...
// Ctor Parameters [CppParam { name: "x", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "y", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "a", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "c", ty: "::BeatmapSaveDataCommon::NoteColorType", modifiers: "", def_value: Some("{}") }, CppParam { name: "d", ty: "::BeatmapSaveDataCommon::NoteCutDirection", modifiers: "", def_value: Some("{}") }]
