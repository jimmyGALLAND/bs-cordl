...
// Type: BeatmapSaveDataVersion4::Chain
...
// Ctor Parameters [CppParam { name: "tx", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "ty", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "c", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "s", ty: "float_t", modifiers: "", def_value: None }]
