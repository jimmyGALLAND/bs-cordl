...
/// @brief Field basicEventTypesWithKeywords, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_basicEventTypesWithKeywords, put=__cordl_internal_set_basicEventTypesWithKeywords)) ::BeatmapSaveDataCommon::BasicEventTypesWithKeywords*  basicEventTypesWithKeywords;

/// @brief Field basicEvents, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_basicEvents, put=__cordl_internal_set_basicEvents)) ::ArrayW<::BeatmapSaveDataVersion4::BeatIndex*,::Array<::BeatmapSaveDataVersion4::BeatIndex*>*>  basicEvents;

/// @brief Field basicEventsData, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_basicEventsData, put=__cordl_internal_set_basicEventsData)) ::ArrayW<::BeatmapSaveDataVersion4::BasicEvent,::Array<::BeatmapSaveDataVersion4::BasicEvent>*>  basicEventsData;

/// @brief Field colorBoostEvents, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_colorBoostEvents, put=__cordl_internal_set_colorBoostEvents)) ::ArrayW<::BeatmapSaveDataVersion4::BeatIndex*,::Array<::BeatmapSaveDataVersion4::BeatIndex*>*>  colorBoostEvents;

/// @brief Field colorBoostEventsData, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_colorBoostEventsData, put=__cordl_internal_set_colorBoostEventsData)) ::ArrayW<::BeatmapSaveDataVersion4::ColorBoostEvent,::Array<::BeatmapSaveDataVersion4::ColorBoostEvent>*>  colorBoostEventsData;

/// @brief Field eventBoxGroups, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_eventBoxGroups, put=__cordl_internal_set_eventBoxGroups)) ::ArrayW<::BeatmapSaveDataVersion4::EventBoxGroup*,::Array<::BeatmapSaveDataVersion4::EventBoxGroup*>*>  eventBoxGroups;

/// @brief Field floatFxEvents, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_floatFxEvents, put=__cordl_internal_set_floatFxEvents)) ::ArrayW<::BeatmapSaveDataVersion4::FloatFxEvent,::Array<::BeatmapSaveDataVersion4::FloatFxEvent>*>  floatFxEvents;

/// @brief Field fxEventBoxes, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get_fxEventBoxes, put=__cordl_internal_set_fxEventBoxes)) ::ArrayW<::BeatmapSaveDataVersion4::FxEventBox,::Array<::BeatmapSaveDataVersion4::FxEventBox>*>  fxEventBoxes;

/// @brief Field indexFilters, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_indexFilters, put=__cordl_internal_set_indexFilters)) ::ArrayW<::BeatmapSaveDataVersion4::IndexFilter,::Array<::BeatmapSaveDataVersion4::IndexFilter>*>  indexFilters;

/// @brief Field lightColorEventBoxes, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_lightColorEventBoxes, put=__cordl_internal_set_lightColorEventBoxes)) ::ArrayW<::BeatmapSaveDataVersion4::LightColorEventBox,::Array<::BeatmapSaveDataVersion4::LightColorEventBox>*>  lightColorEventBoxes;

/// @brief Field lightColorEvents, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_lightColorEvents, put=__cordl_internal_set_lightColorEvents)) ::ArrayW<::BeatmapSaveDataVersion4::LightColorEvent,::Array<::BeatmapSaveDataVersion4::LightColorEvent>*>  lightColorEvents;

/// @brief Field lightRotationEventBoxes, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_lightRotationEventBoxes, put=__cordl_internal_set_lightRotationEventBoxes)) ::ArrayW<::BeatmapSaveDataVersion4::LightRotationEventBox,::Array<::BeatmapSaveDataVersion4::LightRotationEventBox>*>  lightRotationEventBoxes;

/// @brief Field lightRotationEvents, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_lightRotationEvents, put=__cordl_internal_set_lightRotationEvents)) ::ArrayW<::BeatmapSaveDataVersion4::LightRotationEvent,::Array<::BeatmapSaveDataVersion4::LightRotationEvent>*>  lightRotationEvents;

/// @brief Field lightTranslationEventBoxes, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_lightTranslationEventBoxes, put=__cordl_internal_set_lightTranslationEventBoxes)) ::ArrayW<::BeatmapSaveDataVersion4::LightTranslationEventBox,::Array<::BeatmapSaveDataVersion4::LightTranslationEventBox>*>  lightTranslationEventBoxes;

/// @brief Field lightTranslationEvents, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get_lightTranslationEvents, put=__cordl_internal_set_lightTranslationEvents)) ::ArrayW<::BeatmapSaveDataVersion4::LightTranslationEvent,::Array<::BeatmapSaveDataVersion4::LightTranslationEvent>*>  lightTranslationEvents;
...
/// @brief Field waypoints, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_waypoints, put=__cordl_internal_set_waypoints)) ::ArrayW<::BeatmapSaveDataVersion4::BeatmapBeatIndex*,::Array<::BeatmapSaveDataVersion4::BeatmapBeatIndex*>*>  waypoints;

/// @brief Field waypointsData, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_waypointsData, put=__cordl_internal_set_waypointsData)) ::ArrayW<::BeatmapSaveDataVersion4::Waypoint,::Array<::BeatmapSaveDataVersion4::Waypoint>*>  waypointsData;
...
/// @brief Method .ctor, addr 0x26bb2d8, size 0x730, virtual false, abstract: false, final false
inline void _ctor() ;
