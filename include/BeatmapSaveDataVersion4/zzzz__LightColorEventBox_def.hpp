...
// Type: BeatmapSaveDataVersion4::LightColorEventBox
...
constexpr LightColorEventBox(float_t  w, ::BeatmapSaveDataCommon::DistributionParamType  d, float_t  s, ::BeatmapSaveDataCommon::DistributionParamType  t, int32_t  b, ::BeatmapSaveDataCommon::EaseType  e) noexcept;
