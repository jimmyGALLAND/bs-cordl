...
/// @brief Field bombNotes, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_bombNotes, put=__cordl_internal_set_bombNotes)) ::ArrayW<::BeatmapSaveDataVersion4::BeatmapBeatIndex*,::Array<::BeatmapSaveDataVersion4::BeatmapBeatIndex*>*>  bombNotes;

/// @brief Field bombNotesData, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_bombNotesData, put=__cordl_internal_set_bombNotesData)) ::ArrayW<::BeatmapSaveDataVersion4::BombNote,::Array<::BeatmapSaveDataVersion4::BombNote>*>  bombNotesData;

/// @brief Field chains, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_chains, put=__cordl_internal_set_chains)) ::ArrayW<::BeatmapSaveDataVersion4::ChainBeatIndex*,::Array<::BeatmapSaveDataVersion4::ChainBeatIndex*>*>  chains;
...
/// @brief Field colorNotes, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_colorNotes, put=__cordl_internal_set_colorNotes)) ::ArrayW<::BeatmapSaveDataVersion4::BeatmapBeatIndex*,::Array<::BeatmapSaveDataVersion4::BeatmapBeatIndex*>*>  colorNotes;

/// @brief Field colorNotesData, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_colorNotesData, put=__cordl_internal_set_colorNotesData)) ::ArrayW<::BeatmapSaveDataVersion4::ColorNote,::Array<::BeatmapSaveDataVersion4::ColorNote>*>  colorNotesData;

/// @brief Field obstacles, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_obstacles, put=__cordl_internal_set_obstacles)) ::ArrayW<::BeatmapSaveDataVersion4::BeatmapBeatIndex*,::Array<::BeatmapSaveDataVersion4::BeatmapBeatIndex*>*>  obstacles;

/// @brief Field obstaclesData, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_obstaclesData, put=__cordl_internal_set_obstaclesData)) ::ArrayW<::BeatmapSaveDataVersion4::Obstacle,::Array<::BeatmapSaveDataVersion4::Obstacle>*>  obstaclesData;

/// @brief Field spawnRotations, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_spawnRotations, put=__cordl_internal_set_spawnRotations)) ::ArrayW<::BeatmapSaveDataVersion4::BeatIndex*,::Array<::BeatmapSaveDataVersion4::BeatIndex*>*>  spawnRotations;

/// @brief Field spawnRotationsData, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_spawnRotationsData, put=__cordl_internal_set_spawnRotationsData)) ::ArrayW<::BeatmapSaveDataVersion4::SpawnRotation,::Array<::BeatmapSaveDataVersion4::SpawnRotation>*>  spawnRotationsData;
...
/// @brief Method .ctor, addr 0x26badb8, size 0x510, virtual false, abstract: false, final false
inline void _ctor() ;
