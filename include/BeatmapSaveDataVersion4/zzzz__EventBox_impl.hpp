...
// Ctor Parameters [CppParam { name: "f", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "e", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "l", ty: "::ArrayW<::BeatmapSaveDataVersion4::BeatIndex*,::Array<::BeatmapSaveDataVersion4::BeatIndex*>*>", modifiers: "", def_value: Some("nullptr") }]
