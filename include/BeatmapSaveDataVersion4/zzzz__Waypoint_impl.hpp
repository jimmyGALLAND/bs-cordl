...
// Ctor Parameters [CppParam { name: "x", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "y", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "o", ty: "::BeatmapSaveDataCommon::OffsetDirection", modifiers: "", def_value: Some("{}") }]
