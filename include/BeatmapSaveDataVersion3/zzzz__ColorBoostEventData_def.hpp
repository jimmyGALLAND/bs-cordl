...
/// @brief Method .ctor, addr 0x26bcce4, size 0x38, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, bool  boost) ;

/// @brief Method get_boost, addr 0x26bccdc, size 0x8, virtual false, abstract: false, final false
