...
/// @brief Method .ctor, addr 0x26bc538, size 0x38, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, int32_t  value) ;

/// @brief Method get_beat, addr 0x26bc518, size 0x8, virtual false, abstract: false, final false
inline float_t get_beat() ;

/// @brief Method get_usePreviousEventValue, addr 0x26bc520, size 0x10, virtual false, abstract: false, final false
inline bool get_usePreviousEventValue() ;

/// @brief Method get_value, addr 0x26bc530, size 0x8, virtual false, abstract: false, final false
