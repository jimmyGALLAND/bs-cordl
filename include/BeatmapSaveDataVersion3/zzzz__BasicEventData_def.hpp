...
/// @brief Method .ctor, addr 0x26bcc98, size 0x44, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, ::BeatmapSaveDataCommon::BeatmapEventType  eventType, int32_t  value, float_t  floatValue) ;

/// @brief Method get_eventType, addr 0x26bcc80, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::BeatmapEventType get_eventType() ;

/// @brief Method get_floatValue, addr 0x26bcc90, size 0x8, virtual false, abstract: false, final false
inline float_t get_floatValue() ;

/// @brief Method get_value, addr 0x26bcc88, size 0x8, virtual false, abstract: false, final false
