...
/// @brief Method CreateDivisionIndexFilter, addr 0x26bc708, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method CreateForExtension, addr 0x26bc808, size 0x68, virtual false, abstract: false, final false
static inline ::BeatmapSaveDataVersion3::IndexFilter* CreateForExtension() ;

/// @brief Method CreateStepFilter, addr 0x26bc788, size 0x80, virtual false, abstract: false, final false
...
static inline ::BeatmapSaveDataVersion3::IndexFilter* New_ctor(::BeatmapSaveDataCommon::IndexFilterType  type, int32_t  param0, int32_t  param1, bool  reversed, ::BeatmapSaveDataCommon::IndexFilterRandomType  random, int32_t  seed, int32_t  chunks, float_t  limit, ::BeatmapSaveDataCommon::IndexFilterLimitAlsoAffectsType  limitAlsoAffectsType) ;
...
/// @brief Method .ctor, addr 0x26bc6b4, size 0x54, virtual false, abstract: false, final false
inline void _ctor(::BeatmapSaveDataVersion3::IndexFilter*  other) ;

/// @brief Method .ctor, addr 0x26bc634, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::BeatmapSaveDataCommon::IndexFilterType  type, int32_t  param0, int32_t  param1, bool  reversed, ::BeatmapSaveDataCommon::IndexFilterRandomType  random, int32_t  seed, int32_t  chunks, float_t  limit, ::BeatmapSaveDataCommon::IndexFilterLimitAlsoAffectsType  limitAlsoAffectsType) ;

/// @brief Method get_chunks, addr 0x26bc60c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_chunks() ;

/// @brief Method get_limit, addr 0x26bc614, size 0x8, virtual false, abstract: false, final false
inline float_t get_limit() ;

/// @brief Method get_limitAlsoAffectsType, addr 0x26bc61c, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::IndexFilterLimitAlsoAffectsType get_limitAlsoAffectsType() ;

/// @brief Method get_param0, addr 0x26bc5ec, size 0x8, virtual false, abstract: false, final false
inline int32_t get_param0() ;

/// @brief Method get_param1, addr 0x26bc5f4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_param1() ;

/// @brief Method get_random, addr 0x26bc624, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::IndexFilterRandomType get_random() ;

/// @brief Method get_reversed, addr 0x26bc5fc, size 0x10, virtual false, abstract: false, final false
inline bool get_reversed() ;

/// @brief Method get_seed, addr 0x26bc62c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_seed() ;

/// @brief Method get_type, addr 0x26bc5e4, size 0x8, virtual false, abstract: false, final false
