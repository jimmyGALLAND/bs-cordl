...
/// @brief Method .ctor, addr 0x26bcc38, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method get_beat, addr 0x26bcc10, size 0x8, virtual false, abstract: false, final false
inline float_t get_beat() ;

/// @brief Method get_easeType, addr 0x26bcc28, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::EaseType get_easeType() ;

/// @brief Method get_translation, addr 0x26bcc30, size 0x8, virtual false, abstract: false, final false
inline float_t get_translation() ;

/// @brief Method get_usePreviousEventTranslationValue, addr 0x26bcc18, size 0x10, virtual false, abstract: false, final false
