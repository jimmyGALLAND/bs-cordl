...
/// @brief Method .ctor, addr 0x26bd100, size 0x58, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, int32_t  line, int32_t  layer, float_t  duration, int32_t  width, int32_t  height) ;

/// @brief Method get_duration, addr 0x26bd0e8, size 0x8, virtual false, abstract: false, final false
inline float_t get_duration() ;

/// @brief Method get_height, addr 0x26bd0f8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_height() ;

/// @brief Method get_layer, addr 0x26bd0e0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_layer() ;

/// @brief Method get_line, addr 0x26bd0d8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_line() ;

/// @brief Method get_width, addr 0x26bd0f0, size 0x8, virtual false, abstract: false, final false
