...
/// @brief Method .ctor, addr 0x26bcd60, size 0x40, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, ::BeatmapSaveDataCommon::ExecutionTime  executionTime, float_t  rotation) ;

/// @brief Method get_executionTime, addr 0x26bcd50, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::ExecutionTime get_executionTime() ;

/// @brief Method get_rotation, addr 0x26bcd58, size 0x8, virtual false, abstract: false, final false
