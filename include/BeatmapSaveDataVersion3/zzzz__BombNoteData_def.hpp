...
/// @brief Method .ctor, addr 0x26bce38, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, int32_t  line, int32_t  layer) ;

/// @brief Method get_layer, addr 0x26bce30, size 0x8, virtual false, abstract: false, final false
inline int32_t get_layer() ;

/// @brief Method get_line, addr 0x26bce28, size 0x8, virtual false, abstract: false, final false
