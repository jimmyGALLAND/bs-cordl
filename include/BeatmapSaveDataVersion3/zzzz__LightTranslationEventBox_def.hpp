...
/// @brief Method .ctor, addr 0x26bcb80, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_axis, addr 0x26bcb48, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::Axis get_axis() ;

/// @brief Method get_flipTranslation, addr 0x26bcb50, size 0x10, virtual false, abstract: false, final false
inline bool get_flipTranslation() ;

/// @brief Method get_gapDistributionEaseType, addr 0x26bcb70, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::EaseType get_gapDistributionEaseType() ;

/// @brief Method get_gapDistributionParam, addr 0x26bcb38, size 0x8, virtual false, abstract: false, final false
inline float_t get_gapDistributionParam() ;

/// @brief Method get_gapDistributionParamType, addr 0x26bcb40, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::DistributionParamType get_gapDistributionParamType() ;

/// @brief Method get_gapDistributionShouldAffectFirstBaseEvent, addr 0x26bcb60, size 0x10, virtual false, abstract: false, final false
inline bool get_gapDistributionShouldAffectFirstBaseEvent() ;

/// @brief Method get_lightTranslationBaseDataList, addr 0x26bcb78, size 0x8, virtual false, abstract: false, final false
