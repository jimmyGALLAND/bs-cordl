...
/// @brief Method .ctor, addr 0x26bbc24, size 0x28, virtual false, abstract: false, final false
inline void _ctor(float_t  beat) ;

/// @brief Method get_beat, addr 0x26bbc1c, size 0x8, virtual true, abstract: false, final true
