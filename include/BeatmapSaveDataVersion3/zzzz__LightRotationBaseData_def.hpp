...
/// @brief Method .ctor, addr 0x26bcad8, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_beat, addr 0x26bcaa0, size 0x8, virtual false, abstract: false, final false
inline float_t get_beat() ;

/// @brief Method get_easeType, addr 0x26bcab8, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::EaseType get_easeType() ;

/// @brief Method get_loopsCount, addr 0x26bcac0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_loopsCount() ;

/// @brief Method get_rotation, addr 0x26bcac8, size 0x8, virtual false, abstract: false, final false
inline float_t get_rotation() ;

/// @brief Method get_rotationDirection, addr 0x26bcad0, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::RotationDirection get_rotationDirection() ;

/// @brief Method get_usePreviousEventRotationValue, addr 0x26bcaa8, size 0x10, virtual false, abstract: false, final false
