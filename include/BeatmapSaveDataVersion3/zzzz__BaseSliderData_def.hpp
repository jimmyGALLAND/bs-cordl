...
/// @brief Method .ctor, addr 0x26bcf10, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method get_colorType, addr 0x26bced8, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::NoteColorType get_colorType() ;

/// @brief Method get_headCutDirection, addr 0x26bcef0, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::NoteCutDirection get_headCutDirection() ;

/// @brief Method get_headLayer, addr 0x26bcee8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_headLayer() ;

/// @brief Method get_headLine, addr 0x26bcee0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_headLine() ;

/// @brief Method get_tailBeat, addr 0x26bcef8, size 0x8, virtual false, abstract: false, final false
inline float_t get_tailBeat() ;

/// @brief Method get_tailLayer, addr 0x26bcf08, size 0x8, virtual false, abstract: false, final false
inline int32_t get_tailLayer() ;

/// @brief Method get_tailLine, addr 0x26bcf00, size 0x8, virtual false, abstract: false, final false
