...
/// @brief Method .ctor, addr 0x26bc598, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, bool  usePreviousEventValue, float_t  value, ::BeatmapSaveDataCommon::EaseType  easeType) ;

/// @brief Method get_beat, addr 0x26bc570, size 0x8, virtual false, abstract: false, final false
inline float_t get_beat() ;

/// @brief Method get_easeType, addr 0x26bc590, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::EaseType get_easeType() ;

/// @brief Method get_usePreviousEventValue, addr 0x26bc578, size 0x10, virtual false, abstract: false, final false
inline bool get_usePreviousEventValue() ;

/// @brief Method get_value, addr 0x26bc588, size 0x8, virtual false, abstract: false, final false
