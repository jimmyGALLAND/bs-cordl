...
/// @brief Method .ctor, addr 0x26bce8c, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, int32_t  line, int32_t  layer, ::BeatmapSaveDataCommon::OffsetDirection  offsetDirection) ;

/// @brief Method get_layer, addr 0x26bce7c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_layer() ;

/// @brief Method get_line, addr 0x26bce74, size 0x8, virtual false, abstract: false, final false
inline int32_t get_line() ;

/// @brief Method get_offsetDirection, addr 0x26bce84, size 0x8, virtual false, abstract: false, final false
