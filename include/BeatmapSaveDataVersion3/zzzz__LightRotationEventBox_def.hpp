...
/// @brief Method .ctor, addr 0x26bca10, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_axis, addr 0x26bc9d8, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::Axis get_axis() ;

/// @brief Method get_flipRotation, addr 0x26bc9e0, size 0x10, virtual false, abstract: false, final false
inline bool get_flipRotation() ;

/// @brief Method get_lightRotationBaseDataList, addr 0x26bca08, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_rotationDistributionEaseType, addr 0x26bca00, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::EaseType get_rotationDistributionEaseType() ;

/// @brief Method get_rotationDistributionParam, addr 0x26bc9c8, size 0x8, virtual false, abstract: false, final false
inline float_t get_rotationDistributionParam() ;

/// @brief Method get_rotationDistributionParamType, addr 0x26bc9d0, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::DistributionParamType get_rotationDistributionParamType() ;

/// @brief Method get_rotationDistributionShouldAffectFirstBaseEvent, addr 0x26bc9f0, size 0x10, virtual false, abstract: false, final false
