...
/// @brief Method .ctor, addr 0x26bcd24, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, float_t  bpm) ;

/// @brief Method get_bpm, addr 0x26bcd1c, size 0x8, virtual false, abstract: false, final false
