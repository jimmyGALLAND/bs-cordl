...
static inline ::BeatmapSaveDataVersion3::ColorNoteData* New_ctor(float_t  beat, int32_t  line, int32_t  layer, ::BeatmapSaveDataCommon::NoteColorType  color, ::BeatmapSaveDataCommon::NoteCutDirection  cutDirection, int32_t  angleOffset) ;
...
/// @brief Method .ctor, addr 0x26bcdc8, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_angleOffset, addr 0x26bcdb0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_angleOffset() ;

/// @brief Method get_color, addr 0x26bcdb8, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::NoteColorType get_color() ;

/// @brief Method get_cutDirection, addr 0x26bcdc0, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::NoteCutDirection get_cutDirection() ;

/// @brief Method get_layer, addr 0x26bcda8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_layer() ;

/// @brief Method get_line, addr 0x26bcda0, size 0x8, virtual false, abstract: false, final false
