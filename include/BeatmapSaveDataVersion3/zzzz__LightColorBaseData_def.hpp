...
static inline ::BeatmapSaveDataVersion3::LightColorBaseData* New_ctor(float_t  beat, ::BeatmapSaveDataVersion3::TransitionType  transitionType, ::BeatmapSaveDataCommon::EnvironmentColorType  colorType, float_t  brightness, int32_t  strobeFrequency, float_t  strobeBrightness, bool  strobeFade) ;
...
/// @brief Method .ctor, addr 0x26bc958, size 0x70, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, ::BeatmapSaveDataVersion3::TransitionType  transitionType, ::BeatmapSaveDataCommon::EnvironmentColorType  colorType, float_t  brightness, int32_t  strobeFrequency, float_t  strobeBrightness, bool  strobeFade) ;

/// @brief Method get_beat, addr 0x26bc918, size 0x8, virtual false, abstract: false, final false
inline float_t get_beat() ;

/// @brief Method get_brightness, addr 0x26bc930, size 0x8, virtual false, abstract: false, final false
inline float_t get_brightness() ;

/// @brief Method get_colorType, addr 0x26bc928, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::EnvironmentColorType get_colorType() ;

/// @brief Method get_strobeBeatFrequency, addr 0x26bc938, size 0x8, virtual false, abstract: false, final false
inline int32_t get_strobeBeatFrequency() ;

/// @brief Method get_strobeBrightness, addr 0x26bc940, size 0x8, virtual false, abstract: false, final false
inline float_t get_strobeBrightness() ;

/// @brief Method get_strobeFade, addr 0x26bc948, size 0x10, virtual false, abstract: false, final false
inline bool get_strobeFade() ;

/// @brief Method get_transitionType, addr 0x26bc920, size 0x8, virtual false, abstract: false, final false
