...
template<typename TSource,typename TKey,typename TElement>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEnumerable_1<TSource>*> const& System::Linq::GroupedEnumerable_3<TSource,TKey,TElement>::__cordl_internal_get_source() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___source;
}
template<typename TSource,typename TKey,typename TElement>
...
template<typename TSource,typename TKey,typename TElement>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEqualityComparer_1<TKey>*> const& System::Linq::GroupedEnumerable_3<TSource,TKey,TElement>::__cordl_internal_get_comparer() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___comparer;
}
template<typename TSource,typename TKey,typename TElement>
