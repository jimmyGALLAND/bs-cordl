...
/// @brief Method GetOrMakeVariables, addr 0x401bd20, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method ReuseOrValidateVariables, addr 0x401bd70, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x401bcfc, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::ParameterExpression*>*  variables) ;

/// @brief Method get_VariablesList, addr 0x401bd68, size 0x8, virtual false, abstract: false, final false
