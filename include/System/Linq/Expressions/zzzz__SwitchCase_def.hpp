...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::Expression*>*> const& __cordl_internal_get__TestValues_k__BackingField() const;
...
/// @brief Method get_Body, addr 0x402ae34, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* get_Body() ;

/// @brief Method get_TestValues, addr 0x402ae2c, size 0x8, virtual false, abstract: false, final false
