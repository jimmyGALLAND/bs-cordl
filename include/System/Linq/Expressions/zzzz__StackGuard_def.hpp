...
// Declarations
template<typename T1,typename T2>
using __c__3_2 = ::System::Linq::Expressions::__StackGuard____c__3_2<T1, T2>;
...
/// @brief Method TryEnterOnCurrentStack, addr 0x402adc4, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x402ae24, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
