...
/// @brief Method Constant, addr 0x402c3d0, size 0x6c, virtual false, abstract: false, final false
static inline ::System::Linq::Expressions::ConstantExpression* Constant(bool  value) ;

/// @brief Method Constant, addr 0x402c43c, size 0x180, virtual false, abstract: false, final false
