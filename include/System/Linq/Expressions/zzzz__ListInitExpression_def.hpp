...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::ElementInit*>*> const& __cordl_internal_get__Initializers_k__BackingField() const;
...
/// @brief Method get_Initializers, addr 0x4028330, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::ElementInit*>* get_Initializers() ;

/// @brief Method get_NewExpression, addr 0x4028328, size 0x8, virtual false, abstract: false, final false
