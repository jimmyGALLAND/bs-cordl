...
/// @brief Method GetExpression, addr 0x401bfe4, size 0xa8, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* GetExpression(int32_t  index) ;

/// @brief Method GetOrMakeExpressions, addr 0x401c12c, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method Rewrite, addr 0x401c174, size 0xd4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x401bfb4, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_Body, addr 0x401bfdc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::System::Linq::Expressions::Expression*>* get_Body() ;

/// @brief Method get_ExpressionCount, addr 0x401c08c, size 0xa0, virtual true, abstract: false, final false
