...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::ParameterExpression*>*> const& __cordl_internal_get__Variables_k__BackingField() const;
...
/// @brief Method get_Variables, addr 0x402adbc, size 0x8, virtual false, abstract: false, final false
