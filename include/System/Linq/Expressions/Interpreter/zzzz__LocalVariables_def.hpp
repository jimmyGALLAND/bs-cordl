...
/// @brief Field ChildScopes, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_ChildScopes, put=__cordl_internal_set_ChildScopes)) ::System::Collections::Generic::List_1<::System::Linq::Expressions::Interpreter::__LocalVariables__VariableScope*>*  ChildScopes;
...
static inline ::System::Linq::Expressions::Interpreter::__LocalVariables__VariableScope* New_ctor(::System::Linq::Expressions::Interpreter::LocalVariable*  variable, int32_t  start, ::System::Linq::Expressions::Interpreter::__LocalVariables__VariableScope*  parent) ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Linq::Expressions::Interpreter::__LocalVariables__VariableScope*>*> const& __cordl_internal_get_ChildScopes() const;
...
/// @brief Method .ctor, addr 0x405929c, size 0x44, virtual false, abstract: false, final false
...
/// @brief Field _variables, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__variables, put=__cordl_internal_set__variables)) ::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::__LocalVariables__VariableScope*>*  _variables;

/// @brief Method AddClosureVariable, addr 0x405950c, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method Box, addr 0x40592e0, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method DefineLocal, addr 0x4059044, size 0x258, virtual false, abstract: false, final false
...
/// @brief Method TryGetLocalOrClosure, addr 0x405943c, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method UndefineLocal, addr 0x4053ce0, size 0xd4, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*> const& __cordl_internal_get__closureVariables() const;
...
constexpr ::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::__LocalVariables__VariableScope*>*& __cordl_internal_get__variables() ;

constexpr ::cordl_internals::to_const_pointer<::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::__LocalVariables__VariableScope*>*> const& __cordl_internal_get__variables() const;
...
constexpr void __cordl_internal_set__variables(::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::__LocalVariables__VariableScope*>*  value) ;

/// @brief Method .ctor, addr 0x405961c, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ClosureVariables, addr 0x4059504, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_LocalCount, addr 0x4059434, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _variables, offset: 0x10, size: 0x8, def value: None
 ::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::__LocalVariables__VariableScope*>*  ____variables;
