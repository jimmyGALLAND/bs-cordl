...
/// @brief Method GetArgs, addr 0x405d1a4, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method Run, addr 0x405d054, size 0x150, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method ToString, addr 0x405d320, size 0x128, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x405cfd4, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Reflection::ConstructorInfo*  constructor, int32_t  argumentCount) ;

/// @brief Method get_ConsumedStack, addr 0x405d004, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x405d014, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x405d00c, size 0x8, virtual true, abstract: false, final false
