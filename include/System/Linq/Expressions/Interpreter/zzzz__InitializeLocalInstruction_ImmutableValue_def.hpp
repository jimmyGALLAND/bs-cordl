...
/// @brief Method BoxIfIndexMatches, addr 0x40582cc, size 0x7c, virtual true, abstract: false, final true
...
/// @brief Method Run, addr 0x4058260, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4058230, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  index, ::System::Object*  defaultValue) ;

/// @brief Method get_InstructionName, addr 0x4058378, size 0x40, virtual true, abstract: false, final false
