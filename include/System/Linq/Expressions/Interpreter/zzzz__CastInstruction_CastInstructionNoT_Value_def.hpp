...
public:
// Declarations
/// @brief Method ConvertNull, addr 0x4067678, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x40674bc, size 0x28, virtual false, abstract: false, final false
