...
/// @brief Method Run, addr 0x40583b8, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4058348, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  index, ::System::Object*  defaultValue) ;

/// @brief Method get_InstructionName, addr 0x4058488, size 0x40, virtual true, abstract: false, final false
