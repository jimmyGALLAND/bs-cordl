...
/// @brief Method Run, addr 0x405c8d8, size 0xb0, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x405c6d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
