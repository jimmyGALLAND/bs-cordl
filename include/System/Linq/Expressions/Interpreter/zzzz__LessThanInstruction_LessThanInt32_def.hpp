...
/// @brief Method Run, addr 0x40446bc, size 0xdc, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x40442e8, size 0x28, virtual false, abstract: false, final false
