...
/// @brief Method AddBranch, addr 0x4030114, size 0x128, virtual false, abstract: false, final false
inline void AddBranch(::System::Linq::Expressions::Interpreter::InstructionList*  instructions, int32_t  branchIndex) ;

/// @brief Method FixupBranch, addr 0x40300e8, size 0x2c, virtual false, abstract: false, final false
inline void FixupBranch(::System::Linq::Expressions::Interpreter::InstructionList*  instructions, int32_t  branchIndex) ;

/// @brief Method Mark, addr 0x402ff6c, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method ToRuntimeLabel, addr 0x402ff60, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x403023c, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HasRuntimeLabel, addr 0x402ff44, size 0x14, virtual false, abstract: false, final false
inline bool get_HasRuntimeLabel() ;

/// @brief Method get_LabelIndex, addr 0x402ff34, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LabelIndex() ;

/// @brief Method get_TargetIndex, addr 0x402ff58, size 0x8, virtual false, abstract: false, final false
inline int32_t get_TargetIndex() ;

/// @brief Method set_LabelIndex, addr 0x402ff3c, size 0x8, virtual false, abstract: false, final false
