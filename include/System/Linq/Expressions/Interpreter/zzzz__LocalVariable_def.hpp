...
/// @brief Method ToString, addr 0x4058e58, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4058e20, size 0x38, virtual false, abstract: false, final false
inline void _ctor(int32_t  index, bool  closure) ;

/// @brief Method get_InClosure, addr 0x4053af4, size 0xc, virtual false, abstract: false, final false
inline bool get_InClosure() ;

/// @brief Method get_IsBoxed, addr 0x4053b00, size 0xc, virtual false, abstract: false, final false
inline bool get_IsBoxed() ;

/// @brief Method set_IsBoxed, addr 0x4058e10, size 0x10, virtual false, abstract: false, final false
