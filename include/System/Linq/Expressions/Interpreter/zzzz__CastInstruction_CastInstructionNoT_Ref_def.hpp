...
public:
// Declarations
/// @brief Method ConvertNull, addr 0x406765c, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x40674e4, size 0x28, virtual false, abstract: false, final false
