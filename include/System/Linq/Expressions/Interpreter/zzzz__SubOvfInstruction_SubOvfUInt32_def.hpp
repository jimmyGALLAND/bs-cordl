...
/// @brief Method Run, addr 0x4065c34, size 0x1cc, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x40653c4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
