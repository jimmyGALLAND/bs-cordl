...
/// @brief Field _debugInfos, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__debugInfos, put=__cordl_internal_set__debugInfos)) ::ArrayW<::System::Linq::Expressions::Interpreter::DebugInfo*,::Array<::System::Linq::Expressions::Interpreter::DebugInfo*>*>  _debugInfos;
...
/// @brief Field _labels, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__labels, put=__cordl_internal_set__labels)) ::ArrayW<::System::Linq::Expressions::Interpreter::RuntimeLabel,::Array<::System::Linq::Expressions::Interpreter::RuntimeLabel>*>  _labels;
...
/// @brief Method Run, addr 0x4042bd0, size 0x6c, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*,::System::Linq::Expressions::Interpreter::LocalVariable*>*> const& __cordl_internal_get__ClosureVariables_k__BackingField() const;
...
/// @brief Method .ctor, addr 0x4042ad8, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::System::Linq::Expressions::Interpreter::LocalVariables*  locals, ::System::Linq::Expressions::Interpreter::InstructionArray  instructions, ::ArrayW<::System::Linq::Expressions::Interpreter::DebugInfo*,::Array<::System::Linq::Expressions::Interpreter::DebugInfo*>*>  debugInfos) ;

static inline ::System::Object* getStaticF_NoValue() ;

/// @brief Method get_ClosureSize, addr 0x4042b5c, size 0x58, virtual false, abstract: false, final false
inline int32_t get_ClosureSize() ;

/// @brief Method get_ClosureVariables, addr 0x4042bc8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_Instructions, addr 0x4042bb4, size 0x14, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Interpreter::InstructionArray get_Instructions() ;

/// @brief Method get_LocalCount, addr 0x4042b54, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LocalCount() ;

/// @brief Method get_Name, addr 0x4042b4c, size 0x8, virtual false, abstract: false, final false
