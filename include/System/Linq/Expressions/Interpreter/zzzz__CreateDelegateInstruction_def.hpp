...
/// @brief Method Run, addr 0x406605c, size 0x16c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4065fc8, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Linq::Expressions::Interpreter::LightDelegateCreator*  delegateCreator) ;

/// @brief Method get_ConsumedStack, addr 0x4065ff0, size 0x24, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x406601c, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x4066014, size 0x8, virtual true, abstract: false, final false
