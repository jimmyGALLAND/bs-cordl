...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<T,int32_t>*> const& System::Linq::Expressions::Interpreter::IntSwitchInstruction_1<T>::__cordl_internal_get__cases() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____cases;
}
template<typename T>
