...
/// @brief Method Update, addr 0x405390c, size 0x1e8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x40538dc, size 0x30, virtual false, abstract: false, final false
