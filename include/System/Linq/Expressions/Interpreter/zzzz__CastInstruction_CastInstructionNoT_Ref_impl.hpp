...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__CastInstruction__CastInstructionNoT__Ref::*)(::System::Type*)>(&::GlobalNamespace::__CastInstruction__CastInstructionNoT__Ref::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x40674e4;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__CastInstruction__CastInstructionNoT__Ref*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__CastInstruction__CastInstructionNoT__Ref::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(&::GlobalNamespace::__CastInstruction__CastInstructionNoT__Ref::ConvertNull)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x406765c;
