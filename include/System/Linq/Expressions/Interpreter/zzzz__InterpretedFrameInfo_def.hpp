...
public:
// Declarations
/// @brief Method ToString, addr 0x404628c, size 0x78, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x4042990, size 0x8, virtual false, abstract: false, final false
