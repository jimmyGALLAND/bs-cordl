...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::System::Linq::Expressions::Interpreter::ArrayLengthInstruction::*)()>(&::System::Linq::Expressions::Interpreter::ArrayLengthInstruction::get_ConsumedStack)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x402fcd4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::System::Linq::Expressions::Interpreter::ArrayLengthInstruction::*)()>(&::System::Linq::Expressions::Interpreter::ArrayLengthInstruction::get_ProducedStack)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x402fcdc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::System::Linq::Expressions::Interpreter::ArrayLengthInstruction::*)()>(&::System::Linq::Expressions::Interpreter::ArrayLengthInstruction::get_InstructionName)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x402fce4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Linq::Expressions::Interpreter::ArrayLengthInstruction::*)()>(&::System::Linq::Expressions::Interpreter::ArrayLengthInstruction::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x402fd24;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::System::Linq::Expressions::Interpreter::ArrayLengthInstruction::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(&::System::Linq::Expressions::Interpreter::ArrayLengthInstruction::Run)> {
  constexpr static std::size_t size = 0xa4;
  constexpr static std::size_t addrs = 0x402fd2c;
...
::cordl_internals::setStaticField<::System::Linq::Expressions::Interpreter::ArrayLengthInstruction*, "Instance", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Linq::Expressions::Interpreter::ArrayLengthInstruction*>::get>(std::forward<::System::Linq::Expressions::Interpreter::ArrayLengthInstruction*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Linq::Expressions::Interpreter::ArrayLengthInstruction*, "Instance", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Linq::Expressions::Interpreter::ArrayLengthInstruction*>::get>();
}
