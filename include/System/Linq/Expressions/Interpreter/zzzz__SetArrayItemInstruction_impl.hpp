...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Linq::Expressions::Interpreter::SetArrayItemInstruction::*)()>(&::System::Linq::Expressions::Interpreter::SetArrayItemInstruction::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x402fb68;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::System::Linq::Expressions::Interpreter::SetArrayItemInstruction::*)()>(&::System::Linq::Expressions::Interpreter::SetArrayItemInstruction::get_ConsumedStack)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x402fb70;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::System::Linq::Expressions::Interpreter::SetArrayItemInstruction::*)()>(&::System::Linq::Expressions::Interpreter::SetArrayItemInstruction::get_InstructionName)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x402fb78;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::System::Linq::Expressions::Interpreter::SetArrayItemInstruction::*)(::System::Linq::Expressions::Interpreter::InterpretedFrame*)>(&::System::Linq::Expressions::Interpreter::SetArrayItemInstruction::Run)> {
  constexpr static std::size_t size = 0xc0;
  constexpr static std::size_t addrs = 0x402fbb8;
...
::cordl_internals::setStaticField<::System::Linq::Expressions::Interpreter::SetArrayItemInstruction*, "Instance", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Linq::Expressions::Interpreter::SetArrayItemInstruction*>::get>(std::forward<::System::Linq::Expressions::Interpreter::SetArrayItemInstruction*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Linq::Expressions::Interpreter::SetArrayItemInstruction*, "Instance", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Linq::Expressions::Interpreter::SetArrayItemInstruction*>::get>();
}
