...
/// @brief Method Run, addr 0x403bb4c, size 0xac, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x403b648, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
