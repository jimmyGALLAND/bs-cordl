...
/// @brief Method Run, addr 0x4066a38, size 0x70, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x406690c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
