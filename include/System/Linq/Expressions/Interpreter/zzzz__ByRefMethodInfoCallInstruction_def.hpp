...
static inline ::System::Linq::Expressions::Interpreter::ByRefMethodInfoCallInstruction* New_ctor(::System::Reflection::MethodInfo*  target, int32_t  argumentCount, ::ArrayW<::System::Linq::Expressions::Interpreter::ByRefUpdater*,::Array<::System::Linq::Expressions::Interpreter::ByRefUpdater*>*>  byrefArgs) ;

/// @brief Method Run, addr 0x40311bc, size 0x4a8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x40310cc, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Reflection::MethodInfo*  target, int32_t  argumentCount, ::ArrayW<::System::Linq::Expressions::Interpreter::ByRefUpdater*,::Array<::System::Linq::Expressions::Interpreter::ByRefUpdater*>*>  byrefArgs) ;

/// @brief Method get_ProducedStack, addr 0x403110c, size 0xb0, virtual true, abstract: false, final false
