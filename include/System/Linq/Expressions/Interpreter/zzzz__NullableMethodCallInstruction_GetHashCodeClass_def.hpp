...
/// @brief Method Run, addr 0x4066cb4, size 0x50, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x406691c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
DEFINE_IL2CPP_ARG_TYPE(::System::Linq::Expressions::Interpreter::__NullableMethodCallInstruction__GetHashCodeClass*, "System.Linq.Expressions.Interpreter", "NullableMethodCallInstruction/GetHashCodeClass");
