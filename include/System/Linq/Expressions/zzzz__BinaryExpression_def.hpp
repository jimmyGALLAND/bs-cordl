...
/// @brief Method Accept, addr 0x4003a7c, size 0x28, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor*  visitor) ;

/// @brief Method GetBinaryOpFromAssignmentOp, addr 0x4003080, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method GetConversion, addr 0x40038e4, size 0x8, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::LambdaExpression* GetConversion() ;

/// @brief Method GetMethod, addr 0x400167c, size 0x8, virtual true, abstract: false, final false
inline ::System::Reflection::MethodInfo* GetMethod() ;

/// @brief Method IsOpAssignment, addr 0x4001650, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Reduce, addr 0x4002694, size 0x78, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* Reduce() ;

/// @brief Method ReduceIndex, addr 0x4002b20, size 0x45c, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceIndex() ;

/// @brief Method ReduceMember, addr 0x400270c, size 0x414, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceMember() ;

/// @brief Method ReduceUserdefinedLifted, addr 0x4003c0c, size 0x668, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceUserdefinedLifted() ;

/// @brief Method ReduceVariable, addr 0x4002f7c, size 0x104, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceVariable() ;

/// @brief Method Update, addr 0x4001684, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x40015b4, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Linq::Expressions::Expression*  left, ::System::Linq::Expressions::Expression*  right) ;

/// @brief Method get_CanReduce, addr 0x400162c, size 0x24, virtual true, abstract: false, final false
inline bool get_CanReduce() ;

/// @brief Method get_Conversion, addr 0x40017e8, size 0xc, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::LambdaExpression* get_Conversion() ;

/// @brief Method get_IsLifted, addr 0x40038ec, size 0x190, virtual false, abstract: false, final false
inline bool get_IsLifted() ;

/// @brief Method get_IsLiftedLogical, addr 0x4003aa4, size 0x168, virtual false, abstract: false, final false
inline bool get_IsLiftedLogical() ;

/// @brief Method get_IsLiftedToNull, addr 0x4001bd8, size 0x8c, virtual false, abstract: false, final false
inline bool get_IsLiftedToNull() ;

/// @brief Method get_IsReferenceComparison, addr 0x40017f4, size 0xd4, virtual false, abstract: false, final false
inline bool get_IsReferenceComparison() ;

/// @brief Method get_Left, addr 0x4001668, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* get_Left() ;

/// @brief Method get_Method, addr 0x4001670, size 0xc, virtual false, abstract: false, final false
inline ::System::Reflection::MethodInfo* get_Method() ;

/// @brief Method get_Right, addr 0x4001660, size 0x8, virtual false, abstract: false, final false
