...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::MemberBinding*>*> const& __cordl_internal_get__Bindings_k__BackingField() const;
...
/// @brief Method get_Bindings, addr 0x40286ec, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::MemberBinding*>* get_Bindings() ;

/// @brief Method get_NewExpression, addr 0x40286e4, size 0x8, virtual false, abstract: false, final false
