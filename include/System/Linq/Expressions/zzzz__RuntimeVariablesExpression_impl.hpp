...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::ParameterExpression*>* (::System::Linq::Expressions::RuntimeVariablesExpression::*)()>(&::System::Linq::Expressions::RuntimeVariablesExpression::get_Variables)> {
  ...
  constexpr static std::size_t addrs = 0x402adbc;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::ParameterExpression*>*> const& System::Linq::Expressions::RuntimeVariablesExpression::__cordl_internal_get__Variables_k__BackingField() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____Variables_k__BackingField;
}
