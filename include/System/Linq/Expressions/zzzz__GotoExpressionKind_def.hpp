...
/// @brief Field Break value: static_cast<int32_t>(0x2)
static ::System::Linq::Expressions::GotoExpressionKind const Break;

/// @brief Field Continue value: static_cast<int32_t>(0x3)
static ::System::Linq::Expressions::GotoExpressionKind const Continue;

/// @brief Field Goto value: static_cast<int32_t>(0x0)
static ::System::Linq::Expressions::GotoExpressionKind const Goto;

/// @brief Field Return value: static_cast<int32_t>(0x1)
