...
template<typename TElement,typename TKey>
constexpr ::ArrayW<TKey,::Array<TKey>*>& System::Linq::EnumerableSorter_2<TElement,TKey>::__cordl_internal_get_keys()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___keys;
}
template<typename TElement,typename TKey>
constexpr ::ArrayW<TKey,::Array<TKey>*> const& System::Linq::EnumerableSorter_2<TElement,TKey>::__cordl_internal_get_keys() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___keys;
}
template<typename TElement,typename TKey>
constexpr void System::Linq::EnumerableSorter_2<TElement,TKey>::__cordl_internal_set_keys(::ArrayW<TKey,::Array<TKey>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
