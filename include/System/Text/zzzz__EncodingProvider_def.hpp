...
/// @brief Method GetEncoding, addr 0x3beb3ec, size 0xfc, virtual true, abstract: false, final false
...
/// @brief Method GetEncodingFromProvider, addr 0x3beb4e8, size 0xdc, virtual false, abstract: false, final false
static inline ::System::Text::Encoding* GetEncodingFromProvider(int32_t  codepage) ;

/// @brief Method GetEncodingFromProvider, addr 0x3beb6a0, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method GetEncodingFromProvider, addr 0x3beb5c4, size 0xdc, virtual false, abstract: false, final false
