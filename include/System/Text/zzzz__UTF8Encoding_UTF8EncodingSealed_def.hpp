...
/// @brief Method .ctor, addr 0x3bf7f14, size 0x68, virtual false, abstract: false, final false
inline void _ctor(bool  encoderShouldEmitUTF8Identifier) ;

/// @brief Method get_Preamble, addr 0x3bf7f7c, size 0xe4, virtual true, abstract: false, final false
