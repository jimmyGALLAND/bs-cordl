...
/// @brief Method Fallback, addr 0x3dde228, size 0x40, virtual true, abstract: false, final false
inline bool Fallback(::ArrayW<uint8_t,::Array<uint8_t>*>  bytesUnknown, int32_t  index) ;

/// @brief Method GetNextChar, addr 0x3dde3a8, size 0x40, virtual true, abstract: false, final false
inline char16_t GetNextChar() ;

/// @brief Method InternalFallback, addr 0x3dde404, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x3dde3f4, size 0x10, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method TryBestFit, addr 0x3dde268, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3dddf94, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method get_InternalSyncObject, addr 0x3dde18c, size 0x94, virtual false, abstract: false, final false
static inline ::System::Object* get_InternalSyncObject() ;

/// @brief Method get_Remaining, addr 0x3dde3e8, size 0xc, virtual true, abstract: false, final false
