...
/// @brief Method GetByteCount, addr 0x3ddb548, size 0x178, virtual true, abstract: false, final false
inline int32_t GetByteCount(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  index, int32_t  count) ;

/// @brief Method GetByteCount, addr 0x3ddb6c0, size 0x8c, virtual true, abstract: false, final false
inline int32_t GetByteCount(::StringW  chars) ;

/// @brief Method GetByteCount, addr 0x3ddc520, size 0x2f4, virtual true, abstract: false, final false
inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t>  chars, int32_t  charCount, ::System::Text::EncoderNLS*  encoder) ;

/// @brief Method GetByteCount, addr 0x3ddb74c, size 0xd0, virtual true, abstract: false, final false
inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t>  chars, int32_t  count) ;

/// @brief Method GetBytes, addr 0x3ddba64, size 0x264, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x3ddb81c, size 0x248, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x3ddbcc8, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x3ddc860, size 0x424, virtual true, abstract: false, final false
...
/// @brief Method GetCharCount, addr 0x3ddbdc0, size 0x178, virtual true, abstract: false, final false
inline int32_t GetCharCount(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count) ;

/// @brief Method GetCharCount, addr 0x3ddbf38, size 0xd0, virtual true, abstract: false, final false
inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t>  bytes, int32_t  count) ;

/// @brief Method GetCharCount, addr 0x3ddcc84, size 0x150, virtual true, abstract: false, final false
inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t>  bytes, int32_t  count, ::System::Text::DecoderNLS*  decoder) ;

/// @brief Method GetChars, addr 0x3ddc008, size 0x264, virtual true, abstract: false, final false
inline int32_t GetChars(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  byteIndex, int32_t  byteCount, ::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  charIndex) ;

/// @brief Method GetChars, addr 0x3ddc26c, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method GetChars, addr 0x3ddce18, size 0x288, virtual true, abstract: false, final false
...
/// @brief Method GetDecoder, addr 0x3ddd2ac, size 0x58, virtual true, abstract: false, final false
inline ::System::Text::Decoder* GetDecoder() ;

/// @brief Method GetEncoder, addr 0x3ddd348, size 0x5c, virtual true, abstract: false, final false
inline ::System::Text::Encoder* GetEncoder() ;

/// @brief Method GetMaxByteCount, addr 0x3ddd0b0, size 0x100, virtual true, abstract: false, final false
inline int32_t GetMaxByteCount(int32_t  charCount) ;

/// @brief Method GetMaxCharCount, addr 0x3ddd1b0, size 0xfc, virtual true, abstract: false, final false
inline int32_t GetMaxCharCount(int32_t  byteCount) ;

/// @brief Method GetString, addr 0x3ddc364, size 0x1bc, virtual true, abstract: false, final false
...
/// @brief Method SetDefaultFallbacks, addr 0x3ddb490, size 0x24, virtual true, abstract: false, final false
inline void SetDefaultFallbacks() ;

/// @brief Method .ctor, addr 0x3ddb484, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
