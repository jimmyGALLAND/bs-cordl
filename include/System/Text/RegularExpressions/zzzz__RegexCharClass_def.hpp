...
public:
// Declarations
/// @brief Method .ctor, addr 0x438bcfc, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Compare, addr 0x438bd14, size 0x6c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x438bd0c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
constexpr ::System::Collections::Generic::IComparer_1<::System::Text::RegularExpressions::__RegexCharClass__SingleRange>* i___System__Collections__Generic__IComparer_1___System__Text__RegularExpressions____RegexCharClass__SingleRange_() noexcept;
...
// Type: ::SingleRange
// SizeInfo { instance_size: 4, native_size: 2, calculated_instance_size: 4, calculated_native_size: 20, minimum_alignment: 2, packing: None, specified_packing: None }
namespace System::Text::RegularExpressions {
// Is value type: true
...
public:
// Declarations
/// @brief Method .ctor, addr 0x438bddc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field _rangelist, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__rangelist, put=__cordl_internal_set__rangelist)) ::System::Collections::Generic::List_1<::System::Text::RegularExpressions::__RegexCharClass__SingleRange>*  _rangelist;
...
static __declspec(property(get=getStaticF_s_lcTable, put=setStaticF_s_lcTable)) ::ArrayW<::System::Text::RegularExpressions::__RegexCharClass__LowerCaseMapping,::Array<::System::Text::RegularExpressions::__RegexCharClass__LowerCaseMapping>*>  s_lcTable;
...
static __declspec(property(get=getStaticF_s_propTable, put=setStaticF_s_propTable)) ::ArrayW<::ArrayW<::StringW,::Array<::StringW>*>,::Array<::ArrayW<::StringW,::Array<::StringW>*>>*>  s_propTable;
...
/// @brief Method AddCategory, addr 0x438544c, size 0x1c, virtual false, abstract: false, final false
inline void AddCategory(::StringW  category) ;

/// @brief Method AddCategoryFromName, addr 0x4384f58, size 0x210, virtual false, abstract: false, final false
inline void AddCategoryFromName(::StringW  categoryName, bool  invert, bool  caseInsensitive, ::StringW  pattern) ;

/// @brief Method AddChar, addr 0x43849f0, size 0x8, virtual false, abstract: false, final false
inline void AddChar(char16_t  c) ;

/// @brief Method AddCharClass, addr 0x4384b14, size 0x170, virtual false, abstract: false, final false
inline void AddCharClass(::System::Text::RegularExpressions::RegexCharClass*  cc) ;

/// @brief Method AddDigit, addr 0x43859cc, size 0xb4, virtual false, abstract: false, final false
inline void AddDigit(bool  ecma, bool  negate, ::StringW  pattern) ;

/// @brief Method AddLowercase, addr 0x4385468, size 0x13c, virtual false, abstract: false, final false
inline void AddLowercase(::System::Globalization::CultureInfo*  culture) ;

/// @brief Method AddLowercaseRange, addr 0x43855a4, size 0x230, virtual false, abstract: false, final false
inline void AddLowercaseRange(char16_t  chMin, char16_t  chMax, ::System::Globalization::CultureInfo*  culture) ;

/// @brief Method AddRange, addr 0x43849f8, size 0x11c, virtual false, abstract: false, final false
inline void AddRange(char16_t  first, char16_t  last) ;

/// @brief Method AddSet, addr 0x4384d2c, size 0x224, virtual false, abstract: false, final false
inline void AddSet(::StringW  set) ;

/// @brief Method AddSpace, addr 0x43858d0, size 0xfc, virtual false, abstract: false, final false
inline void AddSpace(bool  ecma, bool  negate) ;

/// @brief Method AddSubtraction, addr 0x4384f50, size 0x8, virtual false, abstract: false, final false
inline void AddSubtraction(::System::Text::RegularExpressions::RegexCharClass*  sub) ;

/// @brief Method AddWord, addr 0x43857d4, size 0xfc, virtual false, abstract: false, final false
inline void AddWord(bool  ecma, bool  negate) ;

/// @brief Method Canonicalize, addr 0x43868dc, size 0x238, virtual false, abstract: false, final false
inline void Canonicalize() ;

/// @brief Method CharInCategory, addr 0x4386218, size 0x188, virtual false, abstract: false, final false
static inline bool CharInCategory(char16_t  ch, ::StringW  set, int32_t  start, int32_t  mySetLength, int32_t  myCategoryLength) ;

/// @brief Method CharInCategoryGroup, addr 0x43863a0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method CharInClass, addr 0x4385efc, size 0x68, virtual false, abstract: false, final false
static inline bool CharInClass(char16_t  ch, ::StringW  set) ;

/// @brief Method CharInClassInternal, addr 0x4386108, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method CharInClassRecursive, addr 0x4385fe0, size 0x128, virtual false, abstract: false, final false
static inline bool CharInClassRecursive(char16_t  ch, ::StringW  set, int32_t  start) ;

/// @brief Method GetRangeAt, addr 0x4384ccc, size 0x60, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::__RegexCharClass__SingleRange GetRangeAt(int32_t  i) ;

/// @brief Method IsECMAWordChar, addr 0x4385e90, size 0x6c, virtual false, abstract: false, final false
static inline bool IsECMAWordChar(char16_t  ch) ;

/// @brief Method IsEmpty, addr 0x4385bb4, size 0xc0, virtual false, abstract: false, final false
static inline bool IsEmpty(::StringW  charClass) ;

/// @brief Method IsMergeable, addr 0x4385a98, size 0x9c, virtual false, abstract: false, final false
static inline bool IsMergeable(::StringW  charClass) ;

/// @brief Method IsNegated, addr 0x4385b34, size 0x28, virtual false, abstract: false, final false
static inline bool IsNegated(::StringW  set) ;

/// @brief Method IsSingleton, addr 0x4385c74, size 0x10c, virtual false, abstract: false, final false
static inline bool IsSingleton(::StringW  set) ;

/// @brief Method IsSingletonInverse, addr 0x4385d80, size 0x110, virtual false, abstract: false, final false
static inline bool IsSingletonInverse(::StringW  set) ;

/// @brief Method IsSubtraction, addr 0x4385b5c, size 0x58, virtual false, abstract: false, final false
static inline bool IsSubtraction(::StringW  charClass) ;

/// @brief Method IsWordChar, addr 0x4385f64, size 0x7c, virtual false, abstract: false, final false
static inline bool IsWordChar(char16_t  ch) ;

/// @brief Method NegateCategory, addr 0x4385168, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x4386470, size 0x58, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::RegexCharClass* Parse(::StringW  charClass) ;

/// @brief Method ParseRecursive, addr 0x43864c8, size 0x278, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::RegexCharClass* ParseRecursive(::StringW  charClass, int32_t  start) ;

/// @brief Method RangeCount, addr 0x4384c84, size 0x48, virtual false, abstract: false, final false
inline int32_t RangeCount() ;

/// @brief Method SetFromProperty, addr 0x43851f0, size 0x25c, virtual false, abstract: false, final false
static inline ::StringW SetFromProperty(::StringW  capname, bool  invert, ::StringW  pattern) ;

/// @brief Method SingletonChar, addr 0x4385a80, size 0x18, virtual false, abstract: false, final false
static inline char16_t SingletonChar(::StringW  set) ;

/// @brief Method ToStringClass, addr 0x4386740, size 0x19c, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Text::RegularExpressions::__RegexCharClass__SingleRange>*> const& __cordl_internal_get__rangelist() const;
...
/// @brief Method .ctor, addr 0x43848c0, size 0xb8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4384978, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method get_CanMerge, addr 0x43849c4, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method set_Negate, addr 0x43849e4, size 0xc, virtual false, abstract: false, final false
