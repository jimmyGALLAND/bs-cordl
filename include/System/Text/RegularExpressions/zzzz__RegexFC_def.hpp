...
/// @brief Method AddFC, addr 0x438cf5c, size 0xac, virtual false, abstract: false, final false
inline bool AddFC(::System::Text::RegularExpressions::RegexFC*  fc, bool  concatenate) ;

/// @brief Method GetFirstChars, addr 0x438c2f0, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x438d008, size 0xf8, virtual false, abstract: false, final false
inline void _ctor(char16_t  ch, bool  _cordl_not, bool  nullable, bool  caseInsensitive) ;

/// @brief Method .ctor, addr 0x438d100, size 0x98, virtual false, abstract: false, final false
inline void _ctor(::StringW  charClass, bool  nullable, bool  caseInsensitive) ;

/// @brief Method .ctor, addr 0x438cee4, size 0x78, virtual false, abstract: false, final false
inline void _ctor(bool  nullable) ;

/// @brief Method get_CaseInsensitive, addr 0x438d198, size 0x8, virtual false, abstract: false, final false
inline bool get_CaseInsensitive() ;

/// @brief Method set_CaseInsensitive, addr 0x438d1a0, size 0xc, virtual false, abstract: false, final false
