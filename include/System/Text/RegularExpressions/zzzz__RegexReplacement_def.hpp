...
/// @brief Method GetOrCreate, addr 0x4396514, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method Replace, addr 0x4396a00, size 0x398, virtual false, abstract: false, final false
inline ::StringW Replace(::System::Text::RegularExpressions::Regex*  regex, ::StringW  input, int32_t  count, int32_t  startat) ;

/// @brief Method ReplacementImpl, addr 0x4396630, size 0x1a4, virtual false, abstract: false, final false
inline void ReplacementImpl(::System::Text::StringBuilder*  sb, ::System::Text::RegularExpressions::Match*  match) ;

/// @brief Method ReplacementImplRTL, addr 0x43967d4, size 0x22c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4391a84, size 0x4dc, virtual false, abstract: false, final false
inline void _ctor(::StringW  rep, ::System::Text::RegularExpressions::RegexNode*  concat, ::System::Collections::Hashtable*  _caps) ;

/// @brief Method get_Pattern, addr 0x4396628, size 0x8, virtual false, abstract: false, final false
