...
/// @brief Method Equals, addr 0x4383e68, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x4383ef8, size 0x68, virtual true, abstract: false, final true
inline bool Equals(::System::Text::RegularExpressions::__Regex__CachedCodeEntryKey  other) ;

/// @brief Method GetHashCode, addr 0x4383f60, size 0x58, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x4383d44, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x4381b48, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43821e0, size 0x78, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF_s_cache, put=setStaticF_s_cache)) ::System::Collections::Generic::Dictionary_2<::System::Text::RegularExpressions::__Regex__CachedCodeEntryKey,::System::Text::RegularExpressions::__Regex__CachedCodeEntry*>*  s_cache;
...
/// @brief Method FillCacheDictionary, addr 0x4382258, size 0x104, virtual false, abstract: false, final false
inline void FillCacheDictionary() ;

/// @brief Method GetCachedCode, addr 0x4381a50, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method GetCachedCodeEntryInternal, addr 0x4381b78, size 0x4a4, virtual false, abstract: false, final false
...
/// @brief Method GroupNameFromNumber, addr 0x437f1a8, size 0x140, virtual false, abstract: false, final false
inline ::StringW GroupNameFromNumber(int32_t  i) ;

/// @brief Method GroupNumberFromName, addr 0x437edb4, size 0x140, virtual false, abstract: false, final false
inline int32_t GroupNumberFromName(::StringW  name) ;

/// @brief Method InitDefaultMatchTimeout, addr 0x4383890, size 0x230, virtual false, abstract: false, final false
static inline ::System::TimeSpan InitDefaultMatchTimeout() ;

/// @brief Method InitializeReferences, addr 0x4383d50, size 0xfc, virtual false, abstract: false, final false
inline void InitializeReferences() ;

/// @brief Method IsMatch, addr 0x43829d8, size 0x6c, virtual false, abstract: false, final false
inline bool IsMatch(::StringW  input) ;

/// @brief Method IsMatch, addr 0x4382558, size 0x74, virtual false, abstract: false, final false
static inline bool IsMatch(::StringW  input, ::StringW  pattern) ;

/// @brief Method IsMatch, addr 0x43825cc, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method IsMatch, addr 0x4382a50, size 0x7c, virtual false, abstract: false, final false
inline bool IsMatch(::StringW  input, int32_t  startat) ;

/// @brief Method LookupCachedAndPromote, addr 0x438201c, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method Match, addr 0x4382bcc, size 0x6c, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::Match* Match(::StringW  input) ;

/// @brief Method Match, addr 0x4382acc, size 0x74, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::Match* Match(::StringW  input, ::StringW  pattern) ;

/// @brief Method Match, addr 0x4382b40, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Match, addr 0x4382c38, size 0x70, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::Match* Match(::StringW  input, int32_t  startat) ;

/// @brief Method Matches, addr 0x4382ca8, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method Replace, addr 0x4382d70, size 0x7c, virtual false, abstract: false, final false
static inline ::StringW Replace(::StringW  input, ::StringW  pattern, ::StringW  replacement) ;

/// @brief Method Replace, addr 0x4382e80, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method Replace, addr 0x4382dec, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method Replace, addr 0x4382f08, size 0x70, virtual false, abstract: false, final false
inline ::StringW Replace(::StringW  input, ::StringW  replacement) ;

/// @brief Method Replace, addr 0x4382f78, size 0xd8, virtual false, abstract: false, final false
inline ::StringW Replace(::StringW  input, ::StringW  replacement, int32_t  count, int32_t  startat) ;

/// @brief Method Run, addr 0x437ffd8, size 0x284, virtual false, abstract: false, final false
...
/// @brief Method Split, addr 0x4383050, size 0x70, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> Split(::StringW  input) ;

/// @brief Method Split, addr 0x43830c0, size 0xc0, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> Split(::StringW  input, int32_t  count, int32_t  startat) ;

/// @brief Method Split, addr 0x4383180, size 0x5d4, virtual false, abstract: false, final false
...
/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x4383d0c, size 0x38, virtual true, abstract: false, final true
...
/// @brief Method ToString, addr 0x4383e54, size 0x8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryGetCacheValue, addr 0x438235c, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method TryGetCacheValueSmall, addr 0x4382478, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method UseOptionInvariant, addr 0x4383e5c, size 0xc, virtual false, abstract: false, final false
inline bool UseOptionInvariant() ;

/// @brief Method UseOptionR, addr 0x4382a44, size 0xc, virtual false, abstract: false, final false
inline bool UseOptionR() ;

/// @brief Method ValidateMatchTimeout, addr 0x4383ac0, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4383c18, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::StringW  pattern) ;

/// @brief Method .ctor, addr 0x4383c90, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::StringW  pattern, ::System::Text::RegularExpressions::RegexOptions  options) ;

/// @brief Method .ctor, addr 0x4382658, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method get_Options, addr 0x4383e4c, size 0x8, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexOptions get_Options() ;

/// @brief Method get_RightToLeft, addr 0x4383754, size 0xc, virtual false, abstract: false, final false
