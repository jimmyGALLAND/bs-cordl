...
/// @brief Method AddChild, addr 0x43908c8, size 0x108, virtual false, abstract: false, final false
inline void AddChild(::System::Text::RegularExpressions::RegexNode*  newChild) ;

/// @brief Method Child, addr 0x438c5bc, size 0x58, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* Child(int32_t  i) ;

/// @brief Method ChildCount, addr 0x438c570, size 0x4c, virtual false, abstract: false, final false
inline int32_t ChildCount() ;

/// @brief Method MakeQuantifier, addr 0x43907b0, size 0x118, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* MakeQuantifier(bool  lazy, int32_t  min, int32_t  max) ;

/// @brief Method MakeRep, addr 0x438fc3c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method Reduce, addr 0x438fc54, size 0x68, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* Reduce() ;

/// @brief Method ReduceAlternation, addr 0x438fcbc, size 0x3d4, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* ReduceAlternation() ;

/// @brief Method ReduceConcatenation, addr 0x4390090, size 0x39c, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* ReduceConcatenation() ;

/// @brief Method ReduceGroup, addr 0x43905b4, size 0x2c, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* ReduceGroup() ;

/// @brief Method ReduceRep, addr 0x439042c, size 0x188, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* ReduceRep() ;

/// @brief Method ReduceSet, addr 0x43905e0, size 0x11c, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* ReduceSet() ;

/// @brief Method ReverseLeft, addr 0x438fbc0, size 0x7c, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* ReverseLeft() ;

/// @brief Method StripEnation, addr 0x43906fc, size 0xb4, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* StripEnation(int32_t  emptyType) ;

/// @brief Method Type, addr 0x43909d0, size 0x8, virtual false, abstract: false, final false
inline int32_t Type() ;

/// @brief Method UseOptionR, addr 0x438fbb4, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x438fa80, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  type, ::System::Text::RegularExpressions::RegexOptions  options) ;

/// @brief Method .ctor, addr 0x438fab0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(int32_t  type, ::System::Text::RegularExpressions::RegexOptions  options, char16_t  ch) ;

/// @brief Method .ctor, addr 0x438fb30, size 0x40, virtual false, abstract: false, final false
inline void _ctor(int32_t  type, ::System::Text::RegularExpressions::RegexOptions  options, int32_t  m) ;

/// @brief Method .ctor, addr 0x438fb70, size 0x44, virtual false, abstract: false, final false
inline void _ctor(int32_t  type, ::System::Text::RegularExpressions::RegexOptions  options, int32_t  m, int32_t  n) ;

/// @brief Method .ctor, addr 0x438faf0, size 0x40, virtual false, abstract: false, final false
