...
/// @brief Method IsMatch, addr 0x4384570, size 0x6c, virtual false, abstract: false, final false
inline bool IsMatch(::StringW  text, int32_t  index, int32_t  beglimit, int32_t  endlimit) ;

/// @brief Method MatchPattern, addr 0x438444c, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method Scan, addr 0x43845dc, size 0x2e4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4383fb8, size 0x494, virtual false, abstract: false, final false
