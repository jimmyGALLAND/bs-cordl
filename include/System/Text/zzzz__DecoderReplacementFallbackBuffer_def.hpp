...
/// @brief Method Fallback, addr 0x3ddfcc4, size 0x40, virtual true, abstract: false, final false
inline bool Fallback(::ArrayW<uint8_t,::Array<uint8_t>*>  bytesUnknown, int32_t  index) ;

/// @brief Method GetNextChar, addr 0x3ddfd04, size 0x50, virtual true, abstract: false, final false
inline char16_t GetNextChar() ;

/// @brief Method InternalFallback, addr 0x3ddfd70, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x3ddfd60, size 0x10, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x3ddfbcc, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::System::Text::DecoderReplacementFallback*  fallback) ;

/// @brief Method get_Remaining, addr 0x3ddfd54, size 0xc, virtual true, abstract: false, final false
