...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Text::__ASCIIEncoding__ASCIIEncodingSealed::*)()>(&::System::Text::__ASCIIEncoding__ASCIIEncodingSealed::_ctor)> {
  constexpr static std::size_t size = 0x5c;
  constexpr static std::size_t addrs = 0x3ddd410;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Text::__ASCIIEncoding__ASCIIEncodingSealed*>::get(),
                        ".ctor",
