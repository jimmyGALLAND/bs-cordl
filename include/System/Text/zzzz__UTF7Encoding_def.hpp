...
/// @brief Method Reset, addr 0x3bf4944, size 0x28, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x3bf4740, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Text::UTF7Encoding*  encoding) ;

/// @brief Method get_HasState, addr 0x3bf496c, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x3bf497c, size 0x24, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x3bf47a0, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::System::Text::UTF7Encoding*  encoding) ;

/// @brief Method get_HasState, addr 0x3bf49a0, size 0x20, virtual true, abstract: false, final false
inline bool get_HasState() ;
...
/// @brief Method CreateFallbackBuffer, addr 0x3bf49c0, size 0x5c, virtual true, abstract: false, final false
inline ::System::Text::DecoderFallbackBuffer* CreateFallbackBuffer() ;

/// @brief Method Equals, addr 0x3bf4a34, size 0x5c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetHashCode, addr 0x3bf4a90, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::System::Text::__UTF7Encoding__DecoderUTF7Fallback* New_ctor() ;

/// @brief Method .ctor, addr 0x3bf2f40, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_MaxCharCount, addr 0x3bf4a2c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method Fallback, addr 0x3bf4a98, size 0x3c, virtual true, abstract: false, final false
inline bool Fallback(::ArrayW<uint8_t,::Array<uint8_t>*>  bytesUnknown, int32_t  index) ;

/// @brief Method GetNextChar, addr 0x3bf4ad4, size 0x20, virtual true, abstract: false, final false
inline char16_t GetNextChar() ;

/// @brief Method InternalFallback, addr 0x3bf4b10, size 0x74, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x3bf4b00, size 0x10, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x3bf4a1c, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Text::__UTF7Encoding__DecoderUTF7Fallback*  fallback) ;

/// @brief Method get_Remaining, addr 0x3bf4af4, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method Equals, addr 0x3bf2f48, size 0xd0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetByteCount, addr 0x3bf3084, size 0x178, virtual true, abstract: false, final false
inline int32_t GetByteCount(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  index, int32_t  count) ;

/// @brief Method GetByteCount, addr 0x3bf3288, size 0xd0, virtual true, abstract: false, final false
inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t>  chars, int32_t  count) ;

/// @brief Method GetByteCount, addr 0x3bf405c, size 0x1c, virtual true, abstract: false, final false
inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t>  chars, int32_t  count, ::System::Text::EncoderNLS*  baseEncoder) ;

/// @brief Method GetByteCount, addr 0x3bf31fc, size 0x8c, virtual true, abstract: false, final false
inline int32_t GetByteCount(::StringW  s) ;

/// @brief Method GetBytes, addr 0x3bf35a0, size 0x264, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x3bf3804, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x3bf4078, size 0x39c, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x3bf3358, size 0x248, virtual true, abstract: false, final false
...
/// @brief Method GetCharCount, addr 0x3bf38fc, size 0x178, virtual true, abstract: false, final false
inline int32_t GetCharCount(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count) ;

/// @brief Method GetCharCount, addr 0x3bf3a74, size 0xd0, virtual true, abstract: false, final false
inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t>  bytes, int32_t  count) ;

/// @brief Method GetCharCount, addr 0x3bf4414, size 0x1c, virtual true, abstract: false, final false
inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t>  bytes, int32_t  count, ::System::Text::DecoderNLS*  baseDecoder) ;

/// @brief Method GetChars, addr 0x3bf3b44, size 0x264, virtual true, abstract: false, final false
inline int32_t GetChars(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  byteIndex, int32_t  byteCount, ::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  charIndex) ;

/// @brief Method GetChars, addr 0x3bf3da8, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method GetChars, addr 0x3bf4430, size 0x2b4, virtual true, abstract: false, final false
...
/// @brief Method GetDecoder, addr 0x3bf46e4, size 0x5c, virtual true, abstract: false, final false
inline ::System::Text::Decoder* GetDecoder() ;

/// @brief Method GetEncoder, addr 0x3bf4748, size 0x58, virtual true, abstract: false, final false
inline ::System::Text::Encoder* GetEncoder() ;

/// @brief Method GetHashCode, addr 0x3bf3018, size 0x6c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetMaxByteCount, addr 0x3bf47a4, size 0xc0, virtual true, abstract: false, final false
inline int32_t GetMaxByteCount(int32_t  charCount) ;

/// @brief Method GetMaxCharCount, addr 0x3bf4864, size 0x74, virtual true, abstract: false, final false
inline int32_t GetMaxCharCount(int32_t  byteCount) ;

/// @brief Method GetString, addr 0x3bf3ea0, size 0x1bc, virtual true, abstract: false, final false
inline ::StringW GetString(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count) ;

/// @brief Method MakeTables, addr 0x3bf2c10, size 0x284, virtual false, abstract: false, final false
...
/// @brief Method SetDefaultFallbacks, addr 0x3bf2e94, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3bf2bbc, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3bf2be0, size 0x30, virtual false, abstract: false, final false
