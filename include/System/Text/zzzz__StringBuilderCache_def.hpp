...
/// @brief Method Acquire, addr 0x41b871c, size 0xc0, virtual false, abstract: false, final false
static inline ::System::Text::StringBuilder* Acquire(int32_t  capacity) ;

/// @brief Method GetStringAndRelease, addr 0x41b87dc, size 0x3c, virtual false, abstract: false, final false
static inline ::StringW GetStringAndRelease(::System::Text::StringBuilder*  sb) ;

/// @brief Method Release, addr 0x41bc6d0, size 0x78, virtual false, abstract: false, final false
