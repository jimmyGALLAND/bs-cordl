...
public:
// Declarations
/// @brief Method AppendArgument, addr 0x4376c9c, size 0x1dc, virtual false, abstract: false, final false
static inline void AppendArgument(::System::Text::StringBuilder*  stringBuilder, ::StringW  argument) ;

/// @brief Method ContainsNoWhitespaceOrQuotes, addr 0x4376e78, size 0xc8, virtual false, abstract: false, final false
