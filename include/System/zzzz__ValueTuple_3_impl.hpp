...
// Ctor Parameters [CppParam { name: "Item1", ty: "T1", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "Item2", ty: "T2", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "Item3", ty: "T3", modifiers: "", def_value: Some("nullptr") }]
template<typename T1,typename T2,typename T3>
