...
/// @brief Method GenerateGlobalSeed, addr 0x3d6b95c, size 0x24, virtual false, abstract: false, final false
static inline int32_t GenerateGlobalSeed() ;

/// @brief Method GenerateSeed, addr 0x3d6b540, size 0x1c0, virtual false, abstract: false, final false
static inline int32_t GenerateSeed() ;

/// @brief Method GetSampleForLargeRange, addr 0x3d6b984, size 0x4c, virtual false, abstract: false, final false
inline double_t GetSampleForLargeRange() ;

/// @brief Method InternalSample, addr 0x3d6b8d0, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Next, addr 0x3d6b980, size 0x4, virtual true, abstract: false, final false
inline int32_t Next() ;

/// @brief Method Next, addr 0x3d6bae8, size 0xc4, virtual true, abstract: false, final false
inline int32_t Next(int32_t  maxValue) ;

/// @brief Method Next, addr 0x3d6b9d0, size 0x118, virtual true, abstract: false, final false
inline int32_t Next(int32_t  minValue, int32_t  maxValue) ;

/// @brief Method NextBytes, addr 0x3d6bbb8, size 0xac, virtual true, abstract: false, final false
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer) ;

/// @brief Method NextDouble, addr 0x3d6bbac, size 0xc, virtual true, abstract: false, final false
inline double_t NextDouble() ;

/// @brief Method Sample, addr 0x3d6b8b0, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3d6b4e4, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3d6b700, size 0x1b0, virtual false, abstract: false, final false
