...
/// @brief Method Add, addr 0x3d56850, size 0x298, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x3d56d8c, size 0x48, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GenerateGlobalSeed, addr 0x3d56548, size 0x24, virtual false, abstract: false, final false
static inline uint32_t GenerateGlobalSeed() ;

/// @brief Method GetHashCode, addr 0x3d56d20, size 0x48, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Initialize, addr 0x3d56578, size 0xb8, virtual false, abstract: false, final false
static inline void Initialize(ByRef<uint32_t>  v1, ByRef<uint32_t>  v2, ByRef<uint32_t>  v3, ByRef<uint32_t>  v4) ;

/// @brief Method MixEmptyState, addr 0x3d567c4, size 0x64, virtual false, abstract: false, final false
static inline uint32_t MixEmptyState() ;

/// @brief Method MixFinal, addr 0x3d56828, size 0x28, virtual false, abstract: false, final false
static inline uint32_t MixFinal(uint32_t  hash) ;

/// @brief Method MixState, addr 0x3d56720, size 0xa4, virtual false, abstract: false, final false
static inline uint32_t MixState(uint32_t  v1, uint32_t  v2, uint32_t  v3, uint32_t  v4) ;

/// @brief Method QueueRound, addr 0x3d566a8, size 0x78, virtual false, abstract: false, final false
static inline uint32_t QueueRound(uint32_t  hash, uint32_t  queuedValue) ;

/// @brief Method Rol, addr 0x3d5656c, size 0xc, virtual false, abstract: false, final false
static inline uint32_t Rol(uint32_t  value, int32_t  count) ;

/// @brief Method Round, addr 0x3d56630, size 0x78, virtual false, abstract: false, final false
static inline uint32_t Round(uint32_t  hash, uint32_t  input) ;

/// @brief Method ToHashCode, addr 0x3d56ae8, size 0x238, virtual false, abstract: false, final false
