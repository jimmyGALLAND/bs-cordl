...
/// @brief Method Close, addr 0x3c84478, size 0x10, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method DangerousAddRef, addr 0x3c83b14, size 0xc4, virtual false, abstract: false, final false
inline void DangerousAddRef(ByRef<bool>  success) ;

/// @brief Method DangerousGetHandle, addr 0x3c84464, size 0x8, virtual false, abstract: false, final false
inline ::System::IntPtr DangerousGetHandle() ;

/// @brief Method DangerousRelease, addr 0x3c83c80, size 0x8, virtual false, abstract: false, final false
inline void DangerousRelease() ;

/// @brief Method DangerousReleaseInternal, addr 0x3c845ec, size 0x160, virtual false, abstract: false, final false
inline void DangerousReleaseInternal(bool  dispose) ;

/// @brief Method Dispose, addr 0x3c84488, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x3c84498, size 0x1c, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x3c843bc, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method InternalDispose, addr 0x3c844b4, size 0xa0, virtual false, abstract: false, final false
inline void InternalDispose() ;

/// @brief Method InternalFinalize, addr 0x3c84554, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method SetHandle, addr 0x3c8445c, size 0x8, virtual false, abstract: false, final false
inline void SetHandle(::System::IntPtr  handle) ;

/// @brief Method SetHandleAsInvalid, addr 0x3c84568, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c84324, size 0x98, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  invalidHandleValue, bool  ownsHandle) ;

/// @brief Method get_IsClosed, addr 0x3c8446c, size 0xc, virtual false, abstract: false, final false
