...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Runtime::InteropServices::ComDefaultInterfaceAttribute::*)(::System::Type*)>(&::System::Runtime::InteropServices::ComDefaultInterfaceAttribute::_ctor)> {
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> const& System::Runtime::InteropServices::ComDefaultInterfaceAttribute::__cordl_internal_get__val() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____val;
}
