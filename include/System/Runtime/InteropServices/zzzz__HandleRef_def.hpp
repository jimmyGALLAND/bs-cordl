...
// SizeInfo { instance_size: 16, native_size: 8, calculated_instance_size: 16, calculated_native_size: 32, minimum_alignment: 8, packing: None, specified_packing: None }
namespace System::Runtime::InteropServices {
// Is value type: true
...
/// @brief Method .ctor, addr 0x3c83480, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  wrapper, ::System::IntPtr  handle) ;

/// @brief Method get_Handle, addr 0x3c83488, size 0x8, virtual false, abstract: false, final false
