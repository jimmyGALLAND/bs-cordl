...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)()>(&::System::Runtime::InteropServices::RuntimeInformation::GetOSName)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x3c84e40;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::System::Runtime::InteropServices::OSPlatform)>(&::System::Runtime::InteropServices::RuntimeInformation::IsOSPlatform)> {
  constexpr static std::size_t size = 0x8c;
  constexpr static std::size_t addrs = 0x3c84e44;
...
::cordl_internals::setStaticField<::System::Runtime::InteropServices::Architecture, "_osArchitecture", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::InteropServices::RuntimeInformation*>::get>(std::forward<::System::Runtime::InteropServices::Architecture>(value));
}
...
return ::cordl_internals::getStaticField<::System::Runtime::InteropServices::Architecture, "_osArchitecture", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::InteropServices::RuntimeInformation*>::get>();
}
...
::cordl_internals::setStaticField<::System::Runtime::InteropServices::Architecture, "_processArchitecture", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::InteropServices::RuntimeInformation*>::get>(std::forward<::System::Runtime::InteropServices::Architecture>(value));
}
...
return ::cordl_internals::getStaticField<::System::Runtime::InteropServices::Architecture, "_processArchitecture", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::InteropServices::RuntimeInformation*>::get>();
}
...
::cordl_internals::setStaticField<::System::Runtime::InteropServices::OSPlatform, "_osPlatform", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::InteropServices::RuntimeInformation*>::get>(std::forward<::System::Runtime::InteropServices::OSPlatform>(value));
}
...
return ::cordl_internals::getStaticField<::System::Runtime::InteropServices::OSPlatform, "_osPlatform", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::InteropServices::RuntimeInformation*>::get>();
}
