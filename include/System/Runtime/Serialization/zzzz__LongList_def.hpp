...
/// @brief Method Add, addr 0x3c6ac80, size 0x80, virtual false, abstract: false, final false
inline void Add(int64_t  value) ;

/// @brief Method EnlargeArray, addr 0x3c6af6c, size 0x88, virtual false, abstract: false, final false
inline void EnlargeArray() ;

/// @brief Method MoveNext, addr 0x3c68fd8, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method RemoveElement, addr 0x3c6abcc, size 0x8c, virtual false, abstract: false, final false
inline bool RemoveElement(int64_t  value) ;

/// @brief Method StartEnumeration, addr 0x3c68f8c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c6ac78, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3c6af00, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(int32_t  startingSize) ;

/// @brief Method get_Count, addr 0x3c6aff4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Current, addr 0x3c68f98, size 0x34, virtual false, abstract: false, final false
