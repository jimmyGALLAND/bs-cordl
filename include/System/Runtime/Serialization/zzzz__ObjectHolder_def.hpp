...
/// @brief Method AddDependency, addr 0x3c6a31c, size 0x74, virtual false, abstract: false, final false
inline void AddDependency(int64_t  dependentObject) ;

/// @brief Method AddFixup, addr 0x3c6a260, size 0xbc, virtual false, abstract: false, final false
inline void AddFixup(::System::Runtime::Serialization::FixupHolder*  fixup, ::System::Runtime::Serialization::ObjectManager*  manager) ;

/// @brief Method DecrementFixupsRemaining, addr 0x3c68f2c, size 0x24, virtual false, abstract: false, final false
inline void DecrementFixupsRemaining(::System::Runtime::Serialization::ObjectManager*  manager) ;

/// @brief Method IncrementDescendentFixups, addr 0x3c6ab5c, size 0x10, virtual false, abstract: false, final false
inline void IncrementDescendentFixups(int32_t  amount) ;

/// @brief Method MarkForCompletionWhenAvailable, addr 0x3c68fcc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method RemoveDependency, addr 0x3c68f50, size 0x18, virtual false, abstract: false, final false
inline void RemoveDependency(int64_t  id) ;

/// @brief Method SetFlags, addr 0x3c67be4, size 0xb8, virtual false, abstract: false, final false
inline void SetFlags() ;

/// @brief Method SetObjectValue, addr 0x3c67aec, size 0xf8, virtual false, abstract: false, final false
inline void SetObjectValue(::System::Object*  obj, ::System::Runtime::Serialization::ObjectManager*  manager) ;

/// @brief Method UpdateData, addr 0x3c69a64, size 0x184, virtual false, abstract: false, final false
inline void UpdateData(::System::Object*  obj, ::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::ISerializationSurrogate*  surrogate, int64_t  idOfContainer, ::System::Reflection::FieldInfo*  field, ::ArrayW<int32_t,::Array<int32_t>*>  arrayIndex, ::System::Runtime::Serialization::ObjectManager*  manager) ;

/// @brief Method UpdateDescendentDependencyChain, addr 0x3c6ab6c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c69200, size 0xdc, virtual false, abstract: false, final false
inline void _ctor(::StringW  obj, int64_t  objID, ::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::ISerializationSurrogate*  surrogate, int64_t  idOfContainingObj, ::System::Reflection::FieldInfo*  field, ::ArrayW<int32_t,::Array<int32_t>*>  arrayIndex) ;

/// @brief Method .ctor, addr 0x3c69884, size 0x1d0, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  obj, int64_t  objID, ::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::ISerializationSurrogate*  surrogate, int64_t  idOfContainingObj, ::System::Reflection::FieldInfo*  field, ::ArrayW<int32_t,::Array<int32_t>*>  arrayIndex) ;

/// @brief Method .ctor, addr 0x3c673dc, size 0x34, virtual false, abstract: false, final false
inline void _ctor(int64_t  objID) ;

/// @brief Method get_CanObjectValueChange, addr 0x3c677dc, size 0x20, virtual false, abstract: false, final false
inline bool get_CanObjectValueChange() ;

/// @brief Method get_CanSurrogatedObjectValueChange, addr 0x3c67a44, size 0xa8, virtual false, abstract: false, final false
inline bool get_CanSurrogatedObjectValueChange() ;

/// @brief Method get_CompletelyFixed, addr 0x3c677b8, size 0x24, virtual false, abstract: false, final false
inline bool get_CompletelyFixed() ;

/// @brief Method get_ContainerID, addr 0x3c6ac60, size 0x18, virtual false, abstract: false, final false
inline int64_t get_ContainerID() ;

/// @brief Method get_DependentObjects, addr 0x3c6ad4c, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::LongList* get_DependentObjects() ;

/// @brief Method get_DirectlyDependentObjects, addr 0x3c6ad00, size 0x8, virtual false, abstract: false, final false
inline int32_t get_DirectlyDependentObjects() ;

/// @brief Method get_HasISerializable, addr 0x3c68e3c, size 0xc, virtual false, abstract: false, final false
inline bool get_HasISerializable() ;

/// @brief Method get_HasSurrogate, addr 0x3c67a38, size 0xc, virtual false, abstract: false, final false
inline bool get_HasSurrogate() ;

/// @brief Method get_IsIncompleteObjectReference, addr 0x3c677fc, size 0xc, virtual false, abstract: false, final false
inline bool get_IsIncompleteObjectReference() ;

/// @brief Method get_ObjectValue, addr 0x3c6ad2c, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* get_ObjectValue() ;

/// @brief Method get_Reachable, addr 0x3c6ad08, size 0x8, virtual false, abstract: false, final false
inline bool get_Reachable() ;

/// @brief Method get_RequiresDelayedFixup, addr 0x3c69a54, size 0x10, virtual false, abstract: false, final false
inline bool get_RequiresDelayedFixup() ;

/// @brief Method get_RequiresSerInfoFixup, addr 0x3c6a0b0, size 0x1c, virtual false, abstract: false, final false
inline bool get_RequiresSerInfoFixup() ;

/// @brief Method get_RequiresValueTypeFixup, addr 0x3c67f38, size 0xc, virtual false, abstract: false, final false
inline bool get_RequiresValueTypeFixup() ;

/// @brief Method get_SerializationInfo, addr 0x3c6ad34, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::SerializationInfo* get_SerializationInfo() ;

/// @brief Method get_Surrogate, addr 0x3c6ad44, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::ISerializationSurrogate* get_Surrogate() ;

/// @brief Method get_TotalDependentObjects, addr 0x3c69be8, size 0xc, virtual false, abstract: false, final false
inline int32_t get_TotalDependentObjects() ;

/// @brief Method get_TypeLoadException, addr 0x3c6ad1c, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::TypeLoadExceptionHolder* get_TypeLoadException() ;

/// @brief Method get_TypeLoadExceptionReachable, addr 0x3c68f68, size 0x10, virtual false, abstract: false, final false
inline bool get_TypeLoadExceptionReachable() ;

/// @brief Method get_ValueFixup, addr 0x3c6ad5c, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::ValueTypeFixupInfo* get_ValueFixup() ;

/// @brief Method get_ValueTypeFixupPerformed, addr 0x3c67f44, size 0x38, virtual false, abstract: false, final false
inline bool get_ValueTypeFixupPerformed() ;

/// @brief Method set_DependentObjects, addr 0x3c6ad54, size 0x8, virtual false, abstract: false, final false
inline void set_DependentObjects(::System::Runtime::Serialization::LongList*  value) ;

/// @brief Method set_IsIncompleteObjectReference, addr 0x3c68818, size 0x10, virtual false, abstract: false, final false
inline void set_IsIncompleteObjectReference(bool  value) ;

/// @brief Method set_Reachable, addr 0x3c6ad10, size 0xc, virtual false, abstract: false, final false
inline void set_Reachable(bool  value) ;

/// @brief Method set_RequiresSerInfoFixup, addr 0x3c67f18, size 0x20, virtual false, abstract: false, final false
inline void set_RequiresSerInfoFixup(bool  value) ;

/// @brief Method set_SerializationInfo, addr 0x3c6ad3c, size 0x8, virtual false, abstract: false, final false
inline void set_SerializationInfo(::System::Runtime::Serialization::SerializationInfo*  value) ;

/// @brief Method set_TypeLoadException, addr 0x3c6ad24, size 0x8, virtual false, abstract: false, final false
inline void set_TypeLoadException(::System::Runtime::Serialization::TypeLoadExceptionHolder*  value) ;

/// @brief Method set_ValueTypeFixupPerformed, addr 0x3c68f78, size 0x14, virtual false, abstract: false, final false
