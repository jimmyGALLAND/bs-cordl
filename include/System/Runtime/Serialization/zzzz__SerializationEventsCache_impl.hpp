...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Runtime::Serialization::__SerializationEventsCache____c::*)()>(&::System::Runtime::Serialization::__SerializationEventsCache____c::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3c63f34;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Runtime::Serialization::SerializationEvents* (::System::Runtime::Serialization::__SerializationEventsCache____c::*)(::System::Type*)>(&::System::Runtime::Serialization::__SerializationEventsCache____c::_GetSerializationEventsForType_b__1_0)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x3c63f3c;
...
::cordl_internals::setStaticField<::System::Runtime::Serialization::__SerializationEventsCache____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::Serialization::__SerializationEventsCache____c*>::get>(std::forward<::System::Runtime::Serialization::__SerializationEventsCache____c*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Runtime::Serialization::__SerializationEventsCache____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::Serialization::__SerializationEventsCache____c*>::get>();
}
...
return ::cordl_internals::getStaticField<::System::Func_2<::System::Type*,::System::Runtime::Serialization::SerializationEvents*>*, "<>9__1_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::Serialization::__SerializationEventsCache____c*>::get>();
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Runtime::Serialization::__SerializationEventsCache____c*>());
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Runtime::Serialization::SerializationEvents* (*)(::System::Type*)>(&::System::Runtime::Serialization::SerializationEventsCache::GetSerializationEventsForType)> {
  constexpr static std::size_t size = 0x130;
  constexpr static std::size_t addrs = 0x3c63d1c;
