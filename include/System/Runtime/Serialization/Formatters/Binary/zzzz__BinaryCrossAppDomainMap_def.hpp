...
/// @brief Method Dump, addr 0x3c70718, size 0x4, virtual false, abstract: false, final false
inline void Dump() ;

static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryCrossAppDomainMap* New_ctor() ;

/// @brief Method Read, addr 0x3c706f0, size 0x28, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3c706e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
