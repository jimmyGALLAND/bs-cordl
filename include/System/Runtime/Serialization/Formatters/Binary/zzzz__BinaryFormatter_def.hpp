...
static __declspec(property(get=getStaticF_typeNameCache, put=setStaticF_typeNameCache)) ::System::Collections::Generic::Dictionary_2<::System::Type*,::System::Runtime::Serialization::Formatters::Binary::TypeInformation*>*  typeNameCache;
...
/// @brief Method Deserialize, addr 0x3c739bc, size 0xc, virtual true, abstract: false, final true
inline ::System::Object* Deserialize(::System::IO::Stream*  serializationStream) ;

/// @brief Method Deserialize, addr 0x3c739c8, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method Deserialize, addr 0x3c739d0, size 0x23c, virtual false, abstract: false, final false
...
/// @brief Method GetTypeInformation, addr 0x3c73ec0, size 0x24c, virtual false, abstract: false, final false
...
/// @brief Method Serialize, addr 0x3c73c0c, size 0xc, virtual true, abstract: false, final true
inline void Serialize(::System::IO::Stream*  serializationStream, ::System::Object*  graph) ;

/// @brief Method Serialize, addr 0x3c73c18, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method Serialize, addr 0x3c73c20, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c7393c, size 0x34, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3c73970, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method set_AssemblyFormat, addr 0x3c73924, size 0x8, virtual false, abstract: false, final false
inline void set_AssemblyFormat(::System::Runtime::Serialization::Formatters::FormatterAssemblyStyle  value) ;

/// @brief Method set_Binder, addr 0x3c73934, size 0x8, virtual true, abstract: false, final true
inline void set_Binder(::System::Runtime::Serialization::SerializationBinder*  value) ;

/// @brief Method set_SurrogateSelector, addr 0x3c7392c, size 0x8, virtual true, abstract: false, final true
