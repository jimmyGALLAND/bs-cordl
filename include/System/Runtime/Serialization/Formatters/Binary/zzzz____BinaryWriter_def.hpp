...
/// @brief Method InternalWriteItemNull, addr 0x3c74c0c, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method WriteArrayAsBytes, addr 0x3c75010, size 0x144, virtual false, abstract: false, final false
inline void WriteArrayAsBytes(::System::Array*  array, int32_t  typeLength) ;

/// @brief Method WriteAssembly, addr 0x3c757bc, size 0xd4, virtual false, abstract: false, final false
inline void WriteAssembly(::System::Type*  type, ::StringW  assemblyString, int32_t  assemId, bool  isNew) ;

/// @brief Method WriteBegin, addr 0x3c74198, size 0x4, virtual false, abstract: false, final false
inline void WriteBegin() ;

/// @brief Method WriteBoolean, addr 0x3c741bc, size 0x24, virtual false, abstract: false, final false
inline void WriteBoolean(bool  value) ;

/// @brief Method WriteByte, addr 0x3c6ebc4, size 0x20, virtual false, abstract: false, final false
inline void WriteByte(uint8_t  value) ;

/// @brief Method WriteBytes, addr 0x3c74204, size 0x24, virtual false, abstract: false, final false
inline void WriteBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  byteA, int32_t  offset, int32_t  size) ;

/// @brief Method WriteBytes, addr 0x3c741e0, size 0x24, virtual false, abstract: false, final false
inline void WriteBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method WriteChar, addr 0x3c74228, size 0x24, virtual false, abstract: false, final false
inline void WriteChar(char16_t  value) ;

/// @brief Method WriteChars, addr 0x3c7424c, size 0x24, virtual false, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t,::Array<char16_t>*>  value) ;

/// @brief Method WriteDateTime, addr 0x3c74484, size 0x78, virtual false, abstract: false, final false
inline void WriteDateTime(::System::DateTime  value) ;

/// @brief Method WriteDecimal, addr 0x3c74270, size 0xec, virtual false, abstract: false, final false
inline void WriteDecimal(::System::Decimal  value) ;

/// @brief Method WriteDelayedNullItem, addr 0x3c75778, size 0x10, virtual false, abstract: false, final false
inline void WriteDelayedNullItem() ;

/// @brief Method WriteDouble, addr 0x3c74380, size 0x24, virtual false, abstract: false, final false
inline void WriteDouble(double_t  value) ;

/// @brief Method WriteEnd, addr 0x3c7419c, size 0x20, virtual false, abstract: false, final false
inline void WriteEnd() ;

/// @brief Method WriteInt16, addr 0x3c743a4, size 0x24, virtual false, abstract: false, final false
inline void WriteInt16(int16_t  value) ;

/// @brief Method WriteInt32, addr 0x3c6ec08, size 0x24, virtual false, abstract: false, final false
inline void WriteInt32(int32_t  value) ;

/// @brief Method WriteInt64, addr 0x3c743c8, size 0x24, virtual false, abstract: false, final false
inline void WriteInt64(int64_t  value) ;

/// @brief Method WriteItem, addr 0x3c75728, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method WriteItemEnd, addr 0x3c75788, size 0x4, virtual false, abstract: false, final false
inline void WriteItemEnd() ;

/// @brief Method WriteItemObjectRef, addr 0x3c7578c, size 0x30, virtual false, abstract: false, final false
inline void WriteItemObjectRef(::System::Runtime::Serialization::Formatters::Binary::NameInfo*  nameInfo, int32_t  idRef) ;

/// @brief Method WriteJaggedArray, addr 0x3c75154, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method WriteMember, addr 0x3c7548c, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method WriteMemberNested, addr 0x3c756c4, size 0x1c, virtual false, abstract: false, final false
inline void WriteMemberNested(::System::Runtime::Serialization::Formatters::Binary::NameInfo*  memberNameInfo) ;

/// @brief Method WriteMemberObjectRef, addr 0x3c75630, size 0x94, virtual false, abstract: false, final false
inline void WriteMemberObjectRef(::System::Runtime::Serialization::Formatters::Binary::NameInfo*  memberNameInfo, int32_t  idRef) ;

/// @brief Method WriteMemberString, addr 0x3c756e0, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method WriteMethodCall, addr 0x3c7465c, size 0x70, virtual false, abstract: false, final false
inline void WriteMethodCall() ;

/// @brief Method WriteMethodReturn, addr 0x3c746cc, size 0x70, virtual false, abstract: false, final false
inline void WriteMethodReturn() ;

/// @brief Method WriteNullItem, addr 0x3c75768, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method WriteNullMember, addr 0x3c75594, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method WriteObject, addr 0x3c7473c, size 0x4d0, virtual false, abstract: false, final false
...
/// @brief Method WriteObjectByteArray, addr 0x3c7542c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method WriteObjectEnd, addr 0x3c74568, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method WriteObjectString, addr 0x3c74c9c, size 0x90, virtual false, abstract: false, final false
inline void WriteObjectString(int32_t  objectId, ::StringW  value) ;

/// @brief Method WriteRectangleArray, addr 0x3c752d4, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method WriteSByte, addr 0x3c743ec, size 0x20, virtual false, abstract: false, final false
inline void WriteSByte(int8_t  value) ;

/// @brief Method WriteSerializationHeader, addr 0x3c745cc, size 0x90, virtual false, abstract: false, final false
inline void WriteSerializationHeader(int32_t  topId, int32_t  headerId, int32_t  minorVersion, int32_t  majorVersion) ;

/// @brief Method WriteSerializationHeaderEnd, addr 0x3c7456c, size 0x60, virtual false, abstract: false, final false
inline void WriteSerializationHeaderEnd() ;

/// @brief Method WriteSingle, addr 0x3c7435c, size 0x24, virtual false, abstract: false, final false
inline void WriteSingle(float_t  value) ;

/// @brief Method WriteSingleArray, addr 0x3c74d2c, size 0x2e4, virtual false, abstract: false, final false
...
/// @brief Method WriteString, addr 0x3c6ebe4, size 0x24, virtual false, abstract: false, final false
inline void WriteString(::StringW  value) ;

/// @brief Method WriteTimeSpan, addr 0x3c7440c, size 0x78, virtual false, abstract: false, final false
inline void WriteTimeSpan(::System::TimeSpan  value) ;

/// @brief Method WriteUInt16, addr 0x3c744fc, size 0x24, virtual false, abstract: false, final false
inline void WriteUInt16(uint16_t  value) ;

/// @brief Method WriteUInt32, addr 0x3c74520, size 0x24, virtual false, abstract: false, final false
inline void WriteUInt32(uint32_t  value) ;

/// @brief Method WriteUInt64, addr 0x3c74544, size 0x24, virtual false, abstract: false, final false
inline void WriteUInt64(uint64_t  value) ;

/// @brief Method WriteValue, addr 0x3c6f4ec, size 0x758, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c73e10, size 0xb0, virtual false, abstract: false, final false
