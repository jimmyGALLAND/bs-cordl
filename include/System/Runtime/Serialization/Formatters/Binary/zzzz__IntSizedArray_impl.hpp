...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Runtime::Serialization::Formatters::Binary::IntSizedArray::*)()>(&::System::Runtime::Serialization::Formatters::Binary::IntSizedArray::_ctor)> {
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x3c7bac4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Runtime::Serialization::Formatters::Binary::IntSizedArray::*)(::System::Runtime::Serialization::Formatters::Binary::IntSizedArray*)>(&::System::Runtime::Serialization::Formatters::Binary::IntSizedArray::_ctor)> {
  constexpr static std::size_t size = 0xdc;
  constexpr static std::size_t addrs = 0x3c82aa8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Runtime::Serialization::Formatters::Binary::IntSizedArray*>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Object* (::System::Runtime::Serialization::Formatters::Binary::IntSizedArray::*)()>(&::System::Runtime::Serialization::Formatters::Binary::IntSizedArray::Clone)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x3c82b84;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::System::Runtime::Serialization::Formatters::Binary::IntSizedArray::*)(int32_t)>(&::System::Runtime::Serialization::Formatters::Binary::IntSizedArray::get_Item)> {
  constexpr static std::size_t size = 0x78;
  constexpr static std::size_t addrs = 0x3c7bb2c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Runtime::Serialization::Formatters::Binary::IntSizedArray::*)(int32_t, int32_t)>(&::System::Runtime::Serialization::Formatters::Binary::IntSizedArray::set_Item)> {
  constexpr static std::size_t size = 0xb8;
  constexpr static std::size_t addrs = 0x3c7bba4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Runtime::Serialization::Formatters::Binary::IntSizedArray::*)(int32_t)>(&::System::Runtime::Serialization::Formatters::Binary::IntSizedArray::IncreaseCapacity)> {
  constexpr static std::size_t size = 0x218;
  constexpr static std::size_t addrs = 0x3c82bdc;
...
constexpr ::ArrayW<int32_t,::Array<int32_t>*> const& System::Runtime::Serialization::Formatters::Binary::IntSizedArray::__cordl_internal_get_objects() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___objects;
}
constexpr void System::Runtime::Serialization::Formatters::Binary::IntSizedArray::__cordl_internal_set_objects(::ArrayW<int32_t,::Array<int32_t>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<int32_t,::Array<int32_t>*>& System::Runtime::Serialization::Formatters::Binary::IntSizedArray::__cordl_internal_get_negObjects()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___negObjects;
}
constexpr ::ArrayW<int32_t,::Array<int32_t>*> const& System::Runtime::Serialization::Formatters::Binary::IntSizedArray::__cordl_internal_get_negObjects() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___negObjects;
}
constexpr void System::Runtime::Serialization::Formatters::Binary::IntSizedArray::__cordl_internal_set_negObjects(::ArrayW<int32_t,::Array<int32_t>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
