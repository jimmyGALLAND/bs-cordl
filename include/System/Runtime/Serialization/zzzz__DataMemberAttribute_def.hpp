...
/// @brief Method get_EmitDefaultValue, addr 0x41a38dc, size 0x8, virtual false, abstract: false, final false
inline bool get_EmitDefaultValue() ;

/// @brief Method get_IsRequired, addr 0x41a38d4, size 0x8, virtual false, abstract: false, final false
inline bool get_IsRequired() ;

/// @brief Method get_Name, addr 0x41a38c4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Order, addr 0x41a38cc, size 0x8, virtual false, abstract: false, final false
