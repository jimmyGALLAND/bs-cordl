...
/// @brief Method .ctor, addr 0x3c62ad8, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  frameworkName) ;

/// @brief Method set_FrameworkDisplayName, addr 0x3c62b4c, size 0x8, virtual false, abstract: false, final false
