...
static __declspec(property(get=getStaticF_Int32Tasks, put=setStaticF_Int32Tasks)) ::ArrayW<::System::Threading::Tasks::Task_1<int32_t>*,::Array<::System::Threading::Tasks::Task_1<int32_t>*>*>  Int32Tasks;
...
/// @brief Method CreateInt32Tasks, addr 0x3c8970c, size 0x108, virtual false, abstract: false, final false
