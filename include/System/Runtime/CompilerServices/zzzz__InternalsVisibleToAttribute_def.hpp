...
/// @brief Method .ctor, addr 0x3c8a39c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  assemblyName) ;

/// @brief Method set_AllInternalsVisible, addr 0x3c8a3cc, size 0xc, virtual false, abstract: false, final false
