...
namespace System::Runtime::CompilerServices {
template<typename T>
class __CallSiteBinder__LambdaSignature_1;
}
namespace System {
class Object;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ObjectModel::ReadOnlyCollection_1<::System::Linq::Expressions::ParameterExpression*>*> const& __cordl_internal_get_Parameters() const;
...
// Declarations
template<typename T>
using LambdaSignature_1 = ::System::Runtime::CompilerServices::__CallSiteBinder__LambdaSignature_1<T>;
...
template<typename T>
static inline ::System::Linq::Expressions::Expression_1<T>* Stitch(::System::Linq::Expressions::Expression*  binding, ::System::Runtime::CompilerServices::__CallSiteBinder__LambdaSignature_1<T>*  signature) ;
...
/// @brief Method .ctor, addr 0x4069144, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Linq::Expressions::LabelTarget* getStaticF__UpdateLabel_k__BackingField() ;

/// @brief Method get_UpdateLabel, addr 0x406914c, size 0x58, virtual false, abstract: false, final false
