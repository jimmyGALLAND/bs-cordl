...
/// @brief Field Sometimes value: static_cast<int32_t>(0x2)
...
static_assert(::cordl_internals::size_check_v<::System::Runtime::CompilerServices::LoadHint, 0x4>, "Size mismatch!");
