...
::cordl_internals::setStaticField<::System::Threading::Tasks::Task_1<TResult>*, "s_defaultResultTask", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<TResult>>::get>(std::forward<::System::Threading::Tasks::Task_1<TResult>*>(value));
}
template<typename TResult>
...
return ::cordl_internals::getStaticField<::System::Threading::Tasks::Task_1<TResult>*, "s_defaultResultTask", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<TResult>>::get>();
}
template<typename TResult>
...
inline void System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<TResult>::Start(ByRef<TStateMachine>  stateMachine)  {
...
// Ctor Parameters [CppParam { name: "m_coreState", ty: "::System::Runtime::CompilerServices::AsyncMethodBuilderCore", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_task", ty: "::System::Threading::Tasks::Task_1<TResult>*", modifiers: "", def_value: Some("nullptr") }]
template<typename TResult>
