...
/// @brief Method .ctor, addr 0x3c88374, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  assemblyFullName) ;

/// @brief Method get_AssemblyFullName, addr 0x3c883f4, size 0x8, virtual false, abstract: false, final false
