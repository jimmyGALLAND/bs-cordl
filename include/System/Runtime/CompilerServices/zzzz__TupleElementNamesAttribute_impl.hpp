...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Runtime::CompilerServices::TupleElementNamesAttribute::*)(::ArrayW<::StringW,::Array<::StringW>*>)>(&::System::Runtime::CompilerServices::TupleElementNamesAttribute::_ctor)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x3c88300;
...
inline ::System::Runtime::CompilerServices::TupleElementNamesAttribute* System::Runtime::CompilerServices::TupleElementNamesAttribute::New_ctor(::ArrayW<::StringW,::Array<::StringW>*>  transformNames)  {
