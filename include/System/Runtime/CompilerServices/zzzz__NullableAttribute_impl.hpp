...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Runtime::CompilerServices::NullableAttribute::*)(uint8_t)>(&::System::Runtime::CompilerServices::NullableAttribute::_ctor)> {
  constexpr static std::size_t size = 0x80;
  constexpr static std::size_t addrs = 0x3de65f0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Runtime::CompilerServices::NullableAttribute::*)(::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::System::Runtime::CompilerServices::NullableAttribute::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x3de6670;
...
constexpr ::ArrayW<uint8_t,::Array<uint8_t>*>& System::Runtime::CompilerServices::NullableAttribute::__cordl_internal_get_NullableFlags()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___NullableFlags;
}
constexpr ::ArrayW<uint8_t,::Array<uint8_t>*> const& System::Runtime::CompilerServices::NullableAttribute::__cordl_internal_get_NullableFlags() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___NullableFlags;
}
constexpr void System::Runtime::CompilerServices::NullableAttribute::__cordl_internal_set_NullableFlags(::ArrayW<uint8_t,::Array<uint8_t>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Runtime::CompilerServices::NullableAttribute*>(_cordl_fixed_empty_name_whitespace));
}
