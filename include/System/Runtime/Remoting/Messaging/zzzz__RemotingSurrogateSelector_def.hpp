...
/// @brief Method GetSurrogate, addr 0x3c6128c, size 0x19c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c61284, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
