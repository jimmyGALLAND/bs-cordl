...
public:
// Declarations
/// @brief Method LogicalGetData, addr 0x3c55388, size 0x4c, virtual false, abstract: false, final false
static inline ::System::Object* LogicalGetData(::StringW  name) ;

/// @brief Method LogicalSetData, addr 0x3c553e4, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method SetCurrentCallContext, addr 0x3c55380, size 0x8, virtual false, abstract: false, final false
static inline ::System::Object* SetCurrentCallContext(::System::Runtime::Remoting::Messaging::LogicalCallContext*  ctx) ;

/// @brief Method SetLogicalCallContext, addr 0x3c3f8dc, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c55378, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
