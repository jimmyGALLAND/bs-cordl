...
/// @brief Method CheckPath, addr 0x3c3a6b0, size 0xe0, virtual false, abstract: false, final false
inline bool CheckPath(::StringW  path) ;

/// @brief Method ExtractAssembly, addr 0x3c3d6b4, size 0xc0, virtual false, abstract: false, final false
inline ::StringW ExtractAssembly(ByRef<::StringW>  type) ;

/// @brief Method GetNotNull, addr 0x3c3d580, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method OnChars, addr 0x3c3d774, size 0x4, virtual true, abstract: false, final true
inline void OnChars(::StringW  ch) ;

/// @brief Method OnEndElement, addr 0x3c3d124, size 0x80, virtual true, abstract: false, final true
inline void OnEndElement(::StringW  name) ;

/// @brief Method OnEndParsing, addr 0x3c3d778, size 0xf4, virtual true, abstract: false, final true
inline void OnEndParsing(::Mono::Xml::SmallXmlParser*  parser) ;

/// @brief Method OnIgnorableWhitespace, addr 0x3c3a798, size 0x4, virtual true, abstract: false, final true
inline void OnIgnorableWhitespace(::StringW  s) ;

/// @brief Method OnProcessingInstruction, addr 0x3c3a794, size 0x4, virtual true, abstract: false, final true
inline void OnProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method OnStartElement, addr 0x3c3a79c, size 0x1b4, virtual true, abstract: false, final true
inline void OnStartElement(::StringW  name, ::Mono::Xml::__SmallXmlParser__IAttrList*  attrs) ;

/// @brief Method OnStartParsing, addr 0x3c3a790, size 0x4, virtual true, abstract: false, final true
inline void OnStartParsing(::Mono::Xml::SmallXmlParser*  parser) ;

/// @brief Method ParseElement, addr 0x3c3a950, size 0xe70, virtual false, abstract: false, final false
inline void ParseElement(::StringW  name, ::Mono::Xml::__SmallXmlParser__IAttrList*  attrs) ;

/// @brief Method ParseTime, addr 0x3c3d1a4, size 0x3dc, virtual false, abstract: false, final false
inline ::System::TimeSpan ParseTime(::StringW  s) ;

/// @brief Method ReadChannel, addr 0x3c3c070, size 0x3bc, virtual false, abstract: false, final false
inline void ReadChannel(::Mono::Xml::__SmallXmlParser__IAttrList*  attrs, bool  isTemplate) ;

/// @brief Method ReadClientActivated, addr 0x3c3cafc, size 0x140, virtual false, abstract: false, final false
inline void ReadClientActivated(::Mono::Xml::__SmallXmlParser__IAttrList*  attrs) ;

/// @brief Method ReadClientWellKnown, addr 0x3c3c828, size 0xf0, virtual false, abstract: false, final false
inline void ReadClientWellKnown(::Mono::Xml::__SmallXmlParser__IAttrList*  attrs) ;

/// @brief Method ReadCustomProviderData, addr 0x3c3b7c0, size 0x360, virtual false, abstract: false, final false
inline void ReadCustomProviderData(::StringW  name, ::Mono::Xml::__SmallXmlParser__IAttrList*  attrs) ;

/// @brief Method ReadInteropXml, addr 0x3c3cd00, size 0x1a0, virtual false, abstract: false, final false
inline void ReadInteropXml(::Mono::Xml::__SmallXmlParser__IAttrList*  attrs, bool  isElement) ;

/// @brief Method ReadLifetine, addr 0x3c3bb20, size 0x550, virtual false, abstract: false, final false
inline void ReadLifetine(::Mono::Xml::__SmallXmlParser__IAttrList*  attrs) ;

/// @brief Method ReadPreload, addr 0x3c3cea0, size 0x284, virtual false, abstract: false, final false
inline void ReadPreload(::Mono::Xml::__SmallXmlParser__IAttrList*  attrs) ;

/// @brief Method ReadProvider, addr 0x3c3c42c, size 0x3fc, virtual false, abstract: false, final false
...
/// @brief Method ReadServiceActivated, addr 0x3c3cc3c, size 0xc4, virtual false, abstract: false, final false
inline void ReadServiceActivated(::Mono::Xml::__SmallXmlParser__IAttrList*  attrs) ;

/// @brief Method ReadServiceWellKnown, addr 0x3c3c918, size 0x1e4, virtual false, abstract: false, final false
inline void ReadServiceWellKnown(::Mono::Xml::__SmallXmlParser__IAttrList*  attrs) ;

/// @brief Method ValidatePath, addr 0x3c3a5d0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c381c8, size 0xac, virtual false, abstract: false, final false
