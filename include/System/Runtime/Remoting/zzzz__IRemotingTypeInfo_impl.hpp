...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::System::Runtime::Remoting::IRemotingTypeInfo::*)()>(&::System::Runtime::Remoting::IRemotingTypeInfo::get_TypeName)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::System::Runtime::Remoting::IRemotingTypeInfo::*)(::System::Type*, ::System::Object*)>(&::System::Runtime::Remoting::IRemotingTypeInfo::CanCastTo)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
