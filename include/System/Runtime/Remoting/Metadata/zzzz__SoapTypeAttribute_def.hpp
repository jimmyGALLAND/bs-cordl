...
/// @brief Method SetReflectionObject, addr 0x3c5515c, size 0x21c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c5511c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsInteropXmlElement, addr 0x3c5514c, size 0x8, virtual false, abstract: false, final false
inline bool get_IsInteropXmlElement() ;

/// @brief Method get_IsInteropXmlType, addr 0x3c55154, size 0x8, virtual false, abstract: false, final false
inline bool get_IsInteropXmlType() ;

/// @brief Method get_UseAttribute, addr 0x3c55124, size 0x8, virtual true, abstract: false, final false
inline bool get_UseAttribute() ;

/// @brief Method get_XmlElementName, addr 0x3c5512c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_XmlElementName() ;

/// @brief Method get_XmlNamespace, addr 0x3c55134, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_XmlNamespace() ;

/// @brief Method get_XmlTypeName, addr 0x3c5513c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_XmlTypeName() ;

/// @brief Method get_XmlTypeNamespace, addr 0x3c55144, size 0x8, virtual false, abstract: false, final false
