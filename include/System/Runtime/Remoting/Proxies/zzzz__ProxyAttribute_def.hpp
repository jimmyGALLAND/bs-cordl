...
/// @brief Method CreateInstance, addr 0x3c471d8, size 0xf8, virtual true, abstract: false, final false
inline ::System::MarshalByRefObject* CreateInstance(::System::Type*  serverType) ;

/// @brief Method CreateProxy, addr 0x3c472d0, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method GetPropertiesForNewContext, addr 0x3c47324, size 0x4, virtual true, abstract: false, final true
inline void GetPropertiesForNewContext(::System::Runtime::Remoting::Activation::IConstructionCallMessage*  msg) ;

/// @brief Method IsContextOK, addr 0x3c47328, size 0x8, virtual true, abstract: false, final true
