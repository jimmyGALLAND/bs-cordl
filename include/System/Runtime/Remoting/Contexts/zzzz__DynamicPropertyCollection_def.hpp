...
/// @brief Method .ctor, addr 0x3c4f0cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method FindProperty, addr 0x3c4ef68, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method NotifyMessage, addr 0x3c4d268, size 0x658, virtual false, abstract: false, final false
inline void NotifyMessage(bool  start, ::System::Runtime::Remoting::Messaging::IMessage*  msg, bool  client_site, bool  async) ;

/// @brief Method RegisterDynamicProperty, addr 0x3c4cc40, size 0x2e4, virtual false, abstract: false, final false
inline bool RegisterDynamicProperty(::System::Runtime::Remoting::Contexts::IDynamicProperty*  prop) ;

/// @brief Method UnregisterDynamicProperty, addr 0x3c4cf9c, size 0x16c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c4d108, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HasProperties, addr 0x3c4ca3c, size 0x30, virtual false, abstract: false, final false
