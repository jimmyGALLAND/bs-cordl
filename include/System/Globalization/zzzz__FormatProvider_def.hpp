...
/// @brief Method get_digits, addr 0x41a30e8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method FindSection, addr 0x41a28dc, size 0x14c, virtual false, abstract: false, final false
static inline int32_t FindSection(::System::ReadOnlySpan_1<char16_t>  format, int32_t  section) ;

/// @brief Method FormatCurrency, addr 0x41a11ec, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method FormatExponent, addr 0x41a25ec, size 0x2f0, virtual false, abstract: false, final false
...
/// @brief Method FormatFixed, addr 0x41a144c, size 0x50c, virtual false, abstract: false, final false
...
/// @brief Method FormatGeneral, addr 0x41a1ddc, size 0x388, virtual false, abstract: false, final false
...
/// @brief Method FormatNumber, addr 0x41a1958, size 0x248, virtual false, abstract: false, final false
...
/// @brief Method FormatPercent, addr 0x41a2164, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method FormatScientific, addr 0x41a1ba0, size 0x23c, virtual false, abstract: false, final false
...
/// @brief Method Int32ToDecChars, addr 0x41a10c0, size 0x5c, virtual false, abstract: false, final false
static inline void Int32ToDecChars(::cordl_internals::Ptr<char16_t>  buffer, ByRef<int32_t>  index, uint32_t  value, int32_t  digits) ;

/// @brief Method IsWhite, addr 0x41a07e4, size 0x28, virtual false, abstract: false, final false
static inline bool IsWhite(char16_t  ch) ;

/// @brief Method MatchChars, addr 0x41a080c, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method MatchChars, addr 0x41a08d0, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method NumberToString, addr 0x419f0bc, size 0x558, virtual false, abstract: false, final false
...
/// @brief Method NumberToStringFormat, addr 0x419f614, size 0x1098, virtual false, abstract: false, final false
...
/// @brief Method ParseFormatSpecifier, addr 0x419ef78, size 0x144, virtual false, abstract: false, final false
static inline char16_t ParseFormatSpecifier(::System::ReadOnlySpan_1<char16_t>  format, ByRef<int32_t>  digits) ;

/// @brief Method ParseNumber, addr 0x41a092c, size 0x704, virtual false, abstract: false, final false
static inline bool ParseNumber(ByRef<::cordl_internals::Ptr<char16_t>>  str, ::cordl_internals::Ptr<char16_t>  strEnd, ::System::Globalization::NumberStyles  options, ByRef<::GlobalNamespace::__FormatProvider__Number__NumberBuffer>  number, ::System::Text::StringBuilder*  sb, ::System::Globalization::NumberFormatInfo*  numfmt, bool  parseDecimal) ;

/// @brief Method RoundNumber, addr 0x41a111c, size 0xd0, virtual false, abstract: false, final false
static inline void RoundNumber(ByRef<::GlobalNamespace::__FormatProvider__Number__NumberBuffer>  number, int32_t  pos) ;

/// @brief Method TrailingZeros, addr 0x41a1030, size 0x90, virtual false, abstract: false, final false
static inline bool TrailingZeros(::System::ReadOnlySpan_1<char16_t>  s, int32_t  index) ;

/// @brief Method TryStringToNumber, addr 0x41a06ac, size 0x138, virtual false, abstract: false, final false
static inline bool TryStringToNumber(::System::ReadOnlySpan_1<char16_t>  str, ::System::Globalization::NumberStyles  options, ByRef<::GlobalNamespace::__FormatProvider__Number__NumberBuffer>  number, ::System::Text::StringBuilder*  sb, ::System::Globalization::NumberFormatInfo*  numfmt, bool  parseDecimal) ;
...
/// @brief Method wcslen, addr 0x41a23c4, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method FormatBigInteger, addr 0x419ee14, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method TryStringToBigInteger, addr 0x419d474, size 0xf4, virtual false, abstract: false, final false
static inline bool TryStringToBigInteger(::System::ReadOnlySpan_1<char16_t>  s, ::System::Globalization::NumberStyles  styles, ::System::Globalization::NumberFormatInfo*  numberFormatInfo, ::System::Text::StringBuilder*  receiver, ByRef<int32_t>  precision, ByRef<int32_t>  scale, ByRef<bool>  sign) ;
