...
static __declspec(property(get=getStaticF_codePageDataPtr, put=setStaticF_codePageDataPtr)) ::ArrayW<::System::Globalization::InternalCodePageDataItem,::Array<::System::Globalization::InternalCodePageDataItem>*>  codePageDataPtr;

/// @brief Field encodingDataPtr, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_encodingDataPtr, put=setStaticF_encodingDataPtr)) ::ArrayW<::System::Globalization::InternalEncodingDataItem,::Array<::System::Globalization::InternalEncodingDataItem>*>  encodingDataPtr;

/// @brief Field hashByCodePage, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_hashByCodePage, put=setStaticF_hashByCodePage)) ::System::Collections::Generic::Dictionary_2<int32_t,::System::Globalization::CodePageDataItem*>*  hashByCodePage;
...
/// @brief Method ENC, addr 0x3d184dc, size 0x8, virtual false, abstract: false, final false
static inline ::System::Globalization::InternalEncodingDataItem ENC(::StringW  name, uint16_t  cp) ;

/// @brief Method GetCodePageDataItem, addr 0x3d1de94, size 0x2bc, virtual false, abstract: false, final false
static inline ::System::Globalization::CodePageDataItem* GetCodePageDataItem(int32_t  codepage) ;

/// @brief Method GetCodePageFromName, addr 0x3d1dc18, size 0x27c, virtual false, abstract: false, final false
static inline int32_t GetCodePageFromName(::StringW  name) ;

/// @brief Method GetNumEncodingItems, addr 0x3d18478, size 0x64, virtual false, abstract: false, final false
static inline int32_t GetNumEncodingItems() ;

/// @brief Method MapCodePageDataItem, addr 0x3d184e4, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method internalGetCodePageFromName, addr 0x3d1d9a8, size 0x250, virtual false, abstract: false, final false
