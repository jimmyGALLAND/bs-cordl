...
/// @brief Field calendars, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_calendars, put=__cordl_internal_set_calendars)) ::ArrayW<::System::Globalization::CalendarData*,::Array<::System::Globalization::CalendarData*>*>  calendars;
...
/// @brief Method AbbrevEraNames, addr 0x3d17ae0, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> AbbrevEraNames(int32_t  calendarId) ;

/// @brief Method AbbreviatedDayNames, addr 0x3d17b88, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> AbbreviatedDayNames(int32_t  calendarId) ;

/// @brief Method AbbreviatedEnglishEraNames, addr 0x3d17afc, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> AbbreviatedEnglishEraNames(int32_t  calendarId) ;

/// @brief Method AbbreviatedGenitiveMonthNames, addr 0x3d17bf8, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> AbbreviatedGenitiveMonthNames(int32_t  calendarId) ;

/// @brief Method AbbreviatedMonthNames, addr 0x3d17bdc, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> AbbreviatedMonthNames(int32_t  calendarId) ;

/// @brief Method DateSeparator, addr 0x3d17c4c, size 0xac, virtual false, abstract: false, final false
inline ::StringW DateSeparator(int32_t  calendarId) ;

/// @brief Method DayNames, addr 0x3d17b6c, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> DayNames(int32_t  calendarId) ;

/// @brief Method EraNames, addr 0x3d17ac4, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> EraNames(int32_t  calendarId) ;

/// @brief Method GenitiveMonthNames, addr 0x3d17bc0, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> GenitiveMonthNames(int32_t  calendarId) ;

/// @brief Method GetCalendar, addr 0x3d0cbc8, size 0x114, virtual false, abstract: false, final false
inline ::System::Globalization::CalendarData* GetCalendar(int32_t  calendarId) ;

/// @brief Method GetCalendarIds, addr 0x3d17994, size 0xd8, virtual false, abstract: false, final false
inline ::ArrayW<::System::Globalization::CalendarId,::Array<::System::Globalization::CalendarId>*> GetCalendarIds() ;

/// @brief Method GetCultureData, addr 0x3d17574, size 0xe8, virtual false, abstract: false, final false
static inline ::System::Globalization::CultureData* GetCultureData(::StringW  cultureName, bool  useUserOverride) ;

/// @brief Method GetCultureData, addr 0x3d1765c, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method GetDateSeparator, addr 0x3d17cf8, size 0x48, virtual false, abstract: false, final false
static inline ::StringW GetDateSeparator(::StringW  format) ;

/// @brief Method GetNFIValues, addr 0x3d122a4, size 0x198, virtual false, abstract: false, final false
inline void GetNFIValues(::System::Globalization::NumberFormatInfo*  nfi) ;

/// @brief Method GetSeparator, addr 0x3d17d40, size 0x104, virtual false, abstract: false, final false
static inline ::StringW GetSeparator(::StringW  format, ::StringW  timeParts) ;

/// @brief Method IndexOfTimePart, addr 0x3d17e44, size 0xec, virtual false, abstract: false, final false
static inline int32_t IndexOfTimePart(::StringW  format, int32_t  startIndex, ::StringW  timeParts) ;

/// @brief Method LeapYearMonthNames, addr 0x3d17c14, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> LeapYearMonthNames(int32_t  calendarId) ;

/// @brief Method LongDates, addr 0x3d17b34, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> LongDates(int32_t  calendarId) ;

/// @brief Method MonthDay, addr 0x3d17c30, size 0x1c, virtual false, abstract: false, final false
inline ::StringW MonthDay(int32_t  calendarId) ;

/// @brief Method MonthNames, addr 0x3d17ba4, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method ReescapeWin32String, addr 0x3d0c100, size 0x4, virtual false, abstract: false, final false
static inline ::StringW ReescapeWin32String(::StringW  str) ;

/// @brief Method ReescapeWin32Strings, addr 0x3d0c0fc, size 0x4, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> ReescapeWin32Strings(::ArrayW<::StringW,::Array<::StringW>*>  array) ;

/// @brief Method ShortDates, addr 0x3d17b18, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> ShortDates(int32_t  calendarId) ;

/// @brief Method UnescapeNlsString, addr 0x3d17f30, size 0x19c, virtual false, abstract: false, final false
static inline ::StringW UnescapeNlsString(::StringW  str, int32_t  start, int32_t  end) ;

/// @brief Method YearMonths, addr 0x3d17b50, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3d1754c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method create_group_sizes_array, addr 0x3d18128, size 0xb4, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> create_group_sizes_array(int32_t  gs0, int32_t  gs1) ;

/// @brief Method fill_culture_data, addr 0x3d17770, size 0x4, virtual false, abstract: false, final false
inline void fill_culture_data(int32_t  datetimeIndex) ;

/// @brief Method fill_number_data, addr 0x3d181dc, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_CalendarIds, addr 0x3d177d4, size 0x1c0, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> get_CalendarIds() ;

/// @brief Method get_CultureName, addr 0x3d17a6c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_CultureName() ;

/// @brief Method get_IFIRSTDAYOFWEEK, addr 0x3d177ac, size 0x8, virtual false, abstract: false, final false
inline int32_t get_IFIRSTDAYOFWEEK() ;

/// @brief Method get_IFIRSTWEEKOFYEAR, addr 0x3d177b4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_IFIRSTWEEKOFYEAR() ;

/// @brief Method get_Invariant, addr 0x3d13720, size 0x30c, virtual false, abstract: false, final false
static inline ::System::Globalization::CultureData* get_Invariant() ;

/// @brief Method get_IsInvariantCulture, addr 0x3d1243c, size 0xc, virtual false, abstract: false, final false
inline bool get_IsInvariantCulture() ;

/// @brief Method get_LongTimes, addr 0x3d17774, size 0x18, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_LongTimes() ;

/// @brief Method get_SAM1159, addr 0x3d177bc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SAM1159() ;

/// @brief Method get_SCOMPAREINFO, addr 0x3d17a74, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_SCOMPAREINFO() ;

/// @brief Method get_SISO639LANGNAME, addr 0x3d177a4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SISO639LANGNAME() ;

/// @brief Method get_SPM2359, addr 0x3d177c4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SPM2359() ;

/// @brief Method get_STEXTINFO, addr 0x3d17ab4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_STEXTINFO() ;

/// @brief Method get_ShortTimes, addr 0x3d1778c, size 0x18, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_ShortTimes() ;

/// @brief Method get_TimeSeparator, addr 0x3d177cc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_TimeSeparator() ;

/// @brief Method get_UseUserOverride, addr 0x3d17abc, size 0x8, virtual false, abstract: false, final false
inline bool get_UseUserOverride() ;

/// @brief Method idx2string, addr 0x3d180e4, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method strlen, addr 0x3d180cc, size 0x18, virtual false, abstract: false, final false
