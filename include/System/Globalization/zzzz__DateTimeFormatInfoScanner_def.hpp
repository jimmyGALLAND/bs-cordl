...
/// @brief Method AddDateWordOrPostfix, addr 0x3d01924, size 0x2bc, virtual false, abstract: false, final false
inline void AddDateWordOrPostfix(::StringW  formatPostfix, ::StringW  str) ;

/// @brief Method AddDateWords, addr 0x3d01d30, size 0x1e0, virtual false, abstract: false, final false
inline int32_t AddDateWords(::StringW  pattern, int32_t  index, ::StringW  formatPostfix) ;

/// @brief Method AddIgnorableSymbols, addr 0x3d01be0, size 0x150, virtual false, abstract: false, final false
inline void AddIgnorableSymbols(::StringW  text) ;

/// @brief Method ArrayElementsBeginWithDigit, addr 0x3d02280, size 0x25c, virtual false, abstract: false, final false
static inline bool ArrayElementsBeginWithDigit(::ArrayW<::StringW,::Array<::StringW>*>  array) ;

/// @brief Method ArrayElementsHaveSpace, addr 0x3d024dc, size 0xf8, virtual false, abstract: false, final false
static inline bool ArrayElementsHaveSpace(::ArrayW<::StringW,::Array<::StringW>*>  array) ;

/// @brief Method EqualStringArrays, addr 0x3d021d0, size 0xb0, virtual false, abstract: false, final false
static inline bool EqualStringArrays(::ArrayW<::StringW,::Array<::StringW>*>  array1, ::ArrayW<::StringW,::Array<::StringW>*>  array2) ;

/// @brief Method GetDateWordsOfDTFI, addr 0x3d0027c, size 0x290, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> GetDateWordsOfDTFI(::System::Globalization::DateTimeFormatInfo*  dtfi) ;

/// @brief Method GetFormatFlagGenitiveMonth, addr 0x3cfe69c, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetFormatFlagUseHebrewCalendar, addr 0x3cfe7cc, size 0x10, virtual false, abstract: false, final false
static inline ::System::Globalization::FORMATFLAGS GetFormatFlagUseHebrewCalendar(int32_t  calID) ;

/// @brief Method GetFormatFlagUseSpaceInDayNames, addr 0x3cfe79c, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GetFormatFlagUseSpaceInMonthNames, addr 0x3cfe6dc, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method ScanDateWord, addr 0x3d01f94, size 0x23c, virtual false, abstract: false, final false
inline void ScanDateWord(::StringW  pattern) ;

/// @brief Method ScanRepeatChar, addr 0x3d01f10, size 0x84, virtual false, abstract: false, final false
static inline int32_t ScanRepeatChar(::StringW  pattern, char16_t  ch, int32_t  index, ByRef<int32_t>  count) ;

/// @brief Method SkipWhiteSpacesAndNonLetter, addr 0x3d01828, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3d00200, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>* getStaticF_s_knownWords() ;

/// @brief Method get_KnownWords, addr 0x3d01440, size 0x3e8, virtual false, abstract: false, final false
