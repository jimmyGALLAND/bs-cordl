...
// Ctor Parameters [CppParam { name: "codePage", ty: "uint16_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "uiFamilyCodePage", ty: "uint16_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "flags", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Names", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }]
