...
public:
// Declarations
/// @brief Method .ctor, addr 0x3d02b68, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "token", ty: "::System::Globalization::__HebrewNumber__HebrewToken", modifiers: "", def_value: None }, CppParam { name: "value", ty: "int16_t", modifiers: "", def_value: None }]
...
static __declspec(property(get=getStaticF_s_hebrewValues, put=setStaticF_s_hebrewValues)) ::ArrayW<::System::Globalization::__HebrewNumber__HebrewValue,::Array<::System::Globalization::__HebrewNumber__HebrewValue>*>  s_hebrewValues;
...
static __declspec(property(get=getStaticF_s_numberPasingState, put=setStaticF_s_numberPasingState)) ::ArrayW<::System::Globalization::__HebrewNumber__HS,::Array<::System::Globalization::__HebrewNumber__HS>*>  s_numberPasingState;

/// @brief Method IsDigit, addr 0x3d007a8, size 0xd0, virtual false, abstract: false, final false
static inline bool IsDigit(char16_t  ch) ;

/// @brief Method ParseByChar, addr 0x3d00884, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x3d02634, size 0x284, virtual false, abstract: false, final false
