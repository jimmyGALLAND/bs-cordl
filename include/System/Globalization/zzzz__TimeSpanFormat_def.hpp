...
/// @brief Method Init, addr 0x3d04298, size 0x37c, virtual false, abstract: false, final false
inline void Init(::System::ReadOnlySpan_1<char16_t>  format, bool  useInvariantFieldLengths) ;

/// @brief Method InitInvariant, addr 0x3d04138, size 0x160, virtual false, abstract: false, final false
static inline ::System::Globalization::__TimeSpanFormat__FormatLiterals InitInvariant(bool  isNegative) ;

/// @brief Method get_DayHourSep, addr 0x3d0405c, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_DayHourSep() ;

/// @brief Method get_End, addr 0x3d0410c, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_End() ;

/// @brief Method get_HourMinuteSep, addr 0x3d04088, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_HourMinuteSep() ;

/// @brief Method get_MinuteSecondSep, addr 0x3d040b4, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_MinuteSecondSep() ;

/// @brief Method get_SecondFractionSep, addr 0x3d040e0, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_SecondFractionSep() ;

/// @brief Method get_Start, addr 0x3d04034, size 0x28, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF_NegativeInvariantFormatLiterals, put=setStaticF_NegativeInvariantFormatLiterals)) ::System::Globalization::__TimeSpanFormat__FormatLiterals  NegativeInvariantFormatLiterals;

/// @brief Field PositiveInvariantFormatLiterals, offset 0xffffffff, size 0x28 
static __declspec(property(get=getStaticF_PositiveInvariantFormatLiterals, put=setStaticF_PositiveInvariantFormatLiterals)) ::System::Globalization::__TimeSpanFormat__FormatLiterals  PositiveInvariantFormatLiterals;

/// @brief Method AppendNonNegativeInt32, addr 0x3d02b74, size 0xf8, virtual false, abstract: false, final false
static inline void AppendNonNegativeInt32(::System::Text::StringBuilder*  sb, int32_t  n, int32_t  digits) ;

/// @brief Method Format, addr 0x3d02c6c, size 0xb8, virtual false, abstract: false, final false
static inline ::StringW Format(::System::TimeSpan  value, ::StringW  format, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method FormatCustomized, addr 0x3d03610, size 0x728, virtual false, abstract: false, final false
...
/// @brief Method FormatStandard, addr 0x3d0311c, size 0x4f4, virtual false, abstract: false, final false
...
/// @brief Method FormatToBuilder, addr 0x3d02d24, size 0x2d8, virtual false, abstract: false, final false
...
/// @brief Method TryFormat, addr 0x3d02ffc, size 0x120, virtual false, abstract: false, final false
