...
/// @brief Method Adapt, addr 0x3d25160, size 0x78, virtual false, abstract: false, final false
inline int32_t Adapt(int32_t  delta, int32_t  numPoints, bool  firstTime) ;

/// @brief Method Decode, addr 0x3d24e04, size 0x2d8, virtual false, abstract: false, final false
inline ::StringW Decode(::StringW  s, int32_t  offset) ;

/// @brief Method DecodeDigit, addr 0x3d251d8, size 0x40, virtual false, abstract: false, final false
inline int32_t DecodeDigit(char16_t  c) ;

/// @brief Method Encode, addr 0x3d24698, size 0x348, virtual false, abstract: false, final false
inline ::StringW Encode(::StringW  s, int32_t  offset) ;

/// @brief Method EncodeDigit, addr 0x3d25148, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3d250dc, size 0x6c, virtual false, abstract: false, final false
