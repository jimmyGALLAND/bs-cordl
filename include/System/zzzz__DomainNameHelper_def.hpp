...
public:
// Declarations
/// @brief Method IdnEquivalent, addr 0x437cbfc, size 0x28c, virtual false, abstract: false, final false
...
/// @brief Method IdnEquivalent, addr 0x437ce88, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method IsASCIILetterOrDigit, addr 0x437c95c, size 0x4c, virtual false, abstract: false, final false
static inline bool IsASCIILetterOrDigit(char16_t  character, ByRef<bool>  notCanonical) ;

/// @brief Method IsIdnAce, addr 0x437d0c8, size 0x98, virtual false, abstract: false, final false
static inline bool IsIdnAce(::StringW  input, int32_t  index) ;

/// @brief Method IsIdnAce, addr 0x437d07c, size 0x4c, virtual false, abstract: false, final false
static inline bool IsIdnAce(::cordl_internals::Ptr<char16_t>  input, int32_t  index) ;

/// @brief Method IsValid, addr 0x437c7dc, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method IsValidByIri, addr 0x437ca0c, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method IsValidDomainLabelCharacter, addr 0x437c9a8, size 0x64, virtual false, abstract: false, final false
static inline bool IsValidDomainLabelCharacter(char16_t  character, ByRef<bool>  notCanonical) ;

/// @brief Method ParseCanonicalName, addr 0x437c644, size 0x198, virtual false, abstract: false, final false
static inline ::StringW ParseCanonicalName(::StringW  str, int32_t  start, int32_t  end, ByRef<bool>  loopback) ;

/// @brief Method UnicodeEquivalent, addr 0x437d27c, size 0x45c, virtual false, abstract: false, final false
...
/// @brief Method UnicodeEquivalent, addr 0x437d160, size 0x11c, virtual false, abstract: false, final false
