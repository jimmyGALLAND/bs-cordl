...
/// @brief Method Compare, addr 0x43786a8, size 0xec, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x437862c, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
