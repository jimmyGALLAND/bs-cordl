...
// SizeInfo { instance_size: 22, native_size: 22, calculated_instance_size: 22, calculated_native_size: 38, minimum_alignment: 2, packing: None, specified_packing: None }
namespace System {
// Is value type: true
