...
public:
// Declarations
/// @brief Method Invoke, addr 0x4374540, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43744a4, size 0x9c, virtual false, abstract: false, final false
