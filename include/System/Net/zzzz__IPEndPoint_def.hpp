...
/// @brief Method Create, addr 0x43fce50, size 0x1f0, virtual true, abstract: false, final false
inline ::System::Net::EndPoint* Create(::System::Net::SocketAddress*  socketAddress) ;

/// @brief Method Equals, addr 0x43fd040, size 0xb4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  comparand) ;

/// @brief Method GetHashCode, addr 0x43fd0f4, size 0x30, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::System::Net::IPEndPoint* New_ctor(::System::Net::IPAddress*  address, int32_t  port) ;

/// @brief Method Serialize, addr 0x43fcde8, size 0x68, virtual true, abstract: false, final false
inline ::System::Net::SocketAddress* Serialize() ;

/// @brief Method ToString, addr 0x43fcd2c, size 0xbc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43fcc64, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method get_Address, addr 0x43fcd1c, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::IPAddress* get_Address() ;

/// @brief Method get_AddressFamily, addr 0x43fcc38, size 0x2c, virtual true, abstract: false, final false
inline ::System::Net::Sockets::AddressFamily get_AddressFamily() ;

/// @brief Method get_Port, addr 0x43fcd24, size 0x8, virtual false, abstract: false, final false
