...
/// @brief Method .ctor, addr 0x43ff140, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_InvalidStatusCode, addr 0x43ff12c, size 0x14, virtual false, abstract: false, final false
inline bool get_InvalidStatusCode() ;

/// @brief Method get_PermanentFailure, addr 0x43ff118, size 0x14, virtual false, abstract: false, final false
inline bool get_PermanentFailure() ;

/// @brief Method get_PositiveCompletion, addr 0x43ff0f0, size 0x14, virtual false, abstract: false, final false
inline bool get_PositiveCompletion() ;

/// @brief Method get_PositiveIntermediate, addr 0x43ff0dc, size 0x14, virtual false, abstract: false, final false
inline bool get_PositiveIntermediate() ;

/// @brief Method get_TransientFailure, addr 0x43ff104, size 0x14, virtual false, abstract: false, final false
