...
/// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x441ea74, size 0x9c, virtual true, abstract: false, final true
inline bool System_Collections_IEnumerator_MoveNext() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x441eb10, size 0xc, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x441e9d0, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x441e974, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method Add, addr 0x441dbac, size 0xc0, virtual false, abstract: false, final false
inline void Add(::System::Net::Cookie*  cookie) ;

/// @brief Method Add, addr 0x441e01c, size 0x2fc, virtual false, abstract: false, final false
inline void Add(::System::Net::CookieCollection*  cookies) ;

/// @brief Method CopyTo, addr 0x441e3a0, size 0x24, virtual true, abstract: false, final true
inline void CopyTo(::System::Array*  array, int32_t  index) ;

/// @brief Method GetEnumerator, addr 0x441e318, size 0x58, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method IndexOf, addr 0x441dc6c, size 0x3b0, virtual false, abstract: false, final false
inline int32_t IndexOf(::System::Net::Cookie*  cookie) ;

/// @brief Method InternalAdd, addr 0x441e49c, size 0x4b4, virtual false, abstract: false, final false
inline int32_t InternalAdd(::System::Net::Cookie*  cookie, bool  isStrict) ;

static inline ::System::Net::CookieCollection* New_ctor() ;

/// @brief Method RemoveAt, addr 0x441e950, size 0x24, virtual false, abstract: false, final false
inline void RemoveAt(int32_t  idx) ;

/// @brief Method TimeStamp, addr 0x441e3c4, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x441da1c, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Count, addr 0x441e370, size 0x24, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_IsOtherVersionSeen, addr 0x441e494, size 0x8, virtual false, abstract: false, final false
inline bool get_IsOtherVersionSeen() ;

/// @brief Method get_IsSynchronized, addr 0x441e394, size 0x8, virtual true, abstract: false, final true
inline bool get_IsSynchronized() ;

/// @brief Method get_Item, addr 0x441dac4, size 0xe8, virtual false, abstract: false, final false
inline ::System::Net::Cookie* get_Item(int32_t  index) ;

/// @brief Method get_SyncRoot, addr 0x441e39c, size 0x4, virtual true, abstract: false, final true
