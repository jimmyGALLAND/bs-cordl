...
/// @brief Method GetMethodInfo, addr 0x4404aa0, size 0x160, virtual false, abstract: false, final false
static inline ::System::Net::FtpMethodInfo* GetMethodInfo(::StringW  method) ;

/// @brief Method HasFlag, addr 0x44026f8, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4404a5c, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method get_IsCommandOnly, addr 0x4402898, size 0x10, virtual false, abstract: false, final false
inline bool get_IsCommandOnly() ;

/// @brief Method get_IsDownload, addr 0x440368c, size 0xc, virtual false, abstract: false, final false
inline bool get_IsDownload() ;

/// @brief Method get_IsUpload, addr 0x4403680, size 0xc, virtual false, abstract: false, final false
inline bool get_IsUpload() ;

/// @brief Method get_ShouldParseForResponseUri, addr 0x4400f2c, size 0xc, virtual false, abstract: false, final false
