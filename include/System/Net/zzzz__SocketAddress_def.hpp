...
/// @brief Method Equals, addr 0x4410408, size 0xec, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  comparand) ;

/// @brief Method GetHashCode, addr 0x44104f4, size 0x130, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetIPAddress, addr 0x4410180, size 0x1ec, virtual false, abstract: false, final false
inline ::System::Net::IPAddress* GetIPAddress() ;

/// @brief Method GetIPEndPoint, addr 0x441036c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x4410624, size 0x238, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x440fd88, size 0x11c, virtual false, abstract: false, final false
inline void _ctor(::System::Net::Sockets::AddressFamily  family, int32_t  size) ;

/// @brief Method .ctor, addr 0x440fea4, size 0x280, virtual false, abstract: false, final false
inline void _ctor(::System::Net::IPAddress*  ipAddress) ;

/// @brief Method .ctor, addr 0x4410124, size 0x5c, virtual false, abstract: false, final false
inline void _ctor(::System::Net::IPAddress*  ipaddress, int32_t  port) ;

/// @brief Method get_Family, addr 0x440fcdc, size 0x30, virtual false, abstract: false, final false
inline ::System::Net::Sockets::AddressFamily get_Family() ;

/// @brief Method get_Item, addr 0x440fd14, size 0x74, virtual false, abstract: false, final false
inline uint8_t get_Item(int32_t  offset) ;

/// @brief Method get_Size, addr 0x440fd0c, size 0x8, virtual false, abstract: false, final false
