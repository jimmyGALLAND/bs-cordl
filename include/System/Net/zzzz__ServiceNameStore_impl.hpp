...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Net::ServiceNameStore::*)()>(&::System::Net::ServiceNameStore::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x44191a8;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Authentication::ExtendedProtection::ServiceNameCollection*> const& System::Net::ServiceNameStore::__cordl_internal_get_serviceNameCollection() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___serviceNameCollection;
}
