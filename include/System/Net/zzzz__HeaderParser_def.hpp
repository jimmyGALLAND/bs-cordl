...
public:
// Declarations
/// @brief Method Invoke, addr 0x4416a70, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44169d4, size 0x9c, virtual false, abstract: false, final false
