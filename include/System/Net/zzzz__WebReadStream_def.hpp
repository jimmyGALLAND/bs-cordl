...
/// @brief Method MoveNext, addr 0x434fa14, size 0x5c4, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x434ffd8, size 0x7c, virtual true, abstract: false, final true
...
/// @brief Method BeginRead, addr 0x434f4cc, size 0x1c0, virtual true, abstract: false, final false
...
/// @brief Method Dispose, addr 0x434f9c8, size 0x4c, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EndRead, addr 0x434f68c, size 0x120, virtual true, abstract: false, final false
inline int32_t EndRead(::System::IAsyncResult*  r) ;

/// @brief Method FinishReading, addr 0x434f8c4, size 0x104, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* FinishReading(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method Flush, addr 0x434f0d4, size 0x38, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method GetException, addr 0x434f10c, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x434f274, size 0x258, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method ReadAsync, addr 0x434f7ac, size 0x118, virtual true, abstract: false, final true
...
/// @brief Method Seek, addr 0x434f064, size 0x38, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetLength, addr 0x434f02c, size 0x38, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method Write, addr 0x434f09c, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x434eefc, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Net::WebOperation*  operation, ::System::IO::Stream*  innerStream) ;

/// @brief Method get_CanRead, addr 0x434f01c, size 0x8, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x434f014, size 0x8, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanWrite, addr 0x434f024, size 0x8, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_InnerStream, addr 0x434eef4, size 0x8, virtual false, abstract: false, final false
inline ::System::IO::Stream* get_InnerStream() ;

/// @brief Method get_Length, addr 0x434ef6c, size 0x38, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Operation, addr 0x434eeec, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::WebOperation* get_Operation() ;

/// @brief Method get_Position, addr 0x434efa4, size 0x38, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method set_Position, addr 0x434efdc, size 0x38, virtual true, abstract: false, final false
