...
/// @brief Method ToString, addr 0x4190eb8, size 0x68, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x4189700, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method get_EndPosition, addr 0x4190e9c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_EndPosition() ;

/// @brief Method get_Kind, addr 0x4190eac, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::Http::Headers::__Token__Type get_Kind() ;

/// @brief Method get_StartPosition, addr 0x4190e8c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_StartPosition() ;

/// @brief Method op_Implicit, addr 0x4190eb4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method set_EndPosition, addr 0x4190ea4, size 0x8, virtual false, abstract: false, final false
inline void set_EndPosition(int32_t  value) ;

/// @brief Method set_StartPosition, addr 0x4190e94, size 0x8, virtual false, abstract: false, final false
