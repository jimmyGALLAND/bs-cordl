...
template<typename T>
inline ::System::Net::Http::Headers::ElementTryParser_1<T>* System::Net::Http::Headers::ElementTryParser_1<T>::New_ctor(::System::Object*  object, ::System::IntPtr  method)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Net::Http::Headers::ElementTryParser_1<T>*>(object, method));
}
template<typename T>
inline void System::Net::Http::Headers::ElementTryParser_1<T>::_ctor(::System::Object*  object, ::System::IntPtr  method)  {
...
// Ctor Parameters []
template<typename T>
constexpr ::System::Net::Http::Headers::ElementTryParser_1<T>::ElementTryParser_1()   {
}
