...
static inline bool SequenceEqual(::System::Collections::Generic::List_1<TSource>*  first, ::System::Collections::Generic::List_1<TSource>*  second) ;

/// @brief Method SetValue, addr 0x418b898, size 0x1b8, virtual false, abstract: false, final false
...
template<typename T>
static inline ::StringW ToString(::System::Collections::Generic::List_1<T>*  list) ;

/// @brief Method ToStringBuilder, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void ToStringBuilder(::System::Collections::Generic::List_1<T>*  list, ::System::Text::StringBuilder*  sb) ;
