...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> const& System::Net::Http::Headers::HttpHeaderValueCollection_1<T>::__cordl_internal_get_invalidValues() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___invalidValues;
}
template<typename T>
