...
class __HeaderInfo__CollectionHeaderTypeInfo_2;
}
namespace System::Net::Http::Headers {
template<typename T,typename U>
...
// Declarations
template<typename T,typename U>
using CollectionHeaderTypeInfo_2 = ::System::Net::Http::Headers::__HeaderInfo__CollectionHeaderTypeInfo_2<T, U>;

template<typename T,typename U>
using HeaderTypeInfo_2 = ::System::Net::Http::Headers::__HeaderInfo__HeaderTypeInfo_2<T, U>;
...
/// @brief Method CreateCollection, addr 0x418d758, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x418d728, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::System::Net::Http::Headers::HttpHeaderKind  headerKind) ;

/// @brief Method get_CustomToString, addr 0x418d768, size 0x8, virtual false, abstract: false, final false
inline ::System::Func_2<::System::Object*,::StringW>* get_CustomToString() ;

/// @brief Method get_Separator, addr 0x418d778, size 0x38, virtual true, abstract: false, final false
inline ::StringW get_Separator() ;

/// @brief Method set_CustomToString, addr 0x418d770, size 0x8, virtual false, abstract: false, final false
