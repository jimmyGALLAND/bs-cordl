...
/// @brief Method Equals, addr 0x4188f00, size 0xb4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x4188fb4, size 0x7c, virtual true, abstract: false, final false
...
/// @brief Method System.ICloneable.Clone, addr 0x4188ef8, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_ICloneable_Clone() ;

/// @brief Method ToString, addr 0x4189778, size 0x5c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryParse, addr 0x4189290, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method TryParse, addr 0x4189030, size 0xc8, virtual false, abstract: false, final false
static inline bool TryParse(::StringW  input, ByRef<::System::Net::Http::Headers::AuthenticationHeaderValue*>  parsedValue) ;

/// @brief Method TryParseElement, addr 0x4189120, size 0x170, virtual false, abstract: false, final false
static inline bool TryParseElement(::System::Net::Http::Headers::Lexer*  lexer, ByRef<::System::Net::Http::Headers::AuthenticationHeaderValue*>  parsedValue, ByRef<::System::Net::Http::Headers::Token>  t) ;
...
/// @brief Method .ctor, addr 0x4188ed0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4188e9c, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::StringW  scheme, ::StringW  parameter) ;

/// @brief Method get_Parameter, addr 0x4188ed8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Parameter() ;

/// @brief Method get_Scheme, addr 0x4188ee8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Scheme() ;

/// @brief Convert to "::System::ICloneable"
constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

/// @brief Method set_Parameter, addr 0x4188ee0, size 0x8, virtual false, abstract: false, final false
inline void set_Parameter(::StringW  value) ;

/// @brief Method set_Scheme, addr 0x4188ef0, size 0x8, virtual false, abstract: false, final false
