...
/// @brief Method EatChar, addr 0x418d584, size 0x10, virtual false, abstract: false, final false
inline void EatChar() ;

/// @brief Method GetQuotedStringValue, addr 0x418b038, size 0x84, virtual false, abstract: false, final false
inline ::StringW GetQuotedStringValue(::System::Net::Http::Headers::Token  start) ;

/// @brief Method GetRemainingStringValue, addr 0x41896cc, size 0x34, virtual false, abstract: false, final false
inline ::StringW GetRemainingStringValue(int32_t  position) ;

/// @brief Method GetStringValue, addr 0x4190fa8, size 0x7c, virtual false, abstract: false, final false
inline ::StringW GetStringValue(::System::Net::Http::Headers::Token  start, ::System::Net::Http::Headers::Token  end) ;

/// @brief Method GetStringValue, addr 0x4189650, size 0x7c, virtual false, abstract: false, final false
inline ::StringW GetStringValue(::System::Net::Http::Headers::Token  token) ;

/// @brief Method IsStarStringValue, addr 0x418cd50, size 0xac, virtual false, abstract: false, final false
inline bool IsStarStringValue(::System::Net::Http::Headers::Token  token) ;

/// @brief Method IsValidCharacter, addr 0x41913e8, size 0xb0, virtual false, abstract: false, final false
static inline bool IsValidCharacter(char16_t  input) ;

/// @brief Method IsValidToken, addr 0x4191330, size 0xb8, virtual false, abstract: false, final false
static inline bool IsValidToken(::StringW  input) ;

static inline ::System::Net::Http::Headers::Lexer* New_ctor(::StringW  stream) ;

/// @brief Method PeekChar, addr 0x418d544, size 0x40, virtual false, abstract: false, final false
inline int32_t PeekChar() ;

/// @brief Method Scan, addr 0x4189340, size 0x310, virtual false, abstract: false, final false
inline ::System::Net::Http::Headers::Token Scan(bool  recognizeDash) ;

/// @brief Method ScanCommentOptional, addr 0x4191498, size 0x160, virtual false, abstract: false, final false
inline bool ScanCommentOptional(ByRef<::StringW>  value, ByRef<::System::Net::Http::Headers::Token>  readToken) ;

/// @brief Method TryGetDateValue, addr 0x41911b4, size 0xdc, virtual false, abstract: false, final false
static inline bool TryGetDateValue(::StringW  text, ByRef<::System::DateTimeOffset>  value) ;

/// @brief Method TryGetDateValue, addr 0x41910c4, size 0xf0, virtual false, abstract: false, final false
inline bool TryGetDateValue(::System::Net::Http::Headers::Token  token, ByRef<::System::DateTimeOffset>  value) ;

/// @brief Method TryGetDoubleValue, addr 0x4191290, size 0xa0, virtual false, abstract: false, final false
inline bool TryGetDoubleValue(::System::Net::Http::Headers::Token  token, ByRef<double_t>  value) ;

/// @brief Method TryGetNumericValue, addr 0x4191024, size 0xa0, virtual false, abstract: false, final false
inline bool TryGetNumericValue(::System::Net::Http::Headers::Token  token, ByRef<int32_t>  value) ;

/// @brief Method TryGetNumericValue, addr 0x418cdfc, size 0xa0, virtual false, abstract: false, final false
inline bool TryGetNumericValue(::System::Net::Http::Headers::Token  token, ByRef<int64_t>  value) ;

/// @brief Method TryGetTimeSpanValue, addr 0x418af70, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x41890f8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_Position, addr 0x4190f98, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Position, addr 0x4190fa0, size 0x8, virtual false, abstract: false, final false
