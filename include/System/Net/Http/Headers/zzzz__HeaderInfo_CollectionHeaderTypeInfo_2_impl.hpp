...
constexpr int32_t& System::Net::Http::Headers::__HeaderInfo__CollectionHeaderTypeInfo_2<T,U>::__cordl_internal_get_minimalCount()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___minimalCount;
}
template<typename T,typename U>
constexpr int32_t const& System::Net::Http::Headers::__HeaderInfo__CollectionHeaderTypeInfo_2<T,U>::__cordl_internal_get_minimalCount() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___minimalCount;
}
template<typename T,typename U>
constexpr void System::Net::Http::Headers::__HeaderInfo__CollectionHeaderTypeInfo_2<T,U>::__cordl_internal_set_minimalCount(int32_t  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
this->___minimalCount = value;
}
template<typename T,typename U>
constexpr ::StringW& System::Net::Http::Headers::__HeaderInfo__CollectionHeaderTypeInfo_2<T,U>::__cordl_internal_get_separator()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___separator;
}
template<typename T,typename U>
constexpr ::StringW const& System::Net::Http::Headers::__HeaderInfo__CollectionHeaderTypeInfo_2<T,U>::__cordl_internal_get_separator() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___separator;
}
template<typename T,typename U>
constexpr void System::Net::Http::Headers::__HeaderInfo__CollectionHeaderTypeInfo_2<T,U>::__cordl_internal_set_separator(::StringW  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T,typename U>
constexpr ::cordl_internals::to_const_pointer<::System::Net::Http::Headers::TryParseListDelegate_1<T>*> const& System::Net::Http::Headers::__HeaderInfo__CollectionHeaderTypeInfo_2<T,U>::__cordl_internal_get_parser() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___parser;
}
template<typename T,typename U>
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Net::Http::Headers::__HeaderInfo__CollectionHeaderTypeInfo_2<T,U>*>(name, parser, headerKind, minimalCount, separator));
}
template<typename T,typename U>
...
// Ctor Parameters []
template<typename T,typename U>
constexpr ::System::Net::Http::Headers::__HeaderInfo__CollectionHeaderTypeInfo_2<T,U>::__HeaderInfo__CollectionHeaderTypeInfo_2()   {
}
