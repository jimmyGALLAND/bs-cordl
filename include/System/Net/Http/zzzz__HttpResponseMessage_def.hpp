...
/// @brief Method Dispose, addr 0x4188728, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x4188738, size 0x34, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EnsureSuccessStatusCode, addr 0x4186a38, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x418876c, size 0x23c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x41826d8, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::System::Net::HttpStatusCode  statusCode) ;

/// @brief Method get_Content, addr 0x418860c, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::Http::HttpContent* get_Content() ;

/// @brief Method get_Headers, addr 0x4182834, size 0x60, virtual false, abstract: false, final false
inline ::System::Net::Http::Headers::HttpResponseHeaders* get_Headers() ;

/// @brief Method get_IsSuccessStatusCode, addr 0x418867c, size 0x14, virtual false, abstract: false, final false
inline bool get_IsSuccessStatusCode() ;

/// @brief Method get_ReasonPhrase, addr 0x4188690, size 0x1c, virtual false, abstract: false, final false
inline ::StringW get_ReasonPhrase() ;

/// @brief Method get_StatusCode, addr 0x41886bc, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::HttpStatusCode get_StatusCode() ;

/// @brief Method get_Version, addr 0x41886c4, size 0x64, virtual false, abstract: false, final false
inline ::System::Version* get_Version() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_Content, addr 0x4188614, size 0x8, virtual false, abstract: false, final false
inline void set_Content(::System::Net::Http::HttpContent*  value) ;

/// @brief Method set_ReasonPhrase, addr 0x41886ac, size 0x8, virtual false, abstract: false, final false
inline void set_ReasonPhrase(::StringW  value) ;

/// @brief Method set_RequestMessage, addr 0x41886b4, size 0x8, virtual false, abstract: false, final false
inline void set_RequestMessage(::System::Net::Http::HttpRequestMessage*  value) ;

/// @brief Method set_StatusCode, addr 0x41885c4, size 0x48, virtual false, abstract: false, final false
