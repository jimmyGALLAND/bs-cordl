...
/// @brief Method MoveNext, addr 0x440bb7c, size 0x304, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x440be80, size 0xc, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::System::Net::FtpWebRequest*", modifiers: "", def_value: None }, CppParam { name: "_client_5__2", ty: "::System::Net::Sockets::TcpClient*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter", modifiers: "", def_value: None }]
constexpr __FtpWebRequest___CreateConnectionAsync_d__86(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::System::Net::FtpWebRequest*  __4__this, ::System::Net::Sockets::TcpClient*  _client_5__2, ::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter  __u__1) noexcept;
...
/// @brief Method .ctor, addr 0x440bee8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_ClientCertificates>b__114_0, addr 0x440bef0, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method Abort, addr 0x440af3c, size 0x4b8, virtual true, abstract: false, final false
inline void Abort() ;

/// @brief Method AsyncRequestCallback, addr 0x440a130, size 0xa44, virtual false, abstract: false, final false
inline void AsyncRequestCallback(::System::Object*  obj) ;

/// @brief Method AttemptedRecovery, addr 0x4409250, size 0x278, virtual false, abstract: false, final false
inline bool AttemptedRecovery(::System::Exception*  e) ;

/// @brief Method BeginGetRequestStream, addr 0x44081f8, size 0x56c, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginGetRequestStream(::System::AsyncCallback*  callback, ::System::Object*  state) ;

/// @brief Method BeginGetResponse, addr 0x44076bc, size 0x6f8, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginGetResponse(::System::AsyncCallback*  callback, ::System::Object*  state) ;

/// @brief Method CheckError, addr 0x44063f8, size 0x14, virtual false, abstract: false, final false
inline void CheckError() ;

/// @brief Method CreateConnection, addr 0x4408c84, size 0x168, virtual false, abstract: false, final false
inline ::System::Net::FtpControlStream* CreateConnection() ;

/// @brief Method CreateConnectionAsync, addr 0x4408bf4, size 0x90, virtual false, abstract: false, final false
inline void CreateConnectionAsync() ;

/// @brief Method DataStreamClosed, addr 0x440b934, size 0x80, virtual false, abstract: false, final false
inline void DataStreamClosed(::System::Net::CloseExState  closeState) ;

/// @brief Method EndGetRequestStream, addr 0x440876c, size 0x488, virtual true, abstract: false, final false
inline ::System::IO::Stream* EndGetRequestStream(::System::IAsyncResult*  asyncResult) ;

/// @brief Method EndGetResponse, addr 0x4407dd8, size 0x420, virtual true, abstract: false, final false
inline ::System::Net::WebResponse* EndGetResponse(::System::IAsyncResult*  asyncResult) ;

/// @brief Method EnsureFtpWebResponse, addr 0x4406e98, size 0x4c0, virtual false, abstract: false, final false
inline void EnsureFtpWebResponse(::System::Exception*  exception) ;

/// @brief Method FinishRequestStage, addr 0x4406484, size 0x448, virtual false, abstract: false, final false
inline ::System::Net::__FtpWebRequest__RequestStage FinishRequestStage(::System::Net::__FtpWebRequest__RequestStage  stage) ;

/// @brief Method GetResponse, addr 0x4405c38, size 0x7c0, virtual true, abstract: false, final false
inline ::System::Net::WebResponse* GetResponse() ;

static inline ::System::Net::FtpWebRequest* New_ctor(::System::Uri*  uri) ;

/// @brief Method RequestCallback, addr 0x440a120, size 0x10, virtual false, abstract: false, final false
inline void RequestCallback(::System::Object*  obj) ;

/// @brief Method SetException, addr 0x4407358, size 0x364, virtual false, abstract: false, final false
inline void SetException(::System::Exception*  exception) ;

/// @brief Method SubmitRequest, addr 0x4406964, size 0x534, virtual false, abstract: false, final false
inline void SubmitRequest(bool  isAsync) ;

/// @brief Method SyncRequestCallback, addr 0x440ab74, size 0x3c8, virtual false, abstract: false, final false
inline void SyncRequestCallback(::System::Object*  obj) ;

/// @brief Method TimedSubmitRequestHelper, addr 0x4408e3c, size 0x414, virtual false, abstract: false, final false
inline ::System::IO::Stream* TimedSubmitRequestHelper(bool  isAsync) ;

/// @brief Method TimerCallback, addr 0x440964c, size 0x110, virtual false, abstract: false, final false
inline void TimerCallback(::System::Net::__TimerThread__Timer*  timer, int32_t  timeNoticed, ::System::Object*  context) ;

/// @brief Method TranslateConnectException, addr 0x44094dc, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44056e0, size 0x3c8, virtual false, abstract: false, final false
...
/// @brief Method get_Aborted, addr 0x44056d8, size 0x8, virtual false, abstract: false, final false
inline bool get_Aborted() ;

/// @brief Method get_ClientCertificates, addr 0x440b4f4, size 0xf4, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection* get_ClientCertificates() ;

/// @brief Method get_ContentLength, addr 0x44055f4, size 0x8, virtual true, abstract: false, final false
inline int64_t get_ContentLength() ;

/// @brief Method get_ContentOffset, addr 0x44055ec, size 0x8, virtual false, abstract: false, final false
inline int64_t get_ContentOffset() ;

/// @brief Method get_Credentials, addr 0x44053b0, size 0x8, virtual true, abstract: false, final false
inline ::System::Net::ICredentials* get_Credentials() ;

/// @brief Method get_EnableSsl, addr 0x440b5e8, size 0x8, virtual false, abstract: false, final false
inline bool get_EnableSsl() ;

/// @brief Method get_Headers, addr 0x440b5f0, size 0x60, virtual true, abstract: false, final false
inline ::System::Net::WebHeaderCollection* get_Headers() ;

/// @brief Method get_InUse, addr 0x4405390, size 0x18, virtual false, abstract: false, final false
inline bool get_InUse() ;

/// @brief Method get_Method, addr 0x44051d0, size 0x1c, virtual true, abstract: false, final false
inline ::StringW get_Method() ;

/// @brief Method get_MethodInfo, addr 0x44051c8, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::FtpMethodInfo* get_MethodInfo() ;

/// @brief Method get_Proxy, addr 0x4405604, size 0x8, virtual true, abstract: false, final false
inline ::System::Net::IWebProxy* get_Proxy() ;

/// @brief Method get_ReadWriteTimeout, addr 0x44055e4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ReadWriteTimeout() ;

/// @brief Method get_RemainingTimeout, addr 0x44055dc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_RemainingTimeout() ;

/// @brief Method get_RenameTo, addr 0x44053a8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_RenameTo() ;

/// @brief Method get_RequestUri, addr 0x44054fc, size 0x8, virtual true, abstract: false, final false
inline ::System::Uri* get_RequestUri() ;

/// @brief Method get_Timeout, addr 0x4405504, size 0x8, virtual true, abstract: false, final false
inline int32_t get_Timeout() ;

/// @brief Method get_TimerQueue, addr 0x44095dc, size 0x68, virtual false, abstract: false, final false
inline ::System::Net::__TimerThread__Queue* get_TimerQueue() ;

/// @brief Method get_UseBinary, addr 0x440b4e4, size 0x8, virtual false, abstract: false, final false
inline bool get_UseBinary() ;

/// @brief Method get_UseDefaultCredentials, addr 0x440b6b4, size 0x24, virtual true, abstract: false, final false
inline bool get_UseDefaultCredentials() ;

/// @brief Method get_UsePassive, addr 0x440b4ec, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_CachePolicy, addr 0x440b480, size 0x64, virtual true, abstract: false, final false
inline void set_CachePolicy(::System::Net::Cache::RequestCachePolicy*  value) ;

/// @brief Method set_ConnectionGroupName, addr 0x4405670, size 0x68, virtual true, abstract: false, final false
inline void set_ConnectionGroupName(::StringW  value) ;

/// @brief Method set_ContentLength, addr 0x44055fc, size 0x8, virtual true, abstract: false, final false
inline void set_ContentLength(int64_t  value) ;

/// @brief Method set_Credentials, addr 0x44053b8, size 0x144, virtual true, abstract: false, final false
inline void set_Credentials(::System::Net::ICredentials*  value) ;

/// @brief Method set_Method, addr 0x44051ec, size 0x1a4, virtual true, abstract: false, final false
inline void set_Method(::StringW  value) ;

/// @brief Method set_PreAuthenticate, addr 0x440b758, size 0x24, virtual true, abstract: false, final false
inline void set_PreAuthenticate(bool  value) ;

/// @brief Method set_Proxy, addr 0x440560c, size 0x64, virtual true, abstract: false, final false
inline void set_Proxy(::System::Net::IWebProxy*  value) ;

/// @brief Method set_Timeout, addr 0x440550c, size 0xd0, virtual true, abstract: false, final false
