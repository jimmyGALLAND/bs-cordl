...
/// @brief Method ParseAuthentication, addr 0x4436ba8, size 0x120, virtual false, abstract: false, final false
inline void ParseAuthentication(::System::Net::AuthenticationSchemes  expectedSchemes) ;

/// @brief Method ParseBasicAuthentication, addr 0x4437010, size 0x234, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4432e2c, size 0xac, virtual false, abstract: false, final false
inline void _ctor(::System::Net::HttpConnection*  cnc) ;

/// @brief Method get_Connection, addr 0x4436ff8, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::HttpConnection* get_Connection() ;

/// @brief Method get_ErrorMessage, addr 0x4436fe8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ErrorMessage() ;

/// @brief Method get_ErrorStatus, addr 0x4436fd8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ErrorStatus() ;

/// @brief Method get_HaveError, addr 0x44339e8, size 0x10, virtual false, abstract: false, final false
inline bool get_HaveError() ;

/// @brief Method get_Request, addr 0x4437000, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::HttpListenerRequest* get_Request() ;

/// @brief Method get_Response, addr 0x4437008, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::HttpListenerResponse* get_Response() ;

/// @brief Method set_ErrorMessage, addr 0x4436ff0, size 0x8, virtual false, abstract: false, final false
inline void set_ErrorMessage(::StringW  value) ;

/// @brief Method set_ErrorStatus, addr 0x4436fe0, size 0x8, virtual false, abstract: false, final false
