...
public:
// Declarations
/// @brief Method GetWebStatusCodeString, addr 0x4418fc8, size 0x1e0, virtual false, abstract: false, final false
static inline ::StringW GetWebStatusCodeString(::System::Net::FtpStatusCode  statusCode, ::StringW  statusDescription) ;

/// @brief Method GetWebStatusString, addr 0x440f400, size 0xbc, virtual false, abstract: false, final false
static inline ::StringW GetWebStatusString(::StringW  Res, ::System::Net::WebExceptionStatus  Status) ;

/// @brief Method GetWebStatusString, addr 0x4418f6c, size 0x5c, virtual false, abstract: false, final false
