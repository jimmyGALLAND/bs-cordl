...
/// @brief Method AddByte, addr 0x44165f8, size 0x98, virtual false, abstract: false, final false
inline void AddByte(uint8_t  b) ;

/// @brief Method AddChar, addr 0x4416690, size 0x60, virtual false, abstract: false, final false
inline void AddChar(char16_t  ch) ;

/// @brief Method FlushBytes, addr 0x44168a8, size 0x60, virtual false, abstract: false, final false
inline void FlushBytes() ;

/// @brief Method GetString, addr 0x44166f0, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4416534, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method GetNextUnicodeScalarValueFromUtf16Surrogate, addr 0x4416258, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method HexToInt, addr 0x44165a8, size 0x50, virtual false, abstract: false, final false
static inline int32_t HexToInt(char16_t  h) ;

/// @brief Method HtmlEncode, addr 0x4415b64, size 0x120, virtual false, abstract: false, final false
static inline ::StringW HtmlEncode(::StringW  value) ;

/// @brief Method HtmlEncode, addr 0x4415dcc, size 0x3a8, virtual false, abstract: false, final false
static inline void HtmlEncode(::StringW  value, ::System::IO::TextWriter*  output) ;

/// @brief Method IndexOfHtmlEncodingChars, addr 0x4415c84, size 0x148, virtual false, abstract: false, final false
static inline int32_t IndexOfHtmlEncodingChars(::StringW  s, int32_t  startPos) ;

/// @brief Method UrlDecode, addr 0x4416778, size 0x7c, virtual false, abstract: false, final false
static inline ::StringW UrlDecode(::StringW  encodedValue) ;

/// @brief Method UrlDecodeInternal, addr 0x4416310, size 0x224, virtual false, abstract: false, final false
...
/// @brief Method get_HtmlEncodeConformance, addr 0x4416174, size 0xe4, virtual false, abstract: false, final false
