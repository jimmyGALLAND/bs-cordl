...
/// @brief Method BeginRead, addr 0x4342f98, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method BeginWrite, addr 0x4342af8, size 0x23c, virtual true, abstract: false, final false
...
/// @brief Method Close, addr 0x434227c, size 0x274, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method EndRead, addr 0x4342fd0, size 0x38, virtual true, abstract: false, final false
inline int32_t EndRead(::System::IAsyncResult*  ares) ;

/// @brief Method EndWrite, addr 0x4342d34, size 0x22c, virtual true, abstract: false, final false
inline void EndWrite(::System::IAsyncResult*  ares) ;

/// @brief Method Flush, addr 0x43427e4, size 0x4, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method GetChunkSizeBytes, addr 0x4342638, size 0xf0, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetChunkSizeBytes(int32_t  size, bool  final) ;

/// @brief Method GetHeaders, addr 0x43424f0, size 0x148, virtual false, abstract: false, final false
inline ::System::IO::MemoryStream* GetHeaders(bool  closing) ;

/// @brief Method InternalWrite, addr 0x4342728, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x4342f60, size 0x38, virtual true, abstract: false, final false
inline int32_t Read(ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method Seek, addr 0x4343008, size 0x38, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetLength, addr 0x4343040, size 0x38, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method Write, addr 0x43427e8, size 0x310, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4342134, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method get_CanRead, addr 0x43421bc, size 0x8, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x43421c4, size 0x8, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanWrite, addr 0x43421cc, size 0x8, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Length, addr 0x43421d4, size 0x38, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Position, addr 0x434220c, size 0x38, virtual true, abstract: false, final false
inline int64_t get_Position() ;

static inline void setStaticF_crlf(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method set_Position, addr 0x4342244, size 0x38, virtual true, abstract: false, final false
