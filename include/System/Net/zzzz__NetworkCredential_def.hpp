...
/// @brief Method GetCredential, addr 0x440fcb8, size 0x4, virtual true, abstract: false, final true
inline ::System::Net::NetworkCredential* GetCredential(::System::Uri*  uri, ::StringW  authType) ;

/// @brief Method InternalGetDomain, addr 0x440fcb0, size 0x8, virtual false, abstract: false, final false
inline ::StringW InternalGetDomain() ;

/// @brief Method InternalGetPassword, addr 0x440fc94, size 0xc, virtual false, abstract: false, final false
inline ::StringW InternalGetPassword() ;

/// @brief Method InternalGetUserName, addr 0x440fca8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4405bd0, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::StringW  userName, ::StringW  password) ;

/// @brief Method .ctor, addr 0x440bac0, size 0xbc, virtual false, abstract: false, final false
inline void _ctor(::StringW  userName, ::StringW  password, ::StringW  domain) ;

/// @brief Method get_Domain, addr 0x440fca0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Domain() ;

/// @brief Method get_Password, addr 0x440fc88, size 0xc, virtual false, abstract: false, final false
inline ::StringW get_Password() ;

/// @brief Method get_UserName, addr 0x440fc80, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_UserName() ;

/// @brief Convert to "::System::Net::ICredentials"
constexpr ::System::Net::ICredentials* i___System__Net__ICredentials() noexcept;

/// @brief Method set_Domain, addr 0x440fc28, size 0x58, virtual false, abstract: false, final false
inline void set_Domain(::StringW  value) ;

/// @brief Method set_Password, addr 0x440fc08, size 0x20, virtual false, abstract: false, final false
inline void set_Password(::StringW  value) ;

/// @brief Method set_UserName, addr 0x440fbb0, size 0x58, virtual false, abstract: false, final false
