...
/// @brief Method MoveNext, addr 0x434e444, size 0x26c, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x434e6b0, size 0x7c, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x434e72c, size 0x590, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x434eee0, size 0xc, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method Abort, addr 0x434d658, size 0x40, virtual false, abstract: false, final false
inline void Abort() ;

/// @brief Method CheckDisposed, addr 0x434dbd4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method CheckThrowDisposed, addr 0x434dc5c, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method Close, addr 0x434d848, size 0xac, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method CompleteRequestWritten, addr 0x434e3a0, size 0x80, virtual false, abstract: false, final false
inline void CompleteRequestWritten(::System::Net::WebRequestStream*  stream, ::System::Exception*  error) ;

/// @brief Method Finish, addr 0x434d8f4, size 0x23c, virtual false, abstract: false, final false
inline void Finish(bool  ok, ::System::Exception*  error) ;

/// @brief Method GetRequestStream, addr 0x434e170, size 0xe0, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::System::IO::Stream*>* GetRequestStream() ;

/// @brief Method GetRequestStreamInternal, addr 0x434e250, size 0x50, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::System::Net::WebRequestStream*>* GetRequestStreamInternal() ;

/// @brief Method GetResponseStream, addr 0x434e2b8, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method RegisterRequest, addr 0x434dd94, size 0x260, virtual false, abstract: false, final false
inline void RegisterRequest(::System::Net::ServicePoint*  servicePoint, ::System::Net::WebConnection*  connection) ;

/// @brief Method Run, addr 0x434e310, size 0x90, virtual false, abstract: false, final false
inline void Run() ;

/// @brief Method SetCanceled, addr 0x434d780, size 0xc8, virtual false, abstract: false, final false
inline void SetCanceled() ;

/// @brief Method SetDisposed, addr 0x434d698, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method SetError, addr 0x434db30, size 0xa4, virtual false, abstract: false, final false
inline void SetError(::System::Exception*  error) ;

/// @brief Method SetPriorityRequest, addr 0x434dff4, size 0x17c, virtual false, abstract: false, final false
inline void SetPriorityRequest(::System::Net::WebOperation*  operation) ;

/// @brief Method ThrowIfClosedOrDisposed, addr 0x434b054, size 0x60, virtual false, abstract: false, final false
inline void ThrowIfClosedOrDisposed() ;

/// @brief Method ThrowIfClosedOrDisposed, addr 0x434a7d0, size 0x88, virtual false, abstract: false, final false
inline void ThrowIfClosedOrDisposed(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method ThrowIfDisposed, addr 0x434dcb4, size 0x60, virtual false, abstract: false, final false
inline void ThrowIfDisposed() ;

/// @brief Method ThrowIfDisposed, addr 0x434dd14, size 0x80, virtual false, abstract: false, final false
inline void ThrowIfDisposed(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method <RegisterRequest>b__48_0, addr 0x434e420, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x434d498, size 0x194, virtual false, abstract: false, final false
...
/// @brief Method get_Aborted, addr 0x434ad70, size 0x50, virtual false, abstract: false, final false
inline bool get_Aborted() ;

/// @brief Method get_Closed, addr 0x434d62c, size 0x2c, virtual false, abstract: false, final false
inline bool get_Closed() ;

/// @brief Method get_Connection, addr 0x434d468, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::WebConnection* get_Connection() ;

/// @brief Method get_Finished, addr 0x434e308, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::WebCompletionSource_1<::System::ValueTuple_2<bool,::System::Net::WebOperation*>>* get_Finished() ;

/// @brief Method get_IsNtlmChallenge, addr 0x434d490, size 0x8, virtual false, abstract: false, final false
inline bool get_IsNtlmChallenge() ;

/// @brief Method get_Request, addr 0x434d460, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::HttpWebRequest* get_Request() ;

/// @brief Method get_ServicePoint, addr 0x434d478, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::ServicePoint* get_ServicePoint() ;

/// @brief Method get_WriteBuffer, addr 0x434d488, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::BufferOffsetSize* get_WriteBuffer() ;

/// @brief Method get_WriteStream, addr 0x434e2a0, size 0x18, virtual false, abstract: false, final false
inline ::System::Net::WebRequestStream* get_WriteStream() ;

/// @brief Method set_Connection, addr 0x434d470, size 0x8, virtual false, abstract: false, final false
inline void set_Connection(::System::Net::WebConnection*  value) ;

/// @brief Method set_ServicePoint, addr 0x434d480, size 0x8, virtual false, abstract: false, final false
