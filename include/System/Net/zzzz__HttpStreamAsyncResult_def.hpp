...
/// @brief Method Complete, addr 0x4336e10, size 0x100, virtual false, abstract: false, final false
inline void Complete() ;

/// @brief Method Complete, addr 0x4336e08, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4337124, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AsyncState, addr 0x4336f10, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_AsyncState() ;

/// @brief Method get_AsyncWaitHandle, addr 0x4336f18, size 0x130, virtual true, abstract: false, final true
inline ::System::Threading::WaitHandle* get_AsyncWaitHandle() ;

/// @brief Method get_CompletedSynchronously, addr 0x4337048, size 0x14, virtual true, abstract: false, final true
inline bool get_CompletedSynchronously() ;

/// @brief Method get_IsCompleted, addr 0x433705c, size 0xc8, virtual true, abstract: false, final true
