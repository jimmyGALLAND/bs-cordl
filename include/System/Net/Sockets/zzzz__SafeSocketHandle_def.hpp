...
/// @brief Method RegisterForBlockingSyscall, addr 0x4370114, size 0x13c, virtual false, abstract: false, final false
inline void RegisterForBlockingSyscall() ;

/// @brief Method ReleaseHandle, addr 0x436fb60, size 0x5b4, virtual true, abstract: false, final false
inline bool ReleaseHandle() ;

/// @brief Method UnRegisterForBlockingSyscall, addr 0x4370250, size 0x1f0, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::Threading::Thread*,::System::Diagnostics::StackTrace*>*> const& __cordl_internal_get_threads_stacktraces() const;
...
/// @brief Method .ctor, addr 0x436fa9c, size 0xc4, virtual false, abstract: false, final false
