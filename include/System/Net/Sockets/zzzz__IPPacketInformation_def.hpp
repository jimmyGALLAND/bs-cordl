...
public:
// Declarations
/// @brief Method Equals, addr 0x436e38c, size 0x9c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  comparand) ;

/// @brief Method GetHashCode, addr 0x436e428, size 0x44, virtual true, abstract: false, final false
