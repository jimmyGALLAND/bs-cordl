...
/// @brief Method BeginRead, addr 0x435eecc, size 0x304, virtual true, abstract: false, final false
...
/// @brief Method BeginWrite, addr 0x435f4b0, size 0x304, virtual true, abstract: false, final false
...
/// @brief Method Close, addr 0x435ecbc, size 0x64, virtual false, abstract: false, final false
inline void Close(int32_t  timeout) ;

/// @brief Method Dispose, addr 0x435ed20, size 0x78, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EndRead, addr 0x435f248, size 0x208, virtual true, abstract: false, final false
inline int32_t EndRead(::System::IAsyncResult*  asyncResult) ;

/// @brief Method EndWrite, addr 0x435f82c, size 0x208, virtual true, abstract: false, final false
inline void EndWrite(::System::IAsyncResult*  asyncResult) ;

/// @brief Method Finalize, addr 0x435ee28, size 0xa4, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method Flush, addr 0x4360be0, size 0x4, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushAsync, addr 0x4360be4, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method Read, addr 0x435df2c, size 0x2ec, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method Read, addr 0x435e278, size 0x258, virtual true, abstract: false, final false
inline int32_t Read(::System::Span_1<uint8_t>  destination) ;

/// @brief Method ReadAsync, addr 0x435fa94, size 0x370, virtual true, abstract: false, final false
...
/// @brief Method ReadAsync, addr 0x43600ec, size 0x244, virtual true, abstract: false, final false
...
/// @brief Method ReadByte, addr 0x435e5d0, size 0x64, virtual true, abstract: false, final false
inline int32_t ReadByte() ;

/// @brief Method Seek, addr 0x435dee0, size 0x4c, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetLength, addr 0x4360c6c, size 0x4c, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method SetSocketTimeoutOption, addr 0x435d9d8, size 0x1c4, virtual false, abstract: false, final false
inline void SetSocketTimeoutOption(::System::Net::Sockets::SocketShutdown  mode, int32_t  timeout, bool  silent) ;

/// @brief Method Write, addr 0x435e634, size 0x2ec, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method Write, addr 0x435e980, size 0x258, virtual true, abstract: false, final false
inline void Write(::System::ReadOnlySpan_1<uint8_t>  source) ;

/// @brief Method WriteAsync, addr 0x4360330, size 0x380, virtual true, abstract: false, final false
...
/// @brief Method WriteAsync, addr 0x43609a0, size 0x240, virtual true, abstract: false, final false
...
/// @brief Method WriteByte, addr 0x435ec64, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x435d558, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::System::Net::Sockets::Socket*  socket) ;

/// @brief Method .ctor, addr 0x435d564, size 0x1a0, virtual false, abstract: false, final false
inline void _ctor(::System::Net::Sockets::Socket*  socket, ::System::IO::FileAccess  access, bool  ownsSocket) ;

/// @brief Method .ctor, addr 0x435d704, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::System::Net::Sockets::Socket*  socket, bool  ownsSocket) ;

/// @brief Method get_CanRead, addr 0x435d710, size 0x8, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x435d718, size 0x8, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanTimeout, addr 0x435d728, size 0x8, virtual true, abstract: false, final false
inline bool get_CanTimeout() ;

/// @brief Method get_CanWrite, addr 0x435d720, size 0x8, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_DataAvailable, addr 0x435dca8, size 0xa0, virtual true, abstract: false, final false
inline bool get_DataAvailable() ;

/// @brief Method get_InternalSocket, addr 0x4360df8, size 0x94, virtual false, abstract: false, final false
inline ::System::Net::Sockets::Socket* get_InternalSocket() ;

/// @brief Method get_Length, addr 0x435ddfc, size 0x4c, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Position, addr 0x435de48, size 0x4c, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method get_ReadTimeout, addr 0x435d730, size 0x88, virtual true, abstract: false, final false
inline int32_t get_ReadTimeout() ;

/// @brief Method get_WriteTimeout, addr 0x435db9c, size 0x88, virtual true, abstract: false, final false
inline int32_t get_WriteTimeout() ;

/// @brief Method set_Position, addr 0x435de94, size 0x4c, virtual true, abstract: false, final false
inline void set_Position(int64_t  value) ;

/// @brief Method set_ReadTimeout, addr 0x435d954, size 0x84, virtual true, abstract: false, final false
inline void set_ReadTimeout(int32_t  value) ;

/// @brief Method set_WriteTimeout, addr 0x435dc24, size 0x84, virtual true, abstract: false, final false
