...
/// @brief Method GetBinding, addr 0x435cf48, size 0x1f8, virtual false, abstract: false, final false
static inline ::System::Net::Cache::RequestCacheBinding* GetBinding(::StringW  internedScheme) ;

/// @brief Method LoadConfigSettings, addr 0x435d140, size 0x174, virtual false, abstract: false, final false
