...
/// @brief Method DomainCharsTest, addr 0x441b9d4, size 0xb4, virtual false, abstract: false, final false
static inline bool DomainCharsTest(::StringW  name) ;

/// @brief Method Equals, addr 0x441c118, size 0xd0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  comparand) ;

/// @brief Method GetComparer, addr 0x441c0c0, size 0x58, virtual false, abstract: false, final false
static inline ::System::Collections::IComparer* GetComparer() ;

/// @brief Method GetHashCode, addr 0x441c1e8, size 0x160, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method InternalSetName, addr 0x441ad98, size 0x100, virtual false, abstract: false, final false
inline bool InternalSetName(::StringW  value) ;

/// @brief Method IsDomainEqualToHost, addr 0x441afa8, size 0x58, virtual false, abstract: false, final false
static inline bool IsDomainEqualToHost(::StringW  domain, ::StringW  host) ;

static inline ::System::Net::Cookie* New_ctor() ;

/// @brief Method ToString, addr 0x441c348, size 0x24c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method VerifySetDefaults, addr 0x441b000, size 0x9d4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x441a8a4, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Comment, addr 0x441a984, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Comment() ;

/// @brief Method get_Domain, addr 0x441aa04, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Domain() ;

/// @brief Method get_DomainKey, addr 0x441bf1c, size 0x1c, virtual false, abstract: false, final false
inline ::StringW get_DomainKey() ;

/// @brief Method get_Expired, addr 0x441ab5c, size 0xb8, virtual false, abstract: false, final false
inline bool get_Expired() ;

/// @brief Method get_Name, addr 0x441ac1c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Path, addr 0x441ae98, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Path() ;

/// @brief Method get_Plain, addr 0x441ab4c, size 0x10, virtual false, abstract: false, final false
inline bool get_Plain() ;

/// @brief Method get_Port, addr 0x441ba88, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Port() ;

/// @brief Method get_PortList, addr 0x441bdc0, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> get_PortList() ;

/// @brief Method get_Secure, addr 0x441be90, size 0x8, virtual false, abstract: false, final false
inline bool get_Secure() ;

/// @brief Method get_Value, addr 0x441bea4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method get_Variant, addr 0x441bf14, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::CookieVariant get_Variant() ;

/// @brief Method get_Version, addr 0x441bf38, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Version() ;

/// @brief Method get__Domain, addr 0x441aa80, size 0xcc, virtual false, abstract: false, final false
inline ::StringW get__Domain() ;

/// @brief Method get__Path, addr 0x441af0c, size 0x9c, virtual false, abstract: false, final false
inline ::StringW get__Path() ;

/// @brief Method get__Port, addr 0x441bdc8, size 0xc8, virtual false, abstract: false, final false
inline ::StringW get__Port() ;

/// @brief Method get__Version, addr 0x441bfb4, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method set_Comment, addr 0x441a98c, size 0x58, virtual false, abstract: false, final false
inline void set_Comment(::StringW  value) ;

/// @brief Method set_CommentUri, addr 0x441a9e4, size 0x8, virtual false, abstract: false, final false
inline void set_CommentUri(::System::Uri*  value) ;

/// @brief Method set_Discard, addr 0x441a9f8, size 0xc, virtual false, abstract: false, final false
inline void set_Discard(bool  value) ;

/// @brief Method set_Domain, addr 0x441aa0c, size 0x74, virtual false, abstract: false, final false
inline void set_Domain(::StringW  value) ;

/// @brief Method set_Expires, addr 0x441ac14, size 0x8, virtual false, abstract: false, final false
inline void set_Expires(::System::DateTime  value) ;

/// @brief Method set_HttpOnly, addr 0x441a9ec, size 0xc, virtual false, abstract: false, final false
inline void set_HttpOnly(bool  value) ;

/// @brief Method set_Name, addr 0x441ac24, size 0x174, virtual false, abstract: false, final false
inline void set_Name(::StringW  value) ;

/// @brief Method set_Path, addr 0x441aea0, size 0x6c, virtual false, abstract: false, final false
inline void set_Path(::StringW  value) ;

/// @brief Method set_Port, addr 0x441ba90, size 0x330, virtual false, abstract: false, final false
inline void set_Port(::StringW  value) ;

/// @brief Method set_Secure, addr 0x441be98, size 0xc, virtual false, abstract: false, final false
inline void set_Secure(bool  value) ;

/// @brief Method set_Value, addr 0x441beac, size 0x68, virtual false, abstract: false, final false
inline void set_Value(::StringW  value) ;

/// @brief Method set_Version, addr 0x441bf40, size 0x74, virtual false, abstract: false, final false
