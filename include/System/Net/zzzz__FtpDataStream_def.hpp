...
/// @brief Method AsyncReadCallback, addr 0x4404198, size 0x2b0, virtual false, abstract: false, final false
inline void AsyncReadCallback(::System::IAsyncResult*  ar) ;

/// @brief Method BeginRead, addr 0x4404448, size 0x198, virtual true, abstract: false, final false
...
/// @brief Method BeginWrite, addr 0x4404780, size 0xf4, virtual true, abstract: false, final false
...
/// @brief Method CheckError, addr 0x4403e14, size 0x44, virtual false, abstract: false, final false
inline void CheckError() ;

/// @brief Method Dispose, addr 0x44038a8, size 0x188, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EndRead, addr 0x44045e0, size 0x1a0, virtual true, abstract: false, final false
inline int32_t EndRead(::System::IAsyncResult*  ar) ;

/// @brief Method EndWrite, addr 0x4404874, size 0xa0, virtual true, abstract: false, final false
inline void EndWrite(::System::IAsyncResult*  asyncResult) ;

/// @brief Method Flush, addr 0x4404914, size 0x24, virtual true, abstract: false, final false
inline void Flush() ;
...
/// @brief Method Read, addr 0x4403fbc, size 0x104, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method Seek, addr 0x4403ef0, size 0xcc, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetLength, addr 0x4404938, size 0x24, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method SetSocketTimeoutOption, addr 0x4404a0c, size 0x50, virtual false, abstract: false, final false
inline void SetSocketTimeoutOption(int32_t  timeout) ;

/// @brief Method System.Net.ICloseEx.CloseEx, addr 0x4403a30, size 0x3e4, virtual true, abstract: false, final true
inline void System_Net_ICloseEx_CloseEx(::System::Net::CloseExState  closeState) ;

/// @brief Method Write, addr 0x44040c0, size 0xd8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43ffdd0, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method get_CanRead, addr 0x4403e58, size 0x8, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x4403e60, size 0x20, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanTimeout, addr 0x440495c, size 0x20, virtual true, abstract: false, final false
inline bool get_CanTimeout() ;

/// @brief Method get_CanWrite, addr 0x4403e80, size 0x8, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Length, addr 0x4403e88, size 0x20, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Position, addr 0x4403ea8, size 0x24, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method get_ReadTimeout, addr 0x440497c, size 0x24, virtual true, abstract: false, final false
inline int32_t get_ReadTimeout() ;

/// @brief Method get_WriteTimeout, addr 0x44049c4, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method set_Position, addr 0x4403ecc, size 0x24, virtual true, abstract: false, final false
inline void set_Position(int64_t  value) ;

/// @brief Method set_ReadTimeout, addr 0x44049a0, size 0x24, virtual true, abstract: false, final false
inline void set_ReadTimeout(int32_t  value) ;

/// @brief Method set_WriteTimeout, addr 0x44049e8, size 0x24, virtual true, abstract: false, final false
