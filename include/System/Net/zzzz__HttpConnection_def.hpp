...
/// @brief Method BeginReadRequest, addr 0x442f1dc, size 0x1a8, virtual false, abstract: false, final false
inline void BeginReadRequest() ;

/// @brief Method Close, addr 0x4430a74, size 0x264, virtual false, abstract: false, final false
inline void Close(bool  force_close) ;

/// @brief Method CloseSocket, addr 0x4432fc0, size 0x104, virtual false, abstract: false, final false
inline void CloseSocket() ;

/// @brief Method GetRequestStream, addr 0x44330f4, size 0x148, virtual false, abstract: false, final false
inline ::System::Net::RequestStream* GetRequestStream(bool  chunked, int64_t  contentlength) ;

/// @brief Method GetResponseStream, addr 0x443323c, size 0xc8, virtual false, abstract: false, final false
inline ::System::Net::ResponseStream* GetResponseStream() ;

/// @brief Method Init, addr 0x4432d88, size 0xa4, virtual false, abstract: false, final false
inline void Init() ;
...
/// @brief Method OnRead, addr 0x4433304, size 0xd4, virtual false, abstract: false, final false
static inline void OnRead(::System::IAsyncResult*  ares) ;

/// @brief Method OnReadInternal, addr 0x44333d8, size 0x338, virtual false, abstract: false, final false
inline void OnReadInternal(::System::IAsyncResult*  ares) ;

/// @brief Method OnTimeout, addr 0x4432fa8, size 0x18, virtual false, abstract: false, final false
inline void OnTimeout(::System::Object*  unused) ;

/// @brief Method ProcessInput, addr 0x4433730, size 0x2b8, virtual false, abstract: false, final false
inline bool ProcessInput(::System::IO::MemoryStream*  ms) ;

/// @brief Method ReadLine, addr 0x443441c, size 0x174, virtual false, abstract: false, final false
inline ::StringW ReadLine(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  len, ByRef<int32_t>  used) ;

/// @brief Method RemoveConnection, addr 0x443401c, size 0x40, virtual false, abstract: false, final false
inline void RemoveConnection() ;

/// @brief Method SendError, addr 0x4433710, size 0x20, virtual false, abstract: false, final false
inline void SendError() ;

/// @brief Method SendError, addr 0x442ae24, size 0x1dc, virtual false, abstract: false, final false
inline void SendError(::StringW  msg, int32_t  status) ;

/// @brief Method Unbind, addr 0x44330c4, size 0x30, virtual false, abstract: false, final false
inline void Unbind() ;
...
/// @brief Method <.ctor>b__24_0, addr 0x443564c, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x442ef90, size 0x24c, virtual false, abstract: false, final false
...
/// @brief Method get_IsSecure, addr 0x4432f98, size 0x8, virtual false, abstract: false, final false
inline bool get_IsSecure() ;

/// @brief Method get_LocalEndPoint, addr 0x4432ee0, size 0xb8, virtual false, abstract: false, final false
inline ::System::Net::IPEndPoint* get_LocalEndPoint() ;

/// @brief Method get_Reuses, addr 0x4432ed8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Reuses() ;

static inline void setStaticF_onread_cb(::System::AsyncCallback*  value) ;

/// @brief Method set_Prefix, addr 0x4432fa0, size 0x8, virtual false, abstract: false, final false
