...
/// @brief Method .ctor, addr 0x441a11c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  durationMilliseconds) ;

/// @brief Method get_Duration, addr 0x441a144, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x441a194, size 0xc, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method .ctor, addr 0x441a14c, size 0x34, virtual false, abstract: false, final false
inline void _ctor(int32_t  durationMilliseconds) ;

/// @brief Method get_Expiration, addr 0x441a188, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_StartTime, addr 0x441a180, size 0x8, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method Invoke, addr 0x441a1a0, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4405acc, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method CreateTimer, addr 0x441a1e4, size 0x1e0, virtual true, abstract: false, final false
inline ::System::Net::__TimerThread__Timer* CreateTimer(::System::Net::__TimerThread__Callback*  callback, ::System::Object*  context) ;

/// @brief Method Fire, addr 0x4419e28, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44194bc, size 0x90, virtual false, abstract: false, final false
inline void _ctor(int32_t  durationMilliseconds) ;
...
public:
// Declarations
/// @brief Method CreateTimer, addr 0x441a694, size 0x68, virtual true, abstract: false, final false
inline ::System::Net::__TimerThread__Timer* CreateTimer(::System::Net::__TimerThread__Callback*  callback, ::System::Object*  context) ;

static inline ::System::Net::__TimerThread__InfiniteTimerQueue* New_ctor() ;

/// @brief Method .ctor, addr 0x441949c, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Cancel, addr 0x441a758, size 0x120, virtual true, abstract: false, final false
inline bool Cancel() ;

/// @brief Method Fire, addr 0x441a41c, size 0x278, virtual false, abstract: false, final false
inline bool Fire() ;
...
/// @brief Method .ctor, addr 0x441a1b4, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x441a3c4, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method get_HasExpired, addr 0x441a728, size 0x10, virtual true, abstract: false, final false
inline bool get_HasExpired() ;

/// @brief Method get_Next, addr 0x441a738, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::__TimerThread__TimerNode* get_Next() ;

/// @brief Method get_Prev, addr 0x441a748, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::__TimerThread__TimerNode* get_Prev() ;

/// @brief Method set_Next, addr 0x441a740, size 0x8, virtual false, abstract: false, final false
inline void set_Next(::System::Net::__TimerThread__TimerNode*  value) ;

/// @brief Method set_Prev, addr 0x441a750, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Cancel, addr 0x441a880, size 0x24, virtual true, abstract: false, final false
inline bool Cancel() ;
...
/// @brief Method .ctor, addr 0x441a6fc, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HasExpired, addr 0x441a878, size 0x8, virtual true, abstract: false, final false
inline bool get_HasExpired() ;
...
/// @brief Method CreateQueue, addr 0x4414e2c, size 0x23c, virtual false, abstract: false, final false
static inline ::System::Net::__TimerThread__Queue* CreateQueue(int32_t  durationMilliseconds) ;

/// @brief Method GetOrCreateQueue, addr 0x440975c, size 0x958, virtual false, abstract: false, final false
static inline ::System::Net::__TimerThread__Queue* GetOrCreateQueue(int32_t  durationMilliseconds) ;

/// @brief Method IsTickBetween, addr 0x4419fb8, size 0x24, virtual false, abstract: false, final false
static inline bool IsTickBetween(int32_t  start, int32_t  end, int32_t  comparand) ;

/// @brief Method OnDomainUnload, addr 0x441a058, size 0xc4, virtual false, abstract: false, final false
static inline void OnDomainUnload(::System::Object*  sender, ::System::EventArgs*  e) ;

/// @brief Method Prod, addr 0x441954c, size 0x110, virtual false, abstract: false, final false
static inline void Prod() ;

/// @brief Method StopTimerThread, addr 0x4419fdc, size 0x7c, virtual false, abstract: false, final false
static inline void StopTimerThread() ;

/// @brief Method ThreadProc, addr 0x441965c, size 0x7cc, virtual false, abstract: false, final false
