...
public:
// Declarations
/// @brief Method CountBackslashes, addr 0x4373184, size 0xa4, virtual false, abstract: false, final false
static inline int32_t CountBackslashes(::StringW  data, int32_t  index) ;

/// @brief Method CountQuotedChars, addr 0x4371c84, size 0x18c, virtual false, abstract: false, final false
