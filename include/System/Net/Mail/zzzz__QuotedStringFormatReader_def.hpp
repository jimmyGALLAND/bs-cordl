...
public:
// Declarations
/// @brief Method IsValidQtext, addr 0x4373228, size 0xb8, virtual false, abstract: false, final false
static inline bool IsValidQtext(bool  allowUnicode, char16_t  ch) ;

/// @brief Method ReadReverseQuoted, addr 0x4372e28, size 0x1c4, virtual false, abstract: false, final false
static inline int32_t ReadReverseQuoted(::StringW  data, int32_t  index, bool  permitUnicode) ;

/// @brief Method ReadReverseUnQuoted, addr 0x4372fec, size 0x198, virtual false, abstract: false, final false
