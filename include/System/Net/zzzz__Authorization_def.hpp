...
/// @brief Method .ctor, addr 0x440c92c, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::StringW  token) ;

/// @brief Method .ctor, addr 0x440c9d0, size 0x94, virtual false, abstract: false, final false
inline void _ctor(::StringW  token, bool  finished) ;

/// @brief Method get_Complete, addr 0x440ca6c, size 0x8, virtual false, abstract: false, final false
inline bool get_Complete() ;

/// @brief Method get_Message, addr 0x440ca64, size 0x8, virtual false, abstract: false, final false
