...
/// @brief Method Complete, addr 0x433ea64, size 0x8, virtual false, abstract: false, final false
inline void Complete(::System::Net::HttpListenerContext*  context) ;

/// @brief Method Complete, addr 0x433ea6c, size 0x51c, virtual false, abstract: false, final false
inline void Complete(::System::Net::HttpListenerContext*  context, bool  synch) ;

/// @brief Method Complete, addr 0x433e740, size 0x1e8, virtual false, abstract: false, final false
inline void Complete(::System::Exception*  exc) ;

/// @brief Method GetContext, addr 0x433ef88, size 0x3c, virtual false, abstract: false, final false
inline ::System::Net::HttpListenerContext* GetContext() ;

/// @brief Method InvokeCallback, addr 0x433e928, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x433e6c8, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method get_AsyncState, addr 0x433efc4, size 0x14, virtual true, abstract: false, final true
inline ::System::Object* get_AsyncState() ;

/// @brief Method get_AsyncWaitHandle, addr 0x433efd8, size 0x128, virtual true, abstract: false, final true
inline ::System::Threading::WaitHandle* get_AsyncWaitHandle() ;

/// @brief Method get_CompletedSynchronously, addr 0x433f100, size 0x14, virtual true, abstract: false, final true
inline bool get_CompletedSynchronously() ;

/// @brief Method get_IsCompleted, addr 0x433f114, size 0xdc, virtual true, abstract: false, final true
