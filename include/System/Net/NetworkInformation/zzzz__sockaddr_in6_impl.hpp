...
constexpr ::System::Net::NetworkInformation::sockaddr_in6::sockaddr_in6(uint16_t  sin6_family, uint16_t  sin6_port, uint32_t  sin6_flowinfo, ::System::Net::NetworkInformation::in6_addr  sin6_addr, uint32_t  sin6_scope_id) noexcept  {
