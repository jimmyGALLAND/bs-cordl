...
// Ctor Parameters [CppParam { name: "ifu_broadaddr", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}") }, CppParam { name: "ifu_dstaddr", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}") }]
