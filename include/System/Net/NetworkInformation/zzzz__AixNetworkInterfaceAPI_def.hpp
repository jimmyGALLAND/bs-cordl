...
public:
// Declarations
/// @brief Method ByteArrayCopy, addr 0x435884c, size 0x1c, virtual false, abstract: false, final false
static inline void ByteArrayCopy(::cordl_internals::Ptr<uint8_t>  dst, ::cordl_internals::Ptr<uint8_t>  src, int32_t  elements) ;

/// @brief Method GetAllNetworkInterfaces, addr 0x4358868, size 0xe20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43598f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method close, addr 0x4358554, size 0x78, virtual false, abstract: false, final false
static inline int32_t close(int32_t  fd) ;

/// @brief Method ioctl, addr 0x435866c, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method ioctl, addr 0x435870c, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method ioctl, addr 0x43587ac, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method ioctl, addr 0x43585cc, size 0xa0, virtual false, abstract: false, final false
static inline int32_t ioctl(int32_t  fd, ::System::Net::NetworkInformation::AixIoctlRequest  request, ByRef<int32_t>  arg) ;

/// @brief Method socket, addr 0x43584b4, size 0xa0, virtual false, abstract: false, final false
