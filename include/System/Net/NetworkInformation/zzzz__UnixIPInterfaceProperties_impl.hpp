...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Net::NetworkInformation::UnixIPInterfaceProperties::*)(::System::Net::NetworkInformation::UnixNetworkInterface*, ::System::Collections::Generic::List_1<::System::Net::IPAddress*>*)>(&::System::Net::NetworkInformation::UnixIPInterfaceProperties::_ctor)> {
  constexpr static std::size_t size = 0x2c;
  constexpr static std::size_t addrs = 0x43581e8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Net::NetworkInformation::UnixNetworkInterface*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::List_1<::System::Net::IPAddress*>*>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Net::NetworkInformation::UnicastIPAddressInformationCollection* (::System::Net::NetworkInformation::UnixIPInterfaceProperties::*)()>(&::System::Net::NetworkInformation::UnixIPInterfaceProperties::get_UnicastAddresses)> {
  constexpr static std::size_t size = 0x268;
  constexpr static std::size_t addrs = 0x435c8c8;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::NetworkInformation::UnixNetworkInterface*> const& System::Net::NetworkInformation::UnixIPInterfaceProperties::__cordl_internal_get_iface() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___iface;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Net::IPAddress*>*> const& System::Net::NetworkInformation::UnixIPInterfaceProperties::__cordl_internal_get_addresses() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___addresses;
}
...
inline ::System::Net::NetworkInformation::UnixIPInterfaceProperties* System::Net::NetworkInformation::UnixIPInterfaceProperties::New_ctor(::System::Net::NetworkInformation::UnixNetworkInterface*  iface, ::System::Collections::Generic::List_1<::System::Net::IPAddress*>*  addresses)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Net::NetworkInformation::UnixIPInterfaceProperties*>(iface, addresses));
}
inline void System::Net::NetworkInformation::UnixIPInterfaceProperties::_ctor(::System::Net::NetworkInformation::UnixNetworkInterface*  iface, ::System::Collections::Generic::List_1<::System::Net::IPAddress*>*  addresses)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::NetworkInformation::UnixIPInterfaceProperties*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
