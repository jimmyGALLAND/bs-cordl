...
/// @brief Method GetIPProperties, addr 0x4359988, size 0x7c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4359818, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, uint32_t  ifa_flags, int32_t  ifru_mtu) ;

/// @brief Method get_OperationalStatus, addr 0x4359a04, size 0x14, virtual true, abstract: false, final false
