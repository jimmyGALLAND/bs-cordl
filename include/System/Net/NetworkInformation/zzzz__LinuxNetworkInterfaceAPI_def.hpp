...
public:
// Declarations
/// @brief Method FreeInterfaceAddresses, addr 0x435a044, size 0x4, virtual false, abstract: false, final false
static inline void FreeInterfaceAddresses(::System::IntPtr  ifap) ;

/// @brief Method GetAllNetworkInterfaces, addr 0x435a144, size 0xae0, virtual true, abstract: false, final false
...
/// @brief Method GetInterfaceAddresses, addr 0x435a0c4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x435acfc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
