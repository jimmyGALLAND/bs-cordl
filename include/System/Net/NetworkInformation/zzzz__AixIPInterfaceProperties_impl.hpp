...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Net::NetworkInformation::AixIPInterfaceProperties::*)(::System::Net::NetworkInformation::AixNetworkInterface*, ::System::Collections::Generic::List_1<::System::Net::IPAddress*>*, int32_t)>(&::System::Net::NetworkInformation::AixIPInterfaceProperties::_ctor)> {
  constexpr static std::size_t size = 0x80;
  constexpr static std::size_t addrs = 0x4358168;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Net::NetworkInformation::AixNetworkInterface*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::List_1<::System::Net::IPAddress*>*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::StringW, ByRef<::ArrayW<::StringW,::Array<::StringW>*>>)>(&::System::Net::NetworkInformation::AixIPInterfaceProperties::ParseRouteInfo_icall)> {
  constexpr static std::size_t size = 0x44;
  constexpr static std::size_t addrs = 0x4358214;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<::ArrayW<::StringW,::Array<::StringW>*>>>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Net::NetworkInformation::GatewayIPAddressInformationCollection* (::System::Net::NetworkInformation::AixIPInterfaceProperties::*)()>(&::System::Net::NetworkInformation::AixIPInterfaceProperties::get_GatewayAddresses)> {
  constexpr static std::size_t size = 0x25c;
  constexpr static std::size_t addrs = 0x4358258;
...
inline ::System::Net::NetworkInformation::AixIPInterfaceProperties* System::Net::NetworkInformation::AixIPInterfaceProperties::New_ctor(::System::Net::NetworkInformation::AixNetworkInterface*  iface, ::System::Collections::Generic::List_1<::System::Net::IPAddress*>*  addresses, int32_t  mtu)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Net::NetworkInformation::AixIPInterfaceProperties*>(iface, addresses, mtu));
}
inline void System::Net::NetworkInformation::AixIPInterfaceProperties::_ctor(::System::Net::NetworkInformation::AixNetworkInterface*  iface, ::System::Collections::Generic::List_1<::System::Net::IPAddress*>*  addresses, int32_t  mtu)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::NetworkInformation::AixIPInterfaceProperties*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
