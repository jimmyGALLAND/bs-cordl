...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Net::NetworkInformation::AixStructs::sockaddr_dl::*)(::System::IntPtr)>(&::System::Net::NetworkInformation::AixStructs::sockaddr_dl::Read)> {
  constexpr static std::size_t size = 0x190;
  constexpr static std::size_t addrs = 0x4359688;
...
constexpr ::System::Net::NetworkInformation::AixStructs::sockaddr_dl::sockaddr_dl(uint8_t  sdl_len, uint8_t  sdl_family, uint16_t  sdl_index, uint8_t  sdl_type, uint8_t  sdl_nlen, uint8_t  sdl_alen, uint8_t  sdl_slen, ::ArrayW<uint8_t,::Array<uint8_t>*>  sdl_data) noexcept  {
