...
constexpr ::System::Net::NetworkInformation::AixStructs::sockaddr_in6::sockaddr_in6(uint8_t  sin6_len, uint8_t  sin6_family, uint16_t  sin6_port, uint32_t  sin6_flowinfo, ::System::Net::NetworkInformation::AixStructs::in6_addr  sin6_addr, uint32_t  sin6_scope_id) noexcept  {
...
// Ctor Parameters []
constexpr ::System::Net::NetworkInformation::AixStructs::sockaddr_in6::sockaddr_in6()   {
}
