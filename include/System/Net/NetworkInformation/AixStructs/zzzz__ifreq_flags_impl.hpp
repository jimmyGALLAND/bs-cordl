...
constexpr ::System::Net::NetworkInformation::AixStructs::__ifreq_flags___ifr_name_e__FixedBuffer::__ifreq_flags___ifr_name_e__FixedBuffer(uint8_t  FixedElementField) noexcept  {
...
constexpr ::System::Net::NetworkInformation::AixStructs::__ifreq_flags___ifr_name_e__FixedBuffer const& System::Net::NetworkInformation::AixStructs::ifreq_flags::__cordl_internal_get_ifr_name() const {
return this->___ifr_name;
}
...
constexpr ::System::Net::NetworkInformation::AixStructs::ifreq_flags::ifreq_flags(::System::Net::NetworkInformation::AixStructs::__ifreq_flags___ifr_name_e__FixedBuffer  ifr_name, uint32_t  ifru_flags) noexcept  {
