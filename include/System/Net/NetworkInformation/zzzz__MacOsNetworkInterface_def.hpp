...
/// @brief Method GetIPProperties, addr 0x435c200, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x435c1dc, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, uint32_t  ifa_flags) ;

/// @brief Method get_OperationalStatus, addr 0x435c26c, size 0x14, virtual true, abstract: false, final false
