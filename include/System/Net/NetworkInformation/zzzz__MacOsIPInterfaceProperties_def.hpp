...
/// @brief Method ParseRouteInfo_icall, addr 0x435b440, size 0x4, virtual false, abstract: false, final false
static inline bool ParseRouteInfo_icall(::StringW  iface, ByRef<::ArrayW<::StringW,::Array<::StringW>*>>  gw_addr_list) ;

/// @brief Method .ctor, addr 0x435b3d0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_GatewayAddresses, addr 0x435b444, size 0x234, virtual true, abstract: false, final false
