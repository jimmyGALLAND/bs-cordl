...
static __declspec(property(get=getStaticF__PlatformNeedsLibCWorkaround_k__BackingField, put=setStaticF__PlatformNeedsLibCWorkaround_k__BackingField)) bool  _PlatformNeedsLibCWorkaround_k__BackingField;

/// @brief Method Create, addr 0x4359a60, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_PlatformNeedsLibCWorkaround, addr 0x435c880, size 0x48, virtual false, abstract: false, final false
