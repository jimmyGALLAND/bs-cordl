...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Net::NetworkInformation::MacOsIPInterfaceProperties::*)(::System::Net::NetworkInformation::MacOsNetworkInterface*, ::System::Collections::Generic::List_1<::System::Net::IPAddress*>*)>(&::System::Net::NetworkInformation::MacOsIPInterfaceProperties::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x435b3d0;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Net::NetworkInformation::MacOsNetworkInterface*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::List_1<::System::Net::IPAddress*>*>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::StringW, ByRef<::ArrayW<::StringW,::Array<::StringW>*>>)>(&::System::Net::NetworkInformation::MacOsIPInterfaceProperties::ParseRouteInfo_icall)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x435b440;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Net::NetworkInformation::GatewayIPAddressInformationCollection* (::System::Net::NetworkInformation::MacOsIPInterfaceProperties::*)()>(&::System::Net::NetworkInformation::MacOsIPInterfaceProperties::get_GatewayAddresses)> {
  constexpr static std::size_t size = 0x234;
  constexpr static std::size_t addrs = 0x435b444;
...
inline ::System::Net::NetworkInformation::MacOsIPInterfaceProperties* System::Net::NetworkInformation::MacOsIPInterfaceProperties::New_ctor(::System::Net::NetworkInformation::MacOsNetworkInterface*  iface, ::System::Collections::Generic::List_1<::System::Net::IPAddress*>*  addresses)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Net::NetworkInformation::MacOsIPInterfaceProperties*>(iface, addresses));
}
inline void System::Net::NetworkInformation::MacOsIPInterfaceProperties::_ctor(::System::Net::NetworkInformation::MacOsNetworkInterface*  iface, ::System::Collections::Generic::List_1<::System::Net::IPAddress*>*  addresses)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::NetworkInformation::MacOsIPInterfaceProperties*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
