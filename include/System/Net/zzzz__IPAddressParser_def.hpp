...
public:
// Declarations
/// @brief Method AppendHex, addr 0x43fcbc4, size 0x68, virtual false, abstract: false, final false
static inline void AppendHex(uint16_t  value, ::System::Text::StringBuilder*  buffer) ;

/// @brief Method AppendSections, addr 0x43fc9dc, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method ExtractIPv4Address, addr 0x43fcb90, size 0x34, virtual false, abstract: false, final false
static inline uint32_t ExtractIPv4Address(::ArrayW<uint16_t,::Array<uint16_t>*>  address) ;

/// @brief Method FormatIPv4AddressNumber, addr 0x43fc804, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method IPv4AddressToString, addr 0x43fbb78, size 0x60, virtual false, abstract: false, final false
static inline ::StringW IPv4AddressToString(uint32_t  address) ;

/// @brief Method IPv4AddressToString, addr 0x43fc794, size 0x70, virtual false, abstract: false, final false
static inline void IPv4AddressToString(uint32_t  address, ::System::Text::StringBuilder*  destination) ;

/// @brief Method IPv4AddressToStringHelper, addr 0x43fc6f8, size 0x9c, virtual false, abstract: false, final false
static inline int32_t IPv4AddressToStringHelper(uint32_t  address, ::cordl_internals::Ptr<char16_t>  addressString) ;

/// @brief Method IPv6AddressToString, addr 0x43fbb64, size 0x14, virtual false, abstract: false, final false
static inline ::StringW IPv6AddressToString(::ArrayW<uint16_t,::Array<uint16_t>*>  address, uint32_t  scopeId) ;

/// @brief Method IPv6AddressToStringHelper, addr 0x43fc8bc, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method Ipv4StringToAddress, addr 0x43fc648, size 0xb0, virtual false, abstract: false, final false
static inline bool Ipv4StringToAddress(::System::ReadOnlySpan_1<char16_t>  ipSpan, ByRef<int64_t>  address) ;

/// @brief Method Ipv6StringToAddress, addr 0x43fc4d4, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x43fb4dc, size 0x1c4, virtual false, abstract: false, final false
static inline ::System::Net::IPAddress* Parse(::System::ReadOnlySpan_1<char16_t>  ipSpan, bool  tryParse) ;

/// @brief Method Reverse, addr 0x43fcc2c, size 0xc, virtual false, abstract: false, final false
