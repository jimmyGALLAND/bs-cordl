...
/// @brief Method HasFlag, addr 0x43fdd7c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43ff084, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  command) ;

/// @brief Method .ctor, addr 0x43ff0ac, size 0x30, virtual false, abstract: false, final false
...
/// @brief Field _commands, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__commands, put=__cordl_internal_set__commands)) ::ArrayW<::System::Net::__CommandStream__PipelineEntry*,::Array<::System::Net::__CommandStream__PipelineEntry*>*>  _commands;
...
/// @brief Method Abort, addr 0x43fd284, size 0x1e8, virtual true, abstract: false, final false
inline void Abort(::System::Exception*  e) ;

/// @brief Method BuildCommandsList, addr 0x43fdb88, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method CheckContinuePipeline, addr 0x43fdcc8, size 0xb4, virtual false, abstract: false, final false
inline void CheckContinuePipeline() ;

/// @brief Method CheckValid, addr 0x43fef14, size 0x8, virtual true, abstract: false, final false
inline bool CheckValid(::System::Net::ResponseDescription*  response, ByRef<int32_t>  validThrough, ByRef<int32_t>  completeLength) ;

/// @brief Method ClearState, addr 0x43fdb78, size 0x10, virtual true, abstract: false, final false
inline void ClearState() ;

/// @brief Method ContinueCommandPipeline, addr 0x43fd6a8, size 0x4d0, virtual false, abstract: false, final false
inline ::System::IO::Stream* ContinueCommandPipeline() ;

/// @brief Method Dispose, addr 0x43fd46c, size 0x94, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GenerateException, addr 0x43fdc08, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method GenerateException, addr 0x43fdb90, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method InitCommandPipeline, addr 0x43fd614, size 0x94, virtual false, abstract: false, final false
inline void InitCommandPipeline(::System::Net::WebRequest*  request, ::ArrayW<::System::Net::__CommandStream__PipelineEntry*,::Array<::System::Net::__CommandStream__PipelineEntry*>*>  commands, bool  isAsync) ;

/// @brief Method InvokeRequestCallback, addr 0x43fd500, size 0x74, virtual false, abstract: false, final false
inline void InvokeRequestCallback(::System::Object*  obj) ;

/// @brief Method MarkAsRecoverableFailure, addr 0x43fd57c, size 0x18, virtual false, abstract: false, final false
inline void MarkAsRecoverableFailure() ;

static inline ::System::Net::CommandStream* New_ctor(::System::Net::Sockets::TcpClient*  client) ;

/// @brief Method PipelineCallback, addr 0x43fe408, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method PostReadCommandProcessing, addr 0x43fe204, size 0x204, virtual false, abstract: false, final false
inline bool PostReadCommandProcessing(ByRef<::System::IO::Stream*>  stream) ;

/// @brief Method PostSendCommandProcessing, addr 0x43fdd8c, size 0x130, virtual false, abstract: false, final false
inline bool PostSendCommandProcessing(ByRef<::System::IO::Stream*>  stream) ;

/// @brief Method ReadCallback, addr 0x43fe410, size 0x2c8, virtual false, abstract: false, final false
static inline void ReadCallback(::System::IAsyncResult*  asyncResult) ;

/// @brief Method ReceiveCommandResponse, addr 0x43fdebc, size 0x348, virtual false, abstract: false, final false
inline ::System::Net::ResponseDescription* ReceiveCommandResponse() ;

/// @brief Method ReceiveCommandResponseCallback, addr 0x43fe6d8, size 0x548, virtual false, abstract: false, final false
inline void ReceiveCommandResponseCallback(::System::Net::ReceiveState*  state, int32_t  bytesRead) ;

/// @brief Method SubmitRequest, addr 0x43fd594, size 0x80, virtual false, abstract: false, final false
inline ::System::IO::Stream* SubmitRequest(::System::Net::WebRequest*  request, bool  isAsync, bool  readInitalResponseOnConnect) ;

/// @brief Method WriteCallback, addr 0x43fec20, size 0x2b4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43fd1ec, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method get_Encoding, addr 0x43feed4, size 0x8, virtual false, abstract: false, final false
inline ::System::Text::Encoding* get_Encoding() ;

/// @brief Method get_RecoverableFailure, addr 0x43fd574, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Encoding, addr 0x43feedc, size 0x38, virtual false, abstract: false, final false
