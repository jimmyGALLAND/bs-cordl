...
/// @brief Method Authenticate, addr 0x442d2ec, size 0x298, virtual true, abstract: false, final true
...
/// @brief Method CheckExpired, addr 0x442ca94, size 0x858, virtual false, abstract: false, final false
static inline void CheckExpired(int32_t  count) ;

static inline ::System::Net::DigestClient* New_ctor() ;

/// @brief Method PreAuthenticate, addr 0x442d584, size 0x180, virtual true, abstract: false, final true
inline ::System::Net::Authorization* PreAuthenticate(::System::Net::WebRequest*  webRequest, ::System::Net::ICredentials*  credentials) ;

/// @brief Method .ctor, addr 0x4428f48, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Hashtable* getStaticF_cache() ;

/// @brief Method get_AuthenticationType, addr 0x442d704, size 0x40, virtual true, abstract: false, final true
inline ::StringW get_AuthenticationType() ;

/// @brief Method get_Cache, addr 0x442c930, size 0x164, virtual false, abstract: false, final false
