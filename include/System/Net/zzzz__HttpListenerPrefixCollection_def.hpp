...
/// @brief Method Add, addr 0x443724c, size 0x12c, virtual true, abstract: false, final true
inline void Add(::StringW  uriPrefix) ;

/// @brief Method Clear, addr 0x4437378, size 0xb8, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method Contains, addr 0x4437430, size 0x64, virtual true, abstract: false, final true
inline bool Contains(::StringW  uriPrefix) ;

/// @brief Method CopyTo, addr 0x4437494, size 0x74, virtual true, abstract: false, final true
inline void CopyTo(::ArrayW<::StringW,::Array<::StringW>*>  array, int32_t  offset) ;

/// @brief Method GetEnumerator, addr 0x4431a1c, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method Remove, addr 0x4437598, size 0x100, virtual true, abstract: false, final true
inline bool Remove(::StringW  uriPrefix) ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x4437508, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x44358dc, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::System::Net::HttpListener*  listener) ;

/// @brief Method get_Count, addr 0x4436dc0, size 0x48, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_IsReadOnly, addr 0x4437244, size 0x8, virtual true, abstract: false, final true
