...
/// @brief Method AddPercentEncodedOctetToRawOctetsList, addr 0x440e31c, size 0x150, virtual false, abstract: false, final false
inline bool AddPercentEncodedOctetToRawOctetsList(::System::Text::Encoding*  encoding, ::StringW  escapedCharacter) ;

/// @brief Method AddSlashToAsteriskOnlyPath, addr 0x440cff0, size 0x7c, virtual false, abstract: false, final false
static inline ::StringW AddSlashToAsteriskOnlyPath(::StringW  path) ;

/// @brief Method AppendOctetsPercentEncoded, addr 0x440e46c, size 0x368, virtual false, abstract: false, final false
...
/// @brief Method AppendUnicodeCodePointValuePercentEncoded, addr 0x440e010, size 0x30c, virtual false, abstract: false, final false
inline bool AppendUnicodeCodePointValuePercentEncoded(::StringW  codePoint) ;

/// @brief Method Build, addr 0x440d0fc, size 0xe8, virtual false, abstract: false, final false
inline ::System::Uri* Build() ;

/// @brief Method BuildRequestUriUsingCookedPath, addr 0x440d1e4, size 0x204, virtual false, abstract: false, final false
inline void BuildRequestUriUsingCookedPath() ;

/// @brief Method BuildRequestUriUsingRawPath, addr 0x440d8cc, size 0x254, virtual false, abstract: false, final false
...
/// @brief Method BuildRequestUriUsingRawPath, addr 0x440d3e8, size 0x300, virtual false, abstract: false, final false
inline void BuildRequestUriUsingRawPath() ;

/// @brief Method EmptyDecodeAndAppendRawOctetsList, addr 0x440dc70, size 0x3a0, virtual false, abstract: false, final false
inline bool EmptyDecodeAndAppendRawOctetsList(::System::Text::Encoding*  encoding) ;

/// @brief Method GetEncoding, addr 0x440d860, size 0x6c, virtual false, abstract: false, final false
static inline ::System::Text::Encoding* GetEncoding(::System::Net::__HttpListenerRequestUriBuilder__EncodingType  type) ;

/// @brief Method GetOctetsAsString, addr 0x440e7d4, size 0x3ec, virtual false, abstract: false, final false
static inline ::StringW GetOctetsAsString(::System::Collections::Generic::IEnumerable_1<uint8_t>*  octets) ;

/// @brief Method GetPath, addr 0x440d6f0, size 0x170, virtual false, abstract: false, final false
static inline ::StringW GetPath(::StringW  uriString) ;

/// @brief Method GetRequestUri, addr 0x440d06c, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method LogWarning, addr 0x440d6e8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ParseRawPath, addr 0x440db20, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x440cf2c, size 0xc4, virtual false, abstract: false, final false
