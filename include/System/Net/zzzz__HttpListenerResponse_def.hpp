...
/// @brief Method Close, addr 0x4335a84, size 0x14, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method Close, addr 0x4335a54, size 0x30, virtual false, abstract: false, final false
inline void Close(bool  force) ;

/// @brief Method Close, addr 0x4335a98, size 0xb8, virtual false, abstract: false, final false
inline void Close(::ArrayW<uint8_t,::Array<uint8_t>*>  responseEntity, bool  willBlock) ;

/// @brief Method CookieToClientString, addr 0x4336508, size 0x2a8, virtual false, abstract: false, final false
static inline ::StringW CookieToClientString(::System::Net::Cookie*  cookie) ;

/// @brief Method FormatHeaders, addr 0x43367b0, size 0x25c, virtual false, abstract: false, final false
static inline ::StringW FormatHeaders(::System::Net::WebHeaderCollection*  headers) ;

/// @brief Method IsToken, addr 0x4336adc, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method QuotedString, addr 0x4336a0c, size 0xd0, virtual false, abstract: false, final false
static inline ::StringW QuotedString(::System::Net::Cookie*  cookie, ::StringW  value) ;

/// @brief Method SendHeaders, addr 0x4335b50, size 0x9b8, virtual false, abstract: false, final false
inline void SendHeaders(bool  closing, ::System::IO::MemoryStream*  ms) ;

/// @brief Method System.IDisposable.Dispose, addr 0x4335a4c, size 0x8, virtual true, abstract: false, final true
...
constexpr ::cordl_internals::to_const_pointer<::System::Text::Encoding*> const& __cordl_internal_get_content_encoding() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> const& __cordl_internal_get_headers_lock() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::ResponseStream*> const& __cordl_internal_get_output_stream() const;
...
/// @brief Method .ctor, addr 0x43354f4, size 0x108, virtual false, abstract: false, final false
inline void _ctor(::System::Net::HttpListenerContext*  context) ;

static inline ::StringW getStaticF_tspecials() ;

/// @brief Method get_ContentEncoding, addr 0x4335604, size 0x20, virtual false, abstract: false, final false
inline ::System::Text::Encoding* get_ContentEncoding() ;

/// @brief Method get_ForceCloseChunked, addr 0x43355fc, size 0x8, virtual false, abstract: false, final false
inline bool get_ForceCloseChunked() ;

/// @brief Method get_Headers, addr 0x4335810, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::WebHeaderCollection* get_Headers() ;

/// @brief Method get_OutputStream, addr 0x4335818, size 0x38, virtual false, abstract: false, final false
inline ::System::IO::Stream* get_OutputStream() ;

/// @brief Method get_SendChunked, addr 0x4335850, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_ContentLength64, addr 0x4335624, size 0x120, virtual false, abstract: false, final false
inline void set_ContentLength64(int64_t  value) ;

/// @brief Method set_ContentType, addr 0x4335744, size 0xcc, virtual false, abstract: false, final false
inline void set_ContentType(::StringW  value) ;

/// @brief Method set_SendChunked, addr 0x4335858, size 0xd0, virtual false, abstract: false, final false
inline void set_SendChunked(bool  value) ;

/// @brief Method set_StatusCode, addr 0x4335928, size 0x124, virtual false, abstract: false, final false
