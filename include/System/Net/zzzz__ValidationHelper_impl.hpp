...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::StringW)>(&::System::Net::ValidationHelper::MakeStringNull)> {
  ...
  constexpr static std::size_t addrs = 0x440c9bc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::StringW)>(&::System::Net::ValidationHelper::IsBlankString)> {
  ...
  constexpr static std::size_t addrs = 0x440f2c0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(int32_t)>(&::System::Net::ValidationHelper::ValidateTcpPort)> {
  ...
  constexpr static std::size_t addrs = 0x440f2dc;
...
::cordl_internals::setStaticField<::ArrayW<::StringW,::Array<::StringW>*>, "EmptyArray", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::ValidationHelper*>::get>(std::forward<::ArrayW<::StringW,::Array<::StringW>*>>(value));
}
...
::cordl_internals::setStaticField<::ArrayW<char16_t,::Array<char16_t>*>, "InvalidMethodChars", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::ValidationHelper*>::get>(std::forward<::ArrayW<char16_t,::Array<char16_t>*>>(value));
}
inline ::ArrayW<char16_t,::Array<char16_t>*> System::Net::ValidationHelper::getStaticF_InvalidMethodChars()  {
return ::cordl_internals::getStaticField<::ArrayW<char16_t,::Array<char16_t>*>, "InvalidMethodChars", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::ValidationHelper*>::get>();
}
inline void System::Net::ValidationHelper::setStaticF_InvalidParamChars(::ArrayW<char16_t,::Array<char16_t>*>  value)  {
::cordl_internals::setStaticField<::ArrayW<char16_t,::Array<char16_t>*>, "InvalidParamChars", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::ValidationHelper*>::get>(std::forward<::ArrayW<char16_t,::Array<char16_t>*>>(value));
}
inline ::ArrayW<char16_t,::Array<char16_t>*> System::Net::ValidationHelper::getStaticF_InvalidParamChars()  {
return ::cordl_internals::getStaticField<::ArrayW<char16_t,::Array<char16_t>*>, "InvalidParamChars", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::ValidationHelper*>::get>();
}
