...
/// @brief Method .ctor, addr 0x44185e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Cleanup, addr 0x4418cc0, size 0x4, virtual true, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Complete, addr 0x4418a8c, size 0x188, virtual true, abstract: false, final false
inline void Complete(::System::IntPtr  userToken) ;

/// @brief Method InternalWaitForCompletion, addr 0x440695c, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* InternalWaitForCompletion() ;

/// @brief Method InvokeCallback, addr 0x4407dcc, size 0xc, virtual false, abstract: false, final false
inline void InvokeCallback() ;

/// @brief Method InvokeCallback, addr 0x4407db4, size 0x8, virtual false, abstract: false, final false
inline void InvokeCallback(::System::Object*  result) ;

/// @brief Method LazilyCreateEvent, addr 0x4418698, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method ProtectedInvokeCallback, addr 0x44188b8, size 0x1d4, virtual false, abstract: false, final false
inline void ProtectedInvokeCallback(::System::Object*  result, ::System::IntPtr  userToken) ;

/// @brief Method WaitForCompletion, addr 0x4418cc4, size 0x2a8, virtual false, abstract: false, final false
inline ::System::Object* WaitForCompletion(bool  snap) ;

/// @brief Method WorkerThreadComplete, addr 0x4418c14, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44068cc, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_AsyncCallback, addr 0x44185f8, size 0x8, virtual false, abstract: false, final false
inline ::System::AsyncCallback* get_AsyncCallback() ;

/// @brief Method get_AsyncObject, addr 0x44185e8, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* get_AsyncObject() ;

/// @brief Method get_AsyncState, addr 0x44185f0, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_AsyncState() ;

/// @brief Method get_AsyncWaitHandle, addr 0x4418600, size 0x98, virtual true, abstract: false, final true
inline ::System::Threading::WaitHandle* get_AsyncWaitHandle() ;

/// @brief Method get_CompletedSynchronously, addr 0x4418844, size 0x30, virtual true, abstract: false, final true
inline bool get_CompletedSynchronously() ;

/// @brief Method get_CurrentThreadContext, addr 0x4418554, size 0x8c, virtual false, abstract: false, final false
static inline ::System::Net::__LazyAsyncResult__ThreadContext* get_CurrentThreadContext() ;

/// @brief Method get_EndCalled, addr 0x44188a4, size 0x8, virtual false, abstract: false, final false
inline bool get_EndCalled() ;

/// @brief Method get_InternalPeekCompleted, addr 0x4407dbc, size 0x10, virtual false, abstract: false, final false
inline bool get_InternalPeekCompleted() ;

/// @brief Method get_IsCompleted, addr 0x4418874, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method set_EndCalled, addr 0x44188ac, size 0xc, virtual false, abstract: false, final false
