...
/// @brief Method Add, addr 0x441ed54, size 0x804, virtual false, abstract: false, final false
inline void Add(::System::Net::Cookie*  cookie, bool  throwOnError) ;

/// @brief Method AddRemoveDomain, addr 0x441ec30, size 0x124, virtual false, abstract: false, final false
inline void AddRemoveDomain(::StringW  key, ::System::Net::PathList*  value) ;

/// @brief Method AgeCookies, addr 0x441fb90, size 0x1538, virtual false, abstract: false, final false
inline bool AgeCookies(::StringW  domain) ;

/// @brief Method BuildCookieCollectionFromDomainMatches, addr 0x4422094, size 0x820, virtual false, abstract: false, final false
...
/// @brief Method CookieCutter, addr 0x4421528, size 0x6dc, virtual false, abstract: false, final false
inline ::System::Net::CookieCollection* CookieCutter(::System::Uri*  uri, ::StringW  headerName, ::StringW  setCookieHeader, bool  isThrow) ;

/// @brief Method ExpireCollection, addr 0x44210f4, size 0x170, virtual false, abstract: false, final false
inline int32_t ExpireCollection(::System::Net::CookieCollection*  cc) ;

/// @brief Method GetCookieHeader, addr 0x4422ae8, size 0xcc, virtual false, abstract: false, final false
inline ::StringW GetCookieHeader(::System::Uri*  uri) ;

/// @brief Method GetCookieHeader, addr 0x4422bb4, size 0x398, virtual false, abstract: false, final false
inline ::StringW GetCookieHeader(::System::Uri*  uri, ByRef<::StringW>  optCookie2) ;

/// @brief Method InternalGetCookies, addr 0x4421c04, size 0x490, virtual false, abstract: false, final false
inline ::System::Net::CookieCollection* InternalGetCookies(::System::Uri*  uri) ;

/// @brief Method IsLocalDomain, addr 0x4421288, size 0x2a0, virtual false, abstract: false, final false
inline bool IsLocalDomain(::StringW  host) ;

/// @brief Method MergeUpdateCollections, addr 0x44228d8, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x441eb38, size 0xf8, virtual false, abstract: false, final false
inline void _ctor() ;
