...
/// @brief Method AddHeader, addr 0x44348c8, size 0x8cc, virtual false, abstract: false, final false
inline void AddHeader(::StringW  header) ;

/// @brief Method CreateQueryString, addr 0x4437698, size 0x210, virtual false, abstract: false, final false
inline void CreateQueryString(::StringW  query) ;

/// @brief Method FinishInitialization, addr 0x44339f8, size 0x624, virtual false, abstract: false, final false
inline bool FinishInitialization() ;

/// @brief Method FlushInput, addr 0x44352f0, size 0x2c8, virtual false, abstract: false, final false
inline bool FlushInput() ;

/// @brief Method IsPredefinedScheme, addr 0x4437950, size 0x1f0, virtual false, abstract: false, final false
static inline bool IsPredefinedScheme(::StringW  scheme) ;

/// @brief Method MaybeUri, addr 0x44378a8, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method SetRequestLine, addr 0x4434590, size 0x338, virtual false, abstract: false, final false
inline void SetRequestLine(::StringW  req) ;

/// @brief Method Unquote, addr 0x4437bf8, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4436f30, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method get_HasEntityBody, addr 0x4437c64, size 0x24, virtual false, abstract: false, final false
inline bool get_HasEntityBody() ;

/// @brief Method get_Headers, addr 0x4437d2c, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Specialized::NameValueCollection* get_Headers() ;

/// @brief Method get_InputStream, addr 0x4437c88, size 0xa4, virtual false, abstract: false, final false
inline ::System::IO::Stream* get_InputStream() ;

/// @brief Method get_IsSecureConnection, addr 0x4437bb4, size 0x24, virtual false, abstract: false, final false
inline bool get_IsSecureConnection() ;

/// @brief Method get_KeepAlive, addr 0x4435194, size 0x15c, virtual false, abstract: false, final false
inline bool get_KeepAlive() ;

/// @brief Method get_LocalEndPoint, addr 0x4437bd8, size 0x20, virtual false, abstract: false, final false
inline ::System::Net::IPEndPoint* get_LocalEndPoint() ;

/// @brief Method get_ProtocolVersion, addr 0x4437d34, size 0x8, virtual false, abstract: false, final false
inline ::System::Version* get_ProtocolVersion() ;

/// @brief Method get_Url, addr 0x4437d3c, size 0x8, virtual false, abstract: false, final false
inline ::System::Uri* get_Url() ;

/// @brief Method get_UserHostAddress, addr 0x4437b94, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_UserHostAddress() ;

/// @brief Method get_UserHostName, addr 0x4437b40, size 0x54, virtual false, abstract: false, final false
