...
/// @brief Method .ctor, addr 0x441eb1c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::System::Net::CookieVariant  variant) ;

/// @brief Method get_Name, addr 0x441eb28, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Variant, addr 0x441eb30, size 0x8, virtual false, abstract: false, final false
