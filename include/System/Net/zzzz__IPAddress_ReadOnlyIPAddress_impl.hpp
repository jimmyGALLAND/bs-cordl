...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Net::__IPAddress__ReadOnlyIPAddress::*)(int64_t)>(&::System::Net::__IPAddress__ReadOnlyIPAddress::_ctor)> {
  constexpr static std::size_t size = 0x64;
  constexpr static std::size_t addrs = 0x43fc470;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::__IPAddress__ReadOnlyIPAddress*>::get(),
                        ".ctor",
