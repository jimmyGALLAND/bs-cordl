...
/// @brief Method .ctor, addr 0x435ce30, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Net::Configuration::SettingsSectionInternal* getStaticF_instance() ;

/// @brief Method get_Ipv6Enabled, addr 0x435ce28, size 0x8, virtual false, abstract: false, final false
inline bool get_Ipv6Enabled() ;

/// @brief Method get_Section, addr 0x435cdd0, size 0x58, virtual false, abstract: false, final false
