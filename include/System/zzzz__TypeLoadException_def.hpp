...
/// @brief Method GetObjectData, addr 0x3d9dfd8, size 0x1d0, virtual true, abstract: false, final false
...
/// @brief Method SetMessageField, addr 0x3d9dd2c, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3d9dc8c, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3d9de28, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  className, ::StringW  assemblyName) ;

/// @brief Method .ctor, addr 0x3d9de34, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::StringW  className, ::StringW  assemblyName, ::StringW  messageArg, int32_t  resourceId) ;

/// @brief Method .ctor, addr 0x3d9de94, size 0x144, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x3d9dcec, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method get_Message, addr 0x3d9dd14, size 0x18, virtual true, abstract: false, final false
