...
namespace System::Data {
template<typename K>
struct __RBTree_1__NodeColor;
}
namespace System::Data {
template<typename K>
struct __RBTree_1__NodePath;
}
namespace System::Data {
template<typename K>
struct __RBTree_1__Node;
}
namespace System::Data {
template<typename K>
...
// Ctor Parameters [CppParam { name: "_selfId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_leftId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_rightId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_parentId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_nextId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_subTreeSize", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_keyOfNode", ty: "K", modifiers: "", def_value: None }, CppParam { name: "_nodeColor", ty: "::System::Data::__RBTree_1__NodeColor<K>", modifiers: "", def_value: None }]
constexpr __RBTree_1__Node(int32_t  _selfId, int32_t  _leftId, int32_t  _rightId, int32_t  _parentId, int32_t  _nextId, int32_t  _subTreeSize, K  _keyOfNode, ::System::Data::__RBTree_1__NodeColor<K>  _nodeColor) noexcept;
...
/// @brief Field _pageTable, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__pageTable, put=__cordl_internal_set__pageTable)) ::ArrayW<::System::Data::__RBTree_1__TreePage<K>*,::Array<::System::Data::__RBTree_1__TreePage<K>*>*>  _pageTable;
