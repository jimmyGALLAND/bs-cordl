...
/// @brief Field _errorList, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__errorList, put=__cordl_internal_set__errorList)) ::ArrayW<::System::Data::__DataError__ColumnError,::Array<::System::Data::__DataError__ColumnError>*>  _errorList;
...
/// @brief Method Clear, addr 0x40ca988, size 0xa8, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Clear, addr 0x40ca700, size 0xac, virtual false, abstract: false, final false
inline void Clear(::System::Data::DataColumn*  column) ;

/// @brief Method GetColumnError, addr 0x40ca8ec, size 0x9c, virtual false, abstract: false, final false
inline ::StringW GetColumnError(::System::Data::DataColumn*  column) ;

/// @brief Method GetColumnsInError, addr 0x40caa30, size 0xe8, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> GetColumnsInError() ;

/// @brief Method IndexOf, addr 0x40ca7ac, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method SetColumnError, addr 0x40ca620, size 0xe0, virtual false, abstract: false, final false
inline void SetColumnError(::System::Data::DataColumn*  column, ::StringW  error) ;

/// @brief Method SetText, addr 0x40ca534, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x40ca440, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x40ca498, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(::StringW  rowError) ;

/// @brief Method get_HasErrors, addr 0x40ca5ec, size 0x34, virtual false, abstract: false, final false
inline bool get_HasErrors() ;

/// @brief Method get_Text, addr 0x40ca58c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Text() ;

/// @brief Method set_Text, addr 0x40ca594, size 0x58, virtual false, abstract: false, final false
