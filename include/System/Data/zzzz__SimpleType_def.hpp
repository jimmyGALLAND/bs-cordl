...
/// @brief Method CanHaveMaxLength, addr 0x40f8bac, size 0x64, virtual false, abstract: false, final false
inline bool CanHaveMaxLength() ;

/// @brief Method ConvertToAnnonymousSimpleType, addr 0x40f8c10, size 0x74, virtual false, abstract: false, final false
inline void ConvertToAnnonymousSimpleType() ;

/// @brief Method CreateByteArrayType, addr 0x40f88d4, size 0x68, virtual false, abstract: false, final false
static inline ::System::Data::SimpleType* CreateByteArrayType(::StringW  encoding) ;

/// @brief Method CreateEnumeratedType, addr 0x40f8854, size 0x80, virtual false, abstract: false, final false
static inline ::System::Data::SimpleType* CreateEnumeratedType(::StringW  values) ;

/// @brief Method CreateLimitedStringType, addr 0x40f893c, size 0x80, virtual false, abstract: false, final false
static inline ::System::Data::SimpleType* CreateLimitedStringType(int32_t  length) ;

/// @brief Method CreateSimpleType, addr 0x40f89bc, size 0xf0, virtual false, abstract: false, final false
static inline ::System::Data::SimpleType* CreateSimpleType(::System::Data::Common::StorageType  typeCode, ::System::Type*  type) ;

/// @brief Method HasConflictingDefinition, addr 0x40f8aac, size 0x100, virtual false, abstract: false, final false
inline ::StringW HasConflictingDefinition(::System::Data::SimpleType*  otherSimpleType) ;

/// @brief Method IsPlainString, addr 0x40f8184, size 0x138, virtual false, abstract: false, final false
inline bool IsPlainString() ;

/// @brief Method LoadTypeValues, addr 0x40f78bc, size 0x890, virtual false, abstract: false, final false
...
/// @brief Method QualifiedName, addr 0x40f836c, size 0x7c, virtual false, abstract: false, final false
inline ::StringW QualifiedName(::StringW  name) ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x40f814c, size 0x38, virtual true, abstract: false, final true
inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method ToNode, addr 0x40f83e8, size 0x46c, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Data::SimpleType*> const& __cordl_internal_get__baseSimpleType() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::XmlQualifiedName*> const& __cordl_internal_get__xmlBaseType() const;
...
/// @brief Method .ctor, addr 0x40f7710, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::StringW  baseType) ;

/// @brief Method .ctor, addr 0x40f779c, size 0x120, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::XmlSchemaSimpleType*  node) ;

/// @brief Method get_BaseSimpleType, addr 0x40f82f4, size 0x8, virtual false, abstract: false, final false
inline ::System::Data::SimpleType* get_BaseSimpleType() ;

/// @brief Method get_BaseType, addr 0x40f82bc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_BaseType() ;

/// @brief Method get_Length, addr 0x40f82dc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Length() ;

/// @brief Method get_MaxLength, addr 0x40f82e4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxLength() ;

/// @brief Method get_Name, addr 0x40f82cc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Namespace, addr 0x40f82d4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method get_SimpleTypeQualifiedName, addr 0x40f82fc, size 0x70, virtual false, abstract: false, final false
inline ::StringW get_SimpleTypeQualifiedName() ;

/// @brief Method get_XmlBaseType, addr 0x40f82c4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_XmlBaseType() ;

/// @brief Convert to "::System::Runtime::Serialization::ISerializable"
constexpr ::System::Runtime::Serialization::ISerializable* i___System__Runtime__Serialization__ISerializable() noexcept;

/// @brief Method set_MaxLength, addr 0x40f82ec, size 0x8, virtual false, abstract: false, final false
