...
/// @brief Method Argument, addr 0x4148924, size 0x90, virtual false, abstract: false, final false
static inline ::System::ArgumentException* Argument(::StringW  error) ;

/// @brief Method ArgumentOutOfRange, addr 0x4148a44, size 0x98, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* ArgumentOutOfRange(::StringW  message, ::StringW  parameterName) ;

/// @brief Method ArgumentOutOfRange, addr 0x41489b4, size 0x90, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* ArgumentOutOfRange(::StringW  parameterName) ;

/// @brief Method InvalidAcceptRejectRule, addr 0x4149154, size 0xb0, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* InvalidAcceptRejectRule(::System::Data::AcceptRejectRule  value) ;

/// @brief Method InvalidEnumerationValue, addr 0x4148fdc, size 0x10c, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* InvalidEnumerationValue(::System::Type*  type, int32_t  value) ;

/// @brief Method InvalidMissingSchemaAction, addr 0x4149204, size 0xb0, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* InvalidMissingSchemaAction(::System::Data::MissingSchemaAction  value) ;

/// @brief Method InvalidOperation, addr 0x4148adc, size 0x90, virtual false, abstract: false, final false
static inline ::System::InvalidOperationException* InvalidOperation(::StringW  error) ;

/// @brief Method InvalidRule, addr 0x41492b4, size 0xb0, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* InvalidRule(::System::Data::Rule  value) ;

/// @brief Method InvalidSeekOrigin, addr 0x41490e8, size 0x6c, virtual false, abstract: false, final false
static inline ::System::Exception* InvalidSeekOrigin(::StringW  parameterName) ;

/// @brief Method IsCatchableExceptionType, addr 0x4148bfc, size 0x20c, virtual false, abstract: false, final false
static inline bool IsCatchableExceptionType(::System::Exception*  e) ;

/// @brief Method IsCatchableOrSecurityExceptionType, addr 0x4148e08, size 0x1d4, virtual false, abstract: false, final false
static inline bool IsCatchableOrSecurityExceptionType(::System::Exception*  e) ;

/// @brief Method NotSupported, addr 0x4148b6c, size 0x90, virtual false, abstract: false, final false
static inline ::System::NotSupportedException* NotSupported(::StringW  error) ;

/// @brief Method TraceException, addr 0x41487b4, size 0x98, virtual false, abstract: false, final false
static inline void TraceException(::StringW  trace, ::System::Exception*  e) ;

/// @brief Method TraceExceptionAsReturnValue, addr 0x414884c, size 0x6c, virtual false, abstract: false, final false
static inline void TraceExceptionAsReturnValue(::System::Exception*  e) ;

/// @brief Method TraceExceptionWithoutRethrow, addr 0x41488b8, size 0x6c, virtual false, abstract: false, final false
static inline void TraceExceptionWithoutRethrow(::System::Exception*  e) ;

/// @brief Method WrongType, addr 0x4149364, size 0xc4, virtual false, abstract: false, final false
