...
/// @brief Field _delayedAddRangeTables, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__delayedAddRangeTables, put=__cordl_internal_set__delayedAddRangeTables)) ::ArrayW<::System::Data::DataTable*,::Array<::System::Data::DataTable*>*>  _delayedAddRangeTables;
...
/// @brief Method Add, addr 0x40d6528, size 0x29c, virtual false, abstract: false, final false
inline void Add(::System::Data::DataTable*  table) ;

/// @brief Method ArrayAdd, addr 0x40d69a8, size 0x24, virtual false, abstract: false, final false
inline void ArrayAdd(::System::Data::DataTable*  table) ;

/// @brief Method AssignName, addr 0x40d6a9c, size 0x48, virtual false, abstract: false, final false
inline ::StringW AssignName() ;

/// @brief Method BaseAdd, addr 0x40d6894, size 0x114, virtual false, abstract: false, final false
inline void BaseAdd(::System::Data::DataTable*  table) ;

/// @brief Method BaseGroupSwitch, addr 0x40d6e14, size 0x178, virtual false, abstract: false, final false
inline void BaseGroupSwitch(::ArrayW<::System::Data::DataTable*,::Array<::System::Data::DataTable*>*>  oldArray, int32_t  oldLength, ::ArrayW<::System::Data::DataTable*,::Array<::System::Data::DataTable*>*>  newArray, int32_t  newLength) ;

/// @brief Method BaseRemove, addr 0x40d6f8c, size 0x78, virtual false, abstract: false, final false
inline void BaseRemove(::System::Data::DataTable*  table) ;

/// @brief Method CanRemove, addr 0x40d7004, size 0x464, virtual false, abstract: false, final false
inline bool CanRemove(::System::Data::DataTable*  table, bool  fThrowException) ;

/// @brief Method Clear, addr 0x40d7574, size 0x2c8, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x40d6b9c, size 0x18, virtual false, abstract: false, final false
inline bool Contains(::StringW  name) ;

/// @brief Method Contains, addr 0x40d79b0, size 0x128, virtual false, abstract: false, final false
inline bool Contains(::StringW  name, bool  caseSensitive) ;

/// @brief Method Contains, addr 0x40d783c, size 0x174, virtual false, abstract: false, final false
inline bool Contains(::StringW  name, ::StringW  tableNamespace, bool  checkProperty, bool  caseSensitive) ;

/// @brief Method GetTable, addr 0x40d62d0, size 0x11c, virtual false, abstract: false, final false
inline ::System::Data::DataTable* GetTable(::StringW  name, ::StringW  ns) ;

/// @brief Method GetTableSmart, addr 0x40d63ec, size 0x13c, virtual false, abstract: false, final false
inline ::System::Data::DataTable* GetTableSmart(::StringW  name, ::StringW  ns) ;

/// @brief Method IndexOf, addr 0x40d7ad8, size 0xe4, virtual false, abstract: false, final false
inline int32_t IndexOf(::System::Data::DataTable*  table) ;

/// @brief Method IndexOf, addr 0x40d7bbc, size 0x18, virtual false, abstract: false, final false
inline int32_t IndexOf(::StringW  tableName) ;

/// @brief Method IndexOf, addr 0x40d7bd4, size 0x60, virtual false, abstract: false, final false
inline int32_t IndexOf(::StringW  tableName, ::StringW  tableNamespace, bool  chekforNull) ;

/// @brief Method InternalIndexOf, addr 0x40d5f7c, size 0x1c8, virtual false, abstract: false, final false
inline int32_t InternalIndexOf(::StringW  tableName) ;

/// @brief Method InternalIndexOf, addr 0x40d6144, size 0x18c, virtual false, abstract: false, final false
inline int32_t InternalIndexOf(::StringW  tableName, ::StringW  tableNamespace) ;

/// @brief Method MakeName, addr 0x40d6ae4, size 0xb8, virtual false, abstract: false, final false
inline ::StringW MakeName(int32_t  index) ;

static inline ::System::Data::DataTableCollection* New_ctor(::System::Data::DataSet*  dataSet) ;

/// @brief Method OnCollectionChanged, addr 0x40d69cc, size 0xd0, virtual false, abstract: false, final false
inline void OnCollectionChanged(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method OnCollectionChanging, addr 0x40d67c4, size 0xd0, virtual false, abstract: false, final false
inline void OnCollectionChanging(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method RegisterName, addr 0x40d6bb4, size 0x260, virtual false, abstract: false, final false
inline void RegisterName(::StringW  name, ::StringW  tbNamespace) ;

/// @brief Method Remove, addr 0x40d7c84, size 0x1fc, virtual false, abstract: false, final false
inline void Remove(::System::Data::DataTable*  table) ;

/// @brief Method ReplaceFromInference, addr 0x40d7c34, size 0x50, virtual false, abstract: false, final false
inline void ReplaceFromInference(::System::Collections::Generic::List_1<::System::Data::DataTable*>*  tableList) ;

/// @brief Method UnregisterName, addr 0x40d7468, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x40d5bf8, size 0x150, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataSet*  dataSet) ;

static inline int32_t getStaticF_s_objectTypeCount() ;

/// @brief Method get_Item, addr 0x40d5d58, size 0x130, virtual false, abstract: false, final false
inline ::System::Data::DataTable* get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x40d5e88, size 0xf4, virtual false, abstract: false, final false
inline ::System::Data::DataTable* get_Item(::StringW  name) ;

/// @brief Method get_Item, addr 0x40ce9b4, size 0x108, virtual false, abstract: false, final false
inline ::System::Data::DataTable* get_Item(::StringW  name, ::StringW  tableNamespace) ;

/// @brief Method get_List, addr 0x40d5d48, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* get_List() ;

/// @brief Method get_ObjectID, addr 0x40d5d50, size 0x8, virtual false, abstract: false, final false
