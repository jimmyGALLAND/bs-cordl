...
/// @brief Method Clear, addr 0x40f2f3c, size 0x1ec, virtual false, abstract: false, final false
inline void Clear(bool  clearAll) ;

/// @brief Method CopyRecord, addr 0x40f3160, size 0x314, virtual false, abstract: false, final false
inline int32_t CopyRecord(::System::Data::DataTable*  src, int32_t  record, int32_t  copy) ;

/// @brief Method FreeRecord, addr 0x40f2d88, size 0x150, virtual false, abstract: false, final false
inline void FreeRecord(ByRef<int32_t>  record) ;

/// @brief Method GrowRecordCapacity, addr 0x40f2a80, size 0x104, virtual false, abstract: false, final false
inline void GrowRecordCapacity() ;

/// @brief Method ImportRecord, addr 0x40f3158, size 0x8, virtual false, abstract: false, final false
inline int32_t ImportRecord(::System::Data::DataTable*  src, int32_t  record) ;

/// @brief Method NewCapacity, addr 0x40f2b84, size 0x14, virtual false, abstract: false, final false
static inline int32_t NewCapacity(int32_t  capacity) ;

/// @brief Method NewRecordBase, addr 0x40f2cbc, size 0xcc, virtual false, abstract: false, final false
inline int32_t NewRecordBase() ;

static inline ::System::Data::RecordManager* New_ctor(::System::Data::DataTable*  table) ;

/// @brief Method NormalizedMinimumCapacity, addr 0x40f2b98, size 0x38, virtual false, abstract: false, final false
inline int32_t NormalizedMinimumCapacity(int32_t  capacity) ;

/// @brief Method SetRowCache, addr 0x40f3474, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x40f29bc, size 0xc4, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table) ;

/// @brief Method get_Item, addr 0x40f3128, size 0x30, virtual false, abstract: false, final false
inline ::System::Data::DataRow* get_Item(int32_t  record) ;

/// @brief Method get_LastFreeRecord, addr 0x40f2c60, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LastFreeRecord() ;

/// @brief Method get_MinimumCapacity, addr 0x40f2c68, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MinimumCapacity() ;

/// @brief Method get_RecordCapacity, addr 0x40f2cb4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_RecordCapacity() ;

/// @brief Method set_Item, addr 0x40f2ed8, size 0x64, virtual false, abstract: false, final false
inline void set_Item(int32_t  record, ::System::Data::DataRow*  value) ;

/// @brief Method set_MinimumCapacity, addr 0x40f2c70, size 0x44, virtual false, abstract: false, final false
inline void set_MinimumCapacity(int32_t  value) ;

/// @brief Method set_RecordCapacity, addr 0x40f2bd0, size 0x90, virtual false, abstract: false, final false
