...
/// @brief Method CopyStreamToBuffer, addr 0x412fc0c, size 0x13c, virtual false, abstract: false, final false
inline void CopyStreamToBuffer() ;

/// @brief Method FStream, addr 0x412fbfc, size 0x10, virtual false, abstract: false, final false
inline bool FStream() ;

/// @brief Method GetXsdType, addr 0x41301d4, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method SetBuffer, addr 0x412ff88, size 0x28, virtual false, abstract: false, final false
inline void SetBuffer(::ArrayW<char16_t,::Array<char16_t>*>  buffer) ;

/// @brief Method SetNull, addr 0x412fa2c, size 0x10, virtual false, abstract: false, final false
inline void SetNull() ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x4130260, size 0x38, virtual true, abstract: false, final true
inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method System.Xml.Serialization.IXmlSerializable.GetSchema, addr 0x412ffb0, size 0x8, virtual true, abstract: false, final true
inline ::System::Xml::Schema::XmlSchema* System_Xml_Serialization_IXmlSerializable_GetSchema() ;

/// @brief Method System.Xml.Serialization.IXmlSerializable.ReadXml, addr 0x412ffb8, size 0x11c, virtual true, abstract: false, final true
inline void System_Xml_Serialization_IXmlSerializable_ReadXml(::System::Xml::XmlReader*  r) ;

/// @brief Method System.Xml.Serialization.IXmlSerializable.WriteXml, addr 0x41300d4, size 0x100, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x412fa08, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x412fa3c, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<char16_t,::Array<char16_t>*>  buffer) ;

/// @brief Method .ctor, addr 0x412fa8c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(::System::Data::SqlTypes::SqlString  value) ;

/// @brief Method get_Buffer, addr 0x412fbd4, size 0x28, virtual false, abstract: false, final false
inline ::ArrayW<char16_t,::Array<char16_t>*> get_Buffer() ;

/// @brief Method get_IsNull, addr 0x412fbc4, size 0x10, virtual true, abstract: false, final true
inline bool get_IsNull() ;

/// @brief Method get_Length, addr 0x412fd48, size 0x6c, virtual false, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Null, addr 0x4130298, size 0x68, virtual false, abstract: false, final false
static inline ::System::Data::SqlTypes::SqlChars* get_Null() ;

/// @brief Method get_Value, addr 0x412fdb4, size 0x1d4, virtual false, abstract: false, final false
