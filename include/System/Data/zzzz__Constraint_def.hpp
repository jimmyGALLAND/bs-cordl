...
/// @brief Method CheckConstraint, addr 0x40c4588, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method CheckStateForProperty, addr 0x40c45dc, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x40c46dc, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x40c46e8, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ConstraintName, addr 0x40c402c, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_ConstraintName() ;

/// @brief Method get_ExtendedProperties, addr 0x40c4524, size 0x64, virtual false, abstract: false, final false
inline ::System::Data::PropertyCollection* get_ExtendedProperties() ;

/// @brief Method get_InCollection, addr 0x40c44d8, size 0x8, virtual true, abstract: false, final false
inline bool get_InCollection() ;

/// @brief Method get_SchemaName, addr 0x40c4470, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method get__DataSet, addr 0x40c46d4, size 0x8, virtual true, abstract: false, final false
inline ::System::Data::DataSet* get__DataSet() ;

/// @brief Method set_ConstraintName, addr 0x40c4034, size 0x1d4, virtual true, abstract: false, final false
inline void set_ConstraintName(::StringW  value) ;

/// @brief Method set_InCollection, addr 0x40c44e0, size 0x44, virtual true, abstract: false, final false
inline void set_InCollection(bool  value) ;

/// @brief Method set_SchemaName, addr 0x40c44a8, size 0x30, virtual false, abstract: false, final false
