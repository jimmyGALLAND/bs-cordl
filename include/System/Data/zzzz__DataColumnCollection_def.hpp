...
/// @brief Field _columnsImplementingIChangeTracking, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__columnsImplementingIChangeTracking, put=__cordl_internal_set__columnsImplementingIChangeTracking)) ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*>  _columnsImplementingIChangeTracking;
...
/// @brief Field _delayedAddRangeColumns, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__delayedAddRangeColumns, put=__cordl_internal_set__delayedAddRangeColumns)) ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*>  _delayedAddRangeColumns;
...
/// @brief Method Add, addr 0x40c7bf4, size 0xc, virtual false, abstract: false, final false
inline void Add(::System::Data::DataColumn*  column) ;

/// @brief Method AddAt, addr 0x40c7c00, size 0x25c, virtual false, abstract: false, final false
inline void AddAt(int32_t  index, ::System::Data::DataColumn*  column) ;

/// @brief Method AddColumnsImplementingIChangeTrackingList, addr 0x40c9570, size 0xcc, virtual false, abstract: false, final false
inline void AddColumnsImplementingIChangeTrackingList(::System::Data::DataColumn*  dataColumn) ;

/// @brief Method ArrayAdd, addr 0x40c819c, size 0x6c, virtual false, abstract: false, final false
inline void ArrayAdd(::System::Data::DataColumn*  column) ;

/// @brief Method ArrayAdd, addr 0x40c815c, size 0x40, virtual false, abstract: false, final false
inline void ArrayAdd(int32_t  index, ::System::Data::DataColumn*  column) ;

/// @brief Method ArrayRemove, addr 0x40c8564, size 0x130, virtual false, abstract: false, final false
inline void ArrayRemove(::System::Data::DataColumn*  column) ;

/// @brief Method AssignName, addr 0x40c8798, size 0x94, virtual false, abstract: false, final false
inline ::StringW AssignName() ;

/// @brief Method BaseAdd, addr 0x40c7e84, size 0x2d8, virtual false, abstract: false, final false
inline void BaseAdd(::System::Data::DataColumn*  column) ;

/// @brief Method BaseGroupSwitch, addr 0x40c8b60, size 0x1e0, virtual false, abstract: false, final false
inline void BaseGroupSwitch(::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*>  oldArray, int32_t  oldLength, ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*>  newArray, int32_t  newLength) ;

/// @brief Method BaseRemove, addr 0x40c8d40, size 0xb8, virtual false, abstract: false, final false
inline void BaseRemove(::System::Data::DataColumn*  column) ;

/// @brief Method CanRegisterName, addr 0x40c9b98, size 0x64, virtual false, abstract: false, final false
inline bool CanRegisterName(::StringW  name) ;

/// @brief Method CanRemove, addr 0x40c8df8, size 0x668, virtual false, abstract: false, final false
inline bool CanRemove(::System::Data::DataColumn*  column, bool  fThrowException) ;

/// @brief Method CheckIChangeTracking, addr 0x40c851c, size 0x48, virtual false, abstract: false, final false
inline void CheckIChangeTracking(::System::Data::DataColumn*  column) ;

/// @brief Method Clear, addr 0x40c963c, size 0x2d4, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x40c9910, size 0x94, virtual false, abstract: false, final false
inline bool Contains(::StringW  name) ;

/// @brief Method Contains, addr 0x40c99a4, size 0x9c, virtual false, abstract: false, final false
inline bool Contains(::StringW  name, bool  caseSensitive) ;

/// @brief Method IndexOf, addr 0x40c9a40, size 0x100, virtual false, abstract: false, final false
inline int32_t IndexOf(::StringW  columnName) ;

/// @brief Method IndexOfCaseInsensitive, addr 0x40c7a00, size 0x150, virtual false, abstract: false, final false
inline int32_t IndexOfCaseInsensitive(::StringW  name) ;

/// @brief Method MakeName, addr 0x40c882c, size 0xb8, virtual false, abstract: false, final false
inline ::StringW MakeName(int32_t  index) ;

static inline ::System::Data::DataColumnCollection* New_ctor(::System::Data::DataTable*  table) ;

/// @brief Method OnCollectionChanged, addr 0x40c8208, size 0xa4, virtual false, abstract: false, final false
inline void OnCollectionChanged(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method OnCollectionChanging, addr 0x40c7e5c, size 0x28, virtual false, abstract: false, final false
inline void OnCollectionChanging(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method OnColumnPropertyChanged, addr 0x40c9b40, size 0x58, virtual false, abstract: false, final false
inline void OnColumnPropertyChanged(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method RegisterColumnName, addr 0x40c88e4, size 0x1c0, virtual false, abstract: false, final false
inline void RegisterColumnName(::StringW  name, ::System::Data::DataColumn*  column) ;

/// @brief Method Remove, addr 0x40c9bfc, size 0x10c, virtual false, abstract: false, final false
inline void Remove(::System::Data::DataColumn*  column) ;

/// @brief Method RemoveColumnsImplementingIChangeTrackingList, addr 0x40c8694, size 0x104, virtual false, abstract: false, final false
inline void RemoveColumnsImplementingIChangeTrackingList(::System::Data::DataColumn*  dataColumn) ;

/// @brief Method UnregisterName, addr 0x40c8aa4, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x40c7620, size 0x148, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table) ;

/// @brief Method add_CollectionChanged, addr 0x40c82ac, size 0x9c, virtual false, abstract: false, final false
inline void add_CollectionChanged(::System::ComponentModel::CollectionChangeEventHandler*  value) ;

/// @brief Method add_ColumnPropertyChanged, addr 0x40c83e4, size 0x9c, virtual false, abstract: false, final false
inline void add_ColumnPropertyChanged(::System::ComponentModel::CollectionChangeEventHandler*  value) ;

/// @brief Method get_ColumnsImplementingIChangeTracking, addr 0x40c7770, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_ColumnsImplementingIChangeTracking() ;

/// @brief Method get_ColumnsImplementingIChangeTrackingCount, addr 0x40c7778, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ColumnsImplementingIChangeTrackingCount() ;

/// @brief Method get_ColumnsImplementingIRevertibleChangeTrackingCount, addr 0x40c7780, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ColumnsImplementingIRevertibleChangeTrackingCount() ;

/// @brief Method get_Item, addr 0x40c7788, size 0x130, virtual false, abstract: false, final false
inline ::System::Data::DataColumn* get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x40c78b8, size 0x148, virtual false, abstract: false, final false
inline ::System::Data::DataColumn* get_Item(::StringW  name) ;

/// @brief Method get_Item, addr 0x40c7b50, size 0xa4, virtual false, abstract: false, final false
inline ::System::Data::DataColumn* get_Item(::StringW  name, ::StringW  ns) ;

/// @brief Method get_List, addr 0x40c7768, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* get_List() ;

/// @brief Method remove_CollectionChanged, addr 0x40c8348, size 0x9c, virtual false, abstract: false, final false
inline void remove_CollectionChanged(::System::ComponentModel::CollectionChangeEventHandler*  value) ;

/// @brief Method remove_ColumnPropertyChanged, addr 0x40c8480, size 0x9c, virtual false, abstract: false, final false
