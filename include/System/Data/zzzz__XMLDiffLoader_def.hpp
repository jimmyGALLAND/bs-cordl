...
/// @brief Method CreateTablesHierarchy, addr 0x40fe224, size 0x384, virtual false, abstract: false, final false
inline void CreateTablesHierarchy(::System::Data::DataTable*  dt) ;

/// @brief Method GetTable, addr 0x40ffe44, size 0x1d4, virtual false, abstract: false, final false
inline ::System::Data::DataTable* GetTable(::StringW  tableName, ::StringW  ns) ;

/// @brief Method LoadDiffGram, addr 0x40fda08, size 0x1a4, virtual false, abstract: false, final false
inline void LoadDiffGram(::System::Data::DataSet*  ds, ::System::Xml::XmlReader*  dataTextReader) ;

/// @brief Method LoadDiffGram, addr 0x40fe5a8, size 0x1f8, virtual false, abstract: false, final false
...
/// @brief Method ProcessDiffs, addr 0x40fdbac, size 0x2d8, virtual false, abstract: false, final false
inline void ProcessDiffs(::System::Data::DataSet*  ds, ::System::Xml::XmlReader*  ssync) ;

/// @brief Method ProcessDiffs, addr 0x40fe7a0, size 0x2cc, virtual false, abstract: false, final false
inline void ProcessDiffs(::System::Collections::ArrayList*  tableList, ::System::Xml::XmlReader*  ssync) ;

/// @brief Method ProcessErrors, addr 0x40fde84, size 0x3a0, virtual false, abstract: false, final false
inline void ProcessErrors(::System::Data::DataSet*  ds, ::System::Xml::XmlReader*  ssync) ;

/// @brief Method ProcessErrors, addr 0x40fea6c, size 0x4b0, virtual false, abstract: false, final false
inline void ProcessErrors(::System::Collections::ArrayList*  dt, ::System::Xml::XmlReader*  ssync) ;

/// @brief Method ReadOldRowData, addr 0x40fef7c, size 0xec8, virtual false, abstract: false, final false
...
/// @brief Method SkipWhitespaces, addr 0x40fef1c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4100018, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
