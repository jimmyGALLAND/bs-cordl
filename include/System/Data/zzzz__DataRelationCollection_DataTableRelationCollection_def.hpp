...
/// @brief Method AddCache, addr 0x40d06a4, size 0x48, virtual false, abstract: false, final false
inline void AddCache(::System::Data::DataRelation*  relation) ;

/// @brief Method AddCore, addr 0x40d06ec, size 0xc0, virtual true, abstract: false, final false
inline void AddCore(::System::Data::DataRelation*  relation) ;

/// @brief Method EnsureDataSet, addr 0x40d0318, size 0x44, virtual false, abstract: false, final false
inline void EnsureDataSet() ;

/// @brief Method GetDataSet, addr 0x40d035c, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method RemoveCache, addr 0x40d07ac, size 0xd4, virtual false, abstract: false, final false
inline void RemoveCache(::System::Data::DataRelation*  relation) ;

/// @brief Method RemoveCore, addr 0x40d0880, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x40d026c, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table, bool  fParentCollection) ;

/// @brief Method add_RelationPropertyChanged, addr 0x40d056c, size 0x9c, virtual false, abstract: false, final false
inline void add_RelationPropertyChanged(::System::ComponentModel::CollectionChangeEventHandler*  value) ;

/// @brief Method get_Item, addr 0x40d0380, size 0x100, virtual true, abstract: false, final false
inline ::System::Data::DataRelation* get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x40d0480, size 0xec, virtual true, abstract: false, final false
inline ::System::Data::DataRelation* get_Item(::StringW  name) ;

/// @brief Method get_List, addr 0x40d0310, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* get_List() ;

/// @brief Method remove_RelationPropertyChanged, addr 0x40d0608, size 0x9c, virtual false, abstract: false, final false
