...
/// @brief Field _delayLoadingRelations, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__delayLoadingRelations, put=__cordl_internal_set__delayLoadingRelations)) ::ArrayW<::System::Data::DataRelation*,::Array<::System::Data::DataRelation*>*>  _delayLoadingRelations;
...
/// @brief Method AddCore, addr 0x40d0c00, size 0x534, virtual true, abstract: false, final false
inline void AddCore(::System::Data::DataRelation*  relation) ;

/// @brief Method Clear, addr 0x40d09d8, size 0x34, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method GetDataSet, addr 0x40d0a0c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method RemoveCore, addr 0x40d1134, size 0x230, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x40d0940, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataSet*  dataSet) ;

/// @brief Method get_Item, addr 0x40d0a14, size 0x100, virtual true, abstract: false, final false
inline ::System::Data::DataRelation* get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x40d0b14, size 0xec, virtual true, abstract: false, final false
inline ::System::Data::DataRelation* get_Item(::StringW  name) ;

/// @brief Method get_List, addr 0x40d09d0, size 0x8, virtual true, abstract: false, final false
