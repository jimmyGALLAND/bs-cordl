...
/// @brief Method .ctor, addr 0x3db1e38, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  intValue, ::StringW  stringValue) ;

/// @brief Method .ctor, addr 0x3db1e2c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  value) ;

/// @brief Method get_Int32, addr 0x3db1e44, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Int32() ;

/// @brief Method get_Object, addr 0x3db173c, size 0x5c, virtual false, abstract: false, final false
inline ::System::Object* get_Object() ;

/// @brief Method get_String, addr 0x3db16e8, size 0x54, virtual false, abstract: false, final false
inline ::StringW get_String() ;

/// @brief Method op_Implicit, addr 0x3dae9c0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field _arr, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__arr, put=__cordl_internal_set__arr)) ::ArrayW<::System::__ParameterizedStrings__FormatParam,::Array<::System::__ParameterizedStrings__FormatParam>*>  _arr;

/// @brief Field _count, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__count, put=__cordl_internal_set__count)) int32_t  _count;

/// @brief Method Clear, addr 0x3db0dd0, size 0x28, virtual false, abstract: false, final false
inline void Clear() ;

static inline ::System::__ParameterizedStrings__LowLevelStack* New_ctor() ;

/// @brief Method Pop, addr 0x3db1658, size 0x90, virtual false, abstract: false, final false
inline ::System::__ParameterizedStrings__FormatParam Pop() ;

/// @brief Method Push, addr 0x3db19b8, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3db0d80, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AsBool, addr 0x3db1ba4, size 0xc, virtual false, abstract: false, final false
static inline bool AsBool(int32_t  i) ;

/// @brief Method AsInt, addr 0x3db1b9c, size 0x8, virtual false, abstract: false, final false
static inline int32_t AsInt(bool  b) ;

/// @brief Method Evaluate, addr 0x3dae9cc, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method EvaluateInternal, addr 0x3db0df8, size 0x860, virtual false, abstract: false, final false
...
/// @brief Method FormatPrintF, addr 0x3db1798, size 0x220, virtual false, abstract: false, final false
static inline ::StringW FormatPrintF(::StringW  format, ::System::Object*  arg) ;

/// @brief Method GetDynamicOrStaticVariables, addr 0x3db1a90, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method StringFromAsciiBytes, addr 0x3db1bb0, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method snprintf, addr 0x3db1ca8, size 0xcc, virtual false, abstract: false, final false
static inline int32_t snprintf(::cordl_internals::Ptr<uint8_t>  str, ::System::IntPtr  size, ::StringW  format, ::StringW  arg1) ;

/// @brief Method snprintf, addr 0x3db1d74, size 0xb8, virtual false, abstract: false, final false
