...
/// @brief Method .ctor, addr 0x3d699b4, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3d699d4, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method .ctor, addr 0x3d69a00, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, bool  error) ;

/// @brief Method get_IsError, addr 0x3d69a38, size 0x8, virtual false, abstract: false, final false
inline bool get_IsError() ;

/// @brief Method get_Message, addr 0x3d69a30, size 0x8, virtual false, abstract: false, final false
