...
public:
// Declarations
/// @brief Method IsValid, addr 0x437d6dc, size 0x2d0, virtual false, abstract: false, final false
...
/// @brief Method ParseCanonicalName, addr 0x437d6d8, size 0x4, virtual false, abstract: false, final false
