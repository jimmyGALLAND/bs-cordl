...
/// @brief Method .ctor, addr 0x43c9f40, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  typeName) ;

/// @brief Method get_TypeName, addr 0x43c9fb4, size 0x8, virtual false, abstract: false, final false
