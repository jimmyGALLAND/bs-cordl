...
/// @brief Method FillAttributes, addr 0x43c7e5c, size 0x68, virtual true, abstract: false, final false
inline void FillAttributes(::System::Collections::IList*  attributes) ;

/// @brief Method FillEventInfoAttribute, addr 0x43c8304, size 0x32c, virtual false, abstract: false, final false
inline void FillEventInfoAttribute(::System::Reflection::EventInfo*  realEventInfo, ::System::Collections::IList*  attributes) ;

/// @brief Method FillMethods, addr 0x43c7ec4, size 0x440, virtual false, abstract: false, final false
inline void FillMethods() ;

/// @brief Method FillSingleMethodAttribute, addr 0x43c8630, size 0x36c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43c7ce8, size 0x174, virtual false, abstract: false, final false
