...
/// @brief Method .ctor, addr 0x43b5e90, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_NewObject, addr 0x43b5ee8, size 0x8, virtual false, abstract: false, final false
