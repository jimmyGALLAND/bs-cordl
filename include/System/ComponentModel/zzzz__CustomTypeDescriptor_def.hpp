...
/// @brief Method GetAttributes, addr 0x43bde18, size 0xd8, virtual true, abstract: false, final false
inline ::System::ComponentModel::AttributeCollection* GetAttributes() ;

/// @brief Method GetClassName, addr 0x43bdef0, size 0xb0, virtual true, abstract: false, final false
inline ::StringW GetClassName() ;

/// @brief Method GetComponentName, addr 0x43bdfa0, size 0xb0, virtual true, abstract: false, final false
inline ::StringW GetComponentName() ;

/// @brief Method GetConverter, addr 0x43be050, size 0xd8, virtual true, abstract: false, final false
inline ::System::ComponentModel::TypeConverter* GetConverter() ;

/// @brief Method GetDefaultEvent, addr 0x43be128, size 0xb0, virtual true, abstract: false, final false
inline ::System::ComponentModel::EventDescriptor* GetDefaultEvent() ;

/// @brief Method GetDefaultProperty, addr 0x43be1d8, size 0xb0, virtual true, abstract: false, final false
inline ::System::ComponentModel::PropertyDescriptor* GetDefaultProperty() ;

/// @brief Method GetEditor, addr 0x43be288, size 0xb8, virtual true, abstract: false, final false
inline ::System::Object* GetEditor(::System::Type*  editorBaseType) ;

/// @brief Method GetEvents, addr 0x43be340, size 0xdc, virtual true, abstract: false, final false
inline ::System::ComponentModel::EventDescriptorCollection* GetEvents() ;

/// @brief Method GetEvents, addr 0x43be41c, size 0xe4, virtual true, abstract: false, final false
...
/// @brief Method GetProperties, addr 0x43be500, size 0xdc, virtual true, abstract: false, final false
inline ::System::ComponentModel::PropertyDescriptorCollection* GetProperties() ;

/// @brief Method GetProperties, addr 0x43be5dc, size 0xe4, virtual true, abstract: false, final false
...
/// @brief Method GetPropertyOwner, addr 0x43be6c0, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43bde10, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
