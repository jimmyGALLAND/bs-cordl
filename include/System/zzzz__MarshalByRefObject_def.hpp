...
/// @brief Method CreateObjRef, addr 0x3da60fc, size 0x38, virtual true, abstract: false, final false
inline ::System::Runtime::Remoting::ObjRef* CreateObjRef(::System::Type*  requestedType) ;

/// @brief Method InitializeLifetimeService, addr 0x3da6134, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3d9f7e4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ObjectIdentity, addr 0x3da608c, size 0x38, virtual false, abstract: false, final false
inline ::System::Runtime::Remoting::ServerIdentity* get_ObjectIdentity() ;

/// @brief Method set_ObjectIdentity, addr 0x3da60c4, size 0x38, virtual false, abstract: false, final false
