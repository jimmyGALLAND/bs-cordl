...
/// @brief Method .ctor, addr 0x3da785c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::System::AttributeUsageAttribute*  usage, int32_t  inheritanceLevel) ;

/// @brief Method get_InheritanceLevel, addr 0x3da9fe8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_InheritanceLevel() ;

/// @brief Method get_Usage, addr 0x3da9fe0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method GetBase, addr 0x3da7328, size 0x3c4, virtual false, abstract: false, final false
static inline ::System::Reflection::ICustomAttributeProvider* GetBase(::System::Reflection::ICustomAttributeProvider*  obj) ;

/// @brief Method GetBaseEventDefinition, addr 0x3da9b18, size 0x210, virtual false, abstract: false, final false
static inline ::System::Reflection::EventInfo* GetBaseEventDefinition(::System::Reflection::RuntimeEventInfo*  evt) ;

/// @brief Method GetBasePropertyDefinition, addr 0x3da9830, size 0x2e8, virtual false, abstract: false, final false
static inline ::System::Reflection::PropertyInfo* GetBasePropertyDefinition(::System::Reflection::RuntimePropertyInfo*  property) ;

/// @brief Method GetCustomAttributes, addr 0x3da6944, size 0x9e4, virtual false, abstract: false, final false
...
/// @brief Method GetCustomAttributes, addr 0x3da7868, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method GetCustomAttributesBase, addr 0x3da67a0, size 0x1a4, virtual false, abstract: false, final false
...
/// @brief Method GetCustomAttributesData, addr 0x3da7cd4, size 0x139c, virtual false, abstract: false, final false
...
/// @brief Method GetCustomAttributesData, addr 0x3da79e8, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method GetCustomAttributesDataBase, addr 0x3da7b18, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method GetCustomAttributesDataInternal, addr 0x3da79e4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method GetCustomAttributesInternal, addr 0x3da633c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method GetPseudoCustomAttributes, addr 0x3da6344, size 0x2f4, virtual false, abstract: false, final false
...
/// @brief Method GetPseudoCustomAttributes, addr 0x3da6638, size 0x168, virtual false, abstract: false, final false
static inline ::ArrayW<::System::Object*,::Array<::System::Object*>*> GetPseudoCustomAttributes(::System::Type*  type) ;

/// @brief Method GetPseudoCustomAttributesData, addr 0x3da9070, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method GetPseudoCustomAttributesData, addr 0x3da9368, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method IsDefined, addr 0x3da9598, size 0x294, virtual false, abstract: false, final false
static inline bool IsDefined(::System::Reflection::ICustomAttributeProvider*  obj, ::System::Type*  attributeType, bool  inherit) ;

/// @brief Method IsDefinedInternal, addr 0x3da982c, size 0x4, virtual false, abstract: false, final false
static inline bool IsDefinedInternal(::System::Reflection::ICustomAttributeProvider*  obj, ::System::Type*  AttributeType) ;

/// @brief Method IsUserCattrProvider, addr 0x3da6170, size 0x1cc, virtual false, abstract: false, final false
static inline bool IsUserCattrProvider(::System::Object*  obj) ;

/// @brief Method RetrieveAttributeUsage, addr 0x3da76ec, size 0x170, virtual false, abstract: false, final false
static inline ::System::AttributeUsageAttribute* RetrieveAttributeUsage(::System::Type*  attributeType) ;

/// @brief Method RetrieveAttributeUsageNoCache, addr 0x3da9d28, size 0x244, virtual false, abstract: false, final false
