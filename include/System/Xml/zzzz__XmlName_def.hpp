...
/// @brief Method Create, addr 0x42aee28, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x42af550, size 0xc, virtual true, abstract: false, final false
inline bool Equals(::System::Xml::Schema::IXmlSchemaInfo*  schemaInfo) ;

/// @brief Method GetHashCode, addr 0x42af55c, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42aef10, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method get_HashCode, addr 0x42af358, size 0x8, virtual false, abstract: false, final false
inline int32_t get_HashCode() ;

/// @brief Method get_IsDefault, addr 0x42af520, size 0x8, virtual true, abstract: false, final false
inline bool get_IsDefault() ;

/// @brief Method get_IsNil, addr 0x42af528, size 0x8, virtual true, abstract: false, final false
inline bool get_IsNil() ;

/// @brief Method get_LocalName, addr 0x42af340, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_MemberType, addr 0x42af530, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSimpleType* get_MemberType() ;

/// @brief Method get_Name, addr 0x42af368, size 0x1b0, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NamespaceURI, addr 0x42af348, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_OwnerDocument, addr 0x42af360, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlDocument* get_OwnerDocument() ;

/// @brief Method get_Prefix, addr 0x42af350, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_SchemaAttribute, addr 0x42af548, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAttribute* get_SchemaAttribute() ;

/// @brief Method get_SchemaElement, addr 0x42af540, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaElement* get_SchemaElement() ;

/// @brief Method get_SchemaType, addr 0x42af538, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaType* get_SchemaType() ;

/// @brief Method get_Validity, addr 0x42af518, size 0x8, virtual true, abstract: false, final false
