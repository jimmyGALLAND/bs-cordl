...
/// @brief Method AppendText, addr 0x41bc654, size 0x24, virtual true, abstract: false, final false
inline void AppendText(::System::Text::StringBuilder*  sb) ;

/// @brief Method CloneNode, addr 0x41bc678, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method WriteTo, addr 0x41bc568, size 0xec, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x41b4888, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XText*  other) ;

/// @brief Method .ctor, addr 0x41b4810, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  value) ;

/// @brief Method get_NodeType, addr 0x41bc558, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Value, addr 0x41bc560, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Value, addr 0x41b64a4, size 0xf0, virtual false, abstract: false, final false
