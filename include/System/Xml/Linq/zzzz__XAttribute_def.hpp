...
/// @brief Method GetPrefixOfNamespace, addr 0x41b44c0, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x41b40e4, size 0x3dc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ValidateAttribute, addr 0x41b3b18, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x41b3628, size 0xb4, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XName*  name, ::System::Object*  value) ;

/// @brief Method .ctor, addr 0x41b3d48, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XAttribute*  other) ;

/// @brief Method get_IsNamespaceDeclaration, addr 0x41b3dc8, size 0x9c, virtual false, abstract: false, final false
inline bool get_IsNamespaceDeclaration() ;

/// @brief Method get_Name, addr 0x41b3e80, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Linq::XName* get_Name() ;

/// @brief Method get_NodeType, addr 0x41b3e88, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Value, addr 0x41b3e90, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Value, addr 0x41b3e98, size 0xfc, virtual false, abstract: false, final false
