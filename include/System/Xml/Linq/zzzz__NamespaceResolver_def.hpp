...
/// @brief Method .ctor, addr 0x41bad60, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Add, addr 0x41bac64, size 0x9c, virtual false, abstract: false, final false
inline void Add(::StringW  prefix, ::System::Xml::Linq::XNamespace*  ns) ;

/// @brief Method AddFirst, addr 0x41baae8, size 0x98, virtual false, abstract: false, final false
inline void AddFirst(::StringW  prefix, ::System::Xml::Linq::XNamespace*  ns) ;

/// @brief Method GetPrefixOfNamespace, addr 0x41baa0c, size 0xdc, virtual false, abstract: false, final false
inline ::StringW GetPrefixOfNamespace(::System::Xml::Linq::XNamespace*  ns, bool  allowDefaultNamespace) ;

/// @brief Method PopScope, addr 0x41bad00, size 0x60, virtual false, abstract: false, final false
inline void PopScope() ;

/// @brief Method PushScope, addr 0x41bac54, size 0x10, virtual false, abstract: false, final false
