...
/// @brief Method CloneNode, addr 0x41bc500, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method ValidateName, addr 0x41bc238, size 0xd8, virtual false, abstract: false, final false
static inline void ValidateName(::StringW  name) ;

/// @brief Method WriteTo, addr 0x41bc490, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x41bc310, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XProcessingInstruction*  other) ;

/// @brief Method .ctor, addr 0x41b8014, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  target, ::StringW  data) ;

/// @brief Method get_Data, addr 0x41bc388, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Data() ;

/// @brief Method get_NodeType, addr 0x41bc480, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Target, addr 0x41bc488, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Target() ;

/// @brief Method set_Data, addr 0x41bc390, size 0xf0, virtual false, abstract: false, final false
