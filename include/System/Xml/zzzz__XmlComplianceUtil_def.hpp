...
public:
// Declarations
/// @brief Method CDataNormalize, addr 0x42c4fa8, size 0x1e0, virtual false, abstract: false, final false
static inline ::StringW CDataNormalize(::StringW  value) ;

/// @brief Method NonCDataNormalize, addr 0x42c4d24, size 0x284, virtual false, abstract: false, final false
