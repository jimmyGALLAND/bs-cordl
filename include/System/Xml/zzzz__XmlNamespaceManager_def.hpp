...
public:
// Declarations
/// @brief Method Set, addr 0x42cfde4, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field nsdecls, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_nsdecls, put=__cordl_internal_set_nsdecls)) ::ArrayW<::System::Xml::__XmlNamespaceManager__NamespaceDeclaration,::Array<::System::Xml::__XmlNamespaceManager__NamespaceDeclaration>*>  nsdecls;
...
/// @brief Method AddNamespace, addr 0x42cff4c, size 0x398, virtual true, abstract: false, final false
inline void AddNamespace(::StringW  prefix, ::StringW  uri) ;

/// @brief Method GetEnumerator, addr 0x42d05a8, size 0x174, virtual true, abstract: false, final false
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method GetNamespacesInScope, addr 0x42d071c, size 0x1b8, virtual true, abstract: false, final false
inline ::System::Collections::Generic::IDictionary_2<::StringW,::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope  scope) ;

/// @brief Method LookupNamespace, addr 0x42d08d4, size 0x4c, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupNamespaceDecl, addr 0x42d02e4, size 0x190, virtual false, abstract: false, final false
inline int32_t LookupNamespaceDecl(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x42d0920, size 0xc4, virtual true, abstract: false, final false
...
/// @brief Method PopScope, addr 0x42cfe78, size 0xd4, virtual true, abstract: false, final false
inline bool PopScope() ;

/// @brief Method PushScope, addr 0x42cfe68, size 0x10, virtual true, abstract: false, final false
inline void PushScope() ;

/// @brief Method RemoveNamespace, addr 0x42d0474, size 0x134, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42cfc20, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x42cfc28, size 0x1bc, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNameTable*  nameTable) ;

/// @brief Method get_DefaultNamespace, addr 0x42cfdf8, size 0x70, virtual true, abstract: false, final false
inline ::StringW get_DefaultNamespace() ;

/// @brief Method get_NameTable, addr 0x42cfdf0, size 0x8, virtual true, abstract: false, final false
