...
/// @brief Method CheckOnData, addr 0x42a37ac, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42a34b4, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  data, ::System::Xml::XmlDocument*  doc) ;

/// @brief Method get_Data, addr 0x42a36b8, size 0x54, virtual true, abstract: false, final false
inline ::StringW get_Data() ;

/// @brief Method get_InnerText, addr 0x42a36a0, size 0xc, virtual true, abstract: false, final false
inline ::StringW get_InnerText() ;

/// @brief Method get_Value, addr 0x42a3680, size 0x10, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Data, addr 0x42a370c, size 0xa0, virtual true, abstract: false, final false
inline void set_Data(::StringW  value) ;

/// @brief Method set_InnerText, addr 0x42a36ac, size 0xc, virtual true, abstract: false, final false
inline void set_InnerText(::StringW  value) ;

/// @brief Method set_Value, addr 0x42a3690, size 0x10, virtual true, abstract: false, final false
