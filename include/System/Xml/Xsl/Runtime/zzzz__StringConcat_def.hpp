...
/// @brief Method Clear, addr 0x430198c, size 0xc, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ConcatNoDelimiter, addr 0x4301a94, size 0x2ac, virtual false, abstract: false, final false
inline void ConcatNoDelimiter(::StringW  s) ;

/// @brief Method GetResult, addr 0x43019a0, size 0xf4, virtual false, abstract: false, final false
inline ::StringW GetResult() ;

/// @brief Method get_Count, addr 0x4301998, size 0x8, virtual false, abstract: false, final false
