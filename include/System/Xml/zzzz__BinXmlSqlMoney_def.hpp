...
public:
// Declarations
/// @brief Method ToDecimal, addr 0x41a537c, size 0x64, virtual false, abstract: false, final false
inline ::System::Decimal ToDecimal() ;

/// @brief Method ToString, addr 0x41a53e0, size 0xec, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x41a5368, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  v) ;

/// @brief Method .ctor, addr 0x41a5374, size 0x8, virtual false, abstract: false, final false
