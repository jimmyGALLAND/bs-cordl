...
/// @brief Method Finish, addr 0x427a424, size 0x13c, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method MoveToNextContentNode, addr 0x427a560, size 0xd8, virtual false, abstract: false, final false
inline bool MoveToNextContentNode(bool  moveIfOnContentNode) ;

/// @brief Method Reset, addr 0x427a638, size 0xc, virtual false, abstract: false, final false
inline void Reset() ;
