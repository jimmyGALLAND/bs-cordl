...
/// @brief Method Clone, addr 0x422ce2c, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObject* Clone() ;

/// @brief Method Clone, addr 0x4226e50, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method SetQualifiedName, addr 0x422ce24, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x422ce34, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CanonicalParticle, addr 0x422cde4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaParticle* get_CanonicalParticle() ;

/// @brief Method get_Name, addr 0x422cdbc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NameAttribute, addr 0x422ce14, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_NameAttribute() ;

/// @brief Method get_Particle, addr 0x422cdcc, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaGroupBase* get_Particle() ;

/// @brief Method get_QualifiedName, addr 0x422cddc, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_QualifiedName() ;

/// @brief Method get_Redefined, addr 0x422cdf4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaGroup* get_Redefined() ;

/// @brief Method get_SelfReferenceCount, addr 0x422ce04, size 0x8, virtual false, abstract: false, final false
inline int32_t get_SelfReferenceCount() ;

/// @brief Method set_CanonicalParticle, addr 0x422cdec, size 0x8, virtual false, abstract: false, final false
inline void set_CanonicalParticle(::System::Xml::Schema::XmlSchemaParticle*  value) ;

/// @brief Method set_Name, addr 0x422cdc4, size 0x8, virtual false, abstract: false, final false
inline void set_Name(::StringW  value) ;

/// @brief Method set_NameAttribute, addr 0x422ce1c, size 0x8, virtual true, abstract: false, final false
inline void set_NameAttribute(::StringW  value) ;

/// @brief Method set_Particle, addr 0x422cdd4, size 0x8, virtual false, abstract: false, final false
inline void set_Particle(::System::Xml::Schema::XmlSchemaGroupBase*  value) ;

/// @brief Method set_Redefined, addr 0x422cdfc, size 0x8, virtual false, abstract: false, final false
inline void set_Redefined(::System::Xml::Schema::XmlSchemaGroup*  value) ;

/// @brief Method set_SelfReferenceCount, addr 0x422ce0c, size 0x8, virtual false, abstract: false, final false
