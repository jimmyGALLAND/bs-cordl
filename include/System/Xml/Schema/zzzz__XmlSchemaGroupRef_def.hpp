...
/// @brief Method SetParticle, addr 0x422ceac, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x422cec4, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Particle, addr 0x422cea4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaGroupBase* get_Particle() ;

/// @brief Method get_Redefined, addr 0x422ceb4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaGroup* get_Redefined() ;

/// @brief Method get_RefName, addr 0x422ce9c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_RefName() ;

/// @brief Method set_Redefined, addr 0x422cebc, size 0x8, virtual false, abstract: false, final false
inline void set_Redefined(::System::Xml::Schema::XmlSchemaGroup*  value) ;

/// @brief Method set_RefName, addr 0x422ac84, size 0x98, virtual false, abstract: false, final false
