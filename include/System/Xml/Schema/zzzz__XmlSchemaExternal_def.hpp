...
/// @brief Method SetUnhandledAttributes, addr 0x422cb30, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x422cb48, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BaseUri, addr 0x422cb10, size 0x8, virtual false, abstract: false, final false
inline ::System::Uri* get_BaseUri() ;

/// @brief Method get_Compositor, addr 0x422cb38, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::Compositor get_Compositor() ;

/// @brief Method get_Id, addr 0x422cb00, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Id() ;

/// @brief Method get_IdAttribute, addr 0x422cb20, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_IdAttribute() ;

/// @brief Method get_Schema, addr 0x422caf0, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* get_Schema() ;

/// @brief Method get_SchemaLocation, addr 0x422cae0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SchemaLocation() ;

/// @brief Method set_BaseUri, addr 0x422cb18, size 0x8, virtual false, abstract: false, final false
inline void set_BaseUri(::System::Uri*  value) ;

/// @brief Method set_Compositor, addr 0x422cb40, size 0x8, virtual false, abstract: false, final false
inline void set_Compositor(::System::Xml::Schema::Compositor  value) ;

/// @brief Method set_Id, addr 0x422cb08, size 0x8, virtual false, abstract: false, final false
inline void set_Id(::StringW  value) ;

/// @brief Method set_IdAttribute, addr 0x422cb28, size 0x8, virtual true, abstract: false, final false
inline void set_IdAttribute(::StringW  value) ;

/// @brief Method set_Schema, addr 0x422caf8, size 0x8, virtual false, abstract: false, final false
inline void set_Schema(::System::Xml::Schema::XmlSchema*  value) ;

/// @brief Method set_SchemaLocation, addr 0x422cae8, size 0x8, virtual false, abstract: false, final false
