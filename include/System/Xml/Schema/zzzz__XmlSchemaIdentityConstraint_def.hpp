...
/// @brief Method SetQualifiedName, addr 0x422cf80, size 0x8, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::CompiledIdentityConstraint*> const& __cordl_internal_get_compiledConstraint() const;

constexpr ::System::Xml::Schema::XmlSchemaObjectCollection*& __cordl_internal_get_fields() ;

constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::XmlSchemaObjectCollection*> const& __cordl_internal_get_fields() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::XmlSchemaXPath*> const& __cordl_internal_get_selector() const;
...
/// @brief Method .ctor, addr 0x422cfa8, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CompiledConstraint, addr 0x422cf88, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::CompiledIdentityConstraint* get_CompiledConstraint() ;

/// @brief Method get_Fields, addr 0x422cf70, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Fields() ;

/// @brief Method get_Name, addr 0x422cf50, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NameAttribute, addr 0x422cf98, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_NameAttribute() ;

/// @brief Method get_QualifiedName, addr 0x422cf78, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_QualifiedName() ;

/// @brief Method get_Selector, addr 0x422cf60, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaXPath* get_Selector() ;

/// @brief Method set_CompiledConstraint, addr 0x422cf90, size 0x8, virtual false, abstract: false, final false
inline void set_CompiledConstraint(::System::Xml::Schema::CompiledIdentityConstraint*  value) ;

/// @brief Method set_Name, addr 0x422cf58, size 0x8, virtual false, abstract: false, final false
inline void set_Name(::StringW  value) ;

/// @brief Method set_NameAttribute, addr 0x422cfa0, size 0x8, virtual true, abstract: false, final false
inline void set_NameAttribute(::StringW  value) ;

/// @brief Method set_Selector, addr 0x422cf68, size 0x8, virtual false, abstract: false, final false
