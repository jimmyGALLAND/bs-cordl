...
/// @brief Method Clone, addr 0x4237a18, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4237ac8, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BaseItemType, addr 0x4237a08, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSimpleType* get_BaseItemType() ;

/// @brief Method get_ItemType, addr 0x42379f8, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSimpleType* get_ItemType() ;

/// @brief Method get_ItemTypeName, addr 0x4237958, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_ItemTypeName() ;

/// @brief Method set_BaseItemType, addr 0x4237a10, size 0x8, virtual false, abstract: false, final false
inline void set_BaseItemType(::System::Xml::Schema::XmlSchemaSimpleType*  value) ;

/// @brief Method set_ItemType, addr 0x4237a00, size 0x8, virtual false, abstract: false, final false
inline void set_ItemType(::System::Xml::Schema::XmlSchemaSimpleType*  value) ;

/// @brief Method set_ItemTypeName, addr 0x4237960, size 0x98, virtual false, abstract: false, final false
