...
/// @brief Method Equal, addr 0x4302028, size 0x7c, virtual false, abstract: false, final false
static inline bool Equal(::StringW  thisname, ::StringW  thisURN, ::StringW  name, ::StringW  URN) ;

/// @brief Method MoveToAttribute, addr 0x43024d0, size 0x174, virtual false, abstract: false, final false
inline bool MoveToAttribute(::StringW  name, ::StringW  URN, int32_t  depth) ;

/// @brief Method MoveToChild, addr 0x4302390, size 0x140, virtual false, abstract: false, final false
inline bool MoveToChild(::StringW  name, ::StringW  URN, int32_t  depth) ;

/// @brief Method MoveToParent, addr 0x4302248, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method Pop, addr 0x4302208, size 0x40, virtual false, abstract: false, final false
inline void Pop() ;

/// @brief Method Push, addr 0x4302174, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43020d0, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::ForwardAxis*  faxis, ::System::Xml::Schema::ActiveAxis*  parent) ;

/// @brief Method get_Length, addr 0x43020ac, size 0x24, virtual false, abstract: false, final false
inline int32_t get_Length() ;

/// @brief Method get_Subtree, addr 0x43020a4, size 0x8, virtual false, abstract: false, final false
