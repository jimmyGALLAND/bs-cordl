...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Xml::Schema::XmlUnionConverter::*)(::System::Xml::Schema::XmlSchemaType*)>(&::System::Xml::Schema::XmlUnionConverter::_ctor)> {
  constexpr static std::size_t size = 0x244;
  constexpr static std::size_t addrs = 0x425f87c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Xml::Schema::XmlUnionConverter*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Xml::Schema::XmlValueConverter* (*)(::System::Xml::Schema::XmlSchemaType*)>(&::System::Xml::Schema::XmlUnionConverter::Create)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x425fac0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Object* (::System::Xml::Schema::XmlUnionConverter::*)(::System::Object*, ::System::Type*, ::System::Xml::IXmlNamespaceResolver*)>(&::System::Xml::Schema::XmlUnionConverter::ChangeType)> {
  constexpr static std::size_t size = 0x414;
  constexpr static std::size_t addrs = 0x425fb18;
...
constexpr ::ArrayW<::System::Xml::Schema::XmlValueConverter*,::Array<::System::Xml::Schema::XmlValueConverter*>*> const& System::Xml::Schema::XmlUnionConverter::__cordl_internal_get_converters() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___converters;
}
