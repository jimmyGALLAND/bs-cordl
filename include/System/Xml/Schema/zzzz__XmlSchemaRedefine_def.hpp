...
/// @brief Method AddAnnotation, addr 0x422fb20, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x422fa3c, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AttributeGroups, addr 0x422fb08, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_AttributeGroups() ;

/// @brief Method get_Groups, addr 0x422fb18, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_Groups() ;

/// @brief Method get_Items, addr 0x422fb00, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Items() ;

/// @brief Method get_SchemaTypes, addr 0x422fb10, size 0x8, virtual false, abstract: false, final false
