...
/// @brief Method CompleteValidation, addr 0x4303cf4, size 0x4, virtual true, abstract: false, final false
inline void CompleteValidation() ;

/// @brief Method DetectValidationType, addr 0x43039b0, size 0x344, virtual false, abstract: false, final false
inline ::System::Xml::ValidationType DetectValidationType() ;

/// @brief Method FindId, addr 0x4303cf8, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method Validate, addr 0x43038d4, size 0xdc, virtual true, abstract: false, final false
inline void Validate() ;

/// @brief Method .ctor, addr 0x4303794, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method get_PreserveWhitespace, addr 0x43038cc, size 0x8, virtual true, abstract: false, final false
