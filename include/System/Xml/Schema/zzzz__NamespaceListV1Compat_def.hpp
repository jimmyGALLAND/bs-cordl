...
public:
// Declarations
/// @brief Method Allows, addr 0x41db4e0, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x41db4dc, size 0x4, virtual false, abstract: false, final false
