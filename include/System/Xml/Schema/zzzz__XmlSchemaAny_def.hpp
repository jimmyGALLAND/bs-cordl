...
/// @brief Method Allows, addr 0x4227c48, size 0x28, virtual false, abstract: false, final false
inline bool Allows(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method BuildNamespaceList, addr 0x4227b28, size 0x80, virtual false, abstract: false, final false
inline void BuildNamespaceList(::StringW  targetNamespace) ;

/// @brief Method BuildNamespaceListV1Compat, addr 0x4227ba8, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4227c70, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_NameString, addr 0x4227610, size 0x518, virtual true, abstract: false, final false
inline ::StringW get_NameString() ;

/// @brief Method get_Namespace, addr 0x4227584, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method get_NamespaceList, addr 0x422759c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::NamespaceList* get_NamespaceList() ;

/// @brief Method get_ProcessContentsCorrect, addr 0x42275fc, size 0x14, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContentProcessing get_ProcessContentsCorrect() ;

/// @brief Method get_ResolvedNamespace, addr 0x42275a4, size 0x58, virtual false, abstract: false, final false
inline ::StringW get_ResolvedNamespace() ;

/// @brief Method set_Namespace, addr 0x422758c, size 0x8, virtual false, abstract: false, final false
inline void set_Namespace(::StringW  value) ;

/// @brief Method set_ProcessContents, addr 0x4227594, size 0x8, virtual false, abstract: false, final false
