...
/// @brief Method CompileXPath, addr 0x4302e64, size 0x7cc, virtual false, abstract: false, final false
inline void CompileXPath(::StringW  xPath, bool  isField, ::System::Xml::XmlNamespaceManager*  nsmgr) ;

/// @brief Method IsAttribute, addr 0x4301ff4, size 0x34, virtual false, abstract: false, final false
static inline bool IsAttribute(::MS::Internal::Xml::XPath::Axis*  ast) ;

/// @brief Method IsDescendantOrSelf, addr 0x4303664, size 0x40, virtual false, abstract: false, final false
static inline bool IsDescendantOrSelf(::MS::Internal::Xml::XPath::Axis*  ast) ;

/// @brief Method IsNameTest, addr 0x4303630, size 0x34, virtual false, abstract: false, final false
static inline bool IsNameTest(::MS::Internal::Xml::XPath::Axis*  ast) ;

/// @brief Method IsSelf, addr 0x4302dcc, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method SetURN, addr 0x43036a4, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4302e14, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::StringW  xPath, bool  isField, ::System::Xml::XmlNamespaceManager*  nsmgr) ;

/// @brief Method get_SubtreeArray, addr 0x4302e0c, size 0x8, virtual false, abstract: false, final false
