...
/// @brief Method Clear, addr 0x422d1f8, size 0x1c, virtual false, abstract: false, final false
inline void Clear() ;
...
/// @brief Method .ctor, addr 0x422d1c8, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x422d214, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::XmlSchemaValidity  validity) ;

/// @brief Method get_ContentType, addr 0x422d2ec, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContentType get_ContentType() ;

/// @brief Method get_HasDefaultValue, addr 0x422d310, size 0x34, virtual false, abstract: false, final false
inline bool get_HasDefaultValue() ;

/// @brief Method get_IsDefault, addr 0x422d260, size 0x8, virtual true, abstract: false, final true
inline bool get_IsDefault() ;

/// @brief Method get_IsNil, addr 0x422d274, size 0x8, virtual true, abstract: false, final true
inline bool get_IsNil() ;

/// @brief Method get_IsUnionType, addr 0x422d344, size 0x38, virtual false, abstract: false, final false
inline bool get_IsUnionType() ;

/// @brief Method get_MemberType, addr 0x422d288, size 0x8, virtual true, abstract: false, final true
inline ::System::Xml::Schema::XmlSchemaSimpleType* get_MemberType() ;

/// @brief Method get_SchemaAttribute, addr 0x422d2d4, size 0x8, virtual true, abstract: false, final true
inline ::System::Xml::Schema::XmlSchemaAttribute* get_SchemaAttribute() ;

/// @brief Method get_SchemaElement, addr 0x422d2bc, size 0x8, virtual true, abstract: false, final true
inline ::System::Xml::Schema::XmlSchemaElement* get_SchemaElement() ;

/// @brief Method get_SchemaType, addr 0x422d298, size 0x8, virtual true, abstract: false, final true
inline ::System::Xml::Schema::XmlSchemaType* get_SchemaType() ;

/// @brief Method get_Validity, addr 0x422d250, size 0x8, virtual true, abstract: false, final true
inline ::System::Xml::Schema::XmlSchemaValidity get_Validity() ;

/// @brief Method get_XmlType, addr 0x422d2f4, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method set_IsDefault, addr 0x422d268, size 0xc, virtual false, abstract: false, final false
inline void set_IsDefault(bool  value) ;

/// @brief Method set_IsNil, addr 0x422d27c, size 0xc, virtual false, abstract: false, final false
inline void set_IsNil(bool  value) ;

/// @brief Method set_MemberType, addr 0x422d290, size 0x8, virtual false, abstract: false, final false
inline void set_MemberType(::System::Xml::Schema::XmlSchemaSimpleType*  value) ;

/// @brief Method set_SchemaAttribute, addr 0x422d2dc, size 0x10, virtual false, abstract: false, final false
inline void set_SchemaAttribute(::System::Xml::Schema::XmlSchemaAttribute*  value) ;

/// @brief Method set_SchemaElement, addr 0x422d2c4, size 0x10, virtual false, abstract: false, final false
inline void set_SchemaElement(::System::Xml::Schema::XmlSchemaElement*  value) ;

/// @brief Method set_SchemaType, addr 0x422d2a0, size 0x1c, virtual false, abstract: false, final false
inline void set_SchemaType(::System::Xml::Schema::XmlSchemaType*  value) ;

/// @brief Method set_Validity, addr 0x422d258, size 0x8, virtual false, abstract: false, final false
