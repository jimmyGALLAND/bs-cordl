...
/// @brief Method CheckSchemaRoot, addr 0x41dc030, size 0x100, virtual false, abstract: false, final false
inline bool CheckSchemaRoot(::System::Xml::Schema::SchemaType  rootType, ByRef<::StringW>  code) ;

/// @brief Method CreateXmlNsAttribute, addr 0x41dc8bc, size 0x11c, virtual false, abstract: false, final false
inline ::System::Xml::XmlAttribute* CreateXmlNsAttribute(::StringW  prefix, ::StringW  value) ;

/// @brief Method FinishParsing, addr 0x41dc130, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaType FinishParsing() ;

/// @brief Method LoadAttributeNode, addr 0x41dc748, size 0x174, virtual false, abstract: false, final false
inline ::System::Xml::XmlAttribute* LoadAttributeNode() ;

/// @brief Method LoadElementNode, addr 0x41dc370, size 0x3d8, virtual false, abstract: false, final false
inline ::System::Xml::XmlElement* LoadElementNode(bool  root) ;

/// @brief Method LoadEntityReferenceInAttribute, addr 0x41dc9d8, size 0x208, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x41db5b4, size 0x50, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaType Parse(::System::Xml::XmlReader*  reader, ::StringW  targetNamespace) ;

/// @brief Method ParseReaderNode, addr 0x41db9b4, size 0x67c, virtual false, abstract: false, final false
inline bool ParseReaderNode() ;

/// @brief Method ProcessAppInfoDocMarkup, addr 0x41dc150, size 0x220, virtual false, abstract: false, final false
inline void ProcessAppInfoDocMarkup(bool  root) ;

/// @brief Method StartParsing, addr 0x41db604, size 0x3b0, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::XmlNamespaceManager*> const& __cordl_internal_get_annotationNSManager() const;

constexpr ::System::Xml::Schema::SchemaBuilder*& __cordl_internal_get_builder() ;

constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::SchemaBuilder*> const& __cordl_internal_get_builder() const;

constexpr ::System::Xml::XmlDocument*& __cordl_internal_get_dummyDocument() ;

constexpr ::cordl_internals::to_const_pointer<::System::Xml::XmlDocument*> const& __cordl_internal_get_dummyDocument() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::SchemaInfo*> const& __cordl_internal_get_xdrSchema() const;
...
/// @brief Method .ctor, addr 0x41db504, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_XdrSchema, addr 0x41dc148, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaInfo* get_XdrSchema() ;

/// @brief Method get_XmlSchema, addr 0x41dc138, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* get_XmlSchema() ;

/// @brief Method set_XmlResolver, addr 0x41dc140, size 0x8, virtual false, abstract: false, final false
