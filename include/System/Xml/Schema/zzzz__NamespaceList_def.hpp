...
/// @brief Method Allows, addr 0x41d9ee0, size 0x84, virtual true, abstract: false, final false
inline bool Allows(::StringW  ns) ;

/// @brief Method Allows, addr 0x41d9f64, size 0x20, virtual false, abstract: false, final false
inline bool Allows(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method Clone, addr 0x41d9d44, size 0x128, virtual false, abstract: false, final false
inline ::System::Xml::Schema::NamespaceList* Clone() ;

/// @brief Method CompareSetToOther, addr 0x41dae08, size 0x12c, virtual false, abstract: false, final false
inline ::System::Xml::Schema::NamespaceList* CompareSetToOther(::System::Xml::Schema::NamespaceList*  other) ;

/// @brief Method Intersection, addr 0x41daf34, size 0x548, virtual false, abstract: false, final false
...
/// @brief Method IsSubset, addr 0x41da48c, size 0x3e4, virtual false, abstract: false, final false
...
/// @brief Method RemoveNamespace, addr 0x41db47c, size 0x60, virtual false, abstract: false, final false
inline void RemoveNamespace(::StringW  tns) ;

/// @brief Method ToString, addr 0x41d9f84, size 0x508, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Union, addr 0x41da870, size 0x598, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x41d9aa0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x41d9aa8, size 0x29c, virtual false, abstract: false, final false
inline void _ctor(::StringW  namespaces, ::StringW  targetNamespace) ;

/// @brief Method get_Enumerate, addr 0x41d9e7c, size 0x64, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* get_Enumerate() ;

/// @brief Method get_Excluded, addr 0x41d9e74, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Excluded() ;

/// @brief Method get_Type, addr 0x41d9e6c, size 0x8, virtual false, abstract: false, final false
