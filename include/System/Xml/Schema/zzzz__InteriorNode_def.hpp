...
/// @brief Method ExpandTree, addr 0x430a444, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method ExpandTreeNoRecursive, addr 0x430a25c, size 0x1e8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x430a4a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_LeftChild, addr 0x430a23c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SyntaxTreeNode* get_LeftChild() ;

/// @brief Method get_RightChild, addr 0x430a24c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SyntaxTreeNode* get_RightChild() ;

/// @brief Method set_LeftChild, addr 0x430a244, size 0x8, virtual false, abstract: false, final false
inline void set_LeftChild(::System::Xml::Schema::SyntaxTreeNode*  value) ;

/// @brief Method set_RightChild, addr 0x430a254, size 0x8, virtual false, abstract: false, final false
