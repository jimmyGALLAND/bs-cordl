...
/// @brief Method .ctor, addr 0x4302cb0, size 0x11c, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::DoubleLinkAxis*  axis, bool  isdesorself) ;

/// @brief Method get_IsAttribute, addr 0x4302c98, size 0x8, virtual false, abstract: false, final false
inline bool get_IsAttribute() ;

/// @brief Method get_IsDss, addr 0x4302ca0, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDss() ;

/// @brief Method get_IsSelfAxis, addr 0x4302ca8, size 0x8, virtual false, abstract: false, final false
inline bool get_IsSelfAxis() ;

/// @brief Method get_RootNode, addr 0x4302c88, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::DoubleLinkAxis* get_RootNode() ;

/// @brief Method get_TopNode, addr 0x4302c90, size 0x8, virtual false, abstract: false, final false
