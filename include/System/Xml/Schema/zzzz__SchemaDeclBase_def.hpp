...
/// @brief Method AddValue, addr 0x41ffdb4, size 0xec, virtual false, abstract: false, final false
inline void AddValue(::StringW  value) ;

/// @brief Method CheckEnumeration, addr 0x41fff1c, size 0xb8, virtual false, abstract: false, final false
inline bool CheckEnumeration(::System::Object*  pVal) ;

/// @brief Method CheckValue, addr 0x41fffd4, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x41ffc7c, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x41ffbf4, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlQualifiedName*  name, ::StringW  prefix) ;

/// @brief Method get_Datatype, addr 0x41ffda4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaDatatype* get_Datatype() ;

/// @brief Method get_DefaultValueRaw, addr 0x41ffeb0, size 0x54, virtual false, abstract: false, final false
inline ::StringW get_DefaultValueRaw() ;

/// @brief Method get_DefaultValueTyped, addr 0x41fff0c, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* get_DefaultValueTyped() ;

/// @brief Method get_IsDeclaredInExternal, addr 0x41ffd50, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDeclaredInExternal() ;

/// @brief Method get_MaxLength, addr 0x41ffd74, size 0x8, virtual false, abstract: false, final false
inline int64_t get_MaxLength() ;

/// @brief Method get_MinLength, addr 0x41ffd84, size 0x8, virtual false, abstract: false, final false
inline int64_t get_MinLength() ;

/// @brief Method get_Name, addr 0x41ffce4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_Name() ;

/// @brief Method get_Prefix, addr 0x41ffcf4, size 0x54, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_Presence, addr 0x41ffd64, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::__SchemaDeclBase__Use get_Presence() ;

/// @brief Method get_SchemaType, addr 0x41ffd94, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaType* get_SchemaType() ;

/// @brief Method get_Values, addr 0x41ffea0, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::StringW>* get_Values() ;

/// @brief Method set_Datatype, addr 0x41ffdac, size 0x8, virtual false, abstract: false, final false
inline void set_Datatype(::System::Xml::Schema::XmlSchemaDatatype*  value) ;

/// @brief Method set_DefaultValueRaw, addr 0x41fff04, size 0x8, virtual false, abstract: false, final false
inline void set_DefaultValueRaw(::StringW  value) ;

/// @brief Method set_DefaultValueTyped, addr 0x41fff14, size 0x8, virtual false, abstract: false, final false
inline void set_DefaultValueTyped(::System::Object*  value) ;

/// @brief Method set_IsDeclaredInExternal, addr 0x41ffd58, size 0xc, virtual false, abstract: false, final false
inline void set_IsDeclaredInExternal(bool  value) ;

/// @brief Method set_MaxLength, addr 0x41ffd7c, size 0x8, virtual false, abstract: false, final false
inline void set_MaxLength(int64_t  value) ;

/// @brief Method set_MinLength, addr 0x41ffd8c, size 0x8, virtual false, abstract: false, final false
inline void set_MinLength(int64_t  value) ;

/// @brief Method set_Name, addr 0x41ffcec, size 0x8, virtual false, abstract: false, final false
inline void set_Name(::System::Xml::XmlQualifiedName*  value) ;

/// @brief Method set_Prefix, addr 0x41ffd48, size 0x8, virtual false, abstract: false, final false
inline void set_Prefix(::StringW  value) ;

/// @brief Method set_Presence, addr 0x41ffd6c, size 0x8, virtual false, abstract: false, final false
inline void set_Presence(::System::Xml::Schema::__SchemaDeclBase__Use  value) ;

/// @brief Method set_SchemaType, addr 0x41ffd9c, size 0x8, virtual false, abstract: false, final false
inline void set_SchemaType(::System::Xml::Schema::XmlSchemaType*  value) ;

/// @brief Method set_Values, addr 0x41ffea8, size 0x8, virtual false, abstract: false, final false
