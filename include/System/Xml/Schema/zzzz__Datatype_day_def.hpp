...
/// @brief Method .ctor, addr 0x43132f8, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_TypeCode, addr 0x431a1b4, size 0x8, virtual true, abstract: false, final false
