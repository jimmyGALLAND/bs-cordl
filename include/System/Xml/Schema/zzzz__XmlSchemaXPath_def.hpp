...
/// @brief Method .ctor, addr 0x422d054, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_XPath, addr 0x422d044, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_XPath() ;

/// @brief Method set_XPath, addr 0x422d04c, size 0x8, virtual false, abstract: false, final false
