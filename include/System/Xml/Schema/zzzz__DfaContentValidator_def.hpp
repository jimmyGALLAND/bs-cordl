...
/// @brief Field transitionTable, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_transitionTable, put=__cordl_internal_set_transitionTable)) ::ArrayW<::ArrayW<int32_t,::Array<int32_t>*>,::Array<::ArrayW<int32_t,::Array<int32_t>*>>*>  transitionTable;

/// @brief Method CompleteValidation, addr 0x430d2b8, size 0x18, virtual true, abstract: false, final false
inline bool CompleteValidation(::System::Xml::Schema::ValidationState*  context) ;

/// @brief Method ExpectedElements, addr 0x430d2d0, size 0x1cc, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState*  context, bool  isRequiredOnly) ;

/// @brief Method ExpectedParticles, addr 0x430d49c, size 0x184, virtual true, abstract: false, final false
...
/// @brief Method InitValidation, addr 0x430d144, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method ValidateElement, addr 0x430d1a8, size 0x110, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x430cef0, size 0xa0, virtual false, abstract: false, final false
