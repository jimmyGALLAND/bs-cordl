...
/// @brief Method .ctor, addr 0x422cc2c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_FacetType, addr 0x422cc1c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::FacetType get_FacetType() ;

/// @brief Method get_IsFixed, addr 0x422cb60, size 0x8, virtual true, abstract: false, final false
inline bool get_IsFixed() ;

/// @brief Method get_Value, addr 0x422cb50, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_FacetType, addr 0x422cc24, size 0x8, virtual false, abstract: false, final false
inline void set_FacetType(::System::Xml::Schema::FacetType  value) ;

/// @brief Method set_IsFixed, addr 0x422cb68, size 0xb4, virtual true, abstract: false, final false
inline void set_IsFixed(bool  value) ;

/// @brief Method set_Value, addr 0x422cb58, size 0x8, virtual false, abstract: false, final false
