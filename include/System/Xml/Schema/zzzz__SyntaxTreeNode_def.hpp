...
/// @brief Method .ctor, addr 0x4309c78, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsNullable, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
inline bool get_IsNullable() ;

/// @brief Method get_IsRangeNode, addr 0x4309c70, size 0x8, virtual true, abstract: false, final false
