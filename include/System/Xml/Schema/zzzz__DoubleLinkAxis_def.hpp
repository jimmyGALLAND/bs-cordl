...
/// @brief Method ConvertTree, addr 0x4302bc8, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4302b70, size 0x58, virtual false, abstract: false, final false
inline void _ctor(::MS::Internal::Xml::XPath::Axis*  axis, ::System::Xml::Schema::DoubleLinkAxis*  inputaxis) ;

/// @brief Method get_Next, addr 0x4302b60, size 0x8, virtual false, abstract: false, final false
inline ::MS::Internal::Xml::XPath::Axis* get_Next() ;

/// @brief Method set_Next, addr 0x4302b68, size 0x8, virtual false, abstract: false, final false
