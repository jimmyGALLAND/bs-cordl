...
/// @brief Method AddAnnotation, addr 0x422d1c0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x422d1a0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
