...
/// @brief Method .ctor, addr 0x42295c0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_EnableUpaCheck, addr 0x42295e0, size 0x8, virtual false, abstract: false, final false
