...
// Ctor Parameters [CppParam { name: "curpos", ty: "::System::Xml::Schema::BitSet*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "rangeCounters", ty: "::ArrayW<::System::Decimal,::Array<::System::Decimal>*>", modifiers: "", def_value: Some("nullptr") }]
