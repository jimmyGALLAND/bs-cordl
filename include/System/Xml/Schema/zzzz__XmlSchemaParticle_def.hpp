...
/// @brief Method GetQualifiedName, addr 0x422f780, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x422f900, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Xml::Schema::XmlSchemaParticle* getStaticF_Empty() ;

/// @brief Method get_IsEmpty, addr 0x422f6cc, size 0x6c, virtual true, abstract: false, final false
inline bool get_IsEmpty() ;

/// @brief Method get_MaxOccurs, addr 0x422f55c, size 0xc, virtual false, abstract: false, final false
inline ::System::Decimal get_MaxOccurs() ;

/// @brief Method get_MaxOccursString, addr 0x422f0e4, size 0x124, virtual false, abstract: false, final false
inline ::StringW get_MaxOccursString() ;

/// @brief Method get_MinOccurs, addr 0x422f424, size 0xc, virtual false, abstract: false, final false
inline ::System::Decimal get_MinOccurs() ;

/// @brief Method get_MinOccursString, addr 0x422ef18, size 0x78, virtual false, abstract: false, final false
inline ::StringW get_MinOccursString() ;

/// @brief Method get_NameString, addr 0x422f738, size 0x48, virtual true, abstract: false, final false
inline ::StringW get_NameString() ;

static inline void setStaticF_Empty(::System::Xml::Schema::XmlSchemaParticle*  value) ;

/// @brief Method set_MaxOccurs, addr 0x422f568, size 0x164, virtual false, abstract: false, final false
inline void set_MaxOccurs(::System::Decimal  value) ;

/// @brief Method set_MaxOccursString, addr 0x422f208, size 0x21c, virtual false, abstract: false, final false
inline void set_MaxOccursString(::StringW  value) ;

/// @brief Method set_MinOccurs, addr 0x422f430, size 0x12c, virtual false, abstract: false, final false
inline void set_MinOccurs(::System::Decimal  value) ;

/// @brief Method set_MinOccursString, addr 0x422ef90, size 0x154, virtual false, abstract: false, final false
