...
public:
// Declarations
/// @brief Method LookupNamespace, addr 0x432231c, size 0x8, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

static inline ::System::Xml::Schema::__DtdValidator__NamespaceManager* New_ctor() ;

/// @brief Method .ctor, addr 0x4322314, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddID, addr 0x432199c, size 0x90, virtual false, abstract: false, final false
inline void AddID(::StringW  name, ::System::Object*  node) ;

/// @brief Method CheckDefaultValue, addr 0x4321e90, size 0x414, virtual false, abstract: false, final false
...
/// @brief Method CheckForwardRefs, addr 0x432164c, size 0x104, virtual false, abstract: false, final false
inline void CheckForwardRefs() ;

/// @brief Method CheckValue, addr 0x4320e1c, size 0x570, virtual false, abstract: false, final false
inline void CheckValue(::StringW  value, ::System::Xml::Schema::SchemaAttDef*  attdef) ;

/// @brief Method CompleteValidation, addr 0x4321560, size 0x48, virtual true, abstract: false, final false
inline void CompleteValidation() ;

/// @brief Method FindId, addr 0x4321a2c, size 0x1c, virtual true, abstract: false, final false
inline ::System::Object* FindId(::StringW  name) ;

/// @brief Method GenEntity, addr 0x4320478, size 0x154, virtual false, abstract: false, final false
inline bool GenEntity(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method GetEntity, addr 0x4321a48, size 0x94, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaEntity* GetEntity(::System::Xml::XmlQualifiedName*  qname, bool  fParameterEntity) ;

/// @brief Method Init, addr 0x431fe20, size 0x130, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method MeetsStandAloneConstraint, addr 0x4320328, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method Pop, addr 0x43215a8, size 0xa4, virtual false, abstract: false, final false
inline bool Pop() ;

/// @brief Method ProcessElement, addr 0x43208b4, size 0x10c, virtual false, abstract: false, final false
inline void ProcessElement() ;

/// @brief Method ProcessTokenizedType, addr 0x4321788, size 0x214, virtual false, abstract: false, final false
inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType  ttype, ::StringW  name) ;

/// @brief Method Push, addr 0x431ff50, size 0xd8, virtual false, abstract: false, final false
inline void Push(::System::Xml::XmlQualifiedName*  elementName) ;

/// @brief Method SetDefaultTypedValue, addr 0x4321adc, size 0x3b4, virtual false, abstract: false, final false
static inline void SetDefaultTypedValue(::System::Xml::Schema::SchemaAttDef*  attdef, ::System::Xml::IDtdParserAdapter*  readerAdapter) ;

/// @brief Method Validate, addr 0x4320028, size 0x1f8, virtual true, abstract: false, final false
inline void Validate() ;

/// @brief Method ValidateChildElement, addr 0x4320770, size 0x144, virtual false, abstract: false, final false
inline void ValidateChildElement() ;

/// @brief Method ValidateElement, addr 0x4320220, size 0x108, virtual false, abstract: false, final false
inline void ValidateElement() ;

/// @brief Method ValidateEndElement, addr 0x43205cc, size 0x1a4, virtual false, abstract: false, final false
inline void ValidateEndElement() ;

/// @brief Method ValidateEndStartElement, addr 0x432138c, size 0x1d4, virtual false, abstract: false, final false
inline void ValidateEndStartElement() ;

/// @brief Method ValidatePIComment, addr 0x43203c8, size 0xb0, virtual false, abstract: false, final false
inline void ValidatePIComment() ;

/// @brief Method ValidateStartElement, addr 0x43209c0, size 0x45c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x431fd80, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_PreserveWhitespace, addr 0x4321750, size 0x38, virtual true, abstract: false, final false
