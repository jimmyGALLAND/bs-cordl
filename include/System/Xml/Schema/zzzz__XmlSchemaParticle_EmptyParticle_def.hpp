...
/// @brief Method .ctor, addr 0x422f9e0, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsEmpty, addr 0x422fa34, size 0x8, virtual true, abstract: false, final false
