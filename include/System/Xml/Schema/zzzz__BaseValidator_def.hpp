...
/// @brief Method CompleteValidation, addr 0x4304f70, size 0x4, virtual true, abstract: false, final false
inline void CompleteValidation() ;

/// @brief Method CreateInstance, addr 0x4305c54, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method FindId, addr 0x4304f74, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ProcessEntity, addr 0x4305a60, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method ProcessEntity, addr 0x43058a0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method SaveTextValue, addr 0x43053bc, size 0x74, virtual false, abstract: false, final false
inline void SaveTextValue(::StringW  value) ;

/// @brief Method SendValidationEvent, addr 0x430556c, size 0x60, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code) ;

/// @brief Method SendValidationEvent, addr 0x43051ec, size 0xe8, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::StringW  arg) ;

/// @brief Method SendValidationEvent, addr 0x43052d4, size 0xe8, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::ArrayW<::StringW,::Array<::StringW>*>  args) ;

/// @brief Method SendValidationEvent, addr 0x43057ac, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method SendValidationEvent, addr 0x43056b8, size 0xf4, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::StringW  msg, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method SendValidationEvent, addr 0x43055cc, size 0x8, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException*  e) ;

/// @brief Method SendValidationEvent, addr 0x43055d4, size 0xe4, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException*  e, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method Validate, addr 0x4304f6c, size 0x4, virtual true, abstract: false, final false
inline void Validate() ;

/// @brief Method ValidateText, addr 0x4304f7c, size 0x270, virtual false, abstract: false, final false
inline void ValidateText() ;

/// @brief Method ValidateWhitespace, addr 0x4305430, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4304d00, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::BaseValidator*  other) ;

/// @brief Method .ctor, addr 0x430381c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_BaseUri, addr 0x4304da4, size 0x8, virtual false, abstract: false, final false
inline ::System::Uri* get_BaseUri() ;

/// @brief Method get_EventHandler, addr 0x4304db4, size 0xd0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::ValidationEventHandler* get_EventHandler() ;

/// @brief Method get_NameTable, addr 0x4304d84, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_PositionInfo, addr 0x4304d8c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::PositionInfo* get_PositionInfo() ;

/// @brief Method get_PreserveWhitespace, addr 0x4304f64, size 0x8, virtual true, abstract: false, final false
inline bool get_PreserveWhitespace() ;

/// @brief Method get_Reader, addr 0x4304d74, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlValidatingReaderImpl* get_Reader() ;

/// @brief Method get_SchemaCollection, addr 0x4304d7c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaCollection* get_SchemaCollection() ;

/// @brief Method get_SchemaInfo, addr 0x4304e84, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaInfo* get_SchemaInfo() ;

/// @brief Method get_SchemaNames, addr 0x4303d00, size 0x8c, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaNames* get_SchemaNames() ;

/// @brief Method get_XmlResolver, addr 0x4304d94, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlResolver* get_XmlResolver() ;

/// @brief Method set_BaseUri, addr 0x4304dac, size 0x8, virtual false, abstract: false, final false
inline void set_BaseUri(::System::Uri*  value) ;

/// @brief Method set_DtdInfo, addr 0x4304e8c, size 0xd8, virtual false, abstract: false, final false
inline void set_DtdInfo(::System::Xml::IDtdInfo*  value) ;

/// @brief Method set_XmlResolver, addr 0x4304d9c, size 0x8, virtual false, abstract: false, final false
