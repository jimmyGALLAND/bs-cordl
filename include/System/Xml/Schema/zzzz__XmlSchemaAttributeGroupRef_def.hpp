...
/// @brief Method .ctor, addr 0x42289c4, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_RefName, addr 0x4228924, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_RefName() ;

/// @brief Method set_RefName, addr 0x422892c, size 0x98, virtual false, abstract: false, final false
