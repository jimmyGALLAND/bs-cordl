...
/// @brief Method ConstructPos, addr 0x430ace4, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x430ad0c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsNullable, addr 0x430ad04, size 0x8, virtual true, abstract: false, final false
