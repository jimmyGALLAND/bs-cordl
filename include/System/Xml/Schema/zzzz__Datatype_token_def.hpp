...
/// @brief Method .ctor, addr 0x4313c4c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BuiltInWhitespaceFacet, addr 0x431b4d4, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaWhiteSpace get_BuiltInWhitespaceFacet() ;

/// @brief Method get_TypeCode, addr 0x431b4cc, size 0x8, virtual true, abstract: false, final false
