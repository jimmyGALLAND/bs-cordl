...
/// @brief Method ToString, addr 0x426f1ac, size 0x8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x426f1b4, size 0x42c, virtual false, abstract: false, final false
inline ::StringW ToString(::System::Xml::Schema::__XsdDuration__DurationType  durationType) ;

/// @brief Method ToTimeSpan, addr 0x426eca4, size 0x8, virtual false, abstract: false, final false
inline ::System::TimeSpan ToTimeSpan() ;

/// @brief Method ToTimeSpan, addr 0x426ecac, size 0x48, virtual false, abstract: false, final false
inline ::System::TimeSpan ToTimeSpan(::System::Xml::Schema::__XsdDuration__DurationType  durationType) ;

/// @brief Method TryParse, addr 0x426e524, size 0x738, virtual false, abstract: false, final false
...
/// @brief Method TryParse, addr 0x426f5e0, size 0xc, virtual false, abstract: false, final false
static inline ::System::Exception* TryParse(::StringW  s, ByRef<::System::Xml::Schema::XsdDuration>  result) ;

/// @brief Method TryParseDigits, addr 0x426f5ec, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method TryToTimeSpan, addr 0x426ecf4, size 0x4ac, virtual false, abstract: false, final false
...
/// @brief Method TryToTimeSpan, addr 0x426f1a0, size 0xc, virtual false, abstract: false, final false
inline ::System::Exception* TryToTimeSpan(ByRef<::System::TimeSpan>  result) ;

/// @brief Method .ctor, addr 0x426e174, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x426e4a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  s) ;

/// @brief Method .ctor, addr 0x426e4b0, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  s, ::System::Xml::Schema::__XsdDuration__DurationType  durationType) ;

/// @brief Method .ctor, addr 0x426e2d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::TimeSpan  timeSpan) ;

/// @brief Method .ctor, addr 0x426e2d8, size 0x1d0, virtual false, abstract: false, final false
inline void _ctor(::System::TimeSpan  timeSpan, ::System::Xml::Schema::__XsdDuration__DurationType  durationType) ;

/// @brief Method get_Days, addr 0x426ec84, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Days() ;

/// @brief Method get_Hours, addr 0x426ec8c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Hours() ;

/// @brief Method get_IsNegative, addr 0x426ec68, size 0xc, virtual false, abstract: false, final false
inline bool get_IsNegative() ;

/// @brief Method get_Minutes, addr 0x426ec94, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Minutes() ;

/// @brief Method get_Months, addr 0x426ec7c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Months() ;

/// @brief Method get_Nanoseconds, addr 0x426ec5c, size 0xc, virtual false, abstract: false, final false
inline int32_t get_Nanoseconds() ;

/// @brief Method get_Seconds, addr 0x426ec9c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Seconds() ;

/// @brief Method get_Years, addr 0x426ec74, size 0x8, virtual false, abstract: false, final false
