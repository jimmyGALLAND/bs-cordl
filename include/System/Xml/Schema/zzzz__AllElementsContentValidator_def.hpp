...
/// @brief Method AddElement, addr 0x430ed3c, size 0x148, virtual false, abstract: false, final false
inline bool AddElement(::System::Xml::XmlQualifiedName*  name, ::System::Object*  particle, bool  isEmptiable) ;

/// @brief Method CompleteValidation, addr 0x430f07c, size 0x50, virtual true, abstract: false, final false
inline bool CompleteValidation(::System::Xml::Schema::ValidationState*  context) ;

/// @brief Method ExpectedElements, addr 0x430f0cc, size 0x430, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState*  context, bool  isRequiredOnly) ;

/// @brief Method ExpectedParticles, addr 0x430f4fc, size 0x4d8, virtual true, abstract: false, final false
...
/// @brief Method InitValidation, addr 0x430eea4, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method ValidateElement, addr 0x430ef34, size 0x148, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::BitSet*> const& __cordl_internal_get_isRequired() const;
...
/// @brief Method .ctor, addr 0x430ec34, size 0x108, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::XmlSchemaContentType  contentType, int32_t  size, bool  isEmptiable) ;

/// @brief Method get_IsEmptiable, addr 0x430ee84, size 0x20, virtual true, abstract: false, final false
