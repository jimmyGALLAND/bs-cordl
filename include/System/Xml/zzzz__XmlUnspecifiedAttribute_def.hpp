...
/// @brief Method AppendChild, addr 0x42b8294, size 0x20, virtual true, abstract: false, final false
inline ::System::Xml::XmlNode* AppendChild(::System::Xml::XmlNode*  newChild) ;

/// @brief Method CloneNode, addr 0x42b80e4, size 0x130, virtual true, abstract: false, final false
inline ::System::Xml::XmlNode* CloneNode(bool  deep) ;

/// @brief Method InsertAfter, addr 0x42b8254, size 0x20, virtual true, abstract: false, final false
inline ::System::Xml::XmlNode* InsertAfter(::System::Xml::XmlNode*  newChild, ::System::Xml::XmlNode*  refChild) ;

/// @brief Method InsertBefore, addr 0x42b8234, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method RemoveChild, addr 0x42b8274, size 0x20, virtual true, abstract: false, final false
inline ::System::Xml::XmlNode* RemoveChild(::System::Xml::XmlNode*  oldChild) ;

/// @brief Method SetSpecified, addr 0x42b82c8, size 0xc, virtual false, abstract: false, final false
inline void SetSpecified(bool  f) ;

/// @brief Method WriteTo, addr 0x42b82b4, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42b80d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  prefix, ::StringW  localName, ::StringW  namespaceURI, ::System::Xml::XmlDocument*  doc) ;

/// @brief Method get_Specified, addr 0x42b80dc, size 0x8, virtual true, abstract: false, final false
inline bool get_Specified() ;

/// @brief Method set_InnerText, addr 0x42b8214, size 0x20, virtual true, abstract: false, final false
