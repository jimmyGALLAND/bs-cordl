...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::System::Xml::IDtdParserAdapterWithValidation::*)()>(&::System::Xml::IDtdParserAdapterWithValidation::get_DtdValidation)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Xml::IValidationEventHandling* (::System::Xml::IDtdParserAdapterWithValidation::*)()>(&::System::Xml::IDtdParserAdapterWithValidation::get_ValidationEventHandling)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
