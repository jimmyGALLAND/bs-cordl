...
/// @brief Method CloneNode, addr 0x42a8fc8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method WriteContentTo, addr 0x42a90c0, size 0x4, virtual true, abstract: false, final false
inline void WriteContentTo(::System::Xml::XmlWriter*  w) ;

/// @brief Method WriteTo, addr 0x42a9094, size 0x2c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42a5ecc, size 0xc8, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::StringW  publicId, ::StringW  systemId, ::StringW  internalSubset, ::System::Xml::XmlDocument*  doc) ;

/// @brief Method get_DtdSchemaInfo, addr 0x42a90c4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaInfo* get_DtdSchemaInfo() ;

/// @brief Method get_Entities, addr 0x42a82a0, size 0x68, virtual false, abstract: false, final false
inline ::System::Xml::XmlNamedNodeMap* get_Entities() ;

/// @brief Method get_InternalSubset, addr 0x42a9084, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_InternalSubset() ;

/// @brief Method get_IsReadOnly, addr 0x42a9004, size 0x8, virtual true, abstract: false, final false
inline bool get_IsReadOnly() ;

/// @brief Method get_LocalName, addr 0x42a8fb8, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x42a8fb0, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NodeType, addr 0x42a8fc0, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Notations, addr 0x42a900c, size 0x68, virtual false, abstract: false, final false
inline ::System::Xml::XmlNamedNodeMap* get_Notations() ;

/// @brief Method get_ParseWithNamespaces, addr 0x42a908c, size 0x8, virtual false, abstract: false, final false
inline bool get_ParseWithNamespaces() ;

/// @brief Method get_PublicId, addr 0x42a9074, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_PublicId() ;

/// @brief Method get_SystemId, addr 0x42a907c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SystemId() ;

/// @brief Method set_DtdSchemaInfo, addr 0x42a90cc, size 0x8, virtual false, abstract: false, final false
