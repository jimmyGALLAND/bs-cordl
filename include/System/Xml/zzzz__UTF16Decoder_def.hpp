...
/// @brief Method Convert, addr 0x42cd694, size 0x1cc, virtual true, abstract: false, final false
...
/// @brief Method GetCharCount, addr 0x42cd42c, size 0x10, virtual true, abstract: false, final false
inline int32_t GetCharCount(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count) ;

/// @brief Method GetCharCount, addr 0x42cd43c, size 0xe4, virtual true, abstract: false, final false
inline int32_t GetCharCount(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count, bool  flush) ;

/// @brief Method GetChars, addr 0x42cd520, size 0x174, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42cd3fc, size 0x30, virtual false, abstract: false, final false
