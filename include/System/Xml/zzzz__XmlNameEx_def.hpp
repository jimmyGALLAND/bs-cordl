...
/// @brief Method Equals, addr 0x42af764, size 0x3dc, virtual true, abstract: false, final false
...
/// @brief Method SetIsDefault, addr 0x42af5d4, size 0x20, virtual false, abstract: false, final false
inline void SetIsDefault(bool  value) ;

/// @brief Method SetIsNil, addr 0x42af5f4, size 0x20, virtual false, abstract: false, final false
inline void SetIsNil(bool  value) ;

/// @brief Method SetValidity, addr 0x42af5c0, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42aef68, size 0x3d8, virtual false, abstract: false, final false
...
/// @brief Method get_IsDefault, addr 0x42af644, size 0xc, virtual true, abstract: false, final false
inline bool get_IsDefault() ;

/// @brief Method get_IsNil, addr 0x42af650, size 0xc, virtual true, abstract: false, final false
inline bool get_IsNil() ;

/// @brief Method get_MemberType, addr 0x42af65c, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSimpleType* get_MemberType() ;

/// @brief Method get_SchemaAttribute, addr 0x42af6e8, size 0x7c, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAttribute* get_SchemaAttribute() ;

/// @brief Method get_SchemaElement, addr 0x42af66c, size 0x7c, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaElement* get_SchemaElement() ;

/// @brief Method get_SchemaType, addr 0x42af664, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaType* get_SchemaType() ;

/// @brief Method get_Validity, addr 0x42af614, size 0x30, virtual true, abstract: false, final false
