...
/// @brief Method CloneNode, addr 0x42aa820, size 0x58, virtual true, abstract: false, final false
inline ::System::Xml::XmlNode* CloneNode(bool  deep) ;

/// @brief Method IsValidChildType, addr 0x42aa9d8, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method SetBaseURI, addr 0x42aaa74, size 0x8, virtual false, abstract: false, final false
inline void SetBaseURI(::StringW  inBaseURI) ;

/// @brief Method WriteContentTo, addr 0x42aaa68, size 0x4, virtual true, abstract: false, final false
inline void WriteContentTo(::System::Xml::XmlWriter*  w) ;

/// @brief Method WriteTo, addr 0x42aaa64, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42aa79c, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method get_BaseURI, addr 0x42aaa6c, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_BaseURI() ;

/// @brief Method get_InnerText, addr 0x42aa890, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_InnerText() ;

/// @brief Method get_IsContainer, addr 0x42aa8f0, size 0x8, virtual true, abstract: false, final false
inline bool get_IsContainer() ;

/// @brief Method get_IsReadOnly, addr 0x42aa878, size 0x8, virtual true, abstract: false, final false
inline bool get_IsReadOnly() ;

/// @brief Method get_LastNode, addr 0x42aa8f8, size 0x8c, virtual true, abstract: false, final false
inline ::System::Xml::XmlLinkedNode* get_LastNode() ;

/// @brief Method get_LocalName, addr 0x42aa888, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x42aa880, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NodeType, addr 0x42aa9fc, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_SystemId, addr 0x42aaa04, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SystemId() ;

/// @brief Method set_InnerText, addr 0x42aa898, size 0x58, virtual true, abstract: false, final false
inline void set_InnerText(::StringW  value) ;

/// @brief Method set_InnerXml, addr 0x42aaa0c, size 0x58, virtual true, abstract: false, final false
inline void set_InnerXml(::StringW  value) ;

/// @brief Method set_LastNode, addr 0x42aa9d0, size 0x8, virtual true, abstract: false, final false
