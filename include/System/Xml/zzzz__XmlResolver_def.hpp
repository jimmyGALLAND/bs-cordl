...
/// @brief Method GetEntityAsync, addr 0x42d17ec, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method ResolveUri, addr 0x42d14dc, size 0x1cc, virtual true, abstract: false, final false
inline ::System::Uri* ResolveUri(::System::Uri*  baseUri, ::StringW  relativeUri) ;

/// @brief Method SupportsType, addr 0x42d16a8, size 0x144, virtual true, abstract: false, final false
inline bool SupportsType(::System::Uri*  absoluteUri, ::System::Type*  type) ;

/// @brief Method .ctor, addr 0x42d1824, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
