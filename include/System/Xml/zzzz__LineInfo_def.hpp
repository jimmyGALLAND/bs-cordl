...
public:
// Declarations
/// @brief Method Set, addr 0x42b8dd8, size 0x8, virtual false, abstract: false, final false
inline void Set(int32_t  lineNo, int32_t  linePos) ;

/// @brief Method .ctor, addr 0x42b8dd0, size 0x8, virtual false, abstract: false, final false
