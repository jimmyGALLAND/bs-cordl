...
/// @brief Method .ctor, addr 0x42d6c30, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  method) ;

/// @brief Method get_Method, addr 0x42d6c20, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Method() ;

/// @brief Method set_Method, addr 0x42d6c28, size 0x8, virtual false, abstract: false, final false
