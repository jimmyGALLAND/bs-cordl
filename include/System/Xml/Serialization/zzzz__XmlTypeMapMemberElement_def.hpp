...
/// @brief Method FindElement, addr 0x42f9758, size 0x6fc, virtual false, abstract: false, final false
...
/// @brief Method SetChoice, addr 0x42fe11c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42fe0f0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ChoiceMember, addr 0x42fe0fc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ChoiceMember() ;

/// @brief Method get_ChoiceTypeData, addr 0x42fe10c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::TypeData* get_ChoiceTypeData() ;

/// @brief Method get_ElementInfo, addr 0x42f832c, size 0x64, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfoList* get_ElementInfo() ;

/// @brief Method get_IsXmlTextCollector, addr 0x42fe12c, size 0x8, virtual false, abstract: false, final false
inline bool get_IsXmlTextCollector() ;

/// @brief Method set_ChoiceMember, addr 0x42fe104, size 0x8, virtual false, abstract: false, final false
inline void set_ChoiceMember(::StringW  value) ;

/// @brief Method set_ChoiceTypeData, addr 0x42fe114, size 0x8, virtual false, abstract: false, final false
inline void set_ChoiceTypeData(::System::Xml::Serialization::TypeData*  value) ;

/// @brief Method set_ElementInfo, addr 0x42fe0f4, size 0x8, virtual false, abstract: false, final false
inline void set_ElementInfo(::System::Xml::Serialization::XmlTypeMapElementInfoList*  value) ;

/// @brief Method set_IsXmlTextCollector, addr 0x42fe134, size 0xc, virtual false, abstract: false, final false
