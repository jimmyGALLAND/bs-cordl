...
public:
// Declarations
/// @brief Method Invoke, addr 0x42f1f4c, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42f1e4c, size 0x100, virtual false, abstract: false, final false
