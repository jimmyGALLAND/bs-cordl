...
/// @brief Method .ctor, addr 0x42fe154, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_FlatArrayIndex, addr 0x42fe144, size 0x8, virtual false, abstract: false, final false
inline int32_t get_FlatArrayIndex() ;

/// @brief Method set_FlatArrayIndex, addr 0x42fe14c, size 0x8, virtual false, abstract: false, final false
