...
/// @brief Method .ctor, addr 0x42e7d20, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  methodName) ;

/// @brief Method get_IsAny, addr 0x42e7d50, size 0x8, virtual false, abstract: false, final false
inline bool get_IsAny() ;

/// @brief Method get_MethodName, addr 0x42e7d48, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_MethodName() ;

/// @brief Method set_IsAny, addr 0x42e7d58, size 0xc, virtual false, abstract: false, final false
