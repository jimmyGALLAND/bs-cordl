...
static __declspec(property(get=getStaticF_empty_modifiers, put=setStaticF_empty_modifiers)) ::ArrayW<::System::Reflection::ParameterModifier,::Array<::System::Reflection::ParameterModifier>*>  empty_modifiers;

/// @brief Method CheckSerializableType, addr 0x42d64b4, size 0x2dc, virtual false, abstract: false, final false
static inline void CheckSerializableType(::System::Type*  type, bool  allowPrivateConstructors) ;

/// @brief Method GetRegisteredClrType, addr 0x42d634c, size 0x168, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapping* GetRegisteredClrType(::System::Type*  type, ::StringW  ns) ;

/// @brief Method GetRegisteredSchemaType, addr 0x42d6120, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method RegisterClrType, addr 0x42d61f4, size 0x158, virtual false, abstract: false, final false
inline void RegisterClrType(::System::Xml::Serialization::XmlTypeMapping*  map, ::System::Type*  type, ::StringW  ns) ;

/// @brief Method RegisterSchemaType, addr 0x42d6054, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42d67fc, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;
