...
public:
// Declarations
/// @brief Method AddField, addr 0x42d5d68, size 0x8, virtual false, abstract: false, final false
static inline void AddField(::System::Text::StringBuilder*  sb, int32_t  n, ::StringW  val) ;

/// @brief Method AddField, addr 0x42d5d70, size 0xe4, virtual false, abstract: false, final false
static inline void AddField(::System::Text::StringBuilder*  sb, int32_t  n, ::StringW  val, ::StringW  def) ;

/// @brief Method AddField, addr 0x42d5f68, size 0xec, virtual false, abstract: false, final false
static inline void AddField(::System::Text::StringBuilder*  sb, int32_t  n, ::System::Type*  val) ;

/// @brief Method AddField, addr 0x42d5e54, size 0xc, virtual false, abstract: false, final false
static inline void AddField(::System::Text::StringBuilder*  sb, int32_t  n, bool  val) ;

/// @brief Method AddField, addr 0x42d5e60, size 0x50, virtual false, abstract: false, final false
static inline void AddField(::System::Text::StringBuilder*  sb, int32_t  n, bool  val, bool  def) ;

/// @brief Method AddField, addr 0x42d5eb0, size 0xb8, virtual false, abstract: false, final false
