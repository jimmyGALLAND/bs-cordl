...
static inline ::System::Xml::Serialization::__XmlSerializationWriterInterpreter__CallbackInfo* New_ctor(::System::Xml::Serialization::XmlSerializationWriterInterpreter*  swi, ::System::Xml::Serialization::XmlTypeMapping*  typeMap) ;

/// @brief Method WriteEnum, addr 0x42fbbbc, size 0x50, virtual false, abstract: false, final false
inline void WriteEnum(::System::Object*  ob) ;

/// @brief Method WriteObject, addr 0x42fbb6c, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42f568c, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method GetEnumXmlValue, addr 0x42fb734, size 0xa8, virtual false, abstract: false, final false
inline ::StringW GetEnumXmlValue(::System::Xml::Serialization::XmlTypeMapping*  typeMap, ::System::Object*  ob) ;

/// @brief Method GetListCount, addr 0x42fa804, size 0x128, virtual false, abstract: false, final false
inline int32_t GetListCount(::System::Xml::Serialization::TypeData*  listType, ::System::Object*  ob) ;

/// @brief Method GetMemberValue, addr 0x42f7c08, size 0xc8, virtual false, abstract: false, final false
inline ::System::Object* GetMemberValue(::System::Xml::Serialization::XmlTypeMapMember*  member, ::System::Object*  ob, bool  isValueList) ;

/// @brief Method GetStringValue, addr 0x42f80e4, size 0x248, virtual false, abstract: false, final false
...
/// @brief Method ImplicitConvert, addr 0x42f60d4, size 0x2d8, virtual false, abstract: false, final false
static inline ::System::Object* ImplicitConvert(::System::Object*  obj, ::System::Type*  type) ;

/// @brief Method InitCallbacks, addr 0x42f5270, size 0x41c, virtual true, abstract: false, final false
inline void InitCallbacks() ;

/// @brief Method MemberHasValue, addr 0x42f79e0, size 0x228, virtual false, abstract: false, final false
...
/// @brief Method WriteAnyElementContent, addr 0x42f9100, size 0x658, virtual false, abstract: false, final false
inline void WriteAnyElementContent(::System::Xml::Serialization::XmlTypeMapMemberAnyElement*  member, ::System::Object*  memberValue) ;

/// @brief Method WriteAttributeMembers, addr 0x42f6a80, size 0x760, virtual false, abstract: false, final false
inline void WriteAttributeMembers(::System::Xml::Serialization::ClassMap*  map, ::System::Object*  ob, bool  isValueList) ;

/// @brief Method WriteElementMembers, addr 0x42f7284, size 0x75c, virtual false, abstract: false, final false
inline void WriteElementMembers(::System::Xml::Serialization::ClassMap*  map, ::System::Object*  ob, bool  isValueList) ;

/// @brief Method WriteEnumElement, addr 0x42fb704, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method WriteListContent, addr 0x42f8904, size 0x7fc, virtual false, abstract: false, final false
...
/// @brief Method WriteListElement, addr 0x42fa61c, size 0x1e8, virtual true, abstract: false, final false
...
/// @brief Method WriteMemberElement, addr 0x42f8390, size 0x574, virtual false, abstract: false, final false
inline void WriteMemberElement(::System::Xml::Serialization::XmlTypeMapElementInfo*  elem, ::System::Object*  memberValue) ;

/// @brief Method WriteMembers, addr 0x42f6760, size 0x44, virtual false, abstract: false, final false
inline void WriteMembers(::System::Xml::Serialization::ClassMap*  map, ::System::Object*  ob, bool  isValueList) ;

/// @brief Method WriteMessage, addr 0x42f6570, size 0x1f0, virtual true, abstract: false, final false
...
/// @brief Method WriteObject, addr 0x42f58cc, size 0x808, virtual true, abstract: false, final false
...
/// @brief Method WriteObjectElement, addr 0x42f67a4, size 0x128, virtual true, abstract: false, final false
...
/// @brief Method WriteObjectElementAttributes, addr 0x42f69dc, size 0xa4, virtual true, abstract: false, final false
inline void WriteObjectElementAttributes(::System::Xml::Serialization::XmlTypeMapping*  typeMap, ::System::Object*  ob) ;

/// @brief Method WriteObjectElementElements, addr 0x42f71e0, size 0xa4, virtual true, abstract: false, final false
inline void WriteObjectElementElements(::System::Xml::Serialization::XmlTypeMapping*  typeMap, ::System::Object*  ob) ;

/// @brief Method WritePrimitiveElement, addr 0x42fb6c8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method WritePrimitiveValueEncoded, addr 0x42fa3a0, size 0x27c, virtual false, abstract: false, final false
...
/// @brief Method WritePrimitiveValueLiteral, addr 0x42fa098, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method WriteRoot, addr 0x42f56b8, size 0x214, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42f5238, size 0x38, virtual false, abstract: false, final false
