...
public:
// Declarations
/// @brief Method Invoke, addr 0x42e8020, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42e7f98, size 0x88, virtual false, abstract: false, final false
