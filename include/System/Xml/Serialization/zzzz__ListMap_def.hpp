...
/// @brief Method Equals, addr 0x4301314, size 0x164, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method FindElement, addr 0x4300d0c, size 0x31c, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfo* FindElement(::StringW  elementName, ::StringW  ns) ;

/// @brief Method FindElement, addr 0x42fab34, size 0x860, virtual false, abstract: false, final false
...
/// @brief Method FindTextElement, addr 0x4301028, size 0x2ec, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfo* FindTextElement() ;

/// @brief Method GetArrayType, addr 0x42fa92c, size 0x208, virtual false, abstract: false, final false
inline void GetArrayType(int32_t  itemCount, ByRef<::StringW>  localName, ByRef<::StringW>  ns) ;

/// @brief Method GetHashCode, addr 0x4301478, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4301480, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ItemInfo, addr 0x4300cfc, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfoList* get_ItemInfo() ;

/// @brief Method set_ChoiceMember, addr 0x4300cf4, size 0x8, virtual false, abstract: false, final false
inline void set_ChoiceMember(::StringW  value) ;

/// @brief Method set_ItemInfo, addr 0x4300d04, size 0x8, virtual false, abstract: false, final false
