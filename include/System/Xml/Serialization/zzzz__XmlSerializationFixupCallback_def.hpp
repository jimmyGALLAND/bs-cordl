...
public:
// Declarations
/// @brief Method Invoke, addr 0x42e7f7c, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42e7e7c, size 0x100, virtual false, abstract: false, final false
