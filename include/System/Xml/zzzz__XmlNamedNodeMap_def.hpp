...
/// @brief Method MoveNext, addr 0x42b0ae4, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x42b0b00, size 0xc, virtual true, abstract: false, final true
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x42b0a68, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  value) ;

/// @brief Method get_Current, addr 0x42b0a98, size 0x4c, virtual true, abstract: false, final true
...
/// @brief Method Add, addr 0x42b0324, size 0x11c, virtual false, abstract: false, final false
inline void Add(::System::Object*  value) ;

/// @brief Method GetEnumerator, addr 0x42b00a8, size 0xf8, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method Insert, addr 0x42b08c8, size 0x1a0, virtual false, abstract: false, final false
inline void Insert(int32_t  index, ::System::Object*  value) ;

/// @brief Method RemoveAt, addr 0x42b0650, size 0xe0, virtual false, abstract: false, final false
inline void RemoveAt(int32_t  index) ;

/// @brief Method get_Count, addr 0x42afffc, size 0xa4, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Item, addr 0x42afce4, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method AddNode, addr 0x42b01a0, size 0x184, virtual true, abstract: false, final false
inline ::System::Xml::XmlNode* AddNode(::System::Xml::XmlNode*  node) ;

/// @brief Method AddNodeForLoad, addr 0x42b0440, size 0xa8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNode* AddNodeForLoad(::System::Xml::XmlNode*  node, ::System::Xml::XmlDocument*  doc) ;

/// @brief Method FindNodeOffset, addr 0x42afe7c, size 0x124, virtual false, abstract: false, final false
inline int32_t FindNodeOffset(::StringW  localName, ::StringW  namespaceURI) ;

/// @brief Method FindNodeOffset, addr 0x42afc00, size 0xe4, virtual false, abstract: false, final false
inline int32_t FindNodeOffset(::StringW  name) ;

/// @brief Method GetEnumerator, addr 0x42b00a0, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method GetNamedItem, addr 0x42afb68, size 0x98, virtual true, abstract: false, final false
inline ::System::Xml::XmlNode* GetNamedItem(::StringW  name) ;

/// @brief Method InsertNodeAt, addr 0x42b0730, size 0x198, virtual true, abstract: false, final false
...
/// @brief Method RemoveNodeAt, addr 0x42b04e8, size 0x168, virtual true, abstract: false, final false
inline ::System::Xml::XmlNode* RemoveNodeAt(int32_t  i) ;

/// @brief Method ReplaceNodeAt, addr 0x42affa0, size 0x54, virtual false, abstract: false, final false
inline ::System::Xml::XmlNode* ReplaceNodeAt(int32_t  i, ::System::Xml::XmlNode*  node) ;

/// @brief Method SetNamedItem, addr 0x42afdc0, size 0xbc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42afb40, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNode*  parent) ;

/// @brief Method get_Count, addr 0x42afff4, size 0x8, virtual true, abstract: false, final false
inline int32_t get_Count() ;
