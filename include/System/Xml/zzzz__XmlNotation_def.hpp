...
/// @brief Method CloneNode, addr 0x42b7930, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method WriteContentTo, addr 0x42b79ec, size 0x4, virtual true, abstract: false, final false
inline void WriteContentTo(::System::Xml::XmlWriter*  w) ;

/// @brief Method WriteTo, addr 0x42b79e8, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42b78b0, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::StringW  publicId, ::StringW  systemId, ::System::Xml::XmlDocument*  doc) ;

/// @brief Method get_IsReadOnly, addr 0x42b7988, size 0x8, virtual true, abstract: false, final false
inline bool get_IsReadOnly() ;

/// @brief Method get_LocalName, addr 0x42b7920, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x42b7918, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NodeType, addr 0x42b7928, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method set_InnerXml, addr 0x42b7990, size 0x58, virtual true, abstract: false, final false
