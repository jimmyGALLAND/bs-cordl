...
/// @brief Method FlushBuffer, addr 0x4279720, size 0x2c, virtual true, abstract: false, final false
inline void FlushBuffer() ;

/// @brief Method Init, addr 0x4279228, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method StartElementContent, addr 0x4279594, size 0x78, virtual true, abstract: false, final false
inline void StartElementContent() ;

/// @brief Method WriteDocType, addr 0x4279250, size 0x20, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteEndElement, addr 0x427960c, size 0x9c, virtual true, abstract: false, final false
inline void WriteEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteIndent, addr 0x4279544, size 0x50, virtual false, abstract: false, final false
inline void WriteIndent() ;

/// @brief Method WriteStartAttribute, addr 0x42796a8, size 0x78, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartElement, addr 0x4279270, size 0x1a8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42791e8, size 0x40, virtual false, abstract: false, final false
