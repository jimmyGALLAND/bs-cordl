...
/// @brief Method Decode, addr 0x4279870, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4279878, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsFull, addr 0x4279868, size 0x8, virtual true, abstract: false, final false
