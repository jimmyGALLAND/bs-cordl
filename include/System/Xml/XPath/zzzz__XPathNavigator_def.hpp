...
/// @brief Method GetNamespacesInScope, addr 0x42d446c, size 0x21c, virtual true, abstract: false, final false
...
/// @brief Method IsText, addr 0x42d4778, size 0x10, virtual false, abstract: false, final false
static inline bool IsText(::System::Xml::XPath::XPathNodeType  type) ;

/// @brief Method LookupNamespace, addr 0x42d40d8, size 0x1a4, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x42d427c, size 0x1f0, virtual true, abstract: false, final false
...
/// @brief Method MoveToNamespace, addr 0x42d4690, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method System.ICloneable.Clone, addr 0x42d40c8, size 0x10, virtual true, abstract: false, final true
inline ::System::Object* System_ICloneable_Clone() ;

/// @brief Method ToString, addr 0x42d296c, size 0xc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ValueAs, addr 0x42d3ddc, size 0x2ec, virtual true, abstract: false, final false
inline ::System::Object* ValueAs(::System::Type*  returnType, ::System::Xml::IXmlNamespaceResolver*  nsResolver) ;

/// @brief Method .ctor, addr 0x42d4788, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_SchemaInfo, addr 0x42d4730, size 0x48, virtual true, abstract: false, final false
inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo() ;

/// @brief Method get_TypedValue, addr 0x42d2b00, size 0x2dc, virtual true, abstract: false, final false
inline ::System::Object* get_TypedValue() ;

/// @brief Method get_UnderlyingObject, addr 0x42d4688, size 0x8, virtual true, abstract: false, final false
inline ::System::Object* get_UnderlyingObject() ;

/// @brief Method get_ValueAsBoolean, addr 0x42d2fe8, size 0x2c4, virtual true, abstract: false, final false
inline bool get_ValueAsBoolean() ;

/// @brief Method get_ValueAsDateTime, addr 0x42d32ac, size 0x2cc, virtual true, abstract: false, final false
inline ::System::DateTime get_ValueAsDateTime() ;

/// @brief Method get_ValueAsDouble, addr 0x42d3578, size 0x2cc, virtual true, abstract: false, final false
inline double_t get_ValueAsDouble() ;

/// @brief Method get_ValueAsInt, addr 0x42d3844, size 0x2cc, virtual true, abstract: false, final false
inline int32_t get_ValueAsInt() ;

/// @brief Method get_ValueAsLong, addr 0x42d3b10, size 0x2cc, virtual true, abstract: false, final false
inline int64_t get_ValueAsLong() ;

/// @brief Method get_ValueType, addr 0x42d2ddc, size 0x20c, virtual true, abstract: false, final false
inline ::System::Type* get_ValueType() ;

/// @brief Method get_XmlType, addr 0x42d2978, size 0x188, virtual true, abstract: false, final false
