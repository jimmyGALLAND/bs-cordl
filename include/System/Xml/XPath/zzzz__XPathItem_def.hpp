...
/// @brief Method ValueAs, addr 0x42d2950, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x42d2964, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
