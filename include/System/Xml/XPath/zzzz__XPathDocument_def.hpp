...
/// @brief Method GetXmlNamespaceNode, addr 0x42d1fe0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method LookupNamespaces, addr 0x42d1ff0, size 0xd0, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::MS::Internal::Xml::Cache::XPathNodeRef,::MS::Internal::Xml::Cache::XPathNodeRef>*> const& __cordl_internal_get_mapNmsp() const;
...
/// @brief Method get_HasLineInfo, addr 0x42d1fd8, size 0x8, virtual false, abstract: false, final false
inline bool get_HasLineInfo() ;

/// @brief Method get_NameTable, addr 0x42d1fd0, size 0x8, virtual false, abstract: false, final false
