...
public:
// Declarations
/// @brief Method CheckPrefixNS, addr 0x41ac7ac, size 0xf8, virtual false, abstract: false, final false
inline void CheckPrefixNS(::StringW  prefix, ::StringW  namespaceUri) ;

/// @brief Method Clear, addr 0x41a7c98, size 0x54, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Equals, addr 0x41afb14, size 0xb0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method GetHashCode, addr 0x41afa80, size 0x48, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetNSHashCode, addr 0x41afac8, size 0x4c, virtual false, abstract: false, final false
inline int32_t GetNSHashCode(::System::Xml::SecureStringHasher*  hasher) ;

/// @brief Method MatchNs, addr 0x41ac3c8, size 0x50, virtual false, abstract: false, final false
inline bool MatchNs(::StringW  lname, ::StringW  nsUri) ;

/// @brief Method MatchPrefix, addr 0x41ac418, size 0x50, virtual false, abstract: false, final false
inline bool MatchPrefix(::StringW  prefix, ::StringW  lname) ;

/// @brief Method Set, addr 0x41ab934, size 0xc, virtual false, abstract: false, final false
inline void Set(::StringW  prefix, ::StringW  lname, ::StringW  nsUri) ;

/// @brief Method ToString, addr 0x41ad584, size 0x70, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x41aca74, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  prefix, ::StringW  lname, ::StringW  nsUri) ;

/// @brief Method op_Equality, addr 0x41afbc4, size 0x60, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method Clear, addr 0x41ad734, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::__XmlSqlBinaryReader__NamespaceDecl* Clear() ;

/// @brief Method Set, addr 0x41ae38c, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "name", ty: "::System::Xml::__XmlSqlBinaryReader__QName", modifiers: "", def_value: None }, CppParam { name: "xmlLang", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "xmlSpace", ty: "::System::Xml::XmlSpace", modifiers: "", def_value: None }, CppParam { name: "xmlspacePreserve", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "nsdecls", ty: "::System::Xml::__XmlSqlBinaryReader__NamespaceDecl*", modifiers: "", def_value: None }]
constexpr __XmlSqlBinaryReader__ElemInfo(::System::Xml::__XmlSqlBinaryReader__QName  name, ::StringW  xmlLang, ::System::Xml::XmlSpace  xmlSpace, bool  xmlspacePreserve, ::System::Xml::__XmlSqlBinaryReader__NamespaceDecl*  nsdecls) noexcept;
...
public:
// Declarations
/// @brief Method AdjustPosition, addr 0x41abd10, size 0x14, virtual false, abstract: false, final false
inline void AdjustPosition(int32_t  adj) ;

/// @brief Method GetLocalnameAndNamespaceUri, addr 0x41ad56c, size 0x14, virtual false, abstract: false, final false
inline void GetLocalnameAndNamespaceUri(ByRef<::StringW>  localname, ByRef<::StringW>  namespaceUri) ;

/// @brief Method GetLocalnameAndNamespaceUriAndHash, addr 0x41ad5f4, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method MatchHashNS, addr 0x41ad61c, size 0x20, virtual false, abstract: false, final false
inline bool MatchHashNS(int32_t  hash, ::StringW  localname, ::StringW  namespaceUri) ;

/// @brief Method MatchNS, addr 0x41ad580, size 0x4, virtual false, abstract: false, final false
inline bool MatchNS(::StringW  localname, ::StringW  namespaceUri) ;

/// @brief Method Set, addr 0x41acf50, size 0x1c, virtual false, abstract: false, final false
inline void Set(::System::Xml::__XmlSqlBinaryReader__QName  n, int32_t  pos) ;

/// @brief Method Set, addr 0x41aca80, size 0x1c, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "name", ty: "::System::Xml::__XmlSqlBinaryReader__QName", modifiers: "", def_value: None }, CppParam { name: "val", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "contentPos", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "hashCode", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "prevHash", ty: "int32_t", modifiers: "", def_value: None }]
...
static inline ::System::Xml::__XmlSqlBinaryReader__NamespaceDecl* New_ctor(::StringW  prefix, ::StringW  nsuri, ::System::Xml::__XmlSqlBinaryReader__NamespaceDecl*  nextInScope, ::System::Xml::__XmlSqlBinaryReader__NamespaceDecl*  prevDecl, int32_t  scope, bool  implied) ;
...
/// @brief Method .ctor, addr 0x41ab408, size 0x58, virtual false, abstract: false, final false
inline void _ctor(::StringW  prefix, ::StringW  nsuri, ::System::Xml::__XmlSqlBinaryReader__NamespaceDecl*  nextInScope, ::System::Xml::__XmlSqlBinaryReader__NamespaceDecl*  prevDecl, int32_t  scope, bool  implied) ;
...
public:
// Declarations
/// @brief Method Init, addr 0x41a7bd4, size 0xc4, virtual false, abstract: false, final false
inline void Init() ;
...
// Ctor Parameters [CppParam { name: "symtable", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }, CppParam { name: "symCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "qnametable", ty: "::ArrayW<::System::Xml::__XmlSqlBinaryReader__QName,::Array<::System::Xml::__XmlSqlBinaryReader__QName>*>", modifiers: "", def_value: None }, CppParam { name: "qnameCount", ty: "int32_t", modifiers: "", def_value: None }]
constexpr __XmlSqlBinaryReader__SymbolTables(::ArrayW<::StringW,::Array<::StringW>*>  symtable, int32_t  symCount, ::ArrayW<::System::Xml::__XmlSqlBinaryReader__QName,::Array<::System::Xml::__XmlSqlBinaryReader__QName>*>  qnametable, int32_t  qnameCount) noexcept;
...
static inline ::System::Xml::__XmlSqlBinaryReader__NestedBinXml* New_ctor(::System::Xml::__XmlSqlBinaryReader__SymbolTables  symbolTables, int32_t  docState, ::System::Xml::__XmlSqlBinaryReader__NestedBinXml*  next) ;
...
/// @brief Method .ctor, addr 0x41ae3ac, size 0x44, virtual false, abstract: false, final false
...
// SizeInfo { instance_size: 360, native_size: -1, calculated_instance_size: 360, calculated_native_size: 353, minimum_alignment: 8, packing: None, specified_packing: None }
namespace System::Xml {
// Is value type: false
...
static __declspec(property(get=getStaticF_XsdKatmaiTimeScaleToValueLengthMap, put=setStaticF_XsdKatmaiTimeScaleToValueLengthMap)) ::ArrayW<uint8_t,::Array<uint8_t>*>  XsdKatmaiTimeScaleToValueLengthMap;
...
/// @brief Field attributes, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get_attributes, put=__cordl_internal_set_attributes)) ::ArrayW<::System::Xml::__XmlSqlBinaryReader__AttrInfo,::Array<::System::Xml::__XmlSqlBinaryReader__AttrInfo>*>  attributes;
...
/// @brief Field elementStack, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get_elementStack, put=__cordl_internal_set_elementStack)) ::ArrayW<::System::Xml::__XmlSqlBinaryReader__ElemInfo,::Array<::System::Xml::__XmlSqlBinaryReader__ElemInfo>*>  elementStack;
...
/// @brief Field namespaces, offset 0x120, size 0x8 
 __declspec(property(get=__cordl_internal_get_namespaces, put=__cordl_internal_set_namespaces)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Xml::__XmlSqlBinaryReader__NamespaceDecl*>*  namespaces;
...
/// @brief Method AddInitNamespace, addr 0x41a7cec, size 0xd4, virtual false, abstract: false, final false
inline void AddInitNamespace(::StringW  prefix, ::StringW  uri) ;

/// @brief Method AddName, addr 0x41ab460, size 0x10c, virtual false, abstract: false, final false
inline void AddName() ;

/// @brief Method AddQName, addr 0x41ab630, size 0x278, virtual false, abstract: false, final false
inline void AddQName() ;

/// @brief Method CDATAValue, addr 0x41a8c0c, size 0x104, virtual false, abstract: false, final false
inline ::StringW CDATAValue() ;

/// @brief Method CheckAllowContent, addr 0x41ae324, size 0x68, virtual false, abstract: false, final false
inline void CheckAllowContent() ;

/// @brief Method CheckText, addr 0x41ae498, size 0x1c4, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType CheckText(bool  attr) ;

/// @brief Method CheckTextIsWS, addr 0x41ae65c, size 0x98, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType CheckTextIsWS() ;

/// @brief Method CheckValueTokenBounds, addr 0x41aeaf0, size 0x60, virtual false, abstract: false, final false
inline void CheckValueTokenBounds() ;

/// @brief Method ClearAttributes, addr 0x41ac574, size 0x10, virtual false, abstract: false, final false
inline void ClearAttributes() ;

/// @brief Method Close, addr 0x41aa374, size 0x6c, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Fill, addr 0x41aba48, size 0x1c, virtual false, abstract: false, final false
inline void Fill(int32_t  require) ;

/// @brief Method FillAllowEOF, addr 0x41abaf0, size 0x220, virtual false, abstract: false, final false
inline bool FillAllowEOF() ;

/// @brief Method Fill_, addr 0x41abd24, size 0x78, virtual false, abstract: false, final false
inline void Fill_(int32_t  require) ;

/// @brief Method FinishCDATA, addr 0x41ad63c, size 0xa4, virtual false, abstract: false, final false
inline void FinishCDATA() ;

/// @brief Method FinishEndElement, addr 0x41ad6e0, size 0x54, virtual false, abstract: false, final false
inline void FinishEndElement() ;

/// @brief Method GenerateImpliedXmlnsAttrs, addr 0x41ac948, size 0x12c, virtual false, abstract: false, final false
inline void GenerateImpliedXmlnsAttrs() ;

/// @brief Method GenerateTokenTypeMap, addr 0x41a7dc0, size 0xa90, virtual false, abstract: false, final false
inline void GenerateTokenTypeMap() ;

/// @brief Method GetAttribute, addr 0x41a9bbc, size 0x90, virtual true, abstract: false, final false
inline ::StringW GetAttribute(int32_t  i) ;

/// @brief Method GetAttribute, addr 0x41a9a70, size 0x6c, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name) ;

/// @brief Method GetAttribute, addr 0x41a98c0, size 0x128, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name, ::StringW  ns) ;

/// @brief Method GetAttributeText, addr 0x41a9530, size 0x124, virtual false, abstract: false, final false
inline ::StringW GetAttributeText(int32_t  i) ;

/// @brief Method GetDouble, addr 0x41af50c, size 0xd4, virtual false, abstract: false, final false
inline double_t GetDouble(int32_t  offset) ;

/// @brief Method GetInt16, addr 0x41aee1c, size 0x44, virtual false, abstract: false, final false
inline int16_t GetInt16(int32_t  pos) ;

/// @brief Method GetInt32, addr 0x41aee60, size 0x74, virtual false, abstract: false, final false
inline int32_t GetInt32(int32_t  pos) ;

/// @brief Method GetInt64, addr 0x41aeed4, size 0xd0, virtual false, abstract: false, final false
inline int64_t GetInt64(int32_t  pos) ;

/// @brief Method GetSingle, addr 0x41af494, size 0x78, virtual false, abstract: false, final false
inline float_t GetSingle(int32_t  offset) ;

/// @brief Method GetString, addr 0x41a8aa0, size 0x16c, virtual false, abstract: false, final false
inline ::StringW GetString(int32_t  pos, int32_t  cch) ;

/// @brief Method GetStringAligned, addr 0x41ac39c, size 0x2c, virtual false, abstract: false, final false
inline ::StringW GetStringAligned(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset, int32_t  cch) ;

/// @brief Method GetUInt16, addr 0x41aefa4, size 0x44, virtual false, abstract: false, final false
inline uint16_t GetUInt16(int32_t  pos) ;

/// @brief Method GetUInt32, addr 0x41aefe8, size 0x74, virtual false, abstract: false, final false
inline uint32_t GetUInt32(int32_t  pos) ;

/// @brief Method GetUInt64, addr 0x41af05c, size 0xd0, virtual false, abstract: false, final false
inline uint64_t GetUInt64(int32_t  pos) ;

/// @brief Method GetValueType, addr 0x41aa288, size 0xec, virtual false, abstract: false, final false
inline ::System::Type* GetValueType(::System::Xml::BinXmlToken  token) ;

/// @brief Method GetXsdKatmaiTokenLength, addr 0x41aea08, size 0xe8, virtual false, abstract: false, final false
inline int32_t GetXsdKatmaiTokenLength(::System::Xml::BinXmlToken  token) ;

/// @brief Method GrowAttributes, addr 0x41ac4f0, size 0x84, virtual false, abstract: false, final false
inline void GrowAttributes() ;

/// @brief Method GrowElements, addr 0x41ac468, size 0x88, virtual false, abstract: false, final false
inline void GrowElements() ;

/// @brief Method HashCheckForDuplicateAttributes, addr 0x41ad330, size 0x23c, virtual false, abstract: false, final false
inline void HashCheckForDuplicateAttributes() ;

/// @brief Method ImplReadCDATA, addr 0x41add50, size 0x34, virtual false, abstract: false, final false
inline void ImplReadCDATA() ;

/// @brief Method ImplReadComment, addr 0x41add24, size 0x2c, virtual false, abstract: false, final false
inline void ImplReadComment() ;

/// @brief Method ImplReadData, addr 0x41ae1b8, size 0x16c, virtual false, abstract: false, final false
inline void ImplReadData(::System::Xml::BinXmlToken  tokenType) ;

/// @brief Method ImplReadDoctype, addr 0x41ada54, size 0x26c, virtual false, abstract: false, final false
inline void ImplReadDoctype() ;

/// @brief Method ImplReadElement, addr 0x41ad744, size 0x248, virtual false, abstract: false, final false
inline void ImplReadElement() ;

/// @brief Method ImplReadEndElement, addr 0x41ad98c, size 0xc8, virtual false, abstract: false, final false
inline void ImplReadEndElement() ;

/// @brief Method ImplReadEndNest, addr 0x41ade24, size 0x30, virtual false, abstract: false, final false
inline void ImplReadEndNest() ;

/// @brief Method ImplReadNest, addr 0x41add84, size 0xa0, virtual false, abstract: false, final false
inline void ImplReadNest() ;

/// @brief Method ImplReadPI, addr 0x41adcc0, size 0x64, virtual false, abstract: false, final false
inline void ImplReadPI() ;

/// @brief Method ImplReadXmlText, addr 0x41ade54, size 0x364, virtual false, abstract: false, final false
inline void ImplReadXmlText() ;

/// @brief Method LocateAttribute, addr 0x41a9adc, size 0xe0, virtual false, abstract: false, final false
inline int32_t LocateAttribute(::StringW  name) ;

/// @brief Method LocateAttribute, addr 0x41a99e8, size 0x88, virtual false, abstract: false, final false
inline int32_t LocateAttribute(::StringW  name, ::StringW  ns) ;

/// @brief Method LookupNamespace, addr 0x41aa3e8, size 0xb4, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method MoveToAttribute, addr 0x41a9c4c, size 0x7c, virtual true, abstract: false, final false
inline bool MoveToAttribute(::StringW  name) ;

/// @brief Method MoveToAttribute, addr 0x41a9da4, size 0xa4, virtual true, abstract: false, final false
inline void MoveToAttribute(int32_t  i) ;

/// @brief Method MoveToElement, addr 0x41a9f44, size 0xb8, virtual true, abstract: false, final false
inline bool MoveToElement() ;

/// @brief Method MoveToFirstAttribute, addr 0x41a9e48, size 0x78, virtual true, abstract: false, final false
inline bool MoveToFirstAttribute() ;

/// @brief Method MoveToNextAttribute, addr 0x41a9ec0, size 0x84, virtual true, abstract: false, final false
inline bool MoveToNextAttribute() ;

/// @brief Method NameFlush, addr 0x41ab940, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method NextToken, addr 0x41ac258, size 0x64, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken NextToken() ;

/// @brief Method NextToken1, addr 0x41ac1e0, size 0x78, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken NextToken1() ;

/// @brief Method NextToken2, addr 0x41ac168, size 0x78, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken NextToken2(::System::Xml::BinXmlToken  token) ;

/// @brief Method ParseMB32, addr 0x41aba1c, size 0x2c, virtual false, abstract: false, final false
inline int32_t ParseMB32() ;

/// @brief Method ParseMB32, addr 0x41abf78, size 0xec, virtual false, abstract: false, final false
inline int32_t ParseMB32(int32_t  pos) ;

/// @brief Method ParseMB32_, addr 0x41abee0, size 0x98, virtual false, abstract: false, final false
inline int32_t ParseMB32_(uint8_t  b) ;

/// @brief Method ParseMB64, addr 0x41ac064, size 0x2c, virtual false, abstract: false, final false
inline int32_t ParseMB64() ;

/// @brief Method ParseText, addr 0x41ab56c, size 0xc4, virtual false, abstract: false, final false
inline ::StringW ParseText() ;

/// @brief Method PeekNextToken, addr 0x41ac2bc, size 0x28, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken PeekNextToken() ;

/// @brief Method PeekToken, addr 0x41ac090, size 0x68, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken PeekToken() ;

/// @brief Method PopNamespaces, addr 0x41ac8a4, size 0xa4, virtual false, abstract: false, final false
inline void PopNamespaces(::System::Xml::__XmlSqlBinaryReader__NamespaceDecl*  firstInScopeChain) ;

/// @brief Method PositionOnAttribute, addr 0x41a9ce4, size 0xc0, virtual false, abstract: false, final false
inline void PositionOnAttribute(int32_t  i) ;

/// @brief Method PushNamespace, addr 0x41ac584, size 0x228, virtual false, abstract: false, final false
inline void PushNamespace(::StringW  prefix, ::StringW  ns, bool  implied) ;

/// @brief Method ReScanOverValue, addr 0x41aa27c, size 0xc, virtual false, abstract: false, final false
inline void ReScanOverValue(::System::Xml::BinXmlToken  token) ;

/// @brief Method Read, addr 0x41aa554, size 0x1c8, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method ReadAttributeValue, addr 0x41aa00c, size 0x188, virtual true, abstract: false, final false
inline bool ReadAttributeValue() ;

/// @brief Method ReadByte, addr 0x41abe10, size 0x5c, virtual false, abstract: false, final false
inline uint8_t ReadByte() ;

/// @brief Method ReadDoc, addr 0x41aaad8, size 0x36c, virtual false, abstract: false, final false
inline bool ReadDoc() ;

/// @brief Method ReadInit, addr 0x41aa71c, size 0x3bc, virtual false, abstract: false, final false
inline bool ReadInit(bool  skipXmlDecl) ;

/// @brief Method ReadNameRef, addr 0x41ab8a8, size 0x8c, virtual false, abstract: false, final false
inline int32_t ReadNameRef() ;

/// @brief Method ReadQNameRef, addr 0x41aba64, size 0x8c, virtual false, abstract: false, final false
inline int32_t ReadQNameRef() ;

/// @brief Method ReadToken, addr 0x41ac0f8, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken ReadToken() ;

/// @brief Method ReadUShort, addr 0x41abe6c, size 0x74, virtual false, abstract: false, final false
inline uint16_t ReadUShort() ;

/// @brief Method RescanNextToken, addr 0x41aa194, size 0xe8, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken RescanNextToken() ;

/// @brief Method ResolveEntity, addr 0x41aa49c, size 0x38, virtual true, abstract: false, final false
inline void ResolveEntity() ;

/// @brief Method ScanAttributes, addr 0x41aca9c, size 0x4b4, virtual false, abstract: false, final false
inline void ScanAttributes() ;

/// @brief Method ScanOverAnyValue, addr 0x41ae6f4, size 0x314, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType ScanOverAnyValue(::System::Xml::BinXmlToken  token, bool  attr, bool  checkChars) ;

/// @brief Method ScanOverValue, addr 0x41ad038, size 0x128, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType ScanOverValue(::System::Xml::BinXmlToken  token, bool  attr, bool  checkChars) ;

/// @brief Method ScanText, addr 0x41ac2e4, size 0xb8, virtual false, abstract: false, final false
inline int32_t ScanText(ByRef<int32_t>  start) ;

/// @brief Method SimpleCheckForDuplicateAttributes, addr 0x41ad1e4, size 0x14c, virtual false, abstract: false, final false
inline void SimpleCheckForDuplicateAttributes() ;

/// @brief Method SkipExtn, addr 0x41ab990, size 0x8c, virtual false, abstract: false, final false
inline void SkipExtn() ;

/// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x41aae44, size 0x3a8, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x41ab1ec, size 0x19c, virtual true, abstract: false, final true
inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW  namespaceName) ;

/// @brief Method ThrowNotSupported, addr 0x41ad160, size 0x84, virtual false, abstract: false, final false
inline ::System::Exception* ThrowNotSupported(::StringW  res) ;

/// @brief Method ThrowUnexpectedToken, addr 0x41ab3c0, size 0x48, virtual false, abstract: false, final false
inline ::System::Exception* ThrowUnexpectedToken(::System::Xml::BinXmlToken  token) ;

/// @brief Method ThrowXmlException, addr 0x41abd9c, size 0x74, virtual false, abstract: false, final false
inline ::System::Exception* ThrowXmlException(::StringW  res) ;

/// @brief Method ThrowXmlException, addr 0x41acf6c, size 0xcc, virtual false, abstract: false, final false
inline ::System::Exception* ThrowXmlException(::StringW  res, ::StringW  arg1, ::StringW  arg2) ;

/// @brief Method UpdateFromTextReader, addr 0x41a9cc8, size 0x1c, virtual false, abstract: false, final false
inline bool UpdateFromTextReader(bool  needUpdate) ;

/// @brief Method UpdateFromTextReader, addr 0x41ae3f0, size 0xa8, virtual false, abstract: false, final false
inline void UpdateFromTextReader() ;

/// @brief Method ValueAsDateTimeString, addr 0x41af5e0, size 0x324, virtual false, abstract: false, final false
inline ::StringW ValueAsDateTimeString() ;

/// @brief Method ValueAsDecimal, addr 0x41af260, size 0x1e4, virtual false, abstract: false, final false
inline ::System::Decimal ValueAsDecimal() ;

/// @brief Method ValueAsDouble, addr 0x41af12c, size 0x134, virtual false, abstract: false, final false
inline double_t ValueAsDouble() ;

/// @brief Method ValueAsLong, addr 0x41aec24, size 0x1f8, virtual false, abstract: false, final false
inline int64_t ValueAsLong() ;

/// @brief Method ValueAsString, addr 0x41a8e50, size 0x6e0, virtual false, abstract: false, final false
inline ::StringW ValueAsString(::System::Xml::BinXmlToken  token) ;

/// @brief Method ValueAsULong, addr 0x41af444, size 0x50, virtual false, abstract: false, final false
inline uint64_t ValueAsULong() ;

/// @brief Method VerifyVersion, addr 0x41ab388, size 0x38, virtual false, abstract: false, final false
inline void VerifyVersion(int32_t  requiredVersion, ::System::Xml::BinXmlToken  token) ;

/// @brief Method XmlDeclValue, addr 0x41a8d10, size 0x140, virtual false, abstract: false, final false
inline ::StringW XmlDeclValue() ;

/// @brief Method XsdKatmaiTimeScaleToValueLength, addr 0x41aeb50, size 0xd4, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::System::Xml::__XmlSqlBinaryReader__NamespaceDecl*>*> const& __cordl_internal_get_namespaces() const;
...
/// @brief Method .ctor, addr 0x41a7730, size 0x4a4, virtual false, abstract: false, final false
...
/// @brief Method get_AttributeCount, addr 0x41a986c, size 0x54, virtual true, abstract: false, final false
inline int32_t get_AttributeCount() ;

/// @brief Method get_BaseURI, addr 0x41a96f8, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_BaseURI() ;

/// @brief Method get_Depth, addr 0x41a9654, size 0xa4, virtual true, abstract: false, final false
inline int32_t get_Depth() ;

/// @brief Method get_EOF, addr 0x41a9ffc, size 0x10, virtual true, abstract: false, final false
inline bool get_EOF() ;

/// @brief Method get_IsEmptyElement, addr 0x41a9700, size 0x24, virtual true, abstract: false, final false
inline bool get_IsEmptyElement() ;

/// @brief Method get_LocalName, addr 0x41a8974, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NameTable, addr 0x41aa3e0, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_NamespaceURI, addr 0x41a897c, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_NodeType, addr 0x41a896c, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x41a8984, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_ReadState, addr 0x41aa4d4, size 0x80, virtual true, abstract: false, final false
inline ::System::Xml::ReadState get_ReadState() ;

/// @brief Method get_Settings, addr 0x41a8850, size 0x11c, virtual true, abstract: false, final false
inline ::System::Xml::XmlReaderSettings* get_Settings() ;

/// @brief Method get_Value, addr 0x41a898c, size 0x114, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method get_ValueType, addr 0x41a9864, size 0x8, virtual true, abstract: false, final false
inline ::System::Type* get_ValueType() ;

/// @brief Method get_XmlLang, addr 0x41a97a4, size 0xc0, virtual true, abstract: false, final false
inline ::StringW get_XmlLang() ;

/// @brief Method get_XmlSpace, addr 0x41a9724, size 0x80, virtual true, abstract: false, final false
