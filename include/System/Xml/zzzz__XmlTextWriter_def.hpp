...
public:
// Declarations
/// @brief Method Init, addr 0x4288cd4, size 0x6c, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "prefix", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "defaultNs", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "defaultNsState", ty: "::System::Xml::__XmlTextWriter__NamespaceState", modifiers: "", def_value: None }, CppParam { name: "xmlSpace", ty: "::System::Xml::XmlSpace", modifiers: "", def_value: None }, CppParam { name: "xmlLang", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "prevNsTop", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "prefixCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "mixed", ty: "bool", modifiers: "", def_value: None }]
constexpr __XmlTextWriter__TagInfo(::StringW  name, ::StringW  prefix, ::StringW  defaultNs, ::System::Xml::__XmlTextWriter__NamespaceState  defaultNsState, ::System::Xml::XmlSpace  xmlSpace, ::StringW  xmlLang, int32_t  prevNsTop, int32_t  prefixCount, bool  mixed) noexcept;
...
public:
// Declarations
/// @brief Method Set, addr 0x428d328, size 0x18, virtual false, abstract: false, final false
...
/// @brief Field nsStack, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get_nsStack, put=__cordl_internal_set_nsStack)) ::ArrayW<::System::Xml::__XmlTextWriter__Namespace,::Array<::System::Xml::__XmlTextWriter__Namespace>*>  nsStack;
...
/// @brief Field stateTable, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_stateTable, put=__cordl_internal_set_stateTable)) ::ArrayW<::System::Xml::__XmlTextWriter__State,::Array<::System::Xml::__XmlTextWriter__State>*>  stateTable;

/// @brief Field stateTableDefault, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_stateTableDefault, put=setStaticF_stateTableDefault)) ::ArrayW<::System::Xml::__XmlTextWriter__State,::Array<::System::Xml::__XmlTextWriter__State>*>  stateTableDefault;

/// @brief Field stateTableDocument, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_stateTableDocument, put=setStaticF_stateTableDocument)) ::ArrayW<::System::Xml::__XmlTextWriter__State,::Array<::System::Xml::__XmlTextWriter__State>*>  stateTableDocument;
...
/// @brief Method AddNamespace, addr 0x428d190, size 0x198, virtual false, abstract: false, final false
inline void AddNamespace(::StringW  prefix, ::StringW  ns, bool  declared) ;

/// @brief Method AddToNamespaceHashtable, addr 0x428d340, size 0xe8, virtual false, abstract: false, final false
inline void AddToNamespaceHashtable(int32_t  namespaceIndex) ;

/// @brief Method AutoComplete, addr 0x4289c74, size 0x4fc, virtual false, abstract: false, final false
inline void AutoComplete(::System::Xml::__XmlTextWriter__Token  token) ;

/// @brief Method AutoCompleteAll, addr 0x4289638, size 0x54, virtual false, abstract: false, final false
inline void AutoCompleteAll() ;

/// @brief Method Close, addr 0x428c7c8, size 0x138, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method FindPrefix, addr 0x428a6ec, size 0xd0, virtual false, abstract: false, final false
inline ::StringW FindPrefix(::StringW  ns) ;

/// @brief Method Flush, addr 0x428c900, size 0x20, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushEncoders, addr 0x428ce88, size 0x24, virtual false, abstract: false, final false
inline void FlushEncoders() ;

/// @brief Method GeneratePrefix, addr 0x428b5ec, size 0x114, virtual false, abstract: false, final false
inline ::StringW GeneratePrefix() ;

/// @brief Method HandleSpecialAttribute, addr 0x428cf80, size 0x210, virtual false, abstract: false, final false
inline void HandleSpecialAttribute() ;

/// @brief Method Indent, addr 0x428ca20, size 0xd0, virtual false, abstract: false, final false
inline void Indent(bool  beforeEndElement) ;

/// @brief Method InternalWriteEndElement, addr 0x428ab50, size 0x2dc, virtual false, abstract: false, final false
inline void InternalWriteEndElement(bool  longFormat) ;

/// @brief Method InternalWriteProcessingInstruction, addr 0x428bd94, size 0xfc, virtual false, abstract: false, final false
inline void InternalWriteProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method LookupNamespace, addr 0x428a610, size 0xdc, virtual false, abstract: false, final false
inline int32_t LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupNamespaceInCurrentScope, addr 0x428b4c0, size 0x12c, virtual false, abstract: false, final false
inline int32_t LookupNamespaceInCurrentScope(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x428c920, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method PopNamespaces, addr 0x428ceac, size 0xd4, virtual false, abstract: false, final false
inline void PopNamespaces(int32_t  indexFrom, int32_t  indexTo) ;

/// @brief Method PushNamespace, addr 0x428a7bc, size 0x22c, virtual false, abstract: false, final false
inline void PushNamespace(::StringW  prefix, ::StringW  ns, bool  declared) ;

/// @brief Method PushStack, addr 0x428a540, size 0xd0, virtual false, abstract: false, final false
inline void PushStack() ;

/// @brief Method StartDocument, addr 0x42890dc, size 0x390, virtual false, abstract: false, final false
inline void StartDocument(int32_t  standalone) ;

/// @brief Method ValidateName, addr 0x4289abc, size 0x1b8, virtual false, abstract: false, final false
inline void ValidateName(::StringW  name, bool  isNCName) ;

/// @brief Method VerifyPrefixXml, addr 0x428a9e8, size 0x160, virtual false, abstract: false, final false
inline void VerifyPrefixXml(::StringW  prefix, ::StringW  ns) ;

/// @brief Method WriteBase64, addr 0x428c58c, size 0x148, virtual true, abstract: false, final false
inline void WriteBase64(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteBinHex, addr 0x428c6d4, size 0xd0, virtual true, abstract: false, final false
inline void WriteBinHex(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteCData, addr 0x428b7a0, size 0x1c4, virtual true, abstract: false, final false
inline void WriteCData(::StringW  text) ;

/// @brief Method WriteCharEntity, addr 0x428bf5c, size 0xc0, virtual true, abstract: false, final false
inline void WriteCharEntity(char16_t  ch) ;

/// @brief Method WriteChars, addr 0x428c31c, size 0xd8, virtual true, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteComment, addr 0x428b964, size 0x200, virtual true, abstract: false, final false
inline void WriteComment(::StringW  text) ;

/// @brief Method WriteDocType, addr 0x428968c, size 0x430, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteEndAttribute, addr 0x428b700, size 0xa0, virtual true, abstract: false, final false
inline void WriteEndAttribute() ;

/// @brief Method WriteEndAttributeQuote, addr 0x428caf0, size 0x4c, virtual false, abstract: false, final false
inline void WriteEndAttributeQuote() ;

/// @brief Method WriteEndDocument, addr 0x4289480, size 0x1b8, virtual true, abstract: false, final false
inline void WriteEndDocument() ;

/// @brief Method WriteEndElement, addr 0x428ab48, size 0x8, virtual true, abstract: false, final false
inline void WriteEndElement() ;

/// @brief Method WriteEndStartTag, addr 0x428cb3c, size 0x34c, virtual false, abstract: false, final false
inline void WriteEndStartTag(bool  empty) ;

/// @brief Method WriteEntityRef, addr 0x428be90, size 0xcc, virtual true, abstract: false, final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteFullEndElement, addr 0x428ae2c, size 0x8, virtual true, abstract: false, final false
inline void WriteFullEndElement() ;

/// @brief Method WriteProcessingInstruction, addr 0x428bb64, size 0x230, virtual true, abstract: false, final false
inline void WriteProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method WriteRaw, addr 0x428c3f4, size 0xd8, virtual true, abstract: false, final false
inline void WriteRaw(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteRaw, addr 0x428c4cc, size 0xc0, virtual true, abstract: false, final false
inline void WriteRaw(::StringW  data) ;

/// @brief Method WriteStartAttribute, addr 0x428ae34, size 0x68c, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartDocument, addr 0x42890d4, size 0x8, virtual true, abstract: false, final false
inline void WriteStartDocument() ;

/// @brief Method WriteStartDocument, addr 0x428946c, size 0x14, virtual true, abstract: false, final false
inline void WriteStartDocument(bool  standalone) ;

/// @brief Method WriteStartElement, addr 0x428a170, size 0x3d0, virtual true, abstract: false, final false
inline void WriteStartElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteString, addr 0x428c188, size 0xcc, virtual true, abstract: false, final false
inline void WriteString(::StringW  text) ;

/// @brief Method WriteSurrogateCharEntity, addr 0x428c254, size 0xc8, virtual true, abstract: false, final false
inline void WriteSurrogateCharEntity(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteWhitespace, addr 0x428c01c, size 0x16c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4288bb0, size 0x124, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4288e0c, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  filename, ::System::Text::Encoding*  encoding) ;

/// @brief Method .ctor, addr 0x4288d40, size 0xcc, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  w, ::System::Text::Encoding*  encoding) ;

/// @brief Method .ctor, addr 0x4288e8c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method get_BaseStream, addr 0x4288f24, size 0x9c, virtual false, abstract: false, final false
inline ::System::IO::Stream* get_BaseStream() ;

/// @brief Method get_WriteState, addr 0x428c7a4, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method set_Formatting, addr 0x4289034, size 0x14, virtual false, abstract: false, final false
inline void set_Formatting(::System::Xml::Formatting  value) ;

/// @brief Method set_Namespaces, addr 0x4288fc0, size 0x74, virtual false, abstract: false, final false
inline void set_Namespaces(bool  value) ;

/// @brief Method set_QuoteChar, addr 0x4289048, size 0x8c, virtual false, abstract: false, final false
