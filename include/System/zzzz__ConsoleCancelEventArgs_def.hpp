...
/// @brief Method .ctor, addr 0x3d7b18c, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3d7b118, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::System::ConsoleSpecialKey  type) ;

/// @brief Method get_Cancel, addr 0x3d7b184, size 0x8, virtual false, abstract: false, final false
