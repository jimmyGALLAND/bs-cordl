...
/// @brief Method GetFileLineNumber, addr 0x3d25da8, size 0x8, virtual true, abstract: false, final false
inline int32_t GetFileLineNumber() ;

/// @brief Method GetFileName, addr 0x3d25db0, size 0x8, virtual true, abstract: false, final false
inline ::StringW GetFileName() ;

/// @brief Method GetILOffset, addr 0x3d25e8c, size 0x8, virtual true, abstract: false, final false
inline int32_t GetILOffset() ;

/// @brief Method GetInternalMethodName, addr 0x3d25eb4, size 0x8, virtual false, abstract: false, final false
inline ::StringW GetInternalMethodName() ;

/// @brief Method GetMethod, addr 0x3d25e94, size 0x8, virtual true, abstract: false, final false
inline ::System::Reflection::MethodBase* GetMethod() ;

/// @brief Method GetMethodAddress, addr 0x3d25ea4, size 0x8, virtual false, abstract: false, final false
inline int64_t GetMethodAddress() ;

/// @brief Method GetMethodIndex, addr 0x3d25eac, size 0x8, virtual false, abstract: false, final false
inline uint32_t GetMethodIndex() ;

/// @brief Method GetNativeOffset, addr 0x3d25e9c, size 0x8, virtual true, abstract: false, final false
inline int32_t GetNativeOffset() ;

/// @brief Method GetSecureFileName, addr 0x3d25db8, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x3d25ebc, size 0x240, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3d25cf8, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3d25d48, size 0x60, virtual false, abstract: false, final false
inline void _ctor(int32_t  skipFrames, bool  fNeedFileInfo) ;

/// @brief Method get_frame_info, addr 0x3d25cf0, size 0x8, virtual false, abstract: false, final false
