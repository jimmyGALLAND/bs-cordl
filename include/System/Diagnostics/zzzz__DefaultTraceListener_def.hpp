...
/// @brief Method GetPrefix, addr 0x43a0438, size 0x7c, virtual false, abstract: false, final false
static inline ::StringW GetPrefix(::StringW  var, ::StringW  target) ;

static inline ::System::Diagnostics::DefaultTraceListener* New_ctor() ;

/// @brief Method Write, addr 0x43a0ae0, size 0x4, virtual true, abstract: false, final false
inline void Write(::StringW  message) ;

/// @brief Method WriteDebugString, addr 0x43a04c0, size 0xb0, virtual false, abstract: false, final false
inline void WriteDebugString(::StringW  message) ;

/// @brief Method WriteImpl, addr 0x43a0a24, size 0xbc, virtual false, abstract: false, final false
inline void WriteImpl(::StringW  message) ;

/// @brief Method WriteLine, addr 0x43a0ae4, size 0x48, virtual true, abstract: false, final false
inline void WriteLine(::StringW  message) ;

/// @brief Method WriteLogFile, addr 0x43a0724, size 0x278, virtual false, abstract: false, final false
inline void WriteLogFile(::StringW  message, ::StringW  logFile) ;

/// @brief Method WriteMonoTrace, addr 0x43a0570, size 0x1b4, virtual false, abstract: false, final false
inline void WriteMonoTrace(::StringW  message) ;

/// @brief Method WritePrefix, addr 0x43a099c, size 0x88, virtual false, abstract: false, final false
inline void WritePrefix() ;

/// @brief Method WriteWindowsDebugString, addr 0x43a04bc, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x439a390, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_LogFileName, addr 0x43a04b4, size 0x8, virtual false, abstract: false, final false
