...
/// @brief Method InitializeSettings, addr 0x439a324, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_AutoFlush, addr 0x4399b84, size 0x60, virtual false, abstract: false, final false
static inline bool get_AutoFlush() ;

/// @brief Method get_IndentLevel, addr 0x439a5ec, size 0x58, virtual false, abstract: false, final false
static inline int32_t get_IndentLevel() ;

/// @brief Method get_IndentSize, addr 0x439a644, size 0x60, virtual false, abstract: false, final false
static inline int32_t get_IndentSize() ;

/// @brief Method get_Listeners, addr 0x43998f4, size 0x244, virtual false, abstract: false, final false
