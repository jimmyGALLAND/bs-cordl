...
/// @brief Method GetLogicalOperationStack, addr 0x4398f68, size 0xb8, virtual false, abstract: false, final false
inline ::System::Collections::Stack* GetLogicalOperationStack() ;

static inline ::System::Diagnostics::CorrelationManager* New_ctor() ;

/// @brief Method .ctor, addr 0x4398f5c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_LogicalOperationStack, addr 0x4398f64, size 0x4, virtual false, abstract: false, final false
