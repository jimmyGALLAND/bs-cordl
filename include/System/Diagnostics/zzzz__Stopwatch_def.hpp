...
/// @brief Method GetTimestamp, addr 0x4399e98, size 0x4, virtual false, abstract: false, final false
static inline int64_t GetTimestamp() ;

static inline ::System::Diagnostics::Stopwatch* New_ctor() ;

/// @brief Method Reset, addr 0x43a0f24, size 0xc, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Start, addr 0x43a0c08, size 0x68, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartNew, addr 0x43a0b9c, size 0x64, virtual false, abstract: false, final false
static inline ::System::Diagnostics::Stopwatch* StartNew() ;

/// @brief Method Stop, addr 0x43a0f30, size 0x78, virtual false, abstract: false, final false
inline void Stop() ;
...
/// @brief Method .ctor, addr 0x43a0c00, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Elapsed, addr 0x43a0c70, size 0xf8, virtual false, abstract: false, final false
inline ::System::TimeSpan get_Elapsed() ;

/// @brief Method get_ElapsedMilliseconds, addr 0x43a0dd8, size 0x144, virtual false, abstract: false, final false
inline int64_t get_ElapsedMilliseconds() ;

/// @brief Method get_ElapsedTicks, addr 0x43a0d68, size 0x70, virtual false, abstract: false, final false
inline int64_t get_ElapsedTicks() ;

/// @brief Method get_IsRunning, addr 0x43a0f1c, size 0x8, virtual false, abstract: false, final false
