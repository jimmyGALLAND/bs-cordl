...
/// @brief Method .ctor, addr 0x439ce18, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_TotalProcessorTime, addr 0x439d200, size 0xc, virtual false, abstract: false, final false
