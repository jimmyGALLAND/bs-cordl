...
/// @brief Method Dispose, addr 0x439a764, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x439a7d0, size 0x4, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Flush, addr 0x439a7d4, size 0x4, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method IsEnabled, addr 0x439b070, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method TraceEvent, addr 0x439a8d0, size 0xc4, virtual true, abstract: false, final false
...
/// @brief Method WriteFooter, addr 0x439aaa4, size 0x5cc, virtual false, abstract: false, final false
inline void WriteFooter(::System::Diagnostics::TraceEventCache*  eventCache) ;

/// @brief Method WriteHeader, addr 0x439a994, size 0x110, virtual false, abstract: false, final false
inline void WriteHeader(::StringW  source, ::System::Diagnostics::TraceEventType  eventType, int32_t  id) ;

/// @brief Method WriteIndent, addr 0x439a7fc, size 0xd4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x439a724, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method get_Filter, addr 0x439a7d8, size 0x8, virtual false, abstract: false, final false
inline ::System::Diagnostics::TraceFilter* get_Filter() ;

/// @brief Method get_IsThreadSafe, addr 0x439a75c, size 0x8, virtual true, abstract: false, final false
inline bool get_IsThreadSafe() ;

/// @brief Method get_NeedIndent, addr 0x439a7e0, size 0x8, virtual false, abstract: false, final false
inline bool get_NeedIndent() ;

/// @brief Method get_TraceOutputOptions, addr 0x439a7f4, size 0x8, virtual false, abstract: false, final false
inline ::System::Diagnostics::TraceOptions get_TraceOutputOptions() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_IndentLevel, addr 0x439a3f4, size 0x1c, virtual false, abstract: false, final false
inline void set_IndentLevel(int32_t  value) ;

/// @brief Method set_IndentSize, addr 0x439a410, size 0xa8, virtual false, abstract: false, final false
inline void set_IndentSize(int32_t  value) ;

/// @brief Method set_NeedIndent, addr 0x439a7e8, size 0xc, virtual false, abstract: false, final false
