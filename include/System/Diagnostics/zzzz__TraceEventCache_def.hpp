...
/// @brief Method GetProcessId, addr 0x4399d50, size 0x54, virtual false, abstract: false, final false
static inline int32_t GetProcessId() ;

/// @brief Method GetThreadId, addr 0x4399e14, size 0x20, virtual false, abstract: false, final false
static inline int32_t GetThreadId() ;

/// @brief Method InitProcessInfo, addr 0x4399e9c, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x439a284, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Callstack, addr 0x4399c80, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_Callstack() ;

/// @brief Method get_DateTime, addr 0x4399cb8, size 0x94, virtual false, abstract: false, final false
inline ::System::DateTime get_DateTime() ;

/// @brief Method get_LogicalOperationStack, addr 0x4399ca0, size 0x18, virtual false, abstract: false, final false
inline ::System::Collections::Stack* get_LogicalOperationStack() ;

/// @brief Method get_ProcessId, addr 0x4399d4c, size 0x4, virtual false, abstract: false, final false
inline int32_t get_ProcessId() ;

/// @brief Method get_ThreadId, addr 0x4399da4, size 0x70, virtual false, abstract: false, final false
inline ::StringW get_ThreadId() ;

/// @brief Method get_Timestamp, addr 0x4399e34, size 0x64, virtual false, abstract: false, final false
