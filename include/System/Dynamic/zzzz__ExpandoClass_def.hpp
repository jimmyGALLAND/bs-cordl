...
/// @brief Method FindNewClass, addr 0x406bc44, size 0x3c0, virtual false, abstract: false, final false
inline ::System::Dynamic::ExpandoClass* FindNewClass(::StringW  newKey) ;

/// @brief Method GetTransitionList, addr 0x406c004, size 0x12c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::System::WeakReference*>* GetTransitionList(int32_t  hashCode) ;

/// @brief Method GetValueIndex, addr 0x406c130, size 0x10, virtual false, abstract: false, final false
inline int32_t GetValueIndex(::StringW  name, bool  caseInsensitive, ::System::Dynamic::ExpandoObject*  obj) ;

/// @brief Method GetValueIndexCaseInsensitive, addr 0x406c140, size 0x17c, virtual false, abstract: false, final false
inline int32_t GetValueIndexCaseInsensitive(::StringW  name, ::System::Dynamic::ExpandoObject*  obj) ;

/// @brief Method GetValueIndexCaseSensitive, addr 0x406c2bc, size 0x74, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::System::Collections::Generic::List_1<::System::WeakReference*>*>*> const& __cordl_internal_get__transitions() const;
...
/// @brief Method .ctor, addr 0x406bb6c, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x406bc14, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_Keys, addr 0x406c3d8, size 0x8, virtual false, abstract: false, final false
