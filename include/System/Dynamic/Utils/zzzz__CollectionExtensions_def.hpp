...
template<typename T>
static inline ::ArrayW<T,::Array<T>*> AddLast(::ArrayW<T,::Array<T>*>  array, T  item) ;

/// @brief Method RemoveFirst, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ArrayW<T,::Array<T>*> RemoveFirst(::ArrayW<T,::Array<T>*>  array) ;

/// @brief Method RemoveLast, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::ArrayW<T,::Array<T>*> RemoveLast(::ArrayW<T,::Array<T>*>  array) ;
