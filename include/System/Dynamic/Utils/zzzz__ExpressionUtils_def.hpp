...
public:
// Declarations
/// @brief Method GetParametersForValidation, addr 0x4070d00, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method RequiresCanRead, addr 0x40714e0, size 0x8, virtual false, abstract: false, final false
static inline void RequiresCanRead(::System::Linq::Expressions::Expression*  expression, ::StringW  paramName) ;

/// @brief Method RequiresCanRead, addr 0x4071050, size 0x1b8, virtual false, abstract: false, final false
...
template<typename T>
static inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<T>* ReturnReadOnly(ByRef<::System::Collections::Generic::IReadOnlyList_1<T>*>  collection) ;

/// @brief Method SameElements, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool SameElements(ByRef<::System::Collections::Generic::IEnumerable_1<T>*>  replacement, ::System::Collections::Generic::IReadOnlyList_1<T>*  current) ;
...
/// @brief Method TryQuote, addr 0x40713bc, size 0x124, virtual false, abstract: false, final false
static inline bool TryQuote(::System::Type*  parameterType, ByRef<::System::Linq::Expressions::Expression*>  argument) ;

/// @brief Method ValidateArgumentCount, addr 0x4071690, size 0xd4, virtual false, abstract: false, final false
static inline void ValidateArgumentCount(::System::Linq::Expressions::LambdaExpression*  lambda) ;

/// @brief Method ValidateArgumentCount, addr 0x4070d94, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method ValidateArgumentTypes, addr 0x4070a48, size 0x2b8, virtual false, abstract: false, final false
...
/// @brief Method ValidateOneArgument, addr 0x4070e40, size 0x210, virtual false, abstract: false, final false
