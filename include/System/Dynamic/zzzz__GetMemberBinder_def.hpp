...
/// @brief Method Bind, addr 0x40702a8, size 0xa8, virtual true, abstract: false, final true
...
/// @brief Method FallbackGetMember, addr 0x406ee60, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x40701b8, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, bool  ignoreCase) ;

/// @brief Method get_IgnoreCase, addr 0x40702a0, size 0x8, virtual false, abstract: false, final false
inline bool get_IgnoreCase() ;

/// @brief Method get_IsStandardBinder, addr 0x4070384, size 0x8, virtual true, abstract: false, final true
inline bool get_IsStandardBinder() ;

/// @brief Method get_Name, addr 0x4070298, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_ReturnType, addr 0x407022c, size 0x6c, virtual true, abstract: false, final true
