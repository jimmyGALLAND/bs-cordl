...
public:
// Declarations
/// @brief Method Bind, addr 0x406a660, size 0xbc, virtual true, abstract: false, final true
...
/// @brief Method FallbackDeleteIndex, addr 0x406a71c, size 0x10, virtual false, abstract: false, final false
