...
public:
// Declarations
/// @brief Method Bind, addr 0x4070844, size 0xac, virtual true, abstract: false, final true
...
/// @brief Method FallbackUnaryOperation, addr 0x4070834, size 0x10, virtual false, abstract: false, final false
