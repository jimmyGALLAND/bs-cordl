...
public:
// Declarations
/// @brief Method Init, addr 0x3d536c0, size 0x24, virtual false, abstract: false, final false
inline void Init(::System::ReadOnlySpan_1<char16_t>  originalDateTimeString) ;

/// @brief Method SetBadDateTimeFailure, addr 0x3d537e8, size 0x50, virtual false, abstract: false, final false
inline void SetBadDateTimeFailure() ;

/// @brief Method SetBadFormatSpecifierFailure, addr 0x3d536f0, size 0x94, virtual false, abstract: false, final false
inline void SetBadFormatSpecifierFailure() ;

/// @brief Method SetBadFormatSpecifierFailure, addr 0x3d53784, size 0x64, virtual false, abstract: false, final false
inline void SetBadFormatSpecifierFailure(::System::ReadOnlySpan_1<char16_t>  failedFormatSpecifier) ;

/// @brief Method SetDate, addr 0x3d536e4, size 0xc, virtual false, abstract: false, final false
inline void SetDate(int32_t  year, int32_t  month, int32_t  day) ;

/// @brief Method SetFailure, addr 0x3d53838, size 0xc, virtual false, abstract: false, final false
inline void SetFailure(::System::ParseFailureKind  failure, ::StringW  failureMessageID) ;

/// @brief Method SetFailure, addr 0x3d53844, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method SetFailure, addr 0x3d53850, size 0x10, virtual false, abstract: false, final false
