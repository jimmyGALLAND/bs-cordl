...
/// @brief Method Compare, addr 0x3d70d54, size 0x58, virtual true, abstract: false, final false
inline int32_t Compare(::StringW  x, ::StringW  y) ;

/// @brief Method Equals, addr 0x3d70eb4, size 0x98, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x3d70dac, size 0x80, virtual true, abstract: false, final false
inline bool Equals(::StringW  x, ::StringW  y) ;

/// @brief Method GetHashCode, addr 0x3d70f4c, size 0x64, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetHashCode, addr 0x3d70e2c, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3d70ce4, size 0x70, virtual false, abstract: false, final false
