...
/// @brief Method .ctor, addr 0x3d7cb04, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3d7cba8, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  className, ::StringW  fieldName) ;

/// @brief Method .ctor, addr 0x3d7cc2c, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x3d7cb84, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method get_Message, addr 0x3d7cdb4, size 0x114, virtual true, abstract: false, final false
