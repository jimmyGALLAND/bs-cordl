...
/// @brief Method InternalWriteChar, addr 0x3cf3b94, size 0x84, virtual false, abstract: false, final false
inline void InternalWriteChar(char16_t  val) ;

/// @brief Method InternalWriteChars, addr 0x3cf3c9c, size 0x8c, virtual false, abstract: false, final false
inline void InternalWriteChars(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  n) ;

/// @brief Method InternalWriteString, addr 0x3cf3c18, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method Write, addr 0x3cf36c4, size 0x348, virtual true, abstract: false, final false
inline void Write(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Write, addr 0x3cf3d28, size 0x28, virtual true, abstract: false, final false
inline void Write(::ArrayW<char16_t,::Array<char16_t>*>  val) ;

/// @brief Method Write, addr 0x3cf3d50, size 0xcc, virtual true, abstract: false, final false
inline void Write(::StringW  val) ;

/// @brief Method Write, addr 0x3cf3a0c, size 0x188, virtual true, abstract: false, final false
inline void Write(char16_t  val) ;

/// @brief Method WriteLine, addr 0x3cf3e1c, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3cf359c, size 0x128, virtual false, abstract: false, final false
