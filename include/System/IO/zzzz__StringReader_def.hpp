...
/// @brief Method Close, addr 0x3ce9244, size 0x10, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Dispose, addr 0x3ce9254, size 0x10, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

static inline ::System::IO::StringReader* New_ctor(::StringW  s) ;

/// @brief Method Peek, addr 0x3ce9264, size 0x3c, virtual true, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x3ce92a0, size 0x44, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x3ce92e4, size 0x1a8, virtual true, abstract: false, final false
inline int32_t Read(ByRef<::ArrayW<char16_t,::Array<char16_t>*>>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadAsync, addr 0x3ce95d4, size 0x1dc, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadLine, addr 0x3ce94c8, size 0x10c, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method ReadToEnd, addr 0x3ce948c, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ce9184, size 0xc0, virtual false, abstract: false, final false
