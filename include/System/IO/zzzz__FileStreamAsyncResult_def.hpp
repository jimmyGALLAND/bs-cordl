...
/// @brief Method CBWrapper, addr 0x3ced6d8, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ced60c, size 0xcc, virtual false, abstract: false, final false
inline void _ctor(::System::AsyncCallback*  cb, ::System::Object*  state) ;

/// @brief Method get_AsyncState, addr 0x3ced76c, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_AsyncState() ;

/// @brief Method get_AsyncWaitHandle, addr 0x3ced77c, size 0x8, virtual true, abstract: false, final true
inline ::System::Threading::WaitHandle* get_AsyncWaitHandle() ;

/// @brief Method get_CompletedSynchronously, addr 0x3ced774, size 0x8, virtual true, abstract: false, final true
inline bool get_CompletedSynchronously() ;

/// @brief Method get_IsCompleted, addr 0x3ced784, size 0x8, virtual true, abstract: false, final true
