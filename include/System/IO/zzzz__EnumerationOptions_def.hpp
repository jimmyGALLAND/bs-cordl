...
static __declspec(property(get=getStaticF__CompatibleRecursive_k__BackingField, put=setStaticF__CompatibleRecursive_k__BackingField)) ::System::IO::EnumerationOptions*  _CompatibleRecursive_k__BackingField;
...
/// @brief Method FromSearchOption, addr 0x3cd5204, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3cd6144, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AttributesToSkip, addr 0x3cd6194, size 0x8, virtual false, abstract: false, final false
inline ::System::IO::FileAttributes get_AttributesToSkip() ;

/// @brief Method get_Compatible, addr 0x3cd603c, size 0x58, virtual false, abstract: false, final false
static inline ::System::IO::EnumerationOptions* get_Compatible() ;

/// @brief Method get_CompatibleRecursive, addr 0x3cd6094, size 0x58, virtual false, abstract: false, final false
static inline ::System::IO::EnumerationOptions* get_CompatibleRecursive() ;

/// @brief Method get_Default, addr 0x3cd60ec, size 0x58, virtual false, abstract: false, final false
static inline ::System::IO::EnumerationOptions* get_Default() ;

/// @brief Method get_IgnoreInaccessible, addr 0x3cd6180, size 0x8, virtual false, abstract: false, final false
inline bool get_IgnoreInaccessible() ;

/// @brief Method get_MatchCasing, addr 0x3cd61b4, size 0x8, virtual false, abstract: false, final false
inline ::System::IO::MatchCasing get_MatchCasing() ;

/// @brief Method get_MatchType, addr 0x3cd61a4, size 0x8, virtual false, abstract: false, final false
inline ::System::IO::MatchType get_MatchType() ;

/// @brief Method get_RecurseSubdirectories, addr 0x3cd616c, size 0x8, virtual false, abstract: false, final false
inline bool get_RecurseSubdirectories() ;

/// @brief Method get_ReturnSpecialDirectories, addr 0x3cd61bc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_AttributesToSkip, addr 0x3cd619c, size 0x8, virtual false, abstract: false, final false
inline void set_AttributesToSkip(::System::IO::FileAttributes  value) ;

/// @brief Method set_IgnoreInaccessible, addr 0x3cd6188, size 0xc, virtual false, abstract: false, final false
inline void set_IgnoreInaccessible(bool  value) ;

/// @brief Method set_MatchType, addr 0x3cd61ac, size 0x8, virtual false, abstract: false, final false
inline void set_MatchType(::System::IO::MatchType  value) ;

/// @brief Method set_RecurseSubdirectories, addr 0x3cd6174, size 0xc, virtual false, abstract: false, final false
