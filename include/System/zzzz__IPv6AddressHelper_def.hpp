...
public:
// Declarations
/// @brief Method FindCompressionRange, addr 0x4375960, size 0xe0, virtual false, abstract: false, final false
static inline ::System::ValueTuple_2<int32_t,int32_t> FindCompressionRange(::System::ReadOnlySpan_1<uint16_t>  numbers) ;

/// @brief Method InternalIsValid, addr 0x4376974, size 0x2c4, virtual false, abstract: false, final false
...
/// @brief Method IsLoopback, addr 0x4376894, size 0xe0, virtual false, abstract: false, final false
static inline bool IsLoopback(::System::ReadOnlySpan_1<uint16_t>  numbers) ;

/// @brief Method IsValid, addr 0x4376c38, size 0x8, virtual false, abstract: false, final false
static inline bool IsValid(::cordl_internals::Ptr<char16_t>  name, int32_t  start, ByRef<int32_t>  end) ;

/// @brief Method IsValidStrict, addr 0x4375b10, size 0x330, virtual false, abstract: false, final false
static inline bool IsValidStrict(::cordl_internals::Ptr<char16_t>  name, int32_t  start, ByRef<int32_t>  end) ;

/// @brief Method Parse, addr 0x4375e40, size 0x4a8, virtual false, abstract: false, final false
...
/// @brief Method ParseCanonicalName, addr 0x43762e8, size 0x5ac, virtual false, abstract: false, final false
static inline ::StringW ParseCanonicalName(::StringW  str, int32_t  start, ByRef<bool>  isLoopback, ByRef<::StringW>  scopeId) ;

/// @brief Method ShouldHaveIpv4Embedded, addr 0x4375a40, size 0xd0, virtual false, abstract: false, final false
