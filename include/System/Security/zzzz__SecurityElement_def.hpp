...
/// @brief Method .ctor, addr 0x3c05888, size 0x15c, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::StringW  value) ;

/// @brief Method get_Name, addr 0x3c068a8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Value, addr 0x3c068b0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AddAttribute, addr 0x3c033f0, size 0x194, virtual false, abstract: false, final false
inline void AddAttribute(::StringW  name, ::StringW  value) ;

/// @brief Method AddChild, addr 0x3c03584, size 0xcc, virtual false, abstract: false, final false
inline void AddChild(::System::Security::SecurityElement*  child) ;

/// @brief Method Escape, addr 0x3c059e4, size 0x208, virtual false, abstract: false, final false
static inline ::StringW Escape(::StringW  str) ;

/// @brief Method GetAttribute, addr 0x3c05584, size 0x304, virtual false, abstract: false, final false
inline ::System::Security::__SecurityElement__SecurityAttribute* GetAttribute(::StringW  name) ;

/// @brief Method IsValidAttributeName, addr 0x3c05bec, size 0x7c, virtual false, abstract: false, final false
static inline bool IsValidAttributeName(::StringW  name) ;

/// @brief Method IsValidAttributeValue, addr 0x3c05c68, size 0x7c, virtual false, abstract: false, final false
static inline bool IsValidAttributeValue(::StringW  value) ;

/// @brief Method IsValidTag, addr 0x3c051b8, size 0x7c, virtual false, abstract: false, final false
static inline bool IsValidTag(::StringW  tag) ;

/// @brief Method IsValidText, addr 0x3c05338, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method SearchForChildByTag, addr 0x3c05ce4, size 0x124, virtual false, abstract: false, final false
inline ::System::Security::SecurityElement* SearchForChildByTag(::StringW  tag) ;

/// @brief Method SearchForTextOfLocalName, addr 0x3c064e8, size 0x240, virtual false, abstract: false, final false
inline ::StringW SearchForTextOfLocalName(::StringW  strLocalName) ;

/// @brief Method ToString, addr 0x3c05e08, size 0x84, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToXml, addr 0x3c05e8c, size 0x654, virtual false, abstract: false, final false
inline void ToXml(ByRef<::System::Text::StringBuilder*>  s, int32_t  level) ;

/// @brief Method Unescape, addr 0x3c053b4, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c033e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  tag) ;

/// @brief Method .ctor, addr 0x3c05074, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method get_Children, addr 0x3c05328, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_Children() ;

/// @brief Method get_Tag, addr 0x3c05330, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Text, addr 0x3c05234, size 0xf4, virtual false, abstract: false, final false
inline void set_Text(::StringW  value) ;

/// @brief Method set_m_strText, addr 0x3c064e0, size 0x8, virtual false, abstract: false, final false
