...
/// @brief Method Dec, addr 0x3c152a0, size 0x1e8, virtual false, abstract: false, final false
inline void Dec(::cordl_internals::Ptr<int32_t>  decryptindex, ::cordl_internals::Ptr<int32_t>  decryptKeyExpansion, ::cordl_internals::Ptr<int32_t>  iT, ::cordl_internals::Ptr<int32_t>  iTF, ::cordl_internals::Ptr<int32_t>  work, ::cordl_internals::Ptr<int32_t>  temp) ;

/// @brief Method DecryptData, addr 0x3c14320, size 0xa80, virtual false, abstract: false, final false
inline int32_t DecryptData(::ArrayW<uint8_t,::Array<uint8_t>*>  inputBuffer, int32_t  inputOffset, int32_t  inputCount, ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  outputBuffer, int32_t  outputOffset, ::System::Security::Cryptography::PaddingMode  paddingMode, bool  fLast) ;

/// @brief Method Dispose, addr 0x3c133b4, size 0x8, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x3c133bc, size 0xbc, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Enc, addr 0x3c150d4, size 0x1cc, virtual false, abstract: false, final false
inline void Enc(::cordl_internals::Ptr<int32_t>  encryptindex, ::cordl_internals::Ptr<int32_t>  encryptKeyExpansion, ::cordl_internals::Ptr<int32_t>  T, ::cordl_internals::Ptr<int32_t>  TF, ::cordl_internals::Ptr<int32_t>  work, ::cordl_internals::Ptr<int32_t>  temp) ;

/// @brief Method EncryptData, addr 0x3c13754, size 0xbcc, virtual false, abstract: false, final false
inline int32_t EncryptData(::ArrayW<uint8_t,::Array<uint8_t>*>  inputBuffer, int32_t  inputOffset, int32_t  inputCount, ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  outputBuffer, int32_t  outputOffset, ::System::Security::Cryptography::PaddingMode  paddingMode, bool  fLast) ;

/// @brief Method GenerateKeyExpansion, addr 0x3c12e4c, size 0x568, virtual false, abstract: false, final false
inline void GenerateKeyExpansion(::ArrayW<uint8_t,::Array<uint8_t>*>  rgbKey) ;

/// @brief Method MulX, addr 0x3c15554, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x3c1506c, size 0x68, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SubWord, addr 0x3c15490, size 0xc4, virtual false, abstract: false, final false
static inline int32_t SubWord(int32_t  a) ;

/// @brief Method TransformBlock, addr 0x3c13490, size 0x2c4, virtual true, abstract: false, final true
...
/// @brief Method TransformFinalBlock, addr 0x3c14da0, size 0x2cc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3c12850, size 0x5fc, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  rgbKey, ::System::Security::Cryptography::CipherMode  mode, ::ArrayW<uint8_t,::Array<uint8_t>*>  rgbIV, int32_t  blockSize, int32_t  feedbackSize, ::System::Security::Cryptography::PaddingMode  PaddingValue, ::System::Security::Cryptography::RijndaelManagedTransformMode  transformMode) ;
...
/// @brief Method get_CanTransformMultipleBlocks, addr 0x3c13488, size 0x8, virtual true, abstract: false, final true
inline bool get_CanTransformMultipleBlocks() ;

/// @brief Method get_InputBlockSize, addr 0x3c13478, size 0x8, virtual true, abstract: false, final true
inline int32_t get_InputBlockSize() ;

/// @brief Method get_OutputBlockSize, addr 0x3c13480, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method rot1, addr 0x3c15580, size 0x8, virtual false, abstract: false, final false
static inline int32_t rot1(int32_t  val) ;

/// @brief Method rot2, addr 0x3c15578, size 0x8, virtual false, abstract: false, final false
static inline int32_t rot2(int32_t  val) ;

/// @brief Method rot3, addr 0x3c15488, size 0x8, virtual false, abstract: false, final false
