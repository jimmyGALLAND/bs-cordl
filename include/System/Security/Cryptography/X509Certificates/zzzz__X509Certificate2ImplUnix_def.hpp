...
/// @brief Method AppendPrivateKeyInfo, addr 0x43ab7e8, size 0x94, virtual true, abstract: false, final true
inline void AppendPrivateKeyInfo(::System::Text::StringBuilder*  sb) ;

/// @brief Method EnsureCertData, addr 0x43ab3a0, size 0x80, virtual false, abstract: false, final false
inline void EnsureCertData() ;

/// @brief Method GetNameInfo, addr 0x43ab6dc, size 0x34, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x43a9ee8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Extensions, addr 0x43ab710, size 0x18, virtual true, abstract: false, final true
...
/// @brief Method get_Issuer, addr 0x43ab50c, size 0x28, virtual true, abstract: false, final true
inline ::StringW get_Issuer() ;

/// @brief Method get_IssuerName, addr 0x43ab4cc, size 0x18, virtual true, abstract: false, final true
inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_IssuerName() ;

/// @brief Method get_KeyAlgorithm, addr 0x43ab420, size 0x18, virtual true, abstract: false, final true
inline ::StringW get_KeyAlgorithm() ;

/// @brief Method get_KeyAlgorithmParameters, addr 0x43ab438, size 0x18, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_KeyAlgorithmParameters() ;

/// @brief Method get_NotAfter, addr 0x43ab728, size 0x60, virtual true, abstract: false, final true
inline ::System::DateTime get_NotAfter() ;

/// @brief Method get_NotBefore, addr 0x43ab788, size 0x60, virtual true, abstract: false, final true
inline ::System::DateTime get_NotBefore() ;

/// @brief Method get_PublicKeyValue, addr 0x43ab450, size 0x18, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_PublicKeyValue() ;

/// @brief Method get_RawData, addr 0x43ab534, size 0x18, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_RawData() ;

/// @brief Method get_SerialNumber, addr 0x43ab468, size 0x18, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_SerialNumber() ;

/// @brief Method get_SignatureAlgorithm, addr 0x43ab480, size 0x18, virtual true, abstract: false, final true
inline ::StringW get_SignatureAlgorithm() ;

/// @brief Method get_Subject, addr 0x43ab4e4, size 0x28, virtual true, abstract: false, final true
inline ::StringW get_Subject() ;

/// @brief Method get_SubjectName, addr 0x43ab4b4, size 0x18, virtual true, abstract: false, final true
inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_SubjectName() ;

/// @brief Method get_Thumbprint, addr 0x43ab54c, size 0x190, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Thumbprint() ;

/// @brief Method get_Version, addr 0x43ab498, size 0x1c, virtual true, abstract: false, final true
