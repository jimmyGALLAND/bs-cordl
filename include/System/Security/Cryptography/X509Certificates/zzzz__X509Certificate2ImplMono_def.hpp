...
/// @brief Method Clone, addr 0x43aa134, size 0x64, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateImpl* Clone() ;

/// @brief Method GetDSAPrivateKey, addr 0x43aa81c, size 0x8c, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::DSA* GetDSAPrivateKey() ;

/// @brief Method GetRSAPrivateKey, addr 0x43aa790, size 0x8c, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::RSA* GetRSAPrivateKey() ;

/// @brief Method GetRawCertData, addr 0x43aa1b4, size 0x38, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetRawCertData() ;

/// @brief Method ImportPkcs12, addr 0x43aa0dc, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method ImportPkcs12, addr 0x43aa8a8, size 0x7a8, virtual false, abstract: false, final false
...
/// @brief Method Verify, addr 0x43ab1a0, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43a9ec0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::X509::X509Certificate*  cert) ;

/// @brief Method .ctor, addr 0x43a9ef0, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono*  other) ;

/// @brief Method .ctor, addr 0x43a9f8c, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_Cert, addr 0x43aa198, size 0x1c, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* get_Cert() ;

/// @brief Method get_HasPrivateKey, addr 0x43aa1ec, size 0x24, virtual true, abstract: false, final false
inline bool get_HasPrivateKey() ;

/// @brief Method get_IntermediateCertificates, addr 0x43ab2d0, size 0x8, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection* get_IntermediateCertificates() ;

/// @brief Method get_IsValid, addr 0x43a9eb0, size 0x10, virtual true, abstract: false, final false
inline bool get_IsValid() ;

/// @brief Method get_MonoCertificate, addr 0x43ab2d8, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* get_MonoCertificate() ;

/// @brief Method get_PrivateKey, addr 0x43aa210, size 0x3f8, virtual true, abstract: false, final false
...
/// @brief Method set_PrivateKey, addr 0x43aa608, size 0x188, virtual true, abstract: false, final false
