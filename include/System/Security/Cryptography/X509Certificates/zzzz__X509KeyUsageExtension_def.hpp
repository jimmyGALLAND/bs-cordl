...
/// @brief Method CopyFrom, addr 0x43b25d8, size 0x1cc, virtual true, abstract: false, final false
inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData*  asnEncodedData) ;

/// @brief Method Decode, addr 0x43b2178, size 0x1b4, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  extension) ;

/// @brief Method Encode, addr 0x43b2414, size 0x15c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Encode() ;

/// @brief Method GetValidFlags, addr 0x43b2404, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x43b27a4, size 0x55c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43b200c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x43b20a8, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::AsnEncodedData*  encodedKeyUsage, bool  critical) ;

/// @brief Method .ctor, addr 0x43b232c, size 0xd8, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::X509Certificates::X509KeyUsageFlags  keyUsages, bool  critical) ;

/// @brief Method get_KeyUsages, addr 0x43b2570, size 0x68, virtual false, abstract: false, final false
