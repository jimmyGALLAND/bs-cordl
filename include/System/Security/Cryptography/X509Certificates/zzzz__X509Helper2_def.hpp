...
public:
// Declarations
/// @brief Method CreateChainImpl, addr 0x43b1edc, size 0x5c, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::X509Certificates::X509ChainImpl* CreateChainImpl(bool  useMachineContext) ;

/// @brief Method GetInvalidChainContextException, addr 0x43b1f8c, size 0x80, virtual false, abstract: false, final false
static inline ::System::Exception* GetInvalidChainContextException() ;

/// @brief Method GetMonoCertificate, addr 0x43b1e0c, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x43b1f38, size 0x14, virtual false, abstract: false, final false
static inline bool IsValid(::System::Security::Cryptography::X509Certificates::X509ChainImpl*  impl) ;

/// @brief Method ThrowIfContextInvalid, addr 0x43b1f4c, size 0x40, virtual false, abstract: false, final false
