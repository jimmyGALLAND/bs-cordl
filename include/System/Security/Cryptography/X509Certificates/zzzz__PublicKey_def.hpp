...
/// @brief Method DecodeDSA, addr 0x43a4bf0, size 0x480, virtual false, abstract: false, final false
...
/// @brief Method DecodeRSA, addr 0x43a4854, size 0x39c, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::RSA* DecodeRSA(::ArrayW<uint8_t,::Array<uint8_t>*>  rawPublicKey) ;

/// @brief Method GetUnsignedBigInteger, addr 0x43a5078, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43a4538, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method get_EncodedKeyValue, addr 0x43a46a0, size 0x8, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::AsnEncodedData* get_EncodedKeyValue() ;

/// @brief Method get_EncodedParameters, addr 0x43a46a8, size 0x8, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::AsnEncodedData* get_EncodedParameters() ;

/// @brief Method get_Key, addr 0x43a46b0, size 0x1a4, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::AsymmetricAlgorithm* get_Key() ;

/// @brief Method get_Oid, addr 0x43a5070, size 0x8, virtual false, abstract: false, final false
