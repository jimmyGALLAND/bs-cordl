...
/// @brief Method CopyWithPrivateKey, addr 0x43a9dfc, size 0xac, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x43a9ea8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
