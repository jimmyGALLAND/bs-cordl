...
/// @brief Method CopyFrom, addr 0x43b0d00, size 0x1c8, virtual true, abstract: false, final false
inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData*  asnEncodedData) ;

/// @brief Method Decode, addr 0x43b079c, size 0x240, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  extension) ;

/// @brief Method Encode, addr 0x43b0b58, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x43b0ec8, size 0x2d8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43a80d4, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x43a4464, size 0xd4, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::AsnEncodedData*  encodedEnhancedKeyUsages, bool  critical) ;

/// @brief Method .ctor, addr 0x43b09dc, size 0x17c, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::OidCollection*  enhancedKeyUsages, bool  critical) ;

/// @brief Method get_EnhancedKeyUsages, addr 0x43b0c14, size 0xec, virtual false, abstract: false, final false
