...
/// @brief Method Build, addr 0x43ab290, size 0x40, virtual false, abstract: false, final false
inline bool Build(::System::Security::Cryptography::X509Certificates::X509Certificate2*  certificate) ;

/// @brief Method Create, addr 0x43ab22c, size 0x64, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::X509Certificates::X509Chain* Create() ;

/// @brief Method Dispose, addr 0x43ac654, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x43ac6c0, size 0x20, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x43ac74c, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x43ac624, size 0x30, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x43ac4c4, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x43ac554, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  chainContext) ;

/// @brief Method .ctor, addr 0x43ac520, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::X509Certificates::X509ChainImpl*  impl) ;

/// @brief Method .ctor, addr 0x43ac4ec, size 0x34, virtual false, abstract: false, final false
inline void _ctor(bool  useMachineContext) ;

/// @brief Method get_ChainElements, addr 0x43ac594, size 0x30, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* get_ChainElements() ;

/// @brief Method get_ChainPolicy, addr 0x43ac5c4, size 0x30, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509ChainPolicy* get_ChainPolicy() ;

/// @brief Method get_ChainStatus, addr 0x43ac5f4, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_Impl, addr 0x43ac4a4, size 0x20, virtual false, abstract: false, final false
