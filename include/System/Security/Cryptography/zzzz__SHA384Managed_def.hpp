...
/// @brief Method Ch, addr 0x3c1aee4, size 0x10, virtual false, abstract: false, final false
static inline uint64_t Ch(uint64_t  x, uint64_t  y, uint64_t  z) ;

/// @brief Method HashCore, addr 0x3c1a2bc, size 0x4, virtual true, abstract: false, final false
inline void HashCore(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb, int32_t  ibStart, int32_t  cbSize) ;

/// @brief Method HashFinal, addr 0x3c1a488, size 0x4, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> HashFinal() ;

/// @brief Method Initialize, addr 0x3c1a278, size 0x44, virtual true, abstract: false, final false
inline void Initialize() ;

/// @brief Method InitializeState, addr 0x3c1a178, size 0x100, virtual false, abstract: false, final false
inline void InitializeState() ;

/// @brief Method Maj, addr 0x3c1af50, size 0x14, virtual false, abstract: false, final false
static inline uint64_t Maj(uint64_t  x, uint64_t  y, uint64_t  z) ;

static inline ::System::Security::Cryptography::SHA384Managed* New_ctor() ;

/// @brief Method RotateRight, addr 0x3c1af64, size 0x8, virtual false, abstract: false, final false
static inline uint64_t RotateRight(uint64_t  x, int32_t  n) ;

/// @brief Method SHA384Expand, addr 0x3c1ade0, size 0xa8, virtual false, abstract: false, final false
static inline void SHA384Expand(::cordl_internals::Ptr<uint64_t>  x) ;

/// @brief Method SHATransform, addr 0x3c1a634, size 0x56c, virtual false, abstract: false, final false
...
/// @brief Method Sigma_0, addr 0x3c1aef4, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t Sigma_0(uint64_t  x) ;

/// @brief Method Sigma_1, addr 0x3c1ae88, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t Sigma_1(uint64_t  x) ;

/// @brief Method _EndHash, addr 0x3c1a48c, size 0x1a8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> _EndHash() ;

/// @brief Method _HashData, addr 0x3c1a2c0, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c1a0b0, size 0xc8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method sigma_0, addr 0x3c1af6c, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t sigma_0(uint64_t  x) ;

/// @brief Method sigma_1, addr 0x3c1afc8, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t sigma_1(uint64_t  x) ;
