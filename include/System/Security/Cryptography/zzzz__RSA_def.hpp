...
public:
// Declarations
/// @brief Method Create, addr 0x3c172f0, size 0x6c, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::RSA* Create() ;

/// @brief Method EncryptValue, addr 0x3c17388, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method FromXmlString, addr 0x3c173e0, size 0x52c, virtual true, abstract: false, final false
...
/// @brief Method ToXmlString, addr 0x3c17928, size 0x430, virtual true, abstract: false, final false
inline ::StringW ToXmlString(bool  includePrivateParameters) ;

/// @brief Method .ctor, addr 0x3c172e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
