...
/// @brief Method FromOidValue, addr 0x43a29cc, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43a288c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x43a2894, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::StringW  oid) ;

/// @brief Method .ctor, addr 0x43a294c, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::Oid*  oid) ;

/// @brief Method .ctor, addr 0x43a2920, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  value, ::StringW  friendlyName) ;

/// @brief Method .ctor, addr 0x43a2af8, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  value, ::StringW  friendlyName, ::System::Security::Cryptography::OidGroup  group) ;

/// @brief Method get_FriendlyName, addr 0x43a2b44, size 0x84, virtual false, abstract: false, final false
inline ::StringW get_FriendlyName() ;

/// @brief Method get_Value, addr 0x43a2b34, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Value, addr 0x43a2b3c, size 0x8, virtual false, abstract: false, final false
