...
/// @brief Method SetHashAlgorithm, addr 0x3c1003c, size 0xc4, virtual true, abstract: false, final false
inline void SetHashAlgorithm(::StringW  strName) ;

/// @brief Method SetKey, addr 0x3c0ff54, size 0xe8, virtual true, abstract: false, final false
inline void SetKey(::System::Security::Cryptography::AsymmetricAlgorithm*  key) ;

/// @brief Method VerifySignature, addr 0x3c10100, size 0xe0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c0fde4, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3c0fe64, size 0xf0, virtual false, abstract: false, final false
