...
/// @brief Method Ch, addr 0x3c1bd1c, size 0x10, virtual false, abstract: false, final false
static inline uint64_t Ch(uint64_t  x, uint64_t  y, uint64_t  z) ;

/// @brief Method HashCore, addr 0x3c1b334, size 0x4, virtual true, abstract: false, final false
inline void HashCore(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb, int32_t  ibStart, int32_t  cbSize) ;

/// @brief Method HashFinal, addr 0x3c1b500, size 0x4, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> HashFinal() ;

/// @brief Method Initialize, addr 0x3c1b2f0, size 0x44, virtual true, abstract: false, final false
inline void Initialize() ;

/// @brief Method InitializeState, addr 0x3c1b1f0, size 0x100, virtual false, abstract: false, final false
inline void InitializeState() ;

/// @brief Method Maj, addr 0x3c1bd88, size 0x14, virtual false, abstract: false, final false
static inline uint64_t Maj(uint64_t  x, uint64_t  y, uint64_t  z) ;

static inline ::System::Security::Cryptography::SHA512Managed* New_ctor() ;

/// @brief Method RotateRight, addr 0x3c1bd9c, size 0x8, virtual false, abstract: false, final false
static inline uint64_t RotateRight(uint64_t  x, int32_t  n) ;

/// @brief Method SHA512Expand, addr 0x3c1bc18, size 0xa8, virtual false, abstract: false, final false
static inline void SHA512Expand(::cordl_internals::Ptr<uint64_t>  x) ;

/// @brief Method SHATransform, addr 0x3c1b6ac, size 0x56c, virtual false, abstract: false, final false
...
/// @brief Method Sigma_0, addr 0x3c1bd2c, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t Sigma_0(uint64_t  x) ;

/// @brief Method Sigma_1, addr 0x3c1bcc0, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t Sigma_1(uint64_t  x) ;

/// @brief Method _EndHash, addr 0x3c1b504, size 0x1a8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> _EndHash() ;

/// @brief Method _HashData, addr 0x3c1b338, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c1b128, size 0xc8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method sigma_0, addr 0x3c1bda4, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t sigma_0(uint64_t  x) ;

/// @brief Method sigma_1, addr 0x3c1be00, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t sigma_1(uint64_t  x) ;
