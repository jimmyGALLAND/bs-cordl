...
/// @brief Method Create, addr 0x3c1058c, size 0x68, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::HMAC* Create() ;

/// @brief Method Dispose, addr 0x3c10814, size 0x164, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method HashCore, addr 0x3c10664, size 0x80, virtual true, abstract: false, final false
inline void HashCore(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb, int32_t  ib, int32_t  cb) ;

/// @brief Method HashFinal, addr 0x3c106e4, size 0x130, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> HashFinal() ;

/// @brief Method Initialize, addr 0x3c1061c, size 0x48, virtual true, abstract: false, final false
inline void Initialize() ;

/// @brief Method InitializeKey, addr 0x3c103dc, size 0xd0, virtual false, abstract: false, final false
inline void InitializeKey(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

static inline ::System::Security::Cryptography::HMAC* New_ctor() ;

/// @brief Method UpdateIOPadBuffers, addr 0x3c10270, size 0x16c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c109b0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BlockSizeValue, addr 0x3c10260, size 0x8, virtual false, abstract: false, final false
inline int32_t get_BlockSizeValue() ;

/// @brief Method get_Key, addr 0x3c104ac, size 0x78, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Key() ;

/// @brief Method set_BlockSizeValue, addr 0x3c10268, size 0x8, virtual false, abstract: false, final false
inline void set_BlockSizeValue(int32_t  value) ;

/// @brief Method set_Key, addr 0x3c10524, size 0x68, virtual true, abstract: false, final false
