...
/// @brief Method MoveNext, addr 0x43a300c, size 0x4c, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::System::Security::Cryptography::OidEnumerator* New_ctor(::System::Security::Cryptography::OidCollection*  oids) ;

/// @brief Method Reset, addr 0x43a3058, size 0xc, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x43a3008, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x43a2dfc, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::OidCollection*  oids) ;

/// @brief Method get_Current, addr 0x43a2fe8, size 0x20, virtual false, abstract: false, final false
