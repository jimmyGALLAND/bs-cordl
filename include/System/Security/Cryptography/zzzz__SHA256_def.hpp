...
public:
// Declarations
/// @brief Method Create, addr 0x3c19268, size 0x50, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::SHA256* Create() ;

static inline ::System::Security::Cryptography::SHA256* New_ctor() ;

/// @brief Method .ctor, addr 0x3c19248, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
