...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Security::AccessControl::DirectorySecurity::*)(::StringW, ::System::Security::AccessControl::AccessControlSections)>(&::System::Security::AccessControl::DirectorySecurity::_ctor)> {
  constexpr static std::size_t size = 0x18;
  constexpr static std::size_t addrs = 0x3c34a84;
...
inline ::System::Security::AccessControl::DirectorySecurity* System::Security::AccessControl::DirectorySecurity::New_ctor(::StringW  name, ::System::Security::AccessControl::AccessControlSections  includeSections)  {
