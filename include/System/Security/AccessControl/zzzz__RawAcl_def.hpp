...
/// @brief Method InsertAce, addr 0x3c34068, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method RemoveAce, addr 0x3c33aec, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c32a28, size 0xb4, virtual false, abstract: false, final false
inline void _ctor(uint8_t  revision, int32_t  capacity) ;

/// @brief Method get_Count, addr 0x3c35ff0, size 0x48, virtual true, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Item, addr 0x3c36038, size 0x58, virtual true, abstract: false, final false
inline ::System::Security::AccessControl::GenericAce* get_Item(int32_t  index) ;

/// @brief Method set_Item, addr 0x3c36090, size 0x68, virtual true, abstract: false, final false
