...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Security::Principal::GenericPrincipal::*)(::System::Security::Principal::IIdentity*, ::ArrayW<::StringW,::Array<::StringW>*>)>(&::System::Security::Principal::GenericPrincipal::_ctor)> {
  constexpr static std::size_t size = 0x13c;
  constexpr static std::size_t addrs = 0x3c28604;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Security::Principal::IIdentity*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<::StringW,::Array<::StringW>*>>::get()}
                    )));
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Principal::IIdentity*> const& System::Security::Principal::GenericPrincipal::__cordl_internal_get_m_identity() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_identity;
}
