...
/// @brief Method CloseToken, addr 0x3c2cfe4, size 0x4, virtual false, abstract: false, final false
static inline bool CloseToken(::System::IntPtr  token) ;

/// @brief Method Dispose, addr 0x3c2cf10, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DuplicateToken, addr 0x3c2cf08, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method RevertToSelf, addr 0x3c2cfe0, size 0x4, virtual false, abstract: false, final false
static inline bool RevertToSelf() ;

/// @brief Method SetCurrentToken, addr 0x3c2cf0c, size 0x4, virtual false, abstract: false, final false
static inline bool SetCurrentToken(::System::IntPtr  token) ;

/// @brief Method Undo, addr 0x3c2cf20, size 0xc0, virtual false, abstract: false, final false
inline void Undo() ;
...
/// @brief Method .ctor, addr 0x3c2c82c, size 0x88, virtual false, abstract: false, final false
