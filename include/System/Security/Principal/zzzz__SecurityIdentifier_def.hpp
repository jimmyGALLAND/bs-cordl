...
/// @brief Method CompareTo, addr 0x3c297dc, size 0x168, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Security::Principal::SecurityIdentifier*  sid) ;

/// @brief Method CreateFromBinaryForm, addr 0x3c2937c, size 0x160, virtual false, abstract: false, final false
inline void CreateFromBinaryForm(::System::IntPtr  binaryForm, int32_t  length) ;

/// @brief Method Equals, addr 0x3c299ac, size 0x64, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method Equals, addr 0x3c29a10, size 0xa8, virtual false, abstract: false, final false
inline bool Equals(::System::Security::Principal::SecurityIdentifier*  sid) ;

/// @brief Method GetBinaryForm, addr 0x3c29ab8, size 0xc0, virtual false, abstract: false, final false
inline void GetBinaryForm(::ArrayW<uint8_t,::Array<uint8_t>*>  binaryForm, int32_t  offset) ;

/// @brief Method GetHashCode, addr 0x3c29b78, size 0x28, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetSidAuthority, addr 0x3c296b4, size 0x80, virtual false, abstract: false, final false
inline uint64_t GetSidAuthority() ;

/// @brief Method GetSidSubAuthority, addr 0x3c29734, size 0x7c, virtual false, abstract: false, final false
inline uint32_t GetSidSubAuthority(uint8_t  index) ;

/// @brief Method GetSidSubAuthorityCount, addr 0x3c297b0, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method ParseSddlForm, addr 0x3c28e58, size 0x440, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> ParseSddlForm(::StringW  sddlForm) ;

/// @brief Method ToString, addr 0x3c29ba0, size 0xc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Translate, addr 0x3c29bac, size 0x218, virtual true, abstract: false, final false
inline ::System::Security::Principal::IdentityReference* Translate(::System::Type*  targetType) ;

/// @brief Method TryParseAuthority, addr 0x3c29f44, size 0xe0, virtual false, abstract: false, final false
static inline bool TryParseAuthority(::StringW  s, ByRef<uint64_t>  result) ;

/// @brief Method TryParseSubAuthority, addr 0x3c2a024, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c29298, size 0xe4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  binaryForm, int32_t  offset) ;

/// @brief Method .ctor, addr 0x3c28da0, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method get_BinaryLength, addr 0x3c294dc, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_BinaryLength() ;

/// @brief Method get_Value, addr 0x3c294f8, size 0x1bc, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x3c29944, size 0x68, virtual false, abstract: false, final false
