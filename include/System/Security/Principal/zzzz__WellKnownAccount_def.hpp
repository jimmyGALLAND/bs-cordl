...
static __declspec(property(get=getStaticF_accounts, put=setStaticF_accounts)) ::ArrayW<::System::Security::Principal::WellKnownAccount*,::Array<::System::Security::Principal::WellKnownAccount*>*>  accounts;

/// @brief Method LookupByName, addr 0x3c28ce0, size 0xc0, virtual false, abstract: false, final false
static inline ::System::Security::Principal::WellKnownAccount* LookupByName(::StringW  s) ;

/// @brief Method LookupBySddlForm, addr 0x3c29e84, size 0xc0, virtual false, abstract: false, final false
static inline ::System::Security::Principal::WellKnownAccount* LookupBySddlForm(::StringW  s) ;

/// @brief Method LookupBySid, addr 0x3c29dc4, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c2a1a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_IsAbsolute, addr 0x3c2a15c, size 0x8, virtual false, abstract: false, final false
inline bool get_IsAbsolute() ;

/// @brief Method get_Name, addr 0x3c2a188, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_SddlForm, addr 0x3c2a198, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SddlForm() ;

/// @brief Method get_Sid, addr 0x3c2a170, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_IsAbsolute, addr 0x3c2a164, size 0xc, virtual false, abstract: false, final false
inline void set_IsAbsolute(bool  value) ;

/// @brief Method set_Name, addr 0x3c2a190, size 0x8, virtual false, abstract: false, final false
inline void set_Name(::StringW  value) ;

/// @brief Method set_Rid, addr 0x3c2a180, size 0x8, virtual false, abstract: false, final false
inline void set_Rid(::StringW  value) ;

/// @brief Method set_SddlForm, addr 0x3c2a1a0, size 0x8, virtual false, abstract: false, final false
inline void set_SddlForm(::StringW  value) ;

/// @brief Method set_Sid, addr 0x3c2a178, size 0x8, virtual false, abstract: false, final false
inline void set_Sid(::StringW  value) ;

/// @brief Method set_WellKnownValue, addr 0x3c2a154, size 0x8, virtual false, abstract: false, final false
