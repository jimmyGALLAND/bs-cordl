...
/// @brief Method .ctor, addr 0x3c2883c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Value, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
inline ::StringW get_Value() ;

/// @brief Method op_Equality, addr 0x3c28844, size 0x68, virtual false, abstract: false, final false
