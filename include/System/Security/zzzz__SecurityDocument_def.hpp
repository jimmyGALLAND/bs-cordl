...
/// @brief Method AddString, addr 0x3c02a44, size 0x14c, virtual false, abstract: false, final false
inline void AddString(::StringW  str, ByRef<int32_t>  position) ;

/// @brief Method AddToken, addr 0x3c03158, size 0x5c, virtual false, abstract: false, final false
inline void AddToken(uint8_t  b, ByRef<int32_t>  position) ;

/// @brief Method AppendString, addr 0x3c02b90, size 0x8c, virtual false, abstract: false, final false
inline void AppendString(::StringW  str, ByRef<int32_t>  position) ;

/// @brief Method EncodedStringSize, addr 0x3c02c1c, size 0x20, virtual false, abstract: false, final false
static inline int32_t EncodedStringSize(::StringW  str) ;

/// @brief Method GetElement, addr 0x3c031d0, size 0x1c, virtual false, abstract: false, final false
inline ::System::Security::SecurityElement* GetElement(int32_t  position, bool  bCreate) ;

/// @brief Method GetRootElement, addr 0x3c031b4, size 0x1c, virtual false, abstract: false, final false
inline ::System::Security::SecurityElement* GetRootElement() ;

/// @brief Method GetString, addr 0x3c02c3c, size 0x300, virtual false, abstract: false, final false
inline ::StringW GetString(ByRef<int32_t>  position, bool  bCreate) ;

/// @brief Method GuaranteeSize, addr 0x3c029a0, size 0xa4, virtual false, abstract: false, final false
inline void GuaranteeSize(int32_t  size) ;

/// @brief Method InternalGetElement, addr 0x3c031ec, size 0x1fc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3c02938, size 0x68, virtual false, abstract: false, final false
