...
/// @brief Method AddModifier, addr 0x3db43f0, size 0xec, virtual false, abstract: false, final false
inline void AddModifier(::System::ModifierSpec*  md) ;

/// @brief Method AddName, addr 0x3db42c4, size 0x124, virtual false, abstract: false, final false
inline void AddName(::StringW  type_name) ;

/// @brief Method BoundCheck, addr 0x3db458c, size 0x84, virtual false, abstract: false, final false
static inline void BoundCheck(int32_t  idx, ::StringW  s) ;

/// @brief Method GetDisplayFullName, addr 0x3db2604, size 0x46c, virtual false, abstract: false, final false
inline ::StringW GetDisplayFullName(::System::__TypeSpec__DisplayNameFormat  flags) ;

/// @brief Method GetModifierString, addr 0x3db2a98, size 0x1f4, virtual false, abstract: false, final false
inline ::System::Text::StringBuilder* GetModifierString(::System::Text::StringBuilder*  sb) ;

static inline ::System::TypeSpec* New_ctor() ;

/// @brief Method Parse, addr 0x3db2d5c, size 0xba0, virtual false, abstract: false, final false
static inline ::System::TypeSpec* Parse(::StringW  name, ByRef<int32_t>  p, bool  is_recurse, bool  allow_aqn) ;

/// @brief Method Parse, addr 0x3db2c8c, size 0xd0, virtual false, abstract: false, final false
static inline ::System::TypeSpec* Parse(::StringW  typeName) ;

/// @brief Method ParsedTypeIdentifier, addr 0x3db43e8, size 0x8, virtual false, abstract: false, final false
static inline ::System::TypeIdentifier* ParsedTypeIdentifier(::StringW  displayName) ;

/// @brief Method Resolve, addr 0x3db39f0, size 0x8d4, virtual false, abstract: false, final false
...
/// @brief Method SkipSpace, addr 0x3db44dc, size 0xb0, virtual false, abstract: false, final false
static inline void SkipSpace(::StringW  name, ByRef<int32_t>  pos) ;

/// @brief Method UnescapeInternalName, addr 0x3db38fc, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3db4610, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_DisplayFullName, addr 0x3db2a70, size 0x28, virtual false, abstract: false, final false
inline ::StringW get_DisplayFullName() ;

/// @brief Method get_HasModifiers, addr 0x3db25f4, size 0x10, virtual false, abstract: false, final false
