...
/// @brief Method .ctor, addr 0x3c91764, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  memberName) ;

/// @brief Method get_MemberName, addr 0x3c9178c, size 0x8, virtual false, abstract: false, final false
