...
/// @brief Method ExpandPrime, addr 0x3d2872c, size 0x84, virtual false, abstract: false, final false
static inline int32_t ExpandPrime(int32_t  oldSize) ;

/// @brief Method GetPrime, addr 0x3d285a4, size 0x188, virtual false, abstract: false, final false
static inline int32_t GetPrime(int32_t  min) ;

/// @brief Method IsPrime, addr 0x3d284ec, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method get_SerializationInfoTable, addr 0x3d287b0, size 0xd8, virtual false, abstract: false, final false
