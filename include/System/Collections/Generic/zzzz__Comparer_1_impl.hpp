...
::cordl_internals::setStaticField<::System::Collections::Generic::Comparer_1<T>*, "defaultComparer", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Collections::Generic::Comparer_1<T>*>::get>(std::forward<::System::Collections::Generic::Comparer_1<T>*>(value));
}
template<typename T>
inline ::System::Collections::Generic::Comparer_1<T>* System::Collections::Generic::Comparer_1<T>::getStaticF_defaultComparer()  {
return ::cordl_internals::getStaticField<::System::Collections::Generic::Comparer_1<T>*, "defaultComparer", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Collections::Generic::Comparer_1<T>*>::get>();
}
template<typename T>
