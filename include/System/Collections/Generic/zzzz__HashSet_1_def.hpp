...
/// @brief Field _slots, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__slots, put=__cordl_internal_set__slots)) ::ArrayW<::System::Collections::Generic::__HashSet_1__Slot<T>,::Array<::System::Collections::Generic::__HashSet_1__Slot<T>>*>  _slots;
