...
template<typename T>
constexpr ::ArrayW<T,::Array<T>*>& System::Collections::Generic::LowLevelList_1<T>::__cordl_internal_get__items()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____items;
}
template<typename T>
constexpr ::ArrayW<T,::Array<T>*> const& System::Collections::Generic::LowLevelList_1<T>::__cordl_internal_get__items() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____items;
}
template<typename T>
constexpr void System::Collections::Generic::LowLevelList_1<T>::__cordl_internal_set__items(::ArrayW<T,::Array<T>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
