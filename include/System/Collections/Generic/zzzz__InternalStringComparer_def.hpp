...
public:
// Declarations
/// @brief Method Equals, addr 0x3d38db0, size 0x30, virtual true, abstract: false, final false
inline bool Equals(::StringW  x, ::StringW  y) ;

/// @brief Method GetHashCode, addr 0x3d38d90, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode(::StringW  obj) ;

/// @brief Method IndexOf, addr 0x3d38de0, size 0x68, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3d38e48, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
