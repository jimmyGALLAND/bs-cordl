...
static __declspec(property(get=getStaticF_s_defaultArraySortHelper, put=setStaticF_s_defaultArraySortHelper)) ::System::Collections::Generic::ArraySortHelper_2<TKey,TValue>*  s_defaultArraySortHelper;
