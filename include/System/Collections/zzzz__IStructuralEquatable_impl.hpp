...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::System::Collections::IStructuralEquatable::*)(::System::Object*, ::System::Collections::IEqualityComparer*)>(&::System::Collections::IStructuralEquatable::Equals)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::System::Collections::IStructuralEquatable::*)(::System::Collections::IEqualityComparer*)>(&::System::Collections::IStructuralEquatable::GetHashCode)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
