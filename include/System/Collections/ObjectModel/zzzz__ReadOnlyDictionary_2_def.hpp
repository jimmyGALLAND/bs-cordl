...
template<typename TKey,typename TValue>
struct __ReadOnlyDictionary_2__DictionaryEnumerator;
}
namespace System::Collections::ObjectModel {
template<typename TKey,typename TValue>
class __ReadOnlyDictionary_2__KeyCollection;
}
namespace System::Collections::ObjectModel {
template<typename TKey,typename TValue>
class __ReadOnlyDictionary_2__ValueCollection;
}
...
constexpr __ReadOnlyDictionary_2__DictionaryEnumerator(::System::Collections::Generic::IDictionary_2<TKey,TValue>*  _dictionary, ::System::Collections::Generic::IEnumerator_1<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>*  _enumerator) noexcept;
