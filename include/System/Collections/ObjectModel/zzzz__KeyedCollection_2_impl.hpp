...
template<typename TKey,typename TItem>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEqualityComparer_1<TKey>*> const& System::Collections::ObjectModel::KeyedCollection_2<TKey,TItem>::__cordl_internal_get_comparer() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___comparer;
}
template<typename TKey,typename TItem>
...
template<typename TKey,typename TItem>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<TKey,TItem>*> const& System::Collections::ObjectModel::KeyedCollection_2<TKey,TItem>::__cordl_internal_get_dict() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___dict;
}
template<typename TKey,typename TItem>
