...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<T>*> const& System::Collections::ObjectModel::Collection_1<T>::__cordl_internal_get_items() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___items;
}
template<typename T>
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Collections::ObjectModel::Collection_1<T>*>(list));
}
template<typename T>
...
template<typename T>
inline void System::Collections::ObjectModel::Collection_1<T>::CopyTo(::ArrayW<T,::Array<T>*>  array, int32_t  index)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Collections::ObjectModel::Collection_1<T>*>::get(),
                        "CopyTo",
                        std::span<const Il2CppClass* const, 0>(),
