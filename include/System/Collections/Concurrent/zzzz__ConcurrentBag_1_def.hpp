...
namespace System::Collections::Concurrent {
template<typename T>
class __ConcurrentBag_1__Enumerator;
}
namespace System::Collections::Concurrent {
template<typename T>
class __ConcurrentBag_1__WorkStealingQueue;
}
...
/// @brief Field _locals, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__locals, put=__cordl_internal_set__locals)) ::System::Threading::ThreadLocal_1<::System::Collections::Concurrent::__ConcurrentBag_1__WorkStealingQueue<T>*>*  _locals;

/// @brief Field _workStealingQueues, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__workStealingQueues, put=__cordl_internal_set__workStealingQueues)) ::System::Collections::Concurrent::__ConcurrentBag_1__WorkStealingQueue<T>*  _workStealingQueues;
...
inline bool TryStealFromTo(::System::Collections::Concurrent::__ConcurrentBag_1__WorkStealingQueue<T>*  startInclusive, ::System::Collections::Concurrent::__ConcurrentBag_1__WorkStealingQueue<T>*  endExclusive, ByRef<T>  result, bool  take) ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::ThreadLocal_1<::System::Collections::Concurrent::__ConcurrentBag_1__WorkStealingQueue<T>*>*> const& __cordl_internal_get__locals() const;
