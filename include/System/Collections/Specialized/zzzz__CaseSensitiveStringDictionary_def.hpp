...
public:
// Declarations
/// @brief Method Add, addr 0x43f3334, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x43f3330, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
