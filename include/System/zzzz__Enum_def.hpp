...
public:
// Declarations
/// @brief Method GetEnumParseException, addr 0x3d8eb44, size 0x16c, virtual false, abstract: false, final false
inline ::System::Exception* GetEnumParseException() ;

/// @brief Method Init, addr 0x3d8e488, size 0x68, virtual false, abstract: false, final false
inline void Init(bool  canMethodThrow) ;

/// @brief Method SetFailure, addr 0x3d8ecec, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method SetFailure, addr 0x3d8ecb0, size 0x3c, virtual false, abstract: false, final false
inline void SetFailure(::System::__Enum__ParseFailureKind  failure, ::StringW  failureParameter) ;

/// @brief Method SetFailure, addr 0x3d8f2ec, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3d8d924, size 0x2c, virtual false, abstract: false, final false
