...
template<typename T>
inline ::ArrayW<T,::Array<T>*> System::Buffers::ArrayPool_1<T>::Rent(int32_t  minimumLength)  {
...
template<typename T>
inline void System::Buffers::ArrayPool_1<T>::Return(::ArrayW<T,::Array<T>*>  array, bool  clearArray)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Buffers::ArrayPool_1<T>*>::get(),
                    5
