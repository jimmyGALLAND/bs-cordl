...
public:
// Declarations
/// @brief Method ReverseEndianness, addr 0x3d3931c, size 0x8, virtual false, abstract: false, final false
static inline int32_t ReverseEndianness(int32_t  value) ;

/// @brief Method ReverseEndianness, addr 0x3d39324, size 0x8, virtual false, abstract: false, final false
static inline int64_t ReverseEndianness(int64_t  value) ;

/// @brief Method ReverseEndianness, addr 0x3d3932c, size 0xc, virtual false, abstract: false, final false
static inline uint16_t ReverseEndianness(uint16_t  value) ;

/// @brief Method ReverseEndianness, addr 0x3d39338, size 0x8, virtual false, abstract: false, final false
static inline uint32_t ReverseEndianness(uint32_t  value) ;

/// @brief Method ReverseEndianness, addr 0x3d39340, size 0x8, virtual false, abstract: false, final false
