...
static __declspec(property(get=getStaticF_s_switchMap, put=setStaticF_s_switchMap)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::__AppContext__SwitchValueState>*  s_switchMap;

/// @brief Method InitializeDefaultSwitchValues, addr 0x3d830d0, size 0x174, virtual false, abstract: false, final false
static inline void InitializeDefaultSwitchValues() ;

/// @brief Method TryGetSwitch, addr 0x3d83244, size 0x408, virtual false, abstract: false, final false
