...
/// @brief Method EnsureVMInitialized, addr 0x3dca1e4, size 0x94, virtual false, abstract: false, final false
static inline void EnsureVMInitialized() ;

/// @brief Method InitializeVMTp, addr 0x3dca390, size 0x4, virtual false, abstract: false, final false
static inline void InitializeVMTp(ByRef<bool>  enableWorkerTracking) ;

/// @brief Method NotifyWorkItemComplete, addr 0x3dc933c, size 0x4, virtual false, abstract: false, final false
static inline bool NotifyWorkItemComplete() ;

/// @brief Method NotifyWorkItemProgress, addr 0x3dca39c, size 0x10, virtual false, abstract: false, final false
static inline void NotifyWorkItemProgress() ;

/// @brief Method NotifyWorkItemProgressNative, addr 0x3dca3ac, size 0x4, virtual false, abstract: false, final false
static inline void NotifyWorkItemProgressNative() ;

/// @brief Method NotifyWorkItemQueued, addr 0x3dc851c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method QueueUserWorkItem, addr 0x3dca1b8, size 0x2c, virtual false, abstract: false, final false
static inline bool QueueUserWorkItem(::System::Threading::WaitCallback*  callBack) ;

/// @brief Method QueueUserWorkItem, addr 0x3dc9ea0, size 0x28, virtual false, abstract: false, final false
static inline bool QueueUserWorkItem(::System::Threading::WaitCallback*  callBack, ::System::Object*  state) ;

/// @brief Method QueueUserWorkItemHelper, addr 0x3dca0a0, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method RegisterWaitForSingleObject, addr 0x3dc9ef0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method RegisterWaitForSingleObject, addr 0x3dc9c2c, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method RegisterWaitForSingleObject, addr 0x3dc9f70, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method ReportThreadStatus, addr 0x3dca394, size 0x8, virtual false, abstract: false, final false
static inline void ReportThreadStatus(bool  isWorking) ;

/// @brief Method RequestWorkerThread, addr 0x3dc7e24, size 0x4, virtual false, abstract: false, final false
static inline bool RequestWorkerThread() ;

/// @brief Method TryPopCustomWorkItem, addr 0x3dca2f4, size 0x9c, virtual false, abstract: false, final false
static inline bool TryPopCustomWorkItem(::System::Threading::IThreadPoolWorkItem*  workItem) ;

/// @brief Method UnsafeQueueCustomWorkItem, addr 0x3dca278, size 0x7c, virtual false, abstract: false, final false
static inline void UnsafeQueueCustomWorkItem(::System::Threading::IThreadPoolWorkItem*  workItem, bool  forceGlobal) ;

/// @brief Method UnsafeQueueUserWorkItem, addr 0x3dc9ec8, size 0x28, virtual false, abstract: false, final false
static inline bool UnsafeQueueUserWorkItem(::System::Threading::WaitCallback*  callBack, ::System::Object*  state) ;

/// @brief Method get_IsThreadPoolThread, addr 0x3dca3b0, size 0x20, virtual false, abstract: false, final false
