...
/// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x3dc244c, size 0x4c, virtual true, abstract: false, final true
inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem() ;

/// @brief Method System.Threading.IThreadPoolWorkItem.MarkAborted, addr 0x3dc2498, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3dc1d3c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x3dc249c, size 0x804, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3dc2ca0, size 0x7c, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<bool>", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "asyncWaiter", ty: "::System::Threading::__SemaphoreSlim__TaskNode*", modifiers: "", def_value: None }, CppParam { name: "millisecondsTimeout", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::System::Threading::SemaphoreSlim*", modifiers: "", def_value: None }, CppParam { name: "_cts_5__2", ty: "::System::Threading::CancellationTokenSource*", modifiers: "", def_value: None }, CppParam { name: "__7__wrap2", ty: "::System::Object*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::System::Threading::Tasks::Task*>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<bool>", modifiers: "", def_value: None }]
...
static __declspec(property(get=getStaticF_s_cancellationTokenCanceledEventHandler, put=setStaticF_s_cancellationTokenCanceledEventHandler)) ::System::Action_1<::System::Object*>*  s_cancellationTokenCanceledEventHandler;
...
/// @brief Method CancellationTokenCanceledEventHandler, addr 0x3dc2218, size 0x110, virtual false, abstract: false, final false
static inline void CancellationTokenCanceledEventHandler(::System::Object*  obj) ;

/// @brief Method CheckDispose, addr 0x3dc16c0, size 0x7c, virtual false, abstract: false, final false
inline void CheckDispose() ;

/// @brief Method CreateAndAddAsyncWaiter, addr 0x3dc1ba0, size 0x84, virtual false, abstract: false, final false
inline ::System::Threading::__SemaphoreSlim__TaskNode* CreateAndAddAsyncWaiter() ;

/// @brief Method Dispose, addr 0x3dc2150, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x3dc21bc, size 0x5c, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GetResourceString, addr 0x3dc1184, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method QueueWaiterTask, addr 0x3dc2144, size 0xc, virtual false, abstract: false, final false
static inline void QueueWaiterTask(::System::Threading::__SemaphoreSlim__TaskNode*  waiterTask) ;

/// @brief Method Release, addr 0x3dc1e04, size 0x8, virtual false, abstract: false, final false
inline int32_t Release() ;

/// @brief Method Release, addr 0x3dc1e0c, size 0x2e4, virtual false, abstract: false, final false
inline int32_t Release(int32_t  releaseCount) ;

/// @brief Method RemoveAsyncWaiter, addr 0x3dc1d84, size 0x80, virtual false, abstract: false, final false
inline bool RemoveAsyncWaiter(::System::Threading::__SemaphoreSlim__TaskNode*  task) ;

/// @brief Method Wait, addr 0x3dc16b8, size 0x8, virtual false, abstract: false, final false
inline bool Wait(int32_t  millisecondsTimeout) ;

/// @brief Method Wait, addr 0x3dc1198, size 0x520, virtual false, abstract: false, final false
inline bool Wait(int32_t  millisecondsTimeout, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method Wait, addr 0x3dc118c, size 0xc, virtual false, abstract: false, final false
inline void Wait() ;

/// @brief Method WaitAsync, addr 0x3dc1b88, size 0xc, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* WaitAsync() ;

/// @brief Method WaitAsync, addr 0x3dc1b94, size 0xc, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* WaitAsync(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method WaitAsync, addr 0x3dc173c, size 0x324, virtual false, abstract: false, final false
...
/// @brief Method WaitUntilCountOrTimeout, addr 0x3dc1a60, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method WaitUntilCountOrTimeoutAsync, addr 0x3dc1c24, size 0x118, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<bool>* WaitUntilCountOrTimeoutAsync(::System::Threading::__SemaphoreSlim__TaskNode*  asyncWaiter, int32_t  millisecondsTimeout, ::System::Threading::CancellationToken  cancellationToken) ;
...
/// @brief Method .ctor, addr 0x3dc0ff8, size 0x8, virtual false, abstract: false, final false
inline void _ctor(int32_t  initialCount) ;

/// @brief Method .ctor, addr 0x3dc1000, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method get_CurrentCount, addr 0x3dc0fe0, size 0x18, virtual false, abstract: false, final false
