...
/// @brief Method Compare, addr 0x3dcd720, size 0x70, virtual true, abstract: false, final true
inline int32_t Compare(::System::Threading::Timer*  tx, ::System::Threading::Timer*  ty) ;

/// @brief Method System.Collections.IComparer.Compare, addr 0x3dcd688, size 0x98, virtual true, abstract: false, final true
...
/// @brief Method Add, addr 0x3dcde10, size 0xec, virtual false, abstract: false, final false
inline void Add(::System::Threading::Timer*  timer) ;

/// @brief Method Change, addr 0x3dcd464, size 0x18c, virtual false, abstract: false, final false
inline void Change(::System::Threading::Timer*  timer, int64_t  new_next_run) ;

/// @brief Method FireTimer, addr 0x3dcdf74, size 0xc0, virtual false, abstract: false, final false
inline void FireTimer(::System::Threading::Timer*  timer) ;

/// @brief Method InitScheduler, addr 0x3dcd790, size 0xfc, virtual false, abstract: false, final false
inline void InitScheduler() ;

/// @brief Method InternalRemove, addr 0x3dcdde0, size 0x30, virtual false, abstract: false, final false
inline void InternalRemove(::System::Threading::Timer*  timer) ;

static inline ::System::Threading::__Timer__Scheduler* New_ctor() ;

/// @brief Method Remove, addr 0x3dcd394, size 0xcc, virtual false, abstract: false, final false
inline void Remove(::System::Threading::Timer*  timer) ;

/// @brief Method RunSchedulerLoop, addr 0x3dcd9d8, size 0x314, virtual false, abstract: false, final false
inline int32_t RunSchedulerLoop() ;

/// @brief Method SchedulerThread, addr 0x3dcd8a8, size 0x130, virtual false, abstract: false, final false
inline void SchedulerThread() ;

/// @brief Method TimerCB, addr 0x3dcdefc, size 0x78, virtual false, abstract: false, final false
static inline void TimerCB(::System::Object*  o) ;

/// @brief Method WakeupScheduler, addr 0x3dcd88c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3dcdd44, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Threading::__Timer__Scheduler* getStaticF_instance() ;

/// @brief Method get_Instance, addr 0x3dcdcec, size 0x58, virtual false, abstract: false, final false
...
// SizeInfo { instance_size: 72, native_size: -1, calculated_instance_size: 72, calculated_native_size: 67, minimum_alignment: 8, packing: None, specified_packing: None }
namespace System::Threading {
// Is value type: false
...
/// @brief Method Change, addr 0x3dcd2a4, size 0xb8, virtual false, abstract: false, final false
inline bool Change(::System::TimeSpan  dueTime, ::System::TimeSpan  period) ;

/// @brief Method Change, addr 0x3dcd284, size 0x20, virtual false, abstract: false, final false
inline bool Change(int32_t  dueTime, int32_t  period) ;

/// @brief Method Change, addr 0x3dcd0bc, size 0x1c8, virtual false, abstract: false, final false
inline bool Change(int64_t  dueTime, int64_t  period, bool  first) ;

/// @brief Method Dispose, addr 0x3dcd35c, size 0x38, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DisposeAsync, addr 0x3dcd5f0, size 0x94, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::ValueTask DisposeAsync() ;

/// @brief Method GetTimeMonotonic, addr 0x3dcd460, size 0x4, virtual false, abstract: false, final false
static inline int64_t GetTimeMonotonic() ;

/// @brief Method Init, addr 0x3dccf78, size 0x70, virtual false, abstract: false, final false
inline void Init(::System::Threading::TimerCallback*  callback, ::System::Object*  state, int64_t  dueTime, int64_t  period) ;

/// @brief Method KeepRootedWhileScheduled, addr 0x3dcd684, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3dccfe8, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3dccf2c, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(::System::Threading::TimerCallback*  callback, ::System::Object*  state, int32_t  dueTime, int32_t  period) ;

/// @brief Method get_scheduler, addr 0x3dccea4, size 0x88, virtual false, abstract: false, final false
