...
/// @brief Method <.cctor>b__26_0, addr 0x3dbd8b0, size 0x6c, virtual false, abstract: false, final false
inline void __cctor_b__26_0(::System::Object*  obj) ;

/// @brief Method .ctor, addr 0x3dbd8a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Equals, addr 0x3dbd4d4, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method Equals, addr 0x3dbd4c4, size 0x10, virtual false, abstract: false, final false
inline bool Equals(::System::Threading::CancellationToken  other) ;

/// @brief Method GetHashCode, addr 0x3dbd57c, size 0x74, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method InternalRegisterWithoutEC, addr 0x3dbd0ec, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method Register, addr 0x3dbce2c, size 0xf8, virtual false, abstract: false, final false
inline ::System::Threading::CancellationTokenRegistration Register(::System::Action*  callback) ;

/// @brief Method Register, addr 0x3dbd050, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method Register, addr 0x3dbcf24, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method ThrowIfCancellationRequested, addr 0x3dbd6b8, size 0x78, virtual false, abstract: false, final false
inline void ThrowIfCancellationRequested() ;

/// @brief Method ThrowOperationCanceledException, addr 0x3dbd730, size 0x58, virtual false, abstract: false, final false
inline void ThrowOperationCanceledException() ;

/// @brief Method .ctor, addr 0x3dbcd98, size 0x94, virtual false, abstract: false, final false
inline void _ctor(bool  canceled) ;

/// @brief Method .ctor, addr 0x3dbcd90, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_CanBeCanceled, addr 0x3dbcd80, size 0x10, virtual false, abstract: false, final false
inline bool get_CanBeCanceled() ;

/// @brief Method get_IsCancellationRequested, addr 0x3dbcd38, size 0x2c, virtual false, abstract: false, final false
inline bool get_IsCancellationRequested() ;

/// @brief Method get_None, addr 0x3dbcd30, size 0x8, virtual false, abstract: false, final false
static inline ::System::Threading::CancellationToken get_None() ;

/// @brief Method op_Equality, addr 0x3dbd5f0, size 0x64, virtual false, abstract: false, final false
static inline bool op_Equality(::System::Threading::CancellationToken  left, ::System::Threading::CancellationToken  right) ;

/// @brief Method op_Inequality, addr 0x3dbd654, size 0x64, virtual false, abstract: false, final false
