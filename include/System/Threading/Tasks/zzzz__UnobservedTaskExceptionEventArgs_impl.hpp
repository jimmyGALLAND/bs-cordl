...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Threading::Tasks::UnobservedTaskExceptionEventArgs::*)(::System::AggregateException*)>(&::System::Threading::Tasks::UnobservedTaskExceptionEventArgs::_ctor)> {
  constexpr static std::size_t size = 0x6c;
  constexpr static std::size_t addrs = 0x3dd9ffc;
...
constexpr ::cordl_internals::to_const_pointer<::System::AggregateException*> const& System::Threading::Tasks::UnobservedTaskExceptionEventArgs::__cordl_internal_get_m_exception() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_exception;
}
