...
template<typename TAntecedentResult,typename TResult>
constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::Task_1<TAntecedentResult>*> const& System::Threading::Tasks::ContinuationResultTaskFromResultTask_2<TAntecedentResult,TResult>::__cordl_internal_get_m_antecedent() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_antecedent;
}
template<typename TAntecedentResult,typename TResult>
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Threading::Tasks::ContinuationResultTaskFromResultTask_2<TAntecedentResult,TResult>*>(antecedent, function, state, creationOptions, internalOptions));
}
template<typename TAntecedentResult,typename TResult>
