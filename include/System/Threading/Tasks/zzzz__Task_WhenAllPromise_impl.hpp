...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Threading::Tasks::__Task__WhenAllPromise::*)(::ArrayW<::System::Threading::Tasks::Task*,::Array<::System::Threading::Tasks::Task*>*>)>(&::System::Threading::Tasks::__Task__WhenAllPromise::_ctor)> {
  constexpr static std::size_t size = 0x174;
  constexpr static std::size_t addrs = 0x3dd7458;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Threading::Tasks::__Task__WhenAllPromise::*)(::System::Threading::Tasks::Task*)>(&::System::Threading::Tasks::__Task__WhenAllPromise::Invoke)> {
  constexpr static std::size_t size = 0x2d0;
  constexpr static std::size_t addrs = 0x3dd8528;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::System::Threading::Tasks::__Task__WhenAllPromise::*)()>(&::System::Threading::Tasks::__Task__WhenAllPromise::get_ShouldNotifyDebuggerOfWaitCompletion)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x3dd87f8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::System::Threading::Tasks::__Task__WhenAllPromise::*)()>(&::System::Threading::Tasks::__Task__WhenAllPromise::get_InvokeMayRunArbitraryCode)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3dd886c;
...
constexpr ::ArrayW<::System::Threading::Tasks::Task*,::Array<::System::Threading::Tasks::Task*>*>& System::Threading::Tasks::__Task__WhenAllPromise::__cordl_internal_get_m_tasks()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_tasks;
}
constexpr ::ArrayW<::System::Threading::Tasks::Task*,::Array<::System::Threading::Tasks::Task*>*> const& System::Threading::Tasks::__Task__WhenAllPromise::__cordl_internal_get_m_tasks() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_tasks;
}
constexpr void System::Threading::Tasks::__Task__WhenAllPromise::__cordl_internal_set_m_tasks(::ArrayW<::System::Threading::Tasks::Task*,::Array<::System::Threading::Tasks::Task*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr int32_t& System::Threading::Tasks::__Task__WhenAllPromise::__cordl_internal_get_m_count()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_count;
}
constexpr int32_t const& System::Threading::Tasks::__Task__WhenAllPromise::__cordl_internal_get_m_count() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_count;
}
constexpr void System::Threading::Tasks::__Task__WhenAllPromise::__cordl_internal_set_m_count(int32_t  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::System::Threading::Tasks::__Task__WhenAllPromise*>(tasks));
}
