...
static __declspec(property(get=getStaticF__unobservedTaskException, put=setStaticF__unobservedTaskException)) ::System::EventHandler_1<::System::Threading::Tasks::UnobservedTaskExceptionEventArgs*>*  _unobservedTaskException;
...
static __declspec(property(get=getStaticF_s_activeTaskSchedulers, put=setStaticF_s_activeTaskSchedulers)) ::System::Runtime::CompilerServices::ConditionalWeakTable_2<::System::Threading::Tasks::TaskScheduler*,::System::Object*>*  s_activeTaskSchedulers;
...
/// @brief Method NotifyWorkItemProgress, addr 0x3ddae98, size 0x4, virtual true, abstract: false, final false
inline void NotifyWorkItemProgress() ;

/// @brief Method PublishUnobservedTaskException, addr 0x3dda068, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method TryDequeue, addr 0x3ddae90, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method TryRunInline, addr 0x3dd4a10, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ddaea4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Current, addr 0x3dd5378, size 0xa0, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::TaskScheduler* get_Current() ;

/// @brief Method get_Default, addr 0x3ddaeac, size 0x58, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::TaskScheduler* get_Default() ;

/// @brief Method get_Id, addr 0x3dd4c04, size 0x94, virtual false, abstract: false, final false
inline int32_t get_Id() ;

/// @brief Method get_InternalCurrent, addr 0x3dd4050, size 0xa4, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::TaskScheduler* get_InternalCurrent() ;

/// @brief Method get_RequiresAtomicStartTransition, addr 0x3ddae9c, size 0x8, virtual true, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::System::Threading::Tasks::__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView*, "System.Threading.Tasks", "TaskScheduler/SystemThreadingTasks_TaskSchedulerDebugView");
