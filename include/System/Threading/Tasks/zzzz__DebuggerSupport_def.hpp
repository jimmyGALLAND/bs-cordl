...
static __declspec(property(get=getStaticF_s_activeTasks, put=setStaticF_s_activeTasks)) ::System::Collections::Generic::LowLevelDictionary_2<int32_t,::System::Threading::Tasks::Task*>*  s_activeTasks;
...
/// @brief Method AddToActiveTasks, addr 0x3dcf910, size 0x94, virtual false, abstract: false, final false
static inline void AddToActiveTasks(::System::Threading::Tasks::Task*  task) ;

/// @brief Method AddToActiveTasksNonInlined, addr 0x3dcf9a4, size 0x158, virtual false, abstract: false, final false
static inline void AddToActiveTasksNonInlined(::System::Threading::Tasks::Task*  task) ;

/// @brief Method RemoveFromActiveTasks, addr 0x3dcfb8c, size 0x94, virtual false, abstract: false, final false
static inline void RemoveFromActiveTasks(::System::Threading::Tasks::Task*  task) ;

/// @brief Method RemoveFromActiveTasksNonInlined, addr 0x3dcfc20, size 0x158, virtual false, abstract: false, final false
static inline void RemoveFromActiveTasksNonInlined(::System::Threading::Tasks::Task*  task) ;

/// @brief Method TraceOperationCompletion, addr 0x3dcf900, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method TraceOperationCreation, addr 0x3dcf8fc, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method TraceOperationRelation, addr 0x3dcf904, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method TraceSynchronousWorkCompletion, addr 0x3dcf90c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method TraceSynchronousWorkStart, addr 0x3dcf908, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_LoggingOn, addr 0x3dcf8f4, size 0x8, virtual false, abstract: false, final false
