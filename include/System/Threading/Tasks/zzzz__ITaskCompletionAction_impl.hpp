...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Threading::Tasks::ITaskCompletionAction::*)(::System::Threading::Tasks::Task*)>(&::System::Threading::Tasks::ITaskCompletionAction::Invoke)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::System::Threading::Tasks::ITaskCompletionAction::*)()>(&::System::Threading::Tasks::ITaskCompletionAction::get_InvokeMayRunArbitraryCode)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
