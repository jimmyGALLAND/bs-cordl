...
/// @brief Method Add, addr 0x3dd22b0, size 0xc, virtual false, abstract: false, final false
inline void Add(::System::Object*  exceptionObject, bool  representsCancellation) ;

/// @brief Method AddFaultException, addr 0x3dda258, size 0x510, virtual false, abstract: false, final false
inline void AddFaultException(::System::Object*  exceptionObject) ;

/// @brief Method CreateExceptionObject, addr 0x3dd22bc, size 0x1ac, virtual false, abstract: false, final false
inline ::System::AggregateException* CreateExceptionObject(bool  calledFromFinalizer, ::System::Exception*  includeThisException) ;

/// @brief Method Finalize, addr 0x3dd9e04, size 0x1f8, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetCancellationExceptionDispatchInfo, addr 0x3dda7d8, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::ExceptionServices::ExceptionDispatchInfo* GetCancellationExceptionDispatchInfo() ;

/// @brief Method GetExceptionDispatchInfos, addr 0x3dd2580, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method MarkAsHandled, addr 0x3dd2078, size 0x7c, virtual false, abstract: false, final false
inline void MarkAsHandled(bool  calledFromFinalizer) ;

/// @brief Method MarkAsUnhandled, addr 0x3dda768, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method SetCancellationException, addr 0x3dda19c, size 0xbc, virtual false, abstract: false, final false
inline void SetCancellationException(::System::Object*  exceptionObject) ;

/// @brief Method ShouldFailFastOnUnobservedException, addr 0x3dd9dfc, size 0x8, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::LowLevelListWithIList_1<::System::Runtime::ExceptionServices::ExceptionDispatchInfo*>*> const& __cordl_internal_get_m_faultExceptions() const;
...
/// @brief Method .ctor, addr 0x3dd2288, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Threading::Tasks::Task*  task) ;

static inline bool getStaticF_s_failFastOnUnobservedException() ;

/// @brief Method get_ContainsFaultList, addr 0x3dd1ea4, size 0x1c, virtual false, abstract: false, final false
