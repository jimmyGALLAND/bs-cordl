...
public:
// Declarations
/// @brief Method InlineIfPossibleOrElseQueue, addr 0x3dd8bf8, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3dd8d38, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
