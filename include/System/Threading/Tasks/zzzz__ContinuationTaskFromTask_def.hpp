...
/// @brief Method InnerInvoke, addr 0x3dd8b28, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3dd568c, size 0xb4, virtual false, abstract: false, final false
