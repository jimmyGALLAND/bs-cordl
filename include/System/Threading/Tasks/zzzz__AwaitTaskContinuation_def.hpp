...
/// @brief Method CreateTask, addr 0x3dd9860, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method GetInvokeActionCallback, addr 0x3dd9d58, size 0xa0, virtual false, abstract: false, final false
static inline ::System::Threading::ContextCallback* GetInvokeActionCallback() ;

/// @brief Method InvokeAction, addr 0x3dd9cec, size 0x6c, virtual false, abstract: false, final false
static inline void InvokeAction(::System::Object*  state) ;

/// @brief Method MarkAborted, addr 0x3dd9df8, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method Run, addr 0x3dd974c, size 0x114, virtual true, abstract: false, final false
inline void Run(::System::Threading::Tasks::Task*  ignored, bool  canInlineContinuationTask) ;

/// @brief Method RunCallback, addr 0x3dd90b4, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method RunOrScheduleAction, addr 0x3dd5128, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x3dd9bc8, size 0x124, virtual true, abstract: false, final true
inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem() ;

/// @brief Method ThrowAsyncIfNecessary, addr 0x3dd9a3c, size 0x58, virtual false, abstract: false, final false
static inline void ThrowAsyncIfNecessary(::System::Exception*  exc) ;

/// @brief Method UnsafeScheduleAction, addr 0x3dd41b8, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3dd8ed0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_IsValidLocationForInlining, addr 0x3dd9a94, size 0x134, virtual false, abstract: false, final false
