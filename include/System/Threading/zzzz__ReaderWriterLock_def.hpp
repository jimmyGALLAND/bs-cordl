...
/// @brief Method AcquireReaderLock, addr 0x3dcbce0, size 0x8, virtual false, abstract: false, final false
inline void AcquireReaderLock(int32_t  millisecondsTimeout) ;

/// @brief Method AcquireReaderLock, addr 0x3dcbce8, size 0x394, virtual false, abstract: false, final false
inline void AcquireReaderLock(int32_t  millisecondsTimeout, int32_t  initialLockCount) ;

/// @brief Method AcquireWriterLock, addr 0x3dcc250, size 0x8, virtual false, abstract: false, final false
inline void AcquireWriterLock(int32_t  millisecondsTimeout) ;

/// @brief Method AcquireWriterLock, addr 0x3dcc0b0, size 0x1a0, virtual false, abstract: false, final false
inline void AcquireWriterLock(int32_t  millisecondsTimeout, int32_t  initialLockCount) ;

/// @brief Method Finalize, addr 0x3dcbbfc, size 0x8, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method HasWriterLock, addr 0x3dcc07c, size 0x34, virtual false, abstract: false, final false
inline bool HasWriterLock() ;

static inline ::System::Threading::ReaderWriterLock* New_ctor() ;

/// @brief Method ReleaseReaderLock, addr 0x3dcc258, size 0x1e4, virtual false, abstract: false, final false
inline void ReleaseReaderLock() ;

/// @brief Method ReleaseReaderLock, addr 0x3dcc564, size 0x120, virtual false, abstract: false, final false
inline void ReleaseReaderLock(int32_t  currentCount, int32_t  releaseCount) ;

/// @brief Method ReleaseWriterLock, addr 0x3dcc43c, size 0x128, virtual false, abstract: false, final false
inline void ReleaseWriterLock() ;

/// @brief Method ReleaseWriterLock, addr 0x3dcc684, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3dcbb2c, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsWriterLockHeld, addr 0x3dcbc04, size 0xdc, virtual false, abstract: false, final false
