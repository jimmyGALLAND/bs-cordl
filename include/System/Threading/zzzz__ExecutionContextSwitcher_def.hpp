...
public:
// Declarations
/// @brief Method Undo, addr 0x3dc3d9c, size 0x88, virtual false, abstract: false, final false
inline void Undo() ;

/// @brief Method UndoNoThrow, addr 0x3dc3d14, size 0x88, virtual false, abstract: false, final false
