...
/// @brief Method Dispose, addr 0x3dbf180, size 0x94, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DisposeAsync, addr 0x3dbf46c, size 0x94, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::ValueTask DisposeAsync() ;

/// @brief Method Equals, addr 0x3dbf2d0, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x3dbf360, size 0x80, virtual true, abstract: false, final true
inline bool Equals(::System::Threading::CancellationTokenRegistration  other) ;

/// @brief Method GetHashCode, addr 0x3dbf3e0, size 0x8c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Unregister, addr 0x3dbf104, size 0x7c, virtual false, abstract: false, final false
inline bool Unregister() ;

/// @brief Method .ctor, addr 0x3dbf0f8, size 0xc, virtual false, abstract: false, final false
