...
/// @brief Method Read, addr 0x3dce1a0, size 0x18, virtual false, abstract: false, final false
static inline bool Read(ByRef<bool>  location) ;

/// @brief Method Read, addr 0x3dce1dc, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method Write, addr 0x3dce1b8, size 0x24, virtual false, abstract: false, final false
static inline void Write(ByRef<bool>  location, bool  value) ;

/// @brief Method Write, addr 0x3dce1f4, size 0x24, virtual false, abstract: false, final false
