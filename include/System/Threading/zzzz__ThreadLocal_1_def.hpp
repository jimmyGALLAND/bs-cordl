...
/// @brief Field SlotArray, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_SlotArray, put=__cordl_internal_set_SlotArray)) ::ArrayW<::System::Threading::__ThreadLocal_1__LinkedSlotVolatile<T>,::Array<::System::Threading::__ThreadLocal_1__LinkedSlotVolatile<T>>*>  SlotArray;
...
static __declspec(property(get=getStaticF_ts_slotArray, put=setStaticF_ts_slotArray)) ::ArrayW<::System::Threading::__ThreadLocal_1__LinkedSlotVolatile<T>,::Array<::System::Threading::__ThreadLocal_1__LinkedSlotVolatile<T>>*>  ts_slotArray;
