...
// Ctor Parameters [CppParam { name: "major", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "minor", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "patch", ty: "uint16_t", modifiers: "", def_value: None }]
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x3ec65b8, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x3ec664c, size 0xc, virtual true, abstract: false, final false
inline void EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x3ec65a4, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ec6518, size 0x8c, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "play_call_count", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "stop_call_count", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "samples_played", ty: "int64_t", modifiers: "", def_value: None }]
...
/// @brief Method Failed, addr 0x3ec54b4, size 0x8, virtual false, abstract: false, final false
static inline bool Failed(::Oculus::Haptics::__Ffi__Result  result) ;

static inline ::Oculus::Haptics::Ffi* New_ctor() ;

/// @brief Method Succeeded, addr 0x3ec52f0, size 0xc, virtual false, abstract: false, final false
static inline bool Succeeded(::Oculus::Haptics::__Ffi__Result  result) ;

/// @brief Method .ctor, addr 0x3ec6510, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method clip_duration, addr 0x3ec5808, size 0x84, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result clip_duration(int32_t  clipId, ByRef<float_t>  clip_duration) ;

/// @brief Method create_player, addr 0x3ec5584, size 0x7c, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result create_player(ByRef<int32_t>  player_id) ;

/// @brief Method error_message, addr 0x3ec52fc, size 0x128, virtual false, abstract: false, final false
static inline ::StringW error_message() ;

/// @brief Method get_null_backend_statistics, addr 0x3ec649c, size 0x74, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__NullBackendStatistics get_null_backend_statistics() ;

/// @brief Method haptics_sdk_error_message, addr 0x3ec62b4, size 0x68, virtual false, abstract: false, final false
static inline ::System::IntPtr haptics_sdk_error_message() ;

/// @brief Method haptics_sdk_error_message_length, addr 0x3ec631c, size 0x68, virtual false, abstract: false, final false
static inline int32_t haptics_sdk_error_message_length() ;

/// @brief Method initialize_with_null_backend, addr 0x3ec6234, size 0x80, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result initialize_with_null_backend(::Oculus::Haptics::__Ffi__LogCallback*  logCallback) ;

/// @brief Method initialize_with_ovr_plugin, addr 0x3ec51d0, size 0x120, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result initialize_with_ovr_plugin(::StringW  game_engine_name, ::StringW  game_engine_version, ::StringW  game_engine_haptics_sdk_version, ::Oculus::Haptics::__Ffi__LogCallback*  logCallback) ;

/// @brief Method initialize_with_ovr_plugin_bytes, addr 0x3ec616c, size 0xc8, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result initialize_with_ovr_plugin_bytes(ByRefConst<::ArrayW<uint8_t,::Array<uint8_t>*>>  game_engine_name, ByRefConst<::ArrayW<uint8_t,::Array<uint8_t>*>>  game_engine_version, ByRefConst<::ArrayW<uint8_t,::Array<uint8_t>*>>  game_engine_haptics_sdk_version, ::Oculus::Haptics::__Ffi__LogCallback*  logCallback) ;

/// @brief Method initialized, addr 0x3ec5424, size 0x90, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result initialized(ByRef<bool>  initialized) ;

/// @brief Method load_clip, addr 0x3ec54bc, size 0x4c, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result load_clip(::StringW  data, ByRef<int32_t>  clip_id_out) ;

/// @brief Method load_clip_bytes, addr 0x3ec6400, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method player_amplitude, addr 0x3ec5a34, size 0x84, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result player_amplitude(int32_t  playerId, ByRef<float_t>  amplitude) ;

/// @brief Method player_frequency_shift, addr 0x3ec5b44, size 0x84, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result player_frequency_shift(int32_t  playerId, ByRef<float_t>  frequency_shift) ;

/// @brief Method player_looping_enabled, addr 0x3ec5910, size 0x98, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result player_looping_enabled(int32_t  playerId, ByRef<bool>  looping_enabled) ;

/// @brief Method player_play, addr 0x3ec5708, size 0x84, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result player_play(int32_t  playerId, ::Oculus::Haptics::__Ffi__Controller  controller) ;

/// @brief Method player_priority, addr 0x3ec5ed4, size 0x84, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result player_priority(int32_t  playerId, ByRef<uint32_t>  priority) ;

/// @brief Method player_set_amplitude, addr 0x3ec59a8, size 0x8c, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result player_set_amplitude(int32_t  playerId, float_t  amplitude) ;

/// @brief Method player_set_clip, addr 0x3ec5600, size 0x84, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result player_set_clip(int32_t  playerId, int32_t  clipId) ;

/// @brief Method player_set_frequency_shift, addr 0x3ec5ab8, size 0x8c, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result player_set_frequency_shift(int32_t  playerId, float_t  amount) ;

/// @brief Method player_set_looping_enabled, addr 0x3ec588c, size 0x84, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result player_set_looping_enabled(int32_t  playerId, bool  enabled) ;

/// @brief Method player_set_priority, addr 0x3ec5e50, size 0x84, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result player_set_priority(int32_t  playerId, uint32_t  priority) ;

/// @brief Method player_stop, addr 0x3ec578c, size 0x7c, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result player_stop(int32_t  playerId) ;

/// @brief Method release_clip, addr 0x3ec5508, size 0x7c, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result release_clip(int32_t  clipId) ;

/// @brief Method release_player, addr 0x3ec5f58, size 0x7c, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result release_player(int32_t  playerId) ;

/// @brief Method set_suspended, addr 0x3ec6384, size 0x7c, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result set_suspended(bool  suspended) ;

/// @brief Method uninitialize, addr 0x3ec6098, size 0x68, virtual false, abstract: false, final false
static inline ::Oculus::Haptics::__Ffi__Result uninitialize() ;

/// @brief Method version, addr 0x3ec6100, size 0x6c, virtual false, abstract: false, final false
