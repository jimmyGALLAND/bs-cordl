...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Oculus::Platform::Request_1<::StringW>* (*)(::StringW)>(&::Oculus::Platform::DeviceApplicationIntegrity::GetIntegrityToken)> {
  constexpr static std::size_t size = 0x158;
  constexpr static std::size_t addrs = 0x3ef8700;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::DeviceApplicationIntegrity*>::get(),
                        "GetIntegrityToken",
