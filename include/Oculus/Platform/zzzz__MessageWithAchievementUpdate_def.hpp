...
public:
// Declarations
/// @brief Method GetAchievementUpdate, addr 0x3eecd40, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AchievementUpdate* GetAchievementUpdate() ;

/// @brief Method GetDataFromMessage, addr 0x3eecd7c, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eead48, size 0x58, virtual false, abstract: false, final false
