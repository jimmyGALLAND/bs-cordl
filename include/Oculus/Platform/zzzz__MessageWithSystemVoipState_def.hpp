...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eefd44, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::SystemVoipState* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetSystemVoipState, addr 0x3eefd08, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eebcc0, size 0x58, virtual false, abstract: false, final false
