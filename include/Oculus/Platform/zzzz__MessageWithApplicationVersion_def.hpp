...
public:
// Declarations
/// @brief Method GetApplicationVersion, addr 0x3eed080, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::ApplicationVersion* GetApplicationVersion() ;

/// @brief Method GetDataFromMessage, addr 0x3eed0bc, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eeaea8, size 0x58, virtual false, abstract: false, final false
