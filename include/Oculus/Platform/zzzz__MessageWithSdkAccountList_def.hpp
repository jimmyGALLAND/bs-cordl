...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eefa44, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::SdkAccountList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetSdkAccountList, addr 0x3eefa08, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eebb60, size 0x58, virtual false, abstract: false, final false
