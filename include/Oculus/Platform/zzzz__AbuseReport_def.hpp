...
public:
// Declarations
/// @brief Method ReportRequestHandled, addr 0x3ec9794, size 0x144, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request* ReportRequestHandled(::Oculus::Platform::ReportRequestResponse  response) ;

/// @brief Method SetReportButtonPressedNotificationCallback, addr 0x3ec99c4, size 0x74, virtual false, abstract: false, final false
