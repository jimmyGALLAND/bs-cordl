...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eee1b4, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::LaunchInvitePanelFlowResult* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLaunchInvitePanelFlowResult, addr 0x3eee178, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eeb588, size 0x58, virtual false, abstract: false, final false
