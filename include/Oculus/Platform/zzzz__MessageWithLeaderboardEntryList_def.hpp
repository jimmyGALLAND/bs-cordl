...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eee54c, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::LeaderboardEntryList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLeaderboardEntryList, addr 0x3eee510, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eeb690, size 0x58, virtual false, abstract: false, final false
