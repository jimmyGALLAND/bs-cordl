...
/// @brief Field CurrentCapacity value: static_cast<int32_t>(0x2)
static ::Oculus::Platform::RichPresenceExtraContext const CurrentCapacity;

/// @brief Field EndingIn value: static_cast<int32_t>(0x4)
static ::Oculus::Platform::RichPresenceExtraContext const EndingIn;

/// @brief Field LookingForAMatch value: static_cast<int32_t>(0x5)
...
/// @brief Field StartedAgo value: static_cast<int32_t>(0x3)
