...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eef174, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::OrgScopedID* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetOrgScopedID, addr 0x3eef138, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eeb8a0, size 0x58, virtual false, abstract: false, final false
