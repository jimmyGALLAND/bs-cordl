...
public:
// Declarations
/// @brief Method GetAbuseReportRecording, addr 0x3eecad0, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AbuseReportRecording* GetAbuseReportRecording() ;

/// @brief Method GetDataFromMessage, addr 0x3eecb0c, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eeca78, size 0x58, virtual false, abstract: false, final false
