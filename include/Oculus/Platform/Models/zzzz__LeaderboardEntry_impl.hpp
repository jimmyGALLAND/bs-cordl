...
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::SupplementaryMetric*> const& Oculus::Platform::Models::LeaderboardEntry::__cordl_internal_get_SupplementaryMetricOptional() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___SupplementaryMetricOptional;
}
