...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::NetSyncSessionsChangedNotification::*)(::System::IntPtr)>(&::Oculus::Platform::Models::NetSyncSessionsChangedNotification::_ctor)> {
...
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::NetSyncSessionList*> const& Oculus::Platform::Models::NetSyncSessionsChangedNotification::__cordl_internal_get_Sessions() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___Sessions;
}
