...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::GroupPresenceLeaveIntent::*)(::System::IntPtr)>(&::Oculus::Platform::Models::GroupPresenceLeaveIntent::_ctor)> {
