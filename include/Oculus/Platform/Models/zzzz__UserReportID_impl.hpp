...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::UserReportID::*)(::System::IntPtr)>(&::Oculus::Platform::Models::UserReportID::_ctor)> {
  constexpr static std::size_t size = 0x8c;
  constexpr static std::size_t addrs = 0x3f03538;
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Oculus::Platform::Models::UserReportID*>(o));
}
