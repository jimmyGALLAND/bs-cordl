...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eefbe4, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::ShareMediaResult* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetShareMediaResult, addr 0x3eefba8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eebc10, size 0x58, virtual false, abstract: false, final false
