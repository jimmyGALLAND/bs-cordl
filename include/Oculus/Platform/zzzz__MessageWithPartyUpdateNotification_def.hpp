...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eef564, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::PartyUpdateNotification* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetPartyUpdateNotification, addr 0x3eef528, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eeb950, size 0x58, virtual false, abstract: false, final false
