...
/// @brief Method EntitlementCheckCallback, addr 0x3f06810, size 0x30, virtual false, abstract: false, final false
inline void EntitlementCheckCallback(::Oculus::Platform::Message*  msg) ;

/// @brief Method HandleEntitlementCheckResult, addr 0x3f06570, size 0x2a0, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x3f063c8, size 0x1a8, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3f06840, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_UserFailedEntitlementCheck, addr 0x3f060e0, size 0xb8, virtual false, abstract: false, final false
static inline void add_UserFailedEntitlementCheck(::System::Action*  value) ;

/// @brief Method add_UserPassedEntitlementCheck, addr 0x3f06250, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method remove_UserFailedEntitlementCheck, addr 0x3f06198, size 0xb8, virtual false, abstract: false, final false
static inline void remove_UserFailedEntitlementCheck(::System::Action*  value) ;

/// @brief Method remove_UserPassedEntitlementCheck, addr 0x3f0630c, size 0xbc, virtual false, abstract: false, final false
