...
public:
// Declarations
/// @brief Method GetAssetDetailsList, addr 0x3eed220, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AssetDetailsList* GetAssetDetailsList() ;

/// @brief Method GetDataFromMessage, addr 0x3eed25c, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eeaf58, size 0x58, virtual false, abstract: false, final false
