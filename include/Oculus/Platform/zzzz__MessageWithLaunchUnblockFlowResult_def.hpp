...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eee3ac, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::LaunchUnblockFlowResult* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLaunchUnblockFlowResult, addr 0x3eee370, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eeb5e0, size 0x58, virtual false, abstract: false, final false
