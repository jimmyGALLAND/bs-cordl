...
public:
// Declarations
/// @brief Method GetAppDownloadProgressResult, addr 0x3eece10, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AppDownloadProgressResult* GetAppDownloadProgressResult() ;

/// @brief Method GetDataFromMessage, addr 0x3eece4c, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eeada0, size 0x58, virtual false, abstract: false, final false
