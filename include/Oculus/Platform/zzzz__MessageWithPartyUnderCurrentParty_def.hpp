...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eef36c, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::Party* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetParty, addr 0x3eef330, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eeb8f8, size 0x58, virtual false, abstract: false, final false
