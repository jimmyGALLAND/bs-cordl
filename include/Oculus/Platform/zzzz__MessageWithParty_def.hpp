...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eef29c, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::Party* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetParty, addr 0x3eef260, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eef208, size 0x58, virtual false, abstract: false, final false
