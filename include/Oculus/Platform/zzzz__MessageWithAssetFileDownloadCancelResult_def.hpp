...
public:
// Declarations
/// @brief Method GetAssetFileDownloadCancelResult, addr 0x3eed3c0, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AssetFileDownloadCancelResult* GetAssetFileDownloadCancelResult() ;

/// @brief Method GetDataFromMessage, addr 0x3eed3fc, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eeb008, size 0x58, virtual false, abstract: false, final false
