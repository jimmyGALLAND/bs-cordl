...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eedd4c, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::GroupPresenceLeaveIntent* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetGroupPresenceLeaveIntent, addr 0x3eedd10, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eeb428, size 0x58, virtual false, abstract: false, final false
