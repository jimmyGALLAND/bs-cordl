...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eef494, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::PartyID* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetPartyID, addr 0x3eef458, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eef400, size 0x58, virtual false, abstract: false, final false
