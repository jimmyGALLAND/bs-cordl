...
constexpr ::Oculus::Platform::__PlatformInternal__MessageTypeInternal  Oculus::Platform::__PlatformInternal__MessageTypeInternal::AbuseReport_LaunchAdvancedReportFlow{static_cast<uint32_t>(0xb13a6ef0u)};
constexpr ::Oculus::Platform::__PlatformInternal__MessageTypeInternal  Oculus::Platform::__PlatformInternal__MessageTypeInternal::Application_ExecuteCoordinatedLaunch{static_cast<uint32_t>(0x7db4f4f0u)};
constexpr ::Oculus::Platform::__PlatformInternal__MessageTypeInternal  Oculus::Platform::__PlatformInternal__MessageTypeInternal::Application_GetInstalledApplications{static_cast<uint32_t>(0xf744cf0u)};
...
constexpr ::Oculus::Platform::__PlatformInternal__MessageTypeInternal  Oculus::Platform::__PlatformInternal__MessageTypeInternal::DeviceApplicationIntegrity_GetAttestationToken{static_cast<uint32_t>(0xdea32fd0u)};
...
constexpr ::Oculus::Platform::__PlatformInternal__MessageTypeInternal  Oculus::Platform::__PlatformInternal__MessageTypeInternal::Livestreaming_IsAllowedForApplication{static_cast<uint32_t>(0x768d6dcbu)};
...
constexpr ::Oculus::Platform::__PlatformInternal__MessageTypeInternal  Oculus::Platform::__PlatformInternal__MessageTypeInternal::NetSync_GetVoipAttenuationDefault{static_cast<uint32_t>(0x7ba8a0f0u)};
...
constexpr ::Oculus::Platform::__PlatformInternal__MessageTypeInternal  Oculus::Platform::__PlatformInternal__MessageTypeInternal::User_CancelRecordingForReportFlow{static_cast<uint32_t>(0x49d1e0c3u)};
...
constexpr ::Oculus::Platform::__PlatformInternal__MessageTypeInternal  Oculus::Platform::__PlatformInternal__MessageTypeInternal::User_StopRecordingAndLaunchReportFlow{static_cast<uint32_t>(0x788c8bf0u)};
constexpr ::Oculus::Platform::__PlatformInternal__MessageTypeInternal  Oculus::Platform::__PlatformInternal__MessageTypeInternal::User_StopRecordingAndLaunchReportFlow2{static_cast<uint32_t>(0x2bb3c2d9u)};
constexpr ::Oculus::Platform::__PlatformInternal__MessageTypeInternal  Oculus::Platform::__PlatformInternal__MessageTypeInternal::User_TestUserCreateDeviceManifest{static_cast<uint32_t>(0x70b2bdf0u)};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::Oculus::Platform::__Message_1__Callback<::Oculus::Platform::Models::HttpTransferUpdate*>*)>(&::Oculus::Platform::__PlatformInternal__HTTP::SetHttpTransferUpdateCallback)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x3efc178;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::__PlatformInternal__HTTP*>::get(),
                        "SetHttpTransferUpdateCallback",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Oculus::Platform::__Message_1__Callback<::Oculus::Platform::Models::HttpTransferUpdate*>*>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Oculus::Platform::Request_1<::Oculus::Platform::Models::LinkedAccountList*>* (*)(::ArrayW<::Oculus::Platform::ServiceProvider,::Array<::Oculus::Platform::ServiceProvider>*>)>(&::Oculus::Platform::__PlatformInternal__Users::GetLinkedAccounts)> {
  constexpr static std::size_t size = 0x198;
  constexpr static std::size_t addrs = 0x3efc1ec;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::__PlatformInternal__Users*>::get(),
                        "GetLinkedAccounts",
                        std::span<const Il2CppClass* const, 0>(),
...
inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::LinkedAccountList*>* Oculus::Platform::__PlatformInternal__Users::GetLinkedAccounts(::ArrayW<::Oculus::Platform::ServiceProvider,::Array<::Oculus::Platform::ServiceProvider>*>  providers)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::__PlatformInternal__Users*>::get(),
                        "GetLinkedAccounts",
                        std::span<const Il2CppClass* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&::Oculus::Platform::PlatformInternal::CrashApplication)> {
  ...
  constexpr static std::size_t addrs = 0x3efbf18;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Oculus::Platform::Message* (*)(::System::IntPtr, ::Oculus::Platform::__Message__MessageType)>(&::Oculus::Platform::PlatformInternal::ParseMessageHandle)> {
  constexpr static std::size_t size = 0x868;
  constexpr static std::size_t addrs = 0x3eebfd8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "ParseMessageHandle",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::IntPtr>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Oculus::Platform::__Message__MessageType>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Oculus::Platform::Request_1<::Oculus::Platform::Models::PlatformInitialize*>* (*)(uint64_t, ::StringW)>(&::Oculus::Platform::PlatformInternal::InitializeStandaloneAsync)> {
  ...
  constexpr static std::size_t addrs = 0x3efbf64;
