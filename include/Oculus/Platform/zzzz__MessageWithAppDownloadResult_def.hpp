...
public:
// Declarations
/// @brief Method GetAppDownloadResult, addr 0x3eecee0, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AppDownloadResult* GetAppDownloadResult() ;

/// @brief Method GetDataFromMessage, addr 0x3eecf1c, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eeadf8, size 0x58, virtual false, abstract: false, final false
