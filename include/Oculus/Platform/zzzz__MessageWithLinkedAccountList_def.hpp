...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eee674, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::LinkedAccountList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLinkedAccountList, addr 0x3eee638, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eee5e0, size 0x58, virtual false, abstract: false, final false
