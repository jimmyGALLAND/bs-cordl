...
template<typename T>
constexpr ::Oculus::Platform::__Message_1__Callback<T>*& Oculus::Platform::Request_1<T>::__cordl_internal_get_callback_()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___callback_;
}
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::__Message_1__Callback<T>*> const& Oculus::Platform::Request_1<T>::__cordl_internal_get_callback_() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___callback_;
}
template<typename T>
constexpr void Oculus::Platform::Request_1<T>::__cordl_internal_set_callback_(::Oculus::Platform::__Message_1__Callback<T>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
