...
namespace Oculus::Platform {
template<typename T>
class __Callback__RequestCallback_1;
}
namespace Oculus::Platform {
...
/// @brief Method HandleMessage, addr 0x3ecc154, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ecc14c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3ecba14, size 0x28, virtual false, abstract: false, final false
...
template<typename T>
using RequestCallback_1 = ::Oculus::Platform::__Callback__RequestCallback_1<T>;
...
static __declspec(property(get=getStaticF_latestPendingJoinIntentNotifications, put=setStaticF_latestPendingJoinIntentNotifications)) ::Oculus::Platform::Message*  latestPendingJoinIntentNotifications;

/// @brief Field notificationCallbacks, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_notificationCallbacks, put=setStaticF_notificationCallbacks)) ::System::Collections::Generic::Dictionary_2<::Oculus::Platform::__Message__MessageType,::Oculus::Platform::__Callback__RequestCallback*>*  notificationCallbacks;

/// @brief Field requestIDsToRequests, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_requestIDsToRequests, put=setStaticF_requestIDsToRequests)) ::System::Collections::Generic::Dictionary_2<uint64_t,::Oculus::Platform::Request*>*  requestIDsToRequests;

/// @brief Method AddRequest, addr 0x3ecba3c, size 0xdc, virtual false, abstract: false, final false
static inline void AddRequest(::Oculus::Platform::Request*  request) ;

/// @brief Method FlushJoinIntentNotificationQueue, addr 0x3ecbfcc, size 0xa0, virtual false, abstract: false, final false
static inline void FlushJoinIntentNotificationQueue() ;

/// @brief Method HandleMessage, addr 0x3ecbc58, size 0x248, virtual false, abstract: false, final false
static inline void HandleMessage(::Oculus::Platform::Message*  msg) ;

/// @brief Method OnApplicationQuit, addr 0x3ecbf28, size 0xa4, virtual false, abstract: false, final false
static inline void OnApplicationQuit() ;

/// @brief Method RunCallbacks, addr 0x3ecbb18, size 0x6c, virtual false, abstract: false, final false
static inline void RunCallbacks() ;

/// @brief Method RunLimitedCallbacks, addr 0x3ecbea0, size 0x88, virtual false, abstract: false, final false
...
template<typename T>
static inline void SetNotificationCallback(::Oculus::Platform::__Message__MessageType  type, ::Oculus::Platform::__Message_1__Callback<T>*  callback) ;

/// @brief Method SetNotificationCallback, addr 0x3ecb908, size 0x10c, virtual false, abstract: false, final false
...
static inline void setStaticF_notificationCallbacks(::System::Collections::Generic::Dictionary_2<::Oculus::Platform::__Message__MessageType,::Oculus::Platform::__Callback__RequestCallback*>*  value) ;
