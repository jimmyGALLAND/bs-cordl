...
/// @brief Method Awake, addr 0x3efd500, size 0x84, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::Oculus::Platform::__VoipAudioSourceHiLevel__FilterReadDelegate* New_ctor() ;

/// @brief Method OnAudioFilterRead, addr 0x3efd584, size 0x4e0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3efda64, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(::cordl_internals::size_check_v<::Oculus::Platform::__VoipAudioSourceHiLevel__FilterReadDelegate, 0x30>, "Size mismatch!");

static_assert(offsetof(::Oculus::Platform::__VoipAudioSourceHiLevel__FilterReadDelegate, ___parent) == 0x20, "Offset mismatch!");

static_assert(offsetof(::Oculus::Platform::__VoipAudioSourceHiLevel__FilterReadDelegate, ___scratchBuffer) == 0x28, "Offset mismatch!");
...
/// @brief Method Awake, addr 0x3efce88, size 0x2a4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CreatePCMSource, addr 0x3efd148, size 0x58, virtual true, abstract: false, final false
inline void CreatePCMSource() ;

/// @brief Method MSToElements, addr 0x3efd1a8, size 0x68, virtual false, abstract: false, final false
static inline int32_t MSToElements(int32_t  ms) ;

static inline ::Oculus::Platform::VoipAudioSourceHiLevel* New_ctor() ;

/// @brief Method SampleRateToEnum, addr 0x3efce44, size 0x44, virtual false, abstract: false, final false
inline ::Oculus::Platform::VoipSampleRate SampleRateToEnum(int32_t  rate) ;

/// @brief Method Start, addr 0x3efd12c, size 0x1c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Stop, addr 0x3efce40, size 0x4, virtual false, abstract: false, final false
inline void Stop() ;

/// @brief Method Update, addr 0x3efd210, size 0x2e8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3efd4f8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method set_senderID, addr 0x3efcd94, size 0xac, virtual false, abstract: false, final false
