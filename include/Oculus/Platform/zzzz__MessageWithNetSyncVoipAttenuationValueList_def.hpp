...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3eef0a4, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::NetSyncVoipAttenuationValueList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetNetSyncVoipAttenuationValueList, addr 0x3eef068, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eef010, size 0x58, virtual false, abstract: false, final false
