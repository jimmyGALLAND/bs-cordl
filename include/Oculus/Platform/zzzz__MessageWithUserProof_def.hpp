...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x3ef0224, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::UserProof* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetUserProof, addr 0x3ef01e8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3eebed0, size 0x58, virtual false, abstract: false, final false
