...
/// @brief Method AtomicAddAndGet, addr 0x3a1f1b4, size 0xc, virtual false, abstract: false, final false
inline int64_t AtomicAddAndGet(int64_t  delta) ;

/// @brief Method AtomicCompareExchange, addr 0x3a1f184, size 0x24, virtual false, abstract: false, final false
inline bool AtomicCompareExchange(int64_t  newValue, int64_t  comparand) ;

/// @brief Method AtomicDecrementAndGet, addr 0x3a1f1cc, size 0xc, virtual false, abstract: false, final false
inline int64_t AtomicDecrementAndGet() ;

/// @brief Method AtomicExchange, addr 0x3a1f1a8, size 0xc, virtual false, abstract: false, final false
inline int64_t AtomicExchange(int64_t  newValue) ;

/// @brief Method AtomicIncrementAndGet, addr 0x3a1f1c0, size 0xc, virtual false, abstract: false, final false
inline int64_t AtomicIncrementAndGet() ;

/// @brief Method ReadAcquireFence, addr 0x3a1f0a4, size 0x1c, virtual false, abstract: false, final false
inline int64_t ReadAcquireFence() ;

/// @brief Method ReadCompilerOnlyFence, addr 0x3a1f0dc, size 0x24, virtual false, abstract: false, final false
inline int64_t ReadCompilerOnlyFence() ;

/// @brief Method ReadFullFence, addr 0x3a1f0c0, size 0x1c, virtual false, abstract: false, final false
inline int64_t ReadFullFence() ;

/// @brief Method ReadUnfenced, addr 0x3a1f09c, size 0x8, virtual false, abstract: false, final false
inline int64_t ReadUnfenced() ;

/// @brief Method ToString, addr 0x3a1f1d8, size 0x34, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method WriteCompilerOnlyFence, addr 0x3a1f150, size 0x2c, virtual false, abstract: false, final false
inline void WriteCompilerOnlyFence(int64_t  newValue) ;

/// @brief Method WriteFullFence, addr 0x3a1f128, size 0x28, virtual false, abstract: false, final false
inline void WriteFullFence(int64_t  newValue) ;

/// @brief Method WriteReleaseFence, addr 0x3a1f100, size 0x28, virtual false, abstract: false, final false
inline void WriteReleaseFence(int64_t  newValue) ;

/// @brief Method WriteUnfenced, addr 0x3a1f17c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a1f094, size 0x8, virtual false, abstract: false, final false
