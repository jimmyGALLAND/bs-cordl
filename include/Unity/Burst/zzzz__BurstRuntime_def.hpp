...
template<typename T>
struct __BurstRuntime__HashCode32_1;
}
namespace Unity::Burst {
template<typename T>
...
/// @brief Method .ctor, addr 0x44750f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Declarations
template<typename T>
using HashCode32_1 = ::Unity::Burst::__BurstRuntime__HashCode32_1<T>;

template<typename T>
using HashCode64_1 = ::Unity::Burst::__BurstRuntime__HashCode64_1<T>;
...
/// @brief Method GetHashCode32, addr 0x4474c44, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetHashCode64, addr 0x4474cec, size 0x24, virtual false, abstract: false, final false
static inline int64_t GetHashCode64(::System::Type*  type) ;

/// @brief Method GetUTF8LiteralPointer, addr 0x44750a4, size 0x4c, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<uint8_t> GetUTF8LiteralPointer(::StringW  str, ByRef<int32_t>  byteCount) ;

/// @brief Method HashStringWithFNV1A32, addr 0x4474c68, size 0x84, virtual false, abstract: false, final false
static inline int32_t HashStringWithFNV1A32(::StringW  text) ;

/// @brief Method HashStringWithFNV1A64, addr 0x4474d10, size 0x8c, virtual false, abstract: false, final false
static inline int64_t HashStringWithFNV1A64(::StringW  text) ;

/// @brief Method Initialize, addr 0x4474f7c, size 0x4, virtual false, abstract: false, final false
static inline void Initialize() ;

/// @brief Method LoadAdditionalLibrary, addr 0x4474d9c, size 0x6c, virtual false, abstract: false, final false
static inline bool LoadAdditionalLibrary(::StringW  pathToLibBurstGenerated) ;

/// @brief Method LoadAdditionalLibraryInternal, addr 0x4474e08, size 0x15c, virtual false, abstract: false, final false
static inline bool LoadAdditionalLibraryInternal(::StringW  pathToLibBurstGenerated) ;

/// @brief Method Log, addr 0x447508c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method PreventRequiredAttributeStrip, addr 0x4474f80, size 0x10c, virtual false, abstract: false, final false
static inline void PreventRequiredAttributeStrip() ;

/// @brief Method RuntimeLog, addr 0x4474f64, size 0x18, virtual false, abstract: false, final false
