...
/// @brief Method .ctor, addr 0x447974c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CheckResult, addr 0x44796a8, size 0x54, virtual false, abstract: false, final false
static inline void CheckResult(::cordl_internals::Ptr<void>  result) ;

/// @brief Method CheckSizeOf, addr 0x447963c, size 0x6c, virtual false, abstract: false, final false
static inline void CheckSizeOf(uint32_t  sizeOf) ;

/// @brief Method GetOrCreateSharedStaticInternal, addr 0x44796fc, size 0x50, virtual false, abstract: false, final false
