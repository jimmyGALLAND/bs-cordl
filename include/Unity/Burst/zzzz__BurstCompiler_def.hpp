...
/// @brief Method And, addr 0x4472e40, size 0x28, virtual false, abstract: false, final false
inline ::Unity::Burst::__BurstCompiler__CommandBuilder* And(char16_t  sep) ;

/// @brief Method Begin, addr 0x4471758, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method SendToCompiler, addr 0x4472ba0, size 0x74, virtual false, abstract: false, final false
inline ::StringW SendToCompiler() ;

/// @brief Method With, addr 0x4472b44, size 0x5c, virtual false, abstract: false, final false
inline ::Unity::Burst::__BurstCompiler__CommandBuilder* With(::StringW  arg) ;

/// @brief Method With, addr 0x4472d78, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44716f0, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x4472e68, size 0x28, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x447309c, size 0x20, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x44730bc, size 0x28, virtual true, abstract: false, final false
inline bool EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x4473088, size 0x14, virtual true, abstract: false, final false
inline bool Invoke() ;
...
/// @brief Method .ctor, addr 0x4473000, size 0x88, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF_IsBurstEnabledImpl, put=setStaticF_IsBurstEnabledImpl)) ::GlobalNamespace::__BurstCompiler__BurstCompilerHelper__IsBurstEnabledDelegate*  IsBurstEnabledImpl;
...
/// @brief Method DiscardedMethod, addr 0x4472ee0, size 0x8, virtual false, abstract: false, final false
static inline void DiscardedMethod(ByRef<bool>  value) ;

/// @brief Method IsBurstEnabled, addr 0x4472e90, size 0x50, virtual false, abstract: false, final false
static inline bool IsBurstEnabled() ;

/// @brief Method IsCompiledByBurst, addr 0x4472ee8, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4471a04, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Reflection::MethodInfo*  method) ;

/// @brief Method get_Method, addr 0x44730e4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <Compile>b__22_0, addr 0x4473150, size 0x6c, virtual false, abstract: false, final false
inline bool _Compile_b__22_0(::System::Attribute*  s) ;

/// @brief Method <TriggerUnsafeStaticMethodRecompilation>b__29_0, addr 0x44731bc, size 0x70, virtual false, abstract: false, final false
inline bool _TriggerUnsafeStaticMethodRecompilation_b__29_0(::System::Attribute*  x) ;

/// @brief Method .ctor, addr 0x4473148, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AotCompilation, addr 0x4472a50, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method BeginCompilerCommand, addr 0x4471620, size 0xd0, virtual false, abstract: false, final false
static inline ::Unity::Burst::__BurstCompiler__CommandBuilder* BeginCompilerCommand(::StringW  cmd) ;

/// @brief Method Cancel, addr 0x447219c, size 0x4, virtual false, abstract: false, final false
static inline void Cancel() ;

/// @brief Method Compile, addr 0x4471fc0, size 0x118, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<void> Compile(::System::Object*  delegateObj, bool  isFunctionPointer) ;

/// @brief Method Compile, addr 0x4471a2c, size 0x440, virtual false, abstract: false, final false
...
/// @brief Method CompileILPPMethod, addr 0x4471850, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method CompileILPPMethod2, addr 0x4471888, size 0x17c, virtual false, abstract: false, final false
static inline ::System::IntPtr CompileILPPMethod2(::System::RuntimeMethodHandle  burstMethodHandle) ;

/// @brief Method CompileUnsafeStaticMethod, addr 0x4471f88, size 0x38, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<void> CompileUnsafeStaticMethod(::System::RuntimeMethodHandle  handle) ;

/// @brief Method Disable, addr 0x44721ac, size 0x4, virtual false, abstract: false, final false
static inline void Disable() ;

/// @brief Method DummyMethod, addr 0x4472c14, size 0x4, virtual false, abstract: false, final false
static inline void DummyMethod() ;

/// @brief Method Enable, addr 0x44721a8, size 0x4, virtual false, abstract: false, final false
static inline void Enable() ;

/// @brief Method GetExecutionMode, addr 0x4471848, size 0x8, virtual false, abstract: false, final false
static inline ::Unity::Burst::BurstExecutionEnvironment GetExecutionMode() ;

/// @brief Method GetILPPMethodFunctionPointer, addr 0x4471e6c, size 0x38, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<void> GetILPPMethodFunctionPointer(::System::IntPtr  ilppMethod) ;

/// @brief Method GetILPPMethodFunctionPointer2, addr 0x4471ea4, size 0xe4, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<void> GetILPPMethodFunctionPointer2(::System::IntPtr  ilppMethod, ::System::RuntimeMethodHandle  managedMethodHandle, ::System::RuntimeTypeHandle  delegateTypeHandle) ;

/// @brief Method InitialiseDebuggerHooks, addr 0x44727fc, size 0xd8, virtual false, abstract: false, final false
static inline void InitialiseDebuggerHooks() ;

/// @brief Method Initialize, addr 0x4472a3c, size 0x4, virtual false, abstract: false, final false
static inline void Initialize(::ArrayW<::StringW,::Array<::StringW>*>  assemblyFolders, ::ArrayW<::StringW,::Array<::StringW>*>  ignoreAssemblies) ;

/// @brief Method IsApiAvailable, addr 0x4471594, size 0x8c, virtual false, abstract: false, final false
static inline bool IsApiAvailable(::StringW  apiName) ;

/// @brief Method IsCurrentCompilationDone, addr 0x44721a0, size 0x8, virtual false, abstract: false, final false
static inline bool IsCurrentCompilationDone() ;

/// @brief Method IsHostEditorArm, addr 0x44721b0, size 0x8, virtual false, abstract: false, final false
static inline bool IsHostEditorArm() ;

/// @brief Method IsLoadAdditionalLibrarySupported, addr 0x4471530, size 0x64, virtual false, abstract: false, final false
static inline bool IsLoadAdditionalLibrarySupported() ;

/// @brief Method NotifyAssemblyCompilationFinished, addr 0x4472a48, size 0x4, virtual false, abstract: false, final false
static inline void NotifyAssemblyCompilationFinished(::StringW  assemblyName, ::ArrayW<::StringW,::Array<::StringW>*>  defines) ;

/// @brief Method NotifyAssemblyCompilationNotRequired, addr 0x4472a44, size 0x4, virtual false, abstract: false, final false
static inline void NotifyAssemblyCompilationNotRequired(::StringW  assemblyName) ;

/// @brief Method NotifyCompilationFinished, addr 0x4472a4c, size 0x4, virtual false, abstract: false, final false
static inline void NotifyCompilationFinished() ;

/// @brief Method NotifyCompilationStarted, addr 0x4472a40, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method RequestSetProtocolVersion, addr 0x44728d4, size 0x168, virtual false, abstract: false, final false
static inline int32_t RequestSetProtocolVersion(int32_t  version) ;

/// @brief Method SendCommandToCompiler, addr 0x4472734, size 0xc8, virtual false, abstract: false, final false
static inline ::StringW SendCommandToCompiler(::StringW  commandName, ::StringW  commandArgs) ;

/// @brief Method SendRawCommandToCompiler, addr 0x4472a94, size 0xb0, virtual false, abstract: false, final false
static inline ::StringW SendRawCommandToCompiler(::StringW  command) ;

/// @brief Method SetExecutionMode, addr 0x4471840, size 0x8, virtual false, abstract: false, final false
static inline void SetExecutionMode(::Unity::Burst::BurstExecutionEnvironment  mode) ;

/// @brief Method SetProfilerCallbacks, addr 0x4472a90, size 0x4, virtual false, abstract: false, final false
static inline void SetProfilerCallbacks() ;

/// @brief Method Shutdown, addr 0x4472198, size 0x4, virtual false, abstract: false, final false
static inline void Shutdown() ;

/// @brief Method TriggerRecompilation, addr 0x44726c8, size 0x4, virtual false, abstract: false, final false
static inline void TriggerRecompilation() ;

/// @brief Method TriggerUnsafeStaticMethodRecompilation, addr 0x44721b8, size 0x510, virtual false, abstract: false, final false
static inline void TriggerUnsafeStaticMethodRecompilation() ;

/// @brief Method UnloadAdditionalLibraries, addr 0x44726cc, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method get_IsEnabled, addr 0x44717a4, size 0x9c, virtual false, abstract: false, final false
