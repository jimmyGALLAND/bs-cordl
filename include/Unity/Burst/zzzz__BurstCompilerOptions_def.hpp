...
/// @brief Method AddOption, addr 0x4474ae0, size 0x4c, virtual false, abstract: false, final false
static inline void AddOption(::System::Text::StringBuilder*  builder, ::StringW  option) ;

/// @brief Method CheckIsSecondaryUnityProcess, addr 0x4474c3c, size 0x8, virtual false, abstract: false, final false
static inline bool CheckIsSecondaryUnityProcess() ;

/// @brief Method Clone, addr 0x4473ae4, size 0x148, virtual false, abstract: false, final false
inline ::Unity::Burst::BurstCompilerOptions* Clone() ;

/// @brief Method DeserialiseCompilationOptionsSafe, addr 0x4473424, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method GetBurstCompileAttribute, addr 0x4473cb8, size 0x420, virtual false, abstract: false, final false
static inline ::Unity::Burst::BurstCompileAttribute* GetBurstCompileAttribute(::System::Reflection::MemberInfo*  memberInfo) ;

/// @brief Method GetOption, addr 0x44749fc, size 0xe4, virtual false, abstract: false, final false
static inline ::StringW GetOption(::StringW  optionName, ::System::Object*  value) ;

/// @brief Method GetOptions, addr 0x4474398, size 0x664, virtual false, abstract: false, final false
inline ::StringW GetOptions(::Unity::Burst::BurstCompileAttribute*  attr, bool  isForILPostProcessing, bool  isForCompilerClient) ;

/// @brief Method HasBurstCompileAttribute, addr 0x44720d8, size 0xc0, virtual false, abstract: false, final false
static inline bool HasBurstCompileAttribute(::System::Reflection::MemberInfo*  member) ;

/// @brief Method MaybeTriggerRecompilation, addr 0x447399c, size 0x4, virtual false, abstract: false, final false
inline void MaybeTriggerRecompilation() ;

/// @brief Method MergeAttributes, addr 0x4474154, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method OnOptionsChanged, addr 0x4473940, size 0x1c, virtual false, abstract: false, final false
inline void OnOptionsChanged() ;

/// @brief Method SerialiseCompilationOptionsSafe, addr 0x447322c, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method TryGetAttribute, addr 0x44740d8, size 0x7c, virtual false, abstract: false, final false
static inline bool TryGetAttribute(::System::Reflection::Assembly*  assembly, ByRef<::Unity::Burst::BurstCompileAttribute*>  attribute) ;

/// @brief Method TryGetAttribute, addr 0x4473c2c, size 0x8c, virtual false, abstract: false, final false
static inline bool TryGetAttribute(::System::Reflection::MemberInfo*  member, ByRef<::Unity::Burst::BurstCompileAttribute*>  attribute) ;

/// @brief Method TryGetOptions, addr 0x447427c, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x447375c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4472d10, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method get_DisableOptimizations, addr 0x4473a10, size 0x8, virtual false, abstract: false, final false
inline bool get_DisableOptimizations() ;

/// @brief Method get_EnableBurstCompilation, addr 0x4473938, size 0x8, virtual false, abstract: false, final false
inline bool get_EnableBurstCompilation() ;

/// @brief Method get_EnableBurstCompileSynchronously, addr 0x447395c, size 0x8, virtual false, abstract: false, final false
inline bool get_EnableBurstCompileSynchronously() ;

/// @brief Method get_EnableBurstDebug, addr 0x44739d8, size 0x8, virtual false, abstract: false, final false
inline bool get_EnableBurstDebug() ;

/// @brief Method get_EnableBurstSafetyChecks, addr 0x4473994, size 0x8, virtual false, abstract: false, final false
inline bool get_EnableBurstSafetyChecks() ;

/// @brief Method get_EnableBurstTimings, addr 0x4473a28, size 0x8, virtual false, abstract: false, final false
inline bool get_EnableBurstTimings() ;

/// @brief Method get_EnableFastMath, addr 0x4473a1c, size 0x8, virtual false, abstract: false, final false
inline bool get_EnableFastMath() ;

/// @brief Method get_ForceEnableBurstSafetyChecks, addr 0x44739a0, size 0x8, virtual false, abstract: false, final false
inline bool get_ForceEnableBurstSafetyChecks() ;

/// @brief Method get_IsEnabled, addr 0x44738c4, size 0x74, virtual false, abstract: false, final false
inline bool get_IsEnabled() ;

/// @brief Method get_IsGlobal, addr 0x44738bc, size 0x8, virtual false, abstract: false, final false
inline bool get_IsGlobal() ;

/// @brief Method get_OptionsChanged, addr 0x4473ad4, size 0x8, virtual false, abstract: false, final false
inline ::System::Action* get_OptionsChanged() ;

/// @brief Method get_RequiresSynchronousCompilation, addr 0x4473a60, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method set_DisableOptimizations, addr 0x4473a18, size 0x4, virtual false, abstract: false, final false
inline void set_DisableOptimizations(bool  value) ;

/// @brief Method set_EnableBurstCompilation, addr 0x4473764, size 0x128, virtual false, abstract: false, final false
inline void set_EnableBurstCompilation(bool  value) ;

/// @brief Method set_EnableBurstCompileSynchronously, addr 0x4473964, size 0x30, virtual false, abstract: false, final false
inline void set_EnableBurstCompileSynchronously(bool  value) ;

/// @brief Method set_EnableBurstDebug, addr 0x44739e0, size 0x30, virtual false, abstract: false, final false
inline void set_EnableBurstDebug(bool  value) ;

/// @brief Method set_EnableBurstSafetyChecks, addr 0x447388c, size 0x30, virtual false, abstract: false, final false
inline void set_EnableBurstSafetyChecks(bool  value) ;

/// @brief Method set_EnableBurstTimings, addr 0x4473a30, size 0x30, virtual false, abstract: false, final false
inline void set_EnableBurstTimings(bool  value) ;

/// @brief Method set_EnableFastMath, addr 0x4473a24, size 0x4, virtual false, abstract: false, final false
inline void set_EnableFastMath(bool  value) ;

/// @brief Method set_ForceEnableBurstSafetyChecks, addr 0x44739a8, size 0x30, virtual false, abstract: false, final false
inline void set_ForceEnableBurstSafetyChecks(bool  value) ;

/// @brief Method set_OptionsChanged, addr 0x4473adc, size 0x8, virtual false, abstract: false, final false
