...
template<typename T>
inline void Unity::Burst::SharedStatic_1<T>::_ctor(::cordl_internals::Ptr<void>  buffer)  {
...
template<typename T>
inline ::cordl_internals::Ptr<void> Unity::Burst::SharedStatic_1<T>::get_UnsafeDataPointer()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Burst::SharedStatic_1<T>>::get(),
...
template<typename T>
constexpr ::Unity::Burst::SharedStatic_1<T>::SharedStatic_1(::cordl_internals::Ptr<void>  _buffer) noexcept  {
