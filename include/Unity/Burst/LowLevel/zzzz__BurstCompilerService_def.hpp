...
/// @brief Method CompileAsyncDelegateMethod, addr 0x47ce888, size 0x44, virtual false, abstract: false, final false
static inline int32_t CompileAsyncDelegateMethod(::System::Object*  delegateMethod, ::StringW  compilerOptions) ;

/// @brief Method GetAsyncCompiledAsyncDelegateMethod, addr 0x47ce8cc, size 0x3c, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<void> GetAsyncCompiledAsyncDelegateMethod(int32_t  userID) ;

/// @brief Method GetCurrentExecutionMode, addr 0x47ce944, size 0x28, virtual false, abstract: false, final false
static inline uint32_t GetCurrentExecutionMode() ;

/// @brief Method GetDisassembly, addr 0x47ce844, size 0x44, virtual false, abstract: false, final false
static inline ::StringW GetDisassembly(::System::Reflection::MethodInfo*  m, ::StringW  compilerOptions) ;

/// @brief Method GetOrCreateSharedMemory, addr 0x47ce0c0, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method LoadBurstLibrary, addr 0x47cea44, size 0x3c, virtual false, abstract: false, final false
static inline bool LoadBurstLibrary(::StringW  fullPathToLibBurstGenerated) ;

/// @brief Method Log, addr 0x47ce96c, size 0x6c, virtual false, abstract: false, final false
static inline void Log(::cordl_internals::Ptr<void>  userData, ::Unity::Burst::LowLevel::__BurstCompilerService__BurstLogType  logType, ::cordl_internals::Ptr<uint8_t>  message, ::cordl_internals::Ptr<uint8_t>  filename, int32_t  lineNumber) ;

/// @brief Method RuntimeLog, addr 0x47ce9d8, size 0x6c, virtual false, abstract: false, final false
static inline void RuntimeLog(::cordl_internals::Ptr<void>  userData, ::Unity::Burst::LowLevel::__BurstCompilerService__BurstLogType  logType, ::cordl_internals::Ptr<uint8_t>  message, ::cordl_internals::Ptr<uint8_t>  filename, int32_t  lineNumber) ;

/// @brief Method SetCurrentExecutionMode, addr 0x47ce908, size 0x3c, virtual false, abstract: false, final false
