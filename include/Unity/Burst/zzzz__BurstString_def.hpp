...
/// @brief Method .ctor, addr 0x4479308, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
public:
// Declarations
/// @brief Method GetDigitsPointer, addr 0x4479310, size 0x8, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<uint8_t> GetDigitsPointer() ;

/// @brief Method .ctor, addr 0x44765dc, size 0x18, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_buffer", ty: "::cordl_internals::Ptr<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "Kind", ty: "::Unity::Burst::__BurstString__NumberBufferKind", modifiers: "", def_value: None }, CppParam { name: "DigitsCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "Scale", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "IsNegative", ty: "bool", modifiers: "", def_value: None }]
...
/// @brief Method EncodeToRaw, addr 0x4479318, size 0x8, virtual false, abstract: false, final false
inline int32_t EncodeToRaw() ;

/// @brief Method GetBase, addr 0x4476570, size 0x18, virtual false, abstract: false, final false
inline int32_t GetBase() ;

/// @brief Method ToString, addr 0x4479320, size 0x2ec, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x44772d0, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::Unity::Burst::__BurstString__NumberFormatKind  kind, int8_t  alignAndSize, uint8_t  specifier, bool  lowercase) ;

/// @brief Method get_Uppercase, addr 0x4476588, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "Kind", ty: "::Unity::Burst::__BurstString__NumberFormatKind", modifiers: "", def_value: None }, CppParam { name: "AlignAndSize", ty: "int8_t", modifiers: "", def_value: None }, CppParam { name: "Specifier", ty: "uint8_t", modifiers: "", def_value: None }, CppParam { name: "Lowercase", ty: "bool", modifiers: "", def_value: None }]
...
/// @brief Method GetBlock, addr 0x4478944, size 0xc, virtual false, abstract: false, final false
inline uint32_t GetBlock(int32_t  idx) ;

/// @brief Method GetLength, addr 0x447960c, size 0x8, virtual false, abstract: false, final false
inline int32_t GetLength() ;

/// @brief Method GetU32, addr 0x447961c, size 0x18, virtual false, abstract: false, final false
inline uint32_t GetU32() ;

/// @brief Method IsZero, addr 0x4478950, size 0x10, virtual false, abstract: false, final false
inline bool IsZero() ;

/// @brief Method SetU32, addr 0x4477c5c, size 0x1c, virtual false, abstract: false, final false
inline void SetU32(uint32_t  val) ;

/// @brief Method SetU64, addr 0x4478914, size 0x30, virtual false, abstract: false, final false
inline void SetU64(uint64_t  val) ;

/// @brief Method SetZero, addr 0x4479614, size 0x8, virtual false, abstract: false, final false
inline void SetZero() ;
...
// Ctor Parameters [CppParam { name: "m_length", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_blocks", ty: "::GlobalNamespace::__BurstString__tBigInt___m_blocks_e__FixedBuffer", modifiers: "", def_value: None }]
...
/// @brief Method GetExponent, addr 0x4479114, size 0xc, virtual false, abstract: false, final false
inline uint32_t GetExponent() ;

/// @brief Method GetMantissa, addr 0x4479120, size 0xc, virtual false, abstract: false, final false
inline uint32_t GetMantissa() ;

/// @brief Method IsNegative, addr 0x447912c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method GetExponent, addr 0x4479138, size 0xc, virtual false, abstract: false, final false
inline uint32_t GetExponent() ;

/// @brief Method GetMantissa, addr 0x4479144, size 0xc, virtual false, abstract: false, final false
inline uint64_t GetMantissa() ;

/// @brief Method IsNegative, addr 0x4479150, size 0xc, virtual false, abstract: false, final false
inline bool IsNegative() ;
...
/// @brief Method AlignLeft, addr 0x447524c, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method AlignRight, addr 0x4475298, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Add, addr 0x4477480, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Add_internal, addr 0x4477508, size 0xa8, virtual false, abstract: false, final false
static inline void BigInt_Add_internal(ByRef<::Unity::Burst::__BurstString__tBigInt>  pResult, ByRef<::Unity::Burst::__BurstString__tBigInt>  pLarge, ByRef<::Unity::Burst::__BurstString__tBigInt>  pSmall) ;

/// @brief Method BigInt_Compare, addr 0x4477430, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method BigInt_DivideWithRemainder_MaxQuotient9, addr 0x4477e60, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Multiply, addr 0x44775b0, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Multiply, addr 0x447772c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Multiply10, addr 0x4477844, size 0x5c, virtual false, abstract: false, final false
static inline void BigInt_Multiply10(ByRef<::Unity::Burst::__BurstString__tBigInt>  pResult) ;

/// @brief Method BigInt_Multiply2, addr 0x44777e8, size 0x5c, virtual false, abstract: false, final false
static inline void BigInt_Multiply2(ByRef<::Unity::Burst::__BurstString__tBigInt>  pResult) ;

/// @brief Method BigInt_Multiply2, addr 0x447778c, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method BigInt_MultiplyPow10, addr 0x4477c78, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method BigInt_Multiply_internal, addr 0x4477638, size 0xf4, virtual false, abstract: false, final false
static inline void BigInt_Multiply_internal(ByRef<::Unity::Burst::__BurstString__tBigInt>  pResult, ByRef<::Unity::Burst::__BurstString__tBigInt>  pLarge, ByRef<::Unity::Burst::__BurstString__tBigInt>  pSmall) ;

/// @brief Method BigInt_Pow10, addr 0x4477ae8, size 0x174, virtual false, abstract: false, final false
static inline void BigInt_Pow10(ByRef<::Unity::Burst::__BurstString__tBigInt>  pResult, uint32_t  exponent) ;

/// @brief Method BigInt_Pow2, addr 0x4477e04, size 0x5c, virtual false, abstract: false, final false
static inline void BigInt_Pow2(ByRef<::Unity::Burst::__BurstString__tBigInt>  pResult, uint32_t  exponent) ;

/// @brief Method BigInt_ShiftLeft, addr 0x4478028, size 0x114, virtual false, abstract: false, final false
static inline void BigInt_ShiftLeft(ByRef<::Unity::Burst::__BurstString__tBigInt>  pResult, uint32_t  shift) ;

/// @brief Method ConvertDoubleToString, addr 0x44756f8, size 0x27c, virtual false, abstract: false, final false
static inline void ConvertDoubleToString(::cordl_internals::Ptr<uint8_t>  dest, ByRef<int32_t>  destIndex, int32_t  destLength, double_t  value, ::Unity::Burst::__BurstString__FormatOptions  formatOptions) ;

/// @brief Method ConvertFloatToString, addr 0x44753ec, size 0x280, virtual false, abstract: false, final false
static inline void ConvertFloatToString(::cordl_internals::Ptr<uint8_t>  dest, ByRef<int32_t>  destIndex, int32_t  destLength, float_t  value, ::Unity::Burst::__BurstString__FormatOptions  formatOptions) ;

/// @brief Method ConvertIntegerToString, addr 0x44761a8, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method ConvertUnsignedIntegerToString, addr 0x4475f4c, size 0x1a4, virtual false, abstract: false, final false
static inline void ConvertUnsignedIntegerToString(::cordl_internals::Ptr<uint8_t>  dest, ByRef<int32_t>  destIndex, int32_t  destLength, uint64_t  value, ::Unity::Burst::__BurstString__FormatOptions  options) ;

/// @brief Method CopyFixedString, addr 0x44750f8, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method Dragon4, addr 0x447813c, size 0x7d8, virtual false, abstract: false, final false
static inline uint32_t Dragon4(uint64_t  mantissa, int32_t  exponent, uint32_t  mantissaHighBitIdx, bool  hasUnequalMargins, ::Unity::Burst::__BurstString__CutoffMode  cutoffMode, uint32_t  cutoffNumber, ::cordl_internals::Ptr<uint8_t>  pOutBuffer, uint32_t  bufferSize, ByRef<int32_t>  pOutExponent) ;

/// @brief Method Format, addr 0x447511c, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x4475974, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x4475b44, size 0x1f8, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x447566c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x4475360, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x447635c, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x4476414, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x44764cc, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x44760f0, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x4475e44, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x4475ec8, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x4475dc0, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method Format, addr 0x4475d3c, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method FormatDecimalOrHexadecimal, addr 0x4476894, size 0xa0, virtual false, abstract: false, final false
static inline void FormatDecimalOrHexadecimal(::cordl_internals::Ptr<uint8_t>  dest, ByRef<int32_t>  destIndex, int32_t  destLength, ByRef<::Unity::Burst::__BurstString__NumberBuffer>  number, int32_t  zeroPadding, bool  outputPositiveSign) ;

/// @brief Method FormatGeneral, addr 0x4476bb4, size 0x1f4, virtual false, abstract: false, final false
static inline void FormatGeneral(::cordl_internals::Ptr<uint8_t>  dest, ByRef<int32_t>  destIndex, int32_t  destLength, ByRef<::Unity::Burst::__BurstString__NumberBuffer>  number, int32_t  nMaxDigits, uint8_t  expChar) ;

/// @brief Method FormatInfinityNaN, addr 0x4478f18, size 0x1fc, virtual false, abstract: false, final false
static inline void FormatInfinityNaN(::cordl_internals::Ptr<uint8_t>  dest, ByRef<int32_t>  destIndex, int32_t  destLength, uint64_t  mantissa, bool  isNegative, ::Unity::Burst::__BurstString__FormatOptions  formatOptions) ;

/// @brief Method FormatNumber, addr 0x44765f4, size 0x274, virtual false, abstract: false, final false
static inline void FormatNumber(::cordl_internals::Ptr<uint8_t>  dest, ByRef<int32_t>  destIndex, int32_t  destLength, ByRef<::Unity::Burst::__BurstString__NumberBuffer>  number, int32_t  nMaxDigits, ::Unity::Burst::__BurstString__FormatOptions  options) ;

/// @brief Method FormatPositional, addr 0x4478960, size 0x338, virtual false, abstract: false, final false
static inline int32_t FormatPositional(::cordl_internals::Ptr<uint8_t>  pOutBuffer, uint32_t  bufferSize, uint64_t  mantissa, int32_t  exponent, uint32_t  mantissaHighBitIdx, bool  hasUnequalMargins, int32_t  precision) ;

/// @brief Method FormatScientific, addr 0x4478c98, size 0x280, virtual false, abstract: false, final false
static inline int32_t FormatScientific(::cordl_internals::Ptr<uint8_t>  pOutBuffer, uint32_t  bufferSize, uint64_t  mantissa, int32_t  exponent, uint32_t  mantissaHighBitIdx, bool  hasUnequalMargins, int32_t  precision) ;

/// @brief Method GetLengthForFormatGeneral, addr 0x4476a6c, size 0x148, virtual false, abstract: false, final false
static inline int32_t GetLengthForFormatGeneral(ByRef<::Unity::Burst::__BurstString__NumberBuffer>  number, int32_t  nMaxDigits) ;

/// @brief Method GetLengthIntegerToString, addr 0x4476868, size 0x2c, virtual false, abstract: false, final false
static inline int32_t GetLengthIntegerToString(int64_t  value, int32_t  basis, int32_t  zeroPadding) ;

/// @brief Method LogBase2, addr 0x447730c, size 0x124, virtual false, abstract: false, final false
static inline uint32_t LogBase2(uint32_t  val) ;

/// @brief Method OptsSplit, addr 0x4476da8, size 0x170, virtual false, abstract: false, final false
static inline void OptsSplit(::StringW  fullFormat, ByRef<::StringW>  padding, ByRef<::StringW>  format) ;

/// @brief Method ParseFormatToFormatOptions, addr 0x4476f18, size 0x3b8, virtual false, abstract: false, final false
static inline ::Unity::Burst::__BurstString__FormatOptions ParseFormatToFormatOptions(::StringW  fullFormat) ;

/// @brief Method RoundNumber, addr 0x4476934, size 0x138, virtual false, abstract: false, final false
static inline void RoundNumber(ByRef<::Unity::Burst::__BurstString__NumberBuffer>  number, int32_t  pos, bool  isCorrectlyRounded) ;

/// @brief Method ShouldRoundUp, addr 0x44772e8, size 0x24, virtual false, abstract: false, final false
static inline bool ShouldRoundUp(::cordl_internals::Ptr<uint8_t>  dig, int32_t  i, bool  isCorrectlyRounded) ;

/// @brief Method ValueToIntegerChar, addr 0x4476598, size 0x44, virtual false, abstract: false, final false
static inline uint8_t ValueToIntegerChar(int32_t  value, bool  uppercase) ;

/// @brief Method g_PowerOf10_Big, addr 0x44778a0, size 0x248, virtual false, abstract: false, final false
