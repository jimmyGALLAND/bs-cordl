...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Unity::XR::Oculus::OculusSettings::*)()>(&::Unity::XR::Oculus::OculusSettings::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x47a57c4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Unity::XR::Oculus::OculusSettings::*)()>(&::Unity::XR::Oculus::OculusSettings::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x47a5810;
...
::cordl_internals::setStaticField<::UnityW<::Unity::XR::Oculus::OculusSettings>, "s_Settings", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::XR::Oculus::OculusSettings*>::get>(std::forward<::UnityW<::Unity::XR::Oculus::OculusSettings>>(value));
}
inline ::UnityW<::Unity::XR::Oculus::OculusSettings> Unity::XR::Oculus::OculusSettings::getStaticF_s_Settings()  {
return ::cordl_internals::getStaticField<::UnityW<::Unity::XR::Oculus::OculusSettings>, "s_Settings", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::XR::Oculus::OculusSettings*>::get>();
}
