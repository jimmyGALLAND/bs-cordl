...
// Ctor Parameters []
constexpr ::Unity::XR::Oculus::SystemHeadset::SystemHeadset()   {
}
...
constexpr ::Unity::XR::Oculus::SystemHeadset  Unity::XR::Oculus::SystemHeadset::Placeholder_13{static_cast<int32_t>(0xd)};
constexpr ::Unity::XR::Oculus::SystemHeadset  Unity::XR::Oculus::SystemHeadset::Placeholder_14{static_cast<int32_t>(0xe)};
constexpr ::Unity::XR::Oculus::SystemHeadset  Unity::XR::Oculus::SystemHeadset::Rift_DK1{static_cast<int32_t>(0x1000)};
constexpr ::Unity::XR::Oculus::SystemHeadset  Unity::XR::Oculus::SystemHeadset::Rift_DK2{static_cast<int32_t>(0x1001)};
constexpr ::Unity::XR::Oculus::SystemHeadset  Unity::XR::Oculus::SystemHeadset::Rift_CV1{static_cast<int32_t>(0x1002)};
constexpr ::Unity::XR::Oculus::SystemHeadset  Unity::XR::Oculus::SystemHeadset::Rift_CB{static_cast<int32_t>(0x1003)};
