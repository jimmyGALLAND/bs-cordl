...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(int32_t)>(&::Unity::XR::Oculus::Performance::TrySetCPULevel)> {
  ...
  constexpr static std::size_t addrs = 0x47a2528;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(int32_t)>(&::Unity::XR::Oculus::Performance::TrySetGPULevel)> {
  constexpr static std::size_t size = 0x18;
  constexpr static std::size_t addrs = 0x47a2544;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(ByRef<::ArrayW<float_t,::Array<float_t>*>>)>(&::Unity::XR::Oculus::Performance::TryGetAvailableDisplayRefreshRates)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(float_t)>(&::Unity::XR::Oculus::Performance::TrySetDisplayRefreshRate)> {
  ...
  constexpr static std::size_t addrs = 0x47a2700;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(ByRef<float_t>)>(&::Unity::XR::Oculus::Performance::TryGetDisplayRefreshRate)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x47a2708;
...
::cordl_internals::setStaticField<::ArrayW<float_t,::Array<float_t>*>, "cachedDisplayAvailableFrequencies", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::XR::Oculus::Performance*>::get>(std::forward<::ArrayW<float_t,::Array<float_t>*>>(value));
}
inline ::ArrayW<float_t,::Array<float_t>*> Unity::XR::Oculus::Performance::getStaticF_cachedDisplayAvailableFrequencies()  {
return ::cordl_internals::getStaticField<::ArrayW<float_t,::Array<float_t>*>, "cachedDisplayAvailableFrequencies", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::XR::Oculus::Performance*>::get>();
}
