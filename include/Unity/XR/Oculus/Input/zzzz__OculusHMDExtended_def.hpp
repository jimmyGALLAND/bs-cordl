...
/// @brief Method FinishSetup, addr 0x47a6768, size 0xbc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x47a6824, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_back, addr 0x47a6748, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_back() ;

/// @brief Method get_touchpad, addr 0x47a6758, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::Vector2Control* get_touchpad() ;

/// @brief Method set_back, addr 0x47a6750, size 0x8, virtual false, abstract: false, final false
inline void set_back(::UnityEngine::InputSystem::Controls::ButtonControl*  value) ;

/// @brief Method set_touchpad, addr 0x47a6760, size 0x8, virtual false, abstract: false, final false
