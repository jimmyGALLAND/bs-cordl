...
static __declspec(property(get=getStaticF_s_InputSubsystemDescriptors, put=setStaticF_s_InputSubsystemDescriptors)) ::System::Collections::Generic::List_1<Il2CppObject*>*  s_InputSubsystemDescriptors;

/// @brief Method CheckUnityVersionCompatibility, addr 0x47a1c54, size 0x318, virtual false, abstract: false, final false
inline bool CheckUnityVersionCompatibility() ;

/// @brief Method Deinitialize, addr 0x47a2138, size 0x7c, virtual true, abstract: false, final false
inline bool Deinitialize() ;

/// @brief Method GetSettings, addr 0x47a23fc, size 0x48, virtual false, abstract: false, final false
inline ::UnityW<::Unity::XR::Oculus::OculusSettings> GetSettings() ;

/// @brief Method Initialize, addr 0x47a18d4, size 0x380, virtual true, abstract: false, final false
inline bool Initialize() ;

/// @brief Method IsDeviceSupported, addr 0x47a1778, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method RuntimeLoadOVRPlugin, addr 0x47a2254, size 0x1a4, virtual false, abstract: false, final false
static inline void RuntimeLoadOVRPlugin() ;

/// @brief Method Start, addr 0x47a2040, size 0x7c, virtual true, abstract: false, final false
inline bool Start() ;

/// @brief Method Stop, addr 0x47a20bc, size 0x7c, virtual true, abstract: false, final false
inline bool Stop() ;

/// @brief Method .ctor, addr 0x47a2444, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_displaySubsystem, addr 0x47a180c, size 0x64, virtual false, abstract: false, final false
inline Il2CppObject* get_displaySubsystem() ;

/// @brief Method get_inputSubsystem, addr 0x47a1870, size 0x64, virtual false, abstract: false, final false
