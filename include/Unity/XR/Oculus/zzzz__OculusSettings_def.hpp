...
/// @brief Field FoveatedRenderingMethod, offset 0x28, size 0x4 
 __declspec(property(get=__cordl_internal_get_FoveatedRenderingMethod, put=__cordl_internal_set_FoveatedRenderingMethod)) ::Unity::XR::Oculus::__OculusSettings__FoveationMethod  FoveatedRenderingMethod;
...
/// @brief Field m_StereoRenderingModeAndroid, offset 0x1c, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_StereoRenderingModeAndroid, put=__cordl_internal_set_m_StereoRenderingModeAndroid)) ::Unity::XR::Oculus::__OculusSettings__StereoRenderingModeAndroid  m_StereoRenderingModeAndroid;

/// @brief Field m_StereoRenderingModeDesktop, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_StereoRenderingModeDesktop, put=__cordl_internal_set_m_StereoRenderingModeDesktop)) ::Unity::XR::Oculus::__OculusSettings__StereoRenderingModeDesktop  m_StereoRenderingModeDesktop;
...
/// @brief Method Awake, addr 0x47a57c4, size 0x4c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetStereoRenderingMode, addr 0x47a1f6c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x47a5810, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
