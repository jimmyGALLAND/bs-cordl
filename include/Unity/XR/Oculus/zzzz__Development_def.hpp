...
/// @brief Method OverrideDeveloperModeStart, addr 0x47a12a8, size 0xd4, virtual false, abstract: false, final false
static inline void OverrideDeveloperModeStart() ;

/// @brief Method OverrideDeveloperModeStop, addr 0x47a1384, size 0x74, virtual false, abstract: false, final false
static inline void OverrideDeveloperModeStop() ;

/// @brief Method TrySetDeveloperMode, addr 0x47a1250, size 0x58, virtual false, abstract: false, final false
