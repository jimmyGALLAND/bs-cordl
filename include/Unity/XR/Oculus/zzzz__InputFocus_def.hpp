...
/// @brief Method Update, addr 0x47a1180, size 0xa0, virtual false, abstract: false, final false
static inline void Update() ;

/// @brief Method .ctor, addr 0x47a1220, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_InputFocusAcquired, addr 0x47a0e90, size 0xb8, virtual false, abstract: false, final false
static inline void add_InputFocusAcquired(::System::Action*  value) ;

/// @brief Method add_InputFocusLost, addr 0x47a1000, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method get_hasInputFocus, addr 0x47a1178, size 0x4, virtual false, abstract: false, final false
static inline bool get_hasInputFocus() ;

/// @brief Method remove_InputFocusAcquired, addr 0x47a0f48, size 0xb8, virtual false, abstract: false, final false
static inline void remove_InputFocusAcquired(::System::Action*  value) ;

/// @brief Method remove_InputFocusLost, addr 0x47a10bc, size 0xbc, virtual false, abstract: false, final false
