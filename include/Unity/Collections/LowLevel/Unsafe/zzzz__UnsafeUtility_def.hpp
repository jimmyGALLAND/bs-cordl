...
template<typename T>
struct __UnsafeUtility__AlignOfHelper_1;
}
namespace Unity::Collections::LowLevel::Unsafe {
template<typename T>
struct __UnsafeUtility__TypeFlagsCache_1;
}
...
// Declarations
template<typename T>
using AlignOfHelper_1 = ::Unity::Collections::LowLevel::Unsafe::__UnsafeUtility__AlignOfHelper_1<T>;

template<typename T>
using TypeFlagsCache_1 = ::Unity::Collections::LowLevel::Unsafe::__UnsafeUtility__TypeFlagsCache_1<T>;
...
/// @brief Method Free, addr 0x47ce328, size 0x44, virtual false, abstract: false, final false
static inline void Free(::cordl_internals::Ptr<void>  memory, ::Unity::Collections::Allocator  allocator) ;

/// @brief Method FreeTracked, addr 0x47cdf84, size 0x44, virtual false, abstract: false, final false
static inline void FreeTracked(::cordl_internals::Ptr<void>  memory, ::Unity::Collections::Allocator  allocator) ;

/// @brief Method GetReasonForArrayNonBlittable, addr 0x47ce7e8, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method GetReasonForTypeNonBlittableImpl, addr 0x47ce5fc, size 0x1bc, virtual false, abstract: false, final false
static inline ::StringW GetReasonForTypeNonBlittableImpl(::System::Type*  t, ::StringW  name) ;

/// @brief Method GetScriptingTypeFlags, addr 0x47ce560, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method IsArrayBlittable, addr 0x47ce7b8, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method IsBlittable, addr 0x47ce524, size 0x3c, virtual false, abstract: false, final false
static inline bool IsBlittable(::System::Type*  type) ;

/// @brief Method IsBlittableValueType, addr 0x47ce59c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method LeakErase, addr 0x47ce234, size 0x44, virtual false, abstract: false, final false
static inline int32_t LeakErase(::System::IntPtr  handle, ::Unity::Collections::LeakCategory  category) ;

/// @brief Method LeakRecord, addr 0x47ce1e0, size 0x54, virtual false, abstract: false, final false
static inline int32_t LeakRecord(::System::IntPtr  handle, ::Unity::Collections::LeakCategory  category, int32_t  callstacksToSkip) ;

/// @brief Method Malloc, addr 0x47ce2d4, size 0x54, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<void> Malloc(int64_t  size, int32_t  alignment, ::Unity::Collections::Allocator  allocator) ;

/// @brief Method MallocTracked, addr 0x47ce278, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method MemClear, addr 0x47ce488, size 0x48, virtual false, abstract: false, final false
static inline void MemClear(::cordl_internals::Ptr<void>  destination, int64_t  size) ;

/// @brief Method MemCmp, addr 0x47ce4d0, size 0x54, virtual false, abstract: false, final false
static inline int32_t MemCmp(::cordl_internals::Ptr<void>  ptr1, ::cordl_internals::Ptr<void>  ptr2, int64_t  size) ;

/// @brief Method MemCpy, addr 0x47cdd54, size 0x54, virtual false, abstract: false, final false
static inline void MemCpy(::cordl_internals::Ptr<void>  destination, ::cordl_internals::Ptr<void>  source, int64_t  size) ;

/// @brief Method MemCpyStride, addr 0x47ce36c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method MemMove, addr 0x47ce3e0, size 0x54, virtual false, abstract: false, final false
static inline void MemMove(::cordl_internals::Ptr<void>  destination, ::cordl_internals::Ptr<void>  source, int64_t  size) ;

/// @brief Method MemSet, addr 0x47ce434, size 0x54, virtual false, abstract: false, final false
