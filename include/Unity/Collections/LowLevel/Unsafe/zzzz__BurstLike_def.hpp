...
template<typename T>
struct __BurstLike__SharedStatic_1;
}
namespace Unity::Collections::LowLevel::Unsafe {
...
static inline ::Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic_1<T> GetOrCreate(uint32_t  alignment) ;
...
public:
// Declarations
/// @brief Method GetOrCreateSharedStaticInternal, addr 0x47ce04c, size 0x74, virtual false, abstract: false, final false
...
template<typename T>
using SharedStatic_1 = ::Unity::Collections::LowLevel::Unsafe::__BurstLike__SharedStatic_1<T>;
