...
#include "Unity/Collections/LowLevel/Unsafe/zzzz__BurstRuntime_def.hpp"
template<typename T>
inline void Unity::Collections::LowLevel::Unsafe::__BurstRuntime__HashCode64_1<T>::setStaticF_Value(int64_t  value)  {
::cordl_internals::setStaticField<int64_t, "Value", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::LowLevel::Unsafe::__BurstRuntime__HashCode64_1<T>>::get>(std::forward<int64_t>(value));
}
template<typename T>
inline int64_t Unity::Collections::LowLevel::Unsafe::__BurstRuntime__HashCode64_1<T>::getStaticF_Value()  {
...
// Ctor Parameters []
template<typename T>
constexpr ::Unity::Collections::LowLevel::Unsafe::__BurstRuntime__HashCode64_1<T>::__BurstRuntime__HashCode64_1()   {
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int64_t (*)(::StringW)>(&::Unity::Collections::LowLevel::Unsafe::BurstRuntime::HashStringWithFNV1A64)> {
  ...
  constexpr static std::size_t addrs = 0x47ce114;
