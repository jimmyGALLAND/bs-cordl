...
/// @brief Method GetCustomAttributes, addr 0x487d2ec, size 0xc, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerable_1<::System::Attribute*>* GetCustomAttributes() ;

/// @brief Method .ctor, addr 0x487d2cc, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::Reflection::PropertyInfo*  propertyInfo) ;

/// @brief Method get_IsReadOnly, addr 0x487d278, size 0x30, virtual true, abstract: false, final true
inline bool get_IsReadOnly() ;

/// @brief Method get_Name, addr 0x487d270, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_Name() ;

/// @brief Method get_ValueType, addr 0x487d2a8, size 0x24, virtual true, abstract: false, final true
