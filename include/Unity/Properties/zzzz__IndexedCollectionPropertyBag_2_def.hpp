...
class __IndexedCollectionPropertyBag_2__ListElementProperty;
}
...
/// @brief Field m_Property, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Property, put=__cordl_internal_set_m_Property)) ::Unity::Properties::__IndexedCollectionPropertyBag_2__ListElementProperty<TList,TElement>*  m_Property;
