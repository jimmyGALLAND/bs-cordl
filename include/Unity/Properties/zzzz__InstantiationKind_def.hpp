...
// Type: Unity.Properties::InstantiationKind
...
/// @brief Field Activator value: static_cast<int32_t>(0x0)
static ::Unity::Properties::InstantiationKind const Activator;

/// @brief Field NotInstantiatable value: static_cast<int32_t>(0x2)
static ::Unity::Properties::InstantiationKind const NotInstantiatable;

/// @brief Field PropertyBagOverride value: static_cast<int32_t>(0x1)
