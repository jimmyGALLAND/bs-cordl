...
namespace Unity::Properties {
template<typename T>
struct __TypeUtility__Cache_1;
}
namespace Unity::Properties {
template<typename T>
class __TypeUtility__ITypeConstructor_1;
}
namespace Unity::Properties {
...
namespace Unity::Properties {
template<typename T>
class __TypeUtility__TypeConstructor_1;
}
namespace Unity::Properties {
...
/// @brief Method Instantiate, addr 0x487ed70, size 0x4c, virtual true, abstract: false, final true
inline ::System::Object* Instantiate() ;

static inline ::Unity::Properties::__TypeUtility__NonConstructable* New_ctor() ;

/// @brief Method Unity.Properties.TypeUtility.ITypeConstructor.get_CanBeInstantiated, addr 0x487ed68, size 0x8, virtual true, abstract: false, final true
inline bool Unity_Properties_TypeUtility_ITypeConstructor_get_CanBeInstantiated() ;

/// @brief Method .ctor, addr 0x487e944, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x487e93c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <.cctor>b__11_0, addr 0x487ee20, size 0x54, virtual false, abstract: false, final false
inline ::System::Text::StringBuilder* __cctor_b__11_0() ;

/// @brief Method <.cctor>b__11_1, addr 0x487ee74, size 0x18, virtual false, abstract: false, final false
inline void __cctor_b__11_1(::System::Text::StringBuilder*  sb) ;

/// @brief Method <.cctor>b__11_2, addr 0x487ee8c, size 0x48, virtual false, abstract: false, final false
inline ::StringW __cctor_b__11_2() ;

/// @brief Method .ctor, addr 0x487ee18, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Declarations
template<typename T>
using Cache_1 = ::Unity::Properties::__TypeUtility__Cache_1<T>;

using ITypeConstructor = ::Unity::Properties::__TypeUtility__ITypeConstructor;

template<typename T>
using ITypeConstructor_1 = ::Unity::Properties::__TypeUtility__ITypeConstructor_1<T>;
...
template<typename T>
using TypeConstructor_1 = ::Unity::Properties::__TypeUtility__TypeConstructor_1<T>;
...
static __declspec(property(get=getStaticF_s_CachedResolvedName, put=setStaticF_s_CachedResolvedName)) ::System::Collections::Concurrent::ConcurrentDictionary_2<::System::Type*,::StringW>*  s_CachedResolvedName;
...
static __declspec(property(get=getStaticF_s_TypeConstructors, put=setStaticF_s_TypeConstructors)) ::System::Collections::Concurrent::ConcurrentDictionary_2<::System::Type*,::Unity::Properties::__TypeUtility__ITypeConstructor*>*  s_TypeConstructors;
...
/// @brief Method CanBeInstantiated, addr 0x487ea04, size 0xcc, virtual false, abstract: false, final false
static inline bool CanBeInstantiated(::System::Type*  type) ;

/// @brief Method CheckCanBeInstantiated, addr 0x487ec38, size 0x130, virtual false, abstract: false, final false
...
template<typename T>
static inline void CheckCanBeInstantiated(::Unity::Properties::__TypeUtility__ITypeConstructor_1<T>*  constructor) ;

/// @brief Method CheckIsAssignableFrom, addr 0x487ead0, size 0x168, virtual false, abstract: false, final false
static inline void CheckIsAssignableFrom(::System::Type*  type, ::System::Type*  derivedType) ;

/// @brief Method CreateTypeConstructor, addr 0x487e440, size 0x278, virtual false, abstract: false, final false
...
template<typename T>
static inline ::Unity::Properties::__TypeUtility__ITypeConstructor_1<T>* CreateTypeConstructor() ;

/// @brief Method GetRootType, addr 0x487e30c, size 0x134, virtual false, abstract: false, final false
static inline ::System::Type* GetRootType(::System::Type*  type) ;

/// @brief Method GetTypeConstructor, addr 0x487e94c, size 0xb8, virtual false, abstract: false, final false
...
template<typename T>
static inline ::Unity::Properties::__TypeUtility__ITypeConstructor_1<T>* GetTypeConstructor() ;

/// @brief Method GetTypeDisplayName, addr 0x487d850, size 0x118, virtual false, abstract: false, final false
static inline ::StringW GetTypeDisplayName(::System::Type*  type) ;

/// @brief Method GetTypeDisplayName, addr 0x487d968, size 0x9a4, virtual false, abstract: false, final false
...
template<typename T>
static inline bool TryInstantiate(::System::Type*  derivedType, ByRef<T>  value) ;

/// @brief Method TryInstantiate, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool TryInstantiate(ByRef<T>  instance) ;

/// @brief Method TryInstantiateArray, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TArray>
static inline bool TryInstantiateArray(int32_t  count, ByRef<TArray>  instance) ;
