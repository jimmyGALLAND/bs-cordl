...
constexpr TElement& Unity::Properties::__SetPropertyBagBase_2__SetElementProperty<TSet,TElement>::__cordl_internal_get_m_Value()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Value;
}
template<typename TSet,typename TElement>
constexpr TElement const& Unity::Properties::__SetPropertyBagBase_2__SetElementProperty<TSet,TElement>::__cordl_internal_get_m_Value() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Value;
}
template<typename TSet,typename TElement>
constexpr void Unity::Properties::__SetPropertyBagBase_2__SetElementProperty<TSet,TElement>::__cordl_internal_set_m_Value(TElement  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename TSet,typename TElement>
inline ::StringW Unity::Properties::__SetPropertyBagBase_2__SetElementProperty<TSet,TElement>::get_Name()  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::__SetPropertyBagBase_2__SetElementProperty<TSet,TElement>*>::get(),
                    7
                )));
...
template<typename TSet,typename TElement>
inline void Unity::Properties::__SetPropertyBagBase_2__SetElementProperty<TSet,TElement>::_ctor()  {
...
// Ctor Parameters []
template<typename TSet,typename TElement>
constexpr ::Unity::Properties::__SetPropertyBagBase_2__SetElementProperty<TSet,TElement>::__SetPropertyBagBase_2__SetElementProperty()   {
}
...
template<typename TSet,typename TElement>
constexpr ::cordl_internals::to_const_pointer<::Unity::Properties::__SetPropertyBagBase_2__SetElementProperty<TSet,TElement>*> const& Unity::Properties::SetPropertyBagBase_2<TSet,TElement>::__cordl_internal_get_m_Property() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Property;
}
template<typename TSet,typename TElement>
