...
::cordl_internals::setStaticField<::Unity::Properties::__KeyValuePairPropertyBag_2____c<TKey,TValue>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::__KeyValuePairPropertyBag_2____c<TKey,TValue>*>::get>(std::forward<::Unity::Properties::__KeyValuePairPropertyBag_2____c<TKey,TValue>*>(value));
}
template<typename TKey,typename TValue>
...
return ::cordl_internals::getStaticField<::Unity::Properties::__KeyValuePairPropertyBag_2____c<TKey,TValue>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::__KeyValuePairPropertyBag_2____c<TKey,TValue>*>::get>();
}
template<typename TKey,typename TValue>
inline ::Unity::Properties::__KeyValuePairPropertyBag_2____c<TKey,TValue>* Unity::Properties::__KeyValuePairPropertyBag_2____c<TKey,TValue>::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Unity::Properties::__KeyValuePairPropertyBag_2____c<TKey,TValue>*>());
}
template<typename TKey,typename TValue>
inline void Unity::Properties::__KeyValuePairPropertyBag_2____c<TKey,TValue>::_ctor()  {
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "<.cctor>b__7_0",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>>>::get()}
                    )));
...
// Ctor Parameters []
template<typename TKey,typename TValue>
constexpr ::Unity::Properties::__KeyValuePairPropertyBag_2____c<TKey,TValue>::__KeyValuePairPropertyBag_2____c()   {
}
template<typename TKey,typename TValue>
...
::cordl_internals::setStaticField<::Unity::Properties::DelegateProperty_2<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>,TKey>*, "s_KeyProperty", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::KeyValuePairPropertyBag_2<TKey,TValue>*>::get>(std::forward<::Unity::Properties::DelegateProperty_2<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>,TKey>*>(value));
}
template<typename TKey,typename TValue>
...
return ::cordl_internals::getStaticField<::Unity::Properties::DelegateProperty_2<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>,TKey>*, "s_KeyProperty", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::KeyValuePairPropertyBag_2<TKey,TValue>*>::get>();
}
template<typename TKey,typename TValue>
...
::cordl_internals::setStaticField<::Unity::Properties::DelegateProperty_2<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>,TValue>*, "s_ValueProperty", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::KeyValuePairPropertyBag_2<TKey,TValue>*>::get>(std::forward<::Unity::Properties::DelegateProperty_2<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>,TValue>*>(value));
}
template<typename TKey,typename TValue>
...
return ::cordl_internals::getStaticField<::Unity::Properties::DelegateProperty_2<::System::Collections::Generic::KeyValuePair_2<TKey,TValue>,TValue>*, "s_ValueProperty", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Properties::KeyValuePairPropertyBag_2<TKey,TValue>*>::get>();
}
template<typename TKey,typename TValue>
