...
struct __PropertyBagStore__TypedStore_1;
}
...
// Declarations
template<typename TContainer>
using TypedStore_1 = ::Unity::Properties::Internal::__PropertyBagStore__TypedStore_1<TContainer>;
...
static __declspec(property(get=getStaticF_s_PropertyBags, put=setStaticF_s_PropertyBags)) ::System::Collections::Concurrent::ConcurrentDictionary_2<::System::Type*,::Unity::Properties::IPropertyBag*>*  s_PropertyBags;
...
/// @brief Method GetPropertyBag, addr 0x487e6b8, size 0x284, virtual false, abstract: false, final false
