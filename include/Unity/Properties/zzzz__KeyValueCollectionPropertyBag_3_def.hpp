...
class __KeyValueCollectionPropertyBag_3__KeyValuePairProperty;
}
...
/// @brief Field m_KeyValuePairProperty, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_KeyValuePairProperty, put=__cordl_internal_set_m_KeyValuePairProperty)) ::Unity::Properties::__KeyValueCollectionPropertyBag_3__KeyValuePairProperty<TDictionary,TKey,TValue>*  m_KeyValuePairProperty;
...
constexpr ::cordl_internals::to_const_pointer<::Unity::Properties::__KeyValueCollectionPropertyBag_3__KeyValuePairProperty<TDictionary,TKey,TValue>*> const& __cordl_internal_get_m_KeyValuePairProperty() const;
