...
class __ReflectedMemberProperty_2__GetClassValueAction;
}
namespace Unity::Properties {
template<typename TContainer,typename TValue>
class __ReflectedMemberProperty_2__GetStructValueAction;
}
namespace Unity::Properties {
template<typename TContainer,typename TValue>
class __ReflectedMemberProperty_2__SetClassValueAction;
}
namespace Unity::Properties {
template<typename TContainer,typename TValue>
class __ReflectedMemberProperty_2__SetStructValueAction;
}
...
/// @brief Field m_GetClassValueAction, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_GetClassValueAction, put=__cordl_internal_set_m_GetClassValueAction)) ::Unity::Properties::__ReflectedMemberProperty_2__GetClassValueAction<TContainer,TValue>*  m_GetClassValueAction;

/// @brief Field m_GetStructValueAction, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_GetStructValueAction, put=__cordl_internal_set_m_GetStructValueAction)) ::Unity::Properties::__ReflectedMemberProperty_2__GetStructValueAction<TContainer,TValue>*  m_GetStructValueAction;
...
/// @brief Field m_SetClassValueAction, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_SetClassValueAction, put=__cordl_internal_set_m_SetClassValueAction)) ::Unity::Properties::__ReflectedMemberProperty_2__SetClassValueAction<TContainer,TValue>*  m_SetClassValueAction;

/// @brief Field m_SetStructValueAction, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_SetStructValueAction, put=__cordl_internal_set_m_SetStructValueAction)) ::Unity::Properties::__ReflectedMemberProperty_2__SetStructValueAction<TContainer,TValue>*  m_SetStructValueAction;
