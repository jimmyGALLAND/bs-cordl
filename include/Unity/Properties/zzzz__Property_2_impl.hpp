...
template<typename TContainer,typename TValue>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Attribute*>*> const& Unity::Properties::Property_2<TContainer,TValue>::__cordl_internal_get_m_Attributes() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Attributes;
}
template<typename TContainer,typename TValue>
