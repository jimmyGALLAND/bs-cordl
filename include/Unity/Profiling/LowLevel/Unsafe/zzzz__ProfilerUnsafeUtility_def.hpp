...
public:
// Declarations
/// @brief Method BeginSample, addr 0x47cd704, size 0x3c, virtual false, abstract: false, final false
static inline void BeginSample(::System::IntPtr  markerPtr) ;

/// @brief Method CreateCategory__Unmanaged, addr 0x47cd7fc, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method CreateCounterValue__Unmanaged, addr 0x47cd974, size 0x9c, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<void> CreateCounterValue__Unmanaged(ByRef<::System::IntPtr>  counterPtr, ::cordl_internals::Ptr<uint8_t>  name, int32_t  nameLen, uint16_t  categoryId, ::Unity::Profiling::LowLevel::MarkerFlags  flags, uint8_t  dataType, uint8_t  dataUnit, int32_t  dataSize, ::Unity::Profiling::ProfilerCounterOptions  counterOptions) ;

/// @brief Method CreateMarker, addr 0x47cd590, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method CreateMarker__Unmanaged, addr 0x47cd894, size 0x6c, virtual false, abstract: false, final false
static inline ::System::IntPtr CreateMarker__Unmanaged(::cordl_internals::Ptr<uint8_t>  name, int32_t  nameLen, uint16_t  categoryId, ::Unity::Profiling::LowLevel::MarkerFlags  flags, int32_t  metadataCount) ;

/// @brief Method EndSample, addr 0x47cd7a0, size 0x3c, virtual false, abstract: false, final false
static inline void EndSample(::System::IntPtr  markerPtr) ;

/// @brief Method GetCategoryDescription, addr 0x47cd3b0, size 0x90, virtual false, abstract: false, final false
static inline ::Unity::Profiling::LowLevel::Unsafe::ProfilerCategoryDescription GetCategoryDescription(uint16_t  categoryId) ;

/// @brief Method GetCategoryDescription_Injected, addr 0x47cd850, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method SetMarkerMetadata__Unmanaged, addr 0x47cd900, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method Utf8ToString, addr 0x47cd440, size 0xec, virtual false, abstract: false, final false
