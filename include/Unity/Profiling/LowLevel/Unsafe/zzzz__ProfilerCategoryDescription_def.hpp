...
// Ctor Parameters [CppParam { name: "Id", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "Flags", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "Color", ty: "::UnityEngine::Color32", modifiers: "", def_value: None }, CppParam { name: "reserved0", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "NameUtf8Len", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "NameUtf8", ty: "::cordl_internals::Ptr<uint8_t>", modifiers: "", def_value: None }]
