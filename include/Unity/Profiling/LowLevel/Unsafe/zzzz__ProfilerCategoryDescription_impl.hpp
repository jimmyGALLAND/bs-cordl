...
// Ctor Parameters [CppParam { name: "Id", ty: "uint16_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Flags", ty: "uint16_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Color", ty: "::UnityEngine::Color32", modifiers: "", def_value: Some("{}") }, CppParam { name: "reserved0", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "NameUtf8Len", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "NameUtf8", ty: "::cordl_internals::Ptr<uint8_t>", modifiers: "", def_value: Some("nullptr") }]
constexpr ::Unity::Profiling::LowLevel::Unsafe::ProfilerCategoryDescription::ProfilerCategoryDescription(uint16_t  Id, uint16_t  Flags, ::UnityEngine::Color32  Color, int32_t  reserved0, int32_t  NameUtf8Len, ::cordl_internals::Ptr<uint8_t>  NameUtf8) noexcept  {
this->Id = Id;
this->Flags = Flags;
this->Color = Color;
