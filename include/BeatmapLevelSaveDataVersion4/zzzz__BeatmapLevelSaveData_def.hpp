...
constexpr __BeatmapLevelSaveData__AudioData(::StringW  songFilename, float_t  songDuration, ::StringW  audioDataFilename, float_t  bpm, float_t  lufs, float_t  previewStartTime, float_t  previewDuration) noexcept;
...
/// @brief Method .ctor, addr 0x26bdb10, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x26bdb18, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field colorSchemes, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_colorSchemes, put=__cordl_internal_set_colorSchemes)) ::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*>*>  colorSchemes;
...
/// @brief Field difficultyBeatmaps, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_difficultyBeatmaps, put=__cordl_internal_set_difficultyBeatmaps)) ::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*>*>  difficultyBeatmaps;
...
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*>*> const& __cordl_internal_get_colorSchemes() const;

constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*>*>& __cordl_internal_get_colorSchemes() ;
...
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*>*> const& __cordl_internal_get_difficultyBeatmaps() const;

constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*>*>& __cordl_internal_get_difficultyBeatmaps() ;
...
constexpr void __cordl_internal_set_colorSchemes(::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*>*>  value) ;

constexpr void __cordl_internal_set_coverImageFilename(::StringW  value) ;

constexpr void __cordl_internal_set_difficultyBeatmaps(::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*>*>  value) ;
...
/// @brief Method .ctor, addr 0x26bdac0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
