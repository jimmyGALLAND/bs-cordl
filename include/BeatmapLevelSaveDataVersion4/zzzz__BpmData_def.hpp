...
/// @brief Method .ctor, addr 0x26bdb78, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_beat, addr 0x26bdb70, size 0x8, virtual true, abstract: false, final true
