...
#include "BeatmapLevelSaveDataVersion4/zzzz__BeatmapLevelSaveData_def.hpp"
// Ctor Parameters [CppParam { name: "title", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "subTitle", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "author", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }]
...
// Ctor Parameters [CppParam { name: "songFilename", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "songDuration", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "audioDataFilename", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "bpm", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "lufs", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "previewStartTime", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "previewDuration", ty: "float_t", modifiers: "", def_value: Some("{}") }]
constexpr ::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__AudioData::__BeatmapLevelSaveData__AudioData(::StringW  songFilename, float_t  songDuration, ::StringW  audioDataFilename, float_t  bpm, float_t  lufs, float_t  previewStartTime, float_t  previewDuration) noexcept  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme::*)()>(&::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x26bdb10;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*>::get(),
                        ".ctor",
...
// Ctor Parameters [CppParam { name: "mappers", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "lighters", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: Some("nullptr") }]
constexpr ::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__BeatmapAuthors::__BeatmapLevelSaveData__BeatmapAuthors(::ArrayW<::StringW,::Array<::StringW>*>  mappers, ::ArrayW<::StringW,::Array<::StringW>*>  lighters) noexcept  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap::*)()>(&::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x26bdb18;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::span<const Il2CppType* const, 0>()
                    )));
...
constexpr ::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__BeatmapAuthors const& BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap::__cordl_internal_get_beatmapAuthors() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___beatmapAuthors;
}
constexpr void BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap::__cordl_internal_set_beatmapAuthors(::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__BeatmapAuthors  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::*)()>(&::BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::_ctor)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x26bdac0;
...
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*>*>& BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::__cordl_internal_get_colorSchemes()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___colorSchemes;
}
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*>*> const& BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::__cordl_internal_get_colorSchemes() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___colorSchemes;
}
constexpr void BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::__cordl_internal_set_colorSchemes(::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__ColorScheme*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*>*>& BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::__cordl_internal_get_difficultyBeatmaps()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___difficultyBeatmaps;
}
constexpr ::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*>*> const& BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::__cordl_internal_get_difficultyBeatmaps() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___difficultyBeatmaps;
}
constexpr void BeatmapLevelSaveDataVersion4::BeatmapLevelSaveData::__cordl_internal_set_difficultyBeatmaps(::ArrayW<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*,::Array<::BeatmapLevelSaveDataVersion4::__BeatmapLevelSaveData__DifficultyBeatmap*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
