...
// Ctor Parameters [CppParam { name: "IsFruityDevice", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "BindAllInterfaces", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "Channels", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Peers", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "PollTime", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Port", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "PacketSizeLimit", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Verbosity", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Address", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "UseSsl", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "CertificatePath", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "Certificate", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "PrivateKeyPath", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "PrivateKey", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }]
constexpr ::IgnoranceCore::__IgnoranceServer__ThreadParamInfo::__IgnoranceServer__ThreadParamInfo(bool  IsFruityDevice, bool  BindAllInterfaces, int32_t  Channels, int32_t  Peers, int32_t  PollTime, int32_t  Port, int32_t  PacketSizeLimit, int32_t  Verbosity, ::StringW  Address, bool  UseSsl, ::StringW  CertificatePath, ::StringW  Certificate, ::StringW  PrivateKeyPath, ::StringW  PrivateKey) noexcept  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::IgnoranceCore::IgnoranceServer::*)()>(&::IgnoranceCore::IgnoranceServer::get_IsAlive)> {
  ...
  constexpr static std::size_t addrs = 0x3a257a8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::IgnoranceCore::IgnoranceServer::*)()>(&::IgnoranceCore::IgnoranceServer::Start)> {
  ...
  constexpr static std::size_t addrs = 0x3a257bc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::IgnoranceCore::IgnoranceServer::*)()>(&::IgnoranceCore::IgnoranceServer::Stop)> {
  ...
  constexpr static std::size_t addrs = 0x3a25d88;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::IgnoranceCore::IgnoranceServer::*)(::System::Object*)>(&::IgnoranceCore::IgnoranceServer::ThreadWorker)> {
  ...
  constexpr static std::size_t addrs = 0x3a25e24;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::IgnoranceCore::IgnoranceServer::*)()>(&::IgnoranceCore::IgnoranceServer::SetupRingBuffersIfNull)> {
  ...
  constexpr static std::size_t addrs = 0x3a25b58;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::IgnoranceCore::IgnoranceServer::*)()>(&::IgnoranceCore::IgnoranceServer::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3a26fe4;
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceIncomingPacket>*> const& IgnoranceCore::IgnoranceServer::__cordl_internal_get_Incoming() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___Incoming;
}
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceOutgoingPacket>*> const& IgnoranceCore::IgnoranceServer::__cordl_internal_get_Outgoing() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___Outgoing;
}
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceCommandPacket>*> const& IgnoranceCore::IgnoranceServer::__cordl_internal_get_Commands() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___Commands;
}
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceConnectionEvent>*> const& IgnoranceCore::IgnoranceServer::__cordl_internal_get_ConnectionEvents() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___ConnectionEvents;
}
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceConnectionEvent>*> const& IgnoranceCore::IgnoranceServer::__cordl_internal_get_DisconnectionEvents() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___DisconnectionEvents;
}
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceServerStats>*> const& IgnoranceCore::IgnoranceServer::__cordl_internal_get_StatusUpdates() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___StatusUpdates;
}
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceServerStats>*> const& IgnoranceCore::IgnoranceServer::__cordl_internal_get_RecycledServerStatBlocks() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___RecycledServerStatBlocks;
}
