...
// Ctor Parameters [CppParam { name: "Channels", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "PollTime", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Port", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "PacketSizeLimit", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Verbosity", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Address", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "UseSsl", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "ValidateCertificate", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "RootCertificatePath", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "RootCertificate", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }]
constexpr ::IgnoranceCore::__IgnoranceClient__ThreadParamInfo::__IgnoranceClient__ThreadParamInfo(int32_t  Channels, int32_t  PollTime, int32_t  Port, int32_t  PacketSizeLimit, int32_t  Verbosity, ::StringW  Address, bool  UseSsl, bool  ValidateCertificate, ::StringW  RootCertificatePath, ::StringW  RootCertificate) noexcept  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::IgnoranceCore::IgnoranceClient::*)()>(&::IgnoranceCore::IgnoranceClient::get_IsAlive)> {
  ...
  constexpr static std::size_t addrs = 0x3a241b4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::IgnoranceCore::IgnoranceClient::*)()>(&::IgnoranceCore::IgnoranceClient::Start)> {
  ...
  constexpr static std::size_t addrs = 0x3a241c8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::IgnoranceCore::IgnoranceClient::*)()>(&::IgnoranceCore::IgnoranceClient::Stop)> {
  ...
  constexpr static std::size_t addrs = 0x3a2476c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::IgnoranceCore::IgnoranceClient::*)(::System::Object*)>(&::IgnoranceCore::IgnoranceClient::ThreadWorker)> {
  ...
  constexpr static std::size_t addrs = 0x3a247fc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::IgnoranceCore::IgnoranceClient::*)()>(&::IgnoranceCore::IgnoranceClient::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3a25730;
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceIncomingPacket>*> const& IgnoranceCore::IgnoranceClient::__cordl_internal_get_Incoming() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___Incoming;
}
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceOutgoingPacket>*> const& IgnoranceCore::IgnoranceClient::__cordl_internal_get_Outgoing() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___Outgoing;
}
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceCommandPacket>*> const& IgnoranceCore::IgnoranceClient::__cordl_internal_get_Commands() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___Commands;
}
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceConnectionEvent>*> const& IgnoranceCore::IgnoranceClient::__cordl_internal_get_ConnectionEvents() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___ConnectionEvents;
}
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceConnectionEvent>*> const& IgnoranceCore::IgnoranceClient::__cordl_internal_get_DisconnectionEvents() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___DisconnectionEvents;
}
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceClientStats>*> const& IgnoranceCore::IgnoranceClient::__cordl_internal_get_StatusUpdates() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___StatusUpdates;
}
