...
constexpr __IgnoranceServer__ThreadParamInfo(bool  IsFruityDevice, bool  BindAllInterfaces, int32_t  Channels, int32_t  Peers, int32_t  PollTime, int32_t  Port, int32_t  PacketSizeLimit, int32_t  Verbosity, ::StringW  Address, bool  UseSsl, ::StringW  CertificatePath, ::StringW  Certificate, ::StringW  PrivateKeyPath, ::StringW  PrivateKey) noexcept;
...
/// @brief Field RecycledServerStatBlocks, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_RecycledServerStatBlocks, put=__cordl_internal_set_RecycledServerStatBlocks)) ::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceServerStats>*  RecycledServerStatBlocks;
...
/// @brief Method SetupRingBuffersIfNull, addr 0x3a25b58, size 0x230, virtual false, abstract: false, final false
inline void SetupRingBuffersIfNull() ;

/// @brief Method Start, addr 0x3a257bc, size 0x39c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Stop, addr 0x3a25d88, size 0x9c, virtual false, abstract: false, final false
inline void Stop() ;

/// @brief Method ThreadWorker, addr 0x3a25e24, size 0x11c0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a26fe4, size 0xb4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsAlive, addr 0x3a257a8, size 0x14, virtual false, abstract: false, final false
