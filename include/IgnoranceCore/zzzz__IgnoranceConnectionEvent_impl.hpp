...
// Ctor Parameters [CppParam { name: "EventType", ty: "uint8_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Port", ty: "uint16_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "NativePeerId", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "IP", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }]
