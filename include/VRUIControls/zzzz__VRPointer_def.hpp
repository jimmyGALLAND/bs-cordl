...
/// @brief Method Awake, addr 0x4a5b760, size 0xa4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CreateCursors, addr 0x4a5b908, size 0x134, virtual false, abstract: false, final false
inline bool CreateCursors() ;

/// @brief Method CreateLaserPointers, addr 0x4a5b804, size 0x104, virtual false, abstract: false, final false
inline bool CreateLaserPointers() ;

/// @brief Method EnabledLastSelectedPointer, addr 0x4a5bcb8, size 0x58, virtual false, abstract: false, final false
inline void EnabledLastSelectedPointer() ;

/// @brief Method HideCursors, addr 0x4a5bf90, size 0x60, virtual false, abstract: false, final false
inline void HideCursors() ;

/// @brief Method HideLaserPointers, addr 0x4a5bff0, size 0x60, virtual false, abstract: false, final false
inline void HideLaserPointers() ;

/// @brief Method HideLaserPointersAndCursors, addr 0x4a5bac8, size 0x18, virtual false, abstract: false, final false
inline void HideLaserPointersAndCursors() ;

/// @brief Method IsLeftControllerDown, addr 0x4a5bc10, size 0x54, virtual false, abstract: false, final false
inline bool IsLeftControllerDown() ;

/// @brief Method IsRightControllerDown, addr 0x4a5bc64, size 0x54, virtual false, abstract: false, final false
inline bool IsRightControllerDown() ;

/// @brief Method LateUpdate, addr 0x4a5bae0, size 0x130, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::VRUIControls::VRPointer* New_ctor() ;

/// @brief Method OnApplicationFocus, addr 0x4a5bf84, size 0xc, virtual false, abstract: false, final false
inline void OnApplicationFocus(bool  hasFocus) ;

/// @brief Method OnDisable, addr 0x4a5bab0, size 0x18, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method Process, addr 0x4a5a8c0, size 0x68, virtual false, abstract: false, final false
inline void Process(::UnityEngine::EventSystems::PointerEventData*  pointerEventData) ;

/// @brief Method RefreshLaserPointerAndLaserHit, addr 0x4a5bd84, size 0x200, virtual false, abstract: false, final false
inline void RefreshLaserPointerAndLaserHit(::UnityEngine::EventSystems::PointerEventData*  pointerData) ;

/// @brief Method SelectLeftController, addr 0x4a5ba78, size 0x38, virtual false, abstract: false, final false
inline void SelectLeftController() ;

/// @brief Method SelectRightController, addr 0x4a5ba3c, size 0x3c, virtual false, abstract: false, final false
inline void SelectRightController() ;

/// @brief Method SetupLaserPointer, addr 0x4a5bd10, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a5c050, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_lastUsedControllerChangedEvent, addr 0x4a5b1d0, size 0xb0, virtual false, abstract: false, final false
inline void add_lastUsedControllerChangedEvent(::System::Action_1<::UnityW<::GlobalNamespace::VRController>>*  value) ;

/// @brief Method get_cursorPosition, addr 0x4a5b66c, size 0xf4, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_cursorPosition() ;

/// @brief Method get_cursorTransform, addr 0x4a5b348, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_cursorTransform() ;

/// @brief Method get_lastSelectedVrController, addr 0x4a5b664, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::VRController> get_lastSelectedVrController() ;

/// @brief Method get_pointingOver, addr 0x4a5b330, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_pointingOver() ;

/// @brief Method get_state, addr 0x4a5b350, size 0x314, virtual false, abstract: false, final false
inline ::StringW get_state() ;

/// @brief Method remove_lastUsedControllerChangedEvent, addr 0x4a5b280, size 0xb0, virtual false, abstract: false, final false
