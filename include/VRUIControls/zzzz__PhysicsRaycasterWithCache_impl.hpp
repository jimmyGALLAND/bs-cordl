...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::VRUIControls::__PhysicsRaycasterWithCache__CachedRaycast::*)(bool, ::UnityEngine::Ray, ::UnityEngine::RaycastHit, float_t, int32_t)>(&::VRUIControls::__PhysicsRaycasterWithCache__CachedRaycast::_ctor)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x4a56f9c;
...
constexpr ::VRUIControls::__PhysicsRaycasterWithCache__CachedRaycast::__PhysicsRaycasterWithCache__CachedRaycast(bool  wasHit, ::UnityEngine::Ray  ray, ::UnityEngine::RaycastHit  hitInfo, float_t  maxDistance, int32_t  layerMask) noexcept  {
this->wasHit = wasHit;
this->ray = ray;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::VRUIControls::PhysicsRaycasterWithCache::*)(::UnityEngine::Ray, ByRef<::UnityEngine::RaycastHit>, float_t, int32_t)>(&::VRUIControls::PhysicsRaycasterWithCache::Raycast)> {
  ...
  constexpr static std::size_t addrs = 0x4a56ac8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::VRUIControls::PhysicsRaycasterWithCache::*)()>(&::VRUIControls::PhysicsRaycasterWithCache::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x4a56fdc;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::VRUIControls::__PhysicsRaycasterWithCache__CachedRaycast>*> const& VRUIControls::PhysicsRaycasterWithCache::__cordl_internal_get__cachedRaycasts() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____cachedRaycasts;
}
constexpr void VRUIControls::PhysicsRaycasterWithCache::__cordl_internal_set__cachedRaycasts(::System::Collections::Generic::List_1<::VRUIControls::__PhysicsRaycasterWithCache__CachedRaycast>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
