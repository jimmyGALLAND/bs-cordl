...
/// @brief Method AnyPressesThisFrame, addr 0x4a5672c, size 0xa8, virtual false, abstract: false, final false
inline bool AnyPressesThisFrame() ;

/// @brief Method AnyReleasesThisFrame, addr 0x4a567d4, size 0xac, virtual false, abstract: false, final false
inline bool AnyReleasesThisFrame() ;

/// @brief Method GetButtonState, addr 0x4a56880, size 0x194, virtual false, abstract: false, final false
...
/// @brief Method SetButtonState, addr 0x4a56a14, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a56a4c, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
