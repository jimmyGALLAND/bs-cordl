...
/// @brief Method ClearSelection, addr 0x4a587d0, size 0x208, virtual false, abstract: false, final false
inline void ClearSelection() ;

/// @brief Method DeselectIfSelectionChanged, addr 0x4a59e64, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method GetLastPointerEventData, addr 0x4a58e08, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerEventData* GetLastPointerEventData(int32_t  id) ;

/// @brief Method GetMousePointerEventData, addr 0x4a58ac8, size 0x340, virtual true, abstract: false, final false
inline ::VRUIControls::MouseState* GetMousePointerEventData(int32_t  id) ;

/// @brief Method GetPointerData, addr 0x4a589d8, size 0xf0, virtual false, abstract: false, final false
inline bool GetPointerData(int32_t  id, ByRef<::UnityEngine::EventSystems::PointerEventData*>  data, bool  create) ;

/// @brief Method HandlePointerExitAndEnter, addr 0x4a58f90, size 0x8f8, virtual false, abstract: false, final false
...
/// @brief Method IsPointerOverGameObject, addr 0x4a59b60, size 0x9c, virtual true, abstract: false, final false
inline bool IsPointerOverGameObject(int32_t  pointerId) ;

static inline ::VRUIControls::VRInputModule* New_ctor() ;

/// @brief Method OnDisable, addr 0x4a587b4, size 0x1c, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method Process, addr 0x4a59f54, size 0x214, virtual true, abstract: false, final false
inline void Process() ;

/// @brief Method ProcessDrag, addr 0x4a59888, size 0x2d8, virtual true, abstract: false, final false
inline void ProcessDrag(::UnityEngine::EventSystems::PointerEventData*  pointerEvent) ;

/// @brief Method ProcessMousePress, addr 0x4a5a168, size 0x758, virtual false, abstract: false, final false
inline void ProcessMousePress(::VRUIControls::MouseButtonEventData*  data) ;

/// @brief Method ProcessMove, addr 0x4a58e58, size 0x138, virtual true, abstract: false, final false
inline void ProcessMove(::UnityEngine::EventSystems::PointerEventData*  pointerEvent) ;

/// @brief Method RaycastComparer, addr 0x4a5aa70, size 0x3e4, virtual false, abstract: false, final false
...
/// @brief Method SendUpdateEventToSelectedObject, addr 0x4a5a928, size 0x148, virtual false, abstract: false, final false
inline bool SendUpdateEventToSelectedObject() ;

/// @brief Method ShouldStartDrag, addr 0x4a58e28, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x4a59bfc, size 0x268, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::EventSystems::PointerEventData*>*> const& __cordl_internal_get__pointerData() const;
...
/// @brief Method .ctor, addr 0x4a5ae54, size 0xf0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_onProcessMousePressEvent, addr 0x4a584f4, size 0xb0, virtual true, abstract: false, final true
inline void add_onProcessMousePressEvent(::System::Action_1<::UnityW<::UnityEngine::GameObject>>*  value) ;

/// @brief Method add_pointerDidClickEvent, addr 0x4a58654, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method get_useMouseForPressInput, addr 0x4a584d8, size 0x8, virtual false, abstract: false, final false
inline bool get_useMouseForPressInput() ;

/// @brief Method get_vrPointer, addr 0x4a584ec, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method remove_onProcessMousePressEvent, addr 0x4a585a4, size 0xb0, virtual true, abstract: false, final true
inline void remove_onProcessMousePressEvent(::System::Action_1<::UnityW<::UnityEngine::GameObject>>*  value) ;

/// @brief Method remove_pointerDidClickEvent, addr 0x4a58704, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method set_useMouseForPressInput, addr 0x4a584e0, size 0xc, virtual false, abstract: false, final false
