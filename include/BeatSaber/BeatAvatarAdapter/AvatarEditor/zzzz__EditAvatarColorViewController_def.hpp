...
/// @brief Method ChangeColor, addr 0x221738c, size 0x94, virtual false, abstract: false, final false
inline void ChangeColor(::UnityEngine::Color  color) ;

/// @brief Method HandleApplyButtonWasPressed, addr 0x22174f4, size 0x20, virtual false, abstract: false, final false
inline void HandleApplyButtonWasPressed() ;

/// @brief Method HandleCancelButtonWasPressed, addr 0x2217498, size 0x5c, virtual false, abstract: false, final false
inline void HandleCancelButtonWasPressed() ;

/// @brief Method HandleHSVPanelControllerColorDidChange, addr 0x221731c, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method HandlePreviousColorPanelControllerColorWasSelected, addr 0x2217420, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x22171bc, size 0x160, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetColor, addr 0x2211958, size 0x68, virtual false, abstract: false, final false
inline void SetColor(::UnityEngine::Color  color) ;

/// @brief Method SetColorCallback, addr 0x2217004, size 0x8, virtual false, abstract: false, final false
inline void SetColorCallback(::System::Action_1<::UnityEngine::Color>*  colorCallback) ;

/// @brief Method Start, addr 0x221700c, size 0x1b0, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x2217514, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didChangeColorEvent, addr 0x2210c1c, size 0xb0, virtual false, abstract: false, final false
inline void add_didChangeColorEvent(::System::Action_1<::UnityEngine::Color>*  value) ;

/// @brief Method add_didFinishEvent, addr 0x2210ccc, size 0xb0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_1<bool>*  value) ;

/// @brief Method get_color, addr 0x2211b6c, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method remove_didChangeColorEvent, addr 0x22116b8, size 0xb0, virtual false, abstract: false, final false
inline void remove_didChangeColorEvent(::System::Action_1<::UnityEngine::Color>*  value) ;

/// @brief Method remove_didFinishEvent, addr 0x2211768, size 0xb0, virtual false, abstract: false, final false
