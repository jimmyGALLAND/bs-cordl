...
/// @brief Field _snapShots, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__snapShots, put=__cordl_internal_set__snapShots)) ::System::Collections::Generic::List_1<::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarHistorySnapshot>*  _snapShots;
...
/// @brief Method Clear, addr 0x2213840, size 0x6c, virtual false, abstract: false, final false
inline void Clear() ;

static inline ::BeatSaber::BeatAvatarAdapter::AvatarEditor::AvatarEditHistory* New_ctor() ;

/// @brief Method Redo, addr 0x22138c8, size 0x68, virtual false, abstract: false, final false
inline void Redo() ;

/// @brief Method Undo, addr 0x22138ac, size 0x1c, virtual false, abstract: false, final false
inline void Undo() ;

/// @brief Method UpdateEditHistory, addr 0x2213930, size 0x180, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarHistorySnapshot>*> const& __cordl_internal_get__snapShots() const;
...
/// @brief Method .ctor, addr 0x2213abc, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_currentSnapShot, addr 0x22137dc, size 0x54, virtual false, abstract: false, final false
inline ::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarHistorySnapshot get_currentSnapShot() ;

/// @brief Method get_lastEditedPart, addr 0x2213830, size 0x10, virtual false, abstract: false, final false
inline ::BeatSaber::BeatAvatarSDK::AvatarPart get_lastEditedPart() ;

/// @brief Method get_redoAvailable, addr 0x2213784, size 0x58, virtual false, abstract: false, final false
inline bool get_redoAvailable() ;

/// @brief Method get_undoAvailable, addr 0x2213774, size 0x10, virtual false, abstract: false, final false
