...
/// @brief Field _avatarEditorFlowCoordinator, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__avatarEditorFlowCoordinator, put=__cordl_internal_set__avatarEditorFlowCoordinator)) ::UnityW<::GlobalNamespace::BeatAvatarEditorFlowCoordinator>  _avatarEditorFlowCoordinator;
...
/// @brief Method Awake, addr 0x2216814, size 0x148, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CreateEditAvatarEventData, addr 0x2216bbc, size 0x278, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>* CreateEditAvatarEventData() ;

/// @brief Method HandleAvatarEditorFlowCoordinatorDidFinish, addr 0x2216e34, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method HandleAvatarEditorFlowCoordinatorDidSetup, addr 0x2216ae4, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method HandleAvatarEditorFlowCoordinatorRandomizeAllButtonWasPressed, addr 0x2216f2c, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x221695c, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2216ffc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
