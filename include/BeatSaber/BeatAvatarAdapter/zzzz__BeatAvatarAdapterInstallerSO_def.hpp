...
/// @brief Field _editAvatarColorView, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__editAvatarColorView, put=__cordl_internal_set__editAvatarColorView)) ::UnityW<::BeatSaber::BeatAvatarAdapter::AvatarEditor::EditAvatarColorViewController>  _editAvatarColorView;
...
/// @brief Method InstallBindings, addr 0x2212be8, size 0x10, virtual true, abstract: false, final false
inline void InstallBindings() ;

/// @brief Method InstallBindings, addr 0x2212bf8, size 0x20c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2212e04, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
