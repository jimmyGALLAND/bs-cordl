...
/// @brief Method SetLightColor, addr 0x221299c, size 0x1c, virtual true, abstract: false, final false
inline void SetLightColor(::UnityEngine::Color  lightColor) ;

/// @brief Method UpdateAvatarFromOptionalData, addr 0x2212bdc, size 0x4, virtual true, abstract: false, final false
inline void UpdateAvatarFromOptionalData(::BeatSaber::AvatarCore::OptionalAvatarData  data, float_t  playbackDelaySeconds) ;

/// @brief Method UpdateAvatarFromPose, addr 0x22129b8, size 0x78, virtual true, abstract: false, final false
inline void UpdateAvatarFromPose(::BeatSaber::AvatarCore::AvatarPoseData  currentPose) ;

/// @brief Method UpdateAvatarFromVisualData, addr 0x2212a30, size 0x1ac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2212be0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bodyCenterWorldPosition, addr 0x2212980, size 0x1c, virtual true, abstract: false, final false
