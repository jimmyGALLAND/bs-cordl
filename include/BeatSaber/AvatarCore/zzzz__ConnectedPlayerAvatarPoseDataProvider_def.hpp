...
static inline ::BeatSaber::AvatarCore::ConnectedPlayerAvatarPoseDataProvider* New_ctor(::GlobalNamespace::IConnectedPlayer*  connectedPlayer, ::GlobalNamespace::INodePoseSyncStateManager*  nodePoseSyncStateManager, ::BeatSaber::AvatarCore::IAvatarPoseRestriction*  avatarPoseRestriction) ;

/// @brief Method Tick, addr 0x220d584, size 0x558, virtual true, abstract: false, final true
inline void Tick() ;
...
/// @brief Method .ctor, addr 0x220d548, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::IConnectedPlayer*  connectedPlayer, ::GlobalNamespace::INodePoseSyncStateManager*  nodePoseSyncStateManager, ::BeatSaber::AvatarCore::IAvatarPoseRestriction*  avatarPoseRestriction) ;

/// @brief Method add_poseDidChangeEvent, addr 0x220d3e8, size 0xb0, virtual true, abstract: false, final true
inline void add_poseDidChangeEvent(::System::Action_1<::BeatSaber::AvatarCore::AvatarPoseData>*  value) ;

/// @brief Method get_currentPose, addr 0x220d3d8, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method remove_poseDidChangeEvent, addr 0x220d498, size 0xb0, virtual true, abstract: false, final true
