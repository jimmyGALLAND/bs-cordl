...
/// @brief Method Equals, addr 0x220ce3c, size 0x78, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x220ce2c, size 0x10, virtual true, abstract: false, final true
inline bool Equals(::BeatSaber::AvatarCore::AvatarSystemIdentifier  other) ;

/// @brief Method GetHashCode, addr 0x220ceb4, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method HashAvatarSystemTypeMultiplier, addr 0x220be9c, size 0x8, virtual false, abstract: false, final false
static inline uint32_t HashAvatarSystemTypeMultiplier(::StringW  avatarSystemTypeIdentifier) ;

/// @brief Method .ctor, addr 0x220ce08, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x220cebc, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x220cf34, size 0x7c, virtual false, abstract: false, final false
