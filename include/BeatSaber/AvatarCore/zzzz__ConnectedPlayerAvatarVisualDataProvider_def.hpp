...
/// @brief Method .ctor, addr 0x220dba4, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::IConnectedPlayer*  connectedPlayer) ;

/// @brief Method get_avatarsData, addr 0x220dadc, size 0xc8, virtual true, abstract: false, final true
