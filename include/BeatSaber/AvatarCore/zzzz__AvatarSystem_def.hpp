...
/// @brief Method .ctor, addr 0x220adbc, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method get_isFallbackSystem, addr 0x220ae2c, size 0x8, virtual true, abstract: false, final true
inline bool get_isFallbackSystem() ;

/// @brief Method get_selectableByUser, addr 0x220ae24, size 0x8, virtual true, abstract: false, final true
inline bool get_selectableByUser() ;

/// @brief Method get_selectionSortOrder, addr 0x220ae34, size 0x8, virtual true, abstract: false, final true
inline int32_t get_selectionSortOrder() ;

/// @brief Method get_supportedOptionalAvatarDataTypes, addr 0x220ae3c, size 0x8, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IReadOnlyCollection_1<uint32_t>* get_supportedOptionalAvatarDataTypes() ;

/// @brief Method get_typeIdentifier, addr 0x220ae18, size 0xc, virtual true, abstract: false, final true
