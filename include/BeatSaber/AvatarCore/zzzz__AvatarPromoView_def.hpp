...
/// @brief Method .ctor, addr 0x2209ff8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_rectTransform, addr 0x2209ff0, size 0x8, virtual false, abstract: false, final false
