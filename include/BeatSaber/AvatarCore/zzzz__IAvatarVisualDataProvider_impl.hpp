...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::MultiplayerAvatarsData (::BeatSaber::AvatarCore::IAvatarVisualDataProvider::*)()>(&::BeatSaber::AvatarCore::IAvatarVisualDataProvider::get_avatarsData)> {
