...
/// @brief Field didFinishEvent, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didFinishEvent, put=__cordl_internal_set_didFinishEvent)) ::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__FinishAction>*  didFinishEvent;

/// @brief Field didSetupEvent, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didSetupEvent, put=__cordl_internal_set_didSetupEvent)) ::System::Action_1<::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__EditMode>*  didSetupEvent;
...
/// @brief Method Finish, addr 0x2209c30, size 0x2c, virtual false, abstract: false, final false
inline void Finish(::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__FinishAction  finishAction) ;

/// @brief Method HandleBeatAvatarEditorRandomizeAllButtonWasPressed, addr 0x2209c5c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method SetAvatarSystem, addr 0x2209c28, size 0x8, virtual false, abstract: false, final false
inline void SetAvatarSystem(::BeatSaber::AvatarCore::IAvatarSystemMetadata*  avatarSystem) ;

/// @brief Method Setup, addr 0x2209bc8, size 0x60, virtual true, abstract: false, final false
...
constexpr ::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__FinishAction>*& __cordl_internal_get_didFinishEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__FinishAction>*> const& __cordl_internal_get_didFinishEvent() const;
...
constexpr void __cordl_internal_set_didFinishEvent(::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__FinishAction>*  value) ;
...
/// @brief Method .ctor, addr 0x2209c78, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x22097d0, size 0xb0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__FinishAction>*  value) ;

/// @brief Method add_didSetupEvent, addr 0x2209930, size 0xb0, virtual false, abstract: false, final false
inline void add_didSetupEvent(::System::Action_1<::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__EditMode>*  value) ;

/// @brief Method add_randomizeAllButtonWasPressedEvent, addr 0x2209a90, size 0x9c, virtual false, abstract: false, final false
inline void add_randomizeAllButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method remove_didFinishEvent, addr 0x2209880, size 0xb0, virtual false, abstract: false, final false
inline void remove_didFinishEvent(::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__FinishAction>*  value) ;

/// @brief Method remove_didSetupEvent, addr 0x22099e0, size 0xb0, virtual false, abstract: false, final false
inline void remove_didSetupEvent(::System::Action_1<::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__EditMode>*  value) ;

/// @brief Method remove_randomizeAllButtonWasPressedEvent, addr 0x2209b2c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Field didFinishEvent, offset: 0xb0, size: 0x8, def value: None
 ::System::Action_3<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>,::BeatSaber::AvatarCore::IAvatarSystemMetadata*,::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__FinishAction>*  ___didFinishEvent;
