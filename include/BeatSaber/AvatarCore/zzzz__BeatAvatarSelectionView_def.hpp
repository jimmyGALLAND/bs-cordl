...
/// @brief Method Activate, addr 0x2211e1c, size 0x48, virtual true, abstract: false, final false
inline void Activate() ;

/// @brief Method Deactivate, addr 0x2211e64, size 0x24, virtual true, abstract: false, final false
inline void Deactivate() ;

/// @brief Method HandleAvatarDataModelDidChangeAvatarData, addr 0x2211e88, size 0x4, virtual false, abstract: false, final false
inline void HandleAvatarDataModelDidChangeAvatarData(::BeatSaber::BeatAvatarSDK::AvatarData*  data) ;

/// @brief Method Init, addr 0x2211c84, size 0x98, virtual false, abstract: false, final false
inline void Init() ;

static inline ::BeatSaber::AvatarCore::BeatAvatarSelectionView* New_ctor() ;

/// @brief Method OnDestroy, addr 0x2211d44, size 0x90, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetCreated, addr 0x2211dd4, size 0x48, virtual true, abstract: false, final false
inline void SetCreated(bool  isCreated) ;

/// @brief Method UpdateAvatarVisuals, addr 0x2211d1c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2211e8c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
