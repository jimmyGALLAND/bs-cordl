...
/// @brief Method SetOptionalDataProvider, addr 0x2208bcc, size 0x1e8, virtual false, abstract: false, final false
inline void SetOptionalDataProvider(::BeatSaber::AvatarCore::IOptionalAvatarDataProvider*  optionalDataProvider) ;

/// @brief Method SetPoseDataProvider, addr 0x22088d0, size 0x218, virtual false, abstract: false, final false
inline void SetPoseDataProvider(::BeatSaber::AvatarCore::IAvatarPoseDataProvider*  poseDataProvider) ;

/// @brief Method SetVisualDataProvider, addr 0x2208ae8, size 0xe4, virtual false, abstract: false, final false
inline void SetVisualDataProvider(::BeatSaber::AvatarCore::IAvatarVisualDataProvider*  visualDataProvider) ;

/// @brief Method UpdateAvatarFromOptionalData, addr 0x2208f0c, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method UpdateAvatarFromOptionalDataList, addr 0x2208db4, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2208fd8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
