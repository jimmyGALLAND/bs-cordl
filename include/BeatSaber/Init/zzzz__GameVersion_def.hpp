...
namespace GlobalNamespace {
class __GameVersion__Content____c__DisplayClass14_0;
}
namespace GlobalNamespace {
class __GameVersion__Content____c__DisplayClass15_0;
}
...
MARK_REF_PTR_T(::GlobalNamespace::__GameVersion__Content____c__DisplayClass14_0);
MARK_REF_PTR_T(::GlobalNamespace::__GameVersion__Content____c__DisplayClass15_0);
...
/// @brief Method <.cctor>b__20_0, addr 0x222bf20, size 0x8, virtual false, abstract: false, final false
inline ::StringW __cctor_b__20_0(::System::ValueTuple_2<::BeatSaber::Init::__GameVersion__PreReleasePrefix,::StringW>  el) ;

/// @brief Method .ctor, addr 0x222bf18, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// CS Name: ::GameVersion::Content::<>c__DisplayClass14_0*
class CORDL_TYPE __GameVersion__Content____c__DisplayClass14_0 : public ::System::Object {
public:
// Declarations
/// @brief Field preReleasePrefix, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get_preReleasePrefix, put=__cordl_internal_set_preReleasePrefix)) ::BeatSaber::Init::__GameVersion__PreReleasePrefix  preReleasePrefix;

static inline ::GlobalNamespace::__GameVersion__Content____c__DisplayClass14_0* New_ctor() ;

constexpr ::BeatSaber::Init::__GameVersion__PreReleasePrefix const& __cordl_internal_get_preReleasePrefix() const;

constexpr ::BeatSaber::Init::__GameVersion__PreReleasePrefix& __cordl_internal_get_preReleasePrefix() ;

constexpr void __cordl_internal_set_preReleasePrefix(::BeatSaber::Init::__GameVersion__PreReleasePrefix  value) ;

/// @brief Method <.ctor>b__0, addr 0x222bf28, size 0x10, virtual false, abstract: false, final false
inline bool __ctor_b__0(::System::ValueTuple_2<::BeatSaber::Init::__GameVersion__PreReleasePrefix,::StringW>  tuple) ;

/// @brief Method .ctor, addr 0x222b9e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

protected:
// Ctor Parameters []
// @brief default ctor
constexpr __GameVersion__Content____c__DisplayClass14_0() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "__GameVersion__Content____c__DisplayClass14_0", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
__GameVersion__Content____c__DisplayClass14_0(__GameVersion__Content____c__DisplayClass14_0 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "__GameVersion__Content____c__DisplayClass14_0", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
__GameVersion__Content____c__DisplayClass14_0(__GameVersion__Content____c__DisplayClass14_0 const& ) = delete;

/// @brief Field preReleasePrefix, offset: 0x10, size: 0x4, def value: None
 ::BeatSaber::Init::__GameVersion__PreReleasePrefix  ___preReleasePrefix;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__GameVersion__Content____c__DisplayClass14_0, 0x18>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__GameVersion__Content____c__DisplayClass14_0, ___preReleasePrefix) == 0x10, "Offset mismatch!");
...
namespace GlobalNamespace {
// Is value type: false
// CS Name: ::GameVersion::Content::<>c__DisplayClass15_0*
class CORDL_TYPE __GameVersion__Content____c__DisplayClass15_0 : public ::System::Object {
public:
// Declarations
...
static inline ::GlobalNamespace::__GameVersion__Content____c__DisplayClass15_0* New_ctor() ;

/// @brief Method <Parse>b__0, addr 0x222bf38, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x222b9f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

protected:
// Ctor Parameters []
// @brief default ctor
constexpr __GameVersion__Content____c__DisplayClass15_0() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "__GameVersion__Content____c__DisplayClass15_0", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
__GameVersion__Content____c__DisplayClass15_0(__GameVersion__Content____c__DisplayClass15_0 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "__GameVersion__Content____c__DisplayClass15_0", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
__GameVersion__Content____c__DisplayClass15_0(__GameVersion__Content____c__DisplayClass15_0 const& ) = delete;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__GameVersion__Content____c__DisplayClass15_0, 0x18>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__GameVersion__Content____c__DisplayClass15_0, ___preReleasePrefixGroup) == 0x10, "Offset mismatch!");
...
using __c__DisplayClass14_0 = ::GlobalNamespace::__GameVersion__Content____c__DisplayClass14_0;

using __c__DisplayClass15_0 = ::GlobalNamespace::__GameVersion__Content____c__DisplayClass15_0;
...
static __declspec(property(get=getStaticF_kPreReleasePrefixLabelMap, put=setStaticF_kPreReleasePrefixLabelMap)) ::System::Collections::Generic::IReadOnlyList_1<::System::ValueTuple_2<::BeatSaber::Init::__GameVersion__PreReleasePrefix,::StringW>>*  kPreReleasePrefixLabelMap;
...
/// @brief Method CompareTo, addr 0x222b55c, size 0x60, virtual true, abstract: false, final true
inline int32_t CompareTo(::BeatSaber::Init::__GameVersion__Content  other) ;

/// @brief Method Equals, addr 0x222b9f8, size 0x88, virtual true, abstract: false, final true
inline bool Equals(::BeatSaber::Init::__GameVersion__Content  other) ;

/// @brief Method Parse, addr 0x222add8, size 0x3d4, virtual false, abstract: false, final false
static inline ::BeatSaber::Init::__GameVersion__Content Parse(::StringW  contentVersion) ;

/// @brief Method ToString, addr 0x222b76c, size 0xf4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x222b860, size 0x188, virtual false, abstract: false, final false
...
static inline void setStaticF_kPreReleasePrefixLabelMap(::System::Collections::Generic::IReadOnlyList_1<::System::ValueTuple_2<::BeatSaber::Init::__GameVersion__PreReleasePrefix,::StringW>>*  value) ;
...
// Ctor Parameters [CppParam { name: "major", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "minor", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "patch", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "preRelease", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "preReleasePrefix", ty: "::BeatSaber::Init::__GameVersion__PreReleasePrefix", modifiers: "", def_value: None }]
constexpr __GameVersion__Content(int32_t  major, int32_t  minor, int32_t  patch, ::StringW  preRelease, ::BeatSaber::Init::__GameVersion__PreReleasePrefix  preReleasePrefix) noexcept;
...
/// @brief Field preRelease, offset: 0x10, size: 0x8, def value: None
 ::StringW  preRelease;
...
static_assert(offsetof(::BeatSaber::Init::__GameVersion__Content, preRelease) == 0x10, "Offset mismatch!");
...
/// @brief Method CompareTo, addr 0x222b5bc, size 0xc4, virtual true, abstract: false, final true
inline int32_t CompareTo(::BeatSaber::Init::__GameVersion__Metadata  other) ;

/// @brief Method Equals, addr 0x222bf90, size 0x98, virtual true, abstract: false, final true
inline bool Equals(::BeatSaber::Init::__GameVersion__Metadata  other) ;

/// @brief Method Parse, addr 0x222b1ac, size 0x260, virtual false, abstract: false, final false
static inline ::BeatSaber::Init::__GameVersion__Metadata Parse(::StringW  buildMetadataValue) ;

/// @brief Method ToString, addr 0x222c028, size 0x148, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x222bf68, size 0x28, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "buildId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "platform", ty: "::BeatSaber::Init::__GameVersion__Platform", modifiers: "", def_value: None }, CppParam { name: "platformId", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "platformIdIntValue", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Field contentVersion, offset 0x10, size 0x20 
 __declspec(property(get=__cordl_internal_get_contentVersion, put=__cordl_internal_set_contentVersion)) ::BeatSaber::Init::__GameVersion__Content  contentVersion;
...
/// @brief Method CompareTo, addr 0x222b40c, size 0x150, virtual true, abstract: false, final true
inline int32_t CompareTo(::BeatSaber::Init::GameVersion*  other) ;

/// @brief Method Equals, addr 0x222b680, size 0x18, virtual true, abstract: false, final true
inline bool Equals(::BeatSaber::Init::GameVersion*  other) ;

static inline ::BeatSaber::Init::GameVersion* New_ctor(::BeatSaber::Init::__GameVersion__Content  contentVersion, ::System::Nullable_1<::BeatSaber::Init::__GameVersion__Metadata>  buildMetadata) ;

/// @brief Method Parse, addr 0x222ac04, size 0x1d4, virtual false, abstract: false, final false
static inline ::BeatSaber::Init::GameVersion* Parse(::StringW  version) ;

/// @brief Method ToString, addr 0x222b698, size 0xd4, virtual true, abstract: false, final false
inline ::StringW ToString() ;
...
constexpr ::BeatSaber::Init::__GameVersion__Content const& __cordl_internal_get_contentVersion() const;

constexpr ::BeatSaber::Init::__GameVersion__Content& __cordl_internal_get_contentVersion() ;

constexpr void __cordl_internal_set_buildMetadata(::System::Nullable_1<::BeatSaber::Init::__GameVersion__Metadata>  value) ;

constexpr void __cordl_internal_set_contentVersion(::BeatSaber::Init::__GameVersion__Content  value) ;

/// @brief Method .ctor, addr 0x222abcc, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::BeatSaber::Init::__GameVersion__Content  contentVersion, ::System::Nullable_1<::BeatSaber::Init::__GameVersion__Metadata>  buildMetadata) ;
...
/// @brief Field contentVersion, offset: 0x10, size: 0x20, def value: None
 ::BeatSaber::Init::__GameVersion__Content  ___contentVersion;
...
static_assert(offsetof(::BeatSaber::Init::GameVersion, ___contentVersion) == 0x10, "Offset mismatch!");
...
NEED_NO_BOX(::GlobalNamespace::__GameVersion__Content____c__DisplayClass14_0);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__GameVersion__Content____c__DisplayClass14_0*, "BeatSaber.Init", "GameVersion/Content/<>c__DisplayClass14_0");
NEED_NO_BOX(::GlobalNamespace::__GameVersion__Content____c__DisplayClass15_0);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__GameVersion__Content____c__DisplayClass15_0*, "BeatSaber.Init", "GameVersion/Content/<>c__DisplayClass15_0");
