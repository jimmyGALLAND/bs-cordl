...
/// @brief Field <commandLineArguments>k__BackingField, offset 0x50, size 0x18 
 __declspec(property(get=__cordl_internal_get__commandLineArguments_k__BackingField, put=__cordl_internal_set__commandLineArguments_k__BackingField)) ::BGLib::DotnetExtension::CommandLine::CommandLineParserResult  _commandLineArguments_k__BackingField;
...
static __declspec(property(get=getStaticF_kProgramArgumentOptions, put=setStaticF_kProgramArgumentOptions)) ::ArrayW<::BGLib::DotnetExtension::CommandLine::ArgumentOption,::Array<::BGLib::DotnetExtension::CommandLine::ArgumentOption>*>  kProgramArgumentOptions;
...
/// @brief Method InstallBindings, addr 0x222a5c4, size 0xac, virtual true, abstract: false, final false
inline void InstallBindings() ;

static inline ::BeatSaber::Init::BSAppInit* New_ctor() ;

/// @brief Method PreloadAsync, addr 0x222a51c, size 0xa8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x222a670, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_commandLineArguments, addr 0x222a4f4, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method set_commandLineArguments, addr 0x222a508, size 0x14, virtual false, abstract: false, final false
