...
constexpr ::BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType  BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType::NoTransformation{static_cast<int32_t>(0x0)};
constexpr ::BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType  BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType::Light{static_cast<int32_t>(0x1)};
constexpr ::BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType  BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType::DeltaRotation{static_cast<int32_t>(0x2)};
constexpr ::BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType  BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType::Switch{static_cast<int32_t>(0x3)};
constexpr ::BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType  BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType::TurnOffValueDuration{static_cast<int32_t>(0x4)};
constexpr ::BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType  BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType::ValueDuration{static_cast<int32_t>(0x5)};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::*)()>(&::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::get_visible)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2237de4;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatSaber::TrackDefinitions::EventTrackDefinitionSO*>::get(),
                        "get_visible",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType (::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::*)()>(&::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::get_dataTransformation)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2237dec;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__MarkerType (::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::*)()>(&::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::get_markerType)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2237df4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::*)()>(&::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::get_needsFiltering)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2237dfc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::*)()>(&::BeatSaber::TrackDefinitions::EventTrackDefinitionSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2237e04;
...
constexpr ::BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType const& BeatSaber::TrackDefinitions::EventTrackDefinitionSO::__cordl_internal_get__dataTransformationType() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____dataTransformationType;
}
constexpr void BeatSaber::TrackDefinitions::EventTrackDefinitionSO::__cordl_internal_set__dataTransformationType(::BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
