...
/// @brief Method .ctor, addr 0x2237e1c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_duplicationGroupName, addr 0x2237e0c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_duplicationGroupName() ;

/// @brief Method get_lightGroups, addr 0x2237e14, size 0x8, virtual false, abstract: false, final false
