...
/// @brief Field _dataTransformationType, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__dataTransformationType, put=__cordl_internal_set__dataTransformationType)) ::BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType  _dataTransformationType;
...
/// @brief Method .ctor, addr 0x2237e04, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_dataTransformation, addr 0x2237dec, size 0x8, virtual false, abstract: false, final false
inline ::BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__DataTransformationType get_dataTransformation() ;

/// @brief Method get_markerType, addr 0x2237df4, size 0x8, virtual false, abstract: false, final false
inline ::BeatSaber::TrackDefinitions::__EventTrackDefinitionSO__MarkerType get_markerType() ;

/// @brief Method get_needsFiltering, addr 0x2237dfc, size 0x8, virtual false, abstract: false, final false
inline bool get_needsFiltering() ;

/// @brief Method get_visible, addr 0x2237de4, size 0x8, virtual false, abstract: false, final false
