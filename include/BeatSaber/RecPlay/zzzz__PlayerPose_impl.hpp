...
// Ctor Parameters [CppParam { name: "head", ty: "::UnityEngine::Pose", modifiers: "", def_value: Some("{}") }, CppParam { name: "leftHand", ty: "::UnityEngine::Pose", modifiers: "", def_value: Some("{}") }, CppParam { name: "rightHand", ty: "::UnityEngine::Pose", modifiers: "", def_value: Some("{}") }]
