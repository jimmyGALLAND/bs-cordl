...
public:
// Declarations
/// @brief Method InterpolatePose, addr 0x2231660, size 0x8c, virtual false, abstract: false, final false
static inline ::UnityEngine::Pose InterpolatePose(ByRef<::UnityEngine::Pose>  a, ByRef<::UnityEngine::Pose>  b, float_t  t) ;

/// @brief Method InvertPose, addr 0x22319d4, size 0x68, virtual false, abstract: false, final false
static inline ::UnityEngine::Pose InvertPose(::UnityEngine::Pose  pose) ;

/// @brief Method MirrorPoseYZ, addr 0x2231a3c, size 0x34, virtual false, abstract: false, final false
