...
/// @brief Method .ctor, addr 0x221b6b0, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_headNeckOffset, addr 0x221b69c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_headNeckOffset() ;

/// @brief Method get_verticalOffset, addr 0x221b6a8, size 0x8, virtual false, abstract: false, final false
