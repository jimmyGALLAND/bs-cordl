...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x221b5d0, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x221b690, size 0xc, virtual true, abstract: false, final false
inline void EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x221b5b8, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x221ab40, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Field _avatarPartHighlightSetters, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__avatarPartHighlightSetters, put=__cordl_internal_set__avatarPartHighlightSetters)) ::System::Collections::Generic::Dictionary_2<::BeatSaber::BeatAvatarSDK::AvatarPart,::BeatSaber::BeatAvatarSDK::__BeatAvatarVisualController__HighlighterDelegate*>*  _avatarPartHighlightSetters;
...
/// @brief Field _clothesPropertyBlockSetter, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__clothesPropertyBlockSetter, put=__cordl_internal_set__clothesPropertyBlockSetter)) ::UnityW<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter>  _clothesPropertyBlockSetter;

/// @brief Field _currentHighlighter, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get__currentHighlighter, put=__cordl_internal_set__currentHighlighter)) ::BeatSaber::BeatAvatarSDK::__BeatAvatarVisualController__HighlighterDelegate*  _currentHighlighter;
...
/// @brief Field _facialHairPropertyBlockColorSetter, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__facialHairPropertyBlockColorSetter, put=__cordl_internal_set__facialHairPropertyBlockColorSetter)) ::UnityW<::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter>  _facialHairPropertyBlockColorSetter;
...
/// @brief Field _glassesPropertyBlockColorSetter, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__glassesPropertyBlockColorSetter, put=__cordl_internal_set__glassesPropertyBlockColorSetter)) ::UnityW<::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter>  _glassesPropertyBlockColorSetter;
...
/// @brief Field _headTopPropertyBlockColorSetter, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__headTopPropertyBlockColorSetter, put=__cordl_internal_set__headTopPropertyBlockColorSetter)) ::UnityW<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter>  _headTopPropertyBlockColorSetter;

/// @brief Field _leftHandPropertyBlockSetter, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get__leftHandPropertyBlockSetter, put=__cordl_internal_set__leftHandPropertyBlockSetter)) ::UnityW<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter>  _leftHandPropertyBlockSetter;
...
/// @brief Field _rightHandPropertyBlockSetter, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__rightHandPropertyBlockSetter, put=__cordl_internal_set__rightHandPropertyBlockSetter)) ::UnityW<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter>  _rightHandPropertyBlockSetter;
...
/// @brief Field _skinPropertyBlockColorSetter, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__skinPropertyBlockColorSetter, put=__cordl_internal_set__skinPropertyBlockColorSetter)) ::UnityW<::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter>  _skinPropertyBlockColorSetter;

/// @brief Method Awake, addr 0x221a8d4, size 0x26c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method DisableEditedPartHighlight, addr 0x221b51c, size 0x34, virtual false, abstract: false, final false
inline void DisableEditedPartHighlight() ;

/// @brief Method HighlightEditedPart, addr 0x221b480, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method SetHandsHighlight, addr 0x221b550, size 0x48, virtual false, abstract: false, final false
inline void SetHandsHighlight(bool  highlighted, int32_t  uvSegment) ;

/// @brief Method SetLightColor, addr 0x221b2a4, size 0xc, virtual false, abstract: false, final false
inline void SetLightColor(::UnityEngine::Color  color) ;

/// @brief Method UpdateAvatarColors, addr 0x221b018, size 0x28c, virtual false, abstract: false, final false
inline void UpdateAvatarColors() ;

/// @brief Method UpdateAvatarVisual, addr 0x221abcc, size 0x44c, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::BeatSaber::BeatAvatarSDK::AvatarPart,::BeatSaber::BeatAvatarSDK::__BeatAvatarVisualController__HighlighterDelegate*>*& __cordl_internal_get__avatarPartHighlightSetters() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::BeatSaber::BeatAvatarSDK::AvatarPart,::BeatSaber::BeatAvatarSDK::__BeatAvatarVisualController__HighlighterDelegate*>*> const& __cordl_internal_get__avatarPartHighlightSetters() const;
...
constexpr void __cordl_internal_set__avatarPartHighlightSetters(::System::Collections::Generic::Dictionary_2<::BeatSaber::BeatAvatarSDK::AvatarPart,::BeatSaber::BeatAvatarSDK::__BeatAvatarVisualController__HighlighterDelegate*>*  value) ;
...
/// @brief Method .ctor, addr 0x221b5a8, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
