...
/// @brief Method .ctor, addr 0x221ba60, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_darkerColorMultiplier, addr 0x221ba50, size 0x8, virtual false, abstract: false, final false
inline float_t get_darkerColorMultiplier() ;

/// @brief Method get_defaultColor, addr 0x221ba44, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_defaultColor() ;

/// @brief Method get_whiteBoost, addr 0x221ba58, size 0x8, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF___9__10_0, put=setStaticF___9__10_0)) ::System::Func_2<::BeatSaber::BeatAvatarSDK::__MulticolorAvatarPartPropertyBlockSetter__ColorData*,::UnityEngine::Color>*  __9__10_0;

static inline ::BeatSaber::BeatAvatarSDK::__MulticolorAvatarPartPropertyBlockSetter____c* New_ctor() ;

/// @brief Method <OnValidate>b__10_0, addr 0x221bae0, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x221bad8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _colorDataList, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__colorDataList, put=__cordl_internal_set__colorDataList)) ::ArrayW<::BeatSaber::BeatAvatarSDK::__MulticolorAvatarPartPropertyBlockSetter__ColorData*,::Array<::BeatSaber::BeatAvatarSDK::__MulticolorAvatarPartPropertyBlockSetter__ColorData*>*>  _colorDataList;
...
/// @brief Method OnValidate, addr 0x221b6c4, size 0x1a4, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method SetColors, addr 0x221b2b0, size 0x1d0, virtual false, abstract: false, final false
inline void SetColors(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  colors) ;

/// @brief Method SetHighlight, addr 0x221b598, size 0x10, virtual false, abstract: false, final false
inline void SetHighlight(bool  highlighted, int32_t  uvSegment) ;

/// @brief Method UpdateRenderer, addr 0x221b868, size 0x174, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::BeatSaber::BeatAvatarSDK::__MulticolorAvatarPartPropertyBlockSetter__ColorData*,::Array<::BeatSaber::BeatAvatarSDK::__MulticolorAvatarPartPropertyBlockSetter__ColorData*>*> const& __cordl_internal_get__colorDataList() const;

constexpr ::ArrayW<::BeatSaber::BeatAvatarSDK::__MulticolorAvatarPartPropertyBlockSetter__ColorData*,::Array<::BeatSaber::BeatAvatarSDK::__MulticolorAvatarPartPropertyBlockSetter__ColorData*>*>& __cordl_internal_get__colorDataList() ;
...
constexpr void __cordl_internal_set__colorDataList(::ArrayW<::BeatSaber::BeatAvatarSDK::__MulticolorAvatarPartPropertyBlockSetter__ColorData*,::Array<::BeatSaber::BeatAvatarSDK::__MulticolorAvatarPartPropertyBlockSetter__ColorData*>*>  value) ;
...
/// @brief Method .ctor, addr 0x221b9dc, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _colorDataList, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::BeatSaber::BeatAvatarSDK::__MulticolorAvatarPartPropertyBlockSetter__ColorData*,::Array<::BeatSaber::BeatAvatarSDK::__MulticolorAvatarPartPropertyBlockSetter__ColorData*>*>  ____colorDataList;
