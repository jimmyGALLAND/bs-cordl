...
/// @brief Method Awake, addr 0x2219904, size 0x10, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter* New_ctor() ;

/// @brief Method OnValidate, addr 0x2219914, size 0xc4, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method SetColor, addr 0x22199d8, size 0x38, virtual false, abstract: false, final false
inline void SetColor(::UnityEngine::Color  color) ;

/// @brief Method SetColors, addr 0x2219a10, size 0x14, virtual false, abstract: false, final false
inline void SetColors(::UnityEngine::Color  mainColor, ::UnityEngine::Color  rimLightColor) ;

/// @brief Method SetHighlight, addr 0x2219bc0, size 0xc, virtual false, abstract: false, final false
inline void SetHighlight(bool  highlighted, int32_t  uvSegment) ;

/// @brief Method UpdateRenderer, addr 0x2219a24, size 0x19c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2219bcc, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;
