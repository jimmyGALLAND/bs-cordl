...
/// @brief Method .ctor, addr 0x2219544, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_mesh, addr 0x2219508, size 0x3c, virtual false, abstract: false, final false
