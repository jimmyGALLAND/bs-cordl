...
/// @brief Method .ctor, addr 0x221a5e8, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_sprite, addr 0x221a5ac, size 0x3c, virtual false, abstract: false, final false
