...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,T>*> const& BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<T>::__cordl_internal_get__partById() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____partById;
}
template<typename T>
...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,int32_t>*> const& BeatSaber::BeatAvatarSDK::AvatarPartCollection_1<T>::__cordl_internal_get__partIndexById() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____partIndexById;
}
template<typename T>
