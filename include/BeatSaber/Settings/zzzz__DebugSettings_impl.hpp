...
// Ctor Parameters [CppParam { name: "showBeatmapLevelVersion", ty: "bool", modifiers: "", def_value: Some("{}") }]
constexpr ::BeatSaber::Settings::DebugSettings::DebugSettings(bool  showBeatmapLevelVersion) noexcept  {
