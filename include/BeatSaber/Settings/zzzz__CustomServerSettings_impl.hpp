...
// Ctor Parameters [CppParam { name: "useCustomEnvironment", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "forceGameLiftEnvironment", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "hostName", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }]
