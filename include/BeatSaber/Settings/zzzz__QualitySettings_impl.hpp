...
// Ctor Parameters [CppParam { name: "renderViewportScale", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "vrResolutionScale", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "menuVRResolutionScaleMultiplier", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "antiAliasingLevel", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "targetFramerate", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "vSyncCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "maxQueuedFrames", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "mainEffect", ty: "::BeatSaber::Settings::__QualitySettings__MainEffectOption", modifiers: "", def_value: Some("{}") }, CppParam { name: "bloom", ty: "::BeatSaber::Settings::__QualitySettings__BloomQuality", modifiers: "", def_value: Some("{}") }, CppParam { name: "mirror", ty: "::BeatSaber::Settings::__QualitySettings__MirrorQuality", modifiers: "", def_value: Some("{}") }, CppParam { name: "obstacles", ty: "::BeatSaber::Settings::__QualitySettings__ObstacleQuality", modifiers: "", def_value: Some("{}") }, CppParam { name: "screenDisplacementEffects", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "smokeGraphics", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "depthTexture", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "burnMarkTrails", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "maxShockwaveParticles", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "maxNumberOfCutSoundEffects", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
