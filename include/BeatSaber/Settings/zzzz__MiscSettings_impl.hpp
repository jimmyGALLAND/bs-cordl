...
// Ctor Parameters [CppParam { name: "language", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "pauseButtonResponse", ty: "::BeatSaber::Settings::__MiscSettings__ResponseLevel", modifiers: "", def_value: Some("{}") }]
