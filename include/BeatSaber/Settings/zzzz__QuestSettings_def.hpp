...
// Ctor Parameters [CppParam { name: "cpuLevel", ty: "::BeatSaber::Settings::__QuestSettings__SuggestedPerformanceLevel", modifiers: "", def_value: None }, CppParam { name: "gpuLevel", ty: "::BeatSaber::Settings::__QuestSettings__SuggestedPerformanceLevel", modifiers: "", def_value: None }, CppParam { name: "foveatedRenderingMenu", ty: "::BeatSaber::Settings::__QuestSettings__FoveatedRenderingLevel", modifiers: "", def_value: None }, CppParam { name: "foveatedRenderingGameplay", ty: "::BeatSaber::Settings::__QuestSettings__FoveatedRenderingLevel", modifiers: "", def_value: None }, CppParam { name: "eyeTrackedFoveatedRendering", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "dynamicFoveatedRendering", ty: "bool", modifiers: "", def_value: None }]
constexpr QuestSettings(::BeatSaber::Settings::__QuestSettings__SuggestedPerformanceLevel  cpuLevel, ::BeatSaber::Settings::__QuestSettings__SuggestedPerformanceLevel  gpuLevel, ::BeatSaber::Settings::__QuestSettings__FoveatedRenderingLevel  foveatedRenderingMenu, ::BeatSaber::Settings::__QuestSettings__FoveatedRenderingLevel  foveatedRenderingGameplay, bool  eyeTrackedFoveatedRendering, bool  dynamicFoveatedRendering) noexcept;
