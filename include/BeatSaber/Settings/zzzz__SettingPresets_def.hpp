...
/// @brief Method DefaultAudioSettingsWithLatency, addr 0x2232624, size 0x14, virtual false, abstract: false, final false
static inline ::BeatSaber::Settings::AudioSettings DefaultAudioSettingsWithLatency(float_t  latency) ;

/// @brief Method DefaultControllerSettings, addr 0x223269c, size 0x90, virtual false, abstract: false, final false
static inline ::BeatSaber::Settings::ControllerSettings DefaultControllerSettings() ;

/// @brief Method DefaultMiscSettings, addr 0x2232638, size 0x44, virtual false, abstract: false, final false
static inline ::BeatSaber::Settings::MiscSettings DefaultMiscSettings() ;

/// @brief Method DefaultQuestSettings, addr 0x223267c, size 0x14, virtual false, abstract: false, final false
static inline ::BeatSaber::Settings::QuestSettings DefaultQuestSettings() ;

/// @brief Method DefaultSmoothCameraSettings, addr 0x2232594, size 0x90, virtual false, abstract: false, final false
static inline ::BeatSaber::Settings::SmoothCameraSettings DefaultSmoothCameraSettings() ;

/// @brief Method DefaultWindowSettings, addr 0x2232690, size 0xc, virtual false, abstract: false, final false
