...
/// @brief Method .ctor, addr 0x4274b28, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::MS::Internal::Xml::XPath::AstNode*  groupNode) ;

/// @brief Method get_ReturnType, addr 0x4274b58, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XPath::XPathResultType get_ReturnType() ;

/// @brief Method get_Type, addr 0x4274b50, size 0x8, virtual true, abstract: false, final false
