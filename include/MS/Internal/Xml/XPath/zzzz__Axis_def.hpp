...
static inline ::MS::Internal::Xml::XPath::Axis* New_ctor(::MS::Internal::Xml::XPath::__Axis__AxisType  axisType, ::MS::Internal::Xml::XPath::AstNode*  input, ::StringW  prefix, ::StringW  name, ::System::Xml::XPath::XPathNodeType  nodetype) ;
...
/// @brief Method .ctor, addr 0x42746b0, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::MS::Internal::Xml::XPath::__Axis__AxisType  axisType, ::MS::Internal::Xml::XPath::AstNode*  input) ;

/// @brief Method .ctor, addr 0x4274618, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method get_AbbrAxis, addr 0x427476c, size 0x8, virtual false, abstract: false, final false
inline bool get_AbbrAxis() ;

/// @brief Method get_Input, addr 0x427473c, size 0x8, virtual false, abstract: false, final false
inline ::MS::Internal::Xml::XPath::AstNode* get_Input() ;

/// @brief Method get_Name, addr 0x4274754, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NodeType, addr 0x427475c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XPath::XPathNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x427474c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_ReturnType, addr 0x4274734, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XPath::XPathResultType get_ReturnType() ;

/// @brief Method get_Type, addr 0x427472c, size 0x8, virtual true, abstract: false, final false
inline ::MS::Internal::Xml::XPath::__AstNode__AstType get_Type() ;

/// @brief Method get_TypeOfAxis, addr 0x4274764, size 0x8, virtual false, abstract: false, final false
inline ::MS::Internal::Xml::XPath::__Axis__AxisType get_TypeOfAxis() ;

/// @brief Method get_Urn, addr 0x4274774, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Urn() ;

/// @brief Method set_Input, addr 0x4274744, size 0x8, virtual false, abstract: false, final false
inline void set_Input(::MS::Internal::Xml::XPath::AstNode*  value) ;

/// @brief Method set_Urn, addr 0x427477c, size 0x8, virtual false, abstract: false, final false
