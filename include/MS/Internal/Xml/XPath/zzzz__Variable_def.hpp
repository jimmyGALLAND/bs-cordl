...
/// @brief Method .ctor, addr 0x4274d24, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::StringW  prefix) ;

/// @brief Method get_ReturnType, addr 0x4274d58, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XPath::XPathResultType get_ReturnType() ;

/// @brief Method get_Type, addr 0x4274d50, size 0x8, virtual true, abstract: false, final false
