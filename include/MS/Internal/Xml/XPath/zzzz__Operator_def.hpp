...
static __declspec(property(get=getStaticF_s_invertOp, put=setStaticF_s_invertOp)) ::ArrayW<::MS::Internal::Xml::XPath::__Operator__Op,::Array<::MS::Internal::Xml::XPath::__Operator__Op>*>  s_invertOp;
...
/// @brief Method .ctor, addr 0x4274c10, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_ReturnType, addr 0x4274c54, size 0x24, virtual true, abstract: false, final false
inline ::System::Xml::XPath::XPathResultType get_ReturnType() ;

/// @brief Method get_Type, addr 0x4274c4c, size 0x8, virtual true, abstract: false, final false
