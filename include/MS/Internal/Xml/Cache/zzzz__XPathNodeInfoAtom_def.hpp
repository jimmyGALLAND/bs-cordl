...
/// @brief Field _pageSibling, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__pageSibling, put=__cordl_internal_set__pageSibling)) ::ArrayW<::MS::Internal::Xml::Cache::XPathNode,::Array<::MS::Internal::Xml::Cache::XPathNode>*>  _pageSibling;
...
/// @brief Method get_Document, addr 0x4279154, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XPath::XPathDocument* get_Document() ;

/// @brief Method get_LineNumberBase, addr 0x427915c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LineNumberBase() ;

/// @brief Method get_LinePositionBase, addr 0x4279164, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LinePositionBase() ;

/// @brief Method get_LocalName, addr 0x427912c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NamespaceUri, addr 0x4279134, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_NamespaceUri() ;

/// @brief Method get_PageInfo, addr 0x4279124, size 0x8, virtual false, abstract: false, final false
inline ::MS::Internal::Xml::Cache::XPathNodePageInfo* get_PageInfo() ;

/// @brief Method get_ParentPage, addr 0x427914c, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::MS::Internal::Xml::Cache::XPathNode,::Array<::MS::Internal::Xml::Cache::XPathNode>*> get_ParentPage() ;

/// @brief Method get_Prefix, addr 0x427913c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_SiblingPage, addr 0x4279144, size 0x8, virtual false, abstract: false, final false
