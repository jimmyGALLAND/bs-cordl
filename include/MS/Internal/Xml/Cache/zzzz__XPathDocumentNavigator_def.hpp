...
/// @brief Field _pageCurrent, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__pageCurrent, put=__cordl_internal_set__pageCurrent)) ::ArrayW<::MS::Internal::Xml::Cache::XPathNode,::Array<::MS::Internal::Xml::Cache::XPathNode>*>  _pageCurrent;

/// @brief Field _pageParent, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__pageParent, put=__cordl_internal_set__pageParent)) ::ArrayW<::MS::Internal::Xml::Cache::XPathNode,::Array<::MS::Internal::Xml::Cache::XPathNode>*>  _pageParent;

/// @brief Convert operator to "::System::Xml::IXmlLineInfo"
constexpr operator  ::System::Xml::IXmlLineInfo*() noexcept;

/// @brief Method Clone, addr 0x42786c8, size 0x74, virtual true, abstract: false, final false
inline ::System::Xml::XPath::XPathNavigator* Clone() ;

/// @brief Method GetPositionHashCode, addr 0x4278ff4, size 0xc, virtual false, abstract: false, final false
inline int32_t GetPositionHashCode() ;

/// @brief Method HasLineInfo, addr 0x4278e10, size 0x44, virtual true, abstract: false, final true
inline bool HasLineInfo() ;

/// @brief Method IsSamePosition, addr 0x4278d5c, size 0xa4, virtual true, abstract: false, final false
inline bool IsSamePosition(::System::Xml::XPath::XPathNavigator*  other) ;

/// @brief Method MoveToFirstNamespace, addr 0x42788e8, size 0xf0, virtual true, abstract: false, final false
inline bool MoveToFirstNamespace(::System::Xml::XPath::XPathNamespaceScope  namespaceScope) ;

/// @brief Method MoveToNextNamespace, addr 0x4278ba4, size 0x114, virtual true, abstract: false, final false
inline bool MoveToNextNamespace(::System::Xml::XPath::XPathNamespaceScope  scope) ;

/// @brief Method MoveToParent, addr 0x4278cdc, size 0x2c, virtual true, abstract: false, final false
inline bool MoveToParent() ;

static inline ::MS::Internal::Xml::Cache::XPathDocumentNavigator* New_ctor(::ArrayW<::MS::Internal::Xml::Cache::XPathNode,::Array<::MS::Internal::Xml::Cache::XPathNode>*>  pageCurrent, int32_t  idxCurrent, ::ArrayW<::MS::Internal::Xml::Cache::XPathNode,::Array<::MS::Internal::Xml::Cache::XPathNode>*>  pageParent, int32_t  idxParent) ;
...
/// @brief Method .ctor, addr 0x4278274, size 0x84, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::MS::Internal::Xml::Cache::XPathNode,::Array<::MS::Internal::Xml::Cache::XPathNode>*>  pageCurrent, int32_t  idxCurrent, ::ArrayW<::MS::Internal::Xml::Cache::XPathNode,::Array<::MS::Internal::Xml::Cache::XPathNode>*>  pageParent, int32_t  idxParent) ;

/// @brief Method get_LineNumber, addr 0x4278e54, size 0x84, virtual true, abstract: false, final true
inline int32_t get_LineNumber() ;

/// @brief Method get_LinePosition, addr 0x4278f00, size 0xa4, virtual true, abstract: false, final true
inline int32_t get_LinePosition() ;

/// @brief Method get_LocalName, addr 0x4278780, size 0x3c, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NameTable, addr 0x4278888, size 0x44, virtual true, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_NamespaceURI, addr 0x42787d8, size 0x3c, virtual true, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_NodeType, addr 0x427873c, size 0x38, virtual true, abstract: false, final false
inline ::System::Xml::XPath::XPathNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x4278830, size 0x3c, virtual true, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_UnderlyingObject, addr 0x4278e00, size 0x10, virtual true, abstract: false, final false
inline ::System::Object* get_UnderlyingObject() ;

/// @brief Method get_Value, addr 0x42782f8, size 0x1f0, virtual true, abstract: false, final false
