...
/// @brief Method LogError, addr 0x22a4b64, size 0x58, virtual true, abstract: false, final true
inline void LogError(::StringW  message) ;

/// @brief Method LogException, addr 0x22a4bbc, size 0x88, virtual true, abstract: false, final true
inline void LogException(::System::Exception*  exception, ::StringW  message) ;

/// @brief Method LogInfo, addr 0x22a4b60, size 0x4, virtual true, abstract: false, final true
inline void LogInfo(::StringW  message) ;

/// @brief Method LogWarning, addr 0x22a4c44, size 0x58, virtual true, abstract: false, final true
inline void LogWarning(::StringW  message) ;

static inline ::BGNet::Logging::UnityLogger* New_ctor() ;

/// @brief Method .ctor, addr 0x22a432c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
