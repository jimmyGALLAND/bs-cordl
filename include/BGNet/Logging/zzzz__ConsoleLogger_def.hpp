...
/// @brief Method LogError, addr 0x22a3ee0, size 0x1a8, virtual true, abstract: false, final true
inline void LogError(::StringW  message) ;

/// @brief Method LogException, addr 0x22a4088, size 0x134, virtual true, abstract: false, final true
inline void LogException(::System::Exception*  exception, ::StringW  message) ;

/// @brief Method LogInfo, addr 0x22a3e00, size 0xe0, virtual true, abstract: false, final true
inline void LogInfo(::StringW  message) ;

/// @brief Method LogWarning, addr 0x22a41bc, size 0xe0, virtual true, abstract: false, final true
inline void LogWarning(::StringW  message) ;

static inline ::BGNet::Logging::ConsoleLogger* New_ctor() ;

/// @brief Method .ctor, addr 0x22a429c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
