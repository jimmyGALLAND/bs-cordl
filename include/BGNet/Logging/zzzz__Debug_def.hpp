...
/// @brief Method .ctor, addr 0x22a450c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method AddLogger, addr 0x22a4334, size 0x168, virtual false, abstract: false, final false
static inline void AddLogger(::BGNet::Logging::__Debug__ILogger*  logger) ;

/// @brief Method Log, addr 0x22a477c, size 0xf4, virtual false, abstract: false, final false
static inline void Log(::StringW  message) ;

/// @brief Method LogError, addr 0x22a4870, size 0xf8, virtual false, abstract: false, final false
static inline void LogError(::StringW  message) ;

/// @brief Method LogException, addr 0x22a4968, size 0x100, virtual false, abstract: false, final false
static inline void LogException(::System::Exception*  exception, ::StringW  message) ;

/// @brief Method LogWarning, addr 0x22a4a68, size 0xf8, virtual false, abstract: false, final false
static inline void LogWarning(::StringW  message) ;

/// @brief Method NoDomainReloadInit, addr 0x22a42a4, size 0x88, virtual false, abstract: false, final false
static inline void NoDomainReloadInit() ;

/// @brief Method RemoveLogger, addr 0x22a4534, size 0x248, virtual false, abstract: false, final false
