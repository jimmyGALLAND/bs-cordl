...
/// @brief Method CancellationTokenWithDelay, addr 0x22a0bf0, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method Delay, addr 0x22a0b88, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method Run, addr 0x22a0c70, size 0x68, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task* Run(::System::Action*  action, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method Run, addr 0x22a0cd8, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method Wait, addr 0x22a0c58, size 0x18, virtual true, abstract: false, final true
inline void Wait(::System::Threading::Tasks::Task*  task) ;

/// @brief Method .ctor, addr 0x22a0d40, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
