...
/// @brief Method <.cctor>b__10_0, addr 0x4089954, size 0x3c, virtual false, abstract: false, final false
inline ::StringW __cctor_b__10_0(::System::Collections::Generic::KeyValuePair_2<::StringW,::StringW>  kvp) ;

/// @brief Method <.cctor>b__10_1, addr 0x4089990, size 0x3c, virtual false, abstract: false, final false
inline ::StringW __cctor_b__10_1(::System::Collections::Generic::KeyValuePair_2<::StringW,::StringW>  kvp) ;

/// @brief Method .ctor, addr 0x408994c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static __declspec(property(get=getStaticF_s_lateBoundFriendlyNameToOid, put=setStaticF_s_lateBoundFriendlyNameToOid)) ::System::Collections::Concurrent::ConcurrentDictionary_2<::StringW,::StringW>*  s_lateBoundFriendlyNameToOid;

/// @brief Field s_lateBoundOidToFriendlyName, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_lateBoundOidToFriendlyName, put=setStaticF_s_lateBoundOidToFriendlyName)) ::System::Collections::Concurrent::ConcurrentDictionary_2<::StringW,::StringW>*  s_lateBoundOidToFriendlyName;
...
/// @brief Method NativeFriendlyNameToOid, addr 0x4087888, size 0x3bc, virtual false, abstract: false, final false
...
/// @brief Method NativeOidToFriendlyName, addr 0x4087328, size 0x3b0, virtual false, abstract: false, final false
...
/// @brief Method ShouldUseCache, addr 0x4087320, size 0x8, virtual false, abstract: false, final false
static inline bool ShouldUseCache(::System::Security::Cryptography::OidGroup  oidGroup) ;

/// @brief Method ToFriendlyName, addr 0x4087144, size 0x1dc, virtual false, abstract: false, final false
static inline ::StringW ToFriendlyName(::StringW  oid, ::System::Security::Cryptography::OidGroup  oidGroup, bool  fallBackToAllGroups) ;

/// @brief Method ToOid, addr 0x40876d8, size 0x1b0, virtual false, abstract: false, final false
