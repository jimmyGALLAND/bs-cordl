...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Tweening::FloatTween::*)()>(&::Tweening::FloatTween::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x4448f0c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Tweening::FloatTween::*)(float_t, float_t, ::System::Action_1<float_t>*, float_t, ::GlobalNamespace::EaseType, float_t)>(&::Tweening::FloatTween::_ctor)> {
  constexpr static std::size_t size = 0x90;
  constexpr static std::size_t addrs = 0x4448f54;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::Tweening::FloatTween::*)(float_t)>(&::Tweening::FloatTween::GetValue)> {
  ...
  constexpr static std::size_t addrs = 0x4448fe4;
...
inline void Tweening::FloatTween::setStaticF_Pool(::Zenject::StaticMemoryPool_7<float_t,float_t,::System::Action_1<float_t>*,float_t,::GlobalNamespace::EaseType,float_t,::Tweening::FloatTween*>*  value)  {
...
inline ::Tweening::FloatTween* Tweening::FloatTween::New_ctor(float_t  fromValue, float_t  toValue, ::System::Action_1<float_t>*  onUpdate, float_t  duration, ::GlobalNamespace::EaseType  easeType, float_t  delay)  {
