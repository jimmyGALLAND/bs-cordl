...
/// @brief Field AllFrames value: static_cast<int32_t>(0x0)
static ::Tweening::FrameParity const AllFrames;

/// @brief Field EvenFrames value: static_cast<int32_t>(0x2)
static ::Tweening::FrameParity const EvenFrames;

/// @brief Field OddFrames value: static_cast<int32_t>(0x1)
