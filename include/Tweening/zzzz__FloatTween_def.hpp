...
static __declspec(property(get=getStaticF_Pool, put=setStaticF_Pool)) ::Zenject::StaticMemoryPool_7<float_t,float_t,::System::Action_1<float_t>*,float_t,::GlobalNamespace::EaseType,float_t,::Tweening::FloatTween*>*  Pool;

/// @brief Method GetValue, addr 0x4448fe4, size 0x2c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4448f0c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4448f54, size 0x90, virtual false, abstract: false, final false
