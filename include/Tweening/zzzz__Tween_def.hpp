...
/// @brief Method Kill, addr 0x4449d7c, size 0xc, virtual false, abstract: false, final false
inline void Kill() ;

static inline ::Tweening::Tween* New_ctor() ;

/// @brief Method Restart, addr 0x4449d88, size 0x10, virtual false, abstract: false, final false
inline void Restart(float_t  startTime) ;

/// @brief Method Resume, addr 0x4449d98, size 0x8, virtual false, abstract: false, final false
inline void Resume() ;

/// @brief Method Sample, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
inline void Sample(float_t  t) ;

/// @brief Method SetStartTimeAndEndTime, addr 0x4449da0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4449dac, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_delay, addr 0x4449d4c, size 0x8, virtual false, abstract: false, final false
inline float_t get_delay() ;

/// @brief Method get_duration, addr 0x4449d28, size 0x8, virtual false, abstract: false, final false
inline float_t get_duration() ;

/// @brief Method get_easeType, addr 0x4449d5c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::EaseType get_easeType() ;

/// @brief Method get_isActive, addr 0x4449ccc, size 0x30, virtual false, abstract: false, final false
inline bool get_isActive() ;

/// @brief Method get_isComplete, addr 0x4449cfc, size 0x14, virtual false, abstract: false, final false
inline bool get_isComplete() ;

/// @brief Method get_isKilled, addr 0x4449d10, size 0x8, virtual false, abstract: false, final false
inline bool get_isKilled() ;

/// @brief Method get_isStarted, addr 0x4449cc4, size 0x8, virtual false, abstract: false, final false
inline bool get_isStarted() ;

/// @brief Method get_loop, addr 0x4449d38, size 0x8, virtual false, abstract: false, final false
inline bool get_loop() ;

/// @brief Method get_progress, addr 0x4449d18, size 0x8, virtual false, abstract: false, final false
inline float_t get_progress() ;

/// @brief Method get_startTime, addr 0x4449d20, size 0x8, virtual false, abstract: false, final false
inline float_t get_startTime() ;

/// @brief Method get_updateAt, addr 0x4449d6c, size 0x8, virtual false, abstract: false, final false
inline ::Tweening::FrameParity get_updateAt() ;

/// @brief Method set_delay, addr 0x4449d54, size 0x8, virtual false, abstract: false, final false
inline void set_delay(float_t  value) ;

/// @brief Method set_duration, addr 0x4449d30, size 0x8, virtual false, abstract: false, final false
inline void set_duration(float_t  value) ;

/// @brief Method set_easeType, addr 0x4449d64, size 0x8, virtual false, abstract: false, final false
inline void set_easeType(::GlobalNamespace::EaseType  value) ;

/// @brief Method set_loop, addr 0x4449d40, size 0xc, virtual false, abstract: false, final false
inline void set_loop(bool  value) ;

/// @brief Method set_updateAt, addr 0x4449d74, size 0x8, virtual false, abstract: false, final false
