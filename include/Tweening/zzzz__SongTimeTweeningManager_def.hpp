...
/// @brief Method GetTime, addr 0x3ae30d0, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ae3170, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
