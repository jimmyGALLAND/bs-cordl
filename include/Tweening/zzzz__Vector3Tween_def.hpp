...
static __declspec(property(get=getStaticF_Pool, put=setStaticF_Pool)) ::Zenject::StaticMemoryPool_7<::UnityEngine::Vector3,::UnityEngine::Vector3,::System::Action_1<::UnityEngine::Vector3>*,float_t,::GlobalNamespace::EaseType,float_t,::Tweening::Vector3Tween*>*  Pool;

/// @brief Method GetValue, addr 0x4449490, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4449388, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x44493d0, size 0xc0, virtual false, abstract: false, final false
