...
static __declspec(property(get=getStaticF_Pool, put=setStaticF_Pool)) ::Zenject::StaticMemoryPool_7<::UnityEngine::Vector2,::UnityEngine::Vector2,::System::Action_1<::UnityEngine::Vector2>*,float_t,::GlobalNamespace::EaseType,float_t,::Tweening::Vector2Tween*>*  Pool;

/// @brief Method GetValue, addr 0x444922c, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x444913c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4449184, size 0xa8, virtual false, abstract: false, final false
