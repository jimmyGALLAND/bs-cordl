...
/// @brief Method GetValue, addr 0x4448cb8, size 0x254, virtual true, abstract: false, final false
inline int32_t GetValue(float_t  t) ;

static inline ::Tweening::IntTween* New_ctor() ;

static inline ::Tweening::IntTween* New_ctor(int32_t  fromValue, int32_t  toValue, ::System::Action_1<int32_t>*  onUpdate, float_t  duration, ::GlobalNamespace::EaseType  easeType, ::Tweening::__IntTween__RoundingType  roundingType, float_t  delay) ;
...
/// @brief Method .ctor, addr 0x4448bcc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4448c14, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(int32_t  fromValue, int32_t  toValue, ::System::Action_1<int32_t>*  onUpdate, float_t  duration, ::GlobalNamespace::EaseType  easeType, ::Tweening::__IntTween__RoundingType  roundingType, float_t  delay) ;
