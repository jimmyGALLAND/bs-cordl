...
static __declspec(property(get=getStaticF_Pool, put=setStaticF_Pool)) ::Zenject::StaticMemoryPool_7<::UnityEngine::Color,::UnityEngine::Color,::System::Action_1<::UnityEngine::Color>*,float_t,::GlobalNamespace::EaseType,float_t,::Tweening::ColorTween*>*  Pool;

/// @brief Method GetValue, addr 0x44499a8, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4449890, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x44498d8, size 0xd0, virtual false, abstract: false, final false
