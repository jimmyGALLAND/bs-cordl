...
public:
// Declarations
/// @brief Method Invoke, addr 0x47c1c3c, size 0x14, virtual true, abstract: false, final false
inline void Invoke() ;
...
/// @brief Method .ctor, addr 0x47c1bb4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Field OnOverrideControllerDirty, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_OnOverrideControllerDirty, put=__cordl_internal_set_OnOverrideControllerDirty)) ::UnityEngine::__AnimatorOverrideController__OnOverrideControllerDirtyCallback*  OnOverrideControllerDirty;

/// @brief Method ApplyOverrides, addr 0x47c1928, size 0x25c, virtual false, abstract: false, final false
...
/// @brief Method Internal_Create, addr 0x47c184c, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method OnInvalidateOverrideController, addr 0x47c1b84, size 0x30, virtual false, abstract: false, final false
static inline void OnInvalidateOverrideController(::UnityEngine::AnimatorOverrideController*  controller) ;

/// @brief Method SendNotification, addr 0x47c18ec, size 0x3c, virtual false, abstract: false, final false
inline void SendNotification() ;

/// @brief Method SetClip, addr 0x47c1890, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x47c17a4, size 0x50, virtual false, abstract: false, final false
