...
/// @brief Method ExtractFormattedStackTrace, addr 0x481c2d4, size 0x70c, virtual false, abstract: false, final false
static inline ::StringW ExtractFormattedStackTrace(::System::Diagnostics::StackTrace*  stackTrace) ;

/// @brief Method ExtractStackTrace, addr 0x481c178, size 0x15c, virtual false, abstract: false, final false
static inline ::StringW ExtractStackTrace() ;

/// @brief Method ExtractStringFromExceptionInternal, addr 0x481c9e0, size 0x35c, virtual false, abstract: false, final false
...
/// @brief Method SetProjectFolder, addr 0x481c09c, size 0xdc, virtual false, abstract: false, final false
