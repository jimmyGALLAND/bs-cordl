...
/// @brief Method CopyToNativeArray, addr 0x487a7ac, size 0x6c, virtual false, abstract: false, final false
inline void CopyToNativeArray(::Unity::Collections::NativeArray_1<::UnityEngine::ContactPairPoint>  buffer) ;

/// @brief Method ExtractContacts, addr 0x485fe40, size 0x54, virtual false, abstract: false, final false
inline int32_t ExtractContacts(::System::Collections::Generic::List_1<::UnityEngine::ContactPoint>*  managedContainer, bool  flipped) ;

/// @brief Method ExtractContactsArray, addr 0x485f7e0, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method ExtractContactsArray_Injected, addr 0x487a758, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method ExtractContacts_Injected, addr 0x487a704, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method GetContactPoint, addr 0x487a818, size 0x4, virtual false, abstract: false, final false
inline ByRef<::UnityEngine::ContactPairPoint> GetContactPoint(int32_t  index) ;

/// @brief Method GetContactPointFaceIndex, addr 0x487a81c, size 0xd8, virtual false, abstract: false, final false
inline uint32_t GetContactPointFaceIndex(int32_t  contactIndex) ;

/// @brief Method GetContactPoint_Internal, addr 0x485fb38, size 0x80, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<::UnityEngine::ContactPairPoint> GetContactPoint_Internal(int32_t  index) ;

/// @brief Method get_Collider, addr 0x485f56c, size 0x8c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Collider> get_Collider() ;

/// @brief Method get_ColliderInstanceID, addr 0x487a6e0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ColliderInstanceID() ;

/// @brief Method get_ContactCount, addr 0x487a6f0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ContactCount() ;

/// @brief Method get_HasRemovedCollider, addr 0x486eeb0, size 0x10, virtual false, abstract: false, final false
inline bool get_HasRemovedCollider() ;

/// @brief Method get_ImpulseSum, addr 0x487a6f8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_ImpulseSum() ;

/// @brief Method get_IsCollisionEnter, addr 0x486eec0, size 0xc, virtual false, abstract: false, final false
inline bool get_IsCollisionEnter() ;

/// @brief Method get_IsCollisionExit, addr 0x486effc, size 0xc, virtual false, abstract: false, final false
inline bool get_IsCollisionExit() ;

/// @brief Method get_IsCollisionStay, addr 0x486eff0, size 0xc, virtual false, abstract: false, final false
inline bool get_IsCollisionStay() ;

/// @brief Method get_OtherCollider, addr 0x485f4e0, size 0x8c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Collider> get_OtherCollider() ;

/// @brief Method get_OtherColliderInstanceID, addr 0x487a6e8, size 0x8, virtual false, abstract: false, final false
