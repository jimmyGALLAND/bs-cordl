...
/// @brief Method .ctor, addr 0x47d1470, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::UnityEngine::Hash128  hash) ;

/// @brief Method get_hash, addr 0x47d1484, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Hash128 get_hash() ;

/// @brief Method get_name, addr 0x47d147c, size 0x8, virtual false, abstract: false, final false
