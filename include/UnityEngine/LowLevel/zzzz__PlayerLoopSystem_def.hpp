...
public:
// Declarations
/// @brief Method Invoke, addr 0x482ed34, size 0x14, virtual true, abstract: false, final false
inline void Invoke() ;

static inline ::UnityEngine::LowLevel::__PlayerLoopSystem__UpdateFunction* New_ctor(::System::Object*  object, ::System::IntPtr  method) ;

/// @brief Method .ctor, addr 0x482ecac, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x482ec8c, size 0x20, virtual true, abstract: false, final false
...
constexpr PlayerLoopSystem(::System::Type*  type, ::ArrayW<::UnityEngine::LowLevel::PlayerLoopSystem,::Array<::UnityEngine::LowLevel::PlayerLoopSystem>*>  subSystemList, ::UnityEngine::LowLevel::__PlayerLoopSystem__UpdateFunction*  updateDelegate, ::System::IntPtr  updateFunction, ::System::IntPtr  loopConditionFunction) noexcept;
