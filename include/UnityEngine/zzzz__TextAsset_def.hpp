...
static __declspec(property(get=getStaticF_encodingLookup, put=setStaticF_encodingLookup)) ::ArrayW<::System::Collections::Generic::KeyValuePair_2<::ArrayW<uint8_t,::Array<uint8_t>*>,::System::Text::Encoding*>,::Array<::System::Collections::Generic::KeyValuePair_2<::ArrayW<uint8_t,::Array<uint8_t>*>,::System::Text::Encoding*>>*>  encodingLookup;
...
/// @brief Method DecodeString, addr 0x481d068, size 0x288, virtual false, abstract: false, final false
...
/// @brief Method GetDataPtr, addr 0x481cf60, size 0x3c, virtual false, abstract: false, final false
inline ::System::IntPtr GetDataPtr() ;

/// @brief Method GetDataSize, addr 0x481cf9c, size 0x3c, virtual false, abstract: false, final false
inline int64_t GetDataSize() ;

/// @brief Method GetPreview, addr 0x481d3f4, size 0x48, virtual false, abstract: false, final false
inline ::StringW GetPreview(int32_t  maxChars) ;

/// @brief Method GetPreviewBytes, addr 0x481ced8, size 0x44, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPreviewBytes(int32_t  maxByteCount) ;

/// @brief Method Internal_CreateInstance, addr 0x481cf1c, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x481d32c, size 0x4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x481d330, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x481d33c, size 0xac, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::__TextAsset__CreateOptions  options, ::StringW  text) ;

/// @brief Method .ctor, addr 0x481d3e8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  text) ;

/// @brief Method get_bytes, addr 0x481ce9c, size 0x3c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_bytes() ;

/// @brief Method get_dataSize, addr 0x481d2f0, size 0x3c, virtual false, abstract: false, final false
inline int64_t get_dataSize() ;

/// @brief Method get_text, addr 0x481cfd8, size 0x90, virtual false, abstract: false, final false
