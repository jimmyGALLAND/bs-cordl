...
/// @brief Method .ctor, addr 0x486009c, size 0x118, virtual false, abstract: false, final false
inline void _ctor(int32_t  rows, int32_t  cols) ;

/// @brief Method get_Item, addr 0x48601b4, size 0xb8, virtual false, abstract: false, final false
inline float_t get_Item(int32_t  row, int32_t  col) ;

/// @brief Method get_columns, addr 0x4860344, size 0x8, virtual false, abstract: false, final false
inline int32_t get_columns() ;

/// @brief Method get_elements, addr 0x4860354, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<float_t>* get_elements() ;

/// @brief Method get_rows, addr 0x4860334, size 0x8, virtual false, abstract: false, final false
inline int32_t get_rows() ;

/// @brief Method set_Item, addr 0x486026c, size 0xc8, virtual false, abstract: false, final false
inline void set_Item(int32_t  row, int32_t  col, float_t  value) ;

/// @brief Method set_columns, addr 0x486034c, size 0x8, virtual false, abstract: false, final false
inline void set_columns(int32_t  value) ;

/// @brief Method set_elements, addr 0x486035c, size 0x8, virtual false, abstract: false, final false
inline void set_elements(::System::Collections::Generic::List_1<float_t>*  value) ;

/// @brief Method set_rows, addr 0x486033c, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "rowsCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "colsCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "matrixData", ty: "::System::Collections::Generic::List_1<float_t>*", modifiers: "", def_value: None }]
