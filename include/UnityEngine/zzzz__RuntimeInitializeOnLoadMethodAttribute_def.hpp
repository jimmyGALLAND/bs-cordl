...
/// @brief Method .ctor, addr 0x481bef4, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::RuntimeInitializeLoadType  loadType) ;

/// @brief Method set_loadType, addr 0x481bf1c, size 0x8, virtual false, abstract: false, final false
