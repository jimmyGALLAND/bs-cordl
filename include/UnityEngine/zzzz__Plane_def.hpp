...
/// @brief Method ClosestPointOnPlane, addr 0x47de424, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 ClosestPointOnPlane(::UnityEngine::Vector3  point) ;

/// @brief Method GetDistanceToPoint, addr 0x47de460, size 0x24, virtual false, abstract: false, final false
inline float_t GetDistanceToPoint(::UnityEngine::Vector3  point) ;

/// @brief Method Raycast, addr 0x47de4f0, size 0x100, virtual false, abstract: false, final false
inline bool Raycast(::UnityEngine::Ray  ray, ByRef<float_t>  enter) ;

/// @brief Method SameSide, addr 0x47de484, size 0x6c, virtual false, abstract: false, final false
inline bool SameSide(::UnityEngine::Vector3  inPt0, ::UnityEngine::Vector3  inPt1) ;

/// @brief Method ToString, addr 0x47de5f0, size 0x10, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x47de600, size 0x188, virtual true, abstract: false, final true
inline ::StringW ToString(::StringW  format, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method .ctor, addr 0x47de2ac, size 0x178, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Vector3  a, ::UnityEngine::Vector3  b, ::UnityEngine::Vector3  c) ;

/// @brief Method .ctor, addr 0x47de19c, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Vector3  inNormal, ::UnityEngine::Vector3  inPoint) ;

/// @brief Method get_distance, addr 0x47de194, size 0x8, virtual false, abstract: false, final false
inline float_t get_distance() ;

/// @brief Method get_normal, addr 0x47de188, size 0xc, virtual false, abstract: false, final false
