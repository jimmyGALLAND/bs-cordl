...
/// @brief Method AreEqual, addr 0x483ec68, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method AreEqual, addr 0x483f204, size 0x8c, virtual false, abstract: false, final false
static inline void AreEqual(int32_t  expected, int32_t  actual) ;

/// @brief Method Fail, addr 0x483e8b4, size 0x120, virtual false, abstract: false, final false
static inline void Fail(::StringW  message, ::StringW  userMessage) ;

/// @brief Method IsFalse, addr 0x483ebe8, size 0x80, virtual false, abstract: false, final false
static inline void IsFalse(bool  condition, ::StringW  message) ;

/// @brief Method IsNotNull, addr 0x483f148, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method IsNull, addr 0x483ef24, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method IsTrue, addr 0x483ea48, size 0x6c, virtual false, abstract: false, final false
static inline void IsTrue(bool  condition) ;

/// @brief Method IsTrue, addr 0x483eab4, size 0x80, virtual false, abstract: false, final false
