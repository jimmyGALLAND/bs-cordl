...
/// @brief Method Equals, addr 0x4a513bc, size 0x78, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Experimental::Video::VideoClipPlayable  other) ;

/// @brief Method GetHandle, addr 0x4a513b0, size 0xc, virtual true, abstract: false, final true
