...
/// @brief Method Black, addr 0x483c650, size 0x14, virtual false, abstract: false, final false
static inline ::UnityEngine::Experimental::GlobalIllumination::LinearColor Black() ;

/// @brief Method Convert, addr 0x483c38c, size 0x2c4, virtual false, abstract: false, final false
static inline ::UnityEngine::Experimental::GlobalIllumination::LinearColor Convert(::UnityEngine::Color  color, float_t  intensity) ;

/// @brief Method get_blue, addr 0x483c2d8, size 0x8, virtual false, abstract: false, final false
inline float_t get_blue() ;

/// @brief Method get_green, addr 0x483c224, size 0x8, virtual false, abstract: false, final false
inline float_t get_green() ;

/// @brief Method get_red, addr 0x483c170, size 0x8, virtual false, abstract: false, final false
inline float_t get_red() ;

/// @brief Method set_blue, addr 0x483c2e0, size 0xac, virtual false, abstract: false, final false
inline void set_blue(float_t  value) ;

/// @brief Method set_green, addr 0x483c22c, size 0xac, virtual false, abstract: false, final false
inline void set_green(float_t  value) ;

/// @brief Method set_red, addr 0x483c178, size 0xac, virtual false, abstract: false, final false
