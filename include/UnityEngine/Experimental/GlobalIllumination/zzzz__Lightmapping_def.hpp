...
public:
// Declarations
/// @brief Method Invoke, addr 0x483d7bc, size 0x14, virtual true, abstract: false, final false
inline void Invoke(::ArrayW<::UnityEngine::Light*,::Array<::UnityEngine::Light*>*>  requests, ::Unity::Collections::NativeArray_1<::UnityEngine::Experimental::GlobalIllumination::LightDataGI>  lightsOutput) ;

static inline ::UnityEngine::Experimental::GlobalIllumination::__Lightmapping__RequestLightsDelegate* New_ctor(::System::Object*  object, ::System::IntPtr  method) ;

/// @brief Method .ctor, addr 0x483d71c, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method <.cctor>b__7_0, addr 0x483d834, size 0x248, virtual false, abstract: false, final false
inline void __cctor_b__7_0(::ArrayW<::UnityEngine::Light*,::Array<::UnityEngine::Light*>*>  requests, ::Unity::Collections::NativeArray_1<::UnityEngine::Experimental::GlobalIllumination::LightDataGI>  lightsOutput) ;

/// @brief Method .ctor, addr 0x483d82c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static __declspec(property(get=getStaticF_s_DefaultDelegate, put=setStaticF_s_DefaultDelegate)) ::UnityEngine::Experimental::GlobalIllumination::__Lightmapping__RequestLightsDelegate*  s_DefaultDelegate;

/// @brief Field s_RequestLightsDelegate, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_RequestLightsDelegate, put=setStaticF_s_RequestLightsDelegate)) ::UnityEngine::Experimental::GlobalIllumination::__Lightmapping__RequestLightsDelegate*  s_RequestLightsDelegate;

/// @brief Method GetDelegate, addr 0x483d4cc, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::Experimental::GlobalIllumination::__Lightmapping__RequestLightsDelegate* GetDelegate() ;

/// @brief Method RequestLights, addr 0x483d580, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method ResetDelegate, addr 0x483d524, size 0x5c, virtual false, abstract: false, final false
static inline void ResetDelegate() ;

/// @brief Method SetDelegate, addr 0x483d454, size 0x78, virtual false, abstract: false, final false
