...
/// @brief Method BuiltinUpdate, addr 0x483dc3c, size 0x28, virtual false, abstract: false, final false
static inline bool BuiltinUpdate() ;

/// @brief Method Dispose, addr 0x483dc64, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x483dc68, size 0x4, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Internal_BuiltinRuntimeReflectionSystem_New, addr 0x483dc6c, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method TickRealtimeProbes, addr 0x483dc14, size 0x28, virtual true, abstract: false, final true
inline bool TickRealtimeProbes() ;

/// @brief Method .ctor, addr 0x483dcc0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
