...
/// @brief Method Equals, addr 0x483da88, size 0x78, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Experimental::Playables::CameraPlayable  other) ;

/// @brief Method GetHandle, addr 0x483da7c, size 0xc, virtual true, abstract: false, final true
