...
/// @brief Method Equals, addr 0x483db90, size 0x78, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Experimental::Playables::TextureMixerPlayable  other) ;

/// @brief Method GetHandle, addr 0x483db84, size 0xc, virtual true, abstract: false, final true
