...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Experimental::Audio::__AudioSampleProvider__SampleFramesHandler::*)(::System::Object*, ::System::IntPtr)>(&::UnityEngine::Experimental::Audio::__AudioSampleProvider__SampleFramesHandler::_ctor)> {
  constexpr static std::size_t size = 0x104;
  constexpr static std::size_t addrs = 0x47ca4f0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Experimental::Audio::__AudioSampleProvider__SampleFramesHandler::*)(::UnityEngine::Experimental::Audio::AudioSampleProvider*, uint32_t)>(&::UnityEngine::Experimental::Audio::__AudioSampleProvider__SampleFramesHandler::Invoke)> {
...
inline ::UnityEngine::Experimental::Audio::__AudioSampleProvider__SampleFramesHandler* UnityEngine::Experimental::Audio::__AudioSampleProvider__SampleFramesHandler::New_ctor(::System::Object*  object, ::System::IntPtr  method)  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Experimental::Audio::AudioSampleProvider::*)(int32_t)>(&::UnityEngine::Experimental::Audio::AudioSampleProvider::InvokeSampleFramesAvailable)> {
  ...
  constexpr static std::size_t addrs = 0x47ca4a0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Experimental::Audio::AudioSampleProvider::*)(int32_t)>(&::UnityEngine::Experimental::Audio::AudioSampleProvider::InvokeSampleFramesOverflow)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x47ca4c8;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Experimental::Audio::__AudioSampleProvider__SampleFramesHandler*> const& UnityEngine::Experimental::Audio::AudioSampleProvider::__cordl_internal_get_sampleFramesAvailable() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___sampleFramesAvailable;
}
constexpr void UnityEngine::Experimental::Audio::AudioSampleProvider::__cordl_internal_set_sampleFramesAvailable(::UnityEngine::Experimental::Audio::__AudioSampleProvider__SampleFramesHandler*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Experimental::Audio::__AudioSampleProvider__SampleFramesHandler*> const& UnityEngine::Experimental::Audio::AudioSampleProvider::__cordl_internal_get_sampleFramesOverflow() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___sampleFramesOverflow;
}
