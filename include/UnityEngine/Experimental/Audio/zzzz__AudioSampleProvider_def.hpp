...
public:
// Declarations
/// @brief Method Invoke, addr 0x47ca5f4, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x47ca4f0, size 0x104, virtual false, abstract: false, final false
...
/// @brief Field sampleFramesAvailable, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_sampleFramesAvailable, put=__cordl_internal_set_sampleFramesAvailable)) ::UnityEngine::Experimental::Audio::__AudioSampleProvider__SampleFramesHandler*  sampleFramesAvailable;

/// @brief Field sampleFramesOverflow, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_sampleFramesOverflow, put=__cordl_internal_set_sampleFramesOverflow)) ::UnityEngine::Experimental::Audio::__AudioSampleProvider__SampleFramesHandler*  sampleFramesOverflow;

/// @brief Method InvokeSampleFramesAvailable, addr 0x47ca4a0, size 0x28, virtual false, abstract: false, final false
inline void InvokeSampleFramesAvailable(int32_t  sampleFrameCount) ;

/// @brief Method InvokeSampleFramesOverflow, addr 0x47ca4c8, size 0x28, virtual false, abstract: false, final false
