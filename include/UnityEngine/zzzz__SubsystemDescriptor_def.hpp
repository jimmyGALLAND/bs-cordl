...
/// @brief Method UnityEngine.ISubsystemDescriptor.Create, addr 0x4884d00, size 0xc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x4884d0c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_id, addr 0x4884cf8, size 0x8, virtual true, abstract: false, final true
