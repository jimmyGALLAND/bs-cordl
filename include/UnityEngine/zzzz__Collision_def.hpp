...
/// @brief Method GetContact, addr 0x485f974, size 0x1c4, virtual false, abstract: false, final false
inline ::UnityEngine::ContactPoint GetContact(int32_t  index) ;

/// @brief Method GetContacts, addr 0x485fbe4, size 0xe4, virtual false, abstract: false, final false
inline int32_t GetContacts(::ArrayW<::UnityEngine::ContactPoint,::Array<::UnityEngine::ContactPoint>*>  contacts) ;

/// @brief Method GetContacts, addr 0x485fcc8, size 0x178, virtual false, abstract: false, final false
inline int32_t GetContacts(::System::Collections::Generic::List_1<::UnityEngine::ContactPoint>*  contacts) ;

/// @brief Method GetEnumerator, addr 0x485fe94, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method Reuse, addr 0x485f944, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x485f834, size 0x34, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x485f868, size 0xdc, virtual false, abstract: false, final false
inline void _ctor(ByRef<::UnityEngine::ContactPairHeader>  header, ByRef<::UnityEngine::ContactPair>  pair, bool  flipped) ;

/// @brief Method get_Flipped, addr 0x485f720, size 0x8, virtual false, abstract: false, final false
inline bool get_Flipped() ;

/// @brief Method get_articulationBody, addr 0x485f35c, size 0x80, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::ArticulationBody> get_articulationBody() ;

/// @brief Method get_body, addr 0x485f348, size 0x14, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Component> get_body() ;

/// @brief Method get_collider, addr 0x485f4cc, size 0x14, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Collider> get_collider() ;

/// @brief Method get_contactCount, addr 0x485f734, size 0x8, virtual false, abstract: false, final false
inline int32_t get_contactCount() ;

/// @brief Method get_contacts, addr 0x485f73c, size 0xa4, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::ContactPoint,::Array<::UnityEngine::ContactPoint>*> get_contacts() ;

/// @brief Method get_frictionForceSum, addr 0x485fef4, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_frictionForceSum() ;

/// @brief Method get_gameObject, addr 0x485f68c, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_gameObject() ;

/// @brief Method get_impactForceSum, addr 0x485feb0, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_impactForceSum() ;

/// @brief Method get_impulse, addr 0x485f290, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_impulse() ;

/// @brief Method get_other, addr 0x485ff38, size 0x88, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Component> get_other() ;

/// @brief Method get_relativeVelocity, addr 0x485f29c, size 0x2c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_relativeVelocity() ;

/// @brief Method get_rigidbody, addr 0x485f2c8, size 0x80, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rigidbody> get_rigidbody() ;

/// @brief Method get_transform, addr 0x485f5f8, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_transform() ;

/// @brief Method set_Flipped, addr 0x485f728, size 0xc, virtual false, abstract: false, final false
