...
/// @brief Method .ctor, addr 0x4882868, size 0xfc, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method set_Name, addr 0x4882860, size 0x8, virtual true, abstract: false, final true
