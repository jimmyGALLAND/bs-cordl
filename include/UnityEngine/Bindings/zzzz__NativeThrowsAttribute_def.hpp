...
/// @brief Method .ctor, addr 0x4882e7c, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_ThrowsException, addr 0x4882e70, size 0xc, virtual true, abstract: false, final true
