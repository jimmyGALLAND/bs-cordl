...
/// @brief Method .ctor, addr 0x488272c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  condition) ;

/// @brief Method set_Condition, addr 0x4882718, size 0x8, virtual false, abstract: false, final false
inline void set_Condition(::StringW  value) ;

/// @brief Method set_Enabled, addr 0x4882720, size 0xc, virtual false, abstract: false, final false
