...
/// @brief Method .ctor, addr 0x4882d4c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  exception) ;

/// @brief Method set_Exception, addr 0x4882d44, size 0x8, virtual false, abstract: false, final false
