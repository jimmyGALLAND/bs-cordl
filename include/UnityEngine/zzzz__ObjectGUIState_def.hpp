...
/// @brief Method Destroy, addr 0x484f230, size 0x5c, virtual false, abstract: false, final false
inline void Destroy() ;

/// @brief Method Dispose, addr 0x484f1d0, size 0x60, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Finalize, addr 0x484f28c, size 0x94, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method Internal_Create, addr 0x484f1a8, size 0x28, virtual false, abstract: false, final false
static inline ::System::IntPtr Internal_Create() ;

/// @brief Method Internal_Destroy, addr 0x484f320, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x484f160, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
