...
/// @brief Method ToString, addr 0x47e4964, size 0x180, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_height, addr 0x47e4954, size 0x8, virtual false, abstract: false, final false
inline int32_t get_height() ;

/// @brief Method get_refreshRateRatio, addr 0x47e495c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::RefreshRate get_refreshRateRatio() ;

/// @brief Method get_width, addr 0x47e494c, size 0x8, virtual false, abstract: false, final false
