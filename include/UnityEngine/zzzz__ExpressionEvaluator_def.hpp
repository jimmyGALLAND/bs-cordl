...
/// @brief Method .ctor, addr 0x47dc740, size 0x84, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method GetUInt, addr 0x47dc130, size 0x38, virtual false, abstract: false, final false
inline uint32_t GetUInt() ;

/// @brief Method RotateRight, addr 0x47dc7fc, size 0x8, virtual false, abstract: false, final false
static inline uint32_t RotateRight(uint32_t  v, int32_t  rot) ;

/// @brief Method Step, addr 0x47dc7c4, size 0x20, virtual false, abstract: false, final false
inline void Step() ;

/// @brief Method XshRr, addr 0x47dc7e4, size 0x18, virtual false, abstract: false, final false
static inline uint32_t XshRr(uint64_t  s) ;

/// @brief Method .ctor, addr 0x47dc6d8, size 0x28, virtual false, abstract: false, final false
...
static inline ::UnityEngine::__ExpressionEvaluator__Operator* New_ctor(::UnityEngine::__ExpressionEvaluator__Op  op, int32_t  precedence, int32_t  inputs, ::UnityEngine::__ExpressionEvaluator__Associativity  associativity) ;
...
/// @brief Method .ctor, addr 0x47dc700, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method <ExpressionToTokens>b__14_0, addr 0x47dc868, size 0x80, virtual false, abstract: false, final false
inline bool _ExpressionToTokens_b__14_0(::StringW  f) ;

/// @brief Method .ctor, addr 0x47dc860, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static __declspec(property(get=getStaticF_s_Operators, put=setStaticF_s_Operators)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::__ExpressionEvaluator__Operator*>*  s_Operators;
...
/// @brief Method Evaluate, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool Evaluate(::StringW  expression, ByRef<T>  value, ByRef<::UnityEngine::__ExpressionEvaluator__Expression*>  delayed) ;

/// @brief Method EvaluateDouble, addr 0x47da9dc, size 0x4d0, virtual false, abstract: false, final false
static inline bool EvaluateDouble(::ArrayW<::StringW,::Array<::StringW>*>  tokens, ByRef<double_t>  value, int32_t  index, int32_t  count) ;

/// @brief Method EvaluateOp, addr 0x47db078, size 0x354, virtual false, abstract: false, final false
...
/// @brief Method ExpressionToTokens, addr 0x47db988, size 0x43c, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> ExpressionToTokens(::StringW  expression, ByRef<bool>  hasVariables) ;

/// @brief Method FixUnaryOperators, addr 0x47dbfb4, size 0x17c, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> FixUnaryOperators(::ArrayW<::StringW,::Array<::StringW>*>  tokens) ;

/// @brief Method InfixToRPN, addr 0x47db434, size 0x400, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> InfixToRPN(::ArrayW<::StringW,::Array<::StringW>*>  tokens) ;

/// @brief Method IsCommand, addr 0x47dafcc, size 0xac, virtual false, abstract: false, final false
static inline bool IsCommand(::StringW  token) ;

/// @brief Method IsDelayedFunction, addr 0x47db834, size 0x6c, virtual false, abstract: false, final false
static inline bool IsDelayedFunction(::StringW  token) ;

/// @brief Method IsOperator, addr 0x47daeac, size 0x80, virtual false, abstract: false, final false
static inline bool IsOperator(::StringW  token) ;

/// @brief Method IsVariable, addr 0x47db3cc, size 0x68, virtual false, abstract: false, final false
static inline bool IsVariable(::StringW  token) ;

/// @brief Method NeedToPop, addr 0x47db8a0, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method PreFormatExpression, addr 0x47dbdc4, size 0x1f0, virtual false, abstract: false, final false
static inline ::StringW PreFormatExpression(::StringW  expression) ;

/// @brief Method TokenToOperator, addr 0x47daf2c, size 0xa0, virtual false, abstract: false, final false
