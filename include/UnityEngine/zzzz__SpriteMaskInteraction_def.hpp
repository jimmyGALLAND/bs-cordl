...
/// @brief Field VisibleInsideMask value: static_cast<int32_t>(0x1)
static ::UnityEngine::SpriteMaskInteraction const VisibleInsideMask;

/// @brief Field VisibleOutsideMask value: static_cast<int32_t>(0x2)
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::SpriteMaskInteraction, 0x4>, "Size mismatch!");
