...
static __declspec(property(get=getStaticF_atlasRequested, put=setStaticF_atlasRequested)) ::System::Action_2<::StringW,::System::Action_1<::UnityW<::UnityEngine::U2D::SpriteAtlas>>*>*  atlasRequested;

/// @brief Method PostRegisteredAtlas, addr 0x482a570, size 0x6c, virtual false, abstract: false, final false
static inline void PostRegisteredAtlas(::UnityEngine::U2D::SpriteAtlas*  spriteAtlas) ;

/// @brief Method Register, addr 0x482a5dc, size 0x3c, virtual false, abstract: false, final false
static inline void Register(::UnityEngine::U2D::SpriteAtlas*  spriteAtlas) ;

/// @brief Method RequestAtlas, addr 0x482a31c, size 0xb4, virtual false, abstract: false, final false
static inline bool RequestAtlas(::StringW  tag) ;

/// @brief Method add_atlasRegistered, addr 0x482a3d0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method remove_atlasRegistered, addr 0x482a4a0, size 0xd0, virtual false, abstract: false, final false
