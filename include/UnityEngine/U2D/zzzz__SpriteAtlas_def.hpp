...
/// @brief Method CanBindTo, addr 0x482a6cc, size 0x44, virtual false, abstract: false, final false
inline bool CanBindTo(::UnityEngine::Sprite*  sprite) ;

/// @brief Method GetSprite, addr 0x482a710, size 0x44, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> GetSprite(::StringW  name) ;

/// @brief Method GetSprites, addr 0x482a754, size 0x44, virtual false, abstract: false, final false
inline int32_t GetSprites(::ArrayW<::UnityEngine::Sprite*,::Array<::UnityEngine::Sprite*>*>  sprites) ;

/// @brief Method GetSprites, addr 0x482a7dc, size 0x54, virtual false, abstract: false, final false
inline int32_t GetSprites(::ArrayW<::UnityEngine::Sprite*,::Array<::UnityEngine::Sprite*>*>  sprites, ::StringW  name) ;

/// @brief Method GetSpritesScripting, addr 0x482a798, size 0x44, virtual false, abstract: false, final false
inline int32_t GetSpritesScripting(::ArrayW<::UnityEngine::Sprite*,::Array<::UnityEngine::Sprite*>*>  sprites) ;

/// @brief Method GetSpritesWithNameScripting, addr 0x482a830, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x482a884, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isVariant, addr 0x482a618, size 0x3c, virtual false, abstract: false, final false
inline bool get_isVariant() ;

/// @brief Method get_spriteCount, addr 0x482a690, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_spriteCount() ;

/// @brief Method get_tag, addr 0x482a654, size 0x3c, virtual false, abstract: false, final false
