...
/// @brief Method get_damper, addr 0x485f074, size 0x8, virtual false, abstract: false, final false
inline float_t get_damper() ;

/// @brief Method get_spring, addr 0x485f064, size 0x8, virtual false, abstract: false, final false
inline float_t get_spring() ;

/// @brief Method set_damper, addr 0x485f07c, size 0x8, virtual false, abstract: false, final false
inline void set_damper(float_t  value) ;

/// @brief Method set_spring, addr 0x485f06c, size 0x8, virtual false, abstract: false, final false
