...
/// @brief Method Equals, addr 0x488acc0, size 0x80, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x488ad40, size 0xa4, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::TextCore::GlyphMetrics  other) ;

/// @brief Method GetHashCode, addr 0x488ac54, size 0x6c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x488ac44, size 0x10, virtual false, abstract: false, final false
inline void _ctor(float_t  width, float_t  height, float_t  bearingX, float_t  bearingY, float_t  advance) ;

/// @brief Method get_height, addr 0x488ac24, size 0x8, virtual false, abstract: false, final false
inline float_t get_height() ;

/// @brief Method get_horizontalAdvance, addr 0x488ac3c, size 0x8, virtual false, abstract: false, final false
inline float_t get_horizontalAdvance() ;

/// @brief Method get_horizontalBearingX, addr 0x488ac2c, size 0x8, virtual false, abstract: false, final false
inline float_t get_horizontalBearingX() ;

/// @brief Method get_horizontalBearingY, addr 0x488ac34, size 0x8, virtual false, abstract: false, final false
inline float_t get_horizontalBearingY() ;

/// @brief Method get_width, addr 0x488ac1c, size 0x8, virtual false, abstract: false, final false
