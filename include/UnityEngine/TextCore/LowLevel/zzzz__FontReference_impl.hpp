...
// Ctor Parameters [CppParam { name: "familyName", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "styleName", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "faceIndex", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "filePath", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }]
