...
/// @brief Method get_xPositionAdjustment, addr 0x488d1f0, size 0x8, virtual false, abstract: false, final false
inline float_t get_xPositionAdjustment() ;

/// @brief Method get_yPositionAdjustment, addr 0x488d1f8, size 0x8, virtual false, abstract: false, final false
