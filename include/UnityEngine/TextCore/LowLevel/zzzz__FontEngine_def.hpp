...
static __declspec(property(get=getStaticF_s_FreeGlyphRects, put=setStaticF_s_FreeGlyphRects)) ::ArrayW<::UnityEngine::TextCore::GlyphRect,::Array<::UnityEngine::TextCore::GlyphRect>*>  s_FreeGlyphRects;

/// @brief Field s_GlyphIndexes_MarshallingArray_A, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_GlyphIndexes_MarshallingArray_A, put=setStaticF_s_GlyphIndexes_MarshallingArray_A)) ::ArrayW<uint32_t,::Array<uint32_t>*>  s_GlyphIndexes_MarshallingArray_A;

/// @brief Field s_GlyphLookupDictionary, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_GlyphLookupDictionary, put=setStaticF_s_GlyphLookupDictionary)) ::System::Collections::Generic::Dictionary_2<uint32_t,::UnityEngine::TextCore::Glyph*>*  s_GlyphLookupDictionary;

/// @brief Field s_GlyphMarshallingStruct_IN, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_GlyphMarshallingStruct_IN, put=setStaticF_s_GlyphMarshallingStruct_IN)) ::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct,::Array<::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct>*>  s_GlyphMarshallingStruct_IN;

/// @brief Field s_GlyphMarshallingStruct_OUT, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_GlyphMarshallingStruct_OUT, put=setStaticF_s_GlyphMarshallingStruct_OUT)) ::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct,::Array<::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct>*>  s_GlyphMarshallingStruct_OUT;
...
static __declspec(property(get=getStaticF_s_PairAdjustmentRecords_MarshallingArray, put=setStaticF_s_PairAdjustmentRecords_MarshallingArray)) ::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord,::Array<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*>  s_PairAdjustmentRecords_MarshallingArray;

/// @brief Field s_UsedGlyphRects, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_UsedGlyphRects, put=setStaticF_s_UsedGlyphRects)) ::ArrayW<::UnityEngine::TextCore::GlyphRect,::Array<::UnityEngine::TextCore::GlyphRect>*>  s_UsedGlyphRects;

/// @brief Method GenericListToMarshallingArray, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void GenericListToMarshallingArray(ByRef<::System::Collections::Generic::List_1<T>*>  srcList, ByRef<::ArrayW<T,::Array<T>*>>  dstArray) ;

/// @brief Method GetFaceInfo, addr 0x488b44c, size 0xa0, virtual false, abstract: false, final false
static inline ::UnityEngine::TextCore::FaceInfo GetFaceInfo() ;

/// @brief Method GetFaceInfo_Internal, addr 0x488b4ec, size 0x3c, virtual false, abstract: false, final false
static inline int32_t GetFaceInfo_Internal(ByRef<::UnityEngine::TextCore::FaceInfo>  faceInfo) ;

/// @brief Method GetGlyphIndex, addr 0x488b528, size 0x3c, virtual false, abstract: false, final false
static inline uint32_t GetGlyphIndex(uint32_t  unicode) ;

/// @brief Method GetGlyphPairAdjustmentRecords, addr 0x488c9a8, size 0x188, virtual false, abstract: false, final false
static inline ::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord,::Array<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*> GetGlyphPairAdjustmentRecords(::System::Collections::Generic::List_1<uint32_t>*  glyphIndexes, ByRef<int32_t>  recordCount) ;

/// @brief Method GetGlyphPairAdjustmentTable, addr 0x488c7d8, size 0x150, virtual false, abstract: false, final false
static inline ::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord,::Array<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*> GetGlyphPairAdjustmentTable(::ArrayW<uint32_t,::Array<uint32_t>*>  glyphIndexes) ;

/// @brief Method GetPairAdjustmentRecordsFromMarshallingArray, addr 0x488c96c, size 0x3c, virtual false, abstract: false, final false
static inline int32_t GetPairAdjustmentRecordsFromMarshallingArray(ByRef<::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord,::Array<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*>>  glyphPairAdjustmentRecords) ;

/// @brief Method InitializeFontEngine, addr 0x488af74, size 0x68, virtual false, abstract: false, final false
static inline ::UnityEngine::TextCore::LowLevel::FontEngineError InitializeFontEngine() ;

/// @brief Method InitializeFontEngine_Internal, addr 0x488afdc, size 0x28, virtual false, abstract: false, final false
static inline int32_t InitializeFontEngine_Internal() ;

/// @brief Method LoadFontFace, addr 0x488b28c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method LoadFontFace, addr 0x488b004, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method LoadFontFace, addr 0x488b0e4, size 0x84, virtual false, abstract: false, final false
static inline ::UnityEngine::TextCore::LowLevel::FontEngineError LoadFontFace(::UnityEngine::Font*  font, int32_t  pointSize) ;

/// @brief Method LoadFontFace, addr 0x488b1ac, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method LoadFontFace_With_Size_And_FaceIndex_Internal, addr 0x488b090, size 0x54, virtual false, abstract: false, final false
static inline int32_t LoadFontFace_With_Size_And_FaceIndex_Internal(::StringW  filePath, int32_t  pointSize, int32_t  faceIndex) ;

/// @brief Method LoadFontFace_With_Size_FromFont_Internal, addr 0x488b168, size 0x44, virtual false, abstract: false, final false
static inline int32_t LoadFontFace_With_Size_FromFont_Internal(::UnityEngine::Font*  font, int32_t  pointSize) ;

/// @brief Method LoadFontFace_With_Size_and_FaceIndex_FromFont_Internal, addr 0x488b238, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method LoadFontFace_With_Size_by_FamilyName_and_StyleName_Internal, addr 0x488b318, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method PopulatePairAdjustmentRecordMarshallingArray_from_KernTable, addr 0x488c928, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method ResetAtlasTexture, addr 0x488cb30, size 0x3c, virtual false, abstract: false, final false
...
template<typename T>
static inline void SetMarshallingArraySize(ByRef<::ArrayW<T,::Array<T>*>>  marshallingArray, int32_t  recordCount) ;

/// @brief Method SetTextureUploadMode, addr 0x488b894, size 0x3c, virtual false, abstract: false, final false
static inline void SetTextureUploadMode(bool  shouldUploadImmediately) ;

/// @brief Method TryAddGlyphToTexture, addr 0x488b8d0, size 0x514, virtual false, abstract: false, final false
...
/// @brief Method TryAddGlyphToTexture_Internal, addr 0x488bde4, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method TryAddGlyphsToTexture, addr 0x488be80, size 0x890, virtual false, abstract: false, final false
...
/// @brief Method TryAddGlyphsToTexture_Internal, addr 0x488c730, size 0xa8, virtual false, abstract: false, final false
static inline bool TryAddGlyphsToTexture_Internal(::ArrayW<uint32_t,::Array<uint32_t>*>  glyphIndex, int32_t  padding, ::UnityEngine::TextCore::LowLevel::GlyphPackingMode  packingMode, ByRef<::ArrayW<::UnityEngine::TextCore::GlyphRect,::Array<::UnityEngine::TextCore::GlyphRect>*>>  freeGlyphRects, ByRef<int32_t>  freeGlyphRectCount, ByRef<::ArrayW<::UnityEngine::TextCore::GlyphRect,::Array<::UnityEngine::TextCore::GlyphRect>*>>  usedGlyphRects, ByRef<int32_t>  usedGlyphRectCount, ::UnityEngine::TextCore::LowLevel::GlyphRenderMode  renderMode, ::UnityEngine::Texture2D*  texture, ByRef<::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct,::Array<::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct>*>>  glyphs, ByRef<int32_t>  glyphCount) ;

/// @brief Method TryGetGlyphWithIndexValue, addr 0x488b6fc, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method TryGetGlyphWithIndexValue_Internal, addr 0x488b840, size 0x54, virtual false, abstract: false, final false
static inline bool TryGetGlyphWithIndexValue_Internal(uint32_t  glyphIndex, ::UnityEngine::TextCore::LowLevel::GlyphLoadFlags  loadFlags, ByRef<::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct>  glyphStruct) ;

/// @brief Method TryGetGlyphWithUnicodeValue, addr 0x488b564, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method TryGetGlyphWithUnicodeValue_Internal, addr 0x488b6a8, size 0x54, virtual false, abstract: false, final false
static inline bool TryGetGlyphWithUnicodeValue_Internal(uint32_t  unicode, ::UnityEngine::TextCore::LowLevel::GlyphLoadFlags  loadFlags, ByRef<::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct>  glyphStruct) ;

/// @brief Method TryGetSystemFontReference, addr 0x488b36c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method TryGetSystemFontReference_Internal, addr 0x488b3f8, size 0x54, virtual false, abstract: false, final false
...
static inline ::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord,::Array<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*> getStaticF_s_PairAdjustmentRecords_MarshallingArray() ;
...
static inline void setStaticF_s_GlyphMarshallingStruct_IN(::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct,::Array<::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct>*>  value) ;

static inline void setStaticF_s_GlyphMarshallingStruct_OUT(::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct,::Array<::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct>*>  value) ;

static inline void setStaticF_s_Glyphs(::ArrayW<::UnityEngine::TextCore::Glyph*,::Array<::UnityEngine::TextCore::Glyph*>*>  value) ;

static inline void setStaticF_s_PairAdjustmentRecords_MarshallingArray(::ArrayW<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord,::Array<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*>  value) ;
