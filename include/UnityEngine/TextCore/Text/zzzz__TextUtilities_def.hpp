...
public:
// Declarations
/// @brief Method GetHashCodeCaseInSensitive, addr 0x48ba7e0, size 0x70, virtual false, abstract: false, final false
static inline int32_t GetHashCodeCaseInSensitive(::StringW  s) ;

/// @brief Method ToUpperFast, addr 0x48bc850, size 0x74, virtual false, abstract: false, final false
static inline char16_t ToUpperFast(char16_t  c) ;

/// @brief Method UintToString, addr 0x48bc8c4, size 0xd8, virtual false, abstract: false, final false
