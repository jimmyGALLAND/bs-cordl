...
/// @brief Field textGenerationSettings, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_textGenerationSettings, put=__cordl_internal_set_textGenerationSettings)) ::UnityEngine::TextCore::Text::TextGenerationSettings*  textGenerationSettings;

 __declspec(property(get=get_textInfo)) ::UnityEngine::TextCore::Text::TextInfo*  textInfo;

/// @brief Method ComputeTextHeight, addr 0x48b9a38, size 0x18, virtual false, abstract: false, final false
inline float_t ComputeTextHeight(::UnityEngine::TextCore::Text::TextGenerationSettings*  tgs) ;

/// @brief Method ComputeTextWidth, addr 0x48b99ac, size 0x18, virtual false, abstract: false, final false
inline float_t ComputeTextWidth(::UnityEngine::TextCore::Text::TextGenerationSettings*  tgs) ;

/// @brief Method DistanceToLine, addr 0x48b90a8, size 0xc8, virtual false, abstract: false, final false
static inline float_t DistanceToLine(::UnityEngine::Vector3  a, ::UnityEngine::Vector3  b, ::UnityEngine::Vector3  point) ;

/// @brief Method FindIntersectingLink, addr 0x48b9170, size 0x2c4, virtual false, abstract: false, final false
inline int32_t FindIntersectingLink(::UnityEngine::Vector3  position, bool  inverseYAxis) ;

/// @brief Method FindNearestCharacterOnLine, addr 0x48b8984, size 0x2c0, virtual false, abstract: false, final false
inline int32_t FindNearestCharacterOnLine(::UnityEngine::Vector2  position, int32_t  line, bool  visibleOnly) ;

/// @brief Method FindNearestLine, addr 0x48b88b4, size 0xd0, virtual false, abstract: false, final false
inline int32_t FindNearestLine(::UnityEngine::Vector2  position) ;

/// @brief Method GetCharacterHeightFromIndex, addr 0x48b95e8, size 0x98, virtual false, abstract: false, final false
inline float_t GetCharacterHeightFromIndex(int32_t  index) ;

/// @brief Method GetCursorIndexFromPosition, addr 0x48b879c, size 0x118, virtual false, abstract: false, final false
inline int32_t GetCursorIndexFromPosition(::UnityEngine::Vector2  position, bool  inverseYAxis) ;

/// @brief Method GetCursorPositionFromStringIndexUsingCharacterHeight, addr 0x48b84c0, size 0x150, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetCursorPositionFromStringIndexUsingCharacterHeight(int32_t  index, bool  inverseYAxis) ;

/// @brief Method GetCursorPositionFromStringIndexUsingLineHeight, addr 0x48b8610, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method GetLineHeight, addr 0x48b94c4, size 0x90, virtual false, abstract: false, final false
inline float_t GetLineHeight(int32_t  lineNumber) ;

/// @brief Method GetLineHeightFromCharacterIndex, addr 0x48b9554, size 0x94, virtual false, abstract: false, final false
inline float_t GetLineHeightFromCharacterIndex(int32_t  index) ;

/// @brief Method GetLineNumber, addr 0x48b9434, size 0x90, virtual false, abstract: false, final false
inline int32_t GetLineNumber(int32_t  index) ;

/// @brief Method IndexOf, addr 0x48b97f8, size 0xe8, virtual false, abstract: false, final false
inline int32_t IndexOf(char16_t  value, int32_t  startIndex) ;

/// @brief Method IsDirty, addr 0x48b8470, size 0x50, virtual false, abstract: false, final false
inline bool IsDirty() ;

/// @brief Method IsElided, addr 0x48b9680, size 0x40, virtual false, abstract: false, final false
inline bool IsElided() ;

/// @brief Method LastIndexOf, addr 0x48b98e0, size 0xcc, virtual false, abstract: false, final false
inline int32_t LastIndexOf(char16_t  value, int32_t  startIndex) ;

/// @brief Method LineDownCharacterPosition, addr 0x48b8c44, size 0x1dc, virtual false, abstract: false, final false
inline int32_t LineDownCharacterPosition(int32_t  originalPos) ;

/// @brief Method LineUpCharacterPosition, addr 0x48b8e20, size 0x1c8, virtual false, abstract: false, final false
inline int32_t LineUpCharacterPosition(int32_t  originalPos) ;

static inline ::UnityEngine::TextCore::Text::TextHandle* New_ctor() ;

/// @brief Method PointIntersectRectangle, addr 0x48b8fe8, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method Substring, addr 0x48b96c0, size 0x138, virtual false, abstract: false, final false
inline ::StringW Substring(int32_t  startIndex, int32_t  length) ;

/// @brief Method Update, addr 0x48b9a50, size 0x6c, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextInfo* Update(::UnityEngine::TextCore::Text::TextGenerationSettings*  tgs) ;

/// @brief Method UpdatePreferredValues, addr 0x48b99c4, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x48b81bc, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_layoutTextInfo, addr 0x48b83b8, size 0xb8, virtual false, abstract: false, final false
static inline ::UnityEngine::TextCore::Text::TextInfo* get_layoutTextInfo() ;

/// @brief Method get_textInfo, addr 0x48b8220, size 0x60, virtual false, abstract: false, final false
