...
public:
// Declarations
/// @brief Method Add, addr 0x48b9ec8, size 0xfc, virtual false, abstract: false, final false
inline uint8_t Add(::UnityEngine::TextCore::Text::FontStyles  style) ;

/// @brief Method Clear, addr 0x48b9ebc, size 0xc, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Remove, addr 0x48b9fc4, size 0x144, virtual false, abstract: false, final false
