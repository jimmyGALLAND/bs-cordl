...
/// @brief Field lineInfo, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_lineInfo, put=__cordl_internal_set_lineInfo)) ::ArrayW<::UnityEngine::TextCore::Text::LineInfo,::Array<::UnityEngine::TextCore::Text::LineInfo>*>  lineInfo;
...
/// @brief Field linkInfo, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_linkInfo, put=__cordl_internal_set_linkInfo)) ::ArrayW<::UnityEngine::TextCore::Text::LinkInfo,::Array<::UnityEngine::TextCore::Text::LinkInfo>*>  linkInfo;
...
/// @brief Field meshInfo, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_meshInfo, put=__cordl_internal_set_meshInfo)) ::ArrayW<::UnityEngine::TextCore::Text::MeshInfo,::Array<::UnityEngine::TextCore::Text::MeshInfo>*>  meshInfo;
...
/// @brief Field pageInfo, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_pageInfo, put=__cordl_internal_set_pageInfo)) ::ArrayW<::UnityEngine::TextCore::Text::PageInfo,::Array<::UnityEngine::TextCore::Text::PageInfo>*>  pageInfo;
...
/// @brief Field textElementInfo, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_textElementInfo, put=__cordl_internal_set_textElementInfo)) ::ArrayW<::UnityEngine::TextCore::Text::TextElementInfo,::Array<::UnityEngine::TextCore::Text::TextElementInfo>*>  textElementInfo;
...
/// @brief Field wordInfo, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_wordInfo, put=__cordl_internal_set_wordInfo)) ::ArrayW<::UnityEngine::TextCore::Text::WordInfo,::Array<::UnityEngine::TextCore::Text::WordInfo>*>  wordInfo;

/// @brief Method Clear, addr 0x48b9b2c, size 0x60, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ClearLineInfo, addr 0x48b9c48, size 0x170, virtual false, abstract: false, final false
inline void ClearLineInfo() ;

/// @brief Method ClearMeshInfo, addr 0x48b9b8c, size 0xbc, virtual false, abstract: false, final false
inline void ClearMeshInfo(bool  updateMesh) ;

/// @brief Method ClearPageInfo, addr 0x48b9db8, size 0x98, virtual false, abstract: false, final false
...
template<typename T>
static inline void Resize(ByRef<::ArrayW<T,::Array<T>*>>  array, int32_t  size) ;

/// @brief Method Resize, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void Resize(ByRef<::ArrayW<T,::Array<T>*>>  array, int32_t  size, bool  isBlockAllocated) ;
...
/// @brief Method .ctor, addr 0x48b8280, size 0x138, virtual false, abstract: false, final false
inline void _ctor() ;
