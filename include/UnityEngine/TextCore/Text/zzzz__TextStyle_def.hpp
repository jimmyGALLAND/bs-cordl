...
/// @brief Method RefreshStyle, addr 0x48bc29c, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x48bc250, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method get_hashCode, addr 0x48b4e90, size 0x8, virtual false, abstract: false, final false
inline int32_t get_hashCode() ;

/// @brief Method get_styleClosingTagArray, addr 0x48b542c, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint32_t,::Array<uint32_t>*> get_styleClosingTagArray() ;

/// @brief Method get_styleOpeningTagArray, addr 0x48b4e98, size 0x8, virtual false, abstract: false, final false
