...
// Type: UnityEngine.TextCore.Text::TextProcessingElementType
...
/// @brief Field TextCharacterElement value: static_cast<int32_t>(0x1)
static ::UnityEngine::TextCore::Text::TextProcessingElementType const TextCharacterElement;

/// @brief Field TextMarkupElement value: static_cast<int32_t>(0x2)
