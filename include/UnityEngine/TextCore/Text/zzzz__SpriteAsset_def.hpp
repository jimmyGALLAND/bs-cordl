...
/// @brief Method <SortCharacterTable>b__38_0, addr 0x489b02c, size 0x18, virtual false, abstract: false, final false
inline uint32_t _SortCharacterTable_b__38_0(::UnityEngine::TextCore::Text::SpriteCharacter*  c) ;

/// @brief Method <SortGlyphTable>b__37_0, addr 0x489b014, size 0x18, virtual false, abstract: false, final false
inline uint32_t _SortGlyphTable_b__37_0(::UnityEngine::TextCore::Text::SpriteGlyph*  item) ;

/// @brief Method .ctor, addr 0x489b00c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Awake, addr 0x489a160, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetSpriteIndexFromHashcode, addr 0x489a16c, size 0x88, virtual false, abstract: false, final false
inline int32_t GetSpriteIndexFromHashcode(int32_t  hashCode) ;

/// @brief Method GetSpriteIndexFromName, addr 0x489a288, size 0x40, virtual false, abstract: false, final false
inline int32_t GetSpriteIndexFromName(::StringW  name) ;

/// @brief Method GetSpriteIndexFromUnicode, addr 0x489a1f4, size 0x94, virtual false, abstract: false, final false
inline int32_t GetSpriteIndexFromUnicode(uint32_t  unicode) ;

static inline ::UnityEngine::TextCore::Text::SpriteAsset* New_ctor() ;

/// @brief Method SearchForSpriteByHashCode, addr 0x489a6dc, size 0x338, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::TextCore::Text::SpriteAsset> SearchForSpriteByHashCode(::UnityEngine::TextCore::Text::SpriteAsset*  spriteAsset, int32_t  hashCode, bool  includeFallbacks, ByRef<int32_t>  spriteIndex, ::UnityEngine::TextCore::Text::TextSettings*  textSettings) ;

/// @brief Method SearchForSpriteByHashCodeInternal, addr 0x489abbc, size 0xb0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::TextCore::Text::SpriteAsset> SearchForSpriteByHashCodeInternal(::UnityEngine::TextCore::Text::SpriteAsset*  spriteAsset, int32_t  hashCode, bool  searchFallbacks, ByRef<int32_t>  spriteIndex) ;

/// @brief Method SearchForSpriteByHashCodeInternal, addr 0x489aa14, size 0x1a8, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::TextCore::Text::SpriteAsset> SearchForSpriteByHashCodeInternal(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::TextCore::Text::SpriteAsset>>*  spriteAssets, int32_t  hashCode, bool  searchFallbacks, ByRef<int32_t>  spriteIndex) ;

/// @brief Method SearchForSpriteByUnicode, addr 0x489a2c8, size 0x1c4, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::TextCore::Text::SpriteAsset> SearchForSpriteByUnicode(::UnityEngine::TextCore::Text::SpriteAsset*  spriteAsset, uint32_t  unicode, bool  includeFallbacks, ByRef<int32_t>  spriteIndex) ;

/// @brief Method SearchForSpriteByUnicodeInternal, addr 0x489a62c, size 0xb0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::TextCore::Text::SpriteAsset> SearchForSpriteByUnicodeInternal(::UnityEngine::TextCore::Text::SpriteAsset*  spriteAsset, uint32_t  unicode, bool  includeFallbacks, ByRef<int32_t>  spriteIndex) ;

/// @brief Method SearchForSpriteByUnicodeInternal, addr 0x489a48c, size 0x1a0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::TextCore::Text::SpriteAsset> SearchForSpriteByUnicodeInternal(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::TextCore::Text::SpriteAsset>>*  spriteAssets, uint32_t  unicode, bool  includeFallbacks, ByRef<int32_t>  spriteIndex) ;

/// @brief Method SortCharacterTable, addr 0x489ad9c, size 0x134, virtual false, abstract: false, final false
inline void SortCharacterTable() ;

/// @brief Method SortGlyphAndCharacterTables, addr 0x489aed0, size 0x18, virtual false, abstract: false, final false
inline void SortGlyphAndCharacterTables() ;

/// @brief Method SortGlyphTable, addr 0x489ac6c, size 0x130, virtual false, abstract: false, final false
inline void SortGlyphTable() ;

/// @brief Method UpdateLookupTables, addr 0x4899c8c, size 0x4b4, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint32_t,::UnityEngine::TextCore::Text::SpriteCharacter*>*> const& __cordl_internal_get_m_SpriteCharacterLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint32_t,::UnityEngine::TextCore::Text::SpriteGlyph*>*> const& __cordl_internal_get_m_SpriteGlyphLookup() const;
...
/// @brief Method .ctor, addr 0x489aee8, size 0xc8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::HashSet_1<int32_t>* getStaticF_k_searchedSpriteAssets() ;

/// @brief Method get_faceInfo, addr 0x4899c24, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::FaceInfo get_faceInfo() ;

/// @brief Method get_spriteCharacterLookupTable, addr 0x4897264, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method get_spriteCharacterTable, addr 0x4899c68, size 0x24, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteCharacter*>* get_spriteCharacterTable() ;

/// @brief Method get_spriteGlyphTable, addr 0x489a150, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteGlyph*>* get_spriteGlyphTable() ;

/// @brief Method get_spriteSheet, addr 0x4899c58, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_faceInfo, addr 0x4899c40, size 0x18, virtual false, abstract: false, final false
inline void set_faceInfo(::UnityEngine::TextCore::FaceInfo  value) ;

/// @brief Method set_spriteCharacterLookupTable, addr 0x489a148, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_spriteCharacterTable, addr 0x489a140, size 0x8, virtual false, abstract: false, final false
inline void set_spriteCharacterTable(::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteCharacter*>*  value) ;

/// @brief Method set_spriteGlyphTable, addr 0x489a158, size 0x8, virtual false, abstract: false, final false
inline void set_spriteGlyphTable(::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteGlyph*>*  value) ;

/// @brief Method set_spriteSheet, addr 0x4899c60, size 0x8, virtual false, abstract: false, final false
