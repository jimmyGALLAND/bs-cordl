...
/// @brief Method Resize, addr 0x48b3d74, size 0x64, virtual false, abstract: false, final false
inline void Resize(int32_t  size) ;

/// @brief Method .ctor, addr 0x48b3dd8, size 0x60, virtual false, abstract: false, final false
inline void _ctor(int32_t  size) ;

/// @brief Method get_Capacity, addr 0x48b3cb8, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_Capacity() ;

/// @brief Method get_Count, addr 0x48b3cd4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Item, addr 0x48b3ce4, size 0x30, virtual false, abstract: false, final false
inline uint32_t get_Item(int32_t  index) ;

/// @brief Method set_Count, addr 0x48b3cdc, size 0x8, virtual false, abstract: false, final false
inline void set_Count(int32_t  value) ;

/// @brief Method set_Item, addr 0x48b3d14, size 0x60, virtual false, abstract: false, final false
