...
public:
// Declarations
/// @brief Method GetLinkId, addr 0x48978e0, size 0x44, virtual false, abstract: false, final false
inline ::StringW GetLinkId() ;

/// @brief Method GetLinkText, addr 0x48977e8, size 0xf8, virtual false, abstract: false, final false
inline ::StringW GetLinkText(::UnityEngine::TextCore::Text::TextInfo*  textInfo) ;

/// @brief Method SetLinkId, addr 0x489770c, size 0xdc, virtual false, abstract: false, final false
...
constexpr LinkInfo(int32_t  hashCode, int32_t  linkIdFirstCharacterIndex, int32_t  linkIdLength, int32_t  linkTextfirstCharacterIndex, int32_t  linkTextLength, ::ArrayW<char16_t,::Array<char16_t>*>  linkId, ::StringW  m_LinkIdString, ::StringW  m_LinkTextString) noexcept;
