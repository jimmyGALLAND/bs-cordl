...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::TextCore::Text::__TextResourceManager__FontAssetRef::*)(int32_t, int32_t, int32_t, ::UnityEngine::TextCore::Text::FontAsset*)>(&::UnityEngine::TextCore::Text::__TextResourceManager__FontAssetRef::_ctor)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x48ba618;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::__TextResourceManager__FontAssetRef>::get(),
                        ".ctor",
...
inline void UnityEngine::TextCore::Text::__TextResourceManager__FontAssetRef::_ctor(int32_t  nameHashCode, int32_t  familyNameHashCode, int32_t  styleNameHashCode, ::UnityEngine::TextCore::Text::FontAsset*  fontAsset)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::__TextResourceManager__FontAssetRef>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters [CppParam { name: "nameHashCode", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "familyNameHashCode", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "styleNameHashCode", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "familyNameAndStyleHashCode", ty: "int64_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "fontAsset", ty: "::UnityW<::UnityEngine::TextCore::Text::FontAsset>", modifiers: "", def_value: Some("nullptr") }]
constexpr ::UnityEngine::TextCore::Text::__TextResourceManager__FontAssetRef::__TextResourceManager__FontAssetRef(int32_t  nameHashCode, int32_t  familyNameHashCode, int32_t  styleNameHashCode, int64_t  familyNameAndStyleHashCode, ::UnityW<::UnityEngine::TextCore::Text::FontAsset>  fontAsset) noexcept  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::TextCore::Text::FontAsset*)>(&::UnityEngine::TextCore::Text::TextResourceManager::AddFontAsset)> {
  ...
  constexpr static std::size_t addrs = 0x48ba108;
...
inline void UnityEngine::TextCore::Text::TextResourceManager::setStaticF_s_FontAssetReferences(::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::__TextResourceManager__FontAssetRef>*  value)  {
::cordl_internals::setStaticField<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::__TextResourceManager__FontAssetRef>*, "s_FontAssetReferences", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::TextResourceManager*>::get>(std::forward<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::__TextResourceManager__FontAssetRef>*>(value));
}
inline ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::__TextResourceManager__FontAssetRef>* UnityEngine::TextCore::Text::TextResourceManager::getStaticF_s_FontAssetReferences()  {
return ::cordl_internals::getStaticField<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::__TextResourceManager__FontAssetRef>*, "s_FontAssetReferences", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::TextResourceManager*>::get>();
}
