...
/// @brief Method GetStyle, addr 0x48b5ff4, size 0x88, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextStyle* GetStyle(int32_t  hashCode) ;

/// @brief Method GetStyle, addr 0x48bc738, size 0x94, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextStyle* GetStyle(::StringW  name) ;

/// @brief Method LoadStyleDictionaryInternal, addr 0x48bc45c, size 0x2dc, virtual false, abstract: false, final false
inline void LoadStyleDictionaryInternal() ;

static inline ::UnityEngine::TextCore::Text::TextStyleSheet* New_ctor() ;

/// @brief Method RefreshStyles, addr 0x48bc7cc, size 0x4, virtual false, abstract: false, final false
inline void RefreshStyles() ;

/// @brief Method Reset, addr 0x48bc458, size 0x4, virtual false, abstract: false, final false
inline void Reset() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::TextStyle*>*> const& __cordl_internal_get_m_StyleLookupDictionary() const;
...
/// @brief Method .ctor, addr 0x48bc7d0, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_styles, addr 0x48bc450, size 0x8, virtual false, abstract: false, final false
