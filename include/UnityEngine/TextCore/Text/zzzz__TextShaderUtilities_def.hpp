...
/// @brief Method GetShaderPropertyIDs, addr 0x48bb788, size 0xac8, virtual false, abstract: false, final false
...
/// @brief Method get_ShaderRef_MobileBitmap, addr 0x48bb424, size 0x1e8, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Shader> get_ShaderRef_MobileBitmap() ;

/// @brief Method get_ShaderRef_MobileSDF, addr 0x48bb23c, size 0x1e8, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::TextCore::Text::TextShaderUtilities, 0x10>, "Size mismatch!");
