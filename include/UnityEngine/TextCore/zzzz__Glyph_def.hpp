...
/// @brief Method .ctor, addr 0x488ae50, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x488ae78, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct  glyphStruct) ;

/// @brief Method .ctor, addr 0x488af04, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_atlasIndex, addr 0x488ae40, size 0x8, virtual false, abstract: false, final false
inline int32_t get_atlasIndex() ;

/// @brief Method get_glyphRect, addr 0x488ae1c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::GlyphRect get_glyphRect() ;

/// @brief Method get_index, addr 0x488ade4, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_index() ;

/// @brief Method get_metrics, addr 0x488adf4, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::GlyphMetrics get_metrics() ;

/// @brief Method get_scale, addr 0x488ae30, size 0x8, virtual false, abstract: false, final false
inline float_t get_scale() ;

/// @brief Method set_atlasIndex, addr 0x488ae48, size 0x8, virtual false, abstract: false, final false
inline void set_atlasIndex(int32_t  value) ;

/// @brief Method set_glyphRect, addr 0x488ae28, size 0x8, virtual false, abstract: false, final false
inline void set_glyphRect(::UnityEngine::TextCore::GlyphRect  value) ;

/// @brief Method set_index, addr 0x488adec, size 0x8, virtual false, abstract: false, final false
inline void set_index(uint32_t  value) ;

/// @brief Method set_metrics, addr 0x488ae08, size 0x14, virtual false, abstract: false, final false
inline void set_metrics(::UnityEngine::TextCore::GlyphMetrics  value) ;

/// @brief Method set_scale, addr 0x488ae38, size 0x8, virtual false, abstract: false, final false
