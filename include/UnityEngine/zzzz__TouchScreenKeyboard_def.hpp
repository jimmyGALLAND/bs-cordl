...
/// @brief Method Destroy, addr 0x4821448, size 0xa4, virtual false, abstract: false, final false
inline void Destroy() ;

/// @brief Method Finalize, addr 0x48214ec, size 0x94, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetSelection, addr 0x4821c7c, size 0x44, virtual false, abstract: false, final false
static inline void GetSelection(ByRef<int32_t>  start, ByRef<int32_t>  length) ;

/// @brief Method Internal_Destroy, addr 0x482140c, size 0x3c, virtual false, abstract: false, final false
static inline void Internal_Destroy(::System::IntPtr  ptr) ;

/// @brief Method IsInPlaceEditingAllowed, addr 0x4821890, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method Open, addr 0x4821970, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Open, addr 0x48218b8, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method SetSelection, addr 0x4821db4, size 0x44, virtual false, abstract: false, final false
static inline void SetSelection(int32_t  start, int32_t  length) ;

/// @brief Method TouchScreenKeyboard_InternalConstructorHelper, addr 0x48216dc, size 0x54, virtual false, abstract: false, final false
static inline ::System::IntPtr TouchScreenKeyboard_InternalConstructorHelper(ByRef<::UnityEngine::TouchScreenKeyboard_InternalConstructorHelperArguments>  arguments, ::StringW  text, ::StringW  textPlaceholder) ;
...
/// @brief Method .ctor, addr 0x4821580, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method get_active, addr 0x4821ab8, size 0x3c, virtual false, abstract: false, final false
inline bool get_active() ;

/// @brief Method get_canGetSelection, addr 0x4821bb8, size 0x3c, virtual false, abstract: false, final false
inline bool get_canGetSelection() ;

/// @brief Method get_canSetSelection, addr 0x4821bf4, size 0x3c, virtual false, abstract: false, final false
inline bool get_canSetSelection() ;

/// @brief Method get_disableInPlaceEditing, addr 0x48217dc, size 0x48, virtual false, abstract: false, final false
static inline bool get_disableInPlaceEditing() ;

/// @brief Method get_isInPlaceEditingAllowed, addr 0x4821824, size 0x6c, virtual false, abstract: false, final false
static inline bool get_isInPlaceEditingAllowed() ;

/// @brief Method get_isSupported, addr 0x4821730, size 0xac, virtual false, abstract: false, final false
static inline bool get_isSupported() ;

/// @brief Method get_selection, addr 0x4821c30, size 0x4c, virtual false, abstract: false, final false
inline ::UnityEngine::RangeInt get_selection() ;

/// @brief Method get_status, addr 0x4821b38, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::__TouchScreenKeyboard__Status get_status() ;

/// @brief Method get_text, addr 0x48219fc, size 0x3c, virtual false, abstract: false, final false
inline ::StringW get_text() ;

static inline void setStaticF__disableInPlaceEditing_k__BackingField(bool  value) ;

/// @brief Method set_active, addr 0x4821af4, size 0x44, virtual false, abstract: false, final false
inline void set_active(bool  value) ;

/// @brief Method set_characterLimit, addr 0x4821b74, size 0x44, virtual false, abstract: false, final false
inline void set_characterLimit(int32_t  value) ;

/// @brief Method set_hideInput, addr 0x4821a7c, size 0x3c, virtual false, abstract: false, final false
static inline void set_hideInput(bool  value) ;

/// @brief Method set_selection, addr 0x4821cc0, size 0xf4, virtual false, abstract: false, final false
inline void set_selection(::UnityEngine::RangeInt  value) ;

/// @brief Method set_text, addr 0x4821a38, size 0x44, virtual false, abstract: false, final false
