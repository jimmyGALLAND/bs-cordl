...
/// @brief Method .ctor, addr 0x47cfb90, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ApplicationMemoryUsage  usage) ;

/// @brief Method set_memoryUsage, addr 0x47d138c, size 0x8, virtual false, abstract: false, final false
