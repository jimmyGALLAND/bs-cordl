...
/// @brief Method ExtractArrayFromList, addr 0x481bea4, size 0x3c, virtual false, abstract: false, final false
...
template<typename T>
static inline ::ArrayW<T,::Array<T>*> ExtractArrayFromListT(::System::Collections::Generic::List_1<T>*  list) ;

/// @brief Method Internal_ResizeList, addr 0x481be60, size 0x44, virtual false, abstract: false, final false
...
template<typename T>
static inline void ResizeList(::System::Collections::Generic::List_1<T>*  list, int32_t  size) ;

/// @brief Method SafeLength, addr 0x481be50, size 0x10, virtual false, abstract: false, final false
