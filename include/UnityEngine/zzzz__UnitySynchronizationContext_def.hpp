...
public:
// Declarations
/// @brief Method Invoke, addr 0x481ffa8, size 0xac, virtual false, abstract: false, final false
inline void Invoke() ;

/// @brief Method .ctor, addr 0x481fbdc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field m_AsyncWorkQueue, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AsyncWorkQueue, put=__cordl_internal_set_m_AsyncWorkQueue)) ::System::Collections::Generic::List_1<::UnityEngine::__UnitySynchronizationContext__WorkRequest>*  m_AsyncWorkQueue;

/// @brief Field m_CurrentFrameWork, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CurrentFrameWork, put=__cordl_internal_set_m_CurrentFrameWork)) ::System::Collections::Generic::List_1<::UnityEngine::__UnitySynchronizationContext__WorkRequest>*  m_CurrentFrameWork;
...
/// @brief Method CreateCopy, addr 0x481fd64, size 0x64, virtual true, abstract: false, final false
inline ::System::Threading::SynchronizationContext* CreateCopy() ;

/// @brief Method Exec, addr 0x481fdc8, size 0x1e0, virtual false, abstract: false, final false
inline void Exec() ;

/// @brief Method ExecutePendingTasks, addr 0x4820184, size 0xec, virtual false, abstract: false, final false
static inline bool ExecutePendingTasks(int64_t  millisecondsTimeout) ;

/// @brief Method ExecuteTasks, addr 0x482012c, size 0x58, virtual false, abstract: false, final false
static inline void ExecuteTasks() ;

/// @brief Method HasPendingTasks, addr 0x4820054, size 0x60, virtual false, abstract: false, final false
inline bool HasPendingTasks() ;

/// @brief Method InitializeSynchronizationContext, addr 0x48200b4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method OperationCompleted, addr 0x481fbf4, size 0xc, virtual true, abstract: false, final false
inline void OperationCompleted() ;

/// @brief Method OperationStarted, addr 0x481fbe8, size 0xc, virtual true, abstract: false, final false
inline void OperationStarted() ;

/// @brief Method Post, addr 0x481fc00, size 0x164, virtual true, abstract: false, final false
inline void Post(::System::Threading::SendOrPostCallback*  callback, ::System::Object*  state) ;

/// @brief Method Send, addr 0x481f8c0, size 0x31c, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::__UnitySynchronizationContext__WorkRequest>*> const& __cordl_internal_get_m_AsyncWorkQueue() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::__UnitySynchronizationContext__WorkRequest>*> const& __cordl_internal_get_m_CurrentFrameWork() const;
...
/// @brief Method .ctor, addr 0x481f774, size 0xac, virtual false, abstract: false, final false
inline void _ctor(int32_t  mainThreadID) ;

/// @brief Method .ctor, addr 0x481f820, size 0xa0, virtual false, abstract: false, final false
