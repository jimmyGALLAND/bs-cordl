...
/// @brief Method get_force, addr 0x485f0ec, size 0x8, virtual false, abstract: false, final false
inline float_t get_force() ;

/// @brief Method get_freeSpin, addr 0x485f0fc, size 0x10, virtual false, abstract: false, final false
inline bool get_freeSpin() ;

/// @brief Method get_targetVelocity, addr 0x485f0dc, size 0x8, virtual false, abstract: false, final false
inline float_t get_targetVelocity() ;

/// @brief Method set_force, addr 0x485f0f4, size 0x8, virtual false, abstract: false, final false
inline void set_force(float_t  value) ;

/// @brief Method set_freeSpin, addr 0x485f10c, size 0xc, virtual false, abstract: false, final false
inline void set_freeSpin(bool  value) ;

/// @brief Method set_targetVelocity, addr 0x485f0e4, size 0x8, virtual false, abstract: false, final false
