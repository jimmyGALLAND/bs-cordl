...
/// @brief Method GetPoint, addr 0x47dec14, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetPoint(float_t  distance) ;

/// @brief Method ToString, addr 0x47dec28, size 0x10, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x47dec38, size 0x188, virtual true, abstract: false, final true
inline ::StringW ToString(::StringW  format, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method .ctor, addr 0x47deb3c, size 0xc8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Vector2  origin, ::UnityEngine::Vector2  direction) ;

/// @brief Method get_direction, addr 0x47dec0c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_direction() ;

/// @brief Method get_origin, addr 0x47dec04, size 0x8, virtual false, abstract: false, final false
