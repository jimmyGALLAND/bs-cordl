...
/// @brief Method ValidateAsset, addr 0x444b2d4, size 0x8, virtual true, abstract: false, final false
inline bool ValidateAsset(::UnityEngine::Object*  obj) ;

/// @brief Method ValidateAsset, addr 0x444b2dc, size 0x8, virtual true, abstract: false, final false
inline bool ValidateAsset(::StringW  path) ;

/// @brief Method .ctor, addr 0x444b2e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
