...
/// @brief Method Equals, addr 0x47fdd34, size 0x78, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method Equals, addr 0x47fddac, size 0x5c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::BoneWeight1  other) ;

/// @brief Method GetHashCode, addr 0x47fde08, size 0x48, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_boneIndex, addr 0x47fdd2c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_boneIndex() ;

/// @brief Method get_weight, addr 0x47fdd24, size 0x8, virtual false, abstract: false, final false
