...
public:
// Declarations
/// @brief Method CellToLocal, addr 0x48409e0, size 0x68, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 CellToLocal(::UnityEngine::Vector3Int  cellPosition) ;

/// @brief Method CellToLocal_Injected, addr 0x4840a48, size 0x54, virtual false, abstract: false, final false
inline void CellToLocal_Injected(ByRef<::UnityEngine::Vector3Int>  cellPosition, ByRef<::UnityEngine::Vector3>  ret) ;

/// @brief Method DoNothing, addr 0x4840a9c, size 0x4, virtual false, abstract: false, final false
inline void DoNothing() ;

static inline ::UnityEngine::GridLayout* New_ctor() ;

/// @brief Method .ctor, addr 0x48409d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
