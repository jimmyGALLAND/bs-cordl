...
/// @brief Method get_firstVertex, addr 0x47fa47c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_firstVertex() ;

/// @brief Method get_vertexCount, addr 0x47fa48c, size 0x8, virtual false, abstract: false, final false
