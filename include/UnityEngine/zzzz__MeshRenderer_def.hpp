...
/// @brief Method DontStripMeshRenderer, addr 0x47f3ee4, size 0x4, virtual false, abstract: false, final false
inline void DontStripMeshRenderer() ;

static inline ::UnityEngine::MeshRenderer* New_ctor() ;

/// @brief Method .ctor, addr 0x47f4024, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_additionalVertexStreams, addr 0x47f3ee8, size 0x3c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> get_additionalVertexStreams() ;

/// @brief Method get_enlightenVertexStream, addr 0x47f3f68, size 0x3c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> get_enlightenVertexStream() ;

/// @brief Method get_subMeshStartIndex, addr 0x47f3fe8, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_subMeshStartIndex() ;

/// @brief Method set_additionalVertexStreams, addr 0x47f3f24, size 0x44, virtual false, abstract: false, final false
inline void set_additionalVertexStreams(::UnityEngine::Mesh*  value) ;

/// @brief Method set_enlightenVertexStream, addr 0x47f3fa4, size 0x44, virtual false, abstract: false, final false
