...
// Ctor Parameters [CppParam { name: "m_BoneName", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "m_HumanName", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "limit", ty: "::UnityEngine::HumanLimit", modifiers: "", def_value: Some("{}") }]
