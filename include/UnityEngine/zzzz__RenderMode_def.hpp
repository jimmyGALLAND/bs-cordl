...
/// @brief Field ScreenSpaceCamera value: static_cast<int32_t>(0x1)
static ::UnityEngine::RenderMode const ScreenSpaceCamera;

/// @brief Field ScreenSpaceOverlay value: static_cast<int32_t>(0x0)
static ::UnityEngine::RenderMode const ScreenSpaceOverlay;

/// @brief Field WorldSpace value: static_cast<int32_t>(0x2)
