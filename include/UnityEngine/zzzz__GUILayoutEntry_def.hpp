...
/// @brief Method ApplyOptions, addr 0x484c1e8, size 0x2d4, virtual true, abstract: false, final false
inline void ApplyOptions(::ArrayW<::UnityEngine::GUILayoutOption*,::Array<::UnityEngine::GUILayoutOption*>*>  options) ;

/// @brief Method ApplyStyleSettings, addr 0x484c0ec, size 0xfc, virtual true, abstract: false, final false
inline void ApplyStyleSettings(::UnityEngine::GUIStyle*  style) ;

/// @brief Method CalcHeight, addr 0x484c0d0, size 0x4, virtual true, abstract: false, final false
inline void CalcHeight() ;

/// @brief Method CalcWidth, addr 0x484c0cc, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method SetHorizontal, addr 0x484c0d4, size 0xc, virtual true, abstract: false, final false
inline void SetHorizontal(float_t  x, float_t  width) ;

/// @brief Method SetVertical, addr 0x484c0e0, size 0xc, virtual true, abstract: false, final false
inline void SetVertical(float_t  y, float_t  height) ;

/// @brief Method ToString, addr 0x484c4bc, size 0x4a0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x484bff8, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method get_marginBottom, addr 0x484bf5c, size 0x24, virtual true, abstract: false, final false
inline int32_t get_marginBottom() ;

/// @brief Method get_marginHorizontal, addr 0x484bf80, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_marginHorizontal() ;

/// @brief Method get_marginLeft, addr 0x484bef0, size 0x24, virtual true, abstract: false, final false
inline int32_t get_marginLeft() ;

/// @brief Method get_marginRight, addr 0x484bf14, size 0x24, virtual true, abstract: false, final false
inline int32_t get_marginRight() ;

/// @brief Method get_marginTop, addr 0x484bf38, size 0x24, virtual true, abstract: false, final false
inline int32_t get_marginTop() ;

/// @brief Method get_marginVertical, addr 0x484bfbc, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_marginVertical() ;

/// @brief Method get_style, addr 0x484bee8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_style, addr 0x4847658, size 0x10, virtual false, abstract: false, final false
