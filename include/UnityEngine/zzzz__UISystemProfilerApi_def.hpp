...
/// @brief Method AddMarker, addr 0x4a1704c, size 0x44, virtual false, abstract: false, final false
static inline void AddMarker(::StringW  name, ::UnityEngine::Object*  obj) ;

/// @brief Method BeginSample, addr 0x4a16fd4, size 0x3c, virtual false, abstract: false, final false
static inline void BeginSample(::UnityEngine::__UISystemProfilerApi__SampleType  type) ;

/// @brief Method EndSample, addr 0x4a17010, size 0x3c, virtual false, abstract: false, final false
