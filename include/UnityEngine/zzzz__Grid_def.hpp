...
/// @brief Method .ctor, addr 0x48409d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_cellSize, addr 0x4840930, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_cellSize() ;

/// @brief Method get_cellSize_Injected, addr 0x484098c, size 0x44, virtual false, abstract: false, final false
