...
/// @brief Method .ctor, addr 0x47c17f4, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_animationClips, addr 0x47c2624, size 0x3c, virtual false, abstract: false, final false
