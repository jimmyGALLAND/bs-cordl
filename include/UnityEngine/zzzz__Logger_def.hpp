...
/// @brief Method GetString, addr 0x4808e98, size 0x120, virtual false, abstract: false, final false
static inline ::StringW GetString(::System::Object*  message) ;

/// @brief Method IsLogTypeAllowed, addr 0x4808e60, size 0x38, virtual true, abstract: false, final true
inline bool IsLogTypeAllowed(::UnityEngine::LogType  logType) ;

/// @brief Method Log, addr 0x4808fb8, size 0x178, virtual true, abstract: false, final true
inline void Log(::UnityEngine::LogType  logType, ::System::Object*  message) ;

/// @brief Method Log, addr 0x4809130, size 0x17c, virtual true, abstract: false, final true
inline void Log(::UnityEngine::LogType  logType, ::System::Object*  message, ::UnityEngine::Object*  context) ;

/// @brief Method LogError, addr 0x48092ac, size 0x190, virtual true, abstract: false, final true
inline void LogError(::StringW  tag, ::System::Object*  message) ;

/// @brief Method LogException, addr 0x480943c, size 0xd4, virtual true, abstract: false, final true
inline void LogException(::System::Exception*  exception, ::UnityEngine::Object*  context) ;

/// @brief Method LogFormat, addr 0x480960c, size 0x10c, virtual true, abstract: false, final true
...
/// @brief Method LogFormat, addr 0x4809510, size 0xfc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x4808df4, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ILogHandler*  logHandler) ;

/// @brief Method get_filterLogType, addr 0x4808e50, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::LogType get_filterLogType() ;

/// @brief Method get_logEnabled, addr 0x4808e3c, size 0x8, virtual true, abstract: false, final true
inline bool get_logEnabled() ;

/// @brief Method get_logHandler, addr 0x4808e2c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_filterLogType, addr 0x4808e58, size 0x8, virtual true, abstract: false, final true
inline void set_filterLogType(::UnityEngine::LogType  value) ;

/// @brief Method set_logEnabled, addr 0x4808e44, size 0xc, virtual true, abstract: false, final true
inline void set_logEnabled(bool  value) ;

/// @brief Method set_logHandler, addr 0x4808e34, size 0x8, virtual true, abstract: false, final true
