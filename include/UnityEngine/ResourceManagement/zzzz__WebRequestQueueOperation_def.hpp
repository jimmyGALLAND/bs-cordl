...
/// @brief Method Complete, addr 0x46ff618, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x46ff5f0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Networking::UnityWebRequest*  request) ;

/// @brief Method get_IsDone, addr 0x46ff5c0, size 0x20, virtual false, abstract: false, final false
inline bool get_IsDone() ;

/// @brief Method get_WebRequest, addr 0x46ff5e0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Networking::UnityWebRequest* get_WebRequest() ;

/// @brief Method set_WebRequest, addr 0x46ff5e8, size 0x8, virtual false, abstract: false, final false
