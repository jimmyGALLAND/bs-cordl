...
/// @brief Field m_Handles, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Handles, put=__cordl_internal_set_m_Handles)) ::System::Collections::Generic::HashSet_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*  m_Handles;
...
/// @brief Method Equals, addr 0x4705a1c, size 0x64, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x4705a80, size 0x7c, virtual false, abstract: false, final false
inline bool Equals(::UnityEngine::ResourceManagement::Util::AsyncOpHandlesCacheKey*  other) ;

/// @brief Method Equals, addr 0x4705afc, size 0x64, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::ResourceManagement::Util::IOperationCacheKey*  other) ;

/// @brief Method GetHashCode, addr 0x47059fc, size 0x20, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*> const& __cordl_internal_get_m_Handles() const;
...
/// @brief Method .ctor, addr 0x46fd648, size 0x88, virtual false, abstract: false, final false
