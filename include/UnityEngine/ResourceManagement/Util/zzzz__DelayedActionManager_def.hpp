...
/// @brief Method Invoke, addr 0x4704888, size 0x17c, virtual false, abstract: false, final false
inline void Invoke() ;

/// @brief Method ToString, addr 0x4704c84, size 0x338, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x4704268, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_InvocationTime, addr 0x4704c74, size 0x8, virtual false, abstract: false, final false
inline float_t get_InvocationTime() ;

static inline void setStaticF_s_Id(int32_t  value) ;

/// @brief Method set_InvocationTime, addr 0x4704c7c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field m_Actions, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Actions, put=__cordl_internal_set_m_Actions)) ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*>*>  m_Actions;
...
/// @brief Field m_DelayedActions, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DelayedActions, put=__cordl_internal_set_m_DelayedActions)) ::System::Collections::Generic::LinkedList_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*  m_DelayedActions;
...
/// @brief Field m_NodeCache, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_NodeCache, put=__cordl_internal_set_m_NodeCache)) ::System::Collections::Generic::Stack_1<::System::Collections::Generic::LinkedListNode_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*>*  m_NodeCache;

/// @brief Method AddAction, addr 0x4703f84, size 0x74, virtual false, abstract: false, final false
static inline void AddAction(::System::Delegate*  action, float_t  delay, ::ArrayW<::System::Object*,::Array<::System::Object*>*>  parameters) ;

/// @brief Method AddActionInternal, addr 0x4703ff8, size 0x270, virtual false, abstract: false, final false
inline void AddActionInternal(::System::Delegate*  action, float_t  delay, ::ArrayW<::System::Object*,::Array<::System::Object*>*>  parameters) ;

/// @brief Method Clear, addr 0x4703f04, size 0x74, virtual false, abstract: false, final false
static inline void Clear() ;

/// @brief Method DestroyWhenComplete, addr 0x4703f78, size 0xc, virtual false, abstract: false, final false
inline void DestroyWhenComplete() ;

/// @brief Method GetNode, addr 0x4703e10, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method InternalLateUpdate, addr 0x4704564, size 0x308, virtual false, abstract: false, final false
inline void InternalLateUpdate(float_t  t) ;

/// @brief Method LateUpdate, addr 0x470486c, size 0x1c, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::UnityEngine::ResourceManagement::Util::DelayedActionManager* New_ctor() ;

/// @brief Method OnApplicationQuit, addr 0x4704a04, size 0xb4, virtual false, abstract: false, final false
inline void OnApplicationQuit() ;

/// @brief Method Wait, addr 0x4704404, size 0x160, virtual false, abstract: false, final false
static inline bool Wait(float_t  timeout, float_t  timeAdvanceAmount) ;

constexpr ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*>*> const& __cordl_internal_get_m_Actions() const;

constexpr ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*>*>& __cordl_internal_get_m_Actions() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::LinkedList_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*> const& __cordl_internal_get_m_DelayedActions() const;
...
constexpr ::System::Collections::Generic::Stack_1<::System::Collections::Generic::LinkedListNode_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*>*& __cordl_internal_get_m_NodeCache() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Stack_1<::System::Collections::Generic::LinkedListNode_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*>*> const& __cordl_internal_get_m_NodeCache() const;

constexpr void __cordl_internal_set_m_Actions(::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*>*>  value) ;
...
constexpr void __cordl_internal_set_m_NodeCache(::System::Collections::Generic::Stack_1<::System::Collections::Generic::LinkedListNode_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*>*  value) ;

/// @brief Method .ctor, addr 0x4704ab8, size 0x1bc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsActive, addr 0x47042e8, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Field m_Actions, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::__DelayedActionManager__DelegateInfo>*>*>  ___m_Actions;
