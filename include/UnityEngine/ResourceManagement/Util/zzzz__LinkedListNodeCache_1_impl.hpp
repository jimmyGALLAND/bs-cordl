...
template<typename T>
constexpr ::System::Collections::Generic::LinkedList_1<T>*& UnityEngine::ResourceManagement::Util::LinkedListNodeCache_1<T>::__cordl_internal_get_m_NodeCache()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_NodeCache;
}
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::LinkedList_1<T>*> const& UnityEngine::ResourceManagement::Util::LinkedListNodeCache_1<T>::__cordl_internal_get_m_NodeCache() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_NodeCache;
}
template<typename T>
constexpr void UnityEngine::ResourceManagement::Util::LinkedListNodeCache_1<T>::__cordl_internal_set_m_NodeCache(::System::Collections::Generic::LinkedList_1<T>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
