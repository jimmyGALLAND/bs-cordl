...
constexpr ::System::IEquatable_1<::UnityEngine::ResourceManagement::Util::__LRUCache_2__Entry<TKey,TValue>>* i___System__IEquatable_1___UnityEngine__ResourceManagement__Util____LRUCache_2__Entry_TKey_TValue__() ;

// Ctor Parameters []
// @brief default ctor
constexpr __LRUCache_2__Entry() ;

// Ctor Parameters [CppParam { name: "lruNode", ty: "::System::Collections::Generic::LinkedListNode_1<TKey>*", modifiers: "", def_value: None }, CppParam { name: "Value", ty: "TValue", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "entryLimit", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "cache", ty: "::System::Collections::Generic::Dictionary_2<TKey,::UnityEngine::ResourceManagement::Util::__LRUCache_2__Entry<TKey,TValue>>*", modifiers: "", def_value: None }, CppParam { name: "lru", ty: "::System::Collections::Generic::LinkedList_1<TKey>*", modifiers: "", def_value: None }]
constexpr LRUCache_2(int32_t  entryLimit, ::System::Collections::Generic::Dictionary_2<TKey,::UnityEngine::ResourceManagement::Util::__LRUCache_2__Entry<TKey,TValue>>*  cache, ::System::Collections::Generic::LinkedList_1<TKey>*  lru) noexcept;
