...
/// @brief Method PlatformUsesMultiThreading, addr 0x4705b60, size 0xc, virtual false, abstract: false, final false
static inline bool PlatformUsesMultiThreading(::UnityEngine::RuntimePlatform  platform) ;

/// @brief Method .ctor, addr 0x4705b6c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
