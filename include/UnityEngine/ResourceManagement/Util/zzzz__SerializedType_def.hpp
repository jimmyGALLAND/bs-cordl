...
/// @brief Method ToString, addr 0x4705fc0, size 0xb0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_AssemblyName, addr 0x4705fb0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_AssemblyName() ;

/// @brief Method get_ClassName, addr 0x4705fb8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ClassName() ;

/// @brief Method get_Value, addr 0x4706070, size 0x1f4, virtual false, abstract: false, final false
inline ::System::Type* get_Value() ;

/// @brief Method get_ValueChanged, addr 0x4706324, size 0x8, virtual false, abstract: false, final false
inline bool get_ValueChanged() ;

/// @brief Method set_Value, addr 0x4706264, size 0xc0, virtual false, abstract: false, final false
inline void set_Value(::System::Type*  value) ;

/// @brief Method set_ValueChanged, addr 0x470632c, size 0xc, virtual false, abstract: false, final false
