...
/// @brief Field <Result>k__BackingField, offset 0x20, size 0x4 
 __declspec(property(get=__cordl_internal_get__Result_k__BackingField, put=__cordl_internal_set__Result_k__BackingField)) ::UnityEngine::Networking::__UnityWebRequest__Result  _Result_k__BackingField;
...
/// @brief Method ShouldRetryDownloadError, addr 0x47070c4, size 0x2f8, virtual false, abstract: false, final false
inline bool ShouldRetryDownloadError() ;

/// @brief Method ToString, addr 0x4706f14, size 0x180, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4706e0c, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Networking::UnityWebRequest*  request) ;

/// @brief Method get_Error, addr 0x4707094, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Error() ;

/// @brief Method get_Method, addr 0x47070b4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Method() ;

/// @brief Method get_ResponseCode, addr 0x47070a4, size 0x8, virtual false, abstract: false, final false
inline int64_t get_ResponseCode() ;

/// @brief Method get_Result, addr 0x47070ac, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Networking::__UnityWebRequest__Result get_Result() ;

/// @brief Method get_Url, addr 0x47070bc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Url() ;

/// @brief Method set_Error, addr 0x470709c, size 0x8, virtual false, abstract: false, final false
