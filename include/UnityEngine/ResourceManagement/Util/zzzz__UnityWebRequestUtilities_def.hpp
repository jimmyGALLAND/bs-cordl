...
public:
// Declarations
/// @brief Method IsAssetBundleDownloaded, addr 0x46fff00, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method RequestHasErrors, addr 0x4706ce4, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4706f0c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
