...
static __declspec(property(get=getStaticF_s_ActiveRequests, put=setStaticF_s_ActiveRequests)) ::System::Collections::Generic::List_1<::UnityEngine::Networking::UnityWebRequestAsyncOperation*>*  s_ActiveRequests;
...
static __declspec(property(get=getStaticF_s_QueuedOperations, put=setStaticF_s_QueuedOperations)) ::System::Collections::Generic::Queue_1<::UnityEngine::ResourceManagement::WebRequestQueueOperation*>*  s_QueuedOperations;

/// @brief Method BeginWebRequest, addr 0x46ff800, size 0x28c, virtual false, abstract: false, final false
static inline void BeginWebRequest(::UnityEngine::ResourceManagement::WebRequestQueueOperation*  queueOperation) ;

/// @brief Method DequeueRequest, addr 0x47000ac, size 0xb8, virtual false, abstract: false, final false
static inline void DequeueRequest(::UnityEngine::Networking::UnityWebRequestAsyncOperation*  operation) ;

/// @brief Method OnWebAsyncOpComplete, addr 0x4700164, size 0xa4, virtual false, abstract: false, final false
static inline void OnWebAsyncOpComplete(::UnityEngine::AsyncOperation*  operation) ;

/// @brief Method OnWebAsyncOpComplete, addr 0x46fffa4, size 0x108, virtual false, abstract: false, final false
static inline void OnWebAsyncOpComplete(::UnityEngine::Networking::UnityWebRequestAsyncOperation*  operation) ;

/// @brief Method QueueRequest, addr 0x46ff700, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method SetMaxConcurrentRequests, addr 0x46ff640, size 0xc0, virtual false, abstract: false, final false
static inline void SetMaxConcurrentRequests(int32_t  maxRequests) ;

/// @brief Method WaitForRequestToBeActive, addr 0x46ffa8c, size 0x474, virtual false, abstract: false, final false
