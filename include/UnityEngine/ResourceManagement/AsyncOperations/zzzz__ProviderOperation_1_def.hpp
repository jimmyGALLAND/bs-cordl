...
/// @brief Field m_CompletionCallback, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CompletionCallback, put=__cordl_internal_set_m_CompletionCallback)) ::System::Action_4<int32_t,::System::Object*,bool,::System::Exception*>*  m_CompletionCallback;
...
/// @brief Field m_GetDepCallback, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_GetDepCallback, put=__cordl_internal_set_m_GetDepCallback)) ::System::Action_2<int32_t,::System::Collections::Generic::IList_1<::System::Object*>*>*  m_GetDepCallback;

/// @brief Field m_GetDownloadProgressCallback, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_GetDownloadProgressCallback, put=__cordl_internal_set_m_GetDownloadProgressCallback)) ::System::Func_1<::UnityEngine::ResourceManagement::AsyncOperations::DownloadStatus>*  m_GetDownloadProgressCallback;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_1<::UnityEngine::ResourceManagement::AsyncOperations::DownloadStatus>*> const& __cordl_internal_get_m_GetDownloadProgressCallback() const;
