...
namespace UnityEngine::ResourceManagement::AsyncOperations {
template<typename TObject>
class __AsyncOperationBase_1____c__DisplayClass60_0;
}
namespace UnityEngine::ResourceManagement::AsyncOperations {
template<typename TObject>
class __AsyncOperationBase_1____c__DisplayClass61_0;
}
...
/// @brief Field m_CompletedActionT, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CompletedActionT, put=__cordl_internal_set_m_CompletedActionT)) ::GlobalNamespace::DelegateList_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject>>*  m_CompletedActionT;

/// @brief Field m_DestroyedAction, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DestroyedAction, put=__cordl_internal_set_m_DestroyedAction)) ::GlobalNamespace::DelegateList_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*  m_DestroyedAction;
...
/// @brief Field m_OnDestroyAction, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_OnDestroyAction, put=__cordl_internal_set_m_OnDestroyAction)) ::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::IAsyncOperation*>*  m_OnDestroyAction;
...
/// @brief Field m_dependencyCompleteAction, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_dependencyCompleteAction, put=__cordl_internal_set_m_dependencyCompleteAction)) ::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*  m_dependencyCompleteAction;
...
/// @brief Field m_taskCompletionSource, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_taskCompletionSource, put=__cordl_internal_set_m_taskCompletionSource)) ::System::Threading::Tasks::TaskCompletionSource_1<TObject>*  m_taskCompletionSource;

/// @brief Field m_taskCompletionSourceTypeless, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_taskCompletionSourceTypeless, put=__cordl_internal_set_m_taskCompletionSourceTypeless)) ::System::Threading::Tasks::TaskCompletionSource_1<::System::Object*>*  m_taskCompletionSourceTypeless;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::DelegateList_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject>>*> const& __cordl_internal_get_m_CompletedActionT() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::DelegateList_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*> const& __cordl_internal_get_m_DestroyedAction() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*> const& __cordl_internal_get_m_dependencyCompleteAction() const;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::UnityEngine::ResourceManagement::AsyncOperations::__AsyncOperationBase_1____c__DisplayClass60_0, "UnityEngine.ResourceManagement.AsyncOperations", "AsyncOperationBase`1/<>c__DisplayClass60_0");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::UnityEngine::ResourceManagement::AsyncOperations::__AsyncOperationBase_1____c__DisplayClass61_0, "UnityEngine.ResourceManagement.AsyncOperations", "AsyncOperationBase`1/<>c__DisplayClass61_0");
