...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ResourceManagement::ResourceProviders::DownloadOnlyLocation::*)(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*)>(&::UnityEngine::ResourceManagement::ResourceProviders::DownloadOnlyLocation::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x47073bc;
...
inline ::UnityEngine::ResourceManagement::ResourceProviders::DownloadOnlyLocation* UnityEngine::ResourceManagement::ResourceProviders::DownloadOnlyLocation::New_ctor(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  location)  {
