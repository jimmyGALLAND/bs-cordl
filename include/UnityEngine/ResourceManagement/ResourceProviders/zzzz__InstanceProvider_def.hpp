...
/// @brief Field m_InstanceObjectToPrefabHandle, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_InstanceObjectToPrefabHandle, put=__cordl_internal_set_m_InstanceObjectToPrefabHandle)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityW<::UnityEngine::GameObject>>>*  m_InstanceObjectToPrefabHandle;
...
/// @brief Method ProvideInstance, addr 0x470c180, size 0xd8, virtual true, abstract: false, final true
...
/// @brief Method ReleaseInstance, addr 0x470c258, size 0x23c, virtual true, abstract: false, final true
...
constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityW<::UnityEngine::GameObject>>>*& __cordl_internal_get_m_InstanceObjectToPrefabHandle() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityW<::UnityEngine::GameObject>>>*> const& __cordl_internal_get_m_InstanceObjectToPrefabHandle() const;

constexpr void __cordl_internal_set_m_InstanceObjectToPrefabHandle(::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityW<::UnityEngine::GameObject>>>*  value) ;

/// @brief Method .ctor, addr 0x470c494, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_InstanceObjectToPrefabHandle, offset: 0x10, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityW<::UnityEngine::GameObject>>>*  ___m_InstanceObjectToPrefabHandle;
