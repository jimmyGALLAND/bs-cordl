...
// SizeInfo { instance_size: 80, native_size: -1, calculated_instance_size: 80, calculated_native_size: 75, minimum_alignment: 8, packing: None, specified_packing: None }
namespace UnityEngine::ResourceManagement::ResourceProviders {
// Is value type: false
...
/// @brief Method ComputeSize, addr 0x47074e8, size 0x148, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4707630, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AssetLoadMode, addr 0x470748c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ResourceManagement::ResourceProviders::AssetLoadMode get_AssetLoadMode() ;

/// @brief Method get_BundleName, addr 0x470747c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_BundleName() ;

/// @brief Method get_BundleSize, addr 0x470749c, size 0x8, virtual false, abstract: false, final false
inline int64_t get_BundleSize() ;

/// @brief Method get_ChunkedTransfer, addr 0x470743c, size 0x8, virtual false, abstract: false, final false
inline bool get_ChunkedTransfer() ;

/// @brief Method get_ClearOtherCachedVersionsWhenLoaded, addr 0x47074d4, size 0x8, virtual false, abstract: false, final false
inline bool get_ClearOtherCachedVersionsWhenLoaded() ;

/// @brief Method get_Crc, addr 0x470741c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_Crc() ;

/// @brief Method get_Hash, addr 0x470740c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Hash() ;

/// @brief Method get_RedirectLimit, addr 0x4707450, size 0x14, virtual false, abstract: false, final false
inline int32_t get_RedirectLimit() ;

/// @brief Method get_RetryCount, addr 0x470746c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_RetryCount() ;

/// @brief Method get_Timeout, addr 0x470742c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Timeout() ;

/// @brief Method get_UseCrcForCachedBundle, addr 0x47074ac, size 0x8, virtual false, abstract: false, final false
inline bool get_UseCrcForCachedBundle() ;

/// @brief Method get_UseUnityWebRequestForLocalBundles, addr 0x47074c0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_AssetLoadMode, addr 0x4707494, size 0x8, virtual false, abstract: false, final false
inline void set_AssetLoadMode(::UnityEngine::ResourceManagement::ResourceProviders::AssetLoadMode  value) ;

/// @brief Method set_BundleName, addr 0x4707484, size 0x8, virtual false, abstract: false, final false
inline void set_BundleName(::StringW  value) ;

/// @brief Method set_BundleSize, addr 0x47074a4, size 0x8, virtual false, abstract: false, final false
inline void set_BundleSize(int64_t  value) ;

/// @brief Method set_ChunkedTransfer, addr 0x4707444, size 0xc, virtual false, abstract: false, final false
inline void set_ChunkedTransfer(bool  value) ;

/// @brief Method set_ClearOtherCachedVersionsWhenLoaded, addr 0x47074dc, size 0xc, virtual false, abstract: false, final false
inline void set_ClearOtherCachedVersionsWhenLoaded(bool  value) ;

/// @brief Method set_Crc, addr 0x4707424, size 0x8, virtual false, abstract: false, final false
inline void set_Crc(uint32_t  value) ;

/// @brief Method set_Hash, addr 0x4707414, size 0x8, virtual false, abstract: false, final false
inline void set_Hash(::StringW  value) ;

/// @brief Method set_RedirectLimit, addr 0x4707464, size 0x8, virtual false, abstract: false, final false
inline void set_RedirectLimit(int32_t  value) ;

/// @brief Method set_RetryCount, addr 0x4707474, size 0x8, virtual false, abstract: false, final false
inline void set_RetryCount(int32_t  value) ;

/// @brief Method set_Timeout, addr 0x4707434, size 0x8, virtual false, abstract: false, final false
inline void set_Timeout(int32_t  value) ;

/// @brief Method set_UseCrcForCachedBundle, addr 0x47074b4, size 0xc, virtual false, abstract: false, final false
inline void set_UseCrcForCachedBundle(bool  value) ;

/// @brief Method set_UseUnityWebRequestForLocalBundles, addr 0x47074c8, size 0xc, virtual false, abstract: false, final false
