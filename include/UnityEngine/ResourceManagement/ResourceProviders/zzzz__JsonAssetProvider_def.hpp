...
public:
// Declarations
/// @brief Method Convert, addr 0x470caa0, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x470caac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
