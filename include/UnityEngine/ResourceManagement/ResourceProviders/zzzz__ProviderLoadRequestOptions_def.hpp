...
/// @brief Method Copy, addr 0x470d874, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x470d918, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IgnoreFailures, addr 0x470d8f4, size 0x8, virtual false, abstract: false, final false
inline bool get_IgnoreFailures() ;

/// @brief Method get_WebRequestTimeout, addr 0x470d908, size 0x8, virtual false, abstract: false, final false
inline int32_t get_WebRequestTimeout() ;

/// @brief Method set_IgnoreFailures, addr 0x470d8fc, size 0xc, virtual false, abstract: false, final false
inline void set_IgnoreFailures(bool  value) ;

/// @brief Method set_WebRequestTimeout, addr 0x470d910, size 0x8, virtual false, abstract: false, final false
