...
/// @brief Method Execute, addr 0x470d7c0, size 0x88, virtual true, abstract: false, final false
inline void Execute() ;

/// @brief Method Init, addr 0x470d748, size 0x8, virtual false, abstract: false, final false
inline void Init(::System::Func_1<bool>*  callback) ;

/// @brief Method InvokeWaitForCompletion, addr 0x470d750, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x470d6f8, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::ResourceManagement::ResourceProviders::__ResourceProviderBase__BaseInitAsyncOp, 0xa0>, "Size mismatch!");

static_assert(offsetof(::UnityEngine::ResourceManagement::ResourceProviders::__ResourceProviderBase__BaseInitAsyncOp, ___m_CallBack) == 0x98, "Offset mismatch!");
...
/// @brief Method <InitializeAsync>b__0, addr 0x470d848, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x470d6f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CanProvide, addr 0x470d4e4, size 0x40, virtual true, abstract: false, final false
inline bool CanProvide(::System::Type*  t, ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  location) ;

/// @brief Method GetDefaultType, addr 0x470d534, size 0x6c, virtual true, abstract: false, final false
inline ::System::Type* GetDefaultType(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  location) ;

/// @brief Method Initialize, addr 0x470d4c0, size 0x24, virtual true, abstract: false, final false
inline bool Initialize(::StringW  id, ::StringW  data) ;

/// @brief Method InitializeAsync, addr 0x470d5a0, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method Release, addr 0x470d530, size 0x4, virtual true, abstract: false, final false
inline void Release(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  location, ::System::Object*  obj) ;

/// @brief Method ToString, addr 0x470d524, size 0xc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method UnityEngine.ResourceManagement.ResourceProviders.IResourceProvider.get_BehaviourFlags, addr 0x470d740, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x470a06c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ProviderId, addr 0x470d470, size 0x50, virtual true, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::ResourceManagement::ResourceProviders::__ResourceProviderBase__BaseInitAsyncOp*, "UnityEngine.ResourceManagement.ResourceProviders", "ResourceProviderBase/BaseInitAsyncOp");
NEED_NO_BOX(::UnityEngine::ResourceManagement::ResourceProviders::__ResourceProviderBase____c__DisplayClass10_0);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::ResourceManagement::ResourceProviders::__ResourceProviderBase____c__DisplayClass10_0*, "UnityEngine.ResourceManagement.ResourceProviders", "ResourceProviderBase/<>c__DisplayClass10_0");
