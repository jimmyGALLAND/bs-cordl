...
/// @brief Method AddBeginWebRequestHandler, addr 0x47092b0, size 0x110, virtual false, abstract: false, final false
inline void AddBeginWebRequestHandler(::UnityEngine::ResourceManagement::WebRequestQueueOperation*  webRequestQueueOperation) ;

/// @brief Method AddCallbackInvokeIfDone, addr 0x4708e1c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method BeginOperation, addr 0x4707d8c, size 0x15c, virtual false, abstract: false, final false
inline void BeginOperation() ;

/// @brief Method BeginWebRequestOperation, addr 0x47093c0, size 0xe8, virtual false, abstract: false, final false
inline void BeginWebRequestOperation(::UnityEngine::AsyncOperation*  asyncOp) ;

/// @brief Method CompleteBundleLoad, addr 0x47095c8, size 0x134, virtual false, abstract: false, final false
inline void CompleteBundleLoad(::UnityEngine::AssetBundle*  bundle) ;

/// @brief Method CreateWebRequest, addr 0x47077cc, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method CreateWebRequest, addr 0x47077f4, size 0x238, virtual false, abstract: false, final false
inline ::UnityEngine::Networking::UnityWebRequest* CreateWebRequest(::StringW  url) ;

/// @brief Method EnqueueWebRequest, addr 0x47091a0, size 0x110, virtual false, abstract: false, final false
inline ::UnityEngine::ResourceManagement::WebRequestQueueOperation* EnqueueWebRequest(::StringW  internalId) ;

/// @brief Method GetAssetBundle, addr 0x4707b48, size 0x1c, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::AssetBundle> GetAssetBundle() ;

/// @brief Method GetAssetPreloadRequest, addr 0x4707a2c, size 0x11c, virtual false, abstract: false, final false
inline ::UnityEngine::AssetBundleRequest* GetAssetPreloadRequest() ;

/// @brief Method GetDownloadStatus, addr 0x4707b7c, size 0x150, virtual false, abstract: false, final false
inline ::UnityEngine::ResourceManagement::AsyncOperations::DownloadStatus GetDownloadStatus() ;

/// @brief Method GetLoadInfo, addr 0x4708e7c, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GetLoadInfo, addr 0x4708eac, size 0x244, virtual false, abstract: false, final false
...
/// @brief Method LoadLocalBundle, addr 0x47090f0, size 0xb0, virtual false, abstract: false, final false
inline void LoadLocalBundle() ;

/// @brief Method LocalRequestOperationCompleted, addr 0x4708d74, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method OnUnloadOperationComplete, addr 0x4707d84, size 0x8, virtual false, abstract: false, final false
inline void OnUnloadOperationComplete(::UnityEngine::AsyncOperation*  op) ;

/// @brief Method PercentComplete, addr 0x4707b64, size 0x18, virtual false, abstract: false, final false
inline float_t PercentComplete() ;

/// @brief Method Start, addr 0x4707ee8, size 0x2cc, virtual false, abstract: false, final false
...
/// @brief Method Unload, addr 0x47096fc, size 0xa8, virtual false, abstract: false, final false
inline bool Unload(ByRef<::UnityEngine::AssetBundleUnloadOperation*>  unloadOp) ;

/// @brief Method Update, addr 0x47094a8, size 0x120, virtual true, abstract: false, final true
inline void Update(float_t  unscaledDeltaTime) ;

/// @brief Method WaitForCompletionHandler, addr 0x47083d0, size 0x384, virtual false, abstract: false, final false
inline bool WaitForCompletionHandler() ;

/// @brief Method WebRequestOperationCompleted, addr 0x4708754, size 0x620, virtual false, abstract: false, final false
inline void WebRequestOperationCompleted(::UnityEngine::AsyncOperation*  op) ;

/// @brief Method <AddBeginWebRequestHandler>b__39_0, addr 0x47097b8, size 0x4, virtual false, abstract: false, final false
inline void _AddBeginWebRequestHandler_b__39_0(::UnityEngine::Networking::UnityWebRequestAsyncOperation*  asyncOp) ;

/// @brief Method <GetAssetPreloadRequest>b__26_0, addr 0x47097ac, size 0xc, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AssetBundleUnloadOperation*> const& __cordl_internal_get_m_UnloadOperation() const;
...
/// @brief Method .ctor, addr 0x47097a4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BytesToDownload, addr 0x47076c8, size 0x58, virtual false, abstract: false, final false
inline int64_t get_BytesToDownload() ;

/// @brief Method get_HasTimedOut, addr 0x4707688, size 0x40, virtual false, abstract: false, final false
