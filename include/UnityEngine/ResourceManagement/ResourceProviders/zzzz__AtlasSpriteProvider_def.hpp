...
/// @brief Method Provide, addr 0x470a1f8, size 0x380, virtual true, abstract: false, final false
inline void Provide(::UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle  providerInterface) ;

/// @brief Method .ctor, addr 0x470a578, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
