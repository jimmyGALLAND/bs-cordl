...
/// @brief Method Activate, addr 0x470c790, size 0x20, virtual false, abstract: false, final false
inline void Activate() ;

/// @brief Method ActivateAsync, addr 0x470c7b0, size 0x2c, virtual false, abstract: false, final false
inline ::UnityEngine::AsyncOperation* ActivateAsync() ;

/// @brief Method Equals, addr 0x470c7fc, size 0xb4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x470c7dc, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_Scene, addr 0x470c780, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::SceneManagement::Scene get_Scene() ;

/// @brief Method set_Scene, addr 0x470c788, size 0x8, virtual false, abstract: false, final false
