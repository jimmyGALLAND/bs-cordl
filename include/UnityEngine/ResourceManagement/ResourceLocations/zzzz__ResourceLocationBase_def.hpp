...
/// @brief Field m_Dependencies, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Dependencies, put=__cordl_internal_set_m_Dependencies)) ::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*>*  m_Dependencies;
...
/// @brief Method ComputeDependencyHash, addr 0x4710368, size 0x258, virtual false, abstract: false, final false
inline void ComputeDependencyHash() ;

/// @brief Method Hash, addr 0x47100ec, size 0x54, virtual true, abstract: false, final true
inline int32_t Hash(::System::Type*  t) ;

static inline ::UnityEngine::ResourceManagement::ResourceLocations::ResourceLocationBase* New_ctor(::StringW  name, ::StringW  id, ::StringW  providerId, ::System::Type*  t, ::ArrayW<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*,::Array<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*>*>  dependencies) ;

/// @brief Method ToString, addr 0x4710140, size 0x8, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*>*> const& __cordl_internal_get_m_Dependencies() const;
...
/// @brief Method .ctor, addr 0x4710148, size 0x220, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::StringW  id, ::StringW  providerId, ::System::Type*  t, ::ArrayW<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*,::Array<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*>*>  dependencies) ;

/// @brief Method get_Data, addr 0x47100bc, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_Data() ;

/// @brief Method get_Dependencies, addr 0x4710060, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method get_DependencyHashCode, addr 0x47100dc, size 0x8, virtual true, abstract: false, final true
inline int32_t get_DependencyHashCode() ;

/// @brief Method get_HasDependencies, addr 0x4710068, size 0x54, virtual true, abstract: false, final true
inline bool get_HasDependencies() ;

/// @brief Method get_InternalId, addr 0x4710050, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_InternalId() ;

/// @brief Method get_PrimaryKey, addr 0x47100cc, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_PrimaryKey() ;

/// @brief Method get_ProviderId, addr 0x4710058, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_ProviderId() ;

/// @brief Method get_ResourceType, addr 0x47100e4, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_Data, addr 0x47100c4, size 0x8, virtual false, abstract: false, final false
inline void set_Data(::System::Object*  value) ;

/// @brief Method set_PrimaryKey, addr 0x47100d4, size 0x8, virtual false, abstract: false, final false
