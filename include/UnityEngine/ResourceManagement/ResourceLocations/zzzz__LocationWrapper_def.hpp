...
/// @brief Field m_InternalLocation, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_InternalLocation, put=__cordl_internal_set_m_InternalLocation)) ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  m_InternalLocation;
...
/// @brief Method Hash, addr 0x4710adc, size 0xac, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x47073e4, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  location) ;

/// @brief Method get_Data, addr 0x47108f0, size 0xa4, virtual true, abstract: false, final true
inline ::System::Object* get_Data() ;

/// @brief Method get_Dependencies, addr 0x4710704, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method get_DependencyHashCode, addr 0x47107a8, size 0xa4, virtual true, abstract: false, final true
inline int32_t get_DependencyHashCode() ;

/// @brief Method get_HasDependencies, addr 0x471084c, size 0xa4, virtual true, abstract: false, final true
inline bool get_HasDependencies() ;

/// @brief Method get_InternalId, addr 0x47105c0, size 0xa0, virtual true, abstract: false, final true
inline ::StringW get_InternalId() ;

/// @brief Method get_PrimaryKey, addr 0x4710994, size 0xa4, virtual true, abstract: false, final true
inline ::StringW get_PrimaryKey() ;

/// @brief Method get_ProviderId, addr 0x4710660, size 0xa4, virtual true, abstract: false, final true
inline ::StringW get_ProviderId() ;

/// @brief Method get_ResourceType, addr 0x4710a38, size 0xa4, virtual true, abstract: false, final true
