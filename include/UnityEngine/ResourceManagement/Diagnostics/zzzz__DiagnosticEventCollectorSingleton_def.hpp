...
/// @brief Method <Awake>b__11_0, addr 0x4711ab0, size 0x5c, virtual false, abstract: false, final false
inline void _Awake_b__11_0(::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent  diagnosticEvent) ;

/// @brief Method <RegisterEventHandler>b__8_0, addr 0x4711aa8, size 0x8, virtual false, abstract: false, final false
inline int32_t _RegisterEventHandler_b__8_0(::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent  evt) ;

/// @brief Method .ctor, addr 0x4711aa0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
class CORDL_TYPE DiagnosticEventCollectorSingleton : public ::UnityEngine::ResourceManagement::Util::ComponentSingleton_1<::UnityW<::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEventCollectorSingleton>> {
public:
// Declarations
...
/// @brief Field m_CreatedEvents, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CreatedEvents, put=__cordl_internal_set_m_CreatedEvents)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent>*  m_CreatedEvents;

/// @brief Field m_UnhandledEvents, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_UnhandledEvents, put=__cordl_internal_set_m_UnhandledEvents)) ::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent>*  m_UnhandledEvents;
...
/// @brief Field s_EventHandlers, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_s_EventHandlers, put=__cordl_internal_set_s_EventHandlers)) ::GlobalNamespace::DelegateList_1<::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent>*  s_EventHandlers;
...
/// @brief Method Awake, addr 0x4711694, size 0xe0, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetGameObjectName, addr 0x4710df8, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method PostEvent, addr 0x4711478, size 0x21c, virtual false, abstract: false, final false
inline void PostEvent(::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent  diagnosticEvent) ;

/// @brief Method RegisterEventHandler, addr 0x4710e38, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method RegisterEventHandler, addr 0x4710f04, size 0x4d0, virtual false, abstract: false, final false
inline void RegisterEventHandler(::System::Action_1<::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent>*  handler) ;

/// @brief Method UnregisterEventHandler, addr 0x47113d4, size 0xa4, virtual false, abstract: false, final false
inline void UnregisterEventHandler(::System::Action_1<::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent>*  handler) ;

/// @brief Method Update, addr 0x4711774, size 0x1c8, virtual false, abstract: false, final false
inline void Update() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent>*> const& __cordl_internal_get_m_CreatedEvents() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent>*> const& __cordl_internal_get_m_UnhandledEvents() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::DelegateList_1<::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent>*> const& __cordl_internal_get_s_EventHandlers() const;
...
/// @brief Method .ctor, addr 0x471193c, size 0x108, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Guid getStaticF_s_editorConnectionGuid() ;

/// @brief Method get_PlayerConnectionGuid, addr 0x4710cfc, size 0xfc, virtual false, abstract: false, final false
