...
/// @brief Method Deserialize, addr 0x4710c70, size 0x8c, virtual false, abstract: false, final false
static inline ::UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent Deserialize(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method Serialize, addr 0x4710bd8, size 0x98, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Serialize() ;

/// @brief Method .ctor, addr 0x4710bc0, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method get_Dependencies, addr 0x4710ba0, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> get_Dependencies() ;

/// @brief Method get_DisplayName, addr 0x4710b98, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_DisplayName() ;

/// @brief Method get_Frame, addr 0x4710bb0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Frame() ;

/// @brief Method get_Graph, addr 0x4710b88, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Graph() ;

/// @brief Method get_ObjectId, addr 0x4710b90, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ObjectId() ;

/// @brief Method get_Stream, addr 0x4710ba8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Stream() ;

/// @brief Method get_Value, addr 0x4710bb8, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Graph", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "m_Dependencies", ty: "::ArrayW<int32_t,::Array<int32_t>*>", modifiers: "", def_value: None }, CppParam { name: "m_ObjectId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_DisplayName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "m_Stream", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Frame", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Value", ty: "int32_t", modifiers: "", def_value: None }]
constexpr DiagnosticEvent(::StringW  m_Graph, ::ArrayW<int32_t,::Array<int32_t>*>  m_Dependencies, int32_t  m_ObjectId, ::StringW  m_DisplayName, int32_t  m_Stream, int32_t  m_Frame, int32_t  m_Value) noexcept;
