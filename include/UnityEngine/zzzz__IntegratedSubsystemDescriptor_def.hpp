...
/// @brief Method UnityEngine.ISubsystemDescriptor.Create, addr 0x4884bac, size 0xc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x4884bb8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_id, addr 0x4884b34, size 0x3c, virtual true, abstract: false, final true
