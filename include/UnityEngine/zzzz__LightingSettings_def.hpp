...
/// @brief Method Internal_Create, addr 0x47dc96c, size 0x3c, virtual false, abstract: false, final false
static inline void Internal_Create(::UnityEngine::LightingSettings*  self) ;

/// @brief Method LightingSettingsDontStripMe, addr 0x47dc8e8, size 0x4, virtual false, abstract: false, final false
inline void LightingSettingsDontStripMe() ;

static inline ::UnityEngine::LightingSettings* New_ctor() ;

/// @brief Method .ctor, addr 0x47dc8ec, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bakedGI, addr 0x47dc9a8, size 0x3c, virtual false, abstract: false, final false
inline bool get_bakedGI() ;

/// @brief Method get_realtimeEnvironmentLighting, addr 0x47dcaa8, size 0x3c, virtual false, abstract: false, final false
inline bool get_realtimeEnvironmentLighting() ;

/// @brief Method get_realtimeGI, addr 0x47dca28, size 0x3c, virtual false, abstract: false, final false
inline bool get_realtimeGI() ;

/// @brief Method set_bakedGI, addr 0x47dc9e4, size 0x44, virtual false, abstract: false, final false
inline void set_bakedGI(bool  value) ;

/// @brief Method set_realtimeEnvironmentLighting, addr 0x47dcae4, size 0x44, virtual false, abstract: false, final false
inline void set_realtimeEnvironmentLighting(bool  value) ;

/// @brief Method set_realtimeGI, addr 0x47dca64, size 0x44, virtual false, abstract: false, final false
