...
/// @brief Method GetResult, addr 0x4814a74, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4814b04, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_asset, addr 0x4814af8, size 0xc, virtual false, abstract: false, final false
