...
/// @brief Method get_Impulse, addr 0x487a914, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_Impulse() ;

/// @brief Method get_Normal, addr 0x487a908, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_Normal() ;

/// @brief Method get_Position, addr 0x487a8f4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_Position() ;

/// @brief Method get_Separation, addr 0x487a900, size 0x8, virtual false, abstract: false, final false
