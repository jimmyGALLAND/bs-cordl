...
/// @brief Method Cache_GetPath, addr 0x47d15dc, size 0x3c, virtual false, abstract: false, final false
static inline ::StringW Cache_GetPath(int32_t  handle) ;

/// @brief Method Cache_IsValid, addr 0x47d1564, size 0x3c, virtual false, abstract: false, final false
static inline bool Cache_IsValid(int32_t  handle) ;

/// @brief Method Cache_SetExpirationDelay, addr 0x47d16e4, size 0x44, virtual false, abstract: false, final false
static inline void Cache_SetExpirationDelay(int32_t  handle, int32_t  value) ;

/// @brief Method Cache_SetMaximumDiskSpaceAvailable, addr 0x47d165c, size 0x44, virtual false, abstract: false, final false
static inline void Cache_SetMaximumDiskSpaceAvailable(int32_t  handle, int64_t  value) ;

/// @brief Method Equals, addr 0x47d14a0, size 0x78, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method Equals, addr 0x47d1518, size 0x10, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Cache  other) ;

/// @brief Method GetHashCode, addr 0x47d1498, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_handle, addr 0x47d1490, size 0x8, virtual false, abstract: false, final false
inline int32_t get_handle() ;

/// @brief Method get_path, addr 0x47d15a0, size 0x3c, virtual false, abstract: false, final false
inline ::StringW get_path() ;

/// @brief Method get_valid, addr 0x47d1528, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method set_expirationDelay, addr 0x47d16a0, size 0x44, virtual false, abstract: false, final false
inline void set_expirationDelay(int32_t  value) ;

/// @brief Method set_maximumAvailableStorageSpace, addr 0x47d1618, size 0x44, virtual false, abstract: false, final false
