...
/// @brief Method GetMode, addr 0x482d0b4, size 0x28, virtual false, abstract: false, final false
static inline ::UnityEngine::Scripting::__GarbageCollector__Mode GetMode() ;

/// @brief Method SetMode, addr 0x482d0dc, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method set_GCMode, addr 0x482cff4, size 0xc0, virtual false, abstract: false, final false
