...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Scripting::APIUpdating::MovedFromAttributeData::*)(bool, ::StringW, ::StringW, ::StringW)>(&::UnityEngine::Scripting::APIUpdating::MovedFromAttributeData::Set)> {
  constexpr static std::size_t size = 0x38;
  constexpr static std::size_t addrs = 0x482d120;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 4>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get()}
                    )));
...
// Ctor Parameters [CppParam { name: "className", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "nameSpace", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "assembly", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "classHasChanged", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "nameSpaceHasChanged", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "assemblyHasChanged", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "autoUdpateAPI", ty: "bool", modifiers: "", def_value: Some("{}") }]
