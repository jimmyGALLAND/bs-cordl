...
/// @brief Method .ctor, addr 0x482d158, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(bool  autoUpdateAPI, ::StringW  sourceNamespace, ::StringW  sourceAssembly, ::StringW  sourceClassName) ;

/// @brief Method .ctor, addr 0x482d1c4, size 0x44, virtual false, abstract: false, final false
