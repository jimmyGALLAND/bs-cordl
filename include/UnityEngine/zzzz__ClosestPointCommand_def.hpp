...
/// @brief Method ScheduleBatch, addr 0x487c208, size 0x150, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleBatch(::Unity::Collections::NativeArray_1<::UnityEngine::ClosestPointCommand>  commands, ::Unity::Collections::NativeArray_1<::UnityEngine::Vector3>  results, int32_t  minCommandsPerJob, ::Unity::Jobs::JobHandle  dependsOn) ;

/// @brief Method ScheduleClosestPointCommandBatch, addr 0x487c358, size 0x8c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleClosestPointCommandBatch(ByRef<::Unity::Jobs::LowLevel::Unsafe::__JobsUtility__JobScheduleParameters>  parameters, ::cordl_internals::Ptr<void>  commands, int32_t  commandLen, ::cordl_internals::Ptr<void>  result, int32_t  resultLen, int32_t  minCommandsPerJob) ;

/// @brief Method ScheduleClosestPointCommandBatch_Injected, addr 0x487c3e4, size 0x84, virtual false, abstract: false, final false
static inline void ScheduleClosestPointCommandBatch_Injected(ByRef<::Unity::Jobs::LowLevel::Unsafe::__JobsUtility__JobScheduleParameters>  parameters, ::cordl_internals::Ptr<void>  commands, int32_t  commandLen, ::cordl_internals::Ptr<void>  result, int32_t  resultLen, int32_t  minCommandsPerJob, ByRef<::Unity::Jobs::JobHandle>  ret) ;

/// @brief Method .ctor, addr 0x487c10c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x487c0dc, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_colliderInstanceID, addr 0x487c1b0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_colliderInstanceID() ;

/// @brief Method get_point, addr 0x487c198, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_point() ;

/// @brief Method get_position, addr 0x487c1c0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_position() ;

/// @brief Method get_rotation, addr 0x487c1d8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_rotation() ;

/// @brief Method get_scale, addr 0x487c1f0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_scale() ;

/// @brief Method set_colliderInstanceID, addr 0x487c1b8, size 0x8, virtual false, abstract: false, final false
inline void set_colliderInstanceID(int32_t  value) ;

/// @brief Method set_point, addr 0x487c1a4, size 0xc, virtual false, abstract: false, final false
inline void set_point(::UnityEngine::Vector3  value) ;

/// @brief Method set_position, addr 0x487c1cc, size 0xc, virtual false, abstract: false, final false
inline void set_position(::UnityEngine::Vector3  value) ;

/// @brief Method set_rotation, addr 0x487c1e4, size 0xc, virtual false, abstract: false, final false
inline void set_rotation(::UnityEngine::Quaternion  value) ;

/// @brief Method set_scale, addr 0x487c1fc, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_point_k__BackingField", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "_colliderInstanceID_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_position_k__BackingField", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "_rotation_k__BackingField", ty: "::UnityEngine::Quaternion", modifiers: "", def_value: None }, CppParam { name: "_scale_k__BackingField", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }]
constexpr ClosestPointCommand(::UnityEngine::Vector3  _point_k__BackingField, int32_t  _colliderInstanceID_k__BackingField, ::UnityEngine::Vector3  _position_k__BackingField, ::UnityEngine::Quaternion  _rotation_k__BackingField, ::UnityEngine::Vector3  _scale_k__BackingField) noexcept;
