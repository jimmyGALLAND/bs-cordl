...
/// @brief Method .ctor, addr 0x47f36a4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bakingOutput, addr 0x47f3544, size 0x68, virtual false, abstract: false, final false
inline ::UnityEngine::LightBakingOutput get_bakingOutput() ;

/// @brief Method get_bakingOutput_Injected, addr 0x47f35ac, size 0x44, virtual false, abstract: false, final false
inline void get_bakingOutput_Injected(ByRef<::UnityEngine::LightBakingOutput>  ret) ;

/// @brief Method get_bounceIntensity, addr 0x47f34cc, size 0x3c, virtual false, abstract: false, final false
inline float_t get_bounceIntensity() ;

/// @brief Method get_color, addr 0x47f3298, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_colorTemperature, addr 0x47f33cc, size 0x3c, virtual false, abstract: false, final false
inline float_t get_colorTemperature() ;

/// @brief Method get_color_Injected, addr 0x47f32f0, size 0x44, virtual false, abstract: false, final false
inline void get_color_Injected(ByRef<::UnityEngine::Color>  ret) ;

/// @brief Method get_cookie, addr 0x47f3668, size 0x3c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_cookie() ;

/// @brief Method get_cookieSize, addr 0x47f362c, size 0x3c, virtual false, abstract: false, final false
inline float_t get_cookieSize() ;

/// @brief Method get_intensity, addr 0x47f3444, size 0x3c, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method get_range, addr 0x47f3508, size 0x3c, virtual false, abstract: false, final false
inline float_t get_range() ;

/// @brief Method get_shadows, addr 0x47f35f0, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::LightShadows get_shadows() ;

/// @brief Method get_spotAngle, addr 0x47f325c, size 0x3c, virtual false, abstract: false, final false
inline float_t get_spotAngle() ;

/// @brief Method get_type, addr 0x47f3220, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::LightType get_type() ;

/// @brief Method get_useColorTemperature, addr 0x47f3408, size 0x3c, virtual false, abstract: false, final false
inline bool get_useColorTemperature() ;

/// @brief Method set_color, addr 0x47f3334, size 0x54, virtual false, abstract: false, final false
inline void set_color(::UnityEngine::Color  value) ;

/// @brief Method set_color_Injected, addr 0x47f3388, size 0x44, virtual false, abstract: false, final false
inline void set_color_Injected(ByRef<::UnityEngine::Color>  value) ;

/// @brief Method set_intensity, addr 0x47f3480, size 0x4c, virtual false, abstract: false, final false
