...
/// @brief Method Invoke, addr 0x47b383c, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x47b3718, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::AndroidJavaRunnable*  runnable) ;

/// @brief Method run, addr 0x47b3818, size 0x24, virtual false, abstract: false, final false
inline void run() ;
