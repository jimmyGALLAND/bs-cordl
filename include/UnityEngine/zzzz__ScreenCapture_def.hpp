...
/// @brief Method CaptureScreenshot, addr 0x48824f8, size 0x44, virtual false, abstract: false, final false
static inline void CaptureScreenshot(::StringW  filename) ;

/// @brief Method CaptureScreenshot, addr 0x488253c, size 0x54, virtual false, abstract: false, final false
