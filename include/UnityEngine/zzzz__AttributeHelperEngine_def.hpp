...
static __declspec(property(get=getStaticF__disallowMultipleComponentArray, put=setStaticF__disallowMultipleComponentArray)) ::ArrayW<::UnityEngine::DisallowMultipleComponent*,::Array<::UnityEngine::DisallowMultipleComponent*>*>  _disallowMultipleComponentArray;

/// @brief Field _executeInEditModeArray, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF__executeInEditModeArray, put=setStaticF__executeInEditModeArray)) ::ArrayW<::UnityEngine::ExecuteInEditMode*,::Array<::UnityEngine::ExecuteInEditMode*>*>  _executeInEditModeArray;

/// @brief Field _requireComponentArray, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF__requireComponentArray, put=setStaticF__requireComponentArray)) ::ArrayW<::UnityEngine::RequireComponent*,::Array<::UnityEngine::RequireComponent*>*>  _requireComponentArray;

/// @brief Method CheckIsEditorScript, addr 0x4815e08, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method GetDefaultExecutionOrderFor, addr 0x4815f18, size 0x78, virtual false, abstract: false, final false
static inline int32_t GetDefaultExecutionOrderFor(::System::Type*  klass) ;

/// @brief Method GetExecuteMode, addr 0x4815cf4, size 0x114, virtual false, abstract: false, final false
static inline int32_t GetExecuteMode(::System::Type*  klass) ;

/// @brief Method GetParentTypeDisallowingMultipleInclusion, addr 0x48156ec, size 0x134, virtual false, abstract: false, final false
static inline ::System::Type* GetParentTypeDisallowingMultipleInclusion(::System::Type*  type) ;

/// @brief Method GetRequiredComponents, addr 0x4815820, size 0x4d4, virtual false, abstract: false, final false
