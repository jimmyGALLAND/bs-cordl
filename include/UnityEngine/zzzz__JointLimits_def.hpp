...
/// @brief Method get_bounceMinVelocity, addr 0x485f148, size 0x8, virtual false, abstract: false, final false
inline float_t get_bounceMinVelocity() ;

/// @brief Method get_bounciness, addr 0x485f138, size 0x8, virtual false, abstract: false, final false
inline float_t get_bounciness() ;

/// @brief Method get_contactDistance, addr 0x485f158, size 0x8, virtual false, abstract: false, final false
inline float_t get_contactDistance() ;

/// @brief Method get_max, addr 0x485f128, size 0x8, virtual false, abstract: false, final false
inline float_t get_max() ;

/// @brief Method get_min, addr 0x485f118, size 0x8, virtual false, abstract: false, final false
inline float_t get_min() ;

/// @brief Method set_bounceMinVelocity, addr 0x485f150, size 0x8, virtual false, abstract: false, final false
inline void set_bounceMinVelocity(float_t  value) ;

/// @brief Method set_bounciness, addr 0x485f140, size 0x8, virtual false, abstract: false, final false
inline void set_bounciness(float_t  value) ;

/// @brief Method set_contactDistance, addr 0x485f160, size 0x8, virtual false, abstract: false, final false
inline void set_contactDistance(float_t  value) ;

/// @brief Method set_max, addr 0x485f130, size 0x8, virtual false, abstract: false, final false
inline void set_max(float_t  value) ;

/// @brief Method set_min, addr 0x485f120, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_Min", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_Max", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_Bounciness", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_BounceMinVelocity", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_ContactDistance", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "minBounce", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "maxBounce", ty: "float_t", modifiers: "", def_value: None }]
