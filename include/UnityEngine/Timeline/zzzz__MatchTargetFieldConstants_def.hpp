...
/// @brief Method HasAny, addr 0x477c30c, size 0x74, virtual false, abstract: false, final false
static inline bool HasAny(::UnityEngine::Timeline::MatchTargetFields  me, ::UnityEngine::Timeline::MatchTargetFields  fields) ;

/// @brief Method Toggle, addr 0x477c380, size 0x8, virtual false, abstract: false, final false
