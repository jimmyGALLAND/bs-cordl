...
/// @brief Method Create, addr 0x4792c40, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method DisableAt, addr 0x47930c0, size 0x158, virtual true, abstract: false, final false
inline void DisableAt(double_t  localTime, double_t  rootDuration, ::UnityEngine::Playables::FrameData  frameData) ;

/// @brief Method EvaluateAt, addr 0x4792ec8, size 0x1f8, virtual true, abstract: false, final false
...
/// @brief Method SetDuration, addr 0x4792e70, size 0x58, virtual false, abstract: false, final false
inline void SetDuration(double_t  duration) ;

/// @brief Method SetTime, addr 0x4792e18, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x477d728, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method get_clip, addr 0x4792cc4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Timeline::TimelineClip* get_clip() ;

/// @brief Method get_duration, addr 0x4792c20, size 0x18, virtual true, abstract: false, final false
inline double_t get_duration() ;

/// @brief Method get_mixer, addr 0x4792ccc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::Playable get_mixer() ;

/// @brief Method get_playable, addr 0x4792cd8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::Playable get_playable() ;

/// @brief Method get_start, addr 0x4792bf4, size 0x2c, virtual true, abstract: false, final false
inline double_t get_start() ;

/// @brief Method set_enable, addr 0x4792ce4, size 0x134, virtual true, abstract: false, final false
