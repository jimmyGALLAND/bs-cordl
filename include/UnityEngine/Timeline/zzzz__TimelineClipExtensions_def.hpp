...
/// @brief Method MoveToTrack, addr 0x479ba50, size 0x34c, virtual false, abstract: false, final false
static inline void MoveToTrack(::UnityEngine::Timeline::TimelineClip*  clip, ::UnityEngine::Timeline::TrackAsset*  destinationTrack) ;

/// @brief Method MoveToTrack_Impl, addr 0x479bd9c, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method TryMoveToTrack, addr 0x479bebc, size 0x19c, virtual false, abstract: false, final false
