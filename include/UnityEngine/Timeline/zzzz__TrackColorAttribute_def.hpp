...
/// @brief Method .ctor, addr 0x478cc64, size 0x44, virtual false, abstract: false, final false
inline void _ctor(float_t  r, float_t  g, float_t  b) ;

/// @brief Method get_color, addr 0x478cc58, size 0xc, virtual false, abstract: false, final false
