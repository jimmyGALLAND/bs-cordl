...
/// @brief Field m_ActiveClips, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ActiveClips, put=__cordl_internal_set_m_ActiveClips)) ::System::Collections::Generic::List_1<::UnityEngine::Timeline::RuntimeElement*>*  m_ActiveClips;

/// @brief Field m_CurrentListOfActiveClips, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CurrentListOfActiveClips, put=__cordl_internal_set_m_CurrentListOfActiveClips)) ::System::Collections::Generic::List_1<::UnityEngine::Timeline::RuntimeElement*>*  m_CurrentListOfActiveClips;

/// @brief Field m_EvaluateCallbacks, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_EvaluateCallbacks, put=__cordl_internal_set_m_EvaluateCallbacks)) ::System::Collections::Generic::List_1<::UnityEngine::Timeline::ITimelineEvaluateCallback*>*  m_EvaluateCallbacks;

/// @brief Field m_IntervalTree, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_IntervalTree, put=__cordl_internal_set_m_IntervalTree)) ::UnityEngine::Timeline::IntervalTree_1<::UnityEngine::Timeline::RuntimeElement*>*  m_IntervalTree;

/// @brief Field m_PlayableCache, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PlayableCache, put=__cordl_internal_set_m_PlayableCache)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Timeline::TrackAsset>,::UnityEngine::Playables::Playable>*  m_PlayableCache;
...
/// @brief Method CacheTrack, addr 0x4799fb4, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method Compile, addr 0x4798d10, size 0x290, virtual false, abstract: false, final false
inline void Compile(::UnityEngine::Playables::PlayableGraph  graph, ::UnityEngine::Playables::Playable  timelinePlayable, ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Timeline::TrackAsset>>*  tracks, ::UnityEngine::GameObject*  go, bool  autoRebalance, bool  createOutputs) ;

/// @brief Method CompileTrackList, addr 0x4798fa0, size 0x398, virtual false, abstract: false, final false
inline void CompileTrackList(::UnityEngine::Playables::PlayableGraph  graph, ::UnityEngine::Playables::Playable  timelinePlayable, ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Timeline::TrackAsset>>*  tracks, ::UnityEngine::GameObject*  go, bool  createOutputs) ;

/// @brief Method Create, addr 0x4798afc, size 0x214, virtual false, abstract: false, final false
static inline ::UnityEngine::Playables::ScriptPlayable_1<::UnityEngine::Timeline::TimelinePlayable*> Create(::UnityEngine::Playables::PlayableGraph  graph, ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Timeline::TrackAsset>>*  tracks, ::UnityEngine::GameObject*  go, bool  autoRebalance, bool  createOutputs) ;

/// @brief Method CreateTrackOutput, addr 0x4799728, size 0x6bc, virtual false, abstract: false, final false
inline void CreateTrackOutput(::UnityEngine::Playables::PlayableGraph  graph, ::UnityEngine::Timeline::TrackAsset*  track, ::UnityEngine::GameObject*  go, ::UnityEngine::Playables::Playable  playable, int32_t  port) ;

/// @brief Method CreateTrackPlayable, addr 0x4799338, size 0x3f0, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::Playable CreateTrackPlayable(::UnityEngine::Playables::PlayableGraph  graph, ::UnityEngine::Playables::Playable  timelinePlayable, ::UnityEngine::Timeline::TrackAsset*  track, ::UnityEngine::GameObject*  go, bool  createOutputs) ;

/// @brief Method Evaluate, addr 0x479a050, size 0x5b8, virtual false, abstract: false, final false
inline void Evaluate(::UnityEngine::Playables::Playable  playable, ::UnityEngine::Playables::FrameData  frameData) ;

/// @brief Method EvaluateAnimationPreviewUpdateCallback, addr 0x4799ecc, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method EvaluateWeightsForAnimationPlayableOutput, addr 0x4799de4, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method ForAOTCompilationOnly, addr 0x479a608, size 0x5c, virtual false, abstract: false, final false
static inline void ForAOTCompilationOnly() ;

static inline ::UnityEngine::Timeline::TimelinePlayable* New_ctor() ;

/// @brief Method PrepareFrame, addr 0x479a024, size 0x2c, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Timeline::TrackAsset>,::UnityEngine::Playables::Playable>*> const& __cordl_internal_get_m_PlayableCache() const;
...
/// @brief Method .ctor, addr 0x479a664, size 0x154, virtual false, abstract: false, final false
inline void _ctor() ;
