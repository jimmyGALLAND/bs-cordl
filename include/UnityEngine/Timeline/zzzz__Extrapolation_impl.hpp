...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Timeline::__Extrapolation____c::*)()>(&::UnityEngine::Timeline::__Extrapolation____c::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x479ae34;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::Timeline::__Extrapolation____c::*)(::UnityEngine::Timeline::TimelineClip*, ::UnityEngine::Timeline::TimelineClip*)>(&::UnityEngine::Timeline::__Extrapolation____c::_SortClipsByStartTime_b__2_0)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x479ae3c;
...
::cordl_internals::setStaticField<::UnityEngine::Timeline::__Extrapolation____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::__Extrapolation____c*>::get>(std::forward<::UnityEngine::Timeline::__Extrapolation____c*>(value));
}
inline ::UnityEngine::Timeline::__Extrapolation____c* UnityEngine::Timeline::__Extrapolation____c::getStaticF___9()  {
return ::cordl_internals::getStaticField<::UnityEngine::Timeline::__Extrapolation____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::__Extrapolation____c*>::get>();
}
...
::cordl_internals::setStaticField<::System::Comparison_1<::UnityEngine::Timeline::TimelineClip*>*, "<>9__2_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::__Extrapolation____c*>::get>(std::forward<::System::Comparison_1<::UnityEngine::Timeline::TimelineClip*>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Comparison_1<::UnityEngine::Timeline::TimelineClip*>*, "<>9__2_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::__Extrapolation____c*>::get>();
}
inline ::UnityEngine::Timeline::__Extrapolation____c* UnityEngine::Timeline::__Extrapolation____c::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::Timeline::__Extrapolation____c*>());
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Timeline::TrackAsset*)>(&::UnityEngine::Timeline::Extrapolation::CalculateExtrapolationTimes)> {
  constexpr static std::size_t size = 0x418;
  constexpr static std::size_t addrs = 0x479a804;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::UnityEngine::Timeline::TimelineClip*,::Array<::UnityEngine::Timeline::TimelineClip*>*> (*)(::ArrayW<::UnityEngine::Timeline::TimelineClip*,::Array<::UnityEngine::Timeline::TimelineClip*>*>)>(&::UnityEngine::Timeline::Extrapolation::SortClipsByStartTime)> {
  constexpr static std::size_t size = 0x138;
  constexpr static std::size_t addrs = 0x479ac1c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<::UnityEngine::Timeline::TimelineClip*,::Array<::UnityEngine::Timeline::TimelineClip*>*>>::get()}
                    )));
    return ___internal_method;
  }
};
...
inline ::ArrayW<::UnityEngine::Timeline::TimelineClip*,::Array<::UnityEngine::Timeline::TimelineClip*>*> UnityEngine::Timeline::Extrapolation::SortClipsByStartTime(::ArrayW<::UnityEngine::Timeline::TimelineClip*,::Array<::UnityEngine::Timeline::TimelineClip*>*>  clips)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::Extrapolation*>::get(),
                        "SortClipsByStartTime",
                        std::span<const Il2CppClass* const, 0>(),
