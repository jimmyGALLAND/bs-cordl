...
/// @brief Method UnityEngine.Playables.INotification.get_id, addr 0x4794250, size 0xc0, virtual true, abstract: false, final true
inline ::UnityEngine::PropertyName UnityEngine_Playables_INotification_get_id() ;

/// @brief Method UnityEngine.Timeline.INotificationOptionProvider.get_flags, addr 0x4794310, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x479432c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_asset, addr 0x4794240, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Timeline::SignalAsset> get_asset() ;

/// @brief Method get_emitOnce, addr 0x479422c, size 0x8, virtual false, abstract: false, final false
inline bool get_emitOnce() ;

/// @brief Method get_retroactive, addr 0x4794218, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_asset, addr 0x4794248, size 0x8, virtual false, abstract: false, final false
inline void set_asset(::UnityEngine::Timeline::SignalAsset*  value) ;

/// @brief Method set_emitOnce, addr 0x4794234, size 0xc, virtual false, abstract: false, final false
inline void set_emitOnce(bool  value) ;

/// @brief Method set_retroactive, addr 0x4794220, size 0xc, virtual false, abstract: false, final false
