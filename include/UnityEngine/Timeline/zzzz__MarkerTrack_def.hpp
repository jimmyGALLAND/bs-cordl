...
/// @brief Method .ctor, addr 0x4793fb0, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_outputs, addr 0x4793dcc, size 0x1e4, virtual true, abstract: false, final false
