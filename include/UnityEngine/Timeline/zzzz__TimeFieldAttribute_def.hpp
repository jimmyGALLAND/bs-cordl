...
/// @brief Field <useEditMode>k__BackingField, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__useEditMode_k__BackingField, put=__cordl_internal_set__useEditMode_k__BackingField)) ::UnityEngine::Timeline::__TimeFieldAttribute__UseEditMode  _useEditMode_k__BackingField;
...
/// @brief Method .ctor, addr 0x4798a30, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Timeline::__TimeFieldAttribute__UseEditMode  useEditMode) ;

/// @brief Method get_useEditMode, addr 0x4798a28, size 0x8, virtual false, abstract: false, final false
