...
#include "UnityEngine/Timeline/zzzz__IntervalTree_1_def.hpp"
// Ctor Parameters [CppParam { name: "intervalStart", ty: "int64_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "intervalEnd", ty: "int64_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "item", ty: "T", modifiers: "", def_value: Some("nullptr") }]
template<typename T>
constexpr ::UnityEngine::Timeline::__IntervalTree_1__Entry<T>::__IntervalTree_1__Entry(int64_t  intervalStart, int64_t  intervalEnd, T  item) noexcept  {
...
// Ctor Parameters []
template<typename T>
constexpr ::UnityEngine::Timeline::__IntervalTree_1__Entry<T>::__IntervalTree_1__Entry()   {
}
template<typename T>
...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Timeline::__IntervalTree_1__Entry<T>>*> const& UnityEngine::Timeline::IntervalTree_1<T>::__cordl_internal_get_m_Entries() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Entries;
}
template<typename T>
...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Timeline::IntervalTreeNode>*> const& UnityEngine::Timeline::IntervalTree_1<T>::__cordl_internal_get_m_Nodes() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Nodes;
}
template<typename T>
