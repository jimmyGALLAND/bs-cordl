...
/// @brief Method PrepareFrame, addr 0x478ccb8, size 0x2a8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x478cf60, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
