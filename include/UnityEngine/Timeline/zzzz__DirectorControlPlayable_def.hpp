...
/// @brief Method Create, addr 0x47905f4, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method DetectDiscontinuity, addr 0x4795c78, size 0x114, virtual false, abstract: false, final false
inline bool DetectDiscontinuity(::UnityEngine::Playables::Playable  playable, ::UnityEngine::Playables::FrameData  info) ;

/// @brief Method DetectOutOfSync, addr 0x4796350, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method OnBehaviourPause, addr 0x4796048, size 0x100, virtual true, abstract: false, final false
inline void OnBehaviourPause(::UnityEngine::Playables::Playable  playable, ::UnityEngine::Playables::FrameData  info) ;

/// @brief Method OnBehaviourPlay, addr 0x4795f74, size 0xd4, virtual true, abstract: false, final false
inline void OnBehaviourPlay(::UnityEngine::Playables::Playable  playable, ::UnityEngine::Playables::FrameData  info) ;

/// @brief Method OnPlayableDestroy, addr 0x4795a04, size 0xc0, virtual true, abstract: false, final false
inline void OnPlayableDestroy(::UnityEngine::Playables::Playable  playable) ;

/// @brief Method PrepareFrame, addr 0x4795ac4, size 0x1b4, virtual true, abstract: false, final false
inline void PrepareFrame(::UnityEngine::Playables::Playable  playable, ::UnityEngine::Playables::FrameData  info) ;

/// @brief Method ProcessFrame, addr 0x4796148, size 0x208, virtual true, abstract: false, final false
inline void ProcessFrame(::UnityEngine::Playables::Playable  playable, ::UnityEngine::Playables::FrameData  info, ::System::Object*  playerData) ;

/// @brief Method SyncSpeed, addr 0x4795d8c, size 0x128, virtual false, abstract: false, final false
inline void SyncSpeed(double_t  speed) ;

/// @brief Method SyncStart, addr 0x4795eb4, size 0xc0, virtual false, abstract: false, final false
inline void SyncStart(::UnityEngine::Playables::PlayableGraph  graph, double_t  time) ;

/// @brief Method SyncStop, addr 0x4796634, size 0xcc, virtual false, abstract: false, final false
inline void SyncStop(::UnityEngine::Playables::PlayableGraph  graph, double_t  time) ;

/// @brief Method UpdateTime, addr 0x479649c, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4796700, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
