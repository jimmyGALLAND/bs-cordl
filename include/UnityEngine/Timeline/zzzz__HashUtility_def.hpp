...
public:
// Declarations
/// @brief Method CombineHash, addr 0x479ae6c, size 0x1c, virtual false, abstract: false, final false
static inline int32_t CombineHash(int32_t  h1, int32_t  h2) ;

/// @brief Method CombineHash, addr 0x479ae88, size 0x2c, virtual false, abstract: false, final false
static inline int32_t CombineHash(int32_t  h1, int32_t  h2, int32_t  h3) ;

/// @brief Method CombineHash, addr 0x479aeb4, size 0x3c, virtual false, abstract: false, final false
static inline int32_t CombineHash(int32_t  h1, int32_t  h2, int32_t  h3, int32_t  h4) ;

/// @brief Method CombineHash, addr 0x479aef0, size 0x4c, virtual false, abstract: false, final false
static inline int32_t CombineHash(int32_t  h1, int32_t  h2, int32_t  h3, int32_t  h4, int32_t  h5) ;

/// @brief Method CombineHash, addr 0x479af3c, size 0x5c, virtual false, abstract: false, final false
static inline int32_t CombineHash(int32_t  h1, int32_t  h2, int32_t  h3, int32_t  h4, int32_t  h5, int32_t  h6) ;

/// @brief Method CombineHash, addr 0x479af98, size 0x2c, virtual false, abstract: false, final false
static inline int32_t CombineHash(int32_t  h1, int32_t  h2, int32_t  h3, int32_t  h4, int32_t  h5, int32_t  h6, int32_t  h7) ;

/// @brief Method CombineHash, addr 0x479afc4, size 0x6c, virtual false, abstract: false, final false
