...
/// @brief Method .ctor, addr 0x4792c38, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_duration, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
inline double_t get_duration() ;

/// @brief Method get_intervalEnd, addr 0x4793288, size 0x84, virtual true, abstract: false, final false
inline int64_t get_intervalEnd() ;

/// @brief Method get_intervalStart, addr 0x4793218, size 0x70, virtual true, abstract: false, final false
