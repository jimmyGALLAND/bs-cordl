...
/// @brief Method Append, addr 0x4794638, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method Remove, addr 0x4794cc4, size 0x94, virtual false, abstract: false, final false
inline void Remove(int32_t  idx) ;

/// @brief Method Remove, addr 0x4794880, size 0xc0, virtual false, abstract: false, final false
inline void Remove(::UnityEngine::Timeline::SignalAsset*  key) ;

/// @brief Method TryGetValue, addr 0x479444c, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4794fe4, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_events, addr 0x47950b0, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::Events::UnityEvent*>* get_events() ;

/// @brief Method get_signals, addr 0x47950a8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AddEmptyReaction, addr 0x4794758, size 0x6c, virtual false, abstract: false, final false
inline int32_t AddEmptyReaction(::UnityEngine::Events::UnityEvent*  reaction) ;

/// @brief Method AddReaction, addr 0x4794500, size 0x138, virtual false, abstract: false, final false
inline void AddReaction(::UnityEngine::Timeline::SignalAsset*  asset, ::UnityEngine::Events::UnityEvent*  reaction) ;

/// @brief Method ChangeReactionAtIndex, addr 0x4794d58, size 0xc4, virtual false, abstract: false, final false
inline void ChangeReactionAtIndex(int32_t  idx, ::UnityEngine::Events::UnityEvent*  reaction) ;

/// @brief Method ChangeSignalAtIndex, addr 0x47949dc, size 0x24c, virtual false, abstract: false, final false
inline void ChangeSignalAtIndex(int32_t  idx, ::UnityEngine::Timeline::SignalAsset*  newKey) ;

/// @brief Method Count, addr 0x479498c, size 0x50, virtual false, abstract: false, final false
inline int32_t Count() ;

/// @brief Method GetReaction, addr 0x479495c, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::Events::UnityEvent* GetReaction(::UnityEngine::Timeline::SignalAsset*  key) ;

/// @brief Method GetReactionAtIndex, addr 0x4794e1c, size 0xb4, virtual false, abstract: false, final false
inline ::UnityEngine::Events::UnityEvent* GetReactionAtIndex(int32_t  idx) ;

/// @brief Method GetRegisteredSignals, addr 0x4794940, size 0x1c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Timeline::SignalAsset>>* GetRegisteredSignals() ;

/// @brief Method GetSignalAssetAtIndex, addr 0x4794ed0, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method OnEnable, addr 0x4794f84, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnNotify, addr 0x4794334, size 0x118, virtual true, abstract: false, final true
...
/// @brief Method Remove, addr 0x47947c4, size 0xbc, virtual false, abstract: false, final false
inline void Remove(::UnityEngine::Timeline::SignalAsset*  asset) ;

/// @brief Method RemoveAtIndex, addr 0x4794c28, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4794f88, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
