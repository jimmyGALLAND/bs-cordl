...
/// @brief Field m_Mixers, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Mixers, put=__cordl_internal_set_m_Mixers)) ::System::Collections::Generic::List_1<::UnityEngine::Timeline::__AnimationOutputWeightProcessor__WeightInfo>*  m_Mixers;
...
/// @brief Method Evaluate, addr 0x477add4, size 0x160, virtual true, abstract: false, final true
inline void Evaluate() ;

/// @brief Method FindMixers, addr 0x477a9f8, size 0xe8, virtual false, abstract: false, final false
inline void FindMixers() ;

/// @brief Method FindMixers, addr 0x477aae0, size 0x2f4, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Timeline::__AnimationOutputWeightProcessor__WeightInfo>*> const& __cordl_internal_get_m_Mixers() const;
...
/// @brief Method .ctor, addr 0x477a938, size 0xc0, virtual false, abstract: false, final false
