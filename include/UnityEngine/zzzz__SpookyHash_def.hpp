...
/// @brief Method .ctor, addr 0x4807dfc, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "p8", ty: "::cordl_internals::Ptr<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "p32", ty: "::cordl_internals::Ptr<uint32_t>", modifiers: "", def_value: None }, CppParam { name: "p64", ty: "::cordl_internals::Ptr<uint64_t>", modifiers: "", def_value: None }, CppParam { name: "i", ty: "uint64_t", modifiers: "", def_value: None }]
...
/// @brief Method AttemptDetectAllowUnalignedRead, addr 0x48079e4, size 0x88, virtual false, abstract: false, final false
static inline bool AttemptDetectAllowUnalignedRead() ;

/// @brief Method End, addr 0x4808328, size 0x26c, virtual false, abstract: false, final false
static inline void End(::cordl_internals::Ptr<uint64_t>  data, ByRef<uint64_t>  h0, ByRef<uint64_t>  h1, ByRef<uint64_t>  h2, ByRef<uint64_t>  h3, ByRef<uint64_t>  h4, ByRef<uint64_t>  h5, ByRef<uint64_t>  h6, ByRef<uint64_t>  h7, ByRef<uint64_t>  h8, ByRef<uint64_t>  h9, ByRef<uint64_t>  h10, ByRef<uint64_t>  h11) ;

/// @brief Method EndPartial, addr 0x4808594, size 0x298, virtual false, abstract: false, final false
...
/// @brief Method Hash, addr 0x480769c, size 0x308, virtual false, abstract: false, final false
...
/// @brief Method Mix, addr 0x4807e04, size 0x44c, virtual false, abstract: false, final false
static inline void Mix(::cordl_internals::Ptr<uint64_t>  data, ByRef<uint64_t>  s0, ByRef<uint64_t>  s1, ByRef<uint64_t>  s2, ByRef<uint64_t>  s3, ByRef<uint64_t>  s4, ByRef<uint64_t>  s5, ByRef<uint64_t>  s6, ByRef<uint64_t>  s7, ByRef<uint64_t>  s8, ByRef<uint64_t>  s9, ByRef<uint64_t>  s10, ByRef<uint64_t>  s11) ;

/// @brief Method Rot64, addr 0x480882c, size 0x14, virtual false, abstract: false, final false
static inline void Rot64(ByRef<uint64_t>  x, int32_t  k) ;

/// @brief Method Short, addr 0x4807a6c, size 0x390, virtual false, abstract: false, final false
...
/// @brief Method ShortEnd, addr 0x4808a5c, size 0x1fc, virtual false, abstract: false, final false
static inline void ShortEnd(ByRef<uint64_t>  h0, ByRef<uint64_t>  h1, ByRef<uint64_t>  h2, ByRef<uint64_t>  h3) ;

/// @brief Method ShortMix, addr 0x4808840, size 0x21c, virtual false, abstract: false, final false
...
/// @brief Method memset, addr 0x4808250, size 0xd8, virtual false, abstract: false, final false
