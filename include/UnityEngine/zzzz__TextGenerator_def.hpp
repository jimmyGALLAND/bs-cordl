...
/// @brief Method Finalize, addr 0x48bd25c, size 0x110, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetCharacters, addr 0x48bd778, size 0x44, virtual false, abstract: false, final false
inline void GetCharacters(::System::Collections::Generic::List_1<::UnityEngine::UICharInfo>*  characters) ;

/// @brief Method GetCharactersInternal, addr 0x48bd7bc, size 0x44, virtual false, abstract: false, final false
inline void GetCharactersInternal(::System::Object*  characters) ;

/// @brief Method GetLines, addr 0x48bd800, size 0x44, virtual false, abstract: false, final false
inline void GetLines(::System::Collections::Generic::List_1<::UnityEngine::UILineInfo>*  lines) ;

/// @brief Method GetLinesInternal, addr 0x48bd844, size 0x44, virtual false, abstract: false, final false
inline void GetLinesInternal(::System::Object*  lines) ;

/// @brief Method GetPreferredHeight, addr 0x48bda1c, size 0x60, virtual false, abstract: false, final false
inline float_t GetPreferredHeight(::StringW  str, ::UnityEngine::TextGenerationSettings  settings) ;

/// @brief Method GetPreferredWidth, addr 0x48bd910, size 0x64, virtual false, abstract: false, final false
inline float_t GetPreferredWidth(::StringW  str, ::UnityEngine::TextGenerationSettings  settings) ;

/// @brief Method GetVertices, addr 0x48bd888, size 0x44, virtual false, abstract: false, final false
inline void GetVertices(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>*  vertices) ;

/// @brief Method GetVerticesInternal, addr 0x48bd8cc, size 0x44, virtual false, abstract: false, final false
inline void GetVerticesInternal(::System::Object*  vertices) ;

/// @brief Method Internal_Create, addr 0x48bd234, size 0x28, virtual false, abstract: false, final false
static inline ::System::IntPtr Internal_Create() ;

/// @brief Method Internal_Destroy, addr 0x48bd3c8, size 0x3c, virtual false, abstract: false, final false
static inline void Internal_Destroy(::System::IntPtr  ptr) ;

/// @brief Method Invalidate, addr 0x48bd770, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Populate, addr 0x48bd974, size 0x50, virtual false, abstract: false, final false
inline bool Populate(::StringW  str, ::UnityEngine::TextGenerationSettings  settings) ;

/// @brief Method PopulateAlways, addr 0x48bdcc4, size 0x108, virtual false, abstract: false, final false
inline ::UnityEngine::TextGenerationError PopulateAlways(::StringW  str, ::UnityEngine::TextGenerationSettings  settings) ;

/// @brief Method PopulateWithError, addr 0x48bdc34, size 0x90, virtual false, abstract: false, final false
inline ::UnityEngine::TextGenerationError PopulateWithError(::StringW  str, ::UnityEngine::TextGenerationSettings  settings) ;

/// @brief Method PopulateWithErrors, addr 0x48bda7c, size 0x1b8, virtual false, abstract: false, final false
inline bool PopulateWithErrors(::StringW  str, ::UnityEngine::TextGenerationSettings  settings, ::UnityEngine::GameObject*  context) ;

/// @brief Method Populate_Internal, addr 0x48bddcc, size 0x1a8, virtual false, abstract: false, final false
...
/// @brief Method Populate_Internal, addr 0x48be108, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method Populate_Internal_Injected, addr 0x48be254, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method System.IDisposable.Dispose, addr 0x48bd36c, size 0x5c, virtual true, abstract: false, final true
inline void System_IDisposable_Dispose() ;

/// @brief Method ValidatedSettings, addr 0x48bd484, size 0x2b0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x48bd0e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x48bd0e8, size 0x14c, virtual false, abstract: false, final false
inline void _ctor(int32_t  initialCapacity) ;

/// @brief Method get_characterCount, addr 0x48bd448, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_characterCount() ;

/// @brief Method get_characterCountVisible, addr 0x48bd404, size 0x44, virtual false, abstract: false, final false
inline int32_t get_characterCountVisible() ;

/// @brief Method get_characters, addr 0x48bdfd0, size 0x5c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IList_1<::UnityEngine::UICharInfo>* get_characters() ;

/// @brief Method get_lineCount, addr 0x48be0cc, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_lineCount() ;

/// @brief Method get_lines, addr 0x48be02c, size 0x5c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IList_1<::UnityEngine::UILineInfo>* get_lines() ;

/// @brief Method get_rectExtents, addr 0x48bd9c4, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_rectExtents() ;

/// @brief Method get_rectExtents_Injected, addr 0x48be088, size 0x44, virtual false, abstract: false, final false
inline void get_rectExtents_Injected(ByRef<::UnityEngine::Rect>  ret) ;

/// @brief Method get_verts, addr 0x48bdf74, size 0x5c, virtual false, abstract: false, final false
