...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint32_t (::UnityEngine::BlendShape::*)()>(&::UnityEngine::BlendShape::get_firstVertex)> {
  ...
  constexpr static std::size_t addrs = 0x47fa47c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::BlendShape>::get(),
                        "get_firstVertex",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint32_t (::UnityEngine::BlendShape::*)()>(&::UnityEngine::BlendShape::get_vertexCount)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x47fa48c;
...
// Ctor Parameters [CppParam { name: "m_FirstVertex", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_VertexCount", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_HasNormals", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_HasTangents", ty: "bool", modifiers: "", def_value: Some("{}") }]
