...
/// @brief Method ResetCursor, addr 0x4847e58, size 0x2dc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4847084, size 0xcc, virtual false, abstract: false, final false
inline void _ctor(int32_t  instanceID) ;

/// @brief Method set_id, addr 0x4847e50, size 0x8, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF_s_StoredLayouts, put=setStaticF_s_StoredLayouts)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::__GUILayoutUtility__LayoutCache*>*  s_StoredLayouts;

/// @brief Field s_StoredWindows, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_StoredWindows, put=setStaticF_s_StoredWindows)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::__GUILayoutUtility__LayoutCache*>*  s_StoredWindows;

/// @brief Method Begin, addr 0x4847224, size 0x1cc, virtual false, abstract: false, final false
static inline void Begin(int32_t  instanceID) ;

/// @brief Method BeginContainer, addr 0x48474fc, size 0x15c, virtual false, abstract: false, final false
static inline void BeginContainer(::UnityEngine::__GUILayoutUtility__LayoutCache*  cache) ;

/// @brief Method BeginWindow, addr 0x4846264, size 0x278, virtual false, abstract: false, final false
...
/// @brief Method GetLayoutCache, addr 0x4846fdc, size 0xa8, virtual false, abstract: false, final false
static inline ::UnityEngine::__GUILayoutUtility__LayoutCache* GetLayoutCache(int32_t  instanceID, bool  isWindow) ;

/// @brief Method Internal_GetWindowRect, addr 0x4846e38, size 0x90, virtual false, abstract: false, final false
static inline ::UnityEngine::Rect Internal_GetWindowRect(int32_t  windowID) ;

/// @brief Method Internal_GetWindowRect_Injected, addr 0x4846ec8, size 0x44, virtual false, abstract: false, final false
static inline void Internal_GetWindowRect_Injected(int32_t  windowID, ByRef<::UnityEngine::Rect>  ret) ;

/// @brief Method Internal_MoveWindow, addr 0x4846f0c, size 0x8c, virtual false, abstract: false, final false
static inline void Internal_MoveWindow(int32_t  windowID, ::UnityEngine::Rect  r) ;

/// @brief Method Internal_MoveWindow_Injected, addr 0x4846f98, size 0x44, virtual false, abstract: false, final false
static inline void Internal_MoveWindow_Injected(int32_t  windowID, ByRef<::UnityEngine::Rect>  r) ;

/// @brief Method Layout, addr 0x4846564, size 0x21c, virtual false, abstract: false, final false
static inline void Layout() ;

/// @brief Method LayoutFreeGroup, addr 0x4847690, size 0x1bc, virtual false, abstract: false, final false
static inline void LayoutFreeGroup(::UnityEngine::GUILayoutGroup*  toplevel) ;

/// @brief Method LayoutFromContainer, addr 0x4847bd4, size 0x188, virtual false, abstract: false, final false
static inline void LayoutFromContainer(float_t  w, float_t  h) ;

/// @brief Method LayoutFromEditorWindow, addr 0x48479c4, size 0x210, virtual false, abstract: false, final false
static inline void LayoutFromEditorWindow() ;

/// @brief Method LayoutSingleGroup, addr 0x484784c, size 0x178, virtual false, abstract: false, final false
static inline void LayoutSingleGroup(::UnityEngine::GUILayoutGroup*  i) ;

/// @brief Method RemoveSelectedIdList, addr 0x4847150, size 0xd4, virtual false, abstract: false, final false
static inline void RemoveSelectedIdList(int32_t  instanceID, bool  isWindow) ;

/// @brief Method SelectIDList, addr 0x4845ff4, size 0x144, virtual false, abstract: false, final false
