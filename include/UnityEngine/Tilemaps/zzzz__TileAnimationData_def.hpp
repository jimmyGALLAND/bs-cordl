...
// Ctor Parameters [CppParam { name: "m_AnimatedSprites", ty: "::ArrayW<::UnityW<::UnityEngine::Sprite>,::Array<::UnityW<::UnityEngine::Sprite>>*>", modifiers: "", def_value: None }, CppParam { name: "m_AnimationSpeed", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_AnimationStartTime", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_Flags", ty: "::UnityEngine::Tilemaps::TileAnimationFlags", modifiers: "", def_value: None }]
constexpr TileAnimationData(::ArrayW<::UnityW<::UnityEngine::Sprite>,::Array<::UnityW<::UnityEngine::Sprite>>*>  m_AnimatedSprites, float_t  m_AnimationSpeed, float_t  m_AnimationStartTime, ::UnityEngine::Tilemaps::TileAnimationFlags  m_Flags) noexcept;
