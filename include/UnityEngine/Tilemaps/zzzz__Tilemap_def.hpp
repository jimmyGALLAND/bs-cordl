...
static __declspec(property(get=getStaticF_tilemapPositionsChanged, put=setStaticF_tilemapPositionsChanged)) ::System::Action_2<::UnityW<::UnityEngine::Tilemaps::Tilemap>,::Unity::Collections::NativeArray_1<::UnityEngine::Vector3Int>>*  tilemapPositionsChanged;

/// @brief Field tilemapTileChanged, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_tilemapTileChanged, put=setStaticF_tilemapTileChanged)) ::System::Action_2<::UnityW<::UnityEngine::Tilemaps::Tilemap>,::ArrayW<::UnityEngine::Tilemaps::__Tilemap__SyncTile,::Array<::UnityEngine::Tilemaps::__Tilemap__SyncTile>*>>*  tilemapTileChanged;

/// @brief Method DoPositionsChangedCallback, addr 0x48c0ad0, size 0x4, virtual false, abstract: false, final false
inline void DoPositionsChangedCallback(int32_t  count, ::System::IntPtr  positionsIntPtr) ;

/// @brief Method DoSyncTileCallback, addr 0x48c0acc, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method GetSyncTileCallbackSettings, addr 0x48c0a2c, size 0xa0, virtual false, abstract: false, final false
...
template<typename T>
inline T GetTile(::UnityEngine::Vector3Int  position) ;

/// @brief Method GetTileAsset, addr 0x48c05d0, size 0x54, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Object> GetTileAsset(::UnityEngine::Vector3Int  position) ;

/// @brief Method GetTileAsset_Injected, addr 0x48c0624, size 0x44, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Object> GetTileAsset_Injected(ByRef<::UnityEngine::Vector3Int>  position) ;

/// @brief Method GetTileAssetsBlock, addr 0x48c0668, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method GetTileAssetsBlock_Injected, addr 0x48c06c8, size 0x54, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::Object>,::Array<::UnityW<::UnityEngine::Object>>*> GetTileAssetsBlock_Injected(ByRef<::UnityEngine::Vector3Int>  position, ByRef<::UnityEngine::Vector3Int>  blockDimensions) ;

/// @brief Method GetTilesBlock, addr 0x48c071c, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method GetUsedTilesCount, addr 0x48c0968, size 0x3c, virtual false, abstract: false, final false
inline int32_t GetUsedTilesCount() ;

/// @brief Method GetUsedTilesNonAlloc, addr 0x48c09a4, size 0x44, virtual false, abstract: false, final false
inline int32_t GetUsedTilesNonAlloc(::ArrayW<::UnityEngine::Tilemaps::TileBase*,::Array<::UnityEngine::Tilemaps::TileBase*>*>  usedTiles) ;

/// @brief Method HandlePositionsChangedCallback, addr 0x48c00ec, size 0xac, virtual false, abstract: false, final false
inline void HandlePositionsChangedCallback(int32_t  count, ::System::IntPtr  positionsIntPtr) ;

/// @brief Method HandleSyncTileCallback, addr 0x48bff5c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method HasPositionsChangedCallback, addr 0x48bff0c, size 0x50, virtual false, abstract: false, final false
static inline bool HasPositionsChangedCallback() ;

/// @brief Method HasSyncTileCallback, addr 0x48bfebc, size 0x50, virtual false, abstract: false, final false
static inline bool HasSyncTileCallback() ;

/// @brief Method HasTile, addr 0x48c08a0, size 0x84, virtual false, abstract: false, final false
inline bool HasTile(::UnityEngine::Vector3Int  position) ;

/// @brief Method Internal_GetUsedTilesNonAlloc, addr 0x48c09e8, size 0x44, virtual false, abstract: false, final false
inline int32_t Internal_GetUsedTilesNonAlloc(::ArrayW<::UnityEngine::Object*,::Array<::UnityEngine::Object*>*>  usedTiles) ;

/// @brief Method RefreshTile, addr 0x48bf4a8, size 0x54, virtual false, abstract: false, final false
inline void RefreshTile(::UnityEngine::Vector3Int  position) ;

/// @brief Method RefreshTile_Injected, addr 0x48c0924, size 0x44, virtual false, abstract: false, final false
inline void RefreshTile_Injected(ByRef<::UnityEngine::Vector3Int>  position) ;

/// @brief Method RefreshTilesNative, addr 0x48bf86c, size 0x54, virtual false, abstract: false, final false
inline void RefreshTilesNative(::cordl_internals::Ptr<void>  positions, int32_t  count) ;

/// @brief Method SendTilemapPositionsChangedCallback, addr 0x48c0198, size 0x124, virtual false, abstract: false, final false
inline void SendTilemapPositionsChangedCallback(::Unity::Collections::NativeArray_1<::UnityEngine::Vector3Int>  positions) ;

/// @brief Method SendTilemapTileChangedCallback, addr 0x48bffd0, size 0x11c, virtual false, abstract: false, final false
...
static inline ::System::Action_2<::UnityW<::UnityEngine::Tilemaps::Tilemap>,::ArrayW<::UnityEngine::Tilemaps::__Tilemap__SyncTile,::Array<::UnityEngine::Tilemaps::__Tilemap__SyncTile>*>>* getStaticF_tilemapTileChanged() ;

/// @brief Method get_bufferSyncTile, addr 0x48bfeb4, size 0x8, virtual false, abstract: false, final false
inline bool get_bufferSyncTile() ;

/// @brief Method get_cellBounds, addr 0x48c02f8, size 0x48, virtual false, abstract: false, final false
inline ::UnityEngine::BoundsInt get_cellBounds() ;

/// @brief Method get_layoutGrid, addr 0x48c02bc, size 0x3c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Grid> get_layoutGrid() ;

/// @brief Method get_orientationMatrix, addr 0x48c0520, size 0x6c, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_orientationMatrix() ;

/// @brief Method get_orientationMatrix_Injected, addr 0x48c058c, size 0x44, virtual false, abstract: false, final false
inline void get_orientationMatrix_Injected(ByRef<::UnityEngine::Matrix4x4>  ret) ;

/// @brief Method get_origin, addr 0x48c0340, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3Int get_origin() ;

/// @brief Method get_origin_Injected, addr 0x48c03f8, size 0x44, virtual false, abstract: false, final false
inline void get_origin_Injected(ByRef<::UnityEngine::Vector3Int>  ret) ;

/// @brief Method get_size, addr 0x48c039c, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3Int get_size() ;

/// @brief Method get_size_Injected, addr 0x48c043c, size 0x44, virtual false, abstract: false, final false
inline void get_size_Injected(ByRef<::UnityEngine::Vector3Int>  ret) ;

/// @brief Method get_tileAnchor, addr 0x48c0480, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_tileAnchor() ;

/// @brief Method get_tileAnchor_Injected, addr 0x48c04dc, size 0x44, virtual false, abstract: false, final false
...
static inline void setStaticF_tilemapTileChanged(::System::Action_2<::UnityW<::UnityEngine::Tilemaps::Tilemap>,::ArrayW<::UnityEngine::Tilemaps::__Tilemap__SyncTile,::Array<::UnityEngine::Tilemaps::__Tilemap__SyncTile>*>>*  value) ;
