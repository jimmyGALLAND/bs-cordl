...
public:
// Declarations
/// @brief Method OnSpriteAtlasRegistered, addr 0x48c0bd4, size 0x44, virtual false, abstract: false, final false
inline void OnSpriteAtlasRegistered(::UnityEngine::U2D::SpriteAtlas*  atlas) ;

/// @brief Method RegisterSpriteAtlasRegistered, addr 0x48c0ad4, size 0x80, virtual false, abstract: false, final false
inline void RegisterSpriteAtlasRegistered() ;

/// @brief Method UnregisterSpriteAtlasRegistered, addr 0x48c0b54, size 0x80, virtual false, abstract: false, final false
