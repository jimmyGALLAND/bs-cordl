...
/// @brief Method Destroy, addr 0x4884bfc, size 0x74, virtual true, abstract: false, final true
inline void Destroy() ;
...
/// @brief Method .ctor, addr 0x4884cf0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
