...
static __declspec(property(get=getStaticF_s_DeprecatedSubsystems, put=setStaticF_s_DeprecatedSubsystems)) ::System::Collections::Generic::List_1<::UnityEngine::Subsystem*>*  s_DeprecatedSubsystems;

/// @brief Field s_IntegratedSubsystems, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_IntegratedSubsystems, put=setStaticF_s_IntegratedSubsystems)) ::System::Collections::Generic::List_1<::UnityEngine::IntegratedSubsystem*>*  s_IntegratedSubsystems;

/// @brief Field s_StandaloneSubsystems, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_StandaloneSubsystems, put=setStaticF_s_StandaloneSubsystems)) ::System::Collections::Generic::List_1<::UnityEngine::SubsystemsImplementation::SubsystemWithProvider*>*  s_StandaloneSubsystems;
...
/// @brief Method ClearSubsystems, addr 0x48850a4, size 0x24c, virtual false, abstract: false, final false
...
/// @brief Method GetIntegratedSubsystemByPtr, addr 0x4885460, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method InitializeIntegratedSubsystem, addr 0x4884fa0, size 0x104, virtual false, abstract: false, final false
static inline void InitializeIntegratedSubsystem(::System::IntPtr  ptr, ::UnityEngine::IntegratedSubsystem*  subsystem) ;

/// @brief Method ReloadSubsystemsCompleted, addr 0x4884ec0, size 0xe0, virtual false, abstract: false, final false
static inline void ReloadSubsystemsCompleted() ;

/// @brief Method ReloadSubsystemsStarted, addr 0x4884de0, size 0xe0, virtual false, abstract: false, final false
static inline void ReloadSubsystemsStarted() ;

/// @brief Method RemoveDeprecatedSubsystem, addr 0x4884c70, size 0x80, virtual false, abstract: false, final false
static inline bool RemoveDeprecatedSubsystem(::UnityEngine::Subsystem*  subsystem) ;

/// @brief Method RemoveIntegratedSubsystemByPtr, addr 0x48848ec, size 0x158, virtual false, abstract: false, final false
static inline void RemoveIntegratedSubsystemByPtr(::System::IntPtr  ptr) ;

/// @brief Method RemoveStandaloneSubsystem, addr 0x48855e4, size 0x80, virtual false, abstract: false, final false
static inline bool RemoveStandaloneSubsystem(::UnityEngine::SubsystemsImplementation::SubsystemWithProvider*  subsystem) ;

/// @brief Method StaticConstructScriptingClassMap, addr 0x48852f0, size 0x28, virtual false, abstract: false, final false
