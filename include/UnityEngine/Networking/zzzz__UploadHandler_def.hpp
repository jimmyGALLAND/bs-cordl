...
/// @brief Method Dispose, addr 0x4a51080, size 0x58, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method Release, addr 0x4a51044, size 0x3c, virtual false, abstract: false, final false
inline void Release() ;
