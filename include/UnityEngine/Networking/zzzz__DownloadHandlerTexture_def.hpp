...
/// @brief Method Create, addr 0x4a510d8, size 0x44, virtual false, abstract: false, final false
static inline ::System::IntPtr Create(::UnityEngine::Networking::DownloadHandlerTexture*  obj, bool  readable) ;

/// @brief Method Dispose, addr 0x4a511d4, size 0x24, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method GetContent, addr 0x4a51270, size 0x7c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Texture2D> GetContent(::UnityEngine::Networking::UnityWebRequest*  www) ;

/// @brief Method GetNativeData, addr 0x4a511c8, size 0xc, virtual true, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<uint8_t> GetNativeData() ;

/// @brief Method InternalCreateTexture, addr 0x4a5111c, size 0x4c, virtual false, abstract: false, final false
inline void InternalCreateTexture(bool  readable) ;

/// @brief Method InternalGetTextureNative, addr 0x4a51234, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a51168, size 0x60, virtual false, abstract: false, final false
inline void _ctor(bool  readable) ;

/// @brief Method get_texture, addr 0x4a511f8, size 0x3c, virtual false, abstract: false, final false
