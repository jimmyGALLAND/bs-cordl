...
/// @brief Method <Register>b__0, addr 0x4830838, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x482f27c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <Unregister>b__0, addr 0x48308ac, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x482f5fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <BlockUntilRecvMsg>b__0, addr 0x48308f4, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x482ff10, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method BlockUntilRecvMsg, addr 0x482fcdc, size 0x234, virtual false, abstract: false, final false
inline bool BlockUntilRecvMsg(::System::Guid  messageId, int32_t  timeout) ;

/// @brief Method ConnectedCallbackInternal, addr 0x4830570, size 0xd8, virtual false, abstract: false, final false
static inline void ConnectedCallbackInternal(int32_t  playerId) ;

/// @brief Method CreateInstance, addr 0x482ede8, size 0x84, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Networking::PlayerConnection::PlayerConnection> CreateInstance() ;

/// @brief Method DisconnectAll, addr 0x482ff18, size 0x9c, virtual true, abstract: false, final true
inline void DisconnectAll() ;

/// @brief Method DisconnectedCallback, addr 0x4830648, size 0x94, virtual false, abstract: false, final false
static inline void DisconnectedCallback(int32_t  playerId) ;

/// @brief Method GetConnectionNativeApi, addr 0x482ef08, size 0x78, virtual false, abstract: false, final false
inline ::UnityEngine::IPlayerEditorConnectionNative* GetConnectionNativeApi() ;

/// @brief Method MessageCallbackInternal, addr 0x482ffb4, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method OnEnable, addr 0x482ef80, size 0xc0, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Register, addr 0x482f040, size 0x23c, virtual true, abstract: false, final true
...
/// @brief Method RegisterConnection, addr 0x482f76c, size 0x1a0, virtual true, abstract: false, final true
inline void RegisterConnection(::UnityEngine::Events::UnityAction_1<int32_t>*  callback) ;

/// @brief Method RegisterDisconnection, addr 0x482f90c, size 0x60, virtual true, abstract: false, final true
inline void RegisterDisconnection(::UnityEngine::Events::UnityAction_1<int32_t>*  callback) ;

/// @brief Method Send, addr 0x482fa2c, size 0x158, virtual true, abstract: false, final true
inline void Send(::System::Guid  messageId, ::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method TrySend, addr 0x482fb84, size 0x158, virtual true, abstract: false, final true
inline bool TrySend(::System::Guid  messageId, ::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method Unregister, addr 0x482f458, size 0x1a4, virtual true, abstract: false, final true
...
/// @brief Method UnregisterConnection, addr 0x482f96c, size 0x60, virtual true, abstract: false, final true
inline void UnregisterConnection(::UnityEngine::Events::UnityAction_1<int32_t>*  callback) ;

/// @brief Method UnregisterDisconnection, addr 0x482f9cc, size 0x60, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x48306dc, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_instance, addr 0x482ed50, size 0x98, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Networking::PlayerConnection::PlayerConnection> get_instance() ;

/// @brief Method get_isConnected, addr 0x482ee6c, size 0x9c, virtual false, abstract: false, final false
