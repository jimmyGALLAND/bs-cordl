...
/// @brief Method AddListener, addr 0x482bf54, size 0xa8, virtual false, abstract: false, final false
inline void AddListener(::UnityEngine::Events::BaseInvokableCall*  call) ;

/// @brief Method AddPersistentInvokableCall, addr 0x482beac, size 0xa8, virtual false, abstract: false, final false
inline void AddPersistentInvokableCall(::UnityEngine::Events::BaseInvokableCall*  call) ;

/// @brief Method Clear, addr 0x482c26c, size 0xbc, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ClearPersistent, addr 0x482c328, size 0xbc, virtual false, abstract: false, final false
inline void ClearPersistent() ;

static inline ::UnityEngine::Events::InvokableCallList* New_ctor() ;

/// @brief Method PrepareInvoke, addr 0x482c3e4, size 0xb4, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::Events::BaseInvokableCall*>* PrepareInvoke() ;

/// @brief Method RemoveListener, addr 0x482bffc, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x482c498, size 0xb4, virtual false, abstract: false, final false
inline void _ctor() ;
