...
template<typename T1,typename T2,typename T3,typename T4>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Events::UnityAction_4<T1,T2,T3,T4>*> const& UnityEngine::Events::InvokableCall_4<T1,T2,T3,T4>::__cordl_internal_get_Delegate() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___Delegate;
}
template<typename T1,typename T2,typename T3,typename T4>
