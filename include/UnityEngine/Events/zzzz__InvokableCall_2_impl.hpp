...
template<typename T1,typename T2>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Events::UnityAction_2<T1,T2>*> const& UnityEngine::Events::InvokableCall_2<T1,T2>::__cordl_internal_get_Delegate() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___Delegate;
}
template<typename T1,typename T2>
