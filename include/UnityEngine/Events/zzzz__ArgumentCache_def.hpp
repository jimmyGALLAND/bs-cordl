...
/// @brief Method OnAfterDeserialize, addr 0x482ace4, size 0x1c, virtual true, abstract: false, final true
inline void OnAfterDeserialize() ;

/// @brief Method OnBeforeSerialize, addr 0x482acc8, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x482ad00, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_boolArgument, addr 0x482acc0, size 0x8, virtual false, abstract: false, final false
inline bool get_boolArgument() ;

/// @brief Method get_floatArgument, addr 0x482acb0, size 0x8, virtual false, abstract: false, final false
inline float_t get_floatArgument() ;

/// @brief Method get_intArgument, addr 0x482aca8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_intArgument() ;

/// @brief Method get_stringArgument, addr 0x482acb8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_stringArgument() ;

/// @brief Method get_unityObjectArgument, addr 0x482ac98, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Object> get_unityObjectArgument() ;

/// @brief Method get_unityObjectArgumentAssemblyTypeName, addr 0x482aca0, size 0x8, virtual false, abstract: false, final false
