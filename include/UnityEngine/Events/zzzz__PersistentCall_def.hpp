...
/// @brief Method GetObjectCall, addr 0x482b780, size 0x430, virtual false, abstract: false, final false
...
/// @brief Method GetRuntimeCall, addr 0x482b2c4, size 0x2ec, virtual false, abstract: false, final false
inline ::UnityEngine::Events::BaseInvokableCall* GetRuntimeCall(::UnityEngine::Events::UnityEventBase*  theEvent) ;

/// @brief Method IsValid, addr 0x482b288, size 0x3c, virtual false, abstract: false, final false
inline bool IsValid() ;

static inline ::UnityEngine::Events::PersistentCall* New_ctor() ;

/// @brief Method OnAfterDeserialize, addr 0x482bbcc, size 0x1c, virtual true, abstract: false, final true
inline void OnAfterDeserialize() ;

/// @brief Method OnBeforeSerialize, addr 0x482bbb0, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x482bbe8, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_arguments, addr 0x482b280, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Events::ArgumentCache* get_arguments() ;

/// @brief Method get_methodName, addr 0x482b270, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_methodName() ;

/// @brief Method get_mode, addr 0x482b278, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Events::PersistentListenerMode get_mode() ;

/// @brief Method get_target, addr 0x482b1bc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Object> get_target() ;

/// @brief Method get_targetAssemblyTypeName, addr 0x482b1c4, size 0xac, virtual false, abstract: false, final false
