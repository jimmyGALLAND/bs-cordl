...
/// @brief Method BroadcastMessage, addr 0x4817870, size 0x5c, virtual false, abstract: false, final false
inline void BroadcastMessage(::StringW  methodName, ::System::Object*  parameter, ::UnityEngine::SendMessageOptions  options) ;

/// @brief Method CompareTag, addr 0x4817700, size 0x78, virtual false, abstract: false, final false
inline bool CompareTag(::StringW  tag) ;

/// @brief Method GetComponent, addr 0x4816fd4, size 0x44, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Component> GetComponent(::StringW  type) ;

/// @brief Method GetComponent, addr 0x4816dc8, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method GetComponentFastPath, addr 0x4816e84, size 0x54, virtual false, abstract: false, final false
inline void GetComponentFastPath(::System::Type*  type, ::System::IntPtr  oneFurtherThanResultValue) ;

/// @brief Method GetComponentInChildren, addr 0x4817018, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method GetComponentInParent, addr 0x4817208, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method GetComponents, addr 0x48173f8, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method GetComponents, addr 0x4817544, size 0x54, virtual false, abstract: false, final false
inline void GetComponents(::System::Type*  type, ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Component>>*  results) ;

/// @brief Method GetComponentsForListInternal, addr 0x48174f0, size 0x54, virtual false, abstract: false, final false
inline void GetComponentsForListInternal(::System::Type*  searchType, ::System::Object*  resultList) ;

/// @brief Method GetComponentsInChildren, addr 0x48170f4, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method GetComponentsInParent, addr 0x48172e4, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method SendMessage, addr 0x4817818, size 0x58, virtual false, abstract: false, final false
inline void SendMessage(::StringW  methodName, ::UnityEngine::SendMessageOptions  options) ;

/// @brief Method SendMessage, addr 0x48177bc, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method TryGetComponent, addr 0x4816ed8, size 0x60, virtual false, abstract: false, final false
inline bool TryGetComponent(::System::Type*  type, ByRef<::UnityEngine::Component*>  component) ;

/// @brief Method .ctor, addr 0x4816354, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_gameObject, addr 0x4816d8c, size 0x3c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_gameObject() ;

/// @brief Method get_tag, addr 0x4817598, size 0x70, virtual false, abstract: false, final false
inline ::StringW get_tag() ;

/// @brief Method get_transform, addr 0x4816d50, size 0x3c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_transform() ;

/// @brief Method set_tag, addr 0x4817644, size 0x78, virtual false, abstract: false, final false
