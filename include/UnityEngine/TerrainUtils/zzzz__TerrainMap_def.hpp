...
/// @brief Method <CreateFromPlacement>b__0, addr 0x4889f64, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4888fcc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddTerrainInternal, addr 0x48896c0, size 0x128, virtual false, abstract: false, final false
inline void AddTerrainInternal(int32_t  x, int32_t  z, ::UnityEngine::Terrain*  terrain) ;

/// @brief Method CreateFromPlacement, addr 0x4888fd4, size 0x3e8, virtual false, abstract: false, final false
...
/// @brief Method CreateFromPlacement, addr 0x4888d20, size 0x2ac, virtual false, abstract: false, final false
...
/// @brief Method GetTerrain, addr 0x4888ca8, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method TryToAddTerrain, addr 0x4889440, size 0x114, virtual false, abstract: false, final false
inline bool TryToAddTerrain(int32_t  tileX, int32_t  tileZ, ::UnityEngine::Terrain*  terrain) ;

/// @brief Method Validate, addr 0x4889554, size 0x164, virtual false, abstract: false, final false
inline ::UnityEngine::TerrainUtils::TerrainMapStatusCode Validate() ;

/// @brief Method ValidateTerrain, addr 0x48897e8, size 0x77c, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityEngine::TerrainUtils::TerrainTileCoord,::UnityW<::UnityEngine::Terrain>>*> const& __cordl_internal_get_m_terrainTiles() const;
...
/// @brief Method .ctor, addr 0x48893bc, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_terrainTiles, addr 0x48896b8, size 0x8, virtual false, abstract: false, final false
