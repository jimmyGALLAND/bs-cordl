...
/// @brief Method set_externalAcceleration, addr 0x47cc934, size 0x54, virtual false, abstract: false, final false
inline void set_externalAcceleration(::UnityEngine::Vector3  value) ;

/// @brief Method set_externalAcceleration_Injected, addr 0x47cc988, size 0x44, virtual false, abstract: false, final false
