...
/// @brief Field ScaleAndCrop value: static_cast<int32_t>(0x1)
static ::UnityEngine::ScaleMode const ScaleAndCrop;

/// @brief Field ScaleToFit value: static_cast<int32_t>(0x2)
static ::UnityEngine::ScaleMode const ScaleToFit;

/// @brief Field StretchToFill value: static_cast<int32_t>(0x0)
