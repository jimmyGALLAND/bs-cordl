...
/// @brief Method Create, addr 0x47cc40c, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method GetEvaluateOnSeek, addr 0x47cc834, size 0x3c, virtual false, abstract: false, final false
inline bool GetEvaluateOnSeek() ;

/// @brief Method GetHandle, addr 0x47cc6e8, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Playables::PlayableOutputHandle GetHandle() ;

/// @brief Method GetTarget, addr 0x47cc778, size 0x3c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::AudioSource> GetTarget() ;

/// @brief Method InternalGetEvaluateOnSeek, addr 0x47cc870, size 0x3c, virtual false, abstract: false, final false
static inline bool InternalGetEvaluateOnSeek(ByRef<::UnityEngine::Playables::PlayableOutputHandle>  output) ;

/// @brief Method InternalGetTarget, addr 0x47cc7b4, size 0x3c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::AudioSource> InternalGetTarget(ByRef<::UnityEngine::Playables::PlayableOutputHandle>  output) ;

/// @brief Method InternalSetEvaluateOnSeek, addr 0x47cc8f0, size 0x44, virtual false, abstract: false, final false
static inline void InternalSetEvaluateOnSeek(ByRef<::UnityEngine::Playables::PlayableOutputHandle>  output, bool  value) ;

/// @brief Method InternalSetTarget, addr 0x47cc7f0, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method SetEvaluateOnSeek, addr 0x47cc8ac, size 0x44, virtual false, abstract: false, final false
inline void SetEvaluateOnSeek(bool  value) ;

/// @brief Method SetTarget, addr 0x47cc6a4, size 0x44, virtual false, abstract: false, final false
inline void SetTarget(::UnityEngine::AudioSource*  value) ;

/// @brief Method .ctor, addr 0x47cc5b4, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Playables::PlayableOutputHandle  handle) ;

/// @brief Method get_Null, addr 0x47cc538, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method op_Explicit, addr 0x47cc6f4, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x47cc4b4, size 0x30, virtual false, abstract: false, final false
