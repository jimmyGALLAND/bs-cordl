...
/// @brief Method TransitionTo, addr 0x47cc244, size 0x5c, virtual false, abstract: false, final false
inline void TransitionTo(float_t  timeToReach) ;

/// @brief Method .ctor, addr 0x47cc1ec, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_audioMixer, addr 0x47cbb18, size 0x3c, virtual false, abstract: false, final false
