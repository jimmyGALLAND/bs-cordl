...
/// @brief Method get_m_inspectorSort, addr 0x481adb8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InspectorSort get_m_inspectorSort() ;

/// @brief Method get_m_sortDirection, addr 0x481adc0, size 0x8, virtual false, abstract: false, final false
