...
/// @brief Method Equals, addr 0x4a54f60, size 0x88, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x4a54fe8, size 0x24, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::XR::Eyes  other) ;

/// @brief Method GetHashCode, addr 0x4a5500c, size 0x50, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_deviceId, addr 0x4a54f50, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_deviceId() ;

/// @brief Method get_featureIndex, addr 0x4a54f58, size 0x8, virtual false, abstract: false, final false
