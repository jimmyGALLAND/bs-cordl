...
/// @brief Method GetDeviceAtXRNode, addr 0x4a55168, size 0x44, virtual false, abstract: false, final false
static inline ::UnityEngine::XR::InputDevice GetDeviceAtXRNode(::UnityEngine::XR::XRNode  node) ;

/// @brief Method GetDeviceManufacturer, addr 0x4a54b38, size 0x3c, virtual false, abstract: false, final false
static inline ::StringW GetDeviceManufacturer(uint64_t  deviceId) ;

/// @brief Method InvokeConnectionEvent, addr 0x4a551ac, size 0xbc, virtual false, abstract: false, final false
static inline void InvokeConnectionEvent(uint64_t  deviceId, ::UnityEngine::XR::ConnectionChangeType  change) ;

/// @brief Method IsDeviceValid, addr 0x4a54aa0, size 0x3c, virtual false, abstract: false, final false
static inline bool IsDeviceValid(uint64_t  deviceId) ;

/// @brief Method SendHapticImpulse, addr 0x4a54c6c, size 0x5c, virtual false, abstract: false, final false
static inline bool SendHapticImpulse(uint64_t  deviceId, uint32_t  channel, float_t  amplitude, float_t  duration) ;

/// @brief Method StopHaptics, addr 0x4a54d20, size 0x3c, virtual false, abstract: false, final false
