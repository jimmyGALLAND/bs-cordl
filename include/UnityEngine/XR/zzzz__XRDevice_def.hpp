...
/// @brief Method DisableAutoXRCameraTracking, addr 0x4a54098, size 0x44, virtual false, abstract: false, final false
static inline void DisableAutoXRCameraTracking(::UnityEngine::Camera*  camera, bool  disabled) ;

/// @brief Method InvokeDeviceLoaded, addr 0x4a540dc, size 0x6c, virtual false, abstract: false, final false
static inline void InvokeDeviceLoaded(::StringW  loadedDeviceName) ;

/// @brief Method SetTrackingSpaceType, addr 0x4a5405c, size 0x3c, virtual false, abstract: false, final false
