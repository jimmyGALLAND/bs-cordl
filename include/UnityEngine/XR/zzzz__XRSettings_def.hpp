...
/// @brief Method get_deviceEyeTextureDimension, addr 0x4a53e5c, size 0x28, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::TextureDimension get_deviceEyeTextureDimension() ;

/// @brief Method get_enabled, addr 0x4a53cf8, size 0x28, virtual false, abstract: false, final false
static inline bool get_enabled() ;

/// @brief Method get_eyeTextureHeight, addr 0x4a53e34, size 0x28, virtual false, abstract: false, final false
static inline int32_t get_eyeTextureHeight() ;

/// @brief Method get_eyeTextureResolutionScale, addr 0x4a53dac, size 0x28, virtual false, abstract: false, final false
static inline float_t get_eyeTextureResolutionScale() ;

/// @brief Method get_eyeTextureWidth, addr 0x4a53e0c, size 0x28, virtual false, abstract: false, final false
static inline int32_t get_eyeTextureWidth() ;

/// @brief Method get_isDeviceActive, addr 0x4a53d20, size 0x28, virtual false, abstract: false, final false
static inline bool get_isDeviceActive() ;

/// @brief Method get_loadedDeviceName, addr 0x4a5400c, size 0x28, virtual false, abstract: false, final false
static inline ::StringW get_loadedDeviceName() ;

/// @brief Method get_occlusionMaskScale, addr 0x4a53fbc, size 0x28, virtual false, abstract: false, final false
static inline float_t get_occlusionMaskScale() ;

/// @brief Method get_renderViewportScale, addr 0x4a53e84, size 0x28, virtual false, abstract: false, final false
static inline float_t get_renderViewportScale() ;

/// @brief Method get_renderViewportScaleInternal, addr 0x4a53eac, size 0x28, virtual false, abstract: false, final false
static inline float_t get_renderViewportScaleInternal() ;

/// @brief Method get_showDeviceView, addr 0x4a53d48, size 0x28, virtual false, abstract: false, final false
static inline bool get_showDeviceView() ;

/// @brief Method get_stereoRenderingMode, addr 0x4a54034, size 0x28, virtual false, abstract: false, final false
static inline ::UnityEngine::XR::__XRSettings__StereoRenderingMode get_stereoRenderingMode() ;

/// @brief Method get_useOcclusionMesh, addr 0x4a53fe4, size 0x28, virtual false, abstract: false, final false
static inline bool get_useOcclusionMesh() ;

/// @brief Method set_eyeTextureResolutionScale, addr 0x4a53dd4, size 0x38, virtual false, abstract: false, final false
static inline void set_eyeTextureResolutionScale(float_t  value) ;

/// @brief Method set_renderViewportScale, addr 0x4a53ed4, size 0xb0, virtual false, abstract: false, final false
static inline void set_renderViewportScale(float_t  value) ;

/// @brief Method set_renderViewportScaleInternal, addr 0x4a53f84, size 0x38, virtual false, abstract: false, final false
static inline void set_renderViewportScaleInternal(float_t  value) ;

/// @brief Method set_showDeviceView, addr 0x4a53d70, size 0x3c, virtual false, abstract: false, final false
