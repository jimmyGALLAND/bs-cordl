...
public:
// Declarations
/// @brief Method Deinitialize, addr 0x479fad8, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method GetSupportedGraphicsDeviceTypes, addr 0x479fae0, size 0x68, virtual true, abstract: false, final false
...
/// @brief Method Initialize, addr 0x479fac0, size 0x8, virtual true, abstract: false, final false
inline bool Initialize() ;

static inline ::UnityEngine::XR::Management::XRLoader* New_ctor() ;

/// @brief Method Start, addr 0x479fac8, size 0x8, virtual true, abstract: false, final false
inline bool Start() ;

/// @brief Method Stop, addr 0x479fad0, size 0x8, virtual true, abstract: false, final false
inline bool Stop() ;

/// @brief Method .ctor, addr 0x479fb48, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
