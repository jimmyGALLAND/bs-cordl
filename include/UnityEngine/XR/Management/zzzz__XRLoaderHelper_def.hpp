...
/// @brief Field m_SubsystemInstanceMap, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_SubsystemInstanceMap, put=__cordl_internal_set_m_SubsystemInstanceMap)) ::System::Collections::Generic::Dictionary_2<::System::Type*,::UnityEngine::ISubsystem*>*  m_SubsystemInstanceMap;
...
/// @brief Method Deinitialize, addr 0x479fb50, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x479fba8, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
