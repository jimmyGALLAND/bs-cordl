...
/// @brief Method .ctor, addr 0x47c6180, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_assetBundle, addr 0x47c6144, size 0x3c, virtual false, abstract: false, final false
