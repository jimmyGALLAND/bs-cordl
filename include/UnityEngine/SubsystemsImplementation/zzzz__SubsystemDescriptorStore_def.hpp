...
static __declspec(property(get=getStaticF_s_DeprecatedDescriptors, put=setStaticF_s_DeprecatedDescriptors)) ::System::Collections::Generic::List_1<::UnityEngine::SubsystemDescriptor*>*  s_DeprecatedDescriptors;

/// @brief Field s_IntegratedDescriptors, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_IntegratedDescriptors, put=setStaticF_s_IntegratedDescriptors)) ::System::Collections::Generic::List_1<::UnityEngine::IntegratedSubsystemDescriptor*>*  s_IntegratedDescriptors;

/// @brief Field s_StandaloneDescriptors, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_StandaloneDescriptors, put=setStaticF_s_StandaloneDescriptors)) ::System::Collections::Generic::List_1<::UnityEngine::SubsystemsImplementation::SubsystemDescriptorWithProvider*>*  s_StandaloneDescriptors;
...
/// @brief Method ClearManagedDescriptors, addr 0x488573c, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method InitializeManagedDescriptor, addr 0x4885664, size 0xd8, virtual false, abstract: false, final false
static inline void InitializeManagedDescriptor(::System::IntPtr  ptr, ::UnityEngine::IntegratedSubsystemDescriptor*  desc) ;

/// @brief Method RegisterDeprecatedDescriptor, addr 0x4884d68, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method ReportSingleSubsystemAnalytics, addr 0x48858f8, size 0x3c, virtual false, abstract: false, final false
