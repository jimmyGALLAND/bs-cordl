...
public:
// Declarations
/// @brief Method Compare, addr 0x48562d0, size 0xb4, virtual false, abstract: false, final false
static inline bool Compare(::UnityEngine::__SendMouseEvents__HitInfo  lhs, ::UnityEngine::__SendMouseEvents__HitInfo  rhs) ;

/// @brief Method SendMessage, addr 0x48562ac, size 0x24, virtual false, abstract: false, final false
inline void SendMessage(::StringW  name) ;

/// @brief Method op_Implicit, addr 0x485620c, size 0xa0, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF_m_CurrentHit, put=setStaticF_m_CurrentHit)) ::ArrayW<::UnityEngine::__SendMouseEvents__HitInfo,::Array<::UnityEngine::__SendMouseEvents__HitInfo>*>  m_CurrentHit;
...
static __declspec(property(get=getStaticF_m_MouseDownHit, put=setStaticF_m_MouseDownHit)) ::ArrayW<::UnityEngine::__SendMouseEvents__HitInfo,::Array<::UnityEngine::__SendMouseEvents__HitInfo>*>  m_MouseDownHit;

/// @brief Field s_GetMouseState, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_GetMouseState, put=setStaticF_s_GetMouseState)) ::System::Func_1<::System::Collections::Generic::KeyValuePair_2<int32_t,::UnityEngine::Vector2>>*  s_GetMouseState;
...
/// @brief Method DoSendMouseEvents, addr 0x485547c, size 0x968, virtual false, abstract: false, final false
static inline void DoSendMouseEvents(int32_t  skipRTCameras) ;

/// @brief Method SendEvents, addr 0x4855de4, size 0x428, virtual false, abstract: false, final false
static inline void SendEvents(int32_t  i, ::UnityEngine::__SendMouseEvents__HitInfo  hit) ;

/// @brief Method SetMouseMoved, addr 0x4855420, size 0x5c, virtual false, abstract: false, final false
static inline void SetMouseMoved() ;

/// @brief Method UpdateMouse, addr 0x485525c, size 0x1c4, virtual false, abstract: false, final false
