...
/// @brief Method .ctor, addr 0x48203e0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Func_1<bool>*  predicate) ;

/// @brief Method get_keepWaiting, addr 0x48203b0, size 0x30, virtual true, abstract: false, final false
