...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::PropertyName (::UnityEngine::Playables::INotification::*)()>(&::UnityEngine::Playables::INotification::get_id)> {
