...
/// @brief Method Create, addr 0x483bf84, size 0x78, virtual false, abstract: false, final false
static inline ::UnityEngine::Playables::ScriptPlayableOutput Create(::UnityEngine::Playables::PlayableGraph  graph, ::StringW  name) ;

/// @brief Method GetHandle, addr 0x483c164, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Playables::PlayableOutputHandle GetHandle() ;

/// @brief Method .ctor, addr 0x483c078, size 0xec, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Playables::PlayableOutputHandle  handle) ;

/// @brief Method get_Null, addr 0x483c000, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x483bffc, size 0x4, virtual false, abstract: false, final false
