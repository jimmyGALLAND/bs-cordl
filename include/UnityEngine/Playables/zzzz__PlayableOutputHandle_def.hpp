...
/// @brief Method AddNotificationReceiver, addr 0x483bdb4, size 0x84, virtual false, abstract: false, final false
inline void AddNotificationReceiver(::UnityEngine::Playables::INotificationReceiver*  receiver) ;

/// @brief Method AddNotificationReceiver_Injected, addr 0x483be38, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method CompareVersion, addr 0x483b530, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x483b60c, size 0x80, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Playables::PlayableOutputHandle  other) ;

/// @brief Method Equals, addr 0x483b564, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  p) ;

/// @brief Method GetHashCode, addr 0x483b4fc, size 0x34, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetPlayableOutputType, addr 0x483b73c, size 0x74, virtual false, abstract: false, final false
inline ::System::Type* GetPlayableOutputType() ;

/// @brief Method GetPlayableOutputType_Injected, addr 0x483b7b0, size 0x3c, virtual false, abstract: false, final false
static inline ::System::Type* GetPlayableOutputType_Injected(ByRef<::UnityEngine::Playables::PlayableOutputHandle>  _unity_self) ;

/// @brief Method GetSourceOutputPort, addr 0x483bb38, size 0x74, virtual false, abstract: false, final false
inline int32_t GetSourceOutputPort() ;

/// @brief Method GetSourceOutputPort_Injected, addr 0x483bbac, size 0x3c, virtual false, abstract: false, final false
static inline int32_t GetSourceOutputPort_Injected(ByRef<::UnityEngine::Playables::PlayableOutputHandle>  _unity_self) ;

/// @brief Method GetSourcePlayable, addr 0x483b97c, size 0x8c, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::PlayableHandle GetSourcePlayable() ;

/// @brief Method GetSourcePlayable_Injected, addr 0x483ba08, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x483b68c, size 0x74, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method IsValid_Injected, addr 0x483b700, size 0x3c, virtual false, abstract: false, final false
static inline bool IsValid_Injected(ByRef<::UnityEngine::Playables::PlayableOutputHandle>  _unity_self) ;

/// @brief Method PushNotification, addr 0x483bcb8, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method PushNotification_Injected, addr 0x483bd58, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method SetReferenceObject, addr 0x483b7ec, size 0x84, virtual false, abstract: false, final false
inline void SetReferenceObject(::UnityEngine::Object*  target) ;

/// @brief Method SetReferenceObject_Injected, addr 0x483b870, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method SetSourcePlayable, addr 0x483ba4c, size 0x98, virtual false, abstract: false, final false
inline void SetSourcePlayable(::UnityEngine::Playables::PlayableHandle  target, int32_t  port) ;

/// @brief Method SetSourcePlayable_Injected, addr 0x483bae4, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method SetUserData, addr 0x483b8b4, size 0x84, virtual false, abstract: false, final false
inline void SetUserData(::UnityEngine::Object*  target) ;

/// @brief Method SetUserData_Injected, addr 0x483b938, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method SetWeight, addr 0x483bbe8, size 0x84, virtual false, abstract: false, final false
inline void SetWeight(float_t  weight) ;

/// @brief Method SetWeight_Injected, addr 0x483bc6c, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method get_Null, addr 0x483b4a4, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x483b3ac, size 0x88, virtual false, abstract: false, final false
