...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Playables::PlayableOutputHandle (::UnityEngine::Playables::IPlayableOutput::*)()>(&::UnityEngine::Playables::IPlayableOutput::GetHandle)> {
