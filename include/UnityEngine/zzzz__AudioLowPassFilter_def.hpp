...
/// @brief Method GetCustomLowpassLevelCurveCopy, addr 0x47ca288, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::AnimationCurve* GetCustomLowpassLevelCurveCopy() ;

static inline ::UnityEngine::AudioLowPassFilter* New_ctor() ;

/// @brief Method SetCustomLowpassLevelCurveHelper, addr 0x47ca2c4, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x47ca498, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_customCutoffCurve, addr 0x47ca308, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::AnimationCurve* get_customCutoffCurve() ;

/// @brief Method get_cutoffFrequency, addr 0x47ca388, size 0x3c, virtual false, abstract: false, final false
inline float_t get_cutoffFrequency() ;

/// @brief Method get_lowpassResonanceQ, addr 0x47ca410, size 0x3c, virtual false, abstract: false, final false
inline float_t get_lowpassResonanceQ() ;

/// @brief Method set_customCutoffCurve, addr 0x47ca344, size 0x44, virtual false, abstract: false, final false
inline void set_customCutoffCurve(::UnityEngine::AnimationCurve*  value) ;

/// @brief Method set_cutoffFrequency, addr 0x47ca3c4, size 0x4c, virtual false, abstract: false, final false
inline void set_cutoffFrequency(float_t  value) ;

/// @brief Method set_lowpassResonanceQ, addr 0x47ca44c, size 0x4c, virtual false, abstract: false, final false
