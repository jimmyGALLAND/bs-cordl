...
/// @brief Method Init, addr 0x48ed140, size 0x200, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::ListViewReorderMode>*> const& __cordl_internal_get_m_ReorderMode() const;
...
/// @brief Method .ctor, addr 0x48ed5e0, size 0x214, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddItems, addr 0x48eb9f4, size 0x2c, virtual false, abstract: false, final false
inline void AddItems(int32_t  itemCount) ;

/// @brief Method CreateDragAndDropController, addr 0x48ec4cc, size 0x5c, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::ICollectionDragAndDropController* CreateDragAndDropController() ;

/// @brief Method CreateDragger, addr 0x48ec438, size 0x94, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::ListViewDragger* CreateDragger() ;

/// @brief Method CreateVirtualizationController, addr 0x48ec104, size 0x48, virtual true, abstract: false, final false
inline void CreateVirtualizationController() ;

/// @brief Method EnableFooter, addr 0x48eb5b4, size 0x358, virtual false, abstract: false, final false
inline void EnableFooter(bool  enabled) ;

/// @brief Method HandleItemNavigation, addr 0x48ec5f8, size 0x694, virtual true, abstract: false, final false
inline bool HandleItemNavigation(bool  moveIn, bool  altPressed) ;

static inline ::UnityEngine::UIElements::BaseListView* New_ctor() ;

/// @brief Method OnAddClicked, addr 0x48ebc64, size 0x280, virtual false, abstract: false, final false
inline void OnAddClicked() ;

/// @brief Method OnArraySizeFieldChanged, addr 0x48eba9c, size 0x1c8, virtual false, abstract: false, final false
inline void OnArraySizeFieldChanged(::UnityEngine::UIElements::ChangeEvent_1<::StringW>*  evt) ;

/// @brief Method OnItemAdded, addr 0x48ec30c, size 0x1c, virtual false, abstract: false, final false
inline void OnItemAdded(::System::Collections::Generic::IEnumerable_1<int32_t>*  indices) ;

/// @brief Method OnItemsRemoved, addr 0x48ec328, size 0x1c, virtual false, abstract: false, final false
inline void OnItemsRemoved(::System::Collections::Generic::IEnumerable_1<int32_t>*  indices) ;

/// @brief Method OnItemsSourceSizeChanged, addr 0x48ec344, size 0x8c, virtual false, abstract: false, final false
inline void OnItemsSourceSizeChanged() ;

/// @brief Method OnRemoveClicked, addr 0x48ebee4, size 0x218, virtual false, abstract: false, final false
inline void OnRemoveClicked() ;

/// @brief Method PostRefresh, addr 0x48ec5d4, size 0x24, virtual true, abstract: false, final false
inline void PostRefresh() ;

/// @brief Method SetViewController, addr 0x48ec14c, size 0x1c0, virtual true, abstract: false, final false
inline void SetViewController(::UnityEngine::UIElements::CollectionViewController*  controller) ;

/// @brief Method SetupArraySizeField, addr 0x48eadf4, size 0x2f8, virtual false, abstract: false, final false
inline void SetupArraySizeField() ;

/// @brief Method UpdateArraySizeField, addr 0x48eb90c, size 0xc4, virtual false, abstract: false, final false
inline void UpdateArraySizeField() ;

/// @brief Method UpdateListViewLabel, addr 0x48eb350, size 0x254, virtual false, abstract: false, final false
inline void UpdateListViewLabel() ;

/// @brief Method <OnAddClicked>b__36_0, addr 0x48ed070, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x48ec528, size 0xac, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_reorderModeChanged, addr 0x48e6d44, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_footer, addr 0x48ec0fc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_footer() ;

/// @brief Method get_reorderMode, addr 0x48ec3d0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ListViewReorderMode get_reorderMode() ;

/// @brief Method get_showAddRemoveFooter, addr 0x48eb5a4, size 0x10, virtual false, abstract: false, final false
inline bool get_showAddRemoveFooter() ;

/// @brief Method get_showBoundCollectionSize, addr 0x48eadd0, size 0x8, virtual false, abstract: false, final false
inline bool get_showBoundCollectionSize() ;

/// @brief Method get_showFoldoutHeader, addr 0x48eb0ec, size 0x8, virtual false, abstract: false, final false
inline bool get_showFoldoutHeader() ;

/// @brief Method get_viewController, addr 0x48eba20, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BaseListViewController* get_viewController() ;

/// @brief Method remove_reorderModeChanged, addr 0x48e6e9c, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method set_headerTitle, addr 0x48eb9d0, size 0x1c, virtual false, abstract: false, final false
inline void set_headerTitle(::StringW  value) ;

/// @brief Method set_reorderMode, addr 0x48ec3d8, size 0x60, virtual false, abstract: false, final false
inline void set_reorderMode(::UnityEngine::UIElements::ListViewReorderMode  value) ;

/// @brief Method set_showAddRemoveFooter, addr 0x48eb9ec, size 0x8, virtual false, abstract: false, final false
inline void set_showAddRemoveFooter(bool  value) ;

/// @brief Method set_showBoundCollectionSize, addr 0x48eadd8, size 0x1c, virtual false, abstract: false, final false
inline void set_showBoundCollectionSize(bool  value) ;

/// @brief Method set_showFoldoutHeader, addr 0x48eb0f4, size 0x25c, virtual false, abstract: false, final false
