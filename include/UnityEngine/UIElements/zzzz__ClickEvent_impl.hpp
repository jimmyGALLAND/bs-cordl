...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::__ClickEvent____c::*)()>(&::UnityEngine::UIElements::__ClickEvent____c::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x499d9d8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::ClickEvent* (::UnityEngine::UIElements::__ClickEvent____c::*)()>(&::UnityEngine::UIElements::__ClickEvent____c::__cctor_b__0_0)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x499d9e0;
...
::cordl_internals::setStaticField<::UnityEngine::UIElements::__ClickEvent____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::__ClickEvent____c*>::get>(std::forward<::UnityEngine::UIElements::__ClickEvent____c*>(value));
}
inline ::UnityEngine::UIElements::__ClickEvent____c* UnityEngine::UIElements::__ClickEvent____c::getStaticF___9()  {
return ::cordl_internals::getStaticField<::UnityEngine::UIElements::__ClickEvent____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::__ClickEvent____c*>::get>();
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::ClickEvent::*)()>(&::UnityEngine::UIElements::ClickEvent::Init)> {
  ...
  constexpr static std::size_t addrs = 0x499d858;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::ClickEvent::*)()>(&::UnityEngine::UIElements::ClickEvent::LocalInit)> {
  ...
  constexpr static std::size_t addrs = 0x499d8ac;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::ClickEvent::*)()>(&::UnityEngine::UIElements::ClickEvent::_ctor)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x499d8b8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::ClickEvent* (*)(::UnityEngine::UIElements::PointerUpEvent*, int32_t)>(&::UnityEngine::UIElements::ClickEvent::GetPooled)> {
  constexpr static std::size_t size = 0x70;
  constexpr static std::size_t addrs = 0x499d90c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "GetPooled",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::PointerUpEvent*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                    )));
    return ___internal_method;
  }
};
