...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "Equals",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::UQueryBuilder_1<T>>::get()}
                    )));
...
// Ctor Parameters [CppParam { name: "m_StyleSelectors", ty: "::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSelector*>*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "m_Parts", ty: "::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSelectorPart>*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "m_Element", ty: "::UnityEngine::UIElements::VisualElement*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "m_Matchers", ty: "::System::Collections::Generic::List_1<::UnityEngine::UIElements::RuleMatcher>*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "m_Relationship", ty: "::UnityEngine::UIElements::StyleSelectorRelationship", modifiers: "", def_value: Some("{}") }, CppParam { name: "pseudoStatesMask", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "negatedPseudoStatesMask", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
template<typename T>
