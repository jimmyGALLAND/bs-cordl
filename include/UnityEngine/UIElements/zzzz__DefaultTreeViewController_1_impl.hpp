...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::TreeDataController_1<T>*> const& UnityEngine::UIElements::DefaultTreeViewController_1<T>::__cordl_internal_get_m_TreeDataController() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_TreeDataController;
}
template<typename T>
...
template<typename T>
inline int32_t UnityEngine::UIElements::DefaultTreeViewController_1<T>::GetParentId(int32_t  id)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::DefaultTreeViewController_1<T>*>::get(),
                    23
...
template<typename T>
inline bool UnityEngine::UIElements::DefaultTreeViewController_1<T>::HasChildren(int32_t  id)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::DefaultTreeViewController_1<T>*>::get(),
                    26
...
template<typename T>
inline ::System::Collections::Generic::IEnumerable_1<int32_t>* UnityEngine::UIElements::DefaultTreeViewController_1<T>::GetChildrenIds(int32_t  id)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::DefaultTreeViewController_1<T>*>::get(),
                    24
...
template<typename T>
inline void UnityEngine::UIElements::DefaultTreeViewController_1<T>::Move(int32_t  id, int32_t  newParentId, int32_t  childIndex, bool  rebuildTree)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::DefaultTreeViewController_1<T>*>::get(),
                    25
...
template<typename T>
inline bool UnityEngine::UIElements::DefaultTreeViewController_1<T>::IsChildOf(int32_t  childId, int32_t  id)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::DefaultTreeViewController_1<T>*>::get(),
                        "IsChildOf",
                        std::span<const Il2CppClass* const, 0>(),
