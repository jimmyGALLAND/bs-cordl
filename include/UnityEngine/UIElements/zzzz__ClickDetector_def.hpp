...
/// @brief Method Reset, addr 0x48dcbb4, size 0x64, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x48dc944, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_ClickStatus, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ClickStatus, put=__cordl_internal_set_m_ClickStatus)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::__ClickDetector__ButtonClickStatus*>*  m_ClickStatus;

/// @brief Method CancelClickTracking, addr 0x48dd16c, size 0xfc, virtual false, abstract: false, final false
inline void CancelClickTracking(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method Cleanup, addr 0x48dd784, size 0x184, virtual false, abstract: false, final false
inline void Cleanup(::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>*  elements) ;

/// @brief Method ContainsPointer, addr 0x48dd02c, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method ProcessEvent, addr 0x48dd268, size 0x51c, virtual false, abstract: false, final false
inline void ProcessEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method SendClickEvent, addr 0x48dcc18, size 0x414, virtual false, abstract: false, final false
inline void SendClickEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method StartClickTracking, addr 0x48dc94c, size 0x268, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__ClickDetector__ButtonClickStatus*>*> const& __cordl_internal_get_m_ClickStatus() const;
...
/// @brief Method .ctor, addr 0x48dc6f0, size 0x254, virtual false, abstract: false, final false
inline void _ctor() ;

static inline int32_t getStaticF__s_DoubleClickTime_k__BackingField() ;

/// @brief Method get_s_DoubleClickTime, addr 0x48dc63c, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method set_s_DoubleClickTime, addr 0x48dc694, size 0x5c, virtual false, abstract: false, final false
