...
/// @brief Method ExecuteDefaultActionAtTarget, addr 0x4957828, size 0x2b0, virtual true, abstract: false, final false
...
/// @brief Method OnBlur, addr 0x4957bc0, size 0x54, virtual false, abstract: false, final false
inline void OnBlur(::UnityEngine::UIElements::BlurEvent*  _) ;

/// @brief Method OnExecuteCommandEvent, addr 0x49587f0, size 0x26c, virtual false, abstract: false, final false
inline void OnExecuteCommandEvent(::UnityEngine::UIElements::ExecuteCommandEvent*  evt) ;

/// @brief Method OnFocus, addr 0x4957adc, size 0xe4, virtual false, abstract: false, final false
inline void OnFocus(::UnityEngine::UIElements::FocusEvent*  _) ;

/// @brief Method OnKeyDown, addr 0x4957c14, size 0x9c8, virtual false, abstract: false, final false
...
/// @brief Method OnValidateCommandEvent, addr 0x49585dc, size 0x214, virtual false, abstract: false, final false
inline void OnValidateCommandEvent(::UnityEngine::UIElements::ValidateCommandEvent*  evt) ;

/// @brief Method UpdateLabel, addr 0x4958a5c, size 0x2b8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x49576f0, size 0x10c, virtual false, abstract: false, final false
