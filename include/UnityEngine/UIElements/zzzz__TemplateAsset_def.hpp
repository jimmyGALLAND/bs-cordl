...
/// @brief Field m_AttributeOverrides, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AttributeOverrides, put=__cordl_internal_set_m_AttributeOverrides)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::__TemplateAsset__AttributeOverride>*  m_AttributeOverrides;

/// @brief Field m_SlotUsages, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_SlotUsages, put=__cordl_internal_set_m_SlotUsages)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualTreeAsset__SlotUsageEntry>*  m_SlotUsages;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__TemplateAsset__AttributeOverride>*> const& __cordl_internal_get_m_AttributeOverrides() const;
...
/// @brief Method get_attributeOverrides, addr 0x49fa678, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method get_slotUsages, addr 0x4a0b8d4, size 0x8, virtual false, abstract: false, final false
