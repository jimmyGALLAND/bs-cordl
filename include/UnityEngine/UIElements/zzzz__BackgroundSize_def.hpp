...
/// @brief Method Equals, addr 0x48da9e8, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x48daa78, size 0x5c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::BackgroundSize  other) ;

/// @brief Method GetHashCode, addr 0x48daad4, size 0x5c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Initial, addr 0x48da998, size 0x50, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::BackgroundSize Initial() ;

/// @brief Method ToString, addr 0x48dab78, size 0xd8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x48da300, size 0x54, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BackgroundSizeType  sizeType) ;

/// @brief Method .ctor, addr 0x48da354, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Length  sizeX, ::UnityEngine::UIElements::Length  sizeY) ;

/// @brief Method get_sizeType, addr 0x48da914, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BackgroundSizeType get_sizeType() ;

/// @brief Method get_x, addr 0x48da970, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Length get_x() ;

/// @brief Method get_y, addr 0x48da984, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x48da724, size 0x30, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UIElements::BackgroundSize  style1, ::UnityEngine::UIElements::BackgroundSize  style2) ;

/// @brief Method op_Inequality, addr 0x48dab30, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method set_sizeType, addr 0x48da91c, size 0x54, virtual false, abstract: false, final false
inline void set_sizeType(::UnityEngine::UIElements::BackgroundSizeType  value) ;

/// @brief Method set_x, addr 0x48da978, size 0xc, virtual false, abstract: false, final false
inline void set_x(::UnityEngine::UIElements::Length  value) ;

/// @brief Method set_y, addr 0x48da98c, size 0xc, virtual false, abstract: false, final false
