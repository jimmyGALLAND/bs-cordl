...
/// @brief Method Equals, addr 0x49aadbc, size 0x98, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x49aae54, size 0x34, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::ManipulatorActivationFilter  other) ;

/// @brief Method GetHashCode, addr 0x49aae88, size 0x84, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method HasModifiers, addr 0x49ab05c, size 0x1f4, virtual false, abstract: false, final false
inline bool HasModifiers(::UnityEngine::UIElements::IMouseEvent*  e) ;

/// @brief Method HasModifiers, addr 0x49ab3f4, size 0x1f4, virtual false, abstract: false, final false
inline bool HasModifiers(::UnityEngine::UIElements::IPointerEvent*  e) ;

/// @brief Method MatchModifiers, addr 0x49ab250, size 0x54, virtual false, abstract: false, final false
inline bool MatchModifiers(bool  alt, bool  ctrl, bool  shift, bool  command) ;

/// @brief Method Matches, addr 0x49aaf0c, size 0x150, virtual false, abstract: false, final false
inline bool Matches(::UnityEngine::UIElements::IMouseEvent*  e) ;

/// @brief Method Matches, addr 0x49ab2a4, size 0x150, virtual false, abstract: false, final false
inline bool Matches(::UnityEngine::UIElements::IPointerEvent*  e) ;

/// @brief Method get_button, addr 0x49aad94, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MouseButton get_button() ;

/// @brief Method get_clickCount, addr 0x49aadb4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_clickCount() ;

/// @brief Method get_modifiers, addr 0x49aada4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_button, addr 0x49aad9c, size 0x8, virtual false, abstract: false, final false
inline void set_button(::UnityEngine::UIElements::MouseButton  value) ;

/// @brief Method set_modifiers, addr 0x49aadac, size 0x8, virtual false, abstract: false, final false
