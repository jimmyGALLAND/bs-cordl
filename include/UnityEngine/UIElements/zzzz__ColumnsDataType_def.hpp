...
// Type: UnityEngine.UIElements::ColumnsDataType
...
/// @brief Field PrimaryColumn value: static_cast<int32_t>(0x0)
static ::UnityEngine::UIElements::ColumnsDataType const PrimaryColumn;

/// @brief Field Reorderable value: static_cast<int32_t>(0x2)
static ::UnityEngine::UIElements::ColumnsDataType const Reorderable;

/// @brief Field Resizable value: static_cast<int32_t>(0x3)
static ::UnityEngine::UIElements::ColumnsDataType const Resizable;

/// @brief Field ResizePreview value: static_cast<int32_t>(0x4)
static ::UnityEngine::UIElements::ColumnsDataType const ResizePreview;

/// @brief Field StretchMode value: static_cast<int32_t>(0x1)
