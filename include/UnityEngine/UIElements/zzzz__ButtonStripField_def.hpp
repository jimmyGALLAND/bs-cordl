...
class CORDL_TYPE __ButtonStripField__UxmlFactory : public ::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::ButtonStripField*,::UnityEngine::UIElements::__ButtonStripField__UxmlTraits*> {
public:
// Declarations
static inline ::UnityEngine::UIElements::__ButtonStripField__UxmlFactory* New_ctor() ;

/// @brief Method .ctor, addr 0x48f77e8, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x48f7830, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method RefreshButtonsState, addr 0x48f7710, size 0xd8, virtual false, abstract: false, final false
inline void RefreshButtonsState() ;

/// @brief Method SetValueWithoutNotify, addr 0x48f768c, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x48f75d4, size 0xb8, virtual false, abstract: false, final false
inline void _ctor() ;
