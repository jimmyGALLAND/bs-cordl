...
class __TextInputBaseField_1__TextInputBase;
}
namespace UnityEngine::UIElements {
template<typename TValueType>
class __TextInputBaseField_1__UxmlTraits;
}
...
static __declspec(property(get=getStaticF_horizontalVariantInnerTextElementUssClassName, put=setStaticF_horizontalVariantInnerTextElementUssClassName)) ::StringW  horizontalVariantInnerTextElementUssClassName;
...
static __declspec(property(get=getStaticF_innerTextElementWithScrollViewUssClassName, put=setStaticF_innerTextElementWithScrollViewUssClassName)) ::StringW  innerTextElementWithScrollViewUssClassName;
...
static __declspec(property(get=getStaticF_verticalHorizontalVariantInnerTextElementUssClassName, put=setStaticF_verticalHorizontalVariantInnerTextElementUssClassName)) ::StringW  verticalHorizontalVariantInnerTextElementUssClassName;

/// @brief Field verticalVariantInnerTextElementUssClassName, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_verticalVariantInnerTextElementUssClassName, put=setStaticF_verticalVariantInnerTextElementUssClassName)) ::StringW  verticalVariantInnerTextElementUssClassName;
...
/// @brief Field m_TextInputBase, offset 0x448, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_TextInputBase, put=__cordl_internal_set_m_TextInputBase)) ::UnityEngine::UIElements::__TextInputBaseField_1__TextInputBase<TValueType>*  m_TextInputBase;
...
static __declspec(property(get=getStaticF_s_CursorColorProperty, put=setStaticF_s_CursorColorProperty)) ::UnityEngine::UIElements::CustomStyleProperty_1<::UnityEngine::Color>  s_CursorColorProperty;

/// @brief Field s_SelectionColorProperty, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_SelectionColorProperty, put=setStaticF_s_SelectionColorProperty)) ::UnityEngine::UIElements::CustomStyleProperty_1<::UnityEngine::Color>  s_SelectionColorProperty;
...
static inline ::UnityEngine::UIElements::TextInputBaseField_1<TValueType>* New_ctor(::StringW  label, int32_t  maxLength, char16_t  maskChar, ::UnityEngine::UIElements::__TextInputBaseField_1__TextInputBase<TValueType>*  textInputBase) ;
