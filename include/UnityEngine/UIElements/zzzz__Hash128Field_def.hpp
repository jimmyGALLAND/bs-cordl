...
/// @brief Method .ctor, addr 0x49038ac, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x49038f4, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AcceptCharacter, addr 0x490397c, size 0xb8, virtual true, abstract: false, final false
inline bool AcceptCharacter(char16_t  c) ;

static inline ::UnityEngine::UIElements::__Hash128Field__Hash128Input* New_ctor() ;

/// @brief Method Parse, addr 0x490357c, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::Hash128 Parse(::StringW  str) ;

/// @brief Method StringToValue, addr 0x4903a34, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::Hash128 StringToValue(::StringW  str) ;

/// @brief Method .ctor, addr 0x49030a4, size 0x150, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x490393c, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method ExecuteDefaultAction, addr 0x49035ec, size 0x1f0, virtual true, abstract: false, final false
...
/// @brief Method SetValueWithoutNotify, addr 0x4903488, size 0xc8, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(::UnityEngine::Hash128  newValue) ;

/// @brief Method StringToValue, addr 0x4903574, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::Hash128 StringToValue(::StringW  str) ;

/// @brief Method UpdateTextFromValue, addr 0x49033f0, size 0x98, virtual true, abstract: false, final false
inline void UpdateTextFromValue() ;

/// @brief Method UpdateValueFromText, addr 0x4903304, size 0xec, virtual true, abstract: false, final false
inline void UpdateValueFromText() ;

/// @brief Method ValueToString, addr 0x4903550, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4902f1c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4902f28, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method get_value, addr 0x49031f4, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method set_value, addr 0x490323c, size 0xc8, virtual true, abstract: false, final false
