...
static __declspec(property(get=getStaticF_SingleElementClassQuery, put=setStaticF_SingleElementClassQuery)) ::UnityEngine::UIElements::UQueryState_1<::UnityEngine::UIElements::VisualElement*>  SingleElementClassQuery;

/// @brief Field SingleElementEmptyQuery, offset 0xffffffff, size 0x10 
static __declspec(property(get=getStaticF_SingleElementEmptyQuery, put=setStaticF_SingleElementEmptyQuery)) ::UnityEngine::UIElements::UQueryState_1<::UnityEngine::UIElements::VisualElement*>  SingleElementEmptyQuery;

/// @brief Field SingleElementNameAndClassQuery, offset 0xffffffff, size 0x10 
static __declspec(property(get=getStaticF_SingleElementNameAndClassQuery, put=setStaticF_SingleElementNameAndClassQuery)) ::UnityEngine::UIElements::UQueryState_1<::UnityEngine::UIElements::VisualElement*>  SingleElementNameAndClassQuery;

/// @brief Field SingleElementNameQuery, offset 0xffffffff, size 0x10 
static __declspec(property(get=getStaticF_SingleElementNameQuery, put=setStaticF_SingleElementNameQuery)) ::UnityEngine::UIElements::UQueryState_1<::UnityEngine::UIElements::VisualElement*>  SingleElementNameQuery;

/// @brief Field SingleElementTypeAndClassQuery, offset 0xffffffff, size 0x10 
static __declspec(property(get=getStaticF_SingleElementTypeAndClassQuery, put=setStaticF_SingleElementTypeAndClassQuery)) ::UnityEngine::UIElements::UQueryState_1<::UnityEngine::UIElements::VisualElement*>  SingleElementTypeAndClassQuery;

/// @brief Field SingleElementTypeAndNameAndClassQuery, offset 0xffffffff, size 0x10 
static __declspec(property(get=getStaticF_SingleElementTypeAndNameAndClassQuery, put=setStaticF_SingleElementTypeAndNameAndClassQuery)) ::UnityEngine::UIElements::UQueryState_1<::UnityEngine::UIElements::VisualElement*>  SingleElementTypeAndNameAndClassQuery;

/// @brief Field SingleElementTypeAndNameQuery, offset 0xffffffff, size 0x10 
static __declspec(property(get=getStaticF_SingleElementTypeAndNameQuery, put=setStaticF_SingleElementTypeAndNameQuery)) ::UnityEngine::UIElements::UQueryState_1<::UnityEngine::UIElements::VisualElement*>  SingleElementTypeAndNameQuery;

/// @brief Field SingleElementTypeQuery, offset 0xffffffff, size 0x10 
static __declspec(property(get=getStaticF_SingleElementTypeQuery, put=setStaticF_SingleElementTypeQuery)) ::UnityEngine::UIElements::UQueryState_1<::UnityEngine::UIElements::VisualElement*>  SingleElementTypeQuery;

/// @brief Method Q, addr 0x4a0a87c, size 0x40c, virtual false, abstract: false, final false
