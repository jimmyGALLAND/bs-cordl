...
namespace UnityEngine::UIElements {
template<typename T>
struct __DynamicHeightVirtualizationController_1__ContentHeightCacheInfo;
}
namespace UnityEngine::UIElements {
template<typename T>
struct __DynamicHeightVirtualizationController_1__ScrollDirection;
}
namespace UnityEngine::UIElements {
template<typename T>
struct __DynamicHeightVirtualizationController_1__VirtualizationChange;
}
...
/// @brief Field m_ContentHeightCache, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ContentHeightCache, put=__cordl_internal_set_m_ContentHeightCache)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::UIElements::__DynamicHeightVirtualizationController_1__ContentHeightCacheInfo<T>>*  m_ContentHeightCache;
...
/// @brief Field m_LastChange, offset 0x8c, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_LastChange, put=__cordl_internal_set_m_LastChange)) ::UnityEngine::UIElements::__DynamicHeightVirtualizationController_1__VirtualizationChange<T>  m_LastChange;
...
/// @brief Field m_ScrollDirection, offset 0x90, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_ScrollDirection, put=__cordl_internal_set_m_ScrollDirection)) ::UnityEngine::UIElements::__DynamicHeightVirtualizationController_1__ScrollDirection<T>  m_ScrollDirection;
...
constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::UIElements::__DynamicHeightVirtualizationController_1__ContentHeightCacheInfo<T>>*& __cordl_internal_get_m_ContentHeightCache() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::UIElements::__DynamicHeightVirtualizationController_1__ContentHeightCacheInfo<T>>*> const& __cordl_internal_get_m_ContentHeightCache() const;
...
constexpr void __cordl_internal_set_m_ContentHeightCache(::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::UIElements::__DynamicHeightVirtualizationController_1__ContentHeightCacheInfo<T>>*  value) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::UnityEngine::UIElements::__DynamicHeightVirtualizationController_1__ScrollDirection, "UnityEngine.UIElements", "DynamicHeightVirtualizationController`1/ScrollDirection");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::UnityEngine::UIElements::__DynamicHeightVirtualizationController_1__VirtualizationChange, "UnityEngine.UIElements", "DynamicHeightVirtualizationController`1/VirtualizationChange");
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::UnityEngine::UIElements::__DynamicHeightVirtualizationController_1__ContentHeightCacheInfo, "UnityEngine.UIElements", "DynamicHeightVirtualizationController`1/ContentHeightCacheInfo");
