...
/// @brief Method Create, addr 0x48d9d30, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x48d9dc8, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x48d9d80, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_Database, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Database, put=__cordl_internal_set_m_Database)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Texture>,::UnityEngine::UIElements::__DynamicAtlas__TextureInfo*>*  m_Database;
...
/// @brief Method DestroyPages, addr 0x48d92f4, size 0x78, virtual false, abstract: false, final false
inline void DestroyPages() ;

/// @brief Method InitPages, addr 0x48d9418, size 0xfc, virtual false, abstract: false, final false
inline void InitPages() ;

/// @brief Method IsTextureFormatSupported, addr 0x48d9a1c, size 0x34, virtual false, abstract: false, final false
static inline bool IsTextureFormatSupported(::UnityEngine::TextureFormat  format) ;

/// @brief Method IsTextureValid, addr 0x48d9a50, size 0x138, virtual true, abstract: false, final false
...
/// @brief Method OnAssignedToPanel, addr 0x48d9190, size 0xcc, virtual true, abstract: false, final false
inline void OnAssignedToPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method OnRemovedFromPanel, addr 0x48d925c, size 0x98, virtual true, abstract: false, final false
inline void OnRemovedFromPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method OnUpdateDynamicTextures, addr 0x48d99b4, size 0x68, virtual true, abstract: false, final false
inline void OnUpdateDynamicTextures(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method Reset, addr 0x48d936c, size 0xac, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ReturnAtlas, addr 0x48d9878, size 0x13c, virtual true, abstract: false, final false
...
/// @brief Method TryGetAtlas, addr 0x48d9514, size 0x364, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Texture>,::UnityEngine::UIElements::__DynamicAtlas__TextureInfo*>*> const& __cordl_internal_get_m_Database() const;
...
/// @brief Method .ctor, addr 0x48d9c60, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_defaultFilters, addr 0x48d9bd0, size 0x8, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::DynamicAtlasFilters get_defaultFilters() ;

/// @brief Method get_isInitialized, addr 0x48d9170, size 0x20, virtual false, abstract: false, final false
inline bool get_isInitialized() ;

/// @brief Method get_maxSubTextureSize, addr 0x48d9b88, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxSubTextureSize() ;

/// @brief Method set_activeFilters, addr 0x48d9bd8, size 0x20, virtual false, abstract: false, final false
inline void set_activeFilters(::UnityEngine::UIElements::DynamicAtlasFilters  value) ;

/// @brief Method set_customFilter, addr 0x48d9c18, size 0x48, virtual false, abstract: false, final false
inline void set_customFilter(::UnityEngine::UIElements::DynamicAtlasCustomFilter*  value) ;

/// @brief Method set_maxAtlasSize, addr 0x48d9bb0, size 0x20, virtual false, abstract: false, final false
inline void set_maxAtlasSize(int32_t  value) ;

/// @brief Method set_maxSubTextureSize, addr 0x48d9bf8, size 0x20, virtual false, abstract: false, final false
inline void set_maxSubTextureSize(int32_t  value) ;

/// @brief Method set_minAtlasSize, addr 0x48d9b90, size 0x20, virtual false, abstract: false, final false
