...
/// @brief Method Copy, addr 0x49ebbd8, size 0x1c, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::LayoutData Copy() ;

/// @brief Method CopyFrom, addr 0x49ebbf4, size 0x14, virtual true, abstract: false, final true
inline void CopyFrom(ByRef<::UnityEngine::UIElements::LayoutData>  other) ;

/// @brief Method Equals, addr 0x49ebff0, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x49ebfa4, size 0x4c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::LayoutData  other) ;

/// @brief Method GetHashCode, addr 0x49ec098, size 0x338, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x49ebc08, size 0x39c, virtual false, abstract: false, final false
