...
/// @brief Method .ctor, addr 0x49aa750, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_target, addr 0x49aa95c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_target, addr 0x49ab5e8, size 0x54, virtual true, abstract: false, final true
