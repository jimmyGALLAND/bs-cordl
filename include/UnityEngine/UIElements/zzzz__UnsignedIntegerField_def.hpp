...
class CORDL_TYPE __UnsignedIntegerField__UxmlFactory : public ::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::UnsignedIntegerField*,::UnityEngine::UIElements::__UnsignedIntegerField__UxmlTraits*> {
public:
// Declarations
static inline ::UnityEngine::UIElements::__UnsignedIntegerField__UxmlFactory* New_ctor() ;

/// @brief Method .ctor, addr 0x497c6dc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x497c724, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x497c844, size 0x250, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x497cae0, size 0xa8, virtual true, abstract: false, final false
inline uint32_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x497ca94, size 0x4c, virtual true, abstract: false, final false
inline ::StringW ValueToString(uint32_t  v) ;

/// @brief Method .ctor, addr 0x497c4f0, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x497c7ec, size 0x58, virtual true, abstract: false, final false
inline ::StringW get_allowedCharacters() ;

/// @brief Method get_parentUnsignedIntegerField, addr 0x497c76c, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method ApplyInputDeviceDelta, addr 0x497c5a8, size 0x64, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, uint32_t  startValue) ;

/// @brief Method CanTryParse, addr 0x497c584, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x497c2b8, size 0xdc, virtual true, abstract: false, final false
inline uint32_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x497c200, size 0xb8, virtual true, abstract: false, final false
inline ::StringW ValueToString(uint32_t  v) ;

/// @brief Method .ctor, addr 0x497c394, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x497c3a0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_integerInput, addr 0x497c17c, size 0x84, virtual false, abstract: false, final false
