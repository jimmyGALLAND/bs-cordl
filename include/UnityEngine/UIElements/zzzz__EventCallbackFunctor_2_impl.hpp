...
template<typename TEventType,typename TCallbackArgs>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventCallback_2<TEventType,TCallbackArgs>*> const& UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>::__cordl_internal_get_m_Callback() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Callback;
}
template<typename TEventType,typename TCallbackArgs>
...
template<typename TEventType,typename TCallbackArgs>
constexpr int64_t& UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>::__cordl_internal_get_m_EventTypeId()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_EventTypeId;
}
template<typename TEventType,typename TCallbackArgs>
constexpr int64_t const& UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>::__cordl_internal_get_m_EventTypeId() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_EventTypeId;
}
template<typename TEventType,typename TCallbackArgs>
constexpr void UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>::__cordl_internal_set_m_EventTypeId(int64_t  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>*>::get(),
                        "get_userArgs",
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "set_userArgs",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<TCallbackArgs>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, value);
}
template<typename TEventType,typename TCallbackArgs>
inline ::UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>* UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>::New_ctor(::UnityEngine::UIElements::EventCallback_2<TEventType,TCallbackArgs>*  callback, TCallbackArgs  userArgs, ::UnityEngine::UIElements::CallbackPhase  phase, ::UnityEngine::UIElements::InvokePolicy  invokePolicy)  {
...
template<typename TEventType,typename TCallbackArgs>
inline void UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>::_ctor(::UnityEngine::UIElements::EventCallback_2<TEventType,TCallbackArgs>*  callback, TCallbackArgs  userArgs, ::UnityEngine::UIElements::CallbackPhase  phase, ::UnityEngine::UIElements::InvokePolicy  invokePolicy)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 4>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::EventCallback_2<TEventType,TCallbackArgs>*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<TCallbackArgs>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::CallbackPhase>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::InvokePolicy>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, callback, userArgs, phase, invokePolicy);
}
template<typename TEventType,typename TCallbackArgs>
inline void UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>::Invoke(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::PropagationPhase  propagationPhase)  {
...
template<typename TEventType,typename TCallbackArgs>
inline bool UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>::IsEquivalentTo(int64_t  eventTypeId, ::System::Delegate*  callback, ::UnityEngine::UIElements::CallbackPhase  phase)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::EventCallbackFunctor_2<TEventType,TCallbackArgs>*>::get(),
                    5
