...
public:
// Declarations
/// @brief Method Invoke, addr 0x48d915c, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x48d90bc, size 0xa0, virtual false, abstract: false, final false
