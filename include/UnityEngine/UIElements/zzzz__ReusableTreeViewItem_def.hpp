...
/// @brief Method DetachElement, addr 0x48e8fd8, size 0x1b4, virtual true, abstract: false, final false
inline void DetachElement() ;

/// @brief Method Indent, addr 0x48e2a58, size 0x14, virtual false, abstract: false, final false
inline void Indent(int32_t  depth) ;

/// @brief Method Init, addr 0x48e8d58, size 0xcc, virtual true, abstract: false, final false
inline void Init(::UnityEngine::UIElements::VisualElement*  item) ;

/// @brief Method InitExpandHierarchy, addr 0x48e876c, size 0x4ac, virtual false, abstract: false, final false
...
/// @brief Method OnPointerUp, addr 0x48e94d8, size 0x1c, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OnToggleGeometryChanged, addr 0x48e92c0, size 0x218, virtual false, abstract: false, final false
inline void OnToggleGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnToggleValueChanged, addr 0x48e94f4, size 0x1c, virtual false, abstract: false, final false
inline void OnToggleValueChanged(::UnityEngine::UIElements::ChangeEvent_1<bool>*  evt) ;

/// @brief Method PreAttachElement, addr 0x48e8e24, size 0x1b4, virtual true, abstract: false, final false
inline void PreAttachElement() ;

/// @brief Method SetExpandedWithoutNotify, addr 0x48e2b20, size 0x20, virtual false, abstract: false, final false
inline void SetExpandedWithoutNotify(bool  expanded) ;

/// @brief Method SetToggleVisibility, addr 0x48e2be8, size 0x18, virtual false, abstract: false, final false
inline void SetToggleVisibility(bool  visible) ;

/// @brief Method UpdateIndentLayout, addr 0x48e918c, size 0x134, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::GeometryChangedEvent*>*> const& __cordl_internal_get_m_ToggleGeometryChangedCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::ChangeEvent_1<bool>*>*> const& __cordl_internal_get_m_ToggleValueChangedCallback() const;
...
/// @brief Method .ctor, addr 0x48e8c1c, size 0x124, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_onPointerUp, addr 0x48e2eb8, size 0xb0, virtual false, abstract: false, final false
inline void add_onPointerUp(::System::Action_1<::UnityEngine::UIElements::PointerUpEvent*>*  value) ;

/// @brief Method add_onToggleValueChanged, addr 0x48e2f68, size 0xb0, virtual false, abstract: false, final false
inline void add_onToggleValueChanged(::System::Action_1<::UnityEngine::UIElements::ChangeEvent_1<bool>*>*  value) ;

/// @brief Method get_rootElement, addr 0x48e8d40, size 0x18, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_rootElement() ;

/// @brief Method remove_onPointerUp, addr 0x48e2d2c, size 0xb0, virtual false, abstract: false, final false
inline void remove_onPointerUp(::System::Action_1<::UnityEngine::UIElements::PointerUpEvent*>*  value) ;

/// @brief Method remove_onToggleValueChanged, addr 0x48e2ddc, size 0xb0, virtual false, abstract: false, final false
