...
static __declspec(property(get=getStaticF_sObjectPool, put=setStaticF_sObjectPool)) ::UnityEngine::UIElements::ObjectPool_1<::UnityEngine::UIElements::Experimental::ValueAnimation_1<T>*>*  sObjectPool;
