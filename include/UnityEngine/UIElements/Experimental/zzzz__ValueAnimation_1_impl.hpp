...
template<typename T>
inline void UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>::setStaticF___9(::UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>*  value)  {
::cordl_internals::setStaticField<::UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>*>::get>(std::forward<::UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>*>(value));
}
template<typename T>
inline ::UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>* UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>::getStaticF___9()  {
return ::cordl_internals::getStaticField<::UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>*>::get>();
}
template<typename T>
inline ::UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>* UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>*>());
}
template<typename T>
inline void UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>::_ctor()  {
...
template<typename T>
inline ::UnityEngine::UIElements::Experimental::ValueAnimation_1<T>* UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>::__cctor_b__67_0()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>*>::get(),
                        "<.cctor>b__67_0",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters []
template<typename T>
constexpr ::UnityEngine::UIElements::Experimental::__ValueAnimation_1____c<T>::__ValueAnimation_1____c()   {
}
...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<float_t,float_t>*> const& UnityEngine::UIElements::Experimental::ValueAnimation_1<T>::__cordl_internal_get__easingCurve_k__BackingField() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____easingCurve_k__BackingField;
}
template<typename T>
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____onAnimationCompleted_k__BackingField)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
template<typename T>
...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> const& UnityEngine::UIElements::Experimental::ValueAnimation_1<T>::__cordl_internal_get__owner_k__BackingField() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____owner_k__BackingField;
}
template<typename T>
...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::UIElements::VisualElement*,T>*> const& UnityEngine::UIElements::Experimental::ValueAnimation_1<T>::__cordl_internal_get__valueUpdated_k__BackingField() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____valueUpdated_k__BackingField;
}
template<typename T>
...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::UnityEngine::UIElements::VisualElement*,T>*> const& UnityEngine::UIElements::Experimental::ValueAnimation_1<T>::__cordl_internal_get__initialValue_k__BackingField() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____initialValue_k__BackingField;
}
template<typename T>
...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Func_4<T,T,float_t,T>*> const& UnityEngine::UIElements::Experimental::ValueAnimation_1<T>::__cordl_internal_get__interpolator_k__BackingField() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____interpolator_k__BackingField;
}
template<typename T>
