...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::Experimental::IValueAnimationUpdate::*)(int64_t)>(&::UnityEngine::UIElements::Experimental::IValueAnimationUpdate::Tick)> {
