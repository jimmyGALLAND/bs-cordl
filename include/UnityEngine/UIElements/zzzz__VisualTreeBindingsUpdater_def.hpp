...
static __declspec(property(get=getStaticF_s_AdditionalBindingObjectVEPropertyName, put=setStaticF_s_AdditionalBindingObjectVEPropertyName)) ::UnityEngine::PropertyName  s_AdditionalBindingObjectVEPropertyName;

/// @brief Field s_BindingRequestObjectVEPropertyName, offset 0xffffffff, size 0x4 
static __declspec(property(get=getStaticF_s_BindingRequestObjectVEPropertyName, put=setStaticF_s_BindingRequestObjectVEPropertyName)) ::UnityEngine::PropertyName  s_BindingRequestObjectVEPropertyName;
...
/// @brief Method CurrentTime, addr 0x48db58c, size 0x50, virtual false, abstract: false, final false
static inline int64_t CurrentTime() ;

/// @brief Method GetAdditionalBinding, addr 0x48db0c8, size 0x88, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::IBinding* GetAdditionalBinding(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method GetBindingObjectFromElement, addr 0x48daf90, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method OnHierarchyChange, addr 0x48db574, size 0x18, virtual true, abstract: false, final false
inline void OnHierarchyChange(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::HierarchyChangeType  type) ;

/// @brief Method OnVersionChanged, addr 0x48db47c, size 0xf8, virtual true, abstract: false, final false
inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::VersionChangeType  versionChangeType) ;

/// @brief Method PerformTrackingOperations, addr 0x48db5dc, size 0x288, virtual false, abstract: false, final false
inline void PerformTrackingOperations() ;

/// @brief Method StartTracking, addr 0x48db150, size 0x80, virtual false, abstract: false, final false
inline void StartTracking(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method StartTrackingRecursive, addr 0x48db258, size 0x118, virtual false, abstract: false, final false
inline void StartTrackingRecursive(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method StopTracking, addr 0x48db1d0, size 0x80, virtual false, abstract: false, final false
inline void StopTracking(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method StopTrackingRecursive, addr 0x48db370, size 0x10c, virtual false, abstract: false, final false
inline void StopTrackingRecursive(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method Update, addr 0x48db864, size 0x5b8, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateBindings, addr 0x48dbe1c, size 0x530, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::Object*,::System::Object*>*> const& __cordl_internal_get__temporaryObjectCache_k__BackingField() const;
...
/// @brief Method .ctor, addr 0x48dc34c, size 0x154, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_disableBindingsThrottling, addr 0x48daf38, size 0x58, virtual false, abstract: false, final false
static inline bool get_disableBindingsThrottling() ;

/// @brief Method get_profilerMarker, addr 0x48daee0, size 0x58, virtual true, abstract: false, final false
inline ::Unity::Profiling::ProfilerMarker get_profilerMarker() ;

/// @brief Method get_temporaryObjectCache, addr 0x48db250, size 0x8, virtual false, abstract: false, final false
