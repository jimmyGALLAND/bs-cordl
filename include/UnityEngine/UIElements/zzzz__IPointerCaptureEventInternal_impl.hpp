...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::UIElements::IPointerCaptureEventInternal::*)()>(&::UnityEngine::UIElements::IPointerCaptureEventInternal::get_pointerId)> {
