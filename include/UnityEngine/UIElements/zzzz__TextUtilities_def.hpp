...
public:
// Declarations
/// @brief Method ConvertPixelUnitsToTextCoreRelativeUnits, addr 0x49ffa50, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method GetFontAsset, addr 0x49ff600, size 0x1bc, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::TextCore::Text::FontAsset> GetFontAsset(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method GetTextCoreSettingsForElement, addr 0x49ffd94, size 0x3dc, virtual false, abstract: false, final false
...
/// @brief Method GetTextSettingsFrom, addr 0x49ff53c, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method IsFontAssigned, addr 0x49ffcd0, size 0xc4, virtual false, abstract: false, final false
static inline bool IsFontAssigned(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method MeasureVisualElementTextSize, addr 0x49ffb54, size 0x17c, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 MeasureVisualElementTextSize(::UnityEngine::UIElements::TextElement*  te, ::StringW  textToMeasure, float_t  width, ::UnityEngine::UIElements::__VisualElement__MeasureMode  widthMode, float_t  height, ::UnityEngine::UIElements::__VisualElement__MeasureMode  heightMode) ;
