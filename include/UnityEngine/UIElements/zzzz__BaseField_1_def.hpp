...
static __declspec(property(get=getStaticF_s_LabelBaseMinWidthProperty, put=setStaticF_s_LabelBaseMinWidthProperty)) ::UnityEngine::UIElements::CustomStyleProperty_1<float_t>  s_LabelBaseMinWidthProperty;

/// @brief Field s_LabelExtraContextWidthProperty, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_LabelExtraContextWidthProperty, put=setStaticF_s_LabelExtraContextWidthProperty)) ::UnityEngine::UIElements::CustomStyleProperty_1<float_t>  s_LabelExtraContextWidthProperty;

/// @brief Field s_LabelExtraPaddingProperty, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_LabelExtraPaddingProperty, put=setStaticF_s_LabelExtraPaddingProperty)) ::UnityEngine::UIElements::CustomStyleProperty_1<float_t>  s_LabelExtraPaddingProperty;

/// @brief Field s_LabelWidthRatioProperty, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_LabelWidthRatioProperty, put=setStaticF_s_LabelWidthRatioProperty)) ::UnityEngine::UIElements::CustomStyleProperty_1<float_t>  s_LabelWidthRatioProperty;
