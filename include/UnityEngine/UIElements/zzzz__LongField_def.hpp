...
/// @brief Method .ctor, addr 0x495cb94, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x495cbdc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x495ccfc, size 0x234, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, int64_t  startValue) ;

/// @brief Method ClampMinMaxLongValue, addr 0x495cf30, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x495d020, size 0xa8, virtual true, abstract: false, final false
inline int64_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x495cfd4, size 0x4c, virtual true, abstract: false, final false
inline ::StringW ValueToString(int64_t  v) ;

/// @brief Method .ctor, addr 0x495c9a8, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x495cca4, size 0x58, virtual true, abstract: false, final false
inline ::StringW get_allowedCharacters() ;

/// @brief Method get_parentLongField, addr 0x495cc24, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method ApplyInputDeviceDelta, addr 0x495ca60, size 0x64, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, int64_t  startValue) ;

/// @brief Method CanTryParse, addr 0x495ca3c, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x495c770, size 0xdc, virtual true, abstract: false, final false
inline int64_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x495c6b8, size 0xb8, virtual true, abstract: false, final false
inline ::StringW ValueToString(int64_t  v) ;

/// @brief Method .ctor, addr 0x495c84c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x495c858, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_longInput, addr 0x495c634, size 0x84, virtual false, abstract: false, final false
