...
/// @brief Method .ctor, addr 0x496ddec, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x496de34, size 0x134, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x496df68, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method RadioButtonValueChangedCallback, addr 0x496d880, size 0xf8, virtual false, abstract: false, final false
inline void RadioButtonValueChangedCallback(::UnityEngine::UIElements::ChangeEvent_1<bool>*  evt) ;

/// @brief Method SetValueWithoutNotify, addr 0x496d978, size 0x60, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(int32_t  newValue) ;

/// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionAdded, addr 0x496d9d8, size 0x200, virtual true, abstract: false, final true
inline void UnityEngine_UIElements_IGroupBox_OnOptionAdded(::UnityEngine::UIElements::IGroupBoxOption*  option) ;

/// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionRemoved, addr 0x496dbd8, size 0x174, virtual true, abstract: false, final true
inline void UnityEngine_UIElements_IGroupBox_OnOptionRemoved(::UnityEngine::UIElements::IGroupBoxOption*  option) ;

/// @brief Method UpdateRadioButtons, addr 0x496d43c, size 0x1ec, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::ChangeEvent_1<bool>*>*> const& __cordl_internal_get_m_RadioButtonValueChangedCallback() const;
...
/// @brief Method .ctor, addr 0x496d638, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x496d644, size 0x23c, virtual false, abstract: false, final false
...
/// @brief Method get_contentContainer, addr 0x496d628, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method set_choices, addr 0x496cd94, size 0x6a8, virtual false, abstract: false, final false
