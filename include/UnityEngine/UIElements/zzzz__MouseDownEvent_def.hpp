...
/// @brief Method <.cctor>b__0_0, addr 0x49965e8, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MouseDownEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x49965e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPooled, addr 0x49964dc, size 0x54, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::MouseDownEvent* GetPooled(::UnityEngine::UIElements::PointerDownEvent*  pointerEvent) ;

/// @brief Method GetPooled, addr 0x4996530, size 0x54, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::MouseDownEvent* GetPooled(::UnityEngine::UIElements::PointerMoveEvent*  pointerEvent) ;

/// @brief Method Init, addr 0x49961c0, size 0x54, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x4996214, size 0xc, virtual false, abstract: false, final false
inline void LocalInit() ;

/// @brief Method MakeFromPointerEvent, addr 0x4996274, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4996220, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;
