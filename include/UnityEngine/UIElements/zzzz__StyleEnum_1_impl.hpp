...
// Ctor Parameters [CppParam { name: "m_Value", ty: "T", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "m_Keyword", ty: "::UnityEngine::UIElements::StyleKeyword", modifiers: "", def_value: Some("{}") }]
template<typename T>
