...
template<typename T>
inline void UnityEngine::UIElements::__ObjectListPool_1____c<T>::setStaticF___9(::UnityEngine::UIElements::__ObjectListPool_1____c<T>*  value)  {
::cordl_internals::setStaticField<::UnityEngine::UIElements::__ObjectListPool_1____c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::__ObjectListPool_1____c<T>*>::get>(std::forward<::UnityEngine::UIElements::__ObjectListPool_1____c<T>*>(value));
}
template<typename T>
inline ::UnityEngine::UIElements::__ObjectListPool_1____c<T>* UnityEngine::UIElements::__ObjectListPool_1____c<T>::getStaticF___9()  {
return ::cordl_internals::getStaticField<::UnityEngine::UIElements::__ObjectListPool_1____c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::__ObjectListPool_1____c<T>*>::get>();
}
template<typename T>
inline ::UnityEngine::UIElements::__ObjectListPool_1____c<T>* UnityEngine::UIElements::__ObjectListPool_1____c<T>::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::UIElements::__ObjectListPool_1____c<T>*>());
}
template<typename T>
inline void UnityEngine::UIElements::__ObjectListPool_1____c<T>::_ctor()  {
...
template<typename T>
inline ::System::Collections::Generic::List_1<T>* UnityEngine::UIElements::__ObjectListPool_1____c<T>::__cctor_b__4_0()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::__ObjectListPool_1____c<T>*>::get(),
                        "<.cctor>b__4_0",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters []
template<typename T>
constexpr ::UnityEngine::UIElements::__ObjectListPool_1____c<T>::__ObjectListPool_1____c()   {
}
template<typename T>
