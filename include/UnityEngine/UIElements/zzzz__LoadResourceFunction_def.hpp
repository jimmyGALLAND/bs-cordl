...
public:
// Declarations
/// @brief Method Invoke, addr 0x49ad60c, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x49ad56c, size 0xa0, virtual false, abstract: false, final false
