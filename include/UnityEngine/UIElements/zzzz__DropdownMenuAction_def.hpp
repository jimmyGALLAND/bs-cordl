...
/// @brief Field <status>k__BackingField, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__status_k__BackingField, put=__cordl_internal_set__status_k__BackingField)) ::UnityEngine::UIElements::__DropdownMenuAction__Status  _status_k__BackingField;
...
/// @brief Field actionStatusCallback, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_actionStatusCallback, put=__cordl_internal_set_actionStatusCallback)) ::System::Func_2<::UnityEngine::UIElements::DropdownMenuAction*,::UnityEngine::UIElements::__DropdownMenuAction__Status>*  actionStatusCallback;
...
/// @brief Method AlwaysDisabled, addr 0x498b400, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AlwaysEnabled, addr 0x498b3f8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method UpdateActionStatus, addr 0x498b44c, size 0x3c, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::UnityEngine::UIElements::DropdownMenuAction*,::UnityEngine::UIElements::__DropdownMenuAction__Status>*> const& __cordl_internal_get_actionStatusCallback() const;
...
/// @brief Method .ctor, addr 0x498b408, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method set_eventInfo, addr 0x498b3e8, size 0x8, virtual false, abstract: false, final false
inline void set_eventInfo(::UnityEngine::UIElements::DropdownMenuEventInfo*  value) ;

/// @brief Method set_status, addr 0x498b3e0, size 0x8, virtual false, abstract: false, final false
inline void set_status(::UnityEngine::UIElements::__DropdownMenuAction__Status  value) ;

/// @brief Method set_userData, addr 0x498b3f0, size 0x8, virtual false, abstract: false, final false
