...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::Painter2D* (::UnityEngine::UIElements::MeshGenerationContext::*)()>(&::UnityEngine::UIElements::MeshGenerationContext::get_painter2D)> {
  constexpr static std::size_t size = 0x64;
  constexpr static std::size_t addrs = 0x49b6760;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::UIElements::MeshGenerationContext::*)()>(&::UnityEngine::UIElements::MeshGenerationContext::get_hasPainter2D)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x49b681c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::MeshGenerationContext::*)(::UnityEngine::UIElements::IStylePainter*)>(&::UnityEngine::UIElements::MeshGenerationContext::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x49b682c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::IStylePainter*>::get()}
                    )));
    return ___internal_method;
  }
};
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::Painter2D*> const& UnityEngine::UIElements::MeshGenerationContext::__cordl_internal_get_m_Painter2D() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Painter2D;
}
...
::cordl_internals::setStaticField<::Unity::Profiling::ProfilerMarker, "s_AllocateMarker", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::MeshGenerationContext*>::get>(std::forward<::Unity::Profiling::ProfilerMarker>(value));
}
inline ::Unity::Profiling::ProfilerMarker UnityEngine::UIElements::MeshGenerationContext::getStaticF_s_AllocateMarker()  {
return ::cordl_internals::getStaticField<::Unity::Profiling::ProfilerMarker, "s_AllocateMarker", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::MeshGenerationContext*>::get>();
}
...
::cordl_internals::setStaticField<::Unity::Profiling::ProfilerMarker, "s_DrawVectorImageMarker", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::MeshGenerationContext*>::get>(std::forward<::Unity::Profiling::ProfilerMarker>(value));
}
inline ::Unity::Profiling::ProfilerMarker UnityEngine::UIElements::MeshGenerationContext::getStaticF_s_DrawVectorImageMarker()  {
return ::cordl_internals::getStaticField<::Unity::Profiling::ProfilerMarker, "s_DrawVectorImageMarker", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::MeshGenerationContext*>::get>();
}
