...
class CORDL_TYPE __MultiColumnListView__UxmlFactory : public ::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::MultiColumnListView*,::UnityEngine::UIElements::__MultiColumnListView__UxmlTraits*> {
public:
// Declarations
static inline ::UnityEngine::UIElements::__MultiColumnListView__UxmlFactory* New_ctor() ;

/// @brief Method .ctor, addr 0x4969c2c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x4969c74, size 0x170, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlObjectAttributeDescription_1<::UnityEngine::UIElements::SortColumnDescriptions*>*> const& __cordl_internal_get_m_SortColumnDescriptions() const;
...
/// @brief Method .ctor, addr 0x4969de4, size 0x10c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CreateViewController, addr 0x4969964, size 0x78, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::CollectionViewController* CreateViewController() ;

/// @brief Method CreateVirtualizationController, addr 0x4969bc8, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method RaiseColumnSortingChanged, addr 0x49696e0, size 0x1c, virtual false, abstract: false, final false
inline void RaiseColumnSortingChanged() ;

/// @brief Method RaiseHeaderContextMenuPopulate, addr 0x4969c10, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method SetViewController, addr 0x49699dc, size 0x1ec, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x496975c, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x49697b4, size 0x134, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Columns*  columns) ;

/// @brief Method get_columns, addr 0x49694b4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Columns* get_columns() ;

/// @brief Method get_sortColumnDescriptions, addr 0x4969508, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::SortColumnDescriptions* get_sortColumnDescriptions() ;

/// @brief Method get_viewController, addr 0x4969430, size 0x84, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MultiColumnListViewController* get_viewController() ;

/// @brief Method set_columns, addr 0x49694bc, size 0x4c, virtual false, abstract: false, final false
inline void set_columns(::UnityEngine::UIElements::Columns*  value) ;

/// @brief Method set_sortColumnDescriptions, addr 0x4969510, size 0x90, virtual false, abstract: false, final false
inline void set_sortColumnDescriptions(::UnityEngine::UIElements::SortColumnDescriptions*  value) ;

/// @brief Method set_sortingEnabled, addr 0x49696fc, size 0x60, virtual false, abstract: false, final false
