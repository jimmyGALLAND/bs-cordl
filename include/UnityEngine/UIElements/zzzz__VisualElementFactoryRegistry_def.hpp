...
static __declspec(property(get=getStaticF_s_Factories, put=setStaticF_s_Factories)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Collections::Generic::List_1<::UnityEngine::UIElements::IUxmlFactory*>*>*  s_Factories;

/// @brief Field s_MovedTypesFactories, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_MovedTypesFactories, put=setStaticF_s_MovedTypesFactories)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Collections::Generic::List_1<::UnityEngine::UIElements::IUxmlFactory*>*>*  s_MovedTypesFactories;

/// @brief Method GetMovedUIControlTypeName, addr 0x4a0eb78, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method RegisterEngineFactories, addr 0x4a0edb8, size 0x10c4, virtual false, abstract: false, final false
static inline void RegisterEngineFactories() ;

/// @brief Method RegisterFactory, addr 0x4a1014c, size 0x5d0, virtual false, abstract: false, final false
static inline void RegisterFactory(::UnityEngine::UIElements::IUxmlFactory*  factory) ;

/// @brief Method RegisterUserFactories, addr 0x4a0fe7c, size 0x2d0, virtual false, abstract: false, final false
static inline void RegisterUserFactories() ;

/// @brief Method TryGetValue, addr 0x4a1071c, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method get_factories, addr 0x4a0ecd8, size 0xe0, virtual false, abstract: false, final false
