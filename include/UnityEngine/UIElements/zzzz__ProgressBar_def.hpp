...
/// @brief Method .ctor, addr 0x496c2cc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x496c278, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;
