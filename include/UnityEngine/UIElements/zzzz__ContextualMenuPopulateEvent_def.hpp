...
/// @brief Method <.cctor>b__0_0, addr 0x49990a8, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ContextualMenuPopulateEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x49990a0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPooled, addr 0x4998734, size 0x770, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x4998ea4, size 0x70, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x4998f14, size 0x34, virtual false, abstract: false, final false
inline void LocalInit() ;

static inline ::UnityEngine::UIElements::ContextualMenuPopulateEvent* New_ctor() ;

/// @brief Method PostDispatch, addr 0x4998fb8, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4998f48, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_menu, addr 0x4998714, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::DropdownMenu* get_menu() ;

/// @brief Method get_triggerEvent, addr 0x4998724, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::EventBase* get_triggerEvent() ;

/// @brief Method set_menu, addr 0x499871c, size 0x8, virtual false, abstract: false, final false
inline void set_menu(::UnityEngine::UIElements::DropdownMenu*  value) ;

/// @brief Method set_triggerEvent, addr 0x499872c, size 0x8, virtual false, abstract: false, final false
