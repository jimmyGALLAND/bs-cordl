...
/// @brief Method .ctor, addr 0x497aba8, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x497abf0, size 0x16c, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::TwoPaneSplitViewOrientation>*> const& __cordl_internal_get_m_Orientation() const;
...
/// @brief Method .ctor, addr 0x497ad5c, size 0x144, virtual false, abstract: false, final false
inline void _ctor() ;
...
// SizeInfo { instance_size: 1064, native_size: -1, calculated_instance_size: 1064, calculated_native_size: 1064, minimum_alignment: 8, packing: None, specified_packing: None }
namespace UnityEngine::UIElements {
// Is value type: false
...
static __declspec(property(get=getStaticF_s_HandleDragLineAnchorHorizontalClassName, put=setStaticF_s_HandleDragLineAnchorHorizontalClassName)) ::StringW  s_HandleDragLineAnchorHorizontalClassName;
...
/// @brief Method Init, addr 0x49786ec, size 0x2d8, virtual false, abstract: false, final false
...
/// @brief Method OnPostDisplaySetup, addr 0x4979b9c, size 0x104, virtual false, abstract: false, final false
inline void OnPostDisplaySetup(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnSizeChange, addr 0x4979d70, size 0xc, virtual false, abstract: false, final false
inline void OnSizeChange(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnViewDataReady, addr 0x497a9d0, size 0x3c, virtual true, abstract: false, final false
inline void OnViewDataReady() ;

/// @brief Method PostDisplaySetup, addr 0x49789c4, size 0x11d8, virtual false, abstract: false, final false
inline void PostDisplaySetup() ;

/// @brief Method SetDragLineOffset, addr 0x497a778, size 0x128, virtual false, abstract: false, final false
inline void SetDragLineOffset(float_t  offset) ;

/// @brief Method SetFixedPaneDimension, addr 0x497a8a0, size 0x128, virtual false, abstract: false, final false
inline void SetFixedPaneDimension(float_t  dimension) ;

/// @brief Method UpdateLayout, addr 0x4979d7c, size 0x9fc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x49784e4, size 0x208, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_contentContainer, addr 0x497a9c8, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_contentContainer() ;

/// @brief Method get_fixedPane, addr 0x4978478, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_fixedPane() ;

/// @brief Method get_fixedPaneDimension, addr 0x4978498, size 0x30, virtual false, abstract: false, final false
inline float_t get_fixedPaneDimension() ;

/// @brief Method get_fixedPaneIndex, addr 0x4978488, size 0x8, virtual false, abstract: false, final false
inline int32_t get_fixedPaneIndex() ;

/// @brief Method get_flexedPane, addr 0x4978480, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_flexedPane() ;

/// @brief Method get_orientation, addr 0x4978490, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_fixedPaneDimension, addr 0x49784c8, size 0x1c, virtual false, abstract: false, final false
