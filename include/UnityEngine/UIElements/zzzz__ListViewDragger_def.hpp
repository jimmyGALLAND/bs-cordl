...
/// @brief Method Equals, addr 0x49879e8, size 0x88, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x4985b74, size 0x78, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::__ListViewDragger__DragPosition  other) ;

/// @brief Method GetHashCode, addr 0x4987a70, size 0x64, virtual true, abstract: false, final false
...
constexpr __ListViewDragger__DragPosition(int32_t  insertAtIndex, int32_t  parentId, int32_t  childIndex, ::UnityEngine::UIElements::ReusableCollectionItem*  recycledItem, ::UnityEngine::UIElements::DragAndDropPosition  dropPosition) noexcept;
...
/// @brief Method ApplyDragAndDropUI, addr 0x4984f38, size 0x798, virtual false, abstract: false, final false
inline void ApplyDragAndDropUI(::UnityEngine::UIElements::__ListViewDragger__DragPosition  dragPosition) ;

/// @brief Method CanStartDrag, addr 0x4983fc8, size 0x2d8, virtual true, abstract: false, final false
inline bool CanStartDrag(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method ClearDragAndDropUI, addr 0x4987294, size 0x670, virtual true, abstract: false, final false
inline void ClearDragAndDropUI(bool  dragCancelled) ;

/// @brief Method GetHoverBarTopPosition, addr 0x4987208, size 0x8c, virtual false, abstract: false, final false
inline float_t GetHoverBarTopPosition(::UnityEngine::UIElements::ReusableCollectionItem*  item) ;

/// @brief Method GetPreviousAndNextItemsIgnoringDraggedItems, addr 0x4986f90, size 0x278, virtual false, abstract: false, final false
...
/// @brief Method GetRecycledItem, addr 0x49842a0, size 0x37c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ReusableCollectionItem* GetRecycledItem(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method GetVisualMode, addr 0x4984ac4, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method HandleAutoExpansion, addr 0x4984e4c, size 0xec, virtual false, abstract: false, final false
inline void HandleAutoExpansion(::UnityEngine::Vector2  pointerPosition) ;

/// @brief Method HandleDragAndScroll, addr 0x4984c54, size 0x1f8, virtual false, abstract: false, final false
inline void HandleDragAndScroll(::UnityEngine::Vector2  pointerPosition) ;

/// @brief Method HandleSiblingInsertionAtAvailableDepthsAndChangeTargetIfNeeded, addr 0x4986a78, size 0x518, virtual false, abstract: false, final false
...
/// @brief Method HandleTreePosition, addr 0x4986970, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method MakeDragAndDropArgs, addr 0x49856d0, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method OnDrop, addr 0x49857f4, size 0x380, virtual true, abstract: false, final false
inline void OnDrop(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method PlaceHoverBarAt, addr 0x4985bec, size 0x660, virtual false, abstract: false, final false
inline void PlaceHoverBarAt(float_t  top, float_t  indentationPadding, float_t  siblingBottom) ;

/// @brief Method PlaceHoverBarAtElement, addr 0x4986590, size 0x1c, virtual false, abstract: false, final false
inline void PlaceHoverBarAtElement(::UnityEngine::UIElements::ReusableCollectionItem*  item) ;

/// @brief Method StartDrag, addr 0x498461c, size 0x2d8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::StartDragArgs StartDrag(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method TryGetDragPosition, addr 0x49865ac, size 0x3c4, virtual true, abstract: false, final false
...
/// @brief Method UpdateDrag, addr 0x49848f4, size 0x1d0, virtual true, abstract: false, final false
inline void UpdateDrag(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method <ApplyDragAndDropUI>g__GeometryChangedCallback|27_0, addr 0x4987904, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4983fbc, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BaseVerticalCollectionView*  listView) ;

/// @brief Method get_dragAndDropController, addr 0x4983fac, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ICollectionDragAndDropController* get_dragAndDropController() ;

/// @brief Method get_targetScrollView, addr 0x4983f90, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ScrollView* get_targetScrollView() ;

/// @brief Method get_targetView, addr 0x4983f14, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BaseVerticalCollectionView* get_targetView() ;

/// @brief Method set_dragAndDropController, addr 0x4983fb4, size 0x8, virtual false, abstract: false, final false
