...
/// @brief Method .ctor, addr 0x48f71a0, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x48f70ac, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;
