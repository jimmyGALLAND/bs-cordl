...
/// @brief Method InitLabel, addr 0x48ea5ec, size 0x90, virtual true, abstract: false, final false
inline void InitLabel() ;

static inline ::UnityEngine::UIElements::BaseBoolField* New_ctor(::StringW  label) ;

/// @brief Method OnClickEvent, addr 0x48ea75c, size 0x288, virtual false, abstract: false, final false
inline void OnClickEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method OnNavigationSubmit, addr 0x48ea59c, size 0x34, virtual false, abstract: false, final false
inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent*  evt) ;

/// @brief Method RegisterEditingCallbacks, addr 0x48eaba0, size 0x118, virtual true, abstract: false, final false
inline void RegisterEditingCallbacks() ;

/// @brief Method SetValueWithoutNotify, addr 0x48ea67c, size 0xe0, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(bool  newValue) ;

/// @brief Method ToggleValue, addr 0x48ea9e4, size 0x38, virtual true, abstract: false, final false
inline void ToggleValue() ;

/// @brief Method UnregisterEditingCallbacks, addr 0x48eacb8, size 0x118, virtual true, abstract: false, final false
inline void UnregisterEditingCallbacks() ;

/// @brief Method UpdateMixedValueContent, addr 0x48eaa1c, size 0x184, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x48ea2e0, size 0x234, virtual false, abstract: false, final false
inline void _ctor(::StringW  label) ;

/// @brief Method get_text, addr 0x48ea5d0, size 0x1c, virtual false, abstract: false, final false
inline ::StringW get_text() ;

/// @brief Method set_text, addr 0x48ea514, size 0x88, virtual false, abstract: false, final false
