...
/// @brief Method OnAfterDeserialize, addr 0x4a0e9f0, size 0x188, virtual true, abstract: false, final true
inline void OnAfterDeserialize() ;

/// @brief Method OnBeforeSerialize, addr 0x4a0e9ec, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method get_classes, addr 0x4a0e8cc, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_classes() ;

/// @brief Method get_hasStylesheetPaths, addr 0x4a0e94c, size 0x10, virtual false, abstract: false, final false
inline bool get_hasStylesheetPaths() ;

/// @brief Method get_hasStylesheets, addr 0x4a0e9d4, size 0x10, virtual false, abstract: false, final false
inline bool get_hasStylesheets() ;

/// @brief Method get_ruleIndex, addr 0x4a0e8c4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ruleIndex() ;

/// @brief Method get_skipClone, addr 0x4a0e9e4, size 0x8, virtual false, abstract: false, final false
inline bool get_skipClone() ;

/// @brief Method get_stylesheetPaths, addr 0x4a0e8d4, size 0x78, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::StringW>* get_stylesheetPaths() ;

/// @brief Method get_stylesheets, addr 0x4a0e95c, size 0x78, virtual false, abstract: false, final false
