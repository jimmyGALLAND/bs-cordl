...
/// @brief Method Commit, addr 0x49b2fdc, size 0x44, virtual false, abstract: false, final false
inline void Commit() ;

/// @brief Method CreateAtlasTexture, addr 0x49b338c, size 0x130, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> CreateAtlasTexture() ;

/// @brief Method Dispose, addr 0x49b28b0, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x49b291c, size 0x1dc, virtual true, abstract: false, final false
...
/// @brief Method Remove, addr 0x49b2efc, size 0xe0, virtual false, abstract: false, final false
inline void Remove(::UnityEngine::UIElements::UIR::__Allocator2D__Alloc2D  alloc) ;

/// @brief Method TryAdd, addr 0x49b2af8, size 0x2bc, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x49b2db4, size 0x148, virtual false, abstract: false, final false
inline void Update(::UnityEngine::Texture2D*  image, ::UnityEngine::RectInt  rect) ;

/// @brief Method UpdateAtlasTexture, addr 0x49b3020, size 0x36c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x49b2750, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method get_atlas, addr 0x49b2730, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> get_atlas() ;

/// @brief Method get_disposed, addr 0x49b289c, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Method get_filterMode, addr 0x49b2748, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::FilterMode get_filterMode() ;

/// @brief Method get_format, addr 0x49b2740, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::RenderTextureFormat get_format() ;

/// @brief Method get_textureId, addr 0x49b2720, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_atlas, addr 0x49b2738, size 0x8, virtual false, abstract: false, final false
inline void set_atlas(::UnityEngine::RenderTexture*  value) ;

/// @brief Method set_disposed, addr 0x49b28a4, size 0xc, virtual false, abstract: false, final false
inline void set_disposed(bool  value) ;

/// @brief Method set_textureId, addr 0x49b2728, size 0x8, virtual false, abstract: false, final false
