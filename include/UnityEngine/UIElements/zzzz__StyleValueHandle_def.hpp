...
/// @brief Method get_valueType, addr 0x49eae94, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleValueType get_valueType() ;

/// @brief Method set_valueType, addr 0x49f86f4, size 0x8, virtual false, abstract: false, final false
