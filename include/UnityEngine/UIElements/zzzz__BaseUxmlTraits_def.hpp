...
/// @brief Method .ctor, addr 0x4a0d8e0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_canHaveAnyAttribute, addr 0x4a0d900, size 0xc, virtual false, abstract: false, final false
