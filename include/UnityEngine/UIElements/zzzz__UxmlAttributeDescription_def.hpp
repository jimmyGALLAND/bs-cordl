...
template<typename T>
inline bool TryGetValueFromBag(::UnityEngine::UIElements::IUxmlAttributes*  bag, ::UnityEngine::UIElements::CreationContext  cc, ::System::Func_3<::StringW,T,T>*  converterFunc, T  defaultValue, ByRef<T>  value) ;

/// @brief Method TryGetValueFromBagAsString, addr 0x4a0b98c, size 0x50c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a0b8dc, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_name, addr 0x4a0b900, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method set_name, addr 0x4a0b908, size 0x8, virtual false, abstract: false, final false
inline void set_name(::StringW  value) ;

/// @brief Method set_obsoleteNames, addr 0x4a0b910, size 0x5c, virtual false, abstract: false, final false
inline void set_obsoleteNames(::System::Collections::Generic::IEnumerable_1<::StringW>*  value) ;

/// @brief Method set_restriction, addr 0x4a0b984, size 0x8, virtual false, abstract: false, final false
inline void set_restriction(::UnityEngine::UIElements::UxmlTypeRestriction*  value) ;

/// @brief Method set_type, addr 0x4a0b96c, size 0x8, virtual false, abstract: false, final false
inline void set_type(::StringW  value) ;

/// @brief Method set_typeNamespace, addr 0x4a0b974, size 0x8, virtual false, abstract: false, final false
inline void set_typeNamespace(::StringW  value) ;

/// @brief Method set_use, addr 0x4a0b97c, size 0x8, virtual false, abstract: false, final false
