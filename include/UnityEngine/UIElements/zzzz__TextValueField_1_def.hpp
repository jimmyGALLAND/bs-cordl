...
class __TextValueField_1__TextValueInput;
}
...
MARK_GEN_REF_PTR_T(::UnityEngine::UIElements::__TextValueField_1__TextValueInput);
// Type: ::TextValueInput
// SizeInfo { instance_size: 1032, native_size: 1032, calculated_instance_size: 1032, calculated_native_size: 1032, minimum_alignment: 8, packing: None, specified_packing: None }
namespace UnityEngine::UIElements {
// cpp template
template<typename TValueType>
// Is value type: false
// CS Name: ::TextValueField`1::TextValueInput<TValueType>*
class CORDL_TYPE __TextValueField_1__TextValueInput : public ::UnityEngine::UIElements::__TextInputBaseField_1__TextInputBase<TValueType> {
public:
// Declarations
...
static inline ::UnityEngine::UIElements::__TextValueField_1__TextValueInput<TValueType>* New_ctor() ;
...
// Ctor Parameters []
// @brief default ctor
constexpr __TextValueField_1__TextValueInput() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "__TextValueField_1__TextValueInput", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
__TextValueField_1__TextValueInput(__TextValueField_1__TextValueInput && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "__TextValueField_1__TextValueInput", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
__TextValueField_1__TextValueInput(__TextValueField_1__TextValueInput const& ) = delete;
...
// SizeInfo { instance_size: 1128, native_size: 1122, calculated_instance_size: 1128, calculated_native_size: 1122, minimum_alignment: 8, packing: None, specified_packing: None }
namespace UnityEngine::UIElements {
// cpp template
template<typename TValueType>
// Is value type: false
...
public:
// Declarations
using TextValueInput = ::UnityEngine::UIElements::__TextValueField_1__TextValueInput<TValueType>;
...
/// @brief Field m_UpdateTextFromValue, offset 0x460, size 0x1 
 ...
 __declspec(property(get=get_textValueInput)) ::UnityEngine::UIElements::__TextValueField_1__TextValueInput<TValueType>*  textValueInput;
...
static inline ::UnityEngine::UIElements::TextValueField_1<TValueType>* New_ctor(::StringW  label, int32_t  maxLength, ::UnityEngine::UIElements::__TextValueField_1__TextValueInput<TValueType>*  textValueInput) ;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::BaseFieldMouseDragger*> const& __cordl_internal_get_m_Dragger() const;
...
/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(::StringW  label, int32_t  maxLength, ::UnityEngine::UIElements::__TextValueField_1__TextValueInput<TValueType>*  textValueInput) ;

/// @brief Method get_formatString, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline ::StringW get_formatString() ;

/// @brief Method get_textValueInput, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::__TextValueField_1__TextValueInput<TValueType>* get_textValueInput() ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::UnityEngine::UIElements::__TextValueField_1__TextValueInput, "UnityEngine.UIElements", "TextValueField`1/TextValueInput");
