...
constexpr CopyClosingMeshJobData(::System::IntPtr  vertSrc, ::System::IntPtr  vertDst, int32_t  vertCount, ::System::IntPtr  indexSrc, ::System::IntPtr  indexDst, int32_t  indexCount, int32_t  indexOffset) noexcept;
