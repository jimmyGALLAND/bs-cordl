...
#include "UnityEngine/UIElements/UIR/zzzz__TempAllocator_1_impl.hpp"
...
template<typename T>
constexpr ::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>::__TempAllocator_1__Page(::Unity::Collections::NativeArray_1<T>  array, int32_t  used) noexcept  {
this->array = array;
this->used = used;
}
// Ctor Parameters []
template<typename T>
constexpr ::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>::__TempAllocator_1__Page()   {
}
...
template<typename T>
constexpr ::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>& UnityEngine::UIElements::UIR::TempAllocator_1<T>::__cordl_internal_get_m_Pool()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Pool;
}
template<typename T>
constexpr ::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T> const& UnityEngine::UIElements::UIR::TempAllocator_1<T>::__cordl_internal_get_m_Pool() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Pool;
}
template<typename T>
constexpr void UnityEngine::UIElements::UIR::TempAllocator_1<T>::__cordl_internal_set_m_Pool(::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
this->___m_Pool = value;
}
template<typename T>
constexpr ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>>*& UnityEngine::UIElements::UIR::TempAllocator_1<T>::__cordl_internal_get_m_Excess()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Excess;
}
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>>*> const& UnityEngine::UIElements::UIR::TempAllocator_1<T>::__cordl_internal_get_m_Excess() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Excess;
}
template<typename T>
constexpr void UnityEngine::UIElements::UIR::TempAllocator_1<T>::__cordl_internal_set_m_Excess(::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIR::TempAllocator_1<T>*>::get(),
                        ".ctor",
