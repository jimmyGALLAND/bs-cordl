...
template<typename T>
using GPUBuffer_1 = ::UnityEngine::UIElements::UIR::__Utility__GPUBuffer_1<T>;
...
static __declspec(property(get=getStaticF_RegisterIntermediateRenderers, put=setStaticF_RegisterIntermediateRenderers)) ::System::Action_1<::UnityW<::UnityEngine::Camera>>*  RegisterIntermediateRenderers;
...
/// @brief Method AllocateBuffer, addr 0x491011c, size 0x54, virtual false, abstract: false, final false
static inline ::System::IntPtr AllocateBuffer(int32_t  elementCount, int32_t  elementStride, bool  vertexBuffer) ;

/// @brief Method CPUFencePassed, addr 0x4910744, size 0x3c, virtual false, abstract: false, final false
static inline bool CPUFencePassed(uint32_t  fence) ;

/// @brief Method CreateStencilState, addr 0x49105f0, size 0x84, virtual false, abstract: false, final false
static inline ::System::IntPtr CreateStencilState(::UnityEngine::Rendering::StencilState  stencilState) ;

/// @brief Method CreateStencilState_Injected, addr 0x4910674, size 0x3c, virtual false, abstract: false, final false
static inline ::System::IntPtr CreateStencilState_Injected(ByRef<::UnityEngine::Rendering::StencilState>  stencilState) ;

/// @brief Method DisableScissor, addr 0x49105c8, size 0x28, virtual false, abstract: false, final false
static inline void DisableScissor() ;

/// @brief Method DrawRanges, addr 0x491045c, size 0x74, virtual false, abstract: false, final false
static inline void DrawRanges(::System::IntPtr  ib, ::cordl_internals::Ptr<::System::IntPtr>  vertexStreams, int32_t  streamCount, ::System::IntPtr  ranges, int32_t  rangeCount, ::System::IntPtr  vertexDecl) ;

/// @brief Method FreeBuffer, addr 0x4910170, size 0x3c, virtual false, abstract: false, final false
static inline void FreeBuffer(::System::IntPtr  buffer) ;

/// @brief Method GetActiveViewport, addr 0x49107e4, size 0x84, virtual false, abstract: false, final false
static inline ::UnityEngine::RectInt GetActiveViewport() ;

/// @brief Method GetActiveViewport_Injected, addr 0x4910868, size 0x3c, virtual false, abstract: false, final false
static inline void GetActiveViewport_Injected(ByRef<::UnityEngine::RectInt>  ret) ;

/// @brief Method GetUnityProjectionMatrix, addr 0x4910930, size 0x9c, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 GetUnityProjectionMatrix() ;

/// @brief Method GetUnityProjectionMatrix_Injected, addr 0x49109cc, size 0x3c, virtual false, abstract: false, final false
static inline void GetUnityProjectionMatrix_Injected(ByRef<::UnityEngine::Matrix4x4>  ret) ;

/// @brief Method GetVertexDeclaration, addr 0x4910274, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method HasMappedBufferRange, addr 0x49106f4, size 0x28, virtual false, abstract: false, final false
static inline bool HasMappedBufferRange() ;

/// @brief Method InsertCPUFence, addr 0x491071c, size 0x28, virtual false, abstract: false, final false
static inline uint32_t InsertCPUFence() ;

/// @brief Method NotifyOfUIREvents, addr 0x49108f4, size 0x3c, virtual false, abstract: false, final false
static inline void NotifyOfUIREvents(bool  subscribe) ;

/// @brief Method ProfileDrawChainBegin, addr 0x49108a4, size 0x28, virtual false, abstract: false, final false
static inline void ProfileDrawChainBegin() ;

/// @brief Method ProfileDrawChainEnd, addr 0x49108cc, size 0x28, virtual false, abstract: false, final false
static inline void ProfileDrawChainEnd() ;

/// @brief Method RaiseEngineUpdate, addr 0x490fe24, size 0x94, virtual false, abstract: false, final false
static inline void RaiseEngineUpdate() ;

/// @brief Method RaiseFlushPendingResources, addr 0x490feb8, size 0x74, virtual false, abstract: false, final false
static inline void RaiseFlushPendingResources() ;

/// @brief Method RaiseGraphicsResourcesRecreate, addr 0x490fda8, size 0x7c, virtual false, abstract: false, final false
static inline void RaiseGraphicsResourcesRecreate(bool  recreate) ;

/// @brief Method RaiseRegisterIntermediateRenderers, addr 0x490ff2c, size 0x7c, virtual false, abstract: false, final false
static inline void RaiseRegisterIntermediateRenderers(::UnityEngine::Camera*  camera) ;

/// @brief Method RaiseRenderNodeAdd, addr 0x490ffa8, size 0x7c, virtual false, abstract: false, final false
static inline void RaiseRenderNodeAdd(::System::IntPtr  userData) ;

/// @brief Method RaiseRenderNodeCleanup, addr 0x49100a0, size 0x7c, virtual false, abstract: false, final false
static inline void RaiseRenderNodeCleanup(::System::IntPtr  userData) ;

/// @brief Method RaiseRenderNodeExecute, addr 0x4910024, size 0x7c, virtual false, abstract: false, final false
static inline void RaiseRenderNodeExecute(::System::IntPtr  userData) ;

/// @brief Method RegisterIntermediateRenderer, addr 0x49102b0, size 0xec, virtual false, abstract: false, final false
static inline void RegisterIntermediateRenderer(::UnityEngine::Camera*  camera, ::UnityEngine::Material*  material, ::UnityEngine::Matrix4x4  transform, ::UnityEngine::Bounds  aabb, int32_t  renderLayer, int32_t  shadowCasting, bool  receiveShadows, int32_t  sameDistanceSortPriority, uint64_t  sceneCullingMask, int32_t  rendererCallbackFlags, ::System::IntPtr  userData, int32_t  userDataSize) ;

/// @brief Method RegisterIntermediateRenderer_Injected, addr 0x491039c, size 0xc0, virtual false, abstract: false, final false
static inline void RegisterIntermediateRenderer_Injected(::UnityEngine::Camera*  camera, ::UnityEngine::Material*  material, ByRef<::UnityEngine::Matrix4x4>  transform, ByRef<::UnityEngine::Bounds>  aabb, int32_t  renderLayer, int32_t  shadowCasting, bool  receiveShadows, int32_t  sameDistanceSortPriority, uint64_t  sceneCullingMask, int32_t  rendererCallbackFlags, ::System::IntPtr  userData, int32_t  userDataSize) ;

/// @brief Method SetPropertyBlock, addr 0x49104d0, size 0x3c, virtual false, abstract: false, final false
static inline void SetPropertyBlock(::UnityEngine::MaterialPropertyBlock*  props) ;

/// @brief Method SetScissorRect, addr 0x491050c, size 0x80, virtual false, abstract: false, final false
static inline void SetScissorRect(::UnityEngine::RectInt  scissorRect) ;

/// @brief Method SetScissorRect_Injected, addr 0x491058c, size 0x3c, virtual false, abstract: false, final false
static inline void SetScissorRect_Injected(ByRef<::UnityEngine::RectInt>  scissorRect) ;

/// @brief Method SetStencilState, addr 0x49106b0, size 0x44, virtual false, abstract: false, final false
static inline void SetStencilState(::System::IntPtr  stencilState, int32_t  stencilRef) ;

/// @brief Method SetVectorArray, addr 0x4910218, size 0x5c, virtual false, abstract: false, final false
...
template<typename T>
static inline void SetVectorArray(::UnityEngine::MaterialPropertyBlock*  props, int32_t  name, ::Unity::Collections::NativeSlice_1<T>  vector4s) ;

/// @brief Method SyncRenderThread, addr 0x49107bc, size 0x28, virtual false, abstract: false, final false
static inline void SyncRenderThread() ;

/// @brief Method UpdateBufferRanges, addr 0x49101ac, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method WaitForCPUFencePassed, addr 0x4910780, size 0x3c, virtual false, abstract: false, final false
static inline void WaitForCPUFencePassed(uint32_t  fence) ;

/// @brief Method add_EngineUpdate, addr 0x490f668, size 0xdc, virtual false, abstract: false, final false
static inline void add_EngineUpdate(::System::Action*  value) ;

/// @brief Method add_FlushPendingResources, addr 0x490f820, size 0xdc, virtual false, abstract: false, final false
static inline void add_FlushPendingResources(::System::Action*  value) ;

/// @brief Method add_GraphicsResourcesRecreate, addr 0x490f488, size 0xf0, virtual false, abstract: false, final false
static inline void add_GraphicsResourcesRecreate(::System::Action_1<bool>*  value) ;

/// @brief Method add_RegisterIntermediateRenderers, addr 0x490f9d8, size 0xf4, virtual false, abstract: false, final false
static inline void add_RegisterIntermediateRenderers(::System::Action_1<::UnityW<::UnityEngine::Camera>>*  value) ;

/// @brief Method add_RenderNodeExecute, addr 0x490fbc0, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method remove_EngineUpdate, addr 0x490f744, size 0xdc, virtual false, abstract: false, final false
static inline void remove_EngineUpdate(::System::Action*  value) ;

/// @brief Method remove_FlushPendingResources, addr 0x490f8fc, size 0xdc, virtual false, abstract: false, final false
static inline void remove_FlushPendingResources(::System::Action*  value) ;

/// @brief Method remove_GraphicsResourcesRecreate, addr 0x490f578, size 0xf0, virtual false, abstract: false, final false
static inline void remove_GraphicsResourcesRecreate(::System::Action_1<bool>*  value) ;

/// @brief Method remove_RegisterIntermediateRenderers, addr 0x490facc, size 0xf4, virtual false, abstract: false, final false
static inline void remove_RegisterIntermediateRenderers(::System::Action_1<::UnityW<::UnityEngine::Camera>>*  value) ;

/// @brief Method remove_RenderNodeExecute, addr 0x490fcb4, size 0xf4, virtual false, abstract: false, final false
