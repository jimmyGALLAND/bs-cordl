...
/// @brief Field <currentElement>k__BackingField, offset 0x110, size 0x8 
 __declspec(property(get=__cordl_internal_get__currentElement_k__BackingField, put=__cordl_internal_set__currentElement_k__BackingField)) ::UnityEngine::UIElements::VisualElement*  _currentElement_k__BackingField;

/// @brief Field <meshGenerationContext>k__BackingField, offset 0x108, size 0x8 
 __declspec(property(get=__cordl_internal_get__meshGenerationContext_k__BackingField, put=__cordl_internal_set__meshGenerationContext_k__BackingField)) ::UnityEngine::UIElements::MeshGenerationContext*  _meshGenerationContext_k__BackingField;
...
/// @brief Field m_AllocRawVertsIndicesDelegate, offset 0xf8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AllocRawVertsIndicesDelegate, put=__cordl_internal_set_m_AllocRawVertsIndicesDelegate)) ::GlobalNamespace::__MeshBuilder__AllocMeshData__Allocator*  m_AllocRawVertsIndicesDelegate;

/// @brief Field m_AllocThroughDrawMeshDelegate, offset 0x100, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AllocThroughDrawMeshDelegate, put=__cordl_internal_set_m_AllocThroughDrawMeshDelegate)) ::GlobalNamespace::__MeshBuilder__AllocMeshData__Allocator*  m_AllocThroughDrawMeshDelegate;
...
/// @brief Field m_Entries, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Entries, put=__cordl_internal_set_m_Entries)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__Entry>*  m_Entries;
...
/// @brief Field m_RepeatRectUVList, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RepeatRectUVList, put=__cordl_internal_set_m_RepeatRectUVList)) ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__RepeatRectUV>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__RepeatRectUV>*>*>  m_RepeatRectUVList;
...
/// @brief Method AdjustSpriteWinding, addr 0x493411c, size 0x320, virtual false, abstract: false, final false
...
/// @brief Method AllocRawVertsIndices, addr 0x492d2dc, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method AllocThroughDrawMesh, addr 0x492d39c, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method ApplyInset, addr 0x492fd60, size 0x21c, virtual false, abstract: false, final false
...
/// @brief Method ApplyVisualElementClipping, addr 0x4933234, size 0x238, virtual false, abstract: false, final false
inline void ApplyVisualElementClipping() ;

/// @brief Method Begin, addr 0x492db88, size 0x510, virtual false, abstract: false, final false
inline void Begin(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method BuildEntryFromNativeMesh, addr 0x492e360, size 0x458, virtual false, abstract: false, final false
...
/// @brief Method BuildGradientEntryFromNativeMesh, addr 0x492e7b8, size 0x3f4, virtual false, abstract: false, final false
...
/// @brief Method BuildRawEntryFromNativeMesh, addr 0x492ebac, size 0x1e0, virtual false, abstract: false, final false
inline void BuildRawEntryFromNativeMesh(::UnityEngine::UIElements::MeshWriteDataInterface  meshData) ;

/// @brief Method DrawBorder, addr 0x492ff7c, size 0x90, virtual true, abstract: false, final true
inline void DrawBorder(::UnityEngine::UIElements::__MeshGenerationContextUtils__BorderParams  borderParams) ;

/// @brief Method DrawImmediate, addr 0x493000c, size 0x168, virtual true, abstract: false, final true
inline void DrawImmediate(::System::Action*  callback, bool  cullingEnabled) ;

/// @brief Method DrawMesh, addr 0x492d3b0, size 0x4a4, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::MeshWriteData* DrawMesh(int32_t  vertexCount, int32_t  indexCount, ::UnityEngine::Texture*  texture, ::UnityEngine::Material*  material, ::UnityEngine::UIElements::__MeshGenerationContext__MeshFlags  flags) ;

/// @brief Method DrawRectangle, addr 0x492f410, size 0x22c, virtual true, abstract: false, final true
inline void DrawRectangle(::UnityEngine::UIElements::__MeshGenerationContextUtils__RectangleParams  rectParams) ;

/// @brief Method DrawRectangleRepeat, addr 0x49312ac, size 0x1450, virtual false, abstract: false, final false
...
/// @brief Method DrawSprite, addr 0x492fa00, size 0x360, virtual false, abstract: false, final false
inline void DrawSprite(::UnityEngine::UIElements::__MeshGenerationContextUtils__RectangleParams  rectParams) ;

/// @brief Method DrawText, addr 0x492ed8c, size 0x98, virtual true, abstract: false, final true
inline void DrawText(::UnityEngine::UIElements::TextElement*  te) ;

/// @brief Method DrawTextInfo, addr 0x492ee24, size 0x5ec, virtual false, abstract: false, final false
inline void DrawTextInfo(::UnityEngine::TextCore::Text::TextInfo*  textInfo, ::UnityEngine::Vector2  offset, bool  useHints) ;

/// @brief Method DrawVectorImage, addr 0x492f63c, size 0x3c4, virtual false, abstract: false, final false
inline void DrawVectorImage(::UnityEngine::UIElements::__MeshGenerationContextUtils__RectangleParams  rectParams) ;

/// @brief Method DrawVisualElementBackground, addr 0x493017c, size 0x1130, virtual false, abstract: false, final false
inline void DrawVisualElementBackground() ;

/// @brief Method DrawVisualElementBorder, addr 0x49328fc, size 0x938, virtual false, abstract: false, final false
inline void DrawVisualElementBorder() ;

/// @brief Method GenerateStencilClipEntryForRoundedRectBackground, addr 0x49337ec, size 0x930, virtual false, abstract: false, final false
inline void GenerateStencilClipEntryForRoundedRectBackground() ;

/// @brief Method GenerateStencilClipEntryForSVGBackground, addr 0x493346c, size 0x380, virtual false, abstract: false, final false
inline void GenerateStencilClipEntryForSVGBackground() ;

/// @brief Method GetPooledMeshWriteData, addr 0x492d1cc, size 0x110, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MeshWriteData* GetPooledMeshWriteData() ;

/// @brief Method LandClipRegisterMesh, addr 0x492e10c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method LandClipUnregisterMeshDrawCommand, addr 0x492e098, size 0x74, virtual false, abstract: false, final false
inline void LandClipUnregisterMeshDrawCommand(::UnityEngine::UIElements::UIR::RenderChainCommand*  cmd) ;

/// @brief Method MakeVectorGraphics, addr 0x493443c, size 0x3d0, virtual false, abstract: false, final false
inline void MakeVectorGraphics(::UnityEngine::UIElements::__MeshGenerationContextUtils__RectangleParams  rectParams, bool  isUsingGradients, ::UnityEngine::UIElements::TextureId  svgTexture, int32_t  settingIndexOffset, ByRef<int32_t>  finalVertexCount, ByRef<int32_t>  finalIndexCount) ;
...
/// @brief Method Reset, addr 0x493480c, size 0x88, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method StampRectangleWithSubRect, addr 0x49326fc, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method TryAtlasTexture, addr 0x492e1a8, size 0x1b8, virtual false, abstract: false, final false
inline void TryAtlasTexture(::UnityEngine::Texture*  texture, ::UnityEngine::UIElements::__MeshGenerationContext__MeshFlags  flags, ByRef<::UnityEngine::Rect>  outUVRegion, ByRef<bool>  outIsAtlas, ByRef<::UnityEngine::UIElements::TextureId>  outTextureId, ByRef<::UnityEngine::UIElements::UIR::VertexFlags>  outAddFlags) ;

/// @brief Method ValidateMeshWriteData, addr 0x4934894, size 0x444, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__Entry>*> const& __cordl_internal_get_m_Entries() const;
...
constexpr ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__RepeatRectUV>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__RepeatRectUV>*>*> const& __cordl_internal_get_m_RepeatRectUVList() const;

constexpr ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__RepeatRectUV>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__RepeatRectUV>*>*>& __cordl_internal_get_m_RepeatRectUVList() ;
...
constexpr void __cordl_internal_set_m_RepeatRectUVList(::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__RepeatRectUV>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__RepeatRectUV>*>*>  value) ;
...
/// @brief Method .ctor, addr 0x492d854, size 0x2d8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::UIR::RenderChain*  renderChain) ;

/// @brief Method get_closingInfo, addr 0x492db4c, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__ClosingInfo get_closingInfo() ;

/// @brief Method get_currentElement, addr 0x492db34, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_currentElement() ;

/// @brief Method get_entries, addr 0x492db44, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__Entry>* get_entries() ;

/// @brief Method get_meshGenerationContext, addr 0x492db2c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MeshGenerationContext* get_meshGenerationContext() ;

/// @brief Method get_totalIndices, addr 0x492db78, size 0x8, virtual false, abstract: false, final false
inline int32_t get_totalIndices() ;

/// @brief Method get_totalVertices, addr 0x492db68, size 0x8, virtual false, abstract: false, final false
inline int32_t get_totalVertices() ;

/// @brief Method get_visualElement, addr 0x4930174, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_currentElement, addr 0x492db3c, size 0x8, virtual false, abstract: false, final false
inline void set_currentElement(::UnityEngine::UIElements::VisualElement*  value) ;

/// @brief Method set_totalIndices, addr 0x492db80, size 0x8, virtual false, abstract: false, final false
inline void set_totalIndices(int32_t  value) ;

/// @brief Method set_totalVertices, addr 0x492db70, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field m_RepeatRectUVList, offset: 0xf0, size: 0x8, def value: None
 ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__RepeatRectUV>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::__UIRStylePainter__RepeatRectUV>*>*>  ___m_RepeatRectUVList;
