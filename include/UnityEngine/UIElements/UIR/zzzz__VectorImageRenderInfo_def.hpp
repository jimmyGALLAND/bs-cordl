...
/// @brief Method Reset, addr 0x491e148, size 0x10, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x491e0e0, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
