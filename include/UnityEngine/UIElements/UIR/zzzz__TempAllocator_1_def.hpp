...
template<typename T>
struct __TempAllocator_1__Page;
}
...
/// @brief Field m_Excess, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Excess, put=__cordl_internal_set_m_Excess)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::__TempAllocator_1__Page<T>>*  m_Excess;
