...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Unity::Collections::NativeArray_1<T>>*> const& UnityEngine::UIElements::UIR::NativePagedList_1<T>::__cordl_internal_get_m_Pages() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Pages;
}
template<typename T>
...
template<typename T>
constexpr ::Unity::Collections::NativeArray_1<T>& UnityEngine::UIElements::UIR::NativePagedList_1<T>::__cordl_internal_get_m_CurrentPage()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_CurrentPage;
}
template<typename T>
constexpr ::Unity::Collections::NativeArray_1<T> const& UnityEngine::UIElements::UIR::NativePagedList_1<T>::__cordl_internal_get_m_CurrentPage() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_CurrentPage;
}
template<typename T>
constexpr void UnityEngine::UIElements::UIR::NativePagedList_1<T>::__cordl_internal_set_m_CurrentPage(::Unity::Collections::NativeArray_1<T>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
this->___m_CurrentPage = value;
}
template<typename T>
constexpr int32_t& UnityEngine::UIElements::UIR::NativePagedList_1<T>::__cordl_internal_get_m_CurrentPageCount()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_CurrentPageCount;
}
template<typename T>
constexpr int32_t const& UnityEngine::UIElements::UIR::NativePagedList_1<T>::__cordl_internal_get_m_CurrentPageCount() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_CurrentPageCount;
}
template<typename T>
constexpr void UnityEngine::UIElements::UIR::NativePagedList_1<T>::__cordl_internal_set_m_CurrentPageCount(int32_t  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Unity::Collections::NativeSlice_1<T>>*> const& UnityEngine::UIElements::UIR::NativePagedList_1<T>::__cordl_internal_get_m_Enumerator() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Enumerator;
}
template<typename T>
...
template<typename T>
inline ::UnityEngine::UIElements::UIR::NativePagedList_1<T>* UnityEngine::UIElements::UIR::NativePagedList_1<T>::New_ctor(int32_t  poolCapacity)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::UIElements::UIR::NativePagedList_1<T>*>(poolCapacity));
}
template<typename T>
inline void UnityEngine::UIElements::UIR::NativePagedList_1<T>::_ctor(int32_t  poolCapacity)  {
