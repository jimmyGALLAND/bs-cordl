...
/// @brief Field m_CopyClosingMeshJobs, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CopyClosingMeshJobs, put=__cordl_internal_set_m_CopyClosingMeshJobs)) ::UnityEngine::UIElements::UIR::NativePagedList_1<::UnityEngine::UIElements::UIR::CopyClosingMeshJobData>*  m_CopyClosingMeshJobs;
...
/// @brief Method Add, addr 0x4912800, size 0x58, virtual false, abstract: false, final false
inline void Add(ByRef<::UnityEngine::UIElements::UIR::ConvertMeshJobData>  job) ;

/// @brief Method Add, addr 0x4912858, size 0x58, virtual false, abstract: false, final false
inline void Add(ByRef<::UnityEngine::UIElements::UIR::CopyClosingMeshJobData>  job) ;

/// @brief Method Add, addr 0x49127a8, size 0x58, virtual false, abstract: false, final false
inline void Add(ByRef<::UnityEngine::UIElements::UIR::NudgeJobData>  job) ;

/// @brief Method CompleteClosingMeshJobs, addr 0x4912e1c, size 0x23c, virtual false, abstract: false, final false
inline void CompleteClosingMeshJobs() ;

/// @brief Method CompleteConvertMeshJobs, addr 0x4912be0, size 0x23c, virtual false, abstract: false, final false
inline void CompleteConvertMeshJobs() ;

/// @brief Method CompleteNudgeJobs, addr 0x49128b0, size 0x23c, virtual false, abstract: false, final false
inline void CompleteNudgeJobs() ;

/// @brief Method Dispose, addr 0x491306c, size 0x64, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x49130d0, size 0xc0, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIR::NativePagedList_1<::UnityEngine::UIElements::UIR::ConvertMeshJobData>*> const& __cordl_internal_get_m_ConvertMeshJobs() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIR::NativePagedList_1<::UnityEngine::UIElements::UIR::CopyClosingMeshJobData>*> const& __cordl_internal_get_m_CopyClosingMeshJobs() const;
...
/// @brief Method .ctor, addr 0x49131f4, size 0x144, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disposed, addr 0x4913058, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_disposed, addr 0x4913060, size 0xc, virtual false, abstract: false, final false
