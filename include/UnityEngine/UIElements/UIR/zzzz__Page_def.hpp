...
static inline ::UnityEngine::UIElements::UIR::__Page__DataSet_1<T>* New_ctor(::UnityEngine::UIElements::UIR::__Utility__GPUBufferType  bufferType, uint32_t  totalCount, uint32_t  maxQueuedFrameCount, uint32_t  updateRangePoolSize, bool  mockBuffer) ;
...
// Declarations
template<typename T>
using DataSet_1 = ::UnityEngine::UIElements::UIR::__Page__DataSet_1<T>;
...
/// @brief Method Dispose, addr 0x4924a00, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x49257c8, size 0x90, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;
...
/// @brief Method .ctor, addr 0x4921760, size 0x150, virtual false, abstract: false, final false
inline void _ctor(uint32_t  vertexMaxCount, uint32_t  indexMaxCount, uint32_t  maxQueuedFrameCount, bool  mockPage) ;

/// @brief Method get_disposed, addr 0x49257b4, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Method get_isEmpty, addr 0x49218b0, size 0x48, virtual false, abstract: false, final false
inline bool get_isEmpty() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_disposed, addr 0x49257bc, size 0xc, virtual false, abstract: false, final false
inline void set_disposed(bool  value) ;
