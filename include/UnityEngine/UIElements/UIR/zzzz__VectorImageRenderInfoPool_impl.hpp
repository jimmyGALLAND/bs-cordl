...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c::*)()>(&::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x491e088;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::UIR::VectorImageRenderInfo* (::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c::*)()>(&::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c::__ctor_b__0_0)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x491e090;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c::*)(::UnityEngine::UIElements::UIR::VectorImageRenderInfo*)>(&::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c::__ctor_b__0_1)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "<.ctor>b__0_1",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::UIR::VectorImageRenderInfo*>::get()}
                    )));
    return ___internal_method;
  }
};
...
::cordl_internals::setStaticField<::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c*>::get>(std::forward<::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c*>(value));
}
...
return ::cordl_internals::getStaticField<::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c*>::get>();
}
...
::cordl_internals::setStaticField<::System::Func_1<::UnityEngine::UIElements::UIR::VectorImageRenderInfo*>*, "<>9__0_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c*>::get>(std::forward<::System::Func_1<::UnityEngine::UIElements::UIR::VectorImageRenderInfo*>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Func_1<::UnityEngine::UIElements::UIR::VectorImageRenderInfo*>*, "<>9__0_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c*>::get>();
}
...
::cordl_internals::setStaticField<::System::Action_1<::UnityEngine::UIElements::UIR::VectorImageRenderInfo*>*, "<>9__0_1", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c*>::get>(std::forward<::System::Action_1<::UnityEngine::UIElements::UIR::VectorImageRenderInfo*>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Action_1<::UnityEngine::UIElements::UIR::VectorImageRenderInfo*>*, "<>9__0_1", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIR::__VectorImageRenderInfoPool____c*>::get>();
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::UIR::VectorImageRenderInfoPool::*)()>(&::UnityEngine::UIElements::UIR::VectorImageRenderInfoPool::_ctor)> {
  constexpr static std::size_t size = 0x184;
  constexpr static std::size_t addrs = 0x491dea8;
