...
public:
// Declarations
/// @brief Method CreateBlock, addr 0x492561c, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method ResetBlock, addr 0x49256b4, size 0x4, virtual false, abstract: false, final false
static inline void ResetBlock(::UnityEngine::UIElements::UIR::__BestFitAllocator__Block*  block) ;

/// @brief Method .ctor, addr 0x4924ee8, size 0xec, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x492566c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_size, addr 0x49251c0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field m_FirstAvailableBlock, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_FirstAvailableBlock, put=__cordl_internal_set_m_FirstAvailableBlock)) ::UnityEngine::UIElements::UIR::__BestFitAllocator__Block*  m_FirstAvailableBlock;
...
/// @brief Method Allocate, addr 0x4924fe4, size 0x198, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t  size) ;

/// @brief Method BestFitFindAvailableBlock, addr 0x492517c, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::__BestFitAllocator__Block* BestFitFindAvailableBlock(uint32_t  size) ;

/// @brief Method CoalesceBlockWithPrevious, addr 0x4925514, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method Free, addr 0x49252b8, size 0x25c, virtual false, abstract: false, final false
...
/// @brief Method SplitBlock, addr 0x49251cc, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4924e44, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(uint32_t  size) ;

/// @brief Method get_highWatermark, addr 0x4924fdc, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_highWatermark() ;

/// @brief Method get_totalSize, addr 0x4924fd4, size 0x8, virtual false, abstract: false, final false
