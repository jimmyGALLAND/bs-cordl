...
/// @brief Method AllocatesID, addr 0x4918658, size 0x6c, virtual false, abstract: false, final false
static inline bool AllocatesID(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method InheritsID, addr 0x49186d4, size 0x68, virtual false, abstract: false, final false
static inline bool InheritsID(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method get_isIgnoringDynamicColorHint, addr 0x491873c, size 0xc, virtual false, abstract: false, final false
inline bool get_isIgnoringDynamicColorHint() ;

/// @brief Method get_lastClosingOrLastCommand, addr 0x4918640, size 0x18, virtual false, abstract: false, final false
