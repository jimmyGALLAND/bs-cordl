...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::UIR::DrawParams::*)()>(&::UnityEngine::UIElements::UIR::DrawParams::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x491f6cc;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityW<::UnityEngine::RenderTexture>>*> const& UnityEngine::UIElements::UIR::DrawParams::__cordl_internal_get_renderTexture() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___renderTexture;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Material>>*> const& UnityEngine::UIElements::UIR::DrawParams::__cordl_internal_get_defaultMaterial() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___defaultMaterial;
}
