...
public:
// Declarations
/// @brief Method ScheduleConvertMeshJobs, addr 0x4910b2c, size 0x5c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleConvertMeshJobs(::System::IntPtr  buffer, int32_t  jobCount) ;

/// @brief Method ScheduleConvertMeshJobs_Injected, addr 0x4910b88, size 0x54, virtual false, abstract: false, final false
static inline void ScheduleConvertMeshJobs_Injected(::System::IntPtr  buffer, int32_t  jobCount, ByRef<::Unity::Jobs::JobHandle>  ret) ;

/// @brief Method ScheduleCopyClosingMeshJobs, addr 0x4910bdc, size 0x5c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleCopyClosingMeshJobs(::System::IntPtr  buffer, int32_t  jobCount) ;

/// @brief Method ScheduleCopyClosingMeshJobs_Injected, addr 0x4910c38, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method ScheduleNudgeJobs, addr 0x4910a7c, size 0x5c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleNudgeJobs(::System::IntPtr  buffer, int32_t  jobCount) ;

/// @brief Method ScheduleNudgeJobs_Injected, addr 0x4910ad8, size 0x54, virtual false, abstract: false, final false
