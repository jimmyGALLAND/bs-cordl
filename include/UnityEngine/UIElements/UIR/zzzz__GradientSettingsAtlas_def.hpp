...
public:
// Declarations
/// @brief Method WriteRawFloat4Packed, addr 0x49123e8, size 0xa8, virtual false, abstract: false, final false
inline void WriteRawFloat4Packed(float_t  f0, float_t  f1, float_t  f2, float_t  f3, int32_t  destX, int32_t  destY) ;

/// @brief Method WriteRawInt2Packed, addr 0x4912490, size 0x90, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "rgba", ty: "::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>", modifiers: "", def_value: None }, CppParam { name: "width", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "height", ty: "int32_t", modifiers: "", def_value: None }]
...
/// @brief Method Add, addr 0x4911f68, size 0xdc, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::Alloc Add(int32_t  count) ;

/// @brief Method Commit, addr 0x4912534, size 0x64, virtual false, abstract: false, final false
inline void Commit() ;

/// @brief Method Dispose, addr 0x4911d94, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x4911e00, size 0x78, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

static inline ::UnityEngine::UIElements::UIR::GradientSettingsAtlas* New_ctor(int32_t  length) ;

/// @brief Method PrepareAtlas, addr 0x4912598, size 0x15c, virtual false, abstract: false, final false
inline void PrepareAtlas() ;

/// @brief Method Reset, addr 0x4911ea8, size 0xb8, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Write, addr 0x4912044, size 0x3a4, virtual false, abstract: false, final false
inline void Write(::UnityEngine::UIElements::UIR::Alloc  alloc, ::ArrayW<::UnityEngine::UIElements::GradientSettings,::Array<::UnityEngine::UIElements::GradientSettings>*>  settings, ::UnityEngine::UIElements::UIR::GradientRemap*  remap) ;
...
/// @brief Method .ctor, addr 0x4911e78, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_MustCommit, addr 0x4912520, size 0x8, virtual false, abstract: false, final false
inline bool get_MustCommit() ;

/// @brief Method get_atlas, addr 0x4911f60, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture2D> get_atlas() ;

/// @brief Method get_disposed, addr 0x4911d80, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Method get_length, addr 0x4911d78, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_MustCommit, addr 0x4912528, size 0xc, virtual false, abstract: false, final false
inline void set_MustCommit(bool  value) ;

/// @brief Method set_disposed, addr 0x4911d88, size 0xc, virtual false, abstract: false, final false
