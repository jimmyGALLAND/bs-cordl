...
/// @brief Field m_Textures, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Textures, put=__cordl_internal_set_m_Textures)) ::ArrayW<::UnityEngine::UIElements::TextureId,::Array<::UnityEngine::UIElements::TextureId>*>  m_Textures;
...
/// @brief Method Bind, addr 0x491a904, size 0x1e4, virtual false, abstract: false, final false
inline void Bind(::UnityEngine::UIElements::TextureId  id, float_t  sdfScale, int32_t  slot, ::UnityEngine::MaterialPropertyBlock*  mat) ;

/// @brief Method FindOldestSlot, addr 0x491a834, size 0xd0, virtual false, abstract: false, final false
inline int32_t FindOldestSlot() ;

/// @brief Method IndexOf, addr 0x491a6d4, size 0xf8, virtual false, abstract: false, final false
inline int32_t IndexOf(::UnityEngine::UIElements::TextureId  id) ;

/// @brief Method MarkUsed, addr 0x491a7cc, size 0x58, virtual false, abstract: false, final false
inline void MarkUsed(int32_t  slotIndex) ;

static inline ::UnityEngine::UIElements::UIR::TextureSlotManager* New_ctor() ;

/// @brief Method Reset, addr 0x491a420, size 0x11c, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetGpuData, addr 0x491a53c, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method StartNewBatch, addr 0x491a668, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x491a2b4, size 0x16c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_FreeSlots, addr 0x491a824, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_FreeSlots, addr 0x491a82c, size 0x8, virtual false, abstract: false, final false
