...
public:
// Declarations
/// @brief Method CaptureMouse, addr 0x49ab674, size 0xd8, virtual false, abstract: false, final false
static inline void CaptureMouse(::UnityEngine::UIElements::IEventHandler*  handler) ;

/// @brief Method HasMouseCapture, addr 0x49a9e20, size 0xac, virtual false, abstract: false, final false
static inline bool HasMouseCapture(::UnityEngine::UIElements::IEventHandler*  handler) ;

/// @brief Method ReleaseMouse, addr 0x49ab848, size 0xd8, virtual false, abstract: false, final false
