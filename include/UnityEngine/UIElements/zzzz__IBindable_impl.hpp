...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::IBinding* (::UnityEngine::UIElements::IBindable::*)()>(&::UnityEngine::UIElements::IBindable::get_binding)> {
