...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::UIElements::IUxmlAttributes::*)(::StringW, ByRef<::StringW>)>(&::UnityEngine::UIElements::IUxmlAttributes::TryGetAttributeValue)> {
