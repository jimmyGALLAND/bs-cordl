...
template<typename T>
inline bool UnityEngine::UIElements::TreeViewItemData_1<T>::get_hasChildren()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::TreeViewItemData_1<T>>::get(),
                        "get_hasChildren",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T>
inline void UnityEngine::UIElements::TreeViewItemData_1<T>::InsertChild(::UnityEngine::UIElements::TreeViewItemData_1<T>  child, int32_t  index)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::TreeViewItemData_1<T>>::get(),
                        "InsertChild",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::TreeViewItemData_1<T>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, child, index);
}
template<typename T>
inline void UnityEngine::UIElements::TreeViewItemData_1<T>::RemoveChild(int32_t  childId)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::TreeViewItemData_1<T>>::get(),
                        "RemoveChild",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T>
inline int32_t UnityEngine::UIElements::TreeViewItemData_1<T>::GetChildIndex(int32_t  itemId)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::TreeViewItemData_1<T>>::get(),
                        "GetChildIndex",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T>
inline void UnityEngine::UIElements::TreeViewItemData_1<T>::ReplaceChild(::UnityEngine::UIElements::TreeViewItemData_1<T>  newChild)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::TreeViewItemData_1<T>>::get(),
                        "ReplaceChild",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters [CppParam { name: "_id_k__BackingField", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Data", ty: "T", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "m_Children", ty: "::System::Collections::Generic::IList_1<::UnityEngine::UIElements::TreeViewItemData_1<T>>*", modifiers: "", def_value: Some("nullptr") }]
template<typename T>
