...
static __declspec(property(get=getStaticF_s_ComputedStyleCache, put=setStaticF_s_ComputedStyleCache)) ::System::Collections::Generic::Dictionary_2<int64_t,::UnityEngine::UIElements::ComputedStyle>*  s_ComputedStyleCache;

/// @brief Field s_ComputedTransitionsCache, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_ComputedTransitionsCache, put=setStaticF_s_ComputedTransitionsCache)) ::System::Collections::Generic::Dictionary_2<int32_t,::ArrayW<::UnityEngine::UIElements::ComputedTransitionProperty,::Array<::UnityEngine::UIElements::ComputedTransitionProperty>*>>*  s_ComputedTransitionsCache;

/// @brief Field s_StyleVariableContextCache, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_StyleVariableContextCache, put=setStaticF_s_StyleVariableContextCache)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::UIElements::StyleVariableContext*>*  s_StyleVariableContextCache;

/// @brief Method SetValue, addr 0x490bffc, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method SetValue, addr 0x490bedc, size 0x90, virtual false, abstract: false, final false
static inline void SetValue(int32_t  hash, ::UnityEngine::UIElements::StyleVariableContext*  data) ;

/// @brief Method SetValue, addr 0x490bd88, size 0xc4, virtual false, abstract: false, final false
static inline void SetValue(int64_t  hash, ByRef<::UnityEngine::UIElements::ComputedStyle>  data) ;

/// @brief Method TryGetValue, addr 0x490bf6c, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method TryGetValue, addr 0x490be4c, size 0x90, virtual false, abstract: false, final false
static inline bool TryGetValue(int32_t  hash, ByRef<::UnityEngine::UIElements::StyleVariableContext*>  data) ;

/// @brief Method TryGetValue, addr 0x490bcf8, size 0x90, virtual false, abstract: false, final false
