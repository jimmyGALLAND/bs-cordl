...
/// @brief Method OnEnter, addr 0x490a3e8, size 0x10, virtual false, abstract: false, final false
inline void OnEnter(::UnityEngine::UIElements::AttachToPanelEvent*  evt) ;

/// @brief Method OnLeave, addr 0x490a3f8, size 0x74, virtual false, abstract: false, final false
inline void OnLeave(::UnityEngine::UIElements::DetachFromPanelEvent*  evt) ;

/// @brief Method SendActivation, addr 0x490a1b8, size 0x118, virtual false, abstract: false, final false
inline void SendActivation() ;

/// @brief Method SendDeactivation, addr 0x490a2d0, size 0x118, virtual false, abstract: false, final false
inline void SendDeactivation() ;

/// @brief Method SetActive, addr 0x4909f68, size 0x250, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::AttachToPanelEvent*>*> const& __cordl_internal_get_m_OnAttachToPanelCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::DetachFromPanelEvent*>*> const& __cordl_internal_get_m_OnDetachFromPanelCallback() const;
...
/// @brief Method .ctor, addr 0x4909e88, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::IVisualElementPanelActivatable*  activatable) ;

/// @brief Method get_isActive, addr 0x4909e60, size 0x8, virtual false, abstract: false, final false
inline bool get_isActive() ;

/// @brief Method get_isDetaching, addr 0x4909e74, size 0x8, virtual false, abstract: false, final false
inline bool get_isDetaching() ;

/// @brief Method set_isActive, addr 0x4909e68, size 0xc, virtual false, abstract: false, final false
inline void set_isActive(bool  value) ;

/// @brief Method set_isDetaching, addr 0x4909e7c, size 0xc, virtual false, abstract: false, final false
