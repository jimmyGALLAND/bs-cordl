...
static __declspec(property(get=getStaticF_s_AnimatableProperties, put=setStaticF_s_AnimatableProperties)) ::System::Collections::Generic::HashSet_1<::UnityEngine::UIElements::StyleSheets::StylePropertyId>*  s_AnimatableProperties;

/// @brief Field s_AnimatableWithUsageHintProperties, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_AnimatableWithUsageHintProperties, put=setStaticF_s_AnimatableWithUsageHintProperties)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::UnityEngine::UIElements::UsageHints>*  s_AnimatableWithUsageHintProperties;

/// @brief Field s_IdToName, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_IdToName, put=setStaticF_s_IdToName)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::StringW>*  s_IdToName;

/// @brief Field s_NameToId, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_NameToId, put=setStaticF_s_NameToId)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleSheets::StylePropertyId>*  s_NameToId;

/// @brief Method IsAnimatable, addr 0x493cf9c, size 0x80, virtual false, abstract: false, final false
static inline bool IsAnimatable(::UnityEngine::UIElements::StyleSheets::StylePropertyId  id) ;

/// @brief Method IsMatchingShorthand, addr 0x493ce30, size 0x16c, virtual false, abstract: false, final false
...
/// @brief Method TryGetEnumIntValue, addr 0x493a820, size 0xf78, virtual false, abstract: false, final false
