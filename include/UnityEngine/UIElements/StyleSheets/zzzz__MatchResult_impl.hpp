...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::UIElements::StyleSheets::MatchResult::*)()>(&::UnityEngine::UIElements::StyleSheets::MatchResult::get_success)> {
  ...
  constexpr static std::size_t addrs = 0x49462fc;
...
// Ctor Parameters [CppParam { name: "errorCode", ty: "::UnityEngine::UIElements::StyleSheets::MatchResultErrorCode", modifiers: "", def_value: Some("{}") }, CppParam { name: "errorValue", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }]
