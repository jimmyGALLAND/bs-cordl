...
public:
// Declarations
/// @brief Method IsVarFunction, addr 0x49462c8, size 0x34, virtual false, abstract: false, final false
static inline bool IsVarFunction(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadAsString, addr 0x4945fe4, size 0x2e4, virtual false, abstract: false, final false
