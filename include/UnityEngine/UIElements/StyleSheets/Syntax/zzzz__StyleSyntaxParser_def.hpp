...
/// @brief Method EatSpace, addr 0x4949b54, size 0x40, virtual false, abstract: false, final false
static inline void EatSpace(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenizer*  tokenizer) ;

/// @brief Method IsCombinator, addr 0x4949b40, size 0x14, virtual false, abstract: false, final false
static inline bool IsCombinator(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken  token) ;

/// @brief Method IsExpressionEnd, addr 0x494941c, size 0x20, virtual false, abstract: false, final false
static inline bool IsExpressionEnd(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken  token) ;

/// @brief Method IsMultiplier, addr 0x4949fc8, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x4947ab4, size 0x194, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleSheets::Syntax::Expression* Parse(::StringW  syntax) ;

/// @brief Method ParseCombinatorType, addr 0x4948fe8, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method ParseDataType, addr 0x494943c, size 0x3dc, virtual false, abstract: false, final false
...
/// @brief Method ParseExpression, addr 0x494893c, size 0x278, virtual false, abstract: false, final false
...
/// @brief Method ParseGroup, addr 0x4948dc4, size 0x224, virtual false, abstract: false, final false
...
/// @brief Method ParseMultiplier, addr 0x494991c, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method ParseNonTerminalValue, addr 0x4949b94, size 0x150, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleSheets::Syntax::Expression* ParseNonTerminalValue(::StringW  syntax) ;

/// @brief Method ParseProperty, addr 0x4949ce4, size 0x2e4, virtual false, abstract: false, final false
...
/// @brief Method ParseRanges, addr 0x4949fec, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method ParseTerm, addr 0x4948c60, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method ProcessCombinatorStack, addr 0x4949138, size 0x2e4, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionCombinator>*> const& __cordl_internal_get_m_CombinatorStack() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*>*> const& __cordl_internal_get_m_ExpressionStack() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleSheets::Syntax::Expression*>*> const& __cordl_internal_get_m_ParsedExpressionCache() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*>*> const& __cordl_internal_get_m_ProcessExpressionList() const;
...
/// @brief Method .ctor, addr 0x494a108, size 0x154, virtual false, abstract: false, final false
inline void _ctor() ;
