...
/// @brief Field subExpressions, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_subExpressions, put=__cordl_internal_set_subExpressions)) ::ArrayW<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*,::Array<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*>*>  subExpressions;
...
constexpr ::ArrayW<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*,::Array<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*>*> const& __cordl_internal_get_subExpressions() const;
...
constexpr void __cordl_internal_set_subExpressions(::ArrayW<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*,::Array<::UnityEngine::UIElements::StyleSheets::Syntax::Expression*>*>  value) ;

constexpr void __cordl_internal_set_type(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionType  value) ;

/// @brief Method .ctor, addr 0x4947a08, size 0x44, virtual false, abstract: false, final false
