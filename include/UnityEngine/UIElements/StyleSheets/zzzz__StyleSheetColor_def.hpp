...
/// @brief Method HexToColor32, addr 0x494457c, size 0x14, virtual false, abstract: false, final false
static inline ::UnityEngine::Color32 HexToColor32(uint32_t  color) ;

/// @brief Method TryGetColor, addr 0x4940c54, size 0xd8, virtual false, abstract: false, final false
