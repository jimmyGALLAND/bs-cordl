...
/// @brief Method TryGetNonTerminalValue, addr 0x493b974, size 0x90, virtual false, abstract: false, final false
static inline bool TryGetNonTerminalValue(::StringW  name, ByRef<::StringW>  syntax) ;

/// @brief Method TryGetSyntax, addr 0x493b8e4, size 0x90, virtual false, abstract: false, final false
