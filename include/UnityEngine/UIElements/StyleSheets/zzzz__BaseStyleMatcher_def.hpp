...
/// @brief Field m_ContextStack, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ContextStack, put=__cordl_internal_set_m_ContextStack)) ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::StyleSheets::__BaseStyleMatcher__MatchContext>*  m_ContextStack;

/// @brief Field m_CurrentContext, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CurrentContext, put=__cordl_internal_set_m_CurrentContext)) ::UnityEngine::UIElements::StyleSheets::__BaseStyleMatcher__MatchContext  m_CurrentContext;
...
/// @brief Method DropContext, addr 0x4946498, size 0x50, virtual false, abstract: false, final false
inline void DropContext() ;

/// @brief Method Initialize, addr 0x4946354, size 0x54, virtual false, abstract: false, final false
inline void Initialize() ;

/// @brief Method Match, addr 0x49464e8, size 0xb4, virtual false, abstract: false, final false
inline bool Match(::UnityEngine::UIElements::StyleSheets::Syntax::Expression*  exp) ;

/// @brief Method MatchAndAnd, addr 0x4946b60, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method MatchCombinator, addr 0x4946800, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method MatchDataType, addr 0x49468cc, size 0xfc, virtual false, abstract: false, final false
inline bool MatchDataType(::UnityEngine::UIElements::StyleSheets::Syntax::Expression*  exp) ;

/// @brief Method MatchExpression, addr 0x49465a4, size 0x114, virtual false, abstract: false, final false
inline bool MatchExpression(::UnityEngine::UIElements::StyleSheets::Syntax::Expression*  exp) ;

/// @brief Method MatchExpressionWithMultiplier, addr 0x49466b8, size 0x148, virtual false, abstract: false, final false
inline bool MatchExpressionWithMultiplier(::UnityEngine::UIElements::StyleSheets::Syntax::Expression*  exp) ;

/// @brief Method MatchGroup, addr 0x49469c8, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method MatchJuxtaposition, addr 0x4946b90, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method MatchMany, addr 0x4946c08, size 0x174, virtual false, abstract: false, final false
inline int32_t MatchMany(::UnityEngine::UIElements::StyleSheets::Syntax::Expression*  exp) ;

/// @brief Method MatchManyByOrder, addr 0x4946d7c, size 0x194, virtual false, abstract: false, final false
...
/// @brief Method MatchOr, addr 0x4946a7c, size 0xcc, virtual false, abstract: false, final false
inline bool MatchOr(::UnityEngine::UIElements::StyleSheets::Syntax::Expression*  exp) ;

/// @brief Method MatchOrOr, addr 0x4946b48, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x49463a8, size 0x44, virtual false, abstract: false, final false
inline void MoveNext() ;

static inline ::UnityEngine::UIElements::StyleSheets::BaseStyleMatcher* New_ctor() ;

/// @brief Method RestoreContext, addr 0x4946440, size 0x58, virtual false, abstract: false, final false
inline void RestoreContext() ;

/// @brief Method SaveContext, addr 0x49463ec, size 0x54, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::StyleSheets::__BaseStyleMatcher__MatchContext>*> const& __cordl_internal_get_m_ContextStack() const;
...
/// @brief Method .ctor, addr 0x4946f10, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Text::RegularExpressions::Regex* getStaticF_s_CustomIdentRegex() ;

/// @brief Method get_currentIndex, addr 0x4946334, size 0x8, virtual false, abstract: false, final false
inline int32_t get_currentIndex() ;

/// @brief Method get_hasCurrent, addr 0x494630c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_matchedVariableCount, addr 0x4946344, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_currentIndex, addr 0x494633c, size 0x8, virtual false, abstract: false, final false
inline void set_currentIndex(int32_t  value) ;

/// @brief Method set_matchedVariableCount, addr 0x494634c, size 0x8, virtual false, abstract: false, final false
