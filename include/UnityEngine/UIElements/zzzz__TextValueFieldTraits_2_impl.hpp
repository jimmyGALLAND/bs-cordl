...
template<typename TValueType,typename TValueUxmlAttributeType>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlBoolAttributeDescription*> const& UnityEngine::UIElements::TextValueFieldTraits_2<TValueType,TValueUxmlAttributeType>::__cordl_internal_get_m_IsReadOnly() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_IsReadOnly;
}
template<typename TValueType,typename TValueUxmlAttributeType>
...
template<typename TValueType,typename TValueUxmlAttributeType>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlBoolAttributeDescription*> const& UnityEngine::UIElements::TextValueFieldTraits_2<TValueType,TValueUxmlAttributeType>::__cordl_internal_get_m_IsDelayed() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_IsDelayed;
}
template<typename TValueType,typename TValueUxmlAttributeType>
