...
/// @brief Method <.cctor>b__21_0, addr 0x49b24fc, size 0x54, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::__UIRAtlasAllocator__Row* __cctor_b__21_0() ;

/// @brief Method .ctor, addr 0x49b24f4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Acquire, addr 0x49b2154, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x49b16a4, size 0x90, virtual false, abstract: false, final false
inline void Release() ;
...
/// @brief Method .ctor, addr 0x49b2380, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::UIElements::ObjectPool_1<::UnityEngine::UIElements::__UIRAtlasAllocator__Row*>* getStaticF_s_Pool() ;

/// @brief Method get_offsetX, addr 0x49b2348, size 0x8, virtual false, abstract: false, final false
inline int32_t get_offsetX() ;

/// @brief Method get_offsetY, addr 0x49b2358, size 0x8, virtual false, abstract: false, final false
inline int32_t get_offsetY() ;

/// @brief Method get_width, addr 0x49b2368, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_height, addr 0x49b2378, size 0x8, virtual false, abstract: false, final false
inline void set_height(int32_t  value) ;

/// @brief Method set_offsetX, addr 0x49b2350, size 0x8, virtual false, abstract: false, final false
inline void set_offsetX(int32_t  value) ;

/// @brief Method set_offsetY, addr 0x49b2360, size 0x8, virtual false, abstract: false, final false
inline void set_offsetY(int32_t  value) ;

/// @brief Method set_width, addr 0x49b2370, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <.cctor>b__9_0, addr 0x49b26cc, size 0x54, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::__UIRAtlasAllocator__AreaNode* __cctor_b__9_0() ;

/// @brief Method .ctor, addr 0x49b26c4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Acquire, addr 0x49b1a88, size 0x98, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::__UIRAtlasAllocator__AreaNode* Acquire(::UnityEngine::RectInt  rect) ;

/// @brief Method AddAfter, addr 0x49b2228, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x49b1734, size 0x80, virtual false, abstract: false, final false
inline void Release() ;

/// @brief Method RemoveFromChain, addr 0x49b2200, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x49b2550, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_FirstUnpartitionedArea, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_FirstUnpartitionedArea, put=__cordl_internal_set_m_FirstUnpartitionedArea)) ::UnityEngine::UIElements::__UIRAtlasAllocator__AreaNode*  m_FirstUnpartitionedArea;

/// @brief Field m_OpenRows, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_OpenRows, put=__cordl_internal_set_m_OpenRows)) ::ArrayW<::UnityEngine::UIElements::__UIRAtlasAllocator__Row*,::Array<::UnityEngine::UIElements::__UIRAtlasAllocator__Row*>*>  m_OpenRows;
...
/// @brief Method BuildAreas, addr 0x49b1b20, size 0xf8, virtual false, abstract: false, final false
inline void BuildAreas() ;

/// @brief Method Dispose, addr 0x49b15a8, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x49b1614, size 0x90, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GetLog2OfNextPower, addr 0x49b17b4, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method TryAllocate, addr 0x49b1c18, size 0x3b4, virtual false, abstract: false, final false
inline bool TryAllocate(int32_t  width, int32_t  height, ByRef<::UnityEngine::RectInt>  location) ;

/// @brief Method TryPartitionArea, addr 0x49b1fcc, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x49b18e4, size 0x1a4, virtual false, abstract: false, final false
...
/// @brief Method get_disposed, addr 0x49b1594, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Method get_maxAtlasSize, addr 0x49b153c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxAtlasSize() ;

/// @brief Method get_maxImageHeight, addr 0x49b154c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxImageHeight() ;

/// @brief Method get_maxImageWidth, addr 0x49b1544, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxImageWidth() ;

/// @brief Method get_physicalHeight, addr 0x49b1584, size 0x8, virtual false, abstract: false, final false
inline int32_t get_physicalHeight() ;

/// @brief Method get_physicalWidth, addr 0x49b1574, size 0x8, virtual false, abstract: false, final false
inline int32_t get_physicalWidth() ;

/// @brief Method get_virtualHeight, addr 0x49b1564, size 0x8, virtual false, abstract: false, final false
inline int32_t get_virtualHeight() ;

/// @brief Method get_virtualWidth, addr 0x49b1554, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_disposed, addr 0x49b159c, size 0xc, virtual false, abstract: false, final false
inline void set_disposed(bool  value) ;

/// @brief Method set_physicalHeight, addr 0x49b158c, size 0x8, virtual false, abstract: false, final false
inline void set_physicalHeight(int32_t  value) ;

/// @brief Method set_physicalWidth, addr 0x49b157c, size 0x8, virtual false, abstract: false, final false
inline void set_physicalWidth(int32_t  value) ;

/// @brief Method set_virtualHeight, addr 0x49b156c, size 0x8, virtual false, abstract: false, final false
inline void set_virtualHeight(int32_t  value) ;

/// @brief Method set_virtualWidth, addr 0x49b155c, size 0x8, virtual false, abstract: false, final false
