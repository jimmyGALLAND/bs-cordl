...
/// @brief Field m_PendingTopElementUnderPointer, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PendingTopElementUnderPointer, put=__cordl_internal_set_m_PendingTopElementUnderPointer)) ::ArrayW<::UnityEngine::UIElements::VisualElement*,::Array<::UnityEngine::UIElements::VisualElement*>*>  m_PendingTopElementUnderPointer;

/// @brief Field m_PickingPointerPositions, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PickingPointerPositions, put=__cordl_internal_set_m_PickingPointerPositions)) ::ArrayW<::UnityEngine::Vector2,::Array<::UnityEngine::Vector2>*>  m_PickingPointerPositions;

/// @brief Field m_TopElementUnderPointer, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_TopElementUnderPointer, put=__cordl_internal_set_m_TopElementUnderPointer)) ::ArrayW<::UnityEngine::UIElements::VisualElement*,::Array<::UnityEngine::UIElements::VisualElement*>*>  m_TopElementUnderPointer;

/// @brief Field m_TriggerMouseEvent, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_TriggerMouseEvent, put=__cordl_internal_set_m_TriggerMouseEvent)) ::ArrayW<::UnityEngine::UIElements::IMouseEvent*,::Array<::UnityEngine::UIElements::IMouseEvent*>*>  m_TriggerMouseEvent;

/// @brief Field m_TriggerPointerEvent, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_TriggerPointerEvent, put=__cordl_internal_set_m_TriggerPointerEvent)) ::ArrayW<::UnityEngine::UIElements::IPointerEvent*,::Array<::UnityEngine::UIElements::IPointerEvent*>*>  m_TriggerPointerEvent;

/// @brief Method CommitElementUnderPointers, addr 0x498f688, size 0xcb0, virtual false, abstract: false, final false
...
/// @brief Method GetEventPointerPosition, addr 0x498f274, size 0x1b8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetEventPointerPosition(::UnityEngine::UIElements::EventBase*  triggerEvent) ;

/// @brief Method GetTopElementUnderPointer, addr 0x498f0e4, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* GetTopElementUnderPointer(int32_t  pointerId) ;

/// @brief Method GetTopElementUnderPointer, addr 0x498f070, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method SetElementUnderPointer, addr 0x498f114, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method SetElementUnderPointer, addr 0x498f680, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method SetElementUnderPointer, addr 0x498f434, size 0x24c, virtual false, abstract: false, final false
...
/// @brief Method SetTemporaryElementUnderPointer, addr 0x498f42c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4990a9c, size 0x15c, virtual false, abstract: false, final false
inline void _ctor() ;
