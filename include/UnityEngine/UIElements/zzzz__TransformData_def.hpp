...
/// @brief Method Copy, addr 0x49ec708, size 0x1c, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::TransformData Copy() ;

/// @brief Method CopyFrom, addr 0x49ec724, size 0x14, virtual true, abstract: false, final true
inline void CopyFrom(ByRef<::UnityEngine::UIElements::TransformData>  other) ;

/// @brief Method Equals, addr 0x49ecab8, size 0xa0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x49eca74, size 0x44, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::TransformData  other) ;

/// @brief Method GetHashCode, addr 0x49ecb58, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x49ec738, size 0x184, virtual false, abstract: false, final false
