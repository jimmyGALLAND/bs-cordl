...
/// @brief Field <bubbleUpCallbackCount>k__BackingField, offset 0x1c, size 0x4 
 __declspec(property(get=__cordl_internal_get__bubbleUpCallbackCount_k__BackingField, put=__cordl_internal_set__bubbleUpCallbackCount_k__BackingField)) int32_t  _bubbleUpCallbackCount_k__BackingField;

/// @brief Field <trickleDownCallbackCount>k__BackingField, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__trickleDownCallbackCount_k__BackingField, put=__cordl_internal_set__trickleDownCallbackCount_k__BackingField)) int32_t  _trickleDownCallbackCount_k__BackingField;
...
/// @brief Method Add, addr 0x4991b04, size 0xd4, virtual false, abstract: false, final false
inline void Add(::UnityEngine::UIElements::EventCallbackFunctorBase*  item) ;

/// @brief Method AddRange, addr 0x49915e8, size 0x190, virtual false, abstract: false, final false
inline void AddRange(::UnityEngine::UIElements::EventCallbackList*  list) ;

/// @brief Method Clear, addr 0x49917dc, size 0x6c, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x49918e4, size 0x18, virtual false, abstract: false, final false
inline bool Contains(int64_t  eventTypeId, ::System::Delegate*  callback, ::UnityEngine::UIElements::CallbackPhase  phase) ;

/// @brief Method Find, addr 0x49918fc, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method Remove, addr 0x49919e4, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4991568, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x49914dc, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::EventCallbackList*  source) ;

/// @brief Method get_Count, addr 0x4991bd8, size 0x48, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Item, addr 0x4991c20, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::EventCallbackFunctorBase* get_Item(int32_t  i) ;

/// @brief Method get_bubbleUpCallbackCount, addr 0x49918d4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_bubbleUpCallbackCount() ;

/// @brief Method get_trickleDownCallbackCount, addr 0x49918c4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_trickleDownCallbackCount() ;

/// @brief Method set_bubbleUpCallbackCount, addr 0x49918dc, size 0x8, virtual false, abstract: false, final false
inline void set_bubbleUpCallbackCount(int32_t  value) ;

/// @brief Method set_trickleDownCallbackCount, addr 0x49918cc, size 0x8, virtual false, abstract: false, final false
