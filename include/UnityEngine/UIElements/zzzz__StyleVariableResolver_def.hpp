...
constexpr __StyleVariableResolver__ResolveContext(::UnityW<::UnityEngine::UIElements::StyleSheet>  sheet, ::ArrayW<::UnityEngine::UIElements::StyleValueHandle,::Array<::UnityEngine::UIElements::StyleValueHandle>*>  handles) noexcept;
...
/// @brief Field m_ContextStack, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ContextStack, put=__cordl_internal_set_m_ContextStack)) ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::__StyleVariableResolver__ResolveContext>*  m_ContextStack;
...
/// @brief Method AddValue, addr 0x49f9274, size 0xa8, virtual false, abstract: false, final false
inline void AddValue(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method Init, addr 0x49f90dc, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method ParseVarFunction, addr 0x49f93e8, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method PopContext, addr 0x49f91f8, size 0x7c, virtual false, abstract: false, final false
inline void PopContext() ;

/// @brief Method PushContext, addr 0x49f918c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method ResolveFallback, addr 0x49f9868, size 0x280, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::__StyleVariableResolver__Result ResolveFallback(ByRef<int32_t>  index) ;

/// @brief Method ResolveVarFunction, addr 0x49f9498, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method ResolveVarFunction, addr 0x49f931c, size 0xcc, virtual false, abstract: false, final false
inline bool ResolveVarFunction(ByRef<int32_t>  index) ;

/// @brief Method ResolveVariable, addr 0x49f95f4, size 0x274, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::__StyleVariableResolver__Result ResolveVariable(::StringW  variableName) ;

/// @brief Method ValidateResolvedValues, addr 0x49f9ae8, size 0x170, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::__StyleVariableResolver__ResolveContext>*> const& __cordl_internal_get_m_ContextStack() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSheets::StylePropertyValue>*> const& __cordl_internal_get_m_ResolvedValues() const;
...
/// @brief Method .ctor, addr 0x49f9c58, size 0x138, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxParser* getStaticF_s_SyntaxParser() ;

/// @brief Method get_currentHandles, addr 0x49f90bc, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::UIElements::StyleValueHandle,::Array<::UnityEngine::UIElements::StyleValueHandle>*> get_currentHandles() ;

/// @brief Method get_currentSheet, addr 0x49f90b4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UIElements::StyleSheet> get_currentSheet() ;

/// @brief Method get_resolvedValues, addr 0x49f90c4, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSheets::StylePropertyValue>* get_resolvedValues() ;

/// @brief Method get_variableContext, addr 0x49f90cc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_variableContext, addr 0x49f90d4, size 0x8, virtual false, abstract: false, final false
