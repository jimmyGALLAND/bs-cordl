...
/// @brief Method Equals, addr 0x48d9fd4, size 0x7c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x48da050, size 0x54, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::BackgroundPosition  other) ;

/// @brief Method GetHashCode, addr 0x48da0a4, size 0x48, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Initial, addr 0x48d9f6c, size 0x34, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::BackgroundPosition Initial() ;

/// @brief Method ToString, addr 0x48da190, size 0xbc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x48d9f28, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BackgroundPositionKeyword  keyword) ;

/// @brief Method .ctor, addr 0x48d9f60, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x48da0ec, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x48da13c, size 0x54, virtual false, abstract: false, final false
