...
/// @brief Method <GetValueFromBag>b__3_0, addr 0x4a0d8d4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Hash128 _GetValueFromBag_b__3_0(::StringW  s, ::UnityEngine::Hash128  i) ;

/// @brief Method .ctor, addr 0x4a0d8cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetValueFromBag, addr 0x4a0d724, size 0x14c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a0d68c, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
