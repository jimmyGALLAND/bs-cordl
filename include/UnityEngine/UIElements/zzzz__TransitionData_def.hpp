...
/// @brief Method Copy, addr 0x49ecdb4, size 0x140, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::TransitionData Copy() ;

/// @brief Method CopyFrom, addr 0x49ecef4, size 0x160, virtual true, abstract: false, final true
inline void CopyFrom(ByRef<::UnityEngine::UIElements::TransitionData>  other) ;

/// @brief Method Equals, addr 0x49ed0ec, size 0xb0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x49ed0a0, size 0x4c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::TransitionData  other) ;

/// @brief Method GetHashCode, addr 0x49ed19c, size 0x9c, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x49ed054, size 0x4c, virtual false, abstract: false, final false
