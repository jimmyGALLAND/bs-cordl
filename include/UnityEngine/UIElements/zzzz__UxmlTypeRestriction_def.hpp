...
/// @brief Method Equals, addr 0x4a0e69c, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a0e6a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
