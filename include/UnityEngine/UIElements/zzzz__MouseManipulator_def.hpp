...
/// @brief Method CanStartManipulation, addr 0x49ab9e8, size 0x174, virtual false, abstract: false, final false
inline bool CanStartManipulation(::UnityEngine::UIElements::IMouseEvent*  e) ;

/// @brief Method CanStopManipulation, addr 0x49abb5c, size 0xb8, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::ManipulatorActivationFilter>*> const& __cordl_internal_get__activators_k__BackingField() const;
...
/// @brief Method .ctor, addr 0x49ab968, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_activators, addr 0x49ab958, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::ManipulatorActivationFilter>* get_activators() ;

/// @brief Method set_activators, addr 0x49ab960, size 0x8, virtual false, abstract: false, final false
