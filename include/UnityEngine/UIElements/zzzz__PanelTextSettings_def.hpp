...
static __declspec(property(get=getStaticF_s_DefaultPanelTextSettings, put=setStaticF_s_DefaultPanelTextSettings)) ::UnityW<::UnityEngine::UIElements::PanelTextSettings>  s_DefaultPanelTextSettings;

/// @brief Method GetCachedFontAsset, addr 0x49fb588, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method UpdateLocalizationFontAsset, addr 0x49fafcc, size 0x5bc, virtual false, abstract: false, final false
static inline void UpdateLocalizationFontAsset() ;

/// @brief Method .ctor, addr 0x49fb590, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_defaultPanelTextSettings, addr 0x49fae98, size 0x134, virtual false, abstract: false, final false
