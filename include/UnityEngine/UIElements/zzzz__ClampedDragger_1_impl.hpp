...
template<typename T>
constexpr ::UnityEngine::UIElements::__ClampedDragger_1__DragDirection<T>::__ClampedDragger_1__DragDirection(int32_t  value__) noexcept  {
this->value__ = value__;
}
// Ctor Parameters []
template<typename T>
constexpr ::UnityEngine::UIElements::__ClampedDragger_1__DragDirection<T>::__ClampedDragger_1__DragDirection()   {
}
template<typename T>
...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Action*> const& UnityEngine::UIElements::ClampedDragger_1<T>::__cordl_internal_get_dragging() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___dragging;
}
template<typename T>
...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Action*> const& UnityEngine::UIElements::ClampedDragger_1<T>::__cordl_internal_get_draggingEnded() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___draggingEnded;
}
template<typename T>
...
template<typename T>
constexpr ::UnityEngine::UIElements::__ClampedDragger_1__DragDirection<T>& UnityEngine::UIElements::ClampedDragger_1<T>::__cordl_internal_get__dragDirection_k__BackingField()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "set_dragDirection",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::__ClampedDragger_1__DragDirection<T>>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, value);
}
template<typename T>
