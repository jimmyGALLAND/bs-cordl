...
class CORDL_TYPE __MultiColumnTreeView__UxmlFactory : public ::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::MultiColumnTreeView*,::UnityEngine::UIElements::__MultiColumnTreeView__UxmlTraits*> {
public:
// Declarations
static inline ::UnityEngine::UIElements::__MultiColumnTreeView__UxmlFactory* New_ctor() ;

/// @brief Method .ctor, addr 0x496a544, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x496a58c, size 0x170, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x496a6fc, size 0x10c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CreateViewController, addr 0x496a268, size 0x8c, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::CollectionViewController* CreateViewController() ;

/// @brief Method CreateVirtualizationController, addr 0x496a4e0, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method RaiseColumnSortingChanged, addr 0x496a060, size 0x1c, virtual false, abstract: false, final false
inline void RaiseColumnSortingChanged() ;

/// @brief Method RaiseHeaderContextMenuPopulate, addr 0x496a528, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method SetViewController, addr 0x496a2f4, size 0x1ec, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x496a0dc, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x496a134, size 0x134, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Columns*  columns) ;

/// @brief Method get_columns, addr 0x4969f74, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Columns* get_columns() ;

/// @brief Method get_sortColumnDescriptions, addr 0x4969fc8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::SortColumnDescriptions* get_sortColumnDescriptions() ;

/// @brief Method get_viewController, addr 0x4969ef0, size 0x84, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MultiColumnTreeViewController* get_viewController() ;

/// @brief Method set_columns, addr 0x4969f7c, size 0x4c, virtual false, abstract: false, final false
inline void set_columns(::UnityEngine::UIElements::Columns*  value) ;

/// @brief Method set_sortColumnDescriptions, addr 0x4969fd0, size 0x90, virtual false, abstract: false, final false
inline void set_sortColumnDescriptions(::UnityEngine::UIElements::SortColumnDescriptions*  value) ;

/// @brief Method set_sortingEnabled, addr 0x496a07c, size 0x60, virtual false, abstract: false, final false
