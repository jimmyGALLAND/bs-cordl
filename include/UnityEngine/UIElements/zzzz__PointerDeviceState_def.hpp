...
/// @brief Method SetLocation, addr 0x499a68c, size 0x108, virtual false, abstract: false, final false
inline void SetLocation(::UnityEngine::Vector2  position, ::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method get_Flags, addr 0x499acbc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::__PointerDeviceState__LocationFlag get_Flags() ;

/// @brief Method get_Panel, addr 0x499acac, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::IPanel* get_Panel() ;

/// @brief Method get_Position, addr 0x499ac9c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_Position() ;

/// @brief Method set_Flags, addr 0x499acc4, size 0x8, virtual false, abstract: false, final false
inline void set_Flags(::UnityEngine::UIElements::__PointerDeviceState__LocationFlag  value) ;

/// @brief Method set_Panel, addr 0x499acb4, size 0x8, virtual false, abstract: false, final false
inline void set_Panel(::UnityEngine::UIElements::IPanel*  value) ;

/// @brief Method set_Position, addr 0x499aca4, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_Position_k__BackingField", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "_Panel_k__BackingField", ty: "::UnityEngine::UIElements::IPanel*", modifiers: "", def_value: None }, CppParam { name: "_Flags_k__BackingField", ty: "::UnityEngine::UIElements::__PointerDeviceState__LocationFlag", modifiers: "", def_value: None }]
constexpr __PointerDeviceState__PointerLocation(::UnityEngine::Vector2  _Position_k__BackingField, ::UnityEngine::UIElements::IPanel*  _Panel_k__BackingField, ::UnityEngine::UIElements::__PointerDeviceState__LocationFlag  _Flags_k__BackingField) noexcept;
...
static __declspec(property(get=getStaticF_s_PlayerPanelWithSoftPointerCapture, put=setStaticF_s_PlayerPanelWithSoftPointerCapture)) ::ArrayW<::UnityEngine::UIElements::IPanel*,::Array<::UnityEngine::UIElements::IPanel*>*>  s_PlayerPanelWithSoftPointerCapture;

/// @brief Field s_PlayerPointerLocations, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_PlayerPointerLocations, put=setStaticF_s_PlayerPointerLocations)) ::ArrayW<::UnityEngine::UIElements::__PointerDeviceState__PointerLocation,::Array<::UnityEngine::UIElements::__PointerDeviceState__PointerLocation>*>  s_PlayerPointerLocations;
...
/// @brief Method GetPanel, addr 0x499a83c, size 0x80, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::IPanel* GetPanel(int32_t  pointerId, ::UnityEngine::UIElements::ContextType  contextType) ;

/// @brief Method GetPlayerPanelWithSoftPointerCapture, addr 0x499ab1c, size 0x7c, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::IPanel* GetPlayerPanelWithSoftPointerCapture(int32_t  pointerId) ;

/// @brief Method GetPointerPosition, addr 0x4990338, size 0x80, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 GetPointerPosition(int32_t  pointerId, ::UnityEngine::UIElements::ContextType  contextType) ;

/// @brief Method GetPressedButtons, addr 0x499a95c, size 0x7c, virtual false, abstract: false, final false
static inline int32_t GetPressedButtons(int32_t  pointerId) ;

/// @brief Method HasAdditionalPressedButtons, addr 0x499a9d8, size 0x98, virtual false, abstract: false, final false
static inline bool HasAdditionalPressedButtons(int32_t  pointerId, int32_t  exceptButtonId) ;

/// @brief Method HasFlagFast, addr 0x499a8bc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method HasLocationFlag, addr 0x499a8c8, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method PressButton, addr 0x4996400, size 0xdc, virtual false, abstract: false, final false
static inline void PressButton(int32_t  pointerId, int32_t  buttonId) ;

/// @brief Method ReleaseAllButtons, addr 0x4997fe4, size 0x7c, virtual false, abstract: false, final false
static inline void ReleaseAllButtons(int32_t  pointerId) ;

/// @brief Method ReleaseButton, addr 0x499695c, size 0xdc, virtual false, abstract: false, final false
static inline void ReleaseButton(int32_t  pointerId, int32_t  buttonId) ;

/// @brief Method RemovePanelData, addr 0x499a4a8, size 0x1e4, virtual false, abstract: false, final false
static inline void RemovePanelData(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method SavePointerPosition, addr 0x499a794, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method SetPlayerPanelWithSoftPointerCapture, addr 0x499aa70, size 0xac, virtual false, abstract: false, final false
...
static inline ::ArrayW<::UnityEngine::UIElements::__PointerDeviceState__PointerLocation,::Array<::UnityEngine::UIElements::__PointerDeviceState__PointerLocation>*> getStaticF_s_PlayerPointerLocations() ;
...
static inline void setStaticF_s_PlayerPointerLocations(::ArrayW<::UnityEngine::UIElements::__PointerDeviceState__PointerLocation,::Array<::UnityEngine::UIElements::__PointerDeviceState__PointerLocation>*>  value) ;
