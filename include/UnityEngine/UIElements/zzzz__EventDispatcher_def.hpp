...
/// @brief Method <.cctor>b__31_0, addr 0x498d818, size 0x68, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::__EventDispatcher__EventRecord>* __cctor_b__31_0() ;

/// @brief Method .ctor, addr 0x498d810, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static __declspec(property(get=getStaticF_k_EventQueuePool, put=setStaticF_k_EventQueuePool)) ::UnityEngine::UIElements::ObjectPool_1<::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::__EventDispatcher__EventRecord>*>*  k_EventQueuePool;
...
/// @brief Field m_DispatchContexts, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DispatchContexts, put=__cordl_internal_set_m_DispatchContexts)) ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::__EventDispatcher__DispatchContext>*  m_DispatchContexts;

/// @brief Field m_DispatchingStrategies, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_DispatchingStrategies, put=__cordl_internal_set_m_DispatchingStrategies)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::IEventDispatchingStrategy*>*  m_DispatchingStrategies;
...
/// @brief Field m_Queue, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Queue, put=__cordl_internal_set_m_Queue)) ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::__EventDispatcher__EventRecord>*  m_Queue;
...
static __declspec(property(get=getStaticF_s_EditorStrategies, put=setStaticF_s_EditorStrategies)) ::ArrayW<::UnityEngine::UIElements::IEventDispatchingStrategy*,::Array<::UnityEngine::UIElements::IEventDispatchingStrategy*>*>  s_EditorStrategies;

/// @brief Method ApplyDispatchingStrategies, addr 0x498cc04, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method CloseGate, addr 0x498bd8c, size 0x10, virtual false, abstract: false, final false
inline void CloseGate() ;

/// @brief Method CreateForRuntime, addr 0x498bee4, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method Dispatch, addr 0x498c118, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method OpenGate, addr 0x498bdb4, size 0x88, virtual false, abstract: false, final false
inline void OpenGate() ;

/// @brief Method ProcessEvent, addr 0x498c318, size 0x520, virtual false, abstract: false, final false
inline void ProcessEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method ProcessEventQueue, addr 0x498c838, size 0x3b4, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::__EventDispatcher__DispatchContext>*> const& __cordl_internal_get_m_DispatchContexts() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::IEventDispatchingStrategy*>*> const& __cordl_internal_get_m_DispatchingStrategies() const;
...
/// @brief Method .ctor, addr 0x498bf3c, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method get_dispatchImmediately, addr 0x498c0ec, size 0x20, virtual false, abstract: false, final false
inline bool get_dispatchImmediately() ;

/// @brief Method get_pointerState, addr 0x498bedc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_processingEvents, addr 0x498c10c, size 0xc, virtual false, abstract: false, final false
