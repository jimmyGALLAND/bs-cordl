...
class CORDL_TYPE __UnsignedLongField__UxmlFactory : public ::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::UnsignedLongField*,::UnityEngine::UIElements::__UnsignedLongField__UxmlTraits*> {
public:
// Declarations
static inline ::UnityEngine::UIElements::__UnsignedLongField__UxmlFactory* New_ctor() ;

/// @brief Method .ctor, addr 0x497d0e8, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x497d130, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x497d250, size 0x234, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, uint64_t  startValue) ;

/// @brief Method ClampToMinMaxULongValue, addr 0x497d484, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x497d550, size 0xa8, virtual true, abstract: false, final false
inline uint64_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x497d504, size 0x4c, virtual true, abstract: false, final false
inline ::StringW ValueToString(uint64_t  v) ;

/// @brief Method .ctor, addr 0x497cefc, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x497d1f8, size 0x58, virtual true, abstract: false, final false
inline ::StringW get_allowedCharacters() ;

/// @brief Method get_parentUnsignedLongField, addr 0x497d178, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method ApplyInputDeviceDelta, addr 0x497cfb4, size 0x64, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, uint64_t  startValue) ;

/// @brief Method CanTryParse, addr 0x497cf90, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x497ccc4, size 0xdc, virtual true, abstract: false, final false
inline uint64_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x497cc0c, size 0xb8, virtual true, abstract: false, final false
inline ::StringW ValueToString(uint64_t  v) ;

/// @brief Method .ctor, addr 0x497cda0, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x497cdac, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_unsignedLongInput, addr 0x497cb88, size 0x84, virtual false, abstract: false, final false
