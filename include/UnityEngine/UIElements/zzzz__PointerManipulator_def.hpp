...
/// @brief Method CanStartManipulation, addr 0x49b11c0, size 0x1e4, virtual false, abstract: false, final false
inline bool CanStartManipulation(::UnityEngine::UIElements::IPointerEvent*  e) ;

/// @brief Method CanStopManipulation, addr 0x49b13a4, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x49b1458, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
