...
/// @brief Method <.cctor>b__0_0, addr 0x49996fc, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::NavigationMoveEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x49996f4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <direction>k__BackingField, offset 0x8c, size 0x4 
 __declspec(property(get=__cordl_internal_get__direction_k__BackingField, put=__cordl_internal_set__direction_k__BackingField)) ::UnityEngine::UIElements::__NavigationMoveEvent__Direction  _direction_k__BackingField;
...
/// @brief Method DetermineMoveDirection, addr 0x4999390, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method GetPooled, addr 0x4994994, size 0xac, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::NavigationMoveEvent* GetPooled(::UnityEngine::UIElements::__NavigationMoveEvent__Direction  direction, ::UnityEngine::UIElements::NavigationDeviceType  deviceType, ::UnityEngine::EventModifiers  modifiers) ;

/// @brief Method GetPooled, addr 0x49994fc, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method GetPooled, addr 0x4994a40, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method GetPooled, addr 0x49993fc, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x49995a4, size 0x50, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x49995f4, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4999648, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_direction, addr 0x49993e4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::__NavigationMoveEvent__Direction get_direction() ;

/// @brief Method set_direction, addr 0x49993ec, size 0x8, virtual false, abstract: false, final false
inline void set_direction(::UnityEngine::UIElements::__NavigationMoveEvent__Direction  value) ;

/// @brief Method set_move, addr 0x49993f4, size 0x8, virtual false, abstract: false, final false
