...
/// @brief Field settings, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_settings, put=__cordl_internal_set_settings)) ::ArrayW<::UnityEngine::UIElements::GradientSettings,::Array<::UnityEngine::UIElements::GradientSettings>*>  settings;
...
/// @brief Field vertices, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_vertices, put=__cordl_internal_set_vertices)) ::ArrayW<::UnityEngine::UIElements::VectorImageVertex,::Array<::UnityEngine::UIElements::VectorImageVertex>*>  vertices;
...
/// @brief Method .ctor, addr 0x4906fe0, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_height, addr 0x4906fd8, size 0x8, virtual false, abstract: false, final false
inline float_t get_height() ;

/// @brief Method get_width, addr 0x4906fd0, size 0x8, virtual false, abstract: false, final false
