...
/// @brief Method <GetValueFromBag>b__3_0, addr 0x4a0d400, size 0x40, virtual false, abstract: false, final false
inline int64_t _GetValueFromBag_b__3_0(::StringW  s, int64_t  l) ;

/// @brief Method .ctor, addr 0x4a0d3f8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ConvertValueToLong, addr 0x4a0d360, size 0x3c, virtual false, abstract: false, final false
static inline int64_t ConvertValueToLong(::StringW  v, int64_t  defaultValue) ;

/// @brief Method GetValueFromBag, addr 0x4a0d214, size 0x14c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a0d17c, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
