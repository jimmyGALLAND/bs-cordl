...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::ISerializableJsonDictionary::*)(::System::Object*, ::StringW)>(&::UnityEngine::UIElements::ISerializableJsonDictionary::Overwrite)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::UIElements::ISerializableJsonDictionary::*)(::StringW)>(&::UnityEngine::UIElements::ISerializableJsonDictionary::ContainsKey)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
