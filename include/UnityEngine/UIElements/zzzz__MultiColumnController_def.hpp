...
template<typename T>
static inline void DefaultBindCellItem(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::Column*  column, T  item) ;

/// @brief Method DefaultMakeCellItem, addr 0x49673a0, size 0x94, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::VisualElement* DefaultMakeCellItem() ;

/// @brief Method DestroyItem, addr 0x4967ce0, size 0x468, virtual false, abstract: false, final false
inline void DestroyItem(::UnityEngine::UIElements::VisualElement*  element) ;

/// @brief Method Dispose, addr 0x4968400, size 0x4fc, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method MakeItem, addr 0x4967434, size 0x48c, virtual false, abstract: false, final false
...
/// @brief Method OnColumnAdded, addr 0x4969174, size 0x1c, virtual false, abstract: false, final false
inline void OnColumnAdded(::UnityEngine::UIElements::Column*  column, int32_t  index) ;

/// @brief Method OnColumnChanged, addr 0x496921c, size 0x38, virtual false, abstract: false, final false
inline void OnColumnChanged(::UnityEngine::UIElements::ColumnsDataType  type) ;

/// @brief Method OnColumnContainerGeometryChanged, addr 0x4968d60, size 0x8, virtual false, abstract: false, final false
inline void OnColumnContainerGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnColumnRemoved, addr 0x4969190, size 0x1c, virtual false, abstract: false, final false
inline void OnColumnRemoved(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method OnColumnReordered, addr 0x49691ac, size 0x34, virtual false, abstract: false, final false
inline void OnColumnReordered(::UnityEngine::UIElements::Column*  column, int32_t  from, int32_t  to) ;

/// @brief Method OnColumnResized, addr 0x4968da0, size 0x3d4, virtual false, abstract: false, final false
inline void OnColumnResized(int32_t  index, float_t  width) ;

/// @brief Method OnColumnSortingChanged, addr 0x4968d68, size 0x1c, virtual false, abstract: false, final false
inline void OnColumnSortingChanged() ;

/// @brief Method OnColumnsChanged, addr 0x49691e0, size 0x3c, virtual false, abstract: false, final false
inline void OnColumnsChanged(::UnityEngine::UIElements::Column*  column, ::UnityEngine::UIElements::ColumnDataType  type) ;

/// @brief Method OnContextMenuPopulateEvent, addr 0x4968d84, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method OnHorizontalScrollerValueChanged, addr 0x49688fc, size 0x1c, virtual false, abstract: false, final false
inline void OnHorizontalScrollerValueChanged(float_t  v) ;

/// @brief Method OnViewDataRestored, addr 0x4969254, size 0x1c, virtual false, abstract: false, final false
inline void OnViewDataRestored() ;

/// @brief Method OnViewportGeometryChanged, addr 0x4968918, size 0x2a0, virtual false, abstract: false, final false
inline void OnViewportGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method PrepareView, addr 0x4968148, size 0x2b8, virtual false, abstract: false, final false
inline void PrepareView(::UnityEngine::UIElements::BaseVerticalCollectionView*  collectionView) ;

/// @brief Method UnbindCellItem, addr 0x4967364, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method UnbindItem, addr 0x49678c0, size 0x420, virtual false, abstract: false, final false
inline void UnbindItem(::UnityEngine::UIElements::VisualElement*  element, int32_t  index) ;

/// @brief Method UpdateContentContainer, addr 0x4968bb8, size 0x1a8, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::UIElements::ContextualMenuPopulateEvent*,::UnityEngine::UIElements::Column*>*> const& __cordl_internal_get_headerContextMenuPopulateEvent() const;
...
/// @brief Method .ctor, addr 0x4966f64, size 0x400, virtual false, abstract: false, final false
...
/// @brief Method add_columnSortingChanged, addr 0x4966cc4, size 0x9c, virtual false, abstract: false, final false
inline void add_columnSortingChanged(::System::Action*  value) ;

/// @brief Method add_headerContextMenuPopulateEvent, addr 0x4966dfc, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_header, addr 0x4966f5c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader* get_header() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method remove_columnSortingChanged, addr 0x4966d60, size 0x9c, virtual false, abstract: false, final false
inline void remove_columnSortingChanged(::System::Action*  value) ;

/// @brief Method remove_headerContextMenuPopulateEvent, addr 0x4966eac, size 0xb0, virtual false, abstract: false, final false
