...
static __declspec(property(get=getStaticF_s_GroupManagers, put=setStaticF_s_GroupManagers)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::IGroupBox*,::UnityEngine::UIElements::IGroupManager*>*  s_GroupManagers;

/// @brief Field s_GroupOptionManagerCache, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_GroupOptionManagerCache, put=setStaticF_s_GroupOptionManagerCache)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::IGroupBoxOption*,::UnityEngine::UIElements::IGroupManager*>*  s_GroupOptionManagerCache;

/// @brief Method FindOrCreateGroupManager, addr 0x49a60cc, size 0x46c, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::IGroupManager* FindOrCreateGroupManager(::UnityEngine::UIElements::IGroupBox*  groupBox) ;

/// @brief Method OnGroupBoxDetachedFromPanel, addr 0x49a6664, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method OnPanelDestroyed, addr 0x49a6718, size 0xd4, virtual false, abstract: false, final false
