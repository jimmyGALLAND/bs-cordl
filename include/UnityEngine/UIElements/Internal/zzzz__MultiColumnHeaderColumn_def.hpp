...
/// @brief Method BindHeaderContent, addr 0x4956ab0, size 0xd8, virtual false, abstract: false, final false
inline void BindHeaderContent() ;

/// @brief Method CreateDefaultHeaderContent, addr 0x4956b88, size 0x18c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* CreateDefaultHeaderContent() ;

/// @brief Method DefaultBindHeaderContent, addr 0x4956d14, size 0x344, virtual false, abstract: false, final false
inline void DefaultBindHeaderContent(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method DestroyHeaderContent, addr 0x4956240, size 0xc8, virtual false, abstract: false, final false
inline void DestroyHeaderContent() ;

/// @brief Method InitManipulators, addr 0x4956768, size 0x23c, virtual false, abstract: false, final false
...
/// @brief Method UnbindHeaderContent, addr 0x49569d8, size 0xd8, virtual false, abstract: false, final false
inline void UnbindHeaderContent() ;

/// @brief Method UpdateDataFromColumn, addr 0x49569a4, size 0x34, virtual false, abstract: false, final false
inline void UpdateDataFromColumn() ;

/// @brief Method UpdateGeometryFromColumn, addr 0x4956668, size 0x100, virtual false, abstract: false, final false
inline void UpdateGeometryFromColumn() ;

/// @brief Method UpdateHeaderTemplate, addr 0x4956494, size 0x1d4, virtual false, abstract: false, final false
inline void UpdateHeaderTemplate() ;

/// @brief Method <InitManipulators>b__46_0, addr 0x495753c, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method <.ctor>b__45_0, addr 0x49573a0, size 0x198, virtual false, abstract: false, final false
inline void __ctor_b__45_0(::UnityEngine::UIElements::Column*  c, ::UnityEngine::UIElements::ColumnDataType  role) ;

/// @brief Method <.ctor>b__45_1, addr 0x4957538, size 0x4, virtual false, abstract: false, final false
inline void __ctor_b__45_1(::UnityEngine::UIElements::Column*  c) ;

/// @brief Method .ctor, addr 0x4951f08, size 0x79c, virtual false, abstract: false, final false
...
/// @brief Method get_clickable, addr 0x4956140, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Clickable* get_clickable() ;

/// @brief Method get_column, addr 0x4956160, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Column* get_column() ;

/// @brief Method get_content, addr 0x4956170, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_content() ;

/// @brief Method get_isContentBound, addr 0x4956308, size 0xcc, virtual false, abstract: false, final false
inline bool get_isContentBound() ;

/// @brief Method get_mover, addr 0x4956150, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_clickable, addr 0x4956148, size 0x8, virtual false, abstract: false, final false
inline void set_clickable(::UnityEngine::UIElements::Clickable*  value) ;

/// @brief Method set_column, addr 0x4956168, size 0x8, virtual false, abstract: false, final false
inline void set_column(::UnityEngine::UIElements::Column*  value) ;

/// @brief Method set_content, addr 0x4956178, size 0xc8, virtual false, abstract: false, final false
inline void set_content(::UnityEngine::UIElements::VisualElement*  value) ;

/// @brief Method set_isContentBound, addr 0x49563d4, size 0xc0, virtual false, abstract: false, final false
inline void set_isContentBound(bool  value) ;

/// @brief Method set_mover, addr 0x4956158, size 0x8, virtual false, abstract: false, final false
inline void set_mover(::UnityEngine::UIElements::Internal::ColumnMover*  value) ;

/// @brief Method set_sortOrderLabel, addr 0x495481c, size 0x2c, virtual false, abstract: false, final false
