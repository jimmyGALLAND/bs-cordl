...
/// @brief Method BeginDragResize, addr 0x494f328, size 0x48, virtual false, abstract: false, final false
inline void BeginDragResize(float_t  pos) ;

/// @brief Method DragResize, addr 0x494f46c, size 0x40, virtual false, abstract: false, final false
inline void DragResize(float_t  pos) ;

/// @brief Method EndDragResize, addr 0x494f0c4, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method OnKeyDown, addr 0x494f050, size 0x74, virtual false, abstract: false, final false
inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent*  e) ;

/// @brief Method OnPointerDown, addr 0x494f120, size 0x208, virtual false, abstract: false, final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  e) ;

/// @brief Method OnPointerMove, addr 0x494f370, size 0xfc, virtual false, abstract: false, final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  e) ;

/// @brief Method OnPointerUp, addr 0x494f4ac, size 0x130, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  e) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x494ebc8, size 0x244, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x494ee0c, size 0x244, virtual true, abstract: false, final false
inline void UnregisterCallbacksFromTarget() ;

/// @brief Method UpdatePreviewPosition, addr 0x494f5dc, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x494eb08, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method get_columnLayout, addr 0x494eae4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ColumnLayout* get_columnLayout() ;

/// @brief Method get_preview, addr 0x494eaf4, size 0x8, virtual false, abstract: false, final false
inline bool get_preview() ;

/// @brief Method set_columnLayout, addr 0x494eaec, size 0x8, virtual false, abstract: false, final false
inline void set_columnLayout(::UnityEngine::UIElements::ColumnLayout*  value) ;

/// @brief Method set_preview, addr 0x494eafc, size 0xc, virtual false, abstract: false, final false
