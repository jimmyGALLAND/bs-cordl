...
/// @brief Method BeginDragMove, addr 0x494deb8, size 0x474, virtual false, abstract: false, final false
inline void BeginDragMove(float_t  pos) ;

/// @brief Method DragMove, addr 0x494e32c, size 0x8, virtual false, abstract: false, final false
inline void DragMove(float_t  pos) ;

/// @brief Method EndDragMove, addr 0x494dd2c, size 0x120, virtual false, abstract: false, final false
inline void EndDragMove(bool  cancelled) ;

/// @brief Method IsNotMouseEvent, addr 0x494dc58, size 0x64, virtual false, abstract: false, final false
static inline bool IsNotMouseEvent(int32_t  pointerId) ;

static inline ::UnityEngine::UIElements::Internal::ColumnMover* New_ctor() ;

/// @brief Method OnKeyDown, addr 0x494de4c, size 0x6c, virtual false, abstract: false, final false
inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent*  e) ;

/// @brief Method OnMouseCaptureOut, addr 0x494d704, size 0x7c, virtual false, abstract: false, final false
inline void OnMouseCaptureOut(::UnityEngine::UIElements::MouseCaptureOutEvent*  evt) ;

/// @brief Method OnMouseDown, addr 0x494d12c, size 0xb4, virtual false, abstract: false, final false
inline void OnMouseDown(::UnityEngine::UIElements::MouseDownEvent*  evt) ;

/// @brief Method OnMouseMove, addr 0x494d3c8, size 0x64, virtual false, abstract: false, final false
inline void OnMouseMove(::UnityEngine::UIElements::MouseMoveEvent*  evt) ;

/// @brief Method OnMouseUp, addr 0x494d544, size 0xa4, virtual false, abstract: false, final false
inline void OnMouseUp(::UnityEngine::UIElements::MouseUpEvent*  evt) ;

/// @brief Method OnPointerCancel, addr 0x494dbd4, size 0x84, virtual false, abstract: false, final false
inline void OnPointerCancel(::UnityEngine::UIElements::PointerCancelEvent*  evt) ;

/// @brief Method OnPointerCaptureOut, addr 0x494dcbc, size 0x70, virtual false, abstract: false, final false
inline void OnPointerCaptureOut(::UnityEngine::UIElements::PointerCaptureOutEvent*  evt) ;

/// @brief Method OnPointerDown, addr 0x494d868, size 0x128, virtual false, abstract: false, final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  evt) ;

/// @brief Method OnPointerMove, addr 0x494d990, size 0x118, virtual false, abstract: false, final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  evt) ;

/// @brief Method OnPointerUp, addr 0x494daa8, size 0x12c, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method ProcessCancelEvent, addr 0x494d780, size 0xe8, virtual false, abstract: false, final false
inline void ProcessCancelEvent(::UnityEngine::UIElements::EventBase*  evt, int32_t  pointerId) ;

/// @brief Method ProcessDownEvent, addr 0x494d1e0, size 0x1e8, virtual false, abstract: false, final false
inline void ProcessDownEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition, int32_t  pointerId) ;

/// @brief Method ProcessMoveEvent, addr 0x494d42c, size 0x118, virtual false, abstract: false, final false
inline void ProcessMoveEvent(::UnityEngine::UIElements::EventBase*  e, ::UnityEngine::Vector2  localPosition) ;

/// @brief Method ProcessUpEvent, addr 0x494d5e8, size 0x11c, virtual false, abstract: false, final false
inline void ProcessUpEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition, int32_t  pointerId) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x494c674, size 0x55c, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x494cbd0, size 0x55c, virtual true, abstract: false, final false
inline void UnregisterCallbacksFromTarget() ;

/// @brief Method UpdateMoveLocation, addr 0x494e334, size 0x370, virtual false, abstract: false, final false
inline void UpdateMoveLocation() ;

/// @brief Method UpdatePreviewPosition, addr 0x494e6a4, size 0x270, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*> const& __cordl_internal_get_activeChanged() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::Column*> const& __cordl_internal_get_m_ColumnToMove() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::Column*> const& __cordl_internal_get_m_DestinationColumn() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnMoveLocationPreview*> const& __cordl_internal_get_m_LocationPreviewElement() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*> const& __cordl_internal_get_movingChanged() const;
...
/// @brief Method .ctor, addr 0x494c5bc, size 0xb8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_activeChanged, addr 0x494c2fc, size 0xb0, virtual false, abstract: false, final false
inline void add_activeChanged(::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*  value) ;

/// @brief Method add_movingChanged, addr 0x494c45c, size 0xb0, virtual false, abstract: false, final false
inline void add_movingChanged(::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*  value) ;

/// @brief Method get_active, addr 0x494c27c, size 0x8, virtual false, abstract: false, final false
inline bool get_active() ;

/// @brief Method get_columnLayout, addr 0x494c26c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ColumnLayout* get_columnLayout() ;

/// @brief Method get_moving, addr 0x494c2bc, size 0x8, virtual false, abstract: false, final false
inline bool get_moving() ;

/// @brief Method remove_activeChanged, addr 0x494c3ac, size 0xb0, virtual false, abstract: false, final false
inline void remove_activeChanged(::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*  value) ;

/// @brief Method remove_movingChanged, addr 0x494c50c, size 0xb0, virtual false, abstract: false, final false
inline void remove_movingChanged(::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*  value) ;

/// @brief Method set_active, addr 0x494c284, size 0x38, virtual false, abstract: false, final false
inline void set_active(bool  value) ;

/// @brief Method set_columnLayout, addr 0x494c274, size 0x8, virtual false, abstract: false, final false
inline void set_columnLayout(::UnityEngine::UIElements::ColumnLayout*  value) ;

/// @brief Method set_moving, addr 0x494c2c4, size 0x38, virtual false, abstract: false, final false
