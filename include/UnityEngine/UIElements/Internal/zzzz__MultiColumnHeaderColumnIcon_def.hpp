...
// SizeInfo { instance_size: 1040, native_size: -1, calculated_instance_size: 1040, calculated_native_size: 1036, minimum_alignment: 8, packing: None, specified_packing: None }
namespace UnityEngine::UIElements::Internal {
// Is value type: false
...
/// @brief Method UpdateClassList, addr 0x4955f40, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method <.ctor>b__5_0, addr 0x495613c, size 0x4, virtual false, abstract: false, final false
inline void __ctor_b__5_0(::UnityEngine::UIElements::CustomStyleResolvedEvent*  evt) ;

/// @brief Method .ctor, addr 0x4955e38, size 0x108, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::StringW getStaticF_ussClassName() ;

/// @brief Method get_isImageInline, addr 0x4955e24, size 0x8, virtual false, abstract: false, final false
inline bool get_isImageInline() ;

static inline void setStaticF_ussClassName(::StringW  value) ;

/// @brief Method set_isImageInline, addr 0x4955e2c, size 0xc, virtual false, abstract: false, final false
