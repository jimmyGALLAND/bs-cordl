...
/// @brief Field m_OrderedColumnStates, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_OrderedColumnStates, put=__cordl_internal_set_m_OrderedColumnStates)) ::System::Collections::Generic::List_1<::GlobalNamespace::__MultiColumnCollectionHeader__ViewState__ColumnState>*  m_OrderedColumnStates;
...
/// @brief Method Apply, addr 0x495493c, size 0x35c, virtual false, abstract: false, final false
...
/// @brief Method Save, addr 0x4954c98, size 0x710, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__MultiColumnCollectionHeader__ViewState__ColumnState>*> const& __cordl_internal_get_m_OrderedColumnStates() const;
...
/// @brief Method .ctor, addr 0x495597c, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x4952788, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_control, addr 0x4955a40, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumn* get_control() ;

/// @brief Method get_resizeHandle, addr 0x4955a50, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Internal::MultiColumnHeaderColumnResizeHandle* get_resizeHandle() ;

/// @brief Method set_control, addr 0x4955a48, size 0x8, virtual false, abstract: false, final false
inline void set_control(::UnityEngine::UIElements::Internal::MultiColumnHeaderColumn*  value) ;

/// @brief Method set_resizeHandle, addr 0x4955a58, size 0x8, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method .ctor, addr 0x49516e0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method <OnContextualMenuManipulator>b__1, addr 0x4955a60, size 0x28, virtual false, abstract: false, final false
inline void _OnContextualMenuManipulator_b__1(::UnityEngine::UIElements::DropdownMenuAction*  a) ;

/// @brief Method <OnContextualMenuManipulator>b__2, addr 0x4955a88, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4953cfc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <UpdateSortColumnDescriptionsOnClick>b__0, addr 0x4955b08, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x495465c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <columnDataMap>k__BackingField, offset 0x400, size 0x8 
 __declspec(property(get=__cordl_internal_get__columnDataMap_k__BackingField, put=__cordl_internal_set__columnDataMap_k__BackingField)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::Column*,::UnityEngine::UIElements::Internal::__MultiColumnCollectionHeader__ColumnData*>*  _columnDataMap_k__BackingField;
...
static __declspec(property(get=getStaticF_columnContainerUssClassName, put=setStaticF_columnContainerUssClassName)) ::StringW  columnContainerUssClassName;
 ...
 __declspec(property(get=get_columnDataMap)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::Column*,::UnityEngine::UIElements::Internal::__MultiColumnCollectionHeader__ColumnData*>*  columnDataMap;
...
/// @brief Field m_OldSortedColumnStates, offset 0x3e0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_OldSortedColumnStates, put=__cordl_internal_set_m_OldSortedColumnStates)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::Internal::__MultiColumnCollectionHeader__SortedColumnState>*  m_OldSortedColumnStates;
...
/// @brief Method ApplyColumnSorting, addr 0x4952a20, size 0x8bc, virtual false, abstract: false, final false
inline void ApplyColumnSorting() ;

/// @brief Method Dispose, addr 0x49553a8, size 0x4c8, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DoLayout, addr 0x4953e68, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method OnColumnAdded, addr 0x4951298, size 0x30c, virtual false, abstract: false, final false
inline void OnColumnAdded(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method OnColumnAdded, addr 0x4951f04, size 0x4, virtual false, abstract: false, final false
inline void OnColumnAdded(::UnityEngine::UIElements::Column*  column, int32_t  index) ;

/// @brief Method OnColumnChanged, addr 0x49529c4, size 0x5c, virtual false, abstract: false, final false
inline void OnColumnChanged(::UnityEngine::UIElements::Column*  column, ::UnityEngine::UIElements::ColumnDataType  type) ;

/// @brief Method OnColumnClicked, addr 0x49541e0, size 0x228, virtual false, abstract: false, final false
inline void OnColumnClicked(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method OnColumnControlGeometryChanged, addr 0x4953ea8, size 0x248, virtual false, abstract: false, final false
inline void OnColumnControlGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnColumnRemoved, addr 0x4952790, size 0x234, virtual false, abstract: false, final false
inline void OnColumnRemoved(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method OnColumnReordered, addr 0x49532dc, size 0x17c, virtual false, abstract: false, final false
inline void OnColumnReordered(::UnityEngine::UIElements::Column*  column, int32_t  from, int32_t  to) ;

/// @brief Method OnColumnResized, addr 0x4953458, size 0x4, virtual false, abstract: false, final false
inline void OnColumnResized(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method OnContextualMenuManipulator, addr 0x495345c, size 0x8a0, virtual false, abstract: false, final false
inline void OnContextualMenuManipulator(::UnityEngine::UIElements::ContextualMenuPopulateEvent*  evt) ;

/// @brief Method OnGeometryChanged, addr 0x4953de8, size 0x80, virtual false, abstract: false, final false
inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  e) ;

/// @brief Method OnMoveManipulatorActivated, addr 0x4953d04, size 0xe4, virtual false, abstract: false, final false
inline void OnMoveManipulatorActivated(::UnityEngine::UIElements::Internal::ColumnMover*  mover) ;

/// @brief Method OnViewDataReady, addr 0x4954848, size 0xf4, virtual true, abstract: false, final false
inline void OnViewDataReady() ;

/// @brief Method RaiseColumnResized, addr 0x49540f0, size 0xf0, virtual false, abstract: false, final false
inline void RaiseColumnResized(int32_t  columnIndex) ;

/// @brief Method RaiseColumnSortingChanged, addr 0x4951724, size 0x38, virtual false, abstract: false, final false
inline void RaiseColumnSortingChanged() ;

/// @brief Method ResizeToFit, addr 0x49516b4, size 0x2c, virtual false, abstract: false, final false
inline void ResizeToFit() ;

/// @brief Method SaveViewState, addr 0x49516ec, size 0x38, virtual false, abstract: false, final false
inline void SaveViewState() ;

/// @brief Method ScheduleDoLayout, addr 0x49515a4, size 0x110, virtual false, abstract: false, final false
inline void ScheduleDoLayout() ;

/// @brief Method ScrollHorizontally, addr 0x4954664, size 0x1b8, virtual false, abstract: false, final false
inline void ScrollHorizontally(float_t  horizontalOffset) ;

/// @brief Method UpdateColumnControls, addr 0x495175c, size 0x7a8, virtual false, abstract: false, final false
inline void UpdateColumnControls() ;

/// @brief Method UpdateSortColumnDescriptionsOnClick, addr 0x4954408, size 0x254, virtual false, abstract: false, final false
...
/// @brief Method UpdateSortedColumns, addr 0x494f7b8, size 0x70c, virtual false, abstract: false, final false
inline void UpdateSortedColumns() ;

/// @brief Method UpdateSortingStatus, addr 0x494ff08, size 0x660, virtual false, abstract: false, final false
inline void UpdateSortingStatus() ;

/// @brief Method <OnContextualMenuManipulator>b__65_0, addr 0x4955978, size 0x4, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::Column*,::UnityEngine::UIElements::Internal::__MultiColumnCollectionHeader__ColumnData*>*& __cordl_internal_get__columnDataMap_k__BackingField() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::Column*,::UnityEngine::UIElements::Internal::__MultiColumnCollectionHeader__ColumnData*>*> const& __cordl_internal_get__columnDataMap_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::UIElements::ContextualMenuPopulateEvent*,::UnityEngine::UIElements::Column*>*> const& __cordl_internal_get_contextMenuPopulateEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::Internal::__MultiColumnCollectionHeader__SortedColumnState>*> const& __cordl_internal_get_m_OldSortedColumnStates() const;
...
constexpr void __cordl_internal_set__columnDataMap_k__BackingField(::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::Column*,::UnityEngine::UIElements::Internal::__MultiColumnCollectionHeader__ColumnData*>*  value) ;
...
/// @brief Method .ctor, addr 0x4950ab8, size 0x7e0, virtual false, abstract: false, final false
...
/// @brief Method add_columnResized, addr 0x4950568, size 0xb4, virtual false, abstract: false, final false
inline void add_columnResized(::System::Action_2<int32_t,float_t>*  value) ;

/// @brief Method add_columnSortingChanged, addr 0x49506d0, size 0xa0, virtual false, abstract: false, final false
inline void add_columnSortingChanged(::System::Action*  value) ;

/// @brief Method add_contextMenuPopulateEvent, addr 0x4950810, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method add_viewDataRestored, addr 0x4950978, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_columnContainer, addr 0x494f6fc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_columnContainer() ;

/// @brief Method get_columnDataMap, addr 0x494f6ec, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_columnLayout, addr 0x494f6f4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ColumnLayout* get_columnLayout() ;

/// @brief Method get_columns, addr 0x494fec4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Columns* get_columns() ;

/// @brief Method get_isApplyingViewState, addr 0x494f6e4, size 0x8, virtual false, abstract: false, final false
inline bool get_isApplyingViewState() ;

/// @brief Method get_resizeHandleContainer, addr 0x494f704, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_resizeHandleContainer() ;

/// @brief Method get_sortDescriptions, addr 0x494f714, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::SortColumnDescriptions* get_sortDescriptions() ;

/// @brief Method get_sortedColumns, addr 0x494f70c, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::SortColumnDescription*>* get_sortedColumns() ;

/// @brief Method get_sortingEnabled, addr 0x494fecc, size 0x8, virtual false, abstract: false, final false
inline bool get_sortingEnabled() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method remove_columnResized, addr 0x495061c, size 0xb4, virtual false, abstract: false, final false
inline void remove_columnResized(::System::Action_2<int32_t,float_t>*  value) ;

/// @brief Method remove_columnSortingChanged, addr 0x4950770, size 0xa0, virtual false, abstract: false, final false
inline void remove_columnSortingChanged(::System::Action*  value) ;

/// @brief Method remove_contextMenuPopulateEvent, addr 0x49508c4, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method remove_viewDataRestored, addr 0x4950a18, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method set_sortDescriptions, addr 0x494f71c, size 0x9c, virtual false, abstract: false, final false
inline void set_sortDescriptions(::UnityEngine::UIElements::SortColumnDescriptions*  value) ;

/// @brief Method set_sortingEnabled, addr 0x494fed4, size 0x34, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::Internal::__MultiColumnCollectionHeader____c__DisplayClass65_0*, "UnityEngine.UIElements.Internal", "MultiColumnCollectionHeader/<>c__DisplayClass65_0");
NEED_NO_BOX(::UnityEngine::UIElements::Internal::__MultiColumnCollectionHeader____c__DisplayClass71_0);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::Internal::__MultiColumnCollectionHeader____c__DisplayClass71_0*, "UnityEngine.UIElements.Internal", "MultiColumnCollectionHeader/<>c__DisplayClass71_0");
