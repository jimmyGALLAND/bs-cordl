...
/// @brief Method .ctor, addr 0x497844c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  id, int32_t  parentId, ::System::Collections::Generic::IEnumerable_1<int32_t>*  childrenIds) ;

/// @brief Method get_childrenIds, addr 0x49783ec, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<int32_t>* get_childrenIds() ;

/// @brief Method get_hasChildren, addr 0x49783f4, size 0x58, virtual false, abstract: false, final false
inline bool get_hasChildren() ;

/// @brief Method get_id, addr 0x49783dc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_id() ;

/// @brief Method get_parentId, addr 0x49783e4, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_id_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_parentId_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_childrenIds_k__BackingField", ty: "::System::Collections::Generic::IEnumerable_1<int32_t>*", modifiers: "", def_value: None }]
