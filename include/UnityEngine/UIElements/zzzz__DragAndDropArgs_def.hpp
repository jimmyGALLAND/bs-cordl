...
/// @brief Method get_childIndex, addr 0x4983df4, size 0x8, virtual true, abstract: false, final true
inline int32_t get_childIndex() ;

/// @brief Method get_dragAndDropData, addr 0x4983e14, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::DragAndDropData* get_dragAndDropData() ;

/// @brief Method get_dragAndDropPosition, addr 0x4983e04, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::DragAndDropPosition get_dragAndDropPosition() ;

/// @brief Method get_insertAtIndex, addr 0x4983dd4, size 0x8, virtual true, abstract: false, final true
inline int32_t get_insertAtIndex() ;

/// @brief Method get_parentId, addr 0x4983de4, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_childIndex, addr 0x4983dfc, size 0x8, virtual false, abstract: false, final false
inline void set_childIndex(int32_t  value) ;

/// @brief Method set_dragAndDropData, addr 0x4983e1c, size 0x8, virtual false, abstract: false, final false
inline void set_dragAndDropData(::UnityEngine::UIElements::DragAndDropData*  value) ;

/// @brief Method set_dragAndDropPosition, addr 0x4983e0c, size 0x8, virtual false, abstract: false, final false
inline void set_dragAndDropPosition(::UnityEngine::UIElements::DragAndDropPosition  value) ;

/// @brief Method set_insertAtIndex, addr 0x4983ddc, size 0x8, virtual false, abstract: false, final false
inline void set_insertAtIndex(int32_t  value) ;

/// @brief Method set_parentId, addr 0x4983dec, size 0x8, virtual false, abstract: false, final false
inline void set_parentId(int32_t  value) ;

/// @brief Method set_target, addr 0x4983dcc, size 0x8, virtual false, abstract: false, final false
