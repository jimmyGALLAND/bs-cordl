...
/// @brief Method .ctor, addr 0x49775a0, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x49775e8, size 0x2c0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x49778a8, size 0x228, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x4976b34, size 0x1cc, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, int32_t  startValue) ;

/// @brief Method ComputeValueAndDirectionFromClick, addr 0x4976e88, size 0x368, virtual true, abstract: false, final false
...
/// @brief Method ComputeValueFromKey, addr 0x49771f0, size 0x2e0, virtual true, abstract: false, final false
...
/// @brief Method ParseStringToValue, addr 0x4976e08, size 0x80, virtual true, abstract: false, final false
inline int32_t ParseStringToValue(::StringW  previousValue, ::StringW  newValue) ;

/// @brief Method SliderLerpUnclamped, addr 0x4976d00, size 0xec, virtual true, abstract: false, final false
inline int32_t SliderLerpUnclamped(int32_t  a, int32_t  b, float_t  interpolant) ;

/// @brief Method SliderNormalizeValue, addr 0x4976dec, size 0x1c, virtual true, abstract: false, final false
inline float_t SliderNormalizeValue(int32_t  currentValue, int32_t  lowerValue, int32_t  higherValue) ;

/// @brief Method .ctor, addr 0x4976870, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4976888, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method get_pageSize, addr 0x49769d4, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method set_pageSize, addr 0x4976a1c, size 0x118, virtual true, abstract: false, final false
