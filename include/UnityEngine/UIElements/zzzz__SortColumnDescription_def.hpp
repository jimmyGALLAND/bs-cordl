...
namespace UnityEngine::UIElements {
template<typename T>
class __SortColumnDescription__UxmlObjectFactory_1;
}
namespace UnityEngine::UIElements {
template<typename T>
class __SortColumnDescription__UxmlObjectTraits_1;
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::SortDirection>*> const& __cordl_internal_get_m_SortDescription() const;
...
// Declarations
template<typename T>
using UxmlObjectFactory_1 = ::UnityEngine::UIElements::__SortColumnDescription__UxmlObjectFactory_1<T>;

template<typename T>
using UxmlObjectTraits_1 = ::UnityEngine::UIElements::__SortColumnDescription__UxmlObjectTraits_1<T>;
...
/// @brief Method .ctor, addr 0x496aa4c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x496aa5c, size 0x90, virtual false, abstract: false, final false
inline void _ctor(int32_t  columnIndex, ::UnityEngine::UIElements::SortDirection  direction) ;

/// @brief Method .ctor, addr 0x496aaec, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::StringW  columnName, ::UnityEngine::UIElements::SortDirection  direction) ;

/// @brief Method add_changed, addr 0x496a8ec, size 0xb0, virtual false, abstract: false, final false
inline void add_changed(::System::Action_1<::UnityEngine::UIElements::SortColumnDescription*>*  value) ;

/// @brief Method get_column, addr 0x496a8a0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Column* get_column() ;

/// @brief Method get_columnIndex, addr 0x496a864, size 0x8, virtual false, abstract: false, final false
inline int32_t get_columnIndex() ;

/// @brief Method get_columnName, addr 0x496a808, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_columnName() ;

/// @brief Method get_direction, addr 0x496a8b0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::SortDirection get_direction() ;

/// @brief Method remove_changed, addr 0x496a99c, size 0xb0, virtual false, abstract: false, final false
inline void remove_changed(::System::Action_1<::UnityEngine::UIElements::SortColumnDescription*>*  value) ;

/// @brief Method set_column, addr 0x496a8a8, size 0x8, virtual false, abstract: false, final false
inline void set_column(::UnityEngine::UIElements::Column*  value) ;

/// @brief Method set_columnIndex, addr 0x496a86c, size 0x34, virtual false, abstract: false, final false
inline void set_columnIndex(int32_t  value) ;

/// @brief Method set_columnName, addr 0x496a810, size 0x54, virtual false, abstract: false, final false
inline void set_columnName(::StringW  value) ;

/// @brief Method set_direction, addr 0x496a8b8, size 0x34, virtual false, abstract: false, final false
