...
static __declspec(property(get=getStaticF_s_EnumerationList, put=setStaticF_s_EnumerationList)) ::UnityEngine::UIElements::__UQueryState_1__ListQueryMatcher_1<T,::UnityEngine::UIElements::VisualElement*>*  s_EnumerationList;
