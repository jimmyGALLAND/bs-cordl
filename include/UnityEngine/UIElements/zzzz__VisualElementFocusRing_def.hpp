...
/// @brief Field m_ScopeNavigationOrder, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ScopeNavigationOrder, put=__cordl_internal_set_m_ScopeNavigationOrder)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualElementFocusRing__FocusRingRecord*>*  m_ScopeNavigationOrder;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualElementFocusRing__FocusRingRecord*>*> const& __cordl_internal_get_m_ScopeNavigationOrder() const;
...
/// @brief Method .ctor, addr 0x4909488, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <defaultFocusOrder>k__BackingField, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__defaultFocusOrder_k__BackingField, put=__cordl_internal_set__defaultFocusOrder_k__BackingField)) ::UnityEngine::UIElements::__VisualElementFocusRing__DefaultFocusOrder  _defaultFocusOrder_k__BackingField;
...
/// @brief Field m_FocusRing, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_FocusRing, put=__cordl_internal_set_m_FocusRing)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualElementFocusRing__FocusRingRecord*>*  m_FocusRing;
...
/// @brief Method BuildRingForScopeRecursive, addr 0x4908ee8, size 0x2e4, virtual false, abstract: false, final false
inline void BuildRingForScopeRecursive(::UnityEngine::UIElements::VisualElement*  ve, ByRef<int32_t>  scopeIndex, ::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualElementFocusRing__FocusRingRecord*>*  scopeList) ;

/// @brief Method DoUpdate, addr 0x4908e18, size 0xd0, virtual false, abstract: false, final false
inline void DoUpdate() ;

/// @brief Method FocusRingAutoIndexSort, addr 0x4908a10, size 0x318, virtual false, abstract: false, final false
...
/// @brief Method FocusRingSort, addr 0x4908d28, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method GetFocusChangeDirection, addr 0x4909538, size 0x3b8, virtual true, abstract: false, final true
...
/// @brief Method GetFocusableInternalIndex, addr 0x4909490, size 0xa8, virtual false, abstract: false, final false
inline int32_t GetFocusableInternalIndex(::UnityEngine::UIElements::Focusable*  f) ;

/// @brief Method GetNextFocusable, addr 0x49098f0, size 0x3f4, virtual true, abstract: false, final true
...
/// @brief Method GetNextFocusableInTree, addr 0x4909ce4, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method GetPreviousFocusableInTree, addr 0x4909d80, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method SortAndFlattenScopeLists, addr 0x49091cc, size 0x2bc, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualElementFocusRing__FocusRingRecord*>*> const& __cordl_internal_get_m_FocusRing() const;
...
/// @brief Method .ctor, addr 0x4908944, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method get_defaultFocusOrder, addr 0x4908a00, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::__VisualElementFocusRing__DefaultFocusOrder get_defaultFocusOrder() ;

/// @brief Method get_focusController, addr 0x49089dc, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method set_defaultFocusOrder, addr 0x4908a08, size 0x8, virtual false, abstract: false, final false
