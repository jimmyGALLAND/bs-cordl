...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::IPanel*> const& UnityEngine::UIElements::PanelChangedEventBase_1<T>::__cordl_internal_get__originPanel_k__BackingField() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____originPanel_k__BackingField;
}
template<typename T>
...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::IPanel*> const& UnityEngine::UIElements::PanelChangedEventBase_1<T>::__cordl_internal_get__destinationPanel_k__BackingField() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____destinationPanel_k__BackingField;
}
template<typename T>
