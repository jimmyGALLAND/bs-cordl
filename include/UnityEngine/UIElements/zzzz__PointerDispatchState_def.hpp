...
/// @brief Field m_PendingPointerCapture, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PendingPointerCapture, put=__cordl_internal_set_m_PendingPointerCapture)) ::ArrayW<::UnityEngine::UIElements::IEventHandler*,::Array<::UnityEngine::UIElements::IEventHandler*>*>  m_PendingPointerCapture;

/// @brief Field m_PointerCapture, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PointerCapture, put=__cordl_internal_set_m_PointerCapture)) ::ArrayW<::UnityEngine::UIElements::IEventHandler*,::Array<::UnityEngine::UIElements::IEventHandler*>*>  m_PointerCapture;

/// @brief Field m_ShouldSendCompatibilityMouseEvents, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ShouldSendCompatibilityMouseEvents, put=__cordl_internal_set_m_ShouldSendCompatibilityMouseEvents)) ::ArrayW<bool,::Array<bool>*>  m_ShouldSendCompatibilityMouseEvents;

/// @brief Method ActivateCompatibilityMouseEvents, addr 0x49b0340, size 0x34, virtual false, abstract: false, final false
inline void ActivateCompatibilityMouseEvents(int32_t  pointerId) ;

/// @brief Method CapturePointer, addr 0x49aff58, size 0x12c, virtual false, abstract: false, final false
inline void CapturePointer(::UnityEngine::UIElements::IEventHandler*  handler, int32_t  pointerId) ;

/// @brief Method GetCapturingElement, addr 0x49a9be0, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::IEventHandler* GetCapturingElement(int32_t  pointerId) ;

/// @brief Method HasPointerCapture, addr 0x49aff20, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method PreventCompatibilityMouseEvents, addr 0x49b0438, size 0x30, virtual false, abstract: false, final false
inline void PreventCompatibilityMouseEvents(int32_t  pointerId) ;

/// @brief Method ProcessPointerCapture, addr 0x49b06c0, size 0x998, virtual false, abstract: false, final false
inline void ProcessPointerCapture(int32_t  pointerId) ;

/// @brief Method ReleasePointer, addr 0x49b0084, size 0x3c, virtual false, abstract: false, final false
inline void ReleasePointer(::UnityEngine::UIElements::IEventHandler*  handler, int32_t  pointerId) ;

/// @brief Method ReleasePointer, addr 0x49b024c, size 0x30, virtual false, abstract: false, final false
inline void ReleasePointer(int32_t  pointerId) ;

/// @brief Method Reset, addr 0x49b1130, size 0x90, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method ShouldSendCompatibilityMouseEvents, addr 0x49b058c, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x49b1058, size 0xd8, virtual false, abstract: false, final false
inline void _ctor() ;
