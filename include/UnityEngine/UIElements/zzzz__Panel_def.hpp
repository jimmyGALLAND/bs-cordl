...
static __declspec(property(get=getStaticF__TimeSinceStartup_k__BackingField, put=setStaticF__TimeSinceStartup_k__BackingField)) ::UnityEngine::UIElements::TimeMsFunction*  _TimeSinceStartup_k__BackingField;
...
static __declspec(property(get=getStaticF__loadResourceFunc_k__BackingField, put=setStaticF__loadResourceFunc_k__BackingField)) ::UnityEngine::UIElements::LoadResourceFunction*  _loadResourceFunc_k__BackingField;
...
/// @brief Method ApplyStyles, addr 0x49aeb3c, size 0x20, virtual true, abstract: false, final false
inline void ApplyStyles() ;

/// @brief Method Blur, addr 0x49adb20, size 0x2c, virtual false, abstract: false, final false
inline void Blur() ;

/// @brief Method CreateMarkers, addr 0x49adb8c, size 0x24c, virtual false, abstract: false, final false
inline void CreateMarkers() ;

/// @brief Method DefaultTimeSinceStartupMs, addr 0x49ae3c0, size 0x38, virtual false, abstract: false, final false
static inline int64_t DefaultTimeSinceStartupMs() ;

/// @brief Method Dispose, addr 0x49ae27c, size 0x68, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Focus, addr 0x49adb14, size 0xc, virtual false, abstract: false, final false
inline void Focus() ;

/// @brief Method GetUpdater, addr 0x49aeec0, size 0x1c, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::IVisualTreeUpdater* GetUpdater(::UnityEngine::UIElements::VisualTreeUpdatePhase  phase) ;

/// @brief Method LoadResource, addr 0x49ad9e8, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method OnVersionChanged, addr 0x49aee74, size 0x4c, virtual true, abstract: false, final false
inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::VersionChangeType  versionChangeType) ;

/// @brief Method PerformPick, addr 0x49ae47c, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method Pick, addr 0x49ae858, size 0x178, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* Pick(::UnityEngine::Vector2  point) ;

/// @brief Method PickAll, addr 0x49ae77c, size 0xdc, virtual true, abstract: false, final false
...
/// @brief Method PickAll, addr 0x49ae3f8, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method Repaint, addr 0x49aebd0, size 0x2a4, virtual true, abstract: false, final false
inline void Repaint(::UnityEngine::Event*  e) ;

/// @brief Method TimeSinceStartupMs, addr 0x49ae2e4, size 0xdc, virtual false, abstract: false, final false
static inline int64_t TimeSinceStartupMs() ;

/// @brief Method UpdateAnimations, addr 0x49aeafc, size 0x20, virtual true, abstract: false, final false
inline void UpdateAnimations() ;

/// @brief Method UpdateBindings, addr 0x49aeb1c, size 0x20, virtual true, abstract: false, final false
inline void UpdateBindings() ;

/// @brief Method UpdateForRepaint, addr 0x49aeb5c, size 0x74, virtual false, abstract: false, final false
inline void UpdateForRepaint() ;

/// @brief Method ValidateFocus, addr 0x49adb4c, size 0x38, virtual true, abstract: false, final false
inline void ValidateFocus() ;

/// @brief Method ValidateLayout, addr 0x49aea98, size 0x64, virtual true, abstract: false, final false
inline void ValidateLayout() ;

/// @brief Method <Pick>g__PixelOf|101_0, addr 0x49ae9d0, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x49adedc, size 0x3a0, virtual false, abstract: false, final false
...
/// @brief Method get_IMGUIContainersCount, addr 0x49ade30, size 0x8, virtual true, abstract: false, final false
inline int32_t get_IMGUIContainersCount() ;

/// @brief Method get_IMGUIEventInterests, addr 0x49ad970, size 0x10, virtual true, abstract: false, final false
inline ::UnityEngine::EventInterests get_IMGUIEventInterests() ;

/// @brief Method get_TimeSinceStartup, addr 0x49addd8, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::TimeMsFunction* get_TimeSinceStartup() ;

/// @brief Method get_atlas, addr 0x49ade60, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::AtlasBase* get_atlas() ;

/// @brief Method get_contextType, addr 0x49ad940, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::ContextType get_contextType() ;

/// @brief Method get_dispatcher, addr 0x49ad7fc, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::EventDispatcher* get_dispatcher() ;

/// @brief Method get_focusController, addr 0x49ad960, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::FocusController* get_focusController() ;

/// @brief Method get_getViewDataDictionary, addr 0x49ad958, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::GetViewDataDictionary* get_getViewDataDictionary() ;

/// @brief Method get_hierarchyVersion, addr 0x49ade50, size 0x8, virtual true, abstract: false, final false
inline uint32_t get_hierarchyVersion() ;

/// @brief Method get_loadResourceFunc, addr 0x49ad990, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::LoadResourceFunction* get_loadResourceFunc() ;

/// @brief Method get_name, addr 0x49adb84, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method get_ownerObject, addr 0x49ad930, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::ScriptableObject> get_ownerObject() ;

/// @brief Method get_rootIMGUIContainer, addr 0x49ade40, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::IMGUIContainer* get_rootIMGUIContainer() ;

/// @brief Method get_saveViewData, addr 0x49ad950, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::SavePersistentViewData* get_saveViewData() ;

/// @brief Method get_scheduler, addr 0x49ad870, size 0x4, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::IScheduler* get_scheduler() ;

/// @brief Method get_standardShader, addr 0x49ade58, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_standardShader() ;

/// @brief Method get_styleAnimationSystem, addr 0x49ad874, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::IStylePropertyAnimationSystem* get_styleAnimationSystem() ;

/// @brief Method get_timerEventScheduler, addr 0x49ad80c, size 0x64, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TimerEventScheduler* get_timerEventScheduler() ;

/// @brief Method get_version, addr 0x49ade48, size 0x8, virtual true, abstract: false, final false
inline uint32_t get_version() ;

/// @brief Method get_visualTree, addr 0x49ad7f4, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_IMGUIContainersCount, addr 0x49ade38, size 0x8, virtual true, abstract: false, final false
inline void set_IMGUIContainersCount(int32_t  value) ;

/// @brief Method set_IMGUIEventInterests, addr 0x49ad980, size 0x10, virtual true, abstract: false, final false
inline void set_IMGUIEventInterests(::UnityEngine::EventInterests  value) ;

/// @brief Method set_atlas, addr 0x49ade68, size 0x74, virtual true, abstract: false, final false
inline void set_atlas(::UnityEngine::UIElements::AtlasBase*  value) ;

/// @brief Method set_contextType, addr 0x49ad948, size 0x8, virtual true, abstract: false, final false
inline void set_contextType(::UnityEngine::UIElements::ContextType  value) ;

/// @brief Method set_dispatcher, addr 0x49ad804, size 0x8, virtual true, abstract: false, final true
inline void set_dispatcher(::UnityEngine::UIElements::EventDispatcher*  value) ;

/// @brief Method set_focusController, addr 0x49ad968, size 0x8, virtual true, abstract: false, final true
inline void set_focusController(::UnityEngine::UIElements::FocusController*  value) ;

/// @brief Method set_name, addr 0x49a4974, size 0x8, virtual false, abstract: false, final false
inline void set_name(::StringW  value) ;

/// @brief Method set_ownerObject, addr 0x49ad938, size 0x8, virtual true, abstract: false, final false
inline void set_ownerObject(::UnityEngine::ScriptableObject*  value) ;

/// @brief Method set_styleAnimationSystem, addr 0x49ad87c, size 0xb4, virtual true, abstract: false, final false
