...
/// @brief Method CanDispatchEvent, addr 0x49958e0, size 0x54, virtual true, abstract: false, final true
inline bool CanDispatchEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method DispatchEvent, addr 0x4995934, size 0x108, virtual true, abstract: false, final true
inline void DispatchEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::IPanel*  iPanel) ;

/// @brief Method IsDone, addr 0x4995d94, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method SendEventToIMGUIContainer, addr 0x4995bcc, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method SendEventToRegularTarget, addr 0x4995b18, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method SendEventToTarget, addr 0x4995adc, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method SetBestTargetForEvent, addr 0x4995a3c, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method UpdateElementUnderMouse, addr 0x4995ddc, size 0x300, virtual false, abstract: false, final false
static inline void UpdateElementUnderMouse(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::BaseVisualElementPanel*  panel, ByRef<::UnityEngine::UIElements::VisualElement*>  elementUnderMouse) ;

/// @brief Method .ctor, addr 0x498d78c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
