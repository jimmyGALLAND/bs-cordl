...
// Ctor Parameters [CppParam { name: "DefaultActionCategories", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "DefaultActionAtTargetCategories", ty: "int32_t", modifiers: "", def_value: None }]
...
static __declspec(property(get=getStaticF_s_DefaultEventInterests, put=setStaticF_s_DefaultEventInterests)) ::System::Collections::Generic::Dictionary_2<::System::Type*,::UnityEngine::UIElements::__EventInterestReflectionUtils__DefaultEventInterests>*  s_DefaultEventInterests;

/// @brief Field s_EventCategories, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_EventCategories, put=setStaticF_s_EventCategories)) ::System::Collections::Generic::Dictionary_2<::System::Type*,::UnityEngine::UIElements::EventCategory>*  s_EventCategories;

/// @brief Method ComputeDefaultEventInterests, addr 0x4907dcc, size 0x204, virtual false, abstract: false, final false
static inline int32_t ComputeDefaultEventInterests(::System::Type*  elementType, ::StringW  methodName) ;

/// @brief Method GetDefaultEventInterests, addr 0x4907ba0, size 0x22c, virtual false, abstract: false, final false
...
/// @brief Method GetEventCategory, addr 0x4907fd0, size 0x208, virtual false, abstract: false, final false
...
static inline void setStaticF_s_DefaultEventInterests(::System::Collections::Generic::Dictionary_2<::System::Type*,::UnityEngine::UIElements::__EventInterestReflectionUtils__DefaultEventInterests>*  value) ;
