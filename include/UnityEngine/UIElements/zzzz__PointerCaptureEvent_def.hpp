...
/// @brief Method <.cctor>b__0_0, addr 0x498dbf0, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::PointerCaptureEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x498dbe8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x498db44, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
