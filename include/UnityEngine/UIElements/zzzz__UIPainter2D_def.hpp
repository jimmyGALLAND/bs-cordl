...
public:
// Declarations
/// @brief Method Create, addr 0x49abc14, size 0x3c, virtual false, abstract: false, final false
static inline ::System::IntPtr Create(bool  computeBBox) ;

/// @brief Method Destroy, addr 0x49abc50, size 0x3c, virtual false, abstract: false, final false
static inline void Destroy(::System::IntPtr  handle) ;

/// @brief Method Reset, addr 0x49abc8c, size 0x3c, virtual false, abstract: false, final false
