...
/// @brief Method <GetValueFromBag>b__3_0, addr 0x4a0d67c, size 0x10, virtual false, abstract: false, final false
inline bool _GetValueFromBag_b__3_0(::StringW  s, bool  b) ;

/// @brief Method .ctor, addr 0x4a0d674, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ConvertValueToBool, addr 0x4a0d590, size 0x88, virtual false, abstract: false, final false
static inline bool ConvertValueToBool(::StringW  v, bool  defaultValue) ;

/// @brief Method GetValueFromBag, addr 0x4a0d440, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a046c0, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
