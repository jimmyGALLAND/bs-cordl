...
/// @brief Method .ctor, addr 0x497634c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x4976394, size 0x2b4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4976648, size 0x228, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x4975c20, size 0x124, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, float_t  startValue) ;

/// @brief Method ComputeValueFromKey, addr 0x497607c, size 0x200, virtual true, abstract: false, final false
...
/// @brief Method ParseStringToValue, addr 0x4975ff8, size 0x84, virtual true, abstract: false, final false
inline float_t ParseStringToValue(::StringW  previousValue, ::StringW  newValue) ;

/// @brief Method SliderLerpUnclamped, addr 0x4975d44, size 0x2b4, virtual true, abstract: false, final false
inline float_t SliderLerpUnclamped(float_t  a, float_t  b, float_t  interpolant) ;

/// @brief Method SliderNormalizeValue, addr 0x4975668, size 0x10, virtual true, abstract: false, final false
inline float_t SliderNormalizeValue(float_t  currentValue, float_t  lowerValue, float_t  higherValue) ;

/// @brief Method .ctor, addr 0x4975abc, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4975ad4, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4975638, size 0xc, virtual false, abstract: false, final false
