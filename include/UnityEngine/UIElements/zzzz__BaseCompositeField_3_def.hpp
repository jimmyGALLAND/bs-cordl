...
namespace UnityEngine::UIElements {
template<typename TValueType,typename TField,typename TFieldValue>
class __BaseCompositeField_3____c__DisplayClass24_0;
}
...
/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::StringW  ussName, ::System::Func_2<TValueType,TFieldValue>*  read, ::GlobalNamespace::__BaseCompositeField_3__FieldDescription__WriteDelegate<TValueType,TField,TFieldValue>*  write) ;

// Ctor Parameters []
// @brief default ctor
constexpr __BaseCompositeField_3__FieldDescription() ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "ussName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "read", ty: "::System::Func_2<TValueType,TFieldValue>*", modifiers: "", def_value: None }, CppParam { name: "write", ty: "::GlobalNamespace::__BaseCompositeField_3__FieldDescription__WriteDelegate<TValueType,TField,TFieldValue>*", modifiers: "", def_value: None }]
constexpr __BaseCompositeField_3__FieldDescription(::StringW  name, ::StringW  ussName, ::System::Func_2<TValueType,TFieldValue>*  read, ::GlobalNamespace::__BaseCompositeField_3__FieldDescription__WriteDelegate<TValueType,TField,TFieldValue>*  write) noexcept;
...
inline ::ArrayW<::UnityEngine::UIElements::__BaseCompositeField_3__FieldDescription<TValueType,TField,TFieldValue>,::Array<::UnityEngine::UIElements::__BaseCompositeField_3__FieldDescription<TValueType,TField,TFieldValue>>*> DescribeFields() ;
