...
/// @brief Field m_FocusedElements, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_FocusedElements, put=__cordl_internal_set_m_FocusedElements)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::__FocusController__FocusedElement>*  m_FocusedElements;
...
/// @brief Method AboutToGrabFocus, addr 0x49a1234, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method AboutToReleaseFocus, addr 0x49a0eb4, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method Blur, addr 0x499fb98, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method BlurLastFocusedElement, addr 0x49a0bbc, size 0x94, virtual false, abstract: false, final false
inline void BlurLastFocusedElement() ;

/// @brief Method DoFocusChange, addr 0x49a0c50, size 0x178, virtual false, abstract: false, final false
inline void DoFocusChange(::UnityEngine::UIElements::Focusable*  f) ;

/// @brief Method FocusNextInDirection, addr 0x49a0dc8, size 0xec, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Focusable* FocusNextInDirection(::UnityEngine::UIElements::FocusChangeDirection*  direction) ;

/// @brief Method GetFocusableParentForPointerEvent, addr 0x49a1678, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method GetLeafFocusedElement, addr 0x498e340, size 0xa4, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Focusable* GetLeafFocusedElement() ;

/// @brief Method GetRetargetedFocusedElement, addr 0x49a068c, size 0x214, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Focusable* GetRetargetedFocusedElement(::UnityEngine::UIElements::VisualElement*  retargetAgainst) ;

/// @brief Method GrabFocus, addr 0x49a13f4, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method IsFocused, addr 0x49a08dc, size 0x18c, virtual false, abstract: false, final false
inline bool IsFocused(::UnityEngine::UIElements::Focusable*  f) ;

/// @brief Method IsLocalElement, addr 0x49a08a0, size 0x3c, virtual false, abstract: false, final false
inline bool IsLocalElement(::UnityEngine::UIElements::Focusable*  f) ;

/// @brief Method IsPendingFocus, addr 0x49a0a68, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method ProcessPendingFocusChange, addr 0x4992880, size 0x1c, virtual false, abstract: false, final false
inline void ProcessPendingFocusChange(::UnityEngine::UIElements::Focusable*  f) ;

/// @brief Method ReevaluateFocus, addr 0x49a15c0, size 0xb8, virtual false, abstract: false, final false
inline void ReevaluateFocus() ;

/// @brief Method ReleaseFocus, addr 0x49a1074, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method SetFocusToLastFocusedElement, addr 0x49a0b34, size 0x88, virtual false, abstract: false, final false
inline void SetFocusToLastFocusedElement() ;

/// @brief Method SwitchFocus, addr 0x499faa8, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method SwitchFocus, addr 0x49a0190, size 0x294, virtual false, abstract: false, final false
...
/// @brief Method SwitchFocusOnEvent, addr 0x499fd8c, size 0x290, virtual false, abstract: false, final false
inline void SwitchFocusOnEvent(::UnityEngine::UIElements::EventBase*  e) ;

/// @brief Method SyncIMGUIFocus, addr 0x49a1790, size 0xcc, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__FocusController__FocusedElement>*> const& __cordl_internal_get_m_FocusedElements() const;
...
/// @brief Method .ctor, addr 0x49a04e8, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::IFocusRing*  focusRing) ;

/// @brief Method get_focusRing, addr 0x49a0578, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::IFocusRing* get_focusRing() ;

/// @brief Method get_focusedElement, addr 0x49a0648, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Focusable* get_focusedElement() ;

/// @brief Method get_imguiKeyboardControl, addr 0x49a1780, size 0x8, virtual false, abstract: false, final false
inline int32_t get_imguiKeyboardControl() ;

/// @brief Method set_imguiKeyboardControl, addr 0x49a1788, size 0x8, virtual false, abstract: false, final false
inline void set_imguiKeyboardControl(int32_t  value) ;

/// @brief Method set_selectedTextElement, addr 0x49a0580, size 0xc8, virtual false, abstract: false, final false
