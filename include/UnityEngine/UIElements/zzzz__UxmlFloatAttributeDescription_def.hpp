...
/// @brief Method <GetValueFromBag>b__3_0, addr 0x4a0c49c, size 0x8, virtual false, abstract: false, final false
inline float_t _GetValueFromBag_b__3_0(::StringW  s, float_t  f) ;

/// @brief Method .ctor, addr 0x4a0c494, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ConvertValueToFloat, addr 0x4a0c39c, size 0x9c, virtual false, abstract: false, final false
static inline float_t ConvertValueToFloat(::StringW  v, float_t  defaultValue) ;

/// @brief Method GetValueFromBag, addr 0x4a0c250, size 0x14c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a0c1b8, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
