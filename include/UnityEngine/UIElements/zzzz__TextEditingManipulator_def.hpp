...
/// @brief Method ExecuteDefaultActionAtTarget, addr 0x49fb898, size 0x160, virtual false, abstract: false, final false
inline void ExecuteDefaultActionAtTarget(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method InitTextEditorEventHandler, addr 0x49fb7cc, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method OnFocusInEvent, addr 0x49fb9fc, size 0x2ac, virtual false, abstract: false, final false
inline void OnFocusInEvent(::UnityEngine::UIElements::FocusInEvent*  _) ;

/// @brief Method OnFocusOutEvent, addr 0x49fbca8, size 0xb4, virtual false, abstract: false, final false
inline void OnFocusOutEvent(::UnityEngine::UIElements::FocusOutEvent*  _) ;

/// @brief Method <OnFocusInEvent>b__10_0, addr 0x49fbd5c, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x49fb6a8, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::TextElement*  textElement) ;

/// @brief Method get_touchScreenTextFieldChanged, addr 0x49fb5f8, size 0xb0, virtual false, abstract: false, final false
