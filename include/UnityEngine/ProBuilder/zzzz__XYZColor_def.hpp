...
/// @brief Method FromRGB, addr 0x4674080, size 0x74, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::XYZColor* FromRGB(float_t  R, float_t  G, float_t  B) ;

/// @brief Method FromRGB, addr 0x4673f90, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x46742a0, size 0xc4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4673f54, size 0x3c, virtual false, abstract: false, final false
