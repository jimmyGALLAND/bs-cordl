...
/// @brief Method IsSnapEnabled, addr 0x468b318, size 0x8, virtual false, abstract: false, final false
inline bool IsSnapEnabled() ;

static inline ::UnityEngine::ProBuilder::PolyShape* New_ctor() ;

/// @brief Method SetControlPoints, addr 0x468b1ec, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x468b320, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_controlPoints, addr 0x468b170, size 0x7c, virtual false, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::UnityEngine::Vector3>* get_controlPoints() ;

/// @brief Method get_extrude, addr 0x468b248, size 0x8, virtual false, abstract: false, final false
inline float_t get_extrude() ;

/// @brief Method get_flipNormals, addr 0x468b268, size 0x8, virtual false, abstract: false, final false
inline bool get_flipNormals() ;

/// @brief Method get_mesh, addr 0x468b27c, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh> get_mesh() ;

/// @brief Method get_polyEditMode, addr 0x468b258, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::__PolyShape__PolyEditMode get_polyEditMode() ;

/// @brief Method set_extrude, addr 0x468b250, size 0x8, virtual false, abstract: false, final false
inline void set_extrude(float_t  value) ;

/// @brief Method set_flipNormals, addr 0x468b270, size 0xc, virtual false, abstract: false, final false
inline void set_flipNormals(bool  value) ;

/// @brief Method set_mesh, addr 0x468b310, size 0x8, virtual false, abstract: false, final false
inline void set_mesh(::UnityEngine::ProBuilder::ProBuilderMesh*  value) ;

/// @brief Method set_polyEditMode, addr 0x468b260, size 0x8, virtual false, abstract: false, final false
