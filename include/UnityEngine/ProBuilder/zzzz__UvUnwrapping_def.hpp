...
public:
// Declarations
/// @brief Method ToString, addr 0x46b3c3c, size 0x114, virtual true, abstract: false, final false
...
/// @brief Method <SetAutoUV>b__0_0, addr 0x46b3db4, size 0x18, virtual false, abstract: false, final false
inline bool _SetAutoUV_b__0_0(::UnityEngine::ProBuilder::Face*  x) ;

/// @brief Method .ctor, addr 0x46b3dac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static __declspec(property(get=getStaticF_s_UVTransformProjectionBuffer, put=setStaticF_s_UVTransformProjectionBuffer)) ::System::Collections::Generic::List_1<::UnityEngine::Vector2>*  s_UVTransformProjectionBuffer;

/// @brief Method ApplyUVAnchor, addr 0x46b367c, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method ApplyUVSettings, addr 0x46b29dc, size 0x8f0, virtual false, abstract: false, final false
...
/// @brief Method CalculateDelta, addr 0x46b1fe0, size 0x444, virtual false, abstract: false, final false
...
/// @brief Method CopyUVs, addr 0x46aa52c, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method GetAutoUnwrapSettings, addr 0x46b2424, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method GetIndex, addr 0x46b2630, size 0xb0, virtual false, abstract: false, final false
static inline int32_t GetIndex(::System::Collections::Generic::IList_1<int32_t>*  collection, int32_t  index) ;

/// @brief Method GetRotatedSize, addr 0x46b26e0, size 0x2fc, virtual false, abstract: false, final false
...
/// @brief Method GetUVTransform, addr 0x46b2528, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method ProjectTextureGroup, addr 0x46b32cc, size 0x194, virtual false, abstract: false, final false
...
/// @brief Method ScaleUVs, addr 0x46b3460, size 0x21c, virtual false, abstract: false, final false
...
/// @brief Method SetAutoAndAlignUnwrapParamsToUVs, addr 0x46b1df4, size 0x1ec, virtual false, abstract: false, final false
...
/// @brief Method SetAutoUV, addr 0x46b1c64, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method Unwrap, addr 0x46aa3ec, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method UpgradeAutoUVScaleOffset, addr 0x46b39fc, size 0x124, virtual false, abstract: false, final false
