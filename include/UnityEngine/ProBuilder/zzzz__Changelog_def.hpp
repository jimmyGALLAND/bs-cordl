...
/// @brief Method CreateEntry, addr 0x4672a8c, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4672790, size 0x2fc, virtual false, abstract: false, final false
inline void _ctor(::StringW  log) ;

/// @brief Method get_entries, addr 0x4672714, size 0x7c, virtual false, abstract: false, final false
