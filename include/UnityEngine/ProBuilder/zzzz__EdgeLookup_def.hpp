...
/// @brief Method <GetEdgeLookup>b__0, addr 0x4676004, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4675c60, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Equals, addr 0x46757b4, size 0x84, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x4675720, size 0x94, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::ProBuilder::EdgeLookup  other) ;

/// @brief Method GetEdgeLookup, addr 0x4675b90, size 0xd0, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::EdgeLookup>* GetEdgeLookup(::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Edge>*  edges, ::System::Collections::Generic::Dictionary_2<int32_t,int32_t>*  lookup) ;

/// @brief Method GetEdgeLookupHashSet, addr 0x4675c68, size 0x39c, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::HashSet_1<::UnityEngine::ProBuilder::EdgeLookup>* GetEdgeLookupHashSet(::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Edge>*  edges, ::System::Collections::Generic::Dictionary_2<int32_t,int32_t>*  lookup) ;

/// @brief Method GetHashCode, addr 0x4675838, size 0x70, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x46759e4, size 0x1ac, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x4675700, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ProBuilder::Edge  common, ::UnityEngine::ProBuilder::Edge  local) ;

/// @brief Method .ctor, addr 0x4675708, size 0x18, virtual false, abstract: false, final false
inline void _ctor(int32_t  cx, int32_t  cy, int32_t  x, int32_t  y) ;

/// @brief Method get_common, addr 0x46756f0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Edge get_common() ;

/// @brief Method get_local, addr 0x46756e0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x46758a8, size 0x9c, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::ProBuilder::EdgeLookup  a, ::UnityEngine::ProBuilder::EdgeLookup  b) ;

/// @brief Method op_Inequality, addr 0x4675944, size 0xa0, virtual false, abstract: false, final false
static inline bool op_Inequality(::UnityEngine::ProBuilder::EdgeLookup  a, ::UnityEngine::ProBuilder::EdgeLookup  b) ;

/// @brief Method set_common, addr 0x46756f8, size 0x8, virtual false, abstract: false, final false
inline void set_common(::UnityEngine::ProBuilder::Edge  value) ;

/// @brief Method set_local, addr 0x46756e8, size 0x8, virtual false, abstract: false, final false
