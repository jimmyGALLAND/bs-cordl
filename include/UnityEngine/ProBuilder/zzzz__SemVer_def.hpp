...
/// @brief Method CompareTo, addr 0x46a1f80, size 0x64, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Object*  obj) ;

/// @brief Method CompareTo, addr 0x46a1fe4, size 0x1ac, virtual true, abstract: false, final true
inline int32_t CompareTo(::UnityEngine::ProBuilder::SemVer*  version) ;

/// @brief Method Equals, addr 0x46a1b48, size 0x70, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method Equals, addr 0x46a1bb8, size 0x200, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::ProBuilder::SemVer*  version) ;

/// @brief Method GetBuildNumber, addr 0x46a2710, size 0xc4, virtual false, abstract: false, final false
static inline int32_t GetBuildNumber(::StringW  input) ;

/// @brief Method GetHashCode, addr 0x46a1db8, size 0x1c8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IsValid, addr 0x46a1b18, size 0x30, virtual false, abstract: false, final false
inline bool IsValid() ;
...
/// @brief Method ToString, addr 0x46a24e0, size 0x230, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x46a22b0, size 0x230, virtual false, abstract: false, final false
inline ::StringW ToString(::StringW  format) ;

/// @brief Method TryGetVersionInfo, addr 0x46a173c, size 0x3dc, virtual false, abstract: false, final false
static inline bool TryGetVersionInfo(::StringW  input, ByRef<::UnityEngine::ProBuilder::SemVer*>  version) ;

/// @brief Method WrapNoValue, addr 0x46a2190, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x46a1660, size 0x34, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x46a1694, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(::StringW  formatted, ::StringW  date) ;

/// @brief Method .ctor, addr 0x46a15f4, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(int32_t  major, int32_t  minor, int32_t  patch, int32_t  build, ::StringW  type, ::StringW  date, ::StringW  metadata) ;

/// @brief Method get_MajorMinorPatch, addr 0x46a1570, size 0x84, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::SemVer* get_MajorMinorPatch() ;

/// @brief Method get_build, addr 0x46a1478, size 0x8, virtual false, abstract: false, final false
inline int32_t get_build() ;

/// @brief Method get_date, addr 0x46a1520, size 0x50, virtual false, abstract: false, final false
inline ::StringW get_date() ;

/// @brief Method get_major, addr 0x46a1460, size 0x8, virtual false, abstract: false, final false
inline int32_t get_major() ;

/// @brief Method get_metadata, addr 0x46a14d0, size 0x50, virtual false, abstract: false, final false
inline ::StringW get_metadata() ;

/// @brief Method get_minor, addr 0x46a1468, size 0x8, virtual false, abstract: false, final false
inline int32_t get_minor() ;

/// @brief Method get_patch, addr 0x46a1470, size 0x8, virtual false, abstract: false, final false
inline int32_t get_patch() ;

/// @brief Method get_type, addr 0x46a1480, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x46a21a0, size 0x14, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::ProBuilder::SemVer*  left, ::UnityEngine::ProBuilder::SemVer*  right) ;

/// @brief Method op_GreaterThan, addr 0x46a2200, size 0x1c, virtual false, abstract: false, final false
static inline bool op_GreaterThan(::UnityEngine::ProBuilder::SemVer*  left, ::UnityEngine::ProBuilder::SemVer*  right) ;

/// @brief Method op_GreaterThanOrEqual, addr 0x46a225c, size 0x54, virtual false, abstract: false, final false
static inline bool op_GreaterThanOrEqual(::UnityEngine::ProBuilder::SemVer*  left, ::UnityEngine::ProBuilder::SemVer*  right) ;

/// @brief Method op_Inequality, addr 0x46a21b4, size 0x28, virtual false, abstract: false, final false
static inline bool op_Inequality(::UnityEngine::ProBuilder::SemVer*  left, ::UnityEngine::ProBuilder::SemVer*  right) ;

/// @brief Method op_LessThan, addr 0x46a21dc, size 0x24, virtual false, abstract: false, final false
static inline bool op_LessThan(::UnityEngine::ProBuilder::SemVer*  left, ::UnityEngine::ProBuilder::SemVer*  right) ;

/// @brief Method op_LessThanOrEqual, addr 0x46a221c, size 0x40, virtual false, abstract: false, final false
