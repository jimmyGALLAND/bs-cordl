...
/// @brief Method CacheDistinctIndexes, addr 0x4676db4, size 0x74, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> CacheDistinctIndexes() ;

/// @brief Method CacheEdges, addr 0x4676eb4, size 0x354, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::ProBuilder::Edge,::Array<::UnityEngine::ProBuilder::Edge>*> CacheEdges() ;

/// @brief Method Contains, addr 0x46776cc, size 0x94, virtual false, abstract: false, final false
inline bool Contains(int32_t  a, int32_t  b, int32_t  c) ;

/// @brief Method CopyFrom, addr 0x467758c, size 0x140, virtual false, abstract: false, final false
inline void CopyFrom(::UnityEngine::ProBuilder::Face*  other) ;

/// @brief Method GetDistinctIndices, addr 0x46781f8, size 0x3e0, virtual false, abstract: false, final false
...
/// @brief Method GetIndices, addr 0x4677e3c, size 0x3bc, virtual false, abstract: false, final false
...
/// @brief Method InvalidateCache, addr 0x4676c2c, size 0x8, virtual false, abstract: false, final false
inline void InvalidateCache() ;

/// @brief Method IsQuad, addr 0x4677760, size 0x48, virtual false, abstract: false, final false
inline bool IsQuad() ;
...
/// @brief Method Reverse, addr 0x4677dec, size 0x50, virtual false, abstract: false, final false
inline void Reverse() ;

/// @brief Method SetIndexes, addr 0x4676cb0, size 0x104, virtual false, abstract: false, final false
inline void SetIndexes(::System::Collections::Generic::IEnumerable_1<int32_t>*  indices) ;

/// @brief Method ShiftIndexes, addr 0x4677cf4, size 0x44, virtual false, abstract: false, final false
inline void ShiftIndexes(int32_t  offset) ;

/// @brief Method ShiftIndexesToZero, addr 0x4677d88, size 0x64, virtual false, abstract: false, final false
inline void ShiftIndexesToZero() ;

/// @brief Method SmallestIndexValue, addr 0x4677d38, size 0x50, virtual false, abstract: false, final false
inline int32_t SmallestIndexValue() ;

/// @brief Method ToQuad, addr 0x46777a8, size 0x380, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> ToQuad() ;

/// @brief Method ToString, addr 0x4677b28, size 0x1cc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryGetNextEdge, addr 0x46785d8, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4677314, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4677330, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IEnumerable_1<int32_t>*  indices) ;

/// @brief Method .ctor, addr 0x4677560, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ProBuilder::Face*  other) ;

/// @brief Method .ctor, addr 0x46773d4, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x467749c, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method get_Item, addr 0x46772e4, size 0x30, virtual false, abstract: false, final false
inline int32_t get_Item(int32_t  i) ;

/// @brief Method get_distinctIndexes, addr 0x4676e28, size 0x8c, virtual false, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<int32_t>* get_distinctIndexes() ;

/// @brief Method get_distinctIndexesInternal, addr 0x46764f8, size 0x14, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> get_distinctIndexesInternal() ;

/// @brief Method get_edges, addr 0x4677208, size 0x8c, virtual false, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::UnityEngine::ProBuilder::Edge>* get_edges() ;

/// @brief Method get_edgesInternal, addr 0x4676a48, size 0x14, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::ProBuilder::Edge,::Array<::UnityEngine::ProBuilder::Edge>*> get_edgesInternal() ;

/// @brief Method get_indexes, addr 0x4676c34, size 0x7c, virtual false, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<int32_t>* get_indexes() ;

/// @brief Method get_indexesInternal, addr 0x4676b68, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> get_indexesInternal() ;

/// @brief Method get_manualUV, addr 0x4676b44, size 0x8, virtual false, abstract: false, final false
inline bool get_manualUV() ;

/// @brief Method get_material, addr 0x46772a4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_material() ;

/// @brief Method get_smoothingGroup, addr 0x4677294, size 0x8, virtual false, abstract: false, final false
inline int32_t get_smoothingGroup() ;

/// @brief Method get_submeshIndex, addr 0x46772b4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_submeshIndex() ;

/// @brief Method get_textureGroup, addr 0x4676b58, size 0x8, virtual false, abstract: false, final false
inline int32_t get_textureGroup() ;

/// @brief Method get_uv, addr 0x46772c4, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::AutoUnwrapSettings get_uv() ;

/// @brief Method set_indexesInternal, addr 0x4676b70, size 0xbc, virtual false, abstract: false, final false
inline void set_indexesInternal(::ArrayW<int32_t,::Array<int32_t>*>  value) ;

/// @brief Method set_manualUV, addr 0x4676b4c, size 0xc, virtual false, abstract: false, final false
inline void set_manualUV(bool  value) ;

/// @brief Method set_material, addr 0x46772ac, size 0x8, virtual false, abstract: false, final false
inline void set_material(::UnityEngine::Material*  value) ;

/// @brief Method set_smoothingGroup, addr 0x467729c, size 0x8, virtual false, abstract: false, final false
inline void set_smoothingGroup(int32_t  value) ;

/// @brief Method set_submeshIndex, addr 0x46772bc, size 0x8, virtual false, abstract: false, final false
inline void set_submeshIndex(int32_t  value) ;

/// @brief Method set_textureGroup, addr 0x4676b60, size 0x8, virtual false, abstract: false, final false
inline void set_textureGroup(int32_t  value) ;

/// @brief Method set_uv, addr 0x46772d4, size 0x10, virtual false, abstract: false, final false
