...
/// @brief Method Equals, addr 0x46b4768, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x46b4758, size 0x10, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::ProBuilder::Vector3Mask  other) ;

/// @brief Method GetHashCode, addr 0x46b4810, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x46b41c4, size 0x110, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x46b41bc, size 0x8, virtual false, abstract: false, final false
inline void _ctor(uint8_t  mask) ;

/// @brief Method .ctor, addr 0x46b4188, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Vector3  v, float_t  epsilon) ;

static inline ::UnityEngine::ProBuilder::Vector3Mask getStaticF_XYZ() ;

/// @brief Method get_Item, addr 0x46b4694, size 0x58, virtual false, abstract: false, final false
inline float_t get_Item(int32_t  i) ;

/// @brief Method get_active, addr 0x46b42d4, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_active() ;

/// @brief Method get_x, addr 0x46b4140, size 0x18, virtual false, abstract: false, final false
inline float_t get_x() ;

/// @brief Method get_y, addr 0x46b4158, size 0x18, virtual false, abstract: false, final false
inline float_t get_y() ;

/// @brief Method get_z, addr 0x46b4170, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method op_BitwiseAnd, addr 0x46b43a4, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_BitwiseOr, addr 0x46b4398, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x46b461c, size 0x10, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::ProBuilder::Vector3Mask  left, ::UnityEngine::ProBuilder::Vector3Mask  right) ;

/// @brief Method op_ExclusiveOr, addr 0x46b43b0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Explicit, addr 0x46b4360, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x46b42f0, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 op_Implicit___UnityEngine__Vector3(::UnityEngine::ProBuilder::Vector3Mask  mask) ;

/// @brief Method op_Inequality, addr 0x46b462c, size 0x68, virtual false, abstract: false, final false
static inline bool op_Inequality(::UnityEngine::ProBuilder::Vector3Mask  left, ::UnityEngine::ProBuilder::Vector3Mask  right) ;

/// @brief Method op_Multiply, addr 0x46b4444, size 0x98, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 op_Multiply(::UnityEngine::ProBuilder::Vector3Mask  mask, ::UnityEngine::Vector3  value) ;

/// @brief Method op_Multiply, addr 0x46b43bc, size 0x88, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 op_Multiply(::UnityEngine::ProBuilder::Vector3Mask  mask, float_t  value) ;

/// @brief Method op_Multiply, addr 0x46b44dc, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method set_Item, addr 0x46b46ec, size 0x6c, virtual false, abstract: false, final false
