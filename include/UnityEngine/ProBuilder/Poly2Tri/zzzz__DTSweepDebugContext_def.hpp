...
/// @brief Method Clear, addr 0x466baf8, size 0x44, virtual true, abstract: false, final false
inline void Clear() ;
...
/// @brief Method .ctor, addr 0x466b3fc, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ProBuilder::Poly2Tri::DTSweepContext*  tcx) ;

/// @brief Method get_ActiveConstraint, addr 0x466bac0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint* get_ActiveConstraint() ;

/// @brief Method get_ActiveNode, addr 0x466bab8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode* get_ActiveNode() ;

/// @brief Method get_ActivePoint, addr 0x466ba64, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint* get_ActivePoint() ;

/// @brief Method get_IsDebugContext, addr 0x466baf0, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDebugContext() ;

/// @brief Method get_PrimaryTriangle, addr 0x466ba54, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle* get_PrimaryTriangle() ;

/// @brief Method get_SecondaryTriangle, addr 0x466ba5c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle* get_SecondaryTriangle() ;

/// @brief Method set_ActiveConstraint, addr 0x466847c, size 0x4c, virtual false, abstract: false, final false
inline void set_ActiveConstraint(::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint*  value) ;

/// @brief Method set_ActiveNode, addr 0x4668e98, size 0x4c, virtual false, abstract: false, final false
inline void set_ActiveNode(::UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode*  value) ;

/// @brief Method set_ActivePoint, addr 0x466ba6c, size 0x4c, virtual false, abstract: false, final false
inline void set_ActivePoint(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  value) ;

/// @brief Method set_PrimaryTriangle, addr 0x4669684, size 0x4c, virtual false, abstract: false, final false
inline void set_PrimaryTriangle(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*  value) ;

/// @brief Method set_SecondaryTriangle, addr 0x466a770, size 0x4c, virtual false, abstract: false, final false
