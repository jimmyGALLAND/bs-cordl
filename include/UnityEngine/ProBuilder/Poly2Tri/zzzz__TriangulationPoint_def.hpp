...
/// @brief Field <Edges>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__Edges_k__BackingField, put=__cordl_internal_set__Edges_k__BackingField)) ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint*>*  _Edges_k__BackingField;

/// @brief Method AddEdge, addr 0x466b1a0, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x466c4d0, size 0x108, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint*>*> const& __cordl_internal_get__Edges_k__BackingField() const;
...
/// @brief Method .ctor, addr 0x46660a4, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(double_t  x, double_t  y, int32_t  index) ;

/// @brief Method get_Edges, addr 0x466c4c0, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint*>* get_Edges() ;

/// @brief Method get_HasEdges, addr 0x46683f0, size 0x10, virtual false, abstract: false, final false
inline bool get_HasEdges() ;

/// @brief Method get_Xf, addr 0x466c5d8, size 0xc, virtual false, abstract: false, final false
inline float_t get_Xf() ;

/// @brief Method get_Yf, addr 0x466c5f0, size 0xc, virtual false, abstract: false, final false
inline float_t get_Yf() ;

/// @brief Method set_Edges, addr 0x466c4c8, size 0x8, virtual false, abstract: false, final false
inline void set_Edges(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint*>*  value) ;

/// @brief Method set_Xf, addr 0x466c5e4, size 0xc, virtual false, abstract: false, final false
inline void set_Xf(float_t  value) ;

/// @brief Method set_Yf, addr 0x466c5fc, size 0xc, virtual false, abstract: false, final false
