...
/// @brief Method AddHole, addr 0x46653b4, size 0xec, virtual false, abstract: false, final false
inline void AddHole(::UnityEngine::ProBuilder::Poly2Tri::Polygon*  poly) ;

/// @brief Method AddPoint, addr 0x46659cc, size 0xc0, virtual false, abstract: false, final false
inline void AddPoint(::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint*  p) ;

/// @brief Method AddPoints, addr 0x46655b8, size 0x414, virtual false, abstract: false, final false
inline void AddPoints(::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint*>*  list) ;

/// @brief Method AddSteinerPoint, addr 0x46651bc, size 0xec, virtual false, abstract: false, final false
inline void AddSteinerPoint(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  point) ;

/// @brief Method AddSteinerPoints, addr 0x46652a8, size 0xa0, virtual false, abstract: false, final false
inline void AddSteinerPoints(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*>*  points) ;

/// @brief Method AddTriangle, addr 0x4665b18, size 0xa4, virtual true, abstract: false, final true
inline void AddTriangle(::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*  t) ;

/// @brief Method AddTriangles, addr 0x4665bbc, size 0x58, virtual true, abstract: false, final true
inline void AddTriangles(::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*>*  list) ;

/// @brief Method ClearSteinerPoints, addr 0x4665348, size 0x6c, virtual false, abstract: false, final false
inline void ClearSteinerPoints() ;

/// @brief Method ClearTriangles, addr 0x4665c14, size 0x6c, virtual true, abstract: false, final true
inline void ClearTriangles() ;

/// @brief Method InsertPointAfter, addr 0x46654a0, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method Prepare, addr 0x4665c80, size 0x3e8, virtual true, abstract: false, final true
inline void Prepare(::UnityEngine::ProBuilder::Poly2Tri::TriangulationContext*  tcx) ;

/// @brief Method RemovePoint, addr 0x4665a8c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x46651b0, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4665128, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint*>*  points) ;

/// @brief Method .ctor, addr 0x4664d78, size 0x3b0, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint*>*  points) ;

/// @brief Method get_Holes, addr 0x4665b10, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::Polygon*>* get_Holes() ;

/// @brief Method get_Points, addr 0x4665b00, size 0x8, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*>* get_Points() ;

/// @brief Method get_Triangles, addr 0x4665b08, size 0x8, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*>* get_Triangles() ;

/// @brief Method get_TriangulationMode, addr 0x46651b4, size 0x8, virtual true, abstract: false, final true
