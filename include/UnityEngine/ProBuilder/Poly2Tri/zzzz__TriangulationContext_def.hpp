...
/// @brief Field Triangles, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_Triangles, put=__cordl_internal_set_Triangles)) ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle*>*  Triangles;
...
/// @brief Field <DebugContext>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__DebugContext_k__BackingField, put=__cordl_internal_set__DebugContext_k__BackingField)) ::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext*  _DebugContext_k__BackingField;
...
/// @brief Field <Triangulatable>k__BackingField, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__Triangulatable_k__BackingField, put=__cordl_internal_set__Triangulatable_k__BackingField)) ::UnityEngine::ProBuilder::Poly2Tri::Triangulatable*  _Triangulatable_k__BackingField;

/// @brief Field <TriangulationMode>k__BackingField, offset 0x28, size 0x4 
 __declspec(property(get=__cordl_internal_get__TriangulationMode_k__BackingField, put=__cordl_internal_set__TriangulationMode_k__BackingField)) ::UnityEngine::ProBuilder::Poly2Tri::TriangulationMode  _TriangulationMode_k__BackingField;

/// @brief Method Clear, addr 0x466b5c0, size 0x80, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method Done, addr 0x46682d4, size 0x10, virtual false, abstract: false, final false
inline void Done() ;
...
/// @brief Method PrepareTriangulation, addr 0x466b8dc, size 0x108, virtual true, abstract: false, final false
inline void PrepareTriangulation(::UnityEngine::ProBuilder::Poly2Tri::Triangulatable*  t) ;

/// @brief Method Update, addr 0x466864c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x466b2bc, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_DTDebugContext, addr 0x4668400, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::DTSweepDebugContext* get_DTDebugContext() ;

/// @brief Method get_DebugContext, addr 0x466c46c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext* get_DebugContext() ;

/// @brief Method get_IsDebugEnabled, addr 0x466c4ac, size 0x8, virtual true, abstract: false, final false
inline bool get_IsDebugEnabled() ;

/// @brief Method get_StepCount, addr 0x466c49c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_StepCount() ;

/// @brief Method get_Triangulatable, addr 0x466c48c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::Triangulatable* get_Triangulatable() ;

/// @brief Method get_TriangulationMode, addr 0x466c47c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::TriangulationMode get_TriangulationMode() ;

/// @brief Method set_DebugContext, addr 0x466c474, size 0x8, virtual false, abstract: false, final false
inline void set_DebugContext(::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext*  value) ;

/// @brief Method set_IsDebugEnabled, addr 0x466c4b4, size 0xc, virtual true, abstract: false, final false
inline void set_IsDebugEnabled(bool  value) ;

/// @brief Method set_StepCount, addr 0x466c4a4, size 0x8, virtual false, abstract: false, final false
inline void set_StepCount(int32_t  value) ;

/// @brief Method set_Triangulatable, addr 0x466c494, size 0x8, virtual false, abstract: false, final false
inline void set_Triangulatable(::UnityEngine::ProBuilder::Poly2Tri::Triangulatable*  value) ;

/// @brief Method set_TriangulationMode, addr 0x466c484, size 0x8, virtual false, abstract: false, final false
