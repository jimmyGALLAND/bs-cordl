...
/// @brief Method .ctor, addr 0x4667b1c, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*  point) ;

/// @brief Method get_HasNext, addr 0x4667b54, size 0x10, virtual false, abstract: false, final false
inline bool get_HasNext() ;

/// @brief Method get_HasPrev, addr 0x4667b64, size 0x10, virtual false, abstract: false, final false
