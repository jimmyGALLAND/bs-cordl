...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext::*)(::UnityEngine::ProBuilder::Poly2Tri::TriangulationContext*)>(&::UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x466bac8;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ProBuilder::Poly2Tri::TriangulationContext*> const& UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext::__cordl_internal_get__tcx() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____tcx;
}
