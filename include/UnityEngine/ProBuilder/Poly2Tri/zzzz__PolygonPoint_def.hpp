...
/// @brief Field <Previous>k__BackingField, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__Previous_k__BackingField, put=__cordl_internal_set__Previous_k__BackingField)) ::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint*  _Previous_k__BackingField;
...
/// @brief Method .ctor, addr 0x4666068, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(double_t  x, double_t  y, int32_t  index) ;

/// @brief Method get_Next, addr 0x46660e0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint* get_Next() ;

/// @brief Method get_Previous, addr 0x46660f0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint* get_Previous() ;

/// @brief Method set_Next, addr 0x46660e8, size 0x8, virtual false, abstract: false, final false
inline void set_Next(::UnityEngine::ProBuilder::Poly2Tri::PolygonPoint*  value) ;

/// @brief Method set_Previous, addr 0x46660f8, size 0x8, virtual false, abstract: false, final false
