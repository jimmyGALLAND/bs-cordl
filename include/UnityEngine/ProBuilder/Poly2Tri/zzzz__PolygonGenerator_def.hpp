...
/// @brief Method RandomCircleSweep, addr 0x466ca2c, size 0x2ec, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::Poly2Tri::Polygon* RandomCircleSweep(double_t  scale, int32_t  vertexCount) ;

/// @brief Method RandomCircleSweep2, addr 0x466cd18, size 0x254, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::Poly2Tri::Polygon* RandomCircleSweep2(double_t  scale, int32_t  vertexCount) ;

/// @brief Method .ctor, addr 0x466cf6c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
