...
/// @brief Method Clear, addr 0x468c4dc, size 0xe0, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method DeleteKey, addr 0x468bcc8, size 0x234, virtual false, abstract: false, final false
...
/// @brief Method GetBool, addr 0x468befc, size 0x88, virtual false, abstract: false, final false
inline bool GetBool(::StringW  key, bool  fallback) ;

/// @brief Method GetBoolDictionary, addr 0x468c4ac, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,bool>* GetBoolDictionary() ;

/// @brief Method GetColor, addr 0x468c0f8, size 0xa8, virtual false, abstract: false, final false
inline ::UnityEngine::Color GetColor(::StringW  key, ::UnityEngine::Color  fallback) ;

/// @brief Method GetColorDictionary, addr 0x468c4cc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::Color>* GetColorDictionary() ;

/// @brief Method GetFloat, addr 0x468c000, size 0x7c, virtual false, abstract: false, final false
inline float_t GetFloat(::StringW  key, float_t  fallback) ;

/// @brief Method GetFloatDictionary, addr 0x468c4bc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,float_t>* GetFloatDictionary() ;

/// @brief Method GetInt, addr 0x468bf84, size 0x7c, virtual false, abstract: false, final false
inline int32_t GetInt(::StringW  key, int32_t  fallback) ;

/// @brief Method GetIntDictionary, addr 0x468c4b4, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,int32_t>* GetIntDictionary() ;

/// @brief Method GetMaterial, addr 0x468c1a0, size 0x7c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetMaterial(::StringW  key, ::UnityEngine::Material*  fallback) ;

/// @brief Method GetMaterialDictionary, addr 0x468c4d4, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,::UnityW<::UnityEngine::Material>>* GetMaterialDictionary() ;

/// @brief Method GetString, addr 0x468c07c, size 0x7c, virtual false, abstract: false, final false
inline ::StringW GetString(::StringW  key, ::StringW  fallback) ;

/// @brief Method GetStringDictionary, addr 0x468c4c4, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>* GetStringDictionary() ;

/// @brief Method HasKey, addr 0x468bb84, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method OnAfterDeserialize, addr 0x468b6b8, size 0x3c8, virtual true, abstract: false, final true
inline void OnAfterDeserialize() ;

/// @brief Method OnBeforeSerialize, addr 0x468b3a4, size 0x314, virtual true, abstract: false, final true
...
/// @brief Method SetBool, addr 0x468c21c, size 0x68, virtual false, abstract: false, final false
inline void SetBool(::StringW  key, bool  value) ;

/// @brief Method SetColor, addr 0x468c3bc, size 0x88, virtual false, abstract: false, final false
inline void SetColor(::StringW  key, ::UnityEngine::Color  value) ;

/// @brief Method SetDefaultValues, addr 0x468ba80, size 0x104, virtual true, abstract: false, final true
inline void SetDefaultValues() ;

/// @brief Method SetFloat, addr 0x468c2ec, size 0x68, virtual false, abstract: false, final false
inline void SetFloat(::StringW  key, float_t  value) ;

/// @brief Method SetInt, addr 0x468c284, size 0x68, virtual false, abstract: false, final false
inline void SetInt(::StringW  key, int32_t  value) ;

/// @brief Method SetMaterial, addr 0x468c444, size 0x68, virtual false, abstract: false, final false
inline void SetMaterial(::StringW  key, ::UnityEngine::Material*  value) ;

/// @brief Method SetString, addr 0x468c354, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x468c5bc, size 0x1d4, virtual false, abstract: false, final false
inline void _ctor() ;
