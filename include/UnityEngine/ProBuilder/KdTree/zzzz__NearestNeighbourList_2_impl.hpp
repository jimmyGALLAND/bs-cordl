...
template<typename TItem,typename TDistance>
constexpr ::UnityEngine::ProBuilder::KdTree::INearestNeighbourList_2<TItem,TDistance>* UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem,TDistance>::i___UnityEngine__ProBuilder__KdTree__INearestNeighbourList_2_TItem_TDistance_() noexcept {
return static_cast<::UnityEngine::ProBuilder::KdTree::INearestNeighbourList_2<TItem,TDistance>*>(static_cast<void*>(this));
}
template<typename TItem,typename TDistance>
...
template<typename TItem,typename TDistance>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ProBuilder::KdTree::PriorityQueue_2<TItem,TDistance>*> const& UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem,TDistance>::__cordl_internal_get_queue() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___queue;
}
template<typename TItem,typename TDistance>
...
template<typename TItem,typename TDistance>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ProBuilder::KdTree::ITypeMath_1<TDistance>*> const& UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem,TDistance>::__cordl_internal_get_distanceMath() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___distanceMath;
}
template<typename TItem,typename TDistance>
...
template<typename TItem,typename TDistance>
constexpr int32_t& UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem,TDistance>::__cordl_internal_get_maxCapacity()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___maxCapacity;
}
template<typename TItem,typename TDistance>
constexpr int32_t const& UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem,TDistance>::__cordl_internal_get_maxCapacity() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___maxCapacity;
}
template<typename TItem,typename TDistance>
constexpr void UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem,TDistance>::__cordl_internal_set_maxCapacity(int32_t  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::ProBuilder::KdTree::ITypeMath_1<TDistance>*>::get()}
                    )));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "Add",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<TItem>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<TDistance>::get()}
                    )));
...
// Ctor Parameters []
template<typename TItem,typename TDistance>
constexpr ::UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem,TDistance>::NearestNeighbourList_2()   {
}
