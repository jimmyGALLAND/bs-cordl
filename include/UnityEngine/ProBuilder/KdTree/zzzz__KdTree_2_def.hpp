...
/// @brief Field right, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_right, put=__cordl_internal_set_right)) ::System::Collections::Generic::Stack_1<::UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey,TValue>*>*  right;
...
/// @brief Field <addLeft>5__2, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__addLeft_5__2, put=__cordl_internal_set__addLeft_5__2)) ::System::Action_1<::UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey,TValue>*>*  _addLeft_5__2;

/// @brief Field <addRight>5__3, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__addRight_5__3, put=__cordl_internal_set__addRight_5__3)) ::System::Action_1<::UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey,TValue>*>*  _addRight_5__3;
...
/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.ProBuilder.KdTree.KdTreeNode<TKey,TValue>>.get_Current, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
...
constexpr ::System::Collections::Generic::IEnumerator_1<::UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey,TValue>*>* i___System__Collections__Generic__IEnumerator_1___UnityEngine__ProBuilder__KdTree__KdTreeNode_2_TKey_TValue___() noexcept;
...
/// @brief Field <AddDuplicateBehavior>k__BackingField, offset 0x28, size 0x4 
 __declspec(property(get=__cordl_internal_get__AddDuplicateBehavior_k__BackingField, put=__cordl_internal_set__AddDuplicateBehavior_k__BackingField)) ::UnityEngine::ProBuilder::KdTree::AddDuplicateBehavior  _AddDuplicateBehavior_k__BackingField;
...
constexpr ::System::Collections::Generic::IEnumerable_1<::UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey,TValue>*>* i___System__Collections__Generic__IEnumerable_1___UnityEngine__ProBuilder__KdTree__KdTreeNode_2_TKey_TValue___() noexcept;
