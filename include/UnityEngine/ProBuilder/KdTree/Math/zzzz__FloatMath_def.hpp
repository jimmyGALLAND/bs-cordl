...
/// @brief Method Add, addr 0x4664538, size 0x8, virtual true, abstract: false, final false
inline float_t Add(float_t  a, float_t  b) ;

/// @brief Method AreEqual, addr 0x46644f4, size 0xc, virtual true, abstract: false, final false
inline bool AreEqual(float_t  a, float_t  b) ;

/// @brief Method Compare, addr 0x46644d4, size 0x20, virtual true, abstract: false, final false
inline int32_t Compare(float_t  a, float_t  b) ;

/// @brief Method DistanceSquaredBetweenPoints, addr 0x4664550, size 0x100, virtual true, abstract: false, final false
inline float_t DistanceSquaredBetweenPoints(::ArrayW<float_t,::Array<float_t>*>  a, ::ArrayW<float_t,::Array<float_t>*>  b) ;

/// @brief Method Multiply, addr 0x4664548, size 0x8, virtual true, abstract: false, final false
inline float_t Multiply(float_t  a, float_t  b) ;

static inline ::UnityEngine::ProBuilder::KdTree::Math::FloatMath* New_ctor() ;

/// @brief Method Subtract, addr 0x4664540, size 0x8, virtual true, abstract: false, final false
inline float_t Subtract(float_t  a, float_t  b) ;

/// @brief Method .ctor, addr 0x4664650, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_MaxValue, addr 0x466450c, size 0xc, virtual true, abstract: false, final false
inline float_t get_MaxValue() ;

/// @brief Method get_MinValue, addr 0x4664500, size 0xc, virtual true, abstract: false, final false
inline float_t get_MinValue() ;

/// @brief Method get_NegativeInfinity, addr 0x4664520, size 0xc, virtual true, abstract: false, final false
inline float_t get_NegativeInfinity() ;

/// @brief Method get_PositiveInfinity, addr 0x466452c, size 0xc, virtual true, abstract: false, final false
inline float_t get_PositiveInfinity() ;

/// @brief Method get_Zero, addr 0x4664518, size 0x8, virtual true, abstract: false, final false
