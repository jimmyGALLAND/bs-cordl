...
/// @brief Method Equals, addr 0x4689e2c, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x4689ebc, size 0x98, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::ProBuilder::Normal  other) ;

/// @brief Method GetHashCode, addr 0x4689f54, size 0x64, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_bitangent, addr 0x4689e14, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_bitangent() ;

/// @brief Method get_normal, addr 0x4689de4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_normal() ;

/// @brief Method get_tangent, addr 0x4689dfc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x4689fb8, size 0x30, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::ProBuilder::Normal  a, ::UnityEngine::ProBuilder::Normal  b) ;

/// @brief Method op_Inequality, addr 0x4689fe8, size 0x48, virtual false, abstract: false, final false
static inline bool op_Inequality(::UnityEngine::ProBuilder::Normal  a, ::UnityEngine::ProBuilder::Normal  b) ;

/// @brief Method set_bitangent, addr 0x4689e20, size 0xc, virtual false, abstract: false, final false
inline void set_bitangent(::UnityEngine::Vector3  value) ;

/// @brief Method set_normal, addr 0x4689df0, size 0xc, virtual false, abstract: false, final false
inline void set_normal(::UnityEngine::Vector3  value) ;

/// @brief Method set_tangent, addr 0x4689e08, size 0xc, virtual false, abstract: false, final false
