...
/// @brief Method ComputeOutCode, addr 0x4672bf4, size 0x4c, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::__Clipping__OutCode ComputeOutCode(::UnityEngine::Rect  rect, float_t  x, float_t  y) ;

/// @brief Method RectContainsLineSegment, addr 0x4672c40, size 0x1c0, virtual false, abstract: false, final false
