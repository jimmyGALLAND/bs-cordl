...
/// @brief Method Clear, addr 0x469fd50, size 0xac, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method CopyTo, addr 0x469fdfc, size 0x134, virtual false, abstract: false, final false
inline void CopyTo(::UnityEngine::ProBuilder::SceneSelection*  dst) ;

/// @brief Method Equals, addr 0x46a027c, size 0x10c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x46a0190, size 0xec, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::ProBuilder::SceneSelection*  other) ;

/// @brief Method GetHashCode, addr 0x46a0388, size 0x154, virtual true, abstract: false, final false
...
/// @brief Method SetSingleEdge, addr 0x469fcac, size 0xa4, virtual false, abstract: false, final false
inline void SetSingleEdge(::UnityEngine::ProBuilder::Edge  edge) ;

/// @brief Method SetSingleFace, addr 0x469fb2c, size 0xdc, virtual false, abstract: false, final false
inline void SetSingleFace(::UnityEngine::ProBuilder::Face*  face) ;

/// @brief Method SetSingleVertex, addr 0x469fc08, size 0xa4, virtual false, abstract: false, final false
inline void SetSingleVertex(int32_t  vertex) ;

/// @brief Method ToString, addr 0x469ff30, size 0x260, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x469f3b4, size 0x118, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::GameObject*  gameObject) ;

/// @brief Method .ctor, addr 0x469f6ec, size 0xfc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh, ::UnityEngine::ProBuilder::Edge  edge) ;

/// @brief Method .ctor, addr 0x469f7e8, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x469f90c, size 0xfc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh, ::UnityEngine::ProBuilder::Face*  face) ;

/// @brief Method .ctor, addr 0x469fa08, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x469f4cc, size 0xfc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh, int32_t  vertex) ;

/// @brief Method .ctor, addr 0x469f5c8, size 0x124, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh, ::System::Collections::Generic::List_1<int32_t>*  vertexes) ;

/// @brief Method get_edges, addr 0x469f394, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Edge>* get_edges() ;

/// @brief Method get_faces, addr 0x469f3a4, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Face*>* get_faces() ;

/// @brief Method get_vertexes, addr 0x469f384, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x46a04dc, size 0x8, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::ProBuilder::SceneSelection*  left, ::UnityEngine::ProBuilder::SceneSelection*  right) ;

/// @brief Method op_Inequality, addr 0x46a04e4, size 0x1c, virtual false, abstract: false, final false
static inline bool op_Inequality(::UnityEngine::ProBuilder::SceneSelection*  left, ::UnityEngine::ProBuilder::SceneSelection*  right) ;

/// @brief Method set_edges, addr 0x469f39c, size 0x8, virtual false, abstract: false, final false
inline void set_edges(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Edge>*  value) ;

/// @brief Method set_faces, addr 0x469f3ac, size 0x8, virtual false, abstract: false, final false
inline void set_faces(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Face*>*  value) ;

/// @brief Method set_vertexes, addr 0x469f38c, size 0x8, virtual false, abstract: false, final false
