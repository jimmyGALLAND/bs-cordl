...
/// @brief Method GetDefaultMaterial, addr 0x4671a60, size 0x1f0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> GetDefaultMaterial() ;

/// @brief Method GetLegacyDiffuse, addr 0x4672210, size 0x2a0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> GetLegacyDiffuse() ;

/// @brief Method Init, addr 0x46713b0, size 0x6b0, virtual false, abstract: false, final false
...
/// @brief Method get_ShapePreviewMaterial, addr 0x467250c, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> get_ShapePreviewMaterial() ;

/// @brief Method get_colliderMaterial, addr 0x4672000, size 0x108, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> get_colliderMaterial() ;

/// @brief Method get_defaultMaterial, addr 0x4671d2c, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> get_defaultMaterial() ;

/// @brief Method get_edgePickerMaterial, addr 0x4671e9c, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> get_edgePickerMaterial() ;

/// @brief Method get_facePickerMaterial, addr 0x4671de4, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> get_facePickerMaterial() ;

/// @brief Method get_geometryShadersSupported, addr 0x4671cd0, size 0x5c, virtual false, abstract: false, final false
static inline bool get_geometryShadersSupported() ;

/// @brief Method get_noDrawMaterial, addr 0x4672108, size 0x108, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> get_noDrawMaterial() ;

/// @brief Method get_selectionPickerShader, addr 0x4671d88, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Shader> get_selectionPickerShader() ;

/// @brief Method get_triggerMaterial, addr 0x4671ef8, size 0x108, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> get_triggerMaterial() ;

/// @brief Method get_unlitVertexColor, addr 0x46724b0, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> get_unlitVertexColor() ;

/// @brief Method get_vertexPickerMaterial, addr 0x4671e40, size 0x5c, virtual false, abstract: false, final false
