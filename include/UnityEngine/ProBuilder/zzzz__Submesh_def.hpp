...
/// @brief Method GetSubmeshCount, addr 0x46b003c, size 0x6c, virtual false, abstract: false, final false
static inline int32_t GetSubmeshCount(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh) ;

/// @brief Method GetSubmeshes, addr 0x46b00a8, size 0x940, virtual false, abstract: false, final false
...
/// @brief Method MapFaceMaterialsToSubmeshIndex, addr 0x46b09e8, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x46aff34, size 0x108, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x46afe3c, size 0xf8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Mesh*  mesh, int32_t  subMeshIndex) ;

/// @brief Method .ctor, addr 0x46afd7c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_indexes, addr 0x46afc84, size 0x7c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<int32_t>* get_indexes() ;

/// @brief Method get_submeshIndex, addr 0x46afd6c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_submeshIndex() ;

/// @brief Method get_topology, addr 0x46afd5c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::MeshTopology get_topology() ;

/// @brief Method set_indexes, addr 0x46afd00, size 0x5c, virtual false, abstract: false, final false
inline void set_indexes(::System::Collections::Generic::IEnumerable_1<int32_t>*  value) ;

/// @brief Method set_submeshIndex, addr 0x46afd74, size 0x8, virtual false, abstract: false, final false
inline void set_submeshIndex(int32_t  value) ;

/// @brief Method set_topology, addr 0x46afd64, size 0x8, virtual false, abstract: false, final false
