...
/// @brief Method Equals, addr 0x467d620, size 0xc4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  b) ;

/// @brief Method Equals, addr 0x467d458, size 0x94, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::ProBuilder::IntVec3  p) ;

/// @brief Method Equals, addr 0x467d58c, size 0x94, virtual false, abstract: false, final false
inline bool Equals(::UnityEngine::Vector3  p) ;

/// @brief Method GetHashCode, addr 0x467d6e4, size 0x10, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x467d360, size 0xc4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x467d354, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Vector3  vector) ;

/// @brief Method get_x, addr 0x467d33c, size 0x8, virtual false, abstract: false, final false
inline float_t get_x() ;

/// @brief Method get_y, addr 0x467d344, size 0x8, virtual false, abstract: false, final false
inline float_t get_y() ;

/// @brief Method get_z, addr 0x467d34c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x467d424, size 0x34, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::ProBuilder::IntVec3  a, ::UnityEngine::ProBuilder::IntVec3  b) ;

/// @brief Method op_Implicit, addr 0x467d6f8, size 0x4, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::IntVec3 op_Implicit___UnityEngine__ProBuilder__IntVec3(::UnityEngine::Vector3  p) ;

/// @brief Method op_Implicit, addr 0x467d6f4, size 0x4, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 op_Implicit___UnityEngine__Vector3(::UnityEngine::ProBuilder::IntVec3  p) ;

/// @brief Method op_Inequality, addr 0x467d4ec, size 0x38, virtual false, abstract: false, final false
static inline bool op_Inequality(::UnityEngine::ProBuilder::IntVec3  a, ::UnityEngine::ProBuilder::IntVec3  b) ;

/// @brief Method round, addr 0x467d524, size 0x68, virtual false, abstract: false, final false
