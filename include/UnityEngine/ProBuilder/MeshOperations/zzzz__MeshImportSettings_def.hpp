...
/// @brief Method ToString, addr 0x46eaeb8, size 0xd8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x46eaf90, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_quads, addr 0x46eae80, size 0x8, virtual false, abstract: false, final false
inline bool get_quads() ;

/// @brief Method get_smoothing, addr 0x46eae94, size 0x8, virtual false, abstract: false, final false
inline bool get_smoothing() ;

/// @brief Method get_smoothingAngle, addr 0x46eaea8, size 0x8, virtual false, abstract: false, final false
inline float_t get_smoothingAngle() ;

/// @brief Method set_quads, addr 0x46eae88, size 0xc, virtual false, abstract: false, final false
inline void set_quads(bool  value) ;

/// @brief Method set_smoothing, addr 0x46eae9c, size 0xc, virtual false, abstract: false, final false
inline void set_smoothing(bool  value) ;

/// @brief Method set_smoothingAngle, addr 0x46eaeb0, size 0x8, virtual false, abstract: false, final false
