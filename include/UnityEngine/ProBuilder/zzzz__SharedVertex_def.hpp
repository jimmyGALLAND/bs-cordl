...
/// @brief Method <SortedRemoveAndShift>b__26_0, addr 0x46ad028, size 0x44, virtual false, abstract: false, final false
inline bool _SortedRemoveAndShift_b__26_0(::System::Collections::Generic::KeyValuePair_2<int32_t,int32_t>  x) ;

/// @brief Method .ctor, addr 0x46ad020, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Add, addr 0x46aba4c, size 0x60, virtual true, abstract: false, final true
inline void Add(int32_t  item) ;

/// @brief Method Clear, addr 0x46abaac, size 0x50, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method Contains, addr 0x46abafc, size 0x64, virtual true, abstract: false, final true
inline bool Contains(int32_t  item) ;

/// @brief Method CopyTo, addr 0x46abb60, size 0x1c, virtual true, abstract: false, final true
inline void CopyTo(::ArrayW<int32_t,::Array<int32_t>*>  array, int32_t  arrayIndex) ;

/// @brief Method GetEnumerator, addr 0x46ab940, size 0xa0, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerator_1<int32_t>* GetEnumerator() ;

/// @brief Method GetSharedVertexLookup, addr 0x46abc2c, size 0x410, virtual false, abstract: false, final false
...
/// @brief Method GetSharedVerticesWithPositions, addr 0x46aabfc, size 0x5a4, virtual false, abstract: false, final false
...
/// @brief Method Remove, addr 0x46abb7c, size 0x94, virtual true, abstract: false, final true
inline bool Remove(int32_t  item) ;

/// @brief Method RemoveAndShift, addr 0x46ac8b0, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method SetCoincident, addr 0x46acc9c, size 0x328, virtual false, abstract: false, final false
...
/// @brief Method ShiftIndexes, addr 0x46ac03c, size 0x40, virtual false, abstract: false, final false
inline void ShiftIndexes(int32_t  offset) ;

/// @brief Method SortedRemoveAndShift, addr 0x46ac958, size 0x344, virtual false, abstract: false, final false
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x46aba48, size 0x4, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method ToSharedVertices, addr 0x46ac75c, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method ToSharedVertices, addr 0x46ac07c, size 0x6e0, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x46ab9e0, size 0x68, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x46aab50, size 0xac, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IEnumerable_1<int32_t>*  indexes) ;

/// @brief Method .ctor, addr 0x46ab828, size 0xcc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ProBuilder::SharedVertex*  sharedVertex) ;

/// @brief Method get_Count, addr 0x46ab8f4, size 0x1c, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_IsReadOnly, addr 0x46abc10, size 0x1c, virtual true, abstract: false, final true
inline bool get_IsReadOnly() ;

/// @brief Method get_Item, addr 0x469f2a4, size 0x30, virtual false, abstract: false, final false
inline int32_t get_Item(int32_t  i) ;

/// @brief Method get_arrayInternal, addr 0x46ab820, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Item, addr 0x46ab910, size 0x30, virtual false, abstract: false, final false
