...
static __declspec(property(get=getStaticF_s_cachedFacesIndex, put=setStaticF_s_cachedFacesIndex)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::ProBuilder::Face*,int32_t>*  s_cachedFacesIndex;
...
/// @brief Method Dijkstra, addr 0x46a08c0, size 0x700, virtual false, abstract: false, final false
static inline ::ArrayW<int32_t,::Array<int32_t>*> Dijkstra(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh, int32_t  start) ;

/// @brief Method GetMinimalPath, addr 0x46a07a4, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method GetPath, addr 0x46a0500, size 0x2a4, virtual false, abstract: false, final false
...
/// @brief Method GetWeight, addr 0x46a0fc0, size 0x414, virtual false, abstract: false, final false
