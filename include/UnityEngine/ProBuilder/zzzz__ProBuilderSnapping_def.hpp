...
public:
// Declarations
/// @brief Method GetSnappingMaskBasedOnNormalVector, addr 0x46959c4, size 0xd0, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 GetSnappingMaskBasedOnNormalVector(::UnityEngine::Vector3  normal) ;

/// @brief Method IsCardinalDirection, addr 0x46952dc, size 0x1dc, virtual false, abstract: false, final false
static inline bool IsCardinalDirection(::UnityEngine::Vector3  direction) ;

/// @brief Method Snap, addr 0x4695558, size 0xa0, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 Snap(::UnityEngine::Vector3  val, ::UnityEngine::Vector3  snap) ;

/// @brief Method Snap, addr 0x46954b8, size 0xa0, virtual false, abstract: false, final false
static inline float_t Snap(float_t  val, float_t  snap) ;

/// @brief Method SnapValueOnRay, addr 0x4695a94, size 0x6f8, virtual false, abstract: false, final false
...
/// @brief Method SnapVertices, addr 0x46955f8, size 0x3cc, virtual false, abstract: false, final false
