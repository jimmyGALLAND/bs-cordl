...
static __declspec(property(get=getStaticF_ColorNameLookup, put=setStaticF_ColorNameLookup)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::ProBuilder::CIELabColor*>*  ColorNameLookup;

/// @brief Method CIELabFromRGB, addr 0x4674bc8, size 0x24, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::CIELabColor* CIELabFromRGB(float_t  R, float_t  G, float_t  B, float_t  Scale) ;

/// @brief Method DeltaE, addr 0x4674810, size 0x48, virtual false, abstract: false, final false
static inline float_t DeltaE(::UnityEngine::ProBuilder::CIELabColor*  lhs, ::UnityEngine::ProBuilder::CIELabColor*  rhs) ;

/// @brief Method GetColor, addr 0x4674730, size 0xe0, virtual false, abstract: false, final false
static inline ::UnityEngine::Color GetColor(::UnityEngine::Vector3  vec) ;

/// @brief Method GetColorName, addr 0x46749b8, size 0x210, virtual false, abstract: false, final false
static inline ::StringW GetColorName(::UnityEngine::Color  InColor) ;

/// @brief Method HSVtoRGB, addr 0x46748d4, size 0xe4, virtual false, abstract: false, final false
static inline ::UnityEngine::Color HSVtoRGB(float_t  h, float_t  s, float_t  v) ;

/// @brief Method HSVtoRGB, addr 0x4674858, size 0x7c, virtual false, abstract: false, final false
static inline ::UnityEngine::Color HSVtoRGB(::UnityEngine::ProBuilder::HSVColor*  hsv) ;

/// @brief Method RGBToXYZ, addr 0x467400c, size 0x74, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::XYZColor* RGBToXYZ(::UnityEngine::Color  col) ;

/// @brief Method RGBToXYZ, addr 0x46740f4, size 0x1ac, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::XYZColor* RGBToXYZ(float_t  r, float_t  g, float_t  b) ;

/// @brief Method RGBtoHSV, addr 0x4673c78, size 0x1d0, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::HSVColor* RGBtoHSV(::UnityEngine::Color  color) ;

/// @brief Method XYZToCIE_Lab, addr 0x46743f4, size 0x188, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::CIELabColor* XYZToCIE_Lab(::UnityEngine::ProBuilder::XYZColor*  xyz) ;

/// @brief Method approx, addr 0x46746cc, size 0x64, virtual false, abstract: false, final false
