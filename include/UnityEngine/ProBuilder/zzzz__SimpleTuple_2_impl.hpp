...
inline T1 UnityEngine::ProBuilder::SimpleTuple_2<T1,T2>::get_item1()  {
...
template<typename T1,typename T2>
inline void UnityEngine::ProBuilder::SimpleTuple_2<T1,T2>::set_item1(T1  value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ProBuilder::SimpleTuple_2<T1,T2>>::get(),
                        "set_item1",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T1,typename T2>
inline T2 UnityEngine::ProBuilder::SimpleTuple_2<T1,T2>::get_item2()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ProBuilder::SimpleTuple_2<T1,T2>>::get(),
                        "get_item2",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T1,typename T2>
inline void UnityEngine::ProBuilder::SimpleTuple_2<T1,T2>::set_item2(T2  value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ProBuilder::SimpleTuple_2<T1,T2>>::get(),
                        "set_item2",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T1,typename T2>
inline void UnityEngine::ProBuilder::SimpleTuple_2<T1,T2>::_ctor(T1  item1, T2  item2)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ProBuilder::SimpleTuple_2<T1,T2>>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T1,typename T2>
inline ::StringW UnityEngine::ProBuilder::SimpleTuple_2<T1,T2>::ToString()  {
...
template<typename T1,typename T2>
constexpr ::UnityEngine::ProBuilder::SimpleTuple_2<T1,T2>::SimpleTuple_2(T1  m_Item1, T2  m_Item2) noexcept  {
this->m_Item1 = m_Item1;
this->m_Item2 = m_Item2;
}
// Ctor Parameters []
template<typename T1,typename T2>
constexpr ::UnityEngine::ProBuilder::SimpleTuple_2<T1,T2>::SimpleTuple_2()   {
}
