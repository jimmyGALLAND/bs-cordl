...
/// @brief Method <SortCommonIndexesByAdjacency>b__32_1, addr 0x46ba794, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Edge _SortCommonIndexesByAdjacency_b__32_1(::UnityEngine::ProBuilder::WingedEdge*  y) ;

/// @brief Method <SortCommonIndexesByAdjacency>b__32_2, addr 0x46ba7ac, size 0x8, virtual false, abstract: false, final false
inline int32_t _SortCommonIndexesByAdjacency_b__32_2(::UnityEngine::ProBuilder::Edge  x) ;

/// @brief Method .ctor, addr 0x46ba78c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <SortCommonIndexesByAdjacency>b__0, addr 0x46ba7b4, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x46b9e9c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static __declspec(property(get=getStaticF_k_OppositeEdgeDictionary, put=setStaticF_k_OppositeEdgeDictionary)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::ProBuilder::Edge,::UnityEngine::ProBuilder::WingedEdge*>*  k_OppositeEdgeDictionary;
...
/// @brief Method Count, addr 0x46b8e28, size 0x34, virtual false, abstract: false, final false
inline int32_t Count() ;

/// @brief Method Equals, addr 0x46b8cc8, size 0xf4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x46b8c40, size 0x88, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::ProBuilder::WingedEdge*  other) ;

/// @brief Method GetAdjacentEdgeWithCommonIndex, addr 0x46b9424, size 0xcc, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::WingedEdge* GetAdjacentEdgeWithCommonIndex(int32_t  common) ;

/// @brief Method GetHashCode, addr 0x46b8dbc, size 0x6c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetSpokes, addr 0x46b979c, size 0x418, virtual false, abstract: false, final false
...
/// @brief Method GetWingedEdges, addr 0x46b9f98, size 0x70c, virtual false, abstract: false, final false
...
/// @brief Method GetWingedEdges, addr 0x46b9ea4, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method MakeQuad, addr 0x46b9050, size 0x3d4, virtual false, abstract: false, final false
...
/// @brief Method SortCommonIndexesByAdjacency, addr 0x46b9bb4, size 0x2e8, virtual false, abstract: false, final false
...
/// @brief Method SortEdgesByAdjacency, addr 0x46b94f0, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method SortEdgesByAdjacency, addr 0x46b9604, size 0x198, virtual false, abstract: false, final false
static inline void SortEdgesByAdjacency(::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Edge>*  edges) ;

/// @brief Method ToString, addr 0x46b8e5c, size 0x1f4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x46b8c38, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_edge, addr 0x46b8be4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::EdgeLookup get_edge() ;

/// @brief Method get_face, addr 0x46b8bf8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Face* get_face() ;

/// @brief Method get_next, addr 0x46b8c08, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::WingedEdge* get_next() ;

/// @brief Method get_opposite, addr 0x46b8c28, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::WingedEdge* get_opposite() ;

/// @brief Method get_previous, addr 0x46b8c18, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_edge, addr 0x46b8bf0, size 0x8, virtual false, abstract: false, final false
inline void set_edge(::UnityEngine::ProBuilder::EdgeLookup  value) ;

/// @brief Method set_face, addr 0x46b8c00, size 0x8, virtual false, abstract: false, final false
inline void set_face(::UnityEngine::ProBuilder::Face*  value) ;

/// @brief Method set_next, addr 0x46b8c10, size 0x8, virtual false, abstract: false, final false
inline void set_next(::UnityEngine::ProBuilder::WingedEdge*  value) ;

/// @brief Method set_opposite, addr 0x46b8c30, size 0x8, virtual false, abstract: false, final false
inline void set_opposite(::UnityEngine::ProBuilder::WingedEdge*  value) ;

/// @brief Method set_previous, addr 0x46b8c20, size 0x8, virtual false, abstract: false, final false
