...
/// @brief Method DrawMeshNow, addr 0x46827e8, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x46827bc, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Transform*  transform, ::UnityEngine::Mesh*  mesh) ;

/// @brief Method get_mesh, addr 0x46827b4, size 0x8, virtual false, abstract: false, final false
