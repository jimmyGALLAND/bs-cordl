...
/// @brief Method Init, addr 0x466ece4, size 0x254, virtual false, abstract: false, final false
inline void Init() ;

static inline ::UnityEngine::ProBuilder::BezierShape* New_ctor() ;

/// @brief Method Refresh, addr 0x466ef38, size 0xbc, virtual false, abstract: false, final false
inline void Refresh() ;
...
/// @brief Method .ctor, addr 0x466eff4, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isEditing, addr 0x466ec34, size 0x8, virtual false, abstract: false, final false
inline bool get_isEditing() ;

/// @brief Method get_mesh, addr 0x466ec48, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh> get_mesh() ;

/// @brief Method set_isEditing, addr 0x466ec3c, size 0xc, virtual false, abstract: false, final false
inline void set_isEditing(bool  value) ;

/// @brief Method set_mesh, addr 0x466ecdc, size 0x8, virtual false, abstract: false, final false
