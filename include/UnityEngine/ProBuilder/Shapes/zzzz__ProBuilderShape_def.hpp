...
/// @brief Method OnValidate, addr 0x46c079c, size 0xa4, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method Rebuild, addr 0x46c0a84, size 0x1a0, virtual false, abstract: false, final false
inline void Rebuild() ;

/// @brief Method Rebuild, addr 0x46c0cb4, size 0xdc, virtual false, abstract: false, final false
inline void Rebuild(::UnityEngine::Bounds  bounds, ::UnityEngine::Quaternion  rotation, ::UnityEngine::Vector3  cornerPivot) ;

/// @brief Method RebuildPivot, addr 0x46c0d90, size 0x234, virtual false, abstract: false, final false
inline void RebuildPivot(::UnityEngine::Vector3  size, ::UnityEngine::Quaternion  rotation) ;

/// @brief Method ResetPivot, addr 0x46c0874, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method RotateInsideBounds, addr 0x46c1138, size 0xd4, virtual false, abstract: false, final false
inline void RotateInsideBounds(::UnityEngine::Quaternion  deltaRotation) ;

/// @brief Method SetShape, addr 0x46c0fc4, size 0x174, virtual false, abstract: false, final false
inline void SetShape(::UnityEngine::ProBuilder::Shapes::Shape*  shape, ::UnityEngine::ProBuilder::PivotLocation  location) ;

/// @brief Method UpdateBounds, addr 0x46c0c24, size 0x90, virtual false, abstract: false, final false
inline void UpdateBounds(::UnityEngine::Bounds  bounds) ;

/// @brief Method UpdateComponent, addr 0x46c0840, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x46c120c, size 0xd8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_editionBounds, addr 0x46c06a4, size 0xbc, virtual false, abstract: false, final false
inline ::UnityEngine::Bounds get_editionBounds() ;

/// @brief Method get_isEditable, addr 0x46c0774, size 0x28, virtual false, abstract: false, final false
inline bool get_isEditable() ;

/// @brief Method get_mesh, addr 0x46c046c, size 0xf8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::ProBuilder::ProBuilderMesh> get_mesh() ;

/// @brief Method get_pivotGlobalPosition, addr 0x46c0438, size 0x34, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_pivotGlobalPosition() ;

/// @brief Method get_pivotLocalPosition, addr 0x46c0420, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_pivotLocalPosition() ;

/// @brief Method get_pivotLocation, addr 0x46c0410, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::PivotLocation get_pivotLocation() ;

/// @brief Method get_rotation, addr 0x46c068c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_rotation() ;

/// @brief Method get_shape, addr 0x46c0400, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::Shapes::Shape* get_shape() ;

/// @brief Method get_shapeBox, addr 0x46c0760, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Bounds get_shapeBox() ;

/// @brief Method get_size, addr 0x46c05c4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_size() ;

/// @brief Method set_pivotGlobalPosition, addr 0x46c0564, size 0x60, virtual false, abstract: false, final false
inline void set_pivotGlobalPosition(::UnityEngine::Vector3  value) ;

/// @brief Method set_pivotLocalPosition, addr 0x46c042c, size 0xc, virtual false, abstract: false, final false
inline void set_pivotLocalPosition(::UnityEngine::Vector3  value) ;

/// @brief Method set_pivotLocation, addr 0x46c0418, size 0x8, virtual false, abstract: false, final false
inline void set_pivotLocation(::UnityEngine::ProBuilder::PivotLocation  value) ;

/// @brief Method set_rotation, addr 0x46c0698, size 0xc, virtual false, abstract: false, final false
inline void set_rotation(::UnityEngine::Quaternion  value) ;

/// @brief Method set_shape, addr 0x46c0408, size 0x8, virtual false, abstract: false, final false
inline void set_shape(::UnityEngine::ProBuilder::Shapes::Shape*  value) ;

/// @brief Method set_size, addr 0x46c05d0, size 0xbc, virtual false, abstract: false, final false
