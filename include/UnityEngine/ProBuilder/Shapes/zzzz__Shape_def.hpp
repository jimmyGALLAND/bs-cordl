...
/// @brief Method UpdateBounds, addr 0x46c12e4, size 0x4c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x46bb584, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
