...
public:
// Declarations
/// @brief Method CopyShape, addr 0x46c2484, size 0x4, virtual true, abstract: false, final false
inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape*  shape) ;

static inline ::UnityEngine::ProBuilder::Shapes::Sprite* New_ctor() ;

/// @brief Method RebuildMesh, addr 0x46c2488, size 0x300, virtual true, abstract: false, final false
inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh, ::UnityEngine::Vector3  size, ::UnityEngine::Quaternion  rotation) ;

/// @brief Method .ctor, addr 0x46c2788, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
