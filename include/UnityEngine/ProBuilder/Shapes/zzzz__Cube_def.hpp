...
/// @brief Method CopyShape, addr 0x46bc3e0, size 0x4, virtual true, abstract: false, final false
inline void CopyShape(::UnityEngine::ProBuilder::Shapes::Shape*  shape) ;

static inline ::UnityEngine::ProBuilder::Shapes::Cube* New_ctor() ;

/// @brief Method RebuildMesh, addr 0x46bc3e4, size 0x20c, virtual true, abstract: false, final false
inline ::UnityEngine::Bounds RebuildMesh(::UnityEngine::ProBuilder::ProBuilderMesh*  mesh, ::UnityEngine::Vector3  size, ::UnityEngine::Quaternion  rotation) ;

/// @brief Method .ctor, addr 0x46bc5f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
