...
/// @brief Method FromBool, addr 0x466d56c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method ToBool, addr 0x466d55c, size 0x10, virtual false, abstract: false, final false
inline bool ToBool() ;
...
/// @brief Method .ctor, addr 0x466d518, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ProBuilder::__ActionResult__Status  status, ::StringW  notification) ;

/// @brief Method get_NoSelection, addr 0x466d678, size 0x78, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::ActionResult* get_NoSelection() ;

/// @brief Method get_Success, addr 0x466d604, size 0x74, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::ActionResult* get_Success() ;

/// @brief Method get_UserCanceled, addr 0x466d6f0, size 0x78, virtual false, abstract: false, final false
static inline ::UnityEngine::ProBuilder::ActionResult* get_UserCanceled() ;

/// @brief Method get_notification, addr 0x466d508, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_notification() ;

/// @brief Method get_status, addr 0x466d4f8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ProBuilder::__ActionResult__Status get_status() ;

/// @brief Method op_Implicit, addr 0x466d548, size 0x14, virtual false, abstract: false, final false
static inline bool op_Implicit_bool(::UnityEngine::ProBuilder::ActionResult*  res) ;

/// @brief Method set_notification, addr 0x466d510, size 0x8, virtual false, abstract: false, final false
inline void set_notification(::StringW  value) ;

/// @brief Method set_status, addr 0x466d500, size 0x8, virtual false, abstract: false, final false
