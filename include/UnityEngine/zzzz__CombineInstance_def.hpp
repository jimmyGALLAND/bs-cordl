...
// SizeInfo { instance_size: 104, native_size: 104, calculated_instance_size: 104, calculated_native_size: 120, minimum_alignment: 4, packing: None, specified_packing: None }
namespace UnityEngine {
// Is value type: true
...
/// @brief Method get_mesh, addr 0x47fde50, size 0x3c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> get_mesh() ;

/// @brief Method set_mesh, addr 0x47fde8c, size 0x90, virtual false, abstract: false, final false
inline void set_mesh(::UnityEngine::Mesh*  value) ;

/// @brief Method set_subMeshIndex, addr 0x47fdf1c, size 0x8, virtual false, abstract: false, final false
inline void set_subMeshIndex(int32_t  value) ;

/// @brief Method set_transform, addr 0x47fdf24, size 0x1c, virtual false, abstract: false, final false
