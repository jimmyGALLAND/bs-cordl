...
/// @brief Method AcquireContextAndActivity, addr 0x47b8c64, size 0x244, virtual false, abstract: false, final false
...
/// @brief Method get_Activity, addr 0x47b8ea8, size 0x4c, virtual false, abstract: false, final false
static inline ::UnityEngine::AndroidJavaObject* get_Activity() ;

/// @brief Method get_Context, addr 0x47b8c18, size 0x4c, virtual false, abstract: false, final false
static inline ::UnityEngine::AndroidJavaObject* get_Context() ;

/// @brief Method get_UnityPlayerRaw, addr 0x47a7b74, size 0x28, virtual false, abstract: false, final false
