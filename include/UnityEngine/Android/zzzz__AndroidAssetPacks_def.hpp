...
/// @brief Method .ctor, addr 0x47b9360, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method onStatusUpdate, addr 0x47b93e4, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x47b94f0, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Action_1<::UnityEngine::Android::AndroidAssetPackUseMobileDataRequestResult*>*  callback) ;

/// @brief Method onMobileDataConfirmationResult, addr 0x47b9570, size 0x84, virtual false, abstract: false, final false
...
/// @brief Field m_Callback, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Callback, put=__cordl_internal_set_m_Callback)) ::System::Action_2<uint64_t,::ArrayW<::UnityEngine::Android::AndroidAssetPackState*,::Array<::UnityEngine::Android::AndroidAssetPackState*>*>>*  m_Callback;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<uint64_t,::ArrayW<::UnityEngine::Android::AndroidAssetPackState*,::Array<::UnityEngine::Android::AndroidAssetPackState*>*>>*> const& __cordl_internal_get_m_Callback() const;
...
constexpr void __cordl_internal_set_m_Callback(::System::Action_2<uint64_t,::ArrayW<::UnityEngine::Android::AndroidAssetPackState*,::Array<::UnityEngine::Android::AndroidAssetPackState*>*>>*  value) ;
...
/// @brief Method .ctor, addr 0x47b95f4, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method onStatusResult, addr 0x47b96e4, size 0x36c, virtual false, abstract: false, final false
...
/// @brief Method GetAssetPackManager, addr 0x47b8fbc, size 0x3a4, virtual false, abstract: false, final false
