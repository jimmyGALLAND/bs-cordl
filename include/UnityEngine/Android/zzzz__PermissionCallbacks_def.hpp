...
/// @brief Method .ctor, addr 0x47b9e70, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_PermissionDenied, addr 0x47b9bb0, size 0xb0, virtual false, abstract: false, final false
inline void add_PermissionDenied(::System::Action_1<::StringW>*  value) ;

/// @brief Method add_PermissionDeniedAndDontAskAgain, addr 0x47b9d10, size 0xb0, virtual false, abstract: false, final false
inline void add_PermissionDeniedAndDontAskAgain(::System::Action_1<::StringW>*  value) ;

/// @brief Method add_PermissionGranted, addr 0x47b9a50, size 0xb0, virtual false, abstract: false, final false
inline void add_PermissionGranted(::System::Action_1<::StringW>*  value) ;

/// @brief Method onPermissionDenied, addr 0x47b9ef8, size 0x1c, virtual false, abstract: false, final false
inline void onPermissionDenied(::StringW  permissionName) ;

/// @brief Method onPermissionDeniedAndDontAskAgain, addr 0x47b9f14, size 0x24, virtual false, abstract: false, final false
inline void onPermissionDeniedAndDontAskAgain(::StringW  permissionName) ;

/// @brief Method onPermissionGranted, addr 0x47b9edc, size 0x1c, virtual false, abstract: false, final false
inline void onPermissionGranted(::StringW  permissionName) ;

/// @brief Method remove_PermissionDenied, addr 0x47b9c60, size 0xb0, virtual false, abstract: false, final false
inline void remove_PermissionDenied(::System::Action_1<::StringW>*  value) ;

/// @brief Method remove_PermissionDeniedAndDontAskAgain, addr 0x47b9dc0, size 0xb0, virtual false, abstract: false, final false
inline void remove_PermissionDeniedAndDontAskAgain(::System::Action_1<::StringW>*  value) ;

/// @brief Method remove_PermissionGranted, addr 0x47b9b00, size 0xb0, virtual false, abstract: false, final false
