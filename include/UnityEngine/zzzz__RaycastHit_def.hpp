...
/// @brief Method CalculateRaycastTexCoord, addr 0x48700b0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method CalculateRaycastTexCoord_Injected, addr 0x4870130, size 0x74, virtual false, abstract: false, final false
static inline void CalculateRaycastTexCoord_Injected(int32_t  colliderInstanceID, ByRef<::UnityEngine::Vector2>  uv, ByRef<::UnityEngine::Vector3>  pos, uint32_t  face, int32_t  textcoord, ByRef<::UnityEngine::Vector2>  ret) ;

/// @brief Method get_articulationBody, addr 0x487037c, size 0xbc, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::ArticulationBody> get_articulationBody() ;

/// @brief Method get_barycentricCoordinate, addr 0x487007c, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_barycentricCoordinate() ;

/// @brief Method get_collider, addr 0x486ff98, size 0xac, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Collider> get_collider() ;

/// @brief Method get_colliderInstanceID, addr 0x4870044, size 0x8, virtual false, abstract: false, final false
inline int32_t get_colliderInstanceID() ;

/// @brief Method get_distance, addr 0x4870098, size 0x8, virtual false, abstract: false, final false
inline float_t get_distance() ;

/// @brief Method get_lightmapCoord, addr 0x4870474, size 0xfc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_lightmapCoord() ;

/// @brief Method get_normal, addr 0x4870064, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_normal() ;

/// @brief Method get_point, addr 0x487004c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_point() ;

/// @brief Method get_rigidbody, addr 0x48702c0, size 0xbc, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rigidbody> get_rigidbody() ;

/// @brief Method get_textureCoord, addr 0x48701a4, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_textureCoord() ;

/// @brief Method get_textureCoord1, addr 0x4870570, size 0x4, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_textureCoord1() ;

/// @brief Method get_textureCoord2, addr 0x48701c4, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_textureCoord2() ;

/// @brief Method get_transform, addr 0x48701e4, size 0xdc, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_transform() ;

/// @brief Method get_triangleIndex, addr 0x48700a8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_triangleIndex() ;

/// @brief Method set_barycentricCoordinate, addr 0x4870090, size 0x8, virtual false, abstract: false, final false
inline void set_barycentricCoordinate(::UnityEngine::Vector3  value) ;

/// @brief Method set_distance, addr 0x48700a0, size 0x8, virtual false, abstract: false, final false
inline void set_distance(float_t  value) ;

/// @brief Method set_normal, addr 0x4870070, size 0xc, virtual false, abstract: false, final false
inline void set_normal(::UnityEngine::Vector3  value) ;

/// @brief Method set_point, addr 0x4870058, size 0xc, virtual false, abstract: false, final false
