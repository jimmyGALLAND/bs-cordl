...
static __declspec(property(get=getStaticF_s_ReflectionHelperSetNativeExceptionOnProxy, put=setStaticF_s_ReflectionHelperSetNativeExceptionOnProxy)) ::System::IntPtr  s_ReflectionHelperSetNativeExceptionOnProxy;

/// @brief Method GetConstructorMember, addr 0x47b78a4, size 0x188, virtual false, abstract: false, final false
static inline ::System::IntPtr GetConstructorMember(::System::IntPtr  jclass, ::StringW  signature) ;

/// @brief Method GetFieldClass, addr 0x47b7e24, size 0x64, virtual false, abstract: false, final false
static inline ::System::IntPtr GetFieldClass(::System::IntPtr  field) ;

/// @brief Method GetFieldMember, addr 0x47b7c28, size 0x1fc, virtual false, abstract: false, final false
static inline ::System::IntPtr GetFieldMember(::System::IntPtr  jclass, ::StringW  fieldName, ::StringW  signature, bool  isStatic) ;

/// @brief Method GetFieldSignature, addr 0x47b7e88, size 0xa8, virtual false, abstract: false, final false
static inline ::StringW GetFieldSignature(::System::IntPtr  field) ;

/// @brief Method GetMethodID, addr 0x47b7808, size 0x9c, virtual false, abstract: false, final false
static inline ::System::IntPtr GetMethodID(::StringW  clazz, ::StringW  methodName, ::StringW  signature) ;

/// @brief Method GetMethodMember, addr 0x47b7a2c, size 0x1fc, virtual false, abstract: false, final false
static inline ::System::IntPtr GetMethodMember(::System::IntPtr  jclass, ::StringW  methodName, ::StringW  signature, bool  isStatic) ;

/// @brief Method GetStaticMethodID, addr 0x47b776c, size 0x9c, virtual false, abstract: false, final false
static inline ::System::IntPtr GetStaticMethodID(::StringW  clazz, ::StringW  methodName, ::StringW  signature) ;

/// @brief Method IsAssignableFrom, addr 0x47b774c, size 0x20, virtual false, abstract: false, final false
static inline bool IsAssignableFrom(::System::Type*  t, ::System::Type*  from) ;

/// @brief Method IsPrimitive, addr 0x47b7738, size 0x14, virtual false, abstract: false, final false
static inline bool IsPrimitive(::System::Type*  t) ;

/// @brief Method NewProxyInstance, addr 0x47b7f30, size 0xe4, virtual false, abstract: false, final false
static inline ::System::IntPtr NewProxyInstance(::System::IntPtr  player, ::System::IntPtr  delegateHandle, ::System::IntPtr  interfaze) ;

/// @brief Method SetNativeExceptionOnProxy, addr 0x47b517c, size 0x108, virtual false, abstract: false, final false
