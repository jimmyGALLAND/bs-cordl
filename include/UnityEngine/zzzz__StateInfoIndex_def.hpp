...
/// @brief Field CurrentState value: static_cast<int32_t>(0x0)
static ::UnityEngine::StateInfoIndex const CurrentState;

/// @brief Field ExitState value: static_cast<int32_t>(0x2)
static ::UnityEngine::StateInfoIndex const ExitState;

/// @brief Field InterruptedState value: static_cast<int32_t>(0x3)
static ::UnityEngine::StateInfoIndex const InterruptedState;

/// @brief Field NextState value: static_cast<int32_t>(0x1)
