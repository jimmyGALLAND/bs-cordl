...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Type* (*)(::System::Type*)>(&::UnityEngine::AttributeHelperEngine::GetParentTypeDisallowingMultipleInclusion)> {
  constexpr static std::size_t size = 0x134;
  constexpr static std::size_t addrs = 0x48156ec;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::System::Type*,::Array<::System::Type*>*> (*)(::System::Type*)>(&::UnityEngine::AttributeHelperEngine::GetRequiredComponents)> {
  constexpr static std::size_t size = 0x4d4;
  constexpr static std::size_t addrs = 0x4815820;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (*)(::System::Type*)>(&::UnityEngine::AttributeHelperEngine::GetExecuteMode)> {
  ...
  constexpr static std::size_t addrs = 0x4815cf4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (*)(::System::Type*)>(&::UnityEngine::AttributeHelperEngine::GetDefaultExecutionOrderFor)> {
  ...
  constexpr static std::size_t addrs = 0x4815f18;
...
inline void UnityEngine::AttributeHelperEngine::setStaticF__disallowMultipleComponentArray(::ArrayW<::UnityEngine::DisallowMultipleComponent*,::Array<::UnityEngine::DisallowMultipleComponent*>*>  value)  {
::cordl_internals::setStaticField<::ArrayW<::UnityEngine::DisallowMultipleComponent*,::Array<::UnityEngine::DisallowMultipleComponent*>*>, "_disallowMultipleComponentArray", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::AttributeHelperEngine*>::get>(std::forward<::ArrayW<::UnityEngine::DisallowMultipleComponent*,::Array<::UnityEngine::DisallowMultipleComponent*>*>>(value));
}
...
return ::cordl_internals::getStaticField<::ArrayW<::UnityEngine::DisallowMultipleComponent*,::Array<::UnityEngine::DisallowMultipleComponent*>*>, "_disallowMultipleComponentArray", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::AttributeHelperEngine*>::get>();
}
...
::cordl_internals::setStaticField<::ArrayW<::UnityEngine::ExecuteInEditMode*,::Array<::UnityEngine::ExecuteInEditMode*>*>, "_executeInEditModeArray", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::AttributeHelperEngine*>::get>(std::forward<::ArrayW<::UnityEngine::ExecuteInEditMode*,::Array<::UnityEngine::ExecuteInEditMode*>*>>(value));
}
...
return ::cordl_internals::getStaticField<::ArrayW<::UnityEngine::ExecuteInEditMode*,::Array<::UnityEngine::ExecuteInEditMode*>*>, "_executeInEditModeArray", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::AttributeHelperEngine*>::get>();
}
...
::cordl_internals::setStaticField<::ArrayW<::UnityEngine::RequireComponent*,::Array<::UnityEngine::RequireComponent*>*>, "_requireComponentArray", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::AttributeHelperEngine*>::get>(std::forward<::ArrayW<::UnityEngine::RequireComponent*,::Array<::UnityEngine::RequireComponent*>*>>(value));
}
...
return ::cordl_internals::getStaticField<::ArrayW<::UnityEngine::RequireComponent*,::Array<::UnityEngine::RequireComponent*>*>, "_requireComponentArray", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::AttributeHelperEngine*>::get>();
}
