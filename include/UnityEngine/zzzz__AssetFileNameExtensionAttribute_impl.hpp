...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::AssetFileNameExtensionAttribute::*)(::StringW, ::ArrayW<::StringW,::Array<::StringW>*>)>(&::UnityEngine::AssetFileNameExtensionAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x4882590;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEnumerable_1<::StringW>*> const& UnityEngine::AssetFileNameExtensionAttribute::__cordl_internal_get__otherExtensions_k__BackingField() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____otherExtensions_k__BackingField;
}
