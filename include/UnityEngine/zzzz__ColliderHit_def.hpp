...
/// @brief Method get_collider, addr 0x487a950, size 0xac, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Collider> get_collider() ;

/// @brief Method get_instanceID, addr 0x487a948, size 0x8, virtual false, abstract: false, final false
