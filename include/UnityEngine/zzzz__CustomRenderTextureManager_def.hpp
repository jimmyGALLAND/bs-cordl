...
/// @brief Method InvokeOnTextureLoaded_Internal, addr 0x47e0a5c, size 0x6c, virtual false, abstract: false, final false
static inline void InvokeOnTextureLoaded_Internal(::UnityEngine::CustomRenderTexture*  source) ;

/// @brief Method InvokeOnTextureUnloaded_Internal, addr 0x47e0ac8, size 0x6c, virtual false, abstract: false, final false
