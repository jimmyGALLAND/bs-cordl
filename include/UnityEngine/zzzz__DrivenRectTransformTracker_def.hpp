...
public:
// Declarations
/// @brief Method Add, addr 0x4822c70, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method Clear, addr 0x4822c74, size 0x4, virtual false, abstract: false, final false
inline void Clear() ;
