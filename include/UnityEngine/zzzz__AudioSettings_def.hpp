...
public:
// Declarations
/// @brief Method Invoke, addr 0x47c6714, size 0x18, virtual true, abstract: false, final false
inline void Invoke(bool  deviceWasChanged) ;

static inline ::UnityEngine::__AudioSettings__AudioConfigurationChangeHandler* New_ctor(::System::Object*  object, ::System::IntPtr  method) ;

/// @brief Method .ctor, addr 0x47c6688, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method InvokeIsStopAudioOutputOnMuteEnabled, addr 0x47c69dc, size 0x48, virtual false, abstract: false, final false
static inline bool InvokeIsStopAudioOutputOnMuteEnabled() ;

/// @brief Method InvokeOnMuteStateChanged, addr 0x47c680c, size 0x180, virtual false, abstract: false, final false
static inline void InvokeOnMuteStateChanged(bool  mute) ;

/// @brief Method StartAudioOutput, addr 0x47c69b4, size 0x28, virtual false, abstract: false, final false
static inline void StartAudioOutput() ;

/// @brief Method StopAudioOutput, addr 0x47c698c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_muteState, addr 0x47c672c, size 0x48, virtual false, abstract: false, final false
static inline bool get_muteState() ;

/// @brief Method get_stopAudioOutputOnMute, addr 0x47c67c4, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method set_muteState, addr 0x47c6774, size 0x50, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF_OnAudioConfigurationChanged, put=setStaticF_OnAudioConfigurationChanged)) ::UnityEngine::__AudioSettings__AudioConfigurationChangeHandler*  OnAudioConfigurationChanged;
...
/// @brief Method GetConfiguration, addr 0x47c62f8, size 0x60, virtual false, abstract: false, final false
static inline ::UnityEngine::AudioConfiguration GetConfiguration() ;

/// @brief Method GetConfiguration_Injected, addr 0x47c6358, size 0x3c, virtual false, abstract: false, final false
static inline void GetConfiguration_Injected(ByRef<::UnityEngine::AudioConfiguration>  ret) ;

/// @brief Method GetSampleRate, addr 0x47c6258, size 0x28, virtual false, abstract: false, final false
static inline int32_t GetSampleRate() ;

/// @brief Method GetSpatializerPluginName, addr 0x47c62d0, size 0x28, virtual false, abstract: false, final false
static inline ::StringW GetSpatializerPluginName() ;

/// @brief Method InvokeOnAudioConfigurationChanged, addr 0x47c6504, size 0x6c, virtual false, abstract: false, final false
static inline void InvokeOnAudioConfigurationChanged(bool  deviceWasChanged) ;

/// @brief Method InvokeOnAudioSystemShuttingDown, addr 0x47c6570, size 0x64, virtual false, abstract: false, final false
static inline void InvokeOnAudioSystemShuttingDown() ;

/// @brief Method InvokeOnAudioSystemStartedUp, addr 0x47c65d4, size 0x64, virtual false, abstract: false, final false
static inline void InvokeOnAudioSystemStartedUp() ;

/// @brief Method StartAudioOutput, addr 0x47c6638, size 0x28, virtual false, abstract: false, final false
static inline bool StartAudioOutput() ;

/// @brief Method StopAudioOutput, addr 0x47c6660, size 0x28, virtual false, abstract: false, final false
static inline bool StopAudioOutput() ;

/// @brief Method add_OnAudioConfigurationChanged, addr 0x47c6394, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method get_dspTime, addr 0x47c6280, size 0x28, virtual false, abstract: false, final false
static inline double_t get_dspTime() ;

/// @brief Method get_outputSampleRate, addr 0x47c62a8, size 0x28, virtual false, abstract: false, final false
static inline int32_t get_outputSampleRate() ;

/// @brief Method remove_OnAudioConfigurationChanged, addr 0x47c644c, size 0xb8, virtual false, abstract: false, final false
