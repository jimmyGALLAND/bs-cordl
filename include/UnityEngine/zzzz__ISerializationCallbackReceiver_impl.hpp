...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ISerializationCallbackReceiver::*)()>(&::UnityEngine::ISerializationCallbackReceiver::OnBeforeSerialize)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ISerializationCallbackReceiver::*)()>(&::UnityEngine::ISerializationCallbackReceiver::OnAfterDeserialize)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
