...
/// @brief Method .ctor, addr 0x4816068, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  requiredComponent) ;

/// @brief Method .ctor, addr 0x4816090, size 0x2c, virtual false, abstract: false, final false
