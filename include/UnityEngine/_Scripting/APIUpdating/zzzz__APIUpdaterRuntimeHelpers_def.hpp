...
public:
// Declarations
/// @brief Method GetMovedFromAttributeDataForType, addr 0x4829ea8, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method GetObsoleteTypeRedirection, addr 0x4829fe4, size 0x2b8, virtual false, abstract: false, final false
