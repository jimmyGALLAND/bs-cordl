...
/// @brief Method Finalize, addr 0x48178dc, size 0xbc, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::UnityEngine::Coroutine* New_ctor() ;

/// @brief Method ReleaseCoroutine, addr 0x4817998, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x48178d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
