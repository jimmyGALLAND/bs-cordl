...
/// @brief Method Raycast, addr 0x4a4b8b0, size 0x6ec, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a4b860, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;
