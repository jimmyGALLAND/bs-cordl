...
/// @brief Method AddRaycaster, addr 0x4a4b2fc, size 0x110, virtual false, abstract: false, final false
static inline void AddRaycaster(::UnityEngine::EventSystems::BaseRaycaster*  baseRaycaster) ;

/// @brief Method GetRaycasters, addr 0x4a4b40c, size 0x58, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::EventSystems::BaseRaycaster>>* GetRaycasters() ;

/// @brief Method RemoveRaycasters, addr 0x4a4b464, size 0xd0, virtual false, abstract: false, final false
