...
/// @brief Method .ctor, addr 0x4a48370, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_button, addr 0x4a48360, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::__PointerEventData__InputButton get_button() ;

/// @brief Method get_eventData, addr 0x4a48350, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::__PointerInputModule__MouseButtonEventData* get_eventData() ;

/// @brief Method set_button, addr 0x4a48368, size 0x8, virtual false, abstract: false, final false
inline void set_button(::UnityEngine::EventSystems::__PointerEventData__InputButton  value) ;

/// @brief Method set_eventData, addr 0x4a48358, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field m_TrackedButtons, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_TrackedButtons, put=__cordl_internal_set_m_TrackedButtons)) ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::__PointerInputModule__ButtonState*>*  m_TrackedButtons;

/// @brief Method AnyPressesThisFrame, addr 0x4a48378, size 0xbc, virtual false, abstract: false, final false
inline bool AnyPressesThisFrame() ;

/// @brief Method AnyReleasesThisFrame, addr 0x4a48444, size 0xc0, virtual false, abstract: false, final false
inline bool AnyReleasesThisFrame() ;

/// @brief Method GetButtonState, addr 0x4a48518, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method SetButtonState, addr 0x4a478f8, size 0x38, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::EventSystems::__PointerInputModule__ButtonState*>*> const& __cordl_internal_get_m_TrackedButtons() const;
...
/// @brief Method .ctor, addr 0x4a482d4, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method PressedThisFrame, addr 0x4a48434, size 0x10, virtual false, abstract: false, final false
inline bool PressedThisFrame() ;

/// @brief Method ReleasedThisFrame, addr 0x4a48504, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a486a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ClearSelection, addr 0x4a47d20, size 0x1c0, virtual false, abstract: false, final false
inline void ClearSelection() ;

/// @brief Method CopyFromTo, addr 0x4a474c8, size 0x88, virtual false, abstract: false, final false
inline void CopyFromTo(::UnityEngine::EventSystems::PointerEventData*  from, ::UnityEngine::EventSystems::PointerEventData*  to) ;

/// @brief Method DeselectIfSelectionChanged, addr 0x4a48148, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method GetLastPointerEventData, addr 0x4a47930, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerEventData* GetLastPointerEventData(int32_t  id) ;

/// @brief Method GetMousePointerEventData, addr 0x4a475cc, size 0x14, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::__PointerInputModule__MouseState* GetMousePointerEventData() ;

/// @brief Method GetMousePointerEventData, addr 0x4a475e0, size 0x318, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::__PointerInputModule__MouseState* GetMousePointerEventData(int32_t  id) ;

/// @brief Method GetPointerData, addr 0x4a47004, size 0xec, virtual false, abstract: false, final false
inline bool GetPointerData(int32_t  id, ByRef<::UnityEngine::EventSystems::PointerEventData*>  data, bool  create) ;

/// @brief Method GetTouchPointerEventData, addr 0x4a4714c, size 0x37c, virtual false, abstract: false, final false
...
/// @brief Method IsPointerOverGameObject, addr 0x4a47c84, size 0x9c, virtual true, abstract: false, final false
inline bool IsPointerOverGameObject(int32_t  pointerId) ;

static inline ::UnityEngine::EventSystems::PointerInputModule* New_ctor() ;

/// @brief Method ProcessDrag, addr 0x4a479c4, size 0x2c0, virtual true, abstract: false, final false
inline void ProcessDrag(::UnityEngine::EventSystems::PointerEventData*  pointerEvent) ;

/// @brief Method ProcessMove, addr 0x4a47980, size 0x44, virtual true, abstract: false, final false
inline void ProcessMove(::UnityEngine::EventSystems::PointerEventData*  pointerEvent) ;

/// @brief Method RemovePointerData, addr 0x4a470f0, size 0x5c, virtual false, abstract: false, final false
inline void RemovePointerData(::UnityEngine::EventSystems::PointerEventData*  data) ;

/// @brief Method ShouldStartDrag, addr 0x4a47950, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method StateForMouseButton, addr 0x4a47550, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::__PointerEventData__FramePressState StateForMouseButton(int32_t  buttonId) ;

/// @brief Method ToString, addr 0x4a47ee0, size 0x268, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::EventSystems::PointerEventData*>*> const& __cordl_internal_get_m_PointerData() const;
...
/// @brief Method .ctor, addr 0x4a48234, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;
