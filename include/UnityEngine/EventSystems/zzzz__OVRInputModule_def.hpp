...
/// @brief Method ActivateModule, addr 0x3fe848c, size 0xcc, virtual true, abstract: false, final false
inline void ActivateModule() ;

/// @brief Method AllowMoveEventProcessing, addr 0x3fe8a5c, size 0x5c, virtual false, abstract: false, final false
inline bool AllowMoveEventProcessing(float_t  time) ;

/// @brief Method ClearSelection, addr 0x3fe8574, size 0x2f8, virtual false, abstract: false, final false
inline void ClearSelection() ;

/// @brief Method CopyFromTo, addr 0x3fe99c8, size 0x70, virtual false, abstract: false, final false
inline void CopyFromTo(::UnityEngine::EventSystems::OVRPointerEventData*  from, ::UnityEngine::EventSystems::OVRPointerEventData*  to) ;

/// @brief Method CopyFromTo, addr 0x3fe9a38, size 0x60, virtual false, abstract: false, final false
inline void CopyFromTo(::UnityEngine::EventSystems::PointerEventData*  from, ::UnityEngine::EventSystems::PointerEventData*  to) ;

/// @brief Method DeactivateModule, addr 0x3fe8558, size 0x1c, virtual true, abstract: false, final false
inline void DeactivateModule() ;

/// @brief Method GetCanvasPointerData, addr 0x3fea988, size 0x388, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::__PointerInputModule__MouseState* GetCanvasPointerData() ;

/// @brief Method GetExtraScrollDelta, addr 0x3fea45c, size 0x94, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetExtraScrollDelta() ;

/// @brief Method GetGazeButtonState, addr 0x3feb474, size 0x110, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::__PointerEventData__FramePressState GetGazeButtonState() ;

/// @brief Method GetGazePointerData, addr 0x3fe9d34, size 0x728, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::__PointerInputModule__MouseState* GetGazePointerData() ;

/// @brief Method GetPointerData, addr 0x3fe9a98, size 0xf0, virtual false, abstract: false, final false
inline bool GetPointerData(int32_t  id, ByRef<::UnityEngine::EventSystems::OVRPointerEventData*>  data, bool  create) ;

/// @brief Method GetRawMoveVector, addr 0x3fe8ab8, size 0xb8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetRawMoveVector() ;

/// @brief Method GetRectTransformNormal, addr 0x3fe9b90, size 0x1a4, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 GetRectTransformNormal(::UnityEngine::RectTransform*  rectTransform) ;

/// @brief Method IsModuleSupported, addr 0x3fe82ec, size 0x18, virtual true, abstract: false, final false
inline bool IsModuleSupported() ;

/// @brief Method IsPointerMoving, addr 0x3fe9994, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method Process, addr 0x3fe9930, size 0x64, virtual true, abstract: false, final false
inline void Process() ;

/// @brief Method ProcessDrag, addr 0x3feb15c, size 0x318, virtual true, abstract: false, final false
inline void ProcessDrag(::UnityEngine::EventSystems::PointerEventData*  pointerEvent) ;

/// @brief Method ProcessMouseEvent, addr 0x3fe9628, size 0x2c8, virtual false, abstract: false, final false
inline void ProcessMouseEvent(::UnityEngine::EventSystems::__PointerInputModule__MouseState*  mouseData) ;

/// @brief Method ProcessMousePress, addr 0x3fe8ebc, size 0x668, virtual false, abstract: false, final false
inline void ProcessMousePress(::UnityEngine::EventSystems::__PointerInputModule__MouseButtonEventData*  data) ;

/// @brief Method SendMoveEventToSelectedObject, addr 0x3fe8b70, size 0x204, virtual false, abstract: false, final false
inline bool SendMoveEventToSelectedObject() ;

/// @brief Method SendSubmitEventToSelectedObject, addr 0x3fe886c, size 0x1f0, virtual false, abstract: false, final false
inline bool SendSubmitEventToSelectedObject() ;

/// @brief Method SendUpdateEventToSelectedObject, addr 0x3fe8d74, size 0x148, virtual false, abstract: false, final false
inline bool SendUpdateEventToSelectedObject() ;

/// @brief Method ShouldActivateModule, addr 0x3fe8304, size 0x188, virtual true, abstract: false, final false
inline bool ShouldActivateModule() ;

/// @brief Method ShouldStartDrag, addr 0x3fead10, size 0x348, virtual false, abstract: false, final false
inline bool ShouldStartDrag(::UnityEngine::EventSystems::PointerEventData*  pointerEvent) ;

/// @brief Method SwipeAdjustedPosition, addr 0x3feb0d4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method UpdateModule, addr 0x3fe82c8, size 0x24, virtual true, abstract: false, final false
inline void UpdateModule() ;

/// @brief Method UseMouse, addr 0x3fe98f0, size 0x40, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::EventSystems::OVRPointerEventData*>*> const& __cordl_internal_get_m_VRRayPointerData() const;
...
/// @brief Method .ctor, addr 0x3fe80fc, size 0x160, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowActivationOnMobileDevice, addr 0x3fe8264, size 0x8, virtual false, abstract: false, final false
inline bool get_allowActivationOnMobileDevice() ;

/// @brief Method get_cancelButton, addr 0x3fe82b8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_cancelButton() ;

/// @brief Method get_horizontalAxis, addr 0x3fe8288, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_horizontalAxis() ;

/// @brief Method get_inputActionsPerSecond, addr 0x3fe8278, size 0x8, virtual false, abstract: false, final false
inline float_t get_inputActionsPerSecond() ;

/// @brief Method get_inputMode, addr 0x3fe825c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::__OVRInputModule__InputMode get_inputMode() ;

/// @brief Method get_submitButton, addr 0x3fe82a8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_submitButton() ;

/// @brief Method get_verticalAxis, addr 0x3fe8298, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_verticalAxis() ;

/// @brief Method set_allowActivationOnMobileDevice, addr 0x3fe826c, size 0xc, virtual false, abstract: false, final false
inline void set_allowActivationOnMobileDevice(bool  value) ;

/// @brief Method set_cancelButton, addr 0x3fe82c0, size 0x8, virtual false, abstract: false, final false
inline void set_cancelButton(::StringW  value) ;

/// @brief Method set_horizontalAxis, addr 0x3fe8290, size 0x8, virtual false, abstract: false, final false
inline void set_horizontalAxis(::StringW  value) ;

/// @brief Method set_inputActionsPerSecond, addr 0x3fe8280, size 0x8, virtual false, abstract: false, final false
inline void set_inputActionsPerSecond(float_t  value) ;

/// @brief Method set_submitButton, addr 0x3fe82b0, size 0x8, virtual false, abstract: false, final false
inline void set_submitButton(::StringW  value) ;

/// @brief Method set_verticalAxis, addr 0x3fe82a0, size 0x8, virtual false, abstract: false, final false
