...
/// @brief Method ActivateModule, addr 0x4a46ef4, size 0x4, virtual true, abstract: false, final false
inline void ActivateModule() ;

/// @brief Method ConvertUIToolkitPointerId, addr 0x4a46f04, size 0x7c, virtual true, abstract: false, final false
inline int32_t ConvertUIToolkitPointerId(::UnityEngine::EventSystems::PointerEventData*  sourcePointerData) ;

/// @brief Method DeactivateModule, addr 0x4a46ef0, size 0x4, virtual true, abstract: false, final false
inline void DeactivateModule() ;

/// @brief Method DetermineMoveDirection, addr 0x4a46090, size 0x54, virtual false, abstract: false, final false
static inline ::UnityEngine::EventSystems::MoveDirection DetermineMoveDirection(float_t  x, float_t  y) ;

/// @brief Method DetermineMoveDirection, addr 0x4a460e4, size 0x50, virtual false, abstract: false, final false
static inline ::UnityEngine::EventSystems::MoveDirection DetermineMoveDirection(float_t  x, float_t  y, float_t  deadZone) ;

/// @brief Method FindCommonRoot, addr 0x4a46134, size 0x174, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> FindCommonRoot(::UnityEngine::GameObject*  g1, ::UnityEngine::GameObject*  g2) ;

/// @brief Method FindFirstRaycast, addr 0x4a45f7c, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method GetAxisEventData, addr 0x4a46d2c, size 0x100, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::AxisEventData* GetAxisEventData(float_t  x, float_t  y, float_t  moveDeadZone) ;

/// @brief Method GetBaseEventData, addr 0x4a46e2c, size 0x7c, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::BaseEventData* GetBaseEventData() ;

/// @brief Method HandlePointerExitAndEnter, addr 0x4a462a8, size 0xa84, virtual false, abstract: false, final false
...
/// @brief Method IsModuleSupported, addr 0x4a46efc, size 0x8, virtual true, abstract: false, final false
inline bool IsModuleSupported() ;

/// @brief Method IsPointerOverGameObject, addr 0x4a46ea8, size 0x8, virtual true, abstract: false, final false
inline bool IsPointerOverGameObject(int32_t  pointerId) ;

static inline ::UnityEngine::EventSystems::BaseInputModule* New_ctor() ;

/// @brief Method OnDisable, addr 0x4a45f64, size 0x18, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x4a45f0c, size 0x58, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Process, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
inline void Process() ;

/// @brief Method ShouldActivateModule, addr 0x4a46eb0, size 0x40, virtual true, abstract: false, final false
inline bool ShouldActivateModule() ;

/// @brief Method UpdateModule, addr 0x4a46ef8, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a46f80, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_eventSystem, addr 0x4a45f04, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::EventSystem> get_eventSystem() ;

/// @brief Method get_input, addr 0x4a45cdc, size 0x218, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::BaseInput> get_input() ;

/// @brief Method get_inputOverride, addr 0x4a45ef4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::BaseInput> get_inputOverride() ;

/// @brief Method get_sendPointerHoverToParent, addr 0x4a45cc8, size 0x8, virtual false, abstract: false, final false
inline bool get_sendPointerHoverToParent() ;

/// @brief Method set_inputOverride, addr 0x4a45efc, size 0x8, virtual false, abstract: false, final false
inline void set_inputOverride(::UnityEngine::EventSystems::BaseInput*  value) ;

/// @brief Method set_sendPointerHoverToParent, addr 0x4a45cd0, size 0xc, virtual false, abstract: false, final false
