...
/// @brief Method Compare, addr 0x4a4c910, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x4a4c950, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ComputeRayAndDistance, addr 0x4a4bf9c, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x4a4c50c, size 0x404, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a4b888, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_depth, addr 0x4a4c428, size 0xc4, virtual true, abstract: false, final false
inline int32_t get_depth() ;

/// @brief Method get_eventCamera, addr 0x4a4c358, size 0xd0, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_eventCamera() ;

/// @brief Method get_eventMask, addr 0x4a4c4ec, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_eventMask() ;

/// @brief Method get_finalEventMask, addr 0x4a4c294, size 0xc4, virtual false, abstract: false, final false
inline int32_t get_finalEventMask() ;

/// @brief Method get_maxRayIntersections, addr 0x4a4c4fc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxRayIntersections() ;

/// @brief Method set_eventMask, addr 0x4a4c4f4, size 0x8, virtual false, abstract: false, final false
inline void set_eventMask(::UnityEngine::LayerMask  value) ;

/// @brief Method set_maxRayIntersections, addr 0x4a4c504, size 0x8, virtual false, abstract: false, final false
