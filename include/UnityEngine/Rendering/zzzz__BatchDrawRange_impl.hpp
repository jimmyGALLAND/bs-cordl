...
// Ctor Parameters [CppParam { name: "drawCommandsBegin", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "drawCommandsCount", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "filterSettings", ty: "::UnityEngine::Rendering::BatchFilterSettings", modifiers: "", def_value: Some("{}") }]
