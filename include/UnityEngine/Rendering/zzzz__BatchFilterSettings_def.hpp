...
constexpr BatchFilterSettings(uint32_t  renderingLayerMask, uint8_t  layer, uint8_t  m_motionMode, uint8_t  m_shadowMode, uint8_t  m_receiveShadows, uint8_t  m_staticShadowCaster, uint8_t  m_allDepthSorted) noexcept;
