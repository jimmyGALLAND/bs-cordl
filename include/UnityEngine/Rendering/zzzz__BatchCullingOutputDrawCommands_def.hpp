...
// Ctor Parameters [CppParam { name: "drawCommands", ty: "::cordl_internals::Ptr<::UnityEngine::Rendering::BatchDrawCommand>", modifiers: "", def_value: None }, CppParam { name: "visibleInstances", ty: "::cordl_internals::Ptr<int32_t>", modifiers: "", def_value: None }, CppParam { name: "drawRanges", ty: "::cordl_internals::Ptr<::UnityEngine::Rendering::BatchDrawRange>", modifiers: "", def_value: None }, CppParam { name: "instanceSortingPositions", ty: "::cordl_internals::Ptr<float_t>", modifiers: "", def_value: None }, CppParam { name: "drawCommandPickingInstanceIDs", ty: "::cordl_internals::Ptr<int32_t>", modifiers: "", def_value: None }, CppParam { name: "drawCommandCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "visibleInstanceCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "drawRangeCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "instanceSortingPositionFloatCount", ty: "int32_t", modifiers: "", def_value: None }]
constexpr BatchCullingOutputDrawCommands(::cordl_internals::Ptr<::UnityEngine::Rendering::BatchDrawCommand>  drawCommands, ::cordl_internals::Ptr<int32_t>  visibleInstances, ::cordl_internals::Ptr<::UnityEngine::Rendering::BatchDrawRange>  drawRanges, ::cordl_internals::Ptr<float_t>  instanceSortingPositions, ::cordl_internals::Ptr<int32_t>  drawCommandPickingInstanceIDs, int32_t  drawCommandCount, int32_t  visibleInstanceCount, int32_t  drawRangeCount, int32_t  instanceSortingPositionFloatCount) noexcept;
