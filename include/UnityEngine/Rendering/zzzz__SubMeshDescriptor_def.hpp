...
/// @brief Method ToString, addr 0x4830ccc, size 0x29c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x4830c2c, size 0x18, virtual false, abstract: false, final false
inline void _ctor(int32_t  indexStart, int32_t  indexCount, ::UnityEngine::MeshTopology  topology) ;

/// @brief Method get_baseVertex, addr 0x4830c9c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_baseVertex() ;

/// @brief Method get_bounds, addr 0x4830c44, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Bounds get_bounds() ;

/// @brief Method get_firstVertex, addr 0x4830cac, size 0x8, virtual false, abstract: false, final false
inline int32_t get_firstVertex() ;

/// @brief Method get_indexCount, addr 0x4830c8c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_indexCount() ;

/// @brief Method get_indexStart, addr 0x4830c7c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_indexStart() ;

/// @brief Method get_topology, addr 0x4830c6c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::MeshTopology get_topology() ;

/// @brief Method get_vertexCount, addr 0x4830cbc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_vertexCount() ;

/// @brief Method set_baseVertex, addr 0x4830ca4, size 0x8, virtual false, abstract: false, final false
inline void set_baseVertex(int32_t  value) ;

/// @brief Method set_bounds, addr 0x4830c58, size 0x14, virtual false, abstract: false, final false
inline void set_bounds(::UnityEngine::Bounds  value) ;

/// @brief Method set_firstVertex, addr 0x4830cb4, size 0x8, virtual false, abstract: false, final false
inline void set_firstVertex(int32_t  value) ;

/// @brief Method set_indexCount, addr 0x4830c94, size 0x8, virtual false, abstract: false, final false
inline void set_indexCount(int32_t  value) ;

/// @brief Method set_indexStart, addr 0x4830c84, size 0x8, virtual false, abstract: false, final false
inline void set_indexStart(int32_t  value) ;

/// @brief Method set_topology, addr 0x4830c74, size 0x8, virtual false, abstract: false, final false
inline void set_topology(::UnityEngine::MeshTopology  value) ;

/// @brief Method set_vertexCount, addr 0x4830cc4, size 0x8, virtual false, abstract: false, final false
