...
/// @brief Method Equals, addr 0x48311b0, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method Equals, addr 0x4831258, size 0x44, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::VertexAttributeDescriptor  other) ;

/// @brief Method GetHashCode, addr 0x4831188, size 0x28, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x4830fb4, size 0x1d4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x4830fa8, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_attribute, addr 0x4830f68, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::VertexAttribute get_attribute() ;

/// @brief Method get_dimension, addr 0x4830f88, size 0x8, virtual false, abstract: false, final false
inline int32_t get_dimension() ;

/// @brief Method get_format, addr 0x4830f78, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::VertexAttributeFormat get_format() ;

/// @brief Method get_stream, addr 0x4830f98, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_attribute, addr 0x4830f70, size 0x8, virtual false, abstract: false, final false
inline void set_attribute(::UnityEngine::Rendering::VertexAttribute  value) ;

/// @brief Method set_dimension, addr 0x4830f90, size 0x8, virtual false, abstract: false, final false
inline void set_dimension(int32_t  value) ;

/// @brief Method set_format, addr 0x4830f80, size 0x8, virtual false, abstract: false, final false
inline void set_format(::UnityEngine::Rendering::VertexAttributeFormat  value) ;

/// @brief Method set_stream, addr 0x4830fa0, size 0x8, virtual false, abstract: false, final false
