...
// Ctor Parameters [CppParam { name: "visibleOffset", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "visibleCount", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "batchID", ty: "::UnityEngine::Rendering::BatchID", modifiers: "", def_value: None }, CppParam { name: "materialID", ty: "::UnityEngine::Rendering::BatchMaterialID", modifiers: "", def_value: None }, CppParam { name: "meshID", ty: "::UnityEngine::Rendering::BatchMeshID", modifiers: "", def_value: None }, CppParam { name: "submeshIndex", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "splitVisibilityMask", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "flags", ty: "::UnityEngine::Rendering::BatchDrawCommandFlags", modifiers: "", def_value: None }, CppParam { name: "sortingPosition", ty: "int32_t", modifiers: "", def_value: None }]
constexpr BatchDrawCommand(uint32_t  visibleOffset, uint32_t  visibleCount, ::UnityEngine::Rendering::BatchID  batchID, ::UnityEngine::Rendering::BatchMaterialID  materialID, ::UnityEngine::Rendering::BatchMeshID  meshID, uint16_t  submeshIndex, uint16_t  splitVisibilityMask, ::UnityEngine::Rendering::BatchDrawCommandFlags  flags, int32_t  sortingPosition) noexcept;
