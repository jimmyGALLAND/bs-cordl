...
/// @brief Method Equals, addr 0x4836bd8, size 0x78, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x4836c50, size 0x10, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::ShaderTagId  other) ;

/// @brief Method GetHashCode, addr 0x4836c60, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x4836ba8, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method get_id, addr 0x4836bc8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_id, addr 0x4836bd0, size 0x8, virtual false, abstract: false, final false
