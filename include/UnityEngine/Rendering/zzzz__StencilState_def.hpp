...
/// @brief Method Equals, addr 0x4836dec, size 0x7c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x4836d3c, size 0xb0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::StencilState  other) ;

/// @brief Method GetHashCode, addr 0x4836e68, size 0xf0, virtual true, abstract: false, final false
...
/// @brief Method set_compareFunctionBack, addr 0x4836d1c, size 0x8, virtual false, abstract: false, final false
inline void set_compareFunctionBack(::UnityEngine::Rendering::CompareFunction  value) ;

/// @brief Method set_compareFunctionFront, addr 0x4836cfc, size 0x8, virtual false, abstract: false, final false
inline void set_compareFunctionFront(::UnityEngine::Rendering::CompareFunction  value) ;

/// @brief Method set_enabled, addr 0x4836c80, size 0x6c, virtual false, abstract: false, final false
inline void set_enabled(bool  value) ;

/// @brief Method set_failOperationBack, addr 0x4836d2c, size 0x8, virtual false, abstract: false, final false
inline void set_failOperationBack(::UnityEngine::Rendering::StencilOp  value) ;

/// @brief Method set_failOperationFront, addr 0x4836d0c, size 0x8, virtual false, abstract: false, final false
inline void set_failOperationFront(::UnityEngine::Rendering::StencilOp  value) ;

/// @brief Method set_passOperationBack, addr 0x4836d24, size 0x8, virtual false, abstract: false, final false
inline void set_passOperationBack(::UnityEngine::Rendering::StencilOp  value) ;

/// @brief Method set_passOperationFront, addr 0x4836d04, size 0x8, virtual false, abstract: false, final false
inline void set_passOperationFront(::UnityEngine::Rendering::StencilOp  value) ;

/// @brief Method set_readMask, addr 0x4836cec, size 0x8, virtual false, abstract: false, final false
inline void set_readMask(uint8_t  value) ;

/// @brief Method set_writeMask, addr 0x4836cf4, size 0x8, virtual false, abstract: false, final false
inline void set_writeMask(uint8_t  value) ;

/// @brief Method set_zFailOperationBack, addr 0x4836d34, size 0x8, virtual false, abstract: false, final false
inline void set_zFailOperationBack(::UnityEngine::Rendering::StencilOp  value) ;

/// @brief Method set_zFailOperationFront, addr 0x4836d14, size 0x8, virtual false, abstract: false, final false
