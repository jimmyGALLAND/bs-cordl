...
static __declspec(property(get=getStaticF_activeRenderPipelineAssetChanged, put=setStaticF_activeRenderPipelineAssetChanged)) ::System::Action_2<::UnityW<::UnityEngine::Rendering::RenderPipelineAsset>,::UnityW<::UnityEngine::Rendering::RenderPipelineAsset>>*  activeRenderPipelineAssetChanged;
...
static __declspec(property(get=getStaticF_beginCameraRendering, put=setStaticF_beginCameraRendering)) ::System::Action_2<::UnityEngine::Rendering::ScriptableRenderContext,::UnityW<::UnityEngine::Camera>>*  beginCameraRendering;
...
/// @brief Method CleanupRenderPipeline, addr 0x4835b30, size 0x1b4, virtual false, abstract: false, final false
static inline void CleanupRenderPipeline() ;

/// @brief Method DoRenderLoop_Internal, addr 0x4836404, size 0x288, virtual false, abstract: false, final false
...
/// @brief Method GetCurrentPipelineAssetType, addr 0x48363ac, size 0x58, virtual false, abstract: false, final false
static inline ::StringW GetCurrentPipelineAssetType() ;

/// @brief Method HandleRenderPipelineChange, addr 0x483624c, size 0x80, virtual false, abstract: false, final false
static inline void HandleRenderPipelineChange(::UnityEngine::Rendering::RenderPipelineAsset*  pipelineAsset) ;

/// @brief Method IsPipelineRequireCreation, addr 0x483674c, size 0x14c, virtual false, abstract: false, final false
static inline bool IsPipelineRequireCreation() ;

/// @brief Method OnActiveRenderPipelineAssetChanged, addr 0x4836140, size 0x10c, virtual false, abstract: false, final false
static inline void OnActiveRenderPipelineAssetChanged(::UnityEngine::ScriptableObject*  from, ::UnityEngine::ScriptableObject*  to) ;

/// @brief Method OnActiveRenderPipelineTypeChanged, addr 0x48360cc, size 0x74, virtual false, abstract: false, final false
static inline void OnActiveRenderPipelineTypeChanged() ;

/// @brief Method PrepareRenderPipeline, addr 0x4835ce4, size 0xb4, virtual false, abstract: false, final false
static inline void PrepareRenderPipeline(::UnityEngine::Rendering::RenderPipelineAsset*  pipelineAsset) ;

/// @brief Method add_beginCameraRendering, addr 0x4835ee4, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method get_currentPipeline, addr 0x4835dec, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RenderPipeline* get_currentPipeline() ;

/// @brief Method remove_beginCameraRendering, addr 0x4835fd8, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method set_currentPipeline, addr 0x4835e44, size 0xa0, virtual false, abstract: false, final false
