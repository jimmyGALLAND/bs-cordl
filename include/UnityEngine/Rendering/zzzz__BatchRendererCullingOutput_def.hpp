...
// Ctor Parameters [CppParam { name: "cullingJobsFence", ty: "::Unity::Jobs::JobHandle", modifiers: "", def_value: None }, CppParam { name: "localToWorldMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }, CppParam { name: "cullingPlanes", ty: "::cordl_internals::Ptr<::UnityEngine::Plane>", modifiers: "", def_value: None }, CppParam { name: "cullingPlaneCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "receiverPlaneOffset", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "receiverPlaneCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "cullingSplits", ty: "::cordl_internals::Ptr<::UnityEngine::Rendering::CullingSplit>", modifiers: "", def_value: None }, CppParam { name: "cullingSplitCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "viewType", ty: "::UnityEngine::Rendering::BatchCullingViewType", modifiers: "", def_value: None }, CppParam { name: "projectionType", ty: "::UnityEngine::Rendering::BatchCullingProjectionType", modifiers: "", def_value: None }, CppParam { name: "cullingFlags", ty: "::UnityEngine::Rendering::BatchCullingFlags", modifiers: "", def_value: None }, CppParam { name: "viewID", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "cullingLayerMask", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "sceneCullingMask", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "drawCommands", ty: "::cordl_internals::Ptr<::UnityEngine::Rendering::BatchCullingOutputDrawCommands>", modifiers: "", def_value: None }]
