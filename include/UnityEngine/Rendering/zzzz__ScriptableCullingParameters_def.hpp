...
/// @brief Method Equals, addr 0x4834fdc, size 0xe8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x4834b34, size 0x40c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::ScriptableCullingParameters  other) ;

/// @brief Method GetCullingPlane, addr 0x4834a00, size 0x134, virtual false, abstract: false, final false
inline ::UnityEngine::Plane GetCullingPlane(int32_t  index) ;

/// @brief Method GetHashCode, addr 0x48350c4, size 0x288, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetLayerCullingDistance, addr 0x4834928, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method get_cullingPlaneCount, addr 0x4834920, size 0x8, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::__ScriptableCullingParameters___m_CullingPlanes_e__FixedBuffer, "UnityEngine.Rendering", "ScriptableCullingParameters/<m_CullingPlanes>e__FixedBuffer");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Rendering::__ScriptableCullingParameters___m_LayerFarCullDistances_e__FixedBuffer, "UnityEngine.Rendering", "ScriptableCullingParameters/<m_LayerFarCullDistances>e__FixedBuffer");
