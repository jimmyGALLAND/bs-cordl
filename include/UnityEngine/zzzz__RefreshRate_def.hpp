...
/// @brief Method CompareTo, addr 0x47e13d8, size 0x50, virtual true, abstract: false, final true
inline int32_t CompareTo(::UnityEngine::RefreshRate  other) ;

/// @brief Method Equals, addr 0x47e139c, size 0x3c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::RefreshRate  other) ;

/// @brief Method ToString, addr 0x47e1428, size 0x9c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_value, addr 0x47e1388, size 0x14, virtual false, abstract: false, final false
