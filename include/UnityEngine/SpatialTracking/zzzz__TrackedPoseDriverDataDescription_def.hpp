...
static __declspec(property(get=getStaticF_DeviceData, put=setStaticF_DeviceData)) ::System::Collections::Generic::List_1<::UnityEngine::SpatialTracking::__TrackedPoseDriverDataDescription__PoseData>*  DeviceData;

static inline ::UnityEngine::SpatialTracking::TrackedPoseDriverDataDescription* New_ctor() ;

/// @brief Method .ctor, addr 0x488303c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
