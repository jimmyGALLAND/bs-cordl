...
public:
// Declarations
/// @brief Method .ctor, addr 0x47ceb6c, size 0x10, virtual false, abstract: false, final false
inline void _ctor(float_t  time, float_t  value) ;

/// @brief Method .ctor, addr 0x47ceb7c, size 0x14, virtual false, abstract: false, final false
