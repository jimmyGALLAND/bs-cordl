...
/// @brief Method Instantiate, addr 0x44606e0, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method Instantiate, addr 0x44606ac, size 0x34, virtual false, abstract: false, final false
inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityW<::UnityEngine::GameObject>> Instantiate(::UnityEngine::Vector3  position, ::UnityEngine::Quaternion  rotation, ::UnityEngine::Transform*  parent) ;

/// @brief Method InstantiateAsync, addr 0x4460a08, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method InstantiateAsync, addr 0x4460914, size 0xf4, virtual true, abstract: false, final false
...
/// @brief Method IsValid, addr 0x4460494, size 0xc, virtual false, abstract: false, final false
inline bool IsValid() ;
...
/// @brief Method LoadScene, addr 0x446066c, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method LoadSceneAsync, addr 0x4460718, size 0x160, virtual true, abstract: false, final false
...
/// @brief Method ReleaseAsset, addr 0x4460b34, size 0xec, virtual true, abstract: false, final false
inline void ReleaseAsset() ;

/// @brief Method ReleaseInstance, addr 0x4460c20, size 0x54, virtual true, abstract: false, final false
inline void ReleaseInstance(::UnityEngine::GameObject*  obj) ;

/// @brief Method RuntimeKeyIsValid, addr 0x4460ab4, size 0x80, virtual true, abstract: false, final false
inline bool RuntimeKeyIsValid() ;

/// @brief Method ToString, addr 0x4460600, size 0x6c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method UnLoadScene, addr 0x4460878, size 0x9c, virtual true, abstract: false, final false
...
/// @brief Method ValidateAsset, addr 0x4460c74, size 0x8, virtual true, abstract: false, final false
inline bool ValidateAsset(::UnityEngine::Object*  obj) ;

/// @brief Method ValidateAsset, addr 0x4460c7c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44604ac, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x44604fc, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::StringW  guid) ;

/// @brief Method get_Asset, addr 0x4460560, size 0xa0, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Object> get_Asset() ;

/// @brief Method get_AssetGUID, addr 0x44603d0, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_AssetGUID() ;

/// @brief Method get_IsDone, addr 0x44604a0, size 0xc, virtual false, abstract: false, final false
inline bool get_IsDone() ;

/// @brief Method get_OperationHandle, addr 0x446030c, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle get_OperationHandle() ;

/// @brief Method get_RuntimeKey, addr 0x4460334, size 0x9c, virtual true, abstract: false, final false
inline ::System::Object* get_RuntimeKey() ;

/// @brief Method get_SubObjectName, addr 0x44603d8, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_SubObjectName() ;

/// @brief Method get_SubOjbectType, addr 0x44603e8, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method set_OperationHandle, addr 0x4460320, size 0x14, virtual false, abstract: false, final false
inline void set_OperationHandle(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle  value) ;

/// @brief Method set_SubObjectName, addr 0x44603e0, size 0x8, virtual true, abstract: false, final false
