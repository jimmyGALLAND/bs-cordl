...
// Type: UnityEngine.AddressableAssets::ResourceLocatorInfo
...
/// @brief Method UpdateContent, addr 0x444c368, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x444c32c, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_CanUpdateContent, addr 0x444af00, size 0x1a4, virtual false, abstract: false, final false
inline bool get_CanUpdateContent() ;

/// @brief Method get_CatalogLocation, addr 0x444c308, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* get_CatalogLocation() ;

/// @brief Method get_ContentUpdateAvailable, addr 0x444c318, size 0x8, virtual false, abstract: false, final false
inline bool get_ContentUpdateAvailable() ;

/// @brief Method get_HashLocation, addr 0x444b1a0, size 0x11c, virtual false, abstract: false, final false
inline ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* get_HashLocation() ;

/// @brief Method get_LocalHash, addr 0x444c2f8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_LocalHash() ;

/// @brief Method get_Locator, addr 0x444c2e8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator* get_Locator() ;

/// @brief Method set_CatalogLocation, addr 0x444c310, size 0x8, virtual false, abstract: false, final false
inline void set_CatalogLocation(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  value) ;

/// @brief Method set_ContentUpdateAvailable, addr 0x444c320, size 0xc, virtual false, abstract: false, final false
inline void set_ContentUpdateAvailable(bool  value) ;

/// @brief Method set_LocalHash, addr 0x444c300, size 0x8, virtual false, abstract: false, final false
inline void set_LocalHash(::StringW  value) ;

/// @brief Method set_Locator, addr 0x444c2f0, size 0x8, virtual false, abstract: false, final false
