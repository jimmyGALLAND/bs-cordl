...
/// @brief Method CompleteInternal, addr 0x4461700, size 0x90, virtual false, abstract: false, final false
inline void CompleteInternal(bool  result, bool  success, ::StringW  errorMsg) ;

/// @brief Method Destroy, addr 0x44619f4, size 0x7c, virtual true, abstract: false, final false
inline void Destroy() ;

/// @brief Method DetermineCacheDirsNotInUse, addr 0x4462680, size 0x40c, virtual false, abstract: false, final false
inline void DetermineCacheDirsNotInUse(::System::Collections::Generic::HashSet_1<::StringW>*  cacheDirsInUse) ;

/// @brief Method DetermineCacheDirsNotInUse, addr 0x4462acc, size 0x84, virtual false, abstract: false, final false
inline void DetermineCacheDirsNotInUse(::System::Object*  data) ;

/// @brief Method Execute, addr 0x4461b8c, size 0x1b8, virtual true, abstract: false, final false
inline void Execute() ;

/// @brief Method GetCacheDirsInUse, addr 0x4461d44, size 0x93c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::HashSet_1<::StringW>* GetCacheDirsInUse(::System::Collections::Generic::IList_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*  catalogOps) ;

/// @brief Method GetDependencies, addr 0x4461a70, size 0x11c, virtual true, abstract: false, final false
...
/// @brief Method InvokeWaitForCompletion, addr 0x4461790, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method RemoveCacheEntries, addr 0x4461860, size 0x194, virtual false, abstract: false, final false
inline void RemoveCacheEntries() ;

/// @brief Method Start, addr 0x445edf8, size 0x10c, virtual false, abstract: false, final false
inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<bool> Start(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::System::Collections::Generic::IList_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*>  depOp) ;

/// @brief Method UnityEngine.ResourceManagement.IUpdateReceiver.Update, addr 0x4462a8c, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x445ed50, size 0xa8, virtual false, abstract: false, final false
