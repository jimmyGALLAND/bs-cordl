...
/// @brief Method ReadInt32FromByteArray, addr 0x4465c10, size 0x74, virtual false, abstract: false, final false
static inline int32_t ReadInt32FromByteArray(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method ReadObjectFromByteArray, addr 0x4465d08, size 0x514, virtual false, abstract: false, final false
static inline ::System::Object* ReadObjectFromByteArray(::ArrayW<uint8_t,::Array<uint8_t>*>  keyData, int32_t  dataIndex) ;

/// @brief Method WriteInt32ToByteArray, addr 0x4465c84, size 0x84, virtual false, abstract: false, final false
static inline int32_t WriteInt32ToByteArray(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  val, int32_t  offset) ;

/// @brief Method WriteObjectToByteList, addr 0x446621c, size 0xad0, virtual false, abstract: false, final false
