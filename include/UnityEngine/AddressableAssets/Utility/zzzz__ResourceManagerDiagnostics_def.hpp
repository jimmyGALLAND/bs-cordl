...
/// @brief Field m_cachedDiagnosticInfo, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_cachedDiagnosticInfo, put=__cordl_internal_set_m_cachedDiagnosticInfo)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::AddressableAssets::Utility::DiagnosticInfo*>*  m_cachedDiagnosticInfo;

/// @brief Convert operator to "::System::IDisposable"
constexpr operator  ::System::IDisposable*() noexcept;

/// @brief Method CalculateCompletedOperationHashcode, addr 0x4465290, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method CalculateHashCode, addr 0x446514c, size 0x144, virtual false, abstract: false, final false
inline int32_t CalculateHashCode(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle  handle) ;

/// @brief Method Dispose, addr 0x4465b38, size 0xd8, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GenerateCompletedOperationDisplayName, addr 0x446531c, size 0x44c, virtual false, abstract: false, final false
...
/// @brief Method OnResourceManagerDiagnosticEvent, addr 0x4465768, size 0x3d0, virtual false, abstract: false, final false
...
/// @brief Method SumDependencyNameHashCodes, addr 0x4464f20, size 0x22c, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::AddressableAssets::Utility::DiagnosticInfo*>*> const& __cordl_internal_get_m_cachedDiagnosticInfo() const;
...
/// @brief Method .ctor, addr 0x4464e34, size 0xec, virtual false, abstract: false, final false
