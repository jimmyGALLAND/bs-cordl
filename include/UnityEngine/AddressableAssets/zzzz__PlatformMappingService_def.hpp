...
static __declspec(property(get=getStaticF_s_RuntimeTargetMapping, put=setStaticF_s_RuntimeTargetMapping)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::RuntimePlatform,::UnityEngine::AddressableAssets::AddressablesPlatform>*  s_RuntimeTargetMapping;

/// @brief Method GetAddressablesPlatformInternal, addr 0x446499c, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method GetAddressablesPlatformPathInternal, addr 0x4464a70, size 0x120, virtual false, abstract: false, final false
static inline ::StringW GetAddressablesPlatformPathInternal(::UnityEngine::RuntimePlatform  platform) ;

/// @brief Method GetPlatform, addr 0x4464b90, size 0x84, virtual false, abstract: false, final false
static inline ::UnityEngine::AddressableAssets::AddressablesPlatform GetPlatform() ;

/// @brief Method GetPlatformPathSubFolder, addr 0x4458b14, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4464c14, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
