...
/// @brief Method ValidateAsset, addr 0x446028c, size 0x78, virtual true, abstract: false, final false
inline bool ValidateAsset(::UnityEngine::Object*  obj) ;

/// @brief Method ValidateAsset, addr 0x4460304, size 0x8, virtual true, abstract: false, final false
inline bool ValidateAsset(::StringW  path) ;

/// @brief Method .ctor, addr 0x4460234, size 0x58, virtual false, abstract: false, final false
