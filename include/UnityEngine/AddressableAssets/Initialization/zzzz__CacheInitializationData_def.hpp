...
/// @brief Method .ctor, addr 0x446dfdc, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CacheDirectoryOverride, addr 0x446df98, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_CacheDirectoryOverride() ;

/// @brief Method get_CompressionEnabled, addr 0x446df84, size 0x8, virtual false, abstract: false, final false
inline bool get_CompressionEnabled() ;

/// @brief Method get_ExpirationDelay, addr 0x446dfa8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ExpirationDelay() ;

/// @brief Method get_LimitCacheSize, addr 0x446dfb8, size 0x8, virtual false, abstract: false, final false
inline bool get_LimitCacheSize() ;

/// @brief Method get_MaximumCacheSize, addr 0x446dfcc, size 0x8, virtual false, abstract: false, final false
inline int64_t get_MaximumCacheSize() ;

/// @brief Method set_CacheDirectoryOverride, addr 0x446dfa0, size 0x8, virtual false, abstract: false, final false
inline void set_CacheDirectoryOverride(::StringW  value) ;

/// @brief Method set_CompressionEnabled, addr 0x446df8c, size 0xc, virtual false, abstract: false, final false
inline void set_CompressionEnabled(bool  value) ;

/// @brief Method set_ExpirationDelay, addr 0x446dfb0, size 0x8, virtual false, abstract: false, final false
inline void set_ExpirationDelay(int32_t  value) ;

/// @brief Method set_LimitCacheSize, addr 0x446dfc0, size 0xc, virtual false, abstract: false, final false
inline void set_LimitCacheSize(bool  value) ;

/// @brief Method set_MaximumCacheSize, addr 0x446dfd4, size 0x8, virtual false, abstract: false, final false
