...
/// @brief Method ClearCachedPropertyValues, addr 0x446ce84, size 0x78, virtual false, abstract: false, final false
static inline void ClearCachedPropertyValues() ;

/// @brief Method EvaluateProperty, addr 0x446cefc, size 0x438, virtual false, abstract: false, final false
static inline ::StringW EvaluateProperty(::StringW  name) ;

/// @brief Method EvaluateString, addr 0x4458b98, size 0xac, virtual false, abstract: false, final false
static inline ::StringW EvaluateString(::StringW  input) ;

/// @brief Method EvaluateString, addr 0x446d334, size 0x594, virtual false, abstract: false, final false
...
/// @brief Method GetAssemblies, addr 0x446cd5c, size 0x20, virtual false, abstract: false, final false
static inline ::ArrayW<::System::Reflection::Assembly*,::Array<::System::Reflection::Assembly*>*> GetAssemblies() ;

/// @brief Method GetCachedValueCount, addr 0x446cd7c, size 0x78, virtual false, abstract: false, final false
static inline int32_t GetCachedValueCount() ;

/// @brief Method SetPropertyValue, addr 0x446cdf4, size 0x90, virtual false, abstract: false, final false
