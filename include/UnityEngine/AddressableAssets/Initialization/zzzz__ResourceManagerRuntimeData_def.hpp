...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::AddressableAssets::ResourceLocators::ResourceLocationData*>*> const& __cordl_internal_get_m_CatalogLocations() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::ObjectInitializationData>*> const& __cordl_internal_get_m_ExtraInitializationData() const;
...
/// @brief Method .ctor, addr 0x4470f94, size 0xd4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AddressablesVersion, addr 0x4470f3c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_AddressablesVersion() ;

/// @brief Method get_BuildTarget, addr 0x4470eb0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_BuildTarget() ;

/// @brief Method get_CatalogLocations, addr 0x4470ed0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_CatalogRequestsTimeout, addr 0x4470f70, size 0x8, virtual false, abstract: false, final false
inline int32_t get_CatalogRequestsTimeout() ;

/// @brief Method get_CertificateHandlerType, addr 0x446f67c, size 0xc, virtual false, abstract: false, final false
inline ::System::Type* get_CertificateHandlerType() ;

/// @brief Method get_DisableCatalogUpdateOnStartup, addr 0x4470f08, size 0x8, virtual false, abstract: false, final false
inline bool get_DisableCatalogUpdateOnStartup() ;

/// @brief Method get_InitializationObjects, addr 0x4470f00, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_IsLocalCatalogInBundle, addr 0x4470f1c, size 0x8, virtual false, abstract: false, final false
inline bool get_IsLocalCatalogInBundle() ;

/// @brief Method get_LogResourceManagerExceptions, addr 0x4470eec, size 0x8, virtual false, abstract: false, final false
inline bool get_LogResourceManagerExceptions() ;

/// @brief Method get_MaxConcurrentWebRequests, addr 0x4470f4c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxConcurrentWebRequests() ;

/// @brief Method get_ProfileEvents, addr 0x4470ed8, size 0x8, virtual false, abstract: false, final false
inline bool get_ProfileEvents() ;

/// @brief Method get_SettingsHash, addr 0x4470ec0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SettingsHash() ;

/// @brief Method set_AddressablesVersion, addr 0x4470f44, size 0x8, virtual false, abstract: false, final false
inline void set_AddressablesVersion(::StringW  value) ;

/// @brief Method set_BuildTarget, addr 0x4470eb8, size 0x8, virtual false, abstract: false, final false
inline void set_BuildTarget(::StringW  value) ;

/// @brief Method set_CatalogRequestsTimeout, addr 0x4470f78, size 0x1c, virtual false, abstract: false, final false
inline void set_CatalogRequestsTimeout(int32_t  value) ;

/// @brief Method set_CertificateHandlerType, addr 0x4470f30, size 0xc, virtual false, abstract: false, final false
inline void set_CertificateHandlerType(::System::Type*  value) ;

/// @brief Method set_DisableCatalogUpdateOnStartup, addr 0x4470f10, size 0xc, virtual false, abstract: false, final false
inline void set_DisableCatalogUpdateOnStartup(bool  value) ;

/// @brief Method set_IsLocalCatalogInBundle, addr 0x4470f24, size 0xc, virtual false, abstract: false, final false
inline void set_IsLocalCatalogInBundle(bool  value) ;

/// @brief Method set_LogResourceManagerExceptions, addr 0x4470ef4, size 0xc, virtual false, abstract: false, final false
inline void set_LogResourceManagerExceptions(bool  value) ;

/// @brief Method set_MaxConcurrentWebRequests, addr 0x4470f54, size 0x1c, virtual false, abstract: false, final false
inline void set_MaxConcurrentWebRequests(int32_t  value) ;

/// @brief Method set_ProfileEvents, addr 0x4470ee0, size 0xc, virtual false, abstract: false, final false
inline void set_ProfileEvents(bool  value) ;

/// @brief Method set_SettingsHash, addr 0x4470ec8, size 0x8, virtual false, abstract: false, final false
