...
/// @brief Method Execute, addr 0x446dec8, size 0x98, virtual true, abstract: false, final false
inline void Execute() ;

/// @brief Method Init, addr 0x446dd70, size 0x8, virtual false, abstract: false, final false
inline void Init(::System::Func_1<bool>*  callback) ;

/// @brief Method InvokeWaitForCompletion, addr 0x446dd78, size 0x94, virtual true, abstract: false, final false
inline bool InvokeWaitForCompletion() ;

static inline ::UnityEngine::AddressableAssets::Initialization::__CacheInitialization__CacheInitOp* New_ctor() ;

/// @brief Method Update, addr 0x446de0c, size 0xbc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x446dca0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <InitializeAsync>b__0, addr 0x446df60, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x446dc98, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Initialize, addr 0x446da00, size 0x148, virtual true, abstract: false, final true
inline bool Initialize(::StringW  id, ::StringW  dataStr) ;

/// @brief Method InitializeAsync, addr 0x446db48, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x446dd68, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_RootPath, addr 0x446dcf0, size 0x78, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::AddressableAssets::Initialization::__CacheInitialization____c__DisplayClass1_0*, "UnityEngine.AddressableAssets.Initialization", "CacheInitialization/<>c__DisplayClass1_0");
