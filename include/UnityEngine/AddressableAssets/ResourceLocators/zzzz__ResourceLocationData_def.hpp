...
/// @brief Method .ctor, addr 0x446c118, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method get_Data, addr 0x446c02c, size 0x40, virtual false, abstract: false, final false
inline ::System::Object* get_Data() ;

/// @brief Method get_Dependencies, addr 0x446c018, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_Dependencies() ;

/// @brief Method get_InternalId, addr 0x446c008, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_InternalId() ;

/// @brief Method get_Keys, addr 0x446c000, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_Keys() ;

/// @brief Method get_Provider, addr 0x446c010, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Provider() ;

/// @brief Method get_ResourceType, addr 0x446c020, size 0xc, virtual false, abstract: false, final false
inline ::System::Type* get_ResourceType() ;

/// @brief Method set_Data, addr 0x446c06c, size 0xac, virtual false, abstract: false, final false
