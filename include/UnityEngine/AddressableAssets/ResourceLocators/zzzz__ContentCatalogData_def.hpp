...
/// @brief Method Hash, addr 0x446bbe4, size 0x54, virtual true, abstract: false, final true
...
/// @brief Method ToString, addr 0x446bbdc, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x446a29c, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method get_Data, addr 0x446bbbc, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_Data() ;

/// @brief Method get_Dependencies, addr 0x446baf0, size 0xb4, virtual true, abstract: false, final true
...
/// @brief Method get_DependencyHashCode, addr 0x446bbb4, size 0x8, virtual true, abstract: false, final true
inline int32_t get_DependencyHashCode() ;

/// @brief Method get_HasDependencies, addr 0x446bba4, size 0x10, virtual true, abstract: false, final true
inline bool get_HasDependencies() ;

/// @brief Method get_InternalId, addr 0x446bae0, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_InternalId() ;

/// @brief Method get_PrimaryKey, addr 0x446bbc4, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_PrimaryKey() ;

/// @brief Method get_ProviderId, addr 0x446bae8, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_ProviderId() ;

/// @brief Method get_ResourceType, addr 0x446bbd4, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_PrimaryKey, addr 0x446bbcc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <GetData>b__45_0, addr 0x446bc9c, size 0xa0, virtual false, abstract: false, final false
inline ::StringW _GetData_b__45_0(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  d) ;

/// @brief Method .ctor, addr 0x446bc94, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_Entries, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Entries, put=__cordl_internal_set_m_Entries)) ::System::Collections::Generic::IList_1<::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogDataEntry*>*  m_Entries;
...
/// @brief Field m_InstanceProviderData, offset 0x30, size 0x30 
 __declspec(property(get=__cordl_internal_get_m_InstanceProviderData, put=__cordl_internal_set_m_InstanceProviderData)) ::UnityEngine::ResourceManagement::Util::ObjectInitializationData  m_InstanceProviderData;
...
/// @brief Field m_ResourceProviderData, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ResourceProviderData, put=__cordl_internal_set_m_ResourceProviderData)) ::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::ObjectInitializationData>*  m_ResourceProviderData;

/// @brief Field m_SceneProviderData, offset 0x60, size 0x30 
 __declspec(property(get=__cordl_internal_get_m_SceneProviderData, put=__cordl_internal_set_m_SceneProviderData)) ::UnityEngine::ResourceManagement::Util::ObjectInitializationData  m_SceneProviderData;

/// @brief Field m_resourceTypes, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_resourceTypes, put=__cordl_internal_set_m_resourceTypes)) ::ArrayW<::UnityEngine::ResourceManagement::Util::SerializedType,::Array<::UnityEngine::ResourceManagement::Util::SerializedType>*>  m_resourceTypes;

/// @brief Method CleanData, addr 0x4468020, size 0x5c, virtual false, abstract: false, final false
inline void CleanData() ;

/// @brief Method CreateCustomLocator, addr 0x4462b50, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method CreateLocator, addr 0x4469a00, size 0x73c, virtual false, abstract: false, final false
inline ::UnityEngine::AddressableAssets::ResourceLocators::ResourceLocationMap* CreateLocator(::StringW  providerSuffix) ;

/// @brief Method ExpandInternalId, addr 0x446a1e0, size 0xbc, virtual false, abstract: false, final false
static inline ::StringW ExpandInternalId(::ArrayW<::StringW,::Array<::StringW>*>  internalIdPrefixes, ::StringW  v) ;

/// @brief Method GetData, addr 0x446a438, size 0xd6c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IList_1<::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogDataEntry*>* GetData() ;

/// @brief Method LoadFromFile, addr 0x446998c, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method SaveToFile, addr 0x44699dc, size 0x24, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<::UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogDataEntry*>*> const& __cordl_internal_get_m_Entries() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::ObjectInitializationData>*> const& __cordl_internal_get_m_ResourceProviderData() const;
...
/// @brief Method .ctor, addr 0x4469900, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4469878, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::StringW  id) ;

static inline int32_t getStaticF_kMagic() ;

/// @brief Method get_InstanceProviderData, addr 0x4469818, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::ResourceManagement::Util::ObjectInitializationData get_InstanceProviderData() ;

/// @brief Method get_InternalIds, addr 0x4469984, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_InternalIds() ;

/// @brief Method get_ProviderId, addr 0x4469808, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ProviderId() ;

/// @brief Method get_ProviderIds, addr 0x446997c, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_ProviderIds() ;

/// @brief Method get_ResourceProviderData, addr 0x4469868, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_SceneProviderData, addr 0x4469840, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method set_InstanceProviderData, addr 0x446982c, size 0x14, virtual false, abstract: false, final false
inline void set_InstanceProviderData(::UnityEngine::ResourceManagement::Util::ObjectInitializationData  value) ;

/// @brief Method set_ProviderId, addr 0x4469810, size 0x8, virtual false, abstract: false, final false
inline void set_ProviderId(::StringW  value) ;

/// @brief Method set_ResourceProviderData, addr 0x4469870, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_SceneProviderData, addr 0x4469854, size 0x14, virtual false, abstract: false, final false
