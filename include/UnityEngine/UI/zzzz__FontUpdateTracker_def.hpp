...
static __declspec(property(get=getStaticF_m_Tracked, put=setStaticF_m_Tracked)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Font>,::System::Collections::Generic::HashSet_1<::UnityW<::UnityEngine::UI::Text>>*>*  m_Tracked;

/// @brief Method RebuildForFont, addr 0x48cb4a8, size 0x1a4, virtual false, abstract: false, final false
static inline void RebuildForFont(::UnityEngine::Font*  f) ;

/// @brief Method TrackText, addr 0x48cb260, size 0x248, virtual false, abstract: false, final false
static inline void TrackText(::UnityEngine::UI::Text*  t) ;

/// @brief Method UntrackText, addr 0x48cb64c, size 0x208, virtual false, abstract: false, final false
