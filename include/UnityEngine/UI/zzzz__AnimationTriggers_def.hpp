...
/// @brief Method .ctor, addr 0x48c0e40, size 0xc8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disabledTrigger, addr 0x48c0e30, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_disabledTrigger() ;

/// @brief Method get_highlightedTrigger, addr 0x48c0e00, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_highlightedTrigger() ;

/// @brief Method get_normalTrigger, addr 0x48c0df0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_normalTrigger() ;

/// @brief Method get_pressedTrigger, addr 0x48c0e10, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_pressedTrigger() ;

/// @brief Method get_selectedTrigger, addr 0x48c0e20, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_selectedTrigger() ;

/// @brief Method set_disabledTrigger, addr 0x48c0e38, size 0x8, virtual false, abstract: false, final false
inline void set_disabledTrigger(::StringW  value) ;

/// @brief Method set_highlightedTrigger, addr 0x48c0e08, size 0x8, virtual false, abstract: false, final false
inline void set_highlightedTrigger(::StringW  value) ;

/// @brief Method set_normalTrigger, addr 0x48c0df8, size 0x8, virtual false, abstract: false, final false
inline void set_normalTrigger(::StringW  value) ;

/// @brief Method set_pressedTrigger, addr 0x48c0e18, size 0x8, virtual false, abstract: false, final false
inline void set_pressedTrigger(::StringW  value) ;

/// @brief Method set_selectedTrigger, addr 0x48c0e28, size 0x8, virtual false, abstract: false, final false
