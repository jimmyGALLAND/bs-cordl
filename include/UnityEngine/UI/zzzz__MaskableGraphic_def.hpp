...
/// @brief Method .ctor, addr 0x4a29e10, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_OnCullStateChanged, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_OnCullStateChanged, put=__cordl_internal_set_m_OnCullStateChanged)) ::UnityEngine::UI::__MaskableGraphic__CullStateChangedEvent*  m_OnCullStateChanged;
...
/// @brief Method Cull, addr 0x4a291bc, size 0xd0, virtual true, abstract: false, final false
inline void Cull(::UnityEngine::Rect  clipRect, bool  validRect) ;

/// @brief Method GetModifiedMaterial, addr 0x4a290bc, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method OnCanvasHierarchyChanged, addr 0x4a29870, size 0x50, virtual true, abstract: false, final false
inline void OnCanvasHierarchyChanged() ;

/// @brief Method OnDisable, addr 0x4a29770, size 0xac, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x4a295cc, size 0x50, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnTransformParentChanged, addr 0x4a2981c, size 0x50, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method ParentMaskStateChanged, addr 0x4a2986c, size 0x4, virtual true, abstract: false, final false
inline void ParentMaskStateChanged() ;

/// @brief Method RecalculateClipping, addr 0x4a29cd4, size 0x4, virtual true, abstract: false, final false
inline void RecalculateClipping() ;

/// @brief Method RecalculateMasking, addr 0x4a29cd8, size 0x7c, virtual true, abstract: false, final false
inline void RecalculateMasking() ;

/// @brief Method SetClipRect, addr 0x4a29528, size 0x6c, virtual true, abstract: false, final false
inline void SetClipRect(::UnityEngine::Rect  clipRect, bool  validRect) ;

/// @brief Method SetClipSoftness, addr 0x4a29594, size 0x38, virtual true, abstract: false, final false
inline void SetClipSoftness(::UnityEngine::Vector2  clipSoftness) ;

/// @brief Method UnityEngine.UI.IClippable.get_gameObject, addr 0x4a29e58, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::GameObject> UnityEngine_UI_IClippable_get_gameObject() ;

/// @brief Method UpdateClipParent, addr 0x4a2961c, size 0x154, virtual false, abstract: false, final false
inline void UpdateClipParent() ;

/// @brief Method UpdateCull, addr 0x4a29444, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a29d54, size 0xbc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isMaskingGraphic, addr 0x4a290b4, size 0x8, virtual false, abstract: false, final false
inline bool get_isMaskingGraphic() ;

/// @brief Method get_maskable, addr 0x4a2907c, size 0x8, virtual false, abstract: false, final false
inline bool get_maskable() ;

/// @brief Method get_onCullStateChanged, addr 0x4a2906c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::__MaskableGraphic__CullStateChangedEvent* get_onCullStateChanged() ;

/// @brief Method get_rootCanvasRect, addr 0x4a2928c, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method set_isMaskingGraphic, addr 0x4a284d0, size 0x18, virtual false, abstract: false, final false
inline void set_isMaskingGraphic(bool  value) ;

/// @brief Method set_maskable, addr 0x4a29084, size 0x30, virtual false, abstract: false, final false
inline void set_maskable(bool  value) ;

/// @brief Method set_onCullStateChanged, addr 0x4a29074, size 0x8, virtual false, abstract: false, final false
