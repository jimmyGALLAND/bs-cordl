...
/// @brief Method <ActiveToggles>b__14_0, addr 0x4a398f0, size 0x18, virtual false, abstract: false, final false
inline bool _ActiveToggles_b__14_0(::UnityEngine::UI::Toggle*  x) ;

/// @brief Method <AnyTogglesOn>b__13_0, addr 0x4a398d8, size 0x18, virtual false, abstract: false, final false
inline bool _AnyTogglesOn_b__13_0(::UnityEngine::UI::Toggle*  x) ;

/// @brief Method .ctor, addr 0x4a398d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ActiveToggles, addr 0x4a39600, size 0xf4, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::UI::Toggle>>* ActiveToggles() ;

/// @brief Method AnyTogglesOn, addr 0x4a39224, size 0x138, virtual false, abstract: false, final false
inline bool AnyTogglesOn() ;

/// @brief Method EnsureValidState, addr 0x4a388c4, size 0x3f0, virtual false, abstract: false, final false
inline void EnsureValidState() ;

/// @brief Method GetFirstActiveToggle, addr 0x4a396f4, size 0x88, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Toggle> GetFirstActiveToggle() ;

static inline ::UnityEngine::UI::ToggleGroup* New_ctor() ;

/// @brief Method NotifyToggleOn, addr 0x4a390f8, size 0x10c, virtual false, abstract: false, final false
inline void NotifyToggleOn(::UnityEngine::UI::Toggle*  toggle, bool  sendCallback) ;

/// @brief Method OnEnable, addr 0x4a39494, size 0x1c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RegisterToggle, addr 0x4a39028, size 0xd0, virtual false, abstract: false, final false
inline void RegisterToggle(::UnityEngine::UI::Toggle*  toggle) ;

/// @brief Method SetAllTogglesOff, addr 0x4a3977c, size 0xf8, virtual false, abstract: false, final false
inline void SetAllTogglesOff(bool  sendCallback) ;

/// @brief Method Start, addr 0x4a39478, size 0x1c, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method UnregisterToggle, addr 0x4a38f98, size 0x90, virtual false, abstract: false, final false
inline void UnregisterToggle(::UnityEngine::UI::Toggle*  toggle) ;

/// @brief Method ValidateToggleIsInGroup, addr 0x4a394b0, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a393fc, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowSwitchOff, addr 0x4a393e8, size 0x8, virtual false, abstract: false, final false
inline bool get_allowSwitchOff() ;

/// @brief Method set_allowSwitchOff, addr 0x4a393f0, size 0xc, virtual false, abstract: false, final false
