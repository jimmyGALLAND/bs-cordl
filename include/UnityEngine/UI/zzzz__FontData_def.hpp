...
/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x48cb21c, size 0x44, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x48cb218, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x48cb144, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_alignByGeometry, addr 0x48cb1c0, size 0x8, virtual false, abstract: false, final false
inline bool get_alignByGeometry() ;

/// @brief Method get_alignment, addr 0x48cb1b0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::TextAnchor get_alignment() ;

/// @brief Method get_bestFit, addr 0x48cb17c, size 0x8, virtual false, abstract: false, final false
inline bool get_bestFit() ;

/// @brief Method get_defaultFontData, addr 0x48cb0b4, size 0x90, virtual false, abstract: false, final false
static inline ::UnityEngine::UI::FontData* get_defaultFontData() ;

/// @brief Method get_font, addr 0x48cb14c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Font> get_font() ;

/// @brief Method get_fontSize, addr 0x48cb15c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_fontSize() ;

/// @brief Method get_fontStyle, addr 0x48cb16c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::FontStyle get_fontStyle() ;

/// @brief Method get_horizontalOverflow, addr 0x48cb1e8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::HorizontalWrapMode get_horizontalOverflow() ;

/// @brief Method get_lineSpacing, addr 0x48cb208, size 0x8, virtual false, abstract: false, final false
inline float_t get_lineSpacing() ;

/// @brief Method get_maxSize, addr 0x48cb1a0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxSize() ;

/// @brief Method get_minSize, addr 0x48cb190, size 0x8, virtual false, abstract: false, final false
inline int32_t get_minSize() ;

/// @brief Method get_richText, addr 0x48cb1d4, size 0x8, virtual false, abstract: false, final false
inline bool get_richText() ;

/// @brief Method get_verticalOverflow, addr 0x48cb1f8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::VerticalWrapMode get_verticalOverflow() ;

/// @brief Convert to "::UnityEngine::ISerializationCallbackReceiver"
constexpr ::UnityEngine::ISerializationCallbackReceiver* i___UnityEngine__ISerializationCallbackReceiver() noexcept;

/// @brief Method set_alignByGeometry, addr 0x48cb1c8, size 0xc, virtual false, abstract: false, final false
inline void set_alignByGeometry(bool  value) ;

/// @brief Method set_alignment, addr 0x48cb1b8, size 0x8, virtual false, abstract: false, final false
inline void set_alignment(::UnityEngine::TextAnchor  value) ;

/// @brief Method set_bestFit, addr 0x48cb184, size 0xc, virtual false, abstract: false, final false
inline void set_bestFit(bool  value) ;

/// @brief Method set_font, addr 0x48cb154, size 0x8, virtual false, abstract: false, final false
inline void set_font(::UnityEngine::Font*  value) ;

/// @brief Method set_fontSize, addr 0x48cb164, size 0x8, virtual false, abstract: false, final false
inline void set_fontSize(int32_t  value) ;

/// @brief Method set_fontStyle, addr 0x48cb174, size 0x8, virtual false, abstract: false, final false
inline void set_fontStyle(::UnityEngine::FontStyle  value) ;

/// @brief Method set_horizontalOverflow, addr 0x48cb1f0, size 0x8, virtual false, abstract: false, final false
inline void set_horizontalOverflow(::UnityEngine::HorizontalWrapMode  value) ;

/// @brief Method set_lineSpacing, addr 0x48cb210, size 0x8, virtual false, abstract: false, final false
inline void set_lineSpacing(float_t  value) ;

/// @brief Method set_maxSize, addr 0x48cb1a8, size 0x8, virtual false, abstract: false, final false
inline void set_maxSize(int32_t  value) ;

/// @brief Method set_minSize, addr 0x48cb198, size 0x8, virtual false, abstract: false, final false
inline void set_minSize(int32_t  value) ;

/// @brief Method set_richText, addr 0x48cb1dc, size 0xc, virtual false, abstract: false, final false
inline void set_richText(bool  value) ;

/// @brief Method set_verticalOverflow, addr 0x48cb200, size 0x8, virtual false, abstract: false, final false
