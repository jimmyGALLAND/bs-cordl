...
/// @brief Method AddClippable, addr 0x4a2cc60, size 0x114, virtual false, abstract: false, final false
inline void AddClippable(::UnityEngine::UI::IClippable*  clippable) ;

/// @brief Method IsRaycastLocationValid, addr 0x4a2bf74, size 0xdc, virtual true, abstract: false, final false
...
/// @brief Method OnCanvasHierarchyChanged, addr 0x4a2cf38, size 0x24, virtual true, abstract: false, final false
inline void OnCanvasHierarchyChanged() ;

/// @brief Method OnDestroy, addr 0x4a2bf54, size 0x20, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x4a2be84, size 0xd0, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x4a2be50, size 0x34, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnTransformParentChanged, addr 0x4a2cf14, size 0x24, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method PerformClipping, addr 0x4a2c14c, size 0x81c, virtual true, abstract: false, final false
inline void PerformClipping() ;

/// @brief Method RemoveClippable, addr 0x4a2cd74, size 0x1a0, virtual false, abstract: false, final false
inline void RemoveClippable(::UnityEngine::UI::IClippable*  clippable) ;

/// @brief Method UpdateClipSoftness, addr 0x4a2c968, size 0x2f8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a2bcec, size 0x164, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Canvas, addr 0x4a2baf0, size 0x160, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Canvas> get_Canvas() ;

/// @brief Method get_canvasRect, addr 0x4a2bc50, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_canvasRect() ;

/// @brief Method get_padding, addr 0x4a2bab4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_padding() ;

/// @brief Method get_rectTransform, addr 0x4a2bc94, size 0x58, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform() ;

/// @brief Method get_rootCanvasRect, addr 0x4a2c050, size 0xfc, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_rootCanvasRect() ;

/// @brief Method get_softness, addr 0x4a2bad0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_padding, addr 0x4a2bac0, size 0x10, virtual false, abstract: false, final false
inline void set_padding(::UnityEngine::Vector4  value) ;

/// @brief Method set_softness, addr 0x4a2bad8, size 0x18, virtual false, abstract: false, final false
