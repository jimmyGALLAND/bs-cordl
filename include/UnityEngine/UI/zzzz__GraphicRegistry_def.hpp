...
/// @brief Method DisableGraphicForCanvas, addr 0x48cd0b8, size 0x180, virtual false, abstract: false, final false
static inline void DisableGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method DisableRaycastGraphicForCanvas, addr 0x48d0740, size 0x180, virtual false, abstract: false, final false
static inline void DisableRaycastGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method GetGraphicsForCanvas, addr 0x48d08c0, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method GetRaycastableGraphicsForCanvas, addr 0x48cfcd4, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method RegisterGraphicForCanvas, addr 0x48cc820, size 0x1ec, virtual false, abstract: false, final false
static inline void RegisterGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method RegisterRaycastGraphicForCanvas, addr 0x48cbcd4, size 0x1ec, virtual false, abstract: false, final false
static inline void RegisterRaycastGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method UnregisterGraphicForCanvas, addr 0x48cc458, size 0x1a4, virtual false, abstract: false, final false
static inline void UnregisterGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method UnregisterRaycastGraphicForCanvas, addr 0x48cbb58, size 0x17c, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Canvas>,::UnityEngine::UI::Collections::IndexedSet_1<::UnityW<::UnityEngine::UI::Graphic>>*>*> const& __cordl_internal_get_m_Graphics() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Canvas>,::UnityEngine::UI::Collections::IndexedSet_1<::UnityW<::UnityEngine::UI::Graphic>>*>*> const& __cordl_internal_get_m_RaycastableGraphics() const;
...
/// @brief Method .ctor, addr 0x48d04f8, size 0x1a8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_instance, addr 0x48d06a0, size 0xa0, virtual false, abstract: false, final false
