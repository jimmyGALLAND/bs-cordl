...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<T,int32_t>*> const& UnityEngine::UI::Collections::IndexedSet_1<T>::__cordl_internal_get_m_Dictionary() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_Dictionary;
}
template<typename T>
...
template<typename T>
inline void UnityEngine::UI::Collections::IndexedSet_1<T>::CopyTo(::ArrayW<T,::Array<T>*>  array, int32_t  arrayIndex)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UI::Collections::IndexedSet_1<T>*>::get(),
                        "CopyTo",
                        std::span<const Il2CppClass* const, 0>(),
