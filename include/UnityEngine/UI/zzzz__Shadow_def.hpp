...
/// @brief Method ApplyShadow, addr 0x4a3d024, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ApplyShadowZeroAlloc, addr 0x4a3cd2c, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method ModifyMesh, addr 0x4a3d02c, size 0x120, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a3ca58, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_effectColor, addr 0x4a3ca80, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_effectColor() ;

/// @brief Method get_effectDistance, addr 0x4a3cb60, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_effectDistance() ;

/// @brief Method get_useGraphicAlpha, addr 0x4a3cc6c, size 0x8, virtual false, abstract: false, final false
inline bool get_useGraphicAlpha() ;

/// @brief Method set_effectColor, addr 0x4a3ca8c, size 0xd4, virtual false, abstract: false, final false
inline void set_effectColor(::UnityEngine::Color  value) ;

/// @brief Method set_effectDistance, addr 0x4a3cb68, size 0x104, virtual false, abstract: false, final false
inline void set_effectDistance(::UnityEngine::Vector2  value) ;

/// @brief Method set_useGraphicAlpha, addr 0x4a3cc74, size 0xb8, virtual false, abstract: false, final false
