...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::Material> (::UnityEngine::UI::IMaterialModifier::*)(::UnityEngine::Material*)>(&::UnityEngine::UI::IMaterialModifier::GetModifiedMaterial)> {
