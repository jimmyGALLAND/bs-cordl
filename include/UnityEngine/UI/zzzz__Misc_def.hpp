...
public:
// Declarations
/// @brief Method Destroy, addr 0x4a2a57c, size 0x124, virtual false, abstract: false, final false
static inline void Destroy(::UnityEngine::Object*  obj) ;

/// @brief Method DestroyImmediate, addr 0x4a2a6a0, size 0xcc, virtual false, abstract: false, final false
