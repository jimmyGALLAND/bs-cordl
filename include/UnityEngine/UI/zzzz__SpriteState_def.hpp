...
/// @brief Method Equals, addr 0x4a35c18, size 0x108, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UI::SpriteState  other) ;

/// @brief Method get_disabledSprite, addr 0x4a35c08, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_disabledSprite() ;

/// @brief Method get_highlightedSprite, addr 0x4a35bd8, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_highlightedSprite() ;

/// @brief Method get_pressedSprite, addr 0x4a35be8, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_pressedSprite() ;

/// @brief Method get_selectedSprite, addr 0x4a35bf8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_disabledSprite, addr 0x4a35c10, size 0x8, virtual false, abstract: false, final false
inline void set_disabledSprite(::UnityEngine::Sprite*  value) ;

/// @brief Method set_highlightedSprite, addr 0x4a35be0, size 0x8, virtual false, abstract: false, final false
inline void set_highlightedSprite(::UnityEngine::Sprite*  value) ;

/// @brief Method set_pressedSprite, addr 0x4a35bf0, size 0x8, virtual false, abstract: false, final false
inline void set_pressedSprite(::UnityEngine::Sprite*  value) ;

/// @brief Method set_selectedSprite, addr 0x4a35c00, size 0x8, virtual false, abstract: false, final false
