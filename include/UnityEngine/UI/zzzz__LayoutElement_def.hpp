...
/// @brief Method CalculateLayoutInputHorizontal, addr 0x4a2511c, size 0x4, virtual true, abstract: false, final false
inline void CalculateLayoutInputHorizontal() ;

/// @brief Method CalculateLayoutInputVertical, addr 0x4a25120, size 0x4, virtual true, abstract: false, final false
inline void CalculateLayoutInputVertical() ;

static inline ::UnityEngine::UI::LayoutElement* New_ctor() ;

/// @brief Method OnBeforeTransformParentChanged, addr 0x4a254e8, size 0x4, virtual true, abstract: false, final false
inline void OnBeforeTransformParentChanged() ;

/// @brief Method OnDidApplyAnimationProperties, addr 0x4a254e4, size 0x4, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x4a254c8, size 0x1c, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x4a254a8, size 0x1c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnTransformParentChanged, addr 0x4a254c4, size 0x4, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method SetDirty, addr 0x4a25064, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a25488, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_flexibleHeight, addr 0x4a25390, size 0x8, virtual true, abstract: false, final false
inline float_t get_flexibleHeight() ;

/// @brief Method get_flexibleWidth, addr 0x4a25314, size 0x8, virtual true, abstract: false, final false
inline float_t get_flexibleWidth() ;

/// @brief Method get_ignoreLayout, addr 0x4a24fe8, size 0x8, virtual true, abstract: false, final false
inline bool get_ignoreLayout() ;

/// @brief Method get_layoutPriority, addr 0x4a2540c, size 0x8, virtual true, abstract: false, final false
inline int32_t get_layoutPriority() ;

/// @brief Method get_minHeight, addr 0x4a251a0, size 0x8, virtual true, abstract: false, final false
inline float_t get_minHeight() ;

/// @brief Method get_minWidth, addr 0x4a25124, size 0x8, virtual true, abstract: false, final false
inline float_t get_minWidth() ;

/// @brief Method get_preferredHeight, addr 0x4a25298, size 0x8, virtual true, abstract: false, final false
inline float_t get_preferredHeight() ;

/// @brief Method get_preferredWidth, addr 0x4a2521c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method set_flexibleHeight, addr 0x4a25398, size 0x74, virtual true, abstract: false, final false
inline void set_flexibleHeight(float_t  value) ;

/// @brief Method set_flexibleWidth, addr 0x4a2531c, size 0x74, virtual true, abstract: false, final false
inline void set_flexibleWidth(float_t  value) ;

/// @brief Method set_ignoreLayout, addr 0x4a24ff0, size 0x74, virtual true, abstract: false, final false
inline void set_ignoreLayout(bool  value) ;

/// @brief Method set_layoutPriority, addr 0x4a25414, size 0x74, virtual true, abstract: false, final false
inline void set_layoutPriority(int32_t  value) ;

/// @brief Method set_minHeight, addr 0x4a251a8, size 0x74, virtual true, abstract: false, final false
inline void set_minHeight(float_t  value) ;

/// @brief Method set_minWidth, addr 0x4a2512c, size 0x74, virtual true, abstract: false, final false
inline void set_minWidth(float_t  value) ;

/// @brief Method set_preferredHeight, addr 0x4a252a0, size 0x74, virtual true, abstract: false, final false
inline void set_preferredHeight(float_t  value) ;

/// @brief Method set_preferredWidth, addr 0x4a25224, size 0x74, virtual true, abstract: false, final false
