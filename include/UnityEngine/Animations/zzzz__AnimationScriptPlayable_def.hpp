...
/// @brief Method Equals, addr 0x47c52e8, size 0x9c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Animations::AnimationScriptPlayable  other) ;

/// @brief Method GetHandle, addr 0x47c52dc, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Playables::PlayableHandle GetHandle() ;

/// @brief Method .ctor, addr 0x47c51ec, size 0xf0, virtual false, abstract: false, final false
