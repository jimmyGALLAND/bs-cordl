...
/// @brief Method Equals, addr 0x47c4b7c, size 0xb4, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Animations::AnimationPosePlayable  other) ;

/// @brief Method GetHandle, addr 0x47c4b70, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Playables::PlayableHandle GetHandle() ;

/// @brief Method .ctor, addr 0x47c4a80, size 0xf0, virtual false, abstract: false, final false
