...
/// @brief Method Deinitialize, addr 0x47a6f28, size 0x78, virtual true, abstract: false, final false
inline bool Deinitialize() ;

/// @brief Method DisableVRAndEnable2DReprojection, addr 0x47a6fa0, size 0xa0, virtual false, abstract: false, final false
inline bool DisableVRAndEnable2DReprojection() ;

/// @brief Method EnableVRAndDisable2DReprojection, addr 0x47a7040, size 0xbc, virtual false, abstract: false, final false
inline bool EnableVRAndDisable2DReprojection() ;

/// @brief Method Initialize, addr 0x47a6d64, size 0xd4, virtual true, abstract: false, final false
inline bool Initialize() ;

static inline ::UnityEngine::PS4::XR::PSVRLoader* New_ctor() ;

/// @brief Method Start, addr 0x47a6e38, size 0x78, virtual true, abstract: false, final false
inline bool Start() ;

/// @brief Method Stop, addr 0x47a6eb0, size 0x78, virtual true, abstract: false, final false
inline bool Stop() ;

/// @brief Method .ctor, addr 0x47a70fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_displaySubsystem, addr 0x47a6c9c, size 0x64, virtual false, abstract: false, final false
inline Il2CppObject* get_displaySubsystem() ;

/// @brief Method get_inputSubsystem, addr 0x47a6d00, size 0x64, virtual false, abstract: false, final false
