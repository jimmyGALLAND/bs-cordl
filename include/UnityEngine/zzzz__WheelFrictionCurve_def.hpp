...
/// @brief Method get_asymptoteSlip, addr 0x485efdc, size 0x8, virtual false, abstract: false, final false
inline float_t get_asymptoteSlip() ;

/// @brief Method get_asymptoteValue, addr 0x485efec, size 0x8, virtual false, abstract: false, final false
inline float_t get_asymptoteValue() ;

/// @brief Method get_extremumSlip, addr 0x485efbc, size 0x8, virtual false, abstract: false, final false
inline float_t get_extremumSlip() ;

/// @brief Method get_extremumValue, addr 0x485efcc, size 0x8, virtual false, abstract: false, final false
inline float_t get_extremumValue() ;

/// @brief Method get_stiffness, addr 0x485effc, size 0x8, virtual false, abstract: false, final false
inline float_t get_stiffness() ;

/// @brief Method set_asymptoteSlip, addr 0x485efe4, size 0x8, virtual false, abstract: false, final false
inline void set_asymptoteSlip(float_t  value) ;

/// @brief Method set_asymptoteValue, addr 0x485eff4, size 0x8, virtual false, abstract: false, final false
inline void set_asymptoteValue(float_t  value) ;

/// @brief Method set_extremumSlip, addr 0x485efc4, size 0x8, virtual false, abstract: false, final false
inline void set_extremumSlip(float_t  value) ;

/// @brief Method set_extremumValue, addr 0x485efd4, size 0x8, virtual false, abstract: false, final false
inline void set_extremumValue(float_t  value) ;

/// @brief Method set_stiffness, addr 0x485f004, size 0x8, virtual false, abstract: false, final false
