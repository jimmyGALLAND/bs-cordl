...
/// @brief Method ScheduleBatch, addr 0x487b8c4, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method ScheduleBatch, addr 0x487b644, size 0x1e4, virtual false, abstract: false, final false
...
/// @brief Method ScheduleCapsulecastBatch, addr 0x487b828, size 0x9c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleCapsulecastBatch(ByRef<::Unity::Jobs::LowLevel::Unsafe::__JobsUtility__JobScheduleParameters>  parameters, ::cordl_internals::Ptr<void>  commands, int32_t  commandLen, ::cordl_internals::Ptr<void>  result, int32_t  resultLen, int32_t  minCommandsPerJob, int32_t  maxHits) ;

/// @brief Method ScheduleCapsulecastBatch_Injected, addr 0x487b8e8, size 0x8c, virtual false, abstract: false, final false
static inline void ScheduleCapsulecastBatch_Injected(ByRef<::Unity::Jobs::LowLevel::Unsafe::__JobsUtility__JobScheduleParameters>  parameters, ::cordl_internals::Ptr<void>  commands, int32_t  commandLen, ::cordl_internals::Ptr<void>  result, int32_t  resultLen, int32_t  minCommandsPerJob, int32_t  maxHits, ByRef<::Unity::Jobs::JobHandle>  ret) ;

/// @brief Method .ctor, addr 0x487b974, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x487b4b8, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x487ba70, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x487b59c, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_direction, addr 0x487b60c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_direction() ;

/// @brief Method get_distance, addr 0x487b624, size 0x8, virtual false, abstract: false, final false
inline float_t get_distance() ;

/// @brief Method get_layerMask, addr 0x487baa8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_layerMask() ;

/// @brief Method get_physicsScene, addr 0x487b634, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::PhysicsScene get_physicsScene() ;

/// @brief Method get_point1, addr 0x487b5cc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_point1() ;

/// @brief Method get_point2, addr 0x487b5e4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_point2() ;

/// @brief Method get_radius, addr 0x487b5fc, size 0x8, virtual false, abstract: false, final false
inline float_t get_radius() ;

/// @brief Method set_direction, addr 0x487b618, size 0xc, virtual false, abstract: false, final false
inline void set_direction(::UnityEngine::Vector3  value) ;

/// @brief Method set_distance, addr 0x487b62c, size 0x8, virtual false, abstract: false, final false
inline void set_distance(float_t  value) ;

/// @brief Method set_layerMask, addr 0x487ba68, size 0x8, virtual false, abstract: false, final false
inline void set_layerMask(int32_t  value) ;

/// @brief Method set_physicsScene, addr 0x487b63c, size 0x8, virtual false, abstract: false, final false
inline void set_physicsScene(::UnityEngine::PhysicsScene  value) ;

/// @brief Method set_point1, addr 0x487b5d8, size 0xc, virtual false, abstract: false, final false
inline void set_point1(::UnityEngine::Vector3  value) ;

/// @brief Method set_point2, addr 0x487b5f0, size 0xc, virtual false, abstract: false, final false
inline void set_point2(::UnityEngine::Vector3  value) ;

/// @brief Method set_radius, addr 0x487b604, size 0x8, virtual false, abstract: false, final false
