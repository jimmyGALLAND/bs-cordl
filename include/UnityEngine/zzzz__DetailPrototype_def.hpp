...
/// @brief Method Equals, addr 0x4888010, size 0x64, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x4888074, size 0x25c, virtual false, abstract: false, final false
inline bool Equals(::UnityEngine::DetailPrototype*  other) ;

/// @brief Method GetHashCode, addr 0x48882d0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4887f68, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_dryColor, addr 0x4887f24, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_dryColor() ;

/// @brief Method get_healthyColor, addr 0x4887f0c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_healthyColor() ;

/// @brief Method get_maxHeight, addr 0x4887eec, size 0x8, virtual false, abstract: false, final false
inline float_t get_maxHeight() ;

/// @brief Method get_maxWidth, addr 0x4887ecc, size 0x8, virtual false, abstract: false, final false
inline float_t get_maxWidth() ;

/// @brief Method get_minHeight, addr 0x4887edc, size 0x8, virtual false, abstract: false, final false
inline float_t get_minHeight() ;

/// @brief Method get_minWidth, addr 0x4887ebc, size 0x8, virtual false, abstract: false, final false
inline float_t get_minWidth() ;

/// @brief Method get_noiseSpread, addr 0x4887efc, size 0x8, virtual false, abstract: false, final false
inline float_t get_noiseSpread() ;

/// @brief Method get_renderMode, addr 0x4887f3c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_dryColor, addr 0x4887f30, size 0xc, virtual false, abstract: false, final false
inline void set_dryColor(::UnityEngine::Color  value) ;

/// @brief Method set_healthyColor, addr 0x4887f18, size 0xc, virtual false, abstract: false, final false
inline void set_healthyColor(::UnityEngine::Color  value) ;

/// @brief Method set_maxHeight, addr 0x4887ef4, size 0x8, virtual false, abstract: false, final false
inline void set_maxHeight(float_t  value) ;

/// @brief Method set_maxWidth, addr 0x4887ed4, size 0x8, virtual false, abstract: false, final false
inline void set_maxWidth(float_t  value) ;

/// @brief Method set_minHeight, addr 0x4887ee4, size 0x8, virtual false, abstract: false, final false
inline void set_minHeight(float_t  value) ;

/// @brief Method set_minWidth, addr 0x4887ec4, size 0x8, virtual false, abstract: false, final false
inline void set_minWidth(float_t  value) ;

/// @brief Method set_noiseSpread, addr 0x4887f04, size 0x8, virtual false, abstract: false, final false
inline void set_noiseSpread(float_t  value) ;

/// @brief Method set_prototype, addr 0x4887eac, size 0x8, virtual false, abstract: false, final false
inline void set_prototype(::UnityEngine::GameObject*  value) ;

/// @brief Method set_prototypeTexture, addr 0x4887eb4, size 0x8, virtual false, abstract: false, final false
inline void set_prototypeTexture(::UnityEngine::Texture2D*  value) ;

/// @brief Method set_renderMode, addr 0x4887f44, size 0x8, virtual false, abstract: false, final false
inline void set_renderMode(::UnityEngine::DetailRenderMode  value) ;

/// @brief Method set_usePrototypeMesh, addr 0x4887f4c, size 0x1c, virtual false, abstract: false, final false
