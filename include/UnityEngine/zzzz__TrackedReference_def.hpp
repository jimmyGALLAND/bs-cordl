...
/// @brief Method Equals, addr 0x481d828, size 0x80, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method GetHashCode, addr 0x481d8a8, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x481d7b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Equality, addr 0x481d7bc, size 0x54, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::TrackedReference*  x, ::UnityEngine::TrackedReference*  y) ;

/// @brief Method op_Implicit, addr 0x481d8b4, size 0x1c, virtual false, abstract: false, final false
static inline bool op_Implicit_bool(::UnityEngine::TrackedReference*  exists) ;

/// @brief Method op_Inequality, addr 0x481d810, size 0x18, virtual false, abstract: false, final false
