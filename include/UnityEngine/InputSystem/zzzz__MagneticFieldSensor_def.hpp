...
/// @brief Field <magneticField>k__BackingField, offset 0x170, size 0x8 
 __declspec(property(get=__cordl_internal_get__magneticField_k__BackingField, put=__cordl_internal_set__magneticField_k__BackingField)) ::UnityEngine::InputSystem::Controls::Vector3Control*  _magneticField_k__BackingField;
...
/// @brief Method FinishSetup, addr 0x4535ef4, size 0x78, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method MakeCurrent, addr 0x4535e1c, size 0x54, virtual true, abstract: false, final false
inline void MakeCurrent() ;

static inline ::UnityEngine::InputSystem::MagneticFieldSensor* New_ctor() ;

/// @brief Method OnRemoved, addr 0x4535e70, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4535f6c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::MagneticFieldSensor* getStaticF__current_k__BackingField() ;

/// @brief Method get_current, addr 0x4535d88, size 0x48, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::MagneticFieldSensor* get_current() ;

/// @brief Method get_magneticField, addr 0x4535d78, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_current, addr 0x4535dd0, size 0x4c, virtual false, abstract: false, final false
static inline void set_current(::UnityEngine::InputSystem::MagneticFieldSensor*  value) ;

/// @brief Method set_magneticField, addr 0x4535d80, size 0x8, virtual false, abstract: false, final false
