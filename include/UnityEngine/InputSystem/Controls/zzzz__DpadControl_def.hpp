...
/// @brief Method FinishSetup, addr 0x44d0c54, size 0x84, virtual true, abstract: false, final false
inline void FinishSetup() ;

static inline ::UnityEngine::InputSystem::Controls::__DpadControl__DpadAxisControl* New_ctor() ;

/// @brief Method ReadUnprocessedValueFromState, addr 0x44d0cd8, size 0xec, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44d0dc4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_component, addr 0x44d0c44, size 0x8, virtual false, abstract: false, final false
inline int32_t get_component() ;

/// @brief Method set_component, addr 0x44d0c4c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method FinishSetup, addr 0x44d0700, size 0xf4, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method MakeDpadVector, addr 0x44d0a2c, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 MakeDpadVector(bool  up, bool  down, bool  left, bool  right, bool  normalize) ;

/// @brief Method MakeDpadVector, addr 0x44d0c34, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ReadUnprocessedValueFromState, addr 0x44d07f4, size 0x238, virtual true, abstract: false, final false
inline ::UnityEngine::Vector2 ReadUnprocessedValueFromState(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method WriteValueIntoState, addr 0x44d0a88, size 0x1ac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44d0690, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_down, addr 0x44d0660, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_down() ;

/// @brief Method get_left, addr 0x44d0670, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_left() ;

/// @brief Method get_right, addr 0x44d0680, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_right() ;

/// @brief Method get_up, addr 0x44d0650, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_up() ;

/// @brief Method set_down, addr 0x44d0668, size 0x8, virtual false, abstract: false, final false
inline void set_down(::UnityEngine::InputSystem::Controls::ButtonControl*  value) ;

/// @brief Method set_left, addr 0x44d0678, size 0x8, virtual false, abstract: false, final false
inline void set_left(::UnityEngine::InputSystem::Controls::ButtonControl*  value) ;

/// @brief Method set_right, addr 0x44d0688, size 0x8, virtual false, abstract: false, final false
inline void set_right(::UnityEngine::InputSystem::Controls::ButtonControl*  value) ;

/// @brief Method set_up, addr 0x44d0658, size 0x8, virtual false, abstract: false, final false
