...
/// @brief Method FinishSetup, addr 0x44d0110, size 0xfc, virtual true, abstract: false, final false
inline void FinishSetup() ;

static inline ::UnityEngine::InputSystem::Controls::DiscreteButtonControl* New_ctor() ;

/// @brief Method ReadUnprocessedValueFromState, addr 0x44d020c, size 0x1a0, virtual true, abstract: false, final false
inline float_t ReadUnprocessedValueFromState(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method WriteValueIntoState, addr 0x44d03b0, size 0x130, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44d04e4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
