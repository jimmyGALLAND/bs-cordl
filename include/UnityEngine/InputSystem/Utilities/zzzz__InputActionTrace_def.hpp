...
/// @brief Method ReadValue, addr 0x44d5904, size 0x100, virtual false, abstract: false, final false
inline void ReadValue(::cordl_internals::Ptr<void>  buffer, int32_t  bufferSize) ;

/// @brief Method ReadValueAsObject, addr 0x44d56cc, size 0x238, virtual false, abstract: false, final false
inline ::System::Object* ReadValueAsObject() ;

/// @brief Method ToString, addr 0x44d4ed8, size 0x2f4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_action, addr 0x44d559c, size 0x28, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputAction* get_action() ;

/// @brief Method get_control, addr 0x44d55d0, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputControl* get_control() ;

/// @brief Method get_duration, addr 0x44d5690, size 0x30, virtual false, abstract: false, final false
inline double_t get_duration() ;

/// @brief Method get_interaction, addr 0x44d5610, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::IInputInteraction* get_interaction() ;

/// @brief Method get_phase, addr 0x44d55c4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputActionPhase get_phase() ;

/// @brief Method get_startTime, addr 0x44d5684, size 0xc, virtual false, abstract: false, final false
inline double_t get_startTime() ;

/// @brief Method get_time, addr 0x44d5668, size 0x1c, virtual false, abstract: false, final false
inline double_t get_time() ;

/// @brief Method get_valueSizeInBytes, addr 0x44d56c0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x44d5a74, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method MoveNext, addr 0x44d5a04, size 0x64, virtual true, abstract: false, final true
inline bool MoveNext() ;

/// @brief Method Reset, addr 0x44d5a68, size 0xc, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x44d5adc, size 0x64, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method .ctor, addr 0x44d51e4, size 0x48, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::Utilities::InputActionTrace*  trace) ;

/// @brief Method get_Current, addr 0x44d5a78, size 0x64, virtual true, abstract: false, final true
...
constexpr ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::Utilities::__InputActionTrace__ActionEventPtr>* i___System__Collections__Generic__IEnumerator_1___UnityEngine__InputSystem__Utilities____InputActionTrace__ActionEventPtr_() ;
...
/// @brief Field m_ActionChangeDelegate, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ActionChangeDelegate, put=__cordl_internal_set_m_ActionChangeDelegate)) ::System::Action_2<::System::Object*,::UnityEngine::InputSystem::InputActionChange>*  m_ActionChangeDelegate;

/// @brief Field m_ActionMapStateClones, offset 0x80, size 0x18 
 __declspec(property(get=__cordl_internal_get_m_ActionMapStateClones, put=__cordl_internal_set_m_ActionMapStateClones)) ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputActionState*>  m_ActionMapStateClones;

/// @brief Field m_ActionMapStates, offset 0x68, size 0x18 
 __declspec(property(get=__cordl_internal_get_m_ActionMapStates, put=__cordl_internal_set_m_ActionMapStates)) ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputActionState*>  m_ActionMapStates;

/// @brief Field m_CallbackDelegate, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CallbackDelegate, put=__cordl_internal_set_m_CallbackDelegate)) ::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>*  m_CallbackDelegate;
...
/// @brief Field m_SubscribedActionMaps, offset 0x30, size 0x18 
 __declspec(property(get=__cordl_internal_get_m_SubscribedActionMaps, put=__cordl_internal_set_m_SubscribedActionMaps)) ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputActionMap*>  m_SubscribedActionMaps;

/// @brief Field m_SubscribedActions, offset 0x18, size 0x18 
 __declspec(property(get=__cordl_internal_get_m_SubscribedActions, put=__cordl_internal_set_m_SubscribedActions)) ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputAction*>  m_SubscribedActions;
...
/// @brief Method Clear, addr 0x44d491c, size 0x54, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method CloneActionStateBeforeBindingsChange, addr 0x44d54ac, size 0xf0, virtual false, abstract: false, final false
inline void CloneActionStateBeforeBindingsChange(::UnityEngine::InputSystem::InputActionMap*  actionMap) ;

/// @brief Method Dispose, addr 0x44d51cc, size 0x18, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DisposeInternal, addr 0x44d4a04, size 0x100, virtual false, abstract: false, final false
inline void DisposeInternal() ;

/// @brief Method Finalize, addr 0x44d4970, size 0x94, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetEnumerator, addr 0x44d4e60, size 0x78, virtual true, abstract: false, final true
...
/// @brief Method HookOnActionChange, addr 0x44d433c, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method OnActionChange, addr 0x44d5230, size 0x27c, virtual false, abstract: false, final false
inline void OnActionChange(::System::Object*  actionOrMapOrAsset, ::UnityEngine::InputSystem::InputActionChange  change) ;

/// @brief Method RecordAction, addr 0x44d474c, size 0x1d0, virtual false, abstract: false, final false
inline void RecordAction(::UnityEngine::InputSystem::__InputAction__CallbackContext  context) ;

/// @brief Method SubscribeTo, addr 0x44d3fb8, size 0x128, virtual false, abstract: false, final false
inline void SubscribeTo(::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method SubscribeTo, addr 0x44d4158, size 0x108, virtual false, abstract: false, final false
inline void SubscribeTo(::UnityEngine::InputSystem::InputActionMap*  actionMap) ;

/// @brief Method SubscribeToAll, addr 0x44d4260, size 0xdc, virtual false, abstract: false, final false
inline void SubscribeToAll() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x44d522c, size 0x4, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method ToString, addr 0x44d4b04, size 0x35c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method UnhookOnActionChange, addr 0x44d46e0, size 0x6c, virtual false, abstract: false, final false
inline void UnhookOnActionChange() ;

/// @brief Method UnsubscribeFrom, addr 0x44d43f8, size 0x118, virtual false, abstract: false, final false
inline void UnsubscribeFrom(::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method UnsubscribeFrom, addr 0x44d4510, size 0xf8, virtual false, abstract: false, final false
inline void UnsubscribeFrom(::UnityEngine::InputSystem::InputActionMap*  actionMap) ;

/// @brief Method UnsubscribeFromAll, addr 0x44d4608, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44d3f38, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x44d3f40, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method .ctor, addr 0x44d40e0, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::InputActionMap*  actionMap) ;

/// @brief Method get_buffer, addr 0x44d3f20, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::LowLevel::InputEventBuffer get_buffer() ;

/// @brief Method get_count, addr 0x44d3f30, size 0x8, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::Utilities::__InputActionTrace__ActionEventPtr>* i___System__Collections__Generic__IEnumerable_1___UnityEngine__InputSystem__Utilities____InputActionTrace__ActionEventPtr_() noexcept;
