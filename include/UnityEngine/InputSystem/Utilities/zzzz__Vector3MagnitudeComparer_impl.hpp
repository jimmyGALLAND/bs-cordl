...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::InputSystem::Utilities::Vector3MagnitudeComparer::*)(::UnityEngine::Vector3, ::UnityEngine::Vector3)>(&::UnityEngine::InputSystem::Utilities::Vector3MagnitudeComparer::Compare)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x44d5b70;
...
constexpr ::System::Collections::Generic::IComparer_1<::UnityEngine::Vector3>* UnityEngine::InputSystem::Utilities::Vector3MagnitudeComparer::i___System__Collections__Generic__IComparer_1___UnityEngine__Vector3_()  {
return static_cast<::System::Collections::Generic::IComparer_1<::UnityEngine::Vector3>*>(static_cast<void*>(::il2cpp_utils::Box(this)));
}
