...
template<typename TValue>
constexpr ::cordl_internals::to_const_pointer<::System::Action*> const& UnityEngine::InputSystem::Utilities::Observer_1<TValue>::__cordl_internal_get_m_OnCompleted() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_OnCompleted;
}
template<typename TValue>
