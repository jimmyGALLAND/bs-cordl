...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::InputSystem::Utilities::ISavedState::*)()>(&::UnityEngine::InputSystem::Utilities::ISavedState::StaticDisposeCurrentState)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::InputSystem::Utilities::ISavedState::*)()>(&::UnityEngine::InputSystem::Utilities::ISavedState::RestoreSavedState)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
