...
/// @brief Method Equals, addr 0x44d80a4, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x44d7efc, size 0x1a8, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonString  other) ;

/// @brief Method GetHashCode, addr 0x44d8134, size 0x7c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x44d7e00, size 0xfc, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x44d81b0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x44d8214, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x44d81e0, size 0x34, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF___9__11_1, put=setStaticF___9__11_1)) ::System::Func_2<::System::Collections::Generic::KeyValuePair_2<::StringW,::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>,::StringW>*  __9__11_1;

static inline ::GlobalNamespace::__JsonParser__JsonValue____c* New_ctor() ;

/// @brief Method <ToString>b__11_0, addr 0x44d9704, size 0x8, virtual false, abstract: false, final false
inline ::StringW _ToString_b__11_0(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue  x) ;

/// @brief Method <ToString>b__11_1, addr 0x44d970c, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44d96fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static inline void setStaticF___9__11_1(::System::Func_2<::System::Collections::Generic::KeyValuePair_2<::StringW,::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>,::StringW>*  value) ;
...
/// @brief Method Equals, addr 0x44d948c, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x44d8c00, size 0x88c, virtual false, abstract: false, final false
static inline bool Equals(::System::Object*  obj, ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue  value) ;

/// @brief Method Equals, addr 0x44d8a04, size 0x1fc, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue  other) ;

/// @brief Method GetHashCode, addr 0x44d951c, size 0x14c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToBoolean, addr 0x44d8234, size 0x140, virtual false, abstract: false, final false
inline bool ToBoolean() ;

/// @brief Method ToDouble, addr 0x44d88b4, size 0xcc, virtual false, abstract: false, final false
inline double_t ToDouble() ;

/// @brief Method ToInteger, addr 0x44d87e4, size 0xd0, virtual false, abstract: false, final false
inline int64_t ToInteger() ;

/// @brief Method ToString, addr 0x44d8374, size 0x470, virtual true, abstract: false, final false
inline ::StringW ToString() ;
...
/// @brief Method op_Equality, addr 0x44d7088, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x44d7cb0, size 0x24, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue op_Implicit___UnityEngine__InputSystem__Utilities____JsonParser__JsonValue(::System::Collections::Generic::List_1<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>*  array) ;

/// @brief Method op_Implicit, addr 0x44d89bc, size 0x24, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue op_Implicit___UnityEngine__InputSystem__Utilities____JsonParser__JsonValue(::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>*  obj) ;

/// @brief Method op_Implicit, addr 0x44d8980, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x44d7c3c, size 0x74, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue op_Implicit___UnityEngine__InputSystem__Utilities____JsonParser__JsonValue(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonString  str) ;

/// @brief Method op_Implicit, addr 0x44d89e0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x44d7dc4, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x44d7cfc, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x44d7cd4, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x44d9668, size 0x38, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "type", ty: "::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValueType", modifiers: "", def_value: None }, CppParam { name: "boolValue", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "realValue", ty: "double_t", modifiers: "", def_value: None }, CppParam { name: "integerValue", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "stringValue", ty: "::UnityEngine::InputSystem::Utilities::__JsonParser__JsonString", modifiers: "", def_value: None }, CppParam { name: "arrayValue", ty: "::System::Collections::Generic::List_1<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>*", modifiers: "", def_value: None }, CppParam { name: "objectValue", ty: "::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>*", modifiers: "", def_value: None }, CppParam { name: "anyValue", ty: "::System::Object*", modifiers: "", def_value: None }]
constexpr __JsonParser__JsonValue(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValueType  type, bool  boolValue, double_t  realValue, int64_t  integerValue, ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonString  stringValue, ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>*  arrayValue, ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>*  objectValue, ::System::Object*  anyValue) noexcept;
...
// SizeInfo { instance_size: 24, native_size: 24, calculated_instance_size: 24, calculated_native_size: 34, minimum_alignment: 8, packing: None, specified_packing: None }
namespace UnityEngine::InputSystem::Utilities {
// Is value type: true
...
/// @brief Method CurrentPropertyHasValueEqualTo, addr 0x44cdbfc, size 0x14c, virtual false, abstract: false, final false
inline bool CurrentPropertyHasValueEqualTo(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue  expectedValue) ;

/// @brief Method NavigateToProperty, addr 0x44cd77c, size 0x480, virtual false, abstract: false, final false
inline bool NavigateToProperty(::StringW  path) ;

/// @brief Method ParseArrayValue, addr 0x44d724c, size 0x2b8, virtual false, abstract: false, final false
inline bool ParseArrayValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method ParseBooleanValue, addr 0x44d766c, size 0xd8, virtual false, abstract: false, final false
inline bool ParseBooleanValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method ParseNullValue, addr 0x44d7744, size 0x64, virtual false, abstract: false, final false
inline bool ParseNullValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method ParseNumber, addr 0x44d77a8, size 0x494, virtual false, abstract: false, final false
inline bool ParseNumber(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method ParseObjectValue, addr 0x44d7504, size 0x168, virtual false, abstract: false, final false
inline bool ParseObjectValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method ParseStringValue, addr 0x44d70bc, size 0x190, virtual false, abstract: false, final false
inline bool ParseStringValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method ParseToken, addr 0x44d6dd8, size 0x74, virtual false, abstract: false, final false
inline bool ParseToken(char16_t  token) ;

/// @brief Method ParseValue, addr 0x44d6f48, size 0x30, virtual false, abstract: false, final false
inline bool ParseValue() ;

/// @brief Method ParseValue, addr 0x44d6f78, size 0x110, virtual false, abstract: false, final false
inline bool ParseValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method Reset, addr 0x44d6ce0, size 0xc, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SkipString, addr 0x44d7d1c, size 0xa8, virtual false, abstract: false, final false
inline bool SkipString(::StringW  text) ;

/// @brief Method SkipToValue, addr 0x44d6ee8, size 0x60, virtual false, abstract: false, final false
inline bool SkipToValue() ;

/// @brief Method SkipWhitespace, addr 0x44d6e4c, size 0x9c, virtual false, abstract: false, final false
inline void SkipWhitespace() ;

/// @brief Method ToString, addr 0x44d6cec, size 0xec, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x44cd6bc, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::StringW  json) ;

/// @brief Method get_isAtEnd, addr 0x44d7df0, size 0x10, virtual false, abstract: false, final false
