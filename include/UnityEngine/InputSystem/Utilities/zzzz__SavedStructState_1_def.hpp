...
/// @brief Field m_RestoreAction, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RestoreAction, put=__cordl_internal_set_m_RestoreAction)) ::UnityEngine::InputSystem::Utilities::__SavedStructState_1__TypedRestore<T>*  m_RestoreAction;
...
static inline ::UnityEngine::InputSystem::Utilities::SavedStructState_1<T>* New_ctor(ByRef<T>  state, ::UnityEngine::InputSystem::Utilities::__SavedStructState_1__TypedRestore<T>*  restoreAction, ::System::Action*  staticDisposeCurrentState) ;
