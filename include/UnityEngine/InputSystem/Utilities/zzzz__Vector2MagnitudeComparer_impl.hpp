...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::InputSystem::Utilities::Vector2MagnitudeComparer::*)(::UnityEngine::Vector2, ::UnityEngine::Vector2)>(&::UnityEngine::InputSystem::Utilities::Vector2MagnitudeComparer::Compare)> {
...
constexpr ::System::Collections::Generic::IComparer_1<::UnityEngine::Vector2>* UnityEngine::InputSystem::Utilities::Vector2MagnitudeComparer::i___System__Collections__Generic__IComparer_1___UnityEngine__Vector2_()  {
return static_cast<::System::Collections::Generic::IComparer_1<::UnityEngine::Vector2>*>(static_cast<void*>(::il2cpp_utils::Box(this)));
}
