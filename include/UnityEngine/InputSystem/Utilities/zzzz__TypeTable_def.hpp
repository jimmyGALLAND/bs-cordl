...
/// @brief Method .ctor, addr 0x44e0f70, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_names>b__2_0, addr 0x44e0f78, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method AddTypeRegistration, addr 0x44e0cc0, size 0x160, virtual false, abstract: false, final false
inline void AddTypeRegistration(::StringW  name, ::System::Type*  type) ;

/// @brief Method FindNameForType, addr 0x44e0aa4, size 0x21c, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::InternedString FindNameForType(::System::Type*  type) ;

/// @brief Method Initialize, addr 0x44e0a30, size 0x74, virtual false, abstract: false, final false
inline void Initialize() ;

/// @brief Method LookupTypeRegistration, addr 0x44e0e20, size 0xf4, virtual false, abstract: false, final false
inline ::System::Type* LookupTypeRegistration(::StringW  name) ;

/// @brief Method get_internedNames, addr 0x44e09e0, size 0x50, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::Utilities::InternedString>* get_internedNames() ;

/// @brief Method get_names, addr 0x44e08bc, size 0x124, virtual false, abstract: false, final false
