...
/// @brief Method Dispose, addr 0x45949f8, size 0x8c, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method AddChildControl, addr 0x45927f0, size 0x750, virtual false, abstract: false, final false
...
/// @brief Method AddChildControlIfMissing, addr 0x4592f40, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method AddChildControls, addr 0x45914c8, size 0x6b8, virtual false, abstract: false, final false
...
/// @brief Method AddChildren, addr 0x4594660, size 0x110, virtual false, abstract: false, final false
inline void AddChildren(ByRef<::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode>  parent, ::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode  left, ::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode  right) ;

/// @brief Method AddControlToNode, addr 0x4594770, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method AddParentDisplayNameRecursive, addr 0x45938ec, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method AddProcessors, addr 0x4593134, size 0x234, virtual false, abstract: false, final false
...
/// @brief Method ApplyUseStateFrom, addr 0x459248c, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method ChildControlOverridePath, addr 0x4592ff0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method ComputeStateLayout, addr 0x4591b80, size 0x90c, virtual false, abstract: false, final false
static inline void ComputeStateLayout(::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method Dispose, addr 0x4590e90, size 0x8, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method FinalizeControlHierarchy, addr 0x4590bb4, size 0x250, virtual false, abstract: false, final false
inline void FinalizeControlHierarchy() ;

/// @brief Method FinalizeControlHierarchyRecursive, addr 0x459399c, size 0x428, virtual false, abstract: false, final false
...
/// @brief Method FindOrLoadLayout, addr 0x4590e98, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* FindOrLoadLayout(::StringW  name) ;

/// @brief Method Finish, addr 0x4590e04, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputDevice* Finish() ;

/// @brief Method GetBestMidPoint, addr 0x4594130, size 0x530, virtual false, abstract: false, final false
inline uint16_t GetBestMidPoint(::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode  parent, uint16_t  startOffset) ;

/// @brief Method GetControlIndex, addr 0x45948b0, size 0xb0, virtual false, abstract: false, final false
inline uint16_t GetControlIndex(::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method InsertChildControl, addr 0x4593368, size 0x31c, virtual false, abstract: false, final false
...
/// @brief Method InsertChildControlOverride, addr 0x4592658, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method InsertControlBitRangeNode, addr 0x4593dc4, size 0x36c, virtual false, abstract: false, final false
inline void InsertControlBitRangeNode(ByRef<::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode>  parent, ::UnityEngine::InputSystem::InputControl*  control, ByRef<int32_t>  controlIndiciesNextFreeIndex, uint16_t  startOffset) ;

/// @brief Method InstantiateLayout, addr 0x4590ef4, size 0x5d4, virtual false, abstract: false, final false
...
/// @brief Method InstantiateLayout, addr 0x4590b48, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method Ref, addr 0x45949a4, size 0x54, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Layouts::__InputDeviceBuilder__RefInstance Ref() ;

/// @brief Method Reset, addr 0x4590e1c, size 0x74, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetDisplayName, addr 0x45936e4, size 0x208, virtual false, abstract: false, final false
...
/// @brief Method SetFormat, addr 0x4593080, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method Setup, addr 0x45909f4, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method ShiftChildIndicesInHierarchyOneUp, addr 0x4593684, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method get_instance, addr 0x4594960, size 0x44, virtual false, abstract: false, final false
