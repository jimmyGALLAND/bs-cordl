...
/// @brief Method .ctor, addr 0x4563f00, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method get_distance, addr 0x4564040, size 0x8, virtual false, abstract: false, final false
inline float_t get_distance() ;

/// @brief Method get_graphic, addr 0x4564024, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Graphic> get_graphic() ;

/// @brief Method get_screenPosition, addr 0x4564038, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_screenPosition() ;

/// @brief Method get_worldHitPosition, addr 0x456402c, size 0xc, virtual false, abstract: false, final false
...
constexpr __TrackedDeviceRaycaster__RaycastHitData(::UnityW<::UnityEngine::UI::Graphic>  _graphic_k__BackingField, ::UnityEngine::Vector3  _worldHitPosition_k__BackingField, ::UnityEngine::Vector2  _screenPosition_k__BackingField, float_t  _distance_k__BackingField) noexcept;
...
/// @brief Method <SortedRaycastGraphics>b__25_0, addr 0x45640ac, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x45640a4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_RaycastResultsCache, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RaycastResultsCache, put=__cordl_internal_set_m_RaycastResultsCache)) ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::UI::__TrackedDeviceRaycaster__RaycastHitData>*  m_RaycastResultsCache;
...
static __declspec(property(get=getStaticF_s_Instances, put=setStaticF_s_Instances)) ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityW<::UnityEngine::InputSystem::UI::TrackedDeviceRaycaster>>  s_Instances;

/// @brief Field s_SortedGraphics, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_SortedGraphics, put=setStaticF_s_SortedGraphics)) ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::UI::__TrackedDeviceRaycaster__RaycastHitData>*  s_SortedGraphics;

static inline ::UnityEngine::InputSystem::UI::TrackedDeviceRaycaster* New_ctor() ;

/// @brief Method OnDisable, addr 0x45635a4, size 0xf4, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x4563520, size 0x84, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method PerformRaycast, addr 0x455cf30, size 0x684, virtual false, abstract: false, final false
...
/// @brief Method RayIntersectsRectTransform, addr 0x4563c08, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x4563698, size 0xa8, virtual true, abstract: false, final false
inline void Raycast(::UnityEngine::EventSystems::PointerEventData*  eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>*  resultAppendList) ;

/// @brief Method SortedRaycastGraphics, addr 0x4563740, size 0x4c8, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::InputSystem::UI::__TrackedDeviceRaycaster__RaycastHitData>*> const& __cordl_internal_get_m_RaycastResultsCache() const;
...
/// @brief Method .ctor, addr 0x4563f14, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_blockingMask, addr 0x45634c4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_blockingMask() ;

/// @brief Method get_canvas, addr 0x4563430, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Canvas> get_canvas() ;

/// @brief Method get_checkFor2DOcclusion, addr 0x45634e8, size 0x8, virtual false, abstract: false, final false
inline bool get_checkFor2DOcclusion() ;

/// @brief Method get_checkFor3DOcclusion, addr 0x45634d4, size 0x8, virtual false, abstract: false, final false
inline bool get_checkFor3DOcclusion() ;

/// @brief Method get_eventCamera, addr 0x456339c, size 0x94, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_eventCamera() ;

/// @brief Method get_ignoreReversedGraphics, addr 0x45634fc, size 0x8, virtual false, abstract: false, final false
inline bool get_ignoreReversedGraphics() ;

/// @brief Method get_maxDistance, addr 0x4563510, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_blockingMask, addr 0x45634cc, size 0x8, virtual false, abstract: false, final false
inline void set_blockingMask(::UnityEngine::LayerMask  value) ;

/// @brief Method set_checkFor2DOcclusion, addr 0x45634f0, size 0xc, virtual false, abstract: false, final false
inline void set_checkFor2DOcclusion(bool  value) ;

/// @brief Method set_checkFor3DOcclusion, addr 0x45634dc, size 0xc, virtual false, abstract: false, final false
inline void set_checkFor3DOcclusion(bool  value) ;

/// @brief Method set_ignoreReversedGraphics, addr 0x4563504, size 0xc, virtual false, abstract: false, final false
inline void set_ignoreReversedGraphics(bool  value) ;

/// @brief Method set_maxDistance, addr 0x4563518, size 0x8, virtual false, abstract: false, final false
