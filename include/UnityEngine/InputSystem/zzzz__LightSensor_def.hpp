...
/// @brief Method FinishSetup, addr 0x45360f0, size 0x78, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method MakeCurrent, addr 0x4536018, size 0x54, virtual true, abstract: false, final false
inline void MakeCurrent() ;

static inline ::UnityEngine::InputSystem::LightSensor* New_ctor() ;

/// @brief Method OnRemoved, addr 0x453606c, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4536168, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::LightSensor* getStaticF__current_k__BackingField() ;

/// @brief Method get_current, addr 0x4535f84, size 0x48, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LightSensor* get_current() ;

/// @brief Method get_lightLevel, addr 0x4535f74, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_current, addr 0x4535fcc, size 0x4c, virtual false, abstract: false, final false
static inline void set_current(::UnityEngine::InputSystem::LightSensor*  value) ;

/// @brief Method set_lightLevel, addr 0x4535f7c, size 0x8, virtual false, abstract: false, final false
