...
/// @brief Method Create, addr 0x44bcec4, size 0x6c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::InputSystem::InputActionReference> Create(::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method GetDisplayName, addr 0x44bcb58, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method Set, addr 0x44bc6d8, size 0x100, virtual false, abstract: false, final false
inline void Set(::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method Set, addr 0x44bc948, size 0x210, virtual false, abstract: false, final false
inline void Set(::UnityEngine::InputSystem::InputActionAsset*  asset, ::StringW  mapName, ::StringW  actionName) ;

/// @brief Method SetInternal, addr 0x44bc7d8, size 0x170, virtual false, abstract: false, final false
inline void SetInternal(::UnityEngine::InputSystem::InputActionAsset*  asset, ::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method ToDisplayName, addr 0x44bce7c, size 0x3c, virtual false, abstract: false, final false
inline ::StringW ToDisplayName() ;

/// @brief Method ToInputAction, addr 0x44bcf30, size 0x4, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputAction* ToInputAction() ;

/// @brief Method ToString, addr 0x44bcc34, size 0x248, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44bcf34, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_action, addr 0x44bc2e8, size 0xac, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputAction* get_action() ;

/// @brief Method get_asset, addr 0x44bc6d0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::InputSystem::InputActionAsset> get_asset() ;

/// @brief Method op_Implicit, addr 0x44bceb8, size 0xc, virtual false, abstract: false, final false
