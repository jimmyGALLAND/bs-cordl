...
/// @brief Method GetDeadZoneAdjustedValue, addr 0x458775c, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method Process, addr 0x458768c, size 0xd0, virtual true, abstract: false, final false
inline ::UnityEngine::Vector2 Process(::UnityEngine::Vector2  value, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method ToString, addr 0x45877c4, size 0xa8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x458786c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_maxOrDefault, addr 0x458761c, size 0x70, virtual false, abstract: false, final false
inline float_t get_maxOrDefault() ;

/// @brief Method get_minOrDefault, addr 0x45875ac, size 0x70, virtual false, abstract: false, final false
