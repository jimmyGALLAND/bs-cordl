...
/// @brief Method .ctor, addr 0x44f0b9c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_usages>b__7_0, addr 0x44f0ba4, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method ComparePathElementToString, addr 0x44f09e0, size 0x160, virtual false, abstract: false, final false
static inline bool ComparePathElementToString(::UnityEngine::InputSystem::Utilities::Substring  pathElement, ::StringW  element) ;

/// @brief Method Matches, addr 0x44f0128, size 0x2b0, virtual false, abstract: false, final false
inline bool Matches(::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method ToHumanReadableString, addr 0x44ee5d0, size 0x7a4, virtual false, abstract: false, final false
inline ::StringW ToHumanReadableString(::StringW  parentLayoutName, ::StringW  parentControlPath, ByRef<::StringW>  referencedLayoutName, ByRef<::StringW>  controlPath, ::UnityEngine::InputSystem::__InputControlPath__HumanReadableStringOptions  options) ;

/// @brief Method ToHumanReadableString, addr 0x44f097c, size 0x64, virtual false, abstract: false, final false
static inline ::StringW ToHumanReadableString(::UnityEngine::InputSystem::Utilities::Substring  substring) ;

/// @brief Method get_displayName, addr 0x44f090c, size 0xc, virtual false, abstract: false, final false
inline ::StringW get_displayName() ;

/// @brief Method get_isDoubleWildcard, addr 0x44f0918, size 0x64, virtual false, abstract: false, final false
inline bool get_isDoubleWildcard() ;

/// @brief Method get_isWildcard, addr 0x44ef044, size 0x64, virtual false, abstract: false, final false
inline bool get_isWildcard() ;

/// @brief Method get_layout, addr 0x44f07c8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_layout() ;

/// @brief Method get_name, addr 0x44f0900, size 0xc, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method get_usages, addr 0x44f07d0, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method MoveToNextComponent, addr 0x44ee364, size 0x26c, virtual false, abstract: false, final false
inline bool MoveToNextComponent() ;

/// @brief Method ParseComponentPart, addr 0x44f0bc8, size 0x108, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::Substring ParseComponentPart(char16_t  terminator) ;

/// @brief Method .ctor, addr 0x44ee328, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  path) ;

/// @brief Method get_isAtEnd, addr 0x44ef76c, size 0x14, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "path", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "length", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "leftIndexInPath", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "rightIndexInPath", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "current", ty: "::UnityEngine::InputSystem::__InputControlPath__ParsedPathComponent", modifiers: "", def_value: None }]
constexpr __InputControlPath__PathParser(::StringW  path, int32_t  length, int32_t  leftIndexInPath, int32_t  rightIndexInPath, ::UnityEngine::InputSystem::__InputControlPath__ParsedPathComponent  current) noexcept;
...
/// @brief Method <TryGetDeviceUsages>b__9_0, addr 0x44f0d34, size 0x24, virtual false, abstract: false, final false
inline ::StringW _TryGetDeviceUsages_b__9_0(::UnityEngine::InputSystem::Utilities::Substring  x) ;

/// @brief Method .ctor, addr 0x44f0d2c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x44f0d5c, size 0x130, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::UnityEngine::InputSystem::__InputControlPath___Parse_d__34* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControlPath.ParsedPathComponent>.GetEnumerator, addr 0x44f0f38, size 0x9c, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::__InputControlPath__ParsedPathComponent>* System_Collections_Generic_IEnumerable_UnityEngine_InputSystem_InputControlPath_ParsedPathComponent__GetEnumerator() ;

/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.InputControlPath.ParsedPathComponent>.get_Current, addr 0x44f0e8c, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x44f0fd4, size 0x4, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x44f0e9c, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x44f0ed4, size 0x64, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x44f0d58, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x44f0794, size 0x34, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::__InputControlPath__ParsedPathComponent>* i___System__Collections__Generic__IEnumerable_1___UnityEngine__InputSystem____InputControlPath__ParsedPathComponent_() noexcept;
...
constexpr ::System::Collections::Generic::IEnumerator_1<::UnityEngine::InputSystem::__InputControlPath__ParsedPathComponent>* i___System__Collections__Generic__IEnumerator_1___UnityEngine__InputSystem____InputControlPath__ParsedPathComponent_() noexcept;
...
/// @brief Method CleanSlashes, addr 0x44edda4, size 0x1c, virtual false, abstract: false, final false
static inline ::StringW CleanSlashes(::StringW  pathComponent) ;

/// @brief Method Combine, addr 0x44e90dc, size 0xec, virtual false, abstract: false, final false
static inline ::StringW Combine(::UnityEngine::InputSystem::InputControl*  parent, ::StringW  path) ;

/// @brief Method ControlLayoutMatchesPathComponent, addr 0x44ef5c8, size 0x1a4, virtual false, abstract: false, final false
static inline bool ControlLayoutMatchesPathComponent(ByRef<::UnityEngine::InputSystem::Layouts::__InputControlLayout__ControlItem>  controlItem, ByRef<::UnityEngine::InputSystem::__InputControlPath__PathParser>  parser) ;

/// @brief Method FindControlLayoutRecursive, addr 0x44ef430, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method FindControlLayoutRecursive, addr 0x44ef2c4, size 0x16c, virtual false, abstract: false, final false
...
template<typename TControl>
static inline TControl MatchByUsageAtDeviceRootRecursive(::UnityEngine::InputSystem::InputDevice*  device, ::StringW  path, int32_t  indexInPath, ByRef<::UnityEngine::InputSystem::InputControlList_1<TControl>>  matches, bool  matchMultiple) ;

/// @brief Method MatchChildrenRecursive, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TControl>
static inline TControl MatchChildrenRecursive(::UnityEngine::InputSystem::InputControl*  control, ::StringW  path, int32_t  indexInPath, ByRef<::UnityEngine::InputSystem::InputControlList_1<TControl>>  matches, bool  matchMultiple) ;

/// @brief Method MatchControlComponent, addr 0x44efc1c, size 0x410, virtual false, abstract: false, final false
static inline bool MatchControlComponent(ByRef<::UnityEngine::InputSystem::__InputControlPath__ParsedPathComponent>  expectedControlComponent, ByRef<::UnityEngine::InputSystem::Layouts::__InputControlLayout__ControlItem>  controlItem, bool  matchAlias) ;

/// @brief Method MatchControlsRecursive, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TControl>
static inline TControl MatchControlsRecursive(::UnityEngine::InputSystem::InputControl*  control, ::StringW  path, int32_t  indexInPath, ByRef<::UnityEngine::InputSystem::InputControlList_1<TControl>>  matches, bool  matchMultiple) ;

/// @brief Method MatchPathComponent, addr 0x44f03d8, size 0x290, virtual false, abstract: false, final false
static inline bool MatchPathComponent(::StringW  component, ::StringW  path, ByRef<int32_t>  indexInPath, ::UnityEngine::InputSystem::__InputControlPath__PathComponentType  componentType, int32_t  startIndexInComponent) ;

/// @brief Method Matches, addr 0x44ee248, size 0xe0, virtual false, abstract: false, final false
static inline bool Matches(::StringW  expected, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method MatchesPrefix, addr 0x44f002c, size 0xfc, virtual false, abstract: false, final false
static inline bool MatchesPrefix(::StringW  expected, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method MatchesRecursive, addr 0x44efbb4, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x44f0724, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method PathComponentCanYieldMultipleMatches, addr 0x44f0668, size 0xbc, virtual false, abstract: false, final false
static inline bool PathComponentCanYieldMultipleMatches(::StringW  path, int32_t  indexInPath) ;

/// @brief Method StringMatches, addr 0x44ef780, size 0x268, virtual false, abstract: false, final false
...
/// @brief Method ToHumanReadableString, addr 0x44eddec, size 0x45c, virtual false, abstract: false, final false
static inline ::StringW ToHumanReadableString(::StringW  path, ByRef<::StringW>  deviceLayoutName, ByRef<::StringW>  controlPath, ::UnityEngine::InputSystem::__InputControlPath__HumanReadableStringOptions  options, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method ToHumanReadableString, addr 0x44eddc0, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method TryFindChild, addr 0x44e94e0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method TryFindControl, addr 0x44e261c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method TryFindControls, addr 0x44ef9e8, size 0x15c, virtual false, abstract: false, final false
static inline ::ArrayW<::UnityEngine::InputSystem::InputControl*,::Array<::UnityEngine::InputSystem::InputControl*>*> TryFindControls(::UnityEngine::InputSystem::InputControl*  control, ::StringW  path, int32_t  indexInPath) ;

/// @brief Method TryFindControls, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TControl>
static inline int32_t TryFindControls(::UnityEngine::InputSystem::InputControl*  control, ::StringW  path, int32_t  indexInPath, ByRef<::UnityEngine::InputSystem::InputControlList_1<TControl>>  matches) ;

/// @brief Method TryFindControls, addr 0x44efb44, size 0x70, virtual false, abstract: false, final false
static inline int32_t TryFindControls(::UnityEngine::InputSystem::InputControl*  control, ::StringW  path, ByRef<::UnityEngine::InputSystem::InputControlList_1<::UnityEngine::InputSystem::InputControl*>>  matches, int32_t  indexInPath) ;

/// @brief Method TryGetControlLayout, addr 0x44ef0a8, size 0x21c, virtual false, abstract: false, final false
static inline ::StringW TryGetControlLayout(::StringW  path) ;

/// @brief Method TryGetDeviceLayout, addr 0x44eef0c, size 0x138, virtual false, abstract: false, final false
static inline ::StringW TryGetDeviceLayout(::StringW  path) ;

/// @brief Method TryGetDeviceUsages, addr 0x44eed74, size 0x198, virtual false, abstract: false, final false
