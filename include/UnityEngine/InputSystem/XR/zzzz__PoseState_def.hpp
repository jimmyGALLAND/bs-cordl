...
/// @brief Method .ctor, addr 0x4551c0c, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_format, addr 0x4551bb4, size 0x58, virtual true, abstract: false, final true
