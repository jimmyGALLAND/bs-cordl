...
/// @brief Field inputFeatures, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_inputFeatures, put=__cordl_internal_set_inputFeatures)) ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::XR::XRFeatureDescriptor>*  inputFeatures;
...
/// @brief Method FromJson, addr 0x455292c, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method ToJson, addr 0x455577c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4555784, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
