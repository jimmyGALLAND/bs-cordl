...
/// @brief Method get_parentBoneIndex, addr 0x455578c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_parentBoneIndex() ;

/// @brief Method get_position, addr 0x455579c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_position() ;

/// @brief Method get_rotation, addr 0x45557b4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_rotation() ;

/// @brief Method set_parentBoneIndex, addr 0x4555794, size 0x8, virtual false, abstract: false, final false
inline void set_parentBoneIndex(uint32_t  value) ;

/// @brief Method set_position, addr 0x45557a8, size 0xc, virtual false, abstract: false, final false
inline void set_position(::UnityEngine::Vector3  value) ;

/// @brief Method set_rotation, addr 0x45557c0, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_ParentBoneIndex", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_Position", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "m_Rotation", ty: "::UnityEngine::Quaternion", modifiers: "", def_value: None }]
