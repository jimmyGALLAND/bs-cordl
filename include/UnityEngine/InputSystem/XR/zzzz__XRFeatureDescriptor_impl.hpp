...
// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "usageHints", ty: "::System::Collections::Generic::List_1<::UnityEngine::InputSystem::XR::UsageHint>*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "featureType", ty: "::UnityEngine::InputSystem::XR::FeatureType", modifiers: "", def_value: Some("{}") }, CppParam { name: "customSize", ty: "uint32_t", modifiers: "", def_value: Some("{}") }]
