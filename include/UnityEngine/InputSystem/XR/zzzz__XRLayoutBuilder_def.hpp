...
/// @brief Method <OnFindLayoutForDevice>b__0, addr 0x4555764, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x45547c4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static __declspec(property(get=getStaticF_poseSubControlTypes, put=setStaticF_poseSubControlTypes)) ::ArrayW<::UnityEngine::InputSystem::XR::FeatureType,::Array<::UnityEngine::InputSystem::XR::FeatureType>*>  poseSubControlTypes;

/// @brief Method Build, addr 0x4554af8, size 0xad0, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* Build() ;

/// @brief Method ConvertPotentialAliasToName, addr 0x45547d4, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method GetParentControlName, addr 0x455496c, size 0x38, virtual false, abstract: false, final false
inline ::StringW GetParentControlName(::StringW  name) ;

/// @brief Method GetSizeOfFeature, addr 0x4554228, size 0x78, virtual false, abstract: false, final false
static inline uint32_t GetSizeOfFeature(::UnityEngine::InputSystem::XR::XRFeatureDescriptor  featureDescriptor) ;

/// @brief Method IsPoseControl, addr 0x45549a4, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method IsSubControl, addr 0x4554950, size 0x1c, virtual false, abstract: false, final false
inline bool IsSubControl(::StringW  name) ;

static inline ::UnityEngine::InputSystem::XR::XRLayoutBuilder* New_ctor() ;

/// @brief Method OnFindLayoutForDevice, addr 0x45543fc, size 0x3c8, virtual false, abstract: false, final false
...
/// @brief Method SanitizeString, addr 0x45542a0, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x45547cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
