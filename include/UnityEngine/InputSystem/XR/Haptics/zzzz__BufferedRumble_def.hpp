...
/// @brief Method EnqueueRumble, addr 0x4556a98, size 0xa8, virtual false, abstract: false, final false
inline void EnqueueRumble(::ArrayW<uint8_t,::Array<uint8_t>*>  samples) ;

/// @brief Method .ctor, addr 0x455693c, size 0xf4, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method get_capabilities, addr 0x4556910, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::XR::Haptics::HapticCapabilities get_capabilities() ;

/// @brief Method get_device, addr 0x455692c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputDevice* get_device() ;

/// @brief Method set_capabilities, addr 0x4556920, size 0xc, virtual false, abstract: false, final false
inline void set_capabilities(::UnityEngine::InputSystem::XR::Haptics::HapticCapabilities  value) ;

/// @brief Method set_device, addr 0x4556934, size 0x8, virtual false, abstract: false, final false
