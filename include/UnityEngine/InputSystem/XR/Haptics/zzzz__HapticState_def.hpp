...
/// @brief Method .ctor, addr 0x4556ca4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(uint32_t  samplesQueued, uint32_t  samplesAvailable) ;

/// @brief Method get_samplesAvailable, addr 0x4556cbc, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_samplesAvailable() ;

/// @brief Method get_samplesQueued, addr 0x4556cac, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_samplesQueued() ;

/// @brief Method set_samplesAvailable, addr 0x4556cc4, size 0x8, virtual false, abstract: false, final false
inline void set_samplesAvailable(uint32_t  value) ;

/// @brief Method set_samplesQueued, addr 0x4556cb4, size 0x8, virtual false, abstract: false, final false
