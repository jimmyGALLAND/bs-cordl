...
/// @brief Method .ctor, addr 0x4556d84, size 0xc, virtual false, abstract: false, final false
inline void _ctor(uint32_t  numChannels, uint32_t  frequencyHz, uint32_t  maxBufferSize) ;

/// @brief Method get_frequencyHz, addr 0x4556da0, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_frequencyHz() ;

/// @brief Method get_maxBufferSize, addr 0x4556db0, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_maxBufferSize() ;

/// @brief Method get_numChannels, addr 0x4556d90, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_numChannels() ;

/// @brief Method set_frequencyHz, addr 0x4556da8, size 0x8, virtual false, abstract: false, final false
inline void set_frequencyHz(uint32_t  value) ;

/// @brief Method set_maxBufferSize, addr 0x4556db8, size 0x8, virtual false, abstract: false, final false
inline void set_maxBufferSize(uint32_t  value) ;

/// @brief Method set_numChannels, addr 0x4556d98, size 0x8, virtual false, abstract: false, final false
