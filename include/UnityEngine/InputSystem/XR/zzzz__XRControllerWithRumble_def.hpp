...
/// @brief Method SendImpulse, addr 0x455297c, size 0xac, virtual false, abstract: false, final false
inline void SendImpulse(float_t  amplitude, float_t  duration) ;

/// @brief Method .ctor, addr 0x4552aa4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
