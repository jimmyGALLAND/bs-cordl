...
/// @brief Method DetermineValueTypeAndSize, addr 0x44e16e0, size 0x4cc, virtual false, abstract: false, final false
static inline void DetermineValueTypeAndSize(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context, int32_t  part, ByRef<::System::Type*>  valueType, ByRef<int32_t>  valueSizeInBytes, ByRef<bool>  isButton) ;

/// @brief Method EvaluateMagnitude, addr 0x44e1524, size 0x40, virtual true, abstract: false, final false
inline float_t EvaluateMagnitude(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method FinishSetup, addr 0x44e1650, size 0x90, virtual true, abstract: false, final false
inline void FinishSetup(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method ModifierIsPressed, addr 0x44e1564, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method ReadValue, addr 0x44e15ec, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method ReadValueAsObject, addr 0x44e1bac, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44e1bfc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_valueSizeInBytes, addr 0x44e151c, size 0x8, virtual true, abstract: false, final false
inline int32_t get_valueSizeInBytes() ;

/// @brief Method get_valueType, addr 0x44e1514, size 0x8, virtual true, abstract: false, final false
