...
/// @brief Method EvaluateMagnitude, addr 0x44e1260, size 0xc, virtual true, abstract: false, final false
inline float_t EvaluateMagnitude(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method FinishSetup, addr 0x44e126c, size 0x74, virtual true, abstract: false, final false
inline void FinishSetup(ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method ModifierIsPressed, addr 0x44e11e0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method ReadValue, addr 0x44e1170, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44e12e0, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
