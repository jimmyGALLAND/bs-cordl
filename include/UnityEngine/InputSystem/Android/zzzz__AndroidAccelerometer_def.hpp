...
/// @brief Method .ctor, addr 0x4573b24, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::Android::AndroidAccelerometer, 0x178>, "Size mismatch!");
