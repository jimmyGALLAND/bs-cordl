...
public:
// Declarations
/// @brief Method Initialize, addr 0x4573b84, size 0x910, virtual false, abstract: false, final false
static inline void Initialize() ;

static inline ::UnityEngine::InputSystem::Android::AndroidSupport* New_ctor() ;

/// @brief Method OnFindLayoutForDevice, addr 0x4574494, size 0x24c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x457479c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
