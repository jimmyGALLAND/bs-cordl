...
// SizeInfo { instance_size: 37, native_size: 37, calculated_instance_size: 40, calculated_native_size: 56, minimum_alignment: 8, packing: None, specified_packing: Some(0) }
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
/// @brief Method From, addr 0x4577554, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method GetEventSizeWithValueSize, addr 0x457754c, size 0x8, virtual false, abstract: false, final false
static inline int32_t GetEventSizeWithValueSize(int32_t  valueSizeInBytes) ;

/// @brief Method ToEventPtr, addr 0x4577518, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_Type, addr 0x45772f0, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_bindingIndex, addr 0x457742c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_bindingIndex() ;

/// @brief Method get_controlIndex, addr 0x45773c4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_controlIndex() ;

/// @brief Method get_interactionIndex, addr 0x4577494, size 0x14, virtual false, abstract: false, final false
inline int32_t get_interactionIndex() ;

/// @brief Method get_phase, addr 0x4577330, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputActionPhase get_phase() ;

/// @brief Method get_startTime, addr 0x4577320, size 0x8, virtual false, abstract: false, final false
inline double_t get_startTime() ;

/// @brief Method get_stateIndex, addr 0x457735c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_stateIndex() ;

/// @brief Method get_typeStatic, addr 0x457751c, size 0x30, virtual true, abstract: false, final true
inline ::UnityEngine::InputSystem::Utilities::FourCC get_typeStatic() ;

/// @brief Method get_valueData, addr 0x4577340, size 0x8, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<uint8_t> get_valueData() ;

/// @brief Method get_valueSizeInBytes, addr 0x4577348, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_bindingIndex, addr 0x4577434, size 0x60, virtual false, abstract: false, final false
inline void set_bindingIndex(int32_t  value) ;

/// @brief Method set_controlIndex, addr 0x45773cc, size 0x60, virtual false, abstract: false, final false
inline void set_controlIndex(int32_t  value) ;

/// @brief Method set_interactionIndex, addr 0x45774a8, size 0x70, virtual false, abstract: false, final false
inline void set_interactionIndex(int32_t  value) ;

/// @brief Method set_phase, addr 0x4577338, size 0x8, virtual false, abstract: false, final false
inline void set_phase(::UnityEngine::InputSystem::InputActionPhase  value) ;

/// @brief Method set_startTime, addr 0x4577328, size 0x8, virtual false, abstract: false, final false
inline void set_startTime(double_t  value) ;

/// @brief Method set_stateIndex, addr 0x4577364, size 0x60, virtual false, abstract: false, final false
...
/// @brief Size padding 0x25 - 0x28 = 0x3, packed as 0x3
 uint8_t  _cordl_size_padding[0x3];

/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x25};

static constexpr bool __IL2CPP_IS_VALUE_TYPE = true;
};
#pragma pack(pop)
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::LowLevel::ActionEvent, 0x25>, "Size mismatch!");
