...
/// @brief Method WithButton, addr 0x4576bd8, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method get_Format, addr 0x4576ba8, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format() ;

/// @brief Method get_format, addr 0x4576c0c, size 0x30, virtual true, abstract: false, final true
