...
/// @brief Method Create, addr 0x4575c60, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_Type, addr 0x4575c00, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_typeStatic, addr 0x4575c30, size 0x30, virtual true, abstract: false, final true
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::LowLevel::QueryCanRunInBackground, 0x9>, "Size mismatch!");
