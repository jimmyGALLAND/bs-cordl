...
/// @brief Method GetBackBuffer, addr 0x4583500, size 0x14, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<void> GetBackBuffer(int32_t  deviceIndex) ;

/// @brief Method GetFrontBuffer, addr 0x4583498, size 0x10, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<void> GetFrontBuffer(int32_t  deviceIndex) ;

/// @brief Method SetBackBuffer, addr 0x4583708, size 0x14, virtual false, abstract: false, final false
inline void SetBackBuffer(int32_t  deviceIndex, ::cordl_internals::Ptr<void>  ptr) ;

/// @brief Method SetFrontBuffer, addr 0x45836f8, size 0x10, virtual false, abstract: false, final false
inline void SetFrontBuffer(int32_t  deviceIndex, ::cordl_internals::Ptr<void>  ptr) ;

/// @brief Method SwapBuffers, addr 0x4583ca8, size 0x28, virtual false, abstract: false, final false
inline void SwapBuffers(int32_t  deviceIndex) ;

/// @brief Method get_valid, addr 0x4583c98, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method AllocateAll, addr 0x4583578, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method ComputeSizeOfSingleStateBuffer, addr 0x458362c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method FreeAll, addr 0x458371c, size 0xc0, virtual false, abstract: false, final false
inline void FreeAll() ;

/// @brief Method GetBackBufferForDevice, addr 0x45834a8, size 0x58, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<void> GetBackBufferForDevice(int32_t  deviceIndex) ;

/// @brief Method GetDoubleBuffersFor, addr 0x4583370, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method GetFrontBufferForDevice, addr 0x4583444, size 0x54, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<void> GetFrontBufferForDevice(int32_t  deviceIndex) ;

/// @brief Method MigrateAll, addr 0x45837dc, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method MigrateDoubleBuffer, addr 0x4583934, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method MigrateSingleBuffer, addr 0x4583aa4, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method NextDeviceOffset, addr 0x4583bac, size 0xec, virtual false, abstract: false, final false
static inline uint32_t NextDeviceOffset(uint32_t  currentOffset, ::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method SetUpDeviceToBufferMappings, addr 0x4583698, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method SwitchTo, addr 0x4583514, size 0x64, virtual false, abstract: false, final false
