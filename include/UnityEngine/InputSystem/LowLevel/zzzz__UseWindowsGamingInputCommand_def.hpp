...
/// @brief Method Create, addr 0x45766d0, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method get_Type, addr 0x4576670, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_typeStatic, addr 0x45766a0, size 0x30, virtual true, abstract: false, final true
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::LowLevel::UseWindowsGamingInputCommand, 0x9>, "Size mismatch!");
