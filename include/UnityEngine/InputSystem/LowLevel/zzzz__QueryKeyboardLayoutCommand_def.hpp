...
/// @brief Field nameBuffer, offset 0x8, size 0x100 
 __declspec(property(get=__cordl_internal_get_nameBuffer, put=__cordl_internal_set_nameBuffer)) ::UnityEngine::InputSystem::LowLevel::__QueryKeyboardLayoutCommand___nameBuffer_e__FixedBuffer  nameBuffer;
...
/// @brief Method Create, addr 0x4575e64, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LowLevel::QueryKeyboardLayoutCommand Create() ;

/// @brief Method ReadLayoutName, addr 0x4575e00, size 0x10, virtual false, abstract: false, final false
inline ::StringW ReadLayoutName() ;

/// @brief Method WriteLayoutName, addr 0x4575e10, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method get_Type, addr 0x4575dd0, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_typeStatic, addr 0x4575e34, size 0x30, virtual true, abstract: false, final true
