...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x4575978, size 0x28, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginInvoke(::UnityEngine::InputSystem::InputDevice*  device, ::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputDeviceCommand>  command, ::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x45759a0, size 0x2c, virtual true, abstract: false, final false
inline ::System::Nullable_1<int64_t> EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x4575964, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4575860, size 0x104, virtual false, abstract: false, final false
