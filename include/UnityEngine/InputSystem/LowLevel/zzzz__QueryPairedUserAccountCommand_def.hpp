...
/// @brief Field idBuffer, offset 0x210, size 0x200 
 __declspec(property(get=__cordl_internal_get_idBuffer, put=__cordl_internal_set_idBuffer)) ::UnityEngine::InputSystem::LowLevel::__QueryPairedUserAccountCommand___idBuffer_e__FixedBuffer  idBuffer;

 __declspec(property(get=get_name, put=set_name)) ::StringW  name;

/// @brief Field nameBuffer, offset 0x10, size 0x200 
 __declspec(property(get=__cordl_internal_get_nameBuffer, put=__cordl_internal_set_nameBuffer)) ::UnityEngine::InputSystem::LowLevel::__QueryPairedUserAccountCommand___nameBuffer_e__FixedBuffer  nameBuffer;
...
/// @brief Method Create, addr 0x457622c, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method get_Type, addr 0x4575f8c, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_id, addr 0x4575fbc, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_id() ;

/// @brief Method get_name, addr 0x45760dc, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method get_typeStatic, addr 0x45761fc, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method set_id, addr 0x4575fcc, size 0x110, virtual false, abstract: false, final false
inline void set_id(::StringW  value) ;

/// @brief Method set_name, addr 0x45760ec, size 0x110, virtual false, abstract: false, final false
