...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x4575a7c, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x4575b08, size 0x2c, virtual true, abstract: false, final false
inline int64_t EndInvoke(ByRef<::UnityEngine::InputSystem::LowLevel::InputDeviceCommand>  command, ::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x4575a68, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x45759cc, size 0x9c, virtual false, abstract: false, final false
