...
static __declspec(property(get=getStaticF_s_CurrentTimeOffsetToRealtimeSinceStartup, put=setStaticF_s_CurrentTimeOffsetToRealtimeSinceStartup)) double_t  s_CurrentTimeOffsetToRealtimeSinceStartup;
