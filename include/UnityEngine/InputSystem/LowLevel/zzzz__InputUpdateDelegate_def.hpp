...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x457e874, size 0xbc, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x457e930, size 0x1c, virtual true, abstract: false, final false
inline void EndInvoke(ByRef<::UnityEngine::InputSystem::LowLevel::InputEventBuffer>  eventBuffer, ::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x457e860, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x457e7d4, size 0x8c, virtual false, abstract: false, final false
