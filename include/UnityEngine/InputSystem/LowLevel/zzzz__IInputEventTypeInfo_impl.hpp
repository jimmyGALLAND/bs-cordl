...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (::UnityEngine::InputSystem::LowLevel::IInputEventTypeInfo::*)()>(&::UnityEngine::InputSystem::LowLevel::IInputEventTypeInfo::get_typeStatic)> {
