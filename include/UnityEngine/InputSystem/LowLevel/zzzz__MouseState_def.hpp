...
// SizeInfo { instance_size: 30, native_size: 30, calculated_instance_size: 32, calculated_native_size: 48, minimum_alignment: 4, packing: None, specified_packing: Some(0) }
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
/// @brief Method WithButton, addr 0x4576b44, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method get_Format, addr 0x4576b14, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format() ;

/// @brief Method get_format, addr 0x4576b78, size 0x30, virtual true, abstract: false, final true
...
/// @brief Size padding 0x1e - 0x20 = 0x2, packed as 0x2
 uint8_t  _cordl_size_padding[0x2];
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::LowLevel::MouseState, 0x1e>, "Size mismatch!");
