...
/// @brief Field timerExpiredCallback, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_timerExpiredCallback, put=__cordl_internal_set_timerExpiredCallback)) ::System::Action_4<::UnityEngine::InputSystem::InputControl*,double_t,int64_t,int32_t>*  timerExpiredCallback;

/// @brief Field valueChangeCallback, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_valueChangeCallback, put=__cordl_internal_set_valueChangeCallback)) ::System::Action_4<::UnityEngine::InputSystem::InputControl*,double_t,::UnityEngine::InputSystem::LowLevel::InputEventPtr,int64_t>*  valueChangeCallback;
...
/// @brief Method NotifyControlStateChanged, addr 0x458049c, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method NotifyTimerExpired, addr 0x45804c0, size 0x1c, virtual true, abstract: false, final true
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_4<::UnityEngine::InputSystem::InputControl*,double_t,::UnityEngine::InputSystem::LowLevel::InputEventPtr,int64_t>*> const& __cordl_internal_get_valueChangeCallback() const;
...
/// @brief Method .ctor, addr 0x45801e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddChangeMonitor, addr 0x4580110, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method AddChangeMonitor, addr 0x457ffac, size 0x164, virtual false, abstract: false, final false
static inline void AddChangeMonitor(::UnityEngine::InputSystem::InputControl*  control, ::UnityEngine::InputSystem::LowLevel::IInputStateChangeMonitor*  monitor, int64_t  monitorIndex, uint32_t  groupIndex) ;

/// @brief Method AddChangeMonitorTimeout, addr 0x45802e4, size 0xe8, virtual false, abstract: false, final false
static inline void AddChangeMonitorTimeout(::UnityEngine::InputSystem::InputControl*  control, ::UnityEngine::InputSystem::LowLevel::IInputStateChangeMonitor*  monitor, double_t  time, int64_t  monitorIndex, int32_t  timerIndex) ;

/// @brief Method Change, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TState>
static inline void Change(::UnityEngine::InputSystem::InputControl*  control, ByRef<TState>  state, ::UnityEngine::InputSystem::LowLevel::InputUpdateType  updateType, ::UnityEngine::InputSystem::LowLevel::InputEventPtr  eventPtr) ;

/// @brief Method Change, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TState>
static inline void Change(::UnityEngine::InputSystem::InputControl*  control, TState  state, ::UnityEngine::InputSystem::LowLevel::InputUpdateType  updateType, ::UnityEngine::InputSystem::LowLevel::InputEventPtr  eventPtr) ;

/// @brief Method Change, addr 0x457fbdc, size 0x264, virtual false, abstract: false, final false
static inline void Change(::UnityEngine::InputSystem::InputDevice*  device, ::UnityEngine::InputSystem::LowLevel::InputEventPtr  eventPtr, ::UnityEngine::InputSystem::LowLevel::InputUpdateType  updateType) ;

/// @brief Method IsIntegerFormat, addr 0x457fe40, size 0x16c, virtual false, abstract: false, final false
static inline bool IsIntegerFormat(::UnityEngine::InputSystem::Utilities::FourCC  format) ;

/// @brief Method RemoveChangeMonitor, addr 0x45801f0, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method RemoveChangeMonitorTimeout, addr 0x45803cc, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method add_onChange, addr 0x457fb04, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method get_currentTime, addr 0x4573644, size 0xd0, virtual false, abstract: false, final false
static inline double_t get_currentTime() ;

/// @brief Method get_currentUpdateType, addr 0x457fa74, size 0x48, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LowLevel::InputUpdateType get_currentUpdateType() ;

/// @brief Method get_updateCount, addr 0x457fabc, size 0x48, virtual false, abstract: false, final false
static inline uint32_t get_updateCount() ;

/// @brief Method remove_onChange, addr 0x457fb70, size 0x6c, virtual false, abstract: false, final false
