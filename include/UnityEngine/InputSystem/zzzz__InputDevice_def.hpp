...
// SizeInfo { instance_size: 7, native_size: 7, calculated_instance_size: 7, calculated_native_size: 23, minimum_alignment: 1, packing: Some(1), specified_packing: Some(1) }
namespace UnityEngine::InputSystem {
// Is value type: true
...
public:
// Declarations
/// @brief Method .ctor, addr 0x44f33b4, size 0x14, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "endBitOffset", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "leftChildIndex", ty: "int16_t", modifiers: "", def_value: None }, CppParam { name: "controlStartIndex", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "controlCount", ty: "uint8_t", modifiers: "", def_value: None }]
...
/// @brief Field m_AliasesForEachControl, offset 0x138, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AliasesForEachControl, put=__cordl_internal_set_m_AliasesForEachControl)) ::ArrayW<::UnityEngine::InputSystem::Utilities::InternedString,::Array<::UnityEngine::InputSystem::Utilities::InternedString>*>  m_AliasesForEachControl;

/// @brief Field m_ChildrenForEachControl, offset 0x150, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ChildrenForEachControl, put=__cordl_internal_set_m_ChildrenForEachControl)) ::ArrayW<::UnityEngine::InputSystem::InputControl*,::Array<::UnityEngine::InputSystem::InputControl*>*>  m_ChildrenForEachControl;
...
/// @brief Field m_ControlTreeNodes, offset 0x160, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_ControlTreeNodes, put=__cordl_internal_set_m_ControlTreeNodes)) ::ArrayW<::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode,::Array<::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode>*>  m_ControlTreeNodes;
...
/// @brief Field m_UsageToControl, offset 0x148, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_UsageToControl, put=__cordl_internal_set_m_UsageToControl)) ::ArrayW<::UnityEngine::InputSystem::InputControl*,::Array<::UnityEngine::InputSystem::InputControl*>*>  m_UsageToControl;

/// @brief Field m_UsagesForEachControl, offset 0x140, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_UsagesForEachControl, put=__cordl_internal_set_m_UsagesForEachControl)) ::ArrayW<::UnityEngine::InputSystem::Utilities::InternedString,::Array<::UnityEngine::InputSystem::Utilities::InternedString>*>  m_UsagesForEachControl;
...
/// @brief Method AddDeviceUsage, addr 0x44f2400, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method ClearDeviceUsages, addr 0x44f2590, size 0x60, virtual false, abstract: false, final false
inline void ClearDeviceUsages() ;

/// @brief Method CompareValue, addr 0x44f2080, size 0x100, virtual true, abstract: false, final false
inline bool CompareValue(::cordl_internals::Ptr<void>  firstStatePtr, ::cordl_internals::Ptr<void>  secondStatePtr) ;

/// @brief Method DecodeStateOffsetToControlMapEntry, addr 0x44ed248, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method DumpControlBitRangeNode, addr 0x44f2d44, size 0x418, virtual false, abstract: false, final false
inline void DumpControlBitRangeNode(int32_t  nodeIndex, ::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode  node, uint32_t  startOffset, uint32_t  sizeInBits, ::System::Collections::Generic::List_1<::StringW>*  output) ;

/// @brief Method DumpControlTree, addr 0x44f3280, size 0xcc, virtual false, abstract: false, final false
inline ::StringW DumpControlTree() ;

/// @brief Method DumpControlTree, addr 0x44f315c, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method EncodeStateOffsetToControlMapEntry, addr 0x44f2364, size 0xc, virtual false, abstract: false, final false
...
inline int64_t ExecuteCommand(ByRef<TCommand>  command) ;

/// @brief Method ExecuteCommand, addr 0x44f2208, size 0xd8, virtual true, abstract: false, final false
inline int64_t ExecuteCommand(::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputDeviceCommand>  commandPtr) ;

/// @brief Method ExecuteDisableCommand, addr 0x44f2668, size 0x6c, virtual false, abstract: false, final false
inline bool ExecuteDisableCommand() ;

/// @brief Method ExecuteEnableCommand, addr 0x44f25f0, size 0x78, virtual false, abstract: false, final false
inline bool ExecuteEnableCommand() ;

/// @brief Method HasDataChangedInRange, addr 0x44f334c, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method MakeCurrent, addr 0x44f17a8, size 0x4, virtual true, abstract: false, final false
inline void MakeCurrent() ;

static inline ::UnityEngine::InputSystem::InputDevice* New_ctor() ;

/// @brief Method NotifyAdded, addr 0x44f26d4, size 0x10, virtual false, abstract: false, final false
inline void NotifyAdded() ;

/// @brief Method NotifyConfigurationChanged, addr 0x44f2180, size 0x7c, virtual false, abstract: false, final false
inline void NotifyConfigurationChanged() ;

/// @brief Method NotifyRemoved, addr 0x44f26e4, size 0x10, virtual false, abstract: false, final false
inline void NotifyRemoved() ;

/// @brief Method OnAdded, addr 0x44f21fc, size 0x4, virtual true, abstract: false, final false
inline void OnAdded() ;

/// @brief Method OnConfigurationChanged, addr 0x44f2204, size 0x4, virtual true, abstract: false, final false
inline void OnConfigurationChanged() ;

/// @brief Method OnRemoved, addr 0x44f2200, size 0x4, virtual true, abstract: false, final false
inline void OnRemoved() ;

/// @brief Method QueryEnabledStateFromRuntime, addr 0x44f19f4, size 0xa0, virtual false, abstract: false, final false
inline bool QueryEnabledStateFromRuntime() ;

/// @brief Method ReadValueFromBufferAsObject, addr 0x44f1d8c, size 0x38, virtual true, abstract: false, final false
inline ::System::Object* ReadValueFromBufferAsObject(::cordl_internals::Ptr<void>  buffer, int32_t  bufferSize) ;

/// @brief Method ReadValueFromStateAsObject, addr 0x44f1dc4, size 0x104, virtual true, abstract: false, final false
inline ::System::Object* ReadValueFromStateAsObject(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method ReadValueFromStateIntoBuffer, addr 0x44f1ec8, size 0x1b8, virtual true, abstract: false, final false
...
/// @brief Method RemoveDeviceUsage, addr 0x44f24b4, size 0xdc, virtual false, abstract: false, final false
inline void RemoveDeviceUsage(::UnityEngine::InputSystem::Utilities::InternedString  usage) ;

/// @brief Method RequestReset, addr 0x44e6090, size 0x78, virtual false, abstract: false, final false
inline bool RequestReset() ;

/// @brief Method RequestSync, addr 0x44e5f44, size 0x78, virtual false, abstract: false, final false
inline bool RequestSync() ;

/// @brief Method WriteChangedControlStates, addr 0x44f26f4, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method WriteChangedControlStatesInternal, addr 0x44f2ac0, size 0x284, virtual false, abstract: false, final false
inline void WriteChangedControlStatesInternal(::cordl_internals::Ptr<void>  statePtr, uint32_t  stateSizeInBits, ::cordl_internals::Ptr<uint8_t>  deviceStatePtr, ::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode  parentNode, uint32_t  startOffset) ;

/// @brief Method WritePartialChangedControlStatesInternal, addr 0x44f2848, size 0x278, virtual false, abstract: false, final false
inline void WritePartialChangedControlStatesInternal(::cordl_internals::Ptr<void>  statePtr, uint32_t  stateSizeInBits, uint32_t  stateOffsetInDeviceInBits, ::cordl_internals::Ptr<uint8_t>  deviceStatePtr, ::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode  parentNode, uint32_t  startOffset) ;

constexpr ::ArrayW<::UnityEngine::InputSystem::Utilities::InternedString,::Array<::UnityEngine::InputSystem::Utilities::InternedString>*> const& __cordl_internal_get_m_AliasesForEachControl() const;
...
constexpr ::ArrayW<::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode,::Array<::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode>*> const& __cordl_internal_get_m_ControlTreeNodes() const;

constexpr ::ArrayW<::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode,::Array<::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode>*>& __cordl_internal_get_m_ControlTreeNodes() ;
...
constexpr void __cordl_internal_set_m_ControlTreeNodes(::ArrayW<::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode,::Array<::UnityEngine::InputSystem::__InputDevice__ControlBitRangeNode>*>  value) ;
...
/// @brief Method .ctor, addr 0x44f199c, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_added, addr 0x44e5f34, size 0x10, virtual false, abstract: false, final false
inline bool get_added() ;

/// @brief Method get_all, addr 0x44f1d40, size 0x4c, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_all() ;

/// @brief Method get_allControls, addr 0x44f1c1c, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputControl*> get_allControls() ;

/// @brief Method get_canRunInBackground, addr 0x44f1a94, size 0xb0, virtual false, abstract: false, final false
inline bool get_canRunInBackground() ;

/// @brief Method get_description, addr 0x44f19bc, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Layouts::InputDeviceDescription get_description() ;

/// @brief Method get_deviceId, addr 0x44f1b68, size 0x8, virtual false, abstract: false, final false
inline int32_t get_deviceId() ;

/// @brief Method get_disabledInFrontend, addr 0x44f22e0, size 0xc, virtual false, abstract: false, final false
inline bool get_disabledInFrontend() ;

/// @brief Method get_disabledInRuntime, addr 0x44f230c, size 0xc, virtual false, abstract: false, final false
inline bool get_disabledInRuntime() ;

/// @brief Method get_disabledWhileInBackground, addr 0x44f2338, size 0xc, virtual false, abstract: false, final false
inline bool get_disabledWhileInBackground() ;

/// @brief Method get_enabled, addr 0x44f19d8, size 0x1c, virtual false, abstract: false, final false
inline bool get_enabled() ;

/// @brief Method get_hasControlsWithDefaultState, addr 0x44f2370, size 0xc, virtual false, abstract: false, final false
inline bool get_hasControlsWithDefaultState() ;

/// @brief Method get_hasDontResetControls, addr 0x44f237c, size 0xc, virtual false, abstract: false, final false
inline bool get_hasDontResetControls() ;

/// @brief Method get_hasEventMerger, addr 0x44f23a8, size 0xc, virtual false, abstract: false, final false
inline bool get_hasEventMerger() ;

/// @brief Method get_hasEventPreProcessor, addr 0x44f23d4, size 0xc, virtual false, abstract: false, final false
inline bool get_hasEventPreProcessor() ;

/// @brief Method get_hasStateCallbacks, addr 0x44ebaac, size 0xc, virtual false, abstract: false, final false
inline bool get_hasStateCallbacks() ;

/// @brief Method get_lastUpdateTime, addr 0x44f1b70, size 0x54, virtual false, abstract: false, final false
inline double_t get_lastUpdateTime() ;

/// @brief Method get_native, addr 0x44f1b50, size 0xc, virtual false, abstract: false, final false
inline bool get_native() ;

/// @brief Method get_remote, addr 0x44f1b44, size 0xc, virtual false, abstract: false, final false
inline bool get_remote() ;

/// @brief Method get_updateBeforeRender, addr 0x44f1b5c, size 0xc, virtual false, abstract: false, final false
inline bool get_updateBeforeRender() ;

/// @brief Method get_valueSizeInBytes, addr 0x44f1ce8, size 0x58, virtual true, abstract: false, final false
inline int32_t get_valueSizeInBytes() ;

/// @brief Method get_valueType, addr 0x44f1c7c, size 0x6c, virtual true, abstract: false, final false
inline ::System::Type* get_valueType() ;

/// @brief Method get_wasUpdatedThisFrame, addr 0x44f1bc4, size 0x58, virtual false, abstract: false, final false
inline bool get_wasUpdatedThisFrame() ;

/// @brief Method set_disabledInFrontend, addr 0x44f22ec, size 0x20, virtual false, abstract: false, final false
inline void set_disabledInFrontend(bool  value) ;

/// @brief Method set_disabledInRuntime, addr 0x44f2318, size 0x20, virtual false, abstract: false, final false
inline void set_disabledInRuntime(bool  value) ;

/// @brief Method set_disabledWhileInBackground, addr 0x44f2344, size 0x20, virtual false, abstract: false, final false
inline void set_disabledWhileInBackground(bool  value) ;

/// @brief Method set_hasControlsWithDefaultState, addr 0x44ed4f8, size 0x20, virtual false, abstract: false, final false
inline void set_hasControlsWithDefaultState(bool  value) ;

/// @brief Method set_hasDontResetControls, addr 0x44ed5f4, size 0x20, virtual false, abstract: false, final false
inline void set_hasDontResetControls(bool  value) ;

/// @brief Method set_hasEventMerger, addr 0x44f23b4, size 0x20, virtual false, abstract: false, final false
inline void set_hasEventMerger(bool  value) ;

/// @brief Method set_hasEventPreProcessor, addr 0x44f23e0, size 0x20, virtual false, abstract: false, final false
inline void set_hasEventPreProcessor(bool  value) ;

/// @brief Method set_hasStateCallbacks, addr 0x44f2388, size 0x20, virtual false, abstract: false, final false
