...
/// @brief Field <simulatedTouchscreen>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__simulatedTouchscreen_k__BackingField, put=__cordl_internal_set__simulatedTouchscreen_k__BackingField)) ::UnityEngine::InputSystem::Touchscreen*  _simulatedTouchscreen_k__BackingField;
...
/// @brief Field m_CurrentPositions, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CurrentPositions, put=__cordl_internal_set_m_CurrentPositions)) ::ArrayW<::UnityEngine::Vector2,::Array<::UnityEngine::Vector2>*>  m_CurrentPositions;
...
/// @brief Field m_OnDeviceChange, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_OnDeviceChange, put=__cordl_internal_set_m_OnDeviceChange)) ::System::Action_2<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::InputDeviceChange>*  m_OnDeviceChange;

/// @brief Field m_OnEvent, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_OnEvent, put=__cordl_internal_set_m_OnEvent)) ::System::Action_2<::UnityEngine::InputSystem::LowLevel::InputEventPtr,::UnityEngine::InputSystem::InputDevice*>*  m_OnEvent;

/// @brief Field m_Pointers, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Pointers, put=__cordl_internal_set_m_Pointers)) ::ArrayW<::UnityEngine::InputSystem::Pointer*,::Array<::UnityEngine::InputSystem::Pointer*>*>  m_Pointers;
...
/// @brief Field m_Touches, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Touches, put=__cordl_internal_set_m_Touches)) ::ArrayW<::UnityEngine::InputSystem::Controls::ButtonControl*,::Array<::UnityEngine::InputSystem::Controls::ButtonControl*>*>  m_Touches;
...
/// @brief Method AddPointer, addr 0x4571ffc, size 0x170, virtual false, abstract: false, final false
inline void AddPointer(::UnityEngine::InputSystem::Pointer*  pointer) ;

/// @brief Method Destroy, addr 0x4571f2c, size 0xd0, virtual false, abstract: false, final false
static inline void Destroy() ;

/// @brief Method Disable, addr 0x4571e54, size 0xd8, virtual false, abstract: false, final false
static inline void Disable() ;

/// @brief Method Enable, addr 0x4571cc0, size 0x194, virtual false, abstract: false, final false
static inline void Enable() ;

/// @brief Method InstallStateChangeMonitors, addr 0x45737c8, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnDeviceChange, addr 0x4572d10, size 0x14c, virtual false, abstract: false, final false
inline void OnDeviceChange(::UnityEngine::InputSystem::InputDevice*  device, ::UnityEngine::InputSystem::InputDeviceChange  change) ;

/// @brief Method OnDisable, addr 0x4573368, size 0x164, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x4572e5c, size 0x394, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnEvent, addr 0x4572758, size 0x544, virtual false, abstract: false, final false
inline void OnEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr  eventPtr, ::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method OnSourceControlChangedValue, addr 0x45737cc, size 0x4, virtual false, abstract: false, final false
inline void OnSourceControlChangedValue(::UnityEngine::InputSystem::InputControl*  control, double_t  time, ::UnityEngine::InputSystem::LowLevel::InputEventPtr  eventPtr, int64_t  sourceDeviceAndButtonIndex) ;

/// @brief Method RemovePointer, addr 0x457216c, size 0x1f4, virtual false, abstract: false, final false
inline void RemovePointer(::UnityEngine::InputSystem::Pointer*  pointer) ;

/// @brief Method UninstallStateChangeMonitors, addr 0x45737d0, size 0x4, virtual false, abstract: false, final false
inline void UninstallStateChangeMonitors(int32_t  startIndex) ;

/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyControlStateChanged, addr 0x45737c0, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyTimerExpired, addr 0x45737c4, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method UpdateTouch, addr 0x4572360, size 0x3f8, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::InputDeviceChange>*> const& __cordl_internal_get_m_OnDeviceChange() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::InputSystem::LowLevel::InputEventPtr,::UnityEngine::InputSystem::InputDevice*>*> const& __cordl_internal_get_m_OnEvent() const;
...
/// @brief Method .ctor, addr 0x45737d4, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityW<::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation> getStaticF_s_Instance() ;

/// @brief Method get_instance, addr 0x4571c78, size 0x48, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation> get_instance() ;

/// @brief Method get_simulatedTouchscreen, addr 0x4571c68, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_simulatedTouchscreen, addr 0x4571c70, size 0x8, virtual false, abstract: false, final false
