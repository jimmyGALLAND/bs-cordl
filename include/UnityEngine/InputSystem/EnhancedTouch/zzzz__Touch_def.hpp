...
public:
// Declarations
/// @brief Method AddFingers, addr 0x4571290, size 0x114, virtual false, abstract: false, final false
inline void AddFingers(::UnityEngine::InputSystem::Touchscreen*  screen) ;

/// @brief Method Destroy, addr 0x456e394, size 0x84, virtual false, abstract: false, final false
inline void Destroy() ;

/// @brief Method RemoveFingers, addr 0x45713a4, size 0x144, virtual false, abstract: false, final false
inline void RemoveFingers(::UnityEngine::InputSystem::Touchscreen*  screen) ;

/// @brief Method UpdateActiveFingers, addr 0x45707d0, size 0x118, virtual false, abstract: false, final false
inline void UpdateActiveFingers() ;

/// @brief Method UpdateActiveTouches, addr 0x4570118, size 0x588, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF___9__80_0, put=setStaticF___9__80_0)) ::UnityEngine::InputSystem::Utilities::__SavedStructState_1__TypedRestore<::UnityEngine::InputSystem::EnhancedTouch::__Touch__GlobalState>*  __9__80_0;
...
/// @brief Method <SaveAndResetState>b__80_0, addr 0x4571868, size 0x84, virtual false, abstract: false, final false
inline void _SaveAndResetState_b__80_0(ByRef<::UnityEngine::InputSystem::EnhancedTouch::__Touch__GlobalState>  state) ;

/// @brief Method <SaveAndResetState>b__80_1, addr 0x45718ec, size 0x4, virtual false, abstract: false, final false
inline void _SaveAndResetState_b__80_1() ;

/// @brief Method .ctor, addr 0x4571860, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddTouchscreen, addr 0x456e534, size 0x8c, virtual false, abstract: false, final false
static inline void AddTouchscreen(::UnityEngine::InputSystem::Touchscreen*  screen) ;

/// @brief Method BeginUpdate, addr 0x45714e8, size 0x74, virtual false, abstract: false, final false
static inline void BeginUpdate() ;

/// @brief Method CreateGlobalState, addr 0x457155c, size 0x2c, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::EnhancedTouch::__Touch__GlobalState CreateGlobalState() ;

/// @brief Method Equals, addr 0x457116c, size 0xb0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x45710f8, size 0x74, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::EnhancedTouch::Touch  other) ;

/// @brief Method GetHashCode, addr 0x457121c, size 0x74, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method RemoveTouchscreen, addr 0x456e5c0, size 0xe4, virtual false, abstract: false, final false
static inline void RemoveTouchscreen(::UnityEngine::InputSystem::Touchscreen*  screen) ;

/// @brief Method SaveAndResetState, addr 0x4571588, size 0x210, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::ISavedState* SaveAndResetState() ;

/// @brief Method ToString, addr 0x4570e0c, size 0x2ec, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x456eb0c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method add_onFingerDown, addr 0x4570974, size 0xc4, virtual false, abstract: false, final false
static inline void add_onFingerDown(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>*  value) ;

/// @brief Method add_onFingerMove, addr 0x4570c84, size 0xc4, virtual false, abstract: false, final false
static inline void add_onFingerMove(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>*  value) ;

/// @brief Method add_onFingerUp, addr 0x4570afc, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method get_activeFingers, addr 0x4570730, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_activeTouches, addr 0x4570078, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_began, addr 0x456fa00, size 0x60, virtual false, abstract: false, final false
inline bool get_began() ;

/// @brief Method get_delta, addr 0x456fda8, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_delta() ;

/// @brief Method get_displayIndex, addr 0x456fecc, size 0x5c, virtual false, abstract: false, final false
inline int32_t get_displayIndex() ;

/// @brief Method get_ended, addr 0x456fb08, size 0x88, virtual false, abstract: false, final false
inline bool get_ended() ;

/// @brief Method get_extraData, addr 0x456ff28, size 0x48, virtual false, abstract: false, final false
inline ByRef<::UnityEngine::InputSystem::EnhancedTouch::__Touch__ExtraDataPerTouchState> get_extraData() ;

/// @brief Method get_finger, addr 0x456f9b0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::EnhancedTouch::Finger* get_finger() ;

/// @brief Method get_fingers, addr 0x45706a0, size 0x90, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*> get_fingers() ;

/// @brief Method get_history, addr 0x456ff70, size 0x108, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::EnhancedTouch::TouchHistory get_history() ;

/// @brief Method get_inProgress, addr 0x456fa60, size 0xa8, virtual false, abstract: false, final false
inline bool get_inProgress() ;

/// @brief Method get_isInProgress, addr 0x456eb18, size 0x74, virtual false, abstract: false, final false
inline bool get_isInProgress() ;

/// @brief Method get_isTap, addr 0x456fe60, size 0x60, virtual false, abstract: false, final false
inline bool get_isTap() ;

/// @brief Method get_maxHistoryLengthPerFinger, addr 0x456ef54, size 0x58, virtual false, abstract: false, final false
static inline int32_t get_maxHistoryLengthPerFinger() ;

/// @brief Method get_phase, addr 0x456f954, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::TouchPhase get_phase() ;

/// @brief Method get_pressure, addr 0x456fb90, size 0x5c, virtual false, abstract: false, final false
inline float_t get_pressure() ;

/// @brief Method get_radius, addr 0x456fbec, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_radius() ;

/// @brief Method get_screen, addr 0x456fcec, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Touchscreen* get_screen() ;

/// @brief Method get_screenPosition, addr 0x456eab0, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_screenPosition() ;

/// @brief Method get_screens, addr 0x45708e8, size 0x8c, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::InputSystem::Touchscreen*>* get_screens() ;

/// @brief Method get_startScreenPosition, addr 0x456fd4c, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_startScreenPosition() ;

/// @brief Method get_startTime, addr 0x456fc48, size 0x5c, virtual false, abstract: false, final false
inline double_t get_startTime() ;

/// @brief Method get_state, addr 0x456f9b8, size 0x48, virtual false, abstract: false, final false
inline ByRef<::UnityEngine::InputSystem::LowLevel::TouchState> get_state() ;

/// @brief Method get_tapCount, addr 0x456fe04, size 0x5c, virtual false, abstract: false, final false
inline int32_t get_tapCount() ;

/// @brief Method get_time, addr 0x456fca4, size 0x48, virtual false, abstract: false, final false
inline double_t get_time() ;

/// @brief Method get_touchId, addr 0x456f8f8, size 0x5c, virtual false, abstract: false, final false
inline int32_t get_touchId() ;

/// @brief Method get_uniqueId, addr 0x456f89c, size 0x5c, virtual false, abstract: false, final false
inline uint32_t get_uniqueId() ;

/// @brief Method get_updateStepCount, addr 0x456eb8c, size 0x5c, virtual false, abstract: false, final false
inline uint32_t get_updateStepCount() ;

/// @brief Method get_valid, addr 0x456e958, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method remove_onFingerDown, addr 0x4570a38, size 0xc4, virtual false, abstract: false, final false
static inline void remove_onFingerDown(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>*  value) ;

/// @brief Method remove_onFingerMove, addr 0x4570d48, size 0xc4, virtual false, abstract: false, final false
static inline void remove_onFingerMove(::System::Action_1<::UnityEngine::InputSystem::EnhancedTouch::Finger*>*  value) ;

/// @brief Method remove_onFingerUp, addr 0x4570bc0, size 0xc4, virtual false, abstract: false, final false
