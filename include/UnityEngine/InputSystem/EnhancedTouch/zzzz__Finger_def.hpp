...
/// @brief Field m_StateHistory, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_StateHistory, put=__cordl_internal_set_m_StateHistory)) ::UnityEngine::InputSystem::LowLevel::InputStateHistory_1<::UnityEngine::InputSystem::LowLevel::TouchState>*  m_StateHistory;
...
/// @brief Method FindTouch, addr 0x456f348, size 0x334, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::EnhancedTouch::Touch FindTouch(uint32_t  uniqueId) ;

/// @brief Method GetTouchHistory, addr 0x456f67c, size 0x220, virtual false, abstract: false, final false
...
static inline ::UnityEngine::InputSystem::EnhancedTouch::Finger* New_ctor(::UnityEngine::InputSystem::Touchscreen*  screen, int32_t  index, ::UnityEngine::InputSystem::LowLevel::InputUpdateType  updateMask) ;

/// @brief Method OnTouchRecorded, addr 0x456f094, size 0x28c, virtual false, abstract: false, final false
inline void OnTouchRecorded(::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record  record) ;

/// @brief Method ShouldRecordTouch, addr 0x456efac, size 0xb4, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::LowLevel::InputStateHistory_1<::UnityEngine::InputSystem::LowLevel::TouchState>*> const& __cordl_internal_get_m_StateHistory() const;
...
/// @brief Method .ctor, addr 0x456ec58, size 0x2fc, virtual false, abstract: false, final false
...
/// @brief Method get_currentTouch, addr 0x456e85c, size 0xfc, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::EnhancedTouch::Touch get_currentTouch() ;

/// @brief Method get_index, addr 0x456e7dc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_index() ;

/// @brief Method get_isActive, addr 0x456e7e4, size 0x78, virtual false, abstract: false, final false
inline bool get_isActive() ;

/// @brief Method get_lastTouch, addr 0x456ea38, size 0x78, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::EnhancedTouch::Touch get_lastTouch() ;

/// @brief Method get_screen, addr 0x456e7d4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Touchscreen* get_screen() ;

/// @brief Method get_screenPosition, addr 0x456e9a0, size 0x98, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_screenPosition() ;

/// @brief Method get_touchHistory, addr 0x456ebe8, size 0x34, virtual false, abstract: false, final false
