...
constexpr  UnityEngine::InputSystem::IInputInteraction_1<TValue>::operator ::UnityEngine::InputSystem::IInputInteraction*() noexcept {
...
template<typename TValue>
constexpr ::UnityEngine::InputSystem::IInputInteraction* UnityEngine::InputSystem::IInputInteraction_1<TValue>::i___UnityEngine__InputSystem__IInputInteraction() noexcept {
return static_cast<::UnityEngine::InputSystem::IInputInteraction*>(static_cast<void*>(this));
}
