...
public:
// Declarations
/// @brief Method AddControl, addr 0x4565eb0, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method Destroy, addr 0x4565e0c, size 0xa4, virtual false, abstract: false, final false
inline void Destroy() ;

/// @brief Method RemoveControl, addr 0x4566210, size 0x110, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "eventPtr", ty: "::UnityEngine::InputSystem::LowLevel::InputEventPtr", modifiers: "", def_value: None }, CppParam { name: "buffer", ty: "::Unity::Collections::NativeArray_1<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "device", ty: "::UnityEngine::InputSystem::InputDevice*", modifiers: "", def_value: None }, CppParam { name: "firstControl", ty: "::UnityW<::UnityEngine::InputSystem::OnScreen::OnScreenControl>", modifiers: "", def_value: None }]
constexpr __OnScreenControl__OnScreenDeviceInfo(::UnityEngine::InputSystem::LowLevel::InputEventPtr  eventPtr, ::Unity::Collections::NativeArray_1<uint8_t>  buffer, ::UnityEngine::InputSystem::InputDevice*  device, ::UnityW<::UnityEngine::InputSystem::OnScreen::OnScreenControl>  firstControl) noexcept;
...
static __declspec(property(get=getStaticF_s_OnScreenDevices, put=setStaticF_s_OnScreenDevices)) ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::OnScreen::__OnScreenControl__OnScreenDeviceInfo>  s_OnScreenDevices;

static inline ::UnityEngine::InputSystem::OnScreen::OnScreenControl* New_ctor() ;

/// @brief Method OnDisable, addr 0x4566014, size 0x1fc, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x4566010, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method SentDefaultValueToControl, addr 0x4565edc, size 0x134, virtual false, abstract: false, final false
inline void SentDefaultValueToControl() ;

/// @brief Method SetupInputControl, addr 0x45656ec, size 0x718, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x45656a0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_control, addr 0x4565e04, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputControl* get_control() ;

/// @brief Method get_controlPath, addr 0x45656a8, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_controlPath, addr 0x45656b4, size 0x38, virtual false, abstract: false, final false
