...
/// @brief Field m_CurrentTapPhase, offset 0x20, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_CurrentTapPhase, put=__cordl_internal_set_m_CurrentTapPhase)) ::UnityEngine::InputSystem::Interactions::__MultiTapInteraction__TapPhase  m_CurrentTapPhase;
...
/// @brief Method Process, addr 0x44d32d8, size 0x280, virtual true, abstract: false, final true
inline void Process(ByRef<::UnityEngine::InputSystem::InputInteractionContext>  context) ;

/// @brief Method Reset, addr 0x44d3558, size 0xc, virtual true, abstract: false, final true
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x44d3564, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_pressPointOrDefault, addr 0x44d31f8, size 0x58, virtual false, abstract: false, final false
inline float_t get_pressPointOrDefault() ;

/// @brief Method get_releasePointOrDefault, addr 0x44d3250, size 0x88, virtual false, abstract: false, final false
inline float_t get_releasePointOrDefault() ;

/// @brief Method get_tapDelayOrDefault, addr 0x44d3188, size 0x70, virtual false, abstract: false, final false
inline float_t get_tapDelayOrDefault() ;

/// @brief Method get_tapTimeOrDefault, addr 0x44d3118, size 0x70, virtual false, abstract: false, final false
