...
/// @brief Method FinishSetup, addr 0x44f5b2c, size 0x1cc, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method MakeCurrent, addr 0x44f5864, size 0x80, virtual true, abstract: false, final false
inline void MakeCurrent() ;

static inline ::UnityEngine::InputSystem::Mouse* New_ctor() ;

/// @brief Method OnAdded, addr 0x44f5930, size 0x5c, virtual true, abstract: false, final false
inline void OnAdded() ;

/// @brief Method OnNextUpdate, addr 0x44f5e98, size 0x90, virtual false, abstract: false, final false
inline void OnNextUpdate() ;

/// @brief Method OnRemoved, addr 0x44f598c, size 0x80, virtual true, abstract: false, final false
inline void OnRemoved() ;

/// @brief Method OnStateEvent, addr 0x44f5fb0, size 0x44, virtual false, abstract: false, final false
inline void OnStateEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr  eventPtr) ;

/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.OnNextUpdate, addr 0x44f6040, size 0x4, virtual true, abstract: false, final true
inline void UnityEngine_InputSystem_LowLevel_IInputStateCallbackReceiver_OnNextUpdate() ;

/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.OnStateEvent, addr 0x44f6044, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method WarpCursorPosition, addr 0x44f5a88, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44f6048, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_backButton, addr 0x44f57a0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_backButton() ;

/// @brief Method get_clickCount, addr 0x44f57c0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::IntegerControl* get_clickCount() ;

/// @brief Method get_current, addr 0x44f57d0, size 0x48, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Mouse* get_current() ;

/// @brief Method get_forwardButton, addr 0x44f57b0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_forwardButton() ;

/// @brief Method get_leftButton, addr 0x44f5770, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_leftButton() ;

/// @brief Method get_middleButton, addr 0x44f5780, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_middleButton() ;

/// @brief Method get_rightButton, addr 0x44f5790, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_rightButton() ;

/// @brief Method get_scroll, addr 0x44f5760, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_backButton, addr 0x44f57a8, size 0x8, virtual false, abstract: false, final false
inline void set_backButton(::UnityEngine::InputSystem::Controls::ButtonControl*  value) ;

/// @brief Method set_clickCount, addr 0x44f57c8, size 0x8, virtual false, abstract: false, final false
inline void set_clickCount(::UnityEngine::InputSystem::Controls::IntegerControl*  value) ;

/// @brief Method set_current, addr 0x44f5818, size 0x4c, virtual false, abstract: false, final false
static inline void set_current(::UnityEngine::InputSystem::Mouse*  value) ;

/// @brief Method set_forwardButton, addr 0x44f57b8, size 0x8, virtual false, abstract: false, final false
inline void set_forwardButton(::UnityEngine::InputSystem::Controls::ButtonControl*  value) ;

/// @brief Method set_leftButton, addr 0x44f5778, size 0x8, virtual false, abstract: false, final false
inline void set_leftButton(::UnityEngine::InputSystem::Controls::ButtonControl*  value) ;

/// @brief Method set_middleButton, addr 0x44f5788, size 0x8, virtual false, abstract: false, final false
inline void set_middleButton(::UnityEngine::InputSystem::Controls::ButtonControl*  value) ;

/// @brief Method set_rightButton, addr 0x44f5798, size 0x8, virtual false, abstract: false, final false
inline void set_rightButton(::UnityEngine::InputSystem::Controls::ButtonControl*  value) ;

/// @brief Method set_scroll, addr 0x44f5768, size 0x8, virtual false, abstract: false, final false
