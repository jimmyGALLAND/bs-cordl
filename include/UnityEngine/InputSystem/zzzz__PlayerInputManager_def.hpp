...
/// @brief Method .ctor, addr 0x4550674, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x455071c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_JoinActionDelegate, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_JoinActionDelegate, put=__cordl_internal_set_m_JoinActionDelegate)) ::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>*  m_JoinActionDelegate;
...
/// @brief Field m_PlayerJoinedEvent, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_PlayerJoinedEvent, put=__cordl_internal_set_m_PlayerJoinedEvent)) ::UnityEngine::InputSystem::__PlayerInputManager__PlayerJoinedEvent*  m_PlayerJoinedEvent;
...
/// @brief Method CheckIfPlayerCanJoin, addr 0x4550ac8, size 0x2d8, virtual false, abstract: false, final false
inline bool CheckIfPlayerCanJoin(int32_t  playerIndex) ;

/// @brief Method DisableJoining, addr 0x455028c, size 0xd8, virtual false, abstract: false, final false
inline void DisableJoining() ;

/// @brief Method EnableJoining, addr 0x4550364, size 0x1e8, virtual false, abstract: false, final false
inline void EnableJoining() ;

/// @brief Method IsDeviceUsableWithPlayerActions, addr 0x45511a4, size 0x3a0, virtual false, abstract: false, final false
inline bool IsDeviceUsableWithPlayerActions(::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method JoinPlayer, addr 0x4550df4, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method JoinPlayer, addr 0x4550f98, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method JoinPlayerFromAction, addr 0x4550da0, size 0x54, virtual false, abstract: false, final false
inline void JoinPlayerFromAction(::UnityEngine::InputSystem::__InputAction__CallbackContext  context) ;

/// @brief Method JoinPlayerFromActionIfNotAlreadyJoined, addr 0x4550eb0, size 0xe8, virtual false, abstract: false, final false
inline void JoinPlayerFromActionIfNotAlreadyJoined(::UnityEngine::InputSystem::__InputAction__CallbackContext  context) ;

/// @brief Method JoinPlayerFromUI, addr 0x4550a7c, size 0x4c, virtual false, abstract: false, final false
inline void JoinPlayerFromUI() ;

static inline ::UnityEngine::InputSystem::PlayerInputManager* New_ctor() ;

/// @brief Method NotifyPlayerJoined, addr 0x454df3c, size 0x130, virtual false, abstract: false, final false
inline void NotifyPlayerJoined(::UnityEngine::InputSystem::PlayerInput*  player) ;

/// @brief Method NotifyPlayerLeft, addr 0x454e8e0, size 0x130, virtual false, abstract: false, final false
inline void NotifyPlayerLeft(::UnityEngine::InputSystem::PlayerInput*  player) ;

/// @brief Method OnDisable, addr 0x4551884, size 0xdc, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x4551544, size 0x340, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnUnpairedDeviceUsed, addr 0x45510f0, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method UpdateSplitScreen, addr 0x454fc4c, size 0x564, virtual false, abstract: false, final false
inline void UpdateSplitScreen() ;

/// @brief Method ValidateInputActionAsset, addr 0x4550a78, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4551960, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_onPlayerJoined, addr 0x4550764, size 0x9c, virtual false, abstract: false, final false
inline void add_onPlayerJoined(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>*  value) ;

/// @brief Method add_onPlayerLeft, addr 0x455089c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method get_fixedNumberOfSplitScreens, addr 0x45501b8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_fixedNumberOfSplitScreens() ;

/// @brief Method get_instance, addr 0x45509e4, size 0x48, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::InputSystem::PlayerInputManager> get_instance() ;

/// @brief Method get_joinAction, addr 0x455054c, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputActionProperty get_joinAction() ;

/// @brief Method get_joinBehavior, addr 0x4550234, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::PlayerJoinBehavior get_joinBehavior() ;

/// @brief Method get_joiningEnabled, addr 0x455022c, size 0x8, virtual false, abstract: false, final false
inline bool get_joiningEnabled() ;

/// @brief Method get_maintainAspectRatioInSplitScreen, addr 0x45501b0, size 0x8, virtual false, abstract: false, final false
inline bool get_maintainAspectRatioInSplitScreen() ;

/// @brief Method get_maxPlayerCount, addr 0x4550224, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxPlayerCount() ;

/// @brief Method get_messages, addr 0x4551054, size 0x9c, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> get_messages() ;

/// @brief Method get_notificationBehavior, addr 0x4550604, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::PlayerNotifications get_notificationBehavior() ;

/// @brief Method get_playerCount, addr 0x45501cc, size 0x58, virtual false, abstract: false, final false
inline int32_t get_playerCount() ;

/// @brief Method get_playerJoinedEvent, addr 0x4550614, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::__PlayerInputManager__PlayerJoinedEvent* get_playerJoinedEvent() ;

/// @brief Method get_playerLeftEvent, addr 0x45506bc, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::__PlayerInputManager__PlayerLeftEvent* get_playerLeftEvent() ;

/// @brief Method get_playerPrefab, addr 0x45509d4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_playerPrefab() ;

/// @brief Method get_splitScreen, addr 0x454fa10, size 0x8, virtual false, abstract: false, final false
inline bool get_splitScreen() ;

/// @brief Method get_splitScreenArea, addr 0x45501c0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_splitScreenArea() ;

/// @brief Method remove_onPlayerJoined, addr 0x4550800, size 0x9c, virtual false, abstract: false, final false
inline void remove_onPlayerJoined(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>*  value) ;

/// @brief Method remove_onPlayerLeft, addr 0x4550938, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method set_instance, addr 0x4550a2c, size 0x4c, virtual false, abstract: false, final false
static inline void set_instance(::UnityEngine::InputSystem::PlayerInputManager*  value) ;

/// @brief Method set_joinAction, addr 0x4550560, size 0xa4, virtual false, abstract: false, final false
inline void set_joinAction(::UnityEngine::InputSystem::InputActionProperty  value) ;

/// @brief Method set_joinBehavior, addr 0x455023c, size 0x50, virtual false, abstract: false, final false
inline void set_joinBehavior(::UnityEngine::InputSystem::PlayerJoinBehavior  value) ;

/// @brief Method set_notificationBehavior, addr 0x455060c, size 0x8, virtual false, abstract: false, final false
inline void set_notificationBehavior(::UnityEngine::InputSystem::PlayerNotifications  value) ;

/// @brief Method set_playerPrefab, addr 0x45509dc, size 0x8, virtual false, abstract: false, final false
inline void set_playerPrefab(::UnityEngine::GameObject*  value) ;

/// @brief Method set_splitScreen, addr 0x454fa18, size 0x234, virtual false, abstract: false, final false
