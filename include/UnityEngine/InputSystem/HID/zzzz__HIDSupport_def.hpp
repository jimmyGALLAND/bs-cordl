...
public:
// Declarations
/// @brief Method .ctor, addr 0x456dabc, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::HID::__HID__UsagePage  page, int32_t  usage) ;

/// @brief Method .ctor, addr 0x456dc0c, size 0xc, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF_s_SupportedHIDUsages, put=setStaticF_s_SupportedHIDUsages)) ::ArrayW<::UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage,::Array<::UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage>*>  s_SupportedHIDUsages;

/// @brief Method Initialize, addr 0x456dac4, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method get_supportedHIDUsages, addr 0x456d830, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method set_supportedHIDUsages, addr 0x456d890, size 0x22c, virtual false, abstract: false, final false
