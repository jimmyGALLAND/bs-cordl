...
/// @brief Method Canceled, addr 0x44e38c8, size 0x40, virtual false, abstract: false, final false
inline void Canceled() ;

/// @brief Method ComputeMagnitude, addr 0x44e37bc, size 0x8, virtual false, abstract: false, final false
inline float_t ComputeMagnitude() ;

/// @brief Method ControlIsActuated, addr 0x44e37c4, size 0xc, virtual false, abstract: false, final false
inline bool ControlIsActuated(float_t  threshold) ;

/// @brief Method Performed, addr 0x44e3808, size 0x40, virtual false, abstract: false, final false
inline void Performed() ;

/// @brief Method PerformedAndStayPerformed, addr 0x44e3888, size 0x40, virtual false, abstract: false, final false
inline void PerformedAndStayPerformed() ;

/// @brief Method PerformedAndStayStarted, addr 0x44e3848, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method SetTimeout, addr 0x44e3948, size 0x24, virtual false, abstract: false, final false
inline void SetTimeout(float_t  seconds) ;

/// @brief Method SetTotalTimeoutCompletionTime, addr 0x44e396c, size 0x90, virtual false, abstract: false, final false
inline void SetTotalTimeoutCompletionTime(float_t  seconds) ;

/// @brief Method Started, addr 0x44e37d0, size 0x38, virtual false, abstract: false, final false
inline void Started() ;

/// @brief Method Waiting, addr 0x44e3908, size 0x40, virtual false, abstract: false, final false
inline void Waiting() ;

/// @brief Method get_action, addr 0x44e3710, size 0x24, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputAction* get_action() ;

/// @brief Method get_bindingIndex, addr 0x44e3a10, size 0x8, virtual false, abstract: false, final false
inline int32_t get_bindingIndex() ;

/// @brief Method get_control, addr 0x44e3734, size 0x24, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputControl* get_control() ;

/// @brief Method get_controlIndex, addr 0x44e3a04, size 0xc, virtual false, abstract: false, final false
inline int32_t get_controlIndex() ;

/// @brief Method get_interactionIndex, addr 0x44e3a18, size 0xc, virtual false, abstract: false, final false
inline int32_t get_interactionIndex() ;

/// @brief Method get_isStarted, addr 0x44e37ac, size 0x10, virtual false, abstract: false, final false
inline bool get_isStarted() ;

/// @brief Method get_isWaiting, addr 0x44e379c, size 0x10, virtual false, abstract: false, final false
inline bool get_isWaiting() ;

/// @brief Method get_mapIndex, addr 0x44e39fc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_mapIndex() ;

/// @brief Method get_phase, addr 0x44e3758, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputActionPhase get_phase() ;

/// @brief Method get_startTime, addr 0x44e3768, size 0x8, virtual false, abstract: false, final false
inline double_t get_startTime() ;

/// @brief Method get_time, addr 0x44e3760, size 0x8, virtual false, abstract: false, final false
inline double_t get_time() ;

/// @brief Method get_timerHasExpired, addr 0x44e3770, size 0xc, virtual false, abstract: false, final false
inline bool get_timerHasExpired() ;

/// @brief Method set_timerHasExpired, addr 0x44e377c, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "m_State", ty: "::UnityEngine::InputSystem::InputActionState*", modifiers: "", def_value: None }, CppParam { name: "m_Flags", ty: "::UnityEngine::InputSystem::__InputInteractionContext__Flags", modifiers: "", def_value: None }, CppParam { name: "m_TriggerState", ty: "::UnityEngine::InputSystem::__InputActionState__TriggerState", modifiers: "", def_value: None }]
constexpr InputInteractionContext(::UnityEngine::InputSystem::InputActionState*  m_State, ::UnityEngine::InputSystem::__InputInteractionContext__Flags  m_Flags, ::UnityEngine::InputSystem::__InputActionState__TriggerState  m_TriggerState) noexcept;
...
/// @brief Field m_TriggerState, offset: 0xc, size: 0x30, def value: None
...
static_assert(offsetof(::UnityEngine::InputSystem::InputInteractionContext, m_TriggerState) == 0xc, "Offset mismatch!");
