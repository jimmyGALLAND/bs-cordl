...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::InputSystem::Haptics::IDualMotorRumble::*)(float_t, float_t)>(&::UnityEngine::InputSystem::Haptics::IDualMotorRumble::SetMotorSpeeds)> {
