...
/// @brief Method <MaskByGroups>b__45_0, addr 0x44ca13c, size 0x20, virtual false, abstract: false, final false
inline bool _MaskByGroups_b__45_0(::StringW  x) ;

/// @brief Method .ctor, addr 0x44ca134, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
// SizeInfo { instance_size: 88, native_size: 88, calculated_instance_size: 88, calculated_native_size: 104, minimum_alignment: 8, packing: None, specified_packing: None }
namespace UnityEngine::InputSystem {
// Is value type: true
...
/// @brief Method Equals, addr 0x44c9838, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x44c976c, size 0xcc, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::InputBinding  other) ;

/// @brief Method GenerateId, addr 0x44be69c, size 0x34, virtual false, abstract: false, final false
inline void GenerateId() ;

/// @brief Method GetHashCode, addr 0x44c9914, size 0x104, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetNameOfComposite, addr 0x44c9530, size 0x44, virtual false, abstract: false, final false
inline ::StringW GetNameOfComposite() ;

/// @brief Method MaskByGroup, addr 0x44c9580, size 0x18, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::InputBinding MaskByGroup(::StringW  group) ;

/// @brief Method MaskByGroups, addr 0x44c9598, size 0x158, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::InputBinding MaskByGroups(::ArrayW<::StringW,::Array<::StringW>*>  groups) ;

/// @brief Method Matches, addr 0x44c9fc8, size 0x8, virtual false, abstract: false, final false
inline bool Matches(::UnityEngine::InputSystem::InputBinding  binding) ;

/// @brief Method Matches, addr 0x44c9fd0, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method RemoveOverrides, addr 0x44c9574, size 0xc, virtual false, abstract: false, final false
inline void RemoveOverrides() ;

/// @brief Method ToDisplayString, addr 0x44c9b58, size 0x470, virtual false, abstract: false, final false
inline ::StringW ToDisplayString(ByRef<::StringW>  deviceLayoutName, ByRef<::StringW>  controlPath, ::UnityEngine::InputSystem::__InputBinding__DisplayStringOptions  options, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method ToDisplayString, addr 0x44c9b2c, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x44c9a18, size 0x114, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TriggersAction, addr 0x44bee34, size 0x58, virtual false, abstract: false, final false
inline bool TriggersAction(::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method .ctor, addr 0x44c9510, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, ::StringW  action, ::StringW  groups, ::StringW  processors, ::StringW  interactions, ::StringW  name) ;

/// @brief Method get_action, addr 0x44c94d8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_action() ;

/// @brief Method get_effectiveInteractions, addr 0x44c96f0, size 0x18, virtual false, abstract: false, final false
inline ::StringW get_effectiveInteractions() ;

/// @brief Method get_effectivePath, addr 0x44c2778, size 0x18, virtual false, abstract: false, final false
inline ::StringW get_effectivePath() ;

/// @brief Method get_effectiveProcessors, addr 0x44c9708, size 0x18, virtual false, abstract: false, final false
inline ::StringW get_effectiveProcessors() ;

/// @brief Method get_groups, addr 0x44c94c8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_groups() ;

/// @brief Method get_hasOverrides, addr 0x44c94e8, size 0x28, virtual false, abstract: false, final false
inline bool get_hasOverrides() ;

/// @brief Method get_id, addr 0x44c9420, size 0x48, virtual false, abstract: false, final false
inline ::System::Guid get_id() ;

/// @brief Method get_interactions, addr 0x44c9488, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_interactions() ;

/// @brief Method get_isComposite, addr 0x44bee28, size 0xc, virtual false, abstract: false, final false
inline bool get_isComposite() ;

/// @brief Method get_isEmpty, addr 0x44c9720, size 0x4c, virtual false, abstract: false, final false
inline bool get_isEmpty() ;

/// @brief Method get_isPartOfComposite, addr 0x44c10dc, size 0xc, virtual false, abstract: false, final false
inline bool get_isPartOfComposite() ;

/// @brief Method get_name, addr 0x44c9410, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method get_overrideInteractions, addr 0x44c9498, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_overrideInteractions() ;

/// @brief Method get_overridePath, addr 0x44c9478, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_overridePath() ;

/// @brief Method get_overrideProcessors, addr 0x44c94b8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_overrideProcessors() ;

/// @brief Method get_path, addr 0x44c9468, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_path() ;

/// @brief Method get_processors, addr 0x44c94a8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x44c18a8, size 0x34, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::InputSystem::InputBinding  left, ::UnityEngine::InputSystem::InputBinding  right) ;

/// @brief Method op_Inequality, addr 0x44c98c8, size 0x4c, virtual false, abstract: false, final false
static inline bool op_Inequality(::UnityEngine::InputSystem::InputBinding  left, ::UnityEngine::InputSystem::InputBinding  right) ;

/// @brief Method set_action, addr 0x44c94e0, size 0x8, virtual false, abstract: false, final false
inline void set_action(::StringW  value) ;

/// @brief Method set_groups, addr 0x44c94d0, size 0x8, virtual false, abstract: false, final false
inline void set_groups(::StringW  value) ;

/// @brief Method set_id, addr 0x44beb20, size 0x2c, virtual false, abstract: false, final false
inline void set_id(::System::Guid  value) ;

/// @brief Method set_interactions, addr 0x44c9490, size 0x8, virtual false, abstract: false, final false
inline void set_interactions(::StringW  value) ;

/// @brief Method set_isComposite, addr 0x44be670, size 0x20, virtual false, abstract: false, final false
inline void set_isComposite(bool  value) ;

/// @brief Method set_isPartOfComposite, addr 0x44c13dc, size 0x20, virtual false, abstract: false, final false
inline void set_isPartOfComposite(bool  value) ;

/// @brief Method set_name, addr 0x44c9418, size 0x8, virtual false, abstract: false, final false
inline void set_name(::StringW  value) ;

/// @brief Method set_overrideInteractions, addr 0x44c94a0, size 0x8, virtual false, abstract: false, final false
inline void set_overrideInteractions(::StringW  value) ;

/// @brief Method set_overridePath, addr 0x44c9480, size 0x8, virtual false, abstract: false, final false
inline void set_overridePath(::StringW  value) ;

/// @brief Method set_overrideProcessors, addr 0x44c94c0, size 0x8, virtual false, abstract: false, final false
inline void set_overrideProcessors(::StringW  value) ;

/// @brief Method set_path, addr 0x44c9470, size 0x8, virtual false, abstract: false, final false
inline void set_path(::StringW  value) ;

/// @brief Method set_processors, addr 0x44c94b0, size 0x8, virtual false, abstract: false, final false
...
constexpr InputBinding(::StringW  m_Name, ::StringW  m_Id, ::StringW  m_Path, ::StringW  m_Interactions, ::StringW  m_Processors, ::StringW  m_Groups, ::StringW  m_Action, ::UnityEngine::InputSystem::__InputBinding__Flags  m_Flags, ::StringW  m_OverridePath, ::StringW  m_OverrideInteractions, ::StringW  m_OverrideProcessors) noexcept;
