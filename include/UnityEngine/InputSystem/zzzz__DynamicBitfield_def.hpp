...
public:
// Declarations
/// @brief Method BitCountToULongCount, addr 0x45519fc, size 0x18, virtual false, abstract: false, final false
static inline int32_t BitCountToULongCount(int32_t  bitCount) ;

/// @brief Method ClearBit, addr 0x4551b1c, size 0x98, virtual false, abstract: false, final false
inline void ClearBit(int32_t  bitIndex) ;

/// @brief Method SetBit, addr 0x4551a14, size 0x98, virtual false, abstract: false, final false
inline void SetBit(int32_t  bitIndex) ;

/// @brief Method SetLength, addr 0x4551988, size 0x74, virtual false, abstract: false, final false
inline void SetLength(int32_t  newLength) ;

/// @brief Method TestBit, addr 0x4551aac, size 0x70, virtual false, abstract: false, final false
