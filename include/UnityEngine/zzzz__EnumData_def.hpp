...
// Ctor Parameters [CppParam { name: "values", ty: "::ArrayW<::System::Enum*,::Array<::System::Enum*>*>", modifiers: "", def_value: None }, CppParam { name: "flagValues", ty: "::ArrayW<int32_t,::Array<int32_t>*>", modifiers: "", def_value: None }, CppParam { name: "displayNames", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }, CppParam { name: "names", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }, CppParam { name: "tooltip", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }, CppParam { name: "flags", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "underlyingType", ty: "::System::Type*", modifiers: "", def_value: None }, CppParam { name: "_cordl_unsigned", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "serializable", ty: "bool", modifiers: "", def_value: None }]
