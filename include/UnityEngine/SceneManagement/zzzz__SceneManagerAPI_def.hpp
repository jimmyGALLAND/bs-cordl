...
static __declspec(property(get=getStaticF__overrideAPI_k__BackingField, put=setStaticF__overrideAPI_k__BackingField)) ::UnityEngine::SceneManagement::SceneManagerAPI*  _overrideAPI_k__BackingField;
...
/// @brief Method GetNumScenesInBuildSettings, addr 0x482d9f8, size 0x28, virtual true, abstract: false, final false
inline int32_t GetNumScenesInBuildSettings() ;

/// @brief Method LoadFirstScene, addr 0x482da80, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::AsyncOperation* LoadFirstScene(bool  mustLoadAsync) ;

/// @brief Method LoadSceneAsyncByNameOrIndex, addr 0x482da20, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x482d9f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_ActiveAPI, addr 0x482d8f0, size 0xa8, virtual false, abstract: false, final false
static inline ::UnityEngine::SceneManagement::SceneManagerAPI* get_ActiveAPI() ;

/// @brief Method get_overrideAPI, addr 0x482d998, size 0x58, virtual false, abstract: false, final false
