...
/// @brief Method .ctor, addr 0x485f288, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_collider, addr 0x485f170, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Collider> get_collider() ;

/// @brief Method get_controller, addr 0x485f168, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::CharacterController> get_controller() ;

/// @brief Method get_gameObject, addr 0x485f1f8, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_gameObject() ;

/// @brief Method get_moveDirection, addr 0x485f248, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_moveDirection() ;

/// @brief Method get_moveLength, addr 0x485f254, size 0x8, virtual false, abstract: false, final false
inline float_t get_moveLength() ;

/// @brief Method get_normal, addr 0x485f23c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_normal() ;

/// @brief Method get_point, addr 0x485f230, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_point() ;

/// @brief Method get_push, addr 0x485f25c, size 0x10, virtual false, abstract: false, final false
inline bool get_push() ;

/// @brief Method get_rigidbody, addr 0x485f178, size 0x44, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rigidbody> get_rigidbody() ;

/// @brief Method get_transform, addr 0x485f214, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_transform() ;

/// @brief Method set_push, addr 0x485f26c, size 0x1c, virtual false, abstract: false, final false
