...
/// @brief Method .ctor, addr 0x4860068, size 0x10, virtual false, abstract: false, final false
inline void _ctor(float_t  a) ;

/// @brief Method .ctor, addr 0x4860078, size 0x10, virtual false, abstract: false, final false
inline void _ctor(float_t  a, float_t  b) ;

/// @brief Method .ctor, addr 0x4860088, size 0x14, virtual false, abstract: false, final false
inline void _ctor(float_t  a, float_t  b, float_t  c) ;

/// @brief Method get_Item, addr 0x485ffc0, size 0x54, virtual false, abstract: false, final false
inline float_t get_Item(int32_t  i) ;

/// @brief Method set_Item, addr 0x4860014, size 0x54, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "x", ty: "::UnityEngine::__ArticulationReducedSpace___x_e__FixedBuffer", modifiers: "", def_value: None }, CppParam { name: "dofCount", ty: "int32_t", modifiers: "", def_value: None }]
