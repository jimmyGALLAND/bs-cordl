...
public:
// Declarations
/// @brief Method ComputeHash, addr 0x23fdb08, size 0x164, virtual false, abstract: false, final false
static inline ::StringW ComputeHash(::StringW  text, ::StringW  salt) ;

/// @brief Method CreateCipher, addr 0x23fdd74, size 0x214, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::IBufferedCipher* CreateCipher(bool  isEncryption, ::StringW  key, ::StringW  iv) ;

/// @brief Method Decrypt, addr 0x23fdc6c, size 0x108, virtual false, abstract: false, final false
static inline ::StringW Decrypt(::StringW  cipherText, ::StringW  key, ::StringW  iv) ;

/// @brief Method Encrypt, addr 0x23fdf88, size 0xf4, virtual false, abstract: false, final false
static inline ::StringW Encrypt(::StringW  plainText, ::StringW  key, ::StringW  iv) ;

/// @brief Method GenerateText, addr 0x23fe07c, size 0xc4, virtual false, abstract: false, final false
static inline ::StringW GenerateText(int32_t  size) ;

static inline ::crypto::Security* New_ctor() ;

/// @brief Method .ctor, addr 0x23fe140, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
