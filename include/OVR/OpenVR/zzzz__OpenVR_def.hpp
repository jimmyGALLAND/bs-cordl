...
/// @brief Method CheckClear, addr 0x3fe79c0, size 0xa0, virtual false, abstract: false, final false
inline void CheckClear() ;

/// @brief Method Clear, addr 0x3fe799c, size 0x18, virtual false, abstract: false, final false
inline void Clear() ;

static inline ::OVR::OpenVR::__OpenVR__COpenVRContext* New_ctor() ;

/// @brief Method VRApplications, addr 0x3fe7404, size 0xbc, virtual false, abstract: false, final false
inline ::OVR::OpenVR::CVRApplications* VRApplications() ;

/// @brief Method VRChaperone, addr 0x3fe6e38, size 0xbc, virtual false, abstract: false, final false
inline ::OVR::OpenVR::CVRChaperone* VRChaperone() ;

/// @brief Method VRChaperoneSetup, addr 0x3fe6f0c, size 0xbc, virtual false, abstract: false, final false
inline ::OVR::OpenVR::CVRChaperoneSetup* VRChaperoneSetup() ;

/// @brief Method VRCompositor, addr 0x3fe6fe0, size 0xbc, virtual false, abstract: false, final false
inline ::OVR::OpenVR::CVRCompositor* VRCompositor() ;

/// @brief Method VRExtendedDisplay, addr 0x3fe725c, size 0xbc, virtual false, abstract: false, final false
inline ::OVR::OpenVR::CVRExtendedDisplay* VRExtendedDisplay() ;

/// @brief Method VRInput, addr 0x3fe7680, size 0xbc, virtual false, abstract: false, final false
inline ::OVR::OpenVR::CVRInput* VRInput() ;

/// @brief Method VROverlay, addr 0x3fe70b4, size 0xbc, virtual false, abstract: false, final false
inline ::OVR::OpenVR::CVROverlay* VROverlay() ;

/// @brief Method VRRenderModels, addr 0x3fe7188, size 0xbc, virtual false, abstract: false, final false
inline ::OVR::OpenVR::CVRRenderModels* VRRenderModels() ;

/// @brief Method VRScreenshots, addr 0x3fe74d8, size 0xbc, virtual false, abstract: false, final false
inline ::OVR::OpenVR::CVRScreenshots* VRScreenshots() ;

/// @brief Method VRSettings, addr 0x3fe7330, size 0xbc, virtual false, abstract: false, final false
inline ::OVR::OpenVR::CVRSettings* VRSettings() ;

/// @brief Method VRSpatialAnchors, addr 0x3fe7754, size 0xbc, virtual false, abstract: false, final false
inline ::OVR::OpenVR::CVRSpatialAnchors* VRSpatialAnchors() ;

/// @brief Method VRSystem, addr 0x3fe6d64, size 0xbc, virtual false, abstract: false, final false
inline ::OVR::OpenVR::CVRSystem* VRSystem() ;

/// @brief Method VRTrackedCamera, addr 0x3fe75ac, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fe6d20, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(offsetof(::OVR::OpenVR::__OpenVR__COpenVRContext, ___m_pVRSystem) == 0x10, "Offset mismatch!");

static_assert(offsetof(::OVR::OpenVR::__OpenVR__COpenVRContext, ___m_pVRChaperone) == 0x18, "Offset mismatch!");

static_assert(offsetof(::OVR::OpenVR::__OpenVR__COpenVRContext, ___m_pVRChaperoneSetup) == 0x20, "Offset mismatch!");

static_assert(offsetof(::OVR::OpenVR::__OpenVR__COpenVRContext, ___m_pVRCompositor) == 0x28, "Offset mismatch!");

static_assert(offsetof(::OVR::OpenVR::__OpenVR__COpenVRContext, ___m_pVROverlay) == 0x30, "Offset mismatch!");

static_assert(offsetof(::OVR::OpenVR::__OpenVR__COpenVRContext, ___m_pVRRenderModels) == 0x38, "Offset mismatch!");

static_assert(offsetof(::OVR::OpenVR::__OpenVR__COpenVRContext, ___m_pVRExtendedDisplay) == 0x40, "Offset mismatch!");

static_assert(offsetof(::OVR::OpenVR::__OpenVR__COpenVRContext, ___m_pVRSettings) == 0x48, "Offset mismatch!");

static_assert(offsetof(::OVR::OpenVR::__OpenVR__COpenVRContext, ___m_pVRApplications) == 0x50, "Offset mismatch!");

static_assert(offsetof(::OVR::OpenVR::__OpenVR__COpenVRContext, ___m_pVRScreenshots) == 0x58, "Offset mismatch!");

static_assert(offsetof(::OVR::OpenVR::__OpenVR__COpenVRContext, ___m_pVRTrackedCamera) == 0x60, "Offset mismatch!");

static_assert(offsetof(::OVR::OpenVR::__OpenVR__COpenVRContext, ___m_pVRInput) == 0x68, "Offset mismatch!");

static_assert(offsetof(::OVR::OpenVR::__OpenVR__COpenVRContext, ___m_pVRSpatialAnchors) == 0x70, "Offset mismatch!");
...
/// @brief Method GetGenericInterface, addr 0x3fe6be8, size 0x4, virtual false, abstract: false, final false
static inline ::System::IntPtr GetGenericInterface(::StringW  pchInterfaceVersion, ByRef<::OVR::OpenVR::EVRInitError>  peError) ;

/// @brief Method GetInitToken, addr 0x3fe6bf0, size 0x4, virtual false, abstract: false, final false
static inline uint32_t GetInitToken() ;

/// @brief Method GetStringForHmdError, addr 0x3fe6b80, size 0x68, virtual false, abstract: false, final false
static inline ::StringW GetStringForHmdError(::OVR::OpenVR::EVRInitError  error) ;

/// @brief Method Init, addr 0x3fe7810, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method InitInternal, addr 0x3fe6b6c, size 0x4, virtual false, abstract: false, final false
static inline uint32_t InitInternal(ByRef<::OVR::OpenVR::EVRInitError>  peError, ::OVR::OpenVR::EVRApplicationType  eApplicationType) ;

/// @brief Method InitInternal2, addr 0x3fe6b70, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method IsHmdPresent, addr 0x3fe6b78, size 0x4, virtual false, abstract: false, final false
static inline bool IsHmdPresent() ;

/// @brief Method IsInterfaceVersionValid, addr 0x3fe6bec, size 0x4, virtual false, abstract: false, final false
static inline bool IsInterfaceVersionValid(::StringW  pchInterfaceVersion) ;

/// @brief Method IsRuntimeInstalled, addr 0x3fe6b7c, size 0x4, virtual false, abstract: false, final false
static inline bool IsRuntimeInstalled() ;

static inline ::OVR::OpenVR::OpenVR* New_ctor() ;

/// @brief Method Shutdown, addr 0x3fe79b4, size 0x4, virtual false, abstract: false, final false
static inline void Shutdown() ;

/// @brief Method ShutdownInternal, addr 0x3fe6b74, size 0x4, virtual false, abstract: false, final false
static inline void ShutdownInternal() ;

/// @brief Method .ctor, addr 0x3fe79b8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Applications, addr 0x3fe73ec, size 0x18, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::CVRApplications* get_Applications() ;

/// @brief Method get_Chaperone, addr 0x3fe6e20, size 0x18, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::CVRChaperone* get_Chaperone() ;

/// @brief Method get_ChaperoneSetup, addr 0x3fe6ef4, size 0x18, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::CVRChaperoneSetup* get_ChaperoneSetup() ;

/// @brief Method get_Compositor, addr 0x3fe6fc8, size 0x18, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::CVRCompositor* get_Compositor() ;

/// @brief Method get_ExtendedDisplay, addr 0x3fe7244, size 0x18, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::CVRExtendedDisplay* get_ExtendedDisplay() ;

/// @brief Method get_Input, addr 0x3fe7668, size 0x18, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::CVRInput* get_Input() ;

/// @brief Method get_OpenVRInternal_ModuleContext, addr 0x3fe6c88, size 0x98, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::__OpenVR__COpenVRContext* get_OpenVRInternal_ModuleContext() ;

/// @brief Method get_Overlay, addr 0x3fe709c, size 0x18, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::CVROverlay* get_Overlay() ;

/// @brief Method get_RenderModels, addr 0x3fe7170, size 0x18, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::CVRRenderModels* get_RenderModels() ;

/// @brief Method get_Screenshots, addr 0x3fe74c0, size 0x18, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::CVRScreenshots* get_Screenshots() ;

/// @brief Method get_Settings, addr 0x3fe7318, size 0x18, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::CVRSettings* get_Settings() ;

/// @brief Method get_SpatialAnchors, addr 0x3fe773c, size 0x18, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::CVRSpatialAnchors* get_SpatialAnchors() ;

/// @brief Method get_System, addr 0x3fe6d4c, size 0x18, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::CVRSystem* get_System() ;

/// @brief Method get_TrackedCamera, addr 0x3fe7594, size 0x18, virtual false, abstract: false, final false
static inline ::OVR::OpenVR::CVRTrackedCamera* get_TrackedCamera() ;

/// @brief Method get_VRToken, addr 0x3fe6bf4, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method set_VRToken, addr 0x3fe6c3c, size 0x4c, virtual false, abstract: false, final false
