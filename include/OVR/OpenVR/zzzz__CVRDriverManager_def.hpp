...
/// @brief Method GetDriverCount, addr 0x3fe54fc, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetDriverCount() ;

/// @brief Method GetDriverHandle, addr 0x3fe5544, size 0x24, virtual false, abstract: false, final false
inline uint64_t GetDriverHandle(::StringW  pchDriverName) ;

/// @brief Method GetDriverName, addr 0x3fe5520, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fe53e8, size 0x114, virtual false, abstract: false, final false
