...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x3fe4ab0, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x3fe4bb0, size 0x34, virtual true, abstract: false, final false
...
/// @brief Method Invoke, addr 0x3fe4a9c, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fe49fc, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Field pGetComponentStatePacked, offset 0x0, size 0x8 
 __declspec(property(get=__cordl_internal_get_pGetComponentStatePacked, put=__cordl_internal_set_pGetComponentStatePacked)) ::OVR::OpenVR::__CVRRenderModels___GetComponentStatePacked*  pGetComponentStatePacked;
...
/// @brief Method FreeRenderModel, addr 0x3fe4600, size 0x24, virtual false, abstract: false, final false
inline void FreeRenderModel(::System::IntPtr  pRenderModel) ;

/// @brief Method FreeTexture, addr 0x3fe4648, size 0x24, virtual false, abstract: false, final false
inline void FreeTexture(::System::IntPtr  pTexture) ;

/// @brief Method FreeTextureD3D11, addr 0x3fe46b4, size 0x24, virtual false, abstract: false, final false
inline void FreeTextureD3D11(::System::IntPtr  pD3D11Texture2D) ;

/// @brief Method GetComponentButtonMask, addr 0x3fe4768, size 0x24, virtual false, abstract: false, final false
inline uint64_t GetComponentButtonMask(::StringW  pchRenderModelName, ::StringW  pchComponentName) ;

/// @brief Method GetComponentCount, addr 0x3fe4720, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetComponentCount(::StringW  pchRenderModelName) ;

/// @brief Method GetComponentName, addr 0x3fe4744, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetComponentRenderModelName, addr 0x3fe478c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetComponentState, addr 0x3fe47d4, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method GetComponentStateForDevicePath, addr 0x3fe47b0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetRenderModelCount, addr 0x3fe46fc, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetRenderModelCount() ;

/// @brief Method GetRenderModelErrorNameFromEnum, addr 0x3fe4978, size 0x84, virtual false, abstract: false, final false
inline ::StringW GetRenderModelErrorNameFromEnum(::OVR::OpenVR::EVRRenderModelError  error) ;

/// @brief Method GetRenderModelName, addr 0x3fe46d8, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetRenderModelOriginalPath, addr 0x3fe4954, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetRenderModelThumbnailURL, addr 0x3fe4930, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method LoadIntoTextureD3D11_Async, addr 0x3fe4690, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRRenderModelError LoadIntoTextureD3D11_Async(int32_t  textureId, ::System::IntPtr  pDstTexture) ;

/// @brief Method LoadRenderModel_Async, addr 0x3fe45dc, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRRenderModelError LoadRenderModel_Async(::StringW  pchRenderModelName, ByRef<::System::IntPtr>  ppRenderModel) ;

/// @brief Method LoadTextureD3D11_Async, addr 0x3fe466c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method LoadTexture_Async, addr 0x3fe4624, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method RenderModelHasComponent, addr 0x3fe490c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fe44c8, size 0x114, virtual false, abstract: false, final false
