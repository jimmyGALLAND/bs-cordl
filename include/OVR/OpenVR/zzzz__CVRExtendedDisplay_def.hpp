...
/// @brief Method GetDXGIOutputInfo, addr 0x3fe1ab8, size 0x2c, virtual false, abstract: false, final false
inline void GetDXGIOutputInfo(ByRef<int32_t>  pnAdapterIndex, ByRef<int32_t>  pnAdapterOutputIndex) ;

/// @brief Method GetEyeOutputViewport, addr 0x3fe1a84, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method GetWindowBounds, addr 0x3fe1a50, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fe193c, size 0x114, virtual false, abstract: false, final false
