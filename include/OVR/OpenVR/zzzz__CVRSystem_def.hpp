...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x3fe14ac, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x3fe1564, size 0x2c, virtual true, abstract: false, final false
inline bool EndInvoke(ByRef<::OVR::OpenVR::VREvent_t_Packed>  pEvent, ::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x3fe1498, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fe13f8, size 0xa0, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "pPollNextEvent", ty: "::OVR::OpenVR::__IVRSystem___PollNextEvent*", modifiers: "", def_value: None }, CppParam { name: "pPollNextEventPacked", ty: "::OVR::OpenVR::__CVRSystem___PollNextEventPacked*", modifiers: "", def_value: None }]
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x3fe1630, size 0xd0, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginInvoke(uint32_t  unControllerDeviceIndex, ByRef<::OVR::OpenVR::VRControllerState_t_Packed>  pControllerState, uint32_t  unControllerStateSize, ::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x3fe1700, size 0x2c, virtual true, abstract: false, final false
inline bool EndInvoke(ByRef<::OVR::OpenVR::VRControllerState_t_Packed>  pControllerState, ::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x3fe161c, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fe1590, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  object, ::System::IntPtr  method) ;
...
/// @brief Field pGetControllerStatePacked, offset 0x0, size 0x8 
 __declspec(property(get=__cordl_internal_get_pGetControllerStatePacked, put=__cordl_internal_set_pGetControllerStatePacked)) ::OVR::OpenVR::__CVRSystem___GetControllerStatePacked*  pGetControllerStatePacked;
...
// Ctor Parameters [CppParam { name: "pGetControllerState", ty: "::OVR::OpenVR::__IVRSystem___GetControllerState*", modifiers: "", def_value: None }, CppParam { name: "pGetControllerStatePacked", ty: "::OVR::OpenVR::__CVRSystem___GetControllerStatePacked*", modifiers: "", def_value: None }]
constexpr __CVRSystem__GetControllerStateUnion(::OVR::OpenVR::__IVRSystem___GetControllerState*  pGetControllerState, ::OVR::OpenVR::__CVRSystem___GetControllerStatePacked*  pGetControllerStatePacked) noexcept;
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x3fe17cc, size 0x13c, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x3fe1908, size 0x34, virtual true, abstract: false, final false
...
/// @brief Method Invoke, addr 0x3fe17b8, size 0x14, virtual true, abstract: false, final false
inline bool Invoke(::OVR::OpenVR::ETrackingUniverseOrigin  eOrigin, uint32_t  unControllerDeviceIndex, ByRef<::OVR::OpenVR::VRControllerState_t_Packed>  pControllerState, uint32_t  unControllerStateSize, ByRef<::OVR::OpenVR::TrackedDevicePose_t>  pTrackedDevicePose) ;
...
/// @brief Method .ctor, addr 0x3fe172c, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  object, ::System::IntPtr  method) ;
...
/// @brief Field pGetControllerStateWithPose, offset 0x0, size 0x8 
 __declspec(property(get=__cordl_internal_get_pGetControllerStateWithPose, put=__cordl_internal_set_pGetControllerStateWithPose)) ::OVR::OpenVR::__IVRSystem___GetControllerStateWithPose*  pGetControllerStateWithPose;

/// @brief Field pGetControllerStateWithPosePacked, offset 0x0, size 0x8 
 __declspec(property(get=__cordl_internal_get_pGetControllerStateWithPosePacked, put=__cordl_internal_set_pGetControllerStateWithPosePacked)) ::OVR::OpenVR::__CVRSystem___GetControllerStateWithPosePacked*  pGetControllerStateWithPosePacked;
...
// Ctor Parameters [CppParam { name: "pGetControllerStateWithPose", ty: "::OVR::OpenVR::__IVRSystem___GetControllerStateWithPose*", modifiers: "", def_value: None }, CppParam { name: "pGetControllerStateWithPosePacked", ty: "::OVR::OpenVR::__CVRSystem___GetControllerStateWithPosePacked*", modifiers: "", def_value: None }]
constexpr __CVRSystem__GetControllerStateWithPoseUnion(::OVR::OpenVR::__IVRSystem___GetControllerStateWithPose*  pGetControllerStateWithPose, ::OVR::OpenVR::__CVRSystem___GetControllerStateWithPosePacked*  pGetControllerStateWithPosePacked) noexcept;
...
// SizeInfo { instance_size: 392, native_size: -1, calculated_instance_size: 392, calculated_native_size: 392, minimum_alignment: 8, packing: None, specified_packing: None }
namespace OVR::OpenVR {
// Is value type: false
...
/// @brief Method AcknowledgeQuit_Exiting, addr 0x3fe13b0, size 0x24, virtual false, abstract: false, final false
inline void AcknowledgeQuit_Exiting() ;

/// @brief Method AcknowledgeQuit_UserPrompt, addr 0x3fe13d4, size 0x24, virtual false, abstract: false, final false
inline void AcknowledgeQuit_UserPrompt() ;

/// @brief Method ApplyTransform, addr 0x3fe08fc, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method ComputeDistortion, addr 0x3fe0670, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method DriverDebugRequest, addr 0x3fe1368, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetArrayTrackedDeviceProperty, addr 0x3fe0a88, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetArrayTrackedDeviceProperty(uint32_t  unDeviceIndex, ::OVR::OpenVR::ETrackedDeviceProperty  prop, uint32_t  propType, ::System::IntPtr  pBuffer, uint32_t  unBufferSize, ByRef<::OVR::OpenVR::ETrackedPropertyError>  pError) ;

/// @brief Method GetBoolTrackedDeviceProperty, addr 0x3fe09b0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetButtonIdNameFromEnum, addr 0x3fe11d0, size 0x84, virtual false, abstract: false, final false
inline ::StringW GetButtonIdNameFromEnum(::OVR::OpenVR::EVRButtonId  eButtonId) ;

/// @brief Method GetControllerAxisTypeNameFromEnum, addr 0x3fe1254, size 0x84, virtual false, abstract: false, final false
inline ::StringW GetControllerAxisTypeNameFromEnum(::OVR::OpenVR::EVRControllerAxisType  eAxisType) ;

/// @brief Method GetControllerRoleForTrackedDeviceIndex, addr 0x3fe0944, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::ETrackedControllerRole GetControllerRoleForTrackedDeviceIndex(uint32_t  unDeviceIndex) ;

/// @brief Method GetControllerState, addr 0x3fe0db4, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method GetControllerStateWithPose, addr 0x3fe0fe0, size 0x1cc, virtual false, abstract: false, final false
inline bool GetControllerStateWithPose(::OVR::OpenVR::ETrackingUniverseOrigin  eOrigin, uint32_t  unControllerDeviceIndex, ByRef<::OVR::OpenVR::VRControllerState_t>  pControllerState, uint32_t  unControllerStateSize, ByRef<::OVR::OpenVR::TrackedDevicePose_t>  pTrackedDevicePose) ;

/// @brief Method GetD3D9AdapterIndex, addr 0x3fe0708, size 0x24, virtual false, abstract: false, final false
inline int32_t GetD3D9AdapterIndex() ;

/// @brief Method GetDXGIOutputInfo, addr 0x3fe072c, size 0x28, virtual false, abstract: false, final false
inline void GetDXGIOutputInfo(ByRef<int32_t>  pnAdapterIndex) ;

/// @brief Method GetDeviceToAbsoluteTrackingPose, addr 0x3fe07c8, size 0x2c, virtual false, abstract: false, final false
inline void GetDeviceToAbsoluteTrackingPose(::OVR::OpenVR::ETrackingUniverseOrigin  eOrigin, float_t  fPredictedSecondsToPhotonsFromNow, ::ArrayW<::OVR::OpenVR::TrackedDevicePose_t,::Array<::OVR::OpenVR::TrackedDevicePose_t>*>  pTrackedDevicePoseArray) ;

/// @brief Method GetEventTypeNameFromEnum, addr 0x3fe0d0c, size 0x84, virtual false, abstract: false, final false
inline ::StringW GetEventTypeNameFromEnum(::OVR::OpenVR::EVREventType  eType) ;

/// @brief Method GetEyeToHeadTransform, addr 0x3fe0694, size 0x48, virtual false, abstract: false, final false
inline ::OVR::OpenVR::HmdMatrix34_t GetEyeToHeadTransform(::OVR::OpenVR::EVREye  eEye) ;

/// @brief Method GetFloatTrackedDeviceProperty, addr 0x3fe09d4, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetHiddenAreaMesh, addr 0x3fe0d90, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::HiddenAreaMesh_t GetHiddenAreaMesh(::OVR::OpenVR::EVREye  eEye, ::OVR::OpenVR::EHiddenAreaMeshType  type) ;

/// @brief Method GetInt32TrackedDeviceProperty, addr 0x3fe09f8, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetMatrix34TrackedDeviceProperty, addr 0x3fe0a40, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method GetOutputDevice, addr 0x3fe0754, size 0x28, virtual false, abstract: false, final false
inline void GetOutputDevice(ByRef<uint64_t>  pnDevice, ::OVR::OpenVR::ETextureType  textureType, ::System::IntPtr  pInstance) ;

/// @brief Method GetProjectionMatrix, addr 0x3fe05f4, size 0x48, virtual false, abstract: false, final false
inline ::OVR::OpenVR::HmdMatrix44_t GetProjectionMatrix(::OVR::OpenVR::EVREye  eEye, float_t  fNearZ, float_t  fFarZ) ;

/// @brief Method GetProjectionRaw, addr 0x3fe063c, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method GetPropErrorNameFromEnum, addr 0x3fe0ad0, size 0x84, virtual false, abstract: false, final false
inline ::StringW GetPropErrorNameFromEnum(::OVR::OpenVR::ETrackedPropertyError  error) ;

/// @brief Method GetRawZeroPoseToStandingAbsoluteTrackingPose, addr 0x3fe0860, size 0x48, virtual false, abstract: false, final false
inline ::OVR::OpenVR::HmdMatrix34_t GetRawZeroPoseToStandingAbsoluteTrackingPose() ;

/// @brief Method GetRecommendedRenderTargetSize, addr 0x3fe05c8, size 0x2c, virtual false, abstract: false, final false
inline void GetRecommendedRenderTargetSize(ByRef<uint32_t>  pnWidth, ByRef<uint32_t>  pnHeight) ;

/// @brief Method GetSeatedZeroPoseToStandingAbsoluteTrackingPose, addr 0x3fe0818, size 0x48, virtual false, abstract: false, final false
inline ::OVR::OpenVR::HmdMatrix34_t GetSeatedZeroPoseToStandingAbsoluteTrackingPose() ;

/// @brief Method GetSortedTrackedDeviceIndicesOfClass, addr 0x3fe08a8, size 0x30, virtual false, abstract: false, final false
inline uint32_t GetSortedTrackedDeviceIndicesOfClass(::OVR::OpenVR::ETrackedDeviceClass  eTrackedDeviceClass, ::ArrayW<uint32_t,::Array<uint32_t>*>  punTrackedDeviceIndexArray, uint32_t  unRelativeToTrackedDeviceIndex) ;

/// @brief Method GetStringTrackedDeviceProperty, addr 0x3fe0aac, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetStringTrackedDeviceProperty(uint32_t  unDeviceIndex, ::OVR::OpenVR::ETrackedDeviceProperty  prop, ::System::Text::StringBuilder*  pchValue, uint32_t  unBufferSize, ByRef<::OVR::OpenVR::ETrackedPropertyError>  pError) ;

/// @brief Method GetTimeSinceLastVsync, addr 0x3fe06dc, size 0x2c, virtual false, abstract: false, final false
inline bool GetTimeSinceLastVsync(ByRef<float_t>  pfSecondsSinceLastVsync, ByRef<uint64_t>  pulFrameCounter) ;

/// @brief Method GetTrackedDeviceActivityLevel, addr 0x3fe08d8, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EDeviceActivityLevel GetTrackedDeviceActivityLevel(uint32_t  unDeviceId) ;

/// @brief Method GetTrackedDeviceClass, addr 0x3fe0968, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::ETrackedDeviceClass GetTrackedDeviceClass(uint32_t  unDeviceIndex) ;

/// @brief Method GetTrackedDeviceIndexForControllerRole, addr 0x3fe0920, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetTrackedDeviceIndexForControllerRole(::OVR::OpenVR::ETrackedControllerRole  unDeviceType) ;

/// @brief Method GetUint64TrackedDeviceProperty, addr 0x3fe0a1c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method IsDisplayOnDesktop, addr 0x3fe077c, size 0x24, virtual false, abstract: false, final false
inline bool IsDisplayOnDesktop() ;

/// @brief Method IsInputAvailable, addr 0x3fe12d8, size 0x24, virtual false, abstract: false, final false
inline bool IsInputAvailable() ;

/// @brief Method IsSteamVRDrawingControllers, addr 0x3fe12fc, size 0x24, virtual false, abstract: false, final false
inline bool IsSteamVRDrawingControllers() ;

/// @brief Method IsTrackedDeviceConnected, addr 0x3fe098c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method PerformFirmwareUpdate, addr 0x3fe138c, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRFirmwareError PerformFirmwareUpdate(uint32_t  unDeviceIndex) ;

/// @brief Method PollNextEvent, addr 0x3fe0b54, size 0x174, virtual false, abstract: false, final false
inline bool PollNextEvent(ByRef<::OVR::OpenVR::VREvent_t>  pEvent, uint32_t  uncbVREvent) ;

/// @brief Method PollNextEventWithPose, addr 0x3fe0ce8, size 0x24, virtual false, abstract: false, final false
inline bool PollNextEventWithPose(::OVR::OpenVR::ETrackingUniverseOrigin  eOrigin, ByRef<::OVR::OpenVR::VREvent_t>  pEvent, uint32_t  uncbVREvent, ByRef<::OVR::OpenVR::TrackedDevicePose_t>  pTrackedDevicePose) ;

/// @brief Method ResetSeatedZeroPose, addr 0x3fe07f4, size 0x24, virtual false, abstract: false, final false
inline void ResetSeatedZeroPose() ;

/// @brief Method SetDisplayVisibility, addr 0x3fe07a0, size 0x28, virtual false, abstract: false, final false
inline bool SetDisplayVisibility(bool  bIsVisibleOnDesktop) ;

/// @brief Method ShouldApplicationPause, addr 0x3fe1320, size 0x24, virtual false, abstract: false, final false
inline bool ShouldApplicationPause() ;

/// @brief Method ShouldApplicationReduceRenderingWork, addr 0x3fe1344, size 0x24, virtual false, abstract: false, final false
inline bool ShouldApplicationReduceRenderingWork() ;

/// @brief Method TriggerHapticPulse, addr 0x3fe11ac, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fe04b4, size 0x114, virtual false, abstract: false, final false
