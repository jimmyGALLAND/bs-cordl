...
/// @brief Method get_Channel, addr 0x3b99470, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Channel() ;

/// @brief Method get_MetaEventType, addr 0x3b99468, size 0x8, virtual false, abstract: false, final false
inline ::MidiParser::MetaEventType get_MetaEventType() ;

/// @brief Method get_Note, addr 0x3b99478, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Note() ;

/// @brief Method get_Value, addr 0x3b99488, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Value() ;

/// @brief Method get_Velocity, addr 0x3b99480, size 0x8, virtual false, abstract: false, final false
