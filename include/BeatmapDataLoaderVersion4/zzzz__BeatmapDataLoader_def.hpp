...
/// @brief Method <GetBeatmapDataFromSaveDataJsonAsync>b__0, addr 0x26c08d8, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26bdce4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetBeatmapDataBasicInfoFromSaveDataJsonAsync>b__0, addr 0x26c0918, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26bddd8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetBeatmapDataBasicInfoFromSaveDataJson>b__0, addr 0x26c0920, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26bed44, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ConvertBasicEvents, addr 0x26be218, size 0x710, virtual false, abstract: false, final false
static inline void ConvertBasicEvents(::GlobalNamespace::BeatmapData*  beatmapData, ::BeatmapSaveDataVersion4::LightshowSaveData*  lightshowSaveData, ::GlobalNamespace::BpmTimeProcessor*  bpmTimeProcessor, ::GlobalNamespace::EnvironmentKeywords*  environmentKeywords) ;

/// @brief Method ConvertBeatmapObjects, addr 0x26bed4c, size 0x9a0, virtual false, abstract: false, final false
...
/// @brief Method ConvertEventBoxGroups, addr 0x26be928, size 0x274, virtual false, abstract: false, final false
static inline void ConvertEventBoxGroups(::GlobalNamespace::BeatmapData*  beatmapData, ::BeatmapSaveDataVersion4::LightshowSaveData*  lightshowSaveData, ::GlobalNamespace::BpmTimeProcessor*  bpmTimeProcessor, ::GlobalNamespace::IEnvironmentLightGroups*  environmentLightGroups) ;

/// @brief Method GetBeatmapDataBasicInfoFromSaveDataJson, addr 0x26beb9c, size 0x1a8, virtual false, abstract: false, final false
static inline ::GlobalNamespace::BeatmapDataBasicInfo* GetBeatmapDataBasicInfoFromSaveDataJson(::StringW  beatmapDataJson) ;

/// @brief Method GetBeatmapDataBasicInfoFromSaveDataJsonAsync, addr 0x26bdcec, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method GetBeatmapDataFromSaveData, addr 0x26bdf84, size 0x254, virtual false, abstract: false, final false
...
/// @brief Method GetBeatmapDataFromSaveDataJson, addr 0x26bdde0, size 0x1a4, virtual false, abstract: false, final false
static inline ::GlobalNamespace::BeatmapData* GetBeatmapDataFromSaveDataJson(::StringW  audioDataJson, ::StringW  beatmapJson, ::StringW  lightshowJson, ::StringW  defaultLightshowJson, ::GlobalNamespace::BeatmapDifficulty  beatmapDifficulty, float_t  startBpm, bool  loadingForDesignatedEnvironment, ::GlobalNamespace::IEnvironmentInfo*  environmentInfo, ::GlobalNamespace::BeatmapLevelDataVersion  beatmapLevelDataVersion, ::GlobalNamespace::GameplayModifiers*  gameplayModifiers, ::GlobalNamespace::PlayerSpecificSettings*  playerSpecificSettings) ;

/// @brief Method GetBeatmapDataFromSaveDataJsonAsync, addr 0x26bdb8c, size 0x158, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::BeatmapData*>* GetBeatmapDataFromSaveDataJsonAsync(::StringW  audioDataJson, ::StringW  beatmapJson, ::StringW  lightshowJson, ::StringW  defaultLightshowJson, ::GlobalNamespace::BeatmapDifficulty  beatmapDifficulty, float_t  startBpm, bool  loadingForDesignatedEnvironment, ::GlobalNamespace::IEnvironmentInfo*  environmentInfo, ::GlobalNamespace::BeatmapLevelDataVersion  beatmapLevelDataVersion, ::GlobalNamespace::GameplayModifiers*  gameplayModifiers, ::GlobalNamespace::PlayerSpecificSettings*  playerSpecificSettings) ;

/// @brief Method LoadLightshow, addr 0x26be1d8, size 0x40, virtual false, abstract: false, final false
