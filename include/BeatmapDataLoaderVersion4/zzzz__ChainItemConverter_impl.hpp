...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatmapDataLoaderVersion4::ChainItemConverter::*)(::ArrayW<::BeatmapSaveDataVersion4::ColorNote,::Array<::BeatmapSaveDataVersion4::ColorNote>*>, ::ArrayW<::BeatmapSaveDataVersion4::Chain,::Array<::BeatmapSaveDataVersion4::Chain>*>, ::GlobalNamespace::BpmTimeProcessor*)>(&::BeatmapDataLoaderVersion4::ChainItemConverter::_ctor)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x26bf850;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatmapDataLoaderVersion4::ChainItemConverter*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<::BeatmapSaveDataVersion4::ColorNote,::Array<::BeatmapSaveDataVersion4::ColorNote>*>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<::BeatmapSaveDataVersion4::Chain,::Array<::BeatmapSaveDataVersion4::Chain>*>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::BpmTimeProcessor*>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapObjectData* (::BeatmapDataLoaderVersion4::ChainItemConverter::*)(::BeatmapSaveDataVersion4::ChainBeatIndex*)>(&::BeatmapDataLoaderVersion4::ChainItemConverter::Convert)> {
  constexpr static std::size_t size = 0x174;
  constexpr static std::size_t addrs = 0x26bfb54;
...
constexpr ::ArrayW<::BeatmapSaveDataVersion4::ColorNote,::Array<::BeatmapSaveDataVersion4::ColorNote>*> const& BeatmapDataLoaderVersion4::ChainItemConverter::__cordl_internal_get__colorNotes() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____colorNotes;
}
...
inline ::BeatmapDataLoaderVersion4::ChainItemConverter* BeatmapDataLoaderVersion4::ChainItemConverter::New_ctor(::ArrayW<::BeatmapSaveDataVersion4::ColorNote,::Array<::BeatmapSaveDataVersion4::ColorNote>*>  colorNotes, ::ArrayW<::BeatmapSaveDataVersion4::Chain,::Array<::BeatmapSaveDataVersion4::Chain>*>  chains, ::GlobalNamespace::BpmTimeProcessor*  bpmTimeProcessor)  {
...
inline void BeatmapDataLoaderVersion4::ChainItemConverter::_ctor(::ArrayW<::BeatmapSaveDataVersion4::ColorNote,::Array<::BeatmapSaveDataVersion4::ColorNote>*>  colorNotes, ::ArrayW<::BeatmapSaveDataVersion4::Chain,::Array<::BeatmapSaveDataVersion4::Chain>*>  chains, ::GlobalNamespace::BpmTimeProcessor*  bpmTimeProcessor)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatmapDataLoaderVersion4::ChainItemConverter*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
