...
/// @brief Field _spawnRotations, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__spawnRotations, put=__cordl_internal_set__spawnRotations)) ::ArrayW<::BeatmapSaveDataVersion4::SpawnRotation,::Array<::BeatmapSaveDataVersion4::SpawnRotation>*>  _spawnRotations;

/// @brief Method Convert, addr 0x26bffa8, size 0xc8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapEventData* Convert(::BeatmapSaveDataVersion4::BeatIndex*  index) ;

static inline ::BeatmapDataLoaderVersion4::SpawnRotationItemConverter* New_ctor(::ArrayW<::BeatmapSaveDataVersion4::SpawnRotation,::Array<::BeatmapSaveDataVersion4::SpawnRotation>*>  spawnRotations, ::GlobalNamespace::IBeatToTimeConverter*  bpmTimeProcessor) ;
...
/// @brief Method .ctor, addr 0x26bff7c, size 0x2c, virtual false, abstract: false, final false
