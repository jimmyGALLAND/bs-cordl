...
public:
// Declarations
/// @brief Method ConvertEvents, addr 0x26c139c, size 0x228, virtual true, abstract: false, final false
...
static inline ::BeatmapDataLoaderVersion4::LightTranslationEventBoxGroupConverter* New_ctor(::BeatmapSaveDataVersion4::LightshowSaveData*  lightshowSaveData, ::GlobalNamespace::IEnvironmentLightGroups*  lightGroups) ;

/// @brief Method .ctor, addr 0x26c05c8, size 0x30, virtual false, abstract: false, final false
