...
public:
// Declarations
/// @brief Method .ctor, addr 0x26bdb80, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "lufs", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "blockDuration", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "momentaryValues", ty: "::ArrayW<float_t,::Array<float_t>*>", modifiers: "", def_value: None }]
