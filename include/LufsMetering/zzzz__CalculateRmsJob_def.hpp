...
/// @brief Method Execute, addr 0x3ae32d0, size 0x270, virtual true, abstract: false, final true
inline void Execute(int32_t  i) ;

/// @brief Method .ctor, addr 0x3ae32bc, size 0x14, virtual false, abstract: false, final false
