...
/// @brief Method Create, addr 0x3ae3600, size 0x10, virtual false, abstract: false, final false
static inline ::LufsMetering::SplitAudioJob Create(::Unity::Collections::NativeArray_1<float_t>  interleavedData, ::Unity::Collections::NativeArray_1<float_t>  channelData, int32_t  numChannels, int32_t  channel) ;

/// @brief Method Execute, addr 0x3ae3610, size 0x1c, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "channelData", ty: "::Unity::Collections::NativeArray_1<float_t>", modifiers: "", def_value: None }, CppParam { name: "interleavedData", ty: "::Unity::Collections::NativeArray_1<float_t>", modifiers: "", def_value: None }, CppParam { name: "mumChannels", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "channel", ty: "int32_t", modifiers: "", def_value: None }]
