...
// Ctor Parameters [CppParam { name: "a0", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "a1", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "a2", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "b0", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "b1", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "b2", ty: "float_t", modifiers: "", def_value: None }]
