...
/// @brief Method Equals, addr 0x3fec560, size 0x10c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x3fec488, size 0xd8, virtual true, abstract: false, final true
inline bool Equals(::StyledUITemplates::ColorOverrideOption*  other) ;

/// @brief Method GetHashCode, addr 0x3fec66c, size 0x174, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fec424, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3fec434, size 0x54, virtual false, abstract: false, final false
inline void _ctor(::StyledUITemplates::ColorOverrideOption*  other) ;

/// @brief Method get_color, addr 0x3fec3a8, size 0x2c, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_fixedColor, addr 0x3fec3fc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_fixedColor() ;

/// @brief Method get_overrideEnabled, addr 0x3fec3d4, size 0x8, virtual false, abstract: false, final false
inline bool get_overrideEnabled() ;

/// @brief Method get_scriptableObjectColor, addr 0x3fec414, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::ColorSO> get_scriptableObjectColor() ;

/// @brief Method get_useFixedColor, addr 0x3fec3e8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_fixedColor, addr 0x3fec408, size 0xc, virtual false, abstract: false, final false
inline void set_fixedColor(::UnityEngine::Color  value) ;

/// @brief Method set_overrideEnabled, addr 0x3fec3dc, size 0xc, virtual false, abstract: false, final false
inline void set_overrideEnabled(bool  value) ;

/// @brief Method set_scriptableObjectColor, addr 0x3fec41c, size 0x8, virtual false, abstract: false, final false
inline void set_scriptableObjectColor(::GlobalNamespace::ColorSO*  value) ;

/// @brief Method set_useFixedColor, addr 0x3fec3f0, size 0xc, virtual false, abstract: false, final false
