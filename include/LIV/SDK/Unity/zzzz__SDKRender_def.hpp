...
/// @brief Method CreateAssets, addr 0x3a3f48c, size 0x6d0, virtual false, abstract: false, final false
inline void CreateAssets() ;

/// @brief Method CreateBackgroundTexture, addr 0x3a42b9c, size 0x94, virtual false, abstract: false, final false
inline void CreateBackgroundTexture() ;

/// @brief Method CreateComplexClipPlaneTexture, addr 0x3a42ec8, size 0x94, virtual false, abstract: false, final false
inline void CreateComplexClipPlaneTexture() ;

/// @brief Method CreateForegroundTexture, addr 0x3a42da0, size 0x94, virtual false, abstract: false, final false
inline void CreateForegroundTexture() ;

/// @brief Method CreateOptimizedTexture, addr 0x3a42e34, size 0x94, virtual false, abstract: false, final false
inline void CreateOptimizedTexture() ;

/// @brief Method DestroyAssets, addr 0x3a41f90, size 0x184, virtual false, abstract: false, final false
inline void DestroyAssets() ;

/// @brief Method Dispose, addr 0x3a3dc68, size 0x38, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetClipPlaneMaterial, addr 0x3a3f038, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method GetGroundClipPlaneMaterial, addr 0x3a3f13c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method InvokePostRenderBackground, addr 0x3a412b0, size 0x38, virtual false, abstract: false, final false
inline void InvokePostRenderBackground() ;

/// @brief Method InvokePostRenderForeground, addr 0x3a415c0, size 0x38, virtual false, abstract: false, final false
inline void InvokePostRenderForeground() ;

/// @brief Method InvokePreRender, addr 0x3a4046c, size 0x38, virtual false, abstract: false, final false
inline void InvokePreRender() ;

/// @brief Method InvokePreRenderBackground, addr 0x3a41184, size 0x38, virtual false, abstract: false, final false
inline void InvokePreRenderBackground() ;

/// @brief Method InvokePreRenderForeground, addr 0x3a41588, size 0x38, virtual false, abstract: false, final false
inline void InvokePreRenderForeground() ;

/// @brief Method IvokePostRender, addr 0x3a40f5c, size 0x38, virtual false, abstract: false, final false
inline void IvokePostRender() ;

static inline ::LIV::SDK::Unity::SDKRender* New_ctor(::LIV::SDK::Unity::LIV*  liv) ;

/// @brief Method ReleaseBridgePoseControl, addr 0x3a42114, size 0x60, virtual false, abstract: false, final false
inline void ReleaseBridgePoseControl() ;

/// @brief Method Render, addr 0x3a3e118, size 0xc4, virtual false, abstract: false, final false
inline void Render() ;

/// @brief Method RenderBackground, addr 0x3a404a4, size 0x118, virtual false, abstract: false, final false
inline void RenderBackground() ;

/// @brief Method RenderForeground, addr 0x3a405bc, size 0x4b0, virtual false, abstract: false, final false
inline void RenderForeground() ;

/// @brief Method RenderOptimized, addr 0x3a40a6c, size 0x4f0, virtual false, abstract: false, final false
inline void RenderOptimized() ;

/// @brief Method SendTextureToBridge, addr 0x3a411bc, size 0xf4, virtual false, abstract: false, final false
inline void SendTextureToBridge(::UnityEngine::RenderTexture*  texture, ::LIV::SDK::Unity::TEXTURE_ID  id) ;

/// @brief Method SetGroundPlane, addr 0x3a42830, size 0x18c, virtual false, abstract: false, final false
inline void SetGroundPlane(float_t  distance, ::UnityEngine::Vector3  normal, bool  useLocalSpace) ;

/// @brief Method SetGroundPlane, addr 0x3a429bc, size 0x1c, virtual false, abstract: false, final false
inline void SetGroundPlane(::UnityEngine::Plane  plane, bool  useLocalSpace) ;

/// @brief Method SetGroundPlane, addr 0x3a429d8, size 0x1a0, virtual false, abstract: false, final false
inline void SetGroundPlane(::UnityEngine::Transform*  transform, bool  useLocalSpace) ;

/// @brief Method SetPose, addr 0x3a423a0, size 0x2e0, virtual false, abstract: false, final false
...
/// @brief Method UpdateBridgeInputFrame, addr 0x3a3fbe0, size 0x1b0, virtual false, abstract: false, final false
inline void UpdateBridgeInputFrame() ;

/// @brief Method UpdateBridgeResolution, addr 0x3a400a8, size 0x54, virtual false, abstract: false, final false
inline void UpdateBridgeResolution() ;

/// @brief Method UpdateCameraSettings, addr 0x3a3fb5c, size 0x84, virtual false, abstract: false, final false
inline void UpdateCameraSettings() ;

/// @brief Method UpdateTextures, addr 0x3a401ec, size 0x280, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a3db00, size 0x168, virtual false, abstract: false, final false
inline void _ctor(::LIV::SDK::Unity::LIV*  liv) ;

/// @brief Method get_cameraInstance, addr 0x3a42238, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_cameraInstance() ;

/// @brief Method get_cameraReference, addr 0x3a416c4, size 0x8c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_cameraReference() ;

/// @brief Method get_canRenderBackground, addr 0x3a3f218, size 0x8c, virtual false, abstract: false, final false
inline bool get_canRenderBackground() ;

/// @brief Method get_canRenderForeground, addr 0x3a3f2a4, size 0xa0, virtual false, abstract: false, final false
inline bool get_canRenderForeground() ;

/// @brief Method get_canRenderOptimized, addr 0x3a3f344, size 0x78, virtual false, abstract: false, final false
inline bool get_canRenderOptimized() ;

/// @brief Method get_canSetPose, addr 0x3a42380, size 0x20, virtual false, abstract: false, final false
inline bool get_canSetPose() ;

/// @brief Method get_disableStandardAssets, addr 0x3a41370, size 0x1c, virtual false, abstract: false, final false
inline bool get_disableStandardAssets() ;

/// @brief Method get_hmdCamera, addr 0x3a42240, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_hmdCamera() ;

/// @brief Method get_inputFrame, addr 0x3a42220, size 0x10, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKInputFrame get_inputFrame() ;

/// @brief Method get_interlacedRendering, addr 0x3a3f200, size 0xc, virtual false, abstract: false, final false
inline bool get_interlacedRendering() ;

/// @brief Method get_liv, addr 0x3a42208, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::LIV::SDK::Unity::LIV> get_liv() ;

/// @brief Method get_localToWorldMatrix, addr 0x3a3fd90, size 0xbc, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_localToWorldMatrix() ;

/// @brief Method get_outputFrame, addr 0x3a42210, size 0x10, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKOutputFrame get_outputFrame() ;

/// @brief Method get_resolution, addr 0x3a42230, size 0x8, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKResolution get_resolution() ;

/// @brief Method get_spectatorLayerMask, addr 0x3a3fe4c, size 0x20, virtual false, abstract: false, final false
inline int32_t get_spectatorLayerMask() ;

/// @brief Method get_stage, addr 0x3a4225c, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_stage() ;

/// @brief Method get_stageLocalToWorldMatrix, addr 0x3a42290, size 0xf0, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_stageLocalToWorldMatrix() ;

/// @brief Method get_stageTransform, addr 0x3a42274, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_stageTransform() ;

/// @brief Method get_useDeferredRendering, addr 0x3a3f1d8, size 0x28, virtual false, abstract: false, final false
