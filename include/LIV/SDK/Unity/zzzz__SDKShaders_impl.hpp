...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&::LIV::SDK::Unity::SDKShaders::StartRendering)> {
  ...
  constexpr static std::size_t addrs = 0x3a410fc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LIV::SDK::Unity::SDKShaders*>::get(),
                        "StartRendering",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&::LIV::SDK::Unity::SDKShaders::StopRendering)> {
  constexpr static std::size_t size = 0x44;
  constexpr static std::size_t addrs = 0x3a4132c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&::LIV::SDK::Unity::SDKShaders::StartForegroundRendering)> {
  constexpr static std::size_t size = 0x44;
  constexpr static std::size_t addrs = 0x3a41544;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&::LIV::SDK::Unity::SDKShaders::StartBackgroundRendering)> {
  constexpr static std::size_t size = 0x44;
  constexpr static std::size_t addrs = 0x3a41140;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&::LIV::SDK::Unity::SDKShaders::StopBackgroundRendering)> {
  constexpr static std::size_t size = 0x44;
  constexpr static std::size_t addrs = 0x3a412e8;
...
::cordl_internals::setStaticField<int32_t, "LIV_COLOR_MASK", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LIV::SDK::Unity::SDKShaders*>::get>(std::forward<int32_t>(value));
}
inline int32_t LIV::SDK::Unity::SDKShaders::getStaticF_LIV_COLOR_MASK()  {
return ::cordl_internals::getStaticField<int32_t, "LIV_COLOR_MASK", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LIV::SDK::Unity::SDKShaders*>::get>();
}
inline void LIV::SDK::Unity::SDKShaders::setStaticF_LIV_TESSELLATION_PROPERTY(int32_t  value)  {
::cordl_internals::setStaticField<int32_t, "LIV_TESSELLATION_PROPERTY", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LIV::SDK::Unity::SDKShaders*>::get>(std::forward<int32_t>(value));
}
inline int32_t LIV::SDK::Unity::SDKShaders::getStaticF_LIV_TESSELLATION_PROPERTY()  {
return ::cordl_internals::getStaticField<int32_t, "LIV_TESSELLATION_PROPERTY", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LIV::SDK::Unity::SDKShaders*>::get>();
}
inline void LIV::SDK::Unity::SDKShaders::setStaticF_LIV_CLIP_PLANE_HEIGHT_MAP_PROPERTY(int32_t  value)  {
::cordl_internals::setStaticField<int32_t, "LIV_CLIP_PLANE_HEIGHT_MAP_PROPERTY", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LIV::SDK::Unity::SDKShaders*>::get>(std::forward<int32_t>(value));
}
inline int32_t LIV::SDK::Unity::SDKShaders::getStaticF_LIV_CLIP_PLANE_HEIGHT_MAP_PROPERTY()  {
return ::cordl_internals::getStaticField<int32_t, "LIV_CLIP_PLANE_HEIGHT_MAP_PROPERTY", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LIV::SDK::Unity::SDKShaders*>::get>();
}
