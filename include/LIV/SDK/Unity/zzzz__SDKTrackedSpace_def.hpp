...
public:
// Declarations
/// @brief Method ToString, addr 0x3a449b8, size 0x244, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x3a44890, size 0x64, virtual false, abstract: false, final false
