...
public:
// Declarations
/// @brief Method ToString, addr 0x3a44064, size 0x26c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x3a44058, size 0xc, virtual false, abstract: false, final false
