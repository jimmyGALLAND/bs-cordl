...
public:
// Declarations
/// @brief Method ToString, addr 0x3a448f4, size 0xc4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x3a3f3bc, size 0x60, virtual false, abstract: false, final false
