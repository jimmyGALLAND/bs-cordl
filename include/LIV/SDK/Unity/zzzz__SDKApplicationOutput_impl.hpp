...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::LIV::SDK::Unity::SDKApplicationOutput (*)()>(&::LIV::SDK::Unity::SDKApplicationOutput::get_empty)> {
  ...
  constexpr static std::size_t addrs = 0x3a3dca0;
...
// Ctor Parameters [CppParam { name: "supportedFeatures", ty: "::LIV::SDK::Unity::FEATURES", modifiers: "", def_value: Some("{}") }, CppParam { name: "engineName", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "engineVersion", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "applicationName", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "applicationVersion", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "xrDeviceName", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "graphicsAPI", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "sdkID", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "sdkVersion", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }]
constexpr ::LIV::SDK::Unity::SDKApplicationOutput::SDKApplicationOutput(::LIV::SDK::Unity::FEATURES  supportedFeatures, ::StringW  engineName, ::StringW  engineVersion, ::StringW  applicationName, ::StringW  applicationVersion, ::StringW  xrDeviceName, ::StringW  graphicsAPI, ::StringW  sdkID, ::StringW  sdkVersion) noexcept  {
