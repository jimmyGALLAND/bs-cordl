...
public:
// Declarations
/// @brief Method ObtainControl, addr 0x3a42b88, size 0x14, virtual false, abstract: false, final false
inline void ObtainControl() ;

/// @brief Method ReleaseControl, addr 0x3a42b78, size 0x10, virtual false, abstract: false, final false
inline void ReleaseControl() ;

/// @brief Method ToString, addr 0x3a4455c, size 0x334, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x3a3e878, size 0x13c, virtual false, abstract: false, final false
