...
static __declspec(property(get=getStaticF__injection_SDKInputFrame, put=setStaticF__injection_SDKInputFrame)) ::LIV::SDK::Unity::__SDKBridge__SDKInjection_1<::LIV::SDK::Unity::SDKInputFrame>  _injection_SDKInputFrame;

/// @brief Field _injection_SDKResolution, offset 0xffffffff, size 0x18 
static __declspec(property(get=getStaticF__injection_SDKResolution, put=setStaticF__injection_SDKResolution)) ::LIV::SDK::Unity::__SDKBridge__SDKInjection_1<::LIV::SDK::Unity::SDKResolution>  _injection_SDKResolution;

/// @brief Method AddObjectToChannel, addr 0x3a3e284, size 0x8, virtual false, abstract: false, final false
static inline int32_t AddObjectToChannel(int32_t  slot, ::System::IntPtr  obj, int32_t  objectsize, uint64_t  tag) ;

/// @brief Method AddObjectToCompositorChannel, addr 0x3a3e25c, size 0x8, virtual false, abstract: false, final false
static inline int32_t AddObjectToCompositorChannel(int32_t  slot, ::System::IntPtr  obj, int32_t  objectsize, uint64_t  tag) ;

/// @brief Method AddObjectToFrame, addr 0x3a3e264, size 0x8, virtual false, abstract: false, final false
static inline int32_t AddObjectToFrame(::System::IntPtr  obj, int32_t  objectsize, uint64_t  tag) ;

/// @brief Method AddString, addr 0x3a3e310, size 0xfc, virtual false, abstract: false, final false
static inline void AddString(::StringW  tag, ::StringW  value, int32_t  slot) ;

/// @brief Method AddStringToChannel, addr 0x3a3e224, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AddTexture, addr 0x3a3eb34, size 0x130, virtual false, abstract: false, final false
static inline void AddTexture(::LIV::SDK::Unity::SDKTexture  texture) ;

/// @brief Method AddTexture, addr 0x3a3e40c, size 0xc4, virtual false, abstract: false, final false
static inline void AddTexture(::LIV::SDK::Unity::SDKTexture  texture, uint64_t  tag) ;

/// @brief Method CreateFrame, addr 0x3a3ec64, size 0x160, virtual false, abstract: false, final false
static inline void CreateFrame(::LIV::SDK::Unity::SDKOutputFrame  frame) ;

/// @brief Method GetChannelObject, addr 0x3a3e27c, size 0x8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetChannelObject(int32_t  slot, uint64_t  tag, uint64_t  timestamp) ;

/// @brief Method GetCompositorChannelObject, addr 0x3a3e254, size 0x8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetCompositorChannelObject(int32_t  slot, uint64_t  tag, uint64_t  timestamp) ;

/// @brief Method GetCurrentTime, addr 0x3a3e52c, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t GetCurrentTime() ;

/// @brief Method GetCurrentTimeTicks, addr 0x3a3e23c, size 0x8, virtual false, abstract: false, final false
static inline uint64_t GetCurrentTimeTicks() ;

/// @brief Method GetIsCaptureActive, addr 0x3a3e244, size 0x8, virtual false, abstract: false, final false
static inline bool GetIsCaptureActive() ;

/// @brief Method GetObjectTime, addr 0x3a3e4d0, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t GetObjectTime(::System::IntPtr  objectptr) ;

/// @brief Method GetObjectTimeStamp, addr 0x3a3e234, size 0x8, virtual false, abstract: false, final false
static inline uint64_t GetObjectTimeStamp(::System::IntPtr  obj) ;

/// @brief Method GetRenderEventFunc, addr 0x3a3e24c, size 0x8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetRenderEventFunc() ;

/// @brief Method GetResolution, addr 0x3a3ee64, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method GetViewfinderTexture, addr 0x3a3e9b4, size 0x16c, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKTexture GetViewfinderTexture() ;

/// @brief Method GetViewportTexture, addr 0x3a3e274, size 0x8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetViewportTexture() ;

/// @brief Method IssuePluginEvent, addr 0x3a3e588, size 0x80, virtual false, abstract: false, final false
static inline void IssuePluginEvent() ;

/// @brief Method SetGroundPlane, addr 0x3a3edc4, size 0xa0, virtual false, abstract: false, final false
static inline void SetGroundPlane(::LIV::SDK::Unity::SDKPlane  groundPlane) ;

/// @brief Method SubmitApplicationOutput, addr 0x3a3dd20, size 0x1d0, virtual false, abstract: false, final false
static inline void SubmitApplicationOutput(::LIV::SDK::Unity::SDKApplicationOutput  applicationOutput) ;

/// @brief Method Tag, addr 0x3a3e28c, size 0x84, virtual false, abstract: false, final false
static inline uint64_t Tag(::StringW  str) ;

/// @brief Method UpdateInputFrame, addr 0x3a3e608, size 0x270, virtual false, abstract: false, final false
static inline bool UpdateInputFrame(ByRef<::LIV::SDK::Unity::SDKInputFrame>  setframe) ;

/// @brief Method addtexture, addr 0x3a3e22c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_IsActive, addr 0x3a3d50c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method updatinputframe, addr 0x3a3e26c, size 0x8, virtual false, abstract: false, final false
