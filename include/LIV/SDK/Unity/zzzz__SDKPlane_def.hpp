...
public:
// Declarations
/// @brief Method ToString, addr 0x3a43f94, size 0xc4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x3a43f80, size 0x14, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKPlane get_empty() ;

/// @brief Method op_Implicit, addr 0x3a43f68, size 0x18, virtual false, abstract: false, final false
