...
public:
// Declarations
/// @brief Method ToString, addr 0x3a442d0, size 0x244, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x3a3dca0, size 0x80, virtual false, abstract: false, final false
