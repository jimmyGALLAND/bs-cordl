...
public:
// Declarations
/// @brief Method ToString, addr 0x3a43114, size 0xa0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_zero, addr 0x3a3f030, size 0x8, virtual false, abstract: false, final false
