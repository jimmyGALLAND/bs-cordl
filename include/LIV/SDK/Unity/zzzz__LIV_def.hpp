...
/// @brief Method MoveNext, addr 0x3a3e028, size 0xf0, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::LIV::SDK::Unity::__LIV___WaitForUnityEndOfFrame_d__68* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3a3e1dc, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x3a3e1e4, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3a3e21c, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x3a3e024, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a3d6f4, size 0x28, virtual false, abstract: false, final false
...
/// @brief Field _excludeBehavioursCandidate, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get__excludeBehavioursCandidate, put=__cordl_internal_set__excludeBehavioursCandidate)) ::ArrayW<::StringW,::Array<::StringW>*>  _excludeBehavioursCandidate;
...
/// @brief Method Activate, addr 0x3a3d71c, size 0x18, virtual false, abstract: false, final false
inline void Activate() ;

/// @brief Method CreateAssets, addr 0x3a3da10, size 0x68, virtual false, abstract: false, final false
inline void CreateAssets() ;

/// @brief Method DestroyAssets, addr 0x3a3dae0, size 0x20, virtual false, abstract: false, final false
inline void DestroyAssets() ;

/// @brief Method Invalidate, addr 0x3a3d614, size 0x78, virtual false, abstract: false, final false
inline void Invalidate() ;

static inline ::LIV::SDK::Unity::LIV* New_ctor() ;

/// @brief Method OnDisable, addr 0x3a3d68c, size 0x8, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3a3d5ac, size 0xc, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnSDKActivate, addr 0x3a3d740, size 0xac, virtual false, abstract: false, final false
inline void OnSDKActivate() ;

/// @brief Method OnSDKDeactivate, addr 0x3a3d7ec, size 0xb4, virtual false, abstract: false, final false
inline void OnSDKDeactivate() ;

/// @brief Method OnSDKReadyChanged, addr 0x3a3d734, size 0xc, virtual false, abstract: false, final false
inline void OnSDKReadyChanged(bool  value) ;

/// @brief Method StartRenderCoroutine, addr 0x3a3da78, size 0x44, virtual false, abstract: false, final false
inline void StartRenderCoroutine() ;

/// @brief Method StopRenderCoroutine, addr 0x3a3dabc, size 0x24, virtual false, abstract: false, final false
inline void StopRenderCoroutine() ;

/// @brief Method SubmitSDKOutput, addr 0x3a3d8a0, size 0x170, virtual false, abstract: false, final false
inline void SubmitSDKOutput() ;

/// @brief Method Update, addr 0x3a3d5fc, size 0x18, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateSDKReady, addr 0x3a3d5b8, size 0x44, virtual false, abstract: false, final false
inline void UpdateSDKReady() ;

/// @brief Method WaitForUnityEndOfFrame, addr 0x3a3d694, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a3defc, size 0x128, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HMDCamera, addr 0x3a3d1bc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_HMDCamera() ;

/// @brief Method get_MRCameraPrefab, addr 0x3a3d2b0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_MRCameraPrefab() ;

/// @brief Method get__isReady, addr 0x3a3d498, size 0x74, virtual false, abstract: false, final false
inline bool get__isReady() ;

/// @brief Method get_disableStandardAssets, addr 0x3a3d33c, size 0x8, virtual false, abstract: false, final false
inline bool get_disableStandardAssets() ;

/// @brief Method get_excludeBehaviours, addr 0x3a3d360, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_excludeBehaviours() ;

/// @brief Method get_fixPostEffectsAlpha, addr 0x3a3d388, size 0x8, virtual false, abstract: false, final false
inline bool get_fixPostEffectsAlpha() ;

/// @brief Method get_isActive, addr 0x3a3d490, size 0x8, virtual false, abstract: false, final false
inline bool get_isActive() ;

/// @brief Method get_isValid, addr 0x3a3d39c, size 0xf4, virtual false, abstract: false, final false
inline bool get_isValid() ;

/// @brief Method get_render, addr 0x3a3d5a4, size 0x8, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKRender* get_render() ;

/// @brief Method get_spectatorLayerMask, addr 0x3a3d350, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_spectatorLayerMask() ;

/// @brief Method get_stage, addr 0x3a3ce90, size 0x90, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_stage() ;

/// @brief Method get_stageLocalToWorldMatrix, addr 0x3a3cfcc, size 0xf0, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_stageLocalToWorldMatrix() ;

/// @brief Method get_stageTransform, addr 0x3a3d1ac, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_stageTransform() ;

/// @brief Method get_stageWorldToLocalMatrix, addr 0x3a3d0bc, size 0xf0, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_stageWorldToLocalMatrix() ;

/// @brief Method get_trackedSpaceOrigin, addr 0x3a3cfc4, size 0x4, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_trackedSpaceOrigin() ;

/// @brief Method set_HMDCamera, addr 0x3a3d1c4, size 0xec, virtual false, abstract: false, final false
inline void set_HMDCamera(::UnityEngine::Camera*  value) ;

/// @brief Method set_MRCameraPrefab, addr 0x3a3d2b8, size 0x84, virtual false, abstract: false, final false
inline void set_MRCameraPrefab(::UnityEngine::Camera*  value) ;

/// @brief Method set_disableStandardAssets, addr 0x3a3d344, size 0xc, virtual false, abstract: false, final false
inline void set_disableStandardAssets(bool  value) ;

/// @brief Method set_excludeBehaviours, addr 0x3a3d368, size 0x20, virtual false, abstract: false, final false
inline void set_excludeBehaviours(::ArrayW<::StringW,::Array<::StringW>*>  value) ;

/// @brief Method set_fixPostEffectsAlpha, addr 0x3a3d390, size 0xc, virtual false, abstract: false, final false
inline void set_fixPostEffectsAlpha(bool  value) ;

/// @brief Method set_spectatorLayerMask, addr 0x3a3d358, size 0x8, virtual false, abstract: false, final false
inline void set_spectatorLayerMask(::UnityEngine::LayerMask  value) ;

/// @brief Method set_stage, addr 0x3a3cf20, size 0x90, virtual false, abstract: false, final false
inline void set_stage(::UnityEngine::Transform*  value) ;

/// @brief Method set_stageTransform, addr 0x3a3d1b4, size 0x8, virtual false, abstract: false, final false
inline void set_stageTransform(::UnityEngine::Transform*  value) ;

/// @brief Method set_trackedSpaceOrigin, addr 0x3a3cfc8, size 0x4, virtual false, abstract: false, final false
