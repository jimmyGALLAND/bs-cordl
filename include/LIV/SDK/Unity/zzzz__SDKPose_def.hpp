...
public:
// Declarations
/// @brief Method ToString, addr 0x3a45618, size 0x278, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x3a3f41c, size 0x70, virtual false, abstract: false, final false
