...
/// @brief Method .ctor, addr 0x3bde428, size 0x44, virtual false, abstract: false, final false
inline void _ctor(bool  ownsHandle) ;

/// @brief Method get_IsInvalid, addr 0x3bde46c, size 0x40, virtual true, abstract: false, final false
