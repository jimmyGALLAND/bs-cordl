...
template<typename T>
static inline void AllocFreeAddRange(::System::Collections::Generic::IList_1<T>*  list, ::System::Collections::Generic::IList_1<T>*  items) ;

/// @brief Method Fmt, addr 0x4a5e114, size 0x1b0, virtual false, abstract: false, final false
...
static inline TVal GetValueAndRemove(::System::Collections::Generic::IDictionary_2<TKey,TVal>*  dictionary, TKey  key) ;

/// @brief Method IndexOf, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline int32_t IndexOf(::System::Collections::Generic::IList_1<T>*  list, T  item) ;

/// @brief Method Join, addr 0x4a5ef1c, size 0x64, virtual false, abstract: false, final false
...
template<typename TKey,typename TVal>
static inline void RemoveWithConfirm(::System::Collections::Generic::IDictionary_2<TKey,TVal>*  dictionary, TKey  key) ;

/// @brief Method RemoveWithConfirm, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void RemoveWithConfirm(::System::Collections::Generic::IList_1<T>*  list, T  item) ;

/// @brief Method RemoveWithConfirm, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void RemoveWithConfirm(::System::Collections::Generic::LinkedList_1<T>*  list, T  item) ;

/// @brief Method RemoveWithConfirm, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void RemoveWithConfirm(::System::Collections::Generic::HashSet_1<T>*  set, T  item) ;
