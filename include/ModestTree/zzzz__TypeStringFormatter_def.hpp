...
/// @brief Method <PrettyNameInternal>b__2_0, addr 0x4a60f6c, size 0x54, virtual false, abstract: false, final false
inline ::StringW _PrettyNameInternal_b__2_0(::System::Type*  t) ;

/// @brief Method .ctor, addr 0x4a60f64, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetCSharpTypeName, addr 0x4a60b64, size 0x318, virtual false, abstract: false, final false
static inline ::StringW GetCSharpTypeName(::StringW  typeName) ;

/// @brief Method PrettyName, addr 0x4a5ee30, size 0xec, virtual false, abstract: false, final false
static inline ::StringW PrettyName(::System::Type*  type) ;

/// @brief Method PrettyNameInternal, addr 0x4a60710, size 0x454, virtual false, abstract: false, final false
