...
template<typename T1,typename T2>
static inline ::ModestTree::Util::ValuePair_2<T1,T2>* New(T1  first, T2  second) ;

/// @brief Method New, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T1,typename T2,typename T3>
static inline ::ModestTree::Util::ValuePair_3<T1,T2,T3>* New(T1  first, T2  second, T3  third) ;

/// @brief Method New, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T1,typename T2,typename T3,typename T4>
static inline ::ModestTree::Util::ValuePair_4<T1,T2,T3,T4>* New(T1  first, T2  second, T3  third, T4  fourth) ;
