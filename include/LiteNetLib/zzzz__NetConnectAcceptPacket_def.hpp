...
/// @brief Method FromData, addr 0x3a2ffac, size 0xdc, virtual false, abstract: false, final false
static inline ::LiteNetLib::NetConnectAcceptPacket* FromData(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method Make, addr 0x3a33068, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a33028, size 0x40, virtual false, abstract: false, final false
