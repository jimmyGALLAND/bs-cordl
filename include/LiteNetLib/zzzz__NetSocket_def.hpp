...
/// @brief Method Bind, addr 0x3a30e2c, size 0x3d4, virtual false, abstract: false, final false
...
/// @brief Method BindSocket, addr 0x3a35390, size 0x690, virtual false, abstract: false, final false
inline bool BindSocket(::System::Net::Sockets::Socket*  socket, ::System::Net::IPEndPoint*  ep, bool  reuseAddress) ;

/// @brief Method Close, addr 0x3a3262c, size 0xa8, virtual false, abstract: false, final false
inline void Close(bool  suspend) ;

/// @brief Method IsActive, addr 0x3a34e00, size 0x18, virtual false, abstract: false, final false
inline bool IsActive() ;

static inline ::LiteNetLib::NetSocket* New_ctor(::LiteNetLib::INetSocketListener*  listener) ;

/// @brief Method ReceiveLogic, addr 0x3a34e18, size 0x578, virtual false, abstract: false, final false
inline void ReceiveLogic(::System::Object*  state) ;

/// @brief Method SendBroadcast, addr 0x3a317c4, size 0x2f4, virtual false, abstract: false, final false
inline bool SendBroadcast(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset, int32_t  size, int32_t  port) ;

/// @brief Method SendTo, addr 0x3a2baa0, size 0x364, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a2d2f8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_LocalPort, addr 0x3a34d0c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LocalPort() ;

/// @brief Method get_Ttl, addr 0x3a34d1c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method set_LocalPort, addr 0x3a34d14, size 0x8, virtual false, abstract: false, final false
inline void set_LocalPort(int32_t  value) ;

/// @brief Method set_Ttl, addr 0x3a2ba84, size 0x1c, virtual false, abstract: false, final false
