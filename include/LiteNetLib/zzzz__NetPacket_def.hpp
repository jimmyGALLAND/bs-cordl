...
/// @brief Method FromBytes, addr 0x3a2fb94, size 0x12c, virtual false, abstract: false, final false
inline bool FromBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  start, int32_t  packetSize) ;

/// @brief Method GetHeaderSize, addr 0x3a2c54c, size 0x88, virtual false, abstract: false, final false
inline int32_t GetHeaderSize() ;

/// @brief Method GetHeaderSize, addr 0x3a31764, size 0x2c, virtual false, abstract: false, final false
static inline int32_t GetHeaderSize(::LiteNetLib::PacketProperty  property) ;

/// @brief Method MarkFragmented, addr 0x3a32b64, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a32cb8, size 0xcc, virtual false, abstract: false, final false
inline void _ctor(::LiteNetLib::PacketProperty  property, int32_t  size) ;

/// @brief Method .ctor, addr 0x3a32c4c, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(int32_t  size) ;

static inline int32_t getStaticF_LastProperty() ;

/// @brief Method get_ChannelId, addr 0x3a32b94, size 0x2c, virtual false, abstract: false, final false
inline uint8_t get_ChannelId() ;

/// @brief Method get_ConnectionNumber, addr 0x3a32ae8, size 0x2c, virtual false, abstract: false, final false
inline uint8_t get_ConnectionNumber() ;

/// @brief Method get_FragmentId, addr 0x3a32bec, size 0x10, virtual false, abstract: false, final false
inline uint16_t get_FragmentId() ;

/// @brief Method get_FragmentPart, addr 0x3a32c0c, size 0x10, virtual false, abstract: false, final false
inline uint16_t get_FragmentPart() ;

/// @brief Method get_FragmentsTotal, addr 0x3a32c2c, size 0x10, virtual false, abstract: false, final false
inline uint16_t get_FragmentsTotal() ;

/// @brief Method get_IsFragmented, addr 0x3a32b38, size 0x2c, virtual false, abstract: false, final false
inline bool get_IsFragmented() ;

/// @brief Method get_Property, addr 0x3a2fcc0, size 0x2c, virtual false, abstract: false, final false
inline ::LiteNetLib::PacketProperty get_Property() ;

/// @brief Method get_Sequence, addr 0x3a32b14, size 0x10, virtual false, abstract: false, final false
inline uint16_t get_Sequence() ;

static inline void setStaticF_LastProperty(int32_t  value) ;

/// @brief Method set_ChannelId, addr 0x3a32bc0, size 0x2c, virtual false, abstract: false, final false
inline void set_ChannelId(uint8_t  value) ;

/// @brief Method set_ConnectionNumber, addr 0x3a2f288, size 0x34, virtual false, abstract: false, final false
inline void set_ConnectionNumber(uint8_t  value) ;

/// @brief Method set_FragmentId, addr 0x3a32bfc, size 0x10, virtual false, abstract: false, final false
inline void set_FragmentId(uint16_t  value) ;

/// @brief Method set_FragmentPart, addr 0x3a32c1c, size 0x10, virtual false, abstract: false, final false
inline void set_FragmentPart(uint16_t  value) ;

/// @brief Method set_FragmentsTotal, addr 0x3a32c3c, size 0x10, virtual false, abstract: false, final false
inline void set_FragmentsTotal(uint16_t  value) ;

/// @brief Method set_Property, addr 0x3a31790, size 0x34, virtual false, abstract: false, final false
inline void set_Property(::LiteNetLib::PacketProperty  value) ;

/// @brief Method set_Sequence, addr 0x3a32b24, size 0x10, virtual false, abstract: false, final false
