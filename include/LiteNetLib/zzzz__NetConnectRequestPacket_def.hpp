...
/// @brief Method FromData, addr 0x3a2fdb0, size 0x170, virtual false, abstract: false, final false
static inline ::LiteNetLib::NetConnectRequestPacket* FromData(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method GetProtocolId, addr 0x3a2fcec, size 0x20, virtual false, abstract: false, final false
static inline int32_t GetProtocolId(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method Make, addr 0x3a32ee0, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a32e5c, size 0x44, virtual false, abstract: false, final false
