...
public:
// Declarations
/// @brief Method Clear, addr 0x3a36f30, size 0x40, virtual false, abstract: false, final false
inline bool Clear(::LiteNetLib::NetPeer*  peer) ;

/// @brief Method Init, addr 0x3a373d8, size 0xc, virtual false, abstract: false, final false
inline void Init(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method ToString, addr 0x3a37938, size 0x70, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TrySend, addr 0x3a373e4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Field _pendingPackets, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__pendingPackets, put=__cordl_internal_set__pendingPackets)) ::ArrayW<::LiteNetLib::__ReliableChannel__PendingPacket,::Array<::LiteNetLib::__ReliableChannel__PendingPacket>*>  _pendingPackets;
...
/// @brief Method ProcessAck, addr 0x3a36bec, size 0x344, virtual false, abstract: false, final false
inline void ProcessAck(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method ProcessPacket, addr 0x3a3745c, size 0x4dc, virtual true, abstract: false, final false
inline bool ProcessPacket(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method SendNextPackets, addr 0x3a36f70, size 0x468, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a33524, size 0x188, virtual false, abstract: false, final false
