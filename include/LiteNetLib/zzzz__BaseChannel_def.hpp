...
/// @brief Method AddToQueue, addr 0x3a28420, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a2834c, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::LiteNetLib::NetPeer*  peer) ;

/// @brief Method get_PacketsInQueue, addr 0x3a283d8, size 0x48, virtual false, abstract: false, final false
