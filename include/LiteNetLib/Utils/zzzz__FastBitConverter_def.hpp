...
/// @brief Method GetBytes, addr 0x3a386d4, size 0x8, virtual false, abstract: false, final false
static inline void GetBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  startIndex, double_t  value) ;

/// @brief Method GetBytes, addr 0x3a386dc, size 0x8, virtual false, abstract: false, final false
static inline void GetBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  startIndex, float_t  value) ;

/// @brief Method GetBytes, addr 0x3a386e4, size 0x4, virtual false, abstract: false, final false
static inline void GetBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  startIndex, int16_t  value) ;

/// @brief Method GetBytes, addr 0x3a33024, size 0x4, virtual false, abstract: false, final false
static inline void GetBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  startIndex, int32_t  value) ;

/// @brief Method GetBytes, addr 0x3a2f2bc, size 0x4, virtual false, abstract: false, final false
static inline void GetBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  startIndex, int64_t  value) ;

/// @brief Method GetBytes, addr 0x3a32b34, size 0x4, virtual false, abstract: false, final false
static inline void GetBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  startIndex, uint16_t  value) ;

/// @brief Method GetBytes, addr 0x3a386e8, size 0x4, virtual false, abstract: false, final false
static inline void GetBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  startIndex, uint32_t  value) ;

/// @brief Method GetBytes, addr 0x3a386ec, size 0x4, virtual false, abstract: false, final false
static inline void GetBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  startIndex, uint64_t  value) ;

/// @brief Method WriteLittleEndian, addr 0x3a3868c, size 0x48, virtual false, abstract: false, final false
static inline void WriteLittleEndian(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int16_t  data) ;

/// @brief Method WriteLittleEndian, addr 0x3a3860c, size 0x80, virtual false, abstract: false, final false
static inline void WriteLittleEndian(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  data) ;

/// @brief Method WriteLittleEndian, addr 0x3a3851c, size 0xf0, virtual false, abstract: false, final false
