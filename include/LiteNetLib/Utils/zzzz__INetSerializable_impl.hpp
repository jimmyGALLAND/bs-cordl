...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::LiteNetLib::Utils::INetSerializable::*)(::LiteNetLib::Utils::NetDataWriter*)>(&::LiteNetLib::Utils::INetSerializable::Serialize)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::LiteNetLib::Utils::INetSerializable::*)(::LiteNetLib::Utils::NetDataReader*)>(&::LiteNetLib::Utils::INetSerializable::Deserialize)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
