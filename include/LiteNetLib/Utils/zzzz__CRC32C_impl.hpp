...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint32_t (*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::LiteNetLib::Utils::CRC32C::Compute)> {
  ...
  constexpr static std::size_t addrs = 0x3a38128;
...
::cordl_internals::setStaticField<::ArrayW<uint32_t,::Array<uint32_t>*>, "Table", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LiteNetLib::Utils::CRC32C*>::get>(std::forward<::ArrayW<uint32_t,::Array<uint32_t>*>>(value));
}
