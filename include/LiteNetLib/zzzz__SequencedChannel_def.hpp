...
/// @brief Method ProcessPacket, addr 0x3a37cb4, size 0x208, virtual true, abstract: false, final false
inline bool ProcessPacket(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method SendNextPackets, addr 0x3a379a8, size 0x30c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a336ac, size 0xa8, virtual false, abstract: false, final false
