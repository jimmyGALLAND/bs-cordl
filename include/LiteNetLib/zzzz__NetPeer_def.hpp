...
/// @brief Method .ctor, addr 0x3a3439c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _holdedFragments, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get__holdedFragments, put=__cordl_internal_set__holdedFragments)) ::System::Collections::Generic::Dictionary_2<uint16_t,::LiteNetLib::__NetPeer__IncomingFragments*>*  _holdedFragments;
...
/// @brief Method AddReliablePacket, addr 0x3a33fb0, size 0x3ec, virtual false, abstract: false, final false
inline void AddReliablePacket(::LiteNetLib::DeliveryMethod  method, ::LiteNetLib::NetPacket*  p) ;

/// @brief Method CreateChannel, addr 0x3a333a4, size 0x180, virtual false, abstract: false, final false
inline ::LiteNetLib::BaseChannel* CreateChannel(uint8_t  idx) ;

/// @brief Method Disconnect, addr 0x3a33f30, size 0x44, virtual false, abstract: false, final false
inline void Disconnect() ;

/// @brief Method Disconnect, addr 0x3a33ea0, size 0x24, virtual false, abstract: false, final false
inline void Disconnect(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method Disconnect, addr 0x3a33ee8, size 0x48, virtual false, abstract: false, final false
inline void Disconnect(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  start, int32_t  count) ;

/// @brief Method Disconnect, addr 0x3a33ec4, size 0x24, virtual false, abstract: false, final false
inline void Disconnect(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method Flush, addr 0x3a31ae0, size 0x24c, virtual false, abstract: false, final false
inline void Flush() ;

/// @brief Method GetMaxSinglePacketSize, addr 0x3a33754, size 0x74, virtual false, abstract: false, final false
inline int32_t GetMaxSinglePacketSize(::LiteNetLib::DeliveryMethod  options) ;

/// @brief Method GetPacketsCountInReliableQueue, addr 0x3a332f4, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method ProcessConnectAccept, addr 0x3a30088, size 0x64, virtual false, abstract: false, final false
inline bool ProcessConnectAccept(::LiteNetLib::NetConnectAcceptPacket*  packet) ;

/// @brief Method ProcessConnectRequest, addr 0x3a2fa50, size 0x12c, virtual false, abstract: false, final false
inline ::LiteNetLib::ConnectRequestResult ProcessConnectRequest(::LiteNetLib::NetConnectRequestPacket*  connRequest) ;

/// @brief Method ProcessDisconnect, addr 0x3a2ff20, size 0x8c, virtual false, abstract: false, final false
inline ::LiteNetLib::DisconnectResult ProcessDisconnect(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method ProcessMtuPacket, addr 0x3a343a4, size 0x3c0, virtual false, abstract: false, final false
inline void ProcessMtuPacket(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method ProcessPacket, addr 0x3a300ec, size 0x564, virtual false, abstract: false, final false
inline void ProcessPacket(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method RecycleAndDeliver, addr 0x3a34b8c, size 0x180, virtual false, abstract: false, final false
inline void RecycleAndDeliver(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method Reject, addr 0x3a2f6f4, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method Send, addr 0x3a33e48, size 0x28, virtual false, abstract: false, final false
inline void Send(::ArrayW<uint8_t,::Array<uint8_t>*>  data, uint8_t  channelNumber, ::LiteNetLib::DeliveryMethod  deliveryMethod) ;

/// @brief Method Send, addr 0x3a33de0, size 0x28, virtual false, abstract: false, final false
inline void Send(::ArrayW<uint8_t,::Array<uint8_t>*>  data, ::LiteNetLib::DeliveryMethod  deliveryMethod) ;

/// @brief Method Send, addr 0x3a30a88, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Send, addr 0x3a33e38, size 0x10, virtual false, abstract: false, final false
inline void Send(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  start, int32_t  length, ::LiteNetLib::DeliveryMethod  options) ;

/// @brief Method Send, addr 0x3a33e70, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method Send, addr 0x3a33e08, size 0x30, virtual false, abstract: false, final false
inline void Send(::LiteNetLib::Utils::NetDataWriter*  dataWriter, ::LiteNetLib::DeliveryMethod  deliveryMethod) ;

/// @brief Method SendInternal, addr 0x3a33848, size 0x4b0, virtual false, abstract: false, final false
...
/// @brief Method SendMerged, addr 0x3a349d0, size 0xa0, virtual false, abstract: false, final false
inline void SendMerged() ;

/// @brief Method SendUserData, addr 0x3a34a70, size 0x11c, virtual false, abstract: false, final false
inline void SendUserData(::LiteNetLib::NetPacket*  packet) ;

/// @brief Method SendWithDeliveryEvent, addr 0x3a337c8, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method SendWithDeliveryEvent, addr 0x3a33cf8, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method SendWithDeliveryEvent, addr 0x3a33d58, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method SetMtu, addr 0x3a33248, size 0xac, virtual false, abstract: false, final false
inline void SetMtu(int32_t  mtuIdx) ;

/// @brief Method Shutdown, addr 0x3a2dcb0, size 0x2c8, virtual false, abstract: false, final false
inline ::LiteNetLib::ShutdownResult Shutdown(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  start, int32_t  length, bool  force) ;

/// @brief Method Update, addr 0x3a2e72c, size 0x28c, virtual false, abstract: false, final false
inline void Update(int32_t  deltaTime) ;

/// @brief Method UpdateMtuLogic, addr 0x3a34764, size 0x240, virtual false, abstract: false, final false
inline void UpdateMtuLogic(int32_t  deltaTime) ;

/// @brief Method UpdateRoundTripTime, addr 0x3a33f74, size 0x3c, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint16_t,::LiteNetLib::__NetPeer__IncomingFragments*>*> const& __cordl_internal_get__holdedFragments() const;
...
/// @brief Method .ctor, addr 0x3a2f3f0, size 0x304, virtual false, abstract: false, final false
inline void _ctor(::LiteNetLib::NetManager*  netManager, ::System::Net::IPEndPoint*  remoteEndPoint, int32_t  id) ;

/// @brief Method .ctor, addr 0x3a2f710, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a32268, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method get_ConnectTime, addr 0x3a33180, size 0x8, virtual false, abstract: false, final false
inline int64_t get_ConnectTime() ;

/// @brief Method get_ConnectionNum, addr 0x3a33124, size 0x8, virtual false, abstract: false, final false
inline uint8_t get_ConnectionNum() ;

/// @brief Method get_ConnectionState, addr 0x3a33178, size 0x8, virtual false, abstract: false, final false
inline ::LiteNetLib::ConnectionState get_ConnectionState() ;

/// @brief Method get_Mtu, addr 0x3a3319c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Mtu() ;

/// @brief Method get_Ping, addr 0x3a33188, size 0x14, virtual false, abstract: false, final false
inline int32_t get_Ping() ;

/// @brief Method get_RemoteTimeDelta, addr 0x3a331a4, size 0x8, virtual false, abstract: false, final false
inline int64_t get_RemoteTimeDelta() ;

/// @brief Method get_RemoteUtcTime, addr 0x3a331ac, size 0x8c, virtual false, abstract: false, final false
inline ::System::DateTime get_RemoteUtcTime() ;

/// @brief Method get_ResendDelay, addr 0x3a33240, size 0x8, virtual false, abstract: false, final false
inline double_t get_ResendDelay() ;

/// @brief Method get_TimeSinceLastPacket, addr 0x3a33238, size 0x8, virtual false, abstract: false, final false
inline int32_t get_TimeSinceLastPacket() ;

/// @brief Method set_ConnectionNum, addr 0x3a3312c, size 0x4c, virtual false, abstract: false, final false
