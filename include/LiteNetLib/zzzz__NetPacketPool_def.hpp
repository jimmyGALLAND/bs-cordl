...
/// @brief Method GetPacket, addr 0x3a2da4c, size 0x16c, virtual false, abstract: false, final false
inline ::LiteNetLib::NetPacket* GetPacket(int32_t  size) ;

/// @brief Method GetWithData, addr 0x3a314e4, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method GetWithProperty, addr 0x3a2fd0c, size 0xa4, virtual false, abstract: false, final false
inline ::LiteNetLib::NetPacket* GetWithProperty(::LiteNetLib::PacketProperty  property) ;

/// @brief Method GetWithProperty, addr 0x3a2f1dc, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method Recycle, addr 0x3a2c620, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a2d320, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
