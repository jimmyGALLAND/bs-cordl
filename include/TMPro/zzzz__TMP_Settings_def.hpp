...
/// @brief Field followingCharacters, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_followingCharacters, put=__cordl_internal_set_followingCharacters)) ::System::Collections::Generic::Dictionary_2<int32_t,char16_t>*  followingCharacters;
...
/// @brief Method .ctor, addr 0x476c9b0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetCharacters, addr 0x476c9b8, size 0x124, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::Dictionary_2<int32_t,char16_t>* GetCharacters(::UnityEngine::TextAsset*  file) ;

/// @brief Method GetFontAsset, addr 0x476c824, size 0x84, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_FontAsset> GetFontAsset() ;

/// @brief Method GetSettings, addr 0x476c7a8, size 0x7c, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_Settings> GetSettings() ;

/// @brief Method GetSpriteAsset, addr 0x476c8a8, size 0x84, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_SpriteAsset> GetSpriteAsset() ;

/// @brief Method GetStyleSheet, addr 0x476c92c, size 0x84, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_StyleSheet> GetStyleSheet() ;

/// @brief Method LoadDefaultSettings, addr 0x476c6b0, size 0xf8, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_Settings> LoadDefaultSettings() ;

/// @brief Method LoadLinebreakingRules, addr 0x476c564, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x476cadc, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityW<::TMPro::TMP_Settings> getStaticF_s_Instance() ;

/// @brief Method get_autoSizeTextContainer, addr 0x476c360, size 0x1c, virtual false, abstract: false, final false
static inline bool get_autoSizeTextContainer() ;

/// @brief Method get_defaultColorGradientPresetsPath, addr 0x476c4a8, size 0x1c, virtual false, abstract: false, final false
static inline ::StringW get_defaultColorGradientPresetsPath() ;

/// @brief Method get_defaultFontAsset, addr 0x476c29c, size 0x1c, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_FontAsset> get_defaultFontAsset() ;

/// @brief Method get_defaultFontAssetPath, addr 0x476c2b8, size 0x1c, virtual false, abstract: false, final false
static inline ::StringW get_defaultFontAssetPath() ;

/// @brief Method get_defaultFontSize, addr 0x476c2d4, size 0x1c, virtual false, abstract: false, final false
static inline float_t get_defaultFontSize() ;

/// @brief Method get_defaultSpriteAsset, addr 0x476c3f4, size 0x1c, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_SpriteAsset> get_defaultSpriteAsset() ;

/// @brief Method get_defaultSpriteAssetPath, addr 0x476c410, size 0x1c, virtual false, abstract: false, final false
static inline ::StringW get_defaultSpriteAssetPath() ;

/// @brief Method get_defaultStyleSheet, addr 0x476c4c4, size 0x1c, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_StyleSheet> get_defaultStyleSheet() ;

/// @brief Method get_defaultTextAutoSizingMaxRatio, addr 0x476c30c, size 0x1c, virtual false, abstract: false, final false
static inline float_t get_defaultTextAutoSizingMaxRatio() ;

/// @brief Method get_defaultTextAutoSizingMinRatio, addr 0x476c2f0, size 0x1c, virtual false, abstract: false, final false
static inline float_t get_defaultTextAutoSizingMinRatio() ;

/// @brief Method get_defaultTextMeshProTextContainerSize, addr 0x476c328, size 0x1c, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 get_defaultTextMeshProTextContainerSize() ;

/// @brief Method get_defaultTextMeshProUITextContainerSize, addr 0x476c344, size 0x1c, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 get_defaultTextMeshProUITextContainerSize() ;

/// @brief Method get_enableEmojiSupport, addr 0x476c42c, size 0x1c, virtual false, abstract: false, final false
static inline bool get_enableEmojiSupport() ;

/// @brief Method get_enableExtraPadding, addr 0x476c1b8, size 0x1c, virtual false, abstract: false, final false
static inline bool get_enableExtraPadding() ;

/// @brief Method get_enableKerning, addr 0x476c19c, size 0x1c, virtual false, abstract: false, final false
static inline bool get_enableKerning() ;

/// @brief Method get_enableParseEscapeCharacters, addr 0x476c1f0, size 0x1c, virtual false, abstract: false, final false
static inline bool get_enableParseEscapeCharacters() ;

/// @brief Method get_enableRaycastTarget, addr 0x476c20c, size 0x1c, virtual false, abstract: false, final false
static inline bool get_enableRaycastTarget() ;

/// @brief Method get_enableTintAllSprites, addr 0x476c1d4, size 0x1c, virtual false, abstract: false, final false
static inline bool get_enableTintAllSprites() ;

/// @brief Method get_enableWordWrapping, addr 0x476c0b4, size 0x1c, virtual false, abstract: false, final false
static inline bool get_enableWordWrapping() ;

/// @brief Method get_fallbackFontAssets, addr 0x476c3bc, size 0x1c, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::UnityW<::TMPro::TMP_FontAsset>>* get_fallbackFontAssets() ;

/// @brief Method get_followingCharacters, addr 0x476c518, size 0x1c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::TextAsset> get_followingCharacters() ;

/// @brief Method get_getFontFeaturesAtRuntime, addr 0x476c228, size 0x1c, virtual false, abstract: false, final false
static inline bool get_getFontFeaturesAtRuntime() ;

/// @brief Method get_instance, addr 0x476c0d0, size 0xcc, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_Settings> get_instance() ;

/// @brief Method get_isTextObjectScaleStatic, addr 0x476c37c, size 0x1c, virtual false, abstract: false, final false
static inline bool get_isTextObjectScaleStatic() ;

/// @brief Method get_leadingCharacters, addr 0x476c4fc, size 0x1c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::TextAsset> get_leadingCharacters() ;

/// @brief Method get_linebreakingRules, addr 0x476c534, size 0x30, virtual false, abstract: false, final false
static inline ::TMPro::__TMP_Settings__LineBreakingTable* get_linebreakingRules() ;

/// @brief Method get_matchMaterialPreset, addr 0x476c3d8, size 0x1c, virtual false, abstract: false, final false
static inline bool get_matchMaterialPreset() ;

/// @brief Method get_missingCharacterSpriteUnicode, addr 0x476c46c, size 0x1c, virtual false, abstract: false, final false
static inline uint32_t get_missingCharacterSpriteUnicode() ;

/// @brief Method get_missingGlyphCharacter, addr 0x476c244, size 0x1c, virtual false, abstract: false, final false
static inline int32_t get_missingGlyphCharacter() ;

/// @brief Method get_styleSheetsResourcePath, addr 0x476c4e0, size 0x1c, virtual false, abstract: false, final false
static inline ::StringW get_styleSheetsResourcePath() ;

/// @brief Method get_useModernHangulLineBreakingRules, addr 0x476c670, size 0x1c, virtual false, abstract: false, final false
static inline bool get_useModernHangulLineBreakingRules() ;

/// @brief Method get_version, addr 0x476c074, size 0x40, virtual false, abstract: false, final false
static inline ::StringW get_version() ;

/// @brief Method get_warningsDisabled, addr 0x476c280, size 0x1c, virtual false, abstract: false, final false
static inline bool get_warningsDisabled() ;

static inline void setStaticF_s_Instance(::UnityW<::TMPro::TMP_Settings>  value) ;

/// @brief Method set_enableEmojiSupport, addr 0x476c448, size 0x24, virtual false, abstract: false, final false
static inline void set_enableEmojiSupport(bool  value) ;

/// @brief Method set_isTextObjectScaleStatic, addr 0x476c398, size 0x24, virtual false, abstract: false, final false
static inline void set_isTextObjectScaleStatic(bool  value) ;

/// @brief Method set_missingCharacterSpriteUnicode, addr 0x476c488, size 0x20, virtual false, abstract: false, final false
static inline void set_missingCharacterSpriteUnicode(uint32_t  value) ;

/// @brief Method set_missingGlyphCharacter, addr 0x476c260, size 0x20, virtual false, abstract: false, final false
static inline void set_missingGlyphCharacter(int32_t  value) ;

/// @brief Method set_useModernHangulLineBreakingRules, addr 0x476c68c, size 0x24, virtual false, abstract: false, final false
