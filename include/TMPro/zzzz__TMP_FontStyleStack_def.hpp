...
public:
// Declarations
/// @brief Method Add, addr 0x4775380, size 0xfc, virtual false, abstract: false, final false
inline uint8_t Add(::TMPro::FontStyles  style) ;

/// @brief Method Clear, addr 0x4775374, size 0xc, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Remove, addr 0x477547c, size 0x144, virtual false, abstract: false, final false
