...
public:
// Declarations
/// @brief Method ToString, addr 0x4733b4c, size 0x1a0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x4733b40, size 0xc, virtual false, abstract: false, final false
