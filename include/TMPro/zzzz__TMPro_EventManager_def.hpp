...
static __declspec(property(get=getStaticF_COLOR_GRADIENT_PROPERTY_EVENT, put=setStaticF_COLOR_GRADIENT_PROPERTY_EVENT)) ::TMPro::FastAction_1<::UnityW<::UnityEngine::Object>>*  COLOR_GRADIENT_PROPERTY_EVENT;
...
static __declspec(property(get=getStaticF_DRAG_AND_DROP_MATERIAL_EVENT, put=setStaticF_DRAG_AND_DROP_MATERIAL_EVENT)) ::TMPro::FastAction_3<::UnityW<::UnityEngine::GameObject>,::UnityW<::UnityEngine::Material>,::UnityW<::UnityEngine::Material>>*  DRAG_AND_DROP_MATERIAL_EVENT;
...
static __declspec(property(get=getStaticF_MATERIAL_PROPERTY_EVENT, put=setStaticF_MATERIAL_PROPERTY_EVENT)) ::TMPro::FastAction_2<bool,::UnityW<::UnityEngine::Material>>*  MATERIAL_PROPERTY_EVENT;
...
static __declspec(property(get=getStaticF_SPRITE_ASSET_PROPERTY_EVENT, put=setStaticF_SPRITE_ASSET_PROPERTY_EVENT)) ::TMPro::FastAction_2<bool,::UnityW<::UnityEngine::Object>>*  SPRITE_ASSET_PROPERTY_EVENT;

/// @brief Field TEXTMESHPRO_PROPERTY_EVENT, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_TEXTMESHPRO_PROPERTY_EVENT, put=setStaticF_TEXTMESHPRO_PROPERTY_EVENT)) ::TMPro::FastAction_2<bool,::UnityW<::UnityEngine::Object>>*  TEXTMESHPRO_PROPERTY_EVENT;

/// @brief Field TEXTMESHPRO_UGUI_PROPERTY_EVENT, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_TEXTMESHPRO_UGUI_PROPERTY_EVENT, put=setStaticF_TEXTMESHPRO_UGUI_PROPERTY_EVENT)) ::TMPro::FastAction_2<bool,::UnityW<::UnityEngine::Object>>*  TEXTMESHPRO_UGUI_PROPERTY_EVENT;
...
/// @brief Method ON_COLOR_GRADIENT_PROPERTY_CHANGED, addr 0x473261c, size 0x80, virtual false, abstract: false, final false
static inline void ON_COLOR_GRADIENT_PROPERTY_CHANGED(::UnityEngine::Object*  obj) ;

/// @brief Method ON_COMPUTE_DT_EVENT, addr 0x473286c, size 0x90, virtual false, abstract: false, final false
static inline void ON_COMPUTE_DT_EVENT(::System::Object*  Sender, ::TMPro::Compute_DT_EventArgs*  e) ;

/// @brief Method ON_DRAG_AND_DROP_MATERIAL_CHANGED, addr 0x4732504, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method ON_FONT_PROPERTY_CHANGED, addr 0x4732354, size 0x90, virtual false, abstract: false, final false
static inline void ON_FONT_PROPERTY_CHANGED(bool  isChanged, ::UnityEngine::Object*  obj) ;

/// @brief Method ON_MATERIAL_PROPERTY_CHANGED, addr 0x47322c4, size 0x90, virtual false, abstract: false, final false
static inline void ON_MATERIAL_PROPERTY_CHANGED(bool  isChanged, ::UnityEngine::Material*  mat) ;

/// @brief Method ON_RESOURCES_LOADED, addr 0x473277c, size 0x60, virtual false, abstract: false, final false
static inline void ON_RESOURCES_LOADED() ;

/// @brief Method ON_SPRITE_ASSET_PROPERTY_CHANGED, addr 0x47323e4, size 0x90, virtual false, abstract: false, final false
static inline void ON_SPRITE_ASSET_PROPERTY_CHANGED(bool  isChanged, ::UnityEngine::Object*  obj) ;

/// @brief Method ON_TEXTMESHPRO_PROPERTY_CHANGED, addr 0x4732474, size 0x90, virtual false, abstract: false, final false
static inline void ON_TEXTMESHPRO_PROPERTY_CHANGED(bool  isChanged, ::UnityEngine::Object*  obj) ;

/// @brief Method ON_TEXTMESHPRO_UGUI_PROPERTY_CHANGED, addr 0x47327dc, size 0x90, virtual false, abstract: false, final false
static inline void ON_TEXTMESHPRO_UGUI_PROPERTY_CHANGED(bool  isChanged, ::UnityEngine::Object*  obj) ;

/// @brief Method ON_TEXT_CHANGED, addr 0x473269c, size 0x80, virtual false, abstract: false, final false
static inline void ON_TEXT_CHANGED(::UnityEngine::Object*  obj) ;

/// @brief Method ON_TEXT_STYLE_PROPERTY_CHANGED, addr 0x473259c, size 0x80, virtual false, abstract: false, final false
static inline void ON_TEXT_STYLE_PROPERTY_CHANGED(bool  isChanged) ;

/// @brief Method ON_TMP_SETTINGS_CHANGED, addr 0x473271c, size 0x60, virtual false, abstract: false, final false
