...
/// @brief Method GetCharacterFromFontAsset, addr 0x4743688, size 0x154, virtual false, abstract: false, final false
static inline ::TMPro::TMP_Character* GetCharacterFromFontAsset(uint32_t  unicode, ::TMPro::TMP_FontAsset*  sourceFontAsset, bool  includeFallbacks, ::TMPro::FontStyles  fontStyle, ::TMPro::FontWeight  fontWeight, ByRef<bool>  isAlternativeTypeface) ;

/// @brief Method GetCharacterFromFontAsset_Internal, addr 0x47437dc, size 0x3c4, virtual false, abstract: false, final false
static inline ::TMPro::TMP_Character* GetCharacterFromFontAsset_Internal(uint32_t  unicode, ::TMPro::TMP_FontAsset*  sourceFontAsset, bool  includeFallbacks, ::TMPro::FontStyles  fontStyle, ::TMPro::FontWeight  fontWeight, ByRef<bool>  isAlternativeTypeface) ;

/// @brief Method GetCharacterFromFontAssets, addr 0x4743ba0, size 0x25c, virtual false, abstract: false, final false
static inline ::TMPro::TMP_Character* GetCharacterFromFontAssets(uint32_t  unicode, ::TMPro::TMP_FontAsset*  sourceFontAsset, ::System::Collections::Generic::List_1<::UnityW<::TMPro::TMP_FontAsset>>*  fontAssets, bool  includeFallbacks, ::TMPro::FontStyles  fontStyle, ::TMPro::FontWeight  fontWeight, ByRef<bool>  isAlternativeTypeface) ;

/// @brief Method GetSpriteCharacterFromSpriteAsset, addr 0x4743dfc, size 0x308, virtual false, abstract: false, final false
...
/// @brief Method GetSpriteCharacterFromSpriteAsset_Internal, addr 0x4744104, size 0x1dc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4743628, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_instance, addr 0x4743630, size 0x58, virtual false, abstract: false, final false
