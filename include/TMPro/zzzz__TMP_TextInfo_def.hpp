...
/// @brief Method Clear, addr 0x477460c, size 0x5c, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ClearAllData, addr 0x4774668, size 0x12c, virtual false, abstract: false, final false
inline void ClearAllData() ;

/// @brief Method ClearAllMeshInfo, addr 0x477484c, size 0xb0, virtual false, abstract: false, final false
inline void ClearAllMeshInfo() ;

/// @brief Method ClearLineInfo, addr 0x4774a68, size 0x180, virtual false, abstract: false, final false
inline void ClearLineInfo() ;

/// @brief Method ClearMeshInfo, addr 0x4774794, size 0xb8, virtual false, abstract: false, final false
inline void ClearMeshInfo(bool  updateMesh) ;

/// @brief Method ClearPageInfo, addr 0x4774be8, size 0x98, virtual false, abstract: false, final false
inline void ClearPageInfo() ;

/// @brief Method ClearUnusedVertices, addr 0x47749b8, size 0xb0, virtual false, abstract: false, final false
inline void ClearUnusedVertices(::ArrayW<::TMPro::MaterialReference,::Array<::TMPro::MaterialReference>*>  materials) ;

/// @brief Method CopyMeshInfoVertexData, addr 0x4774c80, size 0x3c0, virtual false, abstract: false, final false
...
/// @brief Method ResetVertexLayout, addr 0x47748fc, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x477424c, size 0x128, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4774374, size 0x12c, virtual false, abstract: false, final false
inline void _ctor(int32_t  characterCount) ;

/// @brief Method .ctor, addr 0x47744a0, size 0x16c, virtual false, abstract: false, final false
