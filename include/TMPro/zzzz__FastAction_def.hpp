...
/// @brief Method Add, addr 0x4722ccc, size 0xc0, virtual false, abstract: false, final false
inline void Add(::System::Action*  rhs) ;

/// @brief Method Call, addr 0x4722e4c, size 0x98, virtual false, abstract: false, final false
inline void Call() ;

static inline ::TMPro::FastAction* New_ctor() ;

/// @brief Method Remove, addr 0x4722d8c, size 0xc0, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::Action*,::System::Collections::Generic::LinkedListNode_1<::System::Action*>*>*> const& __cordl_internal_get_lookup() const;
...
/// @brief Method .ctor, addr 0x4722ee4, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;
