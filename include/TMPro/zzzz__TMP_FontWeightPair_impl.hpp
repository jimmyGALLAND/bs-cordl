...
// Ctor Parameters [CppParam { name: "regularTypeface", ty: "::UnityW<::TMPro::TMP_FontAsset>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "italicTypeface", ty: "::UnityW<::TMPro::TMP_FontAsset>", modifiers: "", def_value: Some("nullptr") }]
