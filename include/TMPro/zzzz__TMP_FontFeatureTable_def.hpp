...
/// @brief Method <SortGlyphPairAdjustmentRecords>b__6_0, addr 0x4744500, size 0x18, virtual false, abstract: false, final false
inline uint32_t _SortGlyphPairAdjustmentRecords_b__6_0(::TMPro::TMP_GlyphPairAdjustmentRecord*  s) ;

/// @brief Method <SortGlyphPairAdjustmentRecords>b__6_1, addr 0x4744518, size 0x18, virtual false, abstract: false, final false
inline uint32_t _SortGlyphPairAdjustmentRecords_b__6_1(::TMPro::TMP_GlyphPairAdjustmentRecord*  s) ;

/// @brief Method .ctor, addr 0x47444f8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_GlyphPairAdjustmentRecordLookupDictionary, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_GlyphPairAdjustmentRecordLookupDictionary, put=__cordl_internal_set_m_GlyphPairAdjustmentRecordLookupDictionary)) ::System::Collections::Generic::Dictionary_2<uint32_t,::TMPro::TMP_GlyphPairAdjustmentRecord*>*  m_GlyphPairAdjustmentRecordLookupDictionary;

/// @brief Field m_GlyphPairAdjustmentRecords, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_GlyphPairAdjustmentRecords, put=__cordl_internal_set_m_GlyphPairAdjustmentRecords)) ::System::Collections::Generic::List_1<::TMPro::TMP_GlyphPairAdjustmentRecord*>*  m_GlyphPairAdjustmentRecords;

static inline ::TMPro::TMP_FontFeatureTable* New_ctor() ;

/// @brief Method SortGlyphPairAdjustmentRecords, addr 0x473c674, size 0x1ec, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint32_t,::TMPro::TMP_GlyphPairAdjustmentRecord*>*> const& __cordl_internal_get_m_GlyphPairAdjustmentRecordLookupDictionary() const;
...
/// @brief Method .ctor, addr 0x47411a0, size 0xc8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_glyphPairAdjustmentRecords, addr 0x474448c, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::TMPro::TMP_GlyphPairAdjustmentRecord*>* get_glyphPairAdjustmentRecords() ;

/// @brief Method set_glyphPairAdjustmentRecords, addr 0x4744494, size 0x8, virtual false, abstract: false, final false
