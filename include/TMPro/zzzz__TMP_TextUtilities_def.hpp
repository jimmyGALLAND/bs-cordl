...
public:
// Declarations
/// @brief Method .ctor, addr 0x477844c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method DistanceToLine, addr 0x4776504, size 0xc8, virtual false, abstract: false, final false
static inline float_t DistanceToLine(::UnityEngine::Vector3  a, ::UnityEngine::Vector3  b, ::UnityEngine::Vector3  point) ;

/// @brief Method FindIntersectingCharacter, addr 0x47766e8, size 0x208, virtual false, abstract: false, final false
...
/// @brief Method FindIntersectingLine, addr 0x47772c4, size 0x158, virtual false, abstract: false, final false
static inline int32_t FindIntersectingLine(::TMPro::TMP_Text*  text, ::UnityEngine::Vector3  position, ::UnityEngine::Camera*  camera) ;

/// @brief Method FindIntersectingLink, addr 0x477741c, size 0x340, virtual false, abstract: false, final false
static inline int32_t FindIntersectingLink(::TMPro::TMP_Text*  text, ::UnityEngine::Vector3  position, ::UnityEngine::Camera*  camera) ;

/// @brief Method FindIntersectingWord, addr 0x47768f0, size 0x410, virtual false, abstract: false, final false
static inline int32_t FindIntersectingWord(::TMPro::TMP_Text*  text, ::UnityEngine::Vector3  position, ::UnityEngine::Camera*  camera) ;

/// @brief Method FindNearestCharacter, addr 0x477572c, size 0x328, virtual false, abstract: false, final false
...
/// @brief Method FindNearestCharacterOnLine, addr 0x47760d8, size 0x36c, virtual false, abstract: false, final false
...
/// @brief Method FindNearestLine, addr 0x4775f58, size 0x180, virtual false, abstract: false, final false
static inline int32_t FindNearestLine(::TMPro::TMP_Text*  text, ::UnityEngine::Vector3  position, ::UnityEngine::Camera*  camera) ;

/// @brief Method FindNearestLink, addr 0x477775c, size 0x714, virtual false, abstract: false, final false
static inline int32_t FindNearestLink(::TMPro::TMP_Text*  text, ::UnityEngine::Vector3  position, ::UnityEngine::Camera*  camera) ;

/// @brief Method FindNearestWord, addr 0x4776d00, size 0x5c4, virtual false, abstract: false, final false
static inline int32_t FindNearestWord(::TMPro::TMP_Text*  text, ::UnityEngine::Vector3  position, ::UnityEngine::Camera*  camera) ;

/// @brief Method GetCursorIndexFromPosition, addr 0x47755c8, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method GetCursorIndexFromPosition, addr 0x4775d78, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method GetHashCode, addr 0x477813c, size 0xbc, virtual false, abstract: false, final false
static inline int32_t GetHashCode(::StringW  s) ;

/// @brief Method GetSimpleHashCode, addr 0x476fda8, size 0x6c, virtual false, abstract: false, final false
static inline int32_t GetSimpleHashCode(::StringW  s) ;

/// @brief Method GetSimpleHashCodeLowercase, addr 0x47781f8, size 0xbc, virtual false, abstract: false, final false
static inline uint32_t GetSimpleHashCodeLowercase(::StringW  s) ;

/// @brief Method HexToInt, addr 0x47782b4, size 0x2c, virtual false, abstract: false, final false
static inline int32_t HexToInt(char16_t  hex) ;

/// @brief Method IntersectLinePlane, addr 0x4777e70, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method IsIntersectingRectTransform, addr 0x47765cc, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method PointIntersectRectangle, addr 0x4776444, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method ScreenPointToWorldPointInRectangle, addr 0x4775a54, size 0x324, virtual false, abstract: false, final false
...
/// @brief Method StringHexToInt, addr 0x47782e0, size 0x104, virtual false, abstract: false, final false
static inline int32_t StringHexToInt(::StringW  s) ;

/// @brief Method ToLowerFast, addr 0x4777fe0, size 0x74, virtual false, abstract: false, final false
static inline char16_t ToLowerFast(char16_t  c) ;

/// @brief Method ToUpperASCIIFast, addr 0x47780c8, size 0x74, virtual false, abstract: false, final false
static inline uint32_t ToUpperASCIIFast(uint32_t  c) ;

/// @brief Method ToUpperFast, addr 0x4778054, size 0x74, virtual false, abstract: false, final false
