...
/// @brief Method Awake, addr 0x4724404, size 0xc8, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method GetAnchorPosition, addr 0x4723ea0, size 0xf8, virtual false, abstract: false, final false
inline ::TMPro::TextContainerAnchors GetAnchorPosition(::UnityEngine::Vector2  pivot) ;

/// @brief Method GetPivot, addr 0x47240ec, size 0x78, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetPivot(::TMPro::TextContainerAnchors  anchor) ;

static inline ::TMPro::TextContainer* New_ctor() ;

/// @brief Method OnContainerChanged, addr 0x4723f98, size 0x110, virtual false, abstract: false, final false
inline void OnContainerChanged() ;

/// @brief Method OnDisable, addr 0x47244d0, size 0x4, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x47244cc, size 0x4, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x4724628, size 0x15c, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method SetRect, addr 0x4724200, size 0x8, virtual false, abstract: false, final false
inline void SetRect(::UnityEngine::Vector2  size) ;

/// @brief Method UpdateCorners, addr 0x47244d4, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4724784, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::Vector2 getStaticF_k_defaultSize() ;

/// @brief Method get_anchorPosition, addr 0x47240a8, size 0x8, virtual false, abstract: false, final false
inline ::TMPro::TextContainerAnchors get_anchorPosition() ;

/// @brief Method get_corners, addr 0x4724264, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*> get_corners() ;

/// @brief Method get_hasChanged, addr 0x4723e2c, size 0x8, virtual false, abstract: false, final false
inline bool get_hasChanged() ;

/// @brief Method get_height, addr 0x4724224, size 0x8, virtual false, abstract: false, final false
inline float_t get_height() ;

/// @brief Method get_isAutoFitting, addr 0x4724250, size 0x8, virtual false, abstract: false, final false
inline bool get_isAutoFitting() ;

/// @brief Method get_isDefaultHeight, addr 0x4724248, size 0x8, virtual false, abstract: false, final false
inline bool get_isDefaultHeight() ;

/// @brief Method get_isDefaultWidth, addr 0x4724240, size 0x8, virtual false, abstract: false, final false
inline bool get_isDefaultWidth() ;

/// @brief Method get_margins, addr 0x4724274, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_margins() ;

/// @brief Method get_pivot, addr 0x4723e40, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_pivot() ;

/// @brief Method get_rect, addr 0x4724164, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_rect() ;

/// @brief Method get_rectTransform, addr 0x47242dc, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform() ;

/// @brief Method get_size, addr 0x47241b8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_size() ;

/// @brief Method get_textMeshPro, addr 0x4724370, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::TMPro::TextMeshPro> get_textMeshPro() ;

/// @brief Method get_width, addr 0x4724208, size 0x8, virtual false, abstract: false, final false
inline float_t get_width() ;

/// @brief Method get_worldCorners, addr 0x472426c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_anchorPosition, addr 0x47240b0, size 0x3c, virtual false, abstract: false, final false
inline void set_anchorPosition(::TMPro::TextContainerAnchors  value) ;

/// @brief Method set_hasChanged, addr 0x4723e34, size 0xc, virtual false, abstract: false, final false
inline void set_hasChanged(bool  value) ;

/// @brief Method set_height, addr 0x472422c, size 0x14, virtual false, abstract: false, final false
inline void set_height(float_t  value) ;

/// @brief Method set_isAutoFitting, addr 0x4724258, size 0xc, virtual false, abstract: false, final false
inline void set_isAutoFitting(bool  value) ;

/// @brief Method set_margins, addr 0x4724280, size 0x5c, virtual false, abstract: false, final false
inline void set_margins(::UnityEngine::Vector4  value) ;

/// @brief Method set_pivot, addr 0x4723e48, size 0x58, virtual false, abstract: false, final false
inline void set_pivot(::UnityEngine::Vector2  value) ;

/// @brief Method set_rect, addr 0x4724170, size 0x48, virtual false, abstract: false, final false
inline void set_rect(::UnityEngine::Rect  value) ;

/// @brief Method set_size, addr 0x47241c0, size 0x40, virtual false, abstract: false, final false
inline void set_size(::UnityEngine::Vector2  value) ;

/// @brief Method set_width, addr 0x4724210, size 0x14, virtual false, abstract: false, final false
