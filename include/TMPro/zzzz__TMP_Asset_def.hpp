...
/// @brief Method .ctor, addr 0x4733d14, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_instanceID, addr 0x4733cec, size 0x28, virtual false, abstract: false, final false
