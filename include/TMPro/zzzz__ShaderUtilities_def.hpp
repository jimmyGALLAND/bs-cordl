...
/// @brief Method GetFontExtent, addr 0x476d2bc, size 0x44, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector4 GetFontExtent(::UnityEngine::Material*  material) ;

/// @brief Method GetPadding, addr 0x476d49c, size 0x6a8, virtual false, abstract: false, final false
static inline float_t GetPadding(::UnityEngine::Material*  material, bool  enableExtraPadding, bool  isBold) ;

/// @brief Method GetPadding, addr 0x476db44, size 0x8f0, virtual false, abstract: false, final false
...
/// @brief Method GetShaderPropertyIDs, addr 0x47663f4, size 0xacc, virtual false, abstract: false, final false
static inline void GetShaderPropertyIDs() ;

/// @brief Method IsMaskingEnabled, addr 0x476d300, size 0x19c, virtual false, abstract: false, final false
static inline bool IsMaskingEnabled(::UnityEngine::Material*  material) ;

/// @brief Method UpdateShaderRatios, addr 0x476ce60, size 0x45c, virtual false, abstract: false, final false
...
/// @brief Method get_ShaderRef_MobileBitmap, addr 0x476cbe8, size 0xfc, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Shader> get_ShaderRef_MobileBitmap() ;

/// @brief Method get_ShaderRef_MobileSDF, addr 0x476caec, size 0xfc, virtual false, abstract: false, final false
