...
/// @brief Method ConvertLegacyKerningData, addr 0x47426c4, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x47425e0, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4742644, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4742604, size 0x40, virtual false, abstract: false, final false
inline void _ctor(uint32_t  left, uint32_t  right, float_t  offset) ;

static inline ::TMPro::KerningPair* getStaticF_empty() ;

/// @brief Method get_firstGlyph, addr 0x47425a0, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_firstGlyph() ;

/// @brief Method get_firstGlyphAdjustments, addr 0x47425b0, size 0xc, virtual false, abstract: false, final false
inline ::TMPro::GlyphValueRecord_Legacy get_firstGlyphAdjustments() ;

/// @brief Method get_ignoreSpacingAdjustments, addr 0x47425d8, size 0x8, virtual false, abstract: false, final false
inline bool get_ignoreSpacingAdjustments() ;

/// @brief Method get_secondGlyph, addr 0x47425bc, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_secondGlyph() ;

/// @brief Method get_secondGlyphAdjustments, addr 0x47425cc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_firstGlyph, addr 0x47425a8, size 0x8, virtual false, abstract: false, final false
inline void set_firstGlyph(uint32_t  value) ;

/// @brief Method set_secondGlyph, addr 0x47425c4, size 0x8, virtual false, abstract: false, final false
