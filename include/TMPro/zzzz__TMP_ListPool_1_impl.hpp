...
template<typename T>
inline void TMPro::__TMP_ListPool_1____c<T>::setStaticF___9(::TMPro::__TMP_ListPool_1____c<T>*  value)  {
::cordl_internals::setStaticField<::TMPro::__TMP_ListPool_1____c<T>*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::TMPro::__TMP_ListPool_1____c<T>*>::get>(std::forward<::TMPro::__TMP_ListPool_1____c<T>*>(value));
}
template<typename T>
inline ::TMPro::__TMP_ListPool_1____c<T>* TMPro::__TMP_ListPool_1____c<T>::getStaticF___9()  {
...
template<typename T>
inline ::TMPro::__TMP_ListPool_1____c<T>* TMPro::__TMP_ListPool_1____c<T>::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::TMPro::__TMP_ListPool_1____c<T>*>());
}
template<typename T>
inline void TMPro::__TMP_ListPool_1____c<T>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::TMPro::__TMP_ListPool_1____c<T>*>::get(),
                        ".ctor",
...
template<typename T>
inline void TMPro::__TMP_ListPool_1____c<T>::__cctor_b__3_0(::System::Collections::Generic::List_1<T>*  l)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::TMPro::__TMP_ListPool_1____c<T>*>::get(),
                        "<.cctor>b__3_0",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters []
template<typename T>
constexpr ::TMPro::__TMP_ListPool_1____c<T>::__TMP_ListPool_1____c()   {
}
template<typename T>
