...
/// @brief Method AddColorGradientPreset, addr 0x47234d4, size 0x30, virtual false, abstract: false, final false
static inline void AddColorGradientPreset(int32_t  hashCode, ::TMPro::TMP_ColorGradient*  spriteAsset) ;

/// @brief Method AddColorGradientPreset_Internal, addr 0x4723504, size 0xa4, virtual false, abstract: false, final false
inline void AddColorGradientPreset_Internal(int32_t  hashCode, ::TMPro::TMP_ColorGradient*  spriteAsset) ;

/// @brief Method AddFontAsset, addr 0x4723170, size 0x20, virtual false, abstract: false, final false
static inline void AddFontAsset(::TMPro::TMP_FontAsset*  fontAsset) ;

/// @brief Method AddFontAssetInternal, addr 0x4723190, size 0xc4, virtual false, abstract: false, final false
inline void AddFontAssetInternal(::TMPro::TMP_FontAsset*  fontAsset) ;

/// @brief Method AddFontMaterial, addr 0x472343c, size 0x30, virtual false, abstract: false, final false
static inline void AddFontMaterial(int32_t  hashCode, ::UnityEngine::Material*  material) ;

/// @brief Method AddFontMaterialInternal, addr 0x472346c, size 0x68, virtual false, abstract: false, final false
inline void AddFontMaterialInternal(int32_t  hashCode, ::UnityEngine::Material*  material) ;

/// @brief Method AddSpriteAsset, addr 0x4723338, size 0x30, virtual false, abstract: false, final false
static inline void AddSpriteAsset(int32_t  hashCode, ::TMPro::TMP_SpriteAsset*  spriteAsset) ;

/// @brief Method AddSpriteAsset, addr 0x4723254, size 0x20, virtual false, abstract: false, final false
static inline void AddSpriteAsset(::TMPro::TMP_SpriteAsset*  spriteAsset) ;

/// @brief Method AddSpriteAssetInternal, addr 0x4723368, size 0xd4, virtual false, abstract: false, final false
inline void AddSpriteAssetInternal(int32_t  hashCode, ::TMPro::TMP_SpriteAsset*  spriteAsset) ;

/// @brief Method AddSpriteAssetInternal, addr 0x4723274, size 0xc4, virtual false, abstract: false, final false
inline void AddSpriteAssetInternal(::TMPro::TMP_SpriteAsset*  spriteAsset) ;

/// @brief Method Contains, addr 0x47235a8, size 0x5c, virtual false, abstract: false, final false
inline bool Contains(::TMPro::TMP_FontAsset*  font) ;

/// @brief Method Contains, addr 0x4723604, size 0x5c, virtual false, abstract: false, final false
inline bool Contains(::TMPro::TMP_SpriteAsset*  sprite) ;

static inline ::TMPro::MaterialReferenceManager* New_ctor() ;

/// @brief Method TryGetColorGradientPreset, addr 0x4723798, size 0x30, virtual false, abstract: false, final false
static inline bool TryGetColorGradientPreset(int32_t  hashCode, ByRef<::TMPro::TMP_ColorGradient*>  gradientPreset) ;

/// @brief Method TryGetColorGradientPresetInternal, addr 0x47237c8, size 0x6c, virtual false, abstract: false, final false
inline bool TryGetColorGradientPresetInternal(int32_t  hashCode, ByRef<::TMPro::TMP_ColorGradient*>  gradientPreset) ;

/// @brief Method TryGetFontAsset, addr 0x4723660, size 0x30, virtual false, abstract: false, final false
static inline bool TryGetFontAsset(int32_t  hashCode, ByRef<::TMPro::TMP_FontAsset*>  fontAsset) ;

/// @brief Method TryGetFontAssetInternal, addr 0x4723690, size 0x6c, virtual false, abstract: false, final false
inline bool TryGetFontAssetInternal(int32_t  hashCode, ByRef<::TMPro::TMP_FontAsset*>  fontAsset) ;

/// @brief Method TryGetMaterial, addr 0x4723834, size 0x30, virtual false, abstract: false, final false
static inline bool TryGetMaterial(int32_t  hashCode, ByRef<::UnityEngine::Material*>  material) ;

/// @brief Method TryGetMaterialInternal, addr 0x4723864, size 0x6c, virtual false, abstract: false, final false
inline bool TryGetMaterialInternal(int32_t  hashCode, ByRef<::UnityEngine::Material*>  material) ;

/// @brief Method TryGetSpriteAsset, addr 0x47236fc, size 0x30, virtual false, abstract: false, final false
static inline bool TryGetSpriteAsset(int32_t  hashCode, ByRef<::TMPro::TMP_SpriteAsset*>  spriteAsset) ;

/// @brief Method TryGetSpriteAssetInternal, addr 0x472372c, size 0x6c, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::TMPro::TMP_ColorGradient>>*> const& __cordl_internal_get_m_ColorGradientReferenceLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::TMPro::TMP_FontAsset>>*> const& __cordl_internal_get_m_FontAssetReferenceLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::UnityEngine::Material>>*> const& __cordl_internal_get_m_FontMaterialReferenceLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::TMPro::TMP_SpriteAsset>>*> const& __cordl_internal_get_m_SpriteAssetReferenceLookup() const;
...
/// @brief Method .ctor, addr 0x472301c, size 0x154, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::TMPro::MaterialReferenceManager* getStaticF_s_Instance() ;

/// @brief Method get_instance, addr 0x4722fa8, size 0x74, virtual false, abstract: false, final false
