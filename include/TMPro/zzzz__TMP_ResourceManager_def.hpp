...
static __declspec(property(get=getStaticF_s_FontAssetReferenceLookup, put=setStaticF_s_FontAssetReferenceLookup)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::TMPro::TMP_FontAsset>>*  s_FontAssetReferenceLookup;

/// @brief Field s_FontAssetReferences, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_s_FontAssetReferences, put=setStaticF_s_FontAssetReferences)) ::System::Collections::Generic::List_1<::UnityW<::TMPro::TMP_FontAsset>>*  s_FontAssetReferences;
...
/// @brief Method AddFontAsset, addr 0x476bb40, size 0x150, virtual false, abstract: false, final false
static inline void AddFontAsset(::TMPro::TMP_FontAsset*  fontAsset) ;

/// @brief Method GetTextSettings, addr 0x476ba30, size 0x110, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_Settings> GetTextSettings() ;

static inline ::TMPro::TMP_ResourceManager* New_ctor() ;

/// @brief Method RebuildFontAssetCache, addr 0x476bd24, size 0x118, virtual false, abstract: false, final false
static inline void RebuildFontAssetCache(int32_t  instanceID) ;

/// @brief Method TryGetFontAsset, addr 0x476bc90, size 0x94, virtual false, abstract: false, final false
static inline bool TryGetFontAsset(int32_t  hashcode, ByRef<::TMPro::TMP_FontAsset*>  fontAsset) ;

/// @brief Method .ctor, addr 0x476ba28, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
