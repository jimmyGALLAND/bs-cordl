...
/// @brief Method Approximately, addr 0x4733484, size 0x30, virtual false, abstract: false, final false
static inline bool Approximately(float_t  a, float_t  b) ;

/// @brief Method Mod, addr 0x47334b4, size 0x14, virtual false, abstract: false, final false
