...
/// @brief Method .ctor, addr 0x4770a78, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4770cec, size 0x54, virtual false, abstract: false, final false
inline void _ctor(uint32_t  unicode, ::TMPro::TMP_SpriteGlyph*  glyph) ;

/// @brief Method .ctor, addr 0x4770da0, size 0x40, virtual false, abstract: false, final false
inline void _ctor(uint32_t  unicode, uint32_t  glyphIndex) ;

/// @brief Method .ctor, addr 0x4770d40, size 0x60, virtual false, abstract: false, final false
inline void _ctor(uint32_t  unicode, ::TMPro::TMP_SpriteAsset*  spriteAsset, ::TMPro::TMP_SpriteGlyph*  glyph) ;

/// @brief Method get_hashCode, addr 0x4770cdc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_hashCode() ;

/// @brief Method get_name, addr 0x4770c68, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method set_name, addr 0x4770a98, size 0x78, virtual false, abstract: false, final false
