...
// Ctor Parameters [CppParam { name: "Variable", ty: "::Tayx::Graphy::__GraphyDebugger__DebugVariable", modifiers: "", def_value: None }, CppParam { name: "Comparer", ty: "::Tayx::Graphy::__GraphyDebugger__DebugComparer", modifiers: "", def_value: None }, CppParam { name: "Value", ty: "float_t", modifiers: "", def_value: None }]
...
/// @brief Field DebugConditions, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_DebugConditions, put=__cordl_internal_set_DebugConditions)) ::System::Collections::Generic::List_1<::Tayx::Graphy::__GraphyDebugger__DebugCondition>*  DebugConditions;
...
/// @brief Method Executed, addr 0x44397a4, size 0xc, virtual false, abstract: false, final false
inline void Executed() ;

static inline ::Tayx::Graphy::__GraphyDebugger__DebugPacket* New_ctor() ;

/// @brief Method Update, addr 0x443907c, size 0x5c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x443867c, size 0x120, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Check, addr 0x44397b0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <CheckDebugPackets>b__24_0, addr 0x443981c, size 0xc, virtual false, abstract: false, final false
inline bool _CheckDebugPackets_b__24_0(::Tayx::Graphy::__GraphyDebugger__DebugPacket*  packet) ;

/// @brief Method .ctor, addr 0x4439814, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetFirstDebugPacketWithId>b__0, addr 0x4439828, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4438b5c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetAllDebugPacketsWithId>b__0, addr 0x443984c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4438c3c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <RemoveAllDebugPacketsWithId>b__0, addr 0x4439870, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4438db8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_debugPackets, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_debugPackets, put=__cordl_internal_set_m_debugPackets)) ::System::Collections::Generic::List_1<::Tayx::Graphy::__GraphyDebugger__DebugPacket*>*  m_debugPackets;
...
/// @brief Method AddCallbackToAllDebugPacketWithId, addr 0x4438e94, size 0x1e8, virtual false, abstract: false, final false
inline void AddCallbackToAllDebugPacketWithId(::System::Action*  callback, int32_t  id) ;

/// @brief Method AddCallbackToFirstDebugPacketWithId, addr 0x4438dc0, size 0xd4, virtual false, abstract: false, final false
inline void AddCallbackToFirstDebugPacketWithId(::System::Action*  callback, int32_t  id) ;

/// @brief Method AddNewDebugPacket, addr 0x4438444, size 0xa4, virtual false, abstract: false, final false
inline void AddNewDebugPacket(::Tayx::Graphy::__GraphyDebugger__DebugPacket*  newDebugPacket) ;

/// @brief Method AddNewDebugPacket, addr 0x44384e8, size 0x194, virtual false, abstract: false, final false
inline void AddNewDebugPacket(int32_t  newId, ::Tayx::Graphy::__GraphyDebugger__DebugCondition  newDebugCondition, ::Tayx::Graphy::__GraphyDebugger__MessageType  newMessageType, ::StringW  newMessage, bool  newDebugBreak, ::System::Action*  newCallback) ;

/// @brief Method AddNewDebugPacket, addr 0x44388b0, size 0x12c, virtual false, abstract: false, final false
inline void AddNewDebugPacket(int32_t  newId, ::Tayx::Graphy::__GraphyDebugger__DebugCondition  newDebugCondition, ::Tayx::Graphy::__GraphyDebugger__MessageType  newMessageType, ::StringW  newMessage, bool  newDebugBreak, ::System::Collections::Generic::List_1<::System::Action*>*  newCallbacks) ;

/// @brief Method AddNewDebugPacket, addr 0x443879c, size 0x114, virtual false, abstract: false, final false
inline void AddNewDebugPacket(int32_t  newId, ::System::Collections::Generic::List_1<::Tayx::Graphy::__GraphyDebugger__DebugCondition>*  newDebugConditions, ::Tayx::Graphy::__GraphyDebugger__MessageType  newMessageType, ::StringW  newMessage, bool  newDebugBreak, ::System::Action*  newCallback) ;

/// @brief Method AddNewDebugPacket, addr 0x44389dc, size 0xac, virtual false, abstract: false, final false
inline void AddNewDebugPacket(int32_t  newId, ::System::Collections::Generic::List_1<::Tayx::Graphy::__GraphyDebugger__DebugCondition>*  newDebugConditions, ::Tayx::Graphy::__GraphyDebugger__MessageType  newMessageType, ::StringW  newMessage, bool  newDebugBreak, ::System::Collections::Generic::List_1<::System::Action*>*  newCallbacks) ;

/// @brief Method CheckDebugPackets, addr 0x443802c, size 0x418, virtual false, abstract: false, final false
inline void CheckDebugPackets() ;

/// @brief Method CheckIfConditionIsMet, addr 0x44390d8, size 0xf4, virtual false, abstract: false, final false
inline bool CheckIfConditionIsMet(::Tayx::Graphy::__GraphyDebugger__DebugCondition  debugCondition) ;

/// @brief Method ExecuteOperationsInDebugPacket, addr 0x44391cc, size 0x3e4, virtual false, abstract: false, final false
inline void ExecuteOperationsInDebugPacket(::Tayx::Graphy::__GraphyDebugger__DebugPacket*  debugPacket) ;

/// @brief Method GetAllDebugPacketsWithId, addr 0x4438b64, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method GetFirstDebugPacketWithId, addr 0x4438a88, size 0xd4, virtual false, abstract: false, final false
inline ::Tayx::Graphy::__GraphyDebugger__DebugPacket* GetFirstDebugPacketWithId(int32_t  packetId) ;

/// @brief Method GetRequestedValueFromDebugVariable, addr 0x44395b0, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method RemoveAllDebugPacketsWithId, addr 0x4438cd0, size 0xe8, virtual false, abstract: false, final false
inline void RemoveAllDebugPacketsWithId(int32_t  packetId) ;

/// @brief Method RemoveFirstDebugPacketWithId, addr 0x4438c44, size 0x8c, virtual false, abstract: false, final false
inline void RemoveFirstDebugPacketWithId(int32_t  packetId) ;

/// @brief Method Start, addr 0x4437f88, size 0xa0, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x4438028, size 0x4, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x4437ed4, size 0xb4, virtual false, abstract: false, final false
inline void _ctor() ;
