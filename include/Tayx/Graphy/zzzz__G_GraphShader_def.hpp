...
/// @brief Method InitializeShader, addr 0x443f394, size 0x17c, virtual false, abstract: false, final false
inline void InitializeShader() ;

static inline ::Tayx::Graphy::G_GraphShader* New_ctor() ;

/// @brief Method UpdateArray, addr 0x443f510, size 0x44, virtual false, abstract: false, final false
inline void UpdateArray() ;

/// @brief Method UpdateAverage, addr 0x443f554, size 0x3c, virtual false, abstract: false, final false
inline void UpdateAverage() ;

/// @brief Method UpdateColors, addr 0x443f5f8, size 0xa0, virtual false, abstract: false, final false
inline void UpdateColors() ;

/// @brief Method UpdatePoints, addr 0x443f698, size 0x3c, virtual false, abstract: false, final false
inline void UpdatePoints() ;

/// @brief Method UpdateThresholds, addr 0x443f590, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x443f6d4, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;
