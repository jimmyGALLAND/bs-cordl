...
/// @brief Method Awake, addr 0x44421f4, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x4441b5c, size 0x144, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Fps::G_FpsText* New_ctor() ;

/// @brief Method SetFpsRelatedTextColor, addr 0x4442504, size 0x80, virtual false, abstract: false, final false
inline void SetFpsRelatedTextColor(::UnityEngine::UI::Text*  text, float_t  fps) ;

/// @brief Method Update, addr 0x44421f8, size 0x30c, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateParameters, addr 0x4441b3c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4442584, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
