...
/// @brief Method <Update>b__25_0, addr 0x44421d4, size 0x20, virtual false, abstract: false, final false
inline int32_t _Update_b__25_0(int16_t  x, int16_t  y) ;

/// @brief Method .ctor, addr 0x44421cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Awake, addr 0x4441dbc, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x443c938, size 0xa4, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Fps::G_FpsMonitor* New_ctor() ;

/// @brief Method Update, addr 0x4441dc0, size 0x394, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateParameters, addr 0x4441afc, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4442154, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AverageFPS, addr 0x4441d8c, size 0x8, virtual false, abstract: false, final false
inline int16_t get_AverageFPS() ;

/// @brief Method get_CurrentFPS, addr 0x4441d7c, size 0x8, virtual false, abstract: false, final false
inline int16_t get_CurrentFPS() ;

/// @brief Method get_OnePercentFPS, addr 0x4441d9c, size 0x8, virtual false, abstract: false, final false
inline int16_t get_OnePercentFPS() ;

/// @brief Method get_Zero1PercentFps, addr 0x4441dac, size 0x8, virtual false, abstract: false, final false
inline int16_t get_Zero1PercentFps() ;

/// @brief Method set_AverageFPS, addr 0x4441d94, size 0x8, virtual false, abstract: false, final false
inline void set_AverageFPS(int16_t  value) ;

/// @brief Method set_CurrentFPS, addr 0x4441d84, size 0x8, virtual false, abstract: false, final false
inline void set_CurrentFPS(int16_t  value) ;

/// @brief Method set_OnePercentFPS, addr 0x4441da4, size 0x8, virtual false, abstract: false, final false
inline void set_OnePercentFPS(int16_t  value) ;

/// @brief Method set_Zero1PercentFps, addr 0x4441db4, size 0x8, virtual false, abstract: false, final false
