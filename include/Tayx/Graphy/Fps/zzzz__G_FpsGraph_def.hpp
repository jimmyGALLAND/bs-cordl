...
/// @brief Method CreatePoints, addr 0x4441954, size 0x14c, virtual true, abstract: false, final false
inline void CreatePoints() ;

/// @brief Method Init, addr 0x44415f8, size 0x114, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Fps::G_FpsGraph* New_ctor() ;

/// @brief Method Update, addr 0x44414e8, size 0xc, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateGraph, addr 0x444170c, size 0x248, virtual true, abstract: false, final false
inline void UpdateGraph() ;

/// @brief Method UpdateParameters, addr 0x44414f4, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4441aa0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
