...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Tayx::Graphy::UI::IModifiableState::*)(::Tayx::Graphy::__GraphyManager__ModuleState, bool)>(&::Tayx::Graphy::UI::IModifiableState::SetState)> {
