...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Tayx::Graphy::UI::IMovable::*)(::Tayx::Graphy::__GraphyManager__ModulePosition)>(&::Tayx::Graphy::UI::IMovable::SetPosition)> {
