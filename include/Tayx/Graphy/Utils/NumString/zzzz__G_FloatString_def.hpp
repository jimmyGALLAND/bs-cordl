...
/// @brief Method Dispose, addr 0x443c0fc, size 0x98, virtual false, abstract: false, final false
static inline void Dispose() ;

/// @brief Method FromIndex, addr 0x443fb48, size 0x64, virtual false, abstract: false, final false
static inline float_t FromIndex(int32_t  i) ;

/// @brief Method Init, addr 0x443fc14, size 0x254, virtual false, abstract: false, final false
static inline void Init(float_t  minNegativeValue, float_t  maxPositiveValue) ;

/// @brief Method ToFloat, addr 0x44401c4, size 0x8, virtual false, abstract: false, final false
static inline float_t ToFloat(int32_t  i) ;

/// @brief Method ToIndex, addr 0x443fe68, size 0xc0, virtual false, abstract: false, final false
static inline int32_t ToIndex(float_t  f) ;

/// @brief Method ToInt, addr 0x44401a8, size 0x1c, virtual false, abstract: false, final false
static inline int32_t ToInt(float_t  f) ;

/// @brief Method ToStringNonAlloc, addr 0x443ff28, size 0x140, virtual false, abstract: false, final false
static inline ::StringW ToStringNonAlloc(float_t  value) ;

/// @brief Method ToStringNonAlloc, addr 0x4440068, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method get_MaxValue, addr 0x443fbac, size 0x68, virtual false, abstract: false, final false
static inline float_t get_MaxValue() ;

/// @brief Method get_MinValue, addr 0x443fad8, size 0x70, virtual false, abstract: false, final false
