...
/// @brief Method CreatePoints, addr 0x4442e6c, size 0x214, virtual true, abstract: false, final false
inline void CreatePoints() ;

/// @brief Method Init, addr 0x4442824, size 0x134, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Audio::G_AudioGraph* New_ctor() ;

/// @brief Method OnEnable, addr 0x4442594, size 0x50, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Update, addr 0x44425e4, size 0x38, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateGraph, addr 0x4442958, size 0x4d0, virtual true, abstract: false, final false
inline void UpdateGraph() ;

/// @brief Method UpdateParameters, addr 0x444267c, size 0x1a8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4443080, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
