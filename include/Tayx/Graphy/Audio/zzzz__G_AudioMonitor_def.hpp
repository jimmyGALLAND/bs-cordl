...
/// @brief Field <SpectrumHighestValues>k__BackingField, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__SpectrumHighestValues_k__BackingField, put=__cordl_internal_set__SpectrumHighestValues_k__BackingField)) ::ArrayW<float_t,::Array<float_t>*>  _SpectrumHighestValues_k__BackingField;
...
/// @brief Method Awake, addr 0x44433d0, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method FindAudioListener, addr 0x44435bc, size 0xb4, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::AudioListener> FindAudioListener() ;

/// @brief Method Init, addr 0x443c9e0, size 0x128, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Audio::G_AudioMonitor* New_ctor() ;

/// @brief Method OnDestroy, addr 0x4443670, size 0xa4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnSceneLoaded, addr 0x4443714, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x44433d4, size 0x1e8, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateParameters, addr 0x44430dc, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4443738, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method dBNormalized, addr 0x4442e58, size 0x14, virtual false, abstract: false, final false
inline float_t dBNormalized(float_t  db) ;

/// @brief Method get_MaxDB, addr 0x44433c0, size 0x8, virtual false, abstract: false, final false
inline float_t get_MaxDB() ;

/// @brief Method get_Spectrum, addr 0x44433a0, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> get_Spectrum() ;

/// @brief Method get_SpectrumDataAvailable, addr 0x444261c, size 0x60, virtual false, abstract: false, final false
inline bool get_SpectrumDataAvailable() ;

/// @brief Method get_SpectrumHighestValues, addr 0x44433b0, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> get_SpectrumHighestValues() ;

/// @brief Method lin2dB, addr 0x4442e28, size 0x30, virtual false, abstract: false, final false
inline float_t lin2dB(float_t  linear) ;

/// @brief Method set_MaxDB, addr 0x44433c8, size 0x8, virtual false, abstract: false, final false
inline void set_MaxDB(float_t  value) ;

/// @brief Method set_Spectrum, addr 0x44433a8, size 0x8, virtual false, abstract: false, final false
inline void set_Spectrum(::ArrayW<float_t,::Array<float_t>*>  value) ;

/// @brief Method set_SpectrumHighestValues, addr 0x44433b8, size 0x8, virtual false, abstract: false, final false
