...
/// @brief Method Awake, addr 0x4443754, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x44431cc, size 0x110, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Audio::G_AudioText* New_ctor() ;

/// @brief Method Update, addr 0x4443758, size 0x100, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateParameters, addr 0x44431ac, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4443858, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
