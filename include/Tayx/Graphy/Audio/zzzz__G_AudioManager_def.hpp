...
/// @brief Method Awake, addr 0x4443090, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x443d4a4, size 0x4e4, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Audio::G_AudioManager* New_ctor() ;

/// @brief Method RefreshParameters, addr 0x443f048, size 0x1bc, virtual false, abstract: false, final false
inline void RefreshParameters() ;

/// @brief Method RestorePreviousState, addr 0x443c920, size 0xc, virtual false, abstract: false, final false
inline void RestorePreviousState() ;

/// @brief Method SetGraphActive, addr 0x4443098, size 0x44, virtual false, abstract: false, final false
inline void SetGraphActive(bool  active) ;

/// @brief Method SetPosition, addr 0x443a06c, size 0x300, virtual true, abstract: false, final true
inline void SetPosition(::Tayx::Graphy::__GraphyManager__ModulePosition  newModulePosition) ;

/// @brief Method SetState, addr 0x443ad78, size 0x150, virtual true, abstract: false, final true
inline void SetState(::Tayx::Graphy::__GraphyManager__ModuleState  state, bool  silentUpdate) ;

/// @brief Method Start, addr 0x4443094, size 0x4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UpdateParameters, addr 0x443aef0, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x44432dc, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;
