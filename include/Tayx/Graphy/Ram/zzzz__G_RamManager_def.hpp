...
/// @brief Method Awake, addr 0x4441024, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x443cfec, size 0x4b8, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Ram::G_RamManager* New_ctor() ;

/// @brief Method RefreshParameters, addr 0x443eeb4, size 0x194, virtual false, abstract: false, final false
inline void RefreshParameters() ;

/// @brief Method RestorePreviousState, addr 0x443c914, size 0xc, virtual false, abstract: false, final false
inline void RestorePreviousState() ;

/// @brief Method SetGraphActive, addr 0x444102c, size 0x44, virtual false, abstract: false, final false
inline void SetGraphActive(bool  active) ;

/// @brief Method SetPosition, addr 0x4439d84, size 0x2e8, virtual true, abstract: false, final true
inline void SetPosition(::Tayx::Graphy::__GraphyManager__ModulePosition  newModulePosition) ;

/// @brief Method SetState, addr 0x443a91c, size 0x150, virtual true, abstract: false, final true
inline void SetState(::Tayx::Graphy::__GraphyManager__ModuleState  state, bool  silentUpdate) ;

/// @brief Method Start, addr 0x4441028, size 0x4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UpdateParameters, addr 0x443aa9c, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x444121c, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;
