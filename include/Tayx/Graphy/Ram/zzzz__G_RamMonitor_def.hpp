...
/// @brief Method Init, addr 0x443c9dc, size 0x4, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Ram::G_RamMonitor* New_ctor() ;

/// @brief Method Update, addr 0x4441310, size 0x5c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x444136c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AllocatedRam, addr 0x44412e0, size 0x8, virtual false, abstract: false, final false
inline float_t get_AllocatedRam() ;

/// @brief Method get_MonoRam, addr 0x4441300, size 0x8, virtual false, abstract: false, final false
inline float_t get_MonoRam() ;

/// @brief Method get_ReservedRam, addr 0x44412f0, size 0x8, virtual false, abstract: false, final false
inline float_t get_ReservedRam() ;

/// @brief Method set_AllocatedRam, addr 0x44412e8, size 0x8, virtual false, abstract: false, final false
inline void set_AllocatedRam(float_t  value) ;

/// @brief Method set_MonoRam, addr 0x4441308, size 0x8, virtual false, abstract: false, final false
inline void set_MonoRam(float_t  value) ;

/// @brief Method set_ReservedRam, addr 0x44412f8, size 0x8, virtual false, abstract: false, final false
