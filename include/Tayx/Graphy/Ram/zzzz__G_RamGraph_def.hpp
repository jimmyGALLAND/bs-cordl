...
/// @brief Method CreatePoints, addr 0x4440d20, size 0x2ec, virtual true, abstract: false, final false
inline void CreatePoints() ;

/// @brief Method Init, addr 0x444095c, size 0x158, virtual false, abstract: false, final false
inline void Init() ;

static inline ::Tayx::Graphy::Ram::G_RamGraph* New_ctor() ;

/// @brief Method Update, addr 0x4440704, size 0xc, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateGraph, addr 0x4440ab4, size 0x26c, virtual true, abstract: false, final false
inline void UpdateGraph() ;

/// @brief Method UpdateParameters, addr 0x4440710, size 0x24c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x444100c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
