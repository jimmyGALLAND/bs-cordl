...
/// @brief Method OpenFilePanel, addr 0x3ae4ec0, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method OpenFilePanel, addr 0x3ae4fd0, size 0xf8, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> OpenFilePanel(::StringW  title, ::StringW  directory, ::ArrayW<::SFB::ExtensionFilter,::Array<::SFB::ExtensionFilter>*>  extensions, bool  multiselect) ;

/// @brief Method OpenFilePanelAsync, addr 0x3ae50c8, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method OpenFilePanelAsync, addr 0x3ae51e8, size 0x104, virtual false, abstract: false, final false
static inline void OpenFilePanelAsync(::StringW  title, ::StringW  directory, ::ArrayW<::SFB::ExtensionFilter,::Array<::SFB::ExtensionFilter>*>  extensions, bool  multiselect, ::System::Action_1<::ArrayW<::StringW,::Array<::StringW>*>>*  cb) ;

/// @brief Method OpenFolderPanel, addr 0x3ae52ec, size 0xec, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> OpenFolderPanel(::StringW  title, ::StringW  directory, bool  multiselect) ;

/// @brief Method OpenFolderPanelAsync, addr 0x3ae53d8, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method SaveFilePanel, addr 0x3ae54d4, size 0x110, virtual false, abstract: false, final false
static inline ::StringW SaveFilePanel(::StringW  title, ::StringW  directory, ::StringW  defaultName, ::StringW  extension) ;

/// @brief Method SaveFilePanel, addr 0x3ae55e4, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method SaveFilePanelAsync, addr 0x3ae56e0, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method SaveFilePanelAsync, addr 0x3ae5800, size 0x104, virtual false, abstract: false, final false
static inline void SaveFilePanelAsync(::StringW  title, ::StringW  directory, ::StringW  defaultName, ::ArrayW<::SFB::ExtensionFilter,::Array<::SFB::ExtensionFilter>*>  extensions, ::System::Action_1<::StringW>*  cb) ;

/// @brief Method .ctor, addr 0x3ae5904, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
