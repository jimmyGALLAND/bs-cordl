...
/// @brief Method AddKey, addr 0x3e8cf64, size 0x70, virtual false, abstract: false, final false
inline void AddKey(::StringW  key, ::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method ChangeItemKey, addr 0x3e8d07c, size 0x184, virtual false, abstract: false, final false
inline void ChangeItemKey(::Newtonsoft::Json::Linq::JToken*  item, ::StringW  newKey) ;

/// @brief Method ClearItems, addr 0x3e8d36c, size 0x78, virtual true, abstract: false, final false
inline void ClearItems() ;

/// @brief Method Compare, addr 0x3e8701c, size 0x360, virtual false, abstract: false, final false
inline bool Compare(::Newtonsoft::Json::Linq::JPropertyKeyedCollection*  other) ;

/// @brief Method Contains, addr 0x3e88e30, size 0xac, virtual false, abstract: false, final false
inline bool Contains(::StringW  key) ;

/// @brief Method ContainsItem, addr 0x3e8d200, size 0x8c, virtual false, abstract: false, final false
inline bool ContainsItem(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method EnsureDictionary, addr 0x3e8cfd4, size 0xa8, virtual false, abstract: false, final false
inline void EnsureDictionary() ;

/// @brief Method GetKeyForItem, addr 0x3e8d28c, size 0x80, virtual false, abstract: false, final false
inline ::StringW GetKeyForItem(::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method IndexOfReference, addr 0x3e873a4, size 0xa4, virtual false, abstract: false, final false
inline int32_t IndexOfReference(::Newtonsoft::Json::Linq::JToken*  t) ;

/// @brief Method InsertItem, addr 0x3e8d3e4, size 0x78, virtual true, abstract: false, final false
...
/// @brief Method Remove, addr 0x3e8d45c, size 0xe8, virtual false, abstract: false, final false
inline bool Remove(::StringW  key) ;

/// @brief Method RemoveItem, addr 0x3e8d544, size 0xf4, virtual true, abstract: false, final false
inline void RemoveItem(int32_t  index) ;

/// @brief Method RemoveKey, addr 0x3e8d30c, size 0x60, virtual false, abstract: false, final false
inline void RemoveKey(::StringW  key) ;

/// @brief Method SetItem, addr 0x3e8d638, size 0x208, virtual true, abstract: false, final false
inline void SetItem(int32_t  index, ::Newtonsoft::Json::Linq::JToken*  item) ;

/// @brief Method TryGetValue, addr 0x3e876d0, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3e86d9c, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::IEqualityComparer_1<::StringW>* getStaticF_Comparer() ;

/// @brief Method get_Item, addr 0x3e8d840, size 0xc0, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JToken* get_Item(::StringW  key) ;

/// @brief Method get_Keys, addr 0x3e88ef4, size 0x58, virtual false, abstract: false, final false
inline ::System::Collections::Generic::ICollection_1<::StringW>* get_Keys() ;

/// @brief Method get_Values, addr 0x3e8d900, size 0x58, virtual false, abstract: false, final false
