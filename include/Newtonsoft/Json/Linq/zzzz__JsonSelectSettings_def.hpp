...
/// @brief Method .ctor, addr 0x3e8e8d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ErrorWhenNoMatch, addr 0x3e8e8c0, size 0x8, virtual false, abstract: false, final false
inline bool get_ErrorWhenNoMatch() ;

/// @brief Method get_RegexMatchTimeout, addr 0x3e8e8ac, size 0xc, virtual false, abstract: false, final false
inline ::System::Nullable_1<::System::TimeSpan> get_RegexMatchTimeout() ;

/// @brief Method set_ErrorWhenNoMatch, addr 0x3e8e8c8, size 0xc, virtual false, abstract: false, final false
inline void set_ErrorWhenNoMatch(bool  value) ;

/// @brief Method set_RegexMatchTimeout, addr 0x3e8e8b8, size 0x8, virtual false, abstract: false, final false
