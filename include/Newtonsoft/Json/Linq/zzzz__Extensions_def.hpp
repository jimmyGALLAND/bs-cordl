...
class __Extensions___Convert_d__14_2;
}
namespace Newtonsoft::Json::Linq {
template<typename T,typename U>
class __Extensions___Values_d__11_2;
}
namespace Newtonsoft::Json::Linq {
...
namespace Newtonsoft::Json::Linq {
template<typename T>
class __Extensions____c__0_1;
}
namespace Newtonsoft::Json::Linq {
template<typename T,typename U>
class __Extensions____c__13_2;
}
namespace Newtonsoft::Json::Linq {
template<typename T>
class __Extensions____c__1_1;
}
namespace Newtonsoft::Json::Linq {
template<typename T>
class __Extensions____c__2_1;
}
namespace Newtonsoft::Json::Linq {
template<typename T>
class __Extensions____c__3_1;
}
...
static __declspec(property(get=getStaticF___9__4_0, put=setStaticF___9__4_0)) ::System::Func_2<::Newtonsoft::Json::Linq::JObject*,::System::Collections::Generic::IEnumerable_1<::Newtonsoft::Json::Linq::JProperty*>*>*  __9__4_0;

static inline ::Newtonsoft::Json::Linq::__Extensions____c* New_ctor() ;

/// @brief Method <Properties>b__4_0, addr 0x3e7c118, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3e7c110, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Declarations
template<typename T,typename U>
using _Convert_d__14_2 = ::Newtonsoft::Json::Linq::__Extensions___Convert_d__14_2<T, U>;

template<typename T,typename U>
using _Values_d__11_2 = ::Newtonsoft::Json::Linq::__Extensions___Values_d__11_2<T, U>;

using __c = ::Newtonsoft::Json::Linq::__Extensions____c;

template<typename T>
using __c__0_1 = ::Newtonsoft::Json::Linq::__Extensions____c__0_1<T>;

template<typename T,typename U>
using __c__13_2 = ::Newtonsoft::Json::Linq::__Extensions____c__13_2<T, U>;

template<typename T>
using __c__1_1 = ::Newtonsoft::Json::Linq::__Extensions____c__1_1<T>;

template<typename T>
using __c__2_1 = ::Newtonsoft::Json::Linq::__Extensions____c__2_1<T>;

template<typename T>
using __c__3_1 = ::Newtonsoft::Json::Linq::__Extensions____c__3_1<T>;
...
/// @brief Method AsJEnumerable, addr 0x3e7c064, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method Properties, addr 0x3e7bed0, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method Values, addr 0x3e7c0ac, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Values, addr 0x3e7c008, size 0x5c, virtual false, abstract: false, final false
