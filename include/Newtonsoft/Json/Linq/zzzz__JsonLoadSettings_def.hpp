...
/// @brief Method .ctor, addr 0x3e8e5f4, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CommentHandling, addr 0x3e8e61c, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::CommentHandling get_CommentHandling() ;

/// @brief Method get_DuplicatePropertyNameHandling, addr 0x3e8e6ec, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling get_DuplicatePropertyNameHandling() ;

/// @brief Method get_LineInfoHandling, addr 0x3e8e684, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::LineInfoHandling get_LineInfoHandling() ;

/// @brief Method set_CommentHandling, addr 0x3e8e624, size 0x60, virtual false, abstract: false, final false
inline void set_CommentHandling(::Newtonsoft::Json::Linq::CommentHandling  value) ;

/// @brief Method set_DuplicatePropertyNameHandling, addr 0x3e8e6f4, size 0x60, virtual false, abstract: false, final false
inline void set_DuplicatePropertyNameHandling(::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling  value) ;

/// @brief Method set_LineInfoHandling, addr 0x3e8e68c, size 0x60, virtual false, abstract: false, final false
