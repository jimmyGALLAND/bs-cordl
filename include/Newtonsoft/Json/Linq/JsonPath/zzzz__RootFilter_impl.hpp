...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Linq::JsonPath::RootFilter::*)()>(&::Newtonsoft::Json::Linq::JsonPath::RootFilter::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3ea8a38;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IEnumerable_1<::Newtonsoft::Json::Linq::JToken*>* (::Newtonsoft::Json::Linq::JsonPath::RootFilter::*)(::Newtonsoft::Json::Linq::JToken*, ::System::Collections::Generic::IEnumerable_1<::Newtonsoft::Json::Linq::JToken*>*, ::Newtonsoft::Json::Linq::JsonSelectSettings*)>(&::Newtonsoft::Json::Linq::JsonPath::RootFilter::ExecuteFilter)> {
  ...
  constexpr static std::size_t addrs = 0x3ea8a40;
...
::cordl_internals::setStaticField<::Newtonsoft::Json::Linq::JsonPath::RootFilter*, "Instance", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Linq::JsonPath::RootFilter*>::get>(std::forward<::Newtonsoft::Json::Linq::JsonPath::RootFilter*>(value));
}
inline ::Newtonsoft::Json::Linq::JsonPath::RootFilter* Newtonsoft::Json::Linq::JsonPath::RootFilter::getStaticF_Instance()  {
return ::cordl_internals::getStaticField<::Newtonsoft::Json::Linq::JsonPath::RootFilter*, "Instance", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Linq::JsonPath::RootFilter*>::get>();
}
