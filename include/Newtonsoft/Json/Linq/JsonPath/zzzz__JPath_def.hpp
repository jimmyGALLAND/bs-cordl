...
/// @brief Method CreatePathFilter, addr 0x3ea3ce8, size 0x84, virtual false, abstract: false, final false
static inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* CreatePathFilter(::StringW  member, bool  scan) ;

/// @brief Method CreateUnexpectedCharacterException, addr 0x3ea52a8, size 0xe4, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::JsonException* CreateUnexpectedCharacterException() ;

/// @brief Method EatWhitespace, addr 0x3ea369c, size 0x54, virtual false, abstract: false, final false
inline void EatWhitespace() ;

/// @brief Method EnsureLength, addr 0x3ea3e9c, size 0x6c, virtual false, abstract: false, final false
inline void EnsureLength(::StringW  message) ;

/// @brief Method Evaluate, addr 0x3ea6068, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method Evaluate, addr 0x3ea5fe8, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method Match, addr 0x3ea5a90, size 0xb0, virtual false, abstract: false, final false
inline bool Match(::StringW  s) ;

static inline ::Newtonsoft::Json::Linq::JsonPath::JPath* New_ctor(::StringW  expression) ;

/// @brief Method ParseArrayIndexer, addr 0x3ea4444, size 0x780, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* ParseArrayIndexer(char16_t  indexerCloseChar) ;

/// @brief Method ParseExpression, addr 0x3ea4bc4, size 0x49c, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JsonPath::QueryExpression* ParseExpression() ;

/// @brief Method ParseIndexer, addr 0x3ea3d6c, size 0x108, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* ParseIndexer(char16_t  indexerOpenChar, bool  scan) ;

/// @brief Method ParseMain, addr 0x3ea3538, size 0x164, virtual false, abstract: false, final false
inline void ParseMain() ;

/// @brief Method ParseOperator, addr 0x3ea57f4, size 0x260, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JsonPath::QueryOperator ParseOperator() ;

/// @brief Method ParsePath, addr 0x3ea36f0, size 0x5f8, virtual false, abstract: false, final false
...
/// @brief Method ParseQuery, addr 0x3ea4274, size 0x1d0, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* ParseQuery(char16_t  indexerCloseChar, bool  scan) ;

/// @brief Method ParseQuotedField, addr 0x3ea3f08, size 0x36c, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* ParseQuotedField(char16_t  indexerCloseChar, bool  scan) ;

/// @brief Method ParseSide, addr 0x3ea538c, size 0x110, virtual false, abstract: false, final false
inline ::System::Object* ParseSide() ;

/// @brief Method ReadQuotedString, addr 0x3ea5bc8, size 0x28c, virtual false, abstract: false, final false
inline ::StringW ReadQuotedString() ;

/// @brief Method ReadRegexString, addr 0x3ea5e54, size 0x16c, virtual false, abstract: false, final false
inline ::StringW ReadRegexString() ;

/// @brief Method TryParseExpression, addr 0x3ea50b0, size 0x1f8, virtual false, abstract: false, final false
...
/// @brief Method TryParseValue, addr 0x3ea549c, size 0x358, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ea3480, size 0xb8, virtual false, abstract: false, final false
inline void _ctor(::StringW  expression) ;

static inline ::ArrayW<char16_t,::Array<char16_t>*> getStaticF_FloatCharacters() ;

/// @brief Method get_Filters, addr 0x3ea3478, size 0x8, virtual false, abstract: false, final false
