...
/// @brief Method IsMatch, addr 0x3ea63ac, size 0x2c0, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JsonPath::QueryExpression*>*> const& __cordl_internal_get__Expressions_k__BackingField() const;
...
/// @brief Method .ctor, addr 0x3ea5b40, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::Linq::JsonPath::QueryOperator  _cordl_operator) ;

/// @brief Method get_Expressions, addr 0x3ea639c, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JsonPath::QueryExpression*>* get_Expressions() ;

/// @brief Method set_Expressions, addr 0x3ea63a4, size 0x8, virtual false, abstract: false, final false
