...
/// @brief Method .ctor, addr 0x3eb28b8, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlDeclaration*  declaration) ;

/// @brief Method get_Encoding, addr 0x3eb2ee0, size 0x1c, virtual true, abstract: false, final true
inline ::StringW get_Encoding() ;

/// @brief Method get_Standalone, addr 0x3eb2f18, size 0x1c, virtual true, abstract: false, final true
inline ::StringW get_Standalone() ;

/// @brief Method get_Version, addr 0x3eb2ec4, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method set_Encoding, addr 0x3eb2efc, size 0x1c, virtual true, abstract: false, final true
inline void set_Encoding(::StringW  value) ;

/// @brief Method set_Standalone, addr 0x3eb2f34, size 0x1c, virtual true, abstract: false, final true
