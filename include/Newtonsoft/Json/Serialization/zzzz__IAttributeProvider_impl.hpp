...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IList_1<::System::Attribute*>* (::Newtonsoft::Json::Serialization::IAttributeProvider::*)(bool)>(&::Newtonsoft::Json::Serialization::IAttributeProvider::GetAttributes)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IList_1<::System::Attribute*>* (::Newtonsoft::Json::Serialization::IAttributeProvider::*)(::System::Type*, bool)>(&::Newtonsoft::Json::Serialization::IAttributeProvider::GetAttributes)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
