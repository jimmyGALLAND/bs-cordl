...
/// @brief Method <GetCreator>b__22_1, addr 0x3e6cb04, size 0x5c, virtual false, abstract: false, final false
inline ::System::Type* _GetCreator_b__22_1(::System::Object*  param) ;

/// @brief Method .ctor, addr 0x3e6cafc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetCreator>b__0, addr 0x3e6cb60, size 0x42c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3e6c488, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static __declspec(property(get=getStaticF_AssociatedMetadataTypesCache, put=setStaticF_AssociatedMetadataTypesCache)) ::Newtonsoft::Json::Utilities::ThreadSafeStore_2<::System::Type*,::System::Type*>*  AssociatedMetadataTypesCache;

/// @brief Field CreatorCache, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_CreatorCache, put=setStaticF_CreatorCache)) ::Newtonsoft::Json::Utilities::ThreadSafeStore_2<::System::Type*,::System::Func_2<::ArrayW<::System::Object*,::Array<::System::Object*>*>,::System::Object*>*>*  CreatorCache;
...
static __declspec(property(get=getStaticF__metadataTypeAttributeReflectionObject, put=setStaticF__metadataTypeAttributeReflectionObject)) ::Newtonsoft::Json::Utilities::ReflectionObject*  _metadataTypeAttributeReflectionObject;

/// @brief Method CanTypeDescriptorConvertString, addr 0x3e69084, size 0x1ec, virtual false, abstract: false, final false
...
/// @brief Method CreateJsonConverterInstance, addr 0x3e6c088, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method CreateNamingStrategyInstance, addr 0x3e6c17c, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method GetAssociateMetadataTypeFromAttribute, addr 0x3e6c598, size 0x238, virtual false, abstract: false, final false
static inline ::System::Type* GetAssociateMetadataTypeFromAttribute(::System::Type*  type) ;

/// @brief Method GetAssociatedMetadataType, addr 0x3e6c518, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method GetContainerNamingStrategy, addr 0x3e6c270, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method GetCreator, addr 0x3e6c328, size 0x160, virtual false, abstract: false, final false
static inline ::System::Func_2<::ArrayW<::System::Object*,::Array<::System::Object*>*>,::System::Object*>* GetCreator(::System::Type*  type) ;

/// @brief Method GetDataContractAttribute, addr 0x3e6bac4, size 0xcc, virtual false, abstract: false, final false
static inline ::System::Runtime::Serialization::DataContractAttribute* GetDataContractAttribute(::System::Type*  type) ;

/// @brief Method GetDataMemberAttribute, addr 0x3e6bb90, size 0x284, virtual false, abstract: false, final false
...
/// @brief Method GetJsonConverter, addr 0x3e6bf68, size 0x120, virtual false, abstract: false, final false
static inline ::Newtonsoft::Json::JsonConverter* GetJsonConverter(::System::Object*  attributeProvider) ;

/// @brief Method GetObjectMemberSerialization, addr 0x3e6be14, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method IsNonSerializable, addr 0x3e6c7d0, size 0x7c, virtual false, abstract: false, final false
static inline bool IsNonSerializable(::System::Object*  provider) ;

/// @brief Method IsSerializable, addr 0x3e6beec, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method get_DynamicCodeGeneration, addr 0x3e6c84c, size 0xd8, virtual false, abstract: false, final false
static inline bool get_DynamicCodeGeneration() ;

/// @brief Method get_FullyTrusted, addr 0x3e6aee0, size 0x10c, virtual false, abstract: false, final false
static inline bool get_FullyTrusted() ;

/// @brief Method get_ReflectionDelegateFactory, addr 0x3e6c490, size 0x88, virtual false, abstract: false, final false
