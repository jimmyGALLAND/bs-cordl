...
/// @brief Method BindToName, addr 0x3e6dfb4, size 0x20, virtual true, abstract: false, final true
inline void BindToName(::System::Type*  serializedType, ByRef<::StringW>  assemblyName, ByRef<::StringW>  typeName) ;

/// @brief Method BindToType, addr 0x3e6df94, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3e6df6c, size 0x28, virtual false, abstract: false, final false
