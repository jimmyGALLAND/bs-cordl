...
static __declspec(property(get=getStaticF__contractCache, put=setStaticF__contractCache)) ::System::Collections::Generic::Dictionary_2<::Newtonsoft::Json::Utilities::StructMultiKey_2<::System::Type*,::System::Type*>,::Newtonsoft::Json::Serialization::JsonContract*>*  _contractCache;

/// @brief Method GetNameTable, addr 0x3e4863c, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method ResolveContract, addr 0x3e48318, size 0x324, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::JsonContract* ResolveContract(::System::Type*  type) ;

/// @brief Method .ctor, addr 0x3e48184, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
