...
/// @brief Method ResolvePropertyName, addr 0x3e52e30, size 0x8, virtual true, abstract: false, final false
inline ::StringW ResolvePropertyName(::StringW  name) ;

/// @brief Method .ctor, addr 0x3e52e38, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
