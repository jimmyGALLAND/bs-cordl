...
static __declspec(property(get=getStaticF_JsonSchemaTypeMapping, put=setStaticF_JsonSchemaTypeMapping)) ::System::Collections::Generic::IDictionary_2<::StringW,::Newtonsoft::Json::Schema::JsonSchemaType>*  JsonSchemaTypeMapping;
