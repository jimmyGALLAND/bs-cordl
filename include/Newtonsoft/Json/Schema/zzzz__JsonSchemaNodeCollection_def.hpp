...
public:
// Declarations
/// @brief Method GetKeyForItem, addr 0x3e7acd8, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3e791ec, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
