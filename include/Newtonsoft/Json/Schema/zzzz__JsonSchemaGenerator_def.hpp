...
/// @brief Method .ctor, addr 0x3e780dc, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  type, ::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method get_Schema, addr 0x3e788bc, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchema* get_Schema() ;

/// @brief Method get_Type, addr 0x3e788b4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <GenerateInternal>b__0, addr 0x3e788c4, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3e77ffc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _stack, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__stack, put=__cordl_internal_set__stack)) ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Schema::__JsonSchemaGenerator__TypeSchema*>*  _stack;

/// @brief Method AddNullType, addr 0x3e78178, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x3e76f54, size 0x6c, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchema* Generate(::System::Type*  type) ;

/// @brief Method Generate, addr 0x3e7706c, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchema* Generate(::System::Type*  type, ::Newtonsoft::Json::Schema::JsonSchemaResolver*  resolver) ;

/// @brief Method Generate, addr 0x3e76fc0, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x3e77074, size 0x70, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchema* Generate(::System::Type*  type, bool  rootSchemaNullable) ;

/// @brief Method GenerateISerializableContract, addr 0x3e7880c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method GenerateInternal, addr 0x3e770e4, size 0xc68, virtual false, abstract: false, final false
...
/// @brief Method GenerateObjectSchema, addr 0x3e78188, size 0x4c4, virtual false, abstract: false, final false
inline void GenerateObjectSchema(::System::Type*  type, ::Newtonsoft::Json::Serialization::JsonObjectContract*  contract) ;

/// @brief Method GetDescription, addr 0x3e77dfc, size 0xfc, virtual false, abstract: false, final false
inline ::StringW GetDescription(::System::Type*  type) ;

/// @brief Method GetJsonSchemaType, addr 0x3e7864c, size 0x1c0, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchemaType GetJsonSchemaType(::System::Type*  type, ::Newtonsoft::Json::Required  valueRequired) ;

/// @brief Method GetTitle, addr 0x3e77d4c, size 0xb0, virtual false, abstract: false, final false
inline ::StringW GetTitle(::System::Type*  type) ;

/// @brief Method GetTypeId, addr 0x3e77ef8, size 0x104, virtual false, abstract: false, final false
inline ::StringW GetTypeId(::System::Type*  type, bool  explicitOnly) ;

/// @brief Method HasFlag, addr 0x3e7882c, size 0xc, virtual false, abstract: false, final false
inline bool HasFlag(::Newtonsoft::Json::DefaultValueHandling  value, ::Newtonsoft::Json::DefaultValueHandling  flag) ;

/// @brief Method HasFlag, addr 0x3e78004, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method Pop, addr 0x3e76d34, size 0x220, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::__JsonSchemaGenerator__TypeSchema* Pop() ;

/// @brief Method Push, addr 0x3e76bf4, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3e78838, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ContractResolver, addr 0x3e76b50, size 0x94, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::IContractResolver* get_ContractResolver() ;

/// @brief Method get_CurrentSchema, addr 0x3e76bec, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchema* get_CurrentSchema() ;

/// @brief Method get_UndefinedSchemaIdHandling, addr 0x3e76b40, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::UndefinedSchemaIdHandling get_UndefinedSchemaIdHandling() ;

/// @brief Method set_ContractResolver, addr 0x3e76be4, size 0x8, virtual false, abstract: false, final false
inline void set_ContractResolver(::Newtonsoft::Json::Serialization::IContractResolver*  value) ;

/// @brief Method set_UndefinedSchemaIdHandling, addr 0x3e76b48, size 0x8, virtual false, abstract: false, final false
