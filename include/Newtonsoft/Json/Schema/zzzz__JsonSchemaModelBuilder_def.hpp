...
/// @brief Method AddAdditionalItems, addr 0x3e7a7c4, size 0x24, virtual false, abstract: false, final false
inline void AddAdditionalItems(::Newtonsoft::Json::Schema::JsonSchemaNode*  parentNode, ::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method AddAdditionalProperties, addr 0x3e7a7e8, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method AddItem, addr 0x3e7a66c, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method AddProperties, addr 0x3e7a374, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method AddProperty, addr 0x3e7a80c, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method AddSchema, addr 0x3e79234, size 0x648, virtual false, abstract: false, final false
...
/// @brief Method Build, addr 0x3e79128, size 0xc4, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchemaModel* Build(::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method BuildNodeModel, addr 0x3e7987c, size 0x6bc, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::Newtonsoft::Json::Schema::JsonSchemaNode*,::Newtonsoft::Json::Schema::JsonSchemaModel*>*> const& __cordl_internal_get__nodeModels() const;
...
/// @brief Method .ctor, addr 0x3e7a950, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;
