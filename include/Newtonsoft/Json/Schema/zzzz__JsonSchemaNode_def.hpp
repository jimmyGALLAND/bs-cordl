...
/// @brief Method <GetId>b__26_0, addr 0x3e7acb8, size 0x18, virtual false, abstract: false, final false
inline ::StringW _GetId_b__26_0(::Newtonsoft::Json::Schema::JsonSchema*  s) ;

/// @brief Method <GetId>b__26_1, addr 0x3e7acd0, size 0x8, virtual false, abstract: false, final false
inline ::StringW _GetId_b__26_1(::StringW  id) ;

/// @brief Method .ctor, addr 0x3e7acb0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Combine, addr 0x3e7a30c, size 0x68, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchemaNode* Combine(::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method GetId, addr 0x3e79f38, size 0x238, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::Newtonsoft::Json::Schema::JsonSchemaNode*>*> const& __cordl_internal_get__PatternProperties_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::Newtonsoft::Json::Schema::JsonSchemaNode*>*> const& __cordl_internal_get__Properties_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ObjectModel::ReadOnlyCollection_1<::Newtonsoft::Json::Schema::JsonSchema*>*> const& __cordl_internal_get__Schemas_k__BackingField() const;
...
/// @brief Method .ctor, addr 0x3e7a170, size 0x19c, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method .ctor, addr 0x3e7aa3c, size 0x218, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::Schema::JsonSchemaNode*  source, ::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method get_AdditionalItems, addr 0x3e7aa2c, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchemaNode* get_AdditionalItems() ;

/// @brief Method get_AdditionalProperties, addr 0x3e7aa1c, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Schema::JsonSchemaNode* get_AdditionalProperties() ;

/// @brief Method get_Id, addr 0x3e7a9f4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Id() ;

/// @brief Method get_Items, addr 0x3e7aa14, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Schema::JsonSchemaNode*>* get_Items() ;

/// @brief Method get_PatternProperties, addr 0x3e7aa0c, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,::Newtonsoft::Json::Schema::JsonSchemaNode*>* get_PatternProperties() ;

/// @brief Method get_Properties, addr 0x3e7aa04, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,::Newtonsoft::Json::Schema::JsonSchemaNode*>* get_Properties() ;

/// @brief Method get_Schemas, addr 0x3e7a9fc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::ObjectModel::ReadOnlyCollection_1<::Newtonsoft::Json::Schema::JsonSchema*>* get_Schemas() ;

/// @brief Method set_AdditionalItems, addr 0x3e7aa34, size 0x8, virtual false, abstract: false, final false
inline void set_AdditionalItems(::Newtonsoft::Json::Schema::JsonSchemaNode*  value) ;

/// @brief Method set_AdditionalProperties, addr 0x3e7aa24, size 0x8, virtual false, abstract: false, final false
