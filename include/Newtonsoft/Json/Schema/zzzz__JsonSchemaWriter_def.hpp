...
/// @brief Method <WriteType>b__7_0, addr 0x3e7bdc8, size 0xc, virtual false, abstract: false, final false
inline bool _WriteType_b__7_0(::Newtonsoft::Json::Schema::JsonSchemaType  v) ;

/// @brief Method .ctor, addr 0x3e7bdc0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ReferenceOrWriteSchema, addr 0x3e7ae90, size 0xe4, virtual false, abstract: false, final false
inline void ReferenceOrWriteSchema(::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method WriteItems, addr 0x3e7b8ac, size 0x4b8, virtual false, abstract: false, final false
inline void WriteItems(::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method WritePropertyIfNotNull, addr 0x3e7af74, size 0x64, virtual false, abstract: false, final false
inline void WritePropertyIfNotNull(::Newtonsoft::Json::JsonWriter*  writer, ::StringW  propertyName, ::System::Object*  value) ;

/// @brief Method WriteSchema, addr 0x3e715cc, size 0x1050, virtual false, abstract: false, final false
inline void WriteSchema(::Newtonsoft::Json::Schema::JsonSchema*  schema) ;

/// @brief Method WriteSchemaDictionaryIfNotNull, addr 0x3e7b51c, size 0x390, virtual false, abstract: false, final false
...
/// @brief Method WriteType, addr 0x3e7afd8, size 0x544, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3e7155c, size 0x70, virtual false, abstract: false, final false
