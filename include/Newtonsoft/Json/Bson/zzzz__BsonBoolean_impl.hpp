...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Bson::BsonBoolean::*)(bool)>(&::Newtonsoft::Json::Bson::BsonBoolean::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3ec24cc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Bson::BsonBoolean*>::get(),
                        ".ctor",
...
::cordl_internals::setStaticField<::Newtonsoft::Json::Bson::BsonBoolean*, "False", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Bson::BsonBoolean*>::get>(std::forward<::Newtonsoft::Json::Bson::BsonBoolean*>(value));
}
...
::cordl_internals::setStaticField<::Newtonsoft::Json::Bson::BsonBoolean*, "True", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Bson::BsonBoolean*>::get>(std::forward<::Newtonsoft::Json::Bson::BsonBoolean*>(value));
}
