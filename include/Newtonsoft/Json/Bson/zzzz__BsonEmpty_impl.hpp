...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Bson::BsonEmpty::*)(::Newtonsoft::Json::Bson::BsonType)>(&::Newtonsoft::Json::Bson::BsonEmpty::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x3ec23d0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Bson::BsonEmpty*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Newtonsoft::Json::Bson::BsonType (::Newtonsoft::Json::Bson::BsonEmpty::*)()>(&::Newtonsoft::Json::Bson::BsonEmpty::get_Type)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3ec23f8;
...
::cordl_internals::setStaticField<::Newtonsoft::Json::Bson::BsonToken*, "Null", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Bson::BsonEmpty*>::get>(std::forward<::Newtonsoft::Json::Bson::BsonToken*>(value));
}
inline ::Newtonsoft::Json::Bson::BsonToken* Newtonsoft::Json::Bson::BsonEmpty::getStaticF_Null()  {
return ::cordl_internals::getStaticField<::Newtonsoft::Json::Bson::BsonToken*, "Null", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Bson::BsonEmpty*>::get>();
}
inline void Newtonsoft::Json::Bson::BsonEmpty::setStaticF_Undefined(::Newtonsoft::Json::Bson::BsonToken*  value)  {
::cordl_internals::setStaticField<::Newtonsoft::Json::Bson::BsonToken*, "Undefined", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Bson::BsonEmpty*>::get>(std::forward<::Newtonsoft::Json::Bson::BsonToken*>(value));
}
