...
/// @brief Method .ctor, addr 0x3ec20a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CalculatedSize, addr 0x3ec2098, size 0x8, virtual false, abstract: false, final false
inline int32_t get_CalculatedSize() ;

/// @brief Method get_Parent, addr 0x3ec2088, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_CalculatedSize, addr 0x3ec20a0, size 0x8, virtual false, abstract: false, final false
inline void set_CalculatedSize(int32_t  value) ;

/// @brief Method set_Parent, addr 0x3ec2090, size 0x8, virtual false, abstract: false, final false
