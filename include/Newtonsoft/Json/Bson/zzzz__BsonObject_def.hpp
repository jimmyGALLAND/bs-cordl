...
/// @brief Method Add, addr 0x3ec20b0, size 0x128, virtual false, abstract: false, final false
inline void Add(::StringW  name, ::Newtonsoft::Json::Bson::BsonToken*  token) ;

/// @brief Method GetEnumerator, addr 0x3ec001c, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3ec2220, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3ec2224, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Type, addr 0x3ec2218, size 0x8, virtual true, abstract: false, final false
