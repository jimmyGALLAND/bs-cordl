...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::DateTimeKind (::Newtonsoft::Json::Bson::BsonBinaryWriter::*)()>(&::Newtonsoft::Json::Bson::BsonBinaryWriter::get_DateTimeKindHandling)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3ebe808;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Bson::BsonBinaryWriter::*)(::System::DateTimeKind)>(&::Newtonsoft::Json::Bson::BsonBinaryWriter::set_DateTimeKindHandling)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3ebe810;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Bson::BsonBinaryWriter::*)(::System::IO::BinaryWriter*)>(&::Newtonsoft::Json::Bson::BsonBinaryWriter::_ctor)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x3ebe818;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Bson::BsonBinaryWriter::*)()>(&::Newtonsoft::Json::Bson::BsonBinaryWriter::Flush)> {
  ...
  constexpr static std::size_t addrs = 0x3ebe848;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Bson::BsonBinaryWriter::*)()>(&::Newtonsoft::Json::Bson::BsonBinaryWriter::Close)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x3ebe868;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Bson::BsonBinaryWriter::*)(::Newtonsoft::Json::Bson::BsonToken*)>(&::Newtonsoft::Json::Bson::BsonBinaryWriter::WriteToken)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x3ebe888;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Bson::BsonBinaryWriter::*)(::Newtonsoft::Json::Bson::BsonToken*)>(&::Newtonsoft::Json::Bson::BsonBinaryWriter::WriteTokenInternal)> {
  constexpr static std::size_t size = 0xec4;
  constexpr static std::size_t addrs = 0x3ebf158;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Bson::BsonBinaryWriter::*)(::StringW, int32_t, ::System::Nullable_1<int32_t>)>(&::Newtonsoft::Json::Bson::BsonBinaryWriter::WriteString)> {
  constexpr static std::size_t size = 0xa4;
  constexpr static std::size_t addrs = 0x3ec00ac;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "WriteString",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Nullable_1<int32_t>>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Bson::BsonBinaryWriter::*)(::StringW, int32_t)>(&::Newtonsoft::Json::Bson::BsonBinaryWriter::WriteUtf8Bytes)> {
  constexpr static std::size_t size = 0x168;
  constexpr static std::size_t addrs = 0x3ec01e0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Newtonsoft::Json::Bson::BsonBinaryWriter::*)(int32_t)>(&::Newtonsoft::Json::Bson::BsonBinaryWriter::CalculateSize)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3ec0348;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Newtonsoft::Json::Bson::BsonBinaryWriter::*)(int32_t, bool)>(&::Newtonsoft::Json::Bson::BsonBinaryWriter::CalculateSizeWithLength)> {
  constexpr static std::size_t size = 0x14;
  constexpr static std::size_t addrs = 0x3ec0350;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Newtonsoft::Json::Bson::BsonBinaryWriter::*)(::Newtonsoft::Json::Bson::BsonToken*)>(&::Newtonsoft::Json::Bson::BsonBinaryWriter::CalculateSize)> {
  constexpr static std::size_t size = 0x8a8;
  constexpr static std::size_t addrs = 0x3ebe8b0;
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::BinaryWriter*> const& Newtonsoft::Json::Bson::BsonBinaryWriter::__cordl_internal_get__writer() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____writer;
}
...
constexpr ::ArrayW<uint8_t,::Array<uint8_t>*>& Newtonsoft::Json::Bson::BsonBinaryWriter::__cordl_internal_get__largeByteBuffer()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____largeByteBuffer;
}
constexpr ::ArrayW<uint8_t,::Array<uint8_t>*> const& Newtonsoft::Json::Bson::BsonBinaryWriter::__cordl_internal_get__largeByteBuffer() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____largeByteBuffer;
}
constexpr void Newtonsoft::Json::Bson::BsonBinaryWriter::__cordl_internal_set__largeByteBuffer(::ArrayW<uint8_t,::Array<uint8_t>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Newtonsoft::Json::Bson::BsonBinaryWriter*>(writer));
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, s, byteCount, calculatedlengthPrefix);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, s, byteCount);
}
...
return ::cordl_internals::RunMethodRethrow<int32_t, false>(this, ___internal_method, stringByteCount);
}
...
return ::cordl_internals::RunMethodRethrow<int32_t, false>(this, ___internal_method, stringByteCount, includeSize);
}
