...
/// @brief Method .ctor, addr 0x3ec03e0, size 0xdc, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method get_Value, addr 0x3ec03d8, size 0x8, virtual false, abstract: false, final false
