...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::__DefaultJsonNameTable__Entry::*)(::StringW, int32_t, ::Newtonsoft::Json::__DefaultJsonNameTable__Entry*)>(&::Newtonsoft::Json::__DefaultJsonNameTable__Entry::_ctor)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x3de6d04;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::__DefaultJsonNameTable__Entry*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Newtonsoft::Json::__DefaultJsonNameTable__Entry*>::get()}
                    )));
...
inline ::Newtonsoft::Json::__DefaultJsonNameTable__Entry* Newtonsoft::Json::__DefaultJsonNameTable__Entry::New_ctor(::StringW  value, int32_t  hashCode, ::Newtonsoft::Json::__DefaultJsonNameTable__Entry*  next)  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::DefaultJsonNameTable::*)()>(&::Newtonsoft::Json::DefaultJsonNameTable::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3de6788;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::DefaultJsonNameTable*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::Newtonsoft::Json::DefaultJsonNameTable::*)(::ArrayW<char16_t,::Array<char16_t>*>, int32_t, int32_t)>(&::Newtonsoft::Json::DefaultJsonNameTable::Get)> {
  constexpr static std::size_t size = 0x194;
  constexpr static std::size_t addrs = 0x3de67f8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::Newtonsoft::Json::DefaultJsonNameTable::*)(::StringW)>(&::Newtonsoft::Json::DefaultJsonNameTable::Add)> {
  ...
  constexpr static std::size_t addrs = 0x3de6a48;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::Newtonsoft::Json::DefaultJsonNameTable::*)(::StringW, int32_t)>(&::Newtonsoft::Json::DefaultJsonNameTable::AddEntry)> {
  constexpr static std::size_t size = 0x108;
  constexpr static std::size_t addrs = 0x3de6bfc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::DefaultJsonNameTable::*)()>(&::Newtonsoft::Json::DefaultJsonNameTable::Grow)> {
  ...
  constexpr static std::size_t addrs = 0x3de6d44;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::StringW, ::ArrayW<char16_t,::Array<char16_t>*>, int32_t, int32_t)>(&::Newtonsoft::Json::DefaultJsonNameTable::TextEquals)> {
  constexpr static std::size_t size = 0xbc;
  constexpr static std::size_t addrs = 0x3de698c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "TextEquals",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 4>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<char16_t,::Array<char16_t>*>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                    )));
    return ___internal_method;
  }
};
...
constexpr ::ArrayW<::Newtonsoft::Json::__DefaultJsonNameTable__Entry*,::Array<::Newtonsoft::Json::__DefaultJsonNameTable__Entry*>*>& Newtonsoft::Json::DefaultJsonNameTable::__cordl_internal_get__entries()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____entries;
}
constexpr ::ArrayW<::Newtonsoft::Json::__DefaultJsonNameTable__Entry*,::Array<::Newtonsoft::Json::__DefaultJsonNameTable__Entry*>*> const& Newtonsoft::Json::DefaultJsonNameTable::__cordl_internal_get__entries() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____entries;
}
constexpr void Newtonsoft::Json::DefaultJsonNameTable::__cordl_internal_set__entries(::ArrayW<::Newtonsoft::Json::__DefaultJsonNameTable__Entry*,::Array<::Newtonsoft::Json::__DefaultJsonNameTable__Entry*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
::cordl_internals::setStaticField<int32_t, "HashCodeRandomizer", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::DefaultJsonNameTable*>::get>(std::forward<int32_t>(value));
}
