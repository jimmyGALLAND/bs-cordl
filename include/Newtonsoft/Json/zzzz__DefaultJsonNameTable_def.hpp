...
/// @brief Method .ctor, addr 0x3de6d04, size 0x40, virtual false, abstract: false, final false
...
/// @brief Field _entries, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__entries, put=__cordl_internal_set__entries)) ::ArrayW<::Newtonsoft::Json::__DefaultJsonNameTable__Entry*,::Array<::Newtonsoft::Json::__DefaultJsonNameTable__Entry*>*>  _entries;
...
/// @brief Method Add, addr 0x3de6a48, size 0x1b4, virtual false, abstract: false, final false
inline ::StringW Add(::StringW  key) ;

/// @brief Method AddEntry, addr 0x3de6bfc, size 0x108, virtual false, abstract: false, final false
inline ::StringW AddEntry(::StringW  str, int32_t  hashCode) ;

/// @brief Method Get, addr 0x3de67f8, size 0x194, virtual true, abstract: false, final false
inline ::StringW Get(::ArrayW<char16_t,::Array<char16_t>*>  key, int32_t  start, int32_t  length) ;

/// @brief Method Grow, addr 0x3de6d44, size 0x12c, virtual false, abstract: false, final false
inline void Grow() ;

static inline ::Newtonsoft::Json::DefaultJsonNameTable* New_ctor() ;

/// @brief Method TextEquals, addr 0x3de698c, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3de6788, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
