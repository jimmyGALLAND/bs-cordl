...
class __StringUtils____c__DisplayClass14_0_1;
}
...
template<typename TSource>
using __c__DisplayClass14_0_1 = ::Newtonsoft::Json::Utilities::__StringUtils____c__DisplayClass14_0_1<TSource>;

/// @brief Method CreateStringWriter, addr 0x3e46fec, size 0xc8, virtual false, abstract: false, final false
static inline ::System::IO::StringWriter* CreateStringWriter(int32_t  capacity) ;

/// @brief Method EndsWith, addr 0x3e477fc, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method FormatWith, addr 0x3e46a68, size 0xa8, virtual false, abstract: false, final false
static inline ::StringW FormatWith(::StringW  format, ::System::IFormatProvider*  provider, ::System::Object*  arg0) ;

/// @brief Method FormatWith, addr 0x3e46b7c, size 0xdc, virtual false, abstract: false, final false
static inline ::StringW FormatWith(::StringW  format, ::System::IFormatProvider*  provider, ::System::Object*  arg0, ::System::Object*  arg1) ;

/// @brief Method FormatWith, addr 0x3e46c58, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method FormatWith, addr 0x3e46d60, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method FormatWith, addr 0x3e46b10, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method IndexOf, addr 0x3e47790, size 0x14, virtual false, abstract: false, final false
static inline int32_t IndexOf(::StringW  s, char16_t  c) ;

/// @brief Method IsHighSurrogate, addr 0x3e476e0, size 0x58, virtual false, abstract: false, final false
static inline bool IsHighSurrogate(char16_t  c) ;

/// @brief Method IsLowSurrogate, addr 0x3e47738, size 0x58, virtual false, abstract: false, final false
static inline bool IsLowSurrogate(char16_t  c) ;

/// @brief Method IsNullOrEmpty, addr 0x3e46a60, size 0x8, virtual false, abstract: false, final false
static inline bool IsNullOrEmpty(::StringW  value) ;

/// @brief Method IsWhiteSpace, addr 0x3e46ee8, size 0x104, virtual false, abstract: false, final false
static inline bool IsWhiteSpace(::StringW  s) ;

/// @brief Method Replace, addr 0x3e477a4, size 0x14, virtual false, abstract: false, final false
static inline ::StringW Replace(::StringW  s, ::StringW  oldValue, ::StringW  newValue) ;

/// @brief Method StartsWith, addr 0x3e477b8, size 0x44, virtual false, abstract: false, final false
static inline bool StartsWith(::StringW  source, char16_t  value) ;

/// @brief Method ToCamelCase, addr 0x3e47170, size 0x1e8, virtual false, abstract: false, final false
static inline ::StringW ToCamelCase(::StringW  s) ;

/// @brief Method ToCharAsUnicode, addr 0x3e470b4, size 0xbc, virtual false, abstract: false, final false
static inline void ToCharAsUnicode(char16_t  c, ::ArrayW<char16_t,::Array<char16_t>*>  buffer) ;

/// @brief Method ToKebabCase, addr 0x3e476d8, size 0x8, virtual false, abstract: false, final false
static inline ::StringW ToKebabCase(::StringW  s) ;

/// @brief Method ToLower, addr 0x3e47358, size 0x90, virtual false, abstract: false, final false
static inline char16_t ToLower(char16_t  c) ;

/// @brief Method ToSeparatedCase, addr 0x3e473f0, size 0x2e8, virtual false, abstract: false, final false
static inline ::StringW ToSeparatedCase(::StringW  s, char16_t  separator) ;

/// @brief Method ToSnakeCase, addr 0x3e473e8, size 0x8, virtual false, abstract: false, final false
static inline ::StringW ToSnakeCase(::StringW  s) ;

/// @brief Method Trim, addr 0x3e4783c, size 0x1b4, virtual false, abstract: false, final false
