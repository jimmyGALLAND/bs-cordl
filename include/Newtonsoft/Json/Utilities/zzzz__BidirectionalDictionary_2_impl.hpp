...
template<typename TFirst,typename TSecond>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IDictionary_2<TFirst,TSecond>*> const& Newtonsoft::Json::Utilities::BidirectionalDictionary_2<TFirst,TSecond>::__cordl_internal_get__firstToSecond() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____firstToSecond;
}
template<typename TFirst,typename TSecond>
...
template<typename TFirst,typename TSecond>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IDictionary_2<TSecond,TFirst>*> const& Newtonsoft::Json::Utilities::BidirectionalDictionary_2<TFirst,TSecond>::__cordl_internal_get__secondToFirst() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____secondToFirst;
}
template<typename TFirst,typename TSecond>
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::IEqualityComparer_1<TFirst>*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::IEqualityComparer_1<TSecond>*>::get()}
                    )));
