...
/// @brief Method Append, addr 0x3e46704, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method Append, addr 0x3e46624, size 0x78, virtual false, abstract: false, final false
inline void Append(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool, char16_t  value) ;

/// @brief Method Clear, addr 0x3e46784, size 0x30, virtual false, abstract: false, final false
inline void Clear(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool) ;

/// @brief Method EnsureSize, addr 0x3e4669c, size 0x68, virtual false, abstract: false, final false
inline void EnsureSize(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool, int32_t  appendLength) ;

/// @brief Method ToString, addr 0x3e467b4, size 0x18, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x3e467cc, size 0x1c, virtual false, abstract: false, final false
inline ::StringW ToString(int32_t  start, int32_t  length) ;

/// @brief Method .ctor, addr 0x3e46618, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<char16_t,::Array<char16_t>*>  buffer) ;

/// @brief Method .ctor, addr 0x3e465f0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool, int32_t  initalSize) ;

/// @brief Method get_InternalBuffer, addr 0x3e467e8, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<char16_t,::Array<char16_t>*> get_InternalBuffer() ;

/// @brief Method get_IsEmpty, addr 0x3e465e0, size 0x10, virtual false, abstract: false, final false
inline bool get_IsEmpty() ;

/// @brief Method get_Position, addr 0x3e465d0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Position() ;

/// @brief Method set_Position, addr 0x3e465d8, size 0x8, virtual false, abstract: false, final false
