...
/// @brief Method MoveNext, addr 0x3e2de84, size 0x3e8, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3e2e26c, size 0x68, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::Newtonsoft::Json::Utilities::Base64Encoder*", modifiers: "", def_value: None }, CppParam { name: "buffer", ty: "::ArrayW<uint8_t,::Array<uint8_t>*>", modifiers: "", def_value: None }, CppParam { name: "index", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "count", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "_num4_5__2", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_length_5__3", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter", modifiers: "", def_value: None }]
constexpr __Base64Encoder___EncodeAsync_d__13(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::Newtonsoft::Json::Utilities::Base64Encoder*  __4__this, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count, ::System::Threading::CancellationToken  cancellationToken, int32_t  _num4_5__2, int32_t  _length_5__3, ::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter  __u__1) noexcept;
...
/// @brief Method Encode, addr 0x3e2d794, size 0x1a0, virtual false, abstract: false, final false
inline void Encode(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method EncodeAsync, addr 0x3e2dbd0, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method Flush, addr 0x3e2db18, size 0xb8, virtual false, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushAsync, addr 0x3e2dd4c, size 0x138, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method FulfillFromLeftover, addr 0x3e2d934, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method StoreLeftOverBytes, addr 0x3e2d9f4, size 0x124, virtual false, abstract: false, final false
inline void StoreLeftOverBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, ByRef<int32_t>  count) ;

/// @brief Method ValidateEncode, addr 0x3e2d6d0, size 0xc4, virtual false, abstract: false, final false
inline void ValidateEncode(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteChars, addr 0x3e2d9d0, size 0x24, virtual false, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  index, int32_t  count) ;

/// @brief Method WriteCharsAsync, addr 0x3e2dcc4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3e2d640, size 0x90, virtual false, abstract: false, final false
