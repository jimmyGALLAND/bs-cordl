...
/// @brief Method .ctor, addr 0x3a20180, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::ENet::ENetEvent  event) ;

/// @brief Method get_ChannelID, addr 0x3a20208, size 0x8, virtual false, abstract: false, final false
inline uint8_t get_ChannelID() ;

/// @brief Method get_Data, addr 0x3a20210, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_Data() ;

/// @brief Method get_NativeData, addr 0x3a20168, size 0xc, virtual false, abstract: false, final false
inline ::ENet::ENetEvent get_NativeData() ;

/// @brief Method get_Packet, addr 0x3a20218, size 0x8, virtual false, abstract: false, final false
inline ::ENet::Packet get_Packet() ;

/// @brief Method get_Peer, addr 0x3a20194, size 0x38, virtual false, abstract: false, final false
inline ::ENet::Peer get_Peer() ;

/// @brief Method get_Type, addr 0x3a2018c, size 0x8, virtual false, abstract: false, final false
inline ::ENet::EventType get_Type() ;

/// @brief Method set_NativeData, addr 0x3a20174, size 0xc, virtual false, abstract: false, final false
