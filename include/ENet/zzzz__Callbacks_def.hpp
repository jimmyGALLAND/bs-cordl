...
/// @brief Method .ctor, addr 0x3a20248, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::ENet::AllocCallback*  allocCallback, ::ENet::FreeCallback*  freeCallback, ::ENet::NoMemoryCallback*  noMemoryCallback) ;

/// @brief Method get_NativeData, addr 0x3a20220, size 0x14, virtual false, abstract: false, final false
inline ::ENet::ENetCallbacks get_NativeData() ;

/// @brief Method set_NativeData, addr 0x3a20234, size 0x14, virtual false, abstract: false, final false
