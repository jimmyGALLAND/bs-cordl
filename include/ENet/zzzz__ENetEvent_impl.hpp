...
// Ctor Parameters [CppParam { name: "type", ty: "::ENet::EventType", modifiers: "", def_value: Some("{}") }, CppParam { name: "peer", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}") }, CppParam { name: "channelID", ty: "uint8_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "data", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "packet", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}") }]
