...
// Ctor Parameters [CppParam { name: "malloc", ty: "::ENet::AllocCallback*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "free", ty: "::ENet::FreeCallback*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "noMemory", ty: "::ENet::NoMemoryCallback*", modifiers: "", def_value: Some("nullptr") }]
