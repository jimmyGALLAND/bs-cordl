...
public:
// Declarations
/// @brief Method CRC64, addr 0x3a23fc4, size 0x4, virtual false, abstract: false, final false
static inline uint64_t CRC64(::System::IntPtr  buffers, int32_t  bufferCount) ;

/// @brief Method Deinitialize, addr 0x3a23f5c, size 0x4, virtual false, abstract: false, final false
static inline void Deinitialize() ;

/// @brief Method InitOpenSSL, addr 0x3a23b18, size 0x24, virtual false, abstract: false, final false
static inline void InitOpenSSL() ;

/// @brief Method Initialize, addr 0x3a23c40, size 0x90, virtual false, abstract: false, final false
static inline bool Initialize() ;

/// @brief Method Initialize, addr 0x3a23da0, size 0xf8, virtual false, abstract: false, final false
static inline bool Initialize(::ENet::Callbacks*  callbacks) ;

/// @brief Method get_Time, addr 0x3a23aac, size 0x4, virtual false, abstract: false, final false
