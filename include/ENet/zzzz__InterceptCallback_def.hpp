...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x3a1f734, size 0x120, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x3a1f854, size 0x34, virtual true, abstract: false, final false
inline int32_t EndInvoke(ByRef<::ENet::Event>  event, ByRef<::ENet::Address>  address, ::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x3a1f720, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a1f680, size 0xa0, virtual false, abstract: false, final false
