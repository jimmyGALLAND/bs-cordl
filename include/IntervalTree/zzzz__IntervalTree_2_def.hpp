...
namespace IntervalTree {
template<typename TKey,typename TValue>
class __IntervalTree_2____c__DisplayClass19_0;
}
namespace IntervalTree {
template<typename TKey,typename TValue>
class __IntervalTree_2____c__DisplayClass20_0;
}
namespace IntervalTree {
template<typename TKey,typename TValue>
class __IntervalTree_2____c__DisplayClass23_0;
}
namespace IntervalTree {
template<typename TKey,typename TValue>
class __IntervalTree_2____c__DisplayClass24_0;
}
namespace IntervalTree {
template<typename TKey,typename TValue>
class __IntervalTree_2____c;
}
...
constexpr ::System::Collections::Generic::IEnumerable_1<::IntervalTree::RangeValuePair_2<TKey,TValue>>* i___System__Collections__Generic__IEnumerable_1___IntervalTree__RangeValuePair_2_TKey_TValue__() noexcept;
