...
/// @brief Field items, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_items, put=__cordl_internal_set_items)) ::ArrayW<::IntervalTree::RangeValuePair_2<TKey,TValue>,::Array<::IntervalTree::RangeValuePair_2<TKey,TValue>>*>  items;
...
constexpr ::System::Collections::Generic::IComparer_1<::IntervalTree::RangeValuePair_2<TKey,TValue>>* i___System__Collections__Generic__IComparer_1___IntervalTree__RangeValuePair_2_TKey_TValue__() noexcept;
