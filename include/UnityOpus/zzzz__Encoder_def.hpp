...
/// @brief Method Dispose, addr 0x3a2808c, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x3a27f30, size 0x40, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Encode, addr 0x3a27e00, size 0x74, virtual false, abstract: false, final false
inline int32_t Encode(::ArrayW<float_t,::Array<float_t>*>  pcm, int32_t  count, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method Finalize, addr 0x3a27fec, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a27c54, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method get_Bitrate, addr 0x3a27a38, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Bitrate() ;

/// @brief Method get_Complexity, addr 0x3a27aec, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Complexity() ;

/// @brief Method get_Signal, addr 0x3a27ba0, size 0x8, virtual false, abstract: false, final false
inline ::UnityOpus::OpusSignal get_Signal() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_Bitrate, addr 0x3a27a40, size 0x28, virtual false, abstract: false, final false
inline void set_Bitrate(int32_t  value) ;

/// @brief Method set_Complexity, addr 0x3a27af4, size 0x28, virtual false, abstract: false, final false
inline void set_Complexity(int32_t  value) ;

/// @brief Method set_Signal, addr 0x3a27ba8, size 0x28, virtual false, abstract: false, final false
