...
/// @brief Method <LoadResourcesBeforeInstall>b__3_0, addr 0x26c94dc, size 0x18, virtual false, abstract: false, final false
inline int32_t _LoadResourcesBeforeInstall_b__3_0(::GlobalNamespace::ColorSchemeSO*  colorScheme) ;

/// @brief Method .ctor, addr 0x26c94d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _colorSchemes, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__colorSchemes, put=__cordl_internal_set__colorSchemes)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::ColorSchemeSO>>*  _colorSchemes;

 __declspec(property(get=get_assetLabelRuntimeKey)) ::StringW  assetLabelRuntimeKey;

/// @brief Method InstallBindings, addr 0x26c9338, size 0xb0, virtual true, abstract: false, final false
inline void InstallBindings() ;

/// @brief Method LoadResourcesBeforeInstall, addr 0x26c9214, size 0x124, virtual true, abstract: false, final false
inline void LoadResourcesBeforeInstall(::System::Collections::Generic::IList_1<::UnityW<::GlobalNamespace::ColorSchemeSO>>*  colorSchemes, ::BGLib::AppFlow::Initialization::__AsyncInstaller__IInstallerRegistry*  registry) ;
...
/// @brief Method .ctor, addr 0x26c93e8, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_assetLabelRuntimeKey, addr 0x26c91d4, size 0x40, virtual true, abstract: false, final false
