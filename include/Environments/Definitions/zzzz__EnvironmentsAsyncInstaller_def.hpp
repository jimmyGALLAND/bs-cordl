...
/// @brief Method <LoadResourcesBeforeInstall>b__3_0, addr 0x26c9880, size 0x18, virtual false, abstract: false, final false
inline int32_t _LoadResourcesBeforeInstall_b__3_0(::GlobalNamespace::EnvironmentInfoSO*  environmentInfo) ;

/// @brief Method .ctor, addr 0x26c9878, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _environmentInfos, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__environmentInfos, put=__cordl_internal_set__environmentInfos)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*  _environmentInfos;

 __declspec(property(get=get_assetLabelRuntimeKey)) ::StringW  assetLabelRuntimeKey;

/// @brief Method InstallBindings, addr 0x26c9658, size 0xb0, virtual true, abstract: false, final false
inline void InstallBindings() ;

/// @brief Method LoadEnvironmentInfoListAsync, addr 0x26c9708, size 0x84, virtual false, abstract: false, final false
static inline ::System::Nullable_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::System::Collections::Generic::IList_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*>> LoadEnvironmentInfoListAsync() ;

/// @brief Method LoadResourcesBeforeInstall, addr 0x26c9534, size 0x124, virtual true, abstract: false, final false
inline void LoadResourcesBeforeInstall(::System::Collections::Generic::IList_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*  environmentInfos, ::BGLib::AppFlow::Initialization::__AsyncInstaller__IInstallerRegistry*  registry) ;
...
/// @brief Method .ctor, addr 0x26c978c, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_assetLabelRuntimeKey, addr 0x26c94f4, size 0x40, virtual true, abstract: false, final false
