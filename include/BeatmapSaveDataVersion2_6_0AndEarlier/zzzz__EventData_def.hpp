...
/// @brief Method .ctor, addr 0x26bd55c, size 0x44, virtual false, abstract: false, final false
inline void _ctor(float_t  time, ::BeatmapSaveDataCommon::BeatmapEventType  type, int32_t  value, float_t  floatValue) ;

/// @brief Method get_floatValue, addr 0x26bd5b8, size 0x8, virtual false, abstract: false, final false
inline float_t get_floatValue() ;

/// @brief Method get_time, addr 0x26bd5a0, size 0x8, virtual true, abstract: false, final false
inline float_t get_time() ;

/// @brief Method get_type, addr 0x26bd5a8, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::BeatmapEventType get_type() ;

/// @brief Method get_value, addr 0x26bd5b0, size 0x8, virtual false, abstract: false, final false
