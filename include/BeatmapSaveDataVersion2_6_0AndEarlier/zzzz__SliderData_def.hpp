...
/// @brief Method .ctor, addr 0x26bd70c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(::BeatmapSaveDataVersion2_6_0AndEarlier::ColorType  colorType, float_t  headTime, int32_t  headLineIndex, ::BeatmapSaveDataCommon::NoteLineLayer  headLineLayer, float_t  headControlPointLengthMultiplier, ::BeatmapSaveDataCommon::NoteCutDirection  headCutDirection, float_t  tailTime, int32_t  tailLineIndex, ::BeatmapSaveDataCommon::NoteLineLayer  tailLineLayer, float_t  tailControlPointLengthMultiplier, ::BeatmapSaveDataCommon::NoteCutDirection  tailCutDirection, ::BeatmapSaveDataCommon::SliderMidAnchorMode  sliderMidAnchorMode) ;

/// @brief Method get_colorType, addr 0x26bd6b4, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataVersion2_6_0AndEarlier::ColorType get_colorType() ;

/// @brief Method get_headControlPointLengthMultiplier, addr 0x26bd6cc, size 0x8, virtual false, abstract: false, final false
inline float_t get_headControlPointLengthMultiplier() ;

/// @brief Method get_headCutDirection, addr 0x26bd6d4, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::NoteCutDirection get_headCutDirection() ;

/// @brief Method get_headLineIndex, addr 0x26bd6bc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_headLineIndex() ;

/// @brief Method get_headLineLayer, addr 0x26bd6c4, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::NoteLineLayer get_headLineLayer() ;

/// @brief Method get_sliderMidAnchorMode, addr 0x26bd704, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::SliderMidAnchorMode get_sliderMidAnchorMode() ;

/// @brief Method get_tailControlPointLengthMultiplier, addr 0x26bd6f4, size 0x8, virtual false, abstract: false, final false
inline float_t get_tailControlPointLengthMultiplier() ;

/// @brief Method get_tailCutDirection, addr 0x26bd6fc, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::NoteCutDirection get_tailCutDirection() ;

/// @brief Method get_tailLineIndex, addr 0x26bd6e4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_tailLineIndex() ;

/// @brief Method get_tailLineLayer, addr 0x26bd6ec, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::NoteLineLayer get_tailLineLayer() ;

/// @brief Method get_tailTime, addr 0x26bd6dc, size 0x8, virtual false, abstract: false, final false
inline float_t get_tailTime() ;

/// @brief Method get_time, addr 0x26bd6ac, size 0x8, virtual true, abstract: false, final false
