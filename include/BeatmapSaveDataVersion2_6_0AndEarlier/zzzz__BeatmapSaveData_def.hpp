...
/// @brief Field _obstacles, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__obstacles, put=__cordl_internal_set__obstacles)) ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleData*>*  _obstacles;
...
/// @brief Field _specialEventsKeywordFilters, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__specialEventsKeywordFilters, put=__cordl_internal_set__specialEventsKeywordFilters)) ::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventKeywordFiltersData*  _specialEventsKeywordFilters;
...
/// @brief Field _waypoints, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__waypoints, put=__cordl_internal_set__waypoints)) ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::WaypointData*>*  _waypoints;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleData*>*> const& __cordl_internal_get__obstacles() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::SliderData*>*> const& __cordl_internal_get__sliders() const;
...
constexpr ::cordl_internals::to_const_pointer<::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventKeywordFiltersData*> const& __cordl_internal_get__specialEventsKeywordFilters() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::WaypointData*>*> const& __cordl_internal_get__waypoints() const;
...
/// @brief Method .ctor, addr 0x26bd190, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::EventData*>*  events, ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::NoteData*>*  notes, ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::SliderData*>*  sliders, ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::WaypointData*>*  waypoints, ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleData*>*  obstacles, ::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventKeywordFiltersData*  specialEventsKeywordFilters) ;

/// @brief Method get_events, addr 0x26bd160, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::EventData*>* get_events() ;

/// @brief Method get_notes, addr 0x26bd168, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::NoteData*>* get_notes() ;

/// @brief Method get_obstacles, addr 0x26bd180, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleData*>* get_obstacles() ;

/// @brief Method get_sliders, addr 0x26bd170, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::BeatmapSaveDataVersion2_6_0AndEarlier::SliderData*>* get_sliders() ;

/// @brief Method get_specialEventsKeywordFilters, addr 0x26bd188, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventKeywordFiltersData* get_specialEventsKeywordFilters() ;

/// @brief Method get_version, addr 0x26bd158, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_version() ;

/// @brief Method get_waypoints, addr 0x26bd178, size 0x8, virtual false, abstract: false, final false
