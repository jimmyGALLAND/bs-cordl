...
static inline ::BeatmapSaveDataVersion2_6_0AndEarlier::WaypointData* New_ctor(float_t  time, int32_t  lineIndex, ::BeatmapSaveDataCommon::NoteLineLayer  lineLayer, ::BeatmapSaveDataCommon::OffsetDirection  offsetDirection) ;
...
/// @brief Method .ctor, addr 0x26bd660, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method get_lineIndex, addr 0x26bd648, size 0x8, virtual false, abstract: false, final false
inline int32_t get_lineIndex() ;

/// @brief Method get_lineLayer, addr 0x26bd650, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::NoteLineLayer get_lineLayer() ;

/// @brief Method get_offsetDirection, addr 0x26bd658, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::OffsetDirection get_offsetDirection() ;

/// @brief Method get_time, addr 0x26bd640, size 0x8, virtual true, abstract: false, final false
