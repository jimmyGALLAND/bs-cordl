...
/// @brief Method .ctor, addr 0x26bd5c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_beat, addr 0x26bd824, size 0xc, virtual true, abstract: false, final true
