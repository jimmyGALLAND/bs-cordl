...
/// @brief Field _specialEvents, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__specialEvents, put=__cordl_internal_set__specialEvents)) ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>*  _specialEvents;
...
static inline ::BeatmapSaveDataVersion2_6_0AndEarlier::SpecialEventsForKeyword* New_ctor(::StringW  keyword, ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>*  specialEvents) ;
...
/// @brief Method .ctor, addr 0x26bd870, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  keyword, ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>*  specialEvents) ;

/// @brief Method get_keyword, addr 0x26bd860, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_keyword() ;

/// @brief Method get_specialEvents, addr 0x26bd868, size 0x8, virtual false, abstract: false, final false
