...
/// @brief Method .ctor, addr 0x26bd7d0, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method get_duration, addr 0x26bd7c0, size 0x8, virtual false, abstract: false, final false
inline float_t get_duration() ;

/// @brief Method get_lineIndex, addr 0x26bd7b0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_lineIndex() ;

/// @brief Method get_time, addr 0x26bd7a8, size 0x8, virtual true, abstract: false, final false
inline float_t get_time() ;

/// @brief Method get_type, addr 0x26bd7b8, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataVersion2_6_0AndEarlier::ObstacleType get_type() ;

/// @brief Method get_width, addr 0x26bd7c8, size 0x8, virtual false, abstract: false, final false
