...
static inline ::BeatmapSaveDataVersion2_6_0AndEarlier::NoteData* New_ctor(float_t  time, int32_t  lineIndex, ::BeatmapSaveDataCommon::NoteLineLayer  lineLayer, ::BeatmapSaveDataVersion2_6_0AndEarlier::NoteType  type, ::BeatmapSaveDataCommon::NoteCutDirection  cutDirection) ;
...
/// @brief Method .ctor, addr 0x26bd5f0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(float_t  time, int32_t  lineIndex, ::BeatmapSaveDataCommon::NoteLineLayer  lineLayer, ::BeatmapSaveDataVersion2_6_0AndEarlier::NoteType  type, ::BeatmapSaveDataCommon::NoteCutDirection  cutDirection) ;

/// @brief Method get_cutDirection, addr 0x26bd5e8, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::NoteCutDirection get_cutDirection() ;

/// @brief Method get_lineIndex, addr 0x26bd5d0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_lineIndex() ;

/// @brief Method get_lineLayer, addr 0x26bd5d8, size 0x8, virtual false, abstract: false, final false
inline ::BeatmapSaveDataCommon::NoteLineLayer get_lineLayer() ;

/// @brief Method get_time, addr 0x26bd5c8, size 0x8, virtual true, abstract: false, final false
inline float_t get_time() ;

/// @brief Method get_type, addr 0x26bd5e0, size 0x8, virtual false, abstract: false, final false
