...
/// @brief Method CreateFromFile, addr 0x3bbf6b8, size 0x8, virtual false, abstract: false, final false
static inline ::Mono::Security::Authenticode::PrivateKey* CreateFromFile(::StringW  filename) ;

/// @brief Method CreateFromFile, addr 0x3bbf6c0, size 0x2ac, virtual false, abstract: false, final false
static inline ::Mono::Security::Authenticode::PrivateKey* CreateFromFile(::StringW  filename, ::StringW  password) ;

/// @brief Method Decode, addr 0x3bbf14c, size 0x44c, virtual false, abstract: false, final false
inline bool Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  pvk, ::StringW  password) ;

/// @brief Method DeriveKey, addr 0x3bbf5a0, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3bbf074, size 0xd8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  data, ::StringW  password) ;

/// @brief Method get_RSA, addr 0x3bbf598, size 0x8, virtual false, abstract: false, final false
