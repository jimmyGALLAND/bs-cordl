...
/// @brief Method CheckSignature, addr 0x3bbd85c, size 0x2f4, virtual false, abstract: false, final false
inline bool CheckSignature() ;

/// @brief Method CompareIssuerSerial, addr 0x3bbe58c, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x3bbd7b8, size 0xa4, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method VerifyCounterSignature, addr 0x3bbe688, size 0x9ec, virtual false, abstract: false, final false
inline bool VerifyCounterSignature(::Mono::Security::__PKCS7__SignerInfo*  cs, ::ArrayW<uint8_t,::Array<uint8_t>*>  signature) ;

/// @brief Method VerifySignature, addr 0x3bbdb58, size 0xa34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3bbd640, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3bbd6c0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  rawData) ;

/// @brief Method get_SigningCertificate, addr 0x3bbdb50, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* get_SigningCertificate() ;

/// @brief Method set_RawData, addr 0x3bbd6e8, size 0xd0, virtual false, abstract: false, final false
