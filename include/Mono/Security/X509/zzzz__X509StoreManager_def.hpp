...
/// @brief Method get_CurrentUser, addr 0x3bb0a38, size 0x98, virtual false, abstract: false, final false
static inline ::Mono::Security::X509::X509Stores* get_CurrentUser() ;

/// @brief Method get_CurrentUserPath, addr 0x3bb0860, size 0xf8, virtual false, abstract: false, final false
static inline ::StringW get_CurrentUserPath() ;

/// @brief Method get_LocalMachine, addr 0x3bb0b00, size 0x98, virtual false, abstract: false, final false
static inline ::Mono::Security::X509::X509Stores* get_LocalMachine() ;

/// @brief Method get_LocalMachinePath, addr 0x3bb0958, size 0xe0, virtual false, abstract: false, final false
static inline ::StringW get_LocalMachinePath() ;

/// @brief Method get_TrustedRootCertificates, addr 0x3baea44, size 0xcc, virtual false, abstract: false, final false
