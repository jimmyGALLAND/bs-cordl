...
/// @brief Method Decode, addr 0x3bafa2c, size 0x4, virtual true, abstract: false, final false
inline void Decode() ;

/// @brief Method Encode, addr 0x3bafa30, size 0x4, virtual true, abstract: false, final false
inline void Encode() ;

/// @brief Method Equals, addr 0x3bafa44, size 0x150, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x3bafb94, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method ToString, addr 0x3bafddc, size 0xd8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method WriteLine, addr 0x3bafbb4, size 0x228, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3baf608, size 0x2b8, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::ASN1*  asn1) ;

/// @brief Method .ctor, addr 0x3baf8c0, size 0x140, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::X509::X509Extension*  extension) ;

/// @brief Method get_Critical, addr 0x3bafa3c, size 0x8, virtual false, abstract: false, final false
inline bool get_Critical() ;

/// @brief Method get_Oid, addr 0x3bafa34, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Oid() ;

/// @brief Method get_Value, addr 0x3bafa00, size 0x2c, virtual false, abstract: false, final false
