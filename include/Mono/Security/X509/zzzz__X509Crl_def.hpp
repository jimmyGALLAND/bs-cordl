...
/// @brief Method .ctor, addr 0x3babb94, size 0xd4, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::ASN1*  entry) ;

/// @brief Method get_Extensions, addr 0x3bac7a8, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509ExtensionCollection* get_Extensions() ;

/// @brief Method get_RevocationDate, addr 0x3bac7a0, size 0x8, virtual false, abstract: false, final false
inline ::System::DateTime get_RevocationDate() ;

/// @brief Method get_SerialNumber, addr 0x3bac21c, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method Compare, addr 0x3babfcc, size 0x90, virtual false, abstract: false, final false
inline bool Compare(::ArrayW<uint8_t,::Array<uint8_t>*>  array1, ::ArrayW<uint8_t,::Array<uint8_t>*>  array2) ;

/// @brief Method GetCrlEntry, addr 0x3bac0d8, size 0x144, virtual false, abstract: false, final false
inline ::Mono::Security::X509::__X509Crl__X509CrlEntry* GetCrlEntry(::ArrayW<uint8_t,::Array<uint8_t>*>  serialNumber) ;

/// @brief Method GetCrlEntry, addr 0x3bac05c, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x3bab540, size 0x654, virtual false, abstract: false, final false
inline void Parse(::ArrayW<uint8_t,::Array<uint8_t>*>  crl) ;

/// @brief Method VerifySignature, addr 0x3bac62c, size 0x174, virtual false, abstract: false, final false
inline bool VerifySignature(::System::Security::Cryptography::AsymmetricAlgorithm*  aa) ;

/// @brief Method VerifySignature, addr 0x3bac294, size 0x2c4, virtual false, abstract: false, final false
inline bool VerifySignature(::System::Security::Cryptography::DSA*  dsa) ;

/// @brief Method VerifySignature, addr 0x3bac558, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3bab44c, size 0xf4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  crl) ;

/// @brief Method get_Extensions, addr 0x3babd9c, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509ExtensionCollection* get_Extensions() ;

/// @brief Method get_Hash, addr 0x3babda4, size 0x218, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Hash() ;

/// @brief Method get_IssuerName, addr 0x3babfbc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_IssuerName() ;

/// @brief Method get_NextUpdate, addr 0x3babfc4, size 0x8, virtual false, abstract: false, final false
