...
/// @brief Method BuildCertificatesCollection, addr 0x3bb0080, size 0x1dc, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509CertificateCollection* BuildCertificatesCollection(::StringW  storeName) ;

/// @brief Method BuildCrlsCollection, addr 0x3bb02e4, size 0x1c8, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* BuildCrlsCollection(::StringW  storeName) ;

/// @brief Method CheckStore, addr 0x3bb0784, size 0xdc, virtual false, abstract: false, final false
inline bool CheckStore(::StringW  path, bool  throwException) ;

/// @brief Method Load, addr 0x3bb04ac, size 0x208, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Load(::StringW  filename) ;

/// @brief Method LoadCertificate, addr 0x3bb06b4, size 0x68, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* LoadCertificate(::StringW  filename) ;

/// @brief Method LoadCrl, addr 0x3bb071c, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3bb0018, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, bool  crl, bool  newFormat) ;

/// @brief Method get_Certificates, addr 0x3bb0058, size 0x28, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509CertificateCollection* get_Certificates() ;

/// @brief Method get_Crls, addr 0x3bb025c, size 0x88, virtual false, abstract: false, final false
