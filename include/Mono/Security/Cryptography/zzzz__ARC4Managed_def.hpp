...
/// @brief Method CheckInput, addr 0x3bb6264, size 0x144, virtual false, abstract: false, final false
inline void CheckInput(::ArrayW<uint8_t,::Array<uint8_t>*>  inputBuffer, int32_t  inputOffset, int32_t  inputCount) ;

/// @brief Method CreateDecryptor, addr 0x3bb6134, size 0x2c, virtual true, abstract: false, final false
...
/// @brief Method CreateEncryptor, addr 0x3bb6114, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method Dispose, addr 0x3bb5e20, size 0xac, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x3bb5d80, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GenerateIV, addr 0x3bb6160, size 0x5c, virtual true, abstract: false, final false
inline void GenerateIV() ;

/// @brief Method GenerateKey, addr 0x3bb61bc, size 0x20, virtual true, abstract: false, final false
inline void GenerateKey() ;

/// @brief Method InternalTransformBlock, addr 0x3bb650c, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method KeySetup, addr 0x3bb6034, size 0xe0, virtual false, abstract: false, final false
inline void KeySetup(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

static inline ::Mono::Security::Cryptography::ARC4Managed* New_ctor() ;

/// @brief Method TransformBlock, addr 0x3bb63a8, size 0x164, virtual true, abstract: false, final true
...
/// @brief Method TransformFinalBlock, addr 0x3bb663c, size 0x9c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3bb5c84, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CanTransformMultipleBlocks, addr 0x3bb624c, size 0x8, virtual true, abstract: false, final true
inline bool get_CanTransformMultipleBlocks() ;

/// @brief Method get_InputBlockSize, addr 0x3bb6254, size 0x8, virtual true, abstract: false, final true
inline int32_t get_InputBlockSize() ;

/// @brief Method get_Key, addr 0x3bb5ecc, size 0x94, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Key() ;

/// @brief Method get_OutputBlockSize, addr 0x3bb625c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_Key, addr 0x3bb5f60, size 0xd4, virtual true, abstract: false, final false
