...
public:
// Declarations
/// @brief Method Invoke, addr 0x3bd72cc, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3bd71c8, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x3bd6804, size 0x204, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EncryptValue, addr 0x3bd5adc, size 0x108, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncryptValue(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb) ;

/// @brief Method ExportParameters, addr 0x3bd5f6c, size 0x328, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::RSAParameters ExportParameters(bool  includePrivateParameters) ;

/// @brief Method Finalize, addr 0x3bd5008, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GenerateKeyPair, addr 0x3bd50a8, size 0x268, virtual false, abstract: false, final false
inline void GenerateKeyPair() ;

/// @brief Method GetPaddedValue, addr 0x3bd5e6c, size 0xb0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPaddedValue(::Mono::Math::BigInteger*  value, int32_t  length) ;

/// @brief Method ImportParameters, addr 0x3bd63c8, size 0x43c, virtual true, abstract: false, final false
...
/// @brief Method ToXmlString, addr 0x3bd6b40, size 0x688, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3bd4f3c, size 0xcc, virtual false, abstract: false, final false
inline void _ctor(int32_t  keySize) ;

/// @brief Method add_KeyGenerated, addr 0x3bd6a08, size 0x9c, virtual false, abstract: false, final false
inline void add_KeyGenerated(::Mono::Security::Cryptography::__RSAManaged__KeyGeneratedEventHandler*  value) ;

/// @brief Method get_KeySize, addr 0x3bd58f0, size 0x9c, virtual true, abstract: false, final false
inline int32_t get_KeySize() ;

/// @brief Method get_PublicOnly, addr 0x3bd598c, size 0xa0, virtual false, abstract: false, final false
inline bool get_PublicOnly() ;

/// @brief Method remove_KeyGenerated, addr 0x3bd6aa4, size 0x9c, virtual false, abstract: false, final false
