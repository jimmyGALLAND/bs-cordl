...
/// @brief Method Create, addr 0x3bba848, size 0x50, virtual false, abstract: false, final false
static inline ::Mono::Security::Cryptography::RC4* Create() ;

static inline ::Mono::Security::Cryptography::RC4* New_ctor() ;

/// @brief Method .ctor, addr 0x3bb5d04, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_IV, addr 0x3bba800, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method set_IV, addr 0x3bba844, size 0x4, virtual true, abstract: false, final false
