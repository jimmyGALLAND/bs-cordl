...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Mono::Security::Protocol::Ntlm::NtlmAuthLevel (*)()>(&::Mono::Security::Protocol::Ntlm::NtlmSettings::get_DefaultAuthLevel)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x3bb3da8;
