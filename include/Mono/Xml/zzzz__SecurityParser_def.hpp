...
/// @brief Method LoadXml, addr 0x3bc5654, size 0x88, virtual false, abstract: false, final false
inline void LoadXml(::StringW  xml) ;

static inline ::Mono::Xml::SecurityParser* New_ctor() ;

/// @brief Method OnChars, addr 0x3bc5bb8, size 0x80, virtual true, abstract: false, final true
inline void OnChars(::StringW  ch) ;

/// @brief Method OnEndElement, addr 0x3bc5b30, size 0x88, virtual true, abstract: false, final true
inline void OnEndElement(::StringW  name) ;

/// @brief Method OnEndParsing, addr 0x3bc5c38, size 0x4, virtual true, abstract: false, final true
inline void OnEndParsing(::Mono::Xml::SmallXmlParser*  parser) ;

/// @brief Method OnIgnorableWhitespace, addr 0x3bc58b4, size 0x4, virtual true, abstract: false, final true
inline void OnIgnorableWhitespace(::StringW  s) ;

/// @brief Method OnProcessingInstruction, addr 0x3bc58b0, size 0x4, virtual true, abstract: false, final true
inline void OnProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method OnStartElement, addr 0x3bc58b8, size 0x278, virtual true, abstract: false, final true
inline void OnStartElement(::StringW  name, ::Mono::Xml::__SmallXmlParser__IAttrList*  attrs) ;

/// @brief Method OnStartParsing, addr 0x3bc58ac, size 0x4, virtual true, abstract: false, final true
inline void OnStartParsing(::Mono::Xml::SmallXmlParser*  parser) ;

/// @brief Method ToXml, addr 0x3bc58a4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3bc54e8, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
