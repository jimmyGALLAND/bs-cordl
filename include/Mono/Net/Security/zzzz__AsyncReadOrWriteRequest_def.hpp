...
/// @brief Method ToString, addr 0x4080278, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x40801dc, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method get_CurrentSize, addr 0x40801cc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_CurrentSize() ;

/// @brief Method get_UserBuffer, addr 0x40801c4, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Net::Security::BufferOffsetSize* get_UserBuffer() ;

/// @brief Method set_CurrentSize, addr 0x40801d4, size 0x8, virtual false, abstract: false, final false
