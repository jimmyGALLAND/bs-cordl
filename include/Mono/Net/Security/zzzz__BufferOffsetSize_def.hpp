...
/// @brief Method ToString, addr 0x407e4f0, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x407e3f8, size 0xf8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method get_EndOffset, addr 0x407e3c4, size 0xc, virtual false, abstract: false, final false
inline int32_t get_EndOffset() ;

/// @brief Method get_Remaining, addr 0x407e3d0, size 0x28, virtual false, abstract: false, final false
