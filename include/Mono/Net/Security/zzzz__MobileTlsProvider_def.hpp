...
public:
// Declarations
/// @brief Method CreateSslStream, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
...
/// @brief Method .ctor, addr 0x407dd28, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
