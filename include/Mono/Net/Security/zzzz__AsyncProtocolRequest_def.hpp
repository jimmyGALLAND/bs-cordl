...
/// @brief Method MoveNext, addr 0x407ec78, size 0x380, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x407f038, size 0x7c, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x407f0b4, size 0x51c, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x407f844, size 0x68, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method MoveNext, addr 0x407f8ac, size 0x39c, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x407fd60, size 0x7c, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method InnerRead, addr 0x407eb24, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method ProcessOperation, addr 0x407ea4c, size 0xd8, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* ProcessOperation(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method RequestRead, addr 0x407e894, size 0xc4, virtual false, abstract: false, final false
inline void RequestRead(int32_t  size) ;

/// @brief Method RequestWrite, addr 0x407e958, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method StartOperation, addr 0x407e964, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x407ec20, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x407e814, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::Mono::Net::Security::MobileAuthenticatedStream*  parent, bool  sync) ;

/// @brief Method get_Name, addr 0x407e7e0, size 0x24, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Parent, addr 0x407e7d0, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Net::Security::MobileAuthenticatedStream* get_Parent() ;

/// @brief Method get_RunSynchronously, addr 0x407e7d8, size 0x8, virtual false, abstract: false, final false
inline bool get_RunSynchronously() ;

/// @brief Method get_UserResult, addr 0x407e804, size 0x8, virtual false, abstract: false, final false
inline int32_t get_UserResult() ;

/// @brief Method set_UserResult, addr 0x407e80c, size 0x8, virtual false, abstract: false, final false
