...
static __declspec(property(get=getStaticF_providerCache, put=setStaticF_providerCache)) ::System::Collections::Generic::Dictionary_2<::System::Guid,::Mono::Net::Security::MobileTlsProvider*>*  providerCache;

/// @brief Field providerRegistration, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_providerRegistration, put=setStaticF_providerRegistration)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Tuple_2<::System::Guid,::StringW>*>*  providerRegistration;

/// @brief Method CreateDefaultProviderImpl, addr 0x40851bc, size 0x188, virtual false, abstract: false, final false
static inline ::Mono::Net::Security::MobileTlsProvider* CreateDefaultProviderImpl() ;

/// @brief Method GetProvider, addr 0x4085a34, size 0x4c, virtual false, abstract: false, final false
static inline ::Mono::Net::Security::MobileTlsProvider* GetProvider() ;

/// @brief Method GetProviderInternal, addr 0x4080a54, size 0x118, virtual false, abstract: false, final false
static inline ::Mono::Net::Security::MobileTlsProvider* GetProviderInternal() ;

/// @brief Method InitializeInternal, addr 0x4084c34, size 0x398, virtual false, abstract: false, final false
static inline void InitializeInternal() ;

/// @brief Method InitializeProviderRegistration, addr 0x4084fcc, size 0x1f0, virtual false, abstract: false, final false
static inline void InitializeProviderRegistration() ;

/// @brief Method LookupProvider, addr 0x4085344, size 0x560, virtual false, abstract: false, final false
static inline ::Mono::Net::Security::MobileTlsProvider* LookupProvider(::StringW  name, bool  throwOnError) ;

/// @brief Method PopulateProviders, addr 0x40859e4, size 0x50, virtual false, abstract: false, final false
static inline void PopulateProviders() ;

/// @brief Method PopulateUnityProviders, addr 0x40858a4, size 0x140, virtual false, abstract: false, final false
