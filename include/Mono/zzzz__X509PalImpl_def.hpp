...
/// @brief Method ConvertData, addr 0x4077ee8, size 0x10c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> ConvertData(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method GetCertContentType, addr 0x4077ffc, size 0x400, virtual false, abstract: false, final false
...
/// @brief Method ImportFallback, addr 0x40775e0, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method ImportFallback, addr 0x4077868, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method PEM, addr 0x4077db4, size 0x134, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> PEM(::StringW  type, ::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method .ctor, addr 0x4077dac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::ArrayW<uint8_t,::Array<uint8_t>*> getStaticF_signedData() ;

/// @brief Method get_SupportsLegacyBasicConstraintsExtension, addr 0x4077ff4, size 0x8, virtual false, abstract: false, final false
