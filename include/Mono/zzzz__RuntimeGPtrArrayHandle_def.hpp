...
/// @brief Method DestroyAndFree, addr 0x3bc5198, size 0x1c, virtual false, abstract: false, final false
static inline void DestroyAndFree(ByRef<::Mono::RuntimeGPtrArrayHandle>  h) ;

/// @brief Method GPtrArrayFree, addr 0x3bc5194, size 0x4, virtual false, abstract: false, final false
static inline void GPtrArrayFree(::cordl_internals::Ptr<::Mono::__RuntimeStructs__GPtrArray>  value) ;

/// @brief Method Lookup, addr 0x3bc5130, size 0x64, virtual false, abstract: false, final false
inline ::System::IntPtr Lookup(int32_t  i) ;

/// @brief Method .ctor, addr 0x3bc50f0, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  ptr) ;

/// @brief Method get_Item, addr 0x3bc512c, size 0x4, virtual false, abstract: false, final false
inline ::System::IntPtr get_Item(int32_t  i) ;

/// @brief Method get_Length, addr 0x3bc5110, size 0x1c, virtual false, abstract: false, final false
