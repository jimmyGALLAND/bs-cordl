...
static __declspec(property(get=getStaticF___9__1_0, put=setStaticF___9__1_0)) ::System::Runtime::CompilerServices::__ConditionalWeakTable_2__CreateValueCallback<::System::Net::HttpWebRequest*,::Mono::Http::NtlmSession*>*  __9__1_0;

static inline ::Mono::Http::__NtlmClient____c* New_ctor() ;

/// @brief Method <Authenticate>b__1_0, addr 0x40870f0, size 0x54, virtual false, abstract: false, final false
inline ::Mono::Http::NtlmSession* _Authenticate_b__1_0(::System::Net::HttpWebRequest*  x) ;

/// @brief Method .ctor, addr 0x40870e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static __declspec(property(get=getStaticF_cache, put=setStaticF_cache)) ::System::Runtime::CompilerServices::ConditionalWeakTable_2<::System::Net::HttpWebRequest*,::Mono::Http::NtlmSession*>*  cache;

/// @brief Convert operator to "::System::Net::IAuthenticationModule"
constexpr operator  ::System::Net::IAuthenticationModule*() noexcept;

/// @brief Method Authenticate, addr 0x4086c4c, size 0x364, virtual true, abstract: false, final true
...
/// @brief Method PreAuthenticate, addr 0x4086fb0, size 0x8, virtual true, abstract: false, final true
inline ::System::Net::Authorization* PreAuthenticate(::System::Net::WebRequest*  webRequest, ::System::Net::ICredentials*  credentials) ;

/// @brief Method .ctor, addr 0x4086ff8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AuthenticationType, addr 0x4086fb8, size 0x40, virtual true, abstract: false, final true
