...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Mono::Http::__NtlmClient____c::*)()>(&::Mono::Http::__NtlmClient____c::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x40870e8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Mono::Http::NtlmSession* (::Mono::Http::__NtlmClient____c::*)(::System::Net::HttpWebRequest*)>(&::Mono::Http::__NtlmClient____c::_Authenticate_b__1_0)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x40870f0;
...
::cordl_internals::setStaticField<::Mono::Http::__NtlmClient____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Mono::Http::__NtlmClient____c*>::get>(std::forward<::Mono::Http::__NtlmClient____c*>(value));
}
...
inline void Mono::Http::__NtlmClient____c::setStaticF___9__1_0(::System::Runtime::CompilerServices::__ConditionalWeakTable_2__CreateValueCallback<::System::Net::HttpWebRequest*,::Mono::Http::NtlmSession*>*  value)  {
::cordl_internals::setStaticField<::System::Runtime::CompilerServices::__ConditionalWeakTable_2__CreateValueCallback<::System::Net::HttpWebRequest*,::Mono::Http::NtlmSession*>*, "<>9__1_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Mono::Http::__NtlmClient____c*>::get>(std::forward<::System::Runtime::CompilerServices::__ConditionalWeakTable_2__CreateValueCallback<::System::Net::HttpWebRequest*,::Mono::Http::NtlmSession*>*>(value));
}
inline ::System::Runtime::CompilerServices::__ConditionalWeakTable_2__CreateValueCallback<::System::Net::HttpWebRequest*,::Mono::Http::NtlmSession*>* Mono::Http::__NtlmClient____c::getStaticF___9__1_0()  {
return ::cordl_internals::getStaticField<::System::Runtime::CompilerServices::__ConditionalWeakTable_2__CreateValueCallback<::System::Net::HttpWebRequest*,::Mono::Http::NtlmSession*>*, "<>9__1_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Mono::Http::__NtlmClient____c*>::get>();
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Net::Authorization* (::Mono::Http::NtlmClient::*)(::StringW, ::System::Net::WebRequest*, ::System::Net::ICredentials*)>(&::Mono::Http::NtlmClient::Authenticate)> {
  ...
  constexpr static std::size_t addrs = 0x4086c4c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Net::Authorization* (::Mono::Http::NtlmClient::*)(::System::Net::WebRequest*, ::System::Net::ICredentials*)>(&::Mono::Http::NtlmClient::PreAuthenticate)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x4086fb0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Mono::Http::NtlmClient::*)()>(&::Mono::Http::NtlmClient::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x4086ff8;
