...
/// @brief Method <BuildTailoringTables>b__17_0, addr 0x3bc991c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3bc9914, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static __declspec(property(get=getStaticF_tailoringInfos, put=setStaticF_tailoringInfos)) ::ArrayW<::Mono::Globalization::Unicode::TailoringInfo*,::Array<::Mono::Globalization::Unicode::TailoringInfo*>*>  tailoringInfos;

/// @brief Method BuildTailoringTables, addr 0x3bc7c7c, size 0x750, virtual false, abstract: false, final false
...
/// @brief Method Category, addr 0x3bc862c, size 0xa4, virtual false, abstract: false, final false
static inline uint8_t Category(int32_t  cp) ;

/// @brief Method FillCJK, addr 0x3bc92d4, size 0x160, virtual false, abstract: false, final false
static inline void FillCJK(::StringW  culture, ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  cjkIndexer, ByRef<::cordl_internals::Ptr<uint8_t>>  catTable, ByRef<::cordl_internals::Ptr<uint8_t>>  lv1Table, ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  lv2Indexer, ByRef<::cordl_internals::Ptr<uint8_t>>  lv2Table) ;

/// @brief Method FillCJKCore, addr 0x3bc9434, size 0x484, virtual false, abstract: false, final false
static inline void FillCJKCore(::StringW  culture, ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  cjkIndexer, ByRef<::cordl_internals::Ptr<uint8_t>>  catTable, ByRef<::cordl_internals::Ptr<uint8_t>>  lv1Table, ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  cjkLv2Indexer, ByRef<::cordl_internals::Ptr<uint8_t>>  lv2Table) ;

/// @brief Method GetResource, addr 0x3bc8dbc, size 0xb8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetResource(::StringW  name) ;

/// @brief Method GetTailoringInfo, addr 0x3bc7b78, size 0x104, virtual false, abstract: false, final false
static inline ::Mono::Globalization::Unicode::TailoringInfo* GetTailoringInfo(int32_t  lcid) ;

/// @brief Method HasSpecialWeight, addr 0x3bc8bd0, size 0x80, virtual false, abstract: false, final false
static inline bool HasSpecialWeight(char16_t  c) ;

/// @brief Method IsHalfWidthKana, addr 0x3bc8c50, size 0x14, virtual false, abstract: false, final false
static inline bool IsHalfWidthKana(char16_t  c) ;

/// @brief Method IsHiragana, addr 0x3bc8c64, size 0x18, virtual false, abstract: false, final false
static inline bool IsHiragana(char16_t  c) ;

/// @brief Method IsIgnorable, addr 0x3bc88bc, size 0x118, virtual false, abstract: false, final false
static inline bool IsIgnorable(int32_t  cp, uint8_t  flag) ;

/// @brief Method IsIgnorableNonSpacing, addr 0x3bc89d4, size 0x58, virtual false, abstract: false, final false
static inline bool IsIgnorableNonSpacing(int32_t  cp) ;

/// @brief Method IsJapaneseSmallLetter, addr 0x3bc8c7c, size 0xe8, virtual false, abstract: false, final false
static inline bool IsJapaneseSmallLetter(char16_t  c) ;

/// @brief Method Level1, addr 0x3bc86d0, size 0xa4, virtual false, abstract: false, final false
static inline uint8_t Level1(int32_t  cp) ;

/// @brief Method Level2, addr 0x3bc8774, size 0xa4, virtual false, abstract: false, final false
static inline uint8_t Level2(int32_t  cp) ;

/// @brief Method Level3, addr 0x3bc8818, size 0xa4, virtual false, abstract: false, final false
static inline uint8_t Level3(int32_t  cp) ;

/// @brief Method SetCJKReferences, addr 0x3bc83cc, size 0x260, virtual false, abstract: false, final false
static inline void SetCJKReferences(::StringW  name, ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  cjkIndexer, ByRef<::cordl_internals::Ptr<uint8_t>>  catTable, ByRef<::cordl_internals::Ptr<uint8_t>>  lv1Table, ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  lv2Indexer, ByRef<::cordl_internals::Ptr<uint8_t>>  lv2Table) ;

/// @brief Method ToKanaTypeInsensitive, addr 0x3bc8a2c, size 0x18, virtual false, abstract: false, final false
static inline int32_t ToKanaTypeInsensitive(int32_t  i) ;

/// @brief Method ToWidthCompat, addr 0x3bc8a44, size 0x18c, virtual false, abstract: false, final false
static inline int32_t ToWidthCompat(int32_t  i) ;

/// @brief Method UInt32FromBytePtr, addr 0x3bc8e74, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_IsReady, addr 0x3bc8d64, size 0x58, virtual false, abstract: false, final false
