...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Mono::Globalization::Unicode::__CodePointIndexer__TableRange::*)(int32_t, int32_t, int32_t)>(&::Mono::Globalization::Unicode::__CodePointIndexer__TableRange::_ctor)> {
  constexpr static std::size_t size = 0x18;
  constexpr static std::size_t addrs = 0x3bc792c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Mono::Globalization::Unicode::__CodePointIndexer__TableRange>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Mono::Globalization::Unicode::CodePointIndexer::*)(::ArrayW<int32_t,::Array<int32_t>*>, ::ArrayW<int32_t,::Array<int32_t>*>, int32_t, int32_t)>(&::Mono::Globalization::Unicode::CodePointIndexer::_ctor)> {
  constexpr static std::size_t size = 0x158;
  constexpr static std::size_t addrs = 0x3bc77d4;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 4>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<int32_t,::Array<int32_t>*>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<int32_t,::Array<int32_t>*>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Mono::Globalization::Unicode::CodePointIndexer::*)(int32_t)>(&::Mono::Globalization::Unicode::CodePointIndexer::ToIndex)> {
  constexpr static std::size_t size = 0x84;
  constexpr static std::size_t addrs = 0x3bc7944;
...
constexpr ::ArrayW<::Mono::Globalization::Unicode::__CodePointIndexer__TableRange,::Array<::Mono::Globalization::Unicode::__CodePointIndexer__TableRange>*>& Mono::Globalization::Unicode::CodePointIndexer::__cordl_internal_get_ranges()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___ranges;
}
constexpr ::ArrayW<::Mono::Globalization::Unicode::__CodePointIndexer__TableRange,::Array<::Mono::Globalization::Unicode::__CodePointIndexer__TableRange>*> const& Mono::Globalization::Unicode::CodePointIndexer::__cordl_internal_get_ranges() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___ranges;
}
constexpr void Mono::Globalization::Unicode::CodePointIndexer::__cordl_internal_set_ranges(::ArrayW<::Mono::Globalization::Unicode::__CodePointIndexer__TableRange,::Array<::Mono::Globalization::Unicode::__CodePointIndexer__TableRange>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::Mono::Globalization::Unicode::CodePointIndexer* Mono::Globalization::Unicode::CodePointIndexer::New_ctor(::ArrayW<int32_t,::Array<int32_t>*>  starts, ::ArrayW<int32_t,::Array<int32_t>*>  ends, int32_t  defaultIndex, int32_t  defaultCP)  {
