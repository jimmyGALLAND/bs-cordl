...
/// @brief Method MapIdx, addr 0x3bca124, size 0x68, virtual false, abstract: false, final false
static inline int32_t MapIdx(int32_t  cp) ;

/// @brief Method PropIdx, addr 0x3bca0bc, size 0x68, virtual false, abstract: false, final false
