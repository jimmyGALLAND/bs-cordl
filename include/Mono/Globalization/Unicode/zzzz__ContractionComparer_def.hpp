...
/// @brief Method Compare, addr 0x3bc7a50, size 0x94, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3bc7ae4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
