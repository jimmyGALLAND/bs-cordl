...
public:
// Declarations
/// @brief Method .ctor, addr 0x3bcb8b4, size 0x1c, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method .ctor, addr 0x3bcd5bc, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field contractions, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_contractions, put=__cordl_internal_set_contractions)) ::ArrayW<::Mono::Globalization::Unicode::Contraction*,::Array<::Mono::Globalization::Unicode::Contraction*>*>  contractions;
...
/// @brief Field level2Maps, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_level2Maps, put=__cordl_internal_set_level2Maps)) ::ArrayW<::Mono::Globalization::Unicode::Level2Map*,::Array<::Mono::Globalization::Unicode::Level2Map*>*>  level2Maps;
...
/// @brief Method Category, addr 0x3bca604, size 0x94, virtual false, abstract: false, final false
inline uint8_t Category(int32_t  cp) ;

/// @brief Method ClearBuffer, addr 0x3bcb854, size 0x60, virtual false, abstract: false, final false
inline void ClearBuffer(::cordl_internals::Ptr<uint8_t>  buffer, int32_t  size) ;

/// @brief Method Compare, addr 0x3bcbf90, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method CompareFlagPair, addr 0x3bcd5cc, size 0x1c, virtual false, abstract: false, final false
inline int32_t CompareFlagPair(bool  b1, bool  b2) ;

/// @brief Method CompareInternal, addr 0x3bcc040, size 0x157c, virtual false, abstract: false, final false
...
/// @brief Method FillSortKeyRaw, addr 0x3bcb8d0, size 0x398, virtual false, abstract: false, final false
...
/// @brief Method FillSurrogateSortKeyRaw, addr 0x3bcbe40, size 0xb8, virtual false, abstract: false, final false
inline void FillSurrogateSortKeyRaw(int32_t  i, ::Mono::Globalization::Unicode::SortKeyBuffer*  buf) ;

/// @brief Method FilterExtender, addr 0x3bcaf68, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method FilterOptions, addr 0x3bcad64, size 0xe4, virtual false, abstract: false, final false
inline int32_t FilterOptions(int32_t  i, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method GetContraction, addr 0x3bca8d4, size 0xc0, virtual false, abstract: false, final false
inline ::Mono::Globalization::Unicode::Contraction* GetContraction(::StringW  s, int32_t  start, int32_t  end) ;

/// @brief Method GetContraction, addr 0x3bca994, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method GetExtenderType, addr 0x3bcae48, size 0x100, virtual false, abstract: false, final false
inline ::Mono::Globalization::Unicode::__SimpleCollator__ExtenderType GetExtenderType(int32_t  i) ;

/// @brief Method GetNeutralCulture, addr 0x3bca594, size 0x70, virtual false, abstract: false, final false
static inline ::System::Globalization::CultureInfo* GetNeutralCulture(::System::Globalization::CultureInfo*  info) ;

/// @brief Method GetSortKey, addr 0x3bcb250, size 0x20, virtual true, abstract: false, final true
inline ::System::Globalization::SortKey* GetSortKey(::StringW  s, ::System::Globalization::CompareOptions  options) ;

/// @brief Method GetSortKey, addr 0x3bcb270, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method GetSortKey, addr 0x3bcb4b8, size 0x378, virtual false, abstract: false, final false
...
/// @brief Method GetTailContraction, addr 0x3bcaabc, size 0xc0, virtual false, abstract: false, final false
inline ::Mono::Globalization::Unicode::Contraction* GetTailContraction(::StringW  s, int32_t  start, int32_t  end) ;

/// @brief Method GetTailContraction, addr 0x3bcab7c, size 0x1e8, virtual false, abstract: false, final false
...
/// @brief Method IndexOf, addr 0x3bcdac0, size 0x1f0, virtual true, abstract: false, final true
inline int32_t IndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IndexOf, addr 0x3bcdcb0, size 0x4a8, virtual false, abstract: false, final false
...
/// @brief Method IndexOfOrdinal, addr 0x3bce158, size 0xd8, virtual false, abstract: false, final false
inline int32_t IndexOfOrdinal(::StringW  s, ::StringW  target, int32_t  start, int32_t  length) ;

/// @brief Method IndexOfOrdinal, addr 0x3bce230, size 0x70, virtual false, abstract: false, final false
inline int32_t IndexOfOrdinal(::StringW  s, char16_t  target, int32_t  start, int32_t  length) ;

/// @brief Method IndexOfSortKey, addr 0x3bce2a0, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method IsHalfKana, addr 0x3bca860, size 0x74, virtual false, abstract: false, final false
static inline bool IsHalfKana(int32_t  cp, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsIgnorable, addr 0x3bcb178, size 0x7c, virtual false, abstract: false, final false
static inline bool IsIgnorable(int32_t  i, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsPrefix, addr 0x3bcd608, size 0xac, virtual false, abstract: false, final false
inline bool IsPrefix(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsPrefix, addr 0x3bcd6b4, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method IsPrefix, addr 0x3bcd5e8, size 0x20, virtual true, abstract: false, final true
inline bool IsPrefix(::StringW  src, ::StringW  target, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsSafe, addr 0x3bcb1f4, size 0x5c, virtual false, abstract: false, final false
inline bool IsSafe(int32_t  i) ;

/// @brief Method IsSuffix, addr 0x3bcd73c, size 0x94, virtual false, abstract: false, final false
inline bool IsSuffix(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsSuffix, addr 0x3bcd71c, size 0x20, virtual true, abstract: false, final true
inline bool IsSuffix(::StringW  src, ::StringW  target, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method LastIndexOf, addr 0x3bcd7d0, size 0x188, virtual true, abstract: false, final true
inline int32_t LastIndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method LastIndexOf, addr 0x3bce508, size 0x52c, virtual false, abstract: false, final false
...
/// @brief Method LastIndexOfOrdinal, addr 0x3bcea34, size 0x134, virtual false, abstract: false, final false
inline int32_t LastIndexOfOrdinal(::StringW  s, ::StringW  target, int32_t  start, int32_t  length) ;

/// @brief Method LastIndexOfSortKey, addr 0x3bceb68, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method Level1, addr 0x3bca698, size 0x94, virtual false, abstract: false, final false
inline uint8_t Level1(int32_t  cp) ;

/// @brief Method Level2, addr 0x3bca72c, size 0x134, virtual false, abstract: false, final false
inline uint8_t Level2(int32_t  cp, ::Mono::Globalization::Unicode::__SimpleCollator__ExtenderType  ext) ;

/// @brief Method MatchesBackward, addr 0x3bcec0c, size 0x1d8, virtual false, abstract: false, final false
...
/// @brief Method MatchesBackwardCore, addr 0x3bcf370, size 0x484, virtual false, abstract: false, final false
...
/// @brief Method MatchesForward, addr 0x3bce33c, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method MatchesForwardCore, addr 0x3bcede4, size 0x364, virtual false, abstract: false, final false
...
/// @brief Method MatchesPrimitive, addr 0x3bcf148, size 0x228, virtual false, abstract: false, final false
...
/// @brief Method QuickIndexOf, addr 0x3bcd958, size 0x168, virtual false, abstract: false, final false
inline int32_t QuickIndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ByRef<bool>  testWasUnable) ;

/// @brief Method SetCJKTable, addr 0x3bca4b8, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method System.Globalization.ISimpleCollator.Compare, addr 0x3bcbf8c, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method ToDashTypeValue, addr 0x3bcaf48, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3bca18c, size 0x32c, virtual false, abstract: false, final false
