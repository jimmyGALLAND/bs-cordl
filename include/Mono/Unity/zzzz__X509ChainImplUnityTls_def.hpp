...
/// @brief Method AddStatus, addr 0x407e1bc, size 0x104, virtual true, abstract: false, final false
inline void AddStatus(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags  error) ;

/// @brief Method Build, addr 0x407e344, size 0x8, virtual true, abstract: false, final false
inline bool Build(::System::Security::Cryptography::X509Certificates::X509Certificate2*  certificate) ;

/// @brief Method Dispose, addr 0x407e38c, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x407e34c, size 0x40, virtual true, abstract: false, final false
inline void Reset() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Security::Cryptography::X509Certificates::X509ChainStatus>*> const& __cordl_internal_get_chainStatusList() const;
...
/// @brief Method .ctor, addr 0x407c8e0, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::Mono::Unity::__UnityTls__unitytls_x509list_ref  nativeCertificateChain, bool  reverseOrder) ;

/// @brief Method get_ChainElements, addr 0x407deec, size 0x2d0, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* get_ChainElements() ;

/// @brief Method get_ChainPolicy, addr 0x407e2c0, size 0x8, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509ChainPolicy* get_ChainPolicy() ;

/// @brief Method get_ChainStatus, addr 0x407e2c8, size 0x7c, virtual true, abstract: false, final false
...
/// @brief Method get_IsValid, addr 0x407debc, size 0x28, virtual true, abstract: false, final false
inline bool get_IsValid() ;

/// @brief Method get_NativeCertificateChain, addr 0x407dee4, size 0x8, virtual false, abstract: false, final false
