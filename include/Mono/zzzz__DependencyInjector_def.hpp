...
/// @brief Method ReflectionLoad, addr 0x3bc47b4, size 0x14c, virtual false, abstract: false, final false
static inline ::Mono::ISystemDependencyProvider* ReflectionLoad() ;

/// @brief Method Register, addr 0x3bc4900, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method get_SystemProvider, addr 0x3bc45bc, size 0x1f8, virtual false, abstract: false, final false
