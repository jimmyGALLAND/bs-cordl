...
/// @brief Method EnsureInitialized, addr 0x40773c8, size 0x150, virtual false, abstract: false, final false
static inline void EnsureInitialized() ;

/// @brief Method GetX509Pal, addr 0x4077320, size 0x50, virtual false, abstract: false, final false
static inline ::Mono::X509PalImpl* GetX509Pal() ;

/// @brief Method Import, addr 0x40778e0, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method Import, addr 0x40777d8, size 0x90, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Impl* Import(::ArrayW<uint8_t,::Array<uint8_t>*>  data, ::Microsoft::Win32::SafeHandles::SafePasswordHandle*  password, ::System::Security::Cryptography::X509Certificates::X509KeyStorageFlags  keyStorageFlags, ::Mono::CertificateImportFlags  importFlags) ;

/// @brief Method Import, addr 0x4077574, size 0x6c, virtual true, abstract: false, final true
...
/// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x40778dc, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x40777d4, size 0x4, virtual true, abstract: false, final true
inline ::System::Security::Cryptography::X509Certificates::X509CertificateImpl* Mono_ISystemCertificateProvider_Import(::ArrayW<uint8_t,::Array<uint8_t>*>  data, ::Microsoft::Win32::SafeHandles::SafePasswordHandle*  password, ::System::Security::Cryptography::X509Certificates::X509KeyStorageFlags  keyStorageFlags, ::Mono::CertificateImportFlags  importFlags) ;

static inline ::Mono::SystemCertificateProvider* New_ctor() ;

/// @brief Method .ctor, addr 0x40779f4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_X509Pal, addr 0x4077518, size 0x5c, virtual false, abstract: false, final false
