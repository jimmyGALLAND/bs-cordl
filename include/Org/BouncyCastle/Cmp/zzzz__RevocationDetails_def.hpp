...
/// @brief Method ToASN1Structure, addr 0x2602454, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2602390, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::RevDetails*  revDetails) ;

/// @brief Method get_Issuer, addr 0x26023e8, size 0x30, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_Issuer() ;

/// @brief Method get_SerialNumber, addr 0x2602418, size 0x3c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_SerialNumber() ;

/// @brief Method get_Subject, addr 0x26023b8, size 0x30, virtual false, abstract: false, final false
