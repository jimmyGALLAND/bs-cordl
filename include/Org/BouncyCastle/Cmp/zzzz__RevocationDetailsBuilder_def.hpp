...
/// @brief Method Build, addr 0x2602578, size 0xac, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cmp::RevocationDetails* Build() ;

static inline ::Org::BouncyCastle::Cmp::RevocationDetailsBuilder* New_ctor() ;

/// @brief Method SetIssuer, addr 0x260248c, size 0x30, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cmp::RevocationDetailsBuilder* SetIssuer(::Org::BouncyCastle::Asn1::X509::X509Name*  issuer) ;

/// @brief Method SetPublicKey, addr 0x260245c, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method SetSerialNumber, addr 0x26024bc, size 0x8c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cmp::RevocationDetailsBuilder* SetSerialNumber(::Org::BouncyCastle::Math::BigInteger*  serialNumber) ;

/// @brief Method SetSubject, addr 0x2602548, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2602624, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
