...
/// @brief Method GetCertificates, addr 0x2600868, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method Process, addr 0x2600b50, size 0x2d8, virtual false, abstract: false, final false
inline ::System::Object* Process(::Org::BouncyCastle::Crypto::IStreamCalculator*  streamCalculator) ;

/// @brief Method ToAsn1Message, addr 0x26007b8, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cmp::PkiMessage* ToAsn1Message() ;

/// @brief Method Verify, addr 0x2600e28, size 0x2e4, virtual false, abstract: false, final false
inline bool Verify(::Org::BouncyCastle::Crmf::PKMacBuilder*  pkMacBuilder, ::ArrayW<char16_t,::Array<char16_t>*>  password) ;

/// @brief Method Verify, addr 0x26009d0, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26006dc, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::PkiMessage*  pkiMessage) ;

/// @brief Method .ctor, addr 0x2600648, size 0x94, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Cmp::GeneralPkiMessage*  pkiMessage) ;

/// @brief Method get_Body, addr 0x2600798, size 0x20, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cmp::PkiBody* get_Body() ;

/// @brief Method get_HasPasswordBasedMacProtected, addr 0x26007c0, size 0xa8, virtual false, abstract: false, final false
inline bool get_HasPasswordBasedMacProtected() ;

/// @brief Method get_Header, addr 0x2600778, size 0x20, virtual false, abstract: false, final false
