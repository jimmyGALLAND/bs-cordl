...
/// @brief Method ToString, addr 0x254dbb8, size 0x1e8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x254da08, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x254d944, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x254d804, size 0x84, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::X509::X509Certificate*  trustedCert, ::ArrayW<uint8_t,::Array<uint8_t>*>  nameConstraints) ;

/// @brief Method get_CA, addr 0x254db44, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_CA() ;

/// @brief Method get_CAName, addr 0x254db4c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_CAName() ;

/// @brief Method get_CAPublicKey, addr 0x254db54, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_CAPublicKey() ;

/// @brief Method get_GetNameConstraints, addr 0x254db5c, size 0x5c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_GetNameConstraints() ;

/// @brief Method get_TrustedCert, addr 0x254db3c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Certificate* get_TrustedCert() ;

/// @brief Method setNameConstraints, addr 0x254d888, size 0xbc, virtual false, abstract: false, final false
