...
/// @brief Method .ctor, addr 0x2531cb8, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2531cc4, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method .ctor, addr 0x251dd2c, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::System::Exception*  cause) ;

/// @brief Method .ctor, addr 0x2527a00, size 0x190, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::System::Exception*  cause, ::Org::BouncyCastle::Pkix::PkixCertPath*  certPath, int32_t  index) ;

/// @brief Method get_CertPath, addr 0x2531d04, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Pkix::PkixCertPath* get_CertPath() ;

/// @brief Method get_Index, addr 0x2531d0c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Index() ;

/// @brief Method get_Message, addr 0x2531cd0, size 0x34, virtual true, abstract: false, final false
