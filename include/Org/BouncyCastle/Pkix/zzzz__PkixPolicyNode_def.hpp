...
/// @brief Method AddChild, addr 0x2543dbc, size 0xc8, virtual true, abstract: false, final false
inline void AddChild(::Org::BouncyCastle::Pkix::PkixPolicyNode*  child) ;

/// @brief Method Clone, addr 0x254442c, size 0x10, virtual true, abstract: false, final false
inline ::System::Object* Clone() ;

/// @brief Method Copy, addr 0x254443c, size 0x458, virtual true, abstract: false, final false
...
/// @brief Method RemoveChild, addr 0x2543e84, size 0xac, virtual true, abstract: false, final false
inline void RemoveChild(::Org::BouncyCastle::Pkix::PkixPolicyNode*  child) ;

/// @brief Method ToString, addr 0x2543f30, size 0x54, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x2543f84, size 0x4a8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2528200, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method get_Children, addr 0x2543b58, size 0x60, virtual true, abstract: false, final false
inline ::System::Collections::IEnumerable* get_Children() ;

/// @brief Method get_Depth, addr 0x2543b50, size 0x8, virtual true, abstract: false, final false
inline int32_t get_Depth() ;

/// @brief Method get_ExpectedPolicies, addr 0x2543ce4, size 0x60, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Collections::ISet* get_ExpectedPolicies() ;

/// @brief Method get_HasChildren, addr 0x2543c34, size 0xb0, virtual true, abstract: false, final false
inline bool get_HasChildren() ;

/// @brief Method get_IsCritical, addr 0x2543bb8, size 0x8, virtual true, abstract: false, final false
inline bool get_IsCritical() ;

/// @brief Method get_Parent, addr 0x2543dac, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Pkix::PkixPolicyNode* get_Parent() ;

/// @brief Method get_PolicyQualifiers, addr 0x2543bcc, size 0x60, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Collections::ISet* get_PolicyQualifiers() ;

/// @brief Method get_ValidPolicy, addr 0x2543c2c, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_ValidPolicy() ;

/// @brief Method set_ExpectedPolicies, addr 0x2543d44, size 0x68, virtual true, abstract: false, final false
inline void set_ExpectedPolicies(::Org::BouncyCastle::Utilities::Collections::ISet*  value) ;

/// @brief Method set_IsCritical, addr 0x2543bc0, size 0xc, virtual true, abstract: false, final false
inline void set_IsCritical(bool  value) ;

/// @brief Method set_Parent, addr 0x2543db4, size 0x8, virtual true, abstract: false, final false
