...
/// @brief Method AddReasons, addr 0x25448d8, size 0x48, virtual false, abstract: false, final false
inline void AddReasons(::Org::BouncyCastle::Pkix::ReasonsMask*  mask) ;

/// @brief Method HasNewReasons, addr 0x2544ab4, size 0x54, virtual false, abstract: false, final false
inline bool HasNewReasons(::Org::BouncyCastle::Pkix::ReasonsMask*  mask) ;

/// @brief Method Intersect, addr 0x25449f4, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25448bc, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2544894, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  reasons) ;

static inline ::Org::BouncyCastle::Pkix::ReasonsMask* getStaticF_AllReasons() ;

/// @brief Method get_IsAllReasons, addr 0x2544980, size 0x74, virtual false, abstract: false, final false
inline bool get_IsAllReasons() ;

/// @brief Method get_Reasons, addr 0x2544920, size 0x60, virtual false, abstract: false, final false
