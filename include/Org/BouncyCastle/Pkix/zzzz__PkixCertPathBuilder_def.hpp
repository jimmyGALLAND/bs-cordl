...
/// @brief Method Build, addr 0x2524128, size 0x860, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Pkix::PkixCertPathBuilderResult* Build(::Org::BouncyCastle::Pkix::PkixBuilderParameters*  pkixParams) ;

/// @brief Method Build, addr 0x2524988, size 0xc48, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25255d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
