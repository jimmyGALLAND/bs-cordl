...
/// @brief Method .ctor, addr 0x251a100, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_RevocationDate, addr 0x251a0e0, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Date::DateTimeObject* get_RevocationDate() ;

/// @brief Method get_Status, addr 0x251a0f0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Status() ;

/// @brief Method set_RevocationDate, addr 0x251a0e8, size 0x8, virtual false, abstract: false, final false
inline void set_RevocationDate(::Org::BouncyCastle::Utilities::Date::DateTimeObject*  value) ;

/// @brief Method set_Status, addr 0x251a0f8, size 0x8, virtual false, abstract: false, final false
