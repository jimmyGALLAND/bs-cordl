...
/// @brief Method Build, addr 0x263a6c0, size 0x110, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IMacFactory* Build(::ArrayW<char16_t,::Array<char16_t>*>  password) ;

/// @brief Method CheckIterationCountCeiling, addr 0x263a494, size 0x1d0, virtual false, abstract: false, final false
inline void CheckIterationCountCeiling(int32_t  iterationCount) ;

/// @brief Method GenCalculator, addr 0x263a7d0, size 0x414, virtual false, abstract: false, final false
...
/// @brief Method SetIterationCount, addr 0x263a41c, size 0x78, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crmf::PKMacBuilder* SetIterationCount(int32_t  iterationCount) ;

/// @brief Method SetParameters, addr 0x263a664, size 0x54, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crmf::PKMacBuilder* SetParameters(::Org::BouncyCastle::Asn1::Cmp::PbmParameter*  parameters) ;

/// @brief Method SetSaltLength, addr 0x263a3bc, size 0x60, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crmf::PKMacBuilder* SetSaltLength(int32_t  saltLength) ;

/// @brief Method SetSecureRandom, addr 0x263a6b8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x263a048, size 0x164, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x263a1ac, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x263a1f8, size 0x140, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crmf::IPKMacPrimitivesProvider*  provider) ;

/// @brief Method .ctor, addr 0x263a338, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x263a384, size 0x38, virtual false, abstract: false, final false
