...
/// @brief Method Build, addr 0x2638da4, size 0x13c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Crmf::EncryptedValue* Build(::Org::BouncyCastle::X509::X509Certificate*  holder) ;

/// @brief Method Build, addr 0x2638ee0, size 0x590, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Crmf::EncryptedValue* Build(::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo*  privateKeyInfo) ;

/// @brief Method Build, addr 0x26385a8, size 0x30, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Crmf::EncryptedValue* Build(::ArrayW<char16_t,::Array<char16_t>*>  revocationPassphrase) ;

/// @brief Method EncryptData, addr 0x263868c, size 0x718, virtual false, abstract: false, final false
...
/// @brief Method PadData, addr 0x26385d8, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x263853c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IKeyWrapper*  wrapper, ::Org::BouncyCastle::Crypto::ICipherBuilderWithKey*  encryptor) ;

/// @brief Method .ctor, addr 0x263856c, size 0x3c, virtual false, abstract: false, final false
