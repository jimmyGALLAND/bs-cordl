...
/// @brief Method .ctor, addr 0x2635ab8, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerUtf8String*  token) ;

/// @brief Method .ctor, addr 0x2635ae0, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  token) ;

static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* getStaticF_type() ;

/// @brief Method get_Type, addr 0x2635b54, size 0x58, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Type() ;

/// @brief Method get_Value, addr 0x2635bac, size 0x8, virtual true, abstract: false, final true
