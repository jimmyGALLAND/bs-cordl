...
/// @brief Method CreateCalculator, addr 0x2639d54, size 0x16c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2639c44, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  key, ::Org::BouncyCastle::Asn1::Cmp::PbmParameter*  parameters) ;

/// @brief Method get_AlgorithmDetails, addr 0x2639cc0, size 0x94, virtual true, abstract: false, final false
