...
/// @brief Method Generate, addr 0x257f9d4, size 0x664, virtual false, abstract: false, final false
...
/// @brief Method SetAccuracyMicros, addr 0x2581c58, size 0x8, virtual false, abstract: false, final false
inline void SetAccuracyMicros(int32_t  accuracyMicros) ;

/// @brief Method SetAccuracyMillis, addr 0x2581c50, size 0x8, virtual false, abstract: false, final false
inline void SetAccuracyMillis(int32_t  accuracyMillis) ;

/// @brief Method SetAccuracySeconds, addr 0x2581c48, size 0x8, virtual false, abstract: false, final false
inline void SetAccuracySeconds(int32_t  accuracySeconds) ;

/// @brief Method SetCertificates, addr 0x2581c38, size 0x8, virtual false, abstract: false, final false
inline void SetCertificates(::Org::BouncyCastle::X509::Store::IX509Store*  certificates) ;

/// @brief Method SetCrls, addr 0x2581c40, size 0x8, virtual false, abstract: false, final false
inline void SetCrls(::Org::BouncyCastle::X509::Store::IX509Store*  crls) ;

/// @brief Method SetOrdering, addr 0x2581c60, size 0xc, virtual false, abstract: false, final false
inline void SetOrdering(bool  ordering) ;

/// @brief Method SetTsa, addr 0x2581c6c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x258181c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2581828, size 0x410, virtual false, abstract: false, final false
