...
/// @brief Method GetEncoded, addr 0x2581e00, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method GetMessageImprintDigest, addr 0x257f0d0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2580a14, size 0x12c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Tsp::TstInfo*  tstInfo) ;

/// @brief Method get_Accuracy, addr 0x2581d00, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Tsp::Accuracy* get_Accuracy() ;

/// @brief Method get_GenTime, addr 0x2581d1c, size 0x8, virtual false, abstract: false, final false
inline ::System::DateTime get_GenTime() ;

/// @brief Method get_GenTimeAccuracy, addr 0x2581d24, size 0x78, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Tsp::GenTimeAccuracy* get_GenTimeAccuracy() ;

/// @brief Method get_HashAlgorithm, addr 0x2581ddc, size 0x24, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm() ;

/// @brief Method get_IsOrdered, addr 0x2581cdc, size 0x24, virtual false, abstract: false, final false
inline bool get_IsOrdered() ;

/// @brief Method get_MessageImprintAlgOid, addr 0x257f0f4, size 0x3c, virtual false, abstract: false, final false
inline ::StringW get_MessageImprintAlgOid() ;

/// @brief Method get_Nonce, addr 0x257f088, size 0x2c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Nonce() ;

/// @brief Method get_Policy, addr 0x257f14c, size 0x24, virtual false, abstract: false, final false
inline ::StringW get_Policy() ;

/// @brief Method get_SerialNumber, addr 0x2581d9c, size 0x24, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_SerialNumber() ;

/// @brief Method get_Tsa, addr 0x2581dc0, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_Tsa() ;

/// @brief Method get_TstInfo, addr 0x2581e1c, size 0x8, virtual false, abstract: false, final false
