...
/// @brief Method GetEncoded, addr 0x257f170, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method GetFailInfo, addr 0x257ecf0, size 0x80, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cmp::PkiFailureInfo* GetFailInfo() ;

/// @brief Method GetStatusString, addr 0x257ebec, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method Validate, addr 0x257ed78, size 0x310, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x257ead8, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input) ;

/// @brief Method .ctor, addr 0x257e950, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  resp) ;

/// @brief Method .ctor, addr 0x257e868, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Tsp::TimeStampResp*  resp) ;

/// @brief Method get_Status, addr 0x257ebbc, size 0x30, virtual false, abstract: false, final false
inline int32_t get_Status() ;

/// @brief Method get_TimeStampToken, addr 0x257ed70, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Tsp::TimeStampToken* get_TimeStampToken() ;

/// @brief Method readTimeStampResp, addr 0x257e9c4, size 0x114, virtual false, abstract: false, final false
