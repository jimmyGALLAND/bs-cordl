...
/// @brief Method CreateDigestInstance, addr 0x25846b0, size 0x8c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::IDigest* CreateDigestInstance(::StringW  digestAlgOID) ;

/// @brief Method GetCriticalExtensionOids, addr 0x258473c, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method GetDigestAlgName, addr 0x25845a8, size 0x108, virtual false, abstract: false, final false
static inline ::StringW GetDigestAlgName(::StringW  digestAlgOID) ;

/// @brief Method GetDigestLength, addr 0x257dce8, size 0x1e0, virtual false, abstract: false, final false
static inline int32_t GetDigestLength(::StringW  digestAlgOID) ;

/// @brief Method GetExtensionOids, addr 0x257df60, size 0xb0, virtual false, abstract: false, final false
static inline ::System::Collections::IList* GetExtensionOids(::Org::BouncyCastle::Asn1::X509::X509Extensions*  extensions) ;

/// @brief Method GetNonCriticalExtensionOids, addr 0x2584b0c, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method GetSignatureTimestamps, addr 0x2583c14, size 0x994, virtual false, abstract: false, final false
...
/// @brief Method ValidateCertificate, addr 0x25813a0, size 0x35c, virtual false, abstract: false, final false
static inline void ValidateCertificate(::Org::BouncyCastle::X509::X509Certificate*  cert) ;

/// @brief Method .ctor, addr 0x2584bb8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
