...
/// @brief Method GetCertHash, addr 0x258133c, size 0x34, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetCertHash() ;

/// @brief Method GetHashAlgorithm, addr 0x2581774, size 0xa8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* GetHashAlgorithm() ;

/// @brief Method GetHashAlgorithmName, addr 0x2581244, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2580b40, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Ess::EssCertID*  certID) ;

/// @brief Method .ctor, addr 0x2580b68, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Ess::EssCertIDv2*  certID) ;

/// @brief Method get_IssuerSerial, addr 0x2581370, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GetAttributeCertificates, addr 0x2580c08, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::Store::IX509Store* GetAttributeCertificates(::StringW  type) ;

/// @brief Method GetCertificates, addr 0x2580bd0, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCertificates(::StringW  type) ;

/// @brief Method GetCrls, addr 0x2580bec, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCrls(::StringW  type) ;

/// @brief Method GetEncoded, addr 0x2581704, size 0x54, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method GetEncoded, addr 0x2581758, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method ToCmsSignedData, addr 0x25816fc, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::CmsSignedData* ToCmsSignedData() ;

/// @brief Method Validate, addr 0x2580c24, size 0x620, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x257e8e4, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Cms::ContentInfo*  contentInfo) ;

/// @brief Method .ctor, addr 0x25801c4, size 0x850, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Cms::CmsSignedData*  signedData) ;

/// @brief Method get_SignedAttributes, addr 0x257f130, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::AttributeTable* get_SignedAttributes() ;

/// @brief Method get_SignerID, addr 0x2580b98, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::SignerID* get_SignerID() ;

/// @brief Method get_TimeStampInfo, addr 0x2580b90, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Tsp::TimeStampTokenInfo* get_TimeStampInfo() ;

/// @brief Method get_UnsignedAttributes, addr 0x2580bb4, size 0x1c, virtual false, abstract: false, final false
