...
/// @brief Method GenerateWrappedKey, addr 0x236a2a8, size 0x130, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2369ffc, size 0x14c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::X509::X509Certificate*  recipCert, ::Org::BouncyCastle::Crypto::IKeyWrapper*  keyWrapper) ;

/// @brief Method .ctor, addr 0x236a148, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  subjectKeyID, ::Org::BouncyCastle::Crypto::IKeyWrapper*  keyWrapper) ;

/// @brief Method get_AlgorithmDetails, addr 0x236a1bc, size 0xec, virtual true, abstract: false, final false
