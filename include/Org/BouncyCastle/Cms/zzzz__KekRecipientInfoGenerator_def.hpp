...
/// @brief Method DetermineKeyEncAlg, addr 0x262a890, size 0x4ac, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x262ad44, size 0x278, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x262a80c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method set_KekIdentifier, addr 0x262a814, size 0x8, virtual false, abstract: false, final false
inline void set_KekIdentifier(::Org::BouncyCastle::Asn1::Cms::KekIdentifier*  value) ;

/// @brief Method set_KeyEncryptionKey, addr 0x262a81c, size 0x74, virtual false, abstract: false, final false
inline void set_KeyEncryptionKey(::Org::BouncyCastle::Crypto::Parameters::KeyParameter*  value) ;

/// @brief Method set_KeyEncryptionKeyOID, addr 0x262ad3c, size 0x8, virtual false, abstract: false, final false
