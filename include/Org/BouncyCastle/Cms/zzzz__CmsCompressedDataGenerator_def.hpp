...
public:
// Declarations
/// @brief Method Generate, addr 0x2606f30, size 0x3ac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2606f28, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
