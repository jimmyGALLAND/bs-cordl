...
/// @brief Method GetContentStream, addr 0x2630948, size 0x530, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Cms::CmsTypedStream* GetContentStream(::Org::BouncyCastle::Crypto::ICipherParameters*  key) ;

static inline ::Org::BouncyCastle::Cms::PasswordRecipientInformation* New_ctor(::Org::BouncyCastle::Asn1::Cms::PasswordRecipientInfo*  info, ::Org::BouncyCastle::Cms::CmsSecureReadable*  secureReadable) ;

constexpr ::Org::BouncyCastle::Asn1::Cms::PasswordRecipientInfo*& __cordl_internal_get_info() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::PasswordRecipientInfo*> const& __cordl_internal_get_info() const;

constexpr void __cordl_internal_set_info(::Org::BouncyCastle::Asn1::Cms::PasswordRecipientInfo*  value) ;

/// @brief Method .ctor, addr 0x260d24c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method get_KeyDerivationAlgorithm, addr 0x263092c, size 0x1c, virtual true, abstract: false, final false
