...
/// @brief Method GetAttributeCertificates, addr 0x260f44c, size 0x88, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::Store::IX509Store* GetAttributeCertificates(::StringW  type) ;

/// @brief Method GetCertificates, addr 0x260fb08, size 0x88, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCertificates(::StringW  type) ;

/// @brief Method GetCrls, addr 0x260fd30, size 0x88, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCrls(::StringW  type) ;

/// @brief Method GetEncoded, addr 0x260ffb8, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method GetEncoded, addr 0x260ffd4, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded(::StringW  encoding) ;

/// @brief Method GetSignerInfos, addr 0x260ec08, size 0x5d4, virtual false, abstract: false, final false
...
/// @brief Method ReplaceCertificatesAndCrls, addr 0x2610790, size 0x314, virtual false, abstract: false, final false
...
/// @brief Method ReplaceSigners, addr 0x260fff0, size 0x6d4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x260e730, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Cms::CmsSignedData*  c) ;

/// @brief Method .ctor, addr 0x260ea78, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::IDictionary*  hashes, ::ArrayW<uint8_t,::Array<uint8_t>*>  sigBlock) ;

/// @brief Method .ctor, addr 0x260eb04, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::IDictionary*  hashes, ::Org::BouncyCastle::Asn1::Cms::ContentInfo*  sigData) ;

/// @brief Method .ctor, addr 0x260e77c, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  sigBlock) ;

/// @brief Method .ctor, addr 0x260e854, size 0x114, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Cms::ContentInfo*  sigData) ;

/// @brief Method .ctor, addr 0x260ebc4, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  sigData) ;

/// @brief Method .ctor, addr 0x260e968, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Cms::CmsProcessable*  signedContent, ::ArrayW<uint8_t,::Array<uint8_t>*>  sigBlock) ;

/// @brief Method .ctor, addr 0x260e9e8, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Cms::CmsProcessable*  signedContent, ::Org::BouncyCastle::Asn1::Cms::ContentInfo*  sigData) ;

/// @brief Method .ctor, addr 0x260eb94, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_ContentInfo, addr 0x260ffb0, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_ContentInfo() ;

/// @brief Method get_SignedContent, addr 0x260ffa8, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::CmsProcessable* get_SignedContent() ;

/// @brief Method get_SignedContentType, addr 0x260ff84, size 0x24, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_SignedContentType() ;

/// @brief Method get_SignedContentTypeOid, addr 0x260ff58, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_SignedContentTypeOid() ;

/// @brief Method get_Version, addr 0x260ebe4, size 0x24, virtual false, abstract: false, final false
