...
/// @brief Method GetContent, addr 0x2606ac8, size 0x260, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetContent() ;

/// @brief Method GetContent, addr 0x2606d28, size 0x1dc, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetContent(int32_t  limit) ;

/// @brief Method GetEncoded, addr 0x2606f0c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2606a30, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  compressedData) ;

/// @brief Method .ctor, addr 0x2606a90, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  compressedDataStream) ;

/// @brief Method .ctor, addr 0x2606a68, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Cms::ContentInfo*  contentInfo) ;

/// @brief Method get_ContentInfo, addr 0x2606f04, size 0x8, virtual false, abstract: false, final false
