...
/// @brief Method GetAuthAttrs, addr 0x2602a94, size 0x6c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::AttributeTable* GetAuthAttrs() ;

/// @brief Method GetEncoded, addr 0x2602b6c, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method GetMac, addr 0x26029f4, size 0x5c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetMac() ;

/// @brief Method GetRecipientInfos, addr 0x2602a84, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::RecipientInformationStore* GetRecipientInfos() ;

/// @brief Method GetUnauthAttrs, addr 0x2602b00, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2602844, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  authData) ;

/// @brief Method .ctor, addr 0x26029d0, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  authData) ;

/// @brief Method .ctor, addr 0x2602868, size 0x168, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Cms::ContentInfo*  contentInfo) ;

/// @brief Method get_ContentInfo, addr 0x2602a8c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* get_ContentInfo() ;

/// @brief Method get_MacAlgOid, addr 0x2602a58, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_MacAlgOid() ;

/// @brief Method get_MacAlgorithmID, addr 0x2602a50, size 0x8, virtual false, abstract: false, final false
