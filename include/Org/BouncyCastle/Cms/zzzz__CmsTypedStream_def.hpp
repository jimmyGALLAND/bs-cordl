...
/// @brief Method Read, addr 0x2628fd0, size 0xc, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method .ctor, addr 0x2628fb8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Drain, addr 0x261731c, size 0x68, virtual false, abstract: false, final false
inline void Drain() ;
...
/// @brief Method .ctor, addr 0x2628e80, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  inStream) ;

/// @brief Method .ctor, addr 0x2617314, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  oid, ::System::IO::Stream*  inStream) ;

/// @brief Method .ctor, addr 0x2628f00, size 0xb8, virtual false, abstract: false, final false
inline void _ctor(::StringW  oid, ::System::IO::Stream*  inStream, int32_t  bufSize) ;

/// @brief Method get_ContentStream, addr 0x2628fc8, size 0x8, virtual false, abstract: false, final false
inline ::System::IO::Stream* get_ContentStream() ;

/// @brief Method get_ContentType, addr 0x2628fc0, size 0x8, virtual false, abstract: false, final false
