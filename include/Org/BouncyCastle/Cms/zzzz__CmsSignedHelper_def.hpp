...
/// @brief Method AddCertsFromSet, addr 0x2628530, size 0x4c8, virtual false, abstract: false, final false
inline void AddCertsFromSet(::System::Collections::IList*  certs, ::Org::BouncyCastle::Asn1::Asn1Set*  certSet) ;

/// @brief Method AddCrlsFromSet, addr 0x26289f8, size 0x478, virtual false, abstract: false, final false
inline void AddCrlsFromSet(::System::Collections::IList*  crls, ::Org::BouncyCastle::Asn1::Asn1Set*  crlSet) ;

/// @brief Method AddEntries, addr 0x2626564, size 0x16c, virtual false, abstract: false, final false
static inline void AddEntries(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid, ::StringW  digest, ::StringW  encryption) ;

/// @brief Method CreateAttributeStore, addr 0x260f4d4, size 0x634, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::Store::IX509Store* CreateAttributeStore(::StringW  type, ::Org::BouncyCastle::Asn1::Asn1Set*  certSet) ;

/// @brief Method CreateCertificateStore, addr 0x260fb90, size 0x1a0, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::Store::IX509Store* CreateCertificateStore(::StringW  type, ::Org::BouncyCastle::Asn1::Asn1Set*  certSet) ;

/// @brief Method CreateCrlStore, addr 0x260fdb8, size 0x1a0, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::Store::IX509Store* CreateCrlStore(::StringW  type, ::Org::BouncyCastle::Asn1::Asn1Set*  crlSet) ;

/// @brief Method FixAlgID, addr 0x26106c4, size 0xcc, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* FixAlgID(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  algId) ;

/// @brief Method GetDigestAlgName, addr 0x2616308, size 0x108, virtual false, abstract: false, final false
inline ::StringW GetDigestAlgName(::StringW  digestAlgOid) ;

/// @brief Method GetDigestAliases, addr 0x26283e4, size 0x14c, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> GetDigestAliases(::StringW  algName) ;

/// @brief Method GetDigestInstance, addr 0x2616788, size 0x1fc, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IDigest* GetDigestInstance(::StringW  algorithm) ;

/// @brief Method GetEncAlgorithmIdentifier, addr 0x2616984, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method GetEncOid, addr 0x2612e20, size 0x4e8, virtual false, abstract: false, final false
inline ::StringW GetEncOid(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  key, ::StringW  digestOID) ;

/// @brief Method GetEncryptionAlgName, addr 0x2616410, size 0x108, virtual false, abstract: false, final false
inline ::StringW GetEncryptionAlgName(::StringW  encryptionAlgOid) ;

/// @brief Method GetSignatureInstance, addr 0x261b9d8, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26283dc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
