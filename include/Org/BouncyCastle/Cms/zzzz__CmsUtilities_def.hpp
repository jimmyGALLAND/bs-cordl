...
public:
// Declarations
/// @brief Method CreateBerOctetOutputStream, addr 0x261ae0c, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method CreateBerSetFromList, addr 0x2611040, size 0x394, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Asn1Set* CreateBerSetFromList(::System::Collections::IList*  berObjects) ;

/// @brief Method CreateDerSetFromList, addr 0x2615dfc, size 0x394, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Asn1Set* CreateDerSetFromList(::System::Collections::IList*  derObjects) ;

/// @brief Method GetCertificatesFromStore, addr 0x2610aa4, size 0x59c, virtual false, abstract: false, final false
static inline ::System::Collections::IList* GetCertificatesFromStore(::Org::BouncyCastle::X509::Store::IX509Store*  certStore) ;

/// @brief Method GetCrlsFromStore, addr 0x26113d4, size 0x59c, virtual false, abstract: false, final false
static inline ::System::Collections::IList* GetCrlsFromStore(::Org::BouncyCastle::X509::Store::IX509Store*  crlStore) ;

/// @brief Method GetIssuerAndSerialNumber, addr 0x261286c, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method GetTbsCertificateStructure, addr 0x2629144, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method ReadContentInfo, addr 0x2628fe4, size 0x150, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* ReadContentInfo(::Org::BouncyCastle::Asn1::Asn1InputStream*  aIn) ;

/// @brief Method ReadContentInfo, addr 0x260eaa8, size 0x5c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* ReadContentInfo(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method ReadContentInfo, addr 0x260e7f4, size 0x60, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* ReadContentInfo(::System::IO::Stream*  input) ;

/// @brief Method StreamToByteArray, addr 0x2629134, size 0x8, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> StreamToByteArray(::System::IO::Stream*  inStream) ;

/// @brief Method StreamToByteArray, addr 0x262913c, size 0x8, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> StreamToByteArray(::System::IO::Stream*  inStream, int32_t  limit) ;

/// @brief Method .ctor, addr 0x2629174, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_MaximumMemory, addr 0x2628fdc, size 0x8, virtual false, abstract: false, final false
