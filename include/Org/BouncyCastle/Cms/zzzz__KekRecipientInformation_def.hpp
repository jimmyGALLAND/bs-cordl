...
/// @brief Method GetContentStream, addr 0x262b6e0, size 0x330, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x260cc34, size 0xb0, virtual false, abstract: false, final false
