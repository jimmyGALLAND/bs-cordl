...
/// @brief Method AddCounterSigners, addr 0x26349f8, size 0x514, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Cms::SignerInformation* AddCounterSigners(::Org::BouncyCastle::Cms::SignerInformation*  signerInformation, ::Org::BouncyCastle::Cms::SignerInformationStore*  counterSigners) ;

/// @brief Method DerDecode, addr 0x2634598, size 0xf0, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::DigestInfo* DerDecode(::ArrayW<uint8_t,::Array<uint8_t>*>  encoding) ;

/// @brief Method DoVerify, addr 0x26329dc, size 0x12b0, virtual false, abstract: false, final false
inline bool DoVerify(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  key) ;

/// @brief Method GetContentDigest, addr 0x2631f08, size 0xbc, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetContentDigest() ;

/// @brief Method GetCounterSignatures, addr 0x2632110, size 0x870, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::SignerInformationStore* GetCounterSignatures() ;

/// @brief Method GetEncodedSignedAttributes, addr 0x2632980, size 0x5c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncodedSignedAttributes() ;

/// @brief Method GetSignature, addr 0x2616218, size 0x78, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSignature() ;

/// @brief Method GetSigningTime, addr 0x263471c, size 0x13c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::Time* GetSigningTime() ;

/// @brief Method GetSingleValuedSignedAttribute, addr 0x2633c8c, size 0x1f8, virtual false, abstract: false, final false
...
/// @brief Method IsNull, addr 0x2634514, size 0x84, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Cms::SignerInformation* New_ctor(::Org::BouncyCastle::Asn1::Cms::SignerInfo*  info, ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  contentType, ::Org::BouncyCastle::Cms::CmsProcessable*  content, ::Org::BouncyCastle::Cms::IDigestCalculator*  digestCalculator) ;

/// @brief Method ReplaceUnsignedAttributes, addr 0x26348d0, size 0x128, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Cms::SignerInformation* ReplaceUnsignedAttributes(::Org::BouncyCastle::Cms::SignerInformation*  signerInformation, ::Org::BouncyCastle::Asn1::Cms::AttributeTable*  unsignedAttributes) ;

/// @brief Method ToSignerInfo, addr 0x26348c8, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::SignerInfo* ToSignerInfo() ;

/// @brief Method Verify, addr 0x2634858, size 0x70, virtual false, abstract: false, final false
inline bool Verify(::Org::BouncyCastle::X509::X509Certificate*  cert) ;

/// @brief Method Verify, addr 0x2634688, size 0x94, virtual false, abstract: false, final false
inline bool Verify(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  pubKey) ;

/// @brief Method VerifyDigest, addr 0x2633e84, size 0x690, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2631dc0, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Cms::SignerInformation*  baseInfo) ;

/// @brief Method .ctor, addr 0x260f1dc, size 0x270, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Cms::SignerInfo*  info, ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  contentType, ::Org::BouncyCastle::Cms::CmsProcessable*  content, ::Org::BouncyCastle::Cms::IDigestCalculator*  digestCalculator) ;

static inline ::Org::BouncyCastle::Cms::CmsSignedHelper* getStaticF_Helper() ;

/// @brief Method get_ContentType, addr 0x2631e68, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_ContentType() ;

/// @brief Method get_DigestAlgOid, addr 0x2631ea4, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_DigestAlgOid() ;

/// @brief Method get_DigestAlgParams, addr 0x2631ed0, size 0x38, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* get_DigestAlgParams() ;

/// @brief Method get_DigestAlgorithmID, addr 0x2631e9c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithmID() ;

/// @brief Method get_EncryptionAlgOid, addr 0x2631fcc, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_EncryptionAlgOid() ;

/// @brief Method get_EncryptionAlgParams, addr 0x2631ff8, size 0x38, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* get_EncryptionAlgParams() ;

/// @brief Method get_EncryptionAlgorithmID, addr 0x2631fc4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_EncryptionAlgorithmID() ;

/// @brief Method get_IsCounterSignature, addr 0x2631e60, size 0x8, virtual false, abstract: false, final false
inline bool get_IsCounterSignature() ;

/// @brief Method get_SignedAttributes, addr 0x2632030, size 0x70, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::AttributeTable* get_SignedAttributes() ;

/// @brief Method get_SignerID, addr 0x2631e70, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::SignerID* get_SignerID() ;

/// @brief Method get_UnsignedAttributes, addr 0x26320a0, size 0x70, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::AttributeTable* get_UnsignedAttributes() ;

/// @brief Method get_Version, addr 0x2631e78, size 0x24, virtual false, abstract: false, final false
