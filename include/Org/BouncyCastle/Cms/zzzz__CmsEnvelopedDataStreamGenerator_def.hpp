...
/// @brief Method Close, addr 0x260b1bc, size 0x1dc, virtual true, abstract: false, final false
inline void Close() ;
...
/// @brief Method Write, addr 0x260b198, size 0x24, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  off, int32_t  len) ;

/// @brief Method WriteByte, addr 0x260b174, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x260b124, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Cms::CmsEnvelopedGenerator*  outer, ::Org::BouncyCastle::Crypto::IO::CipherStream*  outStream, ::Org::BouncyCastle::Asn1::BerSequenceGenerator*  cGen, ::Org::BouncyCastle::Asn1::BerSequenceGenerator*  envGen, ::Org::BouncyCastle::Asn1::BerSequenceGenerator*  eiGen) ;
...
/// @brief Method Open, addr 0x260a744, size 0x82c, virtual false, abstract: false, final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStream, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  encAlgID, ::Org::BouncyCastle::Crypto::ICipherParameters*  cipherParameters, ::Org::BouncyCastle::Asn1::Asn1EncodableVector*  recipientInfos) ;

/// @brief Method Open, addr 0x260af70, size 0xd8, virtual false, abstract: false, final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStream, ::StringW  encryptionOid) ;

/// @brief Method Open, addr 0x260a140, size 0x604, virtual false, abstract: false, final false
...
/// @brief Method Open, addr 0x260b048, size 0xdc, virtual false, abstract: false, final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStream, ::StringW  encryptionOid, int32_t  keySize) ;

/// @brief Method SetBerEncodeRecipients, addr 0x260a0bc, size 0xc, virtual false, abstract: false, final false
inline void SetBerEncodeRecipients(bool  berEncodeRecipientSet) ;

/// @brief Method SetBufferSize, addr 0x260a0b4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2609ff4, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x260a04c, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Security::SecureRandom*  rand) ;

/// @brief Method get_Version, addr 0x260a0c8, size 0x78, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Cms::__CmsEnvelopedDataStreamGenerator__CmsEnvelopedDataOutputStream*, "Org.BouncyCastle.Cms", "CmsEnvelopedDataStreamGenerator/CmsEnvelopedDataOutputStream");
