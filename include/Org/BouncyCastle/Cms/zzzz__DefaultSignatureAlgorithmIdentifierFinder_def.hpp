...
static __declspec(property(get=getStaticF_ENCRYPTION_ECGOST3410_2012_256, put=setStaticF_ENCRYPTION_ECGOST3410_2012_256)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  ENCRYPTION_ECGOST3410_2012_256;

/// @brief Field ENCRYPTION_ECGOST3410_2012_512, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_ENCRYPTION_ECGOST3410_2012_512, put=setStaticF_ENCRYPTION_ECGOST3410_2012_512)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  ENCRYPTION_ECGOST3410_2012_512;
...
/// @brief Method CreatePssParams, addr 0x2623d70, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method Find, addr 0x262455c, size 0x54, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* Find(::StringW  sigAlgName) ;

/// @brief Method Generate, addr 0x2623e90, size 0x6cc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26245b0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
