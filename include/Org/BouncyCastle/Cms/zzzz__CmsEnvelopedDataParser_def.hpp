...
/// @brief Method GetRecipientInfos, addr 0x2609db0, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::RecipientInformationStore* GetRecipientInfos() ;

/// @brief Method GetUnprotectedAttributes, addr 0x2609db8, size 0x23c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26099e4, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  envelopedData) ;

/// @brief Method .ctor, addr 0x2609a54, size 0x2f0, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  envelopedData) ;

/// @brief Method get_EncryptionAlgOid, addr 0x2609d4c, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_EncryptionAlgOid() ;

/// @brief Method get_EncryptionAlgParams, addr 0x2609d78, size 0x38, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* get_EncryptionAlgParams() ;

/// @brief Method get_EncryptionAlgorithmID, addr 0x2609d44, size 0x8, virtual false, abstract: false, final false
