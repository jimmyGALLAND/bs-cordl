...
/// @brief Method GetAuthAttrs, addr 0x2605118, size 0x23c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::AttributeTable* GetAuthAttrs() ;

/// @brief Method GetMac, addr 0x2605084, size 0x94, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetMac() ;

/// @brief Method GetRecipientInfos, addr 0x260507c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Cms::RecipientInformationStore* GetRecipientInfos() ;

/// @brief Method GetUnauthAttrs, addr 0x2605354, size 0x23c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2604ca0, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  envelopedData) ;

/// @brief Method .ctor, addr 0x2604d10, size 0x300, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  envelopedData) ;

/// @brief Method get_MacAlgOid, addr 0x2605018, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_MacAlgOid() ;

/// @brief Method get_MacAlgParams, addr 0x2605044, size 0x38, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* get_MacAlgParams() ;

/// @brief Method get_MacAlgorithmID, addr 0x2605010, size 0x8, virtual false, abstract: false, final false
