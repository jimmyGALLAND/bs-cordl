...
/// @brief Method Generate, addr 0x262dacc, size 0x1a8, virtual true, abstract: false, final true
...
/// @brief Method GenerateWrappedKey, addr 0x262dc90, size 0x1d8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x262d8f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x262d8f8, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber*  issuerAndSerialNumber) ;

/// @brief Method .ctor, addr 0x262d920, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmDetails, addr 0x262dc74, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method set_RecipientCert, addr 0x262d994, size 0x58, virtual false, abstract: false, final false
inline void set_RecipientCert(::Org::BouncyCastle::X509::X509Certificate*  value) ;

/// @brief Method set_RecipientPublicKey, addr 0x262d9ec, size 0xd8, virtual false, abstract: false, final false
inline void set_RecipientPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  value) ;

/// @brief Method set_SubjectKeyIdentifier, addr 0x262dac4, size 0x8, virtual false, abstract: false, final false
