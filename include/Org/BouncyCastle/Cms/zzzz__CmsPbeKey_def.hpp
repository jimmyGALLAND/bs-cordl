...
/// @brief Method Finalize, addr 0x260e100, size 0xac, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetEncoded, addr 0x260e2a4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method GetSalt, addr 0x260e218, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x260def8, size 0x208, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x260ddc8, size 0xf4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<char16_t,::Array<char16_t>*>  password, ::ArrayW<uint8_t,::Array<uint8_t>*>  salt, int32_t  iterationCount) ;

/// @brief Method .ctor, addr 0x260debc, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  password, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  keyDerivationAlgorithm) ;

/// @brief Method .ctor, addr 0x260dd84, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::StringW  password, ::ArrayW<uint8_t,::Array<uint8_t>*>  salt, int32_t  iterationCount) ;

/// @brief Method get_Algorithm, addr 0x260e224, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_Algorithm() ;

/// @brief Method get_Format, addr 0x260e264, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_Format() ;

/// @brief Method get_IterationCount, addr 0x260e21c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_IterationCount() ;

/// @brief Method get_Password, addr 0x260e1ac, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Password() ;

/// @brief Method get_Salt, addr 0x260e1bc, size 0x5c, virtual false, abstract: false, final false
