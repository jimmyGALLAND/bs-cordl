...
public:
// Declarations
/// @brief Method GetEncoded, addr 0x2630f00, size 0x12c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2630efc, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2630ebc, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<char16_t,::Array<char16_t>*>  password, ::ArrayW<uint8_t,::Array<uint8_t>*>  salt, int32_t  iterationCount) ;

/// @brief Method .ctor, addr 0x2630ec0, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  password, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  keyDerivationAlgorithm) ;

/// @brief Method .ctor, addr 0x2630e78, size 0x44, virtual false, abstract: false, final false
