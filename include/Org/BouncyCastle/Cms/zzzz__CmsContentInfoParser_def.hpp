...
/// @brief Method Close, addr 0x2604c44, size 0x5c, virtual false, abstract: false, final false
inline void Close() ;
...
/// @brief Method .ctor, addr 0x2604a18, size 0x22c, virtual false, abstract: false, final false
