...
/// @brief Method GetReadable, addr 0x260d318, size 0x3fc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x260d2d8, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  algorithm, ::Org::BouncyCastle::Cms::CmsReadable*  readable) ;

/// @brief Method get_Algorithm, addr 0x260d308, size 0x8, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_Algorithm() ;

/// @brief Method get_CryptoObject, addr 0x260d310, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method GetReadable, addr 0x260d780, size 0x604, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Cms::CmsReadable* GetReadable(::Org::BouncyCastle::Crypto::Parameters::KeyParameter*  sKey) ;
...
/// @brief Method .ctor, addr 0x260d740, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  algorithm, ::Org::BouncyCastle::Cms::CmsReadable*  readable) ;

/// @brief Method get_Algorithm, addr 0x260d770, size 0x8, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_Algorithm() ;

/// @brief Method get_CryptoObject, addr 0x260d778, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_CryptoObject() ;
...
/// @brief Method BuildRecipientInformationStore, addr 0x260bfc8, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method CreateAsymmetricCipher, addr 0x260b9d8, size 0x118, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IBufferedCipher* CreateAsymmetricCipher(::StringW  encryptionOid) ;

/// @brief Method CreateWrapper, addr 0x260baf0, size 0x104, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IWrapper* CreateWrapper(::StringW  encryptionOid) ;

/// @brief Method GetAsymmetricEncryptionAlgName, addr 0x260b940, size 0x98, virtual false, abstract: false, final false
inline ::StringW GetAsymmetricEncryptionAlgName(::StringW  encryptionAlgOid) ;

/// @brief Method GetKeySize, addr 0x260bdc4, size 0x204, virtual false, abstract: false, final false
inline int32_t GetKeySize(::StringW  oid) ;

/// @brief Method GetRfc3211WrapperName, addr 0x260bbf4, size 0x1d0, virtual false, abstract: false, final false
inline ::StringW GetRfc3211WrapperName(::StringW  oid) ;

static inline ::Org::BouncyCastle::Cms::CmsEnvelopedHelper* New_ctor() ;

/// @brief Method ReadRecipientInfo, addr 0x260c0f8, size 0x370, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x260b938, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
