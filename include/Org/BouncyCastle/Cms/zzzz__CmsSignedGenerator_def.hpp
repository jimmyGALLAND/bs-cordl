...
/// @brief Method AddAttributeCertificates, addr 0x2611ddc, size 0x5b8, virtual false, abstract: false, final false
inline void AddAttributeCertificates(::Org::BouncyCastle::X509::Store::IX509Store*  store) ;

/// @brief Method AddCertificates, addr 0x2611d94, size 0x24, virtual false, abstract: false, final false
inline void AddCertificates(::Org::BouncyCastle::X509::Store::IX509Store*  certStore) ;

/// @brief Method AddCrls, addr 0x2611db8, size 0x24, virtual false, abstract: false, final false
inline void AddCrls(::Org::BouncyCastle::X509::Store::IX509Store*  crlStore) ;

/// @brief Method AddSignerCallback, addr 0x26127fc, size 0x4, virtual true, abstract: false, final false
inline void AddSignerCallback(::Org::BouncyCastle::Cms::SignerInformation*  si) ;

/// @brief Method AddSigners, addr 0x2612394, size 0x3e4, virtual false, abstract: false, final false
inline void AddSigners(::Org::BouncyCastle::Cms::SignerInformationStore*  signerStore) ;

/// @brief Method GetAttributeSet, addr 0x2611d20, size 0x74, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Set* GetAttributeSet(::Org::BouncyCastle::Asn1::Cms::AttributeTable*  attr) ;

/// @brief Method GetBaseParameters, addr 0x2611ae4, size 0x23c, virtual true, abstract: false, final false
...
/// @brief Method GetGeneratedDigests, addr 0x2612778, size 0x5c, virtual false, abstract: false, final false
inline ::System::Collections::IDictionary* GetGeneratedDigests() ;

/// @brief Method GetSignerIdentifier, addr 0x2612800, size 0x6c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Cms::SignerIdentifier* GetSignerIdentifier(::Org::BouncyCastle::X509::X509Certificate*  cert) ;

/// @brief Method GetSignerIdentifier, addr 0x26128fc, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26119e8, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2611a44, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_UseDerForCerts, addr 0x26127d4, size 0x8, virtual false, abstract: false, final false
inline bool get_UseDerForCerts() ;

/// @brief Method get_UseDerForCrls, addr 0x26127e8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_UseDerForCerts, addr 0x26127dc, size 0xc, virtual false, abstract: false, final false
inline void set_UseDerForCerts(bool  value) ;

/// @brief Method set_UseDerForCrls, addr 0x26127f0, size 0xc, virtual false, abstract: false, final false
