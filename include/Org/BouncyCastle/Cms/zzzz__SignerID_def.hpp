...
public:
// Declarations
/// @brief Method Equals, addr 0x26318b0, size 0x12c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x263180c, size 0xa4, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::Org::BouncyCastle::Cms::SignerID* New_ctor() ;

/// @brief Method .ctor, addr 0x26319dc, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
