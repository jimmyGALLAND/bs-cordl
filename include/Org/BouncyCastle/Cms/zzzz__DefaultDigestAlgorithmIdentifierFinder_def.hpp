...
/// @brief Method .ctor, addr 0x2616518, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method find, addr 0x26263cc, size 0x198, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* find(::StringW  digAlgName) ;

/// @brief Method find, addr 0x2616520, size 0x258, virtual false, abstract: false, final false
