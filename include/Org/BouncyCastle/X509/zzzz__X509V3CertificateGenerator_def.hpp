...
/// @brief Method AddExtension, addr 0x25b42c8, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method AddExtension, addr 0x25b41e8, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method AddExtension, addr 0x25b4208, size 0xc0, virtual false, abstract: false, final false
inline void AddExtension(::StringW  oid, bool  critical, ::ArrayW<uint8_t,::Array<uint8_t>*>  extensionValue) ;

/// @brief Method AddExtension, addr 0x25b4154, size 0x94, virtual false, abstract: false, final false
inline void AddExtension(::StringW  oid, bool  critical, ::Org::BouncyCastle::Asn1::Asn1Encodable*  extensionValue) ;

/// @brief Method CopyAndAddExtension, addr 0x25b43e0, size 0x19c, virtual false, abstract: false, final false
...
/// @brief Method CopyAndAddExtension, addr 0x25b435c, size 0x84, virtual false, abstract: false, final false
inline void CopyAndAddExtension(::StringW  oid, bool  critical, ::Org::BouncyCastle::X509::X509Certificate*  cert) ;

/// @brief Method Generate, addr 0x25b457c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Certificate* Generate(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  privateKey) ;

/// @brief Method Generate, addr 0x25b4584, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x25b4600, size 0x4a8, virtual false, abstract: false, final false
...
/// @brief Method GenerateJcaObject, addr 0x25b4aa8, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x25b3bd4, size 0x68, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetIssuerDN, addr 0x25b3d14, size 0x1c, virtual false, abstract: false, final false
inline void SetIssuerDN(::Org::BouncyCastle::Asn1::X509::X509Name*  issuer) ;

/// @brief Method SetIssuerUniqueID, addr 0x25b4134, size 0x20, virtual false, abstract: false, final false
inline void SetIssuerUniqueID(::ArrayW<bool,::Array<bool>*>  uniqueID) ;

/// @brief Method SetNotAfter, addr 0x25b3da4, size 0x74, virtual false, abstract: false, final false
inline void SetNotAfter(::System::DateTime  date) ;

/// @brief Method SetNotBefore, addr 0x25b3d30, size 0x74, virtual false, abstract: false, final false
inline void SetNotBefore(::System::DateTime  date) ;

/// @brief Method SetPublicKey, addr 0x25b3e34, size 0x24, virtual false, abstract: false, final false
inline void SetPublicKey(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  publicKey) ;

/// @brief Method SetSerialNumber, addr 0x25b3c3c, size 0xd8, virtual false, abstract: false, final false
inline void SetSerialNumber(::Org::BouncyCastle::Math::BigInteger*  serialNumber) ;

/// @brief Method SetSignatureAlgorithm, addr 0x25b3e58, size 0x164, virtual false, abstract: false, final false
inline void SetSignatureAlgorithm(::StringW  signatureAlgorithm) ;

/// @brief Method SetSubjectDN, addr 0x25b3e18, size 0x1c, virtual false, abstract: false, final false
inline void SetSubjectDN(::Org::BouncyCastle::Asn1::X509::X509Name*  subject) ;

/// @brief Method SetSubjectUniqueID, addr 0x25b3fbc, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25b3b3c, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method booleanToBitString, addr 0x25b3fdc, size 0x158, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerBitString* booleanToBitString(::ArrayW<bool,::Array<bool>*>  id) ;

/// @brief Method get_SignatureAlgNames, addr 0x25b4b78, size 0x4c, virtual false, abstract: false, final false
