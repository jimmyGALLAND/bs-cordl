...
/// @brief Method CreateX509Certificate, addr 0x25a7eac, size 0x58, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Certificate* CreateX509Certificate(::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*  c) ;

/// @brief Method GetCertificate, addr 0x25a7d20, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method ReadCertificate, addr 0x25a7f74, size 0x2cc, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Certificate* ReadCertificate(::System::IO::Stream*  inStream) ;

/// @brief Method ReadCertificate, addr 0x25a7f04, size 0x70, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Certificate* ReadCertificate(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method ReadCertificates, addr 0x25a82b0, size 0x110, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* ReadCertificates(::System::IO::Stream*  inStream) ;

/// @brief Method ReadCertificates, addr 0x25a8240, size 0x70, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* ReadCertificates(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method ReadDerCertificate, addr 0x25a7b08, size 0x218, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Certificate* ReadDerCertificate(::Org::BouncyCastle::Asn1::Asn1InputStream*  dIn) ;

/// @brief Method ReadPemCertificate, addr 0x25a7e04, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25a8450, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
