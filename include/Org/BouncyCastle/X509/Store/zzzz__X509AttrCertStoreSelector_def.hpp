...
/// @brief Method AddTargetGroup, addr 0x259ebe8, size 0xa8, virtual false, abstract: false, final false
inline void AddTargetGroup(::Org::BouncyCastle::Asn1::X509::GeneralName*  group) ;

/// @brief Method AddTargetGroup, addr 0x259ec90, size 0x2c, virtual false, abstract: false, final false
inline void AddTargetGroup(::ArrayW<uint8_t,::Array<uint8_t>*>  name) ;

/// @brief Method AddTargetName, addr 0x259e6b4, size 0x2c, virtual false, abstract: false, final false
inline void AddTargetName(::ArrayW<uint8_t,::Array<uint8_t>*>  name) ;

/// @brief Method AddTargetName, addr 0x259e60c, size 0xa8, virtual false, abstract: false, final false
inline void AddTargetName(::Org::BouncyCastle::Asn1::X509::GeneralName*  name) ;

/// @brief Method Clone, addr 0x259e554, size 0x58, virtual true, abstract: false, final true
inline ::System::Object* Clone() ;

/// @brief Method ExtractGeneralNames, addr 0x259e6f8, size 0x490, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Collections::ISet* ExtractGeneralNames(::System::Collections::IEnumerable*  names) ;

/// @brief Method GetTargetGroups, addr 0x259ecd4, size 0x60, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerable* GetTargetGroups() ;

/// @brief Method GetTargetNames, addr 0x259eb88, size 0x60, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerable* GetTargetNames() ;

/// @brief Method Match, addr 0x259dd3c, size 0x818, virtual true, abstract: false, final true
...
/// @brief Method SetTargetGroups, addr 0x259ecbc, size 0x18, virtual false, abstract: false, final false
inline void SetTargetGroups(::System::Collections::IEnumerable*  names) ;

/// @brief Method SetTargetNames, addr 0x259e6e0, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x259dbcc, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x259dc44, size 0xf8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::X509::Store::X509AttrCertStoreSelector*  o) ;

/// @brief Method get_AttribueCertificateValid, addr 0x259e5bc, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Date::DateTimeObject* get_AttribueCertificateValid() ;

/// @brief Method get_AttributeCert, addr 0x259e5ac, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::IX509AttributeCertificate* get_AttributeCert() ;

/// @brief Method get_AttributeCertificateValid, addr 0x259e5cc, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Date::DateTimeObject* get_AttributeCertificateValid() ;

/// @brief Method get_Holder, addr 0x259e5dc, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::AttributeCertificateHolder* get_Holder() ;

/// @brief Method get_Issuer, addr 0x259e5ec, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::AttributeCertificateIssuer* get_Issuer() ;

/// @brief Method get_SerialNumber, addr 0x259e5fc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_AttribueCertificateValid, addr 0x259e5c4, size 0x8, virtual false, abstract: false, final false
inline void set_AttribueCertificateValid(::Org::BouncyCastle::Utilities::Date::DateTimeObject*  value) ;

/// @brief Method set_AttributeCert, addr 0x259e5b4, size 0x8, virtual false, abstract: false, final false
inline void set_AttributeCert(::Org::BouncyCastle::X509::IX509AttributeCertificate*  value) ;

/// @brief Method set_AttributeCertificateValid, addr 0x259e5d4, size 0x8, virtual false, abstract: false, final false
inline void set_AttributeCertificateValid(::Org::BouncyCastle::Utilities::Date::DateTimeObject*  value) ;

/// @brief Method set_Holder, addr 0x259e5e4, size 0x8, virtual false, abstract: false, final false
inline void set_Holder(::Org::BouncyCastle::X509::AttributeCertificateHolder*  value) ;

/// @brief Method set_Issuer, addr 0x259e5f4, size 0x8, virtual false, abstract: false, final false
inline void set_Issuer(::Org::BouncyCastle::X509::AttributeCertificateIssuer*  value) ;

/// @brief Method set_SerialNumber, addr 0x259e604, size 0x8, virtual false, abstract: false, final false
