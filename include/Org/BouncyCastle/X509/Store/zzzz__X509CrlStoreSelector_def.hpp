...
/// @brief Method Clone, addr 0x259f7f4, size 0x58, virtual true, abstract: false, final false
inline ::System::Object* Clone() ;

/// @brief Method Match, addr 0x259f9b8, size 0x710, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x259f6c0, size 0x84, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::X509::Store::X509CrlStoreSelector*  o) ;

/// @brief Method get_AttrCertChecking, addr 0x259f8f4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::IX509AttributeCertificate* get_AttrCertChecking() ;

/// @brief Method get_CertificateChecking, addr 0x259f84c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Certificate* get_CertificateChecking() ;

/// @brief Method get_CompleteCrlEnabled, addr 0x259f904, size 0x8, virtual false, abstract: false, final false
inline bool get_CompleteCrlEnabled() ;

/// @brief Method get_DateAndTime, addr 0x259f85c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Date::DateTimeObject* get_DateAndTime() ;

/// @brief Method get_DeltaCrlIndicatorEnabled, addr 0x259f918, size 0x8, virtual false, abstract: false, final false
inline bool get_DeltaCrlIndicatorEnabled() ;

/// @brief Method get_Issuers, addr 0x259f744, size 0x58, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* get_Issuers() ;

/// @brief Method get_IssuingDistributionPoint, addr 0x259f79c, size 0x58, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_IssuingDistributionPoint() ;

/// @brief Method get_IssuingDistributionPointEnabled, addr 0x259f994, size 0x8, virtual false, abstract: false, final false
inline bool get_IssuingDistributionPointEnabled() ;

/// @brief Method get_MaxBaseCrlNumber, addr 0x259f9a8, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_MaxBaseCrlNumber() ;

/// @brief Method get_MaxCrlNumber, addr 0x259f8d4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_MaxCrlNumber() ;

/// @brief Method get_MinCrlNumber, addr 0x259f8e4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_AttrCertChecking, addr 0x259f8fc, size 0x8, virtual false, abstract: false, final false
inline void set_AttrCertChecking(::Org::BouncyCastle::X509::IX509AttributeCertificate*  value) ;

/// @brief Method set_CertificateChecking, addr 0x259f854, size 0x8, virtual false, abstract: false, final false
inline void set_CertificateChecking(::Org::BouncyCastle::X509::X509Certificate*  value) ;

/// @brief Method set_CompleteCrlEnabled, addr 0x259f90c, size 0xc, virtual false, abstract: false, final false
inline void set_CompleteCrlEnabled(bool  value) ;

/// @brief Method set_DateAndTime, addr 0x259f864, size 0x8, virtual false, abstract: false, final false
inline void set_DateAndTime(::Org::BouncyCastle::Utilities::Date::DateTimeObject*  value) ;

/// @brief Method set_DeltaCrlIndicatorEnabled, addr 0x259f920, size 0xc, virtual false, abstract: false, final false
inline void set_DeltaCrlIndicatorEnabled(bool  value) ;

/// @brief Method set_Issuers, addr 0x259f86c, size 0x68, virtual false, abstract: false, final false
inline void set_Issuers(::System::Collections::ICollection*  value) ;

/// @brief Method set_IssuingDistributionPoint, addr 0x259f92c, size 0x68, virtual false, abstract: false, final false
inline void set_IssuingDistributionPoint(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method set_IssuingDistributionPointEnabled, addr 0x259f99c, size 0xc, virtual false, abstract: false, final false
inline void set_IssuingDistributionPointEnabled(bool  value) ;

/// @brief Method set_MaxBaseCrlNumber, addr 0x259f9b0, size 0x8, virtual false, abstract: false, final false
inline void set_MaxBaseCrlNumber(::Org::BouncyCastle::Math::BigInteger*  value) ;

/// @brief Method set_MaxCrlNumber, addr 0x259f8dc, size 0x8, virtual false, abstract: false, final false
inline void set_MaxCrlNumber(::Org::BouncyCastle::Math::BigInteger*  value) ;

/// @brief Method set_MinCrlNumber, addr 0x259f8ec, size 0x8, virtual false, abstract: false, final false
