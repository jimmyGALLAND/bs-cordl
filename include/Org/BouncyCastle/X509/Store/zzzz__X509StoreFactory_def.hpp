...
public:
// Declarations
/// @brief Method Create, addr 0x25a00d0, size 0x3b4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25a00c8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method checkCorrectType, addr 0x25a0484, size 0x374, virtual false, abstract: false, final false
