...
/// @brief Method Clone, addr 0x259ef94, size 0x58, virtual true, abstract: false, final true
inline ::System::Object* Clone() ;

/// @brief Method CloneSelector, addr 0x259ed34, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Match, addr 0x259ee6c, size 0x128, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x259edc0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x259edc8, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::X509::Store::X509CertPairStoreSelector*  o) ;

/// @brief Method get_CertPair, addr 0x259ee24, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509CertificatePair* get_CertPair() ;

/// @brief Method get_ForwardSelector, addr 0x259ee14, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::Store::X509CertStoreSelector* get_ForwardSelector() ;

/// @brief Method get_ReverseSelector, addr 0x259ee1c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_CertPair, addr 0x259ee2c, size 0x8, virtual false, abstract: false, final false
inline void set_CertPair(::Org::BouncyCastle::X509::X509CertificatePair*  value) ;

/// @brief Method set_ForwardSelector, addr 0x259ee34, size 0x1c, virtual false, abstract: false, final false
inline void set_ForwardSelector(::Org::BouncyCastle::X509::Store::X509CertStoreSelector*  value) ;

/// @brief Method set_ReverseSelector, addr 0x259ee50, size 0x1c, virtual false, abstract: false, final false
