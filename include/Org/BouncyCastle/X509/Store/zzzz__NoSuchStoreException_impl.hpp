...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::X509::Store::NoSuchStoreException::*)()>(&::Org::BouncyCastle::X509::Store::NoSuchStoreException::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x259dbc0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::X509::Store::NoSuchStoreException::*)(::StringW)>(&::Org::BouncyCastle::X509::Store::NoSuchStoreException::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x259dbc4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::X509::Store::NoSuchStoreException::*)(::StringW, ::System::Exception*)>(&::Org::BouncyCastle::X509::Store::NoSuchStoreException::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x259dbc8;
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Org::BouncyCastle::X509::Store::NoSuchStoreException*>());
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Org::BouncyCastle::X509::Store::NoSuchStoreException*>(message));
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Org::BouncyCastle::X509::Store::NoSuchStoreException*>(message, e));
}
