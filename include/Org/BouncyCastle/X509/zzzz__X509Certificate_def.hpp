...
/// @brief Method CheckSignature, addr 0x25a71a0, size 0x3dc, virtual true, abstract: false, final false
inline void CheckSignature(::Org::BouncyCastle::Crypto::IVerifierFactory*  verifier) ;

/// @brief Method CheckValidity, addr 0x25a5378, size 0x6c, virtual true, abstract: false, final false
inline void CheckValidity() ;

/// @brief Method CheckValidity, addr 0x25a53e4, size 0x1ec, virtual true, abstract: false, final false
inline void CheckValidity(::System::DateTime  time) ;

/// @brief Method Equals, addr 0x25a61b4, size 0x118, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method GetAlternativeNames, addr 0x25a5de8, size 0x2d8, virtual true, abstract: false, final false
inline ::System::Collections::ICollection* GetAlternativeNames(::StringW  oid) ;

/// @brief Method GetBasicConstraints, addr 0x25a5cd8, size 0x68, virtual true, abstract: false, final false
inline int32_t GetBasicConstraints() ;

/// @brief Method GetEncoded, addr 0x25a6198, size 0x1c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method GetExtendedKeyUsage, addr 0x25a5818, size 0x4c0, virtual true, abstract: false, final false
inline ::System::Collections::IList* GetExtendedKeyUsage() ;

/// @brief Method GetHashCode, addr 0x25a62cc, size 0x5c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetIssuerAlternativeNames, addr 0x25a5d94, size 0x54, virtual true, abstract: false, final false
inline ::System::Collections::ICollection* GetIssuerAlternativeNames() ;

/// @brief Method GetKeyUsage, addr 0x25a57bc, size 0x5c, virtual true, abstract: false, final false
inline ::ArrayW<bool,::Array<bool>*> GetKeyUsage() ;

/// @brief Method GetPublicKey, addr 0x25a6104, size 0x94, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* GetPublicKey() ;

/// @brief Method GetSigAlgParams, addr 0x25a5718, size 0x5c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSigAlgParams() ;

/// @brief Method GetSignature, addr 0x25a56c0, size 0x1c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSignature() ;

/// @brief Method GetSubjectAlternativeNames, addr 0x25a5d40, size 0x54, virtual true, abstract: false, final false
inline ::System::Collections::ICollection* GetSubjectAlternativeNames() ;

/// @brief Method GetTbsCertificate, addr 0x25a569c, size 0x24, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetTbsCertificate() ;

/// @brief Method GetX509Extensions, addr 0x25a60c0, size 0x44, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* GetX509Extensions() ;

/// @brief Method IsAlgIDEqual, addr 0x25a757c, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x25a5278, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method ToString, addr 0x25a6328, size 0xd24, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Verify, addr 0x25a704c, size 0x8c, virtual true, abstract: false, final false
inline void Verify(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  key) ;

/// @brief Method Verify, addr 0x25a70d8, size 0xc8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25a49c0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25a4a20, size 0x4f8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*  c) ;

/// @brief Method get_CertificateStructure, addr 0x25a5204, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* get_CertificateStructure() ;

/// @brief Method get_IsValidNow, addr 0x25a520c, size 0x6c, virtual true, abstract: false, final false
inline bool get_IsValidNow() ;

/// @brief Method get_IssuerDN, addr 0x25a5614, size 0x1c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_IssuerDN() ;

/// @brief Method get_IssuerUniqueID, addr 0x25a5774, size 0x24, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerBitString* get_IssuerUniqueID() ;

/// @brief Method get_NotAfter, addr 0x25a5674, size 0x28, virtual true, abstract: false, final false
inline ::System::DateTime get_NotAfter() ;

/// @brief Method get_NotBefore, addr 0x25a564c, size 0x28, virtual true, abstract: false, final false
inline ::System::DateTime get_NotBefore() ;

/// @brief Method get_SerialNumber, addr 0x25a55ec, size 0x28, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_SerialNumber() ;

/// @brief Method get_SigAlgName, addr 0x25a56dc, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_SigAlgName() ;

/// @brief Method get_SigAlgOid, addr 0x25a56e4, size 0x34, virtual true, abstract: false, final false
inline ::StringW get_SigAlgOid() ;

/// @brief Method get_SubjectDN, addr 0x25a5630, size 0x1c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_SubjectDN() ;

/// @brief Method get_SubjectUniqueID, addr 0x25a5798, size 0x24, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerBitString* get_SubjectUniqueID() ;

/// @brief Method get_Version, addr 0x25a55d0, size 0x1c, virtual true, abstract: false, final false
