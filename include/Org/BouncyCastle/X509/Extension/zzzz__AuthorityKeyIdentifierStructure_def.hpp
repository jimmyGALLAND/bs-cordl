...
public:
// Declarations
/// @brief Method FromCertificate, addr 0x259c7a4, size 0x3d4, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Asn1Sequence* FromCertificate(::Org::BouncyCastle::X509::X509Certificate*  certificate) ;

/// @brief Method FromKey, addr 0x259cb78, size 0x194, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x259cd0c, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::X509::X509Certificate*  certificate) ;

/// @brief Method .ctor, addr 0x259c6ec, size 0x94, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString*  encodedValue) ;

/// @brief Method .ctor, addr 0x259cd30, size 0x24, virtual false, abstract: false, final false
