...
public:
// Declarations
/// @brief Method FromPublicKey, addr 0x259cde8, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x259cd54, size 0x94, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString*  encodedValue) ;

/// @brief Method .ctor, addr 0x259cf98, size 0x24, virtual false, abstract: false, final false
