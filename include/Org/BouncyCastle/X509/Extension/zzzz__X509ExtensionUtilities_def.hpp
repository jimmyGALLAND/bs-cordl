...
public:
// Declarations
/// @brief Method FromExtensionValue, addr 0x259c780, size 0x24, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Asn1Object* FromExtensionValue(::Org::BouncyCastle::Asn1::Asn1OctetString*  extensionValue) ;

/// @brief Method GetAlternativeName, addr 0x259d030, size 0x9e4, virtual false, abstract: false, final false
static inline ::System::Collections::ICollection* GetAlternativeName(::Org::BouncyCastle::Asn1::Asn1OctetString*  extVal) ;

/// @brief Method GetIssuerAlternativeNames, addr 0x259cfbc, size 0x74, virtual false, abstract: false, final false
static inline ::System::Collections::ICollection* GetIssuerAlternativeNames(::Org::BouncyCastle::X509::X509Certificate*  cert) ;

/// @brief Method GetSubjectAlternativeNames, addr 0x259da14, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x259da88, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
