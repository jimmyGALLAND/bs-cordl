...
/// @brief Method ReadCertPair, addr 0x25a85b8, size 0x234, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509CertificatePair* ReadCertPair(::System::IO::Stream*  inStream) ;

/// @brief Method ReadCertPair, addr 0x25a8548, size 0x70, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509CertificatePair* ReadCertPair(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method ReadCertPairs, addr 0x25a885c, size 0x110, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* ReadCertPairs(::System::IO::Stream*  inStream) ;

/// @brief Method ReadCertPairs, addr 0x25a87ec, size 0x70, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* ReadCertPairs(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method ReadDerCrossCertificatePair, addr 0x25a8458, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25a896c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
