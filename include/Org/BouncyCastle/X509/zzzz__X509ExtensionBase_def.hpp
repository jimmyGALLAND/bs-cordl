...
/// @brief Method GetCriticalExtensionOids, addr 0x24cf430, size 0x10, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Collections::ISet* GetCriticalExtensionOids() ;

/// @brief Method GetExtensionOids, addr 0x24cf028, size 0x3f8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Collections::ISet* GetExtensionOids(bool  critical) ;

/// @brief Method GetExtensionValue, addr 0x24cf4b4, size 0x38, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1OctetString* GetExtensionValue(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method GetExtensionValue, addr 0x24cf440, size 0x74, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Asn1::Asn1OctetString* GetExtensionValue(::StringW  oid) ;

/// @brief Method GetNonCriticalExtensionOids, addr 0x24cf420, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24cf4ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
