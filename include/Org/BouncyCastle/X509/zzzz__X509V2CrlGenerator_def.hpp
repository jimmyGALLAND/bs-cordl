...
/// @brief Method AddCrl, addr 0x25b2c34, size 0x490, virtual false, abstract: false, final false
inline void AddCrl(::Org::BouncyCastle::X509::X509Crl*  other) ;

/// @brief Method AddCrlEntry, addr 0x25b2b74, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method AddCrlEntry, addr 0x25b29b8, size 0xc0, virtual false, abstract: false, final false
inline void AddCrlEntry(::Org::BouncyCastle::Math::BigInteger*  userCertificate, ::System::DateTime  revocationDate, int32_t  reason) ;

/// @brief Method AddCrlEntry, addr 0x25b2a78, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method AddExtension, addr 0x25b3398, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method AddExtension, addr 0x25b32b8, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method AddExtension, addr 0x25b32d8, size 0xc0, virtual false, abstract: false, final false
inline void AddExtension(::StringW  oid, bool  critical, ::ArrayW<uint8_t,::Array<uint8_t>*>  extensionValue) ;

/// @brief Method AddExtension, addr 0x25b3224, size 0x94, virtual false, abstract: false, final false
inline void AddExtension(::StringW  oid, bool  critical, ::Org::BouncyCastle::Asn1::Asn1Encodable*  extensionValue) ;

/// @brief Method Generate, addr 0x25b342c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Crl* Generate(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  privateKey) ;

/// @brief Method Generate, addr 0x25b3434, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x25b34b0, size 0x464, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Crl* Generate(::Org::BouncyCastle::Crypto::ISignatureFactory*  signatureCalculatorFactory) ;

/// @brief Method GenerateCertList, addr 0x25b3914, size 0x58, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::TbsCertificateList* GenerateCertList() ;

/// @brief Method GenerateJcaObject, addr 0x25b396c, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x25b284c, size 0x68, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetIssuerDN, addr 0x25b28b4, size 0x1c, virtual false, abstract: false, final false
inline void SetIssuerDN(::Org::BouncyCastle::Asn1::X509::X509Name*  issuer) ;

/// @brief Method SetNextUpdate, addr 0x25b2944, size 0x74, virtual false, abstract: false, final false
inline void SetNextUpdate(::System::DateTime  date) ;

/// @brief Method SetSignatureAlgorithm, addr 0x25b30c4, size 0x160, virtual false, abstract: false, final false
inline void SetSignatureAlgorithm(::StringW  signatureAlgorithm) ;

/// @brief Method SetThisUpdate, addr 0x25b28d0, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25b27b4, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_SignatureAlgNames, addr 0x25b3af0, size 0x4c, virtual false, abstract: false, final false
