...
/// @brief Method CreateX509Crl, addr 0x25ac13c, size 0x58, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Crl* CreateX509Crl(::Org::BouncyCastle::Asn1::X509::CertificateList*  c) ;

/// @brief Method GetCrl, addr 0x25ac0b8, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method ReadCrl, addr 0x25ac204, size 0x338, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Crl* ReadCrl(::System::IO::Stream*  inStream) ;

/// @brief Method ReadCrl, addr 0x25ac194, size 0x70, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Crl* ReadCrl(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method ReadCrls, addr 0x25ac5ac, size 0x110, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* ReadCrls(::System::IO::Stream*  inStream) ;

/// @brief Method ReadCrls, addr 0x25ac53c, size 0x70, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* ReadCrls(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method ReadDerCrl, addr 0x25abea0, size 0x218, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Crl* ReadDerCrl(::Org::BouncyCastle::Asn1::Asn1InputStream*  dIn) ;

/// @brief Method ReadPemCrl, addr 0x25abdf8, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25abdb4, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25abdd0, size 0x28, virtual false, abstract: false, final false
