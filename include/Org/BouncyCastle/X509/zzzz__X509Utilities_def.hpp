...
/// @brief Method CreatePssParams, addr 0x25af158, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method GetAlgNames, addr 0x25af7b0, size 0x108, virtual false, abstract: false, final false
static inline ::System::Collections::IEnumerable* GetAlgNames() ;

/// @brief Method GetAlgorithmOid, addr 0x25af278, size 0x208, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetAlgorithmOid(::StringW  algorithmName) ;

/// @brief Method GetSigAlgID, addr 0x25af480, size 0x330, virtual false, abstract: false, final false
...
/// @brief Method GetSignatureForObject, addr 0x25af8b8, size 0x2c8, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSignatureForObject(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  sigOid, ::StringW  sigName, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  privateKey, ::Org::BouncyCastle::Security::SecureRandom*  random, ::Org::BouncyCastle::Asn1::Asn1Encodable*  ae) ;

static inline ::Org::BouncyCastle::X509::X509Utilities* New_ctor() ;

/// @brief Method .ctor, addr 0x25afb80, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
