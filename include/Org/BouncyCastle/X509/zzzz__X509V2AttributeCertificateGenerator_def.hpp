...
/// @brief Method AddAttribute, addr 0x25b1fe0, size 0x44, virtual false, abstract: false, final false
inline void AddAttribute(::Org::BouncyCastle::X509::X509Attribute*  attribute) ;

/// @brief Method AddExtension, addr 0x25b20fc, size 0x94, virtual false, abstract: false, final false
inline void AddExtension(::StringW  oid, bool  critical, ::ArrayW<uint8_t,::Array<uint8_t>*>  extensionValue) ;

/// @brief Method AddExtension, addr 0x25b2068, size 0x94, virtual false, abstract: false, final false
inline void AddExtension(::StringW  oid, bool  critical, ::Org::BouncyCastle::Asn1::Asn1Encodable*  extensionValue) ;

/// @brief Method Generate, addr 0x25b2190, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x25b2198, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x25b2214, size 0x554, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x25b1c74, size 0x68, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetHolder, addr 0x25b1cdc, size 0x24, virtual false, abstract: false, final false
inline void SetHolder(::Org::BouncyCastle::X509::AttributeCertificateHolder*  holder) ;

/// @brief Method SetIssuer, addr 0x25b1d00, size 0x2c, virtual false, abstract: false, final false
inline void SetIssuer(::Org::BouncyCastle::X509::AttributeCertificateIssuer*  issuer) ;

/// @brief Method SetIssuerUniqueId, addr 0x25b2024, size 0x44, virtual false, abstract: false, final false
inline void SetIssuerUniqueId(::ArrayW<bool,::Array<bool>*>  iui) ;

/// @brief Method SetNotAfter, addr 0x25b1e14, size 0x74, virtual false, abstract: false, final false
inline void SetNotAfter(::System::DateTime  date) ;

/// @brief Method SetNotBefore, addr 0x25b1da0, size 0x74, virtual false, abstract: false, final false
inline void SetNotBefore(::System::DateTime  date) ;

/// @brief Method SetSerialNumber, addr 0x25b1d2c, size 0x74, virtual false, abstract: false, final false
inline void SetSerialNumber(::Org::BouncyCastle::Math::BigInteger*  serialNumber) ;

/// @brief Method SetSignatureAlgorithm, addr 0x25b1e88, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25b1bdc, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_SignatureAlgNames, addr 0x25b2768, size 0x4c, virtual false, abstract: false, final false
