...
/// @brief Method CheckSignature, addr 0x25a8d9c, size 0x3e4, virtual true, abstract: false, final false
inline void CheckSignature(::Org::BouncyCastle::Crypto::IVerifierFactory*  verifier) ;

/// @brief Method Equals, addr 0x25a9dc4, size 0x118, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method GetEncoded, addr 0x25a8b6c, size 0xf0, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method GetHashCode, addr 0x25a9edc, size 0x5c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetRevokedCertificate, addr 0x25a9744, size 0x414, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509CrlEntry* GetRevokedCertificate(::Org::BouncyCastle::Math::BigInteger*  serialNumber) ;

/// @brief Method GetRevokedCertificates, addr 0x25a9b58, size 0xb8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Collections::ISet* GetRevokedCertificates() ;

/// @brief Method GetSigAlgParams, addr 0x25a9d68, size 0x5c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSigAlgParams() ;

/// @brief Method GetSignature, addr 0x25a9d10, size 0x1c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSignature() ;

/// @brief Method GetTbsCertList, addr 0x25a9c10, size 0x100, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetTbsCertList() ;

/// @brief Method GetX509Extensions, addr 0x25a8b28, size 0x44, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* GetX509Extensions() ;

/// @brief Method IsRevoked, addr 0x25aaef0, size 0xc4, virtual true, abstract: false, final false
inline bool IsRevoked(::Org::BouncyCastle::X509::X509Certificate*  cert) ;

/// @brief Method LoadCrlEntries, addr 0x25a9278, size 0x480, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x25a9f38, size 0xfb8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Verify, addr 0x25a8c5c, size 0x78, virtual true, abstract: false, final false
inline void Verify(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  publicKey) ;

/// @brief Method Verify, addr 0x25a8cd4, size 0xc8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25a8974, size 0x1b4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::CertificateList*  c) ;

/// @brief Method get_IsIndirectCrl, addr 0x25aafb4, size 0x15c, virtual true, abstract: false, final false
inline bool get_IsIndirectCrl() ;

/// @brief Method get_IssuerDN, addr 0x25a919c, size 0x1c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_IssuerDN() ;

/// @brief Method get_NextUpdate, addr 0x25a91e0, size 0x98, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Date::DateTimeObject* get_NextUpdate() ;

/// @brief Method get_SigAlgName, addr 0x25a9d2c, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_SigAlgName() ;

/// @brief Method get_SigAlgOid, addr 0x25a9d34, size 0x34, virtual true, abstract: false, final false
inline ::StringW get_SigAlgOid() ;

/// @brief Method get_ThisUpdate, addr 0x25a91b8, size 0x28, virtual true, abstract: false, final false
inline ::System::DateTime get_ThisUpdate() ;

/// @brief Method get_Version, addr 0x25a9180, size 0x1c, virtual true, abstract: false, final false
