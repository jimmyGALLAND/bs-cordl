...
/// @brief Method GetDigestAlgName, addr 0x25ac850, size 0x370, virtual false, abstract: false, final false
static inline ::StringW GetDigestAlgName(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  digestAlgOID) ;

/// @brief Method GetSignatureName, addr 0x25a4f18, size 0x2ec, virtual false, abstract: false, final false
...
/// @brief Method SetSignatureParameters, addr 0x25ac7d4, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25acc38, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
