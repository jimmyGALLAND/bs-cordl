...
/// @brief Method ReadImplicit, addr 0x25e4bf0, size 0x2ac, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadImplicit(bool  constructed, int32_t  tag) ;

/// @brief Method ReadIndef, addr 0x25e4a78, size 0x178, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadIndef(int32_t  tagValue) ;

/// @brief Method ReadObject, addr 0x25e50cc, size 0x60c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject() ;

/// @brief Method ReadTaggedObject, addr 0x25df8a4, size 0x23c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* ReadTaggedObject(bool  constructed, int32_t  tag) ;

/// @brief Method ReadVector, addr 0x25e4f14, size 0x128, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1EncodableVector* ReadVector() ;

/// @brief Method Set00Check, addr 0x25e56d8, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25e49fc, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  encoding) ;

/// @brief Method .ctor, addr 0x25df874, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  inStream) ;

/// @brief Method .ctor, addr 0x25e0f54, size 0xec, virtual false, abstract: false, final false
