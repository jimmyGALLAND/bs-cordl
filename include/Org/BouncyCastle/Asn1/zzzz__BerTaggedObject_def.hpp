...
public:
// Declarations
/// @brief Method Encode, addr 0x25e9d10, size 0x5bc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25e50c4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(bool  explicitly, int32_t  tagNo, ::Org::BouncyCastle::Asn1::Asn1Encodable*  obj) ;

/// @brief Method .ctor, addr 0x25e9c9c, size 0x74, virtual false, abstract: false, final false
inline void _ctor(int32_t  tagNo) ;

/// @brief Method .ctor, addr 0x25e9c58, size 0x44, virtual false, abstract: false, final false
