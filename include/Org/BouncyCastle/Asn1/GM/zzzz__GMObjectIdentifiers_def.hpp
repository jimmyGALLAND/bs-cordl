...
static __declspec(property(get=getStaticF_sm2encrypt_recommendedParameters, put=setStaticF_sm2encrypt_recommendedParameters)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  sm2encrypt_recommendedParameters;

/// @brief Field sm2encrypt_specifiedParameters, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_sm2encrypt_specifiedParameters, put=setStaticF_sm2encrypt_specifiedParameters)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  sm2encrypt_specifiedParameters;
...
/// @brief Method .ctor, addr 0x22df484, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
