...
public:
// Declarations
/// @brief Method CreateDerSequence, addr 0x25f0bcc, size 0x70, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerSequence* CreateDerSequence(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream*  dIn) ;

/// @brief Method CreateDerSet, addr 0x25f0ca4, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25f0b98, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method .ctor, addr 0x25f0b9c, size 0x30, virtual false, abstract: false, final false
