...
/// @brief Method ToAsn1Object, addr 0x25dced8, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25dba0c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::EC::ECFieldElement*  f) ;

/// @brief Method .ctor, addr 0x25dcddc, size 0xf4, virtual false, abstract: false, final false
inline void _ctor(int32_t  m, int32_t  k1, int32_t  k2, int32_t  k3, ::Org::BouncyCastle::Asn1::Asn1OctetString*  s) ;

/// @brief Method .ctor, addr 0x25dcd10, size 0xcc, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::BigInteger*  p, ::Org::BouncyCastle::Asn1::Asn1OctetString*  s) ;

/// @brief Method get_Value, addr 0x25dced0, size 0x8, virtual false, abstract: false, final false
