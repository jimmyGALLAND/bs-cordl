...
public:
// Declarations
/// @brief Method GetByteLength, addr 0x25dd2bc, size 0x34, virtual false, abstract: false, final false
static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECCurve*  c) ;

/// @brief Method GetByteLength, addr 0x25dcf84, size 0x34, virtual false, abstract: false, final false
static inline int32_t GetByteLength(::Org::BouncyCastle::Math::EC::ECFieldElement*  fe) ;

/// @brief Method IntegerToBytes, addr 0x25dcfb8, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25dd2f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
