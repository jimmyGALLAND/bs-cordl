...
/// @brief Method GetInstance, addr 0x25da7ec, size 0x294, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x25dac38, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25daaa8, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X9::X9ECParameters*  ecParameters) ;

/// @brief Method .ctor, addr 0x25daae8, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  namedCurve) ;

/// @brief Method .ctor, addr 0x25dab10, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Null*  obj) ;

/// @brief Method .ctor, addr 0x25daa80, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object*  obj) ;

/// @brief Method get_IsImplicitlyCA, addr 0x25dabb4, size 0x7c, virtual false, abstract: false, final false
inline bool get_IsImplicitlyCA() ;

/// @brief Method get_IsNamedCurve, addr 0x25dab38, size 0x7c, virtual false, abstract: false, final false
inline bool get_IsNamedCurve() ;

/// @brief Method get_Parameters, addr 0x25dac30, size 0x8, virtual false, abstract: false, final false
