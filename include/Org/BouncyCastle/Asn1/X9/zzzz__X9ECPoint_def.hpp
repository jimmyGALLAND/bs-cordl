...
/// @brief Method GetPointEncoding, addr 0x25dcc44, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x25dcd08, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25d5fe0, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve*  c, ::ArrayW<uint8_t,::Array<uint8_t>*>  encoding) ;

/// @brief Method .ctor, addr 0x25dc2d4, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve*  c, ::Org::BouncyCastle::Asn1::Asn1OctetString*  s) ;

/// @brief Method .ctor, addr 0x25dc3c4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::EC::ECPoint*  p) ;

/// @brief Method .ctor, addr 0x25dcb8c, size 0xb4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::EC::ECPoint*  p, bool  compressed) ;

/// @brief Method get_IsPointCompressed, addr 0x25dccbc, size 0x4c, virtual false, abstract: false, final false
inline bool get_IsPointCompressed() ;

/// @brief Method get_Point, addr 0x25d6090, size 0x70, virtual false, abstract: false, final false
