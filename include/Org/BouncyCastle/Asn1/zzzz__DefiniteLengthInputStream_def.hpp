...
/// @brief Method Read, addr 0x25eadd4, size 0x24c, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method ReadAllIntoByteArray, addr 0x25e15c0, size 0x390, virtual false, abstract: false, final false
inline void ReadAllIntoByteArray(::ArrayW<uint8_t,::Array<uint8_t>*>  buf) ;

/// @brief Method ReadByte, addr 0x25eabf8, size 0x1dc, virtual true, abstract: false, final false
inline int32_t ReadByte() ;

/// @brief Method ToArray, addr 0x25df49c, size 0x398, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25df3d8, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method get_Remaining, addr 0x25eabf0, size 0x8, virtual false, abstract: false, final false
