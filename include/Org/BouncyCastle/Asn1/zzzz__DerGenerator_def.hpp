...
/// @brief Method WriteDerEncoded, addr 0x25ed728, size 0x34, virtual false, abstract: false, final false
static inline void WriteDerEncoded(::System::IO::Stream*  outStr, int32_t  tag, ::System::IO::Stream*  inStr) ;

/// @brief Method WriteDerEncoded, addr 0x25ed5e8, size 0x60, virtual false, abstract: false, final false
static inline void WriteDerEncoded(::System::IO::Stream*  outStream, int32_t  tag, ::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method WriteDerEncoded, addr 0x25ed648, size 0xe0, virtual false, abstract: false, final false
inline void WriteDerEncoded(int32_t  tag, ::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method WriteLength, addr 0x25ed534, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25ed4bc, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  outStream) ;

/// @brief Method .ctor, addr 0x25ed4e8, size 0x4c, virtual false, abstract: false, final false
