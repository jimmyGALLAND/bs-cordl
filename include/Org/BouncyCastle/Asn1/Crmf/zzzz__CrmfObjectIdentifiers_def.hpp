...
static __declspec(property(get=getStaticF_id_regCtrl_pkiPublicationInfo, put=setStaticF_id_regCtrl_pkiPublicationInfo)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  id_regCtrl_pkiPublicationInfo;
...
/// @brief Method .ctor, addr 0x22c716c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
