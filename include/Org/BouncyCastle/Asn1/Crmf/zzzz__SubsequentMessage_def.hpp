...
/// @brief Method ValueOf, addr 0x22c90f4, size 0x114, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Crmf::SubsequentMessage* ValueOf(int32_t  value) ;

/// @brief Method .ctor, addr 0x22ca9d0, size 0x4, virtual false, abstract: false, final false
