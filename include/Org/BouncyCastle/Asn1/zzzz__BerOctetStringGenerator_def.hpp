...
/// @brief Method Close, addr 0x25e7fd0, size 0x48, virtual true, abstract: false, final false
inline void Close() ;

static inline ::Org::BouncyCastle::Asn1::__BerOctetStringGenerator__BufferedBerOctetStream* New_ctor(::Org::BouncyCastle::Asn1::BerOctetStringGenerator*  gen, ::ArrayW<uint8_t,::Array<uint8_t>*>  buf) ;

/// @brief Method Write, addr 0x25e7eb0, size 0x120, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  offset, int32_t  len) ;

/// @brief Method WriteByte, addr 0x25e7e48, size 0x68, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25e7d68, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method GetOctetOutputStream, addr 0x25e7c3c, size 0x54, virtual false, abstract: false, final false
inline ::System::IO::Stream* GetOctetOutputStream() ;

/// @brief Method GetOctetOutputStream, addr 0x25e7c90, size 0x68, virtual false, abstract: false, final false
inline ::System::IO::Stream* GetOctetOutputStream(::ArrayW<uint8_t,::Array<uint8_t>*>  buf) ;

/// @brief Method GetOctetOutputStream, addr 0x25e7cf8, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25e7bb4, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  outStream) ;

/// @brief Method .ctor, addr 0x25e7be8, size 0x54, virtual false, abstract: false, final false
