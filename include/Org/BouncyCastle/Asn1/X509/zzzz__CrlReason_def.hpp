...
/// @brief Method ToString, addr 0x25b77f8, size 0xcc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x25b7784, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerEnumerated*  reason) ;

/// @brief Method .ctor, addr 0x25b771c, size 0x68, virtual false, abstract: false, final false
