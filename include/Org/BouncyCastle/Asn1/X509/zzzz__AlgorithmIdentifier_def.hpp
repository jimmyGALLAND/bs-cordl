...
/// @brief Method GetInstance, addr 0x23c1598, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method GetInstance, addr 0x23aec50, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x23c1828, size 0x144, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23c1748, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  algorithm) ;

/// @brief Method .ctor, addr 0x23c17e4, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  algorithm, ::Org::BouncyCastle::Asn1::Asn1Encodable*  parameters) ;

/// @brief Method .ctor, addr 0x23c1770, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  algorithm) ;

/// @brief Method .ctor, addr 0x23c15b0, size 0x198, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_Algorithm, addr 0x23c1810, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Algorithm() ;

/// @brief Method get_ObjectID, addr 0x23c1818, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_ObjectID() ;

/// @brief Method get_Parameters, addr 0x23c1820, size 0x8, virtual true, abstract: false, final false
