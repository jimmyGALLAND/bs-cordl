...
/// @brief Method GetInstance, addr 0x25c949c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method GetInstance, addr 0x25c94b4, size 0xa4, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* GetInstance(::System::Object*  obj) ;

/// @brief Method GetSignatureOctets, addr 0x25c9848, size 0x20, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* New_ctor(::Org::BouncyCastle::Asn1::X509::TbsCertificateStructure*  tbsCert, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  sigAlgID, ::Org::BouncyCastle::Asn1::DerBitString*  sig) ;

/// @brief Method ToAsn1Object, addr 0x25c9868, size 0x118, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::TbsCertificateStructure*> const& __cordl_internal_get_tbsCert() const;
...
/// @brief Method .ctor, addr 0x25c9558, size 0x148, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method .ctor, addr 0x25c96a0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method get_EndDate, addr 0x25c97e4, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::Time* get_EndDate() ;

/// @brief Method get_Issuer, addr 0x25c97ac, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_Issuer() ;

/// @brief Method get_SerialNumber, addr 0x25c9790, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerInteger* get_SerialNumber() ;

/// @brief Method get_Signature, addr 0x25c9840, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerBitString* get_Signature() ;

/// @brief Method get_SignatureAlgorithm, addr 0x25c9838, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_SignatureAlgorithm() ;

/// @brief Method get_StartDate, addr 0x25c97c8, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::Time* get_StartDate() ;

/// @brief Method get_Subject, addr 0x25c9800, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_Subject() ;

/// @brief Method get_SubjectPublicKeyInfo, addr 0x25c981c, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo* get_SubjectPublicKeyInfo() ;

/// @brief Method get_TbsCertificate, addr 0x25c9770, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::TbsCertificateStructure* get_TbsCertificate() ;

/// @brief Method get_Version, addr 0x25c9778, size 0x18, virtual false, abstract: false, final false
