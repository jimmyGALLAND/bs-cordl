...
/// @brief Method GetInstance, addr 0x25bc694, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method GetInstance, addr 0x25bfc4c, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x25c0124, size 0x1bc, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerEnumerated*> const& __cordl_internal_get_digestedObjectType() const;

constexpr ::Org::BouncyCastle::Asn1::DerBitString*& __cordl_internal_get_objectDigest() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerBitString*> const& __cordl_internal_get_objectDigest() const;

constexpr ::Org::BouncyCastle::Asn1::DerObjectIdentifier*& __cordl_internal_get_otherObjectTypeID() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerObjectIdentifier*> const& __cordl_internal_get_otherObjectTypeID() const;
...
/// @brief Method .ctor, addr 0x25c0010, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25bfdc8, size 0x248, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_DigestAlgorithm, addr 0x25c0114, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithm() ;

/// @brief Method get_DigestedObjectType, addr 0x25c0104, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerEnumerated* get_DigestedObjectType() ;

/// @brief Method get_ObjectDigest, addr 0x25c011c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerBitString* get_ObjectDigest() ;

/// @brief Method get_OtherObjectTypeID, addr 0x25c010c, size 0x8, virtual false, abstract: false, final false
