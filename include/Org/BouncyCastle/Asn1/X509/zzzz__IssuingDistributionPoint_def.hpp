...
/// @brief Method GetInstance, addr 0x25bd87c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method GetInstance, addr 0x25bd894, size 0x17c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X509::IssuingDistributionPoint* GetInstance(::System::Object*  obj) ;

static inline ::Org::BouncyCastle::Asn1::X509::IssuingDistributionPoint* New_ctor(::Org::BouncyCastle::Asn1::X509::DistributionPointName*  distributionPoint, bool  onlyContainsUserCerts, bool  onlyContainsCACerts, ::Org::BouncyCastle::Asn1::X509::ReasonFlags*  onlySomeReasons, bool  indirectCRL, bool  onlyContainsAttributeCerts) ;

static inline ::Org::BouncyCastle::Asn1::X509::IssuingDistributionPoint* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method ToAsn1Object, addr 0x25bdff8, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object() ;

/// @brief Method ToString, addr 0x25be000, size 0x2e0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25bdcb4, size 0x314, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::DistributionPointName*  distributionPoint, bool  onlyContainsUserCerts, bool  onlyContainsCACerts, ::Org::BouncyCastle::Asn1::X509::ReasonFlags*  onlySomeReasons, bool  indirectCRL, bool  onlyContainsAttributeCerts) ;

/// @brief Method .ctor, addr 0x25bda10, size 0x2a4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method appendObject, addr 0x25be2e0, size 0xf8, virtual false, abstract: false, final false
inline void appendObject(::System::Text::StringBuilder*  buf, ::StringW  sep, ::StringW  name, ::StringW  val) ;

/// @brief Method get_DistributionPoint, addr 0x25bdfe8, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::DistributionPointName* get_DistributionPoint() ;

/// @brief Method get_IsIndirectCrl, addr 0x25bdfd8, size 0x8, virtual false, abstract: false, final false
inline bool get_IsIndirectCrl() ;

/// @brief Method get_OnlyContainsAttributeCerts, addr 0x25bdfe0, size 0x8, virtual false, abstract: false, final false
inline bool get_OnlyContainsAttributeCerts() ;

/// @brief Method get_OnlyContainsCACerts, addr 0x25bdfd0, size 0x8, virtual false, abstract: false, final false
inline bool get_OnlyContainsCACerts() ;

/// @brief Method get_OnlyContainsUserCerts, addr 0x25bdfc8, size 0x8, virtual false, abstract: false, final false
inline bool get_OnlyContainsUserCerts() ;

/// @brief Method get_OnlySomeReasons, addr 0x25bdff0, size 0x8, virtual false, abstract: false, final false
