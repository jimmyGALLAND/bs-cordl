...
/// @brief Method GetInstance, addr 0x24b9144, size 0xa4, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificate* GetInstance(::System::Object*  obj) ;

/// @brief Method GetSignatureOctets, addr 0x24b952c, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSignatureOctets() ;

static inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificate* New_ctor(::Org::BouncyCastle::Asn1::X509::AttributeCertificateInfo*  acinfo, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  signatureAlgorithm, ::Org::BouncyCastle::Asn1::DerBitString*  signatureValue) ;

static inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificate* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method ToAsn1Object, addr 0x24b954c, size 0x118, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24b935c, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::AttributeCertificateInfo*  acinfo, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  signatureAlgorithm, ::Org::BouncyCastle::Asn1::DerBitString*  signatureValue) ;

/// @brief Method .ctor, addr 0x24b91e8, size 0x174, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_ACInfo, addr 0x24b9514, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificateInfo* get_ACInfo() ;

/// @brief Method get_SignatureAlgorithm, addr 0x24b951c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_SignatureAlgorithm() ;

/// @brief Method get_SignatureValue, addr 0x24b9524, size 0x8, virtual false, abstract: false, final false
