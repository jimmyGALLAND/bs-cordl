...
/// @brief Field nameRegistrationAuthorities, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_nameRegistrationAuthorities, put=__cordl_internal_set_nameRegistrationAuthorities)) ::ArrayW<::Org::BouncyCastle::Asn1::X509::GeneralName*,::Array<::Org::BouncyCastle::Asn1::X509::GeneralName*>*>  nameRegistrationAuthorities;
...
/// @brief Method GetInstance, addr 0x24b695c, size 0x164, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X509::Qualified::SemanticsInformation* GetInstance(::System::Object*  obj) ;

/// @brief Method GetNameRegistrationAuthorities, addr 0x24b6ee8, size 0x8, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Asn1::X509::Qualified::SemanticsInformation* New_ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::GeneralName*,::Array<::Org::BouncyCastle::Asn1::X509::GeneralName*>*>  generalNames) ;
...
static inline ::Org::BouncyCastle::Asn1::X509::Qualified::SemanticsInformation* New_ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  semanticsIdentifier, ::ArrayW<::Org::BouncyCastle::Asn1::X509::GeneralName*,::Array<::Org::BouncyCastle::Asn1::X509::GeneralName*>*>  generalNames) ;

static inline ::Org::BouncyCastle::Asn1::X509::Qualified::SemanticsInformation* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method ToAsn1Object, addr 0x24b6ef0, size 0x134, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24b6eb8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24b6e90, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  semanticsIdentifier) ;

/// @brief Method .ctor, addr 0x24b6e64, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  semanticsIdentifier, ::ArrayW<::Org::BouncyCastle::Asn1::X509::GeneralName*,::Array<::Org::BouncyCastle::Asn1::X509::GeneralName*>*>  generalNames) ;

/// @brief Method .ctor, addr 0x24b6ac0, size 0x3a4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_SemanticsIdentifier, addr 0x24b6ee0, size 0x8, virtual false, abstract: false, final false
