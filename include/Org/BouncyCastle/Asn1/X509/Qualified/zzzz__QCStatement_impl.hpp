...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement* (*)(::System::Object*)>(&::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::GetInstance)> {
  constexpr static std::size_t size = 0x164;
  constexpr static std::size_t addrs = 0x24b6450;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::*)(::Org::BouncyCastle::Asn1::Asn1Sequence*)>(&::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::_ctor)> {
  constexpr static std::size_t size = 0xc4;
  constexpr static std::size_t addrs = 0x24b65b4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::*)(::Org::BouncyCastle::Asn1::DerObjectIdentifier*)>(&::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x24b6678;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::*)(::Org::BouncyCastle::Asn1::DerObjectIdentifier*, ::Org::BouncyCastle::Asn1::Asn1Encodable*)>(&::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::_ctor)> {
  constexpr static std::size_t size = 0x2c;
  constexpr static std::size_t addrs = 0x24b66a0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Asn1::DerObjectIdentifier* (::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::*)()>(&::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::get_StatementId)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x24b66cc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Asn1::Asn1Encodable* (::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::*)()>(&::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::get_StatementInfo)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x24b66d4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Asn1::Asn1Object* (::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::*)()>(&::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::ToAsn1Object)> {
  constexpr static std::size_t size = 0x144;
  constexpr static std::size_t addrs = 0x24b66dc;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerObjectIdentifier*> const& Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::__cordl_internal_get_qcStatementId() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___qcStatementId;
}
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___qcStatementId)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___qcStatementInfo)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
inline ::Org::BouncyCastle::Asn1::X509::Qualified::QCStatement* Org::BouncyCastle::Asn1::X509::Qualified::QCStatement::New_ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  qcStatementId, ::Org::BouncyCastle::Asn1::Asn1Encodable*  qcStatementInfo)  {
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, qcStatementId, qcStatementInfo);
}
