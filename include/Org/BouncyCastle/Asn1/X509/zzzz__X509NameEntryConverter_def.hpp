...
public:
// Declarations
/// @brief Method CanBePrintable, addr 0x25c99f8, size 0xc, virtual false, abstract: false, final false
inline bool CanBePrintable(::StringW  str) ;

/// @brief Method ConvertHexEncoded, addr 0x25c9980, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25c9a04, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
