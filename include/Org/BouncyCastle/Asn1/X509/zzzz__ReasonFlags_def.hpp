...
/// @brief Method .ctor, addr 0x25b84ec, size 0x94, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString*  reasons) ;

/// @brief Method .ctor, addr 0x25c1a2c, size 0x68, virtual false, abstract: false, final false
