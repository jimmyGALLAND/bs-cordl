...
public:
// Declarations
/// @brief Method FromExtensions, addr 0x25be900, size 0x74, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X509::KeyUsage* FromExtensions(::Org::BouncyCastle::Asn1::X509::X509Extensions*  extensions) ;

/// @brief Method GetInstance, addr 0x25be758, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x25be9dc, size 0xb8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x25be86c, size 0x94, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString*  usage) ;

/// @brief Method .ctor, addr 0x25be974, size 0x68, virtual false, abstract: false, final false
