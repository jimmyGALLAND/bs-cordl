...
/// @brief Method GenerateTbsCertificate, addr 0x25c6cc8, size 0x2c8, virtual false, abstract: false, final false
...
/// @brief Method SetEndDate, addr 0x25c6c54, size 0x64, virtual false, abstract: false, final false
inline void SetEndDate(::Org::BouncyCastle::Asn1::DerUtcTime*  endDate) ;

/// @brief Method SetEndDate, addr 0x25c6c4c, size 0x8, virtual false, abstract: false, final false
inline void SetEndDate(::Org::BouncyCastle::Asn1::X509::Time*  endDate) ;

/// @brief Method SetIssuer, addr 0x25c6bd8, size 0x8, virtual false, abstract: false, final false
inline void SetIssuer(::Org::BouncyCastle::Asn1::X509::X509Name*  issuer) ;

/// @brief Method SetSerialNumber, addr 0x25c6bc8, size 0x8, virtual false, abstract: false, final false
inline void SetSerialNumber(::Org::BouncyCastle::Asn1::DerInteger*  serialNumber) ;

/// @brief Method SetSignature, addr 0x25c6bd0, size 0x8, virtual false, abstract: false, final false
inline void SetSignature(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  signature) ;

/// @brief Method SetStartDate, addr 0x25c6be8, size 0x64, virtual false, abstract: false, final false
inline void SetStartDate(::Org::BouncyCastle::Asn1::DerUtcTime*  startDate) ;

/// @brief Method SetStartDate, addr 0x25c6be0, size 0x8, virtual false, abstract: false, final false
inline void SetStartDate(::Org::BouncyCastle::Asn1::X509::Time*  startDate) ;

/// @brief Method SetSubject, addr 0x25c6cb8, size 0x8, virtual false, abstract: false, final false
inline void SetSubject(::Org::BouncyCastle::Asn1::X509::X509Name*  subject) ;

/// @brief Method SetSubjectPublicKeyInfo, addr 0x25c6cc0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25c6b2c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;
