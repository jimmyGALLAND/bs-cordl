...
/// @brief Method AddAttribute, addr 0x25c7118, size 0x1c, virtual false, abstract: false, final false
inline void AddAttribute(::Org::BouncyCastle::Asn1::X509::AttributeX509*  attribute) ;

/// @brief Method AddAttribute, addr 0x25c7034, size 0xe4, virtual false, abstract: false, final false
inline void AddAttribute(::StringW  oid, ::Org::BouncyCastle::Asn1::Asn1Encodable*  value) ;

/// @brief Method GenerateAttributeCertificateInfo, addr 0x25c716c, size 0x2cc, virtual false, abstract: false, final false
...
/// @brief Method SetEndDate, addr 0x25c7154, size 0x8, virtual false, abstract: false, final false
inline void SetEndDate(::Org::BouncyCastle::Asn1::DerGeneralizedTime*  endDate) ;

/// @brief Method SetExtensions, addr 0x25c7164, size 0x8, virtual false, abstract: false, final false
inline void SetExtensions(::Org::BouncyCastle::Asn1::X509::X509Extensions*  extensions) ;

/// @brief Method SetHolder, addr 0x25c702c, size 0x8, virtual false, abstract: false, final false
inline void SetHolder(::Org::BouncyCastle::Asn1::X509::Holder*  holder) ;

/// @brief Method SetIssuer, addr 0x25c7144, size 0x8, virtual false, abstract: false, final false
inline void SetIssuer(::Org::BouncyCastle::Asn1::X509::AttCertIssuer*  issuer) ;

/// @brief Method SetIssuerUniqueID, addr 0x25c715c, size 0x8, virtual false, abstract: false, final false
inline void SetIssuerUniqueID(::Org::BouncyCastle::Asn1::DerBitString*  issuerUniqueID) ;

/// @brief Method SetSerialNumber, addr 0x25c7134, size 0x8, virtual false, abstract: false, final false
inline void SetSerialNumber(::Org::BouncyCastle::Asn1::DerInteger*  serialNumber) ;

/// @brief Method SetSignature, addr 0x25c713c, size 0x8, virtual false, abstract: false, final false
inline void SetSignature(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  signature) ;

/// @brief Method SetStartDate, addr 0x25c714c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25c6f90, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;
