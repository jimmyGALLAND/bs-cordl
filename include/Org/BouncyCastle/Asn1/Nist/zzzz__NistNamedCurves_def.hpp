...
/// @brief Method DefineCurveAlias, addr 0x23b6d98, size 0x198, virtual false, abstract: false, final false
static inline void DefineCurveAlias(::StringW  name, ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method GetByName, addr 0x23b7250, size 0x80, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByName(::StringW  name) ;

/// @brief Method GetByOid, addr 0x23b7424, size 0x58, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByOid(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method GetName, addr 0x23b747c, size 0x100, virtual false, abstract: false, final false
static inline ::StringW GetName(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method GetOid, addr 0x23b72d0, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23b6d90, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Names, addr 0x23b757c, size 0x108, virtual false, abstract: false, final false
