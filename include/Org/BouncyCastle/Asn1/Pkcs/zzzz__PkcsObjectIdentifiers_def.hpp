...
static __declspec(property(get=getStaticF_PbeWithShaAnd2KeyTripleDesCbc, put=setStaticF_PbeWithShaAnd2KeyTripleDesCbc)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  PbeWithShaAnd2KeyTripleDesCbc;

/// @brief Field PbeWithShaAnd3KeyTripleDesCbc, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_PbeWithShaAnd3KeyTripleDesCbc, put=setStaticF_PbeWithShaAnd3KeyTripleDesCbc)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  PbeWithShaAnd3KeyTripleDesCbc;
...
static __declspec(property(get=getStaticF_Pkcs9AtExtendedCertificateAttributes, put=setStaticF_Pkcs9AtExtendedCertificateAttributes)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  Pkcs9AtExtendedCertificateAttributes;
...
/// @brief Method .ctor, addr 0x23c5e04, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
