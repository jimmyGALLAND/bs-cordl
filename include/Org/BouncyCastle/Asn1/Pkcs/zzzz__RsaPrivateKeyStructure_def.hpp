...
/// @brief Method GetInstance, addr 0x23c73b8, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23c77f4, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::BigInteger*  modulus, ::Org::BouncyCastle::Math::BigInteger*  publicExponent, ::Org::BouncyCastle::Math::BigInteger*  privateExponent, ::Org::BouncyCastle::Math::BigInteger*  prime1, ::Org::BouncyCastle::Math::BigInteger*  prime2, ::Org::BouncyCastle::Math::BigInteger*  exponent1, ::Org::BouncyCastle::Math::BigInteger*  exponent2, ::Org::BouncyCastle::Math::BigInteger*  coefficient) ;

/// @brief Method .ctor, addr 0x23c7474, size 0x380, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_Coefficient, addr 0x23c7894, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Coefficient() ;

/// @brief Method get_Exponent1, addr 0x23c7884, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Exponent1() ;

/// @brief Method get_Exponent2, addr 0x23c788c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Exponent2() ;

/// @brief Method get_Modulus, addr 0x23c785c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Modulus() ;

/// @brief Method get_Prime1, addr 0x23c7874, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Prime1() ;

/// @brief Method get_Prime2, addr 0x23c787c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Prime2() ;

/// @brief Method get_PrivateExponent, addr 0x23c786c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_PrivateExponent() ;

/// @brief Method get_PublicExponent, addr 0x23c7864, size 0x8, virtual false, abstract: false, final false
