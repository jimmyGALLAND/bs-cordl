...
/// @brief Method GetInstance, addr 0x23c2f9c, size 0x17c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Pkcs::Pbkdf2Params* GetInstance(::System::Object*  obj) ;

/// @brief Method GetSalt, addr 0x23c36bc, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x23c37ec, size 0x18c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23c353c, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  salt, int32_t  iterationCount) ;

/// @brief Method .ctor, addr 0x23c35ec, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  salt, int32_t  iterationCount, int32_t  keyLength) ;

/// @brief Method .ctor, addr 0x23c3674, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23c3698, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23c3214, size 0x328, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

static inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* getStaticF_algid_hmacWithSHA1() ;

/// @brief Method get_IsDefaultPrf, addr 0x23c370c, size 0x7c, virtual false, abstract: false, final false
inline bool get_IsDefaultPrf() ;

/// @brief Method get_IterationCount, addr 0x23c36dc, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_IterationCount() ;

/// @brief Method get_KeyLength, addr 0x23c36f8, size 0x14, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_KeyLength() ;

/// @brief Method get_Prf, addr 0x23c3788, size 0x64, virtual false, abstract: false, final false
