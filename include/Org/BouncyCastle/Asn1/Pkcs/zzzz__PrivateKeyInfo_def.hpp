...
/// @brief Method GetInstance, addr 0x23c5e0c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method GetInstance, addr 0x23c5e24, size 0xa4, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* GetInstance(::System::Object*  obj) ;

/// @brief Method GetVersionValue, addr 0x23c61e0, size 0x120, virtual false, abstract: false, final false
static inline int32_t GetVersionValue(::Org::BouncyCastle::Asn1::DerInteger*  version) ;

static inline ::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* New_ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  privateKeyAlgorithm, ::Org::BouncyCastle::Asn1::Asn1Encodable*  privateKey) ;

static inline ::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* New_ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  privateKeyAlgorithm, ::Org::BouncyCastle::Asn1::Asn1Encodable*  privateKey, ::Org::BouncyCastle::Asn1::Asn1Set*  attributes) ;

static inline ::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* New_ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  privateKeyAlgorithm, ::Org::BouncyCastle::Asn1::Asn1Encodable*  privateKey, ::Org::BouncyCastle::Asn1::Asn1Set*  attributes, ::ArrayW<uint8_t,::Array<uint8_t>*>  publicKey) ;

static inline ::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method ParsePrivateKey, addr 0x23c6488, size 0x28, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* ParsePrivateKey() ;

/// @brief Method ParsePublicKey, addr 0x23c64b0, size 0x2c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* ParsePublicKey() ;

/// @brief Method ToAsn1Object, addr 0x23c64e4, size 0x178, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23c6300, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23c6450, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23c630c, size 0x144, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  privateKeyAlgorithm, ::Org::BouncyCastle::Asn1::Asn1Encodable*  privateKey, ::Org::BouncyCastle::Asn1::Asn1Set*  attributes, ::ArrayW<uint8_t,::Array<uint8_t>*>  publicKey) ;

/// @brief Method .ctor, addr 0x23c5ec8, size 0x318, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_Attributes, addr 0x23c6460, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Set* get_Attributes() ;

/// @brief Method get_HasPublicKey, addr 0x23c6468, size 0x10, virtual true, abstract: false, final false
inline bool get_HasPublicKey() ;

/// @brief Method get_PrivateKeyAlgorithm, addr 0x23c6478, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_PrivateKeyAlgorithm() ;

/// @brief Method get_PrivateKeyData, addr 0x23c6480, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_PrivateKeyData() ;

/// @brief Method get_PublicKeyData, addr 0x23c64dc, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerBitString* get_PublicKeyData() ;

/// @brief Method get_Version, addr 0x23c6458, size 0x8, virtual true, abstract: false, final false
