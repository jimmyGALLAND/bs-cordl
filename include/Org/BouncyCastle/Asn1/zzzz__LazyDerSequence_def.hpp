...
/// @brief Method Encode, addr 0x25f0f64, size 0xcc, virtual true, abstract: false, final false
inline void Encode(::Org::BouncyCastle::Asn1::DerOutputStream*  derOut) ;

/// @brief Method GetEnumerator, addr 0x25f0f1c, size 0x24, virtual true, abstract: false, final false
inline ::System::Collections::IEnumerator* GetEnumerator() ;

static inline ::Org::BouncyCastle::Asn1::LazyDerSequence* New_ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  encoded) ;

/// @brief Method Parse, addr 0x25f0d7c, size 0x178, virtual false, abstract: false, final false
inline void Parse() ;
...
/// @brief Method .ctor, addr 0x25f0c3c, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  encoded) ;

/// @brief Method get_Count, addr 0x25f0f40, size 0x24, virtual true, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Item, addr 0x25f0ef4, size 0x28, virtual true, abstract: false, final false
