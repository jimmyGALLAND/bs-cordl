...
/// @brief Method SetParentEofDetect, addr 0x25eab60, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25eab2c, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  inStream, int32_t  limit) ;

/// @brief Method get_Limit, addr 0x25eab58, size 0x8, virtual true, abstract: false, final false
