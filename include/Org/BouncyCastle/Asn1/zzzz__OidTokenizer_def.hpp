...
/// @brief Method NextToken, addr 0x25f131c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25f12e4, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  oid) ;

/// @brief Method get_HasMoreTokens, addr 0x25f130c, size 0x10, virtual false, abstract: false, final false
