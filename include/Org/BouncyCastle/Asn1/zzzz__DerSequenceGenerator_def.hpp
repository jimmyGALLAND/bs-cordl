...
/// @brief Method AddObject, addr 0x25ee7a0, size 0x80, virtual true, abstract: false, final false
inline void AddObject(::Org::BouncyCastle::Asn1::Asn1Encodable*  obj) ;

/// @brief Method Close, addr 0x25ee828, size 0x38, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method GetRawOutputStream, addr 0x25ee820, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25ee68c, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  outStream) ;

/// @brief Method .ctor, addr 0x25ee704, size 0x9c, virtual false, abstract: false, final false
