...
/// @brief Method ToString, addr 0x23b6708, size 0xa8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x23b6674, size 0x94, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerBitString*  usage) ;

/// @brief Method .ctor, addr 0x23b660c, size 0x68, virtual false, abstract: false, final false
