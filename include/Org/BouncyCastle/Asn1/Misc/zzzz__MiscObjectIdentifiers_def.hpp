...
static __declspec(property(get=getStaticF_VerisignOnSiteJurisdictionHash, put=setStaticF_VerisignOnSiteJurisdictionHash)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  VerisignOnSiteJurisdictionHash;
...
static __declspec(property(get=getStaticF_cryptlib_algorithm_blowfish_CBC, put=setStaticF_cryptlib_algorithm_blowfish_CBC)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  cryptlib_algorithm_blowfish_CBC;

/// @brief Field cryptlib_algorithm_blowfish_CFB, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_cryptlib_algorithm_blowfish_CFB, put=setStaticF_cryptlib_algorithm_blowfish_CFB)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  cryptlib_algorithm_blowfish_CFB;

/// @brief Field cryptlib_algorithm_blowfish_ECB, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_cryptlib_algorithm_blowfish_ECB, put=setStaticF_cryptlib_algorithm_blowfish_ECB)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  cryptlib_algorithm_blowfish_ECB;

/// @brief Field cryptlib_algorithm_blowfish_OFB, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_cryptlib_algorithm_blowfish_OFB, put=setStaticF_cryptlib_algorithm_blowfish_OFB)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  cryptlib_algorithm_blowfish_OFB;
...
/// @brief Method .ctor, addr 0x23b6604, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
