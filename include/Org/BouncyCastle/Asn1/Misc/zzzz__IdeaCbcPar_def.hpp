...
/// @brief Method GetIV, addr 0x23b5ba0, size 0x18, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetIV() ;

/// @brief Method GetInstance, addr 0x23b590c, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x23b5bb8, size 0x104, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23b5b2c, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  iv) ;

/// @brief Method .ctor, addr 0x23b5a48, size 0xe4, virtual false, abstract: false, final false
