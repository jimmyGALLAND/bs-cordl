...
/// @brief Method GetInstance, addr 0x23b9690, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x23b981c, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23b9478, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x23b9548, size 0x130, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject*  choice) ;

/// @brief Method .ctor, addr 0x23b94e8, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::RevokedInfo*  info) ;

/// @brief Method .ctor, addr 0x23b9518, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  tagNo, ::Org::BouncyCastle::Asn1::Asn1Encodable*  value) ;

/// @brief Method get_Status, addr 0x23b9814, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Status() ;

/// @brief Method get_TagNo, addr 0x23b980c, size 0x8, virtual false, abstract: false, final false
