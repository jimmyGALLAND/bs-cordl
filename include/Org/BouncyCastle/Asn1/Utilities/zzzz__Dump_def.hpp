...
public:
// Declarations
/// @brief Method Main, addr 0x24b35f8, size 0x144, virtual false, abstract: false, final false
static inline void Main(::ArrayW<::StringW,::Array<::StringW>*>  args) ;

static inline ::Org::BouncyCastle::Asn1::Utilities::Dump* New_ctor() ;

/// @brief Method .ctor, addr 0x24b35f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
