...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::ArrayW<::StringW,::Array<::StringW>*>)>(&::Org::BouncyCastle::Asn1::Utilities::Dump::Main)> {
  ...
  constexpr static std::size_t addrs = 0x24b35f8;
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Org::BouncyCastle::Asn1::Utilities::Dump*>());
}
...
inline void Org::BouncyCastle::Asn1::Utilities::Dump::Main(::ArrayW<::StringW,::Array<::StringW>*>  args)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Asn1::Utilities::Dump*>::get(),
                        "Main",
                        std::span<const Il2CppClass* const, 0>(),
