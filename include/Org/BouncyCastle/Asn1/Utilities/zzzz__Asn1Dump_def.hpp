...
/// @brief Method AsString, addr 0x24b00a4, size 0x2628, virtual false, abstract: false, final false
...
/// @brief Method DumpAsString, addr 0x24b338c, size 0x58, virtual false, abstract: false, final false
static inline ::StringW DumpAsString(::Org::BouncyCastle::Asn1::Asn1Encodable*  obj) ;

/// @brief Method DumpAsString, addr 0x24b33e4, size 0xd8, virtual false, abstract: false, final false
static inline ::StringW DumpAsString(::Org::BouncyCastle::Asn1::Asn1Encodable*  obj, bool  verbose) ;

/// @brief Method DumpAsString, addr 0x24b3214, size 0x178, virtual false, abstract: false, final false
static inline ::StringW DumpAsString(::System::Object*  obj) ;

static inline ::Org::BouncyCastle::Asn1::Utilities::Asn1Dump* New_ctor() ;

/// @brief Method .ctor, addr 0x24b009c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method calculateAscString, addr 0x24b34bc, size 0xbc, virtual false, abstract: false, final false
static inline ::StringW calculateAscString(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  off, int32_t  len) ;

/// @brief Method dumpBinaryDataAsString, addr 0x24b26cc, size 0x26c, virtual false, abstract: false, final false
...
/// @brief Method outputApplicationSpecific, addr 0x24b2938, size 0x8dc, virtual false, abstract: false, final false
