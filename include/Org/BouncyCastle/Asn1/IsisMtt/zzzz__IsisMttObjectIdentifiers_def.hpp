...
static __declspec(property(get=getStaticF_IdIsisMttATAdditionalInformation, put=setStaticF_IdIsisMttATAdditionalInformation)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  IdIsisMttATAdditionalInformation;
...
static __declspec(property(get=getStaticF_IdIsisMttATDeclarationOfMajority, put=setStaticF_IdIsisMttATDeclarationOfMajority)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  IdIsisMttATDeclarationOfMajority;
...
static __declspec(property(get=getStaticF_IdIsisMttATLiabilityLimitationFlag, put=setStaticF_IdIsisMttATLiabilityLimitationFlag)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  IdIsisMttATLiabilityLimitationFlag;
...
static __declspec(property(get=getStaticF_IdIsisMttATRequestedCertificate, put=setStaticF_IdIsisMttATRequestedCertificate)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  IdIsisMttATRequestedCertificate;
...
/// @brief Method .ctor, addr 0x23b50fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
