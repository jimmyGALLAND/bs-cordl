...
/// @brief Method GetInstance, addr 0x23b1980, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x23b1bb4, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23b1904, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerGeneralizedTime*  dateOfBirth) ;

/// @brief Method .ctor, addr 0x23b16ec, size 0x218, virtual false, abstract: false, final false
inline void _ctor(bool  fullAge, ::StringW  country) ;

/// @brief Method .ctor, addr 0x23b1644, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(int32_t  notYoungerThan) ;

/// @brief Method .ctor, addr 0x23b1afc, size 0xb8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject*  o) ;

/// @brief Method get_DateOfBirth, addr 0x23b1c50, size 0x38, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerGeneralizedTime* get_DateOfBirth() ;

/// @brief Method get_FullAgeAtCountry, addr 0x23b1c18, size 0x38, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Sequence* get_FullAgeAtCountry() ;

/// @brief Method get_NotYoungerThan, addr 0x23b1bd8, size 0x40, virtual true, abstract: false, final false
inline int32_t get_NotYoungerThan() ;

/// @brief Method get_Type, addr 0x23b1bbc, size 0x1c, virtual false, abstract: false, final false
