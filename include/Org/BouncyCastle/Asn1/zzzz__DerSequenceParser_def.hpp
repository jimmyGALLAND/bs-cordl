...
/// @brief Method ReadObject, addr 0x25ee860, size 0x20, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Asn1::IAsn1Convertible* ReadObject() ;

/// @brief Method ToAsn1Object, addr 0x25ee880, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x25e4ec4, size 0x28, virtual false, abstract: false, final false
