...
/// @brief Method AddObject, addr 0x25e69c0, size 0x80, virtual true, abstract: false, final false
inline void AddObject(::Org::BouncyCastle::Asn1::Asn1Encodable*  obj) ;

/// @brief Method Close, addr 0x25e6a4c, size 0x4, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method GetRawOutputStream, addr 0x25e6a44, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method WriteBerBody, addr 0x25e6b84, size 0x14, virtual false, abstract: false, final false
inline void WriteBerBody(::System::IO::Stream*  contentStream) ;

/// @brief Method WriteBerEnd, addr 0x25e6a50, size 0x98, virtual false, abstract: false, final false
inline void WriteBerEnd() ;

/// @brief Method WriteBerHeader, addr 0x25e6b2c, size 0x58, virtual false, abstract: false, final false
inline void WriteBerHeader(int32_t  tag) ;

/// @brief Method WriteHdr, addr 0x25e6ae8, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25e6948, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  outStream) ;

/// @brief Method .ctor, addr 0x25e6974, size 0x4c, virtual false, abstract: false, final false
