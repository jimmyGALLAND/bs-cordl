...
public:
// Declarations
/// @brief Method Encode, addr 0x25e9b90, size 0xc8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25de520, size 0x8, virtual false, abstract: false, final false
inline void _ctor(bool  explicitly, int32_t  tagNo, ::Org::BouncyCastle::Asn1::Asn1Encodable*  obj) ;

/// @brief Method .ctor, addr 0x25e9b1c, size 0x74, virtual false, abstract: false, final false
inline void _ctor(int32_t  tagNo) ;

/// @brief Method .ctor, addr 0x25d5db8, size 0x44, virtual false, abstract: false, final false
