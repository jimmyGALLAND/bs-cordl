...
/// @brief Method GetBodyForType, addr 0x22abf6c, size 0x158, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetBodyForType(int32_t  type, ::Org::BouncyCastle::Asn1::Asn1Encodable*  o) ;

/// @brief Method GetInstance, addr 0x22abda0, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x22ace48, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22abf1c, size 0x50, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject*  tagged) ;

/// @brief Method .ctor, addr 0x22ac0c4, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(int32_t  type, ::Org::BouncyCastle::Asn1::Asn1Encodable*  content) ;

/// @brief Method get_Content, addr 0x22ace40, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Content() ;

/// @brief Method get_Type, addr 0x22ace38, size 0x8, virtual true, abstract: false, final false
