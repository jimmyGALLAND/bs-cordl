...
/// @brief Method GetInstance, addr 0x22b00e4, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method GetInstance, addr 0x22a8758, size 0x17c, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo* New_ctor(int32_t  status, ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText*  statusString, ::Org::BouncyCastle::Asn1::Cmp::PkiFailureInfo*  failInfo) ;

/// @brief Method ToAsn1Object, addr 0x22b0414, size 0x170, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22b00fc, size 0x178, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method .ctor, addr 0x22b0274, size 0x74, virtual false, abstract: false, final false
inline void _ctor(int32_t  status) ;

/// @brief Method .ctor, addr 0x22b02e8, size 0x78, virtual false, abstract: false, final false
inline void _ctor(int32_t  status, ::Org::BouncyCastle::Asn1::Cmp::PkiFreeText*  statusString) ;

/// @brief Method .ctor, addr 0x22b0360, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method get_FailInfo, addr 0x22b040c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerBitString* get_FailInfo() ;

/// @brief Method get_Status, addr 0x22b03e8, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Status() ;

/// @brief Method get_StatusString, addr 0x22b0404, size 0x8, virtual false, abstract: false, final false
