...
/// @brief Method GetInstance, addr 0x22a7764, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x22a7e10, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22a7d18, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Cmp::CmpCertificate*  certificate) ;

/// @brief Method .ctor, addr 0x22a7d8c, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::EncryptedValue*  encryptedCert) ;

/// @brief Method .ctor, addr 0x22a7c28, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1TaggedObject*  tagged) ;

/// @brief Method get_Certificate, addr 0x22a7e00, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cmp::CmpCertificate* get_Certificate() ;

/// @brief Method get_EncryptedCert, addr 0x22a7e08, size 0x8, virtual true, abstract: false, final false
