...
/// @brief Method ConfigureBasepoint, addr 0x22cafa8, size 0x98, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::EC::ECPoint* ConfigureBasepoint(::Org::BouncyCastle::Math::EC::ECCurve*  curve, ::Org::BouncyCastle::Math::BigInteger*  x, ::Org::BouncyCastle::Math::BigInteger*  y) ;

/// @brief Method ConfigureCurve, addr 0x22cb040, size 0x4, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::EC::ECCurve* ConfigureCurve(::Org::BouncyCastle::Math::EC::ECCurve*  curve) ;

/// @brief Method GetByName, addr 0x22cd274, size 0x1ec, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* GetByName(::StringW  name) ;

/// @brief Method GetByNameX9, addr 0x22cd460, size 0x144, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByNameX9(::StringW  name) ;

/// @brief Method GetByOid, addr 0x22cce8c, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method GetByOidX9, addr 0x22ccfa8, size 0x1c4, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::X9::X9ECParameters* GetByOidX9(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method GetName, addr 0x22cd5a4, size 0x100, virtual false, abstract: false, final false
static inline ::StringW GetName(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method GetOid, addr 0x22cd6a4, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22cb044, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Names, addr 0x22cd16c, size 0x108, virtual false, abstract: false, final false
