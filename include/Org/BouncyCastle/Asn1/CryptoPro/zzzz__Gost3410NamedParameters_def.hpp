...
/// @brief Method GetByName, addr 0x22cea64, size 0x1ec, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::CryptoPro::Gost3410ParamSetParameters* GetByName(::StringW  name) ;

/// @brief Method GetByOid, addr 0x22ce840, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method GetOid, addr 0x22cec50, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22ce114, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Names, addr 0x22ce95c, size 0x108, virtual false, abstract: false, final false
