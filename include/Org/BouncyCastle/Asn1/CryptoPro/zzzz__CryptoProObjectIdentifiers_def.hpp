...
static __declspec(property(get=getStaticF_GostR3411x94CryptoProParamSet, put=setStaticF_GostR3411x94CryptoProParamSet)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  GostR3411x94CryptoProParamSet;

/// @brief Field GostR3411x94WithGostR3410x2001, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_GostR3411x94WithGostR3410x2001, put=setStaticF_GostR3411x94WithGostR3410x2001)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  GostR3411x94WithGostR3410x2001;
...
static __declspec(property(get=getStaticF_ID_Gost28147_89_CryptoPro_A_ParamSet, put=setStaticF_ID_Gost28147_89_CryptoPro_A_ParamSet)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  ID_Gost28147_89_CryptoPro_A_ParamSet;

static inline ::Org::BouncyCastle::Asn1::CryptoPro::CryptoProObjectIdentifiers* New_ctor() ;

/// @brief Method .ctor, addr 0x22cafa0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
