...
/// @brief Method GetCertHash, addr 0x22db180, size 0x20, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetCertHash() ;

/// @brief Method GetInstance, addr 0x22dadc8, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x22db1a8, size 0x144, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22db094, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  hash) ;

/// @brief Method .ctor, addr 0x22db108, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  hash, ::Org::BouncyCastle::Asn1::X509::IssuerSerial*  issuerSerial) ;

/// @brief Method .ctor, addr 0x22daf48, size 0x14c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_IssuerSerial, addr 0x22db1a0, size 0x8, virtual false, abstract: false, final false
