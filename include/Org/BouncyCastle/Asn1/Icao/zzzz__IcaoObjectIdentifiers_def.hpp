...
static __declspec(property(get=getStaticF_IdIcaoCscaMasterListSigningKey, put=setStaticF_IdIcaoCscaMasterListSigningKey)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  IdIcaoCscaMasterListSigningKey;
...
static __declspec(property(get=getStaticF_IdIcaoExtensionsNamechangekeyrollover, put=setStaticF_IdIcaoExtensionsNamechangekeyrollover)) ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  IdIcaoExtensionsNamechangekeyrollover;
...
/// @brief Method .ctor, addr 0x23ae63c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
