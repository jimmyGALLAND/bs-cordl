...
/// @brief Method GetInstance, addr 0x22bc9d0, size 0x21c, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x22bf2a8, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22bf17c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object*  id) ;

/// @brief Method .ctor, addr 0x22bf100, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1OctetString*  id) ;

/// @brief Method .ctor, addr 0x22bf0d8, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber*  id) ;

/// @brief Method get_ID, addr 0x22bf220, size 0x88, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_ID() ;

/// @brief Method get_IsTagged, addr 0x22bf1a4, size 0x7c, virtual false, abstract: false, final false
