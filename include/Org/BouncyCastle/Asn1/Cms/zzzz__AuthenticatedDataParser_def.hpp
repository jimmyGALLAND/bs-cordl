...
/// @brief Method GetAuthAttrs, addr 0x22b6474, size 0x1b8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1SetParser* GetAuthAttrs() ;

/// @brief Method GetDigestAlgorithm, addr 0x22b5fe4, size 0x19c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* GetDigestAlgorithm() ;

/// @brief Method GetEnapsulatedContentInfo, addr 0x22b6180, size 0x114, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::ContentInfoParser* GetEnapsulatedContentInfo() ;

/// @brief Method GetMac, addr 0x22b662c, size 0x130, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1OctetString* GetMac() ;

/// @brief Method GetMacAlgorithm, addr 0x22b5e7c, size 0x168, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* GetMacAlgorithm() ;

/// @brief Method GetOriginatorInfo, addr 0x22b5938, size 0x2dc, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::OriginatorInfo* GetOriginatorInfo() ;

/// @brief Method GetRecipientInfos, addr 0x22b5d7c, size 0x100, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1SetParser* GetRecipientInfos() ;

/// @brief Method GetUnauthAttrs, addr 0x22b675c, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22b580c, size 0x124, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser*  seq) ;

/// @brief Method get_Version, addr 0x22b5930, size 0x8, virtual false, abstract: false, final false
