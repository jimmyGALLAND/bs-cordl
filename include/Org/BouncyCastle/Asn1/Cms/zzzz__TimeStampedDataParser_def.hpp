...
/// @brief Method GetInstance, addr 0x22c4438, size 0x11c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Cms::TimeStampedDataParser* GetInstance(::System::Object*  obj) ;

/// @brief Method GetTemporalEvidence, addr 0x22c456c, size 0x12c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22c4038, size 0x400, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser*  parser) ;

/// @brief Method get_Content, addr 0x22c4564, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1OctetStringParser* get_Content() ;

/// @brief Method get_DataUri, addr 0x22c4554, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerIA5String* get_DataUri() ;

/// @brief Method get_MetaData, addr 0x22c455c, size 0x8, virtual true, abstract: false, final false
