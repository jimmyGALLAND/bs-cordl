...
/// @brief Field digEncryptionAlgorithm, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_digEncryptionAlgorithm, put=__cordl_internal_set_digEncryptionAlgorithm)) ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  digEncryptionAlgorithm;
...
/// @brief Method GetInstance, addr 0x22c23a0, size 0x17c, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Asn1::Cms::SignerInfo* New_ctor(::Org::BouncyCastle::Asn1::Cms::SignerIdentifier*  sid, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  digAlgorithm, ::Org::BouncyCastle::Asn1::Asn1Set*  authenticatedAttributes, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  digEncryptionAlgorithm, ::Org::BouncyCastle::Asn1::Asn1OctetString*  encryptedDigest, ::Org::BouncyCastle::Asn1::Asn1Set*  unauthenticatedAttributes) ;

static inline ::Org::BouncyCastle::Asn1::Cms::SignerInfo* New_ctor(::Org::BouncyCastle::Asn1::Cms::SignerIdentifier*  sid, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  digAlgorithm, ::Org::BouncyCastle::Asn1::Cms::Attributes*  authenticatedAttributes, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  digEncryptionAlgorithm, ::Org::BouncyCastle::Asn1::Asn1OctetString*  encryptedDigest, ::Org::BouncyCastle::Asn1::Cms::Attributes*  unauthenticatedAttributes) ;

/// @brief Method ToAsn1Object, addr 0x22c2e30, size 0x1f8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22c251c, size 0x6ac, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method .ctor, addr 0x22c2bc8, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22c2d18, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_AuthenticatedAttributes, addr 0x22c2e08, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Set* get_AuthenticatedAttributes() ;

/// @brief Method get_DigestAlgorithm, addr 0x22c2e10, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithm() ;

/// @brief Method get_DigestEncryptionAlgorithm, addr 0x22c2e20, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestEncryptionAlgorithm() ;

/// @brief Method get_EncryptedDigest, addr 0x22c2e18, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_EncryptedDigest() ;

/// @brief Method get_SignerID, addr 0x22c2e00, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::SignerIdentifier* get_SignerID() ;

/// @brief Method get_UnauthenticatedAttributes, addr 0x22c2e28, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Set* get_UnauthenticatedAttributes() ;

/// @brief Method get_Version, addr 0x22c2df8, size 0x8, virtual false, abstract: false, final false
