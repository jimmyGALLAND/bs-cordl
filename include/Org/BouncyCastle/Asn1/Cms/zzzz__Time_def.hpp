...
/// @brief Method GetInstance, addr 0x22c3028, size 0x1c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Cms::Time* GetInstance(::Org::BouncyCastle::Asn1::Asn1TaggedObject*  obj, bool  explicitly) ;

/// @brief Method GetInstance, addr 0x22c3044, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method ToAsn1Object, addr 0x22c373c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22c3330, size 0x194, virtual false, abstract: false, final false
inline void _ctor(::System::DateTime  date) ;

/// @brief Method .ctor, addr 0x22c31f8, size 0x138, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Object*  time) ;

/// @brief Method get_Date, addr 0x22c358c, size 0x1b0, virtual false, abstract: false, final false
inline ::System::DateTime get_Date() ;

/// @brief Method get_TimeString, addr 0x22c34c4, size 0xc8, virtual false, abstract: false, final false
