...
/// @brief Method GetEncapContentInfo, addr 0x22b8810, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22b8548, size 0x2b8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1SequenceParser*  seq) ;

/// @brief Method get_CompressionAlgorithmIdentifier, addr 0x22b8808, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_CompressionAlgorithmIdentifier() ;

/// @brief Method get_Version, addr 0x22b8800, size 0x8, virtual false, abstract: false, final false
