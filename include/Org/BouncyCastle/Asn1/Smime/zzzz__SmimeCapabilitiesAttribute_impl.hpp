...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Asn1::Smime::SmimeCapabilitiesAttribute::*)(::Org::BouncyCastle::Asn1::Smime::SmimeCapabilityVector*)>(&::Org::BouncyCastle::Asn1::Smime::SmimeCapabilitiesAttribute::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Org::BouncyCastle::Asn1::Smime::SmimeCapabilityVector*>::get()}
                    )));
    return ___internal_method;
  }
};
inline ::Org::BouncyCastle::Asn1::Smime::SmimeCapabilitiesAttribute* Org::BouncyCastle::Asn1::Smime::SmimeCapabilitiesAttribute::New_ctor(::Org::BouncyCastle::Asn1::Smime::SmimeCapabilityVector*  capabilities)  {
