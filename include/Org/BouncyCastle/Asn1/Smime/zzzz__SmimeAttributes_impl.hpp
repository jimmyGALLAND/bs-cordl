...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Asn1::Smime::SmimeAttributes::*)()>(&::Org::BouncyCastle::Asn1::Smime::SmimeAttributes::_ctor)> {
