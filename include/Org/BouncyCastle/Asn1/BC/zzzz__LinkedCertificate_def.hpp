...
/// @brief Method GetInstance, addr 0x22a669c, size 0xa4, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Asn1::BC::LinkedCertificate* New_ctor(::Org::BouncyCastle::Asn1::X509::DigestInfo*  digest, ::Org::BouncyCastle::Asn1::X509::GeneralName*  certLocation, ::Org::BouncyCastle::Asn1::X509::X509Name*  certIssuer, ::Org::BouncyCastle::Asn1::X509::GeneralNames*  caCerts) ;

static inline ::Org::BouncyCastle::Asn1::BC::LinkedCertificate* New_ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method ToAsn1Object, addr 0x22a6760, size 0x14c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* ToAsn1Object() ;

constexpr ::Org::BouncyCastle::Asn1::X509::GeneralNames*& __cordl_internal_get_mCACerts() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::GeneralNames*> const& __cordl_internal_get_mCACerts() const;

constexpr ::Org::BouncyCastle::Asn1::X509::X509Name*& __cordl_internal_get_mCertIssuer() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::X509Name*> const& __cordl_internal_get_mCertIssuer() const;

constexpr ::Org::BouncyCastle::Asn1::X509::GeneralName*& __cordl_internal_get_mCertLocation() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::GeneralName*> const& __cordl_internal_get_mCertLocation() const;

constexpr ::Org::BouncyCastle::Asn1::X509::DigestInfo*& __cordl_internal_get_mDigest() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::DigestInfo*> const& __cordl_internal_get_mDigest() const;
...
/// @brief Method .ctor, addr 0x22a6468, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::DigestInfo*  digest, ::Org::BouncyCastle::Asn1::X509::GeneralName*  certLocation) ;

/// @brief Method .ctor, addr 0x22a6498, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::DigestInfo*  digest, ::Org::BouncyCastle::Asn1::X509::GeneralName*  certLocation, ::Org::BouncyCastle::Asn1::X509::X509Name*  certIssuer, ::Org::BouncyCastle::Asn1::X509::GeneralNames*  caCerts) ;

/// @brief Method .ctor, addr 0x22a64d8, size 0x1c4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_CACerts, addr 0x22a6758, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::GeneralNames* get_CACerts() ;

/// @brief Method get_CertIssuer, addr 0x22a6750, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Name* get_CertIssuer() ;

/// @brief Method get_CertLocation, addr 0x22a6748, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_CertLocation() ;

/// @brief Method get_Digest, addr 0x22a6740, size 0x8, virtual true, abstract: false, final false
