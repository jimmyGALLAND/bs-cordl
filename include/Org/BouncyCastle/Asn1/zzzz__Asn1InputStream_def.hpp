...
/// @brief Method BuildObject, addr 0x25def68, size 0x470, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* BuildObject(int32_t  tag, int32_t  tagNo, int32_t  length) ;

/// @brief Method CreateDerSequence, addr 0x25e08f0, size 0x80, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerSequence* CreateDerSequence(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream*  dIn) ;

/// @brief Method CreateDerSet, addr 0x25e09f8, size 0x84, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerSet* CreateDerSet(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream*  dIn) ;

/// @brief Method CreatePrimitiveDerObject, addr 0x25dfe38, size 0x584, virtual false, abstract: false, final false
...
/// @brief Method FindLimit, addr 0x25ded18, size 0x134, virtual false, abstract: false, final false
static inline int32_t FindLimit(::System::IO::Stream*  input) ;

/// @brief Method GetBmpCharBuffer, addr 0x25e1950, size 0x308, virtual false, abstract: false, final false
static inline ::ArrayW<char16_t,::Array<char16_t>*> GetBmpCharBuffer(::Org::BouncyCastle::Asn1::DefiniteLengthInputStream*  defIn) ;

/// @brief Method GetBuffer, addr 0x25e14fc, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method ReadLength, addr 0x25e0c34, size 0x2dc, virtual false, abstract: false, final false
static inline int32_t ReadLength(::System::IO::Stream*  s, int32_t  limit, bool  isParsing) ;

/// @brief Method ReadObject, addr 0x25e04ac, size 0x444, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Asn1Object* ReadObject() ;

/// @brief Method ReadTagNumber, addr 0x25e0b14, size 0x120, virtual false, abstract: false, final false
static inline int32_t ReadTagNumber(::System::IO::Stream*  s, int32_t  tag) ;

/// @brief Method ReadVector, addr 0x25e03bc, size 0xf0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25deeec, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method .ctor, addr 0x25dee4c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  inputStream) ;

/// @brief Method .ctor, addr 0x25dee7c, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  inputStream, int32_t  limit) ;

/// @brief Method get_Limit, addr 0x25e14f4, size 0x8, virtual true, abstract: false, final false
