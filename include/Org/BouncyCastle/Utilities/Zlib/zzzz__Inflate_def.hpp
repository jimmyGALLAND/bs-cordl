...
/// @brief Method .ctor, addr 0x2595874, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::ArrayW<uint8_t,::Array<uint8_t>*> getStaticF_mark() ;

/// @brief Method inflate, addr 0x2594e58, size 0x698, virtual false, abstract: false, final false
inline int32_t inflate(::Org::BouncyCastle::Utilities::Zlib::ZStream*  z, int32_t  f) ;

/// @brief Method inflateEnd, addr 0x2594d50, size 0x38, virtual false, abstract: false, final false
inline int32_t inflateEnd(::Org::BouncyCastle::Utilities::Zlib::ZStream*  z) ;

/// @brief Method inflateInit, addr 0x2594d88, size 0xd0, virtual false, abstract: false, final false
inline int32_t inflateInit(::Org::BouncyCastle::Utilities::Zlib::ZStream*  z, int32_t  w) ;

/// @brief Method inflateReset, addr 0x2594cfc, size 0x54, virtual false, abstract: false, final false
inline int32_t inflateReset(::Org::BouncyCastle::Utilities::Zlib::ZStream*  z) ;

/// @brief Method inflateSetDictionary, addr 0x25954f0, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method inflateSync, addr 0x25955f4, size 0x1c0, virtual false, abstract: false, final false
inline int32_t inflateSync(::Org::BouncyCastle::Utilities::Zlib::ZStream*  z) ;

/// @brief Method inflateSyncPoint, addr 0x25957b4, size 0x2c, virtual false, abstract: false, final false
