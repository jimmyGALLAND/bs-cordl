...
/// @brief Method .ctor, addr 0x2592288, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method huft_build, addr 0x25958cc, size 0x778, virtual false, abstract: false, final false
inline int32_t huft_build(::ArrayW<int32_t,::Array<int32_t>*>  b, int32_t  bindex, int32_t  n, int32_t  s, ::ArrayW<int32_t,::Array<int32_t>*>  d, ::ArrayW<int32_t,::Array<int32_t>*>  e, ::ArrayW<int32_t,::Array<int32_t>*>  t, ::ArrayW<int32_t,::Array<int32_t>*>  m, ::ArrayW<int32_t,::Array<int32_t>*>  hp, ::ArrayW<int32_t,::Array<int32_t>*>  hn, ::ArrayW<int32_t,::Array<int32_t>*>  v) ;

/// @brief Method inflate_trees_bits, addr 0x2593518, size 0x114, virtual false, abstract: false, final false
inline int32_t inflate_trees_bits(::ArrayW<int32_t,::Array<int32_t>*>  c, ::ArrayW<int32_t,::Array<int32_t>*>  bb, ::ArrayW<int32_t,::Array<int32_t>*>  tb, ::ArrayW<int32_t,::Array<int32_t>*>  hp, ::Org::BouncyCastle::Utilities::Zlib::ZStream*  z) ;

/// @brief Method inflate_trees_dynamic, addr 0x259362c, size 0x24c, virtual false, abstract: false, final false
inline int32_t inflate_trees_dynamic(int32_t  nl, int32_t  nd, ::ArrayW<int32_t,::Array<int32_t>*>  c, ::ArrayW<int32_t,::Array<int32_t>*>  bl, ::ArrayW<int32_t,::Array<int32_t>*>  bd, ::ArrayW<int32_t,::Array<int32_t>*>  tl, ::ArrayW<int32_t,::Array<int32_t>*>  td, ::ArrayW<int32_t,::Array<int32_t>*>  hp, ::Org::BouncyCastle::Utilities::Zlib::ZStream*  z) ;

/// @brief Method inflate_trees_fixed, addr 0x2593424, size 0xd0, virtual false, abstract: false, final false
static inline int32_t inflate_trees_fixed(::ArrayW<int32_t,::Array<int32_t>*>  bl, ::ArrayW<int32_t,::Array<int32_t>*>  bd, ::ArrayW<::ArrayW<int32_t,::Array<int32_t>*>,::Array<::ArrayW<int32_t,::Array<int32_t>*>>*>  tl, ::ArrayW<::ArrayW<int32_t,::Array<int32_t>*>,::Array<::ArrayW<int32_t,::Array<int32_t>*>>*>  td, ::Org::BouncyCastle::Utilities::Zlib::ZStream*  z) ;

/// @brief Method initWorkArea, addr 0x2596044, size 0x19c, virtual false, abstract: false, final false
