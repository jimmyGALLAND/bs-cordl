...
/// @brief Method .ctor, addr 0x2597314, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method deflate, addr 0x25974dc, size 0x24, virtual false, abstract: false, final false
inline int32_t deflate(int32_t  flush) ;

/// @brief Method deflateEnd, addr 0x25976fc, size 0x30, virtual false, abstract: false, final false
inline int32_t deflateEnd() ;

/// @brief Method deflateInit, addr 0x2598550, size 0xc, virtual false, abstract: false, final false
inline int32_t deflateInit(int32_t  level) ;

/// @brief Method deflateInit, addr 0x259855c, size 0x8, virtual false, abstract: false, final false
inline int32_t deflateInit(int32_t  level, int32_t  bits) ;

/// @brief Method deflateInit, addr 0x2598564, size 0x94, virtual false, abstract: false, final false
inline int32_t deflateInit(int32_t  level, int32_t  bits, bool  nowrap) ;

/// @brief Method deflateInit, addr 0x2597374, size 0xc, virtual false, abstract: false, final false
inline int32_t deflateInit(int32_t  level, bool  nowrap) ;

/// @brief Method deflateParams, addr 0x25985f8, size 0x28, virtual false, abstract: false, final false
inline int32_t deflateParams(int32_t  level, int32_t  strategy) ;

/// @brief Method deflateSetDictionary, addr 0x2598620, size 0x28, virtual false, abstract: false, final false
inline int32_t deflateSetDictionary(::ArrayW<uint8_t,::Array<uint8_t>*>  dictionary, int32_t  dictLength) ;

/// @brief Method flush_pending, addr 0x2598648, size 0xbc, virtual false, abstract: false, final false
inline void flush_pending() ;

/// @brief Method free, addr 0x259772c, size 0x14, virtual false, abstract: false, final false
inline void free() ;

/// @brief Method inflate, addr 0x2597b98, size 0x1c, virtual false, abstract: false, final false
inline int32_t inflate(int32_t  f) ;

/// @brief Method inflateEnd, addr 0x25984c8, size 0x50, virtual false, abstract: false, final false
inline int32_t inflateEnd() ;

/// @brief Method inflateInit, addr 0x2597eb8, size 0xc, virtual false, abstract: false, final false
inline int32_t inflateInit() ;

/// @brief Method inflateInit, addr 0x25979e4, size 0xc, virtual false, abstract: false, final false
inline int32_t inflateInit(bool  nowrap) ;

/// @brief Method inflateInit, addr 0x2598444, size 0x8, virtual false, abstract: false, final false
inline int32_t inflateInit(int32_t  w) ;

/// @brief Method inflateInit, addr 0x259844c, size 0x7c, virtual false, abstract: false, final false
inline int32_t inflateInit(int32_t  w, bool  nowrap) ;

/// @brief Method inflateSetDictionary, addr 0x2598530, size 0x20, virtual false, abstract: false, final false
inline int32_t inflateSetDictionary(::ArrayW<uint8_t,::Array<uint8_t>*>  dictionary, int32_t  dictLength) ;

/// @brief Method inflateSync, addr 0x2598518, size 0x18, virtual false, abstract: false, final false
inline int32_t inflateSync() ;

/// @brief Method read_buf, addr 0x2598704, size 0xb0, virtual false, abstract: false, final false
