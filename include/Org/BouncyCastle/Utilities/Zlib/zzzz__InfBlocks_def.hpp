...
/// @brief Method .ctor, addr 0x2592138, size 0x144, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Utilities::Zlib::ZStream*  z, ::System::Object*  checkfn, int32_t  w) ;

/// @brief Method free, addr 0x25942cc, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method inflate_flush, addr 0x25932a4, size 0x180, virtual false, abstract: false, final false
inline int32_t inflate_flush(::Org::BouncyCastle::Utilities::Zlib::ZStream*  z, int32_t  r) ;

/// @brief Method proc, addr 0x2592330, size 0xf74, virtual false, abstract: false, final false
inline int32_t proc(::Org::BouncyCastle::Utilities::Zlib::ZStream*  z, int32_t  r) ;

/// @brief Method reset, addr 0x259229c, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method set_dictionary, addr 0x25942e8, size 0x40, virtual false, abstract: false, final false
inline void set_dictionary(::ArrayW<uint8_t,::Array<uint8_t>*>  d, int32_t  start, int32_t  n) ;

/// @brief Method sync_point, addr 0x2594328, size 0x10, virtual false, abstract: false, final false
