...
/// @brief Method .ctor, addr 0x259227c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method free, addr 0x259232c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method inflate_fast, addr 0x2594408, size 0x860, virtual false, abstract: false, final false
inline int32_t inflate_fast(int32_t  bl, int32_t  bd, ::ArrayW<int32_t,::Array<int32_t>*>  tl, int32_t  tl_index, ::ArrayW<int32_t,::Array<int32_t>*>  td, int32_t  td_index, ::Org::BouncyCastle::Utilities::Zlib::InfBlocks*  s, ::Org::BouncyCastle::Utilities::Zlib::ZStream*  z) ;

/// @brief Method init, addr 0x25934f4, size 0x24, virtual false, abstract: false, final false
inline void init(int32_t  bl, int32_t  bd, ::ArrayW<int32_t,::Array<int32_t>*>  tl, int32_t  tl_index, ::ArrayW<int32_t,::Array<int32_t>*>  td, int32_t  td_index, ::Org::BouncyCastle::Utilities::Zlib::ZStream*  z) ;

/// @brief Method proc, addr 0x2593878, size 0xa54, virtual false, abstract: false, final false
