...
/// @brief Method .ctor, addr 0x25971fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method bi_reverse, addr 0x2596f70, size 0x28, virtual false, abstract: false, final false
static inline int32_t bi_reverse(int32_t  code, int32_t  len) ;

/// @brief Method build_tree, addr 0x2596980, size 0x474, virtual false, abstract: false, final false
inline void build_tree(::Org::BouncyCastle::Utilities::Zlib::Deflate*  s) ;

/// @brief Method d_code, addr 0x2596610, size 0xa4, virtual false, abstract: false, final false
static inline int32_t d_code(int32_t  dist) ;

/// @brief Method gen_bitlen, addr 0x25966b4, size 0x2cc, virtual false, abstract: false, final false
inline void gen_bitlen(::Org::BouncyCastle::Utilities::Zlib::Deflate*  s) ;

/// @brief Method gen_codes, addr 0x2596df4, size 0x17c, virtual false, abstract: false, final false
