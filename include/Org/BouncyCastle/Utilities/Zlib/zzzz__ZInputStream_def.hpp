...
/// @brief Method Close, addr 0x2598000, size 0x94, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Flush, addr 0x2598094, size 0x4, virtual true, abstract: false, final true
inline void Flush() ;

/// @brief Method GetDefaultZStream, addr 0x2597ccc, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x2598150, size 0x1bc, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  b, int32_t  off, int32_t  len) ;

/// @brief Method ReadByte, addr 0x259830c, size 0x58, virtual true, abstract: false, final false
inline int32_t ReadByte() ;

/// @brief Method Seek, addr 0x2598364, size 0x38, virtual true, abstract: false, final true
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetLength, addr 0x259839c, size 0x38, virtual true, abstract: false, final true
inline void SetLength(int64_t  value) ;

/// @brief Method Write, addr 0x259840c, size 0x38, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2597d38, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input) ;

/// @brief Method .ctor, addr 0x2597ec4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input, int32_t  level) ;

/// @brief Method .ctor, addr 0x2597ecc, size 0x114, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input, int32_t  level, bool  nowrap) ;

/// @brief Method .ctor, addr 0x2597d68, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input, bool  nowrap) ;

/// @brief Method .ctor, addr 0x2597d98, size 0x120, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input, ::Org::BouncyCastle::Utilities::Zlib::ZStream*  z) ;

/// @brief Method get_CanRead, addr 0x2597fe0, size 0x10, virtual true, abstract: false, final true
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x2597ff0, size 0x8, virtual true, abstract: false, final true
inline bool get_CanSeek() ;

/// @brief Method get_CanWrite, addr 0x2597ff8, size 0x8, virtual true, abstract: false, final true
inline bool get_CanWrite() ;

/// @brief Method get_FlushMode, addr 0x2598098, size 0x8, virtual true, abstract: false, final false
inline int32_t get_FlushMode() ;

/// @brief Method get_Length, addr 0x25980a8, size 0x38, virtual true, abstract: false, final true
inline int64_t get_Length() ;

/// @brief Method get_Position, addr 0x25980e0, size 0x38, virtual true, abstract: false, final true
inline int64_t get_Position() ;

/// @brief Method get_TotalIn, addr 0x25983d4, size 0x1c, virtual true, abstract: false, final false
inline int64_t get_TotalIn() ;

/// @brief Method get_TotalOut, addr 0x25983f0, size 0x1c, virtual true, abstract: false, final false
inline int64_t get_TotalOut() ;

/// @brief Method set_FlushMode, addr 0x25980a0, size 0x8, virtual true, abstract: false, final false
inline void set_FlushMode(int32_t  value) ;

/// @brief Method set_Position, addr 0x2598118, size 0x38, virtual true, abstract: false, final true
