...
/// @brief Method .ctor, addr 0x25920e8, size 0x50, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF_config_table, put=setStaticF_config_table)) ::ArrayW<::Org::BouncyCastle::Utilities::Zlib::__Deflate__Config*,::Array<::Org::BouncyCastle::Utilities::Zlib::__Deflate__Config*>*>  config_table;
...
/// @brief Method .ctor, addr 0x258f118, size 0x140, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method _tr_align, addr 0x258fef8, size 0xe0, virtual false, abstract: false, final false
inline void _tr_align() ;

/// @brief Method _tr_flush_block, addr 0x25907e4, size 0x1b8, virtual false, abstract: false, final false
inline void _tr_flush_block(int32_t  buf, int32_t  stored_len, bool  eof) ;

/// @brief Method _tr_stored_block, addr 0x2590cc0, size 0x44, virtual false, abstract: false, final false
inline void _tr_stored_block(int32_t  buf, int32_t  stored_len, bool  eof) ;

/// @brief Method _tr_tally, addr 0x25900ac, size 0x2a0, virtual false, abstract: false, final false
inline bool _tr_tally(int32_t  dist, int32_t  lc) ;

/// @brief Method bi_flush, addr 0x258ffd8, size 0xd4, virtual false, abstract: false, final false
inline void bi_flush() ;

/// @brief Method bi_windup, addr 0x259066c, size 0xb0, virtual false, abstract: false, final false
inline void bi_windup() ;

/// @brief Method build_bl_tree, addr 0x258f8b4, size 0x124, virtual false, abstract: false, final false
inline int32_t build_bl_tree() ;

/// @brief Method compress_block, addr 0x259034c, size 0x274, virtual false, abstract: false, final false
inline void compress_block(::ArrayW<int16_t,::Array<int16_t>*>  ltree, ::ArrayW<int16_t,::Array<int16_t>*>  dtree) ;

/// @brief Method copy_block, addr 0x259071c, size 0x80, virtual false, abstract: false, final false
inline void copy_block(int32_t  buf, int32_t  len, bool  header) ;

/// @brief Method deflate, addr 0x2591d00, size 0x3e8, virtual false, abstract: false, final false
inline int32_t deflate(::Org::BouncyCastle::Utilities::Zlib::ZStream*  strm, int32_t  flush) ;

/// @brief Method deflateEnd, addr 0x25919c4, size 0x44, virtual false, abstract: false, final false
inline int32_t deflateEnd() ;

/// @brief Method deflateInit, addr 0x259193c, size 0x14, virtual false, abstract: false, final false
inline int32_t deflateInit(::Org::BouncyCastle::Utilities::Zlib::ZStream*  strm, int32_t  level) ;

/// @brief Method deflateInit, addr 0x2591780, size 0x14, virtual false, abstract: false, final false
inline int32_t deflateInit(::Org::BouncyCastle::Utilities::Zlib::ZStream*  strm, int32_t  level, int32_t  bits) ;

/// @brief Method deflateInit2, addr 0x2591794, size 0x1a8, virtual false, abstract: false, final false
...
/// @brief Method deflateParams, addr 0x2591a08, size 0x184, virtual false, abstract: false, final false
inline int32_t deflateParams(::Org::BouncyCastle::Utilities::Zlib::ZStream*  strm, int32_t  _level, int32_t  _strategy) ;

/// @brief Method deflateReset, addr 0x2591950, size 0x74, virtual false, abstract: false, final false
inline int32_t deflateReset(::Org::BouncyCastle::Utilities::Zlib::ZStream*  strm) ;

/// @brief Method deflateSetDictionary, addr 0x2591b8c, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method deflate_fast, addr 0x2590d04, size 0x31c, virtual false, abstract: false, final false
inline int32_t deflate_fast(int32_t  flush) ;

/// @brief Method deflate_slow, addr 0x25913cc, size 0x3b4, virtual false, abstract: false, final false
inline int32_t deflate_slow(int32_t  flush) ;

/// @brief Method deflate_stored, addr 0x259099c, size 0x164, virtual false, abstract: false, final false
inline int32_t deflate_stored(int32_t  flush) ;

/// @brief Method fill_window, addr 0x2590b00, size 0x1c0, virtual false, abstract: false, final false
inline void fill_window() ;

/// @brief Method flush_block_only, addr 0x259079c, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method init_block, addr 0x258f428, size 0xb4, virtual false, abstract: false, final false
inline void init_block() ;

/// @brief Method lm_init, addr 0x258f258, size 0x114, virtual false, abstract: false, final false
inline void lm_init() ;

/// @brief Method longest_match, addr 0x2591020, size 0x3ac, virtual false, abstract: false, final false
inline int32_t longest_match(int32_t  cur_match) ;

/// @brief Method pqdownheap, addr 0x258f4dc, size 0x1b4, virtual false, abstract: false, final false
inline void pqdownheap(::ArrayW<int16_t,::Array<int16_t>*>  tree, int32_t  k) ;

/// @brief Method putShortMSB, addr 0x258fe90, size 0x68, virtual false, abstract: false, final false
inline void putShortMSB(int32_t  b) ;

/// @brief Method put_byte, addr 0x258fdec, size 0x3c, virtual false, abstract: false, final false
inline void put_byte(uint8_t  c) ;

/// @brief Method put_byte, addr 0x258fda4, size 0x48, virtual false, abstract: false, final false
inline void put_byte(::ArrayW<uint8_t,::Array<uint8_t>*>  p, int32_t  start, int32_t  len) ;

/// @brief Method put_short, addr 0x258fe28, size 0x68, virtual false, abstract: false, final false
inline void put_short(int32_t  w) ;

/// @brief Method scan_tree, addr 0x258f71c, size 0x198, virtual false, abstract: false, final false
inline void scan_tree(::ArrayW<int16_t,::Array<int16_t>*>  tree, int32_t  max_code) ;

/// @brief Method send_all_trees, addr 0x258f9d8, size 0x130, virtual false, abstract: false, final false
inline void send_all_trees(int32_t  lcodes, int32_t  dcodes, int32_t  blcodes) ;

/// @brief Method send_bits, addr 0x258fb08, size 0xb8, virtual false, abstract: false, final false
inline void send_bits(int32_t  val, int32_t  length) ;

/// @brief Method send_code, addr 0x258fd60, size 0x44, virtual false, abstract: false, final false
inline void send_code(int32_t  c, ::ArrayW<int16_t,::Array<int16_t>*>  tree) ;

/// @brief Method send_tree, addr 0x258fbc0, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method set_data_type, addr 0x25905c0, size 0xac, virtual false, abstract: false, final false
inline void set_data_type() ;

/// @brief Method smaller, addr 0x258f690, size 0x8c, virtual false, abstract: false, final false
static inline bool smaller(::ArrayW<int16_t,::Array<int16_t>*>  tree, int32_t  n, int32_t  m, ::ArrayW<uint8_t,::Array<uint8_t>*>  depth) ;

/// @brief Method tr_init, addr 0x258f36c, size 0xbc, virtual false, abstract: false, final false
inline void tr_init() ;
