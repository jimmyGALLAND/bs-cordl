...
/// @brief Method Decode, addr 0x258cde0, size 0x228, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method Decode, addr 0x258d0fc, size 0x210, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Decode(::StringW  data) ;

/// @brief Method Decode, addr 0x258d008, size 0xf4, virtual false, abstract: false, final false
static inline int32_t Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  data, ::System::IO::Stream*  outStr) ;

/// @brief Method Decode, addr 0x258d30c, size 0xe4, virtual false, abstract: false, final false
static inline int32_t Decode(::StringW  data, ::System::IO::Stream*  outStr) ;

/// @brief Method Encode, addr 0x258cacc, size 0x224, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Encode(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method Encode, addr 0x258ccf0, size 0xf0, virtual false, abstract: false, final false
