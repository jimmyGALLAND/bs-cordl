...
/// @brief Method ProcessByte, addr 0x258b1c0, size 0x128, virtual false, abstract: false, final false
inline int32_t ProcessByte(uint8_t  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff) ;

/// @brief Method ProcessBytes, addr 0x258b2e8, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x258b088, size 0x138, virtual false, abstract: false, final false
