...
/// @brief Method Decode, addr 0x258a0f4, size 0x3f0, virtual true, abstract: false, final true
inline int32_t Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  off, int32_t  length, ::System::IO::Stream*  outStream) ;

/// @brief Method DecodeString, addr 0x258a748, size 0x3fc, virtual true, abstract: false, final true
inline int32_t DecodeString(::StringW  data, ::System::IO::Stream*  outStream) ;

/// @brief Method Encode, addr 0x2589f9c, size 0x12c, virtual true, abstract: false, final true
inline int32_t Encode(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len, ::System::IO::Stream*  outStream) ;

/// @brief Method Encode, addr 0x2589c0c, size 0x390, virtual false, abstract: false, final false
...
/// @brief Method InitialiseDecodingTable, addr 0x2589aac, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2589b68, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method decodeLastBlock, addr 0x258a55c, size 0x1ec, virtual false, abstract: false, final false
...
/// @brief Method ignore, addr 0x258a0c8, size 0x2c, virtual false, abstract: false, final false
inline bool ignore(char16_t  c) ;

/// @brief Method nextI, addr 0x258a4e4, size 0x78, virtual false, abstract: false, final false
inline int32_t nextI(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  i, int32_t  finish) ;

/// @brief Method nextI, addr 0x258ab44, size 0x84, virtual false, abstract: false, final false
