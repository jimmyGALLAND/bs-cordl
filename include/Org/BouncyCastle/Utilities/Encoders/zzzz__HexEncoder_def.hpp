...
/// @brief Method Decode, addr 0x258ba50, size 0x2f4, virtual true, abstract: false, final true
inline int32_t Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  off, int32_t  length, ::System::IO::Stream*  outStream) ;

/// @brief Method DecodeStrict, addr 0x258c1ec, size 0x238, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> DecodeStrict(::StringW  str, int32_t  off, int32_t  len) ;

/// @brief Method DecodeString, addr 0x258be14, size 0x2ec, virtual true, abstract: false, final true
inline int32_t DecodeString(::StringW  data, ::System::IO::Stream*  outStream) ;

/// @brief Method Encode, addr 0x258b75c, size 0x110, virtual true, abstract: false, final true
inline int32_t Encode(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len, ::System::IO::Stream*  outStream) ;

/// @brief Method Encode, addr 0x258c710, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method Ignore, addr 0x258c7e8, size 0x2c, virtual false, abstract: false, final false
static inline bool Ignore(char16_t  c) ;

/// @brief Method InitialiseDecodingTable, addr 0x258c5ac, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x258c510, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;
