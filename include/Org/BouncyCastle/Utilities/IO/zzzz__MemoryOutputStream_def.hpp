...
/// @brief Method .ctor, addr 0x258d89c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CanRead, addr 0x258d894, size 0x8, virtual true, abstract: false, final true
