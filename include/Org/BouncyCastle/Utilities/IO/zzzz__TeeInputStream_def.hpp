...
/// @brief Method Close, addr 0x258dfcc, size 0x74, virtual true, abstract: false, final false
inline void Close() ;

static inline ::Org::BouncyCastle::Utilities::IO::TeeInputStream* New_ctor(::System::IO::Stream*  input, ::System::IO::Stream*  tee) ;

/// @brief Method Read, addr 0x258e040, size 0x78, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method ReadByte, addr 0x258e0b8, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x258dfa0, size 0x2c, virtual false, abstract: false, final false
