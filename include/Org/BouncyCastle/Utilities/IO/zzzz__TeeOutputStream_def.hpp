...
/// @brief Method Close, addr 0x258e140, size 0x74, virtual true, abstract: false, final false
inline void Close() ;

static inline ::Org::BouncyCastle::Utilities::IO::TeeOutputStream* New_ctor(::System::IO::Stream*  output, ::System::IO::Stream*  tee) ;

/// @brief Method Write, addr 0x258e1b4, size 0x68, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method WriteByte, addr 0x258e21c, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x258e114, size 0x2c, virtual false, abstract: false, final false
