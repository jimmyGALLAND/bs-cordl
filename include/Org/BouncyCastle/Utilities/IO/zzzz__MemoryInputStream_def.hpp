...
/// @brief Method .ctor, addr 0x258d880, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer) ;

/// @brief Method get_CanWrite, addr 0x258d88c, size 0x8, virtual true, abstract: false, final true
