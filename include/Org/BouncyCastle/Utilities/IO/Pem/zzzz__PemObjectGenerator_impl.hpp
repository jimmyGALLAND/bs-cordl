...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Utilities::IO::Pem::PemObject* (::Org::BouncyCastle::Utilities::IO::Pem::PemObjectGenerator::*)()>(&::Org::BouncyCastle::Utilities::IO::Pem::PemObjectGenerator::Generate)> {
