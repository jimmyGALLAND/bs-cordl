...
/// @brief Method GetOutputSize, addr 0x2506ef4, size 0x4d4, virtual false, abstract: false, final false
...
/// @brief Method WriteEncoded, addr 0x25079a8, size 0xe8, virtual false, abstract: false, final false
inline void WriteEncoded(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method WriteObject, addr 0x25073c8, size 0x54c, virtual false, abstract: false, final false
inline void WriteObject(::Org::BouncyCastle::Utilities::IO::Pem::PemObjectGenerator*  objGen) ;

/// @brief Method WritePostEncapsulationBoundary, addr 0x2507a90, size 0x94, virtual false, abstract: false, final false
inline void WritePostEncapsulationBoundary(::StringW  type) ;

/// @brief Method WritePreEncapsulationBoundary, addr 0x2507914, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2506df4, size 0xf8, virtual false, abstract: false, final false
inline void _ctor(::System::IO::TextWriter*  writer) ;

/// @brief Method get_Writer, addr 0x2506eec, size 0x8, virtual false, abstract: false, final false
