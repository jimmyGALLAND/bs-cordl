...
/// @brief Method NanoTime, addr 0x259c5f8, size 0xa0, virtual false, abstract: false, final false
static inline int64_t NanoTime() ;

static inline ::Org::BouncyCastle::Utilities::Times* New_ctor() ;

/// @brief Method .ctor, addr 0x259c6e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
