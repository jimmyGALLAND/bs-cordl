...
/// @brief Method GetEnumerator, addr 0x2585754, size 0x58, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* GetEnumerator() ;

static inline ::Org::BouncyCastle::Utilities::Collections::EmptyEnumerable* New_ctor() ;

/// @brief Method .ctor, addr 0x258574c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
