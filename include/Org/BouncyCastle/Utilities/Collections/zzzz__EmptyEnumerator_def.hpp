...
/// @brief Method MoveNext, addr 0x2585810, size 0x8, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::Org::BouncyCastle::Utilities::Collections::EmptyEnumerator* New_ctor() ;

/// @brief Method Reset, addr 0x2585818, size 0x4, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method .ctor, addr 0x2585808, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::IEnumerator* getStaticF_Instance() ;

/// @brief Method get_Current, addr 0x258581c, size 0x4c, virtual true, abstract: false, final true
