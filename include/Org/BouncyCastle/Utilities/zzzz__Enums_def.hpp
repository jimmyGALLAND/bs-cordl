...
public:
// Declarations
/// @brief Method GetArbitraryValue, addr 0x259b48c, size 0xe0, virtual false, abstract: false, final false
static inline ::bs_hook::EnumPtr GetArbitraryValue(::System::Type*  enumType) ;

/// @brief Method GetEnumValue, addr 0x259b1c0, size 0x1d8, virtual false, abstract: false, final false
static inline ::bs_hook::EnumPtr GetEnumValue(::System::Type*  enumType, ::StringW  s) ;

/// @brief Method GetEnumValues, addr 0x259b3b8, size 0xd4, virtual false, abstract: false, final false
static inline ::System::Array* GetEnumValues(::System::Type*  enumType) ;

/// @brief Method IsEnumType, addr 0x259b398, size 0x20, virtual false, abstract: false, final false
static inline bool IsEnumType(::System::Type*  t) ;

static inline ::Org::BouncyCastle::Utilities::Enums* New_ctor() ;

/// @brief Method .ctor, addr 0x259b56c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
