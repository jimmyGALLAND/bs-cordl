...
public:
// Declarations
/// @brief Method AsUnsignedByteArray, addr 0x259acb4, size 0x108, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> AsUnsignedByteArray(int32_t  length, ::Org::BouncyCastle::Math::BigInteger*  n) ;

/// @brief Method AsUnsignedByteArray, addr 0x259aca0, size 0x14, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> AsUnsignedByteArray(::Org::BouncyCastle::Math::BigInteger*  n) ;

/// @brief Method AsUnsignedByteArray, addr 0x259adbc, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method CreateRandomBigInteger, addr 0x259af04, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method CreateRandomInRange, addr 0x259af70, size 0x218, virtual false, abstract: false, final false
...
/// @brief Method GetUnsignedByteLength, addr 0x259b188, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x259b1b8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
