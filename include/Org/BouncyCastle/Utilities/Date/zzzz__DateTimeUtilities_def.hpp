...
/// @brief Method CurrentUnixMs, addr 0x2589688, size 0x84, virtual false, abstract: false, final false
static inline int64_t CurrentUnixMs() ;

/// @brief Method DateTimeToUnixMs, addr 0x258944c, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method UnixMsToDateTime, addr 0x25895d0, size 0xb8, virtual false, abstract: false, final false
static inline ::System::DateTime UnixMsToDateTime(int64_t  unixMs) ;

/// @brief Method .ctor, addr 0x2589444, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
