...
/// @brief Method NumberOfLeadingZeros, addr 0x259b574, size 0x78, virtual false, abstract: false, final false
static inline int32_t NumberOfLeadingZeros(int32_t  i) ;

/// @brief Method NumberOfTrailingZeros, addr 0x259b5ec, size 0x34, virtual false, abstract: false, final false
static inline int32_t NumberOfTrailingZeros(int32_t  i) ;

/// @brief Method RotateLeft, addr 0x259b620, size 0x14, virtual false, abstract: false, final false
static inline int32_t RotateLeft(int32_t  i, int32_t  distance) ;

/// @brief Method RotateLeft, addr 0x259b634, size 0x14, virtual false, abstract: false, final false
static inline uint32_t RotateLeft(uint32_t  i, int32_t  distance) ;

/// @brief Method RotateRight, addr 0x259b648, size 0x14, virtual false, abstract: false, final false
static inline int32_t RotateRight(int32_t  i, int32_t  distance) ;

/// @brief Method RotateRight, addr 0x259b65c, size 0x14, virtual false, abstract: false, final false
static inline uint32_t RotateRight(uint32_t  i, int32_t  distance) ;

/// @brief Method .ctor, addr 0x259b670, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
