...
/// @brief Method GetCertList, addr 0x24d3354, size 0x4cc, virtual false, abstract: false, final false
inline ::System::Collections::IList* GetCertList() ;

/// @brief Method GetCertificates, addr 0x24d3ab8, size 0x180, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::Store::IX509Store* GetCertificates(::StringW  type) ;

/// @brief Method GetCerts, addr 0x24d3820, size 0x298, virtual false, abstract: false, final false
inline ::ArrayW<::Org::BouncyCastle::X509::X509Certificate*,::Array<::Org::BouncyCastle::X509::X509Certificate*>*> GetCerts() ;

/// @brief Method GetEncoded, addr 0x24d3f74, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method GetRequestList, addr 0x24d30e8, size 0x13c, virtual false, abstract: false, final false
inline ::ArrayW<::Org::BouncyCastle::Ocsp::Req*,::Array<::Org::BouncyCastle::Ocsp::Req*>*> GetRequestList() ;

/// @brief Method GetSignature, addr 0x24d3328, size 0x2c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSignature() ;

/// @brief Method GetTbsRequest, addr 0x24d2f98, size 0xf4, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetTbsRequest() ;

/// @brief Method GetX509Extensions, addr 0x24d32bc, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method Verify, addr 0x24d3c38, size 0x33c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24d2de4, size 0x148, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1InputStream*  aIn) ;

/// @brief Method .ctor, addr 0x24d2f2c, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  inStr) ;

/// @brief Method .ctor, addr 0x24d2d78, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  req) ;

/// @brief Method .ctor, addr 0x24d2d50, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::OcspRequest*  req) ;

/// @brief Method get_IsSigned, addr 0x24d3304, size 0x24, virtual false, abstract: false, final false
inline bool get_IsSigned() ;

/// @brief Method get_RequestExtensions, addr 0x24d324c, size 0x70, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_RequestExtensions() ;

/// @brief Method get_RequestorName, addr 0x24d30c0, size 0x28, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::GeneralName* get_RequestorName() ;

/// @brief Method get_SignatureAlgOid, addr 0x24d32c0, size 0x44, virtual false, abstract: false, final false
inline ::StringW get_SignatureAlgOid() ;

/// @brief Method get_Version, addr 0x24d308c, size 0x34, virtual false, abstract: false, final false
