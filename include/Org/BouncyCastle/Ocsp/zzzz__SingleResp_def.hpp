...
/// @brief Method GetCertID, addr 0x24d8658, size 0x68, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Ocsp::CertificateID* GetCertID() ;

/// @brief Method GetCertStatus, addr 0x24d86c0, size 0xc0, virtual false, abstract: false, final false
inline ::System::Object* GetCertStatus() ;

/// @brief Method GetX509Extensions, addr 0x24d8898, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24cf898, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Ocsp::SingleResponse*  resp) ;

/// @brief Method get_NextUpdate, addr 0x24d87fc, size 0x80, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::Date::DateTimeObject* get_NextUpdate() ;

/// @brief Method get_SingleExtensions, addr 0x24d887c, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509Extensions* get_SingleExtensions() ;

/// @brief Method get_ThisUpdate, addr 0x24d87d8, size 0x24, virtual false, abstract: false, final false
