...
/// @brief Method ToRequest, addr 0x24d4ed8, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24d4070, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method AddRequest, addr 0x24d3f90, size 0xe0, virtual false, abstract: false, final false
inline void AddRequest(::Org::BouncyCastle::Ocsp::CertificateID*  certId) ;

/// @brief Method AddRequest, addr 0x24d409c, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x24d4f4c, size 0x14, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Ocsp::OcspReq* Generate() ;

/// @brief Method Generate, addr 0x24d4f60, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Ocsp::OcspReq* Generate(::StringW  signingAlgorithm, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  privateKey, ::ArrayW<::Org::BouncyCastle::X509::X509Certificate*,::Array<::Org::BouncyCastle::X509::X509Certificate*>*>  chain) ;

/// @brief Method Generate, addr 0x24d4f68, size 0x1a4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Ocsp::OcspReq* Generate(::StringW  signingAlgorithm, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  privateKey, ::ArrayW<::Org::BouncyCastle::X509::X509Certificate*,::Array<::Org::BouncyCastle::X509::X509Certificate*>*>  chain, ::Org::BouncyCastle::Security::SecureRandom*  random) ;

/// @brief Method GenerateRequest, addr 0x24d42b8, size 0xc20, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Ocsp::OcspReq* GenerateRequest(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  signingAlgorithm, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  privateKey, ::ArrayW<::Org::BouncyCastle::X509::X509Certificate*,::Array<::Org::BouncyCastle::X509::X509Certificate*>*>  chain, ::Org::BouncyCastle::Security::SecureRandom*  random) ;

static inline ::Org::BouncyCastle::Ocsp::OcspReqGenerator* New_ctor() ;

/// @brief Method SetRequestExtensions, addr 0x24d42b0, size 0x8, virtual false, abstract: false, final false
inline void SetRequestExtensions(::Org::BouncyCastle::Asn1::X509::X509Extensions*  requestExtensions) ;

/// @brief Method SetRequestorName, addr 0x24d42a8, size 0x8, virtual false, abstract: false, final false
inline void SetRequestorName(::Org::BouncyCastle::Asn1::X509::GeneralName*  requestorName) ;

/// @brief Method SetRequestorName, addr 0x24d4180, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24d5360, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_SignatureAlgNames, addr 0x24d5314, size 0x4c, virtual false, abstract: false, final false
