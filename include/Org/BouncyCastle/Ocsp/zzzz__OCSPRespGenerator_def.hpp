...
public:
// Declarations
/// @brief Method Generate, addr 0x24d58c4, size 0x2e4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24d5ba8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
