...
/// @brief Method CalculateDigest, addr 0x2558c20, size 0xf8, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> CalculateDigest(::StringW  algorithm, ::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method CalculateDigest, addr 0x2558bb8, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method DoFinal, addr 0x2558d18, size 0x134, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> DoFinal(::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method DoFinal, addr 0x2558e4c, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method GetAlgorithmName, addr 0x2558ab0, size 0x108, virtual false, abstract: false, final false
static inline ::StringW GetAlgorithmName(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method GetDigest, addr 0x2558030, size 0xa80, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::IDigest* GetDigest(::StringW  algorithm) ;

/// @brief Method GetDigest, addr 0x2557fd0, size 0x60, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::IDigest* GetDigest(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  id) ;

/// @brief Method GetObjectIdentifier, addr 0x2557cac, size 0x258, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2554264, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Algorithms, addr 0x2557f04, size 0xcc, virtual false, abstract: false, final false
