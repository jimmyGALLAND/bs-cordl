...
public:
// Declarations
/// @brief Method CreateKey, addr 0x256ed84, size 0x1c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::System::IO::Stream*  inStr) ;

/// @brief Method CreateKey, addr 0x256d834, size 0x1550, virtual false, abstract: false, final false
...
/// @brief Method CreateKey, addr 0x256d818, size 0x1c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* CreateKey(::ArrayW<uint8_t,::Array<uint8_t>*>  keyInfoData) ;

/// @brief Method GetRawKey, addr 0x256f010, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method IsPkcsDHParam, addr 0x256eda0, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method ReadPkcsDHParam, addr 0x256eee0, size 0x130, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Parameters::DHPublicKeyParameters* ReadPkcsDHParam(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  algOid, ::Org::BouncyCastle::Math::BigInteger*  y, ::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method .ctor, addr 0x256d810, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
