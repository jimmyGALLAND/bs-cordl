...
/// @brief Method CreatePrng, addr 0x237e180, size 0x1a8, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Prng::DigestRandomGenerator* CreatePrng(::StringW  digestName, bool  autoSeed) ;

/// @brief Method GenerateSeed, addr 0x237e694, size 0x90, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSeed(int32_t  length) ;

/// @brief Method GetInstance, addr 0x237e328, size 0x58, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Security::SecureRandom* GetInstance(::StringW  algorithm) ;

/// @brief Method GetInstance, addr 0x237e380, size 0x17c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Security::SecureRandom* GetInstance(::StringW  algorithm, bool  autoSeed) ;

/// @brief Method GetNextBytes, addr 0x237cdc4, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method GetSeed, addr 0x237e56c, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method Next, addr 0x237e878, size 0x20, virtual true, abstract: false, final false
inline int32_t Next() ;

/// @brief Method Next, addr 0x237e898, size 0xe8, virtual true, abstract: false, final false
inline int32_t Next(int32_t  maxValue) ;

/// @brief Method Next, addr 0x237e980, size 0xc4, virtual true, abstract: false, final false
inline int32_t Next(int32_t  minValue, int32_t  maxValue) ;

/// @brief Method NextBytes, addr 0x237ea44, size 0xac, virtual true, abstract: false, final false
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  buf) ;

/// @brief Method NextBytes, addr 0x237eaf0, size 0xc4, virtual true, abstract: false, final false
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method NextCounterValue, addr 0x237e0d0, size 0x58, virtual false, abstract: false, final false
static inline int64_t NextCounterValue() ;

/// @brief Method NextDouble, addr 0x237ebb4, size 0xb8, virtual true, abstract: false, final false
inline double_t NextDouble() ;

/// @brief Method NextInt, addr 0x237ec6c, size 0x6c, virtual true, abstract: false, final false
inline int32_t NextInt() ;

/// @brief Method NextLong, addr 0x237ecd8, size 0x6c, virtual true, abstract: false, final false
inline int64_t NextLong() ;

/// @brief Method SetSeed, addr 0x237e724, size 0xa8, virtual true, abstract: false, final false
inline void SetSeed(::ArrayW<uint8_t,::Array<uint8_t>*>  seed) ;

/// @brief Method SetSeed, addr 0x237e7cc, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2374648, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x237e4fc, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Prng::IRandomGenerator*  generator) ;

/// @brief Method .ctor, addr 0x237e5fc, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method get_Master, addr 0x237e128, size 0x58, virtual false, abstract: false, final false
