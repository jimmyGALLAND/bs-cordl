...
/// @brief Method CalculateMac, addr 0x2560cdc, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method DoFinal, addr 0x2560e34, size 0x134, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> DoFinal(::Org::BouncyCastle::Crypto::IMac*  mac) ;

/// @brief Method DoFinal, addr 0x2560f68, size 0xec, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> DoFinal(::Org::BouncyCastle::Crypto::IMac*  mac, ::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method GetAlgorithmName, addr 0x2560bd4, size 0x108, virtual false, abstract: false, final false
static inline ::StringW GetAlgorithmName(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method GetMac, addr 0x2560064, size 0xb70, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::IMac* GetMac(::StringW  algorithm) ;

/// @brief Method GetMac, addr 0x2560004, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x255e3ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
