...
/// @brief Method Init, addr 0x257cde8, size 0xc4, virtual true, abstract: false, final true
...
/// @brief Method Unwrap, addr 0x257cfc0, size 0x114, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method Wrap, addr 0x257ceac, size 0x114, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x257cc18, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBufferedCipher*  cipher) ;

/// @brief Method get_AlgorithmName, addr 0x257cd48, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method GetAlgorithmName, addr 0x257cc40, size 0x108, virtual false, abstract: false, final false
static inline ::StringW GetAlgorithmName(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method GetWrapper, addr 0x257c6e0, size 0x538, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::IWrapper* GetWrapper(::StringW  algorithm) ;

/// @brief Method GetWrapper, addr 0x257c680, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x257bec0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
