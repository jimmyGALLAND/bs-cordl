...
/// @brief Method CreateBlockCipher, addr 0x2553c28, size 0x534, virtual false, abstract: false, final false
...
/// @brief Method GetAlgorithmName, addr 0x255415c, size 0x108, virtual false, abstract: false, final false
static inline ::StringW GetAlgorithmName(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method GetCipher, addr 0x2551cbc, size 0x1ebc, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::IBufferedCipher* GetCipher(::StringW  algorithm) ;

/// @brief Method GetCipher, addr 0x2551c5c, size 0x60, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::IBufferedCipher* GetCipher(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid) ;

/// @brief Method GetDigitIndex, addr 0x2553b78, size 0xb0, virtual false, abstract: false, final false
static inline int32_t GetDigitIndex(::StringW  s) ;

/// @brief Method GetObjectIdentifier, addr 0x2551938, size 0x258, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2551930, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Algorithms, addr 0x2551b90, size 0xcc, virtual false, abstract: false, final false
