...
/// @brief Method AddAlgorithm, addr 0x256270c, size 0x1c4, virtual false, abstract: false, final false
static inline void AddAlgorithm(::StringW  canonicalName, ::ArrayW<::System::Object*,::Array<::System::Object*>*>  aliases) ;

/// @brief Method AddBasicIVSizeEntries, addr 0x25628d0, size 0x164, virtual false, abstract: false, final false
static inline void AddBasicIVSizeEntries(int32_t  size, ::ArrayW<::StringW,::Array<::StringW>*>  algorithms) ;

/// @brief Method CreateIV, addr 0x2563994, size 0x68, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> CreateIV(::Org::BouncyCastle::Security::SecureRandom*  random, int32_t  ivLength) ;

/// @brief Method CreateIVOctetString, addr 0x25638f4, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method CreateKeyParameter, addr 0x2562b6c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method CreateKeyParameter, addr 0x2562ef4, size 0x80, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Parameters::KeyParameter* CreateKeyParameter(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  algOid, ::ArrayW<uint8_t,::Array<uint8_t>*>  keyBytes, int32_t  offset, int32_t  length) ;

/// @brief Method CreateKeyParameter, addr 0x2562e88, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method CreateKeyParameter, addr 0x2562be0, size 0x2a8, virtual false, abstract: false, final false
...
/// @brief Method FindBasicIVSize, addr 0x2563400, size 0x1a4, virtual false, abstract: false, final false
static inline int32_t FindBasicIVSize(::StringW  canonicalName) ;

/// @brief Method GenerateParameters, addr 0x25635a4, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method GenerateParameters, addr 0x256360c, size 0x2e8, virtual false, abstract: false, final false
...
/// @brief Method GetCanonicalAlgorithmName, addr 0x2562a34, size 0x138, virtual false, abstract: false, final false
static inline ::StringW GetCanonicalAlgorithmName(::StringW  algorithm) ;

/// @brief Method GetCipherParameters, addr 0x2562f74, size 0x78, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::ICipherParameters* GetCipherParameters(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  algOid, ::Org::BouncyCastle::Crypto::ICipherParameters*  key, ::Org::BouncyCastle::Asn1::Asn1Object*  asn1Params) ;

/// @brief Method GetCipherParameters, addr 0x2562fec, size 0x414, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::ICipherParameters* GetCipherParameters(::StringW  algorithm, ::Org::BouncyCastle::Crypto::ICipherParameters*  key, ::Org::BouncyCastle::Asn1::Asn1Object*  asn1Params) ;

static inline ::Org::BouncyCastle::Security::ParameterUtilities* New_ctor() ;

/// @brief Method WithRandom, addr 0x25639fc, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x256106c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
