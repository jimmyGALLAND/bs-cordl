...
/// @brief Method GetRandom, addr 0x23746c0, size 0x8, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Crypto::Parameters::ParametersWithRandom* New_ctor(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters, ::Org::BouncyCastle::Security::SecureRandom*  random) ;
...
/// @brief Method .ctor, addr 0x23745e0, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method .ctor, addr 0x2374544, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters, ::Org::BouncyCastle::Security::SecureRandom*  random) ;

/// @brief Method get_Parameters, addr 0x23746d0, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* get_Parameters() ;

/// @brief Method get_Random, addr 0x23746c8, size 0x8, virtual false, abstract: false, final false
