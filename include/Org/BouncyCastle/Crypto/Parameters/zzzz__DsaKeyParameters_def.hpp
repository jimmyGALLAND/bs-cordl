...
/// @brief Method Equals, addr 0x236dfd0, size 0x9c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x236e06c, size 0x50, virtual false, abstract: false, final false
inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DsaKeyParameters*  other) ;

/// @brief Method GetHashCode, addr 0x236e0bc, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x236df98, size 0x30, virtual false, abstract: false, final false
inline void _ctor(bool  isPrivate, ::Org::BouncyCastle::Crypto::Parameters::DsaParameters*  parameters) ;

/// @brief Method get_Parameters, addr 0x236dfc8, size 0x8, virtual false, abstract: false, final false
