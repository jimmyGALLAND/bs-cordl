...
/// @brief Method .ctor, addr 0x23748a0, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  key, int32_t  rounds) ;

/// @brief Method get_Rounds, addr 0x2374928, size 0x8, virtual false, abstract: false, final false
