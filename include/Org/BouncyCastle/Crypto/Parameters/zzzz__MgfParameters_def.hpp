...
/// @brief Method GetSeed, addr 0x2373d4c, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2373ca0, size 0x1c, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  seed) ;

/// @brief Method .ctor, addr 0x2373cbc, size 0x90, virtual false, abstract: false, final false
