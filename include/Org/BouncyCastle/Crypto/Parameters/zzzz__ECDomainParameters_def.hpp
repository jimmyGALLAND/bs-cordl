...
/// @brief Method Equals, addr 0x236f0fc, size 0xa4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x236f1a0, size 0x88, virtual true, abstract: false, final false
inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters*  other) ;

/// @brief Method GetHashCode, addr 0x236f228, size 0x7c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetSeed, addr 0x236f0a0, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method ValidatePrivateScalar, addr 0x236f2a4, size 0x130, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* ValidatePrivateScalar(::Org::BouncyCastle::Math::BigInteger*  d) ;

/// @brief Method ValidatePublicPoint, addr 0x236ee98, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method ValidatePublicPoint, addr 0x236f3d4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x236ee04, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x236ee90, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x236ecc8, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x236ec80, size 0x48, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::X9::X9ECParameters*  x9) ;

/// @brief Method get_Curve, addr 0x236efbc, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* get_Curve() ;

/// @brief Method get_G, addr 0x236efc4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_G() ;

/// @brief Method get_H, addr 0x236efd4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_H() ;

/// @brief Method get_HInv, addr 0x236efdc, size 0xc4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_HInv() ;

/// @brief Method get_N, addr 0x236efcc, size 0x8, virtual false, abstract: false, final false
