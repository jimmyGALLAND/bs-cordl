...
/// @brief Method GetStrength, addr 0x236c9f0, size 0x34, virtual false, abstract: false, final false
static inline int32_t GetStrength(::Org::BouncyCastle::Crypto::Parameters::DHParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters* New_ctor(::Org::BouncyCastle::Security::SecureRandom*  random, ::Org::BouncyCastle::Crypto::Parameters::DHParameters*  parameters) ;
...
/// @brief Method .ctor, addr 0x236c9b4, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_Parameters, addr 0x236ca24, size 0x8, virtual false, abstract: false, final false
