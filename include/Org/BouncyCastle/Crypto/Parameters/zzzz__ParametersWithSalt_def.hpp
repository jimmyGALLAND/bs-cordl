...
/// @brief Method GetSalt, addr 0x2374788, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23746d8, size 0x1c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters, ::ArrayW<uint8_t,::Array<uint8_t>*>  salt) ;

/// @brief Method .ctor, addr 0x23746f4, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method get_Parameters, addr 0x2374790, size 0x8, virtual false, abstract: false, final false
