...
/// @brief Method Encode, addr 0x2376f9c, size 0x84, virtual false, abstract: false, final false
inline void Encode(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off) ;

/// @brief Method GeneratePublicKey, addr 0x237707c, size 0xa4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters* GeneratePublicKey() ;

/// @brief Method GenerateSecret, addr 0x23771dc, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method GetEncoded, addr 0x2377020, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2376ddc, size 0xbc, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off) ;

/// @brief Method .ctor, addr 0x2376e98, size 0x104, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input) ;

/// @brief Method .ctor, addr 0x2376d38, size 0xa4, virtual false, abstract: false, final false
