...
/// @brief Method Encode, addr 0x23777b8, size 0x84, virtual false, abstract: false, final false
inline void Encode(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off) ;

/// @brief Method GeneratePublicKey, addr 0x2377898, size 0xa4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::X448PublicKeyParameters* GeneratePublicKey() ;

/// @brief Method GenerateSecret, addr 0x23779f8, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method GetEncoded, addr 0x237783c, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23775f8, size 0xbc, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off) ;

/// @brief Method .ctor, addr 0x23776b4, size 0x104, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input) ;

/// @brief Method .ctor, addr 0x2377554, size 0xa4, virtual false, abstract: false, final false
