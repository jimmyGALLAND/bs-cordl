...
/// @brief Method LookupParameters, addr 0x23724e4, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x237247c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(bool  isPrivate, ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters*  parameters) ;

/// @brief Method .ctor, addr 0x23724ac, size 0x38, virtual false, abstract: false, final false
inline void _ctor(bool  isPrivate, ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  publicKeyParamSet) ;

/// @brief Method get_Parameters, addr 0x237264c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters* get_Parameters() ;

/// @brief Method get_PublicKeyParamSet, addr 0x2372654, size 0x8, virtual false, abstract: false, final false
