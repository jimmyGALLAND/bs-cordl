...
/// @brief Method .ctor, addr 0x2373fc0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method get_EphemeralPublicKey, addr 0x23740b8, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters* get_EphemeralPublicKey() ;

/// @brief Method get_StaticPublicKey, addr 0x23740b0, size 0x8, virtual true, abstract: false, final false
