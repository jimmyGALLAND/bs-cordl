...
/// @brief Method GetIV, addr 0x23744c4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23743c4, size 0x1c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters, ::ArrayW<uint8_t,::Array<uint8_t>*>  iv) ;

/// @brief Method .ctor, addr 0x23743e0, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method get_Parameters, addr 0x237453c, size 0x8, virtual false, abstract: false, final false
