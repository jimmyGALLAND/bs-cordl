...
/// @brief Method GetAssociatedText, addr 0x236bd00, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetAssociatedText() ;

/// @brief Method GetNonce, addr 0x236bd08, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x236bc6c, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Parameters::KeyParameter*  key, int32_t  macSize, ::ArrayW<uint8_t,::Array<uint8_t>*>  nonce) ;

/// @brief Method .ctor, addr 0x236bcac, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method get_Key, addr 0x236bcf0, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::KeyParameter* get_Key() ;

/// @brief Method get_MacSize, addr 0x236bcf8, size 0x8, virtual true, abstract: false, final false
