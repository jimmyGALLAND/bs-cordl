...
static inline ::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters* New_ctor(::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters*  domainParameters, ::Org::BouncyCastle::Security::SecureRandom*  random) ;

static inline ::Org::BouncyCastle::Crypto::Parameters::ECKeyGenerationParameters* New_ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  publicKeyParamSet, ::Org::BouncyCastle::Security::SecureRandom*  random) ;
...
/// @brief Method .ctor, addr 0x236f628, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x236f674, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method get_DomainParameters, addr 0x236f7f0, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* get_DomainParameters() ;

/// @brief Method get_PublicKeyParamSet, addr 0x236f7f8, size 0x8, virtual false, abstract: false, final false
