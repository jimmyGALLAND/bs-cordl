...
/// @brief Method Equals, addr 0x236cc54, size 0x9c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x236ccf0, size 0x50, virtual false, abstract: false, final false
inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DHKeyParameters*  other) ;

/// @brief Method GetHashCode, addr 0x236cd40, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x236cb84, size 0x84, virtual false, abstract: false, final false
inline void _ctor(bool  isPrivate, ::Org::BouncyCastle::Crypto::Parameters::DHParameters*  parameters) ;

/// @brief Method .ctor, addr 0x236cc08, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmOid, addr 0x236cc4c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_AlgorithmOid() ;

/// @brief Method get_Parameters, addr 0x236cc44, size 0x8, virtual false, abstract: false, final false
