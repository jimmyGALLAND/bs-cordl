...
/// @brief Method Equals, addr 0x236d524, size 0x9c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x236d5c0, size 0x58, virtual false, abstract: false, final false
inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters*  other) ;

/// @brief Method GetHashCode, addr 0x236d618, size 0x40, virtual true, abstract: false, final false
...
static inline ::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters* New_ctor(::Org::BouncyCastle::Math::BigInteger*  x, ::Org::BouncyCastle::Crypto::Parameters::DHParameters*  parameters, ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  algorithmOid) ;
...
/// @brief Method .ctor, addr 0x236d4b0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::BigInteger*  x, ::Org::BouncyCastle::Crypto::Parameters::DHParameters*  parameters) ;

/// @brief Method .ctor, addr 0x236d4d8, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method get_X, addr 0x236d51c, size 0x8, virtual false, abstract: false, final false
