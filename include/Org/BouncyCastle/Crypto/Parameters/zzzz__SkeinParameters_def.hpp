...
/// @brief Method Build, addr 0x2376870, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Set, addr 0x23763b8, size 0x170, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::__SkeinParameters__Builder* Set(int32_t  type, ::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method SetKey, addr 0x2376528, size 0xc, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::__SkeinParameters__Builder* SetKey(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method SetKeyIdentifier, addr 0x2376858, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method SetNonce, addr 0x2376864, size 0xc, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::__SkeinParameters__Builder* SetNonce(::ArrayW<uint8_t,::Array<uint8_t>*>  nonce) ;

/// @brief Method SetPersonalisation, addr 0x2376540, size 0x30c, virtual false, abstract: false, final false
...
/// @brief Method SetPersonalisation, addr 0x2376534, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method SetPublicKey, addr 0x237684c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2375c44, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2376028, size 0x390, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Parameters::SkeinParameters*  parameters) ;

/// @brief Method .ctor, addr 0x2375ca8, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method GetKey, addr 0x23756e4, size 0x110, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetKey() ;

/// @brief Method GetKeyIdentifier, addr 0x2375a1c, size 0x114, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetKeyIdentifier() ;

/// @brief Method GetNonce, addr 0x2375b30, size 0x114, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetNonce() ;

/// @brief Method GetParameters, addr 0x23756dc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::IDictionary* GetParameters() ;

/// @brief Method GetPersonalisation, addr 0x23757f4, size 0x114, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPersonalisation() ;

/// @brief Method GetPublicKey, addr 0x2375908, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2375648, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x23756b4, size 0x28, virtual false, abstract: false, final false
