...
/// @brief Method .ctor, addr 0x236e0f4, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(int32_t  L, int32_t  N, int32_t  certainty, ::Org::BouncyCastle::Security::SecureRandom*  random) ;

/// @brief Method .ctor, addr 0x236e140, size 0x54, virtual false, abstract: false, final false
inline void _ctor(int32_t  L, int32_t  N, int32_t  certainty, ::Org::BouncyCastle::Security::SecureRandom*  random, int32_t  usageIndex) ;

/// @brief Method get_Certainty, addr 0x236e1ac, size 0x8, virtual true, abstract: false, final false
inline int32_t get_Certainty() ;

/// @brief Method get_L, addr 0x236e194, size 0x8, virtual true, abstract: false, final false
inline int32_t get_L() ;

/// @brief Method get_N, addr 0x236e19c, size 0x8, virtual true, abstract: false, final false
inline int32_t get_N() ;

/// @brief Method get_Random, addr 0x236e1b4, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Security::SecureRandom* get_Random() ;

/// @brief Method get_UsageIndex, addr 0x236e1a4, size 0x8, virtual true, abstract: false, final false
