...
/// @brief Field mEphemeralPublicKey, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_mEphemeralPublicKey, put=__cordl_internal_set_mEphemeralPublicKey)) ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters*  mEphemeralPublicKey;
...
static inline ::Org::BouncyCastle::Crypto::Parameters::SM2KeyExchangePublicParameters* New_ctor(::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters*  staticPublicKey, ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters*  ephemeralPublicKey) ;
...
/// @brief Method .ctor, addr 0x2376b60, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method get_EphemeralPublicKey, addr 0x2376c58, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters* get_EphemeralPublicKey() ;

/// @brief Method get_StaticPublicKey, addr 0x2376c50, size 0x8, virtual true, abstract: false, final false
