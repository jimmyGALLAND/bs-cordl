...
/// @brief Method .ctor, addr 0x2374930, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method get_BlindingFactor, addr 0x23749bc, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_BlindingFactor() ;

/// @brief Method get_PublicKey, addr 0x23749b4, size 0x8, virtual false, abstract: false, final false
