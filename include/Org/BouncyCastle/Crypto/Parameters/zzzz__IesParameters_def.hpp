...
/// @brief Method GetDerivationV, addr 0x2373164, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetDerivationV() ;

/// @brief Method GetEncodingV, addr 0x237316c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2373128, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  derivation, ::ArrayW<uint8_t,::Array<uint8_t>*>  encoding, int32_t  macKeySize) ;

/// @brief Method get_MacKeySize, addr 0x2373174, size 0x8, virtual false, abstract: false, final false
