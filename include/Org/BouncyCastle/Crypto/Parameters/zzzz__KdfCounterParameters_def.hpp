...
/// @brief Method .ctor, addr 0x2373204, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23731f4, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  ki, ::ArrayW<uint8_t,::Array<uint8_t>*>  fixedInputDataCounterSuffix, int32_t  r) ;

/// @brief Method get_FixedInputData, addr 0x237339c, size 0x5c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_FixedInputData() ;

/// @brief Method get_FixedInputDataCounterPrefix, addr 0x23733f8, size 0x5c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_FixedInputDataCounterPrefix() ;

/// @brief Method get_FixedInputDataCounterSuffix, addr 0x2373454, size 0x5c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_FixedInputDataCounterSuffix() ;

/// @brief Method get_Ki, addr 0x2373394, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Ki() ;

/// @brief Method get_R, addr 0x23734b0, size 0x8, virtual false, abstract: false, final false
