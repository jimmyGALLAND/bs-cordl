...
/// @brief Method GetID, addr 0x23743b4, size 0x8, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Crypto::Parameters::ParametersWithID* New_ctor(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters, ::ArrayW<uint8_t,::Array<uint8_t>*>  id, int32_t  idOff, int32_t  idLen) ;
...
/// @brief Method .ctor, addr 0x2374300, size 0x1c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters, ::ArrayW<uint8_t,::Array<uint8_t>*>  id) ;

/// @brief Method .ctor, addr 0x237431c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method get_Parameters, addr 0x23743bc, size 0x8, virtual false, abstract: false, final false
