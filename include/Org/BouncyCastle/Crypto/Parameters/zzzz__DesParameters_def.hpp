...
/// @brief Method IsWeakKey, addr 0x236bf54, size 0x58, virtual false, abstract: false, final false
static inline bool IsWeakKey(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method IsWeakKey, addr 0x236c084, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method SetOddParity, addr 0x236c1e0, size 0x20, virtual false, abstract: false, final false
static inline uint8_t SetOddParity(uint8_t  b) ;

/// @brief Method SetOddParity, addr 0x236c200, size 0xbc, virtual false, abstract: false, final false
static inline void SetOddParity(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method SetOddParity, addr 0x236c2bc, size 0xe0, virtual false, abstract: false, final false
static inline void SetOddParity(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  off, int32_t  len) ;

/// @brief Method .ctor, addr 0x236be98, size 0xbc, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method .ctor, addr 0x236bfac, size 0xd8, virtual false, abstract: false, final false
