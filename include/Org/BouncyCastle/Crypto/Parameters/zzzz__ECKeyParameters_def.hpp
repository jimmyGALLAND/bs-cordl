...
/// @brief Method CreateKeyGenerationParameters, addr 0x236fc68, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x236fb2c, size 0xa4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x236fbd0, size 0x58, virtual false, abstract: false, final false
inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::ECKeyParameters*  other) ;

/// @brief Method GetHashCode, addr 0x236fc28, size 0x40, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method LookupParameters, addr 0x236f6f0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method VerifyAlgorithmName, addr 0x236f8f4, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x236f800, size 0xf4, virtual false, abstract: false, final false
inline void _ctor(::StringW  algorithm, bool  isPrivate, ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters*  parameters) ;

/// @brief Method .ctor, addr 0x236fa14, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x236fb14, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_Parameters, addr 0x236fb1c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* get_Parameters() ;

/// @brief Method get_PublicKeyParamSet, addr 0x236fb24, size 0x8, virtual false, abstract: false, final false
