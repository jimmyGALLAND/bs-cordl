...
/// @brief Field mEphemeralPrivateKey, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_mEphemeralPrivateKey, put=__cordl_internal_set_mEphemeralPrivateKey)) ::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters*  mEphemeralPrivateKey;
...
/// @brief Method .ctor, addr 0x23768d0, size 0x268, virtual false, abstract: false, final false
...
/// @brief Method get_EphemeralPrivateKey, addr 0x2376b50, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters* get_EphemeralPrivateKey() ;

/// @brief Method get_EphemeralPublicPoint, addr 0x2376b58, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_EphemeralPublicPoint() ;

/// @brief Method get_IsInitiator, addr 0x2376b38, size 0x8, virtual true, abstract: false, final false
inline bool get_IsInitiator() ;

/// @brief Method get_StaticPrivateKey, addr 0x2376b40, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters* get_StaticPrivateKey() ;

/// @brief Method get_StaticPublicPoint, addr 0x2376b48, size 0x8, virtual true, abstract: false, final false
