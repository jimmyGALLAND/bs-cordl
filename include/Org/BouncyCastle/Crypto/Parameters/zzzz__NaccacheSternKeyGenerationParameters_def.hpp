...
static inline ::Org::BouncyCastle::Crypto::Parameters::NaccacheSternKeyGenerationParameters* New_ctor(::Org::BouncyCastle::Security::SecureRandom*  random, int32_t  strength, int32_t  certainty, int32_t  countSmallPrimes) ;

static inline ::Org::BouncyCastle::Crypto::Parameters::NaccacheSternKeyGenerationParameters* New_ctor(::Org::BouncyCastle::Security::SecureRandom*  random, int32_t  strength, int32_t  certainty, int32_t  countSmallPrimes, bool  debug) ;
...
/// @brief Method .ctor, addr 0x23740c0, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2374174, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_Certainty, addr 0x2374178, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Certainty() ;

/// @brief Method get_CountSmallPrimes, addr 0x2374180, size 0x8, virtual false, abstract: false, final false
inline int32_t get_CountSmallPrimes() ;

/// @brief Method get_IsDebug, addr 0x2374188, size 0x8, virtual false, abstract: false, final false
