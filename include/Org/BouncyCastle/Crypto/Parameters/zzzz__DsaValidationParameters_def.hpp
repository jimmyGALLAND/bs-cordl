...
/// @brief Method Equals, addr 0x236eac4, size 0xa4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x236eb68, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DsaValidationParameters*  other) ;

/// @brief Method GetHashCode, addr 0x236ebf8, size 0x88, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetSeed, addr 0x236ea3c, size 0x78, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x236e930, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  seed, int32_t  counter) ;

/// @brief Method .ctor, addr 0x236e938, size 0x104, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  seed, int32_t  counter, int32_t  usageIndex) ;

/// @brief Method get_Counter, addr 0x236eab4, size 0x8, virtual true, abstract: false, final false
inline int32_t get_Counter() ;

/// @brief Method get_UsageIndex, addr 0x236eabc, size 0x8, virtual true, abstract: false, final false
