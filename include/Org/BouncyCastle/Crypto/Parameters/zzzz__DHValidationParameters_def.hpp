...
/// @brief Method Equals, addr 0x236dd90, size 0x9c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x236de2c, size 0x90, virtual false, abstract: false, final false
inline bool Equals(::Org::BouncyCastle::Crypto::Parameters::DHValidationParameters*  other) ;

/// @brief Method GetHashCode, addr 0x236debc, size 0x88, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetSeed, addr 0x236dd10, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x236dc18, size 0xf8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  seed, int32_t  counter) ;

/// @brief Method get_Counter, addr 0x236dd88, size 0x8, virtual false, abstract: false, final false
