...
/// @brief Method Org.BouncyCastle.Crypto.Operators.WrapperProvider.CreateWrapper, addr 0x2365edc, size 0x74, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x23657d4, size 0x28, virtual false, abstract: false, final false
