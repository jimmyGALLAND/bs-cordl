...
/// @brief Method CreateCalculator, addr 0x23695f8, size 0xe0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x23695c4, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2369480, size 0x144, virtual false, abstract: false, final false
inline void _ctor(::StringW  algorithm, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  publicKey) ;

/// @brief Method get_AlgorithmDetails, addr 0x23695f0, size 0x8, virtual true, abstract: false, final true
