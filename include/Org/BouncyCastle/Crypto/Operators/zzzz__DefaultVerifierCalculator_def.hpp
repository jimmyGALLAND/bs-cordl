...
/// @brief Method GetResult, addr 0x236a574, size 0x80, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x23696d8, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::ISigner*  signer) ;

/// @brief Method get_Stream, addr 0x236a56c, size 0x8, virtual true, abstract: false, final true
