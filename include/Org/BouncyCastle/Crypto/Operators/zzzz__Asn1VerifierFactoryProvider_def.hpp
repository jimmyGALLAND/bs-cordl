...
/// @brief Method CreateVerifierFactory, addr 0x2369774, size 0xbc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x236974c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  publicKey) ;

/// @brief Method get_SignatureAlgNames, addr 0x2369830, size 0x4c, virtual false, abstract: false, final false
