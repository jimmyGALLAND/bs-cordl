...
/// @brief Method Unwrap, addr 0x2365cdc, size 0x100, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Crypto::IBlockResult* Unwrap(::ArrayW<uint8_t,::Array<uint8_t>*>  cipherText, int32_t  offset, int32_t  length) ;

/// @brief Method Wrap, addr 0x2365ddc, size 0x100, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2365a34, size 0x2a0, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmDetails, addr 0x2365cd4, size 0x8, virtual true, abstract: false, final true
