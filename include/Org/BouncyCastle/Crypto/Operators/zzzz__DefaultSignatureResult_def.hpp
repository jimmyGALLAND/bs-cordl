...
/// @brief Method Collect, addr 0x236a488, size 0xa4, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Collect() ;

/// @brief Method Collect, addr 0x236a52c, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x236a460, size 0x28, virtual false, abstract: false, final false
