...
/// @brief Method CreatePssParams, addr 0x2368440, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method GetAlgNames, addr 0x23690a8, size 0x108, virtual false, abstract: false, final false
static inline ::System::Collections::IEnumerable* GetAlgNames() ;

/// @brief Method GetAlgorithmOid, addr 0x2368b70, size 0x208, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetAlgorithmOid(::StringW  algorithmName) ;

/// @brief Method GetDigestAlgName, addr 0x2368560, size 0x370, virtual false, abstract: false, final false
static inline ::StringW GetDigestAlgName(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  digestAlgOID) ;

/// @brief Method GetSigAlgID, addr 0x2368d78, size 0x330, virtual false, abstract: false, final false
...
/// @brief Method GetSignatureName, addr 0x23688d0, size 0x2a0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23691b0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
