...
/// @brief Method GenerateEncryptionAlgID, addr 0x23f8330, size 0x538, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23f8988, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
