...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Utilities::CipherFactory::*)()>(&::Org::BouncyCastle::Crypto::Utilities::CipherFactory::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x23f8990;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Object* (*)(bool, ::Org::BouncyCastle::Crypto::ICipherParameters*, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*)>(&::Org::BouncyCastle::Crypto::Utilities::CipherFactory::CreateContentCipher)> {
  constexpr static std::size_t size = 0x74c;
  constexpr static std::size_t addrs = 0x23f8998;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Crypto::BufferedBlockCipher* (*)(::Org::BouncyCastle::Asn1::DerObjectIdentifier*)>(&::Org::BouncyCastle::Crypto::Utilities::CipherFactory::CreateCipher)> {
  constexpr static std::size_t size = 0x38c;
  constexpr static std::size_t addrs = 0x23f90e4;
...
::cordl_internals::setStaticField<::ArrayW<int16_t,::Array<int16_t>*>, "rc2Ekb", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Utilities::CipherFactory*>::get>(std::forward<::ArrayW<int16_t,::Array<int16_t>*>>(value));
}
inline ::ArrayW<int16_t,::Array<int16_t>*> Org::BouncyCastle::Crypto::Utilities::CipherFactory::getStaticF_rc2Ekb()  {
return ::cordl_internals::getStaticField<::ArrayW<int16_t,::Array<int16_t>*>, "rc2Ekb", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Utilities::CipherFactory*>::get>();
}
...
inline ::System::Object* Org::BouncyCastle::Crypto::Utilities::CipherFactory::CreateContentCipher(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  encKey, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  encryptionAlgID)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Utilities::CipherFactory*>::get(),
                        "CreateContentCipher",
                        std::span<const Il2CppClass* const, 0>(),
