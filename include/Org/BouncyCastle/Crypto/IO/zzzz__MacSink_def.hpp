...
/// @brief Method Write, addr 0x2346068, size 0xdc, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method WriteByte, addr 0x2345fbc, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2345f8c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IMac*  mac) ;

/// @brief Method get_Mac, addr 0x2345fb4, size 0x8, virtual true, abstract: false, final false
