...
/// @brief Method BlockUpdate, addr 0x2349d64, size 0x110, virtual true, abstract: false, final true
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  len) ;

/// @brief Method DoFinal, addr 0x2349eac, size 0x124, virtual true, abstract: false, final true
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GetMacSize, addr 0x2349d5c, size 0x8, virtual true, abstract: false, final true
inline int32_t GetMacSize() ;

/// @brief Method Init, addr 0x2349a34, size 0x178, virtual true, abstract: false, final true
inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Macs::Dstu7564Mac* New_ctor(int32_t  macSizeBits) ;

/// @brief Method Pad, addr 0x2349fd0, size 0x118, virtual false, abstract: false, final false
inline void Pad() ;

/// @brief Method PadKey, addr 0x2349bac, size 0x1b0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> PadKey(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method Reset, addr 0x234a0e8, size 0x5c, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method Update, addr 0x2349e74, size 0x38, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x23499ac, size 0x88, virtual false, abstract: false, final false
inline void _ctor(int32_t  macSizeBits) ;

/// @brief Method get_AlgorithmName, addr 0x234996c, size 0x40, virtual true, abstract: false, final true
