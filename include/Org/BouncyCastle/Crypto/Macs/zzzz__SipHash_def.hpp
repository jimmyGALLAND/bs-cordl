...
/// @brief Method ApplySipRounds, addr 0x234eaa4, size 0x4c, virtual true, abstract: false, final false
inline void ApplySipRounds(int32_t  n) ;

/// @brief Method BlockUpdate, addr 0x234e768, size 0x1ac, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  offset, int32_t  length) ;

/// @brief Method DoFinal, addr 0x234e9b0, size 0x44, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method DoFinal, addr 0x234e914, size 0x9c, virtual true, abstract: false, final false
inline int64_t DoFinal() ;

/// @brief Method GetMacSize, addr 0x234e5d0, size 0x8, virtual true, abstract: false, final false
inline int32_t GetMacSize() ;

/// @brief Method Init, addr 0x234e5d8, size 0x14c, virtual true, abstract: false, final false
...
/// @brief Method ProcessMessageWord, addr 0x234ea58, size 0x4c, virtual true, abstract: false, final false
inline void ProcessMessageWord() ;

/// @brief Method Reset, addr 0x234e9f4, size 0x64, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method RotateLeft, addr 0x234eaf0, size 0xc, virtual false, abstract: false, final false
static inline int64_t RotateLeft(int64_t  x, int32_t  n) ;

/// @brief Method Update, addr 0x234e724, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x234e3e4, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x234e40c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  c, int32_t  d) ;

/// @brief Method get_AlgorithmName, addr 0x234e43c, size 0x194, virtual true, abstract: false, final false
