...
/// @brief Method GetBlockSize, addr 0x2347fd8, size 0x8, virtual true, abstract: false, final true
inline int32_t GetBlockSize() ;

/// @brief Method GetMacBlock, addr 0x2348230, size 0xbc, virtual false, abstract: false, final false
inline void GetMacBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  mac) ;

/// @brief Method Init, addr 0x2347cd4, size 0x13c, virtual true, abstract: false, final true
...
/// @brief Method ProcessBlock, addr 0x2347fe0, size 0x250, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x2347e10, size 0xbc, virtual true, abstract: false, final true
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x2347af4, size 0x1e0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  cipher, int32_t  bitBlockSize) ;

/// @brief Method get_AlgorithmName, addr 0x2347ecc, size 0x104, virtual true, abstract: false, final true
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x2347fd0, size 0x8, virtual true, abstract: false, final true
