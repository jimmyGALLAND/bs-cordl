...
/// @brief Method BlockUpdate, addr 0x23494bc, size 0x290, virtual true, abstract: false, final true
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  inBytes, int32_t  inOff, int32_t  len) ;

/// @brief Method DoFinal, addr 0x234974c, size 0x220, virtual true, abstract: false, final true
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff) ;

/// @brief Method DoubleLu, addr 0x234900c, size 0xb4, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> DoubleLu(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method GetMacSize, addr 0x234939c, size 0x8, virtual true, abstract: false, final true
inline int32_t GetMacSize() ;

/// @brief Method Init, addr 0x23490c0, size 0x21c, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x23492dc, size 0xc0, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method ShiftLeft, addr 0x2348f94, size 0x78, virtual false, abstract: false, final false
static inline int32_t ShiftLeft(::ArrayW<uint8_t,::Array<uint8_t>*>  block, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method Update, addr 0x23493a4, size 0x118, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2348a00, size 0xb4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  cipher) ;

/// @brief Method .ctor, addr 0x2348ab4, size 0x440, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  cipher, int32_t  macSizeInBits) ;

/// @brief Method get_AlgorithmName, addr 0x2348ef4, size 0xa0, virtual true, abstract: false, final true
