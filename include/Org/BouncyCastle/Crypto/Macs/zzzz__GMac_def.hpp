...
/// @brief Method BlockUpdate, addr 0x234ab28, size 0x24, virtual true, abstract: false, final true
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  len) ;

/// @brief Method DoFinal, addr 0x234ab4c, size 0xf0, virtual true, abstract: false, final true
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GetMacSize, addr 0x234aaec, size 0x18, virtual true, abstract: false, final true
inline int32_t GetMacSize() ;

/// @brief Method Init, addr 0x234a8a4, size 0x180, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x234ac3c, size 0x24, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method Update, addr 0x234ab04, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x234a844, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher*  cipher) ;

/// @brief Method .ctor, addr 0x234a874, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Modes::GcmBlockCipher*  cipher, int32_t  macSizeBits) ;

/// @brief Method get_AlgorithmName, addr 0x234aa24, size 0xc8, virtual true, abstract: false, final true
