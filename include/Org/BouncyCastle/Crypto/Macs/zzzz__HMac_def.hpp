...
/// @brief Method BlockUpdate, addr 0x234c13c, size 0xc4, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  len) ;

/// @brief Method DoFinal, addr 0x234c200, size 0x4a8, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GetMacSize, addr 0x234c088, size 0x8, virtual true, abstract: false, final false
inline int32_t GetMacSize() ;

/// @brief Method GetUnderlyingDigest, addr 0x234bb08, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IDigest* GetUnderlyingDigest() ;

/// @brief Method Init, addr 0x234bb10, size 0x528, virtual true, abstract: false, final false
inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Macs::HMac* New_ctor(::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method Reset, addr 0x234c6a8, size 0x120, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Update, addr 0x234c090, size 0xac, virtual true, abstract: false, final false
inline void Update(uint8_t  input) ;

/// @brief Method XorPad, addr 0x234c038, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x234b8ec, size 0x15c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method get_AlgorithmName, addr 0x234ba48, size 0xc0, virtual true, abstract: false, final false
