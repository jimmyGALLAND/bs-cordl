...
/// @brief Method DecodeBlock, addr 0x22f41a4, size 0x448, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> DecodeBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  inBytes, int32_t  inOff, int32_t  inLen) ;

/// @brief Method EncodeBlock, addr 0x22f3e80, size 0x324, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncodeBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  inBytes, int32_t  inOff, int32_t  inLen) ;

/// @brief Method GetInputBlockSize, addr 0x22f3ce0, size 0xc8, virtual true, abstract: false, final true
inline int32_t GetInputBlockSize() ;

/// @brief Method GetOutputBlockSize, addr 0x22f3da8, size 0xc8, virtual true, abstract: false, final true
inline int32_t GetOutputBlockSize() ;

/// @brief Method GetUnderlyingCipher, addr 0x22f3ad4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* GetUnderlyingCipher() ;

/// @brief Method Init, addr 0x22f3b9c, size 0x144, virtual true, abstract: false, final true
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  param) ;

/// @brief Method ItoOSP, addr 0x22f4ac4, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method ProcessBlock, addr 0x22f3e70, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x22f381c, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher*  cipher) ;

/// @brief Method .ctor, addr 0x22f389c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher*  cipher, ::Org::BouncyCastle::Crypto::IDigest*  hash) ;

/// @brief Method .ctor, addr 0x22f3890, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22f38a8, size 0x22c, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x22f3adc, size 0xc0, virtual true, abstract: false, final true
...
/// @brief Method maskGeneratorFunction1, addr 0x22f45ec, size 0x4d8, virtual false, abstract: false, final false
