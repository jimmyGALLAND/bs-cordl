...
/// @brief Method DecodeBlock, addr 0x22f3228, size 0x4d0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> DecodeBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  inLen) ;

/// @brief Method EncodeBlock, addr 0x22f2ee4, size 0x344, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncodeBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  inLen) ;

/// @brief Method GetInputBlockSize, addr 0x22f2ce4, size 0xc4, virtual true, abstract: false, final true
inline int32_t GetInputBlockSize() ;

/// @brief Method GetOutputBlockSize, addr 0x22f2da8, size 0xc4, virtual true, abstract: false, final true
inline int32_t GetOutputBlockSize() ;

/// @brief Method GetPadBits, addr 0x22f2ecc, size 0x8, virtual false, abstract: false, final false
inline int32_t GetPadBits() ;

/// @brief Method GetUnderlyingCipher, addr 0x22f2b30, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher* GetUnderlyingCipher() ;

/// @brief Method Init, addr 0x22f2b38, size 0x1ac, virtual true, abstract: false, final true
...
/// @brief Method ProcessBlock, addr 0x22f2ed4, size 0x10, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method SetPadBits, addr 0x22f2e6c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22f2a44, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x22f2a70, size 0xc0, virtual true, abstract: false, final true
