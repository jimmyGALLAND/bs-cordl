...
/// @brief Method AddPadding, addr 0x236bbc0, size 0x48, virtual true, abstract: false, final true
inline int32_t AddPadding(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff) ;

/// @brief Method Init, addr 0x236bbbc, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method PadCount, addr 0x236bc08, size 0x5c, virtual true, abstract: false, final true
inline int32_t PadCount(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method .ctor, addr 0x236bc64, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_PaddingName, addr 0x236bb7c, size 0x40, virtual true, abstract: false, final true
