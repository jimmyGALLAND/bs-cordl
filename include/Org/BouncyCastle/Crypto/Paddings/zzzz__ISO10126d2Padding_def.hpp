...
/// @brief Method AddPadding, addr 0x236a890, size 0xb0, virtual true, abstract: false, final true
inline int32_t AddPadding(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff) ;

/// @brief Method Init, addr 0x236a7e0, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method PadCount, addr 0x236a940, size 0x7c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x236a9bc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_PaddingName, addr 0x236a850, size 0x40, virtual true, abstract: false, final true
