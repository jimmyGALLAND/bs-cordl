...
/// @brief Method AddPadding, addr 0x236aa08, size 0x64, virtual true, abstract: false, final true
inline int32_t AddPadding(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff) ;

/// @brief Method Init, addr 0x236a9c4, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method PadCount, addr 0x236aa6c, size 0xb4, virtual true, abstract: false, final true
inline int32_t PadCount(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method .ctor, addr 0x236ab20, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_PaddingName, addr 0x236a9c8, size 0x40, virtual true, abstract: false, final true
