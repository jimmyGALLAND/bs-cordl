...
/// @brief Method AddPadding, addr 0x236b7a4, size 0x4c, virtual true, abstract: false, final true
inline int32_t AddPadding(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff) ;

/// @brief Method Init, addr 0x236b760, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method PadCount, addr 0x236b7f0, size 0xc0, virtual true, abstract: false, final true
inline int32_t PadCount(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method .ctor, addr 0x236ac84, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_PaddingName, addr 0x236b764, size 0x40, virtual true, abstract: false, final true
