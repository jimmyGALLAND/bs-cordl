...
public:
// Declarations
/// @brief Method GenerateSeed, addr 0x237d9b4, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x237db10, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
