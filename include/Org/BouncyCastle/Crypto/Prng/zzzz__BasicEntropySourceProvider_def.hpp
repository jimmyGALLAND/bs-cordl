...
static inline ::Org::BouncyCastle::Crypto::Prng::__BasicEntropySourceProvider__BasicEntropySource* New_ctor(::Org::BouncyCastle::Security::SecureRandom*  secureRandom, bool  predictionResistant, int32_t  entropySize) ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.GetEntropy, addr 0x237cd54, size 0x70, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Org_BouncyCastle_Crypto_IEntropySource_GetEntropy() ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_EntropySize, addr 0x237ce40, size 0x8, virtual true, abstract: false, final true
inline int32_t Org_BouncyCastle_Crypto_IEntropySource_get_EntropySize() ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_IsPredictionResistant, addr 0x237cd4c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x237cd0c, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Get, addr 0x237cc94, size 0x78, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x237cc64, size 0x30, virtual false, abstract: false, final false
