...
/// @brief Method Generate, addr 0x2380720, size 0x490, virtual false, abstract: false, final false
inline int32_t Generate(::ArrayW<uint8_t,::Array<uint8_t>*>  output, bool  predictionResistant) ;

/// @brief Method Increment, addr 0x2380cf8, size 0x44, virtual false, abstract: false, final false
inline void Increment(::ArrayW<uint8_t,::Array<uint8_t>*>  val) ;

/// @brief Method IsTooLarge, addr 0x2380bb0, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Process, addr 0x2380bc4, size 0x134, virtual false, abstract: false, final false
inline void Process(::ArrayW<uint8_t,::Array<uint8_t>*>  res, ::ArrayW<uint8_t,::Array<uint8_t>*>  a, ::ArrayW<uint8_t,::Array<uint8_t>*>  b) ;

/// @brief Method Reseed, addr 0x2380d3c, size 0x188, virtual false, abstract: false, final false
inline void Reseed() ;
...
/// @brief Method .ctor, addr 0x2380528, size 0x1f8, virtual false, abstract: false, final false
...
/// @brief Method get_EntropySource, addr 0x2380ec4, size 0x8, virtual false, abstract: false, final false
