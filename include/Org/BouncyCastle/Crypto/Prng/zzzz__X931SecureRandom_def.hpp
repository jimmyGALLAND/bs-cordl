...
/// @brief Method GenerateSeed, addr 0x2381240, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method NextBytes, addr 0x23811a8, size 0x98, virtual true, abstract: false, final false
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method NextBytes, addr 0x23810b8, size 0xf0, virtual true, abstract: false, final false
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method SetSeed, addr 0x2380f50, size 0xb4, virtual true, abstract: false, final false
inline void SetSeed(::ArrayW<uint8_t,::Array<uint8_t>*>  seed) ;

/// @brief Method SetSeed, addr 0x2381004, size 0xb4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2380ecc, size 0x84, virtual false, abstract: false, final false
