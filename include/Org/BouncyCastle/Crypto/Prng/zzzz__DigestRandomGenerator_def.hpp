...
/// @brief Method AddSeedMaterial, addr 0x237d390, size 0xc8, virtual true, abstract: false, final true
inline void AddSeedMaterial(::ArrayW<uint8_t,::Array<uint8_t>*>  inSeed) ;

/// @brief Method AddSeedMaterial, addr 0x237d5c4, size 0xc8, virtual true, abstract: false, final true
inline void AddSeedMaterial(int64_t  rSeed) ;

/// @brief Method CycleSeed, addr 0x237d980, size 0x34, virtual false, abstract: false, final false
inline void CycleSeed() ;

/// @brief Method DigestAddCounter, addr 0x237d68c, size 0xf8, virtual false, abstract: false, final false
inline void DigestAddCounter(int64_t  seedVal) ;

/// @brief Method DigestDoFinal, addr 0x237d514, size 0xb0, virtual false, abstract: false, final false
inline void DigestDoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  result) ;

/// @brief Method DigestUpdate, addr 0x237d458, size 0xbc, virtual false, abstract: false, final false
inline void DigestUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  inSeed) ;

/// @brief Method GenerateState, addr 0x237d908, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method NextBytes, addr 0x237d784, size 0x1c, virtual true, abstract: false, final true
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method NextBytes, addr 0x237d7a0, size 0x168, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x237d228, size 0x168, virtual false, abstract: false, final false
