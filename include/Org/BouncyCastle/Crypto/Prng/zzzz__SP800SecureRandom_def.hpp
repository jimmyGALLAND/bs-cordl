...
/// @brief Method GenerateSeed, addr 0x237f3cc, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method NextBytes, addr 0x237f334, size 0x98, virtual true, abstract: false, final false
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method NextBytes, addr 0x237f054, size 0x2e0, virtual true, abstract: false, final false
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method Reseed, addr 0x237f3d4, size 0x1d4, virtual true, abstract: false, final false
inline void Reseed(::ArrayW<uint8_t,::Array<uint8_t>*>  additionalInput) ;

/// @brief Method SetSeed, addr 0x237eeec, size 0xb4, virtual true, abstract: false, final false
inline void SetSeed(::ArrayW<uint8_t,::Array<uint8_t>*>  seed) ;

/// @brief Method SetSeed, addr 0x237efa0, size 0xb4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x237ee60, size 0x8c, virtual false, abstract: false, final false
