...
/// @brief Method Generate, addr 0x237c678, size 0x508, virtual true, abstract: false, final true
...
/// @brief Method GetEntropy, addr 0x237c0d8, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method Reseed, addr 0x237cb80, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x237bde8, size 0x2f0, virtual false, abstract: false, final false
...
/// @brief Method get_BlockSize, addr 0x237c658, size 0x20, virtual true, abstract: false, final true
inline int32_t get_BlockSize() ;

/// @brief Method hmac_DRBG_Update, addr 0x237c1ec, size 0x40, virtual false, abstract: false, final false
inline void hmac_DRBG_Update(::ArrayW<uint8_t,::Array<uint8_t>*>  seedMaterial) ;

/// @brief Method hmac_DRBG_Update_Func, addr 0x237c22c, size 0x42c, virtual false, abstract: false, final false
