...
/// @brief Method AddOneTo, addr 0x2378d78, size 0x48, virtual false, abstract: false, final false
inline void AddOneTo(::ArrayW<uint8_t,::Array<uint8_t>*>  longer) ;

/// @brief Method BCC, addr 0x2378f78, size 0x308, virtual false, abstract: false, final false
...
/// @brief Method Block_Cipher_df, addr 0x23784bc, size 0x4d4, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Block_Cipher_df(::ArrayW<uint8_t,::Array<uint8_t>*>  inputString, int32_t  bitLength) ;

/// @brief Method CTR_DRBG_Instantiate_algorithm, addr 0x23782fc, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method CTR_DRBG_Reseed_algorithm, addr 0x2378e54, size 0xa4, virtual false, abstract: false, final false
inline void CTR_DRBG_Reseed_algorithm(::ArrayW<uint8_t,::Array<uint8_t>*>  additionalInput) ;

/// @brief Method CTR_DRBG_Update, addr 0x2378990, size 0x344, virtual false, abstract: false, final false
...
/// @brief Method ExpandKey, addr 0x2378cd4, size 0xa4, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ExpandKey(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method Generate, addr 0x23792a0, size 0x4ac, virtual true, abstract: false, final true
...
/// @brief Method GetEntropy, addr 0x23781e8, size 0x114, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEntropy() ;

/// @brief Method GetMaxSecurityStrength, addr 0x2377fac, size 0xec, virtual false, abstract: false, final false
inline int32_t GetMaxSecurityStrength(::Org::BouncyCastle::Crypto::IBlockCipher*  cipher, int32_t  keySizeInBits) ;

/// @brief Method IsTdea, addr 0x2378098, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method PadKey, addr 0x2379764, size 0x290, virtual false, abstract: false, final false
inline void PadKey(::ArrayW<uint8_t,::Array<uint8_t>*>  keyMaster, int32_t  keyOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  tmp, int32_t  tmpOff) ;

/// @brief Method Reseed, addr 0x2379760, size 0x4, virtual true, abstract: false, final true
inline void Reseed(::ArrayW<uint8_t,::Array<uint8_t>*>  additionalInput) ;

/// @brief Method XOR, addr 0x2378dc0, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2377d64, size 0x248, virtual false, abstract: false, final false
...
/// @brief Method copyIntToByteArray, addr 0x2378ef8, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_BlockSize, addr 0x2379280, size 0x20, virtual true, abstract: false, final true
