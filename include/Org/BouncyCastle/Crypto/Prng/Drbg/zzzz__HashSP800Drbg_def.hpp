...
/// @brief Method AddTo, addr 0x237b9a4, size 0xc8, virtual false, abstract: false, final false
inline void AddTo(::ArrayW<uint8_t,::Array<uint8_t>*>  longer, ::ArrayW<uint8_t,::Array<uint8_t>*>  shorter) ;

/// @brief Method DoHash, addr 0x237bcac, size 0x13c, virtual false, abstract: false, final false
inline void DoHash(::ArrayW<uint8_t,::Array<uint8_t>*>  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method Generate, addr 0x237b390, size 0x358, virtual true, abstract: false, final true
...
/// @brief Method GetEntropy, addr 0x237b1d0, size 0x114, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEntropy() ;

/// @brief Method Hash, addr 0x237b8b4, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method Reseed, addr 0x237b6e8, size 0x1cc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x237adc4, size 0x40c, virtual false, abstract: false, final false
...
/// @brief Method get_BlockSize, addr 0x237b2e4, size 0xac, virtual true, abstract: false, final true
inline int32_t get_BlockSize() ;

/// @brief Method hashgen, addr 0x237ba6c, size 0x240, virtual false, abstract: false, final false
