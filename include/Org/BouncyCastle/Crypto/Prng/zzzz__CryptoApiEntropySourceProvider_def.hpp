...
static inline ::Org::BouncyCastle::Crypto::Prng::__CryptoApiEntropySourceProvider__CryptoApiEntropySource* New_ctor(::System::Security::Cryptography::RandomNumberGenerator*  rng, bool  predictionResistant, int32_t  entropySize) ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.GetEntropy, addr 0x237cfac, size 0x88, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Org_BouncyCastle_Crypto_IEntropySource_GetEntropy() ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_EntropySize, addr 0x237d034, size 0x8, virtual true, abstract: false, final true
inline int32_t Org_BouncyCastle_Crypto_IEntropySource_get_EntropySize() ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_IsPredictionResistant, addr 0x237cfa4, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x237cf64, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Get, addr 0x237ceec, size 0x78, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x237ce48, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x237ce6c, size 0x80, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Crypto::Prng::__CryptoApiEntropySourceProvider__CryptoApiEntropySource*, "Org.BouncyCastle.Crypto.Prng", "CryptoApiEntropySourceProvider/CryptoApiEntropySource");
