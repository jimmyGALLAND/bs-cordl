...
/// @brief Method Get, addr 0x237fbcc, size 0x88, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Crypto::Prng::Drbg::ISP80090Drbg* Get(::Org::BouncyCastle::Crypto::IEntropySource*  entropySource) ;

static inline ::Org::BouncyCastle::Crypto::Prng::__SP800SecureRandomBuilder__HashDrbgProvider* New_ctor(::Org::BouncyCastle::Crypto::IDigest*  digest, ::ArrayW<uint8_t,::Array<uint8_t>*>  nonce, ::ArrayW<uint8_t,::Array<uint8_t>*>  personalizationString, int32_t  securityStrength) ;
...
/// @brief Method .ctor, addr 0x237f838, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method Get, addr 0x237fc54, size 0x88, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Crypto::Prng::Drbg::ISP80090Drbg* Get(::Org::BouncyCastle::Crypto::IEntropySource*  entropySource) ;

static inline ::Org::BouncyCastle::Crypto::Prng::__SP800SecureRandomBuilder__HMacDrbgProvider* New_ctor(::Org::BouncyCastle::Crypto::IMac*  hMac, ::ArrayW<uint8_t,::Array<uint8_t>*>  nonce, ::ArrayW<uint8_t,::Array<uint8_t>*>  personalizationString, int32_t  securityStrength) ;
...
/// @brief Method .ctor, addr 0x237fb88, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method Get, addr 0x237fcdc, size 0x90, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Crypto::Prng::Drbg::ISP80090Drbg* Get(::Org::BouncyCastle::Crypto::IEntropySource*  entropySource) ;

static inline ::Org::BouncyCastle::Crypto::Prng::__SP800SecureRandomBuilder__CtrDrbgProvider* New_ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  blockCipher, int32_t  keySizeInBits, ::ArrayW<uint8_t,::Array<uint8_t>*>  nonce, ::ArrayW<uint8_t,::Array<uint8_t>*>  personalizationString, int32_t  securityStrength) ;
...
/// @brief Method .ctor, addr 0x237f9dc, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method BuildCtr, addr 0x237f87c, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method BuildHMac, addr 0x237fa30, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method BuildHash, addr 0x237f6e0, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method SetEntropyBitsRequired, addr 0x237f6d8, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Prng::SP800SecureRandomBuilder* SetEntropyBitsRequired(int32_t  entropyBitsRequired) ;

/// @brief Method SetPersonalizationString, addr 0x237f6c8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method SetSecurityStrength, addr 0x237f6d0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x237f5a8, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x237f604, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Security::SecureRandom*  entropySource, bool  predictionResistant) ;

/// @brief Method .ctor, addr 0x237f694, size 0x34, virtual false, abstract: false, final false
