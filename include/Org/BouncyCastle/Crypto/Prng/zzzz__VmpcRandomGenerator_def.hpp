...
/// @brief Method AddSeedMaterial, addr 0x23801f8, size 0xd0, virtual true, abstract: false, final false
inline void AddSeedMaterial(::ArrayW<uint8_t,::Array<uint8_t>*>  seed) ;

/// @brief Method AddSeedMaterial, addr 0x23802c8, size 0x2c, virtual true, abstract: false, final false
inline void AddSeedMaterial(int64_t  seed) ;

static inline ::Org::BouncyCastle::Crypto::Prng::VmpcRandomGenerator* New_ctor() ;

/// @brief Method NextBytes, addr 0x23802f4, size 0x24, virtual true, abstract: false, final false
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method NextBytes, addr 0x2380318, size 0x210, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2380168, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
