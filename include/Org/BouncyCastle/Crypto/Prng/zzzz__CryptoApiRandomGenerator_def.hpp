...
/// @brief Method AddSeedMaterial, addr 0x237d098, size 0x4, virtual true, abstract: false, final false
inline void AddSeedMaterial(::ArrayW<uint8_t,::Array<uint8_t>*>  seed) ;

/// @brief Method AddSeedMaterial, addr 0x237d09c, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method NextBytes, addr 0x237d0a0, size 0x20, virtual true, abstract: false, final false
inline void NextBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method NextBytes, addr 0x237d0c0, size 0x168, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x237d03c, size 0x34, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x237d070, size 0x28, virtual false, abstract: false, final false
