...
/// @brief Method BlockUpdate, addr 0x2390ed8, size 0xc4, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method DerEncode, addr 0x23911c8, size 0x88, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> DerEncode(::ArrayW<uint8_t,::Array<uint8_t>*>  hash) ;

/// @brief Method GenerateSignature, addr 0x2390f9c, size 0x22c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSignature() ;

/// @brief Method Init, addr 0x2390c0c, size 0x220, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x2391688, size 0xa4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Update, addr 0x2390e2c, size 0xac, virtual true, abstract: false, final false
inline void Update(uint8_t  input) ;

/// @brief Method VerifySignature, addr 0x2391250, size 0x438, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23906c0, size 0x1ac, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method .ctor, addr 0x2390914, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IDigest*  digest, ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  algId) ;

/// @brief Method .ctor, addr 0x239086c, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IDigest*  digest, ::Org::BouncyCastle::Asn1::DerObjectIdentifier*  digestOid) ;

/// @brief Method .ctor, addr 0x2390988, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2390a0c, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2390ac4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x2390b4c, size 0xc0, virtual true, abstract: false, final false
