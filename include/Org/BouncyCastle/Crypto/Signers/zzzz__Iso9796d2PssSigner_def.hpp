...
/// @brief Method BlockUpdate, addr 0x238b0b0, size 0x144, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method ClearBlock, addr 0x238a6c0, size 0x24, virtual false, abstract: false, final false
inline void ClearBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  block) ;

/// @brief Method GenerateSignature, addr 0x238b2d8, size 0x6c8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSignature() ;

/// @brief Method GetRecoveredMessage, addr 0x2389d04, size 0x8, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetRecoveredMessage() ;

/// @brief Method HasFullMessage, addr 0x238c0c4, size 0x8, virtual true, abstract: false, final false
inline bool HasFullMessage() ;

/// @brief Method Init, addr 0x238a23c, size 0x404, virtual true, abstract: false, final false
inline void Init(bool  forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method IsSameAs, addr 0x238a640, size 0x80, virtual false, abstract: false, final false
inline bool IsSameAs(::ArrayW<uint8_t,::Array<uint8_t>*>  a, ::ArrayW<uint8_t,::Array<uint8_t>*>  b) ;

/// @brief Method ItoOSP, addr 0x238c0cc, size 0x54, virtual false, abstract: false, final false
inline void ItoOSP(int32_t  i, ::ArrayW<uint8_t,::Array<uint8_t>*>  sp) ;

/// @brief Method LtoOSP, addr 0x238b9a0, size 0x94, virtual false, abstract: false, final false
inline void LtoOSP(int64_t  l, ::ArrayW<uint8_t,::Array<uint8_t>*>  sp) ;

/// @brief Method MaskGeneratorFunction1, addr 0x238ab68, size 0x454, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Crypto::Signers::Iso9796d2PssSigner* New_ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher*  cipher, ::Org::BouncyCastle::Crypto::IDigest*  digest, int32_t  saltLength) ;

static inline ::Org::BouncyCastle::Crypto::Signers::Iso9796d2PssSigner* New_ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher*  cipher, ::Org::BouncyCastle::Crypto::IDigest*  digest, int32_t  saltLength, bool  isImplicit) ;

/// @brief Method Reset, addr 0x238b1f4, size 0xe4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Update, addr 0x238afbc, size 0xf4, virtual true, abstract: false, final false
inline void Update(uint8_t  input) ;

/// @brief Method UpdateWithRecoveredMessage, addr 0x238a6e4, size 0x484, virtual true, abstract: false, final false
inline void UpdateWithRecoveredMessage(::ArrayW<uint8_t,::Array<uint8_t>*>  signature) ;

/// @brief Method VerifySignature, addr 0x238ba34, size 0x690, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x238a174, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2389d0c, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x238a17c, size 0xc0, virtual true, abstract: false, final false
