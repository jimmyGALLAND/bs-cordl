...
/// @brief Method BlockUpdate, addr 0x2387908, size 0xc4, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method GenerateSignature, addr 0x23879cc, size 0x21c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSignature() ;

/// @brief Method Init, addr 0x238763c, size 0x220, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x2387f44, size 0xa4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Update, addr 0x238785c, size 0xac, virtual true, abstract: false, final false
inline void Update(uint8_t  input) ;

/// @brief Method VerifySignature, addr 0x2387be8, size 0x35c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2387438, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher*  engine, ::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method get_AlgorithmName, addr 0x2387464, size 0x1d8, virtual true, abstract: false, final false
