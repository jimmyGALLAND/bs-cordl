...
/// @brief Method AddFieldElement, addr 0x2392dfc, size 0xd4, virtual false, abstract: false, final false
inline void AddFieldElement(::Org::BouncyCastle::Crypto::IDigest*  digest, ::Org::BouncyCastle::Math::EC::ECFieldElement*  v) ;

/// @brief Method AddUserID, addr 0x2392c70, size 0x18c, virtual false, abstract: false, final false
inline void AddUserID(::Org::BouncyCastle::Crypto::IDigest*  digest, ::ArrayW<uint8_t,::Array<uint8_t>*>  userID) ;

/// @brief Method BlockUpdate, addr 0x239219c, size 0xc4, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method CalculateE, addr 0x2392ed0, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method CreateBasePointMultiplier, addr 0x2392f30, size 0x54, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateBasePointMultiplier() ;

/// @brief Method GenerateSignature, addr 0x239277c, size 0x4f4, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSignature() ;

/// @brief Method GetZ, addr 0x2391f80, size 0x170, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetZ(::ArrayW<uint8_t,::Array<uint8_t>*>  userID) ;

/// @brief Method Init, addr 0x2391950, size 0x630, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x2392648, size 0x134, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Update, addr 0x23920f0, size 0xac, virtual true, abstract: false, final false
inline void Update(uint8_t  b) ;

/// @brief Method VerifySignature, addr 0x23923e4, size 0x264, virtual false, abstract: false, final false
inline bool VerifySignature(::Org::BouncyCastle::Math::BigInteger*  r, ::Org::BouncyCastle::Math::BigInteger*  s) ;

/// @brief Method VerifySignature, addr 0x2392260, size 0x184, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x239172c, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2391834, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method .ctor, addr 0x23918a4, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Signers::IDsaEncoding*  encoding) ;

/// @brief Method .ctor, addr 0x23917bc, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Signers::IDsaEncoding*  encoding, ::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method get_AlgorithmName, addr 0x2391910, size 0x40, virtual true, abstract: false, final false
