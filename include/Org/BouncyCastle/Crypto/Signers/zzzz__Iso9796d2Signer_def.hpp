...
/// @brief Method BlockUpdate, addr 0x238cb44, size 0x138, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method ClearBlock, addr 0x238c5bc, size 0x24, virtual false, abstract: false, final false
inline void ClearBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  block) ;

/// @brief Method GenerateSignature, addr 0x238cd5c, size 0x3e0, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSignature() ;

/// @brief Method GetRecoveredMessage, addr 0x238c120, size 0x8, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetRecoveredMessage() ;

/// @brief Method HasFullMessage, addr 0x238d904, size 0x8, virtual true, abstract: false, final false
inline bool HasFullMessage() ;

/// @brief Method Init, addr 0x238c2f4, size 0x218, virtual true, abstract: false, final false
inline void Init(bool  forSigning, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method IsSameAs, addr 0x238c50c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x238cc7c, size 0xe0, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ReturnFalse, addr 0x238d8dc, size 0x28, virtual false, abstract: false, final false
inline bool ReturnFalse(::ArrayW<uint8_t,::Array<uint8_t>*>  block) ;

/// @brief Method Update, addr 0x238ca5c, size 0xe8, virtual true, abstract: false, final false
inline void Update(uint8_t  input) ;

/// @brief Method UpdateWithRecoveredMessage, addr 0x238c5e0, size 0x47c, virtual true, abstract: false, final false
inline void UpdateWithRecoveredMessage(::ArrayW<uint8_t,::Array<uint8_t>*>  signature) ;

/// @brief Method VerifySignature, addr 0x238d13c, size 0x7a0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x238c22c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IAsymmetricBlockCipher*  cipher, ::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method .ctor, addr 0x238c128, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x238c234, size 0xc0, virtual true, abstract: false, final false
