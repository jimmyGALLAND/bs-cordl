...
/// @brief Method CheckValue, addr 0x239331c, size 0x9c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* CheckValue(::Org::BouncyCastle::Math::BigInteger*  n, ::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method Decode, addr 0x2392f84, size 0x240, virtual true, abstract: false, final false
...
/// @brief Method DecodeValue, addr 0x23933b8, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method Encode, addr 0x23931c4, size 0x158, virtual true, abstract: false, final false
...
/// @brief Method EncodeValue, addr 0x2393478, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2393560, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
