...
/// @brief Method BlockUpdate, addr 0x2385984, size 0xc4, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method GenerateSignature, addr 0x2385a48, size 0x234, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSignature() ;

/// @brief Method Init, addr 0x2385760, size 0xd4, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x2385834, size 0xa4, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method Update, addr 0x23858d8, size 0xac, virtual true, abstract: false, final false
inline void Update(uint8_t  b) ;

/// @brief Method VerifySignature, addr 0x2385c7c, size 0x1a8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2385678, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  context) ;

/// @brief Method get_AlgorithmName, addr 0x2385720, size 0x40, virtual true, abstract: false, final false
