...
/// @brief Method CalculateMac, addr 0x235f7e4, size 0x288, virtual false, abstract: false, final false
inline void CalculateMac(::ArrayW<uint8_t,::Array<uint8_t>*>  authText, int32_t  authOff, int32_t  len) ;

/// @brief Method DoFinal, addr 0x235fc84, size 0x98, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GetBlockSize, addr 0x235df60, size 0xa4, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method GetMac, addr 0x235fd1c, size 0x5c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetMac() ;

/// @brief Method GetOutputSize, addr 0x235fd80, size 0xc, virtual true, abstract: false, final false
inline int32_t GetOutputSize(int32_t  len) ;

/// @brief Method GetUnderlyingCipher, addr 0x235e004, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher() ;

/// @brief Method GetUpdateOutputSize, addr 0x235fd78, size 0x8, virtual true, abstract: false, final false
inline int32_t GetUpdateOutputSize(int32_t  len) ;

/// @brief Method Init, addr 0x235daa0, size 0x400, virtual true, abstract: false, final false
...
/// @brief Method ProcessAAD, addr 0x235e054, size 0x8a4, virtual false, abstract: false, final false
inline void ProcessAAD(::ArrayW<uint8_t,::Array<uint8_t>*>  assocText, int32_t  assocOff, int32_t  assocLen, int32_t  dataLen) ;

/// @brief Method ProcessAadByte, addr 0x235e00c, size 0x24, virtual true, abstract: false, final false
inline void ProcessAadByte(uint8_t  input) ;

/// @brief Method ProcessAadBytes, addr 0x235e030, size 0x24, virtual true, abstract: false, final false
inline void ProcessAadBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  len) ;

/// @brief Method ProcessBlock, addr 0x235fa6c, size 0x218, virtual false, abstract: false, final false
...
/// @brief Method ProcessByte, addr 0x235ebb4, size 0x2c, virtual true, abstract: false, final false
inline int32_t ProcessByte(uint8_t  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method ProcessBytes, addr 0x235ebe0, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method ProcessPacket, addr 0x235ec80, size 0xb64, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x235fd8c, size 0x118, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x235d5e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  engine) ;

/// @brief Method .ctor, addr 0x235d5f0, size 0x4b0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  engine, int32_t  Nb) ;

/// @brief Method getFlag, addr 0x235e978, size 0x23c, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x235dea0, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method intToBytes, addr 0x235e8f8, size 0x80, virtual false, abstract: false, final false
inline void intToBytes(int32_t  num, ::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff) ;

/// @brief Method setNb, addr 0x235d574, size 0x74, virtual false, abstract: false, final false
