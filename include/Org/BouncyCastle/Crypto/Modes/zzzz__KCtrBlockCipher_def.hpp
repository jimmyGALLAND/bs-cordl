...
/// @brief Method CalculateByte, addr 0x2360578, size 0x14c, virtual false, abstract: false, final false
inline uint8_t CalculateByte(uint8_t  b) ;

/// @brief Method GetBlockSize, addr 0x23604d0, size 0xa4, virtual true, abstract: false, final true
inline int32_t GetBlockSize() ;

/// @brief Method GetUnderlyingCipher, addr 0x236011c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher() ;

/// @brief Method Init, addr 0x2360124, size 0x1b0, virtual true, abstract: false, final true
...
/// @brief Method ProcessBlock, addr 0x2360840, size 0xf8, virtual true, abstract: false, final true
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method ProcessBytes, addr 0x23606c4, size 0x12c, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x23602d4, size 0x134, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method ReturnByte, addr 0x2360574, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x235fef4, size 0x228, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  cipher) ;

/// @brief Method checkCounter, addr 0x236083c, size 0x4, virtual false, abstract: false, final false
inline void checkCounter() ;

/// @brief Method get_AlgorithmName, addr 0x2360408, size 0xc0, virtual true, abstract: false, final true
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x23604c8, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method incrementCounterAt, addr 0x23607f0, size 0x4c, virtual false, abstract: false, final false
