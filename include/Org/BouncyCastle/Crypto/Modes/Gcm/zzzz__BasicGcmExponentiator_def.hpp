...
/// @brief Method ExponentiateX, addr 0x234fd3c, size 0x110, virtual true, abstract: false, final true
inline void ExponentiateX(int64_t  pow, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method Init, addr 0x234fc6c, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x234ff94, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
