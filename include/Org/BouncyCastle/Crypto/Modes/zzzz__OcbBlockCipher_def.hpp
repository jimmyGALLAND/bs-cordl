...
/// @brief Method Clear, addr 0x2361fa8, size 0x1c, virtual true, abstract: false, final false
inline void Clear(::ArrayW<uint8_t,::Array<uint8_t>*>  bs) ;

/// @brief Method DoFinal, addr 0x2361ad8, size 0x404, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GetBlockSize, addr 0x2361770, size 0x8, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method GetLSub, addr 0x2361fc4, size 0x2cc, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetLSub(int32_t  n) ;

/// @brief Method GetMac, addr 0x2361778, size 0x88, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetMac() ;

/// @brief Method GetOutputSize, addr 0x2361800, size 0x28, virtual true, abstract: false, final false
inline int32_t GetOutputSize(int32_t  len) ;

/// @brief Method GetUnderlyingCipher, addr 0x2360d08, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher() ;

/// @brief Method GetUpdateOutputSize, addr 0x2361828, size 0x38, virtual true, abstract: false, final false
inline int32_t GetUpdateOutputSize(int32_t  len) ;

/// @brief Method Init, addr 0x2360dd0, size 0x6d0, virtual true, abstract: false, final false
...
/// @brief Method OCB_double, addr 0x23614a0, size 0x98, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> OCB_double(::ArrayW<uint8_t,::Array<uint8_t>*>  block) ;

/// @brief Method OCB_extend, addr 0x2361edc, size 0x60, virtual false, abstract: false, final false
static inline void OCB_extend(::ArrayW<uint8_t,::Array<uint8_t>*>  block, int32_t  pos) ;

/// @brief Method OCB_ntz, addr 0x2362300, size 0x34, virtual false, abstract: false, final false
static inline int32_t OCB_ntz(int64_t  x) ;

/// @brief Method ProcessAadByte, addr 0x2361860, size 0x68, virtual true, abstract: false, final false
inline void ProcessAadByte(uint8_t  input) ;

/// @brief Method ProcessAadBytes, addr 0x23618c8, size 0xb4, virtual true, abstract: false, final false
inline void ProcessAadBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  off, int32_t  len) ;

/// @brief Method ProcessByte, addr 0x236197c, size 0x7c, virtual true, abstract: false, final false
inline int32_t ProcessByte(uint8_t  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method ProcessBytes, addr 0x23619f8, size 0xe0, virtual true, abstract: false, final false
...
/// @brief Method ProcessHashBlock, addr 0x2362290, size 0x70, virtual true, abstract: false, final false
inline void ProcessHashBlock() ;

/// @brief Method ProcessMainBlock, addr 0x2362334, size 0x1d0, virtual true, abstract: false, final false
inline void ProcessMainBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method ProcessNonce, addr 0x2361538, size 0x238, virtual true, abstract: false, final false
inline int32_t ProcessNonce(::ArrayW<uint8_t,::Array<uint8_t>*>  N) ;

/// @brief Method Reset, addr 0x2361f94, size 0x14, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x2362504, size 0x1ec, virtual true, abstract: false, final false
inline void Reset(bool  clearMac) ;

/// @brief Method ShiftLeft, addr 0x23627d0, size 0x60, virtual false, abstract: false, final false
static inline int32_t ShiftLeft(::ArrayW<uint8_t,::Array<uint8_t>*>  block, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method UpdateHASH, addr 0x23626f0, size 0xe0, virtual true, abstract: false, final false
inline void UpdateHASH(::ArrayW<uint8_t,::Array<uint8_t>*>  LSub) ;

/// @brief Method Xor, addr 0x2361f3c, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2360938, size 0x3d0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  hashCipher, ::Org::BouncyCastle::Crypto::IBlockCipher*  mainCipher) ;

/// @brief Method get_AlgorithmName, addr 0x2360d10, size 0xc0, virtual true, abstract: false, final false
