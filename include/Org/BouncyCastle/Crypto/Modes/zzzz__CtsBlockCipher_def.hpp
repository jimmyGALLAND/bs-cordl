...
/// @brief Method DoFinal, addr 0x2359044, size 0x59c, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GetOutputSize, addr 0x2358bc0, size 0xc, virtual true, abstract: false, final false
inline int32_t GetOutputSize(int32_t  length) ;

/// @brief Method GetUpdateOutputSize, addr 0x2358b88, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method ProcessByte, addr 0x2358bcc, size 0x14c, virtual true, abstract: false, final false
inline int32_t ProcessByte(uint8_t  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method ProcessBytes, addr 0x2358d18, size 0x32c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23589e0, size 0x1a8, virtual false, abstract: false, final false
