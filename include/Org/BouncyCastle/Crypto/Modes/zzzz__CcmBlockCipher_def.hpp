...
/// @brief Method CalculateMac, addr 0x2354134, size 0x898, virtual false, abstract: false, final false
...
/// @brief Method DoFinal, addr 0x2353558, size 0xa8, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff) ;

/// @brief Method GetAssociatedTextLength, addr 0x23549e4, size 0x38, virtual false, abstract: false, final false
inline int32_t GetAssociatedTextLength() ;

/// @brief Method GetBlockSize, addr 0x23533a0, size 0xa4, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method GetMac, addr 0x23536dc, size 0x68, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetMac() ;

/// @brief Method GetMacSize, addr 0x2353274, size 0x6c, virtual false, abstract: false, final false
inline int32_t GetMacSize(bool  forEncryption, int32_t  requestedMacBits) ;

/// @brief Method GetOutputSize, addr 0x235374c, size 0x54, virtual true, abstract: false, final false
inline int32_t GetOutputSize(int32_t  len) ;

/// @brief Method GetUnderlyingCipher, addr 0x235309c, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher() ;

/// @brief Method GetUpdateOutputSize, addr 0x2353744, size 0x8, virtual true, abstract: false, final false
inline int32_t GetUpdateOutputSize(int32_t  len) ;

/// @brief Method HasAssociatedText, addr 0x23549cc, size 0x18, virtual false, abstract: false, final false
inline bool HasAssociatedText() ;

/// @brief Method Init, addr 0x23530a4, size 0x1d0, virtual true, abstract: false, final false
...
/// @brief Method ProcessAadByte, addr 0x2353444, size 0x24, virtual true, abstract: false, final false
inline void ProcessAadByte(uint8_t  input) ;

/// @brief Method ProcessAadBytes, addr 0x2353468, size 0x24, virtual true, abstract: false, final false
inline void ProcessAadBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  inBytes, int32_t  inOff, int32_t  len) ;

/// @brief Method ProcessByte, addr 0x235348c, size 0x2c, virtual true, abstract: false, final false
inline int32_t ProcessByte(uint8_t  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff) ;

/// @brief Method ProcessBytes, addr 0x23534b8, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method ProcessPacket, addr 0x23537a0, size 0xf8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ProcessPacket(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  inLen) ;

/// @brief Method ProcessPacket, addr 0x2353898, size 0x89c, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x2353600, size 0xdc, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x2352e80, size 0x21c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  cipher) ;

static inline int32_t getStaticF_BlockSize() ;

/// @brief Method get_AlgorithmName, addr 0x23532e0, size 0xc0, virtual true, abstract: false, final false
