...
/// @brief Method CheckAad, addr 0x2355f90, size 0xac, virtual false, abstract: false, final false
inline void CheckAad() ;

/// @brief Method CheckData, addr 0x2356514, size 0xc8, virtual false, abstract: false, final false
inline void CheckData() ;

/// @brief Method DoFinal, addr 0x2356bb4, size 0x3c8, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff) ;

/// @brief Method FinishAad, addr 0x2357174, size 0x2c, virtual false, abstract: false, final false
inline void FinishAad(::Org::BouncyCastle::Crypto::Modes::__ChaCha20Poly1305__State  nextState) ;

/// @brief Method FinishData, addr 0x2356f7c, size 0x190, virtual false, abstract: false, final false
inline void FinishData(::Org::BouncyCastle::Crypto::Modes::__ChaCha20Poly1305__State  nextState) ;

/// @brief Method GetMac, addr 0x235710c, size 0x5c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetMac() ;

/// @brief Method GetOutputSize, addr 0x2355ce4, size 0xf0, virtual true, abstract: false, final false
inline int32_t GetOutputSize(int32_t  len) ;

/// @brief Method GetUpdateOutputSize, addr 0x2355dd4, size 0xf4, virtual true, abstract: false, final false
inline int32_t GetUpdateOutputSize(int32_t  len) ;

/// @brief Method IncrementCount, addr 0x235603c, size 0x64, virtual false, abstract: false, final false
inline uint64_t IncrementCount(uint64_t  count, uint32_t  increment, uint64_t  limit) ;

/// @brief Method Init, addr 0x235576c, size 0x444, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method InitMac, addr 0x23572a0, size 0x1c8, virtual false, abstract: false, final false
inline void InitMac() ;
...
/// @brief Method PadMac, addr 0x23571a0, size 0x100, virtual false, abstract: false, final false
inline void PadMac(uint64_t  count) ;

/// @brief Method ProcessAadByte, addr 0x2355ec8, size 0xc8, virtual true, abstract: false, final false
inline void ProcessAadByte(uint8_t  input) ;

/// @brief Method ProcessAadBytes, addr 0x23560a0, size 0x1ec, virtual true, abstract: false, final false
inline void ProcessAadBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  inBytes, int32_t  inOff, int32_t  len) ;

/// @brief Method ProcessByte, addr 0x235628c, size 0x288, virtual true, abstract: false, final false
inline int32_t ProcessByte(uint8_t  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff) ;

/// @brief Method ProcessBytes, addr 0x23566a4, size 0x510, virtual true, abstract: false, final false
...
/// @brief Method ProcessData, addr 0x23565dc, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x2357168, size 0xc, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x2355bb0, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2355500, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2355558, size 0x1d4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IMac*  poly1305) ;

static inline ::ArrayW<uint8_t,::Array<uint8_t>*> getStaticF_Zeroes() ;

/// @brief Method get_AlgorithmName, addr 0x235572c, size 0x40, virtual true, abstract: false, final false
