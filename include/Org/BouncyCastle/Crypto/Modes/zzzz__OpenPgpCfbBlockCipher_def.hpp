...
/// @brief Method DecryptBlock, addr 0x2363280, size 0x650, virtual false, abstract: false, final false
...
/// @brief Method EncryptBlock, addr 0x23638d0, size 0x608, virtual false, abstract: false, final false
...
/// @brief Method EncryptByte, addr 0x2364148, size 0x34, virtual false, abstract: false, final false
inline uint8_t EncryptByte(uint8_t  data, int32_t  blockOff) ;

/// @brief Method GetBlockSize, addr 0x23631cc, size 0xa4, virtual true, abstract: false, final true
inline int32_t GetBlockSize() ;

/// @brief Method GetUnderlyingCipher, addr 0x23630fc, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IBlockCipher* GetUnderlyingCipher() ;

/// @brief Method Init, addr 0x2363fa0, size 0x1a8, virtual true, abstract: false, final true
...
/// @brief Method ProcessBlock, addr 0x2363270, size 0x10, virtual true, abstract: false, final true
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x2363ed8, size 0xc8, virtual true, abstract: false, final true
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x2362ffc, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  cipher) ;

/// @brief Method get_AlgorithmName, addr 0x2363104, size 0xc0, virtual true, abstract: false, final true
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x23631c4, size 0x8, virtual true, abstract: false, final true
