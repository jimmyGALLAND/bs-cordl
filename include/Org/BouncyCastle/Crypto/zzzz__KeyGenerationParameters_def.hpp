...
/// @brief Method .ctor, addr 0x236c8d8, size 0xcc, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Security::SecureRandom*  random, int32_t  strength) ;

/// @brief Method get_Random, addr 0x236c9a4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Security::SecureRandom* get_Random() ;

/// @brief Method get_Strength, addr 0x236c9ac, size 0x8, virtual false, abstract: false, final false
