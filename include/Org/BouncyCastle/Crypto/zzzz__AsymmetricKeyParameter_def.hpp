...
/// @brief Method Equals, addr 0x236ca5c, size 0x98, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x236caf4, size 0x24, virtual false, abstract: false, final false
inline bool Equals(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  other) ;

/// @brief Method GetHashCode, addr 0x236cb18, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x236ca2c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(bool  privateKey) ;

/// @brief Method get_IsPrivate, addr 0x236ca54, size 0x8, virtual false, abstract: false, final false
