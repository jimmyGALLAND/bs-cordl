...
/// @brief Method GenerateKeyPair, addr 0x2344d88, size 0xac, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair() ;

/// @brief Method Init, addr 0x2344d6c, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2344e34, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
