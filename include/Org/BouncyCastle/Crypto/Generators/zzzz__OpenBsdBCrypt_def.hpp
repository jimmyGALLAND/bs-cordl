...
/// @brief Method CheckPassword, addr 0x233fdfc, size 0x508, virtual false, abstract: false, final false
static inline bool CheckPassword(::StringW  bcryptString, ::ArrayW<char16_t,::Array<char16_t>*>  password) ;

/// @brief Method CreateBcryptString, addr 0x233f3b4, size 0x2e0, virtual false, abstract: false, final false
...
/// @brief Method DecodeSaltString, addr 0x2340304, size 0x3d0, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> DecodeSaltString(::StringW  saltString) ;

/// @brief Method EncodeData, addr 0x233f694, size 0x354, virtual false, abstract: false, final false
static inline ::StringW EncodeData(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method Generate, addr 0x233f9e8, size 0x78, virtual false, abstract: false, final false
static inline ::StringW Generate(::ArrayW<char16_t,::Array<char16_t>*>  password, ::ArrayW<uint8_t,::Array<uint8_t>*>  salt, int32_t  cost) ;

/// @brief Method Generate, addr 0x233fa60, size 0x39c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x233f3ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
