...
/// @brief Method GenerateKeyPair, addr 0x2338454, size 0x188, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair() ;

/// @brief Method Init, addr 0x23383b0, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x23385dc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
