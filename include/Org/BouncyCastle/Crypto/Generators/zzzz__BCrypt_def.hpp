...
/// @brief Method CyclicXorKey, addr 0x2333f10, size 0x88, virtual false, abstract: false, final false
inline void CyclicXorKey(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method DeriveRawKey, addr 0x23344c4, size 0x318, virtual false, abstract: false, final false
...
/// @brief Method EncryptMagicString, addr 0x2333f98, size 0x2d0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncryptMagicString() ;

/// @brief Method F, addr 0x2333c58, size 0x84, virtual false, abstract: false, final false
inline uint32_t F(uint32_t  x) ;

/// @brief Method Generate, addr 0x233484c, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method InitState, addr 0x2333e10, size 0x100, virtual false, abstract: false, final false
inline void InitState() ;

static inline ::Org::BouncyCastle::Crypto::Generators::BCrypt* New_ctor() ;

/// @brief Method PasswordToByteArray, addr 0x23347dc, size 0x70, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> PasswordToByteArray(::ArrayW<char16_t,::Array<char16_t>*>  password) ;

/// @brief Method ProcessTable, addr 0x2333cdc, size 0x134, virtual false, abstract: false, final false
inline void ProcessTable(uint32_t  xl, uint32_t  xr, ::ArrayW<uint32_t,::Array<uint32_t>*>  table) ;

/// @brief Method ProcessTableWithSalt, addr 0x2334268, size 0x25c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2333bec, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;
