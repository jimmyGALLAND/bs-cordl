...
/// @brief Method GenerateBytes, addr 0x233b6a8, size 0x200, virtual true, abstract: false, final true
inline int32_t GenerateBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff, int32_t  length) ;

/// @brief Method GetMac, addr 0x233b618, size 0x8, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Crypto::IMac* GetMac() ;

/// @brief Method Init, addr 0x233b37c, size 0x29c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x233b29c, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IMac*  prf) ;

/// @brief Method generateNext, addr 0x233b8a8, size 0x324, virtual false, abstract: false, final false
...
/// @brief Method get_Digest, addr 0x233b620, size 0x88, virtual true, abstract: false, final true
