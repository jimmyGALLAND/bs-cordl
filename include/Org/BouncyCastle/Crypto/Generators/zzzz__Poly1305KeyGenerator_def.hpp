...
public:
// Declarations
/// @brief Method CheckKey, addr 0x23433f8, size 0x108, virtual false, abstract: false, final false
static inline void CheckKey(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method CheckMask, addr 0x2343500, size 0x5c, virtual false, abstract: false, final false
static inline void CheckMask(uint8_t  b, uint8_t  mask) ;

/// @brief Method Clamp, addr 0x234333c, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x234355c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method engineGenerateKey, addr 0x2343320, size 0x1c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> engineGenerateKey() ;

/// @brief Method engineInit, addr 0x23432fc, size 0x24, virtual true, abstract: false, final false
