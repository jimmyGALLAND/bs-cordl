...
/// @brief Method GenerateBytes, addr 0x233cc14, size 0x200, virtual true, abstract: false, final true
inline int32_t GenerateBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff, int32_t  length) ;

/// @brief Method GetMac, addr 0x233d18c, size 0x8, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Crypto::IMac* GetMac() ;

/// @brief Method Init, addr 0x233c8d8, size 0x2b4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x233c7f8, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IMac*  prf) ;

/// @brief Method generateNext, addr 0x233ce14, size 0x378, virtual false, abstract: false, final false
...
/// @brief Method get_Digest, addr 0x233cb8c, size 0x88, virtual true, abstract: false, final true
