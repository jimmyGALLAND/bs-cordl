...
/// @brief Method GenerateKeyPair, addr 0x233822c, size 0xac, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair() ;

/// @brief Method Init, addr 0x2338210, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23382d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
