...
/// @brief Method GenerateKeyPair, addr 0x23353f8, size 0x138, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair() ;

/// @brief Method Init, addr 0x2335354, size 0xa4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2335720, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
