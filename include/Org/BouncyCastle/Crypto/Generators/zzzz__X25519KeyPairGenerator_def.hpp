...
/// @brief Method GenerateKeyPair, addr 0x2344cb8, size 0xac, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair() ;

/// @brief Method Init, addr 0x2344c9c, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2344d64, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(::cordl_internals::size_check_v<::Org::BouncyCastle::Crypto::Generators::X25519KeyPairGenerator, 0x18>, "Size mismatch!");
