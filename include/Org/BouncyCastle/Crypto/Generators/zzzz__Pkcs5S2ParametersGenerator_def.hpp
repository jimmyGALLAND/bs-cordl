...
/// @brief Method F, addr 0x23429fc, size 0x3c0, virtual false, abstract: false, final false
...
/// @brief Method GenerateDerivedKey, addr 0x2342dbc, size 0x224, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateDerivedKey(int32_t  dkLen) ;

/// @brief Method GenerateDerivedMacParameters, addr 0x2343268, size 0x94, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedMacParameters(int32_t  keySize) ;

/// @brief Method GenerateDerivedParameters, addr 0x2342fec, size 0x98, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(::StringW  algorithm, int32_t  keySize) ;

/// @brief Method GenerateDerivedParameters, addr 0x234316c, size 0xfc, virtual true, abstract: false, final false
...
/// @brief Method GenerateDerivedParameters, addr 0x2342fe0, size 0xc, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(int32_t  keySize) ;

/// @brief Method GenerateDerivedParameters, addr 0x2343084, size 0xe8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x234288c, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x23428e8, size 0x114, virtual false, abstract: false, final false
