...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::*)(::Org::BouncyCastle::Crypto::IDigest*)>(&::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::_ctor)> {
  constexpr static std::size_t size = 0xbc;
  constexpr static std::size_t addrs = 0x233d224;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::*)(::Org::BouncyCastle::Crypto::IDerivationParameters*)>(&::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::Init)> {
  constexpr static std::size_t size = 0x144;
  constexpr static std::size_t addrs = 0x233d2e0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Crypto::IDigest* (::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::*)()>(&::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::get_Digest)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x233d424;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::*)(int32_t, ::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::ItoOSP)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x233d42c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::GenerateBytes)> {
  constexpr static std::size_t size = 0x4bc;
  constexpr static std::size_t addrs = 0x233d480;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::IDigest*> const& Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::__cordl_internal_get_digest() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___digest;
}
...
constexpr ::ArrayW<uint8_t,::Array<uint8_t>*>& Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::__cordl_internal_get_seed()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___seed;
}
constexpr ::ArrayW<uint8_t,::Array<uint8_t>*> const& Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::__cordl_internal_get_seed() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___seed;
}
constexpr void Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::__cordl_internal_set_seed(::ArrayW<uint8_t,::Array<uint8_t>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator*>(digest));
}
...
inline void Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::ItoOSP(int32_t  i, ::ArrayW<uint8_t,::Array<uint8_t>*>  sp)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator*>::get(),
                        "ItoOSP",
                        std::span<const Il2CppClass* const, 0>(),
...
inline int32_t Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator::GenerateBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff, int32_t  length)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Generators::Mgf1BytesGenerator*>::get(),
                        "GenerateBytes",
                        std::span<const Il2CppClass* const, 0>(),
