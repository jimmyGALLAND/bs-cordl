...
/// @brief Method GenerateBytes, addr 0x233d480, size 0x4bc, virtual true, abstract: false, final true
inline int32_t GenerateBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff, int32_t  length) ;

/// @brief Method Init, addr 0x233d2e0, size 0x144, virtual true, abstract: false, final true
inline void Init(::Org::BouncyCastle::Crypto::IDerivationParameters*  parameters) ;

/// @brief Method ItoOSP, addr 0x233d42c, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x233d224, size 0xbc, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method get_Digest, addr 0x233d424, size 0x8, virtual true, abstract: false, final true
