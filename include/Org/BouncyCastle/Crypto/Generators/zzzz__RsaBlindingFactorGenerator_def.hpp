...
/// @brief Method GenerateBlindingFactor, addr 0x234373c, size 0x174, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* GenerateBlindingFactor() ;

/// @brief Method Init, addr 0x234356c, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23438b0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
