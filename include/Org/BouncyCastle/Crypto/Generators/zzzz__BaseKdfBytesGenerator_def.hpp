...
/// @brief Method GenerateBytes, addr 0x23336c0, size 0x52c, virtual true, abstract: false, final false
inline int32_t GenerateBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff, int32_t  length) ;

/// @brief Method Init, addr 0x23335a4, size 0x114, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2333574, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  counterStart, ::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method get_Digest, addr 0x23336b8, size 0x8, virtual true, abstract: false, final false
