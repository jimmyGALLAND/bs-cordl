...
/// @brief Method GenerateBytes, addr 0x233c560, size 0x200, virtual true, abstract: false, final true
inline int32_t GenerateBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff, int32_t  length) ;

/// @brief Method GetMac, addr 0x233c760, size 0x8, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Crypto::IMac* GetMac() ;

/// @brief Method Init, addr 0x233bd4c, size 0x2b4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x233bc5c, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IMac*  prf) ;

/// @brief Method generateNext, addr 0x233c000, size 0x4d8, virtual false, abstract: false, final false
...
/// @brief Method get_Digest, addr 0x233c4d8, size 0x88, virtual true, abstract: false, final true
