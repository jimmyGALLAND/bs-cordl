...
/// @brief Method GenerateParameters, addr 0x23385f0, size 0xd8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::ElGamalParameters* GenerateParameters() ;

/// @brief Method Init, addr 0x23385e4, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23386c8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
