...
/// @brief Method ChooseRandomPrime, addr 0x2343d28, size 0x228, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* ChooseRandomPrime(int32_t  bitlength, ::Org::BouncyCastle::Math::BigInteger*  e) ;

/// @brief Method GenerateKeyPair, addr 0x23439c8, size 0x360, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* GenerateKeyPair() ;

/// @brief Method Init, addr 0x23438b8, size 0x110, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2344088, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
