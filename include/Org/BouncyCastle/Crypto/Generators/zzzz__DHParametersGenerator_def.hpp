...
/// @brief Method GenerateParameters, addr 0x233597c, size 0x114, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* GenerateParameters() ;

/// @brief Method Init, addr 0x2335970, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x233603c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
