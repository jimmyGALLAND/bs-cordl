...
/// @brief Method Adjust, addr 0x234134c, size 0xb8, virtual false, abstract: false, final false
inline void Adjust(::ArrayW<uint8_t,::Array<uint8_t>*>  a, int32_t  aOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  b) ;

/// @brief Method GenerateDerivedKey, addr 0x2341404, size 0x5f0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateDerivedKey(int32_t  idByte, int32_t  n) ;

/// @brief Method GenerateDerivedMacParameters, addr 0x2341d3c, size 0x98, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedMacParameters(int32_t  keySize) ;

/// @brief Method GenerateDerivedParameters, addr 0x2341a8c, size 0x9c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(::StringW  algorithm, int32_t  keySize) ;

/// @brief Method GenerateDerivedParameters, addr 0x2341c28, size 0x114, virtual true, abstract: false, final false
...
/// @brief Method GenerateDerivedParameters, addr 0x23419f4, size 0x98, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::ICipherParameters* GenerateDerivedParameters(int32_t  keySize) ;

/// @brief Method GenerateDerivedParameters, addr 0x2341b28, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2341230, size 0x11c, virtual false, abstract: false, final false
