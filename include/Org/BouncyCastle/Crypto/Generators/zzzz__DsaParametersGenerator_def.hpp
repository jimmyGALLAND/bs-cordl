...
/// @brief Method CalculateGenerator_FIPS186_2, addr 0x2337054, size 0x114, virtual true, abstract: false, final false
...
/// @brief Method CalculateGenerator_FIPS186_3_Unverifiable, addr 0x233771c, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method CalculateGenerator_FIPS186_3_Verifiable, addr 0x2337728, size 0x2a8, virtual true, abstract: false, final false
...
/// @brief Method GenerateParameters, addr 0x23369a0, size 0x1c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::DsaParameters* GenerateParameters() ;

/// @brief Method GenerateParameters_FIPS186_2, addr 0x23369bc, size 0x52c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::DsaParameters* GenerateParameters_FIPS186_2() ;

/// @brief Method GenerateParameters_FIPS186_3, addr 0x2337168, size 0x5b4, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::DsaParameters* GenerateParameters_FIPS186_3() ;

/// @brief Method GetDefaultN, addr 0x2336704, size 0x14, virtual false, abstract: false, final false
static inline int32_t GetDefaultN(int32_t  L) ;

/// @brief Method Hash, addr 0x2336ee8, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method Inc, addr 0x2337010, size 0x44, virtual false, abstract: false, final false
static inline void Inc(::ArrayW<uint8_t,::Array<uint8_t>*>  buf) ;

/// @brief Method Init, addr 0x2336718, size 0x288, virtual true, abstract: false, final false
inline void Init(::Org::BouncyCastle::Crypto::Parameters::DsaParameterGenerationParameters*  parameters) ;

/// @brief Method Init, addr 0x2336650, size 0x98, virtual true, abstract: false, final false
inline void Init(int32_t  size, int32_t  certainty, ::Org::BouncyCastle::Security::SecureRandom*  random) ;

/// @brief Method IsValidDsaStrength, addr 0x23366e8, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23365c4, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2336628, size 0x28, virtual false, abstract: false, final false
