...
static __declspec(property(get=getStaticF_BigPrimeProducts, put=setStaticF_BigPrimeProducts)) ::ArrayW<::Org::BouncyCastle::Math::BigInteger*,::Array<::Org::BouncyCastle::Math::BigInteger*>*>  BigPrimeProducts;
...
/// @brief Method ConstructBigPrimeProducts, addr 0x2336044, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method GenerateSafePrimes, addr 0x2335a90, size 0x4bc, virtual false, abstract: false, final false
...
/// @brief Method SelectGenerator, addr 0x2335f4c, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23361fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
