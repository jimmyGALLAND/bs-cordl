...
/// @brief Method CheckBitLength, addr 0x22e526c, size 0xc0, virtual false, abstract: false, final false
static inline int32_t CheckBitLength(int32_t  bitLength) ;

/// @brief Method Copy, addr 0x22e55b4, size 0x58, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method DoFinal, addr 0x22e5490, size 0x40, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method DoFinal, addr 0x22e54d0, size 0xe4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22e532c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x22e5334, size 0x70, virtual false, abstract: false, final false
inline void _ctor(int32_t  bitLength) ;

/// @brief Method .ctor, addr 0x22e53a4, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Digests::Sha3Digest*  source) ;

/// @brief Method get_AlgorithmName, addr 0x22e540c, size 0x84, virtual true, abstract: false, final false
