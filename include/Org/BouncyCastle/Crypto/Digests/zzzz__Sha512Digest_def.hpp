...
/// @brief Method Copy, addr 0x22e583c, size 0x58, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method DoFinal, addr 0x22e5714, size 0xe0, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GetDigestSize, addr 0x22e570c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x22e57f4, size 0x48, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x22e5894, size 0x88, virtual true, abstract: false, final false
inline void Reset(::Org::BouncyCastle::Utilities::IMemoable*  other) ;

/// @brief Method .ctor, addr 0x22e560c, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x22e5664, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Digests::Sha512Digest*  t) ;

/// @brief Method get_AlgorithmName, addr 0x22e56cc, size 0x40, virtual true, abstract: false, final false
