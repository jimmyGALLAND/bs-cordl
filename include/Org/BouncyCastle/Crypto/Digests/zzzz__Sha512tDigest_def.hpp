...
/// @brief Method Copy, addr 0x22e5f7c, size 0x58, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method DoFinal, addr 0x22e5d24, size 0xfc, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GetDigestSize, addr 0x22e5d1c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x22e5e84, size 0x38, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x22e5fd4, size 0x108, virtual true, abstract: false, final false
inline void Reset(::Org::BouncyCastle::Utilities::IMemoable*  other) ;

/// @brief Method UInt32_To_BE, addr 0x22e5ebc, size 0xc0, virtual false, abstract: false, final false
static inline void UInt32_To_BE(uint32_t  n, ::ArrayW<uint8_t,::Array<uint8_t>*>  bs, int32_t  off, int32_t  max) ;

/// @brief Method UInt64_To_BE, addr 0x22e5e20, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22e591c, size 0x15c, virtual false, abstract: false, final false
inline void _ctor(int32_t  bitLength) ;

/// @brief Method .ctor, addr 0x22e5c04, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Digests::Sha512tDigest*  t) ;

/// @brief Method get_AlgorithmName, addr 0x22e5c94, size 0x88, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method tIvGenerate, addr 0x22e5a78, size 0x18c, virtual false, abstract: false, final false
