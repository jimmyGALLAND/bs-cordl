...
/// @brief Method Absorb, addr 0x264ce2c, size 0x16c, virtual false, abstract: false, final false
inline void Absorb(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  off, int32_t  len) ;

/// @brief Method Absorb, addr 0x264cd4c, size 0xdc, virtual false, abstract: false, final false
inline void Absorb(uint8_t  data) ;

/// @brief Method AbsorbBits, addr 0x264d184, size 0x124, virtual false, abstract: false, final false
inline void AbsorbBits(int32_t  data, int32_t  bits) ;

/// @brief Method BlockUpdate, addr 0x264ce28, size 0x4, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  len) ;

/// @brief Method Copy, addr 0x264dc40, size 0x58, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method CopyIn, addr 0x264cc3c, size 0x7c, virtual false, abstract: false, final false
inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::KeccakDigest*  source) ;

/// @brief Method DoFinal, addr 0x264cf98, size 0x3c, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method DoFinal, addr 0x264d114, size 0x70, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff, uint8_t  partialByte, int32_t  partialBits) ;

/// @brief Method GetByteLength, addr 0x264d2b0, size 0xc, virtual true, abstract: false, final false
inline int32_t GetByteLength() ;

/// @brief Method GetDigestSize, addr 0x264cd3c, size 0xc, virtual true, abstract: false, final false
inline int32_t GetDigestSize() ;

/// @brief Method Init, addr 0x264cafc, size 0xac, virtual false, abstract: false, final false
inline void Init(int32_t  bitLength) ;

/// @brief Method InitSponge, addr 0x264d2bc, size 0xf8, virtual false, abstract: false, final false
inline void InitSponge(int32_t  rate) ;

/// @brief Method KeccakAbsorb, addr 0x264d3b4, size 0xb0, virtual false, abstract: false, final false
inline void KeccakAbsorb(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  off) ;

/// @brief Method KeccakExtract, addr 0x264d604, size 0x38, virtual false, abstract: false, final false
inline void KeccakExtract() ;

/// @brief Method KeccakPermutation, addr 0x264d63c, size 0x604, virtual false, abstract: false, final false
...
/// @brief Method PadAndSwitchToSqueezingPhase, addr 0x264d464, size 0x1a0, virtual false, abstract: false, final false
inline void PadAndSwitchToSqueezingPhase() ;

/// @brief Method Reset, addr 0x264d2a8, size 0x8, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x264dc98, size 0x84, virtual true, abstract: false, final false
inline void Reset(::Org::BouncyCastle::Utilities::IMemoable*  other) ;

/// @brief Method Squeeze, addr 0x264cfd4, size 0x140, virtual false, abstract: false, final false
inline void Squeeze(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  offset, int64_t  outputLength) ;

/// @brief Method Update, addr 0x264cd48, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x264ca60, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x264ca68, size 0x94, virtual false, abstract: false, final false
inline void _ctor(int32_t  bitLength) ;

/// @brief Method .ctor, addr 0x264cba8, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x264ccb8, size 0x84, virtual true, abstract: false, final false
