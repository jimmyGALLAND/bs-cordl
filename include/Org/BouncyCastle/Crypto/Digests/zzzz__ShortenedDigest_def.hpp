...
/// @brief Method BlockUpdate, addr 0x22e69a4, size 0xc4, virtual true, abstract: false, final true
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method DoFinal, addr 0x22e6a68, size 0x174, virtual true, abstract: false, final true
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GetByteLength, addr 0x22e6c80, size 0xa4, virtual true, abstract: false, final true
inline int32_t GetByteLength() ;

/// @brief Method GetDigestSize, addr 0x22e68f0, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x22e6bdc, size 0xa4, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method Update, addr 0x22e68f8, size 0xac, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x22e65b8, size 0x148, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IDigest*  baseDigest, int32_t  length) ;

/// @brief Method get_AlgorithmName, addr 0x22e6700, size 0x1f0, virtual true, abstract: false, final true
