...
/// @brief Method .ctor, addr 0x22e895c, size 0x148, virtual false, abstract: false, final false
inline void _ctor(int64_t  outputSizeBits) ;

/// @brief Method get_Bytes, addr 0x22e8f08, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22e88dc, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  type, ::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method get_Type, addr 0x22e8f10, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Type() ;

/// @brief Method get_Value, addr 0x22e8f18, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AdvancePosition, addr 0x22e9194, size 0x160, virtual false, abstract: false, final false
inline void AdvancePosition(int32_t  advance) ;

/// @brief Method GetWords, addr 0x22e92f4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x22e8f80, size 0x3c, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x22e8fbc, size 0x88, virtual false, abstract: false, final false
inline void Reset(::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__UbiTweak*  tweak) ;

/// @brief Method ToString, addr 0x22e92fc, size 0x208, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22e8f20, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Final, addr 0x22e9124, size 0x30, virtual false, abstract: false, final false
inline bool get_Final() ;

/// @brief Method get_First, addr 0x22e90f4, size 0x30, virtual false, abstract: false, final false
inline bool get_First() ;

/// @brief Method get_Type, addr 0x22e9088, size 0x30, virtual false, abstract: false, final false
inline uint32_t get_Type() ;

/// @brief Method set_Final, addr 0x22e9154, size 0x40, virtual false, abstract: false, final false
inline void set_Final(bool  value) ;

/// @brief Method set_First, addr 0x22e9044, size 0x44, virtual false, abstract: false, final false
inline void set_First(bool  value) ;

/// @brief Method set_Type, addr 0x22e90b8, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method DoFinal, addr 0x22e8c2c, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method ProcessBlock, addr 0x22e9504, size 0x170, virtual false, abstract: false, final false
inline void ProcessBlock(::ArrayW<uint64_t,::Array<uint64_t>*>  output) ;

/// @brief Method Reset, addr 0x22e8bec, size 0x40, virtual false, abstract: false, final false
inline void Reset(int32_t  type) ;

/// @brief Method Reset, addr 0x22e7dec, size 0xac, virtual false, abstract: false, final false
inline void Reset(::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__UBI*  ubi) ;

/// @brief Method Update, addr 0x22e8aa4, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22e7c0c, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Field postMessageParameters, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_postMessageParameters, put=__cordl_internal_set_postMessageParameters)) ::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*>  postMessageParameters;

/// @brief Field preMessageParameters, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_preMessageParameters, put=__cordl_internal_set_preMessageParameters)) ::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*>  preMessageParameters;
...
/// @brief Method CheckInitialised, addr 0x22e8c9c, size 0x5c, virtual false, abstract: false, final false
inline void CheckInitialised() ;

/// @brief Method Clone, addr 0x22e7e98, size 0xa0, virtual false, abstract: false, final false
static inline ::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*> Clone(::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*>  data, ::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*>  existing) ;

/// @brief Method Copy, addr 0x22e7f38, size 0x58, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method CopyIn, addr 0x22e7ce8, size 0x104, virtual false, abstract: false, final false
inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::SkeinEngine*  engine) ;

/// @brief Method CreateInitialState, addr 0x22e860c, size 0x2b8, virtual false, abstract: false, final false
inline void CreateInitialState() ;

/// @brief Method DoFinal, addr 0x22e761c, size 0x1c4, virtual false, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff) ;

/// @brief Method Init, addr 0x22e7448, size 0xb4, virtual false, abstract: false, final false
inline void Init(::Org::BouncyCastle::Crypto::Parameters::SkeinParameters*  parameters) ;

/// @brief Method InitParams, addr 0x22e7f98, size 0x674, virtual false, abstract: false, final false
inline void InitParams(::System::Collections::IDictionary*  parameters) ;

/// @brief Method InitialState, addr 0x22e7ac4, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method Output, addr 0x22e8cf8, size 0x210, virtual false, abstract: false, final false
inline void Output(uint64_t  outputSequence, ::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff, int32_t  outputBytes) ;

/// @brief Method Reset, addr 0x22e7514, size 0x40, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x22e70a0, size 0x120, virtual true, abstract: false, final true
inline void Reset(::Org::BouncyCastle::Utilities::IMemoable*  other) ;

/// @brief Method UbiComplete, addr 0x22e890c, size 0x50, virtual false, abstract: false, final false
inline void UbiComplete(int32_t  type, ::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method UbiFinal, addr 0x22e8bcc, size 0x20, virtual false, abstract: false, final false
inline void UbiFinal() ;

/// @brief Method UbiInit, addr 0x22e88c4, size 0x18, virtual false, abstract: false, final false
inline void UbiInit(int32_t  type) ;

/// @brief Method Update, addr 0x22e756c, size 0x34, virtual false, abstract: false, final false
inline void Update(uint8_t  inByte) ;

/// @brief Method Update, addr 0x22e75b8, size 0x4c, virtual false, abstract: false, final false
inline void Update(::ArrayW<uint8_t,::Array<uint8_t>*>  inBytes, int32_t  inOff, int32_t  len) ;

/// @brief Method VariantIdentifier, addr 0x22e7c04, size 0x8, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*> const& __cordl_internal_get_postMessageParameters() const;

constexpr ::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*>& __cordl_internal_get_postMessageParameters() ;

constexpr ::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*> const& __cordl_internal_get_preMessageParameters() const;

constexpr ::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*>& __cordl_internal_get_preMessageParameters() ;
...
constexpr void __cordl_internal_set_postMessageParameters(::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*>  value) ;

constexpr void __cordl_internal_set_preMessageParameters(::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*>  value) ;
...
/// @brief Method .ctor, addr 0x22e6dac, size 0x184, virtual false, abstract: false, final false
inline void _ctor(int32_t  blockSizeBits, int32_t  outputSizeBits) ;

/// @brief Method .ctor, addr 0x22e6fbc, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method get_BlockSize, addr 0x22e73dc, size 0x24, virtual false, abstract: false, final false
inline int32_t get_BlockSize() ;

/// @brief Method get_OutputSize, addr 0x22e7f90, size 0x8, virtual false, abstract: false, final false
