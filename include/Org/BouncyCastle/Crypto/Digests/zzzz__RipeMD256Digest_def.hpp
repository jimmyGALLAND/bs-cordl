...
/// @brief Method Copy, addr 0x22e11b4, size 0x58, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method CopyIn, addr 0x22dfd98, size 0x64, virtual false, abstract: false, final false
inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::RipeMD256Digest*  t) ;

/// @brief Method DoFinal, addr 0x22dffa4, size 0xc0, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method F1, addr 0x22e0114, size 0x1c, virtual false, abstract: false, final false
inline int32_t F1(int32_t  a, int32_t  b, int32_t  c, int32_t  d, int32_t  x, int32_t  s) ;

/// @brief Method F1, addr 0x22e00dc, size 0xc, virtual false, abstract: false, final false
inline int32_t F1(int32_t  x, int32_t  y, int32_t  z) ;

/// @brief Method F2, addr 0x22e0130, size 0x2c, virtual false, abstract: false, final false
inline int32_t F2(int32_t  a, int32_t  b, int32_t  c, int32_t  d, int32_t  x, int32_t  s) ;

/// @brief Method F2, addr 0x22e00e8, size 0x10, virtual false, abstract: false, final false
inline int32_t F2(int32_t  x, int32_t  y, int32_t  z) ;

/// @brief Method F3, addr 0x22e015c, size 0x28, virtual false, abstract: false, final false
inline int32_t F3(int32_t  a, int32_t  b, int32_t  c, int32_t  d, int32_t  x, int32_t  s) ;

/// @brief Method F3, addr 0x22e00f8, size 0xc, virtual false, abstract: false, final false
inline int32_t F3(int32_t  x, int32_t  y, int32_t  z) ;

/// @brief Method F4, addr 0x22e0184, size 0x2c, virtual false, abstract: false, final false
inline int32_t F4(int32_t  a, int32_t  b, int32_t  c, int32_t  d, int32_t  x, int32_t  s) ;

/// @brief Method F4, addr 0x22e0104, size 0x10, virtual false, abstract: false, final false
inline int32_t F4(int32_t  x, int32_t  y, int32_t  z) ;

/// @brief Method FF1, addr 0x22e01b0, size 0x1c, virtual false, abstract: false, final false
inline int32_t FF1(int32_t  a, int32_t  b, int32_t  c, int32_t  d, int32_t  x, int32_t  s) ;

/// @brief Method FF2, addr 0x22e01cc, size 0x2c, virtual false, abstract: false, final false
inline int32_t FF2(int32_t  a, int32_t  b, int32_t  c, int32_t  d, int32_t  x, int32_t  s) ;

/// @brief Method FF3, addr 0x22e01f8, size 0x28, virtual false, abstract: false, final false
inline int32_t FF3(int32_t  a, int32_t  b, int32_t  c, int32_t  d, int32_t  x, int32_t  s) ;

/// @brief Method FF4, addr 0x22e0220, size 0x2c, virtual false, abstract: false, final false
inline int32_t FF4(int32_t  a, int32_t  b, int32_t  c, int32_t  d, int32_t  x, int32_t  s) ;

/// @brief Method GetDigestSize, addr 0x22dfcb0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ProcessBlock, addr 0x22e024c, size 0xf68, virtual true, abstract: false, final false
inline void ProcessBlock() ;

/// @brief Method ProcessLength, addr 0x22dfeb8, size 0x6c, virtual true, abstract: false, final false
inline void ProcessLength(int64_t  bitLength) ;

/// @brief Method ProcessWord, addr 0x22dfdfc, size 0xbc, virtual true, abstract: false, final false
inline void ProcessWord(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff) ;

/// @brief Method RL, addr 0x22e00d0, size 0xc, virtual false, abstract: false, final false
inline int32_t RL(int32_t  x, int32_t  n) ;

/// @brief Method Reset, addr 0x22e0064, size 0x6c, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x22e120c, size 0x84, virtual true, abstract: false, final false
inline void Reset(::Org::BouncyCastle::Utilities::IMemoable*  other) ;

/// @brief Method UnpackWord, addr 0x22dff24, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22dfcb8, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x22dfd24, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Digests::RipeMD256Digest*  t) ;

/// @brief Method get_AlgorithmName, addr 0x22dfc70, size 0x40, virtual true, abstract: false, final false
