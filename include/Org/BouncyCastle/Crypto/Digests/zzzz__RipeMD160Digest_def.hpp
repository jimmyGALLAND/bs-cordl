...
/// @brief Method Copy, addr 0x2654724, size 0x58, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method CopyIn, addr 0x2652bf8, size 0x64, virtual false, abstract: false, final false
inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::RipeMD160Digest*  t) ;

/// @brief Method DoFinal, addr 0x2652e4c, size 0x90, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method F1, addr 0x2652f54, size 0xc, virtual false, abstract: false, final false
inline int32_t F1(int32_t  x, int32_t  y, int32_t  z) ;

/// @brief Method F2, addr 0x2652f60, size 0x10, virtual false, abstract: false, final false
inline int32_t F2(int32_t  x, int32_t  y, int32_t  z) ;

/// @brief Method F3, addr 0x2652f70, size 0xc, virtual false, abstract: false, final false
inline int32_t F3(int32_t  x, int32_t  y, int32_t  z) ;

/// @brief Method F4, addr 0x2652f7c, size 0x10, virtual false, abstract: false, final false
inline int32_t F4(int32_t  x, int32_t  y, int32_t  z) ;

/// @brief Method F5, addr 0x2652f8c, size 0xc, virtual false, abstract: false, final false
inline int32_t F5(int32_t  x, int32_t  y, int32_t  z) ;

/// @brief Method GetDigestSize, addr 0x2652c9c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ProcessBlock, addr 0x2652f98, size 0x178c, virtual true, abstract: false, final false
inline void ProcessBlock() ;

/// @brief Method ProcessLength, addr 0x2652d60, size 0x6c, virtual true, abstract: false, final false
inline void ProcessLength(int64_t  bitLength) ;

/// @brief Method ProcessWord, addr 0x2652ca4, size 0xbc, virtual true, abstract: false, final false
inline void ProcessWord(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff) ;

/// @brief Method RL, addr 0x2652f48, size 0xc, virtual false, abstract: false, final false
inline int32_t RL(int32_t  x, int32_t  n) ;

/// @brief Method Reset, addr 0x2652edc, size 0x6c, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Reset, addr 0x265477c, size 0x84, virtual true, abstract: false, final false
inline void Reset(::Org::BouncyCastle::Utilities::IMemoable*  other) ;

/// @brief Method UnpackWord, addr 0x2652dcc, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2652b18, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2652b84, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Digests::RipeMD160Digest*  t) ;

/// @brief Method get_AlgorithmName, addr 0x2652c5c, size 0x40, virtual true, abstract: false, final false
