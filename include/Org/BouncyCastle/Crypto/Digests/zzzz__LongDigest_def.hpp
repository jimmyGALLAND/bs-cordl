...
/// @brief Method AdjustByteCounts, addr 0x264e1f8, size 0x24, virtual false, abstract: false, final false
inline void AdjustByteCounts() ;

/// @brief Method BlockUpdate, addr 0x264e080, size 0x110, virtual true, abstract: false, final true
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method Ch, addr 0x264e888, size 0x10, virtual false, abstract: false, final false
static inline uint64_t Ch(uint64_t  x, uint64_t  y, uint64_t  z) ;

/// @brief Method Copy, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method CopyIn, addr 0x264defc, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method Finish, addr 0x264e190, size 0x68, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method GetByteLength, addr 0x264e8bc, size 0x8, virtual true, abstract: false, final true
inline int32_t GetByteLength() ;

/// @brief Method GetDigestSize, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
inline int32_t GetDigestSize() ;

/// @brief Method Maj, addr 0x264e8a8, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method ProcessBlock, addr 0x264e27c, size 0x570, virtual false, abstract: false, final false
inline void ProcessBlock() ;

/// @brief Method ProcessLength, addr 0x264e21c, size 0x60, virtual false, abstract: false, final false
inline void ProcessLength(int64_t  lowW, int64_t  hiW) ;

/// @brief Method ProcessWord, addr 0x264e00c, size 0x74, virtual false, abstract: false, final false
inline void ProcessWord(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff) ;

/// @brief Method Reset, addr 0x264e7ec, size 0x6c, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method Sigma0, addr 0x264e868, size 0x10, virtual false, abstract: false, final false
static inline uint64_t Sigma0(uint64_t  x) ;

/// @brief Method Sigma1, addr 0x264e858, size 0x10, virtual false, abstract: false, final false
static inline uint64_t Sigma1(uint64_t  x) ;

/// @brief Method Sum0, addr 0x264e898, size 0x10, virtual false, abstract: false, final false
static inline uint64_t Sum0(uint64_t  x) ;

/// @brief Method Sum1, addr 0x264e878, size 0x10, virtual false, abstract: false, final false
static inline uint64_t Sum1(uint64_t  x) ;

/// @brief Method Update, addr 0x264df98, size 0x74, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x264ddb0, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x264de50, size 0xac, virtual false, abstract: false, final false
