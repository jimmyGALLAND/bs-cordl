...
/// @brief Method BlockUpdate, addr 0x264efe4, size 0x11c, virtual true, abstract: false, final true
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method Copy, addr 0x264f100, size 0x58, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method CopyIn, addr 0x264eb20, size 0x9c, virtual false, abstract: false, final false
inline void CopyIn(::Org::BouncyCastle::Crypto::Digests::MD2Digest*  t) ;

/// @brief Method DoFinal, addr 0x264ec0c, size 0xb8, virtual true, abstract: false, final true
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GetByteLength, addr 0x264ec04, size 0x8, virtual true, abstract: false, final true
inline int32_t GetByteLength() ;

/// @brief Method GetDigestSize, addr 0x264ebfc, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method ProcessBlock, addr 0x264ede8, size 0x194, virtual false, abstract: false, final false
inline void ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  m) ;

/// @brief Method ProcessChecksum, addr 0x264ecc4, size 0x124, virtual false, abstract: false, final false
inline void ProcessChecksum(::ArrayW<uint8_t,::Array<uint8_t>*>  m) ;

/// @brief Method Reset, addr 0x264e9d8, size 0xb8, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method Reset, addr 0x264f158, size 0x84, virtual true, abstract: false, final true
inline void Reset(::Org::BouncyCastle::Utilities::IMemoable*  other) ;

/// @brief Method Update, addr 0x264ef7c, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x264e958, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x264ea90, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Digests::MD2Digest*  t) ;

static inline ::ArrayW<uint8_t,::Array<uint8_t>*> getStaticF_S() ;

/// @brief Method get_AlgorithmName, addr 0x264ebbc, size 0x40, virtual true, abstract: false, final true
