...
/// @brief Method BlockUpdate, addr 0x26510ec, size 0xc4, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  len) ;

/// @brief Method DoFinal, addr 0x26511b0, size 0xbc, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GetByteLength, addr 0x2651310, size 0xa4, virtual true, abstract: false, final false
inline int32_t GetByteLength() ;

/// @brief Method GetDigestSize, addr 0x2650f9c, size 0xa4, virtual true, abstract: false, final false
inline int32_t GetDigestSize() ;

static inline ::Org::BouncyCastle::Crypto::Digests::NonMemoableDigest* New_ctor(::Org::BouncyCastle::Crypto::IDigest*  baseDigest) ;

/// @brief Method Reset, addr 0x265126c, size 0xa4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Update, addr 0x2651040, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2650e88, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IDigest*  baseDigest) ;

/// @brief Method get_AlgorithmName, addr 0x2650efc, size 0xa0, virtual true, abstract: false, final false
