...
/// @brief Method BlockUpdate, addr 0x22e75a0, size 0x18, virtual true, abstract: false, final true
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  inBytes, int32_t  inOff, int32_t  len) ;

/// @brief Method Copy, addr 0x22e71c0, size 0x58, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Utilities::IMemoable* Copy() ;

/// @brief Method DoFinal, addr 0x22e7604, size 0x18, virtual true, abstract: false, final true
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff) ;

/// @brief Method GetByteLength, addr 0x22e741c, size 0x2c, virtual true, abstract: false, final true
inline int32_t GetByteLength() ;

/// @brief Method GetDigestSize, addr 0x22e7400, size 0x1c, virtual true, abstract: false, final true
inline int32_t GetDigestSize() ;

/// @brief Method Init, addr 0x22e6f30, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x22e74fc, size 0x18, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method Reset, addr 0x22e7014, size 0x8c, virtual true, abstract: false, final true
inline void Reset(::Org::BouncyCastle::Utilities::IMemoable*  other) ;

/// @brief Method Update, addr 0x22e7554, size 0x18, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x22e6f48, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Digests::SkeinDigest*  digest) ;

/// @brief Method .ctor, addr 0x22e6d24, size 0x88, virtual false, abstract: false, final false
inline void _ctor(int32_t  stateSizeBits, int32_t  digestSizeBits) ;

/// @brief Method get_AlgorithmName, addr 0x22e7218, size 0x1c4, virtual true, abstract: false, final true
