...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Crypto::IEntropySource* (::Org::BouncyCastle::Crypto::IEntropySourceProvider::*)(int32_t)>(&::Org::BouncyCastle::Crypto::IEntropySourceProvider::Get)> {
