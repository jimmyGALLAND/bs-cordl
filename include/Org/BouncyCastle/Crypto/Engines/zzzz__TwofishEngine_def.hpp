...
/// @brief Method Bits32ToBytes, addr 0x23320f8, size 0x80, virtual false, abstract: false, final false
inline void Bits32ToBytes(int32_t  inData, ::ArrayW<uint8_t,::Array<uint8_t>*>  b, int32_t  offset) ;

/// @brief Method BytesTo32Bits, addr 0x23319f8, size 0x70, virtual false, abstract: false, final false
inline int32_t BytesTo32Bits(::ArrayW<uint8_t,::Array<uint8_t>*>  b, int32_t  p) ;

/// @brief Method DecryptBlock, addr 0x2331770, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method EncryptBlock, addr 0x2331500, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method F32, addr 0x2331b08, size 0x4b0, virtual false, abstract: false, final false
inline int32_t F32(int32_t  x, ::ArrayW<int32_t,::Array<int32_t>*>  k32) ;

/// @brief Method Fe32_0, addr 0x2331fd8, size 0x8c, virtual false, abstract: false, final false
inline int32_t Fe32_0(int32_t  x) ;

/// @brief Method Fe32_3, addr 0x2332064, size 0x94, virtual false, abstract: false, final false
inline int32_t Fe32_3(int32_t  x) ;

/// @brief Method GetBlockSize, addr 0x23319f0, size 0x8, virtual true, abstract: false, final true
inline int32_t GetBlockSize() ;

/// @brief Method Init, addr 0x2330a44, size 0x15c, virtual true, abstract: false, final true
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method LFSR1, addr 0x23321b8, size 0x14, virtual false, abstract: false, final false
inline int32_t LFSR1(int32_t  x) ;

/// @brief Method LFSR2, addr 0x23321cc, size 0x24, virtual false, abstract: false, final false
inline int32_t LFSR2(int32_t  x) ;

/// @brief Method M_b0, addr 0x2331fb8, size 0x8, virtual false, abstract: false, final false
inline int32_t M_b0(int32_t  x) ;

/// @brief Method M_b1, addr 0x2331fc0, size 0x8, virtual false, abstract: false, final false
inline int32_t M_b1(int32_t  x) ;

/// @brief Method M_b2, addr 0x2331fc8, size 0x8, virtual false, abstract: false, final false
inline int32_t M_b2(int32_t  x) ;

/// @brief Method M_b3, addr 0x2331fd0, size 0x8, virtual false, abstract: false, final false
inline int32_t M_b3(int32_t  x) ;

/// @brief Method Mx_X, addr 0x23309e8, size 0x28, virtual false, abstract: false, final false
inline int32_t Mx_X(int32_t  x) ;

/// @brief Method Mx_Y, addr 0x2330a10, size 0x34, virtual false, abstract: false, final false
inline int32_t Mx_Y(int32_t  x) ;

static inline ::Org::BouncyCastle::Crypto::Engines::TwofishEngine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x23313cc, size 0x134, virtual true, abstract: false, final true
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method RS_MDS_Encode, addr 0x2331a68, size 0xa0, virtual false, abstract: false, final false
inline int32_t RS_MDS_Encode(int32_t  k0, int32_t  k1) ;

/// @brief Method RS_rem, addr 0x2332178, size 0x40, virtual false, abstract: false, final false
inline int32_t RS_rem(int32_t  x) ;

/// @brief Method Reset, addr 0x23319e0, size 0x10, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method SetKey, addr 0x2330ba0, size 0x7e4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23306f8, size 0x2f0, virtual false, abstract: false, final false
inline void _ctor() ;

static inline Il2CppObject* getStaticF_P() ;

/// @brief Method get_AlgorithmName, addr 0x2331384, size 0x40, virtual true, abstract: false, final true
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x23313c4, size 0x8, virtual true, abstract: false, final true
