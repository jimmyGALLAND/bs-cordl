...
/// @brief Method GetByte, addr 0x2312a0c, size 0x60, virtual false, abstract: false, final false
inline uint8_t GetByte() ;

/// @brief Method Init, addr 0x23124a0, size 0x35c, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method Init, addr 0x231283c, size 0x1d0, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::HC256Engine* New_ctor() ;

/// @brief Method ProcessBytes, addr 0x2312a6c, size 0x194, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x2312c00, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ReturnByte, addr 0x2312c04, size 0x18, virtual true, abstract: false, final false
inline uint8_t ReturnByte(uint8_t  input) ;

/// @brief Method RotateRight, addr 0x2312498, size 0x8, virtual false, abstract: false, final false
static inline uint32_t RotateRight(uint32_t  x, int32_t  bits) ;

/// @brief Method Step, addr 0x2312224, size 0x274, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2312c1c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AlgorithmName, addr 0x23127fc, size 0x40, virtual true, abstract: false, final false
