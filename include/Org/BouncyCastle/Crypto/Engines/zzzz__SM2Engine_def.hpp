...
/// @brief Method AddFieldElement, addr 0x2327708, size 0xd4, virtual false, abstract: false, final false
inline void AddFieldElement(::Org::BouncyCastle::Crypto::IDigest*  digest, ::Org::BouncyCastle::Math::EC::ECFieldElement*  v) ;

/// @brief Method CreateBasePointMultiplier, addr 0x2327190, size 0x54, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateBasePointMultiplier() ;

/// @brief Method Decrypt, addr 0x2326d20, size 0x470, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Decrypt(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  inLen) ;

/// @brief Method Encrypt, addr 0x2326980, size 0x3a0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Encrypt(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  inLen) ;

/// @brief Method Init, addr 0x2326704, size 0x26c, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  param) ;

/// @brief Method Kdf, addr 0x23272a8, size 0x3f4, virtual false, abstract: false, final false
...
/// @brief Method NextK, addr 0x23271e4, size 0xc4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* NextK() ;

/// @brief Method NotEncrypted, addr 0x232769c, size 0x6c, virtual false, abstract: false, final false
inline bool NotEncrypted(::ArrayW<uint8_t,::Array<uint8_t>*>  encData, ::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff) ;

/// @brief Method ProcessBlock, addr 0x2326970, size 0x10, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  inLen) ;

/// @brief Method Xor, addr 0x23277dc, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2326678, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x23266dc, size 0x28, virtual false, abstract: false, final false
