...
/// @brief Method F, addr 0x2320a4c, size 0x64, virtual false, abstract: false, final false
inline int64_t F(int32_t  ki0, int32_t  ki1, int64_t  r) ;

/// @brief Method G, addr 0x2320b18, size 0xec, virtual false, abstract: false, final false
inline int32_t G(int32_t  x) ;

/// @brief Method GetBlockSize, addr 0x23207fc, size 0x8, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method Init, addr 0x2320580, size 0xb0, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::SeedEngine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x2320804, size 0x1ec, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x2320b04, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x2320e08, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method bytesToLong, addr 0x23209f0, size 0x5c, virtual false, abstract: false, final false
inline int64_t bytesToLong(::ArrayW<uint8_t,::Array<uint8_t>*>  src, int32_t  srcOff) ;

/// @brief Method createWorkingKey, addr 0x2320630, size 0x184, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> createWorkingKey(::ArrayW<uint8_t,::Array<uint8_t>*>  inKey) ;

/// @brief Method extractW0, addr 0x2320b08, size 0x8, virtual false, abstract: false, final false
inline int32_t extractW0(int64_t  lVal) ;

/// @brief Method extractW1, addr 0x2320b10, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x23207b4, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x23207f4, size 0x8, virtual true, abstract: false, final false
inline bool get_IsPartialBlockOkay() ;

/// @brief Convert to "::Org::BouncyCastle::Crypto::IBlockCipher"
constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* i___Org__BouncyCastle__Crypto__IBlockCipher() noexcept;

/// @brief Method longToBytes, addr 0x2320ab0, size 0x54, virtual false, abstract: false, final false
inline void longToBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  dest, int32_t  destOff, int64_t  value) ;

/// @brief Method phaseCalc1, addr 0x2320c54, size 0x20, virtual false, abstract: false, final false
inline int32_t phaseCalc1(int32_t  r0, int32_t  ki0, int32_t  r1, int32_t  ki1) ;

/// @brief Method phaseCalc2, addr 0x2320c14, size 0x40, virtual false, abstract: false, final false
inline int32_t phaseCalc2(int32_t  r0, int32_t  ki0, int32_t  r1, int32_t  ki1) ;

/// @brief Method rotateLeft8, addr 0x2320c0c, size 0x8, virtual false, abstract: false, final false
inline int64_t rotateLeft8(int64_t  x) ;

/// @brief Method rotateRight8, addr 0x2320c04, size 0x8, virtual false, abstract: false, final false
