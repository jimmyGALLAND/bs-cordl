...
/// @brief Method DesFunc, addr 0x230a504, size 0x434, virtual false, abstract: false, final false
...
/// @brief Method GenerateWorkingKey, addr 0x2309e2c, size 0x550, virtual false, abstract: false, final false
static inline ::ArrayW<int32_t,::Array<int32_t>*> GenerateWorkingKey(bool  encrypting, ::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method GetBlockSize, addr 0x230a3c4, size 0x8, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method GetWorkingKey, addr 0x2309ce8, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> GetWorkingKey() ;

/// @brief Method Init, addr 0x2309cf0, size 0x13c, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::DesEngine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x230a3cc, size 0x138, virtual true, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x230a938, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x230acf4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AlgorithmName, addr 0x230a37c, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x230a3bc, size 0x8, virtual true, abstract: false, final false
