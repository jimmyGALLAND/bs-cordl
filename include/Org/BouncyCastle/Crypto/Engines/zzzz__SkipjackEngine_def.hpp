...
/// @brief Method DecryptBlock, addr 0x232637c, size 0x260, virtual true, abstract: false, final false
...
/// @brief Method EncryptBlock, addr 0x2325fd4, size 0x24c, virtual true, abstract: false, final false
...
/// @brief Method G, addr 0x2325e78, size 0x15c, virtual false, abstract: false, final false
inline int32_t G(int32_t  k, int32_t  w) ;

/// @brief Method GetBlockSize, addr 0x2325d3c, size 0x8, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method H, addr 0x2326220, size 0x15c, virtual false, abstract: false, final false
inline int32_t H(int32_t  k, int32_t  w) ;

/// @brief Method Init, addr 0x23259f8, size 0x2fc, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::SkipjackEngine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x2325d44, size 0x130, virtual true, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x2325e74, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x2326670, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::ArrayW<int16_t,::Array<int16_t>*> getStaticF_ftable() ;

/// @brief Method get_AlgorithmName, addr 0x2325cf4, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x2325d34, size 0x8, virtual true, abstract: false, final false
