...
/// @brief Method AddCryptedBlocks, addr 0x2316b6c, size 0x1fc, virtual true, abstract: false, final false
...
/// @brief Method Encrypt, addr 0x2316a94, size 0xd8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Encrypt(::Org::BouncyCastle::Math::BigInteger*  plain) ;

/// @brief Method GetInputBlockSize, addr 0x2315d24, size 0x54, virtual true, abstract: false, final false
inline int32_t GetInputBlockSize() ;

/// @brief Method GetOutputBlockSize, addr 0x2315d78, size 0x54, virtual true, abstract: false, final false
inline int32_t GetOutputBlockSize() ;

/// @brief Method Init, addr 0x23157b4, size 0x56c, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::NaccacheSternEngine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x2315dcc, size 0x8e4, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  inBytes, int32_t  inOff, int32_t  length) ;

/// @brief Method ProcessData, addr 0x2316d68, size 0x210, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2316f78, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method chineseRemainder, addr 0x23166b0, size 0x3e4, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x2315774, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method set_Debug, addr 0x2315d20, size 0x4, virtual true, abstract: false, final false
