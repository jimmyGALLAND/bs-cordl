...
/// @brief Method Init, addr 0x230e860, size 0x118, virtual true, abstract: false, final true
...
/// @brief Method Unwrap, addr 0x230f124, size 0x890, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method Wrap, addr 0x230e978, size 0x7ac, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x230e798, size 0x88, virtual false, abstract: false, final false
inline void _ctor(int32_t  blockSizeBits) ;

/// @brief Method get_AlgorithmName, addr 0x230e820, size 0x40, virtual true, abstract: false, final true
