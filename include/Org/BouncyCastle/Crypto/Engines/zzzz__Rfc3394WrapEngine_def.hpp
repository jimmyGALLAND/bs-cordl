...
/// @brief Method Init, addr 0x22fc5d4, size 0x210, virtual true, abstract: false, final false
...
/// @brief Method Unwrap, addr 0x22fcc3c, size 0x430, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  inLen) ;

/// @brief Method Wrap, addr 0x22fc884, size 0x3b8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22fc544, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  engine) ;

/// @brief Method get_AlgorithmName, addr 0x22fc7e4, size 0xa0, virtual true, abstract: false, final false
