...
/// @brief Method Bits32ToInts, addr 0x2305c18, size 0x78, virtual false, abstract: false, final false
static inline void Bits32ToInts(uint32_t  inData, ::ArrayW<int32_t,::Array<int32_t>*>  b, int32_t  offset) ;

/// @brief Method CAST_Decipher, addr 0x23060a4, size 0x204, virtual false, abstract: false, final false
inline void CAST_Decipher(uint32_t  L16, uint32_t  R16, ::ArrayW<uint32_t,::Array<uint32_t>*>  result) ;

/// @brief Method CAST_Encipher, addr 0x2305d8c, size 0x21c, virtual false, abstract: false, final false
inline void CAST_Encipher(uint32_t  L0, uint32_t  R0, ::ArrayW<uint32_t,::Array<uint32_t>*>  result) ;

/// @brief Method DecryptBlock, addr 0x2305fa8, size 0xfc, virtual true, abstract: false, final false
...
/// @brief Method EncryptBlock, addr 0x2305c90, size 0xfc, virtual true, abstract: false, final false
...
/// @brief Method F1, addr 0x23062a8, size 0x108, virtual false, abstract: false, final false
static inline uint32_t F1(uint32_t  D, uint32_t  Kmi, int32_t  Kri) ;

/// @brief Method F2, addr 0x23063b0, size 0x108, virtual false, abstract: false, final false
static inline uint32_t F2(uint32_t  D, uint32_t  Kmi, int32_t  Kri) ;

/// @brief Method F3, addr 0x23064b8, size 0x108, virtual false, abstract: false, final false
static inline uint32_t F3(uint32_t  D, uint32_t  Kmi, int32_t  Kri) ;

/// @brief Method GetBlockSize, addr 0x2302964, size 0x8, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method Init, addr 0x230263c, size 0x178, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method IntsTo32bits, addr 0x2305ba0, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method ProcessBlock, addr 0x23027fc, size 0x164, virtual true, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x2302960, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method SetKey, addr 0x230296c, size 0x3234, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2302584, size 0xb8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AlgorithmName, addr 0x23027b4, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x23027f4, size 0x8, virtual true, abstract: false, final false
