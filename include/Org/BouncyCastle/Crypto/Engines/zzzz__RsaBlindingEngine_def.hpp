...
/// @brief Method BlindMessage, addr 0x231fae8, size 0x64, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* BlindMessage(::Org::BouncyCastle::Math::BigInteger*  msg) ;

/// @brief Method GetInputBlockSize, addr 0x231f84c, size 0xa4, virtual true, abstract: false, final false
inline int32_t GetInputBlockSize() ;

/// @brief Method GetOutputBlockSize, addr 0x231f8f0, size 0xa4, virtual true, abstract: false, final false
inline int32_t GetOutputBlockSize() ;

/// @brief Method Init, addr 0x231f6d8, size 0x174, virtual true, abstract: false, final false
...
/// @brief Method ProcessBlock, addr 0x231f994, size 0x154, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  inBuf, int32_t  inOff, int32_t  inLen) ;

/// @brief Method UnblindMessage, addr 0x231fb4c, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x231f60c, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x231f670, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IRsa*  rsa) ;

/// @brief Method get_AlgorithmName, addr 0x231f698, size 0x40, virtual true, abstract: false, final false
