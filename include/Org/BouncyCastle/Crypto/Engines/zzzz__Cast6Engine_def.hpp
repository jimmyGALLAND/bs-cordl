...
/// @brief Method CAST_Decipher, addr 0x2307920, size 0x348, virtual false, abstract: false, final false
inline void CAST_Decipher(uint32_t  A, uint32_t  B, uint32_t  C, uint32_t  D, ::ArrayW<uint32_t,::Array<uint32_t>*>  result) ;

/// @brief Method CAST_Encipher, addr 0x2307468, size 0x344, virtual false, abstract: false, final false
inline void CAST_Encipher(uint32_t  A, uint32_t  B, uint32_t  C, uint32_t  D, ::ArrayW<uint32_t,::Array<uint32_t>*>  result) ;

/// @brief Method DecryptBlock, addr 0x23077ac, size 0x174, virtual true, abstract: false, final false
...
/// @brief Method EncryptBlock, addr 0x23072f4, size 0x174, virtual true, abstract: false, final false
...
/// @brief Method GetBlockSize, addr 0x2306934, size 0x8, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

static inline ::Org::BouncyCastle::Crypto::Engines::Cast6Engine* New_ctor() ;

/// @brief Method Reset, addr 0x2306930, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method SetKey, addr 0x230693c, size 0x9b8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x230681c, size 0xd4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AlgorithmName, addr 0x23068f0, size 0x40, virtual true, abstract: false, final false
