...
/// @brief Method ApplyS, addr 0x231d1dc, size 0x68, virtual false, abstract: false, final false
inline int64_t ApplyS(int64_t  r, ::ArrayW<uint8_t,::Array<uint8_t>*>  box) ;

/// @brief Method DecryptBlock, addr 0x231e708, size 0x12c, virtual false, abstract: false, final false
inline void DecryptBlock(::ArrayW<::ArrayW<int64_t,::Array<int64_t>*>,::Array<::ArrayW<int64_t,::Array<int64_t>*>>*>  rk) ;

/// @brief Method EncryptBlock, addr 0x231e60c, size 0xfc, virtual false, abstract: false, final false
inline void EncryptBlock(::ArrayW<::ArrayW<int64_t,::Array<int64_t>*>,::Array<::ArrayW<int64_t,::Array<int64_t>*>>*>  rk) ;

/// @brief Method GenerateWorkingKey, addr 0x231d74c, size 0x788, virtual false, abstract: false, final false
...
/// @brief Method GetBlockSize, addr 0x231e384, size 0x14, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method Init, addr 0x231e1ac, size 0x190, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method InvMixColumn, addr 0x231d434, size 0x318, virtual false, abstract: false, final false
inline void InvMixColumn() ;

/// @brief Method KeyAddition, addr 0x231d078, size 0x78, virtual false, abstract: false, final false
inline void KeyAddition(::ArrayW<int64_t,::Array<int64_t>*>  rk) ;

/// @brief Method MixColumn, addr 0x231d2b0, size 0x184, virtual false, abstract: false, final false
inline void MixColumn() ;

/// @brief Method Mul0x2, addr 0x231ccf8, size 0xa8, virtual false, abstract: false, final false
inline uint8_t Mul0x2(int32_t  b) ;

/// @brief Method Mul0x3, addr 0x231cda0, size 0xa8, virtual false, abstract: false, final false
inline uint8_t Mul0x3(int32_t  b) ;

/// @brief Method Mul0x9, addr 0x231ce48, size 0x8c, virtual false, abstract: false, final false
inline uint8_t Mul0x9(int32_t  b) ;

/// @brief Method Mul0xb, addr 0x231ced4, size 0x8c, virtual false, abstract: false, final false
inline uint8_t Mul0xb(int32_t  b) ;

/// @brief Method Mul0xd, addr 0x231cf60, size 0x8c, virtual false, abstract: false, final false
inline uint8_t Mul0xd(int32_t  b) ;

/// @brief Method Mul0xe, addr 0x231cfec, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method PackBlock, addr 0x231e834, size 0xc0, virtual false, abstract: false, final false
inline void PackBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  off) ;

/// @brief Method ProcessBlock, addr 0x231e398, size 0x158, virtual true, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x231e8f4, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Shift, addr 0x231d0f0, size 0x2c, virtual false, abstract: false, final false
inline int64_t Shift(int64_t  r, int32_t  shift) ;

/// @brief Method ShiftRow, addr 0x231d11c, size 0xc0, virtual false, abstract: false, final false
inline void ShiftRow(::ArrayW<uint8_t,::Array<uint8_t>*>  shiftsSC) ;

/// @brief Method Substitution, addr 0x231d244, size 0x6c, virtual false, abstract: false, final false
inline void Substitution(::ArrayW<uint8_t,::Array<uint8_t>*>  box) ;

/// @brief Method UnPackBlock, addr 0x231e4f0, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x231ded4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x231dedc, size 0x2d0, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x231e33c, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x231e37c, size 0x8, virtual true, abstract: false, final false
