...
/// @brief Method DecryptBlock, addr 0x22fd918, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method EncryptBlock, addr 0x22fd774, size 0x1a4, virtual false, abstract: false, final false
...
/// @brief Method F, addr 0x22fdab0, size 0xa0, virtual false, abstract: false, final false
inline uint32_t F(uint32_t  x) ;

/// @brief Method GetBlockSize, addr 0x22fdaa8, size 0x8, virtual true, abstract: false, final true
inline int32_t GetBlockSize() ;

/// @brief Method Init, addr 0x22fd1b4, size 0x13c, virtual true, abstract: false, final true
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::BlowfishEngine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x22fd640, size 0x134, virtual true, abstract: false, final true
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method ProcessTable, addr 0x22fdb50, size 0x1a8, virtual false, abstract: false, final false
inline void ProcessTable(uint32_t  xl, uint32_t  xr, ::ArrayW<uint32_t,::Array<uint32_t>*>  table) ;

/// @brief Method Reset, addr 0x22fdaa4, size 0x4, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method SetKey, addr 0x22fd2f0, size 0x308, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22fd0cc, size 0xe8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AlgorithmName, addr 0x22fd5f8, size 0x40, virtual true, abstract: false, final true
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x22fd638, size 0x8, virtual true, abstract: false, final true
