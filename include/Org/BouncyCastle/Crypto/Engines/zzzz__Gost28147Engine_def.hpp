...
/// @brief Method AddSBox, addr 0x231060c, size 0x11c, virtual false, abstract: false, final false
static inline void AddSBox(::StringW  sBoxName, ::ArrayW<uint8_t,::Array<uint8_t>*>  sBox) ;

/// @brief Method GetBlockSize, addr 0x2310b64, size 0x8, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method GetSBox, addr 0x23110a8, size 0x1bc, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSBox(::StringW  sBoxName) ;

/// @brief Method GetSBoxName, addr 0x2311264, size 0x560, virtual false, abstract: false, final false
static inline ::StringW GetSBoxName(::ArrayW<uint8_t,::Array<uint8_t>*>  sBox) ;

/// @brief Method Gost28147Func, addr 0x2310c80, size 0x248, virtual false, abstract: false, final false
...
/// @brief Method Gost28147_mainStep, addr 0x2310f40, size 0xe8, virtual false, abstract: false, final false
inline int32_t Gost28147_mainStep(int32_t  n1, int32_t  key) ;

/// @brief Method Init, addr 0x2310794, size 0x258, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::Gost28147Engine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x2310b6c, size 0x114, virtual true, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x2310ec8, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x2310728, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method bytesToint, addr 0x2310ecc, size 0x74, virtual false, abstract: false, final false
static inline int32_t bytesToint(::ArrayW<uint8_t,::Array<uint8_t>*>  inBytes, int32_t  inOff) ;

/// @brief Method generateWorkingKey, addr 0x23109ec, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x2310b1c, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x2310b5c, size 0x8, virtual true, abstract: false, final false
inline bool get_IsPartialBlockOkay() ;

/// @brief Convert to "::Org::BouncyCastle::Crypto::IBlockCipher"
constexpr ::Org::BouncyCastle::Crypto::IBlockCipher* i___Org__BouncyCastle__Crypto__IBlockCipher() noexcept;

/// @brief Method intTobytes, addr 0x2311028, size 0x80, virtual false, abstract: false, final false
