...
/// @brief Method CalculateCmsKeyChecksum, addr 0x2319310, size 0x180, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> CalculateCmsKeyChecksum(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method CheckCmsKeyChecksum, addr 0x2319a34, size 0x80, virtual false, abstract: false, final false
inline bool CheckCmsKeyChecksum(::ArrayW<uint8_t,::Array<uint8_t>*>  key, ::ArrayW<uint8_t,::Array<uint8_t>*>  checksum) ;

/// @brief Method Init, addr 0x2318bbc, size 0x2a8, virtual true, abstract: false, final false
...
/// @brief Method Unwrap, addr 0x2319490, size 0x5a4, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method Wrap, addr 0x2318ea4, size 0x46c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2319b48, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::ArrayW<uint8_t,::Array<uint8_t>*> getStaticF_IV2() ;

/// @brief Method get_AlgorithmName, addr 0x2318e64, size 0x40, virtual true, abstract: false, final false
