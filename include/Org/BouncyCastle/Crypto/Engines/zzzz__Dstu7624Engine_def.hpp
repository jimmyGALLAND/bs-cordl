...
/// @brief Field roundKeys, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_roundKeys, put=__cordl_internal_set_roundKeys)) ::ArrayW<::ArrayW<uint64_t,::Array<uint64_t>*>,::Array<::ArrayW<uint64_t,::Array<uint64_t>*>>*>  roundKeys;
...
/// @brief Method AddRoundKey, addr 0x230d3dc, size 0x88, virtual false, abstract: false, final false
inline void AddRoundKey(int32_t  round) ;

/// @brief Method DecryptBlock_128, addr 0x230d4ec, size 0x360, virtual false, abstract: false, final false
...
/// @brief Method DecryptionRound, addr 0x230d8d4, size 0x20, virtual false, abstract: false, final false
inline void DecryptionRound() ;

/// @brief Method EncryptBlock_128, addr 0x230d07c, size 0x360, virtual false, abstract: false, final false
...
/// @brief Method EncryptionRound, addr 0x230cc0c, size 0x20, virtual false, abstract: false, final false
inline void EncryptionRound() ;

/// @brief Method GetBlockSize, addr 0x230e510, size 0xc, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method Init, addr 0x230c1b4, size 0x2e4, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method InvShiftRows, addr 0x230de74, size 0x250, virtual false, abstract: false, final false
inline void InvShiftRows() ;

/// @brief Method InvSubBytes, addr 0x230e0c4, size 0x1b8, virtual false, abstract: false, final false
inline void InvSubBytes() ;

/// @brief Method MixColumn, addr 0x230e3cc, size 0xb0, virtual false, abstract: false, final false
static inline uint64_t MixColumn(uint64_t  c) ;

/// @brief Method MixColumnInv, addr 0x230e27c, size 0x150, virtual false, abstract: false, final false
static inline uint64_t MixColumnInv(uint64_t  c) ;

/// @brief Method MixColumns, addr 0x230dcfc, size 0xbc, virtual false, abstract: false, final false
inline void MixColumns() ;

/// @brief Method MixColumnsInv, addr 0x230ddb8, size 0xbc, virtual false, abstract: false, final false
inline void MixColumnsInv() ;

/// @brief Method MulX, addr 0x230e47c, size 0x20, virtual false, abstract: false, final false
static inline uint64_t MulX(uint64_t  n) ;

/// @brief Method MulX2, addr 0x230e4a4, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method ProcessBlock, addr 0x230ce34, size 0x248, virtual true, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x230e524, size 0x24, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Rotate, addr 0x230e49c, size 0x8, virtual false, abstract: false, final false
static inline uint64_t Rotate(int32_t  n, uint64_t  x) ;

/// @brief Method RotateLeft, addr 0x230cc2c, size 0x208, virtual false, abstract: false, final false
inline void RotateLeft(::ArrayW<uint64_t,::Array<uint64_t>*>  x, ::ArrayW<uint64_t,::Array<uint64_t>*>  z) ;

/// @brief Method ShiftRows, addr 0x230daac, size 0x250, virtual false, abstract: false, final false
inline void ShiftRows() ;

/// @brief Method SubBytes, addr 0x230d8f4, size 0x1b8, virtual false, abstract: false, final false
inline void SubBytes() ;

/// @brief Method SubRoundKey, addr 0x230d84c, size 0x88, virtual false, abstract: false, final false
inline void SubRoundKey(int32_t  round) ;

/// @brief Method WorkingKeyExpandEven, addr 0x230c708, size 0x490, virtual false, abstract: false, final false
inline void WorkingKeyExpandEven(::ArrayW<uint64_t,::Array<uint64_t>*>  workingKey, ::ArrayW<uint64_t,::Array<uint64_t>*>  tempKey) ;

/// @brief Method WorkingKeyExpandKT, addr 0x230c498, size 0x270, virtual false, abstract: false, final false
inline void WorkingKeyExpandKT(::ArrayW<uint64_t,::Array<uint64_t>*>  workingKey, ::ArrayW<uint64_t,::Array<uint64_t>*>  tempKeys) ;

/// @brief Method WorkingKeyExpandOdd, addr 0x230cb98, size 0x74, virtual false, abstract: false, final false
inline void WorkingKeyExpandOdd() ;

/// @brief Method XorRoundKey, addr 0x230d464, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x230c0f0, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x230e4d0, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x230e51c, size 0x8, virtual true, abstract: false, final false
