...
/// @brief Method BytesToWord, addr 0x231a8f4, size 0x70, virtual false, abstract: false, final false
inline int32_t BytesToWord(::ArrayW<uint8_t,::Array<uint8_t>*>  src, int32_t  srcOff) ;

/// @brief Method DecryptBlock, addr 0x231a6c8, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method EncryptBlock, addr 0x231a7d4, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method GetBlockSize, addr 0x231a228, size 0x8, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method Init, addr 0x231a230, size 0x22c, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::RC532Engine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x231a6a4, size 0x24, virtual true, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x231a8e4, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method RotateLeft, addr 0x231a8e8, size 0xc, virtual false, abstract: false, final false
inline int32_t RotateLeft(int32_t  x, int32_t  y) ;

/// @brief Method RotateRight, addr 0x231a9e4, size 0x8, virtual false, abstract: false, final false
inline int32_t RotateRight(int32_t  x, int32_t  y) ;

/// @brief Method SetKey, addr 0x231a45c, size 0x248, virtual false, abstract: false, final false
inline void SetKey(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method WordToBytes, addr 0x231a964, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x231a1c0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AlgorithmName, addr 0x231a1e0, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x231a220, size 0x8, virtual true, abstract: false, final false
