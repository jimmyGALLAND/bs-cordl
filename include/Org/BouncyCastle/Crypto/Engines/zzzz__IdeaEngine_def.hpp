...
/// @brief Method AddInv, addr 0x2313674, size 0x64, virtual false, abstract: false, final false
inline int32_t AddInv(int32_t  x) ;

/// @brief Method BytesToWord, addr 0x23131f0, size 0x40, virtual false, abstract: false, final false
inline int32_t BytesToWord(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff) ;

/// @brief Method ExpandKey, addr 0x231336c, size 0x1f8, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> ExpandKey(::ArrayW<uint8_t,::Array<uint8_t>*>  uKey) ;

/// @brief Method GenerateWorkingKey, addr 0x2312dd8, size 0x28, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> GenerateWorkingKey(bool  forEncryption, ::ArrayW<uint8_t,::Array<uint8_t>*>  userKey) ;

/// @brief Method GetBlockSize, addr 0x2312e48, size 0x8, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method IdeaFunc, addr 0x2312f64, size 0x288, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x2312cc0, size 0x118, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method InvertKey, addr 0x23136d8, size 0x244, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> InvertKey(::ArrayW<int32_t,::Array<int32_t>*>  inKey) ;

/// @brief Method Mul, addr 0x2313278, size 0xf4, virtual false, abstract: false, final false
inline int32_t Mul(int32_t  x, int32_t  y) ;

/// @brief Method MulInv, addr 0x2313564, size 0x110, virtual false, abstract: false, final false
inline int32_t MulInv(int32_t  x) ;

static inline ::Org::BouncyCastle::Crypto::Engines::IdeaEngine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x2312e50, size 0x114, virtual true, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x23131ec, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method WordToBytes, addr 0x2313230, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2312cb8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AlgorithmName, addr 0x2312e00, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x2312e40, size 0x8, virtual true, abstract: false, final false
