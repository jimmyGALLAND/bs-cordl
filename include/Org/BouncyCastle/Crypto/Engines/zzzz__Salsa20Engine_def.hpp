...
/// @brief Method AdvanceCounter, addr 0x23084c4, size 0x4c, virtual true, abstract: false, final false
inline void AdvanceCounter() ;

/// @brief Method GenerateKeyStream, addr 0x2308a08, size 0x84, virtual true, abstract: false, final false
inline void GenerateKeyStream(::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method Init, addr 0x2307ef8, size 0x3a8, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method LimitExceeded, addr 0x2308488, size 0x3c, virtual false, abstract: false, final false
inline bool LimitExceeded() ;

/// @brief Method LimitExceeded, addr 0x2308778, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method PackTauOrSigma, addr 0x2307c68, size 0x134, virtual false, abstract: false, final false
inline void PackTauOrSigma(int32_t  keyLength, ::ArrayW<uint32_t,::Array<uint32_t>*>  state, int32_t  stateOffset) ;

/// @brief Method ProcessBytes, addr 0x2308510, size 0x268, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x23087b4, size 0x1c, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ResetCounter, addr 0x23087dc, size 0x2c, virtual true, abstract: false, final false
inline void ResetCounter() ;

/// @brief Method ResetLimitCounter, addr 0x23087d0, size 0xc, virtual false, abstract: false, final false
inline void ResetLimitCounter() ;

/// @brief Method ReturnByte, addr 0x2308388, size 0x100, virtual true, abstract: false, final false
inline uint8_t ReturnByte(uint8_t  input) ;

/// @brief Method SalsaCore, addr 0x2308a8c, size 0x5e4, virtual false, abstract: false, final false
static inline void SalsaCore(int32_t  rounds, ::ArrayW<uint32_t,::Array<uint32_t>*>  input, ::ArrayW<uint32_t,::Array<uint32_t>*>  x) ;

/// @brief Method SetKey, addr 0x2308808, size 0x200, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2307d9c, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2307dfc, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x23082a8, size 0xe0, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_NonceSize, addr 0x23082a0, size 0x8, virtual true, abstract: false, final false
