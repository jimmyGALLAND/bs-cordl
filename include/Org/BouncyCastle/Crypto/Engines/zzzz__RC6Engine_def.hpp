...
/// @brief Method BytesToWord, addr 0x231c178, size 0xb0, virtual false, abstract: false, final false
inline int32_t BytesToWord(::ArrayW<uint8_t,::Array<uint8_t>*>  src, int32_t  srcOff) ;

/// @brief Method DecryptBlock, addr 0x231bb4c, size 0x2d4, virtual false, abstract: false, final false
...
/// @brief Method EncryptBlock, addr 0x231be20, size 0x2d4, virtual false, abstract: false, final false
...
/// @brief Method GetBlockSize, addr 0x231b5d8, size 0x5c, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method Init, addr 0x231b634, size 0x138, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::RC6Engine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x231ba00, size 0x14c, virtual true, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x231c0f4, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method RotateLeft, addr 0x231c0f8, size 0x80, virtual false, abstract: false, final false
inline int32_t RotateLeft(int32_t  x, int32_t  y) ;

/// @brief Method RotateRight, addr 0x231c2e8, size 0x80, virtual false, abstract: false, final false
inline int32_t RotateRight(int32_t  x, int32_t  y) ;

/// @brief Method SetKey, addr 0x231b76c, size 0x294, virtual false, abstract: false, final false
inline void SetKey(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method WordToBytes, addr 0x231c228, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x231b588, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AlgorithmName, addr 0x231b590, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x231b5d0, size 0x8, virtual true, abstract: false, final false
