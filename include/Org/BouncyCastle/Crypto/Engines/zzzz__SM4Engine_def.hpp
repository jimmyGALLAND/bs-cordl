...
/// @brief Method ExpandKey, addr 0x23279cc, size 0x564, virtual false, abstract: false, final false
inline void ExpandKey(bool  forEncryption, ::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method GetBlockSize, addr 0x2328208, size 0x8, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method Init, addr 0x2328000, size 0x1c0, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method L, addr 0x2327f30, size 0x78, virtual false, abstract: false, final false
static inline uint32_t L(uint32_t  B) ;

/// @brief Method L_ap, addr 0x2327908, size 0x40, virtual false, abstract: false, final false
static inline uint32_t L_ap(uint32_t  B) ;

static inline ::Org::BouncyCastle::Crypto::Engines::SM4Engine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x2328210, size 0x2b0, virtual true, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x23284c0, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method T, addr 0x2327fa8, size 0x58, virtual false, abstract: false, final false
static inline uint32_t T(uint32_t  Z) ;

/// @brief Method T_ap, addr 0x2327948, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23285ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AlgorithmName, addr 0x23281c0, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x2328200, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method tau, addr 0x2327840, size 0xc8, virtual false, abstract: false, final false
