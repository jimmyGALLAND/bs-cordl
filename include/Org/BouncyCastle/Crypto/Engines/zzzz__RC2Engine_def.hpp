...
/// @brief Method DecryptBlock, addr 0x23186b8, size 0x44c, virtual false, abstract: false, final false
...
/// @brief Method EncryptBlock, addr 0x23181e4, size 0x4d4, virtual false, abstract: false, final false
...
/// @brief Method GenerateWorkingKey, addr 0x2317c08, size 0x2e8, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> GenerateWorkingKey(::ArrayW<uint8_t,::Array<uint8_t>*>  key, int32_t  bits) ;

/// @brief Method GetBlockSize, addr 0x23180a8, size 0x8, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method Init, addr 0x2317ef0, size 0x16c, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::RC2Engine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x23180b0, size 0x134, virtual true, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x231805c, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method RotateWordLeft, addr 0x2318b04, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2318bb4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::ArrayW<uint8_t,::Array<uint8_t>*> getStaticF_piTable() ;

/// @brief Method get_AlgorithmName, addr 0x2318060, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x23180a0, size 0x8, virtual true, abstract: false, final false
