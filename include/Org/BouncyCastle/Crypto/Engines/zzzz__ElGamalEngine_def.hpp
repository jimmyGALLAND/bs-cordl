...
/// @brief Method GetInputBlockSize, addr 0x230fc9c, size 0x40, virtual true, abstract: false, final false
inline int32_t GetInputBlockSize() ;

/// @brief Method GetOutputBlockSize, addr 0x230fcdc, size 0x40, virtual true, abstract: false, final false
inline int32_t GetOutputBlockSize() ;

/// @brief Method Init, addr 0x230f9f4, size 0x2a8, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::ElGamalEngine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x230fd1c, size 0x52c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2310248, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AlgorithmName, addr 0x230f9b4, size 0x40, virtual true, abstract: false, final false
