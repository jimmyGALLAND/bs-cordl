...
/// @brief Method Init, addr 0x2319bd4, size 0x100, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::RC4Engine* New_ctor() ;

/// @brief Method ProcessBytes, addr 0x2319f90, size 0x1d4, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x231a164, size 0x8, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ReturnByte, addr 0x2319ebc, size 0xd4, virtual true, abstract: false, final false
inline uint8_t ReturnByte(uint8_t  input) ;

/// @brief Method SetKey, addr 0x2319cd4, size 0x1a8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x231a1b8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline int32_t getStaticF_STATE_LENGTH() ;

/// @brief Method get_AlgorithmName, addr 0x2319e7c, size 0x40, virtual true, abstract: false, final false
