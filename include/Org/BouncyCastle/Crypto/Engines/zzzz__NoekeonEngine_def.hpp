...
/// @brief Method DecryptBlock, addr 0x23173f0, size 0x310, virtual false, abstract: false, final false
...
/// @brief Method EncryptBlock, addr 0x2317700, size 0x2d8, virtual false, abstract: false, final false
...
/// @brief Method GetBlockSize, addr 0x231702c, size 0x8, virtual true, abstract: false, final false
inline int32_t GetBlockSize() ;

/// @brief Method Init, addr 0x2317034, size 0x264, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::NoekeonEngine* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x2317298, size 0x158, virtual true, abstract: false, final false
inline int32_t ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method Reset, addr 0x23179d8, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x2316f84, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::ArrayW<uint8_t,::Array<uint8_t>*> getStaticF_RoundConstants() ;

/// @brief Method get_AlgorithmName, addr 0x2316fe4, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay, addr 0x2317024, size 0x8, virtual true, abstract: false, final false
