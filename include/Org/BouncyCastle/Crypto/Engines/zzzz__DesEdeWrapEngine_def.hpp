...
/// @brief Method CalculateCmsKeyChecksum, addr 0x230b910, size 0x180, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> CalculateCmsKeyChecksum(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method CheckCmsKeyChecksum, addr 0x230bf50, size 0x80, virtual false, abstract: false, final false
inline bool CheckCmsKeyChecksum(::ArrayW<uint8_t,::Array<uint8_t>*>  key, ::ArrayW<uint8_t,::Array<uint8_t>*>  checksum) ;

/// @brief Method Init, addr 0x230b220, size 0x384, virtual true, abstract: false, final false
...
/// @brief Method Unwrap, addr 0x230bb3c, size 0x414, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Unwrap(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method Wrap, addr 0x230b5e4, size 0x32c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x230c064, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::ArrayW<uint8_t,::Array<uint8_t>*> getStaticF_IV2() ;

/// @brief Method get_AlgorithmName, addr 0x230b5a4, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method reverse, addr 0x230ba90, size 0xac, virtual false, abstract: false, final false
