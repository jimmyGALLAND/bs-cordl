...
/// @brief Method AdvanceCounter, addr 0x2309b30, size 0x4c, virtual true, abstract: false, final false
inline void AdvanceCounter() ;

/// @brief Method ChachaCore, addr 0x23093bc, size 0x638, virtual false, abstract: false, final false
static inline void ChachaCore(int32_t  rounds, ::ArrayW<uint32_t,::Array<uint32_t>*>  input, ::ArrayW<uint32_t,::Array<uint32_t>*>  x) ;

/// @brief Method GenerateKeyStream, addr 0x2309cac, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method ResetCounter, addr 0x2309b7c, size 0x2c, virtual true, abstract: false, final false
inline void ResetCounter() ;

/// @brief Method SetKey, addr 0x2309ba8, size 0x104, virtual true, abstract: false, final false
inline void SetKey(::ArrayW<uint8_t,::Array<uint8_t>*>  keyBytes, ::ArrayW<uint8_t,::Array<uint8_t>*>  ivBytes) ;

/// @brief Method .ctor, addr 0x23099f4, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2309a48, size 0x64, virtual false, abstract: false, final false
inline void _ctor(int32_t  rounds) ;

/// @brief Method get_AlgorithmName, addr 0x2309aac, size 0x84, virtual true, abstract: false, final false
