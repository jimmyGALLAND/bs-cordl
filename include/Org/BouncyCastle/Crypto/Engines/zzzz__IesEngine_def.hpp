...
/// @brief Method DecryptBlock, addr 0x2313c2c, size 0x69c, virtual false, abstract: false, final false
...
/// @brief Method EncryptBlock, addr 0x2314420, size 0x5e0, virtual false, abstract: false, final false
...
/// @brief Method GenerateKdfBytes, addr 0x23142c8, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x2313b60, size 0xcc, virtual true, abstract: false, final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  privParameters, ::Org::BouncyCastle::Crypto::ICipherParameters*  pubParameters, ::Org::BouncyCastle::Crypto::ICipherParameters*  iesParameters) ;

static inline ::Org::BouncyCastle::Crypto::Engines::IesEngine* New_ctor(::Org::BouncyCastle::Crypto::IBasicAgreement*  agree, ::Org::BouncyCastle::Crypto::IDerivationFunction*  kdf, ::Org::BouncyCastle::Crypto::IMac*  mac) ;

static inline ::Org::BouncyCastle::Crypto::Engines::IesEngine* New_ctor(::Org::BouncyCastle::Crypto::IBasicAgreement*  agree, ::Org::BouncyCastle::Crypto::IDerivationFunction*  kdf, ::Org::BouncyCastle::Crypto::IMac*  mac, ::Org::BouncyCastle::Crypto::BufferedBlockCipher*  cipher) ;

/// @brief Method ProcessBlock, addr 0x2314a00, size 0x280, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x231396c, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2313a60, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBasicAgreement*  agree, ::Org::BouncyCastle::Crypto::IDerivationFunction*  kdf, ::Org::BouncyCastle::Crypto::IMac*  mac, ::Org::BouncyCastle::Crypto::BufferedBlockCipher*  cipher) ;
