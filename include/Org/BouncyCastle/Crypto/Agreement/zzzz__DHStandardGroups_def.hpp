...
/// @brief Method FromHex, addr 0x2641770, size 0x98, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::BigInteger* FromHex(::StringW  hex) ;

/// @brief Method FromPG, addr 0x2641808, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method SafePrimeGen2, addr 0x26418b4, size 0x58, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* SafePrimeGen2(::StringW  hexP) ;

/// @brief Method SafePrimeGen2, addr 0x264190c, size 0xcc, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Parameters::DHParameters* SafePrimeGen2(::StringW  hexP, int32_t  l) ;

/// @brief Method .ctor, addr 0x2641e6c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
