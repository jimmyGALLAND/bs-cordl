...
/// @brief Method CalculateS, addr 0x26401d0, size 0x5c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* CalculateS() ;

/// @brief Method CalculateSecret, addr 0x264018c, size 0x44, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* CalculateSecret(::Org::BouncyCastle::Math::BigInteger*  clientA) ;

/// @brief Method CalculateServerEvidenceMessage, addr 0x26402e4, size 0x80, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* CalculateServerEvidenceMessage() ;

/// @brief Method CalculateSessionKey, addr 0x2640364, size 0x80, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* CalculateSessionKey() ;

/// @brief Method GenerateServerCredentials, addr 0x26400dc, size 0xb0, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* GenerateServerCredentials() ;

/// @brief Method Init, addr 0x264009c, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method Init, addr 0x26400ac, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method SelectPrivateValue, addr 0x264022c, size 0xc, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* SelectPrivateValue() ;

/// @brief Method VerifyClientEvidenceMessage, addr 0x2640238, size 0xac, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::BigInteger*> const& __cordl_internal_get_privB() const;

constexpr ::Org::BouncyCastle::Math::BigInteger*& __cordl_internal_get_pubB() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::BigInteger*> const& __cordl_internal_get_pubB() const;
...
/// @brief Method .ctor, addr 0x2640094, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
