...
/// @brief Method .ctor, addr 0x263cbc8, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  participantId, ::Org::BouncyCastle::Math::BigInteger*  magTag) ;

/// @brief Method get_MacTag, addr 0x263d718, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_MacTag() ;

/// @brief Method get_ParticipantId, addr 0x263d710, size 0x8, virtual true, abstract: false, final false
