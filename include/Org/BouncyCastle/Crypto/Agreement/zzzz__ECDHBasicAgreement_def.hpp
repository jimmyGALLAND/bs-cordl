...
/// @brief Method CalculateAgreement, addr 0x2641fa8, size 0x260, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters*  pubKey) ;

/// @brief Method GetFieldSize, addr 0x2641f60, size 0x48, virtual true, abstract: false, final false
inline int32_t GetFieldSize() ;

/// @brief Method Init, addr 0x2641e74, size 0xec, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2642208, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
