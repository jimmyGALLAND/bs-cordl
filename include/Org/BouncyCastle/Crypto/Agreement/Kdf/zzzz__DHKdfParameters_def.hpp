...
/// @brief Method GetExtraInfo, addr 0x263e8e0, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetExtraInfo() ;

/// @brief Method GetZ, addr 0x263e8d8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x263e844, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  algorithm, int32_t  keySize, ::ArrayW<uint8_t,::Array<uint8_t>*>  z) ;

/// @brief Method .ctor, addr 0x263e884, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method get_Algorithm, addr 0x263e8c8, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Algorithm() ;

/// @brief Method get_KeySize, addr 0x263e8d0, size 0x8, virtual false, abstract: false, final false
