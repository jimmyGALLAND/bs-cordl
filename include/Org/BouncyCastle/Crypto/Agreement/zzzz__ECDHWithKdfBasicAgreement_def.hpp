...
/// @brief Method BigIntToBytes, addr 0x2642834, size 0x3c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> BigIntToBytes(::Org::BouncyCastle::Math::BigInteger*  r) ;

/// @brief Method CalculateAgreement, addr 0x26425d4, size 0x260, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2642538, size 0x9c, virtual false, abstract: false, final false
