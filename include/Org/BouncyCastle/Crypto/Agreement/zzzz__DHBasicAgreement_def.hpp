...
/// @brief Method CalculateAgreement, addr 0x26414fc, size 0x26c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* CalculateAgreement(::Org::BouncyCastle::Crypto::ICipherParameters*  pubKey) ;

/// @brief Method GetFieldSize, addr 0x26414b8, size 0x44, virtual true, abstract: false, final false
inline int32_t GetFieldSize() ;

/// @brief Method Init, addr 0x2641380, size 0x138, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2641768, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
