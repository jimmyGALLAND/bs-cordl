...
public:
// Declarations
/// @brief Method IsValid, addr 0x23cae8c, size 0x28, virtual false, abstract: false, final false
static inline bool IsValid(int32_t  namedCurve) ;

static inline ::Org::BouncyCastle::Crypto::Tls::NamedCurve* New_ctor() ;

/// @brief Method RefersToASpecificNamedCurve, addr 0x23caeb4, size 0x14, virtual false, abstract: false, final false
static inline bool RefersToASpecificNamedCurve(int32_t  namedCurve) ;

/// @brief Method .ctor, addr 0x23caec8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
