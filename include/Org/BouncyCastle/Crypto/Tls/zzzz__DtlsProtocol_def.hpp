...
/// @brief Method ApplyMaxFragmentLengthExtension, addr 0x23a2674, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method EvaluateMaxFragmentLengthExtension, addr 0x23a2708, size 0xa4, virtual false, abstract: false, final false
static inline int16_t EvaluateMaxFragmentLengthExtension(bool  resumedSession, ::System::Collections::IDictionary*  clientExtensions, ::System::Collections::IDictionary*  serverExtensions, uint8_t  alertDescription) ;

/// @brief Method GenerateCertificate, addr 0x23a27ac, size 0x84, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate*  certificate) ;

/// @brief Method GenerateSupplementalData, addr 0x23a2830, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method ProcessFinished, addr 0x23a2550, size 0x124, virtual true, abstract: false, final false
inline void ProcessFinished(::ArrayW<uint8_t,::Array<uint8_t>*>  body, ::ArrayW<uint8_t,::Array<uint8_t>*>  expected_verify_data) ;

/// @brief Method ValidateSelectedCipherSuite, addr 0x23a28ac, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23a24dc, size 0x74, virtual false, abstract: false, final false
