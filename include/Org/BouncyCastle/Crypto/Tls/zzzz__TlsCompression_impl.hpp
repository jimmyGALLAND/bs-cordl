...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IO::Stream* (::Org::BouncyCastle::Crypto::Tls::TlsCompression::*)(::System::IO::Stream*)>(&::Org::BouncyCastle::Crypto::Tls::TlsCompression::Compress)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IO::Stream* (::Org::BouncyCastle::Crypto::Tls::TlsCompression::*)(::System::IO::Stream*)>(&::Org::BouncyCastle::Crypto::Tls::TlsCompression::Decompress)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
