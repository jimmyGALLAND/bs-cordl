...
/// @brief Method AllocateSequenceNumber, addr 0x23a6f38, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23a6e00, size 0x124, virtual false, abstract: false, final false
inline void _ctor(int32_t  epoch, ::Org::BouncyCastle::Crypto::Tls::TlsCipher*  cipher) ;

/// @brief Method get_Cipher, addr 0x23a7020, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsCipher* get_Cipher() ;

/// @brief Method get_Epoch, addr 0x23a7028, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Epoch() ;

/// @brief Method get_ReplayWindow, addr 0x23a7030, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::DtlsReplayWindow* get_ReplayWindow() ;

/// @brief Method get_SequenceNumber, addr 0x23a7038, size 0x34, virtual false, abstract: false, final false
