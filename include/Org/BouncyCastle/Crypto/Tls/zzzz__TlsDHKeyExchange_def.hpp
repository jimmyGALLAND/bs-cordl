...
/// @brief Method GenerateClientKeyExchange, addr 0x23dd4cc, size 0x100, virtual true, abstract: false, final false
inline void GenerateClientKeyExchange(::System::IO::Stream*  output) ;

/// @brief Method GeneratePremasterSecret, addr 0x23dd7e4, size 0x120, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GeneratePremasterSecret() ;

/// @brief Method GenerateServerKeyExchange, addr 0x23dcd8c, size 0x15c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateServerKeyExchange() ;

/// @brief Method Init, addr 0x23dc8ac, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method ProcessClientCertificate, addr 0x23dd6e8, size 0x50, virtual true, abstract: false, final false
inline void ProcessClientCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate*  clientCertificate) ;

/// @brief Method ProcessClientCredentials, addr 0x23dd3bc, size 0x110, virtual true, abstract: false, final false
inline void ProcessClientCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials*  clientCredentials) ;

/// @brief Method ProcessClientKeyExchange, addr 0x23dd738, size 0xac, virtual true, abstract: false, final false
inline void ProcessClientKeyExchange(::System::IO::Stream*  input) ;

/// @brief Method ProcessServerCertificate, addr 0x23dc9bc, size 0x3a8, virtual true, abstract: false, final false
inline void ProcessServerCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate*  serverCertificate) ;

/// @brief Method ProcessServerKeyExchange, addr 0x23dd02c, size 0x108, virtual true, abstract: false, final false
inline void ProcessServerKeyExchange(::System::IO::Stream*  input) ;

/// @brief Method SkipServerCredentials, addr 0x23dc96c, size 0x50, virtual true, abstract: false, final false
inline void SkipServerCredentials() ;

/// @brief Method ValidateCertificateRequest, addr 0x23dd2ec, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23dc6f4, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23dc778, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method get_RequiresServerKeyExchange, addr 0x23dcd64, size 0x28, virtual true, abstract: false, final false
