...
/// @brief Method ToTruncatedByteArray, addr 0x23cada8, size 0xa8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ToTruncatedByteArray(int32_t  payloadLength) ;

/// @brief Method .ctor, addr 0x23cada0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Encode, addr 0x23ca9f0, size 0x1fc, virtual true, abstract: false, final false
...
/// @brief Method Parse, addr 0x23cabec, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23ca8b8, size 0x124, virtual false, abstract: false, final false
