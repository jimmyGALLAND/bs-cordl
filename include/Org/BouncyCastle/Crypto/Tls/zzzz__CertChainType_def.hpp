...
public:
// Declarations
/// @brief Method IsValid, addr 0x2398200, size 0x10, virtual false, abstract: false, final false
static inline bool IsValid(uint8_t  certChainType) ;

static inline ::Org::BouncyCastle::Crypto::Tls::CertChainType* New_ctor() ;

/// @brief Method .ctor, addr 0x2398210, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
