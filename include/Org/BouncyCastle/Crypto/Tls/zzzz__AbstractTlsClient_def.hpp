...
/// @brief Method AllowUnexpectedServerExtension, addr 0x2394400, size 0xc0, virtual true, abstract: false, final false
inline bool AllowUnexpectedServerExtension(int32_t  extensionType, ::ArrayW<uint8_t,::Array<uint8_t>*>  extensionData) ;

/// @brief Method CheckForUnexpectedServerExtension, addr 0x23944c0, size 0xcc, virtual true, abstract: false, final false
...
/// @brief Method GetCipher, addr 0x2394bdc, size 0x104, virtual true, abstract: false, final false
...
/// @brief Method GetClientExtensions, addr 0x239460c, size 0x25c, virtual true, abstract: false, final false
inline ::System::Collections::IDictionary* GetClientExtensions() ;

/// @brief Method GetClientSupplementalData, addr 0x2394ae8, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::IList* GetClientSupplementalData() ;

/// @brief Method GetCompression, addr 0x2394af0, size 0xec, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsCompression* GetCompression() ;

/// @brief Method GetCompressionMethods, addr 0x2394934, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method GetSessionToResume, addr 0x2394594, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsSession* GetSessionToResume() ;

/// @brief Method Init, addr 0x239458c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method NotifyNewSessionTicket, addr 0x2394ce0, size 0x4, virtual true, abstract: false, final false
inline void NotifyNewSessionTicket(::Org::BouncyCastle::Crypto::Tls::NewSessionTicket*  newSessionTicket) ;

/// @brief Method NotifySelectedCipherSuite, addr 0x239497c, size 0x8, virtual true, abstract: false, final false
inline void NotifySelectedCipherSuite(int32_t  selectedCipherSuite) ;

/// @brief Method NotifySelectedCompressionMethod, addr 0x2394984, size 0xc, virtual true, abstract: false, final false
inline void NotifySelectedCompressionMethod(uint8_t  selectedCompressionMethod) ;

/// @brief Method NotifyServerVersion, addr 0x23948c0, size 0x74, virtual true, abstract: false, final false
inline void NotifyServerVersion(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion*  serverVersion) ;

/// @brief Method NotifySessionID, addr 0x2394978, size 0x4, virtual true, abstract: false, final false
inline void NotifySessionID(::ArrayW<uint8_t,::Array<uint8_t>*>  sessionID) ;

/// @brief Method ProcessServerExtensions, addr 0x2394990, size 0x114, virtual true, abstract: false, final false
inline void ProcessServerExtensions(::System::Collections::IDictionary*  serverExtensions) ;

/// @brief Method ProcessServerSupplementalData, addr 0x2394aa4, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x239436c, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x23943d8, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsCipherFactory*  cipherFactory) ;

/// @brief Method get_ClientHelloRecordLayerVersion, addr 0x239459c, size 0x10, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* get_ClientHelloRecordLayerVersion() ;

/// @brief Method get_ClientVersion, addr 0x23945ac, size 0x58, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* get_ClientVersion() ;

/// @brief Method get_IsFallback, addr 0x2394604, size 0x8, virtual true, abstract: false, final false
inline bool get_IsFallback() ;

/// @brief Method get_MinimumVersion, addr 0x2394868, size 0x58, virtual true, abstract: false, final false
