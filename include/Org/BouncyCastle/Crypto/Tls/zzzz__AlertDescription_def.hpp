...
public:
// Declarations
/// @brief Method GetName, addr 0x2396838, size 0x3f4, virtual false, abstract: false, final false
static inline ::StringW GetName(uint8_t  alertDescription) ;

/// @brief Method GetText, addr 0x2396c2c, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2396da8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
