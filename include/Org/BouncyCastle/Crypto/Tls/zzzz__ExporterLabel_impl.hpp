...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::ExporterLabel::*)()>(&::Org::BouncyCastle::Crypto::Tls::ExporterLabel::_ctor)> {
