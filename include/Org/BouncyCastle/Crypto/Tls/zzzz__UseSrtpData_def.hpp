...
/// @brief Method .ctor, addr 0x23f1658, size 0x130, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<int32_t,::Array<int32_t>*>  protectionProfiles, ::ArrayW<uint8_t,::Array<uint8_t>*>  mki) ;

/// @brief Method get_Mki, addr 0x23f8328, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Mki() ;

/// @brief Method get_ProtectionProfiles, addr 0x23f8320, size 0x8, virtual true, abstract: false, final false
