...
public:
// Declarations
/// @brief Method IsValid, addr 0x23ca9dc, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23cae50, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
