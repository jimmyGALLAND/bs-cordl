...
/// @brief Method CalculateNonce, addr 0x239b2f8, size 0xec, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> CalculateNonce(int64_t  seqNo, ::ArrayW<uint8_t,::Array<uint8_t>*>  iv) ;

/// @brief Method CalculateRecordMac, addr 0x239b53c, size 0x1a8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> CalculateRecordMac(::Org::BouncyCastle::Crypto::Parameters::KeyParameter*  macKey, ::ArrayW<uint8_t,::Array<uint8_t>*>  additionalData, ::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method DecodeCiphertext, addr 0x239afe8, size 0x1e4, virtual true, abstract: false, final false
...
/// @brief Method EncodePlaintext, addr 0x239aeac, size 0x13c, virtual true, abstract: false, final false
...
/// @brief Method GenerateRecordMacKey, addr 0x239b3e4, size 0x158, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::KeyParameter* GenerateRecordMacKey(::Org::BouncyCastle::Crypto::IStreamCipher*  cipher) ;

/// @brief Method GetAdditionalData, addr 0x239b934, size 0x160, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetAdditionalData(int64_t  seqNo, uint8_t  type, int32_t  len) ;

/// @brief Method GetPlaintextLimit, addr 0x239aea4, size 0x8, virtual true, abstract: false, final false
inline int32_t GetPlaintextLimit(int32_t  ciphertextLimit) ;

/// @brief Method InitRecord, addr 0x239b1cc, size 0x12c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::KeyParameter* InitRecord(::Org::BouncyCastle::Crypto::IStreamCipher*  cipher, bool  forEncryption, int64_t  seqNo, ::ArrayW<uint8_t,::Array<uint8_t>*>  iv) ;

static inline ::Org::BouncyCastle::Crypto::Tls::Chacha20Poly1305* New_ctor(::Org::BouncyCastle::Crypto::Tls::TlsContext*  context) ;

/// @brief Method UpdateRecordMacLength, addr 0x239b6e4, size 0xc8, virtual true, abstract: false, final false
inline void UpdateRecordMacLength(::Org::BouncyCastle::Crypto::IMac*  mac, int32_t  len) ;

/// @brief Method UpdateRecordMacText, addr 0x239b7ac, size 0x188, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x239aba0, size 0x304, virtual false, abstract: false, final false
