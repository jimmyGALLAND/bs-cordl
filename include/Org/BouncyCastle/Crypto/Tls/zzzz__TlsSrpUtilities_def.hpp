...
public:
// Declarations
/// @brief Method AddSrpExtension, addr 0x23f0e74, size 0xf0, virtual false, abstract: false, final false
static inline void AddSrpExtension(::System::Collections::IDictionary*  extensions, ::ArrayW<uint8_t,::Array<uint8_t>*>  identity) ;

/// @brief Method CreateSrpExtension, addr 0x23f0f64, size 0x8c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> CreateSrpExtension(::ArrayW<uint8_t,::Array<uint8_t>*>  identity) ;

/// @brief Method GetSrpExtension, addr 0x23f0ff0, size 0x6c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSrpExtension(::System::Collections::IDictionary*  extensions) ;

/// @brief Method IsSrpCipherSuite, addr 0x23f11d4, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method ReadSrpExtension, addr 0x23f105c, size 0xe8, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadSrpExtension(::ArrayW<uint8_t,::Array<uint8_t>*>  extensionData) ;

/// @brief Method ReadSrpParameter, addr 0x23f0aac, size 0x94, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::BigInteger* ReadSrpParameter(::System::IO::Stream*  input) ;

/// @brief Method WriteSrpParameter, addr 0x23f0868, size 0x78, virtual false, abstract: false, final false
static inline void WriteSrpParameter(::Org::BouncyCastle::Math::BigInteger*  x, ::System::IO::Stream*  output) ;

/// @brief Method .ctor, addr 0x23f11e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
