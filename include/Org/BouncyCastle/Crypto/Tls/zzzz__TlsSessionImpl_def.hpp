...
/// @brief Method ExportSessionParameters, addr 0x23ef350, size 0xb4, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::SessionParameters* ExportSessionParameters() ;

/// @brief Method Invalidate, addr 0x23ef438, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23ef210, size 0x140, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  sessionID, ::Org::BouncyCastle::Crypto::Tls::SessionParameters*  sessionParameters) ;

/// @brief Method get_IsResumable, addr 0x23ef45c, size 0x34, virtual true, abstract: false, final false
inline bool get_IsResumable() ;

/// @brief Method get_SessionID, addr 0x23ef404, size 0x34, virtual true, abstract: false, final false
