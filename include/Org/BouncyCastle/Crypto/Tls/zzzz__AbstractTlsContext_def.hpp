...
/// @brief Method ExportKeyingMaterial, addr 0x23950b8, size 0x2c0, virtual true, abstract: false, final false
...
/// @brief Method NextCounterValue, addr 0x2394ce4, size 0x58, virtual false, abstract: false, final false
static inline int64_t NextCounterValue() ;

/// @brief Method SetClientVersion, addr 0x2395080, size 0x8, virtual true, abstract: false, final false
inline void SetClientVersion(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion*  clientVersion) ;

/// @brief Method SetResumableSession, addr 0x23950a0, size 0x8, virtual true, abstract: false, final false
inline void SetResumableSession(::Org::BouncyCastle::Crypto::Tls::TlsSession*  session) ;

/// @brief Method SetServerVersion, addr 0x2395090, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2394d3c, size 0x324, virtual false, abstract: false, final false
...
/// @brief Method get_ClientVersion, addr 0x2395078, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method get_NonceRandomGenerator, addr 0x2395060, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Prng::IRandomGenerator* get_NonceRandomGenerator() ;

/// @brief Method get_ResumableSession, addr 0x2395098, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsSession* get_ResumableSession() ;

/// @brief Method get_SecureRandom, addr 0x2395068, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Security::SecureRandom* get_SecureRandom() ;

/// @brief Method get_SecurityParameters, addr 0x2395070, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::SecurityParameters* get_SecurityParameters() ;

/// @brief Method get_ServerVersion, addr 0x2395088, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* get_ServerVersion() ;

/// @brief Method get_UserObject, addr 0x23950a8, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method set_UserObject, addr 0x23950b0, size 0x8, virtual true, abstract: false, final false
