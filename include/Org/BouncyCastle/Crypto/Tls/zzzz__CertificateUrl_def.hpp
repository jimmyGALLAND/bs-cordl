...
public:
// Declarations
/// @brief Method EncodeTo, addr 0x239a830, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x239a7c8, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Encode, addr 0x239a424, size 0x3a4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x239a2b0, size 0x164, virtual false, abstract: false, final false
inline void _ctor(uint8_t  type, ::System::Collections::IList*  urlAndHashList) ;

/// @brief Method get_Type, addr 0x239a414, size 0x8, virtual true, abstract: false, final false
inline uint8_t get_Type() ;

/// @brief Method get_UrlAndHashList, addr 0x239a41c, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::IList* get_UrlAndHashList() ;

/// @brief Method parse, addr 0x239a914, size 0x28c, virtual false, abstract: false, final false
