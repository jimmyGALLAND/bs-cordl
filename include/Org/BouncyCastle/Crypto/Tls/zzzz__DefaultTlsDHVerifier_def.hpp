...
/// @brief Method Accept, addr 0x239e748, size 0x4c, virtual true, abstract: false, final false
inline bool Accept(::Org::BouncyCastle::Crypto::Parameters::DHParameters*  dhParameters) ;

/// @brief Method AddDefaultGroup, addr 0x239e474, size 0xd4, virtual false, abstract: false, final false
static inline void AddDefaultGroup(::Org::BouncyCastle::Crypto::Parameters::DHParameters*  dhParameters) ;

/// @brief Method AreGroupsEqual, addr 0x239e79c, size 0x78, virtual true, abstract: false, final false
...
/// @brief Method AreParametersEqual, addr 0x239e814, size 0x3c, virtual true, abstract: false, final false
inline bool AreParametersEqual(::Org::BouncyCastle::Math::BigInteger*  a, ::Org::BouncyCastle::Math::BigInteger*  b) ;

/// @brief Method CheckGroup, addr 0x239e850, size 0x35c, virtual true, abstract: false, final false
inline bool CheckGroup(::Org::BouncyCastle::Crypto::Parameters::DHParameters*  dhParameters) ;

/// @brief Method CheckMinimumPrimeBits, addr 0x239ebac, size 0x4c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x239dff0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x239e718, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::IList*  groups, int32_t  minimumPrimeBits) ;

/// @brief Method .ctor, addr 0x239e69c, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method get_MinimumPrimeBits, addr 0x239e794, size 0x8, virtual true, abstract: false, final false
