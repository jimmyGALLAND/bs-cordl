...
/// @brief Method BlockUpdate, addr 0x23d0f00, size 0xc4, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  len) ;

/// @brief Method DoFinal, addr 0x23d0fc4, size 0x37c, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method GenPad, addr 0x23d1514, size 0x98, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenPad(uint8_t  b, int32_t  count) ;

/// @brief Method GetMacSize, addr 0x23d0db0, size 0xa4, virtual true, abstract: false, final false
inline int32_t GetMacSize() ;

/// @brief Method Init, addr 0x23d0cd8, size 0xd8, virtual true, abstract: false, final false
inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

static inline ::Org::BouncyCastle::Crypto::Tls::Ssl3Mac* New_ctor(::Org::BouncyCastle::Crypto::IDigest*  digest) ;

/// @brief Method Reset, addr 0x23d1340, size 0x1d4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Update, addr 0x23d0e54, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23d0b4c, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method get_AlgorithmName, addr 0x23d0c18, size 0xc0, virtual true, abstract: false, final false
