...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::SrtpProtectionProfile::*)()>(&::Org::BouncyCastle::Crypto::Tls::SrtpProtectionProfile::_ctor)> {
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Org::BouncyCastle::Crypto::Tls::SrtpProtectionProfile*>());
}
