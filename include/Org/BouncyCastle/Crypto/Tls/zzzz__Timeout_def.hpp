...
/// @brief Method ConstrainWaitMillis, addr 0x23d17c8, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method ForWaitMillis, addr 0x23d18cc, size 0x60, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Tls::Timeout* ForWaitMillis(int32_t  waitMillis) ;

/// @brief Method ForWaitMillis, addr 0x23d192c, size 0xcc, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Tls::Timeout* ForWaitMillis(int32_t  waitMillis, int64_t  currentTimeMillis) ;

/// @brief Method GetWaitMillis, addr 0x23d1898, size 0x34, virtual false, abstract: false, final false
static inline int32_t GetWaitMillis(::Org::BouncyCastle::Crypto::Tls::Timeout*  timeout, int64_t  currentTimeMillis) ;

/// @brief Method HasExpired, addr 0x23d19f8, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method RemainingMillis, addr 0x23d1764, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23d1660, size 0x70, virtual false, abstract: false, final false
inline void _ctor(int64_t  durationMillis) ;

/// @brief Method .ctor, addr 0x23d16d0, size 0x94, virtual false, abstract: false, final false
