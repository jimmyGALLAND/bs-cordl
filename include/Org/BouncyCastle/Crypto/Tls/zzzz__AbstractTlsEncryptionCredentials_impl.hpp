...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Crypto::Tls::AbstractTlsEncryptionCredentials::*)(::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::Org::BouncyCastle::Crypto::Tls::AbstractTlsEncryptionCredentials::DecryptPreMasterSecret)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::AbstractTlsEncryptionCredentials::*)()>(&::Org::BouncyCastle::Crypto::Tls::AbstractTlsEncryptionCredentials::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x23953ec;
...
constexpr ::Org::BouncyCastle::Crypto::Tls::TlsEncryptionCredentials* Org::BouncyCastle::Crypto::Tls::AbstractTlsEncryptionCredentials::i___Org__BouncyCastle__Crypto__Tls__TlsEncryptionCredentials() noexcept {
return static_cast<::Org::BouncyCastle::Crypto::Tls::TlsEncryptionCredentials*>(static_cast<void*>(this));
}
