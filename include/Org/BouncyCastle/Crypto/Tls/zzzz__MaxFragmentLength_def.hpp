...
public:
// Declarations
/// @brief Method IsValid, addr 0x23cae70, size 0x14, virtual false, abstract: false, final false
static inline bool IsValid(uint8_t  maxFragmentLength) ;

static inline ::Org::BouncyCastle::Crypto::Tls::MaxFragmentLength* New_ctor() ;

/// @brief Method .ctor, addr 0x23cae84, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
