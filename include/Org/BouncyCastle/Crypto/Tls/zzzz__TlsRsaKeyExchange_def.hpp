...
/// @brief Method GenerateClientKeyExchange, addr 0x23e9c18, size 0x28, virtual true, abstract: false, final false
inline void GenerateClientKeyExchange(::System::IO::Stream*  output) ;

/// @brief Method GeneratePremasterSecret, addr 0x23e9d58, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method ProcessClientCredentials, addr 0x23e9b94, size 0x84, virtual true, abstract: false, final false
inline void ProcessClientCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials*  clientCredentials) ;

/// @brief Method ProcessClientKeyExchange, addr 0x23e9c40, size 0x118, virtual true, abstract: false, final false
inline void ProcessClientKeyExchange(::System::IO::Stream*  input) ;

/// @brief Method ProcessServerCertificate, addr 0x23e98c4, size 0x22c, virtual true, abstract: false, final false
inline void ProcessServerCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate*  serverCertificate) ;

/// @brief Method ProcessServerCredentials, addr 0x23e9764, size 0x160, virtual true, abstract: false, final false
inline void ProcessServerCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials*  serverCredentials) ;

/// @brief Method SkipServerCredentials, addr 0x23e972c, size 0x38, virtual true, abstract: false, final false
inline void SkipServerCredentials() ;

/// @brief Method ValidateCertificateRequest, addr 0x23e9af0, size 0xa4, virtual true, abstract: false, final false
inline void ValidateCertificateRequest(::Org::BouncyCastle::Crypto::Tls::CertificateRequest*  certificateRequest) ;

/// @brief Method ValidateRsaPublicKey, addr 0x23e9da8, size 0x68, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23e9714, size 0x18, virtual false, abstract: false, final false
