...
/// @brief Method Encode, addr 0x23ca778, size 0x6c, virtual true, abstract: false, final false
inline void Encode(::System::IO::Stream*  output) ;

static inline ::Org::BouncyCastle::Crypto::Tls::HeartbeatExtension* New_ctor(uint8_t  mode) ;

/// @brief Method Parse, addr 0x23ca7e4, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23ca6c8, size 0x94, virtual false, abstract: false, final false
inline void _ctor(uint8_t  mode) ;

/// @brief Method get_Mode, addr 0x23ca770, size 0x8, virtual true, abstract: false, final false
