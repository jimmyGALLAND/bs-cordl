...
/// @brief Method GetClientCredentials, addr 0x23ce95c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x23ce964, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
