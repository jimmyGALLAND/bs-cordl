...
/// @brief Method GenerateServerKeyExchange, addr 0x2395860, size 0x5c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateServerKeyExchange() ;

/// @brief Method Init, addr 0x2395590, size 0x20c, virtual true, abstract: false, final false
...
/// @brief Method ParseSignature, addr 0x2395424, size 0x98, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::DigitallySigned* ParseSignature(::System::IO::Stream*  input) ;

/// @brief Method ProcessClientCertificate, addr 0x2395970, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method ProcessClientKeyExchange, addr 0x2395974, size 0x3c, virtual true, abstract: false, final false
inline void ProcessClientKeyExchange(::System::IO::Stream*  input) ;

/// @brief Method ProcessServerCertificate, addr 0x239579c, size 0x4, virtual true, abstract: false, final false
inline void ProcessServerCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate*  serverCertificate) ;

/// @brief Method ProcessServerCredentials, addr 0x23957a0, size 0xb8, virtual true, abstract: false, final false
inline void ProcessServerCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials*  serverCredentials) ;

/// @brief Method ProcessServerKeyExchange, addr 0x2395914, size 0x58, virtual true, abstract: false, final false
inline void ProcessServerKeyExchange(::System::IO::Stream*  input) ;

/// @brief Method SkipClientCredentials, addr 0x239596c, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method SkipServerKeyExchange, addr 0x23958bc, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23953f4, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  keyExchange, ::System::Collections::IList*  supportedSignatureAlgorithms) ;

/// @brief Method get_RequiresServerKeyExchange, addr 0x2395858, size 0x8, virtual true, abstract: false, final false
