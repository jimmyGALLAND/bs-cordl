...
/// @brief Method Write, addr 0x23cf9c8, size 0xc4, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method WriteByte, addr 0x23cf91c, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23cf8ec, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method UpdateSigner, addr 0x23cf87c, size 0x70, virtual false, abstract: false, final false
inline void UpdateSigner(::Org::BouncyCastle::Crypto::ISigner*  s) ;

/// @brief Method .ctor, addr 0x23cf914, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
