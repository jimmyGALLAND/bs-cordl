...
public:
// Declarations
/// @brief Method IsScsv, addr 0x239bb04, size 0x20, virtual false, abstract: false, final false
static inline bool IsScsv(int32_t  cipherSuite) ;

static inline ::Org::BouncyCastle::Crypto::Tls::CipherSuite* New_ctor() ;

/// @brief Method .ctor, addr 0x239bb24, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
