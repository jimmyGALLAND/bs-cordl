...
/// @brief Method .ctor, addr 0x23d1618, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  dataType, ::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method get_Data, addr 0x23d1650, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Data() ;

/// @brief Method get_DataType, addr 0x23d1648, size 0x8, virtual true, abstract: false, final false
