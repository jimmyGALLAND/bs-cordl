...
public:
// Declarations
/// @brief Method GetName, addr 0x23ca468, size 0xb8, virtual false, abstract: false, final false
static inline ::StringW GetName(uint8_t  hashAlgorithm) ;

/// @brief Method GetText, addr 0x23ca520, size 0x17c, virtual false, abstract: false, final false
static inline ::StringW GetText(uint8_t  hashAlgorithm) ;

/// @brief Method IsPrivate, addr 0x23ca69c, size 0x10, virtual false, abstract: false, final false
static inline bool IsPrivate(uint8_t  hashAlgorithm) ;

/// @brief Method IsRecognized, addr 0x23ca6ac, size 0x14, virtual false, abstract: false, final false
static inline bool IsRecognized(uint8_t  hashAlgorithm) ;

static inline ::Org::BouncyCastle::Crypto::Tls::HashAlgorithm* New_ctor() ;

/// @brief Method .ctor, addr 0x23ca6c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
