...
/// @brief Method Clear, addr 0x23cdb90, size 0x6c, virtual true, abstract: false, final false
inline void Clear() ;
...
/// @brief Method .ctor, addr 0x23cdc5c, size 0x34, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CipherSuite, addr 0x23cdc04, size 0x8, virtual true, abstract: false, final false
inline int32_t get_CipherSuite() ;

/// @brief Method get_ClientRandom, addr 0x23cdc2c, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_ClientRandom() ;

/// @brief Method get_CompressionAlgorithm, addr 0x23cdc0c, size 0x8, virtual true, abstract: false, final false
inline uint8_t get_CompressionAlgorithm() ;

/// @brief Method get_Entity, addr 0x23cdbfc, size 0x8, virtual true, abstract: false, final false
inline int32_t get_Entity() ;

/// @brief Method get_IsExtendedMasterSecret, addr 0x23cdc54, size 0x8, virtual true, abstract: false, final false
inline bool get_IsExtendedMasterSecret() ;

/// @brief Method get_MasterSecret, addr 0x23cdc24, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_MasterSecret() ;

/// @brief Method get_PrfAlgorithm, addr 0x23cdc14, size 0x8, virtual true, abstract: false, final false
inline int32_t get_PrfAlgorithm() ;

/// @brief Method get_PskIdentity, addr 0x23cdc44, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_PskIdentity() ;

/// @brief Method get_ServerRandom, addr 0x23cdc34, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_ServerRandom() ;

/// @brief Method get_SessionHash, addr 0x23cdc3c, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_SessionHash() ;

/// @brief Method get_SrpIdentity, addr 0x23cdc4c, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_SrpIdentity() ;

/// @brief Method get_VerifyDataLength, addr 0x23cdc1c, size 0x8, virtual true, abstract: false, final false
