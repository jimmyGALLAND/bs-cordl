...
/// @brief Method GenerateClientKeyExchange, addr 0x23e8868, size 0x478, virtual true, abstract: false, final false
inline void GenerateClientKeyExchange(::System::IO::Stream*  output) ;

/// @brief Method GenerateOtherSecret, addr 0x23e9570, size 0x13c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateOtherSecret(int32_t  pskLength) ;

/// @brief Method GeneratePremasterSecret, addr 0x23e943c, size 0x134, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GeneratePremasterSecret() ;

/// @brief Method GenerateServerKeyExchange, addr 0x23e7fb0, size 0x338, virtual true, abstract: false, final false
...
/// @brief Method ProcessClientCredentials, addr 0x23e8830, size 0x38, virtual true, abstract: false, final false
inline void ProcessClientCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials*  clientCredentials) ;

/// @brief Method ProcessClientKeyExchange, addr 0x23e90cc, size 0x370, virtual true, abstract: false, final false
inline void ProcessClientKeyExchange(::System::IO::Stream*  input) ;

/// @brief Method ProcessServerCertificate, addr 0x23e8370, size 0x254, virtual true, abstract: false, final false
inline void ProcessServerCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate*  serverCertificate) ;

/// @brief Method ProcessServerCredentials, addr 0x23e7e50, size 0x160, virtual true, abstract: false, final false
inline void ProcessServerCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials*  serverCredentials) ;

/// @brief Method ProcessServerKeyExchange, addr 0x23e85e4, size 0x188, virtual true, abstract: false, final false
inline void ProcessServerKeyExchange(::System::IO::Stream*  input) ;

/// @brief Method SkipServerCredentials, addr 0x23e7e04, size 0x4c, virtual true, abstract: false, final false
inline void SkipServerCredentials() ;

/// @brief Method ValidateCertificateRequest, addr 0x23e87f8, size 0x38, virtual true, abstract: false, final false
inline void ValidateCertificateRequest(::Org::BouncyCastle::Crypto::Tls::CertificateRequest*  certificateRequest) ;

/// @brief Method ValidateRsaPublicKey, addr 0x23e96ac, size 0x68, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23e7c78, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23e7d3c, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method get_RequiresServerKeyExchange, addr 0x23e85c4, size 0x20, virtual true, abstract: false, final false
