...
/// @brief Method CreateSrpKeyExchange, addr 0x23d0ac8, size 0x7c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreateSrpKeyExchange(int32_t  keyExchange) ;

/// @brief Method GetCipherSuites, addr 0x23d076c, size 0x70, virtual true, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> GetCipherSuites() ;

/// @brief Method GetCredentials, addr 0x23d0930, size 0xe0, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsCredentials* GetCredentials() ;

/// @brief Method GetDsaSignerCredentials, addr 0x23d06f4, size 0x3c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials* GetDsaSignerCredentials() ;

/// @brief Method GetKeyExchange, addr 0x23d0a10, size 0xb8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* GetKeyExchange() ;

/// @brief Method GetRsaSignerCredentials, addr 0x23d0730, size 0x3c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsSignerCredentials* GetRsaSignerCredentials() ;

/// @brief Method GetSelectedCipherSuite, addr 0x23d0810, size 0x120, virtual true, abstract: false, final false
inline int32_t GetSelectedCipherSuite() ;

static inline ::Org::BouncyCastle::Crypto::Tls::SrpTlsServer* New_ctor(::Org::BouncyCastle::Crypto::Tls::TlsCipherFactory*  cipherFactory, ::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager*  srpIdentityManager) ;
...
/// @brief Method ProcessClientExtensions, addr 0x23d07dc, size 0x34, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23d06c8, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23d0650, size 0x78, virtual false, abstract: false, final false
