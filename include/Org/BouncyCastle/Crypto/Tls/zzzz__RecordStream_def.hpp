...
/// @brief Method Write, addr 0x23cdac4, size 0xcc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23cc7b0, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method NextValue, addr 0x23cd330, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23cc7a0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CheckLength, addr 0x23ccca4, size 0x50, virtual false, abstract: false, final false
static inline void CheckLength(int32_t  length, int32_t  limit, uint8_t  alertDescription) ;

/// @brief Method CheckRecordHeader, addr 0x23ccb24, size 0x12c, virtual true, abstract: false, final false
inline void CheckRecordHeader(::ArrayW<uint8_t,::Array<uint8_t>*>  recordHeader) ;

/// @brief Method CheckType, addr 0x23ccc50, size 0x54, virtual false, abstract: false, final false
static inline void CheckType(uint8_t  type, uint8_t  alertDescription) ;

/// @brief Method DecodeAndVerify, addr 0x23cd0ac, size 0x284, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> DecodeAndVerify(uint8_t  type, ::System::IO::Stream*  input, int32_t  len) ;

/// @brief Method FinaliseHandshake, addr 0x23ccaa8, size 0x7c, virtual true, abstract: false, final false
inline void FinaliseHandshake() ;

/// @brief Method Flush, addr 0x23cdaa0, size 0x24, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method GetBufferContents, addr 0x23cd3a4, size 0x54, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetBufferContents() ;

/// @brief Method GetPlaintextLimit, addr 0x23cc8f4, size 0x8, virtual true, abstract: false, final false
inline int32_t GetPlaintextLimit() ;

/// @brief Method Init, addr 0x23cc7d8, size 0x11c, virtual true, abstract: false, final false
...
/// @brief Method NotifyHelloComplete, addr 0x23cd7d4, size 0xac, virtual true, abstract: false, final false
inline void NotifyHelloComplete() ;

/// @brief Method PrepareToFinish, addr 0x23cd890, size 0xb0, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash* PrepareToFinish() ;

/// @brief Method ReadRecord, addr 0x23cccf4, size 0x1b0, virtual true, abstract: false, final false
inline bool ReadRecord() ;

/// @brief Method ReceivedReadCipherSpec, addr 0x23cc9f8, size 0xb0, virtual true, abstract: false, final false
inline void ReceivedReadCipherSpec() ;

/// @brief Method SafeClose, addr 0x23cd940, size 0x160, virtual true, abstract: false, final false
inline void SafeClose() ;

/// @brief Method SentWriteCipherSpec, addr 0x23cc948, size 0xb0, virtual true, abstract: false, final false
inline void SentWriteCipherSpec() ;

/// @brief Method SetPendingConnectionState, addr 0x23cc93c, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method SetPlaintextLimit, addr 0x23cc8fc, size 0x1c, virtual true, abstract: false, final false
inline void SetPlaintextLimit(int32_t  plaintextLimit) ;

/// @brief Method SetRestrictReadVersion, addr 0x23cc930, size 0xc, virtual true, abstract: false, final false
inline void SetRestrictReadVersion(bool  enabled) ;

/// @brief Method SetWriteVersion, addr 0x23cc928, size 0x8, virtual true, abstract: false, final false
inline void SetWriteVersion(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion*  writeVersion) ;

/// @brief Method WriteRecord, addr 0x23cd3f8, size 0x3dc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23cc644, size 0x15c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Crypto::Tls::TlsProtocol*  handler, ::System::IO::Stream*  input, ::System::IO::Stream*  output) ;

/// @brief Method get_HandshakeHash, addr 0x23cd880, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash* get_HandshakeHash() ;

/// @brief Method get_HandshakeHashUpdater, addr 0x23cd888, size 0x8, virtual true, abstract: false, final false
inline ::System::IO::Stream* get_HandshakeHashUpdater() ;

/// @brief Method get_ReadVersion, addr 0x23cc918, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* get_ReadVersion() ;

/// @brief Method set_ReadVersion, addr 0x23cc920, size 0x8, virtual true, abstract: false, final false
