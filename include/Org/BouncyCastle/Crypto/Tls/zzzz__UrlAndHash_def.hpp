...
/// @brief Method Encode, addr 0x23f809c, size 0x100, virtual true, abstract: false, final false
inline void Encode(::System::IO::Stream*  output) ;

static inline ::Org::BouncyCastle::Crypto::Tls::UrlAndHash* New_ctor(::StringW  url, ::ArrayW<uint8_t,::Array<uint8_t>*>  sha1Hash) ;

/// @brief Method Parse, addr 0x23f819c, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23f7fac, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(::StringW  url, ::ArrayW<uint8_t,::Array<uint8_t>*>  sha1Hash) ;

/// @brief Method get_Sha1Hash, addr 0x23f8094, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Sha1Hash() ;

/// @brief Method get_Url, addr 0x23f808c, size 0x8, virtual true, abstract: false, final false
