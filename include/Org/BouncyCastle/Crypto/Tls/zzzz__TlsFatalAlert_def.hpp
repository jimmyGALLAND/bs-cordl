...
/// @brief Method .ctor, addr 0x23e2898, size 0x40, virtual false, abstract: false, final false
inline void _ctor(uint8_t  alertDescription) ;

/// @brief Method .ctor, addr 0x23e2c6c, size 0x44, virtual false, abstract: false, final false
inline void _ctor(uint8_t  alertDescription, ::System::Exception*  alertCause) ;

/// @brief Method get_AlertDescription, addr 0x23e661c, size 0x8, virtual true, abstract: false, final false
