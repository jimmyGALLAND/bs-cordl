...
/// @brief Method CleanupHandshake, addr 0x23d8f10, size 0x24, virtual true, abstract: false, final false
inline void CleanupHandshake() ;

/// @brief Method Connect, addr 0x23d8aa8, size 0x468, virtual true, abstract: false, final false
inline void Connect(::Org::BouncyCastle::Crypto::Tls::TlsClient*  tlsClient) ;

/// @brief Method HandleHandshakeMessage, addr 0x23d8f4c, size 0x12a0, virtual true, abstract: false, final false
inline void HandleHandshakeMessage(uint8_t  type, ::System::IO::MemoryStream*  buf) ;

/// @brief Method HandleSupplementalData, addr 0x23da1ec, size 0x1b0, virtual true, abstract: false, final false
...
/// @brief Method ReceiveNewSessionTicketMessage, addr 0x23da39c, size 0xc0, virtual true, abstract: false, final false
inline void ReceiveNewSessionTicketMessage(::System::IO::MemoryStream*  buf) ;

/// @brief Method ReceiveServerHelloMessage, addr 0x23da45c, size 0xea4, virtual true, abstract: false, final false
inline void ReceiveServerHelloMessage(::System::IO::MemoryStream*  buf) ;

/// @brief Method SendCertificateVerifyMessage, addr 0x23db300, size 0x8c, virtual true, abstract: false, final false
inline void SendCertificateVerifyMessage(::Org::BouncyCastle::Crypto::Tls::DigitallySigned*  certificateVerify) ;

/// @brief Method SendClientHelloMessage, addr 0x23db38c, size 0x698, virtual true, abstract: false, final false
inline void SendClientHelloMessage() ;

/// @brief Method SendClientKeyExchangeMessage, addr 0x23dba24, size 0xe4, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsAuthentication*> const& __cordl_internal_get_mAuthentication() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::CertificateStatus*> const& __cordl_internal_get_mCertificateStatus() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsClient*> const& __cordl_internal_get_mTlsClient() const;

constexpr ::Org::BouncyCastle::Crypto::Tls::TlsClientContextImpl*& __cordl_internal_get_mTlsClientContext() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsClientContextImpl*> const& __cordl_internal_get_mTlsClientContext() const;
...
/// @brief Method .ctor, addr 0x23d8a78, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input, ::System::IO::Stream*  output, ::Org::BouncyCastle::Security::SecureRandom*  secureRandom) ;

/// @brief Method .ctor, addr 0x23d8a90, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Security::SecureRandom*  secureRandom) ;

/// @brief Method .ctor, addr 0x23d8a58, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, ::Org::BouncyCastle::Security::SecureRandom*  secureRandom) ;

/// @brief Method get_Context, addr 0x23d8f34, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsContext* get_Context() ;

/// @brief Method get_ContextAdmin, addr 0x23d8f3c, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::AbstractTlsContext* get_ContextAdmin() ;

/// @brief Method get_Peer, addr 0x23d8f44, size 0x8, virtual true, abstract: false, final false
