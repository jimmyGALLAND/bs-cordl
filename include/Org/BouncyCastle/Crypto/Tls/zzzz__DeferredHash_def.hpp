...
/// @brief Method BlockUpdate, addr 0x23a136c, size 0x45c, virtual true, abstract: false, final false
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  len) ;

/// @brief Method CheckStopBuffering, addr 0x23a1c44, size 0x45c, virtual true, abstract: false, final false
inline void CheckStopBuffering() ;

/// @brief Method CheckTrackingHash, addr 0x23a20a0, size 0x1a0, virtual true, abstract: false, final false
inline void CheckTrackingHash(uint8_t  hashAlgorithm) ;

/// @brief Method DoFinal, addr 0x23a17c8, size 0x4c, virtual true, abstract: false, final false
inline int32_t DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method ForkPrfHash, addr 0x23a0a84, size 0x1b4, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::IDigest* ForkPrfHash() ;

/// @brief Method GetByteLength, addr 0x23a0e9c, size 0x4c, virtual true, abstract: false, final false
inline int32_t GetByteLength() ;

/// @brief Method GetDigestSize, addr 0x23a0ee8, size 0x4c, virtual true, abstract: false, final false
inline int32_t GetDigestSize() ;

/// @brief Method GetFinalHash, addr 0x23a0c38, size 0x218, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetFinalHash(uint8_t  hashAlgorithm) ;

/// @brief Method Init, addr 0x23a0650, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method NotifyPrfDetermined, addr 0x23a0658, size 0x180, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash* NotifyPrfDetermined() ;

/// @brief Method Reset, addr 0x23a1814, size 0x430, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method SealHashAlgorithms, addr 0x23a08b0, size 0x10, virtual true, abstract: false, final false
inline void SealHashAlgorithms() ;

/// @brief Method StopTracking, addr 0x23a08c0, size 0x1c4, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash* StopTracking() ;

/// @brief Method TrackHashAlgorithm, addr 0x23a0848, size 0x68, virtual true, abstract: false, final false
inline void TrackHashAlgorithm(uint8_t  hashAlgorithm) ;

/// @brief Method Update, addr 0x23a0f34, size 0x438, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23a046c, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x23a0518, size 0x138, virtual false, abstract: false, final false
inline void _ctor(uint8_t  prfHashAlgorithm, ::Org::BouncyCastle::Crypto::IDigest*  prfHash) ;

/// @brief Method get_AlgorithmName, addr 0x23a0e50, size 0x4c, virtual true, abstract: false, final false
