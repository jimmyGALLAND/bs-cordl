...
/// @brief Method CheckPaddingConstantTime, addr 0x23d424c, size 0x1a8, virtual true, abstract: false, final false
...
/// @brief Method ChooseExtraPadBlocks, addr 0x23d43f4, size 0xa8, virtual true, abstract: false, final false
inline int32_t ChooseExtraPadBlocks(::Org::BouncyCastle::Security::SecureRandom*  r, int32_t  max) ;

/// @brief Method DecodeCiphertext, addr 0x23d3da0, size 0x4ac, virtual true, abstract: false, final false
...
/// @brief Method EncodePlaintext, addr 0x23d3750, size 0x650, virtual true, abstract: false, final false
...
/// @brief Method GetPlaintextLimit, addr 0x23d3650, size 0x100, virtual true, abstract: false, final false
inline int32_t GetPlaintextLimit(int32_t  ciphertextLimit) ;

/// @brief Method LowestBitSet, addr 0x23d449c, size 0x28, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23d2af8, size 0xb58, virtual false, abstract: false, final false
...
/// @brief Method get_ReadMac, addr 0x23d2af0, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsMac* get_ReadMac() ;

/// @brief Method get_WriteMac, addr 0x23d2ae8, size 0x8, virtual true, abstract: false, final false
