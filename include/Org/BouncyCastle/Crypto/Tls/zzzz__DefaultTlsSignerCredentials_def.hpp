...
/// @brief Field mSignatureAndHashAlgorithm, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_mSignatureAndHashAlgorithm, put=__cordl_internal_set_mSignatureAndHashAlgorithm)) ::Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm*  mSignatureAndHashAlgorithm;
...
/// @brief Method GenerateCertificateSignature, addr 0x239f98c, size 0x238, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x239f57c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x239f584, size 0x400, virtual false, abstract: false, final false
...
/// @brief Method get_Certificate, addr 0x239f984, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::Certificate* get_Certificate() ;

/// @brief Method get_SignatureAndHashAlgorithm, addr 0x239fbc4, size 0x8, virtual true, abstract: false, final false
