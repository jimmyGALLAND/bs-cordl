...
/// @brief Method CalculateMac, addr 0x23e6b24, size 0x2f4, virtual true, abstract: false, final false
...
/// @brief Method CalculateMacConstantTime, addr 0x23e6fec, size 0x284, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> CalculateMacConstantTime(int64_t  seqNo, uint8_t  type, ::ArrayW<uint8_t,::Array<uint8_t>*>  message, int32_t  offset, int32_t  length, int32_t  fullLength, ::ArrayW<uint8_t,::Array<uint8_t>*>  dummyData) ;

/// @brief Method GetDigestBlockCount, addr 0x23e7270, size 0x10, virtual true, abstract: false, final false
inline int32_t GetDigestBlockCount(int32_t  inputLength) ;

static inline ::Org::BouncyCastle::Crypto::Tls::TlsMac* New_ctor(::Org::BouncyCastle::Crypto::Tls::TlsContext*  context, ::Org::BouncyCastle::Crypto::IDigest*  digest, ::ArrayW<uint8_t,::Array<uint8_t>*>  key, int32_t  keyOff, int32_t  keyLen) ;

/// @brief Method Truncate, addr 0x23e7280, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23e666c, size 0x3fc, virtual false, abstract: false, final false
...
/// @brief Method get_MacSecret, addr 0x23e6b14, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_MacSecret() ;

/// @brief Method get_Size, addr 0x23e6b1c, size 0x8, virtual true, abstract: false, final false
