...
/// @brief Method .ctor, addr 0x23e6624, size 0x40, virtual false, abstract: false, final false
inline void _ctor(uint8_t  alertDescription) ;

/// @brief Method get_AlertDescription, addr 0x23e6664, size 0x8, virtual true, abstract: false, final false
