...
/// @brief Method Encode, addr 0x23caf20, size 0x7c, virtual true, abstract: false, final false
...
/// @brief Method Parse, addr 0x23caf9c, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23caee4, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(int64_t  ticketLifetimeHint, ::ArrayW<uint8_t,::Array<uint8_t>*>  ticket) ;

/// @brief Method get_Ticket, addr 0x23caf18, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Ticket() ;

/// @brief Method get_TicketLifetimeHint, addr 0x23caf10, size 0x8, virtual true, abstract: false, final false
