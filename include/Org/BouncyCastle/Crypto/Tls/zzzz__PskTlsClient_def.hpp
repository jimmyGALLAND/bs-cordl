...
/// @brief Method CreatePskKeyExchange, addr 0x23cc1a0, size 0xa8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsKeyExchange* CreatePskKeyExchange(int32_t  keyExchange) ;

/// @brief Method GetAuthentication, addr 0x23cc164, size 0x3c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsAuthentication* GetAuthentication() ;

/// @brief Method GetCipherSuites, addr 0x23cc030, size 0x74, virtual true, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> GetCipherSuites() ;

/// @brief Method GetKeyExchange, addr 0x23cc0a4, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23cc004, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23cbf8c, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23cbf20, size 0x6c, virtual false, abstract: false, final false
