...
/// @brief Method Encode, addr 0x239a0b0, size 0x10c, virtual true, abstract: false, final false
inline void Encode(::System::IO::Stream*  output) ;

/// @brief Method GetOcspStatusRequest, addr 0x2399fe0, size 0xd0, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::OcspStatusRequest* GetOcspStatusRequest() ;

/// @brief Method IsCorrectType, addr 0x2399eec, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x239a1bc, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2399e50, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(uint8_t  statusType, ::System::Object*  request) ;

/// @brief Method get_Request, addr 0x2399fd8, size 0x8, virtual true, abstract: false, final false
inline ::System::Object* get_Request() ;

/// @brief Method get_StatusType, addr 0x2399fd0, size 0x8, virtual true, abstract: false, final false
