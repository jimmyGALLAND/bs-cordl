...
static inline ::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters* New_ctor(::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters*  group, ::Org::BouncyCastle::Math::BigInteger*  verifier, ::ArrayW<uint8_t,::Array<uint8_t>*>  salt) ;
...
/// @brief Method .ctor, addr 0x23f0e20, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_Group, addr 0x23f0e5c, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters* get_Group() ;

/// @brief Method get_Salt, addr 0x23f0e64, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Salt() ;

/// @brief Method get_Verifier, addr 0x23f0e6c, size 0x8, virtual true, abstract: false, final false
