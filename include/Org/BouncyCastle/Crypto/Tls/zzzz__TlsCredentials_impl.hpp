...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Crypto::Tls::Certificate* (::Org::BouncyCastle::Crypto::Tls::TlsCredentials::*)()>(&::Org::BouncyCastle::Crypto::Tls::TlsCredentials::get_Certificate)> {
