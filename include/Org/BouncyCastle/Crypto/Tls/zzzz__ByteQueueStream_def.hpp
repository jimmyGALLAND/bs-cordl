...
/// @brief Method Flush, addr 0x2397dc8, size 0x4, virtual true, abstract: false, final false
inline void Flush() ;

static inline ::Org::BouncyCastle::Crypto::Tls::ByteQueueStream* New_ctor() ;

/// @brief Method Peek, addr 0x2397e04, size 0xa0, virtual true, abstract: false, final false
inline int32_t Peek(::ArrayW<uint8_t,::Array<uint8_t>*>  buf) ;

/// @brief Method Read, addr 0x2397f14, size 0x28, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buf) ;

/// @brief Method Read, addr 0x2397f3c, size 0xb8, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method ReadByte, addr 0x2397ff4, size 0x48, virtual true, abstract: false, final false
inline int32_t ReadByte() ;

/// @brief Method Seek, addr 0x239803c, size 0x38, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetLength, addr 0x2398074, size 0x38, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method Skip, addr 0x23980ac, size 0x90, virtual true, abstract: false, final false
inline int32_t Skip(int32_t  n) ;

/// @brief Method Write, addr 0x239813c, size 0x24, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buf) ;

/// @brief Method Write, addr 0x2398160, size 0x18, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method WriteByte, addr 0x2398178, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2397d0c, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Available, addr 0x2397d94, size 0x1c, virtual true, abstract: false, final false
inline int32_t get_Available() ;

/// @brief Method get_CanRead, addr 0x2397db0, size 0x8, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x2397db8, size 0x8, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanWrite, addr 0x2397dc0, size 0x8, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Length, addr 0x2397dcc, size 0x38, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Position, addr 0x2397ea4, size 0x38, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method set_Position, addr 0x2397edc, size 0x38, virtual true, abstract: false, final false
