...
/// @brief Method AddData, addr 0x2397278, size 0x168, virtual false, abstract: false, final false
inline void AddData(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset, int32_t  len) ;

/// @brief Method CopyTo, addr 0x23973e8, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method NextTwoPow, addr 0x2397168, size 0x1c, virtual false, abstract: false, final false
static inline int32_t NextTwoPow(int32_t  i) ;

/// @brief Method Read, addr 0x239759c, size 0x250, virtual false, abstract: false, final false
inline void Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  offset, int32_t  len, int32_t  skip) ;

/// @brief Method ReadFrom, addr 0x23977ec, size 0x1ec, virtual false, abstract: false, final false
inline ::System::IO::MemoryStream* ReadFrom(int32_t  length) ;

/// @brief Method RemoveData, addr 0x2397b9c, size 0x88, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> RemoveData(int32_t  len, int32_t  skip) ;

/// @brief Method RemoveData, addr 0x2397b70, size 0x2c, virtual false, abstract: false, final false
inline void RemoveData(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len, int32_t  skip) ;

/// @brief Method RemoveData, addr 0x23979d8, size 0x198, virtual false, abstract: false, final false
inline void RemoveData(int32_t  i) ;

/// @brief Method Shrink, addr 0x2397c24, size 0xe8, virtual false, abstract: false, final false
inline void Shrink() ;
...
/// @brief Method .ctor, addr 0x2397184, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x239722c, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method .ctor, addr 0x239718c, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(int32_t  capacity) ;

/// @brief Method get_Available, addr 0x23973e0, size 0x8, virtual false, abstract: false, final false
