...
/// @brief Method Equals, addr 0x23cb98c, size 0x20, virtual false, abstract: false, final false
inline bool Equals(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion*  other) ;

/// @brief Method Equals, addr 0x23cb90c, size 0x80, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method Get, addr 0x23cb9b4, size 0x224, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* Get(int32_t  major, int32_t  minor) ;

/// @brief Method GetEquivalentTLSVersion, addr 0x23cb7c8, size 0x98, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* GetEquivalentTLSVersion() ;

/// @brief Method GetHashCode, addr 0x23cb9ac, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetUnknownVersion, addr 0x23cbbd8, size 0x164, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Tls::ProtocolVersion* GetUnknownVersion(int32_t  major, int32_t  minor, ::StringW  prefix) ;

/// @brief Method IsEqualOrEarlierVersionOf, addr 0x23cb860, size 0x58, virtual false, abstract: false, final false
inline bool IsEqualOrEarlierVersionOf(::Org::BouncyCastle::Crypto::Tls::ProtocolVersion*  version) ;

/// @brief Method IsLaterVersionOf, addr 0x23cb8b8, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x23cbd3c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23cb6ec, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method get_FullVersion, addr 0x23cb720, size 0x8, virtual false, abstract: false, final false
inline int32_t get_FullVersion() ;

/// @brief Method get_IsDtls, addr 0x23cb73c, size 0x14, virtual false, abstract: false, final false
inline bool get_IsDtls() ;

/// @brief Method get_IsSsl, addr 0x23cb750, size 0x64, virtual false, abstract: false, final false
inline bool get_IsSsl() ;

/// @brief Method get_IsTls, addr 0x23cb7b4, size 0x14, virtual false, abstract: false, final false
inline bool get_IsTls() ;

/// @brief Method get_MajorVersion, addr 0x23cb728, size 0xc, virtual false, abstract: false, final false
inline int32_t get_MajorVersion() ;

/// @brief Method get_MinorVersion, addr 0x23cb734, size 0x8, virtual false, abstract: false, final false
