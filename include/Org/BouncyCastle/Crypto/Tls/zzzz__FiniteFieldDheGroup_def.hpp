...
public:
// Declarations
/// @brief Method IsValid, addr 0x23ca448, size 0x10, virtual false, abstract: false, final false
static inline bool IsValid(uint8_t  group) ;

static inline ::Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup* New_ctor() ;

/// @brief Method .ctor, addr 0x23ca458, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
