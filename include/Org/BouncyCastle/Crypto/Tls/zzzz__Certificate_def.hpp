...
/// @brief Field mCertificateList, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_mCertificateList, put=__cordl_internal_set_mCertificateList)) ::ArrayW<::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*,::Array<::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*>*>  mCertificateList;

/// @brief Method CloneCertificateList, addr 0x2398c2c, size 0x78, virtual true, abstract: false, final false
...
/// @brief Method Encode, addr 0x2398308, size 0x4c4, virtual true, abstract: false, final false
inline void Encode(::System::IO::Stream*  output) ;

/// @brief Method GetCertificateAt, addr 0x2398298, size 0x30, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::X509::X509CertificateStructure* GetCertificateAt(int32_t  index) ;

/// @brief Method GetCertificateList, addr 0x239828c, size 0xc, virtual true, abstract: false, final false
...
static inline ::Org::BouncyCastle::Crypto::Tls::Certificate* New_ctor(::ArrayW<::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*,::Array<::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*>*>  certificateList) ;

/// @brief Method Parse, addr 0x23987cc, size 0x460, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::Tls::Certificate* Parse(::System::IO::Stream*  input) ;

constexpr ::ArrayW<::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*,::Array<::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*>*> const& __cordl_internal_get_mCertificateList() const;
...
constexpr void __cordl_internal_set_mCertificateList(::ArrayW<::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*,::Array<::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*>*>  value) ;

/// @brief Method .ctor, addr 0x2398218, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method get_IsEmpty, addr 0x23982e4, size 0x24, virtual true, abstract: false, final false
inline bool get_IsEmpty() ;

/// @brief Method get_Length, addr 0x23982c8, size 0x1c, virtual true, abstract: false, final false
