...
/// @brief Method .ctor, addr 0x23a96a4, size 0x40, virtual false, abstract: false, final false
inline void _ctor(int32_t  message_seq, uint8_t  msg_type, ::ArrayW<uint8_t,::Array<uint8_t>*>  body) ;

/// @brief Method get_Body, addr 0x23aac18, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Body() ;

/// @brief Method get_Seq, addr 0x23aac08, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Seq() ;

/// @brief Method get_Type, addr 0x23aac10, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method SendToRecordLayer, addr 0x23aab54, size 0xb4, virtual false, abstract: false, final false
inline void SendToRecordLayer(::Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer*  recordLayer) ;

/// @brief Method .ctor, addr 0x23aab4c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ReceivedHandshakeRecord, addr 0x23aac20, size 0x2c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x23aa254, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method BackOff, addr 0x23aa27c, size 0x5c, virtual false, abstract: false, final false
inline int32_t BackOff(int32_t  timeoutMillis) ;

/// @brief Method CheckAll, addr 0x23aa674, size 0x3b0, virtual false, abstract: false, final false
static inline bool CheckAll(::System::Collections::IDictionary*  inboundFlight) ;

/// @brief Method CheckInboundFlight, addr 0x23a931c, size 0x388, virtual false, abstract: false, final false
inline void CheckInboundFlight() ;

/// @brief Method Finish, addr 0x23a4e34, size 0xa0, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method GetPendingMessage, addr 0x23a9a2c, size 0x1a4, virtual false, abstract: false, final false
...
/// @brief Method NotifyHelloComplete, addr 0x23a4d24, size 0xac, virtual false, abstract: false, final false
inline void NotifyHelloComplete() ;

/// @brief Method PrepareInboundFlight, addr 0x23a9a00, size 0x2c, virtual false, abstract: false, final false
inline void PrepareInboundFlight(::System::Collections::IDictionary*  nextFlight) ;

/// @brief Method PrepareToFinish, addr 0x23a4ed4, size 0xb0, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash* PrepareToFinish() ;

/// @brief Method ProcessRecord, addr 0x23a9dcc, size 0x488, virtual false, abstract: false, final false
inline void ProcessRecord(int32_t  windowSize, int32_t  epoch, ::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method ReceiveMessage, addr 0x23a486c, size 0x2e4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::Tls::__DtlsReliableHandshake__Message* ReceiveMessage() ;

/// @brief Method ReceiveMessageBody, addr 0x23a4dd0, size 0x64, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReceiveMessageBody(uint8_t  msg_type) ;

/// @brief Method ResendOutboundFlight, addr 0x23a9bd0, size 0x1fc, virtual false, abstract: false, final false
inline void ResendOutboundFlight() ;

/// @brief Method ResetAll, addr 0x23aa2d8, size 0x39c, virtual false, abstract: false, final false
static inline void ResetAll(::System::Collections::IDictionary*  inboundFlight) ;

/// @brief Method ResetHandshakeMessagesDigest, addr 0x23a4c80, size 0xa4, virtual false, abstract: false, final false
inline void ResetHandshakeMessagesDigest() ;

/// @brief Method SendMessage, addr 0x23a46a0, size 0x1cc, virtual false, abstract: false, final false
inline void SendMessage(uint8_t  msg_type, ::ArrayW<uint8_t,::Array<uint8_t>*>  body) ;

/// @brief Method UpdateHandshakeMessagesDigest, addr 0x23a97f0, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method WriteHandshakeFragment, addr 0x23aaa24, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method WriteMessage, addr 0x23a96e4, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x23a4554, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method get_HandshakeHash, addr 0x23a9314, size 0x8, virtual false, abstract: false, final false
