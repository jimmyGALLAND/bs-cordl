...
public:
// Declarations
/// @brief Method GetDataToSign, addr 0x250e1d0, size 0x1c, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Pkcs::Pkcs10CertificationRequestDelaySigned* New_ctor(::StringW  signatureAlgorithm, ::Org::BouncyCastle::Asn1::X509::X509Name*  subject, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  publicKey, ::Org::BouncyCastle::Asn1::Asn1Set*  attributes) ;

static inline ::Org::BouncyCastle::Pkcs::Pkcs10CertificationRequestDelaySigned* New_ctor(::StringW  signatureAlgorithm, ::Org::BouncyCastle::Asn1::X509::X509Name*  subject, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  publicKey, ::Org::BouncyCastle::Asn1::Asn1Set*  attributes, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  signingKey) ;

/// @brief Method SignRequest, addr 0x250e1ec, size 0x68, virtual false, abstract: false, final false
inline void SignRequest(::ArrayW<uint8_t,::Array<uint8_t>*>  signedData) ;

/// @brief Method SignRequest, addr 0x250e254, size 0x8, virtual false, abstract: false, final false
inline void SignRequest(::Org::BouncyCastle::Asn1::DerBitString*  signedData) ;

/// @brief Method .ctor, addr 0x250d980, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x250d9d8, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  encoded) ;

/// @brief Method .ctor, addr 0x250daa4, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input) ;

/// @brief Method .ctor, addr 0x250da3c, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method .ctor, addr 0x250db9c, size 0x634, virtual false, abstract: false, final false
inline void _ctor(::StringW  signatureAlgorithm, ::Org::BouncyCastle::Asn1::X509::X509Name*  subject, ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  publicKey, ::Org::BouncyCastle::Asn1::Asn1Set*  attributes) ;

/// @brief Method .ctor, addr 0x250db08, size 0x94, virtual false, abstract: false, final false
