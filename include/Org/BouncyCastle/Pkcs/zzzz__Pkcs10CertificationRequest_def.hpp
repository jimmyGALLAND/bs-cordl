...
/// @brief Method CreatePssParams, addr 0x250c574, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method GetDigestAlgName, addr 0x250d610, size 0x370, virtual false, abstract: false, final false
static inline ::StringW GetDigestAlgName(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  digestAlgOID) ;

/// @brief Method GetPublicKey, addr 0x250cd6c, size 0x20, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* GetPublicKey() ;

/// @brief Method GetSignatureName, addr 0x250d460, size 0x1b0, virtual false, abstract: false, final false
static inline ::StringW GetSignatureName(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  sigAlgId) ;

/// @brief Method Init, addr 0x250c90c, size 0x460, virtual false, abstract: false, final false
...
/// @brief Method SetSignatureParameters, addr 0x250d2e4, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method Verify, addr 0x250cd8c, size 0x1c, virtual false, abstract: false, final false
inline bool Verify() ;

/// @brief Method Verify, addr 0x250cda8, size 0x6c, virtual false, abstract: false, final false
inline bool Verify(::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*  publicKey) ;

/// @brief Method Verify, addr 0x250cec8, size 0x41c, virtual false, abstract: false, final false
inline bool Verify(::Org::BouncyCastle::Crypto::IVerifierFactory*  verifier) ;

/// @brief Method Verify, addr 0x250ce14, size 0xb4, virtual false, abstract: false, final false
inline bool Verify(::Org::BouncyCastle::Crypto::IVerifierFactoryProvider*  verifierProvider) ;

/// @brief Method .ctor, addr 0x250c694, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25066b0, size 0x98, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  encoded) ;

/// @brief Method .ctor, addr 0x250c6a4, size 0x98, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input) ;

/// @brief Method .ctor, addr 0x250c69c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method .ctor, addr 0x250c73c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x250c7d8, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x250c908, size 0x4, virtual false, abstract: false, final false
