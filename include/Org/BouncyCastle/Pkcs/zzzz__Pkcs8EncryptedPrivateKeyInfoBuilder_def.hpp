...
/// @brief Method Build, addr 0x25187c0, size 0x3e8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2518760, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  privateKeyInfo) ;

/// @brief Method .ctor, addr 0x2518798, size 0x28, virtual false, abstract: false, final false
