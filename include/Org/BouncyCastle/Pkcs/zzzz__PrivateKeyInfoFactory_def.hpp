...
public:
// Declarations
/// @brief Method CreatePrivateKeyInfo, addr 0x2519d1c, size 0xc, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* CreatePrivateKeyInfo(::ArrayW<char16_t,::Array<char16_t>*>  passPhrase, ::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo*  encInfo) ;

/// @brief Method CreatePrivateKeyInfo, addr 0x2519d28, size 0x214, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* CreatePrivateKeyInfo(::ArrayW<char16_t,::Array<char16_t>*>  passPhrase, bool  wrongPkcs12Zero, ::Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo*  encInfo) ;

/// @brief Method CreatePrivateKeyInfo, addr 0x2518c20, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method CreatePrivateKeyInfo, addr 0x2518c28, size 0xfec, virtual false, abstract: false, final false
...
/// @brief Method ExtractBytes, addr 0x2519c14, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2518c18, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
