...
/// @brief Method GetEncoded, addr 0x25f9cf4, size 0xb8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

static inline ::Org::BouncyCastle::Bcpg::BcpgObject* New_ctor() ;

/// @brief Method .ctor, addr 0x25f9e48, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
