...
/// @brief Method Close, addr 0x25faa58, size 0x8c, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Finish, addr 0x25faa18, size 0x40, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method Flush, addr 0x25fa9f4, size 0x24, virtual true, abstract: false, final false
inline void Flush() ;
...
/// @brief Method PartialFlush, addr 0x25fa4a0, size 0x80, virtual false, abstract: false, final false
inline void PartialFlush(bool  isLast) ;

/// @brief Method Wrap, addr 0x25f9e50, size 0x8c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Bcpg::BcpgOutputStream* Wrap(::System::IO::Stream*  outStr) ;

/// @brief Method Write, addr 0x25fa6a8, size 0x34, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method WriteByte, addr 0x25fa674, size 0x34, virtual true, abstract: false, final false
inline void WriteByte(uint8_t  value) ;

/// @brief Method WriteHeader, addr 0x25f9f68, size 0x174, virtual false, abstract: false, final false
inline void WriteHeader(::Org::BouncyCastle::Bcpg::PacketTag  tag, bool  oldPackets, bool  partial, int64_t  bodyLen) ;

/// @brief Method WriteInt, addr 0x25fa770, size 0xb4, virtual true, abstract: false, final false
inline void WriteInt(int32_t  n) ;

/// @brief Method WriteLong, addr 0x25fa824, size 0xf4, virtual true, abstract: false, final false
inline void WriteLong(int64_t  n) ;

/// @brief Method WriteNewPacketLength, addr 0x25fa3c0, size 0xe0, virtual false, abstract: false, final false
inline void WriteNewPacketLength(int64_t  bodyLen) ;

/// @brief Method WriteObject, addr 0x25f9e20, size 0x28, virtual false, abstract: false, final false
inline void WriteObject(::Org::BouncyCastle::Bcpg::BcpgObject*  bcpgObject) ;

/// @brief Method WriteObjects, addr 0x25fa988, size 0x6c, virtual false, abstract: false, final false
inline void WriteObjects(::ArrayW<::Org::BouncyCastle::Bcpg::BcpgObject*,::Array<::Org::BouncyCastle::Bcpg::BcpgObject*>*>  v) ;

/// @brief Method WritePacket, addr 0x25fa918, size 0x28, virtual false, abstract: false, final false
inline void WritePacket(::Org::BouncyCastle::Bcpg::ContainedPacket*  p) ;

/// @brief Method WritePacket, addr 0x25fa940, size 0x48, virtual false, abstract: false, final false
inline void WritePacket(::Org::BouncyCastle::Bcpg::PacketTag  tag, ::ArrayW<uint8_t,::Array<uint8_t>*>  body, bool  oldFormat) ;

/// @brief Method WritePartial, addr 0x25fa520, size 0x68, virtual false, abstract: false, final false
inline void WritePartial(uint8_t  b) ;

/// @brief Method WritePartial, addr 0x25fa588, size 0xec, virtual false, abstract: false, final false
inline void WritePartial(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  off, int32_t  len) ;

/// @brief Method WriteShort, addr 0x25fa6dc, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25f9dac, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  outStr) ;

/// @brief Method .ctor, addr 0x25f9edc, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  outStr, ::Org::BouncyCastle::Bcpg::PacketTag  tag) ;

/// @brief Method .ctor, addr 0x25fa2a0, size 0x120, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  outStr, ::Org::BouncyCastle::Bcpg::PacketTag  tag, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer) ;

/// @brief Method .ctor, addr 0x25fa208, size 0x98, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  outStr, ::Org::BouncyCastle::Bcpg::PacketTag  tag, int64_t  length) ;

/// @brief Method .ctor, addr 0x25fa0dc, size 0x12c, virtual false, abstract: false, final false
