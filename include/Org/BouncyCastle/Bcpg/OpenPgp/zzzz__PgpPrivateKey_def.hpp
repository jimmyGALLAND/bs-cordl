...
/// @brief Method .ctor, addr 0x24e1240, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method get_Key, addr 0x24e612c, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Crypto::AsymmetricKeyParameter* get_Key() ;

/// @brief Method get_KeyId, addr 0x24e611c, size 0x8, virtual false, abstract: false, final false
inline int64_t get_KeyId() ;

/// @brief Method get_PublicKeyPacket, addr 0x24e6124, size 0x8, virtual false, abstract: false, final false
