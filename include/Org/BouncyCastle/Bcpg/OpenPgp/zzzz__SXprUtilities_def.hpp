...
/// @brief Method .ctor, addr 0x2502be0, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_IterationCount, addr 0x2502c08, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ParseS2k, addr 0x24f6784, size 0xf8, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Bcpg::S2k* ParseS2k(::System::IO::Stream*  input) ;

/// @brief Method ReadBytes, addr 0x24f5fb4, size 0x80, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadBytes(::System::IO::Stream*  input, int32_t  ch) ;

/// @brief Method ReadLength, addr 0x2502b6c, size 0x74, virtual false, abstract: false, final false
static inline int32_t ReadLength(::System::IO::Stream*  input, int32_t  ch) ;

/// @brief Method ReadString, addr 0x24f5e78, size 0xc8, virtual false, abstract: false, final false
static inline ::StringW ReadString(::System::IO::Stream*  input, int32_t  ch) ;

/// @brief Method SkipCloseParenthesis, addr 0x24f5f40, size 0x74, virtual false, abstract: false, final false
static inline void SkipCloseParenthesis(::System::IO::Stream*  input) ;

/// @brief Method SkipOpenParenthesis, addr 0x24f5e04, size 0x74, virtual false, abstract: false, final false
static inline void SkipOpenParenthesis(::System::IO::Stream*  input) ;

/// @brief Method .ctor, addr 0x2502b64, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
