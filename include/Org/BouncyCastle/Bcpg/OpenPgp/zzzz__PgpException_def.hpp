...
/// @brief Method .ctor, addr 0x24dcac8, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x24d8b78, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method .ctor, addr 0x24dcb20, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::System::Exception*  exception) ;

/// @brief Method get_UnderlyingException, addr 0x24dcb90, size 0x8, virtual false, abstract: false, final false
