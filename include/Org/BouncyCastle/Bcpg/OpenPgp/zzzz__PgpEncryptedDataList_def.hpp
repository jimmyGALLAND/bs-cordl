...
/// @brief Method Get, addr 0x24e0964, size 0x4, virtual false, abstract: false, final false
inline ::System::Object* Get(int32_t  index) ;

/// @brief Method GetEncryptedDataObjects, addr 0x24e0b60, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24e02f4, size 0x54c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgInput) ;

/// @brief Method get_Count, addr 0x24e0a0c, size 0xa4, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_IsEmpty, addr 0x24e0ab0, size 0xb0, virtual false, abstract: false, final false
inline bool get_IsEmpty() ;

/// @brief Method get_Item, addr 0x24e0870, size 0xf4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedData* get_Item(int32_t  index) ;

/// @brief Method get_Size, addr 0x24e0968, size 0xa4, virtual false, abstract: false, final false
