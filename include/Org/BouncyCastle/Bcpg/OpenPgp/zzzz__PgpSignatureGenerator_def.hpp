...
static __declspec(property(get=getStaticF_EmptySignatureSubpackets, put=setStaticF_EmptySignatureSubpackets)) ::ArrayW<::Org::BouncyCastle::Bcpg::SignatureSubpacket*,::Array<::Org::BouncyCastle::Bcpg::SignatureSubpacket*>*>  EmptySignatureSubpackets;
...
/// @brief Field hashed, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_hashed, put=__cordl_internal_set_hashed)) ::ArrayW<::Org::BouncyCastle::Bcpg::SignatureSubpacket*,::Array<::Org::BouncyCastle::Bcpg::SignatureSubpacket*>*>  hashed;
...
/// @brief Field unhashed, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_unhashed, put=__cordl_internal_set_unhashed)) ::ArrayW<::Org::BouncyCastle::Bcpg::SignatureSubpacket*,::Array<::Org::BouncyCastle::Bcpg::SignatureSubpacket*>*>  unhashed;

/// @brief Method Generate, addr 0x24fcf98, size 0x800, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignature* Generate() ;

/// @brief Method GenerateCertification, addr 0x24f21c8, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method GenerateCertification, addr 0x24fdf6c, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GenerateCertification, addr 0x24fdf9c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method GenerateCertification, addr 0x24fdd94, size 0x1d8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignature* GenerateCertification(::Org::BouncyCastle::Bcpg::OpenPgp::PgpUserAttributeSubpacketVector*  userAttributes, ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey*  pubKey) ;

/// @brief Method GenerateOnePassVersion, addr 0x24fced4, size 0xc4, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature* GenerateOnePassVersion(bool  isNested) ;

/// @brief Method GetEncodedPublicKey, addr 0x24fdfb4, size 0xf8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncodedPublicKey(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey*  pubKey) ;

/// @brief Method InitSign, addr 0x24f20d0, size 0x8, virtual false, abstract: false, final false
inline void InitSign(int32_t  sigType, ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey*  key) ;

/// @brief Method InitSign, addr 0x24fc908, size 0x258, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureGenerator* New_ctor(::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag  keyAlgorithm, ::Org::BouncyCastle::Bcpg::HashAlgorithmTag  hashAlgorithm) ;

/// @brief Method SetHashedSubpackets, addr 0x24f20d8, size 0x78, virtual false, abstract: false, final false
inline void SetHashedSubpackets(::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureSubpacketVector*  hashedPackets) ;

/// @brief Method SetUnhashedSubpackets, addr 0x24f2150, size 0x78, virtual false, abstract: false, final false
inline void SetUnhashedSubpackets(::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureSubpacketVector*  unhashedPackets) ;

/// @brief Method Update, addr 0x24fcd20, size 0x1c, virtual false, abstract: false, final false
inline void Update(::ArrayW<uint8_t,::Array<uint8_t>*>  b) ;

/// @brief Method Update, addr 0x24fcd3c, size 0x198, virtual false, abstract: false, final false
inline void Update(::ArrayW<uint8_t,::Array<uint8_t>*>  b, int32_t  off, int32_t  len) ;

/// @brief Method Update, addr 0x24fcb60, size 0x14, virtual false, abstract: false, final false
inline void Update(uint8_t  b) ;

/// @brief Method UpdateWithIdData, addr 0x24fdcb8, size 0xdc, virtual false, abstract: false, final false
inline void UpdateWithIdData(int32_t  header, ::ArrayW<uint8_t,::Array<uint8_t>*>  idBytes) ;

/// @brief Method UpdateWithPublicKey, addr 0x24fdbf4, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24f1fc4, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method doCanonicalUpdateByte, addr 0x24fcb74, size 0x64, virtual false, abstract: false, final false
inline void doCanonicalUpdateByte(uint8_t  b) ;

/// @brief Method doUpdateByte, addr 0x24fcbd8, size 0x128, virtual false, abstract: false, final false
inline void doUpdateByte(uint8_t  b) ;

/// @brief Method doUpdateCRLF, addr 0x24fcd00, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method insertSubpacket, addr 0x24fd7f0, size 0xb0, virtual false, abstract: false, final false
inline ::ArrayW<::Org::BouncyCastle::Bcpg::SignatureSubpacket*,::Array<::Org::BouncyCastle::Bcpg::SignatureSubpacket*>*> insertSubpacket(::ArrayW<::Org::BouncyCastle::Bcpg::SignatureSubpacket*,::Array<::Org::BouncyCastle::Bcpg::SignatureSubpacket*>*>  packets, ::Org::BouncyCastle::Bcpg::SignatureSubpacket*  subpacket) ;

/// @brief Method packetPresent, addr 0x24fd798, size 0x58, virtual false, abstract: false, final false
inline bool packetPresent(::ArrayW<::Org::BouncyCastle::Bcpg::SignatureSubpacket*,::Array<::Org::BouncyCastle::Bcpg::SignatureSubpacket*>*>  packets, ::Org::BouncyCastle::Bcpg::SignatureSubpacketTag  type) ;
