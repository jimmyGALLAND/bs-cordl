...
/// @brief Method ReadOptionalTrustPacket, addr 0x24e1348, size 0xa0, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Bcpg::TrustPacket* ReadOptionalTrustPacket(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgInput) ;

/// @brief Method ReadSignaturesAndTrust, addr 0x24e13e8, size 0x2b4, virtual false, abstract: false, final false
static inline ::System::Collections::IList* ReadSignaturesAndTrust(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgInput) ;

/// @brief Method ReadUserIDs, addr 0x24e169c, size 0x33c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24e1340, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
