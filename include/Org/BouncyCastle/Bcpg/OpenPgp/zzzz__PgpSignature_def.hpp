...
/// @brief Method Cast, addr 0x24fb0f0, size 0xc8, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Bcpg::SignaturePacket* Cast(::Org::BouncyCastle::Bcpg::Packet*  packet) ;

/// @brief Method Encode, addr 0x24f4fcc, size 0x58, virtual false, abstract: false, final false
inline void Encode(::System::IO::Stream*  outStream) ;

/// @brief Method GetCreationTime, addr 0x24fc728, size 0x4, virtual false, abstract: false, final false
inline ::System::DateTime GetCreationTime() ;

/// @brief Method GetEncoded, addr 0x24fc890, size 0x78, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method GetEncodedPublicKey, addr 0x24fc05c, size 0xf8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncodedPublicKey(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey*  pubKey) ;

/// @brief Method GetHashedSubPackets, addr 0x24fc7c8, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureSubpacketVector* GetHashedSubPackets() ;

/// @brief Method GetSig, addr 0x24fb278, size 0x7c, virtual false, abstract: false, final false
inline void GetSig() ;

/// @brief Method GetSignature, addr 0x24fbc04, size 0x2b8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSignature() ;

/// @brief Method GetSignatureTrailer, addr 0x24fbbe8, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSignatureTrailer() ;

/// @brief Method GetUnhashedSubPackets, addr 0x24fc84c, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureSubpacketVector* GetUnhashedSubPackets() ;

/// @brief Method InitVerify, addr 0x24fb514, size 0x1a0, virtual false, abstract: false, final false
inline void InitVerify(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey*  pubKey) ;

/// @brief Method IsCertification, addr 0x24fb4c0, size 0x28, virtual false, abstract: false, final false
inline bool IsCertification() ;

/// @brief Method IsCertification, addr 0x24fb504, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x24fb6b4, size 0xcc, virtual false, abstract: false, final false
inline void Update(uint8_t  b) ;

/// @brief Method Update, addr 0x24fb970, size 0x1c, virtual false, abstract: false, final false
inline void Update(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method Update, addr 0x24fb98c, size 0x114, virtual false, abstract: false, final false
inline void Update(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  off, int32_t  length) ;

/// @brief Method UpdateWithIdData, addr 0x24fbebc, size 0xdc, virtual false, abstract: false, final false
inline void UpdateWithIdData(int32_t  header, ::ArrayW<uint8_t,::Array<uint8_t>*>  idBytes) ;

/// @brief Method UpdateWithPublicKey, addr 0x24fbf98, size 0xc4, virtual false, abstract: false, final false
inline void UpdateWithPublicKey(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey*  key) ;

/// @brief Method Verify, addr 0x24fbaa0, size 0x148, virtual false, abstract: false, final false
inline bool Verify() ;

/// @brief Method VerifyCertification, addr 0x24fc3cc, size 0x108, virtual false, abstract: false, final false
inline bool VerifyCertification(::StringW  id, ::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey*  key) ;

/// @brief Method VerifyCertification, addr 0x24fc4d4, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method VerifyCertification, addr 0x24fc5cc, size 0x140, virtual false, abstract: false, final false
inline bool VerifyCertification(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey*  pubKey) ;

/// @brief Method VerifyCertification, addr 0x24fc154, size 0x278, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24fb1b8, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgInput) ;

/// @brief Method .ctor, addr 0x24fb1ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::SignaturePacket*  sigPacket) ;

/// @brief Method .ctor, addr 0x24fb1f4, size 0x84, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::SignaturePacket*  sigPacket, ::Org::BouncyCastle::Bcpg::TrustPacket*  trustPacket) ;

/// @brief Method createSubpacketVector, addr 0x24fc7e4, size 0x68, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureSubpacketVector* createSubpacketVector(::ArrayW<::Org::BouncyCastle::Bcpg::SignatureSubpacket*,::Array<::Org::BouncyCastle::Bcpg::SignatureSubpacket*>*>  pcks) ;

/// @brief Method doCanonicalUpdateByte, addr 0x24fb780, size 0xe0, virtual false, abstract: false, final false
inline void doCanonicalUpdateByte(uint8_t  b) ;

/// @brief Method doUpdateCRLF, addr 0x24fb860, size 0x110, virtual false, abstract: false, final false
inline void doUpdateCRLF() ;

/// @brief Method get_CreationTime, addr 0x24fc72c, size 0x68, virtual false, abstract: false, final false
inline ::System::DateTime get_CreationTime() ;

/// @brief Method get_HasSubpackets, addr 0x24fc794, size 0x34, virtual false, abstract: false, final false
inline bool get_HasSubpackets() ;

/// @brief Method get_HashAlgorithm, addr 0x24fb4a4, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm() ;

/// @brief Method get_KeyAlgorithm, addr 0x24fb488, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm() ;

/// @brief Method get_KeyId, addr 0x24fc70c, size 0x1c, virtual false, abstract: false, final false
inline int64_t get_KeyId() ;

/// @brief Method get_SignatureType, addr 0x24fb4e8, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_SignatureType() ;

/// @brief Method get_Version, addr 0x24fb46c, size 0x1c, virtual false, abstract: false, final false
