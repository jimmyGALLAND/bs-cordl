...
/// @brief Method CreateKey, addr 0x24ecda8, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method CreateUserKeyingMaterial, addr 0x25024f4, size 0x268, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> CreateUserKeyingMaterial(::Org::BouncyCastle::Bcpg::PublicKeyPacket*  pubKeyData) ;

/// @brief Method GetAgreementAlgorithm, addr 0x25021c8, size 0x16c, virtual false, abstract: false, final false
static inline ::StringW GetAgreementAlgorithm(::Org::BouncyCastle::Bcpg::PublicKeyPacket*  pubKeyData) ;

/// @brief Method GetKeyEncryptionOID, addr 0x2502334, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method GetKeyLength, addr 0x2502464, size 0x90, virtual false, abstract: false, final false
static inline int32_t GetKeyLength(::Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag  algID) ;

/// @brief Method Kdf, addr 0x250275c, size 0x37c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25021c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
