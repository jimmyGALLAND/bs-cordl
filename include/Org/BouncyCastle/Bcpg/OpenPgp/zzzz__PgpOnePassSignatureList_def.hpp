...
/// @brief Field sigs, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_sigs, put=__cordl_internal_set_sigs)) ::ArrayW<::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*,::Array<::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*>*>  sigs;

/// @brief Method Get, addr 0x24e5550, size 0x4, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignatureList* New_ctor(::ArrayW<::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*,::Array<::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*>*>  sigs) ;
...
/// @brief Method .ctor, addr 0x24e5478, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*  sig) ;

/// @brief Method .ctor, addr 0x24e46cc, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method get_Count, addr 0x24e5570, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_IsEmpty, addr 0x24e558c, size 0x24, virtual false, abstract: false, final false
inline bool get_IsEmpty() ;

/// @brief Method get_Item, addr 0x24e5520, size 0x30, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature* get_Item(int32_t  index) ;

/// @brief Method get_Size, addr 0x24e5554, size 0x1c, virtual false, abstract: false, final false
