...
/// @brief Method GetDataStream, addr 0x24d8a0c, size 0x16c, virtual false, abstract: false, final false
inline ::System::IO::Stream* GetDataStream() ;

/// @brief Method GetInputStream, addr 0x24d89f0, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24d88bc, size 0x118, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgInput) ;

/// @brief Method get_Algorithm, addr 0x24d89d4, size 0x1c, virtual false, abstract: false, final false
