...
/// @brief Method Cast, addr 0x24e49c0, size 0xc8, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Bcpg::OnePassSignaturePacket* Cast(::Org::BouncyCastle::Bcpg::Packet*  packet) ;

/// @brief Method Encode, addr 0x24e544c, size 0x2c, virtual false, abstract: false, final false
inline void Encode(::System::IO::Stream*  outStr) ;

/// @brief Method GetEncoded, addr 0x24e53d4, size 0x78, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method InitVerify, addr 0x24e4ac0, size 0x26c, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x24e4d2c, size 0xcc, virtual false, abstract: false, final false
inline void Update(uint8_t  b) ;

/// @brief Method Update, addr 0x24e4fe8, size 0x110, virtual false, abstract: false, final false
inline void Update(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method Update, addr 0x24e50f8, size 0x114, virtual false, abstract: false, final false
inline void Update(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  off, int32_t  length) ;

/// @brief Method Verify, addr 0x24e520c, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24e469c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgInput) ;

/// @brief Method .ctor, addr 0x24e4a88, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::OnePassSignaturePacket*  sigPack) ;

/// @brief Method doCanonicalUpdateByte, addr 0x24e4df8, size 0xe0, virtual false, abstract: false, final false
inline void doCanonicalUpdateByte(uint8_t  b) ;

/// @brief Method doUpdateCRLF, addr 0x24e4ed8, size 0x110, virtual false, abstract: false, final false
inline void doUpdateCRLF() ;

/// @brief Method get_HashAlgorithm, addr 0x24e539c, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm() ;

/// @brief Method get_KeyAlgorithm, addr 0x24e53b8, size 0x1c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm() ;

/// @brief Method get_KeyId, addr 0x24e5364, size 0x1c, virtual false, abstract: false, final false
inline int64_t get_KeyId() ;

/// @brief Method get_SignatureType, addr 0x24e5380, size 0x1c, virtual false, abstract: false, final false
