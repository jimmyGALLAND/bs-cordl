...
/// @brief Method IntToByteArray, addr 0x25f39dc, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25f3aa0, size 0x50, virtual false, abstract: false, final false
inline void _ctor(bool  critical, int32_t  depth, int32_t  trustAmount) ;

/// @brief Method .ctor, addr 0x25f3a58, size 0x48, virtual false, abstract: false, final false
inline void _ctor(bool  critical, bool  isLongLength, ::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method get_Depth, addr 0x25f3af0, size 0x28, virtual false, abstract: false, final false
inline int32_t get_Depth() ;

/// @brief Method get_TrustAmount, addr 0x25f3b18, size 0x2c, virtual false, abstract: false, final false
