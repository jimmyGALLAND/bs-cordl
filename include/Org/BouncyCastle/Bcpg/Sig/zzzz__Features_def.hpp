...
/// @brief Method FeatureToByteArray, addr 0x25f1da4, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method SetSupportsFeature, addr 0x25f1fb8, size 0x1b0, virtual false, abstract: false, final false
inline void SetSupportsFeature(uint8_t  feature, bool  support) ;

/// @brief Method SupportsFeature, addr 0x25f1f40, size 0x78, virtual false, abstract: false, final false
inline bool SupportsFeature(uint8_t  feature) ;

/// @brief Method .ctor, addr 0x25f1e50, size 0x90, virtual false, abstract: false, final false
inline void _ctor(bool  critical, uint8_t  feature) ;

/// @brief Method .ctor, addr 0x25f1e08, size 0x48, virtual false, abstract: false, final false
inline void _ctor(bool  critical, bool  isLongLength, ::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

static inline uint8_t getStaticF_FEATURE_MODIFICATION_DETECTION() ;

/// @brief Method get_SupportsModificationDetection, addr 0x25f1ee0, size 0x60, virtual false, abstract: false, final false
