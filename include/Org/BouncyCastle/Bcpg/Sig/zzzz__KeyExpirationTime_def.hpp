...
/// @brief Method TimeToBytes, addr 0x25f23b8, size 0x94, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> TimeToBytes(int64_t  t) ;

/// @brief Method .ctor, addr 0x25f244c, size 0x48, virtual false, abstract: false, final false
inline void _ctor(bool  critical, bool  isLongLength, ::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method .ctor, addr 0x25f2494, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(bool  critical, int64_t  seconds) ;

/// @brief Method get_Time, addr 0x25f24e0, size 0x5c, virtual false, abstract: false, final false
