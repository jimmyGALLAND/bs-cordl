...
public:
// Declarations
/// @brief Method BooleanToByteArray, addr 0x25f1c74, size 0x6c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> BooleanToByteArray(bool  val) ;

/// @brief Method IsExportable, addr 0x25f1d74, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25f1d28, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(bool  critical, bool  isExportable) ;

/// @brief Method .ctor, addr 0x25f1ce0, size 0x48, virtual false, abstract: false, final false
