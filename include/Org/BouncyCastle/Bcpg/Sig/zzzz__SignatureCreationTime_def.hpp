...
public:
// Declarations
/// @brief Method GetTime, addr 0x25f35b8, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method TimeToBytes, addr 0x25f343c, size 0xe8, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> TimeToBytes(::System::DateTime  time) ;

/// @brief Method .ctor, addr 0x25f356c, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(bool  critical, ::System::DateTime  date) ;

/// @brief Method .ctor, addr 0x25f3524, size 0x48, virtual false, abstract: false, final false
