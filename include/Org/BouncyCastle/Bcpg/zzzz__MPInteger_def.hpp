...
/// @brief Method Encode, addr 0x25fc514, size 0x70, virtual true, abstract: false, final false
inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream*  bcpgOut) ;

/// @brief Method Encode, addr 0x25fc584, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25fac84, size 0x134, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgIn) ;

/// @brief Method .ctor, addr 0x25fae84, size 0xc4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::BigInteger*  val) ;

/// @brief Method get_Value, addr 0x25fc50c, size 0x8, virtual false, abstract: false, final false
