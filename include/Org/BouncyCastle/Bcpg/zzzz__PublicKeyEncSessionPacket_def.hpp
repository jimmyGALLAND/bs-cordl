...
/// @brief Method Encode, addr 0x25fc994, size 0x188, virtual true, abstract: false, final false
inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream*  bcpgOut) ;

/// @brief Method GetEncSessionKey, addr 0x25fc98c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25f7a6c, size 0x318, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgIn) ;

/// @brief Method .ctor, addr 0x25fc858, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method get_Algorithm, addr 0x25fc984, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_Algorithm() ;

/// @brief Method get_KeyId, addr 0x25fc97c, size 0x8, virtual false, abstract: false, final false
inline int64_t get_KeyId() ;

/// @brief Method get_Version, addr 0x25fc974, size 0x8, virtual false, abstract: false, final false
