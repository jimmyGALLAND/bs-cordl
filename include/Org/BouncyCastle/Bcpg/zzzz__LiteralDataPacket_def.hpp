...
/// @brief Method GetRawFileName, addr 0x25fc2ec, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25f9298, size 0x1b8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgIn) ;

/// @brief Method get_FileName, addr 0x25fc2e0, size 0xc, virtual false, abstract: false, final false
inline ::StringW get_FileName() ;

/// @brief Method get_Format, addr 0x25fc2d0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Format() ;

/// @brief Method get_ModificationTime, addr 0x25fc2d8, size 0x8, virtual false, abstract: false, final false
