...
/// @brief Method Close, addr 0x25f4e84, size 0x68, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Decode, addr 0x25f3ca4, size 0x20c, virtual false, abstract: false, final false
inline int32_t Decode(int32_t  in0, int32_t  in1, int32_t  in2, int32_t  in3, ::ArrayW<int32_t,::Array<int32_t>*>  result) ;

/// @brief Method DoReadByte, addr 0x25f4948, size 0x288, virtual false, abstract: false, final false
inline int32_t DoReadByte() ;

/// @brief Method GetArmorHeaderLine, addr 0x25f443c, size 0x8, virtual false, abstract: false, final false
inline ::StringW GetArmorHeaderLine() ;

/// @brief Method GetArmorHeaders, addr 0x25f4444, size 0x238, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> GetArmorHeaders() ;

/// @brief Method IsClearText, addr 0x25f442c, size 0x8, virtual false, abstract: false, final false
inline bool IsClearText() ;

/// @brief Method IsEndOfStream, addr 0x25f4434, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ParseHeaders, addr 0x25f3ff0, size 0x43c, virtual false, abstract: false, final false
inline bool ParseHeaders() ;

/// @brief Method Read, addr 0x25f4cac, size 0x1d8, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method ReadByte, addr 0x25f4bd0, size 0x98, virtual true, abstract: false, final false
inline int32_t ReadByte() ;

/// @brief Method ReadByteClearText, addr 0x25f4720, size 0xd8, virtual false, abstract: false, final false
inline int32_t ReadByteClearText() ;

/// @brief Method ReadClearText, addr 0x25f47f8, size 0x150, virtual false, abstract: false, final false
inline int32_t ReadClearText(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method ReadIgnoreSpace, addr 0x25f467c, size 0x44, virtual false, abstract: false, final false
inline int32_t ReadIgnoreSpace() ;

/// @brief Method ReadIgnoreWhitespace, addr 0x25f46c0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25f3eb0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input) ;

/// @brief Method .ctor, addr 0x25f3eb8, size 0x124, virtual false, abstract: false, final false
