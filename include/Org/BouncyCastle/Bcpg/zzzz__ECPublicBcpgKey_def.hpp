...
/// @brief Method Encode, addr 0x25fb738, size 0xb8, virtual true, abstract: false, final false
inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream*  bcpgOut) ;

/// @brief Method GetEncoded, addr 0x25fb6b4, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method ReadBytesOfEncodedLength, addr 0x25fb454, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25fb38c, size 0xc8, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgIn) ;

/// @brief Method .ctor, addr 0x25fb648, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid, ::Org::BouncyCastle::Math::BigInteger*  encodedPoint) ;

/// @brief Method .ctor, addr 0x25fb5a4, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Asn1::DerObjectIdentifier*  oid, ::Org::BouncyCastle::Math::EC::ECPoint*  point) ;

/// @brief Method get_CurveOid, addr 0x25fb7f8, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_CurveOid() ;

/// @brief Method get_EncodedPoint, addr 0x25fb7f0, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_EncodedPoint() ;

/// @brief Method get_Format, addr 0x25fb674, size 0x40, virtual true, abstract: false, final true
