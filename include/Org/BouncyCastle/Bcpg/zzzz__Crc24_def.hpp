...
/// @brief Method GetValue, addr 0x25fabbc, size 0x8, virtual false, abstract: false, final false
inline int32_t GetValue() ;

static inline ::Org::BouncyCastle::Bcpg::Crc24* New_ctor() ;

/// @brief Method Reset, addr 0x25f4c68, size 0x10, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Update, addr 0x25f4c78, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25f3fdc, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Value, addr 0x25fabc4, size 0x8, virtual false, abstract: false, final false
