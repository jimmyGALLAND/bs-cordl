...
/// @brief Method Encode, addr 0x25f1ae8, size 0x144, virtual false, abstract: false, final false
inline void Encode(::System::IO::Stream*  os) ;

/// @brief Method GetData, addr 0x25f1a70, size 0x78, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetData() ;

/// @brief Method IsCritical, addr 0x25f1a60, size 0x8, virtual false, abstract: false, final false
inline bool IsCritical() ;

/// @brief Method IsLongLength, addr 0x25f1a68, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25f1a10, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method get_SubpacketType, addr 0x25f1a58, size 0x8, virtual false, abstract: false, final false
