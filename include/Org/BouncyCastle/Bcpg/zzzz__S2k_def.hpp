...
/// @brief Method Encode, addr 0x25fda0c, size 0xfc, virtual true, abstract: false, final false
inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream*  bcpgOut) ;

/// @brief Method GetIV, addr 0x25fd97c, size 0x5c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetIV() ;

/// @brief Method GetIterationCount, addr 0x25fd9d8, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25fd8b4, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::HashAlgorithmTag  algorithm) ;

/// @brief Method .ctor, addr 0x25fd8e4, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::HashAlgorithmTag  algorithm, ::ArrayW<uint8_t,::Array<uint8_t>*>  iv) ;

/// @brief Method .ctor, addr 0x25fd920, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::HashAlgorithmTag  algorithm, ::ArrayW<uint8_t,::Array<uint8_t>*>  iv, int32_t  itCount) ;

/// @brief Method .ctor, addr 0x25fd724, size 0x190, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  inStr) ;

/// @brief Method get_HashAlgorithm, addr 0x25fd974, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm() ;

/// @brief Method get_IterationCount, addr 0x25fd9e4, size 0x20, virtual true, abstract: false, final false
inline int64_t get_IterationCount() ;

/// @brief Method get_ProtectionMode, addr 0x25fda04, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ProtectionMode() ;

/// @brief Method get_Type, addr 0x25fd96c, size 0x8, virtual true, abstract: false, final false
