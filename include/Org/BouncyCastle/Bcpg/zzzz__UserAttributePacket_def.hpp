...
/// @brief Field subpackets, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_subpackets, put=__cordl_internal_set_subpackets)) ::ArrayW<::Org::BouncyCastle::Bcpg::UserAttributeSubpacket*,::Array<::Org::BouncyCastle::Bcpg::UserAttributeSubpacket*>*>  subpackets;

/// @brief Method Encode, addr 0x25ff4c4, size 0xd8, virtual true, abstract: false, final false
inline void Encode(::Org::BouncyCastle::Bcpg::BcpgOutputStream*  bcpgOut) ;

/// @brief Method GetSubpackets, addr 0x25ff4bc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25f9568, size 0x32c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Bcpg::BcpgInputStream*  bcpgIn) ;

/// @brief Method .ctor, addr 0x25ff494, size 0x28, virtual false, abstract: false, final false
