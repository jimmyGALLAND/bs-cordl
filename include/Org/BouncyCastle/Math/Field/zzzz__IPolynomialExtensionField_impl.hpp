...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::Field::IPolynomial* (::Org::BouncyCastle::Math::Field::IPolynomialExtensionField::*)()>(&::Org::BouncyCastle::Math::Field::IPolynomialExtensionField::get_MinimalPolynomial)> {
