...
/// @brief Method Equals, addr 0x2490c98, size 0xd0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x2490d68, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x249075c, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::Field::IFiniteField*  subfield, ::Org::BouncyCastle::Math::Field::IPolynomial*  polynomial) ;

/// @brief Method get_Characteristic, addr 0x2490a24, size 0xa0, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Characteristic() ;

/// @brief Method get_Degree, addr 0x2490bf0, size 0xa0, virtual true, abstract: false, final false
inline int32_t get_Degree() ;

/// @brief Method get_Dimension, addr 0x2490ac4, size 0x124, virtual true, abstract: false, final false
inline int32_t get_Dimension() ;

/// @brief Method get_MinimalPolynomial, addr 0x2490c90, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::Field::IPolynomial* get_MinimalPolynomial() ;

/// @brief Method get_Subfield, addr 0x2490be8, size 0x8, virtual true, abstract: false, final false
