...
/// @brief Method Equals, addr 0x2490f90, size 0xb4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x2491044, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2490908, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::BigInteger*  characteristic) ;

/// @brief Method get_Characteristic, addr 0x2490f80, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Characteristic() ;

/// @brief Method get_Dimension, addr 0x2490f88, size 0x8, virtual true, abstract: false, final false
