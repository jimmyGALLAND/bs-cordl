...
/// @brief Method CheckResult, addr 0x246b628, size 0xc, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* CheckResult(::Org::BouncyCastle::Math::EC::ECPoint*  p) ;

/// @brief Method Multiply, addr 0x246b54c, size 0xdc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x246b634, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
