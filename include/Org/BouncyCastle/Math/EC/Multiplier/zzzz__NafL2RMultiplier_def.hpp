...
public:
// Declarations
/// @brief Method MultiplyPositive, addr 0x246cd5c, size 0x130, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x246ce8c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
