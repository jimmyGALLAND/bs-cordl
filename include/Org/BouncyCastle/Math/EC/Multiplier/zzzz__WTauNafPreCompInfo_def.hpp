...
/// @brief Field m_preComp, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_preComp, put=__cordl_internal_set_m_preComp)) ::ArrayW<::Org::BouncyCastle::Math::EC::AbstractF2mPoint*,::Array<::Org::BouncyCastle::Math::EC::AbstractF2mPoint*>*>  m_preComp;
...
/// @brief Method .ctor, addr 0x2470704, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_PreComp, addr 0x247070c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method set_PreComp, addr 0x2470714, size 0x8, virtual true, abstract: false, final false
