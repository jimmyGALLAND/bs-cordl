...
public:
// Declarations
/// @brief Method MultiplyPositive, addr 0x246cb58, size 0x1fc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x246cd54, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
