...
// Write type traits
MARK_REF_PTR_T(::Org::BouncyCastle::Math::EC::Multiplier::ZSignedDigitL2RMultiplier);
...
public:
// Declarations
/// @brief Method MultiplyPositive, addr 0x247071c, size 0xf4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2470810, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(::cordl_internals::size_check_v<::Org::BouncyCastle::Math::EC::Multiplier::ZSignedDigitL2RMultiplier, 0x10>, "Size mismatch!");
