...
/// @brief Method MultiplyPositive, addr 0x246c31c, size 0x264, virtual true, abstract: false, final false
...
static inline ::Org::BouncyCastle::Math::EC::Multiplier::GlvMultiplier* New_ctor(::Org::BouncyCastle::Math::EC::ECCurve*  curve, ::Org::BouncyCastle::Math::EC::Endo::GlvEndomorphism*  glvEndomorphism) ;
...
/// @brief Method .ctor, addr 0x246c278, size 0xa4, virtual false, abstract: false, final false
