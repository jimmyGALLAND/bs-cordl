...
public:
// Declarations
/// @brief Method MultiplyPositive, addr 0x246d0a8, size 0x308, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x246d854, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
