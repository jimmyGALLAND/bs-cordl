...
public:
// Declarations
/// @brief Method MultiplyPositive, addr 0x2470818, size 0x130, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2470948, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
