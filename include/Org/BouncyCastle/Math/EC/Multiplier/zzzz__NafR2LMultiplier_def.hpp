...
public:
// Declarations
/// @brief Method MultiplyPositive, addr 0x246ce94, size 0x148, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x246cfdc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
