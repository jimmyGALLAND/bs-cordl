...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::EC::ECPoint* (::Org::BouncyCastle::Math::EC::Multiplier::GlvMultiplier::*)(::Org::BouncyCastle::Math::EC::ECPoint*, ::Org::BouncyCastle::Math::BigInteger*)>(&::Org::BouncyCastle::Math::EC::Multiplier::GlvMultiplier::MultiplyPositive)> {
  ...
  constexpr static std::size_t addrs = 0x246c31c;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Endo::GlvEndomorphism*> const& Org::BouncyCastle::Math::EC::Multiplier::GlvMultiplier::__cordl_internal_get_glvEndomorphism() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___glvEndomorphism;
}
