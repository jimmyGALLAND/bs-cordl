...
/// @brief Method HasCurveEquationPassed, addr 0x246d010, size 0x8, virtual false, abstract: false, final false
inline bool HasCurveEquationPassed() ;

/// @brief Method HasFailed, addr 0x246cffc, size 0x8, virtual false, abstract: false, final false
inline bool HasFailed() ;

/// @brief Method HasOrderPassed, addr 0x246d024, size 0x8, virtual false, abstract: false, final false
inline bool HasOrderPassed() ;

static inline ::Org::BouncyCastle::Math::EC::Multiplier::ValidityPreCompInfo* New_ctor() ;

/// @brief Method ReportCurveEquationPassed, addr 0x246d018, size 0xc, virtual false, abstract: false, final false
inline void ReportCurveEquationPassed() ;

/// @brief Method ReportFailed, addr 0x246d004, size 0xc, virtual false, abstract: false, final false
inline void ReportFailed() ;

/// @brief Method ReportOrderPassed, addr 0x246d02c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x246d098, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
