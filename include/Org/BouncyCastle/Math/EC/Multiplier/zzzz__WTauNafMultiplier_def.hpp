...
/// @brief Method Precompute, addr 0x247061c, size 0xe8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2470584, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method MultiplyFromWTnaf, addr 0x2470144, size 0x440, virtual false, abstract: false, final false
...
/// @brief Method MultiplyPositive, addr 0x246fe08, size 0x1f0, virtual true, abstract: false, final false
...
/// @brief Method MultiplyWTnaf, addr 0x246fff8, size 0x14c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::AbstractF2mPoint* MultiplyWTnaf(::Org::BouncyCastle::Math::EC::AbstractF2mPoint*  p, ::Org::BouncyCastle::Math::EC::Abc::ZTauElement*  lambda, int8_t  a, int8_t  mu) ;

static inline ::Org::BouncyCastle::Math::EC::Multiplier::WTauNafMultiplier* New_ctor() ;

/// @brief Method .ctor, addr 0x2470614, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
