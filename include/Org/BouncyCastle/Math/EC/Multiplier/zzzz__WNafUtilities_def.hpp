...
/// @brief Method Precompute, addr 0x246eb38, size 0x1b0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x246daf0, size 0x30, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Math::EC::Multiplier::__WNafUtilities__MapPointCallback* New_ctor(::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo*  infoP, bool  includeNegated, ::Org::BouncyCastle::Math::EC::ECPointMap*  pointMap) ;

/// @brief Method Precompute, addr 0x246ece8, size 0x374, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo*  existing) ;
...
/// @brief Method .ctor, addr 0x246e7b8, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method CheckExisting, addr 0x246f820, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method CheckTable, addr 0x246f928, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method Precompute, addr 0x246f05c, size 0x7c4, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo*  existing) ;
...
/// @brief Method .ctor, addr 0x246e7f8, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method CheckExisting, addr 0x246fd50, size 0x9c, virtual false, abstract: false, final false
inline bool CheckExisting(::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo*  existingWNaf, int32_t  width, int32_t  reqPreCompLen, bool  includeNegated) ;

/// @brief Method CheckTable, addr 0x246fdec, size 0x1c, virtual false, abstract: false, final false
inline bool CheckTable(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*,::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*>  table, int32_t  reqLen) ;

static inline ::Org::BouncyCastle::Math::EC::Multiplier::__WNafUtilities__PrecomputeWithPointMapCallback* New_ctor(::Org::BouncyCastle::Math::EC::ECPoint*  point, ::Org::BouncyCastle::Math::EC::ECPointMap*  pointMap, ::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo*  fromWNaf, bool  includeNegated) ;

/// @brief Method Precompute, addr 0x246f944, size 0x40c, virtual true, abstract: false, final true
inline ::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo* Precompute(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo*  existing) ;
...
/// @brief Method .ctor, addr 0x246e974, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::EC::ECPoint*  point, ::Org::BouncyCastle::Math::EC::ECPointMap*  pointMap, ::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo*  fromWNaf, bool  includeNegated) ;
...
static __declspec(property(get=getStaticF_EMPTY_POINTS, put=setStaticF_EMPTY_POINTS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*,::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*>  EMPTY_POINTS;
...
/// @brief Method ConfigureBasepoint, addr 0x246d974, size 0x17c, virtual false, abstract: false, final false
static inline void ConfigureBasepoint(::Org::BouncyCastle::Math::EC::ECPoint*  p) ;

/// @brief Method GenerateCompactNaf, addr 0x246c7b8, size 0x270, virtual false, abstract: false, final false
static inline ::ArrayW<int32_t,::Array<int32_t>*> GenerateCompactNaf(::Org::BouncyCastle::Math::BigInteger*  k) ;

/// @brief Method GenerateCompactWindowNaf, addr 0x246d54c, size 0x308, virtual false, abstract: false, final false
static inline ::ArrayW<int32_t,::Array<int32_t>*> GenerateCompactWindowNaf(int32_t  width, ::Org::BouncyCastle::Math::BigInteger*  k) ;

/// @brief Method GenerateJsf, addr 0x246dba4, size 0x298, virtual false, abstract: false, final false
...
/// @brief Method GenerateNaf, addr 0x246dec0, size 0x188, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateNaf(::Org::BouncyCastle::Math::BigInteger*  k) ;

/// @brief Method GenerateWindowNaf, addr 0x246e048, size 0x2cc, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateWindowNaf(int32_t  width, ::Org::BouncyCastle::Math::BigInteger*  k) ;

/// @brief Method GetNafWeight, addr 0x246e314, size 0x64, virtual false, abstract: false, final false
static inline int32_t GetNafWeight(::Org::BouncyCastle::Math::BigInteger*  k) ;

/// @brief Method GetWNafPreCompInfo, addr 0x246e378, size 0x98, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo* GetWNafPreCompInfo(::Org::BouncyCastle::Math::EC::ECPoint*  p) ;

/// @brief Method GetWNafPreCompInfo, addr 0x246e410, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method GetWindowSize, addr 0x246d3b0, size 0x64, virtual false, abstract: false, final false
static inline int32_t GetWindowSize(int32_t  bits) ;

/// @brief Method GetWindowSize, addr 0x246e550, size 0x70, virtual false, abstract: false, final false
static inline int32_t GetWindowSize(int32_t  bits, int32_t  maxWidth) ;

/// @brief Method GetWindowSize, addr 0x246e5c0, size 0x70, virtual false, abstract: false, final false
static inline int32_t GetWindowSize(int32_t  bits, ::ArrayW<int32_t,::Array<int32_t>*>  windowSizeCutoffs) ;

/// @brief Method GetWindowSize, addr 0x246e488, size 0xc8, virtual false, abstract: false, final false
static inline int32_t GetWindowSize(int32_t  bits, ::ArrayW<int32_t,::Array<int32_t>*>  windowSizeCutoffs, int32_t  maxWidth) ;

/// @brief Method MapPointWithPrecomp, addr 0x246e630, size 0x188, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::EC::ECPoint* MapPointWithPrecomp(::Org::BouncyCastle::Math::EC::ECPoint*  p, int32_t  minWidth, bool  includeNegated, ::Org::BouncyCastle::Math::EC::ECPointMap*  pointMap) ;

static inline ::Org::BouncyCastle::Math::EC::Multiplier::WNafUtilities* New_ctor() ;

/// @brief Method Precompute, addr 0x246d414, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method PrecomputeWithPointMap, addr 0x246e838, size 0x13c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo* PrecomputeWithPointMap(::Org::BouncyCastle::Math::EC::ECPoint*  p, ::Org::BouncyCastle::Math::EC::ECPointMap*  pointMap, ::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo*  fromWNaf, bool  includeNegated) ;

/// @brief Method ResizeTable, addr 0x246e9b8, size 0x84, virtual false, abstract: false, final false
static inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*,::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*> ResizeTable(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*,::Array<::Org::BouncyCastle::Math::EC::ECPoint*>*>  a, int32_t  length) ;

/// @brief Method Trim, addr 0x246db20, size 0x84, virtual false, abstract: false, final false
static inline ::ArrayW<int32_t,::Array<int32_t>*> Trim(::ArrayW<int32_t,::Array<int32_t>*>  a, int32_t  length) ;

/// @brief Method Trim, addr 0x246de3c, size 0x84, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Trim(::ArrayW<uint8_t,::Array<uint8_t>*>  a, int32_t  length) ;

/// @brief Method .ctor, addr 0x246eb30, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Math::EC::Multiplier::__WNafUtilities__PrecomputeWithPointMapCallback*, "Org.BouncyCastle.Math.EC.Multiplier", "WNafUtilities/PrecomputeWithPointMapCallback");
