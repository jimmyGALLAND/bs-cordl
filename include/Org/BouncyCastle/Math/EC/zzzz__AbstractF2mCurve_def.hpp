...
/// @brief Method BuildField, addr 0x2438f08, size 0x1d0, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::Field::IFiniteField* BuildField(int32_t  m, int32_t  k1, int32_t  k2, int32_t  k3) ;

/// @brief Method CreatePoint, addr 0x243910c, size 0x158, virtual true, abstract: false, final false
...
/// @brief Method DecompressPoint, addr 0x24393d4, size 0x210, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* DecompressPoint(int32_t  yTilde, ::Org::BouncyCastle::Math::BigInteger*  X1) ;

/// @brief Method GetSi, addr 0x24398dc, size 0xf4, virtual true, abstract: false, final false
inline ::ArrayW<::Org::BouncyCastle::Math::BigInteger*,::Array<::Org::BouncyCastle::Math::BigInteger*>*> GetSi() ;

/// @brief Method ImplRandomFieldElementMult, addr 0x2439394, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Inverse, addr 0x2438e7c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method IsValidFieldElement, addr 0x2439264, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method RandomFieldElement, addr 0x24392b8, size 0x48, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom*  r) ;

/// @brief Method RandomFieldElementMult, addr 0x2439300, size 0x94, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom*  r) ;

/// @brief Method SolveQuadraticEquation, addr 0x24395e4, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24390d8, size 0x34, virtual false, abstract: false, final false
inline void _ctor(int32_t  m, int32_t  k1, int32_t  k2, int32_t  k3) ;

/// @brief Method get_IsKoblitz, addr 0x24399d0, size 0x84, virtual true, abstract: false, final false
