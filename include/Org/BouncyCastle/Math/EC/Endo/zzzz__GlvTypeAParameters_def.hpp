...
static inline ::Org::BouncyCastle::Math::EC::Endo::GlvTypeAParameters* New_ctor(::Org::BouncyCastle::Math::BigInteger*  i, ::Org::BouncyCastle::Math::BigInteger*  lambda, ::Org::BouncyCastle::Math::EC::Endo::ScalarSplitParameters*  splitParams) ;
...
/// @brief Method .ctor, addr 0x246aec0, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_I, addr 0x246aefc, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_I() ;

/// @brief Method get_Lambda, addr 0x246af04, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Lambda() ;

/// @brief Method get_SplitParams, addr 0x246af0c, size 0x8, virtual true, abstract: false, final false
