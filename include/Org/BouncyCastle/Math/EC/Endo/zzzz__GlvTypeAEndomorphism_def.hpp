...
/// @brief Method DecomposeScalar, addr 0x246ae34, size 0x7c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x246ad80, size 0xb4, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve*  curve, ::Org::BouncyCastle::Math::EC::Endo::GlvTypeAParameters*  parameters) ;

/// @brief Method get_HasEfficientPointMap, addr 0x246aeb8, size 0x8, virtual true, abstract: false, final false
inline bool get_HasEfficientPointMap() ;

/// @brief Method get_PointMap, addr 0x246aeb0, size 0x8, virtual true, abstract: false, final false
