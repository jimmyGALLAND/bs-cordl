...
/// @brief Method .ctor, addr 0x246a63c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Endomorphism, addr 0x246a61c, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism* get_Endomorphism() ;

/// @brief Method get_MappedPoint, addr 0x246a62c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method set_Endomorphism, addr 0x246a624, size 0x8, virtual true, abstract: false, final false
inline void set_Endomorphism(::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism*  value) ;

/// @brief Method set_MappedPoint, addr 0x246a634, size 0x8, virtual true, abstract: false, final false
