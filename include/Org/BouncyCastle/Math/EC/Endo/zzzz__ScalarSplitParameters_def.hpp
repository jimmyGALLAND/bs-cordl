...
/// @brief Method CheckVector, addr 0x246b490, size 0x84, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Math::EC::Endo::ScalarSplitParameters* New_ctor(::ArrayW<::Org::BouncyCastle::Math::BigInteger*,::Array<::Org::BouncyCastle::Math::BigInteger*>*>  v1, ::ArrayW<::Org::BouncyCastle::Math::BigInteger*,::Array<::Org::BouncyCastle::Math::BigInteger*>*>  v2, ::Org::BouncyCastle::Math::BigInteger*  g1, ::Org::BouncyCastle::Math::BigInteger*  g2, int32_t  bits) ;
...
/// @brief Method .ctor, addr 0x246b108, size 0xfc, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::Org::BouncyCastle::Math::BigInteger*,::Array<::Org::BouncyCastle::Math::BigInteger*>*>  v1, ::ArrayW<::Org::BouncyCastle::Math::BigInteger*,::Array<::Org::BouncyCastle::Math::BigInteger*>*>  v2, ::Org::BouncyCastle::Math::BigInteger*  g1, ::Org::BouncyCastle::Math::BigInteger*  g2, int32_t  bits) ;

/// @brief Method get_Bits, addr 0x246b544, size 0x8, virtual true, abstract: false, final false
inline int32_t get_Bits() ;

/// @brief Method get_G1, addr 0x246b534, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_G1() ;

/// @brief Method get_G2, addr 0x246b53c, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_G2() ;

/// @brief Method get_V1A, addr 0x246b514, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_V1A() ;

/// @brief Method get_V1B, addr 0x246b51c, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_V1B() ;

/// @brief Method get_V2A, addr 0x246b524, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_V2A() ;

/// @brief Method get_V2B, addr 0x246b52c, size 0x8, virtual true, abstract: false, final false
