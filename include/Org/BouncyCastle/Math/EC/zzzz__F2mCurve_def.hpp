...
/// @brief Method CreatePoint, addr 0x2483980, size 0x1d8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<int64_t,::Array<int64_t>*>  x, ::ArrayW<int64_t,::Array<int64_t>*>  y) ;

/// @brief Method Lookup, addr 0x248380c, size 0x174, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar, addr 0x2483b58, size 0x138, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24837c8, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::EC::F2mCurve*  outer, ::ArrayW<int64_t,::Array<int64_t>*>  table, int32_t  size) ;

/// @brief Method get_Size, addr 0x2483804, size 0x8, virtual true, abstract: false, final false
...
static_assert(offsetof(::Org::BouncyCastle::Math::EC::__F2mCurve__DefaultF2mLookupTable, ___m_outer) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Org::BouncyCastle::Math::EC::__F2mCurve__DefaultF2mLookupTable, ___m_table) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Org::BouncyCastle::Math::EC::__F2mCurve__DefaultF2mLookupTable, ___m_size) == 0x20, "Offset mismatch!");
...
/// @brief Method CloneCurve, addr 0x24830b0, size 0xac, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method CreateCacheSafeLookupTable, addr 0x24835e0, size 0x1bc, virtual true, abstract: false, final false
...
/// @brief Method CreateDefaultMultiplier, addr 0x2483178, size 0x84, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateDefaultMultiplier() ;

/// @brief Method CreateRawPoint, addr 0x2483480, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x2483500, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method FromBigInteger, addr 0x2483204, size 0x84, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method IsTrinomial, addr 0x24835a8, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method SupportsCoordinateSystem, addr 0x248315c, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2482cbc, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  m, int32_t  k, ::Org::BouncyCastle::Math::BigInteger*  a, ::Org::BouncyCastle::Math::BigInteger*  b) ;

/// @brief Method .ctor, addr 0x2482eb8, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2482eec, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2482cec, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2482fd4, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method get_FieldSize, addr 0x24831fc, size 0x8, virtual true, abstract: false, final false
inline int32_t get_FieldSize() ;

/// @brief Method get_Infinity, addr 0x2483598, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_K1, addr 0x24835c8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_K1() ;

/// @brief Method get_K2, addr 0x24835d0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_K2() ;

/// @brief Method get_K3, addr 0x24835d8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_K3() ;

/// @brief Method get_M, addr 0x24835a0, size 0x8, virtual false, abstract: false, final false
