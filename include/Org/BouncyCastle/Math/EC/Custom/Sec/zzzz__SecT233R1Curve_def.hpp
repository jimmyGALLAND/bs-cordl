...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
class __SecT233R1Curve__SecT233R1LookupTable;
}
...
MARK_REF_PTR_T(::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT233R1Curve__SecT233R1LookupTable);
// Type: ::SecT233R1LookupTable
// SizeInfo { instance_size: 40, native_size: -1, calculated_instance_size: 40, calculated_native_size: 36, minimum_alignment: 8, packing: None, specified_packing: None }
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
// Is value type: false
// CS Name: ::SecT233R1Curve::SecT233R1LookupTable*
class CORDL_TYPE __SecT233R1Curve__SecT233R1LookupTable : public ::Org::BouncyCastle::Math::EC::AbstractECLookupTable {
public:
// Declarations
...
/// @brief Method CreatePoint, addr 0x2454b60, size 0xe0, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint64_t,::Array<uint64_t>*>  x, ::ArrayW<uint64_t,::Array<uint64_t>*>  y) ;

/// @brief Method Lookup, addr 0x2454a48, size 0x118, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar, addr 0x2454c40, size 0xc8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t  index) ;

static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT233R1Curve__SecT233R1LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve*  outer, ::ArrayW<uint64_t,::Array<uint64_t>*>  table, int32_t  size) ;

constexpr ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve*& __cordl_internal_get_m_outer() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve*> const& __cordl_internal_get_m_outer() const;
...
/// @brief Method .ctor, addr 0x24548f4, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_Size, addr 0x2454a40, size 0x8, virtual true, abstract: false, final false
inline int32_t get_Size() ;

protected:
// Ctor Parameters []
// @brief default ctor
constexpr __SecT233R1Curve__SecT233R1LookupTable() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "__SecT233R1Curve__SecT233R1LookupTable", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
__SecT233R1Curve__SecT233R1LookupTable(__SecT233R1Curve__SecT233R1LookupTable && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "__SecT233R1Curve__SecT233R1LookupTable", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
__SecT233R1Curve__SecT233R1LookupTable(__SecT233R1Curve__SecT233R1LookupTable const& ) = delete;
...
static_assert(::cordl_internals::size_check_v<::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT233R1Curve__SecT233R1LookupTable, 0x28>, "Size mismatch!");

static_assert(offsetof(::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT233R1Curve__SecT233R1LookupTable, ___m_outer) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT233R1Curve__SecT233R1LookupTable, ___m_table) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT233R1Curve__SecT233R1LookupTable, ___m_size) == 0x20, "Offset mismatch!");
...
public:
// Declarations
using SecT233R1LookupTable = ::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT233R1Curve__SecT233R1LookupTable;
...
static __declspec(property(get=getStaticF_SECT233R1_AFFINE_ZS, put=setStaticF_SECT233R1_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*,::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*>  SECT233R1_AFFINE_ZS;
...
/// @brief Method CloneCurve, addr 0x24544bc, size 0x50, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method CreateCacheSafeLookupTable, addr 0x2454754, size 0x1a0, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x2454584, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x245468c, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method FromBigInteger, addr 0x2454528, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method SupportsCoordinateSystem, addr 0x245450c, size 0xc, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Point*> const& __cordl_internal_get_m_infinity() const;

constexpr void __cordl_internal_set_m_infinity(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Point*  value) ;

/// @brief Method .ctor, addr 0x2454304, size 0x1b0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_FieldSize, addr 0x2454520, size 0x8, virtual true, abstract: false, final false
inline int32_t get_FieldSize() ;

/// @brief Method get_Infinity, addr 0x2454518, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_IsKoblitz, addr 0x2454724, size 0x8, virtual true, abstract: false, final false
inline bool get_IsKoblitz() ;

/// @brief Method get_IsTrinomial, addr 0x2454734, size 0x8, virtual true, abstract: false, final false
inline bool get_IsTrinomial() ;

/// @brief Method get_K1, addr 0x245473c, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K1() ;

/// @brief Method get_K2, addr 0x2454744, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K2() ;

/// @brief Method get_K3, addr 0x245474c, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K3() ;

/// @brief Method get_M, addr 0x245472c, size 0x8, virtual true, abstract: false, final false
...
NEED_NO_BOX(::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT233R1Curve__SecT233R1LookupTable);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT233R1Curve__SecT233R1LookupTable*, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecT233R1Curve/SecT233R1LookupTable");
