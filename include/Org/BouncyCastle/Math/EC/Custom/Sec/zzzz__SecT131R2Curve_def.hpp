...
/// @brief Method CreatePoint, addr 0x24429f8, size 0xe0, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint64_t,::Array<uint64_t>*>  x, ::ArrayW<uint64_t,::Array<uint64_t>*>  y) ;

/// @brief Method Lookup, addr 0x24428f0, size 0x108, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar, addr 0x2442ad8, size 0xcc, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t  index) ;

static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT131R2Curve__SecT131R2LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT131R2Curve*  outer, ::ArrayW<uint64_t,::Array<uint64_t>*>  table, int32_t  size) ;

constexpr ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT131R2Curve*& __cordl_internal_get_m_outer() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT131R2Curve*> const& __cordl_internal_get_m_outer() const;
...
/// @brief Method .ctor, addr 0x24427a0, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_Size, addr 0x24428e8, size 0x8, virtual true, abstract: false, final false
...
static_assert(offsetof(::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT131R2Curve__SecT131R2LookupTable, ___m_outer) == 0x10, "Offset mismatch!");

static_assert(offsetof(::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT131R2Curve__SecT131R2LookupTable, ___m_table) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT131R2Curve__SecT131R2LookupTable, ___m_size) == 0x20, "Offset mismatch!");
...
static __declspec(property(get=getStaticF_SECT131R2_AFFINE_ZS, put=setStaticF_SECT131R2_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*,::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*>  SECT131R2_AFFINE_ZS;
...
/// @brief Method CloneCurve, addr 0x2442368, size 0x50, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method CreateCacheSafeLookupTable, addr 0x24425fc, size 0x1a4, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x2442424, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x244252c, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method FromBigInteger, addr 0x24423cc, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method SupportsCoordinateSystem, addr 0x24423b8, size 0xc, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT131R2Point*> const& __cordl_internal_get_m_infinity() const;

constexpr void __cordl_internal_set_m_infinity(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT131R2Point*  value) ;

/// @brief Method .ctor, addr 0x244216c, size 0x1f4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_FieldSize, addr 0x24423c4, size 0x8, virtual true, abstract: false, final false
inline int32_t get_FieldSize() ;

/// @brief Method get_Infinity, addr 0x24425c4, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_IsKoblitz, addr 0x24425cc, size 0x8, virtual true, abstract: false, final false
inline bool get_IsKoblitz() ;

/// @brief Method get_IsTrinomial, addr 0x24425dc, size 0x8, virtual true, abstract: false, final false
inline bool get_IsTrinomial() ;

/// @brief Method get_K1, addr 0x24425e4, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K1() ;

/// @brief Method get_K2, addr 0x24425ec, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K2() ;

/// @brief Method get_K3, addr 0x24425f4, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K3() ;

/// @brief Method get_M, addr 0x24425d4, size 0x8, virtual true, abstract: false, final false
