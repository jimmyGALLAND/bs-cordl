...
/// @brief Method CreatePoint, addr 0x2469220, size 0xe0, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint64_t,::Array<uint64_t>*>  x, ::ArrayW<uint64_t,::Array<uint64_t>*>  y) ;

/// @brief Method Lookup, addr 0x2469118, size 0x108, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar, addr 0x2469300, size 0xcc, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t  index) ;

static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::__SecT571R1Curve__SecT571R1LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT571R1Curve*  outer, ::ArrayW<uint64_t,::Array<uint64_t>*>  table, int32_t  size) ;

constexpr ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT571R1Curve*& __cordl_internal_get_m_outer() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT571R1Curve*> const& __cordl_internal_get_m_outer() const;
...
/// @brief Method .ctor, addr 0x2468eb4, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_Size, addr 0x2469110, size 0x8, virtual true, abstract: false, final false
...
static __declspec(property(get=getStaticF_SECT571R1_AFFINE_ZS, put=setStaticF_SECT571R1_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*,::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*>  SECT571R1_AFFINE_ZS;
...
/// @brief Method CloneCurve, addr 0x2468a78, size 0x50, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method CreateCacheSafeLookupTable, addr 0x2468d10, size 0x1a4, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x2468b40, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x2468c48, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method FromBigInteger, addr 0x2468ae4, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method SupportsCoordinateSystem, addr 0x2468ac8, size 0xc, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT571R1Point*> const& __cordl_internal_get_m_infinity() const;

constexpr void __cordl_internal_set_m_infinity(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT571R1Point*  value) ;

/// @brief Method .ctor, addr 0x24688e8, size 0x188, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_FieldSize, addr 0x2468adc, size 0x8, virtual true, abstract: false, final false
inline int32_t get_FieldSize() ;

/// @brief Method get_Infinity, addr 0x2468ad4, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_IsKoblitz, addr 0x2468ce0, size 0x8, virtual true, abstract: false, final false
inline bool get_IsKoblitz() ;

/// @brief Method get_IsTrinomial, addr 0x2468cf0, size 0x8, virtual true, abstract: false, final false
inline bool get_IsTrinomial() ;

/// @brief Method get_K1, addr 0x2468cf8, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K1() ;

/// @brief Method get_K2, addr 0x2468d00, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K2() ;

/// @brief Method get_K3, addr 0x2468d08, size 0x8, virtual true, abstract: false, final false
inline int32_t get_K3() ;

/// @brief Method get_M, addr 0x2468ce8, size 0x8, virtual true, abstract: false, final false
