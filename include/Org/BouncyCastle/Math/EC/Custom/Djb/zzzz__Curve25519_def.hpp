...
/// @brief Method CreatePoint, addr 0x2404ff4, size 0xe0, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* CreatePoint(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  y) ;

/// @brief Method Lookup, addr 0x2404edc, size 0x118, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar, addr 0x24050d4, size 0xc4, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t  index) ;

static inline ::Org::BouncyCastle::Math::EC::Custom::Djb::__Curve25519__Curve25519LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519*  outer, ::ArrayW<uint32_t,::Array<uint32_t>*>  table, int32_t  size) ;
...
/// @brief Method .ctor, addr 0x240498c, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519*  outer, ::ArrayW<uint32_t,::Array<uint32_t>*>  table, int32_t  size) ;

/// @brief Method get_Size, addr 0x2404ed4, size 0x8, virtual true, abstract: false, final false
...
static __declspec(property(get=getStaticF_CURVE25519_AFFINE_ZS, put=setStaticF_CURVE25519_AFFINE_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*,::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*>  CURVE25519_AFFINE_ZS;
...
/// @brief Method CloneCurve, addr 0x24043cc, size 0x50, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method CreateCacheSafeLookupTable, addr 0x24047ec, size 0x1a0, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x2404658, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method CreateRawPoint, addr 0x240475c, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method FromBigInteger, addr 0x24044ec, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method RandomFieldElement, addr 0x24049c8, size 0x9c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom*  r) ;

/// @brief Method RandomFieldElementMult, addr 0x2404b84, size 0x9c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom*  r) ;

/// @brief Method SupportsCoordinateSystem, addr 0x240441c, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2404230, size 0x194, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_FieldSize, addr 0x2404488, size 0x64, virtual true, abstract: false, final false
inline int32_t get_FieldSize() ;

/// @brief Method get_Infinity, addr 0x2404480, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_Q, addr 0x2404428, size 0x58, virtual true, abstract: false, final false
