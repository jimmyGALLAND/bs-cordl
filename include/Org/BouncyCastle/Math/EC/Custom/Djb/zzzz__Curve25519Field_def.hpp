...
/// @brief Method Add, addr 0x2405198, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method AddExt, addr 0x24052c0, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method AddOne, addr 0x24054e4, size 0xb0, virtual false, abstract: false, final false
static inline void AddOne(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method AddPExtTo, addr 0x24060b4, size 0x164, virtual false, abstract: false, final false
static inline uint32_t AddPExtTo(::ArrayW<uint32_t,::Array<uint32_t>*>  zz) ;

/// @brief Method AddPTo, addr 0x2405fac, size 0x78, virtual false, abstract: false, final false
static inline uint32_t AddPTo(::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method FromBigInteger, addr 0x2405594, size 0xac, virtual false, abstract: false, final false
static inline ::ArrayW<uint32_t,::Array<uint32_t>*> FromBigInteger(::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method Half, addr 0x2405640, size 0xbc, virtual false, abstract: false, final false
static inline void Half(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method Inv, addr 0x24056fc, size 0x284, virtual false, abstract: false, final false
static inline void Inv(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method IsZero, addr 0x2405980, size 0x54, virtual false, abstract: false, final false
static inline int32_t IsZero(::ArrayW<uint32_t,::Array<uint32_t>*>  x) ;

/// @brief Method Multiply, addr 0x2405a54, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method MultiplyAddToExt, addr 0x2405ce4, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method Negate, addr 0x2405d9c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method Random, addr 0x2404a64, size 0xf8, virtual false, abstract: false, final false
static inline void Random(::Org::BouncyCastle::Security::SecureRandom*  r, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method RandomMult, addr 0x2404c20, size 0x6c, virtual false, abstract: false, final false
static inline void RandomMult(::Org::BouncyCastle::Security::SecureRandom*  r, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method Reduce, addr 0x2405ba8, size 0x13c, virtual false, abstract: false, final false
static inline void Reduce(::ArrayW<uint32_t,::Array<uint32_t>*>  xx, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method Reduce27, addr 0x2405e34, size 0xec, virtual false, abstract: false, final false
static inline void Reduce27(uint32_t  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method Square, addr 0x24059d4, size 0x80, virtual false, abstract: false, final false
static inline void Square(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method SquareN, addr 0x2405adc, size 0xcc, virtual false, abstract: false, final false
static inline void SquareN(::ArrayW<uint32_t,::Array<uint32_t>*>  x, int32_t  n, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method SubPExtFrom, addr 0x240537c, size 0x168, virtual false, abstract: false, final false
static inline int32_t SubPExtFrom(::ArrayW<uint32_t,::Array<uint32_t>*>  zz) ;

/// @brief Method SubPFrom, addr 0x240524c, size 0x74, virtual false, abstract: false, final false
static inline int32_t SubPFrom(::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method Subtract, addr 0x2405f20, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method SubtractExt, addr 0x2406024, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method Twice, addr 0x2406218, size 0xb4, virtual false, abstract: false, final false
static inline void Twice(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method .ctor, addr 0x240639c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
