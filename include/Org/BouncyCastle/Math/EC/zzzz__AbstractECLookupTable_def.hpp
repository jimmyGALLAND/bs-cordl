...
/// @brief Method LookupVar, addr 0x2403c20, size 0xc, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t  index) ;

static inline ::Org::BouncyCastle::Math::EC::AbstractECLookupTable* New_ctor() ;

/// @brief Method .ctor, addr 0x240384c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
