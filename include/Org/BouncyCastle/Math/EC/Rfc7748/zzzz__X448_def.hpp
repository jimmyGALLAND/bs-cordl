...
public:
// Declarations
/// @brief Method CalculateAgreement, addr 0x2473590, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method Decode32, addr 0x2473940, size 0x68, virtual false, abstract: false, final false
static inline uint32_t Decode32(::ArrayW<uint8_t,::Array<uint8_t>*>  bs, int32_t  off) ;

/// @brief Method DecodeScalar, addr 0x24739a8, size 0x8c, virtual false, abstract: false, final false
static inline void DecodeScalar(::ArrayW<uint8_t,::Array<uint8_t>*>  k, int32_t  kOff, ::ArrayW<uint32_t,::Array<uint32_t>*>  n) ;

/// @brief Method GeneratePrivateKey, addr 0x2473a34, size 0x54, virtual false, abstract: false, final false
static inline void GeneratePrivateKey(::Org::BouncyCastle::Security::SecureRandom*  random, ::ArrayW<uint8_t,::Array<uint8_t>*>  k) ;

/// @brief Method GeneratePublicKey, addr 0x2473a88, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method PointDouble, addr 0x2473b70, size 0xb8, virtual false, abstract: false, final false
static inline void PointDouble(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method Precompute, addr 0x24750b8, size 0x50, virtual false, abstract: false, final false
static inline void Precompute() ;

/// @brief Method ScalarMult, addr 0x2473644, size 0x2fc, virtual false, abstract: false, final false
...
/// @brief Method ScalarMultBase, addr 0x2473a8c, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24753bc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
