...
/// @brief Method Precompute, addr 0x24088b0, size 0x11c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2407ee8, size 0x40, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF_EMPTY_ZS, put=setStaticF_EMPTY_ZS)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*,::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*>  EMPTY_ZS;
...
/// @brief Field m_zs, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_zs, put=__cordl_internal_set_m_zs)) ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*,::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*>  m_zs;

/// @brief Method Add, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Add(::Org::BouncyCastle::Math::EC::ECPoint*  b) ;

/// @brief Method CheckNormalized, addr 0x2407ae4, size 0x68, virtual true, abstract: false, final false
inline void CheckNormalized() ;

/// @brief Method CreateScaledPoint, addr 0x2407e38, size 0x9c, virtual true, abstract: false, final false
...
/// @brief Method Equals, addr 0x24081c8, size 0x8c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2408254, size 0x2ac, virtual true, abstract: false, final false
inline bool Equals(::Org::BouncyCastle::Math::EC::ECPoint*  other) ;

/// @brief Method GetDetachedPoint, addr 0x240794c, size 0x2c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* GetDetachedPoint() ;

/// @brief Method GetEncoded, addr 0x240870c, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method GetHashCode, addr 0x2408500, size 0xc4, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetInitialZCoords, addr 0x2407494, size 0x2c8, virtual false, abstract: false, final false
...
/// @brief Method GetZCoord, addr 0x2407a04, size 0x40, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* GetZCoord(int32_t  index) ;

/// @brief Method GetZCoords, addr 0x2407a44, size 0x88, virtual true, abstract: false, final false
inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*,::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*> GetZCoords() ;

/// @brief Method ImplIsValid, addr 0x2403624, size 0x13c, virtual false, abstract: false, final false
inline bool ImplIsValid(bool  decompressed, bool  checkOrder) ;

/// @brief Method IsNormalized, addr 0x2407b4c, size 0x70, virtual true, abstract: false, final false
inline bool IsNormalized() ;

/// @brief Method IsValid, addr 0x2401ea8, size 0xc, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method IsValidPartial, addr 0x2407edc, size 0xc, virtual false, abstract: false, final false
...
static inline ::Org::BouncyCastle::Math::EC::ECPoint* New_ctor(::Org::BouncyCastle::Math::EC::ECCurve*  curve, ::Org::BouncyCastle::Math::EC::ECFieldElement*  x, ::Org::BouncyCastle::Math::EC::ECFieldElement*  y, bool  withCompression) ;

static inline ::Org::BouncyCastle::Math::EC::ECPoint* New_ctor(::Org::BouncyCastle::Math::EC::ECCurve*  curve, ::Org::BouncyCastle::Math::EC::ECFieldElement*  x, ::Org::BouncyCastle::Math::EC::ECFieldElement*  y, ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*,::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*>  zs, bool  withCompression) ;

/// @brief Method Normalize, addr 0x2407bbc, size 0x18c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Normalize() ;

/// @brief Method Normalize, addr 0x2407d48, size 0xf0, virtual true, abstract: false, final false
...
/// @brief Method SatisfiesOrder, addr 0x240784c, size 0x100, virtual true, abstract: false, final false
inline bool SatisfiesOrder() ;

/// @brief Method ScaleX, addr 0x2407f28, size 0x90, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* ScaleX(::Org::BouncyCastle::Math::EC::ECFieldElement*  scale) ;

/// @brief Method ScaleXNegateY, addr 0x2407fb8, size 0xb0, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* ScaleXNegateY(::Org::BouncyCastle::Math::EC::ECFieldElement*  scale) ;

/// @brief Method ScaleY, addr 0x2408068, size 0xa4, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* ScaleY(::Org::BouncyCastle::Math::EC::ECFieldElement*  scale) ;

/// @brief Method ScaleYNegateX, addr 0x240810c, size 0xbc, virtual true, abstract: false, final false
...
/// @brief Method ThreeTimes, addr 0x24087f8, size 0x14, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* ThreeTimes() ;

/// @brief Method TimesPow2, addr 0x2408720, size 0x9c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* TimesPow2(int32_t  e) ;

/// @brief Method ToString, addr 0x24085c4, size 0x148, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Twice, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Twice() ;

/// @brief Method TwicePlus, addr 0x24087bc, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x240775c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve*  curve, ::Org::BouncyCastle::Math::EC::ECFieldElement*  x, ::Org::BouncyCastle::Math::EC::ECFieldElement*  y, bool  withCompression) ;

/// @brief Method .ctor, addr 0x24077f8, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method get_AffineXCoord, addr 0x240799c, size 0x2c, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_AffineXCoord() ;

/// @brief Method get_AffineYCoord, addr 0x24079c8, size 0x2c, virtual true, abstract: false, final false
...
/// @brief Method get_Curve, addr 0x2407978, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* get_Curve() ;

/// @brief Method get_CurveCoordinateSystem, addr 0x2407980, size 0x1c, virtual true, abstract: false, final false
inline int32_t get_CurveCoordinateSystem() ;

/// @brief Method get_IsCompressed, addr 0x2407ed4, size 0x8, virtual false, abstract: false, final false
inline bool get_IsCompressed() ;

/// @brief Method get_IsInfinity, addr 0x24026f0, size 0x20, virtual false, abstract: false, final false
inline bool get_IsInfinity() ;

/// @brief Method get_RawXCoord, addr 0x2407acc, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_RawXCoord() ;

/// @brief Method get_RawYCoord, addr 0x2407ad4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_RawYCoord() ;

/// @brief Method get_RawZCoords, addr 0x2407adc, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*,::Array<::Org::BouncyCastle::Math::EC::ECFieldElement*>*> get_RawZCoords() ;

/// @brief Method get_XCoord, addr 0x24079f4, size 0x8, virtual true, abstract: false, final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* get_XCoord() ;

/// @brief Method get_YCoord, addr 0x24079fc, size 0x8, virtual true, abstract: false, final false
