...
/// @brief Method ProbablyPrime, addr 0x24cee54, size 0x5c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::__Primes__MROutput* ProbablyPrime() ;

/// @brief Method ProvablyCompositeNotPrimePower, addr 0x24cef44, size 0x60, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::__Primes__MROutput* ProvablyCompositeNotPrimePower() ;

/// @brief Method ProvablyCompositeWithFactor, addr 0x24ceee0, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24ceeb0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(bool  provablyComposite, ::Org::BouncyCastle::Math::BigInteger*  factor) ;

/// @brief Method get_Factor, addr 0x24cefa4, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Factor() ;

/// @brief Method get_IsNotPrimePower, addr 0x24cefb4, size 0x20, virtual false, abstract: false, final false
inline bool get_IsNotPrimePower() ;

/// @brief Method get_IsProvablyComposite, addr 0x24cefac, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24cefd4, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::Org::BouncyCastle::Math::BigInteger*  prime, ::ArrayW<uint8_t,::Array<uint8_t>*>  primeSeed, int32_t  primeGenCounter) ;

/// @brief Method get_Prime, addr 0x24cf010, size 0x8, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Math::BigInteger* get_Prime() ;

/// @brief Method get_PrimeGenCounter, addr 0x24cf020, size 0x8, virtual false, abstract: false, final false
inline int32_t get_PrimeGenCounter() ;

/// @brief Method get_PrimeSeed, addr 0x24cf018, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method CheckCandidate, addr 0x24cd978, size 0x80, virtual false, abstract: false, final false
static inline void CheckCandidate(::Org::BouncyCastle::Math::BigInteger*  n, ::StringW  name) ;

/// @brief Method EnhancedMRProbablePrimeTest, addr 0x24cd4f4, size 0x484, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Math::__Primes__MROutput* EnhancedMRProbablePrimeTest(::Org::BouncyCastle::Math::BigInteger*  candidate, ::Org::BouncyCastle::Security::SecureRandom*  random, int32_t  iterations) ;

/// @brief Method Extract32, addr 0x24cea18, size 0xc8, virtual false, abstract: false, final false
static inline uint32_t Extract32(::ArrayW<uint8_t,::Array<uint8_t>*>  bs) ;

/// @brief Method GenerateSTRandomPrime, addr 0x24ccd10, size 0x19c, virtual false, abstract: false, final false
...
/// @brief Method HasAnySmallFactors, addr 0x24cd9f8, size 0x74, virtual false, abstract: false, final false
static inline bool HasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger*  candidate) ;

/// @brief Method Hash, addr 0x24ce890, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method HashGen, addr 0x24cec40, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method ImplHasAnySmallFactors, addr 0x24cda6c, size 0x8d4, virtual false, abstract: false, final false
static inline bool ImplHasAnySmallFactors(::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method ImplMRProbablePrimeToBase, addr 0x24ce56c, size 0x16c, virtual false, abstract: false, final false
static inline bool ImplMRProbablePrimeToBase(::Org::BouncyCastle::Math::BigInteger*  w, ::Org::BouncyCastle::Math::BigInteger*  wSubOne, ::Org::BouncyCastle::Math::BigInteger*  m, int32_t  a, ::Org::BouncyCastle::Math::BigInteger*  b) ;

/// @brief Method ImplSTRandomPrime, addr 0x24cceac, size 0x648, virtual false, abstract: false, final false
...
/// @brief Method Inc, addr 0x24ce9c4, size 0x54, virtual false, abstract: false, final false
static inline void Inc(::ArrayW<uint8_t,::Array<uint8_t>*>  seed, int32_t  c) ;

/// @brief Method IsMRProbablePrime, addr 0x24ce340, size 0x22c, virtual false, abstract: false, final false
...
/// @brief Method IsMRProbablePrimeToBase, addr 0x24ce6d8, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method IsPrime32, addr 0x24ceae0, size 0x160, virtual false, abstract: false, final false
static inline bool IsPrime32(uint32_t  x) ;

static inline ::Org::BouncyCastle::Math::Primes* New_ctor() ;

/// @brief Method .ctor, addr 0x24cee4c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
