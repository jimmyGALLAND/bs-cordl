...
public:
// Declarations
/// @brief Method Mul, addr 0x24c22ac, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method Square, addr 0x24c241c, size 0x114, virtual false, abstract: false, final false
static inline void Square(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  zz) ;

/// @brief Method .ctor, addr 0x24c2530, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
