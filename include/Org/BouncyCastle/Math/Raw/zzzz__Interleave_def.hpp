...
public:
// Declarations
/// @brief Method Expand16to32, addr 0x2491084, size 0x28, virtual false, abstract: false, final false
static inline uint32_t Expand16to32(uint32_t  x) ;

/// @brief Method Expand32to64, addr 0x24910ac, size 0x58, virtual false, abstract: false, final false
static inline uint64_t Expand32to64(uint32_t  x) ;

/// @brief Method Expand64To128, addr 0x2491104, size 0xa8, virtual false, abstract: false, final false
static inline void Expand64To128(uint64_t  x, ::ArrayW<uint64_t,::Array<uint64_t>*>  z, int32_t  zOff) ;

/// @brief Method Expand64To128Rev, addr 0x24911ac, size 0xa8, virtual false, abstract: false, final false
static inline void Expand64To128Rev(uint64_t  x, ::ArrayW<uint64_t,::Array<uint64_t>*>  z, int32_t  zOff) ;

/// @brief Method Expand8to16, addr 0x2491064, size 0x20, virtual false, abstract: false, final false
static inline uint32_t Expand8to16(uint32_t  x) ;

static inline ::Org::BouncyCastle::Math::Raw::Interleave* New_ctor() ;

/// @brief Method Shuffle, addr 0x2491254, size 0x48, virtual false, abstract: false, final false
static inline uint32_t Shuffle(uint32_t  x) ;

/// @brief Method Shuffle, addr 0x249129c, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t Shuffle(uint64_t  x) ;

/// @brief Method Shuffle2, addr 0x24912f8, size 0x54, virtual false, abstract: false, final false
static inline uint32_t Shuffle2(uint32_t  x) ;

/// @brief Method Unshuffle, addr 0x249134c, size 0x48, virtual false, abstract: false, final false
static inline uint32_t Unshuffle(uint32_t  x) ;

/// @brief Method Unshuffle, addr 0x2491394, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t Unshuffle(uint64_t  x) ;

/// @brief Method Unshuffle2, addr 0x24913f0, size 0x54, virtual false, abstract: false, final false
static inline uint32_t Unshuffle2(uint32_t  x) ;

/// @brief Method .ctor, addr 0x2491444, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
