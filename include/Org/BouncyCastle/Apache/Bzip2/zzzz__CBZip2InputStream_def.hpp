...
/// @brief Method BadBlockHeader, addr 0x25b5ad4, size 0x4, virtual false, abstract: false, final false
static inline void BadBlockHeader() ;

/// @brief Method BlockOverrun, addr 0x25b651c, size 0x4, virtual false, abstract: false, final false
static inline void BlockOverrun() ;

/// @brief Method BsFinishedWithStream, addr 0x25b5944, size 0xdc, virtual false, abstract: false, final false
inline void BsFinishedWithStream() ;

/// @brief Method BsGetInt32, addr 0x25b5ad8, size 0x4, virtual false, abstract: false, final false
inline int32_t BsGetInt32() ;

/// @brief Method BsGetIntVS, addr 0x25b657c, size 0x4, virtual false, abstract: false, final false
inline int32_t BsGetIntVS(int32_t  numBits) ;

/// @brief Method BsGetUChar, addr 0x25b5930, size 0x14, virtual false, abstract: false, final false
inline char16_t BsGetUChar() ;

/// @brief Method BsGetint, addr 0x25b6520, size 0x5c, virtual false, abstract: false, final false
inline int32_t BsGetint() ;

/// @brief Method BsR, addr 0x25b5adc, size 0x108, virtual false, abstract: false, final false
inline int32_t BsR(int32_t  n) ;

/// @brief Method BsSetStream, addr 0x25b5110, size 0xc, virtual false, abstract: false, final false
inline void BsSetStream(::System::IO::Stream*  f) ;

/// @brief Method Cadvise, addr 0x25b4ddc, size 0x4, virtual false, abstract: false, final false
static inline void Cadvise() ;

/// @brief Method Complete, addr 0x25b5aac, size 0x28, virtual false, abstract: false, final false
inline void Complete() ;

/// @brief Method CompressedStreamEOF, addr 0x25b4de0, size 0x4, virtual false, abstract: false, final false
static inline void CompressedStreamEOF() ;

/// @brief Method CrcError, addr 0x25b6518, size 0x4, virtual false, abstract: false, final false
static inline void CrcError() ;

/// @brief Method EndBlock, addr 0x25b64e0, size 0x2c, virtual false, abstract: false, final false
inline void EndBlock() ;

/// @brief Method Flush, addr 0x25b6f14, size 0x4, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method GetAndMoveToFrontDecode, addr 0x25b5be4, size 0x8f0, virtual false, abstract: false, final false
inline void GetAndMoveToFrontDecode() ;

/// @brief Method HbCreateDecodeTables, addr 0x25b6580, size 0x200, virtual false, abstract: false, final false
inline void HbCreateDecodeTables(::ArrayW<int32_t,::Array<int32_t>*>  limit, ::ArrayW<int32_t,::Array<int32_t>*>  basev, ::ArrayW<int32_t,::Array<int32_t>*>  perm, ::ArrayW<char16_t,::Array<char16_t>*>  length, int32_t  minLen, int32_t  maxLen, int32_t  alphaSize) ;

/// @brief Method InitBlock, addr 0x25b5204, size 0x174, virtual false, abstract: false, final false
inline void InitBlock() ;

/// @brief Method InitCharArray, addr 0x25b5544, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method InitIntArray, addr 0x25b504c, size 0xc4, virtual false, abstract: false, final false
static inline ::ArrayW<::ArrayW<int32_t,::Array<int32_t>*>,::Array<::ArrayW<int32_t,::Array<int32_t>*>>*> InitIntArray(int32_t  n1, int32_t  n2) ;

/// @brief Method Initialize, addr 0x25b511c, size 0xe8, virtual false, abstract: false, final false
inline void Initialize() ;

/// @brief Method MakeMaps, addr 0x25b4de4, size 0x8c, virtual false, abstract: false, final false
inline void MakeMaps() ;

static inline ::Org::BouncyCastle::Apache::Bzip2::CBZip2InputStream* New_ctor(::System::IO::Stream*  zStream) ;

/// @brief Method Read, addr 0x25b6f18, size 0xa8, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method ReadByte, addr 0x25b5608, size 0x64, virtual true, abstract: false, final false
inline int32_t ReadByte() ;

/// @brief Method RecvDecodingTables, addr 0x25b6780, size 0x4d4, virtual false, abstract: false, final false
inline void RecvDecodingTables() ;

/// @brief Method Seek, addr 0x25b6fc0, size 0x8, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetDecompressStructureSizes, addr 0x25b5a20, size 0x8c, virtual false, abstract: false, final false
inline void SetDecompressStructureSizes(int32_t  newSize100k) ;

/// @brief Method SetLength, addr 0x25b6fc8, size 0x4, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method SetupBlock, addr 0x25b5378, size 0x1cc, virtual false, abstract: false, final false
inline void SetupBlock() ;

/// @brief Method SetupNoRandPartA, addr 0x25b6db4, size 0xbc, virtual false, abstract: false, final false
inline void SetupNoRandPartA() ;

/// @brief Method SetupNoRandPartB, addr 0x25b5824, size 0xa8, virtual false, abstract: false, final false
inline void SetupNoRandPartB() ;

/// @brief Method SetupNoRandPartC, addr 0x25b58cc, size 0x64, virtual false, abstract: false, final false
inline void SetupNoRandPartC() ;

/// @brief Method SetupRandPartA, addr 0x25b6c54, size 0x160, virtual false, abstract: false, final false
inline void SetupRandPartA() ;

/// @brief Method SetupRandPartB, addr 0x25b566c, size 0x154, virtual false, abstract: false, final false
inline void SetupRandPartB() ;

/// @brief Method SetupRandPartC, addr 0x25b57c0, size 0x64, virtual false, abstract: false, final false
inline void SetupRandPartC() ;

/// @brief Method Write, addr 0x25b6fcc, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25b4e70, size 0x1bc, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  zStream) ;

/// @brief Method get_CanRead, addr 0x25b6fd0, size 0x8, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x25b6fd8, size 0x8, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanWrite, addr 0x25b6fe0, size 0x8, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Length, addr 0x25b6fe8, size 0x8, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Position, addr 0x25b6ff0, size 0x8, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method set_Position, addr 0x25b6ff8, size 0x4, virtual true, abstract: false, final false
