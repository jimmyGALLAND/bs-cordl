...
/// @brief Method GetFinalCRC, addr 0x25b650c, size 0xc, virtual false, abstract: false, final false
inline int32_t GetFinalCRC() ;

/// @brief Method GetGlobalCRC, addr 0x25b6ffc, size 0x8, virtual false, abstract: false, final false
inline int32_t GetGlobalCRC() ;

/// @brief Method InitialiseCRC, addr 0x25b64d4, size 0xc, virtual false, abstract: false, final false
inline void InitialiseCRC() ;

static inline ::Org::BouncyCastle::Apache::Bzip2::CRC* New_ctor() ;

/// @brief Method SetGlobalCRC, addr 0x25b7004, size 0x8, virtual false, abstract: false, final false
inline void SetGlobalCRC(int32_t  newCrc) ;

/// @brief Method UpdateCRC, addr 0x25b6e70, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25b502c, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
