...
/// @brief Method .ctor, addr 0x24dc0d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AllocateCompressStructures, addr 0x24d9b30, size 0xe0, virtual false, abstract: false, final false
inline void AllocateCompressStructures() ;

/// @brief Method BsFinishedWithStream, addr 0x24da3c8, size 0xec, virtual false, abstract: false, final false
inline void BsFinishedWithStream() ;

/// @brief Method BsPutIntVS, addr 0x24da53c, size 0x4, virtual false, abstract: false, final false
inline void BsPutIntVS(int32_t  numBits, int32_t  c) ;

/// @brief Method BsPutUChar, addr 0x24da17c, size 0xc, virtual false, abstract: false, final false
inline void BsPutUChar(int32_t  c) ;

/// @brief Method BsPutint, addr 0x24da23c, size 0x54, virtual false, abstract: false, final false
inline void BsPutint(int32_t  u) ;

/// @brief Method BsSetStream, addr 0x24d9b20, size 0x10, virtual false, abstract: false, final false
inline void BsSetStream(::System::IO::Stream*  f) ;

/// @brief Method BsW, addr 0x24da290, size 0x110, virtual false, abstract: false, final false
inline void BsW(int32_t  n, int32_t  v) ;

/// @brief Method Close, addr 0x24da050, size 0x8c, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method DoReversibleTransformation, addr 0x24da188, size 0xb4, virtual false, abstract: false, final false
inline void DoReversibleTransformation() ;

/// @brief Method EndBlock, addr 0x24d9f70, size 0xe0, virtual false, abstract: false, final false
inline void EndBlock() ;

/// @brief Method EndCompression, addr 0x24da0dc, size 0x7c, virtual false, abstract: false, final false
inline void EndCompression() ;

/// @brief Method Finish, addr 0x24d91b0, size 0x64, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method Flush, addr 0x24da158, size 0x24, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FullGtU, addr 0x24db8c8, size 0x314, virtual false, abstract: false, final false
inline bool FullGtU(int32_t  i1, int32_t  i2) ;

/// @brief Method GenerateMTFValues, addr 0x24db220, size 0x39c, virtual false, abstract: false, final false
inline void GenerateMTFValues() ;

/// @brief Method HbAssignCodes, addr 0x24da4b4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method HbMakeCodeLengths, addr 0x24d92d4, size 0x63c, virtual false, abstract: false, final false
...
/// @brief Method InitBlock, addr 0x24d9c4c, size 0x74, virtual false, abstract: false, final false
inline void InitBlock() ;

/// @brief Method Initialize, addr 0x24d9c10, size 0x3c, virtual false, abstract: false, final false
inline void Initialize() ;

/// @brief Method MainSort, addr 0x24dc0dc, size 0x7ec, virtual false, abstract: false, final false
inline void MainSort() ;

/// @brief Method MakeMaps, addr 0x24d9248, size 0x8c, virtual false, abstract: false, final false
inline void MakeMaps() ;

/// @brief Method Med3, addr 0x24dbc44, size 0x2c, virtual false, abstract: false, final false
inline char16_t Med3(char16_t  a, char16_t  b, char16_t  c) ;

/// @brief Method MoveToFrontCodeAndSend, addr 0x24da3a0, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method Panic, addr 0x24d9244, size 0x4, virtual false, abstract: false, final false
static inline void Panic() ;

/// @brief Method QSort3, addr 0x24dbc70, size 0x464, virtual false, abstract: false, final false
inline void QSort3(int32_t  loSt, int32_t  hiSt, int32_t  dSt) ;

/// @brief Method RandomiseBlock, addr 0x24dc8c8, size 0x138, virtual false, abstract: false, final false
inline void RandomiseBlock() ;

/// @brief Method Read, addr 0x24dca00, size 0x8, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method Seek, addr 0x24dca08, size 0x8, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SendMTFValues, addr 0x24da540, size 0xce0, virtual false, abstract: false, final false
inline void SendMTFValues() ;

/// @brief Method SetLength, addr 0x24dca10, size 0x4, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method SimpleSort, addr 0x24db5bc, size 0x30c, virtual false, abstract: false, final false
inline void SimpleSort(int32_t  lo, int32_t  hi, int32_t  d) ;

/// @brief Method Vswap, addr 0x24dbbdc, size 0x68, virtual false, abstract: false, final false
inline void Vswap(int32_t  p1, int32_t  p2, int32_t  n) ;

/// @brief Method Write, addr 0x24dca14, size 0x88, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method WriteByte, addr 0x24d9cc0, size 0x74, virtual true, abstract: false, final false
inline void WriteByte(uint8_t  bv) ;

/// @brief Method WriteRun, addr 0x24d9d34, size 0x23c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x24d91a4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  inStream) ;

/// @brief Method .ctor, addr 0x24d9910, size 0x210, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  inStream, int32_t  inBlockSize) ;

/// @brief Method get_CanRead, addr 0x24dca9c, size 0x8, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x24dcaa4, size 0x8, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanWrite, addr 0x24dcaac, size 0x8, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Length, addr 0x24dcab4, size 0x8, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Position, addr 0x24dcabc, size 0x8, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method set_Position, addr 0x24dcac4, size 0x4, virtual true, abstract: false, final false
