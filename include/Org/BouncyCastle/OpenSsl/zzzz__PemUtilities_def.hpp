...
/// @brief Method Crypt, addr 0x2503e18, size 0x4f0, virtual false, abstract: false, final false
...
/// @brief Method GetCipherParameters, addr 0x2506cac, size 0x140, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Crypto::ICipherParameters* GetCipherParameters(::ArrayW<char16_t,::Array<char16_t>*>  password, ::Org::BouncyCastle::OpenSsl::__PemUtilities__PemBaseAlg  baseAlg, ::ArrayW<uint8_t,::Array<uint8_t>*>  salt) ;

static inline ::Org::BouncyCastle::OpenSsl::PemUtilities* New_ctor() ;

/// @brief Method ParseDekAlgName, addr 0x250695c, size 0x350, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2506dec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
