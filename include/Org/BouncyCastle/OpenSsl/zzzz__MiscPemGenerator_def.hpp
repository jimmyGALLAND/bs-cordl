...
/// @brief Method CreatePemObject, addr 0x2502d54, size 0x640, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Utilities::IO::Pem::PemObject* CreatePemObject(::System::Object*  obj) ;

/// @brief Method CreatePemObject, addr 0x250387c, size 0x59c, virtual false, abstract: false, final false
static inline ::Org::BouncyCastle::Utilities::IO::Pem::PemObject* CreatePemObject(::System::Object*  obj, ::StringW  algorithm, ::ArrayW<char16_t,::Array<char16_t>*>  password, ::Org::BouncyCastle::Security::SecureRandom*  random) ;

/// @brief Method EncodePrivateKey, addr 0x2503394, size 0x4e8, virtual false, abstract: false, final false
...
/// @brief Method Generate, addr 0x2504308, size 0xf0, virtual true, abstract: false, final true
...
static inline ::Org::BouncyCastle::OpenSsl::MiscPemGenerator* New_ctor(::System::Object*  obj, ::StringW  algorithm, ::ArrayW<char16_t,::Array<char16_t>*>  password, ::Org::BouncyCastle::Security::SecureRandom*  random) ;
...
/// @brief Method .ctor, addr 0x2502cec, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  obj) ;

/// @brief Method .ctor, addr 0x2502d14, size 0x40, virtual false, abstract: false, final false
