...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<char16_t,::Array<char16_t>*> (::Org::BouncyCastle::OpenSsl::IPasswordFinder::*)()>(&::Org::BouncyCastle::OpenSsl::IPasswordFinder::GetPassword)> {
