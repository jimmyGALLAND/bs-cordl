...
/// @brief Method GetCurveParameters, addr 0x2506748, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method ReadAttributeCertificate, addr 0x2506648, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method ReadCertificate, addr 0x250627c, size 0x15c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Certificate* ReadCertificate(::Org::BouncyCastle::Utilities::IO::Pem::PemObject*  pemObject) ;

/// @brief Method ReadCertificateRequest, addr 0x2506138, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method ReadCrl, addr 0x25064ec, size 0x15c, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::X509::X509Crl* ReadCrl(::Org::BouncyCastle::Utilities::IO::Pem::PemObject*  pemObject) ;

/// @brief Method ReadObject, addr 0x25049f0, size 0x4cc, virtual false, abstract: false, final false
inline ::System::Object* ReadObject() ;

/// @brief Method ReadPkcs7, addr 0x25063d8, size 0x114, virtual false, abstract: false, final false
inline ::Org::BouncyCastle::Asn1::Cms::ContentInfo* ReadPkcs7(::Org::BouncyCastle::Utilities::IO::Pem::PemObject*  pemObject) ;

/// @brief Method ReadPrivateKey, addr 0x2504ebc, size 0x11d8, virtual false, abstract: false, final false
inline ::System::Object* ReadPrivateKey(::Org::BouncyCastle::Utilities::IO::Pem::PemObject*  pemObject) ;

/// @brief Method ReadPublicKey, addr 0x2506094, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method ReadRsaPublicKey, addr 0x25060b0, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25049b4, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::System::IO::TextReader*  reader) ;

/// @brief Method .ctor, addr 0x25049cc, size 0x24, virtual false, abstract: false, final false
