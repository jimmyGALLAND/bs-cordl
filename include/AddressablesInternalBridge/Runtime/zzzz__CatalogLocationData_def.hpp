...
static inline ::AddressablesInternalBridge::Runtime::CatalogLocationData* New_ctor(::StringW  locatorId, ::StringW  localHash, ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  resourceLocation) ;
...
/// @brief Method .ctor, addr 0x444ac70, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_CatalogLocation, addr 0x444b2cc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation* get_CatalogLocation() ;

/// @brief Method get_LocalHash, addr 0x444b2c4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_LocalHash() ;

/// @brief Method get_LocatorId, addr 0x444b2bc, size 0x8, virtual false, abstract: false, final false
