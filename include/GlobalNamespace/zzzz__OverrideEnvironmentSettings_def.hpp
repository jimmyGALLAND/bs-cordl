...
/// @brief Method GetOverrideEnvironmentInfoForType, addr 0x26a12a4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method SetEnvironmentInfoForType, addr 0x26a1214, size 0x90, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::EnvironmentType,::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*> const& __cordl_internal_get__data() const;
...
/// @brief Method .ctor, addr 0x26a131c, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didChangeOverrideSettingsEvent, addr 0x26a10dc, size 0x9c, virtual false, abstract: false, final false
inline void add_didChangeOverrideSettingsEvent(::System::Action*  value) ;

/// @brief Method get_overrideEnvironments, addr 0x26a10b0, size 0x8, virtual false, abstract: false, final false
inline bool get_overrideEnvironments() ;

/// @brief Method remove_didChangeOverrideSettingsEvent, addr 0x26a1178, size 0x9c, virtual false, abstract: false, final false
inline void remove_didChangeOverrideSettingsEvent(::System::Action*  value) ;

/// @brief Method set_overrideEnvironments, addr 0x26a10b8, size 0x24, virtual false, abstract: false, final false
