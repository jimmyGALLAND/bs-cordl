...
/// @brief Method .ctor, addr 0x3afb460, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method Cleanup, addr 0x3afacfc, size 0x9c, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method GetColor, addr 0x3afb2b4, size 0x34, virtual true, abstract: false, final false
inline ::UnityEngine::Color GetColor(::GlobalNamespace::EnvironmentColorType  colorType, bool  colorBoost, float_t  brightness) ;

/// @brief Method HandleColorChangeBeatmapEvent, addr 0x3afad98, size 0x31c, virtual false, abstract: false, final false
...
/// @brief Method SetColor, addr 0x3afb0b4, size 0x124, virtual false, abstract: false, final false
inline void SetColor(float_t  t) ;

/// @brief Method SetData, addr 0x3afb2e8, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method UseBoostColors, addr 0x3afb1d8, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3afaa20, size 0x2dc, virtual false, abstract: false, final false
