...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds::*)(::UnityEngine::Color)>(&::GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds::ColorWasSet)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x3961240;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds::*)()>(&::GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds::_ctor)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x3961350;
...
constexpr ::UnityW<::GlobalNamespace::MaterialPropertyBlockColorSetter> const& GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds::__cordl_internal_get__materialPropertyBlockColorSetter() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____materialPropertyBlockColorSetter;
}
