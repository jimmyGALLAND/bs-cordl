...
/// @brief Method CreateDirectlyConnectedPlayer, addr 0x2272c5c, size 0x1dc, virtual false, abstract: false, final false
static inline ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer* CreateDirectlyConnectedPlayer(::GlobalNamespace::ConnectedPlayerManager*  manager, uint8_t  connectionId, ::GlobalNamespace::IConnection*  connection) ;

/// @brief Method CreateLocalPlayer, addr 0x2272b3c, size 0xb8, virtual false, abstract: false, final false
static inline ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer* CreateLocalPlayer(::GlobalNamespace::ConnectedPlayerManager*  manager, ::StringW  userId, ::StringW  userName, bool  isConnectionOwner, ::ArrayW<uint8_t,::Array<uint8_t>*>  publicEncryptionKey, ::ArrayW<uint8_t,::Array<uint8_t>*>  random) ;

/// @brief Method CreateRemoteConnectedPlayer, addr 0x2273938, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method Disconnect, addr 0x226e83c, size 0x148, virtual false, abstract: false, final false
inline void Disconnect(::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method GetPlayerAvatarPacket, addr 0x2272938, size 0x80, virtual false, abstract: false, final false
inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerAvatarPacket* GetPlayerAvatarPacket() ;

/// @brief Method GetPlayerConnectedPacket, addr 0x226ef64, size 0x70, virtual false, abstract: false, final false
inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerConnectedPacket* GetPlayerConnectedPacket() ;

/// @brief Method GetPlayerIdentityPacket, addr 0x226f220, size 0x90, virtual false, abstract: false, final false
inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerIdentityPacket* GetPlayerIdentityPacket() ;

/// @brief Method GetPlayerSortOrderPacket, addr 0x226f1b8, size 0x68, virtual false, abstract: false, final false
inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerSortOrderPacket* GetPlayerSortOrderPacket() ;

/// @brief Method GetPlayerStatePacket, addr 0x2272844, size 0x60, virtual false, abstract: false, final false
inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerStatePacket* GetPlayerStatePacket() ;

/// @brief Method HasState, addr 0x2274c28, size 0xc, virtual true, abstract: false, final true
inline bool HasState(::StringW  state) ;

static inline ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer* New_ctor(::GlobalNamespace::ConnectedPlayerManager*  manager, uint8_t  connectionId, uint8_t  remoteConnectionId, ::GlobalNamespace::IConnection*  connection, ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*  parent, ::StringW  userId, ::StringW  userName, bool  isConnectionOwner, bool  isMe, ::ArrayW<uint8_t,::Array<uint8_t>*>  publicEncryptionKey, ::ArrayW<uint8_t,::Array<uint8_t>*>  random) ;

/// @brief Method SetEncryptionState, addr 0x2274c20, size 0x8, virtual false, abstract: false, final false
inline void SetEncryptionState(::GlobalNamespace::__EncryptionUtility__IEncryptionState*  encryptionState) ;

/// @brief Method SetKicked, addr 0x2272758, size 0xc, virtual false, abstract: false, final false
inline void SetKicked() ;

/// @brief Method SetPlayerState, addr 0x2274c34, size 0x8, virtual false, abstract: false, final false
inline void SetPlayerState(::GlobalNamespace::PlayerStateHash  playerState) ;

/// @brief Method ToString, addr 0x2274c3c, size 0x17c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method UpdateAvatar, addr 0x2273e8c, size 0x24, virtual false, abstract: false, final false
inline void UpdateAvatar(::GlobalNamespace::__ConnectedPlayerManager__PlayerAvatarPacket*  packet) ;

/// @brief Method UpdateIdentity, addr 0x2273b84, size 0x64, virtual false, abstract: false, final false
inline void UpdateIdentity(::GlobalNamespace::__ConnectedPlayerManager__PlayerIdentityPacket*  packet) ;

/// @brief Method UpdateLatency, addr 0x2274868, size 0x1c, virtual false, abstract: false, final false
inline void UpdateLatency(int64_t  latency) ;

/// @brief Method UpdateSortIndex, addr 0x2272aa0, size 0x1c, virtual false, abstract: false, final false
inline bool UpdateSortIndex(int32_t  index) ;

/// @brief Method UpdateState, addr 0x2273d4c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2274a90, size 0xfc, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::ConnectedPlayerManager*  manager, uint8_t  connectionId, uint8_t  remoteConnectionId, ::GlobalNamespace::IConnection*  connection, ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*  parent, ::StringW  userId, ::StringW  userName, bool  isConnectionOwner, bool  isMe, ::ArrayW<uint8_t,::Array<uint8_t>*>  publicEncryptionKey, ::ArrayW<uint8_t,::Array<uint8_t>*>  random) ;

/// @brief Method get_connection, addr 0x2274910, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::IConnection* get_connection() ;

/// @brief Method get_connectionId, addr 0x2274918, size 0x8, virtual false, abstract: false, final false
inline uint8_t get_connectionId() ;

/// @brief Method get_currentLatency, addr 0x2274998, size 0x6c, virtual true, abstract: false, final true
inline int64_t get_currentLatency() ;

/// @brief Method get_disconnectedReason, addr 0x2274940, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::DisconnectedReason get_disconnectedReason() ;

/// @brief Method get_encryptionState, addr 0x2274a88, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__EncryptionUtility__IEncryptionState* get_encryptionState() ;

/// @brief Method get_hasValidLatency, addr 0x2274968, size 0x30, virtual true, abstract: false, final true
inline bool get_hasValidLatency() ;

/// @brief Method get_isConnected, addr 0x2274928, size 0x8, virtual true, abstract: false, final true
inline bool get_isConnected() ;

/// @brief Method get_isConnectionOwner, addr 0x2274930, size 0x8, virtual true, abstract: false, final true
inline bool get_isConnectionOwner() ;

/// @brief Method get_isDirectConnection, addr 0x226f0c8, size 0x10, virtual false, abstract: false, final false
inline bool get_isDirectConnection() ;

/// @brief Method get_isKicked, addr 0x2274938, size 0x8, virtual true, abstract: false, final true
inline bool get_isKicked() ;

/// @brief Method get_isMe, addr 0x2274960, size 0x8, virtual true, abstract: false, final true
inline bool get_isMe() ;

/// @brief Method get_multiplayerAvatarsData, addr 0x2274a50, size 0x14, virtual true, abstract: false, final true
inline ::GlobalNamespace::MultiplayerAvatarsData get_multiplayerAvatarsData() ;

/// @brief Method get_offsetSyncTime, addr 0x2274a04, size 0x4c, virtual true, abstract: false, final true
inline int64_t get_offsetSyncTime() ;

/// @brief Method get_publicEncryptionKey, addr 0x2274a78, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_publicEncryptionKey() ;

/// @brief Method get_random, addr 0x2274a80, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_random() ;

/// @brief Method get_remoteConnectionId, addr 0x2274920, size 0x8, virtual false, abstract: false, final false
inline uint8_t get_remoteConnectionId() ;

/// @brief Method get_sortIndex, addr 0x2274948, size 0x8, virtual true, abstract: false, final true
inline int32_t get_sortIndex() ;

/// @brief Method get_userId, addr 0x2274950, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_userId() ;

/// @brief Method get_userName, addr 0x2274958, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_multiplayerAvatarsData, addr 0x2274a64, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Deserialize, addr 0x2274e18, size 0x68, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x2274b8c, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x22739fc, size 0x54, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x2274db8, size 0x60, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2274e80, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_pool, addr 0x2271770, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Deserialize, addr 0x2274ee0, size 0x80, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x2274ba0, size 0x58, virtual false, abstract: false, final false
inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerIdentityPacket* Init(::GlobalNamespace::PlayerStateHash  states, ::GlobalNamespace::MultiplayerAvatarsData  avatar, ::ArrayW<uint8_t,::Array<uint8_t>*>  random, ::ArrayW<uint8_t,::Array<uint8_t>*>  publicEncryptionKey) ;

static inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerIdentityPacket* New_ctor() ;

/// @brief Method Release, addr 0x2274f60, size 0x6c, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x2274e88, size 0x58, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;
...
/// @brief Method .ctor, addr 0x2274fcc, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_pool, addr 0x22717b0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Deserialize, addr 0x22750b8, size 0x40, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x2274c00, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x2273eb0, size 0x54, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x22750ac, size 0xc, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;
...
/// @brief Method .ctor, addr 0x22750f8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_pool, addr 0x22718f0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Deserialize, addr 0x227510c, size 0x20, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x2274bf8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x2273d68, size 0x54, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x2275100, size 0xc, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;
...
/// @brief Method .ctor, addr 0x227512c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_pool, addr 0x2271930, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Deserialize, addr 0x2275174, size 0x44, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x2274c14, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x2274260, size 0x54, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x2275134, size 0x40, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;
...
/// @brief Method .ctor, addr 0x22751b8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_pool, addr 0x2271830, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Deserialize, addr 0x22751d4, size 0x20, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x2272f50, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x2273fac, size 0x54, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x22751c0, size 0x14, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;
...
/// @brief Method .ctor, addr 0x22751f4, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_pool, addr 0x22717f0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Deserialize, addr 0x2275218, size 0x20, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x2272750, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x22740e0, size 0x54, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x2275204, size 0x14, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;
...
/// @brief Method .ctor, addr 0x2275238, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_pool, addr 0x22718b0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Deserialize, addr 0x2275254, size 0x20, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x2274698, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x22743f4, size 0x54, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x2275240, size 0x14, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;
...
/// @brief Method .ctor, addr 0x2275274, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_pool, addr 0x2271870, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Deserialize, addr 0x2275290, size 0x20, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x226ee78, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x227463c, size 0x54, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x227527c, size 0x14, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;
...
/// @brief Method .ctor, addr 0x22752b0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_pool, addr 0x226ed6c, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Deserialize, addr 0x22752cc, size 0x20, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x2274690, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x2274814, size 0x54, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x22752b8, size 0x14, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;
...
/// @brief Method .ctor, addr 0x22752ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_pool, addr 0x2271970, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x22752f4, size 0x4e8, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x2275938, size 0xc, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::ConnectedPlayerManager*", modifiers: "", def_value: None }, CppParam { name: "player", ty: "::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*", modifiers: "", def_value: None }, CppParam { name: "_isClient_5__2", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<uint8_t,::Array<uint8_t>*>>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::__EncryptionUtility__IEncryptionState*>", modifiers: "", def_value: None }]
constexpr __ConnectedPlayerManager___InitializePlayerEncryption_d__132(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::GlobalNamespace::ConnectedPlayerManager*  __4__this, ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*  player, bool  _isClient_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<uint8_t,::Array<uint8_t>*>>  __u__1, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::__EncryptionUtility__IEncryptionState*>  __u__2) noexcept;
...
/// @brief Field _messageSerializer, offset 0x110, size 0x8 
 __declspec(property(get=__cordl_internal_get__messageSerializer, put=__cordl_internal_set__messageSerializer)) ::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::__ConnectedPlayerManager__InternalMessageType,::GlobalNamespace::IConnectedPlayer*>*  _messageSerializer;

/// @brief Field _players, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get__players, put=__cordl_internal_set__players)) ::System::Collections::Generic::List_1<::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*>*  _players;
...
/// @brief Field _temporaryEncryptedDataWriter, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get__temporaryEncryptedDataWriter, put=__cordl_internal_set__temporaryEncryptedDataWriter)) ::LiteNetLib::Utils::NetDataWriter*  _temporaryEncryptedDataWriter;
...
/// @brief Field connectionFailedEvent, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_connectionFailedEvent, put=__cordl_internal_set_connectionFailedEvent)) ::System::Action_1<::GlobalNamespace::ConnectionFailedReason>*  connectionFailedEvent;
...
/// @brief Field playerAvatarChangedEvent, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_playerAvatarChangedEvent, put=__cordl_internal_set_playerAvatarChangedEvent)) ::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  playerAvatarChangedEvent;
...
/// @brief Field playerDisconnectedEvent, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_playerDisconnectedEvent, put=__cordl_internal_set_playerDisconnectedEvent)) ::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  playerDisconnectedEvent;

/// @brief Field playerLatencyInitializedEvent, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_playerLatencyInitializedEvent, put=__cordl_internal_set_playerLatencyInitializedEvent)) ::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  playerLatencyInitializedEvent;

/// @brief Field playerOrderChangedEvent, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_playerOrderChangedEvent, put=__cordl_internal_set_playerOrderChangedEvent)) ::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  playerOrderChangedEvent;

/// @brief Field playerStateChangedEvent, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_playerStateChangedEvent, put=__cordl_internal_set_playerStateChangedEvent)) ::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  playerStateChangedEvent;
...
/// @brief Method AddPlayer, addr 0x226ead4, size 0x298, virtual false, abstract: false, final false
inline void AddPlayer(::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*  player) ;

/// @brief Method Disconnect, addr 0x226ea28, size 0xac, virtual false, abstract: false, final false
inline void Disconnect(::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method Dispose, addr 0x2272114, size 0x570, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method FlushReliableQueue, addr 0x2271e60, size 0xdc, virtual false, abstract: false, final false
inline void FlushReliableQueue() ;

/// @brief Method FlushUnreliableQueue, addr 0x2271f3c, size 0xdc, virtual false, abstract: false, final false
inline void FlushUnreliableQueue() ;

/// @brief Method GetConnectedPlayer, addr 0x226f550, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method GetNextConnectionId, addr 0x226e5e8, size 0x40, virtual false, abstract: false, final false
inline uint8_t GetNextConnectionId() ;

/// @brief Method GetPlayer, addr 0x226f390, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method GetPlayer, addr 0x226e628, size 0xc4, virtual false, abstract: false, final false
inline ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer* GetPlayer(uint8_t  connectionId) ;

/// @brief Method GetPlayer, addr 0x226f484, size 0xcc, virtual false, abstract: false, final false
inline ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer* GetPlayer(::StringW  userId) ;

/// @brief Method HandleConnected, addr 0x22719d8, size 0x2e8, virtual false, abstract: false, final false
inline void HandleConnected() ;

/// @brief Method HandleConnectionConnected, addr 0x2271cc0, size 0x38, virtual false, abstract: false, final false
inline void HandleConnectionConnected(::GlobalNamespace::IConnection*  connection) ;

/// @brief Method HandleConnectionDisconnected, addr 0x2272e38, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method HandleConnectionFailed, addr 0x2272c40, size 0x1c, virtual false, abstract: false, final false
inline void HandleConnectionFailed(::GlobalNamespace::ConnectionFailedReason  reason) ;

/// @brief Method HandleDisconnected, addr 0x2272bf4, size 0x4c, virtual false, abstract: false, final false
inline void HandleDisconnected(::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method HandleInitialized, addr 0x2272abc, size 0x1c, virtual false, abstract: false, final false
inline void HandleInitialized() ;

/// @brief Method HandleKickPlayerPacket, addr 0x2274000, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method HandleNetworkReceive, addr 0x2273044, size 0x500, virtual false, abstract: false, final false
...
/// @brief Method HandlePing, addr 0x2274448, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method HandlePlayerAvatarUpdate, addr 0x2273dbc, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method HandlePlayerIdentityUpdate, addr 0x2273a50, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method HandlePlayerSortOrderUpdate, addr 0x2274134, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method HandlePlayerStateUpdate, addr 0x2273c84, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method HandlePong, addr 0x22746a0, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method HandleServerPlayerConnected, addr 0x227386c, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method HandleServerPlayerDisconnected, addr 0x2273f04, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method HandleSyncTimePacket, addr 0x22742b4, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method InitializePlayerEncryption, addr 0x2273be8, size 0x9c, virtual false, abstract: false, final false
inline void InitializePlayerEncryption(::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*  player) ;

/// @brief Method KickPlayer, addr 0x2272684, size 0xcc, virtual false, abstract: false, final false
inline void KickPlayer(::StringW  userId, ::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method Log, addr 0x2274884, size 0x8c, virtual false, abstract: false, final false
...
static inline ::GlobalNamespace::ConnectedPlayerManager* New_ctor(::BGNet::Core::ITimeProvider*  timeProvider, ::BGNet::Core::ITaskUtility*  taskUtility, ::GlobalNamespace::IConnectionManager*  connectionManager) ;

/// @brief Method PollLateUpdateOptional, addr 0x2272018, size 0x2c, virtual false, abstract: false, final false
inline void PollLateUpdateOptional() ;

/// @brief Method PollUpdate, addr 0x2271cf8, size 0x168, virtual false, abstract: false, final false
inline void PollUpdate(int32_t  frameCount) ;

/// @brief Method RegisterSerializer, addr 0x2272044, size 0x68, virtual false, abstract: false, final false
inline void RegisterSerializer(::GlobalNamespace::__ConnectedPlayerManager__MessageType  serializerType, ::GlobalNamespace::INetworkPacketSubSerializer_1<::GlobalNamespace::IConnectedPlayer*>*  subSerializer) ;

/// @brief Method RemoveAllPlayers, addr 0x226e6ec, size 0x8c, virtual false, abstract: false, final false
inline void RemoveAllPlayers(::GlobalNamespace::DisconnectedReason  reason) ;

/// @brief Method RemovePlayer, addr 0x226e778, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method ResetLocalState, addr 0x22719b0, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method SendImmediately, addr 0x226ee80, size 0xe4, virtual false, abstract: false, final false
inline void SendImmediately(::LiteNetLib::Utils::INetSerializable*  message, bool  onlyFirstDegree) ;

/// @brief Method SendImmediatelyExcludingPlayer, addr 0x226efd4, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method SendImmediatelyFromPlayer, addr 0x2272f58, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method SendImmediatelyFromPlayerToPlayer, addr 0x226f2b0, size 0xe0, virtual false, abstract: false, final false
inline void SendImmediatelyFromPlayerToPlayer(::LiteNetLib::Utils::INetSerializable*  message, ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*  fromPlayer, ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*  toPlayer) ;
...
template<typename T>
inline void SendImmediatelyFromPlayerToPlayerUnreliable(T  message, ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*  fromPlayer, ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*  toPlayer) ;

/// @brief Method SendImmediatelyToPlayer, addr 0x226f0d8, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method SetLocalPlayerAvatar, addr 0x22728a4, size 0x94, virtual false, abstract: false, final false
inline void SetLocalPlayerAvatar(::GlobalNamespace::MultiplayerAvatarsData  multiplayerAvatarsData) ;

/// @brief Method SetLocalPlayerSortIndex, addr 0x22729b8, size 0x10, virtual false, abstract: false, final false
inline void SetLocalPlayerSortIndex(int32_t  sortIndex) ;

/// @brief Method SetLocalPlayerState, addr 0x2272764, size 0xe0, virtual false, abstract: false, final false
inline void SetLocalPlayerState(::StringW  state, bool  setState) ;

/// @brief Method SetPlayerSortIndex, addr 0x22729c8, size 0xd8, virtual false, abstract: false, final false
inline void SetPlayerSortIndex(::GlobalNamespace::IConnectedPlayer*  player, int32_t  sortIndex) ;

/// @brief Method UnregisterSerializer, addr 0x22720ac, size 0x68, virtual false, abstract: false, final false
inline void UnregisterSerializer(::GlobalNamespace::__ConnectedPlayerManager__MessageType  serializerType, ::GlobalNamespace::INetworkPacketSubSerializer_1<::GlobalNamespace::IConnectedPlayer*>*  subSerializer) ;

/// @brief Method Write, addr 0x22735b0, size 0xf8, virtual false, abstract: false, final false
inline void Write(::LiteNetLib::Utils::NetDataWriter*  writer, ::LiteNetLib::Utils::INetSerializable*  packet) ;

/// @brief Method WriteOne, addr 0x2273544, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method WriteOneEncrypted, addr 0x22736a8, size 0x164, virtual false, abstract: false, final false
inline ::LiteNetLib::Utils::NetDataWriter* WriteOneEncrypted(::GlobalNamespace::__EncryptionUtility__IEncryptionState*  encryptionState, uint8_t  senderId, uint8_t  receiverId, ::LiteNetLib::Utils::INetSerializable*  message) ;

/// @brief Method WriteOneOnlyToFirstDegreeConnections, addr 0x227380c, size 0x60, virtual false, abstract: false, final false
...
constexpr ::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::__ConnectedPlayerManager__InternalMessageType,::GlobalNamespace::IConnectedPlayer*>*& __cordl_internal_get__messageSerializer() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::__ConnectedPlayerManager__InternalMessageType,::GlobalNamespace::IConnectedPlayer*>*> const& __cordl_internal_get__messageSerializer() const;
...
constexpr void __cordl_internal_set__messageSerializer(::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::__ConnectedPlayerManager__InternalMessageType,::GlobalNamespace::IConnectedPlayer*>*  value) ;
...
/// @brief Method .ctor, addr 0x2270710, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::IConnectionManager*  connectionManager) ;

/// @brief Method .ctor, addr 0x22707b8, size 0xfb8, virtual false, abstract: false, final false
...
/// @brief Method add_connectedEvent, addr 0x226f5a8, size 0x9c, virtual false, abstract: false, final false
inline void add_connectedEvent(::System::Action*  value) ;

/// @brief Method add_connectionFailedEvent, addr 0x226f978, size 0xb0, virtual false, abstract: false, final false
inline void add_connectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>*  value) ;

/// @brief Method add_disconnectedEvent, addr 0x226f818, size 0xb0, virtual false, abstract: false, final false
inline void add_disconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>*  value) ;

/// @brief Method add_initializedEvent, addr 0x226f6e0, size 0x9c, virtual false, abstract: false, final false
inline void add_initializedEvent(::System::Action*  value) ;

/// @brief Method add_playerAvatarChangedEvent, addr 0x226fef8, size 0xb0, virtual false, abstract: false, final false
inline void add_playerAvatarChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method add_playerConnectedEvent, addr 0x226fad8, size 0xb0, virtual false, abstract: false, final false
inline void add_playerConnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method add_playerDisconnectedEvent, addr 0x226fc38, size 0xb0, virtual false, abstract: false, final false
inline void add_playerDisconnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method add_playerLatencyInitializedEvent, addr 0x22701b8, size 0xb0, virtual false, abstract: false, final false
inline void add_playerLatencyInitializedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method add_playerOrderChangedEvent, addr 0x2270058, size 0xb0, virtual false, abstract: false, final false
inline void add_playerOrderChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method add_playerStateChangedEvent, addr 0x226fd98, size 0xb0, virtual false, abstract: false, final false
inline void add_playerStateChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method add_syncTimeInitializedEvent, addr 0x2270318, size 0x9c, virtual false, abstract: false, final false
inline void add_syncTimeInitializedEvent(::System::Action*  value) ;

/// @brief Method get_connectedPlayerCount, addr 0x227066c, size 0x48, virtual false, abstract: false, final false
inline int32_t get_connectedPlayerCount() ;

/// @brief Method get_isConnected, addr 0x226e984, size 0xa4, virtual false, abstract: false, final false
inline bool get_isConnected() ;

/// @brief Method get_isConnectedOrConnecting, addr 0x22704f4, size 0x28, virtual false, abstract: false, final false
inline bool get_isConnectedOrConnecting() ;

/// @brief Method get_isConnecting, addr 0x227051c, size 0xa4, virtual false, abstract: false, final false
inline bool get_isConnecting() ;

/// @brief Method get_isConnectionOwner, addr 0x2270450, size 0xa4, virtual false, abstract: false, final false
inline bool get_isConnectionOwner() ;

/// @brief Method get_isDisconnecting, addr 0x22705c0, size 0xa4, virtual false, abstract: false, final false
inline bool get_isDisconnecting() ;

/// @brief Method get_localPlayer, addr 0x2270664, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::IConnectedPlayer* get_localPlayer() ;

/// @brief Method get_runTime, addr 0x226edac, size 0xcc, virtual false, abstract: false, final false
inline int64_t get_runTime() ;

/// @brief Method get_syncTime, addr 0x22706b4, size 0x28, virtual false, abstract: false, final false
inline int64_t get_syncTime() ;

/// @brief Method get_syncTimeInitialized, addr 0x22706dc, size 0x34, virtual false, abstract: false, final false
inline bool get_syncTimeInitialized() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method remove_connectedEvent, addr 0x226f644, size 0x9c, virtual false, abstract: false, final false
inline void remove_connectedEvent(::System::Action*  value) ;

/// @brief Method remove_connectionFailedEvent, addr 0x226fa28, size 0xb0, virtual false, abstract: false, final false
inline void remove_connectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>*  value) ;

/// @brief Method remove_disconnectedEvent, addr 0x226f8c8, size 0xb0, virtual false, abstract: false, final false
inline void remove_disconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>*  value) ;

/// @brief Method remove_initializedEvent, addr 0x226f77c, size 0x9c, virtual false, abstract: false, final false
inline void remove_initializedEvent(::System::Action*  value) ;

/// @brief Method remove_playerAvatarChangedEvent, addr 0x226ffa8, size 0xb0, virtual false, abstract: false, final false
inline void remove_playerAvatarChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method remove_playerConnectedEvent, addr 0x226fb88, size 0xb0, virtual false, abstract: false, final false
inline void remove_playerConnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method remove_playerDisconnectedEvent, addr 0x226fce8, size 0xb0, virtual false, abstract: false, final false
inline void remove_playerDisconnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method remove_playerLatencyInitializedEvent, addr 0x2270268, size 0xb0, virtual false, abstract: false, final false
inline void remove_playerLatencyInitializedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method remove_playerOrderChangedEvent, addr 0x2270108, size 0xb0, virtual false, abstract: false, final false
inline void remove_playerOrderChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method remove_playerStateChangedEvent, addr 0x226fe48, size 0xb0, virtual false, abstract: false, final false
inline void remove_playerStateChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method remove_syncTimeInitializedEvent, addr 0x22703b4, size 0x9c, virtual false, abstract: false, final false
