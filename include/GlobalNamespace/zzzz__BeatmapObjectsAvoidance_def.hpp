...
/// @brief Field _accelerationBezierSplineEvaluator, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__accelerationBezierSplineEvaluator, put=__cordl_internal_set__accelerationBezierSplineEvaluator)) ::GlobalNamespace::BezierSplineEvaluator*  _accelerationBezierSplineEvaluator;
...
/// @brief Field _avoidanceYOffsetEvaluatorProvider, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__avoidanceYOffsetEvaluatorProvider, put=__cordl_internal_set__avoidanceYOffsetEvaluatorProvider)) ::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator*  _avoidanceYOffsetEvaluatorProvider;
...
/// @brief Field _pathBezierSplineEvaluator, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__pathBezierSplineEvaluator, put=__cordl_internal_set__pathBezierSplineEvaluator)) ::GlobalNamespace::BezierSplineEvaluator*  _pathBezierSplineEvaluator;
...
/// @brief Field _towardsPlayerWrapperTransform, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__towardsPlayerWrapperTransform, put=__cordl_internal_set__towardsPlayerWrapperTransform)) ::UnityW<::UnityEngine::Transform>  _towardsPlayerWrapperTransform;
...
/// @brief Method AdjustPositionWithOffsetDirection, addr 0x221f5d8, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method Awake, addr 0x221e7e0, size 0x1c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method BuildAnimationCurvePath, addr 0x221ef8c, size 0x588, virtual false, abstract: false, final false
inline bool BuildAnimationCurvePath() ;

/// @brief Method HandleBeatmapObjectSpawnControllerDidInit, addr 0x22200f4, size 0x4, virtual false, abstract: false, final false
inline void HandleBeatmapObjectSpawnControllerDidInit() ;

static inline ::GlobalNamespace::BeatmapObjectsAvoidance* New_ctor() ;

/// @brief Method OnDestroy, addr 0x221ecfc, size 0x100, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetupAndRun, addr 0x221e97c, size 0x380, virtual false, abstract: false, final false
inline void SetupAndRun() ;

/// @brief Method Start, addr 0x221e7fc, size 0x180, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x221edfc, size 0x190, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x22200f8, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
