...
/// @brief Method .ctor, addr 0x2686b70, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _presets, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__presets, put=__cordl_internal_set__presets)) ::ArrayW<::GlobalNamespace::__MainEffectGraphicsSettingsPresetsSO__Preset*,::Array<::GlobalNamespace::__MainEffectGraphicsSettingsPresetsSO__Preset*>*>  _presets;
 ...
 __declspec(property(get=get_presets)) ::ArrayW<::GlobalNamespace::__MainEffectGraphicsSettingsPresetsSO__Preset*,::Array<::GlobalNamespace::__MainEffectGraphicsSettingsPresetsSO__Preset*>*>  presets;

static inline ::GlobalNamespace::MainEffectGraphicsSettingsPresetsSO* New_ctor() ;

constexpr ::ArrayW<::GlobalNamespace::__MainEffectGraphicsSettingsPresetsSO__Preset*,::Array<::GlobalNamespace::__MainEffectGraphicsSettingsPresetsSO__Preset*>*> const& __cordl_internal_get__presets() const;
...
constexpr void __cordl_internal_set__presets(::ArrayW<::GlobalNamespace::__MainEffectGraphicsSettingsPresetsSO__Preset*,::Array<::GlobalNamespace::__MainEffectGraphicsSettingsPresetsSO__Preset*>*>  value) ;

/// @brief Method .ctor, addr 0x2686b68, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_namedPresets, addr 0x2686b60, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<::GlobalNamespace::NamedPreset*,::Array<::GlobalNamespace::NamedPreset*>*> get_namedPresets() ;

/// @brief Method get_presets, addr 0x2686b58, size 0x8, virtual false, abstract: false, final false
