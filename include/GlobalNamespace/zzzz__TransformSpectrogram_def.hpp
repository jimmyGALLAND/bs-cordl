...
/// @brief Method Awake, addr 0x3b09e2c, size 0x188, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::TransformSpectrogram* New_ctor() ;

/// @brief Method Update, addr 0x3b09fb4, size 0x268, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b0a21c, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;
