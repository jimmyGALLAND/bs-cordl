...
/// @brief Method ApplyValue, addr 0x3b7d020, size 0x20, virtual true, abstract: false, final false
inline void ApplyValue(int32_t  idx) ;

/// @brief Method GetInitValues, addr 0x3b7cf7c, size 0xa4, virtual true, abstract: false, final false
inline bool GetInitValues(ByRef<int32_t>  idx, ByRef<int32_t>  numberOfElements) ;

/// @brief Method GetValue, addr 0x3b7cec0, size 0x8, virtual false, abstract: false, final false
inline int32_t GetValue() ;

static inline ::GlobalNamespace::PresetsSettingsController* New_ctor() ;

/// @brief Method SetInteractable, addr 0x3b7cf48, size 0x34, virtual false, abstract: false, final false
inline void SetInteractable(bool  interactable) ;

/// @brief Method SetNumberOfElementsLimit, addr 0x3b7cf28, size 0x20, virtual false, abstract: false, final false
inline void SetNumberOfElementsLimit(int32_t  numberOfElementsLimit) ;

/// @brief Method SetValue, addr 0x3b7cec8, size 0x60, virtual false, abstract: false, final false
inline void SetValue(int32_t  index) ;

/// @brief Method TextForValue, addr 0x3b7d040, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b7d090, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_valueDidChangeEvent, addr 0x3b7cd60, size 0xb0, virtual false, abstract: false, final false
inline void add_valueDidChangeEvent(::System::Action_1<int32_t>*  value) ;

/// @brief Method remove_valueDidChangeEvent, addr 0x3b7ce10, size 0xb0, virtual false, abstract: false, final false
