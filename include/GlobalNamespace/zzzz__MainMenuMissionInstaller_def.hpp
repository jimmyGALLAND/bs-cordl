...
/// @brief Method InstallBindings, addr 0x3b5f48c, size 0x80, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b5f50c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
