...
/// @brief Method GetMultiplayerStatusAsync, addr 0x3b31cbc, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b31d2c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
