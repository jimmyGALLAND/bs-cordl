...
/// @brief Field _selectedAndHighlightedColor, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__selectedAndHighlightedColor, put=__cordl_internal_set__selectedAndHighlightedColor)) ::UnityW<::GlobalNamespace::ColorSO>  _selectedAndHighlightedColor;
...
/// @brief Method .ctor, addr 0x44478cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disabledColor, addr 0x44478a8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_disabledColor() ;

/// @brief Method get_highlightedColor, addr 0x4447890, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_highlightedColor() ;

/// @brief Method get_normalColor, addr 0x4447884, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_normalColor() ;

/// @brief Method get_pressedColor, addr 0x444789c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_pressedColor() ;

/// @brief Method get_selectedAndHighlightedColor, addr 0x44478c0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_selectedAndHighlightedColor() ;

/// @brief Method get_selectedColor, addr 0x44478b4, size 0xc, virtual false, abstract: false, final false
