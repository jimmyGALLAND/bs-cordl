...
public:
// Declarations
/// @brief Method AnyContains, addr 0x2254888, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Contains, addr 0x2254868, size 0x20, virtual false, abstract: false, final false
static inline bool Contains(::StringW  source, ::StringW  substring, ::System::StringComparison  comp) ;

/// @brief Method Truncate, addr 0x22547a0, size 0xc8, virtual false, abstract: false, final false
