...
/// @brief Method GenerateAndSaveCubemapTexture, addr 0x3a7e548, size 0xb4, virtual false, abstract: false, final false
inline void GenerateAndSaveCubemapTexture() ;

static inline ::GlobalNamespace::CubemapCapture* New_ctor() ;

/// @brief Method RenderCubemapTexture, addr 0x3a7e5fc, size 0x4b8, virtual false, abstract: false, final false
inline void RenderCubemapTexture(::UnityEngine::Cubemap*  cubemap) ;

/// @brief Method SaveCubemapTexture, addr 0x3a7eab4, size 0x7c0, virtual false, abstract: false, final false
inline void SaveCubemapTexture(::UnityEngine::Cubemap*  cubemap, ::StringW  path) ;

/// @brief Method SerializeTextureToByteArray, addr 0x3a7f274, size 0xfc, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> SerializeTextureToByteArray(::UnityEngine::Texture2D*  texture) ;

/// @brief Method Update, addr 0x3a7e4c8, size 0x80, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3a7f370, size 0x150, virtual false, abstract: false, final false
inline void _ctor() ;
