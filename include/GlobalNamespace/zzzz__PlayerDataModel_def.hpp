...
/// @brief Method MoveNext, addr 0x26a7cb8, size 0x228, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x26a7ee0, size 0x68, virtual true, abstract: false, final true
...
constexpr __PlayerDataModel___UndoUnsavedChangesAsync_d__11(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::UnityW<::GlobalNamespace::PlayerDataModel>  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::PlayerData*>  __u__1) noexcept;
...
/// @brief Method Inject, addr 0x26a7ad8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method OnApplicationPause, addr 0x26a7b00, size 0xc, virtual false, abstract: false, final false
inline void OnApplicationPause(bool  pauseStatus) ;

/// @brief Method OnDisable, addr 0x26a7b2c, size 0x80, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method ResetData, addr 0x26a7bac, size 0x24, virtual false, abstract: false, final false
inline void ResetData() ;

/// @brief Method Save, addr 0x26a7b0c, size 0x20, virtual false, abstract: false, final false
inline void Save() ;

/// @brief Method SaveAsync, addr 0x26a7c90, size 0x20, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* SaveAsync() ;

/// @brief Method UndoUnsavedChangesAsync, addr 0x26a7bd0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26a7cb0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_playerData, addr 0x26a7ad0, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::PlayerData* get_playerData() ;

/// @brief Method get_playerDataFileModel, addr 0x26a7ac8, size 0x8, virtual false, abstract: false, final false
