...
/// @brief Method .ctor, addr 0x2655194, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_color, addr 0x2654fa8, size 0x84, virtual true, abstract: false, final true
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_color0, addr 0x265505c, size 0x84, virtual true, abstract: false, final true
inline ::UnityEngine::Color get_color0() ;

/// @brief Method get_color1, addr 0x26550ec, size 0x84, virtual true, abstract: false, final true
inline ::UnityEngine::Color get_color1() ;

/// @brief Method get_flipGradientColors, addr 0x265518c, size 0x8, virtual true, abstract: false, final true
inline bool get_flipGradientColors() ;

/// @brief Method get_globalLightTintIntensity, addr 0x2655038, size 0x8, virtual true, abstract: false, final true
inline float_t get_globalLightTintIntensity() ;

/// @brief Method get_gradient, addr 0x2655048, size 0x8, virtual true, abstract: false, final true
inline bool get_gradient() ;

/// @brief Method get_gradientDirection, addr 0x265517c, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::GradientDirection get_gradientDirection() ;

/// @brief Method get_useScriptableObjectColor, addr 0x2654f94, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_color, addr 0x265502c, size 0xc, virtual false, abstract: false, final false
inline void set_color(::UnityEngine::Color  value) ;

/// @brief Method set_color0, addr 0x26550e0, size 0xc, virtual false, abstract: false, final false
inline void set_color0(::UnityEngine::Color  value) ;

/// @brief Method set_color1, addr 0x2655170, size 0xc, virtual false, abstract: false, final false
inline void set_color1(::UnityEngine::Color  value) ;

/// @brief Method set_globalLightTintIntensity, addr 0x2655040, size 0x8, virtual false, abstract: false, final false
inline void set_globalLightTintIntensity(float_t  value) ;

/// @brief Method set_gradient, addr 0x2655050, size 0xc, virtual false, abstract: false, final false
inline void set_gradient(bool  value) ;

/// @brief Method set_gradientDirection, addr 0x2655184, size 0x8, virtual false, abstract: false, final false
inline void set_gradientDirection(::GlobalNamespace::GradientDirection  value) ;

/// @brief Method set_useScriptableObjectColor, addr 0x2654f9c, size 0xc, virtual false, abstract: false, final false
