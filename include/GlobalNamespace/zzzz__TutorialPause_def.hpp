...
/// @brief Method Pause, addr 0x3b5b9d0, size 0x78, virtual true, abstract: false, final true
inline void Pause() ;

/// @brief Method Resume, addr 0x3b5ba64, size 0x74, virtual true, abstract: false, final true
inline void Resume() ;

/// @brief Method WillResume, addr 0x3b5ba48, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b5bad8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didPauseEvent, addr 0x3b5b628, size 0x9c, virtual true, abstract: false, final true
inline void add_didPauseEvent(::System::Action*  value) ;

/// @brief Method add_didResumeEvent, addr 0x3b5b898, size 0x9c, virtual true, abstract: false, final true
inline void add_didResumeEvent(::System::Action*  value) ;

/// @brief Method add_willResumeEvent, addr 0x3b5b760, size 0x9c, virtual true, abstract: false, final true
inline void add_willResumeEvent(::System::Action*  value) ;

/// @brief Method get_isPaused, addr 0x3b5b620, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method remove_didPauseEvent, addr 0x3b5b6c4, size 0x9c, virtual true, abstract: false, final true
inline void remove_didPauseEvent(::System::Action*  value) ;

/// @brief Method remove_didResumeEvent, addr 0x3b5b934, size 0x9c, virtual true, abstract: false, final true
inline void remove_didResumeEvent(::System::Action*  value) ;

/// @brief Method remove_willResumeEvent, addr 0x3b5b7fc, size 0x9c, virtual true, abstract: false, final true
