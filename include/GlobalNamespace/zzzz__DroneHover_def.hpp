...
/// @brief Method .ctor, addr 0x3a46dfc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _compoundSins, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__compoundSins, put=__cordl_internal_set__compoundSins)) ::System::Collections::Generic::List_1<::GlobalNamespace::__DroneHover__SineLayer*>*  _compoundSins;
...
/// @brief Field _tiltTransforms, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__tiltTransforms, put=__cordl_internal_set__tiltTransforms)) ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Transform>>*  _tiltTransforms;

/// @brief Method GetNoise, addr 0x3a46cec, size 0xf4, virtual false, abstract: false, final false
inline float_t GetNoise(float_t  time, float_t  offset) ;

/// @brief Method GetNoiseVec3, addr 0x3a469ac, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetNoiseVec3(float_t  time) ;

static inline ::GlobalNamespace::DroneHover* New_ctor() ;

/// @brief Method Start, addr 0x3a46864, size 0x30, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3a46894, size 0x118, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateTiltTransform, addr 0x3a46a28, size 0x2c4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a46de0, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;
