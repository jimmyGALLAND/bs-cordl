...
/// @brief Method .ctor, addr 0x2660f28, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_bookmarksFolders>b__3_0, addr 0x2660f30, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field _bookmarksFolders, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__bookmarksFolders, put=__cordl_internal_set__bookmarksFolders)) ::ArrayW<::GlobalNamespace::FileBrowserItem*,::Array<::GlobalNamespace::FileBrowserItem*>*>  _bookmarksFolders;
...
/// @brief Method .ctor, addr 0x2660ec4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bookmarksFolders, addr 0x26608c4, size 0x5c0, virtual false, abstract: false, final false
