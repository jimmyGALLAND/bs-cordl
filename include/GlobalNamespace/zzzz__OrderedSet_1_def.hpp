...
template<typename T>
class __OrderedSet_1__Node;
}
namespace GlobalNamespace {
template<typename T>
struct __OrderedSet_1__ProcessOrder;
}
namespace GlobalNamespace {
template<typename T>
class __OrderedSet_1___GetEnumerator_d__23;
}
...
/// @brief Field _sortIndices, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__sortIndices, put=__cordl_internal_set__sortIndices)) ::System::Collections::Generic::Dictionary_2<T,::GlobalNamespace::__OrderedSet_1__Node<T>*>*  _sortIndices;
