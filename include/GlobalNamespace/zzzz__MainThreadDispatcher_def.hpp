...
/// @brief Method DispatchOnMainThread, addr 0x393ce08, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method Tick, addr 0x393ce60, size 0x104, virtual true, abstract: false, final true
inline void Tick() ;
...
/// @brief Method .ctor, addr 0x393cf64, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
