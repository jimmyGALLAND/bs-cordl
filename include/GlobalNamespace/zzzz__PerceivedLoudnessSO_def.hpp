...
/// @brief Method SetLoudness, addr 0x2695374, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2695300, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  levelId) ;

/// @brief Method get_checksum, addr 0x26952f8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_checksum() ;

/// @brief Method get_levelId, addr 0x26952e8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_levelId() ;

/// @brief Method get_perceivedLoudness, addr 0x26952f0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <GetLoudnessData>b__0, addr 0x2695380, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2695244, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _perceivedLoudnessPerLevel, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__perceivedLoudnessPerLevel, put=__cordl_internal_set__perceivedLoudnessPerLevel)) ::ArrayW<::GlobalNamespace::__PerceivedLoudnessSO__PerceivedLevelLoudnessPair*,::Array<::GlobalNamespace::__PerceivedLoudnessSO__PerceivedLevelLoudnessPair*>*>  _perceivedLoudnessPerLevel;
...
/// @brief Method GetLoudnessData, addr 0x2695134, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method SetLoudnessData, addr 0x26950d8, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method ToDictionary, addr 0x2694ff8, size 0xe0, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__PerceivedLoudnessSO__PerceivedLevelLoudnessPair*,::Array<::GlobalNamespace::__PerceivedLoudnessSO__PerceivedLevelLoudnessPair*>*> const& __cordl_internal_get__perceivedLoudnessPerLevel() const;

constexpr ::ArrayW<::GlobalNamespace::__PerceivedLoudnessSO__PerceivedLevelLoudnessPair*,::Array<::GlobalNamespace::__PerceivedLoudnessSO__PerceivedLevelLoudnessPair*>*>& __cordl_internal_get__perceivedLoudnessPerLevel() ;

constexpr void __cordl_internal_set__perceivedLoudnessPerLevel(::ArrayW<::GlobalNamespace::__PerceivedLoudnessSO__PerceivedLevelLoudnessPair*,::Array<::GlobalNamespace::__PerceivedLoudnessSO__PerceivedLevelLoudnessPair*>*>  value) ;

/// @brief Method .ctor, addr 0x269524c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_perceivedLoudnessPairs, addr 0x2694ff0, size 0x8, virtual false, abstract: false, final false
