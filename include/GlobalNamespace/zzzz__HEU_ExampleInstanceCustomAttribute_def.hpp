...
public:
// Declarations
/// @brief Method InstancerCallback, addr 0x3981114, size 0x3a8, virtual false, abstract: false, final false
...
template<typename T>
static inline void LogArray(::StringW  name, ::ArrayW<T,::Array<T>*>  arr, int32_t  tupleSize) ;

/// @brief Method LogAttr, addr 0x39814bc, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3981610, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
