...
/// @brief Method .ctor, addr 0x3a49a38, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method ApplyLoudness, addr 0x3a49904, size 0x30, virtual false, abstract: false, final false
inline void ApplyLoudness(float_t  songLoudness) ;

static inline ::GlobalNamespace::AdaptiveSfxVolume* New_ctor() ;

/// @brief Method OnAudioFilterRead, addr 0x3a49570, size 0x174, virtual false, abstract: false, final false
inline void OnAudioFilterRead(::ArrayW<float_t,::Array<float_t>*>  data, int32_t  channels) ;

/// @brief Method OnDisable, addr 0x3a494e4, size 0x8c, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method Start, addr 0x3a49410, size 0x50, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3a49850, size 0x34, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3a49934, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;
