...
/// @brief Method Init, addr 0x3b55488, size 0x18c, virtual false, abstract: false, final false
inline void Init(::UnityEngine::Transform*  parent, ::GlobalNamespace::Saber*  saber, ::UnityEngine::Color  trailTintColor) ;

/// @brief Method InitColor, addr 0x3b556dc, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b55868, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
