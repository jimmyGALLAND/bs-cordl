...
/// @brief Method Deserialize, addr 0x26d116c, size 0xc4, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Equals, addr 0x26d0ca4, size 0x64, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::BitMaskArray*  other) ;

/// @brief Method GetBits, addr 0x26d0df4, size 0x118, virtual true, abstract: false, final true
inline uint64_t GetBits(int32_t  offset, int32_t  count) ;

static inline ::GlobalNamespace::BitMaskArray* New_ctor(int32_t  bitCount) ;

/// @brief Method Serialize, addr 0x26d1004, size 0x168, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method SetBits, addr 0x26d0d08, size 0xec, virtual true, abstract: false, final true
inline ::GlobalNamespace::BitMaskArray* SetBits(int32_t  offset, uint64_t  bits) ;

/// @brief Method ToString, addr 0x26d0f0c, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26d0c28, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(int32_t  bitCount) ;

/// @brief Method get_bitCount, addr 0x26d0c20, size 0x8, virtual true, abstract: false, final true
