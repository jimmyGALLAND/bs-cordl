...
/// @brief Method Awake, addr 0x3af8f9c, size 0x11c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Move, addr 0x3af90bc, size 0x4c, virtual false, abstract: false, final false
inline void Move(float_t  value) ;

static inline ::GlobalNamespace::MoveInDirectionEffect* New_ctor() ;

/// @brief Method SetValue, addr 0x3af90b8, size 0x4, virtual true, abstract: false, final false
inline void SetValue(int32_t  groupId, int32_t  elementId, float_t  value) ;

/// @brief Method TriggerValue, addr 0x3af9108, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3af910c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
