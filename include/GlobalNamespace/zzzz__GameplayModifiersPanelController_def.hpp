...
/// @brief Method <Awake>b__0, addr 0x3aca434, size 0x204, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ac9fac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Awake, addr 0x3ac9e30, size 0x17c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetToggleValueWithGameplayModifierParams, addr 0x3aca050, size 0x8c, virtual false, abstract: false, final false
inline bool GetToggleValueWithGameplayModifierParams(::GlobalNamespace::GameplayModifierParamsSO*  gameplayModifierParams) ;

/// @brief Method IRefreshable.Refresh, addr 0x3aca2b0, size 0x104, virtual true, abstract: false, final true
inline void IRefreshable_Refresh() ;

static inline ::GlobalNamespace::GameplayModifiersPanelController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3ac9fb4, size 0x14, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method RefreshTotalMultiplierAndRankUI, addr 0x3aca0dc, size 0x1d4, virtual false, abstract: false, final false
inline void RefreshTotalMultiplierAndRankUI() ;

/// @brief Method SetData, addr 0x3ac9e28, size 0x8, virtual false, abstract: false, final false
inline void SetData(::GlobalNamespace::GameplayModifiers*  newGameplayModifiers) ;

/// @brief Method SetToggleValueWithGameplayModifierParams, addr 0x3ac9fc8, size 0x88, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>,::UnityW<::UnityEngine::UI::Toggle>>*> const& __cordl_internal_get__toggleForGameplayModifierParam() const;
...
/// @brief Method .ctor, addr 0x3aca3b4, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didChangeGameplayModifiersEvent, addr 0x3ac9ce8, size 0x9c, virtual false, abstract: false, final false
inline void add_didChangeGameplayModifiersEvent(::System::Action*  value) ;

/// @brief Method get_gameplayModifiers, addr 0x3ac9e20, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method remove_didChangeGameplayModifiersEvent, addr 0x3ac9d84, size 0x9c, virtual false, abstract: false, final false
