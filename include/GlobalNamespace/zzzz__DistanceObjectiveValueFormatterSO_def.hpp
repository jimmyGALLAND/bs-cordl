...
public:
// Declarations
/// @brief Method FormatValue, addr 0x2687064, size 0x80, virtual true, abstract: false, final false
inline ::StringW FormatValue(int32_t  value) ;

static inline ::GlobalNamespace::DistanceObjectiveValueFormatterSO* New_ctor() ;

/// @brief Method .ctor, addr 0x26870e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
