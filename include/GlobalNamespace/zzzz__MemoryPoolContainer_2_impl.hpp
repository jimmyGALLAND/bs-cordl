...
constexpr ::GlobalNamespace::LazyCopyHashSet_1<T1>*& GlobalNamespace::MemoryPoolContainer_2<T0,T1>::__cordl_internal_get__activeItems()  {
...
template<typename T0,typename T1>
constexpr void GlobalNamespace::MemoryPoolContainer_2<T0,T1>::__cordl_internal_set__activeItems(::GlobalNamespace::LazyCopyHashSet_1<T1>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T0,typename T1>
constexpr ::Zenject::IMemoryPool_1<T0>*& GlobalNamespace::MemoryPoolContainer_2<T0,T1>::__cordl_internal_get__memoryPool()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T0,typename T1>
constexpr void GlobalNamespace::MemoryPoolContainer_2<T0,T1>::__cordl_internal_set__memoryPool(::Zenject::IMemoryPool_1<T0>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::IMemoryPool_1<T0>*>::get()}
                    )));
...
template<typename T0,typename T1>
inline void GlobalNamespace::MemoryPoolContainer_2<T0,T1>::DespawnAll()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MemoryPoolContainer_2<T0,T1>*>::get(),
                        "DespawnAll",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T0,typename T1>
inline void GlobalNamespace::MemoryPoolContainer_2<T0,T1>::DestroyAll()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MemoryPoolContainer_2<T0,T1>*>::get(),
                        "DestroyAll",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters []
template<typename T0,typename T1>
constexpr ::GlobalNamespace::MemoryPoolContainer_2<T0,T1>::MemoryPoolContainer_2()   {
}
