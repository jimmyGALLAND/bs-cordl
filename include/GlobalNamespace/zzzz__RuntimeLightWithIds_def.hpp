...
/// @brief Method .ctor, addr 0x3961ae4, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  lightId, float_t  lightIntensity) ;

/// @brief Method get_intensity, addr 0x3961ad4, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method set_intensity, addr 0x3961adc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _lightIntensityData, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightIntensityData, put=__cordl_internal_set__lightIntensityData)) ::ArrayW<::GlobalNamespace::__RuntimeLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__RuntimeLightWithIds__LightIntensitiesWithId*>*>  _lightIntensityData;
...
/// @brief Method GetLightWithIds, addr 0x3961acc, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ProcessColor, addr 0x3961a88, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::Color ProcessColor(::UnityEngine::Color  color, float_t  intensity) ;

/// @brief Method ProcessNewColorData, addr 0x3961908, size 0x180, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__RuntimeLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__RuntimeLightWithIds__LightIntensitiesWithId*>*> const& __cordl_internal_get__lightIntensityData() const;

constexpr ::ArrayW<::GlobalNamespace::__RuntimeLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__RuntimeLightWithIds__LightIntensitiesWithId*>*>& __cordl_internal_get__lightIntensityData() ;
...
constexpr void __cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::__RuntimeLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__RuntimeLightWithIds__LightIntensitiesWithId*>*>  value) ;
...
/// @brief Method .ctor, addr 0x3961370, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_mixType, addr 0x3961904, size 0x4, virtual false, abstract: false, final false
