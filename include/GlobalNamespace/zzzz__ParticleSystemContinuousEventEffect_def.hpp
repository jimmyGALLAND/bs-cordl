...
/// @brief Method HandleBeatmapEvent, addr 0x3b017e8, size 0x20, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

static inline ::GlobalNamespace::ParticleSystemContinuousEventEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b017cc, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b016a4, size 0x128, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method ToggleEmitting, addr 0x3b01808, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b018bc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
