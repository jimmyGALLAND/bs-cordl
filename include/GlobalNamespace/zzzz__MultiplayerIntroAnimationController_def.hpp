...
/// @brief Method BindRingsAndSetTiming, addr 0x3b3e49c, size 0x800, virtual false, abstract: false, final false
...
/// @brief Method BindTimeline, addr 0x3b3d294, size 0x774, virtual false, abstract: false, final false
inline void BindTimeline() ;

/// @brief Method CalculatePlayerIndexSequence, addr 0x3b3de18, size 0x580, virtual false, abstract: false, final false
...
/// @brief Method Completed, addr 0x3b3ed70, size 0x38, virtual false, abstract: false, final false
inline void Completed() ;

/// @brief Method GetFullIntroAnimationTime, addr 0x3b3da08, size 0x410, virtual false, abstract: false, final false
inline int64_t GetFullIntroAnimationTime() ;

static inline ::GlobalNamespace::MultiplayerIntroAnimationController* New_ctor() ;

/// @brief Method OnValidate, addr 0x3b3c72c, size 0x57c, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method PlayIntroAnimation, addr 0x3b3d184, size 0x110, virtual false, abstract: false, final false
inline void PlayIntroAnimation(float_t  maxDesiredIntroAnimationDuration, ::System::Action*  onCompleted) ;

/// @brief Method SetBeforeIntroValue, addr 0x3b3cca8, size 0x474, virtual false, abstract: false, final false
inline void SetBeforeIntroValue() ;

/// @brief Method TransitionToAfterIntroAnimationState, addr 0x3b3ec9c, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b3eda8, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
