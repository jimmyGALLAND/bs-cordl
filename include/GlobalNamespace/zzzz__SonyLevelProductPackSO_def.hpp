...
/// @brief Field _levelPackProductData, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__levelPackProductData, put=__cordl_internal_set__levelPackProductData)) ::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackProductData*  _levelPackProductData;

/// @brief Field _levelPackRedirectionData, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__levelPackRedirectionData, put=__cordl_internal_set__levelPackRedirectionData)) ::ArrayW<::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackRedirectionData*,::Array<::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackRedirectionData*>*>  _levelPackRedirectionData;
 ...
 __declspec(property(get=get_levelPackRedirectionData, put=set_levelPackRedirectionData)) ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackRedirectionData*>*  levelPackRedirectionData;
...
constexpr ::ArrayW<::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackRedirectionData*,::Array<::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackRedirectionData*>*> const& __cordl_internal_get__levelPackRedirectionData() const;

constexpr ::ArrayW<::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackRedirectionData*,::Array<::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackRedirectionData*>*>& __cordl_internal_get__levelPackRedirectionData() ;
...
constexpr void __cordl_internal_set__levelPackRedirectionData(::ArrayW<::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackRedirectionData*,::Array<::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackRedirectionData*>*>  value) ;

/// @brief Method .ctor, addr 0x269a7a8, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_levelPackProductData, addr 0x269c554, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackProductData* get_levelPackProductData() ;

/// @brief Method get_levelPackRedirectionData, addr 0x269c564, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_levelPackProductData, addr 0x269c55c, size 0x8, virtual false, abstract: false, final false
inline void set_levelPackProductData(::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackProductData*  value) ;

/// @brief Method set_levelPackRedirectionData, addr 0x269c56c, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Field _levelPackRedirectionData, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackRedirectionData*,::Array<::GlobalNamespace::__SonyLevelProductCollectionModel__LevelPackRedirectionData*>*>  ____levelPackRedirectionData;
