...
/// @brief Method InstallBindings, addr 0x3b5fa48, size 0x6f8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b60140, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
