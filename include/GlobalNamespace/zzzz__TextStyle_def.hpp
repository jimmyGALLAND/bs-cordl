...
/// @brief Method Update, addr 0x2237524, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2237540, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_autoSizing, addr 0x22374fc, size 0x8, virtual true, abstract: false, final true
inline bool get_autoSizing() ;

/// @brief Method get_charWidthMaxAdj, addr 0x2237514, size 0x8, virtual true, abstract: false, final true
inline float_t get_charWidthMaxAdj() ;

/// @brief Method get_fontSize, addr 0x22374f4, size 0x8, virtual true, abstract: false, final true
inline float_t get_fontSize() ;

/// @brief Method get_fontSizeMax, addr 0x223750c, size 0x8, virtual true, abstract: false, final true
inline float_t get_fontSizeMax() ;

/// @brief Method get_fontSizeMin, addr 0x2237504, size 0x8, virtual true, abstract: false, final true
inline float_t get_fontSizeMin() ;

/// @brief Method get_fontStyle, addr 0x22374ec, size 0x8, virtual true, abstract: false, final true
inline ::TMPro::FontStyles get_fontStyle() ;

/// @brief Method get_lineSpacingMax, addr 0x223751c, size 0x8, virtual true, abstract: false, final true
