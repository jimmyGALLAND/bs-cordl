...
/// @brief Method .ctor, addr 0x3afe10c, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method <GetTranslationEventHandler>b__0, addr 0x3afe1e4, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3afdeb4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Cleanup, addr 0x3afde4c, size 0x68, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method ComputeTranslation, addr 0x3afe0c0, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method GetTranslationEventHandler, addr 0x3afdd60, size 0xec, virtual false, abstract: false, final false
...
static inline ::GlobalNamespace::LightTranslationGroupEffect* New_ctor(::GlobalNamespace::__LightTranslationGroupEffect__InitData*  initData, ::Tweening::SongTimeTweeningManager*  tweeningManager, ::GlobalNamespace::BeatmapCallbacksController*  beatmapCallbacksController) ;

/// @brief Method SetTranslation, addr 0x3afdebc, size 0x1c8, virtual false, abstract: false, final false
inline void SetTranslation(float_t  _) ;

/// @brief Method SetTweenData, addr 0x3afe084, size 0x3c, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::ValueTuple_2<::UnityW<::UnityEngine::Transform>,::UnityEngine::Vector3>>*> const& __cordl_internal_get__transformMask() const;
...
/// @brief Method .ctor, addr 0x3afd18c, size 0xbd4, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::__LightTranslationGroupEffect__InitData*  initData, ::Tweening::SongTimeTweeningManager*  tweeningManager, ::GlobalNamespace::BeatmapCallbacksController*  beatmapCallbacksController) ;
