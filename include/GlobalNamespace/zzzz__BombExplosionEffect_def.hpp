...
/// @brief Method Awake, addr 0x3aeb224, size 0x2c, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::BombExplosionEffect* New_ctor() ;

/// @brief Method SpawnExplosion, addr 0x3aeb250, size 0xbc, virtual false, abstract: false, final false
inline void SpawnExplosion(::UnityEngine::Vector3  pos) ;

/// @brief Method SpawnExplosionWithOffset, addr 0x3aeb30c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aeb398, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
