...
/// @brief Method SetTextureDataToShaders, addr 0x3a8988c, size 0x13c, virtual false, abstract: false, final false
inline void SetTextureDataToShaders() ;

/// @brief Method Start, addr 0x3a897d4, size 0xb8, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3a899c8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_lightmapData, addr 0x3a897c4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_lightmapData, addr 0x3a897cc, size 0x8, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::BakedLightDataLoader, 0x30>, "Size mismatch!");
