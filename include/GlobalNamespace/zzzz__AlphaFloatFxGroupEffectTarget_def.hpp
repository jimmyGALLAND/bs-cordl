...
/// @brief Method Awake, addr 0x3af7934, size 0x30, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method InitIfNeeded, addr 0x3af7964, size 0x30, virtual false, abstract: false, final false
inline void InitIfNeeded() ;

static inline ::GlobalNamespace::AlphaFloatFxGroupEffectTarget* New_ctor() ;

/// @brief Method SetColor, addr 0x3af79ac, size 0xdc, virtual false, abstract: false, final false
inline void SetColor(::UnityEngine::Color  color) ;

/// @brief Method SetValue, addr 0x3af7994, size 0x18, virtual true, abstract: false, final false
inline void SetValue(int32_t  groupId, int32_t  elementId, float_t  value) ;

/// @brief Method TriggerValue, addr 0x3af7a88, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3af7aa0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
