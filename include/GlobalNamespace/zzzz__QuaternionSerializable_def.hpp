...
/// @brief Method Approximately, addr 0x26d7928, size 0x80, virtual false, abstract: false, final false
inline bool Approximately(::GlobalNamespace::QuaternionSerializable  other) ;

/// @brief Method Deserialize, addr 0x26d3ad4, size 0x64, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Equals, addr 0x26d7890, size 0x98, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x26d785c, size 0x34, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::QuaternionSerializable  other) ;

/// @brief Method FromSmallest, addr 0x26d7788, size 0xd4, virtual false, abstract: false, final false
static inline ::UnityEngine::Quaternion FromSmallest(int32_t  sa, int32_t  sb, int32_t  sc) ;

/// @brief Method GetHashCode, addr 0x26d79b8, size 0x3c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetSize, addr 0x26d79f4, size 0x84, virtual false, abstract: false, final false
inline int32_t GetSize() ;

/// @brief Method Serialize, addr 0x26d3d00, size 0x84, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method ToSmallest, addr 0x26d73a0, size 0x3e8, virtual false, abstract: false, final false
static inline void ToSmallest(::UnityEngine::Quaternion  q, ByRef<int32_t>  sa, ByRef<int32_t>  sb, ByRef<int32_t>  sc) ;

/// @brief Method ToString, addr 0x26d7a84, size 0x40, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x26d723c, size 0x164, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Quaternion  q) ;

/// @brief Method .ctor, addr 0x26d7a78, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method get_identity, addr 0x26d71d8, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method op_Addition, addr 0x26d7ac4, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x26d40f8, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x26d79a8, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::Quaternion op_Implicit___UnityEngine__Quaternion(::GlobalNamespace::QuaternionSerializable  q) ;

/// @brief Method op_Subtraction, addr 0x26d7ae0, size 0x1c, virtual false, abstract: false, final false
