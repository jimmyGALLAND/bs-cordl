...
/// @brief Method Awake, addr 0x393d5fc, size 0xd0, virtual false, abstract: false, final false
inline void Awake() ;
...
/// @brief Method .ctor, addr 0x393d6cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
