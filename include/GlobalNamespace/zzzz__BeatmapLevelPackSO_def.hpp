...
/// @brief Method Create, addr 0x267bf78, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x267bfe0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_beatmapLevelCollection, addr 0x267bf68, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::BeatmapLevelCollectionSO> get_beatmapLevelCollection() ;

/// @brief Method get_collectionName, addr 0x267bf48, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_collectionName() ;

/// @brief Method get_contentRating, addr 0x267bf70, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::PlayerSensitivityFlag get_contentRating() ;

/// @brief Method get_coverImage, addr 0x267bf50, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_coverImage() ;

/// @brief Method get_packBuyOption, addr 0x267bf60, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::PackBuyOption get_packBuyOption() ;

/// @brief Method get_packID, addr 0x267bf30, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_packID() ;

/// @brief Method get_packName, addr 0x267bf38, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_packName() ;

/// @brief Method get_shortPackName, addr 0x267bf40, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_shortPackName() ;

/// @brief Method get_smallCoverImage, addr 0x267bf58, size 0x8, virtual false, abstract: false, final false
