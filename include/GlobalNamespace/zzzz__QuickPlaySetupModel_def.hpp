...
/// @brief Method .ctor, addr 0x268869c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x26886a4, size 0x824, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x2688ec8, size 0x7c, virtual true, abstract: false, final true
...
/// @brief Method GetQuickPlaySetupAsync, addr 0x2688330, size 0x64, virtual true, abstract: false, final true
...
/// @brief Method GetQuickPlaySetupInternal, addr 0x26884f8, size 0xe8, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::QuickPlaySetupData*>* GetQuickPlaySetupInternal() ;

/// @brief Method Init, addr 0x26884f4, size 0x4, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method IsQuickPlaySetupTaskValid, addr 0x2688394, size 0xf8, virtual false, abstract: false, final false
inline bool IsQuickPlaySetupTaskValid() ;

/// @brief Method IsUrlValid, addr 0x26885e0, size 0x5c, virtual false, abstract: false, final false
inline bool IsUrlValid(::StringW  url) ;

static inline ::GlobalNamespace::QuickPlaySetupModel* New_ctor() ;

/// @brief Method StartRequest, addr 0x268848c, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x268863c, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
