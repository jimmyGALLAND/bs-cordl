...
/// @brief Method Emit, addr 0x3aeb9ec, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aeba08, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
