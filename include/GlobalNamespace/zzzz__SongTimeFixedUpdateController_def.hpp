...
/// @brief Field songControllerFixedTimeDidUpdateEvent, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_songControllerFixedTimeDidUpdateEvent, put=__cordl_internal_set_songControllerFixedTimeDidUpdateEvent)) ::System::Action_1<float_t>*  songControllerFixedTimeDidUpdateEvent;
...
/// @brief Method Update, addr 0x3a50a00, size 0x140, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3a50b40, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_songControllerFixedTimeDidUpdateEvent, addr 0x3a50754, size 0xb0, virtual false, abstract: false, final false
inline void add_songControllerFixedTimeDidUpdateEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method add_songControllerTimeDidUpdateEvent, addr 0x3a508b4, size 0x9c, virtual false, abstract: false, final false
inline void add_songControllerTimeDidUpdateEvent(::System::Action*  value) ;

/// @brief Method get_fixedDeltaTime, addr 0x3a509ec, size 0xc, virtual false, abstract: false, final false
inline float_t get_fixedDeltaTime() ;

/// @brief Method get_interpolationFactor, addr 0x3a509f8, size 0x8, virtual false, abstract: false, final false
inline float_t get_interpolationFactor() ;

/// @brief Method remove_songControllerFixedTimeDidUpdateEvent, addr 0x3a50804, size 0xb0, virtual false, abstract: false, final false
inline void remove_songControllerFixedTimeDidUpdateEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method remove_songControllerTimeDidUpdateEvent, addr 0x3a50950, size 0x9c, virtual false, abstract: false, final false
