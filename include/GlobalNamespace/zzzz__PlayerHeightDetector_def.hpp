...
/// @brief Method .ctor, addr 0x3b524a4, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method BeatmapObjectSpawnCallback, addr 0x3b52458, size 0x44, virtual false, abstract: false, final false
inline void BeatmapObjectSpawnCallback(::GlobalNamespace::ObstacleData*  obstacleData) ;

/// @brief Method LateUpdate, addr 0x3b5228c, size 0x1cc, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::PlayerHeightDetector* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b52270, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b52190, size 0xe0, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b5249c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_playerHeightDidChangeEvent, addr 0x3b52028, size 0xb0, virtual false, abstract: false, final false
inline void add_playerHeightDidChangeEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method get_playerHeight, addr 0x3b52188, size 0x8, virtual false, abstract: false, final false
inline float_t get_playerHeight() ;

/// @brief Method remove_playerHeightDidChangeEvent, addr 0x3b520d8, size 0xb0, virtual false, abstract: false, final false
