...
/// @brief Method .ctor, addr 0x3b02d00, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x3b02180, size 0x30, virtual false, abstract: false, final false
inline void Init(float_t  startTime) ;

/// @brief Method InitSpeed, addr 0x3b02bf0, size 0x48, virtual false, abstract: false, final false
inline void InitSpeed(float_t  simulationSpeedMultiplier) ;

/// @brief Method ManualUpdate, addr 0x3b02528, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method Pause, addr 0x3b02984, size 0x1c, virtual false, abstract: false, final false
inline void Pause() ;

/// @brief Method Play, addr 0x3b02b18, size 0x1c, virtual false, abstract: false, final false
inline void Play() ;

/// @brief Method Stop, addr 0x3b01e94, size 0x1c, virtual false, abstract: false, final false
inline void Stop() ;
...
/// @brief Method .ctor, addr 0x3b02cf8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_endTime, addr 0x3b0251c, size 0xc, virtual false, abstract: false, final false
inline float_t get_endTime() ;

/// @brief Method get_startTime, addr 0x3b02ce8, size 0x8, virtual false, abstract: false, final false
inline float_t get_startTime() ;

/// @brief Method set_startTime, addr 0x3b02cf0, size 0x8, virtual false, abstract: false, final false
