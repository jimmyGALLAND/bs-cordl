...
/// @brief Method .ctor, addr 0x3af771c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _gameObjectKeywordItems, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameObjectKeywordItems, put=__cordl_internal_set__gameObjectKeywordItems)) ::ArrayW<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*,::Array<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*>*>  _gameObjectKeywordItems;

/// @brief Method Initialize, addr 0x3af75d0, size 0x144, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*,::Array<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*>*> const& __cordl_internal_get__gameObjectKeywordItems() const;

constexpr ::ArrayW<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*,::Array<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*>*>& __cordl_internal_get__gameObjectKeywordItems() ;

constexpr void __cordl_internal_set__defaultGameObject(::UnityW<::UnityEngine::GameObject>  value) ;

constexpr void __cordl_internal_set__gameObjectKeywordItems(::ArrayW<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*,::Array<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*>*>  value) ;

/// @brief Method .ctor, addr 0x3af7714, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
