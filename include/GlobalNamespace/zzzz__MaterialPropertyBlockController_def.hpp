...
/// @brief Method ApplyChanges, addr 0x3962ac8, size 0x64, virtual false, abstract: false, final false
inline void ApplyChanges() ;

static inline ::GlobalNamespace::MaterialPropertyBlockController* New_ctor() ;

/// @brief Method SetRendererState, addr 0x3962cb4, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3962ea0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_materialPropertyBlock, addr 0x3962ba0, size 0x64, virtual false, abstract: false, final false
inline ::UnityEngine::MaterialPropertyBlock* get_materialPropertyBlock() ;

/// @brief Method get_renderers, addr 0x3962e98, size 0x8, virtual false, abstract: false, final false
