...
/// @brief Method OnEnable, addr 0x3951cd0, size 0x1c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method SetParams, addr 0x3951cec, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method Setup, addr 0x395158c, size 0x8, virtual false, abstract: false, final false
inline void Setup(::GlobalNamespace::BloomFogEnvironmentParams*  defaultFogParams) ;

/// @brief Method UpdateShaderParams, addr 0x39516cc, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3951e24, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_autoExposureLimit, addr 0x3951cc0, size 0x8, virtual false, abstract: false, final false
inline float_t get_autoExposureLimit() ;

/// @brief Method get_bloomFogEnabled, addr 0x3951cb0, size 0x8, virtual false, abstract: false, final false
inline bool get_bloomFogEnabled() ;

/// @brief Method get_defaultForParams, addr 0x3951ca0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::BloomFogEnvironmentParams> get_defaultForParams() ;

/// @brief Method get_legacyAutoExposureEnabled, addr 0x3951cb8, size 0x8, virtual false, abstract: false, final false
inline bool get_legacyAutoExposureEnabled() ;

/// @brief Method get_noteSpawnIntensity, addr 0x3951cc8, size 0x8, virtual false, abstract: false, final false
inline float_t get_noteSpawnIntensity() ;

/// @brief Method get_transition, addr 0x3951c98, size 0x8, virtual false, abstract: false, final false
inline float_t get_transition() ;

/// @brief Method get_transitionFogParams, addr 0x3951ca8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_bloomFogEnabled, addr 0x3951638, size 0x78, virtual false, abstract: false, final false
inline void set_bloomFogEnabled(bool  value) ;

/// @brief Method set_defaultForParams, addr 0x3951ac8, size 0x9c, virtual false, abstract: false, final false
inline void set_defaultForParams(::GlobalNamespace::BloomFogEnvironmentParams*  value) ;

/// @brief Method set_legacyAutoExposureEnabled, addr 0x39516b0, size 0x1c, virtual false, abstract: false, final false
inline void set_legacyAutoExposureEnabled(bool  value) ;

/// @brief Method set_transition, addr 0x3951574, size 0x18, virtual false, abstract: false, final false
inline void set_transition(float_t  value) ;

/// @brief Method set_transitionFogParams, addr 0x3951910, size 0x98, virtual false, abstract: false, final false
