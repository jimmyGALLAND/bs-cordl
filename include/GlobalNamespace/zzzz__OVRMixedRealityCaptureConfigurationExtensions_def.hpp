...
public:
// Declarations
/// @brief Method ApplyTo, addr 0x3fa7cbc, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ReadFrom, addr 0x3fa7cc0, size 0x1428, virtual false, abstract: false, final false
