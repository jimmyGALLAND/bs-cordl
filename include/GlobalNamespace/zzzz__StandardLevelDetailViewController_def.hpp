...
/// @brief Method MoveNext, addr 0x3ad8ba4, size 0x2c4, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3ad8e68, size 0x68, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::StandardLevelDetailViewController>", modifiers: "", def_value: None }, CppParam { name: "token", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::OpenProductStoreResult>", modifiers: "", def_value: None }]
...
/// @brief Method MoveNext, addr 0x3ad8ed0, size 0x2c4, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3ad9194, size 0x68, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method MoveNext, addr 0x3ad91fc, size 0x3d0, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3ad95cc, size 0x68, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::StandardLevelDetailViewController>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::IsPackBetterBuyThanLevelResult>", modifiers: "", def_value: None }]
...
/// @brief Method MoveNext, addr 0x3ad9634, size 0x38c, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3ad99c0, size 0x68, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::StandardLevelDetailViewController>", modifiers: "", def_value: None }, CppParam { name: "token", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::EntitlementStatus>", modifiers: "", def_value: None }]
constexpr __StandardLevelDetailViewController____RefreshAvailabilityIfNeeded_b__58_0_d(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::UnityW<::GlobalNamespace::StandardLevelDetailViewController>  __4__this, ::System::Threading::CancellationToken  token, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::EntitlementStatus>  __u__1) noexcept;
...
/// @brief Method MoveNext, addr 0x3ad9a28, size 0x29c, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3ad9cc4, size 0xc, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Field _noAllowedBeatmapInfoContainer, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get__noAllowedBeatmapInfoContainer, put=__cordl_internal_set__noAllowedBeatmapInfoContainer)) ::UnityW<::UnityEngine::GameObject>  _noAllowedBeatmapInfoContainer;

/// @brief Field _notAllowedCharacteristics, offset 0x130, size 0x8 
 __declspec(property(get=__cordl_internal_get__notAllowedCharacteristics, put=__cordl_internal_set__notAllowedCharacteristics)) ::System::Collections::Generic::HashSet_1<::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>>*  _notAllowedCharacteristics;
...
/// @brief Field _standardLevelBuyInfoView, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get__standardLevelBuyInfoView, put=__cordl_internal_set__standardLevelBuyInfoView)) ::UnityW<::GlobalNamespace::StandardLevelBuyInfoView>  _standardLevelBuyInfoView;
...
/// @brief Field _standardLevelDetailView, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__standardLevelDetailView, put=__cordl_internal_set__standardLevelDetailView)) ::UnityW<::GlobalNamespace::StandardLevelDetailView>  _standardLevelDetailView;
...
/// @brief Field didChangeContentEvent, offset 0xf8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didChangeContentEvent, put=__cordl_internal_set_didChangeContentEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>,::GlobalNamespace::__StandardLevelDetailViewController__ContentType>*  didChangeContentEvent;

/// @brief Field didChangeDifficultyBeatmapEvent, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didChangeDifficultyBeatmapEvent, put=__cordl_internal_set_didChangeDifficultyBeatmapEvent)) ::System::Action_1<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>>*  didChangeDifficultyBeatmapEvent;

/// @brief Field didPressActionButtonEvent, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didPressActionButtonEvent, put=__cordl_internal_set_didPressActionButtonEvent)) ::System::Action_1<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>>*  didPressActionButtonEvent;

/// @brief Field didPressOpenLevelPackButtonEvent, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didPressOpenLevelPackButtonEvent, put=__cordl_internal_set_didPressOpenLevelPackButtonEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>,::GlobalNamespace::BeatmapLevelPack*>*  didPressOpenLevelPackButtonEvent;

/// @brief Field didPressPracticeButtonEvent, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didPressPracticeButtonEvent, put=__cordl_internal_set_didPressPracticeButtonEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>,::GlobalNamespace::BeatmapLevel*>*  didPressPracticeButtonEvent;

/// @brief Field levelFavoriteStatusDidChangeEvent, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get_levelFavoriteStatusDidChangeEvent, put=__cordl_internal_set_levelFavoriteStatusDidChangeEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>,bool>*  levelFavoriteStatusDidChangeEvent;

/// @brief Method BuyLevelButtonWasPressed, addr 0x3ad7b9c, size 0x94, virtual false, abstract: false, final false
inline void BuyLevelButtonWasPressed() ;

/// @brief Method BuyPackButtonWasPressed, addr 0x3ad7cb0, size 0xf4, virtual false, abstract: false, final false
inline void BuyPackButtonWasPressed() ;

/// @brief Method ClearSelected, addr 0x3acfd58, size 0x24, virtual false, abstract: false, final false
inline void ClearSelected() ;

/// @brief Method DidActivate, addr 0x3ad76b0, size 0x360, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3ad7a10, size 0x58, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleDidChangeDifficultyBeatmap, addr 0x3ad7aa4, size 0x80, virtual false, abstract: false, final false
inline void HandleDidChangeDifficultyBeatmap(::GlobalNamespace::StandardLevelDetailView*  view) ;

/// @brief Method HandleDidFavoriteToggleChange, addr 0x3ad7b24, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3ad7a68, size 0x3c, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OpenLevelProductStore, addr 0x3ad7c30, size 0x80, virtual false, abstract: false, final false
inline void OpenLevelProductStore() ;

/// @brief Method OpenLevelProductStoreOrShowBuyInfo, addr 0x3ad7e3c, size 0xe4, virtual false, abstract: false, final false
inline void OpenLevelProductStoreOrShowBuyInfo() ;

/// @brief Method RefreshAvailabilityIfNeeded, addr 0x3ad7614, size 0x9c, virtual false, abstract: false, final false
inline void RefreshAvailabilityIfNeeded() ;

/// @brief Method RefreshContentLevelDetailView, addr 0x3acfd24, size 0x1c, virtual false, abstract: false, final false
inline void RefreshContentLevelDetailView() ;

/// @brief Method SetData, addr 0x3ad00f8, size 0x84, virtual false, abstract: false, final false
inline void SetData(::GlobalNamespace::BeatmapLevel*  beatmapLevel, bool  hidePracticeButton, ::StringW  playButtonText, ::GlobalNamespace::BeatmapDifficultyMask  allowedBeatmapDifficultyMask, ::ArrayW<::GlobalNamespace::BeatmapCharacteristicSO*,::Array<::GlobalNamespace::BeatmapCharacteristicSO*>*>  notAllowedCharacteristics) ;

/// @brief Method SetData, addr 0x3ad017c, size 0x254, virtual false, abstract: false, final false
inline void SetData(::GlobalNamespace::BeatmapLevelPack*  pack, ::GlobalNamespace::BeatmapLevel*  beatmapLevel, bool  hidePracticeButton, bool  canBuyPack, ::StringW  playButtonText, ::GlobalNamespace::BeatmapDifficultyMask  allowedBeatmapDifficultyMask, ::ArrayW<::GlobalNamespace::BeatmapCharacteristicSO*,::Array<::GlobalNamespace::BeatmapCharacteristicSO*>*>  notAllowedCharacteristics) ;

/// @brief Method ShowContent, addr 0x3ad7fac, size 0x280, virtual false, abstract: false, final false
inline void ShowContent(::GlobalNamespace::__StandardLevelDetailViewController__ContentType  contentType, ::StringW  errorText) ;

/// @brief Method ShowLoadingAndDoSomething, addr 0x3ad7da4, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method ShowOwnedContent, addr 0x3ad7f20, size 0x8c, virtual false, abstract: false, final false
inline void ShowOwnedContent() ;

/// @brief Method <BuyPackButtonWasPressed>b__55_0, addr 0x3ad8868, size 0xd4, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* _BuyPackButtonWasPressed_b__55_0(::System::Threading::CancellationToken  token) ;

/// @brief Method <DidActivate>b__47_0, addr 0x3ad82a4, size 0x24, virtual false, abstract: false, final false
inline void _DidActivate_b__47_0() ;

/// @brief Method <DidActivate>b__47_1, addr 0x3ad82c8, size 0x20, virtual false, abstract: false, final false
inline void _DidActivate_b__47_1() ;

/// @brief Method <DidActivate>b__47_2, addr 0x3ad82e8, size 0x24, virtual false, abstract: false, final false
inline void _DidActivate_b__47_2() ;

/// @brief Method <DidActivate>b__47_3, addr 0x3ad830c, size 0x17c, virtual false, abstract: false, final false
inline void _DidActivate_b__47_3() ;

/// @brief Method <DidActivate>b__47_4, addr 0x3ad8488, size 0x1f0, virtual false, abstract: false, final false
inline void _DidActivate_b__47_4() ;

/// @brief Method <DidActivate>b__47_5, addr 0x3ad8678, size 0xf0, virtual false, abstract: false, final false
inline void _DidActivate_b__47_5() ;

/// @brief Method <DidActivate>b__47_6, addr 0x3ad8768, size 0x100, virtual false, abstract: false, final false
inline void _DidActivate_b__47_6() ;

/// @brief Method <OpenLevelProductStoreOrShowBuyInfo>b__56_0, addr 0x3ad893c, size 0xc0, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* _OpenLevelProductStoreOrShowBuyInfo_b__56_0(::System::Threading::CancellationToken  _) ;

/// @brief Method <OpenLevelProductStore>b__57_0, addr 0x3ad89fc, size 0xd4, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* _OpenLevelProductStore_b__57_0(::System::Threading::CancellationToken  token) ;

/// @brief Method <RefreshAvailabilityIfNeeded>b__58_0, addr 0x3ad8ad0, size 0xd4, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>>*> const& __cordl_internal_get__notAllowedCharacteristics() const;
...
constexpr ::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>,::GlobalNamespace::__StandardLevelDetailViewController__ContentType>*& __cordl_internal_get_didChangeContentEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>,::GlobalNamespace::__StandardLevelDetailViewController__ContentType>*> const& __cordl_internal_get_didChangeContentEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>>*> const& __cordl_internal_get_didChangeDifficultyBeatmapEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>,::GlobalNamespace::BeatmapLevelPack*>*> const& __cordl_internal_get_didPressOpenLevelPackButtonEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>,::GlobalNamespace::BeatmapLevel*>*> const& __cordl_internal_get_didPressPracticeButtonEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>,bool>*> const& __cordl_internal_get_levelFavoriteStatusDidChangeEvent() const;
...
constexpr void __cordl_internal_set_didChangeContentEvent(::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>,::GlobalNamespace::__StandardLevelDetailViewController__ContentType>*  value) ;
...
/// @brief Method .ctor, addr 0x3ad822c, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didChangeContentEvent, addr 0x3acec34, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method add_didChangeDifficultyBeatmapEvent, addr 0x3aceb84, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method add_didPressActionButtonEvent, addr 0x3acea24, size 0xb0, virtual false, abstract: false, final false
inline void add_didPressActionButtonEvent(::System::Action_1<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>>*  value) ;

/// @brief Method add_didPressOpenLevelPackButtonEvent, addr 0x3acece4, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method add_didPressPracticeButtonEvent, addr 0x3acead4, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method add_levelFavoriteStatusDidChangeEvent, addr 0x3aced94, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_beatmapKey, addr 0x3acdf88, size 0x28, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapKey get_beatmapKey() ;

/// @brief Method get_beatmapLevel, addr 0x3ad760c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevel* get_beatmapLevel() ;

/// @brief Method remove_didChangeContentEvent, addr 0x3acf4b8, size 0xb0, virtual false, abstract: false, final false
inline void remove_didChangeContentEvent(::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelDetailViewController>,::GlobalNamespace::__StandardLevelDetailViewController__ContentType>*  value) ;

/// @brief Method remove_didChangeDifficultyBeatmapEvent, addr 0x3acf408, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_didPressActionButtonEvent, addr 0x3acf2a8, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_didPressOpenLevelPackButtonEvent, addr 0x3acf568, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_didPressPracticeButtonEvent, addr 0x3acf358, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_levelFavoriteStatusDidChangeEvent, addr 0x3acf618, size 0xb0, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__StandardLevelDetailViewController____OpenLevelProductStoreOrShowBuyInfo_b__56_0_d, "", "StandardLevelDetailViewController/<<OpenLevelProductStoreOrShowBuyInfo>b__56_0>d");
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__StandardLevelDetailViewController____RefreshAvailabilityIfNeeded_b__58_0_d, "", "StandardLevelDetailViewController/<<RefreshAvailabilityIfNeeded>b__58_0>d");
