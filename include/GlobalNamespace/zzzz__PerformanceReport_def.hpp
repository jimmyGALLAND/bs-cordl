...
public:
// Declarations
/// @brief Method CreateReportDescriptor, addr 0x3a991a0, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method CreateTimestamp, addr 0x3a9912c, size 0x74, virtual false, abstract: false, final false
static inline ::StringW CreateTimestamp(::System::DateTime  timestamp) ;

/// @brief Method ListAggregatedFps, addr 0x3a98e18, size 0x314, virtual false, abstract: false, final false
static inline ::StringW ListAggregatedFps(::ArrayW<float_t,::Array<float_t>*>  frameDurations, float_t  minWindowSize) ;

/// @brief Method ListFrameDurations, addr 0x3a98cfc, size 0x11c, virtual false, abstract: false, final false
