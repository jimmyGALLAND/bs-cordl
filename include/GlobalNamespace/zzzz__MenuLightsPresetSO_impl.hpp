...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::GlobalNamespace::LightIdColorPair*,::Array<::GlobalNamespace::LightIdColorPair*>*> (::GlobalNamespace::MenuLightsPresetSO::*)()>(&::GlobalNamespace::MenuLightsPresetSO::get_lightIdColorPairs)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3b98010;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MenuLightsPresetSO::*)(::ArrayW<::GlobalNamespace::LightIdColorPair*,::Array<::GlobalNamespace::LightIdColorPair*>*>)>(&::GlobalNamespace::MenuLightsPresetSO::set_lightIdColorPairs)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3b98018;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<::GlobalNamespace::LightIdColorPair*,::Array<::GlobalNamespace::LightIdColorPair*>*>>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MenuLightsPresetSO::*)()>(&::GlobalNamespace::MenuLightsPresetSO::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3b98020;
