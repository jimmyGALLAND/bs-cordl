...
/// @brief Method .ctor, addr 0x3961cd0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  lightId, float_t  intensity) ;

/// @brief Method get_intensity, addr 0x3961e74, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method set_intensity, addr 0x3961e7c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _lightGroupList, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightGroupList, put=__cordl_internal_set__lightGroupList)) ::ArrayW<::UnityW<::GlobalNamespace::LightGroup>,::Array<::UnityW<::GlobalNamespace::LightGroup>>*>  _lightGroupList;

/// @brief Field _lightIntensityData, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightIntensityData, put=__cordl_internal_set__lightIntensityData)) ::ArrayW<::GlobalNamespace::__RuntimeLightWithLightGroupIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__RuntimeLightWithLightGroupIds__LightIntensitiesWithId*>*>  _lightIntensityData;
...
/// @brief Method Awake, addr 0x3961b0c, size 0x1c4, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method ColorWasSet, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
inline void ColorWasSet(::UnityEngine::Color  color) ;

/// @brief Method GetLightWithIds, addr 0x3961e54, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ProcessColor, addr 0x3961e34, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Color ProcessColor(::UnityEngine::Color  color, float_t  intensity) ;

/// @brief Method ProcessNewColorData, addr 0x3961cf8, size 0x13c, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__RuntimeLightWithLightGroupIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__RuntimeLightWithLightGroupIds__LightIntensitiesWithId*>*> const& __cordl_internal_get__lightIntensityData() const;

constexpr ::ArrayW<::GlobalNamespace::__RuntimeLightWithLightGroupIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__RuntimeLightWithLightGroupIds__LightIntensitiesWithId*>*>& __cordl_internal_get__lightIntensityData() ;
...
constexpr void __cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::__RuntimeLightWithLightGroupIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__RuntimeLightWithLightGroupIds__LightIntensitiesWithId*>*>  value) ;
...
/// @brief Method .ctor, addr 0x3961e5c, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
