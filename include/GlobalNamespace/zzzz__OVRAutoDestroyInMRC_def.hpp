...
/// @brief Method Start, addr 0x3f98e58, size 0x118, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3f98f70, size 0x4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method .ctor, addr 0x3f98f74, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
