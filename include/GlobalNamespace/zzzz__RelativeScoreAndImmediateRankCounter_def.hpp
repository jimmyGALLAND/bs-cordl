...
/// @brief Field <immediateRank>k__BackingField, offset 0x44, size 0x4 
 __declspec(property(get=__cordl_internal_get__immediateRank_k__BackingField, put=__cordl_internal_set__immediateRank_k__BackingField)) ::GlobalNamespace::__RankModel__Rank  _immediateRank_k__BackingField;
...
/// @brief Method HandleScoreDidChange, addr 0x3b1398c, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b1388c, size 0x100, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b13750, size 0x13c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UpdateRelativeScoreAndImmediateRank, addr 0x3b13ac8, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b13b50, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_relativeScoreOrImmediateRankDidChangeEvent, addr 0x3b12058, size 0x9c, virtual false, abstract: false, final false
inline void add_relativeScoreOrImmediateRankDidChangeEvent(::System::Action*  value) ;

/// @brief Method get_immediateRank, addr 0x3b13740, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__RankModel__Rank get_immediateRank() ;

/// @brief Method get_relativeScore, addr 0x3b13730, size 0x8, virtual false, abstract: false, final false
inline float_t get_relativeScore() ;

/// @brief Method remove_relativeScoreOrImmediateRankDidChangeEvent, addr 0x3b13694, size 0x9c, virtual false, abstract: false, final false
inline void remove_relativeScoreOrImmediateRankDidChangeEvent(::System::Action*  value) ;

/// @brief Method set_immediateRank, addr 0x3b13748, size 0x8, virtual false, abstract: false, final false
inline void set_immediateRank(::GlobalNamespace::__RankModel__Rank  value) ;

/// @brief Method set_relativeScore, addr 0x3b13738, size 0x8, virtual false, abstract: false, final false
