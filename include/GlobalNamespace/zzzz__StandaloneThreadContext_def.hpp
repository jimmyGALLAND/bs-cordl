...
/// @brief Method Run, addr 0x229cfc4, size 0x4, virtual true, abstract: false, final true
inline void Run(::GlobalNamespace::IStandaloneThreadRunnable*  runnable) ;

/// @brief Method .ctor, addr 0x229cfc8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
