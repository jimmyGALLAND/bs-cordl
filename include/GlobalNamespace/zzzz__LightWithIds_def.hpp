...
/// @brief Method ColorWasSet, addr 0x395e55c, size 0x28, virtual true, abstract: false, final false
...
/// @brief Method __SetIsRegistered, addr 0x3960d94, size 0xc, virtual true, abstract: false, final true
inline void __SetIsRegistered() ;

/// @brief Method __SetIsUnRegistered, addr 0x3960da0, size 0x8, virtual true, abstract: false, final true
inline void __SetIsUnRegistered() ;

/// @brief Method __SetParentLightWithIds, addr 0x3960da8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x395f150, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x395e4ec, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  lightId) ;

/// @brief Method get_color, addr 0x3960d80, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_isRegistered, addr 0x3960d8c, size 0x8, virtual true, abstract: false, final true
inline bool get_isRegistered() ;

/// @brief Method get_lightId, addr 0x3960d78, size 0x8, virtual true, abstract: false, final true
...
/// @brief Field _lightWithIds, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightWithIds, put=__cordl_internal_set__lightWithIds)) ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::__LightWithIds__LightWithId*>*  _lightWithIds;
...
/// @brief Method Awake, addr 0x395f1ec, size 0x38, virtual true, abstract: false, final false
inline void Awake() ;
...
/// @brief Method HandleLightManagerDidChangeSomeColorsThisFrame, addr 0x3960d5c, size 0x1c, virtual false, abstract: false, final false
inline void HandleLightManagerDidChangeSomeColorsThisFrame() ;

/// @brief Method MarkChildrenColorAsSet, addr 0x39609b0, size 0xc, virtual false, abstract: false, final false
inline void MarkChildrenColorAsSet() ;

static inline ::GlobalNamespace::LightWithIds* New_ctor() ;

/// @brief Method OnDisable, addr 0x3960d58, size 0x4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x395def8, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method RegisterForColorChanges, addr 0x39605e8, size 0x3c8, virtual false, abstract: false, final false
inline void RegisterForColorChanges() ;

/// @brief Method SetNewLightsWithIds, addr 0x39605bc, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x39605e4, size 0x4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UnregisterFromColorChanges, addr 0x39609bc, size 0x39c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x395e4b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_lightWithIds, addr 0x39605b4, size 0x8, virtual false, abstract: false, final false
