...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SaberModelController::*)(::UnityEngine::Transform*, ::GlobalNamespace::Saber*, ::UnityEngine::Color)>(&::GlobalNamespace::SaberModelController::Init)> {
  constexpr static std::size_t size = 0x18c;
  constexpr static std::size_t addrs = 0x3b55488;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Transform*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::Saber*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Color>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SaberModelController::*)(::GlobalNamespace::SaberType)>(&::GlobalNamespace::SaberModelController::InitColor)> {
  constexpr static std::size_t size = 0x174;
  constexpr static std::size_t addrs = 0x3b556dc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SaberModelController::*)()>(&::GlobalNamespace::SaberModelController::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3b55868;
...
constexpr ::ArrayW<::UnityW<::GlobalNamespace::SetSaberGlowColor>,::Array<::UnityW<::GlobalNamespace::SetSaberGlowColor>>*>& GlobalNamespace::SaberModelController::__cordl_internal_get__setSaberGlowColors()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____setSaberGlowColors;
}
constexpr ::ArrayW<::UnityW<::GlobalNamespace::SetSaberGlowColor>,::Array<::UnityW<::GlobalNamespace::SetSaberGlowColor>>*> const& GlobalNamespace::SaberModelController::__cordl_internal_get__setSaberGlowColors() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____setSaberGlowColors;
}
constexpr void GlobalNamespace::SaberModelController::__cordl_internal_set__setSaberGlowColors(::ArrayW<::UnityW<::GlobalNamespace::SetSaberGlowColor>,::Array<::UnityW<::GlobalNamespace::SetSaberGlowColor>>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::UnityW<::GlobalNamespace::SetSaberFakeGlowColor>,::Array<::UnityW<::GlobalNamespace::SetSaberFakeGlowColor>>*>& GlobalNamespace::SaberModelController::__cordl_internal_get__setSaberFakeGlowColors()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____setSaberFakeGlowColors;
}
constexpr ::ArrayW<::UnityW<::GlobalNamespace::SetSaberFakeGlowColor>,::Array<::UnityW<::GlobalNamespace::SetSaberFakeGlowColor>>*> const& GlobalNamespace::SaberModelController::__cordl_internal_get__setSaberFakeGlowColors() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____setSaberFakeGlowColors;
}
constexpr void GlobalNamespace::SaberModelController::__cordl_internal_set__setSaberFakeGlowColors(::ArrayW<::UnityW<::GlobalNamespace::SetSaberFakeGlowColor>,::Array<::UnityW<::GlobalNamespace::SetSaberFakeGlowColor>>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
