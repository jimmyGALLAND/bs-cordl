...
/// @brief Method .ctor, addr 0x3a4ec7c, size 0x30, virtual false, abstract: false, final false
...
/// @brief Field <handleWrongSaberTypeAsGood>k__BackingField, offset 0x70, size 0x1 
 __declspec(property(get=__cordl_internal_get__handleWrongSaberTypeAsGood_k__BackingField, put=__cordl_internal_set__handleWrongSaberTypeAsGood_k__BackingField)) bool  _handleWrongSaberTypeAsGood_k__BackingField;
...
/// @brief Field _longCutEffectsAudioClips, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__longCutEffectsAudioClips, put=__cordl_internal_set__longCutEffectsAudioClips)) ::ArrayW<::UnityW<::UnityEngine::AudioClip>,::Array<::UnityW<::UnityEngine::AudioClip>>*>  _longCutEffectsAudioClips;
...
/// @brief Field _noteCutSoundEffectPoolContainer, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get__noteCutSoundEffectPoolContainer, put=__cordl_internal_set__noteCutSoundEffectPoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::NoteCutSoundEffect>>*  _noteCutSoundEffectPoolContainer;
...
/// @brief Field _randomLongCutSoundPicker, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__randomLongCutSoundPicker, put=__cordl_internal_set__randomLongCutSoundPicker)) ::GlobalNamespace::RandomObjectPicker_1<::UnityW<::UnityEngine::AudioClip>>*  _randomLongCutSoundPicker;

/// @brief Field _randomShortCutSoundPicker, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__randomShortCutSoundPicker, put=__cordl_internal_set__randomShortCutSoundPicker)) ::GlobalNamespace::RandomObjectPicker_1<::UnityW<::UnityEngine::AudioClip>>*  _randomShortCutSoundPicker;
...
/// @brief Field _shortCutEffectsAudioClips, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__shortCutEffectsAudioClips, put=__cordl_internal_set__shortCutEffectsAudioClips)) ::ArrayW<::UnityW<::UnityEngine::AudioClip>,::Array<::UnityW<::UnityEngine::AudioClip>>*>  _shortCutEffectsAudioClips;
...
/// @brief Method HandleNoteCutSoundEffectDidFinish, addr 0x3a4eb2c, size 0xd8, virtual true, abstract: false, final true
inline void HandleNoteCutSoundEffectDidFinish(::GlobalNamespace::NoteCutSoundEffect*  noteCutSoundEffect) ;

/// @brief Method HandleNoteDidStartDissolving, addr 0x3a4e98c, size 0x1a0, virtual false, abstract: false, final false
inline void HandleNoteDidStartDissolving(::GlobalNamespace::NoteControllerBase*  noteController) ;

/// @brief Method HandleNoteWasCut, addr 0x3a4e7dc, size 0x1b0, virtual false, abstract: false, final false
inline void HandleNoteWasCut(::GlobalNamespace::NoteController*  noteController, ByRef<::GlobalNamespace::NoteCutInfo>  noteCutInfo) ;

/// @brief Method HandleNoteWasSpawned, addr 0x3a4e218, size 0x590, virtual false, abstract: false, final false
inline void HandleNoteWasSpawned(::GlobalNamespace::NoteController*  noteController) ;

/// @brief Method IsSupportedNote, addr 0x3a4e7a8, size 0x34, virtual false, abstract: false, final false
inline bool IsSupportedNote(::GlobalNamespace::NoteData*  noteData) ;

/// @brief Method LateUpdate, addr 0x3a4e170, size 0xa8, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::NoteCutSoundEffectManager* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3a4dec8, size 0x148, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3a4dadc, size 0x28c, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::NoteCutSoundEffect>>*> const& __cordl_internal_get__noteCutSoundEffectPoolContainer() const;
...
/// @brief Method .ctor, addr 0x3a4ec04, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_handleWrongSaberTypeAsGood, addr 0x3a4dac8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_handleWrongSaberTypeAsGood, addr 0x3a4dad0, size 0xc, virtual false, abstract: false, final false
