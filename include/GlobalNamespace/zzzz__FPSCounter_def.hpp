...
/// @brief Method Awake, addr 0x393ca1c, size 0x10, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::FPSCounter* New_ctor() ;

/// @brief Method Update, addr 0x393ca2c, size 0xac, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x393cad8, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_currentFPS, addr 0x393c9dc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_currentFPS() ;

/// @brief Method get_droppedFrames, addr 0x393ca0c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_droppedFrames() ;

/// @brief Method get_highestFPS, addr 0x393c9fc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_highestFPS() ;

/// @brief Method get_lowestFPS, addr 0x393c9ec, size 0x8, virtual false, abstract: false, final false
inline int32_t get_lowestFPS() ;

/// @brief Method set_currentFPS, addr 0x393c9e4, size 0x8, virtual false, abstract: false, final false
inline void set_currentFPS(int32_t  value) ;

/// @brief Method set_droppedFrames, addr 0x393ca14, size 0x8, virtual false, abstract: false, final false
inline void set_droppedFrames(int32_t  value) ;

/// @brief Method set_highestFPS, addr 0x393ca04, size 0x8, virtual false, abstract: false, final false
inline void set_highestFPS(int32_t  value) ;

/// @brief Method set_lowestFPS, addr 0x393c9f4, size 0x8, virtual false, abstract: false, final false
