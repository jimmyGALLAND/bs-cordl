...
/// @brief Method FadeIn, addr 0x3a4f210, size 0x3c, virtual false, abstract: false, final false
inline void FadeIn(float_t  duration) ;

/// @brief Method FadeOut, addr 0x3a4f34c, size 0x38, virtual true, abstract: false, final false
inline void FadeOut(float_t  duration) ;

static inline ::GlobalNamespace::SimpleAudioPlayer* New_ctor() ;

/// @brief Method PauseCurrentChannel, addr 0x3a4f384, size 0x1c, virtual true, abstract: false, final false
inline void PauseCurrentChannel() ;

/// @brief Method Start, addr 0x3a4f190, size 0x80, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UnPauseCurrentChannel, addr 0x3a4f3a0, size 0x1c, virtual true, abstract: false, final false
inline void UnPauseCurrentChannel() ;

/// @brief Method Update, addr 0x3a4f24c, size 0x100, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3a4f3bc, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_activeAudioClip, addr 0x3a4f188, size 0x8, virtual true, abstract: false, final false
