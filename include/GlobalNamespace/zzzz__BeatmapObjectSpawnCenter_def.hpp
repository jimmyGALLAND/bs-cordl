...
/// @brief Method .ctor, addr 0x3a5a164, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_distance, addr 0x3a5a15c, size 0x8, virtual false, abstract: false, final false
inline float_t get_distance() ;

/// @brief Method get_playerCount, addr 0x3a5a154, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _distances, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__distances, put=__cordl_internal_set__distances)) ::ArrayW<::GlobalNamespace::__BeatmapObjectSpawnCenter__PlayerCountToDistance*,::Array<::GlobalNamespace::__BeatmapObjectSpawnCenter__PlayerCountToDistance*>*>  _distances;
...
/// @brief Method CalculateSpawnCenterPosition, addr 0x3a59fb8, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method ReportAndSaveSpawnCenterDistance, addr 0x3a5a11c, size 0x28, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__BeatmapObjectSpawnCenter__PlayerCountToDistance*,::Array<::GlobalNamespace::__BeatmapObjectSpawnCenter__PlayerCountToDistance*>*> const& __cordl_internal_get__distances() const;

constexpr ::ArrayW<::GlobalNamespace::__BeatmapObjectSpawnCenter__PlayerCountToDistance*,::Array<::GlobalNamespace::__BeatmapObjectSpawnCenter__PlayerCountToDistance*>*>& __cordl_internal_get__distances() ;
...
constexpr void __cordl_internal_set__distances(::ArrayW<::GlobalNamespace::__BeatmapObjectSpawnCenter__PlayerCountToDistance*,::Array<::GlobalNamespace::__BeatmapObjectSpawnCenter__PlayerCountToDistance*>*>  value) ;
...
/// @brief Method .ctor, addr 0x3a5a144, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_spawnCenterDistanceWasFoundEvent, addr 0x3a52030, size 0xb0, virtual false, abstract: false, final false
inline void add_spawnCenterDistanceWasFoundEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method get_spawnCenterDistance, addr 0x3a59ef8, size 0x8, virtual false, abstract: false, final false
inline float_t get_spawnCenterDistance() ;

/// @brief Method get_spawnCenterDistanceWasFound, addr 0x3a59f00, size 0x8, virtual false, abstract: false, final false
inline bool get_spawnCenterDistanceWasFound() ;

/// @brief Method remove_spawnCenterDistanceWasFoundEvent, addr 0x3a59f08, size 0xb0, virtual false, abstract: false, final false
