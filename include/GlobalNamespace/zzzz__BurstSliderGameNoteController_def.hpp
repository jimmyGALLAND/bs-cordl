...
/// @brief Method .ctor, addr 0x3a5fdf4, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Awake, addr 0x3a5f254, size 0x1a0, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleBigWasCutBySaber, addr 0x3a5f73c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method HandleCut, addr 0x3a5f754, size 0x590, virtual false, abstract: false, final false
...
/// @brief Method HandleSmallWasCutBySaber, addr 0x3a5fce4, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method HiddenStateDidChange, addr 0x3a5fdbc, size 0x24, virtual true, abstract: false, final false
inline void HiddenStateDidChange(bool  hide) ;

/// @brief Method Init, addr 0x3a5efb4, size 0x2a0, virtual false, abstract: false, final false
...
/// @brief Method NoteDidPassMissedMarker, addr 0x3a5f5c8, size 0xbc, virtual true, abstract: false, final false
inline void NoteDidPassMissedMarker() ;

/// @brief Method NoteDidStartDissolving, addr 0x3a5f684, size 0xb8, virtual true, abstract: false, final false
inline void NoteDidStartDissolving() ;

/// @brief Method NoteDidStartJump, addr 0x3a5fcfc, size 0xc0, virtual true, abstract: false, final false
inline void NoteDidStartJump() ;

/// @brief Method OnDestroy, addr 0x3a5f3f4, size 0x1d4, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Pause, addr 0x3a5fde0, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a5fdf0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_cubeNoteControllerDidInitEvent, addr 0x3a5ee3c, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method get_gameplayType, addr 0x3a5efac, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::__NoteData__GameplayType get_gameplayType() ;

/// @brief Method get_noteMovement, addr 0x3a5ef9c, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::GlobalNamespace::NoteMovement> get_noteMovement() ;

/// @brief Method get_noteVisualModifierType, addr 0x3a5efa4, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method remove_cubeNoteControllerDidInitEvent, addr 0x3a5eeec, size 0xb0, virtual true, abstract: false, final true
