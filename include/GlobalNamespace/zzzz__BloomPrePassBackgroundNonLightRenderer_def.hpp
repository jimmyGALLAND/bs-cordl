...
/// @brief Method Awake, addr 0x3954c5c, size 0x2c, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method InitIfNeeded, addr 0x3954ce4, size 0xc8, virtual true, abstract: false, final false
inline void InitIfNeeded() ;

static inline ::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer* New_ctor() ;

/// @brief Method OnEnable, addr 0x3954c94, size 0x10, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnValidate, addr 0x3954ca8, size 0x34, virtual true, abstract: false, final false
inline void OnValidate() ;

/// @brief Method SetRenderer, addr 0x3954cdc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3954ec0, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_cachedTransform, addr 0x3954c54, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_cachedTransform() ;

/// @brief Method get_meshFilter, addr 0x3954c4c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::MeshFilter> get_meshFilter() ;

/// @brief Method get_renderer, addr 0x3954c44, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Renderer> get_renderer() ;

/// @brief Method set_isPartOfInstancedRendering, addr 0x3954110, size 0x34, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer, 0x70>, "Size mismatch!");
