...
/// @brief Method SetTextAndRunAnimation, addr 0x3b771ac, size 0x64, virtual false, abstract: false, final false
inline void SetTextAndRunAnimation(::StringW  text) ;

/// @brief Method StopAndHide, addr 0x3b77304, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b7748c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
