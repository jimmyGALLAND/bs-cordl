...
/// @brief Method MoveNext, addr 0x3ae9c84, size 0x4b8, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3aea13c, size 0xc, virtual true, abstract: false, final true
...
/// @brief Method Dispose, addr 0x3ae983c, size 0x1ac, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method HandleDestinationRequestManagerDidSendMenuDestinationRequest, addr 0x3ae9c78, size 0x4, virtual false, abstract: false, final false
inline void HandleDestinationRequestManagerDidSendMenuDestinationRequest(::GlobalNamespace::MenuDestination*  menuDestination) ;

/// @brief Method HandleGameScenesManagerInstallEarlyBindings, addr 0x3ae99e8, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x3ae9530, size 0x270, virtual true, abstract: false, final true
inline void Initialize() ;

static inline ::GlobalNamespace::MainMenuDestinationRequestController* New_ctor() ;

/// @brief Method ProcessDestinationRequest, addr 0x3ae97a0, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ae9c7c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
