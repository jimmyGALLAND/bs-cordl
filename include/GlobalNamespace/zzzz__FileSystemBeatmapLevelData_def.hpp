...
/// @brief Method ContainsBeatmapData, addr 0x267f11c, size 0x18, virtual false, abstract: false, final false
inline bool ContainsBeatmapData(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method GetAudioDataString, addr 0x267f06c, size 0x78, virtual true, abstract: false, final true
inline ::StringW GetAudioDataString() ;

/// @brief Method GetAudioDataStringAsync, addr 0x267ede0, size 0xb8, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::StringW>* GetAudioDataStringAsync() ;

/// @brief Method GetBeatmapString, addr 0x267f0e4, size 0x1c, virtual false, abstract: false, final false
inline ::StringW GetBeatmapString(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method GetBeatmapStringAsync, addr 0x267ee98, size 0x94, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::StringW>* GetBeatmapStringAsync(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method GetDifficultyBeatmap, addr 0x267ef2c, size 0xac, virtual false, abstract: false, final false
inline ::GlobalNamespace::FileDifficultyBeatmap* GetDifficultyBeatmap(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method GetLightshowString, addr 0x267f100, size 0x1c, virtual false, abstract: false, final false
inline ::StringW GetLightshowString(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method GetLightshowStringAsync, addr 0x267efd8, size 0x94, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::StringW>* GetLightshowStringAsync(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method IBeatmapLevelData.ContainsBeatmapData, addr 0x267f144, size 0x18, virtual true, abstract: false, final true
inline bool IBeatmapLevelData_ContainsBeatmapData(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method IBeatmapLevelData.GetBeatmapString, addr 0x267f13c, size 0x4, virtual true, abstract: false, final true
inline ::StringW IBeatmapLevelData_GetBeatmapString(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method IBeatmapLevelData.GetBeatmapStringAsync, addr 0x267f134, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method IBeatmapLevelData.GetLightshowString, addr 0x267f140, size 0x4, virtual true, abstract: false, final true
inline ::StringW IBeatmapLevelData_GetLightshowString(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method IBeatmapLevelData.GetLightshowStringAsync, addr 0x267f138, size 0x4, virtual true, abstract: false, final true
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>,::GlobalNamespace::BeatmapDifficulty>,::GlobalNamespace::FileDifficultyBeatmap*>*> const& __cordl_internal_get__difficultyBeatmaps() const;
...
/// @brief Method .ctor, addr 0x267eda0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_name, addr 0x267ed98, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_name() ;

/// @brief Method get_songAudioClipPath, addr 0x267ed90, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_songAudioClipPath() ;

/// @brief Method get_version, addr 0x267ed88, size 0x8, virtual true, abstract: false, final true
