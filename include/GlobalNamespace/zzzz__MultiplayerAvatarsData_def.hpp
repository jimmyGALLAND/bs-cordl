...
/// @brief Method CreateFromSerializedData, addr 0x26d2ce0, size 0x38, virtual true, abstract: false, final true
inline ::GlobalNamespace::MultiplayerAvatarsData CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Deserialize, addr 0x26d2d18, size 0x34, virtual false, abstract: false, final false
static inline ::GlobalNamespace::MultiplayerAvatarsData Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method DeserializeAvatarsData, addr 0x26d2d4c, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x26d2fe8, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x26d2e7c, size 0x16c, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::MultiplayerAvatarsData  other) ;

/// @brief Method GetHashCode, addr 0x26d3078, size 0x224, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Serialize, addr 0x26d2b18, size 0x28, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method SerializeAvatarsData, addr 0x26d2b40, size 0x1a0, virtual false, abstract: false, final false
inline void SerializeAvatarsData(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method SupportsOptionalAvatarDataType, addr 0x26d329c, size 0x60, virtual false, abstract: false, final false
inline bool SupportsOptionalAvatarDataType(uint32_t  typeHash) ;

/// @brief Method .ctor, addr 0x26d2aa0, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26d2b0c, size 0xc, virtual false, abstract: false, final false
