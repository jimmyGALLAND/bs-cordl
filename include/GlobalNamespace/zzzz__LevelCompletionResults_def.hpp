...
/// @brief Field averageCenterDistanceCutScoreForNotesWithFullScoreScoringType, offset 0x64, size 0x4 
 __declspec(property(get=__cordl_internal_get_averageCenterDistanceCutScoreForNotesWithFullScoreScoringType, put=__cordl_internal_set_averageCenterDistanceCutScoreForNotesWithFullScoreScoringType)) float_t  averageCenterDistanceCutScoreForNotesWithFullScoreScoringType;

/// @brief Field averageCutScoreForNotesWithFullScoreScoringType, offset 0x68, size 0x4 
 __declspec(property(get=__cordl_internal_get_averageCutScoreForNotesWithFullScoreScoringType, put=__cordl_internal_set_averageCutScoreForNotesWithFullScoreScoringType)) float_t  averageCutScoreForNotesWithFullScoreScoringType;
...
/// @brief Field goodCutsCountForNotesWithFullScoreScoringType, offset 0x60, size 0x4 
 __declspec(property(get=__cordl_internal_get_goodCutsCountForNotesWithFullScoreScoringType, put=__cordl_internal_set_goodCutsCountForNotesWithFullScoreScoringType)) int32_t  goodCutsCountForNotesWithFullScoreScoringType;
...
/// @brief Method CompareTo, addr 0x26d2354, size 0x11c, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Object*  obj) ;

/// @brief Method CreateFromSerializedData, addr 0x26d275c, size 0x31c, virtual false, abstract: false, final false
static inline ::GlobalNamespace::LevelCompletionResults* CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method LiteNetLib.Utils.INetImmutableSerializable<LevelCompletionResults>.CreateFromSerializedData, addr 0x26d2754, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method Serialize, addr 0x26d2470, size 0x2c4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x26d2218, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x26d2220, size 0x134, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::GameplayModifiers*  gameplayModifiers, int32_t  modifiedScore, int32_t  multipliedScore, ::GlobalNamespace::__RankModel__Rank  rank, bool  fullCombo, float_t  leftSaberMovementDistance, float_t  rightSaberMovementDistance, float_t  leftHandMovementDistance, float_t  rightHandMovementDistance, ::GlobalNamespace::__LevelCompletionResults__LevelEndStateType  levelEndStateType, ::GlobalNamespace::__LevelCompletionResults__LevelEndAction  levelEndAction, float_t  energy, int32_t  goodCutsCount, int32_t  badCutsCount, int32_t  missedCount, int32_t  notGoodCount, int32_t  okCount, int32_t  maxCutScore, int32_t  totalCutScore, int32_t  goodCutsCountForNotesWithFullScoreScoringType, float_t  averageCenterDistanceCutScoreForNotesWithFullScoreScoringType, float_t  averageCutScoreForNotesWithFullScoreScoringType, int32_t  maxCombo, float_t  endSongTime, bool  invalidated) ;

/// @brief Method get_cumulativeScore, addr 0x26d2210, size 0x8, virtual false, abstract: false, final false
...
constexpr ::LiteNetLib::Utils::INetImmutableSerializable_1<::GlobalNamespace::LevelCompletionResults*>* i___LiteNetLib__Utils__INetImmutableSerializable_1___GlobalNamespace__LevelCompletionResults__() noexcept;
