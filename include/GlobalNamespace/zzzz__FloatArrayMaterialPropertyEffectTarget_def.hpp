...
/// @brief Method Awake, addr 0x3af8058, size 0x20, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::FloatArrayMaterialPropertyEffectTarget* New_ctor() ;

/// @brief Method SetFloat, addr 0x3af807c, size 0xac, virtual false, abstract: false, final false
inline void SetFloat(float_t  value) ;

/// @brief Method SetValue, addr 0x3af8078, size 0x4, virtual true, abstract: false, final false
inline void SetValue(int32_t  groupId, int32_t  elementId, float_t  value) ;

/// @brief Method TriggerValue, addr 0x3af8128, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3af812c, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
