...
/// @brief Method CellForIdx, addr 0x3a744c0, size 0x1b4, virtual true, abstract: false, final true
inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView*  tableView, int32_t  idx) ;

/// @brief Method CellSize, addr 0x3a74400, size 0x8, virtual true, abstract: false, final true
inline float_t CellSize(int32_t  idx) ;

/// @brief Method HandleAdditionalContentModelDidInvalidateData, addr 0x3a74754, size 0xac, virtual false, abstract: false, final false
inline void HandleAdditionalContentModelDidInvalidateData() ;

/// @brief Method HandleDidSelectColumnEvent, addr 0x3a74674, size 0xe0, virtual false, abstract: false, final false
inline void HandleDidSelectColumnEvent(::HMUI::TableView*  tableView, int32_t  column) ;

/// @brief Method Init, addr 0x3a74254, size 0xc4, virtual false, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::BeatmapCharacteristicsTableView* New_ctor() ;

/// @brief Method NumberOfCells, addr 0x3a74408, size 0xb8, virtual true, abstract: false, final true
inline int32_t NumberOfCells() ;

/// @brief Method OnDestroy, addr 0x3a74370, size 0x90, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SelectCellWithIdx, addr 0x3a74800, size 0x20, virtual false, abstract: false, final false
inline void SelectCellWithIdx(int32_t  idx) ;

/// @brief Method SetData, addr 0x3a74318, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a74820, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didSelectCharacteristic, addr 0x3a740f4, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_didSelectCharacteristic, addr 0x3a741a4, size 0xb0, virtual false, abstract: false, final false
