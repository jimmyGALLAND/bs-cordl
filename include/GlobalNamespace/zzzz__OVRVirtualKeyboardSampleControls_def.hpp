...
public:
// Declarations
/// @brief Method RestoreTo, addr 0x3f96310, size 0xc8, virtual false, abstract: false, final false
inline void RestoreTo(::GlobalNamespace::OVRVirtualKeyboard*  keyboard) ;

/// @brief Method .ctor, addr 0x3f9682c, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Field keyboardBackup, offset 0x70, size 0x80 
 __declspec(property(get=__cordl_internal_get_keyboardBackup, put=__cordl_internal_set_keyboardBackup)) ::GlobalNamespace::__OVRVirtualKeyboardSampleControls__OVRVirtualKeyboardBackup  keyboardBackup;
...
/// @brief Method DestroyKeyboard, addr 0x3f96748, size 0xe4, virtual false, abstract: false, final false
inline void DestroyKeyboard() ;

/// @brief Method HideKeyboard, addr 0x3f9670c, size 0x3c, virtual false, abstract: false, final false
inline void HideKeyboard() ;

/// @brief Method MoveKeyboard, addr 0x3f9652c, size 0x12c, virtual false, abstract: false, final false
inline void MoveKeyboard() ;

/// @brief Method MoveKeyboardFar, addr 0x3f966c4, size 0x48, virtual false, abstract: false, final false
inline void MoveKeyboardFar() ;

/// @brief Method MoveKeyboardNear, addr 0x3f9667c, size 0x48, virtual false, abstract: false, final false
inline void MoveKeyboardNear() ;

static inline ::GlobalNamespace::OVRVirtualKeyboardSampleControls* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3f96134, size 0x1dc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnHideKeyboard, addr 0x3f96908, size 0x4, virtual false, abstract: false, final false
inline void OnHideKeyboard() ;

/// @brief Method ShowKeyboard, addr 0x3f96034, size 0x100, virtual false, abstract: false, final false
inline void ShowKeyboard() ;

/// @brief Method Start, addr 0x3f95e78, size 0x1bc, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3f9690c, size 0x274, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateButtonInteractable, addr 0x3f963d8, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f96ea0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
