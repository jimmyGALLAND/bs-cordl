...
/// @brief Method DidActivate, addr 0x3b8613c, size 0x1ec, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HandleSettingsMenuSegmentedControlDidSelectCell, addr 0x3b86328, size 0x54, virtual false, abstract: false, final false
inline void HandleSettingsMenuSegmentedControlDidSelectCell(::HMUI::SegmentedControl*  segmentedControl, int32_t  cellIdx) ;

/// @brief Method Init, addr 0x3b86104, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b8637c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didSelectSettingsSubMenuEvent, addr 0x3b85f80, size 0xb0, virtual false, abstract: false, final false
inline void add_didSelectSettingsSubMenuEvent(::System::Action_2<::GlobalNamespace::SettingsSubMenuInfo*,int32_t>*  value) ;

/// @brief Method get_numberOfSubMenus, addr 0x3b860e0, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_numberOfSubMenus() ;

/// @brief Method get_selectedSubMenuInfo, addr 0x3b860fc, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::SettingsSubMenuInfo* get_selectedSubMenuInfo() ;

/// @brief Method remove_didSelectSettingsSubMenuEvent, addr 0x3b86030, size 0xb0, virtual false, abstract: false, final false
