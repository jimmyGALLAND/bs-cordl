...
/// @brief Method SetPagesCount, addr 0x3a720b8, size 0x3d4, virtual false, abstract: false, final false
inline void SetPagesCount(int32_t  pagesCount) ;

/// @brief Method SetSelectedPageIndex, addr 0x3a7248c, size 0xd0, virtual false, abstract: false, final false
inline void SetSelectedPageIndex(int32_t  page) ;

/// @brief Method SetVisible, addr 0x3a7b470, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a7b4a0, size 0xd4, virtual false, abstract: false, final false
inline void _ctor() ;
