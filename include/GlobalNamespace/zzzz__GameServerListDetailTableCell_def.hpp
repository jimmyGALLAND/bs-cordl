...
/// @brief Method Start, addr 0x3b6579c, size 0xa4, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method <Start>b__5_0, addr 0x3b658a0, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b65840, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_joinServerButtonWasPressedEvent, addr 0x3b65664, size 0x9c, virtual false, abstract: false, final false
inline void add_joinServerButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method remove_joinServerButtonWasPressedEvent, addr 0x3b65700, size 0x9c, virtual false, abstract: false, final false
