...
/// @brief Field subtasks, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_subtasks, put=__cordl_internal_set_subtasks)) ::ArrayW<::UnityW<::GlobalNamespace::ProgressActivitySubtaskSO>,::Array<::UnityW<::GlobalNamespace::ProgressActivitySubtaskSO>>*>  subtasks;
...
/// @brief Method .ctor, addr 0x269a978, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
