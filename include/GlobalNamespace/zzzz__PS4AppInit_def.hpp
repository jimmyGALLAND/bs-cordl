...
/// @brief Method MoveNext, addr 0x26ce30c, size 0x1ec, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x26ce4f8, size 0x68, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::PS4AppInit>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
constexpr __PS4AppInit___PreloadAsync_d__7(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::UnityW<::GlobalNamespace::PS4AppInit>  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter  __u__1) noexcept;
...
/// @brief Field _activePublisherSKUSettingsSO, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get__activePublisherSKUSettingsSO, put=__cordl_internal_set__activePublisherSKUSettingsSO)) ::UnityW<::GlobalNamespace::PS4ActivePublisherSKUSettingsSO>  _activePublisherSKUSettingsSO;
...
/// @brief Method AppStartAndMultiSceneEditorSetup, addr 0x26cdec8, size 0x68, virtual true, abstract: false, final false
inline void AppStartAndMultiSceneEditorSetup() ;

/// @brief Method InitializeModules, addr 0x26cdda0, size 0x68, virtual false, abstract: false, final false
static inline int32_t InitializeModules() ;

/// @brief Method InstallBindings, addr 0x26ce098, size 0x214, virtual true, abstract: false, final false
inline void InstallBindings() ;

static inline ::GlobalNamespace::PS4AppInit* New_ctor() ;

/// @brief Method PreloadAsync, addr 0x26cde08, size 0xc0, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* PreloadAsync() ;

/// @brief Method RepeatableSetupAsync, addr 0x26cdf30, size 0xa0, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* RepeatableSetupAsync() ;

/// @brief Method TransitionToNextScene, addr 0x26cdfd0, size 0xc8, virtual true, abstract: false, final false
...
/// @brief Method <>n__0, addr 0x26ce304, size 0x8, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* __n__0() ;

/// @brief Method .ctor, addr 0x26ce2ac, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
