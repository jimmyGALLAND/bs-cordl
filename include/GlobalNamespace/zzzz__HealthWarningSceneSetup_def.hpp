...
/// @brief Method InstallBindings, addr 0x3aaac0c, size 0x154, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aaad60, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
