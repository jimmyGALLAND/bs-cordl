...
/// @brief Method Awake, addr 0x3b09720, size 0xe8, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::Spectrogram* New_ctor() ;

/// @brief Method Update, addr 0x3b09808, size 0x1a8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b099b0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_materialPropertyBlock, addr 0x3b0966c, size 0xb4, virtual false, abstract: false, final false
