...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EnableEmmisionOnVisible::*)()>(&::GlobalNamespace::EnableEmmisionOnVisible::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x3941374;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EnableEmmisionOnVisible::*)()>(&::GlobalNamespace::EnableEmmisionOnVisible::OnBecameVisible)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x394145c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EnableEmmisionOnVisible::*)()>(&::GlobalNamespace::EnableEmmisionOnVisible::OnBecameInvisible)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x39414d0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EnableEmmisionOnVisible::*)()>(&::GlobalNamespace::EnableEmmisionOnVisible::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3941544;
...
constexpr ::ArrayW<::UnityW<::UnityEngine::ParticleSystem>,::Array<::UnityW<::UnityEngine::ParticleSystem>>*> const& GlobalNamespace::EnableEmmisionOnVisible::__cordl_internal_get__particleSystems() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____particleSystems;
}
constexpr void GlobalNamespace::EnableEmmisionOnVisible::__cordl_internal_set__particleSystems(::ArrayW<::UnityW<::UnityEngine::ParticleSystem>,::Array<::UnityW<::UnityEngine::ParticleSystem>>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::UnityEngine::__ParticleSystem__EmissionModule,::Array<::UnityEngine::__ParticleSystem__EmissionModule>*>& GlobalNamespace::EnableEmmisionOnVisible::__cordl_internal_get__emmisionModules()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____emmisionModules;
}
constexpr ::ArrayW<::UnityEngine::__ParticleSystem__EmissionModule,::Array<::UnityEngine::__ParticleSystem__EmissionModule>*> const& GlobalNamespace::EnableEmmisionOnVisible::__cordl_internal_get__emmisionModules() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____emmisionModules;
}
constexpr void GlobalNamespace::EnableEmmisionOnVisible::__cordl_internal_set__emmisionModules(::ArrayW<::UnityEngine::__ParticleSystem__EmissionModule,::Array<::UnityEngine::__ParticleSystem__EmissionModule>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
