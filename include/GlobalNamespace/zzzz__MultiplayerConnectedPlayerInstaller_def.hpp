...
/// @brief Field _connectedPlayerAudioTimeSyncControllerPrefab, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__connectedPlayerAudioTimeSyncControllerPrefab, put=__cordl_internal_set__connectedPlayerAudioTimeSyncControllerPrefab)) ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerSongTimeSyncController>  _connectedPlayerAudioTimeSyncControllerPrefab;

/// @brief Field _connectedPlayerBeatmapObjectEventManagerPrefab, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__connectedPlayerBeatmapObjectEventManagerPrefab, put=__cordl_internal_set__connectedPlayerBeatmapObjectEventManagerPrefab)) ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerBeatmapObjectEventManager>  _connectedPlayerBeatmapObjectEventManagerPrefab;
...
/// @brief Field _multiplayerBombNoteControllerPrefab, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerBombNoteControllerPrefab, put=__cordl_internal_set__multiplayerBombNoteControllerPrefab)) ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerBombNoteController>  _multiplayerBombNoteControllerPrefab;

/// @brief Field _multiplayerBurstSliderGameNoteControllerPrefab, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerBurstSliderGameNoteControllerPrefab, put=__cordl_internal_set__multiplayerBurstSliderGameNoteControllerPrefab)) ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>  _multiplayerBurstSliderGameNoteControllerPrefab;

/// @brief Field _multiplayerBurstSliderHeadGameNoteControllerPrefab, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerBurstSliderHeadGameNoteControllerPrefab, put=__cordl_internal_set__multiplayerBurstSliderHeadGameNoteControllerPrefab)) ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>  _multiplayerBurstSliderHeadGameNoteControllerPrefab;

/// @brief Field _multiplayerGameNoteControllerPrefab, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerGameNoteControllerPrefab, put=__cordl_internal_set__multiplayerGameNoteControllerPrefab)) ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>  _multiplayerGameNoteControllerPrefab;

/// @brief Field _multiplayerObstacleControllerPrefab, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerObstacleControllerPrefab, put=__cordl_internal_set__multiplayerObstacleControllerPrefab)) ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerObstacleController>  _multiplayerObstacleControllerPrefab;
...
/// @brief Method InstallBindings, addr 0x3b233a8, size 0x9c4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b23da8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
