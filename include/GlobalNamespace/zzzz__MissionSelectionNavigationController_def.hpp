...
/// @brief Method <PresentMissionClearedIfNeeded>b__0, addr 0x3b88b14, size 0xb8, virtual false, abstract: false, final false
inline void _PresentMissionClearedIfNeeded_b__0() ;

/// @brief Method <PresentMissionClearedIfNeeded>b__1, addr 0x3b88bcc, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b88b04, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _missionLevelDetailViewController, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get__missionLevelDetailViewController, put=__cordl_internal_set__missionLevelDetailViewController)) ::UnityW<::GlobalNamespace::MissionLevelDetailViewController>  _missionLevelDetailViewController;

/// @brief Field _missionSelectionMapViewController, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__missionSelectionMapViewController, put=__cordl_internal_set__missionSelectionMapViewController)) ::UnityW<::GlobalNamespace::MissionSelectionMapViewController>  _missionSelectionMapViewController;

/// @brief Field didPressPlayButtonEvent, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didPressPlayButtonEvent, put=__cordl_internal_set_didPressPlayButtonEvent)) ::System::Action_1<::UnityW<::GlobalNamespace::MissionSelectionNavigationController>>*  didPressPlayButtonEvent;

 __declspec(property(get=get_selectedMissionNode)) ::UnityW<::GlobalNamespace::MissionNode>  selectedMissionNode;

/// @brief Method DidActivate, addr 0x3b8870c, size 0x160, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3b8886c, size 0xf0, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleMissionLevelDetailViewControllerDidPressPlayButton, addr 0x3b889d0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method HandleMissionSelectionMapViewControllerDidSelectMissionLevel, addr 0x3b8895c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method PresentMissionClearedIfNeeded, addr 0x3b889f0, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b88b0c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didPressPlayButtonEvent, addr 0x3b88590, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_selectedMissionNode, addr 0x3b886f0, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionNode> get_selectedMissionNode() ;

/// @brief Method remove_didPressPlayButtonEvent, addr 0x3b88640, size 0xb0, virtual false, abstract: false, final false
