...
/// @brief Method OnDestroy, addr 0x396404c, size 0x88, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Resize, addr 0x39640d4, size 0x1a0, virtual false, abstract: false, final false
inline void Resize(::UnityEngine::Vector2  size, float_t  duration) ;

/// @brief Method SetSize, addr 0x3964274, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3964290, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
