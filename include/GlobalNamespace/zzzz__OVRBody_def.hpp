...
/// @brief Field _boneRotations, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__boneRotations, put=__cordl_internal_set__boneRotations)) ::ArrayW<::GlobalNamespace::__OVRPlugin__Quatf,::Array<::GlobalNamespace::__OVRPlugin__Quatf>*>  _boneRotations;

/// @brief Field _boneTranslations, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__boneTranslations, put=__cordl_internal_set__boneTranslations)) ::ArrayW<::GlobalNamespace::__OVRPlugin__Vector3f,::Array<::GlobalNamespace::__OVRPlugin__Vector3f>*>  _boneTranslations;
...
/// @brief Method Awake, addr 0x3f115c0, size 0x7c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetBodyState, addr 0x3f11828, size 0x84, virtual false, abstract: false, final false
inline void GetBodyState(::GlobalNamespace::__OVRPlugin__Step  step) ;

static inline ::GlobalNamespace::OVRBody* New_ctor() ;

/// @brief Method OVRSkeletonRenderer.IOVRSkeletonRendererDataProvider.GetSkeletonRendererData, addr 0x3f11bd8, size 0x18, virtual true, abstract: false, final true
...
/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonPoseData, addr 0x3f119b0, size 0x228, virtual true, abstract: false, final true
inline ::GlobalNamespace::__OVRSkeleton__SkeletonPoseData OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonPoseData() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonType, addr 0x3f119a8, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::__OVRSkeleton__SkeletonType OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonType() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.get_enabled, addr 0x3f11bf8, size 0x8, virtual true, abstract: false, final true
inline bool OVRSkeleton_IOVRSkeletonDataProvider_get_enabled() ;

/// @brief Method OnDestroy, addr 0x3f11994, size 0xc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x3f1190c, size 0x88, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3f1163c, size 0x114, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPermissionGranted, addr 0x3f118ac, size 0x60, virtual false, abstract: false, final false
inline void OnPermissionGranted(::StringW  permissionId) ;

/// @brief Method StartBodyTracking, addr 0x3f11750, size 0xd8, virtual false, abstract: false, final false
inline bool StartBodyTracking() ;

/// @brief Method Update, addr 0x3f119a0, size 0x8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3f11bf0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline int32_t getStaticF__trackingInstanceCount() ;

/// @brief Method get_BodyState, addr 0x3f11538, size 0x88, virtual false, abstract: false, final false
