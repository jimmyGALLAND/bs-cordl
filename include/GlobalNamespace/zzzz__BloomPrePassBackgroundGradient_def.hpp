...
/// @brief Method UpdatePixels, addr 0x3953a50, size 0x74, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3953ac4, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;
