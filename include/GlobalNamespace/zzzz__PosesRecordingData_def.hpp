...
/// @brief Method .ctor, addr 0x3a90e1c, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a8e90c, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Camera*  camera) ;

/// @brief Method .ctor, addr 0x3a91030, size 0x50, virtual false, abstract: false, final false
...
/// @brief Field externalCameraCalibration, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_externalCameraCalibration, put=__cordl_internal_set_externalCameraCalibration)) ::GlobalNamespace::__PosesRecordingData__ExternalCameraCalibration*  externalCameraCalibration;

/// @brief Field keyframes, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_keyframes, put=__cordl_internal_set_keyframes)) ::System::Collections::Generic::List_1<::GlobalNamespace::__PosesRecordingData__TransformsKeyframe*>*  keyframes;
...
/// @brief Method AddKeyframe, addr 0x3a90e54, size 0xa4, virtual false, abstract: false, final false
inline void AddKeyframe(::GlobalNamespace::__PosesRecordingData__TransformsKeyframe*  keyframe) ;

/// @brief Method Contains, addr 0x3a8e888, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method ObjectIndex, addr 0x3a90fd8, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a90d88, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a90f9c, size 0x3c, virtual false, abstract: false, final false
