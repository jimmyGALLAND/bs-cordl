...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::GlobalNamespace::MenuScenesTransitionSetupDataSO> (::GlobalNamespace::DefaultScenesTransitionsFromInit::*)()>(&::GlobalNamespace::DefaultScenesTransitionsFromInit::get_mainMenuScenesTransitionSetupData)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x26c9af0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DefaultScenesTransitionsFromInit::*)(bool, bool, bool)>(&::GlobalNamespace::DefaultScenesTransitionsFromInit::TransitionToNextScene)> {
  constexpr static std::size_t size = 0x1c0;
  constexpr static std::size_t addrs = 0x26c9af8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DefaultScenesTransitionsFromInit::*)(::StringW, ::StringW)>(&::GlobalNamespace::DefaultScenesTransitionsFromInit::TransitionToStartupErrorScene)> {
  constexpr static std::size_t size = 0xa8;
  constexpr static std::size_t addrs = 0x26c9cb8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DefaultScenesTransitionsFromInit::*)()>(&::GlobalNamespace::DefaultScenesTransitionsFromInit::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x26c9d60;
...
constexpr ::UnityW<::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO> const& GlobalNamespace::DefaultScenesTransitionsFromInit::__cordl_internal_get__healthWarningScenesTransitionSetupData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____healthWarningScenesTransitionSetupData;
}
constexpr void GlobalNamespace::DefaultScenesTransitionsFromInit::__cordl_internal_set__healthWarningScenesTransitionSetupData(::UnityW<::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::UnityW<::GlobalNamespace::RecordingToolScenesTransitionSetupDataSO> const& GlobalNamespace::DefaultScenesTransitionsFromInit::__cordl_internal_get__recordingToolScenesTransitionSetupData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____recordingToolScenesTransitionSetupData;
}
constexpr void GlobalNamespace::DefaultScenesTransitionsFromInit::__cordl_internal_set__recordingToolScenesTransitionSetupData(::UnityW<::GlobalNamespace::RecordingToolScenesTransitionSetupDataSO>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::UnityW<::GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO> const& GlobalNamespace::DefaultScenesTransitionsFromInit::__cordl_internal_get__beatmapEditorScenesTransitionSetupData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____beatmapEditorScenesTransitionSetupData;
}
constexpr void GlobalNamespace::DefaultScenesTransitionsFromInit::__cordl_internal_set__beatmapEditorScenesTransitionSetupData(::UnityW<::GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____beatmapEditorScenesTransitionSetupData)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
constexpr ::UnityW<::GlobalNamespace::ShaderWarmupScenesTransitionSetupDataSO> const& GlobalNamespace::DefaultScenesTransitionsFromInit::__cordl_internal_get__shaderWarmupScenesTransitionSetupData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____shaderWarmupScenesTransitionSetupData;
}
constexpr void GlobalNamespace::DefaultScenesTransitionsFromInit::__cordl_internal_set__shaderWarmupScenesTransitionSetupData(::UnityW<::GlobalNamespace::ShaderWarmupScenesTransitionSetupDataSO>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::UnityW<::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO> const& GlobalNamespace::DefaultScenesTransitionsFromInit::__cordl_internal_get__startupErrorScenesTransitionSetupData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____startupErrorScenesTransitionSetupData;
}
constexpr void GlobalNamespace::DefaultScenesTransitionsFromInit::__cordl_internal_set__startupErrorScenesTransitionSetupData(::UnityW<::GlobalNamespace::StartupErrorScenesTransitionSetupDataSO>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
