...
/// @brief Method <CreateFromAddressables>b__13_0, addr 0x2662a68, size 0x4, virtual false, abstract: false, final false
inline void _CreateFromAddressables_b__13_0(::GlobalNamespace::EnvironmentInfoSO*  _) ;

/// @brief Method <.ctor>b__12_0, addr 0x2662a08, size 0x18, virtual false, abstract: false, final false
inline int32_t __ctor_b__12_0(::GlobalNamespace::EnvironmentInfoSO*  envInfo) ;

/// @brief Method <.ctor>b__12_1, addr 0x2662a20, size 0x18, virtual false, abstract: false, final false
inline ::StringW __ctor_b__12_1(::GlobalNamespace::EnvironmentInfoSO*  e) ;

/// @brief Method <.ctor>b__12_2, addr 0x2662a38, size 0x18, virtual false, abstract: false, final false
inline ::StringW __ctor_b__12_2(::GlobalNamespace::EnvironmentInfoSO*  e) ;

/// @brief Method <.ctor>b__12_3, addr 0x2662a50, size 0x18, virtual false, abstract: false, final false
inline ::StringW __ctor_b__12_3(::GlobalNamespace::EnvironmentInfoSO*  envInfo) ;

/// @brief Method .ctor, addr 0x2662a00, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _envInfoMap, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__envInfoMap, put=__cordl_internal_set__envInfoMap)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*  _envInfoMap;

/// @brief Field _envInfos, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__envInfos, put=__cordl_internal_set__envInfos)) ::ArrayW<::UnityW<::GlobalNamespace::EnvironmentInfoSO>,::Array<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*>  _envInfos;
...
/// @brief Field _environmentSerializedNames, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__environmentSerializedNames, put=__cordl_internal_set__environmentSerializedNames)) ::ArrayW<::StringW,::Array<::StringW>*>  _environmentSerializedNames;
...
/// @brief Method CreateFromAddressables, addr 0x26623a0, size 0x240, virtual false, abstract: false, final false
static inline ::GlobalNamespace::EnvironmentsListModel* CreateFromAddressables() ;

/// @brief Method GetAllEnvironmentInfosWithType, addr 0x26627bc, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method GetEnvironmentInfoBySerializedName, addr 0x26625e0, size 0x70, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> GetEnvironmentInfoBySerializedName(::StringW  environmentSerializedName) ;

/// @brief Method GetEnvironmentInfoBySerializedNameSafe, addr 0x2662650, size 0x16c, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> GetEnvironmentInfoBySerializedNameSafe(::StringW  environmentSerializedName) ;

/// @brief Method GetFirstEnvironmentInfoWithType, addr 0x26628ec, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method GetLastEnvironmentInfoWithType, addr 0x2662948, size 0x5c, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*> const& __cordl_internal_get__envInfoMap() const;
...
/// @brief Method .ctor, addr 0x2662058, size 0x348, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IEnumerable_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*  envInfoSOs) ;

/// @brief Method get_environmentInfos, addr 0x2662040, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>* get_environmentInfos() ;

/// @brief Method get_environmentNames, addr 0x2662048, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_environmentNames() ;

/// @brief Method get_environmentSerializedNames, addr 0x2662050, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_environmentSerializedNames() ;

/// @brief Method get_loggerPrefix, addr 0x2662000, size 0x40, virtual true, abstract: false, final true
