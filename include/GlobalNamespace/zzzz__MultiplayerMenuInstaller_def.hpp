...
public:
// Declarations
/// @brief Method InstallBindings, addr 0x3b6045c, size 0x8c, virtual true, abstract: false, final false
inline void InstallBindings() ;

static inline ::GlobalNamespace::MultiplayerMenuInstaller* New_ctor() ;

/// @brief Method .ctor, addr 0x3b604e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
