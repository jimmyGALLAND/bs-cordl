...
class __NetworkPacketSerializer_2____c__6_1;
}
namespace GlobalNamespace {
template<typename TType,typename TData>
class __NetworkPacketSerializer_2____c__DisplayClass10_0;
}
namespace GlobalNamespace {
template<typename TType,typename TData,typename TPacket>
class __NetworkPacketSerializer_2____c__DisplayClass4_0_1;
}
namespace GlobalNamespace {
template<typename TType,typename TData,typename TPacket>
class __NetworkPacketSerializer_2____c__DisplayClass5_0_1;
}
namespace GlobalNamespace {
template<typename TType,typename TData,typename TPacket>
class __NetworkPacketSerializer_2____c__DisplayClass7_0_1;
}
namespace GlobalNamespace {
template<typename TType,typename TData,typename TPacket>
class __NetworkPacketSerializer_2____c__DisplayClass8_0_1;
}
...
using __c__6_1 = ::GlobalNamespace::__NetworkPacketSerializer_2____c__6_1<TType, TData, TPacket>;

using __c__DisplayClass10_0 = ::GlobalNamespace::__NetworkPacketSerializer_2____c__DisplayClass10_0<TType, TData>;

template<typename TPacket>
using __c__DisplayClass4_0_1 = ::GlobalNamespace::__NetworkPacketSerializer_2____c__DisplayClass4_0_1<TType, TData, TPacket>;

template<typename TPacket>
using __c__DisplayClass5_0_1 = ::GlobalNamespace::__NetworkPacketSerializer_2____c__DisplayClass5_0_1<TType, TData, TPacket>;

template<typename TPacket>
using __c__DisplayClass7_0_1 = ::GlobalNamespace::__NetworkPacketSerializer_2____c__DisplayClass7_0_1<TType, TData, TPacket>;

template<typename TPacket>
using __c__DisplayClass8_0_1 = ::GlobalNamespace::__NetworkPacketSerializer_2____c__DisplayClass8_0_1<TType, TData, TPacket>;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint8_t,::System::Action_3<::LiteNetLib::Utils::NetDataReader*,int32_t,TData>*>*> const& __cordl_internal_get__messsageHandlers() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::INetworkPacketSubSerializer_1<TData>*,uint8_t>*> const& __cordl_internal_get__subSerializerRegistry() const;
