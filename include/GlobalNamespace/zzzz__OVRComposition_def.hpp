...
/// @brief Method ComputeCameraTrackingSpacePose, addr 0x3f06ac0, size 0x288, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPose ComputeCameraTrackingSpacePose(::GlobalNamespace::__OVRPlugin__CameraExtrinsics  extrinsics) ;

/// @brief Method ComputeCameraWorldSpacePose, addr 0x3f06a58, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method RecenterPose, addr 0x3f06a54, size 0x4, virtual true, abstract: false, final false
inline void RecenterPose() ;

/// @brief Method RefreshCameraRig, addr 0x3f0689c, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f06868, size 0x34, virtual false, abstract: false, final false
