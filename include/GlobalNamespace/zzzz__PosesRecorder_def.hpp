...
/// @brief Method <Init>b__6_0, addr 0x3a90f64, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> _Init_b__6_0(::GlobalNamespace::PoseObject*  ro) ;

/// @brief Method <Init>b__6_1, addr 0x3a90f7c, size 0x20, virtual false, abstract: false, final false
inline ::StringW _Init_b__6_1(::GlobalNamespace::PoseObject*  ro) ;

/// @brief Method .ctor, addr 0x3a90f5c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x3a8e654, size 0x234, virtual false, abstract: false, final false
...
/// @brief Method LateUpdate, addr 0x3a90ba8, size 0x1c, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::PosesRecorder* New_ctor() ;

/// @brief Method RecordTick, addr 0x3a90bc4, size 0x1c4, virtual false, abstract: false, final false
inline void RecordTick(float_t  time) ;

/// @brief Method StartRecording, addr 0x3a8effc, size 0xc, virtual false, abstract: false, final false
inline void StartRecording() ;

/// @brief Method StopRecording, addr 0x3a8ef74, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a90ef8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_data, addr 0x3a90ba0, size 0x8, virtual false, abstract: false, final false
