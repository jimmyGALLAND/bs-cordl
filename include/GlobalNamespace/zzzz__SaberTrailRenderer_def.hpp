...
/// @brief Method Init, addr 0x3ff629c, size 0x170, virtual true, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3ff6564, size 0xc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x3ff66cc, size 0x84, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3ff6648, size 0x84, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnValidate, addr 0x3ff6570, size 0xd8, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method SetTrailWidth, addr 0x3ff6750, size 0x8, virtual false, abstract: false, final false
inline void SetTrailWidth(float_t  width) ;

/// @brief Method UpdateIndices, addr 0x3ff640c, size 0x158, virtual false, abstract: false, final false
inline void UpdateIndices() ;

/// @brief Method UpdateMesh, addr 0x3ff5d88, size 0x134, virtual false, abstract: false, final false
inline void UpdateMesh(::GlobalNamespace::TrailElementCollection*  trailElementCollection, ::UnityEngine::Color  color) ;

/// @brief Method UpdateVertices, addr 0x3ff6758, size 0x444, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ff6e30, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
