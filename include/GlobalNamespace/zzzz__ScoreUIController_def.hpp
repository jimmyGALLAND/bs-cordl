...
/// @brief Method .ctor, addr 0x3b14598, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method Append000Number, addr 0x3b144d0, size 0x60, virtual false, abstract: false, final false
static inline void Append000Number(::System::Text::StringBuilder*  stringBuilder, int32_t  number) ;

/// @brief Method HandleScoreDidChangeRealtime, addr 0x3b14358, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x3b14254, size 0x4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3b14250, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RegisterForEvents, addr 0x3b1409c, size 0x190, virtual false, abstract: false, final false
inline void RegisterForEvents() ;

/// @brief Method Start, addr 0x3b1402c, size 0x70, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UnregisterFromEvents, addr 0x3b14258, size 0x100, virtual false, abstract: false, final false
inline void UnregisterFromEvents() ;

/// @brief Method UpdateScore, addr 0x3b1435c, size 0x174, virtual false, abstract: false, final false
inline void UpdateScore(int32_t  displayScore) ;

/// @brief Method UpdateScore, addr 0x3b1422c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b14530, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
