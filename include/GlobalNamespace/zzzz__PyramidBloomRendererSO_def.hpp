...
// Ctor Parameters [CppParam { name: "down", ty: "::UnityW<::UnityEngine::RenderTexture>", modifiers: "", def_value: None }, CppParam { name: "up", ty: "::UnityW<::UnityEngine::RenderTexture>", modifiers: "", def_value: None }]
...
/// @brief Field _pyramid, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__pyramid, put=__cordl_internal_set__pyramid)) ::ArrayW<::GlobalNamespace::__PyramidBloomRendererSO__Level,::Array<::GlobalNamespace::__PyramidBloomRendererSO__Level>*>  _pyramid;
...
/// @brief Method OnDisable, addr 0x3950a4c, size 0x24, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3950944, size 0x108, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RenderBloom, addr 0x3950a70, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method RenderBloom, addr 0x3950b00, size 0x834, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3951334, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
