...
/// @brief Method AddLogger, addr 0x3a8c448, size 0xa4, virtual false, abstract: false, final false
inline void AddLogger(::GlobalNamespace::IBeatSaberLogger*  logger) ;

/// @brief Method Log, addr 0x3a8c4ec, size 0x1b0, virtual true, abstract: false, final true
inline void Log(::StringW  message) ;

/// @brief Method Log, addr 0x3a8c69c, size 0x1c4, virtual true, abstract: false, final true
inline void Log(::StringW  message, ::System::Object*  context) ;

/// @brief Method LogError, addr 0x3a8cbd8, size 0x1b4, virtual true, abstract: false, final true
inline void LogError(::StringW  message) ;

/// @brief Method LogError, addr 0x3a8cd8c, size 0x1c4, virtual true, abstract: false, final true
inline void LogError(::StringW  message, ::System::Object*  context) ;

/// @brief Method LogException, addr 0x3a8cf50, size 0x1b4, virtual true, abstract: false, final true
inline void LogException(::System::Exception*  exception) ;

/// @brief Method LogException, addr 0x3a8d104, size 0x1c4, virtual true, abstract: false, final true
inline void LogException(::System::Exception*  exception, ::System::Object*  context) ;

/// @brief Method LogWarning, addr 0x3a8c860, size 0x1b4, virtual true, abstract: false, final true
inline void LogWarning(::StringW  message) ;

/// @brief Method LogWarning, addr 0x3a8ca14, size 0x1c4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a8c420, size 0x28, virtual false, abstract: false, final false
