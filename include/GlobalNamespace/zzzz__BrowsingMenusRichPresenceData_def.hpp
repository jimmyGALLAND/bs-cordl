...
/// @brief Method .ctor, addr 0x3aa00a4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_apiName, addr 0x3aa000c, size 0x40, virtual true, abstract: false, final true
inline ::StringW get_apiName() ;

/// @brief Method get_localizedDescription, addr 0x3aa004c, size 0x58, virtual true, abstract: false, final true
