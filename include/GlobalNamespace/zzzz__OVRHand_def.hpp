...
/// @brief Field <HandConfidence>k__BackingField, offset 0xcc, size 0x4 
 __declspec(property(get=__cordl_internal_get__HandConfidence_k__BackingField, put=__cordl_internal_set__HandConfidence_k__BackingField)) ::GlobalNamespace::__OVRHand__TrackingConfidence  _HandConfidence_k__BackingField;
...
/// @brief Method Awake, addr 0x3fa4948, size 0xcc, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method FixedUpdate, addr 0x3fa4c84, size 0x74, virtual false, abstract: false, final false
inline void FixedUpdate() ;

/// @brief Method GetFingerConfidence, addr 0x3fa4d58, size 0x44, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRHand__TrackingConfidence GetFingerConfidence(::GlobalNamespace::__OVRHand__HandFinger  finger) ;

/// @brief Method GetFingerIsPinching, addr 0x3fa4cf8, size 0x20, virtual false, abstract: false, final false
inline bool GetFingerIsPinching(::GlobalNamespace::__OVRHand__HandFinger  finger) ;

/// @brief Method GetFingerPinchStrength, addr 0x3fa4d18, size 0x40, virtual false, abstract: false, final false
inline float_t GetFingerPinchStrength(::GlobalNamespace::__OVRHand__HandFinger  finger) ;

/// @brief Method GetHandState, addr 0x3fa4a14, size 0x268, virtual false, abstract: false, final false
inline void GetHandState(::GlobalNamespace::__OVRPlugin__Step  step) ;

static inline ::GlobalNamespace::OVRHand* New_ctor() ;

/// @brief Method OVRMeshRenderer.IOVRMeshRendererDataProvider.GetMeshRendererData, addr 0x3fa4ee0, size 0x48, virtual true, abstract: false, final true
...
/// @brief Method OVRMesh.IOVRMeshDataProvider.GetMeshType, addr 0x3fa4ec8, size 0x18, virtual true, abstract: false, final true
inline ::GlobalNamespace::__OVRMesh__MeshType OVRMesh_IOVRMeshDataProvider_GetMeshType() ;

/// @brief Method OVRSkeletonRenderer.IOVRSkeletonRendererDataProvider.GetSkeletonRendererData, addr 0x3fa4e74, size 0x54, virtual true, abstract: false, final true
...
/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonPoseData, addr 0x3fa4db4, size 0xc0, virtual true, abstract: false, final true
inline ::GlobalNamespace::__OVRSkeleton__SkeletonPoseData OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonPoseData() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonType, addr 0x3fa4d9c, size 0x18, virtual true, abstract: false, final true
inline ::GlobalNamespace::__OVRSkeleton__SkeletonType OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonType() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.get_enabled, addr 0x3fa4f40, size 0x8, virtual true, abstract: false, final true
inline bool OVRSkeleton_IOVRSkeletonDataProvider_get_enabled() ;

/// @brief Method SetHandType, addr 0x3fa4898, size 0x8, virtual false, abstract: false, final false
inline void SetHandType(::GlobalNamespace::__OVRHand__Hand  type) ;

/// @brief Method Update, addr 0x3fa4c7c, size 0x8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3fa4f28, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HandConfidence, addr 0x3fa4924, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRHand__TrackingConfidence get_HandConfidence() ;

/// @brief Method get_HandScale, addr 0x3fa4914, size 0x8, virtual false, abstract: false, final false
inline float_t get_HandScale() ;

/// @brief Method get_IsDataHighConfidence, addr 0x3fa48b4, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDataHighConfidence() ;

/// @brief Method get_IsDataValid, addr 0x3fa48a0, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDataValid() ;

/// @brief Method get_IsDominantHand, addr 0x3fa4934, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDominantHand() ;

/// @brief Method get_IsPointerPoseValid, addr 0x3fa48f0, size 0x8, virtual false, abstract: false, final false
inline bool get_IsPointerPoseValid() ;

/// @brief Method get_IsSystemGestureInProgress, addr 0x3fa48dc, size 0x8, virtual false, abstract: false, final false
inline bool get_IsSystemGestureInProgress() ;

/// @brief Method get_IsTracked, addr 0x3fa48c8, size 0x8, virtual false, abstract: false, final false
inline bool get_IsTracked() ;

/// @brief Method get_PointerPose, addr 0x3fa4904, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_HandConfidence, addr 0x3fa492c, size 0x8, virtual false, abstract: false, final false
inline void set_HandConfidence(::GlobalNamespace::__OVRHand__TrackingConfidence  value) ;

/// @brief Method set_HandScale, addr 0x3fa491c, size 0x8, virtual false, abstract: false, final false
inline void set_HandScale(float_t  value) ;

/// @brief Method set_IsDataHighConfidence, addr 0x3fa48bc, size 0xc, virtual false, abstract: false, final false
inline void set_IsDataHighConfidence(bool  value) ;

/// @brief Method set_IsDataValid, addr 0x3fa48a8, size 0xc, virtual false, abstract: false, final false
inline void set_IsDataValid(bool  value) ;

/// @brief Method set_IsDominantHand, addr 0x3fa493c, size 0xc, virtual false, abstract: false, final false
inline void set_IsDominantHand(bool  value) ;

/// @brief Method set_IsPointerPoseValid, addr 0x3fa48f8, size 0xc, virtual false, abstract: false, final false
inline void set_IsPointerPoseValid(bool  value) ;

/// @brief Method set_IsSystemGestureInProgress, addr 0x3fa48e4, size 0xc, virtual false, abstract: false, final false
inline void set_IsSystemGestureInProgress(bool  value) ;

/// @brief Method set_IsTracked, addr 0x3fa48d0, size 0xc, virtual false, abstract: false, final false
inline void set_IsTracked(bool  value) ;

/// @brief Method set_PointerPose, addr 0x3fa490c, size 0x8, virtual false, abstract: false, final false
