...
/// @brief Field _languageSettingsController, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__languageSettingsController, put=__cordl_internal_set__languageSettingsController)) ::UnityW<::GlobalNamespace::LanguageSettingsController>  _languageSettingsController;
...
/// @brief Method DidActivate, addr 0x3adee64, size 0xf8, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HandleLanguageSettingsControllerOndropDownValueDidChange, addr 0x3adf038, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3adef5c, size 0xdc, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method <DidActivate>b__8_0, addr 0x3adf05c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3adf054, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didChangeLanguageEvent, addr 0x3adebf4, size 0x9c, virtual false, abstract: false, final false
inline void add_didChangeLanguageEvent(::System::Action*  value) ;

/// @brief Method add_didPressContinueButtonEvent, addr 0x3aded2c, size 0x9c, virtual false, abstract: false, final false
inline void add_didPressContinueButtonEvent(::System::Action*  value) ;

/// @brief Method remove_didChangeLanguageEvent, addr 0x3adec90, size 0x9c, virtual false, abstract: false, final false
inline void remove_didChangeLanguageEvent(::System::Action*  value) ;

/// @brief Method remove_didPressContinueButtonEvent, addr 0x3adedc8, size 0x9c, virtual false, abstract: false, final false
