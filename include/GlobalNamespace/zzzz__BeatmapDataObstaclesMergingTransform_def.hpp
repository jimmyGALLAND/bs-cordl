...
/// @brief Field prevObstacleDataInLines, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_prevObstacleDataInLines, put=__cordl_internal_set_prevObstacleDataInLines)) ::ArrayW<::GlobalNamespace::ObstacleData*,::Array<::GlobalNamespace::ObstacleData*>*>  prevObstacleDataInLines;

static inline ::GlobalNamespace::__BeatmapDataObstaclesMergingTransform____c__DisplayClass0_0* New_ctor() ;

/// @brief Method <CreateTransformedData>g__ProcessData|0, addr 0x265f4c4, size 0x238, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x265f43c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CanBeMerged, addr 0x265f444, size 0x80, virtual false, abstract: false, final false
static inline bool CanBeMerged(::GlobalNamespace::ObstacleData*  firstObstacle, ::GlobalNamespace::ObstacleData*  secondObstacle) ;

/// @brief Method CreateTransformedData, addr 0x265f2a0, size 0x19c, virtual false, abstract: false, final false
