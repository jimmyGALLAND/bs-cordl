...
/// @brief Method Clear, addr 0x3a9fbb8, size 0x50, virtual true, abstract: false, final true
inline void Clear() ;

static inline ::GlobalNamespace::NoRichPresencePlatformHandler* New_ctor() ;

/// @brief Method SetPresence, addr 0x3a9fb10, size 0xa8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a9fc08, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_currentPresenceApiName, addr 0x3a9fb00, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_currentPresenceApiName, addr 0x3a9fb08, size 0x8, virtual false, abstract: false, final false
