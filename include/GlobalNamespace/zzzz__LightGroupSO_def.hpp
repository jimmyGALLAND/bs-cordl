...
/// @brief Method .ctor, addr 0x395d8a4, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_groupId, addr 0x395d87c, size 0x8, virtual true, abstract: false, final true
inline int32_t get_groupId() ;

/// @brief Method get_groupName, addr 0x395d874, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_groupName() ;

/// @brief Method get_ignoreLightGroupEffectManager, addr 0x395d89c, size 0x8, virtual false, abstract: false, final false
inline bool get_ignoreLightGroupEffectManager() ;

/// @brief Method get_numberOfElements, addr 0x395d88c, size 0x8, virtual true, abstract: false, final true
inline int32_t get_numberOfElements() ;

/// @brief Method get_sameIdElements, addr 0x395d894, size 0x8, virtual false, abstract: false, final false
inline int32_t get_sameIdElements() ;

/// @brief Method get_startLightId, addr 0x395d884, size 0x8, virtual false, abstract: false, final false
