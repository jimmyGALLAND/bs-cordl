...
/// @brief Method MoveNext, addr 0x2230b64, size 0x354, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x2230eb8, size 0x7c, virtual true, abstract: false, final true
...
/// @brief Field _operationState, offset 0x20, size 0x4 
 __declspec(property(get=__cordl_internal_get__operationState, put=__cordl_internal_set__operationState)) ::GlobalNamespace::__OculusXPlatformAccessTokenRequestOperation__OculusTokenRequestOperationState  _operationState;
...
/// @brief Method OnCompleteLoadingOculusAccessToken, addr 0x22309d8, size 0x18c, virtual false, abstract: false, final false
inline void OnCompleteLoadingOculusAccessToken(::Oculus::Platform::Message_1<::StringW>*  message) ;

/// @brief Method RequestAccessToken, addr 0x22308d4, size 0x104, virtual false, abstract: false, final false
inline void RequestAccessToken() ;

/// @brief Method RequestXPlatformAccessToken, addr 0x22307dc, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method Run, addr 0x2230690, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x223076c, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
