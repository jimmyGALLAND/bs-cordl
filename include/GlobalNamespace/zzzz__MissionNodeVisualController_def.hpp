...
/// @brief Field nodeWasDisplayedEvent, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_nodeWasDisplayedEvent, put=__cordl_internal_set_nodeWasDisplayedEvent)) ::System::Action_1<::UnityW<::GlobalNamespace::MissionNodeVisualController>>*  nodeWasDisplayedEvent;

/// @brief Field nodeWasSelectEvent, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_nodeWasSelectEvent, put=__cordl_internal_set_nodeWasSelectEvent)) ::System::Action_1<::UnityW<::GlobalNamespace::MissionNodeVisualController>>*  nodeWasSelectEvent;

 __declspec(property(get=get_selected)) bool  selected;

/// @brief Method Awake, addr 0x3b76338, size 0xa0, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ChangeNodeSelection, addr 0x3b766bc, size 0x34, virtual false, abstract: false, final false
inline void ChangeNodeSelection(bool  selected) ;

/// @brief Method HandleMissionToggleSelectionDidChange, addr 0x3b76754, size 0x40, virtual false, abstract: false, final false
inline void HandleMissionToggleSelectionDidChange(::GlobalNamespace::MissionToggle*  toggle) ;

/// @brief Method Init, addr 0x3b76498, size 0x5c, virtual false, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::MissionNodeVisualController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b764f4, size 0xc8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnEnable, addr 0x3b76318, size 0x20, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Reset, addr 0x3b762a0, size 0x8, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetInteractable, addr 0x3b74710, size 0xc, virtual false, abstract: false, final false
inline void SetInteractable() ;

/// @brief Method SetMissionCleared, addr 0x3b73f28, size 0xc, virtual false, abstract: false, final false
inline void SetMissionCleared() ;

/// @brief Method SetSelected, addr 0x3b74f98, size 0x2c, virtual false, abstract: false, final false
inline void SetSelected(bool  value) ;

/// @brief Method Setup, addr 0x3b762b4, size 0x1c, virtual false, abstract: false, final false
inline void Setup(bool  cleared, bool  interactable) ;

/// @brief Method SetupToggle, addr 0x3b76690, size 0x2c, virtual false, abstract: false, final false
inline void SetupToggle() ;

/// @brief Method Start, addr 0x3b76494, size 0x4, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b76794, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_nodeWasDisplayedEvent, addr 0x3b751a4, size 0xb0, virtual false, abstract: false, final false
inline void add_nodeWasDisplayedEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionNodeVisualController>>*  value) ;

/// @brief Method add_nodeWasSelectEvent, addr 0x3b750f4, size 0xb0, virtual false, abstract: false, final false
inline void add_nodeWasSelectEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionNodeVisualController>>*  value) ;

/// @brief Method get_cleared, addr 0x3b762f8, size 0x8, virtual false, abstract: false, final false
inline bool get_cleared() ;

/// @brief Method get_interactable, addr 0x3b76300, size 0x8, virtual false, abstract: false, final false
inline bool get_interactable() ;

/// @brief Method get_isInitialized, addr 0x3b762f0, size 0x8, virtual false, abstract: false, final false
inline bool get_isInitialized() ;

/// @brief Method get_missionNode, addr 0x3b762e0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionNode> get_missionNode() ;

/// @brief Method get_selected, addr 0x3b762e8, size 0x8, virtual false, abstract: false, final false
inline bool get_selected() ;

/// @brief Method remove_nodeWasDisplayedEvent, addr 0x3b7546c, size 0xb0, virtual false, abstract: false, final false
inline void remove_nodeWasDisplayedEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionNodeVisualController>>*  value) ;

/// @brief Method remove_nodeWasSelectEvent, addr 0x3b753bc, size 0xb0, virtual false, abstract: false, final false
