...
public:
// Declarations
/// @brief Method GetLocalLeaderboardID, addr 0x26b36e4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26b36ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
