...
/// @brief Field <environmentInfo>k__BackingField, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get__environmentInfo_k__BackingField, put=__cordl_internal_set__environmentInfo_k__BackingField)) ::UnityW<::GlobalNamespace::EnvironmentInfoSO>  _environmentInfo_k__BackingField;
...
/// @brief Field <usingOverrideEnvironment>k__BackingField, offset 0x90, size 0x1 
 __declspec(property(get=__cordl_internal_get__usingOverrideEnvironment_k__BackingField, put=__cordl_internal_set__usingOverrideEnvironment_k__BackingField)) bool  _usingOverrideEnvironment_k__BackingField;
...
/// @brief Field didFinishEvent, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_didFinishEvent, put=__cordl_internal_set_didFinishEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>*  didFinishEvent;
...
/// @brief Method Finish, addr 0x3ab24ac, size 0x28, virtual false, abstract: false, final false
inline void Finish(::GlobalNamespace::LevelCompletionResults*  levelCompletionResults) ;

/// @brief Method Init, addr 0x3aaf3b4, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x3aaf6cc, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method InitAndSetupScenes, addr 0x3ab21ec, size 0x2c0, virtual false, abstract: false, final false
...
/// @brief Method InitColorInfo, addr 0x3ab2158, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method InitEnvironmentInfo, addr 0x3ab2000, size 0x158, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO>,::GlobalNamespace::LevelCompletionResults*>*> const& __cordl_internal_get_didFinishEvent() const;
...
/// @brief Method .ctor, addr 0x3ab24d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x3aae598, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_beatmapKey, addr 0x3ab1f60, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapKey get_beatmapKey() ;

/// @brief Method get_beatmapLevel, addr 0x3ab1f88, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevel* get_beatmapLevel() ;

/// @brief Method get_colorScheme, addr 0x3ab1fbc, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorScheme* get_colorScheme() ;

/// @brief Method get_environmentInfo, addr 0x3ab1fe0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> get_environmentInfo() ;

/// @brief Method get_gameMode, addr 0x3ab1f50, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_gameMode() ;

/// @brief Method get_gameplayModifiers, addr 0x3ab1ff0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers() ;

/// @brief Method get_practiceSettings, addr 0x3ab1f98, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::PracticeSettings* get_practiceSettings() ;

/// @brief Method get_usingOverrideColorScheme, addr 0x3ab1fa8, size 0x8, virtual false, abstract: false, final false
inline bool get_usingOverrideColorScheme() ;

/// @brief Method get_usingOverrideEnvironment, addr 0x3ab1fcc, size 0x8, virtual false, abstract: false, final false
inline bool get_usingOverrideEnvironment() ;

/// @brief Method remove_didFinishEvent, addr 0x3aaea78, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method set_beatmapKey, addr 0x3ab1f74, size 0x14, virtual false, abstract: false, final false
inline void set_beatmapKey(::GlobalNamespace::BeatmapKey  value) ;

/// @brief Method set_beatmapLevel, addr 0x3ab1f90, size 0x8, virtual false, abstract: false, final false
inline void set_beatmapLevel(::GlobalNamespace::BeatmapLevel*  value) ;

/// @brief Method set_colorScheme, addr 0x3ab1fc4, size 0x8, virtual false, abstract: false, final false
inline void set_colorScheme(::GlobalNamespace::ColorScheme*  value) ;

/// @brief Method set_environmentInfo, addr 0x3ab1fe8, size 0x8, virtual false, abstract: false, final false
inline void set_environmentInfo(::GlobalNamespace::EnvironmentInfoSO*  value) ;

/// @brief Method set_gameMode, addr 0x3ab1f58, size 0x8, virtual false, abstract: false, final false
inline void set_gameMode(::StringW  value) ;

/// @brief Method set_gameplayModifiers, addr 0x3ab1ff8, size 0x8, virtual false, abstract: false, final false
inline void set_gameplayModifiers(::GlobalNamespace::GameplayModifiers*  value) ;

/// @brief Method set_practiceSettings, addr 0x3ab1fa0, size 0x8, virtual false, abstract: false, final false
inline void set_practiceSettings(::GlobalNamespace::PracticeSettings*  value) ;

/// @brief Method set_usingOverrideColorScheme, addr 0x3ab1fb0, size 0xc, virtual false, abstract: false, final false
inline void set_usingOverrideColorScheme(bool  value) ;

/// @brief Method set_usingOverrideEnvironment, addr 0x3ab1fd4, size 0xc, virtual false, abstract: false, final false
