...
/// @brief Field didAddItemEvent, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_didAddItemEvent, put=__cordl_internal_set_didAddItemEvent)) ::System::Action_2<::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<T>*,T>*  didAddItemEvent;

/// @brief Field didFinishTimeSliceEvent, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_didFinishTimeSliceEvent, put=__cordl_internal_set_didFinishTimeSliceEvent)) ::System::Action_2<::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<T>*,float_t>*  didFinishTimeSliceEvent;

/// @brief Field didStartNewTimeSliceEvent, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_didStartNewTimeSliceEvent, put=__cordl_internal_set_didStartNewTimeSliceEvent)) ::System::Action_1<::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<T>*>*  didStartNewTimeSliceEvent;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<T>*,T>*> const& __cordl_internal_get_didAddItemEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<T>*,float_t>*> const& __cordl_internal_get_didFinishTimeSliceEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<T>*>*> const& __cordl_internal_get_didStartNewTimeSliceEvent() const;
...
/// @brief Method GetCopy, addr 0x2207fdc, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2205bb8, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method <HandleCurrentTimeSliceColorNotesDidFinishTimeSlice>b__17_0, addr 0x2208044, size 0xb8, virtual false, abstract: false, final false
inline bool _HandleCurrentTimeSliceColorNotesDidFinishTimeSlice_b__17_0(::GlobalNamespace::BeatmapDataItem*  item) ;

/// @brief Method .ctor, addr 0x220803c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <HandleCurrentTimeSliceColorNotesDidFinishTimeSlice>b__1, addr 0x22080fc, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2207c2c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _currentTimeSliceAllNotesAndSliders, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__currentTimeSliceAllNotesAndSliders, put=__cordl_internal_set__currentTimeSliceAllNotesAndSliders)) ::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<::GlobalNamespace::BeatmapDataItem*>*  _currentTimeSliceAllNotesAndSliders;

/// @brief Field _currentTimeSliceColorNotes, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__currentTimeSliceColorNotes, put=__cordl_internal_set__currentTimeSliceColorNotes)) ::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<::GlobalNamespace::NoteData*>*  _currentTimeSliceColorNotes;
...
/// @brief Method HandleCurrentNewTimeSliceAllNotesAndSlidersDidStartNewTimeSlice, addr 0x2205a04, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method HandleCurrentTimeSliceAllNotesAndSlidersDidFinishTimeSlice, addr 0x2205c08, size 0x18b0, virtual false, abstract: false, final false
...
/// @brief Method HandleCurrentTimeSliceColorNotesDidAddItem, addr 0x22059a4, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method HandleCurrentTimeSliceColorNotesDidFinishTimeSlice, addr 0x220758c, size 0x6a0, virtual false, abstract: false, final false
...
/// @brief Method HandlePerColorTypeTimeSliceContainerDidFinishTimeSlice, addr 0x2207c34, size 0x35c, virtual false, abstract: false, final false
...
/// @brief Method ProcessAllRemainingData, addr 0x22057a8, size 0x1fc, virtual false, abstract: false, final false
inline void ProcessAllRemainingData() ;

/// @brief Method ProcessNote, addr 0x2205564, size 0xd4, virtual false, abstract: false, final false
inline void ProcessNote(::GlobalNamespace::NoteData*  noteData) ;

/// @brief Method ProcessSlider, addr 0x2205638, size 0x170, virtual false, abstract: false, final false
inline void ProcessSlider(::GlobalNamespace::SliderData*  sliderData) ;

/// @brief Method SliderHeadPositionOverlapsWithBurstTail, addr 0x22074f8, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method SliderHeadPositionOverlapsWithNote, addr 0x22074b8, size 0x40, virtual false, abstract: false, final false
static inline bool SliderHeadPositionOverlapsWithNote(::GlobalNamespace::SliderData*  slider, ::GlobalNamespace::NoteData*  note) ;

/// @brief Method SliderTailPositionOverlapsWithNote, addr 0x220754c, size 0x40, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<::GlobalNamespace::BeatmapDataItem*>*> const& __cordl_internal_get__currentTimeSliceAllNotesAndSliders() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<::GlobalNamespace::NoteData*>*> const& __cordl_internal_get__currentTimeSliceColorNotes() const;

constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ColorType,::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<::GlobalNamespace::NoteData*>*>*& __cordl_internal_get__currentTimeSliceNotesByColorType() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ColorType,::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<::GlobalNamespace::NoteData*>*>*> const& __cordl_internal_get__currentTimeSliceNotesByColorType() const;
...
constexpr void __cordl_internal_set__currentTimeSliceNotesByColorType(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ColorType,::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<::GlobalNamespace::NoteData*>*>*  value) ;
...
/// @brief Method .ctor, addr 0x2204fc8, size 0x59c, virtual false, abstract: false, final false
...
/// @brief Field _currentTimeSliceNotesByColorType, offset: 0x20, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ColorType,::GlobalNamespace::__BeatmapObjectsInTimeRowProcessor__TimeSliceContainer_1<::GlobalNamespace::NoteData*>*>*  ____currentTimeSliceNotesByColorType;
