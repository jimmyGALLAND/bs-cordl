...
/// @brief Method Awake, addr 0x3960dbc, size 0x80, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ColorWasSet, addr 0x3960e3c, size 0x188, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3960fc4, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::MaterialPropertyBlock* getStaticF__materialPropertyBlock() ;

/// @brief Method get_color, addr 0x3960db0, size 0xc, virtual false, abstract: false, final false
