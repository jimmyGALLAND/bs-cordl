...
/// @brief Method Awake, addr 0x3942d14, size 0xc8, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::Rotate* New_ctor() ;

/// @brief Method OnBecameInvisible, addr 0x3942e64, size 0xc, virtual false, abstract: false, final false
inline void OnBecameInvisible() ;

/// @brief Method OnBecameVisible, addr 0x3942ddc, size 0x20, virtual false, abstract: false, final false
inline void OnBecameVisible() ;

/// @brief Method Randomize, addr 0x3942dfc, size 0x68, virtual false, abstract: false, final false
inline void Randomize() ;

/// @brief Method Update, addr 0x3942e70, size 0xc4, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3942f34, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
