...
public:
// Declarations
/// @brief Method FindChildRecursively, addr 0x2269588, size 0xf8, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Transform> FindChildRecursively(::UnityEngine::Transform*  parent, ::StringW  name) ;

/// @brief Method InverseTransformRotation, addr 0x22694d4, size 0xb4, virtual false, abstract: false, final false
