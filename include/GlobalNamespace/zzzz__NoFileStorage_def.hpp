...
/// @brief Method DeleteFileAsync, addr 0x225a590, size 0x88, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task* DeleteFileAsync(::StringW  fileName, ::GlobalNamespace::StoragePreference  storageLocation) ;

/// @brief Method FileExistsAsync, addr 0x225a618, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method LoadFileAsync, addr 0x225a528, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method SaveFileAsync, addr 0x225a4a0, size 0x88, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x225a680, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
