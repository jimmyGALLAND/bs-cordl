...
/// @brief Method Dispose, addr 0x3f19778, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method MoveNext, addr 0x3f196bc, size 0x1c, virtual true, abstract: false, final true
inline bool MoveNext() ;

/// @brief Method Reset, addr 0x3f1976c, size 0xc, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3f1970c, size 0x60, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method .ctor, addr 0x3f19590, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<float_t,::Array<float_t>*>  array) ;

/// @brief Method get_Current, addr 0x3f196d8, size 0x34, virtual true, abstract: false, final true
...
/// @brief Method Awake, addr 0x3f18d58, size 0x7c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CheckValidity, addr 0x3f191b0, size 0x5c, virtual false, abstract: false, final false
inline void CheckValidity() ;

/// @brief Method CopyTo, addr 0x3f192c8, size 0x244, virtual false, abstract: false, final false
inline void CopyTo(::ArrayW<float_t,::Array<float_t>*>  array, int32_t  startIndex) ;

/// @brief Method GetEnumerator, addr 0x3f19570, size 0x20, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRFaceExpressions__FaceExpressionsEnumerator GetEnumerator() ;

/// @brief Method GetWeight, addr 0x3f1920c, size 0x4, virtual true, abstract: false, final true
inline float_t GetWeight(::GlobalNamespace::__OVRFaceExpressions__FaceExpression  expression) ;

static inline ::GlobalNamespace::OVRFaceExpressions* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3f1900c, size 0xc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x3f18f84, size 0x88, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3f18dd4, size 0x78, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPermissionGranted, addr 0x3f18f24, size 0x60, virtual false, abstract: false, final false
inline void OnPermissionGranted(::StringW  permissionId) ;

/// @brief Method StartFaceTracking, addr 0x3f18e4c, size 0xd8, virtual false, abstract: false, final false
inline bool StartFaceTracking() ;

/// @brief Method System.Collections.Generic.IEnumerable<System.Single>.GetEnumerator, addr 0x3f195b4, size 0x74, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3f19628, size 0x74, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method ToArray, addr 0x3f1950c, size 0x64, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> ToArray() ;

/// @brief Method TryGetFaceExpressionWeight, addr 0x3f19210, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method TryGetWeightConfidence, addr 0x3f1926c, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x3f19018, size 0x9c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3f196b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline int32_t getStaticF__trackingInstanceCount() ;

/// @brief Method get_Count, addr 0x3f1969c, size 0x18, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_EyeFollowingBlendshapesValid, addr 0x3f18d44, size 0x8, virtual false, abstract: false, final false
inline bool get_EyeFollowingBlendshapesValid() ;

/// @brief Method get_FaceTrackingEnabled, addr 0x3f18ce0, size 0x50, virtual false, abstract: false, final false
inline bool get_FaceTrackingEnabled() ;

/// @brief Method get_Item, addr 0x3f190b4, size 0xfc, virtual false, abstract: false, final false
inline float_t get_Item(::GlobalNamespace::__OVRFaceExpressions__FaceExpression  expression) ;

/// @brief Method get_ValidExpressions, addr 0x3f18d30, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_EyeFollowingBlendshapesValid, addr 0x3f18d4c, size 0xc, virtual false, abstract: false, final false
inline void set_EyeFollowingBlendshapesValid(bool  value) ;

/// @brief Method set_ValidExpressions, addr 0x3f18d38, size 0xc, virtual false, abstract: false, final false
