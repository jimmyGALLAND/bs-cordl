...
/// @brief Method .ctor, addr 0x444793c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disabledState, addr 0x4447924, size 0x8, virtual false, abstract: false, final false
inline float_t get_disabledState() ;

/// @brief Method get_highlightedState, addr 0x4447914, size 0x8, virtual false, abstract: false, final false
inline float_t get_highlightedState() ;

/// @brief Method get_normalState, addr 0x444790c, size 0x8, virtual false, abstract: false, final false
inline float_t get_normalState() ;

/// @brief Method get_pressedState, addr 0x444791c, size 0x8, virtual false, abstract: false, final false
inline float_t get_pressedState() ;

/// @brief Method get_selectedAndHighlightedState, addr 0x4447934, size 0x8, virtual false, abstract: false, final false
inline float_t get_selectedAndHighlightedState() ;

/// @brief Method get_selectedState, addr 0x444792c, size 0x8, virtual false, abstract: false, final false
