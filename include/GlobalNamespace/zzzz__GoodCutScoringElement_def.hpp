...
/// @brief Method .ctor, addr 0x3b59160, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _multiplierEventType, offset 0x30, size 0x4 
 __declspec(property(get=__cordl_internal_get__multiplierEventType, put=__cordl_internal_set__multiplierEventType)) ::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType  _multiplierEventType;

/// @brief Field _wouldBeCorrectCutBestPossibleMultiplierEventType, offset 0x34, size 0x4 
 __declspec(property(get=__cordl_internal_get__wouldBeCorrectCutBestPossibleMultiplierEventType, put=__cordl_internal_set__wouldBeCorrectCutBestPossibleMultiplierEventType)) ::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType  _wouldBeCorrectCutBestPossibleMultiplierEventType;
...
/// @brief Method HandleCutScoreBufferDidFinish, addr 0x3b590e0, size 0x24, virtual true, abstract: false, final true
inline void HandleCutScoreBufferDidFinish(::GlobalNamespace::CutScoreBuffer*  cutScoreBuffer) ;

/// @brief Method Init, addr 0x3b58bac, size 0x70, virtual false, abstract: false, final false
inline void Init(::GlobalNamespace::NoteCutInfo  noteCutInfo) ;

static inline ::GlobalNamespace::GoodCutScoringElement* New_ctor() ;

/// @brief Method Reinitialize, addr 0x3b590c8, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b59104, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_cutScore, addr 0x3b5904c, size 0x40, virtual true, abstract: false, final false
inline int32_t get_cutScore() ;

/// @brief Method get_cutScoreBuffer, addr 0x3b5909c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::IReadonlyCutScoreBuffer* get_cutScoreBuffer() ;

/// @brief Method get_executionOrder, addr 0x3b590a4, size 0x24, virtual true, abstract: false, final false
inline int32_t get_executionOrder() ;

/// @brief Method get_multiplierEventType, addr 0x3b59094, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType get_multiplierEventType() ;

/// @brief Method get_wouldBeCorrectCutBestPossibleMultiplierEventType, addr 0x3b5908c, size 0x8, virtual true, abstract: false, final false
