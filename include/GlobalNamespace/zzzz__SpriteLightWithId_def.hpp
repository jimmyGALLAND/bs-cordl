...
/// @brief Field _multiplyColorByAlpha, offset 0x54, size 0x4 
 __declspec(property(get=__cordl_internal_get__multiplyColorByAlpha, put=__cordl_internal_set__multiplyColorByAlpha)) ::GlobalNamespace::__SpriteLightWithId__MultiplyColorByAlphaType  _multiplyColorByAlpha;
...
/// @brief Method ColorWasSet, addr 0x3961ea8, size 0x144, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3961fec, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_color, addr 0x3961e8c, size 0x1c, virtual false, abstract: false, final false
