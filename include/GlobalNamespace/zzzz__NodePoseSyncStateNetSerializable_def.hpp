...
/// @brief Method Deserialize, addr 0x229db08, size 0x50, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

static inline ::GlobalNamespace::NodePoseSyncStateNetSerializable* New_ctor() ;

/// @brief Method Release, addr 0x229db78, size 0x54, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x229da98, size 0x4c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x229dbcc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_id, addr 0x229da50, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::SyncStateId get_id() ;

/// @brief Method get_pool, addr 0x229da10, size 0x40, virtual false, abstract: false, final false
static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::NodePoseSyncStateNetSerializable*>* get_pool() ;

/// @brief Method get_state, addr 0x229da70, size 0x10, virtual true, abstract: false, final true
inline ::GlobalNamespace::NodePoseSyncState get_state() ;

/// @brief Method get_time, addr 0x229da60, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_id, addr 0x229da58, size 0x8, virtual true, abstract: false, final true
inline void set_id(::GlobalNamespace::SyncStateId  value) ;

/// @brief Method set_state, addr 0x229da80, size 0x18, virtual true, abstract: false, final true
inline void set_state(::GlobalNamespace::NodePoseSyncState  value) ;

/// @brief Method set_time, addr 0x229da68, size 0x8, virtual true, abstract: false, final true
