...
/// @brief Method DecButtonPressed, addr 0x3b973c4, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method IncButtonPressed, addr 0x3b97384, size 0x40, virtual true, abstract: false, final false
inline void IncButtonPressed() ;

static inline ::GlobalNamespace::ListColorController* New_ctor() ;

/// @brief Method OnEnable, addr 0x3b972a4, size 0x34, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Refresh, addr 0x3b97328, size 0x5c, virtual false, abstract: false, final false
inline void Refresh(bool  applyValue) ;

/// @brief Method RefreshUI, addr 0x3b972d8, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b973fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
