...
/// @brief Method Init, addr 0x3a64a30, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method ManualUpdate, addr 0x3a64bdc, size 0x17c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 ManualUpdate() ;

static inline ::GlobalNamespace::NoteFloorMovement* New_ctor() ;

/// @brief Method SetToStart, addr 0x3a64ae8, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a64d58, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_floorMovementDidFinishEvent, addr 0x3a6486c, size 0x9c, virtual false, abstract: false, final false
inline void add_floorMovementDidFinishEvent(::System::Action*  value) ;

/// @brief Method get_distanceToPlayer, addr 0x3a649a4, size 0x40, virtual false, abstract: false, final false
inline float_t get_distanceToPlayer() ;

/// @brief Method get_endPos, addr 0x3a649f0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_endPos() ;

/// @brief Method get_inverseWorldRotation, addr 0x3a64a18, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_inverseWorldRotation() ;

/// @brief Method get_localPosition, addr 0x3a64a24, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_localPosition() ;

/// @brief Method get_moveDuration, addr 0x3a64a04, size 0x8, virtual false, abstract: false, final false
inline float_t get_moveDuration() ;

/// @brief Method get_startPos, addr 0x3a649e4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_startPos() ;

/// @brief Method get_startTime, addr 0x3a649fc, size 0x8, virtual false, abstract: false, final false
inline float_t get_startTime() ;

/// @brief Method get_worldRotation, addr 0x3a64a0c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_worldRotation() ;

/// @brief Method remove_floorMovementDidFinishEvent, addr 0x3a64908, size 0x9c, virtual false, abstract: false, final false
