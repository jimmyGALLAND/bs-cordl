...
/// @brief Field _copyPositions, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__copyPositions, put=__cordl_internal_set__copyPositions)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::CopyPosition>>*  _copyPositions;
...
/// @brief Method Add, addr 0x3940cf8, size 0x1dc, virtual false, abstract: false, final false
static inline void Add(::GlobalNamespace::CopyPosition*  copyPosition) ;

/// @brief Method LateUpdate, addr 0x3940edc, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3941088, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Awake, addr 0x3940cf4, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::CopyPosition* New_ctor() ;

/// @brief Method Refresh, addr 0x3940cb4, size 0x40, virtual false, abstract: false, final false
inline void Refresh() ;
...
/// @brief Method .ctor, addr 0x3940ed4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
