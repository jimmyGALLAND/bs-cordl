...
/// @brief Method Awake, addr 0x3a98814, size 0xc, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GenerateReports, addr 0x3a98894, size 0x310, virtual false, abstract: false, final false
inline void GenerateReports() ;

static inline ::GlobalNamespace::PerformanceRecorder* New_ctor() ;

/// @brief Method OnDisable, addr 0x3a98890, size 0x4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3a98820, size 0x70, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Update, addr 0x3a98ba4, size 0x158, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method <GenerateReports>g__WriteFileReport|28_0, addr 0x3a99298, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a992cc, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_gamePause, addr 0x3a987c4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::IGamePause* get_gamePause() ;

/// @brief Method get_gameplayModifiers, addr 0x3a98804, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayModifierMask get_gameplayModifiers() ;

/// @brief Method get_playerSpecificSettings, addr 0x3a987f4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSpecificSettings() ;

/// @brief Method get_sceneSetupData, addr 0x3a987d4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayCoreSceneSetupData* get_sceneSetupData() ;

/// @brief Method get_settingsManager, addr 0x3a987e4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::SettingsManager* get_settingsManager() ;

/// @brief Method set_gamePause, addr 0x3a987cc, size 0x8, virtual false, abstract: false, final false
inline void set_gamePause(::GlobalNamespace::IGamePause*  value) ;

/// @brief Method set_gameplayModifiers, addr 0x3a9880c, size 0x8, virtual false, abstract: false, final false
inline void set_gameplayModifiers(::GlobalNamespace::GameplayModifierMask  value) ;

/// @brief Method set_playerSpecificSettings, addr 0x3a987fc, size 0x8, virtual false, abstract: false, final false
inline void set_playerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings*  value) ;

/// @brief Method set_sceneSetupData, addr 0x3a987dc, size 0x8, virtual false, abstract: false, final false
inline void set_sceneSetupData(::GlobalNamespace::GameplayCoreSceneSetupData*  value) ;

/// @brief Method set_settingsManager, addr 0x3a987ec, size 0x8, virtual false, abstract: false, final false
