...
/// @brief Method SetBeatmap, addr 0x3a74878, size 0xb4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a74a04, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
