...
/// @brief Method HandleAnyGameplayLevelDidFinish, addr 0x3aeef08, size 0x14, virtual false, abstract: false, final false
inline void HandleAnyGameplayLevelDidFinish() ;

/// @brief Method HandleDidPauseEvent, addr 0x3aeef34, size 0x14, virtual false, abstract: false, final false
inline void HandleDidPauseEvent() ;

/// @brief Method HandleDidResumeEvent, addr 0x3aeef1c, size 0x18, virtual false, abstract: false, final false
inline void HandleDidResumeEvent() ;

static inline ::GlobalNamespace::HeadInObstacleHapticEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3aeec90, size 0x1f0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3aeea88, size 0x208, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3aeee80, size 0x88, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3aeef48, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;
