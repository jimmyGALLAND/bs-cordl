...
/// @brief Method HandleNoteWasSpawned, addr 0x3a52b8c, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3a525e8, size 0x8c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3a5255c, size 0x8c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3a52674, size 0x518, virtual false, abstract: false, final false
inline void Update() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityEngine::Vector4,::UnityW<::GlobalNamespace::BeatLine>>*> const& __cordl_internal_get__activeBeatLines() const;
...
/// @brief Method .ctor, addr 0x3a52d2c, size 0xcc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isMidRotationValid, addr 0x3a52544, size 0x8, virtual false, abstract: false, final false
inline bool get_isMidRotationValid() ;

/// @brief Method get_midRotation, addr 0x3a5254c, size 0x8, virtual false, abstract: false, final false
inline float_t get_midRotation() ;

/// @brief Method get_rotationRange, addr 0x3a52554, size 0x8, virtual false, abstract: false, final false
