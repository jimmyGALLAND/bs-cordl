...
public:
// Declarations
/// @brief Method ErrorCode, addr 0x268c99c, size 0x80, virtual false, abstract: false, final false
static inline ::StringW ErrorCode(::GlobalNamespace::ConnectionFailedReason  connectionFailedReason) ;

/// @brief Method LocalizedKey, addr 0x268c8e8, size 0xb4, virtual false, abstract: false, final false
