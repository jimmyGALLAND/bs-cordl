...
/// @brief Method CheckAndUpdateStatus, addr 0x3b1d14c, size 0xc4, virtual false, abstract: false, final false
inline void CheckAndUpdateStatus() ;

/// @brief Method HandleEnergyDidChange, addr 0x3b1d0e0, size 0x6c, virtual false, abstract: false, final false
inline void HandleEnergyDidChange(float_t  energy) ;

/// @brief Method Init, addr 0x3b1d210, size 0x130, virtual true, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::EnergyMissionObjectiveChecker* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b1d014, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b1d340, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
