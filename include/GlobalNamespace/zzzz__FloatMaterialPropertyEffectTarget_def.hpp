...
/// @brief Method Awake, addr 0x3af8f00, size 0x20, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::FloatMaterialPropertyEffectTarget* New_ctor() ;

/// @brief Method SetFloat, addr 0x3af8f24, size 0x60, virtual false, abstract: false, final false
inline void SetFloat(float_t  value) ;

/// @brief Method SetValue, addr 0x3af8f20, size 0x4, virtual true, abstract: false, final false
inline void SetValue(int32_t  groupId, int32_t  elementId, float_t  value) ;

/// @brief Method TriggerValue, addr 0x3af8f84, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3af8f88, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
