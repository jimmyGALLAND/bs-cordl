...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::UI::Toggle> (::GlobalNamespace::ColorSchemeColorToggleController::*)()>(&::GlobalNamespace::ColorSchemeColorToggleController::get_toggle)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3b628a0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (::GlobalNamespace::ColorSchemeColorToggleController::*)()>(&::GlobalNamespace::ColorSchemeColorToggleController::get_color)> {
  constexpr static std::size_t size = 0x38;
  constexpr static std::size_t addrs = 0x3b6214c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ColorSchemeColorToggleController::*)(::UnityEngine::Color)>(&::GlobalNamespace::ColorSchemeColorToggleController::set_color)> {
  constexpr static std::size_t size = 0x98;
  constexpr static std::size_t addrs = 0x3b6219c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ColorSchemeColorToggleController::*)()>(&::GlobalNamespace::ColorSchemeColorToggleController::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3b628a8;
...
constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Graphic>,::Array<::UnityW<::UnityEngine::UI::Graphic>>*> const& GlobalNamespace::ColorSchemeColorToggleController::__cordl_internal_get__colorGraphics() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____colorGraphics;
}
constexpr void GlobalNamespace::ColorSchemeColorToggleController::__cordl_internal_set__colorGraphics(::ArrayW<::UnityW<::UnityEngine::UI::Graphic>,::Array<::UnityW<::UnityEngine::UI::Graphic>>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
