...
/// @brief Method RefreshLevelStats, addr 0x3b85970, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b85974, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
