...
/// @brief Method SetBlueNoiseShaderParams, addr 0x395a080, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x395a16c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
