...
// Ctor Parameters [CppParam { name: "targetFrameRate", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "systemLanguage", ty: "::UnityEngine::SystemLanguage", modifiers: "", def_value: None }, CppParam { name: "runInBackground", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "backgroundLoadingPriority", ty: "::UnityEngine::ThreadPriority", modifiers: "", def_value: None }]
constexpr __PerformanceConfigurationChecks__AppConfig(int32_t  targetFrameRate, ::UnityEngine::SystemLanguage  systemLanguage, bool  runInBackground, ::UnityEngine::ThreadPriority  backgroundLoadingPriority) noexcept;
...
// Ctor Parameters [CppParam { name: "enabled", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "isDeviceActive", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "loadedDeviceName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "stereoRenderingMode", ty: "::UnityEngine::XR::__XRSettings__StereoRenderingMode", modifiers: "", def_value: None }, CppParam { name: "eyeTextureWidth", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "eyeTextureHeight", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "eyeTextureResolutionScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "deviceEyeTextureDimension", ty: "::UnityEngine::Rendering::TextureDimension", modifiers: "", def_value: None }, CppParam { name: "renderViewportScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "occlusionMaskScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "useOcclusionMesh", ty: "bool", modifiers: "", def_value: None }]
constexpr __PerformanceConfigurationChecks__XRConfig(bool  enabled, bool  isDeviceActive, ::StringW  loadedDeviceName, ::UnityEngine::XR::__XRSettings__StereoRenderingMode  stereoRenderingMode, int32_t  eyeTextureWidth, int32_t  eyeTextureHeight, float_t  eyeTextureResolutionScale, ::UnityEngine::Rendering::TextureDimension  deviceEyeTextureDimension, float_t  renderViewportScale, float_t  occlusionMaskScale, bool  useOcclusionMesh) noexcept;
...
// Ctor Parameters [CppParam { name: "spaceWarpEnabled", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "chromatic", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "monoscopic", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "colorGamut", ty: "::GlobalNamespace::__OVRManager__ColorSpace", modifiers: "", def_value: None }, CppParam { name: "nativeColorGamut", ty: "::GlobalNamespace::__OVRManager__ColorSpace", modifiers: "", def_value: None }, CppParam { name: "compositionMethod", ty: "::GlobalNamespace::__OVRManager__CompositionMethod", modifiers: "", def_value: None }, CppParam { name: "enableMixedReality", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "trackingOriginType", ty: "::GlobalNamespace::__OVRManager__TrackingOrigin", modifiers: "", def_value: None }, CppParam { name: "usePositionTracking", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "useRotationTracking", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "sharpenType", ty: "::GlobalNamespace::__OVRPlugin__LayerSharpenType", modifiers: "", def_value: None }, CppParam { name: "enableDynamicResolution", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "minDynamicResolutionScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "maxDynamicResolutionScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "simultaneousHandsAndControllersSupport", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "suggestedCpuPerfLevel", ty: "::GlobalNamespace::__OVRPlugin__ProcessorPerformanceLevel", modifiers: "", def_value: None }, CppParam { name: "suggestedGpuPerfLevel", ty: "::GlobalNamespace::__OVRPlugin__ProcessorPerformanceLevel", modifiers: "", def_value: None }, CppParam { name: "systemDisplayFrequency", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "eyeTrackedFoveatedRenderingEnabled", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "foveatedRenderingLevel", ty: "::GlobalNamespace::__OVRPlugin__FoveatedRenderingLevel", modifiers: "", def_value: None }, CppParam { name: "useDynamicFoveatedRendering", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "gpuUtilSupported", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "gpuUtilLevel", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "eyeFovPremultipliedAlphaModeEnabled", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "asymmetricFovEnabled", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "eyeTextureArrayEnabled", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "localDimmingSupported", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "localDimming", ty: "bool", modifiers: "", def_value: None }]
constexpr __PerformanceConfigurationChecks__OVRConfig(bool  spaceWarpEnabled, bool  chromatic, bool  monoscopic, ::GlobalNamespace::__OVRManager__ColorSpace  colorGamut, ::GlobalNamespace::__OVRManager__ColorSpace  nativeColorGamut, ::GlobalNamespace::__OVRManager__CompositionMethod  compositionMethod, bool  enableMixedReality, ::GlobalNamespace::__OVRManager__TrackingOrigin  trackingOriginType, bool  usePositionTracking, bool  useRotationTracking, ::GlobalNamespace::__OVRPlugin__LayerSharpenType  sharpenType, bool  enableDynamicResolution, float_t  minDynamicResolutionScale, float_t  maxDynamicResolutionScale, bool  simultaneousHandsAndControllersSupport, ::GlobalNamespace::__OVRPlugin__ProcessorPerformanceLevel  suggestedCpuPerfLevel, ::GlobalNamespace::__OVRPlugin__ProcessorPerformanceLevel  suggestedGpuPerfLevel, float_t  systemDisplayFrequency, bool  eyeTrackedFoveatedRenderingEnabled, ::GlobalNamespace::__OVRPlugin__FoveatedRenderingLevel  foveatedRenderingLevel, bool  useDynamicFoveatedRendering, bool  gpuUtilSupported, float_t  gpuUtilLevel, bool  eyeFovPremultipliedAlphaModeEnabled, bool  asymmetricFovEnabled, bool  eyeTextureArrayEnabled, bool  localDimmingSupported, bool  localDimming) noexcept;
...
// Ctor Parameters [CppParam { name: "leftHanded", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "automaticPlayerHeight", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "playerHeight", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "noteJumpDurationTypeSettings", ty: "::GlobalNamespace::NoteJumpDurationTypeSettings", modifiers: "", def_value: None }, CppParam { name: "noteJumpFixedDuration", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "noteJumpStartBeatOffset", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "autoRestart", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "headsetHapticIntensity", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "arcsHapticFeedback", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "reduceDebris", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "noFailEffects", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "hideNoteSpawnEffect", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "arcVisibility", ty: "::GlobalNamespace::ArcVisibilityType", modifiers: "", def_value: None }, CppParam { name: "saberTrailIntensity", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "noTextsAndHuds", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "advancedHud", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "sfxVolume", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "adaptiveSfx", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "environmentEffectsFilterDefaultPreset", ty: "::GlobalNamespace::EnvironmentEffectsFilterPreset", modifiers: "", def_value: None }, CppParam { name: "environmentEffectsFilterExpertPlusPreset", ty: "::GlobalNamespace::EnvironmentEffectsFilterPreset", modifiers: "", def_value: None }]
...
/// @brief Field invalid, offset 0x1d8, size 0x8 
 __declspec(property(get=__cordl_internal_get_invalid, put=__cordl_internal_set_invalid)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::__PerformanceConfigurationChecks__Mismatch>*  invalid;
...
/// @brief Method CreateErrorLog, addr 0x3a92ffc, size 0x28c, virtual false, abstract: false, final false
inline ::StringW CreateErrorLog() ;

/// @brief Method IsValid, addr 0x3a92fa0, size 0x5c, virtual false, abstract: false, final false
inline bool IsValid() ;

static inline ::GlobalNamespace::PerformanceConfigurationChecks* New_ctor() ;

/// @brief Method SetExpected, addr 0x3a93288, size 0x4a4, virtual false, abstract: false, final false
...
template<typename T>
inline void VerifyEntry(::StringW  name, T  expected, T  actual) ;

/// @brief Method VerifyExpected, addr 0x3a9372c, size 0x1bf8, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::__PerformanceConfigurationChecks__Mismatch>*> const& __cordl_internal_get_invalid() const;
...
/// @brief Method .ctor, addr 0x3a95324, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
