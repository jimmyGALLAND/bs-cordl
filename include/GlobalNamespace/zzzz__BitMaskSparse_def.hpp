...
/// @brief Method <ToString>b__8_0, addr 0x26d1554, size 0x1c, virtual false, abstract: false, final false
inline ::StringW _ToString_b__8_0(uint32_t  i) ;

/// @brief Method .ctor, addr 0x26d154c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Deserialize, addr 0x26cfeb4, size 0x94, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Equals, addr 0x26d1238, size 0x6c, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::BitMaskSparse*  other) ;

/// @brief Method GetBits, addr 0x26d1334, size 0x98, virtual true, abstract: false, final true
...
/// @brief Method Serialize, addr 0x26cfcb0, size 0x1ec, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method SetBits, addr 0x26d12a4, size 0x90, virtual true, abstract: false, final true
inline ::GlobalNamespace::BitMaskSparse* SetBits(int32_t  offset, uint64_t  bits) ;

/// @brief Method ToString, addr 0x26d13cc, size 0x124, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26cf924, size 0x88, virtual false, abstract: false, final false
inline void _ctor(int32_t  bitCount) ;

/// @brief Method get_bitCount, addr 0x26d1230, size 0x8, virtual true, abstract: false, final true
