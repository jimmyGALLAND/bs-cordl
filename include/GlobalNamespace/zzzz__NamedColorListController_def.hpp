...
/// @brief Method .ctor, addr 0x3b97814, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _textValuePairs, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__textValuePairs, put=__cordl_internal_set__textValuePairs)) ::ArrayW<::GlobalNamespace::__NamedColorListController__ColorValuePair*,::Array<::GlobalNamespace::__NamedColorListController__ColorValuePair*>*>  _textValuePairs;
...
/// @brief Method ApplyValue, addr 0x3b977b0, size 0x20, virtual true, abstract: false, final false
inline void ApplyValue(int32_t  idx) ;

/// @brief Method ColorForValue, addr 0x3b977d0, size 0x3c, virtual true, abstract: false, final false
inline ::UnityEngine::Color ColorForValue(int32_t  idx) ;

/// @brief Method GetInitValues, addr 0x3b9773c, size 0x74, virtual true, abstract: false, final false
inline bool GetInitValues(ByRef<int32_t>  idx, ByRef<int32_t>  numberOfElements) ;

/// @brief Method Init, addr 0x3b976c8, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method SetValue, addr 0x3b97704, size 0x38, virtual false, abstract: false, final false
inline void SetValue(int32_t  value) ;

constexpr ::ArrayW<::GlobalNamespace::__NamedColorListController__ColorValuePair*,::Array<::GlobalNamespace::__NamedColorListController__ColorValuePair*>*> const& __cordl_internal_get__textValuePairs() const;
...
constexpr void __cordl_internal_set__textValuePairs(::ArrayW<::GlobalNamespace::__NamedColorListController__ColorValuePair*,::Array<::GlobalNamespace::__NamedColorListController__ColorValuePair*>*>  value) ;
...
/// @brief Method .ctor, addr 0x3b9780c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_valueChangedEvent, addr 0x3b97568, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method remove_valueChangedEvent, addr 0x3b97618, size 0xb0, virtual true, abstract: false, final true
