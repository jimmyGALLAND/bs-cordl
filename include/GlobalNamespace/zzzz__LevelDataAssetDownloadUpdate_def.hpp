...
/// @brief Method .ctor, addr 0x268547c, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "levelID", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "bytesTotal", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "bytesTransferred", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "assetDownloadingState", ty: "::GlobalNamespace::__LevelDataAssetDownloadUpdate__AssetDownloadingState", modifiers: "", def_value: None }]
constexpr LevelDataAssetDownloadUpdate(::StringW  levelID, uint32_t  bytesTotal, uint32_t  bytesTransferred, ::GlobalNamespace::__LevelDataAssetDownloadUpdate__AssetDownloadingState  assetDownloadingState) noexcept;
