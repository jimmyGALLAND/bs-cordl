...
/// @brief Method .ctor, addr 0x3aeb1dc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _didFinishEvent, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__didFinishEvent, put=__cordl_internal_set__didFinishEvent)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::IBeatEffectDidFinishEvent*>*  _didFinishEvent;
...
/// @brief Method Init, addr 0x3aeadb0, size 0xc4, virtual false, abstract: false, final false
inline void Init(::UnityEngine::Color  color, float_t  animationDuration, ::UnityEngine::Quaternion  rotation) ;

/// @brief Method ManualUpdate, addr 0x3aeae74, size 0x2ec, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aeb160, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_didFinishEvent, addr 0x3aeada8, size 0x8, virtual false, abstract: false, final false
