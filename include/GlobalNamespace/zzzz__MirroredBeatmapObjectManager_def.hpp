...
/// @brief Method Finalize, addr 0x3a5c188, size 0x328, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method HandleDidHideAllBeatmapObjects, addr 0x3a5ced8, size 0x6f8, virtual false, abstract: false, final false
inline void HandleDidHideAllBeatmapObjects(bool  hide) ;

/// @brief Method HandleNoteWasDespawned, addr 0x3a5c79c, size 0x17c, virtual false, abstract: false, final false
inline void HandleNoteWasDespawned(::GlobalNamespace::NoteController*  noteController) ;

/// @brief Method HandleNoteWasSpawned, addr 0x3a5c588, size 0x214, virtual false, abstract: false, final false
inline void HandleNoteWasSpawned(::GlobalNamespace::NoteController*  noteController) ;

/// @brief Method HandleObstacleWasDespawned, addr 0x3a5cab4, size 0xc0, virtual false, abstract: false, final false
inline void HandleObstacleWasDespawned(::GlobalNamespace::ObstacleController*  obstacleController) ;

/// @brief Method HandleObstacleWasSpawned, addr 0x3a5c918, size 0x98, virtual false, abstract: false, final false
inline void HandleObstacleWasSpawned(::GlobalNamespace::ObstacleController*  obstacleController) ;

/// @brief Method HandleSliderWasDespawned, addr 0x3a5ce18, size 0xc0, virtual false, abstract: false, final false
inline void HandleSliderWasDespawned(::GlobalNamespace::SliderController*  sliderController) ;

/// @brief Method HandleSliderWasSpawned, addr 0x3a5cb74, size 0x98, virtual false, abstract: false, final false
inline void HandleSliderWasSpawned(::GlobalNamespace::SliderController*  sliderController) ;

/// @brief Method Init, addr 0x3a5bd8c, size 0x3fc, virtual false, abstract: false, final false
inline void Init(::GlobalNamespace::BeatmapObjectManager*  beatmapObjectManager, ::GlobalNamespace::__MirroredGameNoteController__Pool*  mirroredBasicGameNotePool, ::GlobalNamespace::__MirroredGameNoteController__Pool*  burstSliderHeadGameNotePool, ::GlobalNamespace::__MirroredGameNoteController__Pool*  burstSliderGameNotePool, ::GlobalNamespace::__MirroredBombNoteController__Pool*  mirroredBombNotePool, ::GlobalNamespace::__MirroredObstacleController__Pool*  mirroredObstaclePool, ::GlobalNamespace::__MirroredSliderController__Pool*  mirroredSlidersPool) ;

/// @brief Method InvalidateGameNotePools, addr 0x3a5c4b0, size 0xd8, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::INoteMirrorable*,::UnityW<::GlobalNamespace::MirroredBombNoteController>>*> const& __cordl_internal_get__bombNoteControllersToMirroredBombNoteControllers() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::MirroredGameNoteController>>*> const& __cordl_internal_get__mirroredBasicGameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::MirroredBombNoteController>>*> const& __cordl_internal_get__mirroredBombNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::MirroredGameNoteController>>*> const& __cordl_internal_get__mirroredBurstSliderGameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::MirroredGameNoteController>>*> const& __cordl_internal_get__mirroredBurstSliderHeadGameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::MirroredObstacleController>>*> const& __cordl_internal_get__mirroredObstaclePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::MirroredSliderController>>*> const& __cordl_internal_get__mirroredSlidersPoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::ObstacleController>,::UnityW<::GlobalNamespace::MirroredObstacleController>>*> const& __cordl_internal_get__obstacleControllersToMirroredObstacleControllers() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::SliderController>,::UnityW<::GlobalNamespace::MirroredSliderController>>*> const& __cordl_internal_get__sliderControllersToMirroredSliderControllers() const;
...
/// @brief Method .ctor, addr 0x3a5d628, size 0x154, virtual false, abstract: false, final false
inline void _ctor() ;
