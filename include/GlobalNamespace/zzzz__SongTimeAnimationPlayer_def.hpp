...
/// @brief Method Update, addr 0x3a50708, size 0x44, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3a5074c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
