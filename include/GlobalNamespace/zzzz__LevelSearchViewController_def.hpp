...
namespace GlobalNamespace {
struct __LevelSearchViewController___RefreshAsync_d__35;
}
namespace HMUI {
...
MARK_VAL_T(::GlobalNamespace::__LevelSearchViewController___RefreshAsync_d__35);
// Type: ::<RefreshAsync>d__35
...
struct CORDL_TYPE __LevelSearchViewController___RefreshAsync_d__35 {
public:
// Declarations
/// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine*() ;

/// @brief Method MoveNext, addr 0x3ad5c14, size 0x904, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3ad6518, size 0xc, virtual true, abstract: false, final true
...
// Ctor Parameters []
// @brief default ctor
constexpr __LevelSearchViewController___RefreshAsync_d__35() ;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::LevelSearchViewController>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<::GlobalNamespace::BeatmapLevel*,::Array<::GlobalNamespace::BeatmapLevel*>*>>", modifiers: "", def_value: None }]
constexpr __LevelSearchViewController___RefreshAsync_d__35(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::UnityW<::GlobalNamespace::LevelSearchViewController>  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<::GlobalNamespace::BeatmapLevel*,::Array<::GlobalNamespace::BeatmapLevel*>*>>  __u__1) noexcept;
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__LevelSearchViewController___RefreshAsync_d__35, 0x38>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__LevelSearchViewController___RefreshAsync_d__35, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__LevelSearchViewController___RefreshAsync_d__35, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__LevelSearchViewController___RefreshAsync_d__35, __4__this) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__LevelSearchViewController___RefreshAsync_d__35, __u__1) == 0x30, "Offset mismatch!");
...
public:
// Declarations
using _RefreshAsync_d__35 = ::GlobalNamespace::__LevelSearchViewController___RefreshAsync_d__35;
...
/// @brief Field _preferredBeatmapCharacteristic, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get__preferredBeatmapCharacteristic, put=__cordl_internal_set__preferredBeatmapCharacteristic)) ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>  _preferredBeatmapCharacteristic;

/// @brief Field _preferredBeatmapDifficulty, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get__preferredBeatmapDifficulty, put=__cordl_internal_set__preferredBeatmapDifficulty)) ::System::Nullable_1<::GlobalNamespace::BeatmapDifficulty>  _preferredBeatmapDifficulty;
...
/// @brief Field didFilterBeatmapLevelCollectionEvent, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didFilterBeatmapLevelCollectionEvent, put=__cordl_internal_set_didFilterBeatmapLevelCollectionEvent)) ::System::Action_2<::GlobalNamespace::BeatmapLevelPack*,::GlobalNamespace::LevelSelectionOptions>*  didFilterBeatmapLevelCollectionEvent;

/// @brief Field didPressSearchButtonEvent, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didPressSearchButtonEvent, put=__cordl_internal_set_didPressSearchButtonEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::LevelSearchViewController>,::GlobalNamespace::LevelFilter>*  didPressSearchButtonEvent;

/// @brief Field didStartLoadingEvent, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didStartLoadingEvent, put=__cordl_internal_set_didStartLoadingEvent)) ::System::Action_1<::UnityW<::GlobalNamespace::LevelSearchViewController>>*  didStartLoadingEvent;

/// @brief Method DidActivate, addr 0x3ad518c, size 0x18c, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3ad5318, size 0xc8, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method IsFilteringPlayCounts, addr 0x3ad3430, size 0x8, virtual false, abstract: false, final false
inline bool IsFilteringPlayCounts() ;

/// @brief Method LocalizedLevelFilterParamsDescription, addr 0x3ad54b0, size 0x650, virtual false, abstract: false, final false
static inline ::StringW LocalizedLevelFilterParamsDescription(ByRef<::GlobalNamespace::LevelFilter>  filter, ::GlobalNamespace::SongPackMasksModel*  songPackMasksModel, ::System::Collections::Generic::IReadOnlyList_1<::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>>*  characteristics, bool  isPlayerSensitivityForced) ;

static inline ::GlobalNamespace::LevelSearchViewController* New_ctor() ;

/// @brief Method Refresh, addr 0x3ad3438, size 0x4, virtual false, abstract: false, final false
inline void Refresh() ;

/// @brief Method Refresh, addr 0x3ad516c, size 0x20, virtual false, abstract: false, final false
inline void Refresh(ByRef<::GlobalNamespace::LevelFilter>  filter) ;

/// @brief Method RefreshAsync, addr 0x3ad50dc, size 0x90, virtual false, abstract: false, final false
inline void RefreshAsync() ;

/// @brief Method ResetAllFilterSettings, addr 0x3ad5078, size 0x64, virtual false, abstract: false, final false
inline void ResetAllFilterSettings(bool  onlyFavorites) ;

/// @brief Method ResetFilter, addr 0x3ad3258, size 0x1c, virtual false, abstract: false, final false
inline void ResetFilter(bool  onlyFavorites) ;

/// @brief Method ResetOptionFilterSettings, addr 0x3ad53e8, size 0xac, virtual false, abstract: false, final false
inline void ResetOptionFilterSettings(bool  onlyFavorites) ;

/// @brief Method ResetTextFilterSettings, addr 0x3ad53e0, size 0x8, virtual false, abstract: false, final false
inline void ResetTextFilterSettings(::StringW  text) ;

/// @brief Method SearchTextInputFieldViewOnValueChanged, addr 0x3ad5494, size 0x1c, virtual false, abstract: false, final false
inline void SearchTextInputFieldViewOnValueChanged(::HMUI::InputFieldView*  inputFieldView) ;

/// @brief Method Setup, addr 0x3ad5070, size 0x8, virtual false, abstract: false, final false
inline void Setup(::ArrayW<::GlobalNamespace::BeatmapLevelPack*,::Array<::GlobalNamespace::BeatmapLevelPack*>*>  beatmapLevelPacks) ;

/// @brief Method <DidActivate>b__30_0, addr 0x3ad5b84, size 0x6c, virtual false, abstract: false, final false
inline void _DidActivate_b__30_0() ;

/// @brief Method <DidActivate>b__30_1, addr 0x3ad5bf0, size 0x24, virtual false, abstract: false, final false
inline void _DidActivate_b__30_1() ;

/// @brief Method <LocalizedLevelFilterParamsDescription>g__Append|37_0, addr 0x3ad5b00, size 0x7c, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::BeatmapLevelPack*,::GlobalNamespace::LevelSelectionOptions>*> const& __cordl_internal_get_didFilterBeatmapLevelCollectionEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::LevelSearchViewController>,::GlobalNamespace::LevelFilter>*> const& __cordl_internal_get_didPressSearchButtonEvent() const;
...
/// @brief Method .ctor, addr 0x3ad5b7c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFilterBeatmapLevelCollectionEvent, addr 0x3ad27e8, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method add_didPressSearchButtonEvent, addr 0x3ad4f10, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method add_didStartLoadingEvent, addr 0x3ad2898, size 0xb0, virtual false, abstract: false, final false
inline void add_didStartLoadingEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelSearchViewController>>*  value) ;

/// @brief Method remove_didFilterBeatmapLevelCollectionEvent, addr 0x3ad2eb0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_didPressSearchButtonEvent, addr 0x3ad4fc0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_didStartLoadingEvent, addr 0x3ad2f60, size 0xb0, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__LevelSearchViewController___RefreshAsync_d__35, "", "LevelSearchViewController/<RefreshAsync>d__35");
