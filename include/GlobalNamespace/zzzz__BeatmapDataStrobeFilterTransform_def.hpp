...
/// @brief Field originalBasicBeatmapEventData, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_originalBasicBeatmapEventData, put=__cordl_internal_set_originalBasicBeatmapEventData)) ::GlobalNamespace::BasicBeatmapEventData*  originalBasicBeatmapEventData;
...
/// @brief Method AddStrobeData, addr 0x26603c8, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method StartPotentialStrobe, addr 0x2660484, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x266033c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CreateTransformedData, addr 0x265f6fc, size 0xc40, virtual false, abstract: false, final false
...
/// @brief Method GetFlashAndFadeToBlackEventDataValue, addr 0x2660464, size 0x20, virtual false, abstract: false, final false
static inline int32_t GetFlashAndFadeToBlackEventDataValue(::GlobalNamespace::EnvironmentColorType  lightColorType) ;

/// @brief Method GetOnEventDataValue, addr 0x2660440, size 0x24, virtual false, abstract: false, final false
