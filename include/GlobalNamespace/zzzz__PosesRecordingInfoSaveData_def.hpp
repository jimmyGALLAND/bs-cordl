...
/// @brief Method .ctor, addr 0x3a91264, size 0x50, virtual false, abstract: false, final false
inline void _ctor(float_t  fieldOfVision, float_t  nearClip, float_t  farClip, float_t  hmdOffset, float_t  nearOffset) ;

/// @brief Method get_farClip, addr 0x3a9124c, size 0x8, virtual false, abstract: false, final false
inline float_t get_farClip() ;

/// @brief Method get_fieldOfVision, addr 0x3a9123c, size 0x8, virtual false, abstract: false, final false
inline float_t get_fieldOfVision() ;

/// @brief Method get_hmdOffset, addr 0x3a91254, size 0x8, virtual false, abstract: false, final false
inline float_t get_hmdOffset() ;

/// @brief Method get_nearClip, addr 0x3a91244, size 0x8, virtual false, abstract: false, final false
inline float_t get_nearClip() ;

/// @brief Method get_nearOffset, addr 0x3a9125c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _externalCameraCalibration, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__externalCameraCalibration, put=__cordl_internal_set__externalCameraCalibration)) ::GlobalNamespace::__PosesRecordingInfoSaveData__ExternalCameraCalibrationSaveData*  _externalCameraCalibration;
...
/// @brief Method .ctor, addr 0x3a911c8, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method get_dataFileName, addr 0x3a911c0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_dataFileName() ;

/// @brief Method get_externalCameraCalibration, addr 0x3a911b8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__PosesRecordingInfoSaveData__ExternalCameraCalibrationSaveData* get_externalCameraCalibration() ;

/// @brief Method get_objectIds, addr 0x3a911b0, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_objectIds() ;

/// @brief Method get_version, addr 0x3a911a8, size 0x8, virtual false, abstract: false, final false
