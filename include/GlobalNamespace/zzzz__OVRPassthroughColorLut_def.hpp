...
/// @brief Method Execute, addr 0x3fbc39c, size 0xa0, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "target", ty: "::Unity::Collections::NativeArray_1<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "source", ty: "::Unity::Collections::NativeArray_1<::UnityEngine::Color>", modifiers: "", def_value: None }, CppParam { name: "channelCount", ty: "int32_t", modifiers: "", def_value: None }]
constexpr __OVRPassthroughColorLut__WriteColorsAsBytesJob(::Unity::Collections::NativeArray_1<uint8_t>  target, ::Unity::Collections::NativeArray_1<::UnityEngine::Color>  source, int32_t  channelCount) noexcept;
...
/// @brief Method .ctor, addr 0x3fbc6d4, size 0x18, virtual false, abstract: false, final false
inline void _ctor(int32_t  width, int32_t  height, int32_t  resolution, int32_t  slicesPerRow, int32_t  channelCount, bool  flipY) ;

/// @brief Method get_ChannelCount, addr 0x3fbc7ac, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ChannelCount() ;

/// @brief Method get_FlipY, addr 0x3fbc7b4, size 0x8, virtual false, abstract: false, final false
inline bool get_FlipY() ;

/// @brief Method get_Height, addr 0x3fbc794, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Height() ;

/// @brief Method get_Resolution, addr 0x3fbc79c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Resolution() ;

/// @brief Method get_SlicesPerRow, addr 0x3fbc7a4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_SlicesPerRow() ;

/// @brief Method get_Width, addr 0x3fbc78c, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_Width_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_Height_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_Resolution_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_SlicesPerRow_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_ChannelCount_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_FlipY_k__BackingField", ty: "bool", modifiers: "", def_value: None }]
constexpr __OVRPassthroughColorLut__ColorLutTextureConverter__TextureSettings(int32_t  _Width_k__BackingField, int32_t  _Height_k__BackingField, int32_t  _Resolution_k__BackingField, int32_t  _SlicesPerRow_k__BackingField, int32_t  _ChannelCount_k__BackingField, bool  _FlipY_k__BackingField) noexcept;
...
/// @brief Method Execute, addr 0x3fbc6ec, size 0xa0, virtual true, abstract: false, final true
inline void Execute(int32_t  index) ;
...
// Ctor Parameters [CppParam { name: "settings", ty: "::GlobalNamespace::__OVRPassthroughColorLut__ColorLutTextureConverter__TextureSettings", modifiers: "", def_value: None }, CppParam { name: "target", ty: "::Unity::Collections::NativeArray_1<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "source", ty: "::Unity::Collections::NativeArray_1<uint8_t>", modifiers: "", def_value: None }]
constexpr __OVRPassthroughColorLut__ColorLutTextureConverter__MapColorValuesJob(::GlobalNamespace::__OVRPassthroughColorLut__ColorLutTextureConverter__TextureSettings  settings, ::Unity::Collections::NativeArray_1<uint8_t>  target, ::Unity::Collections::NativeArray_1<uint8_t>  source) noexcept;
...
/// @brief Method GetTextureSettings, addr 0x3fbc43c, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method MapColorValues, addr 0x3fbc538, size 0x19c, virtual false, abstract: false, final false
static inline void MapColorValues(::GlobalNamespace::__OVRPassthroughColorLut__ColorLutTextureConverter__TextureSettings  settings, ::Unity::Collections::NativeArray_1<uint8_t>  source, ::ArrayW<uint8_t,::Array<uint8_t>*>  target) ;

/// @brief Method TextureToColorByteMap, addr 0x3fbbaf4, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method TryGetTextureLayout, addr 0x3fbbea8, size 0x224, virtual false, abstract: false, final false
...
/// @brief Field <Channels>k__BackingField, offset 0x14, size 0x4 
 __declspec(property(get=__cordl_internal_get__Channels_k__BackingField, put=__cordl_internal_set__Channels_k__BackingField)) ::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels  _Channels_k__BackingField;
...
/// @brief Method ChannelsToCount, addr 0x3fbc244, size 0x10, virtual false, abstract: false, final false
static inline int32_t ChannelsToCount(::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels  channels) ;

/// @brief Method Create, addr 0x3fbaf44, size 0xf0, virtual false, abstract: false, final false
inline void Create(::GlobalNamespace::__OVRPlugin__PassthroughColorLutData  lutData) ;

/// @brief Method CreateLutData, addr 0x3fbc274, size 0x94, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRPlugin__PassthroughColorLutData CreateLutData(ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  colorBytes) ;

/// @brief Method CreateLutDataFromArray, addr 0x3fbb0d0, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method CreateLutDataFromArray, addr 0x3fbb1b8, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method CreateLutDataFromArray, addr 0x3fbb370, size 0x58, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRPlugin__PassthroughColorLutData CreateLutDataFromArray(::ArrayW<uint8_t,::Array<uint8_t>*>  colors) ;

/// @brief Method CreateLutDataFromTexture, addr 0x3fbaeec, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method Destroy, addr 0x3fbbbec, size 0x110, virtual false, abstract: false, final false
inline void Destroy() ;

/// @brief Method Dispose, addr 0x3fbbba8, size 0x44, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Finalize, addr 0x3fbc308, size 0x94, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetArraySize, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline int32_t GetArraySize(::ArrayW<T,::Array<T>*>  array) ;

/// @brief Method GetChannelsForTextureFormat, addr 0x3fbac0c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method GetResolutionFromSize, addr 0x3fbc0cc, size 0xb4, virtual false, abstract: false, final false
static inline uint32_t GetResolutionFromSize(int32_t  size) ;

/// @brief Method GetTextureSize, addr 0x3fbab30, size 0xdc, virtual false, abstract: false, final false
static inline int32_t GetTextureSize(::UnityEngine::Texture2D*  texture) ;

/// @brief Method GetTextureSizeFromByteArray, addr 0x3fbb260, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method IsPowerOfTwo, addr 0x3fbc254, size 0x20, virtual false, abstract: false, final false
static inline bool IsPowerOfTwo(uint32_t  x) ;

/// @brief Method IsResolutionAccepted, addr 0x3fbc180, size 0xc4, virtual false, abstract: false, final false
static inline bool IsResolutionAccepted(uint32_t  resolution, int32_t  size, ByRef<::StringW>  errorMessage) ;

/// @brief Method IsTextureSupported, addr 0x3fbbcfc, size 0x1ac, virtual false, abstract: false, final false
...
template<typename T>
inline bool IsValidLutUpdate(::ArrayW<T,::Array<T>*>  colorArray, int32_t  elementByteSize) ;

/// @brief Method IsValidUpdateResolution, addr 0x3fbb9d0, size 0x124, virtual false, abstract: false, final false
inline bool IsValidUpdateResolution(int32_t  lutSize, int32_t  elementByteSize) ;

static inline ::GlobalNamespace::OVRPassthroughColorLut* New_ctor(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  initialColorLut, ::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels  channels) ;

static inline ::GlobalNamespace::OVRPassthroughColorLut* New_ctor(::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>  initialColorLut, ::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels  channels) ;
...
/// @brief Method UpdateFrom, addr 0x3fbb3c8, size 0xc0, virtual false, abstract: false, final false
inline void UpdateFrom(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  colors) ;

/// @brief Method UpdateFrom, addr 0x3fbb6c0, size 0xc0, virtual false, abstract: false, final false
inline void UpdateFrom(::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>  colors) ;

/// @brief Method UpdateFrom, addr 0x3fbb84c, size 0xcc, virtual false, abstract: false, final false
inline void UpdateFrom(::ArrayW<uint8_t,::Array<uint8_t>*>  colors) ;

/// @brief Method UpdateFrom, addr 0x3fbb918, size 0xb8, virtual false, abstract: false, final false
inline void UpdateFrom(::UnityEngine::Texture2D*  lutTexture, bool  flipY) ;

/// @brief Method WriteColorsAsBytes, addr 0x3fbb488, size 0x238, virtual false, abstract: false, final false
...
/// @brief Method WriteColorsAsBytes, addr 0x3fbb780, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fbb034, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fbb11c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fbb204, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fbaa9c, size 0x94, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Texture2D*  initialLutTexture, bool  flipY) ;

/// @brief Method .ctor, addr 0x3fbaca4, size 0x248, virtual false, abstract: false, final false
inline void _ctor(int32_t  size, ::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels  channels) ;

/// @brief Method get_Channels, addr 0x3fbaa78, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels get_Channels() ;

/// @brief Method get_IsInitialized, addr 0x3fbaa88, size 0x8, virtual false, abstract: false, final false
inline bool get_IsInitialized() ;

/// @brief Method get_Resolution, addr 0x3fbaa68, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_Resolution() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_Channels, addr 0x3fbaa80, size 0x8, virtual false, abstract: false, final false
inline void set_Channels(::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels  value) ;

/// @brief Method set_IsInitialized, addr 0x3fbaa90, size 0xc, virtual false, abstract: false, final false
inline void set_IsInitialized(bool  value) ;

/// @brief Method set_Resolution, addr 0x3fbaa70, size 0x8, virtual false, abstract: false, final false
