...
/// @brief Method ColorWasSet, addr 0x3961240, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3961350, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
