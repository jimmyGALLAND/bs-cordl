...
/// @brief Method Awake, addr 0x3aa1448, size 0x78, virtual false, abstract: false, final false
inline void Awake() ;
...
/// @brief Method .ctor, addr 0x3aa14c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
