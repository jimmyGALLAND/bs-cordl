...
/// @brief Method .ctor, addr 0x266085c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(float_t  time) ;

/// @brief Method get_time, addr 0x2660854, size 0x8, virtual false, abstract: false, final false
