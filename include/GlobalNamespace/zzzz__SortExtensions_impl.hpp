...
template<typename T>
constexpr ::System::Func_2<T,int32_t>*& GlobalNamespace::__SortExtensions____c__DisplayClass1_0_1<T>::__cordl_internal_get_getSortIndex()  {
...
template<typename T>
constexpr void GlobalNamespace::__SortExtensions____c__DisplayClass1_0_1<T>::__cordl_internal_set_getSortIndex(::System::Func_2<T,int32_t>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::__SortExtensions____c__DisplayClass1_0_1<T>::__SortExtensions____c__DisplayClass1_0_1()   {
}
template<typename T>
