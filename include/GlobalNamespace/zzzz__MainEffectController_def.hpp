...
/// @brief Method ImageEffectControllerCallback, addr 0x3ff1018, size 0x80, virtual false, abstract: false, final false
inline void ImageEffectControllerCallback(::UnityEngine::RenderTexture*  src, ::UnityEngine::RenderTexture*  dest) ;

/// @brief Method LazySetupImageEffectController, addr 0x3ff0dfc, size 0x148, virtual false, abstract: false, final false
inline void LazySetupImageEffectController() ;

static inline ::GlobalNamespace::MainEffectController* New_ctor() ;

/// @brief Method OnDisable, addr 0x3ff0f44, size 0x88, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3ff0dd4, size 0x28, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPostRender, addr 0x3ff114c, size 0x30, virtual false, abstract: false, final false
inline void OnPostRender() ;

/// @brief Method OnPreRender, addr 0x3ff1098, size 0xb4, virtual false, abstract: false, final false
inline void OnPreRender() ;

/// @brief Method OnValidate, addr 0x3ff0fcc, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ff117c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_afterImageEffectEvent, addr 0x3ff0c2c, size 0xb0, virtual false, abstract: false, final false
inline void add_afterImageEffectEvent(::System::Action_1<::UnityW<::UnityEngine::RenderTexture>>*  value) ;

/// @brief Method get_fadeValue, addr 0x3ff0d8c, size 0x48, virtual false, abstract: false, final false
inline float_t get_fadeValue() ;

/// @brief Method remove_afterImageEffectEvent, addr 0x3ff0cdc, size 0xb0, virtual false, abstract: false, final false
