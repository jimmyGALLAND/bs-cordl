...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ScreenBackButtonAnimationController::*)()>(&::GlobalNamespace::ScreenBackButtonAnimationController::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x2239758;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ScreenBackButtonAnimationController::*)(::GlobalNamespace::__ScreenBackButtonAnimationController__AnimationType)>(&::GlobalNamespace::ScreenBackButtonAnimationController::StartAnimation)> {
  constexpr static std::size_t size = 0x70;
  constexpr static std::size_t addrs = 0x2239778;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "StartAnimation",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__ScreenBackButtonAnimationController__AnimationType>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ScreenBackButtonAnimationController::*)()>(&::GlobalNamespace::ScreenBackButtonAnimationController::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x22397e8;
...
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__ScreenBackButtonAnimationController__AnimationType,int32_t>*& GlobalNamespace::ScreenBackButtonAnimationController::__cordl_internal_get__animationHashes()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____animationHashes;
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__ScreenBackButtonAnimationController__AnimationType,int32_t>*> const& GlobalNamespace::ScreenBackButtonAnimationController::__cordl_internal_get__animationHashes() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____animationHashes;
}
constexpr void GlobalNamespace::ScreenBackButtonAnimationController::__cordl_internal_set__animationHashes(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__ScreenBackButtonAnimationController__AnimationType,int32_t>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
