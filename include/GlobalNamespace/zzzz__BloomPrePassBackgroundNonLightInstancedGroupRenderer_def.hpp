...
/// @brief Field propertyType, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get_propertyType, put=__cordl_internal_set_propertyType)) ::GlobalNamespace::__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType  propertyType;
...
/// @brief Method .ctor, addr 0x3954c3c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _supportedProperties, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__supportedProperties, put=__cordl_internal_set__supportedProperties)) ::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty*,::Array<::GlobalNamespace::__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty*>*>  _supportedProperties;
...
/// @brief Method AutoFillRenderers, addr 0x3954a54, size 0x50, virtual false, abstract: false, final false
inline void AutoFillRenderers() ;

/// @brief Method Awake, addr 0x3953ebc, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetCachedFloatArray, addr 0x395497c, size 0xd8, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> GetCachedFloatArray(::StringW  propertyName) ;

/// @brief Method GetCachedMatrixArray, addr 0x39547cc, size 0xd8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4,::Array<::UnityEngine::Matrix4x4>*> GetCachedMatrixArray(::StringW  propertyName) ;

/// @brief Method GetCachedVectorArray, addr 0x39548a4, size 0xd8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*> GetCachedVectorArray(::StringW  propertyName) ;

/// @brief Method InitIfNeeded, addr 0x3953ec0, size 0x250, virtual false, abstract: false, final false
inline void InitIfNeeded() ;

static inline ::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer* New_ctor() ;

/// @brief Method Render, addr 0x3954144, size 0x688, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::ArrayW<float_t,::Array<float_t>*>>*> const& __cordl_internal_get__reusableFloatArrays() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::ArrayW<::UnityEngine::Matrix4x4,::Array<::UnityEngine::Matrix4x4>*>>*> const& __cordl_internal_get__reusableMatrixArrays() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>>*> const& __cordl_internal_get__reusableVectorArrays() const;

constexpr ::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty*,::Array<::GlobalNamespace::__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty*>*> const& __cordl_internal_get__supportedProperties() const;

constexpr ::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty*,::Array<::GlobalNamespace::__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty*>*>& __cordl_internal_get__supportedProperties() ;
...
constexpr void __cordl_internal_set__supportedProperties(::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty*,::Array<::GlobalNamespace::__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty*>*>  value) ;

/// @brief Method .ctor, addr 0x3954aa4, size 0x130, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _supportedProperties, offset: 0x30, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty*,::Array<::GlobalNamespace::__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty*>*>  ____supportedProperties;
