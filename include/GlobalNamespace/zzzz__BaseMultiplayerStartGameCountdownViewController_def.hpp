...
/// @brief Method DidActivate, addr 0x3b88f70, size 0x98, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3b89008, size 0x1c, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

static inline ::GlobalNamespace::BaseMultiplayerStartGameCountdownViewController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b89024, size 0x1c, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetLevelGameplaySetupData, addr 0x3b88d4c, size 0x164, virtual false, abstract: false, final false
inline void SetLevelGameplaySetupData(::GlobalNamespace::ILevelGameplaySetupData*  levelGameplaySetupData) ;

/// @brief Method SetLobbyPlayerData, addr 0x3b88eb0, size 0xc0, virtual true, abstract: false, final false
inline void SetLobbyPlayerData(::GlobalNamespace::ILobbyPlayerData*  lobbyPlayerData) ;

/// @brief Method <DidActivate>b__9_0, addr 0x3b890a0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b89040, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_playerActiveStateChangedEvent, addr 0x3b88bec, size 0xb0, virtual false, abstract: false, final false
inline void add_playerActiveStateChangedEvent(::System::Action_1<bool>*  value) ;

/// @brief Method remove_playerActiveStateChangedEvent, addr 0x3b88c9c, size 0xb0, virtual false, abstract: false, final false
