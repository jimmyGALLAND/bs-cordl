...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionGameplayInstaller::*)()>(&::GlobalNamespace::MissionGameplayInstaller::InstallBindings)> {
  constexpr static std::size_t size = 0x470;
  constexpr static std::size_t addrs = 0x3b5f5d0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionGameplayInstaller::*)()>(&::GlobalNamespace::MissionGameplayInstaller::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3b5fa40;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionGameplaySceneSetupData*> const& GlobalNamespace::MissionGameplayInstaller::__cordl_internal_get__sceneSetupData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____sceneSetupData;
}
