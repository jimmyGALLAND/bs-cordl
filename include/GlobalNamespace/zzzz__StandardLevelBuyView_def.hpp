...
/// @brief Method Awake, addr 0x3a7d1c8, size 0xe0, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::StandardLevelBuyView* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3a7d2a8, size 0x14, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method RefreshFavouriteToggle, addr 0x3a7d334, size 0x44, virtual false, abstract: false, final false
inline void RefreshFavouriteToggle() ;

/// @brief Method SetContent, addr 0x3a7d2bc, size 0x78, virtual false, abstract: false, final false
inline void SetContent(::GlobalNamespace::BeatmapLevel*  beatmapLevel) ;

/// @brief Method <Awake>b__12_0, addr 0x3a7d380, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a7d378, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFavoriteToggleChangeEvent, addr 0x3a7d060, size 0xb0, virtual false, abstract: false, final false
inline void add_didFavoriteToggleChangeEvent(::System::Action_1<::UnityW<::UnityEngine::UI::Toggle>>*  value) ;

/// @brief Method get_buyButton, addr 0x3a7d1c0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Button> get_buyButton() ;

/// @brief Method remove_didFavoriteToggleChangeEvent, addr 0x3a7d110, size 0xb0, virtual false, abstract: false, final false
