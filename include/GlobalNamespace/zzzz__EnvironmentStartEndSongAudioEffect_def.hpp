...
/// @brief Method HandleGamePauseDidPause, addr 0x3a4cc68, size 0x24, virtual false, abstract: false, final false
inline void HandleGamePauseDidPause() ;

/// @brief Method HandleGamePauseDidResume, addr 0x3a4cc44, size 0x24, virtual false, abstract: false, final false
inline void HandleGamePauseDidResume() ;

/// @brief Method HandleLevelFailed, addr 0x3a4cbb4, size 0x90, virtual false, abstract: false, final false
inline void HandleLevelFailed() ;

/// @brief Method LevelWillFinishWithinAheadTime, addr 0x3a4cb58, size 0x5c, virtual false, abstract: false, final false
inline void LevelWillFinishWithinAheadTime() ;

static inline ::GlobalNamespace::EnvironmentStartEndSongAudioEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3a4c65c, size 0x254, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3a4c1e4, size 0x478, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3a4c8b0, size 0x2a8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3a4cc8c, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
