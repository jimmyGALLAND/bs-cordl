...
/// @brief Method GetGraphicsActivatorType, addr 0x3aa16a8, size 0x90, virtual false, abstract: false, final false
inline bool GetGraphicsActivatorType() ;

static inline ::GlobalNamespace::GraphicSettingsConditionalActivator* New_ctor() ;

/// @brief Method Start, addr 0x3aa1658, size 0x50, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3aa1738, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
