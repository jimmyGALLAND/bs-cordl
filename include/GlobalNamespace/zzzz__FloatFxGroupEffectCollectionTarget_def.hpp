...
/// @brief Field _floatFxGroupEffectTargets, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__floatFxGroupEffectTargets, put=__cordl_internal_set__floatFxGroupEffectTargets)) ::ArrayW<::UnityW<::GlobalNamespace::FloatFxGroupEffectTarget>,::Array<::UnityW<::GlobalNamespace::FloatFxGroupEffectTarget>>*>  _floatFxGroupEffectTargets;

static inline ::GlobalNamespace::FloatFxGroupEffectCollectionTarget* New_ctor() ;

/// @brief Method SetValue, addr 0x3af8158, size 0x8c, virtual true, abstract: false, final false
inline void SetValue(int32_t  groupId, int32_t  elementId, float_t  value) ;

/// @brief Method TriggerValue, addr 0x3af81e4, size 0x8c, virtual true, abstract: false, final false
inline void TriggerValue(int32_t  groupId, int32_t  elementId, float_t  value) ;

constexpr ::ArrayW<::UnityW<::GlobalNamespace::FloatFxGroupEffectTarget>,::Array<::UnityW<::GlobalNamespace::FloatFxGroupEffectTarget>>*> const& __cordl_internal_get__floatFxGroupEffectTargets() const;
...
constexpr void __cordl_internal_set__floatFxGroupEffectTargets(::ArrayW<::UnityW<::GlobalNamespace::FloatFxGroupEffectTarget>,::Array<::UnityW<::GlobalNamespace::FloatFxGroupEffectTarget>>*>  value) ;

/// @brief Method .ctor, addr 0x3af8270, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
