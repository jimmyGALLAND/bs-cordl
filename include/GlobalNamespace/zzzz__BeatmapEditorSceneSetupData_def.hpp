...
/// @brief Method .ctor, addr 0x3aac6c4, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  levelDirPath, ::StringW  levelAssetPath) ;

/// @brief Method get_levelAssetPath, addr 0x3aac6bc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_levelAssetPath() ;

/// @brief Method get_levelDirPath, addr 0x3aac6b4, size 0x8, virtual false, abstract: false, final false
