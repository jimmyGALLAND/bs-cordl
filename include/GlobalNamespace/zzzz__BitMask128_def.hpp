...
/// @brief Method CreateFromSerializedData, addr 0x26d0324, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::BitMask128 CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Deserialize, addr 0x26d032c, size 0x40, virtual false, abstract: false, final false
static inline ::GlobalNamespace::BitMask128 Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Equals, addr 0x26d041c, size 0x88, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x26d03f8, size 0x24, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::BitMask128  other) ;

/// @brief Method GetBits, addr 0x26d0124, size 0xb8, virtual true, abstract: false, final true
inline uint64_t GetBits(int32_t  offset, int32_t  count) ;

/// @brief Method GetHashCode, addr 0x26d04a4, size 0x48, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Serialize, addr 0x26d02e4, size 0x40, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method SetBits, addr 0x26d00bc, size 0x68, virtual true, abstract: false, final true
inline ::GlobalNamespace::BitMask128 SetBits(int32_t  offset, uint64_t  bits) ;

/// @brief Method ToString, addr 0x26d036c, size 0x8c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x26d00ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor(uint64_t  d0, uint64_t  d1) ;

/// @brief Method .ctor, addr 0x26d00b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(uint64_t  value) ;

/// @brief Method get_bitCount, addr 0x26d0098, size 0x8, virtual true, abstract: false, final true
inline int32_t get_bitCount() ;

/// @brief Method get_maxValue, addr 0x26d00a0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_BitwiseAnd, addr 0x26d01f0, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method op_BitwiseOr, addr 0x26d01dc, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x26d0280, size 0x2c, virtual false, abstract: false, final false
static inline bool op_Equality(ByRef<::GlobalNamespace::BitMask128>  a, ByRef<::GlobalNamespace::BitMask128>  b) ;

/// @brief Method op_ExclusiveOr, addr 0x26d0204, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x26d02d8, size 0xc, virtual false, abstract: false, final false
static inline ::GlobalNamespace::BitMask128 op_Implicit___GlobalNamespace__BitMask128(uint64_t  value) ;

/// @brief Method op_Inequality, addr 0x26d02ac, size 0x2c, virtual false, abstract: false, final false
static inline bool op_Inequality(ByRef<::GlobalNamespace::BitMask128>  a, ByRef<::GlobalNamespace::BitMask128>  b) ;

/// @brief Method op_LeftShift, addr 0x26d0218, size 0x34, virtual false, abstract: false, final false
static inline ::GlobalNamespace::BitMask128 op_LeftShift(ByRef<::GlobalNamespace::BitMask128>  a, int32_t  bits) ;

/// @brief Method op_RightShift, addr 0x26d024c, size 0x34, virtual false, abstract: false, final false
