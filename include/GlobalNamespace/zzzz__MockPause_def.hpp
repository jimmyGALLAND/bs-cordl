...
/// @brief Method Pause, addr 0x3b16034, size 0x38, virtual true, abstract: false, final true
inline void Pause() ;

/// @brief Method Resume, addr 0x3b160a4, size 0x38, virtual true, abstract: false, final true
inline void Resume() ;

/// @brief Method WillResume, addr 0x3b1606c, size 0x38, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b160dc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didPauseEvent, addr 0x3b15c8c, size 0x9c, virtual true, abstract: false, final true
inline void add_didPauseEvent(::System::Action*  value) ;

/// @brief Method add_didResumeEvent, addr 0x3b15efc, size 0x9c, virtual true, abstract: false, final true
inline void add_didResumeEvent(::System::Action*  value) ;

/// @brief Method add_willResumeEvent, addr 0x3b15dc4, size 0x9c, virtual true, abstract: false, final true
inline void add_willResumeEvent(::System::Action*  value) ;

/// @brief Method get_isPaused, addr 0x3b15c84, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method remove_didPauseEvent, addr 0x3b15d28, size 0x9c, virtual true, abstract: false, final true
inline void remove_didPauseEvent(::System::Action*  value) ;

/// @brief Method remove_didResumeEvent, addr 0x3b15f98, size 0x9c, virtual true, abstract: false, final true
inline void remove_didResumeEvent(::System::Action*  value) ;

/// @brief Method remove_willResumeEvent, addr 0x3b15e60, size 0x9c, virtual true, abstract: false, final true
