...
constexpr ::GlobalNamespace::__PerformanceConfigurationChecks__AppConfig::__PerformanceConfigurationChecks__AppConfig(int32_t  targetFrameRate, ::UnityEngine::SystemLanguage  systemLanguage, bool  runInBackground, ::UnityEngine::ThreadPriority  backgroundLoadingPriority) noexcept  {
...
// Ctor Parameters [CppParam { name: "spaceWarpEnabled", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "chromatic", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "monoscopic", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "colorGamut", ty: "::GlobalNamespace::__OVRManager__ColorSpace", modifiers: "", def_value: Some("{}") }, CppParam { name: "nativeColorGamut", ty: "::GlobalNamespace::__OVRManager__ColorSpace", modifiers: "", def_value: Some("{}") }, CppParam { name: "compositionMethod", ty: "::GlobalNamespace::__OVRManager__CompositionMethod", modifiers: "", def_value: Some("{}") }, CppParam { name: "enableMixedReality", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "trackingOriginType", ty: "::GlobalNamespace::__OVRManager__TrackingOrigin", modifiers: "", def_value: Some("{}") }, CppParam { name: "usePositionTracking", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "useRotationTracking", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "sharpenType", ty: "::GlobalNamespace::__OVRPlugin__LayerSharpenType", modifiers: "", def_value: Some("{}") }, CppParam { name: "enableDynamicResolution", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "minDynamicResolutionScale", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "maxDynamicResolutionScale", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "simultaneousHandsAndControllersSupport", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "suggestedCpuPerfLevel", ty: "::GlobalNamespace::__OVRPlugin__ProcessorPerformanceLevel", modifiers: "", def_value: Some("{}") }, CppParam { name: "suggestedGpuPerfLevel", ty: "::GlobalNamespace::__OVRPlugin__ProcessorPerformanceLevel", modifiers: "", def_value: Some("{}") }, CppParam { name: "systemDisplayFrequency", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "eyeTrackedFoveatedRenderingEnabled", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "foveatedRenderingLevel", ty: "::GlobalNamespace::__OVRPlugin__FoveatedRenderingLevel", modifiers: "", def_value: Some("{}") }, CppParam { name: "useDynamicFoveatedRendering", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "gpuUtilSupported", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "gpuUtilLevel", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "eyeFovPremultipliedAlphaModeEnabled", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "asymmetricFovEnabled", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "eyeTextureArrayEnabled", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "localDimmingSupported", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "localDimming", ty: "bool", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::__PerformanceConfigurationChecks__OVRConfig::__PerformanceConfigurationChecks__OVRConfig(bool  spaceWarpEnabled, bool  chromatic, bool  monoscopic, ::GlobalNamespace::__OVRManager__ColorSpace  colorGamut, ::GlobalNamespace::__OVRManager__ColorSpace  nativeColorGamut, ::GlobalNamespace::__OVRManager__CompositionMethod  compositionMethod, bool  enableMixedReality, ::GlobalNamespace::__OVRManager__TrackingOrigin  trackingOriginType, bool  usePositionTracking, bool  useRotationTracking, ::GlobalNamespace::__OVRPlugin__LayerSharpenType  sharpenType, bool  enableDynamicResolution, float_t  minDynamicResolutionScale, float_t  maxDynamicResolutionScale, bool  simultaneousHandsAndControllersSupport, ::GlobalNamespace::__OVRPlugin__ProcessorPerformanceLevel  suggestedCpuPerfLevel, ::GlobalNamespace::__OVRPlugin__ProcessorPerformanceLevel  suggestedGpuPerfLevel, float_t  systemDisplayFrequency, bool  eyeTrackedFoveatedRenderingEnabled, ::GlobalNamespace::__OVRPlugin__FoveatedRenderingLevel  foveatedRenderingLevel, bool  useDynamicFoveatedRendering, bool  gpuUtilSupported, float_t  gpuUtilLevel, bool  eyeFovPremultipliedAlphaModeEnabled, bool  asymmetricFovEnabled, bool  eyeTextureArrayEnabled, bool  localDimmingSupported, bool  localDimming) noexcept  {
...
constexpr ::GlobalNamespace::__PerformanceConfigurationChecks__PlayerConfig::__PerformanceConfigurationChecks__PlayerConfig(bool  leftHanded, bool  automaticPlayerHeight, float_t  playerHeight, ::GlobalNamespace::NoteJumpDurationTypeSettings  noteJumpDurationTypeSettings, float_t  noteJumpFixedDuration, float_t  noteJumpStartBeatOffset, bool  autoRestart, float_t  headsetHapticIntensity, bool  arcsHapticFeedback, bool  reduceDebris, bool  noFailEffects, bool  hideNoteSpawnEffect, ::GlobalNamespace::ArcVisibilityType  arcVisibility, float_t  saberTrailIntensity, bool  noTextsAndHuds, bool  advancedHud, float_t  sfxVolume, bool  adaptiveSfx, ::GlobalNamespace::EnvironmentEffectsFilterPreset  environmentEffectsFilterDefaultPreset, ::GlobalNamespace::EnvironmentEffectsFilterPreset  environmentEffectsFilterExpertPlusPreset) noexcept  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::PerformanceConfigurationChecks::*)()>(&::GlobalNamespace::PerformanceConfigurationChecks::IsValid)> {
  ...
  constexpr static std::size_t addrs = 0x3a92fa0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::GlobalNamespace::PerformanceConfigurationChecks::*)()>(&::GlobalNamespace::PerformanceConfigurationChecks::CreateErrorLog)> {
  ...
  constexpr static std::size_t addrs = 0x3a92ffc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::PerformanceConfigurationChecks::*)(ByRef<::BeatSaber::Settings::Settings>, ::GlobalNamespace::PlayerSpecificSettings*, ::GlobalNamespace::GameplayModifierMask)>(&::GlobalNamespace::PerformanceConfigurationChecks::SetExpected)> {
  constexpr static std::size_t size = 0x4a4;
  constexpr static std::size_t addrs = 0x3a93288;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "SetExpected",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<::BeatSaber::Settings::Settings>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::PlayerSpecificSettings*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::GameplayModifierMask>::get()}
                    )));
    return ___internal_method;
  }
};
...
constexpr ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::__PerformanceConfigurationChecks__Mismatch>*& GlobalNamespace::PerformanceConfigurationChecks::__cordl_internal_get_invalid()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___invalid;
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::__PerformanceConfigurationChecks__Mismatch>*> const& GlobalNamespace::PerformanceConfigurationChecks::__cordl_internal_get_invalid() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___invalid;
}
constexpr void GlobalNamespace::PerformanceConfigurationChecks::__cordl_internal_set_invalid(::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::__PerformanceConfigurationChecks__Mismatch>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline bool GlobalNamespace::PerformanceConfigurationChecks::SetExpected(ByRef<::BeatSaber::Settings::Settings>  settings, ::GlobalNamespace::PlayerSpecificSettings*  playerSettings, ::GlobalNamespace::GameplayModifierMask  modifiers)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::PerformanceConfigurationChecks*>::get(),
                        "SetExpected",
                        std::span<const Il2CppClass* const, 0>(),
...
inline bool GlobalNamespace::PerformanceConfigurationChecks::VerifyExpected(ByRef<::BeatSaber::Settings::Settings>  settings, ::GlobalNamespace::PlayerSpecificSettings*  playerSettings, ::GlobalNamespace::GameplayModifierMask  modifiers)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::PerformanceConfigurationChecks*>::get(),
                        "VerifyExpected",
                        std::span<const Il2CppClass* const, 0>(),
