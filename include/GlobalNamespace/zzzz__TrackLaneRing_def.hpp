...
/// @brief Method FixedUpdateRing, addr 0x3b0a354, size 0x64, virtual false, abstract: false, final false
inline void FixedUpdateRing(float_t  fixedDeltaTime) ;

/// @brief Method GetDestinationRotation, addr 0x3b0a430, size 0x8, virtual false, abstract: false, final false
inline float_t GetDestinationRotation() ;

/// @brief Method GetRotation, addr 0x3b0a428, size 0x8, virtual false, abstract: false, final false
inline float_t GetRotation() ;

/// @brief Method Init, addr 0x3b0a2dc, size 0x78, virtual false, abstract: false, final false
inline void Init(::UnityEngine::Vector3  position, ::UnityEngine::Vector3  positionOffset) ;

/// @brief Method LateUpdateRing, addr 0x3b0a3b8, size 0x68, virtual false, abstract: false, final false
inline void LateUpdateRing(float_t  interpolationFactor) ;

static inline ::GlobalNamespace::TrackLaneRing* New_ctor() ;

/// @brief Method SetDestRotation, addr 0x3b0a420, size 0x8, virtual false, abstract: false, final false
inline void SetDestRotation(float_t  destRotZ, float_t  rotateSpeed) ;

/// @brief Method SetPosition, addr 0x3b0a438, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b0a440, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_destRotZ, addr 0x3b0a2d4, size 0x8, virtual false, abstract: false, final false
