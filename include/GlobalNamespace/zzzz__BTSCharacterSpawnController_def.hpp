...
/// @brief Method HandleAnimationFinished, addr 0x2221b7c, size 0x8, virtual false, abstract: false, final false
inline void HandleAnimationFinished() ;

/// @brief Method HandleGamePauseDidPause, addr 0x2221aa8, size 0x40, virtual false, abstract: false, final false
inline void HandleGamePauseDidPause() ;

/// @brief Method HandleGamePauseDidResume, addr 0x2221b2c, size 0x28, virtual false, abstract: false, final false
inline void HandleGamePauseDidResume() ;

/// @brief Method HandleGamePauseWillResume, addr 0x2221ae8, size 0x44, virtual false, abstract: false, final false
inline void HandleGamePauseWillResume() ;

/// @brief Method HandleLevelEndActionsLevelFailed, addr 0x2221b54, size 0x28, virtual false, abstract: false, final false
inline void HandleLevelEndActionsLevelFailed() ;

/// @brief Method HandleStartCharacterAnimation, addr 0x2221a00, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x2221564, size 0x3ec, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x2221140, size 0x374, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x2221b84, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isCharacterVisible, addr 0x2221120, size 0x18, virtual false, abstract: false, final false
inline bool get_isCharacterVisible() ;

/// @brief Method get_isSpawned, addr 0x2221138, size 0x8, virtual false, abstract: false, final false
