...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::LightGroupRotationZTransform::*)()>(&::GlobalNamespace::LightGroupRotationZTransform::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3afc0c0;
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::LightGroupRotationZTransform*>());
}
