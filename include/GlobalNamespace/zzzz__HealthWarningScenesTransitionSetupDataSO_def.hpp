...
public:
// Declarations
/// @brief Method Init, addr 0x3aaedc4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aaedcc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
