...
/// @brief Field materialPropertyBlockController, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_materialPropertyBlockController, put=__cordl_internal_set_materialPropertyBlockController)) ::UnityW<::GlobalNamespace::MaterialPropertyBlockController>  materialPropertyBlockController;

static inline ::GlobalNamespace::__BufferedLightColorGroupEffect__InitData* New_ctor(::GlobalNamespace::LightGroup*  lightGroup, ::GlobalNamespace::MaterialPropertyBlockController*  materialPropertyBlockController) ;
...
/// @brief Method .ctor, addr 0x3afa7cc, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Field _lightColorBeatmapEventCallbackWrappers, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightColorBeatmapEventCallbackWrappers, put=__cordl_internal_set__lightColorBeatmapEventCallbackWrappers)) ::ArrayW<::GlobalNamespace::BeatmapDataCallbackWrapper*,::Array<::GlobalNamespace::BeatmapDataCallbackWrapper*>*>  _lightColorBeatmapEventCallbackWrappers;
...
/// @brief Method Cleanup, addr 0x3afa3b8, size 0x118, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method GetColor, addr 0x3afa6d0, size 0x34, virtual true, abstract: false, final false
inline ::UnityEngine::Color GetColor(::GlobalNamespace::EnvironmentColorType  colorType, bool  colorBoost, float_t  brightness) ;

/// @brief Method HandleBeatmapCallbacksControllerDidProcessAllCallbacksThisFrame, addr 0x3afa5c8, size 0x108, virtual false, abstract: false, final false
inline void HandleBeatmapCallbacksControllerDidProcessAllCallbacksThisFrame() ;

/// @brief Method HandleColorBoostBeatmapEvent, addr 0x3afa4d0, size 0x1c, virtual false, abstract: false, final false
inline void HandleColorBoostBeatmapEvent(::GlobalNamespace::ColorBoostBeatmapEventData*  colorBoost) ;

/// @brief Method HandleColorChangeBeatmapEvent, addr 0x3afa4ec, size 0xdc, virtual false, abstract: false, final false
inline void HandleColorChangeBeatmapEvent(::GlobalNamespace::LightColorBeatmapEventData*  currentEvent) ;

static inline ::GlobalNamespace::BufferedLightColorGroupEffect* New_ctor(::GlobalNamespace::__BufferedLightColorGroupEffect__InitData*  initData, ::GlobalNamespace::ColorManager*  colorManager, ::GlobalNamespace::BeatmapCallbacksController*  beatmapCallbacksController) ;
...
constexpr ::ArrayW<::GlobalNamespace::BeatmapDataCallbackWrapper*,::Array<::GlobalNamespace::BeatmapDataCallbackWrapper*>*> const& __cordl_internal_get__lightColorBeatmapEventCallbackWrappers() const;
...
/// @brief Method .ctor, addr 0x3afa07c, size 0x33c, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::__BufferedLightColorGroupEffect__InitData*  initData, ::GlobalNamespace::ColorManager*  colorManager, ::GlobalNamespace::BeatmapCallbacksController*  beatmapCallbacksController) ;
