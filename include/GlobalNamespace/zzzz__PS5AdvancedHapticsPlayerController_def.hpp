...
/// @brief Method <PlayContinuousHapticPreset>b__0, addr 0x3949298, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39491b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <PlayOneShotHapticPreset>b__0, addr 0x3949344, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39491bc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _activePlayers, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__activePlayers, put=__cordl_internal_set__activePlayers)) ::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::UnityEngine::XR::XRNode,::UnityW<::Libraries::HM::HMLib::VR::HapticPresetSO>>,::UnityW<::GlobalNamespace::HapticsAudioClipPlayer>>*  _activePlayers;
...
/// @brief Method CanPlayHapticPreset, addr 0x39490bc, size 0x14, virtual true, abstract: false, final true
inline bool CanPlayHapticPreset(::Libraries::HM::HMLib::VR::HapticPresetSO*  hapticPreset, ::UnityEngine::XR::XRNode  node) ;

/// @brief Method Initialize, addr 0x3948cf0, size 0x4, virtual true, abstract: false, final true
inline void Initialize() ;

static inline ::GlobalNamespace::PS5AdvancedHapticsPlayerController* New_ctor() ;

/// @brief Method OnHapticPlayFinishedCallback, addr 0x39491c4, size 0x58, virtual false, abstract: false, final false
inline void OnHapticPlayFinishedCallback(::GlobalNamespace::HapticsAudioClipPlayer*  player) ;

/// @brief Method PlayContinuousHapticPreset, addr 0x3948ee8, size 0x1d4, virtual false, abstract: false, final false
inline void PlayContinuousHapticPreset(::UnityEngine::XR::XRNode  node, ::Libraries::HM::HMLib::VR::HapticPresetSO*  hapticPreset) ;

/// @brief Method PlayHapticFeedback, addr 0x3948cf4, size 0x24, virtual true, abstract: false, final true
inline void PlayHapticFeedback(::UnityEngine::XR::XRNode  node, ::Libraries::HM::HMLib::VR::HapticPresetSO*  hapticPreset) ;

/// @brief Method PlayOneShotHapticPreset, addr 0x3948d18, size 0x1d0, virtual false, abstract: false, final false
inline void PlayOneShotHapticPreset(::UnityEngine::XR::XRNode  node, ::Libraries::HM::HMLib::VR::HapticPresetSO*  hapticPreset) ;

constexpr ::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::UnityEngine::XR::XRNode,::UnityW<::Libraries::HM::HMLib::VR::HapticPresetSO>>,::UnityW<::GlobalNamespace::HapticsAudioClipPlayer>>*& __cordl_internal_get__activePlayers() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::UnityEngine::XR::XRNode,::UnityW<::Libraries::HM::HMLib::VR::HapticPresetSO>>,::UnityW<::GlobalNamespace::HapticsAudioClipPlayer>>*> const& __cordl_internal_get__activePlayers() const;
...
constexpr void __cordl_internal_set__activePlayers(::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::UnityEngine::XR::XRNode,::UnityW<::Libraries::HM::HMLib::VR::HapticPresetSO>>,::UnityW<::GlobalNamespace::HapticsAudioClipPlayer>>*  value) ;
...
/// @brief Method .ctor, addr 0x394921c, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _activePlayers, offset: 0x20, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::UnityEngine::XR::XRNode,::UnityW<::Libraries::HM::HMLib::VR::HapticPresetSO>>,::UnityW<::GlobalNamespace::HapticsAudioClipPlayer>>*  ____activePlayers;
