...
/// @brief Method InstallBindings, addr 0x3aaad78, size 0xe64, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aabca8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_colorScheme, addr 0x3aaad68, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::ColorSchemeSO> get_colorScheme() ;

/// @brief Method set_colorScheme, addr 0x3aaad70, size 0x8, virtual false, abstract: false, final false
