...
/// @brief Field _didChangeEvent, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get__didChangeEvent, put=__cordl_internal_set__didChangeEvent)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ICutScoreBufferDidChangeReceiver*>*  _didChangeEvent;

/// @brief Field _didFinishEvent, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get__didFinishEvent, put=__cordl_internal_set__didFinishEvent)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ICutScoreBufferDidFinishReceiver*>*  _didFinishEvent;
...
/// @brief Method HandleSaberSwingRatingCounterDidChange, addr 0x3b56dd0, size 0x1d4, virtual true, abstract: false, final true
...
/// @brief Method HandleSaberSwingRatingCounterDidFinish, addr 0x3b56fa4, size 0x2b8, virtual true, abstract: false, final true
inline void HandleSaberSwingRatingCounterDidFinish(::GlobalNamespace::ISaberSwingRatingCounter*  swingRatingCounter) ;

/// @brief Method Init, addr 0x3b56978, size 0x260, virtual false, abstract: false, final false
inline bool Init(ByRef<::GlobalNamespace::NoteCutInfo>  noteCutInfo) ;

static inline ::GlobalNamespace::CutScoreBuffer* New_ctor() ;

/// @brief Method RefreshScores, addr 0x3b56bd8, size 0x1f8, virtual false, abstract: false, final false
inline void RefreshScores() ;

/// @brief Method RegisterDidChangeReceiver, addr 0x3b56818, size 0x58, virtual true, abstract: false, final true
inline void RegisterDidChangeReceiver(::GlobalNamespace::ICutScoreBufferDidChangeReceiver*  receiver) ;

/// @brief Method RegisterDidFinishReceiver, addr 0x3b56870, size 0x58, virtual true, abstract: false, final true
inline void RegisterDidFinishReceiver(::GlobalNamespace::ICutScoreBufferDidFinishReceiver*  receiver) ;

/// @brief Method UnregisterDidChangeReceiver, addr 0x3b568c8, size 0x58, virtual true, abstract: false, final true
inline void UnregisterDidChangeReceiver(::GlobalNamespace::ICutScoreBufferDidChangeReceiver*  receiver) ;

/// @brief Method UnregisterDidFinishReceiver, addr 0x3b56920, size 0x58, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b5725c, size 0xf0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_afterCutScore, addr 0x3b567c0, size 0x8, virtual true, abstract: false, final true
inline int32_t get_afterCutScore() ;

/// @brief Method get_afterCutSwingRating, addr 0x3b567fc, size 0x1c, virtual true, abstract: false, final true
inline float_t get_afterCutSwingRating() ;

/// @brief Method get_beforeCutScore, addr 0x3b567b0, size 0x8, virtual true, abstract: false, final true
inline int32_t get_beforeCutScore() ;

/// @brief Method get_beforeCutSwingRating, addr 0x3b567e0, size 0x1c, virtual true, abstract: false, final true
inline float_t get_beforeCutSwingRating() ;

/// @brief Method get_centerDistanceCutScore, addr 0x3b567b8, size 0x8, virtual true, abstract: false, final true
inline int32_t get_centerDistanceCutScore() ;

/// @brief Method get_cutScore, addr 0x3b56780, size 0x30, virtual true, abstract: false, final true
inline int32_t get_cutScore() ;

/// @brief Method get_executionOrder, addr 0x3b56740, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_executionOrder() ;

/// @brief Method get_isFinished, addr 0x3b56778, size 0x8, virtual true, abstract: false, final true
inline bool get_isFinished() ;

/// @brief Method get_maxPossibleCutScore, addr 0x3b5675c, size 0x1c, virtual true, abstract: false, final true
inline int32_t get_maxPossibleCutScore() ;

/// @brief Method get_noteCutInfo, addr 0x3b567d0, size 0x10, virtual true, abstract: false, final true
inline ::GlobalNamespace::NoteCutInfo get_noteCutInfo() ;

/// @brief Method get_noteScoreDefinition, addr 0x3b567c8, size 0x8, virtual true, abstract: false, final true
