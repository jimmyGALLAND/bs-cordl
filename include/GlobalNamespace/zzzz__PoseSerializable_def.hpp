...
/// @brief Method Deserialize, addr 0x26d7b5c, size 0x28, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Equals, addr 0x26d7bf0, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x26d7b84, size 0x6c, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::PoseSerializable  other) ;

/// @brief Method GetHashCode, addr 0x26d7c80, size 0x6c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetSize, addr 0x26d7db8, size 0x2c, virtual false, abstract: false, final false
inline int32_t GetSize() ;

/// @brief Method Serialize, addr 0x26d7b34, size 0x28, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method ToString, addr 0x26d7cec, size 0xcc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x26d7afc, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::Vector3Serializable  position, ::GlobalNamespace::QuaternionSerializable  rotation) ;

/// @brief Method get_identity, addr 0x26d7b10, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method op_Addition, addr 0x26d7ef8, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x26d7e7c, size 0x7c, virtual false, abstract: false, final false
static inline ::GlobalNamespace::PoseSerializable op_Implicit___GlobalNamespace__PoseSerializable(::UnityEngine::Pose  p) ;

/// @brief Method op_Implicit, addr 0x26d7de4, size 0x98, virtual false, abstract: false, final false
static inline ::UnityEngine::Pose op_Implicit___UnityEngine__Pose(::GlobalNamespace::PoseSerializable  p) ;

/// @brief Method op_Subtraction, addr 0x26d7f5c, size 0x64, virtual false, abstract: false, final false
