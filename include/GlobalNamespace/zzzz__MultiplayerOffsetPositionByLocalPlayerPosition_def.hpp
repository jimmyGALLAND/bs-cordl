...
/// @brief Method Awake, addr 0x3b44a48, size 0x50, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::MultiplayerOffsetPositionByLocalPlayerPosition* New_ctor() ;

/// @brief Method SetEnabled, addr 0x3b3f848, size 0xc, virtual false, abstract: false, final false
inline void SetEnabled(bool  isEnabled) ;

/// @brief Method Update, addr 0x3b44a98, size 0x4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdatePositionAndRotationIfNeeded, addr 0x3b44a9c, size 0x208, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b44d24, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
