...
/// @brief Method GetScoreForNote, addr 0x3b30adc, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b30ab4, size 0x28, virtual false, abstract: false, final false
