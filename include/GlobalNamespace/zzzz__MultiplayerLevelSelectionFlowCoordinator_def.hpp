...
/// @brief Field didSelectLevelEvent, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didSelectLevelEvent, put=__cordl_internal_set_didSelectLevelEvent)) ::System::Action_1<::GlobalNamespace::__LevelSelectionFlowCoordinator__State*>*  didSelectLevelEvent;
...
/// @brief Method ActionButtonWasPressed, addr 0x3ac3ec4, size 0x114, virtual true, abstract: false, final false
inline void ActionButtonWasPressed() ;

/// @brief Method BackButtonWasPressed, addr 0x3ac3fd8, size 0x5c, virtual true, abstract: false, final false
inline void BackButtonWasPressed(::HMUI::ViewController*  topViewController) ;

/// @brief Method DismissViewControllersAndFinish, addr 0x3ac45b4, size 0x70, virtual false, abstract: false, final false
inline void DismissViewControllersAndFinish() ;

/// @brief Method HandleLobbyGameStateControllerGameStarted, addr 0x3ac4624, size 0x4, virtual false, abstract: false, final false
inline void HandleLobbyGameStateControllerGameStarted(::GlobalNamespace::ILevelGameplaySetupData*  levelGameplaySetupData) ;

/// @brief Method HandleLobbyGameStateControllerLobbyDisconnected, addr 0x3ac4628, size 0x4, virtual false, abstract: false, final false
inline void HandleLobbyGameStateControllerLobbyDisconnected() ;

/// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange, addr 0x3ac4034, size 0xec, virtual true, abstract: false, final false
...
/// @brief Method Setup, addr 0x3abcfe8, size 0x24, virtual false, abstract: false, final false
inline void Setup(::GlobalNamespace::__LevelSelectionFlowCoordinator__State*  state, ::GlobalNamespace::SongPackMask  songPackMask, ::GlobalNamespace::BeatmapDifficultyMask  allowedBeatmapDifficultyMask, ::StringW  actionText, ::StringW  titleText) ;

/// @brief Method TransitionDidFinish, addr 0x3ac42f0, size 0x2c4, virtual true, abstract: false, final false
inline void TransitionDidFinish() ;

/// @brief Method TransitionDidStart, addr 0x3ac4120, size 0x1d0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ac462c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishedEvent, addr 0x3aba008, size 0x9c, virtual false, abstract: false, final false
inline void add_didFinishedEvent(::System::Action*  value) ;

/// @brief Method add_didSelectLevelEvent, addr 0x3ab9f58, size 0xb0, virtual false, abstract: false, final false
inline void add_didSelectLevelEvent(::System::Action_1<::GlobalNamespace::__LevelSelectionFlowCoordinator__State*>*  value) ;

/// @brief Method get_actionButtonText, addr 0x3ac3e84, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_actionButtonText() ;

/// @brief Method get_allowedBeatmapDifficultyMask, addr 0x3ac3eac, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapDifficultyMask get_allowedBeatmapDifficultyMask() ;

/// @brief Method get_enableCustomLevels, addr 0x3ac3ea4, size 0x8, virtual true, abstract: false, final false
inline bool get_enableCustomLevels() ;

/// @brief Method get_hidePacksIfOneOrNone, addr 0x3ac3e7c, size 0x8, virtual true, abstract: false, final false
inline bool get_hidePacksIfOneOrNone() ;

/// @brief Method get_hidePracticeButton, addr 0x3ac3e74, size 0x8, virtual true, abstract: false, final false
inline bool get_hidePracticeButton() ;

/// @brief Method get_mainTitle, addr 0x3ac3ebc, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_mainTitle() ;

/// @brief Method get_notAllowedCharacteristics, addr 0x3ac3eb4, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method get_showBackButtonForMainViewController, addr 0x3ac3e8c, size 0x8, virtual true, abstract: false, final false
inline bool get_showBackButtonForMainViewController() ;

/// @brief Method get_songPackMask, addr 0x3ac3e94, size 0x10, virtual true, abstract: false, final false
inline ::GlobalNamespace::SongPackMask get_songPackMask() ;

/// @brief Method remove_didFinishedEvent, addr 0x3abb628, size 0x9c, virtual false, abstract: false, final false
inline void remove_didFinishedEvent(::System::Action*  value) ;

/// @brief Method remove_didSelectLevelEvent, addr 0x3abb578, size 0xb0, virtual false, abstract: false, final false
