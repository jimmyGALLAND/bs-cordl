...
/// @brief Method .ctor, addr 0x267f770, size 0x30, virtual false, abstract: false, final false
inline void _ctor(uint32_t  sonyLeaderboardId, ::StringW  difficultyBeatmapId) ;

/// @brief Method get_difficultyBeatmapId, addr 0x267f760, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_difficultyBeatmapId() ;

/// @brief Method get_sonyLeaderboardId, addr 0x267f768, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _leaderboardIds, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__leaderboardIds, put=__cordl_internal_set__leaderboardIds)) ::System::Collections::Generic::List_1<::GlobalNamespace::__SonyLeaderboardIdsSO__LeaderboardIdData*>*  _leaderboardIds;
...
/// @brief Method ILeaderboardIdContainer.get_leaderboardIds, addr 0x267f678, size 0x8, virtual true, abstract: false, final true
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__SonyLeaderboardIdsSO__LeaderboardIdData*>*> const& __cordl_internal_get__leaderboardIds() const;
...
/// @brief Method .ctor, addr 0x267f6e4, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_leaderboardIds, addr 0x267f680, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_leaderboardIds, addr 0x267f688, size 0x5c, virtual false, abstract: false, final false
