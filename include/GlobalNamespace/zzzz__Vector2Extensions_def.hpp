...
public:
// Declarations
/// @brief Method Clamp, addr 0x2269ff8, size 0x24, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 Clamp(::UnityEngine::Vector2  value, ::UnityEngine::Vector2  min, ::UnityEngine::Vector2  max) ;

/// @brief Method Clamp, addr 0x226a01c, size 0x2c, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 Clamp(::UnityEngine::Vector2  value, ::UnityEngine::Rect  within) ;

/// @brief Method SignedAngleToLine, addr 0x2269e44, size 0x1b4, virtual false, abstract: false, final false
