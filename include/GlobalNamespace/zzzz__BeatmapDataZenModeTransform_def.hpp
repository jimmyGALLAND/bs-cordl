...
public:
// Declarations
/// @brief Method CreateTransformedData, addr 0x26606a8, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method <CreateTransformedData>g__ProcessData|0_0, addr 0x26607a4, size 0xb0, virtual false, abstract: false, final false
