...
/// @brief Method <EndGameplay>b__50_0, addr 0x3b3a9c4, size 0x20, virtual false, abstract: false, final false
inline bool _EndGameplay_b__50_0(::GlobalNamespace::MultiplayerLevelCompletionResults*  result) ;

/// @brief Method .ctor, addr 0x3b3a9bc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <HandleSongStartSyncControllerSyncStartSuccess>b__0, addr 0x3b3a9e4, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b39934, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x3b3aa08, size 0x838, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::GlobalNamespace::__MultiplayerController___PerformSongStartSync_d__39* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3b3b240, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x3b3b248, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3b3b280, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x3b3aa04, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b39048, size 0x28, virtual false, abstract: false, final false
...
/// @brief Field _introAnimationController, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__introAnimationController, put=__cordl_internal_set__introAnimationController)) ::UnityW<::GlobalNamespace::MultiplayerIntroAnimationController>  _introAnimationController;
...
/// @brief Field _localPlayerSyncStartState, offset 0xac, size 0x4 
 __declspec(property(get=__cordl_internal_get__localPlayerSyncStartState, put=__cordl_internal_set__localPlayerSyncStartState)) ::GlobalNamespace::MultiplayerPlayerStartState  _localPlayerSyncStartState;
...
/// @brief Field _multiplayerLevelFinishedController, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerLevelFinishedController, put=__cordl_internal_set__multiplayerLevelFinishedController)) ::UnityW<::GlobalNamespace::MultiplayerLevelFinishedController>  _multiplayerLevelFinishedController;

/// @brief Field _multiplayerLevelSceneSetupData, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerLevelSceneSetupData, put=__cordl_internal_set__multiplayerLevelSceneSetupData)) ::UnityW<::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO>  _multiplayerLevelSceneSetupData;
...
/// @brief Field _outroAnimationController, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__outroAnimationController, put=__cordl_internal_set__outroAnimationController)) ::UnityW<::GlobalNamespace::MultiplayerOutroAnimationController>  _outroAnimationController;
...
/// @brief Field _playersSpecificSettingsAtGameStartModel, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get__playersSpecificSettingsAtGameStartModel, put=__cordl_internal_set__playersSpecificSettingsAtGameStartModel)) ::GlobalNamespace::PlayersSpecificSettingsAtGameStartModel*  _playersSpecificSettingsAtGameStartModel;
...
/// @brief Field _sceneStartSyncController, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__sceneStartSyncController, put=__cordl_internal_set__sceneStartSyncController)) ::UnityW<::GlobalNamespace::SceneStartSyncController>  _sceneStartSyncController;
...
/// @brief Field _songStartSyncController, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__songStartSyncController, put=__cordl_internal_set__songStartSyncController)) ::UnityW<::GlobalNamespace::SongStartSyncController>  _songStartSyncController;
...
/// @brief Field stateChangedEvent, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get_stateChangedEvent, put=__cordl_internal_set_stateChangedEvent)) ::System::Action_1<::GlobalNamespace::__MultiplayerController__State>*  stateChangedEvent;

/// @brief Method ChangeState, addr 0x3b38634, size 0x20, virtual false, abstract: false, final false
inline void ChangeState(::GlobalNamespace::__MultiplayerController__State  newState) ;

/// @brief Method CreateAndBindPlayersSpecificSettingsAtGameStartModel, addr 0x3b38210, size 0x424, virtual false, abstract: false, final false
inline void CreateAndBindPlayersSpecificSettingsAtGameStartModel() ;

/// @brief Method EndGameplay, addr 0x3b39460, size 0x26c, virtual false, abstract: false, final false
inline void EndGameplay(::GlobalNamespace::MultiplayerLevelCompletionResults*  localPlayerResults, ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::MultiplayerLevelCompletionResults*>*  otherPlayerResults) ;

/// @brief Method GetCurrentSongTime, addr 0x3b3920c, size 0xc0, virtual false, abstract: false, final false
inline float_t GetCurrentSongTime(int64_t  songStartSyncTime) ;

/// @brief Method GetSongStartSyncTime, addr 0x3b391e0, size 0x2c, virtual false, abstract: false, final false
inline int64_t GetSongStartSyncTime(int64_t  introAnimationStartSyncTime) ;

/// @brief Method HandleAllResultsCollected, addr 0x3b3a73c, size 0x4, virtual false, abstract: false, final false
inline void HandleAllResultsCollected(::GlobalNamespace::MultiplayerLevelCompletionResults*  localPlayerResults, ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::MultiplayerLevelCompletionResults*>*  otherPlayerResults) ;

/// @brief Method HandleDidSwitchPlayerToInactive, addr 0x3b39070, size 0x170, virtual false, abstract: false, final false
inline void HandleDidSwitchPlayerToInactive() ;

/// @brief Method HandleDisconnected, addr 0x3b38c2c, size 0x54, virtual false, abstract: false, final false
inline void HandleDisconnected(::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method HandleInitialGetGameStateFailed, addr 0x3b3931c, size 0xb8, virtual false, abstract: false, final false
inline void HandleInitialGetGameStateFailed() ;

/// @brief Method HandleIsDisconnectedDuringLoading, addr 0x3b38c24, size 0x8, virtual false, abstract: false, final false
inline void HandleIsDisconnectedDuringLoading() ;

/// @brief Method HandleOutroAnimationDidFinish, addr 0x3b3a740, size 0x48, virtual false, abstract: false, final false
inline void HandleOutroAnimationDidFinish() ;

/// @brief Method HandleRpcReturnToMenu, addr 0x3b3a788, size 0x180, virtual false, abstract: false, final false
inline void HandleRpcReturnToMenu(::StringW  userId) ;

/// @brief Method HandleSceneStartSyncControllerSyncStartDidFail, addr 0x3b393d4, size 0x8c, virtual false, abstract: false, final false
inline void HandleSceneStartSyncControllerSyncStartDidFail() ;

/// @brief Method HandleSceneStartSyncControllerSyncStartDidReceiveTooLate, addr 0x3b392f4, size 0x28, virtual false, abstract: false, final false
inline void HandleSceneStartSyncControllerSyncStartDidReceiveTooLate(::StringW  sessionGameId) ;

/// @brief Method HandleSceneStartSyncControllerSyncStartDidSuccess, addr 0x3b392cc, size 0x28, virtual false, abstract: false, final false
inline void HandleSceneStartSyncControllerSyncStartDidSuccess(::StringW  sessionGameId) ;

/// @brief Method HandleSetMultiplayerGameState, addr 0x3b38c80, size 0x1ec, virtual false, abstract: false, final false
inline void HandleSetMultiplayerGameState(::StringW  userId, ::GlobalNamespace::MultiplayerGameState  gameState) ;

/// @brief Method HandleSongStartSyncControllerSyncResume, addr 0x3b3a1c8, size 0x4e8, virtual false, abstract: false, final false
inline void HandleSongStartSyncControllerSyncResume(int64_t  introAnimationStartSyncTime) ;

/// @brief Method HandleSongStartSyncControllerSyncStartFailed, addr 0x3b3a6b0, size 0x8c, virtual false, abstract: false, final false
inline void HandleSongStartSyncControllerSyncStartFailed() ;

/// @brief Method HandleSongStartSyncControllerSyncStartSuccess, addr 0x3b396cc, size 0x268, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b38654, size 0x5d0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method PerformSongStartSync, addr 0x3b38fd8, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x3b37dd0, size 0x440, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartGameplay, addr 0x3b3993c, size 0x88c, virtual false, abstract: false, final false
inline void StartGameplay(int64_t  introAnimationStartSyncTime) ;

/// @brief Method StartSceneLoadSync, addr 0x3b38e6c, size 0x16c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b3a908, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_stateChangedEvent, addr 0x3b2fbb0, size 0xb0, virtual false, abstract: false, final false
inline void add_stateChangedEvent(::System::Action_1<::GlobalNamespace::__MultiplayerController__State>*  value) ;

/// @brief Method get_state, addr 0x3b37dc8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__MultiplayerController__State get_state() ;

/// @brief Method remove_stateChangedEvent, addr 0x3b2fd28, size 0xb0, virtual false, abstract: false, final false
