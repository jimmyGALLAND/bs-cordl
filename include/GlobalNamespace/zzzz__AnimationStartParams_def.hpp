...
/// @brief Method Start, addr 0x393fd34, size 0x2d8, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x394000c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
