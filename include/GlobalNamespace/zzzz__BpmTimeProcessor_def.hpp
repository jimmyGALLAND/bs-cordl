...
public:
// Declarations
/// @brief Method .ctor, addr 0x266b88c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method <.ctor>b__3_0, addr 0x266c090, size 0x20, virtual false, abstract: false, final false
inline bool __ctor_b__3_0(::BeatmapSaveDataVersion2_6_0AndEarlier::EventData*  e) ;

/// @brief Method .ctor, addr 0x266c088, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _bpmChangeDataList, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__bpmChangeDataList, put=__cordl_internal_set__bpmChangeDataList)) ::System::Collections::Generic::List_1<::GlobalNamespace::__BpmTimeProcessor__BpmChangeData>*  _bpmChangeDataList;
...
/// @brief Method CalculateTime, addr 0x266b898, size 0x1c, virtual false, abstract: false, final false
static inline float_t CalculateTime(::GlobalNamespace::__BpmTimeProcessor__BpmChangeData  prevBpmChangeData, float_t  beat) ;

/// @brief Method ConvertBeatToTime, addr 0x266bf1c, size 0x108, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x266c024, size 0x8, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x266bda0, size 0x17c, virtual false, abstract: false, final false
inline void _ctor(::BeatmapLevelSaveDataVersion4::AudioSaveData*  audioSaveData) ;

/// @brief Method .ctor, addr 0x266b8b4, size 0x4ec, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x266b510, size 0x37c, virtual false, abstract: false, final false
