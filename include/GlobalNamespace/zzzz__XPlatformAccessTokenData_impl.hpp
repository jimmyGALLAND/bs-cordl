...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::XPlatformAccessTokenData::*)(::StringW, ::GlobalNamespace::PlatformEnvironment)>(&::GlobalNamespace::XPlatformAccessTokenData::_ctor)> {
...
::cordl_internals::setStaticField<::GlobalNamespace::XPlatformAccessTokenData, "invalid", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::XPlatformAccessTokenData>::get>(std::forward<::GlobalNamespace::XPlatformAccessTokenData>(value));
}
inline ::GlobalNamespace::XPlatformAccessTokenData GlobalNamespace::XPlatformAccessTokenData::getStaticF_invalid()  {
return ::cordl_internals::getStaticField<::GlobalNamespace::XPlatformAccessTokenData, "invalid", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::XPlatformAccessTokenData>::get>();
}
...
// Ctor Parameters [CppParam { name: "token", ty: "::StringW", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "platformEnvironment", ty: "::GlobalNamespace::PlatformEnvironment", modifiers: "", def_value: Some("{}") }]
