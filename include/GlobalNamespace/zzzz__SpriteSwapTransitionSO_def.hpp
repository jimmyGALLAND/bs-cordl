...
/// @brief Method .ctor, addr 0x44479b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disabledSprite, addr 0x444799c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_disabledSprite() ;

/// @brief Method get_highlightedSprite, addr 0x444798c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_highlightedSprite() ;

/// @brief Method get_normalSprite, addr 0x4447984, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_normalSprite() ;

/// @brief Method get_pressedSprite, addr 0x4447994, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_pressedSprite() ;

/// @brief Method get_selectedAndHighlightedSprite, addr 0x44479ac, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_selectedAndHighlightedSprite() ;

/// @brief Method get_selectedSprite, addr 0x44479a4, size 0x8, virtual false, abstract: false, final false
