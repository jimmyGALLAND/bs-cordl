...
/// @brief Method CopyFrom, addr 0x3ff7048, size 0x40, virtual false, abstract: false, final false
inline void CopyFrom(::GlobalNamespace::TrailElement*  other) ;

static inline ::GlobalNamespace::TrailElement* New_ctor() ;

/// @brief Method SetData, addr 0x3ff7008, size 0x40, virtual false, abstract: false, final false
inline void SetData(::UnityEngine::Vector3  start, ::UnityEngine::Vector3  end, float_t  time) ;

/// @brief Method SetDistance, addr 0x3ff7088, size 0x8, virtual false, abstract: false, final false
inline void SetDistance(float_t  value) ;

/// @brief Method UpdateLocalDistance, addr 0x3ff7090, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ff7138, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
