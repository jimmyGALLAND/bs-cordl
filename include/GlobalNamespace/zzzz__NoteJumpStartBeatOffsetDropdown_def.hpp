...
public:
// Declarations
/// @brief Method GetNamedValues, addr 0x3b7d7d8, size 0x198, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b7d970, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
