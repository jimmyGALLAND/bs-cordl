...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::WaitUntil* (::GlobalNamespace::IStartSeekSongController::*)()>(&::GlobalNamespace::IStartSeekSongController::get_waitUntilIsReadyToStartTheSong)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::IStartSeekSongController::*)(float_t)>(&::GlobalNamespace::IStartSeekSongController::StartSong)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::IStartSeekSongController::*)(float_t)>(&::GlobalNamespace::IStartSeekSongController::SeekTo)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
