...
/// @brief Method MoveNext, addr 0x3b6e6a4, size 0x494, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3b6eb38, size 0xc, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x3b6eb44, size 0x2a4, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3b6eee4, size 0xc, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Field didFinishEvent, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_didFinishEvent, put=__cordl_internal_set_didFinishEvent)) ::System::Action_2<::UnityW<::HMUI::FlowCoordinator>,::GlobalNamespace::__EditAvatarFlowCoordinatorHelper__FinishAction>*  didFinishEvent;

/// @brief Method HandleAvatarEditorFlowCoordinatorDidFinish, addr 0x3b6e580, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method HandleAvatarSystemSelectionFlowCoordinatorDidFinish, addr 0x3b6e654, size 0x48, virtual false, abstract: false, final false
inline void HandleAvatarSystemSelectionFlowCoordinatorDidFinish(::GlobalNamespace::AvatarSystemSelectionFlowCoordinator*  flowCoordinator, ::GlobalNamespace::__AvatarSystemSelectionFlowCoordinator__FinishAction  finishAction) ;

/// @brief Method Initialize, addr 0x3b6e40c, size 0x8c, virtual false, abstract: false, final false
inline void Initialize() ;

static inline ::GlobalNamespace::EditAvatarFlowCoordinatorHelper* New_ctor() ;

/// @brief Method PresentAvatarEditorFlowCoordinator, addr 0x3b6e498, size 0xe8, virtual false, abstract: false, final false
inline void PresentAvatarEditorFlowCoordinator(::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator*  flowCoordinator, ::BeatSaber::AvatarCore::__AvatarEditorFlowCoordinator__EditMode  editMode, ::HMUI::FlowCoordinator*  parentFlowCoordinator, bool  immediately, bool  replaceTopViewController) ;

/// @brief Method Show, addr 0x3b6e344, size 0xc8, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::HMUI::FlowCoordinator>,::GlobalNamespace::__EditAvatarFlowCoordinatorHelper__FinishAction>*> const& __cordl_internal_get_didFinishEvent() const;
...
/// @brief Method .ctor, addr 0x3b6e69c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get__hasOnlyOneAvatarSystem, addr 0x3b6e2e4, size 0x60, virtual false, abstract: false, final false
