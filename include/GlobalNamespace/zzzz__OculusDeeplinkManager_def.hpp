...
/// @brief Method Init, addr 0x266128c, size 0x80, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method IsAtLeastOneFieldPopulated, addr 0x2661648, size 0x74, virtual false, abstract: false, final false
inline bool IsAtLeastOneFieldPopulated(::GlobalNamespace::Deeplink*  deeplink) ;

/// @brief Method Log, addr 0x26613d0, size 0x58, virtual false, abstract: false, final false
static inline void Log(::StringW  message) ;

static inline ::GlobalNamespace::OculusDeeplinkManager* New_ctor() ;

/// @brief Method OculusPlatformWasInitialized, addr 0x266130c, size 0x18, virtual false, abstract: false, final false
inline void OculusPlatformWasInitialized() ;

/// @brief Method SetJoinIntentReceivedNotificationCallback, addr 0x2661324, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method UpdateDeeplinkMessage, addr 0x2661428, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26616bc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didReceiveDeeplinkEvent, addr 0x2661124, size 0xb0, virtual true, abstract: false, final true
inline void add_didReceiveDeeplinkEvent(::System::Action_1<::GlobalNamespace::Deeplink*>*  value) ;

/// @brief Method get_currentDeeplink, addr 0x2661284, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method remove_didReceiveDeeplinkEvent, addr 0x26611d4, size 0xb0, virtual true, abstract: false, final true
