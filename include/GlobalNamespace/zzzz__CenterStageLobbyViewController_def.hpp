...
/// @brief Method SetLevelGameplaySetupData, addr 0x3b890c4, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b89228, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
