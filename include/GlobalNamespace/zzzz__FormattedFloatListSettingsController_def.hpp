...
/// @brief Field valueDidChangeEvent, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_valueDidChangeEvent, put=__cordl_internal_set_valueDidChangeEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::FormattedFloatListSettingsController>,float_t>*  valueDidChangeEvent;
...
/// @brief Method ApplyValue, addr 0x3b7c848, size 0x58, virtual true, abstract: false, final false
inline void ApplyValue(int32_t  idx) ;

/// @brief Method GetInitValues, addr 0x3b7c6fc, size 0x14c, virtual true, abstract: false, final false
inline bool GetInitValues(ByRef<int32_t>  idx, ByRef<int32_t>  numberOfElements) ;

static inline ::GlobalNamespace::FormattedFloatListSettingsController* New_ctor() ;

/// @brief Method SetValue, addr 0x3b7c6e4, size 0x18, virtual false, abstract: false, final false
inline void SetValue(float_t  value, bool  callCallback) ;

/// @brief Method TextForValue, addr 0x3b7c8a0, size 0xdc, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::FormattedFloatListSettingsController>,float_t>*> const& __cordl_internal_get_valueDidChangeEvent() const;
...
/// @brief Method .ctor, addr 0x3b7c97c, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_valueDidChangeEvent, addr 0x3b7c564, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_value, addr 0x3b7c6c4, size 0x8, virtual false, abstract: false, final false
inline float_t get_value() ;

/// @brief Method get_values, addr 0x3b7c6cc, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> get_values() ;

/// @brief Method remove_valueDidChangeEvent, addr 0x3b7c614, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method set_values, addr 0x3b7c6d4, size 0x10, virtual false, abstract: false, final false
