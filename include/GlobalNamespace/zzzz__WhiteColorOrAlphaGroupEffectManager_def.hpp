...
/// @brief Field _lightGroup, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightGroup, put=__cordl_internal_set__lightGroup)) ::ArrayW<::UnityW<::GlobalNamespace::LightGroup>,::Array<::UnityW<::GlobalNamespace::LightGroup>>*>  _lightGroup;

/// @brief Field _whiteColorOrAlphaEffects, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__whiteColorOrAlphaEffects, put=__cordl_internal_set__whiteColorOrAlphaEffects)) ::System::Collections::Generic::List_1<::GlobalNamespace::WhiteColorOrAlphaGroupEffect*>*  _whiteColorOrAlphaEffects;

static inline ::GlobalNamespace::WhiteColorOrAlphaGroupEffectManager* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3afbd74, size 0x148, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3afbafc, size 0x278, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::WhiteColorOrAlphaGroupEffect*>*> const& __cordl_internal_get__whiteColorOrAlphaEffects() const;
...
/// @brief Method .ctor, addr 0x3afbebc, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
