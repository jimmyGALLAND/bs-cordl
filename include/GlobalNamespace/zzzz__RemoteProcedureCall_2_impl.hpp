...
constexpr ::GlobalNamespace::__RemoteProcedureCall__TypeWrapper_1<T0>*& GlobalNamespace::RemoteProcedureCall_2<T0,T1>::__cordl_internal_get__value0()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value0;
}
template<typename T0,typename T1>
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__RemoteProcedureCall__TypeWrapper_1<T0>*> const& GlobalNamespace::RemoteProcedureCall_2<T0,T1>::__cordl_internal_get__value0() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value0;
}
template<typename T0,typename T1>
constexpr void GlobalNamespace::RemoteProcedureCall_2<T0,T1>::__cordl_internal_set__value0(::GlobalNamespace::__RemoteProcedureCall__TypeWrapper_1<T0>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T0,typename T1>
constexpr ::GlobalNamespace::__RemoteProcedureCall__TypeWrapper_1<T1>*& GlobalNamespace::RemoteProcedureCall_2<T0,T1>::__cordl_internal_get__value1()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value1;
}
template<typename T0,typename T1>
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__RemoteProcedureCall__TypeWrapper_1<T1>*> const& GlobalNamespace::RemoteProcedureCall_2<T0,T1>::__cordl_internal_get__value1() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value1;
}
template<typename T0,typename T1>
constexpr void GlobalNamespace::RemoteProcedureCall_2<T0,T1>::__cordl_internal_set__value1(::GlobalNamespace::__RemoteProcedureCall__TypeWrapper_1<T1>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "Init",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int64_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<T0>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<T1>::get()}
                    )));
...
// Ctor Parameters []
template<typename T0,typename T1>
constexpr ::GlobalNamespace::RemoteProcedureCall_2<T0,T1>::RemoteProcedureCall_2()   {
}
