...
template<typename T>
constexpr ::GlobalNamespace::LazyCopyHashSet_1<T>*& GlobalNamespace::SimpleMemoryPool_1<T>::__cordl_internal_get__activeElements()  {
...
template<typename T>
constexpr void GlobalNamespace::SimpleMemoryPool_1<T>::__cordl_internal_set__activeElements(::GlobalNamespace::LazyCopyHashSet_1<T>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
constexpr ::System::Collections::Generic::List_1<T>*& GlobalNamespace::SimpleMemoryPool_1<T>::__cordl_internal_get__inactiveElements()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
constexpr void GlobalNamespace::SimpleMemoryPool_1<T>::__cordl_internal_set__inactiveElements(::System::Collections::Generic::List_1<T>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
constexpr ::System::Func_1<T>*& GlobalNamespace::SimpleMemoryPool_1<T>::__cordl_internal_get__createNewItemFunc()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____createNewItemFunc;
}
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Func_1<T>*> const& GlobalNamespace::SimpleMemoryPool_1<T>::__cordl_internal_get__createNewItemFunc() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____createNewItemFunc;
}
template<typename T>
constexpr void GlobalNamespace::SimpleMemoryPool_1<T>::__cordl_internal_set__createNewItemFunc(::System::Func_1<T>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Func_1<T>*>::get()}
                    )));
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::SimpleMemoryPool_1<T>::SimpleMemoryPool_1()   {
}
