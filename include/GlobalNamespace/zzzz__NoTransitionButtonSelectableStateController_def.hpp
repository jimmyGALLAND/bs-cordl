...
public:
// Declarations
/// @brief Method HandleNoTransitionButtonSelectionStateDidChange, addr 0x444716c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x44470dc, size 0x90, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x4446f7c, size 0xa8, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method ResolveSelectionState, addr 0x4447024, size 0xb8, virtual false, abstract: false, final false
inline void ResolveSelectionState(::HMUI::__NoTransitionsButton__SelectionState  state, bool  animated) ;

/// @brief Method .ctor, addr 0x4447174, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
