...
public:
// Declarations
/// @brief Method .ctor, addr 0x221e34c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _yJumpOffsetBuffer, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__yJumpOffsetBuffer, put=__cordl_internal_set__yJumpOffsetBuffer)) ::ArrayW<::GlobalNamespace::__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData,::Array<::GlobalNamespace::__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData>*>  _yJumpOffsetBuffer;

/// @brief Method GetJumpOffsetYAtJumpStartSongTime, addr 0x221e4cc, size 0x314, virtual false, abstract: false, final false
inline float_t GetJumpOffsetYAtJumpStartSongTime(float_t  lastDeltaTime) ;

/// @brief Method ManualUpdate, addr 0x221e354, size 0x178, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData,::Array<::GlobalNamespace::__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData>*> const& __cordl_internal_get__yJumpOffsetBuffer() const;

constexpr ::ArrayW<::GlobalNamespace::__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData,::Array<::GlobalNamespace::__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData>*>& __cordl_internal_get__yJumpOffsetBuffer() ;
...
constexpr void __cordl_internal_set__yJumpOffsetBuffer(::ArrayW<::GlobalNamespace::__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData,::Array<::GlobalNamespace::__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData>*>  value) ;

/// @brief Method .ctor, addr 0x221e1f8, size 0x154, virtual false, abstract: false, final false
