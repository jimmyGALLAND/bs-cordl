...
/// @brief Method Awake, addr 0x3b0a238, size 0x94, virtual false, abstract: false, final false
inline void Awake() ;
...
/// @brief Method .ctor, addr 0x3b0a2cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
