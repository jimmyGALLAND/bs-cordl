...
/// @brief Method SetRandomValueToShaders, addr 0x395a4ac, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x395a540, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
