...
// SizeInfo { instance_size: 216, native_size: -1, calculated_instance_size: 216, calculated_native_size: 214, minimum_alignment: 8, packing: None, specified_packing: None }
namespace GlobalNamespace {
// Is value type: false
...
/// @brief Method Awake, addr 0x3facffc, size 0x1dc, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetHaltUpdateMovement, addr 0x3faec1c, size 0xc, virtual false, abstract: false, final false
inline void GetHaltUpdateMovement(ByRef<bool>  haltUpdateMovement) ;

/// @brief Method GetMoveScaleMultiplier, addr 0x3faebdc, size 0xc, virtual false, abstract: false, final false
inline void GetMoveScaleMultiplier(ByRef<float_t>  moveScaleMultiplier) ;

/// @brief Method GetRotationScaleMultiplier, addr 0x3faebf0, size 0xc, virtual false, abstract: false, final false
inline void GetRotationScaleMultiplier(ByRef<float_t>  rotationScaleMultiplier) ;

/// @brief Method GetSkipMouseRotation, addr 0x3faec04, size 0xc, virtual false, abstract: false, final false
inline void GetSkipMouseRotation(ByRef<bool>  skipMouseRotation) ;

/// @brief Method Jump, addr 0x3faeab0, size 0x84, virtual false, abstract: false, final false
inline bool Jump() ;

static inline ::GlobalNamespace::OVRPlayerController* New_ctor() ;

/// @brief Method OnDisable, addr 0x3fad1dc, size 0x194, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3fad1d8, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method ResetOrientation, addr 0x3faec34, size 0xc4, virtual false, abstract: false, final false
inline void ResetOrientation() ;

/// @brief Method SetHaltUpdateMovement, addr 0x3faec28, size 0xc, virtual false, abstract: false, final false
inline void SetHaltUpdateMovement(bool  haltUpdateMovement) ;

/// @brief Method SetMoveScaleMultiplier, addr 0x3faebe8, size 0x8, virtual false, abstract: false, final false
inline void SetMoveScaleMultiplier(float_t  moveScaleMultiplier) ;

/// @brief Method SetRotationScaleMultiplier, addr 0x3faebfc, size 0x8, virtual false, abstract: false, final false
inline void SetRotationScaleMultiplier(float_t  rotationScaleMultiplier) ;

/// @brief Method SetSkipMouseRotation, addr 0x3faec10, size 0xc, virtual false, abstract: false, final false
inline void SetSkipMouseRotation(bool  skipMouseRotation) ;

/// @brief Method Start, addr 0x3facf38, size 0xc4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Stop, addr 0x3faeb34, size 0xa8, virtual false, abstract: false, final false
inline void Stop() ;

/// @brief Method Update, addr 0x3fad370, size 0x1ec, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateController, addr 0x3fad55c, size 0x728, virtual true, abstract: false, final false
inline void UpdateController() ;

/// @brief Method UpdateMovement, addr 0x3fadc84, size 0xca4, virtual true, abstract: false, final false
inline void UpdateMovement() ;

/// @brief Method UpdateTransform, addr 0x3fae928, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3faecf8, size 0xb4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_CameraUpdated, addr 0x3faccb8, size 0x9c, virtual false, abstract: false, final false
inline void add_CameraUpdated(::System::Action*  value) ;

/// @brief Method add_PreCharacterMove, addr 0x3facdf0, size 0x9c, virtual false, abstract: false, final false
inline void add_PreCharacterMove(::System::Action*  value) ;

/// @brief Method add_TransformUpdated, addr 0x3facb58, size 0xb0, virtual false, abstract: false, final false
inline void add_TransformUpdated(::System::Action_1<::UnityW<::UnityEngine::Transform>>*  value) ;

/// @brief Method get_InitialYRotation, addr 0x3facf28, size 0x8, virtual false, abstract: false, final false
inline float_t get_InitialYRotation() ;

/// @brief Method remove_CameraUpdated, addr 0x3facd54, size 0x9c, virtual false, abstract: false, final false
inline void remove_CameraUpdated(::System::Action*  value) ;

/// @brief Method remove_PreCharacterMove, addr 0x3face8c, size 0x9c, virtual false, abstract: false, final false
inline void remove_PreCharacterMove(::System::Action*  value) ;

/// @brief Method remove_TransformUpdated, addr 0x3facc08, size 0xb0, virtual false, abstract: false, final false
inline void remove_TransformUpdated(::System::Action_1<::UnityW<::UnityEngine::Transform>>*  value) ;

/// @brief Method set_InitialYRotation, addr 0x3facf30, size 0x8, virtual false, abstract: false, final false
