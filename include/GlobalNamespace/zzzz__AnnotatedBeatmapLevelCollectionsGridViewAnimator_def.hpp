...
/// @brief Method AnimateClose, addr 0x3adfba4, size 0x338, virtual false, abstract: false, final false
inline void AnimateClose(int32_t  selectedColumn, int32_t  selectedRow, bool  animated) ;

/// @brief Method AnimateOpen, addr 0x3adf838, size 0x36c, virtual false, abstract: false, final false
inline void AnimateOpen(bool  animated) ;

/// @brief Method DespawnAllActiveTweens, addr 0x3adf70c, size 0xc8, virtual false, abstract: false, final false
inline void DespawnAllActiveTweens() ;

/// @brief Method GetContentXOffset, addr 0x3adf6b0, size 0x2c, virtual false, abstract: false, final false
inline float_t GetContentXOffset() ;

/// @brief Method GetContentYOffset, addr 0x3adf6dc, size 0x2c, virtual false, abstract: false, final false
inline float_t GetContentYOffset() ;

/// @brief Method Init, addr 0x3adf5f8, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3adf708, size 0x4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method ScrollToRowIdxInstant, addr 0x3adf7d4, size 0x64, virtual false, abstract: false, final false
inline void ScrollToRowIdxInstant(int32_t  selectedColumn, int32_t  selectedRow) ;

/// @brief Method <AnimateClose>b__19_0, addr 0x3ae0044, size 0x1c, virtual false, abstract: false, final false
inline void _AnimateClose_b__19_0(::UnityEngine::Vector2  size) ;

/// @brief Method <AnimateClose>b__19_1, addr 0x3ae0060, size 0x88, virtual false, abstract: false, final false
inline void _AnimateClose_b__19_1() ;

/// @brief Method <AnimateClose>b__19_2, addr 0x3ae00e8, size 0x1c, virtual false, abstract: false, final false
inline void _AnimateClose_b__19_2(::UnityEngine::Vector2  pos) ;

/// @brief Method <AnimateClose>b__19_3, addr 0x3ae0104, size 0x88, virtual false, abstract: false, final false
inline void _AnimateClose_b__19_3() ;

/// @brief Method <AnimateOpen>b__18_0, addr 0x3adfefc, size 0x1c, virtual false, abstract: false, final false
inline void _AnimateOpen_b__18_0(::UnityEngine::Vector2  size) ;

/// @brief Method <AnimateOpen>b__18_1, addr 0x3adff18, size 0x88, virtual false, abstract: false, final false
inline void _AnimateOpen_b__18_1() ;

/// @brief Method <AnimateOpen>b__18_2, addr 0x3adffa0, size 0x1c, virtual false, abstract: false, final false
inline void _AnimateOpen_b__18_2(::UnityEngine::Vector2  pos) ;

/// @brief Method <AnimateOpen>b__18_3, addr 0x3adffbc, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3adfedc, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
