...
/// @brief Method InstallBindings, addr 0x3b6072c, size 0x34c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b60a78, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
