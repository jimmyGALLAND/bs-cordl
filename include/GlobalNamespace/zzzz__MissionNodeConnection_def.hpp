...
/// @brief Method MissionConnectionEnabledDidFinish, addr 0x3b74d74, size 0x20, virtual false, abstract: false, final false
inline void MissionConnectionEnabledDidFinish() ;

static inline ::GlobalNamespace::MissionNodeConnection* New_ctor() ;

/// @brief Method SetActive, addr 0x3b74644, size 0xcc, virtual false, abstract: false, final false
inline void SetActive(bool  animated) ;

/// @brief Method Setup, addr 0x3b7369c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method UpdateConnectionRectTransform, addr 0x3b74b00, size 0x274, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b74d94, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_childMissionNode, addr 0x3b74af0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionNodeVisualController> get_childMissionNode() ;

/// @brief Method get_isActive, addr 0x3b74af8, size 0x8, virtual false, abstract: false, final false
inline bool get_isActive() ;

/// @brief Method get_parentMissionNode, addr 0x3b74ae8, size 0x8, virtual false, abstract: false, final false
