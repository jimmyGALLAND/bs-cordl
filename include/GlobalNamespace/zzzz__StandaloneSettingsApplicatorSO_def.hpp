...
public:
// Declarations
/// @brief Method ApplyWindowSettings, addr 0x3aa1f64, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aa1fc0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
