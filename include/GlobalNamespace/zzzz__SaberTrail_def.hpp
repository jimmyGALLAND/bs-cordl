...
/// @brief Method Awake, addr 0x3ff4fe0, size 0x12c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetTrailWidth, addr 0x3ff5558, size 0x84, virtual false, abstract: false, final false
inline float_t GetTrailWidth(::GlobalNamespace::BladeMovementDataElement  lastAddedData) ;

/// @brief Method Init, addr 0x3ff512c, size 0x278, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method LateUpdate, addr 0x3ff57e4, size 0x3d8, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::SaberTrail* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3ff5fec, size 0xa8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x3ff5f68, size 0x84, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnDrawGizmosSelected, addr 0x3ff6094, size 0x1d0, virtual false, abstract: false, final false
inline void OnDrawGizmosSelected() ;

/// @brief Method OnEnable, addr 0x3ff5ebc, size 0xac, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method ResetTrailData, addr 0x3ff55dc, size 0x178, virtual false, abstract: false, final false
inline void ResetTrailData() ;

/// @brief Method Setup, addr 0x3ff510c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ff6264, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;
