...
/// @brief Method AnimateCutout, addr 0x3a6204c, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a62080, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
