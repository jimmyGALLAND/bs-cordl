...
/// @brief Method MoveNext, addr 0x3acc524, size 0x2c4, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3acc7e8, size 0xc, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::PlatformLeaderboardViewController>", modifiers: "", def_value: None }, CppParam { name: "showLoadingIndicator", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "clear", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
...
/// @brief Method MoveNext, addr 0x3acc7f8, size 0x254, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::GlobalNamespace::__PlatformLeaderboardViewController___RefreshDelayed_d__33* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3acca4c, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x3acca54, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3acca8c, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x3acc7f4, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3acc3c0, size 0x28, virtual false, abstract: false, final false
...
/// @brief Field _scoreScopes, offset 0xf8, size 0x8 
 __declspec(property(get=__cordl_internal_get__scoreScopes, put=__cordl_internal_set__scoreScopes)) ::ArrayW<::GlobalNamespace::__PlatformLeaderboardsModel__ScoresScope,::Array<::GlobalNamespace::__PlatformLeaderboardsModel__ScoresScope>*>  _scoreScopes;
...
/// @brief Method ClearContent, addr 0x3acc3e8, size 0xbc, virtual false, abstract: false, final false
inline void ClearContent() ;

/// @brief Method DidActivate, addr 0x3acb66c, size 0x53c, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3acbc3c, size 0x118, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleDidPressRefreshButton, addr 0x3acbf50, size 0xc, virtual false, abstract: false, final false
inline void HandleDidPressRefreshButton() ;

/// @brief Method HandleLeaderboardsResultsReturned, addr 0x3acbf5c, size 0x264, virtual false, abstract: false, final false
inline void HandleLeaderboardsResultsReturned(::GlobalNamespace::__PlatformLeaderboardsModel__GetScoresResult  result, ::ArrayW<::GlobalNamespace::__PlatformLeaderboardsModel__LeaderboardScore*,::Array<::GlobalNamespace::__PlatformLeaderboardsModel__LeaderboardScore*>*>  scores, int32_t  playerScoreIndex) ;

/// @brief Method HandlePlatformLeaderboardsModelAllScoresDidUpload, addr 0x3acc230, size 0xc, virtual false, abstract: false, final false
inline void HandlePlatformLeaderboardsModelAllScoresDidUpload() ;

/// @brief Method HandleScopeSegmentedControlDidSelectCell, addr 0x3acc1c0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3acbd54, size 0x1c0, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Refresh, addr 0x3acb590, size 0xac, virtual false, abstract: false, final false
inline void Refresh(bool  showLoadingIndicator, bool  clear) ;

/// @brief Method RefreshAsync, addr 0x3acc23c, size 0x104, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* RefreshAsync(bool  showLoadingIndicator, bool  clear) ;

/// @brief Method RefreshDelayed, addr 0x3acc340, size 0x80, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* RefreshDelayed(bool  showLoadingIndicator, bool  clear) ;

/// @brief Method RefreshLevelStats, addr 0x3acb63c, size 0x30, virtual true, abstract: false, final false
inline void RefreshLevelStats() ;

/// @brief Method ScopeScopeIndexToScoreScope, addr 0x3acbf14, size 0x3c, virtual false, abstract: false, final false
inline ::GlobalNamespace::__PlatformLeaderboardsModel__ScoresScope ScopeScopeIndexToScoreScope(int32_t  scoreScopeIndex) ;

/// @brief Method ScoreScopeToScoreScopeIndex, addr 0x3acbba8, size 0x94, virtual false, abstract: false, final false
inline int32_t ScoreScopeToScoreScopeIndex(::GlobalNamespace::__PlatformLeaderboardsModel__ScoresScope  scoresScope) ;

/// @brief Method SetData, addr 0x3acb4f4, size 0x9c, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__PlatformLeaderboardsModel__ScoresScope,::Array<::GlobalNamespace::__PlatformLeaderboardsModel__ScoresScope>*> const& __cordl_internal_get__scoreScopes() const;
...
/// @brief Method .ctor, addr 0x3acc4a4, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::GlobalNamespace::__PlatformLeaderboardsModel__ScoresScope getStaticF__scoresScope() ;

/// @brief Method get_leaderboardsModel, addr 0x3acb4ec, size 0x8, virtual false, abstract: false, final false
