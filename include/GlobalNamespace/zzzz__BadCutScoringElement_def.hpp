...
/// @brief Method .ctor, addr 0x3b591d4, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x3b58c1c, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b591cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_cutScore, addr 0x3b591a8, size 0x8, virtual true, abstract: false, final false
inline int32_t get_cutScore() ;

/// @brief Method get_executionOrder, addr 0x3b591c0, size 0xc, virtual true, abstract: false, final false
inline int32_t get_executionOrder() ;

/// @brief Method get_multiplierEventType, addr 0x3b591b8, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType get_multiplierEventType() ;

/// @brief Method get_wouldBeCorrectCutBestPossibleMultiplierEventType, addr 0x3b591b0, size 0x8, virtual true, abstract: false, final false
