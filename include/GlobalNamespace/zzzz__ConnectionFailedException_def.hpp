...
/// @brief Method .ctor, addr 0x2275d34, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::ConnectionFailedReason  reason) ;

/// @brief Method .ctor, addr 0x2275da0, size 0x74, virtual false, abstract: false, final false
