...
/// @brief Field _arrowMeshRenderers, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__arrowMeshRenderers, put=__cordl_internal_set__arrowMeshRenderers)) ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>,::Array<::UnityW<::UnityEngine::MeshRenderer>>*>  _arrowMeshRenderers;

/// @brief Field _circleMeshRenderers, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__circleMeshRenderers, put=__cordl_internal_set__circleMeshRenderers)) ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>,::Array<::UnityW<::UnityEngine::MeshRenderer>>*>  _circleMeshRenderers;
...
/// @brief Field didInitEvent, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_didInitEvent, put=__cordl_internal_set_didInitEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::ColorNoteVisuals>,::UnityW<::GlobalNamespace::NoteControllerBase>>*  didInitEvent;
...
/// @brief Method Awake, addr 0x3a600e0, size 0x1d0, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleNoteControllerDidInit, addr 0x3a604d0, size 0x178, virtual true, abstract: false, final true
inline void HandleNoteControllerDidInit(::GlobalNamespace::NoteControllerBase*  noteController) ;

/// @brief Method HandleNoteControllerNoteDidPassJumpThreeQuarters, addr 0x3a60648, size 0x20, virtual true, abstract: false, final true
inline void HandleNoteControllerNoteDidPassJumpThreeQuarters(::GlobalNamespace::NoteControllerBase*  noteController) ;

/// @brief Method HandleNoteControllerNoteDidStartDissolving, addr 0x3a60668, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method OnDestroy, addr 0x3a602b0, size 0x220, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::ColorNoteVisuals>,::UnityW<::GlobalNamespace::NoteControllerBase>>*> const& __cordl_internal_get_didInitEvent() const;
...
/// @brief Method .ctor, addr 0x3a60688, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didInitEvent, addr 0x3a5feb0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_didInitEvent, addr 0x3a5ff60, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method set_showArrow, addr 0x3a60010, size 0x68, virtual false, abstract: false, final false
inline void set_showArrow(bool  value) ;

/// @brief Method set_showCircle, addr 0x3a60078, size 0x68, virtual false, abstract: false, final false
