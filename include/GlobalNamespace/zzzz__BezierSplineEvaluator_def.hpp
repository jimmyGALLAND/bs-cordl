...
public:
// Declarations
/// @brief Method .ctor, addr 0x22255c8, size 0x14, virtual false, abstract: false, final false
inline void _ctor(float_t  solution1) ;

/// @brief Method .ctor, addr 0x22255dc, size 0x14, virtual false, abstract: false, final false
inline void _ctor(float_t  solution1, float_t  solution2) ;

/// @brief Method .ctor, addr 0x22255f0, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method CubeRoot, addr 0x2225594, size 0x34, virtual false, abstract: false, final false
static inline float_t CubeRoot(float_t  x) ;

/// @brief Method Evaluate, addr 0x2224b54, size 0x14c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 Evaluate(float_t  t) ;

/// @brief Method EvaluateFirstDerivation, addr 0x2224ca0, size 0x15c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 EvaluateFirstDerivation(float_t  t) ;

/// @brief Method EvaluatePosition, addr 0x221de38, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 EvaluatePosition(float_t  time) ;

/// @brief Method EvaluateSecondDerivation, addr 0x2224dfc, size 0x14c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 EvaluateSecondDerivation(float_t  t) ;

/// @brief Method GetTForSegment, addr 0x2225068, size 0x14c, virtual false, abstract: false, final false
inline float_t GetTForSegment(int32_t  segmentIndex, float_t  time) ;

/// @brief Method GetTimeValuesForSegment, addr 0x22254dc, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method OffsetSegmentAndGetT, addr 0x2224a40, size 0x114, virtual false, abstract: false, final false
inline float_t OffsetSegmentAndGetT(float_t  time) ;

/// @brief Method OffsetStartIndexToDistance, addr 0x2224f48, size 0x120, virtual false, abstract: false, final false
inline void OffsetStartIndexToDistance(float_t  time) ;

/// @brief Method SolveCubic, addr 0x22251b4, size 0x328, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22200c0, size 0x34, virtual false, abstract: false, final false
