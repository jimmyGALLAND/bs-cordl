...
public:
// Declarations
/// @brief Method .ctor, addr 0x3a5b030, size 0x38, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method .ctor, addr 0x3a5b22c, size 0x30, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method .ctor, addr 0x3a5b3dc, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method Get2DNoteOffset, addr 0x3a5b440, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 Get2DNoteOffset(int32_t  noteLineIndex, ::GlobalNamespace::NoteLineLayer  noteLineLayer) ;

/// @brief Method GetJumpingNoteSpawnData, addr 0x3a5b068, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method GetNoteOffset, addr 0x3a5b168, size 0x78, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetNoteOffset(int32_t  noteLineIndex, ::GlobalNamespace::NoteLineLayer  noteLineLayer) ;

/// @brief Method GetObstacleOffset, addr 0x3a5afa8, size 0x88, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetObstacleOffset(int32_t  noteLineIndex, ::GlobalNamespace::NoteLineLayer  noteLineLayer) ;

/// @brief Method GetObstacleSpawnData, addr 0x3a5ae34, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method GetSliderSpawnData, addr 0x3a5b25c, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method HighestJumpPosYForLineLayer, addr 0x3a5b528, size 0x154, virtual false, abstract: false, final false
inline float_t HighestJumpPosYForLineLayer(::GlobalNamespace::NoteLineLayer  lineLayer) ;

/// @brief Method HighestJumpPosYForLineLayerWithoutJumpOffset, addr 0x3a5b67c, size 0x28, virtual false, abstract: false, final false
inline float_t HighestJumpPosYForLineLayerWithoutJumpOffset(::GlobalNamespace::NoteLineLayer  lineLayer) ;

/// @brief Method Init, addr 0x3a5ace4, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method JumpPosYForLineLayerAtDistanceFromPlayerWithoutJumpOffset, addr 0x3a5b454, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method NoteJumpGravityForLineLayer, addr 0x3a5b1e0, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method NoteJumpGravityForLineLayerWithoutJumpOffset, addr 0x3a5b4c4, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a5b6a4, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_centerPos, addr 0x3a5ac38, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_centerPos() ;

/// @brief Method get_jumpDistance, addr 0x3a5ac20, size 0x8, virtual false, abstract: false, final false
inline float_t get_jumpDistance() ;

/// @brief Method get_jumpDuration, addr 0x3a5ac00, size 0x8, virtual false, abstract: false, final false
inline float_t get_jumpDuration() ;

/// @brief Method get_jumpOffsetY, addr 0x3a5ac44, size 0xa0, virtual false, abstract: false, final false
inline float_t get_jumpOffsetY() ;

/// @brief Method get_moveDuration, addr 0x3a5abf8, size 0x8, virtual false, abstract: false, final false
inline float_t get_moveDuration() ;

/// @brief Method get_noteJumpMovementSpeed, addr 0x3a5ac28, size 0x8, virtual false, abstract: false, final false
inline float_t get_noteJumpMovementSpeed() ;

/// @brief Method get_noteLinesCount, addr 0x3a5ac30, size 0x8, virtual false, abstract: false, final false
inline int32_t get_noteLinesCount() ;

/// @brief Method get_noteLinesDistance, addr 0x3a5ac08, size 0xc, virtual false, abstract: false, final false
inline float_t get_noteLinesDistance() ;

/// @brief Method get_spawnAheadTime, addr 0x3a5abf0, size 0x8, virtual false, abstract: false, final false
inline float_t get_spawnAheadTime() ;

/// @brief Method get_verticalLayersDistance, addr 0x3a5ac14, size 0xc, virtual false, abstract: false, final false
