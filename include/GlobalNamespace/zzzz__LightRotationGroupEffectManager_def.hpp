...
/// @brief Field _lightRotationGroupEffects, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightRotationGroupEffects, put=__cordl_internal_set__lightRotationGroupEffects)) ::System::Collections::Generic::List_1<::GlobalNamespace::LightRotationGroupEffect*>*  _lightRotationGroupEffects;

/// @brief Field _lightRotationGroups, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightRotationGroups, put=__cordl_internal_set__lightRotationGroups)) ::ArrayW<::UnityW<::GlobalNamespace::LightRotationGroup>,::Array<::UnityW<::GlobalNamespace::LightRotationGroup>>*>  _lightRotationGroups;

static inline ::GlobalNamespace::LightRotationGroupEffectManager* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3afcd3c, size 0x148, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3afc7f0, size 0x54c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3afce84, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
