...
/// @brief Method InstallBindings, addr 0x3b2edbc, size 0x138, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b2eef4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
