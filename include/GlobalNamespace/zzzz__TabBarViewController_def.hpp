...
/// @brief Method .ctor, addr 0x3a71aa8, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Field _items, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__items, put=__cordl_internal_set__items)) ::ArrayW<::GlobalNamespace::__TabBarViewController__TabBarItem*,::Array<::GlobalNamespace::__TabBarViewController__TabBarItem*>*>  _items;
...
/// @brief Method Clear, addr 0x3a71860, size 0x54, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method DidActivate, addr 0x3a718b4, size 0xc4, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HandleDidSelectCell, addr 0x3a71a50, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3a71978, size 0xd8, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SelectItem, addr 0x3a71844, size 0x1c, virtual false, abstract: false, final false
inline void SelectItem(int32_t  index) ;

/// @brief Method Setup, addr 0x3a716b4, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a71aa0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_selectedCellNumber, addr 0x3a71698, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_selectedCellNumber() ;

/// @brief Method get_sizeToFit, addr 0x3a7167c, size 0x1c, virtual false, abstract: false, final false
inline bool get_sizeToFit() ;

/// @brief Method set_sizeToFit, addr 0x3a7165c, size 0x20, virtual false, abstract: false, final false
