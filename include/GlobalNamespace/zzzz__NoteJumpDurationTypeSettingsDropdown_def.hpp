...
public:
// Declarations
/// @brief Method GetNamedValues, addr 0x3b7d69c, size 0xf4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b7d790, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
