...
/// @brief Method Awake, addr 0x3b5316c, size 0x30, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Cut, addr 0x3b5319c, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method RefreshRadius, addr 0x3b530b8, size 0x60, virtual false, abstract: false, final false
inline void RefreshRadius() ;

/// @brief Method SetColliderCenterAndSize, addr 0x3b531c0, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b53218, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_canBeCut, addr 0x3b53088, size 0x8, virtual true, abstract: false, final false
inline bool get_canBeCut() ;

/// @brief Method get_colliderCenter, addr 0x3b53150, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_colliderCenter() ;

/// @brief Method get_colliderSize, addr 0x3b53118, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_colliderSize() ;

/// @brief Method get_radius, addr 0x3b53048, size 0x8, virtual true, abstract: false, final false
inline float_t get_radius() ;

/// @brief Method set_canBeCut, addr 0x3b53050, size 0x38, virtual true, abstract: false, final false
inline void set_canBeCut(bool  value) ;

/// @brief Method set_colliderCenter, addr 0x3b53134, size 0x1c, virtual false, abstract: false, final false
inline void set_colliderCenter(::UnityEngine::Vector3  value) ;

/// @brief Method set_colliderSize, addr 0x3b53090, size 0x28, virtual false, abstract: false, final false
