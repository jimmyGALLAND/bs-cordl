...
/// @brief Method <Hide>b__0, addr 0x3a75644, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a7559c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Hide, addr 0x3a754d4, size 0xc8, virtual false, abstract: false, final false
inline void Hide(::System::Action*  finishedCallback) ;

static inline ::GlobalNamespace::DisconnectPromptView* New_ctor() ;

/// @brief Method OnDisable, addr 0x3a75480, size 0x1c, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3a75390, size 0xf0, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Show, addr 0x3a7549c, size 0x38, virtual false, abstract: false, final false
inline void Show() ;

/// @brief Method <OnEnable>b__9_0, addr 0x3a75604, size 0x20, virtual false, abstract: false, final false
inline void _OnEnable_b__9_0() ;

/// @brief Method <OnEnable>b__9_1, addr 0x3a75624, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a755a4, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didViewFinishEvent, addr 0x3a75230, size 0xb0, virtual false, abstract: false, final false
inline void add_didViewFinishEvent(::System::Action_1<bool>*  value) ;

/// @brief Method remove_didViewFinishEvent, addr 0x3a752e0, size 0xb0, virtual false, abstract: false, final false
