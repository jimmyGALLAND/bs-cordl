...
/// @brief Method <ToMockBeatmapData>b__0_0, addr 0x3b31544, size 0x20, virtual false, abstract: false, final false
inline bool _ToMockBeatmapData_b__0_0(::GlobalNamespace::NoteData*  nd) ;

/// @brief Method <ToMockBeatmapData>b__0_1, addr 0x3b31564, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MockNoteData* _ToMockBeatmapData_b__0_1(::GlobalNamespace::NoteData*  nd) ;

/// @brief Method <ToMockBeatmapData>b__0_2, addr 0x3b3156c, size 0x20, virtual false, abstract: false, final false
inline bool _ToMockBeatmapData_b__0_2(::GlobalNamespace::NoteData*  nd) ;

/// @brief Method <ToMockBeatmapData>b__0_3, addr 0x3b3158c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MockNoteData* _ToMockBeatmapData_b__0_3(::GlobalNamespace::NoteData*  nd) ;

/// @brief Method <ToMockBeatmapData>b__0_4, addr 0x3b31594, size 0x20, virtual false, abstract: false, final false
inline bool _ToMockBeatmapData_b__0_4(::GlobalNamespace::NoteData*  nd) ;

/// @brief Method <ToMockBeatmapData>b__0_5, addr 0x3b315b4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MockNoteData* _ToMockBeatmapData_b__0_5(::GlobalNamespace::NoteData*  nd) ;

/// @brief Method <ToMockBeatmapData>b__0_6, addr 0x3b315bc, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MockObstacleData* _ToMockBeatmapData_b__0_6(::GlobalNamespace::ObstacleData*  od) ;

/// @brief Method .ctor, addr 0x3b3153c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ToMockBeatmapData, addr 0x3b30b0c, size 0x8cc, virtual false, abstract: false, final false
static inline ::GlobalNamespace::MockBeatmapData* ToMockBeatmapData(::GlobalNamespace::IReadonlyBeatmapData*  beatmapData) ;

/// @brief Method ToMockNoteData, addr 0x3b313d8, size 0x84, virtual false, abstract: false, final false
static inline ::GlobalNamespace::MockNoteData* ToMockNoteData(::GlobalNamespace::NoteData*  noteData) ;

/// @brief Method ToMockObstacleData, addr 0x3b3145c, size 0x84, virtual false, abstract: false, final false
