...
/// @brief Method CreateCubeGrid, addr 0x3fa4334, size 0x3b8, virtual false, abstract: false, final false
inline void CreateCubeGrid() ;

/// @brief Method CubeGridSwitchColor, addr 0x3fa46ec, size 0x17c, virtual false, abstract: false, final false
inline void CubeGridSwitchColor(bool  CubeSwitchColor) ;

static inline ::GlobalNamespace::OVRGridCube* New_ctor() ;

/// @brief Method SetOVRCameraController, addr 0x3fa4328, size 0xc, virtual false, abstract: false, final false
inline void SetOVRCameraController(ByRef<::GlobalNamespace::OVRCameraRig*>  cameraController) ;

/// @brief Method Update, addr 0x3fa4104, size 0x4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateCubeGrid, addr 0x3fa4108, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fa4868, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
