...
/// @brief Field m_prevControllerInHandState, offset 0x9c, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_prevControllerInHandState, put=__cordl_internal_set_m_prevControllerInHandState)) ::GlobalNamespace::__OVRInput__ControllerInHandState  m_prevControllerInHandState;
...
/// @brief Method InitializeControllerModels, addr 0x3f99188, size 0x494, virtual false, abstract: false, final false
inline void InitializeControllerModels() ;

/// @brief Method InputFocusAquired, addr 0x3f99e84, size 0xc, virtual false, abstract: false, final false
inline void InputFocusAquired() ;

/// @brief Method InputFocusLost, addr 0x3f99e90, size 0x8, virtual false, abstract: false, final false
inline void InputFocusLost() ;

static inline ::GlobalNamespace::OVRControllerHelper* New_ctor() ;

/// @brief Method Start, addr 0x3f99118, size 0x70, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3f9961c, size 0x868, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3f99e98, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;
