...
/// @brief Method Get, addr 0x269ae10, size 0x1b4, virtual false, abstract: false, final false
inline ::StringW Get(::GlobalNamespace::__SonyContentVersion__VersionFormat  versionFormat) ;

/// @brief Method GetFromString, addr 0x269aa80, size 0x300, virtual false, abstract: false, final false
static inline ::GlobalNamespace::SonyContentVersion* GetFromString(::StringW  versionString) ;

/// @brief Method IsVersionFormatValid, addr 0x269ad80, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x269aa44, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(uint32_t  majorVersion, uint32_t  minorVersion, uint32_t  revision) ;

/// @brief Method get_majorVersion, addr 0x269aa2c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_majorVersion() ;

/// @brief Method get_minorVersion, addr 0x269aa34, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_minorVersion() ;

/// @brief Method get_revision, addr 0x269aa3c, size 0x8, virtual false, abstract: false, final false
