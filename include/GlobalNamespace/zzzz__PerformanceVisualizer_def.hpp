...
public:
// Declarations
/// @brief Method Initialize, addr 0x3a993ac, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a99480, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
