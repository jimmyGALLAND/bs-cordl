...
/// @brief Method .ctor, addr 0x268945c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_icon, addr 0x268b130, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_icon() ;

/// @brief Method get_subtitleLocalizationKey, addr 0x268b140, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_subtitleLocalizationKey() ;

/// @brief Method get_titleLocalizationKey, addr 0x268b138, size 0x8, virtual false, abstract: false, final false
