...
/// @brief Method AnimateColorsForAllPlayers, addr 0x3b4c9b0, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method AnimateColorsForPlayer, addr 0x3b4c830, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method GetScoreRingItem, addr 0x3b3e398, size 0x104, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MultiplayerScoreRingItem> GetScoreRingItem(::StringW  userId) ;

/// @brief Method GetScoreRingItems, addr 0x3b46814, size 0x1d8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::GameObject>,::Array<::UnityW<::UnityEngine::GameObject>>*> GetScoreRingItems() ;

/// @brief Method HandlePlayerDisconnected, addr 0x3b4d2c4, size 0x4, virtual false, abstract: false, final false
inline void HandlePlayerDisconnected(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandlePlayerSpawningDidFinish, addr 0x3b4bd30, size 0x18, virtual false, abstract: false, final false
inline void HandlePlayerSpawningDidFinish() ;

/// @brief Method HandlePlayerStateChanged, addr 0x3b4d284, size 0x40, virtual false, abstract: false, final false
inline void HandlePlayerStateChanged(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x3b4bd18, size 0x18, virtual false, abstract: false, final false
inline void HandleSpawnCenterDistanceWasFound(float_t  spawnCenterDistance) ;

/// @brief Method HandleStateChanged, addr 0x3b4bd48, size 0x4dc, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b4c224, size 0x344, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetPlayerToFailedState, addr 0x3b4cb78, size 0x120, virtual false, abstract: false, final false
inline void SetPlayerToFailedState(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method SpawnTexts, addr 0x3b4ccb0, size 0x5d4, virtual false, abstract: false, final false
inline void SpawnTexts() ;

/// @brief Method Start, addr 0x3b4bb68, size 0x1b0, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method TrySpawnTexts, addr 0x3b4cc98, size 0x18, virtual false, abstract: false, final false
inline void TrySpawnTexts() ;

/// @brief Method Update, addr 0x3b4c568, size 0xd4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateScore, addr 0x3b4c63c, size 0x1f4, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::UnityW<::GlobalNamespace::MultiplayerScoreRingItem>>*> const& __cordl_internal_get__scoreRingItems() const;
...
/// @brief Method .ctor, addr 0x3b4d2c8, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
