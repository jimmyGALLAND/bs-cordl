...
/// @brief Field multiplayerLevelCompletionResults, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_multiplayerLevelCompletionResults, put=__cordl_internal_set_multiplayerLevelCompletionResults)) ::GlobalNamespace::MultiplayerLevelCompletionResults*  multiplayerLevelCompletionResults;

/// @brief Convert operator to "::System::IComparable"
constexpr operator  ::System::IComparable*() noexcept;

/// @brief Method CompareTo, addr 0x26936a4, size 0x1dc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2693678, size 0x2c, virtual false, abstract: false, final false
