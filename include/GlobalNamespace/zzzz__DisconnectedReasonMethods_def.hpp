...
public:
// Declarations
/// @brief Method ErrorCode, addr 0x268cac4, size 0x80, virtual false, abstract: false, final false
static inline ::StringW ErrorCode(::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method LocalizedKey, addr 0x268ca1c, size 0xa8, virtual false, abstract: false, final false
