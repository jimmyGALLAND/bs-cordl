...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ProgressActivitySO::*)()>(&::GlobalNamespace::ProgressActivitySO::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x269a978;
...
constexpr ::ArrayW<::UnityW<::GlobalNamespace::ProgressActivitySubtaskSO>,::Array<::UnityW<::GlobalNamespace::ProgressActivitySubtaskSO>>*>& GlobalNamespace::ProgressActivitySO::__cordl_internal_get_subtasks()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___subtasks;
}
constexpr ::ArrayW<::UnityW<::GlobalNamespace::ProgressActivitySubtaskSO>,::Array<::UnityW<::GlobalNamespace::ProgressActivitySubtaskSO>>*> const& GlobalNamespace::ProgressActivitySO::__cordl_internal_get_subtasks() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___subtasks;
}
constexpr void GlobalNamespace::ProgressActivitySO::__cordl_internal_set_subtasks(::ArrayW<::UnityW<::GlobalNamespace::ProgressActivitySubtaskSO>,::Array<::UnityW<::GlobalNamespace::ProgressActivitySubtaskSO>>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
