...
/// @brief Field <cuttableScoringObjectsCount>k__BackingField, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__cuttableScoringObjectsCount_k__BackingField, put=__cordl_internal_set__cuttableScoringObjectsCount_k__BackingField)) int32_t  _cuttableScoringObjectsCount_k__BackingField;
...
/// @brief Method .ctor, addr 0x2669498, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method get_bombsCount, addr 0x2669490, size 0x8, virtual false, abstract: false, final false
inline int32_t get_bombsCount() ;

/// @brief Method get_cuttableNotesCount, addr 0x2669478, size 0x8, virtual false, abstract: false, final false
inline int32_t get_cuttableNotesCount() ;

/// @brief Method get_cuttableScoringObjectsCount, addr 0x2669480, size 0x8, virtual false, abstract: false, final false
inline int32_t get_cuttableScoringObjectsCount() ;

/// @brief Method get_numberOfLines, addr 0x2669470, size 0x8, virtual false, abstract: false, final false
inline int32_t get_numberOfLines() ;

/// @brief Method get_obstaclesCount, addr 0x2669488, size 0x8, virtual false, abstract: false, final false
