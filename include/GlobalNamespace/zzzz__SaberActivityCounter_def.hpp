...
/// @brief Method Awake, addr 0x3b54578, size 0xa8, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleDidPauseEvent, addr 0x3b54d44, size 0x8, virtual false, abstract: false, final false
inline void HandleDidPauseEvent() ;

/// @brief Method HandleSaberPositionsWereUpdated, addr 0x3b54904, size 0x440, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b5476c, size 0x198, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b54620, size 0x14c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b54d4c, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_totalDistanceDidChangeEvent, addr 0x3b543c0, size 0xb0, virtual false, abstract: false, final false
inline void add_totalDistanceDidChangeEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method get_handMovementAveragingValueRecorder, addr 0x3b5455c, size 0x1c, virtual false, abstract: false, final false
inline ::GlobalNamespace::AveragingValueRecorder* get_handMovementAveragingValueRecorder() ;

/// @brief Method get_leftHandMovementDistance, addr 0x3b54530, size 0x8, virtual false, abstract: false, final false
inline float_t get_leftHandMovementDistance() ;

/// @brief Method get_leftSaberMovementDistance, addr 0x3b54520, size 0x8, virtual false, abstract: false, final false
inline float_t get_leftSaberMovementDistance() ;

/// @brief Method get_rightHandMovementDistance, addr 0x3b54538, size 0x8, virtual false, abstract: false, final false
inline float_t get_rightHandMovementDistance() ;

/// @brief Method get_rightSaberMovementDistance, addr 0x3b54528, size 0x8, virtual false, abstract: false, final false
inline float_t get_rightSaberMovementDistance() ;

/// @brief Method get_saberMovementAveragingValueRecorder, addr 0x3b54540, size 0x1c, virtual false, abstract: false, final false
inline ::GlobalNamespace::AveragingValueRecorder* get_saberMovementAveragingValueRecorder() ;

/// @brief Method remove_totalDistanceDidChangeEvent, addr 0x3b54470, size 0xb0, virtual false, abstract: false, final false
