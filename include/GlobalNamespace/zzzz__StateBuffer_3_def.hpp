...
inline bool IEquatableByReference_StateBuffer_TStateTable_TType_TState__TimestampedStateTable__Equals(ByRef<::GlobalNamespace::__StateBuffer_3__TimestampedStateTable<TStateTable,TType,TState>>  other) ;
...
constexpr ::GlobalNamespace::IEquatableByReference_1<::GlobalNamespace::__StateBuffer_3__TimestampedStateTable<TStateTable,TType,TState>>* i___GlobalNamespace__IEquatableByReference_1___GlobalNamespace____StateBuffer_3__TimestampedStateTable_TStateTable_TType_TState__() ;

// Ctor Parameters []
// @brief default ctor
constexpr __StateBuffer_3__TimestampedStateTable() ;

// Ctor Parameters [CppParam { name: "isValid", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "id", ty: "::GlobalNamespace::SyncStateId", modifiers: "", def_value: None }, CppParam { name: "time", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "state", ty: "TStateTable", modifiers: "", def_value: None }]
...
static inline ::GlobalNamespace::__StateBuffer_3__InterpolationDelegate<TStateTable,TType,TState>* New_ctor(::System::Object*  object, ::System::IntPtr  method) ;
...
static inline ::GlobalNamespace::__StateBuffer_3__SmoothingDelegate<TStateTable,TType,TState>* New_ctor(::System::Object*  object, ::System::IntPtr  method) ;
...
/// @brief Field _buffer, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__buffer, put=__cordl_internal_set__buffer)) ::ArrayW<::GlobalNamespace::__StateBuffer_3__TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::__StateBuffer_3__TimestampedStateTable<TStateTable,TType,TState>>*>  _buffer;
...
/// @brief Field _interpolator, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__interpolator, put=__cordl_internal_set__interpolator)) ::GlobalNamespace::__StateBuffer_3__InterpolationDelegate<TStateTable,TType,TState>*  _interpolator;
...
static inline ::GlobalNamespace::StateBuffer_3<TStateTable,TType,TState>* New_ctor(int32_t  size, ::GlobalNamespace::__StateBuffer_3__InterpolationDelegate<TStateTable,TType,TState>*  interpolator, ::GlobalNamespace::__StateBuffer_3__SmoothingDelegate<TStateTable,TType,TState>*  smoother) ;

constexpr ::ArrayW<::GlobalNamespace::__StateBuffer_3__TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::__StateBuffer_3__TimestampedStateTable<TStateTable,TType,TState>>*> const& __cordl_internal_get__buffer() const;

constexpr ::ArrayW<::GlobalNamespace::__StateBuffer_3__TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::__StateBuffer_3__TimestampedStateTable<TStateTable,TType,TState>>*>& __cordl_internal_get__buffer() ;
...
constexpr void __cordl_internal_set__buffer(::ArrayW<::GlobalNamespace::__StateBuffer_3__TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::__StateBuffer_3__TimestampedStateTable<TStateTable,TType,TState>>*>  value) ;
...
/// @brief Field _buffer, offset: 0x18, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::__StateBuffer_3__TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::__StateBuffer_3__TimestampedStateTable<TStateTable,TType,TState>>*>  ____buffer;
