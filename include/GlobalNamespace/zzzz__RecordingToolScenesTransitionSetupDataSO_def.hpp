...
public:
// Declarations
/// @brief Method Init, addr 0x3ab1f30, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ab1f38, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
