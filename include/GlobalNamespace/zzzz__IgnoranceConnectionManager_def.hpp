...
/// @brief Method .ctor, addr 0x2281e68, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Convert to "::GlobalNamespace::IConnectionInitParams_1<::GlobalNamespace::IgnoranceConnectionManager*>"
constexpr ::GlobalNamespace::IConnectionInitParams_1<::GlobalNamespace::IgnoranceConnectionManager*>* i___GlobalNamespace__IConnectionInitParams_1___GlobalNamespace__IgnoranceConnectionManager__() noexcept;
...
/// @brief Method .ctor, addr 0x2281e78, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x227c010, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Disconnect, addr 0x2281ee4, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method Send, addr 0x2281ebc, size 0x28, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x228155c, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method get_isConnectionOwner, addr 0x2281ea8, size 0x8, virtual true, abstract: false, final true
inline bool get_isConnectionOwner() ;

/// @brief Method get_userId, addr 0x2281e88, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_userId() ;

/// @brief Method get_userName, addr 0x2281e98, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_isConnectionOwner, addr 0x2281eb0, size 0xc, virtual false, abstract: false, final false
inline void set_isConnectionOwner(bool  value) ;

/// @brief Method set_userId, addr 0x2281e90, size 0x8, virtual false, abstract: false, final false
inline void set_userId(::StringW  value) ;

/// @brief Method set_userName, addr 0x2281ea0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <DisposeAsync>b__0, addr 0x2281f10, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2281f08, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <DisposeAsync>b__1, addr 0x2281f20, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2281f18, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x2281f28, size 0x45c, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x2282384, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x22823ec, size 0x430, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x228281c, size 0x68, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Field _channels, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__channels, put=__cordl_internal_set__channels)) ::ArrayW<::IgnoranceCore::IgnoranceChannelTypes,::Array<::IgnoranceCore::IgnoranceChannelTypes>*>  _channels;
...
/// @brief Field _connections, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get__connections, put=__cordl_internal_set__connections)) ::System::Collections::Generic::List_1<::GlobalNamespace::__IgnoranceConnectionManager__IgnoranceConnection*>*  _connections;
...
/// @brief Method BackgroundDisconnectSentry, addr 0x2281da4, size 0xc4, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* BackgroundDisconnectSentry() ;

/// @brief Method CheckSentryState, addr 0x228094c, size 0x24, virtual false, abstract: false, final false
inline void CheckSentryState() ;

/// @brief Method Disconnect, addr 0x228105c, size 0x1b4, virtual true, abstract: false, final true
inline void Disconnect(::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method DisconnectPeer, addr 0x22816e8, size 0xf0, virtual false, abstract: false, final false
inline void DisconnectPeer(uint32_t  peerId, ::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method Dispose, addr 0x2281028, size 0x34, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DisposeAsync, addr 0x2280f68, size 0xc0, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task* DisposeAsync() ;

/// @brief Method GetConnection, addr 0x2281a80, size 0x58, virtual true, abstract: false, final true
inline ::GlobalNamespace::IConnection* GetConnection(int32_t  index) ;

/// @brief Method GetConnectionMessage, addr 0x2281368, size 0x110, virtual false, abstract: false, final false
inline ::LiteNetLib::Utils::NetDataWriter* GetConnectionMessage() ;

/// @brief Method HandleConnectionEvents, addr 0x2280970, size 0x270, virtual false, abstract: false, final false
inline void HandleConnectionEvents() ;

/// @brief Method HandleDisconnectionEvents, addr 0x2280eac, size 0xbc, virtual false, abstract: false, final false
inline void HandleDisconnectionEvents() ;

/// @brief Method HandleIncomingEvents, addr 0x2280be0, size 0x2cc, virtual false, abstract: false, final false
...
/// @brief Method Log, addr 0x2281b64, size 0x8c, virtual false, abstract: false, final false
static inline void Log(::StringW  msg) ;

/// @brief Method LogError, addr 0x2281ad8, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method PollUpdate, addr 0x228085c, size 0xf0, virtual true, abstract: false, final true
inline void PollUpdate() ;

/// @brief Method Send, addr 0x2281478, size 0xe4, virtual false, abstract: false, final false
inline void Send(uint32_t  peerId, ::LiteNetLib::Utils::NetDataWriter*  writer, ::BGNet::Core::DeliveryMethod  deliveryMethod) ;

/// @brief Method SendToAll, addr 0x22818e8, size 0xb8, virtual true, abstract: false, final true
inline void SendToAll(::LiteNetLib::Utils::NetDataWriter*  writer, ::BGNet::Core::DeliveryMethod  deliveryMethod) ;

/// @brief Method SendToAll, addr 0x22819a0, size 0xe0, virtual true, abstract: false, final true
...
/// @brief Method StartBackgroundSentry, addr 0x2281bf0, size 0x1b4, virtual false, abstract: false, final false
inline void StartBackgroundSentry() ;

/// @brief Method ToChannel, addr 0x22818d8, size 0x10, virtual false, abstract: false, final false
static inline uint8_t ToChannel(::BGNet::Core::DeliveryMethod  deliveryMethod) ;

/// @brief Method ToDeliveryMethod, addr 0x22818cc, size 0xc, virtual false, abstract: false, final false
static inline ::BGNet::Core::DeliveryMethod ToDeliveryMethod(uint8_t  channel) ;

/// @brief Method TryGetConnection, addr 0x22817d8, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method TryParseConnectionMessage, addr 0x22815b4, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method WaitForClientShutdown, addr 0x2281210, size 0xac, virtual false, abstract: false, final false
static inline void WaitForClientShutdown(::IgnoranceCore::IgnoranceClient*  client) ;

/// @brief Method WaitForServerShutdown, addr 0x22812bc, size 0xac, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__IgnoranceConnectionManager__IgnoranceConnection*>*> const& __cordl_internal_get__connections() const;
...
/// @brief Method .ctor, addr 0x227b160, size 0xac, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x22806b8, size 0x1a4, virtual false, abstract: false, final false
inline void _ctor(::BGNet::Core::ITimeProvider*  timeProvider, ::BGNet::Core::ITaskUtility*  taskUtility) ;

/// @brief Method add_onConnectedEvent, addr 0x227fdc8, size 0x9c, virtual true, abstract: false, final true
inline void add_onConnectedEvent(::System::Action*  value) ;

/// @brief Method add_onConnectionConnectedEvent, addr 0x22801c0, size 0xb0, virtual true, abstract: false, final true
inline void add_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>*  value) ;

/// @brief Method add_onConnectionDisconnectedEvent, addr 0x2280320, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method add_onConnectionFailedEvent, addr 0x2280060, size 0xb0, virtual true, abstract: false, final true
inline void add_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>*  value) ;

/// @brief Method add_onDisconnectedEvent, addr 0x227ff00, size 0xb0, virtual true, abstract: false, final true
inline void add_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>*  value) ;

/// @brief Method add_onInitializedEvent, addr 0x227fc90, size 0x9c, virtual true, abstract: false, final true
inline void add_onInitializedEvent(::System::Action*  value) ;

/// @brief Method add_onReceivedDataEvent, addr 0x2280480, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method get_connectionCount, addr 0x2280630, size 0x48, virtual true, abstract: false, final true
inline int32_t get_connectionCount() ;

/// @brief Method get_isConnected, addr 0x2280600, size 0x10, virtual true, abstract: false, final true
inline bool get_isConnected() ;

/// @brief Method get_isConnecting, addr 0x2280610, size 0x10, virtual true, abstract: false, final true
inline bool get_isConnecting() ;

/// @brief Method get_isConnectionOwner, addr 0x2280678, size 0x10, virtual true, abstract: false, final true
inline bool get_isConnectionOwner() ;

/// @brief Method get_isDisconnecting, addr 0x2280620, size 0x10, virtual true, abstract: false, final true
inline bool get_isDisconnecting() ;

/// @brief Method get_isDisposed, addr 0x2280688, size 0x10, virtual true, abstract: false, final true
inline bool get_isDisposed() ;

/// @brief Method get_serverUserId, addr 0x2280698, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_serverUserId() ;

/// @brief Method get_serverUserName, addr 0x22806a8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_serverUserName() ;

/// @brief Method get_userId, addr 0x22805e0, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_userId() ;

/// @brief Method get_userName, addr 0x22805f0, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_userName() ;
...
/// @brief Method remove_onConnectedEvent, addr 0x227fe64, size 0x9c, virtual true, abstract: false, final true
inline void remove_onConnectedEvent(::System::Action*  value) ;

/// @brief Method remove_onConnectionConnectedEvent, addr 0x2280270, size 0xb0, virtual true, abstract: false, final true
inline void remove_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>*  value) ;

/// @brief Method remove_onConnectionDisconnectedEvent, addr 0x22803d0, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method remove_onConnectionFailedEvent, addr 0x2280110, size 0xb0, virtual true, abstract: false, final true
inline void remove_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>*  value) ;

/// @brief Method remove_onDisconnectedEvent, addr 0x227ffb0, size 0xb0, virtual true, abstract: false, final true
inline void remove_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>*  value) ;

/// @brief Method remove_onInitializedEvent, addr 0x227fd2c, size 0x9c, virtual true, abstract: false, final true
inline void remove_onInitializedEvent(::System::Action*  value) ;

/// @brief Method remove_onReceivedDataEvent, addr 0x2280530, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method set_serverUserId, addr 0x22806a0, size 0x8, virtual false, abstract: false, final false
inline void set_serverUserId(::StringW  value) ;

/// @brief Method set_serverUserName, addr 0x22806b0, size 0x8, virtual false, abstract: false, final false
inline void set_serverUserName(::StringW  value) ;

/// @brief Method set_userId, addr 0x22805e8, size 0x8, virtual false, abstract: false, final false
inline void set_userId(::StringW  value) ;

/// @brief Method set_userName, addr 0x22805f8, size 0x8, virtual false, abstract: false, final false
inline void set_userName(::StringW  value) ;
