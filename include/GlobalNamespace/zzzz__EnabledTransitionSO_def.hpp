...
/// @brief Method .ctor, addr 0x4447904, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disabledState, addr 0x44478ec, size 0x8, virtual false, abstract: false, final false
inline bool get_disabledState() ;

/// @brief Method get_highlightedState, addr 0x44478dc, size 0x8, virtual false, abstract: false, final false
inline bool get_highlightedState() ;

/// @brief Method get_normalState, addr 0x44478d4, size 0x8, virtual false, abstract: false, final false
inline bool get_normalState() ;

/// @brief Method get_pressedState, addr 0x44478e4, size 0x8, virtual false, abstract: false, final false
inline bool get_pressedState() ;

/// @brief Method get_selectedAndHighlightedState, addr 0x44478fc, size 0x8, virtual false, abstract: false, final false
inline bool get_selectedAndHighlightedState() ;

/// @brief Method get_selectedState, addr 0x44478f4, size 0x8, virtual false, abstract: false, final false
