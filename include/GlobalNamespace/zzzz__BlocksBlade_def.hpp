...
/// @brief Method .ctor, addr 0x3b52950, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(offsetof(::GlobalNamespace::__BlocksBlade__Element, ___idx) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__BlocksBlade__Element, ___velocity) == 0x14, "Offset mismatch!");
...
/// @brief Method RandomPointOnCircle, addr 0x3b52ed0, size 0x4c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 RandomPointOnCircle(float_t  radius) ;

/// @brief Method SetUpElement, addr 0x3b52958, size 0x168, virtual false, abstract: false, final false
inline void SetUpElement(::GlobalNamespace::__BlocksBlade__Element*  element, float_t  velocity, ::UnityEngine::Color  color) ;

/// @brief Method Start, addr 0x3b52724, size 0x22c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3b52ac0, size 0x410, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b52f1c, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_color, addr 0x3b5270c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_color, addr 0x3b52718, size 0xc, virtual false, abstract: false, final false
