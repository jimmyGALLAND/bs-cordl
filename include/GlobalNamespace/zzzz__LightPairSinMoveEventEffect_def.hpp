...
/// @brief Method .ctor, addr 0x3aff908, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method HandleBeatmapEvent, addr 0x3affb08, size 0x15c, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

static inline ::GlobalNamespace::LightPairSinMoveEventEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3affaec, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3aff5f8, size 0x310, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3aff910, size 0x1dc, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateMovementData, addr 0x3affc64, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3affd9c, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;
