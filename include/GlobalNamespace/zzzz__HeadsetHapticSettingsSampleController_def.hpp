...
/// @brief Field _formattedFloatListSettingsController, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__formattedFloatListSettingsController, put=__cordl_internal_set__formattedFloatListSettingsController)) ::UnityW<::GlobalNamespace::FormattedFloatListSettingsController>  _formattedFloatListSettingsController;
...
/// @brief Method HandleHapticSettingValueDidChange, addr 0x3b7d3d8, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b7d2a4, size 0xcc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b7d208, size 0x9c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3b7d370, size 0x68, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b7d428, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
