...
/// @brief Method .ctor, addr 0x3b2ed94, size 0x28, virtual false, abstract: false, final false
...
/// @brief Field _inGameMenuController, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__inGameMenuController, put=__cordl_internal_set__inGameMenuController)) ::UnityW<::GlobalNamespace::MultiplayerLocalActivePlayerInGameMenuController>  _inGameMenuController;
...
/// @brief Method HandleGameEnergyDidReach0, addr 0x3b2e88c, size 0x28, virtual false, abstract: false, final false
inline void HandleGameEnergyDidReach0() ;

/// @brief Method HandleHmdUnmounted, addr 0x3b2ed40, size 0x4, virtual false, abstract: false, final false
inline void HandleHmdUnmounted() ;

/// @brief Method HandleInGameMenuControllerDidGiveUp, addr 0x3b2e8b4, size 0x4, virtual false, abstract: false, final false
inline void HandleInGameMenuControllerDidGiveUp() ;

/// @brief Method HandleInGameMenuControllerRequestsDisconnect, addr 0x3b2e8b8, size 0x40, virtual false, abstract: false, final false
inline void HandleInGameMenuControllerRequestsDisconnect() ;

/// @brief Method HandleInputFocusCaptured, addr 0x3b2df70, size 0x20, virtual false, abstract: false, final false
inline void HandleInputFocusCaptured() ;

/// @brief Method HandleInputFocusReleased, addr 0x3b2ed48, size 0x38, virtual false, abstract: false, final false
inline void HandleInputFocusReleased() ;

/// @brief Method HandleSongDidFinish, addr 0x3b2eb04, size 0x23c, virtual false, abstract: false, final false
inline void HandleSongDidFinish() ;

/// @brief Method HandleVrFocusWasCapturedEvent, addr 0x3b2ed44, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnApplicationFocus, addr 0x3b2ed80, size 0xc, virtual false, abstract: false, final false
inline void OnApplicationFocus(bool  hasFocus) ;

/// @brief Method OnDisable, addr 0x3b2df90, size 0x484, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method PerformPlayerFail, addr 0x3b2e414, size 0x23c, virtual false, abstract: false, final false
inline void PerformPlayerFail() ;

/// @brief Method PerformPlayerGivenUp, addr 0x3b2e650, size 0x23c, virtual false, abstract: false, final false
inline void PerformPlayerGivenUp() ;

/// @brief Method Start, addr 0x3b2db0c, size 0x464, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b2ed8c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
