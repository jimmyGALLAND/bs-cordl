...
/// @brief Method ResetToDefault, addr 0x26a88c0, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26a27f8, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x26a88d8, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::PracticeSettings*  practiceSettings) ;

/// @brief Method .ctor, addr 0x26a6c30, size 0x40, virtual false, abstract: false, final false
inline void _ctor(float_t  startSongTime, float_t  songSpeedMul) ;

/// @brief Method get_defaultPracticeSettings, addr 0x26a8854, size 0x6c, virtual false, abstract: false, final false
static inline ::GlobalNamespace::PracticeSettings* get_defaultPracticeSettings() ;

/// @brief Method get_songSpeedMul, addr 0x26a8830, size 0x8, virtual false, abstract: false, final false
inline float_t get_songSpeedMul() ;

/// @brief Method get_startInAdvanceAndClearNotes, addr 0x26a8840, size 0x8, virtual false, abstract: false, final false
inline bool get_startInAdvanceAndClearNotes() ;

/// @brief Method get_startSongTime, addr 0x26a8820, size 0x8, virtual false, abstract: false, final false
inline float_t get_startSongTime() ;

/// @brief Method set_songSpeedMul, addr 0x26a8838, size 0x8, virtual false, abstract: false, final false
inline void set_songSpeedMul(float_t  value) ;

/// @brief Method set_startInAdvanceAndClearNotes, addr 0x26a8848, size 0xc, virtual false, abstract: false, final false
inline void set_startInAdvanceAndClearNotes(bool  value) ;

/// @brief Method set_startSongTime, addr 0x26a8828, size 0x8, virtual false, abstract: false, final false
