...
/// @brief Method CanPlayHapticPreset, addr 0x39493f4, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method PlayHapticFeedback, addr 0x39493f0, size 0x4, virtual true, abstract: false, final true
inline void PlayHapticFeedback(::UnityEngine::XR::XRNode  node, ::Libraries::HM::HMLib::VR::HapticPresetSO*  hapticPreset) ;

/// @brief Method .ctor, addr 0x39493fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
