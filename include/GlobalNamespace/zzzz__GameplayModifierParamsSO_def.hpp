...
/// @brief Method .ctor, addr 0x26654f8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_descriptionLocalizationKey, addr 0x26654b8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_descriptionLocalizationKey() ;

/// @brief Method get_icon, addr 0x26654c0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_icon() ;

/// @brief Method get_isInBeta, addr 0x26654f0, size 0x8, virtual false, abstract: false, final false
inline bool get_isInBeta() ;

/// @brief Method get_modifierNameLocalizationKey, addr 0x26654b0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_modifierNameLocalizationKey() ;

/// @brief Method get_multiplier, addr 0x26654e0, size 0x8, virtual false, abstract: false, final false
inline float_t get_multiplier() ;

/// @brief Method get_multiplierConditionallyValid, addr 0x26654e8, size 0x8, virtual false, abstract: false, final false
inline bool get_multiplierConditionallyValid() ;

/// @brief Method get_mutuallyExclusives, addr 0x26654c8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_requiredBy, addr 0x26654d8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_requires, addr 0x26654d0, size 0x8, virtual false, abstract: false, final false
