...
/// @brief Method CalculateBadgeData, addr 0x268ab40, size 0x558, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x268b098, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
