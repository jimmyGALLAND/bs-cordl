...
/// @brief Field _objectiveValueFormater, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__objectiveValueFormater, put=__cordl_internal_set__objectiveValueFormater)) ::UnityW<::GlobalNamespace::ObjectiveValueFormatterSO>  _objectiveValueFormater;
...
/// @brief Method .ctor, addr 0x26874f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_noConditionValue, addr 0x26874e0, size 0x8, virtual false, abstract: false, final false
inline bool get_noConditionValue() ;

/// @brief Method get_objectiveName, addr 0x26874cc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_objectiveName() ;

/// @brief Method get_objectiveNameLocalized, addr 0x26874d4, size 0xc, virtual false, abstract: false, final false
inline ::StringW get_objectiveNameLocalized() ;

/// @brief Method get_objectiveValueFormater, addr 0x26874e8, size 0x8, virtual false, abstract: false, final false
