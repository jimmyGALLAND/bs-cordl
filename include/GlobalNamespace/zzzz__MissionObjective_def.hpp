...
/// @brief Field _referenceValueComparisonType, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__referenceValueComparisonType, put=__cordl_internal_set__referenceValueComparisonType)) ::GlobalNamespace::__MissionObjective__ReferenceValueComparisonType  _referenceValueComparisonType;
...
/// @brief Method Equals, addr 0x2687248, size 0x10c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x2687354, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26873b8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_referenceValue, addr 0x268716c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_referenceValue() ;

/// @brief Method get_referenceValueComparisonType, addr 0x2687164, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__MissionObjective__ReferenceValueComparisonType get_referenceValueComparisonType() ;

/// @brief Method get_type, addr 0x268715c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionObjectiveTypeSO> get_type() ;

/// @brief Method op_Equality, addr 0x2687174, size 0xbc, virtual false, abstract: false, final false
static inline bool op_Equality(::GlobalNamespace::MissionObjective*  obj1, ::GlobalNamespace::MissionObjective*  obj2) ;

/// @brief Method op_Inequality, addr 0x2687230, size 0x18, virtual false, abstract: false, final false
