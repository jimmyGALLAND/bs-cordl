...
// Ctor Parameters [CppParam { name: "graphic", ty: "::UnityW<::UnityEngine::UI::Graphic>", modifiers: "", def_value: None }, CppParam { name: "worldPos", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "fromMouse", ty: "bool", modifiers: "", def_value: None }]
...
/// @brief Method <GraphicRaycast>b__16_0, addr 0x3fb0790, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fb0788, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_RaycastResults, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RaycastResults, put=__cordl_internal_set_m_RaycastResults)) ::System::Collections::Generic::List_1<::GlobalNamespace::__OVRRaycaster__RaycastHit>*  m_RaycastResults;
...
static __declspec(property(get=getStaticF_s_SortedGraphics, put=setStaticF_s_SortedGraphics)) ::System::Collections::Generic::List_1<::GlobalNamespace::__OVRRaycaster__RaycastHit>*  s_SortedGraphics;
...
/// @brief Method GetScreenPosition, addr 0x3fb044c, size 0x38, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetScreenPosition(::UnityEngine::EventSystems::RaycastResult  raycastResult) ;

/// @brief Method GraphicRaycast, addr 0x3faf7c4, size 0x688, virtual false, abstract: false, final false
...
/// @brief Method IsFocussed, addr 0x3fb0484, size 0x118, virtual false, abstract: false, final false
inline bool IsFocussed() ;

static inline ::GlobalNamespace::OVRRaycaster* New_ctor() ;

/// @brief Method OnPointerEnter, addr 0x3fb059c, size 0x104, virtual true, abstract: false, final true
inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData*  e) ;

/// @brief Method RayIntersectsRectTransform, addr 0x3fb0178, size 0x2d4, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x3fafe4c, size 0x6c, virtual true, abstract: false, final false
inline void Raycast(::UnityEngine::EventSystems::PointerEventData*  eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>*  resultAppendList) ;

/// @brief Method Raycast, addr 0x3faf0fc, size 0x6c8, virtual false, abstract: false, final false
...
/// @brief Method RaycastPointer, addr 0x3fafeb8, size 0x2c0, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x3faefac, size 0x150, virtual true, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3faee54, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::List_1<::GlobalNamespace::__OVRRaycaster__RaycastHit>* getStaticF_s_SortedGraphics() ;

/// @brief Method get_canvas, addr 0x3faeef4, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Canvas> get_canvas() ;

/// @brief Method get_eventCamera, addr 0x3faef88, size 0x1c, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_eventCamera() ;

/// @brief Method get_sortOrderPriority, addr 0x3faefa4, size 0x8, virtual true, abstract: false, final false
