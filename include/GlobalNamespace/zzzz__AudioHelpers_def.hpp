...
public:
// Declarations
/// @brief Method DBToNormalizedVolume, addr 0x2266648, size 0x18, virtual false, abstract: false, final false
static inline float_t DBToNormalizedVolume(float_t  db) ;

/// @brief Method NormalizedVolumeToDB, addr 0x22665d4, size 0x74, virtual false, abstract: false, final false
