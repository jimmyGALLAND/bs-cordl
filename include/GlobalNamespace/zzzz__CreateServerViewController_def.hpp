...
/// @brief Field _createServerFormController, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get__createServerFormController, put=__cordl_internal_set__createServerFormController)) ::UnityW<::GlobalNamespace::CreateServerFormController>  _createServerFormController;
...
/// @brief Method ApplyAndGetData, addr 0x3adc154, size 0xbc, virtual false, abstract: false, final false
inline ::GlobalNamespace::CreateServerFormData ApplyAndGetData() ;

/// @brief Method DidActivate, addr 0x3adc054, size 0x100, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

static inline ::GlobalNamespace::CreateServerViewController* New_ctor() ;

/// @brief Method Setup, addr 0x3adc010, size 0x44, virtual false, abstract: false, final false
inline void Setup(::GlobalNamespace::MultiplayerModeSettings*  multiplayerModeSettings) ;

/// @brief Method <DidActivate>b__10_0, addr 0x3adc218, size 0x58, virtual false, abstract: false, final false
inline void _DidActivate_b__10_0() ;

/// @brief Method <DidActivate>b__10_1, addr 0x3adc270, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3adc210, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x3adbea8, size 0xb0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_2<bool,::GlobalNamespace::CreateServerFormData>*  value) ;

/// @brief Method get_multiplayerModeSettings, addr 0x3adc008, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MultiplayerModeSettings* get_multiplayerModeSettings() ;

/// @brief Method remove_didFinishEvent, addr 0x3adbf58, size 0xb0, virtual false, abstract: false, final false
