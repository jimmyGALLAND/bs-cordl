...
/// @brief Method .ctor, addr 0x395f740, size 0x44, virtual false, abstract: false, final false
inline void _ctor(int32_t  lightId, float_t  lightIntensity, float_t  probeMultiplier) ;

/// @brief Method get_intensity, addr 0x395f730, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method get_probeHighlightsIntensityMultiplier, addr 0x395f738, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _lightIntensityData, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightIntensityData, put=__cordl_internal_set__lightIntensityData)) ::ArrayW<::GlobalNamespace::__LightmapLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__LightmapLightWithIds__LightIntensitiesWithId*>*>  _lightIntensityData;
...
/// @brief Method Awake, addr 0x395f194, size 0x58, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method GetBakedLightsNormalizer, addr 0x395f224, size 0x8c, virtual false, abstract: false, final false
inline void GetBakedLightsNormalizer() ;

/// @brief Method GetLightWithIds, addr 0x395f710, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ProcessNewColorData, addr 0x395f388, size 0x388, virtual true, abstract: false, final false
inline void ProcessNewColorData() ;

/// @brief Method SetChannelColorDirect, addr 0x395f37c, size 0xc, virtual false, abstract: false, final false
inline void SetChannelColorDirect(::UnityEngine::Color  channelColor) ;

/// @brief Method SetDataToShaders, addr 0x395f328, size 0x54, virtual false, abstract: false, final false
inline void SetDataToShaders(::UnityEngine::Color  lightmapColor, ::UnityEngine::Color  probeColor) ;

/// @brief Method SetShaderProperties, addr 0x395f2b0, size 0x78, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__LightmapLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__LightmapLightWithIds__LightIntensitiesWithId*>*> const& __cordl_internal_get__lightIntensityData() const;

constexpr ::ArrayW<::GlobalNamespace::__LightmapLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__LightmapLightWithIds__LightIntensitiesWithId*>*>& __cordl_internal_get__lightIntensityData() ;
...
constexpr void __cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::__LightmapLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__LightmapLightWithIds__LightIntensitiesWithId*>*>  value) ;
...
/// @brief Method .ctor, addr 0x395f718, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bakeId, addr 0x395f18c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__LightConstants__BakeId get_bakeId() ;

/// @brief Method get_calculatedColorPreNormalization, addr 0x395f180, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_calculatedColorPreNormalization() ;

/// @brief Method get_intensity, addr 0x395f160, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method get_mixType, addr 0x395f158, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorMixAndWeightingApproach get_mixType() ;

/// @brief Method get_normalizerWeight, addr 0x395f170, size 0x8, virtual false, abstract: false, final false
inline float_t get_normalizerWeight() ;

/// @brief Method set_intensity, addr 0x395f168, size 0x8, virtual false, abstract: false, final false
inline void set_intensity(float_t  value) ;

/// @brief Method set_normalizerWeight, addr 0x395f178, size 0x8, virtual false, abstract: false, final false
