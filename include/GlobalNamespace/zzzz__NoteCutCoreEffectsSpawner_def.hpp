...
/// @brief Method HandleNoteWasCut, addr 0x3af4c08, size 0x194, virtual false, abstract: false, final false
inline void HandleNoteWasCut(::GlobalNamespace::NoteController*  noteController, ByRef<::GlobalNamespace::NoteCutInfo>  noteCutInfo) ;

/// @brief Method IsArcHapticsCurrentlyActive, addr 0x3af5214, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3af4b78, size 0x90, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method PlayHitChainNoteHapticEffect, addr 0x3af51bc, size 0x58, virtual false, abstract: false, final false
inline void PlayHitChainNoteHapticEffect(::GlobalNamespace::NoteCutInfo  noteCutInfo, bool  isChainHead) ;

/// @brief Method PlayHitNoteHapticEffect, addr 0x3af5078, size 0xf8, virtual false, abstract: false, final false
inline void PlayHitNoteHapticEffect(::GlobalNamespace::NoteCutInfo  noteCutInfo, ::GlobalNamespace::NoteData*  noteData) ;

/// @brief Method SpawnBombCutEffect, addr 0x3af5170, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method SpawnNoteCutEffect, addr 0x3af4d9c, size 0x2dc, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x3af4998, size 0x1e0, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ColorType,::UnityW<::GlobalNamespace::SliderInteractionManager>>*> const& __cordl_internal_get__colorTypeToSliderInteractionManagerDictionary() const;
...
/// @brief Method .ctor, addr 0x3af5b14, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
