...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::AudioClip> (::GlobalNamespace::IAssetSongPreviewAudioClipProvider::*)()>(&::GlobalNamespace::IAssetSongPreviewAudioClipProvider::get_songPreviewAudioClip)> {
