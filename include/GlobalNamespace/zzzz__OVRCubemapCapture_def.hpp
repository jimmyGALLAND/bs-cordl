...
/// @brief Method RenderIntoCubemap, addr 0x3f9dc4c, size 0x560, virtual false, abstract: false, final false
static inline void RenderIntoCubemap(::UnityEngine::Camera*  ownerCamera, ::UnityEngine::Cubemap*  outCubemap) ;

/// @brief Method SaveCubemapCapture, addr 0x3f9e1ac, size 0x798, virtual false, abstract: false, final false
static inline bool SaveCubemapCapture(::UnityEngine::Cubemap*  cubemap, ::StringW  pathName) ;

/// @brief Method TriggerCubemapCapture, addr 0x3f9d9a0, size 0x2ac, virtual false, abstract: false, final false
static inline void TriggerCubemapCapture(::UnityEngine::Vector3  capturePos, int32_t  cubemapSize, ::StringW  pathName) ;

/// @brief Method Update, addr 0x3f9d8f8, size 0xa8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3f9e944, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;
