...
static __declspec(property(get=getStaticF__numberOfActiveEnvironmentSpawnRotationObjects, put=setStaticF__numberOfActiveEnvironmentSpawnRotationObjects)) int32_t  _numberOfActiveEnvironmentSpawnRotationObjects;
...
/// @brief Method FixedUpdate, addr 0x3b06908, size 0x8c, virtual false, abstract: false, final false
inline void FixedUpdate() ;

/// @brief Method HandleSpawnRotationBeatmapEvent, addr 0x3b0680c, size 0xfc, virtual false, abstract: false, final false
inline void HandleSpawnRotationBeatmapEvent(::GlobalNamespace::SpawnRotationBeatmapEventData*  beatmapEventData) ;

/// @brief Method LateUpdate, addr 0x3b06994, size 0x120, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::EnvironmentSpawnRotation* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b067f0, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x3b06630, size 0x60, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3b065d0, size 0x60, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Start, addr 0x3b06690, size 0x160, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b06ab4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_targetRotation, addr 0x3b065c8, size 0x8, virtual false, abstract: false, final false
