...
/// @brief Method GetCopy, addr 0x2204e94, size 0x98, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapDataItem* GetCopy() ;

/// @brief Method Mirror, addr 0x2204f90, size 0x14, virtual true, abstract: false, final false
inline void Mirror(int32_t  lineCount) ;

/// @brief Method MirrorTransformOffsetDirection, addr 0x2204fa4, size 0x24, virtual false, abstract: false, final false
inline void MirrorTransformOffsetDirection() ;

static inline ::GlobalNamespace::WaypointData* New_ctor(float_t  time, float_t  beat, int32_t  lineIndex, ::GlobalNamespace::NoteLineLayer  lineLayer, ::GlobalNamespace::OffsetDirection  offsetDirection) ;
...
/// @brief Method .ctor, addr 0x2204f2c, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method get_lineIndex, addr 0x2204e74, size 0x8, virtual false, abstract: false, final false
inline int32_t get_lineIndex() ;

/// @brief Method get_lineLayer, addr 0x2204e84, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::NoteLineLayer get_lineLayer() ;

/// @brief Method get_offsetDirection, addr 0x2204e64, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OffsetDirection get_offsetDirection() ;

/// @brief Method set_lineIndex, addr 0x2204e7c, size 0x8, virtual false, abstract: false, final false
inline void set_lineIndex(int32_t  value) ;

/// @brief Method set_lineLayer, addr 0x2204e8c, size 0x8, virtual false, abstract: false, final false
inline void set_lineLayer(::GlobalNamespace::NoteLineLayer  value) ;

/// @brief Method set_offsetDirection, addr 0x2204e6c, size 0x8, virtual false, abstract: false, final false
