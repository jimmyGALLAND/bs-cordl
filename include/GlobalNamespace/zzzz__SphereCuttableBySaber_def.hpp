...
/// @brief Method Awake, addr 0x3b55fdc, size 0x2c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Cut, addr 0x3b56008, size 0x34, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b5603c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_canBeCut, addr 0x3b55fd4, size 0x8, virtual true, abstract: false, final false
inline bool get_canBeCut() ;

/// @brief Method get_radius, addr 0x3b55f80, size 0x1c, virtual true, abstract: false, final false
inline float_t get_radius() ;

/// @brief Method set_canBeCut, addr 0x3b55f9c, size 0x38, virtual true, abstract: false, final false
