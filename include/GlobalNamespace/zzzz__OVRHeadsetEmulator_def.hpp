...
/// @brief Method IsEmulationActivated, addr 0x3f250e8, size 0xc8, virtual false, abstract: false, final false
inline bool IsEmulationActivated() ;

/// @brief Method IsTweakingPitch, addr 0x3f251b0, size 0x7c, virtual false, abstract: false, final false
inline bool IsTweakingPitch() ;

static inline ::GlobalNamespace::OVRHeadsetEmulator* New_ctor() ;

/// @brief Method Start, addr 0x3f24c80, size 0x4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3f24c84, size 0x464, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3f2522c, size 0xc8, virtual false, abstract: false, final false
inline void _ctor() ;
