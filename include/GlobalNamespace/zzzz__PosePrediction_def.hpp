...
public:
// Declarations
/// @brief Method InterpolatePose, addr 0x229dcc4, size 0x2fc, virtual false, abstract: false, final false
static inline ::UnityEngine::Pose InterpolatePose(::UnityEngine::Pose  prev, ::UnityEngine::Pose  curr, float_t  t) ;

/// @brief Method InterpolatePoseSerializable, addr 0x229e0a0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method PredictPose, addr 0x229dbd4, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method PredictPoseSerializable, addr 0x229dfc0, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x229e190, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
