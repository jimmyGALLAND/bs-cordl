...
/// @brief Method DidActivate, addr 0x3adda6c, size 0x1a4, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3addc10, size 0x30, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleCancelButtonPressed, addr 0x3addcdc, size 0x24, virtual false, abstract: false, final false
inline void HandleCancelButtonPressed() ;

/// @brief Method HandleInputFieldChanged, addr 0x3addc40, size 0x38, virtual false, abstract: false, final false
inline void HandleInputFieldChanged(::HMUI::InputFieldView*  obj) ;

/// @brief Method HandleJoinButtonPressed, addr 0x3addca0, size 0x3c, virtual false, abstract: false, final false
inline void HandleJoinButtonPressed() ;

static inline ::GlobalNamespace::ServerCodeEntryViewController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3addc78, size 0x28, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3addd00, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x3add90c, size 0xb0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_2<bool,::StringW>*  value) ;

/// @brief Method remove_didFinishEvent, addr 0x3add9bc, size 0xb0, virtual false, abstract: false, final false
