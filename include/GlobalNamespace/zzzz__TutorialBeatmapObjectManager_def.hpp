...
/// @brief Method .ctor, addr 0x3ae84f0, size 0x28, virtual false, abstract: false, final false
...
/// @brief Field _tutorialNotePoolContainer, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__tutorialNotePoolContainer, put=__cordl_internal_set__tutorialNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::TutorialNoteController>>*  _tutorialNotePoolContainer;
...
/// @brief Method DespawnInternal, addr 0x3ae838c, size 0x100, virtual true, abstract: false, final false
inline void DespawnInternal(::GlobalNamespace::NoteController*  noteController) ;

/// @brief Method DespawnInternal, addr 0x3ae848c, size 0x58, virtual true, abstract: false, final false
inline void DespawnInternal(::GlobalNamespace::ObstacleController*  obstacleController) ;

/// @brief Method DespawnInternal, addr 0x3ae84e4, size 0x4, virtual true, abstract: false, final false
inline void DespawnInternal(::GlobalNamespace::SliderController*  sliderNoteController) ;

/// @brief Method Init, addr 0x3ae7fe0, size 0x12c, virtual false, abstract: false, final false
inline void Init(::GlobalNamespace::__TutorialBeatmapObjectManager__InitData*  initData, ::GlobalNamespace::__TutorialNoteController__Pool*  tutorialNotePool, ::GlobalNamespace::__BombNoteController__Pool*  bombNotePool, ::GlobalNamespace::__ObstacleController__Pool*  obstaclePool) ;

static inline ::GlobalNamespace::TutorialBeatmapObjectManager* New_ctor() ;

/// @brief Method ProcessNoteData, addr 0x3ae8204, size 0x184, virtual true, abstract: false, final false
...
/// @brief Method ProcessObstacleData, addr 0x3ae810c, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method ProcessSliderData, addr 0x3ae8388, size 0x4, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::TutorialNoteController>>*> const& __cordl_internal_get__tutorialNotePoolContainer() const;
...
/// @brief Method .ctor, addr 0x3ae84e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_activeObstacleControllers, addr 0x3ae7f90, size 0x50, virtual true, abstract: false, final false
