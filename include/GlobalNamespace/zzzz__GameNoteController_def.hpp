...
/// @brief Method .ctor, addr 0x3a616dc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Awake, addr 0x3a60b94, size 0x158, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleBigWasCutBySaber, addr 0x3a61034, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method HandleCut, addr 0x3a6104c, size 0x580, virtual false, abstract: false, final false
...
/// @brief Method HandleSmallWasCutBySaber, addr 0x3a615cc, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method HiddenStateDidChange, addr 0x3a616a4, size 0x24, virtual true, abstract: false, final false
inline void HiddenStateDidChange(bool  hide) ;

/// @brief Method Init, addr 0x3a608ec, size 0x2a8, virtual false, abstract: false, final false
...
/// @brief Method NoteDidPassMissedMarker, addr 0x3a60ec0, size 0xbc, virtual true, abstract: false, final false
inline void NoteDidPassMissedMarker() ;

/// @brief Method NoteDidStartDissolving, addr 0x3a60f7c, size 0xb8, virtual true, abstract: false, final false
inline void NoteDidStartDissolving() ;

/// @brief Method NoteDidStartJump, addr 0x3a615e4, size 0xc0, virtual true, abstract: false, final false
inline void NoteDidStartJump() ;

/// @brief Method OnDestroy, addr 0x3a60cec, size 0x1d4, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Pause, addr 0x3a616c8, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a616d8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_cubeNoteControllerDidInitEvent, addr 0x3a60774, size 0xb0, virtual true, abstract: false, final true
inline void add_cubeNoteControllerDidInitEvent(::System::Action_1<::UnityW<::GlobalNamespace::GameNoteController>>*  value) ;

/// @brief Method get_gameplayType, addr 0x3a608e4, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::__NoteData__GameplayType get_gameplayType() ;

/// @brief Method get_noteMovement, addr 0x3a608d4, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::GlobalNamespace::NoteMovement> get_noteMovement() ;

/// @brief Method get_noteVisualModifierType, addr 0x3a608dc, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method remove_cubeNoteControllerDidInitEvent, addr 0x3a60824, size 0xb0, virtual true, abstract: false, final true
