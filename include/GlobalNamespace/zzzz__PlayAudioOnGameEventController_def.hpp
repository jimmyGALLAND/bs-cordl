...
/// @brief Field _localizedAudioClips, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__localizedAudioClips, put=__cordl_internal_set__localizedAudioClips)) ::ArrayW<::UnityW<::GlobalNamespace::LocalizedAudioClipSO>,::Array<::UnityW<::GlobalNamespace::LocalizedAudioClipSO>>*>  _localizedAudioClips;

/// @brief Field _randomObjectPicker, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__randomObjectPicker, put=__cordl_internal_set__randomObjectPicker)) ::GlobalNamespace::RandomObjectPicker_1<::UnityW<::GlobalNamespace::LocalizedAudioClipSO>>*  _randomObjectPicker;
...
/// @brief Method Deinit, addr 0x3a4ee5c, size 0x90, virtual false, abstract: false, final false
inline void Deinit() ;

/// @brief Method HandleGameEvent, addr 0x3a4eef4, size 0xc0, virtual false, abstract: false, final false
inline void HandleGameEvent() ;

/// @brief Method Init, addr 0x3a4ed10, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a4efb4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _eventAudioBindings, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__eventAudioBindings, put=__cordl_internal_set__eventAudioBindings)) ::ArrayW<::GlobalNamespace::__PlayAudioOnGameEventController__EventAudioBinding*,::Array<::GlobalNamespace::__PlayAudioOnGameEventController__EventAudioBinding*>*>  _eventAudioBindings;

/// @brief Method Awake, addr 0x3a4ecac, size 0x64, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::PlayAudioOnGameEventController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3a4ee00, size 0x5c, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__PlayAudioOnGameEventController__EventAudioBinding*,::Array<::GlobalNamespace::__PlayAudioOnGameEventController__EventAudioBinding*>*> const& __cordl_internal_get__eventAudioBindings() const;

constexpr ::ArrayW<::GlobalNamespace::__PlayAudioOnGameEventController__EventAudioBinding*,::Array<::GlobalNamespace::__PlayAudioOnGameEventController__EventAudioBinding*>*>& __cordl_internal_get__eventAudioBindings() ;

constexpr void __cordl_internal_set__audioClipQueue(::UnityW<::GlobalNamespace::AudioClipQueue>  value) ;

constexpr void __cordl_internal_set__eventAudioBindings(::ArrayW<::GlobalNamespace::__PlayAudioOnGameEventController__EventAudioBinding*,::Array<::GlobalNamespace::__PlayAudioOnGameEventController__EventAudioBinding*>*>  value) ;

/// @brief Method .ctor, addr 0x3a4eeec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
