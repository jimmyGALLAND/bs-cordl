...
/// @brief Method .ctor, addr 0x26a3690, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allSongPackSerializedName, addr 0x26a3688, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_allSongPackSerializedName() ;

/// @brief Method get_buildInSongPackSerializedName, addr 0x26a3680, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_buildInSongPackSerializedName() ;

/// @brief Method get_defaultLastSelectedBeatmapCharacteristic, addr 0x26a3678, size 0x8, virtual false, abstract: false, final false
