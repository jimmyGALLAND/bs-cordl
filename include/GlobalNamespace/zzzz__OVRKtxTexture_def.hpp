...
public:
// Declarations
/// @brief Method Load, addr 0x3f32b2c, size 0x254, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f32d80, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
