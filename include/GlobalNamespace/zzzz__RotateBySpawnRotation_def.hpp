...
/// @brief Method FixedUpdate, addr 0x3b07df4, size 0x8c, virtual false, abstract: false, final false
inline void FixedUpdate() ;

/// @brief Method HandleSpawnRotationBeatmapEvent, addr 0x3b07d58, size 0x9c, virtual false, abstract: false, final false
inline void HandleSpawnRotationBeatmapEvent(::GlobalNamespace::SpawnRotationBeatmapEventData*  beatmapEventData) ;

/// @brief Method LateUpdate, addr 0x3b07e80, size 0xc0, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::RotateBySpawnRotation* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b07d3c, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b07bfc, size 0x140, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b07f40, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
