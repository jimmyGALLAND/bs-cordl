...
/// @brief Method .ctor, addr 0x269a960, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_applicationVersion, addr 0x269a958, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_applicationVersion() ;

/// @brief Method get_masterVersion, addr 0x269a950, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _latestBuildVersion, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__latestBuildVersion, put=__cordl_internal_set__latestBuildVersion)) ::GlobalNamespace::__PS4PublisherSKUSettingsSO__PS4BuildVersion*  _latestBuildVersion;
...
/// @brief Method .ctor, addr 0x269a940, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_applicationCategory, addr 0x269a938, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::PS4ApplicationCategory get_applicationCategory() ;

/// @brief Method get_buildVersion, addr 0x269a910, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__PS4PublisherSKUSettingsSO__PS4BuildVersion* get_buildVersion() ;

/// @brief Method get_defaultAgeRestriction, addr 0x269a930, size 0x8, virtual false, abstract: false, final false
inline int32_t get_defaultAgeRestriction() ;

/// @brief Method get_latestBuildVersion, addr 0x269a918, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__PS4PublisherSKUSettingsSO__PS4BuildVersion* get_latestBuildVersion() ;

/// @brief Method get_npTitleFilenamePath, addr 0x269a928, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_npTitleFilenamePath() ;

/// @brief Method get_parentalLockLevel, addr 0x269a920, size 0x8, virtual false, abstract: false, final false
