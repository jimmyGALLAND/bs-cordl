...
/// @brief Field <currentViewState>k__BackingField, offset 0x30, size 0x4 
 __declspec(property(get=__cordl_internal_get__currentViewState_k__BackingField, put=__cordl_internal_set__currentViewState_k__BackingField)) ::GlobalNamespace::__SelectableStateController__ViewState  _currentViewState_k__BackingField;
...
/// @brief Field stateDidChangeEvent, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_stateDidChangeEvent, put=__cordl_internal_set_stateDidChangeEvent)) ::System::Action_2<::GlobalNamespace::__SelectableStateController__ViewState,bool>*  stateDidChangeEvent;
...
/// @brief Method SetState, addr 0x4446cdc, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4446d00, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_stateDidChangeEvent, addr 0x4443df0, size 0xb0, virtual false, abstract: false, final false
inline void add_stateDidChangeEvent(::System::Action_2<::GlobalNamespace::__SelectableStateController__ViewState,bool>*  value) ;

/// @brief Method get_currentViewState, addr 0x4446ccc, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__SelectableStateController__ViewState get_currentViewState() ;

/// @brief Method get_tweeningManager, addr 0x4446cc4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::Tweening::TimeTweeningManager> get_tweeningManager() ;

/// @brief Method remove_stateDidChangeEvent, addr 0x4443f2c, size 0xb0, virtual false, abstract: false, final false
inline void remove_stateDidChangeEvent(::System::Action_2<::GlobalNamespace::__SelectableStateController__ViewState,bool>*  value) ;

/// @brief Method set_currentViewState, addr 0x4446cd4, size 0x8, virtual false, abstract: false, final false
