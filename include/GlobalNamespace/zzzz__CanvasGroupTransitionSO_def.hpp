...
/// @brief Method .ctor, addr 0x444787c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disabledAlpha, addr 0x4447864, size 0x8, virtual false, abstract: false, final false
inline float_t get_disabledAlpha() ;

/// @brief Method get_highlightedAlpha, addr 0x4447854, size 0x8, virtual false, abstract: false, final false
inline float_t get_highlightedAlpha() ;

/// @brief Method get_normalAlpha, addr 0x444784c, size 0x8, virtual false, abstract: false, final false
inline float_t get_normalAlpha() ;

/// @brief Method get_pressedAlpha, addr 0x444785c, size 0x8, virtual false, abstract: false, final false
inline float_t get_pressedAlpha() ;

/// @brief Method get_selectedAlpha, addr 0x444786c, size 0x8, virtual false, abstract: false, final false
inline float_t get_selectedAlpha() ;

/// @brief Method get_selectedAndHighlightedAlpha, addr 0x4447874, size 0x8, virtual false, abstract: false, final false
