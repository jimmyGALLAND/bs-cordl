...
/// @brief Method SetProperty, addr 0x3963014, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39630ac, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
