...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::IUnityXRHapticsHandler::*)(float_t, float_t)>(&::GlobalNamespace::IUnityXRHapticsHandler::TriggerHapticPulse)> {
