...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo::*)()>(&::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo::get_levelID)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2684dd8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo*>::get(),
                        "get_levelID",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::GlobalNamespace::PromoBannerInfoSO> (::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo::*)()>(&::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo::get_promoBannerInfo)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2684de0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo::*)()>(&::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2684de8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo*,::Array<::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo*>*> (::GlobalNamespace::PackPromoInfoSO::*)()>(&::GlobalNamespace::PackPromoInfoSO::get_levelPromoInfos)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2684dc8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::PackPromoInfoSO::*)()>(&::GlobalNamespace::PackPromoInfoSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2684dd0;
...
constexpr ::ArrayW<::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo*,::Array<::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo*>*>& GlobalNamespace::PackPromoInfoSO::__cordl_internal_get__levelsPromoInfo()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____levelsPromoInfo;
}
constexpr ::ArrayW<::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo*,::Array<::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo*>*> const& GlobalNamespace::PackPromoInfoSO::__cordl_internal_get__levelsPromoInfo() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____levelsPromoInfo;
}
constexpr void GlobalNamespace::PackPromoInfoSO::__cordl_internal_set__levelsPromoInfo(::ArrayW<::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo*,::Array<::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo*,::Array<::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo*>*>, false>(this, ___internal_method);
}
