...
/// @brief Field _countdownElementControllerQueue, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__countdownElementControllerQueue, put=__cordl_internal_set__countdownElementControllerQueue)) ::System::Collections::Generic::Queue_1<::UnityW<::GlobalNamespace::CountdownElementController>>*  _countdownElementControllerQueue;

/// @brief Field _countdownElementControllers, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__countdownElementControllers, put=__cordl_internal_set__countdownElementControllers)) ::ArrayW<::UnityW<::GlobalNamespace::CountdownElementController>,::Array<::UnityW<::GlobalNamespace::CountdownElementController>>*>  _countdownElementControllers;
...
/// @brief Method Awake, addr 0x3b76fb8, size 0x18, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::CountdownController* New_ctor() ;

/// @brief Method StartCountdown, addr 0x3b77210, size 0xf4, virtual false, abstract: false, final false
inline void StartCountdown(int64_t  countdownEndTime) ;

/// @brief Method StopCountdown, addr 0x3b77390, size 0x78, virtual false, abstract: false, final false
inline void StopCountdown() ;

/// @brief Method Update, addr 0x3b76fd0, size 0x1dc, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateCountdown, addr 0x3b77328, size 0x68, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Queue_1<::UnityW<::GlobalNamespace::CountdownElementController>>*> const& __cordl_internal_get__countdownElementControllerQueue() const;

constexpr ::ArrayW<::UnityW<::GlobalNamespace::CountdownElementController>,::Array<::UnityW<::GlobalNamespace::CountdownElementController>>*> const& __cordl_internal_get__countdownElementControllers() const;
...
constexpr void __cordl_internal_set__countdownElementControllers(::ArrayW<::UnityW<::GlobalNamespace::CountdownElementController>,::Array<::UnityW<::GlobalNamespace::CountdownElementController>>*>  value) ;
...
/// @brief Method .ctor, addr 0x3b77408, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;
