...
/// @brief Method .ctor, addr 0x3a6ca1c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x3a6ca64, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x3a6caac, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetLengthFromSliderData, addr 0x3a6c9c4, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method GetPool, addr 0x3a6c924, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a6c8e8, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x3a6caf8, size 0x3f0, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::GlobalNamespace::__SliderController___DissolveCoroutine_d__70* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3a6cee8, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x3a6cef0, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3a6cf28, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x3a6caf4, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a6bef8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Field _attractingSaber, offset 0xd0, size 0x1 
...
/// @brief Field _beatmapObjectManager, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapObjectManager, put=__cordl_internal_set__beatmapObjectManager)) ::GlobalNamespace::BeatmapObjectManager*  _beatmapObjectManager;

/// @brief Field _beatmapObjectSpawnController, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapObjectSpawnController, put=__cordl_internal_set__beatmapObjectSpawnController)) ::GlobalNamespace::IBeatmapObjectSpawnController*  _beatmapObjectSpawnController;
...
/// @brief Field _closeSmoothedSaberInteractionPos, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get__closeSmoothedSaberInteractionPos, put=__cordl_internal_set__closeSmoothedSaberInteractionPos)) ::GlobalNamespace::FixedUpdateVector3SmoothValue*  _closeSmoothedSaberInteractionPos;

/// @brief Field _colorManager, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__colorManager, put=__cordl_internal_set__colorManager)) ::GlobalNamespace::ColorManager*  _colorManager;

/// @brief Field _headJumpOffsetY, offset 0xb8, size 0x4 
...
/// @brief Field _sliderData, offset 0xa8, size 0x8 
...
/// @brief Field _sliderDidDissolve, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get__sliderDidDissolve, put=__cordl_internal_set__sliderDidDissolve)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderDidDissolveEvent*>*  _sliderDidDissolve;

/// @brief Field _sliderDidFinishMovement, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__sliderDidFinishMovement, put=__cordl_internal_set__sliderDidFinishMovement)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderDidFinishJumpEvent*>*  _sliderDidFinishMovement;

/// @brief Field _sliderDidStartDissolving, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__sliderDidStartDissolving, put=__cordl_internal_set__sliderDidStartDissolving)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderDidStartDissolvingEvent*>*  _sliderDidStartDissolving;

/// @brief Field _sliderDuration, offset 0xbc, size 0x4 
...
/// @brief Field _sliderHeadDidMovePastCutMark, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__sliderHeadDidMovePastCutMark, put=__cordl_internal_set__sliderHeadDidMovePastCutMark)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderHeadDidMovePastCutMarkEvent*>*  _sliderHeadDidMovePastCutMark;
...
/// @brief Field _sliderTailDidMovePastCutMark, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get__sliderTailDidMovePastCutMark, put=__cordl_internal_set__sliderTailDidMovePastCutMark)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderTailDidMovePastCutMarkEvent*>*  _sliderTailDidMovePastCutMark;

/// @brief Field _zDistanceBetweenNotes, offset 0xd8, size 0x4 
...
/// @brief Method Awake, addr 0x3a6b704, size 0x15c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Dissolve, addr 0x3a6bf20, size 0x60, virtual true, abstract: false, final true
inline void Dissolve(float_t  duration) ;

/// @brief Method DissolveCoroutine, addr 0x3a6be88, size 0x70, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* DissolveCoroutine(float_t  duration) ;

/// @brief Method FixedUpdate, addr 0x3a6bdf4, size 0x58, virtual false, abstract: false, final false
inline void FixedUpdate() ;

/// @brief Method GetSaberInteractionPoint, addr 0x3a6b594, size 0x54, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 GetSaberInteractionPoint(::GlobalNamespace::Saber*  saber) ;

/// @brief Method HandleFadeInDidStart, addr 0x3a6c744, size 0x8, virtual false, abstract: false, final false
inline void HandleFadeInDidStart() ;

/// @brief Method HandleHeadDidMovePastCutMark, addr 0x3a6c268, size 0x1e0, virtual false, abstract: false, final false
inline void HandleHeadDidMovePastCutMark() ;

/// @brief Method HandleMovementDidFinish, addr 0x3a6c0a4, size 0x1c4, virtual false, abstract: false, final false
inline void HandleMovementDidFinish() ;

/// @brief Method HandleNoteWasCut, addr 0x3a6c6c4, size 0x80, virtual false, abstract: false, final false
inline void HandleNoteWasCut(::GlobalNamespace::NoteController*  noteController, ByRef<::GlobalNamespace::NoteCutInfo>  noteCutInfo) ;

/// @brief Method HandleNoteWasMissed, addr 0x3a6c648, size 0x4c, virtual false, abstract: false, final false
inline void HandleNoteWasMissed(::GlobalNamespace::NoteController*  noteController) ;

/// @brief Method HandleTailDidMovePastCutMark, addr 0x3a6c478, size 0x1d0, virtual false, abstract: false, final false
inline void HandleTailDidMovePastCutMark() ;

/// @brief Method Hide, addr 0x3a6bf80, size 0x2c, virtual true, abstract: false, final true
inline void Hide(bool  hide) ;

/// @brief Method Init, addr 0x3a6b04c, size 0x3d0, virtual false, abstract: false, final false
...
/// @brief Method IsNoteStartOfThisSlider, addr 0x3a6bfbc, size 0xe8, virtual false, abstract: false, final false
inline bool IsNoteStartOfThisSlider(::GlobalNamespace::NoteData*  noteData) ;

/// @brief Method ManualUpdate, addr 0x3a6bd7c, size 0x78, virtual false, abstract: false, final false
inline void ManualUpdate() ;

static inline ::GlobalNamespace::SliderController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3a6ba40, size 0x29c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Pause, addr 0x3a6bfac, size 0x10, virtual true, abstract: false, final true
inline void Pause(bool  pause) ;

/// @brief Method SetSaberAttraction, addr 0x3a6b510, size 0x84, virtual false, abstract: false, final false
inline void SetSaberAttraction(bool  saberAttraction) ;

/// @brief Method Start, addr 0x3a6b860, size 0x144, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3a6bd78, size 0x4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateMaterialPropertyBlock, addr 0x3a6b5e8, size 0x11c, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderDidStartDissolvingEvent*>*> const& __cordl_internal_get__sliderDidStartDissolving() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderHeadDidMovePastCutMarkEvent*>*> const& __cordl_internal_get__sliderHeadDidMovePastCutMark() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderTailDidMovePastCutMarkEvent*>*> const& __cordl_internal_get__sliderTailDidMovePastCutMark() const;
...
/// @brief Method .ctor, addr 0x3a6c74c, size 0x19c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_closeSmoothedSaberInteractionPos, addr 0x3a6b03c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::FixedUpdateVector3SmoothValue* get_closeSmoothedSaberInteractionPos() ;

/// @brief Method get_headJumpOffsetY, addr 0x3a6b02c, size 0x8, virtual false, abstract: false, final false
inline float_t get_headJumpOffsetY() ;

/// @brief Method get_initColor, addr 0x3a6b008, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_initColor() ;

/// @brief Method get_jumpDistance, addr 0x3a6b024, size 0x8, virtual false, abstract: false, final false
inline float_t get_jumpDistance() ;

/// @brief Method get_lengthType, addr 0x3a6af80, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__SliderController__LengthType get_lengthType() ;

/// @brief Method get_randomValue, addr 0x3a6b014, size 0x8, virtual false, abstract: false, final false
inline float_t get_randomValue() ;

/// @brief Method get_saberInteractionParam, addr 0x3a6af90, size 0x40, virtual false, abstract: false, final false
inline float_t get_saberInteractionParam() ;

/// @brief Method get_sliderData, addr 0x3a6af88, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::SliderData* get_sliderData() ;

/// @brief Method get_sliderDidDissolveEvent, addr 0x3a6af68, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::ISliderDidDissolveEvent*>* get_sliderDidDissolveEvent() ;

/// @brief Method get_sliderDidFinishJumpEvent, addr 0x3a6af58, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::ISliderDidFinishJumpEvent*>* get_sliderDidFinishJumpEvent() ;

/// @brief Method get_sliderDidStartDissolvingEvent, addr 0x3a6af60, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_sliderDuration, addr 0x3a6b034, size 0x8, virtual false, abstract: false, final false
inline float_t get_sliderDuration() ;

/// @brief Method get_sliderHeadDidMovePastCutMark, addr 0x3a6af70, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_sliderIntensityEffect, addr 0x3a6b044, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::SliderIntensityEffect> get_sliderIntensityEffect() ;

/// @brief Method get_sliderMeshController, addr 0x3a6aff8, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::SliderMeshController> get_sliderMeshController() ;

/// @brief Method get_sliderMovement, addr 0x3a6b000, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::SliderMovement> get_sliderMovement() ;

/// @brief Method get_sliderTailDidMovePastCutMark, addr 0x3a6af78, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_zDistanceBetweenNotes, addr 0x3a6b01c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _beatmapObjectSpawnController, offset: 0x58, size: 0x8, def value: None
...
/// @brief Field _beatmapObjectManager, offset: 0x68, size: 0x8, def value: None
 ::GlobalNamespace::BeatmapObjectManager*  ____beatmapObjectManager;

/// @brief Field _saberManager, offset: 0x70, size: 0x8, def value: None
 ::UnityW<::GlobalNamespace::SaberManager>  ____saberManager;

/// @brief Field _sliderDidFinishMovement, offset: 0x78, size: 0x8, def value: None
 ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderDidFinishJumpEvent*>*  ____sliderDidFinishMovement;

/// @brief Field _sliderDidStartDissolving, offset: 0x80, size: 0x8, def value: None
 ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderDidStartDissolvingEvent*>*  ____sliderDidStartDissolving;

/// @brief Field _sliderDidDissolve, offset: 0x88, size: 0x8, def value: None
 ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderDidDissolveEvent*>*  ____sliderDidDissolve;

/// @brief Field _sliderHeadDidMovePastCutMark, offset: 0x90, size: 0x8, def value: None
 ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderHeadDidMovePastCutMarkEvent*>*  ____sliderHeadDidMovePastCutMark;

/// @brief Field _sliderTailDidMovePastCutMark, offset: 0x98, size: 0x8, def value: None
 ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderTailDidMovePastCutMarkEvent*>*  ____sliderTailDidMovePastCutMark;

/// @brief Field _lengthType, offset: 0xa0, size: 0x4, def value: None
 ::GlobalNamespace::__SliderController__LengthType  ____lengthType;

/// @brief Field _sliderData, offset: 0xa8, size: 0x8, def value: None
 ::GlobalNamespace::SliderData*  ____sliderData;

/// @brief Field _saber, offset: 0xb0, size: 0x8, def value: None
 ::UnityW<::GlobalNamespace::Saber>  ____saber;

/// @brief Field _headJumpOffsetY, offset: 0xb8, size: 0x4, def value: None
 float_t  ____headJumpOffsetY;

/// @brief Field _sliderDuration, offset: 0xbc, size: 0x4, def value: None
 float_t  ____sliderDuration;

/// @brief Field _initColor, offset: 0xc0, size: 0x10, def value: None
 ::UnityEngine::Color  ____initColor;

/// @brief Field _attractingSaber, offset: 0xd0, size: 0x1, def value: None
 bool  ____attractingSaber;

/// @brief Field _randomValue, offset: 0xd4, size: 0x4, def value: None
 float_t  ____randomValue;

/// @brief Field _zDistanceBetweenNotes, offset: 0xd8, size: 0x4, def value: None
 float_t  ____zDistanceBetweenNotes;

/// @brief Field _jumpDistance, offset: 0xdc, size: 0x4, def value: None
 float_t  ____jumpDistance;

/// @brief Field _closeSmoothedSaberInteractionPos, offset: 0xe0, size: 0x8, def value: None
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::SliderController, 0xe8>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::SliderController, ____beatmapObjectSpawnController) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____colorManager) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____beatmapObjectManager) == 0x68, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____saberManager) == 0x70, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderDidFinishMovement) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderDidStartDissolving) == 0x80, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderDidDissolve) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderHeadDidMovePastCutMark) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderTailDidMovePastCutMark) == 0x98, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____lengthType) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderData) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____saber) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____headJumpOffsetY) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____sliderDuration) == 0xbc, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____initColor) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____attractingSaber) == 0xd0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____randomValue) == 0xd4, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____zDistanceBetweenNotes) == 0xd8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____jumpDistance) == 0xdc, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SliderController, ____closeSmoothedSaberInteractionPos) == 0xe0, "Offset mismatch!");
