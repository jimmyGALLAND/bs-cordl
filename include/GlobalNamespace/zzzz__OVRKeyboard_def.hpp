...
/// @brief Method GetKeyboardState, addr 0x3f8a604, size 0x148, virtual false, abstract: false, final false
static inline ::GlobalNamespace::__OVRKeyboard__TrackedKeyboardState GetKeyboardState() ;

/// @brief Method GetSystemKeyboardInfo, addr 0x3f8a74c, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method StopKeyboardTracking, addr 0x3f8a834, size 0x50, virtual false, abstract: false, final false
