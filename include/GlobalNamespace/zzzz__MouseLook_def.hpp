...
/// @brief Method ClampRotationAroundXAxis, addr 0x3a83d2c, size 0x64, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion ClampRotationAroundXAxis(::UnityEngine::Quaternion  q) ;

/// @brief Method Init, addr 0x3a83094, size 0x6c, virtual false, abstract: false, final false
inline void Init(::UnityEngine::Transform*  character, ::UnityEngine::Transform*  camera) ;

/// @brief Method InternalLockUpdate, addr 0x3a83da0, size 0x78, virtual false, abstract: false, final false
inline void InternalLockUpdate() ;

/// @brief Method LookRotation, addr 0x3a83714, size 0x358, virtual false, abstract: false, final false
...
/// @brief Method SetCursorLock, addr 0x3a83100, size 0x34, virtual false, abstract: false, final false
inline void SetCursorLock(bool  value) ;

/// @brief Method SetRotations, addr 0x3a83d18, size 0x14, virtual false, abstract: false, final false
inline void SetRotations(::UnityEngine::Quaternion  characterRotation, ::UnityEngine::Quaternion  cameraRotation) ;

/// @brief Method UpdateCursorLock, addr 0x3a83d90, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a83bf0, size 0x34, virtual false, abstract: false, final false
inline void _ctor() ;
