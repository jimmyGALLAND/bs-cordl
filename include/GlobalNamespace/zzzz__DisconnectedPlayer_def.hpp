...
/// @brief Method HasState, addr 0x22775fc, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2277604, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::StringW  userId, ::StringW  userName, int32_t  sortIndex) ;

/// @brief Method get_currentLatency, addr 0x22775b8, size 0x8, virtual true, abstract: false, final true
inline int64_t get_currentLatency() ;

/// @brief Method get_disconnectedReason, addr 0x22775c8, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::DisconnectedReason get_disconnectedReason() ;

/// @brief Method get_hasValidLatency, addr 0x22775b0, size 0x8, virtual true, abstract: false, final true
inline bool get_hasValidLatency() ;

/// @brief Method get_isConnected, addr 0x22775c0, size 0x8, virtual true, abstract: false, final true
inline bool get_isConnected() ;

/// @brief Method get_isConnectionOwner, addr 0x22775d0, size 0x8, virtual true, abstract: false, final true
inline bool get_isConnectionOwner() ;

/// @brief Method get_isFailed, addr 0x2277580, size 0x8, virtual false, abstract: false, final false
inline bool get_isFailed() ;

/// @brief Method get_isKicked, addr 0x22775f4, size 0x8, virtual true, abstract: false, final true
inline bool get_isKicked() ;

/// @brief Method get_isMe, addr 0x2277588, size 0x8, virtual true, abstract: false, final true
inline bool get_isMe() ;

/// @brief Method get_multiplayerAvatarsData, addr 0x22775e0, size 0x14, virtual true, abstract: false, final true
inline ::GlobalNamespace::MultiplayerAvatarsData get_multiplayerAvatarsData() ;

/// @brief Method get_offsetSyncTime, addr 0x2277578, size 0x8, virtual true, abstract: false, final true
inline int64_t get_offsetSyncTime() ;

/// @brief Method get_sortIndex, addr 0x22775d8, size 0x8, virtual true, abstract: false, final true
inline int32_t get_sortIndex() ;

/// @brief Method get_userId, addr 0x2277590, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_userId() ;

/// @brief Method get_userName, addr 0x22775a0, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_userId, addr 0x2277598, size 0x8, virtual false, abstract: false, final false
inline void set_userId(::StringW  value) ;

/// @brief Method set_userName, addr 0x22775a8, size 0x8, virtual false, abstract: false, final false
