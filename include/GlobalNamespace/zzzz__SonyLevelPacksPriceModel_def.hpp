...
/// @brief Method .ctor, addr 0x269b800, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_levelsCount, addr 0x269b7f8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_levelsCount() ;

/// @brief Method get_pricePerBundle, addr 0x269b7f0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _pricePairBundlePairs, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__pricePairBundlePairs, put=__cordl_internal_set__pricePairBundlePairs)) ::ArrayW<::GlobalNamespace::__SonyLevelPacksPriceModel__PricePerBundlePair*,::Array<::GlobalNamespace::__SonyLevelPacksPriceModel__PricePerBundlePair*>*>  _pricePairBundlePairs;
...
/// @brief Field _pricePerLevel, offset 0x18, size 0x4 
 ...
 __declspec(property(get=get_pricePairBundlePairs)) ::ArrayW<::GlobalNamespace::__SonyLevelPacksPriceModel__PricePerBundlePair*,::Array<::GlobalNamespace::__SonyLevelPacksPriceModel__PricePerBundlePair*>*>  pricePairBundlePairs;

 __declspec(property(get=get_pricePerLevel)) float_t  pricePerLevel;

/// @brief Method GetPricePerBundlePair, addr 0x269b730, size 0x5c, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__SonyLevelPacksPriceModel__PricePerBundlePair*,::Array<::GlobalNamespace::__SonyLevelPacksPriceModel__PricePerBundlePair*>*> const& __cordl_internal_get__pricePairBundlePairs() const;

constexpr ::ArrayW<::GlobalNamespace::__SonyLevelPacksPriceModel__PricePerBundlePair*,::Array<::GlobalNamespace::__SonyLevelPacksPriceModel__PricePerBundlePair*>*>& __cordl_internal_get__pricePairBundlePairs() ;

constexpr float_t const& __cordl_internal_get__pricePerLevel() const;

constexpr float_t& __cordl_internal_get__pricePerLevel() ;

constexpr void __cordl_internal_set__pricePairBundlePairs(::ArrayW<::GlobalNamespace::__SonyLevelPacksPriceModel__PricePerBundlePair*,::Array<::GlobalNamespace::__SonyLevelPacksPriceModel__PricePerBundlePair*>*>  value) ;

constexpr void __cordl_internal_set__pricePerLevel(float_t  value) ;

/// @brief Method .ctor, addr 0x269b78c, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_pricePairBundlePairs, addr 0x269b728, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_pricePerLevel, addr 0x269b720, size 0x8, virtual false, abstract: false, final false
