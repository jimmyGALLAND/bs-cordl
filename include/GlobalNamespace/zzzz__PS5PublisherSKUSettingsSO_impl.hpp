...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::PS5PublisherSKUSettingsSO::*)()>(&::GlobalNamespace::PS5PublisherSKUSettingsSO::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x269a9b8;
...
inline ::GlobalNamespace::PS5PublisherSKUSettingsSO* GlobalNamespace::PS5PublisherSKUSettingsSO::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::PS5PublisherSKUSettingsSO*>());
}
inline void GlobalNamespace::PS5PublisherSKUSettingsSO::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::PS5PublisherSKUSettingsSO*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
