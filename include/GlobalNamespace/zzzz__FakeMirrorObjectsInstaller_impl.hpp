...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__FakeMirrorObjectsInstaller____c::*)()>(&::GlobalNamespace::__FakeMirrorObjectsInstaller____c::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3b5d800;
...
//  Writing Method size for method: ::GlobalNamespace::__FakeMirrorObjectsInstaller____c._InstallBindings_b__10_0
template<>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::__FakeMirrorObjectsInstaller____c::*)(::Zenject::BindingId)>(&::GlobalNamespace::__FakeMirrorObjectsInstaller____c::_InstallBindings_b__10_0)> {
  constexpr static std::size_t size = 0x94;
  constexpr static std::size_t addrs = 0x3b5d808;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__FakeMirrorObjectsInstaller____c*>::get(),
                        "<InstallBindings>b__10_0",
                        std::span<const Il2CppClass* const, 0>(),
...
::cordl_internals::setStaticField<::GlobalNamespace::__FakeMirrorObjectsInstaller____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__FakeMirrorObjectsInstaller____c*>::get>(std::forward<::GlobalNamespace::__FakeMirrorObjectsInstaller____c*>(value));
}
...
return ::cordl_internals::getStaticField<::GlobalNamespace::__FakeMirrorObjectsInstaller____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__FakeMirrorObjectsInstaller____c*>::get>();
}
inline void GlobalNamespace::__FakeMirrorObjectsInstaller____c::setStaticF___9__10_0(::System::Func_2<::Zenject::BindingId,bool>*  value)  {
::cordl_internals::setStaticField<::System::Func_2<::Zenject::BindingId,bool>*, "<>9__10_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__FakeMirrorObjectsInstaller____c*>::get>(std::forward<::System::Func_2<::Zenject::BindingId,bool>*>(value));
}
inline ::System::Func_2<::Zenject::BindingId,bool>* GlobalNamespace::__FakeMirrorObjectsInstaller____c::getStaticF___9__10_0()  {
return ::cordl_internals::getStaticField<::System::Func_2<::Zenject::BindingId,bool>*, "<>9__10_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__FakeMirrorObjectsInstaller____c*>::get>();
}
inline ::GlobalNamespace::__FakeMirrorObjectsInstaller____c* GlobalNamespace::__FakeMirrorObjectsInstaller____c::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__FakeMirrorObjectsInstaller____c*>());
}
...
inline bool GlobalNamespace::__FakeMirrorObjectsInstaller____c::_InstallBindings_b__10_0(::Zenject::BindingId  t)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__FakeMirrorObjectsInstaller____c*>::get(),
                        "<InstallBindings>b__10_0",
                        std::span<const Il2CppClass* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::GlobalNamespace::MirroredGameNoteController> (::GlobalNamespace::FakeMirrorObjectsInstaller::*)()>(&::GlobalNamespace::FakeMirrorObjectsInstaller::get_mirroredGameNoteControllerPrefab)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3b5d2d8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::FakeMirrorObjectsInstaller::*)()>(&::GlobalNamespace::FakeMirrorObjectsInstaller::InstallBindings)> {
  constexpr static std::size_t size = 0x4bc;
  constexpr static std::size_t addrs = 0x3b5d2e0;
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____mirroredBurstSliderHeadGameNoteControllerPrefab)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____mirroredBurstSliderGameNoteControllerPrefab)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SettingsManager*> const& GlobalNamespace::FakeMirrorObjectsInstaller::__cordl_internal_get__settingsManager() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____settingsManager;
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::FakeMirrorObjectsInstaller*>());
}
