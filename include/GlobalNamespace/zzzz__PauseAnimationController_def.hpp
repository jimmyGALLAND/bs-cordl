...
/// @brief Field resumeFromPauseAnimationDidFinishEvent, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_resumeFromPauseAnimationDidFinishEvent, put=__cordl_internal_set_resumeFromPauseAnimationDidFinishEvent)) ::System::Action*  resumeFromPauseAnimationDidFinishEvent;

/// @brief Method Awake, addr 0x3b18a2c, size 0x30, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method EnterPauseAnimationDidFinish, addr 0x3b18b4c, size 0x30, virtual false, abstract: false, final false
inline void EnterPauseAnimationDidFinish() ;

static inline ::GlobalNamespace::PauseAnimationController* New_ctor() ;

/// @brief Method ResumeFromPauseAnimationDidFinish, addr 0x3b18b7c, size 0x50, virtual false, abstract: false, final false
inline void ResumeFromPauseAnimationDidFinish() ;

/// @brief Method StartEnterPauseAnimation, addr 0x3b18a5c, size 0x78, virtual false, abstract: false, final false
inline void StartEnterPauseAnimation() ;

/// @brief Method StartResumeFromPauseAnimation, addr 0x3b18ad4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b18bcc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_resumeFromPauseAnimationDidFinishEvent, addr 0x3b188f4, size 0x9c, virtual false, abstract: false, final false
inline void add_resumeFromPauseAnimationDidFinishEvent(::System::Action*  value) ;

/// @brief Method remove_resumeFromPauseAnimationDidFinishEvent, addr 0x3b18990, size 0x9c, virtual false, abstract: false, final false
