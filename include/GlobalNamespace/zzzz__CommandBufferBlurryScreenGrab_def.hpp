...
/// @brief Method CamerasDict, addr 0x3feedd0, size 0x58, virtual true, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Camera>,::GlobalNamespace::CommandBufferOwners*>* CamerasDict() ;

/// @brief Method CommandBufferCameraEvent, addr 0x3feee28, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::Rendering::CameraEvent CommandBufferCameraEvent() ;

/// @brief Method CreateCommandBuffer, addr 0x3feecd4, size 0xfc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3feee30, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
