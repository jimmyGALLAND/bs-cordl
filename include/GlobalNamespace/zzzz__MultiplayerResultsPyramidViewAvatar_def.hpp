...
class CORDL_TYPE __MultiplayerResultsPyramidViewAvatar__Factory : public ::Zenject::PlaceholderFactory_2<::GlobalNamespace::IConnectedPlayer*,::UnityW<::GlobalNamespace::MultiplayerResultsPyramidViewAvatar>> {
public:
// Declarations
static inline ::GlobalNamespace::__MultiplayerResultsPyramidViewAvatar__Factory* New_ctor() ;

/// @brief Method .ctor, addr 0x3b4a810, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _badgeTitles, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__badgeTitles, put=__cordl_internal_set__badgeTitles)) ::ArrayW<::UnityW<::TMPro::TextMeshProUGUI>,::Array<::UnityW<::TMPro::TextMeshProUGUI>>*>  _badgeTitles;
...
/// @brief Field _ghostDuplicationEffect, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get__ghostDuplicationEffect, put=__cordl_internal_set__ghostDuplicationEffect)) ::UnityW<::GlobalNamespace::GhostDuplicationEffect>  _ghostDuplicationEffect;
...
/// @brief Method Awake, addr 0x3b4a7c8, size 0x20, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::MultiplayerResultsPyramidViewAvatar* New_ctor() ;

/// @brief Method Setup, addr 0x3b4a2a4, size 0x498, virtual false, abstract: false, final false
inline void Setup(::GlobalNamespace::MultiplayerPlayerResultsData*  resultData, int32_t  position, int32_t  playerCount) ;

/// @brief Method SetupBadgeTimeline, addr 0x3b49d34, size 0x570, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b4a7e8, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_badgeDirector, addr 0x3b4a7c0, size 0x8, virtual false, abstract: false, final false
