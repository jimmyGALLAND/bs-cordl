...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MainSettingsMenuViewController::*)(::System::Action_2<::GlobalNamespace::SettingsSubMenuInfo*,int32_t>*)>(&::GlobalNamespace::MainSettingsMenuViewController::add_didSelectSettingsSubMenuEvent)> {
  constexpr static std::size_t size = 0xb0;
  constexpr static std::size_t addrs = 0x3b85f80;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Action_2<::GlobalNamespace::SettingsSubMenuInfo*,int32_t>*>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MainSettingsMenuViewController::*)(::System::Action_2<::GlobalNamespace::SettingsSubMenuInfo*,int32_t>*)>(&::GlobalNamespace::MainSettingsMenuViewController::remove_didSelectSettingsSubMenuEvent)> {
  constexpr static std::size_t size = 0xb0;
  constexpr static std::size_t addrs = 0x3b86030;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::MainSettingsMenuViewController::*)()>(&::GlobalNamespace::MainSettingsMenuViewController::get_numberOfSubMenus)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x3b860e0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::SettingsSubMenuInfo* (::GlobalNamespace::MainSettingsMenuViewController::*)()>(&::GlobalNamespace::MainSettingsMenuViewController::get_selectedSubMenuInfo)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3b860fc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MainSettingsMenuViewController::*)(int32_t)>(&::GlobalNamespace::MainSettingsMenuViewController::Init)> {
  constexpr static std::size_t size = 0x38;
  constexpr static std::size_t addrs = 0x3b86104;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MainSettingsMenuViewController::*)(bool, bool, bool)>(&::GlobalNamespace::MainSettingsMenuViewController::DidActivate)> {
  constexpr static std::size_t size = 0x1ec;
  constexpr static std::size_t addrs = 0x3b8613c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MainSettingsMenuViewController::*)(::HMUI::SegmentedControl*, int32_t)>(&::GlobalNamespace::MainSettingsMenuViewController::HandleSettingsMenuSegmentedControlDidSelectCell)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x3b86328;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MainSettingsMenuViewController::*)()>(&::GlobalNamespace::MainSettingsMenuViewController::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3b8637c;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::SettingsSubMenuInfo*,int32_t>*> const& GlobalNamespace::MainSettingsMenuViewController::__cordl_internal_get_didSelectSettingsSubMenuEvent() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___didSelectSettingsSubMenuEvent;
}
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___didSelectSettingsSubMenuEvent)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
constexpr ::ArrayW<::GlobalNamespace::SettingsSubMenuInfo*,::Array<::GlobalNamespace::SettingsSubMenuInfo*>*>& GlobalNamespace::MainSettingsMenuViewController::__cordl_internal_get__settingsSubMenuInfos()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____settingsSubMenuInfos;
}
constexpr ::ArrayW<::GlobalNamespace::SettingsSubMenuInfo*,::Array<::GlobalNamespace::SettingsSubMenuInfo*>*> const& GlobalNamespace::MainSettingsMenuViewController::__cordl_internal_get__settingsSubMenuInfos() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____settingsSubMenuInfos;
}
constexpr void GlobalNamespace::MainSettingsMenuViewController::__cordl_internal_set__settingsSubMenuInfos(::ArrayW<::GlobalNamespace::SettingsSubMenuInfo*,::Array<::GlobalNamespace::SettingsSubMenuInfo*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____settingsSubMenuInfos)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____settingsMenuSegmentedControl)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SettingsSubMenuInfo*> const& GlobalNamespace::MainSettingsMenuViewController::__cordl_internal_get__selectedSubMenuInfo() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____selectedSubMenuInfo;
}
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____selectedSubMenuInfo)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::SettingsSubMenuInfo*, false>(this, ___internal_method);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, selectedSubMenuInfoIdx);
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::MainSettingsMenuViewController*>());
}
