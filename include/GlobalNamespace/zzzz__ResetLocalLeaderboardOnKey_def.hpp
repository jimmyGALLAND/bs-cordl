...
/// @brief Method Update, addr 0x26ba510, size 0xb0, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x26ba5c0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
