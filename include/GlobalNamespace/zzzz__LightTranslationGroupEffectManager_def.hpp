...
/// @brief Method OnDestroy, addr 0x3afe790, size 0x148, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3afe3b0, size 0x3e0, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::LightTranslationGroupEffect*>*> const& __cordl_internal_get__lightTranslationGroupEffects() const;
...
/// @brief Method .ctor, addr 0x3afe8d8, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
