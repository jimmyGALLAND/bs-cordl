...
static __declspec(property(get=getStaticF_CallbackInvokers, put=setStaticF_CallbackInvokers)) ::System::Collections::Generic::Dictionary_2<::System::Guid,::GlobalNamespace::__OVRTask_1__CallbackInvoker<TResult>*>*  CallbackInvokers;

/// @brief Field CallbackRemovers, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_CallbackRemovers, put=setStaticF_CallbackRemovers)) ::System::Collections::Generic::Dictionary_2<::System::Guid,::GlobalNamespace::__OVRTask_1__CallbackRemover<TResult>*>*  CallbackRemovers;
...
static __declspec(property(get=getStaticF_InternalDataRemovers, put=setStaticF_InternalDataRemovers)) ::System::Collections::Generic::Dictionary_2<::System::Guid,::GlobalNamespace::__OVRTask_1__InternalDataRemover<TResult>*>*  InternalDataRemovers;
...
static __declspec(property(get=getStaticF_SubscriberRemovers, put=setStaticF_SubscriberRemovers)) ::System::Collections::Generic::Dictionary_2<::System::Guid,::System::Action_1<::System::Guid>*>*  SubscriberRemovers;
...
static __declspec(property(get=getStaticF_Callbacks, put=setStaticF_Callbacks)) ::System::Collections::Generic::Dictionary_2<::System::Guid,::GlobalNamespace::__OVRTask_1__Callback<TResult>>*  Callbacks;
...
// Declarations
/// @brief Field Callbacks, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_Callbacks, put=setStaticF_Callbacks)) ::System::Collections::Generic::Dictionary_2<::System::Guid,::GlobalNamespace::__OVRTask_1__CallbackWithState_1<TResult,T>>*  Callbacks;
