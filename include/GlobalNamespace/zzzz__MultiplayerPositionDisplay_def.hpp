...
/// @brief Method ChangeColor, addr 0x3b49880, size 0x7c, virtual false, abstract: false, final false
inline void ChangeColor(::UnityEngine::Color  toColor, float_t  duration) ;

/// @brief Method HandleFirstPlayerDidChange, addr 0x3b49c48, size 0xb0, virtual false, abstract: false, final false
inline void HandleFirstPlayerDidChange(::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*  obj) ;

/// @brief Method HandlePlayerFailed, addr 0x3b49b50, size 0x18, virtual false, abstract: false, final false
inline void HandlePlayerFailed() ;

static inline ::GlobalNamespace::MultiplayerPositionDisplay* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b497a4, size 0xdc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b4966c, size 0x118, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3b498fc, size 0x4c, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateColors, addr 0x3b49948, size 0x98, virtual false, abstract: false, final false
inline void UpdateColors() ;

/// @brief Method UpdatePosition, addr 0x3b499e0, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b49cf8, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;
