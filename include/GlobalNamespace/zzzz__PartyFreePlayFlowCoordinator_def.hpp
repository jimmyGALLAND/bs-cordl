...
/// @brief Method <ProcessLevelCompletionResultsAfterLevelDidFinish>b__0, addr 0x3ac4f54, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ac4f4c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <HandleResultsViewControllerRestartButtonPressed>b__0, addr 0x3ac5038, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ac5030, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method HandleResultsViewControllerContinueButtonPressed, addr 0x3ac4e3c, size 0x40, virtual false, abstract: false, final false
inline void HandleResultsViewControllerContinueButtonPressed(::GlobalNamespace::ResultsViewController*  resultsViewController) ;

/// @brief Method HandleResultsViewControllerRestartButtonPressed, addr 0x3ac4e7c, size 0xc8, virtual false, abstract: false, final false
inline void HandleResultsViewControllerRestartButtonPressed(::GlobalNamespace::ResultsViewController*  resultsViewController) ;

/// @brief Method IsNewHighScore, addr 0x3ac4d08, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method ProcessLevelCompletionResultsAfterLevelDidFinish, addr 0x3ac49f4, size 0x2c4, virtual true, abstract: false, final false
...
/// @brief Method ProcessScore, addr 0x3ac4d4c, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidActivate, addr 0x3ac46c8, size 0x1e8, virtual true, abstract: false, final false
inline void SinglePlayerLevelSelectionFlowCoordinatorDidActivate(bool  firstActivation, bool  addedToHierarchy) ;

/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate, addr 0x3ac48b0, size 0x144, virtual true, abstract: false, final false
inline void SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate(bool  removedFromHierarchy) ;

/// @brief Method WillScoreGoToLeaderboard, addr 0x3ac4cb8, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ac4f44, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_gameMode, addr 0x3ac4634, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_gameMode() ;

/// @brief Method get_leaderboardViewController, addr 0x3ac4674, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::GlobalNamespace::LeaderboardViewController> get_leaderboardViewController() ;

/// @brief Method get_mainTitle, addr 0x3ac4684, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_mainTitle() ;

/// @brief Method get_showBackButtonForMainViewController, addr 0x3ac467c, size 0x8, virtual true, abstract: false, final false
