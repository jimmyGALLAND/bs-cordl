...
/// @brief Method .ctor, addr 0x3b6927c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_button, addr 0x3b69274, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Button> get_button() ;

/// @brief Method get_text, addr 0x3b6926c, size 0x8, virtual false, abstract: false, final false
