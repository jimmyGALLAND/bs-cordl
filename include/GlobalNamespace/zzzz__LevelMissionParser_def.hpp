...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x26678cc, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x2667960, size 0x28, virtual true, abstract: false, final false
inline bool EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x26678b8, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2667818, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Field _functions, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__functions, put=__cordl_internal_set__functions)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::__LevelMissionParser__ParserFunction*>*  _functions;

/// @brief Method AddFunction, addr 0x2667224, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x266728c, size 0x1c, virtual false, abstract: false, final false
inline bool Parse(::StringW  s) ;

/// @brief Method Parse, addr 0x26672a8, size 0x27c, virtual false, abstract: false, final false
inline bool Parse(::StringW  s, int32_t  start, int32_t  length) ;

/// @brief Method ParseFunction, addr 0x2667524, size 0x2f4, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::__LevelMissionParser__ParserFunction*>*> const& __cordl_internal_get__functions() const;
...
/// @brief Method .ctor, addr 0x26671a0, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;
