...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GetXPlatformAccessTokenRequestSony::*)(::StringW, ::GlobalNamespace::PlatformEnvironment)>(&::GlobalNamespace::GetXPlatformAccessTokenRequestSony::_ctor)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x3fee95c;
...
inline ::GlobalNamespace::GetXPlatformAccessTokenRequestSony* GlobalNamespace::GetXPlatformAccessTokenRequestSony::New_ctor(::StringW  platformToken, ::GlobalNamespace::PlatformEnvironment  platformEnvironment)  {
