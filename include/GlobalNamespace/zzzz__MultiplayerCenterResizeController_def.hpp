...
/// @brief Method HandlePlayersLayoutWasCalculated, addr 0x3b37214, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b3728c, size 0x90, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b37170, size 0xa4, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b3731c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_edgeDistanceFromCenterWasCalculatedEvent, addr 0x3b2ae14, size 0xb0, virtual false, abstract: false, final false
inline void add_edgeDistanceFromCenterWasCalculatedEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method get_edgeDistanceFromCenter, addr 0x3b37160, size 0x8, virtual false, abstract: false, final false
inline float_t get_edgeDistanceFromCenter() ;

/// @brief Method get_isEdgeDistanceFromCenterCalculated, addr 0x3b3714c, size 0x8, virtual false, abstract: false, final false
inline bool get_isEdgeDistanceFromCenterCalculated() ;

/// @brief Method remove_edgeDistanceFromCenterWasCalculatedEvent, addr 0x3b2b024, size 0xb0, virtual false, abstract: false, final false
inline void remove_edgeDistanceFromCenterWasCalculatedEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method set_edgeDistanceFromCenter, addr 0x3b37168, size 0x8, virtual false, abstract: false, final false
inline void set_edgeDistanceFromCenter(float_t  value) ;

/// @brief Method set_isEdgeDistanceFromCenterCalculated, addr 0x3b37154, size 0xc, virtual false, abstract: false, final false
