...
/// @brief Method Awake, addr 0x3961650, size 0x84, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method ColorWasSet, addr 0x39616d4, size 0x1e0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39618b4, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
