...
public:
// Declarations
/// @brief Method GetAnyJoystickMaxAxisDefaultImplementation, addr 0x3945a24, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method GetMenuButtonDefaultImplementation, addr 0x39452a8, size 0x78, virtual false, abstract: false, final false
static inline bool GetMenuButtonDefaultImplementation() ;

/// @brief Method GetMenuButtonDownDefaultImplementation, addr 0x3945324, size 0x78, virtual false, abstract: false, final false
static inline bool GetMenuButtonDownDefaultImplementation() ;

/// @brief Method StopXR, addr 0x3945b5c, size 0x100, virtual false, abstract: false, final false
static inline void StopXR(::GlobalNamespace::IVerboseLogger*  logger) ;

/// @brief Method TriggerValueDefaultImplementation, addr 0x39459a4, size 0x80, virtual false, abstract: false, final false
