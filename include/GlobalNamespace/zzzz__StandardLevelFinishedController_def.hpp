...
/// @brief Method HandleLevelFinished, addr 0x3b1c890, size 0x4, virtual false, abstract: false, final false
inline void HandleLevelFinished() ;

static inline ::GlobalNamespace::StandardLevelFinishedController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b1c790, size 0x100, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b1c6a0, size 0xf0, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartLevelFinished, addr 0x3b1c894, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b1c8d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
