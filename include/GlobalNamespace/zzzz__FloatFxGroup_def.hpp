...
/// @brief Method .ctor, addr 0x3af8150, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isTriggerOnly, addr 0x3af8140, size 0x8, virtual false, abstract: false, final false
inline bool get_isTriggerOnly() ;

/// @brief Method get_targets, addr 0x3af8148, size 0x8, virtual false, abstract: false, final false
