...
/// @brief Method ProcessBeforeDeleteEventDataInternal, addr 0x2202734, size 0x234, virtual true, abstract: false, final false
...
/// @brief Method ProcessInsertedEventDataInternal, addr 0x220254c, size 0x1e8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2202968, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
