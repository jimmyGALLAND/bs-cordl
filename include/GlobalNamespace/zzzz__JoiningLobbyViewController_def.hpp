...
/// @brief Method DidActivate, addr 0x3b89988, size 0xc4, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HideLoading, addr 0x3b89948, size 0x40, virtual false, abstract: false, final false
inline void HideLoading() ;

/// @brief Method Init, addr 0x3b89914, size 0x34, virtual false, abstract: false, final false
inline void Init(::StringW  text) ;

static inline ::GlobalNamespace::JoiningLobbyViewController* New_ctor() ;

/// @brief Method <DidActivate>b__8_0, addr 0x3b89a54, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b89a4c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didCancelEvent, addr 0x3b897dc, size 0x9c, virtual false, abstract: false, final false
inline void add_didCancelEvent(::System::Action*  value) ;

/// @brief Method remove_didCancelEvent, addr 0x3b89878, size 0x9c, virtual false, abstract: false, final false
