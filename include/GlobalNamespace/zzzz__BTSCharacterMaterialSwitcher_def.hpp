...
/// @brief Field _materialPairs, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__materialPairs, put=__cordl_internal_set__materialPairs)) ::System::Collections::Generic::List_1<::GlobalNamespace::__BTSCharacterMaterialSwitcher__MaterialPairs*>*  _materialPairs;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__BTSCharacterMaterialSwitcher__MaterialPairs*>*> const& __cordl_internal_get__materialPairs() const;
...
/// @brief Method .ctor, addr 0x22205d8, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Renderer*  renderer) ;

/// @brief Method get_materialPairs, addr 0x22205d0, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::GlobalNamespace::__BTSCharacterMaterialSwitcher__MaterialPairs*>* get_materialPairs() ;

/// @brief Method get_renderer, addr 0x22205c8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2220660, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _rendererMaterialsPairs, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__rendererMaterialsPairs, put=__cordl_internal_set__rendererMaterialsPairs)) ::ArrayW<::GlobalNamespace::__BTSCharacterMaterialSwitcher__RendererMaterialsPairs*,::Array<::GlobalNamespace::__BTSCharacterMaterialSwitcher__RendererMaterialsPairs*>*>  _rendererMaterialsPairs;

static inline ::GlobalNamespace::BTSCharacterMaterialSwitcher* New_ctor() ;

/// @brief Method SwapMaterials, addr 0x222031c, size 0x254, virtual false, abstract: false, final false
inline void SwapMaterials(bool  alternative) ;

constexpr ::ArrayW<::GlobalNamespace::__BTSCharacterMaterialSwitcher__RendererMaterialsPairs*,::Array<::GlobalNamespace::__BTSCharacterMaterialSwitcher__RendererMaterialsPairs*>*> const& __cordl_internal_get__rendererMaterialsPairs() const;

constexpr ::ArrayW<::GlobalNamespace::__BTSCharacterMaterialSwitcher__RendererMaterialsPairs*,::Array<::GlobalNamespace::__BTSCharacterMaterialSwitcher__RendererMaterialsPairs*>*>& __cordl_internal_get__rendererMaterialsPairs() ;

constexpr void __cordl_internal_set__rendererMaterialsPairs(::ArrayW<::GlobalNamespace::__BTSCharacterMaterialSwitcher__RendererMaterialsPairs*,::Array<::GlobalNamespace::__BTSCharacterMaterialSwitcher__RendererMaterialsPairs*>*>  value) ;

/// @brief Method .ctor, addr 0x22205c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
