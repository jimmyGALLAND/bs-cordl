...
/// @brief Method AreValuesEqual, addr 0x26a8508, size 0x318, virtual false, abstract: false, final false
inline bool AreValuesEqual(::GlobalNamespace::PlayerSpecificSettings*  other) ;

/// @brief Method CopyWith, addr 0x26a6dc4, size 0x3c4, virtual false, abstract: false, final false
...
/// @brief Method GetEnvironmentEffectsFilterPreset, addr 0x26a84f0, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26a2780, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x26a69bc, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method get_adaptiveSfx, addr 0x26a84c0, size 0x8, virtual false, abstract: false, final false
inline bool get_adaptiveSfx() ;

/// @brief Method get_advancedHud, addr 0x26a8488, size 0x8, virtual false, abstract: false, final false
inline bool get_advancedHud() ;

/// @brief Method get_arcVisibility, addr 0x26a84d0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ArcVisibilityType get_arcVisibility() ;

/// @brief Method get_arcsHapticFeedback, addr 0x26a84c8, size 0x8, virtual false, abstract: false, final false
inline bool get_arcsHapticFeedback() ;

/// @brief Method get_autoRestart, addr 0x26a8490, size 0x8, virtual false, abstract: false, final false
inline bool get_autoRestart() ;

/// @brief Method get_automaticPlayerHeight, addr 0x26a8460, size 0x8, virtual false, abstract: false, final false
inline bool get_automaticPlayerHeight() ;

/// @brief Method get_environmentEffectsFilterDefaultPreset, addr 0x26a84d8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::EnvironmentEffectsFilterPreset get_environmentEffectsFilterDefaultPreset() ;

/// @brief Method get_environmentEffectsFilterExpertPlusPreset, addr 0x26a84e0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::EnvironmentEffectsFilterPreset get_environmentEffectsFilterExpertPlusPreset() ;

/// @brief Method get_headsetHapticIntensity, addr 0x26a84e8, size 0x8, virtual false, abstract: false, final false
inline float_t get_headsetHapticIntensity() ;

/// @brief Method get_hideNoteSpawnEffect, addr 0x26a84b8, size 0x8, virtual false, abstract: false, final false
inline bool get_hideNoteSpawnEffect() ;

/// @brief Method get_leftHanded, addr 0x26a8450, size 0x8, virtual false, abstract: false, final false
inline bool get_leftHanded() ;

/// @brief Method get_noFailEffects, addr 0x26a8480, size 0x8, virtual false, abstract: false, final false
inline bool get_noFailEffects() ;

/// @brief Method get_noTextsAndHuds, addr 0x26a8478, size 0x8, virtual false, abstract: false, final false
inline bool get_noTextsAndHuds() ;

/// @brief Method get_noteJumpDurationTypeSettings, addr 0x26a84a0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::NoteJumpDurationTypeSettings get_noteJumpDurationTypeSettings() ;

/// @brief Method get_noteJumpFixedDuration, addr 0x26a84a8, size 0x8, virtual false, abstract: false, final false
inline float_t get_noteJumpFixedDuration() ;

/// @brief Method get_noteJumpStartBeatOffset, addr 0x26a84b0, size 0x8, virtual false, abstract: false, final false
inline float_t get_noteJumpStartBeatOffset() ;

/// @brief Method get_playerHeight, addr 0x26a8458, size 0x8, virtual false, abstract: false, final false
inline float_t get_playerHeight() ;

/// @brief Method get_reduceDebris, addr 0x26a8470, size 0x8, virtual false, abstract: false, final false
inline bool get_reduceDebris() ;

/// @brief Method get_saberTrailIntensity, addr 0x26a8498, size 0x8, virtual false, abstract: false, final false
inline float_t get_saberTrailIntensity() ;

/// @brief Method get_sfxVolume, addr 0x26a8468, size 0x8, virtual false, abstract: false, final false
