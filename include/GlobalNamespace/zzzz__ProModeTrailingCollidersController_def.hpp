...
/// @brief Field _mainSmallCuttableBySaber, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__mainSmallCuttableBySaber, put=__cordl_internal_set__mainSmallCuttableBySaber)) ::UnityW<::GlobalNamespace::BoxCuttableBySaber>  _mainSmallCuttableBySaber;
...
/// @brief Field _trailingSmallCuttableBySaberList, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__trailingSmallCuttableBySaberList, put=__cordl_internal_set__trailingSmallCuttableBySaberList)) ::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>,::Array<::UnityW<::GlobalNamespace::BoxCuttableBySaber>>*>  _trailingSmallCuttableBySaberList;

/// @brief Field _transform, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__transform, put=__cordl_internal_set__transform)) ::UnityW<::UnityEngine::Transform>  _transform;

/// @brief Method HandleNoteDidMoveInJumpPhase, addr 0x3a6729c, size 0x170, virtual false, abstract: false, final false
inline void HandleNoteDidMoveInJumpPhase() ;

static inline ::GlobalNamespace::ProModeTrailingCollidersController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3a671d0, size 0xcc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3a67134, size 0x9c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3a6740c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
