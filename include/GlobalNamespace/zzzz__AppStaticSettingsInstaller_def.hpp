...
/// @brief Method InstallBindings, addr 0x26c98fc, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26c9968, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
