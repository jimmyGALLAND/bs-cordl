...
/// @brief Method .ctor, addr 0x2687618, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field localizations, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_localizations, put=__cordl_internal_set_localizations)) ::ArrayW<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*,::Array<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*>*>  localizations;

static inline ::GlobalNamespace::__MultiplayerStatusData__UserMessage* New_ctor() ;

constexpr ::ArrayW<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*,::Array<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*>*> const& __cordl_internal_get_localizations() const;

constexpr ::ArrayW<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*,::Array<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*>*>& __cordl_internal_get_localizations() ;

constexpr void __cordl_internal_set_localizations(::ArrayW<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*,::Array<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*>*>  value) ;

/// @brief Method .ctor, addr 0x2687610, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x2687608, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_maintenanceEndTime, addr 0x26875c0, size 0x8, virtual false, abstract: false, final false
inline int64_t get_maintenanceEndTime() ;

/// @brief Method get_maintenanceStartTime, addr 0x26875b0, size 0x8, virtual false, abstract: false, final false
inline int64_t get_maintenanceStartTime() ;

/// @brief Method get_minimumAppVersion, addr 0x26875a0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_minimumAppVersion() ;

/// @brief Method get_useGamelift, addr 0x26875e0, size 0x8, virtual false, abstract: false, final false
inline bool get_useGamelift() ;

/// @brief Method get_useXPlatformAuth, addr 0x26875f4, size 0x8, virtual false, abstract: false, final false
inline bool get_useXPlatformAuth() ;

/// @brief Method get_userMessage, addr 0x26875d0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__MultiplayerStatusData__UserMessage* get_userMessage() ;

/// @brief Method set_maintenanceEndTime, addr 0x26875c8, size 0x8, virtual false, abstract: false, final false
inline void set_maintenanceEndTime(int64_t  value) ;

/// @brief Method set_maintenanceStartTime, addr 0x26875b8, size 0x8, virtual false, abstract: false, final false
inline void set_maintenanceStartTime(int64_t  value) ;

/// @brief Method set_minimumAppVersion, addr 0x26875a8, size 0x8, virtual false, abstract: false, final false
inline void set_minimumAppVersion(::StringW  value) ;

/// @brief Method set_useGamelift, addr 0x26875e8, size 0xc, virtual false, abstract: false, final false
inline void set_useGamelift(bool  value) ;

/// @brief Method set_useXPlatformAuth, addr 0x26875fc, size 0xc, virtual false, abstract: false, final false
inline void set_useXPlatformAuth(bool  value) ;

/// @brief Method set_userMessage, addr 0x26875d8, size 0x8, virtual false, abstract: false, final false
