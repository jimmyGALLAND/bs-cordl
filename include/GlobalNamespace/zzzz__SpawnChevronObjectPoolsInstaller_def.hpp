...
/// @brief Field _spawnRotationChevronPrefab, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__spawnRotationChevronPrefab, put=__cordl_internal_set__spawnRotationChevronPrefab)) ::UnityW<::GlobalNamespace::SpawnRotationChevron>  _spawnRotationChevronPrefab;

/// @brief Method InstallBindings, addr 0x3b07f48, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b07fcc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
