...
/// @brief Method OnDisable, addr 0x3fef5e8, size 0x400, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3fef208, size 0x3e0, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnWillRenderObject, addr 0x3fefa90, size 0x1b0, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Camera>,::GlobalNamespace::CommandBufferOwners*>*> const& __cordl_internal_get__cameras() const;
...
/// @brief Method .ctor, addr 0x3feee44, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
