...
template<typename T>
constexpr ::GlobalNamespace::IValue_1<T>* GlobalNamespace::ObservableVariableSO_1<T>::i___GlobalNamespace__IValue_1_T_() noexcept {
return static_cast<::GlobalNamespace::IValue_1<T>*>(static_cast<void*>(this));
}
...
template<typename T>
constexpr ::GlobalNamespace::IObservableChange* GlobalNamespace::ObservableVariableSO_1<T>::i___GlobalNamespace__IObservableChange() noexcept {
return static_cast<::GlobalNamespace::IObservableChange*>(static_cast<void*>(this));
}
template<typename T>
constexpr ::System::Action*& GlobalNamespace::ObservableVariableSO_1<T>::__cordl_internal_get_didChangeEvent()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___didChangeEvent;
}
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Action*> const& GlobalNamespace::ObservableVariableSO_1<T>::__cordl_internal_get_didChangeEvent() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___didChangeEvent;
}
template<typename T>
constexpr void GlobalNamespace::ObservableVariableSO_1<T>::__cordl_internal_set_didChangeEvent(::System::Action*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
constexpr T& GlobalNamespace::ObservableVariableSO_1<T>::__cordl_internal_get__value()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value;
}
template<typename T>
constexpr T const& GlobalNamespace::ObservableVariableSO_1<T>::__cordl_internal_get__value() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value;
}
template<typename T>
constexpr void GlobalNamespace::ObservableVariableSO_1<T>::__cordl_internal_set__value(T  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "op_Implicit",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::ObservableVariableSO_1<T>*>::get()}
                    )));
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::ObservableVariableSO_1<T>::ObservableVariableSO_1()   {
}
