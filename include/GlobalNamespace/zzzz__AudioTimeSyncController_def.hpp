...
/// @brief Method .ctor, addr 0x3a4b124, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method Awake, addr 0x3a4a8ec, size 0x48, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleAudioConfigurationChanged, addr 0x3a4aae8, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3a4aa68, size 0x80, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Pause, addr 0x3a4b064, size 0x58, virtual false, abstract: false, final false
inline void Pause() ;

/// @brief Method Resume, addr 0x3a4b0bc, size 0x50, virtual false, abstract: false, final false
inline void Resume() ;

/// @brief Method SeekTo, addr 0x3a4aed0, size 0x14c, virtual false, abstract: false, final false
inline void SeekTo(float_t  startTimeOffset) ;

/// @brief Method Start, addr 0x3a4a934, size 0x134, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartSong, addr 0x3a4ae8c, size 0x44, virtual false, abstract: false, final false
inline void StartSong(float_t  startTimeOffset) ;

/// @brief Method StopSong, addr 0x3a4b01c, size 0x48, virtual false, abstract: false, final false
inline void StopSong() ;

/// @brief Method Update, addr 0x3a4ab2c, size 0x360, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3a4b10c, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_waitUntilAudioIsLoaded>b__27_0, addr 0x3a4b120, size 0x4, virtual false, abstract: false, final false
inline bool _get_waitUntilAudioIsLoaded_b__27_0() ;

/// @brief Method add_stateChangedEvent, addr 0x3a4a794, size 0x9c, virtual false, abstract: false, final false
inline void add_stateChangedEvent(::System::Action*  value) ;

/// @brief Method get_dspTimeOffset, addr 0x3a4a6c0, size 0x8, virtual false, abstract: false, final false
inline double_t get_dspTimeOffset() ;

/// @brief Method get_forceNoAudioSyncOrAudioSyncErrorFixing, addr 0x3a4a780, size 0x8, virtual false, abstract: false, final false
inline bool get_forceNoAudioSyncOrAudioSyncErrorFixing() ;

/// @brief Method get_isAudioLoaded, addr 0x3a4a664, size 0x30, virtual false, abstract: false, final false
inline bool get_isAudioLoaded() ;

/// @brief Method get_isReady, addr 0x3a4a770, size 0x8, virtual true, abstract: false, final true
inline bool get_isReady() ;

/// @brief Method get_lastFrameDeltaSongTime, addr 0x3a4a5c4, size 0x8, virtual true, abstract: false, final true
inline float_t get_lastFrameDeltaSongTime() ;

/// @brief Method get_songEndTime, addr 0x3a4a694, size 0x24, virtual true, abstract: false, final true
inline float_t get_songEndTime() ;

/// @brief Method get_songLength, addr 0x3a4a5cc, size 0x98, virtual true, abstract: false, final true
inline float_t get_songLength() ;

/// @brief Method get_songTime, addr 0x3a4a5bc, size 0x8, virtual true, abstract: false, final true
inline float_t get_songTime() ;

/// @brief Method get_songTimeOffset, addr 0x3a4a778, size 0x8, virtual false, abstract: false, final false
inline float_t get_songTimeOffset() ;

/// @brief Method get_state, addr 0x3a4a5b4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__AudioTimeSyncController__State get_state() ;

/// @brief Method get_timeScale, addr 0x3a4a6b8, size 0x8, virtual true, abstract: false, final true
inline float_t get_timeScale() ;

/// @brief Method get_timeSinceStart, addr 0x3a4a8cc, size 0x20, virtual false, abstract: false, final false
inline float_t get_timeSinceStart() ;

/// @brief Method get_waitUntilAudioIsLoaded, addr 0x3a4a6c8, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method remove_stateChangedEvent, addr 0x3a4a830, size 0x9c, virtual false, abstract: false, final false
inline void remove_stateChangedEvent(::System::Action*  value) ;

/// @brief Method set_forceNoAudioSyncOrAudioSyncErrorFixing, addr 0x3a4a788, size 0xc, virtual false, abstract: false, final false
