...
template<typename T,typename TBase>
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ISortedListItemProcessor_1<TBase>*> const& GlobalNamespace::SortedList_2<T,TBase>::__cordl_internal_get__sortedListDataProcessor() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____sortedListDataProcessor;
}
template<typename T,typename TBase>
