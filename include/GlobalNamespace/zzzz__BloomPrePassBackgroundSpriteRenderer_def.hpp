...
/// @brief Method .ctor, addr 0x395540c, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_renderer, addr 0x3955404, size 0x8, virtual true, abstract: false, final false
