...
/// @brief Field _inEnvironmentTextsPrefab, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__inEnvironmentTextsPrefab, put=__cordl_internal_set__inEnvironmentTextsPrefab)) ::UnityW<::GlobalNamespace::MultiplayerScoreRingItem>  _inEnvironmentTextsPrefab;

/// @brief Field _multiplayerResultsPyramidViewAvatarPrefab, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerResultsPyramidViewAvatarPrefab, put=__cordl_internal_set__multiplayerResultsPyramidViewAvatarPrefab)) ::UnityW<::GlobalNamespace::MultiplayerResultsPyramidViewAvatar>  _multiplayerResultsPyramidViewAvatarPrefab;

/// @brief Method InstallBindings, addr 0x3b448fc, size 0x144, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b44a40, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
