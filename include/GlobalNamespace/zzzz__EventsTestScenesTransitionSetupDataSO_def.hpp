...
/// @brief Method Init, addr 0x3aae0c0, size 0x1e0, virtual false, abstract: false, final false
inline void Init() ;
...
/// @brief Method .ctor, addr 0x3aae2a0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
