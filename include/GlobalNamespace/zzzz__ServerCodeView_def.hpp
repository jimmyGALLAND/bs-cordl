...
/// @brief Method HandleShowServerCodeButtonPressed, addr 0x3a7cf38, size 0x10, virtual false, abstract: false, final false
inline void HandleShowServerCodeButtonPressed() ;

static inline ::GlobalNamespace::ServerCodeView* New_ctor() ;

/// @brief Method OnDisable, addr 0x3a7cf1c, size 0x1c, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3a7ce88, size 0x94, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RefreshText, addr 0x3a7cdec, size 0x9c, virtual false, abstract: false, final false
inline void RefreshText(bool  showCode) ;

/// @brief Method SetCode, addr 0x3a7cde0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a7cf48, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
