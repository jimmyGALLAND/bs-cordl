...
/// @brief Method .ctor, addr 0x3a524fc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddHighlight, addr 0x3a52218, size 0xd8, virtual false, abstract: false, final false
inline void AddHighlight(float_t  startTime, float_t  arriveDuration, float_t  jumpDuration) ;

/// @brief Method ColorWasSet, addr 0x3a5220c, size 0xc, virtual true, abstract: false, final false
inline void ColorWasSet(::UnityEngine::Color  color) ;

/// @brief Method Init, addr 0x3a52140, size 0xcc, virtual false, abstract: false, final false
inline void Init(::UnityEngine::Vector3  position, float_t  rotation) ;

/// @brief Method ManualUpdate, addr 0x3a522f0, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a5243c, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isFinished, addr 0x3a520e8, size 0x50, virtual false, abstract: false, final false
inline bool get_isFinished() ;

/// @brief Method get_rotation, addr 0x3a52138, size 0x8, virtual false, abstract: false, final false
