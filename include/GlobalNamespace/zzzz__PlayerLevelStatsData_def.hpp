...
/// @brief Method GetBeatmapKey, addr 0x26a2c20, size 0x20, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapKey GetBeatmapKey() ;

/// @brief Method IncreaseNumberOfGameplays, addr 0x26a3268, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method UpdateScoreData, addr 0x26a83f4, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26a2d90, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method .ctor, addr 0x26a83b4, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26a6ba8, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method get_beatmapCharacteristic, addr 0x26a837c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> get_beatmapCharacteristic() ;

/// @brief Method get_difficulty, addr 0x26a8374, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapDifficulty get_difficulty() ;

/// @brief Method get_fullCombo, addr 0x26a8394, size 0x8, virtual false, abstract: false, final false
inline bool get_fullCombo() ;

/// @brief Method get_highScore, addr 0x26a8384, size 0x8, virtual false, abstract: false, final false
inline int32_t get_highScore() ;

/// @brief Method get_levelID, addr 0x26a836c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_levelID() ;

/// @brief Method get_maxCombo, addr 0x26a838c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxCombo() ;

/// @brief Method get_maxRank, addr 0x26a839c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__RankModel__Rank get_maxRank() ;

/// @brief Method get_playCount, addr 0x26a83ac, size 0x8, virtual false, abstract: false, final false
inline int32_t get_playCount() ;

/// @brief Method get_validScore, addr 0x26a83a4, size 0x8, virtual false, abstract: false, final false
