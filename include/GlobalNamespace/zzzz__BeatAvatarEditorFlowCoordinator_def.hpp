...
/// @brief Method DidActivate, addr 0x22103d0, size 0x4c4, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x22110f0, size 0x280, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleBeatAvatarEditorViewCancelButtonWasPressed, addr 0x2211a60, size 0xc, virtual false, abstract: false, final false
inline void HandleBeatAvatarEditorViewCancelButtonWasPressed() ;

/// @brief Method HandleBeatAvatarEditorViewOkButtonWasPressed, addr 0x2211a6c, size 0xc, virtual false, abstract: false, final false
inline void HandleBeatAvatarEditorViewOkButtonWasPressed() ;

/// @brief Method HandleBeatAvatarViewControllerChangedAvatarPart, addr 0x22119c0, size 0xa0, virtual false, abstract: false, final false
inline void HandleBeatAvatarViewControllerChangedAvatarPart(::BeatSaber::BeatAvatarSDK::AvatarPart  avatarPart) ;

/// @brief Method HandleBeatAvatarViewControllerDidRequestColorChange, addr 0x22118d0, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method HandleEditColorViewControllerControllerDidFinish, addr 0x2211aa0, size 0xcc, virtual false, abstract: false, final false
inline void HandleEditColorViewControllerControllerDidFinish(bool  apply) ;

/// @brief Method HandleEditColorViewControllerDidChangedColor, addr 0x2211a78, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method OneTimeInitialize, addr 0x2211bb0, size 0x4, virtual true, abstract: false, final false
inline void OneTimeInitialize() ;

/// @brief Method Setup, addr 0x2210308, size 0x38, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::BeatSaber::BeatAvatarSDK::AvatarPart,::System::Action*>*> const& __cordl_internal_get__parameterChangedAnimationCallbacks() const;
...
/// @brief Method .ctor, addr 0x2211bb4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
