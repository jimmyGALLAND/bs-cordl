...
/// @brief Field _cachedConnectToServerParams, offset 0x110, size 0x8 
 __declspec(property(get=__cordl_internal_get__cachedConnectToServerParams, put=__cordl_internal_set__cachedConnectToServerParams)) ::GlobalNamespace::__GameLiftConnectionManager__ConnectToServerParams*  _cachedConnectToServerParams;

/// @brief Field _cachedStartClientParams, offset 0x118, size 0x8 
 __declspec(property(get=__cordl_internal_get__cachedStartClientParams, put=__cordl_internal_set__cachedStartClientParams)) ::GlobalNamespace::__GameLiftConnectionManager__StartClientParams*  _cachedStartClientParams;
...
/// @brief Method GetConnectToServerParams, addr 0x3de17c4, size 0xe8, virtual true, abstract: false, final false
...
/// @brief Method GetStartClientParams, addr 0x3de18ac, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method RefreshPublicServers, addr 0x3de170c, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method Update, addr 0x3de164c, size 0xc0, virtual true, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3de197c, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_code, addr 0x3de1500, size 0x54, virtual true, abstract: false, final false
inline ::StringW get_code() ;

/// @brief Method get_configuration, addr 0x3de155c, size 0x78, virtual true, abstract: false, final false
inline ::GlobalNamespace::GameplayServerConfiguration get_configuration() ;

/// @brief Method get_partyOwnerId, addr 0x3de1554, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_partyOwnerId() ;

/// @brief Method get_secret, addr 0x3de14ac, size 0x54, virtual true, abstract: false, final false
inline ::StringW get_secret() ;

/// @brief Method get_selectionMask, addr 0x3de15d4, size 0x78, virtual true, abstract: false, final false
