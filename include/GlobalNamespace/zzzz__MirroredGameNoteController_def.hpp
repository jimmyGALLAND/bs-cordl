...
/// @brief Method .ctor, addr 0x3a61cd8, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Mirror, addr 0x3a61ad8, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a61c28, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_cubeNoteControllerDidInitEvent, addr 0x3a61828, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method get_noteMovement, addr 0x3a61988, size 0xac, virtual true, abstract: false, final true
inline ::UnityW<::GlobalNamespace::NoteMovement> get_noteMovement() ;

/// @brief Method get_noteVisualModifierType, addr 0x3a61a34, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method remove_cubeNoteControllerDidInitEvent, addr 0x3a618d8, size 0xb0, virtual true, abstract: false, final true
