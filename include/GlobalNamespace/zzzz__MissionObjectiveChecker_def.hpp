...
/// @brief Method SetCheckedMissionObjective, addr 0x3b1dba4, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b1d348, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_checkedValueDidChangeEvent, addr 0x3b12428, size 0xb0, virtual false, abstract: false, final false
inline void add_checkedValueDidChangeEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionObjectiveChecker>>*  value) ;

/// @brief Method add_statusDidChangeEvent, addr 0x3b12378, size 0xb0, virtual false, abstract: false, final false
inline void add_statusDidChangeEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionObjectiveChecker>>*  value) ;

/// @brief Method get_checkedValue, addr 0x3b1db9c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_checkedValue() ;

/// @brief Method get_disableChecking, addr 0x3b1db80, size 0x8, virtual false, abstract: false, final false
inline bool get_disableChecking() ;

/// @brief Method get_missionObjective, addr 0x3b1db78, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MissionObjective* get_missionObjective() ;

/// @brief Method get_missionObjectiveType, addr 0x3b1db70, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionObjectiveTypeSO> get_missionObjectiveType() ;

/// @brief Method get_status, addr 0x3b1db94, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__MissionObjectiveChecker__Status get_status() ;

/// @brief Method remove_checkedValueDidChangeEvent, addr 0x3b1dac0, size 0xb0, virtual false, abstract: false, final false
inline void remove_checkedValueDidChangeEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionObjectiveChecker>>*  value) ;

/// @brief Method remove_statusDidChangeEvent, addr 0x3b1da10, size 0xb0, virtual false, abstract: false, final false
inline void remove_statusDidChangeEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionObjectiveChecker>>*  value) ;

/// @brief Method set_checkedValue, addr 0x3b1cc58, size 0x3c, virtual false, abstract: false, final false
inline void set_checkedValue(int32_t  value) ;

/// @brief Method set_disableChecking, addr 0x3b1db88, size 0xc, virtual false, abstract: false, final false
inline void set_disableChecking(bool  value) ;

/// @brief Method set_status, addr 0x3b1cb00, size 0x3c, virtual false, abstract: false, final false
