...
/// @brief Field <levels>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__levels_k__BackingField, put=__cordl_internal_set__levels_k__BackingField)) ::ArrayW<::GlobalNamespace::LevelInfo*,::Array<::GlobalNamespace::LevelInfo*>*>  _levels_k__BackingField;

/// @brief Field <minimumProtocolVersion>k__BackingField, offset 0x20, size 0x4 
 __declspec(property(get=__cordl_internal_get__minimumProtocolVersion_k__BackingField, put=__cordl_internal_set__minimumProtocolVersion_k__BackingField)) uint32_t  _minimumProtocolVersion_k__BackingField;
...
/// @brief Method .ctor, addr 0x22908f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_levels, addr 0x22908d0, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::GlobalNamespace::LevelInfo*,::Array<::GlobalNamespace::LevelInfo*>*> get_levels() ;

/// @brief Method get_minimumProtocolVersion, addr 0x22908e0, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_minimumProtocolVersion() ;

/// @brief Method get_packID, addr 0x22908c0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_packID() ;

/// @brief Method set_levels, addr 0x22908d8, size 0x8, virtual false, abstract: false, final false
inline void set_levels(::ArrayW<::GlobalNamespace::LevelInfo*,::Array<::GlobalNamespace::LevelInfo*>*>  value) ;

/// @brief Method set_minimumProtocolVersion, addr 0x22908e8, size 0x8, virtual false, abstract: false, final false
inline void set_minimumProtocolVersion(uint32_t  value) ;

/// @brief Method set_packID, addr 0x22908c8, size 0x8, virtual false, abstract: false, final false
