...
/// @brief Method .ctor, addr 0x3b36934, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isFailed, addr 0x3b367ec, size 0x148, virtual true, abstract: false, final true
inline bool get_isFailed() ;

/// @brief Method get_offsetSyncTime, addr 0x3b36598, size 0x254, virtual true, abstract: false, final true
