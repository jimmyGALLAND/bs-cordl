...
/// @brief Method WriteNet, addr 0x2290998, size 0x194, virtual true, abstract: false, final true
inline void WriteNet(::LiteNetLib::NetLogLevel  level, ::StringW  str, ::ArrayW<::System::Object*,::Array<::System::Object*>*>  args) ;

/// @brief Method .ctor, addr 0x2290b2c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
