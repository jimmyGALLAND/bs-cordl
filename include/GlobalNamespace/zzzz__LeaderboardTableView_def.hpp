...
/// @brief Method .ctor, addr 0x3a783d0, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(int32_t  score, ::StringW  playerName, int32_t  rank, bool  fullCombo) ;

/// @brief Method get_fullCombo, addr 0x3a783bc, size 0x8, virtual false, abstract: false, final false
inline bool get_fullCombo() ;

/// @brief Method get_playerName, addr 0x3a7839c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_playerName() ;

/// @brief Method get_rank, addr 0x3a783ac, size 0x8, virtual false, abstract: false, final false
inline int32_t get_rank() ;

/// @brief Method get_score, addr 0x3a7838c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_score() ;

/// @brief Method set_fullCombo, addr 0x3a783c4, size 0xc, virtual false, abstract: false, final false
inline void set_fullCombo(bool  value) ;

/// @brief Method set_playerName, addr 0x3a783a4, size 0x8, virtual false, abstract: false, final false
inline void set_playerName(::StringW  value) ;

/// @brief Method set_rank, addr 0x3a783b4, size 0x8, virtual false, abstract: false, final false
inline void set_rank(int32_t  value) ;

/// @brief Method set_score, addr 0x3a78394, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method CellForIdx, addr 0x3a78154, size 0x1f0, virtual true, abstract: false, final true
inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView*  tableView, int32_t  row) ;

/// @brief Method CellSize, addr 0x3a78100, size 0x8, virtual true, abstract: false, final true
inline float_t CellSize(int32_t  idx) ;

static inline ::GlobalNamespace::LeaderboardTableView* New_ctor() ;

/// @brief Method NumberOfCells, addr 0x3a78108, size 0x4c, virtual true, abstract: false, final true
inline int32_t NumberOfCells() ;

/// @brief Method SetScores, addr 0x3a78344, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a7837c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
