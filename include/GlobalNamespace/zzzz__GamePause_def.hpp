...
/// @brief Field _audioListenerController, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__audioListenerController, put=__cordl_internal_set__audioListenerController)) ::UnityW<::GlobalNamespace::AudioListenerController>  _audioListenerController;

/// @brief Field _beatmapObjectExecutionRatingsRecorder, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapObjectExecutionRatingsRecorder, put=__cordl_internal_set__beatmapObjectExecutionRatingsRecorder)) ::UnityW<::GlobalNamespace::BeatmapObjectExecutionRatingsRecorder>  _beatmapObjectExecutionRatingsRecorder;
...
/// @brief Method Pause, addr 0x3b15518, size 0x150, virtual true, abstract: false, final true
inline void Pause() ;

/// @brief Method Resume, addr 0x3b1568c, size 0x14c, virtual true, abstract: false, final true
inline void Resume() ;

/// @brief Method WillResume, addr 0x3b15668, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b157d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didPauseEvent, addr 0x3b15170, size 0x9c, virtual true, abstract: false, final true
inline void add_didPauseEvent(::System::Action*  value) ;

/// @brief Method add_didResumeEvent, addr 0x3b153e0, size 0x9c, virtual true, abstract: false, final true
inline void add_didResumeEvent(::System::Action*  value) ;

/// @brief Method add_willResumeEvent, addr 0x3b152a8, size 0x9c, virtual true, abstract: false, final true
inline void add_willResumeEvent(::System::Action*  value) ;

/// @brief Method get_isPaused, addr 0x3b15168, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method remove_didPauseEvent, addr 0x3b1520c, size 0x9c, virtual true, abstract: false, final true
inline void remove_didPauseEvent(::System::Action*  value) ;

/// @brief Method remove_didResumeEvent, addr 0x3b1547c, size 0x9c, virtual true, abstract: false, final true
inline void remove_didResumeEvent(::System::Action*  value) ;

/// @brief Method remove_willResumeEvent, addr 0x3b15344, size 0x9c, virtual true, abstract: false, final true
