...
/// @brief Method SetDataToShaders, addr 0x395f014, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x395f148, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bakeId, addr 0x395f120, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__LightConstants__BakeId get_bakeId() ;

/// @brief Method get_intensity, addr 0x395f128, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method get_weight, addr 0x395f138, size 0x8, virtual false, abstract: false, final false
inline float_t get_weight() ;

/// @brief Method set_intensity, addr 0x395f130, size 0x8, virtual false, abstract: false, final false
inline void set_intensity(float_t  value) ;

/// @brief Method set_weight, addr 0x395f140, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _lightIntensityData, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightIntensityData, put=__cordl_internal_set__lightIntensityData)) ::ArrayW<::GlobalNamespace::__LightmapLightsWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__LightmapLightsWithIds__LightIntensitiesWithId*>*>  _lightIntensityData;
...
/// @brief Method GetLightWithIds, addr 0x395f108, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ProcessNewColorData, addr 0x395ee14, size 0x200, virtual true, abstract: false, final false
inline void ProcessNewColorData() ;

constexpr ::ArrayW<::GlobalNamespace::__LightmapLightsWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__LightmapLightsWithIds__LightIntensitiesWithId*>*> const& __cordl_internal_get__lightIntensityData() const;

constexpr ::ArrayW<::GlobalNamespace::__LightmapLightsWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__LightmapLightsWithIds__LightIntensitiesWithId*>*>& __cordl_internal_get__lightIntensityData() ;
...
constexpr void __cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::__LightmapLightsWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__LightmapLightsWithIds__LightIntensitiesWithId*>*>  value) ;

constexpr void __cordl_internal_set__maxTotalIntensity(float_t  value) ;

/// @brief Method .ctor, addr 0x395f110, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_maxTotalIntensity, addr 0x395ee04, size 0x8, virtual false, abstract: false, final false
inline float_t get_maxTotalIntensity() ;

/// @brief Method set_maxTotalIntensity, addr 0x395ee0c, size 0x8, virtual false, abstract: false, final false
