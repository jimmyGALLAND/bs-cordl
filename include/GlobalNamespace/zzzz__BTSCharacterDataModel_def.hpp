...
/// @brief Method .ctor, addr 0x22205a0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_id, addr 0x2220590, size 0x8, virtual false, abstract: false, final false
inline int32_t get_id() ;

/// @brief Method get_prefabAssetReference, addr 0x2220598, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22205b8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_animationClipAssetReference, addr 0x22205b0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::AddressableAssets::AssetReference* get_animationClipAssetReference() ;

/// @brief Method get_id, addr 0x22205a8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_id() ;
...
/// @brief Field _animationClipsWithIds, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__animationClipsWithIds, put=__cordl_internal_set__animationClipsWithIds)) ::ArrayW<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*,::Array<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*>*>  _animationClipsWithIds;

/// @brief Field _prefabsWithIds, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__prefabsWithIds, put=__cordl_internal_set__prefabsWithIds)) ::ArrayW<::GlobalNamespace::__BTSCharacterDataModel__PrefabWithId*,::Array<::GlobalNamespace::__BTSCharacterDataModel__PrefabWithId*>*>  _prefabsWithIds;

 __declspec(property(get=get_animationClipsWithIds)) ::ArrayW<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*,::Array<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*>*>  animationClipsWithIds;
...
constexpr ::ArrayW<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*,::Array<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*>*> const& __cordl_internal_get__animationClipsWithIds() const;

constexpr ::ArrayW<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*,::Array<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*>*>& __cordl_internal_get__animationClipsWithIds() ;

constexpr ::ArrayW<::GlobalNamespace::__BTSCharacterDataModel__PrefabWithId*,::Array<::GlobalNamespace::__BTSCharacterDataModel__PrefabWithId*>*> const& __cordl_internal_get__prefabsWithIds() const;
...
constexpr void __cordl_internal_set__animationClipsWithIds(::ArrayW<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*,::Array<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*>*>  value) ;
...
/// @brief Method .ctor, addr 0x2220588, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_animationClipsWithIds, addr 0x2220580, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_prefabsWithIds, addr 0x2220578, size 0x8, virtual false, abstract: false, final false
