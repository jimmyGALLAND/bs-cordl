...
/// @brief Method .ctor, addr 0x3b4f6a0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_defaultSpot>b__3_0, addr 0x3b4f6a8, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Field _spectatingSpots, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__spectatingSpots, put=__cordl_internal_set__spectatingSpots)) ::System::Collections::Generic::List_1<::GlobalNamespace::IMultiplayerSpectatingSpot*>*  _spectatingSpots;

/// @brief Field _spotIndexBySpot, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__spotIndexBySpot, put=__cordl_internal_set__spotIndexBySpot)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::IMultiplayerSpectatingSpot*,int32_t>*  _spotIndexBySpot;
...
/// @brief Method GetAdjacentSpot, addr 0x3b4f324, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method GetIndexBySpot, addr 0x3b4f3d8, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method RegisterSpectatingSpot, addr 0x3b4e914, size 0x164, virtual false, abstract: false, final false
inline void RegisterSpectatingSpot(::GlobalNamespace::IMultiplayerSpectatingSpot*  spectatingSpot) ;

/// @brief Method SpotOnHasBeenRemoved, addr 0x3b4f45c, size 0x124, virtual false, abstract: false, final false
inline void SpotOnHasBeenRemoved(::GlobalNamespace::IMultiplayerSpectatingSpot*  spectatingSpot) ;

/// @brief Method UpdateIndexBySpotDictionary, addr 0x3b4f1b0, size 0x174, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::IMultiplayerSpectatingSpot*,int32_t>*> const& __cordl_internal_get__spotIndexBySpot() const;
...
/// @brief Method .ctor, addr 0x3b4f580, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_defaultSpot, addr 0x3b4f050, size 0x160, virtual false, abstract: false, final false
inline ::GlobalNamespace::IMultiplayerSpectatingSpot* get_defaultSpot() ;

/// @brief Method get_spectatingSpots, addr 0x3b4f048, size 0x8, virtual false, abstract: false, final false
