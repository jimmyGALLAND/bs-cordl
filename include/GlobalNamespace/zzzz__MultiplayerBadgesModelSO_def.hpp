...
/// @brief Field _negativeBadges, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__negativeBadges, put=__cordl_internal_set__negativeBadges)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::MultiplayerBadgeDataSO>>*  _negativeBadges;

/// @brief Field _positiveBadges, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__positiveBadges, put=__cordl_internal_set__positiveBadges)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::MultiplayerBadgeDataSO>>*  _positiveBadges;
...
/// @brief Method .ctor, addr 0x268b158, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_negativeBadges, addr 0x268b150, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::UnityW<::GlobalNamespace::MultiplayerBadgeDataSO>>* get_negativeBadges() ;

/// @brief Method get_positiveBadges, addr 0x268b148, size 0x8, virtual false, abstract: false, final false
