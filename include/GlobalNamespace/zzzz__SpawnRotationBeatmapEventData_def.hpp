...
/// @brief Field spawnRotationEventType, offset 0x34, size 0x4 
 __declspec(property(get=__cordl_internal_get_spawnRotationEventType, put=__cordl_internal_set_spawnRotationEventType)) ::GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType  spawnRotationEventType;

 __declspec(property(get=get_subtypeGroupIdentifier)) int32_t  subtypeGroupIdentifier;

/// @brief Method GetCopy, addr 0x22023bc, size 0x90, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapDataItem* GetCopy() ;

/// @brief Method GetDefault, addr 0x220247c, size 0x58, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapEventData* GetDefault() ;

/// @brief Method Mirror, addr 0x22023a0, size 0x1c, virtual false, abstract: false, final false
inline void Mirror() ;
...
/// @brief Method RecalculateRotationFromPreviousEvent, addr 0x220244c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method SetFirstRotationEventRotation, addr 0x2202470, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2202348, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method get_rotation, addr 0x2202338, size 0x8, virtual false, abstract: false, final false
inline float_t get_rotation() ;

/// @brief Method get_subtypeGroupIdentifier, addr 0x2202330, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method set_rotation, addr 0x2202340, size 0x8, virtual false, abstract: false, final false
