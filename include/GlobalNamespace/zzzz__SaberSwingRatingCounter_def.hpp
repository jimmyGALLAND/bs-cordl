...
/// @brief Field _didChangeReceivers, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__didChangeReceivers, put=__cordl_internal_set__didChangeReceivers)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver*>*  _didChangeReceivers;

/// @brief Field _didFinishReceivers, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__didFinishReceivers, put=__cordl_internal_set__didFinishReceivers)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver*>*  _didFinishReceivers;
...
/// @brief Method DrawGizmos, addr 0x2665138, size 0x2b4, virtual false, abstract: false, final false
inline void DrawGizmos() ;

/// @brief Method Finish, addr 0x2664f8c, size 0x1ac, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method Init, addr 0x2664214, size 0x418, virtual false, abstract: false, final false
...
/// @brief Method ProcessNewData, addr 0x266462c, size 0x960, virtual true, abstract: false, final true
...
/// @brief Method RegisterDidChangeReceiver, addr 0x26640b4, size 0x58, virtual true, abstract: false, final true
inline void RegisterDidChangeReceiver(::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver*  receiver) ;

/// @brief Method RegisterDidFinishReceiver, addr 0x266410c, size 0x58, virtual true, abstract: false, final true
inline void RegisterDidFinishReceiver(::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver*  receiver) ;

/// @brief Method UnregisterDidChangeReceiver, addr 0x2664164, size 0x58, virtual true, abstract: false, final true
inline void UnregisterDidChangeReceiver(::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver*  receiver) ;

/// @brief Method UnregisterDidFinishReceiver, addr 0x26641bc, size 0x58, virtual true, abstract: false, final true
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver*>*> const& __cordl_internal_get__didChangeReceivers() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver*>*> const& __cordl_internal_get__didFinishReceivers() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ISaberMovementData*> const& __cordl_internal_get__saberMovementData() const;
...
/// @brief Method .ctor, addr 0x26653ec, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_afterCutRating, addr 0x26640ac, size 0x8, virtual true, abstract: false, final true
inline float_t get_afterCutRating() ;

/// @brief Method get_beforeCutRating, addr 0x26640a4, size 0x8, virtual true, abstract: false, final true
