...
/// @brief Field _gameplayModifiersModelSO, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameplayModifiersModelSO, put=__cordl_internal_set__gameplayModifiersModelSO)) ::UnityW<::GlobalNamespace::GameplayModifiersModelSO>  _gameplayModifiersModelSO;
...
/// @brief Method FillLevelCompletionResults, addr 0x3b51694, size 0x2c4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b51958, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
