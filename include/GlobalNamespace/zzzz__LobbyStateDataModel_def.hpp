...
/// @brief Field _connectedPlayersById, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__connectedPlayersById, put=__cordl_internal_set__connectedPlayersById)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::IConnectedPlayer*>*  _connectedPlayersById;
...
/// @brief Method Activate, addr 0x269297c, size 0x7d8, virtual true, abstract: false, final true
inline void Activate() ;

/// @brief Method Deactivate, addr 0x2693154, size 0x194, virtual true, abstract: false, final true
inline void Deactivate() ;

/// @brief Method Dispose, addr 0x26932e8, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetPlayerById, addr 0x26932ec, size 0x94, virtual true, abstract: false, final true
inline ::GlobalNamespace::IConnectedPlayer* GetPlayerById(::StringW  userId) ;

/// @brief Method HandleMultiplayerSessionManagerPlayerConnected, addr 0x2693380, size 0x168, virtual false, abstract: false, final false
inline void HandleMultiplayerSessionManagerPlayerConnected(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandleMultiplayerSessionManagerPlayerDisconnected, addr 0x26934e8, size 0x120, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::IConnectedPlayer*>*> const& __cordl_internal_get__connectedPlayersById() const;
...
/// @brief Method .ctor, addr 0x2693608, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_playerConnectedEvent, addr 0x26924b8, size 0xb0, virtual true, abstract: false, final true
inline void add_playerConnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method add_playerDisconnectedEvent, addr 0x2692618, size 0xb0, virtual true, abstract: false, final true
inline void add_playerDisconnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method get_configuration, addr 0x2692968, size 0x14, virtual true, abstract: false, final true
inline ::GlobalNamespace::GameplayServerConfiguration get_configuration() ;

/// @brief Method get_connectedPlayers, addr 0x26928bc, size 0x8, virtual true, abstract: false, final true
inline ::System::Collections::Generic::List_1<::GlobalNamespace::IConnectedPlayer*>* get_connectedPlayers() ;

/// @brief Method get_isConnected, addr 0x2692778, size 0xa4, virtual true, abstract: false, final true
inline bool get_isConnected() ;

/// @brief Method get_localPlayer, addr 0x269281c, size 0xa0, virtual true, abstract: false, final true
inline ::GlobalNamespace::IConnectedPlayer* get_localPlayer() ;

/// @brief Method get_rawConnectedPlayers, addr 0x26928c4, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method remove_playerConnectedEvent, addr 0x2692568, size 0xb0, virtual true, abstract: false, final true
inline void remove_playerConnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method remove_playerDisconnectedEvent, addr 0x26926c8, size 0xb0, virtual true, abstract: false, final true
