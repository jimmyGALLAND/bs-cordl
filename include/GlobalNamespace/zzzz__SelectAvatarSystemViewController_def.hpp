...
/// @brief Method MoveNext, addr 0x3b90420, size 0x228, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3b90648, size 0xc, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::SelectAvatarSystemViewController>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<bool>", modifiers: "", def_value: None }]
...
/// @brief Field _avatarSystems, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get__avatarSystems, put=__cordl_internal_set__avatarSystems)) ::System::Collections::Generic::IReadOnlyList_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>*  _avatarSystems;
...
/// @brief Field didRequestCreationOfAvatarEvent, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didRequestCreationOfAvatarEvent, put=__cordl_internal_set_didRequestCreationOfAvatarEvent)) ::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>*  didRequestCreationOfAvatarEvent;

/// @brief Field didRequestEditOfAvatarEvent, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didRequestEditOfAvatarEvent, put=__cordl_internal_set_didRequestEditOfAvatarEvent)) ::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>*  didRequestEditOfAvatarEvent;

/// @brief Field didSetAvatarSystemPreferredEvent, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didSetAvatarSystemPreferredEvent, put=__cordl_internal_set_didSetAvatarSystemPreferredEvent)) ::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>*  didSetAvatarSystemPreferredEvent;

/// @brief Convert operator to "::HMUI::__TableView__IDataSource"
constexpr operator  ::HMUI::__TableView__IDataSource*() noexcept;

/// @brief Method CellForIdx, addr 0x3b900ec, size 0x2ac, virtual true, abstract: false, final true
inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView*  tableView, int32_t  idx) ;

/// @brief Method CellSize, addr 0x3b90040, size 0xc, virtual true, abstract: false, final true
inline float_t CellSize(int32_t  idx) ;

/// @brief Method DidActivate, addr 0x3b8f900, size 0x388, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3b90030, size 0x10, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleLoadedSelectionViewDidPressCreateButton, addr 0x3b903e0, size 0x1c, virtual false, abstract: false, final false
inline void HandleLoadedSelectionViewDidPressCreateButton(::BeatSaber::AvatarCore::IAvatarSystemMetadata*  avatarSystem) ;

/// @brief Method HandleLoadedSelectionViewDidPressEditButton, addr 0x3b903c4, size 0x1c, virtual false, abstract: false, final false
inline void HandleLoadedSelectionViewDidPressEditButton(::BeatSaber::AvatarCore::IAvatarSystemMetadata*  avatarSystem) ;

/// @brief Method HandleLoadedSelectionViewDidPressPreferredButton, addr 0x3b90398, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method NumberOfCells, addr 0x3b9004c, size 0xa0, virtual true, abstract: false, final true
inline int32_t NumberOfCells() ;

/// @brief Method Prewarm, addr 0x3b8f254, size 0x48, virtual false, abstract: false, final false
inline void Prewarm(::System::Collections::Generic::IReadOnlyList_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>*  avatarSystems, ::BeatSaber::AvatarCore::IAvatarSystemMetadata*  selectedAvatarSystem) ;

/// @brief Method ReloadContinueButtonInteractability, addr 0x3b8ffa0, size 0x90, virtual false, abstract: false, final false
inline void ReloadContinueButtonInteractability() ;

/// @brief Method ReloadCreateEditButtonOfAvatarSystem, addr 0x3b8fc88, size 0x318, virtual false, abstract: false, final false
inline void ReloadCreateEditButtonOfAvatarSystem(::BeatSaber::AvatarCore::IAvatarSystemMetadata*  avatarSystem) ;

/// @brief Method SetAllCellsActive, addr 0x3b8f5c8, size 0x338, virtual false, abstract: false, final false
inline void SetAllCellsActive(bool  active) ;

/// @brief Method SetSelectedAvatarSystem, addr 0x3b8f29c, size 0x32c, virtual false, abstract: false, final false
inline void SetSelectedAvatarSystem(::BeatSaber::AvatarCore::IAvatarSystemMetadata*  selectedAvatarSystem) ;

/// @brief Method <DidActivate>b__26_0, addr 0x3b90404, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b903fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didPressContinueButtonEvent, addr 0x3b8f0c4, size 0x9c, virtual false, abstract: false, final false
inline void add_didPressContinueButtonEvent(::System::Action*  value) ;

/// @brief Method add_didRequestCreationOfAvatarEvent, addr 0x3b8ef64, size 0xb0, virtual false, abstract: false, final false
inline void add_didRequestCreationOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>*  value) ;

/// @brief Method add_didRequestEditOfAvatarEvent, addr 0x3b8ee04, size 0xb0, virtual false, abstract: false, final false
inline void add_didRequestEditOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>*  value) ;

/// @brief Method add_didSetAvatarSystemPreferredEvent, addr 0x3b8eca4, size 0xb0, virtual false, abstract: false, final false
inline void add_didSetAvatarSystemPreferredEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>*  value) ;

/// @brief Method get_continueButtonVisible, addr 0x3b8f1fc, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method remove_didPressContinueButtonEvent, addr 0x3b8f160, size 0x9c, virtual false, abstract: false, final false
inline void remove_didPressContinueButtonEvent(::System::Action*  value) ;

/// @brief Method remove_didRequestCreationOfAvatarEvent, addr 0x3b8f014, size 0xb0, virtual false, abstract: false, final false
inline void remove_didRequestCreationOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>*  value) ;

/// @brief Method remove_didRequestEditOfAvatarEvent, addr 0x3b8eeb4, size 0xb0, virtual false, abstract: false, final false
inline void remove_didRequestEditOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>*  value) ;

/// @brief Method remove_didSetAvatarSystemPreferredEvent, addr 0x3b8ed54, size 0xb0, virtual false, abstract: false, final false
inline void remove_didSetAvatarSystemPreferredEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>*  value) ;

/// @brief Method set_continueButtonVisible, addr 0x3b8f224, size 0x30, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__SelectAvatarSystemViewController___ReloadContinueButtonInteractability_d__31, "", "SelectAvatarSystemViewController/<ReloadContinueButtonInteractability>d__31");
