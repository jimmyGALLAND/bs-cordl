...
/// @brief Method Equals, addr 0x394216c, size 0x20, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::HMAutoincrementedRequestId*  obj) ;

/// @brief Method Equals, addr 0x394218c, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x394221c, size 0x28, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3941fc0, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

static inline uint64_t getStaticF__nextRequestId() ;

/// @brief Method get_RequestId, addr 0x3942164, size 0x8, virtual false, abstract: false, final false
