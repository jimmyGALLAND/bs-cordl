...
/// @brief Method ColorWasSet, addr 0x39620a4, size 0x4c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39620f0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_color, addr 0x3962088, size 0x1c, virtual false, abstract: false, final false
