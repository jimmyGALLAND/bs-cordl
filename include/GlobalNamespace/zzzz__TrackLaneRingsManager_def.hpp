...
/// @brief Field _rings, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__rings, put=__cordl_internal_set__rings)) ::ArrayW<::UnityW<::GlobalNamespace::TrackLaneRing>,::Array<::UnityW<::GlobalNamespace::TrackLaneRing>>*>  _rings;
...
/// @brief Method FixedUpdate, addr 0x3b0a708, size 0x9c, virtual false, abstract: false, final false
inline void FixedUpdate() ;

/// @brief Method LateUpdate, addr 0x3b0a7a4, size 0x9c, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::TrackLaneRingsManager* New_ctor() ;

/// @brief Method OnDrawGizmosSelected, addr 0x3b0a840, size 0x284, virtual false, abstract: false, final false
inline void OnDrawGizmosSelected() ;

/// @brief Method Start, addr 0x3b0a458, size 0x2b0, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b0aac4, size 0x18c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Rings, addr 0x3b0a450, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::GlobalNamespace::TrackLaneRing>,::Array<::UnityW<::GlobalNamespace::TrackLaneRing>>*> get_Rings() ;

/// @brief Method get_ringPositionStep, addr 0x3b0a448, size 0x8, virtual false, abstract: false, final false
