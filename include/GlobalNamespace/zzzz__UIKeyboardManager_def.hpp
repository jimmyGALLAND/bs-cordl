...
/// @brief Method CloseKeyboard, addr 0x3b6a990, size 0x9c, virtual false, abstract: false, final false
inline void CloseKeyboard() ;

/// @brief Method HandleKeyboardOkButton, addr 0x3b6ac80, size 0x160, virtual false, abstract: false, final false
inline void HandleKeyboardOkButton() ;

static inline ::GlobalNamespace::UIKeyboardManager* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b6a6c8, size 0x100, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x3b6a638, size 0x90, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3b6a5a8, size 0x90, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OpenKeyboardFor, addr 0x3b6a7c8, size 0x1c8, virtual false, abstract: false, final false
inline void OpenKeyboardFor(::HMUI::InputFieldView*  input) ;

/// @brief Method ProcessMousePress, addr 0x3b6ab18, size 0x168, virtual false, abstract: false, final false
inline void ProcessMousePress(::UnityEngine::GameObject*  currentOverGo) ;

/// @brief Method ShouldCloseKeyboard, addr 0x3b6aac0, size 0x58, virtual false, abstract: false, final false
inline bool ShouldCloseKeyboard(::UnityEngine::GameObject*  root) ;

/// @brief Method Start, addr 0x3b6a4b8, size 0xf0, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method TransferKeyboardTo, addr 0x3b6aa2c, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b6ade0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_keyboard, addr 0x3b6a4b0, size 0x8, virtual false, abstract: false, final false
