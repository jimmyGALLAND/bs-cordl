...
/// @brief Method OnDisable, addr 0x3960488, size 0x84, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x39603fc, size 0x4, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RegisterLight, addr 0x3960400, size 0x84, virtual false, abstract: false, final false
inline void RegisterLight() ;

/// @brief Method SetLightId, addr 0x396050c, size 0xa8, virtual false, abstract: false, final false
inline void SetLightId(int32_t  newLightId) ;

/// @brief Method Start, addr 0x3960484, size 0x4, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method __SetIsRegistered, addr 0x39603e8, size 0xc, virtual true, abstract: false, final true
inline void __SetIsRegistered() ;

/// @brief Method __SetIsUnRegistered, addr 0x39603f4, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x395ddc8, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isRegistered, addr 0x39603e0, size 0x8, virtual true, abstract: false, final true
inline bool get_isRegistered() ;

/// @brief Method get_lightId, addr 0x39603d8, size 0x8, virtual true, abstract: false, final true
