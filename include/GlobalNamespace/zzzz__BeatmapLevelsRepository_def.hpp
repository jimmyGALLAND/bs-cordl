...
/// @brief Method AddBeatmapLevel, addr 0x267be30, size 0x98, virtual false, abstract: false, final false
inline void AddBeatmapLevel(::GlobalNamespace::BeatmapLevel*  beatmapLevel, ::StringW  songPackId) ;

/// @brief Method GetBeatmapLevelById, addr 0x267bdd8, size 0x58, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevel* GetBeatmapLevelById(::StringW  levelId) ;

/// @brief Method GetBeatmapLevelPackByBeatmapLevelId, addr 0x267bd54, size 0x84, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevelPack* GetBeatmapLevelPackByBeatmapLevelId(::StringW  levelId) ;

/// @brief Method GetBeatmapLevelPackByPackId, addr 0x267bcfc, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method TryGetBeatmapLevelById, addr 0x267bec8, size 0x68, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::BeatmapLevelPack*>*> const& __cordl_internal_get__idToBeatmapLevelPack() const;
...
/// @brief Method .ctor, addr 0x267b9bc, size 0x340, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::BeatmapLevelPack*>*  beatmapLevelPacks) ;

/// @brief Method get_beatmapLevelPacks, addr 0x267b9b4, size 0x8, virtual false, abstract: false, final false
