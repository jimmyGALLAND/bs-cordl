...
/// @brief Method OpenInvitePanel, addr 0x268cc84, size 0x68, virtual true, abstract: false, final true
inline void OpenInvitePanel() ;

/// @brief Method .ctor, addr 0x268ccec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isSupported, addr 0x268cc7c, size 0x8, virtual true, abstract: false, final true
