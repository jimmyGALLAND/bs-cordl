...
/// @brief Method .ctor, addr 0x266088c, size 0x38, virtual false, abstract: false, final false
inline void _ctor(float_t  time, ::GlobalNamespace::__BombExecutionRating__Rating  rating) ;

/// @brief Method get_rating, addr 0x2660884, size 0x8, virtual false, abstract: false, final false
