...
/// @brief Method CreateTexture, addr 0x3a8fa18, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a90324, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method get_backgroundColor, addr 0x3a90318, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_backgroundColor() ;

/// @brief Method get_layerMask, addr 0x3a902f8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_layerMask() ;

/// @brief Method get_name, addr 0x3a902e8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method get_path, addr 0x3a90308, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_path() ;

/// @brief Method get_texture, addr 0x3a902f0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> get_texture() ;

/// @brief Method get_type, addr 0x3a90300, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot__Type get_type() ;

/// @brief Method set_path, addr 0x3a90310, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _cameraCalibration, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__cameraCalibration, put=__cordl_internal_set__cameraCalibration)) ::GlobalNamespace::__PosesRecordingData__ExternalCameraCalibration*  _cameraCalibration;
...
/// @brief Field _screenshots, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__screenshots, put=__cordl_internal_set__screenshots)) ::ArrayW<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*,::Array<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*>*>  _screenshots;
...
/// @brief Method CreateClipQuad, addr 0x3a8f728, size 0x27c, virtual false, abstract: false, final false
inline void CreateClipQuad() ;

/// @brief Method CreateTextures, addr 0x3a8f9a4, size 0x74, virtual false, abstract: false, final false
inline void CreateTextures(int32_t  width, int32_t  height) ;

/// @brief Method GetDistanceToHMD, addr 0x3a8fadc, size 0x30c, virtual false, abstract: false, final false
inline float_t GetDistanceToHMD() ;

/// @brief Method InitCamera, addr 0x3a8f640, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method LateUpdate, addr 0x3a9023c, size 0xa4, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::PlaybackRenderer* New_ctor() ;

/// @brief Method OrientClipQuad, addr 0x3a8fde8, size 0x140, virtual false, abstract: false, final false
inline void OrientClipQuad() ;

/// @brief Method RenderBackground, addr 0x3a900e8, size 0x154, virtual false, abstract: false, final false
inline void RenderBackground(::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*  screenshot) ;

/// @brief Method RenderForeground, addr 0x3a8ff28, size 0x1c0, virtual false, abstract: false, final false
inline void RenderForeground(::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*  screenshot) ;

/// @brief Method Setup, addr 0x3a8ebd4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a902e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_texturesReadyEvent, addr 0x3a8f500, size 0x9c, virtual false, abstract: false, final false
inline void add_texturesReadyEvent(::System::Action*  value) ;

/// @brief Method get_screenshots, addr 0x3a8f638, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method remove_texturesReadyEvent, addr 0x3a8f59c, size 0x9c, virtual false, abstract: false, final false
