...
/// @brief Field <appInitOverrideStartType>k__BackingField, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__appInitOverrideStartType_k__BackingField, put=__cordl_internal_set__appInitOverrideStartType_k__BackingField)) ::GlobalNamespace::__AppInitScenesTransitionSetupDataSO__AppInitOverrideStartType  _appInitOverrideStartType_k__BackingField;

 __declspec(property(get=get_appInitOverrideStartType, put=set_appInitOverrideStartType)) ::GlobalNamespace::__AppInitScenesTransitionSetupDataSO__AppInitOverrideStartType  appInitOverrideStartType;

static inline ::GlobalNamespace::__AppInitScenesTransitionSetupDataSO__AppInitSceneSetupData* New_ctor(::GlobalNamespace::__AppInitScenesTransitionSetupDataSO__AppInitOverrideStartType  appInitOverrideStartType) ;
...
/// @brief Method .ctor, addr 0x2249708, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_appInitOverrideStartType, addr 0x22504d0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__AppInitScenesTransitionSetupDataSO__AppInitOverrideStartType get_appInitOverrideStartType() ;

/// @brief Method set_appInitOverrideStartType, addr 0x22504d8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x22502a0, size 0x64, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method InitAsAppStart, addr 0x22503f0, size 0x64, virtual false, abstract: false, final false
inline void InitAsAppStart() ;

static inline ::GlobalNamespace::AppInitScenesTransitionSetupDataSO* New_ctor() ;

/// @brief Method __Init, addr 0x2250454, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22504c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
