...
/// @brief Method CreateRenderTexturesIfNeeded, addr 0x3ff4808, size 0x28c, virtual false, abstract: false, final false
inline void CreateRenderTexturesIfNeeded(int32_t  width, int32_t  height) ;

/// @brief Method FilterTexture, addr 0x3ff4688, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ff45c4, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;
