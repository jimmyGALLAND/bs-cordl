...
public:
// Declarations
/// @brief Method Init, addr 0x3ab24dc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ab24e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
