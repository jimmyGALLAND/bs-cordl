...
/// @brief Method AnimateOutro, addr 0x3b45fa4, size 0x1bc, virtual false, abstract: false, final false
inline void AnimateOutro(::GlobalNamespace::MultiplayerResultsData*  multiplayerResultsData, ::System::Action*  onCompleted) ;

/// @brief Method BindOutroTimeline, addr 0x3b46160, size 0x6b4, virtual false, abstract: false, final false
inline void BindOutroTimeline() ;

/// @brief Method BindRingsAndAudio, addr 0x3b469ec, size 0x748, virtual false, abstract: false, final false
...
/// @brief Method Completed, addr 0x3b47704, size 0x24, virtual false, abstract: false, final false
inline void Completed() ;

/// @brief Method HandlePlayerSpawningDidFinish, addr 0x3b45d7c, size 0x24, virtual false, abstract: false, final false
inline void HandlePlayerSpawningDidFinish() ;

static inline ::GlobalNamespace::MultiplayerOutroAnimationController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b45e3c, size 0xcc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b45ce0, size 0x9c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b47b24, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
