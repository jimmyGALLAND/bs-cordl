...
/// @brief Method <CreateData>b__3_0, addr 0x26853ec, size 0x20, virtual false, abstract: false, final false
inline ::StringW _CreateData_b__3_0(::GlobalNamespace::BeatmapLevel*  x) ;

/// @brief Method .ctor, addr 0x26853e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CreateData, addr 0x2684e10, size 0x578, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::__AlphabetScrollInfo__Data*>* CreateData(::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::BeatmapLevel*>*  beatmapLevels, bool  sortBeatmapLevels, ByRef<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::BeatmapLevel*>*>  sortedBeatmapLevels) ;
