...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::IServerSongPackProvider* (::GlobalNamespace::IServerSongPackProviderManager::*)()>(&::GlobalNamespace::IServerSongPackProviderManager::GetServerSongPackProvider)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Task* (::GlobalNamespace::IServerSongPackProviderManager::*)()>(&::GlobalNamespace::IServerSongPackProviderManager::RefreshAsync)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
