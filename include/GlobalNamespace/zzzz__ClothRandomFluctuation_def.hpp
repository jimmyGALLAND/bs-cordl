...
/// @brief Method .ctor, addr 0x3a4685c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _compoundSins, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__compoundSins, put=__cordl_internal_set__compoundSins)) ::System::Collections::Generic::List_1<::GlobalNamespace::__ClothRandomFluctuation__SineLayer*>*  _compoundSins;
...
/// @brief Method FluctuateCloth, addr 0x3a465e0, size 0x170, virtual false, abstract: false, final false
inline void FluctuateCloth(::UnityEngine::Cloth*  cloth) ;

/// @brief Method GetNoise, addr 0x3a46750, size 0x104, virtual false, abstract: false, final false
inline float_t GetNoise(float_t  time, float_t  offset) ;

static inline ::GlobalNamespace::ClothRandomFluctuation* New_ctor() ;

/// @brief Method Update, addr 0x3a465d8, size 0x8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3a46854, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
