...
/// @brief Field gameLiftPlayerSessionProvider, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_gameLiftPlayerSessionProvider, put=__cordl_internal_set_gameLiftPlayerSessionProvider)) ::BGNet::Core::GameLift::IGameLiftPlayerSessionProvider*  gameLiftPlayerSessionProvider;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::Task_1<::GlobalNamespace::IAuthenticationTokenProvider*>*> const& __cordl_internal_get_authenticationTokenProviderTask() const;
...
/// @brief Method .ctor, addr 0x227c07c, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Convert to "::GlobalNamespace::IConnectionInitParams_1<::GlobalNamespace::GameLiftConnectionManager*>"
constexpr ::GlobalNamespace::IConnectionInitParams_1<::GlobalNamespace::GameLiftConnectionManager*>* i___GlobalNamespace__IConnectionInitParams_1___GlobalNamespace__GameLiftConnectionManager__() noexcept;
...
/// @brief Method .ctor, addr 0x227c0bc, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x227c0e8, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x227c114, size 0x634, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x227c748, size 0xc, virtual true, abstract: false, final true
...
/// @brief Field _connectionRequestHandler, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__connectionRequestHandler, put=__cordl_internal_set__connectionRequestHandler)) ::GlobalNamespace::GameLiftClientConnectionRequestHandler*  _connectionRequestHandler;
...
/// @brief Method Disconnect, addr 0x227b7ec, size 0x8, virtual true, abstract: false, final true
inline void Disconnect(::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method DisconnectInternal, addr 0x227ba58, size 0xc, virtual false, abstract: false, final false
inline void DisconnectInternal(::GlobalNamespace::ConnectionFailedReason  connectionFailedReason) ;

/// @brief Method DisconnectInternal, addr 0x227b7f4, size 0x264, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x227b74c, size 0xa0, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DisposeAsync, addr 0x227b6a8, size 0xa4, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task* DisposeAsync() ;

/// @brief Method GameLiftConnectToServer, addr 0x227bba0, size 0xb4, virtual false, abstract: false, final false
inline void GameLiftConnectToServer(::StringW  secret, ::StringW  code, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method GetConnection, addr 0x227ba64, size 0xac, virtual true, abstract: false, final true
inline ::GlobalNamespace::IConnection* GetConnection(int32_t  index) ;

/// @brief Method GetPublicServers, addr 0x227c020, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method HandleConnectToServerSuccess, addr 0x227bc54, size 0x3bc, virtual false, abstract: false, final false
...
/// @brief Method HandleConnected, addr 0x227bb10, size 0x30, virtual false, abstract: false, final false
inline void HandleConnected() ;

/// @brief Method HandleConnectionConnected, addr 0x227bb40, size 0x1c, virtual false, abstract: false, final false
inline void HandleConnectionConnected(::GlobalNamespace::IConnection*  connection) ;

/// @brief Method HandleConnectionDisconnected, addr 0x227bb5c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method HandleConnectionFailed, addr 0x227bb78, size 0xc, virtual false, abstract: false, final false
inline void HandleConnectionFailed(::GlobalNamespace::ConnectionFailedReason  failedReason) ;

/// @brief Method HandleReceivedData, addr 0x227bb84, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method PollUpdate, addr 0x227afc8, size 0xa0, virtual true, abstract: false, final true
inline void PollUpdate() ;

/// @brief Method SendToAll, addr 0x227ae48, size 0xbc, virtual true, abstract: false, final true
inline void SendToAll(::LiteNetLib::Utils::NetDataWriter*  writer, ::BGNet::Core::DeliveryMethod  deliveryMethod) ;

/// @brief Method SendToAll, addr 0x227af04, size 0xc4, virtual true, abstract: false, final true
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::Task_1<::GlobalNamespace::IAuthenticationTokenProvider*>*> const& __cordl_internal_get__authenticationTokenProviderTask() const;
...
/// @brief Method .ctor, addr 0x227b068, size 0xf8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x227b20c, size 0x49c, virtual false, abstract: false, final false
...
/// @brief Method add_onConnectedEvent, addr 0x227a1e8, size 0x9c, virtual true, abstract: false, final true
inline void add_onConnectedEvent(::System::Action*  value) ;

/// @brief Method add_onConnectionConnectedEvent, addr 0x227a5e0, size 0xb0, virtual true, abstract: false, final true
inline void add_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>*  value) ;

/// @brief Method add_onConnectionDisconnectedEvent, addr 0x227a740, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method add_onConnectionFailedEvent, addr 0x227a480, size 0xb0, virtual true, abstract: false, final true
inline void add_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>*  value) ;

/// @brief Method add_onDisconnectedEvent, addr 0x227a320, size 0xb0, virtual true, abstract: false, final true
inline void add_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>*  value) ;

/// @brief Method add_onInitializedEvent, addr 0x227a0b0, size 0x9c, virtual true, abstract: false, final true
inline void add_onInitializedEvent(::System::Action*  value) ;

/// @brief Method add_onReceivedDataEvent, addr 0x227a8a0, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method get_code, addr 0x227ae38, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_code() ;

/// @brief Method get_configuration, addr 0x227ae24, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayServerConfiguration get_configuration() ;

/// @brief Method get_connectionCount, addr 0x227ac08, size 0xa4, virtual true, abstract: false, final true
inline int32_t get_connectionCount() ;

/// @brief Method get_isConnected, addr 0x227abd8, size 0x10, virtual true, abstract: false, final true
inline bool get_isConnected() ;

/// @brief Method get_isConnecting, addr 0x227abe8, size 0x10, virtual true, abstract: false, final true
inline bool get_isConnecting() ;

/// @brief Method get_isConnectionOwner, addr 0x227acac, size 0xa4, virtual true, abstract: false, final true
inline bool get_isConnectionOwner() ;

/// @brief Method get_isDisconnecting, addr 0x227abf8, size 0x10, virtual true, abstract: false, final true
inline bool get_isDisconnecting() ;

/// @brief Method get_isDisposed, addr 0x227ad50, size 0xa4, virtual true, abstract: false, final true
inline bool get_isDisposed() ;

/// @brief Method get_playerSessionId, addr 0x227adf4, size 0x1c, virtual false, abstract: false, final false
inline ::StringW get_playerSessionId() ;

/// @brief Method get_secret, addr 0x227ae40, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_secret() ;

/// @brief Method get_selectionMask, addr 0x227ae10, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevelSelectionMask get_selectionMask() ;

/// @brief Method get_userId, addr 0x227aa00, size 0xec, virtual true, abstract: false, final true
inline ::StringW get_userId() ;

/// @brief Method get_userName, addr 0x227aaec, size 0xec, virtual true, abstract: false, final true
...
/// @brief Method remove_onConnectedEvent, addr 0x227a284, size 0x9c, virtual true, abstract: false, final true
inline void remove_onConnectedEvent(::System::Action*  value) ;

/// @brief Method remove_onConnectionConnectedEvent, addr 0x227a690, size 0xb0, virtual true, abstract: false, final true
inline void remove_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>*  value) ;

/// @brief Method remove_onConnectionDisconnectedEvent, addr 0x227a7f0, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method remove_onConnectionFailedEvent, addr 0x227a530, size 0xb0, virtual true, abstract: false, final true
inline void remove_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>*  value) ;

/// @brief Method remove_onDisconnectedEvent, addr 0x227a3d0, size 0xb0, virtual true, abstract: false, final true
inline void remove_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>*  value) ;

/// @brief Method remove_onInitializedEvent, addr 0x227a14c, size 0x9c, virtual true, abstract: false, final true
inline void remove_onInitializedEvent(::System::Action*  value) ;

/// @brief Method remove_onReceivedDataEvent, addr 0x227a950, size 0xb0, virtual true, abstract: false, final true
