...
public:
// Declarations
/// @brief Method Init, addr 0x3ab1f40, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ab1f48, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
