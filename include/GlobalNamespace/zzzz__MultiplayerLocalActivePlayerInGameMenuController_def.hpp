...
/// @brief Field _inGameMenuViewController, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__inGameMenuViewController, put=__cordl_internal_set__inGameMenuViewController)) ::UnityW<::GlobalNamespace::MultiplayerLocalActivePlayerInGameMenuViewController>  _inGameMenuViewController;
...
/// @brief Method HandleInGameMenuViewControllerDidPressDisconnectButton, addr 0x3b170d8, size 0x1c, virtual false, abstract: false, final false
inline void HandleInGameMenuViewControllerDidPressDisconnectButton() ;

/// @brief Method HandleInGameMenuViewControllerDidPressGiveUpButton, addr 0x3b1709c, size 0x3c, virtual false, abstract: false, final false
inline void HandleInGameMenuViewControllerDidPressGiveUpButton() ;

/// @brief Method HandleInGameMenuViewControllerDidPressResumeButton, addr 0x3b17098, size 0x4, virtual false, abstract: false, final false
inline void HandleInGameMenuViewControllerDidPressResumeButton() ;

/// @brief Method HandleInputFocusWasCaptured, addr 0x3b17094, size 0x4, virtual false, abstract: false, final false
inline void HandleInputFocusWasCaptured() ;

/// @brief Method HandleMenuButtonTriggered, addr 0x3b17090, size 0x4, virtual false, abstract: false, final false
inline void HandleMenuButtonTriggered() ;

/// @brief Method HandleStateChanged, addr 0x3b170f4, size 0x1c8, virtual false, abstract: false, final false
inline void HandleStateChanged(::GlobalNamespace::__MultiplayerController__State  state) ;

/// @brief Method HideInGameMenu, addr 0x3b16654, size 0x184, virtual false, abstract: false, final false
inline void HideInGameMenu() ;

static inline ::GlobalNamespace::MultiplayerLocalActivePlayerInGameMenuController* New_ctor() ;

/// @brief Method OnApplicationPause, addr 0x3b16ec8, size 0xc, virtual false, abstract: false, final false
inline void OnApplicationPause(bool  pauseStatus) ;

/// @brief Method OnDestroy, addr 0x3b169ac, size 0x348, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method ShowInGameMenu, addr 0x3b16ed4, size 0x128, virtual false, abstract: false, final false
inline void ShowInGameMenu() ;

/// @brief Method Start, addr 0x3b1638c, size 0x2c8, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b172bc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didGiveUpEvent, addr 0x3b160e4, size 0x9c, virtual false, abstract: false, final false
inline void add_didGiveUpEvent(::System::Action*  value) ;

/// @brief Method add_requestsDisconnectEvent, addr 0x3b1621c, size 0x9c, virtual false, abstract: false, final false
inline void add_requestsDisconnectEvent(::System::Action*  value) ;

/// @brief Method get_canChangeMenuState, addr 0x3b1635c, size 0x30, virtual false, abstract: false, final false
inline bool get_canChangeMenuState() ;

/// @brief Method get_gameMenuIsShown, addr 0x3b16354, size 0x8, virtual false, abstract: false, final false
inline bool get_gameMenuIsShown() ;

/// @brief Method remove_didGiveUpEvent, addr 0x3b16180, size 0x9c, virtual false, abstract: false, final false
inline void remove_didGiveUpEvent(::System::Action*  value) ;

/// @brief Method remove_requestsDisconnectEvent, addr 0x3b162b8, size 0x9c, virtual false, abstract: false, final false
