...
/// @brief Method .ctor, addr 0x3a7b3c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_conditionText, addr 0x3a7b368, size 0x24, virtual false, abstract: false, final false
inline void set_conditionText(::StringW  value) ;

/// @brief Method set_hideCondition, addr 0x3a7b38c, size 0x34, virtual false, abstract: false, final false
inline void set_hideCondition(bool  value) ;

/// @brief Method set_title, addr 0x3a7b344, size 0x24, virtual false, abstract: false, final false
