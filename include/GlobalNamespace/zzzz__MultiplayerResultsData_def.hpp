...
/// @brief Field _allPlayersSortedData, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__allPlayersSortedData, put=__cordl_internal_set__allPlayersSortedData)) ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MultiplayerPlayerResultsData*>*  _allPlayersSortedData;
...
/// @brief Field _otherPlayersData, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__otherPlayersData, put=__cordl_internal_set__otherPlayersData)) ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MultiplayerPlayerResultsData*>*  _otherPlayersData;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MultiplayerPlayerResultsData*>*> const& __cordl_internal_get__allPlayersSortedData() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MultiplayerPlayerResultsData*>*> const& __cordl_internal_get__otherPlayersData() const;
...
/// @brief Method .ctor, addr 0x26938a0, size 0x538, virtual false, abstract: false, final false
inline void _ctor(::StringW  gameId, ::GlobalNamespace::MultiplayerLevelCompletionResults*  localPlayerResultData, ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::MultiplayerLevelCompletionResults*>*  otherPlayersResultData, ::GlobalNamespace::MultiplayerBadgesProvider*  badgesProvider, ::GlobalNamespace::IMultiplayerSessionManager*  multiplayerSessionManager) ;

/// @brief Method get_allPlayersSortedData, addr 0x2693898, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MultiplayerPlayerResultsData*>* get_allPlayersSortedData() ;

/// @brief Method get_gameId, addr 0x2693880, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_gameId() ;

/// @brief Method get_localPlayerResultData, addr 0x2693888, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MultiplayerPlayerResultsData* get_localPlayerResultData() ;

/// @brief Method get_otherPlayersData, addr 0x2693890, size 0x8, virtual false, abstract: false, final false
