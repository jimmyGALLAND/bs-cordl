...
/// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x3a51fc8, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x3a51f28, size 0xa0, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3a520e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
