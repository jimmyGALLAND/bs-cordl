...
/// @brief Field _menuEnvironmentManager, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__menuEnvironmentManager, put=__cordl_internal_set__menuEnvironmentManager)) ::UnityW<::GlobalNamespace::MenuEnvironmentManager>  _menuEnvironmentManager;
...
/// @brief Field _multiplayerLobbyAvatarManager, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerLobbyAvatarManager, put=__cordl_internal_set__multiplayerLobbyAvatarManager)) ::UnityW<::GlobalNamespace::MultiplayerLobbyAvatarManager>  _multiplayerLobbyAvatarManager;

/// @brief Field _multiplayerLobbyAvatarPlaceManager, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerLobbyAvatarPlaceManager, put=__cordl_internal_set__multiplayerLobbyAvatarPlaceManager)) ::UnityW<::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager>  _multiplayerLobbyAvatarPlaceManager;

/// @brief Field _multiplayerLobbyCenterStageManager, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerLobbyCenterStageManager, put=__cordl_internal_set__multiplayerLobbyCenterStageManager)) ::UnityW<::GlobalNamespace::MultiplayerLobbyCenterStageManager>  _multiplayerLobbyCenterStageManager;
...
/// @brief Method ActivateMultiplayerLobby, addr 0x3b79500, size 0xcc, virtual false, abstract: false, final false
inline void ActivateMultiplayerLobby() ;

/// @brief Method DeactivateMultiplayerLobby, addr 0x3b795cc, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b79650, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_lobbyActivated, addr 0x3b794ec, size 0x8, virtual false, abstract: false, final false
inline bool get_lobbyActivated() ;

/// @brief Method set_lobbyActivated, addr 0x3b794f4, size 0xc, virtual false, abstract: false, final false
