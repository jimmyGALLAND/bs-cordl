...
static __declspec(property(get=getStaticF_SceneRooms, put=setStaticF_SceneRooms)) ::System::Collections::Generic::Dictionary_2<::System::Guid,::UnityW<::GlobalNamespace::OVRSceneRoom>>*  SceneRooms;
...
/// @brief Field <Walls>k__BackingField, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__Walls_k__BackingField, put=__cordl_internal_set__Walls_k__BackingField)) ::ArrayW<::UnityW<::GlobalNamespace::OVRScenePlane>,::Array<::UnityW<::GlobalNamespace::OVRScenePlane>>*>  _Walls_k__BackingField;

/// @brief Field _onAnchorLocalizationCompleted, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__onAnchorLocalizationCompleted, put=__cordl_internal_set__onAnchorLocalizationCompleted)) ::System::Action_2<bool,::GlobalNamespace::OVRAnchor>*  _onAnchorLocalizationCompleted;
...
/// @brief Field _orderedRoomGuids, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__orderedRoomGuids, put=__cordl_internal_set__orderedRoomGuids)) ::System::Collections::Generic::Dictionary_2<::System::Guid,int32_t>*  _orderedRoomGuids;
...
/// @brief Field _wallOrderComparer, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__wallOrderComparer, put=__cordl_internal_set__wallOrderComparer)) ::System::Comparison_1<::UnityW<::GlobalNamespace::OVRScenePlane>>*  _wallOrderComparer;
...
/// @brief Method Awake, addr 0x3f80370, size 0x1f4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetUuidsToQuery, addr 0x3f80674, size 0x6f4, virtual false, abstract: false, final false
inline void GetUuidsToQuery() ;

/// @brief Method IOVRSceneComponent.Initialize, addr 0x3f80564, size 0x110, virtual true, abstract: false, final true
inline void IOVRSceneComponent_Initialize() ;

/// @brief Method LoadRoom, addr 0x3f79474, size 0x110, virtual false, abstract: false, final false
inline void LoadRoom() ;

static inline ::GlobalNamespace::OVRSceneRoom* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3f81a24, size 0xb8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnFetchAnchorsCompleted, addr 0x3f80d68, size 0x4a0, virtual false, abstract: false, final false
inline void OnFetchAnchorsCompleted(bool  success) ;

/// @brief Method OnLocalizationCompleted, addr 0x3f81208, size 0x3f0, virtual false, abstract: false, final false
inline void OnLocalizationCompleted(bool  success, ::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method UpdateRoomInformation, addr 0x3f815f8, size 0x42c, virtual false, abstract: false, final false
inline void UpdateRoomInformation(::GlobalNamespace::OVRScenePlane*  plane) ;

/// @brief Method <Awake>b__24_0, addr 0x3f81d4c, size 0x60, virtual false, abstract: false, final false
inline int32_t _Awake_b__24_0(::GlobalNamespace::OVRScenePlane*  planeA, ::GlobalNamespace::OVRScenePlane*  planeB) ;

/// @brief Method <Awake>g__TryGetUuid|24_1, addr 0x3f81dac, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f81adc, size 0x194, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Ceiling, addr 0x3f80350, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::OVRScenePlane> get_Ceiling() ;

/// @brief Method get_Floor, addr 0x3f80340, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::OVRScenePlane> get_Floor() ;

/// @brief Method get_Walls, addr 0x3f80360, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Ceiling, addr 0x3f80358, size 0x8, virtual false, abstract: false, final false
inline void set_Ceiling(::GlobalNamespace::OVRScenePlane*  value) ;

/// @brief Method set_Floor, addr 0x3f80348, size 0x8, virtual false, abstract: false, final false
inline void set_Floor(::GlobalNamespace::OVRScenePlane*  value) ;

/// @brief Method set_Walls, addr 0x3f80368, size 0x8, virtual false, abstract: false, final false
