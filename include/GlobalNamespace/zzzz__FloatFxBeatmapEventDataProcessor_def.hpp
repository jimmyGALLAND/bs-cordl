...
/// @brief Method UpdateByOther, addr 0x22029f8, size 0x28, virtual true, abstract: false, final false
inline void UpdateByOther(::GlobalNamespace::FloatFxBeatmapEventData*  current, ::GlobalNamespace::FloatFxBeatmapEventData*  other) ;

/// @brief Method .ctor, addr 0x2202a20, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
