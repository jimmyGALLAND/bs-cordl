...
/// @brief Method CellForIdx, addr 0x3a7bb50, size 0x1d0, virtual true, abstract: false, final true
inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView*  tableView, int32_t  idx) ;

/// @brief Method CellSize, addr 0x3a7baa8, size 0x8, virtual true, abstract: false, final true
inline float_t CellSize(int32_t  idx) ;

static inline ::GlobalNamespace::ResultsTableView* New_ctor() ;

/// @brief Method NumberOfCells, addr 0x3a7bab0, size 0xa0, virtual true, abstract: false, final true
inline int32_t NumberOfCells() ;

/// @brief Method SetData, addr 0x3a7bd20, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a7bd54, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
