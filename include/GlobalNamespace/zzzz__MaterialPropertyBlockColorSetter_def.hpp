...
/// @brief Field _useTestColor, offset 0x20, size 0x1 
 ...
 __declspec(property(get=get_materialPropertyBlockController, put=set_materialPropertyBlockController)) ::UnityW<::GlobalNamespace::MaterialPropertyBlockController>  materialPropertyBlockController;

/// @brief Method AddNecessaryComponents, addr 0x3962d98, size 0xf0, virtual false, abstract: false, final false
inline void AddNecessaryComponents() ;

/// @brief Method Awake, addr 0x3962c54, size 0x30, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method InitIfNeeded, addr 0x3962c84, size 0x30, virtual false, abstract: false, final false
inline void InitIfNeeded() ;

static inline ::GlobalNamespace::MaterialPropertyBlockColorSetter* New_ctor() ;

/// @brief Method OnValidate, addr 0x3962d1c, size 0x7c, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method SetColor, addr 0x3961270, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3962e88, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_color, addr 0x3962c18, size 0x2c, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_materialPropertyBlockController, addr 0x3962c44, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MaterialPropertyBlockController> get_materialPropertyBlockController() ;

/// @brief Method set_materialPropertyBlockController, addr 0x3962c4c, size 0x8, virtual false, abstract: false, final false
