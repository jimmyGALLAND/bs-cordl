...
/// @brief Field _OpaqueScaleAndOffset0, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get__OpaqueScaleAndOffset0, put=__cordl_internal_set__OpaqueScaleAndOffset0)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  _OpaqueScaleAndOffset0;

/// @brief Field _OpaqueScaleAndOffset1, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get__OpaqueScaleAndOffset1, put=__cordl_internal_set__OpaqueScaleAndOffset1)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  _OpaqueScaleAndOffset1;
...
/// @brief Field _TransparentScaleAndOffset0, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__TransparentScaleAndOffset0, put=__cordl_internal_set__TransparentScaleAndOffset0)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  _TransparentScaleAndOffset0;

/// @brief Field _TransparentScaleAndOffset1, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get__TransparentScaleAndOffset1, put=__cordl_internal_set__TransparentScaleAndOffset1)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  _TransparentScaleAndOffset1;
...
/// @brief Method Awake, addr 0x3fb9f2c, size 0x314, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method BuildMaterials, addr 0x3fb99f4, size 0x3b0, virtual false, abstract: false, final false
inline void BuildMaterials() ;

/// @brief Method BuildMeshes, addr 0x3fb937c, size 0x678, virtual false, abstract: false, final false
inline void BuildMeshes() ;

/// @brief Method DisableRenderers, addr 0x3fb9ef4, size 0x38, virtual false, abstract: false, final false
inline void DisableRenderers() ;

/// @brief Method EnableRenderers, addr 0x3fba82c, size 0x38, virtual false, abstract: false, final false
inline void EnableRenderers() ;

/// @brief Method GetTanFovAndOffsetForMonoEye, addr 0x3fba408, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method GetTanFovAndOffsetForStereoEye, addr 0x3fba240, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method GetTriangleCount, addr 0x3fb9358, size 0x24, virtual false, abstract: false, final false
inline int32_t GetTriangleCount() ;

static inline ::GlobalNamespace::OVRVignette* New_ctor() ;

/// @brief Method OnBeginCameraRendering, addr 0x3fba86c, size 0x8c, virtual false, abstract: false, final false
inline void OnBeginCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext  context, ::UnityEngine::Camera*  camera) ;

/// @brief Method OnDisable, addr 0x3fb9e48, size 0xac, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3fb9da4, size 0xa4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPostRender, addr 0x3fba868, size 0x4, virtual false, abstract: false, final false
inline void OnPostRender() ;

/// @brief Method OnPreCull, addr 0x3fba864, size 0x4, virtual false, abstract: false, final false
inline void OnPreCull() ;

/// @brief Method Update, addr 0x3fba4c8, size 0x364, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method VisibilityTest, addr 0x3fba494, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fba8f8, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;
