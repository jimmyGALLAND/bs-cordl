...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner::*)()>(&::GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner::Start)> {
  ...
  constexpr static std::size_t addrs = 0x3b0ac50;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner::*)()>(&::GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x3b0ad78;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner::*)(::GlobalNamespace::BasicBeatmapEventData*)>(&::GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner::HandleBeatmapEvent)> {
  ...
  constexpr static std::size_t addrs = 0x3b0ad94;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner::*)()>(&::GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner::_ctor)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x3b0ae30;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapCallbacksController*> const& GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner::__cordl_internal_get__beatmapCallbacksController() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____beatmapCallbacksController;
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapDataCallbackWrapper*> const& GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner::__cordl_internal_get__beatmapDataCallbackWrapper() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____beatmapDataCallbackWrapper;
}
