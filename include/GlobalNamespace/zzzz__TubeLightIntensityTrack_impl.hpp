...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TubeLightIntensityTrack::*)()>(&::GlobalNamespace::TubeLightIntensityTrack::_ctor)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x3aa9780;
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::TubeLightIntensityTrack*>());
}
