...
/// @brief Field <hasKickVotePermission>k__BackingField, offset 0x23, size 0x1 
 __declspec(property(get=__cordl_internal_get__hasKickVotePermission_k__BackingField, put=__cordl_internal_set__hasKickVotePermission_k__BackingField)) bool  _hasKickVotePermission_k__BackingField;

/// @brief Field <hasRecommendBeatmapPermission>k__BackingField, offset 0x21, size 0x1 
 __declspec(property(get=__cordl_internal_get__hasRecommendBeatmapPermission_k__BackingField, put=__cordl_internal_set__hasRecommendBeatmapPermission_k__BackingField)) bool  _hasRecommendBeatmapPermission_k__BackingField;

/// @brief Field <hasRecommendModifiersPermission>k__BackingField, offset 0x22, size 0x1 
 __declspec(property(get=__cordl_internal_get__hasRecommendModifiersPermission_k__BackingField, put=__cordl_internal_set__hasRecommendModifiersPermission_k__BackingField)) bool  _hasRecommendModifiersPermission_k__BackingField;
...
/// @brief Method Activate, addr 0x268d130, size 0xf4, virtual false, abstract: false, final false
inline void Activate() ;

/// @brief Method Deactivate, addr 0x268d3c4, size 0xf4, virtual false, abstract: false, final false
inline void Deactivate() ;

/// @brief Method HandleMenuRpcManagerSetPlayersPermissionConfiguration, addr 0x268da68, size 0x2ac, virtual false, abstract: false, final false
...
/// @brief Method SetPlayerPermissions, addr 0x268da24, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x268dd14, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_permissionsChangedEvent, addr 0x268d8ec, size 0x9c, virtual false, abstract: false, final false
inline void add_permissionsChangedEvent(::System::Action*  value) ;

/// @brief Method get_hasInvitePermission, addr 0x268d8d8, size 0x8, virtual false, abstract: false, final false
inline bool get_hasInvitePermission() ;

/// @brief Method get_hasKickVotePermission, addr 0x268d8c4, size 0x8, virtual false, abstract: false, final false
inline bool get_hasKickVotePermission() ;

/// @brief Method get_hasRecommendBeatmapPermission, addr 0x268d89c, size 0x8, virtual false, abstract: false, final false
inline bool get_hasRecommendBeatmapPermission() ;

/// @brief Method get_hasRecommendModifiersPermission, addr 0x268d8b0, size 0x8, virtual false, abstract: false, final false
inline bool get_hasRecommendModifiersPermission() ;

/// @brief Method get_isPartyOwner, addr 0x268d888, size 0x8, virtual false, abstract: false, final false
inline bool get_isPartyOwner() ;

/// @brief Method remove_permissionsChangedEvent, addr 0x268d988, size 0x9c, virtual false, abstract: false, final false
inline void remove_permissionsChangedEvent(::System::Action*  value) ;

/// @brief Method set_hasInvitePermission, addr 0x268d8e0, size 0xc, virtual false, abstract: false, final false
inline void set_hasInvitePermission(bool  value) ;

/// @brief Method set_hasKickVotePermission, addr 0x268d8cc, size 0xc, virtual false, abstract: false, final false
inline void set_hasKickVotePermission(bool  value) ;

/// @brief Method set_hasRecommendBeatmapPermission, addr 0x268d8a4, size 0xc, virtual false, abstract: false, final false
inline void set_hasRecommendBeatmapPermission(bool  value) ;

/// @brief Method set_hasRecommendModifiersPermission, addr 0x268d8b8, size 0xc, virtual false, abstract: false, final false
inline void set_hasRecommendModifiersPermission(bool  value) ;

/// @brief Method set_isPartyOwner, addr 0x268d890, size 0xc, virtual false, abstract: false, final false
