...
/// @brief Method SetClippingParams, addr 0x3b254e4, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b25630, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
