...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleTemporalFiltering::*)()>(&::GlobalNamespace::SimpleTemporalFiltering::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3ff45c4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::RenderTexture> (::GlobalNamespace::SimpleTemporalFiltering::*)(::UnityEngine::RenderTexture*)>(&::GlobalNamespace::SimpleTemporalFiltering::FilterTexture)> {
  constexpr static std::size_t size = 0x180;
  constexpr static std::size_t addrs = 0x3ff4688;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleTemporalFiltering::*)(int32_t, int32_t)>(&::GlobalNamespace::SimpleTemporalFiltering::CreateRenderTexturesIfNeeded)> {
  constexpr static std::size_t size = 0x28c;
  constexpr static std::size_t addrs = 0x3ff4808;
...
constexpr ::ArrayW<::UnityW<::UnityEngine::RenderTexture>,::Array<::UnityW<::UnityEngine::RenderTexture>>*>& GlobalNamespace::SimpleTemporalFiltering::__cordl_internal_get__temporalFilteringTextures()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____temporalFilteringTextures;
}
constexpr ::ArrayW<::UnityW<::UnityEngine::RenderTexture>,::Array<::UnityW<::UnityEngine::RenderTexture>>*> const& GlobalNamespace::SimpleTemporalFiltering::__cordl_internal_get__temporalFilteringTextures() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____temporalFilteringTextures;
}
constexpr void GlobalNamespace::SimpleTemporalFiltering::__cordl_internal_set__temporalFilteringTextures(::ArrayW<::UnityW<::UnityEngine::RenderTexture>,::Array<::UnityW<::UnityEngine::RenderTexture>>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
