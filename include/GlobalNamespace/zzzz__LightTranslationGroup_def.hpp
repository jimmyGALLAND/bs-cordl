...
/// @brief Method __Validate, addr 0x3afcf30, size 0x214, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3afd144, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_xDistributionLimits, addr 0x3afcf18, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_xDistributionLimits() ;

/// @brief Method get_xTranslationLimits, addr 0x3afcf00, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_xTranslationLimits() ;

/// @brief Method get_yDistributionLimits, addr 0x3afcf20, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_yDistributionLimits() ;

/// @brief Method get_yTranslationLimits, addr 0x3afcf08, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_yTranslationLimits() ;

/// @brief Method get_zDistributionLimits, addr 0x3afcf28, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_zDistributionLimits() ;

/// @brief Method get_zTranslationLimits, addr 0x3afcf10, size 0x8, virtual false, abstract: false, final false
