...
/// @brief Field <localizedDescription>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__localizedDescription_k__BackingField, put=__cordl_internal_set__localizedDescription_k__BackingField)) ::StringW  _localizedDescription_k__BackingField;
...
/// @brief Method .ctor, addr 0x3a9f9d0, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::StringW  multiplayerSecret, bool  canInvite, bool  atMaxPartySize) ;

/// @brief Method get_apiName, addr 0x3a9f940, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_apiName() ;

/// @brief Method get_atMaxPartySize, addr 0x3a9f970, size 0x8, virtual true, abstract: false, final true
inline bool get_atMaxPartySize() ;

/// @brief Method get_canInvite, addr 0x3a9f984, size 0x8, virtual true, abstract: false, final true
inline bool get_canInvite() ;

/// @brief Method get_isJoinable, addr 0x3a9f998, size 0x38, virtual true, abstract: false, final true
inline bool get_isJoinable() ;

/// @brief Method get_localizedDescription, addr 0x3a9f950, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_localizedDescription() ;

/// @brief Method get_multiplayerSecret, addr 0x3a9f960, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_apiName, addr 0x3a9f948, size 0x8, virtual false, abstract: false, final false
inline void set_apiName(::StringW  value) ;

/// @brief Method set_atMaxPartySize, addr 0x3a9f978, size 0xc, virtual true, abstract: false, final true
inline void set_atMaxPartySize(bool  value) ;

/// @brief Method set_canInvite, addr 0x3a9f98c, size 0xc, virtual true, abstract: false, final true
inline void set_canInvite(bool  value) ;

/// @brief Method set_localizedDescription, addr 0x3a9f958, size 0x8, virtual false, abstract: false, final false
inline void set_localizedDescription(::StringW  value) ;

/// @brief Method set_multiplayerSecret, addr 0x3a9f968, size 0x8, virtual true, abstract: false, final true
