...
/// @brief Method .ctor, addr 0x3a7b6c8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_conditionText, addr 0x3a7b618, size 0x24, virtual false, abstract: false, final false
inline void set_conditionText(::StringW  value) ;

/// @brief Method set_hideConditionText, addr 0x3a7b63c, size 0x34, virtual false, abstract: false, final false
inline void set_hideConditionText(bool  value) ;

/// @brief Method set_hideValueText, addr 0x3a7b694, size 0x34, virtual false, abstract: false, final false
inline void set_hideValueText(bool  value) ;

/// @brief Method set_icon, addr 0x3a7b5bc, size 0x1c, virtual false, abstract: false, final false
inline void set_icon(::UnityEngine::Sprite*  value) ;

/// @brief Method set_iconColor, addr 0x3a7b598, size 0x24, virtual false, abstract: false, final false
inline void set_iconColor(::UnityEngine::Color  value) ;

/// @brief Method set_iconGlow, addr 0x3a7b5d8, size 0x1c, virtual false, abstract: false, final false
inline void set_iconGlow(::UnityEngine::Sprite*  value) ;

/// @brief Method set_title, addr 0x3a7b5f4, size 0x24, virtual false, abstract: false, final false
inline void set_title(::StringW  value) ;

/// @brief Method set_valueText, addr 0x3a7b670, size 0x24, virtual false, abstract: false, final false
