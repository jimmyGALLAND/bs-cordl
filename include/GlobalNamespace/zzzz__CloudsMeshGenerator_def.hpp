...
constexpr __CloudsMeshGenerator__Cloud(::UnityW<::UnityEngine::Mesh>  precisionOpaqueMesh, ::UnityW<::UnityEngine::Mesh>  lowPolyMesh, float_t  sizeModifier, float_t  bottomThreshold, int32_t  weight, int32_t  precisionVertexCount, int32_t  lowPolyVertexCount, int32_t  generatedCount) noexcept;
...
/// @brief Field _clouds, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get__clouds, put=__cordl_internal_set__clouds)) ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__Cloud,::Array<::GlobalNamespace::__CloudsMeshGenerator__Cloud>*>  _clouds;
...
/// @brief Field _prohibitedRadii, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__prohibitedRadii, put=__cordl_internal_set__prohibitedRadii)) ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius,::Array<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius>*>  _prohibitedRadii;

/// @brief Field _radiusChunks, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get__radiusChunks, put=__cordl_internal_set__radiusChunks)) ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__RadiusChunk,::Array<::GlobalNamespace::__CloudsMeshGenerator__RadiusChunk>*>  _radiusChunks;
...
/// @brief Field _rings, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get__rings, put=__cordl_internal_set__rings)) ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__Ring,::Array<::GlobalNamespace::__CloudsMeshGenerator__Ring>*>  _rings;
...
/// @brief Field _sortedProhibitedRadii, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get__sortedProhibitedRadii, put=__cordl_internal_set__sortedProhibitedRadii)) ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius,::Array<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius>*>  _sortedProhibitedRadii;
...
constexpr ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius,::Array<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius>*> const& __cordl_internal_get__prohibitedRadii() const;
...
constexpr ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius,::Array<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius>*> const& __cordl_internal_get__sortedProhibitedRadii() const;
...
constexpr void __cordl_internal_set__prohibitedRadii(::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius,::Array<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius>*>  value) ;
...
constexpr void __cordl_internal_set__sortedProhibitedRadii(::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius,::Array<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius>*>  value) ;

constexpr void __cordl_internal_set__vertexCount(int32_t  value) ;

/// @brief Method .ctor, addr 0x2222f4c, size 0xb8, virtual false, abstract: false, final false
inline void _ctor() ;
