...
public:
// Declarations
/// @brief Method FileExists, addr 0x225a70c, size 0xc, virtual false, abstract: false, final false
inline bool FileExists(::StringW  filePath) ;

/// @brief Method Initialize, addr 0x225a688, size 0x4, virtual false, abstract: false, final false
static inline void Initialize() ;

/// @brief Method LoadFile, addr 0x225a68c, size 0x80, virtual false, abstract: false, final false
inline bool LoadFile(::StringW  filePath, ByRef<::StringW>  value) ;

static inline ::GlobalNamespace::PlayerPrefsStorage* New_ctor() ;

/// @brief Method .ctor, addr 0x225a718, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
