...
/// @brief Method Disable, addr 0x3a9b7a4, size 0x164, virtual false, abstract: false, final false
inline void Disable() ;

/// @brief Method Enable, addr 0x3a9b5f8, size 0x1ac, virtual false, abstract: false, final false
inline void Enable() ;

/// @brief Method Initialize, addr 0x3a9b088, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x3a9babc, size 0x4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3a9bab8, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Refresh, addr 0x3a9b908, size 0x1ac, virtual false, abstract: false, final false
inline void Refresh() ;

/// @brief Method Update, addr 0x3a9bab4, size 0x4, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3a9bac0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

static inline bool getStaticF__IsActive_k__BackingField() ;

/// @brief Method get_IsActive, addr 0x3a9aff0, size 0x48, virtual false, abstract: false, final false
static inline bool get_IsActive() ;

static inline void setStaticF__IsActive_k__BackingField(bool  value) ;

/// @brief Method set_IsActive, addr 0x3a9b038, size 0x50, virtual false, abstract: false, final false
