...
/// @brief Method .ctor, addr 0x3b1366c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x3b13570, size 0x80, virtual false, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::RecordingUIController* New_ctor() ;

/// @brief Method Update, addr 0x3b135f0, size 0x6c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b1365c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
