...
/// @brief Method Equals, addr 0x26cf6c4, size 0x10c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x26cf654, size 0x70, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::BeatmapKeyNetSerializable*  other) ;

/// @brief Method GetHashCode, addr 0x26cf7d0, size 0x64, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method LiteNetLib.Utils.INetSerializable.Deserialize, addr 0x26cf5a0, size 0x50, virtual true, abstract: false, final true
inline void LiteNetLib_Utils_INetSerializable_Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method LiteNetLib.Utils.INetSerializable.Serialize, addr 0x26cf600, size 0x4c, virtual true, abstract: false, final true
...
/// @brief Method ToString, addr 0x26cf834, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26cf55c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x26cf564, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_beatmapCharacteristicSerializedName, addr 0x26cf53c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_beatmapCharacteristicSerializedName() ;

/// @brief Method get_difficulty, addr 0x26cf54c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapDifficulty get_difficulty() ;

/// @brief Method get_levelID, addr 0x26cf52c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_beatmapCharacteristicSerializedName, addr 0x26cf544, size 0x8, virtual false, abstract: false, final false
inline void set_beatmapCharacteristicSerializedName(::StringW  value) ;

/// @brief Method set_difficulty, addr 0x26cf554, size 0x8, virtual false, abstract: false, final false
inline void set_difficulty(::GlobalNamespace::BeatmapDifficulty  value) ;

/// @brief Method set_levelID, addr 0x26cf534, size 0x8, virtual false, abstract: false, final false
