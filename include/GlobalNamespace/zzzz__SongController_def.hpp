...
/// @brief Method SendSongDidFinishEvent, addr 0x3b5985c, size 0x1c, virtual false, abstract: false, final false
inline void SendSongDidFinishEvent() ;

/// @brief Method SendSongDidStartEvent, addr 0x3b598bc, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b59a90, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_songDidFinishEvent, addr 0x3b59c00, size 0x9c, virtual false, abstract: false, final false
inline void add_songDidFinishEvent(::System::Action*  value) ;

/// @brief Method add_songDidStartEvent, addr 0x3b59ac8, size 0x9c, virtual false, abstract: false, final false
inline void add_songDidStartEvent(::System::Action*  value) ;

/// @brief Method remove_songDidFinishEvent, addr 0x3b59c9c, size 0x9c, virtual false, abstract: false, final false
inline void remove_songDidFinishEvent(::System::Action*  value) ;

/// @brief Method remove_songDidStartEvent, addr 0x3b59b64, size 0x9c, virtual false, abstract: false, final false
