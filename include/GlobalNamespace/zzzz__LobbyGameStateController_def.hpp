...
static __declspec(property(get=getStaticF___9__99_0, put=setStaticF___9__99_0)) ::System::Func_2<::System::Collections::Generic::KeyValuePair_2<::StringW,::GlobalNamespace::ILobbyPlayerData*>,bool>*  __9__99_0;

static inline ::GlobalNamespace::__LobbyGameStateController____c* New_ctor() ;

/// @brief Method <PredictCountdownEndTime>b__99_0, addr 0x3b2a65c, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b2a654, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetGameStateAndConfigurationAsync>b__2, addr 0x3b2abb0, size 0xc8, virtual false, abstract: false, final false
inline bool _GetGameStateAndConfigurationAsync_b__2(::GlobalNamespace::PlayerLobbyPermissionConfigurationNetSerializable*  p) ;

/// @brief Method <GetGameStateAndConfigurationAsync>g__HandleSetMultiplayerGameState|0, addr 0x3b2a774, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method <GetGameStateAndConfigurationAsync>g__HandleSetPlayerPermissionConfiguration|1, addr 0x3b2a9d4, size 0x1dc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b28d98, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Activate, addr 0x3b270b8, size 0x874, virtual true, abstract: false, final true
inline void Activate() ;

/// @brief Method ClearDisconnectedState, addr 0x3b2822c, size 0x10, virtual true, abstract: false, final true
inline void ClearDisconnectedState() ;

/// @brief Method Deactivate, addr 0x3b2792c, size 0x900, virtual true, abstract: false, final true
inline void Deactivate() ;

/// @brief Method Dispose, addr 0x3b2823c, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetCurrentLevelIfGameStarted, addr 0x3b288e4, size 0xa4, virtual true, abstract: false, final true
inline void GetCurrentLevelIfGameStarted() ;

/// @brief Method GetGameStateAndConfigurationAsync, addr 0x3b28988, size 0x410, virtual true, abstract: false, final true
...
/// @brief Method HandleMenuRpcManagerCancelCountdown, addr 0x3b299b8, size 0x22c, virtual false, abstract: false, final false
inline void HandleMenuRpcManagerCancelCountdown(::StringW  userId) ;

/// @brief Method HandleMenuRpcManagerCancelledLevelStart, addr 0x3b29610, size 0x88, virtual false, abstract: false, final false
inline void HandleMenuRpcManagerCancelledLevelStart(::StringW  userId) ;

/// @brief Method HandleMenuRpcManagerClearSelectedBeatmap, addr 0x3b29d80, size 0x54, virtual false, abstract: false, final false
inline void HandleMenuRpcManagerClearSelectedBeatmap(::StringW  userId) ;

/// @brief Method HandleMenuRpcManagerClearSelectedGameplayModifiers, addr 0x3b29dd4, size 0x48, virtual false, abstract: false, final false
inline void HandleMenuRpcManagerClearSelectedGameplayModifiers(::StringW  userId) ;

/// @brief Method HandleMenuRpcManagerSetCountdownEndTime, addr 0x3b29794, size 0x224, virtual false, abstract: false, final false
inline void HandleMenuRpcManagerSetCountdownEndTime(::StringW  userId, int64_t  countdownTime) ;

/// @brief Method HandleMenuRpcManagerSetPlayersMissingEntitlementsToLevel, addr 0x3b29c54, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method HandleMenuRpcManagerSetSelectedBeatmap, addr 0x3b29cb4, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method HandleMenuRpcManagerSetSelectedGameplayModifiers, addr 0x3b29d38, size 0x48, virtual false, abstract: false, final false
inline void HandleMenuRpcManagerSetSelectedGameplayModifiers(::StringW  userId, ::GlobalNamespace::GameplayModifiers*  modifiers) ;

/// @brief Method HandleMenuRpcManagerSetStartGameTime, addr 0x3b29be4, size 0x48, virtual false, abstract: false, final false
inline void HandleMenuRpcManagerSetStartGameTime(::StringW  userId, int64_t  startTime) ;

/// @brief Method HandleMenuRpcManagerStartedLevel, addr 0x3b2938c, size 0x284, virtual false, abstract: false, final false
...
/// @brief Method HandleMultiplayerLevelDidDisconnect, addr 0x3b2a4fc, size 0x8c, virtual false, abstract: false, final false
inline void HandleMultiplayerLevelDidDisconnect(::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method HandleMultiplayerLevelDidFinish, addr 0x3b2a468, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method HandleMultiplayerLevelLoaderCountdownFinished, addr 0x3b29e1c, size 0x33c, virtual false, abstract: false, final false
...
/// @brief Method HandleMultiplayerLevelLoaderStillDownloadingSong, addr 0x3b29c98, size 0x1c, virtual false, abstract: false, final false
inline void HandleMultiplayerLevelLoaderStillDownloadingSong() ;

/// @brief Method HandleMultiplayerSessionManagerConnectionOwnerStateChanged, addr 0x3b2902c, size 0xf8, virtual false, abstract: false, final false
inline void HandleMultiplayerSessionManagerConnectionOwnerStateChanged(::GlobalNamespace::IConnectedPlayer*  connectedPlayer) ;

/// @brief Method HandleMultiplayerSessionManagerDisconnected, addr 0x3b29004, size 0x28, virtual false, abstract: false, final false
inline void HandleMultiplayerSessionManagerDisconnected(::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method HandleSetIsStartButtonEnabled, addr 0x3b29c2c, size 0x28, virtual false, abstract: false, final false
inline void HandleSetIsStartButtonEnabled(::StringW  userId, ::GlobalNamespace::CannotStartGameReason  cannotStartGameReason) ;

/// @brief Method HandleStartTimeChanged, addr 0x3b29c78, size 0x20, virtual false, abstract: false, final false
inline void HandleStartTimeChanged() ;

/// @brief Method IsCloseToStartGame, addr 0x3b28f3c, size 0xc8, virtual true, abstract: false, final true
inline bool IsCloseToStartGame() ;

static inline ::GlobalNamespace::LobbyGameStateController* New_ctor() ;

/// @brief Method PredictCountdownEndTime, addr 0x3b28da0, size 0x19c, virtual true, abstract: false, final true
inline void PredictCountdownEndTime() ;

/// @brief Method StartListeningToGameStart, addr 0x3b28240, size 0x6a4, virtual true, abstract: false, final true
inline void StartListeningToGameStart() ;

/// @brief Method StartMultiplayerLevel, addr 0x3b2a158, size 0x310, virtual false, abstract: false, final false
...
/// @brief Method StopListeningToGameStart, addr 0x3b29124, size 0x268, virtual false, abstract: false, final false
inline void StopListeningToGameStart() ;

/// @brief Method StopLoading, addr 0x3b29698, size 0xfc, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MultiplayerResultsData*>*> const& __cordl_internal_get_levelFinishedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::PlayersMissingEntitlementsNetSerializable*>*> const& __cordl_internal_get_playerMissingEntitlementsChangedEvent() const;
...
/// @brief Method .ctor, addr 0x3b2a588, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_beforeSceneSwitchCallbackEvent, addr 0x3b26a90, size 0x9c, virtual true, abstract: false, final true
inline void add_beforeSceneSwitchCallbackEvent(::System::Action*  value) ;

/// @brief Method add_countdownCancelledEvent, addr 0x3b262f0, size 0x9c, virtual true, abstract: false, final true
inline void add_countdownCancelledEvent(::System::Action*  value) ;

/// @brief Method add_countdownStartedEvent, addr 0x3b261b8, size 0x9c, virtual true, abstract: false, final true
inline void add_countdownStartedEvent(::System::Action*  value) ;

/// @brief Method add_gameStartCancelledEvent, addr 0x3b26080, size 0x9c, virtual true, abstract: false, final true
inline void add_gameStartCancelledEvent(::System::Action*  value) ;

/// @brief Method add_gameStartedEvent, addr 0x3b25f20, size 0xb0, virtual true, abstract: false, final true
inline void add_gameStartedEvent(::System::Action_1<::GlobalNamespace::ILevelGameplaySetupData*>*  value) ;

/// @brief Method add_levelDidGetDisconnectedEvent, addr 0x3b267f8, size 0xb0, virtual true, abstract: false, final true
inline void add_levelDidGetDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>*  value) ;

/// @brief Method add_levelFinishedEvent, addr 0x3b26698, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method add_lobbyDisconnectedEvent, addr 0x3b26958, size 0x9c, virtual true, abstract: false, final true
inline void add_lobbyDisconnectedEvent(::System::Action*  value) ;

/// @brief Method add_lobbyStateChangedEvent, addr 0x3b26bc8, size 0xb0, virtual true, abstract: false, final true
inline void add_lobbyStateChangedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLobbyState>*  value) ;

/// @brief Method add_playerMissingEntitlementsChangedEvent, addr 0x3b26e88, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method add_selectedLevelGameplaySetupDataChangedEvent, addr 0x3b25dc0, size 0xb0, virtual true, abstract: false, final true
inline void add_selectedLevelGameplaySetupDataChangedEvent(::System::Action_1<::GlobalNamespace::ILevelGameplaySetupData*>*  value) ;

/// @brief Method add_songStillDownloadingEvent, addr 0x3b26428, size 0x9c, virtual true, abstract: false, final true
inline void add_songStillDownloadingEvent(::System::Action*  value) ;

/// @brief Method add_startButtonEnabledEvent, addr 0x3b26d28, size 0xb0, virtual true, abstract: false, final true
inline void add_startButtonEnabledEvent(::System::Action_1<::GlobalNamespace::CannotStartGameReason>*  value) ;

/// @brief Method add_startTimeChangedEvent, addr 0x3b26560, size 0x9c, virtual true, abstract: false, final true
inline void add_startTimeChangedEvent(::System::Action*  value) ;

/// @brief Method get_cannotStartGameReason, addr 0x3b2708c, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::CannotStartGameReason get_cannotStartGameReason() ;

/// @brief Method get_countdownEndTime, addr 0x3b27048, size 0x8, virtual true, abstract: false, final true
inline int64_t get_countdownEndTime() ;

/// @brief Method get_countdownStarted, addr 0x3b27034, size 0x8, virtual true, abstract: false, final true
inline bool get_countdownStarted() ;

/// @brief Method get_disconnectedReason, addr 0x3b270a8, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::DisconnectedReason get_disconnectedReason() ;

/// @brief Method get_isDisconnected, addr 0x3b27094, size 0x8, virtual true, abstract: false, final true
inline bool get_isDisconnected() ;

/// @brief Method get_levelStartInitiated, addr 0x3b27018, size 0x8, virtual true, abstract: false, final true
inline bool get_levelStartInitiated() ;

/// @brief Method get_predictedCountdownEndTime, addr 0x3b26fe8, size 0x8, virtual true, abstract: false, final true
inline int64_t get_predictedCountdownEndTime() ;

/// @brief Method get_selectedLevelGameplaySetupData, addr 0x3b2702c, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::ILevelGameplaySetupData* get_selectedLevelGameplaySetupData() ;

/// @brief Method get_startTime, addr 0x3b26ff0, size 0x8, virtual true, abstract: false, final true
inline int64_t get_startTime() ;

/// @brief Method get_state, addr 0x3b27058, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method remove_beforeSceneSwitchCallbackEvent, addr 0x3b26b2c, size 0x9c, virtual true, abstract: false, final true
inline void remove_beforeSceneSwitchCallbackEvent(::System::Action*  value) ;

/// @brief Method remove_countdownCancelledEvent, addr 0x3b2638c, size 0x9c, virtual true, abstract: false, final true
inline void remove_countdownCancelledEvent(::System::Action*  value) ;

/// @brief Method remove_countdownStartedEvent, addr 0x3b26254, size 0x9c, virtual true, abstract: false, final true
inline void remove_countdownStartedEvent(::System::Action*  value) ;

/// @brief Method remove_gameStartCancelledEvent, addr 0x3b2611c, size 0x9c, virtual true, abstract: false, final true
inline void remove_gameStartCancelledEvent(::System::Action*  value) ;

/// @brief Method remove_gameStartedEvent, addr 0x3b25fd0, size 0xb0, virtual true, abstract: false, final true
inline void remove_gameStartedEvent(::System::Action_1<::GlobalNamespace::ILevelGameplaySetupData*>*  value) ;

/// @brief Method remove_levelDidGetDisconnectedEvent, addr 0x3b268a8, size 0xb0, virtual true, abstract: false, final true
inline void remove_levelDidGetDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>*  value) ;

/// @brief Method remove_levelFinishedEvent, addr 0x3b26748, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method remove_lobbyDisconnectedEvent, addr 0x3b269f4, size 0x9c, virtual true, abstract: false, final true
inline void remove_lobbyDisconnectedEvent(::System::Action*  value) ;

/// @brief Method remove_lobbyStateChangedEvent, addr 0x3b26c78, size 0xb0, virtual true, abstract: false, final true
inline void remove_lobbyStateChangedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLobbyState>*  value) ;

/// @brief Method remove_playerMissingEntitlementsChangedEvent, addr 0x3b26f38, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method remove_selectedLevelGameplaySetupDataChangedEvent, addr 0x3b25e70, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method remove_songStillDownloadingEvent, addr 0x3b264c4, size 0x9c, virtual true, abstract: false, final true
inline void remove_songStillDownloadingEvent(::System::Action*  value) ;

/// @brief Method remove_startButtonEnabledEvent, addr 0x3b26dd8, size 0xb0, virtual true, abstract: false, final true
inline void remove_startButtonEnabledEvent(::System::Action_1<::GlobalNamespace::CannotStartGameReason>*  value) ;

/// @brief Method remove_startTimeChangedEvent, addr 0x3b265fc, size 0x9c, virtual true, abstract: false, final true
inline void remove_startTimeChangedEvent(::System::Action*  value) ;

/// @brief Method set_countdownEndTime, addr 0x3b27050, size 0x8, virtual false, abstract: false, final false
inline void set_countdownEndTime(int64_t  value) ;

/// @brief Method set_countdownStarted, addr 0x3b2703c, size 0xc, virtual false, abstract: false, final false
inline void set_countdownStarted(bool  value) ;

/// @brief Method set_disconnectedReason, addr 0x3b270b0, size 0x8, virtual false, abstract: false, final false
inline void set_disconnectedReason(::GlobalNamespace::DisconnectedReason  value) ;

/// @brief Method set_isDisconnected, addr 0x3b2709c, size 0xc, virtual false, abstract: false, final false
inline void set_isDisconnected(bool  value) ;

/// @brief Method set_levelStartInitiated, addr 0x3b27020, size 0xc, virtual false, abstract: false, final false
inline void set_levelStartInitiated(bool  value) ;

/// @brief Method set_startTime, addr 0x3b26ff8, size 0x20, virtual false, abstract: false, final false
inline void set_startTime(int64_t  value) ;

/// @brief Method set_state, addr 0x3b27060, size 0x2c, virtual true, abstract: false, final true
