...
/// @brief Method .ctor, addr 0x26882a0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field localizedNames, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_localizedNames, put=__cordl_internal_set_localizedNames)) ::ArrayW<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__LocalizedCustomPackName*,::Array<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__LocalizedCustomPackName*>*>  localizedNames;
...
constexpr ::ArrayW<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__LocalizedCustomPackName*,::Array<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__LocalizedCustomPackName*>*> const& __cordl_internal_get_localizedNames() const;

constexpr ::ArrayW<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__LocalizedCustomPackName*,::Array<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__LocalizedCustomPackName*>*>& __cordl_internal_get_localizedNames() ;
...
constexpr void __cordl_internal_set_localizedNames(::ArrayW<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__LocalizedCustomPackName*,::Array<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__LocalizedCustomPackName*>*>  value) ;
...
/// @brief Method .ctor, addr 0x26882a8, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field localizedNames, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__LocalizedCustomPackName*,::Array<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__LocalizedCustomPackName*>*>  ___localizedNames;
...
/// @brief Method .ctor, addr 0x2688328, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field localizedCustomPacks, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_localizedCustomPacks, put=__cordl_internal_set_localizedCustomPacks)) ::System::Collections::Generic::List_1<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__LocalizedCustomPack*>*  localizedCustomPacks;

/// @brief Field predefinedPackIds, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_predefinedPackIds, put=__cordl_internal_set_predefinedPackIds)) ::System::Collections::Generic::List_1<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__PredefinedPack*>*  predefinedPackIds;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__LocalizedCustomPack*>*> const& __cordl_internal_get_localizedCustomPacks() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride__PredefinedPack*>*> const& __cordl_internal_get_predefinedPackIds() const;
...
/// @brief Method .ctor, addr 0x26881dc, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field quickPlayAvailablePacksOverride, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_quickPlayAvailablePacksOverride, put=__cordl_internal_set_quickPlayAvailablePacksOverride)) ::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride*  quickPlayAvailablePacksOverride;
...
/// @brief Method .ctor, addr 0x26881d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_hasOverride, addr 0x268814c, size 0x88, virtual false, abstract: false, final false
