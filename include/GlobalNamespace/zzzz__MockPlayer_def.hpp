...
/// @brief Field <configuration>k__BackingField, offset 0x60, size 0x18 
 __declspec(property(get=__cordl_internal_get__configuration_k__BackingField, put=__cordl_internal_set__configuration_k__BackingField)) ::GlobalNamespace::GameplayServerConfiguration  _configuration_k__BackingField;
...
/// @brief Field <selectionMask>k__BackingField, offset 0x38, size 0x28 
 __declspec(property(get=__cordl_internal_get__selectionMask_k__BackingField, put=__cordl_internal_set__selectionMask_k__BackingField)) ::GlobalNamespace::BeatmapLevelSelectionMask  _selectionMask_k__BackingField;
...
/// @brief Method Block, addr 0x3b34110, size 0x38, virtual true, abstract: false, final true
inline void Block() ;

/// @brief Method Connect, addr 0x3b32650, size 0x11cc, virtual true, abstract: false, final false
inline void Connect(::GlobalNamespace::IMultiplayerSessionManager*  multiplayerSessionManager, ::GlobalNamespace::BeatmapLevelsModel*  beatmapLevelsModel, ::GlobalNamespace::BeatmapDataLoader*  beatmapDataLoader, ::GlobalNamespace::EnvironmentsListModel*  environmentsListModel, ::GlobalNamespace::BeatmapCharacteristicCollection*  beatmapCharacteristicCollection, ::GlobalNamespace::NodePoseSyncStateManager*  nodePoseSyncStateManager) ;

/// @brief Method Disconnect, addr 0x3b34040, size 0x28, virtual true, abstract: false, final false
inline void Disconnect() ;

/// @brief Method HasState, addr 0x3b32080, size 0x58, virtual true, abstract: false, final true
inline bool HasState(::StringW  state) ;

/// @brief Method Invite, addr 0x3b34184, size 0x38, virtual true, abstract: false, final true
inline void Invite() ;

/// @brief Method Join, addr 0x3b341f4, size 0x38, virtual true, abstract: false, final false
inline void Join() ;

/// @brief Method Join, addr 0x3b341bc, size 0x38, virtual true, abstract: false, final false
inline void Join(::StringW  password) ;

/// @brief Method Kick, addr 0x3b3414c, size 0x38, virtual true, abstract: false, final true
inline void Kick() ;

/// @brief Method Leave, addr 0x3b34148, size 0x4, virtual true, abstract: false, final true
inline void Leave() ;

static inline ::GlobalNamespace::MockPlayer* New_ctor(::GlobalNamespace::MockPlayerSettings*  settings, bool  isLocalPlayer) ;

/// @brief Method RecommendBeatmapLevel, addr 0x3b3434c, size 0x1c, virtual false, abstract: false, final false
inline void RecommendBeatmapLevel(::GlobalNamespace::BeatmapDifficulty  beatmapDifficulty, ::StringW  beatmapLevelId) ;

/// @brief Method SendInviteResponse, addr 0x3b340d8, size 0x38, virtual true, abstract: false, final true
inline void SendInviteResponse(bool  accept) ;

/// @brief Method SendJoinResponse, addr 0x3b340a0, size 0x38, virtual true, abstract: false, final true
inline void SendJoinResponse(bool  accept) ;

/// @brief Method SetState, addr 0x3b32130, size 0x94, virtual false, abstract: false, final false
inline bool SetState(::StringW  state, bool  value) ;

/// @brief Method SimulateFail, addr 0x3b3422c, size 0x40, virtual false, abstract: false, final false
inline void SimulateFail() ;

/// @brief Method SimulateGiveUp, addr 0x3b3426c, size 0x3c, virtual false, abstract: false, final false
inline void SimulateGiveUp() ;

/// @brief Method SimulateReturnToMainMenu, addr 0x3b342a8, size 0xa4, virtual false, abstract: false, final false
inline void SimulateReturnToMainMenu() ;

/// @brief Method Tick, addr 0x3b3263c, size 0x14, virtual false, abstract: false, final false
inline void Tick() ;

/// @brief Method Unblock, addr 0x3b34068, size 0x38, virtual true, abstract: false, final true
inline void Unblock() ;
...
/// @brief Method .ctor, addr 0x3b32584, size 0xb8, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::MockPlayerSettings*  settings, bool  isLocalPlayer) ;

/// @brief Method get_autoConnect, addr 0x3b31dd0, size 0x1c, virtual false, abstract: false, final false
inline bool get_autoConnect() ;

/// @brief Method get_canBlock, addr 0x3b32010, size 0x8, virtual true, abstract: false, final true
inline bool get_canBlock() ;

/// @brief Method get_canInvite, addr 0x3b31fc0, size 0x8, virtual true, abstract: false, final true
inline bool get_canInvite() ;

/// @brief Method get_canJoin, addr 0x3b31f90, size 0x8, virtual true, abstract: false, final false
inline bool get_canJoin() ;

/// @brief Method get_canKick, addr 0x3b31fe8, size 0x8, virtual true, abstract: false, final true
inline bool get_canKick() ;

/// @brief Method get_canLeave, addr 0x3b31ffc, size 0x8, virtual true, abstract: false, final true
inline bool get_canLeave() ;

/// @brief Method get_canUnblock, addr 0x3b32024, size 0x8, virtual true, abstract: false, final true
inline bool get_canUnblock() ;

/// @brief Method get_configuration, addr 0x3b31f50, size 0x14, virtual true, abstract: false, final true
inline ::GlobalNamespace::GameplayServerConfiguration get_configuration() ;

/// @brief Method get_connectedPlayer, addr 0x3b31f8c, size 0x4, virtual true, abstract: false, final true
inline ::GlobalNamespace::IConnectedPlayer* get_connectedPlayer() ;

/// @brief Method get_currentLatency, addr 0x3b31ec8, size 0x2c, virtual true, abstract: false, final true
inline int64_t get_currentLatency() ;

/// @brief Method get_currentPartySize, addr 0x3b31f10, size 0x8, virtual true, abstract: false, final true
inline int32_t get_currentPartySize() ;

/// @brief Method get_disconnectedReason, addr 0x3b31e58, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::DisconnectedReason get_disconnectedReason() ;

/// @brief Method get_finishedLevel, addr 0x3b32444, size 0x48, virtual false, abstract: false, final false
inline bool get_finishedLevel() ;

/// @brief Method get_hasValidLatency, addr 0x3b31ef4, size 0x8, virtual true, abstract: false, final true
inline bool get_hasValidLatency() ;

/// @brief Method get_inactiveByDefault, addr 0x3b31dec, size 0x1c, virtual false, abstract: false, final false
inline bool get_inactiveByDefault() ;

/// @brief Method get_isActive, addr 0x3b323a4, size 0x48, virtual false, abstract: false, final false
inline bool get_isActive() ;

/// @brief Method get_isConnected, addr 0x3b31e08, size 0x8, virtual true, abstract: false, final true
inline bool get_isConnected() ;

/// @brief Method get_isConnectionOwner, addr 0x3b31e44, size 0x8, virtual true, abstract: false, final true
inline bool get_isConnectionOwner() ;

/// @brief Method get_isDedicatedServer, addr 0x3b321c4, size 0x48, virtual false, abstract: false, final false
inline bool get_isDedicatedServer() ;

/// @brief Method get_isKicked, addr 0x3b31efc, size 0x8, virtual true, abstract: false, final true
inline bool get_isKicked() ;

/// @brief Method get_isMe, addr 0x3b31d74, size 0x8, virtual true, abstract: false, final true
inline bool get_isMe() ;

/// @brief Method get_isMyPartyOwner, addr 0x3b31f78, size 0x8, virtual true, abstract: false, final true
inline bool get_isMyPartyOwner() ;

/// @brief Method get_isPlayer, addr 0x3b32038, size 0x48, virtual false, abstract: false, final false
inline bool get_isPlayer() ;

/// @brief Method get_isReady, addr 0x3b31d34, size 0x8, virtual false, abstract: false, final false
inline bool get_isReady() ;

/// @brief Method get_isTerminating, addr 0x3b324e4, size 0x48, virtual false, abstract: false, final false
inline bool get_isTerminating() ;

/// @brief Method get_isWaitingOnInvite, addr 0x3b31fd4, size 0x8, virtual true, abstract: false, final true
inline bool get_isWaitingOnInvite() ;

/// @brief Method get_isWaitingOnJoin, addr 0x3b31fac, size 0x8, virtual true, abstract: false, final true
inline bool get_isWaitingOnJoin() ;

/// @brief Method get_multiplayerAvatarsData, addr 0x3b31e1c, size 0x14, virtual true, abstract: false, final true
inline ::GlobalNamespace::MultiplayerAvatarsData get_multiplayerAvatarsData() ;

/// @brief Method get_offsetSyncTime, addr 0x3b31e60, size 0x68, virtual true, abstract: false, final true
inline int64_t get_offsetSyncTime() ;

/// @brief Method get_requiresPassword, addr 0x3b31f98, size 0x8, virtual true, abstract: false, final true
inline bool get_requiresPassword() ;

/// @brief Method get_selectionMask, addr 0x3b31f20, size 0x18, virtual true, abstract: false, final true
inline ::GlobalNamespace::BeatmapLevelSelectionMask get_selectionMask() ;

/// @brief Method get_sortIndex, addr 0x3b31db4, size 0x1c, virtual true, abstract: false, final true
inline int32_t get_sortIndex() ;

/// @brief Method get_userId, addr 0x3b31d7c, size 0x1c, virtual true, abstract: false, final true
inline ::StringW get_userId() ;

/// @brief Method get_userName, addr 0x3b31d98, size 0x1c, virtual true, abstract: false, final true
inline ::StringW get_userName() ;

/// @brief Method get_wantsToPlayNextLevel, addr 0x3b32264, size 0x48, virtual false, abstract: false, final false
inline bool get_wantsToPlayNextLevel() ;

/// @brief Method get_wasActiveAtLevelStart, addr 0x3b32304, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method set_canBlock, addr 0x3b32018, size 0xc, virtual false, abstract: false, final false
inline void set_canBlock(bool  value) ;

/// @brief Method set_canInvite, addr 0x3b31fc8, size 0xc, virtual false, abstract: false, final false
inline void set_canInvite(bool  value) ;

/// @brief Method set_canKick, addr 0x3b31ff0, size 0xc, virtual false, abstract: false, final false
inline void set_canKick(bool  value) ;

/// @brief Method set_canLeave, addr 0x3b32004, size 0xc, virtual false, abstract: false, final false
inline void set_canLeave(bool  value) ;

/// @brief Method set_canUnblock, addr 0x3b3202c, size 0xc, virtual false, abstract: false, final false
inline void set_canUnblock(bool  value) ;

/// @brief Method set_configuration, addr 0x3b31f64, size 0x14, virtual false, abstract: false, final false
inline void set_configuration(::GlobalNamespace::GameplayServerConfiguration  value) ;

/// @brief Method set_currentPartySize, addr 0x3b31f18, size 0x8, virtual false, abstract: false, final false
inline void set_currentPartySize(int32_t  value) ;

/// @brief Method set_finishedLevel, addr 0x3b3248c, size 0x58, virtual false, abstract: false, final false
inline void set_finishedLevel(bool  value) ;

/// @brief Method set_isActive, addr 0x3b323ec, size 0x58, virtual false, abstract: false, final false
inline void set_isActive(bool  value) ;

/// @brief Method set_isConnected, addr 0x3b31e10, size 0xc, virtual false, abstract: false, final false
inline void set_isConnected(bool  value) ;

/// @brief Method set_isConnectionOwner, addr 0x3b31e4c, size 0xc, virtual false, abstract: false, final false
inline void set_isConnectionOwner(bool  value) ;

/// @brief Method set_isDedicatedServer, addr 0x3b3220c, size 0x58, virtual false, abstract: false, final false
inline void set_isDedicatedServer(bool  value) ;

/// @brief Method set_isKicked, addr 0x3b31f04, size 0xc, virtual false, abstract: false, final false
inline void set_isKicked(bool  value) ;

/// @brief Method set_isMyPartyOwner, addr 0x3b31f80, size 0xc, virtual false, abstract: false, final false
inline void set_isMyPartyOwner(bool  value) ;

/// @brief Method set_isPlayer, addr 0x3b320d8, size 0x58, virtual false, abstract: false, final false
inline void set_isPlayer(bool  value) ;

/// @brief Method set_isReady, addr 0x3b31d3c, size 0x38, virtual false, abstract: false, final false
inline void set_isReady(bool  value) ;

/// @brief Method set_isTerminating, addr 0x3b3252c, size 0x58, virtual false, abstract: false, final false
inline void set_isTerminating(bool  value) ;

/// @brief Method set_isWaitingOnInvite, addr 0x3b31fdc, size 0xc, virtual false, abstract: false, final false
inline void set_isWaitingOnInvite(bool  value) ;

/// @brief Method set_isWaitingOnJoin, addr 0x3b31fb4, size 0xc, virtual false, abstract: false, final false
inline void set_isWaitingOnJoin(bool  value) ;

/// @brief Method set_multiplayerAvatarsData, addr 0x3b31e30, size 0x14, virtual false, abstract: false, final false
inline void set_multiplayerAvatarsData(::GlobalNamespace::MultiplayerAvatarsData  value) ;

/// @brief Method set_requiresPassword, addr 0x3b31fa0, size 0xc, virtual false, abstract: false, final false
inline void set_requiresPassword(bool  value) ;

/// @brief Method set_selectionMask, addr 0x3b31f38, size 0x18, virtual false, abstract: false, final false
inline void set_selectionMask(::GlobalNamespace::BeatmapLevelSelectionMask  value) ;

/// @brief Method set_wantsToPlayNextLevel, addr 0x3b322ac, size 0x58, virtual false, abstract: false, final false
inline void set_wantsToPlayNextLevel(bool  value) ;

/// @brief Method set_wasActiveAtLevelStart, addr 0x3b3234c, size 0x58, virtual false, abstract: false, final false
