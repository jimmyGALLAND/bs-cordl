...
/// @brief Field _canvasGroups, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__canvasGroups, put=__cordl_internal_set__canvasGroups)) ::ArrayW<::UnityW<::UnityEngine::CanvasGroup>,::Array<::UnityW<::UnityEngine::CanvasGroup>>*>  _canvasGroups;
...
/// @brief Method EnableObjects, addr 0x3aa8050, size 0x114, virtual false, abstract: false, final false
inline void EnableObjects(bool  on) ;

static inline ::GlobalNamespace::GhostEffectBehaviour* New_ctor() ;

/// @brief Method OnBehaviourPlay, addr 0x3aa7ec0, size 0x190, virtual true, abstract: false, final false
inline void OnBehaviourPlay(::UnityEngine::Playables::Playable  playable, ::UnityEngine::Playables::FrameData  info) ;

/// @brief Method ProcessFrame, addr 0x3aa8164, size 0x430, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aa8594, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;
