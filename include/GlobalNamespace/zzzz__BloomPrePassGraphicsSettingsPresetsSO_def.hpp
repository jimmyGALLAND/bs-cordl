...
/// @brief Method .ctor, addr 0x2686b48, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _presets, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__presets, put=__cordl_internal_set__presets)) ::ArrayW<::GlobalNamespace::__BloomPrePassGraphicsSettingsPresetsSO__Preset*,::Array<::GlobalNamespace::__BloomPrePassGraphicsSettingsPresetsSO__Preset*>*>  _presets;
...
constexpr ::ArrayW<::GlobalNamespace::__BloomPrePassGraphicsSettingsPresetsSO__Preset*,::Array<::GlobalNamespace::__BloomPrePassGraphicsSettingsPresetsSO__Preset*>*> const& __cordl_internal_get__presets() const;

constexpr ::ArrayW<::GlobalNamespace::__BloomPrePassGraphicsSettingsPresetsSO__Preset*,::Array<::GlobalNamespace::__BloomPrePassGraphicsSettingsPresetsSO__Preset*>*>& __cordl_internal_get__presets() ;

constexpr void __cordl_internal_set__presets(::ArrayW<::GlobalNamespace::__BloomPrePassGraphicsSettingsPresetsSO__Preset*,::Array<::GlobalNamespace::__BloomPrePassGraphicsSettingsPresetsSO__Preset*>*>  value) ;

/// @brief Method .ctor, addr 0x2686b38, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_namedPresets, addr 0x2686b30, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<::GlobalNamespace::NamedPreset*,::Array<::GlobalNamespace::NamedPreset*>*> get_namedPresets() ;

/// @brief Method get_presets, addr 0x2686b28, size 0x8, virtual false, abstract: false, final false
