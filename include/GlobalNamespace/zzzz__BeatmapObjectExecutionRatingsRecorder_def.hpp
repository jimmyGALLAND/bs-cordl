...
/// @brief Field _beatmapObjectExecutionRatings, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapObjectExecutionRatings, put=__cordl_internal_set__beatmapObjectExecutionRatings)) ::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapObjectExecutionRating*>*  _beatmapObjectExecutionRatings;
...
/// @brief Field _hitObstacles, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__hitObstacles, put=__cordl_internal_set__hitObstacles)) ::System::Collections::Generic::HashSet_1<::UnityW<::GlobalNamespace::ObstacleController>>*  _hitObstacles;
...
/// @brief Method HandleObstacleDidPassAvoidedMark, addr 0x3a57824, size 0x154, virtual false, abstract: false, final false
inline void HandleObstacleDidPassAvoidedMark(::GlobalNamespace::ObstacleController*  obstacleController) ;

/// @brief Method HandlePlayerHeadDidEnterObstacle, addr 0x3a5770c, size 0x118, virtual false, abstract: false, final false
inline void HandlePlayerHeadDidEnterObstacle(::GlobalNamespace::ObstacleController*  obstacleController) ;

/// @brief Method HandleScoringForNoteDidFinish, addr 0x3a5729c, size 0x470, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3a5700c, size 0x1e0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3a56dc8, size 0x194, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapObjectExecutionRating*>*> const& __cordl_internal_get__beatmapObjectExecutionRatings() const;
...
/// @brief Method .ctor, addr 0x3a57978, size 0xc8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_beatmapObjectExecutionRatings, addr 0x3a56dc0, size 0x8, virtual false, abstract: false, final false
