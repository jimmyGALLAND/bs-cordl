...
/// @brief Method <GetPreMasterSecretAsync>b__0, addr 0x227717c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x227710c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPreMasterSecret, addr 0x2277114, size 0x68, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPreMasterSecret(::ArrayW<uint8_t,::Array<uint8_t>*>  clientPublicKey) ;

/// @brief Method GetPreMasterSecretAsync, addr 0x2276fcc, size 0x140, virtual true, abstract: false, final true
...
static inline ::GlobalNamespace::__DiffieHellmanUtility__DiffieHellmanKeyPair* New_ctor(::Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters*  privateKeyParameters, ::ArrayW<uint8_t,::Array<uint8_t>*>  publicKey) ;
...
/// @brief Method .ctor, addr 0x2276a1c, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method get_publicKey, addr 0x2276fc4, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method <GetPreMasterSecretAsync>b__0, addr 0x22773a0, size 0x6c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> _GetPreMasterSecretAsync_b__0() ;
...
/// @brief Method .ctor, addr 0x2277330, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPreMasterSecret, addr 0x2277338, size 0x68, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPreMasterSecret(::ArrayW<uint8_t,::Array<uint8_t>*>  clientPublicKey) ;

/// @brief Method GetPreMasterSecretAsync, addr 0x22771f0, size 0x140, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::ArrayW<uint8_t,::Array<uint8_t>*>>* GetPreMasterSecretAsync(::BGNet::Core::ITaskUtility*  taskUtility, ::ArrayW<uint8_t,::Array<uint8_t>*>  clientPublicKey) ;

static inline ::GlobalNamespace::__DiffieHellmanUtility__ElipticalCurveKeyPair* New_ctor(::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters*  privateKeyParameters, ::ArrayW<uint8_t,::Array<uint8_t>*>  publicKey) ;
...
/// @brief Method .ctor, addr 0x2276ab0, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method get_publicKey, addr 0x22771e8, size 0x8, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_publicKey() ;
...
/// @brief Method Dispose, addr 0x2277490, size 0xe8, virtual true, abstract: false, final true
inline void Dispose() ;

static inline ::GlobalNamespace::__DiffieHellmanUtility__OperationTimer* New_ctor(::StringW  operationName) ;

/// @brief Method Time, addr 0x2276a14, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x227740c, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method GenerateDiffieHellmanKeys, addr 0x227689c, size 0x178, virtual false, abstract: false, final false
static inline ::GlobalNamespace::__DiffieHellmanUtility__DiffieHellmanKeyPair* GenerateDiffieHellmanKeys() ;

/// @brief Method GenerateElipticalCurveKeys, addr 0x2276718, size 0x184, virtual false, abstract: false, final false
static inline ::GlobalNamespace::__DiffieHellmanUtility__ElipticalCurveKeyPair* GenerateElipticalCurveKeys() ;

/// @brief Method GenerateKeys, addr 0x2272ad8, size 0x64, virtual false, abstract: false, final false
static inline ::GlobalNamespace::IDiffieHellmanKeyPair* GenerateKeys(::GlobalNamespace::__DiffieHellmanUtility__KeyType  keyType) ;

/// @brief Method GenerateKeysAsync, addr 0x227658c, size 0x18c, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::IDiffieHellmanKeyPair*>* GenerateKeysAsync(::BGNet::Core::ITaskUtility*  taskUtility, ::System::Threading::CancellationToken  cancellationToken, ::GlobalNamespace::__DiffieHellmanUtility__KeyType  keyType) ;

/// @brief Method GetPreMasterSecret, addr 0x2276b44, size 0x184, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPreMasterSecret(::Org::BouncyCastle::Crypto::Agreement::DHBasicAgreement*  dhBasicAgreement, ::ArrayW<uint8_t,::Array<uint8_t>*>  clientPublicKey) ;

/// @brief Method GetPreMasterSecret, addr 0x2276cc8, size 0x1c4, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPreMasterSecret(::Org::BouncyCastle::Crypto::Agreement::ECDHBasicAgreement*  ecdhBasicAgreement, ::ArrayW<uint8_t,::Array<uint8_t>*>  clientPublicKey) ;
