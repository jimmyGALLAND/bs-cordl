...
/// @brief Method .ctor, addr 0x3944140, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_id, addr 0x3944130, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::PropertyName get_id() ;

/// @brief Method get_jumpDestination, addr 0x3944138, size 0x8, virtual false, abstract: false, final false
