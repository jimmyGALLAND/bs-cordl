...
static_assert(offsetof(::GlobalNamespace::__GameplayModifiers__EnabledObstacleType, value__) == 0x0, "Offset mismatch!");
...
static_assert(offsetof(::GlobalNamespace::__GameplayModifiers__EnergyType, value__) == 0x0, "Offset mismatch!");
...
static_assert(offsetof(::GlobalNamespace::__GameplayModifiers__SongSpeed, value__) == 0x0, "Offset mismatch!");
...
/// @brief Field _enabledObstacleType, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get__enabledObstacleType, put=__cordl_internal_set__enabledObstacleType)) ::GlobalNamespace::__GameplayModifiers__EnabledObstacleType  _enabledObstacleType;
...
/// @brief Method AreValuesEqual, addr 0x26d1f94, size 0x10c, virtual false, abstract: false, final false
inline bool AreValuesEqual(::GlobalNamespace::GameplayModifiers*  other) ;

/// @brief Method CopyWith, addr 0x26d19d8, size 0x308, virtual false, abstract: false, final false
...
/// @brief Method CreateFromSerializedData, addr 0x26d1e5c, size 0x134, virtual false, abstract: false, final false
static inline ::GlobalNamespace::GameplayModifiers* CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method FromGameplayModifierMask, addr 0x26d1f90, size 0x4, virtual false, abstract: false, final false
static inline ::GlobalNamespace::GameplayModifiers* FromGameplayModifierMask(::GlobalNamespace::GameplayModifierMask  mask) ;

/// @brief Method IsWithoutModifiers, addr 0x26d1ce0, size 0x88, virtual false, abstract: false, final false
inline bool IsWithoutModifiers() ;

/// @brief Method LiteNetLib.Utils.INetImmutableSerializable<GameplayModifiers>.CreateFromSerializedData, addr 0x26d1e08, size 0x54, virtual true, abstract: false, final true
...
/// @brief Method Serialize, addr 0x26d1d68, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x26d19ac, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x26d1728, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method get_cutAngleTolerance, addr 0x26d1974, size 0x20, virtual false, abstract: false, final false
inline float_t get_cutAngleTolerance() ;

/// @brief Method get_disappearingArrows, addr 0x26d1910, size 0x8, virtual false, abstract: false, final false
inline bool get_disappearingArrows() ;

/// @brief Method get_enabledObstacleType, addr 0x26d18f8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__GameplayModifiers__EnabledObstacleType get_enabledObstacleType() ;

/// @brief Method get_energyType, addr 0x26d18d8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__GameplayModifiers__EnergyType get_energyType() ;

/// @brief Method get_failOnSaberClash, addr 0x26d18f0, size 0x8, virtual false, abstract: false, final false
inline bool get_failOnSaberClash() ;

/// @brief Method get_fastNotes, addr 0x26d1900, size 0x8, virtual false, abstract: false, final false
inline bool get_fastNotes() ;

/// @brief Method get_ghostNotes, addr 0x26d1918, size 0x8, virtual false, abstract: false, final false
inline bool get_ghostNotes() ;

/// @brief Method get_instaFail, addr 0x26d18e8, size 0x8, virtual false, abstract: false, final false
inline bool get_instaFail() ;

/// @brief Method get_noArrows, addr 0x26d1930, size 0x8, virtual false, abstract: false, final false
inline bool get_noArrows() ;

/// @brief Method get_noBombs, addr 0x26d1920, size 0x8, virtual false, abstract: false, final false
inline bool get_noBombs() ;

/// @brief Method get_noFailOn0Energy, addr 0x26d18e0, size 0x8, virtual false, abstract: false, final false
inline bool get_noFailOn0Energy() ;

/// @brief Method get_notesUniformScale, addr 0x26d1994, size 0x18, virtual false, abstract: false, final false
inline float_t get_notesUniformScale() ;

/// @brief Method get_proMode, addr 0x26d1938, size 0x8, virtual false, abstract: false, final false
inline bool get_proMode() ;

/// @brief Method get_smallCubes, addr 0x26d1948, size 0x8, virtual false, abstract: false, final false
inline bool get_smallCubes() ;

/// @brief Method get_songSpeed, addr 0x26d1928, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__GameplayModifiers__SongSpeed get_songSpeed() ;

/// @brief Method get_songSpeedMul, addr 0x26d1950, size 0x24, virtual false, abstract: false, final false
inline float_t get_songSpeedMul() ;

/// @brief Method get_strictAngles, addr 0x26d1908, size 0x8, virtual false, abstract: false, final false
inline bool get_strictAngles() ;

/// @brief Method get_zenMode, addr 0x26d1940, size 0x8, virtual false, abstract: false, final false
inline bool get_zenMode() ;

/// @brief Convert to "::LiteNetLib::Utils::INetImmutableSerializable_1<::GlobalNamespace::GameplayModifiers*>"
constexpr ::LiteNetLib::Utils::INetImmutableSerializable_1<::GlobalNamespace::GameplayModifiers*>* i___LiteNetLib__Utils__INetImmutableSerializable_1___GlobalNamespace__GameplayModifiers__() noexcept;
