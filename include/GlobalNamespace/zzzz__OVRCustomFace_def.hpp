...
/// @brief Field _mappings, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__mappings, put=__cordl_internal_set__mappings)) ::ArrayW<::GlobalNamespace::__OVRFaceExpressions__FaceExpression,::Array<::GlobalNamespace::__OVRFaceExpressions__FaceExpression>*>  _mappings;
...
/// @brief Method GetCustomBlendShapeNameAndExpressionPairs, addr 0x3f9ea2c, size 0x138, virtual true, abstract: false, final false
...
/// @brief Method GetFaceExpression, addr 0x3f9e9fc, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method Start, addr 0x3f9e9a8, size 0x4, virtual true, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3f9eb64, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AllowDuplicateMapping, addr 0x3f9e994, size 0x8, virtual false, abstract: false, final false
inline bool get_AllowDuplicateMapping() ;

/// @brief Method get_Mappings, addr 0x3f9e974, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_RetargetingValue, addr 0x3f9e984, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRCustomFace__RetargetingType get_RetargetingValue() ;

/// @brief Method set_AllowDuplicateMapping, addr 0x3f9e99c, size 0xc, virtual false, abstract: false, final false
inline void set_AllowDuplicateMapping(bool  value) ;

/// @brief Method set_Mappings, addr 0x3f9e97c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_RetargetingValue, addr 0x3f9e98c, size 0x8, virtual false, abstract: false, final false
