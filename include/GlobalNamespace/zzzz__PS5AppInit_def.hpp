...
/// @brief Method MoveNext, addr 0x26ceb00, size 0x1ec, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x26cecec, size 0x68, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::PS5AppInit>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
constexpr __PS5AppInit___PreloadAsync_d__10(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::UnityW<::GlobalNamespace::PS5AppInit>  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter  __u__1) noexcept;
...
/// @brief Field _backgroundExecutionHelper, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get__backgroundExecutionHelper, put=__cordl_internal_set__backgroundExecutionHelper)) ::GlobalNamespace::SonyBackgroundExecutionHelper*  _backgroundExecutionHelper;
...
/// @brief Field _ps5AdvancedHapticPlayerPrefab, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get__ps5AdvancedHapticPlayerPrefab, put=__cordl_internal_set__ps5AdvancedHapticPlayerPrefab)) ::UnityW<::UnityEngine::GameObject>  _ps5AdvancedHapticPlayerPrefab;
...
/// @brief Field _sonyOnGoingToBackgroundSaveHandler, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__sonyOnGoingToBackgroundSaveHandler, put=__cordl_internal_set__sonyOnGoingToBackgroundSaveHandler)) ::UnityW<::GlobalNamespace::SonyOnGoingToBackgroundSaveHandler>  _sonyOnGoingToBackgroundSaveHandler;

/// @brief Method AppStartAndMultiSceneEditorSetup, addr 0x26ce620, size 0x68, virtual true, abstract: false, final false
inline void AppStartAndMultiSceneEditorSetup() ;

/// @brief Method InstallBindings, addr 0x26ce88c, size 0x214, virtual true, abstract: false, final false
inline void InstallBindings() ;

static inline ::GlobalNamespace::PS5AppInit* New_ctor() ;

/// @brief Method PreloadAsync, addr 0x26ce560, size 0xc0, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* PreloadAsync() ;

/// @brief Method RepeatableSetupAsync, addr 0x26ce688, size 0xa0, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* RepeatableSetupAsync() ;

/// @brief Method TransitionToNextScene, addr 0x26ce728, size 0xfc, virtual true, abstract: false, final false
inline void TransitionToNextScene() ;

/// @brief Method TransitionToNextSceneInternal, addr 0x26ce824, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method <>n__0, addr 0x26ceaf8, size 0x8, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* __n__0() ;

/// @brief Method .ctor, addr 0x26ceaa0, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
