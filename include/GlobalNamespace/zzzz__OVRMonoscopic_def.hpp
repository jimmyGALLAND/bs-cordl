...
/// @brief Method Update, addr 0x3faa388, size 0xf0, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3faa478, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
