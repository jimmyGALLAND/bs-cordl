...
/// @brief Method HandleMultiplayerStateChange, addr 0x3b2fdd8, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b2fc9c, size 0x8c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetMultiplayerState, addr 0x3b2fc60, size 0x3c, virtual false, abstract: false, final false
inline void SetMultiplayerState(::GlobalNamespace::__MultiplayerController__State  state) ;

/// @brief Method Start, addr 0x3b2faf8, size 0xb8, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b2fddc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
