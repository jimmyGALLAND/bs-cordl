...
/// @brief Field playbackScreenshots, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_playbackScreenshots, put=__cordl_internal_set_playbackScreenshots)) ::ArrayW<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*,::Array<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*>*>  playbackScreenshots;
...
constexpr ::ArrayW<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*,::Array<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*>*> const& __cordl_internal_get_playbackScreenshots() const;
...
constexpr void __cordl_internal_set_playbackScreenshots(::ArrayW<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*,::Array<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*>*>  value) ;
...
/// @brief Method .ctor, addr 0x3a8f100, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::__ObjectsMovementRecorder__Mode  mode, ::StringW  recordingPath, ::GlobalNamespace::__ObjectsMovementRecorder__CameraView  cameraView, bool  addDateTimeSuffixToRecordingName, bool  screenshotRecording, int32_t  screenshotWidth, int32_t  screenshotHeight, int32_t  framerate, ::ArrayW<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*,::Array<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*>*>  playbackScreenshots, bool  saveToOldFormat, ::GlobalNamespace::IBeatSaberLogger*  logger, ::GlobalNamespace::IPosesSerializer*  posesSerializer) ;
...
/// @brief Field _playbackScreenshotRecorder, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__playbackScreenshotRecorder, put=__cordl_internal_set__playbackScreenshotRecorder)) ::UnityW<::GlobalNamespace::PlaybackScreenshotRecorder>  _playbackScreenshotRecorder;

/// @brief Field _playbackScreenshots, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__playbackScreenshots, put=__cordl_internal_set__playbackScreenshots)) ::ArrayW<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*,::Array<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*>*>  _playbackScreenshots;
...
/// @brief Method HandleGameStateChanged, addr 0x3a8ef8c, size 0x70, virtual false, abstract: false, final false
inline void HandleGameStateChanged() ;

/// @brief Method Init, addr 0x3a8df50, size 0x704, virtual false, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::ObjectsMovementRecorder* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3a8ed50, size 0x224, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*,::Array<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*>*> const& __cordl_internal_get__playbackScreenshots() const;
...
constexpr void __cordl_internal_set__playbackScreenshots(::ArrayW<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*,::Array<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*>*>  value) ;
...
/// @brief Method .ctor, addr 0x3a8f0f0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
