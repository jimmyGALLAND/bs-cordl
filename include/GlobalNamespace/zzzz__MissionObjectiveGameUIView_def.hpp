...
/// @brief Method HandleMissionObjectiveCheckedValueDidChange, addr 0x3b12638, size 0x4, virtual false, abstract: false, final false
inline void HandleMissionObjectiveCheckedValueDidChange(::GlobalNamespace::MissionObjectiveChecker*  missionObjectiveChecker) ;

/// @brief Method HandleMissionObjectiveStatusDidChange, addr 0x3b12634, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method RefreshIcon, addr 0x3b124d8, size 0x104, virtual false, abstract: false, final false
inline void RefreshIcon() ;

/// @brief Method RefreshValue, addr 0x3b125dc, size 0x58, virtual false, abstract: false, final false
inline void RefreshValue() ;

/// @brief Method SetMissionObjectiveChecker, addr 0x3b1210c, size 0x26c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b1263c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
