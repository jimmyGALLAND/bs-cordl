...
/// @brief Method <.ctor>b__25_0, addr 0x3a9e948, size 0x18, virtual false, abstract: false, final false
inline bool __ctor_b__25_0(::GlobalNamespace::RecordingSettings*  recordingSettings) ;

/// @brief Method .ctor, addr 0x3a9e940, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x3a9e960, size 0x2c4, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3a9ec24, size 0xc, virtual true, abstract: false, final true
...
/// @brief Method BindNextRecording, addr 0x3a9e5a0, size 0x344, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x3a9e480, size 0x90, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method HandleGameplayLevelSceneTransitionEventsAnyGameplayLevelDidFinish, addr 0x3a9e510, size 0x90, virtual false, abstract: false, final false
inline void HandleGameplayLevelSceneTransitionEventsAnyGameplayLevelDidFinish() ;

/// @brief Method Initialize, addr 0x3a9e238, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method StartNextRecording, addr 0x3a9e2dc, size 0x1a4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a9e094, size 0x1a4, virtual false, abstract: false, final false
...
/// @brief Method get_configJsonData, addr 0x3a9e07c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_configJsonData() ;

/// @brief Method get_performanceRecordingEnabled, addr 0x3a9e074, size 0x8, virtual false, abstract: false, final false
inline bool get_performanceRecordingEnabled() ;

/// @brief Method get_posesSerializer, addr 0x3a9e08c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::IPosesSerializer* get_posesSerializer() ;

/// @brief Method get_recordingToolEnabled, addr 0x3a9e064, size 0x8, virtual false, abstract: false, final false
inline bool get_recordingToolEnabled() ;

/// @brief Method get_recordingToolSettings, addr 0x3a9e084, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::RecordingToolSettings* get_recordingToolSettings() ;

/// @brief Method get_showRecordingToolScene, addr 0x3a9e06c, size 0x8, virtual false, abstract: false, final false
