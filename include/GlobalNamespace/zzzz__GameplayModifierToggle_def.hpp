...
/// @brief Method Start, addr 0x3b9832c, size 0x37c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b986a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_gameplayModifier, addr 0x3b98324, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::GameplayModifierParamsSO> get_gameplayModifier() ;

/// @brief Method get_toggle, addr 0x3b9831c, size 0x8, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::GameplayModifierToggle, 0x60>, "Size mismatch!");
