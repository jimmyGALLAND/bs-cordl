...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteDataFromNoteSpawnInfoNetSerializable::*)(::GlobalNamespace::NoteSpawnInfoNetSerializable*)>(&::GlobalNamespace::NoteDataFromNoteSpawnInfoNetSerializable::_ctor)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0x3b25494;
...
inline ::GlobalNamespace::NoteDataFromNoteSpawnInfoNetSerializable* GlobalNamespace::NoteDataFromNoteSpawnInfoNetSerializable::New_ctor(::GlobalNamespace::NoteSpawnInfoNetSerializable*  noteSpawnInfo)  {
