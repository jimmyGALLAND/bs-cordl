...
/// @brief Field <movementPhase>k__BackingField, offset 0x70, size 0x4 
 __declspec(property(get=__cordl_internal_get__movementPhase_k__BackingField, put=__cordl_internal_set__movementPhase_k__BackingField)) ::GlobalNamespace::__NoteMovement__MovementPhase  _movementPhase_k__BackingField;
...
/// @brief Method Awake, addr 0x3a66c78, size 0x1bc, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleFloorMovementDidFinish, addr 0x3a67050, size 0x64, virtual false, abstract: false, final false
inline void HandleFloorMovementDidFinish() ;

/// @brief Method HandleNoteJumpDidFinish, addr 0x3a670b4, size 0x20, virtual false, abstract: false, final false
inline void HandleNoteJumpDidFinish() ;

/// @brief Method HandleNoteJumpDidPassMissedMark, addr 0x3a670d4, size 0x1c, virtual false, abstract: false, final false
inline void HandleNoteJumpDidPassMissedMark() ;

/// @brief Method HandleNoteJumpDidPassThreeQuarters, addr 0x3a670f0, size 0x20, virtual false, abstract: false, final false
inline void HandleNoteJumpDidPassThreeQuarters(::GlobalNamespace::NoteJump*  noteJump) ;

/// @brief Method HandleNoteJumpNoteJumpDidPassHalf, addr 0x3a67110, size 0x1c, virtual false, abstract: false, final false
inline void HandleNoteJumpNoteJumpDidPassHalf() ;

/// @brief Method Init, addr 0x3a631cc, size 0x1a4, virtual false, abstract: false, final false
inline void Init(float_t  beatTime, float_t  worldRotation, ::UnityEngine::Vector3  moveStartPos, ::UnityEngine::Vector3  moveEndPos, ::UnityEngine::Vector3  jumpEndPos, float_t  moveDuration, float_t  jumpDuration, float_t  jumpGravity, float_t  flipYSide, float_t  endRotation, bool  rotateTowardsPlayer, bool  useRandomRotation) ;

/// @brief Method ManualUpdate, addr 0x3a62b0c, size 0xb8, virtual false, abstract: false, final false
inline void ManualUpdate() ;

static inline ::GlobalNamespace::NoteMovement* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3a66e34, size 0x21c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a6712c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didInitEvent, addr 0x3a668f8, size 0x9c, virtual false, abstract: false, final false
inline void add_didInitEvent(::System::Action*  value) ;

/// @brief Method add_noteDidFinishJumpEvent, addr 0x3a625dc, size 0x9c, virtual false, abstract: false, final false
inline void add_noteDidFinishJumpEvent(::System::Action*  value) ;

/// @brief Method add_noteDidMoveInJumpPhaseEvent, addr 0x3a66acc, size 0x9c, virtual false, abstract: false, final false
inline void add_noteDidMoveInJumpPhaseEvent(::System::Action*  value) ;

/// @brief Method add_noteDidPassHalfJumpEvent, addr 0x3a5e160, size 0x9c, virtual false, abstract: false, final false
inline void add_noteDidPassHalfJumpEvent(::System::Action*  value) ;

/// @brief Method add_noteDidPassJumpThreeQuartersEvent, addr 0x3a62714, size 0xb0, virtual false, abstract: false, final false
inline void add_noteDidPassJumpThreeQuartersEvent(::System::Action_1<::UnityW<::GlobalNamespace::NoteMovement>>*  value) ;

/// @brief Method add_noteDidPassMissedMarkerEvent, addr 0x3a627c4, size 0x9c, virtual false, abstract: false, final false
inline void add_noteDidPassMissedMarkerEvent(::System::Action*  value) ;

/// @brief Method add_noteDidStartJumpEvent, addr 0x3a62678, size 0x9c, virtual false, abstract: false, final false
inline void add_noteDidStartJumpEvent(::System::Action*  value) ;

/// @brief Method get_beatPos, addr 0x3a624c8, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_beatPos() ;

/// @brief Method get_distanceToPlayer, addr 0x3a66c44, size 0x34, virtual false, abstract: false, final false
inline float_t get_distanceToPlayer() ;

/// @brief Method get_inverseWorldRotation, addr 0x3a62388, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_inverseWorldRotation() ;

/// @brief Method get_jumpDuration, addr 0x3a6244c, size 0x1c, virtual false, abstract: false, final false
inline float_t get_jumpDuration() ;

/// @brief Method get_jumpMoveVec, addr 0x3a62490, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_jumpMoveVec() ;

/// @brief Method get_localPosition, addr 0x3a66c2c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_localPosition() ;

/// @brief Method get_moveDuration, addr 0x3a6240c, size 0x1c, virtual false, abstract: false, final false
inline float_t get_moveDuration() ;

/// @brief Method get_moveEndPos, addr 0x3a62534, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_moveEndPos() ;

/// @brief Method get_moveStartTime, addr 0x3a623cc, size 0x1c, virtual false, abstract: false, final false
inline float_t get_moveStartTime() ;

/// @brief Method get_movementPhase, addr 0x3a66c04, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__NoteMovement__MovementPhase get_movementPhase() ;

/// @brief Method get_position, addr 0x3a66c14, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_position() ;

/// @brief Method get_prevLocalPosition, addr 0x3a66c38, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_prevLocalPosition() ;

/// @brief Method get_prevPosition, addr 0x3a66c20, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_prevPosition() ;

/// @brief Method get_worldRotation, addr 0x3a62368, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_worldRotation() ;

/// @brief Method remove_didInitEvent, addr 0x3a66994, size 0x9c, virtual false, abstract: false, final false
inline void remove_didInitEvent(::System::Action*  value) ;

/// @brief Method remove_noteDidFinishJumpEvent, addr 0x3a62860, size 0x9c, virtual false, abstract: false, final false
inline void remove_noteDidFinishJumpEvent(::System::Action*  value) ;

/// @brief Method remove_noteDidMoveInJumpPhaseEvent, addr 0x3a66b68, size 0x9c, virtual false, abstract: false, final false
inline void remove_noteDidMoveInJumpPhaseEvent(::System::Action*  value) ;

/// @brief Method remove_noteDidPassHalfJumpEvent, addr 0x3a66a30, size 0x9c, virtual false, abstract: false, final false
inline void remove_noteDidPassHalfJumpEvent(::System::Action*  value) ;

/// @brief Method remove_noteDidPassJumpThreeQuartersEvent, addr 0x3a62998, size 0xb0, virtual false, abstract: false, final false
inline void remove_noteDidPassJumpThreeQuartersEvent(::System::Action_1<::UnityW<::GlobalNamespace::NoteMovement>>*  value) ;

/// @brief Method remove_noteDidPassMissedMarkerEvent, addr 0x3a62a48, size 0x9c, virtual false, abstract: false, final false
inline void remove_noteDidPassMissedMarkerEvent(::System::Action*  value) ;

/// @brief Method remove_noteDidStartJumpEvent, addr 0x3a628fc, size 0x9c, virtual false, abstract: false, final false
inline void remove_noteDidStartJumpEvent(::System::Action*  value) ;

/// @brief Method set_movementPhase, addr 0x3a66c0c, size 0x8, virtual false, abstract: false, final false
