...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController> (::GlobalNamespace::MultiplayerConnectedPlayerDisappearingArrowController::*)()>(&::GlobalNamespace::MultiplayerConnectedPlayerDisappearingArrowController::get_gameNoteController)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3b2510c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerConnectedPlayerDisappearingArrowController::*)()>(&::GlobalNamespace::MultiplayerConnectedPlayerDisappearingArrowController::_ctor)> {
  constexpr static std::size_t size = 0x6c;
  constexpr static std::size_t addrs = 0x3b25114;
...
constexpr ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>& GlobalNamespace::MultiplayerConnectedPlayerDisappearingArrowController::__cordl_internal_get__gameNoteController()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____gameNoteController;
}
constexpr ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController> const& GlobalNamespace::MultiplayerConnectedPlayerDisappearingArrowController::__cordl_internal_get__gameNoteController() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____gameNoteController;
}
constexpr void GlobalNamespace::MultiplayerConnectedPlayerDisappearingArrowController::__cordl_internal_set__gameNoteController(::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
