...
/// @brief Method EndEarlyAnimation, addr 0x2220e74, size 0x74, virtual false, abstract: false, final false
inline void EndEarlyAnimation() ;

/// @brief Method HandleSpawnCharacterPlayableDirectorStopped, addr 0x22210fc, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x2220cdc, size 0xd0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method PauseAnimation, addr 0x2221060, size 0x9c, virtual false, abstract: false, final false
inline void PauseAnimation() ;

/// @brief Method PlayAnimation, addr 0x2220dac, size 0xc8, virtual false, abstract: false, final false
inline void PlayAnimation() ;

/// @brief Method ResumeAnimation, addr 0x222101c, size 0x44, virtual false, abstract: false, final false
inline void ResumeAnimation() ;

/// @brief Method SetCharacter, addr 0x2220f04, size 0x94, virtual false, abstract: false, final false
inline void SetCharacter(::GlobalNamespace::BTSCharacter*  btsCharacter) ;

/// @brief Method Start, addr 0x2220c4c, size 0x90, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StopAnimation, addr 0x2220ee8, size 0x1c, virtual false, abstract: false, final false
inline void StopAnimation() ;

/// @brief Method WillResumeAnimation, addr 0x2220f98, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2221118, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_animationFinishedEvent, addr 0x2220690, size 0x9c, virtual false, abstract: false, final false
inline void add_animationFinishedEvent(::System::Action*  value) ;

/// @brief Method get_characterActivationTrack, addr 0x2220800, size 0x44c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Timeline::ActivationTrack> get_characterActivationTrack() ;

/// @brief Method get_duration, addr 0x22207c8, size 0x38, virtual false, abstract: false, final false
inline float_t get_duration() ;

/// @brief Method get_isCharacterVisible, addr 0x2220668, size 0x28, virtual false, abstract: false, final false
inline bool get_isCharacterVisible() ;

/// @brief Method remove_animationFinishedEvent, addr 0x222072c, size 0x9c, virtual false, abstract: false, final false
