...
/// @brief Method .ctor, addr 0x26618b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_colorScheme, addr 0x2661854, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::ColorSchemeSO> get_colorScheme() ;

/// @brief Method get_defaultLightshowAsset, addr 0x266188c, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::TextAsset> get_defaultLightshowAsset() ;

/// @brief Method get_environmentIntensityReductionOptions, addr 0x2661874, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::EnvironmentIntensityReductionOptions* get_environmentIntensityReductionOptions() ;

/// @brief Method get_environmentKeywords, addr 0x266187c, size 0x8, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IReadOnlyList_1<::StringW>* get_environmentKeywords() ;

/// @brief Method get_environmentLightGroups, addr 0x2661884, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::IEnvironmentLightGroups* get_environmentLightGroups() ;

/// @brief Method get_environmentName, addr 0x266184c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_environmentName() ;

/// @brief Method get_environmentSizeData, addr 0x266186c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::EnvironmentSizeData* get_environmentSizeData() ;

/// @brief Method get_environmentType, addr 0x2661864, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::EnvironmentType get_environmentType() ;

/// @brief Method get_isBranded, addr 0x266189c, size 0xc, virtual false, abstract: false, final false
inline bool get_isBranded() ;

/// @brief Method get_isInDevelopment, addr 0x26618a8, size 0xc, virtual false, abstract: false, final false
inline bool get_isInDevelopment() ;

/// @brief Method get_order, addr 0x2661894, size 0x8, virtual false, abstract: false, final false
inline int32_t get_order() ;

/// @brief Method get_sceneInfo, addr 0x2661844, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::SceneInfo> get_sceneInfo() ;

/// @brief Method get_serializedName, addr 0x266185c, size 0x8, virtual false, abstract: false, final false
