...
/// @brief Method SetProperty, addr 0x39633b4, size 0x34, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39633e8, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
