...
/// @brief Method .ctor, addr 0x3b4bb20, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x3b4bb18, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
