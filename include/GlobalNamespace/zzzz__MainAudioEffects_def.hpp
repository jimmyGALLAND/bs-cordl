...
/// @brief Method LateUpdate, addr 0x3a4ce74, size 0xbc, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::MainAudioEffects* New_ctor() ;

/// @brief Method ResumeNormalSound, addr 0x3a4cf30, size 0x28, virtual false, abstract: false, final false
inline void ResumeNormalSound() ;

/// @brief Method Start, addr 0x3a4ce40, size 0x34, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method TriggerLowPass, addr 0x3a4cf58, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a4cf94, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
