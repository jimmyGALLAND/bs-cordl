...
/// @brief Field <difficulties>k__BackingField, offset 0x18, size 0x1 
 __declspec(property(get=__cordl_internal_get__difficulties_k__BackingField, put=__cordl_internal_set__difficulties_k__BackingField)) ::GlobalNamespace::BeatmapDifficultyMask  _difficulties_k__BackingField;
...
/// @brief Method .ctor, addr 0x2290940, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_characteristic, addr 0x2290920, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_characteristic() ;

/// @brief Method get_difficulties, addr 0x2290930, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapDifficultyMask get_difficulties() ;

/// @brief Method set_characteristic, addr 0x2290928, size 0x8, virtual false, abstract: false, final false
inline void set_characteristic(::StringW  value) ;

/// @brief Method set_difficulties, addr 0x2290938, size 0x8, virtual false, abstract: false, final false
