...
/// @brief Method Deinit, addr 0x3b51ab8, size 0x90, virtual false, abstract: false, final false
inline void Deinit() ;

/// @brief Method HandleGameEvent, addr 0x3b51b50, size 0x2c, virtual false, abstract: false, final false
inline void HandleGameEvent() ;

/// @brief Method Init, addr 0x3b519c4, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b51b7c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _eventTextBindings, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__eventTextBindings, put=__cordl_internal_set__eventTextBindings)) ::ArrayW<::GlobalNamespace::__ShowTextOnGameEventController__EventTextBinding*,::Array<::GlobalNamespace::__ShowTextOnGameEventController__EventTextBinding*>*>  _eventTextBindings;

/// @brief Field _textFadeTransitions, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__textFadeTransitions, put=__cordl_internal_set__textFadeTransitions)) ::UnityW<::GlobalNamespace::TextFadeTransitions>  _textFadeTransitions;

/// @brief Method Awake, addr 0x3b51960, size 0x64, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::ShowTextOnGameEventController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b51a5c, size 0x5c, virtual false, abstract: false, final false
inline void OnDestroy() ;

constexpr ::ArrayW<::GlobalNamespace::__ShowTextOnGameEventController__EventTextBinding*,::Array<::GlobalNamespace::__ShowTextOnGameEventController__EventTextBinding*>*> const& __cordl_internal_get__eventTextBindings() const;

constexpr ::ArrayW<::GlobalNamespace::__ShowTextOnGameEventController__EventTextBinding*,::Array<::GlobalNamespace::__ShowTextOnGameEventController__EventTextBinding*>*>& __cordl_internal_get__eventTextBindings() ;

constexpr ::UnityW<::GlobalNamespace::TextFadeTransitions> const& __cordl_internal_get__textFadeTransitions() const;

constexpr ::UnityW<::GlobalNamespace::TextFadeTransitions>& __cordl_internal_get__textFadeTransitions() ;

constexpr void __cordl_internal_set__eventTextBindings(::ArrayW<::GlobalNamespace::__ShowTextOnGameEventController__EventTextBinding*,::Array<::GlobalNamespace::__ShowTextOnGameEventController__EventTextBinding*>*>  value) ;

constexpr void __cordl_internal_set__textFadeTransitions(::UnityW<::GlobalNamespace::TextFadeTransitions>  value) ;

/// @brief Method .ctor, addr 0x3b51b48, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
