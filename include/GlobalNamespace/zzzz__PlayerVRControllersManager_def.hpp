...
/// @brief Method DisableAllVRControllers, addr 0x3b51fb0, size 0x38, virtual false, abstract: false, final false
inline void DisableAllVRControllers() ;

/// @brief Method EnableAllVRControllers, addr 0x3b51fe8, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b52020, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_leftHandVRController, addr 0x3b51fa0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::VRController> get_leftHandVRController() ;

/// @brief Method get_rightHandVRController, addr 0x3b51fa8, size 0x8, virtual false, abstract: false, final false
