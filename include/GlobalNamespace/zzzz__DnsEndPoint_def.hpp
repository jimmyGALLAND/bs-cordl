...
/// @brief Method Equals, addr 0x2277a54, size 0xa0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2277af4, size 0x4c, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::DnsEndPoint*  other) ;

/// @brief Method GetEndPoint, addr 0x2277884, size 0x94, virtual false, abstract: false, final false
inline ::System::Net::IPEndPoint* GetEndPoint() ;

/// @brief Method GetEndPointAsync, addr 0x2277770, size 0x114, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::System::Net::IPEndPoint*>* GetEndPointAsync(::BGNet::Core::ITaskUtility*  taskUtility) ;

/// @brief Method GetEndPointInternal, addr 0x2277918, size 0xb0, virtual false, abstract: false, final false
inline ::System::Net::IPEndPoint* GetEndPointInternal() ;

/// @brief Method GetHashCode, addr 0x2277b40, size 0x2c, virtual true, abstract: false, final false
...
/// @brief Method ToString, addr 0x22779c8, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22776bc, size 0xb4, virtual false, abstract: false, final false
inline void _ctor(::System::Net::IPEndPoint*  endPoint) ;

/// @brief Method .ctor, addr 0x227655c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  hostName, int32_t  port) ;

/// @brief Method get_endPoint, addr 0x2277648, size 0x74, virtual false, abstract: false, final false
