...
// Ctor Parameters [CppParam { name: "chunkStream", ty: "::System::IO::Stream*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "chunkLength", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "chunkStart", ty: "int64_t", modifiers: "", def_value: Some("{}") }]
