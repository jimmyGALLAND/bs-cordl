...
/// @brief Method Awake, addr 0x3b09c84, size 0x90, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method LazyInit, addr 0x3b09d14, size 0x30, virtual false, abstract: false, final false
inline void LazyInit() ;

static inline ::GlobalNamespace::SpectrogramRowPropertyAnimator* New_ctor() ;

/// @brief Method SetMultiplier, addr 0x3b09de8, size 0x8, virtual false, abstract: false, final false
inline void SetMultiplier(float_t  value) ;

/// @brief Method SetProperty, addr 0x3b09c50, size 0x34, virtual true, abstract: false, final false
inline void SetProperty() ;

/// @brief Method Update, addr 0x3b09d44, size 0xa4, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b09df0, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
