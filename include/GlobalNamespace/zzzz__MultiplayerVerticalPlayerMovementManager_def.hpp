...
/// @brief Field _reusablePlayersList, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__reusablePlayersList, put=__cordl_internal_set__reusablePlayersList)) ::System::Collections::Generic::List_1<::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*>*  _reusablePlayersList;
...
/// @brief Method HandleStateChanged, addr 0x3b4d400, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b4d410, size 0xd0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b4d350, size 0xb0, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3b4d4e0, size 0x7e0, virtual false, abstract: false, final false
inline void Update() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerFacade>,float_t>*> const& __cordl_internal_get__currentSpeedsDictionary() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*>*> const& __cordl_internal_get__reusablePlayersList() const;
...
/// @brief Method .ctor, addr 0x3b4dcc0, size 0xdc, virtual false, abstract: false, final false
inline void _ctor() ;
