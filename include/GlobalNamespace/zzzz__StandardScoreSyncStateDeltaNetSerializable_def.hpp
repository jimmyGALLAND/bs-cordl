...
/// @brief Method Deserialize, addr 0x229e5bc, size 0x6c, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

static inline ::GlobalNamespace::StandardScoreSyncStateDeltaNetSerializable* New_ctor() ;

/// @brief Method Release, addr 0x229e628, size 0xac, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x229e50c, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x229e6d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_baseId, addr 0x229e4c4, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::SyncStateId get_baseId() ;

/// @brief Method get_delta, addr 0x229e4e4, size 0x14, virtual true, abstract: false, final true
inline ::GlobalNamespace::StandardScoreSyncState get_delta() ;

/// @brief Method get_pool, addr 0x229e484, size 0x40, virtual false, abstract: false, final false
static inline ::GlobalNamespace::IPacketPool_1<::GlobalNamespace::StandardScoreSyncStateDeltaNetSerializable*>* get_pool() ;

/// @brief Method get_timeOffsetMs, addr 0x229e4d4, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_baseId, addr 0x229e4cc, size 0x8, virtual true, abstract: false, final true
inline void set_baseId(::GlobalNamespace::SyncStateId  value) ;

/// @brief Method set_delta, addr 0x229e4f8, size 0x14, virtual true, abstract: false, final true
inline void set_delta(::GlobalNamespace::StandardScoreSyncState  value) ;

/// @brief Method set_timeOffsetMs, addr 0x229e4dc, size 0x8, virtual true, abstract: false, final true
