...
/// @brief Method HandleBeatmapEvent, addr 0x3b00020, size 0x11c, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

static inline ::GlobalNamespace::LightRotationEventEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b00004, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3affdc4, size 0x158, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3afff1c, size 0xe8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b0013c, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
