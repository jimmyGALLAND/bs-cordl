...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLevelSceneSetupData::*)(ByRef<::GlobalNamespace::BeatmapKey>, bool)>(&::GlobalNamespace::MultiplayerLevelSceneSetupData::_ctor)> {
