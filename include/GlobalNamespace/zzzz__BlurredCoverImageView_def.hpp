...
/// @brief Method MoveNext, addr 0x3a74b54, size 0x6d0, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3a75224, size 0xc, virtual true, abstract: false, final true
...
/// @brief Field _blurredCoverTexture, offset 0x40, size 0x8 
...
/// @brief Field _settingTextureForLevelId, offset 0x30, size 0x8 
...
/// @brief Method OnDestroy, addr 0x3a74a0c, size 0xa4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetTextureAsync, addr 0x3a74ab0, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a74b4c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _settingTextureForLevelId, offset: 0x30, size: 0x8, def value: None
...
/// @brief Field _blurredCoverTexture, offset: 0x40, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Texture2D>  ____blurredCoverTexture;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::BlurredCoverImageView, 0x48>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::BlurredCoverImageView, ____settingTextureForLevelId) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BlurredCoverImageView, ____cancellationTokenSource) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BlurredCoverImageView, ____blurredCoverTexture) == 0x40, "Offset mismatch!");
