...
/// @brief Method DidActivate, addr 0x3a6f0ac, size 0x3e4, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3a6f490, size 0x2e4, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleAntiAliasingLevelChanged, addr 0x3a6f774, size 0x1c, virtual false, abstract: false, final false
inline void HandleAntiAliasingLevelChanged(int32_t  newValue) ;

/// @brief Method HandleFullscreenToggled, addr 0x3a6f7ac, size 0x20, virtual false, abstract: false, final false
inline void HandleFullscreenToggled(bool  newValue) ;

/// @brief Method HandleMainEffectChanged, addr 0x3a6f82c, size 0x1c, virtual false, abstract: false, final false
inline void HandleMainEffectChanged(int32_t  newValue) ;

/// @brief Method HandleMirrorChanged, addr 0x3a6f848, size 0x1c, virtual false, abstract: false, final false
inline void HandleMirrorChanged(int32_t  newValue) ;

/// @brief Method HandleScreenDisplacementToggled, addr 0x3a6f80c, size 0x20, virtual false, abstract: false, final false
inline void HandleScreenDisplacementToggled(bool  newValue) ;

/// @brief Method HandleShockwaveMaxParticlesChanged, addr 0x3a6f7cc, size 0x1c, virtual false, abstract: false, final false
inline void HandleShockwaveMaxParticlesChanged(int32_t  newValue) ;

/// @brief Method HandleSmokeToggled, addr 0x3a6f7e8, size 0x24, virtual false, abstract: false, final false
inline void HandleSmokeToggled(bool  newValue) ;

/// @brief Method HandleVrRenderingScaleChanged, addr 0x3a6f790, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a6f864, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
