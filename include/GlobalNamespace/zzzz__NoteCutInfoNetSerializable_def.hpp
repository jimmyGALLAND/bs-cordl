...
/// @brief Method Deserialize, addr 0x26d3958, size 0x118, virtual true, abstract: false, final false
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x26d3de4, size 0xdc, virtual false, abstract: false, final false
inline ::GlobalNamespace::NoteCutInfoNetSerializable* Init(ByRef<::GlobalNamespace::NoteCutInfo>  noteCutInfo, ::GlobalNamespace::NoteData*  noteData, ::UnityEngine::Vector3  notePosition, ::UnityEngine::Quaternion  noteRotation, ::UnityEngine::Vector3  noteScale, ::UnityEngine::Vector3  moveVec) ;

/// @brief Method Init, addr 0x26d3ec0, size 0x20c, virtual false, abstract: false, final false
inline ::GlobalNamespace::NoteCutInfoNetSerializable* Init(float_t  saberSpeed, bool  cutWasOk, ::UnityEngine::Vector3  saberDir, ::UnityEngine::Vector3  cutPoint, ::UnityEngine::Vector3  cutNormal, ::GlobalNamespace::__NoteData__GameplayType  gameplayType, ::GlobalNamespace::ColorType  colorType, ::GlobalNamespace::NoteLineLayer  lineLayer, int32_t  noteLineIndex, float_t  noteTime, float_t  timeToNextColorNote, ::UnityEngine::Vector3  notePosition, ::UnityEngine::Quaternion  noteRotation, ::UnityEngine::Vector3  noteScale, ::UnityEngine::Vector3  moveVec) ;

static inline ::GlobalNamespace::NoteCutInfoNetSerializable* New_ctor() ;

/// @brief Method Obtain, addr 0x26d38f4, size 0x64, virtual false, abstract: false, final false
static inline ::GlobalNamespace::NoteCutInfoNetSerializable* Obtain() ;

/// @brief Method Serialize, addr 0x26d3b38, size 0x144, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26d3d84, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
