...
/// @brief Method DidActivate, addr 0x3add864, size 0xa0, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

static inline ::GlobalNamespace::SelectModifiersViewController* New_ctor() ;

/// @brief Method Setup, addr 0x3add848, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3add904, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_gameplayModifiers, addr 0x3add82c, size 0x1c, virtual false, abstract: false, final false
