...
/// @brief Method Deserialize, addr 0x229e7b0, size 0x50, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

static inline ::GlobalNamespace::StandardScoreSyncStateNetSerializable* New_ctor() ;

/// @brief Method Release, addr 0x229e800, size 0x54, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x229e764, size 0x4c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x229e854, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_id, addr 0x229e71c, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::SyncStateId get_id() ;

/// @brief Method get_pool, addr 0x229e6dc, size 0x40, virtual false, abstract: false, final false
static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::StandardScoreSyncStateNetSerializable*>* get_pool() ;

/// @brief Method get_state, addr 0x229e73c, size 0x14, virtual true, abstract: false, final true
inline ::GlobalNamespace::StandardScoreSyncState get_state() ;

/// @brief Method get_time, addr 0x229e72c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_id, addr 0x229e724, size 0x8, virtual true, abstract: false, final true
inline void set_id(::GlobalNamespace::SyncStateId  value) ;

/// @brief Method set_state, addr 0x229e750, size 0x14, virtual true, abstract: false, final true
inline void set_state(::GlobalNamespace::StandardScoreSyncState  value) ;

/// @brief Method set_time, addr 0x229e734, size 0x8, virtual true, abstract: false, final true
