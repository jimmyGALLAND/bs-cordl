...
/// @brief Method HandleLevelFinished, addr 0x3b1b180, size 0x4, virtual false, abstract: false, final false
inline void HandleLevelFinished() ;

static inline ::GlobalNamespace::MissionLevelFinishedController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b1b080, size 0x100, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b1af90, size 0xf0, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartLevelFinished, addr 0x3b1b184, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b1b230, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
