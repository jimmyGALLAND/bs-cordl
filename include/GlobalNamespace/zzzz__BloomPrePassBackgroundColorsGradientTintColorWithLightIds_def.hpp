...
/// @brief Method ColorWasSet, addr 0x395de60, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x395de80, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
