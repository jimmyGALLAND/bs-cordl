...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::MomentaryLoudnessBuffer::*)()>(&::GlobalNamespace::MomentaryLoudnessBuffer::get_isNextReadingIntervalReady)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x3a497e4;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MomentaryLoudnessBuffer*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<float_t,::Array<float_t>*> (::GlobalNamespace::MomentaryLoudnessBuffer::*)()>(&::GlobalNamespace::MomentaryLoudnessBuffer::get_buffer)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3a4d02c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MomentaryLoudnessBuffer::*)(int32_t, int32_t, float_t, int32_t)>(&::GlobalNamespace::MomentaryLoudnessBuffer::_ctor)> {
  constexpr static std::size_t size = 0xbc;
  constexpr static std::size_t addrs = 0x3a496e4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MomentaryLoudnessBuffer::*)(float_t)>(&::GlobalNamespace::MomentaryLoudnessBuffer::AddSample)> {
  constexpr static std::size_t size = 0x44;
  constexpr static std::size_t addrs = 0x3a497a0;
...
inline ::GlobalNamespace::MomentaryLoudnessBuffer* GlobalNamespace::MomentaryLoudnessBuffer::New_ctor(int32_t  numChannels, int32_t  sampleFrequency, float_t  momentaryWindowDuration, int32_t  readingsPerBuffer)  {
