...
public:
// Declarations
/// @brief Method GetValue, addr 0x2688f44, size 0x28, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2688f6c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
