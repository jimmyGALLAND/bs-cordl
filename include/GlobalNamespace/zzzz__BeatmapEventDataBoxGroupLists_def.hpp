...
/// @brief Method Insert, addr 0x266e058, size 0xfc, virtual false, abstract: false, final false
...
static inline ::GlobalNamespace::BeatmapEventDataBoxGroupLists* New_ctor(::GlobalNamespace::BeatmapData*  beatmapData, ::GlobalNamespace::IBeatToTimeConverter*  beatToTimeConverter, bool  updateBeatmapDataOnInsert) ;

/// @brief Method Remove, addr 0x266e154, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method SyncWithBeatmapData, addr 0x266e3a4, size 0x18c, virtual false, abstract: false, final false
inline void SyncWithBeatmapData() ;

/// @brief Method ToggleUpdateBeatmapDataOnInsert, addr 0x266e20c, size 0x198, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::BeatmapEventDataBoxGroupList*>*> const& __cordl_internal_get__beatmapEventDataBoxGroupListDict() const;
...
/// @brief Method .ctor, addr 0x266dfb8, size 0xa0, virtual false, abstract: false, final false
