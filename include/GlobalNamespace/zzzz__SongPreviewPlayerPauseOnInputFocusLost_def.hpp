...
/// @brief Method HandleInputFocusCaptured, addr 0x3a504d0, size 0x44, virtual false, abstract: false, final false
inline void HandleInputFocusCaptured() ;

/// @brief Method HandleInputFocusReleased, addr 0x3a506bc, size 0x44, virtual false, abstract: false, final false
inline void HandleInputFocusReleased() ;

static inline ::GlobalNamespace::SongPreviewPlayerPauseOnInputFocusLost* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3a50514, size 0x1a8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3a502bc, size 0x214, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3a50700, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
