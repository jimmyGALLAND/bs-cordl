...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::SliderMidAnchorMode (*)(::GlobalNamespace::SliderMidAnchorMode)>(&::GlobalNamespace::SliderMidAnchorModeExtensions::OppositeDirection)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x2204e10;
