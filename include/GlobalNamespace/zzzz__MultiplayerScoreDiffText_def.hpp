...
/// @brief Method AnimateHide, addr 0x3b24da8, size 0xf0, virtual false, abstract: false, final false
inline void AnimateHide() ;

/// @brief Method AnimateIsLeadPlayer, addr 0x3b24e98, size 0x50, virtual false, abstract: false, final false
inline void AnimateIsLeadPlayer(bool  isLeader) ;

/// @brief Method AnimateScoreDiff, addr 0x3b24bf8, size 0x1b0, virtual false, abstract: false, final false
inline void AnimateScoreDiff(int32_t  scoreDiff) ;

/// @brief Method HandleNewLeaderWasSelected, addr 0x3b24ee8, size 0xc0, virtual false, abstract: false, final false
inline void HandleNewLeaderWasSelected(::StringW  userId) ;

static inline ::GlobalNamespace::MultiplayerScoreDiffText* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b24a14, size 0x10c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetHorizontalPositionRelativeToLocalPlayer, addr 0x3b24b20, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x3b248bc, size 0x158, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method <AnimateHide>b__18_0, addr 0x3b2502c, size 0x30, virtual false, abstract: false, final false
inline void _AnimateHide_b__18_0() ;

/// @brief Method <AnimateScoreDiff>b__17_0, addr 0x3b25020, size 0xc, virtual false, abstract: false, final false
inline void _AnimateScoreDiff_b__17_0() ;

/// @brief Method <Start>b__14_0, addr 0x3b24fc4, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b24fa8, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;
