...
static __declspec(property(get=getStaticF___9__1_0, put=setStaticF___9__1_0)) ::System::Func_2<::GlobalNamespace::ISortedList_1<TBase>*,::System::Collections::Generic::LinkedListNode_1<TBase>*>*  __9__1_0;
...
/// @brief Field _itemToNodeMap, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__itemToNodeMap, put=__cordl_internal_set__itemToNodeMap)) ::System::Collections::Generic::Dictionary_2<TBase,::System::Collections::Generic::LinkedListNode_1<TBase>*>*  _itemToNodeMap;

/// @brief Field _items, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__items, put=__cordl_internal_set__items)) ::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::System::Type*,int32_t>,::GlobalNamespace::ISortedList_1<TBase>*>*  _items;

/// @brief Field _sortedListsDataProcessors, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__sortedListsDataProcessors, put=__cordl_internal_set__sortedListsDataProcessors)) ::System::Collections::Generic::Dictionary_2<::System::Type*,::GlobalNamespace::ISortedListItemProcessor_1<TBase>*>*  _sortedListsDataProcessors;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<TBase,::System::Collections::Generic::LinkedListNode_1<TBase>*>*> const& __cordl_internal_get__itemToNodeMap() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::System::Type*,int32_t>,::GlobalNamespace::ISortedList_1<TBase>*>*> const& __cordl_internal_get__items() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::Type*,::GlobalNamespace::ISortedListItemProcessor_1<TBase>*>*> const& __cordl_internal_get__sortedListsDataProcessors() const;
