...
/// @brief Method .ctor, addr 0x39442ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_id, addr 0x39442a4, size 0x8, virtual true, abstract: false, final true
