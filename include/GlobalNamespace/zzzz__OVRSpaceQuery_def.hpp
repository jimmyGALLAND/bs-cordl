...
static __declspec(property(get=getStaticF_ComponentTypes, put=setStaticF_ComponentTypes)) ::ArrayW<::GlobalNamespace::__OVRPlugin__SpaceComponentType,::Array<::GlobalNamespace::__OVRPlugin__SpaceComponentType>*>  ComponentTypes;
...
/// @brief Method ToQueryInfo, addr 0x3f83af4, size 0x368, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRPlugin__SpaceQueryInfo ToQueryInfo() ;

/// @brief Method TryQuerySpaces, addr 0x3f83e5c, size 0x178, virtual false, abstract: false, final false
inline bool TryQuerySpaces(ByRef<uint64_t>  requestId) ;

/// @brief Method ValidateSingleFilter, addr 0x3f8382c, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f83a68, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method get_ActionType, addr 0x3f837a4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRPlugin__SpaceQueryActionType get_ActionType() ;

/// @brief Method get_ComponentFilter, addr 0x3f837b4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRPlugin__SpaceComponentType get_ComponentFilter() ;

/// @brief Method get_Location, addr 0x3f83784, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRSpace__StorageLocation get_Location() ;

/// @brief Method get_MaxResults, addr 0x3f83764, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxResults() ;

/// @brief Method get_QueryType, addr 0x3f83794, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRPlugin__SpaceQueryType get_QueryType() ;

/// @brief Method get_Timeout, addr 0x3f83774, size 0x8, virtual false, abstract: false, final false
inline double_t get_Timeout() ;

/// @brief Method get_UuidFilter, addr 0x3f83884, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_ActionType, addr 0x3f837ac, size 0x8, virtual false, abstract: false, final false
inline void set_ActionType(::GlobalNamespace::__OVRPlugin__SpaceQueryActionType  value) ;

/// @brief Method set_ComponentFilter, addr 0x3f837bc, size 0x70, virtual false, abstract: false, final false
inline void set_ComponentFilter(::GlobalNamespace::__OVRPlugin__SpaceComponentType  value) ;

/// @brief Method set_Location, addr 0x3f8378c, size 0x8, virtual false, abstract: false, final false
inline void set_Location(::GlobalNamespace::__OVRSpace__StorageLocation  value) ;

/// @brief Method set_MaxResults, addr 0x3f8376c, size 0x8, virtual false, abstract: false, final false
inline void set_MaxResults(int32_t  value) ;

/// @brief Method set_QueryType, addr 0x3f8379c, size 0x8, virtual false, abstract: false, final false
inline void set_QueryType(::GlobalNamespace::__OVRPlugin__SpaceQueryType  value) ;

/// @brief Method set_Timeout, addr 0x3f8377c, size 0x8, virtual false, abstract: false, final false
inline void set_Timeout(double_t  value) ;

/// @brief Method set_UuidFilter, addr 0x3f8388c, size 0x1dc, virtual false, abstract: false, final false
