...
/// @brief Method .ctor, addr 0x3a4da80, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Awake, addr 0x3a4d078, size 0x84, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ComputeDSPTimes, addr 0x3a4d2c8, size 0xac, virtual false, abstract: false, final false
inline void ComputeDSPTimes(double_t  noteDSPTime, float_t  aheadTime, float_t  timeToPrevNote, float_t  timeToNextNote) ;

/// @brief Method Init, addr 0x3a4d11c, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method NoteDidStartDissolving, addr 0x3a4d980, size 0x7c, virtual false, abstract: false, final false
inline void NoteDidStartDissolving(::GlobalNamespace::NoteControllerBase*  noteController) ;

/// @brief Method NoteWasCut, addr 0x3a4d774, size 0x20c, virtual false, abstract: false, final false
inline void NoteWasCut(::GlobalNamespace::NoteController*  noteController, ByRef<::GlobalNamespace::NoteCutInfo>  noteCutInfo) ;

/// @brief Method OnLateUpdate, addr 0x3a4d374, size 0x210, virtual false, abstract: false, final false
inline void OnLateUpdate() ;

/// @brief Method Start, addr 0x3a4d0fc, size 0x20, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StopPlayingAndFinish, addr 0x3a4d584, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a4d9fc, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_didFinishEvent, addr 0x3a4d034, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::INoteCutSoundEffectDidFinishEvent*>* get_didFinishEvent() ;

/// @brief Method get_time, addr 0x3a4d04c, size 0x2c, virtual false, abstract: false, final false
inline float_t get_time() ;

/// @brief Method get_volumeMultiplier, addr 0x3a4d044, size 0x8, virtual false, abstract: false, final false
inline float_t get_volumeMultiplier() ;

/// @brief Method set_volumeMultiplier, addr 0x3a4d03c, size 0x8, virtual false, abstract: false, final false
