...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x3a5bc84, size 0xfc, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginInvoke(::GlobalNamespace::NoteData*  noteData, ByRef<::GlobalNamespace::__BeatmapObjectSpawnMovementData__NoteSpawnData>  noteSpawnData, float_t  rotation, bool  forceIsFirstNote, ::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x3a5bd80, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method Invoke, addr 0x3a5bc6c, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a5bb68, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method BezierCurve, addr 0x3a5b6d4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method ProcessSliderData, addr 0x3a5b74c, size 0x41c, virtual false, abstract: false, final false
static inline void ProcessSliderData(::GlobalNamespace::SliderData*  sliderData, ByRef<::GlobalNamespace::__BeatmapObjectSpawnMovementData__SliderSpawnData>  sliderSpawnData, float_t  rotation, bool  forceIsFirstNote, ::GlobalNamespace::__BurstSliderSpawner__ProcessNoteDataDelegate*  processNoteData) ;
