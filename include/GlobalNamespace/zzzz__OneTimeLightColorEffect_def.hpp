...
/// @brief Method Update, addr 0x3af03e8, size 0x5c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3af0444, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
