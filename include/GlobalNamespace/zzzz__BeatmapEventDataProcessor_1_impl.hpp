...
template<typename T>
constexpr ::GlobalNamespace::ISortedListItemProcessor_1<::GlobalNamespace::BeatmapDataItem*>* GlobalNamespace::BeatmapEventDataProcessor_1<T>::i___GlobalNamespace__ISortedListItemProcessor_1___GlobalNamespace__BeatmapDataItem__() noexcept {
return static_cast<::GlobalNamespace::ISortedListItemProcessor_1<::GlobalNamespace::BeatmapDataItem*>*>(static_cast<void*>(this));
}
template<typename T>
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::BeatmapEventDataProcessor_1<T>::BeatmapEventDataProcessor_1()   {
}
