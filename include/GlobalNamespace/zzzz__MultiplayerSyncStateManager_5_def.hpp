...
/// @brief Field _connectedPlayerStates, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__connectedPlayerStates, put=__cordl_internal_set__connectedPlayerStates)) ::System::Collections::Generic::List_1<::GlobalNamespace::RemoteMultiplayerSyncState_3<TStateTable,TType,TState>*>*  _connectedPlayerStates;

/// @brief Field _disconnectedPlayerStates, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__disconnectedPlayerStates, put=__cordl_internal_set__disconnectedPlayerStates)) ::System::Collections::Generic::List_1<::GlobalNamespace::RemoteMultiplayerSyncState_3<TStateTable,TType,TState>*>*  _disconnectedPlayerStates;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::RemoteMultiplayerSyncState_3<TStateTable,TType,TState>*>*> const& __cordl_internal_get__connectedPlayerStates() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::RemoteMultiplayerSyncState_3<TStateTable,TType,TState>*>*> const& __cordl_internal_get__disconnectedPlayerStates() const;
