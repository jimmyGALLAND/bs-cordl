...
/// @brief Method .ctor, addr 0x3b05820, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_id, addr 0x3b05810, size 0x8, virtual false, abstract: false, final false
inline int32_t get_id() ;

/// @brief Method get_videoAssetReference, addr 0x3b05818, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _videoClipsWithId, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__videoClipsWithId, put=__cordl_internal_set__videoClipsWithId)) ::ArrayW<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*,::Array<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*>*>  _videoClipsWithId;

 __declspec(property(get=get_videoClipWithIds)) ::ArrayW<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*,::Array<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*>*>  videoClipWithIds;

static inline ::GlobalNamespace::VideoProjectionDataModelSO* New_ctor() ;

constexpr ::ArrayW<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*,::Array<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*>*> const& __cordl_internal_get__videoClipsWithId() const;

constexpr ::ArrayW<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*,::Array<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*>*>& __cordl_internal_get__videoClipsWithId() ;

constexpr void __cordl_internal_set__videoClipsWithId(::ArrayW<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*,::Array<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*>*>  value) ;

/// @brief Method .ctor, addr 0x3b05808, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_videoClipWithIds, addr 0x3b05800, size 0x8, virtual false, abstract: false, final false
