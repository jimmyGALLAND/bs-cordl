...
/// @brief Method HandleDropDownDidSelectCellWithIdx, addr 0x3b63c24, size 0x190, virtual false, abstract: false, final false
inline void HandleDropDownDidSelectCellWithIdx(::HMUI::DropdownWithTableView*  dropDownWithTableView, int32_t  idx) ;

/// @brief Method HandleEditColorSchemeButtonWasPressed, addr 0x3b64010, size 0x80, virtual false, abstract: false, final false
inline void HandleEditColorSchemeButtonWasPressed() ;

/// @brief Method HandleEditColorSchemeControllerDidChangeColorScheme, addr 0x3b640fc, size 0x2c, virtual false, abstract: false, final false
inline void HandleEditColorSchemeControllerDidChangeColorScheme(::GlobalNamespace::ColorScheme*  colorScheme) ;

/// @brief Method HandleEditColorSchemeControllerDidFinish, addr 0x3b640a8, size 0x54, virtual false, abstract: false, final false
inline void HandleEditColorSchemeControllerDidFinish() ;

/// @brief Method HandleOverrideColorsToggleValueChanged, addr 0x3b63db4, size 0x25c, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b6369c, size 0x22c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x3b63a14, size 0x28, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3b63a3c, size 0x10, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Refresh, addr 0x3b63a4c, size 0x1d8, virtual true, abstract: false, final true
inline void Refresh() ;

/// @brief Method SetData, addr 0x3b632fc, size 0x254, virtual false, abstract: false, final false
inline void SetData(::GlobalNamespace::ColorSchemesSettings*  colorSchemesSettings) ;

/// @brief Method <HandleOverrideColorsToggleValueChanged>b__19_0, addr 0x3b64130, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b64128, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
