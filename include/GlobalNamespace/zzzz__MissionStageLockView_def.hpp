...
/// @brief Method Update, addr 0x3b76800, size 0xd0, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateLocalPositionY, addr 0x3b7679c, size 0x64, virtual false, abstract: false, final false
inline void UpdateLocalPositionY(float_t  dstPosY, bool  animated, float_t  animationDuration) ;

/// @brief Method UpdateStageLockText, addr 0x3b768d0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b768f4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
