...
/// @brief Method LateUpdate, addr 0x3aeeffc, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aef028, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
