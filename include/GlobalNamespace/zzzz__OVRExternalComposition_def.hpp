...
/// @brief Method CacheAudioData, addr 0x3f0aa54, size 0x138, virtual false, abstract: false, final false
inline void CacheAudioData(::ArrayW<float_t,::Array<float_t>*>  data, int32_t  channels) ;

/// @brief Method CastMrcFrame, addr 0x3f09518, size 0x1e4, virtual false, abstract: false, final false
inline int32_t CastMrcFrame(int32_t  castTextureIndex) ;

/// @brief Method Cleanup, addr 0x3f0a870, size 0x1e4, virtual true, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CleanupAudioFilter, addr 0x3f093d4, size 0x144, virtual false, abstract: false, final false
inline void CleanupAudioFilter() ;

/// @brief Method CompositionMethod, addr 0x3f07c90, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::__OVRManager__CompositionMethod CompositionMethod() ;

/// @brief Method DisplayRefreshRateChanged, addr 0x3f0ab8c, size 0x14, virtual false, abstract: false, final false
inline void DisplayRefreshRateChanged(float_t  fromRefreshRate, float_t  toRefreshRate) ;

/// @brief Method GetAndResetAudioData, addr 0x3f096fc, size 0x1dc, virtual false, abstract: false, final false
...
/// @brief Method RefreshAudioFilter, addr 0x3f08e04, size 0x5d0, virtual false, abstract: false, final false
inline void RefreshAudioFilter(::UnityEngine::Camera*  mainCamera) ;

/// @brief Method RefreshCameraObjects, addr 0x3f08290, size 0xb74, virtual false, abstract: false, final false
...
/// @brief Method SetCameraTargetTexture, addr 0x3f098d8, size 0x1e0, virtual false, abstract: false, final false
inline void SetCameraTargetTexture(int32_t  drawTextureIndex) ;

/// @brief Method Update, addr 0x3f09ab8, size 0xca4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f07c98, size 0x5a8, virtual false, abstract: false, final false
