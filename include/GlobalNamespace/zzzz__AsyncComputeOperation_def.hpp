...
/// @brief Method .ctor, addr 0x226cf60, size 0x84, virtual false, abstract: false, final false
inline void _ctor(int32_t  timeoutMs) ;

/// @brief Method get_elapsedTime, addr 0x226ceac, size 0x84, virtual false, abstract: false, final false
inline double_t get_elapsedTime() ;

/// @brief Method get_hasTimedOut, addr 0x226cf30, size 0x30, virtual false, abstract: false, final false
