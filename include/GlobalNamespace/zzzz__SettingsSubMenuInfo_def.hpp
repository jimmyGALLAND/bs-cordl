...
/// @brief Method .ctor, addr 0x3b85f78, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_localizedMenuName, addr 0x3b85f6c, size 0xc, virtual false, abstract: false, final false
inline ::StringW get_localizedMenuName() ;

/// @brief Method get_viewController, addr 0x3b85f64, size 0x8, virtual false, abstract: false, final false
