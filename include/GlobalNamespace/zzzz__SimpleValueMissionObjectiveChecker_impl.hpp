...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleValueMissionObjectiveChecker::*)()>(&::GlobalNamespace::SimpleValueMissionObjectiveChecker::CheckAndUpdateStatus)> {
  constexpr static std::size_t size = 0x104;
  constexpr static std::size_t addrs = 0x3b1cc94;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleValueMissionObjectiveChecker::*)()>(&::GlobalNamespace::SimpleValueMissionObjectiveChecker::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3b1cda0;
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::SimpleValueMissionObjectiveChecker*>());
}
