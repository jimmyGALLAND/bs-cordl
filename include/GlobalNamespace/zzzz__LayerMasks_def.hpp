...
/// @brief Method GetLayer, addr 0x26554a0, size 0x8, virtual false, abstract: false, final false
static inline int32_t GetLayer(::StringW  layerName) ;

/// @brief Method GetLayerMask, addr 0x2655448, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::LayerMask GetLayerMask(::StringW  layerName) ;

/// @brief Method GetLayerMask, addr 0x2655478, size 0x28, virtual false, abstract: false, final false
static inline ::UnityEngine::LayerMask GetLayerMask(int32_t  layerNum) ;

static inline ::GlobalNamespace::LayerMasks* New_ctor() ;

/// @brief Method .ctor, addr 0x26554a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
