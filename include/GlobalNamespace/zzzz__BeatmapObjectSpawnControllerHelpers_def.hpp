...
public:
// Declarations
/// @brief Method GetNoteJumpValues, addr 0x3a5abb8, size 0x38, virtual false, abstract: false, final false
static inline void GetNoteJumpValues(::GlobalNamespace::PlayerSpecificSettings*  playerSpecificSettings, float_t  defaultNoteJumpStartBeatOffset, ByRef<::GlobalNamespace::__BeatmapObjectSpawnMovementData__NoteJumpValueType>  noteJumpValueType, ByRef<float_t>  noteJumpValue) ;
