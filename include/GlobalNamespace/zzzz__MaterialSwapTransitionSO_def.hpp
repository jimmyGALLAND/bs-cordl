...
/// @brief Method .ctor, addr 0x444797c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disabledMaterial, addr 0x4447964, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_disabledMaterial() ;

/// @brief Method get_highlightedMaterial, addr 0x4447954, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_highlightedMaterial() ;

/// @brief Method get_normalMaterial, addr 0x444794c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_normalMaterial() ;

/// @brief Method get_pressedMaterial, addr 0x444795c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_pressedMaterial() ;

/// @brief Method get_selectedAndHighlightedMaterial, addr 0x4447974, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_selectedAndHighlightedMaterial() ;

/// @brief Method get_selectedMaterial, addr 0x444796c, size 0x8, virtual false, abstract: false, final false
