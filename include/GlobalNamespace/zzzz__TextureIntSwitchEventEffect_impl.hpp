...
// Ctor Parameters [CppParam { name: "value", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "texture", ty: "::UnityW<::UnityEngine::Texture>", modifiers: "", def_value: Some("nullptr") }]
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TextureIntSwitchEventEffect::*)()>(&::GlobalNamespace::TextureIntSwitchEventEffect::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x3b05378;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TextureIntSwitchEventEffect::*)(::GlobalNamespace::BasicBeatmapEventData*)>(&::GlobalNamespace::TextureIntSwitchEventEffect::HandleBasicBeatmapEventData)> {
  ...
  constexpr static std::size_t addrs = 0x3b05394;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TextureIntSwitchEventEffect::*)()>(&::GlobalNamespace::TextureIntSwitchEventEffect::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3b053ac;
...
constexpr ::ArrayW<::GlobalNamespace::__TextureIntSwitchEventEffect__TextureValueTuple,::Array<::GlobalNamespace::__TextureIntSwitchEventEffect__TextureValueTuple>*>& GlobalNamespace::TextureIntSwitchEventEffect::__cordl_internal_get__textureValueTuples()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____textureValueTuples;
}
constexpr ::ArrayW<::GlobalNamespace::__TextureIntSwitchEventEffect__TextureValueTuple,::Array<::GlobalNamespace::__TextureIntSwitchEventEffect__TextureValueTuple>*> const& GlobalNamespace::TextureIntSwitchEventEffect::__cordl_internal_get__textureValueTuples() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____textureValueTuples;
}
constexpr void GlobalNamespace::TextureIntSwitchEventEffect::__cordl_internal_set__textureValueTuples(::ArrayW<::GlobalNamespace::__TextureIntSwitchEventEffect__TextureValueTuple,::Array<::GlobalNamespace::__TextureIntSwitchEventEffect__TextureValueTuple>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapCallbacksController*> const& GlobalNamespace::TextureIntSwitchEventEffect::__cordl_internal_get__beatmapCallbacksController() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____beatmapCallbacksController;
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapDataCallbackWrapper*> const& GlobalNamespace::TextureIntSwitchEventEffect::__cordl_internal_get__beatmapDataCallbackWrapper() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____beatmapDataCallbackWrapper;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::UnityEngine::Texture>>*> const& GlobalNamespace::TextureIntSwitchEventEffect::__cordl_internal_get__valueToTextureMap() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____valueToTextureMap;
}
