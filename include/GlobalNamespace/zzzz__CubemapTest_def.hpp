...
/// @brief Field _downsampledCubemapRenderTexture, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__downsampledCubemapRenderTexture, put=__cordl_internal_set__downsampledCubemapRenderTexture)) ::UnityW<::UnityEngine::RenderTexture>  _downsampledCubemapRenderTexture;
...
/// @brief Method Start, addr 0x3a8b4c0, size 0x7c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3a8b53c, size 0x210, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3a8b74c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
