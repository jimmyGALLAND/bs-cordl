...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::JoiningLobbyViewController::*)(::System::Action*)>(&::GlobalNamespace::JoiningLobbyViewController::add_didCancelEvent)> {
  constexpr static std::size_t size = 0x9c;
  constexpr static std::size_t addrs = 0x3b897dc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::JoiningLobbyViewController::*)(::System::Action*)>(&::GlobalNamespace::JoiningLobbyViewController::remove_didCancelEvent)> {
  constexpr static std::size_t size = 0x9c;
  constexpr static std::size_t addrs = 0x3b89878;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::JoiningLobbyViewController::*)(::StringW)>(&::GlobalNamespace::JoiningLobbyViewController::Init)> {
  constexpr static std::size_t size = 0x34;
  constexpr static std::size_t addrs = 0x3b89914;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::JoiningLobbyViewController::*)()>(&::GlobalNamespace::JoiningLobbyViewController::HideLoading)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x3b89948;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::JoiningLobbyViewController::*)(bool, bool, bool)>(&::GlobalNamespace::JoiningLobbyViewController::DidActivate)> {
  constexpr static std::size_t size = 0xc4;
  constexpr static std::size_t addrs = 0x3b89988;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::JoiningLobbyViewController::*)()>(&::GlobalNamespace::JoiningLobbyViewController::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3b89a4c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::JoiningLobbyViewController::*)()>(&::GlobalNamespace::JoiningLobbyViewController::_DidActivate_b__8_0)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x3b89a54;
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____cancelJoiningButton)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> const& GlobalNamespace::JoiningLobbyViewController::__cordl_internal_get_didCancelEvent() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___didCancelEvent;
}
constexpr void GlobalNamespace::JoiningLobbyViewController::__cordl_internal_set_didCancelEvent(::System::Action*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->___didCancelEvent)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::JoiningLobbyViewController*>());
}
