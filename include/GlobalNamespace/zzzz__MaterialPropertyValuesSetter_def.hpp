...
/// @brief Method RefreshPropertyId, addr 0x39637ec, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3963824, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_propertyId, addr 0x3963814, size 0x8, virtual false, abstract: false, final false
inline int32_t get_propertyId() ;

/// @brief Method set_propertyId, addr 0x396381c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x396384c, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x3963874, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x396389c, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x39638c4, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _colors, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__colors, put=__cordl_internal_set__colors)) ::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameColorValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameColorValuePair*>*>  _colors;

/// @brief Field _floats, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__floats, put=__cordl_internal_set__floats)) ::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameFloatValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameFloatValuePair*>*>  _floats;

/// @brief Field _ints, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__ints, put=__cordl_internal_set__ints)) ::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameIntValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameIntValuePair*>*>  _ints;
...
/// @brief Field _vectors, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__vectors, put=__cordl_internal_set__vectors)) ::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameVectorValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameVectorValuePair*>*>  _vectors;

/// @brief Method ApplyParams, addr 0x39635b0, size 0x1a4, virtual false, abstract: false, final false
inline void ApplyParams() ;

static inline ::GlobalNamespace::MaterialPropertyValuesSetter* New_ctor() ;

/// @brief Method OnValidate, addr 0x3963754, size 0x98, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method RefreshPropertyIds, addr 0x3963458, size 0x158, virtual false, abstract: false, final false
inline void RefreshPropertyIds() ;

/// @brief Method Start, addr 0x3963440, size 0x18, virtual false, abstract: false, final false
inline void Start() ;

constexpr ::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameColorValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameColorValuePair*>*> const& __cordl_internal_get__colors() const;

constexpr ::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameColorValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameColorValuePair*>*>& __cordl_internal_get__colors() ;

constexpr ::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameFloatValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameFloatValuePair*>*> const& __cordl_internal_get__floats() const;

constexpr ::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameFloatValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameFloatValuePair*>*>& __cordl_internal_get__floats() ;

constexpr ::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameIntValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameIntValuePair*>*> const& __cordl_internal_get__ints() const;

constexpr ::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameIntValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameIntValuePair*>*>& __cordl_internal_get__ints() ;
...
constexpr ::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameVectorValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameVectorValuePair*>*> const& __cordl_internal_get__vectors() const;

constexpr ::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameVectorValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameVectorValuePair*>*>& __cordl_internal_get__vectors() ;

constexpr void __cordl_internal_set__colors(::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameColorValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameColorValuePair*>*>  value) ;

constexpr void __cordl_internal_set__floats(::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameFloatValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameFloatValuePair*>*>  value) ;

constexpr void __cordl_internal_set__ints(::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameIntValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameIntValuePair*>*>  value) ;

constexpr void __cordl_internal_set__materialPropertyBlockController(::UnityW<::GlobalNamespace::MaterialPropertyBlockController>  value) ;

constexpr void __cordl_internal_set__vectors(::ArrayW<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameVectorValuePair*,::Array<::GlobalNamespace::__MaterialPropertyValuesSetter__PropertyNameVectorValuePair*>*>  value) ;

/// @brief Method .ctor, addr 0x396380c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
