...
// Type: ::<Post>d__5`1
// SizeInfo { instance_size: 96, native_size: 112, calculated_instance_size: 96, calculated_native_size: 112, minimum_alignment: 8, packing: None, specified_packing: None }
namespace GlobalNamespace {
// cpp template
template<typename TResponse>
// Is value type: true
...
/// @brief Method CalculateDelayMsBeforeRetry, addr 0x227f52c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x227f4b8, size 0x74, virtual false, abstract: false, final false
