...
/// @brief Method Start, addr 0x3942a34, size 0x2d8, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3942d0c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
