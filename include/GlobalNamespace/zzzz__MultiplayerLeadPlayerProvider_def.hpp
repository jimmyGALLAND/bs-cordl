...
/// @brief Field _currentlyDisplayedUser, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__currentlyDisplayedUser, put=__cordl_internal_set__currentlyDisplayedUser)) ::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*  _currentlyDisplayedUser;

/// @brief Field _currentlyLeadingUser, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__currentlyLeadingUser, put=__cordl_internal_set__currentlyLeadingUser)) ::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*  _currentlyLeadingUser;
...
/// @brief Method HandleFirstPlayerDidChange, addr 0x3b40728, size 0xe8, virtual false, abstract: false, final false
inline void HandleFirstPlayerDidChange(::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*  firstPlayer) ;

/// @brief Method HandleStateChanged, addr 0x3b40284, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b40294, size 0x15c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b401c8, size 0xbc, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartProviding, addr 0x3b40688, size 0xa0, virtual false, abstract: false, final false
inline void StartProviding() ;

/// @brief Method StopProviding, addr 0x3b405ec, size 0x9c, virtual false, abstract: false, final false
inline void StopProviding() ;

/// @brief Method Update, addr 0x3b404a0, size 0x94, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b40910, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_newLeaderWasSelectedEvent, addr 0x3b3c580, size 0xb0, virtual false, abstract: false, final false
inline void add_newLeaderWasSelectedEvent(::System::Action_1<::StringW>*  value) ;

/// @brief Method remove_newLeaderWasSelectedEvent, addr 0x3b3c374, size 0xb0, virtual false, abstract: false, final false
