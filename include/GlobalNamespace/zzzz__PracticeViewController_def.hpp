...
/// @brief Method MoveNext, addr 0x3b8e038, size 0x4a0, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3b8e4d8, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method CancelSongLoading, addr 0x3b8da64, size 0x2c, virtual false, abstract: false, final false
inline void CancelSongLoading() ;

/// @brief Method DidActivate, addr 0x3b8db00, size 0x168, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3b8dd3c, size 0xac, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method GetSongTime, addr 0x3b8debc, size 0x4c, virtual false, abstract: false, final false
inline float_t GetSongTime() ;

/// @brief Method HandlePlayButtonPressed, addr 0x3b8dfbc, size 0x74, virtual false, abstract: false, final false
inline void HandlePlayButtonPressed() ;

/// @brief Method HandleSongStartSliderValueDidChange, addr 0x3b8df88, size 0x34, virtual false, abstract: false, final false
inline void HandleSongStartSliderValueDidChange(::HMUI::RangeValuesTextSlider*  slider, float_t  value) ;

/// @brief Method Init, addr 0x3b8d928, size 0x13c, virtual false, abstract: false, final false
inline void Init(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey, ::GlobalNamespace::BeatmapLevel*  beatmapLevel) ;

/// @brief Method LoadSong, addr 0x3b8dc68, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method PlayPreview, addr 0x3b8dde8, size 0xd4, virtual false, abstract: false, final false
inline void PlayPreview() ;

/// @brief Method SetLoader, addr 0x3b8df08, size 0x80, virtual false, abstract: false, final false
inline void SetLoader(bool  loading) ;

/// @brief Method SetSongLength, addr 0x3b8da90, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b8e030, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didPressPlayButtonEvent, addr 0x3b8d7e8, size 0x9c, virtual false, abstract: false, final false
inline void add_didPressPlayButtonEvent(::System::Action*  value) ;

/// @brief Method get_practiceSettings, addr 0x3b8d920, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::PracticeSettings* get_practiceSettings() ;

/// @brief Method remove_didPressPlayButtonEvent, addr 0x3b8d884, size 0x9c, virtual false, abstract: false, final false
