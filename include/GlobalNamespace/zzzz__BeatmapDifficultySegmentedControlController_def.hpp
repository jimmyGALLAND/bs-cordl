...
/// @brief Method Awake, addr 0x3ac9440, size 0x90, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetClosestDifficultyIndex, addr 0x3ac95a0, size 0x14c, virtual false, abstract: false, final false
inline int32_t GetClosestDifficultyIndex(::GlobalNamespace::BeatmapDifficulty  searchDifficulty) ;

/// @brief Method HandleDifficultySegmentedControlDidSelectCell, addr 0x3ac96ec, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3ac94d0, size 0xd0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetData, addr 0x3ac9774, size 0x4f4, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::BeatmapDifficultySegmentedControlController>,::GlobalNamespace::BeatmapDifficulty>*> const& __cordl_internal_get_didSelectDifficultyEvent() const;
...
/// @brief Method .ctor, addr 0x3ac9c68, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didSelectDifficultyEvent, addr 0x3ac92d8, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_selectedDifficulty, addr 0x3ac9438, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapDifficulty get_selectedDifficulty() ;

/// @brief Method remove_didSelectDifficultyEvent, addr 0x3ac9388, size 0xb0, virtual false, abstract: false, final false
