...
/// @brief Method Awake, addr 0x3aa13c0, size 0x80, virtual false, abstract: false, final false
inline void Awake() ;
...
/// @brief Method .ctor, addr 0x3aa1440, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
