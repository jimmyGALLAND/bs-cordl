...
/// @brief Method Awake, addr 0x39576d4, size 0x164, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CreateMesh, addr 0x3957934, size 0x2bc, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> CreateMesh() ;

/// @brief Method InitIfNeeded, addr 0x3957838, size 0xfc, virtual false, abstract: false, final false
inline void InitIfNeeded() ;

static inline ::GlobalNamespace::Parametric3SliceSpriteController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3957ca0, size 0xc4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x3957c80, size 0x20, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3957c60, size 0x20, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Refresh, addr 0x3957d64, size 0x208, virtual false, abstract: false, final false
inline void Refresh() ;

/// @brief Method Start, addr 0x3957bf0, size 0x70, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3957f6c, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_collisionLength, addr 0x39576c4, size 0x8, virtual false, abstract: false, final false
inline float_t get_collisionLength() ;

/// @brief Method get_useCollision, addr 0x39576b0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_collisionLength, addr 0x39576cc, size 0x8, virtual false, abstract: false, final false
inline void set_collisionLength(float_t  value) ;

/// @brief Method set_useCollision, addr 0x39576b8, size 0xc, virtual false, abstract: false, final false
