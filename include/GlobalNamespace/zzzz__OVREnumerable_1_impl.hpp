...
template<typename T>
constexpr ::GlobalNamespace::__OVREnumerable_1__Enumerator__CollectionType<T>::__OVREnumerable_1__Enumerator__CollectionType(int32_t  value__) noexcept  {
this->value__ = value__;
}
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::__OVREnumerable_1__Enumerator__CollectionType<T>::__OVREnumerable_1__Enumerator__CollectionType()   {
}
template<typename T>
...
template<typename T>
constexpr ::System::Collections::Generic::IEnumerator_1<T>* GlobalNamespace::__OVREnumerable_1__Enumerator<T>::i___System__Collections__Generic__IEnumerator_1_T_()  {
return static_cast<::System::Collections::Generic::IEnumerator_1<T>*>(static_cast<void*>(::il2cpp_utils::Box(this)));
}
...
template<typename T>
constexpr ::System::Collections::IEnumerator* GlobalNamespace::__OVREnumerable_1__Enumerator<T>::i___System__Collections__IEnumerator()  {
return static_cast<::System::Collections::IEnumerator*>(static_cast<void*>(::il2cpp_utils::Box(this)));
}
...
template<typename T>
constexpr ::System::IDisposable* GlobalNamespace::__OVREnumerable_1__Enumerator<T>::i___System__IDisposable()  {
return static_cast<::System::IDisposable*>(static_cast<void*>(::il2cpp_utils::Box(this)));
}
template<typename T>
...
// Ctor Parameters [CppParam { name: "_listIndex", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "_type", ty: "::GlobalNamespace::__OVREnumerable_1__Enumerator__CollectionType<T>", modifiers: "", def_value: Some("{}") }, CppParam { name: "_listCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "_enumerator", ty: "::System::Collections::Generic::IEnumerator_1<T>*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "_list", ty: "::System::Collections::Generic::IReadOnlyList_1<T>*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "_setEnumerator", ty: "::System::Collections::Generic::__HashSet_1__Enumerator<T>", modifiers: "", def_value: Some("{}") }, CppParam { name: "_queueEnumerator", ty: "::System::Collections::Generic::__Queue_1__Enumerator<T>", modifiers: "", def_value: Some("{}") }]
template<typename T>
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::__OVREnumerable_1__Enumerator<T>::__OVREnumerable_1__Enumerator()   {
}
