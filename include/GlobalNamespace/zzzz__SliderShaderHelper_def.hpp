...
static __declspec(property(get=getStaticF_tailHeadNoteJumpOffsetDifferencePropertyId, put=setStaticF_tailHeadNoteJumpOffsetDifferencePropertyId)) int32_t  tailHeadNoteJumpOffsetDifferencePropertyId;
...
/// @brief Method EnableSaberAttraction, addr 0x3ae748c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method SetColor, addr 0x3ae7514, size 0x9c, virtual false, abstract: false, final false
static inline void SetColor(::UnityEngine::MaterialPropertyBlock*  materialPropertyBlock, ::UnityEngine::Color  color) ;

/// @brief Method SetInitialProperties, addr 0x3ae75b0, size 0x25c, virtual false, abstract: false, final false
...
/// @brief Method SetInitialProperties, addr 0x3ae780c, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method SetSaberAttractionPoint, addr 0x3ae73f4, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method SetTailHeadNoteJumpOffsetDifference, addr 0x3ae7378, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method SetTimeSinceHeadNoteJump, addr 0x3ae72fc, size 0x7c, virtual false, abstract: false, final false
static inline void SetTimeSinceHeadNoteJump(::UnityEngine::MaterialPropertyBlock*  materialPropertyBlock, float_t  time) ;

/// @brief Method UpdateMaterialPropertyBlock, addr 0x3ae7938, size 0x16c, virtual false, abstract: false, final false
