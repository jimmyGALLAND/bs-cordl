...
/// @brief Field _noteTrailParticleSystem, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__noteTrailParticleSystem, put=__cordl_internal_set__noteTrailParticleSystem)) ::UnityW<::GlobalNamespace::NoteTrailParticleSystem>  _noteTrailParticleSystem;
...
/// @brief Method Awake, addr 0x3b01158, size 0xf8, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleNoteDidStartJump, addr 0x3b013e4, size 0xc, virtual false, abstract: false, final false
inline void HandleNoteDidStartJump() ;

/// @brief Method HandleNoteMovementDidInit, addr 0x3b013d8, size 0xc, virtual false, abstract: false, final false
inline void HandleNoteMovementDidInit() ;

static inline ::GlobalNamespace::NoteTrailEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b01250, size 0x124, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Update, addr 0x3b01374, size 0x64, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b013f0, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
