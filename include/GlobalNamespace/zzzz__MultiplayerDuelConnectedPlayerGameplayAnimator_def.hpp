...
/// @brief Method AnimateNewLeaderSelected, addr 0x3b246cc, size 0xdc, virtual true, abstract: false, final false
inline void AnimateNewLeaderSelected(bool  isLeading) ;

/// @brief Method HandlePlayerDidFail, addr 0x3b248b0, size 0x4, virtual false, abstract: false, final false
inline void HandlePlayerDidFail() ;

/// @brief Method HandleStateChanged, addr 0x3b247a8, size 0x108, virtual true, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b24520, size 0xd8, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method TransitionIntoFailedState, addr 0x3b245f8, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b248b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
