...
/// @brief Field levelCategory, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_levelCategory, put=__cordl_internal_set_levelCategory)) ::System::Nullable_1<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>  levelCategory;
...
static inline ::GlobalNamespace::__LevelSelectionFlowCoordinator__State* New_ctor(::System::Nullable_1<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>  levelCategory, ::GlobalNamespace::BeatmapLevelPack*  beatmapLevelPack, ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey, ::GlobalNamespace::BeatmapLevel*  beatmapLevel) ;
...
/// @brief Method .ctor, addr 0x3ab5620, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::BeatmapLevelPack*  beatmapLevelPack) ;

/// @brief Method .ctor, addr 0x3ab5650, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::BeatmapLevelPack*  beatmapLevelPack, ::GlobalNamespace::BeatmapLevel*  beatmapLevel) ;

/// @brief Method .ctor, addr 0x3ab55d4, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(::System::Nullable_1<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>  levelCategory, ::GlobalNamespace::BeatmapLevelPack*  beatmapLevelPack, ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey, ::GlobalNamespace::BeatmapLevel*  beatmapLevel) ;
...
/// @brief Method ActionButtonWasPressed, addr 0x3ab4c20, size 0x4, virtual true, abstract: false, final false
inline void ActionButtonWasPressed() ;

/// @brief Method DidActivate, addr 0x3ab4c34, size 0x4a8, virtual true, abstract: false, final true
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3ab50dc, size 0x294, virtual true, abstract: false, final true
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleLevelSearchViewControllerDidPressSearchButton, addr 0x3ab53f8, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method HandleLevelSelectionNavigationControllerDidChangeDifficultyBeatmap, addr 0x3ab5458, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method HandleLevelSelectionNavigationControllerDidChangeLevelDetailContent, addr 0x3ab54bc, size 0x6c, virtual true, abstract: false, final false
inline void HandleLevelSelectionNavigationControllerDidChangeLevelDetailContent(::GlobalNamespace::LevelSelectionNavigationController*  viewController, ::GlobalNamespace::__StandardLevelDetailViewController__ContentType  contentType) ;

/// @brief Method HandleLevelSelectionNavigationControllerDidPressActionButton, addr 0x3ab5438, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method HandleLevelSelectionNavigationControllerDidPressPracticeButton, addr 0x3ab5448, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method HandleLevelSelectionNavigationControllerDidSelectPack, addr 0x3ab5380, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method HandleSearchFilterParamsViewControllerDidFinish, addr 0x3ab53b0, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method IsMainViewController, addr 0x3ab5544, size 0x6c, virtual false, abstract: false, final false
inline bool IsMainViewController(::HMUI::ViewController*  viewController) ;

/// @brief Method LevelSelectionFlowCoordinatorDidActivate, addr 0x3ab4b1c, size 0x4, virtual true, abstract: false, final false
inline void LevelSelectionFlowCoordinatorDidActivate(bool  firstActivation, bool  addedToHierarchy) ;

/// @brief Method LevelSelectionFlowCoordinatorDidDeactivate, addr 0x3ab4b20, size 0x4, virtual true, abstract: false, final false
inline void LevelSelectionFlowCoordinatorDidDeactivate(bool  removedFromHierarchy) ;

/// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange, addr 0x3ab4b24, size 0xfc, virtual true, abstract: false, final false
inline void LevelSelectionFlowCoordinatorTopViewControllerWillChange(::HMUI::ViewController*  oldViewController, ::HMUI::ViewController*  newViewController, ::HMUI::__ViewController__AnimationType  animationType) ;

static inline ::GlobalNamespace::LevelSelectionFlowCoordinator* New_ctor() ;

/// @brief Method PracticeButtonWasPressed, addr 0x3ab4c24, size 0x4, virtual true, abstract: false, final false
inline void PracticeButtonWasPressed() ;

/// @brief Method PresentMainViewController, addr 0x3ab55b0, size 0x1c, virtual false, abstract: false, final false
inline void PresentMainViewController(::System::Action*  finishedCallback, ::HMUI::__ViewController__AnimationType  animationType) ;

/// @brief Method Refresh, addr 0x3ab5528, size 0x1c, virtual true, abstract: false, final false
inline void Refresh() ;

/// @brief Method SelectionDidChange, addr 0x3ab4c28, size 0x4, virtual true, abstract: false, final false
inline void SelectionDidChange(::GlobalNamespace::BeatmapLevelPack*  pack, ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method Setup, addr 0x3ab4c2c, size 0x8, virtual false, abstract: false, final false
inline void Setup(::GlobalNamespace::__LevelSelectionFlowCoordinator__State*  state) ;

/// @brief Method TopViewControllerWillChange, addr 0x3ab5370, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3ab55cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_actionButtonText, addr 0x3ab4a50, size 0x44, virtual true, abstract: false, final false
inline ::StringW get_actionButtonText() ;

/// @brief Method get_allowedBeatmapDifficultyMask, addr 0x3ab4ad0, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapDifficultyMask get_allowedBeatmapDifficultyMask() ;

/// @brief Method get_enableCustomLevels, addr 0x3ab4a9c, size 0x8, virtual true, abstract: false, final false
inline bool get_enableCustomLevels() ;

/// @brief Method get_hidePacksIfOneOrNone, addr 0x3ab4a40, size 0x8, virtual true, abstract: false, final false
inline bool get_hidePacksIfOneOrNone() ;

/// @brief Method get_hidePracticeButton, addr 0x3ab4a48, size 0x8, virtual true, abstract: false, final false
inline bool get_hidePracticeButton() ;

/// @brief Method get_initialLeftScreenViewController, addr 0x3ab4a28, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::HMUI::ViewController> get_initialLeftScreenViewController() ;

/// @brief Method get_initialRightScreenViewController, addr 0x3ab4a30, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::HMUI::ViewController> get_initialRightScreenViewController() ;

/// @brief Method get_initialTopScreenViewController, addr 0x3ab4a20, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::HMUI::ViewController> get_initialTopScreenViewController() ;

/// @brief Method get_isInRootViewController, addr 0x3ab4918, size 0x74, virtual false, abstract: false, final false
inline bool get_isInRootViewController() ;

/// @brief Method get_mainTitle, addr 0x3ab4a94, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_mainTitle() ;

/// @brief Method get_notAllowedCharacteristics, addr 0x3ab4ad8, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method get_selectedBeatmapKey, addr 0x3ab49c4, size 0x40, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapKey get_selectedBeatmapKey() ;

/// @brief Method get_selectedBeatmapLevel, addr 0x3ab4a04, size 0x1c, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevel* get_selectedBeatmapLevel() ;

/// @brief Method get_selectedBeatmapLevelPack, addr 0x3ab49a8, size 0x1c, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevelPack* get_selectedBeatmapLevelPack() ;

/// @brief Method get_selectedLevelCategory, addr 0x3ab498c, size 0x1c, virtual false, abstract: false, final false
inline ::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory get_selectedLevelCategory() ;

/// @brief Method get_showBackButtonForMainViewController, addr 0x3ab4a38, size 0x8, virtual true, abstract: false, final false
inline bool get_showBackButtonForMainViewController() ;

/// @brief Method get_songPackMask, addr 0x3ab4aa4, size 0x2c, virtual true, abstract: false, final false
