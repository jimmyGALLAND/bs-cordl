...
/// @brief Field _burstSliderElementNotesDebrisPool, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderElementNotesDebrisPool, put=__cordl_internal_set__burstSliderElementNotesDebrisPool)) ::GlobalNamespace::__NoteDebris__Pool*  _burstSliderElementNotesDebrisPool;

/// @brief Field _burstSliderHeadNotesDebrisPool, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderHeadNotesDebrisPool, put=__cordl_internal_set__burstSliderHeadNotesDebrisPool)) ::GlobalNamespace::__NoteDebris__Pool*  _burstSliderHeadNotesDebrisPool;
...
/// @brief Field _poolForNoteDebris, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__poolForNoteDebris, put=__cordl_internal_set__poolForNoteDebris)) ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::NoteDebris>,::GlobalNamespace::__NoteDebris__Pool*>*  _poolForNoteDebris;

/// @brief Field _poolForNoteGameplayType, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__poolForNoteGameplayType, put=__cordl_internal_set__poolForNoteGameplayType)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__NoteData__GameplayType,::GlobalNamespace::__NoteDebris__Pool*>*  _poolForNoteGameplayType;
...
/// @brief Method DespawnNoteDebris, addr 0x3af60e4, size 0xa4, virtual false, abstract: false, final false
inline void DespawnNoteDebris(::GlobalNamespace::NoteDebris*  noteDebris) ;

/// @brief Method HandleNoteDebrisDidFinish, addr 0x3af6028, size 0xbc, virtual true, abstract: false, final true
...
/// @brief Method SpawnDebris, addr 0x3af52a8, size 0x86c, virtual false, abstract: false, final false
...
/// @brief Method SpawnNoteDebris, addr 0x3af5f1c, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x3af5e50, size 0xcc, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::NoteDebris>,::GlobalNamespace::__NoteDebris__Pool*>*> const& __cordl_internal_get__poolForNoteDebris() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__NoteData__GameplayType,::GlobalNamespace::__NoteDebris__Pool*>*> const& __cordl_internal_get__poolForNoteGameplayType() const;
...
constexpr void __cordl_internal_set__poolForNoteGameplayType(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__NoteData__GameplayType,::GlobalNamespace::__NoteDebris__Pool*>*  value) ;

constexpr void __cordl_internal_set__rotation(float_t  value) ;

/// @brief Method .ctor, addr 0x3af6188, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _poolForNoteGameplayType, offset: 0x48, size: 0x8, def value: None
...
/// @brief Field _poolForNoteDebris, offset: 0x50, size: 0x8, def value: None
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::NoteDebrisSpawner, 0x58>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::NoteDebrisSpawner, ____poolForNoteGameplayType) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteDebrisSpawner, ____poolForNoteDebris) == 0x50, "Offset mismatch!");
