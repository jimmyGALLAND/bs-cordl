...
/// @brief Field _batteryLifeSegments, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__batteryLifeSegments, put=__cordl_internal_set__batteryLifeSegments)) ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::UI::Image>>*  _batteryLifeSegments;
...
/// @brief Method CreateUIForBatteryEnergyType, addr 0x3b116e0, size 0x2a0, virtual false, abstract: false, final false
inline void CreateUIForBatteryEnergyType(int32_t  batteryLives) ;

/// @brief Method HandleGameEnergyCounterDidInit, addr 0x3b11e10, size 0x4, virtual false, abstract: false, final false
inline void HandleGameEnergyCounterDidInit() ;

/// @brief Method HandleGameEnergyDidChange, addr 0x3b11e14, size 0x4, virtual false, abstract: false, final false
inline void HandleGameEnergyDidChange(float_t  energy) ;

/// @brief Method Init, addr 0x3b11348, size 0x398, virtual false, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::GameEnergyUIPanel* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b11c54, size 0x1bc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method RefreshEnergyUI, addr 0x3b11980, size 0x2d4, virtual false, abstract: false, final false
inline void RefreshEnergyUI(float_t  energy) ;

/// @brief Method Start, addr 0x3b111c8, size 0x180, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b11e18, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
