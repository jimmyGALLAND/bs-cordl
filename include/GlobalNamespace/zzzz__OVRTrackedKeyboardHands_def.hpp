...
// Ctor Parameters [CppParam { name: "LeftHandTransform", ty: "::UnityW<::UnityEngine::Transform>", modifiers: "", def_value: None }, CppParam { name: "LeftPresenceTransform", ty: "::UnityW<::UnityEngine::Transform>", modifiers: "", def_value: None }, CppParam { name: "RightHandTransform", ty: "::UnityW<::UnityEngine::Transform>", modifiers: "", def_value: None }, CppParam { name: "RightPresenceTransform", ty: "::UnityW<::UnityEngine::Transform>", modifiers: "", def_value: None }, CppParam { name: "BoneName", ty: "::GlobalNamespace::__OVRSkeleton__BoneId", modifiers: "", def_value: None }, CppParam { name: "HandPresenceLeftBoneName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "HandPresenceRightBoneName", ty: "::StringW", modifiers: "", def_value: None }]
constexpr __OVRTrackedKeyboardHands__HandBoneMapping(::UnityW<::UnityEngine::Transform>  LeftHandTransform, ::UnityW<::UnityEngine::Transform>  LeftPresenceTransform, ::UnityW<::UnityEngine::Transform>  RightHandTransform, ::UnityW<::UnityEngine::Transform>  RightPresenceTransform, ::GlobalNamespace::__OVRSkeleton__BoneId  BoneName, ::StringW  HandPresenceLeftBoneName, ::StringW  HandPresenceRightBoneName) noexcept;
...
/// @brief Field boneMappings_, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get_boneMappings_, put=__cordl_internal_set_boneMappings_)) ::ArrayW<::GlobalNamespace::__OVRTrackedKeyboardHands__HandBoneMapping,::Array<::GlobalNamespace::__OVRTrackedKeyboardHands__HandBoneMapping>*>  boneMappings_;
...
/// @brief Field lastVisibilityEvent_, offset 0xba, size 0x3 
 __declspec(property(get=__cordl_internal_get_lastVisibilityEvent_, put=__cordl_internal_set_lastVisibilityEvent_)) ::System::Nullable_1<::GlobalNamespace::__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent>  lastVisibilityEvent_;
...
/// @brief Method Awake, addr 0x3f8dd14, size 0x1dc, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ComputeOpacity, addr 0x3f8f228, size 0x24, virtual false, abstract: false, final false
inline float_t ComputeOpacity(float_t  distance, float_t  innerThreshold, float_t  outerThreshold) ;

/// @brief Method DisableHandObjects, addr 0x3f8eb8c, size 0xec, virtual false, abstract: false, final false
inline void DisableHandObjects() ;

/// @brief Method GetHandDistanceToKeyboard, addr 0x3f8ec78, size 0x2d0, virtual false, abstract: false, final false
inline float_t GetHandDistanceToKeyboard(::GlobalNamespace::OVRSkeleton*  handSkeleton) ;

/// @brief Method LateUpdate, addr 0x3f8e3a0, size 0x7ec, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::OVRTrackedKeyboardHands* New_ctor() ;

/// @brief Method RetargetHandTrackingToHandPresence, addr 0x3f8e1f4, size 0x170, virtual false, abstract: false, final false
inline void RetargetHandTrackingToHandPresence() ;

/// @brief Method SetHandModelsEnabled, addr 0x3f8f020, size 0x208, virtual false, abstract: false, final false
inline void SetHandModelsEnabled(bool  enableLeftModel, bool  enableRightModel) ;

/// @brief Method ShouldEnableModel, addr 0x3f8efb4, size 0x6c, virtual false, abstract: false, final false
inline bool ShouldEnableModel(float_t  distance) ;

/// @brief Method ShouldEnablePassthrough, addr 0x3f8ef48, size 0x6c, virtual false, abstract: false, final false
inline bool ShouldEnablePassthrough(float_t  distance) ;

/// @brief Method Start, addr 0x3f8def0, size 0x304, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StopHandPresence, addr 0x3f8f24c, size 0x30, virtual false, abstract: false, final false
inline void StopHandPresence() ;

/// @brief Method TrackedKeyboardActiveUpdated, addr 0x3f8f27c, size 0xc, virtual false, abstract: false, final false
inline void TrackedKeyboardActiveUpdated(::GlobalNamespace::__OVRTrackedKeyboard__TrackedKeyboardSetActiveEvent  e) ;

/// @brief Method TrackedKeyboardVisibilityChanged, addr 0x3f8f288, size 0x198, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__OVRTrackedKeyboardHands__HandBoneMapping,::Array<::GlobalNamespace::__OVRTrackedKeyboardHands__HandBoneMapping>*> const& __cordl_internal_get_boneMappings_() const;
...
constexpr void __cordl_internal_set_boneMappings_(::ArrayW<::GlobalNamespace::__OVRTrackedKeyboardHands__HandBoneMapping,::Array<::GlobalNamespace::__OVRTrackedKeyboardHands__HandBoneMapping>*>  value) ;
...
/// @brief Method .ctor, addr 0x3f8f420, size 0x754, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AreControllersActive, addr 0x3f8e364, size 0x3c, virtual false, abstract: false, final false
inline bool get_AreControllersActive() ;

/// @brief Method get_LeftHandOverKeyboard, addr 0x3f8dd00, size 0x8, virtual false, abstract: false, final false
inline bool get_LeftHandOverKeyboard() ;

/// @brief Method get_RightHandOverKeyboard, addr 0x3f8dcec, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_LeftHandOverKeyboard, addr 0x3f8dd08, size 0xc, virtual false, abstract: false, final false
inline void set_LeftHandOverKeyboard(bool  value) ;

/// @brief Method set_RightHandOverKeyboard, addr 0x3f8dcf4, size 0xc, virtual false, abstract: false, final false
