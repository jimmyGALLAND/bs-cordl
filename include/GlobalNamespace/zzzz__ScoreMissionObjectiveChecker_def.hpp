...
/// @brief Method HandleScoreDidChange, addr 0x3b1ea20, size 0x48, virtual false, abstract: false, final false
inline void HandleScoreDidChange(int32_t  multipliedScore, int32_t  modifiedScore) ;

/// @brief Method Init, addr 0x3b1ea68, size 0x200, virtual true, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::ScoreMissionObjectiveChecker* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b1e920, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b1ec68, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
