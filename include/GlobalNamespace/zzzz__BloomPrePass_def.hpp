...
/// @brief Field _bloomPrePassRenderData, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__bloomPrePassRenderData, put=__cordl_internal_set__bloomPrePassRenderData)) ::UnityW<::GlobalNamespace::BloomPrePassRenderDataSO>  _bloomPrePassRenderData;
...
/// @brief Method Awake, addr 0x3951f30, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method LazyInit, addr 0x3951f34, size 0xc4, virtual false, abstract: false, final false
inline void LazyInit() ;

static inline ::GlobalNamespace::BloomPrePass* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3952140, size 0xac, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnPostRender, addr 0x39533b4, size 0x94, virtual false, abstract: false, final false
inline void OnPostRender() ;

/// @brief Method OnPreRender, addr 0x39521ec, size 0x254, virtual false, abstract: false, final false
inline void OnPreRender() ;

/// @brief Method SetMode, addr 0x3953464, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x395346c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
