...
/// @brief Method NotifyAlphaWasChanged, addr 0x22299cc, size 0xc0, virtual false, abstract: false, final false
inline void NotifyAlphaWasChanged(float_t  currentAlpha) ;

/// @brief Method OnDestroy, addr 0x2229548, size 0x2c, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetRenderersEnabled, addr 0x22297ac, size 0x8c, virtual false, abstract: false, final false
inline void SetRenderersEnabled(bool  enabled) ;

/// @brief Method Start, addr 0x22292ec, size 0x11c, virtual true, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x2229b04, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;
