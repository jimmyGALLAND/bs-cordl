...
/// @brief Field _failAudioPitchGainEffect, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__failAudioPitchGainEffect, put=__cordl_internal_set__failAudioPitchGainEffect)) ::UnityW<::GlobalNamespace::AudioPitchGainEffect>  _failAudioPitchGainEffect;
...
/// @brief Method FailStopSong, addr 0x3b59954, size 0x118, virtual false, abstract: false, final false
inline void FailStopSong() ;

/// @brief Method LateUpdate, addr 0x3b597e8, size 0x74, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::GameSongController* New_ctor() ;

/// @brief Method PauseSong, addr 0x3b598f4, size 0x30, virtual true, abstract: false, final false
inline void PauseSong() ;

/// @brief Method ResumeSong, addr 0x3b59924, size 0x30, virtual true, abstract: false, final false
inline void ResumeSong() ;

/// @brief Method SeekTo, addr 0x3b59a6c, size 0x1c, virtual true, abstract: false, final true
inline void SeekTo(float_t  songTime) ;

/// @brief Method StartSong, addr 0x3b59878, size 0x44, virtual true, abstract: false, final true
inline void StartSong(float_t  songTimeOffset) ;

/// @brief Method StopSong, addr 0x3b598d8, size 0x1c, virtual true, abstract: false, final false
inline void StopSong() ;

/// @brief Method <FailStopSong>b__14_0, addr 0x3b59a98, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b59a88, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_songLength, addr 0x3b597b0, size 0x1c, virtual false, abstract: false, final false
inline float_t get_songLength() ;

/// @brief Method get_waitUntilIsReadyToStartTheSong, addr 0x3b597cc, size 0x1c, virtual true, abstract: false, final true
