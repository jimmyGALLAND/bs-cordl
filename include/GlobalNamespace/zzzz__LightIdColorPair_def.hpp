...
/// @brief Method .ctor, addr 0x3b98000, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_lightColor, addr 0x3b97fac, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_lightColor() ;

/// @brief Method get_useScriptableObjectColor, addr 0x3b97fec, size 0x8, virtual false, abstract: false, final false
inline bool get_useScriptableObjectColor() ;

/// @brief Method set_useScriptableObjectColor, addr 0x3b97ff4, size 0xc, virtual false, abstract: false, final false
