...
/// @brief Method .ctor, addr 0x395e940, size 0x38, virtual false, abstract: false, final false
inline void _ctor(int32_t  lightId, float_t  lightIntensity) ;

/// @brief Method get_intensity, addr 0x395e930, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method set_intensity, addr 0x395e938, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _lightIntensityData, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightIntensityData, put=__cordl_internal_set__lightIntensityData)) ::ArrayW<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*>*>  _lightIntensityData;
...
/// @brief Method GetLightWithIds, addr 0x395e8b0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ProcessNewColorData, addr 0x395e764, size 0x14c, virtual true, abstract: false, final false
inline void ProcessNewColorData() ;

constexpr ::ArrayW<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*>*> const& __cordl_internal_get__lightIntensityData() const;

constexpr ::ArrayW<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*>*>& __cordl_internal_get__lightIntensityData() ;
...
constexpr void __cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*>*>  value) ;
...
/// @brief Method .ctor, addr 0x395e8b8, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
