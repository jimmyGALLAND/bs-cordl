...
/// @brief Method .ctor, addr 0x3b2fa60, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method Awake, addr 0x3b2ff28, size 0xf4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method FollowOffsetSyncTime, addr 0x3b30840, size 0x1e0, virtual false, abstract: false, final false
inline void FollowOffsetSyncTime(::GlobalNamespace::IMultiplayerObservable*  observable, bool  crossFade, bool  forceUpdate) ;

/// @brief Method HandleVrFocusWasReleased, addr 0x3b30a2c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b30110, size 0x100, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SeekTo, addr 0x3b30a20, size 0xc, virtual true, abstract: false, final true
inline void SeekTo(float_t  offsetTime) ;

/// @brief Method SeekTo, addr 0x3b306e0, size 0x160, virtual false, abstract: false, final false
inline void SeekTo(float_t  offsetTime, bool  crossFade, float_t  toVolume) ;

/// @brief Method Start, addr 0x3b3001c, size 0xf4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartSong, addr 0x3b305f0, size 0xf0, virtual true, abstract: false, final true
inline void StartSong(float_t  offsetTime) ;

/// @brief Method Update, addr 0x3b30210, size 0x27c, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateOffsetSyncTime, addr 0x3b3048c, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b30a30, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_waitUntilIsReadyToStartTheSong>b__7_0, addr 0x3b30a38, size 0x4, virtual false, abstract: false, final false
inline bool _get_waitUntilIsReadyToStartTheSong_b__7_0() ;

/// @brief Method get_isAudioLoaded, addr 0x3b2fe8c, size 0x9c, virtual false, abstract: false, final false
inline bool get_isAudioLoaded() ;

/// @brief Method get_waitUntilIsReadyToStartTheSong, addr 0x3b2fde4, size 0xa8, virtual true, abstract: false, final true
