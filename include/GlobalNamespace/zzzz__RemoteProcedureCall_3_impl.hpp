...
template<typename T0,typename T1,typename T2>
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__RemoteProcedureCall__TypeWrapper_1<T0>*> const& GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>::__cordl_internal_get__value0() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value0;
}
template<typename T0,typename T1,typename T2>
...
template<typename T0,typename T1,typename T2>
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__RemoteProcedureCall__TypeWrapper_1<T1>*> const& GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>::__cordl_internal_get__value1() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value1;
}
template<typename T0,typename T1,typename T2>
...
template<typename T0,typename T1,typename T2>
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__RemoteProcedureCall__TypeWrapper_1<T2>*> const& GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>::__cordl_internal_get__value2() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value2;
}
template<typename T0,typename T1,typename T2>
...
template<typename T0,typename T1,typename T2>
inline T0 GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>::get_value0()  {
...
template<typename T0,typename T1,typename T2>
inline T1 GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>::get_value1()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>*>::get(),
                        "get_value1",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T0,typename T1,typename T2>
inline T2 GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>::get_value2()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>*>::get(),
                        "get_value2",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T0,typename T1,typename T2>
inline void GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>::SerializeData(::LiteNetLib::Utils::NetDataWriter*  writer, uint32_t  protocolVersion)  {
...
template<typename T0,typename T1,typename T2>
inline void GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>::DeserializeData(::LiteNetLib::Utils::NetDataReader*  reader, uint32_t  protocolVersion)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>*>::get(),
                    9
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "Init",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 4>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int64_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<T0>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<T1>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<T2>::get()}
                    )));
...
template<typename T0,typename T1,typename T2>
inline void GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>::Release()  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>*>::get(),
                    10
...
template<typename T0,typename T1,typename T2>
inline ::GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>* GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>*>());
}
template<typename T0,typename T1,typename T2>
inline void GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters []
template<typename T0,typename T1,typename T2>
constexpr ::GlobalNamespace::RemoteProcedureCall_3<T0,T1,T2>::RemoteProcedureCall_3()   {
}
