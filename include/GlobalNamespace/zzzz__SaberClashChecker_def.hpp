...
/// @brief Method AreSabersClashing, addr 0x3b54d88, size 0x164, virtual false, abstract: false, final false
inline bool AreSabersClashing(ByRef<::UnityEngine::Vector3>  clashingPoint) ;

/// @brief Method Init, addr 0x3b54d6c, size 0x1c, virtual false, abstract: false, final false
inline void Init(::GlobalNamespace::SaberManager*  saberManager) ;

static inline ::GlobalNamespace::SaberClashChecker* New_ctor() ;

/// @brief Method SegmentToSegmentDist, addr 0x3b54eec, size 0x268, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b55154, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
