...
/// @brief Field didFinishEvent, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didFinishEvent, put=__cordl_internal_set_didFinishEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerModeSelectionViewController>,::GlobalNamespace::__MultiplayerModeSelectionViewController__MenuButton>*  didFinishEvent;

/// @brief Method DidActivate, addr 0x3adcc68, size 0x2cc, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HandleMenuButton, addr 0x3add1d0, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method SetData, addr 0x3adcf34, size 0x29c, virtual false, abstract: false, final false
inline void SetData(::GlobalNamespace::MultiplayerStatusData*  multiplayerStatusData) ;

/// @brief Method <DidActivate>b__11_0, addr 0x3add200, size 0x24, virtual false, abstract: false, final false
inline void _DidActivate_b__11_0() ;

/// @brief Method <DidActivate>b__11_1, addr 0x3add224, size 0x24, virtual false, abstract: false, final false
inline void _DidActivate_b__11_1() ;

/// @brief Method <DidActivate>b__11_2, addr 0x3add248, size 0x24, virtual false, abstract: false, final false
inline void _DidActivate_b__11_2() ;

/// @brief Method <DidActivate>b__11_3, addr 0x3add26c, size 0x24, virtual false, abstract: false, final false
...
constexpr ::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerModeSelectionViewController>,::GlobalNamespace::__MultiplayerModeSelectionViewController__MenuButton>*& __cordl_internal_get_didFinishEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerModeSelectionViewController>,::GlobalNamespace::__MultiplayerModeSelectionViewController__MenuButton>*> const& __cordl_internal_get_didFinishEvent() const;
...
constexpr void __cordl_internal_set_didFinishEvent(::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerModeSelectionViewController>,::GlobalNamespace::__MultiplayerModeSelectionViewController__MenuButton>*  value) ;

/// @brief Method .ctor, addr 0x3add1f8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x3adcb08, size 0xb0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerModeSelectionViewController>,::GlobalNamespace::__MultiplayerModeSelectionViewController__MenuButton>*  value) ;

/// @brief Method remove_didFinishEvent, addr 0x3adcbb8, size 0xb0, virtual false, abstract: false, final false
inline void remove_didFinishEvent(::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerModeSelectionViewController>,::GlobalNamespace::__MultiplayerModeSelectionViewController__MenuButton>*  value) ;
