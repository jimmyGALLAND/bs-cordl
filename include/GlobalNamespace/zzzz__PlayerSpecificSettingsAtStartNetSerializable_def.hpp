...
/// @brief Field _activePlayersAtGameStart, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__activePlayersAtGameStart, put=__cordl_internal_set__activePlayersAtGameStart)) ::System::Collections::Generic::List_1<::GlobalNamespace::IConnectedPlayer*>*  _activePlayersAtGameStart;
...
/// @brief Method Deserialize, addr 0x2295f6c, size 0x154, virtual true, abstract: false, final true
...
/// @brief Method Serialize, addr 0x2295b74, size 0x368, virtual true, abstract: false, final true
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::PlayerSpecificSettingsNetSerializable*>*> const& __cordl_internal_get__activePlayerSpecificSettingsAtGameStart_k__BackingField() const;
...
/// @brief Method .ctor, addr 0x2295b44, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2295b4c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_activePlayerSpecificSettingsAtGameStart, addr 0x2295b34, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_activePlayersAtGameStart, addr 0x22958dc, size 0x258, virtual false, abstract: false, final false
...
/// @brief Method set_activePlayerSpecificSettingsAtGameStart, addr 0x2295b3c, size 0x8, virtual false, abstract: false, final false
