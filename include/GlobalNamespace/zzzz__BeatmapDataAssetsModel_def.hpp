...
/// @brief Method AssetBundleStreamingAssetsPathForAssetBundleName, addr 0x267178c, size 0x90, virtual false, abstract: false, final false
static inline ::StringW AssetBundleStreamingAssetsPathForAssetBundleName(::StringW  assetBundleName) ;

/// @brief Method GetAssetBundleNameForBeatmapLevel, addr 0x2671594, size 0x74, virtual false, abstract: false, final false
static inline ::StringW GetAssetBundleNameForBeatmapLevel(::StringW  levelID, ::GlobalNamespace::BeatmapLevelDataVersion  version) ;

/// @brief Method GetAssetBundleNameWithVersionForBeatmapLevelData, addr 0x2671608, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method GetAssetBundleStreamingAssetsPathForBeatmapLevelId, addr 0x26716e0, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method GetBeatmapLevelAssetFilenameForBeatmapLevel, addr 0x26714b0, size 0x4c, virtual false, abstract: false, final false
static inline ::StringW GetBeatmapLevelAssetFilenameForBeatmapLevel(::StringW  levelID) ;

/// @brief Method GetBeatmapLevelDataAssetFilenameForBeatmapLevel, addr 0x2671464, size 0x4c, virtual false, abstract: false, final false
static inline ::StringW GetBeatmapLevelDataAssetFilenameForBeatmapLevel(::StringW  levelID) ;

/// @brief Method GetBeatmapLevelDataAssetNameForBeatmapLevel, addr 0x2671548, size 0x4c, virtual false, abstract: false, final false
static inline ::StringW GetBeatmapLevelDataAssetNameForBeatmapLevel(::StringW  levelID) ;

/// @brief Method GetBeatmapLevelPackAssetFilename, addr 0x26714fc, size 0x4c, virtual false, abstract: false, final false
