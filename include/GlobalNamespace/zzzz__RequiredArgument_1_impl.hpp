...
template<typename T>
constexpr T& GlobalNamespace::RequiredArgument_1<T>::__cordl_internal_get__value()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value;
}
template<typename T>
constexpr T const& GlobalNamespace::RequiredArgument_1<T>::__cordl_internal_get__value() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value;
}
template<typename T>
constexpr void GlobalNamespace::RequiredArgument_1<T>::__cordl_internal_set__value(T  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
inline bool GlobalNamespace::RequiredArgument_1<T>::TryParseWithValue(::StringW  inValue, ByRef<::StringW>  outError)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::RequiredArgument_1<T>*>::get(),
                    5
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "op_Implicit",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::RequiredArgument_1<T>*>::get()}
                    )));
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::RequiredArgument_1<T>::RequiredArgument_1()   {
}
