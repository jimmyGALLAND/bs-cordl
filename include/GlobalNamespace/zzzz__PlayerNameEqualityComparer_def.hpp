...
/// @brief Method Equals, addr 0x26b36f4, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method GetHashCode, addr 0x26b3714, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x26b3738, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
constexpr ::System::Collections::Generic::IEqualityComparer_1<::GlobalNamespace::__PlatformLeaderboardsModel__LeaderboardScore*>* i___System__Collections__Generic__IEqualityComparer_1___GlobalNamespace____PlatformLeaderboardsModel__LeaderboardScore__() noexcept;
