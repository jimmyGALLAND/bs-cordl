...
/// @brief Field _menuEnvironmentType, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__menuEnvironmentType, put=__cordl_internal_set__menuEnvironmentType)) ::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentType  _menuEnvironmentType;
...
/// @brief Method .ctor, addr 0x3a51ef4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_menuEnvironmentType, addr 0x3a51ee4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentType get_menuEnvironmentType() ;

/// @brief Method get_wrapper, addr 0x3a51eec, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _data, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__data, put=__cordl_internal_set__data)) ::ArrayW<::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentObjects*,::Array<::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentObjects*>*>  _data;

/// @brief Field _prevMenuEnvironmentType, offset 0x28, size 0x4 
 __declspec(property(get=__cordl_internal_get__prevMenuEnvironmentType, put=__cordl_internal_set__prevMenuEnvironmentType)) ::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentType  _prevMenuEnvironmentType;

static inline ::GlobalNamespace::MenuEnvironmentManager* New_ctor() ;

/// @brief Method ShowEnvironmentType, addr 0x3a51d54, size 0x188, virtual false, abstract: false, final false
inline void ShowEnvironmentType(::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentType  menuEnvironmentType) ;

/// @brief Method Start, addr 0x3a51d4c, size 0x8, virtual false, abstract: false, final false
inline void Start() ;

constexpr ::ArrayW<::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentObjects*,::Array<::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentObjects*>*> const& __cordl_internal_get__data() const;

constexpr ::ArrayW<::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentObjects*,::Array<::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentObjects*>*>& __cordl_internal_get__data() ;
...
constexpr void __cordl_internal_set__data(::ArrayW<::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentObjects*,::Array<::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentObjects*>*>  value) ;
...
/// @brief Method .ctor, addr 0x3a51edc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
