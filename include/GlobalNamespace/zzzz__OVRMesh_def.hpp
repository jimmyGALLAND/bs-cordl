...
/// @brief Method Awake, addr 0x3fa646c, size 0xf4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Initialize, addr 0x3fa6580, size 0xb4, virtual false, abstract: false, final false
inline void Initialize(::GlobalNamespace::__OVRMesh__MeshType  meshType) ;

static inline ::GlobalNamespace::OVRMesh* New_ctor() ;

/// @brief Method SetMeshType, addr 0x3fa6464, size 0x8, virtual false, abstract: false, final false
inline void SetMeshType(::GlobalNamespace::__OVRMesh__MeshType  type) ;

/// @brief Method ShouldInitialize, addr 0x3fa6560, size 0x20, virtual false, abstract: false, final false
inline bool ShouldInitialize() ;

/// @brief Method TransformOvrpMesh, addr 0x3fa6634, size 0xa78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fa70ac, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsInitialized, addr 0x3fa6448, size 0x8, virtual false, abstract: false, final false
inline bool get_IsInitialized() ;

/// @brief Method get_Mesh, addr 0x3fa645c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> get_Mesh() ;

/// @brief Method set_IsInitialized, addr 0x3fa6450, size 0xc, virtual false, abstract: false, final false
