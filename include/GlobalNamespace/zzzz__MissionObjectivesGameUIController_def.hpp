...
/// @brief Method CreateUIElements, addr 0x3b1277c, size 0x398, virtual false, abstract: false, final false
inline void CreateUIElements() ;

/// @brief Method HandleMissionObjectiveCheckersManagerObjectivesListDidChange, addr 0x3b12c7c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b12b14, size 0xcc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b1264c, size 0x94, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::MissionObjectiveGameUIView>>*> const& __cordl_internal_get__missionObjectiveGameUIViews() const;
...
/// @brief Method .ctor, addr 0x3b12c80, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
