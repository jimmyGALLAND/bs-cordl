...
/// @brief Method SetEndSprite, addr 0x3b69134, size 0x24, virtual false, abstract: false, final false
inline void SetEndSprite() ;

/// @brief Method SetMiddleSprite, addr 0x3b69110, size 0x24, virtual false, abstract: false, final false
inline void SetMiddleSprite() ;

/// @brief Method SetStartSprite, addr 0x3b690ec, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b69158, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
