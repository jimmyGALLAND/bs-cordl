...
/// @brief Method IMultiplayerSpectatingSpot.get_transform, addr 0x3b4f040, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method OnDisable, addr 0x3b4f014, size 0x20, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method SetIsObserved, addr 0x3b4f034, size 0x4, virtual true, abstract: false, final true
inline void SetIsObserved(bool  isObserved) ;

/// @brief Method Start, addr 0x3b4eff8, size 0x1c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b4f038, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_hasBeenRemovedEvent, addr 0x3b4edcc, size 0xb0, virtual true, abstract: false, final true
inline void add_hasBeenRemovedEvent(::System::Action_1<::GlobalNamespace::IMultiplayerSpectatingSpot*>*  value) ;

/// @brief Method get_isMain, addr 0x3b4eff0, size 0x8, virtual true, abstract: false, final true
inline bool get_isMain() ;

/// @brief Method get_observable, addr 0x3b4ef2c, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::IMultiplayerObservable* get_observable() ;

/// @brief Method get_spotName, addr 0x3b4ef34, size 0xbc, virtual true, abstract: false, final true
...
/// @brief Method remove_hasBeenRemovedEvent, addr 0x3b4ee7c, size 0xb0, virtual true, abstract: false, final true
