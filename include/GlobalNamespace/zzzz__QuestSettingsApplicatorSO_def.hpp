...
public:
// Declarations
/// @brief Method ApplyGraphicSettings, addr 0x3aa17f4, size 0x2a4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aa1c8c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
