...
/// @brief Method .ctor, addr 0x3aadbfc, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::ScenesTransitionSetupDataSO*  nextScenesTransitionSetupData) ;

/// @brief Method get_nextScenesTransitionSetupData, addr 0x3aadbf4, size 0x8, virtual false, abstract: false, final false
