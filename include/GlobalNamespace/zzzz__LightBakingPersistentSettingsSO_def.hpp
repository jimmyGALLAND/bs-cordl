...
/// @brief Method ApplySettings, addr 0x3a8b9dc, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a8ba54, size 0xbc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bakedLightDataLoaderPrefab, addr 0x3a8b9ac, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::BakedLightDataLoader> get_bakedLightDataLoaderPrefab() ;

/// @brief Method get_bakedLightEditorColors, addr 0x3a8b9a4, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*> get_bakedLightEditorColors() ;

/// @brief Method get_bakedReflectionProbePrefab, addr 0x3a8b9b4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::BakedReflectionProbe> get_bakedReflectionProbePrefab() ;

/// @brief Method get_colorFromSchemeAlpha, addr 0x3a8b994, size 0x8, virtual false, abstract: false, final false
inline float_t get_colorFromSchemeAlpha() ;

/// @brief Method get_defaultDepthOnlyWriteMaterialForFakeMirror, addr 0x3a8b9d4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_defaultDepthOnlyWriteMaterialForFakeMirror() ;

/// @brief Method get_fakeMirrorObjectsInstallerPrefab, addr 0x3a8b9c4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::FakeMirrorObjectsInstaller> get_fakeMirrorObjectsInstallerPrefab() ;

/// @brief Method get_fakeMirrorSettingsPrefab, addr 0x3a8b9cc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::FakeMirrorSettings> get_fakeMirrorSettingsPrefab() ;

/// @brief Method get_lightmapLightsWithIds, addr 0x3a8b9bc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::LightmapLightsWithIds> get_lightmapLightsWithIds() ;

/// @brief Method get_reflectionsCount, addr 0x3a8b984, size 0x8, virtual false, abstract: false, final false
inline int32_t get_reflectionsCount() ;

/// @brief Method set_colorFromSchemeAlpha, addr 0x3a8b99c, size 0x8, virtual false, abstract: false, final false
inline void set_colorFromSchemeAlpha(float_t  value) ;

/// @brief Method set_reflectionsCount, addr 0x3a8b98c, size 0x8, virtual false, abstract: false, final false
