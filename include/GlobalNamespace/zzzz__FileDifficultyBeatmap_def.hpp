...
/// @brief Method GetBeatmapString, addr 0x267ec98, size 0x78, virtual false, abstract: false, final false
inline ::StringW GetBeatmapString() ;

/// @brief Method GetBeatmapStringAsync, addr 0x267eb28, size 0xb8, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::StringW>* GetBeatmapStringAsync() ;

/// @brief Method GetLightshowString, addr 0x267ed10, size 0x78, virtual false, abstract: false, final false
inline ::StringW GetLightshowString() ;

/// @brief Method GetLightshowStringAsync, addr 0x267ebe0, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x267eafc, size 0x2c, virtual false, abstract: false, final false
