...
/// @brief Method ApplyDeadzone, addr 0x3f96eb0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x3f96f00, size 0xc4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3f96fc4, size 0x18, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateInteractionAnchor, addr 0x3f96fdc, size 0x2b0, virtual false, abstract: false, final false
inline void UpdateInteractionAnchor() ;

/// @brief Method UpdateLineRenderer, addr 0x3f9728c, size 0x68, virtual false, abstract: false, final false
inline void UpdateLineRenderer() ;

/// @brief Method UpdateLineRendererFromSource, addr 0x3f972f4, size 0x760, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f97a54, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AnalogStickX, addr 0x3f96c44, size 0xc4, virtual false, abstract: false, final false
inline float_t get_AnalogStickX() ;

/// @brief Method get_AnalogStickY, addr 0x3f96b80, size 0xc4, virtual false, abstract: false, final false
inline float_t get_AnalogStickY() ;

/// @brief Method get_InputRayPosition, addr 0x3f96658, size 0x24, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_InputRayPosition() ;

/// @brief Method get_InputRayRotation, addr 0x3f96d08, size 0x198, virtual false, abstract: false, final false
