...
static __declspec(property(get=getStaticF_AnchorReferenceCountDictionary, put=setStaticF_AnchorReferenceCountDictionary)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::OVRSpace,int32_t>*  AnchorReferenceCountDictionary;
...
static __declspec(property(get=getStaticF_SceneAnchors, put=setStaticF_SceneAnchors)) ::System::Collections::Generic::Dictionary_2<::System::Guid,::UnityW<::GlobalNamespace::OVRSceneAnchor>>*  SceneAnchors;

/// @brief Field SceneAnchorsList, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF_SceneAnchorsList, put=setStaticF_SceneAnchorsList)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::OVRSceneAnchor>>*  SceneAnchorsList;
...
/// @brief Method ClearPoseCache, addr 0x3f7636c, size 0x10, virtual false, abstract: false, final false
inline void ClearPoseCache() ;

/// @brief Method GetSceneAnchors, addr 0x3f76b00, size 0xf4, virtual false, abstract: false, final false
static inline void GetSceneAnchors(::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::OVRSceneAnchor>>*  anchors) ;

/// @brief Method Initialize, addr 0x3f7637c, size 0x380, virtual false, abstract: false, final false
inline void Initialize(::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method InitializeFrom, addr 0x3f76a1c, size 0xe4, virtual false, abstract: false, final false
inline void InitializeFrom(::GlobalNamespace::OVRSceneAnchor*  other) ;

/// @brief Method IsComponentEnabled, addr 0x3f762dc, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3f76bf4, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method TryUpdateTransform, addr 0x3f76710, size 0x30c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f76dd4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Anchor, addr 0x3f762a0, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRAnchor get_Anchor() ;

/// @brief Method get_IsTracked, addr 0x3f762c8, size 0x8, virtual false, abstract: false, final false
inline bool get_IsTracked() ;

/// @brief Method get_Space, addr 0x3f7627c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRSpace get_Space() ;

/// @brief Method get_Uuid, addr 0x3f7628c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_Anchor, addr 0x3f762b4, size 0x14, virtual false, abstract: false, final false
inline void set_Anchor(::GlobalNamespace::OVRAnchor  value) ;

/// @brief Method set_IsTracked, addr 0x3f762d0, size 0xc, virtual false, abstract: false, final false
inline void set_IsTracked(bool  value) ;

/// @brief Method set_Space, addr 0x3f76284, size 0x8, virtual false, abstract: false, final false
inline void set_Space(::GlobalNamespace::OVRSpace  value) ;

/// @brief Method set_Uuid, addr 0x3f76298, size 0x8, virtual false, abstract: false, final false
