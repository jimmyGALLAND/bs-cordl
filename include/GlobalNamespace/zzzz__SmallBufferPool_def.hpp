...
/// @brief Method GetBuffer, addr 0x229a81c, size 0x27c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetBuffer(int32_t  length) ;

static inline ::GlobalNamespace::SmallBufferPool* New_ctor() ;

/// @brief Method ReleaseBuffer, addr 0x229aa98, size 0x4, virtual false, abstract: false, final false
inline void ReleaseBuffer(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer) ;

/// @brief Method ReleaseBuffer, addr 0x229ac58, size 0x1c, virtual false, abstract: false, final false
inline void ReleaseBuffer(ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  buffer) ;

/// @brief Method ReleaseBufferInternal, addr 0x229aa9c, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x229ac74, size 0xd4, virtual false, abstract: false, final false
inline void _ctor() ;
