...
/// @brief Method ReturnToMenu, addr 0x3b1c924, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b1c964, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
