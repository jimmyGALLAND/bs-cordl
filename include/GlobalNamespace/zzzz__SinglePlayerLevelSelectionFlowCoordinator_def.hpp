...
/// @brief Method <StartLevelOrShow360Prompt>b__0, addr 0x3ac6050, size 0x94, virtual false, abstract: false, final false
inline void _StartLevelOrShow360Prompt_b__0(int32_t  _) ;

/// @brief Method <StartLevelOrShow360Prompt>b__1, addr 0x3ac60e4, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ac5b9c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ActionButtonWasPressed, addr 0x3ac571c, size 0xc, virtual true, abstract: false, final false
inline void ActionButtonWasPressed() ;

/// @brief Method BackButtonWasPressed, addr 0x3ac5eac, size 0x94, virtual true, abstract: false, final false
inline void BackButtonWasPressed(::HMUI::ViewController*  topViewController) ;

/// @brief Method DismissPracticeViewController, addr 0x3ac5f94, size 0xb4, virtual false, abstract: false, final false
inline void DismissPracticeViewController(::System::Action*  finishedCallback, bool  immediately) ;

/// @brief Method HandleBasicLevelCompletionResults, addr 0x3ac5f70, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method HandlePracticeViewControllerDidPressPlayButton, addr 0x3ac5df0, size 0xc, virtual false, abstract: false, final false
inline void HandlePracticeViewControllerDidPressPlayButton() ;

/// @brief Method HandleStandardLevelDidFinish, addr 0x3ac5dfc, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method LevelSelectionFlowCoordinatorDidActivate, addr 0x3ac5310, size 0xb8, virtual true, abstract: false, final true
inline void LevelSelectionFlowCoordinatorDidActivate(bool  firstActivation, bool  addedToHierarchy) ;

/// @brief Method LevelSelectionFlowCoordinatorDidDeactivate, addr 0x3ac53c8, size 0xb0, virtual true, abstract: false, final true
inline void LevelSelectionFlowCoordinatorDidDeactivate(bool  removedFromHierarchy) ;

/// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange, addr 0x3ac5478, size 0x2a4, virtual true, abstract: false, final false
...
/// @brief Method PracticeButtonWasPressed, addr 0x3ac5a5c, size 0x8c, virtual true, abstract: false, final false
inline void PracticeButtonWasPressed() ;

/// @brief Method ProcessLevelCompletionResultsAfterLevelDidFinish, addr 0x3ac51a4, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method SelectionDidChange, addr 0x3ac5ae8, size 0xb4, virtual true, abstract: false, final false
inline void SelectionDidChange(::GlobalNamespace::BeatmapLevelPack*  pack, ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method SetupGameplaySetupViewController, addr 0x3ac5f40, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidActivate, addr 0x3ac519c, size 0x4, virtual true, abstract: false, final false
inline void SinglePlayerLevelSelectionFlowCoordinatorDidActivate(bool  firstActivation, bool  addedToHierarchy) ;

/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate, addr 0x3ac51a0, size 0x4, virtual true, abstract: false, final false
inline void SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate(bool  removedFromHierarchy) ;

/// @brief Method StartLevel, addr 0x3ac5ba4, size 0x24c, virtual false, abstract: false, final false
inline void StartLevel(::System::Action*  beforeSceneSwitchCallback, bool  practice) ;

/// @brief Method StartLevelOrShow360Prompt, addr 0x3ac5728, size 0x334, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ac6048, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x3ac51a8, size 0xb4, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::SinglePlayerLevelSelectionFlowCoordinator>>*  value) ;

/// @brief Method get_enableCustomLevels, addr 0x3ac511c, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method get_gameplayModifiers, addr 0x3ac5138, size 0x1c, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers() ;

/// @brief Method get_hideGameplaySetup, addr 0x3ac5154, size 0x8, virtual true, abstract: false, final false
inline bool get_hideGameplaySetup() ;

/// @brief Method get_initialLeftScreenViewController, addr 0x3ac516c, size 0x30, virtual true, abstract: false, final false
inline ::UnityW<::HMUI::ViewController> get_initialLeftScreenViewController() ;

/// @brief Method get_initialTopScreenViewController, addr 0x3ac5164, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::HMUI::ViewController> get_initialTopScreenViewController() ;

/// @brief Method get_isInPracticeView, addr 0x3ac508c, size 0x74, virtual false, abstract: false, final false
inline bool get_isInPracticeView() ;

/// @brief Method get_leaderboardViewController, addr 0x3ac515c, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::GlobalNamespace::LeaderboardViewController> get_leaderboardViewController() ;

/// @brief Method get_playerSettings, addr 0x3ac5100, size 0x1c, virtual false, abstract: false, final false
inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSettings() ;

/// @brief Method remove_didFinishEvent, addr 0x3ac525c, size 0xb4, virtual false, abstract: false, final false
