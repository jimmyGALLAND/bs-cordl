...
/// @brief Field _nextScenesTransitionSetupData, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__nextScenesTransitionSetupData, put=__cordl_internal_set__nextScenesTransitionSetupData)) ::UnityW<::GlobalNamespace::ScenesTransitionSetupDataSO>  _nextScenesTransitionSetupData;
...
/// @brief Method .ctor, addr 0x3aadb2c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::ScenesTransitionSetupDataSO*  nextScenesTransitionSetupData) ;

/// @brief Method get_nextScenesTransitionSetupData, addr 0x3aadb24, size 0x8, virtual false, abstract: false, final false
