...
/// @brief Method HandleSongDidFinish, addr 0x3b14ce4, size 0x4c, virtual false, abstract: false, final false
inline void HandleSongDidFinish() ;

static inline ::GlobalNamespace::SongProgressUIController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b148d8, size 0xd0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b14654, size 0x284, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3b149a8, size 0xf8, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateSongProgressUIElements, addr 0x3b14aa0, size 0x244, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b14d30, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;
