...
/// @brief Method Deserialize, addr 0x26d41c8, size 0x7c, virtual true, abstract: false, final false
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x26d4364, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x26d4338, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method Obtain, addr 0x26d4164, size 0x64, virtual false, abstract: false, final false
static inline ::GlobalNamespace::NoteMissInfoNetSerializable* Obtain() ;

/// @brief Method Serialize, addr 0x26d4244, size 0x9c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26d42e0, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_colorType, addr 0x26d4124, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorType get_colorType() ;

/// @brief Method get_noteLineIndex, addr 0x26d4144, size 0x8, virtual false, abstract: false, final false
inline int32_t get_noteLineIndex() ;

/// @brief Method get_noteLineLayer, addr 0x26d4154, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::NoteLineLayer get_noteLineLayer() ;

/// @brief Method get_noteTime, addr 0x26d4134, size 0x8, virtual false, abstract: false, final false
inline float_t get_noteTime() ;

/// @brief Method set_colorType, addr 0x26d412c, size 0x8, virtual false, abstract: false, final false
inline void set_colorType(::GlobalNamespace::ColorType  value) ;

/// @brief Method set_noteLineIndex, addr 0x26d414c, size 0x8, virtual false, abstract: false, final false
inline void set_noteLineIndex(int32_t  value) ;

/// @brief Method set_noteLineLayer, addr 0x26d415c, size 0x8, virtual false, abstract: false, final false
inline void set_noteLineLayer(::GlobalNamespace::NoteLineLayer  value) ;

/// @brief Method set_noteTime, addr 0x26d413c, size 0x8, virtual false, abstract: false, final false
