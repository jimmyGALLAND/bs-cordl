...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::GlobalNamespace::__RankModel__Rank)>(&::GlobalNamespace::RankModel::GetRankName)> {
  ...
  constexpr static std::size_t addrs = 0x26d5d58;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::__RankModel__Rank (*)(int32_t, int32_t, int32_t, int32_t)>(&::GlobalNamespace::RankModel::GetRankForScore)> {
  constexpr static std::size_t size = 0xc8;
  constexpr static std::size_t addrs = 0x26d5e14;
