...
/// @brief Method Awake, addr 0x3961028, size 0x84, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method ColorWasSet, addr 0x39610ac, size 0x144, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39611f0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
