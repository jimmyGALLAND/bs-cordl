...
public:
// Declarations
/// @brief Method .ctor, addr 0x3adf57c, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "region", ty: "::GlobalNamespace::__SelectRegionViewController__Region", modifiers: "", def_value: None }, CppParam { name: "localizationKey", ty: "::StringW", modifiers: "", def_value: None }]
...
/// @brief Method <DidActivate>b__8_1, addr 0x3adf5ec, size 0xc, virtual false, abstract: false, final false
inline ::StringW _DidActivate_b__8_1(::GlobalNamespace::__SelectRegionViewController__RegionToLocalizationKeyPair  p) ;

/// @brief Method .ctor, addr 0x3adf5e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _regionLocalizationKeys, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get__regionLocalizationKeys, put=__cordl_internal_set__regionLocalizationKeys)) ::ArrayW<::GlobalNamespace::__SelectRegionViewController__RegionToLocalizationKeyPair,::Array<::GlobalNamespace::__SelectRegionViewController__RegionToLocalizationKeyPair>*>  _regionLocalizationKeys;
...
/// @brief Field didPressContinueButtonEvent, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_didPressContinueButtonEvent, put=__cordl_internal_set_didPressContinueButtonEvent)) ::System::Action_1<::GlobalNamespace::__SelectRegionViewController__Region>*  didPressContinueButtonEvent;

/// @brief Method DidActivate, addr 0x3adf1d8, size 0x224, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HandleRegionSelectionDropdownDidSelectCell, addr 0x3adf4d8, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3adf3fc, size 0xdc, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method <DidActivate>b__8_0, addr 0x3adf524, size 0x58, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__SelectRegionViewController__RegionToLocalizationKeyPair,::Array<::GlobalNamespace::__SelectRegionViewController__RegionToLocalizationKeyPair>*> const& __cordl_internal_get__regionLocalizationKeys() const;

constexpr ::ArrayW<::GlobalNamespace::__SelectRegionViewController__RegionToLocalizationKeyPair,::Array<::GlobalNamespace::__SelectRegionViewController__RegionToLocalizationKeyPair>*>& __cordl_internal_get__regionLocalizationKeys() ;
...
constexpr void __cordl_internal_set__regionLocalizationKeys(::ArrayW<::GlobalNamespace::__SelectRegionViewController__RegionToLocalizationKeyPair,::Array<::GlobalNamespace::__SelectRegionViewController__RegionToLocalizationKeyPair>*>  value) ;
...
/// @brief Method .ctor, addr 0x3adf51c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didPressContinueButtonEvent, addr 0x3adf078, size 0xb0, virtual false, abstract: false, final false
inline void add_didPressContinueButtonEvent(::System::Action_1<::GlobalNamespace::__SelectRegionViewController__Region>*  value) ;

/// @brief Method remove_didPressContinueButtonEvent, addr 0x3adf128, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Field _regionLocalizationKeys, offset: 0x88, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::__SelectRegionViewController__RegionToLocalizationKeyPair,::Array<::GlobalNamespace::__SelectRegionViewController__RegionToLocalizationKeyPair>*>  ____regionLocalizationKeys;
