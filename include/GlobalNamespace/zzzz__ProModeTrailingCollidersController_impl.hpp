...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ProModeTrailingCollidersController::*)()>(&::GlobalNamespace::ProModeTrailingCollidersController::Start)> {
  constexpr static std::size_t size = 0x9c;
  constexpr static std::size_t addrs = 0x3a67134;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ProModeTrailingCollidersController::*)()>(&::GlobalNamespace::ProModeTrailingCollidersController::OnDestroy)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ProModeTrailingCollidersController::*)()>(&::GlobalNamespace::ProModeTrailingCollidersController::HandleNoteDidMoveInJumpPhase)> {
  constexpr static std::size_t size = 0x170;
  constexpr static std::size_t addrs = 0x3a6729c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ProModeTrailingCollidersController::*)()>(&::GlobalNamespace::ProModeTrailingCollidersController::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3a6740c;
...
constexpr ::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>,::Array<::UnityW<::GlobalNamespace::BoxCuttableBySaber>>*>& GlobalNamespace::ProModeTrailingCollidersController::__cordl_internal_get__trailingSmallCuttableBySaberList()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____trailingSmallCuttableBySaberList;
}
constexpr ::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>,::Array<::UnityW<::GlobalNamespace::BoxCuttableBySaber>>*> const& GlobalNamespace::ProModeTrailingCollidersController::__cordl_internal_get__trailingSmallCuttableBySaberList() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____trailingSmallCuttableBySaberList;
}
constexpr void GlobalNamespace::ProModeTrailingCollidersController::__cordl_internal_set__trailingSmallCuttableBySaberList(::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>,::Array<::UnityW<::GlobalNamespace::BoxCuttableBySaber>>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::ProModeTrailingCollidersController*>());
}
