...
/// @brief Method ValidateCertificateChain, addr 0x226e1a0, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method ValidateCertificateChainInternal, addr 0x226e1a4, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x226e360, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
