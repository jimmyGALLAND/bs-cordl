...
/// @brief Method GetPoint, addr 0x3aece84, size 0x8c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetPoint(float_t  time) ;

static inline ::GlobalNamespace::FloatingTransformEffect* New_ctor() ;

/// @brief Method Refresh, addr 0x3aecc5c, size 0xd8, virtual false, abstract: false, final false
inline void Refresh() ;

/// @brief Method Start, addr 0x3aecc24, size 0x38, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Tick, addr 0x3aecd34, size 0x150, virtual true, abstract: false, final true
inline void Tick() ;
...
/// @brief Method .ctor, addr 0x3aecf10, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;
