...
public:
// Declarations
/// @brief Method GetHardwareCategory, addr 0x26afd7c, size 0x74, virtual false, abstract: false, final false
static inline ::GlobalNamespace::HardwareCategory GetHardwareCategory() ;

/// @brief Method GetHardwareCategoryWithEditorOverride, addr 0x26afd78, size 0x4, virtual false, abstract: false, final false
