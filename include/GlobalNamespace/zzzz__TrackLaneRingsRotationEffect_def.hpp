...
/// @brief Method .ctor, addr 0x3b0afc0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _activeRingRotationEffects, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__activeRingRotationEffects, put=__cordl_internal_set__activeRingRotationEffects)) ::System::Collections::Generic::List_1<::GlobalNamespace::__TrackLaneRingsRotationEffect__RingRotationEffect*>*  _activeRingRotationEffects;

/// @brief Field _ringRotationEffectsPool, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__ringRotationEffectsPool, put=__cordl_internal_set__ringRotationEffectsPool)) ::System::Collections::Generic::List_1<::GlobalNamespace::__TrackLaneRingsRotationEffect__RingRotationEffect*>*  _ringRotationEffectsPool;
...
/// @brief Field ringRotationEffectsToDelete, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_ringRotationEffectsToDelete, put=__cordl_internal_set_ringRotationEffectsToDelete)) ::System::Collections::Generic::List_1<int32_t>*  ringRotationEffectsToDelete;

/// @brief Method AddRingRotationEffect, addr 0x3b0afd8, size 0xe0, virtual false, abstract: false, final false
inline void AddRingRotationEffect(float_t  angle, float_t  step, int32_t  propagationSpeed, float_t  flexySpeed) ;

/// @brief Method Awake, addr 0x3b0ae4c, size 0x174, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method FixedUpdate, addr 0x3b0b0b8, size 0x168, virtual false, abstract: false, final false
inline void FixedUpdate() ;

/// @brief Method GetFirstRingDestinationRotationAngle, addr 0x3b0b3cc, size 0x38, virtual false, abstract: false, final false
inline float_t GetFirstRingDestinationRotationAngle() ;

/// @brief Method GetFirstRingRotationAngle, addr 0x3b0b394, size 0x38, virtual false, abstract: false, final false
inline float_t GetFirstRingRotationAngle() ;

static inline ::GlobalNamespace::TrackLaneRingsRotationEffect* New_ctor() ;

/// @brief Method RecycleRingRotationEffect, addr 0x3b0b220, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method SpawnRingRotationEffect, addr 0x3b0b2c4, size 0xd0, virtual false, abstract: false, final false
inline ::GlobalNamespace::__TrackLaneRingsRotationEffect__RingRotationEffect* SpawnRingRotationEffect() ;

/// @brief Method Start, addr 0x3b0afc8, size 0x10, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__TrackLaneRingsRotationEffect__RingRotationEffect*>*> const& __cordl_internal_get__activeRingRotationEffects() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__TrackLaneRingsRotationEffect__RingRotationEffect*>*> const& __cordl_internal_get__ringRotationEffectsPool() const;
...
/// @brief Method .ctor, addr 0x3b0b404, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
