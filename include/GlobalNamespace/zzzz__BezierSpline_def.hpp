...
public:
// Declarations
/// @brief Method .ctor, addr 0x2224990, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <ComputeControlPoints>b__8_0, addr 0x2224a2c, size 0x4, virtual false, abstract: false, final false
inline float_t _ComputeControlPoints_b__8_0(::UnityEngine::Vector3  p) ;

/// @brief Method <ComputeControlPoints>b__8_1, addr 0x2224a30, size 0x8, virtual false, abstract: false, final false
inline float_t _ComputeControlPoints_b__8_1(::UnityEngine::Vector3  p) ;

/// @brief Method <ComputeControlPoints>b__8_2, addr 0x2224a38, size 0x8, virtual false, abstract: false, final false
inline float_t _ComputeControlPoints_b__8_2(::UnityEngine::Vector3  p) ;

/// @brief Method <SortSourceData>b__6_0, addr 0x22249fc, size 0x30, virtual false, abstract: false, final false
inline int32_t _SortSourceData_b__6_0(::UnityEngine::Vector3  point1, ::UnityEngine::Vector3  point2) ;

/// @brief Method .ctor, addr 0x22249f4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddArtificialStartAndFinishPoint, addr 0x221f9ac, size 0x1f4, virtual false, abstract: false, final false
inline void AddArtificialStartAndFinishPoint() ;

/// @brief Method AddPoint, addr 0x221f8d8, size 0xd4, virtual false, abstract: false, final false
inline void AddPoint(float_t  distance, ::UnityEngine::Vector2  point) ;

/// @brief Method Clear, addr 0x2224920, size 0x70, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ComputeControlPoints, addr 0x22243f8, size 0x528, virtual false, abstract: false, final false
...
/// @brief Method ComputeControlPoints, addr 0x221fba0, size 0x520, virtual false, abstract: false, final false
inline void ComputeControlPoints() ;

static inline ::GlobalNamespace::BezierSpline* New_ctor() ;

/// @brief Method SortSourceData, addr 0x22242fc, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x221f514, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_segments, addr 0x22242f4, size 0x8, virtual false, abstract: false, final false
