...
public:
// Declarations
/// @brief Method GetAnimationId, addr 0x22229c0, size 0x8, virtual false, abstract: false, final false
static inline int32_t GetAnimationId(int32_t  value) ;

/// @brief Method GetIsAlternativeMaterial, addr 0x2222e00, size 0x8, virtual false, abstract: false, final false
static inline bool GetIsAlternativeMaterial(int32_t  value) ;

/// @brief Method GetPrefabId, addr 0x22229b8, size 0x8, virtual false, abstract: false, final false
static inline int32_t GetPrefabId(int32_t  value) ;

/// @brief Method MergeValuesIntoOneInt, addr 0x2222f34, size 0x18, virtual false, abstract: false, final false
