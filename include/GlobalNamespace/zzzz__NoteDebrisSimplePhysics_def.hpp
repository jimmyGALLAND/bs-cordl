...
/// @brief Method Awake, addr 0x3a64750, size 0x70, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x3a647c0, size 0xa4, virtual true, abstract: false, final false
inline void Init(::UnityEngine::Vector3  linearVelocity, ::UnityEngine::Vector3  angularVelocity) ;

/// @brief Method LateUpdate, addr 0x3a6447c, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a64864, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_currentAngularVelocityDegrees, addr 0x3a64744, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_currentAngularVelocityDegrees() ;

/// @brief Method get_currentLinearVelocity, addr 0x3a64738, size 0xc, virtual false, abstract: false, final false
