...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IReadOnlyList_1<::StringW>* (::GlobalNamespace::SongPackMasksModelSO::*)()>(&::GlobalNamespace::SongPackMasksModelSO::get_defaultSongPackMaskItems)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2694f54;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::GlobalNamespace::SongPackMasksModelItem*,::Array<::GlobalNamespace::SongPackMasksModelItem*>*> (::GlobalNamespace::SongPackMasksModelSO::*)()>(&::GlobalNamespace::SongPackMasksModelSO::get_customSongPackMaskItems)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2694f5c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SongPackMasksModelSO::*)()>(&::GlobalNamespace::SongPackMasksModelSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2694f64;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> const& GlobalNamespace::SongPackMasksModelSO::__cordl_internal_get__defaultSongPackMaskItems() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____defaultSongPackMaskItems;
}
...
constexpr ::ArrayW<::GlobalNamespace::SongPackMasksModelItem*,::Array<::GlobalNamespace::SongPackMasksModelItem*>*>& GlobalNamespace::SongPackMasksModelSO::__cordl_internal_get__customSongPackMaskItems()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____customSongPackMaskItems;
}
constexpr ::ArrayW<::GlobalNamespace::SongPackMasksModelItem*,::Array<::GlobalNamespace::SongPackMasksModelItem*>*> const& GlobalNamespace::SongPackMasksModelSO::__cordl_internal_get__customSongPackMaskItems() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____customSongPackMaskItems;
}
constexpr void GlobalNamespace::SongPackMasksModelSO::__cordl_internal_set__customSongPackMaskItems(::ArrayW<::GlobalNamespace::SongPackMasksModelItem*,::Array<::GlobalNamespace::SongPackMasksModelItem*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
