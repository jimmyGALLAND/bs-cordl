...
/// @brief Method Awake, addr 0x3a82cfc, size 0x28, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method InitColors, addr 0x3a82d24, size 0xa0, virtual false, abstract: false, final false
inline void InitColors() ;

static inline ::GlobalNamespace::EnvironmentColorManager* New_ctor() ;

/// @brief Method SetColorScheme, addr 0x3a82dc4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a82dcc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didChangeColorEvent, addr 0x3a82bc4, size 0x9c, virtual true, abstract: false, final true
inline void add_didChangeColorEvent(::System::Action*  value) ;

/// @brief Method get_environmentColor0, addr 0x3a82adc, size 0x20, virtual true, abstract: false, final true
inline ::UnityEngine::Color get_environmentColor0() ;

/// @brief Method get_environmentColor0Boost, addr 0x3a82b1c, size 0x54, virtual true, abstract: false, final true
inline ::UnityEngine::Color get_environmentColor0Boost() ;

/// @brief Method get_environmentColor1, addr 0x3a82afc, size 0x20, virtual true, abstract: false, final true
inline ::UnityEngine::Color get_environmentColor1() ;

/// @brief Method get_environmentColor1Boost, addr 0x3a82b70, size 0x54, virtual true, abstract: false, final true
...
/// @brief Method remove_didChangeColorEvent, addr 0x3a82c60, size 0x9c, virtual true, abstract: false, final true
