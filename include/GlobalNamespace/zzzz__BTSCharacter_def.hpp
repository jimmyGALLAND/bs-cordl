...
/// @brief Field _btsCharacterMaterialSwitcher, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__btsCharacterMaterialSwitcher, put=__cordl_internal_set__btsCharacterMaterialSwitcher)) ::UnityW<::GlobalNamespace::BTSCharacterMaterialSwitcher>  _btsCharacterMaterialSwitcher;
...
/// @brief Method SetAlternativeAnimationAndMaterial, addr 0x222012c, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2220570, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_animator, addr 0x222011c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Animator> get_animator() ;

/// @brief Method get_characterName, addr 0x222010c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_characterName() ;

/// @brief Method get_headTransform, addr 0x2220124, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_headTransform() ;

/// @brief Method get_materialPropertyBlockController, addr 0x2220114, size 0x8, virtual false, abstract: false, final false
