...
template<typename T>
constexpr ::HMUI::__TableView__IDataSource* GlobalNamespace::EnumTableViewDataSource_1<T>::i___HMUI____TableView__IDataSource() noexcept {
return static_cast<::HMUI::__TableView__IDataSource*>(static_cast<void*>(this));
}
template<typename T>
constexpr ::UnityW<::GlobalNamespace::TextOnlyTableCell>& GlobalNamespace::EnumTableViewDataSource_1<T>::__cordl_internal_get__cellPrefab()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____cellPrefab;
}
template<typename T>
constexpr ::UnityW<::GlobalNamespace::TextOnlyTableCell> const& GlobalNamespace::EnumTableViewDataSource_1<T>::__cordl_internal_get__cellPrefab() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____cellPrefab;
}
template<typename T>
constexpr void GlobalNamespace::EnumTableViewDataSource_1<T>::__cordl_internal_set__cellPrefab(::UnityW<::GlobalNamespace::TextOnlyTableCell>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
constexpr float_t& GlobalNamespace::EnumTableViewDataSource_1<T>::__cordl_internal_get__cellHeight()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____cellHeight;
}
template<typename T>
constexpr float_t const& GlobalNamespace::EnumTableViewDataSource_1<T>::__cordl_internal_get__cellHeight() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____cellHeight;
}
template<typename T>
constexpr void GlobalNamespace::EnumTableViewDataSource_1<T>::__cordl_internal_set__cellHeight(float_t  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
this->____cellHeight = value;
}
template<typename T>
constexpr ::ArrayW<T,::Array<T>*>& GlobalNamespace::EnumTableViewDataSource_1<T>::__cordl_internal_get__values()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____values;
}
template<typename T>
constexpr ::ArrayW<T,::Array<T>*> const& GlobalNamespace::EnumTableViewDataSource_1<T>::__cordl_internal_get__values() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____values;
}
template<typename T>
constexpr void GlobalNamespace::EnumTableViewDataSource_1<T>::__cordl_internal_set__values(::ArrayW<T,::Array<T>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
inline float_t GlobalNamespace::EnumTableViewDataSource_1<T>::CellSize(int32_t  idx)  {
...
template<typename T>
inline ::UnityW<::HMUI::TableCell> GlobalNamespace::EnumTableViewDataSource_1<T>::CellForIdx(::HMUI::TableView*  tableView, int32_t  idx)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::EnumTableViewDataSource_1<T>*>::get(),
                        "CellForIdx",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::EnumTableViewDataSource_1<T>::EnumTableViewDataSource_1()   {
}
