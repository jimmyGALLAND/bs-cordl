...
/// @brief Method Awake, addr 0x3b046e4, size 0x110, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetPositionForValue, addr 0x3b04a98, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetPositionForValue(int32_t  value) ;

/// @brief Method HandleBeatmapEvent, addr 0x3b049b8, size 0xe0, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

static inline ::GlobalNamespace::SmoothStepPositionEventEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b0491c, size 0x9c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetPosition, addr 0x3b04af4, size 0x48, virtual false, abstract: false, final false
inline void SetPosition(::UnityEngine::Vector3  position) ;

/// @brief Method Start, addr 0x3b047f4, size 0x128, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b04b3c, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;
