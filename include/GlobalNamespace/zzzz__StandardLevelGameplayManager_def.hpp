...
namespace GlobalNamespace {
class __StandardLevelGameplayManager___Start_d__25;
}
...
MARK_REF_PTR_T(::GlobalNamespace::__StandardLevelGameplayManager___Start_d__25);
// Type: ::InitData
...
/// @brief Method .ctor, addr 0x3b10580, size 0x28, virtual false, abstract: false, final false
...
namespace GlobalNamespace {
// Is value type: false
// CS Name: ::StandardLevelGameplayManager::<Start>d__25*
class CORDL_TYPE __StandardLevelGameplayManager___Start_d__25 : public ::System::Object {
public:
// Declarations
...
/// @brief Method MoveNext, addr 0x3b105ac, size 0x360, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::GlobalNamespace::__StandardLevelGameplayManager___Start_d__25* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3b1090c, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x3b10914, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3b1094c, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x3b105a8, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b100d4, size 0x28, virtual false, abstract: false, final false
...
// Ctor Parameters []
// @brief default ctor
constexpr __StandardLevelGameplayManager___Start_d__25() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "__StandardLevelGameplayManager___Start_d__25", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
__StandardLevelGameplayManager___Start_d__25(__StandardLevelGameplayManager___Start_d__25 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "__StandardLevelGameplayManager___Start_d__25", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
__StandardLevelGameplayManager___Start_d__25(__StandardLevelGameplayManager___Start_d__25 const& ) = delete;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__StandardLevelGameplayManager___Start_d__25, 0x28>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__StandardLevelGameplayManager___Start_d__25, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__StandardLevelGameplayManager___Start_d__25, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__StandardLevelGameplayManager___Start_d__25, _____4__this) == 0x20, "Offset mismatch!");
...
using _Start_d__25 = ::GlobalNamespace::__StandardLevelGameplayManager___Start_d__25;
...
/// @brief Field _levelEndStateType, offset 0x6c, size 0x4 
...
/// @brief Field _prePauseGameState, offset 0x70, size 0x4 
...
/// @brief Method Awake, addr 0x3b1006c, size 0x8, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleGameEnergyDidReach0, addr 0x3b10494, size 0x58, virtual false, abstract: false, final false
inline void HandleGameEnergyDidReach0() ;

/// @brief Method HandlePauseControllerCanPause, addr 0x3b10520, size 0x24, virtual false, abstract: false, final false
inline void HandlePauseControllerCanPause(::System::Action_1<bool>*  canPause) ;

/// @brief Method HandlePauseControllerDidPause, addr 0x3b10544, size 0x1c, virtual false, abstract: false, final false
inline void HandlePauseControllerDidPause() ;

/// @brief Method HandlePauseControllerDidResume, addr 0x3b10560, size 0x18, virtual false, abstract: false, final false
inline void HandlePauseControllerDidResume() ;

/// @brief Method HandleSongDidFinish, addr 0x3b104ec, size 0x34, virtual false, abstract: false, final false
inline void HandleSongDidFinish() ;

static inline ::GlobalNamespace::StandardLevelGameplayManager* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b100fc, size 0x254, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b10074, size 0x60, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* Start() ;

/// @brief Method Update, addr 0x3b10350, size 0x34, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b10578, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_levelDidStartEvent, addr 0x3b0fcbc, size 0x9c, virtual true, abstract: false, final true
inline void add_levelDidStartEvent(::System::Action*  value) ;

/// @brief Method add_levelFailedEvent, addr 0x3b0ff2c, size 0x9c, virtual true, abstract: false, final true
inline void add_levelFailedEvent(::System::Action*  value) ;

/// @brief Method add_levelFinishedEvent, addr 0x3b0fdf4, size 0x9c, virtual true, abstract: false, final true
inline void add_levelFinishedEvent(::System::Action*  value) ;

/// @brief Method add_levelWillStartIntroEvent, addr 0x3b0fb84, size 0x9c, virtual true, abstract: false, final true
inline void add_levelWillStartIntroEvent(::System::Action*  value) ;

/// @brief Method get_levelEndStateType, addr 0x3b10064, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method remove_levelDidStartEvent, addr 0x3b0fd58, size 0x9c, virtual true, abstract: false, final true
inline void remove_levelDidStartEvent(::System::Action*  value) ;

/// @brief Method remove_levelFailedEvent, addr 0x3b0ffc8, size 0x9c, virtual true, abstract: false, final true
inline void remove_levelFailedEvent(::System::Action*  value) ;

/// @brief Method remove_levelFinishedEvent, addr 0x3b0fe90, size 0x9c, virtual true, abstract: false, final true
inline void remove_levelFinishedEvent(::System::Action*  value) ;

/// @brief Method remove_levelWillStartIntroEvent, addr 0x3b0fc20, size 0x9c, virtual true, abstract: false, final true
...
/// @brief Field _levelEndStateType, offset: 0x6c, size: 0x4, def value: None
 ::GlobalNamespace::__LevelCompletionResults__LevelEndStateType  ____levelEndStateType;

/// @brief Field _prePauseGameState, offset: 0x70, size: 0x4, def value: None
 ::GlobalNamespace::__StandardLevelGameplayManager__GameState  ____prePauseGameState;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::StandardLevelGameplayManager, 0x78>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::StandardLevelGameplayManager, ___levelWillStartIntroEvent) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StandardLevelGameplayManager, ___levelDidStartEvent) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StandardLevelGameplayManager, ___levelFinishedEvent) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StandardLevelGameplayManager, ___levelFailedEvent) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StandardLevelGameplayManager, ____gameState) == 0x68, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StandardLevelGameplayManager, ____levelEndStateType) == 0x6c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StandardLevelGameplayManager, ____prePauseGameState) == 0x70, "Offset mismatch!");
...
NEED_NO_BOX(::GlobalNamespace::__StandardLevelGameplayManager___Start_d__25);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__StandardLevelGameplayManager___Start_d__25*, "", "StandardLevelGameplayManager/<Start>d__25");
