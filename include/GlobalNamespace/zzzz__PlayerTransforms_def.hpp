...
/// @brief Field _useOriginParentTransformForPseudoLocalCalculations, offset 0xc8, size 0x1 
 __declspec(property(get=__cordl_internal_get__useOriginParentTransformForPseudoLocalCalculations, put=__cordl_internal_set__useOriginParentTransformForPseudoLocalCalculations)) bool  _useOriginParentTransformForPseudoLocalCalculations;
...
/// @brief Method Awake, addr 0x3b51c30, size 0x84, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ClearHeadPositionOverride, addr 0x3b51cd0, size 0x8, virtual false, abstract: false, final false
inline void ClearHeadPositionOverride() ;

/// @brief Method GetZPos, addr 0x3b51f44, size 0x28, virtual false, abstract: false, final false
inline float_t GetZPos(float_t  start, float_t  end, float_t  headOffsetZ, float_t  t) ;

/// @brief Method GetZPosOffsetByHeadPosAtTime, addr 0x3b51f6c, size 0x2c, virtual false, abstract: false, final false
inline float_t GetZPosOffsetByHeadPosAtTime(float_t  start, float_t  end, float_t  t) ;

/// @brief Method HeadOffsetZ, addr 0x3b51f24, size 0x20, virtual false, abstract: false, final false
inline float_t HeadOffsetZ(::UnityEngine::Quaternion  noteInverseWorldRotation) ;

/// @brief Method MoveTowardsHead, addr 0x3b51eb0, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method OverrideHeadPos, addr 0x3b51cb4, size 0x1c, virtual false, abstract: false, final false
inline void OverrideHeadPos(::UnityEngine::Vector3  pos) ;

/// @brief Method Update, addr 0x3b51cd8, size 0x1d8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b51f98, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_headPseudoLocalPos, addr 0x3b51be8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_headPseudoLocalPos() ;

/// @brief Method get_headPseudoLocalRot, addr 0x3b51bf4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_headPseudoLocalRot() ;

/// @brief Method get_headWorldPos, addr 0x3b51bd0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_headWorldPos() ;

/// @brief Method get_headWorldRot, addr 0x3b51bdc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_headWorldRot() ;

/// @brief Method get_leftHandPseudoLocalPos, addr 0x3b51c00, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_leftHandPseudoLocalPos() ;

/// @brief Method get_leftHandPseudoLocalRot, addr 0x3b51c0c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_leftHandPseudoLocalRot() ;

/// @brief Method get_rightHandPseudoLocalPos, addr 0x3b51c18, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_rightHandPseudoLocalPos() ;

/// @brief Method get_rightHandPseudoLocalRot, addr 0x3b51c24, size 0xc, virtual false, abstract: false, final false
