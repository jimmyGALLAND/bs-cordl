...
// Ctor Parameters [CppParam { name: "resolution", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "fov", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "fullFov", ty: "::GlobalNamespace::__OVRDisplay__EyeFov", modifiers: "", def_value: None }]
...
/// @brief Field eyeDescs, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_eyeDescs, put=__cordl_internal_set_eyeDescs)) ::ArrayW<::GlobalNamespace::__OVRDisplay__EyeRenderDesc,::Array<::GlobalNamespace::__OVRDisplay__EyeRenderDesc>*>  eyeDescs;
...
/// @brief Method ConfigureEyeDesc, addr 0x3f18114, size 0x254, virtual false, abstract: false, final false
inline void ConfigureEyeDesc(::UnityEngine::XR::XRNode  eye) ;

/// @brief Method GetEyeRenderDesc, addr 0x3f17d70, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method RecenterPose, addr 0x3f17868, size 0x78, virtual false, abstract: false, final false
inline void RecenterPose() ;

/// @brief Method Update, addr 0x3f175a4, size 0x18c, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateTextures, addr 0x3f17584, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f1750c, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_RecenteredPose, addr 0x3f17730, size 0x9c, virtual false, abstract: false, final false
inline void add_RecenteredPose(::System::Action*  value) ;

/// @brief Method get_acceleration, addr 0x3f178e0, size 0x124, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_acceleration() ;

/// @brief Method get_angularAcceleration, addr 0x3f17a04, size 0x124, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_angularAcceleration() ;

/// @brief Method get_angularVelocity, addr 0x3f17c4c, size 0x124, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_angularVelocity() ;

/// @brief Method get_appFramerate, addr 0x3f17f78, size 0x90, virtual false, abstract: false, final false
inline float_t get_appFramerate() ;

/// @brief Method get_displayFrequenciesAvailable, addr 0x3f18064, size 0x50, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> get_displayFrequenciesAvailable() ;

/// @brief Method get_displayFrequency, addr 0x3f08240, size 0x50, virtual false, abstract: false, final false
inline float_t get_displayFrequency() ;

/// @brief Method get_latency, addr 0x3f17da8, size 0x1d0, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRDisplay__LatencyData get_latency() ;

/// @brief Method get_recommendedMSAALevel, addr 0x3f18008, size 0x5c, virtual false, abstract: false, final false
inline int32_t get_recommendedMSAALevel() ;

/// @brief Method get_velocity, addr 0x3f17b28, size 0x124, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_velocity() ;

/// @brief Method remove_RecenteredPose, addr 0x3f177cc, size 0x9c, virtual false, abstract: false, final false
inline void remove_RecenteredPose(::System::Action*  value) ;

/// @brief Method set_displayFrequency, addr 0x3f180b4, size 0x60, virtual false, abstract: false, final false
