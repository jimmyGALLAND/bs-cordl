...
/// @brief Method AddNecessaryComponents, addr 0x395ea40, size 0x104, virtual false, abstract: false, final false
inline void AddNecessaryComponents() ;

/// @brief Method ColorWasSet, addr 0x395e998, size 0xa8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x395eb44, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_intensity, addr 0x395e978, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method set_intensity, addr 0x395e980, size 0x18, virtual false, abstract: false, final false
