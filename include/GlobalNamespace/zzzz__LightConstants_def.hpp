...
/// @brief Method GetComputeFieldPropertyId, addr 0x395ecac, size 0x50, virtual false, abstract: false, final false
static inline int32_t GetComputeFieldPropertyId(::StringW  fieldName) ;

/// @brief Method GetLightProbeLightBakeIdPropertyId, addr 0x395ec04, size 0xa8, virtual false, abstract: false, final false
static inline int32_t GetLightProbeLightBakeIdPropertyId(::GlobalNamespace::__LightConstants__BakeId  bakeId) ;

/// @brief Method GetLightmapLightBakeIdPropertyId, addr 0x395eb5c, size 0xa8, virtual false, abstract: false, final false
