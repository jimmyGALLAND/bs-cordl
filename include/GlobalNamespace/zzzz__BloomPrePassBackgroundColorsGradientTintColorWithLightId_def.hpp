...
/// @brief Method ColorWasSet, addr 0x395dde8, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x395de58, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
