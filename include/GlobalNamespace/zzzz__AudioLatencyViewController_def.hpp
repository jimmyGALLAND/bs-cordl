...
/// @brief Method DidActivate, addr 0x3b90654, size 0x290, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3b90980, size 0xe8, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleAmbientVolumeChanged, addr 0x3b90b64, size 0x1c, virtual false, abstract: false, final false
inline void HandleAmbientVolumeChanged(::GlobalNamespace::FormattedFloatListSettingsController*  _, float_t  newValue) ;

/// @brief Method HandleOverrideAudioLatencyToggleValueChanged, addr 0x3b90ba8, size 0x50, virtual false, abstract: false, final false
inline void HandleOverrideAudioLatencyToggleValueChanged(bool  isOn) ;

/// @brief Method HandleVolumeChanged, addr 0x3b90b48, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b90a68, size 0xe0, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method RefreshVisuals, addr 0x3b908e4, size 0x9c, virtual false, abstract: false, final false
inline void RefreshVisuals(bool  overrideAudioLatencyIsEnabled) ;

/// @brief Method SliderValueDidChange, addr 0x3b90b80, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b90bf8, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
