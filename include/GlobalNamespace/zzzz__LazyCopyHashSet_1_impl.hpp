...
template<typename T>
constexpr ::GlobalNamespace::ILazyCopyHashSet_1<T>* GlobalNamespace::LazyCopyHashSet_1<T>::i___GlobalNamespace__ILazyCopyHashSet_1_T_() noexcept {
return static_cast<::GlobalNamespace::ILazyCopyHashSet_1<T>*>(static_cast<void*>(this));
}
template<typename T>
constexpr ::System::Collections::Generic::List_1<T>*& GlobalNamespace::LazyCopyHashSet_1<T>::__cordl_internal_get__itemsCopy()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____itemsCopy;
}
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<T>*> const& GlobalNamespace::LazyCopyHashSet_1<T>::__cordl_internal_get__itemsCopy() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____itemsCopy;
}
template<typename T>
constexpr void GlobalNamespace::LazyCopyHashSet_1<T>::__cordl_internal_set__itemsCopy(::System::Collections::Generic::List_1<T>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
constexpr ::System::Collections::Generic::HashSet_1<T>*& GlobalNamespace::LazyCopyHashSet_1<T>::__cordl_internal_get__items()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____items;
}
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<T>*> const& GlobalNamespace::LazyCopyHashSet_1<T>::__cordl_internal_get__items() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____items;
}
template<typename T>
constexpr void GlobalNamespace::LazyCopyHashSet_1<T>::__cordl_internal_set__items(::System::Collections::Generic::HashSet_1<T>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
constexpr bool& GlobalNamespace::LazyCopyHashSet_1<T>::__cordl_internal_get__dirty()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____dirty;
}
template<typename T>
constexpr bool const& GlobalNamespace::LazyCopyHashSet_1<T>::__cordl_internal_get__dirty() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____dirty;
}
template<typename T>
constexpr void GlobalNamespace::LazyCopyHashSet_1<T>::__cordl_internal_set__dirty(bool  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::LazyCopyHashSet_1<T>::LazyCopyHashSet_1()   {
}
