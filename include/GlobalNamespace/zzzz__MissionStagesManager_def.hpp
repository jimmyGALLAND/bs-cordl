...
/// @brief Method <InitStages>b__6_0, addr 0x3b76ab4, size 0x18, virtual false, abstract: false, final false
inline int32_t _InitStages_b__6_0(::GlobalNamespace::MissionStage*  stage) ;

/// @brief Method .ctor, addr 0x3b76aac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method InitStages, addr 0x3b76904, size 0x144, virtual false, abstract: false, final false
inline void InitStages() ;

static inline ::GlobalNamespace::MissionStagesManager* New_ctor() ;

/// @brief Method UpdateFirtsLockedMissionStage, addr 0x3b76018, size 0x90, virtual false, abstract: false, final false
inline void UpdateFirtsLockedMissionStage(int32_t  numberOfClearedMissions) ;

/// @brief Method UpdateStageLockPosition, addr 0x3b762a8, size 0xc, virtual false, abstract: false, final false
inline void UpdateStageLockPosition() ;

/// @brief Method UpdateStageLockPositionAnimated, addr 0x3b748d4, size 0xf0, virtual false, abstract: false, final false
inline void UpdateStageLockPositionAnimated(bool  animated, float_t  animationDuration) ;

/// @brief Method UpdateStageLockText, addr 0x3b760a8, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b76a48, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_firstLockedMissionStage, addr 0x3b768fc, size 0x8, virtual false, abstract: false, final false
