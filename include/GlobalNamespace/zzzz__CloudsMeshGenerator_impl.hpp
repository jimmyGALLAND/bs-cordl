...
// Ctor Parameters [CppParam { name: "precisionOpaqueMesh", ty: "::UnityW<::UnityEngine::Mesh>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "lowPolyMesh", ty: "::UnityW<::UnityEngine::Mesh>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "sizeModifier", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "bottomThreshold", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "weight", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "precisionVertexCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "lowPolyVertexCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "generatedCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::__CloudsMeshGenerator__Cloud::__CloudsMeshGenerator__Cloud(::UnityW<::UnityEngine::Mesh>  precisionOpaqueMesh, ::UnityW<::UnityEngine::Mesh>  lowPolyMesh, float_t  sizeModifier, float_t  bottomThreshold, int32_t  weight, int32_t  precisionVertexCount, int32_t  lowPolyVertexCount, int32_t  generatedCount) noexcept  {
...
// Ctor Parameters [CppParam { name: "radius", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "normalizedRadius", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "meshCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "cloudIDs", ty: "::ArrayW<int32_t,::Array<int32_t>*>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "sizeMultiplier", ty: "float_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::__CloudsMeshGenerator__Ring::__CloudsMeshGenerator__Ring(float_t  radius, float_t  normalizedRadius, int32_t  meshCount, ::ArrayW<int32_t,::Array<int32_t>*>  cloudIDs, float_t  sizeMultiplier) noexcept  {
this->radius = radius;
...
// Ctor Parameters [CppParam { name: "transform", ty: "::UnityW<::UnityEngine::Transform>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "distance", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "radius", ty: "float_t", modifiers: "", def_value: Some("{}") }]
...
constexpr ::GlobalNamespace::__CloudsMeshGenerator__RadiusChunk::__CloudsMeshGenerator__RadiusChunk(float_t  normalizedStart, float_t  normalizedEnd, float_t  absoluteStart, float_t  absoluteEnd) noexcept  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::CloudsMeshGenerator::*)()>(&::GlobalNamespace::CloudsMeshGenerator::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2222f4c;
...
constexpr ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius,::Array<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius>*>& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__prohibitedRadii()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____prohibitedRadii;
}
constexpr ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius,::Array<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius>*> const& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__prohibitedRadii() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____prohibitedRadii;
}
constexpr void GlobalNamespace::CloudsMeshGenerator::__cordl_internal_set__prohibitedRadii(::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius,::Array<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__Cloud,::Array<::GlobalNamespace::__CloudsMeshGenerator__Cloud>*> const& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__clouds() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____clouds;
}
constexpr void GlobalNamespace::CloudsMeshGenerator::__cordl_internal_set__clouds(::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__Cloud,::Array<::GlobalNamespace::__CloudsMeshGenerator__Cloud>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__RadiusChunk,::Array<::GlobalNamespace::__CloudsMeshGenerator__RadiusChunk>*>& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__radiusChunks()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____radiusChunks;
}
constexpr ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__RadiusChunk,::Array<::GlobalNamespace::__CloudsMeshGenerator__RadiusChunk>*> const& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__radiusChunks() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____radiusChunks;
}
constexpr void GlobalNamespace::CloudsMeshGenerator::__cordl_internal_set__radiusChunks(::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__RadiusChunk,::Array<::GlobalNamespace::__CloudsMeshGenerator__RadiusChunk>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__Ring,::Array<::GlobalNamespace::__CloudsMeshGenerator__Ring>*> const& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__rings() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____rings;
}
constexpr void GlobalNamespace::CloudsMeshGenerator::__cordl_internal_set__rings(::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__Ring,::Array<::GlobalNamespace::__CloudsMeshGenerator__Ring>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius,::Array<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius>*>& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__sortedProhibitedRadii()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____sortedProhibitedRadii;
}
constexpr ::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius,::Array<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius>*> const& GlobalNamespace::CloudsMeshGenerator::__cordl_internal_get__sortedProhibitedRadii() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____sortedProhibitedRadii;
}
constexpr void GlobalNamespace::CloudsMeshGenerator::__cordl_internal_set__sortedProhibitedRadii(::ArrayW<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius,::Array<::GlobalNamespace::__CloudsMeshGenerator__ProhibitedRadius>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
