...
public:
// Declarations
/// @brief Method .ctor, addr 0x227f3f0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Field <beatmapProvider>k__BackingField, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapProvider_k__BackingField, put=__cordl_internal_set__beatmapProvider_k__BackingField)) ::GlobalNamespace::IServerBeatmapProvider*  _beatmapProvider_k__BackingField;
...
/// @brief Field <gameplayRpcManager>k__BackingField, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameplayRpcManager_k__BackingField, put=__cordl_internal_set__gameplayRpcManager_k__BackingField)) ::GlobalNamespace::GameplayRpcManager*  _gameplayRpcManager_k__BackingField;

/// @brief Field <menuRpcManager>k__BackingField, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__menuRpcManager_k__BackingField, put=__cordl_internal_set__menuRpcManager_k__BackingField)) ::GlobalNamespace::MenuRpcManager*  _menuRpcManager_k__BackingField;

/// @brief Field <multiplayerSessionManager>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerSessionManager_k__BackingField, put=__cordl_internal_set__multiplayerSessionManager_k__BackingField)) ::GlobalNamespace::IMultiplayerSessionManager*  _multiplayerSessionManager_k__BackingField;
...
/// @brief Method .ctor, addr 0x227f2d8, size 0x118, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams  initParams) ;

/// @brief Method get_beatmapProvider, addr 0x227f2a8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::IServerBeatmapProvider* get_beatmapProvider() ;

/// @brief Method get_configuration, addr 0x227f280, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayServerConfiguration get_configuration() ;

/// @brief Method get_gameplayRpcManager, addr 0x227f2c8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayRpcManager* get_gameplayRpcManager() ;

/// @brief Method get_menuRpcManager, addr 0x227f2b8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MenuRpcManager* get_menuRpcManager() ;

/// @brief Method get_multiplayerSessionManager, addr 0x227f230, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::IMultiplayerSessionManager* get_multiplayerSessionManager() ;

/// @brief Method get_ownerUserId, addr 0x227f240, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ownerUserId() ;

/// @brief Method get_selectionMask, addr 0x227f250, size 0x18, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevelSelectionMask get_selectionMask() ;

/// @brief Method get_taskUtility, addr 0x227f220, size 0x8, virtual false, abstract: false, final false
inline ::BGNet::Core::ITaskUtility* get_taskUtility() ;

/// @brief Method set_beatmapProvider, addr 0x227f2b0, size 0x8, virtual false, abstract: false, final false
inline void set_beatmapProvider(::GlobalNamespace::IServerBeatmapProvider*  value) ;

/// @brief Method set_configuration, addr 0x227f294, size 0x14, virtual false, abstract: false, final false
inline void set_configuration(::GlobalNamespace::GameplayServerConfiguration  value) ;

/// @brief Method set_gameplayRpcManager, addr 0x227f2d0, size 0x8, virtual false, abstract: false, final false
inline void set_gameplayRpcManager(::GlobalNamespace::GameplayRpcManager*  value) ;

/// @brief Method set_menuRpcManager, addr 0x227f2c0, size 0x8, virtual false, abstract: false, final false
inline void set_menuRpcManager(::GlobalNamespace::MenuRpcManager*  value) ;

/// @brief Method set_multiplayerSessionManager, addr 0x227f238, size 0x8, virtual false, abstract: false, final false
inline void set_multiplayerSessionManager(::GlobalNamespace::IMultiplayerSessionManager*  value) ;

/// @brief Method set_ownerUserId, addr 0x227f248, size 0x8, virtual false, abstract: false, final false
inline void set_ownerUserId(::StringW  value) ;

/// @brief Method set_selectionMask, addr 0x227f268, size 0x18, virtual false, abstract: false, final false
inline void set_selectionMask(::GlobalNamespace::BeatmapLevelSelectionMask  value) ;

/// @brief Method set_taskUtility, addr 0x227f228, size 0x8, virtual false, abstract: false, final false
