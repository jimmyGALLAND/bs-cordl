...
/// @brief Method .ctor, addr 0x2694bb4, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_text, addr 0x2694e54, size 0xc, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method .ctor, addr 0x2694bc4, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "localizedText", ty: "::GlobalNamespace::__SongPackMasksModel__LocalizedText", modifiers: "", def_value: None }, CppParam { name: "mask", ty: "::GlobalNamespace::SongPackMask", modifiers: "", def_value: None }]
...
/// @brief Field _songPackSerializedNameToMaskInfoDict, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__songPackSerializedNameToMaskInfoDict, put=__cordl_internal_set__songPackSerializedNameToMaskInfoDict)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::__SongPackMasksModel__MaskInfo>*  _songPackSerializedNameToMaskInfoDict;
...
/// @brief Method GetSongPackMaskText, addr 0x2694c8c, size 0x9c, virtual false, abstract: false, final false
inline ::GlobalNamespace::__SongPackMasksModel__LocalizedText GetSongPackMaskText(::GlobalNamespace::SongPackMask  songPackMask) ;

/// @brief Method Init, addr 0x26943ec, size 0x544, virtual false, abstract: false, final false
inline void Init() ;
...
/// @brief Method ToLocalizedName, addr 0x2694bd4, size 0xb8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__SongPackMasksModel__LocalizedText ToLocalizedName(::StringW  serializedName) ;

/// @brief Method ToSerializedName, addr 0x2694d28, size 0x90, virtual false, abstract: false, final false
inline ::StringW ToSerializedName(::GlobalNamespace::SongPackMask  songPackMask) ;

/// @brief Method ToSongPackMask, addr 0x2694930, size 0xcc, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::SongPackMask,::StringW>*> const& __cordl_internal_get__songPackMaskToSerializedNameDict() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::__SongPackMasksModel__MaskInfo>*> const& __cordl_internal_get__songPackSerializedNameToMaskInfoDict() const;
...
/// @brief Method .ctor, addr 0x2694348, size 0xa4, virtual false, abstract: false, final false
