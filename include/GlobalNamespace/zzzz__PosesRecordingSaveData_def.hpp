...
/// @brief Method .ctor, addr 0x3a910bc, size 0x64, virtual false, abstract: false, final false
...
/// @brief Field poses, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_poses, put=__cordl_internal_set_poses)) ::ArrayW<::GlobalNamespace::__PosesRecordingSaveData__PoseSaveData*,::Array<::GlobalNamespace::__PosesRecordingSaveData__PoseSaveData*>*>  poses;
...
static inline ::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe* New_ctor(::ArrayW<::GlobalNamespace::__PosesRecordingSaveData__PoseSaveData*,::Array<::GlobalNamespace::__PosesRecordingSaveData__PoseSaveData*>*>  poses, float_t  time) ;
...
/// @brief Method .ctor, addr 0x3a91120, size 0x38, virtual false, abstract: false, final false
...
static inline ::GlobalNamespace::__PosesRecordingSaveData__ExternalCameraCalibrationSaveData* New_ctor(float_t  fieldOfVision, float_t  nearClip, float_t  farClip, float_t  hmdOffset, float_t  nearOffset) ;
...
/// @brief Method .ctor, addr 0x3a91158, size 0x50, virtual false, abstract: false, final false
...
/// @brief Field externalCameraCalibration, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_externalCameraCalibration, put=__cordl_internal_set_externalCameraCalibration)) ::GlobalNamespace::__PosesRecordingSaveData__ExternalCameraCalibrationSaveData*  externalCameraCalibration;

/// @brief Field keyframes, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_keyframes, put=__cordl_internal_set_keyframes)) ::ArrayW<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*,::Array<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*>*>  keyframes;
...
static inline ::GlobalNamespace::PosesRecordingSaveData* New_ctor(::ArrayW<::StringW,::Array<::StringW>*>  objectIds, ::ArrayW<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*,::Array<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*>*>  keyframes, ::GlobalNamespace::__PosesRecordingSaveData__ExternalCameraCalibrationSaveData*  externalCameraCalibration) ;
...
constexpr ::ArrayW<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*,::Array<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*>*> const& __cordl_internal_get_keyframes() const;

constexpr ::ArrayW<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*,::Array<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*>*>& __cordl_internal_get_keyframes() ;
...
constexpr void __cordl_internal_set_keyframes(::ArrayW<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*,::Array<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*>*>  value) ;

constexpr void __cordl_internal_set_objectIds(::ArrayW<::StringW,::Array<::StringW>*>  value) ;

/// @brief Method .ctor, addr 0x3a91080, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::StringW,::Array<::StringW>*>  objectIds, ::ArrayW<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*,::Array<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*>*>  keyframes, ::GlobalNamespace::__PosesRecordingSaveData__ExternalCameraCalibrationSaveData*  externalCameraCalibration) ;
