...
/// @brief Field _compressExpand, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__compressExpand, put=__cordl_internal_set__compressExpand)) ::GlobalNamespace::__EnvironmentIntensityReductionOptions__CompressExpandReductionType  _compressExpand;

/// @brief Field _rotateRings, offset 0x14, size 0x4 
 __declspec(property(get=__cordl_internal_get__rotateRings, put=__cordl_internal_set__rotateRings)) ::GlobalNamespace::__EnvironmentIntensityReductionOptions__RotateRingsReductionType  _rotateRings;
...
/// @brief Method .ctor, addr 0x26618cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_compressExpand, addr 0x26618bc, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__EnvironmentIntensityReductionOptions__CompressExpandReductionType get_compressExpand() ;

/// @brief Method get_rotateRings, addr 0x26618c4, size 0x8, virtual false, abstract: false, final false
