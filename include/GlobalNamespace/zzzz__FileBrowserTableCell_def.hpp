...
/// @brief Method HighlightDidChange, addr 0x3b6c7c8, size 0x40, virtual true, abstract: false, final false
inline void HighlightDidChange(::HMUI::__SelectableCell__TransitionType  transitionType) ;

static inline ::GlobalNamespace::FileBrowserTableCell* New_ctor() ;

/// @brief Method SelectionDidChange, addr 0x3b6c730, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b6c808, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_text, addr 0x3b6c70c, size 0x24, virtual false, abstract: false, final false
inline ::StringW get_text() ;

/// @brief Method set_text, addr 0x3b6c6e8, size 0x24, virtual false, abstract: false, final false
