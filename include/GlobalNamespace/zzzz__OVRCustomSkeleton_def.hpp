...
/// @brief Method AllocateBones, addr 0x3f9fe18, size 0xc4, virtual false, abstract: false, final false
inline void AllocateBones() ;

/// @brief Method GetBoneTransform, addr 0x3f9fdb8, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method SetSkeletonType, addr 0x3f9fedc, size 0x80, virtual true, abstract: false, final false
inline void SetSkeletonType(::GlobalNamespace::__OVRSkeleton__SkeletonType  skeletonType) ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x3f9fe14, size 0x4, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x3f9fe10, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3f9ff5c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CustomBones, addr 0x3f9fdb0, size 0x8, virtual false, abstract: false, final false
