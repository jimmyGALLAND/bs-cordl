...
/// @brief Method <ProcessMesh>b__0, addr 0x3f226a4, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f20ad8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static __declspec(property(get=getStaticF_InputNodeNameMap, put=setStaticF_InputNodeNameMap)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::OVRGLTFInputNode>*  InputNodeNameMap;
...
/// @brief Field m_AnimationLookup, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AnimationLookup, put=__cordl_internal_set_m_AnimationLookup)) ::System::Collections::Generic::Dictionary_2<int32_t,::ArrayW<::GlobalNamespace::OVRGLTFAnimatinonNode*,::Array<::GlobalNamespace::OVRGLTFAnimatinonNode*>*>>*  m_AnimationLookup;

/// @brief Field m_InputAnimationNodes, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_InputAnimationNodes, put=__cordl_internal_set_m_InputAnimationNodes)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::OVRGLTFInputNode,::GlobalNamespace::OVRGLTFAnimatinonNode*>*  m_InputAnimationNodes;
...
/// @brief Field m_morphTargetHandlers, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_morphTargetHandlers, put=__cordl_internal_set_m_morphTargetHandlers)) ::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::OVRGLTFAnimationNodeMorphTargetHandler*>*  m_morphTargetHandlers;

/// @brief Field textureUriHandler, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get_textureUriHandler, put=__cordl_internal_set_textureUriHandler)) ::System::Func_3<::StringW,::UnityW<::UnityEngine::Material>,::UnityW<::UnityEngine::Texture2D>>*  textureUriHandler;

/// @brief Method ApplyTextureQuality, addr 0x3f1edd0, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method CreateUnityMaterial, addr 0x3f21fa4, size 0x274, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> CreateUnityMaterial(::GlobalNamespace::OVRMaterialData  matData, bool  loadMips) ;

/// @brief Method DetectTextureQuality, addr 0x3f1ed10, size 0xc0, virtual false, abstract: false, final false
static inline ::GlobalNamespace::OVRTextureQualityFiltering DetectTextureQuality(ByRef<::UnityEngine::Texture2D*>  srcTexture) ;

/// @brief Method FlipTraingleIndices, addr 0x3f21368, size 0x6c, virtual false, abstract: false, final false
static inline void FlipTraingleIndices(ByRef<::ArrayW<int32_t,::Array<int32_t>*>>  indices) ;

/// @brief Method GetInputNodeType, addr 0x3f222cc, size 0x19c, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRGLTFInputNode GetInputNodeType(::StringW  name) ;

/// @brief Method LoadGLB, addr 0x3f1df10, size 0x63c, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRGLTFScene LoadGLB(bool  supportAnimation, bool  loadMips) ;

/// @brief Method LoadGLTF, addr 0x3f1e8e8, size 0x3f4, virtual false, abstract: false, final false
...
/// @brief Method ProcessAnimations, addr 0x3f1f888, size 0x518, virtual false, abstract: false, final false
inline void ProcessAnimations() ;

/// @brief Method ProcessMaterial, addr 0x3f20ae0, size 0x388, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRMaterialData ProcessMaterial(int32_t  matId) ;

/// @brief Method ProcessMesh, addr 0x3f1fda0, size 0x91c, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRMeshData ProcessMesh(::OVRSimpleJSON::JSONNode*  meshNode, bool  loadMips) ;

/// @brief Method ProcessNode, addr 0x3f1ef44, size 0x944, virtual false, abstract: false, final false
inline void ProcessNode(::OVRSimpleJSON::JSONNode*  node, int32_t  nodeId, bool  loadMips) ;

/// @brief Method ProcessSkin, addr 0x3f206bc, size 0x41c, virtual false, abstract: false, final false
inline void ProcessSkin(::OVRSimpleJSON::JSONNode*  skinNode, ::UnityEngine::SkinnedMeshRenderer*  renderer) ;

/// @brief Method ProcessTexture, addr 0x3f20e68, size 0x500, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRTextureData ProcessTexture(int32_t  textureId) ;

/// @brief Method ReadChunk, addr 0x3f1e718, size 0xac, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadChunk(::System::IO::Stream*  glbStream, ::GlobalNamespace::OVRChunkType  type) ;

/// @brief Method ReadMeshAttributes, addr 0x3f213d4, size 0xbd0, virtual false, abstract: false, final false
...
/// @brief Method SetMipMapBias, addr 0x3f1ecf4, size 0x1c, virtual false, abstract: false, final false
inline void SetMipMapBias(float_t  loadedTexturesMipmapBiasing) ;

/// @brief Method SetModelAlphaBlendShader, addr 0x3f1ece4, size 0x8, virtual false, abstract: false, final false
inline void SetModelAlphaBlendShader(::UnityEngine::Shader*  shader) ;

/// @brief Method SetModelShader, addr 0x3f1ecdc, size 0x8, virtual false, abstract: false, final false
inline void SetModelShader(::UnityEngine::Shader*  shader) ;

/// @brief Method SetTextureQualityFiltering, addr 0x3f1ecec, size 0x8, virtual false, abstract: false, final false
inline void SetTextureQualityFiltering(::GlobalNamespace::OVRTextureQualityFiltering  loadedTexturesQuality) ;

/// @brief Method TranscodeTexture, addr 0x3f22218, size 0xb4, virtual false, abstract: false, final false
inline void TranscodeTexture(ByRef<::GlobalNamespace::OVRTextureData>  textureData) ;

/// @brief Method ValidateChunk, addr 0x3f1e7c4, size 0x124, virtual false, abstract: false, final false
inline bool ValidateChunk(::System::IO::Stream*  glbStream, ::GlobalNamespace::OVRChunkType  type, ByRef<uint32_t>  chunkLength) ;

/// @brief Method ValidateGLB, addr 0x3f1e54c, size 0x1cc, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::ArrayW<::GlobalNamespace::OVRGLTFAnimatinonNode*,::Array<::GlobalNamespace::OVRGLTFAnimatinonNode*>*>>*& __cordl_internal_get_m_AnimationLookup() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::ArrayW<::GlobalNamespace::OVRGLTFAnimatinonNode*,::Array<::GlobalNamespace::OVRGLTFAnimatinonNode*>*>>*> const& __cordl_internal_get_m_AnimationLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::OVRGLTFInputNode,::GlobalNamespace::OVRGLTFAnimatinonNode*>*> const& __cordl_internal_get_m_InputAnimationNodes() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::OVRGLTFAnimationNodeMorphTargetHandler*>*> const& __cordl_internal_get_m_morphTargetHandlers() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_3<::StringW,::UnityW<::UnityEngine::Material>,::UnityW<::UnityEngine::Texture2D>>*> const& __cordl_internal_get_textureUriHandler() const;

constexpr void __cordl_internal_set_m_AlphaBlendShader(::UnityW<::UnityEngine::Shader>  value) ;

constexpr void __cordl_internal_set_m_AnimationLookup(::System::Collections::Generic::Dictionary_2<int32_t,::ArrayW<::GlobalNamespace::OVRGLTFAnimatinonNode*,::Array<::GlobalNamespace::OVRGLTFAnimatinonNode*>*>>*  value) ;
...
/// @brief Method .ctor, addr 0x3f1de8c, size 0x84, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method .ctor, addr 0x3f1de54, size 0x38, virtual false, abstract: false, final false
