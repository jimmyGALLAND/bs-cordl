...
constexpr ::GlobalNamespace::BladeMovementDataElement::BladeMovementDataElement(float_t  time, float_t  segmentAngle, ::UnityEngine::Vector3  topPos, ::UnityEngine::Vector3  bottomPos, ::UnityEngine::Vector3  segmentNormal) noexcept  {
this->time = time;
