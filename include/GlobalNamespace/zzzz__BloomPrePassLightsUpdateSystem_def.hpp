...
/// @brief Method LateUpdate, addr 0x3956060, size 0x2d4, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::BloomPrePassLightsUpdateSystem* New_ctor() ;

/// @brief Method .ctor, addr 0x3956334, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
