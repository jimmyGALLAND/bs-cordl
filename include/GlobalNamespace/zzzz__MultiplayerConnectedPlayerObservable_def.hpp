...
/// @brief Method .ctor, addr 0x3b37cf0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::IConnectedPlayer*  connectedPlayer) ;

/// @brief Method get_isFailed, addr 0x3b37dbc, size 0xc, virtual true, abstract: false, final true
inline bool get_isFailed() ;

/// @brief Method get_offsetSyncTime, addr 0x3b37d18, size 0xa4, virtual true, abstract: false, final true
