...
/// @brief Method Awake, addr 0x3b09a20, size 0xa0, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::SpectrogramRow* New_ctor() ;

/// @brief Method Update, addr 0x3b09ac0, size 0x120, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b09be0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
