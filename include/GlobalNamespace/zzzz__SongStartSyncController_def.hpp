...
/// @brief Method HandleSetSongStartSyncTime, addr 0x3de376c, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method OnApplicationPause, addr 0x3de35e0, size 0x44, virtual false, abstract: false, final false
inline void OnApplicationPause(bool  pauseStatus) ;

/// @brief Method OnDestroy, addr 0x3de356c, size 0x14, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3de3560, size 0xc, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartSong, addr 0x3de3624, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x3de3580, size 0x60, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3de3798, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_syncResumeEvent, addr 0x3de3400, size 0xb0, virtual false, abstract: false, final false
inline void add_syncResumeEvent(::System::Action_1<int64_t>*  value) ;

/// @brief Method add_syncStartFailedEvent, addr 0x3de3168, size 0x9c, virtual false, abstract: false, final false
inline void add_syncStartFailedEvent(::System::Action*  value) ;

/// @brief Method add_syncStartSuccessEvent, addr 0x3de32a0, size 0xb0, virtual false, abstract: false, final false
inline void add_syncStartSuccessEvent(::System::Action_1<int64_t>*  value) ;

/// @brief Method get_isSongStarted, addr 0x3de3144, size 0x8, virtual false, abstract: false, final false
inline bool get_isSongStarted() ;

/// @brief Method get_songStartSyncTime, addr 0x3de314c, size 0x1c, virtual false, abstract: false, final false
inline int64_t get_songStartSyncTime() ;

/// @brief Method remove_syncResumeEvent, addr 0x3de34b0, size 0xb0, virtual false, abstract: false, final false
inline void remove_syncResumeEvent(::System::Action_1<int64_t>*  value) ;

/// @brief Method remove_syncStartFailedEvent, addr 0x3de3204, size 0x9c, virtual false, abstract: false, final false
inline void remove_syncStartFailedEvent(::System::Action*  value) ;

/// @brief Method remove_syncStartSuccessEvent, addr 0x3de3350, size 0xb0, virtual false, abstract: false, final false
