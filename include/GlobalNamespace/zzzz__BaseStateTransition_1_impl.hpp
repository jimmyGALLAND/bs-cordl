...
template<typename T>
constexpr T& GlobalNamespace::BaseStateTransition_1<T>::__cordl_internal_get__component()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____component;
}
template<typename T>
constexpr T const& GlobalNamespace::BaseStateTransition_1<T>::__cordl_internal_get__component() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____component;
}
template<typename T>
constexpr void GlobalNamespace::BaseStateTransition_1<T>::__cordl_internal_set__component(T  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::BaseStateTransition_1<T>::BaseStateTransition_1()   {
}
