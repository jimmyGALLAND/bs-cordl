...
/// @brief Method RestartLevel, addr 0x3b1c8dc, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b1c91c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
