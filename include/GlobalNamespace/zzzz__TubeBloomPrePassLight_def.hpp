...
/// @brief Field _dynamic3SliceSprite, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get__dynamic3SliceSprite, put=__cordl_internal_set__dynamic3SliceSprite)) ::UnityW<::GlobalNamespace::Parametric3SliceSpriteController>  _dynamic3SliceSprite;
...
/// @brief Field _mainEffectPostProcessEnabled, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__mainEffectPostProcessEnabled, put=__cordl_internal_set__mainEffectPostProcessEnabled)) ::UnityW<::GlobalNamespace::BoolSO>  _mainEffectPostProcessEnabled;
...
/// @brief Field _multiplyLengthByAlphaBloomFogMultiplier, offset 0x100, size 0x4 
 __declspec(property(get=__cordl_internal_get__multiplyLengthByAlphaBloomFogMultiplier, put=__cordl_internal_set__multiplyLengthByAlphaBloomFogMultiplier)) float_t  _multiplyLengthByAlphaBloomFogMultiplier;
...
/// @brief Field _parametricBoxController, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get__parametricBoxController, put=__cordl_internal_set__parametricBoxController)) ::UnityW<::GlobalNamespace::ParametricBoxController>  _parametricBoxController;

/// @brief Field _parametricBoxControllerOnceParInitialized, offset 0xea, size 0x1 
 __declspec(property(get=__cordl_internal_get__parametricBoxControllerOnceParInitialized, put=__cordl_internal_set__parametricBoxControllerOnceParInitialized)) bool  _parametricBoxControllerOnceParInitialized;
...
/// @brief Method Awake, addr 0x3958fe8, size 0x14, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ClipPoints, addr 0x3959d70, size 0x94, virtual false, abstract: false, final false
static inline void ClipPoints(ByRef<::UnityEngine::Vector4>  fromPointClipPos, ByRef<::UnityEngine::Vector4>  toPointClipPos, ByRef<::UnityEngine::Vector3>  fromPointViewPos, ByRef<::UnityEngine::Vector3>  toPointViewPos, bool  fromPointInside, float_t  t) ;

/// @brief Method DidRegisterLight, addr 0x395901c, size 0x1c, virtual true, abstract: false, final false
inline void DidRegisterLight() ;

/// @brief Method FillMeshData, addr 0x3959434, size 0x8a4, virtual true, abstract: false, final false
...
/// @brief Method InitIfNeeded, addr 0x3958d50, size 0xc4, virtual false, abstract: false, final false
inline void InitIfNeeded() ;

/// @brief Method MarkDirty, addr 0x3958eb8, size 0xc, virtual false, abstract: false, final false
inline void MarkDirty() ;

/// @brief Method NeedsRefresh, addr 0x3959038, size 0x68, virtual false, abstract: false, final false
inline bool NeedsRefresh() ;

static inline ::GlobalNamespace::TubeBloomPrePassLight* New_ctor() ;

/// @brief Method OnDrawGizmos, addr 0x3959e04, size 0x15c, virtual false, abstract: false, final false
inline void OnDrawGizmos() ;

/// @brief Method OnEnable, addr 0x3958ffc, size 0x20, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Refresh, addr 0x39590a0, size 0x394, virtual true, abstract: false, final false
inline void Refresh() ;

/// @brief Method ZeroQuad, addr 0x3959cd8, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3959f60, size 0x120, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didRefreshEvent, addr 0x3958ba8, size 0x9c, virtual false, abstract: false, final false
inline void add_didRefreshEvent(::System::Action*  value) ;

/// @brief Method get_bloomFogIntensityMultiplier, addr 0x3958f1c, size 0x8, virtual false, abstract: false, final false
inline float_t get_bloomFogIntensityMultiplier() ;

/// @brief Method get_calculatedCollisionLength, addr 0x3958e94, size 0x24, virtual false, abstract: false, final false
inline float_t get_calculatedCollisionLength() ;

/// @brief Method get_center, addr 0x3958cf0, size 0x8, virtual false, abstract: false, final false
inline float_t get_center() ;

/// @brief Method get_collisionEndAlpha, addr 0x3958e2c, size 0x68, virtual false, abstract: false, final false
inline float_t get_collisionEndAlpha() ;

/// @brief Method get_collisionLength, addr 0x3958e14, size 0x8, virtual false, abstract: false, final false
inline float_t get_collisionLength() ;

/// @brief Method get_color, addr 0x3958fdc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_colorAlphaMultiplier, addr 0x3958ce8, size 0x8, virtual false, abstract: false, final false
inline float_t get_colorAlphaMultiplier() ;

/// @brief Method get_enabledRenderers, addr 0x3958ce0, size 0x8, virtual false, abstract: false, final false
inline bool get_enabledRenderers() ;

/// @brief Method get_length, addr 0x3958ec4, size 0x8, virtual false, abstract: false, final false
inline float_t get_length() ;

/// @brief Method get_lightWidthMultiplier, addr 0x3958f0c, size 0x8, virtual false, abstract: false, final false
inline float_t get_lightWidthMultiplier() ;

/// @brief Method get_startAlpha, addr 0x3958ef4, size 0x8, virtual false, abstract: false, final false
inline float_t get_startAlpha() ;

/// @brief Method get_useCollision, addr 0x3958cf8, size 0x8, virtual false, abstract: false, final false
inline bool get_useCollision() ;

/// @brief Method get_width, addr 0x3958edc, size 0x8, virtual false, abstract: false, final false
inline float_t get_width() ;

/// @brief Method remove_didRefreshEvent, addr 0x3958c44, size 0x9c, virtual false, abstract: false, final false
inline void remove_didRefreshEvent(::System::Action*  value) ;

/// @brief Method set_bloomFogIntensityMultiplier, addr 0x3958f24, size 0x8, virtual false, abstract: false, final false
inline void set_bloomFogIntensityMultiplier(float_t  value) ;

/// @brief Method set_collisionLength, addr 0x3958e1c, size 0x10, virtual false, abstract: false, final false
inline void set_collisionLength(float_t  value) ;

/// @brief Method set_color, addr 0x3958f2c, size 0xb0, virtual false, abstract: false, final false
inline void set_color(::UnityEngine::Color  value) ;

/// @brief Method set_length, addr 0x3958ecc, size 0x10, virtual false, abstract: false, final false
inline void set_length(float_t  value) ;

/// @brief Method set_lightWidthMultiplier, addr 0x3958f14, size 0x8, virtual false, abstract: false, final false
inline void set_lightWidthMultiplier(float_t  value) ;

/// @brief Method set_startAlpha, addr 0x3958efc, size 0x10, virtual false, abstract: false, final false
inline void set_startAlpha(float_t  value) ;

/// @brief Method set_useCollision, addr 0x3958d00, size 0x50, virtual false, abstract: false, final false
inline void set_useCollision(bool  value) ;

/// @brief Method set_width, addr 0x3958ee4, size 0x10, virtual false, abstract: false, final false
