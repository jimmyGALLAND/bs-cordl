...
/// @brief Method MoveNext, addr 0x3de211c, size 0x2cc, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3de23e8, size 0x7c, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x3de2464, size 0x260, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3de26c4, size 0xc, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method GetEntitlementStatus, addr 0x3de2028, size 0xec, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::EntitlementsStatus>* GetEntitlementStatus(::StringW  levelId) ;

/// @brief Method HandleDataInvalidated, addr 0x3de1eec, size 0xa4, virtual false, abstract: false, final false
inline void HandleDataInvalidated() ;

/// @brief Method HandleGetIsEntitledToLevel, addr 0x3de1f90, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3de1d2c, size 0x1c0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3de1c38, size 0xf4, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3de2114, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::NetworkPlayerEntitlementChecker, 0x38>, "Size mismatch!");
