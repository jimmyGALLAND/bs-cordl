...
/// @brief Method Fade, addr 0x3942964, size 0x2c, virtual false, abstract: false, final false
static inline float_t Fade(float_t  t) ;

/// @brief Method Grad3D, addr 0x39429a8, size 0x74, virtual false, abstract: false, final false
static inline float_t Grad3D(int32_t  hash, float_t  x, float_t  y, float_t  z) ;

/// @brief Method Inc, addr 0x3942990, size 0x18, virtual false, abstract: false, final false
static inline int32_t Inc(int32_t  num, int32_t  repeat) ;

/// @brief Method Lerp, addr 0x3942a1c, size 0x10, virtual false, abstract: false, final false
static inline float_t Lerp(float_t  a, float_t  b, float_t  x) ;

static inline ::GlobalNamespace::PerlinNoise* New_ctor() ;

/// @brief Method OctavePerlin3D, addr 0x3942340, size 0xdc, virtual false, abstract: false, final false
static inline float_t OctavePerlin3D(float_t  x, float_t  y, float_t  z, int32_t  octaves, float_t  persistence, int32_t  repeat) ;

/// @brief Method Perlin3D, addr 0x394241c, size 0x548, virtual false, abstract: false, final false
static inline float_t Perlin3D(float_t  x, float_t  y, float_t  z, int32_t  repeat) ;

/// @brief Method .ctor, addr 0x3942a2c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
