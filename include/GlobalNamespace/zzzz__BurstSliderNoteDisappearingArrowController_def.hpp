...
/// @brief Method .ctor, addr 0x3a5fe44, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_gameNoteController, addr 0x3a5fe3c, size 0x8, virtual true, abstract: false, final false
