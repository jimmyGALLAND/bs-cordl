...
/// @brief Method ActivateSmoothCameraIfNeeded, addr 0x3b59678, size 0xe8, virtual false, abstract: false, final false
inline void ActivateSmoothCameraIfNeeded() ;

/// @brief Method HandleDidActivate, addr 0x3b59764, size 0x40, virtual false, abstract: false, final false
inline void HandleDidActivate() ;

/// @brief Method HandleDidDeactivate, addr 0x3b597a4, size 0x4, virtual false, abstract: false, final false
inline void HandleDidDeactivate() ;

static inline ::GlobalNamespace::SmoothCameraController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b59760, size 0x4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b59674, size 0x4, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b597a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
