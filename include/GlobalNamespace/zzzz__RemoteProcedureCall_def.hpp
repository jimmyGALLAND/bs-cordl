...
/// @brief Method DeserializeData, addr 0x2297ee4, size 0x4, virtual true, abstract: false, final false
inline void DeserializeData(::LiteNetLib::Utils::NetDataReader*  reader, uint32_t  protocolVersion) ;

/// @brief Method Init, addr 0x229806c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::IRemoteProcedureCall* Init(int64_t  syncTime) ;

/// @brief Method LiteNetLib.Utils.INetSerializable.Deserialize, addr 0x2297f2c, size 0x40, virtual true, abstract: false, final true
inline void LiteNetLib_Utils_INetSerializable_Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method LiteNetLib.Utils.INetSerializable.Serialize, addr 0x2297ee8, size 0x44, virtual true, abstract: false, final true
...
/// @brief Method Release, addr 0x2297f6c, size 0x4, virtual true, abstract: false, final false
inline void Release() ;

/// @brief Method SerializeData, addr 0x2297ee0, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x228cce8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_syncTime, addr 0x2297ed0, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_syncTime, addr 0x2297ed8, size 0x8, virtual false, abstract: false, final false
