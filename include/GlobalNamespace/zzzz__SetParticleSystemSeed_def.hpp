...
/// @brief Method Awake, addr 0x3af2d6c, size 0x4c, virtual false, abstract: false, final false
inline void Awake() ;
...
/// @brief Method .ctor, addr 0x3af2db8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
