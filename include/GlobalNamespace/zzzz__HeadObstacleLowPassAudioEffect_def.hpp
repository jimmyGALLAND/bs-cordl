...
/// @brief Method Update, addr 0x3af78d0, size 0x5c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3af792c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
