...
/// @brief Method ProcessBeforeDeleteEventDataInternal, addr 0x2203080, size 0xfc, virtual true, abstract: false, final false
...
/// @brief Method ProcessInsertedEventDataInternal, addr 0x2202f70, size 0x110, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x220317c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
