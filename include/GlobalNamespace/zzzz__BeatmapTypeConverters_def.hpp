...
public:
// Declarations
/// @brief Method ConvertBasicBeatmapEventType, addr 0x266c224, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ConvertDistributionParamType, addr 0x266c228, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ConvertEaseType, addr 0x266c0f8, size 0xe0, virtual false, abstract: false, final false
static inline ::GlobalNamespace::EaseType ConvertEaseType(::BeatmapSaveDataCommon::EaseType  easeType) ;

/// @brief Method ConvertEnvironmentColorType, addr 0x266c0d0, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method ConvertLightAxis, addr 0x266c0e4, size 0x14, virtual false, abstract: false, final false
static inline ::GlobalNamespace::LightAxis ConvertLightAxis(::BeatmapSaveDataCommon::Axis  axis) ;

/// @brief Method ConvertLightRotationDirection, addr 0x266c210, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method ConvertNoteColorType, addr 0x266c0c0, size 0x10, virtual false, abstract: false, final false
static inline ::GlobalNamespace::ColorType ConvertNoteColorType(::BeatmapSaveDataCommon::NoteColorType  noteType) ;

/// @brief Method ConvertNoteColorType, addr 0x266c0b0, size 0x10, virtual false, abstract: false, final false
static inline ::GlobalNamespace::ColorType ConvertNoteColorType(::BeatmapSaveDataVersion2_6_0AndEarlier::ColorType  noteType) ;

/// @brief Method ConvertNoteCutDirection, addr 0x266c238, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ConvertNoteLineLayer, addr 0x266c1ec, size 0x14, virtual false, abstract: false, final false
static inline ::GlobalNamespace::NoteLineLayer ConvertNoteLineLayer(::BeatmapSaveDataCommon::NoteLineLayer  layer) ;

/// @brief Method ConvertNoteLineLayer, addr 0x266c1d8, size 0x14, virtual false, abstract: false, final false
static inline ::GlobalNamespace::NoteLineLayer ConvertNoteLineLayer(int32_t  layer) ;

/// @brief Method ConvertOffsetDirection, addr 0x266c25c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method ConvertSliderDataType, addr 0x266c200, size 0x10, virtual false, abstract: false, final false
static inline ::GlobalNamespace::__SliderData__Type ConvertSliderDataType(::BeatmapSaveDataVersion3::SliderType  sliderType) ;

/// @brief Method ConvertSliderMidAnchorMode, addr 0x266c248, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method ConvertSpawnRotationEventType, addr 0x266c294, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ConvertTransitionTypeToEaseType, addr 0x266c288, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method ConvertTransitionTypeToExtension, addr 0x266c27c, size 0xc, virtual false, abstract: false, final false
