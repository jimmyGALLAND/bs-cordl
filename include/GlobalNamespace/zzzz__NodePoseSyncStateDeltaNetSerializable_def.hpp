...
/// @brief Method Deserialize, addr 0x229d8bc, size 0x74, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

static inline ::GlobalNamespace::NodePoseSyncStateDeltaNetSerializable* New_ctor() ;

/// @brief Method Release, addr 0x229d95c, size 0xac, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x229d7f4, size 0x94, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x229da08, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_baseId, addr 0x229d7ac, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::SyncStateId get_baseId() ;

/// @brief Method get_delta, addr 0x229d7cc, size 0x10, virtual true, abstract: false, final true
inline ::GlobalNamespace::NodePoseSyncState get_delta() ;

/// @brief Method get_pool, addr 0x229d76c, size 0x40, virtual false, abstract: false, final false
static inline ::GlobalNamespace::IPacketPool_1<::GlobalNamespace::NodePoseSyncStateDeltaNetSerializable*>* get_pool() ;

/// @brief Method get_timeOffsetMs, addr 0x229d7bc, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_baseId, addr 0x229d7b4, size 0x8, virtual true, abstract: false, final true
inline void set_baseId(::GlobalNamespace::SyncStateId  value) ;

/// @brief Method set_delta, addr 0x229d7dc, size 0x18, virtual true, abstract: false, final true
inline void set_delta(::GlobalNamespace::NodePoseSyncState  value) ;

/// @brief Method set_timeOffsetMs, addr 0x229d7c4, size 0x8, virtual true, abstract: false, final true
