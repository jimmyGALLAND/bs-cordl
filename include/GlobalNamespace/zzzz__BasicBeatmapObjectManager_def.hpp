...
/// @brief Method .ctor, addr 0x3a54404, size 0x44, virtual false, abstract: false, final false
...
/// @brief Field _basicGameNotePoolContainer, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get__basicGameNotePoolContainer, put=__cordl_internal_set__basicGameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::GameNoteController>>*  _basicGameNotePoolContainer;

/// @brief Field _bombNotePoolContainer, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get__bombNotePoolContainer, put=__cordl_internal_set__bombNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::BombNoteController>>*  _bombNotePoolContainer;

/// @brief Field _burstSliderGameNotePoolContainer, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderGameNotePoolContainer, put=__cordl_internal_set__burstSliderGameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::BurstSliderGameNoteController>>*  _burstSliderGameNotePoolContainer;

/// @brief Field _burstSliderHeadGameNotePoolContainer, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderHeadGameNotePoolContainer, put=__cordl_internal_set__burstSliderHeadGameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::GameNoteController>>*  _burstSliderHeadGameNotePoolContainer;
...
/// @brief Field _obstaclePoolContainer, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get__obstaclePoolContainer, put=__cordl_internal_set__obstaclePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::ObstacleController>>*  _obstaclePoolContainer;

/// @brief Field _sliderNotePoolContainersDictionary, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get__sliderNotePoolContainersDictionary, put=__cordl_internal_set__sliderNotePoolContainersDictionary)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__SliderController__LengthType,::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::SliderController>>*>*  _sliderNotePoolContainersDictionary;
...
/// @brief Method ProcessObstacleData, addr 0x3a533d0, size 0xf4, virtual true, abstract: false, final false
...
/// @brief Method ProcessSliderData, addr 0x3a53db4, size 0x240, virtual true, abstract: false, final false
...
/// @brief Method __InvalidateBombNotePool, addr 0x3a542f0, size 0x94, virtual false, abstract: false, final false
inline void __InvalidateBombNotePool() ;

/// @brief Method __InvalidateGameNotePools, addr 0x3a54228, size 0xc8, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::GameNoteController>>*> const& __cordl_internal_get__basicGameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::BurstSliderGameNoteController>>*> const& __cordl_internal_get__burstSliderGameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::GameNoteController>>*> const& __cordl_internal_get__burstSliderHeadGameNotePoolContainer() const;
...
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__SliderController__LengthType,::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::SliderController>>*>*& __cordl_internal_get__sliderNotePoolContainersDictionary() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__SliderController__LengthType,::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::SliderController>>*>*> const& __cordl_internal_get__sliderNotePoolContainersDictionary() const;
...
constexpr void __cordl_internal_set__sliderNotePoolContainersDictionary(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__SliderController__LengthType,::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::SliderController>>*>*  value) ;

/// @brief Method .ctor, addr 0x3a54384, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_activeObstacleControllers, addr 0x3a52df8, size 0x50, virtual true, abstract: false, final false
...
/// @brief Field _sliderNotePoolContainersDictionary, offset: 0xd8, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__SliderController__LengthType,::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::SliderController>>*>*  ____sliderNotePoolContainersDictionary;
