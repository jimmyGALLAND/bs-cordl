...
public:
// Declarations
/// @brief Method GetScores, addr 0x26b8dac, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method UploadScore, addr 0x26b8e00, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26b8e54, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
