...
/// @brief Field _rotationDirection, offset 0x34, size 0x4 
 __declspec(property(get=__cordl_internal_get__rotationDirection, put=__cordl_internal_set__rotationDirection)) ::GlobalNamespace::__LightGroupCircularLayouter__RotationDirection  _rotationDirection;
...
/// @brief Method .ctor, addr 0x3afbf38, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
