...
/// @brief Method .ctor, addr 0x395ddd8, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _elements, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__elements, put=__cordl_internal_set__elements)) ::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientElementWithLightId__Elements*,::Array<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientElementWithLightId__Elements*>*>  _elements;

/// @brief Method ColorWasSet, addr 0x395dd0c, size 0xac, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientElementWithLightId__Elements*,::Array<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientElementWithLightId__Elements*>*> const& __cordl_internal_get__elements() const;

constexpr ::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientElementWithLightId__Elements*,::Array<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientElementWithLightId__Elements*>*>& __cordl_internal_get__elements() ;
...
constexpr void __cordl_internal_set__elements(::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientElementWithLightId__Elements*,::Array<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientElementWithLightId__Elements*>*>  value) ;

/// @brief Method .ctor, addr 0x395ddb8, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _elements, offset: 0x40, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientElementWithLightId__Elements*,::Array<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientElementWithLightId__Elements*>*>  ____elements;
