...
public:
// Declarations
/// @brief Method ContainsLayer, addr 0x2268098, size 0x30, virtual false, abstract: false, final false
static inline bool ContainsLayer(::UnityEngine::LayerMask  layerMask, int32_t  layer) ;

/// @brief Method CreateTexture2D, addr 0x2268534, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method GetPath, addr 0x22682ac, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method IsDescendantOf, addr 0x2268188, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method Reflect, addr 0x22683ac, size 0x188, virtual false, abstract: false, final false
static inline ::UnityEngine::Quaternion Reflect(::UnityEngine::Quaternion  source, ::UnityEngine::Vector3  normal) ;

/// @brief Method Rotate, addr 0x226865c, size 0x48, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 Rotate(::UnityEngine::Vector2  vector, float_t  rads) ;

/// @brief Method SetLocalPositionAndRotation, addr 0x2268254, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method SetSeed, addr 0x22686a4, size 0x74, virtual false, abstract: false, final false
static inline void SetSeed(::UnityEngine::ParticleSystem*  particleSystem, uint32_t  seed) ;

/// @brief Method StartUniqueCoroutine, addr 0x22680c8, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method StopUniqueCoroutine, addr 0x2268144, size 0x44, virtual false, abstract: false, final false
