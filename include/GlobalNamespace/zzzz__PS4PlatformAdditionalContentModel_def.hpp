...
public:
// Declarations
static inline ::GlobalNamespace::PS4PlatformAdditionalContentModel* New_ctor(::GlobalNamespace::ISonyCommerceHelper*  sonyCommerceHelper, ::GlobalNamespace::SonyLevelProductCollectionModel*  sonyLevelProductCollectionModel) ;

/// @brief Method .ctor, addr 0x269a844, size 0x4, virtual false, abstract: false, final false
