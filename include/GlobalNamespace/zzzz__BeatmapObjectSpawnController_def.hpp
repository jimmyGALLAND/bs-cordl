...
/// @brief Field noteJumpValueType, offset 0x1c, size 0x4 
 __declspec(property(get=__cordl_internal_get_noteJumpValueType, put=__cordl_internal_set_noteJumpValueType)) ::GlobalNamespace::__BeatmapObjectSpawnMovementData__NoteJumpValueType  noteJumpValueType;
...
/// @brief Method .ctor, addr 0x3a5ab60, size 0x58, virtual false, abstract: false, final false
...
/// @brief Field _spawnRotationCallbackWrapper, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__spawnRotationCallbackWrapper, put=__cordl_internal_set__spawnRotationCallbackWrapper)) ::GlobalNamespace::BeatmapDataCallbackWrapper*  _spawnRotationCallbackWrapper;
...
/// @brief Method Get2DNoteOffset, addr 0x3a5aac8, size 0x1c, virtual true, abstract: false, final true
inline ::UnityEngine::Vector2 Get2DNoteOffset(int32_t  noteLineIndex, ::GlobalNamespace::NoteLineLayer  noteLineLayer) ;

/// @brief Method HandleNoteDataCallback, addr 0x3a5a878, size 0x10c, virtual false, abstract: false, final false
inline void HandleNoteDataCallback(::GlobalNamespace::NoteData*  noteData) ;

/// @brief Method HandleObstacleDataCallback, addr 0x3a5a764, size 0x114, virtual false, abstract: false, final false
inline void HandleObstacleDataCallback(::GlobalNamespace::ObstacleData*  obstacleData) ;

/// @brief Method HandleSliderDataCallback, addr 0x3a5a984, size 0x11c, virtual false, abstract: false, final false
inline void HandleSliderDataCallback(::GlobalNamespace::SliderData*  sliderNoteData) ;

/// @brief Method HandleSpawnRotationCallback, addr 0x3a5aaa0, size 0x1c, virtual false, abstract: false, final false
inline void HandleSpawnRotationCallback(::GlobalNamespace::SpawnRotationBeatmapEventData*  beatmapEventData) ;

/// @brief Method JumpPosYForLineLayerAtDistanceFromPlayerWithoutJumpOffset, addr 0x3a5aae4, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method OnDestroy, addr 0x3a5a70c, size 0x58, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3a5a394, size 0x378, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StopSpawning, addr 0x3a5aabc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a5ab00, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didInitEvent, addr 0x3a5a25c, size 0x9c, virtual true, abstract: false, final true
inline void add_didInitEvent(::System::Action*  value) ;

/// @brief Method get_beatmapObjectSpawnMovementData, addr 0x3a5a24c, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::BeatmapObjectSpawnMovementData* get_beatmapObjectSpawnMovementData() ;

/// @brief Method get_isInitialized, addr 0x3a5a254, size 0x8, virtual true, abstract: false, final true
inline bool get_isInitialized() ;

/// @brief Method get_jumpDistance, addr 0x3a5a1dc, size 0x1c, virtual true, abstract: false, final true
inline float_t get_jumpDistance() ;

/// @brief Method get_jumpDuration, addr 0x3a5a1c0, size 0x1c, virtual true, abstract: false, final true
inline float_t get_jumpDuration() ;

/// @brief Method get_jumpOffsetY, addr 0x3a5a188, size 0x1c, virtual true, abstract: false, final true
inline float_t get_jumpOffsetY() ;

/// @brief Method get_moveDuration, addr 0x3a5a1a4, size 0x1c, virtual true, abstract: false, final true
inline float_t get_moveDuration() ;

/// @brief Method get_noteJumpMovementSpeed, addr 0x3a5a214, size 0x1c, virtual true, abstract: false, final true
inline float_t get_noteJumpMovementSpeed() ;

/// @brief Method get_noteLinesCount, addr 0x3a5a16c, size 0x1c, virtual true, abstract: false, final true
inline int32_t get_noteLinesCount() ;

/// @brief Method get_noteLinesDistance, addr 0x3a5a230, size 0x1c, virtual true, abstract: false, final true
inline float_t get_noteLinesDistance() ;

/// @brief Method get_verticalLayerDistance, addr 0x3a5a1f8, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method remove_didInitEvent, addr 0x3a5a2f8, size 0x9c, virtual true, abstract: false, final true
