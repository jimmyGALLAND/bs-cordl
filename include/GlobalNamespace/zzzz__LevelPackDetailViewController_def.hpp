...
namespace GlobalNamespace {
struct __LevelPackDetailViewController___OpenLevelPackProductStoreAsync_d__24;
}
namespace GlobalNamespace {
struct __LevelPackDetailViewController___RefreshAvailabilityAsync_d__22;
}
namespace HMUI {
class ImageView;
}
...
MARK_VAL_T(::GlobalNamespace::__LevelPackDetailViewController___OpenLevelPackProductStoreAsync_d__24);
MARK_VAL_T(::GlobalNamespace::__LevelPackDetailViewController___RefreshAvailabilityAsync_d__22);
// Type: ::ContentType
...
/// @brief Field Buyable value: static_cast<int32_t>(0x2)
static ::GlobalNamespace::__LevelPackDetailViewController__ContentType const Buyable;
...
/// @brief Field NonBuyable value: static_cast<int32_t>(0x1)
...
// Type: ::<OpenLevelPackProductStoreAsync>d__24
...
struct CORDL_TYPE __LevelPackDetailViewController___OpenLevelPackProductStoreAsync_d__24 {
public:
// Declarations
/// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine*() ;

/// @brief Method MoveNext, addr 0x3ad46f8, size 0x378, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3ad4a70, size 0xc, virtual true, abstract: false, final true
...
// Ctor Parameters []
// @brief default ctor
constexpr __LevelPackDetailViewController___OpenLevelPackProductStoreAsync_d__24() ;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::LevelPackDetailViewController>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::OpenProductStoreResult>", modifiers: "", def_value: None }]
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__LevelPackDetailViewController___OpenLevelPackProductStoreAsync_d__24, 0x38>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__LevelPackDetailViewController___OpenLevelPackProductStoreAsync_d__24, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__LevelPackDetailViewController___OpenLevelPackProductStoreAsync_d__24, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__LevelPackDetailViewController___OpenLevelPackProductStoreAsync_d__24, __4__this) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__LevelPackDetailViewController___OpenLevelPackProductStoreAsync_d__24, __u__1) == 0x30, "Offset mismatch!");
...
struct CORDL_TYPE __LevelPackDetailViewController___RefreshAvailabilityAsync_d__22 {
public:
// Declarations
/// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine*() ;

/// @brief Method MoveNext, addr 0x3ad4a7c, size 0x488, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3ad4f04, size 0xc, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
// Ctor Parameters []
// @brief default ctor
constexpr __LevelPackDetailViewController___RefreshAvailabilityAsync_d__22() ;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::LevelPackDetailViewController>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::EntitlementStatus>", modifiers: "", def_value: None }]
constexpr __LevelPackDetailViewController___RefreshAvailabilityAsync_d__22(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::UnityW<::GlobalNamespace::LevelPackDetailViewController>  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::EntitlementStatus>  __u__1) noexcept;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__LevelPackDetailViewController___RefreshAvailabilityAsync_d__22, 0x38>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__LevelPackDetailViewController___RefreshAvailabilityAsync_d__22, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__LevelPackDetailViewController___RefreshAvailabilityAsync_d__22, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__LevelPackDetailViewController___RefreshAvailabilityAsync_d__22, __4__this) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__LevelPackDetailViewController___RefreshAvailabilityAsync_d__22, __u__1) == 0x30, "Offset mismatch!");
...
using _OpenLevelPackProductStoreAsync_d__24 = ::GlobalNamespace::__LevelPackDetailViewController___OpenLevelPackProductStoreAsync_d__24;

using _RefreshAvailabilityAsync_d__22 = ::GlobalNamespace::__LevelPackDetailViewController___RefreshAvailabilityAsync_d__22;
...
/// @brief Method BuyPackButtonWasPressed, addr 0x3ad4218, size 0x94, virtual false, abstract: false, final false
inline void BuyPackButtonWasPressed() ;

/// @brief Method DidActivate, addr 0x3ad3da8, size 0x1ec, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3ad3f94, size 0x114, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleAdditionalContentModelDidInvalidateData, addr 0x3ad4570, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3ad40a8, size 0x170, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OpenLevelPackProductStoreAsync, addr 0x3ad42ac, size 0x90, virtual false, abstract: false, final false
inline void OpenLevelPackProductStoreAsync() ;

/// @brief Method RefreshAvailabilityAsync, addr 0x3ad3d18, size 0x90, virtual false, abstract: false, final false
inline void RefreshAvailabilityAsync() ;

/// @brief Method SetData, addr 0x3acf978, size 0x2b0, virtual false, abstract: false, final false
inline void SetData(::GlobalNamespace::BeatmapLevelPack*  pack) ;

/// @brief Method ShowContent, addr 0x3ad433c, size 0x234, virtual false, abstract: false, final false
inline void ShowContent(::GlobalNamespace::__LevelPackDetailViewController__ContentType  contentType, ::StringW  errorText) ;

/// @brief Method <DidActivate>b__19_1, addr 0x3ad45d8, size 0x90, virtual false, abstract: false, final false
inline void _DidActivate_b__19_1() ;

/// @brief Method <DidActivate>b__19_2, addr 0x3ad4668, size 0x90, virtual false, abstract: false, final false
inline void _DidActivate_b__19_2() ;

/// @brief Method <DidActivate>g__HandleDidPressRefreshButton|19_0, addr 0x3ad45d4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ad4574, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__LevelPackDetailViewController___OpenLevelPackProductStoreAsync_d__24, "", "LevelPackDetailViewController/<OpenLevelPackProductStoreAsync>d__24");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__LevelPackDetailViewController___RefreshAvailabilityAsync_d__22, "", "LevelPackDetailViewController/<RefreshAvailabilityAsync>d__22");
