...
/// @brief Method .ctor, addr 0x3b23d6c, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method SetConnectedPlayerSongTime, addr 0x3b244d4, size 0x38, virtual false, abstract: false, final false
inline void SetConnectedPlayerSongTime(int64_t  syncTime, float_t  songTime) ;

/// @brief Method Start, addr 0x3b24368, size 0xc, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartSong, addr 0x3b224a0, size 0x140, virtual false, abstract: false, final false
inline void StartSong(int64_t  songStartSyncTime) ;

/// @brief Method StopSong, addr 0x3b2275c, size 0xc, virtual false, abstract: false, final false
inline void StopSong() ;

/// @brief Method Update, addr 0x3b24374, size 0x160, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b2450c, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isReady, addr 0x3b24360, size 0x8, virtual true, abstract: false, final true
inline bool get_isReady() ;

/// @brief Method get_lastFrameDeltaSongTime, addr 0x3b24330, size 0x8, virtual true, abstract: false, final true
inline float_t get_lastFrameDeltaSongTime() ;

/// @brief Method get_songEndTime, addr 0x3b24340, size 0xc, virtual true, abstract: false, final true
inline float_t get_songEndTime() ;

/// @brief Method get_songLength, addr 0x3b2434c, size 0xc, virtual true, abstract: false, final true
inline float_t get_songLength() ;

/// @brief Method get_songTime, addr 0x3b24320, size 0x8, virtual true, abstract: false, final true
inline float_t get_songTime() ;

/// @brief Method get_timeScale, addr 0x3b24358, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_lastFrameDeltaSongTime, addr 0x3b24338, size 0x8, virtual false, abstract: false, final false
inline void set_lastFrameDeltaSongTime(float_t  value) ;

/// @brief Method set_songTime, addr 0x3b24328, size 0x8, virtual false, abstract: false, final false
