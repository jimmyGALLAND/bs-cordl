...
/// @brief Field _sonyBackgroundExecutionHelper, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__sonyBackgroundExecutionHelper, put=__cordl_internal_set__sonyBackgroundExecutionHelper)) ::GlobalNamespace::SonyBackgroundExecutionHelper*  _sonyBackgroundExecutionHelper;

/// @brief Method HandlePlatformBackgroundExecutionHelperDidGoToBackgroundExecution, addr 0x269caa4, size 0xc4, virtual false, abstract: false, final false
inline void HandlePlatformBackgroundExecutionHelperDidGoToBackgroundExecution() ;

/// @brief Method Initialize, addr 0x269c95c, size 0xbc, virtual false, abstract: false, final false
inline void Initialize() ;

static inline ::GlobalNamespace::SonyOnGoingToBackgroundSaveHandler* New_ctor() ;

/// @brief Method OnDestroy, addr 0x269ca18, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x269cb68, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
