...
public:
// Declarations
/// @brief Method InstallBindings, addr 0x3a8f1a4, size 0x4, virtual true, abstract: false, final false
inline void InstallBindings() ;

static inline ::GlobalNamespace::ObjectsMovementRecorderEditorInstaller* New_ctor() ;

/// @brief Method .ctor, addr 0x3a8f1a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
