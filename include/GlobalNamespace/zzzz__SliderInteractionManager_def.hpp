...
/// @brief Field _activeSliders, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__activeSliders, put=__cordl_internal_set__activeSliders)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::SliderController>>*  _activeSliders;
...
/// @brief Field <saberInteractionParam>k__BackingField, offset 0x30, size 0x4 
 __declspec(property(get=__cordl_internal_get__saberInteractionParam_k__BackingField, put=__cordl_internal_set__saberInteractionParam_k__BackingField)) float_t  _saberInteractionParam_k__BackingField;

/// @brief Field allSliderWereRemovedFromActiveSlidersEvent, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_allSliderWereRemovedFromActiveSlidersEvent, put=__cordl_internal_set_allSliderWereRemovedFromActiveSlidersEvent)) ::System::Action_1<::UnityW<::GlobalNamespace::SliderInteractionManager>>*  allSliderWereRemovedFromActiveSlidersEvent;
...
/// @brief Field sliderWasAddedToActiveSlidersEvent, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_sliderWasAddedToActiveSlidersEvent, put=__cordl_internal_set_sliderWasAddedToActiveSlidersEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::SliderInteractionManager>,float_t>*  sliderWasAddedToActiveSlidersEvent;

/// @brief Method AddActiveSlider, addr 0x3a6e404, size 0x220, virtual false, abstract: false, final false
inline void AddActiveSlider(::GlobalNamespace::SliderController*  newSliderController) ;

/// @brief Method HandleSliderWasDespawned, addr 0x3a6e6f4, size 0x34, virtual false, abstract: false, final false
inline void HandleSliderWasDespawned(::GlobalNamespace::SliderController*  sliderController) ;

/// @brief Method HandleSliderWasSpawned, addr 0x3a6e6c0, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3a6e1b8, size 0xe8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method RemoveActiveSlider, addr 0x3a6e624, size 0x9c, virtual false, abstract: false, final false
inline void RemoveActiveSlider(::GlobalNamespace::SliderController*  sliderController) ;

/// @brief Method Start, addr 0x3a6e0e0, size 0xd8, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3a6e2a0, size 0x164, virtual false, abstract: false, final false
inline void Update() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityW<::GlobalNamespace::SliderInteractionManager>>*> const& __cordl_internal_get_allSliderWereRemovedFromActiveSlidersEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::SliderInteractionManager>,float_t>*> const& __cordl_internal_get_sliderWasAddedToActiveSlidersEvent() const;
...
/// @brief Method .ctor, addr 0x3a6e728, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_allSliderWereRemovedFromActiveSlidersEvent, addr 0x3a6ddbc, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method add_sliderWasAddedToActiveSlidersEvent, addr 0x3a6dd0c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_colorType, addr 0x3a6e0c8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorType get_colorType() ;

/// @brief Method get_saberInteractionParam, addr 0x3a6e0d0, size 0x8, virtual false, abstract: false, final false
inline float_t get_saberInteractionParam() ;

/// @brief Method remove_allSliderWereRemovedFromActiveSlidersEvent, addr 0x3a6e000, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_sliderWasAddedToActiveSlidersEvent, addr 0x3a6df50, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method set_saberInteractionParam, addr 0x3a6e0d8, size 0x8, virtual false, abstract: false, final false
