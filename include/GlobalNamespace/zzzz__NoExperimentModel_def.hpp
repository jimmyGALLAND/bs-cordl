...
/// @brief Method IsEmployee, addr 0x2662a94, size 0x68, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<bool>* IsEmployee() ;

/// @brief Method IsInTest, addr 0x2662afc, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2662b64, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
