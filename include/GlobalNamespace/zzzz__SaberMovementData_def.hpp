...
/// @brief Method AddDataProcessor, addr 0x2663250, size 0x58, virtual true, abstract: false, final true
inline void AddDataProcessor(::GlobalNamespace::ISaberMovementDataProcessor*  dataProcessor) ;

/// @brief Method AddNewData, addr 0x2663480, size 0x4c8, virtual false, abstract: false, final false
inline void AddNewData(::UnityEngine::Vector3  topPos, ::UnityEngine::Vector3  bottomPos, float_t  time) ;

/// @brief Method ComputeAdditionalData, addr 0x2663948, size 0x22c, virtual false, abstract: false, final false
...
/// @brief Method ComputeCutPlaneNormal, addr 0x2663cb0, size 0x98, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 ComputeCutPlaneNormal() ;

/// @brief Method ComputePlaneNormal, addr 0x2663b74, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method ComputeSwingRating, addr 0x2663ff4, size 0xc, virtual true, abstract: false, final true
inline float_t ComputeSwingRating() ;

/// @brief Method ComputeSwingRating, addr 0x2663d50, size 0x2a4, virtual false, abstract: false, final false
inline float_t ComputeSwingRating(bool  overrideSegmenAngle, float_t  overrideValue) ;

/// @brief Method ComputeSwingRating, addr 0x2663d48, size 0x8, virtual true, abstract: false, final true
inline float_t ComputeSwingRating(float_t  overrideSegmentAngle) ;

static inline ::GlobalNamespace::SaberMovementData* New_ctor() ;

/// @brief Method RemoveDataProcessor, addr 0x26632a8, size 0x58, virtual true, abstract: false, final true
inline void RemoveDataProcessor(::GlobalNamespace::ISaberMovementDataProcessor*  dataProcessor) ;

/// @brief Method RequestLastDataProcessing, addr 0x2663300, size 0x180, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x26631a8, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bladeSpeed, addr 0x26630e8, size 0x8, virtual true, abstract: false, final true
inline float_t get_bladeSpeed() ;

/// @brief Method get_lastAddedData, addr 0x26630f0, size 0x5c, virtual true, abstract: false, final true
inline ::GlobalNamespace::BladeMovementDataElement get_lastAddedData() ;

/// @brief Method get_prevAddedData, addr 0x266314c, size 0x5c, virtual true, abstract: false, final true
