...
public:
// Declarations
/// @brief Method Init, addr 0x3b361a4, size 0x68, virtual true, abstract: false, final false
inline void Init() ;
...
/// @brief Method Tick, addr 0x3b3620c, size 0x68, virtual true, abstract: false, final false
inline void Tick() ;

/// @brief Method .ctor, addr 0x3b34038, size 0x8, virtual false, abstract: false, final false
