...
/// @brief Method InstallBindings, addr 0x3b5f514, size 0xb4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b5f5c8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
