...
// Ctor Parameters [CppParam { name: "shader", ty: "::UnityW<::UnityEngine::Shader>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "textureId", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "texture", ty: "::GlobalNamespace::OVRTextureData", modifiers: "", def_value: Some("{}") }, CppParam { name: "baseColorFactor", ty: "::UnityEngine::Color", modifiers: "", def_value: Some("{}") }]
