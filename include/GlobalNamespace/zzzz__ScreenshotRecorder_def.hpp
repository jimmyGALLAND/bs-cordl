...
/// @brief Method ConvertRenderTexture, addr 0x3943358, size 0xfc, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture2D> ConvertRenderTexture(::UnityEngine::RenderTexture*  renderTexture) ;

/// @brief Method LateUpdate, addr 0x39431fc, size 0xc0, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::ScreenshotRecorder* New_ctor() ;

/// @brief Method OnApplicationFocus, addr 0x3943340, size 0x18, virtual false, abstract: false, final false
inline void OnApplicationFocus(bool  hasFocus) ;

/// @brief Method OnDisable, addr 0x3943138, size 0xc4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3942fc4, size 0x174, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method SaveCameraScreenshot, addr 0x39432bc, size 0x84, virtual false, abstract: false, final false
inline void SaveCameraScreenshot() ;

/// @brief Method SaveTextureScreenshot, addr 0x3943454, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3943594, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_directory, addr 0x3942fb4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_directory() ;

/// @brief Method set_directory, addr 0x3942fbc, size 0x8, virtual false, abstract: false, final false
