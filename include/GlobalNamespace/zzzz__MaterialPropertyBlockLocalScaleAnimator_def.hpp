...
/// @brief Method SetProperty, addr 0x39630bc, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3963114, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
