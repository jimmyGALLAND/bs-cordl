...
/// @brief Method .ctor, addr 0x3b67608, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_playerName, addr 0x3b6740c, size 0x24, virtual false, abstract: false, final false
inline void set_playerName(::StringW  value) ;

/// @brief Method set_rank, addr 0x3b673c4, size 0x48, virtual false, abstract: false, final false
inline void set_rank(int32_t  value) ;

/// @brief Method set_score, addr 0x3b67430, size 0xa0, virtual false, abstract: false, final false
inline void set_score(int32_t  value) ;

/// @brief Method set_showFullCombo, addr 0x3b674f0, size 0x20, virtual false, abstract: false, final false
inline void set_showFullCombo(bool  value) ;

/// @brief Method set_showSeparator, addr 0x3b674d0, size 0x20, virtual false, abstract: false, final false
inline void set_showSeparator(bool  value) ;

/// @brief Method set_specialScore, addr 0x3b67510, size 0xf8, virtual false, abstract: false, final false
