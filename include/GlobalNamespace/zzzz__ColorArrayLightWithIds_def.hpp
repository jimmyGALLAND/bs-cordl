...
/// @brief Method ColorWasSet, addr 0x395e514, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x395e4bc, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  index, int32_t  lightId) ;

/// @brief Method add_didSetColorEvent, addr 0x395e2e4, size 0xb0, virtual false, abstract: false, final false
inline void add_didSetColorEvent(::System::Action_2<int32_t,::UnityEngine::Color>*  value) ;

/// @brief Method remove_didSetColorEvent, addr 0x395e394, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Field _colorArrayLightWithIds, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__colorArrayLightWithIds, put=__cordl_internal_set__colorArrayLightWithIds)) ::ArrayW<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*,::Array<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*>*>  _colorArrayLightWithIds;
...
/// @brief Method GetLightWithIds, addr 0x395e184, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::__LightWithIds__LightWithId*>* GetLightWithIds() ;

/// @brief Method HandleColorLightWithIdDidSetColor, addr 0x395e18c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x395e07c, size 0x4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnEnable, addr 0x395dee0, size 0x18, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method ProcessNewColorData, addr 0x395e150, size 0x4, virtual true, abstract: false, final false
inline void ProcessNewColorData() ;

/// @brief Method RegisterArrayForColorChanges, addr 0x395defc, size 0x180, virtual false, abstract: false, final false
inline void RegisterArrayForColorChanges() ;

/// @brief Method SetColorArrayOffsetToMaterialPropertyBlocks, addr 0x395e218, size 0xcc, virtual false, abstract: false, final false
inline void SetColorArrayOffsetToMaterialPropertyBlocks() ;

/// @brief Method SetColorDataToMaterial, addr 0x395e154, size 0x30, virtual false, abstract: false, final false
inline void SetColorDataToMaterial() ;

/// @brief Method UnregisterArrayFromColorChanges, addr 0x395e080, size 0xd0, virtual false, abstract: false, final false
inline void UnregisterArrayFromColorChanges() ;

constexpr ::ArrayW<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*,::Array<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*>*> const& __cordl_internal_get__colorArrayLightWithIds() const;

constexpr ::ArrayW<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*,::Array<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*>*>& __cordl_internal_get__colorArrayLightWithIds() ;
...
constexpr void __cordl_internal_set__colorArrayLightWithIds(::ArrayW<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*,::Array<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*>*>  value) ;
...
/// @brief Method .ctor, addr 0x395e444, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
