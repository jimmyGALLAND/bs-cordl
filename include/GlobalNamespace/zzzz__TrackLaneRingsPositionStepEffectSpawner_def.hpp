...
/// @brief Method HandleBeatmapEvent, addr 0x3b0ad94, size 0x9c, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

static inline ::GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b0ad78, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b0ac50, size 0x128, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b0ae30, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;
