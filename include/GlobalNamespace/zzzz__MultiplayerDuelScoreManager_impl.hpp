...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerDuelScoreManager::*)()>(&::GlobalNamespace::MultiplayerDuelScoreManager::Start)> {
  ...
  constexpr static std::size_t addrs = 0x3b3b288;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerDuelScoreManager::*)()>(&::GlobalNamespace::MultiplayerDuelScoreManager::OnDestroy)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerDuelScoreManager::*)()>(&::GlobalNamespace::MultiplayerDuelScoreManager::Update)> {
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x3b3b5d0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::MultiplayerDuelScoreManager::*)()>(&::GlobalNamespace::MultiplayerDuelScoreManager::EnsureOpponentAssigned)> {
  constexpr static std::size_t size = 0x2c;
  constexpr static std::size_t addrs = 0x3b3b638;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::IConnectedPlayer* (::GlobalNamespace::MultiplayerDuelScoreManager::*)()>(&::GlobalNamespace::MultiplayerDuelScoreManager::GetOpponentPlayer)> {
  constexpr static std::size_t size = 0x3d4;
  constexpr static std::size_t addrs = 0x3b3b664;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerDuelScoreManager::*)()>(&::GlobalNamespace::MultiplayerDuelScoreManager::UpdateScoreAndName)> {
  constexpr static std::size_t size = 0x1a8;
  constexpr static std::size_t addrs = 0x3b3b35c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerDuelScoreManager::*)(::GlobalNamespace::__MultiplayerController__State)>(&::GlobalNamespace::MultiplayerDuelScoreManager::HandleStateChanged)> {
  constexpr static std::size_t size = 0xf8;
  constexpr static std::size_t addrs = 0x3b3ba38;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerDuelScoreManager::*)()>(&::GlobalNamespace::MultiplayerDuelScoreManager::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3b3bb30;
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____scoreItem)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
constexpr ::GlobalNamespace::IMultiplayerSessionManager*& GlobalNamespace::MultiplayerDuelScoreManager::__cordl_internal_get__multiplayerSessionManager()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____multiplayerSessionManager;
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IMultiplayerSessionManager*> const& GlobalNamespace::MultiplayerDuelScoreManager::__cordl_internal_get__multiplayerSessionManager() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____multiplayerSessionManager;
}
constexpr void GlobalNamespace::MultiplayerDuelScoreManager::__cordl_internal_set__multiplayerSessionManager(::GlobalNamespace::IMultiplayerSessionManager*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IConnectedPlayer*> const& GlobalNamespace::MultiplayerDuelScoreManager::__cordl_internal_get__opponentPlayer() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____opponentPlayer;
}
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____opponentPlayer)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::MultiplayerDuelScoreManager*>());
}
