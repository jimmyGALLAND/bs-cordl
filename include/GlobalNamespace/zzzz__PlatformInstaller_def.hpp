...
class CORDL_TYPE PlatformInstaller : public ::Zenject::Installer_3<::GlobalNamespace::AppInitSetupData*,::UnityW<::GlobalNamespace::MockPlatformAdditionalContentModelInitialDataSO>,::GlobalNamespace::PlatformInstaller*> {
public:
// Declarations
...
/// @brief Method BindAchievementsHandler, addr 0x26cd638, size 0x7c, virtual false, abstract: false, final false
inline void BindAchievementsHandler() ;

/// @brief Method BindAdditionalContentModel, addr 0x26cd6b4, size 0x74, virtual false, abstract: false, final false
inline void BindAdditionalContentModel() ;

/// @brief Method BindAnalyticsModel, addr 0x26cd59c, size 0x9c, virtual false, abstract: false, final false
inline void BindAnalyticsModel() ;

/// @brief Method BindBeatmapDataAssetFileModel, addr 0x26cd728, size 0x7c, virtual false, abstract: false, final false
inline void BindBeatmapDataAssetFileModel() ;

/// @brief Method BindMockPlatformAdditionalContentModel, addr 0x26cd7a8, size 0x9c, virtual false, abstract: false, final false
inline void BindMockPlatformAdditionalContentModel() ;

/// @brief Method BindPSPlusHandler, addr 0x26cd7a4, size 0x4, virtual false, abstract: false, final false
inline void BindPSPlusHandler() ;

/// @brief Method BindPlatformUserModel, addr 0x26cd4c0, size 0xdc, virtual false, abstract: false, final false
inline void BindPlatformUserModel() ;

/// @brief Method InstallBindings, addr 0x26cd490, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26cd418, size 0x78, virtual false, abstract: false, final false
