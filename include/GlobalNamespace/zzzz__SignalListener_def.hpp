...
/// @brief Method HandleEvent, addr 0x3943e78, size 0x1c, virtual false, abstract: false, final false
inline void HandleEvent() ;

static inline ::GlobalNamespace::SignalListener* New_ctor() ;

/// @brief Method OnDisable, addr 0x3943dec, size 0x8c, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3943d54, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3943e94, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
