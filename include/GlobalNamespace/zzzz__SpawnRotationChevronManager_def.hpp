...
/// @brief Method .ctor, addr 0x3b09210, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _beatmapObjectDataCallbackWrapper, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapObjectDataCallbackWrapper, put=__cordl_internal_set__beatmapObjectDataCallbackWrapper)) ::GlobalNamespace::BeatmapDataCallbackWrapper*  _beatmapObjectDataCallbackWrapper;
...
/// @brief Field _directionToDataDictionary, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__directionToDataDictionary, put=__cordl_internal_set__directionToDataDictionary)) ::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::__SpawnRotationChevronManager__DirectionData*>*  _directionToDataDictionary;
...
/// @brief Field _halfJumpDuration, offset 0x8c, size 0x4 
...
/// @brief Field _moveDuration, offset 0x88, size 0x4 
...
/// @brief Field _spawnRotationDataCallbackWrapper, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__spawnRotationDataCallbackWrapper, put=__cordl_internal_set__spawnRotationDataCallbackWrapper)) ::GlobalNamespace::BeatmapDataCallbackWrapper*  _spawnRotationDataCallbackWrapper;

/// @brief Method ComputeAheadTime, addr 0x3b09234, size 0x5c, virtual false, abstract: false, final false
inline float_t ComputeAheadTime() ;

/// @brief Method HandleBeatmapObjectCallback, addr 0x3b08ec0, size 0x350, virtual false, abstract: false, final false
inline void HandleBeatmapObjectCallback(::GlobalNamespace::BeatmapObjectData*  beatmapObjectData) ;

/// @brief Method HandleBeatmapObjectSpawnControllerDidInit, addr 0x3b0822c, size 0x13c, virtual false, abstract: false, final false
inline void HandleBeatmapObjectSpawnControllerDidInit() ;

/// @brief Method HandleSpawnRotationBeatmapEvent, addr 0x3b09218, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b08dc8, size 0xf8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b080a8, size 0x184, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3b08368, size 0xa60, virtual false, abstract: false, final false
inline void Update() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::__SpawnRotationChevronManager__DirectionData*>*> const& __cordl_internal_get__directionToDataDictionary() const;
...
/// @brief Method .ctor, addr 0x3b09290, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _moveDuration, offset: 0x88, size: 0x4, def value: None
 float_t  ____moveDuration;

/// @brief Field _halfJumpDuration, offset: 0x8c, size: 0x4, def value: None
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::SpawnRotationChevronManager, 0x98>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::SpawnRotationChevronManager, ____moveDuration) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SpawnRotationChevronManager, ____halfJumpDuration) == 0x8c, "Offset mismatch!");
