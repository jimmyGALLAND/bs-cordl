...
/// @brief Field <validPlatformEnvironment>k__BackingField, offset 0x18, size 0x1 
 __declspec(property(get=__cordl_internal_get__validPlatformEnvironment_k__BackingField, put=__cordl_internal_set__validPlatformEnvironment_k__BackingField)) ::GlobalNamespace::PlatformEnvironment  _validPlatformEnvironment_k__BackingField;
...
/// @brief Method .ctor, addr 0x3fed1ec, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  token, ::GlobalNamespace::PlatformEnvironment  validPlatformEnvironment) ;

/// @brief Method get_token, addr 0x3fed1cc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_token() ;

/// @brief Method get_validPlatformEnvironment, addr 0x3fed1dc, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::PlatformEnvironment get_validPlatformEnvironment() ;

/// @brief Method set_token, addr 0x3fed1d4, size 0x8, virtual false, abstract: false, final false
inline void set_token(::StringW  value) ;

/// @brief Method set_validPlatformEnvironment, addr 0x3fed1e4, size 0x8, virtual false, abstract: false, final false
