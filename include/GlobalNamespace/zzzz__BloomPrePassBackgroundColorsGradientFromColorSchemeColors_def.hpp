...
/// @brief Field environmentColor, offset 0x14, size 0x4 
 __declspec(property(get=__cordl_internal_get_environmentColor, put=__cordl_internal_set_environmentColor)) ::GlobalNamespace::__BloomPrePassBackgroundColorsGradientFromColorSchemeColors__EnvironmentColor  environmentColor;
...
/// @brief Method .ctor, addr 0x3a7d970, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _elements, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__elements, put=__cordl_internal_set__elements)) ::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientFromColorSchemeColors__Element*,::Array<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientFromColorSchemeColors__Element*>*>  _elements;

/// @brief Method HandleColorProviderDidChangeColor, addr 0x3a7db6c, size 0x2c8, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3a7da6c, size 0x100, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3a7d978, size 0xf4, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientFromColorSchemeColors__Element*,::Array<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientFromColorSchemeColors__Element*>*> const& __cordl_internal_get__elements() const;

constexpr ::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientFromColorSchemeColors__Element*,::Array<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientFromColorSchemeColors__Element*>*>& __cordl_internal_get__elements() ;
...
constexpr void __cordl_internal_set__elements(::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientFromColorSchemeColors__Element*,::Array<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientFromColorSchemeColors__Element*>*>  value) ;

/// @brief Method .ctor, addr 0x3a7d694, size 0x2dc, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _elements, offset: 0x28, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientFromColorSchemeColors__Element*,::Array<::GlobalNamespace::__BloomPrePassBackgroundColorsGradientFromColorSchemeColors__Element*>*>  ____elements;
