...
/// @brief Method Awake, addr 0x393c7f0, size 0xd0, virtual false, abstract: false, final false
inline void Awake() ;
...
/// @brief Method .ctor, addr 0x393c8c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
