...
static __declspec(property(get=getStaticF__bloomPrePassAfterBlurList, put=setStaticF__bloomPrePassAfterBlurList)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::BloomPrePassNonLightPass>>*  _bloomPrePassAfterBlurList;

/// @brief Field _bloomPrePassBeforeBlurList, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF__bloomPrePassBeforeBlurList, put=setStaticF__bloomPrePassBeforeBlurList)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::BloomPrePassNonLightPass>>*  _bloomPrePassBeforeBlurList;
...
/// @brief Field _registeredExecutionTimeType, offset 0x24, size 0x4 
 __declspec(property(get=__cordl_internal_get__registeredExecutionTimeType, put=__cordl_internal_set__registeredExecutionTimeType)) ::GlobalNamespace::__BloomPrePassNonLightPass__ExecutionTimeType  _registeredExecutionTimeType;
...
/// @brief Method OnDisable, addr 0x395640c, size 0x4, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3954ca4, size 0x4, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnValidate, addr 0x3955800, size 0x2c, virtual true, abstract: false, final false
inline void OnValidate() ;

/// @brief Method Register, addr 0x3953b98, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method Unregister, addr 0x3953d4c, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39537e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_bloomPrePassAfterBlurList, addr 0x395635c, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method get_bloomPrePassBeforeBlurList, addr 0x39563b4, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method get_executionTimeType, addr 0x3956354, size 0x8, virtual false, abstract: false, final false
