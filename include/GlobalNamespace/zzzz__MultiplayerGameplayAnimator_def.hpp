...
/// @brief Method HandleNewLeaderWasSelected, addr 0x3b3c630, size 0xe8, virtual false, abstract: false, final false
inline void HandleNewLeaderWasSelected(::StringW  userId) ;

/// @brief Method HandleStateChanged, addr 0x3b3c424, size 0x15c, virtual true, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b3c1ec, size 0x188, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b3c158, size 0x94, virtual true, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b3c718, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
