...
/// @brief Field _selectedAndHighlightedColor1, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__selectedAndHighlightedColor1, put=__cordl_internal_set__selectedAndHighlightedColor1)) ::UnityW<::GlobalNamespace::ColorSO>  _selectedAndHighlightedColor1;

/// @brief Field _selectedAndHighlightedColor2, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__selectedAndHighlightedColor2, put=__cordl_internal_set__selectedAndHighlightedColor2)) ::UnityW<::GlobalNamespace::ColorSO>  _selectedAndHighlightedColor2;
...
/// @brief Method .ctor, addr 0x4447944, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disabledColor1, addr 0x4445878, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_disabledColor1() ;

/// @brief Method get_disabledColor2, addr 0x4445884, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_disabledColor2() ;

/// @brief Method get_highlightColor1, addr 0x4445728, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_highlightColor1() ;

/// @brief Method get_highlightColor2, addr 0x4445734, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_highlightColor2() ;

/// @brief Method get_normalColor1, addr 0x4445458, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_normalColor1() ;

/// @brief Method get_normalColor2, addr 0x4445464, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_normalColor2() ;

/// @brief Method get_pressedColor1, addr 0x44457d0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_pressedColor1() ;

/// @brief Method get_pressedColor2, addr 0x44457dc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_pressedColor2() ;

/// @brief Method get_selectedAndHighlightedColor1, addr 0x44459c8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_selectedAndHighlightedColor1() ;

/// @brief Method get_selectedAndHighlightedColor2, addr 0x44459d4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_selectedAndHighlightedColor2() ;

/// @brief Method get_selectedColor1, addr 0x4445920, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_selectedColor1() ;

/// @brief Method get_selectedColor2, addr 0x444592c, size 0xc, virtual false, abstract: false, final false
