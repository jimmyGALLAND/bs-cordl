...
/// @brief Method .ctor, addr 0x3b690c4, size 0x28, virtual false, abstract: false, final false
...
/// @brief Field _activeObjectWhenInsideSafeArea, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__activeObjectWhenInsideSafeArea, put=__cordl_internal_set__activeObjectWhenInsideSafeArea)) ::UnityW<::UnityEngine::GameObject>  _activeObjectWhenInsideSafeArea;

/// @brief Field _activeObjectWhenNotInsideSafeArea, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__activeObjectWhenNotInsideSafeArea, put=__cordl_internal_set__activeObjectWhenNotInsideSafeArea)) ::UnityW<::UnityEngine::GameObject>  _activeObjectWhenNotInsideSafeArea;
...
/// @brief Method Start, addr 0x3b68e18, size 0x64, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3b68e7c, size 0x1e4, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b69060, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;
