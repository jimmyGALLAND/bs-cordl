...
/// @brief Method HandleSceneSetupDidFinish, addr 0x3de2f20, size 0x4c, virtual false, abstract: false, final false
inline void HandleSceneSetupDidFinish(::StringW  sessionGameId) ;

/// @brief Method HandleSceneSetupDidReceiveTooLate, addr 0x3de2f6c, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3de2cc8, size 0xf8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3de2c58, size 0x18, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartSceneLoadSync, addr 0x3de2dc0, size 0x160, virtual false, abstract: false, final false
inline void StartSceneLoadSync(::GlobalNamespace::PlayersSpecificSettingsAtGameStartModel*  playersAtGameStartModel) ;

/// @brief Method Update, addr 0x3de2c70, size 0x58, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3de2fb8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_syncStartDidFailEvent, addr 0x3de2b20, size 0x9c, virtual false, abstract: false, final false
inline void add_syncStartDidFailEvent(::System::Action*  value) ;

/// @brief Method add_syncStartDidReceiveTooLateEvent, addr 0x3de29c0, size 0xb0, virtual false, abstract: false, final false
inline void add_syncStartDidReceiveTooLateEvent(::System::Action_1<::StringW>*  value) ;

/// @brief Method add_syncStartDidSuccessEvent, addr 0x3de2860, size 0xb0, virtual false, abstract: false, final false
inline void add_syncStartDidSuccessEvent(::System::Action_1<::StringW>*  value) ;

/// @brief Method remove_syncStartDidFailEvent, addr 0x3de2bbc, size 0x9c, virtual false, abstract: false, final false
inline void remove_syncStartDidFailEvent(::System::Action*  value) ;

/// @brief Method remove_syncStartDidReceiveTooLateEvent, addr 0x3de2a70, size 0xb0, virtual false, abstract: false, final false
inline void remove_syncStartDidReceiveTooLateEvent(::System::Action_1<::StringW>*  value) ;

/// @brief Method remove_syncStartDidSuccessEvent, addr 0x3de2910, size 0xb0, virtual false, abstract: false, final false
