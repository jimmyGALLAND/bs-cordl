...
/// @brief Method Animate, addr 0x3b4e1f8, size 0x100, virtual false, abstract: false, final false
inline void Animate(bool  show, float_t  duration, ::GlobalNamespace::EaseType  easeType, float_t  delay) ;

/// @brief Method HideInstant, addr 0x3b4e0e0, size 0xa8, virtual false, abstract: false, final false
inline void HideInstant() ;

/// @brief Method InitIfNeeded, addr 0x3b4de24, size 0x244, virtual false, abstract: false, final false
inline void InitIfNeeded() ;

static inline ::GlobalNamespace::ScaleAnimator* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b4dd9c, size 0x88, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetPositionAndRotation, addr 0x3b4e068, size 0x78, virtual false, abstract: false, final false
inline void SetPositionAndRotation(::UnityEngine::Vector3  position, ::UnityEngine::Quaternion  rotation) ;

/// @brief Method ShowInstant, addr 0x3b4e188, size 0x70, virtual false, abstract: false, final false
inline void ShowInstant() ;

/// @brief Method <InitIfNeeded>b__7_0, addr 0x3b4e308, size 0x24, virtual false, abstract: false, final false
inline void _InitIfNeeded_b__7_0(float_t  val) ;

/// @brief Method <InitIfNeeded>b__7_1, addr 0x3b4e358, size 0x24, virtual false, abstract: false, final false
inline void _InitIfNeeded_b__7_1(float_t  val) ;

/// @brief Method <InitIfNeeded>b__7_2, addr 0x3b4e32c, size 0x2c, virtual false, abstract: false, final false
inline void _InitIfNeeded_b__7_2() ;

/// @brief Method <InitIfNeeded>b__7_3, addr 0x3b4e37c, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b4e2f8, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
