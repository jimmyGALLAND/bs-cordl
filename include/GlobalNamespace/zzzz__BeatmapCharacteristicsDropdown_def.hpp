...
/// @brief Method <Start>b__5_0, addr 0x3ac77d8, size 0x1c, virtual false, abstract: false, final false
inline ::StringW _Start_b__5_0(::GlobalNamespace::BeatmapCharacteristicSO*  x) ;

/// @brief Method .ctor, addr 0x3ac77d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetSelectedBeatmapCharacteristic, addr 0x3ac73dc, size 0xb8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> GetSelectedBeatmapCharacteristic() ;

/// @brief Method HandleSimpleTextDropdownDidSelectCellWithIdx, addr 0x3ac7690, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3ac730c, size 0xd0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SelectCellWithBeatmapCharacteristic, addr 0x3ac7494, size 0x78, virtual false, abstract: false, final false
inline void SelectCellWithBeatmapCharacteristic(::GlobalNamespace::BeatmapCharacteristicSO*  beatmapCharacteristic) ;

/// @brief Method SelectCellWithBeatmapCharacteristic, addr 0x3ac750c, size 0x184, virtual false, abstract: false, final false
inline void SelectCellWithBeatmapCharacteristic(::StringW  serializedName) ;

/// @brief Method Start, addr 0x3ac715c, size 0x1b0, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3ac776c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didSelectCellWithIdxEvent, addr 0x3ac6ffc, size 0xb0, virtual false, abstract: false, final false
inline void add_didSelectCellWithIdxEvent(::System::Action_1<::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>>*  value) ;

/// @brief Method remove_didSelectCellWithIdxEvent, addr 0x3ac70ac, size 0xb0, virtual false, abstract: false, final false
