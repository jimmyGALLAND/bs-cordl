...
/// @brief Method SetActive, addr 0x3b03fa0, size 0xbc, virtual false, abstract: false, final false
inline void SetActive(bool  enabled, ::UnityEngine::Color  mainLightColor) ;

/// @brief Method SetCollisionLength, addr 0x3b04170, size 0x27c, virtual false, abstract: false, final false
inline void SetCollisionLength(bool  rayHitGeometry, ::UnityEngine::RaycastHit  hit) ;

/// @brief Method SetData, addr 0x3b0405c, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b043f4, size 0x34, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _environmentCollisionRepository, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__environmentCollisionRepository, put=__cordl_internal_set__environmentCollisionRepository)) ::GlobalNamespace::EnvironmentCollisionRepository*  _environmentCollisionRepository;
...
/// @brief Field _mainTubeBloomPrePassLight, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__mainTubeBloomPrePassLight, put=__cordl_internal_set__mainTubeBloomPrePassLight)) ::GlobalNamespace::__TubeBloomPrePassLightReflectionEffect__TubeBloomPrePassLightWithHitPoint*  _mainTubeBloomPrePassLight;
...
/// @brief Field _tubeBloomPrePassLightBounces, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__tubeBloomPrePassLightBounces, put=__cordl_internal_set__tubeBloomPrePassLightBounces)) ::ArrayW<::GlobalNamespace::__TubeBloomPrePassLightReflectionEffect__TubeBloomPrePassLightWithHitPoint*,::Array<::GlobalNamespace::__TubeBloomPrePassLightReflectionEffect__TubeBloomPrePassLightWithHitPoint*>*>  _tubeBloomPrePassLightBounces;

/// @brief Method Awake, addr 0x3b03aac, size 0x80, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method LateUpdate, addr 0x3b03b2c, size 0x1c4, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::TubeBloomPrePassLightReflectionEffect* New_ctor() ;

/// @brief Method RaycastAndSetLightLength, addr 0x3b03cf0, size 0x2b0, virtual false, abstract: false, final false
inline bool RaycastAndSetLightLength(::GlobalNamespace::__TubeBloomPrePassLightReflectionEffect__TubeBloomPrePassLightWithHitPoint*  bounce, ::UnityEngine::Vector3  rayWorldOrigin, ::UnityEngine::Vector3  rayDirection, ByRef<::UnityEngine::Vector3>  hitWorldPosition, ByRef<::UnityEngine::Vector3>  hitReflection, ByRef<float_t>  length, ByRef<float_t>  endAlpha) ;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__TubeBloomPrePassLightReflectionEffect__TubeBloomPrePassLightWithHitPoint*> const& __cordl_internal_get__mainTubeBloomPrePassLight() const;

constexpr ::UnityW<::UnityEngine::Transform> const& __cordl_internal_get__transform() const;

constexpr ::UnityW<::UnityEngine::Transform>& __cordl_internal_get__transform() ;

constexpr ::ArrayW<::GlobalNamespace::__TubeBloomPrePassLightReflectionEffect__TubeBloomPrePassLightWithHitPoint*,::Array<::GlobalNamespace::__TubeBloomPrePassLightReflectionEffect__TubeBloomPrePassLightWithHitPoint*>*> const& __cordl_internal_get__tubeBloomPrePassLightBounces() const;

constexpr ::ArrayW<::GlobalNamespace::__TubeBloomPrePassLightReflectionEffect__TubeBloomPrePassLightWithHitPoint*,::Array<::GlobalNamespace::__TubeBloomPrePassLightReflectionEffect__TubeBloomPrePassLightWithHitPoint*>*>& __cordl_internal_get__tubeBloomPrePassLightBounces() ;
...
constexpr void __cordl_internal_set__tubeBloomPrePassLightBounces(::ArrayW<::GlobalNamespace::__TubeBloomPrePassLightReflectionEffect__TubeBloomPrePassLightWithHitPoint*,::Array<::GlobalNamespace::__TubeBloomPrePassLightReflectionEffect__TubeBloomPrePassLightWithHitPoint*>*>  value) ;

/// @brief Method .ctor, addr 0x3b043ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _tubeBloomPrePassLightBounces, offset: 0x28, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::__TubeBloomPrePassLightReflectionEffect__TubeBloomPrePassLightWithHitPoint*,::Array<::GlobalNamespace::__TubeBloomPrePassLightReflectionEffect__TubeBloomPrePassLightWithHitPoint*>*>  ____tubeBloomPrePassLightBounces;
