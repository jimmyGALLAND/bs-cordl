...
/// @brief Method Awake, addr 0x3f3fac0, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method DisableMultiModality, addr 0x3f3fc38, size 0x80, virtual false, abstract: false, final false
inline void DisableMultiModality() ;

/// @brief Method EnableMultiModality, addr 0x3f3fbb8, size 0x80, virtual false, abstract: false, final false
inline void EnableMultiModality() ;

static inline ::GlobalNamespace::OVRMultimodalHandsAndControllersSample* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3f3fac4, size 0x4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x3f3facc, size 0x4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3f3fac8, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Update, addr 0x3f3fad0, size 0xe8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3f3fcb8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
