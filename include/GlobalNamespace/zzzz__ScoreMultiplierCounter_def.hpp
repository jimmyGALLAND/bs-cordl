...
/// @brief Method ProcessMultiplierEvent, addr 0x26af804, size 0x90, virtual false, abstract: false, final false
inline bool ProcessMultiplierEvent(::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType  multiplierEventType) ;

/// @brief Method Reset, addr 0x26af7ec, size 0x18, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x26afc94, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_multiplier, addr 0x26afd5c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_multiplier() ;

/// @brief Method get_normalizedProgress, addr 0x26afd64, size 0x14, virtual false, abstract: false, final false
