...
/// @brief Method .ctor, addr 0x3f8a514, size 0x10, virtual false, abstract: false, final false
inline void _ctor(bool  sent, ::GlobalNamespace::__OVRPlugin__Qpl__ResultType  result) ;

/// @brief Method get_Result, addr 0x3f8a5f4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRPlugin__Qpl__ResultType get_Result() ;

/// @brief Method get_Sent, addr 0x3f8a5e0, size 0x8, virtual false, abstract: false, final false
inline bool get_Sent() ;

/// @brief Method set_Result, addr 0x3f8a5fc, size 0x8, virtual false, abstract: false, final false
inline void set_Result(::GlobalNamespace::__OVRPlugin__Qpl__ResultType  value) ;

/// @brief Method set_Sent, addr 0x3f8a5e8, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_Sent_k__BackingField", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "_Result_k__BackingField", ty: "::GlobalNamespace::__OVRPlugin__Qpl__ResultType", modifiers: "", def_value: None }]
...
/// @brief Method AddAnnotation, addr 0x3f8a140, size 0x50, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRTelemetryMarker AddAnnotation(::StringW  annotationKey, ::StringW  annotationValue) ;

/// @brief Method AddPoint, addr 0x3f8a56c, size 0x50, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRTelemetryMarker AddPoint(::GlobalNamespace::__OVRTelemetry__MarkerPoint  point) ;

/// @brief Method Dispose, addr 0x3f8a5bc, size 0x24, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Send, addr 0x3f89fb0, size 0x5c, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRTelemetryMarker Send() ;

/// @brief Method SendIf, addr 0x3f8a524, size 0x48, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRTelemetryMarker SendIf(bool  condition) ;

/// @brief Method SetResult, addr 0x3f89f88, size 0x28, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRTelemetryMarker SetResult(::GlobalNamespace::__OVRPlugin__Qpl__ResultType  result) ;

/// @brief Method .ctor, addr 0x3f8a4d4, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f89e3c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(int32_t  markerId, int32_t  instanceKey, int64_t  timestampMs) ;

/// @brief Method get_InstanceKey, addr 0x3f8a4cc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_InstanceKey() ;

/// @brief Method get_MarkerId, addr 0x3f8a4c4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MarkerId() ;

/// @brief Method get_Result, addr 0x3f8a4bc, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRPlugin__Qpl__ResultType get_Result() ;

/// @brief Method get_Sent, addr 0x3f8a4ac, size 0x10, virtual false, abstract: false, final false
inline bool get_Sent() ;

/// @brief Method get_State, addr 0x3f8a49c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRTelemetryMarker__OVRTelemetryMarkerState get_State() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() ;

/// @brief Method set_State, addr 0x3f8a4a4, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_State_k__BackingField", ty: "::GlobalNamespace::__OVRTelemetryMarker__OVRTelemetryMarkerState", modifiers: "", def_value: None }, CppParam { name: "_MarkerId_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_InstanceKey_k__BackingField", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_client", ty: "::GlobalNamespace::__OVRTelemetry__TelemetryClient*", modifiers: "", def_value: None }]
constexpr OVRTelemetryMarker(::GlobalNamespace::__OVRTelemetryMarker__OVRTelemetryMarkerState  _State_k__BackingField, int32_t  _MarkerId_k__BackingField, int32_t  _InstanceKey_k__BackingField, ::GlobalNamespace::__OVRTelemetry__TelemetryClient*  _client) noexcept;
