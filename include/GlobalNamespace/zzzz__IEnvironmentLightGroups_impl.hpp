...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::ILightGroup*>* (::GlobalNamespace::IEnvironmentLightGroups::*)()>(&::GlobalNamespace::IEnvironmentLightGroups::get_lightGroups)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::ILightGroup* (::GlobalNamespace::IEnvironmentLightGroups::*)(int32_t)>(&::GlobalNamespace::IEnvironmentLightGroups::GetDataForGroup)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
