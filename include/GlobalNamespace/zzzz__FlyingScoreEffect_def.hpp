...
/// @brief Method OnDespawned, addr 0x3aedccc, size 0x60, virtual true, abstract: false, final false
inline void OnDespawned(::GlobalNamespace::FlyingScoreEffect*  item) ;

/// @brief Method .ctor, addr 0x3aedd2c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _maxCutDistanceScoreIndicator, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__maxCutDistanceScoreIndicator, put=__cordl_internal_set__maxCutDistanceScoreIndicator)) ::UnityW<::UnityEngine::SpriteRenderer>  _maxCutDistanceScoreIndicator;
...
/// @brief Method HandleCutScoreBufferDidChange, addr 0x3aedb24, size 0x4c, virtual true, abstract: false, final true
inline void HandleCutScoreBufferDidChange(::GlobalNamespace::CutScoreBuffer*  cutScoreBuffer) ;

/// @brief Method HandleCutScoreBufferDidFinish, addr 0x3aedb70, size 0x4, virtual true, abstract: false, final true
inline void HandleCutScoreBufferDidFinish(::GlobalNamespace::CutScoreBuffer*  cutScoreBuffer) ;

/// @brief Method InitAndPresent, addr 0x3aed530, size 0x4e4, virtual false, abstract: false, final false
...
/// @brief Method ManualUpdate, addr 0x3aeda9c, size 0x88, virtual true, abstract: false, final false
inline void ManualUpdate(float_t  t) ;

static inline ::GlobalNamespace::FlyingScoreEffect* New_ctor() ;

/// @brief Method RefreshScore, addr 0x3aeda14, size 0x88, virtual false, abstract: false, final false
inline void RefreshScore(int32_t  score, int32_t  maxPossibleCutScore) ;

/// @brief Method UnregisterCallbacksIfNeeded, addr 0x3aedb74, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aedc9c, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
