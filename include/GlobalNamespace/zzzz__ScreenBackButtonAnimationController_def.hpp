...
/// @brief Field _animationHashes, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__animationHashes, put=__cordl_internal_set__animationHashes)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__ScreenBackButtonAnimationController__AnimationType,int32_t>*  _animationHashes;
...
/// @brief Method Awake, addr 0x2239758, size 0x20, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::ScreenBackButtonAnimationController* New_ctor() ;

/// @brief Method StartAnimation, addr 0x2239778, size 0x70, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__ScreenBackButtonAnimationController__AnimationType,int32_t>*> const& __cordl_internal_get__animationHashes() const;
...
/// @brief Method .ctor, addr 0x22397e8, size 0x1e0, virtual false, abstract: false, final false
inline void _ctor() ;
