...
/// @brief Method CreateFromSerializedData, addr 0x226d1a0, size 0x2c, virtual true, abstract: false, final true
inline ::GlobalNamespace::AuthenticationToken CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Deserialize, addr 0x226d1cc, size 0xf0, virtual false, abstract: false, final false
static inline ::GlobalNamespace::AuthenticationToken Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method FromHex, addr 0x226d0b8, size 0xe8, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> FromHex(::StringW  str) ;

/// @brief Method FromUtf8, addr 0x226d088, size 0x30, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> FromUtf8(::StringW  str) ;

/// @brief Method GetHexVal, addr 0x226d360, size 0xc4, virtual false, abstract: false, final false
static inline uint8_t GetHexVal(char16_t  c) ;

/// @brief Method Serialize, addr 0x226cff4, size 0x94, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method ToHex, addr 0x226d2ec, size 0x74, virtual false, abstract: false, final false
static inline ::StringW ToHex(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method ToUtf8, addr 0x226d2bc, size 0x30, virtual false, abstract: false, final false
static inline ::StringW ToUtf8(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method .ctor, addr 0x226cfe4, size 0x10, virtual false, abstract: false, final false
