...
/// @brief Method AdjustPose, addr 0x394f698, size 0xac, virtual false, abstract: false, final false
static inline ::UnityEngine::Pose AdjustPose(::UnityEngine::Pose  originalPose, ::UnityEngine::Pose  adjustment) ;

/// @brief Method Init, addr 0x394f0a0, size 0xc, virtual false, abstract: false, final false
inline void Init(::GlobalNamespace::IVRPlatformHelper*  vrPlatformHelper) ;

/// @brief Method InvertControllerPose, addr 0x394f744, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x394f264, size 0x100, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x394f260, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method SetupVRPlatformHelper, addr 0x394f0ac, size 0x1b4, virtual false, abstract: false, final false
inline void SetupVRPlatformHelper() ;

/// @brief Method TryGetControllerOffset, addr 0x394f364, size 0x74, virtual false, abstract: false, final false
inline bool TryGetControllerOffset(ByRef<::UnityEngine::Pose>  poseOffset) ;

/// @brief Method TryGetControllerOffset, addr 0x394f3d8, size 0x210, virtual false, abstract: false, final false
static inline bool TryGetControllerOffset(::GlobalNamespace::IVRPlatformHelper*  vrPlatformHelper, ::GlobalNamespace::VRControllerTransformOffset*  transformOffset, ::UnityEngine::XR::XRNode  node, ByRef<::UnityEngine::Pose>  poseOffset) ;

/// @brief Method Update, addr 0x394f8a8, size 0x2b0, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateAnchorOffsetPose, addr 0x394f054, size 0x4c, virtual false, abstract: false, final false
inline void UpdateAnchorOffsetPose() ;

/// @brief Method UpdateAnchorOffsetPose, addr 0x394f794, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x394fb58, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_anchorUpdateEvent, addr 0x394edf8, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_active, addr 0x394edd0, size 0x20, virtual false, abstract: false, final false
inline bool get_active() ;

/// @brief Method get_forward, addr 0x394ec28, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_forward() ;

/// @brief Method get_mouseMode, addr 0x394ef58, size 0x8, virtual false, abstract: false, final false
inline bool get_mouseMode() ;

/// @brief Method get_node, addr 0x394ebc8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::XR::XRNode get_node() ;

/// @brief Method get_nodeIdx, addr 0x394ebd8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_nodeIdx() ;

/// @brief Method get_position, addr 0x394ebe8, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_position() ;

/// @brief Method get_rotation, addr 0x394ec08, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_rotation() ;

/// @brief Method get_thumbstick, addr 0x394ed24, size 0xac, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_thumbstick() ;

/// @brief Method get_triggerValue, addr 0x394ec48, size 0xdc, virtual false, abstract: false, final false
inline float_t get_triggerValue() ;

/// @brief Method get_viewAnchorTransform, addr 0x394edf0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_viewAnchorTransform() ;

/// @brief Method remove_anchorUpdateEvent, addr 0x394eea8, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method set_mouseMode, addr 0x394ef60, size 0xf4, virtual false, abstract: false, final false
inline void set_mouseMode(bool  value) ;

/// @brief Method set_node, addr 0x394ebd0, size 0x8, virtual false, abstract: false, final false
inline void set_node(::UnityEngine::XR::XRNode  value) ;

/// @brief Method set_nodeIdx, addr 0x394ebe0, size 0x8, virtual false, abstract: false, final false
