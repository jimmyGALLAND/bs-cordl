...
/// @brief Method Clear, addr 0x226dcfc, size 0x70, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method CopyTo, addr 0x226de10, size 0x1c, virtual false, abstract: false, final false
inline void CopyTo(::ArrayW<uint8_t,::Array<uint8_t>*>  destination) ;

/// @brief Method CopyTo, addr 0x226e164, size 0x3c, virtual false, abstract: false, final false
inline void CopyTo(::ArrayW<uint8_t,::Array<uint8_t>*>  destination, ByRef<int32_t>  length) ;

/// @brief Method Deserialize, addr 0x226df14, size 0x23c, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method GetData, addr 0x226d940, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method Resize, addr 0x226dd6c, size 0xa4, virtual false, abstract: false, final false
inline void Resize(int32_t  length) ;

/// @brief Method Serialize, addr 0x226de2c, size 0xe8, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method SetData, addr 0x226da30, size 0x28, virtual false, abstract: false, final false
inline void SetData(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method SetData, addr 0x226dae4, size 0x218, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x226da58, size 0x48, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, int32_t  minLength, int32_t  maxLength, bool  allowEmpty) ;

/// @brief Method .ctor, addr 0x226daa0, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, int32_t  size, bool  allowEmpty) ;

/// @brief Method get_data, addr 0x226d938, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_data() ;

/// @brief Method get_length, addr 0x226d930, size 0x8, virtual false, abstract: false, final false
inline int32_t get_length() ;

/// @brief Convert to "::LiteNetLib::Utils::INetSerializable"
constexpr ::LiteNetLib::Utils::INetSerializable* i___LiteNetLib__Utils__INetSerializable() noexcept;

/// @brief Method op_Implicit, addr 0x226e150, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method set_data, addr 0x226da2c, size 0x4, virtual false, abstract: false, final false
