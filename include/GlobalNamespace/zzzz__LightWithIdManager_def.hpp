...
/// @brief Method GetColorForId, addr 0x396023c, size 0xcc, virtual false, abstract: false, final false
inline ::UnityEngine::Color GetColorForId(int32_t  lightId, bool  initializeIfNull) ;

/// @brief Method LateUpdate, addr 0x395f994, size 0x27c, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::LightWithIdManager* New_ctor() ;

/// @brief Method RegisterLight, addr 0x395fc10, size 0x42c, virtual false, abstract: false, final false
inline void RegisterLight(::GlobalNamespace::ILightWithId*  lightWithId) ;

/// @brief Method SetColorForId, addr 0x395d628, size 0x23c, virtual false, abstract: false, final false
inline void SetColorForId(int32_t  lightId, ::UnityEngine::Color  color) ;

/// @brief Method UnregisterLight, addr 0x396003c, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3960308, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didChangeSomeColorsThisFrameEvent, addr 0x395f85c, size 0x9c, virtual false, abstract: false, final false
inline void add_didChangeSomeColorsThisFrameEvent(::System::Action*  value) ;

/// @brief Method remove_didChangeSomeColorsThisFrameEvent, addr 0x395f8f8, size 0x9c, virtual false, abstract: false, final false
