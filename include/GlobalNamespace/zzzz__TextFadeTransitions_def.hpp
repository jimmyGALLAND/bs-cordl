...
/// @brief Method Awake, addr 0x3b5a5b0, size 0x7c, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::TextFadeTransitions* New_ctor() ;

/// @brief Method RefreshState, addr 0x3b5a700, size 0x100, virtual false, abstract: false, final false
inline void RefreshState() ;

/// @brief Method RefreshTextAlpha, addr 0x3b5a62c, size 0xd0, virtual false, abstract: false, final false
inline void RefreshTextAlpha() ;

/// @brief Method ShowText, addr 0x3b5a800, size 0x74, virtual false, abstract: false, final false
inline void ShowText(::StringW  text) ;

/// @brief Method Update, addr 0x3b5a6fc, size 0x4, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b5a874, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
