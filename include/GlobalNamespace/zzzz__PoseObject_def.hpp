...
/// @brief Method .ctor, addr 0x3a8e8e0, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Transform*  transform, ::GlobalNamespace::PoseObjectIdSO*  poseObjectId) ;

/// @brief Method get_id, addr 0x3a907b0, size 0x1c, virtual false, abstract: false, final false
inline ::StringW get_id() ;

/// @brief Method get_objectTransform, addr 0x3a907a8, size 0x8, virtual false, abstract: false, final false
