...
/// @brief Method InstallBindings, addr 0x3b60a80, size 0x18c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b60c0c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
