...
/// @brief Method .ctor, addr 0x2661064, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  lobbyCode) ;

/// @brief Method .ctor, addr 0x2661038, size 0x2c, virtual false, abstract: false, final false
