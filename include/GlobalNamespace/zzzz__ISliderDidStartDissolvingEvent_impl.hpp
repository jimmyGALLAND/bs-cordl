...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ISliderDidStartDissolvingEvent::*)(::GlobalNamespace::SliderController*, float_t)>(&::GlobalNamespace::ISliderDidStartDissolvingEvent::HandleSliderDidStartDissolving)> {
