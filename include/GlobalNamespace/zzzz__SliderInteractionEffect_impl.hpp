...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::GlobalNamespace::SliderInteractionEffect::*)()>(&::GlobalNamespace::SliderInteractionEffect::get_saberInteractionParam)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x3a6d144;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::ColorType (::GlobalNamespace::SliderInteractionEffect::*)()>(&::GlobalNamespace::SliderInteractionEffect::get_colorType)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x3a6d054;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderInteractionEffect::*)()>(&::GlobalNamespace::SliderInteractionEffect::Start)> {
  ...
  constexpr static std::size_t addrs = 0x3a6cf70;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderInteractionEffect::*)()>(&::GlobalNamespace::SliderInteractionEffect::OnDestroy)> {
  constexpr static std::size_t size = 0xe4;
  constexpr static std::size_t addrs = 0x3a6de6c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderInteractionEffect::*)(float_t)>(&::GlobalNamespace::SliderInteractionEffect::StartEffect)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderInteractionEffect::*)()>(&::GlobalNamespace::SliderInteractionEffect::EndEffect)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderInteractionEffect::*)(::GlobalNamespace::SliderInteractionManager*, float_t)>(&::GlobalNamespace::SliderInteractionEffect::HandleSliderWasAddedToActiveSliders)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x3a6e0b0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderInteractionEffect::*)(::GlobalNamespace::SliderInteractionManager*)>(&::GlobalNamespace::SliderInteractionEffect::HandleAllSliderWereRemovedFromActiveSliders)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x3a6e0bc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderInteractionEffect::*)()>(&::GlobalNamespace::SliderInteractionEffect::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3a6d1fc;
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, sliderInteractionManager, saberInteractionParam);
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::SliderInteractionEffect*>());
}
