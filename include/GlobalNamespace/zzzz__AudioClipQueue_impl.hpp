...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::AudioClipQueue::*)()>(&::GlobalNamespace::AudioClipQueue::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x3a49a78;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::AudioClipQueue::*)()>(&::GlobalNamespace::AudioClipQueue::Update)> {
  ...
  constexpr static std::size_t addrs = 0x3a49a98;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::AudioClipQueue::*)(::UnityEngine::AudioClip*, float_t)>(&::GlobalNamespace::AudioClipQueue::PlayAudioClipWithDelay)> {
  constexpr static std::size_t size = 0xc8;
  constexpr static std::size_t addrs = 0x3a49bd8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::AudioClipQueue::*)()>(&::GlobalNamespace::AudioClipQueue::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3a49ca0;
...
constexpr ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::AudioClip>>*& GlobalNamespace::AudioClipQueue::__cordl_internal_get__queue()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____queue;
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityW<::UnityEngine::AudioClip>>*> const& GlobalNamespace::AudioClipQueue::__cordl_internal_get__queue() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____queue;
}
constexpr void GlobalNamespace::AudioClipQueue::__cordl_internal_set__queue(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::AudioClip>>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr float_t& GlobalNamespace::AudioClipQueue::__cordl_internal_get__delay()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____delay;
}
constexpr float_t const& GlobalNamespace::AudioClipQueue::__cordl_internal_get__delay() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____delay;
}
constexpr void GlobalNamespace::AudioClipQueue::__cordl_internal_set__delay(float_t  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
