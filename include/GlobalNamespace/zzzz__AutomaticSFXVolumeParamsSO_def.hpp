...
/// @brief Method .ctor, addr 0x3a4b1b0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_attackTime, addr 0x3a4b188, size 0x8, virtual false, abstract: false, final false
inline float_t get_attackTime() ;

/// @brief Method get_impact, addr 0x3a4b180, size 0x8, virtual false, abstract: false, final false
inline float_t get_impact() ;

/// @brief Method get_maxVolume, addr 0x3a4b1a0, size 0x8, virtual false, abstract: false, final false
inline float_t get_maxVolume() ;

/// @brief Method get_minVolume, addr 0x3a4b198, size 0x8, virtual false, abstract: false, final false
inline float_t get_minVolume() ;

/// @brief Method get_musicVolumeMultiplier, addr 0x3a4b170, size 0x8, virtual false, abstract: false, final false
inline float_t get_musicVolumeMultiplier() ;

/// @brief Method get_releaseTime, addr 0x3a4b190, size 0x8, virtual false, abstract: false, final false
inline float_t get_releaseTime() ;

/// @brief Method get_threshold, addr 0x3a4b178, size 0x8, virtual false, abstract: false, final false
inline float_t get_threshold() ;

/// @brief Method get_volumeSmooth, addr 0x3a4b1a8, size 0x8, virtual false, abstract: false, final false
