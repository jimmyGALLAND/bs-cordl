...
/// @brief Field _stinsonOnlyEntries, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__stinsonOnlyEntries, put=__cordl_internal_set__stinsonOnlyEntries)) ::ArrayW<::UnityW<::UnityEngine::GameObject>,::Array<::UnityW<::UnityEngine::GameObject>>*>  _stinsonOnlyEntries;

/// @brief Method DidActivate, addr 0x3a6ecf4, size 0x24c, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3a6ef40, size 0x108, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method Handle120HzToggleValueChanged, addr 0x3a6f064, size 0x40, virtual false, abstract: false, final false
inline void Handle120HzToggleValueChanged(bool  newState) ;

/// @brief Method HandleMirrorChanged, addr 0x3a6f048, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a6f0a4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
