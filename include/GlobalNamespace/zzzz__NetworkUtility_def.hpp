...
/// @brief Method DecryptName, addr 0x22914f0, size 0x420, virtual false, abstract: false, final false
static inline ::StringW DecryptName(::StringW  text) ;

/// @brief Method EncryptName, addr 0x22910d4, size 0x41c, virtual false, abstract: false, final false
static inline ::StringW EncryptName(::StringW  text) ;

/// @brief Method GenerateId, addr 0x2291910, size 0x98, virtual false, abstract: false, final false
static inline ::StringW GenerateId() ;

/// @brief Method GetHashBase64, addr 0x2290ecc, size 0x208, virtual false, abstract: false, final false
static inline ::StringW GetHashBase64(::StringW  input) ;

/// @brief Method GetHashedUserId, addr 0x2290e00, size 0xcc, virtual false, abstract: false, final false
static inline ::StringW GetHashedUserId(::StringW  userId, ::GlobalNamespace::__AuthenticationToken__Platform  platform) ;

/// @brief Method Init, addr 0x2290d20, size 0xe0, virtual false, abstract: false, final false
