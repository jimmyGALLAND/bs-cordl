...
/// @brief Field <>7__wrap1, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get___7__wrap1, put=__cordl_internal_set___7__wrap1)) ::System::Collections::Generic::IEnumerator_1<::GlobalNamespace::__ExpiringDictionary_2__Entry<TKey,TValue>*>*  __7__wrap1;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEnumerator_1<::GlobalNamespace::__ExpiringDictionary_2__Entry<TKey,TValue>*>*> const& __cordl_internal_get___7__wrap1() const;
...
/// @brief Field _entryLookup, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__entryLookup, put=__cordl_internal_set__entryLookup)) ::System::Collections::Generic::Dictionary_2<TKey,::GlobalNamespace::__ExpiringDictionary_2__Entry<TKey,TValue>*>*  _entryLookup;
...
/// @brief Field _expirationQueue, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__expirationQueue, put=__cordl_internal_set__expirationQueue)) ::GlobalNamespace::OrderedSet_1<::GlobalNamespace::__ExpiringDictionary_2__Entry<TKey,TValue>*>*  _expirationQueue;

/// @brief Field _reusableEntries, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__reusableEntries, put=__cordl_internal_set__reusableEntries)) ::System::Collections::Generic::List_1<::GlobalNamespace::__ExpiringDictionary_2__Entry<TKey,TValue>*>*  _reusableEntries;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<TKey,::GlobalNamespace::__ExpiringDictionary_2__Entry<TKey,TValue>*>*> const& __cordl_internal_get__entryLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__ExpiringDictionary_2__Entry<TKey,TValue>*>*> const& __cordl_internal_get__reusableEntries() const;
