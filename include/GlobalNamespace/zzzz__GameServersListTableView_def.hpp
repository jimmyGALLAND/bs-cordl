...
/// @brief Field _gameServerDetailCellPrefab, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameServerDetailCellPrefab, put=__cordl_internal_set__gameServerDetailCellPrefab)) ::UnityW<::GlobalNamespace::GameServerListDetailTableCell>  _gameServerDetailCellPrefab;

/// @brief Field _gameServerListCellPrefab, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameServerListCellPrefab, put=__cordl_internal_set__gameServerListCellPrefab)) ::UnityW<::GlobalNamespace::GameServerListTableCell>  _gameServerListCellPrefab;

/// @brief Field _gamesList, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__gamesList, put=__cordl_internal_set__gamesList)) ::ArrayW<::GlobalNamespace::INetworkPlayer*,::Array<::GlobalNamespace::INetworkPlayer*>*>  _gamesList;
...
/// @brief Field joinButtonPressedEvent, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_joinButtonPressedEvent, put=__cordl_internal_set_joinButtonPressedEvent)) ::System::Action_1<::GlobalNamespace::INetworkPlayer*>*  joinButtonPressedEvent;
...
/// @brief Method CellForContent, addr 0x3a77590, size 0x164, virtual true, abstract: false, final true
...
/// @brief Method CellForDetail, addr 0x3a776f4, size 0x1b4, virtual true, abstract: false, final true
inline ::UnityW<::HMUI::TableCell> CellForDetail(::GlobalNamespace::TableViewWithDetailCell*  tableView, int32_t  contentIdx) ;

/// @brief Method CellSize, addr 0x3a77460, size 0xc, virtual true, abstract: false, final true
inline float_t CellSize() ;

/// @brief Method HandleGameServerListDetailTableCellJoinServerButtonWasPressed, addr 0x3a779cc, size 0x24, virtual false, abstract: false, final false
inline void HandleGameServerListDetailTableCellJoinServerButtonWasPressed() ;

/// @brief Method HandleTableViewDidDeselectCellWithIdx, addr 0x3a77a24, size 0x8, virtual false, abstract: false, final false
inline void HandleTableViewDidDeselectCellWithIdx(::GlobalNamespace::TableViewWithDetailCell*  arg1, int32_t  arg2) ;

/// @brief Method HandleTableViewDidSelectCellWithIdx, addr 0x3a779f0, size 0x34, virtual false, abstract: false, final false
inline void HandleTableViewDidSelectCellWithIdx(::HMUI::TableView*  tableView, int32_t  id) ;

/// @brief Method Init, addr 0x3a77484, size 0x10c, virtual false, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::GameServersListTableView* New_ctor() ;

/// @brief Method NumberOfCells, addr 0x3a7746c, size 0x18, virtual true, abstract: false, final true
inline int32_t NumberOfCells() ;

/// @brief Method OnDestroy, addr 0x3a77a2c, size 0xec, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetData, addr 0x3a778a8, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a77b18, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_joinButtonPressedEvent, addr 0x3a77300, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_joinButtonPressedEvent, addr 0x3a773b0, size 0xb0, virtual false, abstract: false, final false
