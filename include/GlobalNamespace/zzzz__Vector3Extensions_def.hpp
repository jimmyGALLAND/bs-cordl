...
public:
// Declarations
/// @brief Method Abs, addr 0x226a10c, size 0x18, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 Abs(ByRef<::UnityEngine::Vector3>  vector) ;

/// @brief Method InverseLerp, addr 0x226a048, size 0x50, virtual false, abstract: false, final false
static inline float_t InverseLerp(::UnityEngine::Vector3  a, ::UnityEngine::Vector3  b, ::UnityEngine::Vector3  value) ;

/// @brief Method MirrorEulerAnglesOnYZPlane, addr 0x226a100, size 0xc, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 MirrorEulerAnglesOnYZPlane(::UnityEngine::Vector3  vector) ;

/// @brief Method MirrorOnYZPlane, addr 0x226a0f8, size 0x8, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 MirrorOnYZPlane(::UnityEngine::Vector3  vector) ;

/// @brief Method RotatedAroundPivot, addr 0x226a098, size 0x60, virtual false, abstract: false, final false
