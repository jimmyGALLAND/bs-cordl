...
/// @brief Field _privacyPolicyLocalizedTextAsset, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__privacyPolicyLocalizedTextAsset, put=__cordl_internal_set__privacyPolicyLocalizedTextAsset)) ::UnityW<::GlobalNamespace::LocalizedTextAsset>  _privacyPolicyLocalizedTextAsset;
...
/// @brief Method DidActivate, addr 0x3b8e6c4, size 0x1d4, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method Init, addr 0x3b8e898, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method <DidActivate>b__10_0, addr 0x3b8e8b4, size 0x1c, virtual false, abstract: false, final false
inline void _DidActivate_b__10_0() ;

/// @brief Method <DidActivate>b__10_1, addr 0x3b8e8d0, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b8e8ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x3b8e58c, size 0x9c, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action*  value) ;

/// @brief Method remove_didFinishEvent, addr 0x3b8e628, size 0x9c, virtual false, abstract: false, final false
