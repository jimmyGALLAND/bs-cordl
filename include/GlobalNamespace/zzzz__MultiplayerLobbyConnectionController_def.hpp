...
/// @brief Field <connectionState>k__BackingField, offset 0x30, size 0x4 
 __declspec(property(get=__cordl_internal_get__connectionState_k__BackingField, put=__cordl_internal_set__connectionState_k__BackingField)) ::GlobalNamespace::__MultiplayerLobbyConnectionController__LobbyConnectionState  _connectionState_k__BackingField;

/// @brief Field <connectionType>k__BackingField, offset 0x34, size 0x4 
 __declspec(property(get=__cordl_internal_get__connectionType_k__BackingField, put=__cordl_internal_set__connectionType_k__BackingField)) ::GlobalNamespace::__MultiplayerLobbyConnectionController__LobbyConnectionType  _connectionType_k__BackingField;
...
/// @brief Field connectionFailedEvent, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_connectionFailedEvent, put=__cordl_internal_set_connectionFailedEvent)) ::System::Action_2<::GlobalNamespace::__MultiplayerLobbyConnectionController__LobbyConnectionType,::GlobalNamespace::ConnectionFailedReason>*  connectionFailedEvent;
...
/// @brief Method ClearCurrentConnection, addr 0x3b43f48, size 0x8, virtual false, abstract: false, final false
inline void ClearCurrentConnection() ;

/// @brief Method ConnectToMatchmaking, addr 0x3b43b74, size 0x32c, virtual false, abstract: false, final false
...
/// @brief Method ConnectToParty, addr 0x3b43208, size 0x31c, virtual false, abstract: false, final false
inline void ConnectToParty(::StringW  serverCode) ;

/// @brief Method ConnectToServer, addr 0x3b43938, size 0x23c, virtual false, abstract: false, final false
inline void ConnectToServer(::GlobalNamespace::INetworkPlayer*  server, ::StringW  password) ;

/// @brief Method CreateOrConnectToDestinationParty, addr 0x3b43524, size 0x414, virtual false, abstract: false, final false
inline void CreateOrConnectToDestinationParty(::GlobalNamespace::SelectMultiplayerLobbyDestination*  lobbyDestination) ;

/// @brief Method CreateParty, addr 0x3b42b3c, size 0x448, virtual false, abstract: false, final false
inline void CreateParty(::GlobalNamespace::CreateServerFormData  data) ;

/// @brief Method HandleMultiplayerSessionManagerConnected, addr 0x3b43f50, size 0x274, virtual false, abstract: false, final false
inline void HandleMultiplayerSessionManagerConnected() ;

/// @brief Method HandleMultiplayerSessionManagerConnectionFailed, addr 0x3b42f84, size 0x284, virtual false, abstract: false, final false
inline void HandleMultiplayerSessionManagerConnectionFailed(::GlobalNamespace::ConnectionFailedReason  reason) ;

/// @brief Method HandleMultiplayerSessionManagerConnectionFailedWithRetry, addr 0x3b441c4, size 0x130, virtual false, abstract: false, final false
inline void HandleMultiplayerSessionManagerConnectionFailedWithRetry(::GlobalNamespace::ConnectionFailedReason  reason) ;

/// @brief Method LeaveLobby, addr 0x3b43ea0, size 0xa8, virtual false, abstract: false, final false
...
constexpr ::System::Action_2<::GlobalNamespace::__MultiplayerLobbyConnectionController__LobbyConnectionType,::GlobalNamespace::ConnectionFailedReason>*& __cordl_internal_get_connectionFailedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::__MultiplayerLobbyConnectionController__LobbyConnectionType,::GlobalNamespace::ConnectionFailedReason>*> const& __cordl_internal_get_connectionFailedEvent() const;
...
constexpr void __cordl_internal_set_connectionFailedEvent(::System::Action_2<::GlobalNamespace::__MultiplayerLobbyConnectionController__LobbyConnectionType,::GlobalNamespace::ConnectionFailedReason>*  value) ;

constexpr void __cordl_internal_set_connectionSuccessEvent(::System::Action*  value) ;

/// @brief Method .ctor, addr 0x3b442f4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_connectionFailedEvent, addr 0x3b429ac, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method add_connectionSuccessEvent, addr 0x3b42874, size 0x9c, virtual false, abstract: false, final false
inline void add_connectionSuccessEvent(::System::Action*  value) ;

/// @brief Method get_connectionFailedReason, addr 0x3b42b2c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ConnectionFailedReason get_connectionFailedReason() ;

/// @brief Method get_connectionState, addr 0x3b42b0c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__MultiplayerLobbyConnectionController__LobbyConnectionState get_connectionState() ;

/// @brief Method get_connectionType, addr 0x3b42b1c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__MultiplayerLobbyConnectionController__LobbyConnectionType get_connectionType() ;

/// @brief Method remove_connectionFailedEvent, addr 0x3b42a5c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_connectionSuccessEvent, addr 0x3b42910, size 0x9c, virtual false, abstract: false, final false
inline void remove_connectionSuccessEvent(::System::Action*  value) ;

/// @brief Method set_connectionFailedReason, addr 0x3b42b34, size 0x8, virtual false, abstract: false, final false
inline void set_connectionFailedReason(::GlobalNamespace::ConnectionFailedReason  value) ;

/// @brief Method set_connectionState, addr 0x3b42b14, size 0x8, virtual false, abstract: false, final false
inline void set_connectionState(::GlobalNamespace::__MultiplayerLobbyConnectionController__LobbyConnectionState  value) ;

/// @brief Method set_connectionType, addr 0x3b42b24, size 0x8, virtual false, abstract: false, final false
