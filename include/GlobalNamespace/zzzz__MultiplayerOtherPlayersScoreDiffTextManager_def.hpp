...
/// @brief Method <Update>b__10_0, addr 0x3b45ccc, size 0x14, virtual false, abstract: false, final false
inline bool _Update_b__10_0(::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*  p) ;

/// @brief Method .ctor, addr 0x3b45cc4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method HandleStateChanged, addr 0x3b45af8, size 0x168, virtual false, abstract: false, final false
inline void HandleStateChanged(::GlobalNamespace::__MultiplayerController__State  newState) ;

/// @brief Method HideAll, addr 0x3b4527c, size 0x3c0, virtual false, abstract: false, final false
inline void HideAll() ;

/// @brief Method InitLeftRightPositions, addr 0x3b4563c, size 0x4bc, virtual false, abstract: false, final false
inline void InitLeftRightPositions() ;

static inline ::GlobalNamespace::MultiplayerOtherPlayersScoreDiffTextManager* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b44de4, size 0xd0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b44d2c, size 0xb8, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3b44eb4, size 0x3c8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b45c60, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
