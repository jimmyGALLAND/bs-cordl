...
/// @brief Method GetCoverSpriteAsync, addr 0x267f400, size 0x28, virtual true, abstract: false, final true
...
/// @brief Method GetPreviewAudioClip, addr 0x267f428, size 0x24, virtual true, abstract: false, final true
...
static inline ::GlobalNamespace::FileSystemPreviewMediaData* New_ctor(::GlobalNamespace::SpriteAsyncLoader*  spriteAsyncLoader, ::GlobalNamespace::AudioClipAsyncLoader*  audioClipAsyncLoader, ::StringW  rootPath, ::StringW  coverSpritePath, ::StringW  previewAudioClipPath) ;

/// @brief Method UnloadPreviewAudioClip, addr 0x267f44c, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x267f240, size 0x1c0, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::SpriteAsyncLoader*  spriteAsyncLoader, ::GlobalNamespace::AudioClipAsyncLoader*  audioClipAsyncLoader, ::StringW  rootPath, ::StringW  coverSpritePath, ::StringW  previewAudioClipPath) ;
