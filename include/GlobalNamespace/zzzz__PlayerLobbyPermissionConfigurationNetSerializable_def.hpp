...
/// @brief Field _hasRecommendGameplayModifiersPermission, offset 0x22, size 0x1 
 __declspec(property(get=__cordl_internal_get__hasRecommendGameplayModifiersPermission, put=__cordl_internal_set__hasRecommendGameplayModifiersPermission)) bool  _hasRecommendGameplayModifiersPermission;
...
/// @brief Method Deserialize, addr 0x26d4ef8, size 0x6c, virtual true, abstract: false, final false
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x26d4e10, size 0x30, virtual false, abstract: false, final false
inline ::GlobalNamespace::PlayerLobbyPermissionConfigurationNetSerializable* Init(::StringW  userId, bool  isServerOwner, bool  hasRecommendBeatmapsPermission, bool  hasRecommendGameplayModifiersPermission, bool  hasKickVotePermission, bool  hasInvitePermission) ;

static inline ::GlobalNamespace::PlayerLobbyPermissionConfigurationNetSerializable* New_ctor() ;

/// @brief Method Obtain, addr 0x26d4dac, size 0x64, virtual false, abstract: false, final false
static inline ::GlobalNamespace::PlayerLobbyPermissionConfigurationNetSerializable* Obtain() ;

/// @brief Method Serialize, addr 0x26d4e98, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26d4e40, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_hasInvitePermission, addr 0x26d4da4, size 0x8, virtual false, abstract: false, final false
inline bool get_hasInvitePermission() ;

/// @brief Method get_hasKickVotePermission, addr 0x26d4d9c, size 0x8, virtual false, abstract: false, final false
inline bool get_hasKickVotePermission() ;

/// @brief Method get_hasRecommendBeatmapsPermission, addr 0x26d4d8c, size 0x8, virtual false, abstract: false, final false
inline bool get_hasRecommendBeatmapsPermission() ;

/// @brief Method get_hasRecommendGameplayModifiersPermission, addr 0x26d4d94, size 0x8, virtual false, abstract: false, final false
inline bool get_hasRecommendGameplayModifiersPermission() ;

/// @brief Method get_isServerOwner, addr 0x26d4d84, size 0x8, virtual false, abstract: false, final false
inline bool get_isServerOwner() ;

/// @brief Method get_userId, addr 0x26d4d7c, size 0x8, virtual false, abstract: false, final false
