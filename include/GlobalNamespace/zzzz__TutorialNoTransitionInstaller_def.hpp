...
/// @brief Field _scenesTransitionSetupData, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__scenesTransitionSetupData, put=__cordl_internal_set__scenesTransitionSetupData)) ::UnityW<::GlobalNamespace::TutorialScenesTransitionSetupDataSO>  _scenesTransitionSetupData;

/// @brief Method InstallBindings, addr 0x3aac560, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aac5a4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
