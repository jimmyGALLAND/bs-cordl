...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint64_t (::GlobalNamespace::ISonyPlatformManager::*)()>(&::GlobalNamespace::ISonyPlatformManager::get_userAccountId)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Task* (::GlobalNamespace::ISonyPlatformManager::*)()>(&::GlobalNamespace::ISonyPlatformManager::get_initializationTask)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
