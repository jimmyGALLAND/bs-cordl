...
/// @brief Method InstallBindings, addr 0x3b6023c, size 0x218, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b60454, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
