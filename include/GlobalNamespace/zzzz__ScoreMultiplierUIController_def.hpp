...
/// @brief Field _multiplierTexts, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplierTexts, put=__cordl_internal_set__multiplierTexts)) ::ArrayW<::UnityW<::TMPro::TextMeshProUGUI>,::Array<::UnityW<::TMPro::TextMeshProUGUI>>*>  _multiplierTexts;
...
/// @brief Method HandleMultiplierDidChange, addr 0x3b13f58, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x3b13dd4, size 0x4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3b13dd0, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RegisterForEvents, addr 0x3b13c3c, size 0x194, virtual false, abstract: false, final false
inline void RegisterForEvents() ;

/// @brief Method Start, addr 0x3b13b58, size 0xe4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UnregisterFromEvents, addr 0x3b13dd8, size 0x100, virtual false, abstract: false, final false
inline void UnregisterFromEvents() ;

/// @brief Method Update, addr 0x3b13ed8, size 0x80, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b14024, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
