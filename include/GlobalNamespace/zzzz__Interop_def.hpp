...
/// @brief Method GetErrorMessage, addr 0x3bc374c, size 0x64, virtual false, abstract: false, final false
inline ::StringW GetErrorMessage() ;

/// @brief Method ToString, addr 0x3bc3998, size 0xd4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x3bc3818, size 0x68, virtual false, abstract: false, final false
inline void _ctor(int32_t  _cordl_errno) ;

/// @brief Method .ctor, addr 0x3bc3884, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::__Interop__Error  error) ;

/// @brief Method get_Error, addr 0x3bc3890, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__Interop__Error get_Error() ;

/// @brief Method get_RawErrno, addr 0x3bc36e0, size 0x6c, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_error", ty: "::GlobalNamespace::__Interop__Error", modifiers: "", def_value: None }, CppParam { name: "_rawErrno", ty: "int32_t", modifiers: "", def_value: None }]
...
public:
// Declarations
/// @brief Method GetName, addr 0x3bc4304, size 0x124, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "Name", ty: "::cordl_internals::Ptr<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "NameLength", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "InodeType", ty: "::GlobalNamespace::__Interop__Sys__NodeType", modifiers: "", def_value: None }]
...
/// @brief Method CloseDir, addr 0x3bc3aac, size 0x1c, virtual false, abstract: false, final false
static inline int32_t CloseDir(::System::IntPtr  dir) ;

/// @brief Method ConvertErrorPalToPlatform, addr 0x3bc3898, size 0x4, virtual false, abstract: false, final false
static inline int32_t ConvertErrorPalToPlatform(::GlobalNamespace::__Interop__Error  error) ;

/// @brief Method ConvertErrorPlatformToPal, addr 0x3bc3880, size 0x4, virtual false, abstract: false, final false
static inline ::GlobalNamespace::__Interop__Error ConvertErrorPlatformToPal(int32_t  platformErrno) ;

/// @brief Method CopyFile, addr 0x3bc3df8, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method DoubleToString, addr 0x3bc42ac, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method GetEGid, addr 0x3bc3eac, size 0x4, virtual false, abstract: false, final false
static inline uint32_t GetEGid() ;

/// @brief Method GetEUid, addr 0x3bc3eb0, size 0x4, virtual false, abstract: false, final false
static inline uint32_t GetEUid() ;

/// @brief Method GetLastErrorInfo, addr 0x3bc3564, size 0x68, virtual false, abstract: false, final false
static inline ::GlobalNamespace::__Interop__ErrorInfo GetLastErrorInfo() ;

/// @brief Method GetNonCryptographicallySecureRandomBytes, addr 0x3bc3814, size 0x4, virtual false, abstract: false, final false
static inline void GetNonCryptographicallySecureRandomBytes(::cordl_internals::Ptr<uint8_t>  buffer, int32_t  length) ;

/// @brief Method GetReadDirRBufferSize, addr 0x3bc3aa4, size 0x4, virtual false, abstract: false, final false
static inline int32_t GetReadDirRBufferSize() ;

/// @brief Method LChflagsCanSetHiddenFlag, addr 0x3bc3eb4, size 0x4, virtual false, abstract: false, final false
static inline int32_t LChflagsCanSetHiddenFlag() ;

/// @brief Method LStat, addr 0x3bc3d68, size 0x3c, virtual false, abstract: false, final false
static inline int32_t LStat(::StringW  path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus>  output) ;

/// @brief Method LStat, addr 0x3bc4140, size 0x138, virtual false, abstract: false, final false
static inline int32_t LStat(::System::ReadOnlySpan_1<char16_t>  path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus>  output) ;

/// @brief Method LStat, addr 0x3bc4124, size 0x1c, virtual false, abstract: false, final false
static inline int32_t LStat(ByRef<uint8_t>  path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus>  output) ;

/// @brief Method Link, addr 0x3bc3eb8, size 0x54, virtual false, abstract: false, final false
static inline int32_t Link(::StringW  source, ::StringW  link) ;

/// @brief Method MkDir, addr 0x3bc3f0c, size 0x3c, virtual false, abstract: false, final false
static inline int32_t MkDir(::StringW  path, int32_t  mode) ;

/// @brief Method OpenDir, addr 0x3bc3a70, size 0x34, virtual false, abstract: false, final false
static inline ::System::IntPtr OpenDir(::StringW  path) ;

/// @brief Method ReadDirR, addr 0x3bc3aa8, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ReadLink, addr 0x3bc3b14, size 0x218, virtual false, abstract: false, final false
static inline ::StringW ReadLink(::StringW  path) ;

/// @brief Method ReadLink, addr 0x3bc3ac8, size 0x4c, virtual false, abstract: false, final false
static inline int32_t ReadLink(::StringW  path, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  bufferSize) ;

/// @brief Method Rename, addr 0x3bc3f48, size 0x54, virtual false, abstract: false, final false
static inline int32_t Rename(::StringW  oldPath, ::StringW  newPath) ;

/// @brief Method RmDir, addr 0x3bc3f9c, size 0x34, virtual false, abstract: false, final false
static inline int32_t RmDir(::StringW  path) ;

/// @brief Method Stat, addr 0x3bc3d2c, size 0x3c, virtual false, abstract: false, final false
static inline int32_t Stat(::StringW  path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus>  output) ;

/// @brief Method Stat, addr 0x3bc3fec, size 0x138, virtual false, abstract: false, final false
static inline int32_t Stat(::System::ReadOnlySpan_1<char16_t>  path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus>  output) ;

/// @brief Method Stat, addr 0x3bc3fd0, size 0x1c, virtual false, abstract: false, final false
static inline int32_t Stat(ByRef<uint8_t>  path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus>  output) ;

/// @brief Method StrError, addr 0x3bc389c, size 0xfc, virtual false, abstract: false, final false
static inline ::StringW StrError(int32_t  platformErrno) ;

/// @brief Method StrErrorR, addr 0x3bc3a6c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method Symlink, addr 0x3bc3da4, size 0x54, virtual false, abstract: false, final false
static inline int32_t Symlink(::StringW  target, ::StringW  linkPath) ;

/// @brief Method Unlink, addr 0x3bc4278, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method CheckIo, addr 0x3bc35cc, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method CheckIo, addr 0x3bc34ec, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method GetExceptionForIoErrno, addr 0x3bc3000, size 0x4ec, virtual false, abstract: false, final false
...
/// @brief Method GetIOException, addr 0x3bc365c, size 0x84, virtual false, abstract: false, final false
static inline ::System::Exception* GetIOException(::GlobalNamespace::__Interop__ErrorInfo  errorInfo) ;

/// @brief Method GetRandomBytes, addr 0x3bc37b0, size 0x64, virtual false, abstract: false, final false
static inline void GetRandomBytes(::cordl_internals::Ptr<uint8_t>  buffer, int32_t  length) ;

/// @brief Method ThrowExceptionForIoErrno, addr 0x3bc2fa8, size 0x58, virtual false, abstract: false, final false
static inline void ThrowExceptionForIoErrno(::GlobalNamespace::__Interop__ErrorInfo  errorInfo, ::StringW  path, bool  isDirectory, ::System::Func_2<::GlobalNamespace::__Interop__ErrorInfo,::GlobalNamespace::__Interop__ErrorInfo>*  errorRewriter) ;
