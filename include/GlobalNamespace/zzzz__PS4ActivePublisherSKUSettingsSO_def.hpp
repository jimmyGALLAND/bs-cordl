...
/// @brief Field activePublisherSKUSettings, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_activePublisherSKUSettings, put=__cordl_internal_set_activePublisherSKUSettings)) ::UnityW<::GlobalNamespace::PS4PublisherSKUSettingsSO>  activePublisherSKUSettings;
...
/// @brief Method .ctor, addr 0x269a79c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
