...
/// @brief Method Awake, addr 0x3b9523c, size 0x90, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleNormalizedValueDidChange, addr 0x3b9549c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b952cc, size 0x90, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnPointerUp, addr 0x3b954c0, size 0x44, virtual true, abstract: false, final false
inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method SetHue, addr 0x3b9535c, size 0x14, virtual false, abstract: false, final false
inline void SetHue(float_t  hue) ;

/// @brief Method UpdateVisuals, addr 0x3b95370, size 0x12c, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_3<::UnityW<::GlobalNamespace::ColorSaturationValueSlider>,::UnityEngine::Vector2,::GlobalNamespace::ColorChangeUIEventType>*> const& __cordl_internal_get_colorSaturationOrValueDidChangeEvent() const;
...
/// @brief Method .ctor, addr 0x3b95504, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_colorSaturationOrValueDidChangeEvent, addr 0x3b950d4, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method remove_colorSaturationOrValueDidChangeEvent, addr 0x3b95188, size 0xb4, virtual false, abstract: false, final false
