...
/// @brief Method ErrorCode, addr 0x2693e5c, size 0x80, virtual false, abstract: false, final false
static inline ::StringW ErrorCode(::GlobalNamespace::MultiplayerUnavailableReason  multiplayerUnavailableReason) ;

/// @brief Method GetLocalizedMessage, addr 0x2694204, size 0xb0, virtual false, abstract: false, final false
static inline ::StringW GetLocalizedMessage(::GlobalNamespace::MultiplayerStatusData*  data, ::BGLib::Polyglot::Language  language) ;

/// @brief Method LocalizedKey, addr 0x2693dd8, size 0x84, virtual false, abstract: false, final false
static inline ::StringW LocalizedKey(::GlobalNamespace::MultiplayerUnavailableReason  multiplayerUnavailableReason) ;

/// @brief Method TryGetMultiplayerUnavailableReason, addr 0x2693edc, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method VersionLessThan, addr 0x269403c, size 0x1c8, virtual false, abstract: false, final false
