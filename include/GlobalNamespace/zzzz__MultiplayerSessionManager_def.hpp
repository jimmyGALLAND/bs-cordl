...
/// @brief Method <TryUpdateConnectedPlayer>b__104_0, addr 0x2290770, size 0xa0, virtual false, abstract: false, final false
inline int32_t _TryUpdateConnectedPlayer_b__104_0(::GlobalNamespace::IConnectedPlayer*  p) ;

/// @brief Method .ctor, addr 0x2290768, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetPlayerByUserId>b__0, addr 0x2290810, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x229030c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _connectedPlayers, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__connectedPlayers, put=__cordl_internal_set__connectedPlayers)) ::System::Collections::Generic::List_1<::GlobalNamespace::IConnectedPlayer*>*  _connectedPlayers;

/// @brief Field <connectionOwner>k__BackingField, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get__connectionOwner_k__BackingField, put=__cordl_internal_set__connectionOwner_k__BackingField)) ::GlobalNamespace::IConnectedPlayer*  _connectionOwner_k__BackingField;
...
/// @brief Field _packetSerializer, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__packetSerializer, put=__cordl_internal_set__packetSerializer)) ::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::__MultiplayerSessionManager__MessageType,::GlobalNamespace::IConnectedPlayer*>*  _packetSerializer;
...
/// @brief Field connectionOwnerStateChangedEvent, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get_connectionOwnerStateChangedEvent, put=__cordl_internal_set_connectionOwnerStateChangedEvent)) ::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  connectionOwnerStateChangedEvent;
...
/// @brief Method Disconnect, addr 0x228f734, size 0x10, virtual true, abstract: false, final true
inline void Disconnect() ;

/// @brief Method EndSession, addr 0x228eba4, size 0x4a4, virtual true, abstract: false, final true
inline void EndSession() ;

/// @brief Method GetConnectedPlayer, addr 0x2290314, size 0x58, virtual true, abstract: false, final true
inline ::GlobalNamespace::IConnectedPlayer* GetConnectedPlayer(int32_t  i) ;

/// @brief Method GetNextAvailableSortIndex, addr 0x2290468, size 0xb4, virtual false, abstract: false, final false
inline int32_t GetNextAvailableSortIndex() ;

/// @brief Method GetPlayerByUserId, addr 0x2290174, size 0x198, virtual true, abstract: false, final true
inline ::GlobalNamespace::IConnectedPlayer* GetPlayerByUserId(::StringW  userId) ;

/// @brief Method HandleConnected, addr 0x228f754, size 0x10, virtual false, abstract: false, final false
inline void HandleConnected() ;

/// @brief Method HandleConnectionFailed, addr 0x228f774, size 0x10, virtual false, abstract: false, final false
inline void HandleConnectionFailed(::GlobalNamespace::ConnectionFailedReason  reason) ;

/// @brief Method HandleDisconnected, addr 0x228f764, size 0x10, virtual false, abstract: false, final false
inline void HandleDisconnected(::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method HandleInitialized, addr 0x228f744, size 0x10, virtual false, abstract: false, final false
inline void HandleInitialized() ;

/// @brief Method HandlePlayerAvatarChanged, addr 0x22900ac, size 0x84, virtual false, abstract: false, final false
inline void HandlePlayerAvatarChanged(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandlePlayerConnected, addr 0x228f794, size 0xbc, virtual false, abstract: false, final false
inline void HandlePlayerConnected(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandlePlayerDisconnected, addr 0x228fe48, size 0xbc, virtual false, abstract: false, final false
inline void HandlePlayerDisconnected(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandlePlayerLatencyInitialized, addr 0x229016c, size 0x8, virtual false, abstract: false, final false
inline void HandlePlayerLatencyInitialized(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandlePlayerOrderChanged, addr 0x2290130, size 0x3c, virtual false, abstract: false, final false
inline void HandlePlayerOrderChanged(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandlePlayerStateChanged, addr 0x228ff04, size 0x1a8, virtual false, abstract: false, final false
inline void HandlePlayerStateChanged(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandleSyncTimeInitialized, addr 0x228f784, size 0x10, virtual false, abstract: false, final false
inline void HandleSyncTimeInitialized() ;

/// @brief Method KickPlayer, addr 0x229036c, size 0x18, virtual true, abstract: false, final true
inline void KickPlayer(::StringW  userId) ;

/// @brief Method LateUpdate, addr 0x228e7a4, size 0x14, virtual false, abstract: false, final false
inline void LateUpdate() ;

/// @brief Method LocalPlayerHasState, addr 0x2290384, size 0xe4, virtual true, abstract: false, final true
inline bool LocalPlayerHasState(::StringW  state) ;

static inline ::GlobalNamespace::MultiplayerSessionManager* New_ctor() ;

/// @brief Method OnApplicationPause, addr 0x228f048, size 0x58, virtual true, abstract: false, final false
inline void OnApplicationPause(bool  pauseStatus) ;

/// @brief Method OnDestroy, addr 0x228e7b8, size 0x24, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method RegisterCallback, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: false, final true
template<typename T>
inline void RegisterCallback(::GlobalNamespace::__MultiplayerSessionManager__MessageType  serializerType, ::System::Action_2<T,::GlobalNamespace::IConnectedPlayer*>*  callback, ::System::Func_1<T>*  constructor) ;

/// @brief Method RegisterSerializer, addr 0x228f0a0, size 0x68, virtual true, abstract: false, final true
inline void RegisterSerializer(::GlobalNamespace::__MultiplayerSessionManager__MessageType  serializerType, ::GlobalNamespace::INetworkPacketSubSerializer_1<::GlobalNamespace::IConnectedPlayer*>*  subSerializer) ;
...
/// @brief Method SetLocalPlayerState, addr 0x228e690, size 0xb4, virtual true, abstract: false, final true
inline void SetLocalPlayerState(::StringW  state, bool  hasState) ;

/// @brief Method SetMaxPlayerCount, addr 0x228f72c, size 0x8, virtual true, abstract: false, final true
inline void SetMaxPlayerCount(int32_t  maxPlayerCount) ;

/// @brief Method Start, addr 0x228e644, size 0x4c, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method StartSession, addr 0x228f170, size 0x5bc, virtual true, abstract: false, final true
...
/// @brief Method TryUpdateConnectedPlayer, addr 0x228f850, size 0x5f8, virtual false, abstract: false, final false
...
template<typename T>
inline void UnregisterCallback(::GlobalNamespace::__MultiplayerSessionManager__MessageType  serializerType) ;

/// @brief Method UnregisterSerializer, addr 0x228f108, size 0x68, virtual true, abstract: false, final true
inline void UnregisterSerializer(::GlobalNamespace::__MultiplayerSessionManager__MessageType  serializerType, ::GlobalNamespace::INetworkPacketSubSerializer_1<::GlobalNamespace::IConnectedPlayer*>*  subSerializer) ;

/// @brief Method Update, addr 0x228e744, size 0x58, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateConnectionState, addr 0x228e7dc, size 0x3c8, virtual false, abstract: false, final false
inline void UpdateConnectionState(::GlobalNamespace::UpdateConnectionStateReason  updateReason, ::GlobalNamespace::DisconnectedReason  disconnectedReason, ::GlobalNamespace::ConnectionFailedReason  connectionFailedReason) ;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::__MultiplayerSessionManager__MessageType,::GlobalNamespace::IConnectedPlayer*>*> const& __cordl_internal_get__packetSerializer() const;
...
constexpr void __cordl_internal_set__packetSerializer(::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::__MultiplayerSessionManager__MessageType,::GlobalNamespace::IConnectedPlayer*>*  value) ;
...
/// @brief Method .ctor, addr 0x229051c, size 0x150, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_connectedEvent, addr 0x228d818, size 0x9c, virtual true, abstract: false, final true
inline void add_connectedEvent(::System::Action*  value) ;

/// @brief Method add_connectionFailedEvent, addr 0x228d950, size 0xb0, virtual true, abstract: false, final true
inline void add_connectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>*  value) ;

/// @brief Method add_connectionOwnerStateChangedEvent, addr 0x228e030, size 0xb0, virtual true, abstract: false, final true
inline void add_connectionOwnerStateChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method add_disconnectedEvent, addr 0x228e190, size 0xb0, virtual true, abstract: false, final true
inline void add_disconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>*  value) ;

/// @brief Method add_playerAvatarChangedEvent, addr 0x228dd70, size 0xb0, virtual true, abstract: false, final true
inline void add_playerAvatarChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method add_playerConnectedEvent, addr 0x228dab0, size 0xb0, virtual true, abstract: false, final true
inline void add_playerConnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method add_playerDisconnectedEvent, addr 0x228dc10, size 0xb0, virtual true, abstract: false, final true
inline void add_playerDisconnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method add_playerStateChangedEvent, addr 0x228ded0, size 0xb0, virtual true, abstract: false, final true
inline void add_playerStateChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method add_pollUpdateEvent, addr 0x228e2f0, size 0x9c, virtual true, abstract: false, final true
inline void add_pollUpdateEvent(::System::Action*  value) ;

/// @brief Method get_connectedPlayerCount, addr 0x228e5ac, size 0x48, virtual true, abstract: false, final true
inline int32_t get_connectedPlayerCount() ;

/// @brief Method get_connectedPlayerManager, addr 0x228e634, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ConnectedPlayerManager* get_connectedPlayerManager() ;

/// @brief Method get_connectedPlayers, addr 0x228e5a4, size 0x8, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IConnectedPlayer*>* get_connectedPlayers() ;

/// @brief Method get_connectionOwner, addr 0x228e440, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::IConnectedPlayer* get_connectionOwner() ;

/// @brief Method get_isConnected, addr 0x228e584, size 0x10, virtual true, abstract: false, final true
inline bool get_isConnected() ;

/// @brief Method get_isConnecting, addr 0x228e574, size 0x10, virtual true, abstract: false, final true
inline bool get_isConnecting() ;

/// @brief Method get_isConnectingOrConnected, addr 0x228e560, size 0x14, virtual true, abstract: false, final true
inline bool get_isConnectingOrConnected() ;

/// @brief Method get_isConnectionOwner, addr 0x228e428, size 0x18, virtual true, abstract: false, final true
inline bool get_isConnectionOwner() ;

/// @brief Method get_isDisconnecting, addr 0x228e594, size 0x10, virtual true, abstract: false, final true
inline bool get_isDisconnecting() ;

/// @brief Method get_isSpectating, addr 0x228e450, size 0x110, virtual true, abstract: false, final true
inline bool get_isSpectating() ;

/// @brief Method get_isSyncTimeInitialized, addr 0x228e608, size 0x14, virtual true, abstract: false, final true
inline bool get_isSyncTimeInitialized() ;

/// @brief Method get_localPlayer, addr 0x228e61c, size 0x18, virtual true, abstract: false, final true
inline ::GlobalNamespace::IConnectedPlayer* get_localPlayer() ;

/// @brief Method get_maxPlayerCount, addr 0x228e63c, size 0x8, virtual true, abstract: false, final true
inline int32_t get_maxPlayerCount() ;

/// @brief Method get_syncTime, addr 0x228e5f4, size 0x14, virtual true, abstract: false, final true
...
/// @brief Method remove_connectedEvent, addr 0x228d8b4, size 0x9c, virtual true, abstract: false, final true
inline void remove_connectedEvent(::System::Action*  value) ;

/// @brief Method remove_connectionFailedEvent, addr 0x228da00, size 0xb0, virtual true, abstract: false, final true
inline void remove_connectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>*  value) ;

/// @brief Method remove_connectionOwnerStateChangedEvent, addr 0x228e0e0, size 0xb0, virtual true, abstract: false, final true
inline void remove_connectionOwnerStateChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method remove_disconnectedEvent, addr 0x228e240, size 0xb0, virtual true, abstract: false, final true
inline void remove_disconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>*  value) ;

/// @brief Method remove_playerAvatarChangedEvent, addr 0x228de20, size 0xb0, virtual true, abstract: false, final true
inline void remove_playerAvatarChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method remove_playerConnectedEvent, addr 0x228db60, size 0xb0, virtual true, abstract: false, final true
inline void remove_playerConnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method remove_playerDisconnectedEvent, addr 0x228dcc0, size 0xb0, virtual true, abstract: false, final true
inline void remove_playerDisconnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method remove_playerStateChangedEvent, addr 0x228df80, size 0xb0, virtual true, abstract: false, final true
inline void remove_playerStateChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  value) ;

/// @brief Method remove_pollUpdateEvent, addr 0x228e38c, size 0x9c, virtual true, abstract: false, final true
inline void remove_pollUpdateEvent(::System::Action*  value) ;

/// @brief Method set_connectionOwner, addr 0x228e448, size 0x8, virtual false, abstract: false, final false
