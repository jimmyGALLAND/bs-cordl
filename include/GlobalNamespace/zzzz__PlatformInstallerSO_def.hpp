...
/// @brief Field _ps5AchievementIdsModel, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__ps5AchievementIdsModel, put=__cordl_internal_set__ps5AchievementIdsModel)) ::UnityW<::GlobalNamespace::SonyAchievementIdsModelSO>  _ps5AchievementIdsModel;
...
/// @brief Method InstallBindings, addr 0x26cd380, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26cd410, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
