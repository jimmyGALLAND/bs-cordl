...
/// @brief Method InstallBindings, addr 0x3b4a858, size 0x250, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b4aaa8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
