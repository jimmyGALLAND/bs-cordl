...
/// @brief Method GetUserAuthToken, addr 0x3fed54c, size 0xb8, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::PlatformUserAuthTokenData*>* GetUserAuthToken() ;

/// @brief Method GetUserFriendsUserIds, addr 0x3fed490, size 0xbc, virtual true, abstract: false, final true
...
/// @brief Method GetUserInfo, addr 0x3fed384, size 0xd0, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::UserInfo*>* GetUserInfo(::System::Threading::CancellationToken  ctx) ;

/// @brief Method GetUserNamesForUserIds, addr 0x3fed604, size 0x6c, virtual true, abstract: false, final true
...
/// @brief Method RequestXPlatformAccessToken, addr 0x3fed670, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3fed710, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_platformUserInfoDidChangeEvent, addr 0x3fed21c, size 0xb0, virtual true, abstract: false, final true
inline void add_platformUserInfoDidChangeEvent(::System::Action_1<::GlobalNamespace::UserInfo*>*  value) ;

/// @brief Method get_CanXPlatformAccessTokenBeCached, addr 0x3fed37c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method remove_platformUserInfoDidChangeEvent, addr 0x3fed2cc, size 0xb0, virtual true, abstract: false, final true
