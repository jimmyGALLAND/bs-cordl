...
/// @brief Method MarkModified, addr 0x3f1de48, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x3f1dabc, size 0x38c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3f1da88, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRMeshData  meshData) ;

/// @brief Method get_MeshData, addr 0x3f1da60, size 0x10, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRMeshData get_MeshData() ;

/// @brief Method set_MeshData, addr 0x3f1da70, size 0x18, virtual false, abstract: false, final false
