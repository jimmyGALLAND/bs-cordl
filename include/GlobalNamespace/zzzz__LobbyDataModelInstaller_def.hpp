...
public:
// Declarations
/// @brief Method InstallBindings, addr 0x3b5f0a4, size 0x37c, virtual true, abstract: false, final false
inline void InstallBindings() ;

static inline ::GlobalNamespace::LobbyDataModelInstaller* New_ctor() ;

/// @brief Method .ctor, addr 0x3b5f420, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
