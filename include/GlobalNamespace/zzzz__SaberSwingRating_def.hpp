...
public:
// Declarations
/// @brief Method AfterCutStepRating, addr 0x2664068, size 0x3c, virtual false, abstract: false, final false
static inline float_t AfterCutStepRating(float_t  angleDiff, float_t  normalDiff) ;

/// @brief Method BeforeCutStepRating, addr 0x2664000, size 0x3c, virtual false, abstract: false, final false
static inline float_t BeforeCutStepRating(float_t  angleDiff, float_t  normalDiff) ;

/// @brief Method NormalRating, addr 0x266403c, size 0x2c, virtual false, abstract: false, final false
