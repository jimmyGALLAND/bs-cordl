...
#include "GlobalNamespace/zzzz__UnitySourceGeneratedAssemblyMonoScriptTypes_v1_def.hpp"
// Ctor Parameters [CppParam { name: "FilePathsData", ty: "::ArrayW<uint8_t,::Array<uint8_t>*>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "TypesData", ty: "::ArrayW<uint8_t,::Array<uint8_t>*>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "TotalTypes", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "TotalFiles", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "IsEditorOnly", ty: "bool", modifiers: "", def_value: Some("{}") }]
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::__UnitySourceGeneratedAssemblyMonoScriptTypes_v1__MonoScriptData (*)()>(&::GlobalNamespace::UnitySourceGeneratedAssemblyMonoScriptTypes_v1::Get)> {
  constexpr static std::size_t size = 0xc4;
  constexpr static std::size_t addrs = 0x2255d5c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::UnitySourceGeneratedAssemblyMonoScriptTypes_v1::*)()>(&::GlobalNamespace::UnitySourceGeneratedAssemblyMonoScriptTypes_v1::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2255e20;
