...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderHapticFeedbackInteractionEffect::*)()>(&::GlobalNamespace::SliderHapticFeedbackInteractionEffect::Start)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x3a6cf30;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderHapticFeedbackInteractionEffect::*)()>(&::GlobalNamespace::SliderHapticFeedbackInteractionEffect::Update)> {
  constexpr static std::size_t size = 0xd4;
  constexpr static std::size_t addrs = 0x3a6d070;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderHapticFeedbackInteractionEffect::*)(float_t)>(&::GlobalNamespace::SliderHapticFeedbackInteractionEffect::StartEffect)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x3a6d1a0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderHapticFeedbackInteractionEffect::*)()>(&::GlobalNamespace::SliderHapticFeedbackInteractionEffect::EndEffect)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x3a6d1e8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderHapticFeedbackInteractionEffect::*)()>(&::GlobalNamespace::SliderHapticFeedbackInteractionEffect::Vibrate)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x3a6d160;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderHapticFeedbackInteractionEffect::*)()>(&::GlobalNamespace::SliderHapticFeedbackInteractionEffect::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3a6d1f4;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IGamePause*> const& GlobalNamespace::SliderHapticFeedbackInteractionEffect::__cordl_internal_get__gamePause() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____gamePause;
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::SliderHapticFeedbackInteractionEffect*>());
}
