...
template<typename T>
constexpr ::GlobalNamespace::LazyCopyHashSet_1<T>*& GlobalNamespace::MemoryPoolContainer_1<T>::__cordl_internal_get__activeItems()  {
...
template<typename T>
constexpr void GlobalNamespace::MemoryPoolContainer_1<T>::__cordl_internal_set__activeItems(::GlobalNamespace::LazyCopyHashSet_1<T>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
constexpr ::Zenject::IMemoryPool_1<T>*& GlobalNamespace::MemoryPoolContainer_1<T>::__cordl_internal_get__memoryPool()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____memoryPool;
}
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::Zenject::IMemoryPool_1<T>*> const& GlobalNamespace::MemoryPoolContainer_1<T>::__cordl_internal_get__memoryPool() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____memoryPool;
}
template<typename T>
constexpr void GlobalNamespace::MemoryPoolContainer_1<T>::__cordl_internal_set__memoryPool(::Zenject::IMemoryPool_1<T>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
inline void GlobalNamespace::MemoryPoolContainer_1<T>::DespawnAll()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MemoryPoolContainer_1<T>*>::get(),
                        "DespawnAll",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T>
inline void GlobalNamespace::MemoryPoolContainer_1<T>::DestroyAll()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MemoryPoolContainer_1<T>*>::get(),
                        "DestroyAll",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::MemoryPoolContainer_1<T>::MemoryPoolContainer_1()   {
}
