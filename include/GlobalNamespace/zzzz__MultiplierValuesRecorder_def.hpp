...
public:
// Declarations
/// @brief Method .ctor, addr 0x3b50f50, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field _multiplierValues, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplierValues, put=__cordl_internal_set__multiplierValues)) ::System::Collections::Generic::List_1<::GlobalNamespace::__MultiplierValuesRecorder__MultiplierValue>*  _multiplierValues;
...
/// @brief Method HandleScoreControllerMultiplierDidChange, addr 0x3b50e58, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b50d58, size 0x100, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b50c64, size 0xf4, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__MultiplierValuesRecorder__MultiplierValue>*> const& __cordl_internal_get__multiplierValues() const;
...
/// @brief Method .ctor, addr 0x3b50f5c, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_multiplierValues, addr 0x3b50c5c, size 0x8, virtual false, abstract: false, final false
