...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Task_1<::GlobalNamespace::__ISonyOnlineServicesAvailabilityModel__OnlineServicesAvailability>* (::GlobalNamespace::ISonyOnlineServicesAvailabilityModel::*)()>(&::GlobalNamespace::ISonyOnlineServicesAvailabilityModel::GetOnlineServicesAvailabilityAsync)> {
