...
/// @brief Method .ctor, addr 0x44479cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_easeDuration, addr 0x44479c4, size 0x8, virtual false, abstract: false, final false
inline float_t get_easeDuration() ;

/// @brief Method get_easeType, addr 0x44479bc, size 0x8, virtual false, abstract: false, final false
