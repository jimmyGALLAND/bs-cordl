...
/// @brief Method Inject, addr 0x3a83a6c, size 0xe4, virtual false, abstract: false, final false
inline void Inject(::UnityEngine::Camera*  camera, ::GlobalNamespace::VRCenterAdjust*  centerAdjust, ::GlobalNamespace::VRController*  controller0, ::GlobalNamespace::VRController*  controller1, ::UnityEngine::SpatialTracking::TrackedPoseDriver*  trackedPoseDriver) ;

static inline ::GlobalNamespace::FirstPersonFlyingController* New_ctor() ;

/// @brief Method OnDisable, addr 0x3a83134, size 0x24c, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3a82e24, size 0x270, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Update, addr 0x3a83380, size 0x394, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3a83b50, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;
