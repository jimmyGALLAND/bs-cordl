...
// Type: ::MultiClickButtonController
...
/// @brief Method HandleButtonClicked, addr 0x3b68c8c, size 0x38, virtual false, abstract: false, final false
inline void HandleButtonClicked() ;

static inline ::GlobalNamespace::MultiClickButtonController* New_ctor() ;

/// @brief Method OnDisable, addr 0x3b68c70, size 0x1c, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3b68bd8, size 0x98, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> const& __cordl_internal_get_wasTriggeredEvent() const;
...
/// @brief Method .ctor, addr 0x3b68cc4, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_wasTriggeredEvent, addr 0x3b68aa0, size 0x9c, virtual false, abstract: false, final false
inline void add_wasTriggeredEvent(::System::Action*  value) ;

/// @brief Method remove_wasTriggeredEvent, addr 0x3b68b3c, size 0x9c, virtual false, abstract: false, final false
