...
/// @brief Method Awake, addr 0x3b04bb0, size 0x114, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetPositionForValue, addr 0x3b04f68, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetPositionForValue(int32_t  value) ;

/// @brief Method HandleBeatmapEvent, addr 0x3b04e88, size 0xe0, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

static inline ::GlobalNamespace::SmoothStepPositionGroupEventEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b04dec, size 0x9c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetPosition, addr 0x3b04fc0, size 0x8c, virtual false, abstract: false, final false
inline void SetPosition(::UnityEngine::Vector3  position) ;

/// @brief Method Start, addr 0x3b04cc4, size 0x128, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b0504c, size 0xac, virtual false, abstract: false, final false
inline void _ctor() ;
