...
/// @brief Field _scenesTransitionSetupData, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__scenesTransitionSetupData, put=__cordl_internal_set__scenesTransitionSetupData)) ::UnityW<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO>  _scenesTransitionSetupData;

/// @brief Field _settingsManager, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__settingsManager, put=__cordl_internal_set__settingsManager)) ::GlobalNamespace::SettingsManager*  _settingsManager;

/// @brief Method InstallBindings, addr 0x3aabe6c, size 0x15c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aabfc8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
