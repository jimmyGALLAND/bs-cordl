...
/// @brief Method LoadDataFile, addr 0x3a91bf4, size 0x5f0, virtual false, abstract: false, final false
...
/// @brief Method LoadInfoFile, addr 0x3a91a50, size 0x1a4, virtual false, abstract: false, final false
inline ::GlobalNamespace::PosesRecordingInfoSaveData* LoadInfoFile(::StringW  filePath) ;

/// @brief Method LoadRecording, addr 0x3a925fc, size 0x118, virtual true, abstract: false, final true
inline ::GlobalNamespace::PosesRecordingData* LoadRecording(::StringW  path) ;

/// @brief Method LoadRecordingFromDirectory, addr 0x3a921e4, size 0x2d4, virtual false, abstract: false, final false
...
/// @brief Method RecordingCanBeCreated, addr 0x3a92a9c, size 0x504, virtual true, abstract: false, final true
inline bool RecordingCanBeCreated(::StringW  path) ;

/// @brief Method RecordingExists, addr 0x3a92714, size 0x388, virtual true, abstract: false, final true
inline bool RecordingExists(::StringW  path) ;

/// @brief Method SaveDataFile, addr 0x3a91458, size 0x368, virtual false, abstract: false, final false
static inline void SaveDataFile(::StringW  filePath, ::GlobalNamespace::PosesRecordingData*  data) ;

/// @brief Method SaveInfoFile, addr 0x3a91354, size 0x104, virtual false, abstract: false, final false
static inline void SaveInfoFile(::StringW  filePath, ::GlobalNamespace::PosesRecordingData*  data) ;

/// @brief Method SaveRecording, addr 0x3a925c0, size 0x3c, virtual true, abstract: false, final true
inline void SaveRecording(::StringW  path, ::GlobalNamespace::PosesRecordingData*  data, bool  saveToOldFormat) ;

/// @brief Method SaveRecordingIntoDirectory, addr 0x3a917c0, size 0x290, virtual false, abstract: false, final false
inline void SaveRecordingIntoDirectory(::StringW  path, ::GlobalNamespace::PosesRecordingData*  data) ;

/// @brief Method SaveToOldFormat, addr 0x3a924b8, size 0x18, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a912b4, size 0x78, virtual false, abstract: false, final false
