...
/// @brief Method .ctor, addr 0x269b470, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_achievement, addr 0x269b468, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::AchievementSO> get_achievement() ;

/// @brief Method get_achievementId, addr 0x269b1fc, size 0x1c, virtual false, abstract: false, final false
inline ::StringW get_achievementId() ;

/// @brief Method get_ps4TrophyId, addr 0x269b460, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _achievementIdToTrophyId, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__achievementIdToTrophyId, put=__cordl_internal_set__achievementIdToTrophyId)) ::System::Collections::Generic::Dictionary_2<::StringW,int32_t>*  _achievementIdToTrophyId;

/// @brief Field _achievementsIds, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__achievementsIds, put=__cordl_internal_set__achievementsIds)) ::System::Collections::Generic::List_1<::GlobalNamespace::__SonyAchievementIdsModelSO__AchievementIdData*>*  _achievementsIds;

/// @brief Field _trophyIdToAchievementId, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__trophyIdToAchievementId, put=__cordl_internal_set__trophyIdToAchievementId)) ::System::Collections::Generic::Dictionary_2<int32_t,::StringW>*  _trophyIdToAchievementId;
...
/// @brief Method GetAchievementId, addr 0x269b2ec, size 0x68, virtual false, abstract: false, final false
inline bool GetAchievementId(int32_t  trophyId, ByRef<::StringW>  achievementId) ;

/// @brief Method GetTrophyId, addr 0x269b218, size 0x68, virtual false, abstract: false, final false
inline bool GetTrophyId(::StringW  achievementId, ByRef<int32_t>  trophyId) ;

/// @brief Method GetTrophyIds, addr 0x269b280, size 0x6c, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> GetTrophyIds() ;

static inline ::GlobalNamespace::SonyAchievementIdsModelSO* New_ctor() ;

/// @brief Method OnEnable, addr 0x269afcc, size 0x230, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__SonyAchievementIdsModelSO__AchievementIdData*>*> const& __cordl_internal_get__achievementsIds() const;
...
/// @brief Method .ctor, addr 0x269b354, size 0x10c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_achievementsIds, addr 0x269afc4, size 0x8, virtual false, abstract: false, final false
