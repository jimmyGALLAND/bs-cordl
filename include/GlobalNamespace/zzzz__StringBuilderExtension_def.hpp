...
public:
// Declarations
/// @brief Method AppendNumber, addr 0x22546d0, size 0x14, virtual false, abstract: false, final false
static inline void AppendNumber(::System::Text::StringBuilder*  sb, int32_t  number) ;

/// @brief Method AppendNumber, addr 0x22546fc, size 0xa4, virtual false, abstract: false, final false
static inline void AppendNumber(::System::Text::StringBuilder*  sb, uint32_t  uNumber, bool  isNegative) ;

/// @brief Method Swap, addr 0x22544b0, size 0x220, virtual false, abstract: false, final false
