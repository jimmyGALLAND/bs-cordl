...
/// @brief Method GetDestinationLocalizedString, addr 0x3aa021c, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aa0364, size 0x48, virtual false, abstract: false, final false
inline void _ctor(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey, ::GlobalNamespace::BeatmapLevel*  beatmapLevel) ;

/// @brief Method get_apiName, addr 0x3aa01ec, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_apiName() ;

/// @brief Method get_localizedDescription, addr 0x3aa01f4, size 0x28, virtual true, abstract: false, final true
