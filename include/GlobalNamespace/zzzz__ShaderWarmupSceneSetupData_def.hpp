...
/// @brief Field <nextScenesTransitionSetupData>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__nextScenesTransitionSetupData_k__BackingField, put=__cordl_internal_set__nextScenesTransitionSetupData_k__BackingField)) ::UnityW<::GlobalNamespace::ScenesTransitionSetupDataSO>  _nextScenesTransitionSetupData_k__BackingField;
...
/// @brief Method .ctor, addr 0x3aadc34, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::ScenesTransitionSetupDataSO*  nextScenesTransitionSetupData) ;

/// @brief Method get_nextScenesTransitionSetupData, addr 0x3aadc24, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::ScenesTransitionSetupDataSO> get_nextScenesTransitionSetupData() ;

/// @brief Method set_nextScenesTransitionSetupData, addr 0x3aadc2c, size 0x8, virtual false, abstract: false, final false
