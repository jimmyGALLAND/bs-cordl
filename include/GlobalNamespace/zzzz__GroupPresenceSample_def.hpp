...
/// @brief Method ClearPresence, addr 0x3ec716c, size 0xb0, virtual false, abstract: false, final false
inline void ClearPresence() ;

/// @brief Method LaunchInvitePanel, addr 0x3ec7358, size 0x108, virtual false, abstract: false, final false
inline void LaunchInvitePanel() ;

/// @brief Method LaunchRosterPanel, addr 0x3ec768c, size 0xec, virtual false, abstract: false, final false
inline void LaunchRosterPanel() ;

static inline ::GlobalNamespace::GroupPresenceSample* New_ctor() ;

/// @brief Method OnGetDestinations, addr 0x3ec8174, size 0x354, virtual false, abstract: false, final false
inline void OnGetDestinations(::Oculus::Platform::Message_1<::Oculus::Platform::Models::DestinationList*>*  message) ;

/// @brief Method OnInviteSentNotif, addr 0x3ec7da0, size 0x3d4, virtual false, abstract: false, final false
inline void OnInviteSentNotif(::Oculus::Platform::Message_1<::Oculus::Platform::Models::LaunchInvitePanelFlowResult*>*  message) ;

/// @brief Method OnJoinIntentChangeNotif, addr 0x3ec7990, size 0x25c, virtual false, abstract: false, final false
inline void OnJoinIntentChangeNotif(::Oculus::Platform::Message_1<::Oculus::Platform::Models::GroupPresenceJoinIntent*>*  message) ;

/// @brief Method OnLeaveIntentChangeNotif, addr 0x3ec7bfc, size 0x1a4, virtual false, abstract: false, final false
inline void OnLeaveIntentChangeNotif(::Oculus::Platform::Message_1<::Oculus::Platform::Models::GroupPresenceLeaveIntent*>*  message) ;

/// @brief Method OnLoggedInUser, addr 0x3ec8838, size 0xa8, virtual false, abstract: false, final false
inline void OnLoggedInUser(::Oculus::Platform::Message_1<::Oculus::Platform::Models::User*>*  message) ;

/// @brief Method PressAButton, addr 0x3ec871c, size 0xc, virtual false, abstract: false, final false
inline bool PressAButton() ;

/// @brief Method PressBButton, addr 0x3ec8728, size 0xc, virtual false, abstract: false, final false
inline bool PressBButton() ;

/// @brief Method PressDown, addr 0x3ec882c, size 0xc, virtual false, abstract: false, final false
inline bool PressDown() ;

/// @brief Method PressUp, addr 0x3ec8820, size 0xc, virtual false, abstract: false, final false
inline bool PressUp() ;

/// @brief Method PressXButton, addr 0x3ec8734, size 0xc, virtual false, abstract: false, final false
inline bool PressXButton() ;

/// @brief Method PressYButton, addr 0x3ec8740, size 0xc, virtual false, abstract: false, final false
inline bool PressYButton() ;

/// @brief Method ScrollThroughDestinations, addr 0x3ec874c, size 0xd4, virtual false, abstract: false, final false
inline void ScrollThroughDestinations() ;

/// @brief Method SetPresence, addr 0x3ec6b14, size 0x19c, virtual false, abstract: false, final false
inline void SetPresence() ;

/// @brief Method Start, addr 0x3ec6658, size 0xf4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3ec8634, size 0xe8, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateConsole, addr 0x3ec674c, size 0xac, virtual false, abstract: false, final false
inline void UpdateConsole(::StringW  value) ;

/// @brief Method UpdateDestinationsConsole, addr 0x3ec84c8, size 0x16c, virtual false, abstract: false, final false
inline void UpdateDestinationsConsole() ;

/// @brief Method <ClearPresence>b__10_0, addr 0x3ec9330, size 0xe0, virtual false, abstract: false, final false
inline void _ClearPresence_b__10_0(::Oculus::Platform::Message*  message) ;

/// @brief Method <ClearPresence>b__10_1, addr 0x3ec9410, size 0xb4, virtual false, abstract: false, final false
inline void _ClearPresence_b__10_1(::Oculus::Platform::Message_1<::Oculus::Platform::Models::User*>*  message2) ;

/// @brief Method <LaunchInvitePanel>b__11_0, addr 0x3ec94c4, size 0x48, virtual false, abstract: false, final false
inline void _LaunchInvitePanel_b__11_0(::Oculus::Platform::Message_1<::Oculus::Platform::Models::InvitePanelResultInfo*>*  message) ;

/// @brief Method <LaunchRosterPanel>b__12_0, addr 0x3ec950c, size 0x48, virtual false, abstract: false, final false
inline void _LaunchRosterPanel_b__12_0(::Oculus::Platform::Message*  message) ;

/// @brief Method <SetPresence>b__9_0, addr 0x3ec8fb8, size 0xe0, virtual false, abstract: false, final false
inline void _SetPresence_b__9_0(::Oculus::Platform::Message*  message) ;

/// @brief Method <SetPresence>b__9_1, addr 0x3ec91f0, size 0x140, virtual false, abstract: false, final false
inline void _SetPresence_b__9_1(::Oculus::Platform::Message_1<::Oculus::Platform::Models::User*>*  message2) ;

/// @brief Method <Start>b__8_0, addr 0x3ec8964, size 0x258, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ec88e0, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;
