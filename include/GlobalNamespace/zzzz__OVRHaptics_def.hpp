...
static __declspec(property(get=getStaticF__MaximumBufferSamplesCount_k__BackingField, put=setStaticF__MaximumBufferSamplesCount_k__BackingField)) int32_t  _MaximumBufferSamplesCount_k__BackingField;

/// @brief Field <MinimumBufferSamplesCount>k__BackingField, offset 0xffffffff, size 0x4 
static __declspec(property(get=getStaticF__MinimumBufferSamplesCount_k__BackingField, put=setStaticF__MinimumBufferSamplesCount_k__BackingField)) int32_t  _MinimumBufferSamplesCount_k__BackingField;
...
static __declspec(property(get=getStaticF__OptimalBufferSamplesCount_k__BackingField, put=setStaticF__OptimalBufferSamplesCount_k__BackingField)) int32_t  _OptimalBufferSamplesCount_k__BackingField;
...
/// @brief Method Load, addr 0x3f228d8, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method get_MaximumBufferSamplesCount, addr 0x3f239f8, size 0x58, virtual false, abstract: false, final false
static inline int32_t get_MaximumBufferSamplesCount() ;

/// @brief Method get_MinimumBufferSamplesCount, addr 0x3f23890, size 0x58, virtual false, abstract: false, final false
static inline int32_t get_MinimumBufferSamplesCount() ;

/// @brief Method get_MinimumSafeSamplesQueued, addr 0x3f237dc, size 0x58, virtual false, abstract: false, final false
static inline int32_t get_MinimumSafeSamplesQueued() ;

/// @brief Method get_OptimalBufferSamplesCount, addr 0x3f23944, size 0x58, virtual false, abstract: false, final false
static inline int32_t get_OptimalBufferSamplesCount() ;

/// @brief Method get_SampleRateHz, addr 0x3f23674, size 0x58, virtual false, abstract: false, final false
static inline int32_t get_SampleRateHz() ;

/// @brief Method get_SampleSizeInBytes, addr 0x3f23728, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method set_MaximumBufferSamplesCount, addr 0x3f23a50, size 0x5c, virtual false, abstract: false, final false
static inline void set_MaximumBufferSamplesCount(int32_t  value) ;

/// @brief Method set_MinimumBufferSamplesCount, addr 0x3f238e8, size 0x5c, virtual false, abstract: false, final false
static inline void set_MinimumBufferSamplesCount(int32_t  value) ;

/// @brief Method set_MinimumSafeSamplesQueued, addr 0x3f23834, size 0x5c, virtual false, abstract: false, final false
static inline void set_MinimumSafeSamplesQueued(int32_t  value) ;

/// @brief Method set_OptimalBufferSamplesCount, addr 0x3f2399c, size 0x5c, virtual false, abstract: false, final false
static inline void set_OptimalBufferSamplesCount(int32_t  value) ;

/// @brief Method set_SampleRateHz, addr 0x3f236cc, size 0x5c, virtual false, abstract: false, final false
static inline void set_SampleRateHz(int32_t  value) ;

/// @brief Method set_SampleSizeInBytes, addr 0x3f23780, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method Clear, addr 0x3f24194, size 0x18, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Mix, addr 0x3f23cd8, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method Preempt, addr 0x3f23ab0, size 0x18, virtual false, abstract: false, final false
inline void Preempt(::GlobalNamespace::OVRHapticsClip*  clip) ;

/// @brief Method Queue, addr 0x3f23be0, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f22c40, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f2421c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRHapticsClip*  clip) ;

/// @brief Method get_Clip, addr 0x3f2445c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRHapticsClip* get_Clip() ;

/// @brief Method get_ReadCount, addr 0x3f2444c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ReadCount() ;

/// @brief Method set_Clip, addr 0x3f24464, size 0x8, virtual false, abstract: false, final false
inline void set_Clip(::GlobalNamespace::OVRHapticsClip*  value) ;

/// @brief Method set_ReadCount, addr 0x3f24454, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field m_pendingClips, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_pendingClips, put=__cordl_internal_set_m_pendingClips)) ::System::Collections::Generic::List_1<::GlobalNamespace::__OVRHaptics__OVRHapticsOutput__ClipPlaybackTracker*>*  m_pendingClips;
...
/// @brief Method Clear, addr 0x3f241ac, size 0x70, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Mix, addr 0x3f23cf0, size 0x4a4, virtual false, abstract: false, final false
inline void Mix(::GlobalNamespace::OVRHapticsClip*  clip) ;

static inline ::GlobalNamespace::__OVRHaptics__OVRHapticsOutput* New_ctor(uint32_t  controller) ;

/// @brief Method Preempt, addr 0x3f23ac8, size 0x118, virtual false, abstract: false, final false
inline void Preempt(::GlobalNamespace::OVRHapticsClip*  clip) ;

/// @brief Method Process, addr 0x3f22db4, size 0x8c0, virtual false, abstract: false, final false
inline void Process() ;

/// @brief Method Queue, addr 0x3f23bf8, size 0xe0, virtual false, abstract: false, final false
inline void Queue(::GlobalNamespace::OVRHapticsClip*  clip) ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__OVRHaptics__OVRHapticsOutput__ClipPlaybackTracker*>*> const& __cordl_internal_get_m_pendingClips() const;
...
/// @brief Method .ctor, addr 0x3f22ad8, size 0x168, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF_Channels, put=setStaticF_Channels)) ::ArrayW<::GlobalNamespace::__OVRHaptics__OVRHapticsChannel*,::Array<::GlobalNamespace::__OVRHaptics__OVRHapticsChannel*>*>  Channels;
...
static __declspec(property(get=getStaticF_m_outputs, put=setStaticF_m_outputs)) ::ArrayW<::GlobalNamespace::__OVRHaptics__OVRHapticsOutput*,::Array<::GlobalNamespace::__OVRHaptics__OVRHapticsOutput*>*>  m_outputs;

/// @brief Method Process, addr 0x3f22cd8, size 0xdc, virtual false, abstract: false, final false
