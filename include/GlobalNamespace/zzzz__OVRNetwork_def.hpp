...
public:
// Declarations
/// @brief Method FromBytes, addr 0x3faa5b0, size 0x130, virtual false, abstract: false, final false
static inline ::GlobalNamespace::__OVRNetwork__FrameHeader FromBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  arr) ;

/// @brief Method ToBytes, addr 0x3faa490, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method Broadcast, addr 0x3fab564, size 0x598, virtual false, abstract: false, final false
inline void Broadcast(int32_t  payloadType, ::ArrayW<uint8_t,::Array<uint8_t>*>  payload) ;

/// @brief Method DoAcceptTcpClientCallback, addr 0x3faadbc, size 0x540, virtual false, abstract: false, final false
inline void DoAcceptTcpClientCallback(::System::IAsyncResult*  ar) ;

/// @brief Method DoWriteDataCallback, addr 0x3fabafc, size 0xf4, virtual false, abstract: false, final false
inline void DoWriteDataCallback(::System::IAsyncResult*  ar) ;

/// @brief Method HasConnectedClient, addr 0x3fab2fc, size 0x268, virtual false, abstract: false, final false
inline bool HasConnectedClient() ;

static inline ::GlobalNamespace::__OVRNetwork__OVRNetworkTcpServer* New_ctor() ;

/// @brief Method StartListening, addr 0x3faa6e0, size 0x520, virtual false, abstract: false, final false
inline void StartListening(int32_t  listeningPort) ;

/// @brief Method StopListening, addr 0x3faac00, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fabbf0, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field payloadReceivedCallback, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_payloadReceivedCallback, put=__cordl_internal_set_payloadReceivedCallback)) ::System::Action_4<int32_t,::ArrayW<uint8_t,::Array<uint8_t>*>,int32_t,int32_t>*  payloadReceivedCallback;
...
/// @brief Field receivedBuffers, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_receivedBuffers, put=__cordl_internal_set_receivedBuffers)) ::ArrayW<::ArrayW<uint8_t,::Array<uint8_t>*>,::Array<::ArrayW<uint8_t,::Array<uint8_t>*>>*>  receivedBuffers;
...
/// @brief Method Connect, addr 0x3fabcd4, size 0x178, virtual false, abstract: false, final false
inline void Connect(int32_t  listeningPort) ;

/// @brief Method ConnectCallback, addr 0x3fabe4c, size 0x300, virtual false, abstract: false, final false
inline void ConnectCallback(::System::IAsyncResult*  ar) ;

/// @brief Method Disconnect, addr 0x3fac14c, size 0x238, virtual false, abstract: false, final false
inline void Disconnect() ;

static inline ::GlobalNamespace::__OVRNetwork__OVRNetworkTcpClient* New_ctor() ;

/// @brief Method OnReadDataCallback, addr 0x3fac598, size 0x4d4, virtual false, abstract: false, final false
inline void OnReadDataCallback(::System::IAsyncResult*  ar) ;

/// @brief Method Tick, addr 0x3fac384, size 0x214, virtual false, abstract: false, final false
inline void Tick() ;
...
/// @brief Method .ctor, addr 0x3faca6c, size 0xec, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Connected, addr 0x3fabcc0, size 0x14, virtual false, abstract: false, final false
inline bool get_Connected() ;

/// @brief Method get_connectionState, addr 0x3fabc98, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3faa488, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
