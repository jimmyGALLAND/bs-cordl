...
/// @brief Method .ctor, addr 0x26b35fc, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method get_authType, addr 0x26b35c8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_authType() ;

/// @brief Method get_playerFriends, addr 0x26b35d8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_playerFriends() ;

/// @brief Method get_playerId, addr 0x26b3598, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_playerId() ;

/// @brief Method get_playerKey, addr 0x26b35b8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_playerKey() ;

/// @brief Method get_playerName, addr 0x26b35a8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_playerName() ;

/// @brief Method get_succeeded, addr 0x26b35e8, size 0x8, virtual false, abstract: false, final false
inline bool get_succeeded() ;

/// @brief Method set_authType, addr 0x26b35d0, size 0x8, virtual false, abstract: false, final false
inline void set_authType(::StringW  value) ;

/// @brief Method set_playerFriends, addr 0x26b35e0, size 0x8, virtual false, abstract: false, final false
inline void set_playerFriends(::StringW  value) ;

/// @brief Method set_playerId, addr 0x26b35a0, size 0x8, virtual false, abstract: false, final false
inline void set_playerId(::StringW  value) ;

/// @brief Method set_playerKey, addr 0x26b35c0, size 0x8, virtual false, abstract: false, final false
inline void set_playerKey(::StringW  value) ;

/// @brief Method set_playerName, addr 0x26b35b0, size 0x8, virtual false, abstract: false, final false
inline void set_playerName(::StringW  value) ;

/// @brief Method set_succeeded, addr 0x26b35f0, size 0xc, virtual false, abstract: false, final false
