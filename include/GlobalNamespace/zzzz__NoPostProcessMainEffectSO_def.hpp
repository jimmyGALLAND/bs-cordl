...
/// @brief Method DrawFadeQuad, addr 0x3ff1340, size 0xe8, virtual false, abstract: false, final false
inline void DrawFadeQuad(float_t  alpha) ;

static inline ::GlobalNamespace::NoPostProcessMainEffectSO* New_ctor() ;

/// @brief Method OnDisable, addr 0x3ff12c4, size 0xc, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3ff1244, size 0x80, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method PostRender, addr 0x3ff1334, size 0xc, virtual true, abstract: false, final false
inline void PostRender(float_t  fade) ;

/// @brief Method PreRender, addr 0x3ff12d0, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ff1428, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_hasPostProcessEffect, addr 0x3ff123c, size 0x8, virtual true, abstract: false, final false
