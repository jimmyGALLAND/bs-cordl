...
/// @brief Method MoveNext, addr 0x3b9e59c, size 0x254, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3b9e7f0, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x3b9e858, size 0x284, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3b9eadc, size 0x68, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method MoveNext, addr 0x3b9eb44, size 0x178, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3b9ecbc, size 0xc, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Field _multiplayerSessionManager, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerSessionManager, put=__cordl_internal_set__multiplayerSessionManager)) ::UnityW<::GlobalNamespace::MultiplayerSessionManager>  _multiplayerSessionManager;
...
/// @brief Method Dispose, addr 0x3b9e418, size 0xb4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DisposeAsync, addr 0x3b9e358, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method RunAsync, addr 0x3b9e1bc, size 0xd4, virtual true, abstract: false, final true
...
/// @brief Method Stop, addr 0x3b9e2c8, size 0x90, virtual true, abstract: false, final true
inline void Stop() ;

/// @brief Method Tick, addr 0x3b9e1a4, size 0x18, virtual false, abstract: false, final false
inline void Tick() ;

/// @brief Method WhenReady, addr 0x3b9e290, size 0x1c, virtual true, abstract: false, final true
inline void WhenReady(::System::Action*  action) ;

/// @brief Method WhenReadyAsync, addr 0x3b9e2ac, size 0x1c, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task* WhenReadyAsync(::System::Func_1<::System::Threading::Tasks::Task*>*  action) ;

/// @brief Method <DisposeAsync>b__22_0, addr 0x3b9e4d4, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method <.ctor>b__15_0, addr 0x3b9e4cc, size 0x4, virtual false, abstract: false, final false
inline void __ctor_b__15_0(::GlobalNamespace::ConnectionFailedReason  r) ;

/// @brief Method <.ctor>b__15_1, addr 0x3b9e4d0, size 0x4, virtual false, abstract: false, final false
inline void __ctor_b__15_1(::GlobalNamespace::DisconnectedReason  r) ;

/// @brief Method .ctor, addr 0x3b9de40, size 0x360, virtual false, abstract: false, final false
...
/// @brief Method get_id, addr 0x3b9de28, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_id() ;

/// @brief Method get_userId, addr 0x3b9de30, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_userId() ;

/// @brief Method get_userName, addr 0x3b9de38, size 0x8, virtual false, abstract: false, final false
