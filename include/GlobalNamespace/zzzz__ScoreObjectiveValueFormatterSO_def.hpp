...
public:
// Declarations
/// @brief Method FormatValue, addr 0x2687540, size 0x58, virtual true, abstract: false, final false
inline ::StringW FormatValue(int32_t  value) ;

static inline ::GlobalNamespace::ScoreObjectiveValueFormatterSO* New_ctor() ;

/// @brief Method .ctor, addr 0x2687598, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
