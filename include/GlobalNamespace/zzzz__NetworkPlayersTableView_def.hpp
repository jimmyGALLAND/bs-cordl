...
/// @brief Method .ctor, addr 0x3b7bb90, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _cellInfo, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__cellInfo, put=__cordl_internal_set__cellInfo)) ::System::Collections::Generic::List_1<::GlobalNamespace::__NetworkPlayersTableView__CellInfo*>*  _cellInfo;
...
/// @brief Method AddPlayers, addr 0x3b7afd4, size 0x698, virtual false, abstract: false, final false
inline void AddPlayers(::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::INetworkPlayer*>*  players, ::StringW  title) ;

/// @brief Method CellForIdx, addr 0x3b7a9ec, size 0x5e8, virtual true, abstract: false, final true
inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView*  tableView, int32_t  row) ;

/// @brief Method CellSize, addr 0x3b7a99c, size 0x8, virtual true, abstract: false, final true
inline float_t CellSize(int32_t  idx) ;

/// @brief Method HandleCellWasPressed, addr 0x3b7bb00, size 0x4, virtual false, abstract: false, final false
inline void HandleCellWasPressed(::HMUI::TableView*  tableView, ::HMUI::TableCell*  tableCell) ;

/// @brief Method HasVisibleOptions, addr 0x3b7b66c, size 0x350, virtual false, abstract: false, final false
...
/// @brief Method NumberOfCells, addr 0x3b7a9a4, size 0x48, virtual true, abstract: false, final true
inline int32_t NumberOfCells() ;

/// @brief Method SetParties, addr 0x3b7b9bc, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b7bb04, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;
