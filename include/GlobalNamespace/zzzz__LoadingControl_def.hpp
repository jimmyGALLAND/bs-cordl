...
/// @brief Method Awake, addr 0x3b68794, size 0xc0, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Hide, addr 0x3b68a58, size 0x24, virtual false, abstract: false, final false
inline void Hide() ;

static inline ::GlobalNamespace::LoadingControl* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b68854, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method ShowDownloadingProgress, addr 0x3b689ac, size 0xac, virtual false, abstract: false, final false
inline void ShowDownloadingProgress(::StringW  text, float_t  downloadingProgress) ;

/// @brief Method ShowLoading, addr 0x3b68870, size 0x8c, virtual false, abstract: false, final false
inline void ShowLoading(::StringW  text) ;

/// @brief Method ShowText, addr 0x3b688fc, size 0xb0, virtual false, abstract: false, final false
inline void ShowText(::StringW  text, bool  showRefreshButton) ;

/// @brief Method <Awake>b__14_0, addr 0x3b68a84, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b68a7c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didPressRefreshButtonEvent, addr 0x3b68640, size 0x9c, virtual false, abstract: false, final false
inline void add_didPressRefreshButtonEvent(::System::Action*  value) ;

/// @brief Method get_isLoading, addr 0x3b68778, size 0x1c, virtual false, abstract: false, final false
inline bool get_isLoading() ;

/// @brief Method remove_didPressRefreshButtonEvent, addr 0x3b686dc, size 0x9c, virtual false, abstract: false, final false
