...
/// @brief Method ApplyUVLayoutTo, addr 0x3981720, size 0x858, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x398201c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
