...
/// @brief Field _sortedConnectedPlayers, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get__sortedConnectedPlayers, put=__cordl_internal_set__sortedConnectedPlayers)) ::System::Collections::Generic::List_1<::GlobalNamespace::IConnectedPlayer*>*  _sortedConnectedPlayers;
...
/// @brief Method CellForIdx, addr 0x3a75ff0, size 0x4f0, virtual true, abstract: false, final true
inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView*  tableView, int32_t  idx) ;

/// @brief Method CellSize, addr 0x3a75e7c, size 0xc, virtual true, abstract: false, final true
inline float_t CellSize(int32_t  idx) ;

/// @brief Method GetCurrentPrefab, addr 0x3a75f54, size 0x9c, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::GameServerPlayerTableCell> GetCurrentPrefab() ;

/// @brief Method HandleCellKickPlayer, addr 0x3a76bd4, size 0xfc, virtual false, abstract: false, final false
inline void HandleCellKickPlayer(int32_t  idx) ;

/// @brief Method HandleCellUseBeatmap, addr 0x3a76648, size 0x338, virtual false, abstract: false, final false
inline void HandleCellUseBeatmap(int32_t  idx) ;

/// @brief Method HandleCellUseModifiers, addr 0x3a76980, size 0x254, virtual false, abstract: false, final false
inline void HandleCellUseModifiers(int32_t  idx) ;

/// @brief Method Init, addr 0x3a76d8c, size 0x44, virtual false, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::GameServerPlayersTableView* New_ctor() ;

/// @brief Method NumberOfCells, addr 0x3a75e88, size 0x48, virtual true, abstract: false, final true
inline int32_t NumberOfCells() ;

/// @brief Method SetData, addr 0x3a76cd0, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method TryGetLobbyPlayerData, addr 0x3a764e0, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a76dd0, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_kickPlayerEvent, addr 0x3a75d1c, size 0xb0, virtual false, abstract: false, final false
inline void add_kickPlayerEvent(::System::Action_1<::StringW>*  value) ;

/// @brief Method add_selectSuggestedGameplayModifiersEvent, addr 0x3a75bbc, size 0xb0, virtual false, abstract: false, final false
inline void add_selectSuggestedGameplayModifiersEvent(::System::Action_1<::GlobalNamespace::GameplayModifiers*>*  value) ;

/// @brief Method add_selectSuggestedLevelEvent, addr 0x3a75a5c, size 0xb0, virtual false, abstract: false, final false
inline void add_selectSuggestedLevelEvent(::System::Action_1<::GlobalNamespace::BeatmapKey>*  value) ;

/// @brief Method get_currentCellId, addr 0x3a75ed0, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method remove_kickPlayerEvent, addr 0x3a75dcc, size 0xb0, virtual false, abstract: false, final false
inline void remove_kickPlayerEvent(::System::Action_1<::StringW>*  value) ;

/// @brief Method remove_selectSuggestedGameplayModifiersEvent, addr 0x3a75c6c, size 0xb0, virtual false, abstract: false, final false
inline void remove_selectSuggestedGameplayModifiersEvent(::System::Action_1<::GlobalNamespace::GameplayModifiers*>*  value) ;

/// @brief Method remove_selectSuggestedLevelEvent, addr 0x3a75b0c, size 0xb0, virtual false, abstract: false, final false
