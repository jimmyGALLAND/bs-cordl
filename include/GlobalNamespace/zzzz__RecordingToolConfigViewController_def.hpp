...
/// @brief Method DidActivate, addr 0x3b8e8ec, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b8e978, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
