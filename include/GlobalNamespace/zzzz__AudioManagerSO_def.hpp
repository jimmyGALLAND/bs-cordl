...
/// @brief Method Init, addr 0x3a49f50, size 0xa4, virtual false, abstract: false, final false
inline void Init() ;
...
/// @brief Method .ctor, addr 0x3a4a264, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_sfxEnabled, addr 0x3a4a0d8, size 0x8, virtual false, abstract: false, final false
inline bool get_sfxEnabled() ;

/// @brief Method get_sfxLatency, addr 0x3a49ef0, size 0x60, virtual false, abstract: false, final false
inline float_t get_sfxLatency() ;

/// @brief Method get_sfxVolume, addr 0x3a4a0c0, size 0x18, virtual false, abstract: false, final false
inline float_t get_sfxVolume() ;

/// @brief Method set_mainVolume, addr 0x3a49ff4, size 0x64, virtual false, abstract: false, final false
inline void set_mainVolume(float_t  value) ;

/// @brief Method set_musicPitch, addr 0x3a4a100, size 0x100, virtual false, abstract: false, final false
inline void set_musicPitch(float_t  value) ;

/// @brief Method set_musicSpeed, addr 0x3a4a200, size 0x64, virtual false, abstract: false, final false
inline void set_musicSpeed(float_t  value) ;

/// @brief Method set_musicVolume, addr 0x3a4a058, size 0x68, virtual false, abstract: false, final false
inline void set_musicVolume(float_t  value) ;

/// @brief Method set_sfxEnabled, addr 0x3a4a0e0, size 0x20, virtual false, abstract: false, final false
inline void set_sfxEnabled(bool  value) ;

/// @brief Method set_sfxVolume, addr 0x3a49460, size 0x84, virtual false, abstract: false, final false
