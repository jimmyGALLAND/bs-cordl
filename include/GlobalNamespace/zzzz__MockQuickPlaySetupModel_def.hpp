...
/// @brief Method GetQuickPlaySetupAsync, addr 0x3b363b8, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b36428, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
