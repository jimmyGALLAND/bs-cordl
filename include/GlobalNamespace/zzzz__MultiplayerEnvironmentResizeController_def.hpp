...
/// @brief Field _otherTransforms, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__otherTransforms, put=__cordl_internal_set__otherTransforms)) ::ArrayW<::UnityW<::UnityEngine::Transform>,::Array<::UnityW<::UnityEngine::Transform>>*>  _otherTransforms;
...
/// @brief Method .ctor, addr 0x3b3c150, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_lights, addr 0x3b3c140, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>,::Array<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>>*> get_lights() ;

/// @brief Method get_offset, addr 0x3b3c138, size 0x8, virtual false, abstract: false, final false
inline float_t get_offset() ;

/// @brief Method get_otherTransforms, addr 0x3b3c148, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::Transform>,::Array<::UnityW<::UnityEngine::Transform>>*> get_otherTransforms() ;

/// @brief Method get_resizeType, addr 0x3b3c130, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _resizeData, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__resizeData, put=__cordl_internal_set__resizeData)) ::ArrayW<::GlobalNamespace::__MultiplayerEnvironmentResizeController__ResizeData*,::Array<::GlobalNamespace::__MultiplayerEnvironmentResizeController__ResizeData*>*>  _resizeData;
...
/// @brief Method HandleEdgeDistanceFromCenterWasCalculated, addr 0x3b3bdb0, size 0x18, virtual false, abstract: false, final false
inline void HandleEdgeDistanceFromCenterWasCalculated(float_t  edgeDistanceFromCenter) ;

/// @brief Method HandleSpawnCenterDistanceWasFound, addr 0x3b3bdc8, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b3bde0, size 0x148, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Resize, addr 0x3b3bf40, size 0x1e8, virtual false, abstract: false, final false
inline void Resize() ;

/// @brief Method Start, addr 0x3b3bc84, size 0x12c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method TryResize, addr 0x3b3bf28, size 0x18, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__MultiplayerEnvironmentResizeController__ResizeData*,::Array<::GlobalNamespace::__MultiplayerEnvironmentResizeController__ResizeData*>*> const& __cordl_internal_get__resizeData() const;

constexpr ::ArrayW<::GlobalNamespace::__MultiplayerEnvironmentResizeController__ResizeData*,::Array<::GlobalNamespace::__MultiplayerEnvironmentResizeController__ResizeData*>*>& __cordl_internal_get__resizeData() ;
...
constexpr void __cordl_internal_set__resizeData(::ArrayW<::GlobalNamespace::__MultiplayerEnvironmentResizeController__ResizeData*,::Array<::GlobalNamespace::__MultiplayerEnvironmentResizeController__ResizeData*>*>  value) ;
...
/// @brief Method .ctor, addr 0x3b3c128, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_resizingDidFinishEvent, addr 0x3b3bb4c, size 0x9c, virtual false, abstract: false, final false
inline void add_resizingDidFinishEvent(::System::Action*  value) ;

/// @brief Method get_isResizingFinished, addr 0x3b3bb44, size 0x8, virtual false, abstract: false, final false
inline bool get_isResizingFinished() ;

/// @brief Method remove_resizingDidFinishEvent, addr 0x3b3bbe8, size 0x9c, virtual false, abstract: false, final false
