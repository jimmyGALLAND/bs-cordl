...
/// @brief Method .ctor, addr 0x393d084, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_time, addr 0x393cfe0, size 0xa4, virtual true, abstract: false, final true
