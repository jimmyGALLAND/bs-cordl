...
/// @brief Method OnDisable, addr 0x3962248, size 0x80, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnDrawGizmos, addr 0x39622c8, size 0x88, virtual false, abstract: false, final false
inline void OnDrawGizmos() ;

/// @brief Method OnEnable, addr 0x396217c, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3962350, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LineLight>>* getStaticF__lineLights() ;

/// @brief Method get_color, addr 0x3962118, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_lineLights, addr 0x3962124, size 0x58, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LineLight>>* get_lineLights() ;

/// @brief Method get_p0, addr 0x3962100, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_p0() ;

/// @brief Method get_p1, addr 0x396210c, size 0xc, virtual false, abstract: false, final false
