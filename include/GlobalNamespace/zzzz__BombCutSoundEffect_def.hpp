...
/// @brief Method .ctor, addr 0x3a4b48c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x3a4b330, size 0x74, virtual false, abstract: false, final false
inline void Init(::UnityEngine::AudioClip*  audioClip, ::GlobalNamespace::Saber*  saber, float_t  volume) ;

/// @brief Method LateUpdate, addr 0x3a4b3a4, size 0x90, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::BombCutSoundEffect* New_ctor() ;

/// @brief Method StopPlayingAndFinish, addr 0x3a4b434, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a4b484, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x3a4b1d0, size 0xb0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::BombCutSoundEffect>>*  value) ;

/// @brief Method remove_didFinishEvent, addr 0x3a4b280, size 0xb0, virtual false, abstract: false, final false
