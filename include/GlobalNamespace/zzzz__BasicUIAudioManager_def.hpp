...
/// @brief Method HandleButtonClickEvent, addr 0x3b61b44, size 0xd0, virtual false, abstract: false, final false
inline void HandleButtonClickEvent() ;

static inline ::GlobalNamespace::BasicUIAudioManager* New_ctor() ;

/// @brief Method OnDisable, addr 0x3b61a74, size 0xd0, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3b619a4, size 0xd0, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Start, addr 0x3b61908, size 0x9c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b61c14, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
