...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Task_1<::UnityW<::UnityEngine::AudioClip>>* (::GlobalNamespace::IMediaAsyncLoader::*)(::StringW)>(&::GlobalNamespace::IMediaAsyncLoader::LoadAudioClipFromFilePathAsync)> {
