...
/// @brief Field _rotationStepType, offset 0x34, size 0x4 
 __declspec(property(get=__cordl_internal_get__rotationStepType, put=__cordl_internal_set__rotationStepType)) ::GlobalNamespace::__TrackLaneRingsRotationEffectSpawner__RotationStepType  _rotationStepType;

/// @brief Field _trackLaneRingsRotationEffect, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__trackLaneRingsRotationEffect, put=__cordl_internal_set__trackLaneRingsRotationEffect)) ::UnityW<::GlobalNamespace::TrackLaneRingsRotationEffect>  _trackLaneRingsRotationEffect;

/// @brief Method HandleBeatmapEvent, addr 0x3b0b5d8, size 0xc8, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

static inline ::GlobalNamespace::TrackLaneRingsRotationEffectSpawner* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b0b5bc, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b0b494, size 0x128, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b0b6a0, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::TrackLaneRingsRotationEffectSpawner, 0x50>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::TrackLaneRingsRotationEffectSpawner, ____beatmapDataCallbackWrapper) == 0x48, "Offset mismatch!");
