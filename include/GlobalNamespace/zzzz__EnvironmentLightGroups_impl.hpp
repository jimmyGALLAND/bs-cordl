...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__EnvironmentLightGroups____c::*)()>(&::GlobalNamespace::__EnvironmentLightGroups____c::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2661e14;
...
//  Writing Method size for method: ::GlobalNamespace::__EnvironmentLightGroups____c._Sort_b__9_0
template<>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::__EnvironmentLightGroups____c::*)(::GlobalNamespace::LightGroupSO*)>(&::GlobalNamespace::__EnvironmentLightGroups____c::_Sort_b__9_0)> {
  constexpr static std::size_t size = 0x18;
  constexpr static std::size_t addrs = 0x2661e1c;
...
::cordl_internals::setStaticField<::GlobalNamespace::__EnvironmentLightGroups____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__EnvironmentLightGroups____c*>::get>(std::forward<::GlobalNamespace::__EnvironmentLightGroups____c*>(value));
}
inline ::GlobalNamespace::__EnvironmentLightGroups____c* GlobalNamespace::__EnvironmentLightGroups____c::getStaticF___9()  {
return ::cordl_internals::getStaticField<::GlobalNamespace::__EnvironmentLightGroups____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__EnvironmentLightGroups____c*>::get>();
}
inline void GlobalNamespace::__EnvironmentLightGroups____c::setStaticF___9__9_0(::System::Func_2<::UnityW<::GlobalNamespace::LightGroupSO>,int32_t>*  value)  {
::cordl_internals::setStaticField<::System::Func_2<::UnityW<::GlobalNamespace::LightGroupSO>,int32_t>*, "<>9__9_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__EnvironmentLightGroups____c*>::get>(std::forward<::System::Func_2<::UnityW<::GlobalNamespace::LightGroupSO>,int32_t>*>(value));
}
inline ::System::Func_2<::UnityW<::GlobalNamespace::LightGroupSO>,int32_t>* GlobalNamespace::__EnvironmentLightGroups____c::getStaticF___9__9_0()  {
return ::cordl_internals::getStaticField<::System::Func_2<::UnityW<::GlobalNamespace::LightGroupSO>,int32_t>*, "<>9__9_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__EnvironmentLightGroups____c*>::get>();
}
inline ::GlobalNamespace::__EnvironmentLightGroups____c* GlobalNamespace::__EnvironmentLightGroups____c::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__EnvironmentLightGroups____c*>());
}
...
inline int32_t GlobalNamespace::__EnvironmentLightGroups____c::_Sort_b__9_0(::GlobalNamespace::LightGroupSO*  s)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__EnvironmentLightGroups____c*>::get(),
                        "<Sort>b__9_0",
                        std::span<const Il2CppClass* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::ILightGroup*>* (::GlobalNamespace::EnvironmentLightGroups::*)()>(&::GlobalNamespace::EnvironmentLightGroups::get_lightGroups)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2661a28;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>* (::GlobalNamespace::EnvironmentLightGroups::*)()>(&::GlobalNamespace::EnvironmentLightGroups::get_lightGroupSOList)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2661a30;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EnvironmentLightGroups::*)(::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>*)>(&::GlobalNamespace::EnvironmentLightGroups::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x2661a38;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>*>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::ILightGroup* (::GlobalNamespace::EnvironmentLightGroups::*)(int32_t)>(&::GlobalNamespace::EnvironmentLightGroups::GetDataForGroup)> {
  constexpr static std::size_t size = 0x238;
  constexpr static std::size_t addrs = 0x2661a60;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EnvironmentLightGroups::*)()>(&::GlobalNamespace::EnvironmentLightGroups::Sort)> {
  ...
  constexpr static std::size_t addrs = 0x2661c98;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>*> const& GlobalNamespace::EnvironmentLightGroups::__cordl_internal_get__lightGroupSOList() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____lightGroupSOList;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::GlobalNamespace::LightGroupSO>>*> const& GlobalNamespace::EnvironmentLightGroups::__cordl_internal_get__lightGroupSODict() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____lightGroupSODict;
}
constexpr void GlobalNamespace::EnvironmentLightGroups::__cordl_internal_set__lightGroupSODict(::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::GlobalNamespace::LightGroupSO>>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>*> const& GlobalNamespace::EnvironmentLightGroups::__cordl_internal_get__lightGroupSOListForLightGroupDataDict() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____lightGroupSOListForLightGroupDataDict;
}
constexpr void GlobalNamespace::EnvironmentLightGroups::__cordl_internal_set__lightGroupSOListForLightGroupDataDict(::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____lightGroupSOListForLightGroupDataDict)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
