...
/// @brief Method Awake, addr 0x394001c, size 0x1c, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::Billboard* New_ctor() ;

/// @brief Method OnWillRenderObject, addr 0x3940038, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3940108, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
