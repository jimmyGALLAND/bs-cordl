...
/// @brief Method Dispose, addr 0x229b484, size 0x240, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method ForceStart, addr 0x229b6c4, size 0x6b4, virtual false, abstract: false, final false
inline void ForceStart(::StringW  sessionGameId) ;

/// @brief Method GetLevelStartTimeOffset, addr 0x229afa4, size 0x4e0, virtual false, abstract: false, final false
inline void GetLevelStartTimeOffset() ;

/// @brief Method HandleGetGameplaySongReady, addr 0x229c2c0, size 0xa4, virtual false, abstract: false, final false
inline void HandleGetGameplaySongReady(::StringW  user) ;

/// @brief Method HandleSetGameplaySongReady, addr 0x229c010, size 0x2b0, virtual false, abstract: false, final false
inline void HandleSetGameplaySongReady(::StringW  user) ;

/// @brief Method HandleSetSongStartTime, addr 0x229c364, size 0x30, virtual false, abstract: false, final false
inline void HandleSetSongStartTime(::StringW  user, int64_t  time) ;

/// @brief Method Log, addr 0x229c394, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method StartSong, addr 0x229bd78, size 0x298, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x229af08, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method add_setSongStartSyncTimeEvent, addr 0x229ada8, size 0xb0, virtual false, abstract: false, final false
inline void add_setSongStartSyncTimeEvent(::System::Action_1<int64_t>*  value) ;

/// @brief Method get_songStartSyncTime, addr 0x229ada0, size 0x8, virtual false, abstract: false, final false
inline int64_t get_songStartSyncTime() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method remove_setSongStartSyncTimeEvent, addr 0x229ae58, size 0xb0, virtual false, abstract: false, final false
