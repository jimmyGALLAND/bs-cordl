...
public:
// Declarations
/// @brief Method BuildFilePath, addr 0x229a790, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method ReadAppVersion, addr 0x229a800, size 0x14, virtual false, abstract: false, final false
static inline ::StringW ReadAppVersion(::StringW  directoryPath) ;

/// @brief Method WriteAppVersion, addr 0x229a774, size 0x1c, virtual false, abstract: false, final false
static inline void WriteAppVersion(::StringW  directoryPath, ::StringW  appVersion) ;

/// @brief Method .ctor, addr 0x229a814, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
