...
/// @brief Method Execute, addr 0x3fa70c4, size 0x180, virtual true, abstract: false, final true
...
/// @brief Method Execute, addr 0x3fa7244, size 0x20, virtual true, abstract: false, final true
inline void Execute(int32_t  index) ;
...
/// @brief Method .ctor, addr 0x3fa70bc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
