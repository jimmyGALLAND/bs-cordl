...
class CORDL_TYPE __MultiplayerLocalActivePlayerFacade__Factory : public ::Zenject::PlaceholderFactory_2<::GlobalNamespace::MultiplayerPlayerStartState,::UnityW<::GlobalNamespace::MultiplayerLocalActivePlayerFacade>> {
public:
// Declarations
static inline ::GlobalNamespace::__MultiplayerLocalActivePlayerFacade__Factory* New_ctor() ;

/// @brief Method .ctor, addr 0x3b2d534, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _activeOnlyGameObjects, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__activeOnlyGameObjects, put=__cordl_internal_set__activeOnlyGameObjects)) ::ArrayW<::UnityW<::UnityEngine::GameObject>,::Array<::UnityW<::UnityEngine::GameObject>>*>  _activeOnlyGameObjects;

/// @brief Field _beatmapCallbacksUpdater, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapCallbacksUpdater, put=__cordl_internal_set__beatmapCallbacksUpdater)) ::UnityW<::GlobalNamespace::BeatmapCallbacksUpdater>  _beatmapCallbacksUpdater;
...
/// @brief Method DisablePlayer, addr 0x3b2d454, size 0x64, virtual false, abstract: false, final false
inline void DisablePlayer() ;

static inline ::GlobalNamespace::MultiplayerLocalActivePlayerFacade* New_ctor() ;

/// @brief Method PauseSpawning, addr 0x3b2d4b8, size 0x1c, virtual false, abstract: false, final false
inline void PauseSpawning() ;

/// @brief Method ReportPlayerDidFinish, addr 0x3b2d41c, size 0x1c, virtual true, abstract: false, final true
inline void ReportPlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults*  results) ;

/// @brief Method ReportPlayerNetworkDidFailed, addr 0x3b2d438, size 0x1c, virtual true, abstract: false, final true
inline void ReportPlayerNetworkDidFailed(::GlobalNamespace::MultiplayerLevelCompletionResults*  results) ;

/// @brief Method ResumeSpawning, addr 0x3b2d4d4, size 0x1c, virtual false, abstract: false, final false
inline void ResumeSpawning() ;

/// @brief Method __ForceStopSong, addr 0x3b2d4f0, size 0x34, virtual false, abstract: false, final false
inline void __ForceStopSong() ;

/// @brief Method __GetActiveOnlyGameObjects, addr 0x3b2d524, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b2d52c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_playerDidFinishEvent, addr 0x3b2d15c, size 0xb0, virtual true, abstract: false, final true
inline void add_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method add_playerNetworkDidFailedEvent, addr 0x3b2d2bc, size 0xb0, virtual true, abstract: false, final true
inline void add_playerNetworkDidFailedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method get_currentLocalPlayerLevelCompletionResult, addr 0x3b2d138, size 0x24, virtual false, abstract: false, final false
inline ::GlobalNamespace::LevelCompletionResults* get_currentLocalPlayerLevelCompletionResult() ;

/// @brief Method get_introAnimator, addr 0x3b2d120, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MultiplayerLocalActivePlayerIntroAnimator> get_introAnimator() ;

/// @brief Method get_outroAnimator, addr 0x3b2d128, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_outroAnimator() ;

/// @brief Method get_songController, addr 0x3b2d130, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method remove_playerDidFinishEvent, addr 0x3b2d20c, size 0xb0, virtual true, abstract: false, final true
inline void remove_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method remove_playerNetworkDidFailedEvent, addr 0x3b2d36c, size 0xb0, virtual true, abstract: false, final true
