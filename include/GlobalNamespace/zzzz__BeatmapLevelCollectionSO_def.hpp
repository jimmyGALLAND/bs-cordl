...
/// @brief Method AddBeatmapLevel, addr 0x2677198, size 0xa4, virtual false, abstract: false, final false
inline void AddBeatmapLevel(::GlobalNamespace::BeatmapLevelSO*  beatmapLevel) ;

/// @brief Method Create, addr 0x26770f8, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x267723c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_beatmapLevels, addr 0x26770f0, size 0x8, virtual false, abstract: false, final false
