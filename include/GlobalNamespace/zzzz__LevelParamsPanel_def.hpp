...
/// @brief Method .ctor, addr 0x3a7ac6c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_bombsCount, addr 0x3a7ac24, size 0x48, virtual false, abstract: false, final false
inline void set_bombsCount(int32_t  value) ;

/// @brief Method set_notesCount, addr 0x3a7ab94, size 0x48, virtual false, abstract: false, final false
inline void set_notesCount(int32_t  value) ;

/// @brief Method set_notesPerSecond, addr 0x3a7ab14, size 0x80, virtual false, abstract: false, final false
inline void set_notesPerSecond(float_t  value) ;

/// @brief Method set_obstaclesCount, addr 0x3a7abdc, size 0x48, virtual false, abstract: false, final false
