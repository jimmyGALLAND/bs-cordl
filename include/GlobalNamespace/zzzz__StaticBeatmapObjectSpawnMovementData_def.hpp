...
public:
// Declarations
/// @brief Method Get2DNoteOffset, addr 0x2207f90, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method LineYPosForLineLayer, addr 0x2208280, size 0x24, virtual false, abstract: false, final false
static inline float_t LineYPosForLineLayer(::GlobalNamespace::NoteLineLayer  lineLayer) ;

/// @brief Method get_layerHeight, addr 0x22082a4, size 0xc, virtual false, abstract: false, final false
