...
/// @brief Field <promoInfo>k__BackingField, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__promoInfo_k__BackingField, put=__cordl_internal_set__promoInfo_k__BackingField)) ::GlobalNamespace::__DlcPromoPanelModel__PromoInfo*  _promoInfo_k__BackingField;
...
/// @brief Method Setup, addr 0x3a7b1f0, size 0x14c, virtual false, abstract: false, final false
inline void Setup(::GlobalNamespace::__DlcPromoPanelModel__PromoInfo*  newPromoInfo, bool  probablyOwned) ;

/// @brief Method StartLoading, addr 0x3a7b184, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a7b33c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_promoButtonText, addr 0x3a7b17c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_promoButtonText() ;

/// @brief Method get_promoInfo, addr 0x3a7b16c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__DlcPromoPanelModel__PromoInfo* get_promoInfo() ;

/// @brief Method set_promoInfo, addr 0x3a7b174, size 0x8, virtual false, abstract: false, final false
