...
/// @brief Method .ctor, addr 0x2684de8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_levelID, addr 0x2684dd8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_levelID() ;

/// @brief Method get_promoBannerInfo, addr 0x2684de0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _levelsPromoInfo, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__levelsPromoInfo, put=__cordl_internal_set__levelsPromoInfo)) ::ArrayW<::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo*,::Array<::GlobalNamespace::__PackPromoInfoSO__LevelPromoInfo*>*>  _levelsPromoInfo;
...
/// @brief Method .ctor, addr 0x2684dd0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_levelPromoInfos, addr 0x2684dc8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_promoBannerInfo, addr 0x2684dc0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::PromoBannerInfoSO> get_promoBannerInfo() ;
