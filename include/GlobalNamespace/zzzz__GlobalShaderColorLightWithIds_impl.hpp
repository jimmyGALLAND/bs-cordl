...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId::*)()>(&::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId::get_intensity)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x395e930;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*>::get(),
                        "get_intensity",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId::*)(float_t)>(&::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId::set_intensity)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x395e938;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId::*)(int32_t, float_t)>(&::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId::_ctor)> {
  constexpr static std::size_t size = 0x38;
  constexpr static std::size_t addrs = 0x395e940;
...
inline ::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId* GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId::New_ctor(int32_t  lightId, float_t  lightIntensity)  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GlobalShaderColorLightWithIds::*)()>(&::GlobalNamespace::GlobalShaderColorLightWithIds::ProcessNewColorData)> {
  ...
  constexpr static std::size_t addrs = 0x395e764;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::__LightWithIds__LightWithId*>* (::GlobalNamespace::GlobalShaderColorLightWithIds::*)()>(&::GlobalNamespace::GlobalShaderColorLightWithIds::GetLightWithIds)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x395e8b0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GlobalShaderColorLightWithIds::*)()>(&::GlobalNamespace::GlobalShaderColorLightWithIds::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x395e8b8;
...
constexpr ::ArrayW<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*>*>& GlobalNamespace::GlobalShaderColorLightWithIds::__cordl_internal_get__lightIntensityData()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____lightIntensityData;
}
constexpr ::ArrayW<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*>*> const& GlobalNamespace::GlobalShaderColorLightWithIds::__cordl_internal_get__lightIntensityData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____lightIntensityData;
}
constexpr void GlobalNamespace::GlobalShaderColorLightWithIds::__cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*,::Array<::GlobalNamespace::__GlobalShaderColorLightWithIds__LightIntensitiesWithId*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
