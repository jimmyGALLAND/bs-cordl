...
/// @brief Method GetDefault, addr 0x22010a4, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method __ConnectWithNextSameTypeEventData, addr 0x220108c, size 0x10, virtual false, abstract: false, final false
inline void __ConnectWithNextSameTypeEventData(::GlobalNamespace::BeatmapEventData*  newNextSameTypeEvent) ;

/// @brief Method __ConnectWithPreviousSameTypeEventData, addr 0x220107c, size 0x10, virtual false, abstract: false, final false
inline void __ConnectWithPreviousSameTypeEventData(::GlobalNamespace::BeatmapEventData*  newPreviousSameTypeEvent) ;

/// @brief Method __ResetConnections, addr 0x220109c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2200ca0, size 0x44, virtual false, abstract: false, final false
inline void _ctor(float_t  time, int32_t  executionOrder, int32_t  subtypeIdentifier) ;

/// @brief Method get_nextSameTypeEventData, addr 0x220106c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapEventData* get_nextSameTypeEventData() ;

/// @brief Method get_previousSameTypeEventData, addr 0x220105c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapEventData* get_previousSameTypeEventData() ;

/// @brief Method set_nextSameTypeEventData, addr 0x2201074, size 0x8, virtual false, abstract: false, final false
inline void set_nextSameTypeEventData(::GlobalNamespace::BeatmapEventData*  value) ;

/// @brief Method set_previousSameTypeEventData, addr 0x2201064, size 0x8, virtual false, abstract: false, final false
