...
/// @brief Method HandleAllSliderWereRemovedFromActiveSliders, addr 0x3a6e0bc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method HandleSliderWasAddedToActiveSliders, addr 0x3a6e0b0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3a6de6c, size 0xe4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3a6cf70, size 0xe4, virtual true, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3a6d1fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_colorType, addr 0x3a6d054, size 0x1c, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorType get_colorType() ;

/// @brief Method get_saberInteractionParam, addr 0x3a6d144, size 0x1c, virtual false, abstract: false, final false
