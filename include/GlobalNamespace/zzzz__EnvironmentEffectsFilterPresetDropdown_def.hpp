...
public:
// Declarations
/// @brief Method GetNamedValues, addr 0x3b7d098, size 0x128, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b7d1c0, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
