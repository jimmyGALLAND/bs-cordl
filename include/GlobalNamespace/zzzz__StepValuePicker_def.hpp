...
/// @brief Method DecButtonPressed, addr 0x3b97cfc, size 0x1c, virtual false, abstract: false, final false
inline void DecButtonPressed() ;

/// @brief Method IncButtonPressed, addr 0x3b97ce0, size 0x1c, virtual false, abstract: false, final false
inline void IncButtonPressed() ;

static inline ::GlobalNamespace::StepValuePicker* New_ctor() ;

/// @brief Method OnDisable, addr 0x3b97bf8, size 0xe8, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3b97b10, size 0xe8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b97d18, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_decButtonWasPressedEvent, addr 0x3b96f30, size 0x9c, virtual false, abstract: false, final false
inline void add_decButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method add_incButtonWasPressedEvent, addr 0x3b96fcc, size 0x9c, virtual false, abstract: false, final false
inline void add_incButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method get_text, addr 0x3b97aec, size 0x24, virtual false, abstract: false, final false
inline ::StringW get_text() ;

/// @brief Method remove_decButtonWasPressedEvent, addr 0x3b97164, size 0x9c, virtual false, abstract: false, final false
inline void remove_decButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method remove_incButtonWasPressedEvent, addr 0x3b97200, size 0x9c, virtual false, abstract: false, final false
inline void remove_incButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method set_decButtonInteractable, addr 0x3b96dc8, size 0x20, virtual false, abstract: false, final false
inline void set_decButtonInteractable(bool  value) ;

/// @brief Method set_incButtonInteractable, addr 0x3b96e10, size 0x20, virtual false, abstract: false, final false
inline void set_incButtonInteractable(bool  value) ;

/// @brief Method set_text, addr 0x3b96e5c, size 0x24, virtual false, abstract: false, final false
