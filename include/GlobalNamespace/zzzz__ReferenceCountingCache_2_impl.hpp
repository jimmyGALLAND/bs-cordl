...
template<typename TKey,typename TValue>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<TKey,TValue>*> const& GlobalNamespace::ReferenceCountingCache_2<TKey,TValue>::__cordl_internal_get__items() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____items;
}
template<typename TKey,typename TValue>
...
template<typename TKey,typename TValue>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<TKey,int32_t>*> const& GlobalNamespace::ReferenceCountingCache_2<TKey,TValue>::__cordl_internal_get__referencesCount() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____referencesCount;
}
template<typename TKey,typename TValue>
