...
/// @brief Method .ctor, addr 0x267f5c0, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  difficultyBeatmapId, ::StringW  platformLeaderboardId) ;

/// @brief Method get_difficultyBeatmapId, addr 0x267f670, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_difficultyBeatmapId() ;

/// @brief Method get_platformLeaderboardId, addr 0x267f668, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _leaderboardIds, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__leaderboardIds, put=__cordl_internal_set__leaderboardIds)) ::System::Collections::Generic::List_1<::GlobalNamespace::__LeaderboardIdsSO__LeaderboardIdData*>*  _leaderboardIds;
...
/// @brief Method Add, addr 0x267f4dc, size 0xe4, virtual false, abstract: false, final false
inline void Add(::StringW  difficultyBeatmapId, ::StringW  platformLeaderboardId) ;

/// @brief Method ILeaderboardIdContainer.get_leaderboardIds, addr 0x267f470, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x267f5ec, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_leaderboardIds, addr 0x267f478, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_leaderboardIds, addr 0x267f480, size 0x5c, virtual false, abstract: false, final false
