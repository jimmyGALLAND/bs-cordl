...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*> const& __cordl_internal_get__environmentInfos_k__BackingField() const;
...
/// @brief Method .ctor, addr 0x3b6c664, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_environmentInfos, addr 0x3b6c654, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>* get_environmentInfos() ;

/// @brief Method set_environmentInfos, addr 0x3b6c65c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <SetData>b__10_0, addr 0x3b6c6d0, size 0x18, virtual false, abstract: false, final false
inline ::StringW _SetData_b__10_0(::GlobalNamespace::EnvironmentInfoSO*  x) ;

/// @brief Method .ctor, addr 0x3b6c6c8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _elements, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__elements, put=__cordl_internal_set__elements)) ::ArrayW<::GlobalNamespace::__EnvironmentOverrideSettingsPanelController__Elements*,::Array<::GlobalNamespace::__EnvironmentOverrideSettingsPanelController__Elements*>*>  _elements;
...
/// @brief Method HandleDropDownDidSelectCellWithIdx, addr 0x3b6c154, size 0x27c, virtual false, abstract: false, final false
inline void HandleDropDownDidSelectCellWithIdx(::HMUI::DropdownWithTableView*  dropDownWithTableView, int32_t  idx) ;

/// @brief Method HandleOverrideEnvironmentsToggleValueChanged, addr 0x3b6c3d0, size 0x25c, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b6be68, size 0x194, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Refresh, addr 0x3b6bffc, size 0x158, virtual true, abstract: false, final true
inline void Refresh() ;

/// @brief Method SetData, addr 0x3b6bbc4, size 0x2a4, virtual false, abstract: false, final false
inline void SetData(::GlobalNamespace::OverrideEnvironmentSettings*  overrideEnvironmentSettings) ;

/// @brief Method <HandleOverrideEnvironmentsToggleValueChanged>b__14_0, addr 0x3b6c634, size 0x20, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__EnvironmentOverrideSettingsPanelController__Elements*,::Array<::GlobalNamespace::__EnvironmentOverrideSettingsPanelController__Elements*>*> const& __cordl_internal_get__elements() const;

constexpr ::ArrayW<::GlobalNamespace::__EnvironmentOverrideSettingsPanelController__Elements*,::Array<::GlobalNamespace::__EnvironmentOverrideSettingsPanelController__Elements*>*>& __cordl_internal_get__elements() ;
...
constexpr void __cordl_internal_set__elements(::ArrayW<::GlobalNamespace::__EnvironmentOverrideSettingsPanelController__Elements*,::Array<::GlobalNamespace::__EnvironmentOverrideSettingsPanelController__Elements*>*>  value) ;
...
/// @brief Method .ctor, addr 0x3b6c62c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
