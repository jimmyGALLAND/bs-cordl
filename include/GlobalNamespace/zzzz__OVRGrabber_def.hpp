...
/// @brief Method Awake, addr 0x3fa2c80, size 0x140, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method CheckForGrabOrRelease, addr 0x3fa3278, size 0x40, virtual false, abstract: false, final false
inline void CheckForGrabOrRelease(float_t  prevFlex) ;

/// @brief Method ForceRelease, addr 0x3fa2950, size 0xb0, virtual false, abstract: false, final false
inline void ForceRelease(::GlobalNamespace::OVRGrabbable*  grabbable) ;

/// @brief Method GrabBegin, addr 0x3fa35ac, size 0x6b0, virtual true, abstract: false, final false
inline void GrabBegin() ;

/// @brief Method GrabEnd, addr 0x3fa2a18, size 0x268, virtual false, abstract: false, final false
inline void GrabEnd() ;

/// @brief Method GrabVolumeEnable, addr 0x3fa3ee0, size 0xc0, virtual true, abstract: false, final false
inline void GrabVolumeEnable(bool  enabled) ;

/// @brief Method GrabbableRelease, addr 0x3fa3e8c, size 0x54, virtual false, abstract: false, final false
inline void GrabbableRelease(::UnityEngine::Vector3  linearVelocity, ::UnityEngine::Vector3  angularVelocity) ;

/// @brief Method MoveGrabbedObject, addr 0x3fa3c5c, size 0x230, virtual true, abstract: false, final false
...
/// @brief Method OffhandGrabbed, addr 0x3fa3fa0, size 0xcc, virtual true, abstract: false, final false
inline void OffhandGrabbed(::GlobalNamespace::OVRGrabbable*  grabbable) ;

/// @brief Method OnDestroy, addr 0x3fa32b8, size 0x78, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnTriggerEnter, addr 0x3fa3330, size 0x124, virtual false, abstract: false, final false
inline void OnTriggerEnter(::UnityEngine::Collider*  otherCollider) ;

/// @brief Method OnTriggerExit, addr 0x3fa3454, size 0x158, virtual false, abstract: false, final false
inline void OnTriggerExit(::UnityEngine::Collider*  otherCollider) ;

/// @brief Method OnUpdatedAnchors, addr 0x3fa3054, size 0x224, virtual false, abstract: false, final false
inline void OnUpdatedAnchors() ;

/// @brief Method SetPlayerIgnoreCollision, addr 0x3fa2ea0, size 0x1a4, virtual false, abstract: false, final false
inline void SetPlayerIgnoreCollision(::UnityEngine::GameObject*  grabbable, bool  ignore) ;

/// @brief Method Start, addr 0x3fa2dc0, size 0xe0, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3fa3044, size 0x10, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method <Awake>b__23_0, addr 0x3fa4100, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fa406c, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_grabbedObject, addr 0x3fa2a10, size 0x8, virtual false, abstract: false, final false
