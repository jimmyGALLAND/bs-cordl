...
/// @brief Method ApplyParams, addr 0x3962eec, size 0xbc, virtual false, abstract: false, final false
inline void ApplyParams() ;

static inline ::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter* New_ctor() ;

/// @brief Method OnValidate, addr 0x3962fa8, size 0x24, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method RefreshPropertyId, addr 0x3962ecc, size 0x20, virtual false, abstract: false, final false
inline void RefreshPropertyId() ;

/// @brief Method Start, addr 0x3962ea8, size 0x24, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3962fcc, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
