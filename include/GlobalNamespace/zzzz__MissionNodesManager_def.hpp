...
/// @brief Method Awake, addr 0x3b75b84, size 0x2c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method DidFirstLockedMissionStageChange, addr 0x3b74838, size 0x9c, virtual false, abstract: false, final false
inline bool DidFirstLockedMissionStageChange() ;

/// @brief Method GetAllMissionNodes, addr 0x3b76160, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method GetAllMissionNodes, addr 0x3b75bb0, size 0xa8, virtual false, abstract: false, final false
inline void GetAllMissionNodes() ;

/// @brief Method GetMissionNodeWithModelClearedStateInconsistency, addr 0x3b73720, size 0xb0, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionNode> GetMissionNodeWithModelClearedStateInconsistency() ;

/// @brief Method GetNewEnabledConnection, addr 0x3b744d0, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method GetTopMostNotClearedMissionNode, addr 0x3b7389c, size 0x15c, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionNode> GetTopMostNotClearedMissionNode() ;

/// @brief Method IMissionNodesManager.get_allMissionNodes, addr 0x3b75b7c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method IMissionNodesManager.get_finalMissionNode, addr 0x3b75b74, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::IMissionNode* IMissionNodesManager_get_finalMissionNode() ;

/// @brief Method IsNodeInteractable, addr 0x3b76244, size 0x5c, virtual false, abstract: false, final false
inline bool IsNodeInteractable(::GlobalNamespace::MissionNodeVisualController*  node, bool  parentCleared) ;

/// @brief Method MissionWasCleared, addr 0x3b75fac, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method RegisterAllNodes, addr 0x3b75c58, size 0xc0, virtual false, abstract: false, final false
inline void RegisterAllNodes() ;

/// @brief Method ResetAllNodes, addr 0x3b75d18, size 0x58, virtual false, abstract: false, final false
inline void ResetAllNodes() ;

/// @brief Method SetupNodeConnections, addr 0x3b75eec, size 0xc0, virtual false, abstract: false, final false
inline void SetupNodeConnections() ;

/// @brief Method SetupNodeMap, addr 0x3b73ae0, size 0x3c, virtual false, abstract: false, final false
inline void SetupNodeMap() ;

/// @brief Method SetupNodeTree, addr 0x3b75dd4, size 0x118, virtual false, abstract: false, final false
inline void SetupNodeTree(::GlobalNamespace::MissionNodeVisualController*  node, bool  parentCleared) ;

/// @brief Method SetupStages, addr 0x3b75d70, size 0x64, virtual false, abstract: false, final false
inline void SetupStages() ;

/// @brief Method UpdateStageLockText, addr 0x3b74804, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b762d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsInitialized, addr 0x3b75b6c, size 0x8, virtual false, abstract: false, final false
inline bool get_IsInitialized() ;

/// @brief Method get_allMissionNodes, addr 0x3b75b64, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>,::Array<::UnityW<::GlobalNamespace::MissionNode>>*> get_allMissionNodes() ;

/// @brief Method get_finalMissionNode, addr 0x3b75b4c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionNode> get_finalMissionNode() ;

/// @brief Method get_missionProgressModel, addr 0x3b75b5c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::CampaignProgressModel> get_missionProgressModel() ;

/// @brief Method get_missionStagesManager, addr 0x3b75b54, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionStagesManager> get_missionStagesManager() ;

/// @brief Method get_rootMissionNode, addr 0x3b75b44, size 0x8, virtual false, abstract: false, final false
