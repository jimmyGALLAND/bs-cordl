...
/// @brief Method ExecuteInternal, addr 0x225a1dc, size 0xe4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2259c70, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method ExecuteInternal, addr 0x225a2c0, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2259e5c, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method ExecuteInternal, addr 0x225a378, size 0x38, virtual true, abstract: false, final false
inline void ExecuteInternal() ;
...
/// @brief Method .ctor, addr 0x2259f60, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  filePath) ;
...
/// @brief Method ExecuteInternal, addr 0x225a3b0, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x225a044, size 0x5c, virtual false, abstract: false, final false
inline void _ctor(::StringW  filePath) ;
...
/// @brief Method <GetCommandQueue>b__6_0, addr 0x225a44c, size 0x54, virtual false, abstract: false, final false
inline ::GlobalNamespace::BackgroundCommandQueue* _GetCommandQueue_b__6_0(::StringW  _) ;

/// @brief Method .ctor, addr 0x225a444, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method DeleteFileAsync, addr 0x2259eb8, size 0xa8, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task* DeleteFileAsync(::StringW  fileName, ::GlobalNamespace::StoragePreference  storageLocation) ;

/// @brief Method FileExistsAsync, addr 0x2259f88, size 0xbc, virtual true, abstract: false, final true
...
/// @brief Method GetBackupFilePath, addr 0x225a0a0, size 0x4c, virtual false, abstract: false, final false
static inline ::StringW GetBackupFilePath(::StringW  filePath) ;

/// @brief Method GetCommandQueue, addr 0x2259c9c, size 0x104, virtual false, abstract: false, final false
inline ::GlobalNamespace::BackgroundCommandQueue* GetCommandQueue(::StringW  fileName) ;

/// @brief Method GetFilePath, addr 0x2259b58, size 0x118, virtual false, abstract: false, final false
inline ::StringW GetFilePath(::StringW  fileName, ::GlobalNamespace::StoragePreference  storageLocation) ;

/// @brief Method GetTempFilePath, addr 0x225a0ec, size 0x4c, virtual false, abstract: false, final false
static inline ::StringW GetTempFilePath(::StringW  filePath) ;

/// @brief Method LoadFileAsync, addr 0x2259da0, size 0xbc, virtual true, abstract: false, final true
...
/// @brief Method SaveFileAsync, addr 0x2259aa4, size 0xb4, virtual true, abstract: false, final true
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Concurrent::ConcurrentDictionary_2<::StringW,::GlobalNamespace::BackgroundCommandQueue*>*> const& __cordl_internal_get__commandQueueMap() const;
...
/// @brief Method .ctor, addr 0x225a138, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;
