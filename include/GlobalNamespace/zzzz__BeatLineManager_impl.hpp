...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::BeatLineManager::*)()>(&::GlobalNamespace::BeatLineManager::get_isMidRotationValid)> {
  ...
  constexpr static std::size_t addrs = 0x3a52544;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::GlobalNamespace::BeatLineManager::*)()>(&::GlobalNamespace::BeatLineManager::get_midRotation)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3a5254c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::GlobalNamespace::BeatLineManager::*)()>(&::GlobalNamespace::BeatLineManager::get_rotationRange)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3a52554;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatLineManager::*)()>(&::GlobalNamespace::BeatLineManager::Start)> {
  ...
  constexpr static std::size_t addrs = 0x3a5255c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatLineManager::*)()>(&::GlobalNamespace::BeatLineManager::OnDestroy)> {
  constexpr static std::size_t size = 0x8c;
  constexpr static std::size_t addrs = 0x3a525e8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatLineManager::*)()>(&::GlobalNamespace::BeatLineManager::Update)> {
  ...
  constexpr static std::size_t addrs = 0x3a52674;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatLineManager::*)(::GlobalNamespace::NoteController*)>(&::GlobalNamespace::BeatLineManager::HandleNoteWasSpawned)> {
  constexpr static std::size_t size = 0x1a0;
  constexpr static std::size_t addrs = 0x3a52b8c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatLineManager::*)()>(&::GlobalNamespace::BeatLineManager::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3a52d2c;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityEngine::Vector4,::UnityW<::GlobalNamespace::BeatLine>>*> const& GlobalNamespace::BeatLineManager::__cordl_internal_get__activeBeatLines() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____activeBeatLines;
}
constexpr void GlobalNamespace::BeatLineManager::__cordl_internal_set__activeBeatLines(::System::Collections::Generic::Dictionary_2<::UnityEngine::Vector4,::UnityW<::GlobalNamespace::BeatLine>>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____activeBeatLines)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Vector4>*> const& GlobalNamespace::BeatLineManager::__cordl_internal_get__removeBeatLineKeyList() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____removeBeatLineKeyList;
}
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____removeBeatLineKeyList)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
