...
/// @brief Method HandleNoteWasCut, addr 0x3b1d734, size 0x8c, virtual false, abstract: false, final false
inline void HandleNoteWasCut(::GlobalNamespace::NoteController*  noteController, ByRef<::GlobalNamespace::NoteCutInfo>  noteCutInfo) ;

/// @brief Method Init, addr 0x3b1d560, size 0x144, virtual true, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::GoodCutsMissionObjectiveChecker* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b1d6a4, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b1d7c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
