...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::LightTranslationBaseData*>*> const& __cordl_internal_get__lightTranslationBaseDataList() const;
...
/// @brief Method .ctor, addr 0x2670d1c, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method get_beatStep, addr 0x2670d14, size 0x8, virtual true, abstract: false, final false
inline float_t get_beatStep() ;

/// @brief Method get_subtypeIdentifier, addr 0x2670d0c, size 0x8, virtual true, abstract: false, final false
