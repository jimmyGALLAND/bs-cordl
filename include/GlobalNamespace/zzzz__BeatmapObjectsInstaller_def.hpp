...
/// @brief Field _burstSliderHeadNotePrefab, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderHeadNotePrefab, put=__cordl_internal_set__burstSliderHeadNotePrefab)) ::UnityW<::GlobalNamespace::GameNoteController>  _burstSliderHeadNotePrefab;

/// @brief Field _burstSliderNotePrefab, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderNotePrefab, put=__cordl_internal_set__burstSliderNotePrefab)) ::UnityW<::GlobalNamespace::BurstSliderGameNoteController>  _burstSliderNotePrefab;
...
/// @brief Field _noteLineConnectionControllerPrefab, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__noteLineConnectionControllerPrefab, put=__cordl_internal_set__noteLineConnectionControllerPrefab)) ::UnityW<::GlobalNamespace::NoteLineConnectionController>  _noteLineConnectionControllerPrefab;
...
/// @brief Method InstallBindings, addr 0x3b5cb48, size 0x478, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b5cfc0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
