...
public:
// Declarations
/// @brief Method .ctor, addr 0x229d154, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field _synchronizedActionQueue, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__synchronizedActionQueue, put=__cordl_internal_set__synchronizedActionQueue)) ::System::Collections::Generic::List_1<::GlobalNamespace::__SynchronizedActionQueue__SynchronizedAction>*  _synchronizedActionQueue;

/// @brief Method Clear, addr 0x229d02c, size 0x70, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method EnqueueAction, addr 0x229d09c, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x229d160, size 0x114, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__SynchronizedActionQueue__SynchronizedAction>*> const& __cordl_internal_get__synchronizedActionQueue() const;
...
/// @brief Method .ctor, addr 0x229d274, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
