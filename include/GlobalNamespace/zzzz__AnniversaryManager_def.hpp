...
/// @brief Method HandleMainMenuViewControllerDidFinish, addr 0x3a465a8, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method HandleMainMenuViewControllerPromoButtonWasPressed, addr 0x3a465cc, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3a4647c, size 0x12c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3a46368, size 0xf4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartFireworks, addr 0x3a4645c, size 0x20, virtual false, abstract: false, final false
inline void StartFireworks() ;

/// @brief Method StopFireworks, addr 0x3a465ac, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a465d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
