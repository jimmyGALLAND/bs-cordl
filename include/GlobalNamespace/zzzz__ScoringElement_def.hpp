...
namespace GlobalNamespace {
template<typename T>
class __ScoringElement__Pool_1;
}
namespace System {
template<typename T>
class IComparable_1;
...
// Declarations
template<typename T>
using Pool_1 = ::GlobalNamespace::__ScoringElement__Pool_1<T>;
...
/// @brief Method CompareTo, addr 0x3b58fb8, size 0x88, virtual true, abstract: false, final true
inline int32_t CompareTo(::GlobalNamespace::ScoringElement*  other) ;

static inline ::GlobalNamespace::ScoringElement* New_ctor() ;

/// @brief Method Reinitialize, addr 0x3b59040, size 0x4, virtual true, abstract: false, final false
inline void Reinitialize() ;

/// @brief Method SetMultipliers, addr 0x3b5879c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b59044, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_isFinished, addr 0x3b58fa4, size 0x8, virtual false, abstract: false, final false
inline bool get_isFinished() ;

/// @brief Method get_maxMultiplier, addr 0x3b58f94, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxMultiplier() ;

/// @brief Method get_maxPossibleCutScore, addr 0x3b587a4, size 0x74, virtual false, abstract: false, final false
inline int32_t get_maxPossibleCutScore() ;

/// @brief Method get_multiplier, addr 0x3b58f84, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_noteData, addr 0x3b58f74, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::NoteData* get_noteData() ;

/// @brief Method get_time, addr 0x3b58780, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method set_isFinished, addr 0x3b58fac, size 0xc, virtual false, abstract: false, final false
inline void set_isFinished(bool  value) ;

/// @brief Method set_maxMultiplier, addr 0x3b58f9c, size 0x8, virtual false, abstract: false, final false
inline void set_maxMultiplier(int32_t  value) ;

/// @brief Method set_multiplier, addr 0x3b58f8c, size 0x8, virtual false, abstract: false, final false
inline void set_multiplier(int32_t  value) ;

/// @brief Method set_noteData, addr 0x3b58f7c, size 0x8, virtual false, abstract: false, final false
