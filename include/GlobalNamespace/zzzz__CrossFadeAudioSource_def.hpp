...
/// @brief Method Awake, addr 0x3a4bc50, size 0x154, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CrossFade, addr 0x3a4be7c, size 0x1cc, virtual false, abstract: false, final false
inline void CrossFade(float_t  toSongTime, float_t  toVolume) ;

/// @brief Method InterruptLastPitchGainEffect, addr 0x3a4be64, size 0x18, virtual false, abstract: false, final false
inline void InterruptLastPitchGainEffect() ;

static inline ::GlobalNamespace::CrossFadeAudioSource* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3a4bda4, size 0x88, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Play, addr 0x3a4c048, size 0x1c, virtual false, abstract: false, final false
inline void Play() ;

/// @brief Method PlayPitchGainEffect, addr 0x3a4be2c, size 0x38, virtual false, abstract: false, final false
inline void PlayPitchGainEffect(float_t  volumeScale) ;

/// @brief Method Stop, addr 0x3a4c064, size 0x50, virtual false, abstract: false, final false
inline void Stop() ;

/// @brief Method <Awake>b__21_0, addr 0x3a4c0c8, size 0x1c, virtual false, abstract: false, final false
inline void _Awake_b__21_0(float_t  val) ;

/// @brief Method <Awake>b__21_1, addr 0x3a4c0e4, size 0x1c, virtual false, abstract: false, final false
inline void _Awake_b__21_1(float_t  val) ;

/// @brief Method <CrossFade>b__25_0, addr 0x3a4c100, size 0x1c, virtual false, abstract: false, final false
inline void _CrossFade_b__25_0(float_t  val) ;

/// @brief Method <CrossFade>b__25_1, addr 0x3a4c11c, size 0x1c, virtual false, abstract: false, final false
inline void _CrossFade_b__25_1(float_t  val) ;

/// @brief Method <CrossFade>b__25_2, addr 0x3a4c138, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a4c0b4, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_clip, addr 0x3a4bb58, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::AudioClip> get_clip() ;

/// @brief Method get_isPlaying, addr 0x3a4bc34, size 0x1c, virtual false, abstract: false, final false
inline bool get_isPlaying() ;

/// @brief Method set_clip, addr 0x3a4bb74, size 0x40, virtual false, abstract: false, final false
inline void set_clip(::UnityEngine::AudioClip*  value) ;

/// @brief Method set_pitch, addr 0x3a4bbb4, size 0x40, virtual false, abstract: false, final false
inline void set_pitch(float_t  value) ;

/// @brief Method set_time, addr 0x3a4bbf4, size 0x40, virtual false, abstract: false, final false
