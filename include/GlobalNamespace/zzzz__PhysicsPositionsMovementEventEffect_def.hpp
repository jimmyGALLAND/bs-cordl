...
/// @brief Method HandleBeatmapEvent, addr 0x3b037dc, size 0x7c, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

/// @brief Method HandleSongTimeFixedUpdate, addr 0x3b03690, size 0xdc, virtual false, abstract: false, final false
inline void HandleSongTimeFixedUpdate(float_t  fixedDeltaTime) ;

/// @brief Method HandleSongTimeUpdate, addr 0x3b0376c, size 0x70, virtual false, abstract: false, final false
inline void HandleSongTimeUpdate() ;

static inline ::GlobalNamespace::PhysicsPositionsMovementEventEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b03550, size 0x140, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b0330c, size 0x244, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b03858, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
