...
/// @brief Method Render, addr 0x3ff4b5c, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ff4b94, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;
