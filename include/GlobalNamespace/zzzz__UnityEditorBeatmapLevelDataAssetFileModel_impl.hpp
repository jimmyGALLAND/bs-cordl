...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::GlobalNamespace::BeatmapLevelDataSO> (*)(::StringW)>(&::GlobalNamespace::UnityEditorBeatmapLevelDataAssetFileModel::LoadBeatmapLevelDataFromAssetDatabase)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x26b33ec;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::UnityEditorBeatmapLevelDataAssetFileModel*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::GlobalNamespace::BeatmapLevelSO> (*)(::StringW)>(&::GlobalNamespace::UnityEditorBeatmapLevelDataAssetFileModel::LoadBeatmapLevelFromAssetDatabase)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x26b3460;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::GlobalNamespace::BeatmapLevelPackSO> (*)(::StringW)>(&::GlobalNamespace::UnityEditorBeatmapLevelDataAssetFileModel::LoadBeatmapLevelPackFromAssetDatabase)> {
  constexpr static std::size_t size = 0x74;
  constexpr static std::size_t addrs = 0x26b34d4;
...
return ::cordl_internals::RunMethodRethrow<::UnityW<::GlobalNamespace::BeatmapLevelDataSO>, false>(nullptr, ___internal_method, levelId);
}
...
return ::cordl_internals::RunMethodRethrow<::UnityW<::GlobalNamespace::BeatmapLevelSO>, false>(nullptr, ___internal_method, levelId);
}
...
template<typename T>
inline ::ArrayW<T,::Array<T>*> GlobalNamespace::UnityEditorBeatmapLevelDataAssetFileModel::LoadAllAssetsFromAssetDatabase()  {
...
return ::cordl_internals::RunMethodRethrow<T, false>(nullptr, ___internal_method, filename);
}
// Ctor Parameters []
