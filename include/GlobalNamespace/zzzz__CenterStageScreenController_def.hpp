...
/// @brief Field _countdownMenuLightsPreset, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__countdownMenuLightsPreset, put=__cordl_internal_set__countdownMenuLightsPreset)) ::UnityW<::GlobalNamespace::MenuLightsPresetSO>  _countdownMenuLightsPreset;
...
/// @brief Field _defaultMenuLightsPreset, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__defaultMenuLightsPreset, put=__cordl_internal_set__defaultMenuLightsPreset)) ::UnityW<::GlobalNamespace::MenuLightsPresetSO>  _defaultMenuLightsPreset;
...
/// @brief Field _multiplayerLobbyCenterScreenLayoutAnimator, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerLobbyCenterScreenLayoutAnimator, put=__cordl_internal_set__multiplayerLobbyCenterScreenLayoutAnimator)) ::UnityW<::GlobalNamespace::MultiplayerLobbyCenterScreenLayoutAnimator>  _multiplayerLobbyCenterScreenLayoutAnimator;

 __declspec(property(get=get_countdownShown, put=set_countdownShown)) bool  countdownShown;

/// @brief Method HandleLobbyGameStateControllerSelectedLevelGameplaySetupDataChanged, addr 0x3b897d0, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method Hide, addr 0x3b89590, size 0x138, virtual false, abstract: false, final false
inline void Hide() ;

/// @brief Method HideCountdown, addr 0x3b896c8, size 0x44, virtual false, abstract: false, final false
inline void HideCountdown(bool  instant) ;

static inline ::GlobalNamespace::CenterStageScreenController* New_ctor() ;

/// @brief Method SetCountdownEndTime, addr 0x3b89748, size 0x58, virtual false, abstract: false, final false
inline void SetCountdownEndTime(int64_t  countdownEndTime) ;

/// @brief Method SetNextGameplaySetupData, addr 0x3b8942c, size 0x164, virtual false, abstract: false, final false
inline void SetNextGameplaySetupData(::GlobalNamespace::ILevelGameplaySetupData*  levelGameplaySetupData) ;

/// @brief Method Setup, addr 0x3b89244, size 0x30, virtual false, abstract: false, final false
inline void Setup(bool  showModifiers) ;

/// @brief Method Show, addr 0x3b89274, size 0x188, virtual false, abstract: false, final false
inline void Show() ;

/// @brief Method ShowCountdown, addr 0x3b8970c, size 0x3c, virtual false, abstract: false, final false
inline void ShowCountdown(int64_t  countdownEndTime) ;

/// @brief Method ShowCountdownColorPreset, addr 0x3b897a0, size 0x30, virtual false, abstract: false, final false
inline void ShowCountdownColorPreset(bool  animated) ;

/// @brief Method ShowLobbyColorPreset, addr 0x3b893fc, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_countdownShown, addr 0x3b89230, size 0x8, virtual false, abstract: false, final false
inline bool get_countdownShown() ;

/// @brief Method set_countdownShown, addr 0x3b89238, size 0xc, virtual false, abstract: false, final false
