...
/// @brief Field _promotedBeatmapLevelPacksSet, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__promotedBeatmapLevelPacksSet, put=__cordl_internal_set__promotedBeatmapLevelPacksSet)) ::System::Collections::Generic::HashSet_1<::StringW>*  _promotedBeatmapLevelPacksSet;

/// @brief Field _promotedBeatmapLevelsSet, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__promotedBeatmapLevelsSet, put=__cordl_internal_set__promotedBeatmapLevelsSet)) ::System::Collections::Generic::HashSet_1<::StringW>*  _promotedBeatmapLevelsSet;

/// @brief Field _updatedBeatmapLevelPacksSet, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__updatedBeatmapLevelPacksSet, put=__cordl_internal_set__updatedBeatmapLevelPacksSet)) ::System::Collections::Generic::HashSet_1<::StringW>*  _updatedBeatmapLevelPacksSet;

/// @brief Field _updatedBeatmapLevelsSet, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__updatedBeatmapLevelsSet, put=__cordl_internal_set__updatedBeatmapLevelsSet)) ::System::Collections::Generic::HashSet_1<::StringW>*  _updatedBeatmapLevelsSet;

/// @brief Method IsBeatmapLevelPackPromoted, addr 0x26a8a74, size 0x5c, virtual false, abstract: false, final false
inline bool IsBeatmapLevelPackPromoted(::GlobalNamespace::BeatmapLevelPack*  beatmapLevelPack) ;

/// @brief Method IsBeatmapLevelPackUpdated, addr 0x26a8ad0, size 0x5c, virtual false, abstract: false, final false
inline bool IsBeatmapLevelPackUpdated(::GlobalNamespace::BeatmapLevelPack*  beatmapLevelPack) ;

/// @brief Method IsBeatmapLevelPromoted, addr 0x26a8b2c, size 0x5c, virtual false, abstract: false, final false
inline bool IsBeatmapLevelPromoted(::GlobalNamespace::BeatmapLevel*  beatmapLevel) ;

/// @brief Method IsBeatmapLevelUpdated, addr 0x26a8b88, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26a8958, size 0x11c, virtual false, abstract: false, final false
