...
/// @brief Method .ctor, addr 0x3b55f00, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _propertyTintColorPairs, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__propertyTintColorPairs, put=__cordl_internal_set__propertyTintColorPairs)) ::ArrayW<::GlobalNamespace::__SetSaberGlowColor__PropertyTintColorPair*,::Array<::GlobalNamespace::__SetSaberGlowColor__PropertyTintColorPair*>*>  _propertyTintColorPairs;
...
/// @brief Method SetColors, addr 0x3b55d64, size 0x114, virtual false, abstract: false, final false
inline void SetColors() ;

/// @brief Method Start, addr 0x3b55e78, size 0x80, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::ArrayW<::GlobalNamespace::__SetSaberGlowColor__PropertyTintColorPair*,::Array<::GlobalNamespace::__SetSaberGlowColor__PropertyTintColorPair*>*> const& __cordl_internal_get__propertyTintColorPairs() const;

constexpr ::ArrayW<::GlobalNamespace::__SetSaberGlowColor__PropertyTintColorPair*,::Array<::GlobalNamespace::__SetSaberGlowColor__PropertyTintColorPair*>*>& __cordl_internal_get__propertyTintColorPairs() ;
...
constexpr void __cordl_internal_set__propertyTintColorPairs(::ArrayW<::GlobalNamespace::__SetSaberGlowColor__PropertyTintColorPair*,::Array<::GlobalNamespace::__SetSaberGlowColor__PropertyTintColorPair*>*>  value) ;
...
/// @brief Method .ctor, addr 0x3b55ef8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_saberType, addr 0x3b55850, size 0xc, virtual false, abstract: false, final false
