...
/// @brief Method Dispose, addr 0x227f6b8, size 0xa4, virtual true, abstract: false, final true
inline void Dispose() ;

static inline ::GlobalNamespace::HealthCheckService* New_ctor(int32_t  port) ;

/// @brief Method PollUpdate, addr 0x227f75c, size 0x94, virtual true, abstract: false, final true
inline void PollUpdate() ;

/// @brief Method Run, addr 0x227f7f0, size 0x4a0, virtual false, abstract: false, final false
inline void Run() ;
...
/// @brief Method .ctor, addr 0x227f5c4, size 0xf4, virtual false, abstract: false, final false
