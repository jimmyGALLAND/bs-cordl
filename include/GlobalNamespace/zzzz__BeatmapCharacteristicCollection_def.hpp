...
/// @brief Method GetBeatmapCharacteristicBySerializedName, addr 0x2667ea8, size 0x70, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>>*> const& __cordl_internal_get__beatmapCharacteristicsBySerializedName() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>>*> const& __cordl_internal_get_beatmapCharacteristics() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>>*> const& __cordl_internal_get_disabledBeatmapCharacteristics() const;
...
/// @brief Method .ctor, addr 0x2667988, size 0x520, virtual false, abstract: false, final false
