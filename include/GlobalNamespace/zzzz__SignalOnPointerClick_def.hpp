...
/// @brief Method OnPointerClick, addr 0x3943e9c, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3943ebc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
