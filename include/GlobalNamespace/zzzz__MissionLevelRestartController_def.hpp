...
/// @brief Method RestartLevel, addr 0x3b1b238, size 0xac, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b1b2e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
