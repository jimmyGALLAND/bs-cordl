...
/// @brief Method ColorForSaberType, addr 0x3a7dfbc, size 0x54, virtual false, abstract: false, final false
inline ::UnityEngine::Color ColorForSaberType(::GlobalNamespace::SaberType  type) ;

/// @brief Method ColorForType, addr 0x3a7df48, size 0x74, virtual false, abstract: false, final false
inline ::UnityEngine::Color ColorForType(::GlobalNamespace::ColorType  type) ;

/// @brief Method ColorForType, addr 0x3a7de5c, size 0xec, virtual false, abstract: false, final false
inline ::UnityEngine::Color ColorForType(::GlobalNamespace::EnvironmentColorType  type, bool  boost) ;

/// @brief Method EffectsColorForSaberType, addr 0x3a7e010, size 0x90, virtual false, abstract: false, final false
inline ::UnityEngine::Color EffectsColorForSaberType(::GlobalNamespace::SaberType  type) ;

/// @brief Method GetObstacleEffectColor, addr 0x3a7e0a0, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Color GetObstacleEffectColor() ;

static inline ::GlobalNamespace::ColorManager* New_ctor() ;

/// @brief Method SetColorScheme, addr 0x3a7de54, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a7e0fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_obstaclesColor, addr 0x3a7de34, size 0x20, virtual false, abstract: false, final false
