...
/// @brief Method Initialize, addr 0x3fa93ec, size 0x224, virtual false, abstract: false, final false
inline void Initialize() ;

static inline ::GlobalNamespace::OVRMixedRealityCaptureTest* New_ctor() ;

/// @brief Method Start, addr 0x3fa933c, size 0xb0, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3fa9a20, size 0x764, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateDefaultExternalCamera, addr 0x3fa9610, size 0x410, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3faa184, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
