...
public:
// Declarations
/// @brief Method Approximately, addr 0x26d618c, size 0x60, virtual false, abstract: false, final false
static inline bool Approximately(::UnityEngine::Pose  a, ::UnityEngine::Pose  b) ;

/// @brief Method Approximately, addr 0x26d6000, size 0xd4, virtual false, abstract: false, final false
static inline bool Approximately(::UnityEngine::Quaternion  a, ::UnityEngine::Quaternion  b) ;

/// @brief Method Approximately, addr 0x26d6154, size 0x38, virtual false, abstract: false, final false
static inline bool Approximately(::UnityEngine::Vector3  a, ::UnityEngine::Vector3  b) ;

/// @brief Method Approximately, addr 0x26d60d4, size 0x10, virtual false, abstract: false, final false
static inline bool Approximately(float_t  a, float_t  b, float_t  epsilon) ;

/// @brief Method Approximately, addr 0x26d60e4, size 0x70, virtual false, abstract: false, final false
static inline bool Approximately(int32_t  a, int32_t  b, int32_t  epsilon) ;

/// @brief Method QuantizedVectorComponentToString, addr 0x26d61ec, size 0x100, virtual false, abstract: false, final false
