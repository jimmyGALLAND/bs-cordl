...
/// @brief Field _loadedMultiplayerEnvironmentInfo, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__loadedMultiplayerEnvironmentInfo, put=__cordl_internal_set__loadedMultiplayerEnvironmentInfo)) ::UnityW<::GlobalNamespace::EnvironmentInfoSO>  _loadedMultiplayerEnvironmentInfo;

/// @brief Field _multiplayerEnvironmentInfo, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerEnvironmentInfo, put=__cordl_internal_set__multiplayerEnvironmentInfo)) ::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*  _multiplayerEnvironmentInfo;
...
/// @brief Method Finish, addr 0x3ab1ed8, size 0x28, virtual false, abstract: false, final false
inline void Finish(::GlobalNamespace::MultiplayerResultsData*  resultsData) ;

/// @brief Method FinishWithDisconnect, addr 0x3ab1f00, size 0x28, virtual false, abstract: false, final false
inline void FinishWithDisconnect(::GlobalNamespace::DisconnectedReason  disconnectedReason) ;

/// @brief Method GetOrLoadMultiplayerEnvironmentInfo, addr 0x3ab1abc, size 0xf8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> GetOrLoadMultiplayerEnvironmentInfo() ;

/// @brief Method Init, addr 0x3aafff8, size 0x1dc, virtual false, abstract: false, final false
...
/// @brief Method InitAndSetupScenes, addr 0x3ab1c38, size 0x2a0, virtual false, abstract: false, final false
inline void InitAndSetupScenes() ;

/// @brief Method InitColorInfo, addr 0x3ab1bb4, size 0x84, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*> const& __cordl_internal_get__multiplayerEnvironmentInfo() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO>,::GlobalNamespace::DisconnectedReason>*> const& __cordl_internal_get_didDisconnectEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO>,::GlobalNamespace::MultiplayerResultsData*>*> const& __cordl_internal_get_didFinishEvent() const;
...
/// @brief Method .ctor, addr 0x3ab1f28, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didDisconnectEvent, addr 0x3aae6f8, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method add_didFinishEvent, addr 0x3aae648, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_beatmapKey, addr 0x3ab1a50, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapKey get_beatmapKey() ;

/// @brief Method get_beatmapLevel, addr 0x3ab1a78, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevel* get_beatmapLevel() ;

/// @brief Method get_beatmapLevelData, addr 0x3ab1aac, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::IBeatmapLevelData* get_beatmapLevelData() ;

/// @brief Method get_colorScheme, addr 0x3ab1a9c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorScheme* get_colorScheme() ;

/// @brief Method get_gameMode, addr 0x3ab1a40, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_gameMode() ;

/// @brief Method get_usingOverrideColorScheme, addr 0x3ab1a88, size 0x8, virtual false, abstract: false, final false
inline bool get_usingOverrideColorScheme() ;

/// @brief Method remove_didDisconnectEvent, addr 0x3aaebd8, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_didFinishEvent, addr 0x3aaeb28, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method set_beatmapKey, addr 0x3ab1a64, size 0x14, virtual false, abstract: false, final false
inline void set_beatmapKey(::GlobalNamespace::BeatmapKey  value) ;

/// @brief Method set_beatmapLevel, addr 0x3ab1a80, size 0x8, virtual false, abstract: false, final false
inline void set_beatmapLevel(::GlobalNamespace::BeatmapLevel*  value) ;

/// @brief Method set_beatmapLevelData, addr 0x3ab1ab4, size 0x8, virtual false, abstract: false, final false
inline void set_beatmapLevelData(::GlobalNamespace::IBeatmapLevelData*  value) ;

/// @brief Method set_colorScheme, addr 0x3ab1aa4, size 0x8, virtual false, abstract: false, final false
inline void set_colorScheme(::GlobalNamespace::ColorScheme*  value) ;

/// @brief Method set_gameMode, addr 0x3ab1a48, size 0x8, virtual false, abstract: false, final false
inline void set_gameMode(::StringW  value) ;

/// @brief Method set_usingOverrideColorScheme, addr 0x3ab1a90, size 0xc, virtual false, abstract: false, final false
