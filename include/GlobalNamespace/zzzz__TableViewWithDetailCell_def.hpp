...
/// @brief Field didDeselectContentCellEvent, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didDeselectContentCellEvent, put=__cordl_internal_set_didDeselectContentCellEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::TableViewWithDetailCell>,int32_t>*  didDeselectContentCellEvent;

/// @brief Field didSelectContentCellEvent, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didSelectContentCellEvent, put=__cordl_internal_set_didSelectContentCellEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::TableViewWithDetailCell>,int32_t>*  didSelectContentCellEvent;

/// @brief Convert operator to "::HMUI::__TableView__IDataSource"
constexpr operator  ::HMUI::__TableView__IDataSource*() noexcept;

/// @brief Method CellForIdx, addr 0x3964878, size 0x1e0, virtual true, abstract: false, final true
inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView*  tableView, int32_t  idx) ;

/// @brief Method CellSize, addr 0x3964724, size 0xa0, virtual true, abstract: false, final true
inline float_t CellSize(int32_t  idx) ;

/// @brief Method DidSelectCellWithIdx, addr 0x3964abc, size 0x130, virtual true, abstract: false, final false
inline void DidSelectCellWithIdx(int32_t  idx) ;

static inline ::GlobalNamespace::TableViewWithDetailCell* New_ctor() ;

/// @brief Method NumberOfCells, addr 0x39647c4, size 0xb4, virtual true, abstract: false, final true
inline int32_t NumberOfCells() ;

/// @brief Method ReloadData, addr 0x3964a58, size 0x28, virtual true, abstract: false, final false
inline void ReloadData() ;

/// @brief Method ReloadData, addr 0x3964a80, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3964bec, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didDeselectContentCellEvent, addr 0x3964594, size 0xb0, virtual false, abstract: false, final false
inline void add_didDeselectContentCellEvent(::System::Action_2<::UnityW<::GlobalNamespace::TableViewWithDetailCell>,int32_t>*  value) ;

/// @brief Method add_didSelectContentCellEvent, addr 0x3964434, size 0xb0, virtual false, abstract: false, final false
inline void add_didSelectContentCellEvent(::System::Action_2<::UnityW<::GlobalNamespace::TableViewWithDetailCell>,int32_t>*  value) ;

/// @brief Method get_dataSource, addr 0x39646f4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method remove_didDeselectContentCellEvent, addr 0x3964644, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_didSelectContentCellEvent, addr 0x39644e4, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method set_dataSource, addr 0x39646fc, size 0x28, virtual false, abstract: false, final false
