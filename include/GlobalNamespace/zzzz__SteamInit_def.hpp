...
public:
// Declarations
/// @brief Method InitializeInternalAsync, addr 0x26cf188, size 0x68, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<bool>* InitializeInternalAsync() ;

static inline ::GlobalNamespace::SteamInit* New_ctor() ;

/// @brief Method .ctor, addr 0x26cf1f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
