...
/// @brief Field <activePlayerSpotsCount>k__BackingField, offset 0x14, size 0x4 
 __declspec(property(get=__cordl_internal_get__activePlayerSpotsCount_k__BackingField, put=__cordl_internal_set__activePlayerSpotsCount_k__BackingField)) int32_t  _activePlayerSpotsCount_k__BackingField;
...
/// @brief Field playersLayoutWasCalculatedEvent, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_playersLayoutWasCalculatedEvent, put=__cordl_internal_set_playersLayoutWasCalculatedEvent)) ::System::Action_2<::GlobalNamespace::MultiplayerPlayerLayout,int32_t>*  playersLayoutWasCalculatedEvent;

/// @brief Method CalculateLayout, addr 0x3b40164, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b401c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_playersLayoutWasCalculatedEvent, addr 0x3b40004, size 0xb0, virtual false, abstract: false, final false
inline void add_playersLayoutWasCalculatedEvent(::System::Action_2<::GlobalNamespace::MultiplayerPlayerLayout,int32_t>*  value) ;

/// @brief Method get_activePlayerSpotsCount, addr 0x3b3fff4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_activePlayerSpotsCount() ;

/// @brief Method get_layout, addr 0x3b3ffe4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MultiplayerPlayerLayout get_layout() ;

/// @brief Method remove_playersLayoutWasCalculatedEvent, addr 0x3b400b4, size 0xb0, virtual false, abstract: false, final false
inline void remove_playersLayoutWasCalculatedEvent(::System::Action_2<::GlobalNamespace::MultiplayerPlayerLayout,int32_t>*  value) ;

/// @brief Method set_activePlayerSpotsCount, addr 0x3b3fffc, size 0x8, virtual false, abstract: false, final false
inline void set_activePlayerSpotsCount(int32_t  value) ;

/// @brief Method set_layout, addr 0x3b3ffec, size 0x8, virtual false, abstract: false, final false
