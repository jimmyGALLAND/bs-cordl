...
/// @brief Method ButtonPressed, addr 0x3adca64, size 0x8c, virtual false, abstract: false, final false
inline void ButtonPressed(bool  success) ;

/// @brief Method DidActivate, addr 0x3adc944, size 0x120, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

static inline ::GlobalNamespace::JoinQuickPlayViewController* New_ctor() ;

/// @brief Method Setup, addr 0x3adc8b4, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method <DidActivate>b__12_0, addr 0x3adcaf8, size 0x8, virtual false, abstract: false, final false
inline void _DidActivate_b__12_0() ;

/// @brief Method <DidActivate>b__12_1, addr 0x3adcb00, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3adcaf0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x3adc74c, size 0xb0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_1<bool>*  value) ;

/// @brief Method get_multiplayerModeSettings, addr 0x3adc8ac, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MultiplayerModeSettings* get_multiplayerModeSettings() ;

/// @brief Method remove_didFinishEvent, addr 0x3adc7fc, size 0xb0, virtual false, abstract: false, final false
