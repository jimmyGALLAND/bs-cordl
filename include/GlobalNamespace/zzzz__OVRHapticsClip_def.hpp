...
/// @brief Method InitializeFromAudioFloatTrack, addr 0x3f24944, size 0x334, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x3f24c78, size 0x8, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method WriteSample, addr 0x3f2431c, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f2449c, size 0x100, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3f24660, size 0x20c, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRHapticsClip*  a, ::GlobalNamespace::OVRHapticsClip*  b) ;

/// @brief Method .ctor, addr 0x3f2486c, size 0xd8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::AudioClip*  audioClip, int32_t  channel) ;

/// @brief Method .ctor, addr 0x3f24244, size 0xd8, virtual false, abstract: false, final false
inline void _ctor(int32_t  capacity) ;

/// @brief Method .ctor, addr 0x3f2459c, size 0xc4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  samples, int32_t  samplesCount) ;

/// @brief Method get_Capacity, addr 0x3f2447c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Capacity() ;

/// @brief Method get_Count, addr 0x3f2446c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Samples, addr 0x3f2448c, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Samples() ;

/// @brief Method set_Capacity, addr 0x3f24484, size 0x8, virtual false, abstract: false, final false
inline void set_Capacity(int32_t  value) ;

/// @brief Method set_Count, addr 0x3f24474, size 0x8, virtual false, abstract: false, final false
inline void set_Count(int32_t  value) ;

/// @brief Method set_Samples, addr 0x3f24494, size 0x8, virtual false, abstract: false, final false
