...
/// @brief Field _burnParticleSystemEmissionModule, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__burnParticleSystemEmissionModule, put=__cordl_internal_set__burnParticleSystemEmissionModule)) ::UnityEngine::__ParticleSystem__EmissionModule  _burnParticleSystemEmissionModule;
...
/// @brief Field _sparkleParticleSystemEmissionModule, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__sparkleParticleSystemEmissionModule, put=__cordl_internal_set__sparkleParticleSystemEmissionModule)) ::UnityEngine::__ParticleSystem__EmissionModule  _sparkleParticleSystemEmissionModule;

 __declspec(property(put=set_color)) ::UnityEngine::Color  color;

/// @brief Method Awake, addr 0x3b01500, size 0x5c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method IsEmitting, addr 0x3b015d4, size 0xc, virtual false, abstract: false, final false
inline bool IsEmitting() ;

static inline ::GlobalNamespace::ObstacleSaberSparkleEffect* New_ctor() ;

/// @brief Method SetPositionAndRotation, addr 0x3b0155c, size 0x78, virtual false, abstract: false, final false
inline void SetPositionAndRotation(::UnityEngine::Vector3  pos, ::UnityEngine::Quaternion  rot) ;

/// @brief Method StartEmission, addr 0x3b015e0, size 0x54, virtual false, abstract: false, final false
inline void StartEmission() ;

/// @brief Method StopEmission, addr 0x3b01634, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b0169c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_color, addr 0x3b01404, size 0xfc, virtual false, abstract: false, final false
