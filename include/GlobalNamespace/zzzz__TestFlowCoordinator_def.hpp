...
/// @brief Method DidActivate, addr 0x3ac69c8, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ac69e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
