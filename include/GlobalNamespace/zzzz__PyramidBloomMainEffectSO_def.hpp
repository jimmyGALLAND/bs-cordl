...
/// @brief Method LazyInitializeMaterials, addr 0x3ff145c, size 0x124, virtual false, abstract: false, final false
inline void LazyInitializeMaterials() ;

static inline ::GlobalNamespace::PyramidBloomMainEffectSO* New_ctor() ;

/// @brief Method OnDisable, addr 0x3ff1580, size 0x30, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3ff1440, size 0x1c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method PreRender, addr 0x3ff15b0, size 0x64, virtual true, abstract: false, final false
inline void PreRender() ;

/// @brief Method Render, addr 0x3ff1614, size 0x27c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ff1890, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_hasPostProcessEffect, addr 0x3ff1438, size 0x8, virtual true, abstract: false, final false
