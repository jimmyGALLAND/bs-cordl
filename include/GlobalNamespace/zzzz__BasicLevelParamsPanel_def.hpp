...
/// @brief Method .ctor, addr 0x3a740ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_bpm, addr 0x3a740a4, size 0x48, virtual false, abstract: false, final false
inline void set_bpm(float_t  value) ;

/// @brief Method set_duration, addr 0x3a74070, size 0x34, virtual false, abstract: false, final false
