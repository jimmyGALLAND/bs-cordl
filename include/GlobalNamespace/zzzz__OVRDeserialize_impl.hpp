...
constexpr ::GlobalNamespace::__OVRDeserialize__SpatialAnchorCreateCompleteData::__OVRDeserialize__SpatialAnchorCreateCompleteData(uint64_t  RequestId, int32_t  Result, uint64_t  Space, ::System::Guid  Uuid) noexcept  {
this->RequestId = RequestId;
this->Result = Result;
this->Space = Space;
this->Uuid = Uuid;
...
// Ctor Parameters [CppParam { name: "RequestId", ty: "uint64_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Result", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Space", ty: "uint64_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Uuid", ty: "::System::Guid", modifiers: "", def_value: Some("{}") }, CppParam { name: "ComponentType", ty: "::GlobalNamespace::__OVRPlugin__SpaceComponentType", modifiers: "", def_value: Some("{}") }, CppParam { name: "Enabled", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::__OVRDeserialize__SpaceSetComponentStatusCompleteData::__OVRDeserialize__SpaceSetComponentStatusCompleteData(uint64_t  RequestId, int32_t  Result, uint64_t  Space, ::System::Guid  Uuid, ::GlobalNamespace::__OVRPlugin__SpaceComponentType  ComponentType, int32_t  Enabled) noexcept  {
this->RequestId = RequestId;
this->Result = Result;
this->Space = Space;
this->Uuid = Uuid;
...
// Ctor Parameters [CppParam { name: "RequestId", ty: "uint64_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Result", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "Uuid", ty: "::System::Guid", modifiers: "", def_value: Some("{}") }, CppParam { name: "Location", ty: "::GlobalNamespace::__OVRPlugin__SpaceStorageLocation", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::__OVRDeserialize__SpaceEraseCompleteData::__OVRDeserialize__SpaceEraseCompleteData(uint64_t  RequestId, int32_t  Result, ::System::Guid  Uuid, ::GlobalNamespace::__OVRPlugin__SpaceStorageLocation  Location) noexcept  {
this->RequestId = RequestId;
this->Result = Result;
this->Uuid = Uuid;
...
template<typename T>
inline T GlobalNamespace::OVRDeserialize::ByteArrayToStructure(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes)  {
