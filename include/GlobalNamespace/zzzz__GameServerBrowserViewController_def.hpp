...
/// @brief Field _gameServersListTableView, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameServersListTableView, put=__cordl_internal_set__gameServersListTableView)) ::UnityW<::GlobalNamespace::GameServersListTableView>  _gameServersListTableView;
...
/// @brief Method .ctor, addr 0x3adc2d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
