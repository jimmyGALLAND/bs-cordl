...
class CORDL_TYPE MultiplayerConnectedPlayerDisappearingArrowController : public ::GlobalNamespace::DisappearingArrowControllerBase_1<::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>> {
public:
// Declarations
/// @brief Field _gameNoteController, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameNoteController, put=__cordl_internal_set__gameNoteController)) ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>  _gameNoteController;
...
/// @brief Method .ctor, addr 0x3b25114, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_gameNoteController, addr 0x3b2510c, size 0x8, virtual true, abstract: false, final false
