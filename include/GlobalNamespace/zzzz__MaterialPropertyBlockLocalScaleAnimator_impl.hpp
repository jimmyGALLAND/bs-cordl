...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MaterialPropertyBlockLocalScaleAnimator::*)()>(&::GlobalNamespace::MaterialPropertyBlockLocalScaleAnimator::SetProperty)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x39630bc;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MaterialPropertyBlockLocalScaleAnimator*>::get(),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MaterialPropertyBlockLocalScaleAnimator*>::get(),
                                  4
                                ));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MaterialPropertyBlockLocalScaleAnimator::*)()>(&::GlobalNamespace::MaterialPropertyBlockLocalScaleAnimator::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3963114;
