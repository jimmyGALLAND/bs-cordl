...
/// @brief Method LazyInitializeMaterials, addr 0x3ff0660, size 0xbc, virtual false, abstract: false, final false
inline void LazyInitializeMaterials() ;

static inline ::GlobalNamespace::KawaseBloomMainEffectSO* New_ctor() ;

/// @brief Method OnDisable, addr 0x3ff071c, size 0x20, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3ff0644, size 0x1c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method PreRender, addr 0x3ff073c, size 0x64, virtual true, abstract: false, final false
inline void PreRender() ;

/// @brief Method Render, addr 0x3ff0828, size 0x210, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ff0a38, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_hasPostProcessEffect, addr 0x3ff063c, size 0x8, virtual true, abstract: false, final false
