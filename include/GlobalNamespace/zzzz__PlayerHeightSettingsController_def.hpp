...
/// @brief Method AutoSetHeight, addr 0x3b7dc90, size 0x114, virtual false, abstract: false, final false
inline void AutoSetHeight() ;

/// @brief Method Awake, addr 0x3b7db20, size 0xc0, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Init, addr 0x3b7dbe0, size 0x8, virtual false, abstract: false, final false
inline void Init(float_t  playerHeight) ;

static inline ::GlobalNamespace::PlayerHeightSettingsController* New_ctor() ;

/// @brief Method RefreshUI, addr 0x3b7dbe8, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b7dda4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_valueDidChangeEvent, addr 0x3b7d9b8, size 0xb0, virtual false, abstract: false, final false
inline void add_valueDidChangeEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method get_value, addr 0x3b7db18, size 0x8, virtual false, abstract: false, final false
inline float_t get_value() ;

/// @brief Method remove_valueDidChangeEvent, addr 0x3b7da68, size 0xb0, virtual false, abstract: false, final false
