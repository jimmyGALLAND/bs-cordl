...
/// @brief Field <platform>k__BackingField, offset 0x30, size 0x1 
 __declspec(property(get=__cordl_internal_get__platform_k__BackingField, put=__cordl_internal_set__platform_k__BackingField)) ::GlobalNamespace::__AuthenticationToken__Platform  _platform_k__BackingField;
...
/// @brief Method GetAuthenticationToken, addr 0x3b99ce4, size 0xa0, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::AuthenticationToken>* GetAuthenticationToken() ;

/// @brief Method GetTokenPlatform, addr 0x3b99d84, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method GetXPlatformAccessToken, addr 0x3b99d8c, size 0x74, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b99bc0, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method get_hashedUserId, addr 0x3b99ba8, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_hashedUserId() ;

/// @brief Method get_platform, addr 0x3b99bb8, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::__AuthenticationToken__Platform get_platform() ;

/// @brief Method get_userName, addr 0x3b99bb0, size 0x8, virtual true, abstract: false, final true
