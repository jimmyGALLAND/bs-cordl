...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::*)()>(&::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::Start)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x3962ea8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter*>::get(),
                        "Start",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::*)()>(&::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::OnValidate)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x3962fa8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::*)()>(&::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::RefreshPropertyId)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x3962ecc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::*)()>(&::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::ApplyParams)> {
  constexpr static std::size_t size = 0xbc;
  constexpr static std::size_t addrs = 0x3962eec;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::*)()>(&::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::_ctor)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x3962fcc;
...
constexpr ::UnityW<::GlobalNamespace::MaterialPropertyBlockController> const& GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::__cordl_internal_get__materialPropertyBlockController() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____materialPropertyBlockController;
}
constexpr void GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::__cordl_internal_set__materialPropertyBlockController(::UnityW<::GlobalNamespace::MaterialPropertyBlockController>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::ArrayW<::UnityEngine::MaterialPropertyBlock*,::Array<::UnityEngine::MaterialPropertyBlock*>*>& GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::__cordl_internal_get__materialPropertyBlocks()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____materialPropertyBlocks;
}
constexpr ::ArrayW<::UnityEngine::MaterialPropertyBlock*,::Array<::UnityEngine::MaterialPropertyBlock*>*> const& GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::__cordl_internal_get__materialPropertyBlocks() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____materialPropertyBlocks;
}
constexpr void GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter::__cordl_internal_set__materialPropertyBlocks(::ArrayW<::UnityEngine::MaterialPropertyBlock*,::Array<::UnityEngine::MaterialPropertyBlock*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
