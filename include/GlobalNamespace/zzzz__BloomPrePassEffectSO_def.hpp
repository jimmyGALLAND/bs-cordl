...
/// @brief Method .ctor, addr 0x3955b04, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_fov, addr 0x3955aec, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::Vector2 get_fov() ;

/// @brief Method get_linesWidth, addr 0x3955af4, size 0x8, virtual true, abstract: false, final true
inline float_t get_linesWidth() ;

/// @brief Method get_textureEffect, addr 0x3955ad8, size 0x4, virtual true, abstract: false, final true
inline ::UnityW<::GlobalNamespace::TextureEffectSO> get_textureEffect() ;

/// @brief Method get_textureHeight, addr 0x3955ae4, size 0x8, virtual true, abstract: false, final true
inline int32_t get_textureHeight() ;

/// @brief Method get_textureWidth, addr 0x3955adc, size 0x8, virtual true, abstract: false, final true
inline int32_t get_textureWidth() ;

/// @brief Method get_toneMapping, addr 0x3955afc, size 0x8, virtual true, abstract: false, final false
