...
/// @brief Method Dispose, addr 0x3b35a0c, size 0xd0, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method FindPlayerToMirror, addr 0x3b35c2c, size 0x39c, virtual false, abstract: false, final false
inline void FindPlayerToMirror() ;

/// @brief Method HandleOptionalAvatarDataReceived, addr 0x3b35fc8, size 0x1dc, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x3b35a08, size 0x4, virtual true, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::MockPlayerLobbyPoseGeneratorMirror* New_ctor(::GlobalNamespace::IMultiplayerSessionManager*  multiplayerSessionManager, ::GlobalNamespace::NodePoseSyncStateManager*  nodePoseSyncStateManager) ;

/// @brief Method Tick, addr 0x3b35adc, size 0x150, virtual true, abstract: false, final false
inline void Tick() ;
...
/// @brief Method .ctor, addr 0x3b3381c, size 0x178, virtual false, abstract: false, final false
