...
/// @brief Field <capturingCameraDevice>k__BackingField, offset 0x6c, size 0x4 
 __declspec(property(get=__cordl_internal_get__capturingCameraDevice_k__BackingField, put=__cordl_internal_set__capturingCameraDevice_k__BackingField)) ::GlobalNamespace::__OVRManager__CameraDevice  _capturingCameraDevice_k__BackingField;
...
/// @brief Field <chromaKeySmoothRange>k__BackingField, offset 0x94, size 0x4 
 __declspec(property(get=__cordl_internal_get__chromaKeySmoothRange_k__BackingField, put=__cordl_internal_set__chromaKeySmoothRange_k__BackingField)) float_t  _chromaKeySmoothRange_k__BackingField;
...
/// @brief Field <compositionMethod>k__BackingField, offset 0x48, size 0x4 
 __declspec(property(get=__cordl_internal_get__compositionMethod_k__BackingField, put=__cordl_internal_set__compositionMethod_k__BackingField)) ::GlobalNamespace::__OVRManager__CompositionMethod  _compositionMethod_k__BackingField;

/// @brief Field <depthQuality>k__BackingField, offset 0xa0, size 0x4 
 __declspec(property(get=__cordl_internal_get__depthQuality_k__BackingField, put=__cordl_internal_set__depthQuality_k__BackingField)) ::GlobalNamespace::__OVRManager__DepthQuality  _depthQuality_k__BackingField;
...
/// @brief Field <dynamicLightingDepthVariationClampingValue>k__BackingField, offset 0xa8, size 0x4 
 __declspec(property(get=__cordl_internal_get__dynamicLightingDepthVariationClampingValue_k__BackingField, put=__cordl_internal_set__dynamicLightingDepthVariationClampingValue_k__BackingField)) float_t  _dynamicLightingDepthVariationClampingValue_k__BackingField;

/// @brief Field <dynamicLightingSmoothFactor>k__BackingField, offset 0xa4, size 0x4 
 __declspec(property(get=__cordl_internal_get__dynamicLightingSmoothFactor_k__BackingField, put=__cordl_internal_set__dynamicLightingSmoothFactor_k__BackingField)) float_t  _dynamicLightingSmoothFactor_k__BackingField;
...
/// @brief Field <externalCompositionBackdropColorQuest>k__BackingField, offset 0x5c, size 0x10 
 __declspec(property(get=__cordl_internal_get__externalCompositionBackdropColorQuest_k__BackingField, put=__cordl_internal_set__externalCompositionBackdropColorQuest_k__BackingField)) ::UnityEngine::Color  _externalCompositionBackdropColorQuest_k__BackingField;

/// @brief Field <externalCompositionBackdropColorRift>k__BackingField, offset 0x4c, size 0x10 
 __declspec(property(get=__cordl_internal_get__externalCompositionBackdropColorRift_k__BackingField, put=__cordl_internal_set__externalCompositionBackdropColorRift_k__BackingField)) ::UnityEngine::Color  _externalCompositionBackdropColorRift_k__BackingField;

/// @brief Field <extraHiddenLayers>k__BackingField, offset 0x3c, size 0x4 
 __declspec(property(get=__cordl_internal_get__extraHiddenLayers_k__BackingField, put=__cordl_internal_set__extraHiddenLayers_k__BackingField)) ::UnityEngine::LayerMask  _extraHiddenLayers_k__BackingField;

/// @brief Field <extraVisibleLayers>k__BackingField, offset 0x40, size 0x4 
 __declspec(property(get=__cordl_internal_get__extraVisibleLayers_k__BackingField, put=__cordl_internal_set__extraVisibleLayers_k__BackingField)) ::UnityEngine::LayerMask  _extraVisibleLayers_k__BackingField;

/// @brief Field <flipCameraFrameHorizontally>k__BackingField, offset 0x70, size 0x1 
 __declspec(property(get=__cordl_internal_get__flipCameraFrameHorizontally_k__BackingField, put=__cordl_internal_set__flipCameraFrameHorizontally_k__BackingField)) bool  _flipCameraFrameHorizontally_k__BackingField;

/// @brief Field <flipCameraFrameVertically>k__BackingField, offset 0x71, size 0x1 
 __declspec(property(get=__cordl_internal_get__flipCameraFrameVertically_k__BackingField, put=__cordl_internal_set__flipCameraFrameVertically_k__BackingField)) bool  _flipCameraFrameVertically_k__BackingField;

/// @brief Field <handPoseStateLatency>k__BackingField, offset 0x74, size 0x4 
 __declspec(property(get=__cordl_internal_get__handPoseStateLatency_k__BackingField, put=__cordl_internal_set__handPoseStateLatency_k__BackingField)) float_t  _handPoseStateLatency_k__BackingField;

/// @brief Field _instantiateMixedRealityBackgroundCameraGameObject, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__instantiateMixedRealityBackgroundCameraGameObject, put=__cordl_internal_set__instantiateMixedRealityBackgroundCameraGameObject)) ::System::Func_2<::UnityW<::UnityEngine::GameObject>,::UnityW<::UnityEngine::GameObject>>*  _instantiateMixedRealityBackgroundCameraGameObject;

/// @brief Field _instantiateMixedRealityCameraGameObject, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get__instantiateMixedRealityCameraGameObject, put=__cordl_internal_set__instantiateMixedRealityCameraGameObject)) ::GlobalNamespace::__OVRManager__InstantiateMrcCameraDelegate*  _instantiateMixedRealityCameraGameObject;

/// @brief Field _instantiateMixedRealityForegroundCameraGameObject, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__instantiateMixedRealityForegroundCameraGameObject, put=__cordl_internal_set__instantiateMixedRealityForegroundCameraGameObject)) ::System::Func_2<::UnityW<::UnityEngine::GameObject>,::UnityW<::UnityEngine::GameObject>>*  _instantiateMixedRealityForegroundCameraGameObject;

/// @brief Field <mrcActivationMode>k__BackingField, offset 0xc0, size 0x4 
 __declspec(property(get=__cordl_internal_get__mrcActivationMode_k__BackingField, put=__cordl_internal_set__mrcActivationMode_k__BackingField)) ::GlobalNamespace::__OVRManager__MrcActivationMode  _mrcActivationMode_k__BackingField;

/// @brief Field <sandwichCompositionBufferedFrames>k__BackingField, offset 0x7c, size 0x4 
 __declspec(property(get=__cordl_internal_get__sandwichCompositionBufferedFrames_k__BackingField, put=__cordl_internal_set__sandwichCompositionBufferedFrames_k__BackingField)) int32_t  _sandwichCompositionBufferedFrames_k__BackingField;

/// @brief Field <sandwichCompositionRenderLatency>k__BackingField, offset 0x78, size 0x4 
 __declspec(property(get=__cordl_internal_get__sandwichCompositionRenderLatency_k__BackingField, put=__cordl_internal_set__sandwichCompositionRenderLatency_k__BackingField)) float_t  _sandwichCompositionRenderLatency_k__BackingField;
...
/// @brief Field <virtualGreenScreenApplyDepthCulling>k__BackingField, offset 0xb8, size 0x1 
 __declspec(property(get=__cordl_internal_get__virtualGreenScreenApplyDepthCulling_k__BackingField, put=__cordl_internal_set__virtualGreenScreenApplyDepthCulling_k__BackingField)) bool  _virtualGreenScreenApplyDepthCulling_k__BackingField;

/// @brief Field <virtualGreenScreenBottomY>k__BackingField, offset 0xb4, size 0x4 
 __declspec(property(get=__cordl_internal_get__virtualGreenScreenBottomY_k__BackingField, put=__cordl_internal_set__virtualGreenScreenBottomY_k__BackingField)) float_t  _virtualGreenScreenBottomY_k__BackingField;

/// @brief Field <virtualGreenScreenDepthTolerance>k__BackingField, offset 0xbc, size 0x4 
 __declspec(property(get=__cordl_internal_get__virtualGreenScreenDepthTolerance_k__BackingField, put=__cordl_internal_set__virtualGreenScreenDepthTolerance_k__BackingField)) float_t  _virtualGreenScreenDepthTolerance_k__BackingField;

/// @brief Field <virtualGreenScreenTopY>k__BackingField, offset 0xb0, size 0x4 
 __declspec(property(get=__cordl_internal_get__virtualGreenScreenTopY_k__BackingField, put=__cordl_internal_set__virtualGreenScreenTopY_k__BackingField)) float_t  _virtualGreenScreenTopY_k__BackingField;

/// @brief Field <virtualGreenScreenType>k__BackingField, offset 0xac, size 0x4 
 __declspec(property(get=__cordl_internal_get__virtualGreenScreenType_k__BackingField, put=__cordl_internal_set__virtualGreenScreenType_k__BackingField)) ::GlobalNamespace::__OVRManager__VirtualGreenScreenType  _virtualGreenScreenType_k__BackingField;
...
/// @brief Field _vrPlatformHelper, offset 0x20, size 0x8 
 ...
 __declspec(property(get=get_instantiateMixedRealityCameraGameObject, put=set_instantiateMixedRealityCameraGameObject)) ::GlobalNamespace::__OVRManager__InstantiateMrcCameraDelegate*  instantiateMixedRealityCameraGameObject;
...
/// @brief Method Init, addr 0x3946b94, size 0x160, virtual false, abstract: false, final false
inline void Init(::System::Func_2<::UnityW<::UnityEngine::GameObject>,::UnityW<::UnityEngine::GameObject>>*  instantiateMixedRealityBackgroundCameraGameObject, ::System::Func_2<::UnityW<::UnityEngine::GameObject>,::UnityW<::UnityEngine::GameObject>>*  instantiateMixedRealityForegroundCameraGameObject) ;

/// @brief Method InstantiateMixedRealityCameraGameObject, addr 0x3946cf4, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3946b3c, size 0x58, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Update, addr 0x3946ac8, size 0x74, virtual false, abstract: false, final false
inline void Update() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::UnityW<::UnityEngine::GameObject>,::UnityW<::UnityEngine::GameObject>>*> const& __cordl_internal_get__instantiateMixedRealityBackgroundCameraGameObject() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::UnityW<::UnityEngine::GameObject>,::UnityW<::UnityEngine::GameObject>>*> const& __cordl_internal_get__instantiateMixedRealityForegroundCameraGameObject() const;
...
/// @brief Method .ctor, addr 0x3946d28, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_capturingCameraDevice, addr 0x39468ec, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::__OVRManager__CameraDevice get_capturingCameraDevice() ;

/// @brief Method get_chromaKeyColor, addr 0x3946954, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Color get_chromaKeyColor() ;

/// @brief Method get_chromaKeySimilarity, addr 0x394696c, size 0x8, virtual true, abstract: false, final true
inline float_t get_chromaKeySimilarity() ;

/// @brief Method get_chromaKeySmoothRange, addr 0x394697c, size 0x8, virtual true, abstract: false, final true
inline float_t get_chromaKeySmoothRange() ;

/// @brief Method get_chromaKeySpillRange, addr 0x394698c, size 0x8, virtual true, abstract: false, final true
inline float_t get_chromaKeySpillRange() ;

/// @brief Method get_compositionMethod, addr 0x39468ac, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::__OVRManager__CompositionMethod get_compositionMethod() ;

/// @brief Method get_depthQuality, addr 0x39469b0, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::__OVRManager__DepthQuality get_depthQuality() ;

/// @brief Method get_dynamicCullingMask, addr 0x3946898, size 0x8, virtual true, abstract: false, final true
inline bool get_dynamicCullingMask() ;

/// @brief Method get_dynamicLightingDepthVariationClampingValue, addr 0x39469d0, size 0x8, virtual true, abstract: false, final true
inline float_t get_dynamicLightingDepthVariationClampingValue() ;

/// @brief Method get_dynamicLightingSmoothFactor, addr 0x39469c0, size 0x8, virtual true, abstract: false, final true
inline float_t get_dynamicLightingSmoothFactor() ;

/// @brief Method get_enableMixedReality, addr 0x3946864, size 0x8, virtual true, abstract: false, final true
inline bool get_enableMixedReality() ;

/// @brief Method get_externalCompositionBackdropColorQuest, addr 0x39468d4, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Color get_externalCompositionBackdropColorQuest() ;

/// @brief Method get_externalCompositionBackdropColorRift, addr 0x39468bc, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Color get_externalCompositionBackdropColorRift() ;

/// @brief Method get_extraHiddenLayers, addr 0x3946878, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::LayerMask get_extraHiddenLayers() ;

/// @brief Method get_extraVisibleLayers, addr 0x3946888, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::LayerMask get_extraVisibleLayers() ;

/// @brief Method get_flipCameraFrameHorizontally, addr 0x39468fc, size 0x8, virtual true, abstract: false, final true
inline bool get_flipCameraFrameHorizontally() ;

/// @brief Method get_flipCameraFrameVertically, addr 0x3946910, size 0x8, virtual true, abstract: false, final true
inline bool get_flipCameraFrameVertically() ;

/// @brief Method get_handPoseStateLatency, addr 0x3946924, size 0x8, virtual true, abstract: false, final true
inline float_t get_handPoseStateLatency() ;

/// @brief Method get_instantiateMixedRealityCameraGameObject, addr 0x3946a44, size 0x80, virtual true, abstract: false, final true
inline ::GlobalNamespace::__OVRManager__InstantiateMrcCameraDelegate* get_instantiateMixedRealityCameraGameObject() ;

/// @brief Method get_mrcActivationMode, addr 0x3946a34, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::__OVRManager__MrcActivationMode get_mrcActivationMode() ;

/// @brief Method get_sandwichCompositionBufferedFrames, addr 0x3946944, size 0x8, virtual true, abstract: false, final true
inline int32_t get_sandwichCompositionBufferedFrames() ;

/// @brief Method get_sandwichCompositionRenderLatency, addr 0x3946934, size 0x8, virtual true, abstract: false, final true
inline float_t get_sandwichCompositionRenderLatency() ;

/// @brief Method get_useDynamicLighting, addr 0x394699c, size 0x8, virtual true, abstract: false, final true
inline bool get_useDynamicLighting() ;

/// @brief Method get_virtualGreenScreenApplyDepthCulling, addr 0x3946a10, size 0x8, virtual true, abstract: false, final true
inline bool get_virtualGreenScreenApplyDepthCulling() ;

/// @brief Method get_virtualGreenScreenBottomY, addr 0x3946a00, size 0x8, virtual true, abstract: false, final true
inline float_t get_virtualGreenScreenBottomY() ;

/// @brief Method get_virtualGreenScreenDepthTolerance, addr 0x3946a24, size 0x8, virtual true, abstract: false, final true
inline float_t get_virtualGreenScreenDepthTolerance() ;

/// @brief Method get_virtualGreenScreenTopY, addr 0x39469f0, size 0x8, virtual true, abstract: false, final true
inline float_t get_virtualGreenScreenTopY() ;

/// @brief Method get_virtualGreenScreenType, addr 0x39469e0, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_capturingCameraDevice, addr 0x39468f4, size 0x8, virtual true, abstract: false, final true
inline void set_capturingCameraDevice(::GlobalNamespace::__OVRManager__CameraDevice  value) ;

/// @brief Method set_chromaKeyColor, addr 0x3946960, size 0xc, virtual true, abstract: false, final true
inline void set_chromaKeyColor(::UnityEngine::Color  value) ;

/// @brief Method set_chromaKeySimilarity, addr 0x3946974, size 0x8, virtual true, abstract: false, final true
inline void set_chromaKeySimilarity(float_t  value) ;

/// @brief Method set_chromaKeySmoothRange, addr 0x3946984, size 0x8, virtual true, abstract: false, final true
inline void set_chromaKeySmoothRange(float_t  value) ;

/// @brief Method set_chromaKeySpillRange, addr 0x3946994, size 0x8, virtual true, abstract: false, final true
inline void set_chromaKeySpillRange(float_t  value) ;

/// @brief Method set_compositionMethod, addr 0x39468b4, size 0x8, virtual true, abstract: false, final true
inline void set_compositionMethod(::GlobalNamespace::__OVRManager__CompositionMethod  value) ;

/// @brief Method set_depthQuality, addr 0x39469b8, size 0x8, virtual true, abstract: false, final true
inline void set_depthQuality(::GlobalNamespace::__OVRManager__DepthQuality  value) ;

/// @brief Method set_dynamicCullingMask, addr 0x39468a0, size 0xc, virtual true, abstract: false, final true
inline void set_dynamicCullingMask(bool  value) ;

/// @brief Method set_dynamicLightingDepthVariationClampingValue, addr 0x39469d8, size 0x8, virtual true, abstract: false, final true
inline void set_dynamicLightingDepthVariationClampingValue(float_t  value) ;

/// @brief Method set_dynamicLightingSmoothFactor, addr 0x39469c8, size 0x8, virtual true, abstract: false, final true
inline void set_dynamicLightingSmoothFactor(float_t  value) ;

/// @brief Method set_enableMixedReality, addr 0x394686c, size 0xc, virtual true, abstract: false, final true
inline void set_enableMixedReality(bool  value) ;

/// @brief Method set_externalCompositionBackdropColorQuest, addr 0x39468e0, size 0xc, virtual true, abstract: false, final true
inline void set_externalCompositionBackdropColorQuest(::UnityEngine::Color  value) ;

/// @brief Method set_externalCompositionBackdropColorRift, addr 0x39468c8, size 0xc, virtual true, abstract: false, final true
inline void set_externalCompositionBackdropColorRift(::UnityEngine::Color  value) ;

/// @brief Method set_extraHiddenLayers, addr 0x3946880, size 0x8, virtual true, abstract: false, final true
inline void set_extraHiddenLayers(::UnityEngine::LayerMask  value) ;

/// @brief Method set_extraVisibleLayers, addr 0x3946890, size 0x8, virtual true, abstract: false, final true
inline void set_extraVisibleLayers(::UnityEngine::LayerMask  value) ;

/// @brief Method set_flipCameraFrameHorizontally, addr 0x3946904, size 0xc, virtual true, abstract: false, final true
inline void set_flipCameraFrameHorizontally(bool  value) ;

/// @brief Method set_flipCameraFrameVertically, addr 0x3946918, size 0xc, virtual true, abstract: false, final true
inline void set_flipCameraFrameVertically(bool  value) ;

/// @brief Method set_handPoseStateLatency, addr 0x394692c, size 0x8, virtual true, abstract: false, final true
inline void set_handPoseStateLatency(float_t  value) ;

/// @brief Method set_instantiateMixedRealityCameraGameObject, addr 0x3946ac4, size 0x4, virtual true, abstract: false, final true
inline void set_instantiateMixedRealityCameraGameObject(::GlobalNamespace::__OVRManager__InstantiateMrcCameraDelegate*  value) ;

/// @brief Method set_mrcActivationMode, addr 0x3946a3c, size 0x8, virtual true, abstract: false, final true
inline void set_mrcActivationMode(::GlobalNamespace::__OVRManager__MrcActivationMode  value) ;

/// @brief Method set_sandwichCompositionBufferedFrames, addr 0x394694c, size 0x8, virtual true, abstract: false, final true
inline void set_sandwichCompositionBufferedFrames(int32_t  value) ;

/// @brief Method set_sandwichCompositionRenderLatency, addr 0x394693c, size 0x8, virtual true, abstract: false, final true
inline void set_sandwichCompositionRenderLatency(float_t  value) ;

/// @brief Method set_useDynamicLighting, addr 0x39469a4, size 0xc, virtual true, abstract: false, final true
inline void set_useDynamicLighting(bool  value) ;

/// @brief Method set_virtualGreenScreenApplyDepthCulling, addr 0x3946a18, size 0xc, virtual true, abstract: false, final true
inline void set_virtualGreenScreenApplyDepthCulling(bool  value) ;

/// @brief Method set_virtualGreenScreenBottomY, addr 0x3946a08, size 0x8, virtual true, abstract: false, final true
inline void set_virtualGreenScreenBottomY(float_t  value) ;

/// @brief Method set_virtualGreenScreenDepthTolerance, addr 0x3946a2c, size 0x8, virtual true, abstract: false, final true
inline void set_virtualGreenScreenDepthTolerance(float_t  value) ;

/// @brief Method set_virtualGreenScreenTopY, addr 0x39469f8, size 0x8, virtual true, abstract: false, final true
inline void set_virtualGreenScreenTopY(float_t  value) ;

/// @brief Method set_virtualGreenScreenType, addr 0x39469e8, size 0x8, virtual true, abstract: false, final true
