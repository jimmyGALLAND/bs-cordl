...
/// @brief Method Awake, addr 0x3a49ea4, size 0x20, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::AudioListenerController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3a49ec4, size 0xc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Pause, addr 0x3a49ed0, size 0xc, virtual false, abstract: false, final false
inline void Pause() ;

/// @brief Method Resume, addr 0x3a49edc, size 0xc, virtual false, abstract: false, final false
inline void Resume() ;
...
/// @brief Method .ctor, addr 0x3a49ee8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isPaused, addr 0x3a49e9c, size 0x8, virtual false, abstract: false, final false
