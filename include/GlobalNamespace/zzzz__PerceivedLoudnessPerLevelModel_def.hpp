...
/// @brief Field _loudnessLevelPerLevelId, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__loudnessLevelPerLevelId, put=__cordl_internal_set__loudnessLevelPerLevelId)) ::System::Collections::Generic::Dictionary_2<::StringW,float_t>*  _loudnessLevelPerLevelId;

/// @brief Method GetLoudnessByLevelId, addr 0x26869a0, size 0x7c, virtual false, abstract: false, final false
inline float_t GetLoudnessByLevelId(::StringW  levelId) ;

/// @brief Method GetLoudnessByLevelIdOrNull, addr 0x2686a34, size 0xa8, virtual false, abstract: false, final false
inline ::System::Nullable_1<float_t> GetLoudnessByLevelIdOrNull(::StringW  levelId) ;

/// @brief Method GetLoudnessCorrectionByLevelId, addr 0x2686980, size 0x20, virtual false, abstract: false, final false
inline float_t GetLoudnessCorrectionByLevelId(::StringW  levelId) ;

/// @brief Method GetMaxSfxVolumeByLevelId, addr 0x2686a1c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2686388, size 0x5f8, virtual false, abstract: false, final false
