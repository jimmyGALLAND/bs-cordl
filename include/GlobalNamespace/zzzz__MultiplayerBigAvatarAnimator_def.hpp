...
/// @brief Method Animate, addr 0x3b227f4, size 0x1d4, virtual false, abstract: false, final false
inline void Animate(bool  show, float_t  duration, ::GlobalNamespace::EaseType  easeType) ;

/// @brief Method HideInstant, addr 0x3b22b18, size 0xa8, virtual false, abstract: false, final false
inline void HideInstant() ;

/// @brief Method InitIfNeeded, addr 0x3b369c4, size 0x1c8, virtual false, abstract: false, final false
inline void InitIfNeeded() ;

static inline ::GlobalNamespace::MultiplayerBigAvatarAnimator* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b3693c, size 0x88, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetPositionAndRotation, addr 0x3b36b8c, size 0x78, virtual false, abstract: false, final false
inline void SetPositionAndRotation(::UnityEngine::Vector3  position, ::UnityEngine::Quaternion  rotation) ;

/// @brief Method <InitIfNeeded>b__8_0, addr 0x3b36c14, size 0x78, virtual false, abstract: false, final false
inline void _InitIfNeeded_b__8_0(float_t  val) ;

/// @brief Method <InitIfNeeded>b__8_1, addr 0x3b36c8c, size 0x78, virtual false, abstract: false, final false
inline void _InitIfNeeded_b__8_1(float_t  val) ;

/// @brief Method <InitIfNeeded>b__8_2, addr 0x3b36d04, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b36c04, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
