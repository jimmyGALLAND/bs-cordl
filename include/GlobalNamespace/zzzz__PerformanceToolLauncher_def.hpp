...
// Ctor Parameters [CppParam { name: "visualizer", ty: "::UnityW<::GlobalNamespace::PerformanceVisualizer>", modifiers: "", def_value: None }, CppParam { name: "recorder", ty: "::UnityW<::GlobalNamespace::PerformanceRecorder>", modifiers: "", def_value: None }]
...
/// @brief Method <Run>g__HandleSongControllerSongDidFinish|1, addr 0x3a99ac0, size 0xa4, virtual false, abstract: false, final false
inline void _Run_g__HandleSongControllerSongDidFinish_1() ;

/// @brief Method <Run>g__HandleSongControllerSongDidStart|0, addr 0x3a99a1c, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a999c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x3a999c8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
