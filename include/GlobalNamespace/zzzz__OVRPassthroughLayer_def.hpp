...
// Type: ::Settings
// SizeInfo { instance_size: 48, native_size: -1, calculated_instance_size: 48, calculated_native_size: 61, minimum_alignment: 8, packing: None, specified_packing: None }
namespace GlobalNamespace {
// Is value type: true
...
public:
// Declarations
/// @brief Method .ctor, addr 0x3f4a1b4, size 0x20, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "colorLutTargetTexture", ty: "::UnityW<::UnityEngine::Texture2D>", modifiers: "", def_value: None }, CppParam { name: "colorLutSourceTexture", ty: "::UnityW<::UnityEngine::Texture2D>", modifiers: "", def_value: None }, CppParam { name: "saturation", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "posterize", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "brightness", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "contrast", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "gradient", ty: "::UnityEngine::Gradient*", modifiers: "", def_value: None }, CppParam { name: "lutWeight", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "flipLutY", ty: "bool", modifiers: "", def_value: None }]
constexpr __OVRPassthroughLayer__Settings(::UnityW<::UnityEngine::Texture2D>  colorLutTargetTexture, ::UnityW<::UnityEngine::Texture2D>  colorLutSourceTexture, float_t  saturation, float_t  posterize, float_t  brightness, float_t  contrast, ::UnityEngine::Gradient*  gradient, float_t  lutWeight, bool  flipLutY) noexcept;
...
// Ctor Parameters [CppParam { name: "meshFilter", ty: "::UnityW<::UnityEngine::MeshFilter>", modifiers: "", def_value: None }, CppParam { name: "updateTransform", ty: "bool", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "gameObject", ty: "::UnityW<::UnityEngine::GameObject>", modifiers: "", def_value: None }, CppParam { name: "updateTransform", ty: "bool", modifiers: "", def_value: None }]
...
/// @brief Field _interpolatedLutHandler, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__interpolatedLutHandler, put=__cordl_internal_set__interpolatedLutHandler)) ::GlobalNamespace::__OVRPassthroughLayer__InterpolatedColorLutHandler*  _interpolatedLutHandler;
...
/// @brief Field _monoToMonoHandler, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__monoToMonoHandler, put=__cordl_internal_set__monoToMonoHandler)) ::GlobalNamespace::__OVRPassthroughLayer__MonoToMonoStyleHandler*  _monoToMonoHandler;

/// @brief Field _monoToRgbaHandler, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__monoToRgbaHandler, put=__cordl_internal_set__monoToRgbaHandler)) ::GlobalNamespace::__OVRPassthroughLayer__MonoToRgbaStyleHandler*  _monoToRgbaHandler;
...
/// @brief Method GetStyleHandler, addr 0x3f4a520, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method SetColorLutHandler, addr 0x3f47668, size 0x58, virtual false, abstract: false, final false
inline void SetColorLutHandler(::GlobalNamespace::OVRPassthroughColorLut*  lut, float_t  weight) ;

/// @brief Method SetInterpolatedColorLutHandler, addr 0x3f477dc, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method SetMonoToMonoHandler, addr 0x3f47c48, size 0x5c, virtual false, abstract: false, final false
inline void SetMonoToMonoHandler(::ArrayW<uint8_t,::Array<uint8_t>*>  values) ;

/// @brief Method SetMonoToRgbaHandler, addr 0x3f47498, size 0x34, virtual false, abstract: false, final false
inline void SetMonoToRgbaHandler(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  values) ;

/// @brief Method SetStyleHandler, addr 0x3f47fac, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f4a1d4, size 0x17c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyStyleSettings, addr 0x3f4a700, size 0x4, virtual true, abstract: false, final true
inline void ApplyStyleSettings(ByRef<::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2>  style) ;

/// @brief Method Clear, addr 0x3f4a708, size 0x4, virtual true, abstract: false, final true
inline void Clear() ;

static inline ::GlobalNamespace::__OVRPassthroughLayer__NoneStyleHandler* New_ctor() ;

/// @brief Method Update, addr 0x3f4a704, size 0x4, virtual true, abstract: false, final true
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;

/// @brief Method .ctor, addr 0x3f4a478, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsValid, addr 0x3f4a6f8, size 0x8, virtual true, abstract: false, final true
inline bool get_IsValid() ;
...
/// @brief Method AllocateColorMapData, addr 0x3f4a7bc, size 0x90, virtual true, abstract: false, final false
inline void AllocateColorMapData(uint32_t  size) ;

/// @brief Method ApplyStyleSettings, addr 0x3f4a748, size 0x68, virtual true, abstract: false, final false
inline void ApplyStyleSettings(ByRef<::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2>  style) ;

/// @brief Method Clear, addr 0x3f4a7b0, size 0xc, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method ComputeBrightnessContrastPosterizeMap, addr 0x3f4a918, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method DeallocateColorMapData, addr 0x3f4a84c, size 0x28, virtual true, abstract: false, final false
inline void DeallocateColorMapData() ;

static inline ::GlobalNamespace::__OVRPassthroughLayer__BaseGeneratedStyleHandler* New_ctor(ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method Update, addr 0x3f4a744, size 0x4, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;

/// @brief Method WriteColorToColorMap, addr 0x3f4a874, size 0x6c, virtual false, abstract: false, final false
inline void WriteColorToColorMap(int32_t  colorIndex, ByRef<::UnityEngine::Color>  color) ;

/// @brief Method WriteFloatToColorMap, addr 0x3f4a8e0, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f4a714, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_IsValid, addr 0x3f4a70c, size 0x8, virtual true, abstract: false, final true
inline bool get_IsValid() ;
...
/// @brief Method AllocateColorMapData, addr 0x3f4ab5c, size 0x68, virtual true, abstract: false, final false
inline void AllocateColorMapData(uint32_t  size) ;

/// @brief Method DeallocateColorMapData, addr 0x3f4abc4, size 0x2c, virtual true, abstract: false, final false
inline void DeallocateColorMapData() ;

static inline ::GlobalNamespace::__OVRPassthroughLayer__MonoToRgbaStyleHandler* New_ctor(ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method Update, addr 0x3f4aaa0, size 0xbc, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;

/// @brief Method Update, addr 0x3f4a640, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f4a4c0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method get_MapSize, addr 0x3f4aa98, size 0x8, virtual true, abstract: false, final false
inline uint32_t get_MapSize() ;
...
static inline ::GlobalNamespace::__OVRPassthroughLayer__MonoToMonoStyleHandler* New_ctor(ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method Update, addr 0x3f4abf8, size 0x38, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;

/// @brief Method Update, addr 0x3f4a6b4, size 0x44, virtual false, abstract: false, final false
inline void Update(::ArrayW<uint8_t,::Array<uint8_t>*>  values) ;

/// @brief Method .ctor, addr 0x3f4a490, size 0x30, virtual false, abstract: false, final false
inline void _ctor(ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method get_MapSize, addr 0x3f4abf0, size 0x8, virtual true, abstract: false, final false
inline uint32_t get_MapSize() ;
...
static inline ::GlobalNamespace::__OVRPassthroughLayer__BCSStyleHandler* New_ctor(ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method Update, addr 0x3f4ac38, size 0xb4, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;

/// @brief Method .ctor, addr 0x3f4a4f0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method get_MapSize, addr 0x3f4ac30, size 0x8, virtual true, abstract: false, final false
inline uint32_t get_MapSize() ;
...
/// @brief Field _currentColorLutSourceTexture, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__currentColorLutSourceTexture, put=__cordl_internal_set__currentColorLutSourceTexture)) ::UnityW<::UnityEngine::Texture2D>  _currentColorLutSourceTexture;
...
/// @brief Method ApplyStyleSettings, addr 0x3f4ad20, size 0x28, virtual true, abstract: false, final false
inline void ApplyStyleSettings(ByRef<::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2>  style) ;

/// @brief Method Clear, addr 0x3f4aef0, size 0x8, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method GetColorLutForTexture, addr 0x3f4ad9c, size 0x154, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPassthroughColorLut* GetColorLutForTexture(::UnityEngine::Texture2D*  newTexture, ::GlobalNamespace::OVRPassthroughColorLut*  lut, ByRef<::UnityEngine::Texture2D*>  lastTexture, bool  flipY) ;

static inline ::GlobalNamespace::__OVRPassthroughLayer__ColorLutHandler* New_ctor() ;

/// @brief Method Update, addr 0x3f4a5f8, size 0x20, virtual false, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughColorLut*  lut, float_t  weight) ;

/// @brief Method Update, addr 0x3f4ad48, size 0x54, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;
...
/// @brief Method .ctor, addr 0x3f4a480, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsValid, addr 0x3f4ad0c, size 0x8, virtual true, abstract: false, final true
inline bool get_IsValid() ;

/// @brief Method get_Lut, addr 0x3f4acec, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPassthroughColorLut* get_Lut() ;

/// @brief Method get_Weight, addr 0x3f4acfc, size 0x8, virtual false, abstract: false, final false
inline float_t get_Weight() ;

/// @brief Convert to "::GlobalNamespace::__OVRPassthroughLayer__IStyleHandler"
constexpr ::GlobalNamespace::__OVRPassthroughLayer__IStyleHandler* i___GlobalNamespace____OVRPassthroughLayer__IStyleHandler() noexcept;

/// @brief Method set_IsValid, addr 0x3f4ad14, size 0xc, virtual false, abstract: false, final false
inline void set_IsValid(bool  value) ;

/// @brief Method set_Lut, addr 0x3f4acf4, size 0x8, virtual false, abstract: false, final false
inline void set_Lut(::GlobalNamespace::OVRPassthroughColorLut*  value) ;

/// @brief Method set_Weight, addr 0x3f4ad04, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field <LutTarget>k__BackingField, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__LutTarget_k__BackingField, put=__cordl_internal_set__LutTarget_k__BackingField)) ::GlobalNamespace::OVRPassthroughColorLut*  _LutTarget_k__BackingField;

/// @brief Field _currentColorLutTargetTexture, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__currentColorLutTargetTexture, put=__cordl_internal_set__currentColorLutTargetTexture)) ::UnityW<::UnityEngine::Texture2D>  _currentColorLutTargetTexture;

/// @brief Method ApplyStyleSettings, addr 0x3f4af08, size 0x38, virtual true, abstract: false, final false
inline void ApplyStyleSettings(ByRef<::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2>  style) ;

/// @brief Method Clear, addr 0x3f4afbc, size 0xc, virtual true, abstract: false, final false
inline void Clear() ;

static inline ::GlobalNamespace::__OVRPassthroughLayer__InterpolatedColorLutHandler* New_ctor() ;

/// @brief Method Update, addr 0x3f4a618, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x3f4af40, size 0x7c, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;
...
/// @brief Method .ctor, addr 0x3f4a488, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_LutTarget, addr 0x3f4aef8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPassthroughColorLut* get_LutTarget() ;

/// @brief Method set_LutTarget, addr 0x3f4af00, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <IsSurfaceGeometry>b__0, addr 0x3f4afc8, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f4725c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <RemoveSurfaceGeometry>b__0, addr 0x3f4b034, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3f46fac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static __declspec(property(get=getStaticF__editorToColorMapType, put=setStaticF__editorToColorMapType)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__OVRPassthroughLayer__ColorMapEditorType,::GlobalNamespace::__OVRPlugin__InsightPassthroughColorMapType>*  _editorToColorMapType;
...
/// @brief Field deferredSurfaceGameObjects, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get_deferredSurfaceGameObjects, put=__cordl_internal_set_deferredSurfaceGameObjects)) ::System::Collections::Generic::List_1<::GlobalNamespace::__OVRPassthroughLayer__DeferredPassthroughMeshAddition>*  deferredSurfaceGameObjects;
...
/// @brief Field projectionSurfaceType, offset 0x20, size 0x4 
 __declspec(property(get=__cordl_internal_get_projectionSurfaceType, put=__cordl_internal_set_projectionSurfaceType)) ::GlobalNamespace::__OVRPassthroughLayer__ProjectionSurfaceType  projectionSurfaceType;

/// @brief Field serializedSurfaceGeometry, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get_serializedSurfaceGeometry, put=__cordl_internal_set_serializedSurfaceGeometry)) ::System::Collections::Generic::List_1<::GlobalNamespace::__OVRPassthroughLayer__SerializedSurfaceGeometry>*  serializedSurfaceGeometry;
...
/// @brief Field surfaceGameObjects, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get_surfaceGameObjects, put=__cordl_internal_set_surfaceGameObjects)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::__OVRPassthroughLayer__PassthroughMeshInstance>*  surfaceGameObjects;
...
/// @brief Method AddDeferredSurfaceGeometries, addr 0x3f4807c, size 0x248, virtual false, abstract: false, final false
inline void AddDeferredSurfaceGeometries() ;

/// @brief Method AddSurfaceGeometry, addr 0x3f46b94, size 0x1f8, virtual false, abstract: false, final false
inline void AddSurfaceGeometry(::UnityEngine::GameObject*  obj, bool  updateTransform) ;

/// @brief Method Awake, addr 0x3f49648, size 0x224, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ClampWeight, addr 0x3f475c8, size 0xa0, virtual false, abstract: false, final false
static inline float_t ClampWeight(float_t  weight) ;

/// @brief Method CreateAndAddMesh, addr 0x3f482c4, size 0x2bc, virtual false, abstract: false, final false
...
/// @brief Method CreateNeutralColorMapGradient, addr 0x3f479d8, size 0x1d0, virtual false, abstract: false, final false
static inline ::UnityEngine::Gradient* CreateNeutralColorMapGradient() ;

/// @brief Method CreateOvrPluginStyleObject, addr 0x3f499d8, size 0x128, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2 CreateOvrPluginStyleObject() ;

/// @brief Method DestroySurfaceGeometries, addr 0x3f48b64, size 0x27c, virtual false, abstract: false, final false
inline void DestroySurfaceGeometries(bool  addBackToDeferredQueue) ;

/// @brief Method DisableColorMap, addr 0x3f47f9c, size 0x8, virtual false, abstract: false, final false
inline void DisableColorMap() ;

/// @brief Method GetTransformMatrixForPassthroughSurfaceObject, addr 0x3f48580, size 0x320, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 GetTransformMatrixForPassthroughSurfaceObject(::UnityEngine::Matrix4x4  worldFromObj) ;

/// @brief Method HasControlsBasedColorMap, addr 0x3f49390, size 0x28, virtual false, abstract: false, final false
inline bool HasControlsBasedColorMap() ;

/// @brief Method IsSurfaceGeometry, addr 0x3f47144, size 0x118, virtual false, abstract: false, final false
inline bool IsSurfaceGeometry(::UnityEngine::GameObject*  obj) ;

/// @brief Method LateUpdate, addr 0x3f49870, size 0x168, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::OVRPassthroughLayer* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3f49f70, size 0x8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x3f49ea0, size 0xd0, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3f49d14, size 0x18c, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RemoveSurfaceGeometry, addr 0x3f46d8c, size 0x220, virtual false, abstract: false, final false
inline void RemoveSurfaceGeometry(::UnityEngine::GameObject*  obj) ;

/// @brief Method SetBrightnessContrastSaturation, addr 0x3f47ca4, size 0x4c, virtual false, abstract: false, final false
inline void SetBrightnessContrastSaturation(float_t  brightness, float_t  contrast, float_t  saturation) ;

/// @brief Method SetColorLut, addr 0x3f474cc, size 0xfc, virtual false, abstract: false, final false
inline void SetColorLut(::GlobalNamespace::OVRPassthroughColorLut*  lut, float_t  weight) ;

/// @brief Method SetColorLut, addr 0x3f476c0, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method SetColorMap, addr 0x3f47324, size 0x9c, virtual false, abstract: false, final false
inline void SetColorMap(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  values) ;

/// @brief Method SetColorMapControls, addr 0x3f47840, size 0x198, virtual false, abstract: false, final false
inline void SetColorMapControls(float_t  contrast, float_t  brightness, float_t  posterize, ::UnityEngine::Gradient*  gradient, ::GlobalNamespace::__OVRPassthroughLayer__ColorMapEditorType  colorMapType) ;

/// @brief Method SetColorMapMonochromatic, addr 0x3f47ba8, size 0xa0, virtual false, abstract: false, final false
inline void SetColorMapMonochromatic(::ArrayW<uint8_t,::Array<uint8_t>*>  values) ;

/// @brief Method SetStyleDirty, addr 0x3f48070, size 0xc, virtual false, abstract: false, final false
inline void SetStyleDirty() ;

/// @brief Method SyncToOverlay, addr 0x3f493b8, size 0x27c, virtual false, abstract: false, final false
inline void SyncToOverlay() ;

/// @brief Method Update, addr 0x3f4986c, size 0x4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateColorMapFromControls, addr 0x3f47cf0, size 0x2ac, virtual false, abstract: false, final false
inline void UpdateColorMapFromControls(bool  forceUpdate) ;

/// @brief Method UpdateSurfaceGeometryTransform, addr 0x3f490e0, size 0x1b0, virtual false, abstract: false, final false
inline void UpdateSurfaceGeometryTransform(uint64_t  instanceHandle, ::UnityEngine::Matrix4x4  localToWorld) ;

/// @brief Method UpdateSurfaceGeometryTransforms, addr 0x3f48de0, size 0x300, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__OVRPassthroughLayer__DeferredPassthroughMeshAddition>*> const& __cordl_internal_get_deferredSurfaceGameObjects() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__OVRPassthroughLayer__SerializedSurfaceGeometry>*> const& __cordl_internal_get_serializedSurfaceGeometry() const;

constexpr bool const& __cordl_internal_get_styleDirty() const;

constexpr bool& __cordl_internal_get_styleDirty() ;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::__OVRPassthroughLayer__PassthroughMeshInstance>*& __cordl_internal_get_surfaceGameObjects() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::__OVRPassthroughLayer__PassthroughMeshInstance>*> const& __cordl_internal_get_surfaceGameObjects() const;
...
constexpr void __cordl_internal_set_surfaceGameObjects(::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::__OVRPassthroughLayer__PassthroughMeshInstance>*  value) ;

constexpr void __cordl_internal_set_textureOpacity_(float_t  value) ;

/// @brief Method .ctor, addr 0x3f49f78, size 0x23c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__OVRPassthroughLayer__ColorMapEditorType,::GlobalNamespace::__OVRPlugin__InsightPassthroughColorMapType>* getStaticF__editorToColorMapType() ;

static inline ::UnityEngine::Gradient* getStaticF_colorMapNeutralGradient() ;

/// @brief Method get_colorMapEditorType, addr 0x3f47fa4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRPassthroughLayer__ColorMapEditorType get_colorMapEditorType() ;

/// @brief Method get_edgeColor, addr 0x3f472b4, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_edgeColor() ;

/// @brief Method get_edgeRenderingEnabled, addr 0x3f4728c, size 0x8, virtual false, abstract: false, final false
inline bool get_edgeRenderingEnabled() ;

/// @brief Method get_overlayShape, addr 0x3f49634, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVROverlay__OverlayShape get_overlayShape() ;

/// @brief Method get_textureOpacity, addr 0x3f47264, size 0x8, virtual false, abstract: false, final false
inline float_t get_textureOpacity() ;

static inline void setStaticF__editorToColorMapType(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__OVRPassthroughLayer__ColorMapEditorType,::GlobalNamespace::__OVRPlugin__InsightPassthroughColorMapType>*  value) ;

static inline void setStaticF_colorMapNeutralGradient(::UnityEngine::Gradient*  value) ;

/// @brief Method set_colorMapEditorType, addr 0x3f473c0, size 0xd8, virtual false, abstract: false, final false
inline void set_colorMapEditorType(::GlobalNamespace::__OVRPassthroughLayer__ColorMapEditorType  value) ;

/// @brief Method set_edgeColor, addr 0x3f472c4, size 0x60, virtual false, abstract: false, final false
inline void set_edgeColor(::UnityEngine::Color  value) ;

/// @brief Method set_edgeRenderingEnabled, addr 0x3f47294, size 0x20, virtual false, abstract: false, final false
inline void set_edgeRenderingEnabled(bool  value) ;

/// @brief Method set_textureOpacity, addr 0x3f4726c, size 0x20, virtual false, abstract: false, final false
