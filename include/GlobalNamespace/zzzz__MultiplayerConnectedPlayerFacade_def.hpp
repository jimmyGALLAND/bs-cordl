...
class CORDL_TYPE __MultiplayerConnectedPlayerFacade__Factory : public ::Zenject::PlaceholderFactory_3<::GlobalNamespace::IConnectedPlayer*,::GlobalNamespace::MultiplayerPlayerStartState,::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerFacade>> {
public:
// Declarations
static inline ::GlobalNamespace::__MultiplayerConnectedPlayerFacade__Factory* New_ctor() ;

/// @brief Method .ctor, addr 0x3b22a28, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _songTimeSyncController, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__songTimeSyncController, put=__cordl_internal_set__songTimeSyncController)) ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerSongTimeSyncController>  _songTimeSyncController;
...
/// @brief Method HideBigAvatar, addr 0x3b22768, size 0x8c, virtual false, abstract: false, final false
inline void HideBigAvatar() ;

static inline ::GlobalNamespace::MultiplayerConnectedPlayerFacade* New_ctor() ;

/// @brief Method PauseSpawning, addr 0x3b225e0, size 0xa4, virtual false, abstract: false, final false
inline void PauseSpawning() ;

/// @brief Method ResumeSpawning, addr 0x3b22684, size 0xa4, virtual false, abstract: false, final false
inline void ResumeSpawning() ;

/// @brief Method SetSongStartSyncTime, addr 0x3b22488, size 0x18, virtual false, abstract: false, final false
inline void SetSongStartSyncTime(int64_t  songStartSyncTime) ;

/// @brief Method __ForceStopSong, addr 0x3b22728, size 0x34, virtual false, abstract: false, final false
inline void __ForceStopSong() ;

/// @brief Method __GetPlayerAvatar, addr 0x3b229c8, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b22a14, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_introAnimator, addr 0x3b22470, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerIntroAnimator> get_introAnimator() ;

/// @brief Method get_outroAnimator, addr 0x3b22478, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_outroAnimator() ;

/// @brief Method get_scoreDiffText, addr 0x3b22480, size 0x8, virtual false, abstract: false, final false
