...
/// @brief Field mirrorDidChangeEnabledStateEvent, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_mirrorDidChangeEnabledStateEvent, put=__cordl_internal_set_mirrorDidChangeEnabledStateEvent)) ::System::Action_1<bool>*  mirrorDidChangeEnabledStateEvent;
...
/// @brief Method ChangeMirrorEnabledState, addr 0x3ff1f78, size 0x3c, virtual false, abstract: false, final false
inline void ChangeMirrorEnabledState(bool  newIsEnabled) ;

static inline ::GlobalNamespace::Mirror* New_ctor() ;

/// @brief Method OnWillRenderObject, addr 0x3ff1cb8, size 0x2c0, virtual false, abstract: false, final false
inline void OnWillRenderObject() ;

/// @brief Method Update, addr 0x3ff1b14, size 0x18, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3ff282c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_mirrorDidChangeEnabledStateEvent, addr 0x3ff19b4, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_isEnabled, addr 0x3ff19a0, size 0x8, virtual false, abstract: false, final false
inline bool get_isEnabled() ;

/// @brief Method get_mirrorMaterial, addr 0x3ff1990, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_mirrorMaterial() ;

/// @brief Method get_noMirrorMaterial, addr 0x3ff1998, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_noMirrorMaterial() ;

/// @brief Method remove_mirrorDidChangeEnabledStateEvent, addr 0x3ff1a64, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method set_isEnabled, addr 0x3ff19a8, size 0xc, virtual false, abstract: false, final false
