...
/// @brief Method ApplyDelta, addr 0x229d5b0, size 0x110, virtual false, abstract: false, final false
inline ::GlobalNamespace::NodePoseSyncState ApplyDelta(ByRef<::GlobalNamespace::NodePoseSyncState>  delta) ;

/// @brief Method Deserialize, addr 0x229d330, size 0x40, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Equals, addr 0x229d40c, size 0x94, virtual false, abstract: false, final false
inline bool Equals(ByRef<::GlobalNamespace::NodePoseSyncState>  other) ;

/// @brief Method GetDelta, addr 0x229d4a0, size 0x110, virtual false, abstract: false, final false
inline ::GlobalNamespace::NodePoseSyncState GetDelta(ByRef<::GlobalNamespace::NodePoseSyncState>  latest) ;

/// @brief Method GetSize, addr 0x229d6c0, size 0x48, virtual true, abstract: false, final true
inline int32_t GetSize() ;

/// @brief Method GetState, addr 0x229d3c0, size 0x4c, virtual true, abstract: false, final true
inline ::GlobalNamespace::PoseSerializable GetState(::GlobalNamespace::__NodePoseSyncState__NodePose  nodePose) ;

/// @brief Method IEquatableByReference<NodePoseSyncState>.Equals, addr 0x229d768, size 0x4, virtual true, abstract: false, final true
inline bool IEquatableByReference_NodePoseSyncState__Equals(ByRef<::GlobalNamespace::NodePoseSyncState>  other) ;

/// @brief Method IStateTable<NodePoseSyncState,NodePoseSyncState.NodePose,PoseSerializable>.ApplyDelta, addr 0x229d738, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method IStateTable<NodePoseSyncState,NodePoseSyncState.NodePose,PoseSerializable>.GetDelta, addr 0x229d708, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method Serialize, addr 0x229d2f0, size 0x40, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method SetState, addr 0x229d370, size 0x50, virtual true, abstract: false, final true
...
constexpr ::GlobalNamespace::IStateTable_3<::GlobalNamespace::NodePoseSyncState,::GlobalNamespace::__NodePoseSyncState__NodePose,::GlobalNamespace::PoseSerializable>* i___GlobalNamespace__IStateTable_3___GlobalNamespace__NodePoseSyncState___GlobalNamespace____NodePoseSyncState__NodePose___GlobalNamespace__PoseSerializable_() ;
