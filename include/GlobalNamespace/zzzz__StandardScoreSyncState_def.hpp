...
/// @brief Method ApplyDelta, addr 0x229e204, size 0x24, virtual false, abstract: false, final false
inline ::GlobalNamespace::StandardScoreSyncState ApplyDelta(ByRef<::GlobalNamespace::StandardScoreSyncState>  delta) ;

/// @brief Method Deserialize, addr 0x229e2e4, size 0x6c, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Equals, addr 0x229e350, size 0x5c, virtual false, abstract: false, final false
inline bool Equals(ByRef<::GlobalNamespace::StandardScoreSyncState>  other) ;

/// @brief Method GetDelta, addr 0x229e1e0, size 0x24, virtual false, abstract: false, final false
inline ::GlobalNamespace::StandardScoreSyncState GetDelta(ByRef<::GlobalNamespace::StandardScoreSyncState>  stateTable) ;

/// @brief Method GetSize, addr 0x229e3ac, size 0x8c, virtual true, abstract: false, final true
inline int32_t GetSize() ;

/// @brief Method GetState, addr 0x229e228, size 0x50, virtual true, abstract: false, final true
inline int32_t GetState(::GlobalNamespace::__StandardScoreSyncState__Score  s) ;

/// @brief Method IEquatableByReference<StandardScoreSyncState>.Equals, addr 0x229e480, size 0x4, virtual true, abstract: false, final true
inline bool IEquatableByReference_StandardScoreSyncState__Equals(ByRef<::GlobalNamespace::StandardScoreSyncState>  other) ;

/// @brief Method IStateTable<StandardScoreSyncState,StandardScoreSyncState.Score,System.Int32>.ApplyDelta, addr 0x229e45c, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method IStateTable<StandardScoreSyncState,StandardScoreSyncState.Score,System.Int32>.GetDelta, addr 0x229e438, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method Serialize, addr 0x229e278, size 0x6c, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method SetState, addr 0x229e198, size 0x48, virtual true, abstract: false, final true
...
constexpr ::GlobalNamespace::IStateTable_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::__StandardScoreSyncState__Score,int32_t>* i___GlobalNamespace__IStateTable_3___GlobalNamespace__StandardScoreSyncState___GlobalNamespace____StandardScoreSyncState__Score_int32_t_() ;
