...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::GlobalNamespace::BeatmapData*)>(&::GlobalNamespace::DefaultEnvironmentEventsFactory::InsertDefaultEvents)> {
  constexpr static std::size_t size = 0xac;
  constexpr static std::size_t addrs = 0x266c37c;
