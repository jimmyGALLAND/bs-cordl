...
/// @brief Method PostRender, addr 0x3ff1230, size 0x4, virtual true, abstract: false, final false
inline void PostRender(float_t  fade) ;

/// @brief Method PreRender, addr 0x3ff1228, size 0x4, virtual true, abstract: false, final false
inline void PreRender() ;

/// @brief Method Render, addr 0x3ff122c, size 0x4, virtual true, abstract: false, final false
inline void Render(::UnityEngine::RenderTexture*  src, ::UnityEngine::RenderTexture*  dest, float_t  fade) ;

/// @brief Method .ctor, addr 0x3ff0a60, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_hasPostProcessEffect, addr 0x3ff1234, size 0x8, virtual true, abstract: false, final false
