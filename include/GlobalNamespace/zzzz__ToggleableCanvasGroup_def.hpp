...
/// @brief Method HandleToggleValueChanged, addr 0x3964d88, size 0x8, virtual false, abstract: false, final false
inline void HandleToggleValueChanged(bool  isOn) ;

static inline ::GlobalNamespace::ToggleableCanvasGroup* New_ctor() ;

/// @brief Method OnDisable, addr 0x3964ce4, size 0xa4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3964bfc, size 0xb8, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method SetCanvasGroupData, addr 0x3964cb4, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3964d90, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
