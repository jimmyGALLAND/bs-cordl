...
/// @brief Field gameObjects, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_gameObjects, put=__cordl_internal_set_gameObjects)) ::ArrayW<::UnityW<::UnityEngine::GameObject>,::Array<::UnityW<::UnityEngine::GameObject>>*>  gameObjects;
...
/// @brief Method SetActive, addr 0x3af73c4, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3af75c8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isActive, addr 0x3af75b4, size 0x8, virtual false, abstract: false, final false
inline bool get_isActive() ;

/// @brief Method set_isActive, addr 0x3af75bc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field _gameObjectsValueLists, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameObjectsValueLists, put=__cordl_internal_set__gameObjectsValueLists)) ::ArrayW<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*,::Array<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*>*>  _gameObjectsValueLists;
...
/// @brief Field _valueToListMap, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__valueToListMap, put=__cordl_internal_set__valueToListMap)) ::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*>*  _valueToListMap;

/// @brief Method HandleBasicBeatmapEventData, addr 0x3af746c, size 0x140, virtual false, abstract: false, final false
inline void HandleBasicBeatmapEventData(::GlobalNamespace::BasicBeatmapEventData*  data) ;

/// @brief Method Initialize, addr 0x3af720c, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3af7440, size 0x2c, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*,::Array<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*>*> const& __cordl_internal_get__gameObjectsValueLists() const;

constexpr ::ArrayW<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*,::Array<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*>*>& __cordl_internal_get__gameObjectsValueLists() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*>*> const& __cordl_internal_get__valueToListMap() const;
...
constexpr void __cordl_internal_set__gameObjectsValueLists(::ArrayW<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*,::Array<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*>*>  value) ;
...
/// @brief Method .ctor, addr 0x3af75ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
