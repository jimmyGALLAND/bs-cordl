...
/// @brief Method HandleComboBreakingEventHappened, addr 0x3b11070, size 0x3c, virtual false, abstract: false, final false
inline void HandleComboBreakingEventHappened() ;

/// @brief Method HandleComboDidChange, addr 0x3b11028, size 0x48, virtual false, abstract: false, final false
inline void HandleComboDidChange(int32_t  combo) ;

static inline ::GlobalNamespace::ComboUIController* New_ctor() ;

/// @brief Method OnDisable, addr 0x3b10e68, size 0x4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3b10e64, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RegisterForEvents, addr 0x3b10ba4, size 0x2c0, virtual false, abstract: false, final false
inline void RegisterForEvents() ;

/// @brief Method Start, addr 0x3b10b1c, size 0x88, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UnregisterFromEvents, addr 0x3b10e6c, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b110ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
