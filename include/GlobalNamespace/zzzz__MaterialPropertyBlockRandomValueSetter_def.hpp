...
/// @brief Method ApplyParams, addr 0x39631dc, size 0x184, virtual false, abstract: false, final false
inline void ApplyParams() ;

static inline ::GlobalNamespace::MaterialPropertyBlockRandomValueSetter* New_ctor() ;

/// @brief Method OnValidate, addr 0x3963360, size 0x24, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method RefreshPropertyId, addr 0x3963384, size 0x20, virtual false, abstract: false, final false
inline void RefreshPropertyId() ;

/// @brief Method Start, addr 0x39631d8, size 0x4, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x39633a4, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
