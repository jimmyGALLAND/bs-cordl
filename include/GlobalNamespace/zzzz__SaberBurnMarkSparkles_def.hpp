...
/// @brief Field _burnMarksEmissionModules, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get__burnMarksEmissionModules, put=__cordl_internal_set__burnMarksEmissionModules)) ::ArrayW<::UnityEngine::__ParticleSystem__EmissionModule,::Array<::UnityEngine::__ParticleSystem__EmissionModule>*>  _burnMarksEmissionModules;

/// @brief Field _burnMarksPS, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__burnMarksPS, put=__cordl_internal_set__burnMarksPS)) ::ArrayW<::UnityW<::UnityEngine::ParticleSystem>,::Array<::UnityW<::UnityEngine::ParticleSystem>>*>  _burnMarksPS;
...
/// @brief Method GetBurnMarkPos, addr 0x3af24f4, size 0x454, virtual false, abstract: false, final false
...
/// @brief Method LateUpdate, addr 0x3af2948, size 0x40c, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::SaberBurnMarkSparkles* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3af2118, size 0xf4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x3af2414, size 0xe0, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3af220c, size 0x208, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Start, addr 0x3af1d0c, size 0x40c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3af2d54, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
