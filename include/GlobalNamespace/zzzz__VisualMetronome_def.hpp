...
/// @brief Method Awake, addr 0x3b61c84, size 0x98, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::VisualMetronome* New_ctor() ;

/// @brief Method OnDisable, addr 0x3b61d64, size 0x48, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3b61d1c, size 0x48, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method SetMovingTickerNormalizedPosition, addr 0x3b61ef8, size 0xa4, virtual false, abstract: false, final false
inline void SetMovingTickerNormalizedPosition(float_t  t) ;

/// @brief Method Update, addr 0x3b61dac, size 0x14c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3b61f9c, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_zeroOffset, addr 0x3b61c7c, size 0x8, virtual false, abstract: false, final false
inline float_t get_zeroOffset() ;

/// @brief Method set_movingTickerColor, addr 0x3b61c48, size 0x24, virtual false, abstract: false, final false
inline void set_movingTickerColor(::UnityEngine::Color  value) ;

/// @brief Method set_tickerColor, addr 0x3b61c24, size 0x24, virtual false, abstract: false, final false
inline void set_tickerColor(::UnityEngine::Color  value) ;

/// @brief Method set_zeroOffset, addr 0x3b61c6c, size 0x10, virtual false, abstract: false, final false
