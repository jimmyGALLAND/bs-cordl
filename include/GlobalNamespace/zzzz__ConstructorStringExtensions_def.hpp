...
/// @brief Method ToConstructorString, addr 0x2267964, size 0x108, virtual false, abstract: false, final false
static inline ::StringW ToConstructorString(::UnityEngine::Pose  pose) ;

/// @brief Method ToConstructorString, addr 0x22677b4, size 0x1b0, virtual false, abstract: false, final false
static inline ::StringW ToConstructorString(::UnityEngine::Quaternion  quaternion) ;

/// @brief Method ToConstructorString, addr 0x22676e4, size 0xd0, virtual false, abstract: false, final false
