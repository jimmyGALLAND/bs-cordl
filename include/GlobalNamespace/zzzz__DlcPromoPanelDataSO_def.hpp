...
/// @brief Method .ctor, addr 0x26a8c04, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_cutOffTest, addr 0x26a8be4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_cutOffTest() ;

/// @brief Method get_defaultPromoInfoId, addr 0x26a8bf4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_defaultPromoInfoId() ;

/// @brief Method get_minNumberOfNotOwnedPacks, addr 0x26a8bec, size 0x8, virtual false, abstract: false, final false
inline int32_t get_minNumberOfNotOwnedPacks() ;

/// @brief Method set_defaultPromoInfoId, addr 0x26a8bfc, size 0x8, virtual false, abstract: false, final false
