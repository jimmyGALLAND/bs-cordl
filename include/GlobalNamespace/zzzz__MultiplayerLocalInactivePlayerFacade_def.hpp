...
class CORDL_TYPE __MultiplayerLocalInactivePlayerFacade__Factory : public ::Zenject::PlaceholderFactory_2<::GlobalNamespace::MultiplayerPlayerStartState,::UnityW<::GlobalNamespace::MultiplayerLocalInactivePlayerFacade>> {
public:
// Declarations
static inline ::GlobalNamespace::__MultiplayerLocalInactivePlayerFacade__Factory* New_ctor() ;

/// @brief Method .ctor, addr 0x3b2f5f4, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _inactivePlayerSongSyncController, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__inactivePlayerSongSyncController, put=__cordl_internal_set__inactivePlayerSongSyncController)) ::UnityW<::GlobalNamespace::MultiplayerLocalInactivePlayerSongSyncController>  _inactivePlayerSongSyncController;
...
/// @brief Method ReportPlayerDidFinish, addr 0x3b2f5b4, size 0x1c, virtual true, abstract: false, final true
inline void ReportPlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults*  results) ;

/// @brief Method ReportPlayerNetworkDidFailed, addr 0x3b2f5d0, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b2f5ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_playerDidFinishEvent, addr 0x3b2f2f4, size 0xb0, virtual true, abstract: false, final true
inline void add_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method add_playerNetworkDidFailedEvent, addr 0x3b2f454, size 0xb0, virtual true, abstract: false, final true
inline void add_playerNetworkDidFailedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method get_introAnimator, addr 0x3b2f2c8, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_introAnimator() ;

/// @brief Method get_introPlayableDirector, addr 0x3b2f2e4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Playables::PlayableDirector> get_introPlayableDirector() ;

/// @brief Method get_outroAnimator, addr 0x3b2f2ec, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MultiplayerLocalInactivePlayerOutroAnimator> get_outroAnimator() ;

/// @brief Method get_songController, addr 0x3b2f2b8, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::IStartSeekSongController* get_songController() ;

/// @brief Method get_spectatorController, addr 0x3b2f2c0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method remove_playerDidFinishEvent, addr 0x3b2f3a4, size 0xb0, virtual true, abstract: false, final true
inline void remove_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method remove_playerNetworkDidFailedEvent, addr 0x3b2f504, size 0xb0, virtual true, abstract: false, final true
