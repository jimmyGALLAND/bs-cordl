...
/// @brief Method CreateFromSerializedData, addr 0x26d0938, size 0x2c, virtual true, abstract: false, final true
inline ::GlobalNamespace::BitMask256 CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Deserialize, addr 0x26d0964, size 0x6c, virtual false, abstract: false, final false
static inline ::GlobalNamespace::BitMask256 Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Equals, addr 0x26d0af0, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x26d0aa4, size 0x4c, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::BitMask256  other) ;

/// @brief Method GetBits, addr 0x26d05e8, size 0x154, virtual true, abstract: false, final true
inline uint64_t GetBits(int32_t  offset, int32_t  count) ;

/// @brief Method GetHashCode, addr 0x26d0b98, size 0x88, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Serialize, addr 0x26d08d8, size 0x60, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method SetBits, addr 0x26d0518, size 0xd0, virtual true, abstract: false, final true
inline ::GlobalNamespace::BitMask256 SetBits(int32_t  offset, uint64_t  bits) ;

/// @brief Method ToString, addr 0x26d09d0, size 0xd4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x26d0500, size 0xc, virtual false, abstract: false, final false
inline void _ctor(uint64_t  d0, uint64_t  d1, uint64_t  d2, uint64_t  d3) ;

/// @brief Method .ctor, addr 0x26d050c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(uint64_t  value) ;

/// @brief Method get_bitCount, addr 0x26d04ec, size 0x8, virtual true, abstract: false, final true
inline int32_t get_bitCount() ;

/// @brief Method get_maxValue, addr 0x26d04f4, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_BitwiseAnd, addr 0x26d0754, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method op_BitwiseOr, addr 0x26d073c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x26d0834, size 0x4c, virtual false, abstract: false, final false
static inline bool op_Equality(ByRef<::GlobalNamespace::BitMask256>  a, ByRef<::GlobalNamespace::BitMask256>  b) ;

/// @brief Method op_ExclusiveOr, addr 0x26d076c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x26d08cc, size 0xc, virtual false, abstract: false, final false
static inline ::GlobalNamespace::BitMask256 op_Implicit___GlobalNamespace__BitMask256(uint64_t  value) ;

/// @brief Method op_Inequality, addr 0x26d0880, size 0x4c, virtual false, abstract: false, final false
static inline bool op_Inequality(ByRef<::GlobalNamespace::BitMask256>  a, ByRef<::GlobalNamespace::BitMask256>  b) ;

/// @brief Method op_LeftShift, addr 0x26d0784, size 0x58, virtual false, abstract: false, final false
static inline ::GlobalNamespace::BitMask256 op_LeftShift(ByRef<::GlobalNamespace::BitMask256>  a, int32_t  bits) ;

/// @brief Method op_RightShift, addr 0x26d07dc, size 0x58, virtual false, abstract: false, final false
