...
/// @brief Method CreateController, addr 0x394a2d4, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x394cfa8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_orientationActionReference, addr 0x394cf88, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::InputSystem::InputActionReference> get_orientationActionReference() ;

/// @brief Method get_positionActionReference, addr 0x394cf78, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::InputSystem::InputActionReference> get_positionActionReference() ;

/// @brief Method get_thumbstickActionReference, addr 0x394cf98, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::InputSystem::InputActionReference> get_thumbstickActionReference() ;

/// @brief Method set_orientationActionReference, addr 0x394cf90, size 0x8, virtual false, abstract: false, final false
inline void set_orientationActionReference(::UnityEngine::InputSystem::InputActionReference*  value) ;

/// @brief Method set_positionActionReference, addr 0x394cf80, size 0x8, virtual false, abstract: false, final false
inline void set_positionActionReference(::UnityEngine::InputSystem::InputActionReference*  value) ;

/// @brief Method set_thumbstickActionReference, addr 0x394cfa0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field <manufacturerName>k__BackingField, offset 0x2c, size 0x4 
 __declspec(property(get=__cordl_internal_get__manufacturerName_k__BackingField, put=__cordl_internal_set__manufacturerName_k__BackingField)) ::GlobalNamespace::__UnityXRHelper__VRControllerManufacturerName  _manufacturerName_k__BackingField;
...
/// @brief Method ResetManufacturerName, addr 0x394cf70, size 0x8, virtual false, abstract: false, final false
inline void ResetManufacturerName() ;

/// @brief Method SetupController, addr 0x394cc68, size 0x34, virtual false, abstract: false, final false
inline bool SetupController(::UnityEngine::XR::InputDevice  device, ::UnityEngine::MonoBehaviour*  coroutineRunner) ;

/// @brief Method TryToUpdateManufacturerName, addr 0x394cc9c, size 0x150, virtual false, abstract: false, final false
inline bool TryToUpdateManufacturerName(::UnityEngine::XR::InputDevice  device) ;

/// @brief Method UpdateHapticsHandler, addr 0x394cdec, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x394cb9c, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method get_hapticsHandler, addr 0x394cb84, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::IUnityXRHapticsHandler* get_hapticsHandler() ;

/// @brief Method get_manufacturerName, addr 0x394cb8c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__UnityXRHelper__VRControllerManufacturerName get_manufacturerName() ;

/// @brief Method set_manufacturerName, addr 0x394cb94, size 0x8, virtual false, abstract: false, final false
