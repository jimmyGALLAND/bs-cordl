...
/// @brief Method InstallBindings, addr 0x3b2f63c, size 0x424, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b2faac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
