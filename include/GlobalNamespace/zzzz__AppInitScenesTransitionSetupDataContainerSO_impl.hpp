...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::AppInitScenesTransitionSetupDataContainerSO::*)()>(&::GlobalNamespace::AppInitScenesTransitionSetupDataContainerSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3aadd18;
...
constexpr ::UnityW<::GlobalNamespace::AppInitScenesTransitionSetupDataSO> const& GlobalNamespace::AppInitScenesTransitionSetupDataContainerSO::__cordl_internal_get_appInitScenesTransitionSetupData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___appInitScenesTransitionSetupData;
}
constexpr void GlobalNamespace::AppInitScenesTransitionSetupDataContainerSO::__cordl_internal_set_appInitScenesTransitionSetupData(::UnityW<::GlobalNamespace::AppInitScenesTransitionSetupDataSO>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
