...
/// @brief Method <SelectAnnotatedBeatmapLevelCollection>b__53_0, addr 0x3ad37e8, size 0x18, virtual false, abstract: false, final false
inline ::StringW _SelectAnnotatedBeatmapLevelCollection_b__53_0(::GlobalNamespace::BeatmapLevelPack*  pack) ;

/// @brief Method .ctor, addr 0x3ad37e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <SelectAnnotatedBeatmapLevelCollection>b__1, addr 0x3ad3800, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ad36d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x3ad3828, size 0x4e4, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x3ad3d0c, size 0xc, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::LevelFilteringNavigationController>", modifiers: "", def_value: None }, CppParam { name: "_cancellationToken_5__2", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::BeatmapLevelsRepository*>", modifiers: "", def_value: None }]
constexpr __LevelFilteringNavigationController___UpdateCustomSongs_d__54(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::UnityW<::GlobalNamespace::LevelFilteringNavigationController>  __4__this, ::System::Threading::CancellationToken  _cancellationToken_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::BeatmapLevelsRepository*>  __u__1) noexcept;
...
/// @brief Field _allBeatmapLevelPacks, offset 0x168, size 0x8 
 __declspec(property(get=__cordl_internal_get__allBeatmapLevelPacks, put=__cordl_internal_set__allBeatmapLevelPacks)) ::ArrayW<::GlobalNamespace::BeatmapLevelPack*,::Array<::GlobalNamespace::BeatmapLevelPack*>*>  _allBeatmapLevelPacks;

/// @brief Field _allOfficialBeatmapLevelPacks, offset 0x160, size 0x8 
 __declspec(property(get=__cordl_internal_get__allOfficialBeatmapLevelPacks, put=__cordl_internal_set__allOfficialBeatmapLevelPacks)) ::ArrayW<::GlobalNamespace::BeatmapLevelPack*,::Array<::GlobalNamespace::BeatmapLevelPack*>*>  _allOfficialBeatmapLevelPacks;

/// @brief Field _annotatedBeatmapLevelCollectionsViewController, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get__annotatedBeatmapLevelCollectionsViewController, put=__cordl_internal_set__annotatedBeatmapLevelCollectionsViewController)) ::UnityW<::GlobalNamespace::AnnotatedBeatmapLevelCollectionsViewController>  _annotatedBeatmapLevelCollectionsViewController;
...
/// @brief Field _customLevelPacks, offset 0x158, size 0x8 
 __declspec(property(get=__cordl_internal_get__customLevelPacks, put=__cordl_internal_set__customLevelPacks)) ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::BeatmapLevelPack*>*  _customLevelPacks;

/// @brief Field _emptyCustomSongListInfoPrefab, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get__emptyCustomSongListInfoPrefab, put=__cordl_internal_set__emptyCustomSongListInfoPrefab)) ::UnityW<::UnityEngine::GameObject>  _emptyCustomSongListInfoPrefab;

/// @brief Field _emptyFavoritesListInfoPrefab, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__emptyFavoritesListInfoPrefab, put=__cordl_internal_set__emptyFavoritesListInfoPrefab)) ::UnityW<::UnityEngine::GameObject>  _emptyFavoritesListInfoPrefab;
...
/// @brief Field _enabledLevelCategories, offset 0x140, size 0x8 
 __declspec(property(get=__cordl_internal_get__enabledLevelCategories, put=__cordl_internal_set__enabledLevelCategories)) ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*>  _enabledLevelCategories;
...
/// @brief Field _musicPacksBeatmapLevelPacks, offset 0x150, size 0x8 
 __declspec(property(get=__cordl_internal_get__musicPacksBeatmapLevelPacks, put=__cordl_internal_set__musicPacksBeatmapLevelPacks)) ::ArrayW<::GlobalNamespace::BeatmapLevelPack*,::Array<::GlobalNamespace::BeatmapLevelPack*>*>  _musicPacksBeatmapLevelPacks;

/// @brief Field _ostBeatmapLevelPacks, offset 0x148, size 0x8 
 __declspec(property(get=__cordl_internal_get__ostBeatmapLevelPacks, put=__cordl_internal_set__ostBeatmapLevelPacks)) ::ArrayW<::GlobalNamespace::BeatmapLevelPack*,::Array<::GlobalNamespace::BeatmapLevelPack*>*>  _ostBeatmapLevelPacks;
...
/// @brief Field _selectLevelCategoryViewController, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get__selectLevelCategoryViewController, put=__cordl_internal_set__selectLevelCategoryViewController)) ::UnityW<::GlobalNamespace::SelectLevelCategoryViewController>  _selectLevelCategoryViewController;
...
/// @brief Field didCloseBeatmapLevelCollectionsEvent, offset 0xf8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didCloseBeatmapLevelCollectionsEvent, put=__cordl_internal_set_didCloseBeatmapLevelCollectionsEvent)) ::System::Action*  didCloseBeatmapLevelCollectionsEvent;

/// @brief Field didOpenBeatmapLevelCollectionsEvent, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didOpenBeatmapLevelCollectionsEvent, put=__cordl_internal_set_didOpenBeatmapLevelCollectionsEvent)) ::System::Action*  didOpenBeatmapLevelCollectionsEvent;

/// @brief Field didPressAllSongsEvent, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didPressAllSongsEvent, put=__cordl_internal_set_didPressAllSongsEvent)) ::System::Action_1<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>>*  didPressAllSongsEvent;

/// @brief Field didSelectBeatmapLevelPackEvent, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didSelectBeatmapLevelPackEvent, put=__cordl_internal_set_didSelectBeatmapLevelPackEvent)) ::System::Action_4<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>,::GlobalNamespace::BeatmapLevelPack*,::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::LevelSelectionOptions>*  didSelectBeatmapLevelPackEvent;

/// @brief Field didStartLoadingEvent, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didStartLoadingEvent, put=__cordl_internal_set_didStartLoadingEvent)) ::System::Action_1<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>>*  didStartLoadingEvent;
...
/// @brief Method DidActivate, addr 0x3ad237c, size 0x3bc, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3ad2ae4, size 0x31c, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleAnnotatedBeatmapLevelCollectionsViewControllerDidCloseBeatmapLevelCollections, addr 0x3ad3458, size 0x1c, virtual false, abstract: false, final false
inline void HandleAnnotatedBeatmapLevelCollectionsViewControllerDidCloseBeatmapLevelCollections() ;

/// @brief Method HandleAnnotatedBeatmapLevelCollectionsViewControllerDidOpenBeatmapLevelCollections, addr 0x3ad343c, size 0x1c, virtual false, abstract: false, final false
inline void HandleAnnotatedBeatmapLevelCollectionsViewControllerDidOpenBeatmapLevelCollections() ;

/// @brief Method HandleAnnotatedBeatmapLevelCollectionsViewControllerDidSelectAnnotatedBeatmapLevelCollection, addr 0x3ad3474, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method HandleIncreaseNumberOfGameplays, addr 0x3ad33e4, size 0x4c, virtual false, abstract: false, final false
inline void HandleIncreaseNumberOfGameplays() ;

/// @brief Method HandleLevelSearchViewControllerDidFilterBeatmapLevelCollection, addr 0x3ad3010, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method HandleLevelSearchViewControllerDidStartLoading, addr 0x3ad2ac4, size 0x20, virtual false, abstract: false, final false
inline void HandleLevelSearchViewControllerDidStartLoading(::GlobalNamespace::LevelSearchViewController*  obj) ;

/// @brief Method HandlePlayerDataFavoriteLevelsSetDidChange, addr 0x3ad33a0, size 0x44, virtual false, abstract: false, final false
inline void HandlePlayerDataFavoriteLevelsSetDidChange() ;

/// @brief Method HandleSelectLevelCategoryViewControllerDidSelectLevelCategory, addr 0x3ad3074, size 0x8, virtual false, abstract: false, final false
inline void HandleSelectLevelCategoryViewControllerDidSelectLevelCategory(::GlobalNamespace::SelectLevelCategoryViewController*  viewController, ::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory  levelCategory) ;

static inline ::GlobalNamespace::LevelFilteringNavigationController* New_ctor() ;

/// @brief Method ReplaceSecondViewController, addr 0x3ad3274, size 0xa0, virtual false, abstract: false, final false
inline void ReplaceSecondViewController(::HMUI::ViewController*  viewController) ;

/// @brief Method SelectAnnotatedBeatmapLevelCollection, addr 0x3ad34e0, size 0x1f4, virtual false, abstract: false, final false
inline void SelectAnnotatedBeatmapLevelCollection(::GlobalNamespace::BeatmapLevelPack*  levelPack) ;

/// @brief Method Setup, addr 0x3ad1c14, size 0xa8, virtual false, abstract: false, final false
inline void Setup(::GlobalNamespace::SongPackMask  songPackMask, ::GlobalNamespace::BeatmapLevelPack*  levelPackToBeSelectedAfterPresent, ::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory  startLevelCategory, bool  hidePacksIfOneOrNone, bool  enableCustomLevels) ;

/// @brief Method SetupBeatmapLevelPacks, addr 0x3ad1cbc, size 0x3b4, virtual false, abstract: false, final false
inline void SetupBeatmapLevelPacks() ;

/// @brief Method ShowPacksInSecondChildController, addr 0x3ad307c, size 0x1dc, virtual false, abstract: false, final false
...
/// @brief Method UpdateCustomSongs, addr 0x3ad3314, size 0x8c, virtual false, abstract: false, final false
inline void UpdateCustomSongs() ;

/// @brief Method UpdateSecondChildControllerContent, addr 0x3ad2948, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method <SetupBeatmapLevelPacks>b__39_0, addr 0x3ad36e4, size 0x50, virtual false, abstract: false, final false
inline bool _SetupBeatmapLevelPacks_b__39_0(::GlobalNamespace::BeatmapLevelPack*  pack) ;

/// @brief Method <SetupBeatmapLevelPacks>b__39_1, addr 0x3ad3734, size 0x50, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*> const& __cordl_internal_get__enabledLevelCategories() const;

constexpr ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*>& __cordl_internal_get__enabledLevelCategories() ;
...
constexpr ::System::Action_4<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>,::GlobalNamespace::BeatmapLevelPack*,::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::LevelSelectionOptions>*& __cordl_internal_get_didSelectBeatmapLevelPackEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action_4<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>,::GlobalNamespace::BeatmapLevelPack*,::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::LevelSelectionOptions>*> const& __cordl_internal_get_didSelectBeatmapLevelPackEvent() const;
...
constexpr void __cordl_internal_set__enabledLevelCategories(::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*>  value) ;
...
constexpr void __cordl_internal_set_didSelectBeatmapLevelPackEvent(::System::Action_4<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>,::GlobalNamespace::BeatmapLevelPack*,::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::LevelSelectionOptions>*  value) ;
...
/// @brief Method .ctor, addr 0x3ad36dc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didCloseBeatmapLevelCollectionsEvent, addr 0x3ad1a54, size 0x9c, virtual false, abstract: false, final false
inline void add_didCloseBeatmapLevelCollectionsEvent(::System::Action*  value) ;

/// @brief Method add_didOpenBeatmapLevelCollectionsEvent, addr 0x3ad191c, size 0x9c, virtual false, abstract: false, final false
inline void add_didOpenBeatmapLevelCollectionsEvent(::System::Action*  value) ;

/// @brief Method add_didPressAllSongsEvent, addr 0x3ad17bc, size 0xb0, virtual false, abstract: false, final false
inline void add_didPressAllSongsEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>>*  value) ;

/// @brief Method add_didSelectBeatmapLevelPackEvent, addr 0x3ad14fc, size 0xb0, virtual false, abstract: false, final false
inline void add_didSelectBeatmapLevelPackEvent(::System::Action_4<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>,::GlobalNamespace::BeatmapLevelPack*,::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::LevelSelectionOptions>*  value) ;

/// @brief Method add_didStartLoadingEvent, addr 0x3ad165c, size 0xb0, virtual false, abstract: false, final false
inline void add_didStartLoadingEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>>*  value) ;

/// @brief Method get_selectedBeatmapLevelPack, addr 0x3ad1b8c, size 0x18, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevelPack* get_selectedBeatmapLevelPack() ;

/// @brief Method get_selectedLevelCategory, addr 0x3ad1ba4, size 0x18, virtual false, abstract: false, final false
inline ::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory get_selectedLevelCategory() ;

/// @brief Method remove_didCloseBeatmapLevelCollectionsEvent, addr 0x3ad1af0, size 0x9c, virtual false, abstract: false, final false
inline void remove_didCloseBeatmapLevelCollectionsEvent(::System::Action*  value) ;

/// @brief Method remove_didOpenBeatmapLevelCollectionsEvent, addr 0x3ad19b8, size 0x9c, virtual false, abstract: false, final false
inline void remove_didOpenBeatmapLevelCollectionsEvent(::System::Action*  value) ;

/// @brief Method remove_didPressAllSongsEvent, addr 0x3ad186c, size 0xb0, virtual false, abstract: false, final false
inline void remove_didPressAllSongsEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>>*  value) ;

/// @brief Method remove_didSelectBeatmapLevelPackEvent, addr 0x3ad15ac, size 0xb0, virtual false, abstract: false, final false
inline void remove_didSelectBeatmapLevelPackEvent(::System::Action_4<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>,::GlobalNamespace::BeatmapLevelPack*,::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::LevelSelectionOptions>*  value) ;

/// @brief Method remove_didStartLoadingEvent, addr 0x3ad170c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Field didSelectBeatmapLevelPackEvent, offset: 0xd8, size: 0x8, def value: None
 ::System::Action_4<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>,::GlobalNamespace::BeatmapLevelPack*,::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::LevelSelectionOptions>*  ___didSelectBeatmapLevelPackEvent;
