...
/// @brief Method ReturnToMenu, addr 0x3b1c994, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b1c9b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
