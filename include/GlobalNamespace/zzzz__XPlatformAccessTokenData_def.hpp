...
/// @brief Method IsValid, addr 0x2295898, size 0x40, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method .ctor, addr 0x229588c, size 0xc, virtual false, abstract: false, final false
