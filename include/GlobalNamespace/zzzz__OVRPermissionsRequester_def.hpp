...
/// @brief Method <BuildPermissionCallbacks>b__14_0, addr 0x3f4be54, size 0xa4, virtual false, abstract: false, final false
inline void _BuildPermissionCallbacks_b__14_0(::StringW  permissionId) ;

/// @brief Method <BuildPermissionCallbacks>b__14_1, addr 0x3f4bef8, size 0xa4, virtual false, abstract: false, final false
inline void _BuildPermissionCallbacks_b__14_1(::StringW  permissionId) ;

/// @brief Method <BuildPermissionCallbacks>b__14_2, addr 0x3f4bf9c, size 0xec, virtual false, abstract: false, final false
inline void _BuildPermissionCallbacks_b__14_2(::StringW  permissionId) ;

/// @brief Method .ctor, addr 0x3f4be4c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method BuildPermissionCallbacks, addr 0x3f4bbc8, size 0x228, virtual false, abstract: false, final false
static inline ::UnityEngine::Android::PermissionCallbacks* BuildPermissionCallbacks() ;

/// @brief Method GetPermissionId, addr 0x3f4b238, size 0xe0, virtual false, abstract: false, final false
static inline ::StringW GetPermissionId(::GlobalNamespace::__OVRPermissionsRequester__Permission  permission) ;

/// @brief Method IsPermissionGranted, addr 0x3f4b6c0, size 0x14, virtual false, abstract: false, final false
static inline bool IsPermissionGranted(::GlobalNamespace::__OVRPermissionsRequester__Permission  permission) ;

/// @brief Method IsPermissionSupportedByPlatform, addr 0x3f4b318, size 0x138, virtual false, abstract: false, final false
static inline bool IsPermissionSupportedByPlatform(::GlobalNamespace::__OVRPermissionsRequester__Permission  permission) ;

/// @brief Method Request, addr 0x3f4b6d4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method RequestPermissions, addr 0x3f4b6d8, size 0x3f4, virtual false, abstract: false, final false
...
/// @brief Method ShouldRequestPermission, addr 0x3f4bacc, size 0xfc, virtual false, abstract: false, final false
static inline bool ShouldRequestPermission(::GlobalNamespace::__OVRPermissionsRequester__Permission  permission) ;

/// @brief Method add_PermissionGranted, addr 0x3f4b0a0, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method remove_PermissionGranted, addr 0x3f4b16c, size 0xcc, virtual false, abstract: false, final false
