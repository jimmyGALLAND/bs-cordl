...
/// @brief Method Init, addr 0x3a65460, size 0x398, virtual false, abstract: false, final false
inline void Init(float_t  beatTime, float_t  worldRotation, ::UnityEngine::Vector3  startPos, ::UnityEngine::Vector3  endPos, float_t  jumpDuration, float_t  gravity, float_t  flipYSide, float_t  endRotation, bool  rotateTowardsPlayer, bool  useRandomRotation) ;

/// @brief Method ManualUpdate, addr 0x3a657f8, size 0x65c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a65e54, size 0x1b8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_noteJumpDidFinishEvent, addr 0x3a64d60, size 0x9c, virtual false, abstract: false, final false
inline void add_noteJumpDidFinishEvent(::System::Action*  value) ;

/// @brief Method add_noteJumpDidPassHalfEvent, addr 0x3a65130, size 0x9c, virtual false, abstract: false, final false
inline void add_noteJumpDidPassHalfEvent(::System::Action*  value) ;

/// @brief Method add_noteJumpDidPassMissedMarkerEvent, addr 0x3a64e98, size 0x9c, virtual false, abstract: false, final false
inline void add_noteJumpDidPassMissedMarkerEvent(::System::Action*  value) ;

/// @brief Method add_noteJumpDidPassThreeQuartersEvent, addr 0x3a64fd0, size 0xb0, virtual false, abstract: false, final false
inline void add_noteJumpDidPassThreeQuartersEvent(::System::Action_1<::UnityW<::GlobalNamespace::NoteJump>>*  value) ;

/// @brief Method add_noteJumpDidUpdateProgressEvent, addr 0x3a65268, size 0xb0, virtual false, abstract: false, final false
inline void add_noteJumpDidUpdateProgressEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method get_beatPos, addr 0x3a65410, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_beatPos() ;

/// @brief Method get_distanceToPlayer, addr 0x3a653c8, size 0x48, virtual false, abstract: false, final false
inline float_t get_distanceToPlayer() ;

/// @brief Method get_jumpDuration, addr 0x3a65440, size 0x8, virtual false, abstract: false, final false
inline float_t get_jumpDuration() ;

/// @brief Method get_localPosition, addr 0x3a65454, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_localPosition() ;

/// @brief Method get_moveVec, addr 0x3a65448, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_moveVec() ;

/// @brief Method remove_noteJumpDidFinishEvent, addr 0x3a64dfc, size 0x9c, virtual false, abstract: false, final false
inline void remove_noteJumpDidFinishEvent(::System::Action*  value) ;

/// @brief Method remove_noteJumpDidPassHalfEvent, addr 0x3a651cc, size 0x9c, virtual false, abstract: false, final false
inline void remove_noteJumpDidPassHalfEvent(::System::Action*  value) ;

/// @brief Method remove_noteJumpDidPassMissedMarkerEvent, addr 0x3a64f34, size 0x9c, virtual false, abstract: false, final false
inline void remove_noteJumpDidPassMissedMarkerEvent(::System::Action*  value) ;

/// @brief Method remove_noteJumpDidPassThreeQuartersEvent, addr 0x3a65080, size 0xb0, virtual false, abstract: false, final false
inline void remove_noteJumpDidPassThreeQuartersEvent(::System::Action_1<::UnityW<::GlobalNamespace::NoteJump>>*  value) ;

/// @brief Method remove_noteJumpDidUpdateProgressEvent, addr 0x3a65318, size 0xb0, virtual false, abstract: false, final false
