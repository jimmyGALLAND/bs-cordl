...
/// @brief Field AnyoneCanInvite value: static_cast<int32_t>(0x1)
static ::GlobalNamespace::InvitePolicy const AnyoneCanInvite;

/// @brief Field NobodyCanInvite value: static_cast<int32_t>(0x2)
static ::GlobalNamespace::InvitePolicy const NobodyCanInvite;

/// @brief Field OnlyConnectionOwnerCanInvite value: static_cast<int32_t>(0x0)
