...
/// @brief Method DidActivate, addr 0x3a6fb84, size 0x1ec, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3a6fdbc, size 0x13c, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleHideExplicitChanged, addr 0x3a6ff14, size 0x30, virtual false, abstract: false, final false
inline void HandleHideExplicitChanged(bool  newValue) ;

/// @brief Method HandlePausePressDurationChanged, addr 0x3a6fef8, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method UpdateExplicitContentHiddenWarningVisibility, addr 0x3a6fd70, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a6ff44, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
