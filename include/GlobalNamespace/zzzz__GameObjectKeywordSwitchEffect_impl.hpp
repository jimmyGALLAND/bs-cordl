...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem::*)()>(&::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3af771c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GameObjectKeywordSwitchEffect::*)(::GlobalNamespace::IReadonlyBeatmapData*)>(&::GlobalNamespace::GameObjectKeywordSwitchEffect::Initialize)> {
  constexpr static std::size_t size = 0x144;
  constexpr static std::size_t addrs = 0x3af75d0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::GameObjectKeywordSwitchEffect*>::get(),
                        "Initialize",
                        std::span<const Il2CppClass* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GameObjectKeywordSwitchEffect::*)()>(&::GlobalNamespace::GameObjectKeywordSwitchEffect::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3af7714;
...
constexpr ::ArrayW<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*,::Array<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*>*>& GlobalNamespace::GameObjectKeywordSwitchEffect::__cordl_internal_get__gameObjectKeywordItems()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____gameObjectKeywordItems;
}
constexpr ::ArrayW<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*,::Array<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*>*> const& GlobalNamespace::GameObjectKeywordSwitchEffect::__cordl_internal_get__gameObjectKeywordItems() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____gameObjectKeywordItems;
}
constexpr void GlobalNamespace::GameObjectKeywordSwitchEffect::__cordl_internal_set__gameObjectKeywordItems(::ArrayW<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*,::Array<::GlobalNamespace::__GameObjectKeywordSwitchEffect__GameObjectKeywordItem*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
