...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::*)(float_t, float_t)>(&::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::Activate)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3b4220c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::*)()>(&::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::Deactivate)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x3b426a4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::*)()>(&::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::OnDestroy)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x3b427f4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::*)()>(&::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::SpawnAllPlaces)> {
  constexpr static std::size_t size = 0x490;
  constexpr static std::size_t addrs = 0x3b42214;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::*)()>(&::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::DespawnAllPlaces)> {
  constexpr static std::size_t size = 0x14c;
  constexpr static std::size_t addrs = 0x3b426a8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::*)()>(&::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::_ctor)> {
  constexpr static std::size_t size = 0x7c;
  constexpr static std::size_t addrs = 0x3b427f8;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__MultiplayerLobbyAvatarPlace__Pool*> const& GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::__cordl_internal_get__avatarPlacesPool() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____avatarPlacesPool;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::MultiplayerLobbyAvatarPlace>>*> const& GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::__cordl_internal_get__allPlaces() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____allPlaces;
}
constexpr void GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::__cordl_internal_set__allPlaces(::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::MultiplayerLobbyAvatarPlace>>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
