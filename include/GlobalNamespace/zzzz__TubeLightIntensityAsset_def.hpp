...
/// @brief Method CreatePlayable, addr 0x3aa91a4, size 0xa8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aa924c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_clipCaps, addr 0x3aa919c, size 0x8, virtual true, abstract: false, final true
