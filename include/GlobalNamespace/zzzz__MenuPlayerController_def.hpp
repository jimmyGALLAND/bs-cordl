...
/// @brief Method .ctor, addr 0x3b72e48, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_headPos, addr 0x3b72e10, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_headPos() ;

/// @brief Method get_headRot, addr 0x3b72e2c, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_headRot() ;

/// @brief Method get_leftController, addr 0x3b72e00, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::VRController> get_leftController() ;

/// @brief Method get_rightController, addr 0x3b72e08, size 0x8, virtual false, abstract: false, final false
