...
/// @brief Method HandleBeatmapEvent, addr 0x3b00ecc, size 0x20, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

static inline ::GlobalNamespace::MeshRendererSwitchEventEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b00eb0, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b00d88, size 0x128, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method ToggleObjects, addr 0x3b00eec, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b00fb0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
