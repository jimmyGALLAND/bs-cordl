...
/// @brief Method AnimateNewLeaderSelected, addr 0x3b2d9ac, size 0xe4, virtual true, abstract: false, final false
inline void AnimateNewLeaderSelected(bool  isLeading) ;

/// @brief Method HandlePlayerDidFinish, addr 0x3b2da90, size 0x34, virtual false, abstract: false, final false
inline void HandlePlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults*  levelCompletionResults) ;

/// @brief Method HandleStateChanged, addr 0x3b2d74c, size 0x1ac, virtual true, abstract: false, final false
inline void HandleStateChanged(::GlobalNamespace::__MultiplayerController__State  state) ;

/// @brief Method InitializeIfNeeded, addr 0x3b2d688, size 0xc4, virtual false, abstract: false, final false
inline void InitializeIfNeeded() ;

static inline ::GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b2d57c, size 0x10c, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method TransitionIntoFailedState, addr 0x3b2d8f8, size 0xb4, virtual false, abstract: false, final false
inline void TransitionIntoFailedState() ;

/// @brief Method <InitializeIfNeeded>b__6_0, addr 0x3b2dacc, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b2dac4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
