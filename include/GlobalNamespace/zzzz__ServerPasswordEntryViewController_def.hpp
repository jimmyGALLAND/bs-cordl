...
/// @brief Method DidActivate, addr 0x3addec8, size 0xc0, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x3addf88, size 0xb0, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleJoinClicked, addr 0x3ade038, size 0x3c, virtual false, abstract: false, final false
inline void HandleJoinClicked() ;

/// @brief Method HandleUIKeyboardOkButtonWasPressed, addr 0x3ade074, size 0x3c, virtual false, abstract: false, final false
inline void HandleUIKeyboardOkButtonWasPressed() ;

static inline ::GlobalNamespace::ServerPasswordEntryViewController* New_ctor() ;

/// @brief Method Setup, addr 0x3addec0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ade0b0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x3addd60, size 0xb0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_2<::GlobalNamespace::INetworkPlayer*,::StringW>*  value) ;

/// @brief Method remove_didFinishEvent, addr 0x3adde10, size 0xb0, virtual false, abstract: false, final false
