...
/// @brief Method Awake, addr 0x3af9388, size 0x20, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::StepFloatMaterialPropertyEffectTarget* New_ctor() ;

/// @brief Method SetFloat, addr 0x3af93ac, size 0x5c, virtual false, abstract: false, final false
inline void SetFloat(float_t  value) ;

/// @brief Method SetValue, addr 0x3af93a8, size 0x4, virtual true, abstract: false, final false
inline void SetValue(int32_t  groupId, int32_t  elementId, float_t  value) ;

/// @brief Method TriggerValue, addr 0x3af9408, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3af940c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
