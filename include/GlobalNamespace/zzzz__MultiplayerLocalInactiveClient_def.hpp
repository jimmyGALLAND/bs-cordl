...
/// @brief Method LateUpdate, addr 0x3b2ef68, size 0x348, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b2f2b0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
