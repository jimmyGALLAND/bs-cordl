...
/// @brief Field _beatmapLevel, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapLevel, put=__cordl_internal_set__beatmapLevel)) ::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityW<::GlobalNamespace::BeatmapLevelSO>>*  _beatmapLevel;

/// @brief Field _colorScheme, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__colorScheme, put=__cordl_internal_set__colorScheme)) ::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityW<::GlobalNamespace::ColorSchemeSO>>*  _colorScheme;

/// @brief Field _environmentInfo, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__environmentInfo, put=__cordl_internal_set__environmentInfo)) ::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*  _environmentInfo;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*> const& __cordl_internal_get__environmentInfo() const;
...
/// @brief Method .ctor, addr 0x3aac50c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_backButtonText, addr 0x3aac4e8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_backButtonText() ;

/// @brief Method get_beatmapCharacteristic, addr 0x3aac498, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> get_beatmapCharacteristic() ;

/// @brief Method get_beatmapDifficulty, addr 0x3aac4a8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapDifficulty get_beatmapDifficulty() ;

/// @brief Method get_beatmapLevel, addr 0x3aac2f8, size 0xcc, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::BeatmapLevelSO> get_beatmapLevel() ;

/// @brief Method get_colorScheme, addr 0x3aac3c4, size 0xcc, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::ColorSchemeSO> get_colorScheme() ;

/// @brief Method get_environmentInfo, addr 0x3aabbdc, size 0xcc, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> get_environmentInfo() ;

/// @brief Method get_gameplayModifiers, addr 0x3aac4b8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers() ;

/// @brief Method get_playerSpecificSettings, addr 0x3aac4c8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSpecificSettings() ;

/// @brief Method get_practiceSettings, addr 0x3aac4d8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::PracticeSettings* get_practiceSettings() ;

/// @brief Method get_useTestNoteCutSoundEffects, addr 0x3aac4f8, size 0x8, virtual false, abstract: false, final false
inline bool get_useTestNoteCutSoundEffects() ;

/// @brief Method set_backButtonText, addr 0x3aac4f0, size 0x8, virtual false, abstract: false, final false
inline void set_backButtonText(::StringW  value) ;

/// @brief Method set_beatmapCharacteristic, addr 0x3aac4a0, size 0x8, virtual false, abstract: false, final false
inline void set_beatmapCharacteristic(::GlobalNamespace::BeatmapCharacteristicSO*  value) ;

/// @brief Method set_beatmapDifficulty, addr 0x3aac4b0, size 0x8, virtual false, abstract: false, final false
inline void set_beatmapDifficulty(::GlobalNamespace::BeatmapDifficulty  value) ;

/// @brief Method set_gameplayModifiers, addr 0x3aac4c0, size 0x8, virtual false, abstract: false, final false
inline void set_gameplayModifiers(::GlobalNamespace::GameplayModifiers*  value) ;

/// @brief Method set_playerSpecificSettings, addr 0x3aac4d0, size 0x8, virtual false, abstract: false, final false
inline void set_playerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings*  value) ;

/// @brief Method set_practiceSettings, addr 0x3aac4e0, size 0x8, virtual false, abstract: false, final false
inline void set_practiceSettings(::GlobalNamespace::PracticeSettings*  value) ;

/// @brief Method set_useTestNoteCutSoundEffects, addr 0x3aac500, size 0xc, virtual false, abstract: false, final false
