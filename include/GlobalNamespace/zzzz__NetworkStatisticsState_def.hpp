...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x2290c84, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x2290d10, size 0xc, virtual true, abstract: false, final false
inline void EndInvoke(ByRef<::GlobalNamespace::NetworkStatisticsState>  statisticsState, ::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x2290c70, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2290bd4, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2290b34, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method op_Subtraction, addr 0x2290b5c, size 0x50, virtual false, abstract: false, final false
