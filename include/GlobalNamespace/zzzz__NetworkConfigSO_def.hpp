...
/// @brief Method .ctor, addr 0x3de1bac, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_appId, addr 0x3de1b2c, size 0x70, virtual true, abstract: false, final true
inline ::StringW get_appId() ;

/// @brief Method get_discoveryPort, addr 0x3de1a2c, size 0x8, virtual true, abstract: false, final true
inline int32_t get_discoveryPort() ;

/// @brief Method get_forceGameLift, addr 0x3de1b9c, size 0x8, virtual true, abstract: false, final true
inline bool get_forceGameLift() ;

/// @brief Method get_graphAccessToken, addr 0x3de1ac4, size 0x68, virtual true, abstract: false, final true
inline ::StringW get_graphAccessToken() ;

/// @brief Method get_graphUrl, addr 0x3de1abc, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_graphUrl() ;

/// @brief Method get_masterServerEndPoint, addr 0x3de1a44, size 0x68, virtual true, abstract: false, final true
inline ::GlobalNamespace::DnsEndPoint* get_masterServerEndPoint() ;

/// @brief Method get_maxPartySize, addr 0x3de1a24, size 0x8, virtual true, abstract: false, final true
inline int32_t get_maxPartySize() ;

/// @brief Method get_multiplayerPort, addr 0x3de1a3c, size 0x8, virtual true, abstract: false, final true
inline int32_t get_multiplayerPort() ;

/// @brief Method get_multiplayerStatusUrl, addr 0x3de1aac, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_multiplayerStatusUrl() ;

/// @brief Method get_partyPort, addr 0x3de1a34, size 0x8, virtual true, abstract: false, final true
inline int32_t get_partyPort() ;

/// @brief Method get_quickPlaySetupUrl, addr 0x3de1ab4, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_quickPlaySetupUrl() ;

/// @brief Method get_serviceEnvironment, addr 0x3de1ba4, size 0x8, virtual true, abstract: false, final true
