...
/// @brief Method AddSample, addr 0x3a497a0, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a496e4, size 0xbc, virtual false, abstract: false, final false
inline void _ctor(int32_t  numChannels, int32_t  sampleFrequency, float_t  momentaryWindowDuration, int32_t  readingsPerBuffer) ;

/// @brief Method get_buffer, addr 0x3a4d02c, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> get_buffer() ;

/// @brief Method get_isNextReadingIntervalReady, addr 0x3a497e4, size 0x1c, virtual false, abstract: false, final false
