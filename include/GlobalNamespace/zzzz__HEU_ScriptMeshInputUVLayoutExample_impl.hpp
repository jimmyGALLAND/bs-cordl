...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::ArrayW<::UnityEngine::GameObject*,::Array<::UnityEngine::GameObject*>*>, ::GlobalNamespace::__HEU_ScriptMeshInputUVLayoutExample__OutputMode, ::StringW)>(&::GlobalNamespace::HEU_ScriptMeshInputUVLayoutExample::ApplyUVLayoutTo)> {
  constexpr static std::size_t size = 0x858;
  constexpr static std::size_t addrs = 0x3981720;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<::UnityEngine::GameObject*,::Array<::UnityEngine::GameObject*>*>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__HEU_ScriptMeshInputUVLayoutExample__OutputMode>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::HEU_ScriptMeshInputUVLayoutExample::*)()>(&::GlobalNamespace::HEU_ScriptMeshInputUVLayoutExample::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x398201c;
...
inline void GlobalNamespace::HEU_ScriptMeshInputUVLayoutExample::ApplyUVLayoutTo(::ArrayW<::UnityEngine::GameObject*,::Array<::UnityEngine::GameObject*>*>  gameObjects, ::GlobalNamespace::__HEU_ScriptMeshInputUVLayoutExample__OutputMode  outputMode, ::StringW  output_name_suffix)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::HEU_ScriptMeshInputUVLayoutExample*>::get(),
                        "ApplyUVLayoutTo",
                        std::span<const Il2CppClass* const, 0>(),
