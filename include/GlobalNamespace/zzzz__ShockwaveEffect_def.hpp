...
/// @brief Method SpawnShockwave, addr 0x3af2f00, size 0xd4, virtual false, abstract: false, final false
inline void SpawnShockwave(::UnityEngine::Vector3  pos) ;

/// @brief Method Start, addr 0x3af2dc0, size 0x140, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3af2fd4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
