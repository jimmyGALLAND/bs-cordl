...
/// @brief Method Format, addr 0x26aeb3c, size 0x80, virtual false, abstract: false, final false
static inline ::StringW Format(int32_t  score) ;

static inline ::GlobalNamespace::ScoreFormatter* New_ctor() ;

/// @brief Method .ctor, addr 0x26aebbc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
