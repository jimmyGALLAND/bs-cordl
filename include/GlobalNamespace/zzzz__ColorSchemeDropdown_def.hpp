...
/// @brief Field _colorSchemes, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__colorSchemes, put=__cordl_internal_set__colorSchemes)) ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::ColorScheme*>*  _colorSchemes;
...
/// @brief Method CellForIdx, addr 0x3b62d24, size 0x298, virtual true, abstract: false, final true
inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView*  tableView, int32_t  idx) ;

/// @brief Method CellSize, addr 0x3b62c70, size 0x8, virtual true, abstract: false, final true
inline float_t CellSize(int32_t  idx) ;

/// @brief Method HandleDidSelectCellWithIdx, addr 0x3b63140, size 0x138, virtual false, abstract: false, final false
inline void HandleDidSelectCellWithIdx(::HMUI::DropdownWithTableView*  dropdownWithTableView, int32_t  idx) ;

/// @brief Method Init, addr 0x3b629e8, size 0x38, virtual false, abstract: false, final false
inline void Init(::HMUI::__TableView__IDataSource*  initTableViewDataSource) ;

/// @brief Method LazyInit, addr 0x3b628b0, size 0xa8, virtual false, abstract: false, final false
inline void LazyInit() ;

static inline ::GlobalNamespace::ColorSchemeDropdown* New_ctor() ;

/// @brief Method NumberOfCells, addr 0x3b62c78, size 0xac, virtual true, abstract: false, final true
inline int32_t NumberOfCells() ;

/// @brief Method OnDestroy, addr 0x3b62958, size 0x90, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method RefreshUI, addr 0x3b62b78, size 0xf8, virtual false, abstract: false, final false
inline void RefreshUI(::GlobalNamespace::ColorScheme*  colorScheme) ;

/// @brief Method SelectCellWithIdx, addr 0x3b6307c, size 0xc4, virtual true, abstract: false, final false
inline void SelectCellWithIdx(int32_t  idx) ;

/// @brief Method SetData, addr 0x3b62a20, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b63278, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
