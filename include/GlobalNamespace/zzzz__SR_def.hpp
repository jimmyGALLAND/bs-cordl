...
public:
// Declarations
/// @brief Method Format, addr 0x41b34c0, size 0x70, virtual false, abstract: false, final false
static inline ::StringW Format(::StringW  resourceFormat, ::System::Object*  p1) ;

/// @brief Method Format, addr 0x41b3530, size 0x78, virtual false, abstract: false, final false
