...
/// @brief Method DidDeactivate, addr 0x3b81c9c, size 0x44, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleOpenPartyToggleChanged, addr 0x3b81d10, size 0x10, virtual false, abstract: false, final false
inline void HandleOpenPartyToggleChanged(bool  openParty) ;

/// @brief Method NetworkPlayersViewControllerDidActivate, addr 0x3b81a08, size 0x114, virtual true, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b81ce0, size 0x28, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method RefreshParty, addr 0x3b81b1c, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b81d20, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_myPartyTitle, addr 0x3b81980, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_myPartyTitle() ;

/// @brief Method get_networkPlayerModel, addr 0x3b81a00, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::INetworkPlayerModel* get_networkPlayerModel() ;

/// @brief Method get_otherPlayersTitle, addr 0x3b819c0, size 0x40, virtual true, abstract: false, final false
