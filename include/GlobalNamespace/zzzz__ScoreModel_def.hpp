...
/// @brief Method .ctor, addr 0x26afc40, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method get_executionOrder, addr 0x26afcac, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_executionOrder() ;

/// @brief Method get_maxCutScore, addr 0x26aecf4, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method CompareTo, addr 0x26afcc8, size 0x94, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x26af768, size 0x84, virtual false, abstract: false, final false
...
static __declspec(property(get=getStaticF__scoreDefinitions, put=setStaticF__scoreDefinitions)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__NoteData__ScoringType,::GlobalNamespace::__ScoreModel__NoteScoreDefinition*>*  _scoreDefinitions;
...
static __declspec(property(get=getStaticF_fullScoreScoringTypes, put=setStaticF_fullScoreScoringTypes)) ::System::Collections::Generic::HashSet_1<::GlobalNamespace::__NoteData__ScoringType>*  fullScoreScoringTypes;

/// @brief Method ComputeMaxMultipliedScoreForBeatmap, addr 0x26aed10, size 0xa58, virtual false, abstract: false, final false
static inline int32_t ComputeMaxMultipliedScoreForBeatmap(::GlobalNamespace::IReadonlyBeatmapData*  beatmapData) ;

/// @brief Method ComputeQuickInaccurateMaxMultipliedScoreForBeatmap, addr 0x26aec44, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method GetModifiedScoreForGameplayModifiersScoreMultiplier, addr 0x26af894, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method GetNoteScoreDefinition, addr 0x26aebc4, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26af914, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
