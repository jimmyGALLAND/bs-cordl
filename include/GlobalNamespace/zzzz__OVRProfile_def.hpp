...
/// @brief Method .ctor, addr 0x3f75cf8, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_eyeDepth, addr 0x3f75c84, size 0x50, virtual false, abstract: false, final false
inline float_t get_eyeDepth() ;

/// @brief Method get_eyeHeight, addr 0x3f75c34, size 0x50, virtual false, abstract: false, final false
inline float_t get_eyeHeight() ;

/// @brief Method get_id, addr 0x3f75a40, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_id() ;

/// @brief Method get_ipd, addr 0x3f75b00, size 0x134, virtual false, abstract: false, final false
inline float_t get_ipd() ;

/// @brief Method get_locale, addr 0x3f75ac0, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_locale() ;

/// @brief Method get_neckHeight, addr 0x3f75cd4, size 0x1c, virtual false, abstract: false, final false
inline float_t get_neckHeight() ;

/// @brief Method get_state, addr 0x3f75cf0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__OVRProfile__State get_state() ;

/// @brief Method get_userName, addr 0x3f75a80, size 0x40, virtual false, abstract: false, final false
