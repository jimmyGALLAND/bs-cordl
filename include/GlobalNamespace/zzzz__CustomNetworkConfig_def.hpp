...
/// @brief Field <masterServerEndPoint>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__masterServerEndPoint_k__BackingField, put=__cordl_internal_set__masterServerEndPoint_k__BackingField)) ::GlobalNamespace::DnsEndPoint*  _masterServerEndPoint_k__BackingField;
...
/// @brief Field <multiplayerStatusUrl>k__BackingField, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerStatusUrl_k__BackingField, put=__cordl_internal_set__multiplayerStatusUrl_k__BackingField)) ::StringW  _multiplayerStatusUrl_k__BackingField;
...
/// @brief Field <serviceEnvironment>k__BackingField, offset 0x44, size 0x4 
 __declspec(property(get=__cordl_internal_get__serviceEnvironment_k__BackingField, put=__cordl_internal_set__serviceEnvironment_k__BackingField)) ::GlobalNamespace::ServiceEnvironment  _serviceEnvironment_k__BackingField;
...
/// @brief Method .ctor, addr 0x22760b4, size 0x4a8, virtual false, abstract: false, final false
...
/// @brief Method get_appId, addr 0x227606c, size 0x48, virtual true, abstract: false, final true
inline ::StringW get_appId() ;

/// @brief Method get_discoveryPort, addr 0x2275fdc, size 0x8, virtual true, abstract: false, final true
inline int32_t get_discoveryPort() ;

/// @brief Method get_forceGameLift, addr 0x227605c, size 0x8, virtual true, abstract: false, final true
inline bool get_forceGameLift() ;

/// @brief Method get_graphAccessToken, addr 0x2276054, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_graphAccessToken() ;

/// @brief Method get_graphUrl, addr 0x227604c, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_graphUrl() ;

/// @brief Method get_masterServerEndPoint, addr 0x2275ff4, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::DnsEndPoint* get_masterServerEndPoint() ;

/// @brief Method get_maxPartySize, addr 0x2275fd4, size 0x8, virtual true, abstract: false, final true
inline int32_t get_maxPartySize() ;

/// @brief Method get_multiplayerPort, addr 0x2275fec, size 0x8, virtual true, abstract: false, final true
inline int32_t get_multiplayerPort() ;

/// @brief Method get_multiplayerStatusUrl, addr 0x2275ffc, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_multiplayerStatusUrl() ;

/// @brief Method get_partyPort, addr 0x2275fe4, size 0x8, virtual true, abstract: false, final true
inline int32_t get_partyPort() ;

/// @brief Method get_quickPlaySetupUrl, addr 0x2276004, size 0x48, virtual true, abstract: false, final true
inline ::StringW get_quickPlaySetupUrl() ;

/// @brief Method get_serviceEnvironment, addr 0x2276064, size 0x8, virtual true, abstract: false, final true
