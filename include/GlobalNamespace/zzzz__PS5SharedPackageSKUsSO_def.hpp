...
/// @brief Method .ctor, addr 0x269aa24, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_contentVersion, addr 0x269aa1c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_contentVersion() ;

/// @brief Method get_masterVersion, addr 0x269aa14, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _availableSKUs, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__availableSKUs, put=__cordl_internal_set__availableSKUs)) ::ArrayW<::UnityW<::GlobalNamespace::PS5PublisherSKUSettingsSO>,::Array<::UnityW<::GlobalNamespace::PS5PublisherSKUSettingsSO>>*>  _availableSKUs;
...
/// @brief Method GetPrimarySKU, addr 0x269a9e8, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x269aa0c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_availableSKUs, addr 0x269a9c0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_buildType, addr 0x269a9d0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__PS5SharedPackageSKUsSO__BuildType get_buildType() ;

/// @brief Method get_buildVersion, addr 0x269a9d8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__PS5SharedPackageSKUsSO__PS5BuildVersion* get_buildVersion() ;

/// @brief Method get_conceptId, addr 0x269a9c8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_conceptId() ;

/// @brief Method get_latestBuildVersion, addr 0x269a9e0, size 0x8, virtual false, abstract: false, final false
