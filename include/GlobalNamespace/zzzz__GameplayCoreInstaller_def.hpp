...
/// @brief Method GetEnvironmentInfoSource, addr 0x3b5ef14, size 0x90, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> GetEnvironmentInfoSource(::GlobalNamespace::BeatmapKey  beatmapKey) ;

/// @brief Method InstallBindings, addr 0x3b5d89c, size 0x1678, virtual true, abstract: false, final false
inline void InstallBindings() ;

/// @brief Method InstallRecordingTool, addr 0x3b5efa4, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b5f09c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
