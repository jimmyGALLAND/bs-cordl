...
template<typename T>
constexpr ::System::Threading::Tasks::TaskCompletionSource_1<T>*& GlobalNamespace::AsyncComputeOperation_1<T>::__cordl_internal_get__tcs()  {
...
template<typename T>
constexpr void GlobalNamespace::AsyncComputeOperation_1<T>::__cordl_internal_set__tcs(::System::Threading::Tasks::TaskCompletionSource_1<T>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::AsyncComputeOperation_1<T>::AsyncComputeOperation_1()   {
}
