...
/// @brief Field _missionNodes, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__missionNodes, put=__cordl_internal_set__missionNodes)) ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>,::Array<::UnityW<::GlobalNamespace::MissionNode>>*>  _missionNodes;
...
/// @brief Field didSelectMissionNodeEvent, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_didSelectMissionNodeEvent, put=__cordl_internal_set_didSelectMissionNodeEvent)) ::System::Action_1<::UnityW<::GlobalNamespace::MissionNodeVisualController>>*  didSelectMissionNodeEvent;

/// @brief Method DeselectSelectedNode, addr 0x3b74f18, size 0x80, virtual false, abstract: false, final false
inline void DeselectSelectedNode() ;

/// @brief Method HandleNodeWasDisplayed, addr 0x3b755d0, size 0x80, virtual false, abstract: false, final false
inline void HandleNodeWasDisplayed(::GlobalNamespace::MissionNodeVisualController*  missionNode) ;

/// @brief Method HandleNodeWasSelect, addr 0x3b7551c, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b75254, size 0x168, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b74fc4, size 0x130, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b75650, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didSelectMissionNodeEvent, addr 0x3b74db8, size 0xb0, virtual false, abstract: false, final false
inline void add_didSelectMissionNodeEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionNodeVisualController>>*  value) ;

/// @brief Method remove_didSelectMissionNodeEvent, addr 0x3b74e68, size 0xb0, virtual false, abstract: false, final false
