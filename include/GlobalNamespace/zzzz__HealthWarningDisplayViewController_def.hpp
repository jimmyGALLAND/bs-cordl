...
/// @brief Method DidActivate, addr 0x3b84c9c, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b84cd8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
