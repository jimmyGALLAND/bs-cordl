...
static __declspec(property(get=getStaticF__defaults, put=setStaticF__defaults)) ::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::LightTranslationBeatmapEventData*>*  _defaults;
...
/// @brief Method ChangeTranslation, addr 0x2202098, size 0x8, virtual false, abstract: false, final false
inline void ChangeTranslation(float_t  translation, float_t  distribution) ;

/// @brief Method GetCopy, addr 0x22020a0, size 0xa8, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapDataItem* GetCopy() ;

/// @brief Method GetDefault, addr 0x2202148, size 0x15c, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapEventData* GetDefault() ;

static inline ::GlobalNamespace::LightTranslationBeatmapEventData* New_ctor(float_t  time, int32_t  groupId, int32_t  elementId, bool  usePreviousEventValue, ::GlobalNamespace::EaseType  easeType, ::GlobalNamespace::LightAxis  axis, float_t  translation, float_t  distribution) ;

/// @brief Method SubtypeIdentifier, addr 0x2202080, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2201fa0, size 0xe0, virtual false, abstract: false, final false
inline void _ctor(float_t  time, int32_t  groupId, int32_t  elementId, bool  usePreviousEventValue, ::GlobalNamespace::EaseType  easeType, ::GlobalNamespace::LightAxis  axis, float_t  translation, float_t  distribution) ;
...
/// @brief Method get_distribution, addr 0x2201f90, size 0x8, virtual false, abstract: false, final false
inline float_t get_distribution() ;

/// @brief Method get_translation, addr 0x2201f80, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_distribution, addr 0x2201f98, size 0x8, virtual false, abstract: false, final false
inline void set_distribution(float_t  value) ;

/// @brief Method set_translation, addr 0x2201f88, size 0x8, virtual false, abstract: false, final false
