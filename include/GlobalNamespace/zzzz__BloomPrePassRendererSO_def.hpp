...
/// @brief Method .ctor, addr 0x39576a0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field lightQuads, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_lightQuads, put=__cordl_internal_set_lightQuads)) ::ArrayW<::GlobalNamespace::__BloomPrePassLight__QuadData,::Array<::GlobalNamespace::__BloomPrePassLight__QuadData>*>  lightQuads;
...
/// @brief Method .ctor, addr 0x39566d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _lightsRenderingData, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightsRenderingData, put=__cordl_internal_set__lightsRenderingData)) ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::BloomPrePassLightTypeSO>,::GlobalNamespace::__BloomPrePassRendererSO__LightsRenderingData*>*  _lightsRenderingData;
...
/// @brief Field _preallocationData, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__preallocationData, put=__cordl_internal_set__preallocationData)) ::ArrayW<::GlobalNamespace::__BloomPrePassRendererSO__PreallocationData*,::Array<::GlobalNamespace::__BloomPrePassRendererSO__PreallocationData*>*>  _preallocationData;
...
/// @brief Method Cleanup, addr 0x395653c, size 0x198, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CreateBloomPrePassRenderTextureIfNeeded, addr 0x39525b4, size 0x2f0, virtual false, abstract: false, final false
...
/// @brief Method DisableBloomFog, addr 0x3953448, size 0x1c, virtual false, abstract: false, final false
inline void DisableBloomFog() ;

/// @brief Method EnableBloomFog, addr 0x39532a4, size 0x1c, virtual false, abstract: false, final false
inline void EnableBloomFog() ;

/// @brief Method GetCameraParams, addr 0x3952440, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x3952000, size 0x140, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method MatrixLerp, addr 0x3957470, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x3956538, size 0x4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x395651c, size 0x1c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method PrepareLightsMeshRendering, addr 0x39566dc, size 0x4f4, virtual false, abstract: false, final false
...
/// @brief Method RenderAllLights, addr 0x3956bd0, size 0x788, virtual false, abstract: false, final false
inline void RenderAllLights(::UnityEngine::Matrix4x4  viewMatrix, ::UnityEngine::Matrix4x4  projectionMatrix, float_t  linesWidth) ;

/// @brief Method RenderAndSetData, addr 0x39528a4, size 0xa00, virtual false, abstract: false, final false
...
/// @brief Method SetCustomStereoCameraEyeOffset, addr 0x39573ec, size 0x6c, virtual false, abstract: false, final false
inline void SetCustomStereoCameraEyeOffset(float_t  stereoCameraEyeOffset) ;

/// @brief Method SetDataToShaders, addr 0x39532c0, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method UpdateBloomFogParams, addr 0x3957458, size 0x18, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::BloomPrePassLightTypeSO>,::GlobalNamespace::__BloomPrePassRendererSO__LightsRenderingData*>*& __cordl_internal_get__lightsRenderingData() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::BloomPrePassLightTypeSO>,::GlobalNamespace::__BloomPrePassRendererSO__LightsRenderingData*>*> const& __cordl_internal_get__lightsRenderingData() const;
...
constexpr ::ArrayW<::GlobalNamespace::__BloomPrePassRendererSO__PreallocationData*,::Array<::GlobalNamespace::__BloomPrePassRendererSO__PreallocationData*>*> const& __cordl_internal_get__preallocationData() const;

constexpr ::ArrayW<::GlobalNamespace::__BloomPrePassRendererSO__PreallocationData*,::Array<::GlobalNamespace::__BloomPrePassRendererSO__PreallocationData*>*>& __cordl_internal_get__preallocationData() ;
...
constexpr void __cordl_internal_set__lightsRenderingData(::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::BloomPrePassLightTypeSO>,::GlobalNamespace::__BloomPrePassRendererSO__LightsRenderingData*>*  value) ;

constexpr void __cordl_internal_set__lowestResBloomTexture(::UnityW<::UnityEngine::RenderTexture>  value) ;

constexpr void __cordl_internal_set__preallocationData(::ArrayW<::GlobalNamespace::__BloomPrePassRendererSO__PreallocationData*,::Array<::GlobalNamespace::__BloomPrePassRendererSO__PreallocationData*>*>  value) ;

/// @brief Method .ctor, addr 0x3957528, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
