...
/// @brief Method .ctor, addr 0x2661ff8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ceilingType, addr 0x2661fe8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__EnvironmentSizeData__CeilingType get_ceilingType() ;

/// @brief Method get_floorType, addr 0x2661fe0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__EnvironmentSizeData__FloorType get_floorType() ;

/// @brief Method get_trackLaneType, addr 0x2661ff0, size 0x8, virtual false, abstract: false, final false
