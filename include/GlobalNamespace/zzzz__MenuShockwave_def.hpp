...
/// @brief Method Awake, addr 0x3b6b940, size 0x10, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleButtonClickEvent, addr 0x3b6baf0, size 0x28, virtual false, abstract: false, final false
inline void HandleButtonClickEvent() ;

static inline ::GlobalNamespace::MenuShockwave* New_ctor() ;

/// @brief Method OnDisable, addr 0x3b6ba20, size 0xd0, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3b6b950, size 0xd0, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method SpawnShockwave, addr 0x3b6bb18, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b6bbbc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
