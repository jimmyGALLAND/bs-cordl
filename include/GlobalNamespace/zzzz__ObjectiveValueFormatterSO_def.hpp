...
public:
// Declarations
/// @brief Method FormatValue, addr 0x2687524, size 0x1c, virtual true, abstract: false, final false
inline ::StringW FormatValue(int32_t  value) ;

static inline ::GlobalNamespace::ObjectiveValueFormatterSO* New_ctor() ;

/// @brief Method .ctor, addr 0x26870ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
