...
/// @brief Method AnimateEnabled, addr 0x3b37908, size 0x144, virtual false, abstract: false, final false
inline void AnimateEnabled(bool  isEnabled, float_t  duration, ::GlobalNamespace::EaseType  easeType) ;

/// @brief Method AnimateFontSize, addr 0x3b37830, size 0x48, virtual false, abstract: false, final false
inline void AnimateFontSize(float_t  fontSize, float_t  duration, ::GlobalNamespace::EaseType  easeType) ;

/// @brief Method AnimatePositionOffsetSize, addr 0x3b37878, size 0x90, virtual false, abstract: false, final false
inline void AnimatePositionOffsetSize(::UnityEngine::Vector3  offset, float_t  duration, ::GlobalNamespace::EaseType  easeType) ;

/// @brief Method AnimateTextColor, addr 0x3b37794, size 0x9c, virtual false, abstract: false, final false
inline void AnimateTextColor(::UnityEngine::Color  color, float_t  duration, ::GlobalNamespace::EaseType  easeType) ;

/// @brief Method Awake, addr 0x3b37324, size 0x3e8, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::MultiplayerCenterTextAnimator* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b3770c, size 0x88, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetText, addr 0x3b37a4c, size 0x24, virtual false, abstract: false, final false
inline void SetText(::StringW  text) ;

/// @brief Method <Awake>b__8_0, addr 0x3b37a78, size 0x78, virtual false, abstract: false, final false
inline void _Awake_b__8_0(float_t  val) ;

/// @brief Method <Awake>b__8_1, addr 0x3b37af0, size 0x78, virtual false, abstract: false, final false
inline void _Awake_b__8_1(float_t  val) ;

/// @brief Method <Awake>b__8_2, addr 0x3b37b94, size 0x1c, virtual false, abstract: false, final false
inline void _Awake_b__8_2(float_t  val) ;

/// @brief Method <Awake>b__8_3, addr 0x3b37bb0, size 0x24, virtual false, abstract: false, final false
inline void _Awake_b__8_3(::UnityEngine::Color  val) ;

/// @brief Method <Awake>b__8_4, addr 0x3b37bd4, size 0x1c, virtual false, abstract: false, final false
inline void _Awake_b__8_4(::UnityEngine::Vector3  val) ;

/// @brief Method <Awake>b__8_5, addr 0x3b37b68, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b37a70, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
