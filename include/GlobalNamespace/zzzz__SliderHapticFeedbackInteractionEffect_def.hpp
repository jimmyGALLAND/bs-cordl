...
/// @brief Method EndEffect, addr 0x3a6d1e8, size 0xc, virtual true, abstract: false, final false
inline void EndEffect() ;

static inline ::GlobalNamespace::SliderHapticFeedbackInteractionEffect* New_ctor() ;

/// @brief Method Start, addr 0x3a6cf30, size 0x40, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method StartEffect, addr 0x3a6d1a0, size 0x48, virtual true, abstract: false, final false
inline void StartEffect(float_t  saberInteractionParam) ;

/// @brief Method Update, addr 0x3a6d070, size 0xd4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method Vibrate, addr 0x3a6d160, size 0x40, virtual false, abstract: false, final false
inline void Vibrate() ;
...
/// @brief Method .ctor, addr 0x3a6d1f4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
