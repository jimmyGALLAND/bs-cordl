...
/// @brief Method ColorWasSet, addr 0x39618cc, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39618ec, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
