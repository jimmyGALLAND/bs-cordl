...
static __declspec(property(get=getStaticF__defaults, put=setStaticF__defaults)) ::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::LightRotationBeatmapEventData*>*  _defaults;
...
/// @brief Method ChangeRotation, addr 0x2201cd4, size 0x8, virtual false, abstract: false, final false
inline void ChangeRotation(float_t  rotation) ;

/// @brief Method GetCopy, addr 0x2201cdc, size 0xb8, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapDataItem* GetCopy() ;

/// @brief Method GetDefault, addr 0x2201d94, size 0x160, virtual true, abstract: false, final false
...
/// @brief Method SubtypeIdentifier, addr 0x2201cbc, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2201bd4, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method get_axis, addr 0x2201b94, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::LightAxis get_axis() ;

/// @brief Method get_easeType, addr 0x2201b84, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::EaseType get_easeType() ;

/// @brief Method get_elementId, addr 0x2201b60, size 0x8, virtual false, abstract: false, final false
inline int32_t get_elementId() ;

/// @brief Method get_groupId, addr 0x2201b50, size 0x8, virtual false, abstract: false, final false
inline int32_t get_groupId() ;

/// @brief Method get_loopCount, addr 0x2201ba4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_loopCount() ;

/// @brief Method get_rotation, addr 0x2201bc4, size 0x8, virtual false, abstract: false, final false
inline float_t get_rotation() ;

/// @brief Method get_rotationDirection, addr 0x2201bb4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::LightRotationDirection get_rotationDirection() ;

/// @brief Method get_usePreviousEventValue, addr 0x2201b70, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_axis, addr 0x2201b9c, size 0x8, virtual false, abstract: false, final false
inline void set_axis(::GlobalNamespace::LightAxis  value) ;

/// @brief Method set_easeType, addr 0x2201b8c, size 0x8, virtual false, abstract: false, final false
inline void set_easeType(::GlobalNamespace::EaseType  value) ;

/// @brief Method set_elementId, addr 0x2201b68, size 0x8, virtual false, abstract: false, final false
inline void set_elementId(int32_t  value) ;

/// @brief Method set_groupId, addr 0x2201b58, size 0x8, virtual false, abstract: false, final false
inline void set_groupId(int32_t  value) ;

/// @brief Method set_loopCount, addr 0x2201bac, size 0x8, virtual false, abstract: false, final false
inline void set_loopCount(int32_t  value) ;

/// @brief Method set_rotation, addr 0x2201bcc, size 0x8, virtual false, abstract: false, final false
inline void set_rotation(float_t  value) ;

/// @brief Method set_rotationDirection, addr 0x2201bbc, size 0x8, virtual false, abstract: false, final false
inline void set_rotationDirection(::GlobalNamespace::LightRotationDirection  value) ;

/// @brief Method set_usePreviousEventValue, addr 0x2201b78, size 0xc, virtual false, abstract: false, final false
