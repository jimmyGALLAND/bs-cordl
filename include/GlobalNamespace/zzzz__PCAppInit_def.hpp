...
/// @brief Method AppStartAndMultiSceneEditorSetup, addr 0x26cce20, size 0x68, virtual true, abstract: false, final false
inline void AppStartAndMultiSceneEditorSetup() ;

/// @brief Method InstallBindings, addr 0x26cd0e4, size 0x244, virtual true, abstract: false, final false
inline void InstallBindings() ;

static inline ::GlobalNamespace::PCAppInit* New_ctor() ;

/// @brief Method RepeatableSetupAsync, addr 0x26cce88, size 0xa0, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* RepeatableSetupAsync() ;

/// @brief Method TransitionToNextScene, addr 0x26ccf28, size 0x1bc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26cd328, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
