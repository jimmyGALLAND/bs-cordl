...
/// @brief Method EnsureOpponentAssigned, addr 0x3b3b638, size 0x2c, virtual false, abstract: false, final false
inline bool EnsureOpponentAssigned() ;

/// @brief Method GetOpponentPlayer, addr 0x3b3b664, size 0x3d4, virtual false, abstract: false, final false
inline ::GlobalNamespace::IConnectedPlayer* GetOpponentPlayer() ;

/// @brief Method HandleStateChanged, addr 0x3b3ba38, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b3b504, size 0xcc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b3b288, size 0xd4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3b3b5d0, size 0x68, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateScoreAndName, addr 0x3b3b35c, size 0x1a8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b3bb30, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
