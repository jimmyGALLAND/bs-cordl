...
/// @brief Method HandleInputFocusCaptured, addr 0x393d8e8, size 0x40, virtual false, abstract: false, final false
inline void HandleInputFocusCaptured() ;

/// @brief Method HandleInputFocusReleased, addr 0x393dad0, size 0x24, virtual false, abstract: false, final false
inline void HandleInputFocusReleased() ;

static inline ::GlobalNamespace::DeactivateAnimatorOnInputFocusCapture* New_ctor() ;

/// @brief Method OnDestroy, addr 0x393d928, size 0x1a8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x393d6d4, size 0x214, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x393daf4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
