...
/// @brief Method InstallBindings, addr 0x3b06500, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b065c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
