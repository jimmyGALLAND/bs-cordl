...
/// @brief Method RegisterColliderEventEffect, addr 0x3b03900, size 0x60, virtual false, abstract: false, final false
inline void RegisterColliderEventEffect(::GlobalNamespace::ColliderEventEffect*  colliderEventEffect) ;

/// @brief Method TryGetColliderEventEffect, addr 0x3b03978, size 0xb8, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Collider>,::UnityW<::GlobalNamespace::ColliderEventEffect>>*> const& __cordl_internal_get__colliders() const;
...
/// @brief Method .ctor, addr 0x3b03a30, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
