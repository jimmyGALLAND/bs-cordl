...
/// @brief Method Awake, addr 0x39416ac, size 0x64, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::EnableOnVisible* New_ctor() ;

/// @brief Method OnBecameInvisible, addr 0x3941798, size 0x88, virtual false, abstract: false, final false
inline void OnBecameInvisible() ;

/// @brief Method OnBecameVisible, addr 0x3941710, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3941820, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_VisibilityChangedEvent, addr 0x394154c, size 0xb0, virtual false, abstract: false, final false
inline void add_VisibilityChangedEvent(::System::Action_1<bool>*  value) ;

/// @brief Method remove_VisibilityChangedEvent, addr 0x39415fc, size 0xb0, virtual false, abstract: false, final false
