...
public:
// Declarations
/// @brief Method GetEscapedURLForFilePath, addr 0x2268910, size 0x78, virtual false, abstract: false, final false
static inline ::StringW GetEscapedURLForFilePath(::StringW  filePath) ;

/// @brief Method GetFileNamesFromFilePaths, addr 0x2268c78, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method GetFilePaths, addr 0x2268a44, size 0x234, virtual false, abstract: false, final false
...
/// @brief Method GetUniqueDirectoryNameByAppendingNumber, addr 0x2268988, size 0xbc, virtual false, abstract: false, final false
static inline ::StringW GetUniqueDirectoryNameByAppendingNumber(::StringW  dirName) ;

/// @brief Method PathIsUrl, addr 0x22688bc, size 0x54, virtual false, abstract: false, final false
