...
/// @brief Method FadeIn, addr 0x3a49d78, size 0x24, virtual false, abstract: false, final false
inline void FadeIn() ;

/// @brief Method FadeOut, addr 0x3a49e6c, size 0x20, virtual false, abstract: false, final false
inline void FadeOut() ;

static inline ::GlobalNamespace::AudioFading* New_ctor() ;

/// @brief Method Start, addr 0x3a49d1c, size 0x5c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3a49d9c, size 0xd0, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3a49e8c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
