...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::FixedScenesScenesTransitionSetupDataSO::*)()>(&::GlobalNamespace::FixedScenesScenesTransitionSetupDataSO::Init)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x2250500;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::FixedScenesScenesTransitionSetupDataSO::*)()>(&::GlobalNamespace::FixedScenesScenesTransitionSetupDataSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x225050c;
...
constexpr ::ArrayW<::UnityW<::GlobalNamespace::SceneInfo>,::Array<::UnityW<::GlobalNamespace::SceneInfo>>*>& GlobalNamespace::FixedScenesScenesTransitionSetupDataSO::__cordl_internal_get__sceneInfos()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____sceneInfos;
}
constexpr ::ArrayW<::UnityW<::GlobalNamespace::SceneInfo>,::Array<::UnityW<::GlobalNamespace::SceneInfo>>*> const& GlobalNamespace::FixedScenesScenesTransitionSetupDataSO::__cordl_internal_get__sceneInfos() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____sceneInfos;
}
constexpr void GlobalNamespace::FixedScenesScenesTransitionSetupDataSO::__cordl_internal_set__sceneInfos(::ArrayW<::UnityW<::GlobalNamespace::SceneInfo>,::Array<::UnityW<::GlobalNamespace::SceneInfo>>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
