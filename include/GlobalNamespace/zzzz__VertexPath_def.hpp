...
/// @brief Field _cumulativeLengthAtEachVertex, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__cumulativeLengthAtEachVertex, put=__cordl_internal_set__cumulativeLengthAtEachVertex)) ::ArrayW<float_t,::Array<float_t>*>  _cumulativeLengthAtEachVertex;
...
/// @brief Field _localVertices, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__localVertices, put=__cordl_internal_set__localVertices)) ::ArrayW<::GlobalNamespace::__VertexPath__Vertex,::Array<::GlobalNamespace::__VertexPath__Vertex>*>  _localVertices;
...
/// @brief Method AddVertex, addr 0x3aa4f94, size 0x40c, virtual false, abstract: false, final false
...
/// @brief Method GetPoint, addr 0x3aa4f5c, size 0x38, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetPoint(int32_t  index) ;

/// @brief Method GetVertex, addr 0x3aa4efc, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method SplitBezierPathIntoFixNumberOfSegments, addr 0x3aa4988, size 0x53c, virtual false, abstract: false, final false
inline void SplitBezierPathIntoFixNumberOfSegments(::GlobalNamespace::BezierPath*  bezierPath, int32_t  numberOfVertexSegments) ;

/// @brief Method TimeAtPoint, addr 0x3aa4ec4, size 0x38, virtual false, abstract: false, final false
inline float_t TimeAtPoint(int32_t  pointIndex) ;

/// @brief Method UpdateByBezierPath, addr 0x3aa4508, size 0x458, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aa4424, size 0xe4, virtual false, abstract: false, final false
inline void _ctor(int32_t  numberOfPathSegments) ;

static inline ::UnityEngine::Vector3 getStaticF__back() ;

/// @brief Method get_length, addr 0x3aa4980, size 0x8, virtual false, abstract: false, final false
