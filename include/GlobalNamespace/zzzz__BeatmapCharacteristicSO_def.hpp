...
/// @brief Method .ctor, addr 0x2667f70, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_characteristicNameLocalizationKey, addr 0x2667f38, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_characteristicNameLocalizationKey() ;

/// @brief Method get_compoundIdPartName, addr 0x2667f48, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_compoundIdPartName() ;

/// @brief Method get_containsRotationEvents, addr 0x2667f58, size 0x8, virtual false, abstract: false, final false
inline bool get_containsRotationEvents() ;

/// @brief Method get_descriptionLocalizationKey, addr 0x2667f30, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_descriptionLocalizationKey() ;

/// @brief Method get_icon, addr 0x2667f28, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_icon() ;

/// @brief Method get_numberOfColors, addr 0x2667f68, size 0x8, virtual false, abstract: false, final false
inline int32_t get_numberOfColors() ;

/// @brief Method get_requires360Movement, addr 0x2667f60, size 0x8, virtual false, abstract: false, final false
inline bool get_requires360Movement() ;

/// @brief Method get_serializedName, addr 0x2667f40, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_serializedName() ;

/// @brief Method get_sortingOrder, addr 0x2667f50, size 0x8, virtual false, abstract: false, final false
