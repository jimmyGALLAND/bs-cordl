...
/// @brief Method ApplyValue, addr 0x3b7d55c, size 0xd4, virtual true, abstract: false, final false
inline void ApplyValue(int32_t  idx) ;

/// @brief Method GetInitValues, addr 0x3b7d438, size 0x124, virtual true, abstract: false, final false
inline bool GetInitValues(ByRef<int32_t>  idx, ByRef<int32_t>  numberOfElements) ;

static inline ::GlobalNamespace::LanguageSettingsController* New_ctor() ;

/// @brief Method TextForValue, addr 0x3b7d630, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b7d694, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
