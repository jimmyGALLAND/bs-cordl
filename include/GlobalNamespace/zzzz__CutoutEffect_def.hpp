...
/// @brief Method SetCutout, addr 0x3aeb4e0, size 0xc4, virtual false, abstract: false, final false
inline void SetCutout(float_t  cutout) ;

/// @brief Method SetCutout, addr 0x3aeb864, size 0xe4, virtual false, abstract: false, final false
inline void SetCutout(float_t  cutout, ::UnityEngine::Vector3  cutoutOffset) ;

/// @brief Method Start, addr 0x3aeb828, size 0x3c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3aeb948, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_useRandomCutoutOffset, addr 0x3aeb794, size 0x94, virtual false, abstract: false, final false
