...
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Concurrent::ConcurrentBag_1<T>*> const& GlobalNamespace::PacketPool_1<T>::__cordl_internal_get__bag() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____bag;
}
template<typename T>
