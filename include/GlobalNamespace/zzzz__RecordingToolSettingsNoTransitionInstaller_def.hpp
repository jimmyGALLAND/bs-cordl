...
/// @brief Method InstallBindings, addr 0x3aabfd8, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aac01c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
