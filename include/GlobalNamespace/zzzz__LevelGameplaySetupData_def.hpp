...
/// @brief Method ClearGameplaySetupData, addr 0x268ce28, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method SetBeatmapKey, addr 0x268ce90, size 0x14, virtual false, abstract: false, final false
inline void SetBeatmapKey(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method SetGameplayModifiers, addr 0x268cea4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x268cd10, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x268cd78, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey, ::GlobalNamespace::GameplayModifiers*  gameplayModifiers) ;

/// @brief Method get_beatmapKey, addr 0x268ccf4, size 0x14, virtual true, abstract: false, final true
inline ::GlobalNamespace::BeatmapKey get_beatmapKey() ;

/// @brief Method get_gameplayModifiers, addr 0x268cd08, size 0x8, virtual true, abstract: false, final true
