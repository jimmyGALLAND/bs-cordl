...
/// @brief Method Hide, addr 0x3a7ac74, size 0x24, virtual false, abstract: false, final false
inline void Hide() ;

static inline ::GlobalNamespace::LevelStatsView* New_ctor() ;

/// @brief Method ShowStats, addr 0x3a7ac98, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a7ae24, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
