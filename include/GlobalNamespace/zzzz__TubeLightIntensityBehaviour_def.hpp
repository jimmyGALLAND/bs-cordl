...
/// @brief Method EnableObjects, addr 0x3aa95d0, size 0xd4, virtual false, abstract: false, final false
inline void EnableObjects(bool  on) ;

static inline ::GlobalNamespace::TubeLightIntensityBehaviour* New_ctor() ;

/// @brief Method OnPlayableDestroy, addr 0x3aa96a4, size 0xd4, virtual true, abstract: false, final false
inline void OnPlayableDestroy(::UnityEngine::Playables::Playable  playable) ;

/// @brief Method ProcessFrame, addr 0x3aa9254, size 0x37c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3aa9778, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
