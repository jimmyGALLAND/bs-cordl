...
namespace GlobalNamespace {
template<typename T>
class __BeatmapData____c__DisplayClass46_0_1;
}
...
/// @brief Method CompareTo, addr 0x26693c4, size 0xac, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2668c84, size 0x28, virtual false, abstract: false, final false
...
template<typename T>
using __c__DisplayClass46_0_1 = ::GlobalNamespace::__BeatmapData____c__DisplayClass46_0_1<T>;
...
/// @brief Field _allBeatmapDataItemToNodeMap, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__allBeatmapDataItemToNodeMap, put=__cordl_internal_set__allBeatmapDataItemToNodeMap)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::BeatmapDataItem*,::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapDataItem*>*>*  _allBeatmapDataItemToNodeMap;

/// @brief Field _beatmapDataItemsPerTypeAndId, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapDataItemsPerTypeAndId, put=__cordl_internal_set__beatmapDataItemsPerTypeAndId)) ::GlobalNamespace::BeatmapDataSortedListForTypeAndIds_1<::GlobalNamespace::BeatmapDataItem*>*  _beatmapDataItemsPerTypeAndId;

/// @brief Field _beatmapObjectsInTimeRowProcessor, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapObjectsInTimeRowProcessor, put=__cordl_internal_set__beatmapObjectsInTimeRowProcessor)) ::GlobalNamespace::BeatmapObjectsInTimeRowProcessor*  _beatmapObjectsInTimeRowProcessor;
...
/// @brief Field _specialBasicBeatmapEventKeywords, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__specialBasicBeatmapEventKeywords, put=__cordl_internal_set__specialBasicBeatmapEventKeywords)) ::System::Collections::Generic::HashSet_1<::StringW>*  _specialBasicBeatmapEventKeywords;

/// @brief Field <updateAllBeatmapDataOnInsert>k__BackingField, offset 0x10, size 0x1 
 __declspec(property(get=__cordl_internal_get__updateAllBeatmapDataOnInsert_k__BackingField, put=__cordl_internal_set__updateAllBeatmapDataOnInsert_k__BackingField)) bool  _updateAllBeatmapDataOnInsert_k__BackingField;
...
/// @brief Field beatmapEventDataWasInsertedEvent, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_beatmapEventDataWasInsertedEvent, put=__cordl_internal_set_beatmapEventDataWasInsertedEvent)) ::System::Action_2<::GlobalNamespace::BeatmapEventData*,::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapDataItem*>*>*  beatmapEventDataWasInsertedEvent;

/// @brief Field beatmapEventDataWasRemovedEvent, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_beatmapEventDataWasRemovedEvent, put=__cordl_internal_set_beatmapEventDataWasRemovedEvent)) ::System::Action_1<::GlobalNamespace::BeatmapEventData*>*  beatmapEventDataWasRemovedEvent;

/// @brief Field beatmapEventDataWillBeRemovedEvent, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_beatmapEventDataWillBeRemovedEvent, put=__cordl_internal_set_beatmapEventDataWillBeRemovedEvent)) ::System::Action_2<::GlobalNamespace::BeatmapEventData*,::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapDataItem*>*>*  beatmapEventDataWillBeRemovedEvent;
...
/// @brief Method AddBeatmapObjectData, addr 0x265e88c, size 0x19c, virtual false, abstract: false, final false
inline void AddBeatmapObjectData(::GlobalNamespace::BeatmapObjectData*  beatmapObjectData) ;

/// @brief Method AddBeatmapObjectDataInOrder, addr 0x266039c, size 0x2c, virtual false, abstract: false, final false
inline void AddBeatmapObjectDataInOrder(::GlobalNamespace::BeatmapObjectData*  beatmapObjectData) ;

/// @brief Method AddSpecialBasicBeatmapEventKeyword, addr 0x2660504, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method GetCopy, addr 0x2668cac, size 0x37c, virtual true, abstract: false, final true
inline ::GlobalNamespace::BeatmapData* GetCopy() ;

/// @brief Method GetFilteredCopy, addr 0x2669028, size 0x39c, virtual true, abstract: false, final true
...
/// @brief Method InsertBeatmapEventData, addr 0x265e7f0, size 0x9c, virtual false, abstract: false, final false
inline void InsertBeatmapEventData(::GlobalNamespace::BeatmapEventData*  beatmapEventData) ;

/// @brief Method InsertBeatmapEventDataInOrder, addr 0x2660344, size 0x58, virtual false, abstract: false, final false
inline void InsertBeatmapEventDataInOrder(::GlobalNamespace::BeatmapEventData*  beatmapEventData) ;

/// @brief Method InsertToAllBeatmapData, addr 0x26685d0, size 0x1d4, virtual false, abstract: false, final false
...
/// @brief Method IsBasicEventSpecialKeywordEnabled, addr 0x2668578, size 0x58, virtual true, abstract: false, final true
...
/// @brief Method ProcessAndSortBeatmapData, addr 0x266893c, size 0x348, virtual false, abstract: false, final false
inline void ProcessAndSortBeatmapData() ;

/// @brief Method ProcessRemainingData, addr 0x2668920, size 0x1c, virtual false, abstract: false, final false
inline void ProcessRemainingData() ;

/// @brief Method RemoveBeatmapEventData, addr 0x26687a4, size 0x17c, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::BeatmapDataItem*,::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapDataItem*>*>*& __cordl_internal_get__allBeatmapDataItemToNodeMap() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::BeatmapDataItem*,::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapDataItem*>*>*> const& __cordl_internal_get__allBeatmapDataItemToNodeMap() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapDataSortedListForTypeAndIds_1<::GlobalNamespace::BeatmapDataItem*>*> const& __cordl_internal_get__beatmapDataItemsPerTypeAndId() const;
...
constexpr ::System::Action_2<::GlobalNamespace::BeatmapEventData*,::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapDataItem*>*>*& __cordl_internal_get_beatmapEventDataWasInsertedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::BeatmapEventData*,::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapDataItem*>*>*> const& __cordl_internal_get_beatmapEventDataWasInsertedEvent() const;
...
constexpr ::System::Action_2<::GlobalNamespace::BeatmapEventData*,::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapDataItem*>*>*& __cordl_internal_get_beatmapEventDataWillBeRemovedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::BeatmapEventData*,::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapDataItem*>*>*> const& __cordl_internal_get_beatmapEventDataWillBeRemovedEvent() const;

constexpr void __cordl_internal_set__allBeatmapData(::GlobalNamespace::ISortedList_1<::GlobalNamespace::BeatmapDataItem*>*  value) ;

constexpr void __cordl_internal_set__allBeatmapDataItemToNodeMap(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::BeatmapDataItem*,::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapDataItem*>*>*  value) ;
...
constexpr void __cordl_internal_set_beatmapEventDataWasInsertedEvent(::System::Action_2<::GlobalNamespace::BeatmapEventData*,::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapDataItem*>*>*  value) ;
...
constexpr void __cordl_internal_set_beatmapEventDataWillBeRemovedEvent(::System::Action_2<::GlobalNamespace::BeatmapEventData*,::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapDataItem*>*>*  value) ;

/// @brief Method .ctor, addr 0x265e65c, size 0x194, virtual false, abstract: false, final false
inline void _ctor(int32_t  numberOfLines) ;

/// @brief Method add_beatmapEventDataWasInsertedEvent, addr 0x2668158, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method add_beatmapEventDataWasRemovedEvent, addr 0x2668418, size 0xb0, virtual true, abstract: false, final true
inline void add_beatmapEventDataWasRemovedEvent(::System::Action_1<::GlobalNamespace::BeatmapEventData*>*  value) ;

/// @brief Method add_beatmapEventDataWillBeRemovedEvent, addr 0x26682b8, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method get_allBeatmapDataItems, addr 0x2668028, size 0xa4, virtual true, abstract: false, final true
inline ::System::Collections::Generic::LinkedList_1<::GlobalNamespace::BeatmapDataItem*>* get_allBeatmapDataItems() ;

/// @brief Method get_bombsCount, addr 0x26680f4, size 0x8, virtual true, abstract: false, final true
inline int32_t get_bombsCount() ;

/// @brief Method get_cuttableNotesCount, addr 0x26680d4, size 0x8, virtual true, abstract: false, final true
inline int32_t get_cuttableNotesCount() ;

/// @brief Method get_numberOfLines, addr 0x26680cc, size 0x8, virtual true, abstract: false, final true
inline int32_t get_numberOfLines() ;

/// @brief Method get_obstaclesCount, addr 0x26680e4, size 0x8, virtual true, abstract: false, final true
inline int32_t get_obstaclesCount() ;

/// @brief Method get_spawnRotationEventsCount, addr 0x2668104, size 0x4c, virtual true, abstract: false, final true
inline int32_t get_spawnRotationEventsCount() ;

/// @brief Method get_specialBasicBeatmapEventKeywords, addr 0x2668150, size 0x8, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerable_1<::StringW>* get_specialBasicBeatmapEventKeywords() ;

/// @brief Method get_updateAllBeatmapDataOnInsert, addr 0x2668014, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method remove_beatmapEventDataWasInsertedEvent, addr 0x2668208, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method remove_beatmapEventDataWasRemovedEvent, addr 0x26684c8, size 0xb0, virtual true, abstract: false, final true
inline void remove_beatmapEventDataWasRemovedEvent(::System::Action_1<::GlobalNamespace::BeatmapEventData*>*  value) ;

/// @brief Method remove_beatmapEventDataWillBeRemovedEvent, addr 0x2668368, size 0xb0, virtual true, abstract: false, final true
...
/// @brief Method set_bombsCount, addr 0x26680fc, size 0x8, virtual false, abstract: false, final false
inline void set_bombsCount(int32_t  value) ;

/// @brief Method set_cuttableNotesCount, addr 0x26680dc, size 0x8, virtual false, abstract: false, final false
inline void set_cuttableNotesCount(int32_t  value) ;

/// @brief Method set_obstaclesCount, addr 0x26680ec, size 0x8, virtual false, abstract: false, final false
inline void set_obstaclesCount(int32_t  value) ;

/// @brief Method set_updateAllBeatmapDataOnInsert, addr 0x266801c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field _allBeatmapDataItemToNodeMap, offset: 0x40, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::BeatmapDataItem*,::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapDataItem*>*>*  ____allBeatmapDataItemToNodeMap;
