...
template<typename T>
constexpr ::ArrayW<T,::Array<T>*>& GlobalNamespace::BinaryHeap_1<T>::__cordl_internal_get__data()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____data;
}
template<typename T>
constexpr ::ArrayW<T,::Array<T>*> const& GlobalNamespace::BinaryHeap_1<T>::__cordl_internal_get__data() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____data;
}
template<typename T>
constexpr void GlobalNamespace::BinaryHeap_1<T>::__cordl_internal_set__data(::ArrayW<T,::Array<T>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
constexpr int32_t& GlobalNamespace::BinaryHeap_1<T>::__cordl_internal_get__tail()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____tail;
}
template<typename T>
constexpr int32_t const& GlobalNamespace::BinaryHeap_1<T>::__cordl_internal_get__tail() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____tail;
}
template<typename T>
constexpr void GlobalNamespace::BinaryHeap_1<T>::__cordl_internal_set__tail(int32_t  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
this->____tail = value;
}
template<typename T>
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::BinaryHeap_1<T>::BinaryHeap_1()   {
}
