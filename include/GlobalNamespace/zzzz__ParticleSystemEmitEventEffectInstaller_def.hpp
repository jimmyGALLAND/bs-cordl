...
/// @brief Method InstallBindings, addr 0x3b02c38, size 0xa8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b02ce0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
