...
/// @brief Method CheckIfPlayerFailed, addr 0x3b24124, size 0x1ec, virtual false, abstract: false, final false
inline void CheckIfPlayerFailed(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandlePlayerDisconnected, addr 0x3b24310, size 0x4, virtual false, abstract: false, final false
inline void HandlePlayerDisconnected(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method HandlePlayerStateChanged, addr 0x3b24314, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x3b23f7c, size 0x1a8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3b23dd4, size 0x1a8, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b24318, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_playerDidFailEvent, addr 0x3b23214, size 0x9c, virtual false, abstract: false, final false
inline void add_playerDidFailEvent(::System::Action*  value) ;

/// @brief Method remove_playerDidFailEvent, addr 0x3b22d28, size 0x9c, virtual false, abstract: false, final false
