...
/// @brief Field _bufferedLightColorGroupEffects, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__bufferedLightColorGroupEffects, put=__cordl_internal_set__bufferedLightColorGroupEffects)) ::ArrayW<::GlobalNamespace::BufferedLightColorGroupEffect*,::Array<::GlobalNamespace::BufferedLightColorGroupEffect*>*>  _bufferedLightColorGroupEffects;
...
/// @brief Method OnDestroy, addr 0x3afa9ac, size 0x5c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x3afa7f8, size 0x1b4, virtual false, abstract: false, final false
inline void Start() ;

constexpr ::ArrayW<::GlobalNamespace::BufferedLightColorGroupEffect*,::Array<::GlobalNamespace::BufferedLightColorGroupEffect*>*> const& __cordl_internal_get__bufferedLightColorGroupEffects() const;
...
/// @brief Method .ctor, addr 0x3afaa08, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
