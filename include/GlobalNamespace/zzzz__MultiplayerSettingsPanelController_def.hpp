...
/// @brief Method Awake, addr 0x3b8320c, size 0xc0, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HideConnectionSettings, addr 0x3b831a8, size 0x24, virtual false, abstract: false, final false
inline void HideConnectionSettings(bool  hide) ;

/// @brief Method HideSpectateSettings, addr 0x3b831cc, size 0x24, virtual false, abstract: false, final false
inline void HideSpectateSettings(bool  hide) ;

static inline ::GlobalNamespace::MultiplayerSettingsPanelController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b832cc, size 0x14, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Refresh, addr 0x3b8309c, size 0x10c, virtual true, abstract: false, final true
inline void Refresh() ;

/// @brief Method SetLobbyCode, addr 0x3b831f0, size 0x1c, virtual false, abstract: false, final false
inline void SetLobbyCode(::StringW  code) ;

/// @brief Method SetLobbyPlayerDataModel, addr 0x3b83090, size 0xc, virtual false, abstract: false, final false
inline void SetLobbyPlayerDataModel(::GlobalNamespace::ILobbyPlayerData*  lobbyPlayerData) ;

/// @brief Method UpdateLocalPlayerIsActiveState, addr 0x3b832e0, size 0x24, virtual false, abstract: false, final false
inline void UpdateLocalPlayerIsActiveState(bool  isActive) ;

/// @brief Method <Awake>b__14_0, addr 0x3b8330c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b83304, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_playerActiveStateChangedEvent, addr 0x3b82f30, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_playerActiveStateChangedEvent, addr 0x3b82fe0, size 0xb0, virtual false, abstract: false, final false
