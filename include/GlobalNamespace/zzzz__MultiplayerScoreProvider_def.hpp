...
/// @brief Field _multiplayerSyncState, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerSyncState, put=__cordl_internal_set__multiplayerSyncState)) ::GlobalNamespace::MultiplayerSyncState_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::__StandardScoreSyncState__Score,int32_t>*  _multiplayerSyncState;
...
/// @brief Method CompareTo, addr 0x3b4b9e4, size 0x84, virtual true, abstract: false, final true
...
constexpr ::GlobalNamespace::MultiplayerSyncState_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::__StandardScoreSyncState__Score,int32_t>*& __cordl_internal_get__multiplayerSyncState() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerSyncState_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::__StandardScoreSyncState__Score,int32_t>*> const& __cordl_internal_get__multiplayerSyncState() const;
...
constexpr void __cordl_internal_set__multiplayerSyncState(::GlobalNamespace::MultiplayerSyncState_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::__StandardScoreSyncState__Score,int32_t>*  value) ;

constexpr void __cordl_internal_set__scoreSyncManager(::UnityW<::GlobalNamespace::MultiplayerScoreProvider>  value) ;

/// @brief Method .ctor, addr 0x3b4b6c4, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method get_isActiveOrFinished, addr 0x3b408c0, size 0x28, virtual false, abstract: false, final false
inline bool get_isActiveOrFinished() ;

/// @brief Method get_isConnected, addr 0x3b4b5e4, size 0xb8, virtual false, abstract: false, final false
inline bool get_isConnected() ;

/// @brief Method get_isFailed, addr 0x3b408e8, size 0x28, virtual false, abstract: false, final false
inline bool get_isFailed() ;

/// @brief Method get_isMe, addr 0x3b447c4, size 0xb4, virtual false, abstract: false, final false
inline bool get_isMe() ;

/// @brief Method get_lastScoreTime, addr 0x3b4b8dc, size 0x50, virtual false, abstract: false, final false
inline int64_t get_lastScoreTime() ;

/// @brief Method get_offsetSyncTime, addr 0x3b4b6f0, size 0xb8, virtual false, abstract: false, final false
inline int64_t get_offsetSyncTime() ;

/// @brief Method get_score, addr 0x3b44878, size 0x30, virtual false, abstract: false, final false
inline int32_t get_score() ;

/// @brief Method get_userId, addr 0x3b40534, size 0xb8, virtual false, abstract: false, final false
inline ::StringW get_userId() ;

/// @brief Method get_userName, addr 0x3b4b92c, size 0xb8, virtual false, abstract: false, final false
inline ::StringW get_userName() ;

/// @brief Method get_wasActiveAtLevelStart, addr 0x3b4b69c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method <Update>b__16_0, addr 0x3b4bacc, size 0x24, virtual false, abstract: false, final false
inline bool _Update_b__16_0(::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*  p) ;

/// @brief Method .ctor, addr 0x3b4bac4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetPositionOfPlayer>b__0, addr 0x3b4baf0, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b4b810, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <firstPlayer>k__BackingField, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__firstPlayer_k__BackingField, put=__cordl_internal_set__firstPlayer_k__BackingField)) ::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*  _firstPlayer_k__BackingField;

/// @brief Field _players, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__players, put=__cordl_internal_set__players)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*>*  _players;

/// @brief Field _rankedPlayers, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__rankedPlayers, put=__cordl_internal_set__rankedPlayers)) ::System::Collections::Generic::List_1<::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*>*  _rankedPlayers;
...
/// @brief Field firstPlayerDidChangeEvent, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_firstPlayerDidChangeEvent, put=__cordl_internal_set_firstPlayerDidChangeEvent)) ::System::Action_1<::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*>*  firstPlayerDidChangeEvent;
...
/// @brief Method GetPositionOfPlayer, addr 0x3b49b68, size 0xe0, virtual false, abstract: false, final false
inline int32_t GetPositionOfPlayer(::StringW  userId) ;

static inline ::GlobalNamespace::MultiplayerScoreProvider* New_ctor() ;

/// @brief Method TryGetScore, addr 0x3b4b7a8, size 0x68, virtual false, abstract: false, final false
inline bool TryGetScore(::StringW  userId, ByRef<::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*>  data) ;

/// @brief Method Update, addr 0x3b4af24, size 0x6c0, virtual false, abstract: false, final false
inline void Update() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*>*> const& __cordl_internal_get__players() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*>*> const& __cordl_internal_get__rankedPlayers() const;
...
/// @brief Method .ctor, addr 0x3b4b818, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_firstPlayerDidChangeEvent, addr 0x3b40810, size 0xb0, virtual false, abstract: false, final false
inline void add_firstPlayerDidChangeEvent(::System::Action_1<::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*>*  value) ;

/// @brief Method get_firstPlayer, addr 0x3b4af0c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer* get_firstPlayer() ;

/// @brief Method get_rankedPlayers, addr 0x3b4af1c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_scoresAvailable, addr 0x3b49784, size 0x20, virtual false, abstract: false, final false
inline bool get_scoresAvailable() ;

/// @brief Method remove_firstPlayerDidChangeEvent, addr 0x3b403f0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method set_firstPlayer, addr 0x3b4af14, size 0x8, virtual false, abstract: false, final false
