...
/// @brief Method .ctor, addr 0x3b11188, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x3b110f0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b11180, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_energyPanelGo, addr 0x3b110cc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_energyPanelGo() ;

/// @brief Method get_immediateRankGo, addr 0x3b110c4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_immediateRankGo() ;

/// @brief Method get_relativeScoreGo, addr 0x3b110bc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_relativeScoreGo() ;

/// @brief Method get_songProgressPanelGO, addr 0x3b110b4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_songProgressPanelGO() ;

/// @brief Method set_alpha, addr 0x3b110d4, size 0x1c, virtual false, abstract: false, final false
