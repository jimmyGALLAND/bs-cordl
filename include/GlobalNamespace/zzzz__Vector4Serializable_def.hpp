...
/// @brief Method Approximately, addr 0x26d6a7c, size 0x74, virtual false, abstract: false, final false
inline bool Approximately(::GlobalNamespace::Vector4Serializable  other) ;

/// @brief Method Deserialize, addr 0x26d69bc, size 0x7c, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Equals, addr 0x26d6af0, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x26d6a38, size 0x44, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::Vector4Serializable  other) ;

/// @brief Method GetHashCode, addr 0x26d6b98, size 0x40, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetSize, addr 0x26d6d28, size 0xac, virtual false, abstract: false, final false
inline int32_t GetSize() ;

/// @brief Method Serialize, addr 0x26d6914, size 0xa8, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method ToString, addr 0x26d6bd8, size 0x150, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x26d7120, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method .ctor, addr 0x26d6dd4, size 0x34c, virtual false, abstract: false, final false
...
/// @brief Method op_Addition, addr 0x26d7180, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x26d715c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x26d7128, size 0x34, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector4 op_Implicit___UnityEngine__Vector4(::GlobalNamespace::Vector4Serializable  v) ;

/// @brief Method op_Subtraction, addr 0x26d71ac, size 0x2c, virtual false, abstract: false, final false
