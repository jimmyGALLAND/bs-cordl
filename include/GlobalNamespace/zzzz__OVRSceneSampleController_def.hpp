...
/// @brief Method Awake, addr 0x3fb15a8, size 0x1b4, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::OVRSceneSampleController* New_ctor() ;

/// @brief Method Start, addr 0x3fb175c, size 0xf0, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x3fb184c, size 0xd4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateRecenterPose, addr 0x3fb1920, size 0xb0, virtual false, abstract: false, final false
inline void UpdateRecenterPose() ;

/// @brief Method UpdateSpeedAndRotationScaleMultiplier, addr 0x3fb1a8c, size 0xac, virtual false, abstract: false, final false
inline void UpdateSpeedAndRotationScaleMultiplier() ;

/// @brief Method UpdateVisionMode, addr 0x3fb19d0, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fb1b38, size 0x1e4, virtual false, abstract: false, final false
inline void _ctor() ;
