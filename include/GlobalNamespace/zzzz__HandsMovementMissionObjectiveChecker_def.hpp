...
/// @brief Method HandleTotalDistanceDidChange, addr 0x3b1d898, size 0x60, virtual false, abstract: false, final false
inline void HandleTotalDistanceDidChange(float_t  distance) ;

/// @brief Method Init, addr 0x3b1d8f8, size 0x110, virtual true, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::HandsMovementMissionObjectiveChecker* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3b1d7c8, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b1da08, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
