...
static __declspec(property(get=getStaticF__defaultsForType, put=setStaticF__defaultsForType)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::BasicBeatmapEventType,::GlobalNamespace::BasicBeatmapEventData*>*  _defaultsForType;
...
/// @brief Method GetCopy, addr 0x2200d14, size 0x80, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapDataItem* GetCopy() ;

/// @brief Method GetDefault, addr 0x2200dc0, size 0x10c, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapEventData* GetDefault() ;

static inline ::GlobalNamespace::BasicBeatmapEventData* New_ctor() ;
...
/// @brief Method RecalculateSameTypeIndexFromPreviousEvent, addr 0x2200da0, size 0x20, virtual false, abstract: false, final false
inline void RecalculateSameTypeIndexFromPreviousEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

/// @brief Method SetFirstSameTypeIndex, addr 0x2200d94, size 0xc, virtual false, abstract: false, final false
inline void SetFirstSameTypeIndex() ;

/// @brief Method SubtypeIdentifier, addr 0x2200c9c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2200ce4, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2200c04, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method get_nextSameTypeEventData, addr 0x2200b7c, size 0x78, virtual false, abstract: false, final false
inline ::GlobalNamespace::BasicBeatmapEventData* get_nextSameTypeEventData() ;

/// @brief Method get_previousSameTypeEventData, addr 0x2200b04, size 0x78, virtual false, abstract: false, final false
inline ::GlobalNamespace::BasicBeatmapEventData* get_previousSameTypeEventData() ;

/// @brief Method get_sameTypeIndex, addr 0x2200bf4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_sameTypeIndex, addr 0x2200bfc, size 0x8, virtual false, abstract: false, final false
