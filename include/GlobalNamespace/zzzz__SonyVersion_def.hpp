...
/// @brief Method Get, addr 0x26a05f4, size 0x228, virtual false, abstract: false, final false
inline ::StringW Get(::GlobalNamespace::__SonyVersion__VersionFormat  format) ;

/// @brief Method GetFromString, addr 0x26a0014, size 0x550, virtual false, abstract: false, final false
static inline ::GlobalNamespace::SonyVersion* GetFromString(::StringW  versionString) ;

/// @brief Method IsVersionFormatValid, addr 0x26a0564, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x269ffe8, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(uint32_t  majorVersion, uint32_t  minorVersion) ;

/// @brief Method get_majorVersion, addr 0x269ffd8, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_majorVersion() ;

/// @brief Method get_minorVersion, addr 0x269ffe0, size 0x8, virtual false, abstract: false, final false
