...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::SpawnRotationBeatmapEventData::*)()>(&::GlobalNamespace::SpawnRotationBeatmapEventData::get_subtypeGroupIdentifier)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2202330;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::GlobalNamespace::SpawnRotationBeatmapEventData::*)()>(&::GlobalNamespace::SpawnRotationBeatmapEventData::get_rotation)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2202338;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SpawnRotationBeatmapEventData::*)(float_t)>(&::GlobalNamespace::SpawnRotationBeatmapEventData::set_rotation)> {
  constexpr static std::size_t size = 0x8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SpawnRotationBeatmapEventData::*)(float_t, ::GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType, float_t)>(&::GlobalNamespace::SpawnRotationBeatmapEventData::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SpawnRotationBeatmapEventData::*)()>(&::GlobalNamespace::SpawnRotationBeatmapEventData::Mirror)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x22023a0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapDataItem* (::GlobalNamespace::SpawnRotationBeatmapEventData::*)()>(&::GlobalNamespace::SpawnRotationBeatmapEventData::GetCopy)> {
  constexpr static std::size_t size = 0x90;
  constexpr static std::size_t addrs = 0x22023bc;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SpawnRotationBeatmapEventData::*)(::GlobalNamespace::SpawnRotationBeatmapEventData*)>(&::GlobalNamespace::SpawnRotationBeatmapEventData::RecalculateRotationFromPreviousEvent)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x220244c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SpawnRotationBeatmapEventData::*)()>(&::GlobalNamespace::SpawnRotationBeatmapEventData::SetFirstRotationEventRotation)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x2202470;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapEventData* (::GlobalNamespace::SpawnRotationBeatmapEventData::*)()>(&::GlobalNamespace::SpawnRotationBeatmapEventData::GetDefault)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x220247c;
...
inline ::GlobalNamespace::SpawnRotationBeatmapEventData* GlobalNamespace::SpawnRotationBeatmapEventData::New_ctor(float_t  time, ::GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType  spawnRotationEventType, float_t  deltaRotation)  {
...
inline void GlobalNamespace::SpawnRotationBeatmapEventData::_ctor(float_t  time, ::GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType  spawnRotationEventType, float_t  deltaRotation)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SpawnRotationBeatmapEventData*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
