...
/// @brief Field _playerLevelEndReason, offset 0x14, size 0x4 
 __declspec(property(get=__cordl_internal_get__playerLevelEndReason, put=__cordl_internal_set__playerLevelEndReason)) ::GlobalNamespace::__MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndReason  _playerLevelEndReason;

/// @brief Field _playerLevelEndState, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__playerLevelEndState, put=__cordl_internal_set__playerLevelEndState)) ::GlobalNamespace::__MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndState  _playerLevelEndState;
...
/// @brief Method CompareTo, addr 0x228d730, size 0xe8, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Object*  obj) ;

/// @brief Method CreateFromSerializedData, addr 0x228d68c, size 0xa4, virtual true, abstract: false, final true
inline ::GlobalNamespace::MultiplayerLevelCompletionResults* CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method HasAnyResult, addr 0x228d5bc, size 0xc, virtual false, abstract: false, final false
...
static inline ::GlobalNamespace::MultiplayerLevelCompletionResults* New_ctor(::GlobalNamespace::__MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndState  playerLevelEndState, ::GlobalNamespace::__MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndReason  playerLevelEndReason, ::GlobalNamespace::LevelCompletionResults*  levelCompletionResults) ;

/// @brief Method Serialize, addr 0x228d620, size 0x6c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x228d5dc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x228d5e4, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::__MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndState  playerLevelEndState, ::GlobalNamespace::__MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndReason  playerLevelEndReason, ::GlobalNamespace::LevelCompletionResults*  levelCompletionResults) ;

/// @brief Method get_failedOrGivenUp, addr 0x228d5c8, size 0x14, virtual false, abstract: false, final false
inline bool get_failedOrGivenUp() ;

/// @brief Method get_hasAnyResults, addr 0x228d5ac, size 0x10, virtual false, abstract: false, final false
inline bool get_hasAnyResults() ;

/// @brief Method get_levelCompletionResults, addr 0x228d5a4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::LevelCompletionResults* get_levelCompletionResults() ;

/// @brief Method get_playerLevelEndReason, addr 0x228d59c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::__MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndReason get_playerLevelEndReason() ;

/// @brief Method get_playerLevelEndState, addr 0x228d594, size 0x8, virtual false, abstract: false, final false
