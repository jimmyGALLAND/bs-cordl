...
/// @brief Method Awake, addr 0x3b09508, size 0xac, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method LateUpdate, addr 0x3b095b4, size 0x8, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::BasicSpectrogramData* New_ctor() ;

/// @brief Method ProcessSamples, addr 0x3b09378, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b095bc, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ProcessedSamples, addr 0x3b0933c, size 0x3c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<float_t>* get_ProcessedSamples() ;

/// @brief Method get_Samples, addr 0x3b092a4, size 0x98, virtual false, abstract: false, final false
