...
/// @brief Method OnReportButtonIntentNotif, addr 0x3ec96f4, size 0xa0, virtual false, abstract: false, final false
inline void OnReportButtonIntentNotif(::Oculus::Platform::Message_1<::StringW>*  message) ;

/// @brief Method Start, addr 0x3ec9554, size 0xf4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UpdateConsole, addr 0x3ec9648, size 0xac, virtual false, abstract: false, final false
inline void UpdateConsole(::StringW  value) ;

/// @brief Method <Start>b__2_0, addr 0x3ec98e0, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ec98d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
