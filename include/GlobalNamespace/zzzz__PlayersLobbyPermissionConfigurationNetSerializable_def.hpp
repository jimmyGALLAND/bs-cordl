...
/// @brief Method Deserialize, addr 0x26d5250, size 0x164, virtual true, abstract: false, final false
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x26d4fd0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Obtain, addr 0x26d4f6c, size 0x64, virtual false, abstract: false, final false
static inline ::GlobalNamespace::PlayersLobbyPermissionConfigurationNetSerializable* Obtain() ;

/// @brief Method Release, addr 0x26d53b4, size 0xc4, virtual true, abstract: false, final false
inline void Release() ;

/// @brief Method Retain, addr 0x26d54e8, size 0x9c, virtual true, abstract: false, final false
inline void Retain() ;

/// @brief Method Serialize, addr 0x26d50d0, size 0x180, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::PlayerLobbyPermissionConfigurationNetSerializable*>*> const& __cordl_internal_get__playersPermission() const;
...
/// @brief Method .ctor, addr 0x26d5030, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_playersPermission, addr 0x26d4f64, size 0x8, virtual false, abstract: false, final false
