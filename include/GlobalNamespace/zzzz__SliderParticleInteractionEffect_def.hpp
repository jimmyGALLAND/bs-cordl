...
/// @brief Method EndEffect, addr 0x3ae7260, size 0x94, virtual true, abstract: false, final false
inline void EndEffect() ;

static inline ::GlobalNamespace::SliderParticleInteractionEffect* New_ctor() ;

/// @brief Method SetPSStartColor, addr 0x3ae7050, size 0xd4, virtual false, abstract: false, final false
inline void SetPSStartColor(::UnityEngine::Color  color) ;

/// @brief Method Start, addr 0x3ae6fac, size 0xa4, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method StartEffect, addr 0x3ae71a8, size 0xb8, virtual true, abstract: false, final false
inline void StartEffect(float_t  saberInteractionParam) ;

/// @brief Method Update, addr 0x3ae7124, size 0x84, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3ae72f4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
