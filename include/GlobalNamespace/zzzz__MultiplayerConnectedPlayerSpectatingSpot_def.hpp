...
/// @brief Method HandlePlayerDisconnected, addr 0x3b4edb8, size 0x4, virtual false, abstract: false, final false
inline void HandlePlayerDisconnected(::GlobalNamespace::IConnectedPlayer*  connectedPlayer) ;

/// @brief Method HandlePlayerStateChanged, addr 0x3b4edb4, size 0x4, virtual false, abstract: false, final false
inline void HandlePlayerStateChanged(::GlobalNamespace::IConnectedPlayer*  connectedPlayer) ;

/// @brief Method IMultiplayerSpectatingSpot.get_transform, addr 0x3b4edc4, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method OnDestroy, addr 0x3b4ea78, size 0x1a8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method ReloadBasedOnPlayerCurrentState, addr 0x3b4ec40, size 0x174, virtual false, abstract: false, final false
inline void ReloadBasedOnPlayerCurrentState(::GlobalNamespace::IConnectedPlayer*  connectedPlayer) ;

/// @brief Method SetIsObserved, addr 0x3b4ec20, size 0x20, virtual true, abstract: false, final true
inline void SetIsObserved(bool  isObserved) ;

/// @brief Method Start, addr 0x3b4e724, size 0x1f0, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b4edbc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_hasBeenRemovedEvent, addr 0x3b4e3a8, size 0xb0, virtual true, abstract: false, final true
inline void add_hasBeenRemovedEvent(::System::Action_1<::GlobalNamespace::IMultiplayerSpectatingSpot*>*  value) ;

/// @brief Method add_isObservedChangedEvent, addr 0x3b4e508, size 0xb0, virtual false, abstract: false, final false
inline void add_isObservedChangedEvent(::System::Action_1<bool>*  value) ;

/// @brief Method get_isMain, addr 0x3b4e71c, size 0x8, virtual true, abstract: false, final true
inline bool get_isMain() ;

/// @brief Method get_observable, addr 0x3b4e668, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::IMultiplayerObservable* get_observable() ;

/// @brief Method get_spotName, addr 0x3b4e678, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method remove_hasBeenRemovedEvent, addr 0x3b4e458, size 0xb0, virtual true, abstract: false, final true
inline void remove_hasBeenRemovedEvent(::System::Action_1<::GlobalNamespace::IMultiplayerSpectatingSpot*>*  value) ;

/// @brief Method remove_isObservedChangedEvent, addr 0x3b4e5b8, size 0xb0, virtual false, abstract: false, final false
inline void remove_isObservedChangedEvent(::System::Action_1<bool>*  value) ;

/// @brief Method set_observable, addr 0x3b4e670, size 0x8, virtual false, abstract: false, final false
