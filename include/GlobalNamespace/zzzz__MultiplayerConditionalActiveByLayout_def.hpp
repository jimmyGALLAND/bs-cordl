...
/// @brief Method HandlePlayersLayoutWasCalculated, addr 0x3b37c90, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x3b37bf0, size 0xa0, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x3b37ce8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
