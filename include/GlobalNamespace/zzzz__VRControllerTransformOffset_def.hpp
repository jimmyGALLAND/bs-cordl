...
/// @brief Method .ctor, addr 0x394fc5c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_poseOffset, addr 0x394f5e8, size 0xb0, virtual false, abstract: false, final false
