...
/// @brief Method ColorWasSet, addr 0x395e5e0, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x395e624, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
