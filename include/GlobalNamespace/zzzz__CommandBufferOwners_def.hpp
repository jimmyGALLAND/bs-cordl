...
/// @brief Method AddOwner, addr 0x3fefc98, size 0xa0, virtual false, abstract: false, final false
inline void AddOwner(::UnityEngine::Object*  owner) ;

/// @brief Method ContainsOwner, addr 0x3fefc40, size 0x58, virtual false, abstract: false, final false
inline bool ContainsOwner(::UnityEngine::Object*  owner) ;

static inline ::GlobalNamespace::CommandBufferOwners* New_ctor() ;

/// @brief Method RemoveOwner, addr 0x3fef9e8, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3fefd38, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_NumberOfOwners, addr 0x3fefa48, size 0x48, virtual false, abstract: false, final false
