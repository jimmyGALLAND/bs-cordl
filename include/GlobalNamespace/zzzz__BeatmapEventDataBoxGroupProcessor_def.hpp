...
/// @brief Field _dirtyBoxGroups, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__dirtyBoxGroups, put=__cordl_internal_set__dirtyBoxGroups)) ::System::Collections::Generic::HashSet_1<::GlobalNamespace::BeatmapEventDataBoxGroup*>*  _dirtyBoxGroups;
...
/// @brief Method ClearDirtyData, addr 0x266d9a0, size 0x50, virtual false, abstract: false, final false
inline void ClearDirtyData() ;

static inline ::GlobalNamespace::BeatmapEventDataBoxGroupProcessor* New_ctor() ;

/// @brief Method ProcessBeforeDeleteData, addr 0x266eb38, size 0x36c, virtual true, abstract: false, final true
...
/// @brief Method ProcessInsertedData, addr 0x266e538, size 0x600, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x266d55c, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_dirtyBoxGroups, addr 0x266e530, size 0x8, virtual false, abstract: false, final false
...
constexpr ::GlobalNamespace::ISortedListItemProcessor_1<::GlobalNamespace::BeatmapEventDataBoxGroup*>* i___GlobalNamespace__ISortedListItemProcessor_1___GlobalNamespace__BeatmapEventDataBoxGroup__() noexcept;
