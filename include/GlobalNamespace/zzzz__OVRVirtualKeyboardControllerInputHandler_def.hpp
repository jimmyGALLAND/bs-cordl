...
public:
// Declarations
/// @brief Method Awake, addr 0x3f95db8, size 0x58, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::OVRVirtualKeyboardControllerInputHandler* New_ctor() ;

/// @brief Method .ctor, addr 0x3f95e10, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
