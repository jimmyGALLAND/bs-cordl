...
/// @brief Method DidActivate, addr 0x3a71530, size 0xb0, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HandleQuitButtonPressed, addr 0x3a71604, size 0x50, virtual false, abstract: false, final false
inline void HandleQuitButtonPressed() ;

static inline ::GlobalNamespace::StartupErrorViewController* New_ctor() ;

/// @brief Method SetMessage, addr 0x3a715e0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a71654, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
