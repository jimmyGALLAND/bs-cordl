...
/// @brief Method Init, addr 0x3ae6c7c, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method ManualUpdate, addr 0x3ae6d94, size 0x210, virtual false, abstract: false, final false
inline void ManualUpdate() ;

static inline ::GlobalNamespace::SliderMovement* New_ctor() ;

/// @brief Method StartMovement, addr 0x3ae6d6c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ae6fa4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_headDidMovePastCutMarkEvent, addr 0x3ae69ec, size 0x9c, virtual false, abstract: false, final false
inline void add_headDidMovePastCutMarkEvent(::System::Action*  value) ;

/// @brief Method add_movementDidFinishEvent, addr 0x3ae6754, size 0x9c, virtual false, abstract: false, final false
inline void add_movementDidFinishEvent(::System::Action*  value) ;

/// @brief Method add_movementDidMoveEvent, addr 0x3ae688c, size 0xb0, virtual false, abstract: false, final false
inline void add_movementDidMoveEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method add_tailDidMovePastCutMarkEvent, addr 0x3ae6b24, size 0x9c, virtual false, abstract: false, final false
inline void add_tailDidMovePastCutMarkEvent(::System::Action*  value) ;

/// @brief Method get_headNoteGravity, addr 0x3ae6c64, size 0x8, virtual false, abstract: false, final false
inline float_t get_headNoteGravity() ;

/// @brief Method get_jumpDuration, addr 0x3ae6c5c, size 0x8, virtual false, abstract: false, final false
inline float_t get_jumpDuration() ;

/// @brief Method get_tailNoteGravity, addr 0x3ae6c6c, size 0x8, virtual false, abstract: false, final false
inline float_t get_tailNoteGravity() ;

/// @brief Method get_timeSinceHeadNoteJump, addr 0x3ae6c74, size 0x8, virtual false, abstract: false, final false
inline float_t get_timeSinceHeadNoteJump() ;

/// @brief Method remove_headDidMovePastCutMarkEvent, addr 0x3ae6a88, size 0x9c, virtual false, abstract: false, final false
inline void remove_headDidMovePastCutMarkEvent(::System::Action*  value) ;

/// @brief Method remove_movementDidFinishEvent, addr 0x3ae67f0, size 0x9c, virtual false, abstract: false, final false
inline void remove_movementDidFinishEvent(::System::Action*  value) ;

/// @brief Method remove_movementDidMoveEvent, addr 0x3ae693c, size 0xb0, virtual false, abstract: false, final false
inline void remove_movementDidMoveEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method remove_tailDidMovePastCutMarkEvent, addr 0x3ae6bc0, size 0x9c, virtual false, abstract: false, final false
