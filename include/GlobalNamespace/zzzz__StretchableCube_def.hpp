...
/// @brief Method Awake, addr 0x3a6a074, size 0x70, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CreateBox, addr 0x3a6a0e4, size 0x144, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> CreateBox() ;

static inline ::GlobalNamespace::StretchableCube* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3a6a228, size 0xc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method RecalculateUVs, addr 0x3a6a234, size 0x1ec, virtual false, abstract: false, final false
inline void RecalculateUVs(::ArrayW<::UnityEngine::Vector2,::Array<::UnityEngine::Vector2>*>  uvs) ;

/// @brief Method RefreshUVs, addr 0x3a6a420, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3a6a4b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
