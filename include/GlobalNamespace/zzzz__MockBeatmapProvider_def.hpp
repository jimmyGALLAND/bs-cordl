...
/// @brief Method Dispose, addr 0x3b31cb0, size 0x4, virtual false, abstract: false, final false
inline void Dispose() ;

static inline ::GlobalNamespace::MockBeatmapProvider* New_ctor() ;

/// @brief Method SelectBeatmapFromSuggestionsWithSelectionMaskAndOwnedSongPacks, addr 0x3b31c20, size 0x90, virtual true, abstract: false, final true
...
/// @brief Method VerifyBeatmapForSelectionMask, addr 0x3b31c18, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3b31cb4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
