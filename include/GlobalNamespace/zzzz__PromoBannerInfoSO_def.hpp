...
/// @brief Method .ctor, addr 0x2684e08, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_bannerImage, addr 0x2684df0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_bannerImage() ;

/// @brief Method get_bannerPromoText, addr 0x2684df8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_bannerPromoText() ;

/// @brief Method get_bannerPromoTextPosition, addr 0x2684e00, size 0x8, virtual false, abstract: false, final false
