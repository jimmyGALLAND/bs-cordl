...
/// @brief Field _characterSpawnController, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__characterSpawnController, put=__cordl_internal_set__characterSpawnController)) ::UnityW<::GlobalNamespace::BTSCharacterSpawnController>  _characterSpawnController;
...
/// @brief Field _standardSceneSetupData, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__standardSceneSetupData, put=__cordl_internal_set__standardSceneSetupData)) ::GlobalNamespace::StandardGameplaySceneSetupData*  _standardSceneSetupData;
...
/// @brief Method GetBar, addr 0x2223c04, size 0x1a8, virtual false, abstract: false, final false
inline ::StringW GetBar(float_t  songTime) ;

/// @brief Method LateUpdate, addr 0x2223038, size 0xbcc, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::WaypointsTestGameplayManager* New_ctor() ;

/// @brief Method OnDestroy, addr 0x2223dac, size 0x320, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDrawGizmos, addr 0x22240cc, size 0x1d8, virtual false, abstract: false, final false
inline void OnDrawGizmos() ;

/// @brief Method Start, addr 0x2223004, size 0x34, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x22242a4, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
