...
/// @brief Method ColorWasSet, addr 0x395e6e0, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x395e700, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
