...
/// @brief Method <.ctor>b__14_0, addr 0x26a1098, size 0x18, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorScheme* __ctor_b__14_0(::GlobalNamespace::ColorSchemeSO*  csSO) ;

/// @brief Method .ctor, addr 0x26a1090, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _colorSchemesDict, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__colorSchemesDict, put=__cordl_internal_set__colorSchemesDict)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::ColorScheme*>*  _colorSchemesDict;

/// @brief Field _colorSchemesList, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__colorSchemesList, put=__cordl_internal_set__colorSchemesList)) ::System::Collections::Generic::List_1<::GlobalNamespace::ColorScheme*>*  _colorSchemesList;
...
/// @brief Method GetColorSchemeForId, addr 0x26a0dac, size 0x58, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorScheme* GetColorSchemeForId(::StringW  id) ;

/// @brief Method GetColorSchemeForIdx, addr 0x26a0d54, size 0x58, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorScheme* GetColorSchemeForIdx(int32_t  idx) ;

/// @brief Method GetNumberOfColorSchemes, addr 0x26a0d0c, size 0x48, virtual false, abstract: false, final false
inline int32_t GetNumberOfColorSchemes() ;

/// @brief Method GetOverrideColorScheme, addr 0x26a1020, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorScheme* GetOverrideColorScheme() ;

/// @brief Method GetSelectedColorScheme, addr 0x26a0f2c, size 0x54, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorScheme* GetSelectedColorScheme() ;

/// @brief Method GetSelectedColorSchemeIdx, addr 0x26a0f80, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method SetColorSchemeForId, addr 0x26a0e04, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26a0c04, size 0x108, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IEnumerable_1<::UnityW<::GlobalNamespace::ColorSchemeSO>>*  colorSchemeSOs) ;

/// @brief Method .ctor, addr 0x26a09a8, size 0x25c, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::ColorScheme*>*  colorSchemes) ;

/// @brief Method add_didChangeOverrideSettingsEvent, addr 0x26a0870, size 0x9c, virtual false, abstract: false, final false
inline void add_didChangeOverrideSettingsEvent(::System::Action*  value) ;

/// @brief Method get_overrideDefaultColors, addr 0x26a081c, size 0x8, virtual false, abstract: false, final false
inline bool get_overrideDefaultColors() ;

/// @brief Method get_selectedColorSchemeId, addr 0x26a0868, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_selectedColorSchemeId() ;

/// @brief Method remove_didChangeOverrideSettingsEvent, addr 0x26a090c, size 0x9c, virtual false, abstract: false, final false
inline void remove_didChangeOverrideSettingsEvent(::System::Action*  value) ;

/// @brief Method set_overrideDefaultColors, addr 0x26a0824, size 0x24, virtual false, abstract: false, final false
inline void set_overrideDefaultColors(bool  value) ;

/// @brief Method set_selectedColorSchemeId, addr 0x26a0848, size 0x20, virtual false, abstract: false, final false
