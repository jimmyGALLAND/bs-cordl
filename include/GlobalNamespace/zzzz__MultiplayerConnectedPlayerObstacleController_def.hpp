...
/// @brief Method .ctor, addr 0x3b258ac, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _multiplayerConnectedPlayerObstacleClippingController, offset 0x128, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerConnectedPlayerObstacleClippingController, put=__cordl_internal_set__multiplayerConnectedPlayerObstacleClippingController)) ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerObstacleClippingController>  _multiplayerConnectedPlayerObstacleClippingController;

/// @brief Method Init, addr 0x3b256d4, size 0x1d0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3b258a4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
