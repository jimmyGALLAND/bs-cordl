...
/// @brief Method GetBurnMarkPos, addr 0x3af121c, size 0x330, virtual false, abstract: false, final false
...
/// @brief Method LateUpdate, addr 0x3af1608, size 0x688, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::SaberBurnMarkArea* New_ctor() ;

/// @brief Method OnDestroy, addr 0x3af0db8, size 0x224, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x3af10fc, size 0x120, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3af0fdc, size 0x120, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Start, addr 0x3af0454, size 0x964, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method WorldToCameraBurnMarkPos, addr 0x3af154c, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3af1c90, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
