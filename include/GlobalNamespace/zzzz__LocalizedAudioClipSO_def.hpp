...
/// @brief Method .ctor, addr 0x3a8c028, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x3a8c018, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_localizedAudioClip>b__0, addr 0x3a8c030, size 0x24, virtual false, abstract: false, final false
...
/// @brief Field _lastLocalizedAudioClipInfo, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__lastLocalizedAudioClipInfo, put=__cordl_internal_set__lastLocalizedAudioClipInfo)) ::GlobalNamespace::__LocalizedAudioClipSO__LocalizedAudioClipInfo*  _lastLocalizedAudioClipInfo;

/// @brief Field _localizedAudioClipInfo, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__localizedAudioClipInfo, put=__cordl_internal_set__localizedAudioClipInfo)) ::ArrayW<::GlobalNamespace::__LocalizedAudioClipSO__LocalizedAudioClipInfo*,::Array<::GlobalNamespace::__LocalizedAudioClipSO__LocalizedAudioClipInfo*>*>  _localizedAudioClipInfo;
...
constexpr ::ArrayW<::GlobalNamespace::__LocalizedAudioClipSO__LocalizedAudioClipInfo*,::Array<::GlobalNamespace::__LocalizedAudioClipSO__LocalizedAudioClipInfo*>*> const& __cordl_internal_get__localizedAudioClipInfo() const;

constexpr ::ArrayW<::GlobalNamespace::__LocalizedAudioClipSO__LocalizedAudioClipInfo*,::Array<::GlobalNamespace::__LocalizedAudioClipSO__LocalizedAudioClipInfo*>*>& __cordl_internal_get__localizedAudioClipInfo() ;
...
constexpr void __cordl_internal_set__localizedAudioClipInfo(::ArrayW<::GlobalNamespace::__LocalizedAudioClipSO__LocalizedAudioClipInfo*,::Array<::GlobalNamespace::__LocalizedAudioClipSO__LocalizedAudioClipInfo*>*>  value) ;

/// @brief Method .ctor, addr 0x3a8c020, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_localizedAudioClip, addr 0x3a8bf0c, size 0x10c, virtual false, abstract: false, final false
