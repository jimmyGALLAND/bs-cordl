...
/// @brief Method GetPrefab, addr 0x4aa96a8, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x4aa9674, size 0x34, virtual false, abstract: false, final false
