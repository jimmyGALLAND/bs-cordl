...
/// @brief Method WithDefaultGameObjectParent, addr 0x4a6e084, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a6e048, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::Zenject::SubContainerCreatorBindInfo*  subContainerBindInfo, ::Zenject::BindInfo*  bindInfo) ;

/// @brief Method get_SubContainerCreatorBindInfo, addr 0x4a6e074, size 0x8, virtual false, abstract: false, final false
inline ::Zenject::SubContainerCreatorBindInfo* get_SubContainerCreatorBindInfo() ;

/// @brief Method set_SubContainerCreatorBindInfo, addr 0x4a6e07c, size 0x8, virtual false, abstract: false, final false
