...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Zenject::SignalDeclarationBindInfo* (*)(::Zenject::DiContainer*, ::System::Type*)>(&::Zenject::SignalExtensions::CreateDefaultSignalDeclarationBindInfo)> {
  constexpr static std::size_t size = 0xa0;
  constexpr static std::size_t addrs = 0x4a64fa8;
...
inline ::Zenject::DeclareSignalIdRequireHandlerAsyncTickPriorityCopyBinder* Zenject::SignalExtensions::DeclareSignal(::Zenject::DiContainer*  container)  {
...
template<typename TSignal>
inline ::Zenject::BindSignalIdToBinder_1<TSignal>* Zenject::SignalExtensions::BindSignal(::Zenject::DiContainer*  container)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::SignalExtensions*>::get(),
                    "BindSignal",
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TSignal>::get()},
