...
return static_cast<::Zenject::IFactory_6<::StringW,P1,P2,P3,P4,T>*>(static_cast<void*>(this));
}
/// @brief Convert to "::Zenject::IFactory_6<::StringW,P1,P2,P3,P4,T>"
template<typename P1,typename P2,typename P3,typename P4,typename T>
constexpr ::Zenject::IFactory_6<::StringW,P1,P2,P3,P4,T>* Zenject::PrefabResourceFactory_5<P1,P2,P3,P4,T>::i___Zenject__IFactory_6___StringW_P1_P2_P3_P4_T_() noexcept {
return static_cast<::Zenject::IFactory_6<::StringW,P1,P2,P3,P4,T>*>(static_cast<void*>(this));
}
/// @brief Convert operator to "::Zenject::IFactory"
template<typename P1,typename P2,typename P3,typename P4,typename T>
constexpr  Zenject::PrefabResourceFactory_5<P1,P2,P3,P4,T>::operator ::Zenject::IFactory*() noexcept {
return static_cast<::Zenject::IFactory*>(static_cast<void*>(this));
}
/// @brief Convert to "::Zenject::IFactory"
template<typename P1,typename P2,typename P3,typename P4,typename T>
constexpr ::Zenject::IFactory* Zenject::PrefabResourceFactory_5<P1,P2,P3,P4,T>::i___Zenject__IFactory() noexcept {
return static_cast<::Zenject::IFactory*>(static_cast<void*>(this));
}
template<typename P1,typename P2,typename P3,typename P4,typename T>
constexpr ::Zenject::DiContainer*& Zenject::PrefabResourceFactory_5<P1,P2,P3,P4,T>::__cordl_internal_get__container()  {
...
template<typename P1,typename P2,typename P3,typename P4,typename T>
inline ::Zenject::DiContainer* Zenject::PrefabResourceFactory_5<P1,P2,P3,P4,T>::get_Container()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::PrefabResourceFactory_5<P1,P2,P3,P4,T>*>::get(),
                        "get_Container",
...
template<typename P1,typename P2,typename P3,typename P4,typename T>
inline void Zenject::PrefabResourceFactory_5<P1,P2,P3,P4,T>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::PrefabResourceFactory_5<P1,P2,P3,P4,T>*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename P1,typename P2,typename P3,typename P4,typename T>
inline ::Zenject::InjectTypeInfo* Zenject::PrefabResourceFactory_5<P1,P2,P3,P4,T>::__zenCreateInjectTypeInfo()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::PrefabResourceFactory_5<P1,P2,P3,P4,T>*>::get(),
...
// Ctor Parameters []
template<typename P1,typename P2,typename P3,typename P4,typename T>
constexpr ::Zenject::PrefabResourceFactory_5<P1,P2,P3,P4,T>::PrefabResourceFactory_5()   {
}
