...
/// @brief Method .ctor, addr 0x4aa59cc, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  markedType) ;

/// @brief Method .ctor, addr 0x4ac09a4, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  markedType, bool  instantiateFailed) ;

/// @brief Method get_InstantiateFailed, addr 0x4ac09d8, size 0x8, virtual false, abstract: false, final false
inline bool get_InstantiateFailed() ;

/// @brief Method get_MarkedType, addr 0x4ac09ec, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_MarkedType() ;

/// @brief Method set_InstantiateFailed, addr 0x4ac09e0, size 0xc, virtual false, abstract: false, final false
inline void set_InstantiateFailed(bool  value) ;

/// @brief Method set_MarkedType, addr 0x4ac09f4, size 0x8, virtual false, abstract: false, final false
