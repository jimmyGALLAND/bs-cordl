...
/// @brief Field <MemoryPoolBindInfo>k__BackingField, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__MemoryPoolBindInfo_k__BackingField, put=__cordl_internal_set__MemoryPoolBindInfo_k__BackingField)) ::Zenject::MemoryPoolBindInfo*  _MemoryPoolBindInfo_k__BackingField;
