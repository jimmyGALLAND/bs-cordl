...
/// @brief Method GetPrefab, addr 0x4aa9458, size 0xa4, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::Object> GetPrefab() ;

/// @brief Method Instantiate, addr 0x4aa94fc, size 0x178, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x4aa9248, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Zenject::IPrefabInstantiator*  subInstantiator) ;

/// @brief Method get_ArgumentTarget, addr 0x4aa9314, size 0xa0, virtual true, abstract: false, final true
inline ::System::Type* get_ArgumentTarget() ;

/// @brief Method get_ExtraArguments, addr 0x4aa9270, size 0xa4, virtual true, abstract: false, final true
inline ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>* get_ExtraArguments() ;

/// @brief Method get_GameObjectCreationParameters, addr 0x4aa93b4, size 0xa4, virtual true, abstract: false, final true
