...
/// @brief Method MarkNonSingleton, addr 0x4ac0af0, size 0xac, virtual false, abstract: false, final false
inline void MarkNonSingleton(::System::Type*  type) ;

/// @brief Method MarkSingleton, addr 0x4ac0b9c, size 0xd4, virtual false, abstract: false, final false
inline void MarkSingleton(::System::Type*  type) ;

static inline ::Zenject::Internal::SingletonMarkRegistry* New_ctor() ;

/// @brief Method Unmark, addr 0x4ac0c70, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4ac0cdc, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;
