...
template<typename TContract>
constexpr ::Zenject::Internal::IDecoratorProvider* Zenject::Internal::DecoratorProvider_1<TContract>::i___Zenject__Internal__IDecoratorProvider() noexcept {
return static_cast<::Zenject::Internal::IDecoratorProvider*>(static_cast<void*>(this));
}
template<typename TContract>
constexpr ::System::Collections::Generic::Dictionary_2<::Zenject::IProvider*,::System::Collections::Generic::List_1<::System::Object*>*>*& Zenject::Internal::DecoratorProvider_1<TContract>::__cordl_internal_get__cachedInstances()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____cachedInstances;
}
template<typename TContract>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::Zenject::IProvider*,::System::Collections::Generic::List_1<::System::Object*>*>*> const& Zenject::Internal::DecoratorProvider_1<TContract>::__cordl_internal_get__cachedInstances() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____cachedInstances;
}
template<typename TContract>
constexpr void Zenject::Internal::DecoratorProvider_1<TContract>::__cordl_internal_set__cachedInstances(::System::Collections::Generic::Dictionary_2<::Zenject::IProvider*,::System::Collections::Generic::List_1<::System::Object*>*>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename TContract>
constexpr ::Zenject::DiContainer*& Zenject::Internal::DecoratorProvider_1<TContract>::__cordl_internal_get__container()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____container;
}
template<typename TContract>
constexpr ::cordl_internals::to_const_pointer<::Zenject::DiContainer*> const& Zenject::Internal::DecoratorProvider_1<TContract>::__cordl_internal_get__container() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____container;
}
template<typename TContract>
constexpr void Zenject::Internal::DecoratorProvider_1<TContract>::__cordl_internal_set__container(::Zenject::DiContainer*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____container)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
template<typename TContract>
constexpr ::System::Collections::Generic::List_1<::System::Guid>*& Zenject::Internal::DecoratorProvider_1<TContract>::__cordl_internal_get__factoryBindIds()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____factoryBindIds;
}
template<typename TContract>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Guid>*> const& Zenject::Internal::DecoratorProvider_1<TContract>::__cordl_internal_get__factoryBindIds() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____factoryBindIds;
}
template<typename TContract>
constexpr void Zenject::Internal::DecoratorProvider_1<TContract>::__cordl_internal_set__factoryBindIds(::System::Collections::Generic::List_1<::System::Guid>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename TContract>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Zenject::IFactory_2<TContract,TContract>*>*> const& Zenject::Internal::DecoratorProvider_1<TContract>::__cordl_internal_get__decoratorFactories() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____decoratorFactories;
}
template<typename TContract>
constexpr void Zenject::Internal::DecoratorProvider_1<TContract>::__cordl_internal_set__decoratorFactories(::System::Collections::Generic::List_1<::Zenject::IFactory_2<TContract,TContract>*>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "DecorateInstance",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Object*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::InjectContext*>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<::System::Object*, false>(this, ___internal_method, instance, context);
}
// Ctor Parameters []
template<typename TContract>
constexpr ::Zenject::Internal::DecoratorProvider_1<TContract>::DecoratorProvider_1()   {
}
