...
template<typename TParam1,typename TParam2,typename TParam3,typename TParam4,typename TValue>
constexpr ::cordl_internals::to_const_pointer<::System::Action_5<TParam1,TParam2,TParam3,TParam4,TValue>*> const& Zenject::StaticMemoryPool_5<TParam1,TParam2,TParam3,TParam4,TValue>::__cordl_internal_get__onSpawnMethod() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____onSpawnMethod;
}
template<typename TParam1,typename TParam2,typename TParam3,typename TParam4,typename TValue>
