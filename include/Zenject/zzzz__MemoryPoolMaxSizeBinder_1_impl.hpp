...
inline ::Zenject::MemoryPoolMaxSizeBinder_1<TContract>* Zenject::MemoryPoolMaxSizeBinder_1<TContract>::New_ctor(::Zenject::DiContainer*  bindContainer, ::Zenject::BindInfo*  bindInfo, ::Zenject::FactoryBindInfo*  factoryBindInfo, ::Zenject::MemoryPoolBindInfo*  poolBindInfo)  {
...
template<typename TContract>
inline void Zenject::MemoryPoolMaxSizeBinder_1<TContract>::_ctor(::Zenject::DiContainer*  bindContainer, ::Zenject::BindInfo*  bindInfo, ::Zenject::FactoryBindInfo*  factoryBindInfo, ::Zenject::MemoryPoolBindInfo*  poolBindInfo)  {
...
template<typename TContract>
inline ::Zenject::MemoryPoolExpandBinder_1<TContract>* Zenject::MemoryPoolMaxSizeBinder_1<TContract>::WithMaxSize(int32_t  size)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::MemoryPoolMaxSizeBinder_1<TContract>*>::get(),
                        "WithMaxSize",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters []
template<typename TContract>
constexpr ::Zenject::MemoryPoolMaxSizeBinder_1<TContract>::MemoryPoolMaxSizeBinder_1()   {
}
