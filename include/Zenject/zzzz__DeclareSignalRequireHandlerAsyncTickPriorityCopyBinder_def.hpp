...
/// @brief Method OptionalSubscriber, addr 0x4a64bdc, size 0x1c, virtual false, abstract: false, final false
inline ::Zenject::DeclareSignalAsyncTickPriorityCopyBinder* OptionalSubscriber() ;

/// @brief Method OptionalSubscriberWithWarning, addr 0x4a64bf8, size 0x20, virtual false, abstract: false, final false
inline ::Zenject::DeclareSignalAsyncTickPriorityCopyBinder* OptionalSubscriberWithWarning() ;

/// @brief Method RequireSubscriber, addr 0x4a64bbc, size 0x20, virtual false, abstract: false, final false
inline ::Zenject::DeclareSignalAsyncTickPriorityCopyBinder* RequireSubscriber() ;

/// @brief Method .ctor, addr 0x4a64b7c, size 0x24, virtual false, abstract: false, final false
