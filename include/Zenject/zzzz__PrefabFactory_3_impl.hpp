...
constexpr  Zenject::PrefabFactory_3<P1,P2,T>::operator ::Zenject::IFactory_4<::UnityW<::UnityEngine::Object>,P1,P2,T>*() noexcept {
...
template<typename P1,typename P2,typename T>
constexpr ::Zenject::IFactory* Zenject::PrefabFactory_3<P1,P2,T>::i___Zenject__IFactory() noexcept {
return static_cast<::Zenject::IFactory*>(static_cast<void*>(this));
}
template<typename P1,typename P2,typename T>
constexpr ::Zenject::DiContainer*& Zenject::PrefabFactory_3<P1,P2,T>::__cordl_internal_get__container()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____container;
}
template<typename P1,typename P2,typename T>
constexpr ::cordl_internals::to_const_pointer<::Zenject::DiContainer*> const& Zenject::PrefabFactory_3<P1,P2,T>::__cordl_internal_get__container() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____container;
}
template<typename P1,typename P2,typename T>
constexpr void Zenject::PrefabFactory_3<P1,P2,T>::__cordl_internal_set__container(::Zenject::DiContainer*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
// Ctor Parameters []
template<typename P1,typename P2,typename T>
constexpr ::Zenject::PrefabFactory_3<P1,P2,T>::PrefabFactory_3()   {
}
