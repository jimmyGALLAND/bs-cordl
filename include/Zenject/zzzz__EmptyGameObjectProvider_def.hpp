...
/// @brief Method GetAllInstancesWithInjectSplit, addr 0x4aa711c, size 0x104, virtual true, abstract: false, final true
...
/// @brief Method GetInstanceType, addr 0x4aa70b0, size 0x6c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x4aa7074, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::Zenject::DiContainer*  container, ::Zenject::GameObjectCreationParameters*  gameObjectBindInfo) ;

/// @brief Method get_IsCached, addr 0x4aa70a0, size 0x8, virtual true, abstract: false, final true
inline bool get_IsCached() ;

/// @brief Method get_TypeVariesBasedOnMemberType, addr 0x4aa70a8, size 0x8, virtual true, abstract: false, final true
