...
/// @brief Method GetAllInstancesWithInjectSplit, addr 0x4aa72c4, size 0x14c, virtual true, abstract: false, final true
...
/// @brief Method GetInstanceType, addr 0x4aa7258, size 0x6c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x4aa7220, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Zenject::IPrefabInstantiator*  prefabCreator) ;

/// @brief Method get_IsCached, addr 0x4aa7248, size 0x8, virtual true, abstract: false, final true
inline bool get_IsCached() ;

/// @brief Method get_TypeVariesBasedOnMemberType, addr 0x4aa7250, size 0x8, virtual true, abstract: false, final true
