...
inline ::Zenject::FactoryToChoiceIdBinder_1<TContract>* Zenject::FactoryToChoiceIdBinder_1<TContract>::New_ctor(::Zenject::DiContainer*  container, ::Zenject::BindInfo*  bindInfo, ::Zenject::FactoryBindInfo*  factoryBindInfo)  {
...
template<typename TContract>
inline ::Zenject::FactoryArgumentsToChoiceBinder_1<TContract>* Zenject::FactoryToChoiceIdBinder_1<TContract>::WithId(::System::Object*  identifier)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::FactoryToChoiceIdBinder_1<TContract>*>::get(),
                        "WithId",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters []
template<typename TContract>
constexpr ::Zenject::FactoryToChoiceIdBinder_1<TContract>::FactoryToChoiceIdBinder_1()   {
}
