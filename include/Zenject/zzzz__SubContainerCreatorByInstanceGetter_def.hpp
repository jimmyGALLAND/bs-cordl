...
/// @brief Field _subcontainerGetter, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__subcontainerGetter, put=__cordl_internal_set__subcontainerGetter)) ::System::Func_2<::Zenject::InjectContext*,::Zenject::DiContainer*>*  _subcontainerGetter;

/// @brief Convert operator to "::Zenject::ISubContainerCreator"
constexpr operator  ::Zenject::ISubContainerCreator*() noexcept;

/// @brief Method CreateSubContainer, addr 0x4aab0f4, size 0x84, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x4aab0cc, size 0x28, virtual false, abstract: false, final false
