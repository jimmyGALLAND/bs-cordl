...
/// @brief Method WithId, addr 0x4a7c304, size 0x1c, virtual false, abstract: false, final false
inline ::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder* WithId(::System::Object*  identifier) ;

/// @brief Method .ctor, addr 0x4a7c2fc, size 0x8, virtual false, abstract: false, final false
