...
/// @brief Method CreateSubContainer, addr 0x4aab21c, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4aab1e0, size 0x3c, virtual false, abstract: false, final false
