...
/// @brief Field _queuedTasks, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__queuedTasks, put=__cordl_internal_set__queuedTasks)) ::System::Collections::Generic::List_1<::Zenject::__TaskUpdater_1__TaskInfo<TTask>*>*  _queuedTasks;
