...
/// @brief Method AddCopyBindInfo, addr 0x4a64e50, size 0xa4, virtual false, abstract: false, final false
inline void AddCopyBindInfo(::Zenject::BindInfo*  bindInfo) ;

/// @brief Method CopyIntoAllSubContainers, addr 0x4a64ef4, size 0x8, virtual false, abstract: false, final false
inline void CopyIntoAllSubContainers() ;

/// @brief Method CopyIntoDirectSubContainers, addr 0x4a64f90, size 0x8, virtual false, abstract: false, final false
inline void CopyIntoDirectSubContainers() ;

/// @brief Method MoveIntoAllSubContainers, addr 0x4a64f98, size 0x8, virtual false, abstract: false, final false
inline void MoveIntoAllSubContainers() ;

/// @brief Method MoveIntoDirectSubContainers, addr 0x4a64fa0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method SetInheritanceMethod, addr 0x4a64efc, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a64cdc, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4a64d5c, size 0xf4, virtual false, abstract: false, final false
