...
/// @brief Method .ctor, addr 0x4a80678, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ExpandMethod, addr 0x4a806b8, size 0x8, virtual false, abstract: false, final false
inline ::Zenject::PoolExpandMethods get_ExpandMethod() ;

/// @brief Method get_InitialSize, addr 0x4a806c8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_InitialSize() ;

/// @brief Method get_MaxSize, addr 0x4a806d8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxSize() ;

/// @brief Method get_ShowExpandWarning, addr 0x4a806a4, size 0x8, virtual false, abstract: false, final false
inline bool get_ShowExpandWarning() ;

/// @brief Method set_ExpandMethod, addr 0x4a806c0, size 0x8, virtual false, abstract: false, final false
inline void set_ExpandMethod(::Zenject::PoolExpandMethods  value) ;

/// @brief Method set_InitialSize, addr 0x4a806d0, size 0x8, virtual false, abstract: false, final false
inline void set_InitialSize(int32_t  value) ;

/// @brief Method set_MaxSize, addr 0x4a806e0, size 0x8, virtual false, abstract: false, final false
inline void set_MaxSize(int32_t  value) ;

/// @brief Method set_ShowExpandWarning, addr 0x4a806ac, size 0xc, virtual false, abstract: false, final false
