...
/// @brief Field <GameObjectInfo>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__GameObjectInfo_k__BackingField, put=__cordl_internal_set__GameObjectInfo_k__BackingField)) ::Zenject::GameObjectCreationParameters*  _GameObjectInfo_k__BackingField;
...
/// @brief Method UnderTransform, addr 0x4a7c264, size 0x1c, virtual false, abstract: false, final false
inline ::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder* UnderTransform(::UnityEngine::Transform*  parent) ;

/// @brief Method UnderTransform, addr 0x4a7c280, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method UnderTransformGroup, addr 0x4a7c29c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a7c224, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Zenject::BindInfo*  bindInfo, ::Zenject::GameObjectCreationParameters*  gameObjectInfo) ;

/// @brief Method get_GameObjectInfo, addr 0x4a7c254, size 0x8, virtual false, abstract: false, final false
inline ::Zenject::GameObjectCreationParameters* get_GameObjectInfo() ;

/// @brief Method set_GameObjectInfo, addr 0x4a7c25c, size 0x8, virtual false, abstract: false, final false
