...
namespace Zenject {
template<typename TParam1,typename TParam2,typename TParam3,typename TContract>
class __FactoryFromBinder3Extensions____c__1_4;
}
namespace Zenject {
template<typename TParam1,typename TParam2,typename TParam3,typename TContract>
class __FactoryFromBinder3Extensions____c__3_4;
}
namespace Zenject {
template<typename TParam1,typename TParam2,typename TParam3,typename TContract,typename TMemoryPool>
class __FactoryFromBinder3Extensions____c__5_5;
}
namespace Zenject {
template<typename TParam1,typename TParam2,typename TParam3,typename TContract>
class __FactoryFromBinder3Extensions____c__DisplayClass0_0_4;
}
namespace Zenject {
template<typename TParam1,typename TParam2,typename TParam3,typename TContract,typename TMemoryPool>
class __FactoryFromBinder3Extensions____c__DisplayClass6_0_5;
}
...
// Declarations
template<typename TParam1,typename TParam2,typename TParam3,typename TContract>
using __c__1_4 = ::Zenject::__FactoryFromBinder3Extensions____c__1_4<TParam1, TParam2, TParam3, TContract>;

template<typename TParam1,typename TParam2,typename TParam3,typename TContract>
using __c__3_4 = ::Zenject::__FactoryFromBinder3Extensions____c__3_4<TParam1, TParam2, TParam3, TContract>;
...
template<typename TParam1,typename TParam2,typename TParam3,typename TContract>
static inline ::Zenject::ArgConditionCopyNonLazyBinder* FromIFactory(::Zenject::FactoryFromBinder_4<TParam1,TParam2,TParam3,TContract>*  fromBinder, ::System::Action_1<::Zenject::ConcreteBinderGeneric_1<::Zenject::IFactory_4<TParam1,TParam2,TParam3,TContract>*>*>*  factoryBindGenerator) ;
...
/// @brief Method FromMonoPoolableMemoryPool, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TParam1,typename TParam2,typename TParam3,typename TContract>
static inline ::Zenject::ArgConditionCopyNonLazyBinder* FromMonoPoolableMemoryPool(::Zenject::FactoryFromBinder_4<TParam1,TParam2,TParam3,TContract>*  fromBinder, ::System::Action_1<::Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>*>*  poolBindGenerator) ;
...
/// @brief Method FromPoolableMemoryPool, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TParam1,typename TParam2,typename TParam3,typename TContract>
static inline ::Zenject::ArgConditionCopyNonLazyBinder* FromPoolableMemoryPool(::Zenject::FactoryFromBinder_4<TParam1,TParam2,TParam3,TContract>*  fromBinder, ::System::Action_1<::Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>*>*  poolBindGenerator) ;
