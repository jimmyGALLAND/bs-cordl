...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Zenject::BindingInheritanceMethods (::Zenject::IBindingFinalizer::*)()>(&::Zenject::IBindingFinalizer::get_BindingInheritanceMethod)> {
