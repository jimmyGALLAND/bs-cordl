...
template<typename TValue>
constexpr ::cordl_internals::to_const_pointer<::Zenject::IProvider*> const& Zenject::PlaceholderFactoryBase_1<TValue>::__cordl_internal_get__provider() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____provider;
}
template<typename TValue>
...
template<typename TValue>
constexpr ::cordl_internals::to_const_pointer<::Zenject::InjectContext*> const& Zenject::PlaceholderFactoryBase_1<TValue>::__cordl_internal_get__injectContext() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____injectContext;
}
template<typename TValue>
