...
template<typename TParam1,typename TValue>
constexpr ::Zenject::IProvider* Zenject::MethodProviderWithContainer_2<TParam1,TValue>::i___Zenject__IProvider() noexcept {
return static_cast<::Zenject::IProvider*>(static_cast<void*>(this));
}
template<typename TParam1,typename TValue>
...
template<typename TParam1,typename TValue>
constexpr ::cordl_internals::to_const_pointer<::System::Func_3<::Zenject::DiContainer*,TParam1,TValue>*> const& Zenject::MethodProviderWithContainer_2<TParam1,TValue>::__cordl_internal_get__method() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____method;
}
template<typename TParam1,typename TValue>
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Func_3<::Zenject::DiContainer*,TParam1,TValue>*>::get()}
                    )));
...
// Ctor Parameters []
template<typename TParam1,typename TValue>
constexpr ::Zenject::MethodProviderWithContainer_2<TParam1,TValue>::MethodProviderWithContainer_2()   {
}
