...
/// @brief Method AddSecondaryCopyBindInfo, addr 0x4a6ddc4, size 0xec, virtual false, abstract: false, final false
inline void AddSecondaryCopyBindInfo(::Zenject::BindInfo*  bindInfo) ;

/// @brief Method CopyIntoAllSubContainers, addr 0x4a68704, size 0x1c, virtual false, abstract: false, final false
inline ::Zenject::NonLazyBinder* CopyIntoAllSubContainers() ;

/// @brief Method CopyIntoDirectSubContainers, addr 0x4a6dff4, size 0x1c, virtual false, abstract: false, final false
inline ::Zenject::NonLazyBinder* CopyIntoDirectSubContainers() ;

/// @brief Method MoveIntoAllSubContainers, addr 0x4a6e010, size 0x1c, virtual false, abstract: false, final false
inline ::Zenject::NonLazyBinder* MoveIntoAllSubContainers() ;

/// @brief Method MoveIntoDirectSubContainers, addr 0x4a6e02c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method SetInheritanceMethod, addr 0x4a6deb0, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a69b94, size 0x8, virtual false, abstract: false, final false
