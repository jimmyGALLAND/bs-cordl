...
/// @brief Method CreateSubContainer, addr 0x4aab064, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x4aab03c, size 0x28, virtual false, abstract: false, final false
