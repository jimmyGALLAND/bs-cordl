...
/// @brief Method Clear, addr 0x4a9567c, size 0x48, virtual false, abstract: false, final false
static inline void Clear() ;

static inline ::Zenject::DiContainer* getStaticF__container() ;

/// @brief Method get_Container, addr 0x4a911c0, size 0x88, virtual false, abstract: false, final false
static inline ::Zenject::DiContainer* get_Container() ;

/// @brief Method get_HasContainer, addr 0x4a956c4, size 0x50, virtual false, abstract: false, final false
