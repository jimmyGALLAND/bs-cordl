...
inline TDerived Zenject::ScriptableObjectInstaller_1<TDerived>::InstallFromResource(::Zenject::DiContainer*  container)  {
...
template<typename TDerived>
inline TDerived Zenject::ScriptableObjectInstaller_1<TDerived>::InstallFromResource(::StringW  resourcePath, ::Zenject::DiContainer*  container)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::ScriptableObjectInstaller_1<TDerived>*>::get(),
                        "InstallFromResource",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename TDerived>
inline ::Zenject::ScriptableObjectInstaller_1<TDerived>* Zenject::ScriptableObjectInstaller_1<TDerived>::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::ScriptableObjectInstaller_1<TDerived>*>());
}
template<typename TDerived>
inline void Zenject::ScriptableObjectInstaller_1<TDerived>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::ScriptableObjectInstaller_1<TDerived>*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename TDerived>
inline ::System::Object* Zenject::ScriptableObjectInstaller_1<TDerived>::__zenCreate(::ArrayW<::System::Object*,::Array<::System::Object*>*>  P_0)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::ScriptableObjectInstaller_1<TDerived>*>::get(),
                        "__zenCreate",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename TDerived>
inline ::Zenject::InjectTypeInfo* Zenject::ScriptableObjectInstaller_1<TDerived>::__zenCreateInjectTypeInfo()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::ScriptableObjectInstaller_1<TDerived>*>::get(),
...
// Ctor Parameters []
template<typename TDerived>
constexpr ::Zenject::ScriptableObjectInstaller_1<TDerived>::ScriptableObjectInstaller_1()   {
}
