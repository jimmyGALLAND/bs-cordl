...
constexpr ::System::Action_2<::Zenject::DiContainer*,TParam1>*& Zenject::SubContainerCreatorByMethod_1<TParam1>::__cordl_internal_get__installMethod()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____installMethod;
}
template<typename TParam1>
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::Zenject::DiContainer*,TParam1>*> const& Zenject::SubContainerCreatorByMethod_1<TParam1>::__cordl_internal_get__installMethod() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____installMethod;
}
template<typename TParam1>
constexpr void Zenject::SubContainerCreatorByMethod_1<TParam1>::__cordl_internal_set__installMethod(::System::Action_2<::Zenject::DiContainer*,TParam1>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::DiContainer*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::SubContainerCreatorBindInfo*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Action_2<::Zenject::DiContainer*,TParam1>*>::get()}
                    )));
...
// Ctor Parameters []
template<typename TParam1>
constexpr ::Zenject::SubContainerCreatorByMethod_1<TParam1>::SubContainerCreatorByMethod_1()   {
}
