...
constexpr ::Zenject::MemoryPoolBindInfo*& Zenject::MemoryPoolBindingFinalizer_1<TContract>::__cordl_internal_get__poolBindInfo()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____poolBindInfo;
}
template<typename TContract>
constexpr ::cordl_internals::to_const_pointer<::Zenject::MemoryPoolBindInfo*> const& Zenject::MemoryPoolBindingFinalizer_1<TContract>::__cordl_internal_get__poolBindInfo() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____poolBindInfo;
}
template<typename TContract>
constexpr void Zenject::MemoryPoolBindingFinalizer_1<TContract>::__cordl_internal_set__poolBindInfo(::Zenject::MemoryPoolBindInfo*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename TContract>
constexpr ::Zenject::FactoryBindInfo*& Zenject::MemoryPoolBindingFinalizer_1<TContract>::__cordl_internal_get__factoryBindInfo()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____factoryBindInfo;
}
template<typename TContract>
constexpr ::cordl_internals::to_const_pointer<::Zenject::FactoryBindInfo*> const& Zenject::MemoryPoolBindingFinalizer_1<TContract>::__cordl_internal_get__factoryBindInfo() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____factoryBindInfo;
}
template<typename TContract>
constexpr void Zenject::MemoryPoolBindingFinalizer_1<TContract>::__cordl_internal_set__factoryBindInfo(::Zenject::FactoryBindInfo*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::BindInfo*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::FactoryBindInfo*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::MemoryPoolBindInfo*>::get()}
                    )));
...
// Ctor Parameters []
template<typename TContract>
constexpr ::Zenject::MemoryPoolBindingFinalizer_1<TContract>::MemoryPoolBindingFinalizer_1()   {
}
