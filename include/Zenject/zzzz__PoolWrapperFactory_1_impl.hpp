...
template<typename T>
constexpr ::Zenject::IFactory_1<T>* Zenject::PoolWrapperFactory_1<T>::i___Zenject__IFactory_1_T_() noexcept {
return static_cast<::Zenject::IFactory_1<T>*>(static_cast<void*>(this));
}
...
template<typename T>
constexpr ::Zenject::IFactory* Zenject::PoolWrapperFactory_1<T>::i___Zenject__IFactory() noexcept {
return static_cast<::Zenject::IFactory*>(static_cast<void*>(this));
}
template<typename T>
constexpr ::Zenject::IMemoryPool_1<T>*& Zenject::PoolWrapperFactory_1<T>::__cordl_internal_get__pool()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____pool;
}
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::Zenject::IMemoryPool_1<T>*> const& Zenject::PoolWrapperFactory_1<T>::__cordl_internal_get__pool() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____pool;
}
template<typename T>
constexpr void Zenject::PoolWrapperFactory_1<T>::__cordl_internal_set__pool(::Zenject::IMemoryPool_1<T>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
// Ctor Parameters []
template<typename T>
constexpr ::Zenject::PoolWrapperFactory_1<T>::PoolWrapperFactory_1()   {
}
