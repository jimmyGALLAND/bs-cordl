...
/// @brief Field _buildsReflectionBakingCoverageMode, offset 0x70, size 0x4 
 __declspec(property(get=__cordl_internal_get__buildsReflectionBakingCoverageMode, put=__cordl_internal_set__buildsReflectionBakingCoverageMode)) ::Zenject::ReflectionBakingCoverageModes  _buildsReflectionBakingCoverageMode;
...
/// @brief Field _editorReflectionBakingCoverageMode, offset 0x6c, size 0x4 
 __declspec(property(get=__cordl_internal_get__editorReflectionBakingCoverageMode, put=__cordl_internal_set__editorReflectionBakingCoverageMode)) ::Zenject::ReflectionBakingCoverageModes  _editorReflectionBakingCoverageMode;
...
/// @brief Method Awake, addr 0x4a91118, size 0xa8, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method EnsureIsInitialized, addr 0x4a91114, size 0x4, virtual false, abstract: false, final false
inline void EnsureIsInitialized() ;

/// @brief Method GetInjectableMonoBehaviours, addr 0x4a91f64, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method GetRootGameObjects, addr 0x4a90aa0, size 0x78, virtual true, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::GameObject>>* GetRootGameObjects() ;

/// @brief Method Initialize, addr 0x4a90ca4, size 0x45c, virtual false, abstract: false, final false
inline void Initialize() ;

/// @brief Method InstallBindings, addr 0x4a91c2c, size 0x338, virtual false, abstract: false, final false
inline void InstallBindings(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::MonoBehaviour>>*  injectableMonoBehaviours) ;

/// @brief Method InstantiateAndInitialize, addr 0x4a9076c, size 0x29c, virtual false, abstract: false, final false
static inline void InstantiateAndInitialize() ;

static inline ::Zenject::ProjectContext* New_ctor() ;

/// @brief Method NoDomainReloadInit, addr 0x4a90600, size 0x48, virtual false, abstract: false, final false
static inline void NoDomainReloadInit() ;

/// @brief Method TryGetPrefab, addr 0x4a90b18, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method __zenCreateInjectTypeInfo, addr 0x4a92030, size 0x16c, virtual false, abstract: false, final false
static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo() ;

/// @brief Method .ctor, addr 0x4a92024, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_PostInstall, addr 0x4a90258, size 0x9c, virtual false, abstract: false, final false
inline void add_PostInstall(::System::Action*  value) ;

/// @brief Method add_PostResolve, addr 0x4a904c8, size 0x9c, virtual false, abstract: false, final false
inline void add_PostResolve(::System::Action*  value) ;

/// @brief Method add_PreInstall, addr 0x4a90120, size 0x9c, virtual false, abstract: false, final false
inline void add_PreInstall(::System::Action*  value) ;

/// @brief Method add_PreResolve, addr 0x4a90390, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method get_Container, addr 0x4a90648, size 0x8, virtual true, abstract: false, final false
inline ::Zenject::DiContainer* get_Container() ;

/// @brief Method get_HasInstance, addr 0x4a90650, size 0x78, virtual false, abstract: false, final false
static inline bool get_HasInstance() ;

/// @brief Method get_Instance, addr 0x4a906c8, size 0xa4, virtual false, abstract: false, final false
static inline ::UnityW<::Zenject::ProjectContext> get_Instance() ;

/// @brief Method get_ParentNewObjectsUnderContext, addr 0x4a91100, size 0x8, virtual false, abstract: false, final false
inline bool get_ParentNewObjectsUnderContext() ;

/// @brief Method get_ValidateOnNextRun, addr 0x4a90a08, size 0x48, virtual false, abstract: false, final false
static inline bool get_ValidateOnNextRun() ;

/// @brief Method remove_PostInstall, addr 0x4a902f4, size 0x9c, virtual false, abstract: false, final false
inline void remove_PostInstall(::System::Action*  value) ;

/// @brief Method remove_PostResolve, addr 0x4a90564, size 0x9c, virtual false, abstract: false, final false
inline void remove_PostResolve(::System::Action*  value) ;

/// @brief Method remove_PreInstall, addr 0x4a901bc, size 0x9c, virtual false, abstract: false, final false
inline void remove_PreInstall(::System::Action*  value) ;

/// @brief Method remove_PreResolve, addr 0x4a9042c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method set_ParentNewObjectsUnderContext, addr 0x4a91108, size 0xc, virtual false, abstract: false, final false
inline void set_ParentNewObjectsUnderContext(bool  value) ;

/// @brief Method set_ValidateOnNextRun, addr 0x4a90a50, size 0x50, virtual false, abstract: false, final false
