...
public:
// Declarations
/// @brief Method InstallBindings, addr 0x4aa47e4, size 0x4, virtual true, abstract: false, final false
inline void InstallBindings(::Zenject::DiContainer*  container) ;

static inline ::Zenject::NoTransitionInstaller* New_ctor() ;

/// @brief Method PostInstall, addr 0x4aa47e8, size 0x4, virtual true, abstract: false, final false
inline void PostInstall(::Zenject::DiContainer*  container) ;

/// @brief Method __zenCreateInjectTypeInfo, addr 0x4aa47f4, size 0x16c, virtual false, abstract: false, final false
static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo() ;

/// @brief Method .ctor, addr 0x4aa47ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
