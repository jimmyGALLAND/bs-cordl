...
template<typename T>
constexpr ::Zenject::IFactory_2<::StringW,T>* Zenject::PrefabResourceFactory_1<T>::i___Zenject__IFactory_2___StringW_T_() noexcept {
return static_cast<::Zenject::IFactory_2<::StringW,T>*>(static_cast<void*>(this));
}
...
template<typename T>
constexpr ::Zenject::IFactory* Zenject::PrefabResourceFactory_1<T>::i___Zenject__IFactory() noexcept {
return static_cast<::Zenject::IFactory*>(static_cast<void*>(this));
}
template<typename T>
constexpr ::Zenject::DiContainer*& Zenject::PrefabResourceFactory_1<T>::__cordl_internal_get__container()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____container;
}
template<typename T>
constexpr ::cordl_internals::to_const_pointer<::Zenject::DiContainer*> const& Zenject::PrefabResourceFactory_1<T>::__cordl_internal_get__container() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____container;
}
template<typename T>
constexpr void Zenject::PrefabResourceFactory_1<T>::__cordl_internal_set__container(::Zenject::DiContainer*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
// Ctor Parameters []
template<typename T>
constexpr ::Zenject::PrefabResourceFactory_1<T>::PrefabResourceFactory_1()   {
}
