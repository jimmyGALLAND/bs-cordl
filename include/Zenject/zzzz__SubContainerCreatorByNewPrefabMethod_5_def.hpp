...
class __SubContainerCreatorByNewPrefabMethod_5____c__DisplayClass2_0;
}
...
MARK_GEN_REF_PTR_T(::Zenject::__SubContainerCreatorByNewPrefabMethod_5____c__DisplayClass2_0);
...
/// @brief Field <>4__this, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get___4__this, put=__cordl_internal_set___4__this)) ::Zenject::SubContainerCreatorByNewPrefabMethod_5<TParam1,TParam2,TParam3,TParam4,TParam5>*  __4__this;
...
static inline ::Zenject::__SubContainerCreatorByNewPrefabMethod_5____c__DisplayClass2_0<TParam1,TParam2,TParam3,TParam4,TParam5>* New_ctor() ;
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::SubContainerCreatorByNewPrefabMethod_5<TParam1,TParam2,TParam3,TParam4,TParam5>*> const& __cordl_internal_get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
constexpr __SubContainerCreatorByNewPrefabMethod_5____c__DisplayClass2_0() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "__SubContainerCreatorByNewPrefabMethod_5____c__DisplayClass2_0", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
__SubContainerCreatorByNewPrefabMethod_5____c__DisplayClass2_0(__SubContainerCreatorByNewPrefabMethod_5____c__DisplayClass2_0 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "__SubContainerCreatorByNewPrefabMethod_5____c__DisplayClass2_0", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
__SubContainerCreatorByNewPrefabMethod_5____c__DisplayClass2_0(__SubContainerCreatorByNewPrefabMethod_5____c__DisplayClass2_0 const& ) = delete;
...
public:
// Declarations
using __c__DisplayClass2_0 = ::Zenject::__SubContainerCreatorByNewPrefabMethod_5____c__DisplayClass2_0<TParam1, TParam2, TParam3, TParam4, TParam5>;

/// @brief Field _installerMethod, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__installerMethod, put=__cordl_internal_set__installerMethod)) ::System::Action_6<::Zenject::DiContainer*,TParam1,TParam2,TParam3,TParam4,TParam5>*  _installerMethod;
...
static inline ::Zenject::SubContainerCreatorByNewPrefabMethod_5<TParam1,TParam2,TParam3,TParam4,TParam5>* New_ctor(::Zenject::DiContainer*  container, ::Zenject::IPrefabProvider*  prefabProvider, ::Zenject::GameObjectCreationParameters*  gameObjectBindInfo, ::System::Action_6<::Zenject::DiContainer*,TParam1,TParam2,TParam3,TParam4,TParam5>*  installerMethod) ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_6<::Zenject::DiContainer*,TParam1,TParam2,TParam3,TParam4,TParam5>*> const& __cordl_internal_get__installerMethod() const;
...
/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(::Zenject::DiContainer*  container, ::Zenject::IPrefabProvider*  prefabProvider, ::Zenject::GameObjectCreationParameters*  gameObjectBindInfo, ::System::Action_6<::Zenject::DiContainer*,TParam1,TParam2,TParam3,TParam4,TParam5>*  installerMethod) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::__SubContainerCreatorByNewPrefabMethod_5____c__DisplayClass2_0, "Zenject", "SubContainerCreatorByNewPrefabMethod`5/<>c__DisplayClass2_0");
