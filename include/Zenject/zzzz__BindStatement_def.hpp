...
/// @brief Method AddDisposable, addr 0x4a7fe94, size 0xa4, virtual false, abstract: false, final false
inline void AddDisposable(::System::IDisposable*  disposable) ;

/// @brief Method AssertHasFinalizer, addr 0x4a7fe38, size 0x44, virtual false, abstract: false, final false
inline void AssertHasFinalizer() ;

/// @brief Method Dispose, addr 0x4a80058, size 0x58, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method FinalizeBinding, addr 0x4a7ffa4, size 0xb4, virtual false, abstract: false, final false
inline void FinalizeBinding(::Zenject::DiContainer*  container) ;

static inline ::Zenject::BindStatement* New_ctor() ;

/// @brief Method Reset, addr 0x4a7fc54, size 0x13c, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetFinalizer, addr 0x4a7fe8c, size 0x8, virtual false, abstract: false, final false
inline void SetFinalizer(::Zenject::IBindingFinalizer*  bindingFinalizer) ;

/// @brief Method SpawnBindInfo, addr 0x4a7ff38, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4a7fbd0, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BindingInheritanceMethod, addr 0x4a7fd90, size 0xa8, virtual false, abstract: false, final false
inline ::Zenject::BindingInheritanceMethods get_BindingInheritanceMethod() ;

/// @brief Method get_HasFinalizer, addr 0x4a7fe7c, size 0x10, virtual false, abstract: false, final false
