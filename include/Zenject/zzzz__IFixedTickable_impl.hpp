...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::IFixedTickable::*)()>(&::Zenject::IFixedTickable::FixedTick)> {
...
inline void Zenject::IFixedTickable::FixedTick()  {
