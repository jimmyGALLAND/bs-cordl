...
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    ...
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::KeyedFactory_5<TBase,TKey,TParam1,TParam2,TParam3>*>::get(),
                    5
                )));
...
template<typename TBase,typename TKey,typename TParam1,typename TParam2,typename TParam3>
inline void Zenject::KeyedFactory_5<TBase,TKey,TParam1,TParam2,TParam3>::_ctor()  {
...
// Ctor Parameters []
template<typename TBase,typename TKey,typename TParam1,typename TParam2,typename TParam3>
constexpr ::Zenject::KeyedFactory_5<TBase,TKey,TParam1,TParam2,TParam3>::KeyedFactory_5()   {
}
