...
inline TDerived Zenject::MonoInstaller_1<TDerived>::InstallFromResource(::Zenject::DiContainer*  container)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::MonoInstaller_1<TDerived>*>::get(),
                        "InstallFromResource",
...
template<typename TDerived>
inline TDerived Zenject::MonoInstaller_1<TDerived>::InstallFromResource(::StringW  resourcePath, ::Zenject::DiContainer*  container)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::MonoInstaller_1<TDerived>*>::get(),
                        "InstallFromResource",
                        std::span<const Il2CppClass* const, 0>(),
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "InstallFromResource",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::DiContainer*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<::System::Object*,::Array<::System::Object*>*>>::get()}
                    )));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "InstallFromResource",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::DiContainer*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<::System::Object*,::Array<::System::Object*>*>>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<TDerived, false>(nullptr, ___internal_method, resourcePath, container, extraArgs);
}
template<typename TDerived>
inline ::Zenject::MonoInstaller_1<TDerived>* Zenject::MonoInstaller_1<TDerived>::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::MonoInstaller_1<TDerived>*>());
}
template<typename TDerived>
inline void Zenject::MonoInstaller_1<TDerived>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::MonoInstaller_1<TDerived>*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename TDerived>
inline ::Zenject::InjectTypeInfo* Zenject::MonoInstaller_1<TDerived>::__zenCreateInjectTypeInfo()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::MonoInstaller_1<TDerived>*>::get(),
...
// Ctor Parameters []
template<typename TDerived>
constexpr ::Zenject::MonoInstaller_1<TDerived>::MonoInstaller_1()   {
}
