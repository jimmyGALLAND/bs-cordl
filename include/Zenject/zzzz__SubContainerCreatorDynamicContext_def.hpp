...
/// @brief Method CreateSubContainer, addr 0x4aacef0, size 0xe4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x4aab2e0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Zenject::DiContainer*  container) ;

/// @brief Method get_Container, addr 0x4aacee8, size 0x8, virtual false, abstract: false, final false
