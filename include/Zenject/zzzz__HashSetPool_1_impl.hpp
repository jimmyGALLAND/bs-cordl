...
template<typename T>
inline void Zenject::HashSetPool_1<T>::setStaticF__instance(::Zenject::HashSetPool_1<T>*  value)  {
...
template<typename T>
inline ::Zenject::HashSetPool_1<T>* Zenject::HashSetPool_1<T>::getStaticF__instance()  {
...
template<typename T>
inline ::Zenject::HashSetPool_1<T>* Zenject::HashSetPool_1<T>::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::HashSetPool_1<T>*>());
}
template<typename T>
inline void Zenject::HashSetPool_1<T>::_ctor()  {
...
template<typename T>
inline ::Zenject::HashSetPool_1<T>* Zenject::HashSetPool_1<T>::get_Instance()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::HashSetPool_1<T>*>::get(),
                        "get_Instance",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T>
inline void Zenject::HashSetPool_1<T>::OnSpawned(::System::Collections::Generic::HashSet_1<T>*  items)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::HashSetPool_1<T>*>::get(),
                        "OnSpawned",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T>
inline void Zenject::HashSetPool_1<T>::OnDespawned(::System::Collections::Generic::HashSet_1<T>*  items)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::HashSetPool_1<T>*>::get(),
                        "OnDespawned",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters []
template<typename T>
constexpr ::Zenject::HashSetPool_1<T>::HashSetPool_1()   {
}
