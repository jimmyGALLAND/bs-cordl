...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder::*)(::Zenject::BindInfo*)>(&::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x4a7c24c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Zenject::ConcreteIdArgConditionCopyNonLazyBinder* (::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder::*)()>(&::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder::AsCached)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x4a7c400;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Zenject::ConcreteIdArgConditionCopyNonLazyBinder* (::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder::*)()>(&::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder::AsSingle)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x4a7c420;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Zenject::ConcreteIdArgConditionCopyNonLazyBinder* (::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder::*)()>(&::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder::AsTransient)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x4a7c448;
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder*>(bindInfo));
}
...
return ::cordl_internals::RunMethodRethrow<::Zenject::ConcreteIdArgConditionCopyNonLazyBinder*, false>(this, ___internal_method);
}
