...
/// @brief Method .ctor, addr 0x4a64c60, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  signalType) ;

/// @brief Method get_Identifier, addr 0x4a64c88, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* get_Identifier() ;

/// @brief Method get_MissingHandlerResponse, addr 0x4a64ccc, size 0x8, virtual false, abstract: false, final false
inline ::Zenject::SignalMissingHandlerResponses get_MissingHandlerResponse() ;

/// @brief Method get_RunAsync, addr 0x4a64ca8, size 0x8, virtual false, abstract: false, final false
inline bool get_RunAsync() ;

/// @brief Method get_SignalType, addr 0x4a64c98, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_SignalType() ;

/// @brief Method get_TickPriority, addr 0x4a64cbc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_TickPriority() ;

/// @brief Method set_Identifier, addr 0x4a64c90, size 0x8, virtual false, abstract: false, final false
inline void set_Identifier(::System::Object*  value) ;

/// @brief Method set_MissingHandlerResponse, addr 0x4a64cd4, size 0x8, virtual false, abstract: false, final false
inline void set_MissingHandlerResponse(::Zenject::SignalMissingHandlerResponses  value) ;

/// @brief Method set_RunAsync, addr 0x4a64cb0, size 0xc, virtual false, abstract: false, final false
inline void set_RunAsync(bool  value) ;

/// @brief Method set_SignalType, addr 0x4a64ca0, size 0x8, virtual false, abstract: false, final false
inline void set_SignalType(::System::Type*  value) ;

/// @brief Method set_TickPriority, addr 0x4a64cc4, size 0x8, virtual false, abstract: false, final false
