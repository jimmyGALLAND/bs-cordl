...
/// @brief Method WithGameObjectName, addr 0x4a7c09c, size 0x1c, virtual false, abstract: false, final false
inline ::Zenject::TransformScopeConcreteIdArgConditionCopyNonLazyBinder* WithGameObjectName(::StringW  gameObjectName) ;

/// @brief Method .ctor, addr 0x4a6e9bc, size 0x8, virtual false, abstract: false, final false
