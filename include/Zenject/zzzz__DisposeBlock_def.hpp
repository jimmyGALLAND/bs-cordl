...
/// @brief Field _objectPoolPairs, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__objectPoolPairs, put=__cordl_internal_set__objectPoolPairs)) ::System::Collections::Generic::List_1<::Zenject::__DisposeBlock__SpawnedObjectPoolPair>*  _objectPoolPairs;
...
/// @brief Method Add, addr 0x4abd244, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x4abd404, size 0x80, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method LazyInitializeDisposableList, addr 0x4abd150, size 0xf4, virtual false, abstract: false, final false
inline void LazyInitializeDisposableList() ;

static inline ::Zenject::DisposeBlock* New_ctor() ;

/// @brief Method OnDespawned, addr 0x4abcdf0, size 0x360, virtual false, abstract: false, final false
static inline void OnDespawned(::Zenject::DisposeBlock*  that) ;

/// @brief Method OnSpawned, addr 0x4abcdc4, size 0x2c, virtual false, abstract: false, final false
static inline void OnSpawned(::Zenject::DisposeBlock*  that) ;

/// @brief Method Remove, addr 0x4abd328, size 0x64, virtual false, abstract: false, final false
inline void Remove(::System::IDisposable*  disposable) ;

/// @brief Method Spawn, addr 0x4abd38c, size 0x78, virtual false, abstract: false, final false
...
template<typename T>
inline T Spawn(::Zenject::IMemoryPool_1<T>*  pool) ;

/// @brief Method Spawn, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TValue,typename TParam1>
inline TValue Spawn(::Zenject::IMemoryPool_2<TParam1,TValue>*  pool, TParam1  p1) ;

/// @brief Method Spawn, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename TValue,typename TParam1,typename TParam2>
inline TValue Spawn(::Zenject::IMemoryPool_3<TParam1,TParam2,TValue>*  pool, TParam1  p1, TParam2  p2) ;
...
inline TValue Spawn(::Zenject::IMemoryPool_8<TParam1,TParam2,TParam3,TParam4,TParam5,TParam6,TParam7,TValue>*  pool, TParam1  p1, TParam2  p2, TParam3  p3, TParam4  p4, TParam5  p5, TParam6  p6, TParam7  p7) ;

/// @brief Method SpawnList, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
inline ::System::Collections::Generic::List_1<T>* SpawnList() ;

/// @brief Method SpawnList, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
inline ::System::Collections::Generic::List_1<T>* SpawnList(::System::Collections::Generic::IEnumerable_1<T>*  elements) ;

/// @brief Method StoreSpawnedObject, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
inline void StoreSpawnedObject(T  obj, ::Zenject::IDespawnableMemoryPool_1<T>*  pool) ;
...
/// @brief Method .ctor, addr 0x4abd484, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
