...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::GetFromGameObjectGetterComponentProvider::*)(::System::Type*, ::System::Func_2<::Zenject::InjectContext*,::UnityW<::UnityEngine::GameObject>>*, bool)>(&::Zenject::GetFromGameObjectGetterComponentProvider::_ctor)> {
  constexpr static std::size_t size = 0x3c;
  constexpr static std::size_t addrs = 0x4aa6910;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Type*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Func_2<::Zenject::InjectContext*,::UnityW<::UnityEngine::GameObject>>*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Zenject::GetFromGameObjectGetterComponentProvider::*)()>(&::Zenject::GetFromGameObjectGetterComponentProvider::get_IsCached)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x4aa694c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Zenject::GetFromGameObjectGetterComponentProvider::*)()>(&::Zenject::GetFromGameObjectGetterComponentProvider::get_TypeVariesBasedOnMemberType)> {
  constexpr static std::size_t size = 0x8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Type* (::Zenject::GetFromGameObjectGetterComponentProvider::*)(::Zenject::InjectContext*)>(&::Zenject::GetFromGameObjectGetterComponentProvider::GetInstanceType)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x4aa695c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::GetFromGameObjectGetterComponentProvider::*)(::Zenject::InjectContext*, ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>*, ByRef<::System::Action*>, ::System::Collections::Generic::List_1<::System::Object*>*)>(&::Zenject::GetFromGameObjectGetterComponentProvider::GetAllInstancesWithInjectSplit)> {
  constexpr static std::size_t size = 0x210;
  constexpr static std::size_t addrs = 0x4aa6964;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::Zenject::InjectContext*,::UnityW<::UnityEngine::GameObject>>*> const& Zenject::GetFromGameObjectGetterComponentProvider::__cordl_internal_get__gameObjectGetter() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____gameObjectGetter;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> const& Zenject::GetFromGameObjectGetterComponentProvider::__cordl_internal_get__componentType() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____componentType;
}
...
inline ::Zenject::GetFromGameObjectGetterComponentProvider* Zenject::GetFromGameObjectGetterComponentProvider::New_ctor(::System::Type*  componentType, ::System::Func_2<::Zenject::InjectContext*,::UnityW<::UnityEngine::GameObject>>*  gameObjectGetter, bool  matchSingle)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::GetFromGameObjectGetterComponentProvider*>(componentType, gameObjectGetter, matchSingle));
}
inline void Zenject::GetFromGameObjectGetterComponentProvider::_ctor(::System::Type*  componentType, ::System::Func_2<::Zenject::InjectContext*,::UnityW<::UnityEngine::GameObject>>*  gameObjectGetter, bool  matchSingle)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::GetFromGameObjectGetterComponentProvider*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, componentType, gameObjectGetter, matchSingle);
}
...
inline void Zenject::GetFromGameObjectGetterComponentProvider::GetAllInstancesWithInjectSplit(::Zenject::InjectContext*  context, ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>*  args, ByRef<::System::Action*>  injectAction, ::System::Collections::Generic::List_1<::System::Object*>*  buffer)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::GetFromGameObjectGetterComponentProvider*>::get(),
                        "GetAllInstancesWithInjectSplit",
                        std::span<const Il2CppClass* const, 0>(),
