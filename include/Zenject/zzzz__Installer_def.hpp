...
/// @brief Method __zenCreateInjectTypeInfo, addr 0x4a957bc, size 0x16c, virtual false, abstract: false, final false
static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo() ;

/// @brief Method .ctor, addr 0x4a957ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
