...
inline void Zenject::PoolableMemoryPool_4<TParam1,TParam2,TParam3,TValue>::OnDespawned(TValue  item)  {
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::PoolableMemoryPool_4<TParam1,TParam2,TParam3,TValue>*>());
}
template<typename TParam1,typename TParam2,typename TParam3,typename TValue>
inline void Zenject::PoolableMemoryPool_4<TParam1,TParam2,TParam3,TValue>::_ctor()  {
...
// Ctor Parameters []
template<typename TParam1,typename TParam2,typename TParam3,typename TValue>
constexpr ::Zenject::PoolableMemoryPool_4<TParam1,TParam2,TParam3,TValue>::PoolableMemoryPool_4()   {
}
