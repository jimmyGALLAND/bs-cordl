...
/// @brief Method WithId, addr 0x4a69b4c, size 0x1c, virtual false, abstract: false, final false
inline ::Zenject::ConcreteBinderNonGeneric* WithId(::System::Object*  identifier) ;

/// @brief Method .ctor, addr 0x4a69b18, size 0x34, virtual false, abstract: false, final false
