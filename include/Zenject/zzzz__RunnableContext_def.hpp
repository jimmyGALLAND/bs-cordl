...
/// @brief Method Initialize, addr 0x4a8f3d0, size 0x9c, virtual false, abstract: false, final false
inline void Initialize() ;

static inline ::Zenject::RunnableContext* New_ctor() ;

/// @brief Method Run, addr 0x4a921b0, size 0x70, virtual true, abstract: false, final false
inline void Run() ;
...
/// @brief Method __zenCreateInjectTypeInfo, addr 0x4a9226c, size 0x16c, virtual false, abstract: false, final false
static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo() ;

/// @brief Method .ctor, addr 0x4a8fd30, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

static inline bool getStaticF__staticAutoRun() ;

/// @brief Method get_Initialized, addr 0x4a9219c, size 0x8, virtual false, abstract: false, final false
inline bool get_Initialized() ;

static inline void setStaticF__staticAutoRun(bool  value) ;

/// @brief Method set_Initialized, addr 0x4a921a4, size 0xc, virtual false, abstract: false, final false
