...
constexpr  Zenject::MemoryPool_3<TParam1,TParam2,TValue>::operator ::Zenject::IMemoryPool_3<TParam1,TParam2,TValue>*() noexcept {
...
template<typename TParam1,typename TParam2,typename TValue>
constexpr  Zenject::MemoryPool_3<TParam1,TParam2,TValue>::operator ::Zenject::IDespawnableMemoryPool_1<TValue>*() noexcept {
...
template<typename TParam1,typename TParam2,typename TValue>
constexpr  Zenject::MemoryPool_3<TParam1,TParam2,TValue>::operator ::Zenject::IMemoryPool*() noexcept {
return static_cast<::Zenject::IMemoryPool*>(static_cast<void*>(this));
}
/// @brief Convert to "::Zenject::IMemoryPool"
template<typename TParam1,typename TParam2,typename TValue>
constexpr ::Zenject::IMemoryPool* Zenject::MemoryPool_3<TParam1,TParam2,TValue>::i___Zenject__IMemoryPool() noexcept {
return static_cast<::Zenject::IMemoryPool*>(static_cast<void*>(this));
}
/// @brief Convert operator to "::Zenject::IFactory_3<TParam1,TParam2,TValue>"
template<typename TParam1,typename TParam2,typename TValue>
constexpr  Zenject::MemoryPool_3<TParam1,TParam2,TValue>::operator ::Zenject::IFactory_3<TParam1,TParam2,TValue>*() noexcept {
...
template<typename TParam1,typename TParam2,typename TValue>
constexpr  Zenject::MemoryPool_3<TParam1,TParam2,TValue>::operator ::Zenject::IFactory*() noexcept {
return static_cast<::Zenject::IFactory*>(static_cast<void*>(this));
}
/// @brief Convert to "::Zenject::IFactory"
template<typename TParam1,typename TParam2,typename TValue>
constexpr ::Zenject::IFactory* Zenject::MemoryPool_3<TParam1,TParam2,TValue>::i___Zenject__IFactory() noexcept {
return static_cast<::Zenject::IFactory*>(static_cast<void*>(this));
}
template<typename TParam1,typename TParam2,typename TValue>
inline TValue Zenject::MemoryPool_3<TParam1,TParam2,TValue>::Spawn(TParam1  param1, TParam2  param2)  {
...
template<typename TParam1,typename TParam2,typename TValue>
inline void Zenject::MemoryPool_3<TParam1,TParam2,TValue>::Reinitialize(TParam1  p1, TParam2  p2, TValue  item)  {
...
template<typename TParam1,typename TParam2,typename TValue>
inline TValue Zenject::MemoryPool_3<TParam1,TParam2,TValue>::Zenject_IFactory_TParam1_TParam2_TValue__Create(TParam1  p1, TParam2  p2)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::MemoryPool_3<TParam1,TParam2,TValue>*>::get(),
...
template<typename TParam1,typename TParam2,typename TValue>
inline ::Zenject::MemoryPool_3<TParam1,TParam2,TValue>* Zenject::MemoryPool_3<TParam1,TParam2,TValue>::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::MemoryPool_3<TParam1,TParam2,TValue>*>());
}
template<typename TParam1,typename TParam2,typename TValue>
inline void Zenject::MemoryPool_3<TParam1,TParam2,TValue>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::MemoryPool_3<TParam1,TParam2,TValue>*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename TParam1,typename TParam2,typename TValue>
inline ::Zenject::InjectTypeInfo* Zenject::MemoryPool_3<TParam1,TParam2,TValue>::__zenCreateInjectTypeInfo()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::MemoryPool_3<TParam1,TParam2,TValue>*>::get(),
...
// Ctor Parameters []
template<typename TParam1,typename TParam2,typename TValue>
constexpr ::Zenject::MemoryPool_3<TParam1,TParam2,TValue>::MemoryPool_3()   {
}
