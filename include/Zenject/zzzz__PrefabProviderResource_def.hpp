...
/// @brief Method GetPrefab, addr 0x4aa96d8, size 0xcc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x4aa96b0, size 0x28, virtual false, abstract: false, final false
