...
public:
// Declarations
/// @brief Method Lazy, addr 0x4a7c3e4, size 0x1c, virtual false, abstract: false, final false
inline ::Zenject::IfNotBoundBinder* Lazy() ;

static inline ::Zenject::NonLazyBinder* New_ctor(::Zenject::BindInfo*  bindInfo) ;

/// @brief Method NonLazy, addr 0x4a7c3c4, size 0x20, virtual false, abstract: false, final false
inline ::Zenject::IfNotBoundBinder* NonLazy() ;

/// @brief Method .ctor, addr 0x4a7c39c, size 0x28, virtual false, abstract: false, final false
