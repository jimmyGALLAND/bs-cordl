...
constexpr ::Zenject::FactoryBindInfo*& Zenject::PlaceholderFactoryBindingFinalizer_1<TContract>::__cordl_internal_get__factoryBindInfo()  {
...
template<typename TContract>
constexpr void Zenject::PlaceholderFactoryBindingFinalizer_1<TContract>::__cordl_internal_set__factoryBindInfo(::Zenject::FactoryBindInfo*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::BindInfo*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::FactoryBindInfo*>::get()}
                    )));
...
// Ctor Parameters []
template<typename TContract>
constexpr ::Zenject::PlaceholderFactoryBindingFinalizer_1<TContract>::PlaceholderFactoryBindingFinalizer_1()   {
}
