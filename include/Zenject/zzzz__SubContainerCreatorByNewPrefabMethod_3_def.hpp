...
constexpr ::cordl_internals::to_const_pointer<::Zenject::SubContainerCreatorByNewPrefabMethod_3<TParam1,TParam2,TParam3>*> const& __cordl_internal_get___4__this() const;
