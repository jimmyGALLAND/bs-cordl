...
/// @brief Field _typePairs, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__typePairs, put=__cordl_internal_set__typePairs)) ::System::Collections::Generic::List_1<::ModestTree::Util::ValuePair_2<TKey,::System::Type*>*>*  _typePairs;
