...
template<typename TParam1,typename TParam2,typename TParam3,typename TParam4,typename TParam5,typename TValue>
constexpr ::cordl_internals::to_const_pointer<::System::Action_6<TParam1,TParam2,TParam3,TParam4,TParam5,TValue>*> const& Zenject::StaticMemoryPool_6<TParam1,TParam2,TParam3,TParam4,TParam5,TValue>::__cordl_internal_get__onSpawnMethod() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____onSpawnMethod;
}
template<typename TParam1,typename TParam2,typename TParam3,typename TParam4,typename TParam5,typename TValue>
