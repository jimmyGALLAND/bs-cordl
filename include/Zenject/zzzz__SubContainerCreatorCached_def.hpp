...
/// @brief Method CreateSubContainer, addr 0x4aacd6c, size 0x17c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x4aacd44, size 0x28, virtual false, abstract: false, final false
