...
/// @brief Method .ctor, addr 0x4abf648, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method .ctor, addr 0x4abf6b0, size 0x70, virtual false, abstract: false, final false
