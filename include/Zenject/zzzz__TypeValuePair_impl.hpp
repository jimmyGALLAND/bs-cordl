...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::TypeValuePair::*)(::System::Type*, ::System::Object*)>(&::Zenject::TypeValuePair::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x4a8c518;
...
// Ctor Parameters [CppParam { name: "Type", ty: "::System::Type*", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "Value", ty: "::System::Object*", modifiers: "", def_value: Some("nullptr") }]
