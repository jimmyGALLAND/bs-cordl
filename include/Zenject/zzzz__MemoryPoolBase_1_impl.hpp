...
template<typename TContract>
constexpr ::cordl_internals::to_const_pointer<::Zenject::IFactory_1<TContract>*> const& Zenject::MemoryPoolBase_1<TContract>::__cordl_internal_get__factory() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____factory;
}
template<typename TContract>
...
template<typename TContract>
constexpr ::cordl_internals::to_const_pointer<::Zenject::MemoryPoolSettings*> const& Zenject::MemoryPoolBase_1<TContract>::__cordl_internal_get__settings() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____settings;
}
template<typename TContract>
...
template<typename TContract>
constexpr ::cordl_internals::to_const_pointer<::Zenject::DiContainer*> const& Zenject::MemoryPoolBase_1<TContract>::__cordl_internal_get__container() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____container;
}
template<typename TContract>
