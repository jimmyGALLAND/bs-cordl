...
/// @brief Method WithId, addr 0x4a64ba0, size 0x1c, virtual false, abstract: false, final false
inline ::Zenject::DeclareSignalRequireHandlerAsyncTickPriorityCopyBinder* WithId(::System::Object*  identifier) ;

/// @brief Method .ctor, addr 0x4a64b58, size 0x24, virtual false, abstract: false, final false
