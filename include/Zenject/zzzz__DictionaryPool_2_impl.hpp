...
inline void Zenject::DictionaryPool_2<TKey,TValue>::setStaticF__instance(::Zenject::DictionaryPool_2<TKey,TValue>*  value)  {
...
template<typename TKey,typename TValue>
inline ::Zenject::DictionaryPool_2<TKey,TValue>* Zenject::DictionaryPool_2<TKey,TValue>::getStaticF__instance()  {
...
template<typename TKey,typename TValue>
inline ::Zenject::DictionaryPool_2<TKey,TValue>* Zenject::DictionaryPool_2<TKey,TValue>::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::DictionaryPool_2<TKey,TValue>*>());
}
template<typename TKey,typename TValue>
inline void Zenject::DictionaryPool_2<TKey,TValue>::_ctor()  {
...
template<typename TKey,typename TValue>
inline ::Zenject::DictionaryPool_2<TKey,TValue>* Zenject::DictionaryPool_2<TKey,TValue>::get_Instance()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::DictionaryPool_2<TKey,TValue>*>::get(),
                        "get_Instance",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename TKey,typename TValue>
inline void Zenject::DictionaryPool_2<TKey,TValue>::OnSpawned(::System::Collections::Generic::Dictionary_2<TKey,TValue>*  items)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::DictionaryPool_2<TKey,TValue>*>::get(),
                        "OnSpawned",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename TKey,typename TValue>
inline void Zenject::DictionaryPool_2<TKey,TValue>::OnDespawned(::System::Collections::Generic::Dictionary_2<TKey,TValue>*  items)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::DictionaryPool_2<TKey,TValue>*>::get(),
                        "OnDespawned",
                        std::span<const Il2CppClass* const, 0>(),
...
// Ctor Parameters []
template<typename TKey,typename TValue>
constexpr ::Zenject::DictionaryPool_2<TKey,TValue>::DictionaryPool_2()   {
}
