...
static inline ::BeatmapSaveDataCommon::__BasicEventTypesWithKeywords__BasicEventTypesForKeyword* New_ctor(::StringW  keyword, ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>*  eventTypes) ;
...
/// @brief Method .ctor, addr 0x26bd980, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  keyword, ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>*  eventTypes) ;

/// @brief Method get_eventTypes, addr 0x26bd978, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>* get_eventTypes() ;

/// @brief Method get_keyword, addr 0x26bd970, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field d, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_d, put=__cordl_internal_set_d)) ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::__BasicEventTypesWithKeywords__BasicEventTypesForKeyword*>*  d;
...
static inline ::BeatmapSaveDataCommon::BasicEventTypesWithKeywords* New_ctor(::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::__BasicEventTypesWithKeywords__BasicEventTypesForKeyword*>*  data) ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::__BasicEventTypesWithKeywords__BasicEventTypesForKeyword*>*> const& __cordl_internal_get_d() const;
...
/// @brief Method .ctor, addr 0x26bba08, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_data, addr 0x26bd968, size 0x8, virtual false, abstract: false, final false
