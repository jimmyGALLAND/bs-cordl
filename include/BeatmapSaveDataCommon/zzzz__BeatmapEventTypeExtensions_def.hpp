...
public:
// Declarations
/// @brief Method GetSpecialEventTypes, addr 0x26bd89c, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26bd960, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
