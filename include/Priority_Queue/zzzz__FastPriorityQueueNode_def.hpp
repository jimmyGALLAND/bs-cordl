...
/// @brief Method .ctor, addr 0x2255e48, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Priority, addr 0x2255e28, size 0x8, virtual false, abstract: false, final false
inline float_t get_Priority() ;

/// @brief Method get_QueueIndex, addr 0x2255e38, size 0x8, virtual false, abstract: false, final false
inline int32_t get_QueueIndex() ;

/// @brief Method set_Priority, addr 0x2255e30, size 0x8, virtual false, abstract: false, final false
inline void set_Priority(float_t  value) ;

/// @brief Method set_QueueIndex, addr 0x2255e40, size 0x8, virtual false, abstract: false, final false
