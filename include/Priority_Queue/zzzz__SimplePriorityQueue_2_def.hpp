...
/// @brief Field _itemToNodesCache, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__itemToNodesCache, put=__cordl_internal_set__itemToNodesCache)) ::System::Collections::Generic::Dictionary_2<TItem,::System::Collections::Generic::IList_1<::Priority_Queue::__SimplePriorityQueue_2__SimpleNode<TItem,TPriority>*>*>*  _itemToNodesCache;

/// @brief Field _nullNodesCache, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__nullNodesCache, put=__cordl_internal_set__nullNodesCache)) ::System::Collections::Generic::IList_1<::Priority_Queue::__SimplePriorityQueue_2__SimpleNode<TItem,TPriority>*>*  _nullNodesCache;

/// @brief Field _queue, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__queue, put=__cordl_internal_set__queue)) ::Priority_Queue::GenericPriorityQueue_2<::Priority_Queue::__SimplePriorityQueue_2__SimpleNode<TItem,TPriority>*,TPriority>*  _queue;
...
constexpr ::System::Collections::Generic::Dictionary_2<TItem,::System::Collections::Generic::IList_1<::Priority_Queue::__SimplePriorityQueue_2__SimpleNode<TItem,TPriority>*>*>*& __cordl_internal_get__itemToNodesCache() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<TItem,::System::Collections::Generic::IList_1<::Priority_Queue::__SimplePriorityQueue_2__SimpleNode<TItem,TPriority>*>*>*> const& __cordl_internal_get__itemToNodesCache() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<::Priority_Queue::__SimplePriorityQueue_2__SimpleNode<TItem,TPriority>*>*> const& __cordl_internal_get__nullNodesCache() const;
...
constexpr ::cordl_internals::to_const_pointer<::Priority_Queue::GenericPriorityQueue_2<::Priority_Queue::__SimplePriorityQueue_2__SimpleNode<TItem,TPriority>*,TPriority>*> const& __cordl_internal_get__queue() const;

constexpr void __cordl_internal_set__itemToNodesCache(::System::Collections::Generic::Dictionary_2<TItem,::System::Collections::Generic::IList_1<::Priority_Queue::__SimplePriorityQueue_2__SimpleNode<TItem,TPriority>*>*>*  value) ;
