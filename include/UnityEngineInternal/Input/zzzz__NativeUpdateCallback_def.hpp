...
public:
// Declarations
/// @brief Method Invoke, addr 0x48566d4, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x4856648, size 0x8c, virtual false, abstract: false, final false
