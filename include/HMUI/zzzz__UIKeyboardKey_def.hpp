...
/// @brief Method Awake, addr 0x396b8d0, size 0xa0, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::HMUI::UIKeyboardKey* New_ctor() ;

/// @brief Method OnValidate, addr 0x396b970, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x396ba4c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_canBeUppercase, addr 0x396b8c8, size 0x8, virtual false, abstract: false, final false
inline bool get_canBeUppercase() ;

/// @brief Method get_keyCode, addr 0x396b8c0, size 0x8, virtual false, abstract: false, final false
