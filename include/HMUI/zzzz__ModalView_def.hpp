...
/// @brief Method <Hide>b__0, addr 0x2249094, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2248674, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <HandleParentViewControllerDidDeactivate>b__0, addr 0x2249110, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x224907c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CreateBlocker, addr 0x2248b30, size 0x458, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> CreateBlocker() ;

/// @brief Method GetModalRootTransform, addr 0x2248a30, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method HandleBlockerButtonClicked, addr 0x2248f88, size 0x1c, virtual false, abstract: false, final false
inline void HandleBlockerButtonClicked() ;

/// @brief Method HandleParentViewControllerDidDeactivate, addr 0x2248fa4, size 0xd8, virtual false, abstract: false, final false
inline void HandleParentViewControllerDidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method Hide, addr 0x2248468, size 0x20c, virtual true, abstract: false, final false
inline void Hide(bool  animated, ::System::Action*  finishedCallback) ;

static inline ::HMUI::ModalView* New_ctor() ;

/// @brief Method OnDestroy, addr 0x224815c, size 0x8c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x2248148, size 0x14, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method SetupView, addr 0x22481e8, size 0x280, virtual false, abstract: false, final false
inline void SetupView(::UnityEngine::Transform*  screenTransform) ;

/// @brief Method Show, addr 0x224867c, size 0x3b4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2249084, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_blockerClickedEvent, addr 0x2248010, size 0x9c, virtual true, abstract: false, final false
inline void add_blockerClickedEvent(::System::Action*  value) ;

/// @brief Method remove_blockerClickedEvent, addr 0x22480ac, size 0x9c, virtual true, abstract: false, final false
