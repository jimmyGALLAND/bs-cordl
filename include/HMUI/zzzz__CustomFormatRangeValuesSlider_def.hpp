...
/// @brief Method TextForValue, addr 0x396ddcc, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x396de3c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
