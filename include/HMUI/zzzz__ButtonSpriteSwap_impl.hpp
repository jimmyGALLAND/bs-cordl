...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::ButtonSpriteSwap::*)()>(&::HMUI::ButtonSpriteSwap::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x3970f9c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::ButtonSpriteSwap::*)()>(&::HMUI::ButtonSpriteSwap::Start)> {
  ...
  constexpr static std::size_t addrs = 0x39710c4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::ButtonSpriteSwap::*)()>(&::HMUI::ButtonSpriteSwap::OnEnable)> {
  ...
  constexpr static std::size_t addrs = 0x3971114;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::ButtonSpriteSwap::*)()>(&::HMUI::ButtonSpriteSwap::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x3971138;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::ButtonSpriteSwap::*)(::HMUI::__NoTransitionsButton__SelectionState)>(&::HMUI::ButtonSpriteSwap::HandleButtonSelectionStateDidChange)> {
  constexpr static std::size_t size = 0xcc;
  constexpr static std::size_t addrs = 0x39712a8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::ButtonSpriteSwap::*)()>(&::HMUI::ButtonSpriteSwap::RefreshVisualState)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x39710f0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::ButtonSpriteSwap::*)()>(&::HMUI::ButtonSpriteSwap::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3971374;
...
constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Image>,::Array<::UnityW<::UnityEngine::UI::Image>>*>& HMUI::ButtonSpriteSwap::__cordl_internal_get__images()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____images;
}
constexpr ::ArrayW<::UnityW<::UnityEngine::UI::Image>,::Array<::UnityW<::UnityEngine::UI::Image>>*> const& HMUI::ButtonSpriteSwap::__cordl_internal_get__images() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____images;
}
constexpr void HMUI::ButtonSpriteSwap::__cordl_internal_set__images(::ArrayW<::UnityW<::UnityEngine::UI::Image>,::Array<::UnityW<::UnityEngine::UI::Image>>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline void HMUI::ButtonSpriteSwap::HandleButtonSelectionStateDidChange(::HMUI::__NoTransitionsButton__SelectionState  state)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::ButtonSpriteSwap*>::get(),
                    5
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::HMUI::ButtonSpriteSwap*>());
}
