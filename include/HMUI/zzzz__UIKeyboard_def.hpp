...
/// @brief Method <Awake>b__2, addr 0x396b89c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x396b5dc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Awake, addr 0x396b2c0, size 0x31c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleCapsLockPressed, addr 0x396b6cc, size 0x18, virtual false, abstract: false, final false
inline void HandleCapsLockPressed() ;

/// @brief Method HandleKeyPress, addr 0x396b5e4, size 0xe8, virtual false, abstract: false, final false
inline void HandleKeyPress(::UnityEngine::KeyCode  keyCode) ;

/// @brief Method HasFontStyle, addr 0x396b7d0, size 0x20, virtual false, abstract: false, final false
inline bool HasFontStyle(::TMPro::TextMeshProUGUI*  text, ::TMPro::FontStyles  style) ;

static inline ::HMUI::UIKeyboard* New_ctor() ;

/// @brief Method OnEnable, addr 0x396b7f0, size 0xc, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method SetKeyboardCapitalization, addr 0x396b6e4, size 0xec, virtual false, abstract: false, final false
inline void SetKeyboardCapitalization(bool  capitalize) ;

/// @brief Method <Awake>b__13_0, addr 0x396b864, size 0x1c, virtual false, abstract: false, final false
inline void _Awake_b__13_0() ;

/// @brief Method <Awake>b__13_1, addr 0x396b880, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x396b7fc, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_deleteButtonWasPressedEvent, addr 0x396b188, size 0x9c, virtual false, abstract: false, final false
inline void add_deleteButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method add_keyWasPressedEvent, addr 0x396b028, size 0xb0, virtual false, abstract: false, final false
inline void add_keyWasPressedEvent(::System::Action_1<char16_t>*  value) ;

/// @brief Method add_okButtonWasPressedEvent, addr 0x396aef0, size 0x9c, virtual false, abstract: false, final false
inline void add_okButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method remove_deleteButtonWasPressedEvent, addr 0x396b224, size 0x9c, virtual false, abstract: false, final false
inline void remove_deleteButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method remove_keyWasPressedEvent, addr 0x396b0d8, size 0xb0, virtual false, abstract: false, final false
inline void remove_keyWasPressedEvent(::System::Action_1<char16_t>*  value) ;

/// @brief Method remove_okButtonWasPressedEvent, addr 0x396af8c, size 0x9c, virtual false, abstract: false, final false
