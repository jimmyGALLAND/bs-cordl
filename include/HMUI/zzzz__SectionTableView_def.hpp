...
/// @brief Field _sections, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get__sections, put=__cordl_internal_set__sections)) ::ArrayW<::HMUI::__SectionTableView__Section,::Array<::HMUI::__SectionTableView__Section>*>  _sections;
...
/// @brief Method CellForIdx, addr 0x397afcc, size 0x184, virtual true, abstract: false, final true
inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView*  tableView, int32_t  baseRow) ;

/// @brief Method CellSize, addr 0x397aeec, size 0xa0, virtual true, abstract: false, final true
inline float_t CellSize(int32_t  idx) ;

/// @brief Method DidSelectCellWithIdx, addr 0x397b724, size 0x7c, virtual true, abstract: false, final false
inline void DidSelectCellWithIdx(int32_t  baseRow) ;

/// @brief Method FoldAll, addr 0x397b7f8, size 0x54, virtual false, abstract: false, final false
inline void FoldAll() ;

/// @brief Method FoldSection, addr 0x397bd14, size 0xa8, virtual false, abstract: false, final false
inline void FoldSection(int32_t  section) ;

/// @brief Method IsSectionUnfolded, addr 0x397aeb8, size 0x34, virtual false, abstract: false, final false
inline bool IsSectionUnfolded(int32_t  section) ;

static inline ::HMUI::SectionTableView* New_ctor() ;

/// @brief Method NumberOfCells, addr 0x397af8c, size 0x40, virtual true, abstract: false, final true
inline int32_t NumberOfCells() ;

/// @brief Method ReloadData, addr 0x397b230, size 0x8, virtual true, abstract: false, final false
inline void ReloadData() ;

/// @brief Method ReloadData, addr 0x397b238, size 0x214, virtual false, abstract: false, final false
inline void ReloadData(bool  resetFoldState) ;

/// @brief Method ScrollToRow, addr 0x397c0d4, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method SectionAndRowForBaseRow, addr 0x397b150, size 0xe0, virtual false, abstract: false, final false
inline void SectionAndRowForBaseRow(int32_t  baseRow, ByRef<int32_t>  section, ByRef<int32_t>  row, ByRef<bool>  isSectionHeader) ;

/// @brief Method UnfoldAllSections, addr 0x397b7a0, size 0x58, virtual false, abstract: false, final false
inline void UnfoldAllSections() ;

/// @brief Method UnfoldSection, addr 0x397b84c, size 0x16c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x397c1fc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didSelectHeaderEvent, addr 0x397ad28, size 0xb0, virtual false, abstract: false, final false
inline void add_didSelectHeaderEvent(::System::Action_2<::UnityW<::HMUI::SectionTableView>,int32_t>*  value) ;

/// @brief Method add_didSelectRowInSectionEvent, addr 0x397abc8, size 0xb0, virtual false, abstract: false, final false
inline void add_didSelectRowInSectionEvent(::System::Action_3<::UnityW<::HMUI::SectionTableView>,int32_t,int32_t>*  value) ;

/// @brief Method get_dataSource, addr 0x397ae88, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method remove_didSelectHeaderEvent, addr 0x397add8, size 0xb0, virtual false, abstract: false, final false
inline void remove_didSelectHeaderEvent(::System::Action_2<::UnityW<::HMUI::SectionTableView>,int32_t>*  value) ;

/// @brief Method remove_didSelectRowInSectionEvent, addr 0x397ac78, size 0xb0, virtual false, abstract: false, final false
inline void remove_didSelectRowInSectionEvent(::System::Action_3<::UnityW<::HMUI::SectionTableView>,int32_t,int32_t>*  value) ;

/// @brief Method set_dataSource, addr 0x397ae90, size 0x28, virtual false, abstract: false, final false
