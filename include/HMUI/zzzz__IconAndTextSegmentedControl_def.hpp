...
/// @brief Method .ctor, addr 0x3ff8050, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Sprite*  icon, ::StringW  text, bool  interactable) ;

/// @brief Method get_icon, addr 0x3ff801c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_icon() ;

/// @brief Method get_interactable, addr 0x3ff803c, size 0x8, virtual false, abstract: false, final false
inline bool get_interactable() ;

/// @brief Method get_text, addr 0x3ff802c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_text() ;

/// @brief Method set_icon, addr 0x3ff8024, size 0x8, virtual false, abstract: false, final false
inline void set_icon(::UnityEngine::Sprite*  value) ;

/// @brief Method set_interactable, addr 0x3ff8044, size 0xc, virtual false, abstract: false, final false
inline void set_interactable(bool  value) ;

/// @brief Method set_text, addr 0x3ff8034, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _dataItems, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__dataItems, put=__cordl_internal_set__dataItems)) ::ArrayW<::HMUI::__IconAndTextSegmentedControl__DataItem*,::Array<::HMUI::__IconAndTextSegmentedControl__DataItem*>*>  _dataItems;
...
/// @brief Method CellForCellNumber, addr 0x3ff7994, size 0x150, virtual true, abstract: false, final true
inline ::UnityW<::HMUI::SegmentedControlCell> CellForCellNumber(int32_t  cellNumber) ;

/// @brief Method Init, addr 0x3ff7434, size 0x1c, virtual false, abstract: false, final false
inline void Init() ;

static inline ::HMUI::IconAndTextSegmentedControl* New_ctor() ;

/// @brief Method NumberOfCells, addr 0x3ff797c, size 0x18, virtual true, abstract: false, final true
inline int32_t NumberOfCells() ;

/// @brief Method SetData, addr 0x3ff7458, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method SetTextsActive, addr 0x3ff7b24, size 0x328, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ff7e7c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
