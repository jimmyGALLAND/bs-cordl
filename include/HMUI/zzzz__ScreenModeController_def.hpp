...
/// @brief Method Awake, addr 0x223fdcc, size 0x13c, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::HMUI::ScreenModeController* New_ctor() ;

/// @brief Method SetDefaultMode, addr 0x22401b4, size 0x8, virtual false, abstract: false, final false
inline void SetDefaultMode() ;

/// @brief Method SetMode, addr 0x223ffa0, size 0x214, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22401bc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
