...
/// @brief Method CellForIdx, addr 0x397a274, size 0x1bc, virtual true, abstract: false, final true
inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView*  tableView, int32_t  idx) ;

/// @brief Method CellSize, addr 0x397a1c0, size 0x8, virtual true, abstract: false, final true
inline float_t CellSize(int32_t  idx) ;

/// @brief Method HandleDidSelectCellWithIdx, addr 0x397a51c, size 0x14c, virtual false, abstract: false, final false
inline void HandleDidSelectCellWithIdx(::HMUI::DropdownWithTableView*  dropdownWithTableView, int32_t  idx) ;

/// @brief Method LazyInit, addr 0x3979d00, size 0xa8, virtual false, abstract: false, final false
inline void LazyInit() ;

static inline ::HMUI::SimpleTextDropdown* New_ctor() ;

/// @brief Method NumberOfCells, addr 0x397a1c8, size 0xac, virtual true, abstract: false, final true
inline int32_t NumberOfCells() ;

/// @brief Method OnDestroy, addr 0x3979da8, size 0x90, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SelectCellWithIdx, addr 0x3979fd4, size 0x1ec, virtual true, abstract: false, final false
inline void SelectCellWithIdx(int32_t  idx) ;

/// @brief Method SetTexts, addr 0x3979e38, size 0x19c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x397a668, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
