...
/// @brief Method Awake, addr 0x397a678, size 0x50, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleOnValueChanged, addr 0x397ab64, size 0x4, virtual false, abstract: false, final false
inline void HandleOnValueChanged(bool  value) ;

/// @brief Method HandleStateDidChange, addr 0x397ab68, size 0x4, virtual false, abstract: false, final false
inline void HandleStateDidChange(::HMUI::__ToggleWithCallbacks__SelectionState  value) ;

static inline ::HMUI::SwitchView* New_ctor() ;

/// @brief Method OnDestroy, addr 0x397a9ac, size 0x104, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method RefreshVisuals, addr 0x397a888, size 0x124, virtual false, abstract: false, final false
inline void RefreshVisuals() ;

/// @brief Method Start, addr 0x397a6c8, size 0x10c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x397abc0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
