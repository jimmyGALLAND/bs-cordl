...
/// @brief Method FormatTimeSpan, addr 0x396fc4c, size 0x154, virtual false, abstract: false, final false
static inline ::StringW FormatTimeSpan(::System::TimeSpan  ts) ;

static inline ::HMUI::TimeSlider* New_ctor() ;

/// @brief Method SetBounds, addr 0x396f9e8, size 0x14, virtual false, abstract: false, final false
inline void SetBounds(bool  valuesValid, float_t  lowerValue, float_t  upperValue) ;

/// @brief Method TextForValue, addr 0x396f9fc, size 0x250, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x396fda0, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
