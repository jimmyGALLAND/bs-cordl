...
/// @brief Method AddQuad, addr 0x2247034, size 0x2dc, virtual false, abstract: false, final false
...
/// @brief Method AddQuad, addr 0x2247310, size 0x274, virtual false, abstract: false, final false
...
/// @brief Method AddQuad, addr 0x2247584, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method AddQuadWithHorizontalGradient, addr 0x2246990, size 0x3b8, virtual false, abstract: false, final false
...
/// @brief Method AddQuadWithVerticalGradient, addr 0x2246d48, size 0x2ec, virtual false, abstract: false, final false
...
/// @brief Method GenerateFilledSprite, addr 0x2245ad8, size 0x9b8, virtual false, abstract: false, final false
inline void GenerateFilledSprite(::UnityEngine::UI::VertexHelper*  toFill, bool  preserveAspect, float_t  curvedUIRadius) ;

/// @brief Method GenerateSimpleSprite, addr 0x2243c28, size 0x6f4, virtual false, abstract: false, final false
inline void GenerateSimpleSprite(::UnityEngine::UI::VertexHelper*  vh, bool  lPreserveAspect, float_t  curvedUIRadius) ;

/// @brief Method GenerateSlicedSprite, addr 0x224431c, size 0xea4, virtual false, abstract: false, final false
inline void GenerateSlicedSprite(::UnityEngine::UI::VertexHelper*  toFill, float_t  curvedUIRadius) ;

/// @brief Method GenerateTiledSprite, addr 0x22451c0, size 0x918, virtual false, abstract: false, final false
inline void GenerateTiledSprite(::UnityEngine::UI::VertexHelper*  toFill, float_t  curvedUIRadius) ;

/// @brief Method GetAdjustedBorders, addr 0x224694c, size 0x44, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector4 GetAdjustedBorders(::UnityEngine::Vector4  border, ::UnityEngine::Rect  rect) ;

/// @brief Method GetDrawingDimensions, addr 0x22464a0, size 0x414, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 GetDrawingDimensions(bool  shouldPreserveAspect) ;

/// @brief Method GetNumberOfElements, addr 0x22468b4, size 0x98, virtual false, abstract: false, final false
static inline int32_t GetNumberOfElements(float_t  curvedUIRadius, float_t  width) ;

static inline ::HMUI::ImageView* New_ctor() ;

/// @brief Method OnEnable, addr 0x2243a8c, size 0x28, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPopulateMesh, addr 0x2243ab4, size 0x174, virtual true, abstract: false, final false
inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper*  toFill) ;

/// @brief Method RadialCut, addr 0x2247668, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method RadialCut, addr 0x2247788, size 0x42c, virtual false, abstract: false, final false
...
/// @brief Method __Refresh, addr 0x2246490, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2247bb4, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_color, addr 0x2243870, size 0x8c, virtual true, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_color0, addr 0x224392c, size 0x90, virtual true, abstract: false, final false
inline ::UnityEngine::Color get_color0() ;

/// @brief Method get_color1, addr 0x22439dc, size 0x90, virtual true, abstract: false, final false
inline ::UnityEngine::Color get_color1() ;

/// @brief Method get_gradient, addr 0x224390c, size 0x8, virtual true, abstract: false, final false
inline bool get_gradient() ;

/// @brief Method get_skew, addr 0x2243904, size 0x8, virtual false, abstract: false, final false
inline float_t get_skew() ;

/// @brief Method get_useScriptableObjectColors, addr 0x224385c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_color, addr 0x22438fc, size 0x8, virtual true, abstract: false, final false
inline void set_color(::UnityEngine::Color  value) ;

/// @brief Method set_color0, addr 0x22439bc, size 0x20, virtual true, abstract: false, final false
inline void set_color0(::UnityEngine::Color  value) ;

/// @brief Method set_color1, addr 0x2243a6c, size 0x20, virtual true, abstract: false, final false
inline void set_color1(::UnityEngine::Color  value) ;

/// @brief Method set_gradient, addr 0x2243914, size 0x18, virtual true, abstract: false, final false
inline void set_gradient(bool  value) ;

/// @brief Method set_useScriptableObjectColors, addr 0x2243864, size 0xc, virtual false, abstract: false, final false
