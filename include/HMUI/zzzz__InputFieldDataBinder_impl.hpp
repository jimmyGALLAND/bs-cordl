...
// Ctor Parameters []
template<typename T>
constexpr ::HMUI::__InputFieldDataBinder____c__3_1<T>::__InputFieldDataBinder____c__3_1()   {
}
template<typename T0,typename T1>
constexpr ::System::Func_2<::StringW,T1>*& HMUI::__InputFieldDataBinder____c__DisplayClass2_0_2<T0,T1>::__cordl_internal_get_toValueConvertor()  {
...
template<typename T0,typename T1>
constexpr void HMUI::__InputFieldDataBinder____c__DisplayClass2_0_2<T0,T1>::__cordl_internal_set_toValueConvertor(::System::Func_2<::StringW,T1>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T0,typename T1>
constexpr T0& HMUI::__InputFieldDataBinder____c__DisplayClass2_0_2<T0,T1>::__cordl_internal_get_valueItem()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___valueItem;
}
template<typename T0,typename T1>
constexpr T0 const& HMUI::__InputFieldDataBinder____c__DisplayClass2_0_2<T0,T1>::__cordl_internal_get_valueItem() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___valueItem;
}
template<typename T0,typename T1>
constexpr void HMUI::__InputFieldDataBinder____c__DisplayClass2_0_2<T0,T1>::__cordl_internal_set_valueItem(T0  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T0,typename T1>
constexpr ::UnityW<::UnityEngine::UI::InputField>& HMUI::__InputFieldDataBinder____c__DisplayClass2_0_2<T0,T1>::__cordl_internal_get_inputField()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___inputField;
}
template<typename T0,typename T1>
constexpr ::UnityW<::UnityEngine::UI::InputField> const& HMUI::__InputFieldDataBinder____c__DisplayClass2_0_2<T0,T1>::__cordl_internal_get_inputField() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___inputField;
}
template<typename T0,typename T1>
constexpr void HMUI::__InputFieldDataBinder____c__DisplayClass2_0_2<T0,T1>::__cordl_internal_set_inputField(::UnityW<::UnityEngine::UI::InputField>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T0,typename T1>
constexpr ::System::Func_2<T1,::StringW>*& HMUI::__InputFieldDataBinder____c__DisplayClass2_0_2<T0,T1>::__cordl_internal_get_toStringConvertor()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T0,typename T1>
constexpr void HMUI::__InputFieldDataBinder____c__DisplayClass2_0_2<T0,T1>::__cordl_internal_set_toStringConvertor(::System::Func_2<T1,::StringW>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
// Ctor Parameters []
template<typename T0,typename T1>
constexpr ::HMUI::__InputFieldDataBinder____c__DisplayClass2_0_2<T0,T1>::__InputFieldDataBinder____c__DisplayClass2_0_2()   {
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::InputFieldDataBinder::*)()>(&::HMUI::InputFieldDataBinder::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3966a7c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::InputFieldDataBinder::*)()>(&::HMUI::InputFieldDataBinder::ClearBindings)> {
  ...
  constexpr static std::size_t addrs = 0x3966afc;
...
constexpr ::System::Collections::Generic::List_1<::System::Tuple_4<::UnityW<::UnityEngine::UI::InputField>,::GlobalNamespace::IObservableChange*,::UnityEngine::Events::UnityAction_1<::StringW>*,::System::Action*>*>*& HMUI::InputFieldDataBinder::__cordl_internal_get__bindings()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____bindings;
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Tuple_4<::UnityW<::UnityEngine::UI::InputField>,::GlobalNamespace::IObservableChange*,::UnityEngine::Events::UnityAction_1<::StringW>*,::System::Action*>*>*> const& HMUI::InputFieldDataBinder::__cordl_internal_get__bindings() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____bindings;
}
constexpr void HMUI::InputFieldDataBinder::__cordl_internal_set__bindings(::System::Collections::Generic::List_1<::System::Tuple_4<::UnityW<::UnityEngine::UI::InputField>,::GlobalNamespace::IObservableChange*,::UnityEngine::Events::UnityAction_1<::StringW>*,::System::Action*>*>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T0,typename T1>
inline void HMUI::InputFieldDataBinder::AddBindings(::System::Collections::Generic::List_1<::System::Tuple_4<::UnityW<::UnityEngine::UI::InputField>,T0,::System::Func_2<::StringW,T1>*,::System::Func_2<T1,::StringW>*>*>*  bindingData)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ...
                    ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::List_1<::System::Tuple_4<::UnityW<::UnityEngine::UI::InputField>,T0,::System::Func_2<::StringW,T1>*,::System::Func_2<T1,::StringW>*>*>*>::get()}
                )));
...
template<typename T>
inline void HMUI::InputFieldDataBinder::AddStringBindings(::System::Collections::Generic::List_1<::System::Tuple_2<::UnityW<::UnityEngine::UI::InputField>,T>*>*  bindingData)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::InputFieldDataBinder*>::get(),
                    "AddStringBindings",
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()},
                    ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::List_1<::System::Tuple_2<::UnityW<::UnityEngine::UI::InputField>,T>*>*>::get()}
                )));
static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(
                    ___internal_method_base,
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}
