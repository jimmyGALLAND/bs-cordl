...
/// @brief Method Awake, addr 0x3971c18, size 0x174, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method GetNewTableViewRectSize, addr 0x3971fec, size 0x154, virtual false, abstract: false, final false
inline float_t GetNewTableViewRectSize(::HMUI::__TableView__IDataSource*  dataSource) ;

/// @brief Method HandleModalViewBlockerClicked, addr 0x3972214, size 0x8, virtual false, abstract: false, final false
inline void HandleModalViewBlockerClicked() ;

/// @brief Method HandleTableViewDidSelectCellWithIdx, addr 0x39721cc, size 0x48, virtual false, abstract: false, final false
inline void HandleTableViewDidSelectCellWithIdx(::HMUI::TableView*  tableView, int32_t  idx) ;

/// @brief Method Hide, addr 0x3971d94, size 0x40, virtual false, abstract: false, final false
inline void Hide(bool  animated) ;

/// @brief Method Init, addr 0x3971b84, size 0x28, virtual false, abstract: false, final false
inline void Init(::HMUI::__TableView__IDataSource*  tableViewDataSource) ;

static inline ::HMUI::DropdownWithTableView* New_ctor() ;

/// @brief Method OnButtonClick, addr 0x3972140, size 0x8, virtual false, abstract: false, final false
inline void OnButtonClick() ;

/// @brief Method OnDestroy, addr 0x3971dd4, size 0x1f0, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x3971d8c, size 0x8, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method RefreshSize, addr 0x3971fc4, size 0x28, virtual true, abstract: false, final false
inline void RefreshSize(::HMUI::__TableView__IDataSource*  dataSource) ;

/// @brief Method ReloadData, addr 0x3971bac, size 0x44, virtual false, abstract: false, final false
inline void ReloadData() ;

/// @brief Method SelectCellWithIdx, addr 0x3971bf0, size 0x28, virtual true, abstract: false, final false
inline void SelectCellWithIdx(int32_t  idx) ;

/// @brief Method Show, addr 0x3972148, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x397221c, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didSelectCellWithIdxEvent, addr 0x39719bc, size 0xb0, virtual false, abstract: false, final false
inline void add_didSelectCellWithIdxEvent(::System::Action_2<::UnityW<::HMUI::DropdownWithTableView>,int32_t>*  value) ;

/// @brief Method get_interactable, addr 0x3971b48, size 0x1c, virtual false, abstract: false, final false
inline bool get_interactable() ;

/// @brief Method get_selectedIndex, addr 0x3971b38, size 0x8, virtual false, abstract: false, final false
inline int32_t get_selectedIndex() ;

/// @brief Method get_tableViewDataSource, addr 0x3971b1c, size 0x1c, virtual false, abstract: false, final false
inline ::HMUI::__TableView__IDataSource* get_tableViewDataSource() ;

/// @brief Method remove_didSelectCellWithIdxEvent, addr 0x3971a6c, size 0xb0, virtual false, abstract: false, final false
inline void remove_didSelectCellWithIdxEvent(::System::Action_2<::UnityW<::HMUI::DropdownWithTableView>,int32_t>*  value) ;

/// @brief Method set_interactable, addr 0x3971b64, size 0x20, virtual false, abstract: false, final false
inline void set_interactable(bool  value) ;

/// @brief Method set_selectedIndex, addr 0x3971b40, size 0x8, virtual false, abstract: false, final false
