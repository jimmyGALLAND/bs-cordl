...
/// @brief Method <AddBinding>b__0, addr 0x39691fc, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3968bc4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _bindings, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__bindings, put=__cordl_internal_set__bindings)) ::System::Collections::Generic::List_1<::System::Tuple_2<::UnityW<::UnityEngine::UI::Toggle>,::UnityEngine::Events::UnityAction_1<bool>*>*>*  _bindings;
...
/// @brief Method AddBinding, addr 0x39689d0, size 0xdc, virtual false, abstract: false, final false
inline void AddBinding(::UnityEngine::UI::Toggle*  toggle, ::System::Action_1<bool>*  action) ;

/// @brief Method AddBinding, addr 0x3968aac, size 0x118, virtual false, abstract: false, final false
inline void AddBinding(::UnityEngine::UI::Toggle*  toggle, bool  enabled, ::System::Action*  action) ;

/// @brief Method AddBindings, addr 0x396886c, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method ClearBindings, addr 0x3968bcc, size 0x234, virtual false, abstract: false, final false
inline void ClearBindings() ;

/// @brief Method Disable, addr 0x3968e00, size 0x1fc, virtual false, abstract: false, final false
inline void Disable() ;

/// @brief Method Enable, addr 0x3968ffc, size 0x200, virtual false, abstract: false, final false
inline void Enable() ;

/// @brief Method Init, addr 0x39687bc, size 0x74, virtual false, abstract: false, final false
inline void Init() ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Tuple_2<::UnityW<::UnityEngine::UI::Toggle>,::UnityEngine::Events::UnityAction_1<bool>*>*>*> const& __cordl_internal_get__bindings() const;
...
/// @brief Method .ctor, addr 0x3968798, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3968830, size 0x3c, virtual false, abstract: false, final false
