...
// SizeInfo { instance_size: 328, native_size: -1, calculated_instance_size: 328, calculated_native_size: 321, minimum_alignment: 8, packing: None, specified_packing: None }
namespace HMUI {
// Is value type: false
...
/// @brief Field normalizedValueDidChangeEvent, offset 0x128, size 0x8 
 __declspec(property(get=__cordl_internal_get_normalizedValueDidChangeEvent, put=__cordl_internal_set_normalizedValueDidChangeEvent)) ::System::Action_2<::UnityW<::HMUI::TextSlider>,float_t>*  normalizedValueDidChangeEvent;
...
/// @brief Method GraphicUpdateComplete, addr 0x396f4c0, size 0x4, virtual true, abstract: false, final false
inline void GraphicUpdateComplete() ;

/// @brief Method LayoutComplete, addr 0x396f4bc, size 0x4, virtual true, abstract: false, final false
inline void LayoutComplete() ;

/// @brief Method MayDrag, addr 0x396f788, size 0x64, virtual false, abstract: false, final false
inline bool MayDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

static inline ::HMUI::TextSlider* New_ctor() ;

/// @brief Method OnBeginDrag, addr 0x396f7ec, size 0x88, virtual true, abstract: false, final false
inline void OnBeginDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnDisable, addr 0x396f514, size 0x24, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnDrag, addr 0x396f874, size 0x98, virtual true, abstract: false, final false
inline void OnDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnEnable, addr 0x396f4d4, size 0x40, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnInitializePotentialDrag, addr 0x396f9ac, size 0x18, virtual true, abstract: false, final false
inline void OnInitializePotentialDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnPointerDown, addr 0x396f90c, size 0xa0, virtual true, abstract: false, final false
inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x396f538, size 0x44, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method Rebuild, addr 0x396f4b8, size 0x4, virtual true, abstract: false, final false
inline void Rebuild(::UnityEngine::UI::CanvasUpdate  executing) ;

/// @brief Method Refresh, addr 0x396f4c4, size 0x10, virtual false, abstract: false, final false
inline void Refresh() ;

/// @brief Method SetNormalizedValue, addr 0x396e55c, size 0x8, virtual false, abstract: false, final false
inline void SetNormalizedValue(float_t  input) ;

/// @brief Method SetNormalizedValue, addr 0x396f424, size 0x94, virtual false, abstract: false, final false
inline void SetNormalizedValue(float_t  input, bool  sendCallback) ;

/// @brief Method TextForNormalizedValue, addr 0x396f9c4, size 0x1c, virtual true, abstract: false, final false
inline ::StringW TextForNormalizedValue(float_t  normalizedValue) ;

/// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x396f9e0, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::Transform> UnityEngine_UI_ICanvasElement_get_transform() ;

/// @brief Method UpdateCachedReferences, addr 0x396f14c, size 0x138, virtual false, abstract: false, final false
inline void UpdateCachedReferences() ;

/// @brief Method UpdateDrag, addr 0x396f57c, size 0x20c, virtual false, abstract: false, final false
inline void UpdateDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method UpdateVisuals, addr 0x396d4e8, size 0x3d0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x396dce0, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_normalizedValueDidChangeEvent, addr 0x396d110, size 0xb4, virtual false, abstract: false, final false
inline void add_normalizedValueDidChangeEvent(::System::Action_2<::UnityW<::HMUI::TextSlider>,float_t>*  value) ;

/// @brief Method get_handleRect, addr 0x396f0bc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_handleRect() ;

/// @brief Method get_handleSize, addr 0x396f284, size 0x8, virtual false, abstract: false, final false
inline float_t get_handleSize() ;

/// @brief Method get_normalizedValue, addr 0x396d8b8, size 0xb8, virtual false, abstract: false, final false
inline float_t get_normalizedValue() ;

/// @brief Method get_numberOfSteps, addr 0x396f41c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_numberOfSteps() ;

/// @brief Method get_separatorSize, addr 0x396f394, size 0x8, virtual false, abstract: false, final false
inline float_t get_separatorSize() ;

/// @brief Method get_valueSize, addr 0x396f30c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method remove_normalizedValueDidChangeEvent, addr 0x396d250, size 0xb4, virtual false, abstract: false, final false
inline void remove_normalizedValueDidChangeEvent(::System::Action_2<::UnityW<::HMUI::TextSlider>,float_t>*  value) ;

/// @brief Method set_handleColor, addr 0x396d970, size 0xc4, virtual false, abstract: false, final false
inline void set_handleColor(::UnityEngine::Color  value) ;

/// @brief Method set_handleRect, addr 0x396f0c4, size 0x88, virtual false, abstract: false, final false
inline void set_handleRect(::UnityEngine::RectTransform*  value) ;

/// @brief Method set_handleSize, addr 0x396f28c, size 0x80, virtual false, abstract: false, final false
inline void set_handleSize(float_t  value) ;

/// @brief Method set_normalizedValue, addr 0x396e030, size 0x8, virtual false, abstract: false, final false
inline void set_normalizedValue(float_t  value) ;

/// @brief Method set_numberOfSteps, addr 0x396d080, size 0x90, virtual false, abstract: false, final false
inline void set_numberOfSteps(int32_t  value) ;

/// @brief Method set_separatorSize, addr 0x396f39c, size 0x80, virtual false, abstract: false, final false
inline void set_separatorSize(float_t  value) ;

/// @brief Method set_valueSize, addr 0x396f314, size 0x80, virtual false, abstract: false, final false
inline void set_valueSize(float_t  value) ;

/// @brief Method set_valueTextColor, addr 0x396da34, size 0x24, virtual false, abstract: false, final false
