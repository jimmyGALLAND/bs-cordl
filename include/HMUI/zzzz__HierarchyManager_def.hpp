...
/// @brief Method HandleBeforeDismissingScenes, addr 0x223ea88, size 0xac, virtual false, abstract: false, final false
inline void HandleBeforeDismissingScenes(::System::Collections::Generic::List_1<::StringW>*  _) ;

/// @brief Method HandleSceneTransitionDidFinish, addr 0x223e8b0, size 0xac, virtual false, abstract: false, final false
inline void HandleSceneTransitionDidFinish(::GlobalNamespace::__GameScenesManager__SceneTransitionType  sceneTransitionType, ::GlobalNamespace::ScenesTransitionSetupDataSO*  scenesTransitionSetupData, ::Zenject::DiContainer*  container) ;

static inline ::HMUI::HierarchyManager* New_ctor() ;

/// @brief Method OnDestroy, addr 0x223e95c, size 0x12c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x223e798, size 0x118, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartWithFlowCoordinator, addr 0x223eb34, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x223eb58, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
