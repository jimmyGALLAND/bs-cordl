...
public:
// Declarations
/// @brief Method GetWorldCorners, addr 0x39788f8, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3978960, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
