...
/// @brief Field stateDidChangeEvent, offset 0x128, size 0x8 
 __declspec(property(get=__cordl_internal_get_stateDidChangeEvent, put=__cordl_internal_set_stateDidChangeEvent)) ::System::Action_1<::HMUI::__ToggleWithCallbacks__SelectionState>*  stateDidChangeEvent;

/// @brief Method DoStateTransition, addr 0x397f0e8, size 0x4c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x397f134, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_stateDidChangeEvent, addr 0x397a7d4, size 0xb4, virtual false, abstract: false, final false
inline void add_stateDidChangeEvent(::System::Action_1<::HMUI::__ToggleWithCallbacks__SelectionState>*  value) ;

/// @brief Method get_selectionState, addr 0x397ab6c, size 0x54, virtual false, abstract: false, final false
inline ::HMUI::__ToggleWithCallbacks__SelectionState get_selectionState() ;

/// @brief Method remove_stateDidChangeEvent, addr 0x397aab0, size 0xb4, virtual false, abstract: false, final false
