...
/// @brief Field _curvedMeshInfos, offset 0x7a8, size 0x8 
 __declspec(property(get=__cordl_internal_get__curvedMeshInfos, put=__cordl_internal_set__curvedMeshInfos)) ::ArrayW<::HMUI::__CurvedTextMeshPro__CurvedMeshInfo,::Array<::HMUI::__CurvedTextMeshPro__CurvedMeshInfo>*>  _curvedMeshInfos;
...
/// @brief Method FillColors, addr 0x224375c, size 0x74, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*> FillColors(int32_t  meshIndex, ::UnityEngine::Color32  color32) ;

/// @brief Method FillUV3s, addr 0x2243684, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method GenerateTextMesh, addr 0x22432e8, size 0x2dc, virtual true, abstract: false, final false
inline void GenerateTextMesh() ;

static inline ::HMUI::CurvedTextMeshPro* New_ctor() ;

/// @brief Method OnEnable, addr 0x22432c0, size 0x28, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method UpdateMesh, addr 0x22435c4, size 0xb0, virtual false, abstract: false, final false
inline void UpdateMesh(::UnityEngine::Mesh*  mesh, int32_t  meshIndex, ::UnityEngine::Vector2  curveUV, ::UnityEngine::Color32  color32) ;

/// @brief Method __Refresh, addr 0x2243674, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x22437d0, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_color, addr 0x2243224, size 0x94, virtual true, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_useScriptableObjectColors, addr 0x2243210, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_color, addr 0x22432b8, size 0x8, virtual true, abstract: false, final false
inline void set_color(::UnityEngine::Color  value) ;

/// @brief Method set_useScriptableObjectColors, addr 0x2243218, size 0xc, virtual false, abstract: false, final false
