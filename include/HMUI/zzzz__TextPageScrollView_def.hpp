...
/// @brief Method AddText, addr 0x397f054, size 0x64, virtual false, abstract: false, final false
inline void AddText(::StringW  text) ;

static inline ::HMUI::TextPageScrollView* New_ctor() ;

/// @brief Method SetText, addr 0x397efd4, size 0x30, virtual false, abstract: false, final false
inline void SetText(::StringW  text) ;

/// @brief Method UpdateMeshes, addr 0x397f004, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x397f0b8, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
