...
/// @brief Method .ctor, addr 0x3ff84cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_sprite, addr 0x3ff84b0, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_sprite() ;

/// @brief Method set_hideBackgroundImage, addr 0x3ff8354, size 0x9c, virtual false, abstract: false, final false
inline void set_hideBackgroundImage(bool  value) ;

/// @brief Method set_hintText, addr 0x3ff8338, size 0x1c, virtual false, abstract: false, final false
inline void set_hintText(::StringW  value) ;

/// @brief Method set_iconSize, addr 0x3ff83f0, size 0x3c, virtual false, abstract: false, final false
inline void set_iconSize(float_t  value) ;

/// @brief Method set_sprite, addr 0x3ff831c, size 0x1c, virtual false, abstract: false, final false
