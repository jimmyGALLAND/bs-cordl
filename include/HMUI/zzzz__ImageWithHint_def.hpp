...
/// @brief Method .ctor, addr 0x3975568, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_imageColor, addr 0x3975520, size 0x24, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_imageColor() ;

/// @brief Method get_sprite, addr 0x39754e8, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_sprite() ;

/// @brief Method set_hintText, addr 0x3975504, size 0x1c, virtual false, abstract: false, final false
inline void set_hintText(::StringW  value) ;

/// @brief Method set_imageColor, addr 0x3975544, size 0x24, virtual false, abstract: false, final false
inline void set_imageColor(::UnityEngine::Color  value) ;

/// @brief Method set_sprite, addr 0x39754cc, size 0x1c, virtual false, abstract: false, final false
