...
inline void UpdateColorStyle(::UnityEngine::Color  color, float_t  globalLightTintIntensity, bool  gradient, ::GlobalNamespace::GradientDirection  gradientDirection, ::UnityEngine::Color  color0, ::UnityEngine::Color  color1) ;
