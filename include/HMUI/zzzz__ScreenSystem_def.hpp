...
/// @brief Method Awake, addr 0x2240204, size 0xc0, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::HMUI::ScreenSystem* New_ctor() ;

/// @brief Method OnDestroy, addr 0x22402c4, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetBackButton, addr 0x223bfe0, size 0x30, virtual false, abstract: false, final false
inline void SetBackButton(bool  visible, bool  animated) ;

/// @brief Method <Awake>b__24_0, addr 0x22402e8, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22402e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_backButtonWasPressedEvent, addr 0x223d59c, size 0x9c, virtual false, abstract: false, final false
inline void add_backButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method get_bottomScreen, addr 0x22401f4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::HMUI::Screen> get_bottomScreen() ;

/// @brief Method get_leftScreen, addr 0x22401e4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::HMUI::Screen> get_leftScreen() ;

/// @brief Method get_mainScreen, addr 0x22401dc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::HMUI::Screen> get_mainScreen() ;

/// @brief Method get_rightScreen, addr 0x22401ec, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::HMUI::Screen> get_rightScreen() ;

/// @brief Method get_titleViewController, addr 0x22401d4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::HMUI::TitleViewController> get_titleViewController() ;

/// @brief Method get_topScreen, addr 0x22401fc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::HMUI::Screen> get_topScreen() ;

/// @brief Method remove_backButtonWasPressedEvent, addr 0x223d638, size 0x9c, virtual false, abstract: false, final false
