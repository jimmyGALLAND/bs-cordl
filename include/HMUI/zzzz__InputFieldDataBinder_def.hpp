...
/// @brief Method ClearBindings, addr 0x3966afc, size 0x2c4, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Tuple_4<::UnityW<::UnityEngine::UI::InputField>,::GlobalNamespace::IObservableChange*,::UnityEngine::Events::UnityAction_1<::StringW>*,::System::Action*>*>*> const& __cordl_internal_get__bindings() const;
...
/// @brief Method .ctor, addr 0x3966a7c, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
