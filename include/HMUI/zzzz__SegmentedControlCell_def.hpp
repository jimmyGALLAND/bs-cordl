...
/// @brief Method InternalToggle, addr 0x3ff9024, size 0x24, virtual true, abstract: false, final false
inline void InternalToggle() ;

static inline ::HMUI::SegmentedControlCell* New_ctor() ;

/// @brief Method SegmentedControlSetup, addr 0x3ff8d00, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3ff80d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_cellNumber, addr 0x3ff9014, size 0x8, virtual false, abstract: false, final false
inline int32_t get_cellNumber() ;

/// @brief Method set_cellNumber, addr 0x3ff901c, size 0x8, virtual false, abstract: false, final false
