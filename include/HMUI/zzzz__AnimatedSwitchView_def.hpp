...
/// @brief Method .ctor, addr 0x224308c, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x22430b8, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x22430d8, size 0x2c, virtual true, abstract: false, final false
inline ::UnityEngine::Color EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x22430a4, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2242d4c, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method <LerpColors>b__31_0, addr 0x2243168, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::Color _LerpColors_b__31_0(::HMUI::__AnimatedSwitchView__ColorBlock*  colorBlock) ;

/// @brief Method <LerpColors>b__31_1, addr 0x2243184, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::Color _LerpColors_b__31_1(::HMUI::__AnimatedSwitchView__ColorBlock*  colorBlock) ;

/// @brief Method <LerpColors>b__31_2, addr 0x22431a0, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::Color _LerpColors_b__31_2(::HMUI::__AnimatedSwitchView__ColorBlock*  colorBlock) ;

/// @brief Method <LerpColors>b__31_3, addr 0x22431bc, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::Color _LerpColors_b__31_3(::HMUI::__AnimatedSwitchView__ColorBlock*  colorBlock) ;

/// @brief Method <LerpColors>b__31_4, addr 0x22431d8, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::Color _LerpColors_b__31_4(::HMUI::__AnimatedSwitchView__ColorBlock*  colorBlock) ;

/// @brief Method <LerpColors>b__31_5, addr 0x22431f4, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::Color _LerpColors_b__31_5(::HMUI::__AnimatedSwitchView__ColorBlock*  colorBlock) ;

/// @brief Method .ctor, addr 0x2243160, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Awake, addr 0x22421ac, size 0x50, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleOnValueChanged, addr 0x2242ff4, size 0x28, virtual false, abstract: false, final false
inline void HandleOnValueChanged(bool  value) ;

/// @brief Method HandleStateDidChange, addr 0x224301c, size 0x50, virtual false, abstract: false, final false
inline void HandleStateDidChange(::HMUI::__ToggleWithCallbacks__SelectionState  selectionState) ;

/// @brief Method LerpColor, addr 0x2242e4c, size 0x1a8, virtual false, abstract: false, final false
...
/// @brief Method LerpColors, addr 0x224239c, size 0x4e4, virtual false, abstract: false, final false
inline void LerpColors(float_t  switchAmount, float_t  highlightAmount, float_t  disabledAmount) ;

/// @brief Method LerpPosition, addr 0x2242880, size 0x64, virtual false, abstract: false, final false
inline void LerpPosition(float_t  switchAmount) ;

/// @brief Method LerpStretch, addr 0x2242ccc, size 0x80, virtual false, abstract: false, final false
inline void LerpStretch(float_t  switchAmount) ;

static inline ::HMUI::AnimatedSwitchView* New_ctor() ;

/// @brief Method OnDestroy, addr 0x22428e4, size 0x148, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x22421fc, size 0x1a0, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x2242a2c, size 0x2a0, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x224306c, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
