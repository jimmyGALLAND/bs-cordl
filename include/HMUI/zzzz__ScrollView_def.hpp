...
/// @brief Method <Awake>b__42_1, addr 0x39788b0, size 0x4, virtual false, abstract: false, final false
inline float_t _Awake_b__42_1(float_t  i) ;

/// @brief Method <Awake>b__42_3, addr 0x39788b4, size 0x4, virtual false, abstract: false, final false
inline float_t _Awake_b__42_3(float_t  i) ;

/// @brief Method .ctor, addr 0x39788a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <PageUpButtonPressed>b__0, addr 0x39788b8, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3978418, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <PageDownButtonPressed>b__0, addr 0x39788c8, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3978728, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <HandleJoystickWasCenteredThisFrame>b__0, addr 0x39788d8, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x397879c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <HandleJoystickWasCenteredThisFrame>b__1, addr 0x39788e8, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39787a4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _lastJoystickScrollDirection, offset 0xa0, size 0x4 
 __declspec(property(get=__cordl_internal_get__lastJoystickScrollDirection, put=__cordl_internal_set__lastJoystickScrollDirection)) ::HMUI::__ScrollView__ScrollDirection  _lastJoystickScrollDirection;
...
/// @brief Method Awake, addr 0x3976c94, size 0x4dc, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CheckScrollInput, addr 0x3977418, size 0x15c, virtual false, abstract: false, final false
inline void CheckScrollInput() ;

/// @brief Method HandleJoystickWasCenteredThisFrame, addr 0x3977668, size 0x45c, virtual false, abstract: false, final false
inline void HandleJoystickWasCenteredThisFrame() ;

/// @brief Method HandleJoystickWasNotCenteredThisFrame, addr 0x3977574, size 0xf4, virtual false, abstract: false, final false
inline void HandleJoystickWasNotCenteredThisFrame(::UnityEngine::Vector2  deltaPos) ;

/// @brief Method HandlePointerDidEnter, addr 0x3978730, size 0x14, virtual false, abstract: false, final false
inline void HandlePointerDidEnter(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method HandlePointerDidExit, addr 0x3978744, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x39772e4, size 0x134, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method PageDownButtonPressed, addr 0x3978420, size 0x308, virtual false, abstract: false, final false
inline void PageDownButtonPressed() ;

/// @brief Method PageUpButtonPressed, addr 0x3978140, size 0x2d8, virtual false, abstract: false, final false
inline void PageUpButtonPressed() ;

/// @brief Method RefreshButtons, addr 0x39771d4, size 0x110, virtual false, abstract: false, final false
inline void RefreshButtons() ;

/// @brief Method ResolveScrollDirection, addr 0x397874c, size 0x50, virtual false, abstract: false, final false
inline ::HMUI::__ScrollView__ScrollDirection ResolveScrollDirection(::UnityEngine::Vector2  deltaPos) ;

/// @brief Method ScrollTo, addr 0x3976994, size 0xc4, virtual false, abstract: false, final false
inline void ScrollTo(float_t  destinationPos, bool  animated) ;

/// @brief Method ScrollToEnd, addr 0x3977edc, size 0x40, virtual false, abstract: false, final false
inline void ScrollToEnd(bool  animated) ;

/// @brief Method ScrollToWorldPosition, addr 0x3977f1c, size 0x48, virtual false, abstract: false, final false
inline void ScrollToWorldPosition(::UnityEngine::Vector3  worldPosition, float_t  pageRelativePosition, bool  animated) ;

/// @brief Method ScrollToWorldPositionIfOutsideArea, addr 0x3978014, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method SetContentSize, addr 0x3977cb8, size 0x1f8, virtual false, abstract: false, final false
inline void SetContentSize(float_t  contentSize) ;

/// @brief Method SetDestinationPos, addr 0x39780c4, size 0x50, virtual false, abstract: false, final false
inline void SetDestinationPos(float_t  value) ;

/// @brief Method Update, addr 0x3977ac4, size 0x120, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateContentSize, addr 0x3977170, size 0x64, virtual false, abstract: false, final false
inline void UpdateContentSize() ;

/// @brief Method UpdateVerticalScrollIndicator, addr 0x3977be4, size 0xd4, virtual false, abstract: false, final false
inline void UpdateVerticalScrollIndicator(float_t  posY) ;

/// @brief Method WorldPositionToScrollViewPosition, addr 0x3977f64, size 0xb0, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 WorldPositionToScrollViewPosition(::UnityEngine::Vector3  worldPosition) ;

/// @brief Method <Awake>b__42_0, addr 0x39787dc, size 0x3c, virtual false, abstract: false, final false
inline float_t _Awake_b__42_0(::HMUI::ItemForFocussedScrolling*  item) ;

/// @brief Method <Awake>b__42_2, addr 0x3978818, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39787ac, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_scrollPositionChangedEvent, addr 0x3976a60, size 0xb0, virtual false, abstract: false, final false
inline void add_scrollPositionChangedEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method get_contentSize, addr 0x3976c34, size 0x30, virtual false, abstract: false, final false
inline float_t get_contentSize() ;

/// @brief Method get_contentTransform, addr 0x3976bc8, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_contentTransform() ;

/// @brief Method get_position, addr 0x3976bd0, size 0x30, virtual false, abstract: false, final false
inline float_t get_position() ;

/// @brief Method get_scrollPageSize, addr 0x3976c64, size 0x30, virtual false, abstract: false, final false
inline float_t get_scrollPageSize() ;

/// @brief Method get_scrollableSize, addr 0x3976c00, size 0x34, virtual false, abstract: false, final false
inline float_t get_scrollableSize() ;

/// @brief Method get_viewportTransform, addr 0x3976bc0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_viewportTransform() ;

/// @brief Method remove_scrollPositionChangedEvent, addr 0x3976b10, size 0xb0, virtual false, abstract: false, final false
