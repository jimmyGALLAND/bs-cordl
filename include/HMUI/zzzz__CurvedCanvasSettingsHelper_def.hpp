...
static __declspec(property(get=getStaticF__curvedCanvasCache, put=setStaticF__curvedCanvasCache)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Canvas>,::UnityW<::HMUI::CurvedCanvasSettings>>*  _curvedCanvasCache;
...
/// @brief Method GetCurvedCanvasSettings, addr 0x3969634, size 0x1ec, virtual false, abstract: false, final false
inline ::UnityW<::HMUI::CurvedCanvasSettings> GetCurvedCanvasSettings(::UnityEngine::Canvas*  canvas) ;

/// @brief Method GetCurvedCanvasSettingsForCanvas, addr 0x3969820, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x3969620, size 0x14, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x396995c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
