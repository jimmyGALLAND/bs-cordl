...
/// @brief Method OnCanvasGroupChanged, addr 0x39699f0, size 0x194, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3969b84, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
