...
/// @brief Method Awake, addr 0x396cfe8, size 0x98, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleNormalizedValueDidChange, addr 0x396dbf0, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x396d1c4, size 0x8c, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnPointerUp, addr 0x396dc44, size 0x98, virtual true, abstract: false, final false
inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method SetColors, addr 0x396d304, size 0x30, virtual false, abstract: false, final false
inline void SetColors(::UnityEngine::Color  color0, ::UnityEngine::Color  color1) ;

/// @brief Method TextForNormalizedValue, addr 0x396da58, size 0x198, virtual true, abstract: false, final false
inline ::StringW TextForNormalizedValue(float_t  normalizedValue) ;

/// @brief Method UpdateVisuals, addr 0x396d334, size 0x1b4, virtual true, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_3<::UnityW<::HMUI::ColorGradientSlider>,::UnityEngine::Color,::GlobalNamespace::ColorChangeUIEventType>*> const& __cordl_internal_get_colorDidChangeEvent() const;
...
/// @brief Method .ctor, addr 0x396dcdc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_colorDidChangeEvent, addr 0x396ce80, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method remove_colorDidChangeEvent, addr 0x396cf34, size 0xb4, virtual false, abstract: false, final false
