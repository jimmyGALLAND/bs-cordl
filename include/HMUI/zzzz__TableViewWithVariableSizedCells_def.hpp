...
/// @brief Method GetCellPosition, addr 0x397ed68, size 0x50, virtual true, abstract: false, final false
inline float_t GetCellPosition(int32_t  idx) ;

/// @brief Method GetCellSize, addr 0x397ed38, size 0x30, virtual true, abstract: false, final false
inline float_t GetCellSize(int32_t  idx) ;

/// @brief Method GetMaxVisibleIdx, addr 0x397ec44, size 0xf4, virtual true, abstract: false, final false
inline int32_t GetMaxVisibleIdx() ;

/// @brief Method GetMinVisibleIdx, addr 0x397eb6c, size 0xd8, virtual true, abstract: false, final false
inline int32_t GetMinVisibleIdx() ;

static inline ::HMUI::TableViewWithVariableSizedCells* New_ctor() ;

/// @brief Method UpdateCachedData, addr 0x397edb8, size 0x218, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x397efd0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_contentSize, addr 0x397eb64, size 0x8, virtual true, abstract: false, final false
