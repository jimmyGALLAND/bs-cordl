...
/// @brief Method .ctor, addr 0x39761a4, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x3976278, size 0x8c, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::HMUI::__InputFieldView___BlinkingCaretCoroutine_d__43* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3976304, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x397630c, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3976344, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x3976274, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3976048, size 0x28, virtual false, abstract: false, final false
...
/// @brief Field selectionStateDidChangeEvent, offset 0x148, size 0x8 
 __declspec(property(get=__cordl_internal_get_selectionStateDidChangeEvent, put=__cordl_internal_set_selectionStateDidChangeEvent)) ::System::Action_1<::HMUI::__InputFieldView__SelectionState>*  selectionStateDidChangeEvent;

 __declspec(property(get=get_text, put=set_text)) ::StringW  text;

 __declspec(property(get=get_useGlobalKeyboard)) bool  useGlobalKeyboard;

/// @brief Method ActivateKeyboard, addr 0x39759e0, size 0x1b8, virtual false, abstract: false, final false
inline void ActivateKeyboard(::HMUI::UIKeyboard*  keyboard) ;

/// @brief Method Awake, addr 0x3975884, size 0xe8, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method BlinkingCaretCoroutine, addr 0x3975b98, size 0x60, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* BlinkingCaretCoroutine() ;

/// @brief Method ClearInput, addr 0x3975ddc, size 0x50, virtual false, abstract: false, final false
inline void ClearInput() ;

/// @brief Method DeactivateKeyboard, addr 0x3975bf8, size 0x198, virtual false, abstract: false, final false
inline void DeactivateKeyboard(::HMUI::UIKeyboard*  keyboard) ;

/// @brief Method DoStateTransition, addr 0x3975980, size 0x60, virtual true, abstract: false, final false
inline void DoStateTransition(::UnityEngine::UI::__Selectable__SelectionState  state, bool  instant) ;

/// @brief Method KeyboardDeletePressed, addr 0x3975f6c, size 0xdc, virtual false, abstract: false, final false
inline void KeyboardDeletePressed() ;

/// @brief Method KeyboardKeyPressed, addr 0x3975e2c, size 0x140, virtual false, abstract: false, final false
inline void KeyboardKeyPressed(char16_t  letter) ;

static inline ::HMUI::InputFieldView* New_ctor() ;

/// @brief Method OnDestroy, addr 0x397596c, size 0x14, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetText, addr 0x3975dc4, size 0x18, virtual false, abstract: false, final false
inline void SetText(::StringW  value) ;

/// @brief Method UpdateCaretPosition, addr 0x3975768, size 0xec, virtual false, abstract: false, final false
inline void UpdateCaretPosition() ;

/// @brief Method UpdateClearButton, addr 0x3975d90, size 0x34, virtual false, abstract: false, final false
inline void UpdateClearButton() ;

/// @brief Method UpdatePlaceholder, addr 0x3975854, size 0x30, virtual false, abstract: false, final false
inline void UpdatePlaceholder() ;

/// @brief Method <Awake>b__34_0, addr 0x39761ec, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3976070, size 0x134, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_selectionStateDidChangeEvent, addr 0x3975580, size 0xb4, virtual false, abstract: false, final false
inline void add_selectionStateDidChangeEvent(::System::Action_1<::HMUI::__InputFieldView__SelectionState>*  value) ;

/// @brief Method get_keyboardPositionOffset, addr 0x39756f8, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_keyboardPositionOffset() ;

/// @brief Method get_onValueChanged, addr 0x3975570, size 0x8, virtual false, abstract: false, final false
inline ::HMUI::__InputFieldView__InputFieldChanged* get_onValueChanged() ;

/// @brief Method get_selectionState, addr 0x39756e8, size 0x8, virtual false, abstract: false, final false
inline ::HMUI::__InputFieldView__SelectionState get_selectionState() ;

/// @brief Method get_text, addr 0x3975708, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_text() ;

/// @brief Method get_useGlobalKeyboard, addr 0x39756f0, size 0x8, virtual false, abstract: false, final false
inline bool get_useGlobalKeyboard() ;

/// @brief Method remove_selectionStateDidChangeEvent, addr 0x3975634, size 0xb4, virtual false, abstract: false, final false
inline void remove_selectionStateDidChangeEvent(::System::Action_1<::HMUI::__InputFieldView__SelectionState>*  value) ;

/// @brief Method set_onValueChanged, addr 0x3975578, size 0x8, virtual false, abstract: false, final false
inline void set_onValueChanged(::HMUI::__InputFieldView__InputFieldChanged*  value) ;

/// @brief Method set_text, addr 0x3975710, size 0x58, virtual false, abstract: false, final false
