...
/// @brief Field selectionStateDidChangeEvent, offset 0x108, size 0x8 
 __declspec(property(get=__cordl_internal_get_selectionStateDidChangeEvent, put=__cordl_internal_set_selectionStateDidChangeEvent)) ::System::Action_1<::HMUI::__NoTransitionsButton__SelectionState>*  selectionStateDidChangeEvent;

/// @brief Method DoStateTransition, addr 0x3971974, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39719b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_selectionStateDidChangeEvent, addr 0x3971010, size 0xb4, virtual false, abstract: false, final false
inline void add_selectionStateDidChangeEvent(::System::Action_1<::HMUI::__NoTransitionsButton__SelectionState>*  value) ;

/// @brief Method get_selectionState, addr 0x397196c, size 0x8, virtual false, abstract: false, final false
inline ::HMUI::__NoTransitionsButton__SelectionState get_selectionState() ;

/// @brief Method remove_selectionStateDidChangeEvent, addr 0x39711f4, size 0xb4, virtual false, abstract: false, final false
