...
/// @brief Method <PopViewControllers>g__AnimationLayouter|0, addr 0x22407b4, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2240710, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method LayoutViewControllers, addr 0x224037c, size 0xe8, virtual true, abstract: false, final false
...
/// @brief Method PopViewController, addr 0x2240550, size 0x14, virtual false, abstract: false, final false
inline void PopViewController(::System::Action*  finishedCallback, bool  immediately) ;

/// @brief Method PopViewControllers, addr 0x2240564, size 0x1ac, virtual false, abstract: false, final false
inline void PopViewControllers(int32_t  numberOfViewControllersToPop, ::System::Action*  finishedCallback, bool  immediately) ;

/// @brief Method PushViewController, addr 0x22404b0, size 0xa0, virtual false, abstract: false, final false
inline void PushViewController(::HMUI::ViewController*  viewController, ::System::Action*  finishedCallback, bool  immediately) ;

/// @brief Method SetupViewControllerRect, addr 0x2240464, size 0x28, virtual false, abstract: false, final false
static inline void SetupViewControllerRect(::HMUI::ViewController*  viewController, int32_t  index) ;

/// @brief Method <PushViewController>g__AnimationLayouter|3_0, addr 0x224071c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2240718, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_topStackedViewController, addr 0x2240304, size 0x78, virtual false, abstract: false, final false
