...
/// @brief Field _cellToPrefabMap, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__cellToPrefabMap, put=__cordl_internal_set__cellToPrefabMap)) ::System::Collections::Generic::Dictionary_2<::UnityW<::HMUI::SegmentedControlCell>,::UnityW<::UnityEngine::Object>>*  _cellToPrefabMap;
...
/// @brief Field _reusableCellPools, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__reusableCellPools, put=__cordl_internal_set__reusableCellPools)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Object>,::System::Collections::Generic::Queue_1<::UnityW<::HMUI::SegmentedControlCell>>*>*  _reusableCellPools;
...
/// @brief Field didPressNonInteractableCellEvent, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_didPressNonInteractableCellEvent, put=__cordl_internal_set_didPressNonInteractableCellEvent)) ::System::Action_2<::UnityW<::HMUI::SegmentedControl>,int32_t>*  didPressNonInteractableCellEvent;
...
/// @brief Method CreateCells, addr 0x3ff87ac, size 0x554, virtual false, abstract: false, final false
...
/// @brief Method HandleCellSelectionDidChange, addr 0x3ff8d0c, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method HandleNonInteractableCellWasPressed, addr 0x3ff8e5c, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method ReloadData, addr 0x3ff7498, size 0x4e4, virtual false, abstract: false, final false
inline void ReloadData() ;

/// @brief Method SelectCellWithNumber, addr 0x3ff8f6c, size 0xa8, virtual false, abstract: false, final false
inline void SelectCellWithNumber(int32_t  selectCellNumber) ;

/// @brief Method SetCallbackForCell, addr 0x3ff8f04, size 0x68, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::HMUI::SegmentedControlCell>,::UnityW<::UnityEngine::Object>>*> const& __cordl_internal_get__cellToPrefabMap() const;
...
constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Object>,::System::Collections::Generic::Queue_1<::UnityW<::HMUI::SegmentedControlCell>>*>*& __cordl_internal_get__reusableCellPools() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Object>,::System::Collections::Generic::Queue_1<::UnityW<::HMUI::SegmentedControlCell>>*>*> const& __cordl_internal_get__reusableCellPools() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::HMUI::SegmentedControl>,int32_t>*> const& __cordl_internal_get_didPressNonInteractableCellEvent() const;
...
constexpr void __cordl_internal_set__reusableCellPools(::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Object>,::System::Collections::Generic::Queue_1<::UnityW<::HMUI::SegmentedControlCell>>*>*  value) ;
...
/// @brief Method .ctor, addr 0x3ff7e80, size 0x19c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didPressNonInteractableCellEvent, addr 0x3ff8634, size 0xb0, virtual false, abstract: false, final false
inline void add_didPressNonInteractableCellEvent(::System::Action_2<::UnityW<::HMUI::SegmentedControl>,int32_t>*  value) ;

/// @brief Method add_didSelectCellEvent, addr 0x3ff84d4, size 0xb0, virtual false, abstract: false, final false
inline void add_didSelectCellEvent(::System::Action_2<::UnityW<::HMUI::SegmentedControl>,int32_t>*  value) ;

/// @brief Method get_cells, addr 0x3ff87a4, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::UnityW<::HMUI::SegmentedControlCell>>* get_cells() ;

/// @brief Method get_dataSource, addr 0x3ff8794, size 0x8, virtual false, abstract: false, final false
inline ::HMUI::__SegmentedControl__IDataSource* get_dataSource() ;

/// @brief Method get_selectedCellNumber, addr 0x3ff879c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_selectedCellNumber() ;

/// @brief Method remove_didPressNonInteractableCellEvent, addr 0x3ff86e4, size 0xb0, virtual false, abstract: false, final false
inline void remove_didPressNonInteractableCellEvent(::System::Action_2<::UnityW<::HMUI::SegmentedControl>,int32_t>*  value) ;

/// @brief Method remove_didSelectCellEvent, addr 0x3ff8584, size 0xb0, virtual false, abstract: false, final false
inline void remove_didSelectCellEvent(::System::Action_2<::UnityW<::HMUI::SegmentedControl>,int32_t>*  value) ;

/// @brief Method set_dataSource, addr 0x3ff7450, size 0x8, virtual false, abstract: false, final false
