...
namespace BGLib::AppFlow::Initialization {
template<typename T>
struct __ScriptableObjectReferenceAsyncInstaller_1___LoadResourcesBeforeInstallAsync_d__4;
}
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<T>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<T>", modifiers: "", def_value: None }]
constexpr __ScriptableObjectReferenceAsyncInstaller_1___LoadResourcesBeforeInstallAsync_d__4(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::UnityW<T>  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter_1<T>  __u__1) noexcept;
...
/// @brief Field _operationHandle, offset 0x28, size 0x20 
 __declspec(property(get=__cordl_internal_get__operationHandle, put=__cordl_internal_set__operationHandle)) ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<T>  _operationHandle;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::BGLib::AppFlow::Initialization::__ScriptableObjectReferenceAsyncInstaller_1___LoadResourcesBeforeInstallAsync_d__4, "BGLib.AppFlow.Initialization", "ScriptableObjectReferenceAsyncInstaller`1/<LoadResourcesBeforeInstallAsync>d__4");
