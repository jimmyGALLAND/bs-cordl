...
/// @brief Method <HandleGameSceneChanged>b__9_0, addr 0x225bb5c, size 0x54, virtual false, abstract: false, final false
inline bool _HandleGameSceneChanged_b__9_0(::GlobalNamespace::SceneInfo*  info) ;

/// @brief Method .ctor, addr 0x225bb54, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x225bbb0, size 0x510, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x225c284, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method CheckForCatalogUpdateWithInterval, addr 0x225b858, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x225b928, size 0x1c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method HandleGameSceneChanged, addr 0x225b944, size 0x1b4, virtual false, abstract: false, final false
inline void HandleGameSceneChanged(::GlobalNamespace::__GameScenesManager__SceneTransitionType  sceneTransitionType, ::GlobalNamespace::ScenesTransitionSetupDataSO*  transitionSetupDataSo, ::Zenject::DiContainer*  container) ;

/// @brief Method Initialize, addr 0x225b770, size 0xe8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x225b6f8, size 0x78, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::BGLib::MetaRemoteAssets::__MetaRemoteAssetsCatalogUpdater___CheckForCatalogUpdateWithInterval_d__10, "BGLib.MetaRemoteAssets", "MetaRemoteAssetsCatalogUpdater/<CheckForCatalogUpdateWithInterval>d__10");
