...
/// @brief Method <ParseArgs>b__7_1, addr 0x225818c, size 0x8, virtual false, abstract: false, final false
inline ::StringW _ParseArgs_b__7_1(::BGLib::DotnetExtension::CommandLine::ArgumentOption  option) ;

/// @brief Method .ctor, addr 0x2258184, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field requiredFound, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_requiredFound, put=__cordl_internal_set_requiredFound)) ::System::Collections::Generic::HashSet_1<::BGLib::DotnetExtension::CommandLine::ArgumentOption>*  requiredFound;

static inline ::BGLib::DotnetExtension::CommandLine::__CommandLineParser____c__DisplayClass7_0* New_ctor() ;

/// @brief Method <ParseArgs>b__0, addr 0x2258194, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2258014, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddParsedOption, addr 0x225801c, size 0x10c, virtual false, abstract: false, final false
static inline void AddParsedOption(::System::Collections::Generic::Dictionary_2<::BGLib::DotnetExtension::CommandLine::ArgumentOption,::StringW>*  parsedOption, ::BGLib::DotnetExtension::CommandLine::ArgumentOption  option, ::StringW  value) ;

/// @brief Method GenerateHint, addr 0x2257b28, size 0x4ec, virtual false, abstract: false, final false
...
/// @brief Method GenerateOptionsMap, addr 0x225674c, size 0x798, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::Dictionary_2<::StringW,::BGLib::DotnetExtension::CommandLine::ArgumentOption>* GenerateOptionsMap(::System::Collections::Generic::IEnumerable_1<::BGLib::DotnetExtension::CommandLine::ArgumentOption>*  options, ::System::Text::RegularExpressions::Regex*  argumentIdentifierRegex) ;

/// @brief Method GetCommandLineArgs, addr 0x2256388, size 0x70, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> GetCommandLineArgs() ;

/// @brief Method ParseArgs, addr 0x2257274, size 0x8a8, virtual false, abstract: false, final false
static inline void ParseArgs(::System::Collections::Generic::IReadOnlyList_1<::StringW>*  args, int32_t  startIndex, ::System::Collections::Generic::IEnumerable_1<::BGLib::DotnetExtension::CommandLine::ArgumentOption>*  requiredOptions, ::System::Collections::Generic::IReadOnlyDictionary_2<::StringW,::BGLib::DotnetExtension::CommandLine::ArgumentOption>*  optionsMap, ByRef<::System::Collections::Generic::Dictionary_2<::BGLib::DotnetExtension::CommandLine::ArgumentOption,::StringW>*>  parsedOption, ByRef<::System::Collections::Generic::List_1<::StringW>*>  ignored) ;

/// @brief Method ParseCommandLine, addr 0x2256438, size 0x314, virtual false, abstract: false, final false
static inline ::BGLib::DotnetExtension::CommandLine::CommandLineParserResult ParseCommandLine(::System::Collections::Generic::IReadOnlyList_1<::StringW>*  args, ::ArrayW<::BGLib::DotnetExtension::CommandLine::ArgumentOption,::Array<::BGLib::DotnetExtension::CommandLine::ArgumentOption>*>  options) ;

/// @brief Method ParseEnvironmentCommandLine, addr 0x22563f8, size 0x40, virtual false, abstract: false, final false
static inline ::BGLib::DotnetExtension::CommandLine::CommandLineParserResult ParseEnvironmentCommandLine(::ArrayW<::BGLib::DotnetExtension::CommandLine::ArgumentOption,::Array<::BGLib::DotnetExtension::CommandLine::ArgumentOption>*>  options) ;

/// @brief Method SelectRequiredOptions, addr 0x2256ee4, size 0x390, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::HashSet_1<::BGLib::DotnetExtension::CommandLine::ArgumentOption>* SelectRequiredOptions(::System::Collections::Generic::IEnumerable_1<::BGLib::DotnetExtension::CommandLine::ArgumentOption>*  options) ;
