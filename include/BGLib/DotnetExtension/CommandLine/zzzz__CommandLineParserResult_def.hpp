...
/// @brief Method <Contains>b__0, addr 0x225907c, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2258954, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x2258734, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_Item>b__0, addr 0x22590e0, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Contains, addr 0x2258880, size 0xd4, virtual false, abstract: false, final false
inline bool Contains(::StringW  identifier) ;

/// @brief Method Contains, addr 0x22587ac, size 0xd4, virtual false, abstract: false, final false
inline bool Contains(::BGLib::DotnetExtension::CommandLine::ArgumentOption  option) ;

/// @brief Method GetValueOrDefault, addr 0x225873c, size 0x70, virtual false, abstract: false, final false
inline ::StringW GetValueOrDefault(::BGLib::DotnetExtension::CommandLine::ArgumentOption  option) ;

/// @brief Method ToString, addr 0x225895c, size 0x720, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2257b1c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  applicationPath, ::System::Collections::Generic::IReadOnlyDictionary_2<::BGLib::DotnetExtension::CommandLine::ArgumentOption,::StringW>*  parsed, ::System::Collections::Generic::IReadOnlyList_1<::StringW>*  unexpectedArguments) ;

/// @brief Method get_Item, addr 0x22582ec, size 0x448, virtual false, abstract: false, final false
inline ::StringW get_Item(::StringW  identifier) ;

/// @brief Method get_Item, addr 0x2258218, size 0xd4, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "applicationPath", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "_parsed", ty: "::System::Collections::Generic::IReadOnlyDictionary_2<::BGLib::DotnetExtension::CommandLine::ArgumentOption,::StringW>*", modifiers: "", def_value: None }, CppParam { name: "unexpectedArguments", ty: "::System::Collections::Generic::IReadOnlyList_1<::StringW>*", modifiers: "", def_value: None }]
constexpr CommandLineParserResult(::StringW  applicationPath, ::System::Collections::Generic::IReadOnlyDictionary_2<::BGLib::DotnetExtension::CommandLine::ArgumentOption,::StringW>*  _parsed, ::System::Collections::Generic::IReadOnlyList_1<::StringW>*  unexpectedArguments) noexcept;
