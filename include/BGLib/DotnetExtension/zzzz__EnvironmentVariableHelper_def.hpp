...
public:
// Declarations
/// @brief Method GetDirectoryPath, addr 0x2255e68, size 0xa8, virtual false, abstract: false, final false
static inline ::StringW GetDirectoryPath(::StringW  variableName) ;

/// @brief Method SetDirectoryPath, addr 0x2255f10, size 0x120, virtual false, abstract: false, final false
