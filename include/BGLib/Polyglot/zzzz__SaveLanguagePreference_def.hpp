...
/// @brief Method OnLocalize, addr 0x2266480, size 0x28, virtual true, abstract: false, final true
inline void OnLocalize(::BGLib::Polyglot::LocalizationModel*  localization) ;

/// @brief Method Start, addr 0x2266430, size 0x50, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x22664a8, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
