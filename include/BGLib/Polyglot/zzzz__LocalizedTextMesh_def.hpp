...
/// @brief Method IsAlignmentLeft, addr 0x2266044, size 0xc, virtual false, abstract: false, final false
inline bool IsAlignmentLeft(::UnityEngine::TextAlignment  alignment) ;

/// @brief Method IsAlignmentRight, addr 0x2266038, size 0xc, virtual false, abstract: false, final false
inline bool IsAlignmentRight(::UnityEngine::TextAlignment  alignment) ;

/// @brief Method IsOppositeDirection, addr 0x2266010, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method OnLocalize, addr 0x2265f10, size 0x100, virtual true, abstract: false, final true
inline void OnLocalize(::BGLib::Polyglot::LocalizationModel*  localization) ;

/// @brief Method Reset, addr 0x2265ea0, size 0x50, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Start, addr 0x2265ef0, size 0x20, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x2266050, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Key, addr 0x2265e98, size 0x8, virtual false, abstract: false, final false
