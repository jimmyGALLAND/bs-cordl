...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::StringW>*>* (*)(::StringW)>(&::BGLib::Polyglot::TsvReader::Parse)> {
  constexpr static std::size_t size = 0x1a4;
  constexpr static std::size_t addrs = 0x22611f0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BGLib::Polyglot::TsvReader*>::get(),
                        "Parse",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BGLib::Polyglot::TsvReader::*)()>(&::BGLib::Polyglot::TsvReader::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2261394;
