...
/// @brief Method CreateDropdown, addr 0x2262740, size 0x22c, virtual false, abstract: false, final false
inline void CreateDropdown() ;

static inline ::BGLib::Polyglot::LanguageDropdown* New_ctor() ;

/// @brief Method OnLocalize, addr 0x2262c44, size 0x130, virtual true, abstract: false, final true
inline void OnLocalize(::BGLib::Polyglot::LocalizationModel*  localization) ;

/// @brief Method Reset, addr 0x22626cc, size 0x50, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Start, addr 0x226271c, size 0x24, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x2262d74, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
