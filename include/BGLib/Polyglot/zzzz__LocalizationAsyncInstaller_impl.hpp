...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BGLib::Polyglot::__LocalizationAsyncInstaller____c::*)()>(&::BGLib::Polyglot::__LocalizationAsyncInstaller____c::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x22636e0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BGLib::Polyglot::LocalizationAsset* (::BGLib::Polyglot::__LocalizationAsyncInstaller____c::*)(::UnityEngine::TextAsset*)>(&::BGLib::Polyglot::__LocalizationAsyncInstaller____c::_LocalizationContentToAsset_b__6_0)> {
  constexpr static std::size_t size = 0x60;
  constexpr static std::size_t addrs = 0x22636e8;
...
::cordl_internals::setStaticField<::BGLib::Polyglot::__LocalizationAsyncInstaller____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BGLib::Polyglot::__LocalizationAsyncInstaller____c*>::get>(std::forward<::BGLib::Polyglot::__LocalizationAsyncInstaller____c*>(value));
}
inline ::BGLib::Polyglot::__LocalizationAsyncInstaller____c* BGLib::Polyglot::__LocalizationAsyncInstaller____c::getStaticF___9()  {
return ::cordl_internals::getStaticField<::BGLib::Polyglot::__LocalizationAsyncInstaller____c*, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BGLib::Polyglot::__LocalizationAsyncInstaller____c*>::get>();
}
...
::cordl_internals::setStaticField<::System::Func_2<::UnityW<::UnityEngine::TextAsset>,::BGLib::Polyglot::LocalizationAsset*>*, "<>9__6_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BGLib::Polyglot::__LocalizationAsyncInstaller____c*>::get>(std::forward<::System::Func_2<::UnityW<::UnityEngine::TextAsset>,::BGLib::Polyglot::LocalizationAsset*>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Func_2<::UnityW<::UnityEngine::TextAsset>,::BGLib::Polyglot::LocalizationAsset*>*, "<>9__6_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BGLib::Polyglot::__LocalizationAsyncInstaller____c*>::get>();
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::BGLib::Polyglot::LocalizationAsyncInstaller::*)()>(&::BGLib::Polyglot::LocalizationAsyncInstaller::get_assetLabelRuntimeKey)> {
  ...
  constexpr static std::size_t addrs = 0x2263324;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BGLib::Polyglot::LocalizationAsyncInstaller::*)(::System::Collections::Generic::IList_1<::UnityW<::UnityEngine::TextAsset>>*, ::BGLib::AppFlow::Initialization::__AsyncInstaller__IInstallerRegistry*)>(&::BGLib::Polyglot::LocalizationAsyncInstaller::LoadResourcesBeforeInstall)> {
  ...
  constexpr static std::size_t addrs = 0x2263364;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::BGLib::Polyglot::LocalizationAsset*>* (*)(::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::TextAsset>>*)>(&::BGLib::Polyglot::LocalizationAsyncInstaller::LocalizationContentToAsset)> {
  ...
  constexpr static std::size_t addrs = 0x2263380;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BGLib::Polyglot::LocalizationAsyncInstaller::*)()>(&::BGLib::Polyglot::LocalizationAsyncInstaller::InstallBindings)> {
  ...
  constexpr static std::size_t addrs = 0x2263494;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::BGLib::Polyglot::LocalizationAsset*>* (*)()>(&::BGLib::Polyglot::LocalizationAsyncInstaller::LoadLocalizationAssetsSync)> {
  ...
  constexpr static std::size_t addrs = 0x22635e0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BGLib::Polyglot::LocalizationAsyncInstaller::*)()>(&::BGLib::Polyglot::LocalizationAsyncInstaller::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x226363c;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::BGLib::Polyglot::LocalizationAsset*>*> const& BGLib::Polyglot::LocalizationAsyncInstaller::__cordl_internal_get__inputFiles() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____inputFiles;
}
...
inline void BGLib::Polyglot::LocalizationAsyncInstaller::LoadResourcesBeforeInstall(::System::Collections::Generic::IList_1<::UnityW<::UnityEngine::TextAsset>>*  assets, ::BGLib::AppFlow::Initialization::__AsyncInstaller__IInstallerRegistry*  registry)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BGLib::Polyglot::LocalizationAsyncInstaller*>::get(),
                    12
