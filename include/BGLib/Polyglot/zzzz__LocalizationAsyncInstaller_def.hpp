...
/// @brief Method <LocalizationContentToAsset>b__6_0, addr 0x22636e8, size 0x60, virtual false, abstract: false, final false
inline ::BGLib::Polyglot::LocalizationAsset* _LocalizationContentToAsset_b__6_0(::UnityEngine::TextAsset*  localizationTextAsset) ;

/// @brief Method .ctor, addr 0x22636e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method InstallBindings, addr 0x2263494, size 0x14c, virtual true, abstract: false, final false
inline void InstallBindings() ;

/// @brief Method LoadLocalizationAssetsSync, addr 0x22635e0, size 0x5c, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::BGLib::Polyglot::LocalizationAsset*>* LoadLocalizationAssetsSync() ;

/// @brief Method LoadResourcesBeforeInstall, addr 0x2263364, size 0x1c, virtual true, abstract: false, final false
inline void LoadResourcesBeforeInstall(::System::Collections::Generic::IList_1<::UnityW<::UnityEngine::TextAsset>>*  assets, ::BGLib::AppFlow::Initialization::__AsyncInstaller__IInstallerRegistry*  registry) ;

/// @brief Method LocalizationContentToAsset, addr 0x2263380, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x226363c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_assetLabelRuntimeKey, addr 0x2263324, size 0x40, virtual true, abstract: false, final false
