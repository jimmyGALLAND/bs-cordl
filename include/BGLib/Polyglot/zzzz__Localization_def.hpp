...
/// @brief Field supportedLanguages, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_supportedLanguages, put=__cordl_internal_set_supportedLanguages)) ::System::Collections::Generic::List_1<::BGLib::Polyglot::Language>*  supportedLanguages;

/// @brief Method ConvertSystemLanguage, addr 0x226305c, size 0xc8, virtual false, abstract: false, final false
static inline ::BGLib::Polyglot::Language ConvertSystemLanguage(::UnityEngine::SystemLanguage  selected) ;

/// @brief Method Get, addr 0x2262ffc, size 0x20, virtual false, abstract: false, final false
static inline ::StringW Get(::StringW  key) ;

/// @brief Method GetKeys, addr 0x22631fc, size 0x4c, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::StringW>* GetKeys() ;

/// @brief Method GetLanguageDirection, addr 0x2262e6c, size 0x1c, virtual false, abstract: false, final false
static inline ::BGLib::Polyglot::LanguageDirection GetLanguageDirection(::BGLib::Polyglot::Language  language) ;

/// @brief Method HasNoSupportedLanguage, addr 0x2262ef8, size 0x50, virtual false, abstract: false, final false
inline bool HasNoSupportedLanguage() ;

/// @brief Method IsLanguageSupported, addr 0x2262f48, size 0x74, virtual false, abstract: false, final false
inline bool IsLanguageSupported(::BGLib::Polyglot::Language  language) ;

static inline ::BGLib::Polyglot::Localization* New_ctor() ;

/// @brief Method NoDomainReloadInit, addr 0x2262d7c, size 0x48, virtual false, abstract: false, final false
static inline void NoDomainReloadInit() ;

/// @brief Method SetSingletonInstance, addr 0x2262dc4, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22632dc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::BGLib::Polyglot::LocalizationModel* getStaticF__instance() ;

/// @brief Method get_EnglishLanguageName, addr 0x2262fbc, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_EnglishLanguageName() ;

/// @brief Method get_FallbackLanguage, addr 0x2262e64, size 0x8, virtual false, abstract: false, final false
inline ::BGLib::Polyglot::Language get_FallbackLanguage() ;

/// @brief Method get_Instance, addr 0x226296c, size 0x94, virtual false, abstract: false, final false
static inline ::BGLib::Polyglot::LocalizationModel* get_Instance() ;

/// @brief Method get_LocalizedLanguageName, addr 0x226301c, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_LocalizedLanguageName() ;

/// @brief Method get_SupportedLanguages, addr 0x2262e5c, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::BGLib::Polyglot::Language>* get_SupportedLanguages() ;

/// @brief Method get_selectedLanguageIndex, addr 0x2262e88, size 0x70, virtual false, abstract: false, final false
