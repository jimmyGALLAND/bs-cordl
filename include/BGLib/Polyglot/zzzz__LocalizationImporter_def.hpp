...
static __declspec(property(get=getStaticF_languageStrings, put=setStaticF_languageStrings)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Collections::Generic::List_1<::StringW>*>*  languageStrings;

/// @brief Method GetKeys, addr 0x2263248, size 0x94, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::StringW>* GetKeys() ;

/// @brief Method GetLanguages, addr 0x2264380, size 0xc0, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::StringW>* GetLanguages(::StringW  key) ;

/// @brief Method GetLanguages, addr 0x2264440, size 0x444, virtual false, abstract: false, final false
...
/// @brief Method GetLanguagesContains, addr 0x2264b4c, size 0x2c8, virtual false, abstract: false, final false
...
/// @brief Method GetLanguagesStartsWith, addr 0x2264884, size 0x2c8, virtual false, abstract: false, final false
...
/// @brief Method Import, addr 0x22639f0, size 0x64, virtual false, abstract: false, final false
static inline void Import(::StringW  text, ::BGLib::Polyglot::GoogleDriveDownloadFormat  format) ;

/// @brief Method ImportFromFiles, addr 0x2263928, size 0xc8, virtual false, abstract: false, final false
static inline void ImportFromFiles(::BGLib::Polyglot::LocalizationModel*  settings) ;

/// @brief Method ImportInputFiles, addr 0x22640d8, size 0x218, virtual false, abstract: false, final false
static inline void ImportInputFiles() ;

/// @brief Method ImportTextFile, addr 0x2263a54, size 0x684, virtual false, abstract: false, final false
static inline void ImportTextFile(::StringW  text, ::BGLib::Polyglot::GoogleDriveDownloadFormat  format) ;

/// @brief Method Initialize, addr 0x22638a4, size 0x84, virtual false, abstract: false, final false
static inline void Initialize(::BGLib::Polyglot::LocalizationModel*  settings) ;

/// @brief Method IsLineBreak, addr 0x22642f0, size 0x90, virtual false, abstract: false, final false
static inline bool IsLineBreak(::StringW  currentString) ;

/// @brief Method NoDomainReloadInit, addr 0x22637c0, size 0xe4, virtual false, abstract: false, final false
