...
/// @brief Method <InputFilesContains>b__0, addr 0x2265b40, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x22656d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddOnLocalizeEvent, addr 0x2262a00, size 0x1b0, virtual false, abstract: false, final false
inline void AddOnLocalizeEvent(::BGLib::Polyglot::ILocalize*  localize) ;

/// @brief Method Get, addr 0x2263124, size 0xd8, virtual false, abstract: false, final false
inline ::StringW Get(::StringW  key) ;

/// @brief Method GetCultureInfo, addr 0x2265128, size 0xb0, virtual false, abstract: false, final false
inline ::System::Globalization::CultureInfo* GetCultureInfo(::BGLib::Polyglot::Language  language) ;

/// @brief Method GetFormatOrKey, addr 0x2265a24, size 0x58, virtual false, abstract: false, final false
inline ::StringW GetFormatOrKey(::StringW  key, ::ArrayW<::System::Object*,::Array<::System::Object*>*>  arguments) ;

/// @brief Method GetOrKey, addr 0x2265980, size 0x2c, virtual false, abstract: false, final false
inline ::StringW GetOrKey(::StringW  key) ;

/// @brief Method InputFilesContains, addr 0x22655fc, size 0xd4, virtual false, abstract: false, final false
inline bool InputFilesContains(::BGLib::Polyglot::LocalizationDocument*  doc) ;

/// @brief Method IsValueValid, addr 0x22659ac, size 0x78, virtual false, abstract: false, final false
static inline bool IsValueValid(::StringW  value) ;

/// @brief Method KeyExist, addr 0x2265a7c, size 0x24, virtual false, abstract: false, final false
inline bool KeyExist(::StringW  key) ;

/// @brief Method KeyExist, addr 0x2265aa0, size 0xa0, virtual false, abstract: false, final false
static inline bool KeyExist(::StringW  key, ::BGLib::Polyglot::Language  language) ;

static inline ::BGLib::Polyglot::LocalizationModel* New_ctor(::BGLib::Polyglot::Localization*  localization, ::BGLib::Polyglot::Language  language, ::System::Collections::Generic::List_1<::BGLib::Polyglot::LocalizationAsset*>*  inputFiles) ;

/// @brief Method SelectLanguage, addr 0x2265524, size 0xd8, virtual false, abstract: false, final false
inline void SelectLanguage(int32_t  selected) ;

/// @brief Method TryGet, addr 0x22656d8, size 0x2a8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2265414, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method add__onChangeLanguage, addr 0x22652b4, size 0xb0, virtual false, abstract: false, final false
inline void add__onChangeLanguage(::System::Action_1<::BGLib::Polyglot::LocalizationModel*>*  value) ;

/// @brief Method get_EnglishLanguageNames, addr 0x2262bb0, size 0x7c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::StringW>* get_EnglishLanguageNames() ;

/// @brief Method get_InputFiles, addr 0x2264f40, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::BGLib::Polyglot::LocalizationAsset*>* get_InputFiles() ;

/// @brief Method get_LocalizedLanguageNames, addr 0x2265238, size 0x7c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::StringW>* get_LocalizedLanguageNames() ;

/// @brief Method get_SelectedCultureInfo, addr 0x2264f48, size 0x8, virtual false, abstract: false, final false
inline ::System::Globalization::CultureInfo* get_SelectedCultureInfo() ;

/// @brief Method get_SelectedLanguage, addr 0x2264fdc, size 0x1c, virtual false, abstract: false, final false
inline ::BGLib::Polyglot::Language get_SelectedLanguage() ;

/// @brief Method get_SelectedLanguageDirection, addr 0x22651f4, size 0x28, virtual false, abstract: false, final false
inline ::BGLib::Polyglot::LanguageDirection get_SelectedLanguageDirection() ;

/// @brief Method get_SelectedLanguageIndex, addr 0x2262c2c, size 0x18, virtual false, abstract: false, final false
inline int32_t get_SelectedLanguageIndex() ;

/// @brief Method get_SupportedLanguages, addr 0x226521c, size 0x1c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::BGLib::Polyglot::Language>* get_SupportedLanguages() ;

/// @brief Method get_fallbackLanguage, addr 0x22651d8, size 0x1c, virtual false, abstract: false, final false
inline ::BGLib::Polyglot::Language get_fallbackLanguage() ;

/// @brief Method remove__onChangeLanguage, addr 0x2265364, size 0xb0, virtual false, abstract: false, final false
inline void remove__onChangeLanguage(::System::Action_1<::BGLib::Polyglot::LocalizationModel*>*  value) ;

/// @brief Method set_SelectedCultureInfo, addr 0x2264f50, size 0x8c, virtual false, abstract: false, final false
inline void set_SelectedCultureInfo(::System::Globalization::CultureInfo*  value) ;

/// @brief Method set_SelectedLanguage, addr 0x2264ff8, size 0x130, virtual false, abstract: false, final false
