...
template<typename T>
class __JsonFileHandler____c__DisplayClass0_0_1;
}
...
template<typename T>
// Is value type: false
// CS Name: ::JsonFileHandler::<>c__DisplayClass0_0`1<T>*
class CORDL_TYPE __JsonFileHandler____c__DisplayClass0_0_1 : public ::System::Object {
public:
// Declarations
...
static inline ::BGLib::JsonExtension::__JsonFileHandler____c__DisplayClass0_0_1<T>* New_ctor() ;
...
// Ctor Parameters []
// @brief default ctor
constexpr __JsonFileHandler____c__DisplayClass0_0_1() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "__JsonFileHandler____c__DisplayClass0_0_1", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
__JsonFileHandler____c__DisplayClass0_0_1(__JsonFileHandler____c__DisplayClass0_0_1 && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "__JsonFileHandler____c__DisplayClass0_0_1", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
__JsonFileHandler____c__DisplayClass0_0_1(__JsonFileHandler____c__DisplayClass0_0_1 const& ) = delete;
...
// Declarations
template<typename T>
using __c__DisplayClass0_0_1 = ::BGLib::JsonExtension::__JsonFileHandler____c__DisplayClass0_0_1<T>;

/// @brief Method ReadFromFile, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline T ReadFromFile(::StringW  filePath) ;

/// @brief Method ReadFromFile, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline T ReadFromFile(::StringW  filePath, ::Newtonsoft::Json::JsonSerializerSettings*  settings) ;

/// @brief Method ReadFromText, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline T ReadFromText(::System::IO::TextReader*  textReader, ::Newtonsoft::Json::JsonSerializerSettings*  settings) ;

/// @brief Method WriteCompactWithoutDefault, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void WriteCompactWithoutDefault(T  content, ::StringW  filePath) ;

/// @brief Method WriteIndentedWithDefault, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void WriteIndentedWithDefault(T  content, ::StringW  filePath, int32_t  indentation) ;
...
template<typename T>
static inline void WriteToText(::System::IO::TextWriter*  writer, T  content, ::Newtonsoft::Json::JsonSerializerSettings*  settings, ::System::Action_1<::Newtonsoft::Json::JsonTextWriter*>*  beforeSerialize) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::BGLib::JsonExtension::__JsonFileHandler____c__DisplayClass0_0_1, "BGLib.JsonExtension", "JsonFileHandler/<>c__DisplayClass0_0`1");
