...
/// @brief Method .ctor, addr 0x226cb48, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_endPoint, addr 0x226cb2c, size 0x1c, virtual true, abstract: false, final false
inline ::UnityEngine::Vector3 get_endPoint() ;

/// @brief Method get_hasReferences, addr 0x226c8ac, size 0x98, virtual false, abstract: false, final false
inline bool get_hasReferences() ;

/// @brief Method get_startPoint, addr 0x226cb10, size 0x1c, virtual true, abstract: false, final false
