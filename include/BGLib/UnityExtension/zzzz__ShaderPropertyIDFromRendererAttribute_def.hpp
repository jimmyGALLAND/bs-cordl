...
/// @brief Method GetTargetName, addr 0x226ae58, size 0x8, virtual true, abstract: false, final false
inline ::StringW GetTargetName() ;

static inline ::BGLib::UnityExtension::ShaderPropertyIDFromRendererAttribute* New_ctor(::StringW  propertyName, ::StringW  nameFilter, ::BGLib::UnityExtension::__ShaderPropertyAttributeFilter__PropType  filterPropType) ;
...
/// @brief Method .ctor, addr 0x226ae2c, size 0x2c, virtual false, abstract: false, final false
