...
template<typename T>
class __AddressablesExtensions____c__DisplayClass3_0_1;
}
...
// Declarations
template<typename T>
using __c__DisplayClass3_0_1 = ::BGLib::UnityExtension::__AddressablesExtensions____c__DisplayClass3_0_1<T>;
