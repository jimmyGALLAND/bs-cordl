...
/// @brief Method DespawnAll, addr 0x2228060, size 0xc0, virtual true, abstract: false, final false
inline void DespawnAll() ;

/// @brief Method DespawnTile, addr 0x2228120, size 0x60, virtual false, abstract: false, final false
inline void DespawnTile(::Ice::FloorLightTile*  floorLightTile) ;

/// @brief Method HandleFloorLightTileDidFinish, addr 0x2228180, size 0x4, virtual false, abstract: false, final false
inline void HandleFloorLightTileDidFinish(::Ice::FloorLightTile*  floorLightTile) ;

/// @brief Method HighlightTile, addr 0x222771c, size 0x1b4, virtual false, abstract: false, final false
inline void HighlightTile(int32_t  x, int32_t  y, float_t  fadeInDuration, float_t  fadeOutDuration, ::UnityEngine::Color  color) ;

/// @brief Method Init, addr 0x2227180, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2228184, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ySize, addr 0x2228058, size 0x8, virtual false, abstract: false, final false
