...
/// @brief Method ManualUpdate, addr 0x22275e0, size 0x68, virtual false, abstract: false, final false
inline void ManualUpdate(float_t  deltaTime) ;

static inline ::Ice::__FloorLightStreakTileEffect__Element* New_ctor() ;

/// @brief Method Setup, addr 0x2227708, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2227ab4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_color, addr 0x2227b7c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_currentTileY, addr 0x2227b74, size 0x8, virtual false, abstract: false, final false
inline int32_t get_currentTileY() ;

/// @brief Method get_lineIndex, addr 0x2227b6c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _elementsPool, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__elementsPool, put=__cordl_internal_set__elementsPool)) ::GlobalNamespace::SimpleMemoryPool_1<::Ice::__FloorLightStreakTileEffect__Element*>*  _elementsPool;
...
/// @brief Method CreateNewElement, addr 0x22279b4, size 0x100, virtual false, abstract: false, final false
inline ::Ice::__FloorLightStreakTileEffect__Element* CreateNewElement() ;

/// @brief Method DespawnAll, addr 0x22278d0, size 0xe4, virtual true, abstract: false, final false
inline void DespawnAll() ;

/// @brief Method HandleElementDidMoveToNextTile, addr 0x2227abc, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method SpawnEffect, addr 0x2227648, size 0xc0, virtual false, abstract: false, final false
inline void SpawnEffect(int32_t  x, ::UnityEngine::Color  color) ;

/// @brief Method Start, addr 0x2227328, size 0xc8, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x22273f0, size 0x1f0, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x2227b58, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
