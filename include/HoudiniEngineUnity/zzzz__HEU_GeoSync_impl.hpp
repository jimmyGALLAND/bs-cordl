...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_GeoSync::*)(::HoudiniEngineUnity::HEU_SessionBase*)>(&::HoudiniEngineUnity::HEU_GeoSync::SetupLoadTask)> {
  constexpr static std::size_t size = 0x98;
  constexpr static std::size_t addrs = 0x39dd0ec;
