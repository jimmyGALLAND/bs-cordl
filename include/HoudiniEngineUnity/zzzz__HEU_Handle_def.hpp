...
/// @brief Field _handleParamRotateBinding, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__handleParamRotateBinding, put=__cordl_internal_set__handleParamRotateBinding)) ::HoudiniEngineUnity::HEU_HandleParamBinding*  _handleParamRotateBinding;
...
/// @brief Field _handleParamTranslateBinding, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__handleParamTranslateBinding, put=__cordl_internal_set__handleParamTranslateBinding)) ::HoudiniEngineUnity::HEU_HandleParamBinding*  _handleParamTranslateBinding;
...
/// @brief Method CleanUp, addr 0x39c42bc, size 0xc, virtual false, abstract: false, final false
inline void CleanUp() ;

/// @brief Method GenerateTransform, addr 0x39c3dd0, size 0x4ec, virtual false, abstract: false, final false
inline void GenerateTransform(::HoudiniEngineUnity::HEU_SessionBase*  session, ::HoudiniEngineUnity::HEU_Parameters*  parameters) ;

/// @brief Method GetRotateBinding, addr 0x39c3394, size 0x8, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_HandleParamBinding* GetRotateBinding() ;

/// @brief Method GetScaleBinding, addr 0x39c339c, size 0x8, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_HandleParamBinding* GetScaleBinding() ;

/// @brief Method GetTranslateBinding, addr 0x39c338c, size 0x8, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_HandleParamBinding* GetTranslateBinding() ;

/// @brief Method GetUpdatedPosition, addr 0x39c42ec, size 0x15c, virtual false, abstract: false, final false
inline bool GetUpdatedPosition(::HoudiniEngineUnity::HEU_HoudiniAsset*  asset, ByRef<::UnityEngine::Vector3>  inPosition) ;

/// @brief Method GetUpdatedRotation, addr 0x39c4448, size 0x1fc, virtual false, abstract: false, final false
inline bool GetUpdatedRotation(::HoudiniEngineUnity::HEU_HoudiniAsset*  asset, ByRef<::UnityEngine::Quaternion>  inRotation) ;

/// @brief Method HasRotateHandle, addr 0x39c330c, size 0x10, virtual false, abstract: false, final false
inline bool HasRotateHandle() ;

/// @brief Method HasScaleHandle, addr 0x39c331c, size 0x10, virtual false, abstract: false, final false
inline bool HasScaleHandle() ;

/// @brief Method HasTranslateHandle, addr 0x39c32fc, size 0x10, virtual false, abstract: false, final false
inline bool HasTranslateHandle() ;

/// @brief Method IsEquivalentTo, addr 0x39c4644, size 0x4e4, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_Handle*  other) ;

/// @brief Method IsRotateHandleDisabled, addr 0x39c334c, size 0x20, virtual false, abstract: false, final false
inline bool IsRotateHandleDisabled() ;

/// @brief Method IsScaleHandleDisabled, addr 0x39c336c, size 0x20, virtual false, abstract: false, final false
inline bool IsScaleHandleDisabled() ;

/// @brief Method IsSpecialRSTOrder, addr 0x39c42c8, size 0x24, virtual false, abstract: false, final false
static inline bool IsSpecialRSTOrder(::HoudiniEngineUnity::HAPI_RSTOrder  rstOrder) ;

/// @brief Method IsTranslateHandleDisabled, addr 0x39c332c, size 0x20, virtual false, abstract: false, final false
inline bool IsTranslateHandleDisabled() ;

static inline ::HoudiniEngineUnity::HEU_Handle* New_ctor() ;

/// @brief Method SetupHandle, addr 0x39c33c8, size 0x7cc, virtual false, abstract: false, final false
inline bool SetupHandle(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  assetID, int32_t  handleIndex, ::StringW  handleName, ::HoudiniEngineUnity::__HEU_Handle__HEU_HandleType  handleType, ByRef<::HoudiniEngineUnity::HAPI_HandleInfo>  handleInfo, ::HoudiniEngineUnity::HEU_Parameters*  parameters) ;
...
/// @brief Method .ctor, addr 0x39c4b28, size 0xd8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ConvertedTransformEuler, addr 0x39c32e8, size 0x14, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HAPI_TransformEuler get_ConvertedTransformEuler() ;

/// @brief Method get_HandleName, addr 0x39c32c8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_HandleName() ;

/// @brief Method get_HandlePosition, addr 0x39c33a4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_HandlePosition() ;

/// @brief Method get_HandleRotation, addr 0x39c33b0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_HandleRotation() ;

/// @brief Method get_HandleScale, addr 0x39c33bc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_HandleScale() ;

/// @brief Method get_HandleType, addr 0x39c32d0, size 0x8, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::__HEU_Handle__HEU_HandleType get_HandleType() ;

/// @brief Method get_RSTOrder, addr 0x39c32d8, size 0x8, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HAPI_RSTOrder get_RSTOrder() ;

/// @brief Method get_XYZOrder, addr 0x39c32e0, size 0x8, virtual false, abstract: false, final false
