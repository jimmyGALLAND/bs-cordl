...
/// @brief Field _volumeCachePresets, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__volumeCachePresets, put=__cordl_internal_set__volumeCachePresets)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VolumeCachePreset*>*  _volumeCachePresets;
...
/// @brief Method .ctor, addr 0x3983000, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;
