...
/// @brief Method IsEquivalentTo, addr 0x3a13678, size 0x200, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a13644, size 0x34, virtual false, abstract: false, final false
