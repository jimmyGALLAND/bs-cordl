...
/// @brief Field _updatedLayers, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__updatedLayers, put=__cordl_internal_set__updatedLayers)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VolumeLayer*>*  _updatedLayers;
...
/// @brief Method ApplyPreset, addr 0x3a1df34, size 0x2d0, virtual false, abstract: false, final false
inline bool ApplyPreset(::HoudiniEngineUnity::HEU_VolumeCachePreset*  volumeCachePreset) ;

/// @brief Method CopyDetailProperties, addr 0x3a1ebd0, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method CopyLayer, addr 0x3a1be14, size 0xb4, virtual false, abstract: false, final false
static inline void CopyLayer(::HoudiniEngineUnity::HEU_VolumeLayer*  srcLayer, ::HoudiniEngineUnity::HEU_VolumeLayer*  destLayer) ;

/// @brief Method CopyPrototype, addr 0x3a1ebf8, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method CopyValuesTo, addr 0x3a1e990, size 0x240, virtual false, abstract: false, final false
inline void CopyValuesTo(::HoudiniEngineUnity::HEU_VolumeCache*  destCache) ;

/// @brief Method FinishUpdateLayers, addr 0x3a1bc90, size 0xc, virtual false, abstract: false, final false
inline void FinishUpdateLayers() ;

/// @brief Method GenerateTerrainWithAlphamaps, addr 0x3a1c75c, size 0x17d8, virtual false, abstract: false, final false
...
/// @brief Method GetLayer, addr 0x3a1bec8, size 0x168, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_VolumeLayer* GetLayer(::StringW  layerName) ;

/// @brief Method GetPartLayerAttributes, addr 0x3a1c030, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x3a1bc54, size 0x3c, virtual false, abstract: false, final false
inline void Initialize(::HoudiniEngineUnity::HEU_GeoNode*  ownerNode, int32_t  tileIndex) ;

/// @brief Method IsEquivalentTo, addr 0x3a1ec40, size 0x304, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_VolumeCache*  other) ;

/// @brief Method LoadAssetTexture, addr 0x3a1c280, size 0x100, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Texture2D> LoadAssetTexture(::StringW  path) ;

/// @brief Method LoadDefaultSplatTexture, addr 0x3a1e204, size 0x88, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Texture2D> LoadDefaultSplatTexture() ;

/// @brief Method LoadLayerColorFromAttribute, addr 0x3a1c4b0, size 0x16c, virtual false, abstract: false, final false
...
/// @brief Method LoadLayerFloatFromAttribute, addr 0x3a1c380, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method LoadLayerPropertiesFromAttributes, addr 0x3a1e28c, size 0x408, virtual false, abstract: false, final false
inline void LoadLayerPropertiesFromAttributes(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  geoID, int32_t  partID, ::UnityEngine::TerrainLayer*  terrainLayer, bool  bNewTerrainLayer, ::UnityEngine::Texture2D*  defaultTexture) ;

/// @brief Method LoadLayerTextureFromAttribute, addr 0x3a1c188, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method LoadLayerVector2FromAttribute, addr 0x3a1c61c, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method PopulateDetailPrototype, addr 0x3a1e6b8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method PopulatePreset, addr 0x3a1e6e0, size 0x2b0, virtual false, abstract: false, final false
inline void PopulatePreset(::HoudiniEngineUnity::HEU_VolumeCachePreset*  cachePreset) ;

/// @brief Method PopulateScatterTrees, addr 0x3a1e694, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method ResetParameters, addr 0x3a1bc9c, size 0x178, virtual false, abstract: false, final false
inline void ResetParameters() ;

/// @brief Method StartUpdateLayers, addr 0x3a1b814, size 0x74, virtual false, abstract: false, final false
inline void StartUpdateLayers() ;

/// @brief Method UpdateLayerFromPart, addr 0x3a1b888, size 0x3cc, virtual false, abstract: false, final false
inline void UpdateLayerFromPart(::HoudiniEngineUnity::HEU_SessionBase*  session, ::HoudiniEngineUnity::HEU_PartData*  part) ;

/// @brief Method UpdateVolumeCachesFromParts, addr 0x3a1af40, size 0x8d4, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_VolumeCache>>* UpdateVolumeCachesFromParts(::HoudiniEngineUnity::HEU_SessionBase*  session, ::HoudiniEngineUnity::HEU_GeoNode*  ownerNode, ::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_PartData>>*  volumeParts, ::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_VolumeCache>>*  volumeCaches) ;
...
/// @brief Method .ctor, addr 0x3a1ef44, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_GeoName, addr 0x3a1af24, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_GeoName() ;

/// @brief Method get_IsDirty, addr 0x3a1af00, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDirty() ;

/// @brief Method get_ObjectName, addr 0x3a1af1c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ObjectName() ;

/// @brief Method get_TileIndex, addr 0x3a1af14, size 0x8, virtual false, abstract: false, final false
inline int32_t get_TileIndex() ;

/// @brief Method get_UIExpanded, addr 0x3a1af2c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_IsDirty, addr 0x3a1af08, size 0xc, virtual false, abstract: false, final false
inline void set_IsDirty(bool  value) ;

/// @brief Method set_UIExpanded, addr 0x3a1af34, size 0xc, virtual false, abstract: false, final false
