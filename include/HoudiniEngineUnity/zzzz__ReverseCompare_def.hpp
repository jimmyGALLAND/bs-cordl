...
/// @brief Method Compare, addr 0x39ebfe8, size 0x78, virtual true, abstract: false, final true
inline int32_t Compare(::System::Object*  x, ::System::Object*  y) ;

static inline ::HoudiniEngineUnity::ReverseCompare* New_ctor() ;

/// @brief Method .ctor, addr 0x39ec060, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
