...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_LoadBufferVolume::*)()>(&::HoudiniEngineUnity::HEU_LoadBufferVolume::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x39ded1c;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_LoadBufferVolumeLayer*>*> const& HoudiniEngineUnity::HEU_LoadBufferVolume::__cordl_internal_get__splatLayers() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____splatLayers;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_DetailPrototype*>*> const& HoudiniEngineUnity::HEU_LoadBufferVolume::__cordl_internal_get__detailPrototypes() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____detailPrototypes;
}
