...
/// @brief Field _detailPrototypes, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get__detailPrototypes, put=__cordl_internal_set__detailPrototypes)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_DetailPrototype*>*  _detailPrototypes;
...
/// @brief Field _splatLayers, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__splatLayers, put=__cordl_internal_set__splatLayers)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_LoadBufferVolumeLayer*>*  _splatLayers;
...
/// @brief Method .ctor, addr 0x39ded1c, size 0x10c, virtual false, abstract: false, final false
inline void _ctor() ;
