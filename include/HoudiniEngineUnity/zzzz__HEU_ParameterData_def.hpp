...
/// @brief Method HasMax, addr 0x39c5508, size 0x8, virtual false, abstract: false, final false
inline bool HasMax() ;

/// @brief Method HasMin, addr 0x39c5500, size 0x8, virtual false, abstract: false, final false
inline bool HasMin() ;

/// @brief Method HasUIMax, addr 0x39c5518, size 0x8, virtual false, abstract: false, final false
inline bool HasUIMax() ;

/// @brief Method HasUIMin, addr 0x39c5510, size 0x8, virtual false, abstract: false, final false
inline bool HasUIMin() ;

/// @brief Method IsAssetPath, addr 0x39c59c8, size 0x8, virtual false, abstract: false, final false
inline bool IsAssetPath() ;

/// @brief Method IsColor, addr 0x39c5934, size 0x10, virtual false, abstract: false, final false
inline bool IsColor() ;

/// @brief Method IsContainer, addr 0x39c58b0, size 0x54, virtual false, abstract: false, final false
inline bool IsContainer() ;

/// @brief Method IsEquivalentTo, addr 0x39c59d0, size 0x71c, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_ParameterData*  other) ;

/// @brief Method IsFloat, addr 0x39c54cc, size 0x10, virtual false, abstract: false, final false
inline bool IsFloat() ;

/// @brief Method IsInt, addr 0x39c54bc, size 0x10, virtual false, abstract: false, final false
inline bool IsInt() ;

/// @brief Method IsMultiParam, addr 0x39c5904, size 0x10, virtual false, abstract: false, final false
inline bool IsMultiParam() ;

/// @brief Method IsPathFile, addr 0x39c54ec, size 0x14, virtual false, abstract: false, final false
inline bool IsPathFile() ;

/// @brief Method IsRamp, addr 0x39c5914, size 0x10, virtual false, abstract: false, final false
inline bool IsRamp() ;

/// @brief Method IsString, addr 0x39c54dc, size 0x10, virtual false, abstract: false, final false
inline bool IsString() ;

/// @brief Method IsToggle, addr 0x39c5924, size 0x10, virtual false, abstract: false, final false
inline bool IsToggle() ;

static inline ::HoudiniEngineUnity::HEU_ParameterData* New_ctor() ;

/// @brief Method ToVector3, addr 0x39c5944, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39c60ec, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ChildIndex, addr 0x39c54ac, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ChildIndex() ;

/// @brief Method get_FloatMax, addr 0x39c5898, size 0x8, virtual false, abstract: false, final false
inline float_t get_FloatMax() ;

/// @brief Method get_FloatMin, addr 0x39c5890, size 0x8, virtual false, abstract: false, final false
inline float_t get_FloatMin() ;

/// @brief Method get_FloatUIMax, addr 0x39c58a8, size 0x8, virtual false, abstract: false, final false
inline float_t get_FloatUIMax() ;

/// @brief Method get_FloatUIMin, addr 0x39c58a0, size 0x8, virtual false, abstract: false, final false
inline float_t get_FloatUIMin() ;

/// @brief Method get_IntMax, addr 0x39c55fc, size 0xdc, virtual false, abstract: false, final false
inline int32_t get_IntMax() ;

/// @brief Method get_IntMin, addr 0x39c5520, size 0xdc, virtual false, abstract: false, final false
inline int32_t get_IntMin() ;

/// @brief Method get_IntUIMax, addr 0x39c57b4, size 0xdc, virtual false, abstract: false, final false
inline int32_t get_IntUIMax() ;

/// @brief Method get_IntUIMin, addr 0x39c56d8, size 0xdc, virtual false, abstract: false, final false
inline int32_t get_IntUIMin() ;

/// @brief Method get_ParentID, addr 0x39c54a4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ParentID() ;

/// @brief Method get_ParmID, addr 0x39c3d44, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ParmID() ;

/// @brief Method get_ParmSize, addr 0x39c54b4, size 0x8, virtual false, abstract: false, final false
