...
/// @brief Method AnyWorkItemsFailed, addr 0x39cfc88, size 0x10, virtual false, abstract: false, final false
inline bool AnyWorkItemsFailed() ;

/// @brief Method AnyWorkItemsPending, addr 0x39cfcf0, size 0x44, virtual false, abstract: false, final false
inline bool AnyWorkItemsPending() ;

/// @brief Method AreAllWorkItemsComplete, addr 0x39cfc50, size 0x38, virtual false, abstract: false, final false
inline bool AreAllWorkItemsComplete() ;

static inline ::HoudiniEngineUnity::HEU_WorkItemTally* New_ctor() ;

/// @brief Method ProgressRatio, addr 0x39cfd34, size 0xac, virtual false, abstract: false, final false
inline ::StringW ProgressRatio() ;

/// @brief Method ZeroAll, addr 0x39cebf4, size 0xc, virtual false, abstract: false, final false
inline void ZeroAll() ;
...
/// @brief Method .ctor, addr 0x39cfb10, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
