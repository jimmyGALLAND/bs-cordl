...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x39b6cbc, size 0xe8, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginInvoke(::HoudiniEngineUnity::HEU_AttributeData*  attributeData, int32_t  targetIndex, ::HoudiniEngineUnity::HEU_ToolsInfo*  sourceTools, int32_t  sourceIndex, float_t  factor, ::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x39b6da4, size 0xc, virtual true, abstract: false, final false
inline void EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x39b6ca8, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39b6c08, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Field _attributeDatas, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__attributeDatas, put=__cordl_internal_set__attributeDatas)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_AttributeData*>*  _attributeDatas;
...
/// @brief Field _outputMaterials, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__outputMaterials, put=__cordl_internal_set__outputMaterials)) ::ArrayW<::UnityW<::UnityEngine::Material>,::Array<::UnityW<::UnityEngine::Material>>*>  _outputMaterials;
...
/// @brief Field _positionAttributeValues, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__positionAttributeValues, put=__cordl_internal_set__positionAttributeValues)) ::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>  _positionAttributeValues;
...
/// @brief Method AddAttributeValueFloat, addr 0x39b5d08, size 0x94, virtual false, abstract: false, final false
static inline void AddAttributeValueFloat(::HoudiniEngineUnity::HEU_AttributeData*  attributeData, int32_t  targetIndex, ::HoudiniEngineUnity::HEU_ToolsInfo*  sourceTools, int32_t  sourceIndex, float_t  factor) ;

/// @brief Method AddAttributeValueInt, addr 0x39b5714, size 0x1b4, virtual false, abstract: false, final false
static inline void AddAttributeValueInt(::HoudiniEngineUnity::HEU_AttributeData*  attributeData, int32_t  targetIndex, ::HoudiniEngineUnity::HEU_ToolsInfo*  sourceTools, int32_t  sourceIndex, float_t  factor) ;

/// @brief Method AreAttributesDirty, addr 0x39b622c, size 0x15c, virtual false, abstract: false, final false
inline bool AreAttributesDirty() ;

/// @brief Method CopyAttributeValuesTo, addr 0x39b63a0, size 0x1d8, virtual false, abstract: false, final false
inline void CopyAttributeValuesTo(::HoudiniEngineUnity::HEU_AttributesStore*  destAttrStore) ;

/// @brief Method CreateAttribute, addr 0x39b3398, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method DestroyAllData, addr 0x39b1f04, size 0xcc, virtual false, abstract: false, final false
inline void DestroyAllData(::HoudiniEngineUnity::HEU_HoudiniAsset*  asset) ;

/// @brief Method DisablePaintCollider, addr 0x39b4f98, size 0x118, virtual false, abstract: false, final false
inline void DisablePaintCollider() ;

/// @brief Method EnablePaintCollider, addr 0x39b4df4, size 0x1a4, virtual false, abstract: false, final false
inline void EnablePaintCollider() ;

/// @brief Method FillAttribute, addr 0x39b5f6c, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method GetAttributeData, addr 0x39b4b60, size 0x84, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_AttributeData* GetAttributeData(int32_t  index) ;

/// @brief Method GetAttributeData, addr 0x39b3230, size 0x168, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_AttributeData* GetAttributeData(::StringW  name) ;

/// @brief Method GetAttributeNames, addr 0x39b4be4, size 0x210, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::StringW>* GetAttributeNames() ;

/// @brief Method GetAttributeSetValueFunction, addr 0x39b600c, size 0x220, virtual false, abstract: false, final false
static inline ::HoudiniEngineUnity::__HEU_AttributesStore__SetAttributeValueFunc* GetAttributeSetValueFunction(::HoudiniEngineUnity::__HEU_AttributeData__AttributeType  attrType, ::HoudiniEngineUnity::__HEU_ToolsInfo__PaintMergeMode  paintMergeMode) ;

/// @brief Method GetAttributesList, addr 0x39b4294, size 0x264, virtual false, abstract: false, final false
inline void GetAttributesList(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  geoID, int32_t  partID, ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_AttributeData*>*  attributesList, ::HoudiniEngineUnity::HAPI_AttributeOwner  ownerType, int32_t  attributeCount) ;

/// @brief Method GetPaintMeshCollider, addr 0x39b531c, size 0x78, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::MeshCollider> GetPaintMeshCollider() ;

/// @brief Method GetPositionAttributeValues, addr 0x39b6388, size 0xc, virtual false, abstract: false, final false
inline void GetPositionAttributeValues(ByRef<::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>>  positionArray) ;

/// @brief Method GetVertexIndices, addr 0x39b6394, size 0xc, virtual false, abstract: false, final false
inline void GetVertexIndices(ByRef<::ArrayW<int32_t,::Array<int32_t>*>>  indices) ;

/// @brief Method HasColorAttribute, addr 0x39b3218, size 0x8, virtual false, abstract: false, final false
inline bool HasColorAttribute() ;

/// @brief Method HasDirtyAttributes, addr 0x39b3bb0, size 0x18c, virtual false, abstract: false, final false
inline bool HasDirtyAttributes() ;

/// @brief Method HasMeshForPainting, addr 0x39b52bc, size 0x60, virtual false, abstract: false, final false
inline bool HasMeshForPainting() ;

/// @brief Method HidePaintMesh, addr 0x39b51d4, size 0xe8, virtual false, abstract: false, final false
inline void HidePaintMesh() ;

/// @brief Method IsEquivalentTo, addr 0x39b65d4, size 0x568, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_AttributesStore*  other) ;

/// @brief Method IsValidStore, addr 0x39b6578, size 0x5c, virtual false, abstract: false, final false
inline bool IsValidStore(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method MultiplyAttributeValueFloat, addr 0x39b5e30, size 0xb0, virtual false, abstract: false, final false
static inline void MultiplyAttributeValueFloat(::HoudiniEngineUnity::HEU_AttributeData*  attributeData, int32_t  targetIndex, ::HoudiniEngineUnity::HEU_ToolsInfo*  sourceTools, int32_t  sourceIndex, float_t  factor) ;

/// @brief Method MultiplyAttributeValueInt, addr 0x39b5a7c, size 0x1ec, virtual false, abstract: false, final false
static inline void MultiplyAttributeValueInt(::HoudiniEngineUnity::HEU_AttributeData*  attributeData, int32_t  targetIndex, ::HoudiniEngineUnity::HEU_ToolsInfo*  sourceTools, int32_t  sourceIndex, float_t  factor) ;

static inline ::HoudiniEngineUnity::HEU_AttributesStore* New_ctor() ;

/// @brief Method PaintAttribute, addr 0x39b5394, size 0x54, virtual false, abstract: false, final false
inline void PaintAttribute(::HoudiniEngineUnity::HEU_AttributeData*  attributeData, ::HoudiniEngineUnity::HEU_ToolsInfo*  sourceTools, int32_t  attributeIndex, float_t  paintFactor, ::HoudiniEngineUnity::__HEU_AttributesStore__SetAttributeValueFunc*  setAttrFunc) ;

/// @brief Method PopulateAttributeData, addr 0x39b344c, size 0x764, virtual false, abstract: false, final false
inline void PopulateAttributeData(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  geoID, int32_t  partID, ::HoudiniEngineUnity::HEU_AttributeData*  attributeData, ByRef<::HoudiniEngineUnity::HAPI_AttributeInfo>  attributeInfo) ;

/// @brief Method RefreshUpstreamInputs, addr 0x39b4acc, size 0x78, virtual false, abstract: false, final false
inline void RefreshUpstreamInputs(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method ReplaceAttributeValueFloat, addr 0x39b5c68, size 0xa0, virtual false, abstract: false, final false
static inline void ReplaceAttributeValueFloat(::HoudiniEngineUnity::HEU_AttributeData*  attributeData, int32_t  targetIndex, ::HoudiniEngineUnity::HEU_ToolsInfo*  sourceTools, int32_t  sourceIndex, float_t  factor) ;

/// @brief Method ReplaceAttributeValueInt, addr 0x39b552c, size 0x1e8, virtual false, abstract: false, final false
static inline void ReplaceAttributeValueInt(::HoudiniEngineUnity::HEU_AttributeData*  attributeData, int32_t  targetIndex, ::HoudiniEngineUnity::HEU_ToolsInfo*  sourceTools, int32_t  sourceIndex, float_t  factor) ;

/// @brief Method SetAttributeDataDirty, addr 0x39b4b44, size 0x1c, virtual false, abstract: false, final false
static inline void SetAttributeDataDirty(::HoudiniEngineUnity::HEU_AttributeData*  attributeData) ;

/// @brief Method SetAttributeDataSyncd, addr 0x39b4278, size 0x1c, virtual false, abstract: false, final false
static inline void SetAttributeDataSyncd(::HoudiniEngineUnity::HEU_AttributeData*  attributeData) ;

/// @brief Method SetAttributeEditValueFloat, addr 0x39b5454, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method SetAttributeEditValueInt, addr 0x39b53e8, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method SetAttributeEditValueString, addr 0x39b54c0, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method SetAttributeValueString, addr 0x39b5ee0, size 0x8c, virtual false, abstract: false, final false
static inline void SetAttributeValueString(::HoudiniEngineUnity::HEU_AttributeData*  attributeData, int32_t  targetIndex, ::HoudiniEngineUnity::HEU_ToolsInfo*  sourceTools, int32_t  sourceIndex, float_t  factor) ;

/// @brief Method SetupMeshAndMaterials, addr 0x39b1b5c, size 0x3a8, virtual false, abstract: false, final false
...
/// @brief Method ShowPaintMesh, addr 0x39b50b0, size 0x124, virtual false, abstract: false, final false
inline void ShowPaintMesh() ;

/// @brief Method SubtractAttributeValueFloat, addr 0x39b5d9c, size 0x94, virtual false, abstract: false, final false
static inline void SubtractAttributeValueFloat(::HoudiniEngineUnity::HEU_AttributeData*  attributeData, int32_t  targetIndex, ::HoudiniEngineUnity::HEU_ToolsInfo*  sourceTools, int32_t  sourceIndex, float_t  factor) ;

/// @brief Method SubtractAttributeValueInt, addr 0x39b58c8, size 0x1b4, virtual false, abstract: false, final false
static inline void SubtractAttributeValueInt(::HoudiniEngineUnity::HEU_AttributeData*  attributeData, int32_t  targetIndex, ::HoudiniEngineUnity::HEU_ToolsInfo*  sourceTools, int32_t  sourceIndex, float_t  factor) ;

/// @brief Method SyncAllAttributesFrom, addr 0x39b14c0, size 0x69c, virtual false, abstract: false, final false
inline void SyncAllAttributesFrom(::HoudiniEngineUnity::HEU_SessionBase*  session, ::HoudiniEngineUnity::HEU_HoudiniAsset*  asset, int32_t  geoID, ByRef<::HoudiniEngineUnity::HAPI_PartInfo>  partInfo, ::UnityEngine::GameObject*  outputGameObject) ;

/// @brief Method SyncDirtyAttributesToHoudini, addr 0x39b3d3c, size 0x6c, virtual false, abstract: false, final false
inline void SyncDirtyAttributesToHoudini(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method UpdateAttribute, addr 0x39b44f8, size 0x480, virtual false, abstract: false, final false
...
/// @brief Method UpdateAttributeList, addr 0x39b4978, size 0x154, virtual false, abstract: false, final false
inline void UpdateAttributeList(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  geoID, int32_t  partID, ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_AttributeData*>*  attributeDataList) ;

/// @brief Method UploadAttributeViaMeshInput, addr 0x39b3da8, size 0x4d0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39b6b3c, size 0xcc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_GeoID, addr 0x39b3200, size 0x8, virtual false, abstract: false, final false
inline int32_t get_GeoID() ;

/// @brief Method get_GeoName, addr 0x39b3210, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_GeoName() ;

/// @brief Method get_OutputMesh, addr 0x39b3228, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> get_OutputMesh() ;

/// @brief Method get_OutputTransform, addr 0x39b3220, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_OutputTransform() ;

/// @brief Method get_PartID, addr 0x39b3208, size 0x8, virtual false, abstract: false, final false
inline int32_t get_PartID() ;

/// @brief Convert to "::HoudiniEngineUnity::IEquivable_1<::UnityW<::HoudiniEngineUnity::HEU_AttributesStore>>"
constexpr ::HoudiniEngineUnity::IEquivable_1<::UnityW<::HoudiniEngineUnity::HEU_AttributesStore>>* i___HoudiniEngineUnity__IEquivable_1___UnityW___HoudiniEngineUnity__HEU_AttributesStore__() noexcept;
