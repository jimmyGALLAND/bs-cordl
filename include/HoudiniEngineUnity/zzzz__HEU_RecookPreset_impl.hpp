...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_RecookPreset::*)()>(&::HoudiniEngineUnity::HEU_RecookPreset::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3983000;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VolumeCachePreset*>*> const& HoudiniEngineUnity::HEU_RecookPreset::__cordl_internal_get__volumeCachePresets() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____volumeCachePresets;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_InputPreset*>*> const& HoudiniEngineUnity::HEU_RecookPreset::__cordl_internal_get__inputPresets() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____inputPresets;
}
