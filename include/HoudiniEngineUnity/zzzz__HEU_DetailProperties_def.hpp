...
/// @brief Method IsEquivalentTo, addr 0x3a1ab10, size 0x1f0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a1ad00, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
