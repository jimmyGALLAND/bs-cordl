...
/// @brief Method IsEquivalentTo, addr 0x3a13ce0, size 0xec, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a13cac, size 0x34, virtual false, abstract: false, final false
