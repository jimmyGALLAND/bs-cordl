...
/// @brief Field _inputAssetPresets, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__inputAssetPresets, put=__cordl_internal_set__inputAssetPresets)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_InputAssetPreset*>*  _inputAssetPresets;
...
/// @brief Field _inputObjectPresets, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__inputObjectPresets, put=__cordl_internal_set__inputObjectPresets)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_InputObjectPreset*>*  _inputObjectPresets;
...
/// @brief Method .ctor, addr 0x3982e08, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;
