...
/// @brief Method CompleteTask, addr 0x39de254, size 0x230, virtual true, abstract: false, final false
inline void CompleteTask(::HoudiniEngineUnity::__HEU_Task__TaskResult  result) ;

/// @brief Method CookCompletedCallback, addr 0x39de484, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method CookCompletedCallback, addr 0x39de504, size 0x10, virtual false, abstract: false, final false
inline void CookCompletedCallback(::HoudiniEngineUnity::HEU_CookedEventData*  cookedEventData) ;

/// @brief Method CookCompletedCallback, addr 0x39de514, size 0x10, virtual false, abstract: false, final false
inline void CookCompletedCallback(::HoudiniEngineUnity::HEU_ReloadEventData*  reloadEventData) ;

/// @brief Method DoTask, addr 0x39dda60, size 0x59c, virtual true, abstract: false, final false
inline void DoTask() ;

/// @brief Method GetTaskSession, addr 0x39dd9ac, size 0xb4, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_SessionBase* GetTaskSession() ;

/// @brief Method KillTask, addr 0x39de024, size 0x230, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39de524, size 0xb8, virtual false, abstract: false, final false
inline void _ctor() ;
