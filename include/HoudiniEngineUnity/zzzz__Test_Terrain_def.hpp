...
/// @brief Method IsEquivalentTo, addr 0x3a1975c, size 0x15c, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_Terrain*  other) ;

/// @brief Method IsNull, addr 0x3a196fc, size 0x60, virtual true, abstract: false, final true
inline bool IsNull() ;
...
/// @brief Method .ctor, addr 0x3a196d4, size 0x28, virtual false, abstract: false, final false
