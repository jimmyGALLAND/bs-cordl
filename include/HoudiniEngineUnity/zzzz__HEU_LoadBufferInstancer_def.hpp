...
/// @brief Field _instanceTransforms, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__instanceTransforms, put=__cordl_internal_set__instanceTransforms)) ::ArrayW<::HoudiniEngineUnity::HAPI_Transform,::Array<::HoudiniEngineUnity::HAPI_Transform>*>  _instanceTransforms;
...
/// @brief Method .ctor, addr 0x39deea8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
