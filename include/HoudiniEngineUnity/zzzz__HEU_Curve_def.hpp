...
/// @brief Method <UpdateCurveInputForCustomAttributes>b__0, addr 0x39899fc, size 0x1b8, virtual false, abstract: false, final false
inline void _UpdateCurveInputForCustomAttributes_b__0(::HoudiniEngineUnity::CurveNodeData*  data) ;

/// @brief Method <UpdateCurveInputForCustomAttributes>b__1, addr 0x3989bb4, size 0x3c0, virtual false, abstract: false, final false
...
/// @brief Method <UpdateCurveInputForCustomAttributes>b__2, addr 0x3989f74, size 0x2cc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3987ae4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <UpdatePoints>b__0, addr 0x398a240, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39885b8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetAllPoints>b__0, addr 0x398a358, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3988fe0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _curveNodeData, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__curveNodeData, put=__cordl_internal_set__curveNodeData)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::CurveNodeData*>*  _curveNodeData;
...
/// @brief Method CreateSetupCurve, addr 0x39858ac, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method DestroyAllData, addr 0x3985b00, size 0x14c, virtual false, abstract: false, final false
inline void DestroyAllData(bool  bIsRebuild) ;

/// @brief Method DownloadAsDefaultPresetData, addr 0x3989374, size 0x98, virtual false, abstract: false, final false
inline void DownloadAsDefaultPresetData(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method DownloadPresetData, addr 0x3988520, size 0x98, virtual false, abstract: false, final false
inline void DownloadPresetData(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method DuplicateCurveNodeData, addr 0x398940c, size 0x218, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::CurveNodeData*>* DuplicateCurveNodeData() ;

/// @brief Method GenerateMesh, addr 0x3986154, size 0x3b0, virtual false, abstract: false, final false
inline void GenerateMesh(::UnityEngine::GameObject*  inGameObject) ;

/// @brief Method GetAllPointTransforms, addr 0x3988ec0, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::CurveNodeData*>* GetAllPointTransforms() ;

/// @brief Method GetAllPoints, addr 0x3988ec8, size 0x118, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::Vector3>* GetAllPoints() ;

/// @brief Method GetCurvePoint, addr 0x3988df0, size 0xd0, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetCurvePoint(int32_t  pointIndex) ;

/// @brief Method GetInvertedTransformedDirection, addr 0x398919c, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetInvertedTransformedDirection(::UnityEngine::Vector3  inPosition) ;

/// @brief Method GetInvertedTransformedPosition, addr 0x398914c, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetInvertedTransformedPosition(::UnityEngine::Vector3  inPosition) ;

/// @brief Method GetNumPoints, addr 0x3988fe8, size 0x48, virtual false, abstract: false, final false
inline int32_t GetNumPoints() ;

/// @brief Method GetPointsString, addr 0x3988acc, size 0x27c, virtual false, abstract: false, final false
static inline ::StringW GetPointsString(::System::Collections::Generic::List_1<::HoudiniEngineUnity::CurveNodeData*>*  points) ;

/// @brief Method GetPointsString, addr 0x3987aec, size 0x268, virtual false, abstract: false, final false
static inline ::StringW GetPointsString(::System::Collections::Generic::List_1<::UnityEngine::Vector3>*  points) ;

/// @brief Method GetTransformedPoint, addr 0x3989030, size 0xcc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetTransformedPoint(int32_t  pointIndex) ;

/// @brief Method GetTransformedPosition, addr 0x39890fc, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetTransformedPosition(::UnityEngine::Vector3  inPosition) ;

/// @brief Method GetVertices, addr 0x39891ec, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*> GetVertices() ;

/// @brief Method IsEditable, addr 0x3985870, size 0x8, virtual false, abstract: false, final false
inline bool IsEditable() ;

/// @brief Method IsEquivalentTo, addr 0x398962c, size 0x354, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_Curve*  other) ;

/// @brief Method IsGeoCurve, addr 0x3985894, size 0x8, virtual false, abstract: false, final false
inline bool IsGeoCurve() ;

static inline ::HoudiniEngineUnity::HEU_Curve* New_ctor() ;

/// @brief Method ProjectToColliders, addr 0x39885c0, size 0x50c, virtual false, abstract: false, final false
...
/// @brief Method ResetCurveParameters, addr 0x3985dd0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method SetCurveGeometryVisibility, addr 0x39891f4, size 0xe8, virtual false, abstract: false, final false
inline void SetCurveGeometryVisibility(bool  bVisible) ;

/// @brief Method SetCurveName, addr 0x3985c4c, size 0x9c, virtual false, abstract: false, final false
inline void SetCurveName(::StringW  name) ;

/// @brief Method SetCurveNodeData, addr 0x3989624, size 0x8, virtual false, abstract: false, final false
inline void SetCurveNodeData(::System::Collections::Generic::List_1<::HoudiniEngineUnity::CurveNodeData*>*  curveNodeData) ;

/// @brief Method SetCurveParameterPreset, addr 0x3985ea0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method SetCurvePoint, addr 0x3988d50, size 0xa0, virtual false, abstract: false, final false
inline void SetCurvePoint(int32_t  pointIndex, ::UnityEngine::Vector3  newPosition) ;

/// @brief Method SetEditState, addr 0x3988d48, size 0x8, virtual false, abstract: false, final false
inline void SetEditState(::HoudiniEngineUnity::__HEU_Curve__CurveEditState  editState) ;

/// @brief Method SetUploadParameterPreset, addr 0x3985880, size 0xc, virtual false, abstract: false, final false
inline void SetUploadParameterPreset(bool  bValue) ;

/// @brief Method SyncFromParameters, addr 0x3987d54, size 0x274, virtual false, abstract: false, final false
...
/// @brief Method UpdateCurve, addr 0x3985f70, size 0x1e4, virtual false, abstract: false, final false
inline void UpdateCurve(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  partID) ;

/// @brief Method UpdateCurveInputForCustomAttributes, addr 0x3986504, size 0x15e0, virtual false, abstract: false, final false
...
/// @brief Method UpdatePoints, addr 0x3987fc8, size 0x558, virtual false, abstract: false, final false
inline void UpdatePoints(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  partID) ;

/// @brief Method UploadParameterPreset, addr 0x3985ce8, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method UploadPresetData, addr 0x39892dc, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3989980, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::HoudiniEngineUnity::__HEU_Curve__Interaction getStaticF_PreferredNextInteractionMode() ;

/// @brief Method get_CurveName, addr 0x398588c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_CurveName() ;

/// @brief Method get_CurveNodeData, addr 0x3985868, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::CurveNodeData*>* get_CurveNodeData() ;

/// @brief Method get_EditState, addr 0x398589c, size 0x8, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::__HEU_Curve__CurveEditState get_EditState() ;

/// @brief Method get_GeoID, addr 0x3985860, size 0x8, virtual false, abstract: false, final false
inline int32_t get_GeoID() ;

/// @brief Method get_Parameters, addr 0x3985878, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::HoudiniEngineUnity::HEU_Parameters> get_Parameters() ;

/// @brief Method get_ParentAsset, addr 0x39858a4, size 0x8, virtual false, abstract: false, final false
