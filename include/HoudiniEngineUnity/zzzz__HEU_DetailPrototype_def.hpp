...
/// @brief Method IsEquivalentTo, addr 0x3a1ae14, size 0xec, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a1ad18, size 0xfc, virtual false, abstract: false, final false
inline void _ctor() ;
