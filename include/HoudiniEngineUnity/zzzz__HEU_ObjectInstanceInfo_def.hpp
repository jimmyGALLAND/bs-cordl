...
/// @brief Field _instancedInputs, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__instancedInputs, put=__cordl_internal_set__instancedInputs)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_InstancedInput*>*  _instancedInputs;
...
/// @brief Method IsEquivalentTo, addr 0x39a5c98, size 0x148, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x39a5de0, size 0xcc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Convert to "::HoudiniEngineUnity::IEquivable_1<::UnityW<::HoudiniEngineUnity::HEU_ObjectInstanceInfo>>"
constexpr ::HoudiniEngineUnity::IEquivable_1<::UnityW<::HoudiniEngineUnity::HEU_ObjectInstanceInfo>>* i___HoudiniEngineUnity__IEquivable_1___UnityW___HoudiniEngineUnity__HEU_ObjectInstanceInfo__() noexcept;
