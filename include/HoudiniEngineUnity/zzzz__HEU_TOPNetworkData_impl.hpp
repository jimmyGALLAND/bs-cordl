...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_TOPNetworkData::*)()>(&::HoudiniEngineUnity::HEU_TOPNetworkData::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x39cdc90;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_TOPNodeData*>*> const& HoudiniEngineUnity::HEU_TOPNetworkData::__cordl_internal_get__topNodes() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____topNodes;
}
