...
/// @brief Method CopyValuesTo, addr 0x39b2dac, size 0x124, virtual false, abstract: false, final false
inline void CopyValuesTo(::HoudiniEngineUnity::HEU_AttributeData*  destAttrData) ;

/// @brief Method IsColorAttribute, addr 0x39b2d3c, size 0x70, virtual false, abstract: false, final false
inline bool IsColorAttribute() ;

/// @brief Method IsEquivalentTo, addr 0x39b2ed0, size 0x328, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x39b31f8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
