...
/// @brief Method IsEquivalentTo, addr 0x39c4c00, size 0x200, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x39c3cec, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
