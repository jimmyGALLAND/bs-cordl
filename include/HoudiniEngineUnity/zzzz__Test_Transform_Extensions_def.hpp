...
// Write type traits
MARK_REF_PTR_T(::HoudiniEngineUnity::Test_Transform_Extensions);
MARK_REF_PTR_T(::HoudiniEngineUnity::__Test_Transform_Extensions____c);
// Type: ::<>c
...
static __declspec(property(get=getStaticF___9, put=setStaticF___9)) ::HoudiniEngineUnity::__Test_Transform_Extensions____c*  __9;

/// @brief Field <>9__1_0, offset 0xffffffff, size 0x8 
static __declspec(property(get=getStaticF___9__1_0, put=setStaticF___9__1_0)) ::System::Converter_2<::UnityW<::UnityEngine::Transform>,::HoudiniEngineUnity::Test_Transform*>*  __9__1_0;
...
/// @brief Method <ToTestObject>b__1_0, addr 0x3a1544c, size 0x5c, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::Test_Transform* _ToTestObject_b__1_0(::UnityEngine::Transform*  lod) ;

/// @brief Method <ToTestObject>b__2_0, addr 0x3a154a8, size 0x5c, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::Test_Transform* _ToTestObject_b__2_0(::UnityEngine::Transform*  lod) ;

/// @brief Method .ctor, addr 0x3a15444, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Ctor Parameters [CppParam { name: "", ty: "__Test_Transform_Extensions____c", modifiers: "const&", def_value: None }]
...
static_assert(::cordl_internals::size_check_v<::HoudiniEngineUnity::__Test_Transform_Extensions____c, 0x10>, "Size mismatch!");
...
/// @brief Method ToTestObject, addr 0x3a15200, size 0xf0, virtual false, abstract: false, final false
static inline ::ArrayW<::HoudiniEngineUnity::Test_Transform*,::Array<::HoudiniEngineUnity::Test_Transform*>*> ToTestObject(::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*>  self) ;

/// @brief Method ToTestObject, addr 0x3a12c04, size 0x5c, virtual false, abstract: false, final false
static inline ::HoudiniEngineUnity::Test_Transform* ToTestObject(::UnityEngine::Transform*  self) ;

/// @brief Method ToTestObject, addr 0x3a152f0, size 0xf8, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::HoudiniEngineUnity::Test_Transform_Extensions, 0x10>, "Size mismatch!");
...
NEED_NO_BOX(::HoudiniEngineUnity::__Test_Transform_Extensions____c);
DEFINE_IL2CPP_ARG_TYPE(::HoudiniEngineUnity::__Test_Transform_Extensions____c*, "HoudiniEngineUnity", "Test_Transform_Extensions/<>c");
