...
/// @brief Field _sharedNormalIndices, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__sharedNormalIndices, put=__cordl_internal_set__sharedNormalIndices)) ::ArrayW<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VertexEntry*>*,::Array<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VertexEntry*>*>*>  _sharedNormalIndices;

/// @brief Field _subMeshesMap, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__subMeshesMap, put=__cordl_internal_set__subMeshesMap)) ::System::Collections::Generic::Dictionary_2<int32_t,::HoudiniEngineUnity::HEU_MeshData*>*  _subMeshesMap;
...
/// @brief Method CompareTo, addr 0x39f6f04, size 0x30, virtual true, abstract: false, final true
inline int32_t CompareTo(::HoudiniEngineUnity::HEU_GeoGroup*  other) ;

static inline ::HoudiniEngineUnity::HEU_GeoGroup* New_ctor() ;

/// @brief Method SetupNormalIndices, addr 0x39f4db0, size 0x124, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VertexEntry*>*,::Array<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VertexEntry*>*>*> const& __cordl_internal_get__sharedNormalIndices() const;

constexpr ::ArrayW<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VertexEntry*>*,::Array<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VertexEntry*>*>*>& __cordl_internal_get__sharedNormalIndices() ;
...
constexpr void __cordl_internal_set__sharedNormalIndices(::ArrayW<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VertexEntry*>*,::Array<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VertexEntry*>*>*>  value) ;
...
/// @brief Method .ctor, addr 0x39f4d34, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _sharedNormalIndices, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VertexEntry*>*,::Array<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VertexEntry*>*>*>  ____sharedNormalIndices;
