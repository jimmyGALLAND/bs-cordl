...
/// @brief Field _volumeLayersPresets, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__volumeLayersPresets, put=__cordl_internal_set__volumeLayersPresets)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VolumeLayerPreset*>*  _volumeLayersPresets;
...
/// @brief Method .ctor, addr 0x3982f84, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
