...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_LoadBufferVolumeLayer::*)()>(&::HoudiniEngineUnity::HEU_LoadBufferVolumeLayer::_ctor)> {
