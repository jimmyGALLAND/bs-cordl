...
static inline ::HoudiniEngineUnity::HEU_BakedEventData* New_ctor(::HoudiniEngineUnity::HEU_HoudiniAsset*  asset, bool  successful, ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>*  outputObjects, bool  isNewBake) ;
...
/// @brief Method .ctor, addr 0x3982a34, size 0x58, virtual false, abstract: false, final false
