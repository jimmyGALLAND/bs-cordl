...
/// @brief Field volumeCachePresets, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get_volumeCachePresets, put=__cordl_internal_set_volumeCachePresets)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VolumeCachePreset*>*  volumeCachePresets;
...
/// @brief Method .ctor, addr 0x3982cb4, size 0x154, virtual false, abstract: false, final false
inline void _ctor() ;
