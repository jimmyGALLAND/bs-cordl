...
/// @brief Method IsEquivalentTo, addr 0x3a18e0c, size 0x568, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_TerrainData*  other) ;

/// @brief Method IsNull, addr 0x3a18dac, size 0x60, virtual true, abstract: false, final true
inline bool IsNull() ;
...
/// @brief Method .ctor, addr 0x3a18d84, size 0x28, virtual false, abstract: false, final false
...
constexpr ::HoudiniEngineUnity::IEquivableWrapperClass_1<::HoudiniEngineUnity::Test_TerrainData*>* i___HoudiniEngineUnity__IEquivableWrapperClass_1___HoudiniEngineUnity__Test_TerrainData__() noexcept;
