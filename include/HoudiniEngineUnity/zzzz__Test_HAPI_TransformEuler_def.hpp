...
/// @brief Method IsEquivalentTo, addr 0x3a13e80, size 0x254, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a13e4c, size 0x34, virtual false, abstract: false, final false
