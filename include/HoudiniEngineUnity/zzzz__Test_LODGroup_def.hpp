...
/// @brief Method IsEquivalentTo, addr 0x3a14a1c, size 0x28c, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_LODGroup*  other) ;

/// @brief Method IsNull, addr 0x3a149bc, size 0x60, virtual true, abstract: false, final true
inline bool IsNull() ;
...
/// @brief Method .ctor, addr 0x3a14994, size 0x28, virtual false, abstract: false, final false
