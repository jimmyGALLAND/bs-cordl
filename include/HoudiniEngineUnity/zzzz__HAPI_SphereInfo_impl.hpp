...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HAPI_SphereInfo::*)(bool)>(&::HoudiniEngineUnity::HAPI_SphereInfo::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x39c5348;
...
// Ctor Parameters [CppParam { name: "center", ty: "::ArrayW<float_t,::Array<float_t>*>", modifiers: "", def_value: Some("nullptr") }, CppParam { name: "radius", ty: "float_t", modifiers: "", def_value: Some("{}") }]
