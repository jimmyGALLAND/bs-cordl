...
public:
// Declarations
/// @brief Method Init, addr 0x39c4ee0, size 0xc8, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method .ctor, addr 0x39bb99c, size 0xa4, virtual false, abstract: false, final false
