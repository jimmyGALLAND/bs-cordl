...
/// @brief Method IsEquivalentTo, addr 0x39a5eac, size 0x1a0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x39a604c, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;
