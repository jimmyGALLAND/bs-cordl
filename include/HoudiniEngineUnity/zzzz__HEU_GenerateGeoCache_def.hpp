...
/// @brief Field _collisionVertices, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__collisionVertices, put=__cordl_internal_set__collisionVertices)) ::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>  _collisionVertices;
...
/// @brief Method .ctor, addr 0x39f4b44, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GenerateLODMeshesFromGeoGroups>b__65_0, addr 0x39f6ee8, size 0x1c, virtual false, abstract: false, final false
inline int32_t _GenerateLODMeshesFromGeoGroups_b__65_0(float_t  a, float_t  b) ;

/// @brief Method <GetFinalMaterialsFromComparingNewWithPrevious>b__63_0, addr 0x39f6e8c, size 0x5c, virtual false, abstract: false, final false
inline bool _GetFinalMaterialsFromComparingNewWithPrevious_b__63_0(::UnityEngine::Material*  material) ;

/// @brief Method .ctor, addr 0x39f6e84, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _colliderInfos, offset 0x290, size 0x8 
 __declspec(property(get=__cordl_internal_get__colliderInfos, put=__cordl_internal_set__colliderInfos)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::__HEU_GenerateGeoCache__HEU_ColliderInfo*>*  _colliderInfos;
...
/// @brief Field _groupSplitFaceIndices, offset 0x258, size 0x8 
 __declspec(property(get=__cordl_internal_get__groupSplitFaceIndices, put=__cordl_internal_set__groupSplitFaceIndices)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Collections::Generic::List_1<int32_t>*>*  _groupSplitFaceIndices;

/// @brief Field _groupSplitVertexIndices, offset 0x250, size 0x8 
 __declspec(property(get=__cordl_internal_get__groupSplitVertexIndices, put=__cordl_internal_set__groupSplitVertexIndices)) ::System::Collections::Generic::Dictionary_2<::StringW,::ArrayW<int32_t,::Array<int32_t>*>>*  _groupSplitVertexIndices;

/// @brief Field _groupVertexOffsets, offset 0x260, size 0x8 
 __declspec(property(get=__cordl_internal_get__groupVertexOffsets, put=__cordl_internal_set__groupVertexOffsets)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Collections::Generic::List_1<int32_t>*>*  _groupVertexOffsets;
...
/// @brief Field _inUseMaterials, offset 0x138, size 0x8 
 __declspec(property(get=__cordl_internal_get__inUseMaterials, put=__cordl_internal_set__inUseMaterials)) ::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_MaterialData>>*  _inUseMaterials;
...
/// @brief Field _materialIDToDataMap, offset 0x2a0, size 0x8 
 __declspec(property(get=__cordl_internal_get__materialIDToDataMap, put=__cordl_internal_set__materialIDToDataMap)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::HoudiniEngineUnity::HEU_MaterialData>>*  _materialIDToDataMap;
...
/// @brief Field _substanceMaterialAttrIndexInfo, offset 0x108, size 0x28 
 __declspec(property(get=__cordl_internal_get__substanceMaterialAttrIndexInfo, put=__cordl_internal_set__substanceMaterialAttrIndexInfo)) ::HoudiniEngineUnity::HAPI_AttributeInfo  _substanceMaterialAttrIndexInfo;
...
/// @brief Field _substanceMaterialAttrNameInfo, offset 0xd0, size 0x28 
 __declspec(property(get=__cordl_internal_get__substanceMaterialAttrNameInfo, put=__cordl_internal_set__substanceMaterialAttrNameInfo)) ::HoudiniEngineUnity::HAPI_AttributeInfo  _substanceMaterialAttrNameInfo;

/// @brief Field _substanceMaterialAttrStringsMap, offset 0x100, size 0x8 
 __declspec(property(get=__cordl_internal_get__substanceMaterialAttrStringsMap, put=__cordl_internal_set__substanceMaterialAttrStringsMap)) ::System::Collections::Generic::Dictionary_2<int32_t,::StringW>*  _substanceMaterialAttrStringsMap;
...
/// @brief Field _unityMaterialAttrStringsMap, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get__unityMaterialAttrStringsMap, put=__cordl_internal_set__unityMaterialAttrStringsMap)) ::System::Collections::Generic::Dictionary_2<int32_t,::StringW>*  _unityMaterialAttrStringsMap;

/// @brief Field _unityMaterialInfos, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__unityMaterialInfos, put=__cordl_internal_set__unityMaterialInfos)) ::System::Collections::Generic::Dictionary_2<int32_t,::HoudiniEngineUnity::HEU_UnityMaterialInfo*>*  _unityMaterialInfos;
...
/// @brief Field _uvsAttrInfo, offset 0x168, size 0x8 
 __declspec(property(get=__cordl_internal_get__uvsAttrInfo, put=__cordl_internal_set__uvsAttrInfo)) ::ArrayW<::HoudiniEngineUnity::HAPI_AttributeInfo,::Array<::HoudiniEngineUnity::HAPI_AttributeInfo>*>  _uvsAttrInfo;
...
/// @brief Method CalculateGroupMeshTopology, addr 0x39f4b4c, size 0x1e8, virtual false, abstract: false, final false
...
/// @brief Method CombineMeshes, addr 0x39f1b40, size 0x354, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Mesh> CombineMeshes(::System::Collections::Generic::Dictionary_2<int32_t,::HoudiniEngineUnity::HEU_MeshData*>*  subMeshesMap, ::System::Collections::Generic::List_1<int32_t>*  submeshIndices, bool  bGenerateUVs, bool  bGenerateNormals, ::HoudiniEngineUnity::HEU_MeshIndexFormat*  meshIndexFormat) ;

/// @brief Method CombineQuadMeshes, addr 0x39f1568, size 0x5d8, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Mesh> CombineQuadMeshes(::System::Collections::Generic::Dictionary_2<int32_t,::HoudiniEngineUnity::HEU_MeshData*>*  subMeshesMap, ::System::Collections::Generic::List_1<int32_t>*  subMeshIndices, bool  bGenerateNormals) ;

/// @brief Method CreateMaterialInfoEntryFromAttributeIndex, addr 0x39ee5a4, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method CreateMeshFromMeshData, addr 0x39f12b8, size 0x2b0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Mesh> CreateMeshFromMeshData(::HoudiniEngineUnity::HEU_MeshData*  submesh, bool  bGenerateUVs, bool  bGenerateNormals, ::HoudiniEngineUnity::HEU_MeshIndexFormat*  meshIndexFormat) ;

/// @brief Method GenerateGeoGroupUsingGeoCachePoints, addr 0x39f4f10, size 0x1f18, virtual false, abstract: false, final false
...
/// @brief Method GenerateGeoGroupUsingGeoCacheVertices, addr 0x39f21c8, size 0x297c, virtual false, abstract: false, final false
...
/// @brief Method GenerateLODMeshesFromGeoGroups, addr 0x39f0264, size 0xb78, virtual false, abstract: false, final false
static inline bool GenerateLODMeshesFromGeoGroups(::HoudiniEngineUnity::HEU_SessionBase*  session, ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeoGroup*>*  GeoGroupMeshes, ::HoudiniEngineUnity::HEU_GenerateGeoCache*  geoCache, ::HoudiniEngineUnity::HEU_GeneratedOutput*  generatedOutput, int32_t  defaultMaterialKey, bool  bGenerateUVs, bool  bGenerateTangents, bool  bGenerateNormals, bool  bPartInstanced) ;

/// @brief Method GenerateMeshFromGeoGroup, addr 0x39ef764, size 0xb00, virtual false, abstract: false, final false
static inline bool GenerateMeshFromGeoGroup(::HoudiniEngineUnity::HEU_SessionBase*  session, ::HoudiniEngineUnity::HEU_GeoGroup*  GeoGroup, ::HoudiniEngineUnity::HEU_GenerateGeoCache*  geoCache, int32_t  defaultMaterialKey, bool  bGenerateUVs, bool  bGenerateTangents, bool  bGenerateNormals, bool  bPartInstanced, ByRef<::UnityEngine::Mesh*>  newMesh, ByRef<::ArrayW<::UnityEngine::Material*,::Array<::UnityEngine::Material*>*>>  newMaterials) ;

/// @brief Method GenerateMeshFromSingleGroup, addr 0x39ef5ac, size 0x1b8, virtual false, abstract: false, final false
static inline bool GenerateMeshFromSingleGroup(::HoudiniEngineUnity::HEU_SessionBase*  session, ::HoudiniEngineUnity::HEU_GeoGroup*  GeoGroup, ::HoudiniEngineUnity::HEU_GenerateGeoCache*  geoCache, ::HoudiniEngineUnity::HEU_GeneratedOutput*  generatedOutput, int32_t  defaultMaterialKey, bool  bGenerateUVs, bool  bGenerateTangents, bool  bGenerateNormals, bool  bPartInstanced) ;

/// @brief Method GetFinalMaterialsFromComparingNewWithPrevious, addr 0x39ef1f8, size 0x3b4, virtual false, abstract: false, final false
static inline void GetFinalMaterialsFromComparingNewWithPrevious(::UnityEngine::GameObject*  gameObject, ::ArrayW<::UnityEngine::Material*,::Array<::UnityEngine::Material*>*>  previousMaterials, ::ArrayW<::UnityEngine::Material*,::Array<::UnityEngine::Material*>*>  newMaterials, ByRef<::ArrayW<::UnityEngine::Material*,::Array<::UnityEngine::Material*>*>>  finalMaterials) ;

/// @brief Method GetMaterialKeyFromAttributeIndex, addr 0x39ee6bc, size 0x15c, virtual false, abstract: false, final false
static inline int32_t GetMaterialKeyFromAttributeIndex(::HoudiniEngineUnity::HEU_GenerateGeoCache*  geoCache, int32_t  attributeIndex, ByRef<::StringW>  unityMaterialName, ByRef<::StringW>  substanceName, ByRef<int32_t>  substanceIndex) ;

/// @brief Method GetPopulatedGeoCache, addr 0x39ec088, size 0x2fc, virtual false, abstract: false, final false
static inline ::HoudiniEngineUnity::HEU_GenerateGeoCache* GetPopulatedGeoCache(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  assetID, int32_t  geoID, int32_t  partID, bool  bUseLODGroups, ::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_MaterialData>>*  materialCache, ::StringW  assetCacheFolderPath) ;

static inline ::HoudiniEngineUnity::HEU_GenerateGeoCache* New_ctor() ;

/// @brief Method ParseLODTransitionAttribute, addr 0x39ee818, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method PopulateGeometryData, addr 0x39ecb5c, size 0x1a48, virtual false, abstract: false, final false
inline bool PopulateGeometryData(::HoudiniEngineUnity::HEU_SessionBase*  session, bool  bUseLODGroups) ;

/// @brief Method PopulateUnityMaterialData, addr 0x39ec574, size 0x5e8, virtual false, abstract: false, final false
inline void PopulateUnityMaterialData(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method TransferRegularAttributesToVertices, addr 0x39f1ee0, size 0x2e8, virtual false, abstract: false, final false
static inline void TransferRegularAttributesToVertices(::ArrayW<int32_t,::Array<int32_t>*>  groupVertexList, ::ArrayW<int32_t,::Array<int32_t>*>  allFaceCounts, ::System::Collections::Generic::List_1<int32_t>*  groupFaces, ::System::Collections::Generic::List_1<int32_t>*  groupVertexOffset, ByRef<::HoudiniEngineUnity::HAPI_AttributeInfo>  attribInfo, ::ArrayW<float_t,::Array<float_t>*>  inData, ByRef<::ArrayW<float_t,::Array<float_t>*>>  outData) ;

/// @brief Method UpdateCollider, addr 0x39eeb20, size 0x6d8, virtual false, abstract: false, final false
static inline void UpdateCollider(::HoudiniEngineUnity::HEU_GenerateGeoCache*  geoCache, ::HoudiniEngineUnity::HEU_GeneratedOutputData*  outputData, ::HoudiniEngineUnity::__HEU_GenerateGeoCache__HEU_ColliderInfo*  colliderInfo) ;

/// @brief Method UpdateColliders, addr 0x39ee9d0, size 0x150, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::__HEU_GenerateGeoCache__HEU_ColliderInfo*>*> const& __cordl_internal_get__colliderInfos() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::System::Collections::Generic::List_1<int32_t>*>*> const& __cordl_internal_get__groupSplitFaceIndices() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::ArrayW<int32_t,::Array<int32_t>*>>*> const& __cordl_internal_get__groupSplitVertexIndices() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::System::Collections::Generic::List_1<int32_t>*>*> const& __cordl_internal_get__groupVertexOffsets() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::HoudiniEngineUnity::HEU_MaterialData>>*> const& __cordl_internal_get__materialIDToDataMap() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::HoudiniEngineUnity::HEU_UnityMaterialInfo*>*> const& __cordl_internal_get__unityMaterialInfos() const;
...
/// @brief Method .ctor, addr 0x39ec384, size 0x1f0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AssetID, addr 0x39ec078, size 0x8, virtual false, abstract: false, final false
inline int32_t get_AssetID() ;

/// @brief Method get_GeoID, addr 0x39ec068, size 0x8, virtual false, abstract: false, final false
inline int32_t get_GeoID() ;

/// @brief Method get_PartID, addr 0x39ec070, size 0x8, virtual false, abstract: false, final false
inline int32_t get_PartID() ;

/// @brief Method set_AssetID, addr 0x39ec080, size 0x8, virtual false, abstract: false, final false
