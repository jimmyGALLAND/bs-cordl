...
/// @brief Method IsEquivalentTo, addr 0x3a14188, size 0x78c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a14154, size 0x34, virtual false, abstract: false, final false
