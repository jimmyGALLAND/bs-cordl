...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::HoudiniEngineUnity::Test_HAPI_AssetInfo* (*)(::HoudiniEngineUnity::HAPI_AssetInfo)>(&::HoudiniEngineUnity::Test_HAPI_AssetInfo_Extensions::ToTestObject)> {
  constexpr static std::size_t size = 0x80;
  constexpr static std::size_t addrs = 0x3a12f5c;
