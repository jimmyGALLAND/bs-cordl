...
/// @brief Method RegisterInterface, addr 0x39f7b70, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39f7b48, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  priority) ;

/// @brief Method get_Priority, addr 0x39f7b40, size 0x8, virtual false, abstract: false, final false
