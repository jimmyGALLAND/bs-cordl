...
/// @brief Field _inputMeshes, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__inputMeshes, put=__cordl_internal_set__inputMeshes)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::__HEU_InputInterfaceMesh__HEU_InputDataMesh*>*  _inputMeshes;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::__HEU_InputInterfaceMesh__HEU_InputDataMesh*>*> const& __cordl_internal_get__inputMeshes() const;
...
/// @brief Method .ctor, addr 0x39fa854, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x39fa8d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CreateInputNodeWithDataUpload, addr 0x39f7be8, size 0x184, virtual true, abstract: false, final false
...
/// @brief Method CreateSingleMeshData, addr 0x39fa478, size 0x1d4, virtual false, abstract: false, final false
...
/// @brief Method GenerateMeshDatasFromGameObject, addr 0x39f7d6c, size 0x374, virtual false, abstract: false, final false
...
/// @brief Method GetMeshFromObject, addr 0x39fa64c, size 0x208, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Mesh> GetMeshFromObject(::UnityEngine::GameObject*  meshGameObject) ;

/// @brief Method GetUVsFromMesh, addr 0x39fa3e8, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method IsThisInputObjectSupported, addr 0x39fa284, size 0x164, virtual true, abstract: false, final false
...
/// @brief Method UploadData, addr 0x39f80e0, size 0x21a4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39f7bc8, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
