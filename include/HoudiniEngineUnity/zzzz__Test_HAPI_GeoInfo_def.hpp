...
/// @brief Method IsEquivalentTo, addr 0x3a1392c, size 0x300, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a138f8, size 0x34, virtual false, abstract: false, final false
