...
/// @brief Method IsEquivalentTo, addr 0x3a1835c, size 0x108, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_Texture2D*  other) ;

/// @brief Method IsNull, addr 0x3a182fc, size 0x60, virtual true, abstract: false, final true
inline bool IsNull() ;
...
/// @brief Method .ctor, addr 0x3a182d4, size 0x28, virtual false, abstract: false, final false
