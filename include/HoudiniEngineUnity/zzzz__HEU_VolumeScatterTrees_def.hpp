...
/// @brief Field _treePrototypInfos, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__treePrototypInfos, put=__cordl_internal_set__treePrototypInfos)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_TreePrototypeInfo*>*  _treePrototypInfos;
...
/// @brief Method IsEquivalentTo, addr 0x3a1a640, size 0x374, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a1a9b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
