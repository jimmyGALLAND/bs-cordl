...
/// @brief Method IsEquivalentTo, addr 0x3a13010, size 0x340, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a12fdc, size 0x34, virtual false, abstract: false, final false
