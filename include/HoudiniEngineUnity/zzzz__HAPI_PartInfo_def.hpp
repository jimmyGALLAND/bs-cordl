...
/// @brief Method getElementCountByAttributeOwner, addr 0x39c5070, size 0x4c, virtual false, abstract: false, final false
inline int32_t getElementCountByAttributeOwner(::HoudiniEngineUnity::HAPI_AttributeOwner  owner) ;

/// @brief Method getElementCountByGroupType, addr 0x39c50bc, size 0x28, virtual false, abstract: false, final false
inline int32_t getElementCountByGroupType(::HoudiniEngineUnity::HAPI_GroupType  type) ;

/// @brief Method get_detailAttributeCount, addr 0x39c5238, size 0x34, virtual false, abstract: false, final false
inline int32_t get_detailAttributeCount() ;

/// @brief Method get_pointAttributeCount, addr 0x39c50e4, size 0x34, virtual false, abstract: false, final false
inline int32_t get_pointAttributeCount() ;

/// @brief Method get_primitiveAttributeCount, addr 0x39c5158, size 0x34, virtual false, abstract: false, final false
inline int32_t get_primitiveAttributeCount() ;

/// @brief Method get_vertexAttributeCount, addr 0x39c51cc, size 0x30, virtual false, abstract: false, final false
inline int32_t get_vertexAttributeCount() ;

/// @brief Method init, addr 0x39ba1e4, size 0x58, virtual false, abstract: false, final false
inline void init() ;

/// @brief Method set_detailAttributeCount, addr 0x39c526c, size 0x40, virtual false, abstract: false, final false
inline void set_detailAttributeCount(int32_t  value) ;

/// @brief Method set_pointAttributeCount, addr 0x39c5118, size 0x40, virtual false, abstract: false, final false
inline void set_pointAttributeCount(int32_t  value) ;

/// @brief Method set_primitiveAttributeCount, addr 0x39c518c, size 0x40, virtual false, abstract: false, final false
inline void set_primitiveAttributeCount(int32_t  value) ;

/// @brief Method set_vertexAttributeCount, addr 0x39c51fc, size 0x3c, virtual false, abstract: false, final false
