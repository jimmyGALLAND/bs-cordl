...
/// @brief Method IsEquivalentTo, addr 0x3a1558c, size 0xf4, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_Material*  other) ;

/// @brief Method IsNull, addr 0x3a1552c, size 0x60, virtual true, abstract: false, final true
inline bool IsNull() ;
...
/// @brief Method .ctor, addr 0x3a15504, size 0x28, virtual false, abstract: false, final false
