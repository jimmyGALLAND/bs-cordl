...
class CORDL_TYPE BakedEvent : public ::UnityEngine::Events::UnityEvent_3<::UnityW<::HoudiniEngineUnity::HEU_HoudiniAsset>,bool,::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>*> {
public:
// Declarations
static inline ::HoudiniEngineUnity::BakedEvent* New_ctor() ;

/// @brief Method .ctor, addr 0x3982bdc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
