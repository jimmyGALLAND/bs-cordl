...
/// @brief Method IsEquivalentTo, addr 0x3a15e2c, size 0x42c, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_Mesh*  other) ;

/// @brief Method IsNull, addr 0x3a15dcc, size 0x60, virtual true, abstract: false, final true
inline bool IsNull() ;
...
/// @brief Method .ctor, addr 0x3a15da4, size 0x28, virtual false, abstract: false, final false
