...
/// @brief Field _boundingVolumeReference, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__boundingVolumeReference, put=__cordl_internal_set__boundingVolumeReference)) ::UnityW<::GlobalNamespace::HEU_BoundingVolume>  _boundingVolumeReference;
...
/// @brief Method CopyTo, addr 0x39a32f8, size 0x84, virtual false, abstract: false, final false
inline void CopyTo(::HoudiniEngineUnity::HEU_InputObjectInfo*  destObject) ;

/// @brief Method IsEquivalentTo, addr 0x39a55f0, size 0x28c, virtual true, abstract: false, final true
...
/// @brief Method SetReferencesFromGameObject, addr 0x39a3600, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39a3210, size 0xe8, virtual false, abstract: false, final false
inline void _ctor() ;
