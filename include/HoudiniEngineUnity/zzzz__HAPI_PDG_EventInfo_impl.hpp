...
constexpr ::HoudiniEngineUnity::HAPI_PDG_EventInfo::HAPI_PDG_EventInfo(int32_t  nodeId, int32_t  workitemId, int32_t  dependencyId, int32_t  currentState, int32_t  lastState, int32_t  eventType, int32_t  msgSH) noexcept  {
this->nodeId = nodeId;
