...
/// @brief Method .ctor, addr 0x39a5a70, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x39a5a78, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _inputAssetCache, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__inputAssetCache, put=__cordl_internal_set__inputAssetCache)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::__HEU_InputNodeUICache__HEU_InputAssetUICache*>*  _inputAssetCache;

/// @brief Field _inputObjectCache, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__inputObjectCache, put=__cordl_internal_set__inputObjectCache)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::__HEU_InputNodeUICache__HEU_InputObjectUICache*>*  _inputObjectCache;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::__HEU_InputNodeUICache__HEU_InputAssetUICache*>*> const& __cordl_internal_get__inputAssetCache() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::__HEU_InputNodeUICache__HEU_InputObjectUICache*>*> const& __cordl_internal_get__inputObjectCache() const;
...
/// @brief Method .ctor, addr 0x39a59ac, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;
