...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_AssetPreset::*)()>(&::HoudiniEngineUnity::HEU_AssetPreset::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3982cb4;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::ArrayW<uint8_t,::Array<uint8_t>*>>*> const& HoudiniEngineUnity::HEU_AssetPreset::__cordl_internal_get__curvePresets() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____curvePresets;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_InputPreset*>*> const& HoudiniEngineUnity::HEU_AssetPreset::__cordl_internal_get_inputPresets() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___inputPresets;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VolumeCachePreset*>*> const& HoudiniEngineUnity::HEU_AssetPreset::__cordl_internal_get_volumeCachePresets() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___volumeCachePresets;
}
