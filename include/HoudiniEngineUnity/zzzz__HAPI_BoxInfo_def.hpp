...
// SizeInfo { instance_size: 24, native_size: 36, calculated_instance_size: 24, calculated_native_size: 40, minimum_alignment: 8, packing: None, specified_packing: None }
namespace HoudiniEngineUnity {
// Is value type: true
...
public:
// Declarations
/// @brief Method .ctor, addr 0x39c52d8, size 0x70, virtual false, abstract: false, final false
