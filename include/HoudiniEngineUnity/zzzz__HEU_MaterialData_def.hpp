...
/// @brief Method GetMaterialAlpha, addr 0x39d2468, size 0x1d8, virtual false, abstract: false, final false
static inline bool GetMaterialAlpha(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  nodeID, ::ArrayW<::HoudiniEngineUnity::HAPI_ParmInfo,::Array<::HoudiniEngineUnity::HAPI_ParmInfo>*>  parameters, float_t  defaultValue, ByRef<float_t>  alpha) ;

/// @brief Method GetSupportedFileFormat, addr 0x39d2640, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method GetTextureFileNameFromMaterialParam, addr 0x39d1da0, size 0x24c, virtual false, abstract: false, final false
...
/// @brief Method IsEquivalentTo, addr 0x39d2764, size 0x1b8, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::HEU_MaterialData*  other) ;

/// @brief Method IsExistingMaterial, addr 0x39d0814, size 0x14, virtual false, abstract: false, final false
inline bool IsExistingMaterial() ;

/// @brief Method IsTransparentMaterial, addr 0x39d1748, size 0x30, virtual false, abstract: false, final false
static inline bool IsTransparentMaterial(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  nodeID, ::ArrayW<::HoudiniEngineUnity::HAPI_ParmInfo,::Array<::HoudiniEngineUnity::HAPI_ParmInfo>*>  parameters) ;

static inline ::HoudiniEngineUnity::HEU_MaterialData* New_ctor() ;

/// @brief Method UpdateMaterialFromHoudini, addr 0x39d0828, size 0xf20, virtual false, abstract: false, final false
inline void UpdateMaterialFromHoudini(::HoudiniEngineUnity::HAPI_MaterialInfo  materialInfo, ::StringW  assetCacheFolderPath) ;

/// @brief Method UseLegacyShaders, addr 0x39d17c4, size 0x5dc, virtual false, abstract: false, final false
inline void UseLegacyShaders(::HoudiniEngineUnity::HAPI_MaterialInfo  materialInfo, ::StringW  assetCacheFolderPath, ::HoudiniEngineUnity::HEU_SessionBase*  session, ::HoudiniEngineUnity::HAPI_NodeInfo  nodeInfo, ::ArrayW<::HoudiniEngineUnity::HAPI_ParmInfo,::Array<::HoudiniEngineUnity::HAPI_ParmInfo>*>  parmInfos) ;
...
/// @brief Method .ctor, addr 0x39d291c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
