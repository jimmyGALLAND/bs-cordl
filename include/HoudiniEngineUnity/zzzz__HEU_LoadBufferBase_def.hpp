...
/// @brief Method InitializeBuffer, addr 0x39decf0, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39ded0c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
