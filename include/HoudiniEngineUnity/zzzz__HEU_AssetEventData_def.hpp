...
static inline ::HoudiniEngineUnity::HEU_AssetEventData* New_ctor(::HoudiniEngineUnity::HEU_HoudiniAsset*  asset, bool  successful, ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>*  outputObjects) ;
...
/// @brief Method .ctor, addr 0x3982964, size 0x40, virtual false, abstract: false, final false
