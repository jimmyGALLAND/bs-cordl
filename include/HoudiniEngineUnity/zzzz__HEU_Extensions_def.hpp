...
public:
// Declarations
/// @brief Method ApproximatelyEquals, addr 0x39e60e0, size 0x3c, virtual false, abstract: false, final false
static inline bool ApproximatelyEquals(::UnityEngine::Quaternion  quatA, ::UnityEngine::Quaternion  value) ;

/// @brief Method ApproximatelyEquals, addr 0x39e611c, size 0x10, virtual false, abstract: false, final false
static inline bool ApproximatelyEquals(float_t  self, float_t  other, float_t  epsilon) ;

/// @brief Method AsByteArray, addr 0x39e612c, size 0x78, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> AsByteArray(::StringW  self) ;

/// @brief Method AsString, addr 0x39e61a4, size 0x80, virtual false, abstract: false, final false
...
template<typename T>
static inline ::ArrayW<::HoudiniEngineUnity::IEquivable_1<T>*,::Array<::HoudiniEngineUnity::IEquivable_1<T>*>*> ConvertArrayToEquivable(::ArrayW<T,::Array<T>*>  self) ;

/// @brief Method ConvertList, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T,typename U>
static inline ::System::Collections::Generic::List_1<U>* ConvertList(::System::Collections::Generic::List_1<T>*  self) ;

/// @brief Method ConvertListToEquivable, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::IEquivable_1<T>*>* ConvertListToEquivable(::System::Collections::Generic::List_1<T>*  self) ;

/// @brief Method DecomposeToPosition, addr 0x39e6254, size 0xc, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 DecomposeToPosition(::UnityEngine::Matrix4x4  self) ;

/// @brief Method DecomposeToRotation, addr 0x39e6260, size 0x64, virtual false, abstract: false, final false
static inline ::UnityEngine::Quaternion DecomposeToRotation(::UnityEngine::Matrix4x4  self) ;

/// @brief Method DecomposeToScale, addr 0x39e62c4, size 0x194, virtual false, abstract: false, final false
...
template<typename T>
static inline ::System::Collections::Generic::List_1<T>* Filter(::System::Collections::Generic::IEnumerable_1<T>*  self, ::System::Func_2<T,bool>*  predicate) ;

/// @brief Method IsEquivalentList, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool IsEquivalentList(::System::Collections::Generic::List_1<T>*  self, ::System::Collections::Generic::List_1<T>*  other) ;

/// @brief Method IsValidIndex, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline bool IsValidIndex(::System::Collections::Generic::List_1<T>*  self, int32_t  index) ;

/// @brief Method Map, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T,typename R>
static inline ::System::Collections::Generic::List_1<R>* Map(::System::Collections::Generic::IEnumerable_1<T>*  self, ::System::Func_2<T,R>*  selector) ;

/// @brief Method Reduce, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline T Reduce(::System::Collections::Generic::IEnumerable_1<T>*  self, ::System::Func_3<T,T,T>*  func) ;

/// @brief Method SwapXAndY, addr 0x39e6224, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 SwapXAndY(::UnityEngine::Vector3  self) ;

/// @brief Method SwapXAndZ, addr 0x39e6234, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 SwapXAndZ(::UnityEngine::Vector3  self) ;

/// @brief Method SwapYAndZ, addr 0x39e6244, size 0x10, virtual false, abstract: false, final false
