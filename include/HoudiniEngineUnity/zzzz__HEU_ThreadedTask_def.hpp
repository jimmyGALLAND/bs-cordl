...
/// @brief Method Abort, addr 0x39df32c, size 0x34, virtual true, abstract: false, final false
inline void Abort() ;

/// @brief Method CleanUp, addr 0x39df5d8, size 0x4, virtual true, abstract: false, final false
inline void CleanUp() ;

/// @brief Method DoWork, addr 0x39df5cc, size 0x4, virtual true, abstract: false, final false
inline void DoWork() ;

static inline ::HoudiniEngineUnity::HEU_ThreadedTask* New_ctor() ;

/// @brief Method OnComplete, addr 0x39df5d0, size 0x4, virtual true, abstract: false, final false
inline void OnComplete() ;

/// @brief Method OnStopped, addr 0x39df5d4, size 0x4, virtual true, abstract: false, final false
inline void OnStopped() ;

/// @brief Method Reset, addr 0x39df360, size 0x84, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method Run, addr 0x39df5dc, size 0x24, virtual false, abstract: false, final false
inline void Run() ;

/// @brief Method Start, addr 0x39deeb0, size 0x138, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method Stop, addr 0x39df168, size 0x3c, virtual true, abstract: false, final false
inline void Stop() ;

/// @brief Method Update, addr 0x39df3e4, size 0x58, virtual true, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x39df62c, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsActive, addr 0x39df43c, size 0xc8, virtual false, abstract: false, final false
inline bool get_IsActive() ;

/// @brief Method get_IsBackground, addr 0x39df618, size 0x8, virtual false, abstract: false, final false
inline bool get_IsBackground() ;

/// @brief Method get_IsComplete, addr 0x39df1a4, size 0xc8, virtual false, abstract: false, final false
inline bool get_IsComplete() ;

/// @brief Method get_Priority, addr 0x39df608, size 0x8, virtual false, abstract: false, final false
inline ::System::Threading::ThreadPriority get_Priority() ;

/// @brief Method get_StopRequested, addr 0x39df504, size 0xc8, virtual false, abstract: false, final false
inline bool get_StopRequested() ;

/// @brief Method get_TaskName, addr 0x39df600, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_TaskName() ;

/// @brief Method set_IsActive, addr 0x39defe8, size 0xc0, virtual false, abstract: false, final false
inline void set_IsActive(bool  value) ;

/// @brief Method set_IsBackground, addr 0x39df620, size 0xc, virtual false, abstract: false, final false
inline void set_IsBackground(bool  value) ;

/// @brief Method set_IsComplete, addr 0x39df0a8, size 0xc0, virtual false, abstract: false, final false
inline void set_IsComplete(bool  value) ;

/// @brief Method set_Priority, addr 0x39df610, size 0x8, virtual false, abstract: false, final false
inline void set_Priority(::System::Threading::ThreadPriority  value) ;

/// @brief Method set_StopRequested, addr 0x39df26c, size 0xc0, virtual false, abstract: false, final false
