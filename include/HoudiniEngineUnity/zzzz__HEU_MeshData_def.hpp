...
/// @brief Field _pointIndexToMeshIndexMap, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__pointIndexToMeshIndexMap, put=__cordl_internal_set__pointIndexToMeshIndexMap)) ::System::Collections::Generic::Dictionary_2<int32_t,int32_t>*  _pointIndexToMeshIndexMap;
...
/// @brief Field _uvs, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__uvs, put=__cordl_internal_set__uvs)) ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::Vector4>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::Vector4>*>*>  _uvs;
...
constexpr ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::Vector4>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::Vector4>*>*> const& __cordl_internal_get__uvs() const;
...
/// @brief Method .ctor, addr 0x3a016d4, size 0x1e8, virtual false, abstract: false, final false
inline void _ctor() ;
