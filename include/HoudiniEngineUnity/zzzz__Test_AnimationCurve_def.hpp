...
/// @brief Method IsEquivalentTo, addr 0x3a175ec, size 0xe0, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_AnimationCurve*  other) ;

/// @brief Method IsNull, addr 0x3a175dc, size 0x10, virtual true, abstract: false, final true
inline bool IsNull() ;
...
/// @brief Method .ctor, addr 0x3a175b4, size 0x28, virtual false, abstract: false, final false
...
constexpr ::HoudiniEngineUnity::IEquivableWrapperClass_1<::HoudiniEngineUnity::Test_AnimationCurve*>* i___HoudiniEngineUnity__IEquivableWrapperClass_1___HoudiniEngineUnity__Test_AnimationCurve__() noexcept;
