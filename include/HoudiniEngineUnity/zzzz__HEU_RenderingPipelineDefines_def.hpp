...
public:
// Declarations
/// @brief Method AddDefine, addr 0x3a01b6c, size 0x104, virtual false, abstract: false, final false
static inline void AddDefine(::StringW  define) ;

/// @brief Method GetDefines, addr 0x3a01d30, size 0x68, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::StringW>* GetDefines() ;

/// @brief Method GetPipeline, addr 0x3a01a3c, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method RemoveDefine, addr 0x3a01c70, size 0xc0, virtual false, abstract: false, final false
static inline void RemoveDefine(::StringW  define) ;

/// @brief Method SetDefines, addr 0x3a01d98, size 0x4, virtual false, abstract: false, final false
static inline void SetDefines(::System::Collections::Generic::List_1<::StringW>*  definesList) ;

/// @brief Method UpdateDefines, addr 0x3a01964, size 0xd8, virtual false, abstract: false, final false
static inline void UpdateDefines() ;

/// @brief Method .ctor, addr 0x3a01d9c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
