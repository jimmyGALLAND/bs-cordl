...
public:
// Declarations
/// @brief Method isFloat, addr 0x39c4fc4, size 0x14, virtual false, abstract: false, final false
inline bool isFloat() ;

/// @brief Method isInt, addr 0x39c4fa8, size 0x1c, virtual false, abstract: false, final false
inline bool isInt() ;

/// @brief Method isNode, addr 0x39c5024, size 0x10, virtual false, abstract: false, final false
inline bool isNode() ;

/// @brief Method isNonValue, addr 0x39c5034, size 0x14, virtual false, abstract: false, final false
inline bool isNonValue() ;

/// @brief Method isPath, addr 0x39c5004, size 0x20, virtual false, abstract: false, final false
inline bool isPath() ;

/// @brief Method isString, addr 0x39c4fd8, size 0x2c, virtual false, abstract: false, final false
