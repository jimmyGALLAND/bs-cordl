...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HAPI_Keyframe::*)(float_t, float_t, float_t, float_t)>(&::HoudiniEngineUnity::HAPI_Keyframe::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x39c52cc;
