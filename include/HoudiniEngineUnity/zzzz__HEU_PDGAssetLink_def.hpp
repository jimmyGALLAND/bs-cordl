...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x39cfbb4, size 0x20, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x39cfbd4, size 0xc, virtual true, abstract: false, final false
inline void EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x39cfba0, size 0x14, virtual true, abstract: false, final false
inline void Invoke() ;

static inline ::HoudiniEngineUnity::__HEU_PDGAssetLink__UpdateUIDelegate* New_ctor(::System::Object*  object, ::System::IntPtr  method) ;

/// @brief Method .ctor, addr 0x39cfb18, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method Awake, addr 0x39cc824, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CancelCook, addr 0x39ced10, size 0x60, virtual false, abstract: false, final false
inline void CancelCook() ;

/// @brief Method ClearAllTOPData, addr 0x39cd000, size 0x2c4, virtual false, abstract: false, final false
inline void ClearAllTOPData() ;

/// @brief Method ClearTOPNetworkWorkItemResults, addr 0x39ce5d8, size 0x140, virtual false, abstract: false, final false
static inline void ClearTOPNetworkWorkItemResults(::HoudiniEngineUnity::HEU_TOPNetworkData*  topNetwork) ;

/// @brief Method ClearTOPNodeWorkItemResults, addr 0x39ce2dc, size 0x124, virtual false, abstract: false, final false
static inline void ClearTOPNodeWorkItemResults(::HoudiniEngineUnity::HEU_TOPNodeData*  topNode) ;

/// @brief Method ClearWorkItemResult, addr 0x39cea7c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method ClearWorkItemResultByID, addr 0x39ce904, size 0x1c, virtual false, abstract: false, final false
static inline void ClearWorkItemResultByID(::HoudiniEngineUnity::HEU_TOPNodeData*  topNode, int32_t  workItemID) ;

/// @brief Method CookOutput, addr 0x39cce18, size 0x60, virtual false, abstract: false, final false
inline void CookOutput() ;

/// @brief Method CookTOPNode, addr 0x39ceba4, size 0x20, virtual false, abstract: false, final false
inline void CookTOPNode(::HoudiniEngineUnity::HEU_TOPNodeData*  topNode) ;

/// @brief Method DestroyWorkItemResultData, addr 0x39ce718, size 0x1ec, virtual false, abstract: false, final false
...
/// @brief Method DirtyAll, addr 0x39cebcc, size 0x20, virtual false, abstract: false, final false
inline void DirtyAll() ;

/// @brief Method DirtyTOPNode, addr 0x39ceb7c, size 0x20, virtual false, abstract: false, final false
inline void DirtyTOPNode(::HoudiniEngineUnity::HEU_TOPNodeData*  topNode) ;

/// @brief Method GetHAPISession, addr 0x39cd788, size 0x8c, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_SessionBase* GetHAPISession() ;

/// @brief Method GetLoadRootTransform, addr 0x39cf3d4, size 0xdc, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> GetLoadRootTransform() ;

/// @brief Method GetSelectedTOPNetwork, addr 0x39ce4bc, size 0x8, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_TOPNetworkData* GetSelectedTOPNetwork() ;

/// @brief Method GetSelectedTOPNode, addr 0x39ce548, size 0x90, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_TOPNodeData* GetSelectedTOPNode() ;

/// @brief Method GetTOPNetwork, addr 0x39ce4c4, size 0x84, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_TOPNetworkData* GetTOPNetwork(int32_t  index) ;

/// @brief Method GetTOPNetworkByName, addr 0x39cdbc4, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method GetTOPNode, addr 0x39cf4b0, size 0x170, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_TOPNodeData* GetTOPNode(int32_t  nodeID) ;

/// @brief Method GetTOPNodeByName, addr 0x39ce12c, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method GetTOPNodeStatus, addr 0x39cf8f8, size 0x100, virtual false, abstract: false, final false
inline ::StringW GetTOPNodeStatus(::HoudiniEngineUnity::HEU_TOPNodeData*  topNode) ;

/// @brief Method GetWorkResultByID, addr 0x39ce920, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method HandleInitialLoad, addr 0x39cc828, size 0x4, virtual false, abstract: false, final false
inline void HandleInitialLoad() ;

/// @brief Method LoadResults, addr 0x39ced74, size 0x5dc, virtual false, abstract: false, final false
...
/// @brief Method NotifyAssetCooked, addr 0x39ccdec, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method NotifyAssetCooked, addr 0x39ccfe0, size 0x10, virtual false, abstract: false, final false
inline void NotifyAssetCooked(::HoudiniEngineUnity::HEU_CookedEventData*  cookedEventData) ;

/// @brief Method NotifyAssetCooked, addr 0x39ccff0, size 0x10, virtual false, abstract: false, final false
inline void NotifyAssetCooked(::HoudiniEngineUnity::HEU_ReloadEventData*  reloadEventData) ;

/// @brief Method OnAfterDeserialize, addr 0x39cc830, size 0x4, virtual true, abstract: false, final true
inline void OnAfterDeserialize() ;

/// @brief Method OnBeforeSerialize, addr 0x39cc82c, size 0x4, virtual true, abstract: false, final true
inline void OnBeforeSerialize() ;

/// @brief Method OnDestroy, addr 0x39cc834, size 0x4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method ParseHEngineData, addr 0x39cd9fc, size 0x1c8, virtual false, abstract: false, final false
static inline void ParseHEngineData(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  topNodeID, ByRef<::HoudiniEngineUnity::HAPI_NodeInfo>  nodeInfo, ByRef<::HoudiniEngineUnity::TOPNodeTags*>  nodeTags) ;

/// @brief Method PauseCook, addr 0x39cecac, size 0x60, virtual false, abstract: false, final false
inline void PauseCook() ;

/// @brief Method PopulateFromHDA, addr 0x39cce78, size 0x168, virtual false, abstract: false, final false
inline void PopulateFromHDA() ;

/// @brief Method PopulateTOPNetworks, addr 0x39cd2e0, size 0x4a8, virtual false, abstract: false, final false
inline bool PopulateTOPNetworks() ;

/// @brief Method PopulateTOPNodes, addr 0x39cdd64, size 0x3c8, virtual false, abstract: false, final false
static inline bool PopulateTOPNodes(::HoudiniEngineUnity::HEU_SessionBase*  session, ::HoudiniEngineUnity::HEU_TOPNetworkData*  topNetwork, ::ArrayW<int32_t,::Array<int32_t>*>  topNodeIDs, bool  useHEngineData) ;

/// @brief Method Refresh, addr 0x39cc9e4, size 0x408, virtual false, abstract: false, final false
inline void Refresh() ;

/// @brief Method RepaintUI, addr 0x39cd2c4, size 0x1c, virtual false, abstract: false, final false
inline void RepaintUI() ;

/// @brief Method Reset, addr 0x39cc9e0, size 0x4, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method ResetTOPNetworkWorkItemTally, addr 0x39cec00, size 0xa8, virtual false, abstract: false, final false
inline void ResetTOPNetworkWorkItemTally(::HoudiniEngineUnity::HEU_TOPNetworkData*  topNetwork) ;

/// @brief Method SelectTOPNetwork, addr 0x39ce400, size 0x5c, virtual false, abstract: false, final false
inline void SelectTOPNetwork(int32_t  newIndex) ;

/// @brief Method SelectTOPNode, addr 0x39ce45c, size 0x60, virtual false, abstract: false, final false
inline void SelectTOPNode(::HoudiniEngineUnity::HEU_TOPNetworkData*  network, int32_t  newIndex) ;

/// @brief Method Setup, addr 0x39cc8b0, size 0x130, virtual false, abstract: false, final false
inline void Setup(::HoudiniEngineUnity::HEU_HoudiniAsset*  hdaAsset) ;

/// @brief Method UpdateTOPNodeResultsVisibility, addr 0x39ceaf0, size 0x8c, virtual false, abstract: false, final false
inline void UpdateTOPNodeResultsVisibility(::HoudiniEngineUnity::HEU_TOPNodeData*  topNode) ;

/// @brief Method UpdateWorkItemTally, addr 0x39cf620, size 0x2d8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39cfa34, size 0xdc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AssetLinkState, addr 0x39cfa2c, size 0x8, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::__HEU_PDGAssetLink__LinkState get_AssetLinkState() ;

/// @brief Method get_AssetName, addr 0x39cfa1c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_AssetName() ;

/// @brief Method get_SelectedTOPNetwork, addr 0x39cfa24, size 0x8, virtual false, abstract: false, final false
