...
/// @brief Field _renderMaterials, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__renderMaterials, put=__cordl_internal_set__renderMaterials)) ::ArrayW<::UnityW<::UnityEngine::Material>,::Array<::UnityW<::UnityEngine::Material>>*>  _renderMaterials;
...
/// @brief Method IsEquivalentTo, addr 0x398b88c, size 0x1ec, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x398b810, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
