...
/// @brief Method IsEquivalentTo, addr 0x3a15034, size 0x1cc, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_Transform*  other) ;

/// @brief Method IsNull, addr 0x3a14fd4, size 0x60, virtual true, abstract: false, final true
inline bool IsNull() ;
...
/// @brief Method .ctor, addr 0x3a14fac, size 0x28, virtual false, abstract: false, final false
