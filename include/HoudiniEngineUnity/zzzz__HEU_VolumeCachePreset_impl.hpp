...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_VolumeCachePreset::*)()>(&::HoudiniEngineUnity::HEU_VolumeCachePreset::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3982f84;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_VolumeLayerPreset*>*> const& HoudiniEngineUnity::HEU_VolumeCachePreset::__cordl_internal_get__volumeLayersPresets() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____volumeLayersPresets;
}
