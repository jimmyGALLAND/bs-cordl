...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_LoadBufferMesh::*)()>(&::HoudiniEngineUnity::HEU_LoadBufferMesh::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x39ded14;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeoGroup*>*> const& HoudiniEngineUnity::HEU_LoadBufferMesh::__cordl_internal_get__LODGroupMeshes() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____LODGroupMeshes;
}
