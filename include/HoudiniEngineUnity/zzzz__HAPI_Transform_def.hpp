...
// SizeInfo { instance_size: 40, native_size: 56, calculated_instance_size: 40, calculated_native_size: 52, minimum_alignment: 8, packing: None, specified_packing: None }
namespace HoudiniEngineUnity {
// Is value type: true
...
public:
// Declarations
/// @brief Method Init, addr 0x39c4e00, size 0xe0, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method .ctor, addr 0x39bbd18, size 0xac, virtual false, abstract: false, final false
