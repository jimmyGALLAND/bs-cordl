...
/// @brief Method <Initialize>b__0, addr 0x39cadec, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39c82f8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _paramChoices, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__paramChoices, put=__cordl_internal_set__paramChoices)) ::ArrayW<::HoudiniEngineUnity::HAPI_ParmChoiceInfo,::Array<::HoudiniEngineUnity::HAPI_ParmChoiceInfo>*>  _paramChoices;
...
/// @brief Field _parameterList, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__parameterList, put=__cordl_internal_set__parameterList)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterData*>*  _parameterList;

/// @brief Field _parameterModifiers, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__parameterModifiers, put=__cordl_internal_set__parameterModifiers)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterModifier*>*  _parameterModifiers;
...
/// @brief Method AreParametersValid, addr 0x39c64cc, size 0x8, virtual false, abstract: false, final false
inline bool AreParametersValid() ;

/// @brief Method CleanUp, addr 0x39c64fc, size 0x280, virtual false, abstract: false, final false
inline void CleanUp() ;

/// @brief Method ClearInstancesFromMultiParm, addr 0x39c96e0, size 0xbc, virtual false, abstract: false, final false
inline void ClearInstancesFromMultiParm(int32_t  unityParamIndex) ;

/// @brief Method DownloadAsDefaultPresetData, addr 0x39ca0fc, size 0x50, virtual false, abstract: false, final false
inline void DownloadAsDefaultPresetData(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method DownloadPresetData, addr 0x39ca068, size 0x50, virtual false, abstract: false, final false
inline void DownloadPresetData(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method GetChosenIndexFromChoiceList, addr 0x39c88ec, size 0xac, virtual false, abstract: false, final false
inline int32_t GetChosenIndexFromChoiceList(::HoudiniEngineUnity::HEU_ParameterData*  inChoiceParameter) ;

/// @brief Method GetDefaultPresetData, addr 0x39c64c4, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetDefaultPresetData() ;

/// @brief Method GetInputNodeConnectionObjects, addr 0x39ca064, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method GetParameter, addr 0x39c3d4c, size 0x84, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_ParameterData* GetParameter(int32_t  listIndex) ;

/// @brief Method GetParameter, addr 0x39c8704, size 0x168, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_ParameterData* GetParameter(::StringW  name) ;

/// @brief Method GetParameterDataForUIRestore, addr 0x39c9e7c, size 0x1e8, virtual false, abstract: false, final false
inline void GetParameterDataForUIRestore(::System::Collections::Generic::Dictionary_2<::StringW,::HoudiniEngineUnity::HEU_ParameterData*>*  folderParams, ::System::Collections::Generic::Dictionary_2<::StringW,::UnityW<::HoudiniEngineUnity::HEU_InputNode>>*  inputNodeParams) ;

/// @brief Method GetParameterWithParmID, addr 0x39c3b94, size 0x158, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_ParameterData* GetParameterWithParmID(int32_t  parmID) ;

/// @brief Method GetParameters, addr 0x39c86fc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterData*>* GetParameters() ;

/// @brief Method GetPresetData, addr 0x39c64b4, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPresetData() ;

/// @brief Method GetStringFromParameter, addr 0x39c8998, size 0x48, virtual false, abstract: false, final false
inline ::StringW GetStringFromParameter(::StringW  paramName) ;

/// @brief Method HasModifiersPending, addr 0x39c979c, size 0x50, virtual false, abstract: false, final false
inline bool HasModifiersPending() ;

/// @brief Method HaveParametersChanged, addr 0x39c8a24, size 0x410, virtual false, abstract: false, final false
inline bool HaveParametersChanged() ;

/// @brief Method Initialize, addr 0x39c677c, size 0x1b7c, virtual false, abstract: false, final false
inline bool Initialize(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  nodeID, ByRef<::HoudiniEngineUnity::HAPI_NodeInfo>  nodeInfo, ::System::Collections::Generic::Dictionary_2<::StringW,::HoudiniEngineUnity::HEU_ParameterData*>*  previousParamFolders, ::System::Collections::Generic::Dictionary_2<::StringW,::UnityW<::HoudiniEngineUnity::HEU_InputNode>>*  previousParamInputNodes, ::HoudiniEngineUnity::HEU_HoudiniAsset*  parentAsset) ;

/// @brief Method InsertInstanceToMultiParm, addr 0x39c9540, size 0xd0, virtual false, abstract: false, final false
inline void InsertInstanceToMultiParm(int32_t  unityParamIndex, int32_t  instanceIndex, int32_t  numInstancesToAdd) ;

/// @brief Method IsEquivalentTo, addr 0x39ca9bc, size 0x300, virtual true, abstract: false, final true
...
/// @brief Method ProcessModifiers, addr 0x39c97ec, size 0x690, virtual false, abstract: false, final false
inline void ProcessModifiers(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method RemoveInstancesFromMultiParm, addr 0x39c9610, size 0xd0, virtual false, abstract: false, final false
inline void RemoveInstancesFromMultiParm(int32_t  unityParamIndex, int32_t  instanceIndex, int32_t  numInstancesToRemove) ;

/// @brief Method RemoveParameter, addr 0x39c886c, size 0x80, virtual false, abstract: false, final false
inline void RemoveParameter(int32_t  listIndex) ;

/// @brief Method ResetAllToDefault, addr 0x39ca834, size 0x188, virtual false, abstract: false, final false
inline void ResetAllToDefault(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method SetPresetData, addr 0x39c64bc, size 0x8, virtual false, abstract: false, final false
inline void SetPresetData(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method SetStringToParameter, addr 0x39c89e0, size 0x44, virtual false, abstract: false, final false
inline void SetStringToParameter(::StringW  paramName, ::StringW  value) ;

/// @brief Method SetupRampParameter, addr 0x39c8300, size 0x3fc, virtual false, abstract: false, final false
inline void SetupRampParameter(::HoudiniEngineUnity::HEU_ParameterData*  rampParameter) ;

/// @brief Method SyncInternalParametersForUndoCompare, addr 0x39ca454, size 0x3e0, virtual false, abstract: false, final false
inline void SyncInternalParametersForUndoCompare(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method SyncParameterFromHoudini, addr 0x39ca3d4, size 0x80, virtual false, abstract: false, final false
inline void SyncParameterFromHoudini(::HoudiniEngineUnity::HEU_SessionBase*  session, ::StringW  parameterName) ;

/// @brief Method UpdateTransformParameters, addr 0x39ca32c, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method UploadParameterInputs, addr 0x39ca14c, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method UploadPresetData, addr 0x39ca0b8, size 0x44, virtual false, abstract: false, final false
inline void UploadPresetData(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method UploadValuesToHoudini, addr 0x39c8e34, size 0x70c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39cacbc, size 0x130, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ParameterModifiers, addr 0x39c6490, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterModifier*>* get_ParameterModifiers() ;

/// @brief Method get_RecacheUI, addr 0x39c64e8, size 0x8, virtual false, abstract: false, final false
inline bool get_RecacheUI() ;

/// @brief Method get_RequiresRegeneration, addr 0x39c64a0, size 0x8, virtual false, abstract: false, final false
inline bool get_RequiresRegeneration() ;

/// @brief Method get_RootParameters, addr 0x39c6480, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<int32_t>* get_RootParameters() ;

/// @brief Method get_ShowParameters, addr 0x39c64d4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_ParameterModifiers, addr 0x39c6498, size 0x8, virtual false, abstract: false, final false
inline void set_ParameterModifiers(::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ParameterModifier*>*  value) ;

/// @brief Method set_RecacheUI, addr 0x39c64f0, size 0xc, virtual false, abstract: false, final false
inline void set_RecacheUI(bool  value) ;

/// @brief Method set_RequiresRegeneration, addr 0x39c64a8, size 0xc, virtual false, abstract: false, final false
inline void set_RequiresRegeneration(bool  value) ;

/// @brief Method set_RootParameters, addr 0x39c6488, size 0x8, virtual false, abstract: false, final false
inline void set_RootParameters(::System::Collections::Generic::List_1<int32_t>*  value) ;

/// @brief Method set_ShowParameters, addr 0x39c64dc, size 0xc, virtual false, abstract: false, final false
