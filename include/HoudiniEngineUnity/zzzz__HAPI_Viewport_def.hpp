...
public:
// Declarations
/// @brief Method Init, addr 0x39c5424, size 0x70, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method .ctor, addr 0x39c539c, size 0x88, virtual false, abstract: false, final false
