...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_InputPreset::*)()>(&::HoudiniEngineUnity::HEU_InputPreset::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3982e08;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_InputObjectPreset*>*> const& HoudiniEngineUnity::HEU_InputPreset::__cordl_internal_get__inputObjectPresets() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____inputObjectPresets;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_InputAssetPreset*>*> const& HoudiniEngineUnity::HEU_InputPreset::__cordl_internal_get__inputAssetPresets() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____inputAssetPresets;
}
