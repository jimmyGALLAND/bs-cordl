...
/// @brief Method IsEquivalentTo, addr 0x3a16fd4, size 0xf8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a16fac, size 0x28, virtual false, abstract: false, final false
