...
/// @brief Method AppendCookLog, addr 0x39e4840, size 0x100, virtual false, abstract: false, final false
inline void AppendCookLog(::StringW  logStr) ;

/// @brief Method ClearCookLog, addr 0x39e4b90, size 0x5c, virtual false, abstract: false, final false
inline void ClearCookLog() ;

/// @brief Method DeleteCookingFile, addr 0x39e4d04, size 0x88, virtual false, abstract: false, final false
inline void DeleteCookingFile() ;

/// @brief Method GetCookLogFilePath, addr 0x39e4bec, size 0x118, virtual false, abstract: false, final false
inline ::StringW GetCookLogFilePath() ;

/// @brief Method GetCookLogString, addr 0x39e4820, size 0x20, virtual false, abstract: false, final false
inline ::StringW GetCookLogString() ;

/// @brief Method GetFileSizeOfLogFile, addr 0x39e4d8c, size 0x88, virtual false, abstract: false, final false
inline int64_t GetFileSizeOfLogFile() ;

static inline ::HoudiniEngineUnity::HEU_CookLogs* New_ctor() ;

/// @brief Method WriteToLogFile, addr 0x39e4940, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39e4794, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::HoudiniEngineUnity::HEU_CookLogs* getStaticF__instance() ;

/// @brief Method get_Instance, addr 0x39e4720, size 0x74, virtual false, abstract: false, final false
