...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::HoudiniEngineUnity::HEU_InputInterface::*)()>(&::HoudiniEngineUnity::HEU_InputInterface::get_Priority)> {
  ...
  constexpr static std::size_t addrs = 0x39f7b40;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_InputInterface::*)(int32_t)>(&::HoudiniEngineUnity::HEU_InputInterface::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x39f7b48;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_InputInterface::*)()>(&::HoudiniEngineUnity::HEU_InputInterface::RegisterInterface)> {
  ...
  constexpr static std::size_t addrs = 0x39f7b70;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::HoudiniEngineUnity::HEU_InputInterface::*)(::UnityEngine::GameObject*)>(&::HoudiniEngineUnity::HEU_InputInterface::IsThisInputObjectSupported)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::HoudiniEngineUnity::HEU_InputInterface::*)(::HoudiniEngineUnity::HEU_SessionBase*, int32_t, ::UnityEngine::GameObject*, ByRef<int32_t>)>(&::HoudiniEngineUnity::HEU_InputInterface::CreateInputNodeWithDataUpload)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
inline bool HoudiniEngineUnity::HEU_InputInterface::CreateInputNodeWithDataUpload(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  connectNodeID, ::UnityEngine::GameObject*  inputObject, ByRef<int32_t>  inputNodeID)  {
auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(
                    il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::HEU_InputInterface*>::get(),
                    5
