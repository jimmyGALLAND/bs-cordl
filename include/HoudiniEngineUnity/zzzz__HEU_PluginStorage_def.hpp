...
/// @brief Method .ctor, addr 0x39c2628, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _dataMap, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__dataMap, put=__cordl_internal_set__dataMap)) ::System::Collections::Generic::Dictionary_2<::StringW,::HoudiniEngineUnity::__HEU_PluginStorage__StoreData*>*  _dataMap;
...
/// @brief Method ClearPluginData, addr 0x39c2e4c, size 0xac, virtual false, abstract: false, final false
static inline void ClearPluginData() ;

/// @brief Method ConvertEnvKeyedPathToReal, addr 0x39b8fe8, size 0x238, virtual false, abstract: false, final false
inline ::StringW ConvertEnvKeyedPathToReal(::StringW  inPath) ;

/// @brief Method ConvertRealPathToEnvKeyedPath, addr 0x39c30d8, size 0x1f0, virtual false, abstract: false, final false
inline ::StringW ConvertRealPathToEnvKeyedPath(::StringW  inPath) ;

/// @brief Method DeleteAllSavedSessionData, addr 0x39c30d4, size 0x4, virtual false, abstract: false, final false
static inline void DeleteAllSavedSessionData() ;

/// @brief Method Get, addr 0x39bd9f0, size 0xbc, virtual false, abstract: false, final false
inline bool Get(::StringW  key, ByRef<::StringW>  value, ::StringW  defaultValue) ;

/// @brief Method Get, addr 0x39bdfec, size 0xf4, virtual false, abstract: false, final false
inline bool Get(::StringW  key, ByRef<bool>  value, bool  defaultValue) ;

/// @brief Method Get, addr 0x39bed44, size 0x134, virtual false, abstract: false, final false
inline bool Get(::StringW  key, ByRef<float_t>  value, float_t  defaultValue) ;

/// @brief Method Get, addr 0x39bf704, size 0xf4, virtual false, abstract: false, final false
inline bool Get(::StringW  key, ByRef<int32_t>  value, int32_t  defaultValue) ;

/// @brief Method Get, addr 0x39c2704, size 0xf4, virtual false, abstract: false, final false
inline bool Get(::StringW  key, ByRef<int64_t>  value, int64_t  defaultValue) ;

/// @brief Method Get, addr 0x39bff80, size 0x1c8, virtual false, abstract: false, final false
inline bool Get(::StringW  key, ByRef<::System::Collections::Generic::List_1<::StringW>*>  values, char16_t  delimiter) ;

/// @brief Method GetEnvironmentPathMap, addr 0x39c1a74, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method InstantiateAndLoad, addr 0x39c1a84, size 0xd0, virtual false, abstract: false, final false
static inline void InstantiateAndLoad() ;

/// @brief Method LoadAllSessionData, addr 0x39c306c, size 0x68, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_SessionData*>* LoadAllSessionData() ;

/// @brief Method LoadAssetEnvironmentPaths, addr 0x39bdbac, size 0x3dc, virtual false, abstract: false, final false
inline void LoadAssetEnvironmentPaths() ;

/// @brief Method LoadFromSavedFile, addr 0x39c2ef8, size 0x58, virtual false, abstract: false, final false
static inline void LoadFromSavedFile() ;

/// @brief Method LoadPluginData, addr 0x39c1bd0, size 0xa58, virtual false, abstract: false, final false
inline bool LoadPluginData() ;

/// @brief Method MarkDirtyForSave, addr 0x39c2630, size 0x4, virtual false, abstract: false, final false
inline void MarkDirtyForSave() ;

static inline ::HoudiniEngineUnity::HEU_PluginStorage* New_ctor() ;

/// @brief Method ReadFromEditorPrefs, addr 0x39c2e44, size 0x8, virtual false, abstract: false, final false
inline bool ReadFromEditorPrefs() ;

/// @brief Method SaveAllSessionData, addr 0x39c3068, size 0x4, virtual false, abstract: false, final false
static inline void SaveAllSessionData(::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_SessionBase*>*  allSessions) ;

/// @brief Method SaveIfRequired, addr 0x39c27f8, size 0x60, virtual false, abstract: false, final false
static inline void SaveIfRequired() ;

/// @brief Method SavePluginData, addr 0x39c2858, size 0x4d4, virtual false, abstract: false, final false
inline bool SavePluginData() ;

/// @brief Method SessionFilePath, addr 0x39c2f50, size 0x118, virtual false, abstract: false, final false
static inline ::StringW SessionFilePath() ;

/// @brief Method Set, addr 0x39bdb0c, size 0xa0, virtual false, abstract: false, final false
inline void Set(::StringW  key, ::StringW  value) ;

/// @brief Method Set, addr 0x39be134, size 0xcc, virtual false, abstract: false, final false
inline void Set(::StringW  key, bool  value) ;

/// @brief Method Set, addr 0x39beecc, size 0xd8, virtual false, abstract: false, final false
inline void Set(::StringW  key, float_t  value) ;

/// @brief Method Set, addr 0x39bf84c, size 0xd0, virtual false, abstract: false, final false
inline void Set(::StringW  key, int32_t  value) ;

/// @brief Method Set, addr 0x39c2634, size 0xd0, virtual false, abstract: false, final false
inline void Set(::StringW  key, int64_t  value) ;

/// @brief Method Set, addr 0x39c01a0, size 0x15c, virtual false, abstract: false, final false
inline void Set(::StringW  key, ::System::Collections::Generic::List_1<::StringW>*  values, char16_t  delimiter) ;

/// @brief Method SetCurrentCulture, addr 0x39c0fc0, size 0x10c, virtual false, abstract: false, final false
static inline void SetCurrentCulture(bool  useInvariant) ;

/// @brief Method SettingsFilePath, addr 0x39c2d2c, size 0x118, virtual false, abstract: false, final false
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::HoudiniEngineUnity::__HEU_PluginStorage__StoreData*>*> const& __cordl_internal_get__dataMap() const;
...
/// @brief Method .ctor, addr 0x39c1b54, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::HoudiniEngineUnity::HEU_PluginStorage* getStaticF__instance() ;

/// @brief Method get_Instance, addr 0x39b8f8c, size 0x5c, virtual false, abstract: false, final false
static inline ::HoudiniEngineUnity::HEU_PluginStorage* get_Instance() ;

/// @brief Method get_RequiresSave, addr 0x39c1a7c, size 0x8, virtual false, abstract: false, final false
