...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_Shelf::*)()>(&::HoudiniEngineUnity::HEU_Shelf::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3a01e00;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ShelfToolData*>*> const& HoudiniEngineUnity::HEU_Shelf::__cordl_internal_get__tools() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____tools;
}
