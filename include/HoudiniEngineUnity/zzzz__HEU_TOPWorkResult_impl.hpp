...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_TOPWorkResult::*)()>(&::HoudiniEngineUnity::HEU_TOPWorkResult::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x39cf350;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>*> const& HoudiniEngineUnity::HEU_TOPWorkResult::__cordl_internal_get__generatedGOs() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____generatedGOs;
}
