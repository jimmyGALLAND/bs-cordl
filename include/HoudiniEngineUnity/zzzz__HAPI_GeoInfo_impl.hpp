...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::HoudiniEngineUnity::HAPI_GeoInfo::*)(::HoudiniEngineUnity::HAPI_GroupType)>(&::HoudiniEngineUnity::HAPI_GeoInfo::getGroupCountByType)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x39c5048;
