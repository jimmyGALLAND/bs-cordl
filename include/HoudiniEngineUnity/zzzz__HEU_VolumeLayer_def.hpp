...
/// @brief Method IsEquivalentTo, addr 0x3a1a2c0, size 0x370, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a1a630, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
