...
/// @brief Method LoadPresetFileIntoAssetAndCook, addr 0x3983eb4, size 0x66c, virtual false, abstract: false, final false
static inline void LoadPresetFileIntoAssetAndCook(::HoudiniEngineUnity::HEU_HoudiniAsset*  asset, ::StringW  filePath) ;

/// @brief Method SaveAssetPresetToFile, addr 0x39830c4, size 0x640, virtual false, abstract: false, final false
