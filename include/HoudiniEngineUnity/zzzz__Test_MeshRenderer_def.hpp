...
/// @brief Method IsEquivalentTo, addr 0x3a16640, size 0x13c, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_MeshRenderer*  other) ;

/// @brief Method IsNull, addr 0x3a165e0, size 0x60, virtual true, abstract: false, final true
inline bool IsNull() ;
...
/// @brief Method .ctor, addr 0x3a165b8, size 0x28, virtual false, abstract: false, final false
...
constexpr ::HoudiniEngineUnity::IEquivableWrapperClass_1<::HoudiniEngineUnity::Test_MeshRenderer*>* i___HoudiniEngineUnity__IEquivableWrapperClass_1___HoudiniEngineUnity__Test_MeshRenderer__() noexcept;
