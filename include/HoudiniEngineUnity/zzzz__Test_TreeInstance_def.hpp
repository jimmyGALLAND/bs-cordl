...
/// @brief Method IsEquivalentTo, addr 0x3a1879c, size 0x21c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a18768, size 0x34, virtual false, abstract: false, final false
