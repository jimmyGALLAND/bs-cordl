...
template<typename T>
inline void HoudiniEngineUnity::ArrayExtensions::Init(::ArrayW<T,::Array<T>*>  array, T  defaultValue)  {
...
template<typename T>
inline void HoudiniEngineUnity::ArrayExtensions::Init(::System::Collections::Generic::List_1<T>*  array, T  defaultValue)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::ArrayExtensions*>::get(),
                    "Init",
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()},
...
template<typename T>
inline void HoudiniEngineUnity::ArrayExtensions::CopyToWithResize(::ArrayW<T,::Array<T>*>  srcArray, ByRef<::ArrayW<T,::Array<T>*>>  destArray)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::ArrayExtensions*>::get(),
                    "CopyToWithResize",
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()},
                    ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<T,::Array<T>*>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<::ArrayW<T,::Array<T>*>>>::get()}
                )));
static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(
                    ___internal_method_base,
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}
...
template<typename T>
inline bool HoudiniEngineUnity::ArrayExtensions::IsEquivalentArray(::ArrayW<T,::Array<T>*>  arr, ::ArrayW<T,::Array<T>*>  other)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::ArrayExtensions*>::get(),
                    "IsEquivalentArray",
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()},
...
template<typename T>
inline bool HoudiniEngineUnity::ArrayExtensions::IsNull(::ArrayW<T,::Array<T>*>  arr)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::ArrayExtensions*>::get(),
                    "IsNull",
                    std::array<const Il2CppClass*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()},
