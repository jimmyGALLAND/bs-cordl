...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_LoadBufferInstancer::*)()>(&::HoudiniEngineUnity::HEU_LoadBufferInstancer::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x39deea8;
...
constexpr ::ArrayW<::HoudiniEngineUnity::HAPI_Transform,::Array<::HoudiniEngineUnity::HAPI_Transform>*> const& HoudiniEngineUnity::HEU_LoadBufferInstancer::__cordl_internal_get__instanceTransforms() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____instanceTransforms;
}
constexpr void HoudiniEngineUnity::HEU_LoadBufferInstancer::__cordl_internal_set__instanceTransforms(::ArrayW<::HoudiniEngineUnity::HAPI_Transform,::Array<::HoudiniEngineUnity::HAPI_Transform>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
