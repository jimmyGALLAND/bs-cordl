...
class CORDL_TYPE ReloadEvent : public ::UnityEngine::Events::UnityEvent_3<::UnityW<::HoudiniEngineUnity::HEU_HoudiniAsset>,bool,::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>*> {
public:
// Declarations
static inline ::HoudiniEngineUnity::ReloadEvent* New_ctor() ;

/// @brief Method .ctor, addr 0x3982abc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
