...
/// @brief Method IsEquivalentTo, addr 0x3a17160, size 0xf4, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_Gradient*  other) ;

/// @brief Method IsNull, addr 0x3a17150, size 0x10, virtual true, abstract: false, final true
inline bool IsNull() ;
...
/// @brief Method .ctor, addr 0x3a17128, size 0x28, virtual false, abstract: false, final false
