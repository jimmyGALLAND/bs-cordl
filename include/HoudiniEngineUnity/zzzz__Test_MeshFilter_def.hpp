...
/// @brief Method IsEquivalentTo, addr 0x3a16b08, size 0x1a0, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_MeshFilter*  other) ;

/// @brief Method IsNull, addr 0x3a16aa8, size 0x60, virtual true, abstract: false, final true
inline bool IsNull() ;
...
/// @brief Method .ctor, addr 0x3a16a80, size 0x28, virtual false, abstract: false, final false
