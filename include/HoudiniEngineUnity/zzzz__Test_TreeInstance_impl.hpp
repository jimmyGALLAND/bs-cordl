...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::Test_TreeInstance::*)(::UnityEngine::TreeInstance)>(&::HoudiniEngineUnity::Test_TreeInstance::_ctor)> {
  constexpr static std::size_t size = 0x34;
  constexpr static std::size_t addrs = 0x3a18768;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::HoudiniEngineUnity::Test_TreeInstance::*)(::HoudiniEngineUnity::Test_TreeInstance*)>(&::HoudiniEngineUnity::Test_TreeInstance::IsEquivalentTo)> {
  constexpr static std::size_t size = 0x21c;
  constexpr static std::size_t addrs = 0x3a1879c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "IsEquivalentTo",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::HoudiniEngineUnity::Test_TreeInstance*>::get()}
                    )));
    return ___internal_method;
  }
};
...
constexpr ::HoudiniEngineUnity::IEquivable_1<::HoudiniEngineUnity::Test_TreeInstance*>* HoudiniEngineUnity::Test_TreeInstance::i___HoudiniEngineUnity__IEquivable_1___HoudiniEngineUnity__Test_TreeInstance__() noexcept {
return static_cast<::HoudiniEngineUnity::IEquivable_1<::HoudiniEngineUnity::Test_TreeInstance*>*>(static_cast<void*>(this));
}
