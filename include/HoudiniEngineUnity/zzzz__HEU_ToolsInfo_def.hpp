...
/// @brief Method IsEquivalentTo, addr 0x3a19bbc, size 0x610, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3a1a1cc, size 0xf4, virtual false, abstract: false, final false
inline void _ctor() ;
