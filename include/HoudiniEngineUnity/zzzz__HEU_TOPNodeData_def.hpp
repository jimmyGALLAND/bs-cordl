...
/// @brief Method AnyWorkItemsFailed, addr 0x39cf9f8, size 0x24, virtual false, abstract: false, final false
inline bool AnyWorkItemsFailed() ;

/// @brief Method AnyWorkItemsPending, addr 0x39cfc98, size 0x58, virtual false, abstract: false, final false
inline bool AnyWorkItemsPending() ;

/// @brief Method AreAllWorkItemsComplete, addr 0x39cfc04, size 0x4c, virtual false, abstract: false, final false
inline bool AreAllWorkItemsComplete() ;

static inline ::HoudiniEngineUnity::HEU_TOPNodeData* New_ctor() ;

/// @brief Method Reset, addr 0x39cfbe0, size 0x24, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x39ce1f8, size 0xe4, virtual false, abstract: false, final false
inline void _ctor() ;
