...
/// @brief Method CopyTo, addr 0x39a41b4, size 0x24, virtual false, abstract: false, final false
inline void CopyTo(::HoudiniEngineUnity::HEU_InputHDAInfo*  destInfo) ;

/// @brief Method IsEquivalentTo, addr 0x39a587c, size 0x130, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x39a36ec, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
