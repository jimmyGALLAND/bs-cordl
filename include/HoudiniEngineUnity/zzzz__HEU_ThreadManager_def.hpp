...
/// @brief Field _pendingRemove, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__pendingRemove, put=__cordl_internal_set__pendingRemove)) ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ThreadedTask*>*  _pendingRemove;
...
/// @brief Method AddTask, addr 0x39e44a4, size 0xe8, virtual false, abstract: false, final false
inline void AddTask(::HoudiniEngineUnity::HEU_ThreadedTask*  task) ;

/// @brief Method CreateInstance, addr 0x39e40c0, size 0x4, virtual false, abstract: false, final false
static inline void CreateInstance() ;

/// @brief Method Finalize, addr 0x39e40c4, size 0x8, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::HoudiniEngineUnity::HEU_ThreadManager* New_ctor() ;

/// @brief Method Register, addr 0x39e40d0, size 0x4, virtual false, abstract: false, final false
inline void Register() ;

/// @brief Method RemoveTask, addr 0x39e458c, size 0xe8, virtual false, abstract: false, final false
inline void RemoveTask(::HoudiniEngineUnity::HEU_ThreadedTask*  task) ;

/// @brief Method Unregister, addr 0x39e40cc, size 0x4, virtual false, abstract: false, final false
inline void Unregister() ;

/// @brief Method Update, addr 0x39e40d4, size 0x3d0, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x39e4674, size 0xac, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::HoudiniEngineUnity::HEU_ThreadManager* getStaticF__instance() ;

/// @brief Method get_Instance, addr 0x39e4078, size 0x48, virtual false, abstract: false, final false
