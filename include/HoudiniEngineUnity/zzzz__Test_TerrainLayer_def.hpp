...
/// @brief Method IsEquivalentTo, addr 0x3a17ab4, size 0x464, virtual true, abstract: false, final true
inline bool IsEquivalentTo(::HoudiniEngineUnity::Test_TerrainLayer*  other) ;

/// @brief Method IsNull, addr 0x3a17a54, size 0x60, virtual true, abstract: false, final true
inline bool IsNull() ;
...
/// @brief Method .ctor, addr 0x3a17a2c, size 0x28, virtual false, abstract: false, final false
...
constexpr ::HoudiniEngineUnity::IEquivableWrapperClass_1<::HoudiniEngineUnity::Test_TerrainLayer*>* i___HoudiniEngineUnity__IEquivableWrapperClass_1___HoudiniEngineUnity__Test_TerrainLayer__() noexcept;
