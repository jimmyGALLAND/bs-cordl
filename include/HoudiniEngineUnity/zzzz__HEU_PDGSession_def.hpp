...
/// @brief Field _pdgAssets, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__pdgAssets, put=__cordl_internal_set__pdgAssets)) ::System::Collections::Generic::List_1<::UnityW<::HoudiniEngineUnity::HEU_PDGAssetLink>>*  _pdgAssets;
...
/// @brief Field _pdgQueryEvents, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__pdgQueryEvents, put=__cordl_internal_set__pdgQueryEvents)) ::ArrayW<::HoudiniEngineUnity::HAPI_PDG_EventInfo,::Array<::HoudiniEngineUnity::HAPI_PDG_EventInfo>*>  _pdgQueryEvents;
...
/// @brief Method AddAsset, addr 0x39cff3c, size 0x4, virtual false, abstract: false, final false
inline void AddAsset(::HoudiniEngineUnity::HEU_PDGAssetLink*  asset) ;

/// @brief Method AddEventMessage, addr 0x39d07b8, size 0x1c, virtual false, abstract: false, final false
inline void AddEventMessage(::StringW  msg) ;

/// @brief Method CancelCook, addr 0x39ced70, size 0x4, virtual false, abstract: false, final false
inline void CancelCook(::HoudiniEngineUnity::HEU_TOPNetworkData*  topNetwork) ;

/// @brief Method CleanUp, addr 0x39cff44, size 0xfc, virtual false, abstract: false, final false
inline void CleanUp() ;

/// @brief Method ClearErrorState, addr 0x39d03e0, size 0x4c, virtual false, abstract: false, final false
inline void ClearErrorState() ;

/// @brief Method ClearEventMessages, addr 0x39d07f4, size 0x20, virtual false, abstract: false, final false
inline void ClearEventMessages() ;

/// @brief Method ClearWorkItemResult, addr 0x39d07b4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method CookTOPNetworkOutputNode, addr 0x39ceca8, size 0x4, virtual false, abstract: false, final false
inline void CookTOPNetworkOutputNode(::HoudiniEngineUnity::HEU_TOPNetworkData*  topNetwork) ;

/// @brief Method CookTOPNode, addr 0x39cebc4, size 0x8, virtual false, abstract: false, final false
inline bool CookTOPNode(int32_t  nodeID) ;

/// @brief Method DirtyAll, addr 0x39cebec, size 0x8, virtual false, abstract: false, final false
inline bool DirtyAll(int32_t  nodeID) ;

/// @brief Method DirtyTOPNode, addr 0x39ceb9c, size 0x8, virtual false, abstract: false, final false
inline bool DirtyTOPNode(int32_t  nodeID) ;

/// @brief Method GetEventMessages, addr 0x39d07d4, size 0x20, virtual false, abstract: false, final false
inline ::StringW GetEventMessages() ;

/// @brief Method GetHAPIPDGSession, addr 0x39d042c, size 0x68, virtual false, abstract: false, final false
inline ::HoudiniEngineUnity::HEU_SessionBase* GetHAPIPDGSession(bool  bCreate) ;

/// @brief Method GetPDGSession, addr 0x39cc838, size 0x74, virtual false, abstract: false, final false
static inline ::HoudiniEngineUnity::HEU_PDGSession* GetPDGSession() ;

/// @brief Method GetTOPAssetLinkAndNode, addr 0x39d004c, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method NotifyTOPNodeCookedWorkItem, addr 0x39d0218, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method NotifyTOPNodeCookingWorkItem, addr 0x39d0340, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method NotifyTOPNodeErrorWorkItem, addr 0x39d0260, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method NotifyTOPNodePDGStateClear, addr 0x39d0184, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method NotifyTOPNodeScheduledWorkItem, addr 0x39d02f4, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method NotifyTOPNodeTotalWorkItem, addr 0x39d01cc, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method NotifyTOPNodeWaitingWorkItem, addr 0x39d02a8, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method PauseCook, addr 0x39ced0c, size 0x4, virtual false, abstract: false, final false
inline void PauseCook(::HoudiniEngineUnity::HEU_TOPNetworkData*  topNetwork) ;

/// @brief Method ProcessPDGEvent, addr 0x39d0048, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ReinitializePDGContext, addr 0x39d0044, size 0x4, virtual false, abstract: false, final false
inline void ReinitializePDGContext() ;

/// @brief Method RemoveAsset, addr 0x39cc8ac, size 0x4, virtual false, abstract: false, final false
inline void RemoveAsset(::HoudiniEngineUnity::HEU_PDGAssetLink*  asset) ;

/// @brief Method ResetPDGEventInfo, addr 0x39d038c, size 0x14, virtual false, abstract: false, final false
static inline void ResetPDGEventInfo(ByRef<::HoudiniEngineUnity::HAPI_PDG_EventInfo>  eventInfo) ;

/// @brief Method SetErrorState, addr 0x39d03a0, size 0x40, virtual false, abstract: false, final false
inline void SetErrorState(::StringW  msg, bool  bLogIt) ;

/// @brief Method SetTOPNodePDGState, addr 0x39d014c, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x39cff40, size 0x4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdatePDGContext, addr 0x39d0040, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39cfde0, size 0x15c, virtual false, abstract: false, final false
inline void _ctor() ;
