...
/// @brief Method CreateNodeSync, addr 0x39dd3ec, size 0x304, virtual false, abstract: false, final false
static inline void CreateNodeSync(::HoudiniEngineUnity::HEU_SessionBase*  session, ::StringW  opName, ::StringW  nodeNabel) ;

/// @brief Method InitializeFromHoudini, addr 0x39dd1f4, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x39dd1e8, size 0xc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnEnable, addr 0x39dd1e4, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Resync, addr 0x39dd6f0, size 0x38, virtual true, abstract: false, final false
inline void Resync() ;

/// @brief Method SaveNodeToFile, addr 0x39dd34c, size 0xa0, virtual false, abstract: false, final false
inline bool SaveNodeToFile(::StringW  filePath) ;

/// @brief Method SetupLoadTask, addr 0x39dd2a0, size 0x98, virtual true, abstract: false, final false
inline void SetupLoadTask(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method SyncUpdate, addr 0x39dd728, size 0x10c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x39dd834, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
