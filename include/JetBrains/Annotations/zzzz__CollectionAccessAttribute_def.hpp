...
/// @brief Method .ctor, addr 0x4a5d048, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::JetBrains::Annotations::CollectionAccessType  collectionAccessType) ;

/// @brief Method get_CollectionAccessType, addr 0x4a5d070, size 0x8, virtual false, abstract: false, final false
inline ::JetBrains::Annotations::CollectionAccessType get_CollectionAccessType() ;

/// @brief Method set_CollectionAccessType, addr 0x4a5d078, size 0x8, virtual false, abstract: false, final false
