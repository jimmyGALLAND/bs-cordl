...
/// @brief Method .ctor, addr 0x4a5cce0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4a5cce8, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  basePath) ;

/// @brief Method get_BasePath, addr 0x4a5cd10, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_BasePath() ;

/// @brief Method set_BasePath, addr 0x4a5cd18, size 0x8, virtual false, abstract: false, final false
