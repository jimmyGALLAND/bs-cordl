...
/// @brief Method .ctor, addr 0x4a5d258, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  directive) ;

/// @brief Method get_Directive, addr 0x4a5d280, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Directive() ;

/// @brief Method set_Directive, addr 0x4a5d288, size 0x8, virtual false, abstract: false, final false
