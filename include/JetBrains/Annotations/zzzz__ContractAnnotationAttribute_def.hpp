...
/// @brief Method .ctor, addr 0x4a5c994, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  contract) ;

/// @brief Method .ctor, addr 0x4a5c9c0, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::StringW  contract, bool  forceFullStates) ;

/// @brief Method get_Contract, addr 0x4a5c9f4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Contract() ;

/// @brief Method get_ForceFullStates, addr 0x4a5ca04, size 0x8, virtual false, abstract: false, final false
inline bool get_ForceFullStates() ;

/// @brief Method set_Contract, addr 0x4a5c9fc, size 0x8, virtual false, abstract: false, final false
inline void set_Contract(::StringW  value) ;

/// @brief Method set_ForceFullStates, addr 0x4a5ca0c, size 0xc, virtual false, abstract: false, final false
