...
/// @brief Method .ctor, addr 0x4a5cab8, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4a5cb34, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::JetBrains::Annotations::ImplicitUseTargetFlags  targetFlags) ;

/// @brief Method .ctor, addr 0x4a5cb08, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::JetBrains::Annotations::ImplicitUseKindFlags  useKindFlags) ;

/// @brief Method .ctor, addr 0x4a5cadc, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method get_TargetFlags, addr 0x4a5cb70, size 0x8, virtual false, abstract: false, final false
inline ::JetBrains::Annotations::ImplicitUseTargetFlags get_TargetFlags() ;

/// @brief Method get_UseKindFlags, addr 0x4a5cb60, size 0x8, virtual false, abstract: false, final false
inline ::JetBrains::Annotations::ImplicitUseKindFlags get_UseKindFlags() ;

/// @brief Method set_TargetFlags, addr 0x4a5cb78, size 0x8, virtual false, abstract: false, final false
inline void set_TargetFlags(::JetBrains::Annotations::ImplicitUseTargetFlags  value) ;

/// @brief Method set_UseKindFlags, addr 0x4a5cb68, size 0x8, virtual false, abstract: false, final false
