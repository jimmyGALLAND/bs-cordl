...
/// @brief Method .ctor, addr 0x4a5d1a8, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(bool  createConstructorReferences) ;

/// @brief Method get_CreateConstructorReferences, addr 0x4a5d194, size 0x8, virtual false, abstract: false, final false
inline bool get_CreateConstructorReferences() ;

/// @brief Method set_CreateConstructorReferences, addr 0x4a5d19c, size 0xc, virtual false, abstract: false, final false
