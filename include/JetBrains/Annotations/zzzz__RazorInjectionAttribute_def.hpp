...
/// @brief Method .ctor, addr 0x4a5d20c, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  type, ::StringW  fieldName) ;

/// @brief Method get_FieldName, addr 0x4a5d248, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_FieldName() ;

/// @brief Method get_Type, addr 0x4a5d238, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Type() ;

/// @brief Method set_FieldName, addr 0x4a5d250, size 0x8, virtual false, abstract: false, final false
inline void set_FieldName(::StringW  value) ;

/// @brief Method set_Type, addr 0x4a5d240, size 0x8, virtual false, abstract: false, final false
