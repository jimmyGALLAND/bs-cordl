...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::LocalizationRequiredAttribute::*)()>(&::JetBrains::Annotations::LocalizationRequiredAttribute::_ctor)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x4a5ca18;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::LocalizationRequiredAttribute::*)(bool)>(&::JetBrains::Annotations::LocalizationRequiredAttribute::_ctor)> {
  constexpr static std::size_t size = 0x2c;
  constexpr static std::size_t addrs = 0x4a5ca38;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::JetBrains::Annotations::LocalizationRequiredAttribute::*)()>(&::JetBrains::Annotations::LocalizationRequiredAttribute::get_Required)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x4a5ca64;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::LocalizationRequiredAttribute::*)(bool)>(&::JetBrains::Annotations::LocalizationRequiredAttribute::set_Required)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x4a5ca6c;
