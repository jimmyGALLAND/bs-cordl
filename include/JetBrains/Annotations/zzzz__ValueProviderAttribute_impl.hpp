...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::ValueProviderAttribute::*)(::StringW)>(&::JetBrains::Annotations::ValueProviderAttribute::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x4a5c914;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::JetBrains::Annotations::ValueProviderAttribute::*)()>(&::JetBrains::Annotations::ValueProviderAttribute::get_Name)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x4a5c93c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::ValueProviderAttribute::*)(::StringW)>(&::JetBrains::Annotations::ValueProviderAttribute::set_Name)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x4a5c944;
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::JetBrains::Annotations::ValueProviderAttribute*>(name));
}
