...
static inline ::JetBrains::Annotations::MeansImplicitUseAttribute* New_ctor(::JetBrains::Annotations::ImplicitUseKindFlags  useKindFlags, ::JetBrains::Annotations::ImplicitUseTargetFlags  targetFlags) ;
...
/// @brief Method .ctor, addr 0x4a5cb80, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4a5cbfc, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::JetBrains::Annotations::ImplicitUseTargetFlags  targetFlags) ;

/// @brief Method .ctor, addr 0x4a5cbd0, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::JetBrains::Annotations::ImplicitUseKindFlags  useKindFlags) ;

/// @brief Method .ctor, addr 0x4a5cba4, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method get_TargetFlags, addr 0x4a5cc38, size 0x8, virtual false, abstract: false, final false
inline ::JetBrains::Annotations::ImplicitUseTargetFlags get_TargetFlags() ;

/// @brief Method get_UseKindFlags, addr 0x4a5cc28, size 0x8, virtual false, abstract: false, final false
inline ::JetBrains::Annotations::ImplicitUseKindFlags get_UseKindFlags() ;

/// @brief Method set_TargetFlags, addr 0x4a5cc40, size 0x8, virtual false, abstract: false, final false
inline void set_TargetFlags(::JetBrains::Annotations::ImplicitUseTargetFlags  value) ;

/// @brief Method set_UseKindFlags, addr 0x4a5cc30, size 0x8, virtual false, abstract: false, final false
