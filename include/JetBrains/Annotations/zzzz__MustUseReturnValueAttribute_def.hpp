...
/// @brief Method .ctor, addr 0x4a5cc98, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4a5cca0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  justification) ;

/// @brief Method get_Justification, addr 0x4a5ccc8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Justification() ;

/// @brief Method set_Justification, addr 0x4a5ccd0, size 0x8, virtual false, abstract: false, final false
