...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::AssertionConditionAttribute::*)(::JetBrains::Annotations::AssertionConditionType)>(&::JetBrains::Annotations::AssertionConditionAttribute::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x4a5d088;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::JetBrains::Annotations::AssertionConditionType>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::JetBrains::Annotations::AssertionConditionType (::JetBrains::Annotations::AssertionConditionAttribute::*)()>(&::JetBrains::Annotations::AssertionConditionAttribute::get_ConditionType)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x4a5d0b0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::AssertionConditionAttribute::*)(::JetBrains::Annotations::AssertionConditionType)>(&::JetBrains::Annotations::AssertionConditionAttribute::set_ConditionType)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x4a5d0b8;
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::JetBrains::Annotations::AssertionConditionAttribute*>(conditionType));
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, conditionType);
}
...
return ::cordl_internals::RunMethodRethrow<::JetBrains::Annotations::AssertionConditionType, false>(this, ___internal_method);
}
