...
/// @brief Method .ctor, addr 0x4a5c8dc, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  formatParameterName) ;

/// @brief Method get_FormatParameterName, addr 0x4a5c904, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_FormatParameterName() ;

/// @brief Method set_FormatParameterName, addr 0x4a5c90c, size 0x8, virtual false, abstract: false, final false
