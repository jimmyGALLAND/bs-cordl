...
/// @brief Method .ctor, addr 0x4a5d088, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::JetBrains::Annotations::AssertionConditionType  conditionType) ;

/// @brief Method get_ConditionType, addr 0x4a5d0b0, size 0x8, virtual false, abstract: false, final false
inline ::JetBrains::Annotations::AssertionConditionType get_ConditionType() ;

/// @brief Method set_ConditionType, addr 0x4a5d0b8, size 0x8, virtual false, abstract: false, final false
