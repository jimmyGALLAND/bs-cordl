...
/// @brief Method .ctor, addr 0x4a5d15c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  attribute) ;

/// @brief Method get_Attribute, addr 0x4a5d184, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Attribute() ;

/// @brief Method set_Attribute, addr 0x4a5d18c, size 0x8, virtual false, abstract: false, final false
