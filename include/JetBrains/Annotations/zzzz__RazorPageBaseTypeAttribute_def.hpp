...
/// @brief Method .ctor, addr 0x4a5d290, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  baseType) ;

/// @brief Method .ctor, addr 0x4a5d2b8, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  baseType, ::StringW  pageName) ;

/// @brief Method get_BaseType, addr 0x4a5d2e4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_BaseType() ;

/// @brief Method get_PageName, addr 0x4a5d2f4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_PageName() ;

/// @brief Method set_BaseType, addr 0x4a5d2ec, size 0x8, virtual false, abstract: false, final false
inline void set_BaseType(::StringW  value) ;

/// @brief Method set_PageName, addr 0x4a5d2fc, size 0x8, virtual false, abstract: false, final false
