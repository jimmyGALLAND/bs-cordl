...
/// @brief Method .ctor, addr 0x4a5ca18, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x4a5ca38, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(bool  required) ;

/// @brief Method get_Required, addr 0x4a5ca64, size 0x8, virtual false, abstract: false, final false
inline bool get_Required() ;

/// @brief Method set_Required, addr 0x4a5ca6c, size 0xc, virtual false, abstract: false, final false
